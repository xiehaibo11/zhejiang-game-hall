...
function TeaHouseInviteView:setInviterName()
    ...
    self._txtMsgLable2:setText(XH.StringTool.replaceMatchStr(string.format("邀请您加入他的亲友圈【%s】",self._info.teapwd)))
    ...
    if next(self._info.playmodes) then
        ...
        textStr = "<font face='cocosStudio/Common/Font/fangzhengcuyuan.TTF' size='46' color='#AE895D'>亲友圈内常玩:<font color='#C84747'>" 
        .. tempPlayModeName .. "</font><font color='#AE895D'>等</font></font>"
    else
        textStr = "<font face='cocosStudio/Common/Font/fangzhengcuyuan.TTF' size='46' color='#AE895D'>亲友圈内可选您常用的玩法</font>"
    end
    ...
    if self._info.friendcount < 1 then
        ...
        local textMsg = "<font face='cocosStudio/Common/Font/fangzhengcuyuan.TTF' size='46' color='#AE895D'>提示：亲友圈内有<font color='#C84747'>"..self._info.friendcount.. "</font>位玩家曾与您对局</font>"
        local richText2 = ccui.RichText:createWithXML(XH.StringTool.replaceMatchStr(textMsg), { })
