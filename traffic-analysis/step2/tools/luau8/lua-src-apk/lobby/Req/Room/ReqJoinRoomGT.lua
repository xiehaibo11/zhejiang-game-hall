...
function ReqJoinRoomGT:start(roomID,appID,srsGroupID,timeoutTime)
    ...
    reqJoinRoom.hardWareFlag = XH.GameProtocolGT.ReqJoinRoom.HARDWAREFLAG.HF_NONE
    ...
    reqJoinRoom.m_breconnect = false
