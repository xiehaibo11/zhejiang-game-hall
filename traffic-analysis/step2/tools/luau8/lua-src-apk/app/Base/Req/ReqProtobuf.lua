...
function ReqProtobuf:getProtoFilePath()
    if self._protobuf and cc.FileUtils:getInstance():isFileExist("src/app/Protobuf/ProtoFile/" .. self._protobuf.protobufFile) then
        return "src/app/Protobuf/ProtoFile/" .. self._protobuf.protobufFile
    end
    if self._protobuf and cc.FileUtils:getInstance():isFileExist("src/app/Protobuf/ProtoFile/" .. self._protobuf.protobufFile .. "c") then
        return "src/app/Protobuf/ProtoFile/" .. self._protobuf.protobufFile .. "c"
    end
    return ""
end
