...
function TableInfoView:getCSBPath()
    return "cocosStudio/GoldNew/Game/HPLandlord/CSB/TableInfo/TableInfoLayer.csb"
end
...
function TableInfoView:getProxyEvents()
    return {
        --
        {module = NG.goldGame:getModule("GameMain"), eventKeyName = "EVENT_UPDATE_MULT_DATA", callBack = "onMultData"},
        ...
        {module = NG.goldGame:getModule("GameMain"), eventKeyName = "EVENT_UPDATE_MULT_DATA_SINGLE", callBack = "onMultDataAniSingle"}
    }
end
