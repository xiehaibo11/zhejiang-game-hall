...
function MatchView:getCSBPath()
    return "cocosStudio/GoldNew/Game/HPLandlord/CSB/Match/MatchingLayer.csb"
end
...
function MatchView:getProxyEvents()
    return {
        ...
        {module = NG.goldGame:getModule("GameMain"), eventKeyName = "EVENT_START_GAME", callBack = "initView"},
...
function MatchView:initMatchAni()
    ...
    local params = {path = "NewGoldRes/Spine/HPLandlord/Match/", tex = "Hp_ppz.json", ske = "Hp_ppz.atlas", armatureName = "animation"}
...
function MatchView:initWaitAni()
    ...
    local params = {path = "NewGoldRes/Spine/HPLandlord/Match/", tex = "Dengdaizhong.json", ske = "Dengdaizhong.atlas", armatureName = "animation"}
    local spineNode = display.playDargonBonesSpine(params)
    if spineNode then
