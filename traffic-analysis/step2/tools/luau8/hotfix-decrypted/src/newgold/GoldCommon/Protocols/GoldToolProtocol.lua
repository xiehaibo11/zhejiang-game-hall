...
ToolProtocol.RespTempSessionID = {
    ...
    FLAG = {SUCCESS = 0, SHOW_MESSAGE = 1, PTUSER_NEED_REGISTER = 2, UNKNOW_USERID = 3, INVALID_PASSWORD = 4, UNKNOW_USERTYPE = 5, LOCALAUTH_USERTYPE_ERR = 6, PLAYERCENTER_SEND_ERR = 7, PTSVR_SEND_ERR = 8, NO_PTINFO = 9, NO_AUTHFLAG = 10, DBERR = 11, DBCONNERR = 12, FORBID_USERID = 13, LOCK_BY_USER_SELF = 14, INVALID_HARDWARE = 15, PT_TIME_OUT = 16, PC_SEND_ERR = 17, PC_TIME_OUT = 18, AD_SEND_ERR = 19, AD_TIME_OUT = 20, POST_SENDERR = 23, POST_TIMEOUT = 24, AUTH_TOO_FREQUENTLY = 25, IP_TOO_FREQUENTLY = 26, PASS_ERR_OVER_TIMES = 27, SMS_ERR_OVER_TIMES = 28, IPPASS_ERR_OVER_TIMES = 29, INVALID_SESSIONID = 72, NO_SESSIONID = 74},
...
ToolProtocol.ResSR = {
    ...
    FLAG = {SUCCESS = 0, POST_SENDERR = 1, POST_TIMEOUT = 2, DBERR = 21, GAMETABLENOTFIND = 22, DBCONNNOTFIND = 23, SVRSCORETYPEERR = 24},
    askid = 0,
    flag = 0,
    purse = 0,
    bank = 0,
...
ToolProtocol.RespPlayerPropsData = {
    ...
    FLAG = {SUCCESS = 0, POST_SENDERR = 1, POST_TIMEOUT = 2, DBCONNNOTFIND = 21, NETBUSY = 28, DBERR = 29},
...
ToolProtocol.ReqChangePlayerInfo = {
    ...
    CHANGETYPE = {CGT_NULL = 0x00, CGT_SEX = 0x01, CGT_NICKNAME = 0x02, CGT_HEADURL = 0x04, CGT_UNBIND = 0x08},
    askid = 0,
    flag = 0,
    sex = 0,
    nickname = "",
...
ToolProtocol.RespCheckBindUser = {
    ...
    LOGINTYPE = {WX_LOGIN = 0, GY_LOGIN = 1, DX_LOGIN = 2, GY2WX_LOGIN = 3, DX2WX_LOGIN = 4},
