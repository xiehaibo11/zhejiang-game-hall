...
local ServerMainRule = g_gameConstant.GAME_PLAY_RULE_SCMJ_XZDD_3P3R
local NameStr = "三人三房"
...
local XZddMjIni = {
    ...
    HelpImg = {
        {"bigImg/help_mj_3p3r_%d.png", 3, NameStr},
    },
    
    CreationViewTable = {
        [g_gameConstant.GAME_PLAY_RULE_SCMJ_XZDD_3P3R] = "newgold.MatchGames.subMjGame.xzddMjGame.lobby.GameCreationView3p3r",
    },
