...
function VipEmojiPropChargeView:ctor(param)
    ...
    local isVipProp = param.isVipProp == nil and true or param.isVipProp
    if not isVipProp then
        self._btnRechargeVIP:setVisible(false)
        self._btnRechargeProp:setPositionX(410)
    end
end
...
function VipEmojiPropChargeView:onEventProductList(data)
    ...
    if self._butProductIndex == nil then
        return
    end
...
return VipEmojiPropChargeViewR