...
function PropEventTrackerModule:track(key, customize)
    local _, _ = pcall(function()
        ...
        local content = {
            ...
            page = customize.page or self:roomType(),
        ...
        if cfg and cfg.customize then
            ...
            if string.find(cfg.customize, 'task_id') then
                customize['task_id'] = (CF.game and CF.game:getModule("Shuffle4") and CF.game:getModule("Shuffle4"):getStrategyId()) or 0
            end
        end
