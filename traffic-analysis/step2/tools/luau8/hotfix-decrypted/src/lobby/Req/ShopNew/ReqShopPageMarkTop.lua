...
function ReqShopPageMarkTop:start(numid, gameid, areaId, windMsgId, uid, timeoutTime)
    ...
    XH.httpManager50:RequestGet("", UrlConf.REQ_SHOP_PAGE_MARK_EX .. "?" .. param, XH.HttpDefine.HTTP_CALLBACK_TYPE.CALL_BACK_JSON, handler(self, self.onHttpReqShopPageMarkTopCallBack),nil,true)
end
