...
ReqH5StartGameLogin.GameList = {
    ...
    SHENYUANQIYUE = 18, -- 深渊契约
    FUMOZHANGE = 19, -- 伏魔战歌
    BAZHETIANXIA = 20, -- 霸者天下
    LONGJIZHICHENG = 21, -- 龙迹之城
}

-- 横屏游戏
ReqH5StartGameLogin.HorizontalGameList = {
    [ReqH5StartGameLogin.GameList.LONGJIZHICHENG] = 1,
}
...
ReqH5StartGameLogin.GameConfig = {
    ...
    [ReqH5StartGameLogin.GameList.SHENYUANQIYUE] = { gameid = "810028",shopid = "1032"},
    [ReqH5StartGameLogin.GameList.FUMOZHANGE] = { gameid = "810030",shopid = "1034"},
    [ReqH5StartGameLogin.GameList.BAZHETIANXIA] = { gameid = "810032",shopid = "1036"},
    [ReqH5StartGameLogin.GameList.LONGJIZHICHENG] = { gameid = "810033",shopid = "1037"},
}
...
function ReqH5StartGameLogin:start(numid, nickname, sex, wechaturl, gametag, bNeedConfigID, isWeChatId)
    ...
    if ReqH5StartGameLogin.HorizontalGameList[gametag] then
        ext.direction = 1
    end
    local mapData = {
