...
UserDefault.KEY_ID = {
    ...
    KW_LUCKY_TASK_AUTO_SHOW = 176, --幸运任务每日自动弹窗次数
    KW_AURO_POP_SHOW = 177, --幸运任务每日自动弹窗次数
    ...
    KW_SCORING_ASSISTANT = 205, -- 计分助手
    KW_SCORING_ASSISTANT2 = 206,    -- 计分助手
    KW_BIND_PHONE_POP_DATE = 207, -- 绑定手机
    KW_SPFEST_RECALL = 208, -- 春节召回
    KW_NEWGUIDE = 209, -- 新版本新手引导
    KW_SXVIP_EXPIRE_TIME = 210, -- 记录vip过期时间
    KW_SXVIP_AUTOPOP_EXPIRE = 211, -- 已过期记录弹窗次数
    KW_SXVIP_AUTOPOP_UNEXPIRE = 212, -- 未过期记录弹窗次数

    KW_DARK_SHUANGKOU_IMAGE_TEXT_TUTORIAL = 213, -- 暗斗图文引导
    KW_DARK_SHUANGKOU_FIRST_EXIT_POP_CHANLLANGE = 214, -- 暗斗每日首次退出游戏暗斗挑战引导
    KW_FIRST_IN_TEAHOUSE = 215, -- 首次进入比赛场
    UM_LIMIT_GOLD_POP_TIMES = 216, -- 无限金币当日推送次数
    UN_LIMIT_GOLD_POP_SMALL_TIMES = 217, -- 无限金币小局间隔次数

    KW_SXVIPS_SHOW_FINNER_DATE = 218, -- 展示手势日期
    KW_SXVIPS_SHOW_RED_POINT_DATE = 219, -- 显示红点日期
    KW_SXVIPS_SHOW_WIN_TIPS_DATE = 220, -- 显示胜利提示日期

    
    UN_LIMIT_BOX_COOLDOWN_TIMES = 221, -- 无限对局推送冷却次数
    UN_LIMIT_BOX_DAILY_POP_TIMES = 222, -- 无限对局每日最大推送

    KW_BOXPLAYER_CONVERSION_TODAY_SHOW_TIMES = 223, -- 推荐弹窗当日显示次数
    KW_BOXPLAYER_CONVERSION_TODAY_FREQUENTLY = 224,  -- 频繁弹窗数据

    KW_LIMITED_TIME_CARD_INFO = 225,  --限时绑定信息
    KW_LAST_GAME_INFO = 226,  --上一次游戏信息
    KW_RECALL_NEW_MATCH_POP_LIST = 227,  -- 召回比赛场弹窗数据
    KW_RECALL_NEW_CLICK_LIMIT = 228,    -- 每日弹窗
    KW_POP_SYSTEM_CLOSE_INFO = 229,  -- iop弹窗关闭信息
    GAMERULE_CACHE_DROPDOWN_STATE = 230, -- 下拉框选中状态
    GAME_TRUST_TIP = 231, -- 托管提示
    KW_FEE_LOCALSTORAGE_PHONE = 232,    -- 话费充值绑定手机号
    KW_CONTINUE_CLICK = 233,    -- 续桌点击
    KW_PROMOTE2_TEAHOUSE_AUTO_POP = 234,  -- 推广活动2，比赛场大厅每日自动弹窗次数（每天最多3次）
    POPSYSTEM_POP_CLICK_AFTER = 235,
    KW_GAMECENTER_FINGER_ANI_SHOW = 236,
    KW_GAMEPLAY_REACH_SHOW_COUNT = 237,  -- 玩法触达弹窗单用户展示次数
    KW_GAMEPLAY_REACH_READ_STATE = 238,  -- 玩法触达红点已读状态（玩法/规则/功能）
    KW_LUCKY_TASK_PROMOTE_POP = 239,  -- 幸运任务推广弹窗每日弹出次数（每天最多3次）
}
...
function UserDefault:getKeyInfoTable()
    return {
        ...
        [UserDefault.KEY_ID.GAMERULE_CACHE_DROPDOWN_STATE] = { keyType = KEY_TYPE.STRING ,getFullKeyFunc = "getFullKey_GAMERULE_CACHE_DROPDOWN_STATE"},
        ...
        [UserDefault.KEY_ID.KW_LIMITED_TIME_CARD_INFO] = {keyType = KEY_TYPE.JSON, mainKey = "KW_LIMITED_TIME_CARD_INFO_%d_%d",getFullKeyFunc = "getFullKeyByMainKeyAndNumidAreaid"},
        [UserDefault.KEY_ID.KW_LAST_GAME_INFO] = {keyType = KEY_TYPE.JSON, mainKey = "KW_LAST_GAME_INFO_%d_%d",getFullKeyFunc = "getFullKeyByMainKeyAndNumidAreaid"},
        [UserDefault.KEY_ID.KW_LUCKY_TASK_AUTO_SHOW] = {keyType = KEY_TYPE.JSON, mainKey = "KW_LUCKY_TASK_AUTO_SHOW_%s_%d_%d",getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid"},
        [UserDefault.KEY_ID.KW_AURO_POP_SHOW] = {keyType = KEY_TYPE.JSON, mainKey = "KW_AURO_POP_SHOW_%s_%d_%d",getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid"},
        ...
        [UserDefault.KEY_ID.KW_SCORING_ASSISTANT] = {keyType = KEY_TYPE.STRING, mainKey = "KW_SCORING_ASSISTANT_%d_%d", getFullKeyFunc = "getFullKeyByMainKeyAndNumidAreaid" },
        [UserDefault.KEY_ID.KW_SPFEST_RECALL] = {keyType = KEY_TYPE.STRING, mainKey = "KW_SPFEST_RECALL%d_%d", getFullKeyFunc = "getFullKeyByMainKeyAndNumidAreaid" },
        [UserDefault.KEY_ID.KW_SCORING_ASSISTANT2] = {keyType = KEY_TYPE.STRING, mainKey = "KW_SCORING_ASSISTANT2_%d_%d", getFullKeyFunc = "getFullKeyByMainKeyAndNumidAreaid" },
        [UserDefault.KEY_ID.KW_NEWGUIDE] = {keyType = KEY_TYPE.BOOL, mainKey = "KW_NEWGUIDE_%d_%d", getFullKeyFunc = "getFullKeyByMainKeyAndNumidAreaid" },
        [UserDefault.KEY_ID.KW_BIND_PHONE_POP_DATE] = {keyType = KEY_TYPE.INT, mainKey = "KW_BIND_PHONE_POP_DATE_%s_%d_%d", getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid" },
        [UserDefault.KEY_ID.KW_SXVIP_EXPIRE_TIME] = {keyType = KEY_TYPE.INT, mainKey = "KW_SXVIP_EXPIRE_TIME_%d_%d", getFullKeyFunc = "getFullKeyByMainKeyAndNumidAreaid" },
        [UserDefault.KEY_ID.KW_SXVIP_AUTOPOP_EXPIRE] = {keyType = KEY_TYPE.INT, mainKey = "KW_SXVIP_AUTOPOP_EXPIRE_%s_%d_%d", getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid" },
        [UserDefault.KEY_ID.KW_SXVIP_AUTOPOP_UNEXPIRE] = {keyType = KEY_TYPE.INT, mainKey = "KW_SXVIP_AUTOPOP_UNEXPIRE_%s_%d_%d", getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid" },
        [UserDefault.KEY_ID.KW_DARK_SHUANGKOU_IMAGE_TEXT_TUTORIAL] = {keyType = KEY_TYPE.BOOL, mainKey = "KW_DARK_SHUANGKOU_IMAGE_TEXT_TUTORIAL_%d", getFullKeyFunc = "getFullKeyByMainKeyAndNumid" },
        [UserDefault.KEY_ID.KW_DARK_SHUANGKOU_FIRST_EXIT_POP_CHANLLANGE] = {keyType = KEY_TYPE.BOOL, mainKey = "KW_DARK_SHUANGKOU_FIRST_EXIT_POP_CHANLLANGE_%s_%d_%d", getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid" },
        [UserDefault.KEY_ID.KW_FIRST_IN_TEAHOUSE] = {keyType = KEY_TYPE.INT, mainKey = "KW_FIRST_IN_TEAHOUSE_%d_%d", getFullKeyFunc = "getFullKeyByMainKeyAndNumidAreaid" },
        [UserDefault.KEY_ID.UM_LIMIT_GOLD_POP_TIMES] = {keyType = KEY_TYPE.INT, mainKey = "UM_LIMIT_GOLD_POP_TIMES_%s_%d_%d", getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid" },
        [UserDefault.KEY_ID.UN_LIMIT_GOLD_POP_SMALL_TIMES] = {keyType = KEY_TYPE.INT, mainKey = "UN_LIMIT_GOLD_POP_SMALL_TIMES_%s_%d_%d", getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid" },
        [UserDefault.KEY_ID.KW_SXVIPS_SHOW_FINNER_DATE] = {keyType = KEY_TYPE.INT, mainKey = "KW_SXVIPS_SHOW_FINNER_DATE_%d" , getFullKeyFunc = "getFullKeyByMainKeyAndNumid"},
        [UserDefault.KEY_ID.KW_SXVIPS_SHOW_RED_POINT_DATE] = {keyType = KEY_TYPE.INT, mainKey = "KW_SXVIPS_SHOW_RED_POINT_DATE_%d" , getFullKeyFunc = "getFullKeyByMainKeyAndNumid"},
        [UserDefault.KEY_ID.KW_SXVIPS_SHOW_WIN_TIPS_DATE] = {keyType = KEY_TYPE.INT, mainKey = "KW_SXVIPS_SHOW_WIN_TIPS_DATE_%d" , getFullKeyFunc = "getFullKeyByMainKeyAndNumid"},
        [UserDefault.KEY_ID.KW_BOXPLAYER_CONVERSION_TODAY_SHOW_TIMES] = {keyType = KEY_TYPE.STRING, mainKey = "KW_BOXPLAYER_CONVERSION_TODAY_SHOW_TIMES_%d" , getFullKeyFunc = "getFullKeyByMainKeyAndNumid"},
        [UserDefault.KEY_ID.KW_BOXPLAYER_CONVERSION_TODAY_FREQUENTLY] = {keyType = KEY_TYPE.JSON, mainKey = "KW_BOXPLAYER_CONVERSION_TODAY_FREQUENTLY_%d" , getFullKeyFunc = "getFullKeyByMainKeyAndNumid"},
        [UserDefault.KEY_ID.UN_LIMIT_BOX_COOLDOWN_TIMES] = {keyType = KEY_TYPE.INT, mainKey = "UN_LIMIT_BOX_COOLDOWN_TIMES_%s_%d_%d", getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid" },
        [UserDefault.KEY_ID.UN_LIMIT_BOX_DAILY_POP_TIMES] = {keyType = KEY_TYPE.INT, mainKey = "UN_LIMIT_BOX_DAILY_POP_TIMES_%s_%d_%d", getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid" },
        [UserDefault.KEY_ID.KW_RECALL_NEW_MATCH_POP_LIST] = {keyType = KEY_TYPE.JSON, mainKey = "KW_RECALL_NEW_MATCH_POP_LIST_%s_%d_%d" , getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid"},
        [UserDefault.KEY_ID.KW_POP_SYSTEM_CLOSE_INFO] = {keyType = KEY_TYPE.JSON, mainKey = "KW_POP_SYSTEM_CLOSE_INFO_%s_%d" , getFullKeyFunc = "getFullKeyByMainKeyAndNumidAreaid"},
        [UserDefault.KEY_ID.KW_GAMEPLAY_REACH_SHOW_COUNT] = {keyType = KEY_TYPE.JSON, mainKey = "KW_GAMEPLAY_REACH_SHOW_COUNT_%s_%d", getFullKeyFunc = "getFullKeyByMainKeyAndNumidAreaid"},
        [UserDefault.KEY_ID.KW_GAMEPLAY_REACH_READ_STATE] = {keyType = KEY_TYPE.JSON, mainKey = "KW_GAMEPLAY_REACH_READ_STATE_%s_%d", getFullKeyFunc = "getFullKeyByMainKeyAndNumidAreaid"},
        [UserDefault.KEY_ID.KW_RECALL_NEW_CLICK_LIMIT] = {keyType = KEY_TYPE.INT, mainKey = "KW_RECALL_NEW_CLICK_LIMIT_%s_%d_%d" , getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid"},
        [UserDefault.KEY_ID.KW_CONTINUE_CLICK] = {keyType = KEY_TYPE.INT, mainKey = "KW_CONTINUE_CLICK_%s_%d_%d" , getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid"},
        [UserDefault.KEY_ID.KW_PROMOTE2_TEAHOUSE_AUTO_POP] = {keyType = KEY_TYPE.INT, mainKey = "KW_PROMOTE2_TEAHOUSE_AUTO_POP_%s_%d_%d", getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid"},
        [UserDefault.KEY_ID.KW_LUCKY_TASK_PROMOTE_POP] = {keyType = KEY_TYPE.INT, mainKey = "KW_LUCKY_TASK_PROMOTE_POP_%s_%d_%d", getFullKeyFunc = "getFullKeyTodayLobbyidAndNumid"},
        [UserDefault.KEY_ID.KW_FEE_LOCALSTORAGE_PHONE] = {keyType = KEY_TYPE.STRING, mainKey = "KW_FEE_LOCALSTORAGE_PHONE_%s_%d" , getFullKeyFunc = "getFullKeyByMainKeyAndNumidAreaid"},
        [UserDefault.KEY_ID.GAME_TRUST_TIP] = {keyType = KEY_TYPE.JSON, mainKey = "GAME_TRUST_TIP_JSON_%s_%d", getFullKeyFunc = "getFullKeyTodayLobbyidAndGameid" },
        [UserDefault.KEY_ID.POPSYSTEM_POP_CLICK_AFTER] = {keyType = KEY_TYPE.BOOL, mainKey = "POPSYSTEM_POP_CLICK_AFTER_%s_%d_%d_%d", getFullKeyFunc = "getFullKey_POPSYSTEM_POP_CLICK_AFTER" },
        [UserDefault.KEY_ID.KW_GAMECENTER_FINGER_ANI_SHOW] = {keyType = KEY_TYPE.BOOL, mainKey = "KW_GAMECENTER_FINGER_ANI_SHOW_%d_%d", getFullKeyFunc = "getFullKeyByMainKeyAndNumidLobbyid" },
    }
end
...
function UserDefault:deleteValueForKey(key, Value, extraParam)
    local wholeInfo = self:getWholeInfoByKey(key, Value, extraParam)
    cc.UserDefault:getInstance():deleteValueForKey(wholeInfo.fullKey)
end
...
--全key 由主key和 当天时间、lobbyid 和Gameidid组成
function UserDefault:getFullKeyTodayLobbyidAndGameid(mainKey, gameid)
    gameid = gameid or 0
    return string.format(mainKey,os.date("%Y-%m-%d"),gameid)
end
...
function UserDefault:isNeedFitGameID(gameID)
    if gameID and table.indexof(FIT_LOBBYID_GAMEIDS, gameID) then
        return true
    end
    return false
end
...
function UserDefault:getFullKey_GAMERULE_CACHE_BUTTON_STATE(mainKey, extraParam)
    ...
    if self:isNeedFitGameID(gameID) then
        keyString = keyString .. "_" .. XH.areaData:getLobbyID()
    end
...
function UserDefault:getFullKey_GAMERULE_CACHE_DROPDOWN_STATE(mainKey, extraParam)
    local gameID = extraParam.gameID or ""
    local categoriesIndex = extraParam.categoriesIndex
    local nodeName = extraParam.nodeName or ""
    local keyCacheInfo = extraParam.keyCacheInfo or ""

    local keyString = "gameRuleDropDown".. gameID .. "_" .. nodeName .. "_1"
    if categoriesIndex then
        keyString = "gameRuleDropDown".. gameID .. "_" .. nodeName .. "_" .. categoriesIndex
    end
    if self:isNeedFitGameID(gameID) then
        keyString = keyString .. "_" .. XH.areaData:getLobbyID()
    end
...
function UserDefault:getFullKey_GAMERULE_CATEGORIE_SELECT(mainKey, extraParam)
    ...
    local keyCacheInfo = extraParam.keyCacheInfo or ""
    if self:isNeedFitGameID(gameID) then
        keyCacheInfo = keyCacheInfo .. "_" .. XH.areaData:getLobbyID()
    end
...
function UserDefault:getFullKey_GAMERULE_CACHE_EXIST(mainKey, extraParam)
    ...
    if self:isNeedFitGameID(gameID) then
        key = key .. "_" .. XH.areaData:getLobbyID()
    end
...
function UserDefault:getFullKey_POPSYSTEM_POP_CLICK_AFTER(mainKey, extraParam)
    local popId = extraParam.popId or 0
    return string.format(mainKey, os.date("%Y-%m-%d"), XH.areaData:getAreaID(), XH.playerData:getNumberID(), popId)
end
