...
TeaHouseProtobuf.PageRecallPlayerExRequest = {
    reqName = "PageRecallPlayerExRequest",
    xyid = 2338,
    resqName = "PageRecallPlayerExReply",
    data ={
        tenant_id = 1, -- 租户ID
        area_id = 2,   -- 区域ID
        club_id = 3,   -- 比赛场ID
...
-- 请求求财运策略
TeaHouseProtobuf.LimitedTimeOfferRequest = {
    reqName = "LimitedTimeOfferRequest",
    xyid = 2213,
    resqName = "LimitedTimeOfferReply",
    data ={
        ask_id = 1,
        tenant_id = 2, -- 租户ID
        area_id = 3,   -- 区域ID
...
-- 免费使用
TeaHouseProtobuf.CaiYunFreeUsePropsRequest = {
    reqName = "CaiYunFreeUsePropsRequest",
    xyid = 2215,
    resqName = "CaiYunFreeUsePropsReply",
    data ={
        ask_id = 1,
        tenant_id = 2, -- 租户ID
        area_id = 3,   -- 区域ID
