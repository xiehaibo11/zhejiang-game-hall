...
GameProtocolGT.RespJoinRoom = {
    ...
    bistream = function (self,buff, bufflen)
        ...
        if self.flag == GameProtocolGT.RespJoinRoom.JOINROOMFLAG.SHOW_MESSAGE then
            ...
            self.msgbox.m_szCaption = un.StringUtils.GB_18030_2000_TO_UTF8(bis:readString())
            self.msgbox.m_szText = un.StringUtils.GB_18030_2000_TO_UTF8(bis:readString())
            self.msgbox.m_dwIconBtn = bis:readUInt32()
            self.msgbox.m_delay = bis:readUInt8()
            self.msgbox.m_colour = bis:readUInt32()
            self.msgbox.m_szWeb = un.StringUtils.GB_18030_2000_TO_UTF8(bis:readString())
