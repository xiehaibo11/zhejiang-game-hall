...
table.insert(scriptPath,"LiangBang.Code.CardLayer.CardAreaLiangBang.UICardsAreaInterface")
table.insert(scriptPath,"LiangBang.Code.CardLayer.UICardsAreaAnimation")
