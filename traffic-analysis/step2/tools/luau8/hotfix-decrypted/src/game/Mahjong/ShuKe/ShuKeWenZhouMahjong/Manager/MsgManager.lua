...
function MsgManager:sendGameQuickStart(state)
    local msgPlayerQuickStart =CF.GameProtocol.msgReqAdvancedPlayInfo:new()
    msgPlayerQuickStart.nSeat = CF.roomData:getSelfSeat()
    msgPlayerQuickStart.state = state
    msgPlayerQuickStart.playerCnt = CF.roomData:getCurPlayerCount()
    self:sendStreamPacket(msgPlayerQuickStart)
end
