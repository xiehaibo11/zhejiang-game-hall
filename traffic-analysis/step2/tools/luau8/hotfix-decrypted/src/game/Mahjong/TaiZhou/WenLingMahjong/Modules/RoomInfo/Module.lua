...
function RoomInfoModule:onMsgGameRule(msgData)
    ...
    local orderRuleTable = {"playType", "winLostType", "shuZhangFirst", "zhongFaBaoPai", "queMen", "forceGPS", "lianZhuang"}
    local gameRuleStrTable = {
        ["playType"] = {[1] = "小闹", [2] = "大闹", [3] = "全闹", [4] = "常规"},
        ["winLostType"] = {[1] = "庄家翻倍", [2] = "闲家减半", [3] = "平搓"},
        ["shuZhangFirst"] = {[0] = "先打财神", [1] = "先打熟张"},
        ["zhongFaBaoPai"] = {[1] = "中发包牌"},
        ["queMen"] = {[1] = "缺一门", [2] = "缺二门"},
        ["forceGPS"] = {[1] = "强制定位"},
        ["PayType"] = {[0] = "房主付", [1] = "平摊付"},
