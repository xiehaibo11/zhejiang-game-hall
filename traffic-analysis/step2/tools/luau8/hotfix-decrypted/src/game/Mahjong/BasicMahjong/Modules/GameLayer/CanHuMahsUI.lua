...
function CanHuMahsUI:getCSBPath()
    return "cocosStudio/MahjongNew/GameLayer/CSB/CanHuMahs.csb"
end
...
function CanHuMahsUI:setHuInfo(data)
    ...
    for i = 1, #data do
        ...
        if node then
            ...
            for j = 1, #infoData do
                ...
                local text = cc.LabelBMFont:create("", "res/fnt/can_hu_mah_info.fnt")
    ...
    for i = 1, #data do
        ...
        for j = 1, #infoData do
            ...
            if node then
                local text = cc.LabelBMFont:create("", "res/fnt/can_hu_mah_info_2.fnt")
                text:setString(infoData[j])
...
function CanHuMahsUI:getSurplusMahs(mahID)
    ...
    local gameIDSIgnoreOpenMahs = {30287}
    if not table.indexof(gameIDSIgnoreOpenMahs, gameID) then
