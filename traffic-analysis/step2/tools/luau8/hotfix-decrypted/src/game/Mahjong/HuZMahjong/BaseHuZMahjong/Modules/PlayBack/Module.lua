local PlayBackModule = CF.gameClass("PlayBackModule", "game.Mahjong.BasicMahjong.Modules.PlayBack.Module")
...
function PlayBackModule:processMsgData(subXYID, subBuff, subLen)
    ...
    return PlayBackModule.super.processMsgData(self, subXYID, subBuff, subLen)
end

function PlayBackModule:onFillMsgPlayerPowerEx(XYID,buff,len)    
...
function PlayBackModule:onFillMsgPlayerAction(XYID,buff,len)    
