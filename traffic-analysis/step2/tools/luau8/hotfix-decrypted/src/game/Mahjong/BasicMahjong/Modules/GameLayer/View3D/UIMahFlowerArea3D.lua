...
local UIMahFlowerArea3D = CF.gameClass("UIMahFlowerArea3D", "game.Mahjong.BasicMahjong.Modules.GameLayer.ViewBase.UIMahFlowerAreaBase")
...
function UIMahFlowerArea3D:_getMahType()
    ...
    elseif self._localSeat == CF.GameDefine.LOCAL_SEAT.RIGHT then
        return CF.GameDefine.MAH_TYPE.LIE_FACE_UP_HORIZONTAL_TOLEFT
    elseif self._localSeat == CF.GameDefine.LOCAL_SEAT.TOP then
        return CF.GameDefine.MAH_TYPE.LIE_FACE_UP_VERTICAL_TODOWN
    elseif self._localSeat == CF.GameDefine.LOCAL_SEAT.LEFT then
        return CF.GameDefine.MAH_TYPE.LIE_FACE_UP_HORIZONTAL_TORIGHT
    end
end
