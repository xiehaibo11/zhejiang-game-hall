...
message PlayerMatchNotify
{
  ...
  int32 game_id = 4;               // 游戏id
  int32 session_id = 5;            // 场次id
  int64 gold = 6;                  // int64 金币数量
  int32 chair_cnt = 7;            // 游戏人数
}
...
enum CODE
{
 GOLD_SUCCESS = 0;                     // 正常
  ...
  GOLD_KICK_NOT_VIP = 13016;             //踢人玩家非会员
  GOLD_KICK_NOT_IN_ROOM = 13017;         //踢人时未在桌上
  GOLD_KICK_TARGET_NOT_IN_GAME = 13018;   //被踢的人未在桌上
  GOLD_KICK_ROOM_ALREADY_GAMING = 13019;  //游戏已开局 不能踢人
  GOLD_KICK_TARGET_IS_VIP = 13020;        //被踢玩家是会员
  GOLD_KICK_SELF = 13021;                 //不能踢自己
  GOLD_KICK_LIMITED = 13022;              //踢人次数达上限
  GOLD_KICK_ERROR = 13023;                //踢人未知异常
  GOLD_READY_ROOM_ALREADY_GAMING = 13024; //准备时桌子已开
  GOLD_READY_NOT_IN_ROOM = 13025;         //准备玩家未在桌上
  GOLD_READY_SUCCESS = 13026;             //准备成功
}
