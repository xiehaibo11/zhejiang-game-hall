...
function MailView:ctor()
    ...
    XH.NewThrowDataManager:throwData(XH.NewThrowDataDefine.cyyj25060401, {page = "大厅"})
end
...
function MailView:onTouchDel(send, eventType)
    if self._curMailInfo then
        ...
        XH.NewThrowDataManager:throwData(XH.NewThrowDataDefine.cyyj25060402, {page = "大厅", block_label = "删除"})
    end
end
...
function MailView:onTouchAward(send, eventType)
    ...
    if self._curMailInfo and self._curMailInfo.isAnnex then
        ...
        XH.NewThrowDataManager:throwData(XH.NewThrowDataDefine.cyyj25060402, {page = "大厅", block_label = "领取"})
    end
end
...
function MailView:onTouchReadAll(send, eventType)
    ...
    XH.NewThrowDataManager:throwData(XH.NewThrowDataDefine.cyyj25060402, {page = "大厅", block_label = "全部已读"})
end
...
function MailView:onTouchAwardAll(send, eventType)
    ...
    XH.NewThrowDataManager:throwData(XH.NewThrowDataDefine.cyyj25060402, {page = "大厅", block_label = "一键领取"})
end
function MailView:onTouchDelSelected(send, eventType)
    ...
    self:reqDel()
    XH.NewThrowDataManager:throwData(XH.NewThrowDataDefine.cyyj25060402, {page = "大厅", block_label = "全部删除"})
end
