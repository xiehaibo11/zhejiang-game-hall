...
GameMProtocol.LeaveTemporarilyReq = {
    XY_ID = 11370,
    askID = 0,
    new = function(self, o)
        o = o or {}
...
function GameMProtocol:setGameProcessID(id)
    for _, v in pairs(GameMProtocol) do
    ...
    GameMProtocol.processid = id or 1
end
