...
local KW_SWITCH_OFF_PNG_3 = "lookAnxiously_btn_woman.png"      --女(出牌语音)
local KW_SWITCH_NO_PNG_3 = "lookAnxiously_btn_man.png"         --男 
...
function SettingView:ctor(param)
    ...
    self._switchNames = {"_yxImage", "_yyImage", "_fyImage", "_clearImage","_cpyyImage",}
...
function SettingView:getCSBPath()
    return "res/cocosStudio/LookAnxiously/GameLayer/CSB/Setting.csb"
end
