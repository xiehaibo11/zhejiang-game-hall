local GameBaseProtocol = {}

GameBaseProtocol.msgPlayerData = {
    XY_ID = 4,
    ...
    nVipID = 0, -- 得到会员, 可修改
    nBankRich = 0, -- 银行财富, 可修改, 当前未实现
    nRight = 0, -- 权利, 可修改
    nCharm = 0, -- 魅力, 可修改
    nContribution = 0, -- 贡献, 可修改
    nYuanBao = 0, -- 获取元宝, 可修改
    nFamily = 0, -- 家族, 可修改
...
GameBaseProtocol.msgPlayerDataEx = {
    XY_ID = 5,
...
GameBaseProtocol.msgPlayerEnter = {
    XY_ID = 6,
...
GameBaseProtocol.msgPlayerLeave = {
    XY_ID = 7,
...
GameBaseProtocol.msgPlayerStart = {
    XY_ID = 8,
...
GameBaseProtocol.msgPlayerTimer = {
    XY_ID = 9,
...
GameBaseProtocol.msgBaseClientForwardEx = {
...
GameBaseProtocol.msgRoomHostSeat = {
    XY_ID = 23,
...
GameBaseProtocol.msgRequestDismiss = {
    XY_ID = 26,
...
GameBaseProtocol.msgRespondDismiss = {
    XY_ID = 27,
...
GameBaseProtocol.msgDismissFlag = {
    XY_ID = 28,
...
GameBaseProtocol.msgAskContinue = {
    XY_ID = 31,
...
GameBaseProtocol.msgRespContinue = {
    XY_ID = 32,
...
GameBaseProtocol.msgContinueFlag = {
    XY_ID = 33,
...
GameBaseProtocol.msgContinueTips = {
    XY_ID = 34,
