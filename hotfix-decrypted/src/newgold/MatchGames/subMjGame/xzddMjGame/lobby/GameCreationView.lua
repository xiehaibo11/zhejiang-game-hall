...
GameCreationView.resourceFilename = "creation_options_csb/xuezhandaodiMj.csb"
...
function GameCreationView:ctor(initConfigData)
    ...
    self.mMainGameRule = g_gameConstant.GAME_PLAY_RULE_SCMJ_XZDD
end
        ...
        for i, v in pairs(wanfaItemTable) do
            if v == target then
                ...
                elseif i >= 9 and i <= 12 then
                    self:selectMostOneChoices(wanfaItemTable, i, 9, 4)
