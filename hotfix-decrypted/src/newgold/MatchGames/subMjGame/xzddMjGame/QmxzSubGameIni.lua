...
local ServerMainRule = g_gameConstant.GAME_PLAY_RULE_SCMJ_QMXZ              -- Hown 游戏类型————主玩法
local NameStr = "全民血战"                  -- Hown 创建房间选择按钮标题
...
local XZddMjIni = {
    ...
    CreationViewTable = {
        [g_gameConstant.GAME_PLAY_RULE_SCMJ_QMXZ] = "newgold.MatchGames.subMjGame.xzddMjGame.lobby.GameCreationView_qmxz",      -- Hown 对应的csb创建面板中选择解析文件
    },
        ...
        {
            {
                ...
                {g_gameConstant.GAME_SUB_RULE_MJ_QUAN_YAO_JIU_3_FAN          }, 
                ...
                {g_gameConstant.GAME_SUB_RULE_MJ_XIA_DA_YU        },   
                {g_gameConstant.GAME_SUB_RULE_MJ_JIANG_DUI               }, 
    ...
    WanfaDescTable = {
        ...
        [g_gameConstant.GAME_SUB_RULE_MJ_DUI_DUI_HU_1_FAN]                 =   {"对对胡1番", "玩家胡牌后，从剩余牌堆中依次翻6只鸟，若所抓鸟牌中，有1/5/9、红中则算中鸟，每中一鸟+1分。"},
        
        [g_gameConstant.GAME_SUB_RULE_MJ_DUI_DUI_HU_2_FAN]          =   {"对对胡2番", "玩家胡牌后，从剩余牌堆中依次翻6只鸟，若所抓鸟牌中，有1/5/9、红中则算中鸟，每中一鸟+1分。"},
        [g_gameConstant.GAME_SUB_RULE_MJ_QUAN_YAO_JIU_2_FAN]                =   {"全幺久2番", "玩家胡牌后，从剩余牌堆中依次翻6只鸟，若所抓鸟牌中，有1/5/9、红中则算中鸟，每中一鸟+1分。"},
        [g_gameConstant.GAME_SUB_RULE_MJ_QUAN_YAO_JIU_3_FAN]           =   {"全幺久3番", "玩家胡牌后，从剩余牌堆中依次翻6只鸟，若所抓鸟牌中，有1/5/9、红中则算中鸟，每中一鸟+1分。"},
        ...
        [g_gameConstant.GAME_SUB_RULE_MJ_XIA_DA_YU]                 =   {"下大雨", "玩家胡牌后，从剩余牌堆中依次翻6只鸟，若所抓鸟牌中，有1/5/9、红中则算中鸟，每中一鸟+1分。"},
        [g_gameConstant.GAME_SUB_RULE_MJ_JIANG_DUI]                 =   {"将对", "玩家胡牌后，从剩余牌堆中依次翻6只鸟，若所抓鸟牌中，有1/5/9、红中则算中鸟，每中一鸟+1分。"},
        [g_gameConstant.GAME_SUB_RULE_MJ_DA_DAN_DIAO]              =   {"大单钓", "玩家胡牌后，从剩余牌堆中依次翻6只鸟，若所抓鸟牌中，有1/5/9、红中则算中鸟，每中一鸟+1分。"},
