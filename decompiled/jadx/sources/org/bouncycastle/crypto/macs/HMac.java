...
public class HMac implements Mac {
    ...
    static {
        ...
        blockLengths.put(MessageDigestAlgorithms.SHA_1, new Integer(64));
        blockLengths.put("SHA-224", new Integer(64));
        blockLengths.put(MessageDigestAlgorithms.SHA_256, new Integer(64));
        blockLengths.put(MessageDigestAlgorithms.SHA_384, new Integer(128));
        blockLengths.put(MessageDigestAlgorithms.SHA_512, new Integer(128));
