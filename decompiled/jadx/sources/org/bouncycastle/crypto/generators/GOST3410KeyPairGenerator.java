    ...
    public AsymmetricCipherKeyPair generateKeyPair() {
        ...
        while (true) {
            ...
            if (!bigInteger.equals(ZERO) && bigInteger.compareTo(q) < 0) {
                return new AsymmetricCipherKeyPair(new GOST3410PublicKeyParameters(a2.modPow(bigInteger, p), parameters), new GOST3410PrivateKeyParameters(bigInteger, parameters));
            }
        }
    }
