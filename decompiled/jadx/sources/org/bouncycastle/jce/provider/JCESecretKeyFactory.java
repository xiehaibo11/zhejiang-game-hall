...
public class JCESecretKeyFactory extends SecretKeyFactorySpi implements PBE {
    ...
    public static class DESPBEKeyFactory extends JCESecretKeyFactory {
        ...
        protected SecretKey engineGenerateSecret(KeySpec keySpec) throws InvalidKeySpecException {
            ...
            if (cipherParametersMakePBEParameters instanceof ParametersWithIV) {
                DESParameters.setOddParity(((KeyParameter) ((ParametersWithIV) cipherParametersMakePBEParameters).getParameters()).getKey());
            } else {
                DESParameters.setOddParity(((KeyParameter) cipherParametersMakePBEParameters).getKey());
            }
            return new JCEPBEKey(this.algName, this.algOid, this.scheme, this.digest, this.keySize, this.ivSize, pBEKeySpec, cipherParametersMakePBEParameters);
        }
    }
    ...
    public static class PBEWithSHAAndIDEA extends PBEKeyFactory {
