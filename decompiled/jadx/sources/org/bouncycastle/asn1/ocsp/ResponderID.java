...
public class ResponderID extends ASN1Encodable implements ASN1Choice {
    ...
    public static ResponderID getInstance(Object obj) {
        ...
        return aSN1TaggedObject.getTagNo() == 1 ? new ResponderID(X509Name.getInstance(aSN1TaggedObject, true)) : new ResponderID(ASN1OctetString.getInstance(aSN1TaggedObject, true));
    }
