...
public class X509Store implements Store {
    ...
    public static X509Store getInstance(String str, X509StoreParameters x509StoreParameters, Provider provider) throws NoSuchStoreException, NoSuchProviderException {
        try {
