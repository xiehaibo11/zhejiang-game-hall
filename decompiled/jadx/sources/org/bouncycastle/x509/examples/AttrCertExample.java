...
public class AttrCertExample {
    ...
    public static X509Certificate createClientCert(PublicKey publicKey, PrivateKey privateKey, PublicKey publicKey2) throws Exception {
        ...
        v3CertGen.addExtension(MiscObjectIdentifiers.netscapeCertType, false, (DEREncodable) new NetscapeCertType(48));
    ...
    public static void main(String[] strArr) throws Exception {
        ...
        X509V2AttributeCertificate x509V2AttributeCertificate = (X509V2AttributeCertificate) x509V2AttributeCertificateGenerator.generateCertificate(privateKeyGeneratePrivate, "BC");
        ...
        try {
            x509V2AttributeCertificate.verify(publicKeyGeneratePublic, "BC");
        } catch (Exception e2) {
