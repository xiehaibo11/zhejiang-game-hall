...
public abstract class ECCurve {
    ...
    public static class F2m extends ECCurve {
        ...
        public F2m(int i, int i2, int i3, int i4, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
            ...
            this.f8426a = fromBigInteger(bigInteger);
        ...
        private ECPoint decompressPoint(byte[] bArr, int i) {
            ...
            if (f2m.toBigInteger().equals(ECConstants.ZERO)) {
                ...
                ECFieldElement eCFieldElementSolveQuadradicEquation = solveQuadradicEquation(f2m.add(this.f8426a).add(this.b.multiply(f2m.square().invert())));
        ...
        public boolean equals(Object obj) {
            ...
            F2m f2m = (F2m) obj;
            return this.m == f2m.m && this.k1 == f2m.k1 && this.k2 == f2m.k2 && this.k3 == f2m.k3 && this.f8426a.equals(f2m.f8426a) && this.b.equals(f2m.b);
        }
        ...
        public int hashCode() {
            return ((((this.f8426a.hashCode() ^ this.b.hashCode()) ^ this.m) ^ this.k1) ^ this.k2) ^ this.k3;
        }

        public boolean isKoblitz() {
            return (this.n == null || this.h == null || (!this.f8426a.toBigInteger().equals(ECConstants.ZERO) && !this.f8426a.toBigInteger().equals(ECConstants.ONE)) || !this.b.toBigInteger().equals(ECConstants.ONE)) ? false : true;
        }
    ...
    public static class Fp extends ECCurve {
        ...
        public Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3) {
            this.q = bigInteger;
            this.f8426a = fromBigInteger(bigInteger2);
        ...
        public ECPoint decodePoint(byte[] bArr) {
            ...
            if (b == 2 || b == 3) {
                ...
                ECFieldElement eCFieldElementSqrt = fp2.multiply(fp2.square().add(this.f8426a)).add(this.b).sqrt();
        ...
        public boolean equals(Object obj) {
            ...
            Fp fp = (Fp) obj;
            return this.q.equals(fp.q) && this.f8426a.equals(fp.f8426a) && this.b.equals(fp.b);
        }
        ...
        public int hashCode() {
            return (this.f8426a.hashCode() ^ this.b.hashCode()) ^ this.q.hashCode();
        }
    }
