...
public abstract class ECPoint {
    ...
    public static class Fp extends ECPoint {
        ...
        public ECPoint twice() {
            ...
            ECFieldElement eCFieldElementDivide = this.x.square().multiply(this.curve.fromBigInteger(BigInteger.valueOf(3L))).add(this.curve.f8426a).divide(this.y.multiply(eCFieldElementFromBigInteger));
