...
public class PEMReader extends BufferedReader {
    ...
    private KeyPair readKeyPair(String str, String str2) throws Exception {
        ...
        boolean zEquals = str.equals(d.f1221a);
    ...
    private PublicKey readRSAPublicKey(String str) throws IOException {
        ...
        try {
            return KeyFactory.getInstance(d.f1221a, this.provider).generatePublic(new RSAPublicKeySpec(rSAPublicKeyStructure.getModulus(), rSAPublicKeyStructure.getPublicExponent()));
    ...
    public Object readObject() throws IOException {
        ...
        do {
            ...
            if (line.indexOf("-----BEGIN RSA PRIVATE KEY") != -1) {
                try {
                    return readKeyPair(d.f1221a, "-----END RSA PRIVATE KEY");
                } catch (Exception e) {
