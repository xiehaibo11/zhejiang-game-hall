...
public class PhoneticEngine {
    private static /* synthetic */ int[] $SWITCH_TABLE$org$apache$commons$codec1$language$bm$NameType = null;
    ...
    static /* synthetic */ int[] $SWITCH_TABLE$org$apache$commons$codec1$language$bm$NameType() {
