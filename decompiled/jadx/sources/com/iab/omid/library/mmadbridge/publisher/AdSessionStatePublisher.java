...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.mmadbridge.weakreference.b f2387a;
    private AdEvents b;
    ...
    public AdSessionStatePublisher() {
        a();
        this.f2387a = new com.iab.omid.library.mmadbridge.weakreference.b(null);
    }
    ...
    void a(WebView webView) {
        this.f2387a = new com.iab.omid.library.mmadbridge.weakreference.b(webView);
    }
