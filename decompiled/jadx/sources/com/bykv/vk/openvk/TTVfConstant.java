...
public class TTVfConstant {
    ...
    public static final String BRANCH = "v5100";
    public static final int BUILD_IN_MODULE_VERSION_CODE = 5114;
    public static final String BUILD_IN_MODULE_VERSION_NAME = "5.1.1.4";
    ...
    public static final String C_H = "d63b5eb";
    ...
    public static final int SDK_VERSION_CODE = 5114;
    public static final String SDK_VERSION_NAME = "5.1.1.4";
    ...
    public enum RitScenes {
        ...
        GAME_MORE_KLLKRTUNITIES(TTVfConstant.df("game_more_kllkrtunities")),
