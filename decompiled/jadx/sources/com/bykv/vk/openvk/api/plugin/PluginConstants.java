...
public class PluginConstants {
    ...
    public static final String STUB_ACTIVITY = "com.bykv.vk.openvk.stub.activity.Stub_Activity";
    public static final String STUB_SINGLE_TASK_ACTIVITY = "com.bykv.vk.openvk.stub.activity.Stub_SingleTask_Activity";
    public static final String STUB_SINGLE_TASK_ACTIVITY_T = "com.bykv.vk.openvk.stub.activity.Stub_SingleTask_Activity_T";
    public static final String STUB_STANDARD_ACTIVITY = "com.bykv.vk.openvk.stub.activity.Stub_Standard_Activity";
    public static final String STUB_STANDARD_ACTIVITY_T = "com.bykv.vk.openvk.stub.activity.Stub_Standard_Activity_T";
    public static final String STUB_STANDARD_LANDSCAPE_ACTIVITY = "com.bykv.vk.openvk.stub.activity.Stub_Standard_Landscape_Activity";
    public static final String STUB_STANDARD_PORTRAIT_ACTIVITY_T = "com.bykv.vk.openvk.stub.activity.Stub_Standard_Portrait_Activity";
}
