...
public class b extends Handler {
    ...
    private static String f2521a = b.class.getName();
    ...
    private void a() {
        ...
        com.igexin.b.a.c.b.a(f2521a + "|userPresent, reConnectDelayTime = " + iRandom, new Object[0]);
        d.F = (long) iRandom;
    ...
    private void a(Intent intent) throws Throwable {
        ...
        com.igexin.b.a.c.b.a(f2521a + "|processIntentMsgService action：" + stringExtra, new Object[0]);
        ...
        if (stringExtra.equals(PushConsts.ACTION_SERVICE_ONRESUME)) {
            com.igexin.b.a.c.b.a(f2521a + "|handle onresume ~~~", new Object[0]);
        ...
        com.igexin.b.a.c.b.a(f2521a + "|intent action = " + action, new Object[0]);
        if (!TextUtils.isEmpty(action) && action.startsWith("pre_doaction.")) {
            ...
            com.igexin.b.a.c.b.a(f2521a + "|sendBroadCast，current action = " + CoreConsts.f2497a, new Object[0]);
            str = CoreConsts.f2497a;
        }
    ...
    public void handleMessage(Message message) {
        try {
            ...
            if (message.what == CoreConsts.g) {
                ...
                com.igexin.b.a.c.b.a(f2521a + "|hand execute_action taskid = " + string + ", actionid = " + string3, new Object[0]);
            ...
            com.igexin.b.a.c.b.a(f2521a + "|" + th.toString(), new Object[0]);
        }
    }
}
