...
public abstract class m {
    ...
    private void b(String str) {
        ...
        if (jSONObject.has("lastDetectTime")) {
            try {
                this.f2479a = jSONObject.getLong("lastDetectTime");
            } catch (JSONException unused2) {
            }
        }
        if (Math.abs(System.currentTimeMillis() - this.f2479a) >= f.f2473a) {
            a();
            return;
        }
    ...
    private void c(String str) {
        ...
        if (jSONObject.has("domainType")) {
            try {
                this.d.f2468a = d.a(jSONObject.getInt("domainType"));
                if (this.d.f2468a == d.BACKUP) {
                    this.d.b.set(true);
                }
    ...
    public void h() {
        this.f2479a = System.currentTimeMillis();
        synchronized (this.g) {
            for (Map.Entry<String, q> entry : this.b.entrySet()) {
                entry.getValue().a(c());
    ...
    public synchronized void i() {
        ...
        synchronized (this.g) {
            try {
                jSONObject.put("lastDetectTime", this.f2479a);
    ...
    protected boolean k() {
        long jAbs = Math.abs(System.currentTimeMillis() - this.f2479a);
        if (jAbs >= (f.f2473a * 2) - com.tkay.expressad.d.a.b.P) {
            com.igexin.b.a.c.b.a(e + "|current time - last detect time > " + (f.f2473a / 1000) + " s, detect = true", new Object[0]);
            k.f2478a.set(true);
            return true;
        }
        if (!k.f2478a.getAndSet(true)) {
            long jAbs2 = Math.abs(f.f2473a - jAbs);
            k.c_().a(jAbs2);
    ...
    protected synchronized void n() {
        ...
        try {
            ...
            jSONObject.put("domainType", this.d.f2468a.b());
        } catch (Exception unused) {
        }
        if (jSONObject.length() > 0) {
            if (q()) {
