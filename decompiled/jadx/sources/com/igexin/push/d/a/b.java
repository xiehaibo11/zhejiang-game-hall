...
public class b extends com.igexin.b.a.b.b {
    ...
    public static final String f2594a = b.class.getName();
    ...
    private e a(com.igexin.b.a.b.e eVar, d dVar, o oVar, com.igexin.push.d.c.e eVar2) throws Exception {
        ...
        if (sB > 0) {
            ...
            if (!Arrays.equals(eVar2.n, EncryptUtils.getSocketSignature(aVar, iD, iD2))) {
                com.igexin.b.a.c.b.a(f2594a + "|decode signature error!!!!", new Object[0]);
                return null;
            }
        } else if (aVar.f2596a < 0) {
            com.igexin.b.a.c.b.a(f2594a + "|data len < 0, error", new Object[0]);
            return null;
        }
        if (this.d != null) {
    ...
    public Object a(com.igexin.b.a.b.e eVar, d dVar, Object obj) {
        ...
        if (obj instanceof com.igexin.push.d.c.a) {
            ...
            if (aVar.b > 0 && aVar.f2596a > 0) {
                ...
                if ((eVarA.h & com.sigmob.sdk.archives.tar.e.H) == 16) {
                    ...
                    if ((eVarA.h & com.sigmob.sdk.archives.tar.e.H) == 48) {
                        com.igexin.b.a.c.b.a(f2594a + "|encry type = 0x30 not support", new Object[0]);
                        return null;
                    }
                    if ((eVarA.h & com.sigmob.sdk.archives.tar.e.H) != 32) {
                        com.igexin.b.a.c.b.a(f2594a + "|encry type = " + (eVarA.h & com.sigmob.sdk.archives.tar.e.H) + " not support", new Object[0]);
                        return null;
                    }
                    com.igexin.b.a.c.b.a(f2594a + "|encry type = 0x20 reserved", new Object[0]);
                }
            }
            bArr = new byte[eVarA.b + (aVar.b > 0 ? aVar.f2596a + 11 : 0)];
            ...
            if (aVar.b > 0) {
                ...
                int iB = iA4 + com.igexin.b.a.b.f.b(aVar.f2596a, bArr, iA4);
                int iC8 = iB + com.igexin.b.a.b.f.c(aVar.b, bArr, iB);
                if (aVar.f2596a > 0) {
                    com.igexin.b.a.b.f.a(aVar.e, 0, bArr, iC8, aVar.f2596a);
                }
            }
        }
        return bArr;
    ...
    public e c(com.igexin.b.a.b.e eVar, d dVar, Object obj) throws IOException {
        ...
        if (oVar == null) {
            com.igexin.b.a.c.b.a(f2594a + "|syncIns is null", new Object[0]);
            return null;
        }
        byte[] bArrA = a(oVar, 8);
        ...
        com.igexin.b.a.c.b.a(f2594a + "|server socket resp version = " + eVar2.c + ", not support !!!", new Object[0]);
        return null;
    }
}
