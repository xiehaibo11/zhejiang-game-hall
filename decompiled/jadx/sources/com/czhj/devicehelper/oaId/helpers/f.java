...
public class f {
    ...
    public String f1729a = "OUID";
    public final LinkedBlockingQueue<IBinder> c = new LinkedBlockingQueue<>(1);
    ServiceConnection d = new ServiceConnection() { // from class: com.czhj.devicehelper.oaId.helpers.f.1
    ...
    private String a(String str) {
        ...
        return ((d.a.C0069a) this.b).a(packageName, this.f, str);
    }
