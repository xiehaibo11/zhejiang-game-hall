...
public class DevicesIDsHelper {
    ...
    private static AppIdsUpdater f1719a = null;
    ...
    private static final List<String> l = new LinkedList<String>() { // from class: com.czhj.devicehelper.oaId.helpers.DevicesIDsHelper.2
        {
            add("00000000-0000-0000-0000-000000000000");
            add("00000000000000000000000000000000");
        }
    };
    private static final List<String> m = new LinkedList<String>() { // from class: com.czhj.devicehelper.oaId.helpers.DevicesIDsHelper.3
        {
            add("msaoaidsec");
    ...
    static class IdentifyListenerHandler implements InvocationHandler {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
            try {
                ...
                if (DevicesIDsHelper.f1719a != null && !TextUtils.isEmpty(DevicesIDsHelper.f)) {
                    DevicesIDsHelper.f1719a.OnIdsAvalid(DevicesIDsHelper.f);
                }
    ...
    private static void a(Context context) {
        try {
            ...
            AppIdsUpdater appIdsUpdater = f1719a;
    ...
    private static void b(Context context) {
        try {
            ...
            if (iIntValue == 1008614 || iIntValue == 1008610 || f1719a == null || TextUtils.isEmpty(f)) {
                return;
            }
            f1719a.OnIdsAvalid(f);
        } catch (Throwable th) {
            SigmobLog.e(th.getMessage());
            if (f1719a == null || TextUtils.isEmpty(f)) {
                return;
            }
            f1719a.OnIdsAvalid(f);
        }
