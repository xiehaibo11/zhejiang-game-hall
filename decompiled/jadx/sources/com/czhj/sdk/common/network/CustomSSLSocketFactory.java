...
public class CustomSSLSocketFactory extends SSLSocketFactory {
    private static final TrustManager[] b = {new X509TrustManager() { // from class: com.czhj.sdk.common.network.CustomSSLSocketFactory.1
    ...
    private SSLSocketFactory f1780a;
    ...
    private void a(Socket socket, String str) throws IOException {
        ...
        SSLSocketFactory sSLSocketFactory = this.f1780a;
    ...
    public static CustomSSLSocketFactory getDefault(int i) {
        ...
        customSSLSocketFactory.f1780a = SSLCertificateSocketFactory.getDefault(i, null);
    ...
    public static CustomSSLSocketFactory getForceValid() {
        ...
        customSSLSocketFactory.f1780a = sSLContext.getSocketFactory();
        return customSSLSocketFactory;
    }

    @Deprecated
    void a(SSLSocketFactory sSLSocketFactory) {
        this.f1780a = sSLSocketFactory;
    }
    ...
    public Socket createSocket(Socket socket, String str, int i, boolean z) throws IOException {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            Socket socketCreateSocket = this.f1780a.createSocket(socket, str, i, z);
            a(socketCreateSocket);
            return socketCreateSocket;
        }
        if (z && socket != null) {
        ...
        Socket socketCreateSocket2 = this.f1780a.createSocket(InetAddressUtils.getInetAddressByName(str), i);
