...
public class d {
    ...
    String f7792a = "RewardVideoAuto";
    TYRewardVideoAutoLoadListener b = new TYRewardVideoAutoLoadListener() { // from class: com.tkay.rewardvideo.a.d.1
        @Override // com.tkay.rewardvideo.api.TYRewardVideoAutoLoadListener
        public final void onRewardVideoAutoLoaded(final String str) {
            m.a().a(new Runnable() { // from class: com.tkay.rewardvideo.a.d.1.1
        ...
        public final void onRewardVideoAutoLoadFail(final String str, final AdError adError) {
            m.a().a(new Runnable() { // from class: com.tkay.rewardvideo.a.d.1.2
                @Override // java.lang.Runnable
                public final void run() {
                    if (d.this.d != null) {
    ...
    public final void a(Activity activity, String str, String str2, TYRewardVideoAutoEventListener tYRewardVideoAutoEventListener) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            Log.e(this.f7792a, "PlacementId is Empty!");
        }
        if (m.a().f() == null || TextUtils.isEmpty(m.a().o()) || TextUtils.isEmpty(m.a().p())) {
            ...
            Log.e(this.f7792a, "SDK init error!");
            return;
        }
        if (activity == null) {
            Log.e(this.f7792a, "RewardedVideo Show Activity is null.");
        }
