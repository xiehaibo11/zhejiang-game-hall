...
public class NativeAd {
    ...
    View.OnClickListener mDefaultCloseViewListener = new View.OnClickListener() { // from class: com.tkay.nativead.api.NativeAd.4
    ...
    protected NativeAd(Context context, String str, a aVar) {
        ...
        aVar2.setNativeEventListener(new k() { // from class: com.tkay.nativead.api.NativeAd.1
    ...
    private void renderViewToWindow(View view) {
        ...
        this.mNativeView.renderView(iHashCode, view, new ImpressionEventListener() { // from class: com.tkay.nativead.api.NativeAd.3
            @Override // com.tkay.nativead.api.NativeAd.ImpressionEventListener
    ...
    public synchronized void fillShowTrackingInfo(d dVar) {
    ...
    synchronized void recordShow(TYNativeAdView tYNativeAdView) {
        if (!this.mRecordedShow) {
            ...
            com.tkay.core.common.l.b.a.a().a(new Runnable() { // from class: com.tkay.nativead.api.NativeAd.5
    ...
    synchronized void handleImpression(final TYNativeAdView tYNativeAdView) {
        if (!this.mRecordedImpression && !this.mIsDestroyed) {
            ...
            com.tkay.core.common.l.b.a.a().a(new Runnable() { // from class: com.tkay.nativead.api.NativeAd.6
                @Override // java.lang.Runnable
                public void run() {
                    ...
                    try {
                        if (NativeAd.this.mBaseNativeAd != null) {
                            ...
                            m.a().a(new Runnable() { // from class: com.tkay.nativead.api.NativeAd.6.1
                                @Override // java.lang.Runnable
                                public final void run() {
    ...
    synchronized void handleClick(final TYNativeAdView tYNativeAdView, View view) {
        ...
        m.a().a(new Runnable() { // from class: com.tkay.nativead.api.NativeAd.7
            @Override // java.lang.Runnable
            public final void run() {
                if (NativeAd.this.mNativeEventListener != null) {
    ...
    synchronized void handleVideoStart(final TYNativeAdView tYNativeAdView) {
        ...
        m.a().a(new Runnable() { // from class: com.tkay.nativead.api.NativeAd.8
            @Override // java.lang.Runnable
            public final void run() {
                if (NativeAd.this.mNativeEventListener != null) {
    ...
    synchronized void handleAdDislikeButtonClick(final TYNativeAdView tYNativeAdView) {
        ...
        m.a().a(new Runnable() { // from class: com.tkay.nativead.api.NativeAd.9
            @Override // java.lang.Runnable
            public final void run() {
    ...
    synchronized void handleVideoEnd(final TYNativeAdView tYNativeAdView) {
        ...
        m.a().a(new Runnable() { // from class: com.tkay.nativead.api.NativeAd.10
            @Override // java.lang.Runnable
            public final void run() {
                if (NativeAd.this.mNativeEventListener != null) {
    ...
    synchronized void handleVideoProgress(final TYNativeAdView tYNativeAdView, final int i) {
        ...
        m.a().a(new Runnable() { // from class: com.tkay.nativead.api.NativeAd.2
            @Override // java.lang.Runnable
            public final void run() {
                if (NativeAd.this.mNativeEventListener != null) {
