...
public class SinglePictureSplashATView extends BaseSdkSplashATView {
    ...
    protected final void b() {
        ...
        com.tkay.core.common.res.b.a(getContext()).a(new e(1, this.d.u()), getResources().getDisplayMetrics().widthPixels, (getResources().getDisplayMetrics().widthPixels * 627) / SysfuncInterface.SYSFUNC_GET_PACKAGE_ID_SUCCESS, new b.a() { // from class: com.tkay.basead.ui.SinglePictureSplashATView.1
            ...
            public final void onSuccess(String str, final Bitmap bitmap) {
                if (TextUtils.equals(str, SinglePictureSplashATView.this.d.u())) {
                    ...
                    if (SinglePictureSplashATView.this.c.m.j() == 2) {
                        ...
                        wrapRoundImageView.post(new Runnable() { // from class: com.tkay.basead.ui.SinglePictureSplashATView.1.1
    ...
    protected final void c() {
        super.a(this.c.m.R() < 0 ? 100 : this.c.m.R(), new Runnable() { // from class: com.tkay.basead.ui.SinglePictureSplashATView.2
            @Override // java.lang.Runnable
            public final void run() {
