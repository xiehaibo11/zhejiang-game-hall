...
public class GuideToClickView extends RelativeLayout {
    ...
    private void a(Context context) {
        ...
        this.f5782a = (WaveAnimImageView) findViewById(h.a(context, "myoffer_wave_anim_image", "id"));
    ...
    protected void onAttachedToWindow() {
        ...
        startAnim(this.m, this.f5782a, 0L);
    ...
    public void startAnim(ValueAnimator valueAnimator, final WaveAnimImageView waveAnimImageView, long j) {
        if (valueAnimator != null) {
            ...
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.tkay.basead.ui.GuideToClickView.1
