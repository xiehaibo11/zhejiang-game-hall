...
public class MediaATView extends BaseMediaATView {
    ...
    public void init(int i, int i2) {
        ...
        com.tkay.core.common.res.b.a(getContext()).a(new e(1, this.f5735a.u()), i, i2, new b.a() { // from class: com.tkay.basead.ui.MediaATView.1
            @Override // com.tkay.core.common.res.b.a
            public final void onSuccess(String str, final Bitmap bitmap) {
                if (TextUtils.equals(MediaATView.this.f5735a.u(), str)) {
                    MediaATView.this.q.setImageBitmap(bitmap);
                    MediaATView.this.post(new Runnable() { // from class: com.tkay.basead.ui.MediaATView.1.1
        ...
        if (!TextUtils.isEmpty(this.f5735a.v())) {
            com.tkay.core.common.res.b.a(getContext()).a(new e(1, this.f5735a.v()), new b.a() { // from class: com.tkay.basead.ui.MediaATView.2
                @Override // com.tkay.core.common.res.b.a
                public final void onSuccess(String str, Bitmap bitmap) {
                    if (TextUtils.equals(MediaATView.this.f5735a.v(), str)) {
        ...
        String strS = this.f5735a.s();
        if (!TextUtils.isEmpty(strS)) {
            this.t.setText(strS);
        } else {
            this.t.setVisibility(8);
        }
        if (!TextUtils.isEmpty(this.f5735a.t())) {
            this.s.setRadiusInDip(6);
            this.s.setNeedRadiu(true);
            ViewGroup.LayoutParams layoutParams2 = this.s.getLayoutParams();
            com.tkay.core.common.res.b.a(getContext()).a(new e(1, this.f5735a.t()), layoutParams2.width, layoutParams2.height, new b.a() { // from class: com.tkay.basead.ui.MediaATView.3
                @Override // com.tkay.core.common.res.b.a
                public final void onFail(String str, String str2) {
                }
                ...
                @Override // com.tkay.core.common.res.b.a
                public final void onSuccess(String str, Bitmap bitmap) {
                    if (TextUtils.equals(MediaATView.this.f5735a.t(), str)) {
        ...
        if (this.f5735a.K()) {
            ...
            if (relativeLayout != null) {
                ...
                this.h.setOnClickListener(new View.OnClickListener() { // from class: com.tkay.basead.ui.MediaATView.4
            ...
            if (textView != null) {
                ...
                this.i.setText(this.f5735a.F());
                this.i.setOnClickListener(new View.OnClickListener() { // from class: com.tkay.basead.ui.MediaATView.5
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                    }
                });
            ...
            if (textView2 != null) {
                ...
                this.j.setOnClickListener(new View.OnClickListener() { // from class: com.tkay.basead.ui.MediaATView.6
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        l.a(m.a().f(), MediaATView.this.f5735a.H());
                    }
                });
            }
            ...
            if (textView3 != null) {
                ...
                this.k.setOnClickListener(new View.OnClickListener() { // from class: com.tkay.basead.ui.MediaATView.7
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        l.a(m.a().f(), MediaATView.this.f5735a.I());
                    }
                });
            }
            ...
            if (textView4 != null) {
                ...
                this.l.setText(getContext().getResources().getString(com.tkay.core.common.l.h.a(getContext(), "myoffer_panel_version", com.tkay.expressad.foundation.h.i.g), this.f5735a.G()));
                this.l.setOnClickListener(new View.OnClickListener() { // from class: com.tkay.basead.ui.MediaATView.8
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                    }
                });
        ...
        if (com.tkay.basead.a.e.a(this.f5735a) || (viewFindViewById = findViewById(com.tkay.core.common.l.h.a(getContext(), "myoffer_media_ad_main_image_container", "id"))) == null) {
            return;
        }
