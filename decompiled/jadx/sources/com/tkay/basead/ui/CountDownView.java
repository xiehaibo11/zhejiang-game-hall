...
public class CountDownView extends View {
    ...
    public CountDownView(Context context, AttributeSet attributeSet) {
        ...
        this.f5775a.setStrokeCap(Paint.Cap.ROUND);
        this.f5775a.setStyle(Paint.Style.STROKE);
        this.f5775a.setStrokeWidth(this.d);
        Paint paint2 = new Paint(this.f5775a);
        this.b = paint2;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.f5775a.setColor(this.g);
        canvas.drawArc(this.l, 0.0f, 360.0f, false, this.f5775a);
        this.f5775a.setColor(this.h);
        canvas.drawArc(this.l, -90.0f, this.m, false, this.f5775a);
