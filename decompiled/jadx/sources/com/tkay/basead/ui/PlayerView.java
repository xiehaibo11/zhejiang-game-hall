...
public class PlayerView extends RelativeLayout {
    ...
    public PlayerView(Context context, AttributeSet attributeSet) {
        ...
        this.M = 0L;
        setSaveEnabled(true);
        this.B = new Handler(Looper.getMainLooper()) { // from class: com.tkay.basead.ui.PlayerView.1
            ...
            public final void handleMessage(Message message) {
                ...
                if (!PlayerView.this.H || PlayerView.this.n < PlayerView.this.f5816a || PlayerView.this.A == null) {
                    return;
                }
    ...
    static class b extends View.BaseSavedState {
        public static final Parcelable.Creator<b> CREATOR = new Parcelable.Creator<b>() { // from class: com.tkay.basead.ui.PlayerView.b.1
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void j() throws InterruptedException {
        Handler handler;
        while (this.v) {
            if (!this.x && isPlaying() && (handler = this.B) != null) {
                ...
                if (SystemClock.elapsedRealtime() - this.M > 5000) {
                    if (this.A != null) {
                        m.a().a(new Runnable() { // from class: com.tkay.basead.ui.PlayerView.2
    ...
    public void load(String str, boolean z) {
        ...
        setOnClickListener(new $$Lambda$PlayerView$4s3xspIf8SMNa8DRmWjbBihJyo(this));
    }
    ...
    /* JADX INFO: renamed from: com.tkay.basead.ui.PlayerView$3, reason: invalid class name */
    final class AnonymousClass3 extends w.a {
        AnonymousClass3() {
        }

        @Override // com.tkay.expressad.exoplayer.w.a, com.tkay.expressad.exoplayer.w.c
        ...
        public final void onPlayerStateChanged(boolean z, int i) {
            ...
            if (!PlayerView.this.y) {
                ...
                if (PlayerView.this.c <= 0 || PlayerView.this.c >= 100) {
                    ...
                    PlayerView.this.f5816a = Math.round(((r6.b * 1.0f) / 100.0f) * PlayerView.this.o);
                    PlayerView.this.f5816a += BaseResp.CODE_ERROR_PARAMS;
    ...
    /* JADX INFO: renamed from: com.tkay.basead.ui.PlayerView$4, reason: invalid class name */
    final class AnonymousClass4 implements com.tkay.expressad.exoplayer.l.g {
        @Override // com.tkay.expressad.exoplayer.l.g
        public final void a() {
        }
    ...
    */
    private void a(java.lang.String r8, boolean r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tkay.basead.ui.PlayerView.a(java.lang.String, boolean):void");
    }
