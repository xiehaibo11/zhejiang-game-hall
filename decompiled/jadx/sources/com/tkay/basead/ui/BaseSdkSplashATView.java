...
public abstract class BaseSdkSplashATView extends BaseSplashATView {
    ...
    public BaseSdkSplashATView(Context context) {
        super(context);
        this.z = new View.OnClickListener() { // from class: com.tkay.basead.ui.BaseSdkSplashATView.1
    ...
    protected void o() {
        ...
        if (this.d.K()) {
            ...
            if (textView2 != null) {
                ...
                this.w.setOnClickListener(new View.OnClickListener() { // from class: com.tkay.basead.ui.BaseSdkSplashATView.2
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
            ...
            if (textView3 != null) {
                ...
                this.x.setOnClickListener(new View.OnClickListener() { // from class: com.tkay.basead.ui.BaseSdkSplashATView.3
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
        ...
        if (!TextUtils.isEmpty(this.d.v())) {
            ...
            com.tkay.core.common.res.b.a(getContext()).a(new e(1, this.d.v()), i, i, new b.a() { // from class: com.tkay.basead.ui.BaseSdkSplashATView.4
    ...
    @Override // com.tkay.basead.ui.BaseSplashATView, com.tkay.basead.ui.BaseATView, android.view.ViewGroup, android.view.View
