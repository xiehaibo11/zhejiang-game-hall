...
public class f {
    ...
    final String f5573a = f.class.getSimpleName();
    private String b;
    private String c;
    private String d;
    private int e;
    ...
    public f(String str, final h hVar, j jVar) {
        ...
        this.h.a(new a.AbstractC0425a() { // from class: com.tkay.basead.a.b.f.1
        ...
        this.h.k = new a.b() { // from class: com.tkay.basead.a.b.f.2
            @Override // com.tkay.core.common.res.a.a.b
