...
public class e extends c {
    ...
    /* JADX INFO: renamed from: com.tkay.basead.f.e$2, reason: invalid class name */
    final class AnonymousClass2 implements c.b {
        ...
        @Override // com.tkay.basead.a.c.b
        public final void a() {
            if (e.this.f5687a != null) {
                e.this.f5687a.onAdClick(this.f5689a);
            }
        }
        ...
        public final void a(boolean z) {
            if (e.this.f5687a != null) {
                e.this.f5687a.onDeeplinkCallback(z);
            }
        }
    }
    ...
    private void b(View view) {
        ...
        this.q = true;
        this.p = new com.tkay.basead.a.a(view, this.d, new AnonymousClass3());
    }

    /* JADX INFO: renamed from: com.tkay.basead.f.e$3, reason: invalid class name */
    final class AnonymousClass3 implements a.InterfaceC0383a {
        AnonymousClass3() {
        }
    ...
    public e(Context context, com.tkay.core.common.f.i iVar, String str, boolean z) {
        ...
        this.o = new View.OnClickListener() { // from class: com.tkay.basead.f.e.1
    ...
    private void c(View view) {
        this.m = view;
        com.tkay.core.common.l.a.a aVar = new com.tkay.core.common.l.a.a() { // from class: com.tkay.basead.f.e.4
    ...
    public void p() {
        ...
        com.tkay.basead.e.a aVar = this.f5687a;
        if (aVar != null) {
            aVar.onAdShow();
        }
        n();
    ...
    static /* synthetic */ void a(e eVar, int i) {
        ...
        eVar.l.a(eVar.new AnonymousClass2(i));
