...
public class TYSplashAd {
    ...
    public void loadAd(int i) {
        ...
        a.a().a(new AnonymousClass1(i));
    }

    /* JADX INFO: renamed from: com.tkay.splashad.api.TYSplashAd$1, reason: invalid class name */
    class AnonymousClass1 implements Runnable {
        ...
        public void run() {
            ...
            if (this.val$loadType == 0) {
                c05071 = new C05071();
                c05071.startCountDown(i);
            }
            C05071 c050712 = c05071;
            c cVar = TYSplashAd.this.mAdLoadManager;
            if (activity == null) {
                activity = TYSplashAd.this.mContext;
            }
            cVar.a(activity, TYSplashAd.this.mDefaultRequestInfo, TYSplashAd.this.mDefaultAdSourceConfig, c050712, i, this.val$loadType, TYSplashAd.this.mAdSourceEventListener, TYSplashAd.this.mTKExtraMap);
        }

        /* JADX INFO: renamed from: com.tkay.splashad.api.TYSplashAd$1$1, reason: invalid class name and collision with other inner class name */
        class C05071 extends com.tkay.splashad.a.b {
            ...
            public void onAdLoaded(String str, final boolean z) {
                m.a().a(new Runnable() { // from class: com.tkay.splashad.api.TYSplashAd.1.1.1
                    @Override // java.lang.Runnable
                    public final void run() {
                        if (TYSplashAd.this.mListener != null) {
                            TYSplashAd.this.mListener.onAdLoaded(!C05071.this.hasCacheWhenTimeout && z);
                        }
                    }
                });
            }
            ...
            public void onNoAdError(String str, final AdError adError) {
                m.a().a(new Runnable() { // from class: com.tkay.splashad.api.TYSplashAd.1.1.2
                    @Override // java.lang.Runnable
                    public final void run() {
                        if (TYSplashAd.this.mListener != null) {
            ...
            public void onTimeout(String str) {
                ...
                m.a().a(new Runnable() { // from class: com.tkay.splashad.api.TYSplashAd.1.1.3
                    @Override // java.lang.Runnable
                    public final void run() {
                        if (TYSplashAd.this.mListener != null) {
        ...
        if (viewGroup == null) {
            ...
            this.mAdLoadManager.a(activity, viewGroup, new com.tkay.splashad.a.a() { // from class: com.tkay.splashad.api.TYSplashAd.2
                ...
                public void onDeeplinkCallback(final TYAdInfo tYAdInfo, final boolean z) {
                    m.a().a(new Runnable() { // from class: com.tkay.splashad.api.TYSplashAd.2.1
                        @Override // java.lang.Runnable
                        public final void run() {
                ...
                public void onDownloadConfirm(final Context context, final TYAdInfo tYAdInfo, final TYNetworkConfirmInfo tYNetworkConfirmInfo) {
                    m.a().a(new Runnable() { // from class: com.tkay.splashad.api.TYSplashAd.2.2
                        @Override // java.lang.Runnable
                        public final void run() {
                            if (TYSplashAd.this.mListener == null || !(TYSplashAd.this.mListener instanceof TYSplashExListener)) {
                                return;
                ...
                public void onAdShow(final TYAdInfo tYAdInfo) {
                    m.a().a(new Runnable() { // from class: com.tkay.splashad.api.TYSplashAd.2.3
                        @Override // java.lang.Runnable
                        public final void run() {
                            if (TYSplashAd.this.mListener != null) {
                ...
                public void onAdClick(final TYAdInfo tYAdInfo) {
                    m.a().a(new Runnable() { // from class: com.tkay.splashad.api.TYSplashAd.2.4
                        @Override // java.lang.Runnable
                        public final void run() {
                            if (TYSplashAd.this.mListener != null) {
                ...
                public void onAdDismiss(final TYAdInfo tYAdInfo, final TYSplashAdExtraInfo tYSplashAdExtraInfo) {
                    m.a().a(new Runnable() { // from class: com.tkay.splashad.api.TYSplashAd.2.5
                        @Override // java.lang.Runnable
                        public final void run() {
                            if (TYSplashAd.this.mListener != null) {
