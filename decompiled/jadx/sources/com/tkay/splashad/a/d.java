...
public final class d {
    ...
    /* JADX INFO: renamed from: com.tkay.splashad.a.d$1, reason: invalid class name */
    ...
    /* JADX INFO: renamed from: com.tkay.splashad.a.d$2, reason: invalid class name */
    final class AnonymousClass2 implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ CustomSplashAdapter f7807a;
        final /* synthetic */ AdError b;

        AnonymousClass2(CustomSplashAdapter customSplashAdapter, AdError adError) {
            this.f7807a = customSplashAdapter;
            this.b = adError;
        }

        @Override // java.lang.Runnable
        public final void run() {
            CustomSplashAdapter customSplashAdapter = this.f7807a;
            if (customSplashAdapter != null) {
    ...
    private class a implements TYCustomLoadListener {
        ...
        public a(CustomSplashAdapter customSplashAdapter) {
            this.f7808a = customSplashAdapter;
        }

        @Override // com.tkay.core.api.TYCustomLoadListener
        public final void onAdCacheLoaded(BaseAd... baseAdArr) {
            d.this.a(this.f7808a, baseAdArr);
        }

        @Override // com.tkay.core.api.TYCustomLoadListener
        public final void onAdLoadError(String str, String str2) {
            d.this.a(this.f7808a, ErrorCode.getErrorCode(ErrorCode.noADError, str, str2));
        }
    }
