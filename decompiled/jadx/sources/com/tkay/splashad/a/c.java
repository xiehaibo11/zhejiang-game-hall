...
public class c extends com.tkay.core.common.f<g> {
    ...
    @Override // com.tkay.core.common.f
    public final /* synthetic */ boolean a(String str, String str2, j jVar, com.tkay.core.common.b.a aVar) {
        g gVar = (g) jVar;
    ...
    public final synchronized void a(final Activity activity, final ViewGroup viewGroup, final a aVar, final TYEventInterface tYEventInterface, final TYSplashSkipInfo tYSplashSkipInfo, final String str, final Map<String, Object> map) {
        ...
        if (aVarA != null && (aVarA.e() instanceof CustomSplashAdapter)) {
            ...
            f();
            aVarA.a(aVarA.d() + 1);
            if (this.f7799a != null && this.f7799a.d == aVarA) {
                this.f7799a.d = null;
            }
            com.tkay.core.common.l.b.a.a().a(new Runnable() { // from class: com.tkay.splashad.a.c.1
                ...
                public final void run() {
                    ...
                    m.a().a(new Runnable() { // from class: com.tkay.splashad.a.c.1.1
                        @Override // java.lang.Runnable
                        public final void run() {
                            ...
                            if (z) {
                                ...
                                if (zIsSupportCustomSkipView) {
                                    tYSplashSkipInfo.getSkipView().setOnClickListener(new View.OnClickListener() { // from class: com.tkay.splashad.a.c.1.1.1
    ...
    private void a(Activity activity, ViewGroup viewGroup, f fVar, boolean z, BaseAd baseAd, com.tkay.core.common.f.d dVar) {
        ...
        if (baseAd != 0 && (baseAd instanceof com.tkay.core.common.f.a.e)) {
            ...
            i.a().a(strA, baseAd);
            ThirdPartySplashATView thirdPartySplashATView = new ThirdPartySplashATView(activity.getApplicationContext(), cVar, bVar, new AnonymousClass3(fVar), strA);
    ...
    /* JADX INFO: renamed from: com.tkay.splashad.a.c$2, reason: invalid class name */
    ...
    /* JADX INFO: renamed from: com.tkay.splashad.a.c$3, reason: invalid class name */
    final class AnonymousClass3 implements com.tkay.basead.e.a {
        ...
        public final void onAdClosed() {
            this.f7804a.onSplashAdDismiss();
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    static /* synthetic */ void a(c cVar, Activity activity, ViewGroup viewGroup, f fVar, boolean z, BaseAd baseAd, com.tkay.core.common.f.d dVar) {
        ViewGroup customAdContainer;
        if (baseAd != 0 && (baseAd instanceof com.tkay.core.common.f.a.e)) {
            com.tkay.core.common.f.a.b bVar = new com.tkay.core.common.f.a.b((com.tkay.core.common.f.a.e) baseAd);
            ...
            i.a().a(strA, baseAd);
            ThirdPartySplashATView thirdPartySplashATView = new ThirdPartySplashATView(activity.getApplicationContext(), cVar2, bVar, cVar.new AnonymousClass3(fVar), strA);
            thirdPartySplashATView.setDontCountDown(z);
            if (baseAd.getCustomAdContainer() != null) {
                customAdContainer = baseAd.getCustomAdContainer();
                customAdContainer.addView(thirdPartySplashATView);
