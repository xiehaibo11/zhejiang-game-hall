...
public final class c implements CustomAdapterDownloadListener {
    ...
    private void a() {
        ...
        if (baseAd != null) {
            ...
            this.c = i.a(this.f5932a);
        }
    }

    private void a(final int i, final long j, final String str) {
        com.tkay.core.common.l.b.a.a().a(new Runnable() { // from class: com.tkay.china.common.c.1
            @Override // java.lang.Runnable
            public final void run() {
                try {
                    e eVar = new e();
                    eVar.b = c.this.b != null ? c.this.b.getDetail() : c.this.f5932a.getTrackingInfo();
                    eVar.f6153a = i;
