...
public class OnlineApiTYRewardedVideoAdapter extends CustomRewardVideoAdapter {
    ...
    public void show(Activity activity) {
        ...
        this.b.a(new g() { // from class: com.tkay.network.onlineapi.OnlineApiTYRewardedVideoAdapter.1
    ...
    public void loadCustomNetworkAd(Context context, Map<String, Object> map, Map<String, Object> map2) {
        a(context, map);
        this.b.a(new com.tkay.basead.e.c() { // from class: com.tkay.network.onlineapi.OnlineApiTYRewardedVideoAdapter.2
    ...
    private void a(Context context, Map<String, Object> map) {
        ...
        this.f7673a = (i) map.get(f.k.f6060a);
        com.tkay.basead.d.f fVar = new com.tkay.basead.d.f(context, b.a.ONLINE_API_OFFER_REQUEST_TYPE, this.f7673a);
        this.b = fVar;
