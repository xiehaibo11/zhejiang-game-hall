...
public class MintegralTYInitManager extends TYInitMediation {
    ...
    public synchronized void initSDK(Context context, final Map<String, Object> map, final MediationInitCallback mediationInitCallback) {
        ...
        try {
            this.f7625a = TYSDK.getPersionalizedAdStatus();
        } catch (Throwable unused) {
        }
        this.f.post(new Runnable() { // from class: com.tkay.network.mintegral.MintegralTYInitManager.1
    ...
    /* JADX INFO: renamed from: com.tkay.network.mintegral.MintegralTYInitManager$2, reason: invalid class name */
    ...
    static /* synthetic */ void a(MintegralTYInitManager mintegralTYInitManager, MBridgeSDK mBridgeSDK) {
        boolean z = mintegralTYInitManager.f7625a == 2;
        mBridgeSDK.setDoNotTrackStatus(z);
        if (TYSDK.isNetworkLogDebug()) {
            Log.i(TAG, "setDoNotTrackStatus:".concat(String.valueOf(z)));
        }
    ...
    static /* synthetic */ void a(MintegralTYInitManager mintegralTYInitManager, Context context) {
        if (context instanceof Application) {
            ((Application) context).registerActivityLifecycleCallbacks(mintegralTYInitManager.new AnonymousClass2());
        }
    }
}
