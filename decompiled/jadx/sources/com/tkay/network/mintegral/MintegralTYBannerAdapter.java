...
public class MintegralTYBannerAdapter extends CustomBannerAdapter {
    ...
    private void a(Context context, Map<String, Object> map) {
        byte b;
        int iDip2px;
        this.f7620a = new MBBannerView(context);
        String str = this.d;
        int i = 3;
        switch (str.hashCode()) {
            case -559799608:
            ...
            case 109549001:
                ...
                break;
            case 1507809730:
                b = !str.equals(j.f6157a) ? (byte) -1 : (byte) 3;
                break;
            case 1507809854:
        ...
        this.f7620a.init(new BannerSize(i, 0, 0), this.c, this.b);
        MBBannerView mBBannerView = this.f7620a;
        if (iDip2px > 0) {
            iDip2px = dip2px(context, iDip2px);
        }
        mBBannerView.setLayoutParams(new ViewGroup.LayoutParams(-1, iDip2px));
        this.f7620a.setBannerAdListener(new AnonymousClass1());
        int i2 = this.f;
        if (i2 > 0) {
            this.f7620a.setRefreshTime(i2);
        } else {
            this.f7620a.setRefreshTime(0);
        }
        if (!TextUtils.isEmpty(this.e)) {
            MintegralTYInitManager.getInstance().setCustomInfo(7, map);
            this.f7620a.loadFromBid(this.e);
        } else {
    ...
    /* JADX INFO: renamed from: com.tkay.network.mintegral.MintegralTYBannerAdapter$1, reason: invalid class name */
    final class AnonymousClass1 implements BannerAdListener {
        ...
        public final void onLogImpression(MBridgeIds mBridgeIds) {
            try {
                MintegralTYInitManager.getInstance().a(MintegralTYBannerAdapter.this.getTrackingInfo().l(), new WeakReference(MintegralTYBannerAdapter.this.f7620a));
    ...
    public void loadCustomNetworkAd(Context context, final Map<String, Object> map, Map<String, Object> map2) {
        ...
        MintegralTYInitManager.getInstance().initSDK(applicationContext, map, new MediationInitCallback() { // from class: com.tkay.network.mintegral.MintegralTYBannerAdapter.2
    ...
    /* JADX WARN: Failed to restore switch over string. Please report as a decompilation issue */
    static /* synthetic */ void a(MintegralTYBannerAdapter mintegralTYBannerAdapter, Context context, Map map) {
        byte b;
        int iDip2px;
        mintegralTYBannerAdapter.f7620a = new MBBannerView(context);
        ...
        mintegralTYBannerAdapter.f7620a.init(new BannerSize(i, 0, 0), mintegralTYBannerAdapter.c, mintegralTYBannerAdapter.b);
        MBBannerView mBBannerView = mintegralTYBannerAdapter.f7620a;
        if (iDip2px > 0) {
            iDip2px = dip2px(context, iDip2px);
        }
        mBBannerView.setLayoutParams(new ViewGroup.LayoutParams(-1, iDip2px));
        mintegralTYBannerAdapter.f7620a.setBannerAdListener(mintegralTYBannerAdapter.new AnonymousClass1());
        int i2 = mintegralTYBannerAdapter.f;
        if (i2 > 0) {
            mintegralTYBannerAdapter.f7620a.setRefreshTime(i2);
        } else {
            mintegralTYBannerAdapter.f7620a.setRefreshTime(0);
        }
        if (!TextUtils.isEmpty(mintegralTYBannerAdapter.e)) {
            MintegralTYInitManager.getInstance().setCustomInfo(7, map);
            mintegralTYBannerAdapter.f7620a.loadFromBid(mintegralTYBannerAdapter.e);
        } else {
            MintegralTYInitManager.getInstance().setCustomInfo(8, map);
            mintegralTYBannerAdapter.f7620a.load();
        }
    }
}
