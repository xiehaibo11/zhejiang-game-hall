...
public class AdxBidRequestInfo extends TYBidRequestInfo {
    ...
    public void fillBannerData(Map<String, Object> map) {
        try {
            ...
            this.f7525a.put(TYAdConst.NETWORK_REQUEST_PARAMS_KEY.AD_WIDTH, i);
            this.f7525a.put(TYAdConst.NETWORK_REQUEST_PARAMS_KEY.AD_HEIGHT, i2);
            this.f7525a.put(TYAdConst.NETWORK_REQUEST_PARAMS_KEY.ADP_ACCEPT_TYPE, new JSONArray(TYAdConst.AD_SUPPORT_TYPE_ARRAY));
        } catch (Throwable unused) {
        }
    }
    ...
    public void fillSplashData() {
        try {
            this.f7525a.put(TYAdConst.NETWORK_REQUEST_PARAMS_KEY.GET_OFFER, 2);
            fillAdAcceptType();
        } catch (Throwable unused) {
        }
    }
        ...
        try {
            if (map.containsKey("unit_type")) {
                ...
                if (!TextUtils.isEmpty(stringFromMap)) {
                    this.f7525a.put("unit_type", Integer.parseInt(stringFromMap));
                }
