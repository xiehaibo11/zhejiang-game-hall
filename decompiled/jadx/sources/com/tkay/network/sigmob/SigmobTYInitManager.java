...
public class SigmobTYInitManager extends TYInitMediation {
    ...
    final void a(Context context, final Map<String, Object> map, final Map<String, Object> map2, final TYBidRequestInfoListener tYBidRequestInfoListener) {
        getInstance().initSDK(context, map, new MediationInitCallback() { // from class: com.tkay.network.sigmob.SigmobTYInitManager.1
            @Override // com.tkay.core.api.MediationInitCallback
            public final void onSuccess() {
                SigmobTYInitManager.this.runOnThreadPool(new Runnable() { // from class: com.tkay.network.sigmob.SigmobTYInitManager.1.1
