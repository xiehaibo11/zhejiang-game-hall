...
public class SigmobTYNativeAd extends CustomNativeAd {
    ...
    protected SigmobTYNativeAd(Context context, WindNativeAdData windNativeAdData, WindNativeUnifiedAd windNativeUnifiedAd) {
        ...
        if (windNativeAdData.getAdPatternType() == 1) {
            ...
            this.f7693a = new FrameLayout(this.h);
            return;
        }
    ...
    public void prepare(View view, TYNativePrepareInfo tYNativePrepareInfo) {
        ...
        if (this.i != null) {
            ...
            this.i.bindViewForInteraction(view, list, arrayList, tYNativePrepareInfo.getCloseView(), new NativeADEventListener() { // from class: com.tkay.network.sigmob.SigmobTYNativeAd.1
            ...
            if (this.i.getAdPatternType() == 1) {
                this.i.bindMediaView(this.f7693a, new WindNativeAdData.NativeADMediaListener() { // from class: com.tkay.network.sigmob.SigmobTYNativeAd.2
            ...
            bindDislikeListener(new View.OnClickListener() { // from class: com.tkay.network.sigmob.SigmobTYNativeAd.3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                }
            });
            this.i.setDislikeInteractionCallback((Activity) view.getContext(), new WindNativeAdData.DislikeInteractionCallback() { // from class: com.tkay.network.sigmob.SigmobTYNativeAd.4
