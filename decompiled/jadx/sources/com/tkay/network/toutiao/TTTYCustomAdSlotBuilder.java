...
public class TTTYCustomAdSlotBuilder extends VfSlot.Builder {
    ...
    private final String f7730a = getClass().getSimpleName();
        ...
        try {
            if (map.containsKey(f.k.k)) {
                ...
                if (TYSDK.isNetworkLogDebug()) {
                    Log.i(this.f7730a, "adLoadSeq: ".concat(String.valueOf(iIntValue)));
                }
        ...
        try {
            if (map.containsKey(f.k.l)) {
                ...
                if (!TextUtils.isEmpty(strOptString)) {
                    if (TYSDK.isNetworkLogDebug()) {
                        Log.i(this.f7730a, "primeRit: ".concat(String.valueOf(strOptString)));
                    }
