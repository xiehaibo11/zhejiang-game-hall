...
public class b {
    ...
    String f7509a = "InterstitialAuto";
    TYInterstitialAutoLoadListener b = new TYInterstitialAutoLoadListener() { // from class: com.tkay.interstitial.a.b.1
        ...
        public final void onInterstitialAutoLoaded(final String str) {
            m.a().a(new Runnable() { // from class: com.tkay.interstitial.a.b.1.1
        ...
        public final void onInterstitialAutoLoadFail(final String str, final AdError adError) {
            m.a().a(new Runnable() { // from class: com.tkay.interstitial.a.b.1.2
                @Override // java.lang.Runnable
                public final void run() {
                    if (b.this.d != null) {
    ...
    public final void a(Activity activity, String str, String str2, TYInterstitialAutoEventListener tYInterstitialAutoEventListener) {
        ...
        if (TextUtils.isEmpty(str)) {
            Log.e(this.f7509a, "PlacementId is Empty!");
            return;
        }
        if (m.a().f() == null || TextUtils.isEmpty(m.a().o()) || TextUtils.isEmpty(m.a().p())) {
            Log.e(this.f7509a, "Show error: SDK init error!");
            return;
        }
        if (activity == null) {
            Log.e(this.f7509a, "Interstitial Show Activity is null.");
        }
    ...
    private TYAdStatusInfo d(String str) {
        if (m.a().f() == null || TextUtils.isEmpty(m.a().o()) || TextUtils.isEmpty(m.a().p())) {
            Log.e(this.f7509a, "SDK init error!");
            return null;
        }
        a aVarA = a.a(m.a().D(), str);
        if (aVarA != null) {
