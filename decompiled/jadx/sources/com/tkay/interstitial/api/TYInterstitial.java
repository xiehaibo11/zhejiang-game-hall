...
public class TYInterstitial {
    ...
    private TYInterstitialExListener mInterListener = new TYInterstitialExListener() { // from class: com.tkay.interstitial.api.TYInterstitial.1
        ...
        public void onDeeplinkCallback(final TYAdInfo tYAdInfo, final boolean z) {
            m.a().a(new Runnable() { // from class: com.tkay.interstitial.api.TYInterstitial.1.1
        ...
        public void onDownloadConfirm(final Context context, final TYAdInfo tYAdInfo, final TYNetworkConfirmInfo tYNetworkConfirmInfo) {
            m.a().a(new Runnable() { // from class: com.tkay.interstitial.api.TYInterstitial.1.2
                @Override // java.lang.Runnable
                public final void run() {
                    if (TYInterstitial.this.mInterstitialListener == null || !(TYInterstitial.this.mInterstitialListener instanceof TYInterstitialExListener)) {
                        return;
        ...
        public void onInterstitialAdVideoStart(final TYAdInfo tYAdInfo) {
            m.a().a(new Runnable() { // from class: com.tkay.interstitial.api.TYInterstitial.1.3
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void onInterstitialAdVideoEnd(final TYAdInfo tYAdInfo) {
            m.a().a(new Runnable() { // from class: com.tkay.interstitial.api.TYInterstitial.1.4
                @Override // java.lang.Runnable
                public final void run() {
                    if (TYInterstitial.this.mInterstitialListener != null) {
        ...
        public void onInterstitialAdVideoError(final AdError adError) {
            m.a().a(new Runnable() { // from class: com.tkay.interstitial.api.TYInterstitial.1.5
                @Override // java.lang.Runnable
                public final void run() {
                    if (TYInterstitial.this.mInterstitialListener != null) {
        ...
        public void onInterstitialAdClose(final TYAdInfo tYAdInfo) {
            m.a().a(new Runnable() { // from class: com.tkay.interstitial.api.TYInterstitial.1.6
                @Override // java.lang.Runnable
                public final void run() {
                    if (TYInterstitial.this.mInterstitialListener != null) {
        ...
        public void onInterstitialAdClicked(final TYAdInfo tYAdInfo) {
            m.a().a(new Runnable() { // from class: com.tkay.interstitial.api.TYInterstitial.1.7
                @Override // java.lang.Runnable
                public final void run() {
                    if (TYInterstitial.this.mInterstitialListener != null) {
        ...
        public void onInterstitialAdShow(final TYAdInfo tYAdInfo) {
            m.a().a(new Runnable() { // from class: com.tkay.interstitial.api.TYInterstitial.1.8
                @Override // java.lang.Runnable
                public final void run() {
                    if (TYInterstitial.this.mInterstitialListener != null) {
    ...
    com.tkay.core.common.b.a adLoadListener = new com.tkay.core.common.b.a() { // from class: com.tkay.interstitial.api.TYInterstitial.2
        @Override // com.tkay.core.common.b.a
        public void onAdLoaded() {
            m.a().a(new Runnable() { // from class: com.tkay.interstitial.api.TYInterstitial.2.1
                @Override // java.lang.Runnable
                public final void run() {
                    if (TYInterstitial.this.mInterstitialListener != null) {
        ...
        public void onAdLoadFail(final AdError adError) {
            m.a().a(new Runnable() { // from class: com.tkay.interstitial.api.TYInterstitial.2.2
                @Override // java.lang.Runnable
                public final void run() {
                    if (TYInterstitial.this.mInterstitialListener != null) {
