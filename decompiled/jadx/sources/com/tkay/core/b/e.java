...
public final class e extends a {
    ...
    protected final void a(final com.tkay.core.b.b.a aVar) {
        ...
        if (mediationBidManagerB == null) {
            Log.i(n.f6248a, "No BidManager.");
            a((List<aj>) null, -9);
        } else {
            mediationBidManagerB.setBidRequestUrl(this.f5950a.p);
            mediationBidManagerB.startBid(this.f5950a, new MediationBidManager.BidListener() { // from class: com.tkay.core.b.e.1
    ...
    public synchronized void a(List<aj> list, int i) {
        ...
        Iterator<aj> it = this.f5950a.j.iterator();
        while (true) {
            boolean z = false;
            if (!it.hasNext()) {
                break;
