...
public final class c {
    ...
    ConcurrentHashMap<String, l> f5958a = new ConcurrentHashMap<>();
    ...
    public final l a(aj ajVar) {
        l lVarA = this.f5958a.get(ajVar.t());
