...
public class c {
    ...
    public static String f6093a = c.class.getSimpleName();
    ...
    public final void a(String str, long j, AdError adError) {
        if (TextUtils.equals(adError.getCode(), ErrorCode.noADError)) {
            ...
            aVar.f6094a = adError.getPlatformCode();
            aVar.b = j;
            this.d.put(str, aVar);
        }
    }
    ...
    public final boolean a(int i, com.tkay.core.c.d dVar, aj ajVar) {
        ...
        return (map == null || (l = map.get(aVar.f6094a)) == null || aVar.b + l.longValue() < System.currentTimeMillis()) ? false : true;
    }
}
