...
public class w {
    ...
    private boolean c(String str) {
        ...
        if (boolValueOf == null) {
            boolValueOf = Boolean.valueOf(com.tkay.core.common.l.p.c(this.f6321a, com.tkay.core.common.b.f.E, str));
            if (boolValueOf.booleanValue()) {
                StringBuilder sb = new StringBuilder("checkFirstLoadAfterInstall: ");
                sb.append(str);
                sb.append(",  update to false");
                com.tkay.core.common.l.p.b(this.f6321a, com.tkay.core.common.b.f.E, str);
            }
