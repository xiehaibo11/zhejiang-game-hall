...
public class d {
    ...
    public static final String f6261a = d.class.getSimpleName();
    String b;
    aj c;
    ...
    public final void b() {
        ...
        AnonymousClass1 anonymousClass1 = new AnonymousClass1(tYBaseAdAdapterA, this.c, k());
        if (TextUtils.equals(String.valueOf(this.o.e.Y()), "2")) {
            m.a().a(anonymousClass1);
        } else {
            com.tkay.core.common.l.b.a.a().b(anonymousClass1);
        }
    }
    ...
    private void a(TYBaseAdAdapter tYBaseAdAdapter, aj ajVar) {
        AnonymousClass1 anonymousClass1 = new AnonymousClass1(tYBaseAdAdapter, ajVar, k());
        if (TextUtils.equals(String.valueOf(this.o.e.Y()), "2")) {
            m.a().a(anonymousClass1);
        } else {
            com.tkay.core.common.l.b.a.a().b(anonymousClass1);
    ...
    /* JADX INFO: renamed from: com.tkay.core.common.m.d$1, reason: invalid class name */
    final class AnonymousClass1 implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ TYBaseAdAdapter f6262a;
        final /* synthetic */ aj b;
        final /* synthetic */ Map c;

        AnonymousClass1(TYBaseAdAdapter tYBaseAdAdapter, aj ajVar, Map map) {
            this.f6262a = tYBaseAdAdapter;
            this.b = ajVar;
            this.c = map;
        }
        ...
        public final void run() {
            ...
            if (contextA == null) {
                if (d.this.h != null) {
                    ...
                    d.this.a(this.f6262a, aVar);
                    return;
                }
                return;
            }
            d.a(d.this, contextA, this.b, this.f6262a);
            try {
                Map<String, Object> mapB = d.b(d.this);
                d.this.g = this.f6262a;
                this.f6262a.internalLoad(contextA, this.c, mapB, new a(d.this, d.this, this.f6262a, b));
                com.tkay.core.common.f.d trackingInfo = this.f6262a.getTrackingInfo();
                trackingInfo.g(this.f6262a.getNetworkPlacementId());
                if (d.this.h != null) {
    ...
    private void a(Context context, aj ajVar, TYBaseAdAdapter tYBaseAdAdapter) {
        if (com.tkay.core.c.a.an()) {
            p pVarA = p.a(m.a().f());
            try {
                if (pVarA.c(ajVar.c()) || !tYBaseAdAdapter.setUserDataConsent(context, pVarA.c(), TYSDK.isEUTraffic(this.o.f6260a))) {
                    return;
                }
                pVarA.b(ajVar.c());
            } catch (Throwable th) {
    ...
    private Map<String, Object> k() {
        ...
        int iC = this.c.c();
        if (iC == 2) {
            com.tkay.core.c.a aVarB = com.tkay.core.c.b.a(this.o.f6260a).b(m.a().o());
            if (aVarB != null) {
                mapA.put(f.k.p, Boolean.valueOf(aVarB.j() == 1));
            }
            mapA.put(f.k.s, Integer.valueOf(dVar.a()));
        } else if (iC == 6) {
            JSONObject jSONObjectA = com.tkay.core.common.l.g.a(this.o.f6260a, str, this.b, dVar.Y(), this.f);
            if (dVar.aw() == 1) {
                mapA.put("tp_info", jSONObjectA.toString());
            }
        }
        if (t.a(this.c) && this.o.e.ar() == 1) {
            ad adVarA = com.tkay.core.a.a.a(this.o.f6260a).a(this.b);
    ...
    private Context m() {
        ...
        if (TYSDK.isNetworkLogDebug()) {
            Log.d(f6261a, "requestContext = ".concat(String.valueOf(contextD)));
        }
        return contextD;
    }
    ...
    private Runnable p() {
        return new Runnable() { // from class: com.tkay.core.common.m.d.2
            @Override // java.lang.Runnable
            public final void run() {
                com.tkay.core.common.l.b.a.a().a(new Runnable() { // from class: com.tkay.core.common.m.d.2.1
                    @Override // java.lang.Runnable
                    public final void run() {
                        d.this.o();
                    }
    ...
    public class a implements TYCustomLoadListener {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        TYBaseAdAdapter f6266a;
        d b;

        /* synthetic */ a(d dVar, d dVar2, TYBaseAdAdapter tYBaseAdAdapter, byte b) {
            this(dVar2, tYBaseAdAdapter);
        }

        private a(d dVar, TYBaseAdAdapter tYBaseAdAdapter) {
            this.b = dVar;
            this.f6266a = tYBaseAdAdapter;
        }

        @Override // com.tkay.core.api.TYCustomLoadListener
        public final void onAdDataLoaded() {
            com.tkay.core.common.l.b.a.a().a(new Runnable() { // from class: com.tkay.core.common.m.d.a.1
                @Override // java.lang.Runnable
                public final void run() {
                    synchronized (a.this) {
                        if (a.this.b != null && a.this.f6266a != null) {
                            a.this.b.q();
                        }
                    }
                }
        ...
        public final void onAdCacheLoaded(final BaseAd... baseAdArr) {
            com.tkay.core.common.l.b.a.a().a(new Runnable() { // from class: com.tkay.core.common.m.d.a.2
                @Override // java.lang.Runnable
                public final void run() {
                    synchronized (a.this) {
                        if (a.this.b != null && a.this.f6266a != null) {
                            a.this.b.a(a.this.f6266a, baseAdArr);
                            a.this.b = null;
                            a.this.f6266a = null;
                        }
                    }
        ...
        public final void onAdLoadError(final String str, final String str2) {
            com.tkay.core.common.l.b.a.a().a(new Runnable() { // from class: com.tkay.core.common.m.d.a.3
                @Override // java.lang.Runnable
                public final void run() {
                    synchronized (a.this) {
                        if (a.this.b != null && a.this.f6266a != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void a(TYBaseAdAdapter tYBaseAdAdapter, BaseAd... baseAdArr) {
        if (n()) {
            return;
        }
    ...
    public final synchronized void a(final TYBaseAdAdapter tYBaseAdAdapter, com.tkay.core.common.m.a aVar) {
        ...
        if (tYBaseAdAdapter != null) {
            m.a().a(new Runnable() { // from class: com.tkay.core.common.m.d.3
                @Override // java.lang.Runnable
                public final void run() {
                    try {
                        if (tYBaseAdAdapter != null) {
    ...
    static /* synthetic */ void a(d dVar, Context context, aj ajVar, TYBaseAdAdapter tYBaseAdAdapter) {
        if (com.tkay.core.c.a.an()) {
            p pVarA = p.a(m.a().f());
            try {
                if (pVarA.c(ajVar.c()) || !tYBaseAdAdapter.setUserDataConsent(context, pVarA.c(), TYSDK.isEUTraffic(dVar.o.f6260a))) {
                    return;
                }
                pVarA.b(ajVar.c());
            } catch (Throwable th) {
