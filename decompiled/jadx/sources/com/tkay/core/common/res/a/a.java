...
public class a extends com.tkay.core.common.res.image.b {
    ...
    public a(String str) {
        super(str);
        this.f6294a = a.class.getSimpleName();
        this.m = 0;
        this.n = 1;
        this.l = -1;
    ...
    public final synchronized void a(com.tkay.core.common.res.a.b bVar) {
        ...
        sb.append(bVar.f6295a);
        sb.append(",mVideoCtnType:");
        sb.append(bVar.c);
        if (this.b.f6295a < bVar.f6295a) {
            this.b.f6295a = bVar.f6295a;
        }
        if (this.b.c != 1) {
            this.b.c = bVar.c;
        }
    ...
    public final synchronized void a(AbstractC0425a abstractC0425a) {
        if (!this.j.contains(abstractC0425a)) {
            this.j.add(abstractC0425a);
        }
    }
    ...
    private synchronized void a(int i, long j) {
        ...
        Iterator<AbstractC0425a> it = this.j.iterator();
        boolean z = false;
        while (it.hasNext()) {
