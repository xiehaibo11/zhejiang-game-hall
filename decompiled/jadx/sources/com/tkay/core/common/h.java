...
public abstract class h {
    ...
    protected Runnable M = new Runnable() { // from class: com.tkay.core.common.h.1
        @Override // java.lang.Runnable
        public final void run() {
            com.tkay.core.common.l.b.a.a().b(new Runnable() { // from class: com.tkay.core.common.h.1.1
                @Override // java.lang.Runnable
                public final void run() {
                    h.this.a();
                }
    ...
    protected Context f6172a = com.tkay.core.common.b.m.a().f();
    ...
    public synchronized void j() {
        ...
        com.tkay.core.common.f.a aVarA = com.tkay.core.common.a.a().a(this.f6172a, this.g);
        this.s = true;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void a(List<aj> list, int i) {
    ...
    public synchronized void l() {
        ...
        if ((this.m && this.B >= this.e.an() && dA >= dS) || this.K.c() || this.K.b()) {
            ...
            k();
            if (this.L.d() == 0) {
                com.tkay.core.common.m.f.a(this.f6172a, this.g);
                q();
            }
        }
        p();
    ...
    */
    public final void a(java.util.List<com.tkay.core.common.f.aj> r13, java.util.List<com.tkay.core.common.f.aj> r14, java.util.List<com.tkay.core.common.f.aj> r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tkay.core.common.h.a(java.util.List, java.util.List, java.util.List):void");
    }
    ...
    /* JADX INFO: renamed from: com.tkay.core.common.h$2, reason: invalid class name */
    final class AnonymousClass2 implements Runnable {
        ...
        public final void run() {
            h.this.I = null;
            com.tkay.core.common.l.b.a.a().a(new Runnable() { // from class: com.tkay.core.common.h.2.1
                @Override // java.lang.Runnable
                public final void run() {
                    h.this.j();
                }
    ...
    /* JADX INFO: renamed from: com.tkay.core.common.h$3, reason: invalid class name */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void b(final aj ajVar, final int i) {
        final com.tkay.core.common.m.d dVar = new com.tkay.core.common.m.d(ajVar, i);
        final String strA = dVar.a();
        this.G.put(strA, dVar);
        this.L.a(1, i);
        com.tkay.core.common.l.b.a.a().b(new Runnable() { // from class: com.tkay.core.common.h.4
            @Override // java.lang.Runnable
            public final void run() {
                String string;
                synchronized (h.this) {
    ...
    /* JADX INFO: renamed from: com.tkay.core.common.h$5, reason: invalid class name */
    final class AnonymousClass5 implements com.tkay.core.common.m.b {
        AnonymousClass5() {
        }

        @Override // com.tkay.core.common.m.b
        public final void a(com.tkay.core.common.f.d dVar) {
            com.tkay.core.common.k.a.a(h.this.f6172a).a(1, dVar);
            com.tkay.core.common.l.g.a(dVar, f.i.f6058a, f.i.n, "");
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void a(String str, TYBaseAdAdapter tYBaseAdAdapter, aj ajVar) {
    ...
    */
    public final synchronized void a(java.lang.String r12, com.tkay.core.api.TYBaseAdAdapter r13, java.util.List<? extends com.tkay.core.api.BaseAd> r14) {
        ...
        L4c:
            ...
            android.content.Context r2 = r11.f6172a     // Catch: java.lang.Throwable -> Lc4
            ...
            r3 = r0
            r5 = r13
            r3.<init>(r5, r6, r8)     // Catch: java.lang.Throwable -> Lc4
        ...
        Lc4:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tkay.core.common.h.a(java.lang.String, com.tkay.core.api.TYBaseAdAdapter, java.util.List):void");
    }
    ...
    */
    private synchronized void p() {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tkay.core.common.h.p():void");
    }
    ...
    private void a(com.tkay.core.common.m.d dVar, TYBaseAdAdapter tYBaseAdAdapter, aj ajVar, com.tkay.core.common.f.d dVar2) {
        ...
        com.tkay.core.common.m.f.a(this.f6172a, this.g, this.f, ajVar, null);
    }
    ...
    public final void b(int i) {
        ...
        com.tkay.core.common.k.a.a(this.f6172a).a(12, dVarA);
        v vVarA = v.a();
        String str5 = this.g;
        StringBuilder sb2 = new StringBuilder();
        sb2.append(this.e.Y());
    ...
    private synchronized boolean v() {
        if (this.R != null && this.R.size() != 0) {
            ...
            this.R.clear();
            a(8, arrayList, new k.a() { // from class: com.tkay.core.common.h.6
                ...
                public final void a(String str, List<aj> list, List<aj> list2) {
                    ...
                    for (aj ajVar : list) {
                        com.tkay.core.common.m.f.a(h.this.f6172a, h.this.g, h.this.f, null, ajVar);
                        ajVar.x(8);
                        h.this.u.add(ajVar);
                        h.this.b(ajVar, 3);
                    }
    ...
    private synchronized void w() {
        if (this.m) {
            ...
            if (this.H != null && this.H.size() != 0) {
                ...
                this.q = true;
                a(7, this.H, new k.a() { // from class: com.tkay.core.common.h.7
                    @Override // com.tkay.core.common.k.a
                    public final void a(String str) {
                    }
                    ...
                    public final void a(String str, List<aj> list, List<aj> list2) {
                        ...
                        for (aj ajVar2 : arrayList) {
                            com.tkay.core.common.m.f.a(h.this.f6172a, h.this.g, h.this.f, null, ajVar2);
                            ajVar2.x(7);
                            h.this.u.add(ajVar2);
                            h.this.b(ajVar2, 5);
                        }
    ...
    private void a(int i, List<aj> list, final k.a aVar) {
        ...
        hVar.a(new k.a() { // from class: com.tkay.core.common.h.8
            @Override // com.tkay.core.common.k.a
    ...
    protected synchronized void a(String str, com.tkay.core.common.m.a aVar) {
        ...
        com.tkay.core.common.k.c.a(dVar, aVar.f6259a, adError, j);
        if (j > 0) {
            if (this.l != null) {
    ...
    private void z() {
        if (com.tkay.core.common.a.a().a(this.f6172a, this.g) != null) {
            b(9);
        } else {
            if (v()) {
                return;
    ...
    */
    private synchronized boolean B() {
        ...
        L16:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tkay.core.common.h.B():boolean");
    }
    ...
    public void h() {
        ...
        w.a(this.f6172a).a(this.g, this.f, true);
        j jVar = this.j;
    ...
    public void a(AdError adError) {
        ...
        w.a(this.f6172a).a(this.g, this.f, false);
        j jVar = this.j;
        if (jVar == null || jVar.f == null) {
            return;
        }
    ...
    static /* synthetic */ void a(h hVar, com.tkay.core.common.m.d dVar, com.tkay.core.common.f.d dVar2) {
        com.tkay.core.common.m.c cVar = new com.tkay.core.common.m.c();
        cVar.f6260a = hVar.f6172a;
        cVar.b = hVar.b;
        cVar.c = hVar.f;
        cVar.d = hVar.g;
        cVar.e = hVar.e;
    ...
    static /* synthetic */ void a(h hVar, com.tkay.core.common.f.d dVar) {
