...
public final class p {
    ...
    public final void a(Context context) {
        this.m = context;
        com.tkay.core.common.l.b.a.a().a(new Runnable() { // from class: com.tkay.core.common.p.1
    ...
    private void f() {
        ...
        try {
            this.f6281a = new AnonymousClass2();
            ...
            this.m.registerReceiver(this.f6281a, intentFilter);
        } catch (Throwable unused) {
        }
    }

    /* JADX INFO: renamed from: com.tkay.core.common.p$2, reason: invalid class name */
    ...
    private void b(Context context) {
        BroadcastReceiver broadcastReceiver = this.f6281a;
    ...
    static /* synthetic */ void b(p pVar) {
        ...
        try {
            pVar.f6281a = pVar.new AnonymousClass2();
            IntentFilter intentFilter = new IntentFilter();
            intentFilter.addAction(com.tkay.core.common.l.c.b(b));
            intentFilter.addAction(com.tkay.core.common.l.c.b(c));
            intentFilter.addAction(com.tkay.core.common.l.c.b(d));
            pVar.m.registerReceiver(pVar.f6281a, intentFilter);
        } catch (Throwable unused) {
        }
    }
}
