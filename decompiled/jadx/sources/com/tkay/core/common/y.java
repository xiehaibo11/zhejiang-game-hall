...
public class y {
    ...
    private void a() {
        if (this.f6325a == null) {
            this.f6325a = new ConcurrentHashMap(5);
            try {
                ...
                if (mapA != null) {
                    for (Map.Entry<String, ?> entry : mapA.entrySet()) {
                        ...
                        if (value instanceof String) {
                            this.f6325a.put(key, am.a((String) value));
                        }
                    }
                }
    ...
    public final void a(String str, String str2, am.a aVar, am.a aVar2) {
        ...
        if (amVar == null) {
            synchronized (this) {
                amVar = this.f6325a.get(str);
                if (amVar == null) {
                    amVar = new am();
                    amVar.b(str2);
                    this.f6325a.put(str, amVar);
                }
            }
        }
