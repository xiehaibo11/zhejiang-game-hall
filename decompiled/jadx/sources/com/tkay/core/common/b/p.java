...
public class p {
    ...
    public final void a(final Context context, final TYGDPRAuthCallback tYGDPRAuthCallback) {
        m.a().a(new Runnable() { // from class: com.tkay.core.common.b.p.1
    ...
    public final void a(final NetTrafficeCallback netTrafficeCallback) {
        ...
        if (iB == -100) {
            new com.tkay.core.common.h.j().a(0, new com.tkay.core.common.h.k() { // from class: com.tkay.core.common.b.p.2
    ...
    public final void b(final int i) {
        com.tkay.core.common.l.b.a.a().a(new Runnable() { // from class: com.tkay.core.common.b.p.3
            @Override // java.lang.Runnable
            public final void run() {
                if (p.this.c(i)) {
                    return;
