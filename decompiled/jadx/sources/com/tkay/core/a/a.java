...
public final class a {
    ...
    private a(Context context) {
        this.f5939a = l.a(com.tkay.core.common.c.c.a(context));
        this.d = context;
    }

    public final void a() {
        com.tkay.core.common.l.b.a.a().a(new Runnable() { // from class: com.tkay.core.a.a.1
            @Override // java.lang.Runnable
            public final void run() {
                a.this.f5939a.a(a.this.b.format(new Date(System.currentTimeMillis())));
            }
        });
    }
    ...
    public final boolean a(d dVar, String str) {
        ...
        ad adVarA = this.f5939a.a(str, this.b.format(new Date(jCurrentTimeMillis)), this.c.format(new Date(jCurrentTimeMillis)));
    ...
    public final boolean a(String str, aj ajVar) {
        ...
        long jCurrentTimeMillis = System.currentTimeMillis();
        ad.a aVarA = this.f5939a.a(str, ajVar.t(), this.b.format(new Date(jCurrentTimeMillis)), this.c.format(new Date(jCurrentTimeMillis)));
        if (aVarA == null) {
            aVarA = new ad.a();
        }
    ...
    public final ad a(String str) {
        long jCurrentTimeMillis = System.currentTimeMillis();
        return this.f5939a.a(str, this.b.format(new Date(jCurrentTimeMillis)), this.c.format(new Date(jCurrentTimeMillis)));
    }

    public final ad.a a(String str, String str2) {
        long jCurrentTimeMillis = System.currentTimeMillis();
        return this.f5939a.a(str, str2, this.b.format(new Date(jCurrentTimeMillis)), this.c.format(new Date(jCurrentTimeMillis)));
    }

    public final Map<String, ad> a(int i) {
        long jCurrentTimeMillis = System.currentTimeMillis();
        return this.f5939a.a(i, this.b.format(new Date(jCurrentTimeMillis)), this.c.format(new Date(jCurrentTimeMillis)));
    }
