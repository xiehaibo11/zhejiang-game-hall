...
public class e {
    ...
    public static final String f6005a = e.class.getSimpleName();
    ...
    public final void a(final d dVar, final String str, final String str2, final String str3, final Map<String, Object> map, final a aVar) {
        m.a().a(new Runnable() { // from class: com.tkay.core.c.e.1
            ...
            public final void run() {
                ...
                if (dVar != null) {
                    if ((!mapD.equals(r0.N())) || dVar.az() || s.a().c(e.this.c, str3)) {
                        String str4 = e.f6005a;
                        final boolean[] zArr = new boolean[1];
                        long jZ = dVar.Z();
                        final CountDownTimer countDownTimer = new CountDownTimer(jZ, jZ) { // from class: com.tkay.core.c.e.1.1
                        ...
                        new l(e.this.c, str, str2, str3, strQ, mapD, map).a(0, new k() { // from class: com.tkay.core.c.e.1.2
                            ...
                            public final void onLoadFinish(int i, Object obj) {
                                ...
                                m.a().a(new Runnable() { // from class: com.tkay.core.c.e.1.2.1
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        String str7 = e.f6005a;
                            ...
                            public final void onLoadError(int i, String str6, AdError adError) {
                                ...
                                m.a().a(new Runnable() { // from class: com.tkay.core.c.e.1.2.2
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        String str10 = e.f6005a;
                                        if (countDownTimer != null) {
                                            countDownTimer.cancel();
                                        }
                                    }
                ...
                new l(e.this.c, str, str2, str3, strQ, mapD, map).a(0, new k() { // from class: com.tkay.core.c.e.1.3
                    @Override // com.tkay.core.common.h.k
                    public final void onLoadStart(int i) {
                    }
