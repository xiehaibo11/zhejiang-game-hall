...
public class b {
    ...
    public static final String f5998a = b.class.getSimpleName();
    ...
    public final synchronized com.tkay.core.c.a b(String str) {
        ...
        if (d == null) {
            try {
                ...
                List<af> listA = com.tkay.core.common.c.d.a(com.tkay.core.common.c.c.a(this.e)).a(str, f.o.f6064a);
    ...
    private static com.tkay.core.c.a a(Context context, String str) {
        af afVar;
        List<af> listA = com.tkay.core.common.c.d.a(com.tkay.core.common.c.c.a(context)).a(str, f.o.f6064a);
        com.tkay.core.c.a aVarF = null;
        if (listA != null && listA.size() > 0 && (afVar = listA.get(0)) != null && (aVarF = com.tkay.core.c.a.f(afVar.d())) != null) {
            aVarF.a(Long.parseLong(afVar.a()));
        }
    ...
    private static com.tkay.core.c.a a(Context context, String str, String str2) {
        com.tkay.core.common.c.d.a(com.tkay.core.common.c.c.a(context)).a(str, str2, f.o.f6064a);
    ...
    public final synchronized void a(final String str, String str2) {
        ...
        this.f = true;
        new com.tkay.core.common.h.d(this.e, str, str2).a(0, new k() { // from class: com.tkay.core.c.b.1
    ...
    public final void b() {
        ...
        new g(context, strO, strP).a(0, new k() { // from class: com.tkay.core.c.b.2
            @Override // com.tkay.core.common.h.k
            public final void onLoadStart(int i) {
            }
    ...
    private void a(Context context, Object obj, String str) {
        if (obj != null) {
            ...
            if (aVarA != null) {
                ...
                com.tkay.core.common.l.b.a.a().a(new AnonymousClass3());
    ...
    /* JADX INFO: renamed from: com.tkay.core.c.b$3, reason: invalid class name */
    ...
    static /* synthetic */ void a(b bVar, Context context, Object obj, String str) {
        if (obj != null) {
            ...
            if (aVarA != null) {
                ...
                com.tkay.core.common.l.b.a.a().a(bVar.new AnonymousClass3());
                com.tkay.core.common.c.a().a(d.b());
            }
            bVar.e();
        }
