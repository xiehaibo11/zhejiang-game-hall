...
public class d {
    ...
    private final String f6003a = "Placement";
    private int aA;
    private int aB;
    private int aC;
    private int aD;
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public static final String f6004a = "hb_bid_timeout";
        ...
        try {
            ...
            if (!jSONObject.isNull("tp_ps")) {
                try {
                    ...
                    ahVar.f6140a = jSONObjectOptJSONObject.optInt("pucs") == 1;
            ...
            if (!jSONObject.isNull(com.tkay.core.common.h.l.f6197a)) {
                JSONObject jSONObject2 = new JSONObject(jSONObject.optString(com.tkay.core.common.h.l.f6197a));
            ...
            if (jSONObject.isNull(a.f6004a)) {
                dVar.M = com.heytap.mcssdk.constant.a.q;
            } else {
                dVar.M = jSONObject.optLong(a.f6004a);
            }
