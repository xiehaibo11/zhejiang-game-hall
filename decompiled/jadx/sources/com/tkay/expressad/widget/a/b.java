...
public final class b extends Dialog {
    ...
    private static final String f7498a = "TYAlertDialog";
    private c b;
    private TextView c;
    private TextView d;
    private Button e;
    ...
    public b(Context context, final c cVar) {
        ...
        if (button != null) {
            button.setOnClickListener(new View.OnClickListener() { // from class: com.tkay.expressad.widget.a.b.1
        ...
        if (button2 != null) {
            button2.setOnClickListener(new View.OnClickListener() { // from class: com.tkay.expressad.widget.a.b.2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    c cVar2 = cVar;
                    if (cVar2 != null) {
