...
public class ATRotationView extends FrameLayout {
    ...
    public ATRotationView(Context context) {
        ...
        this.o = false;
        this.p = false;
        this.f7254a = new Runnable() { // from class: com.tkay.expressad.video.dynview.widget.ATRotationView.1
    ...
    public void setAutoscroll(boolean z) {
        if (z) {
            postDelayed(this.f7254a, 1000 / this.g);
        }
        this.n = z;
    }
    ...
    static /* synthetic */ void a(ATRotationView aTRotationView) {
        ...
        if (aTRotationView.getChildCount() != 0) {
            ...
            if (aTRotationView.n) {
                aTRotationView.postDelayed(aTRotationView.f7254a, 1000 / aTRotationView.g);
            }
        }
    }
}
