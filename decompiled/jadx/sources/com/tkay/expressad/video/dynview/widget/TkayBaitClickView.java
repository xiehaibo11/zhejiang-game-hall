...
public class TkayBaitClickView extends RelativeLayout {
    ...
    private static final String f7269a = "MBridgeAnimationClickView";
    ...
    public void init() {
        try {
            ...
            if (TextUtils.isEmpty(this.f)) {
                ...
                b.a(m.a().f()).a(this.e, new c() { // from class: com.tkay.expressad.video.dynview.widget.TkayBaitClickView.1
            ...
            if (TextUtils.isEmpty(this.e)) {
                ...
                b.a(m.a().f()).a(this.e, new c() { // from class: com.tkay.expressad.video.dynview.widget.TkayBaitClickView.2
                    @Override // com.tkay.expressad.foundation.g.d.c
                    public final void a(Bitmap bitmap, String str) {
                        if (bitmap.isRecycled()) {
                            return;
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.video.dynview.widget.TkayBaitClickView$3, reason: invalid class name */
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.video.dynview.widget.TkayBaitClickView$4, reason: invalid class name */
    final class AnonymousClass4 implements Animation.AnimationListener {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ AnimationSet f7273a;
        ...
        AnonymousClass4(AnimationSet animationSet) {
            this.f7273a = animationSet;
        }

        @Override // android.view.animation.Animation.AnimationListener
        public final void onAnimationStart(Animation animation) {
            TkayBaitClickView.this.postDelayed(new Runnable() { // from class: com.tkay.expressad.video.dynview.widget.TkayBaitClickView.4.1
                @Override // java.lang.Runnable
                public final void run() {
                    if (TkayBaitClickView.this.c != null) {
                        TkayBaitClickView.this.c.startAnimation(AnonymousClass4.this.f7273a);
                    }
                }
            }, 550L);
        }
        ...
        @Override // android.view.animation.Animation.AnimationListener
        public final void onAnimationEnd(Animation animation) {
            TkayBaitClickView.this.postDelayed(new Runnable() { // from class: com.tkay.expressad.video.dynview.widget.TkayBaitClickView.4.2
                @Override // java.lang.Runnable
                public final void run() {
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.video.dynview.widget.TkayBaitClickView$5, reason: invalid class name */
    final class AnonymousClass5 implements Animation.AnimationListener {
        ...
        @Override // android.view.animation.Animation.AnimationListener
        public final void onAnimationEnd(Animation animation) {
            TkayBaitClickView.this.postDelayed(new Runnable() { // from class: com.tkay.expressad.video.dynview.widget.TkayBaitClickView.5.1
                @Override // java.lang.Runnable
                public final void run() {
                    if (TkayBaitClickView.this.b != null) {
                        TkayBaitClickView.this.b.startAnimation(TkayBaitClickView.this.j);
