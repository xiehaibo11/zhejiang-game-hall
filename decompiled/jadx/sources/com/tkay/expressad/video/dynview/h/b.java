...
public final class b {
    ...
    public final void d(final View view) {
        if (view != null) {
            view.setAlpha(1.0f);
            view.animate().alpha(0.0f).setDuration(500L).setListener(new Animator.AnimatorListener() { // from class: com.tkay.expressad.video.dynview.h.b.1
    ...
    private void a(final View view, int i, int i2, long j) {
        ...
        duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.tkay.expressad.video.dynview.h.b.2
    ...
    private void a(final View view, int i, int i2, int i3, int i4, long j) {
        ...
        valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.tkay.expressad.video.dynview.h.b.3
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                View view2 = view;
                if (view2 != null) {
        ...
        valueAnimatorOfInt2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.tkay.expressad.video.dynview.h.b.4
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                View view2 = view;
                if (view2 != null) {
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.video.dynview.h.b$5, reason: invalid class name */
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.video.dynview.h.b$6, reason: invalid class name */
    final class AnonymousClass6 implements ValueAnimator.AnimatorUpdateListener {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ View f7232a;
        ...
        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            this.f7232a.setScaleX(((Float) valueAnimator.getAnimatedValue()).floatValue());
            this.f7232a.setScaleY(((Float) valueAnimator.getAnimatedValue()).floatValue());
        }
    }
