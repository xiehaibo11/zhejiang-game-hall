...
public final class c {
    ...
    public static final int f7167a = -999;
    ...
    private static class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static c f7170a = new c(0);
    ...
    public final void a(final Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            Rect rect2 = new Rect(f7167a, f7167a, f7167a, f7167a);
            if (jSONObjectOptJSONObject2 != null) {
                Rect rect3 = new Rect(jSONObjectOptJSONObject2.optInt(TtmlNode.LEFT, f7167a), jSONObjectOptJSONObject2.optInt("top", f7167a), jSONObjectOptJSONObject2.optInt(TtmlNode.RIGHT, f7167a), jSONObjectOptJSONObject2.optInt("bottom", f7167a));
            ...
            new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: com.tkay.expressad.video.bt.a.c.1
    ...
    public final void b(final Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: com.tkay.expressad.video.bt.a.c.2
                @Override // java.lang.Runnable
                public final void run() {
                    String rid;
                    WindVaneWebView windVaneWebView;
    ...
    public final void g(Object obj, JSONObject jSONObject) {
        try {
            ...
            LinkedHashMap<String, View> linkedHashMapB = b(strOptString, strH);
            Rect rect = new Rect(jSONObjectOptJSONObject2.optInt(TtmlNode.LEFT, f7167a), jSONObjectOptJSONObject2.optInt("top", f7167a), jSONObjectOptJSONObject2.optInt(TtmlNode.RIGHT, f7167a), jSONObjectOptJSONObject2.optInt("bottom", f7167a));
    ...
    private static ViewGroup.LayoutParams a(ViewGroup.LayoutParams layoutParams, Rect rect, int i2, int i3) {
        if (rect == null) {
            rect = new Rect(f7167a, f7167a, f7167a, f7167a);
        }
                ...
                if (viewGroup != null && view != null) {
                    ...
                    if (view instanceof TYTempContainer) {
                        ...
                        if (jSONObjectOptJSONObject2 == null) {
                            ...
                            Rect rect2 = new Rect(jSONObjectOptJSONObject2.optInt(TtmlNode.LEFT, f7167a), jSONObjectOptJSONObject2.optInt("top", f7167a), jSONObjectOptJSONObject2.optInt(TtmlNode.RIGHT, f7167a), jSONObjectOptJSONObject2.optInt("bottom", f7167a));
    ...
    public final void w(Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            Rect rect = new Rect(f7167a, f7167a, f7167a, f7167a);
            if (jSONObjectOptJSONObject3 != null) {
                Rect rect2 = new Rect(jSONObjectOptJSONObject3.optInt(TtmlNode.LEFT, f7167a), jSONObjectOptJSONObject3.optInt("top", f7167a), jSONObjectOptJSONObject3.optInt(TtmlNode.RIGHT, f7167a), jSONObjectOptJSONObject3.optInt("bottom", f7167a));
    ...
    public final void M(Object obj, JSONObject jSONObject) {
        try {
            com.tkay.expressad.atsignalcommon.windvane.a aVar = (com.tkay.expressad.atsignalcommon.windvane.a) obj;
            String rid = aVar.f6439a != null ? aVar.f6439a.getRid() : "";
            String strOptString = jSONObject.optString("unitId");
    ...
    private static void a(String str, String str2, String str3) {
        try {
            LinkedHashMap<String, View> linkedHashMapB = a.f7170a.b(str, str2);
            if (linkedHashMapB == null || linkedHashMapB.size() <= 0) {
                return;
            }
            for (View view : linkedHashMapB.values()) {
