...
public abstract class BTBaseView extends FrameLayout {
    ...
    public int findID(String str) {
        return i.a(this.f7171a.getApplicationContext(), str, "id");
    }

    public int findLayout(String str) {
        return i.a(this.f7171a.getApplicationContext(), str, "layout");
    }

    public int findColor(String str) {
        return i.a(this.f7171a.getApplicationContext(), str, "color");
    }

    public int findDrawable(String str) {
        return i.a(this.f7171a.getApplicationContext(), str, i.c);
    }
    ...
    public boolean isLandscape() {
        return this.f7171a.getResources().getConfiguration().orientation == 2;
    }
    ...
    protected final JSONObject a(int i) {
        ...
        try {
            jSONObject.put(a.cc, t.a(b.b().d(), this.i));
            jSONObject.put(a.cd, t.a(b.b().d(), this.j));
    ...
    protected static void a(WebView webView, String str, String str2) {
        try {
            ...
            com.tkay.expressad.video.bt.a.c.a(webView, e.getMessage());
            e.getMessage();
        }
    }
}
