...
public abstract class TkayBaseView extends RelativeLayout {
    ...
    public int findID(String str) {
        return i.a(this.f7279a.getApplicationContext(), str, "id");
    }
    ...
    public int findLayout(String str) {
        return i.a(this.f7279a.getApplicationContext(), str, "layout");
    }

    public int findColor(String str) {
        return i.a(this.f7279a.getApplicationContext(), str, "color");
    }

    public int findDrawable(String str) {
        return i.a(this.f7279a.getApplicationContext(), str, i.c);
    }
    ...
    public boolean isLandscape() {
        return this.f7279a.getResources().getConfiguration().orientation == 2;
    }
