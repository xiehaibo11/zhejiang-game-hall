...
public class TkayVideoView extends TkayBaseView implements f, j {
    ...
    static /* synthetic */ boolean e(TkayVideoView tkayVideoView) {
        tkayVideoView.aH = true;
        return true;
    }

    static /* synthetic */ boolean h(TkayVideoView tkayVideoView) {
        tkayVideoView.V = false;
        return false;
    }

    static /* synthetic */ boolean k(TkayVideoView tkayVideoView) {
        tkayVideoView.aC = true;
        return true;
    }

    static /* synthetic */ boolean l(TkayVideoView tkayVideoView) {
        tkayVideoView.aG = true;
        return true;
    }

    static /* synthetic */ boolean n(TkayVideoView tkayVideoView) {
        tkayVideoView.aD = true;
        return true;
    }

    static /* synthetic */ boolean p(TkayVideoView tkayVideoView) {
        tkayVideoView.ar = true;
        return true;
    }

    static /* synthetic */ boolean q(TkayVideoView tkayVideoView) {
        tkayVideoView.L = true;
        return true;
    }

    static /* synthetic */ boolean w(TkayVideoView tkayVideoView) {
    ...
    public TkayVideoView(Context context) {
        ...
        this.aL = new b(this);
        this.aM = false;
        this.aN = new Runnable() { // from class: com.tkay.expressad.video.module.TkayVideoView.3
    ...
    public void setVideoLayout(com.tkay.expressad.foundation.d.c cVar) {
        ...
        if (this.i) {
            ...
            com.tkay.expressad.video.dynview.b.a(cVarA, new AnonymousClass1(this, cVarA));
            return;
        }
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.video.module.TkayVideoView$1, reason: invalid class name */
    final class AnonymousClass1 implements h {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ ViewGroup f7322a;
        final /* synthetic */ com.tkay.expressad.video.dynview.c b;

        AnonymousClass1(ViewGroup viewGroup, com.tkay.expressad.video.dynview.c cVar) {
        ...
        public final void a(com.tkay.expressad.video.dynview.a aVar) {
            if (this.f7322a != null && aVar.a() != null) {
                aVar.a().setLayoutParams(new RelativeLayout.LayoutParams(-1, -1));
                this.f7322a.addView(aVar.a());
            }
            if (aVar.b() != null) {
                Iterator<View> it = aVar.b().iterator();
                while (it.hasNext()) {
                    it.next().setOnClickListener(new com.tkay.expressad.widget.a() { // from class: com.tkay.expressad.video.module.TkayVideoView.1.1
    ...
    private void a(ViewGroup viewGroup, com.tkay.expressad.foundation.d.c cVar) {
        ...
        com.tkay.expressad.video.dynview.b.a();
        com.tkay.expressad.video.dynview.b.a(cVarA, new AnonymousClass1(viewGroup, cVarA));
    }
        ...
        if (this.f) {
            if (this.i) {
                if (com.tkay.expressad.video.dynview.i.c.a(this.b) == -1 || com.tkay.expressad.video.dynview.i.c.a(this.b) == 100) {
                    this.D.setOnClickListener(new View.OnClickListener() { // from class: com.tkay.expressad.video.module.TkayVideoView.5
                ...
                this.D.setOnClickListener(new View.OnClickListener() { // from class: com.tkay.expressad.video.module.TkayVideoView.6
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        if (TkayVideoView.this.e != null) {
                            TkayVideoView.this.e.a(1, "");
            ...
            if (soundImageView != null) {
                soundImageView.setOnClickListener(new View.OnClickListener() { // from class: com.tkay.expressad.video.module.TkayVideoView.7
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        Integer num = 2;
            ...
            this.G.setOnClickListener(new View.OnClickListener() { // from class: com.tkay.expressad.video.module.TkayVideoView.8
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public void showAlertView() {
        ...
        if (this.ag == null) {
            this.ag = new c() { // from class: com.tkay.expressad.video.module.TkayVideoView.9
    ...
    public void defaultShow() {
        super.defaultShow();
        this.ak = true;
        showVideoLocation(0, 0, t.f(this.f7279a), t.e(this.f7279a), 0, 0, 0, 0, 0);
        videoOperate(1);
        if (this.ab == 0) {
    ...
    public void showVideoLocation(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        if (this.f) {
            ...
            if ((i3 > 0 && i4 > 0 && t.f(this.f7279a) >= i3 && t.e(this.f7279a) >= i4) && !this.ak) {
                y = i6;
                z = i7;
                A = i8 + 4;
                B = i9 + 4;
    ...
    public boolean isH5Canvas() {
        return getLayoutParams().height < t.e(this.f7279a.getApplicationContext());
    }
    ...
    private boolean b(int i, int i2) {
        return i > 0 && i2 > 0 && t.f(this.f7279a) >= i && t.e(this.f7279a) >= i2;
    }
    ...
    private boolean f() {
        try {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(strAE)) {
                    com.tkay.expressad.foundation.g.d.b.a(this.f7279a).a(strAE, new com.tkay.expressad.foundation.g.d.c() { // from class: com.tkay.expressad.video.module.TkayVideoView.10
                        ...
                        public final void a(Bitmap bitmap, String str) {
                            int iB = t.b(TkayVideoView.this.f7279a, 12.0f);
                            ImageView imageView = new ImageView(TkayVideoView.this.f7279a);
                            ...
                            layoutParams.bottomMargin = t.b(TkayVideoView.this.f7279a, 5.0f);
                            layoutParams.rightMargin = t.b(TkayVideoView.this.f7279a, 12.0f);
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.video.module.TkayVideoView$11, reason: invalid class name */
    ...
    private void l() {
        float f;
        float f2 = t.f(this.f7279a);
        float fE = t.e(this.f7279a);
        c.C0460c c0460cM = this.b.M();
        if (c0460cM != null && ((c0460cM.c() == 1 && f2 > fE) || (c0460cM.c() == 2 && fE > f2))) {
            float f3 = f2 + fE;
            fE = f3 - fE;
            f2 = f3 - fE;
        }
    ...
    private static final class b extends DefaultVideoPlayerStatusListener {
        ...
        public final void onPlayStarted(int i) {
            ...
            if (!this.d) {
                TkayVideoView tkayVideoView = this.f7336a;
                if (tkayVideoView != null) {
                    TkayVideoView.q(tkayVideoView);
                }
                this.f7336a.e.a(10, this.e);
                this.d = true;
            }
            ...
            if (cVar != null) {
                ...
                if (this.k.j()) {
                    TkayVideoView tkayVideoView2 = this.f7336a;
                    if (tkayVideoView2 != null && tkayVideoView2.F != null) {
                        if (this.k.k() != 5 || this.f7336a.mCurrPlayNum <= 1 || i2 > 0) {
                            if (i2 > 0) {
                                d();
                                str = "tkay_reward_video_time_count_num_bg";
                            }
                            this.f7336a.F.setBackgroundResource(i.a(m.a().f(), str, i.c));
                        } else {
                            this.f7336a.F.setBackgroundResource(i.a(m.a().f(), "tkay_reward_video_time_count_num_bg", i.c));
                            d();
                        }
                    }
                } else if (i2 > 0) {
                    ...
                    this.f7336a.F.setPadding(iB, 0, iB, 0);
                    this.f7336a.F.setLayoutParams(layoutParams);
                } else {
                    this.f7336a.F.setBackgroundResource(i.a(m.a().f(), "tkay_reward_shape_progress", i.c));
                }
            }
            if (this.f7336a.J != null) {
                this.f7336a.J.setMax(i);
            }
            com.tkay.expressad.foundation.d.c cVar2 = this.k;
            if (cVar2 != null && cVar2.f() == 2) {
                this.f7336a.H.setVisibility(0);
            }
            if (this.f7336a.F.getVisibility() == 0) {
                this.f7336a.n();
            }
            boolean unused = TkayVideoView.av = false;
            if (this.f7336a.S == 0) {
                this.f7336a.setCTALayoutVisibleOrGone();
            }
            this.f7336a.showMoreOfferInPlayTemplate();
            this.f7336a.showBaitClickView();
        }
        ...
        private void b(int i) {
            ...
            if (this.k.k() != 5 || this.f7336a.mCurrPlayNum <= 1 || i > 0) {
                if (i > 0) {
                    d();
                } else {
        ...
        public final void onPlayCompleted() {
            ...
            TkayVideoView.w(this.f7336a);
            com.tkay.expressad.foundation.d.c cVar = this.k;
            if (cVar == null) {
                this.f7336a.F.setText("0");
            } else {
                if (cVar.i() > 0) {
                    this.f7336a.F.setText(i.a(m.a().f(), "tkay_reward_video_view_reward_time_complete", i.g));
                } else {
                    this.f7336a.F.setText("0");
                }
                this.k.n(100);
                if (this.k.f() == 2) {
                    this.f7336a.G.setVisibility(4);
                    if (this.f7336a.K != null) {
                        this.f7336a.K.setClickable(false);
                    }
                    if (this.f7336a.E != null) {
                        this.f7336a.E.setClickable(false);
                    }
                }
            }
            this.f7336a.D.setClickable(false);
            String strB = this.f7336a.b(true);
            com.tkay.expressad.foundation.d.c cVar2 = this.k;
            if (cVar2 != null && cVar2.k() == 5 && (tkayVideoView = this.f7336a) != null && tkayVideoView.N != null && this.f7336a.mCampaignSize > this.f7336a.mCurrPlayNum) {
                HashMap map = new HashMap();
                map.put(RequestParameters.POSITION, Integer.valueOf(this.f7336a.mCurrPlayNum));
                if (this.f7336a.mMuteSwitch != 0) {
                    map.put("mute", Integer.valueOf(this.f7336a.mMuteSwitch));
                }
                this.f7336a.N.a(map);
                return;
            }
            this.f7336a.e.a(com.tkay.expressad.video.module.a.a.L, "");
            this.f7336a.e.a(11, strB);
            int i = this.c;
            this.b = i;
            this.f7336a.mCurrentPlayProgressTime = i;
        ...
        public final void onPlayProgress(int i, int i2) {
            ...
            if (this.f7336a.f) {
                ...
                if (this.k.j() && this.k.k() == 5) {
                    try {
                        int i5 = this.f7336a.O;
                        if (this.f7336a != null) {
                            String strValueOf2 = (String) this.f7336a.getContext().getResources().getText(i.a(m.a().f(), "tkay_reward_video_view_reward_time_complete", i.g));
                            String str3 = (String) this.f7336a.getContext().getResources().getText(i.a(m.a().f(), "tkay_reward_video_view_reward_time_left", i.g));
                            if (i4 >= 0) {
                                int i6 = i4 - i;
                                if (i6 > 0) {
                                    strValueOf2 = i6 + str3;
                                ...
                                if (i7 <= 0) {
                                    ...
                                    this.e.f7335a = i;
                                    this.f7336a.F.setText(str2);
                                    if (this.f7336a.J != null && this.f7336a.J.getVisibility() == 0) {
                                        this.f7336a.J.setProgress(i);
                                    }
                                } else if (i4 <= 0) {
                    ...
                    if (this.f7336a != null) {
                        ...
                        if (i8 > 0) {
                            if (i4 <= 0) {
                                ...
                                strValueOf = i8 + ((String) this.f7336a.getContext().getResources().getText(i.a(m.a().f(), "tkay_reward_video_view_reward_time_left", i.g)));
                            }
                            str2 = strValueOf;
                        } else if (i4 > 0) {
                            str2 = (String) this.f7336a.getContext().getResources().getText(i.a(m.a().f(), "tkay_reward_video_view_reward_time_complete", i.g));
                        }
                        this.f7336a.F.setText(str2);
                        if (this.f7336a.J != null && this.f7336a.J.getVisibility() == 0) {
                            this.f7336a.J.setProgress(i);
            ...
            this.e.f7335a = i;
            this.e.b = i2;
            this.e.c = this.f7336a.aG;
            this.b = i;
            this.f7336a.e.a(15, this.e);
            if (this.f7336a.au && !this.f7336a.aB && this.f7336a.ay == com.tkay.expressad.foundation.g.a.cs) {
                this.f7336a.e();
            }
            try {
                if (this.f7336a != null && this.f7336a.M != null) {
                    int i9 = (i * 100) / i2;
                    this.f7336a.M.setProgress(i9, this.f7336a.mCurrPlayNum - 1);
                    this.k.n(i9);
                }
                if (this.f7336a != null && this.f7336a.S != -1 && i == this.f7336a.S && this.f7336a.b != null && this.f7336a.b.j()) {
                    this.f7336a.setCTALayoutVisibleOrGone();
                }
            } catch (Throwable th) {
                th.getMessage();
        ...
        private void a(int i, int i2, int i3) {
            ...
            String str = (String) this.f7336a.getContext().getResources().getText(i.a(m.a().f(), "tkay_reward_video_view_reward_time_left", i.g));
            if (i >= 0) {
                int i4 = i - i3;
                if (i4 > 0) {
                    strValueOf = i4 + str;
            ...
            this.e.f7335a = i3;
            this.f7336a.F.setText(strValueOf);
            if (this.f7336a.J == null || this.f7336a.J.getVisibility() != 0) {
                return;
            }
            this.f7336a.J.setProgress(i3);
        }
        ...
        private void b(int i, int i2, int i3) {
            ...
            if (i4 <= 0) {
                strValueOf = i <= 0 ? "0" : (String) this.f7336a.getContext().getResources().getText(i.a(m.a().f(), "tkay_reward_video_view_reward_time_complete", i.g));
            } else if (i <= 0) {
                strValueOf = String.valueOf(i4);
            } else {
                strValueOf = i4 + ((String) this.f7336a.getContext().getResources().getText(i.a(m.a().f(), "tkay_reward_video_view_reward_time_left", i.g)));
            }
            this.f7336a.F.setText(strValueOf);
            if (this.f7336a.J == null || this.f7336a.J.getVisibility() != 0) {
                return;
    ...
    public static class a {
        ...
        public final String toString() {
            return "ProgressData{curPlayPosition=" + this.f7335a + ", allDuration=" + this.b + '}';
        }
    }
    ...
    public void setNotchPadding(final int i, final int i2, final int i3, final int i4) {
        try {
            ...
            if (!(Math.max(Math.max(layoutParams.leftMargin, layoutParams.rightMargin), Math.max(layoutParams.topMargin, layoutParams.bottomMargin)) > Math.max(Math.max(i, i2), Math.max(i3, i4))) && this.H != null) {
                this.H.postDelayed(new Runnable() { // from class: com.tkay.expressad.video.module.TkayVideoView.12
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    private void a(String str) {
        com.tkay.expressad.foundation.g.d.b.a(m.a().f()).a(str, new com.tkay.expressad.foundation.g.d.c() { // from class: com.tkay.expressad.video.module.TkayVideoView.2
            @Override // com.tkay.expressad.foundation.g.d.c
    ...
    public void showBaitClickView() {
        ...
        try {
            ...
            this.aK.setOnClickListener(new View.OnClickListener() { // from class: com.tkay.expressad.video.module.TkayVideoView.4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    if (TkayVideoView.this.e != null) {
                        TkayVideoView.this.e.a(1, "");
