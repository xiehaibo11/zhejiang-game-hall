...
public class g {
    ...
    public static final String f7463a = "ending_page_source";
    ...
    private void c(final String str, final a aVar) {
        try {
            ...
            this.d.add(str);
            f.a.f7462a.a(new com.tkay.expressad.foundation.g.g.a() { // from class: com.tkay.expressad.videocommon.b.g.1
                ...
                public final void a() {
                    ...
                    e.a(str, new c() { // from class: com.tkay.expressad.videocommon.b.g.1.1
