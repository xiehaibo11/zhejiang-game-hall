...
public final class a {
    ...
    public static String f6328a = "mtg_retry_report=1";
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.a.a.a$a, reason: collision with other inner class name */
    private static class C0428a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static a f6330a = new a(0);
        ...
        public final void handleMessage(Message message) {
            ...
            if (i != 1) {
                ...
                if (obj instanceof String) {
                    a.a().a((String) obj, com.tkay.expressad.a.a.b.f6331a);
                }
            }
        }
    }
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.a.a.a$1, reason: invalid class name */
    ...
    public final void a(String str, String str2, com.tkay.expressad.foundation.d.c cVar, String str3, boolean z, boolean z2, int i2) {
        ...
        String strReplace = str.replace("?" + f6328a, "").replace("&" + f6328a, "");
        if (this.o == null) {
            this.o = new ConcurrentHashMap<>();
        }
        ...
        if ((a(i2) && q != 0) || (b(i2) && r != 0) || i2 == m) {
            if (System.currentTimeMillis() >= bVarRemove.h() + ((long) g)) {
                bVarRemove.c();
                int i3 = com.tkay.expressad.a.a.b.f6331a;
                return;
            }
            if (this.p == null) {
                this.p = new c(f);
            ...
            if (bVarRemove.c() != com.tkay.expressad.a.a.b.f6331a || bVarRemove.g() > e) {
                return;
            }
            a(strReplace);
        }
