...
public final class b {
    ...
    private int i = -1;
    private View.OnClickListener n = new View.OnClickListener() { // from class: com.tkay.expressad.advanced.c.b.1
    ...
    public Handler f6376a = new Handler(Looper.getMainLooper()) { // from class: com.tkay.expressad.advanced.c.b.2
    ...
    private com.tkay.expressad.advanced.d.a o = new com.tkay.expressad.advanced.d.a() { // from class: com.tkay.expressad.advanced.c.b.3
        @Override // com.tkay.expressad.advanced.d.a
        public final void b() {
        }
    ...
    public final void a(final com.tkay.expressad.foundation.d.c cVar, final TYNativeAdvancedView tYNativeAdvancedView, boolean z) {
        ...
        com.tkay.expressad.foundation.f.b.a().a(this.k, new com.tkay.expressad.foundation.f.a() { // from class: com.tkay.expressad.advanced.c.b.4
        ...
        if (cVar2 == null || zA || cVar2.c() == null || this.g.c().getAlpha() < 0.5f || this.g.c().getVisibility() != 0 || this.m) {
            if (z) {
                tYNativeAdvancedView.postDelayed(new Runnable() { // from class: com.tkay.expressad.advanced.c.b.5
        ...
        com.tkay.expressad.advanced.a.c.c(cVar.Z());
        this.f6376a.sendEmptyMessageDelayed(2, 1000L);
    }
    ...
    public final void e() {
        ...
        j.a();
        j.a((WebView) advancedNativeWebview, NativeAdvancedJsUtils.f6397a, "");
    }
