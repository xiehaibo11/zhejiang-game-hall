...
public class c extends h implements com.tkay.expressad.e.a, Serializable {
    ...
    public static final String f6830a = c.class.getSimpleName();
    ...
    public static final int f6831cm = 1;

    /* JADX INFO: renamed from: cn, reason: collision with root package name */
    public static final int f6832cn = 0;
    ...
    public final void k(String str) {
        C0460c c0460c;
        this.fb = str;
        if (TextUtils.isEmpty(this.eV) && (((c0460c = this.fo) == null || TextUtils.isEmpty(c0460c.k)) && !TextUtils.isEmpty(str) && str.contains("cmpt=1"))) {
            this.eW = str;
        }
        this.fz = t.d(str);
    }
    ...
    public final C0460c M() {
        return this.fo;
    }

    private void a(C0460c c0460c) {
        this.fo = c0460c;
        if (c0460c == null || TextUtils.isEmpty(c0460c.e())) {
            return;
        }
        if (TextUtils.isEmpty(this.eV) && c0460c.e().contains("cmpt=1")) {
            this.eW = c0460c.e();
        }
        boolean zE = t.e(c0460c.e());
        int iG = t.g(c0460c.e());
        if (zE) {
            this.dp = true;
            v(iG);
    ...
    @Override // com.tkay.expressad.out.d
    ...
    @Override // com.tkay.expressad.foundation.d.h
    public final c.b aj() {
        return this.fp;
    }
    ...
    public static c a(JSONObject jSONObject) {
        ...
        cVar.o(jSONObject.optString(a.C0386a.k));
    ...
    public static c b(JSONObject jSONObject) {
        ...
        if (jSONObject != null) {
            ...
            try {
                ...
                cVar.a(C0460c.a(jSONObject.optJSONObject("rv")));
                ...
                cVarA.f23do = jSONObject.optString("encrypt_p");
    ...
    public static c a(JSONObject jSONObject, String str, String str2, String str3, boolean z2, d dVar, String str4) {
        ...
        try {
            ...
            try {
                ...
                cVar.a(C0460c.a(jSONObjectC.optJSONObject("rv")));
    ...
    public static JSONObject a(c cVar) {
        ...
        if (cVar != null && (c0460c = cVar.fo) != null && w.b(c0460c.a())) {
        ...
        jSONObject.put("encrypt_p", cVar.f23do);
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.foundation.d.c$c, reason: collision with other inner class name */
    public static final class C0460c implements Serializable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public static final String f6835a = "video_template";
        ...
        /* JADX INFO: renamed from: com.tkay.expressad.foundation.d.c$c$a */
        ...
        private static C0460c d(String str) {
            try {
                if (w.b(str)) {
        ...
        public static C0460c a(JSONObject jSONObject) {
            if (jSONObject == null) {
                return null;
            }
            try {
                ...
                C0460c c0460c = new C0460c(jSONObject.toString());
                c0460c.h = jSONObject.optInt(f6835a, 1);
                c0460c.a(jSONObject.optString("template_url"));
                c0460c.i = jSONObject.optInt("orientation");
                c0460c.j = jSONObject.optString(d);
    ...
    public static final class a implements Serializable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public static final String f6833a = "ad_logo_link";
        ...
        private static a a(JSONObject jSONObject) {
            ...
            try {
                ...
                try {
                    ...
                    aVar2.i = jSONObject.optString(f6833a);
