...
public final class d extends com.tkay.expressad.foundation.g.g.a {
    ...
    private static final String f6886a = "ImageWorker";
    private String e;
    private String f;
    private String g;
    ...
    private void n() {
        try {
            ...
            com.tkay.expressad.foundation.g.f.h.a.a(file, this.f, new f<Void>() { // from class: com.tkay.expressad.foundation.g.d.d.1
                ...
                public final void a(com.tkay.expressad.foundation.g.f.a.a aVar) {
                    d dVar = d.this;
                    dVar.b(dVar.f, "load image from http faild because http return code: " + aVar.f6891a + ".image url is " + d.this.f);
                }
            });
        } catch (Exception e) {
