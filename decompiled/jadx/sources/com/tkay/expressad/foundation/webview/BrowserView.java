...
public class BrowserView extends LinearLayout {
    ...
    private static final String f6963a = "BrowserView";
    private String b;
    ...
    public void init() {
        ...
        this.e.setOnItemClickListener(new View.OnClickListener() { // from class: com.tkay.expressad.foundation.webview.BrowserView.1
    ...
    private WebView b() {
        ...
        webView.setWebViewClient(new WebViewClient() { // from class: com.tkay.expressad.foundation.webview.BrowserView.2
        ...
        if (k.d() <= 10) {
            webChromeClient = new WebChromeClient() { // from class: com.tkay.expressad.foundation.webview.BrowserView.3
                ...
                public final void onProgressChanged(WebView webView2, int i) {
                    if (i == 100) {
                        ...
                        new Handler().postDelayed(new Runnable() { // from class: com.tkay.expressad.foundation.webview.BrowserView.3.1
            ...
            webChromeClient = new WebChromeClient() { // from class: com.tkay.expressad.foundation.webview.BrowserView.4
                @Override // android.webkit.WebChromeClient
                public final void onProgressChanged(WebView webView2, int i) {
                    if (i == 100) {
                        BrowserView.this.c.setProgressState(7);
                        new Handler().postDelayed(new Runnable() { // from class: com.tkay.expressad.foundation.webview.BrowserView.4.1
                            @Override // java.lang.Runnable
                            public final void run() {
                                BrowserView.this.c.setVisible(false);
                            }
