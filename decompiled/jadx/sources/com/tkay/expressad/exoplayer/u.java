...
final class u {
    ...
    public final u a(s.a aVar, long j, long j2) {
        return new u(this.f6812a, this.b, aVar, j, aVar.a() ? j2 : -9223372036854775807L, this.f, this.g, this.h, this.i);
    }

    public final u a(int i) {
        u uVar = new u(this.f6812a, this.b, this.c.a(i), this.d, this.e, this.f, this.g, this.h, this.i);
        a(this, uVar);
        return uVar;
    }
    ...
    public final u b(int i) {
        u uVar = new u(this.f6812a, this.b, this.c, this.d, this.e, i, this.g, this.h, this.i);
        a(this, uVar);
        return uVar;
    }

    public final u a(boolean z) {
        u uVar = new u(this.f6812a, this.b, this.c, this.d, this.e, this.f, z, this.h, this.i);
        a(this, uVar);
        return uVar;
    }

    public final u a(af afVar, com.tkay.expressad.exoplayer.i.i iVar) {
        u uVar = new u(this.f6812a, this.b, this.c, this.d, this.e, this.f, this.g, afVar, iVar);
        a(this, uVar);
        return uVar;
    }
