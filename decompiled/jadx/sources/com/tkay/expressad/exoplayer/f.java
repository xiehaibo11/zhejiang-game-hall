...
public final class f implements ab {
    ...
    public static final long f6578a = 5000;
    ...
    @Override // com.tkay.expressad.exoplayer.ab
    public final y[] a(Handler handler, com.tkay.expressad.exoplayer.l.h hVar, com.tkay.expressad.exoplayer.b.g gVar, com.tkay.expressad.exoplayer.g.f fVar, com.tkay.expressad.exoplayer.d.g<com.tkay.expressad.exoplayer.d.k> gVar2) {
        ...
        long j = this.j;
        int i3 = this.i;
        arrayList.add(new com.tkay.expressad.exoplayer.l.e(context, com.tkay.expressad.exoplayer.f.c.f6581a, j, gVar3, handler, hVar, 50));
        if (i3 != 0) {
        ...
        int i4 = this.i;
        arrayList.add(new com.tkay.expressad.exoplayer.b.o(context2, com.tkay.expressad.exoplayer.f.c.f6581a, gVar3, handler, gVar, com.tkay.expressad.exoplayer.b.c.a(context2), fVarArr));
        if (i4 != 0) {
    ...
    private static void a(Context context, com.tkay.expressad.exoplayer.d.g<com.tkay.expressad.exoplayer.d.k> gVar, long j, Handler handler, com.tkay.expressad.exoplayer.l.h hVar, int i, ArrayList<y> arrayList) {
        arrayList.add(new com.tkay.expressad.exoplayer.l.e(context, com.tkay.expressad.exoplayer.f.c.f6581a, j, gVar, handler, hVar, 50));
        if (i == 0) {
            return;
        }
        int size = arrayList.size();
    ...
    private static void a(Context context, com.tkay.expressad.exoplayer.d.g<com.tkay.expressad.exoplayer.d.k> gVar, com.tkay.expressad.exoplayer.b.f[] fVarArr, Handler handler, com.tkay.expressad.exoplayer.b.g gVar2, int i, ArrayList<y> arrayList) {
        int i2;
        int i3;
        arrayList.add(new com.tkay.expressad.exoplayer.b.o(context, com.tkay.expressad.exoplayer.f.c.f6581a, gVar, handler, gVar2, com.tkay.expressad.exoplayer.b.c.a(context), fVarArr));
        if (i == 0) {
            return;
        }
        int size = arrayList.size();
