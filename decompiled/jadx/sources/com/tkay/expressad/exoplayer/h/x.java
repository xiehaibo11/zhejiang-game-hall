...
public final class x implements com.tkay.expressad.exoplayer.e.m {
    ...
    public static final int f6686a = -1;
    ...
    public final int a(com.tkay.expressad.exoplayer.n nVar, com.tkay.expressad.exoplayer.c.e eVar, boolean z, boolean z2, long j) {
        ...
        if (!eVar.c()) {
            ...
            if (eVar.g()) {
                ...
                int iE = 1;
                this.g.a(1);
                a(j2, this.g.f6774a, 1);
                long j3 = j2 + 1;
                byte b2 = this.g.f6774a[0];
                boolean z3 = (b2 & ByteCompanionObject.MIN_VALUE) != 0;
                int i = b2 & ByteCompanionObject.MAX_VALUE;
                if (eVar.d.f6512a == null) {
                    eVar.d.f6512a = new byte[16];
                }
                a(j3, eVar.d.f6512a, i);
                long j4 = j3 + ((long) i);
                if (z3) {
                    this.g.a(2);
                    a(j4, this.g.f6774a, 2);
                    j4 += 2;
                    iE = this.g.e();
                }
                int i2 = iE;
                ...
                if (z3) {
                    ...
                    iArr2[0] = 0;
                    iArr4[0] = aVar.f6685a - ((int) (j4 - aVar.b));
                }
                m.a aVar2 = aVar.c;
                eVar.d.a(i2, iArr2, iArr4, aVar2.b, eVar.d.f6512a, aVar2.f6577a, aVar2.c, aVar2.d);
                int i5 = (int) (j4 - aVar.b);
                aVar.b += (long) i5;
                aVar.f6685a -= i5;
            }
            eVar.d(this.f.f6685a);
            long j5 = this.f.b;
            ByteBuffer byteBuffer = eVar.e;
            int i6 = this.f.f6685a;
            b(j5);
            while (i6 > 0) {
                int iMin = Math.min(i6, (int) (this.i.b - j5));
                byteBuffer.put(this.i.d.f6706a, this.i.a(j5), iMin);
                i6 -= iMin;
                j5 += (long) iMin;
                if (j5 == this.i.b) {
                    this.i = this.i.e;
    ...
    private void a(com.tkay.expressad.exoplayer.c.e eVar, w.a aVar) {
        ...
        a(j2, eVar.d.f6512a, i);
        long j3 = j2 + ((long) i);
        if (z) {
            this.g.a(2);
            a(j3, this.g.f6774a, 2);
            j3 += 2;
            iE = this.g.e();
        }
        int i2 = iE;
        ...
        if (z) {
            ...
            iArr2[0] = 0;
            iArr4[0] = aVar.f6685a - ((int) (j3 - aVar.b));
        }
        m.a aVar2 = aVar.c;
        eVar.d.a(i2, iArr2, iArr4, aVar2.b, eVar.d.f6512a, aVar2.f6577a, aVar2.c, aVar2.d);
    ...
    private void a(long j, ByteBuffer byteBuffer, int i) {
        ...
        while (i > 0) {
            ...
            byteBuffer.put(this.i.d.f6706a, this.i.a(j), iMin);
            i -= iMin;
            j += (long) iMin;
            if (j == this.i.b) {
                this.i = this.i.e;
    ...
    private void a(long j, byte[] bArr, int i) {
        ...
        while (i2 > 0) {
            ...
            System.arraycopy(this.i.d.f6706a, this.i.a(j), bArr, i - i2, iMin);
            i2 -= iMin;
            j += (long) iMin;
            if (j == this.i.b) {
                this.i = this.i.e;
    ...
    private void c(long j) {
        ...
        if (this.i.f6687a < this.h.f6687a) {
            this.i = this.h;
        }
    }
    ...
    public final int a(com.tkay.expressad.exoplayer.e.f fVar, int i, boolean z) throws EOFException {
        int iA = fVar.a(this.j.d.f6706a, this.j.a(this.o), d(i));
        if (iA != -1) {
            e(iA);
            return iA;
        }
    ...
    public final void a(com.tkay.expressad.exoplayer.k.s sVar, int i) {
        while (i > 0) {
            int iD = d(i);
            sVar.a(this.j.d.f6706a, this.j.a(this.o), iD);
            i -= iD;
            e(iD);
        }
    }
    ...
    private void a(a aVar) {
        if (aVar.c) {
            boolean z = this.j.c;
            int i = (z ? 1 : 0) + (((int) (this.j.f6687a - aVar.f6687a)) / this.d);
    ...
    private static final class a {
        ...
        public final int a(long j) {
            return ((int) (j - this.f6687a)) + this.d.b;
        }
