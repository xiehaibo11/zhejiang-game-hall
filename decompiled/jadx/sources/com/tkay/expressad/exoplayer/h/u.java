...
final class u implements r, r.a {
    ...
    public final void a(r.a aVar, long j) {
        this.e = aVar;
        Collections.addAll(this.d, this.f6681a);
        for (r rVar : this.f6681a) {
            rVar.a(this, j);
        }
    }
    ...
    public final long a(com.tkay.expressad.exoplayer.i.f[] fVarArr, boolean[] zArr, y[] yVarArr, boolean[] zArr2, long j) {
        ...
        ArrayList arrayList = new ArrayList(this.f6681a.length);
        long j2 = j;
        int i3 = 0;
        while (i3 < this.f6681a.length) {
            ...
            long jA = this.f6681a[i3].a(fVarArr2, zArr, yVarArr4, zArr2, j2);
            if (i5 == 0) {
                j2 = jA;
            } else if (jA != j2) {
        ...
        while (true) {
            ...
            if (i >= rVarArr.length) {
                if (jC != -9223372036854775807L) {
                    for (r rVar : this.g) {
                        if (rVar != this.f6681a[0] && rVar.b(jC) != jC) {
    ...
    public final void a(r rVar) {
        ...
        if (this.d.isEmpty()) {
            int i = 0;
            for (r rVar2 : this.f6681a) {
                i += rVar2.b().b;
            }
            ae[] aeVarArr = new ae[i];
            int i2 = 0;
            for (r rVar3 : this.f6681a) {
                af afVarB = rVar3.b();
                int i3 = afVarB.b;
                int i4 = 0;
                while (i4 < i3) {
