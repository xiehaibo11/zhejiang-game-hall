...
public final class b implements d.b {
    ...
    private static final String f6636a = "BaseMediaChunkOutput";
    private final int[] b;
    private final x[] c;
    ...
    @Override // com.tkay.expressad.exoplayer.h.b.d.b
    public final m a(int i) {
        ...
        while (true) {
            ...
            if (i2 < iArr.length) {
                ...
                Log.e(f6636a, "Unmatched track of type: ".concat(String.valueOf(i)));
