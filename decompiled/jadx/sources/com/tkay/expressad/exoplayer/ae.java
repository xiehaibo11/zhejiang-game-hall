...
public abstract class ae {
    ...
    public static final ae f6477a = new ae() { // from class: com.tkay.expressad.exoplayer.ae.1
    ...
    public static final class a {
        ...
        public final int d(int i) {
            return this.f.i[i].f6612a;
        }

        public final boolean b(int i, int i2) {
            a.C0447a c0447a = this.f.i[i];
            return (c0447a.f6612a == -1 || c0447a.c[i2] == 0) ? false : true;
        }
