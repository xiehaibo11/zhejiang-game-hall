...
public final class d {
    ...
    private static final byte[] f6759a = {0, 0, 0, 1};
    ...
    public static byte[] a(byte[] bArr, int i2, int i3) {
        ...
        System.arraycopy(bArr, i2, bArr3, f6759a.length, i3);
        return bArr3;
    }
    ...
    private static int a(byte[] bArr, int i2) {
        int length = bArr.length - f6759a.length;
        while (i2 <= length) {
            if (b(bArr, i2)) {
                return i2;
            }
    ...
    private static boolean b(byte[] bArr, int i2) {
        if (bArr.length - i2 <= f6759a.length) {
            return false;
        }
        int i3 = 0;
        while (true) {
