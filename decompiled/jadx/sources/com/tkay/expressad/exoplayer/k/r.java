...
public final class r {
    ...
    public final boolean d() {
        boolean z = (this.f6773a[this.b] & (128 >> this.c)) != 0;
        c();
        return z;
    }
    ...
    private void b(byte[] bArr, int i, int i2) {
        a.b(this.c == 0);
        System.arraycopy(this.f6773a, this.b, bArr, i, i2);
        this.b += i2;
        g();
    }
