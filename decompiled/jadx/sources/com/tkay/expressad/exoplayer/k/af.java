...
public final class af {
    ...
    public static final int f6754a;
    ...
    static {
        f6754a = (Build.VERSION.SDK_INT == 25 && Build.VERSION.CODENAME.charAt(0) == 'O') ? 26 : Build.VERSION.SDK_INT;
        b = Build.DEVICE;
    ...
    public static ExecutorService a(final String str) {
        return Executors.newSingleThreadExecutor(new ThreadFactory() { // from class: com.tkay.expressad.exoplayer.k.af.1
    ...
    public static long a(long j2, com.tkay.expressad.exoplayer.ac acVar, long j3, long j4) {
        if (com.tkay.expressad.exoplayer.ac.f6475a.equals(acVar)) {
            return j2;
        }
        long j5 = acVar.f;
        long j6 = j2 - j5;
    ...
    */
    private static java.util.UUID k(java.lang.String r5) {
        ...
        L4c:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tkay.expressad.exoplayer.k.af.k(java.lang.String):java.util.UUID");
    }
    ...
    private static Point a(Context context, Display display) {
        if (f6754a < 25 && display.getDisplayId() == 0) {
