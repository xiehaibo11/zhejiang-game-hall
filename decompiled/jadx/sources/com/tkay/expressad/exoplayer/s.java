...
final class s {
    ...
    private static final int f6806a = 100;
    ...
    public final boolean a(com.tkay.expressad.exoplayer.h.r rVar) {
        q qVar = this.j;
        return qVar != null && qVar.f6804a == rVar;
    }
    ...
    public final boolean a(s.a aVar, long j) {
        ...
        for (q qVarE = e(); qVarE != null; qVarE = qVarE.i) {
            if (qVar == null) {
                ...
                qVarE.h = a(qVarE.h, iA);
                r rVar = qVarE.h;
                if (!(rVar.b == rVarA.b && rVar.c == rVarA.c && rVar.f6805a.equals(rVarA.f6805a))) {
                    return !a(qVar);
                }
            }
            if (qVarE.h.f) {
    ...
    private static boolean a(q qVar, r rVar) {
        r rVar2 = qVar.h;
        return rVar2.b == rVar.b && rVar2.c == rVar.c && rVar2.f6805a.equals(rVar.f6805a);
    }
    ...
    private boolean i() {
        ...
        while (true) {
            int iA = this.e.a(qVarE.h.f6805a.f6667a, this.b, this.c, this.f, this.g);
            while (qVarE.i != null && !qVarE.h.f) {
                qVarE = qVarE.i;
            }
            if (iA == -1 || qVarE.i == null || qVarE.i.h.f6805a.f6667a != iA) {
                break;
            }
            qVarE = qVarE.i;
        }
        boolean zA = a(qVarE);
        qVarE.h = a(qVarE.h, qVarE.h.f6805a);
    ...
    private r a(q qVar, long j) {
        ...
        r rVar = qVar.h;
        if (rVar.f) {
            int iA = this.e.a(rVar.f6805a.f6667a, this.b, this.c, this.f, this.g);
            if (iA == -1) {
                return null;
            }
            int i2 = this.e.a(iA, this.b, true).c;
            Object obj = this.b.b;
            long j4 = rVar.f6805a.d;
            long j5 = 0;
        ...
        s.a aVar = rVar.f6805a;
        this.e.a(aVar.f6667a, this.b, false);
        if (aVar.a()) {
            int i3 = aVar.b;
            int iD = this.b.d(i3);
            if (iD == -1) {
            ...
            if (iA2 < iD) {
                if (this.b.b(i3, iA2)) {
                    return a(aVar.f6667a, i3, iA2, rVar.d, aVar.d);
                }
                return null;
            }
            return b(aVar.f6667a, rVar.d, aVar.d);
        }
        if (rVar.c != Long.MIN_VALUE) {
            int iA3 = this.b.a(rVar.c);
            if (iA3 == -1) {
                return b(aVar.f6667a, rVar.c, aVar.d);
            }
            int iB = this.b.b(iA3);
            if (this.b.b(iA3, iB)) {
                return a(aVar.f6667a, iA3, iB, rVar.c, aVar.d);
            }
            return null;
        }
        int iC = this.b.c();
        ...
        return a(aVar.f6667a, i4, iB2, this.b.d, aVar.d);
    }
    ...
    private r a(s.a aVar, long j, long j2) {
        ...
        if (aVar.a()) {
            if (this.b.b(aVar.b, aVar.c)) {
                return a(aVar.f6667a, aVar.b, aVar.c, j, aVar.d);
            }
            return null;
        }
        return b(aVar.f6667a, j2, aVar.d);
    }
    ...
    private r a(int i, int i2, int i3, long j, long j2) {
        ...
        boolean zA = a(aVar, zB);
        return new r(aVar, i3 == this.b.b(i2) ? this.b.d() : 0L, Long.MIN_VALUE, j, this.e.a(aVar.f6667a, this.b, false).c(aVar.b, aVar.c), zB, zA);
    }
    ...
    private boolean b(s.a aVar, long j) {
        int iC = this.e.a(aVar.f6667a, this.b, false).c();
        if (iC == 0) {
            return true;
        }
        int i = iC - 1;
    ...
    private boolean a(s.a aVar, boolean z) {
        return !this.e.a(this.e.a(aVar.f6667a, this.b, false).c, this.c, false).e && this.e.b(aVar.f6667a, this.b, this.c, this.f, this.g) && z;
    }
