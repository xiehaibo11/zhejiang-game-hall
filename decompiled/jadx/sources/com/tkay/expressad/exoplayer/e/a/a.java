...
abstract class a {
    ...
    public static final int f6548a = 8;
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.exoplayer.e.a.a$a, reason: collision with other inner class name */
    static final class C0442a extends a {
        public final long aV;
        public final List<b> aW;
        public final List<C0442a> aX;

        public C0442a(int i, long j) {
            super(i);
            this.aV = j;
        ...
        public final C0442a e(int i) {
            int size = this.aX.size();
            for (int i2 = 0; i2 < size; i2++) {
                C0442a c0442a = this.aX.get(i2);
                if (c0442a.aU == i) {
                    return c0442a;
                }
            }
        ...
        @Override // com.tkay.expressad.exoplayer.e.a.a
