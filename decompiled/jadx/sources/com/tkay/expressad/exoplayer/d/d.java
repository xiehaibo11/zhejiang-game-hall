...
public final class d<T extends i> implements b.c<T>, g<T> {
    ...
    public static final String f6531a = "PRCustomData";
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.exoplayer.d.d$d, reason: collision with other inner class name */
    public static final class C0441d extends Exception {
        /* synthetic */ C0441d(UUID uuid, byte b) {
            this(uuid);
        }

        private C0441d(UUID uuid) {
    ...
    @Override // com.tkay.expressad.exoplayer.d.g
    public final boolean a(com.tkay.expressad.exoplayer.d.e eVar) {
        ...
        return !("cbc1".equals(str) || "cbcs".equals(str) || "cens".equals(str)) || af.f6754a >= 25;
    }
    ...
    public final f<T> a(Looper looper, com.tkay.expressad.exoplayer.d.e eVar) {
        ...
        if (this.t == null) {
            ...
            if (aVarA == null) {
                C0441d c0441d = new C0441d(this.i, b2);
                this.m.a(c0441d);
                return new h(new f.a(c0441d));
            }
            aVar = aVarA;
        } else {
            aVar = null;
    ...
    @Override // com.tkay.expressad.exoplayer.d.b.c
    ...
    private static e.a a(com.tkay.expressad.exoplayer.d.e eVar, UUID uuid, boolean z) {
        ...
        if (com.tkay.expressad.exoplayer.b.bk.equals(uuid)) {
            for (int i2 = 0; i2 < arrayList.size(); i2++) {
                ...
                if (af.f6754a < 23 && iB == 0) {
                    return aVar;
                }
                if (af.f6754a >= 23 && iB == 1) {
                    return aVar;
                }
            }
        }
    ...
    private class b implements j.f<T> {
        ...
        @Override // com.tkay.expressad.exoplayer.d.j.f
