...
public final class d {
    ...
    private static final String f6582a = "MediaCodecUtil";
    ...
    private static void b(String str, boolean z) {
        try {
            ...
            Log.e(f6582a, "Codec warming failed", e2);
        }
    }
    ...
    private static synchronized List<com.tkay.expressad.exoplayer.f.a> c(String str, boolean z) {
        ...
        byte b2 = 0;
        c eVar = af.f6754a >= 21 ? new e(z) : new C0445d(b2);
        ArrayList<com.tkay.expressad.exoplayer.f.a> arrayListA = a(aVar, eVar, str);
        if (z && arrayListA.isEmpty() && 21 <= af.f6754a && af.f6754a <= 23) {
            eVar = new C0445d(b2);
            arrayListA = a(aVar, eVar, str);
            if (!arrayListA.isEmpty()) {
                Log.w(f6582a, "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + arrayListA.get(0).c);
            }
        }
    ...
    public static int b() {
        if (n == -1) {
            ...
            if (aVarA != null) {
                ...
                iMax = Math.max(iMax2, af.f6754a >= 21 ? 345600 : 172800);
            }
            n = iMax;
        }
        return n;
    ...
    public static Pair<Integer, Integer> a(String str) {
        ...
        if (strArrSplit.length < 4) {
            Log.w(f6582a, "Ignoring malformed HEVC codec string: ".concat(String.valueOf(str)));
            return null;
        }
        ...
        if ("1".equals(strGroup)) {
            ...
            Log.w(f6582a, "Unknown HEVC profile string: ".concat(String.valueOf(strGroup)));
            return null;
        }
        Integer num = k.get(strArrSplit[3]);
        if (num == null) {
            Log.w(f6582a, "Unknown HEVC level string: " + matcher.group(1));
            return null;
        }
    ...
    */
    private static java.util.ArrayList<com.tkay.expressad.exoplayer.f.a> a(com.tkay.expressad.exoplayer.f.d.a r18, com.tkay.expressad.exoplayer.f.d.c r19, java.lang.String r20) throws com.tkay.expressad.exoplayer.f.d.b {
        /*
            Method dump skipped, instruction units count: 828
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tkay.expressad.exoplayer.f.d.a(com.tkay.expressad.exoplayer.f.d$a, com.tkay.expressad.exoplayer.f.d$c, java.lang.String):java.util.ArrayList");
    }
    ...
    private static boolean a(MediaCodecInfo mediaCodecInfo, String str, boolean z, String str2) {
        ...
        if (af.f6754a < 21 && ("CIPAACDecoder".equals(str) || "CIPMP3Decoder".equals(str) || "CIPVorbisDecoder".equals(str) || "CIPAMRNBDecoder".equals(str) || "AACDecoder".equals(str) || "MP3Decoder".equals(str))) {
            return false;
        }
        if (af.f6754a < 18 && "OMX.SEC.MP3.Decoder".equals(str)) {
            return false;
        }
        if (af.f6754a < 18 && "OMX.MTK.AUDIO.DECODER.AAC".equals(str) && ("a70".equals(af.b) || ("Xiaomi".equals(af.c) && af.b.startsWith("HM")))) {
            return false;
        }
        if (af.f6754a == 16 && "OMX.qcom.audio.decoder.mp3".equals(str) && ("dlxu".equals(af.b) || "protou".equals(af.b) || "ville".equals(af.b) || "villeplus".equals(af.b) || "villec2".equals(af.b) || af.b.startsWith("gee") || "C6602".equals(af.b) || "C6603".equals(af.b) || "C6606".equals(af.b) || "C6616".equals(af.b) || "L36h".equals(af.b) || "SO-02E".equals(af.b))) {
            return false;
        }
        if (af.f6754a == 16 && "OMX.qcom.audio.decoder.aac".equals(str) && ("C1504".equals(af.b) || "C1505".equals(af.b) || "C1604".equals(af.b) || "C1605".equals(af.b))) {
            return false;
        }
        if (af.f6754a < 24 && (("OMX.SEC.aac.dec".equals(str) || "OMX.Exynos.AAC.Decoder".equals(str)) && "samsung".equals(af.c) && (af.b.startsWith("zeroflte") || af.b.startsWith("zerolte") || af.b.startsWith("zenlte") || "SC-05G".equals(af.b) || "marinelteatt".equals(af.b) || "404SC".equals(af.b) || "SC-04G".equals(af.b) || "SCV31".equals(af.b)))) {
            return false;
        }
        if (af.f6754a <= 19 && "OMX.SEC.vp8.dec".equals(str) && "samsung".equals(af.c) && (af.b.startsWith(com.tkay.expressad.foundation.g.a.O) || af.b.startsWith("serrano") || af.b.startsWith("jflte") || af.b.startsWith("santos") || af.b.startsWith("t0"))) {
            return false;
        }
        if (af.f6754a <= 19 && af.b.startsWith("jflte") && "OMX.qcom.video.decoder.vp8".equals(str)) {
            return false;
        }
    ...
    private static Pair<Integer, Integer> b(String str, String[] strArr) {
        ...
        Integer numValueOf2;
        if (strArr.length < 2) {
            Log.w(f6582a, "Ignoring malformed AVC codec string: ".concat(String.valueOf(str)));
            return null;
        }
        try {
            ...
            if (i2 == -1) {
                Log.w(f6582a, "Unknown AVC profile: ".concat(String.valueOf(numValueOf2)));
                return null;
            }
            int i3 = h.get(numValueOf.intValue(), -1);
            if (i3 == -1) {
                Log.w(f6582a, "Unknown AVC level: ".concat(String.valueOf(numValueOf)));
                return null;
            }
    ...
    private static final class e implements c {
        ...
        @Override // com.tkay.expressad.exoplayer.f.d.c
        ...
        private void c() {
            if (this.b == null) {
                this.b = new MediaCodecList(this.f6584a).getCodecInfos();
            }
        }
    }

    /* JADX INFO: renamed from: com.tkay.expressad.exoplayer.f.d$d, reason: collision with other inner class name */
    private static final class C0445d implements c {
        @Override // com.tkay.expressad.exoplayer.f.d.c
        public final boolean b() {
            return false;
        }
    ...
    private static final class a {
        ...
        public final boolean equals(Object obj) {
            ...
            if (obj != null && obj.getClass() == a.class) {
                a aVar = (a) obj;
                if (TextUtils.equals(this.f6583a, aVar.f6583a) && this.b == aVar.b) {
                    return true;
                }
            }
            return false;
