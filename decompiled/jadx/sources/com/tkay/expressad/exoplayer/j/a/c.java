...
public final class c implements com.tkay.expressad.exoplayer.j.h {
    ...
    public static final long f6708a = 2097152;
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.exoplayer.j.a.c$c, reason: collision with other inner class name */
    @Retention(RetentionPolicy.SOURCE)
    ...
    private void b(IOException iOException) {
        if (f() || (iOException instanceof a.C0455a)) {
            this.z = true;
        }
    }
