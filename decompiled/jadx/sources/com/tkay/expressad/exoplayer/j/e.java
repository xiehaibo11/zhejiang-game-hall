...
public final class e implements h {
    ...
    private final ContentResolver f6720a;
    ...
    public e(Context context, aa<? super e> aaVar) {
        this.f6720a = context.getContentResolver();
        this.b = aaVar;
    }
    ...
    public final long a(k kVar) throws a {
        try {
            Uri uri = kVar.c;
            this.c = uri;
            AssetFileDescriptor assetFileDescriptorOpenAssetFileDescriptor = this.f6720a.openAssetFileDescriptor(uri, "r");
