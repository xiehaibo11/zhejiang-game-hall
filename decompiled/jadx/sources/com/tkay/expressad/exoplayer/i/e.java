...
public abstract class e extends h {
    ...
    public static final class a {
        ...
        /* JADX INFO: renamed from: com.tkay.expressad.exoplayer.i.e$a$a, reason: collision with other inner class name */
    ...
    @Override // com.tkay.expressad.exoplayer.i.h
    ...
    public final i a(z[] zVarArr, af afVar) {
        ...
        for (int i3 = 0; i3 < afVar.b; i3++) {
            ...
            while (true) {
                ...
                z zVar = zVarArr[i4];
                for (int i6 = 0; i6 < aeVarA.f6632a; i6++) {
            ...
            if (length3 == zVarArr.length) {
                iArr = new int[aeVarA.f6632a];
            } else {
                z zVar2 = zVarArr[length3];
                int[] iArr5 = new int[aeVarA.f6632a];
                for (int i7 = 0; i7 < aeVarA.f6632a; i7++) {
    ...
    private static int[] a(z zVar, ae aeVar) {
        int[] iArr = new int[aeVar.f6632a];
        for (int i = 0; i < aeVar.f6632a; i++) {
