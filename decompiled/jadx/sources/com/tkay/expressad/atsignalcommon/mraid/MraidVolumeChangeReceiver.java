...
public class MraidVolumeChangeReceiver {
    ...
    public static double f6432a = -1.0d;
    ...
    private static class VolumeChangeBroadcastReceiver extends BroadcastReceiver {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private WeakReference<MraidVolumeChangeReceiver> f6433a;

        public VolumeChangeBroadcastReceiver(MraidVolumeChangeReceiver mraidVolumeChangeReceiver) {
            this.f6433a = new WeakReference<>(mraidVolumeChangeReceiver);
        }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (!MraidVolumeChangeReceiver.b.equals(intent.getAction()) || intent.getIntExtra(MraidVolumeChangeReceiver.c, -1) != 3 || (mraidVolumeChangeReceiver = this.f6433a.get()) == null || (volumeChangeListener = mraidVolumeChangeReceiver.getVolumeChangeListener()) == null) {
                return;
            }
