...
public abstract class AbsFeedBackForH5 extends l {
    ...
    public static final String f6436a = "onFeedbackAlertStatusNotify";
    ...
    public void startShake(Object obj, String str) {
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                com.tkay.expressad.atsignalcommon.c.a.a().a(obj, ((a) obj).f6439a, jSONObject.optString("oldCache", ""), jSONObject.optString("cache", ""));
            }
            callbackSuccess(obj);
        } catch (Throwable th) {
            callbackExcep(obj, th.getMessage());
    ...
    public void stopShake(Object obj, String str) {
        try {
            if (!TextUtils.isEmpty(str)) {
                com.tkay.expressad.atsignalcommon.c.a.a().a(obj, ((a) obj).f6439a, new JSONObject(str).optString("cache", ""));
            }
            callbackSuccess(obj);
        } catch (Throwable th) {
            callbackExcep(obj, th.getMessage());
