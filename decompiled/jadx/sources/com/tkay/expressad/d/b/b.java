...
import com.tkay.expressad.foundation.g.c.c;
...
public class b {
    ...
    private void a(Context context, String str) {
        ...
        String strA = com.tkay.expressad.foundation.a.a.a.a().a(b);
        if (TextUtils.isEmpty(strA) || !strA.equals(str)) {
            try {
                new com.tkay.expressad.d.a.a(context).a(str, (com.tkay.expressad.foundation.g.f.h.b) null, new AnonymousClass1(str));
            } catch (Exception e2) {
                e2.getMessage();
            }
        }
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.d.b.b$1, reason: invalid class name */
    final class AnonymousClass1 extends com.tkay.expressad.foundation.g.f.b.b {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ String f6466a;

        @Override // com.tkay.expressad.foundation.g.f.b.b
        public final void f() {
        }
        ...
        public final void a(String str) {
            ...
            b.this.f = str;
            b.b(b.this, str);
            com.tkay.expressad.foundation.a.a.a.a().a(b.b, this.f6466a);
        }
    }

    /* JADX INFO: renamed from: com.tkay.expressad.d.b.b$2, reason: invalid class name */
    final class AnonymousClass2 implements Runnable {
        ...
        public final void run() throws Throwable {
            try {
                File file = new File(f.b(c.ANYTHINK_OTHER), b.c);
                if (file.exists()) {
                    file.delete();
                }
                m.a(this.f6467a.getBytes(), file);
            } catch (Exception e) {
                String unused = b.f6465a;
                e.getMessage();
            }
        }
    }
    ...
    private static String e() {
        try {
            File file = new File(f.b(c.ANYTHINK_OTHER), c);
            return (file.length() <= 0 || !file.canRead()) ? "" : m.a(file);
        } catch (Exception e2) {
            e2.getMessage();
            return "";
        }
    ...
    public final String b() {
        try {
            ...
            if (TextUtils.isEmpty(this.f)) {
                ...
                if (aVarB != null && !TextUtils.isEmpty(aVarB.M())) {
                    Context contextD = com.tkay.expressad.foundation.b.b.b().d();
                    String strM = aVarB.M();
                    if (contextD != null) {
                        String strA = com.tkay.expressad.foundation.a.a.a.a().a(b);
                        if (TextUtils.isEmpty(strA) || !strA.equals(strM)) {
                            try {
                                new com.tkay.expressad.d.a.a(contextD).a(strM, (com.tkay.expressad.foundation.g.f.h.b) null, new AnonymousClass1(strM));
                            } catch (Exception e2) {
                                e2.getMessage();
                            }
                        }
    ...
    static /* synthetic */ void b(b bVar, String str) {
        new Thread(bVar.new AnonymousClass2(str)).start();
    }
}
