...
public class a {
    ...
    private static final String f6462a = "MraidJSController";
    ...
    private void a(Context context, final String str) {
        ...
        String strA = com.tkay.expressad.foundation.a.a.a.a().a(f6462a);
        if (TextUtils.isEmpty(strA) || !strA.equals(str)) {
            try {
                new com.tkay.expressad.d.a.a(context).a(str, (com.tkay.expressad.foundation.g.f.h.b) null, new com.tkay.expressad.foundation.g.f.b.b() { // from class: com.tkay.expressad.d.b.a.1
                    ...
                    public final void a(String str2) {
                        ...
                        a.this.d = str2;
                        a.b(a.this, str2);
                        com.tkay.expressad.foundation.a.a.a.a().a(a.f6462a, str);
                    }
                });
            } catch (Exception e) {
                e.getMessage();
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.d.b.a$2, reason: invalid class name */
    final class AnonymousClass2 implements Runnable {
        ...
        public final void run() throws Throwable {
            try {
                File file = new File(f.b(c.ANYTHINK_OTHER), "mraid_js.txt");
                if (file.exists()) {
                    file.delete();
                }
                m.a(this.f6464a.getBytes(), file);
            } catch (Exception e) {
                e.getMessage();
            }
        }
    ...
    private void a(String str) {
        com.tkay.core.common.l.b.a.a().a(new AnonymousClass2(str));
    }
    ...
    static /* synthetic */ void b(a aVar, String str) {
        com.tkay.core.common.l.b.a.a().a(aVar.new AnonymousClass2(str));
    }
}
