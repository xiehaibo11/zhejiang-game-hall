...
public final class c implements g {
    ...
    public void a(final com.tkay.expressad.foundation.d.c cVar, final int i, final boolean z) {
        if (!com.tkay.expressad.splash.c.b.a(this.n, cVar)) {
            if (i > 0) {
                this.j.f7106a.postDelayed(new Runnable() { // from class: com.tkay.expressad.splash.d.c.1
    ...
    private void l() {
        TYSplashWebview tYSplashWebview = this.o;
        if (tYSplashWebview != null) {
            tYSplashWebview.setOnTouchListener(new View.OnTouchListener() { // from class: com.tkay.expressad.splash.d.c.2

                /* JADX INFO: renamed from: a, reason: collision with root package name */
                final /* synthetic */ boolean f7121a = true;
        ...
        TYSplashView tYSplashView = this.n;
        if (tYSplashView != null) {
            tYSplashView.setOnTouchListener(new View.OnTouchListener() { // from class: com.tkay.expressad.splash.d.c.3

                /* JADX INFO: renamed from: a, reason: collision with root package name */
                final /* synthetic */ boolean f7122a = true;
