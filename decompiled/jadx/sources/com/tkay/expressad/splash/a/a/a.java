...
public class a {
    ...
    public static String a(int i, float f, float f2) {
        ...
        try {
            ...
            if (i == 4) {
                jSONObject2.put(com.tkay.expressad.foundation.g.a.cc, com.tkay.expressad.video.bt.a.c.f7167a);
                jSONObject2.put(com.tkay.expressad.foundation.g.a.cd, com.tkay.expressad.video.bt.a.c.f7167a);
            } else {
                jSONObject2.put(com.tkay.expressad.foundation.g.a.cc, t.a(m.a().f(), f));
                jSONObject2.put(com.tkay.expressad.foundation.g.a.cd, t.a(m.a().f(), f2));
            }
            jSONObject2.put(com.tkay.expressad.foundation.g.a.cf, i);
            jSONObject2.put(com.tkay.expressad.foundation.g.a.cg, m.a().f().getResources().getConfiguration().orientation);
            jSONObject2.put(com.tkay.expressad.foundation.g.a.ch, t.c(m.a().f()));
