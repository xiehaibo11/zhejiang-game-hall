...
public class b {
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.mbbanner.a.d.b$1, reason: invalid class name */
    ...
    protected final void a(String str, com.tkay.expressad.foundation.d.d dVar, d dVar2) throws Throwable {
        ...
        if (listA.size() == 0) {
            this.e.a(this.f, com.tkay.expressad.reward.a.d.f7047a, str);
            this.g.a(str);
            return;
        }
        this.i.schedule(new AnonymousClass1(str), 60000L);
    ...
    private String a(String str, String str2) throws Throwable {
        ...
        if (!TextUtils.isEmpty(str2)) {
            ...
            try {
                try {
                    String strB = com.tkay.expressad.foundation.g.c.f.b(com.tkay.expressad.foundation.g.c.c.ANYTHINK_700_HTML);
    ...
    /* JADX INFO: renamed from: com.tkay.expressad.mbbanner.a.d.b$2, reason: invalid class name */
    final class AnonymousClass2 implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ com.tkay.expressad.foundation.d.d f6992a;

        AnonymousClass2(com.tkay.expressad.foundation.d.d dVar) {
            this.f6992a = dVar;
        }

        @Override // java.lang.Runnable
        public final void run() {
            String unused = b.f6990a;
            com.tkay.expressad.foundation.d.d dVar = this.f6992a;
            if (dVar != null && dVar.J != null && this.f6992a.J.size() > 0) {
                Context unused2 = b.this.b;
                com.tkay.expressad.mbbanner.a.e.b.a();
            }
            String unused3 = b.f6990a;
        }
    }
