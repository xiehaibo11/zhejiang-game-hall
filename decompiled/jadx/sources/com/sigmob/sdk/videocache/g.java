...
class g extends o {
    ...
    private static final float f5222a = 0.2f;
    private final j b;
    ...
    private boolean a(f fVar) throws p {
        long jA = this.b.a();
        return (((jA > 0L ? 1 : (jA == 0L ? 0 : -1)) > 0) && fVar.c && ((float) fVar.b) > ((float) this.c.a()) + (((float) jA) * f5222a)) ? false : true;
    }
    ...
    protected void a(int i) {
        d dVar = this.d;
        if (dVar != null) {
            dVar.a(this.c.f5216a, this.b.d(), i);
        }
    }
