...
public class h {
    ...
    private static final String f5223a = "127.0.0.1";
    ...
    public static final class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final long f5224a = 536870912;
        private File b;
        private com.sigmob.sdk.videocache.sourcestorage.c e;
        private com.sigmob.sdk.videocache.file.a d = new com.sigmob.sdk.videocache.file.h(f5224a);
    ...
    private h(e eVar) {
        ...
        this.h = (e) n.a(eVar);
        try {
            ServerSocket serverSocket = new ServerSocket(0, 8, InetAddress.getByName(f5223a));
            this.e = serverSocket;
            int localPort = serverSocket.getLocalPort();
            this.f = localPort;
            k.a(f5223a, localPort);
            CountDownLatch countDownLatch = new CountDownLatch(1);
            Thread thread = new Thread(new c(countDownLatch));
            this.g = thread;
            thread.start();
            countDownLatch.await();
            this.i = new m(f5223a, this.f);
    ...
    private String e(String str) {
        return String.format(Locale.US, "http://%s:%d/%s", f5223a, Integer.valueOf(this.f), q.b(str));
    }
    ...
    public File c(String str) {
        return new File(this.h.f5214a, this.h.b.a(str));
    }
