...
public class u extends com.sigmob.sdk.base.common.i {
    ...
    private void a(Context context) {
        ...
        this.r.setOnClickListener(new View.OnClickListener() { // from class: com.sigmob.sdk.nativead.u.3
    ...
    private void q() {
        ...
        this.k.postDelayed(new Runnable() { // from class: com.sigmob.sdk.nativead.u.8
            @Override // java.lang.Runnable
            public void run() {
                if (u.g != null) {
                    u.g.setUIStyle(f.PREVIEW);
                }
                u.this.h().a();
            }
        }, 300L);
    ...
    public void b() {
        ...
        if (g != null) {
            ...
            g.setBackClickListener(new View.OnClickListener() { // from class: com.sigmob.sdk.nativead.u.1
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    u.this.h().onBackPressed();
                }
            ...
            this.k.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: com.sigmob.sdk.nativead.u.2
    ...
    public View l() {
        ...
        this.n.a(new d.a() { // from class: com.sigmob.sdk.nativead.u.4
            ...
            public void a(String str) {
                ...
                u.this.m.a(com.sigmob.sdk.base.a.COMPANION, u.this.n.a(), z);
            ...
            public void f() {
                ...
                if (u.this.s == null) {
                    ...
                    u.this.s.a(new q.b() { // from class: com.sigmob.sdk.nativead.u.4.1
                        ...
                        public void a(String str, String str2) {
                            ...
                            u.this.l.getClickCommon().is_final_click = true;
                            if (u.this.m != null) {
                                u.this.m.a(com.sigmob.sdk.base.a.COMPANION, str, str2, true);
                                u.this.a(IntentActions.ACTION_NATIVE_TEMPLE_CLICK);
                            }
                        }
        ...
        if (!TextUtils.isEmpty(this.l.getHtmlUrl())) {
            this.n.b(this.l.getHtmlUrl(), new d.b() { // from class: com.sigmob.sdk.nativead.u.5
            ...
            this.n.a(this.l.getHtmlData(), new d.b() { // from class: com.sigmob.sdk.nativead.u.6
                @Override // com.sigmob.sdk.mraid.d.b
                public void a(com.sigmob.sdk.mraid.o oVar, com.sigmob.sdk.base.common.r rVar) {
                }
            });
        }
        this.n.a(new d.e() { // from class: com.sigmob.sdk.nativead.u.7
