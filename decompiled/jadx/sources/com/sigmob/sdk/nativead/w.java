...
public class w implements View.OnClickListener, View.OnTouchListener, c.a, l.a, x, WindNativeAdData.DislikeInteractionCallback {
    ...
    protected WindNativeAdData f5130a;
    ...
    private void I() {
        try {
            ...
            if (this.v == null && rootViewFromView != null) {
                ...
                this.v = qVar;
                qVar.a(new q.b() { // from class: com.sigmob.sdk.nativead.w.7
    ...
    private void a(int i, MotionEvent motionEvent) {
        ...
        if (this.f5130a.getAdPatternType() == 1 || this.b.getInteractionType() != 2) {
            this.b.getClickCommon().is_final_click = true;
            x().a(H(), touchLocation2, touchLocation, com.sigmob.sdk.base.a.PREVIEW, this.b);
        } else {
            this.b.getClickCommon().is_final_click = false;
            j().a(com.sigmob.sdk.base.common.a.AD_CLICK, 0);
            I();
    ...
    public void a(View view, List<View> list, List<View> list2, View view2, NativeADEventListener nativeADEventListener) {
        ...
        x().a(new com.sigmob.sdk.base.common.x() { // from class: com.sigmob.sdk.nativead.w.5
            ...
            public void a(boolean z, com.sigmob.sdk.base.a aVar2) {
                ...
                if (z && (abVarJ = w.this.j()) != null) {
                    abVarJ.a(com.sigmob.sdk.base.common.a.AD_CLICK, 0);
                }
            }
        });
        this.j = list2;
        ...
        com.sigmob.sdk.base.common.f.e().a(this.b, new f.b() { // from class: com.sigmob.sdk.nativead.w.6
    ...
    public void a(BaseAdUnit baseAdUnit, WindNativeAdData windNativeAdData) {
        this.b = baseAdUnit;
        this.f5130a = windNativeAdData;
        com.sigmob.sdk.base.common.f.a().getBitmap(k().getAd_source_logo(), new ImageManager.BitmapLoadedListener() { // from class: com.sigmob.sdk.nativead.w.1
    ...
    public void h() {
        ...
        if (abVarJ != null) {
            abVarJ.a(com.sigmob.sdk.base.common.a.AD_HIDE, 0);
        }
        if (this.B || this.C || abVarJ == null) {
            return;
        }
        abVarJ.a(com.sigmob.sdk.base.common.a.AD_VIDEO_LINK, 0);
    }
    ...
    public void i() {
        ...
        com.sigmob.sdk.base.common.ab abVarJ = j();
        if (abVarJ != null) {
            abVarJ.a(com.sigmob.sdk.base.common.a.AD_START, 0);
        }
    }
