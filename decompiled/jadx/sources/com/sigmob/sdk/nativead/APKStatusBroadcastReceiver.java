...
public class APKStatusBroadcastReceiver extends BaseBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (this.f5088a != null && a(intent)) {
            ...
            if (b == 0) {
                this.f5088a.a(zEqualsIgnoreCase, longExtra);
                return;
            }
            if (b == 1) {
                this.f5088a.b(zEqualsIgnoreCase, longExtra);
            } else if (b == 2) {
                this.f5088a.a(zEqualsIgnoreCase);
            } else {
                if (b != 3) {
                    return;
                }
                this.f5088a.b(zEqualsIgnoreCase);
            }
        }
    }
}
