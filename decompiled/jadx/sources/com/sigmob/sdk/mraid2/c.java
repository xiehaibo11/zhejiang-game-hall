...
public class c {
    ...
    private e.b k = new e.b() { // from class: com.sigmob.sdk.mraid2.c.2
        ...
        public LinearLayout a(e eVar, int i) {
            ...
            if (c.this.f == null) {
                ...
                c.this.f5057a.addView(c.this.f.getView(), 0, new ViewGroup.LayoutParams(-1, -1));
            }
    ...
    public c(Context context, List<BaseAdUnit> list, com.sigmob.sdk.base.common.e eVar) {
        ...
        this.g = bVar;
        bVar.a(context);
        e eVar2 = new e(context, list, this.f5057a);
        this.d = eVar2;
        eVar2.setAdSize(eVar);
        this.d.setLoadListener(new e.a() { // from class: com.sigmob.sdk.mraid2.c.1
        ...
        this.h.clear();
        this.h.add(this.d);
        this.f5057a.addView(this.d, new FrameLayout.LayoutParams(-1, -1));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public e a(Context context, e eVar, JSONObject jSONObject) {
        e eVar2 = new e(context, this.i, this.f5057a, eVar, jSONObject);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public Context f() {
        FrameLayout frameLayout = this.f5057a;
        if (frameLayout != null) {
