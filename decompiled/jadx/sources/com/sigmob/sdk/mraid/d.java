...
public class d {
    ...
    private final PlacementType f5006a;
    private final BaseAdUnit b;
    private final FrameLayout c;
    private final C0337d d;
    private final k e;
    ...
    private final b.c x;
    private final b.InterfaceC0335b y;
    ...
    /* JADX INFO: renamed from: com.sigmob.sdk.mraid.d$d, reason: collision with other inner class name */
    static class C0337d {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final Handler f5015a = new Handler();
        private a b;

        /* JADX INFO: renamed from: com.sigmob.sdk.mraid.d$d$a */
        static class a {
        ...
        a a(View... viewArr) {
            a aVar = new a(this.f5015a, viewArr);
            this.b = aVar;
            return aVar;
        }
    ...
    public d(Context context, BaseAdUnit baseAdUnit, PlacementType placementType) {
        this(context, baseAdUnit, placementType, new com.sigmob.sdk.mraid.b(baseAdUnit, placementType), null, new C0337d());
    }

    d(Context context, BaseAdUnit baseAdUnit, PlacementType placementType, com.sigmob.sdk.mraid.b bVar, com.sigmob.sdk.mraid.b bVar2, C0337d c0337d) {
        this.h = false;
        ...
        this.v = true;
        this.w = new HashMap<>();
        this.x = new b.c() { // from class: com.sigmob.sdk.mraid.d.1
        ...
        this.y = new b.InterfaceC0335b() { // from class: com.sigmob.sdk.mraid.d.2
            @Override // com.sigmob.sdk.mraid.b.InterfaceC0335b
            public void a() {
                d.this.j();
                if (d.this.m != null) {
                    d.this.m.a(d.this.c);
            ...
            public void a(int i, int i2, int i3, int i4, a.EnumC0334a enumC0334a, boolean z) {
                if (d.this.m != null) {
                    d.this.m.a(i, i2, i3, i4, enumC0334a, z);
                }
            }
    ...
    void a(int i, int i2, int i3, int i4, a.EnumC0334a enumC0334a, boolean z) throws com.sigmob.sdk.mraid.c {
    }
    ...
    void a(boolean z, j jVar) throws com.sigmob.sdk.mraid.c {
        ...
        this.t = z;
        this.u = jVar;
        if (this.l == ViewState.EXPANDED || (this.f5006a == PlacementType.INTERSTITIAL && !this.v)) {
            n();
        }
    }
    ...
    boolean g() {
        ...
        if (this.f5006a != PlacementType.INLINE) {
            return true;
        }
    ...
    protected void m() {
        ...
        if (this.l == ViewState.EXPANDED || this.f5006a == PlacementType.INTERSTITIAL) {
            o();
        }
