...
public class h {
    ...
    public static final String f5021a = "vnd.android.cursor.item/event";
    ...
    private static class b implements MediaScannerConnection.MediaScannerConnectionClient {
        ...
        public void onMediaScannerConnected() {
            ...
            if (mediaScannerConnection != null) {
                mediaScannerConnection.scanFile(this.f5022a, this.b);
            }
        }
    ...
    public void a(Context context, Map<String, String> map) throws c {
        ...
        try {
            ...
            Intent type = new Intent("android.intent.action.INSERT").setType(f5021a);
