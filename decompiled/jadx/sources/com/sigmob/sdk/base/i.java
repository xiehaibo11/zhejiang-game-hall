...
public class i {
    ...
    private static final String f4887a = "sdkConfigVer";
    private static i b;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void a(SdkConfig sdkConfig) throws Throwable {
        ...
        if (sdkConfig != null) {
            ...
            try {
                ...
                try {
                    ...
                    com.sigmob.sdk.base.utils.c.a().edit().putString(f4887a, "4.9.0").apply();
    ...
    public void e() {
        ...
        String string = com.sigmob.sdk.base.utils.c.a().getString(f4887a, null);
        File file = new File(com.sigmob.sdk.base.utils.b.a() + "/config");
