...
public class BaseMacroCommon implements Serializable {
    ...
    /* JADX INFO: renamed from: com.sigmob.sdk.base.models.BaseMacroCommon$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$sigmob$sdk$base$models$BaseMacroCommon$SigmobMacro;
    ...
    public enum SigmobMacro {
        ...
        static String getMacroValue(String str) {
            switch (AnonymousClass1.$SwitchMap$com$sigmob$sdk$base$models$BaseMacroCommon$SigmobMacro[valueOf(str).ordinal()]) {
                case 1:
