    ...
    */
    public com.sigmob.sdk.base.common.h getAdConfig() {
        ...
        L26:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sigmob.sdk.base.models.BaseAdUnit.getAdConfig():com.sigmob.sdk.base.common.h");
    }
    ...
    public File getAdPrivacyTemplateFile() {
        ...
        return new File(b.b(b.b), strMd5 + ".html");
    }
    ...
    public List<g> getAdTracker(a aVar) {
    ...
    public k.b getCreativeResourceType() {
        return (TextUtils.isEmpty(getEndcard_url()) || !(getCreativeType() == l.CreativeTypeVideo_Tar.a() || getCreativeType() == l.CreativeTypeVideo_Tar_Companion.a())) ? !TextUtils.isEmpty(getHtmlData()) ? k.b.HTML_RESOURCE : !TextUtils.isEmpty(getHtmlUrl()) ? k.b.URL_RESOURCE : k.b.NATIVE_RESOURCE : k.b.NATIVE_RESOURCE;
    }
    ...
    public String getEndCardDirPath() {
        return b.b() + String.format("/%s/", getEndcard_md5());
    }
    ...
    public String getEndCardZipPath() {
        return b.b() + String.format("/%s.tgz", this.endcard_md5);
    }
    ...
    public String getVideoTmpPath() {
        return b.a() + String.format("/%s.mp4.tmp", getVideo_md5());
    }
    ...
    public String resourcePath() {
        return (TextUtils.isEmpty(getEndcard_url()) || !(getCreativeType() == l.CreativeTypeVideo_Tar.a() || getCreativeType() == l.CreativeTypeVideo_Tar_Companion.a())) ? !TextUtils.isEmpty(getHtmlData()) ? getHtmlData() : getHtmlUrl() : getEndCardIndexPath();
    }
