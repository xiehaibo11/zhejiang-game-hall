...
public class j extends RelativeLayout {
    ...
    public j(Context context, BaseAdUnit baseAdUnit, String str, String str2, float f, String str3, int i, int i2, String str4, int i3, int i4, int i5, int i6, int i7, float f2) {
        ...
        this.j = null;
        this.k = 0;
        this.f4957a = Dips.asIntPixels(f2, context);
    ...
    private void d() {
        ...
        objectAnimatorOfPropertyValuesHolder.setInterpolator(new Interpolator() { // from class: com.sigmob.sdk.base.views.j.1
    ...
    private void e() {
        ...
        f();
        this.q = true;
        objectAnimatorOfPropertyValuesHolder.addListener(new AnimatorListenerAdapter() { // from class: com.sigmob.sdk.base.views.j.2
    ...
    private void h() {
        ...
        f();
        translateAnimation.setAnimationListener(new Animation.AnimationListener() { // from class: com.sigmob.sdk.base.views.j.3
    ...
    private void i() {
        ...
        translateAnimation.setInterpolator(new LinearInterpolator());
        translateAnimation.setDuration(500L);
        translateAnimation.setAnimationListener(new Animation.AnimationListener() { // from class: com.sigmob.sdk.base.views.j.4
            @Override // android.view.animation.Animation.AnimationListener
            public void onAnimationEnd(Animation animation) {
                j.this.p = true;
                j.this.j.clearAnimation();
    ...
    public void a(String str) {
        ...
        this.i = imageLoader.get(str, new ImageLoader.ImageListener() { // from class: com.sigmob.sdk.base.views.j.5
