...
public class d extends RelativeLayout {
    ...
    public d(Context context, com.sigmob.sdk.videoAd.e eVar) {
        ...
        this.l = null;
        this.l = eVar;
        this.f4947a = Dips.dipsToIntPixels(10.0f, context);
    ...
    private TextView a(Context context) {
        ...
        textView.setTextColor(n.f4970a);
        textView.setTextSize((float) (((double) this.f4947a) * 0.7d));
        return textView;
    }
    ...
    private TextView b(Context context) {
        ...
        this.k.setTextSize((float) (((double) this.f4947a) * 0.55d));
    ...
    private Button c(Context context) {
        ...
        button.setTextColor(n.f4970a);
        button.setTextSize((float) (((double) this.f4947a) * 0.6d));
        button.setBackgroundColor(0);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(this.e, this.d + this.f4947a);
        int i = this.f4947a;
    ...
    private Button d(Context context) {
        ...
        button.setBackgroundColor(0);
        button.setTextSize((float) (((double) this.f4947a) * 0.6d));
        u.a(button, n.f4970a, this.b, Color.parseColor("#66000000"), this.f4947a, 0, 0);
        return button;
    }
    ...
    private void e(Context context) {
        ...
        u.a(linearLayout, Color.parseColor("#FFFFFF"), this.b, Color.parseColor("#66000000"), this.f4947a, 0, 0);
        ...
        layoutParams2.setMargins(0, 0, 0, this.f4947a * 2);
