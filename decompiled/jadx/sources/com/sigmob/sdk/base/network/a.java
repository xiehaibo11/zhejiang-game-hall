...
public class a extends SigmobRequest<BidResponse> {
    ...
    private void a(final int i, final String str, final String str2, int i2, String str3) {
        z.a(PointCategory.SERVER_ERROR, i2, str3, (BaseAdUnit) null, new z.a() { // from class: com.sigmob.sdk.base.network.a.1
    ...
    private void e() {
        ...
        if (this.b.getAdType() == 2) {
            this.d.material_type.add(Integer.valueOf(com.sigmob.sdk.splash.a.ImageTypeJPEG.a()));
            this.d.material_type.add(Integer.valueOf(com.sigmob.sdk.splash.a.ImageTypePNG.a()));
            this.d.material_type.add(Integer.valueOf(com.sigmob.sdk.splash.a.ImageTypeGIF.a()));
            this.d.creative_type.add(Integer.valueOf(l.CreativeTypeImage.a()));
            this.d.creative_type.add(Integer.valueOf(l.CreativeTypeSplashVideo.a()));
        } else {
            if (this.b.getAdType() == 1 || this.b.getAdType() == 4) {
                this.d.creative_type.add(Integer.valueOf(l.CreativeTypeVideo_Tar.a()));
                this.d.creative_type.add(Integer.valueOf(l.CreativeTypeVideo_Html_Snippet.a()));
                this.d.creative_type.add(Integer.valueOf(l.CreativeTypeVideo_transparent_html.a()));
                this.d.creative_type.add(Integer.valueOf(l.CreativeTypeVideo_EndCardURL.a()));
                this.d.creative_type.add(Integer.valueOf(l.CreativeTypeMRAID.a()));
            }
    ...
    public void deliverResponse(BidResponse bidResponse) {
        if (bidResponse != null) {
            ...
            if (bidResponse.ads.size() <= 0) {
                ...
                this.f4911a.a(bidResponse.error_code.intValue(), bidResponse.error_message, bidResponse.request_id, this.b);
                return;
            }
            try {
                ...
                this.f4911a.a(arrayList, this.b);
                return;
            } catch (Throwable th) {
                SigmobLog.e("ads Response: error ", th);
            }
        }
        this.f4911a.a(WindAdError.ERROR_SIGMOB_INFORMATION_LOSE.getErrorCode(), "bidResponse is null", null, this.b);
    }
