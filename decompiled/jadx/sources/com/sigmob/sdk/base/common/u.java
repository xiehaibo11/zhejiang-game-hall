...
public class u extends i {
    ...
    private void a() {
        if (this.f == null) {
            try {
                ...
                this.f.setWebViewClient(new com.sigmob.sdk.base.e() { // from class: com.sigmob.sdk.base.common.u.1
                    ...
                    public boolean shouldOverrideUrlLoading(WebView webView, String str) {
                            ...
                            if ("sigmobAd".equalsIgnoreCase(scheme)) {
                                ...
                                if (!TextUtils.isEmpty(host) && ("track".equals(host) || "active".equals(host))) {
                                    ...
                                    if (!TextUtils.isEmpty(queryParameter2) && !TextUtils.isEmpty(queryParameter)) {
                                        ...
                                        z.a(host, queryParameter2, u.this.h, new z.a() { // from class: com.sigmob.sdk.base.common.u.1.1
                        ...
                        if (list != null && list.size() > 0) {
                            for (i = 0; i < list.size(); i++) {
                                ...
                                z.a(com.sigmob.sdk.base.a.LAND_PAGE, "click", u.this.h, "1", str, u.this.l);
                            }
                        }
                        return true;
                    }
                });
                this.f.setWebChromeClient(new WebChromeClient() { // from class: com.sigmob.sdk.base.common.u.2
        ...
        if (this.h.getAd() != null && this.h.getAd().ad_setting != null && !this.h.getAd().ad_setting.disable_download_listener.booleanValue()) {
            this.f.setDownloadListener(new DownloadListener() { // from class: com.sigmob.sdk.base.common.u.3
                @Override // android.webkit.DownloadListener
                public void onDownloadStart(String str, String str2, String str3, String str4, long j) {
                    n.a(str, u.this.h);
                    z.a(com.sigmob.sdk.base.a.LAND_PAGE, "click", u.this.h, "0", str, u.this.l);
                    SigmobLog.d("onDownloadStart() called with: url = [" + str + "], userAgent = [" + str2 + "], contentDisposition = [" + str3 + "], mimetype = [" + str4 + "], contentLength = [" + j + "]");
                }
            });
        }
        this.f.setOnTouchListener(new View.OnTouchListener() { // from class: com.sigmob.sdk.base.common.u.4

            /* JADX INFO: renamed from: a, reason: collision with root package name */
            MotionEvent f4866a = null;

            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
                SigmobLog.d(motionEvent.toString());
                if (motionEvent.getAction() == 0) {
                    this.f4866a = MotionEvent.obtain(motionEvent);
                } else if (motionEvent.getAction() == 1) {
                    MotionEvent motionEvent2 = this.f4866a;
                    if (motionEvent2 == null) {
                        ...
                        u.this.l = String.format("%d,%d,%d,%d", Integer.valueOf((int) motionEvent2.getRawX()), Integer.valueOf((int) this.f4866a.getRawY()), Integer.valueOf((int) motionEvent.getRawX()), Integer.valueOf((int) motionEvent.getRawY()));
                    }
                }
                return false;
            }
    ...
    private void a(String str, String str2, BaseAdUnit baseAdUnit, final String str3) {
        z.a(str2, str, baseAdUnit, new z.a() { // from class: com.sigmob.sdk.base.common.u.5
            @Override // com.sigmob.sdk.base.common.z.a
            public void a(Object obj) {
                if (obj instanceof PointEntitySigmob) {
    ...
    private void l() {
        if (this.i == null) {
            ...
            this.k = imageView;
            imageView.setImageBitmap(com.sigmob.sdk.base.views.o.BACK.a());
            this.k.setScaleType(ImageView.ScaleType.CENTER_CROP);
            this.k.setClickable(true);
            this.k.setId(ClientMetadata.generateViewId());
            this.k.setOnClickListener(new View.OnClickListener() { // from class: com.sigmob.sdk.base.common.u.6
