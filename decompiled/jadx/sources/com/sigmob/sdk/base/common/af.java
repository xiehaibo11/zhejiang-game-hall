...
public enum af {
    IGNORE_ABOUT_SCHEME(0 == true ? 1 : 0) { // from class: com.sigmob.sdk.base.common.af.1
    ...
    MINI_PROGRAM(0 == true ? 1 : 0) { // from class: com.sigmob.sdk.base.common.af.2
        @Override // com.sigmob.sdk.base.common.af
        public String a(BaseAdUnit baseAdUnit) {
    ...
    FOLLOW_DEEP_LINK(1 == true ? 1 : 0) { // from class: com.sigmob.sdk.base.common.af.3
        @Override // com.sigmob.sdk.base.common.af
        public String a(BaseAdUnit baseAdUnit) {
            if (baseAdUnit == null) {
                return null;
    ...
    MARKET_SCHEME(0 == true ? 1 : 0) { // from class: com.sigmob.sdk.base.common.af.4
        @Override // com.sigmob.sdk.base.common.af
        public String a(BaseAdUnit baseAdUnit) {
    ...
    DOWNLOAD_APK(1 == true ? 1 : 0) { // from class: com.sigmob.sdk.base.common.af.5
        @Override // com.sigmob.sdk.base.common.af
        public String a(BaseAdUnit baseAdUnit) {
            if (baseAdUnit == null) {
                return null;
    ...
    OPEN_WITH_BROWSER(1 == true ? 1 : 0) { // from class: com.sigmob.sdk.base.common.af.6
        @Override // com.sigmob.sdk.base.common.af
        public String a(BaseAdUnit baseAdUnit) {
            if (baseAdUnit == null) {
                return null;
    ...
    NOOP(0 == true ? 1 : 0) { // from class: com.sigmob.sdk.base.common.af.7
        @Override // com.sigmob.sdk.base.common.af
        public String a(BaseAdUnit baseAdUnit) {
            return null;
        }
