...
public class n {
    ...
    private static Map<String, String> f4852a = new Hashtable();
    ...
    public static void a(final String str, BaseAdUnit baseAdUnit) {
        ...
        try {
            ...
            SigmobLog.e(th.getMessage());
            if (baseAdUnit.isRecord()) {
                z.a(PointCategory.DOWNLOAD_START, "0", baseAdUnit, new z.a() { // from class: com.sigmob.sdk.base.common.n.5
                ...
                z.a(PointCategory.DOWNLOAD_START, 0, th.getMessage(), baseAdUnit, new z.a() { // from class: com.sigmob.sdk.base.common.n.6
                    @Override // com.sigmob.sdk.base.common.z.a
                    public void a(Object obj) {
    ...
    private static void a(String str, final String str2, BaseAdUnit baseAdUnit) {
        ...
        try {
            ...
            boolean zContainsKey = f4852a.containsKey(baseAdUnit.getUuid());
            ...
            f4852a.put(baseAdUnit.getUuid(), str4);
            ...
            if (jA != -1) {
                ...
                if (baseAdUnit.isRecord()) {
                    z.a(PointCategory.DOWNLOAD_START, "1", baseAdUnit, new z.a() { // from class: com.sigmob.sdk.base.common.n.1
                        @Override // com.sigmob.sdk.base.common.z.a
                ...
                if (baseAdUnit.isRecord()) {
                    z.a(PointCategory.DOWNLOAD_START, "0", baseAdUnit, new z.a() { // from class: com.sigmob.sdk.base.common.n.2
                        @Override // com.sigmob.sdk.base.common.z.a
                        public void a(Object obj2) {
                            if (obj2 instanceof PointEntitySigmob) {
                                PointEntitySigmob pointEntitySigmob = (PointEntitySigmob) obj2;
            ...
            SigmobLog.e(th2.getMessage());
            if (baseAdUnit.isRecord()) {
                z.a(PointCategory.DOWNLOAD_START, "0", baseAdUnit, new z.a() { // from class: com.sigmob.sdk.base.common.n.3
                    @Override // com.sigmob.sdk.base.common.z.a
                    public void a(Object obj2) {
                        if (obj2 instanceof PointEntitySigmob) {
                ...
                z.a(PointCategory.DOWNLOAD_START, 0, th2.getMessage(), baseAdUnit, new z.a() { // from class: com.sigmob.sdk.base.common.n.4
                    @Override // com.sigmob.sdk.base.common.z.a
                    public void a(Object obj2) {
    ...
    public static void b(long j, String str) {
        for (a aVar : b) {
            if (aVar.c == j || aVar.f4859a.equalsIgnoreCase(str)) {
                b.remove(aVar);
                return;
            }
        }
