...
public class EventForwardingBroadcastReceiver extends BaseBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (this.c == null || this.f4793a == null || !a(intent)) {
            return;
        }
        ...
        if (b2 == 0) {
            this.c.b(this.f4793a, intent.getStringExtra("error"));
            return;
        }
        if (b2 == 1) {
            this.c.e(this.f4793a);
            return;
        }
        if (b2 == 2) {
            this.c.b(this.f4793a);
            return;
        }
        if (b2 != 3) {
            if (b2 != 4) {
            ...
            this.c.c(this.f4793a);
        } else {
            this.c.d(this.f4793a);
            b(this);
            this.f4793a = null;
        }
    }
