...
public class ac {
    ...
    private static final class b {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final IntentFilter f4801a;
        final BroadcastReceiver b;
        boolean c;
        boolean d;

        b(IntentFilter intentFilter, BroadcastReceiver broadcastReceiver) {
            this.f4801a = intentFilter;
    ...
    private ac(Context context) {
        this.f = context;
        this.j = new Handler(context.getMainLooper()) { // from class: com.sigmob.sdk.base.common.ac.1
        ...
        while (true) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    if (!bVar.d) {
                        bVar.b.onReceive(this.f, aVar.f4800a);
                    }
                }
            }
        }
    ...
    public void a(BroadcastReceiver broadcastReceiver) {
        synchronized (this.g) {
            ...
            for (int size = arrayListRemove.size() - 1; size >= 0; size--) {
                ...
                bVar.d = true;
                for (int i = 0; i < bVar.f4801a.countActions(); i++) {
                    String action = bVar.f4801a.getAction(i);
        ...
        synchronized (this.g) {
            ...
            if (arrayList3 != null) {
                ...
                while (i3 < arrayList3.size()) {
                    ...
                    if (z) {
                        Log.v(b, "Matching against filter " + bVar.f4801a);
                    }
                    if (bVar.c) {
                        if (z) {
                        ...
                        str2 = strResolveTypeIfNeeded;
                        uri = data;
                        int iMatch = bVar.f4801a.match(action, strResolveTypeIfNeeded, scheme, data, categories, b);
                        if (iMatch >= 0) {
                            if (z) {
