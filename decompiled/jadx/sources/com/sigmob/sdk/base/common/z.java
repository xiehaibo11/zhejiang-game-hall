...
public class z {
    ...
    public static void a(com.sigmob.sdk.base.a aVar, final String str, final BaseAdUnit baseAdUnit, final String str2, final String str3, final String str4, final long j) {
        a(aVar == null ? str : aVar.name().toLowerCase(), str, baseAdUnit, new a() { // from class: com.sigmob.sdk.base.common.z.6
    ...
    public static void a(final g gVar, final String str, BaseAdUnit baseAdUnit, final NetworkResponse networkResponse, final a aVar) {
        ae.a(gVar.n()).c("13").a(baseAdUnit).a(new a() { // from class: com.sigmob.sdk.base.common.z.4
            @Override // com.sigmob.sdk.base.common.z.a
            public void a(Object obj) {
                if (obj instanceof PointEntitySigmob) {
                    PointEntitySigmob pointEntitySigmob = (PointEntitySigmob) obj;
    ...
    public static void a(g gVar, String str, BaseAdUnit baseAdUnit, final VolleyError volleyError) {
        ...
        a(gVar, str, baseAdUnit, networkResponse, networkResponse == null ? new a() { // from class: com.sigmob.sdk.base.common.z.3
            @Override // com.sigmob.sdk.base.common.z.a
            public void a(Object obj) {
                if (obj instanceof PointEntitySigmob) {
                    PointEntitySigmob pointEntitySigmob = (PointEntitySigmob) obj;
    ...
    public static void a(final BaseAdUnit baseAdUnit, final String str, final PackageInfo packageInfo, final String str2) {
        ThreadPoolFactory.BackgroundThreadPool.getInstance().submit(new Runnable() { // from class: com.sigmob.sdk.base.common.z.5
            @Override // java.lang.Runnable
            public void run() {
                z.a(str, str2, baseAdUnit, new a() { // from class: com.sigmob.sdk.base.common.z.5.1
                    @Override // com.sigmob.sdk.base.common.z.a
                    public void a(Object obj) {
    ...
    public static void a(BaseAdUnit baseAdUnit, String str, final String str2) {
        a(PointCategory.TARGET_URL, (String) null, baseAdUnit, new a() { // from class: com.sigmob.sdk.base.common.z.2
            @Override // com.sigmob.sdk.base.common.z.a
            public void a(Object obj) {
                if (obj instanceof PointEntitySigmob) {
    ...
    public static void a(String str, String str2, BaseAdUnit baseAdUnit, WindAdRequest windAdRequest, LoadAdRequest loadAdRequest, final a aVar) {
        ae.a(str).d(str2).a(baseAdUnit).a(windAdRequest).a(loadAdRequest).a(new a() { // from class: com.sigmob.sdk.base.common.z.1
            @Override // com.sigmob.sdk.base.common.z.a
            public void a(Object obj) {
                a aVar2 = aVar;
                if (aVar2 != null) {
