...
public final class a {
    ...
    /* JADX INFO: renamed from: com.sigmob.sdk.base.utils.a$a, reason: collision with other inner class name */
    private static class AsyncTaskC0332a extends AsyncTask<String, Void, Boolean> {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final File f4939a;
        private final File b;
        private final b c;

        AsyncTaskC0332a(File file, File file2, b bVar) {
            this.f4939a = file2;
            this.b = file;
            this.c = bVar;
        }
    ...
    public static void a(File file, File file2, b bVar) {
        new AsyncTaskC0332a(file, file2, bVar);
