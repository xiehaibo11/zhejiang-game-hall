...
public class g extends RelativeLayout implements View.OnClickListener, View.OnTouchListener, SeekBar.OnSeekBarChangeListener, i {
    ...
    public static final String f5250a = "VideoPlayerView";
    ...
    /* JADX INFO: renamed from: com.sigmob.sdk.videoplayer.g$3, reason: invalid class name */
    static /* synthetic */ class AnonymousClass3 {
        ...
        static {
            ...
            try {
                f5253a[f.RETRY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f5253a[f.VOLUME.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f5253a[f.FULLSCREEN.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f5253a[f.BIGRETRY.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f5253a[f.BACK.ordinal()] = 6;
    ...
    public class a extends TimerTask {
        ...
        public void run() {
            if (g.this.w == 4 || g.this.w == 5) {
                g.this.post(new Runnable() { // from class: com.sigmob.sdk.videoplayer.g.a.1
    ...
    private class c extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            int streamVolume;
            if (!g.V.equals(intent.getAction()) || intent.getIntExtra(g.W, -1) != 3 || this.f5256a == null || (streamVolume = ((AudioManager) g.this.getApplicationContext().getSystemService("audio")).getStreamVolume(3)) < 0) {
                return;
            }
            this.f5256a.a(streamVolume);
        }
    }
    ...
    public void a(f fVar, boolean z) {
        ViewGroup viewGroup;
        int i2 = 0;
        switch (AnonymousClass3.f5253a[fVar.ordinal()]) {
            case 1:
                viewGroup = this.ab;
                if (!z) {
                }
