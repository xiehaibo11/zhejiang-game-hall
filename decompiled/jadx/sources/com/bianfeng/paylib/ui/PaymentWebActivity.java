...
public class PaymentWebActivity extends Activity {
    ...
    private void initData() {
        ...
        this.webView.registerHandler("payInH5", new BridgeHandler() { // from class: com.bianfeng.paylib.ui.PaymentWebActivity.1
        ...
        this.webView.registerHandler("closePayWindow", new BridgeHandler() { // from class: com.bianfeng.paylib.ui.PaymentWebActivity.2
            @Override // com.github.lzyzsd.jsbridge.BridgeHandler
            public void handler(String str, CallBackFunction callBackFunction) {
