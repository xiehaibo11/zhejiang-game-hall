...
public class HttpHelper {
    ...
    class a implements Runnable {
                    ...
                    try {
                        if (HttpHelper.this.method.equals("GET")) {
                            if (this.f1422a == null || this.f1422a.isEmpty()) {
                                ...
                                Map<String, Object> infoMap = (Map) new Gson().fromJson(URLDecoder.decode(this.f1422a), new C0037a(this).getType());
                                String appendString = "?";
                            ...
                            outputStream.write(String.valueOf(this.f1422a).getBytes("UTF-8"));
                            outputStream.flush();
                            outputStream.close();
                        }
        ...
        /* JADX INFO: renamed from: com.bianfeng.ymnsdk.action.HttpHelper$a$a, reason: collision with other inner class name */
        class C0037a extends TypeToken<Map<String, Object>> {
            C0037a(a this$1) {
            }
        }
    }
