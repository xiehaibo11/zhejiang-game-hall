...
public final class Base64 {
    ...
    public static String AESencode(String str, String str2) throws GeneralSecurityException {
        byte[] bytes = str.getBytes();
        SecretKeySpec secretKeySpec = new SecretKeySpec(decode(str2), "AES");
        Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5Padding");
        cipher.init(1, secretKeySpec);
        return encode(cipher.doFinal(bytes)).replaceAll("\r", "").replaceAll("\n", "");
    }
}
