...
public class CoustomDialog {
    public static void sysMessageBox(Activity activity, String str, String str2, String str3, final SysfuncInterface sysfuncInterface) {
        ...
        if (length > 0 && strArrSplit[0] != null) {
            builder.setPositiveButton(strArrSplit[0], new DialogInterface.OnClickListener() { // from class: com.bianfeng.ymnsdk.sysfunc.CoustomDialog.1
        ...
        if (i < length && strArrSplit[i] != null) {
            builder.setNeutralButton(strArrSplit[i], new DialogInterface.OnClickListener() { // from class: com.bianfeng.ymnsdk.sysfunc.CoustomDialog.2
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int i2) {
        ...
        if (i < length && strArrSplit[i] != null) {
            builder.setNegativeButton(strArrSplit[i], new DialogInterface.OnClickListener() { // from class: com.bianfeng.ymnsdk.sysfunc.CoustomDialog.3
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int i2) {
