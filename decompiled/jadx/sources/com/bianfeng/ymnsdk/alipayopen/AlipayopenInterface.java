...
public class AlipayopenInterface extends YmnPaymentInterface {
    ...
    public void pay(Map<String, String> map) {
        ...
        try {
            ...
            PaySdk.pay(getActivity(), new String(Base64.decode(strOptString)), new OnPayListener() { // from class: com.bianfeng.ymnsdk.alipayopen.AlipayopenInterface.1
                @Override // com.alipayopen.sdk.OnPayListener
