...
/* JADX INFO: compiled from: YmnPluginManager.java */
/* JADX INFO: loaded from: classes.dex */
public class c {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private static HashMap<String, YmnPluginWrapper> f1434a = new HashMap<>();
    ...
    private static void a(List<YmnPluginWrapper> items) {
        if (items != null && !items.isEmpty()) {
            for (YmnPluginWrapper plugin : items) {
                f1434a.put(YmnPlugin.b.a(plugin), plugin);
            }
        }
    }
    ...
    private static void a(Context context) {
        ...
        for (YmnPluginWrapper plugin : f1434a.values()) {
    ...
    private static void d(Context context) {
        ...
        Iterator<YmnPluginWrapper> it = f1434a.values().iterator();
        while (it.hasNext()) {
