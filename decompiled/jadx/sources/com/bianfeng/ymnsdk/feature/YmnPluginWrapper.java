...
public abstract class YmnPluginWrapper extends YmnPlugin {
    ...
    static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f1432a = new int[YPlugin.Policy.values().length];

        static {
            try {
                f1432a[YPlugin.Policy.LAZY.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f1432a[YPlugin.Policy.REMOTE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f1432a[YPlugin.Policy.FORCE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f1432a[YPlugin.Policy.TRIGGER.ordinal()] = 4;
    ...
    public void checkState(PluginLocalState local) {
        int i = a.f1432a[getPolicy().ordinal()];
        if (i == 1) {
