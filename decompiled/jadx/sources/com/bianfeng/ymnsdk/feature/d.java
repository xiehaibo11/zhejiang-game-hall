...
/* JADX INFO: compiled from: YmnPreferences.java */
/* JADX INFO: loaded from: classes.dex */
public class d {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private static Gson f1435a = new Gson();
    ...
    public static Map<String, UrlConfig> f(Context context) {
        ...
        if (!TextUtils.isEmpty(configs)) {
            Map<String, UrlConfig> remoteConfigs2 = (Map) f1435a.fromJson(configs, new a().getType());
    ...
    public static UrlLocalState e(Context context) {
        ...
        return (UrlLocalState) f1435a.fromJson(config, UrlLocalState.class);
    }
    ...
    public static <T> T a(Context context, String str, Class<T> cls) throws Exception {
        ...
        if (!TextUtils.isEmpty(preferences)) {
            return (T) f1435a.fromJson(preferences, (Class) cls);
        }
    ...
    public static void a(Context context, String cfgKey, Object localState) {
        if (localState != null) {
            ResourceUtil.savePreferences(context, cfgKey, f1435a.toJson(localState));
        }
    }
    ...
    static class b implements f.a {
        ...
        @Override // com.bianfeng.ymnsdk.feature.f.a
