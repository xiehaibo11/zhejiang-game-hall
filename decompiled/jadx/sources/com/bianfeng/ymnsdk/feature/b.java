...
/* JADX INFO: compiled from: YmnPluginLoader.java */
/* JADX INFO: loaded from: classes.dex */
public class b {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private static Map<String, JsonElement> f1433a = new HashMap();
    ...
    public static void a(Context context) {
        try {
            ...
            if (ResourceUtil.assetFileExist(context, "plugins.ymn")) {
                Gson gson = new Gson();
                f1433a = (Map) gson.fromJson(new InputStreamReader(am.open("plugins.ymn")), new a().getType());
            }
        } catch (Exception e) {
    ...
    public static List<YmnPluginWrapper> b(Context context) {
        if (f1433a.containsKey("apiClass")) {
            Gson gson = new Gson();
            List<String> clsNames = (List) gson.fromJson(f1433a.get("apiClass"), List.class);
