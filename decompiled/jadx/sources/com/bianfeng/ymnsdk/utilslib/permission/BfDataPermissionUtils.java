...
public class BfDataPermissionUtils {
    ...
    public boolean requestPermissions(final int code) {
        ...
        if (this.lists.size() > 0) {
            ...
            this.activity.runOnUiThread(new Runnable() { // from class: com.bianfeng.ymnsdk.utilslib.permission.BfDataPermissionUtils.1
    ...
    protected class RequestPermissionsResultCallbackImpl implements RequestPermissionsResultCallback {
        ...
        @Override // com.bianfeng.ymnsdk.utilslib.permission.BfDataPermissionUtils.RequestPermissionsResultCallback
        public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
