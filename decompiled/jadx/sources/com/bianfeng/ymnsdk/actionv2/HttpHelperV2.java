...
public class HttpHelperV2 {
    ...
    public static HttpURLConnection getProxy(Context context, URL url) {
        ConnectivityManager cm2 = (ConnectivityManager) context.getSystemService("connectivity");
    ...
    public HttpURLConnection createHttpRequest(String urlString, String postContent, String token, String trace) {
    ...
    class a extends Thread {
        ...
        final /* synthetic */ PayTokenEntity.PayloadEntity f1425a;
        ...
        public void run() {
            this.f1425a.setAud(this.b);
            String token = SecurityUtil.getInstance().getPayToken(PayTokenEntity.getHeader, this.f1425a.toString());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean openUrl(HttpURLConnection connection, HttpListener listerner) {
