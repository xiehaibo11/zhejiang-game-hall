...
public class HostHttpHelper {
    ...
    public HttpURLConnection createHttpRequest(String urlString, String postContent) {
    ...
    class a extends Thread {
        ...
        public void run() {
            HttpURLConnection request = HostHttpHelper.this.createHttpRequest(this.f1475a, this.b);
