...
public interface UserWrapper {
    ...
    public static final int ACTION_RET_LOGIN_YMN_FAIL = 119;
    public static final int ACTION_RET_LOGIN_YMN_SERVERSUCCESS = 118;
    ...
    public static final int ACTION_SET_YMNSDK_VERSION = 118;
}
