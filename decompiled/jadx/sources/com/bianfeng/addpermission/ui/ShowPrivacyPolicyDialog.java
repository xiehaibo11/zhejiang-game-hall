...
public class ShowPrivacyPolicyDialog extends Dialog implements View.OnClickListener {
    ...
    private void initdata() {
        ...
        this.show_policy_bg_rl.setOnClickListener(new View.OnClickListener() { // from class: com.bianfeng.addpermission.ui.ShowPrivacyPolicyDialog.3
