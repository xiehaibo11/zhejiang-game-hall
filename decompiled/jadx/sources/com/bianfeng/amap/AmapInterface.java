...
public class AmapInterface extends YmnPluginWrapper {
    ...
    AMapLocationListener locationListener = new AMapLocationListener() { // from class: com.bianfeng.amap.AmapInterface.2
    ...
    public void getLocation(String str) {
        ...
        BfDataPermissionUtils.newInstance(getActivity()).setCallback(new BfDataPermissionUtils.PermissCallback() { // from class: com.bianfeng.amap.AmapInterface.1
    ...
    public void getLocationWithSport() {
        ...
        flag = 0;
        BfDataPermissionUtils.newInstance(getActivity()).setCallback(new BfDataPermissionUtils.PermissCallback() { // from class: com.bianfeng.amap.AmapInterface.3
            @Override // com.bianfeng.ymnsdk.utilslib.permission.BfDataPermissionUtils.PermissCallback
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void getLocationWithSportAfter() {
        AMapLocationClient aMapLocationClient = this.locationClient;
        if (aMapLocationClient != null && aMapLocationClient.isStarted()) {
            this.locationClient.stopLocation();
        }
