...
public class YidongLoginInterface extends YmnChannelInterface {
    ...
    private void initSdk() {
        ...
        genAuthnHelper.setPageInListener(new GenLoginPageInListener() { // from class: com.bianfeng.yidonglogin.YidongLoginInterface.1
        ...
        this.mListener = new GenTokenListener() { // from class: com.bianfeng.yidonglogin.YidongLoginInterface.2
        ...
        }).setGenCheckBoxListener(new GenCheckBoxListener() { // from class: com.bianfeng.yidonglogin.YidongLoginInterface.4
            @Override // com.cmic.gen.sdk.view.GenCheckBoxListener
            public void onLoginClick(final Context context, JSONObject jSONObject) {
                YidongLoginInterface.this.tryRunOnUiThreadOrJustRun(new Runnable() { // from class: com.bianfeng.yidonglogin.YidongLoginInterface.4.1
