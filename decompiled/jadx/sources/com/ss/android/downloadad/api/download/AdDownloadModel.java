...
import com.ss.android.download.api.q.df;
...
public class AdDownloadModel implements DownloadModel {
    ...
    public boolean shouldDownloadWithPatchApply() {
        return df.rg(DownloadSetting.obtain(getDownloadSettings()), getMimeType());
    }
    ...
    public AdDownloadModel setQuickAppModel(q qVar) {
        this.mQuickAppModel = qVar;
        return this;
    }
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.putOpt(m.a.c, this.mFilePath);
            ...
            if (this.mQuickAppModel != null) {
                jSONObject.putOpt("quick_app_url", this.mQuickAppModel.rg());
            }
            ...
            bm.qx().rg(e, "AdDownloadModel toJson");
        }
        return jSONObject;
    }
    ...
    public static AdDownloadModel fromJson(JSONObject jSONObject) {
        ...
        try {
            ...
            bm.qx().rg(e, "AdDownloadModel fromJson");
        }
    ...
    private static void appendQuickAppUrlFromJson(JSONObject jSONObject, Builder builder) {
        ...
        builder.setQuickAppModel(new q.rg().rg(strOptString).rg());
    }
    ...
    public static final class Builder {
        ...
        public Builder setQuickAppModel(q qVar) {
            this.model.mQuickAppModel = qVar;
            return this;
        }
