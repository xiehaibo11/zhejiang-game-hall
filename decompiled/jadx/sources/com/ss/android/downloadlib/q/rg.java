...
public class rg implements IDownloadCompleteHandler {
    ...
    private void rg(Context context, final DownloadInfo downloadInfo) {
        ...
        if (cursorQuery != null && cursorQuery.moveToFirst()) {
            ...
            MediaScannerConnection.scanFile(context, new String[]{str}, new String[]{AdBaseConstants.MIME_APK}, new MediaScannerConnection.OnScanCompletedListener() { // from class: com.ss.android.downloadlib.q.rg.1
