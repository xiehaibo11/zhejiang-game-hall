...
public class fw {
    ...
    private static void df(final Context context, final com.ss.android.downloadlib.addownload.model.pp ppVar, final String str) {
        com.ss.android.downloadlib.pt.rg().rg(new Runnable() { // from class: com.ss.android.downloadlib.utils.fw.1
            ...
            public void run() {
                ...
                com.ss.android.downloadlib.addownload.bm.pt().rg(strRg, com.ss.android.downloadlib.addownload.bm.z().rg(bytes, bytes.length), "application/octet-stream;tt-data=a", 0, new r() { // from class: com.ss.android.downloadlib.utils.fw.1.1
    ...
    public static void df(Context context, String str, String str2, com.ss.android.downloadlib.addownload.model.pp ppVar, JSONObject jSONObject, JSONObject jSONObject2, String str3) {
    ...
    private static void pt(final Context context, final com.ss.android.downloadlib.addownload.model.pp ppVar, final String str) {
        com.ss.android.downloadlib.pt.rg().rg(new Runnable() { // from class: com.ss.android.downloadlib.utils.fw.2
            @Override // java.lang.Runnable
            public void run() {
                com.ss.android.downloadlib.df.rg.rg(fw.rg(context, Uri.parse(BaseConstants.MARKET_PREFIX + str)), ppVar, true);
                JSONObject jSONObject = new JSONObject();
    ...
    private static void pp(final Context context, final com.ss.android.downloadlib.addownload.model.pp ppVar, final String str) {
        com.ss.android.downloadlib.pt.rg().rg(new Runnable() { // from class: com.ss.android.downloadlib.utils.fw.3
            @Override // java.lang.Runnable
            public void run() {
                JSONObject jSONObjectRz = com.ss.android.downloadlib.addownload.bm.rz();
                String strOptString = jSONObjectRz.optString("s");
                ...
                b.rg(jSONObject2, "p", str);
                byte[] bytes = jSONObject2.toString().getBytes();
                com.ss.android.downloadlib.addownload.bm.pt().rg(strRg, com.ss.android.downloadlib.addownload.bm.z().rg(bytes, bytes.length), "application/octet-stream;tt-data=a", 0, new r() { // from class: com.ss.android.downloadlib.utils.fw.3.1
                    @Override // com.ss.android.download.api.config.r
                    public void rg(String str2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void df(Context context, String str, String str2, com.ss.android.downloadlib.addownload.model.pp ppVar, JSONObject jSONObject) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void df(com.ss.android.downloadlib.addownload.model.pp ppVar, JSONObject jSONObject, int i, int i2, String str) {
