...
class pp implements com.ss.android.download.api.rg {
    ...
    @Override // com.ss.android.download.api.rg
    ...
    public com.ss.android.download.api.rg rg(final com.ss.android.download.api.config.df dfVar) {
        bm.rg(dfVar);
        AppStatusManager.getInstance().setInnerAppStatusChangeCaller(new AppStatusManager.InnerAppStatusChangeCaller() { // from class: com.ss.android.downloadlib.pp.1
    ...
    public com.ss.android.download.api.rg rg(DownloaderBuilder downloaderBuilder) {
        if (downloaderBuilder.getNotificationClickCallback() == null) {
            downloaderBuilder.notificationClickCallback(new INotificationClickCallback() { // from class: com.ss.android.downloadlib.pp.2
    ...
    public void rg() {
        ...
        pt.rg().df(new Runnable() { // from class: com.ss.android.downloadlib.pp.3
