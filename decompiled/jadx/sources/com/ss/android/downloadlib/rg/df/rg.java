...
public class rg {
    ...
    public final List<InterfaceC0354rg> df = new ArrayList();
    private final ServiceConnection oh = new ServiceConnection() { // from class: com.ss.android.downloadlib.rg.df.rg.1
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            synchronized (rg.this.q) {
                ...
                rg.this.q();
                Iterator<InterfaceC0354rg> it = rg.this.df.iterator();
                while (it.hasNext()) {
                    it.next().rg();
                }
            }
    ...
    /* JADX INFO: renamed from: com.ss.android.downloadlib.rg.df.rg$rg, reason: collision with other inner class name */
    public interface InterfaceC0354rg {
        void df();
