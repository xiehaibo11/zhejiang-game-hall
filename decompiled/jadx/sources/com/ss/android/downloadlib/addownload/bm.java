...
public class bm {
    ...
    public static com.ss.android.download.api.config.q df() {
        if (pt == null) {
            pt = new com.ss.android.download.api.config.q() { // from class: com.ss.android.downloadlib.addownload.bm.1
    ...
    public static com.ss.android.socialbase.appdownloader.q.ux c() {
        if (b == null) {
            b = new com.ss.android.socialbase.appdownloader.q.ux() { // from class: com.ss.android.downloadlib.addownload.bm.2
    ...
    public static un ux() {
        if (qx == null) {
            qx = new un() { // from class: com.ss.android.downloadlib.addownload.bm.3
                @Override // com.ss.android.download.api.config.un
    ...
    public static com.ss.android.download.api.df.rg qx() {
        if (n == null) {
            n = new com.ss.android.download.api.df.rg() { // from class: com.ss.android.downloadlib.addownload.bm.4
                @Override // com.ss.android.download.api.df.rg
    ...
    public static qx n() {
        if (y == null) {
            y = new qx() { // from class: com.ss.android.downloadlib.addownload.bm.5
                @Override // com.ss.android.download.api.config.qx
