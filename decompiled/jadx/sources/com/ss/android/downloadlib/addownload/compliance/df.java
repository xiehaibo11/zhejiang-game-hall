...
public class df {
    ...
    public boolean rg(com.ss.android.downloadlib.addownload.model.pp ppVar) {
        ...
        final long j3 = j;
        Chain.rg((Chain.rg<String, R>) new Chain.rg<String, Boolean>() { // from class: com.ss.android.downloadlib.addownload.compliance.df.2
            @Override // com.ss.android.downloadlib.utils.Chain.rg
            public Boolean rg(String str) {
                final boolean[] zArr = {false};
                bm.pt().rg("GET", str, new HashMap(), new r() { // from class: com.ss.android.downloadlib.addownload.compliance.df.2.1
        ...
        }, "https://apps.oceanengine.com/customer/api/app/pkg_info?" + sb.toString()).rg(new Chain.rg<Boolean, Object>() { // from class: com.ss.android.downloadlib.addownload.compliance.df.1
            @Override // com.ss.android.downloadlib.utils.Chain.rg
    ...
    public boolean rg(long j, long j2, String str) {
        try {
