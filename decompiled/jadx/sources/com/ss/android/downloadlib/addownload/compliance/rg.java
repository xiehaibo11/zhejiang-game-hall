...
public class rg extends Dialog {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: com.ss.android.downloadlib.addownload.compliance.rg.1
    ...
    private void rg() {
        ...
        pt.rg().rg(this.bm, new pt.rg() { // from class: com.ss.android.downloadlib.addownload.compliance.rg.2
            @Override // com.ss.android.downloadlib.addownload.compliance.pt.rg
        ...
        this.pt.setOnClickListener(new View.OnClickListener() { // from class: com.ss.android.downloadlib.addownload.compliance.rg.3
        ...
        this.pp.setOnClickListener(new View.OnClickListener() { // from class: com.ss.android.downloadlib.addownload.compliance.rg.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                df.rg().rg(rg.this.rz);
        ...
        this.c.setOnClickListener(new View.OnClickListener() { // from class: com.ss.android.downloadlib.addownload.compliance.rg.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                rg.this.dismiss();
        ...
        this.ux.setOnClickListener(new View.OnClickListener() { // from class: com.ss.android.downloadlib.addownload.compliance.rg.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
