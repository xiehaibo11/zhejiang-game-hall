...
public class rg implements com.ss.android.downloadad.api.rg, df.q, AppStatusManager.AppStatusChangeListener, IOpenInstallerListener {
    ...
    public synchronized void rg(final String str) {
        ...
        new com.ss.android.downloadlib.df.df().rg(dfVarRg, new com.ss.android.downloadlib.df.fw() { // from class: com.ss.android.downloadlib.rg.1
            @Override // com.ss.android.downloadlib.df.fw
    ...
    private static class df implements Runnable {
        ...
        */
        boolean rg() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ss.android.downloadlib.rg.df.rg():boolean");
        }
    ...
    public void rg(final long j, int i) {
        ...
        pt.rg().rg(new Runnable() { // from class: com.ss.android.downloadlib.rg.2
            @Override // java.lang.Runnable
            public void run() {
                rg.rg().rg(j);
            }
    ...
    public void df(DownloadInfo downloadInfo, final com.ss.android.downloadad.api.rg.df dfVar) {
        ...
        pt.rg().df(new Runnable() { // from class: com.ss.android.downloadlib.rg.3
            @Override // java.lang.Runnable
            public void run() {
    ...
    @Override // com.ss.android.downloadad.api.rg
    public void rg(int i) {
        long jCurrentTimeMillis = System.currentTimeMillis();
        if (jCurrentTimeMillis - this.df < 120000) {
            return;
        }
        pt.rg().rg(new RunnableC0351rg(i), this.df > 0 ? 2000L : 8000L);
        this.df = jCurrentTimeMillis;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void rg(ConcurrentHashMap<Long, com.ss.android.downloadad.api.rg.df> concurrentHashMap, int i) {
    ...
    @Override // com.ss.android.socialbase.appdownloader.df.q
    ...
    public void onOpenInstaller(final DownloadInfo downloadInfo, String str) {
        if (downloadInfo == null) {
            ...
            com.ss.android.downloadlib.df.pp.rg().df(new com.ss.android.downloadlib.df.pt() { // from class: com.ss.android.downloadlib.rg.4
    ...
    /* JADX INFO: renamed from: com.ss.android.downloadlib.rg$rg, reason: collision with other inner class name */
    private class RunnableC0351rg implements Runnable {
        private final int df;

        public RunnableC0351rg(int i) {
            this.df = i;
        }
