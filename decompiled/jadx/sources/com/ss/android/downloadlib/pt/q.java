...
public class q implements bm {
    ...
    public void rg(final DownloadInfo downloadInfo, final int i, final rz rzVar) {
        if (i == this.df.size() || i < 0) {
            rzVar.rg();
        } else {
            this.df.get(i).rg(downloadInfo, new rz() { // from class: com.ss.android.downloadlib.pt.q.1
