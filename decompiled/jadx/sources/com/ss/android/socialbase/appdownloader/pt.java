...
public class pt {
    ...
    private void r() {
        if (Build.VERSION.SDK_INT >= 21) {
            RetryScheduler.setRetryScheduleHandler(new RetryScheduler.RetryScheduleHandler() { // from class: com.ss.android.socialbase.appdownloader.pt.1
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str2) && !TextUtils.isEmpty(strCd)) {
                ...
                if (iDownloadDependMs == null) {
                    iDownloadDependMs = new IDownloadDepend() { // from class: com.ss.android.socialbase.appdownloader.pt.2
                ...
                if (autoInstall != null) {
                    if (z3 && cVar.gk() && cVar.getActivity() != null && !cVar.getActivity().isFinishing() && !com.ss.android.socialbase.appdownloader.pp.pt.rg()) {
                        com.ss.android.socialbase.appdownloader.pp.pt.rg(cVar.getActivity(), new f() { // from class: com.ss.android.socialbase.appdownloader.pt.3
                            @Override // com.ss.android.socialbase.appdownloader.q.f
                            public void rg() {
    ...
    public void rg(DownloadTask downloadTask, int i, boolean z) {
    ...
    private IDownloadNotificationEventListener rg(final com.ss.android.socialbase.appdownloader.q.pp ppVar) {
        ...
        return new IDownloadNotificationEventListener() { // from class: com.ss.android.socialbase.appdownloader.pt.4
