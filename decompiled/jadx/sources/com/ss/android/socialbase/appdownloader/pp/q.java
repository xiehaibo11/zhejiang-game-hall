...
public class q {
    ...
    public void rg(final int i, final String str) {
        ...
        DownloadComponentManager.getIOThreadExecutor().submit(new Runnable() { // from class: com.ss.android.socialbase.appdownloader.pp.q.1
    ...
    public static ByteArrayOutputStream df(InputStream inputStream) throws IOException {
