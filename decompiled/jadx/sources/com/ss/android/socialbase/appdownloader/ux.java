...
public class ux {
    ...
    private ux() {
        ...
        this.fw = new Runnable() { // from class: com.ss.android.socialbase.appdownloader.ux.1
            @Override // java.lang.Runnable
            public void run() {
                ux.this.q();
            }
        };
        AppStatusManager.getInstance().registerAppSwitchListener(new AppStatusManager.AppStatusChangeListener() { // from class: com.ss.android.socialbase.appdownloader.ux.2
        ...
        if (Build.VERSION.SDK_INT < 29 || AppStatusManager.getInstance().isAppForeground()) {
            ...
            if (numPoll != null) {
                ...
                if (Looper.myLooper() != Looper.getMainLooper()) {
                    this.c.post(new Runnable() { // from class: com.ss.android.socialbase.appdownloader.ux.3
                        @Override // java.lang.Runnable
                        public void run() {
    ...
    public int rg(final Context context, final int i, final boolean z) {
        ...
        if (pt()) {
            this.c.postDelayed(new Runnable() { // from class: com.ss.android.socialbase.appdownloader.ux.4
                @Override // java.lang.Runnable
                public void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public int df(Context context, int i, boolean z) {
