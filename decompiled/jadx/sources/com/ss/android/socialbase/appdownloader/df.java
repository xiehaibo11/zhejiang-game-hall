...
public class df {
    ...
    /* JADX INFO: renamed from: com.ss.android.socialbase.appdownloader.df$df, reason: collision with other inner class name */
    interface InterfaceC0361df {
    ...
    */
    private static boolean rg(android.content.Context r11, com.ss.android.socialbase.downloader.model.DownloadInfo r12, android.content.Intent r13, org.json.JSONObject r14, boolean r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.socialbase.appdownloader.df.rg(android.content.Context, com.ss.android.socialbase.downloader.model.DownloadInfo, android.content.Intent, org.json.JSONObject, boolean):boolean");
    }
    ...
    public static boolean rg(Context context, Intent intent, int i, JSONObject jSONObject) {
        try {
            if (com.ss.android.socialbase.appdownloader.c.pt.df() && Build.VERSION.SDK_INT < 26 && !pt(context)) {
                ...
                if (cVar.rg()) {
                    rg(context, intent, i, jSONObject, new InterfaceC0361df() { // from class: com.ss.android.socialbase.appdownloader.df.1
                        @Override // com.ss.android.socialbase.appdownloader.df.InterfaceC0361df
                ...
                if (dfVar.rg()) {
                    rg(context, intent, i, jSONObject, new InterfaceC0361df() { // from class: com.ss.android.socialbase.appdownloader.df.2
                        @Override // com.ss.android.socialbase.appdownloader.df.InterfaceC0361df
                        public boolean rg(Context context2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void df(int i, boolean z, boolean z2) {
    ...
    private static void rg(Context context, Intent intent, int i, JSONObject jSONObject, InterfaceC0361df interfaceC0361df) {
        if (q != null) {
            AppStatusManager.getInstance().unregisterAppSwitchListener(q);
            q = null;
        }
        q = new rg(context, intent, i, jSONObject, interfaceC0361df);
    ...
    private static class pt implements Callable<Boolean> {
        private final InterfaceC0361df df;
        private final long pt;
        private final Handler q;
        private final Context rg;

        public pt(Handler handler, Context context, InterfaceC0361df interfaceC0361df, long j) {
            this.rg = context;
            this.df = interfaceC0361df;
            this.q = handler;
            this.pt = j;
        }
    ...
    private static class rg implements AppStatusManager.AppStatusChangeListener {
        ...
        public rg(Context context, Intent intent, int i, JSONObject jSONObject, InterfaceC0361df interfaceC0361df) {
            this.q = jSONObject;
            int iOptInt = jSONObject.optInt(DownloadSettingKeys.AhPlans.KEY_JUMP_UNKNWON_SOURCE_QUERY_INTERVAL, 1000);
            this.df = iOptInt;
            this.rg = new pp(context, intent, i, interfaceC0361df, iOptInt);
        }
    ...
    private static class pp implements WeakDownloadHandler.IHandler {
        ...
        private final InterfaceC0361df pp;
        private final Intent pt;
        private final Context q;
        private boolean rz = false;
        private Future<Boolean> ux;

        public pp(Context context, Intent intent, int i, InterfaceC0361df interfaceC0361df, long j) {
            this.q = context;
            this.pt = intent;
            df = i;
            this.pp = interfaceC0361df;
