...
public class cn {
    ...
    private JSONObject a() {
        try {
            ...
            jSONObject.put("36", ab.a(this.f2738a) ? 1 : 0);
            JSONObject jSONObjectA = ah.a(this.f2738a);
            if (jSONObjectA != null) {
                jSONObject.put("4", jSONObjectA);
            }
            if (hVarA.b(df.ac, 0) == 1 && (zE || zE2)) {
                jSONObject.put(Constants.VIA_REPORT_TYPE_CHAT_AUDIO, al.a(this.f2738a) ? 1 : 0);
            }
            ac acVar = new ac();
            jSONObject.put("7", acVar.a() ? 1 : 0);
            boolean zA = acVar.a(this.f2738a);
            jSONObject.put("8", zA ? 1 : 0);
            if (zA) {
                jSONObject.put("61", acVar.b(this.f2738a));
            }
            jSONObject.put("10", acVar.e(this.f2738a));
            jSONObject.put(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE, acVar.c(this.f2738a));
            ae aeVar = new ae();
            ...
            jSONObject2.put("03007", bu.a(this.f2738a));
            jSONObject2.put("03014", bg.g(this.f2738a));
            jSONObject2.put("03020", bu.b(this.f2738a));
            jSONObject2.put("03030", bf.d(this.f2738a));
    ...
    public String a(String str) {
        ...
        try {
            ...
            String strA = dl.a(ct.f2745a);
            String strB = b(strA);
            if (TextUtils.isEmpty(strB) || (jSONObjectA = clVar.a(this.f2738a)) == null) {
                return null;
            }
            String str2 = ct.h + "?" + cu.a(this.f2738a);
            if (ct.a() && ct.f2745a.contains("api")) {
                str2 = "/api" + str2;
            }
            JSONObject jSONObject = new JSONObject();
