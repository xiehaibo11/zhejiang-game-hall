...
public class t {
    ...
    public static final String f2791a = "k";
    ...
    public long a(s sVar) {
        ...
        try {
            if (b(sVar.f2790a)) {
                jInsert = this.C.update(bh.q, contentValues, "k=" + sVar.f2790a, null);
            } else {
                contentValues.put("k", Integer.valueOf(sVar.f2790a));
        ...
        try {
            ...
            if (cursorQuery != null) {
                while (cursorQuery.moveToNext()) {
                    try {
                        s sVar = new s();
                        sVar.f2790a = cursorQuery.getInt(cursorQuery.getColumnIndex("k"));
                        sVar.c = cursorQuery.getString(cursorQuery.getColumnIndex("p"));
                        sVar.e = cursorQuery.getString(cursorQuery.getColumnIndex("a"));
                        sVar.h = cursorQuery.getString(cursorQuery.getColumnIndex("l"));
                        sVar.d = cursorQuery.getString(cursorQuery.getColumnIndex("v"));
    ...
    public void b() {
        ...
        try {
            ...
            for (s sVar2 : arrayList) {
                ...
                this.C.delete(bh.q, "k=" + sVar2.f2790a, null);
                if (r.b != null && !r.b.contains(Integer.valueOf(sVar2.f2790a))) {
                    dn.c(this.D.getFilesDir().getCanonicalPath() + bh.j + sVar2.f2790a);
                }
