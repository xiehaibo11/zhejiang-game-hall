...
public class ck {
    ...
    public String a(String str) {
        ...
        try {
            JSONObject jSONObjectA2 = new cl(str, cj.j).a(this.f2735a);
    ...
    public JSONObject a() {
        ...
        try {
            ...
            jSONObject.put("36", ab.a(this.f2735a) ? 1 : 0);
            JSONObject jSONObjectA = ah.a(this.f2735a);
            if (jSONObjectA != null) {
                jSONObject.put("4", jSONObjectA);
            }
            z zVar = new z();
            JSONArray jSONArrayA = zVar.a(this.f2735a);
            ...
            boolean zA = acVar.a(this.f2735a);
            jSONObject.put("8", zA ? 1 : 0);
            if (zA) {
                jSONObject.put("61", acVar.b(this.f2735a));
            }
            jSONObject.put("181", acVar.f(this.f2735a) ? 1 : 0);
            jSONObject.put("9", acVar.d(this.f2735a));
            jSONObject.put("10", acVar.e(this.f2735a));
            jSONObject.put(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE, acVar.c(this.f2735a));
            ae aeVar = new ae();
            ...
            if (setA != null) {
                ...
                if (setB != null || setC != null) {
                    ...
                    jSONObject.put("13", anVar.a(this.f2735a, 13, hashSet));
                    jSONObject.put(Constants.VIA_REPORT_TYPE_MAKE_FRIEND, anVar.a(this.f2735a, 14, hashSet));
                    jSONObject.put(Constants.VIA_REPORT_TYPE_WPA_STATE, anVar.a(this.f2735a, 15, hashSet));
                    jSONObject.put(Constants.VIA_REPORT_TYPE_START_WAP, anVar.a(this.f2735a, 16, hashSet));
                    jSONObject.put(Constants.VIA_REPORT_TYPE_START_GROUP, anVar.a(this.f2735a, 17, hashSet));
                    jSONObject.put("18", anVar.a(this.f2735a, 18, hashSet));
                    jSONObject.put(Constants.VIA_ACT_TYPE_NINETEEN, anVar.a(this.f2735a, 19, hashSet));
                    jSONObject.put("20", anVar.a(this.f2735a, 20, hashSet));
                    jSONObject.put("21", anVar.a(this.f2735a, 21, hashSet));
            ...
            jSONObject2.put("03007", bu.a(this.f2735a));
            jSONObject2.put("03014", bg.g(this.f2735a));
            jSONObject2.put("03020", bu.b(this.f2735a));
            jSONObject2.put("03030", bf.d(this.f2735a));
            ...
            jSONObject.put("145", agVar.a(this.f2735a));
            jSONObject.put("132", dk.a());
            jSONObject.put("133", new ai(this.f2735a).g());
            if (hVarA.b(df.ah, 1) == 1) {
                jSONObject.put("139", dl.c(this.f2735a));
                jSONObject.put("140", dl.d(this.f2735a));
            ...
            if (hVarA.b(df.ac, 0) == 1) {
                if (zE || zE2) {
                    jSONObject.put(Constants.VIA_REPORT_TYPE_CHAT_AUDIO, al.a(this.f2735a) ? 1 : 0);
                }
                jSONObject.put("128", ad.b() ? 1 : 0);
            }
            if (Engine.loadSuccess) {
                as asVar = new as(this.f2735a, 100);
                ...
                if (hVarA.b(df.ab, 1) == 1) {
                    ...
                    aq aqVar3 = new aq(this.f2735a, 4);
                ...
                if (hVarA.b(df.ad, 0) == 1) {
                    av avVar = new av(this.f2735a, 100);
                    ...
                    av avVar2 = new av(this.f2735a, 200);
                    jSONObject.put("173", avVar2.a("173"));
                    jSONObject.put("182", avVar2.a("182"));
                }
                if (hVarA.b(df.Y, 1) == 1) {
                    jSONObject.put("129", new bd(this.f2735a, 4).a("129"));
                    bd bdVar = new bd(this.f2735a, 1);
                    jSONObject.put("121", bdVar.a(bdVar.a(), "121"));
                    bd bdVar2 = new bd(this.f2735a, 2);
                ...
                if (hVarA.b(df.U, 1) == 1) {
                    az azVar = new az(this.f2735a, 100);
                    ...
                    jSONObject.put("177", new az(this.f2735a, 500).d("177"));
                }
                if ((zE || zE2) && hVarA.b(df.W, 0) == 1) {
                    jSONObject.put("158", new az(this.f2735a, 300).b("158"));
                }
                i = 0;
                if (hVarA.b(df.ag, 0) == 1) {
                    bc bcVar = new bc(this.f2735a);
                    jSONObject.put("162", bcVar.a("162"));
                    jSONObject.put("160", bcVar.a(bcVar.a(), "160"));
                    az azVar2 = new az(this.f2735a, 400);
                ...
                if (hVarA.b(df.ae, 1) == 1) {
                    ax axVar = new ax(this.f2735a, 600);
            ...
            jSONObject.put("58", ae.a(this.f2735a));
            jSONObject.put("60", ab.b(this.f2735a) ? 1 : i);
            jSONObject.put("11000", Engine.loadSuccess ? 1 : i);
            jSONObject.put("11002", Engine.soVersion);
            jSONObject.put("11008", hVarA.b(df.g, bp.e));
            jSONObject.put("11009", br.a(this.f2735a.getApplicationContext()));
            try {
            ...
            jSONObject.put("187", ak.a(this.f2735a) ? 1 : i);
