...
public class ci {
    ...
    public String a(String str) {
        ...
        try {
            JSONObject jSONObjectA2 = new cl(str, cj.j).a(this.f2733a);
        ...
        try {
            ...
            if (hVarA.b(df.G, 1) == 1) {
                ...
                if (hVarA.b(df.K, 1) == 1 && Engine.loadSuccess) {
                    ...
                    jSONObject.put("49", (Object) dl.b(this.f2733a));
                    jSONObject.put("50", (Object) dl.a(this.f2733a));
                }
                if (hVarA.b(df.J, 1) == 1 && Engine.loadSuccess) {
                    at atVar = new at(this.f2733a);
                    ...
                    jSONObject.put("52", (Object) atVar.a(this.f2733a, "52", 0));
                    ...
                    ay ayVar = new ay(this.f2733a, 200);
                ...
                if (hVarA.b(df.M, 1) == 1) {
                    aw awVar = new aw(this.f2733a);
                    jSONObject.put("53", (Object) awVar.a(this.f2733a, "53", 1));
                    jSONObject.put("56", awVar.a("56"));
                    jSONObject.put("57", awVar.a("57"));
                    if (zE || zE2) {
                        aj ajVar = new aj();
                        jSONObject.put("47", ajVar.a(this.f2733a));
                        jSONObject.put("59", ajVar.d(this.f2733a));
                        jSONObject.put("60", ajVar.c(this.f2733a));
                        jSONObject.put("61", ajVar.b(this.f2733a));
                        jSONObject.put("62", ajVar.e(this.f2733a));
                        jSONObject.put("65", ajVar.f(this.f2733a));
                        jSONObject.put("69", ajVar.g(this.f2733a));
                        jSONObject.put("75", ajVar.h(this.f2733a));
                        jSONObject.put("80", aj.a());
                        jSONObject.put("85", ajVar.i(this.f2733a));
                        jSONObject.put("87", ajVar.j(this.f2733a));
                        jSONObject.put("91", ajVar.k(this.f2733a));
                        jSONObject.put("92", ajVar.l(this.f2733a));
                    }
                ...
                if (hVarA.b(df.N, 1) == 1) {
                    ...
                    jSONObject.put("109", dl.e(this.f2733a));
                    ai aiVar = new ai(this.f2733a);
                ...
                try {
                    if (h.a(this.f2733a, "re_po_rt").b(df.aD, 1) == 1) {
                        JSONObject jSONObjectC = new ba(this.f2733a, 100, Environment.getExternalStorageDirectory().getAbsolutePath(), ba.a(this.f2733a)).c();
                        if (jSONObjectC == null || jSONObjectC.length() <= 10) {
                            i = 1;
                            try {
                                jSONObject.put("16102", new ba(this.f2733a, 200, "", true).a("16102"));
                        ...
                        if ((zE || zE2) && (jSONObjectG = bf.g(this.f2733a)) != null && jSONObjectG.length() > 0) {
