...
public class PluginProcessMain {
    ...
    static final void connectToHostSvc() {
        ...
        try {
            iBinderProxyFetchHostBinder.linkToDeath(new IBinder.DeathRecipient() { // from class: com.qihoo360.loader2.PluginProcessMain.1
                @Override // android.os.IBinder.DeathRecipient
                public void binderDied() {
    ...
    static final int getPidByProcessName(final String str) {
        ...
        return ((Integer) readProcessClientLock(new Action<Integer>() { // from class: com.qihoo360.loader2.PluginProcessMain.9
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.qihoo360.loader2.PluginProcessMain.Action
            public Integer call() {
    ...
    static final String getProcessNameByPid(final int i) {
        ...
        return (String) readProcessClientLock(new Action<String>() { // from class: com.qihoo360.loader2.PluginProcessMain.10
            @Override // com.qihoo360.loader2.PluginProcessMain.Action
            public String call() {
                for (ProcessClientRecord processClientRecord : PluginProcessMain.ALL.values()) {
