...
public class c {
    ...
    protected final com.cmic.gen.sdk.auth.a f1622a;
    ...
    c(Context context) {
        ...
        this.f1622a = com.cmic.gen.sdk.auth.a.a(this.b);
        r.a(this.b);
        k.a(this.b);
        j.a(this.b);
    ...
    public void a(com.cmic.gen.sdk.a aVar) {
        ...
        this.f1622a.a(aVar, new b() { // from class: com.cmic.gen.sdk.auth.c.5
