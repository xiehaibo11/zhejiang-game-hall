        ...
        try {
            ...
            if (TextUtils.isEmpty(strB)) {
                ...
                if (key instanceof SecretKey) {
                    ...
                    cipher2.init(1, key, new IvParameterSpec(f1665a));
                } else {
                ...
                String strEncodeToString2 = Base64.encodeToString(f1665a, 0);
                HashMap map = new HashMap();
                map.put("AES_IV", strEncodeToString2);
                map.put("AES_KEY", strEncodeToString);
                k.a(map);
            } else {
                f1665a = Base64.decode(c(), 0);
                ...
                if (key2 instanceof SecretKey) {
                    ...
                    cipher.init(2, key2, new IvParameterSpec(f1665a));
