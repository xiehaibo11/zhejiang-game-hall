...
public abstract class MiPushClient {
    ...
    public static String getAppRegion(Context context) {
        if (b.m85a(context).m94c()) {
            return b.m85a(context).f();
        }
        return null;
    }

    private static boolean getDefaultSwitch() {
        return com.xiaomi.push.m.m578b();
    }
    ...
    public static void initialize(Context context, String str, String str2, MiPushClientCallback miPushClientCallback, String str3, ICallbackResult iCallbackResult) {
        try {
            ...
            if (com.xiaomi.push.v.m704a(sContext)) {
                v.a(sContext);
            }
            boolean z = b.m85a(sContext).a() != Constants.a();
            if (!z && !shouldSendRegRequest(sContext)) {
                ao.a(sContext).m76a();
                com.xiaomi.channel.commonutils.logger.b.m43a("Could not send  register message within 5s repeatly .");
                return;
            }
            if (z || !b.m85a(sContext).a(str, str2) || b.m85a(sContext).m97f()) {
                String strA = bp.a(6);
                b.m85a(sContext).m87a();
                b.m85a(sContext).a(Constants.a());
                b.m85a(sContext).a(str, str2, strA);
                ...
                ijVar.f(strA);
                ijVar.c(com.xiaomi.push.h.m397a(sContext, sContext.getPackageName()));
                ...
                if (1 == PushMessageHelper.getPushMode(sContext)) {
                    ...
                    miPushClientCallback.onInitializeResult(0L, null, b.m85a(sContext).m93c());
                } else {
                    ArrayList arrayList = new ArrayList();
                    arrayList.add(b.m85a(sContext).m93c());
                    PushMessageHelper.sendCommandMessageBroadcast(sContext, PushMessageHelper.generateCommandMessage(ey.COMMAND_REGISTER.f347a, arrayList, 0L, null, null, null));
                }
                ao.a(sContext).m76a();
                if (b.m85a(sContext).m89a()) {
                    ii iiVar = new ii();
                    iiVar.b(b.m85a(sContext).m86a());
                    iiVar.c(ht.ClientInfoUpdate.f519a);
                    iiVar.a(bd.a());
                    iiVar.f658a = new HashMap();
                    iiVar.f658a.put("app_version", com.xiaomi.push.h.m397a(sContext, sContext.getPackageName()));
                    iiVar.f658a.put(Constants.EXTRA_KEY_APP_VERSION_CODE, Integer.toString(com.xiaomi.push.h.a(sContext, sContext.getPackageName())));
                    iiVar.f658a.put("push_sdk_vn", "4_9_0");
                    iiVar.f658a.put("push_sdk_vc", Integer.toString(40090));
                    String strE2 = b.m85a(sContext).e();
                    if (!TextUtils.isEmpty(strE2)) {
                        iiVar.f658a.put("deviceid", strE2);
                    }
                    ao.a(sContext).a(iiVar, hj.Notification, false, (hw) null);
                }
                if (!com.xiaomi.push.n.m582a(sContext, "update_devId", false)) {
                    updateImeiOrOaid();
                    com.xiaomi.push.n.a(sContext, "update_devId", true);
                }
                if (shouldUseMIUIPush(sContext) && shouldPullNotification(sContext)) {
                    ii iiVar2 = new ii();
                    iiVar2.b(b.m85a(sContext).m86a());
                    iiVar2.c(ht.PullOfflineMessage.f519a);
                    iiVar2.a(bd.a());
                    iiVar2.a(false);
                    ao.a(sContext).a(iiVar2, hj.Notification, false, (hw) null, false);
    ...
    static void reInitialize(Context context, hx hxVar) {
        ...
        String strA = bp.a(6);
        String strM86a = b.m85a(context).m86a();
        String strB = b.m85a(context).b();
        b.m85a(context).m87a();
        clearExtrasForInitialize(context);
        clearNotification(context);
        b.m85a(context).a(Constants.a());
        b.m85a(context).a(strM86a, strB, strA);
        ij ijVar = new ij();
        ijVar.a(bd.a());
        ijVar.b(strM86a);
        ijVar.e(strB);
    ...
    private static void registerNetworkReceiver(Context context) {
        try {
            ...
            com.xiaomi.channel.commonutils.logger.b.m43a("dynamic register network status receiver failed:" + th);
        }
    }
    ...
    public static void reportAppRunInBackground(Context context, boolean z) {
        if (b.m85a(context).m92b()) {
            ...
            iiVar.a(bd.a());
            iiVar.a(false);
            ao.a(context).a(iiVar, hj.Notification, false, (hw) null, false);
        }
    }
    ...
    static void reportMessageClicked(Context context, String str, hw hwVar, String str2) {
        ...
        if (TextUtils.isEmpty(str2)) {
            ...
            str2 = b.m85a(context).m86a();
        }
        iiVar.b(str2);
        iiVar.c("bar:click");
        iiVar.a(str);
        iiVar.a(false);
        ao.a(context).a(iiVar, hj.Notification, false, hwVar);
    }
    ...
    public static void setAcceptTime(Context context, int i, int i2, int i3, int i4, String str) {
        ...
        if (!acceptTimeSet(context, (String) arrayList.get(0), (String) arrayList.get(1))) {
            setCommand(context, ey.COMMAND_SET_ACCEPT_TIME.f347a, (ArrayList<String>) arrayList, str);
        } else if (1 == PushMessageHelper.getPushMode(context)) {
            PushMessageHandler.a(context, str, ey.COMMAND_SET_ACCEPT_TIME.f347a, 0L, null, arrayList2);
        } else {
            PushMessageHelper.sendCommandMessageBroadcast(context, PushMessageHelper.generateCommandMessage(ey.COMMAND_SET_ACCEPT_TIME.f347a, arrayList2, 0L, null, null, null));
        }
    }
    ...
    public static void setAlias(Context context, String str, String str2) {
        ...
        setCommand(context, ey.COMMAND_SET_ALIAS.f347a, str, str2);
    }
    ...
    protected static void setCommand(Context context, String str, String str2, String str3) {
        ...
        if (ey.COMMAND_SET_ALIAS.f347a.equalsIgnoreCase(str) && Math.abs(System.currentTimeMillis() - aliasSetTime(context, str2)) < 86400000) {
            if (1 != PushMessageHelper.getPushMode(context)) {
                eyVar = ey.COMMAND_SET_ALIAS;
                PushMessageHelper.sendCommandMessageBroadcast(context, PushMessageHelper.generateCommandMessage(eyVar.f347a, arrayList, 0L, null, str3, null));
                return;
            }
            PushMessageHandler.a(context, str3, str, 0L, null, arrayList);
            return;
        }
        if (ey.COMMAND_UNSET_ALIAS.f347a.equalsIgnoreCase(str) && aliasSetTime(context, str2) < 0) {
            sb = new StringBuilder();
            str4 = "Don't cancel alias for ";
        } else {
            if (ey.COMMAND_SET_ACCOUNT.f347a.equalsIgnoreCase(str) && Math.abs(System.currentTimeMillis() - accountSetTime(context, str2)) < 3600000) {
                if (1 != PushMessageHelper.getPushMode(context)) {
            ...
            if (!ey.COMMAND_UNSET_ACCOUNT.f347a.equalsIgnoreCase(str) || accountSetTime(context, str2) >= 0) {
    ...
    protected static void setCommand(Context context, String str, ArrayList<String> arrayList, String str2) {
        if (TextUtils.isEmpty(b.m85a(context).m86a())) {
            return;
        }
        id idVar = new id();
        String strA = bd.a();
        idVar.a(strA);
        idVar.b(b.m85a(context).m86a());
        idVar.c(str);
    ...
    public static void setUserAccount(Context context, String str, String str2) {
        ...
        setCommand(context, ey.COMMAND_SET_ACCOUNT.f347a, str, str2);
    }
    ...
    public static boolean shouldUseMIUIPush(Context context) {
        return ao.a(context).m78a();
    }

    public static void subscribe(Context context, String str, String str2) {
        if (TextUtils.isEmpty(b.m85a(context).m86a()) || TextUtils.isEmpty(str)) {
            return;
        }
        if (Math.abs(System.currentTimeMillis() - topicSubscribedTime(context, str)) <= 86400000) {
            ...
            ArrayList arrayList = new ArrayList();
            arrayList.add(str);
            PushMessageHelper.sendCommandMessageBroadcast(context, PushMessageHelper.generateCommandMessage(ey.COMMAND_SUBSCRIBE_TOPIC.f347a, arrayList, 0L, null, null, null));
            return;
        }
        in inVar = new in();
        String strA = bd.a();
        inVar.a(strA);
        inVar.b(b.m85a(context).m86a());
        inVar.c(str);
        inVar.d(context.getPackageName());
        inVar.e(str2);
        com.xiaomi.channel.commonutils.logger.b.e("cmd:" + ey.COMMAND_SUBSCRIBE_TOPIC + ", " + strA);
    ...
    public static void unregisterPush(Context context) {
        ...
        if (b.m85a(context).m92b()) {
            ip ipVar = new ip();
            ipVar.a(bd.a());
            ipVar.b(b.m85a(context).m86a());
            ipVar.c(b.m85a(context).m93c());
            ipVar.e(b.m85a(context).b());
    ...
    public static void unsetAlias(Context context, String str, String str2) {
        setCommand(context, ey.COMMAND_UNSET_ALIAS.f347a, str, str2);
    }

    public static void unsetUserAccount(Context context, String str, String str2) {
        setCommand(context, ey.COMMAND_UNSET_ACCOUNT.f347a, str, str2);
    }

    public static void unsubscribe(Context context, String str, String str2) {
        if (b.m85a(context).m92b()) {
            if (topicSubscribedTime(context, str) < 0) {
                com.xiaomi.channel.commonutils.logger.b.m43a("Don't cancel subscribe for " + str + " is unsubscribed");
                return;
            }
            ir irVar = new ir();
            String strA = bd.a();
            irVar.a(strA);
            irVar.b(b.m85a(context).m86a());
            irVar.c(str);
            irVar.d(context.getPackageName());
            irVar.e(str2);
            com.xiaomi.channel.commonutils.logger.b.e("cmd:" + ey.COMMAND_UNSUBSCRIBE_TOPIC + ", " + strA);
    ...
    private static void updateImeiOrOaid() {
        new Thread(new Runnable() { // from class: com.xiaomi.mipush.sdk.MiPushClient.3
            ...
            public void run() {
                ...
                if (com.xiaomi.push.j.d(MiPushClient.sContext) != null || com.xiaomi.push.ba.a(MiPushClient.sContext).mo127a()) {
                    ii iiVar = new ii();
                    iiVar.b(b.m85a(MiPushClient.sContext).m86a());
                    iiVar.c(ht.ClientInfoUpdate.f519a);
                    iiVar.a(bd.a());
                    iiVar.a(new HashMap());
                    String str = "";
                    ...
                    if (!TextUtils.isEmpty(str)) {
                        iiVar.m494a().put(Constants.EXTRA_KEY_IMEI_MD5, str);
                    }
                    com.xiaomi.push.ba.a(MiPushClient.sContext).a(iiVar.m494a());
                    int iA = com.xiaomi.push.j.a();
                    if (iA >= 0) {
                        iiVar.m494a().put("space_id", Integer.toString(iA));
                    }
                    ao.a(MiPushClient.sContext).a(iiVar, hj.Notification, false, (hw) null);
                }
            }
        }).start();
    }
