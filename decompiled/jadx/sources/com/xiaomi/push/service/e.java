...
class e {
    ...
    private static final int[] f993a = {1, 2, 4, 8, 16};

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private static final SparseArray<ay.a<String, String, String>> f8375a = new f(5);
    ...
    static void a(Context context, String str) {
        List<NotificationChannel> listM643a;
        if (!com.xiaomi.push.m.m575a(context) || TextUtils.isEmpty(str) || (listM643a = ax.a(context, str).m643a()) == null) {
            return;
        }
    ...
    static void a(Context context, String str, String str2, int i, String str3, boolean z, int i2) {
        if (!com.xiaomi.push.m.m575a(context) || TextUtils.isEmpty(str3) || TextUtils.isEmpty(str2) || TextUtils.isEmpty(str)) {
            if (com.xiaomi.push.m.m575a(context)) {
                com.xiaomi.channel.commonutils.logger.b.m43a("ChannelPC: can`t setup permission with permissionCode:" + String.valueOf(str3) + " channelId:" + String.valueOf(str2) + " targetPkg:" + str);
                return;
            }
            return;
        }
    ...
    static void a(String str, String str2, int i, int i2) {
        for (int i3 : f993a) {
            if ((b.get(i3).intValue() & i2) == 0) {
                ...
                com.xiaomi.channel.commonutils.logger.b.m43a("ChannelPermissions.grantPermission:" + str + Constants.COLON_SEPARATOR + str2 + ": <" + i3 + "> :stoped by userLock");
            }
        }
    }

    private static void a(String str, String str2, int i, boolean z) {
        com.xiaomi.channel.commonutils.logger.b.m43a("ChannelPermissions.grantPermission:" + str + Constants.COLON_SEPARATOR + str2 + ": <" + i + ContainerUtils.KEY_VALUE_DELIMITER + z + "> :" + ay.a(com.xiaomi.push.v.m701a(), str, str2, f8375a.get(i), z));
    }
    ...
    private static boolean a(String str, String str2, int i) {
        boolean z = ay.a(com.xiaomi.push.v.m701a(), str, str2, f8375a.get(i)) == 1;
        com.xiaomi.channel.commonutils.logger.b.m43a("ChannelPermissions.checkPermission:" + str + Constants.COLON_SEPARATOR + str2 + ": <" + i + ContainerUtils.KEY_VALUE_DELIMITER + z + ">");
        return z;
    }
}
