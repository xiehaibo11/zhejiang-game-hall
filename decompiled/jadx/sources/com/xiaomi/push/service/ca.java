...
public class ca {
    ...
    public static ArrayList<hn> f978a = new ArrayList<>();
    ...
    public static byte[] a(Context context) {
        ...
        if (TextUtils.isEmpty(strA)) {
            ...
            com.xiaomi.push.r.a(context).m583a("mipush", "td_key", strA);
        }
        return a(strA);
    }

    private static byte[] a(String str) {
        byte[] bArrCopyOf = Arrays.copyOf(com.xiaomi.push.bm.m157a(str), 16);
        bArrCopyOf[0] = 68;
        bArrCopyOf[15] = 84;
        return bArrCopyOf;
    }
    ...
    public static void c(Context context, hn hnVar) throws Throwable {
