...
public class l {
    public static ComponentName a(Context context, Intent intent) {
        ...
        try {
            ...
            if (resolveInfoResolveActivity != null) {
                return new ComponentName(resolveInfoResolveActivity.activityInfo.packageName, resolveInfoResolveActivity.activityInfo.name);
            }
            return null;
    ...
    public static boolean a(Context context, String str) {
        try {
            ...
            com.xiaomi.channel.commonutils.logger.b.m43a("checkService " + e);
            return false;
        }
    }
    ...
    public static boolean a(Context context, String str, String str2) {
        try {
            ...
            com.xiaomi.channel.commonutils.logger.b.m43a("checkService action: " + str2 + ", " + e);
            return false;
        }
    }
    ...
    public static boolean b(Context context, String str) {
        ...
        try {
            ...
            com.xiaomi.channel.commonutils.logger.b.m43a("checkProvider " + e);
        }
        return z;
    }
    ...
    public static boolean b(Context context, String str, String str2) {
        try {
            ...
            com.xiaomi.channel.commonutils.logger.b.m43a("checkActivity action: " + str2 + ", " + e);
            return false;
        }
    }
}
