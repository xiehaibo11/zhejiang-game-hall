...
public class ay {
    ...
    public static final a<String, String, String> f8322a;
    ...
    public static int a(ContentResolver contentResolver) {
        try {
            ...
            com.xiaomi.channel.commonutils.logger.b.m43a("get user aggregate failed, " + e2);
            return 0;
        }
    }
    ...
    */
    public static <T> T a(java.lang.Object r2, java.lang.String r3, T r4) {
        ...
        L23:
            ...
            com.xiaomi.channel.commonutils.logger.b.m43a(r2)     // Catch: java.lang.Exception -> L38
            goto L4d
        L38:
            r2 = move-exception
            ...
            com.xiaomi.channel.commonutils.logger.b.m43a(r2)
        L4d:
            if (r0 != 0) goto L50
            goto L51
        L50:
    ...
    static void m646a(Notification notification, String str) {
        try {
            if (notification.extras != null) {
    ...
    static void a(Context context, String str, Intent intent) {
        ...
        arrayList.addAll(Arrays.asList(f931a));
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!TextUtils.isEmpty(str2)) {
                ...
                try {
                    ...
                    com.xiaomi.channel.commonutils.logger.b.m43a("can't match url intent. " + e2);
                }
            }
        }
    ...
    public static void a(Map<String, String> map, Bundle bundle, String str) {
        if (map == null || bundle == null || TextUtils.isEmpty(str)) {
            com.xiaomi.channel.commonutils.logger.b.m43a("cp map to b fail:" + str);
            return;
        }
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public static boolean m647a(ContentResolver contentResolver) {
    ...
    public static boolean a(Context context, String str, String str2, a<String, String, String> aVar, boolean z) {
        if (aVar != null) {
            try {
                ...
                a(context, aVar.f8323a, str, str2, bundle);
                return true;
            } catch (Exception unused) {
            }
        }
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public static Notification.Action[] m648a(Notification notification) {
