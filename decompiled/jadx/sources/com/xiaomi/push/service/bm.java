...
public class bm implements eh {
    ...
    public void a(Context context, HashMap<String, String> map) {
        ...
        iiVar.a(bd.a());
        iiVar.f658a = map;
        byte[] bArrA = it.a(ah.a(iiVar.c(), iiVar.b(), iiVar, hj.Notification));
        if (!(context instanceof XMPushService)) {
            com.xiaomi.channel.commonutils.logger.b.m43a("MoleInfo : context is not correct in pushLayer " + iiVar.m493a());
            return;
        }
        com.xiaomi.channel.commonutils.logger.b.m43a("MoleInfo : send data directly in pushLayer " + iiVar.m493a());
