...
public enum ho {
    ...
    StatDataUploadNum(com.tkay.expressad.video.module.a.a.L),
    StatDataProcessFrequency(122),
    StatDataSwitch(com.tkay.expressad.video.module.a.a.N),
    StatDataUploadWay(com.tkay.expressad.video.module.a.a.O),
    StatDataDeleteFrequency(125),
    SdkExceptionMonitorSwitch(126),
    ShortHeartbeatEffectivePeriodMsLong(TsExtractor.TS_STREAM_TYPE_HDMV_DTS),
