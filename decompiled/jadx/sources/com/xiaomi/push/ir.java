...
public class ir implements iu<ir, Object>, Serializable, Cloneable {
    ...
    /* JADX INFO: renamed from: a, reason: collision with other field name */
    private static final jk f790a = new jk("XmPushActionUnSubscription");

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private static final jc f8240a = new jc("", (byte) 11, 1);
    ...
    public int compareTo(ir irVar) {
        ...
        int iCompareTo = Boolean.valueOf(m537a()).compareTo(Boolean.valueOf(irVar.m537a()));
        if (iCompareTo != 0) {
            return iCompareTo;
        }
        if (m537a() && (iA8 = iv.a(this.f792a, irVar.f792a)) != 0) {
            return iA8;
        }
        ...
        if (b() && (iA7 = iv.a(this.f791a, irVar.f791a)) != 0) {
            return iA7;
        }
        ...
        if (c() && (iA6 = iv.a(this.f794b, irVar.f794b)) != 0) {
            return iA6;
        }
        ...
        if (d() && (iA5 = iv.a(this.f795c, irVar.f795c)) != 0) {
            return iA5;
        }
        ...
        if (e() && (iA4 = iv.a(this.f796d, irVar.f796d)) != 0) {
            return iA4;
        }
        ...
        if (f() && (iA3 = iv.a(this.f797e, irVar.f797e)) != 0) {
            return iA3;
        }
        ...
        if (g() && (iA2 = iv.a(this.f798f, irVar.f798f)) != 0) {
            return iA2;
        }
        ...
        if (!h() || (iA = iv.a(this.f793a, irVar.f793a)) == 0) {
            return 0;
        }
        return iA;
    }
    ...
    */
    public void a(com.xiaomi.push.jf r5) throws com.xiaomi.push.jg {
        ...
        L34:
            ...
            java.util.List<java.lang.String> r3 = r4.f793a
            r3.add(r2)
            int r1 = r1 + 1
            goto L34
        L44:
        ...
        L9a:
            ...
            goto L3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.ir.a(com.xiaomi.push.jf):void");
    }
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public boolean m538a(ir irVar) {
        if (irVar == null) {
            return false;
        }
        boolean zM537a = m537a();
        boolean zM537a2 = irVar.m537a();
        if ((zM537a || zM537a2) && !(zM537a && zM537a2 && this.f792a.equals(irVar.f792a))) {
            return false;
        }
        boolean zB = b();
        boolean zB2 = irVar.b();
        if ((zB || zB2) && !(zB && zB2 && this.f791a.m456a(irVar.f791a))) {
            return false;
        }
        boolean zC = c();
        boolean zC2 = irVar.c();
        if ((zC || zC2) && !(zC && zC2 && this.f794b.equals(irVar.f794b))) {
            return false;
        }
        boolean zD = d();
        boolean zD2 = irVar.d();
        if ((zD || zD2) && !(zD && zD2 && this.f795c.equals(irVar.f795c))) {
            return false;
        }
        boolean zE = e();
        boolean zE2 = irVar.e();
        if ((zE || zE2) && !(zE && zE2 && this.f796d.equals(irVar.f796d))) {
            return false;
        }
        boolean zF = f();
        boolean zF2 = irVar.f();
        if ((zF || zF2) && !(zF && zF2 && this.f797e.equals(irVar.f797e))) {
            return false;
        }
        boolean zG = g();
        boolean zG2 = irVar.g();
        if ((zG || zG2) && !(zG && zG2 && this.f798f.equals(irVar.f798f))) {
            return false;
        }
        boolean zH = h();
        boolean zH2 = irVar.h();
        if (zH || zH2) {
            return zH && zH2 && this.f793a.equals(irVar.f793a);
        }
        return true;
    }
    ...
    public void b(jf jfVar) throws jg {
        ...
        if (this.f797e != null && f()) {
            jfVar.a(f);
            jfVar.a(this.f797e);
            jfVar.b();
        }
        if (this.f798f != null && g()) {
            jfVar.a(g);
            jfVar.a(this.f798f);
            jfVar.b();
        }
        if (this.f793a != null && h()) {
            jfVar.a(h);
            jfVar.a(new jd((byte) 11, this.f793a.size()));
            Iterator<String> it = this.f793a.iterator();
            while (it.hasNext()) {
                jfVar.a(it.next());
            }
            jfVar.e();
