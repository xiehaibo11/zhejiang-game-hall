...
class ej implements eg {
    ...
    private void b(Context context, ec ecVar) {
        String strM309a = ecVar.m309a();
        String strB = ecVar.b();
        String strD = ecVar.d();
        int iA = ecVar.a();
        if (context == null || TextUtils.isEmpty(strM309a) || TextUtils.isEmpty(strB) || TextUtils.isEmpty(strD)) {
        ...
        if (!com.xiaomi.push.service.l.a(context, strM309a, strB)) {
        ...
        try {
            ...
            intent.setPackage(strM309a);
            intent.putExtra("awake_info", dy.a(strD));
            if (iA == 1 && !ed.m310a(context)) {
