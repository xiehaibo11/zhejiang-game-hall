...
public class i {
    ...
    private static final byte[] f8222a = {100, 23, 84, 114, 72, 0, 4, 97, 73, 97, 2, com.sigmob.sdk.archives.tar.e.L, 84, 102, 18, 32};
    ...
    private static Cipher a(byte[] bArr, int i) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        IvParameterSpec ivParameterSpec = new IvParameterSpec(f8222a);
