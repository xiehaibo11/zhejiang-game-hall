...
public class gv {
    ...
    private static XmlPullParser f8193a;

    public static gk a(String str, String str2, XmlPullParser xmlPullParser) {
        Object objM389a = gu.a().m389a("all", "xm:chat");
        if (objM389a == null || !(objM389a instanceof com.xiaomi.push.service.k)) {
            return null;
        }
        return ((com.xiaomi.push.service.k) objM389a).b(xmlPullParser);
    }
    ...
    public static gl a(XmlPullParser xmlPullParser, fw fwVar) throws XmlPullParserException, IOException {
        ...
        while (!z) {
            ...
            if (next == 2) {
                ...
                if (name.equals("error")) {
                    grVarM393a = m393a(xmlPullParser);
                } else {
                    gxVar = new gl();
        ...
        if (gxVar == null) {
            if (gl.a.f8183a == aVarA || gl.a.b == aVarA) {
                gw gwVar = new gw();
    ...
    public static gp m391a(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        gp.b bVarValueOf = gp.b.available;
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public static gq m392a(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        gq gqVar = null;
        boolean z = false;
        while (!z) {
            int next = xmlPullParser.next();
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public static gr m393a(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    private static String m394a(XmlPullParser xmlPullParser) {
    ...
    private static void a(byte[] bArr) throws XmlPullParserException {
        if (f8193a == null) {
            try {
                ...
                f8193a = xmlPullParserNewPullParser;
                xmlPullParserNewPullParser.setFeature("http://xmlpull.org/v1/doc/features.html#process-namespaces", true);
            } catch (XmlPullParserException e) {
                e.printStackTrace();
            }
        }
        f8193a.setInput(new InputStreamReader(new ByteArrayInputStream(bArr)));
    }
