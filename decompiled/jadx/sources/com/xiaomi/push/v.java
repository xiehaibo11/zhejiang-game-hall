...
public class v {
    ...
    public static Class<?> a(Context context, String str) throws ClassNotFoundException {
        ...
        try {
            ...
            com.xiaomi.channel.commonutils.logger.b.m43a(String.format("loadClass fail hasContext= %s, errMsg = %s", Boolean.valueOf(z), th.getLocalizedMessage()));
            throw new ClassNotFoundException("loadClass fail ", th);
        }
    }

    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public static synchronized String m702a() {
        if (f1026a != null) {
            return f1026a;
        }
    ...
    public static void a(Context context) {
        f8397a = context.getApplicationContext();
    }
    ...
    private static String b() {
        String strA = u.a(com.alipay.sdk.m.c.a.f1162a, "");
        f1026a = strA;
        return strA;
    }
