...
public final class b implements HttpClient {
    ...
    public static long f1052a = 160;
    public static String[] b = {"text/", "application/xml", RequestParams.APPLICATION_JSON};
    ...
    public static class C0004b {
        ...
        public static /* synthetic */ void a(C0004b c0004b, String str) {
            Log.println(c0004b.b, c0004b.f1054a, str);
        }

        public static /* synthetic */ boolean a(C0004b c0004b) {
            return Log.isLoggable(c0004b.f1054a, c0004b.b);
        }
    }
    ...
    public static /* synthetic */ String a(HttpUriRequest httpUriRequest) throws IOException {
        ...
        for (Header header : httpUriRequest.getAllHeaders()) {
            if (!header.getName().equals("Authorization") && !header.getName().equals(SM.COOKIE)) {
                sb.append("--header \"");
