...
public class AliPayHelper implements Handler.Callback {
    ...
    private static Map<String, String> resultStatus = new HashMap<String, String>() { // from class: com.alipay.sdk.executor.AliPayHelper.1
    ...
    public void start(final String str, OnPayListener onPayListener) {
        ...
        new Thread(new Runnable() { // from class: com.alipay.sdk.executor.AliPayHelper.2
