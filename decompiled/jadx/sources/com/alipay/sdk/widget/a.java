...
public class a {
    ...
    public static final String f1330a = "正在加载";
    ...
    private AlertDialogC0031a e;
    private Activity f;
    private String g;
    private long h = -1;
    private final int i = 1;
    private final long j = MBInterstitialActivity.WEB_LOAD_TIME;
    ...
    public class AlertDialogC0031a extends AlertDialog {
        protected AlertDialogC0031a(Context context) {
            super(context);
        }
