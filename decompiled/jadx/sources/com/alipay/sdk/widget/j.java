...
public class j extends g implements WebViewWindow.a, WebViewWindow.b, WebViewWindow.c {
    ...
    private boolean c() {
        try {
            this.x = new WebViewWindow(this.f1336a);
    ...
    public boolean a(WebViewWindow webViewWindow, String str, String str2, String str3, JsPromptResult jsPromptResult) {
        if (str2.startsWith("<head>") && str2.contains("sdk_result_code:")) {
            this.f1336a.runOnUiThread(new k(this));
        }
    ...
    public boolean a(WebViewWindow webViewWindow, int i2, String str, String str2) {
        com.alipay.sdk.app.statistic.a.a("net", "SSLError", "onReceivedError:" + str2);
        webViewWindow.getRefreshButton().setVisibility(0);
        return false;
    }
    ...
    public boolean a(WebViewWindow webViewWindow, SslErrorHandler sslErrorHandler, SslError sslError) {
        com.alipay.sdk.app.statistic.a.a("net", "SSLError", String.valueOf(sslError));
        if (this.w) {
            sslErrorHandler.proceed();
            this.w = false;
            return true;
        }
        this.f1336a.runOnUiThread(new n(this, sslErrorHandler));
        return true;
    }
    ...
    private void b(String str) {
        ...
        if (str.startsWith("callNativeFunc")) {
            a(mapC.get(com.alipay.sdk.authjs.a.f), mapC.get("cbId"), mapC.get("data"));
            return;
        }
        ...
        if (str.startsWith("setTitle") && mapC.containsKey("title")) {
        ...
        if (str.startsWith("showBackButton") && mapC.containsKey("bshow")) {
            this.x.getBackButton().setVisibility(TextUtils.equals("true", mapC.get("bshow")) ? 0 : 4);
        } else if (str.startsWith("onExit")) {
            com.alipay.sdk.app.j.a(mapC.get("result"));
            a(TextUtils.equals("true", mapC.get("bsucc")));
    ...
    private void a(String str, String str2, String str3) {
        ...
        if ("backButton".equals(str)) {
            this.x.getBackButton().setVisibility(jSONObjectD.optBoolean(PointCategory.SHOW, true) ? 0 : 4);
            return;
        }
        if ("refreshButton".equals(str)) {
            this.x.getRefreshButton().setVisibility(jSONObjectD.optBoolean(PointCategory.SHOW, true) ? 0 : 4);
        } else {
            if (!"pushWindow".equals(str) || jSONObjectD.optString("url", null) == null) {
                return;
            }
