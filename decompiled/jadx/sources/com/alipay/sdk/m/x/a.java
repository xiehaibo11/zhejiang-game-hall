...
public class a {
    ...
    public final long f = com.heytap.mcssdk.constant.a.q;
    ...
    public class RunnableC0026a implements Runnable {
        ...
        public void run() {
            if (a.this.f1277a == null) {
                a aVar = a.this;
                a aVar2 = a.this;
                aVar.f1277a = aVar2.new d(aVar2.b);
                a.this.f1277a.setCancelable(a.this.g);
            }
            try {
                if (a.this.f1277a.isShowing()) {
                    return;
                }
                a.this.f1277a.show();
                a.this.h.sendEmptyMessageDelayed(1, com.heytap.mcssdk.constant.a.q);
            } catch (Exception e) {
    ...
    public class b implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            if (a.this.f1277a == null || !a.this.f1277a.isShowing()) {
                return;
            }
            try {
                a.this.h.removeMessages(1);
                a.this.f1277a.dismiss();
            } catch (Exception e) {
                com.alipay.sdk.m.u.e.a(e);
            }
        }
    ...
    public class d extends AlertDialog {
        ...
        private View a(Context context) {
            ...
            textView.setText(TextUtils.isEmpty(a.this.c) ? "正在加载" : a.this.c);
