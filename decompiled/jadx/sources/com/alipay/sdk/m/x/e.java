...
public class e extends LinearLayout {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (hVar != null) {
                ...
                e.m.postDelayed(new RunnableC0028a(view), 256L);
                if (view == e.this.f1290a) {
                    hVar.b(e.this);
    ...
    public static final class C0029e {
        ...
        public C0029e(boolean z, boolean z2) {
            this.f1296a = z;
            this.b = z2;
        }
    }
    ...
    public e(Context context, com.alipay.sdk.m.s.a aVar, C0029e c0029e) {
        this(context, null, aVar, c0029e);
    }
    ...
    public e(Context context, AttributeSet attributeSet, com.alipay.sdk.m.s.a aVar, C0029e c0029e) {
        super(context, attributeSet);
        this.k = new a();
        this.f = c0029e == null ? new C0029e(false, false) : c0029e;
        this.j = aVar;
    ...
    private void a(Context context) {
        ...
        linearLayout.setVisibility(this.f.f1296a ? 0 : 8);
        ImageView imageView = new ImageView(context);
        this.f1290a = imageView;
        imageView.setOnClickListener(this.k);
        this.f1290a.setScaleType(ImageView.ScaleType.CENTER);
        this.f1290a.setImageDrawable(k.a("", context));
        this.f1290a.setPadding(a(12), 0, a(12), 0);
        linearLayout.addView(this.f1290a, new LinearLayout.LayoutParams(-2, -2));
