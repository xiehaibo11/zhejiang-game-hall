...
public abstract class e {
    ...
    public static String a(a.b bVar, String str) {
        ...
        List<String> list;
        if (bVar == null || str == null || (map = bVar.f1228a) == null || (list = map.get(str)) == null) {
            return null;
        }
    ...
    public b a(com.alipay.sdk.m.s.a aVar, Context context, String str, String str2, boolean z) throws Throwable {
        ...
        d dVarA = cVar.a(bVar, this.f1233a, mapA.get("iSr"));
        a.b bVarA = com.alipay.sdk.m.o.a.a(context, new a.C0018a(str2, a(dVarA.b(), str), dVarA.a()));
        if (bVarA != null) {
