...
public class c {
    ...
    public static final String f1236a = "VMS_IDLG_SDK_Client";
    ...
    public static class a extends Handler {
        ...
        public void handleMessage(Message message) {
            if (message.what != 11) {
                Log.e(c.f1236a, "message type valid");
                return;
            }
