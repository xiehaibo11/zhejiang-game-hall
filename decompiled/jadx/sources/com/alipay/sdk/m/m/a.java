...
public final class a {
    ...
    public class RunnableC0017a implements Runnable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ com.alipay.sdk.m.s.a f1216a;
        public final /* synthetic */ Context b;
        public final /* synthetic */ boolean c;
        public final /* synthetic */ int d;

        public RunnableC0017a(com.alipay.sdk.m.s.a aVar, Context context, boolean z, int i) {
            this.f1216a = aVar;
            this.b = context;
            this.c = z;
            this.d = i;
        ...
        public void run() {
            try {
                com.alipay.sdk.m.p.b bVarA = new com.alipay.sdk.m.q.b().a(this.f1216a, this.b);
                if (bVarA != null) {
                    a.this.a(this.f1216a, bVarA.a());
                    a.this.a(com.alipay.sdk.m.s.a.h());
                    com.alipay.sdk.m.k.a.a(this.f1216a, "biz", "offcfg|" + this.c + "|" + this.d);
                }
            } catch (Throwable th) {
                e.a(th);
            }
    ...
    public static final class b {
        ...
        public static JSONObject a(b bVar) {
            ...
            try {
                return new JSONObject().put("pn", bVar.f1217a).put("v", bVar.b).put(PushConstants.URI_PACKAGE_NAME, bVar.c);
    ...
    private void a(JSONObject jSONObject) {
        this.f1215a = jSONObject.optInt("timeout", 10000);
    ...
    public void a(com.alipay.sdk.m.s.a aVar, Context context, boolean z, int i) {
        ...
        RunnableC0017a runnableC0017a = new RunnableC0017a(aVar, context, z, i);
        if (z && !n.h()) {
            int iC = C();
            if (n.a(iC, runnableC0017a, "AlipayDCPBlok")) {
                return;
            }
            com.alipay.sdk.m.k.a.b(aVar, "biz", com.alipay.sdk.m.k.b.m0, "" + iC);
            return;
        }
        Thread thread = new Thread(runnableC0017a);
