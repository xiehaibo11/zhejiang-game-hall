...
public class AlipayResultActivity extends Activity {
    ...
    public static final ConcurrentHashMap<String, a> f1089a = new ConcurrentHashMap<>();
    ...
    private void a(String str, Bundle bundle) {
        a aVarRemove = f1089a.remove(str);
        if (aVarRemove == null) {
            return;
        }
        try {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            try {
                ...
                com.alipay.sdk.m.s.a aVarA = a.C0022a.a(stringExtra);
                if (aVarA == null) {
                    finish();
                    return;
                }
