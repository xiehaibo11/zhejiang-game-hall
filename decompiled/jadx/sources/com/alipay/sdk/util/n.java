...
public class n {
    ...
    static final String f1325a = "com.alipay.android.app";
    ...
    public static String a() {
        ...
        try {
            return com.alipay.sdk.app.i.f1112a.get(0).f1141a;
    ...
    public static a a(Context context, List<a.C0006a> list) {
        ...
        for (a.C0006a c0006a : list) {
            if (c0006a != null && (aVarA = a(context, c0006a.f1141a, c0006a.b, c0006a.c)) != null && !aVarA.a() && !aVarA.b()) {
                return aVarA;
            }
        }
        return null;
    ...
    public static final class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final PackageInfo f1326a;
        public final int b;
        public final String c;

        public a(PackageInfo packageInfo, int i, String str) {
            this.f1326a = packageInfo;
            this.b = i;
            this.c = str;
        }

        public boolean a() {
            Signature[] signatureArr = this.f1326a.signatures;
        ...
        public boolean b() {
            return this.f1326a.versionCode < this.b;
        }
    }
    ...
    public static boolean a(WebView webView, String str, Activity activity) {
        ...
        if (str.toLowerCase().startsWith("alipays://platformapi/startApp?".toLowerCase()) || str.toLowerCase().startsWith("intent://platformapi/startapp?".toLowerCase())) {
            try {
                a aVarA = a(activity, com.alipay.sdk.app.i.f1112a);
        ...
        try {
            ...
            if (i2 == com.alipay.sdk.app.k.SUCCEEDED.a() || i2 == com.alipay.sdk.app.k.PAY_WAITTING.a()) {
