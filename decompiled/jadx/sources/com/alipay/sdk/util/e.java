...
public class e {
    ...
    public static final String f1316a = "failed";
    ...
    public String a(String str) {
        String strA = "";
        try {
            List<a.C0006a> listF = com.alipay.sdk.data.a.g().f();
            if (!com.alipay.sdk.data.a.g().p || listF == null) {
                listF = com.alipay.sdk.app.i.f1112a;
            }
            n.a aVarA = n.a(this.c, listF);
            if (aVarA == null || aVarA.a() || aVarA.b() || n.a(aVarA.f1326a)) {
                return "failed";
            }
            if (aVarA.f1326a == null || "com.eg.android.AlipayGphone".equals(aVarA.f1326a.packageName)) {
                strA = n.a();
            } else {
                strA = aVarA.f1326a.packageName;
            }
            i = aVarA.f1326a != null ? aVarA.f1326a.versionCode : 0;
            a(aVarA);
        } catch (Throwable th) {
    ...
    private void a(n.a aVar) throws InterruptedException {
        ...
        if (aVar == null || (packageInfo = aVar.f1326a) == null) {
            return;
        }
