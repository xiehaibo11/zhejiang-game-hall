...
public class CallbackTimerUtils {
    ...
    private static Handler handler = new Handler(Looper.getMainLooper()) { // from class: com.ymnsdk.replugin.util.CallbackTimerUtils.1
        @Override // android.os.Handler
        public void handleMessage(Message message2) {
            super.handleMessage(message2);
            if (CallbackTimerUtils.callback != null) {
                CallbackTimerUtils.callback.callTime();
            }
            boolean unused = CallbackTimerUtils.isNotDingshiIng = true;
        }
    };
