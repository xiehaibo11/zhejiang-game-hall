...
public class DownloadOnePluginEvent extends SepperllitaEvent {
    public DownloadOnePluginEvent(Activity activity) {
        super(activity);
        setAct("push");
        setPg("P1069");
        setBlk("BHF001");
    ...
    public DownloadOnePluginEvent(Activity activity, String str, String str2) {
        this(activity);
        setRv(str2);
