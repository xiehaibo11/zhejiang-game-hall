...
public class PatchStartSilentDownloadFailEvent extends SepperllitaEvent {
    public PatchStartSilentDownloadFailEvent(Activity activity, String str, String str2) {
        super(activity);
        setAct("push");
        setPg("P1069");
        setBlk("BHF008");
        setBl("选择插件静默下载");
        setLabel("patch包静默下载失败");
        setEid("1045");
