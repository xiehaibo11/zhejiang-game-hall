...
public class ClearDownloadingEvent extends SepperllitaEvent {
    public ClearDownloadingEvent(Activity activity) {
        super(activity);
        setAct("push");
        setPg("P1069");
        setBlk("BHF001");
    ...
    public ClearDownloadingEvent(Activity activity, String str, String str2) {
        this(activity);
        setRv(str2);
