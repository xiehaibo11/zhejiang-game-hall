...
public class DownloadPatchResponseEvent extends SepperllitaEvent {
    public DownloadPatchResponseEvent(Activity activity) {
        super(activity);
        setAct("push");
        setPg("P1069");
        setBlk("BHF002");
    ...
    public DownloadPatchResponseEvent(Activity activity, int i, String str, String str2, long j, int i2, String str3, int i3, long j2) {
        this(activity);
        setEid(i + "");
        setDur(j2 + "");
        setRv(str2);
