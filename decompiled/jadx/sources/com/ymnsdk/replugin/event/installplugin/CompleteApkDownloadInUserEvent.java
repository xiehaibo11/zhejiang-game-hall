...
public class CompleteApkDownloadInUserEvent extends SepperllitaEvent {
    public CompleteApkDownloadInUserEvent(Activity activity) {
        super(activity);
        setAct("push");
        setPg("P1069");
        setBlk("BHF002");
    ...
    public CompleteApkDownloadInUserEvent(Activity activity, String str, String str2, long j, long j2) {
        this(activity);
        setRv(str2);
        setDur(j2 + "");
