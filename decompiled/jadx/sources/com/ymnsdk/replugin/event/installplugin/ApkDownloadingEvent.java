...
public class ApkDownloadingEvent extends SepperllitaEvent {
    public ApkDownloadingEvent(Activity activity) {
        super(activity);
        setAct("push");
        setPg("P1069");
        setBlk("BHF002");
    ...
    public ApkDownloadingEvent(Activity activity, String str, String str2, long j, long j2, long j3) {
        this(activity);
        setRv(str2);
        setDur(j3 + "");
