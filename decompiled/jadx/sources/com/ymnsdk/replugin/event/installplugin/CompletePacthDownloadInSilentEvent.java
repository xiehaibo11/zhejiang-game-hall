...
public class CompletePacthDownloadInSilentEvent extends SepperllitaEvent {
    public CompletePacthDownloadInSilentEvent(Activity activity) {
        super(activity);
        setAct("push");
        setPg("P1069");
        setBlk("BHF001");
        setBl("宿主包启动");
        setLabel("patch完整静默下载");
        setEid("1060");
    }

    public CompletePacthDownloadInSilentEvent(Activity activity, String str, String str2, long j, long j2) {
        this(activity);
        setRv(str2);
        setDur(j2 + "");
