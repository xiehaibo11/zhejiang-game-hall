...
public class CompletePatchDownloadInUserEvent extends SepperllitaEvent {
    public CompletePatchDownloadInUserEvent(Activity activity) {
        super(activity);
        setAct("push");
        setPg("P1069");
        setBlk("BHF002");
        setBl("点击插件icon");
        setLabel("patch完整主动下载");
        setEid("1060");
    }

    public CompletePatchDownloadInUserEvent(Activity activity, String str, String str2, long j, long j2) {
        this(activity);
        setRv(str2);
        setDur(j2 + "");
