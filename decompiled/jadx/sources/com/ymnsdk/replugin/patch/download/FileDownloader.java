...
public class FileDownloader {
    ...
    private FileDownloader() {
        ...
        this.mCallback = null;
        this.mDownloadResume = new Interceptor() { // from class: com.ymnsdk.replugin.patch.download.-$$Lambda$FileDownloader$xbiRJJYc9H5SW7s69CK1t4yn2Gs
    ...
    static /* synthetic */ Response lambda$new$0(Interceptor.Chain chain) throws IOException {
    ...
    private boolean downloadFailed(DownloadCode.Code code, int i) {
        ...
        DownloadFileState.getInstance().updateTaskState(downloadFileInfo);
        switch (AnonymousClass1.$SwitchMap$com$ymnsdk$replugin$patch$download$DownloadCode$Code[code.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
    ...
    /* JADX WARN: Classes with same name are omitted, all sources:
      ...
      classes4.dex
     */
    /* JADX INFO: renamed from: com.ymnsdk.replugin.patch.download.FileDownloader$1, reason: invalid class name */
