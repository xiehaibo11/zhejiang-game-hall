...
public class PluginInstallWapper {
        ...
        PatchDownloadApi.downloadPatch(activity, str, str2, i, j, str3, i2, i3, 0, new DownloadCallback() { // from class: com.ymnsdk.replugin.feature.PluginInstallWapper.2
            ...
            public void downloadSuccess(String str5) {
                ...
                if (i == 1) {
                    ...
                    DownloadUtils.getInstance().mergeApk(activity, str, str5, str4, new MergeCallback() { // from class: com.ymnsdk.replugin.feature.PluginInstallWapper.2.1
            ...
            public void downloadFail(DownloadCode.Code code) {
                ...
                int i4 = AnonymousClass3.$SwitchMap$com$ymnsdk$replugin$patch$download$DownloadCode$Code[code.ordinal()];
                if (i4 != 1 && i4 != 2) {
                    if (i4 == 3 || i4 == 4 || i4 == 5) {
    ...
    /* JADX WARN: Classes with same name are omitted, all sources:
      ...
      classes4.dex
     */
    /* JADX INFO: renamed from: com.ymnsdk.replugin.feature.PluginInstallWapper$3, reason: invalid class name */
