...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    BaseWXApiImplV10(Context context, String str, boolean z, int i) {
        ...
        this.launchMode = i;
        b.f5473a = context.getApplicationContext();
    }
    ...
    private void launchWXUsingPendingIntent() {
        ...
        try {
            ...
            PendingIntent.getActivity(this.context, 1, this.context.getPackageManager().getLaunchIntentForPackage("com.tencent.mm"), DownloadExpSwitchCode.BUGFIX_SIGBUS_24_25).send(this.context, 2, null, new PendingIntent.OnFinished() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.2
    ...
    private boolean sendOpenBusinessWebview(Context context, BaseReq baseReq) {
        ...
        Cursor cursorQuery = contentResolver.query(uri, null, null, new String[]{this.appId, req.businessType + "", (map == null || map.size() <= 0) ? "" : new JSONObject((Map<String, Object>) req.queryInfo).toString()}, null);
        if (cursorQuery != null) {
            cursorQuery.close();
        }
        return true;
    ...
    public boolean registerApp(String str, long j) {
        ...
        c0374a.f5463a = "com.tencent.mm";
        c0374a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0374a.c = "weixin://registerapp?appid=" + this.appId;
        c0374a.d = j;
        return a.a(this.context, c0374a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0374a c0374a = new a.C0374a();
        c0374a.f5463a = "com.tencent.mm";
        c0374a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0374a.c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0374a);
    }
}
