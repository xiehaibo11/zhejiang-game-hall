...
public class QQToken {
    ...
    public String getOpenIdWithCache() {
        ...
        try {
            if (TextUtils.isEmpty(openId)) {
                JSONObject jSONObjectLoadSession = loadSession(this.f5417a);
                ...
                SLog.i("QQToken", "getOpenId from Session openId = " + openId + " appId = " + this.f5417a);
            } else {
                SLog.i("QQToken", "getOpenId from field openId = " + openId + " appId = " + this.f5417a);
            }
        } catch (Exception e) {
    ...
    public boolean saveSession(JSONObject jSONObject) {
        try {
            ...
            return a(this.f5417a, jSONObject, this.f);
        } catch (Exception e) {
