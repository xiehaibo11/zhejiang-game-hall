...
public class AuthAgent extends BaseApi {
    ...
    private boolean a(Activity activity, Fragment fragment, Map<String, Object> map, boolean z, Object[] objArr) {
        ...
        if (intentC != null) {
            ...
            try {
                this.f5408a = new b(this.f5408a);
                UIListenerManager.getInstance().setListenerWithRequestcode(Constants.REQUEST_LOGIN, this.f5408a);
                if (fragment != null) {
    ...
    private class a extends DefaultUiListener {
        ...
        public void onComplete(Object obj) {
            ...
            try {
                ...
                if (this.f5411a != null) {
                    this.f5411a.onComplete(new JSONObject().put("ret", i).put("msg", string));
                }
        ...
        @Override // com.tencent.tauth.DefaultUiListener, com.tencent.tauth.IUiListener
        public void onError(UiError uiError) {
            IUiListener iUiListener = this.f5411a;
            if (iUiListener != null) {
    ...
    private class b extends DefaultUiListener {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        WeakReference<IUiListener> f5412a;
        ...
        public b(IUiListener iUiListener) {
            this.f5412a = new WeakReference<>(iUiListener);
        }
        ...
        public void onComplete(Object obj) {
            ...
            if (z && !TextUtils.isEmpty(strDecode)) {
                a(strDecode, this.f5412a.get(), obj);
                SLog.i("openSDK_LOG.AuthAgent", " WORDING is not empty and return");
                return;
            }
            IUiListener iUiListener = this.f5412a.get();
            if (iUiListener != null) {
        ...
        public void onError(UiError uiError) {
            if (this.f5412a.get() != null) {
                this.f5412a.get().onError(uiError);
            }
        }
