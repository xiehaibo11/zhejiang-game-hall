...
public class H5JavaScriptInterface {
    ...
    private static HashSet<Integer> f5311a = new HashSet<>();
    ...
    public static H5JavaScriptInterface getInstance(CrashReport.a aVar) {
        String string = null;
        if (aVar == null || f5311a.contains(Integer.valueOf(aVar.hashCode()))) {
            return null;
        }
        H5JavaScriptInterface h5JavaScriptInterface = new H5JavaScriptInterface();
        f5311a.add(Integer.valueOf(aVar.hashCode()));
    ...
    private static bb a(String str) {
        ...
        if (str != null && str.length() > 0) {
            try {
                ...
                bb bbVar = new bb();
                bbVar.f5362a = jSONObject.getString("projectRoot");
                if (bbVar.f5362a == null) {
                    return null;
                }
                ...
                al.a("[projectRoot]: " + bbVar.f5362a, new Object[0]);
    ...
    public void reportJSException(String str) {
        ...
        if (bbVarA.f5362a != null) {
            linkedHashMap2.put("[JS] projectRoot", bbVarA.f5362a);
        }
        if (bbVarA.b != null) {
