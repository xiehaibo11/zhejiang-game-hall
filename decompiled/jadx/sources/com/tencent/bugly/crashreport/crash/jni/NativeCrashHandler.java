...
public class NativeCrashHandler implements q {
    ...
    private synchronized void a(boolean z) {
        ...
        if (this.j) {
            try {
                String strRegist = regist(f5312a, z, c);
                if (strRegist != null) {
            ...
            try {
                ...
                if (str == null) {
                    ...
                    aa.b();
                    str = (String) ap.a("com.tencent.feedback.eup.jni.NativeExceptionUpload", "registNativeExceptionHandler", clsArr2, new Object[]{f5312a, ab.d(), Integer.valueOf(aa.B())});
                }
                if (str != null) {
                    this.k = true;
                    this.e.u = str;
    ...
    public synchronized void startNativeMonitor() {
        if (!this.j && !this.i) {
            ...
            if (this.j || this.i) {
                ...
                setNativeLaunchTime(this.e.f5315a);
                return;
            }
            return;
        }
        ...
        this.f.a(new Runnable() { // from class: com.tencent.bugly.crashreport.crash.jni.NativeCrashHandler.1
            ...
            public final void run() {
                ...
                if (ap.a(NativeCrashHandler.this.d, "native_record_lock")) {
                    ...
                    CrashDetailBean crashDetailBeanA = be.a(NativeCrashHandler.this.d, NativeCrashHandler.f5312a, NativeCrashHandler.this.g);
