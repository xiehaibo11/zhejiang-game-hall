...
public final class aq extends BroadcastReceiver {
    ...
    private IntentFilter f5339a = new IntentFilter();
    ...
    public final synchronized void a(String str) {
        if (!this.f5339a.hasAction(str)) {
            this.f5339a.addAction(str);
        }
        ...
        ap.a(new Runnable() { // from class: com.tencent.bugly.proguard.aq.1
            ...
            public final void run() {
                try {
                    ...
                    synchronized (this) {
                        aq.this.b.registerReceiver(aq.d, aq.this.f5339a, "com.tencent.bugly.BuglyBroadcastReceiver.permission", null);
                    }
                } catch (Throwable th) {
                    th.printStackTrace();
                }
        ...
        if (context != null && intent != null) {
            if (intent.getAction().equals("android.net.conn.CONNECTIVITY_CHANGE")) {
                ...
                if (acVarA != null && aiVarA != null && aaVarA != null) {
                    if (!strC.equals(str) && jCurrentTimeMillis - aiVarA.a(at.f5345a) > 30000) {
