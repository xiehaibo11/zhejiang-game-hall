...
public final class ag {
    ...
    private final SimpleDateFormat f5320a;
    private final ad b;
    ...
    private ag() {
        this.f5320a = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss:SSS", Locale.US);
        this.b = new ad();
    }
    ...
    private static void e(List<b> list) {
        for (b bVar : list) {
            al.c("sla save id:%s time:%s msg:%s", bVar.f5323a, Long.valueOf(bVar.b), bVar.c);
            try {
                ContentValues contentValues = new ContentValues();
                contentValues.put("_id", bVar.f5323a);
    ...
    public static List<b> a() {
        ...
        while (cursorA.moveToNext()) {
            try {
                try {
                    b bVar = new b();
                    bVar.f5323a = cursorA.getString(cursorA.getColumnIndex("_id"));
    ...
    public static class b {
        ...
        public final String toString() {
            return "SLAData{uuid='" + this.f5323a + "', time=" + this.b + ", data='" + this.c + "'}";
        }
    }
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final ag f5322a = new ag(0);
    }
    ...
    private b b(c cVar) {
        ...
        sb.append(this.f5320a.format(new Date(cVar.c)));
        ...
        al.c("sla convert eventId:%s eventType:%s, eventTime:%s success:%s cost:%s from:%s uploadMsg:", cVar.f5324a, cVar.b, Long.valueOf(cVar.c), Boolean.valueOf(cVar.d), Long.valueOf(cVar.e), cVar.f, cVar.g);
        String str = cVar.f5324a + Constants.ACCEPT_TIME_SEPARATOR_SERVER + cVar.b;
        b bVar = new b();
        bVar.f5323a = str;
        bVar.b = cVar.c;
        bVar.c = string;
