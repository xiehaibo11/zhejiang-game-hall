...
public final class i {
    ...
    public final i a(byte[] bArr, String str) {
        ...
        StringBuilder sb2 = this.f5383a;
        sb2.append(bArr.length);
        sb2.append(", [\n");
        i iVar = new i(this.f5383a, this.b + 1);
        for (byte b : bArr) {
    ...
    public final <K, V> i a(Map<K, V> map, String str) {
        ...
        sb2.append(", {\n");
        i iVar = new i(this.f5383a, this.b + 1);
        i iVar2 = new i(this.f5383a, this.b + 2);
