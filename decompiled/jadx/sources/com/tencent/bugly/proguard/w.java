    ...
    public synchronized int a(String str, String str2, String[] strArr, v vVar) {
        ...
        try {
            try {
                ...
                if (f5401a && writableDatabase != null) {
                }
            }
        } finally {
            if (vVar != null) {
    ...
    */
    ...
    private static ContentValues c(y yVar) {
        ...
        try {
            ...
            if (yVar.f5404a > 0) {
                contentValues.put("_id", Long.valueOf(yVar.f5404a));
            }
    ...
    private static y a(Cursor cursor) {
        ...
        try {
            y yVar = new y();
            yVar.f5404a = cursor.getLong(cursor.getColumnIndex("_id"));
