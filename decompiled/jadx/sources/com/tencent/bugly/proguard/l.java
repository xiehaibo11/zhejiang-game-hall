...
public final class l {
    ...
    public ByteBuffer f5386a;
    protected String b;

    public l(int i) {
        this.b = "GBK";
        this.f5386a = ByteBuffer.allocate(i);
    }
    ...
    private void a(int i) {
        if (this.f5386a.remaining() < i) {
            ByteBuffer byteBufferAllocate = ByteBuffer.allocate((this.f5386a.capacity() + i) * 2);
            byteBufferAllocate.put(this.f5386a.array(), 0, this.f5386a.position());
            this.f5386a = byteBufferAllocate;
        }
    }

    private void b(byte b, int i) {
        if (i < 15) {
            this.f5386a.put((byte) (b | (i << 4)));
        } else {
            if (i < 256) {
                this.f5386a.put((byte) (b | 240));
                this.f5386a.put((byte) i);
                return;
            }
    ...
    private void a(float f, int i) {
        a(6);
        b((byte) 4, i);
        this.f5386a.putFloat(f);
    }

    private void a(double d, int i) {
        a(10);
        b((byte) 5, i);
        this.f5386a.putDouble(d);
    }
    ...
    public final void a(String str, int i) {
        ...
        if (bytes.length > 255) {
            b((byte) 7, i);
            this.f5386a.putInt(bytes.length);
            this.f5386a.put(bytes);
        } else {
            b((byte) 6, i);
            this.f5386a.put((byte) bytes.length);
            this.f5386a.put(bytes);
        }
    }
