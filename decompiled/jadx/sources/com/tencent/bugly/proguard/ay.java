...
public final class ay {
    ...
    public final AtomicBoolean f5355a = new AtomicBoolean(false);
    ...
    private CrashDetailBean a(ax axVar) {
        ...
        try {
            ...
            crashDetailBean.A = axVar.f5354a;
    ...
    public final boolean a(boolean z) {
        boolean zCompareAndSet = this.f5355a.compareAndSet(!z, z);
        ...
        try {
            ...
            if (TextUtils.isEmpty(str) || !new File(str).exists()) {
                ...
                if (str.startsWith("/data/anr/")) {
                    al.a("backup trace isOK:%s", Boolean.valueOf(a(str, file.getAbsolutePath(), axVar.f5354a)));
                } else {
                    al.a("trace file rename :%s", Boolean.valueOf(new File(str).renameTo(file)));
                }
                synchronized (this.j) {
                    listC = this.m != null ? this.m.f5367a.c() : null;
                }
                if (listC != null) {
            ...
            if (crashDetailBeanA.f5307a >= 0) {
                al.a("backup anr record success!", new Object[0]);
            } else {
                al.d("backup anr record fail!", new Object[0]);
            }
            as.a("ANR", ap.a(j), axVar.f5354a, RePlugin.PLUGIN_NAME_MAIN, axVar.g, crashDetailBeanA);
