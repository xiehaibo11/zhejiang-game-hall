...
public class b {
    ...
    protected HashMap<String, C0377b> f5494a = new HashMap<>();

    /* JADX INFO: compiled from: ProGuard */
    public static class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        protected WeakReference<WebView> f5495a;
        protected long b;
        protected String c;
    ...
    public void a(C0377b c0377b, String str) {
        this.f5494a.put(str, c0377b);
    }
    ...
    public void a(String str, String str2, List<String> list, a aVar) {
        ...
        C0377b c0377b = this.f5494a.get(str);
        if (c0377b != null) {
            SLog.d("openSDK_LOG.JsBridge", "call----");
            c0377b.call(str2, list, aVar);
        } else {
