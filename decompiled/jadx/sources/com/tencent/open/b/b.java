...
public class b {
    ...
    private void c() {
        while (!this.j.isEmpty()) {
            ...
            cVar.f5499a.put("appid", this.b);
            cVar.f5499a.put("app_name", this.c);
            cVar.f5499a.put(Constants.PARAM_APP_VER, this.e);
            cVar.f5499a.put("pkg_name", this.f);
            cVar.f5499a.put("qq_install", this.g);
            cVar.f5499a.put(Constants.PARAM_QQ_VER, this.h);
            cVar.f5499a.put("openid", this.d);
            cVar.f5499a.put("time_appid_openid", cVar.f5499a.get("time") + "_" + this.b + "_" + this.d);
    ...
    private boolean b(c cVar) {
        ...
        do {
            ...
            try {
                ...
                return com.tencent.open.a.f.a().b("https://h.trace.qq.com/kv", cVar.f5499a).d() == 200;
            } catch (Exception e) {
