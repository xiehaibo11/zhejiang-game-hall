...
public class d extends com.tencent.open.c implements a.InterfaceC0378a {
    static Toast c;
    private String d;
    ...
    public d(Context context, String str, String str2, IUiListener iUiListener, QQToken qQToken) {
        ...
        this.g = new HandlerC0379d(this.f, context.getMainLooper());
        this.e = iUiListener;
    ...
    private void c() {
        ...
        this.f5507a.a(new b(), "sdk_js_if");
        this.i.clearView();
        this.i.loadUrl(this.d);
    }

    /* JADX INFO: compiled from: ProGuard */
    private class b extends b.C0377b {
        private b() {
        }
    }
    ...
    /* JADX INFO: compiled from: ProGuard */
    private class HandlerC0379d extends Handler {
        private c b;

        public HandlerC0379d(c cVar, Looper looper) {
            super(looper);
            this.b = cVar;
        }
    ...
    private static class c extends DefaultUiListener {
        ...
        public void onComplete(Object obj) {
            ...
            h.a().a(this.d + "_H5", SystemClock.elapsedRealtime(), 0L, 0L, jSONObject.optInt("ret", -6), this.f5513a, false);
        ...
        public void onError(UiError uiError) {
            ...
            if (uiError.errorMessage != null) {
                str = uiError.errorMessage + this.f5513a;
            } else {
                str = this.f5513a;
            }
            h hVarA = h.a();
    ...
    @Override // com.tencent.open.c.a.InterfaceC0378a
    public void a(int i) {
        WeakReference<Context> weakReference = this.j;
        if (weakReference != null && weakReference.get() != null) {
