...
public class TDialog extends c {
    ...
    private static class OnTimeListener extends DefaultUiListener {
        ...
        public void onComplete(Object obj) {
            ...
            h.a().a(this.d + "_H5", SystemClock.elapsedRealtime(), 0L, 0L, jSONObject.optInt("ret", -6), this.f5483a, false);
        ...
        public void onError(UiError uiError) {
            ...
            if (uiError.errorMessage != null) {
                str = uiError.errorMessage + this.f5483a;
            } else {
                str = this.f5483a;
            }
            h hVarA = h.a();
    ...
    private void b() {
        ...
        this.f5507a.a(new JsListener(), "sdk_js_if");
    ...
    /* JADX INFO: compiled from: ProGuard */
    private class JsListener extends b.C0377b {
        private JsListener() {
        }
