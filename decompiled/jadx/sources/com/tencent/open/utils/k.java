...
public class k {
    ...
    private static ConcurrentHashMap<String, com.tencent.a.a.a> f5540a = new ConcurrentHashMap<>();
    ...
    private static PackageInfo e(Context context, String str) {
        ...
        synchronized (k.class) {
            if (f5540a.containsKey(str)) {
                com.tencent.a.a.a aVar = f5540a.get(str);
                if (aVar == null) {
            ...
            f5540a.put(str, new com.tencent.a.a.a(str, packageInfoF));
            return packageInfoF;
        }
    }
