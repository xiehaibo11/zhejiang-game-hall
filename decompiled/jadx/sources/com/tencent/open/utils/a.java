...
public class a {
    ...
    public a(Context context) {
        try {
            ...
            this.f5526a = keyStore;
            keyStore.load(null);
            if (this.f5526a.containsAlias("KEYSTORE_AES")) {
                return;
            }
            c("");
            a(context);
    ...
    private void a(Context context) throws Exception {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance(com.alipay.sdk.m.n.d.f1221a, "AndroidKeyStore");
            ...
            KeyPairGenerator keyPairGenerator2 = KeyPairGenerator.getInstance(com.alipay.sdk.m.n.d.f1221a, "AndroidKeyStore");
    ...
    private void a() throws Exception {
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            PublicKey publicKey = this.f5526a.getCertificate("KEYSTORE_AES").getPublicKey();
    ...
    private SecretKeySpec c() throws Exception {
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            PrivateKey privateKey = (PrivateKey) this.f5526a.getKey("KEYSTORE_AES", null);
            Cipher cipher = Cipher.getInstance("RSA/ECB/PKCS1Padding");
