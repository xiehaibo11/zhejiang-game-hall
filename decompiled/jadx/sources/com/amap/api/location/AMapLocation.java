...
public class AMapLocation extends Location implements Parcelable, Cloneable {
    ...
    public static final Parcelable.Creator<AMapLocation> CREATOR = new Parcelable.Creator<AMapLocation>() { // from class: com.amap.api.location.AMapLocation.1
        private static AMapLocation a(Parcel parcel) {
            ...
            aMapLocation.f1369a = parcel.readString();
    ...
    public AMapLocation m7clone() {
        ...
        try {
            ...
            aMapLocation.setBuildingId(this.f1369a);
            ...
            if (this.c != null) {
                aMapLocation.setLocationQualityReport(this.c.m9clone());
            }
    ...
    public JSONObject toJson(int i) {
        try {
            ...
            jSONObject.put("poiid", this.f1369a);
    ...
    public String toString() {
        ...
        try {
            ...
            stringBuffer.append("poiid=" + this.f1369a + "#");
