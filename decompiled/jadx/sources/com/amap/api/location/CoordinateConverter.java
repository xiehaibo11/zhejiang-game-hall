...
public class CoordinateConverter {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f1381a[CoordType.MAPBAR.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1381a[CoordType.MAPABC.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1381a[CoordType.SOSOMAP.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1381a[CoordType.ALIYUN.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f1381a[CoordType.GOOGLE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f1381a[CoordType.GPS.ordinal()] = 7;
    ...
    public synchronized DPoint convert() throws Exception {
        ...
        boolean z = false;
        String str = null;
        switch (AnonymousClass1.f1381a[this.k.ordinal()]) {
            case 1:
                this.f1380a = fu.a(this.l);
                if ((b & c) == 0) {
                    str = AdnName.BAIDU;
                    i2 = b;
                    i3 = c;
                ...
                break;
            case 2:
                this.f1380a = fu.b(this.j, this.l);
                if ((b & d) == 0) {
                    str = "mapbar";
                    i2 = b;
                    i3 = d;
