...
public final class ev {
    ...
    public final ew a(ew ewVar) {
        ...
        this.e = fz.b();
        if (!fz.a(this.f2958a) || !fz.a(ewVar)) {
            this.b = fz.b();
            this.f2958a = ewVar;
            return ewVar;
        }
        if (ewVar.getTime() == this.f2958a.getTime() && ewVar.getAccuracy() < 300.0f) {
            return ewVar;
        }
        ...
        if (ewVar.c() != this.f2958a.c()) {
            this.b = fz.b();
            this.f2958a = ewVar;
            return ewVar;
        }
        if (ewVar.getBuildingId() != null && !ewVar.getBuildingId().equals(this.f2958a.getBuildingId()) && !TextUtils.isEmpty(ewVar.getBuildingId())) {
            this.b = fz.b();
            this.f2958a = ewVar;
            return ewVar;
        }
        this.d = ewVar.getLocationType();
        float fA = fz.a(ewVar, this.f2958a);
        float accuracy = this.f2958a.getAccuracy();
        ...
        if (fA >= 10.0f || fA <= 0.1d || accuracy2 <= 5.0f) {
            ...
            ew ewVarB2 = b(this.f2958a);
            this.f2958a = ewVarB2;
            return ewVarB2;
        }
        if (f >= -300.0f) {
            ew ewVarB3 = b(this.f2958a);
            this.f2958a = ewVarB3;
            return ewVarB3;
        }
