...
public abstract class bp extends r {
    ...
    private byte[] B() {
        ...
        try {
            ...
            if (i()) {
                byte[] bArrA = n.a(this.f2874a, k(), this.b != null && "navi".equals(this.b.a()));
    ...
    public Map<String, String> e() {
        String strF = l.f(this.f2874a);
        String strA = n.a();
        String strA2 = n.a(this.f2874a, strA, "key=".concat(String.valueOf(strF)));
