...
public final class d {
    ...
    /* JADX INFO: renamed from: com.loc.d$3, reason: invalid class name */
    /* JADX INFO: compiled from: AmapLocationManager.java */
    static /* synthetic */ class AnonymousClass3 {
        ...
        static {
            ...
            try {
                f2922a[AMapLocationClientOption.AMapLocationMode.Device_Sensors.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f2922a[AMapLocationClientOption.AMapLocationMode.Hight_Accuracy.ordinal()] = 3;
    ...
    static class b extends HandlerThread {
        ...
        protected final void onLooperPrepared() {
            try {
                ...
                fw.a(this.f2924a.D);
                this.f2924a.p();
                if (this.f2924a != null && this.f2924a.D != null) {
                    fq.b(this.f2924a.D);
                    fq.a(this.f2924a.D);
                }
    ...
    public class c extends Handler {
        ...
        public final void handleMessage(Message message) {
            try {
                ...
                if (i != 2) {
                    if (i == 13) {
                        if (d.this.f2919a != null) {
                            d.this.a(d.this.f2919a);
                            return;
                        }
    ...
    */
    ...
    public synchronized void j() {
        ...
        this.G = true;
        int i = AnonymousClass3.f2922a[this.b.getLocationMode().ordinal()];
