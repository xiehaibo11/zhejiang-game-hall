...
public final class o {
        ...
        cr.a().b(new cs() { // from class: com.loc.o.1
            ...
            public final void a() {
                try {
                    ...
                    bo.a();
                    String strA2 = o.g.a(context, new String(bo.a(o.g.a(strA.getBytes(), mapB)).f2891a));
    ...
    */
    private static java.lang.String a(android.content.Context r12, int r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.loc.o.a(android.content.Context, int):java.lang.String");
    }
    ...
    public static String f(Context context) {
        ...
        if (f3019a != null && !"".equals(f3019a)) {
            return f3019a;
        }
        if (b(context, x.c("WYW5kcm9pZC5wZXJtaXNzaW9uLldSSVRFX1NFVFRJTkdT"))) {
            f3019a = Settings.System.getString(context.getContentResolver(), "mqBRboGZkQPcAkyk");
        }
        if (!TextUtils.isEmpty(f3019a)) {
            t = true;
            return f3019a;
        }
        try {
