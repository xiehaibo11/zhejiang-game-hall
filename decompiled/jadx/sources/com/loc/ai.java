...
public final class ai {
    ...
    public static final String f2835a = x.c("SU2hhcmVkUHJlZmVyZW5jZUFkaXU");
    private static ai f;
    ...
    private static final class a extends Handler {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final WeakReference<ai> f2837a;

        a(Looper looper, ai aiVar) {
            super(looper);
            this.f2837a = new WeakReference<>(aiVar);
        }
    ...
    public synchronized void a(final String str, final int i) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            new Thread() { // from class: com.loc.ai.1
                ...
                public final void run() {
                    ...
                    if ((i & 256) > 0) {
                        SharedPreferences.Editor editorEdit = ai.this.d.getSharedPreferences(ai.f2835a, 0).edit();
        ...
        if (!TextUtils.isEmpty(strB)) {
            ...
            if ((i & 256) > 0) {
                SharedPreferences.Editor editorEdit = this.d.getSharedPreferences(f2835a, 0).edit();
