...
public final class av extends as implements Thread.UncaughtExceptionHandler {
    ...
    private static final ThreadFactory h = new ThreadFactory() { // from class: com.loc.av.2
        ...
        private final AtomicInteger f2852a = new AtomicInteger(1);

        @Override // java.util.concurrent.ThreadFactory
        public final Thread newThread(Runnable runnable) {
            return new Thread(runnable, "pama#" + this.f2852a.getAndIncrement()) { // from class: com.loc.av.2.1
    ...
    public static synchronized av a(Context context, w wVar) throws k {
        try {
            ...
            if (as.f2847a == null) {
                as.f2847a = new av(context);
            } else {
                as.f2847a.c = false;
            }
            as.f2847a.a(wVar, as.f2847a.c);
            return (av) as.f2847a;
        } catch (Throwable th2) {
            throw th2;
        }
    ...
    public static void a(w wVar, String str, String str2, String str3, String str4, String str5) {
        try {
            if (as.f2847a != null) {
                as.f2847a.a(wVar, "path:" + str + ",type:" + str2 + ",gsid:" + str3 + ",csid:" + str4 + ",code:" + str5, SplashMonitorInfo.ERROR_NET_MSG);
            }
        } catch (Throwable unused) {
        }
    }
    ...
    public static synchronized void b() {
        ...
        try {
            if (as.f2847a != null && Thread.getDefaultUncaughtExceptionHandler() == as.f2847a && as.f2847a.b != null) {
                Thread.setDefaultUncaughtExceptionHandler(as.f2847a.b);
            }
            as.f2847a = null;
        } catch (Throwable th2) {
            th2.printStackTrace();
