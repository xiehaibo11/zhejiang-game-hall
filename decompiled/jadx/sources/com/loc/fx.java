...
public final class fx {
    ...
    public SparseArray<Long> f2989a = new SparseArray<>();
    public int b = -1;
    public long c = 0;
    ...
    /* JADX INFO: renamed from: com.loc.fx$1, reason: invalid class name */
    /* JADX INFO: compiled from: ReportUtil.java */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f2990a[AMapLocationClientOption.AMapLocationMode.Device_Sensors.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f2990a[AMapLocationClientOption.AMapLocationMode.Hight_Accuracy.ordinal()] = 3;
    ...
    */
    public static synchronized void a(android.content.Context r8, com.amap.api.location.AMapLocation r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.loc.fx.a(android.content.Context, com.amap.api.location.AMapLocation):void");
    }
    ...
    public static void a(AMapLocation aMapLocation, AMapLocation aMapLocation2) {
        try {
            ...
            if (fz.a(g) && fz.a(aMapLocation2)) {
                ...
                if (g.getLocationType() != 1 && g.getLocationType() != 9 && !"gps".equalsIgnoreCase(g.getProvider()) && g.getLocationType() != 7 && aMapLocationM7clone.getLocationType() != 1 && aMapLocationM7clone.getLocationType() != 9 && !"gps".equalsIgnoreCase(aMapLocationM7clone.getProvider()) && aMapLocationM7clone.getLocationType() != 7) {
                    long jAbs = Math.abs(aMapLocationM7clone.getTime() - g.getTime()) / 1000;
                    if (jAbs <= 0) {
                        jAbs = 1;
                    }
                    if (jAbs <= com.tkay.expressad.d.a.b.aC) {
                        float fA = fz.a(g, aMapLocationM7clone);
                        float f = fA / jAbs;
                        if (fA > 30000.0f && f > 1000.0f) {
                            ...
                            if (aMapLocationM7clone.getTime() != 0) {
                                sb.append(fz.a(aMapLocationM7clone.getTime(), "yyyyMMdd_HH:mm:ss:SS"));
                            } else {
    ...
    public final void a(Context context, int i2) {
        try {
            ...
            if (this.b != -1 && this.b != i2) {
                this.f2989a.append(this.b, Long.valueOf((fz.b() - this.c) + this.f2989a.get(this.b, 0L).longValue()));
            }
    ...
    public final void a(Context context, AMapLocationClientOption aMapLocationClientOption) {
        try {
            int i2 = AnonymousClass1.f2990a[aMapLocationClientOption.getLocationMode().ordinal()];
            int i3 = 3;
            if (i2 == 1) {
                i3 = 4;
            } else if (i2 == 2) {
            ...
            if (this.e != -1 && this.e != i3) {
                this.f2989a.append(this.e, Long.valueOf((fz.b() - this.f) + this.f2989a.get(this.e, 0L).longValue()));
            }
    ...
    public final void b(Context context) {
        try {
            long jB = fz.b() - this.c;
            if (this.b != -1) {
                this.f2989a.append(this.b, Long.valueOf(jB + this.f2989a.get(this.b, 0L).longValue()));
            }
            long jB2 = fz.b() - this.f;
            if (this.e != -1) {
                this.f2989a.append(this.e, Long.valueOf(jB2 + this.f2989a.get(this.e, 0L).longValue()));
            }
            SharedPreferences.Editor editorA = fy.a(context, "pref1");
            for (int i2 = 0; i2 < this.d.length; i2++) {
                long jLongValue = this.f2989a.get(i2, 0L).longValue();
