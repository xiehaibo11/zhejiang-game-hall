...
public final class fd {
    ...
    private LinkedList<fc> f2970a = new LinkedList<>();
    ...
    private void a() {
        LinkedList<fc> linkedList = this.f2970a;
    ...
    public void b() {
        ...
        Iterator<fc> it = this.f2970a.iterator();
        while (it.hasNext()) {
            try {
    ...
    public final void a(fc fcVar) {
        ...
        if (i >= 5) {
            this.f2970a.remove(fcVar3);
        }
        if (this.f2970a.size() >= 10) {
            this.f2970a.removeFirst();
        }
        this.f2970a.add(fcVar);
        this.f = true;
    }
    ...
    public final void b(fc fcVar) {
        if (this.f2970a.size() > 0) {
            if (fcVar.f2969a != 6 && fcVar.f2969a != 5) {
                if (this.f2970a.contains(fcVar)) {
                    return;
                }
                if (this.f2970a.size() >= 10) {
                    this.f2970a.removeFirst();
