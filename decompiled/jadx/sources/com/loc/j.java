    ...
    private fi f() {
        ...
        if (listA == null || listA.size() <= 0) {
            ...
            try {
                ...
                String str2 = (bArrB3 == null || bArrB3.length <= 0 || (bArrB2 = fg.b(bArrB3, this.f3005a)) == null || bArrB2.length <= 0) ? null : new String(bArrB2, "UTF-8");
                byte[] bArrB4 = p.b(fiVar.b());
                if (bArrB4 != null && bArrB4.length > 0 && (bArrB = fg.b(bArrB4, this.f3005a)) != null && bArrB.length > 0) {
        ...
        try {
            ...
            if (this.c != null && fz.a(this.c.a()) && e != null && this.c != this.d && this.c.d() == 0) {
                ...
                if (TextUtils.isEmpty(str)) {
                    ...
                    String strB3 = p.b(fg.a(str.getBytes("UTF-8"), this.f3005a));
                    strB = TextUtils.isEmpty(strB2) ? null : p.b(fg.a(strB2.getBytes("UTF-8"), this.f3005a));
                    str = strB3;
                }
                if (TextUtils.isEmpty(str)) {
                    return;
