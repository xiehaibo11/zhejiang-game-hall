...
public final class db {
    ...
    private List<eg> f2928a = new ArrayList();
    ...
    private static boolean a(ef efVar, long j, long j2) {
        return j > 0 && j2 - j < ((long) ((efVar.g > 10.0f ? 1 : (efVar.g == 10.0f ? 0 : -1)) >= 0 ? 2000 : com.alipay.sdk.data.a.f1140a));
    }
    ...
    private static boolean a(List<eg> list, List<eg> list2) {
        if (list != null && list2 != null) {
            ...
            while (it.hasNext()) {
                map.put(Long.valueOf(it.next().f2941a), 1);
            }
            Iterator<eg> it2 = list2.iterator();
            int i2 = 0;
            while (it2.hasNext()) {
                if (((Integer) map.get(Long.valueOf(it2.next().f2941a))) != null) {
                    i2++;
                }
            }
    ...
    private boolean b(ef efVar, List<eg> list, boolean z, long j, long j2) {
        ...
        boolean zA = a(efVar);
        return !zA ? !a(list, this.f2928a) : zA;
    }
