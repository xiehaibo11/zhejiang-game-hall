...
public final class r extends z {
    ...
    protected final void a(com.vivo.push.o oVar) {
        ...
        boolean zIsEnablePush = ClientConfigManagerImpl.getInstance(this.f7928a).isEnablePush();
        com.vivo.push.b.q qVar = (com.vivo.push.b.q) oVar;
        if (!com.vivo.push.util.t.d(this.f7928a, this.f7928a.getPackageName())) {
        ...
        com.vivo.push.util.p.d("OnNotificationArrivedTask", "PushMessageReceiver " + this.f7928a.getPackageName() + " isEnablePush :" + zIsEnablePush);
        if (!zIsEnablePush) {
            com.vivo.push.b.x xVar2 = new com.vivo.push.b.x(1020L);
            HashMap<String, String> map2 = new HashMap<>();
            map2.put(com.heytap.mcssdk.constant.b.c, String.valueOf(qVar.f()));
            String strB2 = com.vivo.push.util.z.b(this.f7928a, this.f7928a.getPackageName());
        ...
        if (com.vivo.push.e.a().g() && !a(com.vivo.push.util.z.c(this.f7928a), qVar.e(), qVar.i())) {
            com.vivo.push.b.x xVar3 = new com.vivo.push.b.x(1021L);
            HashMap<String, String> map3 = new HashMap<>();
            map3.put(com.heytap.mcssdk.constant.b.c, String.valueOf(qVar.f()));
            String strB3 = com.vivo.push.util.z.b(this.f7928a, this.f7928a.getPackageName());
        ...
        if (insideNotificationItemD == null) {
            ...
            com.vivo.push.util.p.c(this.f7928a, "通知内容为空，" + qVar.f());
            com.vivo.push.util.e.a(this.f7928a, qVar.f(), 1027L);
            return;
        }
