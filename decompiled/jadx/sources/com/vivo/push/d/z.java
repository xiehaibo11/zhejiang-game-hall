...
public abstract class z extends com.vivo.push.l {
    ...
    public final boolean a(PublicKey publicKey, String str, String str2) {
        ...
        if (publicKey == null) {
            ...
            try {
                ...
                com.vivo.push.util.p.c(this.f7928a, "vertify fail srcDigest is ".concat(String.valueOf(str)));
                return false;
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public final int b() {
        ...
        NotificationManager notificationManager = (NotificationManager) this.f7928a.getSystemService(RemoteMessageConst.NOTIFICATION);
