...
public final class z {
    ...
    */
    ...
    public static boolean b(Context context, String str, String str2) {
        ...
        if (context == null) {
            p.a("Utility", com.tkay.expressad.foundation.g.b.b.f6873a);
            return false;
        }
    ...
    public static PublicKey c(Context context) {
        Cursor cursorQuery = context.getContentResolver().query(com.vivo.push.p.f7933a, null, null, null, null);
        if (cursorQuery == null) {
            return null;
        }
