...
public final class a extends q {
    ...
    private boolean b(Intent intent) {
        ...
        try {
            String strB = com.vivo.push.util.a.a(this.f7934a).b(stringExtra);
    ...
    private boolean c(Intent intent) {
        ...
        String strC = z.c(this.f7934a, "com.vivo.pushservice");
        ...
        try {
            if (d.a(this.f7934a).a().a("com.vivo.pushservice".getBytes("UTF-8"), u.a(stringExtra2), Base64.decode(stringExtra, 2))) {
    ...
    private int d(Intent intent) {
        ...
        String packageName = this.f7934a.getPackageName();
        try {
    ...
    public final void a(Intent intent) {
        if (intent != null && this.f7934a != null) {
            Message messageObtain = Message.obtain();
            messageObtain.obj = intent;
            a(messageObtain);
        } else {
            p.d("CommandWorker", " sendMessage error: intent : " + intent + ", mContext: " + this.f7934a);
        }
    }
    ...
    public final void b(Message message) {
        ...
        if (intent == null || this.f7934a == null) {
            p.d("CommandWorker", " handleMessage error: intent : " + intent + ", mContext: " + this.f7934a);
            return;
        }
        String packageName = this.f7934a.getPackageName();
        int iD = d(intent);
        if (iD <= 0) {
            try {
                ...
                method.invoke(objNewInstance, ContextDelegate.getContext(this.f7934a).getApplicationContext(), intent);
                return;
            } catch (Exception e2) {
        ...
        String strB = z.b(this.f7934a, packageName);
