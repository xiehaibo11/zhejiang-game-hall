...
public final class c {
    ...
    static C0056c a(RandomAccessFile randomAccessFile, m mVar) {
        ArrayMap arrayMap = new ArrayMap();
        try {
            CertificateFactory certificateFactory = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer byteBufferA = f.a(mVar.f1545a);
                int i = 0;
                C0056c c0056cA = null;
                while (byteBufferA.hasRemaining()) {
                    try {
                        c0056cA = a(f.a(byteBufferA), arrayMap, certificateFactory);
                        i++;
                    } catch (a unused) {
                    } catch (IOException e) {
                        e = e;
                ...
                if (arrayMap.containsKey(3)) {
                    c0056cA.c = f.a((byte[]) arrayMap.get(3), randomAccessFile.length(), mVar);
                }
                return c0056cA;
    ...
    private static C0056c a(ByteBuffer byteBuffer, Map<Integer, byte[]> map, CertificateFactory certificateFactory) throws IOException {
    ...
    private static C0056c a(ByteBuffer byteBuffer, List<X509Certificate> list, CertificateFactory certificateFactory) throws IOException {
        ...
        while (byteBuffer.hasRemaining()) {
            ...
            if (byteBufferA.getInt() == 1000370060) {
                ...
                try {
                    if (bVarA.f1536a.size() > 0 && !Arrays.equals(bVarA.f1536a.get(bVarA.f1536a.size() - 1).getEncoded(), x509CertificateArr[0].getEncoded())) {
        ...
        return new C0056c(x509CertificateArr, bVarA);
    }
    ...
    public static class b {
        ...
        public final List<X509Certificate> f1536a;
    ...
    public static class C0056c {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final X509Certificate[] f1537a;
        public final b b;
        public byte[] c;

        public C0056c(X509Certificate[] x509CertificateArr, b bVar) {
            this.f1537a = x509CertificateArr;
            this.b = bVar;
        }
    }
}
