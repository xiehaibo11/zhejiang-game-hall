...
public final class j {
    ...
    static volatile ArrayList<String> f1605a;
    ...
    public static synchronized List<String> b() {
        if (f1605a == null) {
            synchronized (j.class) {
                if (f1605a == null) {
                    f1605a = new ArrayList<>();
                    boolean z = false;
                    if (i.c()) {
                        try {
                            Resources resources = Zeus.getAppApplication().getResources();
                            f1605a.add(Zeus.getAppApplication().createPackageContext(resources.getString(resources.getIdentifier("android:string/config_webViewPackageName", com.tkay.expressad.foundation.h.i.g, "android")), 0).getApplicationInfo().sourceDir);
                        } catch (Exception e) {
                        ...
                        try {
                            ...
                            if (z) {
                                Collections.addAll(f1605a, a(((Context) objInvokeStaticMethod).getApplicationInfo()));
                            } else {
                                f1605a.add(((Context) objInvokeStaticMethod).getApplicationInfo().sourceDir);
                            }
                        } catch (Exception e2) {
