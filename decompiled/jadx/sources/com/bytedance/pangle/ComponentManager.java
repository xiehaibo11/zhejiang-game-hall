...
public class ComponentManager {
    ...
    public static void unregisterReceiver(Context context, PluginBroadcastReceiver pluginBroadcastReceiver) {
        ...
        if (pluginBroadcastReceiver != null) {
            com.bytedance.pangle.receiver.c cVarA = com.bytedance.pangle.receiver.c.a();
            Iterator<Map.Entry<String, c.a>> it = cVarA.f1576a.entrySet().iterator();
            while (it.hasNext()) {
                ...
                if (value != null && pluginBroadcastReceiver != null) {
                    try {
                        if (value.b.size() > 0 && (zRemove = value.b.remove(pluginBroadcastReceiver))) {
                            ZeusLogger.d(ZeusLogger.TAG_RECEIVER, "unregisterReceiver->[移除Action]:" + value.f1577a + ",receiver.hashCode()=" + pluginBroadcastReceiver.hashCode() + ",是否成功，success:" + zRemove);
                        }
                    } catch (Throwable th) {
                        ZeusLogger.w(ZeusLogger.TAG_RECEIVER, "unregisterReceiver-plugin-receiver->action:" + value.f1577a + "[exception]:", th);
                    }
                }
