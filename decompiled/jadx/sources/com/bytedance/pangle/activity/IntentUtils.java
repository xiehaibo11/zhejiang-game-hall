...
public class IntentUtils {
    ...
    static HashMap<Long, WeakReference<Bundle>> f1495a = new HashMap<>();
    ...
    public static void a(Intent intent, String str) {
        ...
        if (longExtra != 0) {
            ...
            f1495a.put(Long.valueOf(longExtra), new WeakReference<>(extras));
    ...
    public static void a(Intent intent) {
        long longExtra = intent.getLongExtra("pangle_use_memory", 0L);
        if (longExtra != 0) {
            WeakReference<Bundle> weakReferenceRemove = f1495a.remove(Long.valueOf(longExtra));
