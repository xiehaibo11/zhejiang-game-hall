    ...
    public final void unregisterReceiver(PluginBroadcastReceiver pluginBroadcastReceiver) {
        synchronized (this.mReceivers) {
            ...
            for (int size = arrayListRemove.size() - 1; size >= 0; size--) {
                ...
                bVar.d = true;
                for (int i = 0; i < bVar.f1491a.countActions(); i++) {
                    String action = bVar.f1491a.getAction(i);
        ...
        synchronized (this.mReceivers) {
            ...
            if (arrayList3 != null) {
                ...
                while (i2 < arrayList3.size()) {
                    ...
                    if (z) {
                        Log.v(TAG, "Matching against filter " + bVar.f1491a);
                    }
                    if (bVar.c) {
                        if (z) {
                        ...
                        arrayList2 = arrayList3;
                        str2 = strResolveTypeIfNeeded;
                        int iMatch = bVar.f1491a.match(action, strResolveTypeIfNeeded, scheme, data, categories, TAG);
                        if (iMatch >= 0) {
                            if (z) {
        ...
        while (true) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    if (!bVar.d) {
                        bVar.b.onReceive(this.mAppContext, aVar.f1490a);
                    }
                }
            }
        }
