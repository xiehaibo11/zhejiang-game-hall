...
public final class a {
    ...
    /* JADX INFO: renamed from: com.mbridge.msdk.widget.custom.a.a$a, reason: collision with other inner class name */
    /* JADX INFO: compiled from: MBLayoutInflate.java */
    ...
    public final View a(XmlPullParser xmlPullParser, ViewGroup viewGroup, boolean z) {
        int next;
        synchronized (this.e) {
            AttributeSet attributeSetAsAttributeSet = Xml.asAttributeSet(xmlPullParser);
            this.e[0] = this.f4419a;
            do {
                try {
    ...
    private View a(String str, String str2, AttributeSet attributeSet) throws InflateException, ClassNotFoundException {
        ...
        try {
            if (constructor == null) {
                ClassLoader classLoader = this.f4419a.getClassLoader();
                if (str2 != null) {
                    str4 = str2 + str;
                } else {
                    str4 = str;
                ...
                if (bool == null) {
                    ClassLoader classLoader2 = this.f4419a.getClassLoader();
                    if (str2 != null) {
                        str3 = str2 + str;
                    } else {
                        str3 = str;
    ...
    private View a(String str, AttributeSet attributeSet) {
        ...
        try {
            View viewA2 = this.c == null ? null : this.c.a(str, this.f4419a, attributeSet);
            if (viewA2 != null) {
                return viewA2;
            }
            if (-1 != str.indexOf(46)) {
            ...
            if (str.equals("MBStarLevelLayoutView")) {
                ...
                viewA = a(str, com.mbridge.msdk.widget.custom.b.d.b, attributeSet);
            }
            return viewA;
    ...
    private void b(XmlPullParser xmlPullParser, View view, AttributeSet attributeSet) throws XmlPullParserException, IOException {
        ...
        if (view instanceof ViewGroup) {
            ...
            XmlResourceParser layout = this.f4419a.getResources().getLayout(attributeResourceValue);
            try {
