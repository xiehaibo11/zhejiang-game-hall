...
/* JADX INFO: compiled from: RenderEngine.java */
/* JADX INFO: loaded from: classes3.dex */
public final class d {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private CustomViewMessageWrap f4422a;
    ...
    public d(CustomViewMessageWrap customViewMessageWrap, com.mbridge.msdk.widget.custom.a aVar, DownloadMessageDialog downloadMessageDialog, int i, int i2) {
        this.f4422a = customViewMessageWrap;
        this.b = aVar;
    ...
    public final void a(ViewGroup viewGroup) {
        if ((viewGroup instanceof MBStarLevelLayoutView) && viewGroup.getContentDescription().equals("getStarCount")) {
            ...
            CustomViewMessageWrap customViewMessageWrap = this.f4422a;
        ...
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            ...
            if (!TextUtils.isEmpty(childAt.getContentDescription())) {
                ...
                if (strArrSplit.length > 1) {
                    ...
                    if (e.a(str3)) {
                        ...
                        if (i2 == 1) {
                            childAt.setVisibility(TextUtils.isEmpty(CustomViewMessageWrap.getMessage(this.f4422a, str2)) ? 8 : 0);
                        } else if (i2 == 2) {
                            try {
                ...
                if (str.equals("close")) {
                    childAt.setOnClickListener(new View.OnClickListener() { // from class: com.mbridge.msdk.widget.custom.a.d.2
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            d.this.f4422a.putView("image_close", d.this.i);
                            d.this.b.a(d.this.c, d.this.f4422a, a.EnumC0311a.CLICK_EVENT_CLOSE);
                        }
                    });
                }
            ...
            if (childAt instanceof ViewGroup) {
                ...
                String message = CustomViewMessageWrap.getMessage(this.f4422a, String.valueOf(mBTextView.getContentDescription()));
                ...
                if (!TextUtils.isEmpty(mBImageView.getContentDescription())) {
                    if (mBImageView.getContentDescription().equals("imgbg")) {
                        this.g = mBImageView;
                        if (!TextUtils.isEmpty(CustomViewMessageWrap.getMessage(this.f4422a, "getApplicationImage"))) {
                        ...
                        String message2 = CustomViewMessageWrap.getMessage(this.f4422a, String.valueOf(mBImageView.getContentDescription()));
                        ...
                        String message3 = CustomViewMessageWrap.getMessage(this.f4422a, String.valueOf(mBImageView.getContentDescription()));
                        ...
                        mBImageView.setOnClickListener(new View.OnClickListener() { // from class: com.mbridge.msdk.widget.custom.a.d.4
                            ...
                            public final void onClick(View view) {
                                if (d.this.f4422a != null) {
                                    d.this.f4422a.putView("image_privacy", mBImageView);
                                }
                                d.this.b.a(d.this.c, d.this.f4422a, a.EnumC0311a.CLICK_EVENT_OPEN_PRIVACY);
                            }
                        });
                    }
                }
                ...
                if (!TextUtils.isEmpty(mBButton.getContentDescription()) && String.valueOf(mBButton.getContentDescription()).startsWith("download")) {
                    ...
                    mBButton.setOnClickListener(new View.OnClickListener() { // from class: com.mbridge.msdk.widget.custom.a.d.5
                        ...
                        public final void onClick(View view) {
                            if (d.this.f4422a != null) {
                                d.this.f4422a.putView("button_download", mBButton);
                            }
                            d.this.b.a(d.this.c, d.this.f4422a, a.EnumC0311a.CLICK_EVENT_DOWNLOAD);
                        }
                    });
                }
            }
