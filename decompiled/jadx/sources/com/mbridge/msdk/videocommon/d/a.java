...
public class a {
    ...
    private Map<String, Integer> f4391a;
    ...
    public final Map<String, Integer> i() {
        if (this.f4391a == null) {
            ...
            this.f4391a = map;
            map.put("1", 1000);
            this.f4391a.put("9", 1000);
            this.f4391a.put("8", 1000);
        }
        return this.f4391a;
    }
    ...
    public static a a(String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(com.tkay.expressad.videocommon.e.b.f7483a);
        ...
        try {
            if (this.f4391a != null && this.f4391a.size() > 0) {
                try {
                    ...
                    for (Map.Entry<String, Integer> entry : this.f4391a.entrySet()) {
                        jSONObject2.put(entry.getKey(), entry.getValue().intValue());
                    }
                    jSONObject.put(com.tkay.expressad.videocommon.e.b.f7483a, jSONObject2);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
