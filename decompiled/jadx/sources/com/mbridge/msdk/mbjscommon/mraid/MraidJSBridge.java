...
public class MraidJSBridge extends AbsMbridgeDownload {
    ...
    public void open(Object obj, String str) {
        ...
        if (obj instanceof com.mbridge.msdk.mbjscommon.windvane.a) {
            windVaneWebView = ((com.mbridge.msdk.mbjscommon.windvane.a) obj).f3733a;
            a.C0272a.f3722a.a(windVaneWebView, PushBuildConfig.sdk_conf_channelid);
        } else {
        ...
        try {
            ...
            if (this.f3721a == null || TextUtils.isEmpty(strOptString)) {
                return;
            }
            if (windVaneWebView == null || System.currentTimeMillis() - windVaneWebView.lastTouchTime <= com.mbridge.msdk.click.b.a.c || !com.mbridge.msdk.click.b.a.a(this.f3721a.getMraidCampaign(), windVaneWebView.getUrl(), com.mbridge.msdk.click.b.a.f3152a)) {
                this.f3721a.open(strOptString);
            }
        } catch (Throwable th) {
    ...
    public void close(Object obj, String str) {
        if (obj instanceof com.mbridge.msdk.mbjscommon.windvane.a) {
            a.C0272a.f3722a.a(((com.mbridge.msdk.mbjscommon.windvane.a) obj).f3733a, "close");
        }
        try {
    ...
    public void unload(Object obj, String str) {
        if (obj instanceof com.mbridge.msdk.mbjscommon.windvane.a) {
            a.C0272a.f3722a.a(((com.mbridge.msdk.mbjscommon.windvane.a) obj).f3733a, "unload");
        }
        try {
    ...
    public void useCustomClose(Object obj, String str) {
        if (obj instanceof com.mbridge.msdk.mbjscommon.windvane.a) {
            a.C0272a.f3722a.a(((com.mbridge.msdk.mbjscommon.windvane.a) obj).f3733a, "useCustomClose");
        }
        try {
            String strOptString = new JSONObject(str).optString("shouldUseCustomClose");
            z.d("MraidJSBridge", "MRAID useCustomClose " + strOptString);
            if (TextUtils.isEmpty(strOptString) || this.f3721a == null) {
                return;
            }
            this.f3721a.useCustomClose(strOptString.toLowerCase().equals("true"));
        } catch (Throwable th) {
    ...
    public void expand(Object obj, String str) {
        if (obj instanceof com.mbridge.msdk.mbjscommon.windvane.a) {
            a.C0272a.f3722a.a(((com.mbridge.msdk.mbjscommon.windvane.a) obj).f3733a, "expand");
        }
        try {
            ...
            if (TextUtils.isEmpty(strOptString) || TextUtils.isEmpty(strOptString2) || this.f3721a == null) {
                return;
            }
            this.f3721a.expand(strOptString, strOptString2.toLowerCase().equals("true"));
        } catch (Throwable th) {
    ...
    public void setOrientationProperties(Object obj, String str) {
        String str2;
        if (obj instanceof com.mbridge.msdk.mbjscommon.windvane.a) {
            a.C0272a.f3722a.a(((com.mbridge.msdk.mbjscommon.windvane.a) obj).f3733a, "setOrientationProperties");
        }
        try {
            JSONObject jSONObject = new JSONObject(str);
