    ...
    public void onDownloadAPKStatusChange(int i, String str) {
        try {
            ...
            if (this.currentObject instanceof a) {
                ...
                aVar.f3733a.post(new Runnable() { // from class: com.mbridge.msdk.mbjscommon.windvane.AbsMbridgeDownload.3
    ...
    public void onDownloadAPKProgressChange(int i, String str) {
        try {
            ...
            if (this.currentObject instanceof a) {
                ...
                aVar.f3733a.post(new Runnable() { // from class: com.mbridge.msdk.mbjscommon.windvane.AbsMbridgeDownload.4
                    @Override // java.lang.Runnable
                    public final void run() {
