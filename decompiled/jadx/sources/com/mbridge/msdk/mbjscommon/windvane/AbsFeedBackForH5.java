...
public abstract class AbsFeedBackForH5 extends j {
    ...
    public void feedbackOperate(Object obj, String str) {
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                com.mbridge.msdk.foundation.b.b.a().a(jSONObject.optString("key", ""), iOptInt == 1 ? 8 : 0, aVar.f3733a);
            }
            callbackSuccess(obj);
        } catch (Throwable th) {
    ...
    public void startShake(Object obj, String str) {
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                com.mbridge.msdk.mbjscommon.d.a.a().a(obj, ((a) obj).f3733a, jSONObject.optString("oldCache", ""), jSONObject.optString("cache", ""), iOptInt);
            }
            callbackSuccess(obj);
        } catch (Throwable th) {
            callbackExcep(obj, th.getMessage());
    ...
    public void stopShake(Object obj, String str) {
        try {
            if (!TextUtils.isEmpty(str)) {
                com.mbridge.msdk.mbjscommon.d.a.a().a(obj, ((a) obj).f3733a, new JSONObject(str).optString("cache", ""));
            }
            callbackSuccess(obj);
        } catch (Throwable th) {
            callbackExcep(obj, th.getMessage());
