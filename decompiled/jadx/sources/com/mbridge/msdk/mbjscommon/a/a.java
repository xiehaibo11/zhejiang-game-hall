...
public class a {
    ...
    /* JADX INFO: renamed from: com.mbridge.msdk.mbjscommon.a.a$a, reason: collision with other inner class name */
    /* JADX INFO: compiled from: H5ReportManager.java */
        ...
        try {
            ...
            if ("reportMessageR".equalsIgnoreCase(str)) {
                ...
                if (contextJ != null && !TextUtils.isEmpty(string)) {
                    try {
                        new com.mbridge.msdk.foundation.same.report.d.a(contextJ).post(0, d.a().f3453a, e.a(string, contextJ), new b() { // from class: com.mbridge.msdk.mbjscommon.a.a.1
            ...
            a(this.f3686a, "called reporter success", obj);
        } catch (Throwable th2) {
