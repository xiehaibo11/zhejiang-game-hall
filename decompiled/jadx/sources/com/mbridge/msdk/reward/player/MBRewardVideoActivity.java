...
public class MBRewardVideoActivity extends AbstractJSActivity {
    ...
    private com.mbridge.msdk.video.dynview.e.d J = new com.mbridge.msdk.video.dynview.e.d() { // from class: com.mbridge.msdk.reward.player.MBRewardVideoActivity.2
        ...
        public final void a() {
            ...
            try {
                com.mbridge.msdk.foundation.same.f.b.b().execute(new b(MBRewardVideoActivity.this.r, MBRewardVideoActivity.this.f3947a, 1));
    ...
    protected void onCreate(Bundle bundle) {
        ...
        try {
            ...
            this.f3947a = stringExtra;
            if (TextUtils.isEmpty(stringExtra)) {
                a("data empty error");
                return;
            }
            this.m = com.mbridge.msdk.reward.a.a.b.get(this.f3947a);
            ...
            com.mbridge.msdk.videocommon.d.c cVar = RewardUnitCacheManager.getInstance().get(this.b, this.f3947a);
            this.n = cVar;
            if (cVar == null) {
                com.mbridge.msdk.videocommon.d.c cVarA = com.mbridge.msdk.videocommon.d.b.a().a(com.mbridge.msdk.foundation.controller.a.f().k(), this.f3947a);
                this.n = cVarA;
                if (cVarA == null) {
                    this.n = com.mbridge.msdk.videocommon.d.b.a().a(com.mbridge.msdk.foundation.controller.a.f().k(), this.f3947a, this.f);
                }
            }
            if (this.n != null) {
                this.d.a(this.n.m());
            ...
            this.s = com.mbridge.msdk.videocommon.download.b.getInstance().b(this.f3947a);
            ...
            CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayListA = com.mbridge.msdk.videocommon.download.b.getInstance().a(this.f3947a);
            ...
            a.C0309a c0309aA = com.mbridge.msdk.videocommon.a.a(this.f3947a + "_" + this.y + "_" + cMPTEntryUrl);
            WindVaneWebView windVaneWebViewA = c0309aA != null ? c0309aA.a() : null;
            ...
            if (windVaneWebViewA == null) {
                ...
                this.k = false;
                try {
                    com.mbridge.msdk.reward.b.a.a(this.r, com.mbridge.msdk.foundation.controller.a.f().j(), "showMoreOffer showBTOld", this.f3947a, this.g, this.r.getRequestId(), this.r.getRequestIdNotice(), 0L);
                } catch (Exception unused) {
                }
                ...
                if (size == 1) {
                    ...
                    if (campaignEx2 != null) {
                        ...
                        com.mbridge.msdk.reward.b.a.a(this.r, com.mbridge.msdk.foundation.controller.a.f().j(), "no available campaign but to one offer show", this.f3947a, this.g, this.r.getRequestId(), this.r.getRequestIdNotice(), 0L);
                    }
                    a(this.r);
                    return;
                }
    ...
    private void b(CampaignEx campaignEx) {
        if (this.n == null || TextUtils.isEmpty(com.mbridge.msdk.videocommon.d.c.f4394a)) {
            return;
        }
        e.a().a(com.mbridge.msdk.videocommon.d.c.f4394a, campaignEx, (Context) this, this.f3947a, (com.mbridge.msdk.mbjscommon.confirmation.c) null);
    }
    ...
    public void a() {
        ...
        this.u.onCreate();
        try {
            com.mbridge.msdk.reward.b.a.a(this.r, com.mbridge.msdk.foundation.controller.a.f().j(), "showBTOld", this.f3947a, this.g, "", "", 0L);
        } catch (Exception unused) {
        }
        b(this.r);
    }
    ...
    private void b() {
        ...
        try {
            if (this.s != null && this.s.size() > 0) {
                com.mbridge.msdk.reward.b.a.a(this.s.get(0).g(), com.mbridge.msdk.foundation.controller.a.f().j(), "showMoreOffer", this.f3947a, this.g, "", "", 0L);
            }
        } catch (Exception unused) {
        }
    ...
    public void onResume() {
        ...
        com.mbridge.msdk.foundation.controller.a.f().a(this);
        try {
            com.mbridge.msdk.foundation.same.f.b.a().execute(new c(this.f3947a, this.s));
        } catch (Throwable th) {
    ...
    public void onDestroy() {
        ...
        com.mbridge.msdk.video.module.b.b.a(this.f3947a);
        MBTempContainer mBTempContainer = this.u;
        if (mBTempContainer != null) {
        ...
        this.I = null;
        this.J = null;
        com.mbridge.msdk.foundation.same.f.b.a().execute(new a(this.s, this.f3947a, this.y));
    }
    ...
    protected void onStart() {
        ...
        if (mBTempContainer != null) {
            ...
            this.r.setCampaignUnitId(this.f3947a);
            com.mbridge.msdk.foundation.b.b.a().a(this.f3947a + "_1", this.r);
        }
        MBridgeBTContainer mBridgeBTContainer = this.v;
        if (mBridgeBTContainer != null) {
            ...
            if (list != null && list.size() > 0) {
                CampaignEx campaignEx = this.t.get(0);
                campaignEx.setCampaignUnitId(this.f3947a);
                com.mbridge.msdk.foundation.b.b.a().a(this.f3947a + "_1", campaignEx);
            }
        }
        if (this.A) {
            return;
        }
        com.mbridge.msdk.foundation.b.b.a().c(this.f3947a + "_1", 1);
        com.mbridge.msdk.foundation.b.b.a().c(this.f3947a + "_2");
        this.A = true;
    }
    ...
    private static final class a implements Runnable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final List<com.mbridge.msdk.videocommon.download.a> f3952a;
        ...
        public final void run() {
            try {
                ...
                for (com.mbridge.msdk.videocommon.download.a aVar : this.f3952a) {
    ...
    public void finish() {
        ...
        com.mbridge.msdk.foundation.b.b.a().c(this.f3947a + "_1");
        com.mbridge.msdk.foundation.b.b.a().c(this.f3947a + "_2");
    }
    ...
    public void setTopControllerPadding(int i, int i2, int i3, int i4, int i5) {
        ...
        com.mbridge.msdk.video.dynview.a.a.f4131a = i2;
    ...
    private static final class b implements Runnable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final CampaignEx f3953a;
        private final String b;
        private final int c;

        public b(CampaignEx campaignEx, String str, int i) {
            this.f3953a = campaignEx;
            this.b = str;
            this.c = i;
        }
        ...
        @Override // java.lang.Runnable
        public final void run() {
            if (this.f3953a == null || TextUtils.isEmpty(this.b)) {
                return;
            }
            try {
                String mof_template_url = this.f3953a.getMof_template_url();
                com.mbridge.msdk.video.module.b.a.a(this.b, this.f3953a, this.c, TextUtils.isEmpty(mof_template_url) ? "" : ak.a(mof_template_url, "cltp"));
            } catch (Exception unused) {
            }
        }
    }
    ...
    private static final class c implements Runnable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final List<com.mbridge.msdk.videocommon.download.a> f3954a;
        private final String b;
        ...
        public final void run() {
            try {
                ...
                for (com.mbridge.msdk.videocommon.download.a aVar : this.f3954a) {
                    if (aVar != null && aVar.g() != null) {
