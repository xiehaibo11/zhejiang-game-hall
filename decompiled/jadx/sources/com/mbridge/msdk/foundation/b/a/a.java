...
public final class a {
    ...
    public final void a() {
        ...
        int i = b.a().a(this.f3329a, contextJ, this.v) ? 2 : 3;
        if (i == 2) {
            b.a().a(this.f3329a, 0, 2, y);
        } else {
            b.a().a(this.f3329a, 0, 3, y);
        }
        List<C0254a> list = this.w;
        if (list != null) {
    ...
    /* JADX INFO: renamed from: com.mbridge.msdk.foundation.b.a.a$a, reason: collision with other inner class name */
    /* JADX INFO: compiled from: FeedBackBtnBean.java */
    public static class C0254a implements com.mbridge.msdk.widget.dialog.a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private com.mbridge.msdk.foundation.b.a f3335a;
        private String b;
        ...
        public final void a() {
            b.c = false;
            com.mbridge.msdk.foundation.b.a aVar = this.f3335a;
            if (aVar != null) {
                aVar.a(a.y);
            }
        }
    ...
    static /* synthetic */ void a(a aVar) {
        b.a().a(aVar.f3329a, 1, 4, y);
        List<C0254a> list = aVar.w;
        if (list != null) {
            for (C0254a c0254a : list) {
                if (c0254a != null) {
                    c0254a.a();
