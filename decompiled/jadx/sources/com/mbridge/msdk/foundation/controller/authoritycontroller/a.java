...
public class a {
    ...
    public ArrayList<String> f3344a = new ArrayList<>();
    private int e = 3;
    ...
    private a() {
        try {
            ...
            this.f3344a.add(MBridgeConstans.AUTHORITY_GENERAL_DATA);
            this.f3344a.add(MBridgeConstans.AUTHORITY_DEVICE_ID);
            this.f3344a.add("authority_applist");
            this.f3344a.add("authority_app_download");
            this.f3344a.add(MBridgeConstans.AUTHORITY_SERIAL_ID);
            this.f3344a.add(com.mbridge.msdk.a.AUTHORITY_OA_ID);
            this.f3344a.add(MBridgeConstans.AUTHORITY_OTHER);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public final String d() {
        ...
        for (int i = 0; i < this.f3344a.size(); i++) {
            JSONObject jSONObject = new JSONObject();
            try {
                jSONObject.put("keyname", String.valueOf(this.f3344a.get(i)));
                jSONObject.put("client_status", c(this.f3344a.get(i)));
                jSONObject.put("server_status", d(this.f3344a.get(i)));
