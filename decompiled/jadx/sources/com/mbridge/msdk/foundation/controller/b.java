...
public class b {
    ...
    Handler i = new Handler(Looper.getMainLooper()) { // from class: com.mbridge.msdk.foundation.controller.b.4
        ...
        if (context != null) {
            ...
            if (map != null) {
                ...
                try {
                    if (d() && this.u == null) {
                        try {
                            this.u = new FastKV.Builder(e.b(c.MBRIDGE_700_CONFIG), t.b(com.tkay.expressad.foundation.h.v.f6960a)).build();
                    ...
                    if (this.u != null) {
                        ...
                        String string3 = this.u.getString(t.b(com.tkay.expressad.foundation.g.a.f6864cm), "");
                        ...
                        if (TextUtils.isEmpty(string2) && TextUtils.isEmpty(string3)) {
                            if (!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.t) || !TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.u)) {
                                ...
                                this.u.putString(t.b(com.tkay.expressad.foundation.g.a.f6864cm), com.mbridge.msdk.foundation.same.a.u);
                            }
                        } else {
                        ...
                        SharedPreferences sharedPreferences = applicationContext2.getSharedPreferences(t.b(com.tkay.expressad.foundation.h.v.f6960a), 0);
                        if (sharedPreferences != null) {
                            String string4 = sharedPreferences.getString(t.b(com.tkay.expressad.foundation.g.a.cj), "");
                            string = sharedPreferences.getString(t.b(com.tkay.expressad.foundation.g.a.f6864cm), "");
                            str = string4;
                        } else {
                            string = "";
                        }
                        ...
                        if (TextUtils.isEmpty(str) && TextUtils.isEmpty(string)) {
                            if ((!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.t) || !TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.u)) && sharedPreferences != null) {
                                ...
                                editorEdit.putString(t.b(com.tkay.expressad.foundation.g.a.f6864cm), com.mbridge.msdk.foundation.same.a.u);
                                editorEdit.apply();
                            }
                        } else {
            ...
            if (jA != 1300) {
                this.i.postDelayed(new Runnable() { // from class: com.mbridge.msdk.foundation.controller.b.1
                    @Override // java.lang.Runnable
                    public final void run() {
                        v.B(context);
                    }
