...
public final class v extends e {
    ...
    private static String f3547a = null;
    ...
    public static void B(final Context context) {
        ...
        try {
            if (Looper.myLooper() == Looper.getMainLooper()) {
                ...
                new Handler(context.getMainLooper()).post(new Runnable() { // from class: com.mbridge.msdk.foundation.tools.v.1
        ...
        try {
            if (Looper.myLooper() == Looper.getMainLooper()) {
                if (TextUtils.isEmpty(f)) {
                    ...
                    try {
                        new Thread(new Runnable() { // from class: com.mbridge.msdk.foundation.tools.v.2
                            @Override // java.lang.Runnable
                            public final void run() {
    ...
    public static int D(Context context) {
        try {
            ...
            try {
                Runnable runnable = new Runnable() { // from class: com.mbridge.msdk.foundation.tools.v.3
                    @Override // java.lang.Runnable
                    public final void run() {
                        try {
    ...
    public static String B() {
        try {
            ...
            if (TextUtils.isEmpty(l)) {
                new Thread(new Runnable() { // from class: com.mbridge.msdk.foundation.tools.v.4
                    @Override // java.lang.Runnable
                    public final void run() {
                        try {
    ...
    public static String E() {
        return !com.mbridge.msdk.foundation.controller.authoritycontroller.a.a().a(MBridgeConstans.AUTHORITY_DEVICE_ID) ? "" : !com.mbridge.msdk.foundation.controller.authoritycontroller.a.h() ? TextUtils.isEmpty(f3547a) ? "" : f3547a : TextUtils.isEmpty(f3547a) ? "" : f3547a;
    }
    ...
    public static int P() {
        try {
            if (!ab.a.f3513a.a("v_a_d_p", false)) {
                return 0;
            }
            if (ae.g()) {
                y = 1;
