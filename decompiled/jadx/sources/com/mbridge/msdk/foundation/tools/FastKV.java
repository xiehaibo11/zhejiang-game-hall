...
public class FastKV {
    ...
    private final b logger = k.f3533a;
    ...
    */
    ...
    private boolean isABFileEqual() {
        ...
        this.bBuffer.rewind();
        this.bBuffer.get(jVar.f3532a, 0, this.dataEnd);
        byte[] bArr = this.fastBuffer.f3532a;
        byte[] bArr2 = jVar.f3532a;
    ...
    private boolean loadWithBlockingIO(File file) throws IOException {
        ...
        if (length != 0 && length <= 536870912) {
            ...
            if (jVar2 != null && jVar2.f3532a.length == newCapacity) {
    ...
    private boolean writeToABFile(j jVar) {
        ...
        try {
            ...
            this.aBuffer.put(jVar.f3532a, 0, this.dataEnd);
            this.bBuffer.put(jVar.f3532a, 0, this.dataEnd);
            return true;
        } catch (Exception e) {
            error(e);
            return false;
    ...
    */
    ...
    public synchronized boolean getBoolean(String str, boolean z) {
        c.C0263c c0263c = (c.C0263c) this.data.get(str);
        if (c0263c != null) {
            z = c0263c.b;
        }
        return z;
    ...
    public synchronized void putBoolean(String str, boolean z) {
        ...
        if (c0263c == null) {
            ...
            updateChange();
            this.data.put(str, new c.C0263c(i, z));
            checkIfCommit();
        } else if (c0263c.b != z) {
            c0263c.b = z;
            updateBoolean((byte) (z ? 1 : 0), c0263c.f3522a);
            checkIfCommit();
        }
    }
    ...
    public synchronized void putFloat(String str, float f) {
        ...
        if (eVar == null) {
            ...
            eVar.b = f;
            updateInt32(iFloatToRawIntBits, jFloatToRawIntBits, eVar.f3522a);
            checkIfCommit();
        }
    }
    ...
    public synchronized void putDouble(String str, double d) {
        ...
        if (dVar == null) {
            ...
            dVar.b = d;
            updateInt64(jDoubleToRawLongBits, jDoubleToRawLongBits2, dVar.f3522a);
            checkIfCommit();
        }
    }
    ...
    public synchronized <T> void putObject(String str, T t, a<T> aVar) {
        ...
        jVar.a(strA);
        jVar.a(bArrA);
        addOrUpdate(str, t, jVar.f3532a, (c.h) this.data.get(str), (byte) 8);
    }
    ...
    public synchronized void remove(String str) {
        ...
        if (bVar != null) {
            ...
            String str2 = null;
            if (bA <= 5) {
                remove(bA, bVar.f3522a - (j.b(str) + 2), bVar.f3522a + TYPE_SIZE[bA]);
            } else {
                c.j jVar = (c.j) bVar;
                remove(bA, jVar.c, jVar.f3522a + jVar.d);
                if (jVar.e) {
                    str2 = (String) jVar.b;
                }
            }
    ...
    public synchronized Map<String, Object> getAll() {
        ...
        for (Map.Entry<String, c.b> entry : this.data.entrySet()) {
            ...
            switch (value.a()) {
                case 1:
                    objValueOf = Boolean.valueOf(((c.C0263c) value).b);
                    break;
                case 2:
    ...
    */
    public synchronized boolean writeToCFile() {
        /*
            ...
            byte[] r3 = r3.f3532a     // Catch: java.lang.Throwable -> L75 java.lang.Exception -> L77
    ...
    private void clearData() {
        ...
        if (jVar == null || jVar.f3532a.length != PAGE_SIZE) {
            this.fastBuffer = new j(PAGE_SIZE);
        } else {
    ...
    private void syncABBuffer(MappedByteBuffer mappedByteBuffer) {
        ...
        if (i != 0) {
            mappedByteBuffer.put(i, this.fastBuffer.f3532a[this.removeStart]);
        }
        if (this.updateSize != 0) {
            mappedByteBuffer.position(this.updateStart);
            mappedByteBuffer.put(this.fastBuffer.f3532a, this.updateStart, this.updateSize);
        }
    }
    ...
    private void ensureSize(int i) {
        int length = this.fastBuffer.f3532a.length;
        ...
        if (i2 >= length) {
            ...
            System.arraycopy(this.fastBuffer.f3532a, 0, bArr, 0, this.dataEnd);
            this.fastBuffer.f3532a = bArr;
            if (this.writingMode == 0) {
                try {
                    long j = newCapacity;
                    MappedByteBuffer map = this.aChannel.map(FileChannel.MapMode.READ_WRITE, 0L, j);
    ...
    private void putKey(String str, int i) {
        ...
        if (i == str.length()) {
            str.getBytes(0, i, this.fastBuffer.f3532a, this.fastBuffer.b);
            this.fastBuffer.b += i;
            return;
        }
    ...
    private void fastPutString(String str, String str2, c.i iVar) {
        ...
        if (iVar == null) {
            ...
            int i3 = iVar.f3522a - iVar.c;
            boolean z = true;
            if (iVar.d == iB) {
                this.checksum ^= this.fastBuffer.b(iVar.f3522a, iVar.d);
                if (iB == str2.length()) {
                    str2.getBytes(0, iB, this.fastBuffer.f3532a, iVar.f3522a);
                } else {
                    this.fastBuffer.b = iVar.f3522a;
                    this.fastBuffer.a(str2);
                }
                this.updateStart = iVar.f3522a;
                this.updateSize = iB;
                z = false;
            } else {
                ...
                this.fastBuffer.a((byte) 6);
                int i4 = i3 - 3;
                System.arraycopy(this.fastBuffer.f3532a, iVar.c + 1, this.fastBuffer.f3532a, this.fastBuffer.b, i4);
                this.fastBuffer.b += i4;
                putStringValue(str2, iB);
                remove((byte) 6, iVar.c, iVar.f3522a + iVar.d);
                str = iVar.e ? (String) iVar.b : null;
                iVar.e = false;
                iVar.c = this.updateStart;
                iVar.f3522a = this.updateStart + i3;
                iVar.d = iB;
            }
            iVar.b = str2;
            updateChange();
    ...
    private void updateObject(String str, Object obj, byte[] bArr, c.j jVar) {
        ...
        if (iSaveArray != 0) {
            ...
            remove(jVar.a(), jVar.c, jVar.f3522a + jVar.d);
            boolean z = this.tempExternalName != null;
            jVar.c = this.updateStart;
            jVar.f3522a = iSaveArray;
            jVar.e = z;
            if (z) {
    ...
    private void remove(byte b2, int i, int i2) {
        ...
        this.checksum ^= (((long) (this.fastBuffer.f3532a[i] ^ b3)) & 255) << ((i & 7) << 3);
        this.fastBuffer.f3532a[i] = b3;
        this.removeStart = i;
    }
    ...
    void gc(int i) {
        ...
        while (i12 < size) {
            ...
            int i13 = cVar2.f3509a - i11;
            int i14 = size;
            System.arraycopy(this.fastBuffer.f3532a, i11, this.fastBuffer.f3532a, i10, i13);
            int i15 = (i12 - 1) << 1;
            iArr[i15] = i11;
            iArr[i15 + 1] = i11 - i10;
            i10 += i13;
        ...
        if (i9 > 0) {
            System.arraycopy(this.fastBuffer.f3532a, i11, this.fastBuffer.f3532a, i10, i9);
            int i16 = i8 << 1;
            iArr[i16] = i11;
            iArr[i16 + 1] = i11 - i10;
        }
        ...
        if (this.writingMode == 0) {
            ...
            this.aBuffer.put(this.fastBuffer.f3532a, i2, i6);
            this.aBuffer.putInt(0, i5);
            this.bBuffer.putInt(0, i5);
            this.bBuffer.putLong(4, this.checksum);
            this.bBuffer.position(i2);
            this.bBuffer.put(this.fastBuffer.f3532a, i2, i6);
        } else {
        ...
        int i17 = i4 + i;
        if (this.fastBuffer.f3532a.length - i17 > TRUNCATE_THRESHOLD) {
            truncate(i17);
        }
        info(GC_FINISH);
    }
    ...
    private void truncate(int i) {
        ...
        if (newCapacity >= this.fastBuffer.f3532a.length) {
            return;
        }
        byte[] bArr = new byte[newCapacity];
        System.arraycopy(this.fastBuffer.f3532a, 0, bArr, 0, this.dataEnd);
    ...
    private static class c implements Comparable<c> {
        ...
        public final /* bridge */ /* synthetic */ int compareTo(c cVar) {
            return this.f3509a - cVar.f3509a;
        }
