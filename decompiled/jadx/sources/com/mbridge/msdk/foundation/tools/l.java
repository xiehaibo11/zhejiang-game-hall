...
/* JADX INFO: compiled from: InstallAppManager.java */
...
public class l {
    ...
    public final CopyOnWriteArraySet<com.mbridge.msdk.foundation.entity.i> a(String str) {
        ...
        if (this.d && this.e == null) {
            try {
                this.e = new FastKV.Builder(com.mbridge.msdk.foundation.same.b.e.b(com.mbridge.msdk.foundation.same.b.c.MBRIDGE_700_CONFIG), "installed").build();
    ...
    public final void a(Set<com.mbridge.msdk.foundation.entity.i> set) {
        ...
        try {
            ...
            if (this.f3534a != null) {
                SharedPreferences sharedPreferences = this.f3534a.getSharedPreferences("installed", 0);
                this.c = sharedPreferences;
