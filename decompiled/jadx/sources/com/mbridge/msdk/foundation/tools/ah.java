    ...
    public final /* synthetic */ byte[] a(Set<String> set) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            while ((i6 & com.alipay.sdk.m.n.a.g) != 0) {
                jVar.f3532a[i5] = (byte) ((i6 & 127) | 128);
                i6 >>>= 7;
                i5++;
            }
            jVar.f3532a[i5] = (byte) i6;
            jVar.b = i5 + 1;
            if (i4 >= 0) {
                jVar.a(strArr[i3]);
            }
    ...
    public final /* synthetic */ Set<String> a(byte[] bArr, int i, int i2) {
        ...
        if (i2 > 0) {
            ...
            while (jVar.b < i3) {
                ...
                int i5 = bArr2[i4];
                if ((i5 >> 7) != 0) {
                    byte[] bArr3 = jVar.f3532a;
                    int i6 = jVar.b;
                    jVar.b = i6 + 1;
                    i5 = (i5 & 127) | (bArr3[i6] << 7);
                    if ((i5 >> 14) != 0) {
                        byte[] bArr4 = jVar.f3532a;
                        int i7 = jVar.b;
                        jVar.b = i7 + 1;
                        i5 = (i5 & 16383) | (bArr4[i7] << 14);
                        if ((i5 >> 21) != 0) {
                            byte[] bArr5 = jVar.f3532a;
                            int i8 = jVar.b;
                            jVar.b = i8 + 1;
                            i5 = (i5 & 2097151) | (bArr5[i8] << 21);
                            if ((i5 >> 28) != 0) {
                                byte[] bArr6 = jVar.f3532a;
                                int i9 = jVar.b;
                                jVar.b = i9 + 1;
