...
public final class j {
    ...
    public final void a(byte[] bArr) {
        ...
        if (length > 0) {
            System.arraycopy(bArr, 0, this.f3532a, this.b, length);
            this.b += length;
        }
    }
    ...
    public final String b(int i) {
        ...
        if (i > 2048) {
            if (Build.VERSION.SDK_INT >= 19) {
                str = new String(this.f3532a, this.b, i, StandardCharsets.UTF_8);
            } else {
                str = new String(this.f3532a, this.b, i);
            }
        } else {
            char[] cArr = this.c;
            if (cArr == null) {
