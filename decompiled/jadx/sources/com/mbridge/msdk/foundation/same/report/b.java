...
/* JADX INFO: compiled from: MBBatchReportManager.java */
/* JADX INFO: loaded from: classes2.dex */
public final class b {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private static final String f3477a = b.class.getSimpleName();
    ...
    private String g = com.mbridge.msdk.foundation.same.net.f.d.a().f3453a;
    ...
    private b() {
        ...
        z.a(f3477a, "初始化批量上报： " + this.g + " " + this.e + " " + this.f + " " + this.d);
        if (this.d) {
    ...
    static /* synthetic */ void b(b bVar, final ArrayList arrayList, final long j) {
        if (arrayList != null && arrayList.size() > 0) {
            z.a(f3477a, "需要上报的数据条数： " + arrayList.size());
            ...
            try {
                ...
                z.a(f3477a, "需要批量上报的数据： " + strEncode);
                new com.mbridge.msdk.foundation.same.report.d.a(com.mbridge.msdk.foundation.controller.a.f().j()).post(0, bVar.g, dVarA, new com.mbridge.msdk.foundation.same.report.d.b() { // from class: com.mbridge.msdk.foundation.same.report.b.2
                    ...
                    public final void onFailed(String str2) {
                        ...
                        synchronized (b.this.j) {
                            ...
                            if (b.this.j.size() >= 5) {
                                z.a(b.f3477a, "批量上报失败，上报失败的数据超过阈值");
                                try {
                                    try {
                                        b.this.j.pop();
                ...
                z.d(f3477a, e.getMessage());
                return;
            }
        }
        z.a(f3477a, "需要上报的数据条数： 0");
    }
}
