...
public final class c {
    ...
    private static class b {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final c f3452a = new c();
    }

    private c() {
        this.f3450a = "IDErrorUtil";
    ...
    private synchronized a a(String str) {
        ...
        if (System.currentTimeMillis() > aVar.f3451a + ((long) this.b)) {
            this.d.remove(str);
            if (this.d.size() > 0) {
                for (Map.Entry<String, a> entry : this.d.entrySet()) {
                    z.d("IDErrorUtil", "getErrorInfo : delete timeout entry");
                    if (System.currentTimeMillis() - entry.getValue().f3451a > this.b) {
        ...
        if (aVarA != null && !TextUtils.isEmpty(aVarA.c)) {
            try {
                ...
                if (str4 != null && !TextUtils.isEmpty(str4) && (i = Integer.parseInt(str4)) != 287 && i != 94) {
                    if (System.currentTimeMillis() < ((long) (com.mbridge.msdk.c.b.a().d(str, str3).w() * 1000)) + aVarA.f3451a) {
                        return k.a(new JSONObject(aVarA.c), new com.mbridge.msdk.foundation.same.net.e.c(200, aVarA.c.getBytes(), null));
                    }
                    this.d.remove(str6);
                    return null;
