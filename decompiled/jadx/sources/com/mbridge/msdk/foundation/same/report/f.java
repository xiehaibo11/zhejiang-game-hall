...
/* JADX INFO: compiled from: RewardVideoReportManager.java */
...
public final class f {
    ...
    private f() {
        this.f3503a = Executors.newSingleThreadExecutor();
    }
    ...
    public final void a(String str, String str2, boolean z) {
        if (!b() || TextUtils.isEmpty(str) || this.f3503a == null) {
            return;
        }
        this.f3503a.execute(c(PointCategory.LOAD, "", str2, z, str));
    }
    ...
    public final void b(String str, String str2, boolean z) {
        ...
        this.f3503a.execute(c("campaign_success", "", str2, z, str));
    }
    ...
    public final void c(String str, String str2, boolean z) {
        ...
        this.f3503a.execute(c("load_success", "", str2, z, str));
    }
    ...
    public final void d(String str, String str2, boolean z) {
        ...
        this.f3503a.execute(c("is_ready_true", "", str2, z, str));
    }
    ...
    public final void e(String str, String str2, boolean z) {
        ...
        this.f3503a.execute(c("is_ready_false", "", str2, z, str));
    }
    ...
    public final void a(String str, String str2, String str3, boolean z) {
        ...
        this.f3503a.execute(c("load_failed", str2, str3, z, str));
    }
    ...
    public final void f(String str, String str2, boolean z) {
        ...
        this.f3503a.execute(c(PointCategory.SHOW, "", str2, z, str));
    }
    ...
    public final void g(String str, String str2, boolean z) {
        ...
        this.f3503a.execute(c("show_success", "", str2, z, str));
    }
    ...
    public final void b(String str, String str2, String str3, boolean z) {
        ...
        this.f3503a.execute(c("show_failed", str2, str3, z, str));
    }
    ...
    private static final class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final f f3505a = new f();
    }
}
