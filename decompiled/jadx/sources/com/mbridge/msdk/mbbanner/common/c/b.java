...
public class b {
    ...
    public final void a(String str, int i, String str2, boolean z) {
        if (!z) {
            if (i == -1) {
                z.d(f3620a, " unitId =" + str + " --> time out!");
            }
            this.i.cancel();
            z.b(f3620a, "在子线程处理业务逻辑 完成");
            z.b(f3620a, "downloadResource--> Fail");
            this.h = true;
            this.e.b(this.f, str);
            this.g.a(str);
            return;
        ...
        if (i == 1) {
            z.b(f3620a, "downloadResource--> Success Image");
            synchronized (this) {
                this.j.remove(str2);
                if (this.j.size() == 0) {
                    a(str);
        ...
        if (i == 2) {
            z.b(f3620a, "downloadResource--> Success banner_html");
            this.l = true;
            a(str);
        } else if (i == 3) {
            z.b(f3620a, "downloadResource--> Success banner_url");
            this.k = true;
            a(str);
        }
    }
    ...
    public final void a(String str, String str2, com.mbridge.msdk.mbbanner.common.a.b bVar, d dVar) throws Throwable {
        boolean z;
        try {
            z.b(f3620a, "requestCampaign--> started");
            this.g = dVar;
            com.mbridge.msdk.mbbanner.common.f.a aVar = new com.mbridge.msdk.mbbanner.common.f.a() { // from class: com.mbridge.msdk.mbbanner.common.c.b.2
                ...
                public final void a(CampaignUnit campaignUnit) throws Throwable {
                    try {
                        z.b(b.f3620a, "requestCampaign--> Succeed");
                        b.this.e.a(b.this.f, campaignUnit, this.unitId);
                        b.a(b.this, this.unitId, campaignUnit);
                    } catch (Exception e) {
                        z.b(b.f3620a, "requestCampaign--> Fail with exception = " + e.getMessage());
                ...
                public final void a(int i, String str3) {
                    z.b(b.f3620a, "requestCampaign--> Fail errorCode:" + i + " msg:" + str3);
        ...
        if (campaignUnit != null) {
            try {
                if (campaignUnit.getAds() != null && campaignUnit.getAds().size() > 0) {
                    ...
                    z.b(f3620a, "getNeedShowList 总共返回的campaign有：" + ads.size());
                    ...
                    z.b(f3620a, "getNeedShowList 返回有以下带有视频素材的campaign：" + arrayList.size());
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private static class a implements com.mbridge.msdk.foundation.same.c.c {
        ...
        public final void onSuccessLoad(Bitmap bitmap, String str) {
            if (MBridgeConstans.DEBUG) {
                z.b(b.f3620a, "DownloadImageListener campaign image success");
            }
            b bVar = this.f3624a;
            if (bVar != null) {
        ...
        public final void onFailedLoad(String str, String str2) {
            if (MBridgeConstans.DEBUG) {
                z.b(b.f3620a, "DownloadImageListener campaign image fail");
            }
            b bVar = this.f3624a;
            if (bVar != null) {
    ...
    private String a(String str, String str2) throws Throwable {
        ...
        if (!TextUtils.isEmpty(str2)) {
            ...
            try {
                try {
                    String strB = e.b(com.mbridge.msdk.foundation.same.b.c.MBRIDGE_700_HTML);
    ...
    static /* synthetic */ void a(b bVar, final String str, final CampaignUnit campaignUnit) throws Throwable {
        ...
        new Thread(new Runnable() { // from class: com.mbridge.msdk.mbbanner.common.c.b.3
            ...
            public final void run() {
                ...
                z.b(b.f3620a, "在单独子线程保存数据库 完成");
            }
        }).start();
        if (listA == null || listA.size() == 0) {
            z.b(f3620a, "tryDownloadOnLoadSuccess 返回的campaign 没有符合下载规则的");
            bVar.e.a(bVar.f, com.tkay.expressad.reward.a.d.f7047a, str);
            bVar.g.a(str);
            return;
        }
        z.b(f3620a, "在子线程处理业务逻辑 开始");
        ...
        if (size > bVar.d.c()) {
            z.b(f3620a, "saveNextOffset 重置offset为0");
            size = 0;
        }
        z.b(f3620a, "saveNextOffset 算出 下次的offset是:" + size);
        if (ai.b(str)) {
            bVar.d.a(size);
        }
