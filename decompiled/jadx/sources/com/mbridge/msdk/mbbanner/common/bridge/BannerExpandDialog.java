...
public class BannerExpandDialog extends Dialog {
    ...
    public BannerExpandDialog(Context context, Bundle bundle, com.mbridge.msdk.mbbanner.common.b.a aVar) {
        super(context);
        this.f3610a = "BannerExpandDialog";
        this.j = new b() { // from class: com.mbridge.msdk.mbbanner.common.bridge.BannerExpandDialog.4
            ...
            public final void open(String str) {
                try {
                    if (BannerExpandDialog.this.e == null || System.currentTimeMillis() - BannerExpandDialog.this.e.lastTouchTime <= com.mbridge.msdk.click.b.a.c || !com.mbridge.msdk.click.b.a.a((CampaignEx) BannerExpandDialog.this.h.get(0), BannerExpandDialog.this.e.getUrl(), com.mbridge.msdk.click.b.a.f3152a)) {
                        z.d("BannerExpandDialog", str);
                    ...
                    z.c("BannerExpandDialog", PushBuildConfig.sdk_conf_channelid, th);
                }
            }
            ...
            public final void useCustomClose(boolean z) {
                try {
                    ...
                    z.c("BannerExpandDialog", "useCustomClose", th);
                }
            }
        };
        if (bundle != null) {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.f.setOnClickListener(new View.OnClickListener() { // from class: com.mbridge.msdk.mbbanner.common.bridge.BannerExpandDialog.1
        ...
        this.e.setWebViewListener(new com.mbridge.msdk.mbjscommon.c.b() { // from class: com.mbridge.msdk.mbbanner.common.bridge.BannerExpandDialog.2
    ...
    static /* synthetic */ void a(BannerExpandDialog bannerExpandDialog) {
        try {
            ...
            com.mbridge.msdk.mbjscommon.mraid.a.a().a(bannerExpandDialog.e, r1[0], r1[1], bannerExpandDialog.e.getWidth(), bannerExpandDialog.e.getHeight());
            com.mbridge.msdk.mbjscommon.mraid.a.a().b(bannerExpandDialog.e, r1[0], r1[1], bannerExpandDialog.e.getWidth(), bannerExpandDialog.e.getHeight());
            com.mbridge.msdk.mbjscommon.mraid.a.a().b(bannerExpandDialog.e, fX, fY);
            com.mbridge.msdk.mbjscommon.mraid.a.a().c(bannerExpandDialog.e, iIntValue, iIntValue2);
            com.mbridge.msdk.mbjscommon.mraid.a.a().a(bannerExpandDialog.e, map);
            com.mbridge.msdk.mbjscommon.mraid.a.a().a(bannerExpandDialog.e);
        } catch (Throwable th) {
            z.c("BannerExpandDialog", "notifyMraid", th);
        }
    }
}
