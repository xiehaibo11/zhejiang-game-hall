    ...
    public static void a(String str, CampaignEx campaignEx, String str2) {
        try {
            ...
            if (b.a().c()) {
                ...
                aVar.post(0, com.mbridge.msdk.foundation.same.net.f.d.a().f3453a, e.a(sb.toString(), com.mbridge.msdk.foundation.controller.a.f().j(), str), new com.mbridge.msdk.foundation.same.report.d.b() { // from class: com.mbridge.msdk.mbbanner.common.d.a.1
