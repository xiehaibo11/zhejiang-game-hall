...
public class AppletsReport {
    ...
    private static void reportLoadData(Context context, String str) {
        ...
        try {
            new com.mbridge.msdk.foundation.same.report.d.a(context).post(0, d.a().f3453a, e.a(str, context), new com.mbridge.msdk.foundation.same.report.d.b() { // from class: com.mbridge.msdk.scheme.report.AppletsReport.1
