...
public class MBInterstitialActivity extends MBBaseActivity implements b {
    ...
    Runnable f3585a = new Runnable() { // from class: com.mbridge.msdk.interstitial.view.MBInterstitialActivity.11
    ...
    Runnable b = new Runnable() { // from class: com.mbridge.msdk.interstitial.view.MBInterstitialActivity.12
        @Override // java.lang.Runnable
        public final void run() {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (iA != -1) {
                ...
                initView();
                a();
                this.g.setOnClickListener(new View.OnClickListener() { // from class: com.mbridge.msdk.interstitial.view.MBInterstitialActivity.9
                ...
                try {
                    if (this.e != null && (!TextUtils.isEmpty(this.e.getHtmlUrl()) || this.e.isMraid())) {
                        ...
                        goneWebView();
                        this.f.setWebViewListener(new com.mbridge.msdk.mbjscommon.windvane.d() { // from class: com.mbridge.msdk.interstitial.view.MBInterstitialActivity.10
                            ...
                            public final void a(WebView webView, String str) {
                                try {
                                    ...
                                    if (MBInterstitialActivity.this.f3585a != null && MBInterstitialActivity.this.n != null) {
                                        MBInterstitialActivity.this.n.removeCallbacks(MBInterstitialActivity.this.f3585a);
                                    }
                                    if (MBInterstitialActivity.this.h != null) {
                        ...
                        this.n.postDelayed(this.f3585a, WEB_LOAD_TIME);
                    } else if (this.h != null) {
                ...
                com.mbridge.msdk.foundation.b.b.a().a(this.mUnitid, this, null, null, new com.mbridge.msdk.foundation.b.a() { // from class: com.mbridge.msdk.interstitial.view.MBInterstitialActivity.8
    ...
    private void a() {
        ...
        this.j = dVar;
        dVar.c();
        this.j.a(new d.b() { // from class: com.mbridge.msdk.interstitial.view.MBInterstitialActivity.13
    ...
    public void goneWebView() {
        try {
            runOnUiThread(new Runnable() { // from class: com.mbridge.msdk.interstitial.view.MBInterstitialActivity.15
                @Override // java.lang.Runnable
                public final void run() {
                    if (MBInterstitialActivity.this.f != null) {
                        MBInterstitialActivity.this.f.setVisibility(8);
    ...
    public void reportPlayableClosed() {
        if (this.e != null) {
            ...
            pVar.a(this.e.isMraid() ? p.f3396a : p.b);
    ...
    static /* synthetic */ void a(MBInterstitialActivity mBInterstitialActivity, int i, String str) {
        ...
        pVar.p(str);
        pVar.h("5");
        pVar.a(mBInterstitialActivity.e.isMraid() ? p.f3396a : p.b);
    ...
    static /* synthetic */ void h(MBInterstitialActivity mBInterstitialActivity) {
        ...
        try {
            ...
            Runnable runnable = new Runnable() { // from class: com.mbridge.msdk.interstitial.view.MBInterstitialActivity.7
                @Override // java.lang.Runnable
                public final void run() {
