...
public class interstitial extends AbsMbridgeDownload {
    ...
    private static final String f3582a = interstitial.class.getName();
    private Object b;

    public void getInfo(Object obj, String str) {
        MBInterstitialActivity mBInterstitialActivity;
        try {
            z.b(f3582a, "======前端调用 getInfo() 获取campaign数据 params:" + str);
            this.b = obj;
            if (this.mContext == null) {
                z.d(f3582a, "getInfo() context 为空 return");
                b();
                return;
            }
            ...
            if (TextUtils.isEmpty(strC)) {
                z.d(f3582a, "getInfo() unitid is null");
                b();
                return;
            }
            z.b(f3582a, "getInfo() mCurrentCallState:" + iA + " unitid:" + strC);
            if (iA == 1) {
                try {
                    z.b(f3582a, "instersGetInfo hideLoading");
                    try {
                    ...
                    if (this.mContext == null) {
                        z.b(f3582a, "instersGetInfo context 为空 通知前端没有数据");
                        b();
                        return;
                    }
                    if (a(this.mContext) != 1) {
                        z.d(f3582a, "instersGetInfo mCurrentCallState!=INTERSTITIAL_CALL");
                        b();
                        return;
                    }
                    if (this.mContext instanceof MBInterstitialActivity) {
                        ((MBInterstitialActivity) this.mContext).mIsMBPage = true;
                        z.b(f3582a, "set mIsMBPage true");
                    }
                    final String strC2 = c();
                    if (TextUtils.isEmpty(strC2)) {
                        z.d(f3582a, "instersGetInfo unitid is null");
                        b();
                        return;
                    }
                    final List<CampaignEx> listA = a(strC2);
                    z.b(f3582a, "instersGetInfo 开始从缓存里取数据");
                    if (listA != null) {
                        z.d(f3582a, "instersGetInfo 从缓存里取到的数据 不为空 size：" + listA.size());
                        String strA = a(listA);
                        if (TextUtils.isEmpty(strA)) {
                            z.d(f3582a, "instersGetInfo campListJson is null return");
                            b();
                            return;
                        }
                        h.a().a(obj, strA);
                        ...
                        try {
                            if (!TextUtils.isEmpty(strC2) && listA != null && listA.size() != 0) {
                                new Thread(new Runnable() { // from class: com.mbridge.msdk.interstitial.jscommon.interstitial.2
                                    ...
                                    public final void run() {
                                        for (int i = 0; i < listA.size(); i++) {
                                            ...
                                            if (campaignEx != null) {
                                                ...
                                                z.b(interstitial.f3582a, "======更新frequence：" + campaignEx.getId() + " sUnitId:" + strC2);
                                            }
                                        }
                                    }
                                }).start();
                        ...
                        try {
                            new Thread(new Runnable() { // from class: com.mbridge.msdk.interstitial.jscommon.interstitial.1
                                @Override // java.lang.Runnable
                                public final void run() {
                                    z.b(interstitial.f3582a, "清除本地的InterstitialCampaign集合");
                                    a aVarA = a.a();
                                    if (aVarA != null) {
                                        aVarA.a(listA, strC2);
                                    }
    ...
    public void install(Object obj, String str) {
        try {
            ...
            z.b(f3582a, "======前端调用 install()  params:" + strAddDownloaderListener);
            if (this.mContext == null) {
                z.d(f3582a, "install() context 为空 return");
                return;
            }
            z.b(f3582a, "install() 开始tracking跳转");
            if (this.mContext instanceof MBInterstitialActivity) {
    ...
    public void openURL(Object obj, String str) {
        ...
        try {
            ...
            z.d(f3582a, e.getMessage());
        } catch (Throwable th) {
            z.d(f3582a, th.getMessage());
        }
    }

    private void b() {
        try {
            z.b(f3582a, "通知h5 没有数据");
            h.a().a(this.b, "");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private String a(List<CampaignEx> list) {
        ...
        try {
            ...
            z.b(f3582a, "===========campListJson:" + string);
        ...
        try {
            if (!TextUtils.isEmpty(str) && list != null && list.size() != 0) {
                for (int i = 0; i < list.size(); i++) {
                    ...
                    if (campaignEx != null) {
                        z.b(f3582a, "======更新displayid：" + campaignEx.getId());
