...
public final class a {
    ...
    private static String f3052a = "NativeAdvancedLoadManager";
    private String b;
    private String c;
    private long d;
    ...
    public final void a(String str, int i) {
        ...
        z.a(f3052a, "开始从V3请求新的 offer，超时 ：" + this.d);
    ...
    private void a(Context context, final String str, final int i) throws Throwable {
        try {
            ...
            try {
                ...
                z.d(f3052a, th.getMessage());
            }
            z.b(f3052a, "load 开始准备请求参数");
            com.mbridge.msdk.foundation.same.net.g.d dVarA = a(i, this.u);
            if (dVarA == null) {
                z.b(f3052a, "load 请求参数为空 load失败");
            ...
            com.mbridge.msdk.advanced.e.c cVar = new com.mbridge.msdk.advanced.e.c(i) { // from class: com.mbridge.msdk.advanced.b.a.6
                ...
                public final void a(CampaignUnit campaignUnit, final int i2) throws Throwable {
                    try {
                        z.b(a.f3052a, "onLoadCompaginSuccess 数据刚请求回来");
                        a.a(a.this, campaignUnit, i2, a.this.b, str);
                        a.this.w = campaignUnit.getRequestId();
                    } catch (Exception e) {
                        e.printStackTrace();
                        z.b(a.f3052a, "onLoadCompaginSuccess 数据刚请求失败");
                        if (a.this.x != null) {
                ...
                public final void a(int i2, final String str2) {
                    z.d(a.f3052a, str2);
                    z.b(a.f3052a, "onLoadCompaginFailed load failed errorCode:" + i2 + " msg:" + str2);
                    if (a.this.x != null) {
    ...
    private com.mbridge.msdk.foundation.same.net.g.d a(int i, String str) throws Throwable {
        ...
        com.mbridge.msdk.foundation.same.net.f.b.a(dVar, com.mbridge.msdk.foundation.same.net.g.d.f3456a, str);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void a(String str, String str2, int i) throws Throwable {
        if (this.p) {
            this.p = false;
            a(str, i, str2);
        } else {
    ...
    private void c(CampaignEx campaignEx, int i) throws Throwable {
        ...
        if (!TextUtils.isEmpty(campaignEx.getAdZip())) {
            z.a(f3052a, "开始下载zip： " + campaignEx.getAdZip());
            h(campaignEx, i);
        }
        if (!TextUtils.isEmpty(campaignEx.getAdHtml())) {
            z.a(f3052a, "开始下载HTML： " + campaignEx.getAdHtml());
            g(campaignEx, i);
        }
        if (!TextUtils.isEmpty(campaignEx.getVideoUrlEncode())) {
            z.a(f3052a, "开始下载Video： " + campaignEx.getVideoUrlEncode());
            i(campaignEx, i);
        }
        if (!TextUtils.isEmpty(campaignEx.getImageUrl())) {
            z.a(f3052a, "开始下载image： " + campaignEx.getImageUrl());
            f(campaignEx, i);
        }
        if (!TextUtils.isEmpty(campaignEx.getendcard_url())) {
            z.a(f3052a, "开始下载EndCard： " + campaignEx.getendcard_url());
            e(campaignEx, i);
        }
        if (TextUtils.isEmpty(campaignEx.getGifUrl())) {
            return;
        }
        z.a(f3052a, "开始下载gitUrl： " + campaignEx.getGifUrl());
        d(campaignEx, i);
    }
    ...
    private void e(final CampaignEx campaignEx, final int i) {
        this.t = new H5DownLoadManager.ZipDownloadListener() { // from class: com.mbridge.msdk.advanced.b.a.9
            ...
            public final void onFailed(String str, String str2) {
                z.a(a.f3052a, "endcard 下载失败： " + str2);
                if (a.this.g != null) {
    ...
    */
    private void g(final com.mbridge.msdk.foundation.entity.CampaignEx r9, final int r10) throws java.lang.Throwable {
        /*
    ...
    private void h(final CampaignEx campaignEx, final int i) {
        this.s = new H5DownLoadManager.ZipDownloadListener() { // from class: com.mbridge.msdk.advanced.b.a.12
            ...
            @Override // com.mbridge.msdk.foundation.download.download.H5DownLoadManager.H5ResDownloadListerInter
            public final void onFailed(String str, String str2) {
                z.a(a.f3052a, "zip 下载失败： " + str2 + " " + str);
                Message messageObtain = Message.obtain();
                messageObtain.what = 2;
                messageObtain.obj = str;
                a.this.x.sendMessage(messageObtain);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void a(CampaignEx campaignEx, String str, int i) throws Throwable {
        a(str, this.n, i);
        b(campaignEx, str, 2);
    }
    ...
    public final String a(String str) {
        ...
        try {
            ...
            z.d(f3052a, "本地已下载完 拿本地播放地址：" + strD + " state：" + iF);
            return strD;
        } catch (Exception e) {
            e.printStackTrace();
            return str;
    ...
    static /* synthetic */ void a(a aVar, final String str, final CampaignEx campaignEx, final int i) throws Throwable {
    ...
    static /* synthetic */ void a(a aVar, CampaignUnit campaignUnit, int i, String str, String str2) throws Throwable {
        ArrayList arrayList;
        ...
        if (arrayList == null || arrayList.size() <= 0) {
            z.b(f3052a, "onload load失败 返回的compaign没有可以用的");
        ...
        try {
            ...
            if (aVar.h == null || i2 > aVar.h.v()) {
                z.b(f3052a, "onload 重置offset为0");
                aVar.v = 0;
            }
            z.b(f3052a, "onload 算出 下次的offset是:" + aVar.v);
        } catch (Exception e) {
            e.printStackTrace();
        }
        z.b(f3052a, "onload load成功 size:" + arrayList.size());
