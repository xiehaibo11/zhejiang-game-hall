...
public final class a {
    ...
    public static void a(String str, CampaignEx campaignEx, String str2) {
        try {
            ...
            if (b.a().c()) {
                ...
                aVar.post(0, com.mbridge.msdk.foundation.same.net.f.d.a().f3453a, e.a(sb.toString(), com.mbridge.msdk.foundation.controller.a.f().j(), str), new com.mbridge.msdk.foundation.same.report.d.b() { // from class: com.mbridge.msdk.advanced.d.a.1
    ...
    public static void a(com.mbridge.msdk.advanced.common.c cVar, String str) {
        if (cVar != null) {
            cVar.a(com.tkay.expressad.mbbanner.a.b.c.f6982a);
            if (b.a().c()) {
                b.a().a(cVar.b());
            } else {
