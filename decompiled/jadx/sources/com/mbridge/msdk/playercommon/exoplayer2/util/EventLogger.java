...
public class EventLogger implements AnalyticsListener {
    ...
    public void onLoadingChanged(AnalyticsListener.EventTime eventTime, boolean z) {
        logd(eventTime, CallMraidJS.e, Boolean.toString(z));
    }

    @Override // com.mbridge.msdk.playercommon.exoplayer2.analytics.AnalyticsListener
    public void onPlayerStateChanged(AnalyticsListener.EventTime eventTime, boolean z, int i) {
        logd(eventTime, CallMraidJS.b, z + ", " + getStateString(i));
    }
    ...
    public void onNetworkTypeChanged(AnalyticsListener.EventTime eventTime, NetworkInfo networkInfo) {
        logd(eventTime, "networkTypeChanged", networkInfo == null ? Device.NETWORN_NONE : networkInfo.toString());
    }
