...
public class MBMediaView extends LinearLayout implements VideoPlayerStatusListener, IRewardBridge {
    ...
    /* JADX INFO: renamed from: com.mbridge.msdk.nativex.view.MBMediaView$11, reason: invalid class name */
    static /* synthetic */ class AnonymousClass11 {
        ...
        static {
            ...
            try {
                f3803a[BaseView.a.FULL_TOP_VIEW.ordinal()] = 2;
    ...
    private static final class g extends WebViewClient {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        WeakReference<MBMediaView> f3828a;

        public g(MBMediaView mBMediaView) {
            this.f3828a = new WeakReference<>(mBMediaView);
        }
        ...
        public final void onPageFinished(WebView webView, String str) {
            ...
            try {
                MBMediaView mBMediaView = this.f3828a.get();
    ...
    private static final class f implements com.mbridge.msdk.videocommon.listener.a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        WeakReference<MBMediaView> f3827a;
        ...
        public f(MBMediaView mBMediaView) {
            this.f3827a = new WeakReference<>(mBMediaView);
        }

        @Override // com.mbridge.msdk.videocommon.listener.a
        public final void a(String str) {
            MBMediaView mBMediaView = this.f3827a.get();
            if (mBMediaView != null) {
    ...
    private static final class b implements Runnable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        WeakReference<MBMediaView> f3822a;

        public b(MBMediaView mBMediaView) {
            this.f3822a = new WeakReference<>(mBMediaView);
        }

        @Override // java.lang.Runnable
        public final void run() {
            MBMediaView mBMediaView = this.f3822a.get();
            if (mBMediaView != null) {
                try {
    ...
    private static final class c implements com.mbridge.msdk.nativex.listener.a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        WeakReference<MBMediaView> f3823a;

        public c(MBMediaView mBMediaView) {
            this.f3823a = new WeakReference<>(mBMediaView);
        }

        @Override // com.mbridge.msdk.nativex.listener.a
        public final void a() {
            MBMediaView mBMediaView = this.f3823a.get();
            if (mBMediaView != null) {
    ...
    public BaseView getFullScreenViewByStyle(Context context, BaseView.a aVar) {
        ...
        BaseView baseView;
        int i = AnonymousClass11.f3803a[aVar.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ void b(MBMediaView mBMediaView) {
        ...
        if (!mediaViewHolder.f3378a && mBMediaView.ab == a.VIDEO && ai.b(mBMediaView.N.getImpressionURL())) {
            mediaViewHolder.f3378a = true;
    ...
    static /* synthetic */ void h(MBMediaView mBMediaView) {
        try {
            if (mBMediaView.getRootView() != null && (mBMediaView.getRootView() instanceof ViewGroup)) {
                ...
                int i2 = -16777216;
                if (AnonymousClass11.f3803a[mBMediaView.F.style.ordinal()] == 2) {
                    i2 = -1;
                }
                if (mBMediaView.v != 0) {
