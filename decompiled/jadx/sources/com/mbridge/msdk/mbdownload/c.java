...
/* JADX INFO: compiled from: DownloadProvider.java */
/* JADX INFO: loaded from: classes2.dex */
public class c {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final String f3665a = c.class.getSimpleName();
    ...
    class b extends Handler {
        ...
        public final void handleMessage(Message message) {
            try {
                z.a(c.f3665a, "IncomingHandler(msg.what:" + message.what + " msg.arg1:" + message.arg1 + " msg.arg2:" + message.arg2 + " msg.replyTo:" + message.replyTo);
            } catch (Exception e) {
                e.printStackTrace();
                return;
            }
            if (message.what == 4) {
                ...
                z.a(c.f3665a, "IncomingHandler(msg.getData():" + data);
                ...
                aVar.f3663a = data.getString("mReqClz");
                ...
                z.b(c.f3665a, aVar.c + " is already in downloading list. ");
                int iA = c.this.h.a(aVar);
                if (iA == -1 || c.d.get(iA).f3674a != null) {
        ...
        public final void handleMessage(Message message) {
            ...
            try {
                try {
                    ...
                    z.a(c.f3665a, "Cancel old notification....");
                    ...
                    if (notificationA2 != null) {
                        ...
                        z.a(c.f3665a, "Show new  notification....");
                    }
                    boolean zA = c.this.h.a(c.this.l);
                    z.a(c.f3665a, String.format("isAppOnForeground = %1$B", Boolean.valueOf(zA)));
                    if (zA && !aVar2.r) {
                        c.this.g.cancel(i3 + 1);
                        com.mbridge.msdk.click.c.c(c.this.l, aVar2.g);
                    }
                    z.b(c.f3665a, String.format("%1$10s downloaded. Saved to: %2$s", aVar2.c, string2));
                } catch (Throwable unused2) {
                }
            } catch (Exception e4) {
                z.d(c.f3665a, "can not install. " + e4.getMessage());
                c.this.g.cancel(i3 + 1);
            }
        }
    }
    ...
    static /* synthetic */ void a(c cVar, b.a aVar) {
        z.a(f3665a, "startDownload([mComponentName:" + aVar.b + " mTitle:" + aVar.c + " mUrl:" + aVar.d + "])");
        e eVar = cVar.h;
        ...
        if (b) {
            int size = c.size();
            int size2 = d.size();
            z.b(f3665a, "Client size =" + size + "   cacheSize = " + size2);
            if (size != size2) {
        ...
        if (b) {
            for (int i = 0; i < d.size(); i++) {
                ...
                z.a(f3665a, "Running task " + bVarValueAt.e.c);
            }
        }
    }
}
