...
public class b {
    ...
    final Messenger f3661a = new Messenger(new HandlerC0267b());
    private ServiceConnection z = new ServiceConnection() { // from class: com.mbridge.msdk.mbdownload.b.1
        ...
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            try {
                ...
                bundle.putString("mReqClz", aVar.f3663a);
                ...
                messageObtain.replyTo = b.this.f3661a;
    ...
    /* JADX INFO: renamed from: com.mbridge.msdk.mbdownload.b$b, reason: collision with other inner class name */
    /* JADX INFO: compiled from: DownloadAgent.java */
    class HandlerC0267b extends Handler {
        HandlerC0267b() {
        }
