...
public class MBBannerView extends RelativeLayout {
    ...
    public void load() {
        ...
        if (aVar != null) {
            ...
            if (bannerAdListener != null) {
                bannerAdListener.onLoadFailed(this.mBridgeIds, com.tkay.expressad.mbbanner.a.a.f6972a);
            }
        }
    }
    ...
    public void loadFromBid(String str) {
        ...
        if (bannerAdListener2 != null) {
            bannerAdListener2.onLoadFailed(this.mBridgeIds, com.tkay.expressad.mbbanner.a.a.f6972a);
        }
    }
