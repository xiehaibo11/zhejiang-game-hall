...
public class MBGridView extends GridView implements InterBase {
    ...
    private Map<String, String> f3190a;
    ...
    public MBGridView(Context context, AttributeSet attributeSet) {
        ...
        this.c = "";
        try {
            this.f3190a = c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            c.a(this.f3190a, this);
        } catch (Exception e) {
            z.d("MBGridView", e.getMessage());
        }
    }
    ...
    public AbsListView.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                int i2 = AnonymousClass1.f3191a[cVar.ordinal()];
                if (i2 == 1) {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f3191a[com.mbridge.msdk.dycreator.a.c.layout_height.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3191a[com.mbridge.msdk.dycreator.a.c.fadingEdge.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3191a[com.mbridge.msdk.dycreator.a.c.visibility.ordinal()] = 4;
    ...
    public String getBindDataDes() {
        Map<String, String> map = this.f3190a;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f3190a.get("mbridgeData");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getActionDes() {
        Map<String, String> map = this.f3190a;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f3190a.get("mbridgeAction");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getStrategyDes() {
        Map<String, String> map = this.f3190a;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f3190a.get("mbridgeStrategy");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getEffectDes() {
        Map<String, String> map = this.f3190a;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f3190a.get("mbridgeEffect");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getReportDes() {
        Map<String, String> map = this.f3190a;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f3190a.get("mbridgeReport");
    }
