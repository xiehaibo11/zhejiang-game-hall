...
public class MBHorizontalScrollView extends HorizontalScrollView implements InterBase {
    ...
    private Map<String, String> f3192a;
    ...
    public MBHorizontalScrollView(Context context, AttributeSet attributeSet) {
        ...
        this.c = "";
        try {
            this.f3192a = c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            c.a(this.f3192a, this);
        } catch (Exception e) {
    ...
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                int i2 = AnonymousClass1.f3193a[cVar.ordinal()];
                if (i2 == 1) {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f3193a[com.mbridge.msdk.dycreator.a.c.layout_height.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3193a[com.mbridge.msdk.dycreator.a.c.layout_gravity.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3193a[com.mbridge.msdk.dycreator.a.c.layout_marginLeft.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f3193a[com.mbridge.msdk.dycreator.a.c.layout_margin.ordinal()] = 5;
    ...
    public String getBindDataDes() {
        Map<String, String> map = this.f3192a;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f3192a.get("mbridgeData");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getActionDes() {
        Map<String, String> map = this.f3192a;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f3192a.get("mbridgeAction");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getStrategyDes() {
        Map<String, String> map = this.f3192a;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f3192a.get("mbridgeStrategy");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getEffectDes() {
        Map<String, String> map = this.f3192a;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f3192a.get("mbridgeEffect");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getReportDes() {
        Map<String, String> map = this.f3192a;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f3192a.get("mbridgeReport");
    }
