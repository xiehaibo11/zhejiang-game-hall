...
public class MBExtAcquireRewardPopView extends MBAcquireRewardPopView implements InterBase {
    ...
    public MBExtAcquireRewardPopView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f3238a = c.a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            c.a(this.f3238a, this);
        } catch (Exception e) {
            z.d("MBExtAcquireRewardPopView", e.getMessage());
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                int i2 = AnonymousClass1.f3239a[cVar.ordinal()];
                if (i2 == 1) {
    ...
    public String getBindDataDes() {
        Map<String, String> map = this.f3238a;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f3238a.get("mbridgeData");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getActionDes() {
        Map<String, String> map = this.f3238a;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f3238a.get("mbridgeAction");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getStrategyDes() {
        Map<String, String> map = this.f3238a;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f3238a.get("mbridgeStrategy");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getEffectDes() {
        Map<String, String> map = this.f3238a;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f3238a.get("mbridgeEffect");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getReportDes() {
        Map<String, String> map = this.f3238a;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f3238a.get("mbridgeReport");
    }
}
