...
public class MBExtFeedBackView extends FeedBackButton implements InterBase {
    ...
    private Map<String, String> f3240a;
    ...
    public MBExtFeedBackView(Context context, AttributeSet attributeSet) {
        ...
        this.c = "";
        try {
            this.f3240a = c.a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            c.a(this.f3240a, this);
        } catch (Exception e) {
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                ...
                switch (AnonymousClass1.f3241a[cVar.ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.text.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.ellipsize.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.singleLine.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.lines.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.drawableLeft.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.drawablePadding.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.fadingEdge.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.scrollHorizontally.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.textColor.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.textSize.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.visibility.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.background.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.textStyle.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.style.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.contentDescription.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.tag.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.gravity.ordinal()] = 18;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.padding.ordinal()] = 19;
            } catch (NoSuchFieldError unused19) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.paddingTop.ordinal()] = 20;
            } catch (NoSuchFieldError unused20) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.paddingBottom.ordinal()] = 21;
            } catch (NoSuchFieldError unused21) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.paddingLeft.ordinal()] = 22;
            } catch (NoSuchFieldError unused22) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.paddingRight.ordinal()] = 23;
            } catch (NoSuchFieldError unused23) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.paddingStart.ordinal()] = 24;
            } catch (NoSuchFieldError unused24) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.paddingEnd.ordinal()] = 25;
            } catch (NoSuchFieldError unused25) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.layout_width.ordinal()] = 26;
            } catch (NoSuchFieldError unused26) {
            }
            try {
                f3241a[com.mbridge.msdk.dycreator.a.c.layout_height.ordinal()] = 27;
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                int i2 = AnonymousClass1.f3241a[cVar.ordinal()];
                if (i2 == 26) {
                    String attributeValue = attributeSet.getAttributeValue(i);
    ...
    public String getBindDataDes() {
        Map<String, String> map = this.f3240a;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f3240a.get("mbridgeData");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getActionDes() {
        Map<String, String> map = this.f3240a;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f3240a.get("mbridgeAction");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getStrategyDes() {
        Map<String, String> map = this.f3240a;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f3240a.get("mbridgeStrategy");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getEffectDes() {
        Map<String, String> map = this.f3240a;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f3240a.get("mbridgeEffect");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getReportDes() {
        Map<String, String> map = this.f3240a;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f3240a.get("mbridgeReport");
    }
