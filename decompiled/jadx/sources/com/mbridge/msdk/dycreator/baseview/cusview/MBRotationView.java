...
public class MBRotationView extends FrameLayout {
    ...
    public MBRotationView(Context context) {
        ...
        this.o = false;
        this.p = false;
        this.f3221a = new Runnable() { // from class: com.mbridge.msdk.dycreator.baseview.cusview.MBRotationView.1
    ...
    public void setAutoscroll(boolean z) {
        if (z) {
            postDelayed(this.f3221a, 1000 / this.g);
        }
        this.n = z;
    }
    ...
    static /* synthetic */ void a(MBRotationView mBRotationView) {
        ...
        if (mBRotationView.n) {
            mBRotationView.postDelayed(mBRotationView.f3221a, 1000 / mBRotationView.g);
        }
    }
}
