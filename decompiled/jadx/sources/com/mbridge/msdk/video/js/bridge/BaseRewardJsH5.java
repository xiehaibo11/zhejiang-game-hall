...
public class BaseRewardJsH5 implements IRewardBridge {
    ...
    protected IJSFactory f4203a;

    /* JADX WARN: Multi-variable type inference failed */
    public void initialize(Context context, WindVaneWebView windVaneWebView) {
        if (context instanceof IJSFactory) {
            this.f4203a = (IJSFactory) context;
        }
    }

    public void initialize(Object obj, WindVaneWebView windVaneWebView) {
        if (obj instanceof IJSFactory) {
            this.f4203a = (IJSFactory) obj;
        }
    }
    ...
    public void getEndScreenInfo(Object obj, String str) {
        ...
        try {
            if (this.f4203a != null) {
                String strA = this.f4203a.getIJSRewardVideoV1().a();
    ...
    public void install(Object obj, String str) {
        ...
        try {
            if (this.f4203a != null) {
                ...
                if (obj != null) {
                    a aVar = (a) obj;
                    if ((aVar.f3733a.getObject() instanceof j) && (jVar = (j) aVar.f3733a.getObject()) != null && (context = aVar.f3733a.getContext()) != null && context != context.getApplicationContext()) {
                        jVar.a(context);
                    }
                }
                if (this.f4203a.getJSContainerModule().endCardShowing()) {
                    this.f4203a.getJSCommon().click(3, str);
                } else {
                    this.f4203a.getJSCommon().click(1, str);
                }
            }
        } catch (Throwable th) {
    ...
    public void openURL(Object obj, String str) {
        ...
        if (contextJ == null) {
            try {
                if ((obj instanceof a) && (windVaneWebView = ((a) obj).f3733a) != null) {
    ...
    public void toggleCloseBtn(Object obj, String str) {
        try {
            ...
            this.f4203a.getIJSRewardVideoV1().toggleCloseBtn(iOptInt);
        } catch (Throwable th) {
    ...
    public void triggerCloseBtn(Object obj, String str) {
        try {
            ...
            h.a().a(obj, a(0));
            this.f4203a.getIJSRewardVideoV1().a(new JSONObject(str).optString(CallMraidJS.b));
    ...
    public void setOrientation(Object obj, String str) {
        try {
            ...
            this.f4203a.getIJSRewardVideoV1().b(strOptString);
        } catch (Throwable th) {
    ...
    public void handlerPlayableException(Object obj, String str) {
        try {
            ...
            this.f4203a.getIJSRewardVideoV1().c(strOptString);
        } catch (Throwable th) {
            z.c("JS-Reward-Brigde", "setOrientation", th);
        }
    }
