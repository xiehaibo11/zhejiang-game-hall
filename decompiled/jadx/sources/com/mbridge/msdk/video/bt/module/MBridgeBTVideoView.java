...
public class MBridgeBTVideoView extends BTBaseView {
    ...
    private static final class a extends DefaultVideoPlayerStatusListener {
        ...
        private MBridgeBTVideoView f4118a;
        private WebView b;
        ...
        public a(MBridgeBTVideoView mBridgeBTVideoView, WebView webView, MediaEvents mediaEvents) {
            this.f4118a = mBridgeBTVideoView;
            this.b = webView;
            this.c = mediaEvents;
        ...
        public final void a(int i, int i2) {
            ...
            this.l = i;
            this.m = i2;
            if (!ab.a().a("h_c_r_w_p_c", false) || (i3 = this.l) == 100 || this.m != 0 || this.n || i3 == 0 || (mBridgeBTVideoView = this.f4118a) == null || mBridgeBTVideoView.b == null) {
                return;
            }
            try {
                if (this.f4118a.b.getAdType() == 94 || this.f4118a.b.getAdType() == 287) {
                    str = this.f4118a.b.getRequestId() + this.f4118a.b.getId() + this.f4118a.b.getVideoUrlEncode();
                } else {
                    str = this.f4118a.b.getId() + this.f4118a.b.getVideoUrlEncode() + this.f4118a.b.getBidToken();
                }
        ...
        public final void onPlayCompleted() {
            ...
            if (this.f4118a.b == null || this.f4118a.b.getVideoCompleteTime() <= 0) {
                this.f4118a.r.setText("0");
            } else {
                this.f4118a.r.setText(s.a(com.mbridge.msdk.foundation.controller.a.f().j(), "mbridge_reward_video_view_reward_time_complete", i.g));
            }
            this.f4118a.p.setClickable(false);
            WebView webView = this.b;
            if (webView != null) {
        ...
        public final void onPlayProgress(int i, int i2) {
            ...
            if (this.f4118a.h) {
                ...
                if (this.f4118a.b != null) {
                    videoCompleteTime = this.f4118a.b.getVideoCompleteTime();
                    b.a().b(this.f4118a.b.getCampaignUnitId() + "_1", i);
                }
                ...
                if (i4 <= 0) {
                    string = videoCompleteTime <= 0 ? "0" : (String) this.f4118a.getContext().getResources().getText(s.a(com.mbridge.msdk.foundation.controller.a.f().j(), "mbridge_reward_video_view_reward_time_complete", i.g));
                } else {
                    if (videoCompleteTime <= 0) {
                        ...
                        sb = new StringBuilder();
                        sb.append(i4);
                        str2 = (String) this.f4118a.getContext().getResources().getText(s.a(com.mbridge.msdk.foundation.controller.a.f().j(), "mbridge_reward_video_view_reward_time_left", i.g));
                    }
                    sb.append(str2);
                    string = sb.toString();
                }
                this.f4118a.r.setText(string);
            }
            this.g = i2;
            this.f = i;
            this.f4118a.O.setMax(this.g);
            this.f4118a.O.setProgress(this.f);
            if (this.b != null) {
                try {
                    JSONObject jSONObject = new JSONObject();
                    jSONObject.put("code", BTBaseView.n);
