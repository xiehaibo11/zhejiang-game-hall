...
public class j extends e {
    ...
    public final void b() {
        Runnable runnable = new Runnable() { // from class: com.mbridge.msdk.video.module.a.a.j.1
            ...
            public final void run() {
                try {
                    if (!j.this.f4371a || j.this.b == null || !ai.b(j.this.g) || com.mbridge.msdk.foundation.controller.a.f().j() == null) {
                        return;
                    }
    ...
    public final void c() {
        try {
            Runnable runnable = new Runnable() { // from class: com.mbridge.msdk.video.module.a.a.j.2
                ...
                public final void run() {
                    try {
                        if (j.this.f4371a && j.this.b != null && ai.b(j.this.g)) {
    ...
    protected final void e() {
        ...
        try {
            ...
            if (!this.f4371a || TextUtils.isEmpty(this.b.getOnlyImpressionURL()) || com.mbridge.msdk.foundation.same.a.d.f3400a == null || com.mbridge.msdk.foundation.same.a.d.f3400a.containsKey(this.b.getOnlyImpressionURL()) || this.l) {
                return;
            }
            com.mbridge.msdk.foundation.same.a.d.f3400a.put(this.b.getOnlyImpressionURL(), Long.valueOf(System.currentTimeMillis()));
    ...
    protected final void f() {
        try {
            if (!this.f4371a || this.k || TextUtils.isEmpty(this.b.getImpressionURL())) {
                return;
            }
            this.k = true;
            ...
            if (!this.f4371a || com.mbridge.msdk.foundation.same.a.d.d == null || TextUtils.isEmpty(this.b.getId())) {
                return;
            }
    ...
    protected final void g() {
        List<String> pv_urls;
        try {
            if (!this.f4371a || this.m || this.b == null) {
                return;
            }
            this.m = true;
