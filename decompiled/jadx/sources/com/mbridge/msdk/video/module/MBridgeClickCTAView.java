...
public class MBridgeClickCTAView extends MBridgeBaseView {
    ...
    protected final void c() {
        ...
        if (this.f) {
            ...
            this.r.setOnClickListener(new a() { // from class: com.mbridge.msdk.video.module.MBridgeClickCTAView.3
                @Override // com.mbridge.msdk.widget.a
                protected final void a(View view) {
                    MBridgeClickCTAView.b(MBridgeClickCTAView.this);
                }
        ...
        if (this.b != null) {
            ...
            if (this.f) {
                ...
                if (!TextUtils.isEmpty(this.b.getIconUrl())) {
                    com.mbridge.msdk.foundation.same.c.b.a(this.f4304a.getApplicationContext()).a(this.b.getIconUrl(), new d(this.o, this.b, this.s) { // from class: com.mbridge.msdk.video.module.MBridgeClickCTAView.5
    ...
    static /* synthetic */ void b(MBridgeClickCTAView mBridgeClickCTAView) {
        ...
        if (mBridgeClickCTAView.b != null && mBridgeClickCTAView.b.isDynamicView()) {
            try {
                ...
                e.a(mBridgeClickCTAView.f4304a, "cta_click", mBridgeClickCTAView.b.getCampaignUnitId(), mBridgeClickCTAView.b.isBidCampaign(), mBridgeClickCTAView.b.getRequestId(), mBridgeClickCTAView.b.getRequestIdNotice(), mBridgeClickCTAView.b.getId(), str);
            } catch (Exception e2) {
                e2.printStackTrace();
            }
        }
