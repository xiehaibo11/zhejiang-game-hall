...
public final class a {
    ...
    /* JADX INFO: renamed from: com.mbridge.msdk.splash.c.a$a, reason: collision with other inner class name */
    /* JADX INFO: compiled from: NativeViewRenderManager.java */
    static class C0297a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final a f3979a = new a();
    }
        ...
        if (!TextUtils.isEmpty(strA)) {
            ...
            if (!TextUtils.isEmpty(cVar.c().getAdZip())) {
                try {
                    ...
                    DynamicViewCreator.getInstance().createDynamicView(dyOptionBuild, new DynamicViewBackListener() { // from class: com.mbridge.msdk.splash.c.a.2
                        ...
                        public final void viewClicked(BaseRespData baseRespData) {
                            ...
                            if (eAction != null) {
                                switch (AnonymousClass5.f3978a[eAction.ordinal()]) {
                                    case 1:
    ...
    /* JADX INFO: renamed from: com.mbridge.msdk.splash.c.a$5, reason: invalid class name */
    /* JADX INFO: compiled from: NativeViewRenderManager.java */
    static /* synthetic */ class AnonymousClass5 {
        ...
        static {
            ...
            try {
                f3978a[EAction.CLOSE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3978a[EAction.NOTICE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3978a[EAction.FEEDBACK.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f3978a[EAction.PRIVATE_ADDRESS.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f3978a[EAction.PERMISSION_INFO.ordinal()] = 6;
