...
public final class c {
    ...
    private static String f3983a = "SplashLoadManager";
    private String b;
    private String c;
    private long d;
    private long e;
        ...
        try {
            ...
            com.mbridge.msdk.splash.f.a aVar = new com.mbridge.msdk.splash.f.a(i) { // from class: com.mbridge.msdk.splash.c.c.3
                ...
                public final void a(CampaignUnit campaignUnit, int i2) throws Throwable {
                    try {
                        z.b(c.f3983a, "onLoadCompaginSuccess 数据刚请求回来");
                        c.a(c.this, campaignUnit, i2, c.this.b, str);
                        c.this.v = campaignUnit.getRequestId();
                    } catch (Exception e) {
                        e.printStackTrace();
                        z.b(c.f3983a, "onLoadCompaginSuccess 数据刚请求失败： " + e.getMessage());
                ...
                public final void a(int i2, String str2) throws Throwable {
                    z.d(c.f3983a, str2);
                    z.b(c.f3983a, "onLoadCompaginFailed load failed errorCode:" + i2 + " msg:" + str2);
                    c.this.a(str2, str, i);
                    c.this.u = 0;
                }
            };
    ...
    private void d(final CampaignEx campaignEx, final int i) {
        b.a(this.h, campaignEx, new com.mbridge.msdk.splash.view.nativeview.a() { // from class: com.mbridge.msdk.splash.c.c.5
    ...
    */
    private void e(com.mbridge.msdk.foundation.entity.CampaignEx r9, int r10) throws java.lang.Throwable {
        /*
    ...
    private void f(final CampaignEx campaignEx, final int i) {
        if (campaignEx.isDynamicView()) {
            ...
            this.s = new H5DownLoadManager.ZipDownloadListener() { // from class: com.mbridge.msdk.splash.c.c.6
    ...
    public void a(String str, final CampaignEx campaignEx, final int i) {
        ...
        cVar.a(this.j);
        cVar.a(this.k);
        e.a.f4004a.a(this.h, cVar, new e.b() { // from class: com.mbridge.msdk.splash.c.c.8
    ...
    private void g(final CampaignEx campaignEx, int i) {
        this.r = new com.mbridge.msdk.videocommon.listener.a() { // from class: com.mbridge.msdk.splash.c.c.9
            @Override // com.mbridge.msdk.videocommon.listener.a
            public final void a(String str) {
                c.this.h.setVideoReady(true);
                z.a(c.f3983a, "========VIDEO SUC");
                Message messageObtain = Message.obtain();
                messageObtain.obj = campaignEx;
    ...
    static /* synthetic */ void a(c cVar, CampaignUnit campaignUnit, int i, String str, String str2) throws Throwable {
        ArrayList arrayList;
        ...
        if (arrayList == null || arrayList.size() <= 0) {
            z.b(f3983a, "onload load失败 返回的compaign没有可以用的");
        ...
        try {
            ...
            if (cVar.i == null || i2 > cVar.i.v()) {
                z.b(f3983a, "onload 重置offset为0");
                cVar.u = 0;
            }
            z.b(f3983a, "onload 算出 下次的offset是:" + cVar.u);
        } catch (Exception e) {
            e.printStackTrace();
        }
        z.b(f3983a, "onload load成功 size:" + arrayList.size());
    ...
    static /* synthetic */ void b(c cVar, final CampaignEx campaignEx, final int i) {
        if (campaignEx.isDynamicView()) {
            ...
            try {
                ...
                z.d(f3983a, th.getMessage());
            }
            a.C0297a.f3979a.a(cVar.h, new com.mbridge.msdk.splash.a.c(aVar), new com.mbridge.msdk.splash.b.a() { // from class: com.mbridge.msdk.splash.c.c.7
    ...
    static /* synthetic */ void a(c cVar, String str, int i) throws Throwable {
        cVar.a(str, cVar.n, i);
    }
}
