...
public class a {
    ...
    private static final String f3970a = a.class.getSimpleName();
    ...
    public static String a(int i, float f, float f2) {
        ...
        try {
            ...
            if (i == 4) {
                jSONObject2.put(com.mbridge.msdk.foundation.same.a.n, com.tkay.expressad.video.bt.a.c.f7167a);
                jSONObject2.put(com.mbridge.msdk.foundation.same.a.o, com.tkay.expressad.video.bt.a.c.f7167a);
            } else {
