...
public abstract class c extends f<JSONObject> {
    ...
    private static final String f4013a = c.class.getSimpleName();
    private int b;
    private String c;
            ...
            if (1 == iOptInt) {
                ...
                com.mbridge.msdk.foundation.same.f.b.a().execute(new Runnable() { // from class: com.mbridge.msdk.splash.f.c.1
                    ...
                    public final void run() {
                        ...
                        com.mbridge.msdk.foundation.same.f.b.g().post(new Runnable() { // from class: com.mbridge.msdk.splash.f.c.1.1
                            @Override // java.lang.Runnable
                            public final void run() {
    ...
    public void onError(com.mbridge.msdk.foundation.same.net.a.a aVar) {
        z.d(f4013a, "errorCode = " + aVar.f3429a);
