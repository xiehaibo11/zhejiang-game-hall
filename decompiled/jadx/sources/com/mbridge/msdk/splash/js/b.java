...
/* JADX INFO: compiled from: SplashJSBridgeImpl.java */
...
public final class b implements a {
    ...
    private String f4023a = "SplashJSBridgeImpl";
    private int h = 5;
    ...
    public final void a(Object obj, String str) {
        try {
            ...
            jSONObject.put(TYAdConst.NETWORK_REQUEST_PARAMS_KEY.SDK_INFO, com.mbridge.msdk.mbjscommon.base.d.f3697a);
            z.d(this.f4023a, PointCategory.INIT + jSONObject.toString());
            h.a().a(obj, Base64.encodeToString(jSONObject.toString().getBytes(), 2));
        } catch (Throwable th) {
            z.c(this.f4023a, PointCategory.INIT, th);
        }
    }
    ...
    public final void b(Object obj, String str) {
        try {
            ...
            z.c(this.f4023a, "toggleCloseBtn", th);
        }
    }
    ...
    public final void d(Object obj, String str) {
        ...
        try {
            ...
            z.c(this.f4023a, "click", th);
        }
    }

    public final void e(Object obj, String str) {
        WindVaneWebView windVaneWebView;
        z.d(this.f4023a, "openURL:" + str);
        if (TextUtils.isEmpty(str)) {
        ...
        try {
            ...
            z.d(this.f4023a, e2.getMessage());
        } catch (Throwable th) {
            z.d(this.f4023a, th.getMessage());
        }
    }

    public final void f(Object obj, String str) {
        z.a(this.f4023a, "cai:" + str);
        if (TextUtils.isEmpty(str)) {
            com.mbridge.msdk.mbjscommon.bridge.b.a(obj, "params is null");
            return;
        }
    ...
    public final void close() {
        z.d(this.f4023a, "close");
        try {
            if (this.j != null) {
                this.j.a();
            }
        } catch (Throwable th) {
            z.c(this.f4023a, "close", th);
        }
    }
    ...
    public final void useCustomClose(boolean z) {
        ...
        try {
            ...
            z.c(this.f4023a, "useCustomClose", th);
        }
    }
    ...
    public final void expand(String str, boolean z) {
        try {
            ...
            z.c(this.f4023a, "expand", th);
        }
    }

    public final void i(Object obj, String str) {
        z.a(this.f4023a, "sendImpressions:" + str);
        try {
            if (TextUtils.isEmpty(str)) {
                return;
            }
            ...
            new Thread(new Runnable() { // from class: com.mbridge.msdk.splash.js.b.1
                ...
                public final void run() {
                    try {
                        ...
                        z.d(b.this.f4023a, "campain can't insert db");
                    }
                }
            }).start();
        } catch (Throwable th) {
            z.c(this.f4023a, "sendImpressions", th);
        }
    }

    public final void j(Object obj, String str) {
        z.a(this.f4023a, "reportUrls:" + str);
        if (TextUtils.isEmpty(str)) {
            com.mbridge.msdk.mbjscommon.bridge.b.a(obj, "params is null");
            return;
        }
    ...
    public final void k(Object obj, String str) {
        try {
            ...
            z.c(this.f4023a, "onJSBridgeConnect", th);
        }
    }
