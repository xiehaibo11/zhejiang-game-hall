...
/* JADX INFO: compiled from: SplashJsUtils.java */
/* JADX INFO: loaded from: classes2.dex */
public final class c {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private static String f4025a = "SplashJsUtils";
                        ...
                        if (i4 == i2 && !TextUtils.isEmpty(strOptString)) {
                            ...
                            if (i4 == 2 && !TextUtils.isEmpty(strOptString)) {
                                ...
                                if (file.exists() && file.isFile() && file.canRead()) {
                                    z.a(f4025a, "getFileInfo Mraid file " + strOptString);
    ...
    public static String a(int i) {
        try {
            ...
            z.d(f4025a, "code to string is error");
            return "";
        }
    }
    ...
    public static void a(WebView webView) {
        z.d(f4025a, "fireOnJSBridgeConnected");
        h.a().a(webView);
    }
