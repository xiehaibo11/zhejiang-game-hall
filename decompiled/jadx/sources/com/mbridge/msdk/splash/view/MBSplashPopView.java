...
public class MBSplashPopView extends RelativeLayout {
    ...
    public MBSplashPopView(Context context, a aVar, d dVar) {
        ...
        this.q = new Handler();
        this.r = false;
        this.t = new h() { // from class: com.mbridge.msdk.splash.view.MBSplashPopView.1
        ...
        this.u = new Runnable() { // from class: com.mbridge.msdk.splash.view.MBSplashPopView.6
        ...
        this.v = new Runnable() { // from class: com.mbridge.msdk.splash.view.MBSplashPopView.7
            @Override // java.lang.Runnable
            public final void run() {
                if (MBSplashPopView.this.h != null) {
        ...
        this.f4040a = new View.OnClickListener() { // from class: com.mbridge.msdk.splash.view.MBSplashPopView.8
        ...
        this.b = new View.OnClickListener() { // from class: com.mbridge.msdk.splash.view.MBSplashPopView.9
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private void b() {
        ...
        setOnClickListener(this.f4040a);
    ...
    private void a(String str) {
        com.mbridge.msdk.foundation.same.c.b.a(com.mbridge.msdk.foundation.controller.a.f().j()).a(str, new c() { // from class: com.mbridge.msdk.splash.view.MBSplashPopView.4
            @Override // com.mbridge.msdk.foundation.same.c.c
            public final void onSuccessLoad(Bitmap bitmap, String str2) {
                try {
                    if (bitmap.isRecycled()) {
    ...
    private void b(String str) {
        com.mbridge.msdk.foundation.same.c.b.a(com.mbridge.msdk.foundation.controller.a.f().j()).a(str, new c() { // from class: com.mbridge.msdk.splash.view.MBSplashPopView.5
            @Override // com.mbridge.msdk.foundation.same.c.c
            public final void onSuccessLoad(Bitmap bitmap, String str2) {
                try {
                    if (bitmap.isRecycled()) {
