    ...
    public final class Editor {
        ...
        public Sink newSink(int i) {
            synchronized (DiskLruCache.this) {
                ...
                try {
                    return new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[i])) { // from class: com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.Editor.1
                        @Override // com.mbridge.msdk.thrid.okhttp.internal.cache.FaultHidingSink
                        protected void onException(IOException iOException) {
                            synchronized (DiskLruCache.this) {
                                Editor.this.detach();
