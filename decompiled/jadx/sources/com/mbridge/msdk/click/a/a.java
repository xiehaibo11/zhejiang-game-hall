...
public final class a {
    ...
    public static String f3136a = "mtg_retry_report=1";
    ...
    /* JADX INFO: renamed from: com.mbridge.msdk.click.a.a$a, reason: collision with other inner class name */
    /* JADX INFO: compiled from: RetryReportControl.java */
    private static class C0245a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static a f3139a = new a();
    }

    public static a a() {
        return C0245a.f3139a;
    }
        ...
        public final void handleMessage(Message message) {
            ...
            if (i != 1) {
                ...
                if (obj instanceof String) {
                    a.a().a((String) obj, com.mbridge.msdk.click.a.b.f3140a);
                }
            }
        }
    }
    ...
    private static void a(final Context context, final String str) {
        ...
        try {
            new com.mbridge.msdk.foundation.same.report.d.a(context).post(0, d.a().f3453a, e.a(str, context), new com.mbridge.msdk.foundation.same.report.d.b() { // from class: com.mbridge.msdk.click.a.a.1
    ...
    public final void a(String str, String str2, CampaignEx campaignEx, String str3, boolean z, boolean z2, int i2) {
        ...
        String strReplace = str.replace("?" + f3136a, "").replace("&" + f3136a, "");
        if (this.m == null) {
            this.m = new ConcurrentHashMap<>();
        }
        ...
        if (System.currentTimeMillis() >= bVarRemove.j() + ((long) e)) {
            if (bVarRemove.c() == com.mbridge.msdk.click.a.b.f3140a) {
                a(bVarRemove);
                return;
            }
            return;
