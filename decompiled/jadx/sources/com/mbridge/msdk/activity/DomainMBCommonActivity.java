...
public class DomainMBCommonActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) throws Throwable {
        ...
        this.f3047a = stringExtra3;
        if (!TextUtils.isEmpty(stringExtra3)) {
            this.b = (CampaignEx) getIntent().getSerializableExtra("mvcommon");
            if (com.mbridge.msdk.foundation.webview.b.f3568a.containsKey(this.f3047a)) {
                BrowserView browserView = com.mbridge.msdk.foundation.webview.b.f3568a.get(this.f3047a);
                ...
                this.browserView.loadUrl(this.f3047a);
            }
