...
public final class a {
    public static void a(final Context context, List<Campaign> list, String str) {
        ...
        try {
            ...
            try {
                new com.mbridge.msdk.foundation.same.report.d.a(context).post(0, d.a().f3453a, e.a(string, context, str), new com.mbridge.msdk.foundation.same.report.d.b() { // from class: com.mbridge.msdk.mbnative.d.a.1
    ...
    public static void a(final Context context, String str, String str2, boolean z) {
        if (context != null) {
            try {
                ...
                try {
                    new com.mbridge.msdk.foundation.same.report.d.a(context).post(0, d.a().f3453a, e.a(string, context), new com.mbridge.msdk.foundation.same.report.d.b() { // from class: com.mbridge.msdk.mbnative.d.a.2
                        @Override // com.mbridge.msdk.foundation.same.report.d.b
