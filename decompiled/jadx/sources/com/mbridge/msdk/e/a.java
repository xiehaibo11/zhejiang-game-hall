...
public final class a {
    ...
    /* JADX INFO: renamed from: com.mbridge.msdk.e.a$a, reason: collision with other inner class name */
    /* JADX INFO: compiled from: LoopTimer.java */
    static class C0251a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static a f3319a = new a();
    }
    ...
    private a() {
        ...
        this.e = 0;
        this.f = 0;
        this.k = new Handler() { // from class: com.mbridge.msdk.e.a.1
            ...
            public final void handleMessage(Message message) {
                synchronized (a.this) {
                    ...
                    if (i != 1) {
                        ...
                        a.a(a.this, a.this.f3316a);
                        sendMessageDelayed(obtainMessage(1), a.this.f3316a);
                    }
                }
            }
        };
    ...
    public final void a(long j) {
        ...
        handler.sendMessageDelayed(handler.obtainMessage(1), this.f3316a);
    }
