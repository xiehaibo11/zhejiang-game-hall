...
public class c {
    ...
    public final void a(final Context context, final String str, final String str2) {
        ...
        com.mbridge.msdk.foundation.same.net.g.c cVar = new com.mbridge.msdk.foundation.same.net.g.c() { // from class: com.mbridge.msdk.c.c.1
                ...
                try {
                    ...
                    if (ae.a(jSONObject)) {
                        ...
                        try {
                            ...
                            z.d(b.f3115a, th2.getMessage());
                        }
                    }
                    c.a(c.this, 1, i, "", strB);
                    c.b(c.this);
                } catch (Exception e3) {
                    z.d(c.f3126a, e3.getMessage());
                }
            }
            ...
            public final void a(String str3) {
                ...
                c.b(c.this);
                z.d(c.f3126a, "get app setting error" + str3);
            }
        };
    ...
    public void b(final Context context, final String str, final String str2) {
        ...
        try {
            ...
            new com.mbridge.msdk.foundation.same.net.g.b(context.getApplicationContext()).get(0, com.mbridge.msdk.foundation.same.net.f.d.a().C, new com.mbridge.msdk.foundation.same.net.g.d(), new com.mbridge.msdk.foundation.same.net.b.a() { // from class: com.mbridge.msdk.c.c.2
                @Override // com.mbridge.msdk.foundation.same.net.b.a
                public final void a(String str4) {
                    z.a(c.f3126a, "fetch CNDSettingHost success, content = " + str4);
                ...
                public final void b(String str4) {
                    ...
                    z.a(c.f3126a, "fetch CNDSettingHost failed, errorCode = " + str4);
                }
            });
        } catch (Throwable th) {
            com.mbridge.msdk.foundation.same.net.f.d.a().F = false;
    ...
    public final void a(Context context, final String str, String str2, final String str3) {
        ...
        if (b.a().a(str3, str) && b.a().a(str, 2, str3)) {
            ...
            new com.mbridge.msdk.c.a.c(context).get(1, com.mbridge.msdk.foundation.same.net.f.d.a().q, dVar, new com.mbridge.msdk.foundation.same.net.g.c() { // from class: com.mbridge.msdk.c.c.3
                @Override // com.mbridge.msdk.foundation.same.net.g.c
                public final void a(JSONObject jSONObject) {
                    try {
                        if (ae.a(jSONObject)) {
    ...
    static /* synthetic */ void a(c cVar, int i, int i2, String str, String str2) {
        try {
