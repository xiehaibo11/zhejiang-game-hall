...
public class a {
    ...
    public static final String f7870a = a.class.getSimpleName();
    private String b;
    private long c;
    private List d;
    ...
    /* JADX INFO: renamed from: com.tramini.plugin.b.a$a, reason: collision with other inner class name */
    static class C0517a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static String f7871a = "si";
    ...
    public static a a(String str) {
        ...
        try {
            ...
            if (jSONObject.isNull(C0517a.f7871a)) {
                aVar.b = "";
            } else {
                aVar.b = jSONObject.optString(C0517a.f7871a);
            }
            if (jSONObject.isNull(C0517a.b)) {
                aVar.c = 3600000L;
            } else {
                aVar.c = jSONObject.optInt(C0517a.b);
            }
            if (jSONObject.isNull(C0517a.f)) {
                aVar.o = 0;
            } else {
                aVar.o = jSONObject.optInt(C0517a.f);
            }
            if (!jSONObject.isNull(C0517a.g)) {
                aVar.p = jSONObject.optString(C0517a.g);
            }
            if (!jSONObject.isNull(C0517a.h)) {
                aVar.q = jSONObject.optString(C0517a.h);
            }
            if (!jSONObject.isNull(C0517a.i)) {
                aVar.r = jSONObject.optString(C0517a.i);
            }
            if (!jSONObject.isNull(C0517a.j)) {
                aVar.s = jSONObject.optString(C0517a.j);
            }
            if (!jSONObject.isNull(C0517a.c)) {
                ConcurrentHashMap<String, c> concurrentHashMap = new ConcurrentHashMap<>();
                try {
                    JSONObject jSONObject2 = new JSONObject(jSONObject.optString(C0517a.c));
                    ...
                    while (itKeys.hasNext()) {
                        try {
                            ...
                            cVar.f7839a = jSONObjectOptJSONObject.optString("uu");
            ...
            if (!jSONObject.isNull(C0517a.d)) {
                JSONObject jSONObject3 = new JSONObject(jSONObject.optString(C0517a.d));
            ...
            if (jSONObject.isNull(C0517a.e)) {
                aVar.n = 0;
            } else {
                aVar.n = jSONObject.optInt(C0517a.e);
            }
            return aVar;
