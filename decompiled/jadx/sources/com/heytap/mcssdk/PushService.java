...
public class PushService implements com.heytap.mcssdk.a {
    ...
    private static class a {
        ...
        private static final PushService f1907a = new PushService();
    ...
    public void clearNotificationType(JSONObject jSONObject) {
        if (checkAll()) {
            ...
            com.heytap.mcssdk.utils.d.e(com.heytap.mcssdk.utils.d.f1925a, "please call the register first!");
        }
    }
    ...
    public void setPushTime(List<Integer> list, int i, int i2, int i3, int i4, JSONObject jSONObject) {
        ...
        try {
            ...
            com.heytap.mcssdk.utils.d.e(com.heytap.mcssdk.utils.d.f1925a, e.getLocalizedMessage());
        }
    }
