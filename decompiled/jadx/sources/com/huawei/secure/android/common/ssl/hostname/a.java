...
public class a {
    ...
    */
    ...
    private char b() {
        ...
        this.c = i;
        if (i == this.b) {
            throw new IllegalStateException("Unexpected end of DN: " + this.f2253a);
        }
        char[] cArr = this.g;
        char c = cArr[i];
        if (c != ' ' && c != '%' && c != '\\' && c != '_' && c != '\"' && c != '#') {
    ...
    */
    ...
    public List<String> b(String str) {
        ...
        this.e = 0;
        this.f = 0;
        this.g = this.f2253a.toCharArray();
            ...
            if (i < this.b) {
                ...
                if (i2 < this.b) {
                    ...
                    if (cArr[i2] != ',' && cArr[i2] != ';' && cArr[i2] != '+') {
                        throw new IllegalStateException("Malformed DN: " + this.f2253a);
                    }
                    this.c++;
                    strE = e();
                }
