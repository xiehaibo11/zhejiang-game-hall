...
public class LogsUtil {
    ...
    private static final Pattern f2270a = Pattern.compile("[0-9]*[a-z|A-Z]*[一-龥]*");
    ...
    private static class a extends Throwable {
        ...
        public String toString() {
            ...
            String str = name + ": ";
            if (this.f2271a.startsWith(str)) {
                return this.f2271a;
            }
            return str + this.f2271a;
        }
    ...
    private static String a(String str) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (f2270a.matcher(String.valueOf(cCharAt)).matches()) {
                if (i % 2 == 0) {
                    cCharAt = '*';
                }
                i++;
