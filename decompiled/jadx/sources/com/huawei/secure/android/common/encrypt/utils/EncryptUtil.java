...
public class EncryptUtil {
    ...
    private static final String f2232a = "EncryptUtil";
    private static final String b = "RSA";
    private static boolean c = false;
    private static boolean d = true;

    private static SecureRandom a() {
        b.a(f2232a, "generateSecureRandomNew ");
        ...
        try {
            ...
            b.b(f2232a, "NoSuchAlgorithmException");
            return instanceStrong;
        } catch (Throwable th) {
            if (d) {
                b.b(f2232a, "exception : " + th.getMessage() + " , you should implementation bcprov-jdk15on library");
                d = false;
            }
            return instanceStrong;
        }
    ...
    public static SecureRandom genSecureRandom() {
        ...
        try {
            ...
            b.b(f2232a, "genSecureRandom: NoSuchAlgorithmException");
        }
        return instanceStrong;
    }
    ...
    public static byte[] generateSecureRandom(int i) {
        ...
        try {
            ...
            Log.e(f2232a, "getSecureRandomBytes: NoSuchAlgorithmException");
            return new byte[0];
        }
    }
    ...
    public static PrivateKey getPrivateKey(String str) {
        try {
            try {
                ...
                b.b(f2232a, "load Key Exception:" + e.getMessage());
                return null;
            }
        } catch (IllegalArgumentException unused) {
            b.b(f2232a, "base64 decode IllegalArgumentException");
            return null;
        } catch (Exception e2) {
            b.b(f2232a, "base64 decode Exception" + e2.getMessage());
            return null;
        }
    }
    ...
    public static void setBouncycastleFlag(boolean z) {
        b.c(f2232a, "setBouncycastleFlag: " + z);
        c = z;
    }
