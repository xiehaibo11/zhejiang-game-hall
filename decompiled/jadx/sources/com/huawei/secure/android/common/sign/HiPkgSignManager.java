...
public class HiPkgSignManager {
    ...
    private static final String f2238a = "HiPkgSignManager";
    ...
    private static String b(byte[] bArr) {
        try {
            ...
            Log.e(f2238a, "NoSuchAlgorithmException" + e.getMessage());
            return "";
        }
    }
    ...
    public static byte[] getInstalledAPPSignature(Context context, String str) {
        ...
        if (context == null || TextUtils.isEmpty(str)) {
            Log.e(f2238a, "packageName is null or context is null");
            return new byte[0];
        }
        try {
            ...
            LogsUtil.e(f2238a, "PackageManager.NameNotFoundException : " + e.getMessage(), true);
        } catch (Exception e2) {
            LogsUtil.e(f2238a, "Exception : " + e2.getMessage(), true);
        }
        return new byte[0];
    }
    ...
    public static String getUnInstalledAPPPackageName(Context context, String str) {
        ...
        if (context == null || TextUtils.isEmpty(str)) {
            Log.e(f2238a, "archiveFilePath is null or context is null");
            return "";
        }
        try {
            PackageManager packageManager = context.getPackageManager();
            ...
            Log.e(f2238a, "getUnInstalledAPPSignature exception : " + e.getMessage());
        }
        return "";
    }
    ...
    public static byte[] getUnInstalledAPPSignature(Context context, String str) {
        ...
        try {
            ...
            if (packageManager != null) {
                ...
                Log.e(f2238a, "PackageInfo is null ");
            }
        } catch (Exception e) {
            LogsUtil.e(f2238a, "Exception : " + e.getMessage(), true);
        }
        return new byte[0];
    }
