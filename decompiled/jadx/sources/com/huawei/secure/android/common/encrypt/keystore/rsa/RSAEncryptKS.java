...
public abstract class RSAEncryptKS {
    ...
    private static final String f2227a = "RSAEncryptKS";
    ...
    private static Certificate c(String str) {
        try {
            ...
            b.b(f2227a, "IOException: " + e2.getMessage());
            return null;
        } catch (KeyStoreException e3) {
            b.b(f2227a, "KeyStoreException: " + e3.getMessage());
            return null;
        } catch (NoSuchAlgorithmException e4) {
            b.b(f2227a, "NoSuchAlgorithmException: " + e4.getMessage());
            return null;
        } catch (CertificateException e5) {
            b.b(f2227a, "CertificateException: " + e5.getMessage());
            return null;
        } catch (Exception e6) {
            b.b(f2227a, "Exception: " + e6.getMessage());
            return null;
        }
    }
    ...
    public static String decrpyt(String str, String str2) {
        try {
            ...
            b.b(f2227a, "UnsupportedEncodingException: " + e2.getMessage());
            return "";
        } catch (Exception e3) {
            b.b(f2227a, "Exception: " + e3.getMessage());
            return "";
        }
    }
    ...
    private static byte[] a(String str, byte[] bArr, boolean z) {
        ...
        if (TextUtils.isEmpty(str) || bArr == null) {
            b.b(f2227a, "alias or content is null");
            return bArr2;
        }
        if (!a()) {
            b.b(f2227a, "sdk version is too low");
            return bArr2;
        }
        PublicKey publicKeyB = b(str, z);
        if (publicKeyB == null) {
            b.b(f2227a, "Public key is null");
            return bArr2;
        }
        try {
            ...
            b.b(f2227a, "InvalidAlgorithmParameterException: " + e2.getMessage());
            return bArr2;
        } catch (InvalidKeyException e3) {
            b.b(f2227a, "InvalidKeyException: " + e3.getMessage());
            return bArr2;
        } catch (NoSuchAlgorithmException e4) {
            b.b(f2227a, "NoSuchAlgorithmException: " + e4.getMessage());
            return bArr2;
        } catch (BadPaddingException e5) {
            b.b(f2227a, "BadPaddingException: " + e5.getMessage());
            return bArr2;
        } catch (IllegalBlockSizeException e6) {
            b.b(f2227a, "IllegalBlockSizeException: " + e6.getMessage());
            return bArr2;
        } catch (NoSuchPaddingException e7) {
            b.b(f2227a, "NoSuchPaddingException: " + e7.getMessage());
            return bArr2;
        } catch (Exception e8) {
            b.b(f2227a, "Exception: " + e8.getMessage());
            return bArr2;
        }
    }
    ...
    private static boolean b(String str) {
        try {
            ...
            b.b(f2227a, "UnrecoverableKeyException: " + e5.getMessage());
            return false;
        } catch (CertificateException e6) {
            b.b(f2227a, "CertificateException: " + e6.getMessage());
            return false;
        } catch (Exception e7) {
            b.b(f2227a, "Exception: " + e7.getMessage());
            return false;
        }
    }
    ...
    public static byte[] decrpyt(String str, byte[] bArr) {
        ...
        if (!TextUtils.isEmpty(str) && bArr != null) {
            ...
            if (privateKeyA == null) {
                b.b(f2227a, "Private key is null");
                return bArr2;
            }
            try {
                Cipher cipher = Cipher.getInstance(c);
        ...
        b.b(f2227a, "alias or encrypted content is null");
        return bArr2;
    }
    ...
    private static synchronized KeyPair a(String str, boolean z) {
        ...
        if (b(str)) {
            b.b(f2227a, "Key pair exits");
            return null;
        }
        b.c(f2227a, "generate key pair.");
        try {
            try {
                try {
                    ...
                    b.b(f2227a, "NoSuchAlgorithmException: " + e2.getMessage());
                }
            } catch (InvalidAlgorithmParameterException e3) {
                b.b(f2227a, "InvalidAlgorithmParameterException: " + e3.getMessage());
            }
        } catch (NoSuchProviderException e4) {
            b.b(f2227a, "NoSuchProviderException: " + e4.getMessage());
        } catch (Exception e5) {
            b.b(f2227a, "Exception: " + e5.getMessage());
        }
