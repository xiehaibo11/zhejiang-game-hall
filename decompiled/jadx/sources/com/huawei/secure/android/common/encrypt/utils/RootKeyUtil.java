...
public class RootKeyUtil {
    ...
    public byte[] getRootKey() {
        return (byte[]) this.f2234a.clone();
    }

    public String getRootKeyHex() {
        return HexUtil.byteArray2HexStr(this.f2234a);
    }

    private void a(String str, String str2, String str3, byte[] bArr) {
        if (Build.VERSION.SDK_INT < 26) {
            b.c(b, "initRootKey: sha1");
            this.f2234a = BaseKeyUtil.exportRootKey(str, str2, str3, bArr, false);
        } else {
            b.c(b, "initRootKey: sha256");
            this.f2234a = BaseKeyUtil.exportRootKey(str, str2, str3, bArr, true);
        }
    }
