...
public abstract class c {
    ...
    public static final String f2132a = "c";
    ...
    public static RootKeyUtil b(Context context) {
        if (b == null) {
            if (g()) {
                ...
                HMSLog.w(f2132a, "root key util is null, init root key.");
                d(context);
            }
        }
        return b;
    ...
    public static String c(Context context) {
        if (!g()) {
            HMSLog.i(f2132a, "work key is empty, execute init.");
            d(context);
        }
    ...
    public static void d(Context context) {
        synchronized (d) {
            ...
            if (g()) {
                HMSLog.i(f2132a, "The local secret is already in separate file mode.");
                return;
            }
            ...
            if (file.exists()) {
                ...
                HMSLog.i(f2132a, "destroy C, delete file LocalAvengers.xml.");
            }
            ...
            HMSLog.i(f2132a, "generate D.");
        }
    }

    public static void e(Context context) throws Throwable {
        if (g()) {
            HMSLog.i(f2132a, "secretKeyCache not empty.");
            return;
        }
        c.clear();
    ...
    public static void a(String str, String str2, String str3, String str4, String str5, Context context) throws Throwable {
        ...
        try {
            ...
            HMSLog.e(f2132a, "save key IOException.");
        }
    }
    ...
    public static void a(String str, String str2, String str3) throws Throwable {
        ...
        HMSLog.i(f2132a, "save local secret key.");
