...
public class j0 implements m0 {
    ...
    public void run() {
        ...
        if (p0.a(this.f2102a, "stat_v2_1", iE * 1048576)) {
        ...
        try {
            ...
            String strA2 = g0.a(this.f2102a, "stat_v2_1", strA, "");
            try {
            ...
            g0.b(this.f2102a, "stat_v2_1", strA, jSONArray.toString());
