...
public final class PushReceiver extends BroadcastReceiver {
    ...
    private static class a implements Runnable {
        ...
        public void run() {
            ...
            int i = JsonUtil.getInt(jSONObjectB, com.alipay.sdk.authjs.a.g, 0);
            ...
            if ("Push".equals(string) && i == 1) {
                ...
                bundle.putString(CommonCode.MapKey.TRANSACTION_ID, JsonUtil.getString(jSONObjectB, AnalyticsData.KEY_TRANSACTIONID, ""));
            } else {
            ...
            if (new h().a(this.f2184a, bundle, intent)) {
        ...
        public void run() {
            try {
                ...
                if (byteArrayExtra != null && byteArrayExtra.length != 0) {
                    ...
                    sb.append(this.f2185a.getPackageName());
                    ...
                    if (new h().a(this.f2185a, bundle, intent)) {
                        return;
                    }
