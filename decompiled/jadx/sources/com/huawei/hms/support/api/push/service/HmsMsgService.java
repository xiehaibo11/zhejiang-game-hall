    ...
    private static class a extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                if (Objects.equals(this.f2186a.getApplicationContext().getPackageManager().getNameForUid(message.sendingUid), HMSPackageManager.getInstance(this.f2186a).getHMSPackageName()) && data != null) {
                    if (HMSPackageManager.getInstance(this.f2186a).getHMSPackageStates() != PackageManagerHelper.PackageStates.ENABLED) {
