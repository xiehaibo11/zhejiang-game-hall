...
public class UpdateAdapter implements IBridgeActivityDelegate {
    ...
    public WeakReference<Activity> f1989a;
    public int b;
    public UpdateBean c;
    public String d;
    ...
    public final Activity b() {
        WeakReference<Activity> weakReference = this.f1989a;
    ...
    public void onBridgeActivityCreate(Activity activity) {
        this.f1989a = new WeakReference<>(activity);
        if (a.b.a(b())) {
    ...
    public boolean onBridgeActivityResult(int i, int i2, Intent intent) {
        ...
        if (i2 == 1214) {
            ...
            UpdateManager.startUpdate(activityB, 1001, this.c);
            this.c = null;
        }
        if (i2 == -1) {
            if (intent != null) {
            ...
            if (a(activityB2, HMSPackageManager.getInstance(activityB2.getApplicationContext()).getHMSPackageName(), this.b)) {
