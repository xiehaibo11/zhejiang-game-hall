...
public class j extends b implements Callable<f> {
    ...
    public f call() {
        ...
        try {
            ...
            this.f2061a = new f(responseCode, headerFields, bArr == null ? new byte[0] : bArr, jElapsedRealtime2 - jElapsedRealtime);
            ...
            this.f2061a = new f(e, jElapsedRealtime3 - jCurrentTimeMillis2);
            jCurrentTimeMillis2 = j;
        }
        this.f2061a.a(c());
        this.f2061a.a(d());
        this.f2061a.b(jCurrentTimeMillis2);
        this.f2061a.a(jCurrentTimeMillis);
        if (a() != null) {
            a().a(this.f2061a);
        }
        return this.f2061a;
