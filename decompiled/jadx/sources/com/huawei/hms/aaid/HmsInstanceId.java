...
public class HmsInstanceId {
    ...
    public final void a(String str) {
        ...
        if (!p.c(this.f1978a)) {
            i.a(this.f1978a).removeKey("subjectId");
            return;
        }
        String string = i.a(this.f1978a).getString("subjectId");
        if (TextUtils.isEmpty(string)) {
            i.a(this.f1978a).saveString("subjectId", str);
            return;
        }
        if (string.contains(str)) {
            return;
        }
        i.a(this.f1978a).saveString("subjectId", string + Constants.ACCEPT_TIME_SEPARATOR_SP + str);
    }
            ...
            if (this.b.containsKey("aaid")) {
                ...
                if (o.e(this.f1978a)) {
                    if (ProxyCenter.getProxy() != null) {
                        ...
                        ProxyCenter.getProxy().deleteAllToken(this.f1978a);
                        return;
                    }
                    DeleteTokenReq deleteTokenReqB = o.b(this.f1978a);
                    deleteTokenReqB.setDeleteType(1);
                    deleteTokenReqB.setMultiSender(false);
                    a(deleteTokenReqB, 1);
                    BaseUtils.deleteAllTokenCache(this.f1978a);
                }
            }
    ...
    public void deleteToken(String str, String str2) throws ApiException {
        b();
        a();
        DeleteTokenReq deleteTokenReqA = o.a(this.f1978a, str, str2);
    ...
    public Task<AAIDResult> getAAID() {
        try {
            return Tasks.callInBackground(new j(this.f1978a.getApplicationContext()));
        } catch (Exception unused) {
    ...
    public String getToken(String str, String str2) throws ApiException {
        b();
        a();
        TokenReq tokenReqB = o.b(this.f1978a, str, str2);
        tokenReqB.setAaid(getId());
        tokenReqB.setMultiSender(false);
        i.a(this.f1978a).saveString(this.f1978a.getPackageName(), "1");
    ...
    public void deleteToken(String str) throws ApiException {
        ...
        a();
        if (!TextUtils.isEmpty(str)) {
            String strD = o.d(this.f1978a);
            if (!TextUtils.isEmpty(strD)) {
                if (str.equals(strD)) {
                    deleteToken(null, null);
                    return;
                }
                DeleteTokenReq deleteTokenReqA = o.a(this.f1978a, str);
    ...
    public String getToken(String str) throws ApiException {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            if (!TextUtils.isEmpty(strD)) {
                ...
                TokenReq tokenReqB = o.b(this.f1978a, str);
                tokenReqB.setAaid(getId());
    ...
    public final String a(TokenReq tokenReq, int i) throws ApiException {
        if (ProxyCenter.getProxy() != null) {
            ...
            ProxyCenter.getProxy().getToken(this.f1978a, tokenReq.getSubjectId(), null);
            return null;
        }
        a(tokenReq.getSubjectId());
        String strA = q.a(this.f1978a, "push.gettoken");
        try {
            String str = TAG;
            ...
            l lVar = new l("push.gettoken", tokenReq, this.f1978a, strA);
            lVar.setApiLevel(i);
            return ((TokenResult) Tasks.await(this.c.doWrite(lVar))).getToken();
        } catch (Exception e) {
            if (e.getCause() instanceof ApiException) {
                ApiException apiException = (ApiException) e.getCause();
                q.a(this.f1978a, "push.gettoken", strA, apiException.getStatusCode());
                throw apiException;
            }
            q.a(this.f1978a, "push.gettoken", strA, ErrorEnum.ERROR_INTERNAL_ERROR);
            throw ErrorEnum.ERROR_INTERNAL_ERROR.toApiException();
        }
    }
    ...
    public final void a(DeleteTokenReq deleteTokenReq, int i) throws ApiException {
        ...
        if (ProxyCenter.getProxy() != null) {
            ...
            ProxyCenter.getProxy().deleteToken(this.f1978a, subjectId, null);
            return;
        }
        String strA = q.a(this.f1978a, "push.deletetoken");
        try {
            String strB = i.a(this.f1978a).b(subjectId);
            if (deleteTokenReq.isMultiSender() && (TextUtils.isEmpty(strB) || strB.equals(i.a(this.f1978a).b(null)))) {
                i.a(this.f1978a).removeKey(subjectId);
            ...
            i.a(this.f1978a).c(subjectId);
        } catch (Exception e) {
            if (e.getCause() instanceof ApiException) {
                ApiException apiException = (ApiException) e.getCause();
                q.a(this.f1978a, "push.deletetoken", strA, apiException.getStatusCode());
                throw apiException;
            }
            q.a(this.f1978a, "push.deletetoken", strA, ErrorEnum.ERROR_INTERNAL_ERROR);
            throw ErrorEnum.ERROR_INTERNAL_ERROR.toApiException();
        }
    }

    public final void a() throws ApiException {
        if (BaseUtils.getProxyInit(this.f1978a) && ProxyCenter.getProxy() == null && !BaseUtils.isMainProc(this.f1978a)) {
