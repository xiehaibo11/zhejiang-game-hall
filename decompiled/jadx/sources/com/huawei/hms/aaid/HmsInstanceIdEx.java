    ...
    public Task<TokenResult> getToken() {
        if (ProxyCenter.getProxy() != null) {
            try {
                ...
                ProxyCenter.getProxy().getToken(this.f1979a, null, null);
        ...
        String strA = q.a(this.f1979a, "push.gettoken");
        try {
            TokenReq tokenReqB = o.b(this.f1979a, null, null);
            tokenReqB.setAaid(HmsInstanceId.getInstance(this.f1979a).getId());
            return this.c.doWrite(new l("push.gettoken", tokenReqB, this.f1979a, strA));
        } catch (RuntimeException unused2) {
            q.a(this.f1979a, "push.gettoken", strA, ErrorEnum.ERROR_INTERNAL_ERROR);
            return a(ErrorEnum.ERROR_INTERNAL_ERROR.toApiException());
