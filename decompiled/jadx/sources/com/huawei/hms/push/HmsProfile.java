...
public class HmsProfile {
    ...
    public static final String f2148a = "HmsProfile";
    public Context b;
    ...
    public final Task<Void> a(int i, String str, int i2, String str2) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            if (TextUtils.isEmpty(strA)) {
                HMSLog.i(f2148a, "agc connect services config missing project id.");
    ...
    public boolean isSupportProfile() {
        ...
        if (s.c()) {
            HMSLog.i(f2148a, "current EMUI version below 9.1, not support profile operation.");
            return false;
        }
        if (b(this.b)) {
            return true;
        }
        HMSLog.i(f2148a, "current HwPushService.apk version below 11.0.1.400,please upgrade your HwPushService.apk version.");
        return false;
    }

    public Task<Void> addProfile(String str, int i, String str2) {
        if (i != 1 && i != 2) {
            HMSLog.i(f2148a, "add profile type undefined.");
            TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        ...
        HMSLog.i(f2148a, "add profile params is empty.");
        TaskCompletionSource taskCompletionSource2 = new TaskCompletionSource();
    ...
    public Task<Void> deleteProfile(String str, String str2) {
        ...
        HMSLog.e(f2148a, "del profile params is empty.");
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        taskCompletionSource.setException(ErrorEnum.ERROR_PUSH_ARGUMENTS_INVALID.toApiException());
        return taskCompletionSource.getTask();
    }
