...
public class PluginUtil {
    public static void a(Context context, String str, String str2, String str3) {
        ...
        if (!t.a(context)) {
            ...
            e.a(context, str, null, TYAdConst.BIDDING_TYPE.BIDDING_LOSS_WITH_LOW_PRICE_IN_NORMAL);
            return;
        }
        Intent intent = new Intent();
        intent.setAction("com.huawei.push.msg.NOTIFY_MSG");
        intent.putExtra("selfshow_info", str3.getBytes(w.f2170a));
        intent.putExtra("selfshow_token", str2.getBytes(w.f2170a));
    ...
    public static boolean onDataMessage(Context context, String str, String str2, boolean z) {
        ...
        bundle.putByteArray(RemoteMessageConst.MSGBODY, str2.getBytes(w.f2170a));
