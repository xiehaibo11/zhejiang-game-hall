...
public class k {
    ...
    public k(byte[] bArr, byte[] bArr2) {
        this.r = new String(bArr, w.f2170a);
        this.s = new String(bArr2, w.f2170a);
    }

    public final JSONObject a(JSONObject jSONObject) throws JSONException {
        JSONObject jSONObject2 = new JSONObject();
        jSONObject2.put(RemoteMessageConst.MessageBody.MSG_CONTENT, jSONObject);
        jSONObject2.put("group", this.f2156a);
    ...
    public final void g(JSONObject jSONObject) {
        this.f2156a = jSONObject.optString("group");
        HMSLog.d("PushSelfShowLog", "NOTIFY_GROUP:" + this.f2156a);
    ...
    public byte[] o() {
        try {
            return a(a(b(v()), r())).toString().getBytes(w.f2170a);
        } catch (JSONException e) {
    ...
    public byte[] y() {
        return this.s.getBytes(w.f2170a);
    }
