...
public class q {
    ...
    public static long a(String str) {
        ...
        try {
            date = new Date();
            hours = (date.getHours() * 2) + (date.getMinutes() / 30);
            strConcat = str.concat(str);
            StringBuilder sb = new StringBuilder();
    ...
    public static void a(Context context, int i) {
        if (context == null) {
            HMSLog.e("PushSelfShowLog", com.tkay.expressad.foundation.g.b.b.f6873a);
            return;
        }
        try {
