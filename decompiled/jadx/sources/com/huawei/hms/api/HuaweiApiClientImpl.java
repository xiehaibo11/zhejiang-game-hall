...
public class HuaweiApiClientImpl extends HuaweiApiClient implements InnerApiClient, ServiceConnection {
    ...
    class d extends c.a {
        ...
        public void call(com.huawei.hms.core.aidl.b bVar) {
            if (bVar == null) {
                ...
                this.f2002a.onResult(new BundleResult(-1, null));
                return;
            }
            ...
            this.f2002a.onResult(bundleResult);
        }
    }
    ...
    private class f implements ResultCallback<ResolveResult<ConnectResp>> {
        ...
        class a implements Runnable {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            final /* synthetic */ ResolveResult f2004a;

            a(ResolveResult resolveResult) {
                this.f2004a = resolveResult;
            }

            @Override // java.lang.Runnable
            public void run() {
                HuaweiApiClientImpl.this.a((ResolveResult<ConnectResp>) this.f2004a);
            }
        }
    ...
    private class g implements ResultCallback<ResolveResult<DisconnectResp>> {
        ...
        class a implements Runnable {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            final /* synthetic */ ResolveResult f2006a;

            a(ResolveResult resolveResult) {
                this.f2006a = resolveResult;
            }

            @Override // java.lang.Runnable
            public void run() {
                HuaweiApiClientImpl.this.b((ResolveResult<DisconnectResp>) this.f2006a);
            }
        }
    ...
    public void disableLifeCycleManagement(Activity activity) {
        ...
        autoLifecycleFragment.stopAutoManage(this.f1998a);
    }
