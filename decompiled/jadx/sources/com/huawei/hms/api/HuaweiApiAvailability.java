...
public abstract class HuaweiApiAvailability {
    ...
    public static final String HMS_SDK_VERSION_NAME = "5.3.0.301";
    ...
    private static final Map<String, Integer> f1996a;

    static {
        HashMap map = new HashMap();
        f1996a = map;
        map.put(HMS_API_NAME_ID, 30000000);
        f1996a.put(HMS_API_NAME_SNS, 20503000);
        f1996a.put(HMS_API_NAME_PAY, 20503000);
        f1996a.put(HMS_API_NAME_PUSH, 20503000);
        f1996a.put(HMS_API_NAME_GAME, 20503000);
        f1996a.put(HMS_API_NAME_OD, Integer.valueOf(HMS_VERSION_CODE_OD));
        f1996a.put(HMS_API_NAME_IAP, 20700300);
        f1996a.put(HMS_API_NAME_PPS, 20700300);
    }
