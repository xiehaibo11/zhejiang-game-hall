...
final class b extends HuaweiApiAvailability {
    ...
    class a implements BusResponseCallback {
        ...
        final /* synthetic */ TaskCompletionSource[] f2014a;

        a(b bVar, TaskCompletionSource[] taskCompletionSourceArr) {
            this.f2014a = taskCompletionSourceArr;
        }
        ...
        public BusResponseResult innerError(Activity activity, int i, String str) {
            ...
            this.f2014a[0].setException(new AvailabilityException());
            return null;
        }
    ...
    public PendingIntent b(Context context, int i) {
        ...
        if (intentA != null) {
            return PendingIntent.getActivity(context, 0, intentA, DownloadExpSwitchCode.BUGFIX_SIGBUS_24_25);
        }
        return null;
    }
    ...
    public PendingIntent getResolveErrorPendingIntent(Activity activity, int i) {
        ...
        if (resolveErrorIntent != null) {
            return PendingIntent.getActivity(activity, 0, resolveErrorIntent, DownloadExpSwitchCode.BUGFIX_SIGBUS_24_25);
        }
        return null;
    }
    ...
    public PendingIntent getErrPendingIntent(Context context, int i, int i2) {
        ...
        Intent intentA = a(context, i);
        if (intentA != null) {
            return PendingIntent.getActivity(context, i2, intentA, DownloadExpSwitchCode.BUGFIX_SIGBUS_24_25);
        }
        return null;
    }
