...
public class JsonUtil {
    ...
    private static Object getObjectValue(String str, JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject.has(f.j) && jSONObject.getJSONObject(f.j).has(str)) {
            return jSONObject.getJSONObject(f.j).get(str);
        }
    ...
    private static void readFiled(IMessageEntity iMessageEntity, Field field, JSONObject jSONObject) throws IllegalAccessException, JSONException {
    ...
    private static void writeList(String str, List<?> list, JSONObject jSONObject) throws IllegalAccessException, JSONException {
        JSONObject jSONObject2 = new JSONObject();
