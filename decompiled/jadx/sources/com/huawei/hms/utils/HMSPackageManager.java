...
public class HMSPackageManager {
    ...
    public final Pair<String, String> b() {
        List<ResolveInfo> listQueryIntentServices = this.f2208a.getPackageManager().queryIntentServices(new Intent("com.huawei.hms.core.aidlservice"), 128);
    ...
    public final boolean d() {
        PackageManager packageManager = this.f2208a.getPackageManager();
    ...
    public final boolean a() {
        String hmsPath = ReadApkFileUtil.getHmsPath(this.f2208a);
        if (hmsPath == null) {
