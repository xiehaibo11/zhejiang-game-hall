...
public class b {
    ...
    public long a(String str, long j) {
        try {
            return this.f2318a.getLong(str, j);
        } catch (Exception unused) {
            return j;
        }
    }
    ...
    public String a(String str, String str2) {
        try {
            return this.f2318a.getString(str, str2);
        } catch (Exception unused) {
            return str2;
        }
    }
    ...
    public void a(String str) {
        try {
            if (this.f2318a.contains(str)) {
                SharedPreferences.Editor editorEdit = this.f2318a.edit();
