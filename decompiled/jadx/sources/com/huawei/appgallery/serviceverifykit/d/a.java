...
public class a {
    ...
    public static byte[] a(String str) {
        ...
        for (int i6 = 0; i6 < str.length(); i6++) {
            ...
            byte b = cCharAt > 255 ? (byte) -1 : f1950a[cCharAt];
            if (b >= 0) {
                i5 += 6;
                i4 = (i4 << 6) | b;
                if (i5 >= 8) {
    ...
    private static int b(String str) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (cCharAt > 255 || f1950a[cCharAt] < 0) {
                length--;
            }
        }
        return length;
