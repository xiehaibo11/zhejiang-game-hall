...
class NeuQuant {
    ...
    public void learn() {
        ...
        int i13 = 0;
        while (i9 < i4) {
            int i14 = (bArr[i13 + 0] & UByte.MAX_VALUE) << 4;
            int i15 = (bArr[i13 + 1] & UByte.MAX_VALUE) << 4;
            int i16 = (bArr[i13 + 2] & UByte.MAX_VALUE) << 4;
            int iContest = contest(i14, i15, i16);
            int i17 = i9;
            altersingle(i12, iContest, i14, i15, i16);
            if (i11 != 0) {
                alterneigh(i11, iContest, i14, i15, i16);
            }
            int i18 = i13 + i;
            if (i18 >= i3) {
            ...
            if (i9 % i8 == 0) {
                ...
                for (int i20 = 0; i20 < i11; i20++) {
                    int i21 = i11 * i11;
                    this.radpower[i20] = (((i21 - (i20 * i20)) * 256) / i21) * i12;
                }
            }
        }
    }
