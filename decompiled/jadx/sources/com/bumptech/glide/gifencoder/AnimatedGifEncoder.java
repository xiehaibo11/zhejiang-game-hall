...
public class AnimatedGifEncoder {
    ...
    private void analyzePixels() {
        ...
        while (i4 < i) {
            ...
            int i6 = i5 + 1;
            int i7 = i6 + 1;
            int map = neuQuant.map(bArr2[i5] & UByte.MAX_VALUE, bArr2[i6] & UByte.MAX_VALUE, bArr2[i7] & UByte.MAX_VALUE);
    ...
    private int findClosest(int i) {
        ...
        while (i3 < length) {
            byte[] bArr = this.colorTab;
            int i5 = i3 + 1;
            int i6 = iRed - (bArr[i3] & UByte.MAX_VALUE);
            int i7 = i5 + 1;
