    ...
    private void l(final String str, final String str2) {
        ...
        if (!TextUtils.isEmpty(this.XZ)) {
            ...
            spannableStringBuilder.setSpan(new ClickableSpan() { // from class: com.kwad.components.core.widget.ComplianceTextView.2
                ...
                public final void onClick(View view) {
                    AdWebViewActivityProxy.launch(ComplianceTextView.this.getContext(), new AdWebViewActivityProxy.a.C0160a().aq(str).ar(ComplianceTextView.this.XZ).ay(true).S(ComplianceTextView.this.mAdTemplate).oA());
                }
        ...
        if (!TextUtils.isEmpty(this.Ya)) {
            ...
            spannableStringBuilder.setSpan(new ClickableSpan() { // from class: com.kwad.components.core.widget.ComplianceTextView.3
                @Override // android.text.style.ClickableSpan
                public final void onClick(View view) {
                    AdWebViewActivityProxy.launch(ComplianceTextView.this.getContext(), new AdWebViewActivityProxy.a.C0160a().aq(str2).ar(ComplianceTextView.this.Ya).ay(true).S(ComplianceTextView.this.mAdTemplate).oA());
                }
