...
public class AdWebViewActivityProxy extends com.kwad.components.core.n.c {
    ...
    public static class a {
        ...
        public static class C0160a {
            ...
            public final C0160a S(AdTemplate adTemplate) {
                this.adTemplate = adTemplate;
                return this;
            }

            public final C0160a aq(String str) {
                this.MB = str;
                return this;
            }

            public final C0160a ar(String str) {
                this.MC = str;
                return this;
            }

            public final C0160a ay(boolean z) {
                this.MF = z;
                return this;
            }

            public final C0160a az(boolean z) {
                this.ME = z;
                return this;
            }
    ...
    private com.kwad.components.core.page.widget.a buildDialog() {
        return new com.kwad.components.core.page.widget.a(getActivity(), new a.InterfaceC0163a() { // from class: com.kwad.components.core.page.AdWebViewActivityProxy.5
    ...
    private void initContentView() {
        ...
        c cVarB = c.b(this.mContext, new a.C0160a().aq(this.mPageTitle).ar(this.mPageUrl).S(this.mAdTemplate).ay(this.mShowPermission).az(this.mAutoShow).oA());
    ...
    public static void launch(Context context, AdTemplate adTemplate) {
        launch(context, new a.C0160a().ar(com.kwad.sdk.core.response.b.b.bm(adTemplate)).S(adTemplate).oA());
    }
        ...
        if (isFormAdExitInterceptEnable()) {
            try {
                if (this.mKsExitInterceptDialogV2 == null) {
                    this.mKsExitInterceptDialogV2 = new com.kwad.components.core.page.widget.a(getActivity(), new a.InterfaceC0163a() { // from class: com.kwad.components.core.page.AdWebViewActivityProxy.4
                        @Override // com.kwad.components.core.page.widget.a.InterfaceC0163a
                        public final void a(DialogInterface dialogInterface) {
                            com.kwad.sdk.core.report.a.q(AdWebViewActivityProxy.this.mAdTemplate, 104);
                            dialogInterface.dismiss();
