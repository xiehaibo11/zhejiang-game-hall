...
public final class b {
    ...
    private al Ti;
    private e Tj;
    private ah.b Tk = new ah.b() { // from class: com.kwad.components.core.webview.b.10
    ...
    private void b(com.kwad.components.core.webview.a aVar, com.kwad.sdk.core.webview.b bVar) {
        ...
        aVar.a(new at(new at.a() { // from class: com.kwad.components.core.webview.b.1
            @Override // com.kwad.components.core.webview.jshandler.at.a
        ...
        if (com.kwad.sdk.core.response.b.a.ax(d.cg(this.mAdTemplate))) {
            final l lVar = new l();
            aVar.a(lVar);
            this.Tj = new e(this.mAdTemplate) { // from class: com.kwad.components.core.webview.b.6
        ...
        aVar.a(new j() { // from class: com.kwad.components.core.webview.b.8
            ...
            public final void a(n nVar) {
                super.a(nVar);
                AdWebViewActivityProxy.launch(b.this.cE.Ms.getContext(), new AdWebViewActivityProxy.a.C0160a().aq(nVar.title).ar(nVar.url).ay(true).S(b.this.mAdTemplate).oA());
            }
        });
        ...
        aVar.a(new aa(this.cE, new aa.b() { // from class: com.kwad.components.core.webview.b.9
