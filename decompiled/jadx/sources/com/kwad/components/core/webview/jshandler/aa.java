...
public final class aa implements com.kwad.sdk.core.webview.c.a {
    ...
    public final void a(String str, com.kwad.sdk.core.webview.c.c cVar) {
        ...
        try {
            ...
            this.TT.post(new Runnable() { // from class: com.kwad.components.core.webview.jshandler.aa.1
            ...
            this.TT.post(new Runnable() { // from class: com.kwad.components.core.webview.jshandler.aa.2
                @Override // java.lang.Runnable
                public final void run() {
                    if (aa.this.TU != null) {
                        aa.this.TU.a(null);
