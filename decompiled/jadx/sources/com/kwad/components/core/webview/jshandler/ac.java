...
public final class ac implements com.kwad.sdk.core.webview.c.a {
    ...
    public final void a(String str, com.kwad.sdk.core.webview.c.c cVar) {
        ...
        if (com.kwad.sdk.core.response.b.d.bY(adTemplate)) {
            ...
            if (this.TL.ayg) {
                this.TT.post(new Runnable() { // from class: com.kwad.components.core.webview.jshandler.ac.1
                    @Override // java.lang.Runnable
                    public final void run() {
                        z.b bVar = new z.b();
                        bVar.UP = aVar.Va.UP;
                        com.kwad.components.core.e.d.a.a(new a.C0150a(ac.this.TL.MT.getContext()).P(adTemplate).b(cVar2).ao(aVar.UZ).am(true).a(bVar).ao(true).a(new a.b() { // from class: com.kwad.components.core.webview.jshandler.ac.1.1
                ...
                this.TT.post(new Runnable() { // from class: com.kwad.components.core.webview.jshandler.ac.2
                    @Override // java.lang.Runnable
                    public final void run() {
                    }
                });
