...
public class o implements com.kwad.sdk.core.webview.c.a {
    ...
    static /* synthetic */ boolean a(o oVar, com.kwad.sdk.core.webview.d.b.a aVar) {
        return b(aVar);
    }
    ...
    public final void a(String str, com.kwad.sdk.core.webview.c.c cVar) {
        ...
        if (!this.TL.ayg) {
            if (this.cH != null) {
                runnable = new Runnable() { // from class: com.kwad.components.core.webview.jshandler.o.2
        ...
        runnable = new Runnable() { // from class: com.kwad.components.core.webview.jshandler.o.1
            @Override // java.lang.Runnable
            public final void run() {
                ...
                if (o.this.TL.ayh) {
                    ...
                    o.this.J(com.kwad.components.core.e.d.a.a(new a.C0150a(o.this.TL.MT.getContext()).P(adTemplate).b(cVarC).al(strQ).am(o.a(o.this, aVar)).an(o.this.TN).d(o.this.TL.mReportExtData).ao(aVar.UZ).am(aVar.azd).an(aVar.jG).ao(o.this.TO || aVar.JK).aq(o.this.TM).a(o.this.a(aVar, adTemplate)).a(new a.b() { // from class: com.kwad.components.core.webview.jshandler.o.1.1
