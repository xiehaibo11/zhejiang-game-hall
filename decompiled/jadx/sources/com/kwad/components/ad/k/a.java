...
public final class a {
    ...
    /* JADX INFO: renamed from: com.kwad.components.ad.k.a$a, reason: collision with other inner class name */
    ...
    private void fA() {
        ...
        this.GQ.setDownloadListener(new DownloadListener() { // from class: com.kwad.components.ad.k.a.1
    ...
    public final boolean ap() {
        ...
        if (zLU && this.mActivity != null) {
            ...
            this.GT.a(new View.OnTouchListener() { // from class: com.kwad.components.ad.k.a.5
