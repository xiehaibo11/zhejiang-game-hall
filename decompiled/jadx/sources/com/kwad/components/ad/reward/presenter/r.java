...
public final class r extends a implements com.kwad.components.ad.reward.e.f, a.InterfaceC0155a, n.b {
    ...
    private Animator a(boolean z, float f, int i, boolean z2, boolean z3) {
        ...
        if (z) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.kwad.components.ad.reward.presenter.r.3
        ...
        ValueAnimator valueAnimatorA = this.tc.a(this.mAdTemplate, i, new ValueAnimator.AnimatorUpdateListener() { // from class: com.kwad.components.ad.reward.presenter.r.4
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    private void d(List<AdTemplate> list) {
        ...
        this.pb.a(new b.InterfaceC0115b() { // from class: com.kwad.components.ad.reward.presenter.r.2
            @Override // com.kwad.components.ad.k.b.InterfaceC0115b
