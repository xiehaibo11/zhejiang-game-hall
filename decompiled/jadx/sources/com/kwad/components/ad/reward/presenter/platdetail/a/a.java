...
public final class a extends com.kwad.components.ad.reward.presenter.a implements View.OnClickListener, bn.a {
    ...
    public final void onClick(View view) {
        if (view == this.vd || view == this.ve) {
            com.kwad.components.core.e.d.a.a(new a.C0150a(view.getContext()).P(this.mAdTemplate).b(this.mApkDownloadHelper).ao(2).s(this.qx.oV.getPlayDuration()).a(new a.b() { // from class: com.kwad.components.ad.reward.presenter.platdetail.a.a.6
