...
public final class i extends d implements View.OnClickListener {
    ...
    public final void a(r rVar) {
        ...
        if (viewGroup != null) {
            ...
            this.sw.postDelayed(new Runnable() { // from class: com.kwad.components.ad.reward.m.i.2
                @Override // java.lang.Runnable
                public final void run() {
                    ...
                    if (animatorA != null) {
                        animatorA.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.reward.m.i.2.1
                            private int ze = 1;
