...
public class ActionBarAppLandscape extends LinearLayout implements c {
    ...
    private KsAppDownloadListener f2817cn;
    ...
    private void b(View view, final boolean z) {
        com.kwad.components.core.e.d.a.a(new a.C0150a(view.getContext()).P(this.mAdTemplate).b(this.mApkDownloadHelper).am(view == this.Be).ao(view == this.Bf ? 1 : 2).a(new a.b() { // from class: com.kwad.components.ad.reward.widget.actionbar.ActionBarAppLandscape.2
    ...
    private KsAppDownloadListener getAppDownloadListener() {
        if (this.f2817cn == null) {
            this.f2817cn = new com.kwad.sdk.core.download.a.a() { // from class: com.kwad.components.ad.reward.widget.actionbar.ActionBarAppLandscape.1
