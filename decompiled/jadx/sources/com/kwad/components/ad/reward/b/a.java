...
public final class a extends d implements View.OnClickListener {
        ...
        public final void run() {
            ...
            animatorA.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.reward.b.a.1.1
                ...
                public final void onAnimationEnd(Animator animator) {
                    ...
                    com.kwad.sdk.core.report.a.b(AnonymousClass1.this.qY.getAdTemplate(), 169, (JSONObject) null);
                    a.a(a.this, a.this.qU, AnonymousClass1.this.qZ).start();
                    bj.a(new Runnable() { // from class: com.kwad.components.ad.reward.b.a.1.1.1
                        @Override // java.lang.Runnable
                        public final void run() {
                            a.this.gR();
                        }
                    }, null, AnonymousClass1.this.qZ);
                }
            });
            animatorA.start();
        }
    ...
    static class C0118a {
        ...
        private C0118a(CouponInfo couponInfo) {
        ...
        private static C0118a a(CouponInfo couponInfo) {
            if (couponInfo == null) {
                return null;
            }
            return new C0118a(couponInfo);
        }

        public static C0118a u(AdTemplate adTemplate) {
    ...
    private void a(C0118a c0118a) {
        ...
        if (textView != null) {
            textView.setText(c0118a.getTitle());
        }
        TextView textView2 = this.qV;
        if (textView2 != null) {
            textView2.setText(c0118a.N(this.gg.getContext()));
        }
        TextView textView3 = this.lC;
        if (textView3 != null) {
            textView3.setText(c0118a.gS());
        }
        Button button = this.qW;
        if (button != null) {
            button.setText(c0118a.gT());
        }
    }
    ...
    public void gR() {
        ...
        animatorN.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.reward.b.a.2
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public final void onAnimationEnd(Animator animator) {
                super.onAnimationEnd(animator);
    ...
    public final void a(r rVar) {
        super.a(rVar);
        a(C0118a.u(rVar.getAdTemplate()));
        this.gg.post(new AnonymousClass1(rVar, com.kwad.components.ad.reward.a.b.gL()));
    }
