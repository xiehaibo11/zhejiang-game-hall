...
public final class d extends AbstractKsNativeAd implements DialogInterface.OnDismissListener, DialogInterface.OnShowListener, com.kwad.components.core.internal.api.a {
    ...
    private int mB = 0;
    private int mC = 0;
    private KsNativeAd.VideoPlayListener mD = new KsNativeAd.VideoPlayListener() { // from class: com.kwad.components.ad.f.d.8
    ...
    private a mE = new a() { // from class: com.kwad.components.ad.f.d.9
    ...
    public void a(Activity activity, final View view, final ac.a aVar, int i, boolean z, final int i2) {
        ...
        a.C0150a c0150aAm = new a.C0150a(l.wrapContextIfNeed(context)).P(this.mAdTemplate).b(this.mApkDownloadHelper).ap(i).am(true);
        e eVar = this.my;
        com.kwad.components.core.e.d.a.a(c0150aAm.s((eVar == null || eVar.eF == null) ? 0L : this.my.eF.getPlayDuration()).at(z).a(new a.b() { // from class: com.kwad.components.ad.f.d.4
    ...
    private void a(final ViewGroup viewGroup) {
        ...
        if (!com.kwad.sdk.core.config.d.zJ() && com.kwad.sdk.core.config.d.zI() >= 0.0f) {
            ...
            aVar.setViewCallback(new a.InterfaceC0176a() { // from class: com.kwad.components.ad.f.d.5
        ...
        cVarB.setViewCallback(new c.a() { // from class: com.kwad.components.ad.f.d.6
        ...
        if (com.kwad.sdk.core.response.b.a.aa(this.mAdInfo)) {
            ...
            this.mr = new b.c() { // from class: com.kwad.components.ad.f.d.7
                ...
                public final void f(final double d) {
                    ...
                    com.kwad.components.core.e.d.a.a(new a.C0150a(l.wrapContextIfNeed(view.getContext())).P(d.this.mAdTemplate).b(d.this.mApkDownloadHelper).at(false).a(new a.b() { // from class: com.kwad.components.ad.f.d.7.1
                        @Override // com.kwad.components.core.e.d.a.b
                        public final void onAdClicked() {
    ...
    public final View getVideoView2(Context context, KsAdVideoPlayConfig ksAdVideoPlayConfig) {
        ...
        try {
            ...
            com.kwad.sdk.i.a.ah(com.tkay.expressad.foundation.g.a.f.f6871a, PointCategory.SHOW);
            ...
            com.kwad.sdk.i.a.ai(com.tkay.expressad.foundation.g.a.f.f6871a, PointCategory.SHOW);
            return viewA;
        } catch (Throwable th) {
