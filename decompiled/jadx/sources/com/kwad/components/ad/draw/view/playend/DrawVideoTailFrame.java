...
public class DrawVideoTailFrame extends FrameLayout implements View.OnClickListener {
    ...
    private KsAppDownloadListener f2816cn;
    ...
    public void onClick(View view) {
        com.kwad.components.core.e.d.a.a(new a.C0150a(getContext()).P(this.mAdTemplate).b(this.mApkDownloadHelper).ao(view == this.dz ? 1 : 2).am(view == this.dz).a(new a.b() { // from class: com.kwad.components.ad.draw.view.playend.DrawVideoTailFrame.2
    ...
    public final void release() {
        ...
        c cVar = this.mApkDownloadHelper;
        if (cVar == null || (ksAppDownloadListener = this.f2816cn) == null) {
            return;
        }
