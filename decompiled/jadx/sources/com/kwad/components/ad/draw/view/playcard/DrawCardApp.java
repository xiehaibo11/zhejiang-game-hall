...
public class DrawCardApp extends FrameLayout implements View.OnClickListener {
    ...
    private KsAppDownloadListener f2815cn;
    private a da;
    ...
    private KsAppDownloadListener getAppDownloadListener() {
        if (this.f2815cn == null) {
            this.f2815cn = new com.kwad.sdk.core.download.a.a() { // from class: com.kwad.components.ad.draw.view.playcard.DrawCardApp.1
    ...
    public void onClick(View view) {
        if (view != this.db) {
            com.kwad.components.core.e.d.a.a(new a.C0150a(getContext()).P(this.mAdTemplate).b(this.mApkDownloadHelper).am(view == this.dj).ao(view == this.dj ? 1 : 2).a(new a.b() { // from class: com.kwad.components.ad.draw.view.playcard.DrawCardApp.2
