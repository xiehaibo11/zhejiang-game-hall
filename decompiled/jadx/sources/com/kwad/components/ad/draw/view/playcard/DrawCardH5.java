...
public class DrawCardH5 extends FrameLayout implements View.OnClickListener {
    ...
    public final void a(AdTemplate adTemplate, a aVar) {
        ...
        this.dm = aVar;
        this.f0do.setText(com.kwad.sdk.core.response.b.a.an(adInfoCg));
    ...
    public void onClick(View view) {
        if (view != this.dn) {
            com.kwad.components.core.e.d.a.a(new a.C0150a(getContext()).P(this.mAdTemplate).a(new a.b() { // from class: com.kwad.components.ad.draw.view.playcard.DrawCardH5.1
