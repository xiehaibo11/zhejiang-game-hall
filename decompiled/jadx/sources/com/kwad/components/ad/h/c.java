...
public final class c implements Runnable {
    ...
    public void ff() {
        ...
        this.nY = true;
        this.oa.c(new com.kwad.components.ad.b.a.b() { // from class: com.kwad.components.ad.h.c.3
    ...
    public final void fe() {
        ...
        nZ = true;
        com.kwad.components.core.i.a.b(this.nX.mAdScene, new a.InterfaceC0155a() { // from class: com.kwad.components.ad.h.c.1
    ...
    public final void run() {
        if (com.kwad.components.core.e.a.e.mN().isShowing()) {
            com.kwad.components.core.e.a.e.mN().a(new com.kwad.components.core.e.a.c() { // from class: com.kwad.components.ad.h.c.2
