...
public class FeedDownloadActivityProxy extends com.kwad.components.core.n.c implements View.OnClickListener {
    ...
    public void onClick(View view) {
        com.kwad.components.core.e.d.a.a(new a.C0150a(view.getContext()).P(this.mAdTemplate).b(this.mApkDownloadHelper).ao(view == this.mProgressBarTv ? 1 : 2).am(view == this.mProgressBarTv).a(new a.b() { // from class: com.kwad.components.ad.feed.FeedDownloadActivityProxy.2
