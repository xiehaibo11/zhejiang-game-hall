...
public final class m extends com.kwad.components.core.widget.b<AdTemplate> implements View.OnClickListener, com.kwad.sdk.widget.c {
    ...
    public m(Context context) {
        ...
        this.fG = new b.a() { // from class: com.kwad.components.ad.feed.b.m.20
        ...
        this.mNetworking = new com.kwad.sdk.core.network.m<com.kwad.components.core.liveEnd.a, AdLiveEndCommonResultData>() { // from class: com.kwad.components.ad.feed.b.m.3
        ...
        this.eJ = new AdLivePlayStateListenerAdapter() { // from class: com.kwad.components.ad.feed.b.m.4
            ...
            public final void onLivePlayEnd() {
                ...
                m.this.mNetworking.request(new p<com.kwad.components.core.liveEnd.a, AdLiveEndCommonResultData>() { // from class: com.kwad.components.ad.feed.b.m.4.1
                    /* JADX INFO: Access modifiers changed from: private */
        ...
        this.cK = new ah.b() { // from class: com.kwad.components.ad.feed.b.m.8
        ...
        this.eC = new a.InterfaceC0165a() { // from class: com.kwad.components.ad.feed.b.m.18
            ...
            public final void a(int i, ac.a aVar) {
                ...
                bVar.jG = i2;
                m.this.bu();
                com.kwad.components.core.e.d.a.a(new a.C0150a(m.this.getContext()).P(m.this.mAdTemplate).b(m.this.mApkDownloadHelper).ao(i3).am(z).ao(true).a(bVar).aq(true).a(new a.b() { // from class: com.kwad.components.ad.feed.b.m.18.1
    ...
    private void a(com.kwad.components.core.webview.a aVar) {
        ...
        aVar.a(new aa(this.cE, new aa.b() { // from class: com.kwad.components.ad.feed.b.m.21
        ...
        aVar.a(new WebCardVideoPositionHandler(new WebCardVideoPositionHandler.a() { // from class: com.kwad.components.ad.feed.b.m.22
        ...
        aVar.a(new s(this.cE, new s.a() { // from class: com.kwad.components.ad.feed.b.m.23
            @Override // com.kwad.components.core.webview.jshandler.s.a
            public final void bz() {
                m.this.mHandler.post(new Runnable() { // from class: com.kwad.components.ad.feed.b.m.23.1
        ...
        tVar.a(new t.b() { // from class: com.kwad.components.ad.feed.b.m.24
        ...
        aVar.a(new ao(new ao.a() { // from class: com.kwad.components.ad.feed.b.m.25
    ...
    private void a(com.kwad.sdk.core.video.videoview.a aVar, final int i) {
        if (aVar != null) {
            ...
            bu();
            com.kwad.components.core.e.d.a.a(new a.C0150a(getContext()).P(this.mAdTemplate).b(this.mApkDownloadHelper).ao(2).aq(com.kwad.sdk.core.response.b.a.aU(this.mAdInfo)).a(new a.b() { // from class: com.kwad.components.ad.feed.b.m.17
                @Override // com.kwad.components.core.e.d.a.b
                public final void onAdClicked() {
                    m.this.aK(i);
                }
    ...
    public IAdLivePlayModule bg() {
        ...
        bj.postOnUiThread(new Runnable() { // from class: com.kwad.components.ad.feed.b.m.10
            @Override // java.lang.Runnable
            public final void run() {
                m.this.c(view2);
            }
    ...
    private void bh() {
        ...
        if (TextUtils.isEmpty(url)) {
            ...
            KSImageLoader.loadImage(this.ew, url, this.mAdTemplate, new DisplayImageOptionsCompat.Builder().setBlurRadius(50).build(), new SimpleImageLoadingListener() { // from class: com.kwad.components.ad.feed.b.m.14
    ...
    public void bs() {
        ...
        this.dS = new d.b() { // from class: com.kwad.components.ad.feed.b.m.5
            ...
            public final boolean b(final double d) {
                ...
                com.kwad.components.core.e.d.a.a(new a.C0150a(m.this.getContext()).P(m.this.mAdTemplate).b(m.this.mApkDownloadHelper).ao(2).am(false).ao(false).an(157).am(5).aq(true).a(new a.b() { // from class: com.kwad.components.ad.feed.b.m.5.1
                    @Override // com.kwad.components.core.e.d.a.b
                    public final void onAdClicked() {
    ...
    private void bw() {
        this.eD.registerLiveMessageListener(new AdLiveMessageListener() { // from class: com.kwad.components.ad.feed.b.m.11
        ...
        this.eD.registerLiveShopListener(new AdLiveShopListener() { // from class: com.kwad.components.ad.feed.b.m.13
    ...
    private com.kwad.sdk.core.webview.d.a.a getClickListener() {
        return new com.kwad.sdk.core.webview.d.a.a() { // from class: com.kwad.components.ad.feed.b.m.7
            ...
            public final void a(com.kwad.sdk.core.webview.d.b.a aVar) {
                ...
                com.kwad.components.core.e.d.a.a(new a.C0150a(m.this.getContext()).P(m.this.mAdTemplate).b(m.this.mApkDownloadHelper).am(m.a(m.this, aVar)).ao(i).an(aVar.jG).am(5).as(aVar.JC).aq(zAU).s(m.this.eF == null ? 0L : m.this.eF.getPlayDuration()).a(bVar).ao(true).a(new a.b() { // from class: com.kwad.components.ad.feed.b.m.7.1
                    @Override // com.kwad.components.core.e.d.a.b
                    public final void onAdClicked() {
                        if (m.this.XT != null) {
                            m.this.XT.onAdClicked();
    ...
    public a.b getCurrentVoiceItem() {
        if (this.eI == null) {
            this.eI = new a.b(new a.c() { // from class: com.kwad.components.ad.feed.b.m.9
    ...
    private af.a getOpenNewPageListener() {
        return new af.a() { // from class: com.kwad.components.ad.feed.b.m.6
            @Override // com.kwad.components.core.webview.jshandler.af.a
            public final void a(com.kwad.components.core.webview.a.b bVar) {
                AdWebViewActivityProxy.launch(m.this.mContext, new AdWebViewActivityProxy.a.C0160a().aq(bVar.title).ar(bVar.url).ay(true).S(m.this.mAdTemplate).oA());
            }
        };
    }

    private an.c getRegisterLiveListener() {
        return new an.c() { // from class: com.kwad.components.ad.feed.b.m.2
    ...
    private a.b getVideoPlayCallback() {
        return new a.b() { // from class: com.kwad.components.ad.feed.b.m.15
            ...
            public final void onVideoPlayStart() {
                ...
                if (m.this.fC == null && com.kwad.sdk.core.response.b.b.bs(m.this.mAdTemplate) && m.this.fE) {
                    ...
                    m.this.fC.setOnViewEventListener(new com.kwad.sdk.widget.c() { // from class: com.kwad.components.ad.feed.b.m.15.1
                    ...
                    m.this.fC.a(new AnimatorListenerAdapter() { // from class: com.kwad.components.ad.feed.b.m.15.2
    ...
    private KsAdWebView.d getWebListener() {
        return new KsAdWebView.d() { // from class: com.kwad.components.ad.feed.b.m.19
    ...
    public void u(final int i) {
        bu();
        com.kwad.components.core.e.d.a.a(new a.C0150a(getContext()).P(this.mAdTemplate).b(this.mApkDownloadHelper).ao(1).am(true).an(i).am(5).ao(false).aq(true).a(new a.b() { // from class: com.kwad.components.ad.feed.b.m.16
            @Override // com.kwad.components.core.e.d.a.b
            public final void onAdClicked() {
                m.this.aK(i);
            }
