...
public final class e {
    ...
    static class AnonymousClass2 extends com.kwad.components.core.p.c {
    ...
    public static void a(KsScene ksScene, final KsLoadManager.FeedAdListener feedAdListener, boolean z) {
        ...
        KsAdLoadManager.M();
        KsAdLoadManager.a(new a.C0159a().e(new com.kwad.components.core.p.a.b(sceneImplCovert)).aF(zA).a(new AnonymousClass2(feedAdListener, sceneImplCovert, z, jElapsedRealtime)).pI());
    }
}
