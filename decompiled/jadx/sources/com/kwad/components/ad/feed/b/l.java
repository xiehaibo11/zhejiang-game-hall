...
public final class l extends a implements View.OnClickListener, com.kwad.sdk.widget.c {
    ...
    private void c(View view, final int i) {
        if (view == this.em) {
            ...
            com.kwad.components.core.e.d.a.a(new a.C0150a(getContext()).P(this.mAdTemplate).am(5).an(i).b(this.mApkDownloadHelper).ao(view == this.er ? 1 : 2).am(view == this.er).a(new a.b() { // from class: com.kwad.components.ad.feed.b.l.1
