                            ...
                            if (TextUtils.isEmpty(strF)) {
                                ...
                                if (adInfo.adPreloadInfo.preloadType != 1 || ag.isWifiConnected(KsAdSDKImpl.get().getContext()) || z) {
                                    ...
                                    if (j.a(strF, strAS, c0212a)) {
                                        ...
                                        com.kwad.components.ad.splashscreen.monitor.a.kN();
                                        com.kwad.components.ad.splashscreen.monitor.a.a(adInfo, 4, c0212a.msg, next.posId);
                                        com.kwad.components.core.o.a.pA().c(next, 1, c0212a.msg);
                                    }
                                } else {
                                    com.kwad.components.ad.splashscreen.monitor.a.kN();
