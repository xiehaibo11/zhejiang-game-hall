...
public abstract class a extends LinearLayout {
    ...
    private void mc() {
        ...
        if (valueAnimator == null || !valueAnimator.isRunning()) {
            ...
            this.iI.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.kwad.components.ad.widget.tailframe.appbar.a.2
    ...
    public void b(AdTemplate adTemplate) {
        ...
        if (d.s(adTemplate)) {
            ...
            if (!adTemplate.mRewardVerifyCalled) {
                if (this.yB == null) {
                    this.yB = new Runnable() { // from class: com.kwad.components.ad.widget.tailframe.appbar.a.1
