...
public final class c extends com.kwad.sdk.mvp.a {
    ...
    public List<InterfaceC0110c> jq = new ArrayList();

    /* JADX INFO: renamed from: com.kwad.components.ad.interstitial.d.c$4, reason: invalid class name */
        ...
        public final void onLoadingComplete(String str, View view, final DecodedResult decodedResult) {
            com.kwad.sdk.utils.g.execute(new Runnable() { // from class: com.kwad.components.ad.interstitial.d.c.4.1
                ...
                public final void run() {
                    ...
                    final RoundedBitmapDrawable roundedBitmapDrawableCreate = RoundedBitmapDrawableFactory.create(AnonymousClass4.this.jz.getResources(), bitmapStackBlur);
                    ...
                    AnonymousClass4.this.eX.post(new Runnable() { // from class: com.kwad.components.ad.interstitial.d.c.4.1.1
                        @Override // java.lang.Runnable
                        public final void run() {
                            AnonymousClass4.this.eX.setBackground(roundedBitmapDrawableCreate);
                        }
                    });
                }
            });
    ...
    /* JADX INFO: renamed from: com.kwad.components.ad.interstitial.d.c$c, reason: collision with other inner class name */
    ...
    public final void a(final Context context, final int i, int i2, int i3) {
        final int i4 = 9;
        com.kwad.components.core.e.d.a.a(new a.C0150a(context).P(this.mAdTemplate).b(this.mApkDownloadHelper).am(false).ao(2).am(6).an(i).a(new a.b() { // from class: com.kwad.components.ad.interstitial.d.c.3
    ...
    public final void a(final b bVar) {
        boolean z = bVar.cV() == 1;
        if ((com.kwad.components.ad.interstitial.a.b.cD() || z || bVar.cX() || bVar.jK) && com.kwad.components.core.e.d.a.a(new a.C0150a(bVar.getContext()).P(this.mAdTemplate).b(this.mApkDownloadHelper).am(z).am(1).an(bVar.jG).ao(bVar.cV()).a(new a.b() { // from class: com.kwad.components.ad.interstitial.d.c.1
            @Override // com.kwad.components.core.e.d.a.b
            public final void onAdClicked() {
                c.this.b(bVar);
            }
    ...
    public final void cR() {
        Iterator<InterfaceC0110c> it = this.jq.iterator();
        while (it.hasNext()) {
            it.next().da();
        }
    }
