...
public final class e extends b implements bn.a {
    ...
    private c.a jl = new c.a() { // from class: com.kwad.components.ad.interstitial.d.e.1
    ...
    private HorizontalSwipeLayout.a kF = new HorizontalSwipeLayout.a() { // from class: com.kwad.components.ad.interstitial.d.e.4
    ...
    /* JADX INFO: renamed from: com.kwad.components.ad.interstitial.d.e$3, reason: invalid class name */
    ...
    private void initContentView() {
        ...
        this.kp.setTranslationX(com.kwad.sdk.d.a.a.a(this.mContext, 140.0f));
        this.kq.setVisibility(8);
        this.kv.setOnClickListener(new View.OnClickListener() { // from class: com.kwad.components.ad.interstitial.d.e.2
