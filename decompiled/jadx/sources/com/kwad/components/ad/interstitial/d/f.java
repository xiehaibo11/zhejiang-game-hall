...
public final class f extends b {
    ...
    private com.kwad.sdk.core.h.d kL = new com.kwad.sdk.core.h.d() { // from class: com.kwad.components.ad.interstitial.d.f.4
    ...
    public void dG() {
        ...
        if (com.kwad.sdk.core.response.b.a.aV(this.mAdInfo)) {
            ...
            fVar.t(true);
            this.jf.jq.add(new c.InterfaceC0110c() { // from class: com.kwad.components.ad.interstitial.d.f.6
