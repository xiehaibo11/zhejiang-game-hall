...
public final class a {
    ...
    private static Animator a(final View view, float f, final float f2, long j) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.kwad.components.ad.i.a.3
    ...
    private static Animator a(final View view, View view2, int i, int i2, long j, long j2) {
        ...
        animatorA.addListener(new com.kwad.components.ad.widget.tailframe.appbar.b() { // from class: com.kwad.components.ad.i.a.2
    ...
    public final void ia() {
        ...
        if (this.gX == null) {
            ...
            this.gX = animatorA;
            animatorA.addListener(new com.kwad.components.ad.widget.tailframe.appbar.b() { // from class: com.kwad.components.ad.i.a.1
                @Override // com.kwad.components.ad.widget.tailframe.appbar.b, android.animation.Animator.AnimatorListener
                public final void onAnimationEnd(final Animator animator) {
                    ...
                    if (a.this.GB == null) {
                        a.this.GB = new Runnable() { // from class: com.kwad.components.ad.i.a.1.1
