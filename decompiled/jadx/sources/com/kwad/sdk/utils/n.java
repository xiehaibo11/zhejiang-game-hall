...
public final class n {
    ...
    static class a extends com.kwad.sdk.k.a.a {
        ...
        private void HW() {
            ...
            this.aGk.add(new com.kwad.sdk.k.a.a(this.enabled) { // from class: com.kwad.sdk.utils.n.a.1
            ...
            this.aGk.add(new com.kwad.sdk.k.a.a(this.enabled) { // from class: com.kwad.sdk.utils.n.a.2
                @Override // com.kwad.sdk.k.a.a
                public final boolean bB(Context context) {
    ...
    static class d extends com.kwad.sdk.k.a.a {
        ...
        private void HW() {
            this.aGk = new ArrayList();
            this.aGk.add(new com.kwad.sdk.k.a.a(this.enabled) { // from class: com.kwad.sdk.utils.n.d.1
                @Override // com.kwad.sdk.k.a.a
                public final boolean bB(Context context) {
                    return new File("/system/app/Superuser.apk").exists();
                }
            });
            this.aGk.add(new com.kwad.sdk.k.a.a(this.enabled) { // from class: com.kwad.sdk.utils.n.d.2
                @Override // com.kwad.sdk.k.a.a
                public final boolean bB(Context context) {
            ...
            this.aGk.add(new com.kwad.sdk.k.a.a(this.enabled) { // from class: com.kwad.sdk.utils.n.d.3
                @Override // com.kwad.sdk.k.a.a
                public final boolean bB(Context context) {
                    return !TextUtils.isEmpty(n.g(new String[]{"/system/xbin/which", "su"}));
                }
            });
            this.aGk.add(new com.kwad.sdk.k.a.a(this.enabled) { // from class: com.kwad.sdk.utils.n.d.4
                @Override // com.kwad.sdk.k.a.a
                public final boolean bB(Context context) {
    ...
    static class e extends com.kwad.sdk.k.a.a {
        ...
        private void HW() {
            this.aGk = new ArrayList();
            this.aGk.add(new com.kwad.sdk.k.a.a(this.enabled) { // from class: com.kwad.sdk.utils.n.e.1
                @Override // com.kwad.sdk.k.a.a
                public final boolean bB(Context context) {
                    return ak.ak(context, "de.robv.android.xposed.installer") || ak.ak(context, "com.saurik.substrate");
                }
            });
            this.aGk.add(new com.kwad.sdk.k.a.a(this.enabled) { // from class: com.kwad.sdk.utils.n.e.2
                @Override // com.kwad.sdk.k.a.a
                public final boolean bB(Context context) {
                    try {
            ...
            this.aGk.add(new com.kwad.sdk.k.a.a(this.enabled) { // from class: com.kwad.sdk.utils.n.e.3
                @Override // com.kwad.sdk.k.a.a
