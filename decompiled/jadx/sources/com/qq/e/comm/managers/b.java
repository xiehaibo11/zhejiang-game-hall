...
public class b implements IGDTAdManager {
    ...
    private static final class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static b f4681a = new b(null);
    }

    private b() {
        this.f4680a = Boolean.FALSE;
        this.b = false;
    }
    ...
    public boolean d() {
        if (this.f4680a != null && this.f4680a.booleanValue()) {
            return true;
        }
