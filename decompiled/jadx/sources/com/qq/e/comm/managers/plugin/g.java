...
class g {
    ...
    boolean a() {
        int i;
        try {
            if (this.b.exists() && this.f4690a.exists()) {
                ...
                if (strArrSplit.length == 2) {
                    ...
                    if (c.b.f4688a.a(str, this.f4690a)) {
                        this.c = str;
                        this.d = i;
                        return true;
                    }
    ...
    boolean a(File file, File file2) {
        return (file.equals(this.f4690a) || h.a(this.f4690a, file)) && (file2.equals(this.b) || h.a(this.b, file2));
    }
