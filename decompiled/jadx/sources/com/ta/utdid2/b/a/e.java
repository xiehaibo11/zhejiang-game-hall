...
class e {
    ...
    public static final void a(byte[] bArr, String str, XmlSerializer xmlSerializer) throws XmlPullParserException, IOException {
        ...
        xmlSerializer.attribute(null, l.d, Integer.toString(bArr.length));
    ...
    public static final void a(int[] iArr, String str, XmlSerializer xmlSerializer) throws XmlPullParserException, IOException {
        ...
        xmlSerializer.attribute(null, l.d, Integer.toString(iArr.length));
        for (int i : iArr) {
    ...
    public static final void a(Object obj, String str, XmlSerializer xmlSerializer) throws XmlPullParserException, IOException {
        ...
        if (obj instanceof String) {
            xmlSerializer.startTag(null, i.g);
            if (str != null) {
                xmlSerializer.attribute(null, "name", str);
            }
            xmlSerializer.text(obj.toString());
            xmlSerializer.endTag(null, i.g);
            return;
        }
        ...
        if (!name.equals("null")) {
            if (name.equals(i.g)) {
                ...
                while (true) {
                    ...
                    if (next2 == 3) {
                        if (xmlPullParser.getName().equals(i.g)) {
                ...
                if (name.equals("int-array")) {
                    xmlPullParser.next();
                    int[] iArrM35a = m35a(xmlPullParser, "int-array", strArr);
                    strArr[0] = attributeValue;
                    return iArrM35a;
                }
                if (name.equals("map")) {
                    xmlPullParser.next();
                    HashMap mapM34a = m34a(xmlPullParser, "map", strArr);
                    strArr[0] = attributeValue;
                    return mapM34a;
                }
                if (name.equals("list")) {
