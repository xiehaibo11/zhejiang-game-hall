...
class a implements XmlSerializer {
    ...
    private static final String[] f5290a = {null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, "&quot;", null, null, null, "&amp;", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, "&lt;", null, "&gt;", null};
    ...
    /* JADX INFO: renamed from: a, reason: collision with other field name */
    private CharsetEncoder f7a;
    private boolean b;
    private int mPos;

    /* JADX INFO: renamed from: a, reason: collision with other field name */
    private final char[] f8a = new char[8192];

    /* JADX INFO: renamed from: a, reason: collision with other field name */
    private ByteBuffer f6a = ByteBuffer.allocate(8192);
    ...
    private void a(String str, int i, int i2) throws IOException {
        ...
        str.getChars(i, i + i2, this.f8a, i5);
        this.mPos = i5 + i2;
    }
    ...
    private void append(char[] cArr, int i, int i2) throws IOException {
        ...
        System.arraycopy(cArr, i, this.f8a, i5, i2);
        this.mPos = i5 + i2;
    }
    ...
    private void a() throws IOException {
        int iPosition = this.f6a.position();
        if (iPosition > 0) {
            this.f6a.flip();
            this.f4a.write(this.f6a.array(), 0, iPosition);
            this.f6a.clear();
        }
    }
    ...
    public void flush() throws IOException {
        ...
        if (i > 0) {
            if (this.f4a != null) {
                CharBuffer charBufferWrap = CharBuffer.wrap(this.f8a, 0, i);
                CoderResult coderResultEncode = this.f7a.encode(charBufferWrap, this.f6a, true);
                while (!coderResultEncode.isError()) {
                    if (coderResultEncode.isOverflow()) {
                        a();
                        coderResultEncode = this.f7a.encode(charBufferWrap, this.f6a, true);
                    } else {
                        a();
                        this.f4a.flush();
                    }
    ...
    public void setOutput(OutputStream outputStream, String str) throws IllegalStateException, IOException, IllegalArgumentException {
        ...
        try {
            this.f7a = Charset.forName(str).newEncoder();
