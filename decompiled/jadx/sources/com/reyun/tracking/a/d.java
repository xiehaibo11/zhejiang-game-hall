...
class d implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (System.currentTimeMillis() - this.e >= 3000) {
            try {
                if (Math.abs(sensorEvent.values[0]) + Math.abs(sensorEvent.values[1]) + Math.abs(sensorEvent.values[2]) < 0.004f || (sensorEvent.values[0] == this.f4699a && sensorEvent.values[1] == this.b && sensorEvent.values[2] == this.c)) {
                    this.g.a(0);
                } else {
                    this.g.a(1);
                }
        ...
        this.f4699a = sensorEvent.values[0];
