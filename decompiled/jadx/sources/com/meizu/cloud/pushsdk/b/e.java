...
class e {
    ...
    private final SimpleDateFormat f4505a = new SimpleDateFormat("yyyy-MM-dd");
    ...
    void a(File file) {
        File[] fileArrListFiles = file.listFiles(new FileFilter() { // from class: com.meizu.cloud.pushsdk.b.e.1
    ...
    public void a(String str) throws IOException {
        ...
        String str2 = this.f4505a.format(new Date());
