...
public class e extends a<MessageV3> {
    ...
    public void b(MessageV3 messageV3) {
        ...
        String strB = b(messageV3.getThroughMessage());
        if (TextUtils.isEmpty(strB)) {
            ...
            com.meizu.cloud.pushsdk.util.d.c(d(), strB, messageV3.getDeviceId(), messageV3.getTaskId(), messageV3.getSeqId(), messageV3.getPushTimestamp());
        }
    }
