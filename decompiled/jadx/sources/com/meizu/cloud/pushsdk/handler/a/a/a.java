...
public class a {
    ...
    private void b(int i) {
        ...
        com.meizu.cloud.pushsdk.b.a.a aVar2 = new com.meizu.cloud.pushsdk.b.a.a(this.f4599a, new Runnable() { // from class: com.meizu.cloud.pushsdk.handler.a.a.a.1
    ...
    public void a() {
        ...
        try {
            ((NotificationManager) this.f4599a.getSystemService(RemoteMessageConst.NOTIFICATION)).notify(this.c, this.d);
