...
public class g implements Parcelable {
    ...
    public g(String str, String str2, String str3, String str4) {
        ...
        try {
            ...
            if (!jSONObject.isNull("max_size")) {
                this.f4610a = jSONObject.getInt("max_size");
            }
    ...
    public String toString() {
        return "UploadLogMessage{maxSize=" + this.f4610a + ", wifiUpload=" + this.b + ", fileList=" + this.c + ", controlMessage=" + this.d + ", uploadMessage='" + this.e + "'}";
    }
