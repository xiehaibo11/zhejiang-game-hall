...
public class c {
    ...
    public static int c(Context context) {
        ...
        if (flymeVersion > 0 && flymeVersion <= 6) {
            ...
            str = ("2.0".equals(strValueOf) || "3.0".equals(strValueOf) || "4.0".equals(strValueOf) || "6.0".equals(strValueOf)) ? "push_pure_pic_notification_f9" : "3.3".equals(strValueOf) ? "push_pure_pic_notification_f9_337" : "push_pure_pic_notification_f9_275";
        }
        return dVarA.a(context, str, "layout");
    }
    ...
    public static int l(Context context) {
        return d.a(context).a(context, "stat_sys_third_app_notify", i.c);
    }
