...
public class NotificationService extends IntentService {
    ...
    public void a(Intent intent) {
        ...
        try {
            ...
            com.meizu.cloud.pushsdk.b.b.d dVarA = com.meizu.cloud.pushsdk.b.b.a.a(strA).a((Class<?>[]) null).a((Object[]) null);
            if (!dVarA.f4494a || dVarA.b == 0) {
                return;
            }
            DebugLogger.i("NotificationService", "Reflect MzPushReceiver true");
            com.meizu.cloud.pushsdk.b.b.a.a(dVarA.b).a("onReceive", Context.class, Intent.class).a(dVarA.b, getApplicationContext(), intent);
        } catch (Exception e) {
