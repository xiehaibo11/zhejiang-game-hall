...
public class a extends c {
    ...
    protected boolean a() {
        ...
        if (iArr == null || iArr.length <= 0 || i != 1) {
            return this.i == 2 && !TextUtils.isEmpty(this.j);
        }
        return true;
    }
    ...
    protected BasicPushStatus e() {
        ...
        if (i == 0) {
            if (!MinSdkChecker.isSupportSetDrawableSmallIcon()) {
                ...
                com.meizu.cloud.pushsdk.notification.c.b.a(this.f4636a);
            }
            com.meizu.cloud.pushsdk.notification.c.b.a(this.f4636a, this.d);
            return null;
        }
        if (i != 1) {
            if (i != 2) {
            ...
            com.meizu.cloud.pushsdk.notification.c.b.a(this.f4636a, this.d, this.j);
            return null;
        }
        int[] iArr = this.h;
        if (iArr == null) {
        ...
        for (int i2 : iArr) {
            ...
            com.meizu.cloud.pushsdk.notification.c.b.a(this.f4636a, this.d, i2);
        }
        return null;
    }
