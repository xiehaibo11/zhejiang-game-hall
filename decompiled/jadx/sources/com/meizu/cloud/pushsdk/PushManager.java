...
public class PushManager {
    ...
    public static void checkNotificationMessage(Context context) {
        ...
        DebugLogger.i("4.1.4", context.getPackageName() + " checkNotificationMessage cloudVersion_name " + appVersionName);
        ...
        try {
            ...
            DebugLogger.e("4.1.4", "start check notification message service error " + e.getMessage());
        }
    }
    ...
    public static void checkPush(Context context, String str, String str2, String str3) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            ...
            DebugLogger.e("4.1.4", "please invoke checkPush on meizu device Build-in FlymeOS");
        }
    }
    ...
    public static void checkSubScribeAlias(Context context, String str, String str2, String str3) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            ...
            DebugLogger.e("4.1.4", "please invoke checkSubScribeAlias on meizu device Build-in FlymeOS");
        }
    }
    ...
    public static void checkSubScribeTags(Context context, String str, String str2, String str3) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            ...
            DebugLogger.e("4.1.4", "please invoke checkSubScribeTags on meizu device Build-in FlymeOS");
        }
    }
    ...
    public static void register(Context context) {
        ...
        if (!MzSystemUtils.isBrandMeizu(context)) {
            DebugLogger.e("4.1.4", "please invoke register on meizu device Build-in FlymeOS");
            return;
        }
        String packageName = "com.meizu.cloud";
        String appVersionName = MzSystemUtils.getAppVersionName(context, "com.meizu.cloud");
        DebugLogger.i("4.1.4", context.getPackageName() + " start register cloudVersion_name " + appVersionName);
        ...
        if ("com.meizu.cloud".equals(MzSystemUtils.getMzPushServicePackageName(context))) {
            ...
            if (!TextUtils.isEmpty(appVersionName) && MzSystemUtils.compareVersion(appVersionName, PushConstants.PUSH_FLYME_4_CHANGE_VERSION)) {
                DebugLogger.e("4.1.4", "flyme 4.x start register cloud versionName " + appVersionName);
            } else if (TextUtils.isEmpty(appVersionName) || !appVersionName.startsWith("3")) {
                DebugLogger.e("4.1.4", context.getPackageName() + " start register ");
                packageName = context.getPackageName();
                intent.setClassName(packageName, PushConstants.MZ_PUSH_SERVICE_NAME);
            } else {
                DebugLogger.e("4.1.4", "flyme 3.x start register cloud versionName " + appVersionName);
        ...
        try {
            ...
            DebugLogger.e("4.1.4", "start register service error " + e.getMessage());
        }
    }
    ...
    public static void subScribeAlias(Context context, String str, String str2, String str3, String str4) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            ...
            DebugLogger.e("4.1.4", "please invoke subScribeAlias on meizu device Build-in FlymeOS");
        }
    }
    ...
    public static void subScribeTags(Context context, String str, String str2, String str3, String str4) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            ...
            DebugLogger.e("4.1.4", "please invoke subScribeTags on meizu device Build-in FlymeOS");
        }
    }
    ...
    public static void switchPush(Context context, String str, String str2, String str3, int i, boolean z) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            ...
            DebugLogger.e("4.1.4", "please invoke switchPush on meizu device Build-in FlymeOS");
        }
    }
    ...
    public static void unRegister(Context context) {
        if (!MzSystemUtils.isBrandMeizu(context)) {
            DebugLogger.e("4.1.4", "please invoke unRegister on meizu device Build-in FlymeOS");
            return;
        }
        String packageName = "com.meizu.cloud";
        String appVersionName = MzSystemUtils.getAppVersionName(context, "com.meizu.cloud");
        DebugLogger.e("4.1.4", context.getPackageName() + " start unRegister cloud versionName " + appVersionName);
        ...
        if ("com.meizu.cloud".equals(MzSystemUtils.getMzPushServicePackageName(context))) {
            ...
            if (TextUtils.isEmpty(appVersionName) || !MzSystemUtils.compareVersion(appVersionName, PushConstants.PUSH_FLYME_4_CHANGE_VERSION)) {
                if (TextUtils.isEmpty(appVersionName) || !appVersionName.startsWith("3")) {
                    DebugLogger.e("4.1.4", context.getPackageName() + " start unRegister ");
                    packageName = context.getPackageName();
                    intent.setClassName(packageName, PushConstants.MZ_PUSH_SERVICE_NAME);
                } else {
        ...
        try {
            ...
            DebugLogger.e("4.1.4", "start unRegister service error " + e.getMessage());
        }
    }
    ...
    public static void unSubScribeAlias(Context context, String str, String str2, String str3, String str4) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            ...
            DebugLogger.e("4.1.4", "please invoke unSubScribeAlias on meizu device Build-in FlymeOS");
        }
    }
    ...
    public static void unSubScribeAllTags(Context context, String str, String str2, String str3) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            ...
            DebugLogger.e("4.1.4", "please invoke unSubScribeAllTags on meizu device Build-in FlymeOS");
        }
    }
    ...
    public static void unSubScribeTags(Context context, String str, String str2, String str3, String str4) {
        if (MzSystemUtils.isBrandMeizu(context)) {
            ...
            DebugLogger.e("4.1.4", "please invoke unSubScribeTags on meizu device Build-in FlymeOS");
        }
    }
}
