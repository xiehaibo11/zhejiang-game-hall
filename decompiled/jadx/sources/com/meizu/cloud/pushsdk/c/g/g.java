...
public final class g {
    ...
    private static final Logger f4554a = Logger.getLogger(g.class.getName());
            ...
            return new l() { // from class: com.meizu.cloud.pushsdk.c.g.g.1
                ...
                public void a(b bVar, long j) throws IOException {
                    ...
                    while (j > 0) {
                        ...
                        outputStream.write(jVar.f4560a, jVar.b, iMin);
                        jVar.b += iMin;
                        long j2 = iMin;
                        j -= j2;
                        bVar.b -= j2;
        ...
        if (nVar != null) {
            return new m() { // from class: com.meizu.cloud.pushsdk.c.g.g.2
                ...
                public long b(b bVar, long j) throws IOException {
                    ...
                    nVar.a();
                    j jVarC = bVar.c(1);
                    int i = inputStream.read(jVarC.f4560a, jVarC.c, (int) Math.min(j, 2048 - jVarC.c));
                    if (i == -1) {
                        return -1L;
                    }
                    jVarC.c += i;
