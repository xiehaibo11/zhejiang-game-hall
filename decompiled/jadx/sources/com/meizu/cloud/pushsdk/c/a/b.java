...
public class b<T extends b> {
    ...
    private static final String f4513a = b.class.getSimpleName();
    ...
    /* JADX INFO: renamed from: com.meizu.cloud.pushsdk.c.a.b$2, reason: invalid class name */
    /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            try {
                f4515a[e.JSON_OBJECT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f4515a[e.STRING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f4515a[e.BITMAP.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f4515a[e.PREFETCH.ordinal()] = 5;
    ...
    public class a<T extends a> {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private com.meizu.cloud.pushsdk.c.a.d f4516a = com.meizu.cloud.pushsdk.c.a.d.MEDIUM;
    ...
    /* JADX INFO: renamed from: com.meizu.cloud.pushsdk.c.a.b$b, reason: collision with other inner class name */
    public class C0318b<T extends C0318b> {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private com.meizu.cloud.pushsdk.c.a.d f4517a = com.meizu.cloud.pushsdk.c.a.d.MEDIUM;
    ...
    public class c<T extends c> {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private com.meizu.cloud.pushsdk.c.a.d f4518a = com.meizu.cloud.pushsdk.c.a.d.MEDIUM;
        private final HashMap<String, String> d = new HashMap<>();
        private final HashMap<String, String> e = new HashMap<>();
        private final HashMap<String, String> f = new HashMap<>();
    ...
    public class d<T extends d> {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private com.meizu.cloud.pushsdk.c.a.d f4519a = com.meizu.cloud.pushsdk.c.a.d.MEDIUM;
    ...
    public com.meizu.cloud.pushsdk.c.a.c a(k kVar) {
        com.meizu.cloud.pushsdk.c.a.c<Bitmap> cVarA;
        int i = AnonymousClass2.f4515a[this.h.ordinal()];
        if (i == 1) {
            try {
        ...
        synchronized (z) {
            try {
                try {
                    cVarA = com.meizu.cloud.pushsdk.c.h.b.a(kVar, this.G, this.H, this.F, this.I);
                } catch (Throwable th) {
                    throw th;
                }
            } catch (Exception e4) {
    ...
    public String e() {
        ...
        f.a aVarF = f.c(strReplace).f();
        for (Map.Entry<String, String> entry2 : this.m.entrySet()) {
            aVarF.a(entry2.getKey(), entry2.getValue());
        }
        return aVarF.b().toString();
    }
    ...
    public j n() {
        h.a aVarA = new h.a().a(h.e);
        try {
            for (Map.Entry<String, String> entry : this.l.entrySet()) {
                aVarA.a(com.meizu.cloud.pushsdk.c.c.c.a("Content-Disposition", "form-data; name=\"" + entry.getKey() + "\""), j.a((g) null, entry.getValue()));
            }
            for (Map.Entry<String, File> entry2 : this.o.entrySet()) {
                if (entry2.getValue() != null) {
                    String name = entry2.getValue().getName();
                    aVarA.a(com.meizu.cloud.pushsdk.c.c.c.a("Content-Disposition", "form-data; name=\"" + entry2.getKey() + "\"; filename=\"" + name + "\""), j.a(g.a(com.meizu.cloud.pushsdk.c.h.b.a(name)), entry2.getValue()));
                    if (this.y != null) {
                        aVarA.a(this.y);
                    }
                }
