...
public class b extends SQLiteOpenHelper {
    ...
    private static final String f4585a = b.class.getName();
    private static b b;
    ...
    public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        com.meizu.cloud.pushsdk.d.f.c.b(f4585a, "Upgrading database from version " + i + " to " + i2 + ". Destroying old data now..", new Object[0]);
