...
public class a {
    ...
    private static com.meizu.cloud.pushsdk.d.e.a f4564a;
    ...
    public static com.meizu.cloud.pushsdk.d.e.a a(Context context, boolean z) {
        if (f4564a == null) {
            synchronized (a.class) {
                if (f4564a == null) {
                    f4564a = a(b(context, null, null), (c) null, context);
                }
            }
        }
    ...
    private static com.meizu.cloud.pushsdk.d.e.a a(com.meizu.cloud.pushsdk.d.b.a aVar, c cVar, Context context) {
        return new com.meizu.cloud.pushsdk.d.e.a.a(new a.C0323a(aVar, "PushAndroidTracker", context.getPackageCodePath(), context, com.meizu.cloud.pushsdk.d.e.a.a.class).a(b.VERBOSE).a((Boolean) false).a(cVar).a(4));
    }
    ...
    private static com.meizu.cloud.pushsdk.d.b.a b(Context context, com.meizu.cloud.pushsdk.c.c.a aVar, f fVar) {
        return new com.meizu.cloud.pushsdk.d.b.a.a(new a.C0320a(a(), context, com.meizu.cloud.pushsdk.d.b.a.a.class).a(fVar).a(aVar).a(1).a(com.meizu.cloud.pushsdk.d.b.b.DefaultGroup).b(com.meizu.cloud.pushsdk.d.b.b.DefaultGroup.a()).c(2));
    }
}
