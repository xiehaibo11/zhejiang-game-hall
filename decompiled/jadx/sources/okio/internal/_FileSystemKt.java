...
public final class _FileSystemKt {
    ...
    static final class C05991 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        C05991(Path path, FileSystem fileSystem, boolean z, Continuation<? super C05991> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05991 c05991 = new C05991(this.$dir, this.$this_commonListRecursively, this.$followSymlinks, continuation);
            c05991.L$0 = obj;
            return c05991;
        }
        ...
        public final Object invoke(SequenceScope<? super Path> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C05991) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            while (it.hasNext()) {
                Path next = it.next();
                c05991.L$0 = sequenceScope;
                c05991.L$1 = arrayDeque;
                c05991.L$2 = it;
                c05991.label = 1;
                if (_FileSystemKt.collectRecursively(sequenceScope, c05991.$this_commonListRecursively, arrayDeque, next, c05991.$followSymlinks, false, c05991) == coroutine_suspended) {
    ...
    public static final Sequence<Path> commonListRecursively(FileSystem fileSystem, Path dir, boolean z) throws IOException {
        Intrinsics.checkNotNullParameter(fileSystem, "<this>");
        Intrinsics.checkNotNullParameter(dir, "dir");
        return SequencesKt.sequence(new C05991(dir, fileSystem, z, null));
    }
