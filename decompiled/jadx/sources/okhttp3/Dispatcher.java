...
public final class Dispatcher {
    ...
    private final ArrayDeque<okhttp3.internal.connection.RealCall> runningSyncCalls;
    ...
    public final synchronized void cancelAll() {
        ...
        Iterator<okhttp3.internal.connection.RealCall> it3 = this.runningSyncCalls.iterator();
        while (it3.hasNext()) {
            it3.next().cancel();
        }
    }
    ...
    public final synchronized List<Call> runningCalls() {
        List<Call> listUnmodifiableList;
        ArrayDeque<okhttp3.internal.connection.RealCall> arrayDeque = this.runningSyncCalls;
    ...
    public final ExecutorService m2171deprecated_executorService() {
        return executorService();
    }
