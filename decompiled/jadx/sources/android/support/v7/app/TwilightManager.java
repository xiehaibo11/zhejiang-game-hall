...
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        Location lastKnownLocationForProvider = PermissionChecker.checkSelfPermission(this.mContext, g.h) == 0 ? getLastKnownLocationForProvider(PointCategory.NETWORK) : null;
