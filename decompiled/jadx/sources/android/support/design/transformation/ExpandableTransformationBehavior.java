...
public abstract class ExpandableTransformationBehavior extends ExpandableBehavior {
    ...
    protected boolean onExpandedStateChange(View view, View view2, boolean z, boolean z2) {
        ...
        animatorSetOnCreateExpandedStateChangeAnimation.addListener(new AnimatorListenerAdapter() { // from class: android.support.design.transformation.ExpandableTransformationBehavior.1
