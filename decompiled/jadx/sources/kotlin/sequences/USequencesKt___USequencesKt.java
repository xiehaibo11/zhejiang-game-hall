...
class USequencesKt___USequencesKt {
    public static final int sumOfUInt(Sequence<UInt> sequence) {
        ...
        int iM809constructorimpl = 0;
        while (it.hasNext()) {
            iM809constructorimpl = UInt.m809constructorimpl(iM809constructorimpl + it.next().getData());
        }
        return iM809constructorimpl;
    }

    public static final long sumOfULong(Sequence<ULong> sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        Iterator<ULong> it = sequence.iterator();
        long jM887constructorimpl = 0;
        while (it.hasNext()) {
            jM887constructorimpl = ULong.m887constructorimpl(jM887constructorimpl + it.next().getData());
        }
        return jM887constructorimpl;
    }
    ...
    public static final int sumOfUByte(Sequence<UByte> sequence) {
        ...
        int iM809constructorimpl = 0;
        while (it.hasNext()) {
            iM809constructorimpl = UInt.m809constructorimpl(iM809constructorimpl + UInt.m809constructorimpl(it.next().getData() & UByte.MAX_VALUE));
        }
        return iM809constructorimpl;
    }
    ...
    public static final int sumOfUShort(Sequence<UShort> sequence) {
        ...
        int iM809constructorimpl = 0;
        while (it.hasNext()) {
            iM809constructorimpl = UInt.m809constructorimpl(iM809constructorimpl + UInt.m809constructorimpl(it.next().getData() & UShort.MAX_VALUE));
        }
        return iM809constructorimpl;
    }
}
