...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1902getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result) {
        synchronized (this) {
            this.result = Result.m714boximpl(result);
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> resultM1902getResultxLWZpok = m1902getResultxLWZpok();
                if (resultM1902getResultxLWZpok == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(resultM1902getResultxLWZpok.getValue());
                }
            }
        }
    }
