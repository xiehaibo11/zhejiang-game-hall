...
public final class DurationConversionsJDK8Kt {
    private static final long toKotlinDuration(Duration duration) {
        return kotlin.time.Duration.m2033plusLRDsOJo(kotlin.time.Duration.INSTANCE.m2121secondsUwyO8pc(duration.getSeconds()), kotlin.time.Duration.INSTANCE.m2113nanosecondsUwyO8pc(duration.getNano()));
    }

    /* JADX INFO: renamed from: toJavaDuration-LRDsOJo, reason: not valid java name */
    private static final Duration m2131toJavaDurationLRDsOJo(long j) {
        Duration durationOfSeconds = Duration.ofSeconds(kotlin.time.Duration.m2018getInWholeSecondsimpl(j), kotlin.time.Duration.m2020getNanosecondsComponentimpl(j));
