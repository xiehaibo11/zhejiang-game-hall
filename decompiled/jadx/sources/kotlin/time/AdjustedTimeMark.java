...
final class AdjustedTimeMark extends TimeMark {
    ...
    public long mo1990elapsedNowUwyO8pc() {
        return Duration.m2032minusLRDsOJo(this.mark.mo1990elapsedNowUwyO8pc(), getAdjustment());
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1991plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2033plusLRDsOJo(getAdjustment(), duration), null);
    }
}
