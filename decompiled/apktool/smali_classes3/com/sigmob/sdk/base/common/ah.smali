.class public Lcom/sigmob/sdk/base/common/ah;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/sigmob/sdk/base/common/ah$a;
    }
.end annotation
...
# instance fields
.field private final b:Lcom/sigmob/sdk/base/common/ah$a;


# direct methods
.method private constructor <init>(Lcom/sigmob/sdk/base/common/ah$a;)V
    .locals 0

    invoke-direct {p0}, Landroid/os/AsyncTask;-><init>()V

    iput-object p1, p0, Lcom/sigmob/sdk/base/common/ah;->b:Lcom/sigmob/sdk/base/common/ah$a;
...
.method public static a(Ljava/lang/String;Lcom/sigmob/sdk/base/common/ah$a;)V
    .locals 4

    new-instance v0, Lcom/sigmob/sdk/base/common/ah;

    invoke-direct {v0, p1}, Lcom/sigmob/sdk/base/common/ah;-><init>(Lcom/sigmob/sdk/base/common/ah$a;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/sigmob/sdk/base/common/ah;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {p1, v0, p0}, Lcom/sigmob/sdk/base/common/ah$a;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v1}, Lcom/sigmob/sdk/base/common/ah;->a(Ljava/lang/String;Ljava/net/HttpURLConnection;)Ljava/lang/String;
...
.method protected varargs a([Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lcom/sigmob/sdk/base/common/af;->a(Landroid/net/Uri;)Z
    ...
    :cond_1
    :try_start_2
    invoke-direct {p0, v0}, Lcom/sigmob/sdk/base/common/ah;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public a(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/sigmob/sdk/base/common/ah;->isCancelled()Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/sigmob/sdk/base/common/ah;->b:Lcom/sigmob/sdk/base/common/ah$a;

    invoke-interface {v0, p1}, Lcom/sigmob/sdk/base/common/ah$a;->a(Ljava/lang/String;)V

    goto :goto_1

    :cond_1
    :goto_0
    invoke-virtual {p0}, Lcom/sigmob/sdk/base/common/ah;->onCancelled()V
...
.method protected synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/sigmob/sdk/base/common/ah;->a([Ljava/lang/String;)Ljava/lang/String;
...
.method public onCancelled()V
    ...
    invoke-interface {v0, v1, v2}, Lcom/sigmob/sdk/base/common/ah$a;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/sigmob/sdk/base/common/ah;->a(Ljava/lang/String;)V
