...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/sigmob/sdk/base/views/e$a;
    }
.end annotation
...
# instance fields
.field private b:Lcom/sigmob/sdk/nativead/APKStatusBroadcastReceiver;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/sigmob/sdk/base/views/e;->f:Ljava/util/Map;

    invoke-virtual {p0}, Lcom/sigmob/sdk/base/views/e;->getSettings()Landroid/webkit/WebSettings;

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/sigmob/sdk/base/views/e;->a(Landroid/webkit/WebSettings;)V

    sget-boolean p1, Lcom/sigmob/sdk/base/views/e;->a:Z

    if-nez p1, :cond_0

    invoke-virtual {p0}, Lcom/sigmob/sdk/base/views/e;->getContext()Landroid/content/Context;

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/sigmob/sdk/base/views/e;->a(Landroid/content/Context;)V

    const/4 p1, 0x1

    sput-boolean p1, Lcom/sigmob/sdk/base/views/e;->a:Z

    :cond_0
    invoke-virtual {p0}, Lcom/sigmob/sdk/base/views/e;->resumeTimers()V

    return-void
.end method

.method static synthetic a(Lcom/sigmob/sdk/base/views/e;)Lcom/sigmob/sdk/base/common/m$a;
    .locals 0

    invoke-direct {p0}, Lcom/sigmob/sdk/base/views/e;->getListener()Lcom/sigmob/sdk/base/common/m$a;
...
.method private a(Landroid/webkit/WebSettings;)V
    ...
    :cond_3
    new-instance p1, Lcom/sigmob/sdk/base/views/e$a;

    invoke-direct {p1, p0}, Lcom/sigmob/sdk/base/views/e$a;-><init>(Lcom/sigmob/sdk/base/views/e;)V

    const-string v0, "sigandroidapk"

    invoke-virtual {p0, p1, v0}, Lcom/sigmob/sdk/base/views/e;->addJavascriptInterface(Ljava/lang/Object;Ljava/lang/String;)V
...
.method public static a(Landroid/webkit/WebView;)V
    ...
    invoke-virtual {v1}, Lcom/sigmob/sdk/base/c;->i()Z
...
.method static synthetic b(Lcom/sigmob/sdk/base/views/e;)Lcom/sigmob/sdk/base/models/BaseAdUnit;
    .locals 0

    iget-object p0, p0, Lcom/sigmob/sdk/base/views/e;->d:Lcom/sigmob/sdk/base/models/BaseAdUnit;
...
.method private getListener()Lcom/sigmob/sdk/base/common/m$a;
    .locals 1

    iget-object v0, p0, Lcom/sigmob/sdk/base/views/e;->c:Ljava/lang/ref/WeakReference;
    ...
    check-cast v0, Lcom/sigmob/sdk/base/common/m$a;
...
.method public a()V
    ...
    iget-object v0, p0, Lcom/sigmob/sdk/base/views/e;->d:Lcom/sigmob/sdk/base/models/BaseAdUnit;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/sigmob/sdk/base/views/e;->b:Lcom/sigmob/sdk/nativead/APKStatusBroadcastReceiver;
    ...
    iget-object v2, p0, Lcom/sigmob/sdk/base/views/e;->d:Lcom/sigmob/sdk/base/models/BaseAdUnit;
    ...
    iput-object v0, p0, Lcom/sigmob/sdk/base/views/e;->b:Lcom/sigmob/sdk/nativead/APKStatusBroadcastReceiver;
...
.method public a(Lcom/sigmob/sdk/base/common/m$a;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/sigmob/sdk/base/views/e;->c:Ljava/lang/ref/WeakReference;
...
.method a(Ljava/lang/String;Landroid/webkit/ValueCallback;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/sigmob/sdk/base/views/e;->evaluateJavascript(Ljava/lang/String;Landroid/webkit/ValueCallback;)V
    ...
    invoke-virtual {p0, p1}, Lcom/sigmob/sdk/base/views/e;->loadUrl(Ljava/lang/String;)V
...
.method public b()V
    ...
    new-instance v0, Lcom/sigmob/sdk/base/views/e$2;

    invoke-direct {v0, p0}, Lcom/sigmob/sdk/base/views/e$2;-><init>(Lcom/sigmob/sdk/base/views/e;)V

    invoke-virtual {p0, v0}, Lcom/sigmob/sdk/base/views/e;->setWebChromeClient(Landroid/webkit/WebChromeClient;)V
...
.method public b(Z)V
    ...
    invoke-virtual {p0}, Lcom/sigmob/sdk/base/views/e;->stopLoading()V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/sigmob/sdk/base/views/e;->onPause()V
...
.method d()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/sigmob/sdk/base/views/e;->a(Ljava/lang/String;Landroid/webkit/ValueCallback;)V
...
.method public destroy()V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/sigmob/sdk/base/views/e;->removeAllViews()V
...
.method public loadUrl(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/sigmob/sdk/base/views/e;->f:Ljava/util/Map;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/sigmob/sdk/base/views/e;->loadUrl(Ljava/lang/String;Ljava/util/Map;)V
...
.method public setAdUnit(Lcom/sigmob/sdk/base/models/BaseAdUnit;)V
    ...
    iput-object p1, p0, Lcom/sigmob/sdk/base/views/e;->d:Lcom/sigmob/sdk/base/models/BaseAdUnit;
...
.method public setWebViewClient(Landroid/webkit/WebViewClient;)V
    ...
    iput-object p1, p0, Lcom/sigmob/sdk/base/views/e;->e:Landroid/webkit/WebViewClient;
