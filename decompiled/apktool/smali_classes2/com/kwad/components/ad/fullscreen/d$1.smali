.class final Lcom/kwad/components/ad/fullscreen/d$1;
...
# direct methods
.method constructor <init>(Lcom/kwad/sdk/internal/api/SceneImpl;Lcom/kwad/sdk/api/KsLoadManager$FullScreenVideoAdListener;J)V
    .locals 0

    iput-object p1, p0, Lcom/kwad/components/ad/fullscreen/d$1;->dU:Lcom/kwad/sdk/internal/api/SceneImpl;

    iput-object p2, p0, Lcom/kwad/components/ad/fullscreen/d$1;->fR:Lcom/kwad/sdk/api/KsLoadManager$FullScreenVideoAdListener;

    iput-wide p3, p0, Lcom/kwad/components/ad/fullscreen/d$1;->fS:J
...
.method public final a(Lcom/kwad/components/core/response/model/AdResultData;Z)V
    ...
    iget-object v1, p0, Lcom/kwad/components/ad/fullscreen/d$1;->dU:Lcom/kwad/sdk/internal/api/SceneImpl;

    invoke-static {v1, v0}, Lcom/kwad/components/ad/fullscreen/d;->b(Lcom/kwad/sdk/internal/api/SceneImpl;Ljava/util/List;)Ljava/util/List;
    ...
    const-string v2, "onFullScreenVideoAdCacheFailed"

    const-string v3, "fullAd_"
    ...
    iget-wide v5, p0, Lcom/kwad/components/ad/fullscreen/d$1;->fS:J

    invoke-static {p2, v1, v4, v5, v6}, Lcom/kwad/components/ad/reward/monitor/a;->a(ZLcom/kwad/sdk/core/response/model/AdTemplate;IJ)V
    ...
    sget-object v4, Lcom/kwai/adclient/kscommerciallogger/model/BusinessType;->AD_FULLSCREEN:Lcom/kwai/adclient/kscommerciallogger/model/BusinessType;
    ...
    new-instance v1, Lcom/kwad/components/ad/fullscreen/d$1$2;

    invoke-direct {v1, p0, p1}, Lcom/kwad/components/ad/fullscreen/d$1$2;-><init>(Lcom/kwad/components/ad/fullscreen/d$1;Ljava/util/List;)V
    ...
    invoke-static {v6, p2}, Lcom/kwad/components/ad/c/a;->a(Lcom/kwad/sdk/core/response/model/AdTemplate;Z)Z
    ...
    invoke-static {v7}, Lcom/kwad/sdk/core/response/b/a;->cw(Lcom/kwad/sdk/core/response/model/AdInfo;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/kwad/components/ad/fullscreen/d$1;->onError(ILjava/lang/String;)V
    ...
    iget-wide v2, p0, Lcom/kwad/components/ad/fullscreen/d$1;->fS:J

    invoke-static {p2, v1, v0, v2, v3}, Lcom/kwad/components/ad/reward/monitor/a;->b(ZLcom/kwad/sdk/core/response/model/AdTemplate;IJ)V

    new-instance p2, Lcom/kwad/components/ad/fullscreen/d$1$3;

    invoke-direct {p2, p0, p1}, Lcom/kwad/components/ad/fullscreen/d$1$3;-><init>(Lcom/kwad/components/ad/fullscreen/d$1;Ljava/util/List;)V

    invoke-static {p2}, Lcom/kwad/sdk/utils/bj;->runOnUiThread(Ljava/lang/Runnable;)V
...
.method public final onError(ILjava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/kwad/components/ad/fullscreen/d$1;->dU:Lcom/kwad/sdk/internal/api/SceneImpl;
