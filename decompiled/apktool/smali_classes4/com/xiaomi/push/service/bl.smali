...
# interfaces
.implements Lcom/xiaomi/push/cv$a;
...
.method public static a(Lcom/xiaomi/push/service/XMPushService;)V
    ...
    const-class v1, Lcom/xiaomi/push/cv;

    monitor-enter v1

    :try_start_0
    invoke-static {v0}, Lcom/xiaomi/push/cv;->a(Lcom/xiaomi/push/cv$a;)V
    ...
    invoke-static/range {v2 .. v7}, Lcom/xiaomi/push/cv;->a(Landroid/content/Context;Lcom/xiaomi/push/cu;Lcom/xiaomi/push/cv$b;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
# virtual methods
.method public a(Landroid/content/Context;Lcom/xiaomi/push/cu;Lcom/xiaomi/push/cv$b;Ljava/lang/String;)Lcom/xiaomi/push/cv;
    .locals 1

    new-instance v0, Lcom/xiaomi/push/service/bl$b;

    invoke-direct {v0, p1, p2, p3, p4}, Lcom/xiaomi/push/service/bl$b;-><init>(Landroid/content/Context;Lcom/xiaomi/push/cu;Lcom/xiaomi/push/cv$b;Ljava/lang/String;)V

    return-object v0
.end method

.method public a(Lcom/xiaomi/push/dw$a;)V
    .locals 0
...
.method public a(Lcom/xiaomi/push/dx$b;)V
    ...
    invoke-virtual {p1}, Lcom/xiaomi/push/dx$b;->b()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p1}, Lcom/xiaomi/push/dx$b;->a()Z
    ...
    invoke-virtual {p1}, Lcom/xiaomi/push/cv;->a()V

    invoke-virtual {p1}, Lcom/xiaomi/push/cv;->b()V
    ...
    invoke-virtual {v0}, Lcom/xiaomi/push/fw;->a()Lcom/xiaomi/push/fx;

    move-result-object v1

    invoke-virtual {v1}, Lcom/xiaomi/push/fx;->c()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1, v1}, Lcom/xiaomi/push/cv;->b(Ljava/lang/String;)Lcom/xiaomi/push/cr;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lcom/xiaomi/push/cr;->a()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lcom/xiaomi/push/fw;->a()Ljava/lang/String;
