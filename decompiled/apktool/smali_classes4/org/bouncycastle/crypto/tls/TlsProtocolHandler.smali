...
.method private processHandshake()V
    ...
    invoke-static {v1, v3}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint8(SLjava/io/OutputStream;)V
    ...
    invoke-static {v1, v3}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint16(ILjava/io/OutputStream;)V
    ...
    invoke-virtual {v1, v4, v0, v2, v3}, Lorg/bouncycastle/crypto/tls/RecordStream;->writeMessage(S[BII)V
    ...
    iget-object v12, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->serverRsaKey:Lorg/bouncycastle/crypto/params/RSAKeyParameters;

    iget-object v13, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->random:Ljava/security/SecureRandom;

    invoke-direct {v0, v12, v13}, Lorg/bouncycastle/crypto/params/ParametersWithRandom;-><init>(Lorg/bouncycastle/crypto/CipherParameters;Ljava/security/SecureRandom;)V
    ...
    iget-object v12, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->pms:[B

    array-length v12, v12

    invoke-virtual {v3, v0, v2, v12}, Lorg/bouncycastle/crypto/encodings/PKCS1Encoding;->processBlock([BII)[B
    ...
    invoke-virtual {v1, v6, v0, v2, v5}, Lorg/bouncycastle/crypto/tls/RecordStream;->writeMessage(S[BII)V
    ...
    invoke-static {v3}, Lorg/bouncycastle/crypto/tls/TlsUtils;->toByteArray(Ljava/lang/String;)[B

    move-result-object v3

    iget-object v7, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->ms:[B

    invoke-static {v0, v3, v1, v7}, Lorg/bouncycastle/crypto/tls/TlsUtils;->PRF([B[B[B[B)V

    iget-object v0, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->rs:Lorg/bouncycastle/crypto/tls/RecordStream;

    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->choosenCipherSuite:Lorg/bouncycastle/crypto/tls/TlsCipherSuite;

    iput-object v1, v0, Lorg/bouncycastle/crypto/tls/RecordStream;->writeSuite:Lorg/bouncycastle/crypto/tls/TlsCipherSuite;

    iget-object v0, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->rs:Lorg/bouncycastle/crypto/tls/RecordStream;

    iget-object v0, v0, Lorg/bouncycastle/crypto/tls/RecordStream;->writeSuite:Lorg/bouncycastle/crypto/tls/TlsCipherSuite;

    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->ms:[B

    iget-object v3, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->clientRandom:[B

    iget-object v7, p0, Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;->serverRandom:[B

    invoke-virtual {v0, v1, v3, v7}, Lorg/bouncycastle/crypto/tls/TlsCipherSuite;->init([B[B[B)V
    ...
    iget-object v3, v3, Lorg/bouncycastle/crypto/tls/RecordStream;->hash1:Lorg/bouncycastle/crypto/tls/CombinedHash;

    invoke-virtual {v3, v1, v2}, Lorg/bouncycastle/crypto/tls/CombinedHash;->doFinal([BI)I
    ...
    invoke-static {v3, v7, v1, v0}, Lorg/bouncycastle/crypto/tls/TlsUtils;->PRF([B[B[B[B)V

    new-instance v1, Ljava/io/ByteArrayOutputStream;

    invoke-direct {v1}, Ljava/io/ByteArrayOutputStream;-><init>()V

    invoke-static {v6, v1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint8(SLjava/io/OutputStream;)V

    invoke-static {v10, v1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint24(ILjava/io/OutputStream;)V
    ...
    invoke-static {v13, v0}, Lorg/bouncycastle/crypto/tls/TlsUtils;->readFully([BLjava/io/InputStream;)V
    ...
    invoke-static {v3, v14}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint16(ILjava/io/OutputStream;)V

    invoke-virtual {v14, v4}, Ljava/io/ByteArrayOutputStream;->write([B)V

    invoke-static {v6, v14}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint16(ILjava/io/OutputStream;)V

    invoke-virtual {v14, v8}, Ljava/io/ByteArrayOutputStream;->write([B)V

    invoke-static {v9, v14}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint16(ILjava/io/OutputStream;)V
    ...
    invoke-virtual {v0, v6, v2}, Lorg/bouncycastle/crypto/tls/CombinedHash;->doFinal([BI)I

    new-instance v0, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;

    invoke-direct {v0}, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;-><init>()V

    new-instance v9, Lorg/bouncycastle/crypto/encodings/PKCS1Encoding;

    invoke-direct {v9, v0}, Lorg/bouncycastle/crypto/encodings/PKCS1Encoding;-><init>(Lorg/bouncycastle/crypto/AsymmetricBlockCipher;)V
    ...
    invoke-virtual {v9, v2, v0}, Lorg/bouncycastle/crypto/encodings/PKCS1Encoding;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V

    const/16 v0, 0x2a

    :try_start_1
    invoke-virtual {v9, v13, v2, v12}, Lorg/bouncycastle/crypto/encodings/PKCS1Encoding;->processBlock([BII)[B
