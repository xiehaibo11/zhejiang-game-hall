...
.method public static final openZip(Lokio/Path;Lokio/FileSystem;Lkotlin/jvm/functions/Function1;)Lokio/ZipFileSystem;
    ...
    .line 69
    invoke-static {v6, v8, v9, v7, v4}, Lokio/FileHandle;->source$default(Lokio/FileHandle;JILjava/lang/Object;)Lokio/Source;
    ...
    invoke-static {v15}, Lokio/internal/ZipKt;->getHex(I)Ljava/lang/String;
    ...
    .line 98
    invoke-static {v12}, Lokio/internal/ZipKt;->readEocdRecord(Lokio/BufferedSource;)Lokio/internal/EocdRecord;
    ...
    invoke-interface {v12, v14, v15}, Lokio/BufferedSource;->readUtf8(J)Ljava/lang/String;
    ...
    .line 118
    invoke-interface {v11}, Lokio/BufferedSource;->readLongLe()J
    ...
    .line 131
    invoke-static {v8, v4}, Lokio/internal/ZipKt;->readZip64EocdRecord(Lokio/BufferedSource;Lokio/internal/EocdRecord;)Lokio/internal/EocdRecord;
    ...
    .line 141
    invoke-static {v9}, Lokio/internal/ZipKt;->readEntry(Lokio/BufferedSource;)Lokio/internal/ZipEntry;

    move-result-object v12

    .line 142
    invoke-virtual {v12}, Lokio/internal/ZipEntry;->getOffset()J
    ...
    .line 152
    invoke-static {v7}, Lokio/internal/ZipKt;->buildIndex(Ljava/util/List;)Ljava/util/Map;
    ...
    invoke-direct {v4, v0, v1, v2, v5}, Lokio/ZipFileSystem;-><init>(Lokio/Path;Lokio/FileSystem;Ljava/util/Map;Ljava/lang/String;)V
    :try_end_10
...
.method public static final readEntry(Lokio/BufferedSource;)Lokio/internal/ZipEntry;
    ...
    invoke-static {v0, v4, v4, v3, v1}, Lkotlin/text/StringsKt;->contains$default(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
