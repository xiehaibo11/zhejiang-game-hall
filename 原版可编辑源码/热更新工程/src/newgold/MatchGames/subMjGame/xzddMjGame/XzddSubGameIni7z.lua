...
local ServerMainRule = g_gameConstant.GAME_PLAY_RULE_SCMJ_XZ_7              -- Hown 游戏类型————主玩法
local NameStr = "血战七张"               -- Hown 创建房间选择按钮标题
...
local XZddMjIni = {
    ...
    CreationViewTable = {
        [g_gameConstant.GAME_PLAY_RULE_SCMJ_XZ_7] = "newgold.MatchGames.subMjGame.xzddMjGame.lobby.GameCreationView_xz7z",      -- Hown 对应的csb创建面板中选择解析文件
    },
    ...
    WanfaDescTable = {
        ...
        [g_gameConstant.GAME_SUB_RULE_SI_DUI]                        =   {"4对", ""},
    },
