...
local ServerMainRule = g_gameConstant.GAME_PLAY_RULE_SCMJ_XZDZ              -- Hown 游戏类型————主玩法
local NameStr = "达州麻将"                  -- Hown 创建房间选择按钮标题
...
local XZDZMjIni = {
    ...
    HelpImg = {
        {"bigImg/help_mj_xzdz_%d.png", 3, NameStr},
    },
    
    CreationViewTable = {
        [g_gameConstant.GAME_PLAY_RULE_SCMJ_XZDZ] = "newgold.MatchGames.subMjGame.xzddMjGame.lobby.GameCreationView_dazhou",      -- Hown 对应的csb创建面板中选择解析文件
    },
        ...
        {
            {
                ...
                {g_gameConstant.GAME_SUB_RULE_MJ_WA_SHENG_ROU             },  
                ...
                {g_gameConstant.GAME_SUB_RULE_MJ_SI_JIAO_BU_SUAN              }, 
                {g_gameConstant.GAME_SUB_RULE_MJ_JUE_ZHANG_JIA_FAN              }, 
    ...
    WanfaDescTable = {
        ...
        [g_gameConstant.GAME_SUB_RULE_MJ_WA_SHENG_ROU]         =   {"挖生肉", "玩家胡牌后，从剩余牌堆中依次翻6只鸟，若所抓鸟牌中，有1/5/9、红中则算中鸟，每中一鸟+1分。"},
        ...
        [g_gameConstant.GAME_SUB_RULE_MJ_SI_JIAO_BU_SUAN]               =   {" 死叫不算叫", "玩家胡牌后，从剩余牌堆中依次翻6只鸟，若所抓鸟牌中，有1/5/9、红中则算中鸟，每中一鸟+1分。"},
        [g_gameConstant.GAME_SUB_RULE_MJ_JUE_ZHANG_JIA_FAN]               =   {" 胡绝张加番", "玩家胡牌后，从剩余牌堆中依次翻6只鸟，若所抓鸟牌中，有1/5/9、红中则算中鸟，每中一鸟+1分。"},
