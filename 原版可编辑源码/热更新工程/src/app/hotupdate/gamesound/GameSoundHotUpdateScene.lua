...
--进度更新自定义事件
local EVENT_GAMESOUND_PERCENT_CHANGED = "hotupdate.GameSoundUpate.ProgressChanged"
local EVENT_GAMESOUND_START_UPDATE = "hotupdate.GameSoundUpate.startUpdate"
...
function HotUpdateScene:start(gameID, gameName)
    ...
    self:dispatchPercentEvent(EVENT_GAMESOUND_START_UPDATE, param)
end
...
function HotUpdateScene:needHotUpdate(tag, oldVersion, newVersion)
    ...
    param.percent = 0
    self:dispatchPercentEvent(EVENT_GAMESOUND_PERCENT_CHANGED, param)
end
