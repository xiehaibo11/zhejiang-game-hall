...
tab.NORMAL = {
       CUSTOM_STYLE = {
        [1] = {
            ...
            BODY_TYPE       = MAH_SHAPE_TYPE.SQUARE,                ---牌身(圆方)
            FACE_TYPE       = MAH_LIGHT_TYPE.DARK,                ---牌面(亮暗)
            HAND_STYLE      = COMB_LIE_TYPE.ARROW_BY_ICON,                ---吃碰杠摆放(箭头/牌)
            HAND_SORT_STYLE = HANDAREA_PLACE_TYPE.COMB_AT_LEFT,                ---手牌摆放(左右)
            TABLE_STYLE     = 5,                ---桌布
            OUT_MOVE_STYLE  = 1,                ---轨迹 
            OUT_STYLE       = 2,                ---大牌
            OUT_EFFECTS     = 2,                ---特效
    ...
    BACK_TYPE = {MAH_BACK_COLOR_TYPE.ORANGE, MAH_BACK_COLOR_TYPE.YELLOW, MAH_BACK_COLOR_TYPE.GREEN, MAH_BACK_COLOR_TYPE.XGSJ, normal = MAH_BACK_COLOR_TYPE.YELLOW},
    BODY_TYPE = {MAH_SHAPE_TYPE.CIRCLE, MAH_SHAPE_TYPE.SQUARE, normal = MAH_SHAPE_TYPE.SQUARE},
    FACE_TYPE = {MAH_LIGHT_TYPE.LIGHT, MAH_LIGHT_TYPE.DARK, normal = MAH_LIGHT_TYPE.DARK},
    TABLE_STYLE = {7, 1, 2, 3, 4, 5, normal = 5},
    OUT_MOVE_STYLE = {1, 2, normal = 2},
    OUT_STYLE = {1, 2, normal = 2},
    OUT_EFFECTS = {1, normal = 1},
    HAND_STYLE = {COMB_LIE_TYPE.ARROW_BY_ICON, COMB_LIE_TYPE.ARROW_BY_MAH, normal = COMB_LIE_TYPE.ARROW_BY_ICON},
    HAND_SORT_STYLE = {HANDAREA_PLACE_TYPE.COMB_AT_LEFT, HANDAREA_PLACE_TYPE.COMB_AT_RIGHT, normal = HANDAREA_PLACE_TYPE.COMB_AT_LEFT},
...
tab[7101] = {
     CUSTOM_STYLE = {
        ...
        [2] = {
            ...
            BODY_TYPE       = MAH_SHAPE_TYPE.CIRCLE,                ---牌身(圆方)
            FACE_TYPE       = MAH_LIGHT_TYPE.DARK,                ---牌面(亮暗)
            HAND_STYLE      = COMB_LIE_TYPE.ARROW_BY_ICON,                ---吃碰杠摆放(箭头/牌)
            HAND_SORT_STYLE = HANDAREA_PLACE_TYPE.COMB_AT_LEFT,                ---手牌摆放(左右)
            TABLE_STYLE     = 4,                ---桌布
...
tab[7107] = {
     CUSTOM_STYLE = {
        ...
        [2] = {
            ...
            BODY_TYPE       = MAH_SHAPE_TYPE.SQUARE,                ---牌身(圆方)
            FACE_TYPE       = MAH_LIGHT_TYPE.DARK,                ---牌面(亮暗)
            HAND_STYLE      = COMB_LIE_TYPE.ARROW_BY_MAH,                ---吃碰杠摆放(箭头/牌)
            HAND_SORT_STYLE = HANDAREA_PLACE_TYPE.COMB_AT_LEFT,                ---手牌摆放(左右)
            TABLE_STYLE     = 4,                ---桌布
            OUT_MOVE_STYLE  = 2,                ---轨迹 
            OUT_STYLE       = 2,                ---大牌
    ...
    CARD_WIDTH = {normal = 0.89},
    CARD_WORD_SIZE = {normal = 0.72},
    WORD_TYPE = {MAH_FACE_TYPE.FACE_1, MAH_FACE_TYPE.FACE_2, normal = MAH_FACE_TYPE.FACE_1},
    BACK_TYPE = {MAH_BACK_COLOR_TYPE.ORANGE, MAH_BACK_COLOR_TYPE.YELLOW, MAH_BACK_COLOR_TYPE.GREEN, MAH_BACK_COLOR_TYPE.XGSJ, normal = MAH_BACK_COLOR_TYPE.YELLOW},
    BODY_TYPE = {MAH_SHAPE_TYPE.CIRCLE, MAH_SHAPE_TYPE.SQUARE, normal = MAH_SHAPE_TYPE.SQUARE},
    FACE_TYPE = {MAH_LIGHT_TYPE.LIGHT, MAH_LIGHT_TYPE.DARK, normal = MAH_LIGHT_TYPE.DARK},
    TABLE_STYLE = {7, 1, 2, 3, 4, 5, normal = 5},
...
tab[7119] = {
     CUSTOM_STYLE = {
        [1] = {
            ...
            BACK_TYPE       = MAH_BACK_COLOR_TYPE.GREEN,                ---牌背(颜色)
            BODY_TYPE       = MAH_SHAPE_TYPE.CIRCLE,                ---牌身(圆方)
            FACE_TYPE       = MAH_LIGHT_TYPE.LIGHT,                ---牌面(亮暗)
            HAND_STYLE      = COMB_LIE_TYPE.ARROW_BY_ICON,                ---吃碰杠摆放(箭头/牌)
            HAND_SORT_STYLE = HANDAREA_PLACE_TYPE.COMB_AT_LEFT,                ---手牌摆放(左右)
            TABLE_STYLE     = 1,                ---桌布
            OUT_MOVE_STYLE  = 2,                ---轨迹 
    ...
    PLAYER_TYPE = {1, normal = 1},
    CARD_HEIGHT = {normal = 0.7},
    CARD_WIDTH = {normal = 0.2},
    CARD_WORD_SIZE = {normal = 0.5},
    WORD_TYPE = {MAH_FACE_TYPE.FACE_1, MAH_FACE_TYPE.FACE_2, normal = MAH_FACE_TYPE.FACE_2},
    BACK_TYPE = {MAH_BACK_COLOR_TYPE.ORANGE, MAH_BACK_COLOR_TYPE.YELLOW, MAH_BACK_COLOR_TYPE.GREEN, MAH_BACK_COLOR_TYPE.XGSJ, normal = MAH_BACK_COLOR_TYPE.GREEN},
    BODY_TYPE = {MAH_SHAPE_TYPE.CIRCLE, MAH_SHAPE_TYPE.SQUARE, normal = MAH_SHAPE_TYPE.CIRCLE},
    FACE_TYPE = {MAH_LIGHT_TYPE.LIGHT, MAH_LIGHT_TYPE.DARK, normal = MAH_LIGHT_TYPE.LIGHT},
    TABLE_STYLE = {7, 1, 2, 3, 4, 5, normal = 1},
    OUT_MOVE_STYLE = {1, 2, normal = 2},
    OUT_STYLE = {1, 2, normal = 1},
    OUT_EFFECTS = {1, 2,normal = 1},
    HAND_STYLE = {COMB_LIE_TYPE.ARROW_BY_ICON, COMB_LIE_TYPE.ARROW_BY_MAH, normal = COMB_LIE_TYPE.ARROW_BY_ICON},
    HAND_SORT_STYLE = {HANDAREA_PLACE_TYPE.COMB_AT_LEFT, HANDAREA_PLACE_TYPE.COMB_AT_RIGHT, normal = HANDAREA_PLACE_TYPE.COMB_AT_LEFT},
}
...
tab[7128] = {
    ...
    PLAYER_TYPE = {1, 2, normal = 1},
    CARD_HEIGHT = {normal = 0.68},
    CARD_WIDTH = {normal = 0.09},
    CARD_WORD_SIZE = {normal = 1},
    OUT_EFFECTS_SIZE = {normal = 1},         -- 吃碰杠动画大小
    WORD_TYPE = {MAH_FACE_TYPE.FACE_1, MAH_FACE_TYPE.FACE_2, normal = MAH_FACE_TYPE.FACE_2},
    BACK_TYPE = {MAH_BACK_COLOR_TYPE.ORANGE, MAH_BACK_COLOR_TYPE.YELLOW, MAH_BACK_COLOR_TYPE.GREEN, MAH_BACK_COLOR_TYPE.XGSJ, normal = MAH_BACK_COLOR_TYPE.YELLOW},
    BODY_TYPE = {MAH_SHAPE_TYPE.CIRCLE, MAH_SHAPE_TYPE.SQUARE, normal = MAH_SHAPE_TYPE.SQUARE},
    FACE_TYPE = {MAH_LIGHT_TYPE.LIGHT, MAH_LIGHT_TYPE.DARK, normal = MAH_LIGHT_TYPE.DARK},
    TABLE_STYLE = {7, 1, 2, 3, 4, 5, 6, normal = 6},
    OUT_MOVE_STYLE = {1, 2, normal = 1},
    OUT_STYLE = {1, 2, normal = 2},
    OUT_EFFECTS = {1, 2,normal = 1},
    HAND_STYLE = {COMB_LIE_TYPE.ARROW_BY_ICON, COMB_LIE_TYPE.ARROW_BY_MAH, normal = COMB_LIE_TYPE.ARROW_BY_ICON},
...
tab[7109] = {
    ...
    BODY_TYPE = {MAH_SHAPE_TYPE.CIRCLE, MAH_SHAPE_TYPE.SQUARE, normal = MAH_SHAPE_TYPE.CIRCLE},
    FACE_TYPE = {MAH_LIGHT_TYPE.LIGHT, MAH_LIGHT_TYPE.DARK, normal = MAH_LIGHT_TYPE.LIGHT},
    TABLE_STYLE = {7, 1, 2, 3, 4, 5, normal = 2},
    OUT_MOVE_STYLE = {1, 2, normal = 2},
    OUT_STYLE = {1, 2, normal = 2},
    OUT_EFFECTS = {1, 2,normal = 1},
