...
function BigWinLostModule:onMsgTotalResult(msgData)
    ...
    for seat = 0, CF.roomData:getMaxPlayer() - 1 do
        ...
        if player then
            ...
            tmpStrType[#tmpStrType + 1] = "公杠 " .. msgData.nKongType[seat][2] .. " 次"
            tmpStrType[#tmpStrType + 1] = "暗杠 " .. msgData.nKongType[seat][1] .. " 次"
            tmpStrType[#tmpStrType + 1] = "中码 " .. msgData.zhongmaCount[seat] .. " 个"
