...
function BigWinLostModule:onMsgTotalResult(msgData)
    ...
    CF.game:getModule("GameLayer"):hideHuFanTips()
    ...
    for seat = 0, CF.roomData:getMaxPlayer() - 1 do
        ...
        if player then
            ...
            tmpStrType[#tmpStrType + 1] = "最大 " .. msgData.maxFanNum[seat] .. " 台"
            
            if msgData.maxFanCount[seat] > 0 then
                tmpStrType[#tmpStrType + 1] = "最大台 " .. WinLostFanConfig.KW_WINLOST_FAN_TYPE[msgData.maxFanName[seat][1]] or ""
