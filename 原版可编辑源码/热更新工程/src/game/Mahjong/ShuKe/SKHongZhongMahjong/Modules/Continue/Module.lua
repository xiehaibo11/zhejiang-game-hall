...
function ContinueModule:getSubXYDealList()
    local subXYDealList = ContinueModule.super.getSubXYDealList(self)
    subXYDealList[#subXYDealList + 1] = {callback = handler(self, self.onMsgAskContinue), msgClass = CF.GameProtocol.msgAskContinue}
    subXYDealList[#subXYDealList + 1] = {callback = handler(self, self.onMsgContinueFlag), msgClass = CF.GameProtocol.msgContinueFlag}
    subXYDealList[#subXYDealList + 1] = {callback = handler(self, self.onMsgContinueTips), msgClass = CF.GameProtocol.msgContinueTips}
