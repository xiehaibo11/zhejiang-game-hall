local GoldManager = CF.gameClass("GoldManager", CF.gameScriptRootPath .. ".GameBase.Manager.GoldManager")
...
function GoldManager:showTipLayer(leaveReason)
    ...
    if CF.roomData and CF.roomData:isDKGoldRoom() and leaveReason == GoldManager.ENUM_MSG.NOT_ENOUGH_SR_MSG then
        ...
        if CF.viewManager:isViewExist("GoldBankruptcyView") or CF.viewManager:isViewExist("YGiftDefeatView") then
            return
        end
