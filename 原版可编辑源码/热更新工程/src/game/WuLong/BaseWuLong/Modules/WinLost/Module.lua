...
function WinLostModule:onMsgWinLost(msgData)
    ...
    winLostData:setFinishOrder(msgData.sFinishOrder)
    winLostData:setScore(msgData.iScore)
    winLostData:setBoomCount(msgData.iBoomCount)
    winLostData:setBombRewardScore(msgData.iBombRewardScore)
    winLostData:setPickupScore(msgData.iPickupScore)
    winLostData:setFinalScore(msgData.iFinalScore)
    if msgData.bZaoFanRebelled then
        winLostData:setChaoDiSeat(msgData.sZaoFanRebelSeats)
    else
        winLostData:setChaoDiSeat({})
    end
