...
public class ViewModelProvider {
    ...
    public static class AndroidViewModelFactory extends android.arch.lifecycle.ViewModelProvider.NewInstanceFactory {
        ...
        public static android.arch.lifecycle.ViewModelProvider.AndroidViewModelFactory getInstance(android.app.Application r1) {
        ...
        @Override
        public <T extends android.arch.lifecycle.ViewModel> T create(java.lang.Class<T> r6) {
                r5 = this;
    ...
    public interface Factory {
        <T extends android.arch.lifecycle.ViewModel> T create(java.lang.Class<T> r1);
    }
    ...
    public static class NewInstanceFactory implements android.arch.lifecycle.ViewModelProvider.Factory {
        ...
        @Override
        public <T extends android.arch.lifecycle.ViewModel> T create(java.lang.Class<T> r5) {
                r4 = this;
                java.lang.String r0 = "Cannot create an instance of "
    ...
    public ViewModelProvider(android.arch.lifecycle.ViewModelStore r1, android.arch.lifecycle.ViewModelProvider.Factory r2) {
            r0 = this;
            r0.<init>()
            r0.mFactory = r2
    ...
    public ViewModelProvider(android.arch.lifecycle.ViewModelStoreOwner r1, android.arch.lifecycle.ViewModelProvider.Factory r2) {
            r0 = this;
    ...
    public <T extends android.arch.lifecycle.ViewModel> T get(java.lang.Class<T> r4) {
            r3 = this;
    ...
    public <T extends android.arch.lifecycle.ViewModel> T get(java.lang.String r3, java.lang.Class<T> r4) {
            r2 = this;
