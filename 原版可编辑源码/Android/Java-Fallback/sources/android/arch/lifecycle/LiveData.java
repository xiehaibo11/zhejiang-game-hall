...
public abstract class LiveData<T> {
    ...
    class LifecycleBoundObserver extends android.arch.lifecycle.LiveData<T>.ObserverWrapper implements android.arch.lifecycle.GenericLifecycleObserver {
        ...
        LifecycleBoundObserver(android.arch.lifecycle.LiveData r1, android.arch.lifecycle.LifecycleOwner r2, android.arch.lifecycle.Observer<T> r3) {
                r0 = this;
                r0.this$0 = r1
                r0.<init>(r1, r3)
                r0.mOwner = r2
    ...
    private void dispatchingValue(android.arch.lifecycle.LiveData<T>.ObserverWrapper r4) {
            r3 = this;
    ...
    public void observe(android.arch.lifecycle.LifecycleOwner r3, android.arch.lifecycle.Observer<T> r4) {
            r2 = this;
    ...
    public void observeForever(android.arch.lifecycle.Observer<T> r3) {
            r2 = this;
    ...
    public void removeObserver(android.arch.lifecycle.Observer<T> r2) {
            r1 = this;
    ...
    public void removeObservers(android.arch.lifecycle.LifecycleOwner r4) {
            r3 = this;
