...
public class DescendantOffsetUtils {
    ...
    static {
            ...
            r0.<init>()
            android.support.design.widget.DescendantOffsetUtils.matrix = r0
            java.lang.ThreadLocal r0 = new java.lang.ThreadLocal
            r0.<init>()
            android.support.design.widget.DescendantOffsetUtils.rectF = r0
            return
    }
    ...
    public static void offsetDescendantRect(android.view.ViewGroup r3, android.view.View r4, android.graphics.Rect r5) {
            java.lang.ThreadLocal<android.graphics.Matrix> r0 = android.support.design.widget.DescendantOffsetUtils.matrix
            java.lang.Object r0 = r0.get()
            android.graphics.Matrix r0 = (android.graphics.Matrix) r0
            if (r0 != 0) goto L15
            android.graphics.Matrix r0 = new android.graphics.Matrix
            r0.<init>()
            java.lang.ThreadLocal<android.graphics.Matrix> r1 = android.support.design.widget.DescendantOffsetUtils.matrix
            r1.set(r0)
            goto L18
        L15:
            r0.reset()
        L18:
            ...
            java.lang.ThreadLocal<android.graphics.RectF> r3 = android.support.design.widget.DescendantOffsetUtils.rectF
            java.lang.Object r3 = r3.get()
            android.graphics.RectF r3 = (android.graphics.RectF) r3
            if (r3 != 0) goto L2f
            android.graphics.RectF r3 = new android.graphics.RectF
            r3.<init>()
            java.lang.ThreadLocal<android.graphics.RectF> r4 = android.support.design.widget.DescendantOffsetUtils.rectF
            r4.set(r3)
        L2f:
            r3.set(r5)
            r0.mapRect(r3)
