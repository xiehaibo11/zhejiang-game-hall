...
public class FragmentTransitionSupport extends android.support.v4.app.FragmentTransitionImpl {
    ...
    private static boolean hasSimpleTarget(android.support.transition.Transition r1) {
    ...
    public void addTargets(java.lang.Object r4, java.util.ArrayList<android.view.View> r5) {
            r3 = this;
            android.support.transition.Transition r4 = (android.support.transition.Transition) r4
            if (r4 != 0) goto L5
            return
        L5:
            boolean r0 = r4 instanceof android.support.transition.TransitionSet
            r1 = 0
            if (r0 == 0) goto L1c
        ...
        L10:
            if (r1 >= r0) goto L3e
            android.support.transition.Transition r2 = r4.getTransitionAt(r1)
            r3.addTargets(r2, r5)
            int r1 = r1 + 1
            goto L10
        L1c:
    ...
    public void beginDelayedTransition(android.view.ViewGroup r1, java.lang.Object r2) {
            ...
            android.support.transition.TransitionManager.beginDelayedTransition(r1, r2)
            return
    }
    ...
    public boolean canHandle(java.lang.Object r1) {
            r0 = this;
            boolean r1 = r1 instanceof android.support.transition.Transition
            return r1
    }
    ...
    public java.lang.Object cloneTransition(java.lang.Object r1) {
            ...
            if (r1 == 0) goto L9
            android.support.transition.Transition r1 = (android.support.transition.Transition) r1
            android.support.transition.Transition r1 = r1.clone()
            goto La
        L9:
            r1 = 0
        La:
    ...
    public java.lang.Object mergeTransitionsInSequence(java.lang.Object r2, java.lang.Object r3, java.lang.Object r4) {
            ...
            if (r2 == 0) goto L1d
            if (r3 == 0) goto L1d
            android.support.transition.TransitionSet r0 = new android.support.transition.TransitionSet
            r0.<init>()
            android.support.transition.TransitionSet r2 = r0.addTransition(r2)
            android.support.transition.TransitionSet r2 = r2.addTransition(r3)
            r3 = 1
            android.support.transition.TransitionSet r2 = r2.setOrdering(r3)
            goto L25
        L1d:
            if (r2 == 0) goto L20
            goto L25
    ...
    public void replaceTargets(java.lang.Object r5, java.util.ArrayList<android.view.View> r6, java.util.ArrayList<android.view.View> r7) {
            ...
            boolean r0 = r5 instanceof android.support.transition.TransitionSet
            r1 = 0
            if (r0 == 0) goto L19
            android.support.transition.TransitionSet r5 = (android.support.transition.TransitionSet) r5
            int r0 = r5.getTransitionCount()
        Ld:
            if (r1 >= r0) goto L5d
            android.support.transition.Transition r2 = r5.getTransitionAt(r1)
    ...
    public void scheduleHideFragmentView(java.lang.Object r2, android.view.View r3, java.util.ArrayList<android.view.View> r4) {
            r1 = this;
            android.support.transition.Transition r2 = (android.support.transition.Transition) r2
            android.support.transition.FragmentTransitionSupport$2 r0 = new android.support.transition.FragmentTransitionSupport$2
            r0.<init>(r1, r3, r4)
            r2.addListener(r0)
            return
    }
    ...
    public void scheduleRemoveTargets(java.lang.Object r11, java.lang.Object r12, java.util.ArrayList<android.view.View> r13, java.lang.Object r14, java.util.ArrayList<android.view.View> r15, java.lang.Object r16, java.util.ArrayList<android.view.View> r17) {
            ...
            android.support.transition.FragmentTransitionSupport$3 r9 = new android.support.transition.FragmentTransitionSupport$3
            r1 = r9
            r2 = r10
            r3 = r12
            r4 = r13
    ...
    public void setEpicenter(java.lang.Object r2, android.graphics.Rect r3) {
            ...
            if (r2 == 0) goto Lc
            android.support.transition.Transition r2 = (android.support.transition.Transition) r2
            android.support.transition.FragmentTransitionSupport$4 r0 = new android.support.transition.FragmentTransitionSupport$4
            r0.<init>(r1, r3)
    ...
    public void setEpicenter(java.lang.Object r2, android.view.View r3) {
            ...
            android.support.transition.FragmentTransitionSupport$1 r3 = new android.support.transition.FragmentTransitionSupport$1
            r3.<init>(r1, r0)
