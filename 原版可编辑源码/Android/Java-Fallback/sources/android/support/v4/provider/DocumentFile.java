...
public abstract class DocumentFile {
    ...
    DocumentFile(android.support.v4.provider.DocumentFile r1) {
            r0 = this;
            r0.<init>()
            r0.mParent = r1
            return
    ...
    public static android.support.v4.provider.DocumentFile fromFile(java.io.File r2) {
    ...
    public static android.support.v4.provider.DocumentFile fromSingleUri(android.content.Context r3, android.net.Uri r4) {
    ...
    public static android.support.v4.provider.DocumentFile fromTreeUri(android.content.Context r3, android.net.Uri r4) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 0
            r2 = 21
            if (r0 < r2) goto L15
    ...
    public static boolean isDocumentUri(android.content.Context r2, android.net.Uri r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 19
            if (r0 < r1) goto Lb
    ...
    public abstract android.support.v4.provider.DocumentFile createDirectory(java.lang.String r1);

    public abstract android.support.v4.provider.DocumentFile createFile(java.lang.String r1, java.lang.String r2);

    public abstract boolean delete();

    public abstract boolean exists();

    public android.support.v4.provider.DocumentFile findFile(java.lang.String r6) {
            r5 = this;
