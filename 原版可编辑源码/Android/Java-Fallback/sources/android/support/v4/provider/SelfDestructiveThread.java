...
public class SelfDestructiveThread {
    ...
    private void post(java.lang.Runnable r6) {
            ...
            monitor-enter(r0)
            android.os.HandlerThread r1 = r5.mThread     // Catch: java.lang.Throwable -> L3d
            r2 = 1
            if (r1 != 0) goto L2a
            android.os.HandlerThread r1 = new android.os.HandlerThread     // Catch: java.lang.Throwable -> L3d
            java.lang.String r3 = r5.mThreadName     // Catch: java.lang.Throwable -> L3d
            int r4 = r5.mPriority     // Catch: java.lang.Throwable -> L3d
            r1.<init>(r3, r4)     // Catch: java.lang.Throwable -> L3d
            r5.mThread = r1     // Catch: java.lang.Throwable -> L3d
            r1.start()     // Catch: java.lang.Throwable -> L3d
            android.os.Handler r1 = new android.os.Handler     // Catch: java.lang.Throwable -> L3d
            android.os.HandlerThread r3 = r5.mThread     // Catch: java.lang.Throwable -> L3d
            android.os.Looper r3 = r3.getLooper()     // Catch: java.lang.Throwable -> L3d
            android.os.Handler$Callback r4 = r5.mCallback     // Catch: java.lang.Throwable -> L3d
            r1.<init>(r3, r4)     // Catch: java.lang.Throwable -> L3d
            r5.mHandler = r1     // Catch: java.lang.Throwable -> L3d
            int r1 = r5.mGeneration     // Catch: java.lang.Throwable -> L3d
            int r1 = r1 + r2
            r5.mGeneration = r1     // Catch: java.lang.Throwable -> L3d
        L2a:
            android.os.Handler r1 = r5.mHandler     // Catch: java.lang.Throwable -> L3d
            r3 = 0
            r1.removeMessages(r3)     // Catch: java.lang.Throwable -> L3d
            android.os.Handler r1 = r5.mHandler     // Catch: java.lang.Throwable -> L3d
            android.os.Handler r3 = r5.mHandler     // Catch: java.lang.Throwable -> L3d
            android.os.Message r6 = r3.obtainMessage(r2, r6)     // Catch: java.lang.Throwable -> L3d
            r1.sendMessage(r6)     // Catch: java.lang.Throwable -> L3d
