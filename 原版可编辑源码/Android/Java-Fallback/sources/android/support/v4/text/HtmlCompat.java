...
public final class HtmlCompat {
    ...
    public static android.text.Spanned fromHtml(java.lang.String r2, int r3) {
    ...
    public static android.text.Spanned fromHtml(java.lang.String r2, int r3, android.text.Html.ImageGetter r4, android.text.Html.TagHandler r5) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 24
            if (r0 < r1) goto Lb
    ...
    public static java.lang.String toHtml(android.text.Spanned r2, int r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 24
            if (r0 < r1) goto Lb
