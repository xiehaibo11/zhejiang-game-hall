...
public class PrecomputedTextCompat implements android.text.Spannable {
    ...
    public static final class Params {
        ...
        public static class Builder {
            ...
            public android.support.v4.text.PrecomputedTextCompat.Params.Builder setTextDirection(android.text.TextDirectionHeuristic r1) {
                    r0 = this;
                    r0.mTextDir = r1
                    return r0
            }
        ...
        public Params(android.text.PrecomputedText.Params r2) {
                r1 = this;
                r1.<init>()
    ...
    private static class PrecomputedTextFutureTask extends java.util.concurrent.FutureTask<android.support.v4.text.PrecomputedTextCompat> {
        ...
        private static class PrecomputedTextCallback implements java.util.concurrent.Callable<android.support.v4.text.PrecomputedTextCompat> {
            ...
            PrecomputedTextCallback(android.support.v4.text.PrecomputedTextCompat.Params r1, java.lang.CharSequence r2) {
                    r0 = this;
                    r0.<init>()
                    r0.mParams = r1
                    r0.mText = r2
        ...
        PrecomputedTextFutureTask(android.support.v4.text.PrecomputedTextCompat.Params r2, java.lang.CharSequence r3) {
                r1 = this;
    ...
    private PrecomputedTextCompat(android.text.PrecomputedText r1, android.support.v4.text.PrecomputedTextCompat.Params r2) {
            r0 = this;
            r0.<init>()
            r0.mText = r1
            r0.mParams = r2
    ...
    private PrecomputedTextCompat(java.lang.CharSequence r2, android.support.v4.text.PrecomputedTextCompat.Params r3, int[] r4) {
            r1 = this;
            r1.<init>()
    ...
    public static android.support.v4.text.PrecomputedTextCompat create(java.lang.CharSequence r11, android.support.v4.text.PrecomputedTextCompat.Params r12) {
    ...
    private int findParaIndex(int r5) {
            r4 = this;
            r0 = 0
        L1:
    ...
    public static java.util.concurrent.Future<android.support.v4.text.PrecomputedTextCompat> getTextFuture(java.lang.CharSequence r1, android.support.v4.text.PrecomputedTextCompat.Params r2, java.util.concurrent.Executor r3) {
