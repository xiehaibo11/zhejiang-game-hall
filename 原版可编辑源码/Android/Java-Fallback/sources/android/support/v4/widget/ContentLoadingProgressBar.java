...
public class ContentLoadingProgressBar extends android.widget.ProgressBar {
    ...
    public synchronized void hide() {
            ...
            monitor-enter(r9)
            r0 = 1
            r9.mDismissed = r0     // Catch: java.lang.Throwable -> L36
            java.lang.Runnable r1 = r9.mDelayedShow     // Catch: java.lang.Throwable -> L36
            r9.removeCallbacks(r1)     // Catch: java.lang.Throwable -> L36
            r1 = 0
            r9.mPostedShow = r1     // Catch: java.lang.Throwable -> L36
            long r1 = java.lang.System.currentTimeMillis()     // Catch: java.lang.Throwable -> L36
            long r3 = r9.mStartTime     // Catch: java.lang.Throwable -> L36
            long r1 = r1 - r3
            r3 = 500(0x1f4, double:2.47E-321)
            int r5 = (r1 > r3 ? 1 : (r1 == r3 ? 0 : -1))
            if (r5 >= 0) goto L2f
            long r5 = r9.mStartTime     // Catch: java.lang.Throwable -> L36
            r7 = -1
            int r5 = (r5 > r7 ? 1 : (r5 == r7 ? 0 : -1))
            if (r5 != 0) goto L22
            goto L2f
        L22:
            boolean r5 = r9.mPostedHide     // Catch: java.lang.Throwable -> L36
            if (r5 != 0) goto L34
            java.lang.Runnable r5 = r9.mDelayedHide     // Catch: java.lang.Throwable -> L36
            long r3 = r3 - r1
            r9.postDelayed(r5, r3)     // Catch: java.lang.Throwable -> L36
            r9.mPostedHide = r0     // Catch: java.lang.Throwable -> L36
            goto L34
        L2f:
            r0 = 8
            r9.setVisibility(r0)     // Catch: java.lang.Throwable -> L36
        L34:
            monitor-exit(r9)
            return
        L36:
