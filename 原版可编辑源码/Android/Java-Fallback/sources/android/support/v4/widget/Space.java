...
public class Space extends android.view.View {
    @java.lang.Deprecated
    public Space(android.content.Context r2) {
            r1 = this;
            r0 = 0
            r1.<init>(r2, r0)
            return
    ...
    @java.lang.Deprecated
    public Space(android.content.Context r2, android.util.AttributeSet r3) {
            r1 = this;
            r0 = 0
            r1.<init>(r2, r3, r0)
            return
    ...
    @java.lang.Deprecated
    public Space(android.content.Context r1, android.util.AttributeSet r2, int r3) {
            r0 = this;
            r0.<init>(r1, r2, r3)
