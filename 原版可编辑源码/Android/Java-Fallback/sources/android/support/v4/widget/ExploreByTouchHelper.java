...
public abstract class ExploreByTouchHelper extends android.support.v4.view.AccessibilityDelegateCompat {
    ...
    protected void onPopulateNodeForHost(android.support.v4.view.accessibility.AccessibilityNodeInfoCompat r1) {
            r0 = this;
            return
    }

    protected abstract void onPopulateNodeForVirtualView(int r1, android.support.v4.view.accessibility.AccessibilityNodeInfoCompat r2);
