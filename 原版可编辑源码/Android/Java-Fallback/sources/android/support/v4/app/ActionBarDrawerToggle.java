...
public class ActionBarDrawerToggle implements android.support.v4.widget.DrawerLayout.DrawerListener {
    ...
    public ActionBarDrawerToggle(android.app.Activity r9, android.support.v4.widget.DrawerLayout r10, int r11, int r12, int r13) {
            r8 = this;
    ...
    public ActionBarDrawerToggle(android.app.Activity r2, android.support.v4.widget.DrawerLayout r3, boolean r4, int r5, int r6, int r7) {
            r1 = this;
            r1.<init>()
            r0 = 1
