...
public final class TaskStackBuilder implements java.lang.Iterable<android.content.Intent> {
    ...
    public static android.support.v4.app.TaskStackBuilder create(android.content.Context r1) {
    ...
    public android.support.v4.app.TaskStackBuilder addNextIntent(android.content.Intent r2) {
            r1 = this;
    ...
    public android.support.v4.app.TaskStackBuilder addNextIntentWithParentStack(android.content.Intent r2) {
            r1 = this;
    ...
    public android.support.v4.app.TaskStackBuilder addParentStack(android.app.Activity r2) {
            r1 = this;
    ...
    public android.support.v4.app.TaskStackBuilder addParentStack(java.lang.Class<?> r3) {
            r2 = this;
