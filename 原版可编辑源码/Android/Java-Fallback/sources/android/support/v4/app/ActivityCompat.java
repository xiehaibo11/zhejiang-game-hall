...
public class ActivityCompat extends android.support.v4.content.ContextCompat {
    ...
    public static void finishAffinity(android.app.Activity r2) {
    ...
    public static void finishAfterTransition(android.app.Activity r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto La
    ...
    public static android.net.Uri getReferrer(android.app.Activity r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 22
            if (r0 < r1) goto Lb
    ...
    public static void postponeEnterTransition(android.app.Activity r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto L9
    ...
    public static void requestPermissions(android.app.Activity r2, java.lang.String[] r3, int r4) {
            android.support.v4.app.ActivityCompat$PermissionCompatDelegate r0 = android.support.v4.app.ActivityCompat.sDelegate
            if (r0 == 0) goto Lb
    ...
    public static void setEnterSharedElementCallback(android.app.Activity r2, android.support.v4.app.SharedElementCallback r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto L12
            if (r3 == 0) goto Le
    ...
    public static void setExitSharedElementCallback(android.app.Activity r2, android.support.v4.app.SharedElementCallback r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto L12
            if (r3 == 0) goto Le
    ...
    public static void setPermissionCompatDelegate(android.support.v4.app.ActivityCompat.PermissionCompatDelegate r0) {
    ...
    public static void startActivityForResult(android.app.Activity r2, android.content.Intent r3, int r4, android.os.Bundle r5) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 16
            if (r0 < r1) goto La
    ...
    public static void startIntentSenderForResult(android.app.Activity r2, android.content.IntentSender r3, int r4, android.content.Intent r5, int r6, int r7, int r8, android.os.Bundle r9) throws android.content.IntentSender.SendIntentException {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 16
            if (r0 < r1) goto La
    ...
    public static void startPostponedEnterTransition(android.app.Activity r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto L9
