...
public class ContextCompat {
    ...
    public static java.io.File getCodeCacheDir(android.content.Context r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto Lb
    ...
    public static java.io.File getNoBackupFilesDir(android.content.Context r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto Lb
    ...
    public static java.io.File[] getObbDirs(android.content.Context r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 19
            if (r0 < r1) goto Lb
    ...
    public static boolean startActivities(android.content.Context r2, android.content.Intent[] r3, android.os.Bundle r4) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 16
            if (r0 < r1) goto La
    ...
    public static void startActivity(android.content.Context r2, android.content.Intent r3, android.os.Bundle r4) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 16
            if (r0 < r1) goto La
