...
final class GradientColorInflaterCompat {
    ...
    private static android.support.v4.content.res.GradientColorInflaterCompat.ColorStops checkColors(android.support.v4.content.res.GradientColorInflaterCompat.ColorStops r0, int r1, int r2, boolean r3, int r4) {
            if (r0 == 0) goto L3
            return r0
        L3:
            if (r3 == 0) goto Lb
