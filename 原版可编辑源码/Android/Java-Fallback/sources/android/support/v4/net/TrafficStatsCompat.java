...
public final class TrafficStatsCompat {
    ...
    public static void tagDatagramSocket(java.net.DatagramSocket r3) throws java.net.SocketException {
    ...
    public static void untagDatagramSocket(java.net.DatagramSocket r3) throws java.net.SocketException {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 24
            if (r0 < r1) goto La
