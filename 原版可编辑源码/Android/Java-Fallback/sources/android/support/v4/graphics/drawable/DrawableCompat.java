...
public final class DrawableCompat {
    ...
    public static void applyTheme(android.graphics.drawable.Drawable r2, android.content.res.Resources.Theme r3) {
    ...
    public static boolean canApplyTheme(android.graphics.drawable.Drawable r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto Lb
    ...
    public static void clearColorFilter(android.graphics.drawable.Drawable r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 23
            if (r0 < r1) goto La
            r3.clearColorFilter()
    ...
    public static int getAlpha(android.graphics.drawable.Drawable r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 19
            if (r0 < r1) goto Lb
            int r2 = r2.getAlpha()
    ...
    public static android.graphics.ColorFilter getColorFilter(android.graphics.drawable.Drawable r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto Lb
    ...
    public static int getLayoutDirection(android.graphics.drawable.Drawable r6) {
        ...
        Lb:
            ...
            java.lang.reflect.Method r3 = r3.getDeclaredMethod(r4, r5)     // Catch: java.lang.NoSuchMethodException -> L29
            android.support.v4.graphics.drawable.DrawableCompat.sGetLayoutDirectionMethod = r3     // Catch: java.lang.NoSuchMethodException -> L29
            r3.setAccessible(r0)     // Catch: java.lang.NoSuchMethodException -> L29
            goto L2f
        L29:
            r3 = move-exception
        ...
        L31:
            ...
            if (r0 == 0) goto L4b
            java.lang.Object[] r3 = new java.lang.Object[r2]     // Catch: java.lang.Exception -> L42
    ...
    public static void inflate(android.graphics.drawable.Drawable r2, android.content.res.Resources r3, org.xmlpull.v1.XmlPullParser r4, android.util.AttributeSet r5, android.content.res.Resources.Theme r6) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto La
    ...
    public static boolean isAutoMirrored(android.graphics.drawable.Drawable r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 19
            if (r0 < r1) goto Lb
    ...
    public static void setAutoMirrored(android.graphics.drawable.Drawable r2, boolean r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 19
            if (r0 < r1) goto L9
    ...
    public static void setHotspot(android.graphics.drawable.Drawable r2, float r3, float r4) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto L9
            r2.setHotspot(r3, r4)
    ...
    public static void setHotspotBounds(android.graphics.drawable.Drawable r2, int r3, int r4, int r5, int r6) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto L9
    ...
    public static boolean setLayoutDirection(android.graphics.drawable.Drawable r7, int r8) {
        ...
        Lb:
            ...
            java.lang.Class r6 = java.lang.Integer.TYPE     // Catch: java.lang.NoSuchMethodException -> L2d
            r5[r2] = r6     // Catch: java.lang.NoSuchMethodException -> L2d
            java.lang.reflect.Method r0 = r0.getDeclaredMethod(r4, r5)     // Catch: java.lang.NoSuchMethodException -> L2d
            android.support.v4.graphics.drawable.DrawableCompat.sSetLayoutDirectionMethod = r0     // Catch: java.lang.NoSuchMethodException -> L2d
            r0.setAccessible(r3)     // Catch: java.lang.NoSuchMethodException -> L2d
            goto L33
        L2d:
            r0 = move-exception
        ...
        L35:
            ...
            if (r0 == 0) goto L4e
            java.lang.Object[] r4 = new java.lang.Object[r3]     // Catch: java.lang.Exception -> L45
            java.lang.Integer r8 = java.lang.Integer.valueOf(r8)     // Catch: java.lang.Exception -> L45
            r4[r2] = r8     // Catch: java.lang.Exception -> L45
            r0.invoke(r7, r4)     // Catch: java.lang.Exception -> L45
            return r3
        L45:
            r7 = move-exception
    ...
    public static void setTint(android.graphics.drawable.Drawable r2, int r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto La
            r2.setTint(r3)
    ...
    public static void setTintList(android.graphics.drawable.Drawable r2, android.content.res.ColorStateList r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto La
            r2.setTintList(r3)
    ...
    public static void setTintMode(android.graphics.drawable.Drawable r2, android.graphics.PorterDuff.Mode r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto La
            r2.setTintMode(r3)
