...
public class TypefaceCompatApi26Impl extends android.support.v4.graphics.TypefaceCompatApi21Impl {
    ...
    public android.graphics.Typeface createFromFontInfo(android.content.Context r11, android.os.CancellationSignal r12, android.support.v4.provider.FontsContractCompat.FontInfo[] r13, int r14) {
        ...
        L6:
            ...
            android.net.Uri r14 = r13.getUri()     // Catch: java.io.IOException -> L57
            java.lang.String r0 = "r"
            android.os.ParcelFileDescriptor r11 = r11.openFileDescriptor(r14, r0, r12)     // Catch: java.io.IOException -> L57
            if (r11 != 0) goto L26
            if (r11 == 0) goto L25
        ...
        L52:
            r11 = move-exception
            r12.addSuppressed(r11)     // Catch: java.io.IOException -> L57
        L56:
            throw r13     // Catch: java.io.IOException -> L57
        L57:
            return r2
        L58:
