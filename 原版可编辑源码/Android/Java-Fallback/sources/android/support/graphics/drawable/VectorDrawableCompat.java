...
public class VectorDrawableCompat extends android.support.graphics.drawable.VectorDrawableCommon {
    ...
    private static class VGroup extends android.support.graphics.drawable.VectorDrawableCompat.VObject {
        ...
        public VGroup(android.support.graphics.drawable.VectorDrawableCompat.VGroup r5, android.support.v4.util.ArrayMap<java.lang.String, java.lang.Object> r6) {
                ...
                r4.mGroupName = r0
                int r1 = r5.mChangingConfigurations
    ...
    private static class VPathRenderer {
        ...
        public VPathRenderer(android.support.graphics.drawable.VectorDrawableCompat.VPathRenderer r4) {
                ...
                r0.<init>()
                r3.mVGTargetsMap = r0
                android.support.graphics.drawable.VectorDrawableCompat$VGroup r1 = new android.support.graphics.drawable.VectorDrawableCompat$VGroup
                android.support.graphics.drawable.VectorDrawableCompat$VGroup r2 = r4.mRootGroup
                r1.<init>(r2, r0)
                r3.mRootGroup = r1
                android.graphics.Path r0 = new android.graphics.Path
    ...
    VectorDrawableCompat(android.support.graphics.drawable.VectorDrawableCompat.VectorDrawableCompatState r3) {
            r2 = this;
            r2.<init>()
            r0 = 1
            r2.mAllowCaching = r0
    ...
    private void printGroupTree(android.support.graphics.drawable.VectorDrawableCompat.VGroup r5, int r6) {
        ...
        L1a:
            ...
            r2.<init>()
            r2.append(r1)
            java.lang.String r1 = "matrix is :"
            r2.append(r1)
            android.graphics.Matrix r1 = r5.getLocalMatrix()
