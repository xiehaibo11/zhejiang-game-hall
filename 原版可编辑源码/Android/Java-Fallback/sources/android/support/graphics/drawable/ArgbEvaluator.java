...
public class ArgbEvaluator implements android.animation.TypeEvaluator {
    private static final android.support.graphics.drawable.ArgbEvaluator sInstance = null;

    static {
            android.support.graphics.drawable.ArgbEvaluator r0 = new android.support.graphics.drawable.ArgbEvaluator
            r0.<init>()
            android.support.graphics.drawable.ArgbEvaluator.sInstance = r0
            return
    }
    ...
    public static android.support.graphics.drawable.ArgbEvaluator getInstance() {
            android.support.graphics.drawable.ArgbEvaluator r0 = android.support.graphics.drawable.ArgbEvaluator.sInstance
            return r0
    }
