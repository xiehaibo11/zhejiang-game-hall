...
public interface Animatable2Compat extends android.graphics.drawable.Animatable {
    ...
    void registerAnimationCallback(android.support.graphics.drawable.Animatable2Compat.AnimationCallback r1);

    boolean unregisterAnimationCallback(android.support.graphics.drawable.Animatable2Compat.AnimationCallback r1);
}
