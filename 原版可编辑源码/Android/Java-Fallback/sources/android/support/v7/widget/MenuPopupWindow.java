...
public class MenuPopupWindow extends android.support.v7.widget.ListPopupWindow implements android.support.v7.widget.MenuItemHoverListener {
    ...
    @Override
    public void onItemHoverEnter(android.support.v7.view.menu.MenuBuilder r2, android.view.MenuItem r3) {
            r1 = this;
    ...
    @Override
    public void onItemHoverExit(android.support.v7.view.menu.MenuBuilder r2, android.view.MenuItem r3) {
            r1 = this;
            android.support.v7.widget.MenuItemHoverListener r0 = r1.mHoverListener
            if (r0 == 0) goto L7
