...
class AlertController {
    ...
    private void setScrollIndicators(android.view.ViewGroup r5, android.view.View r6, int r7, int r8) {
        ...
        L39:
            ...
            if (r1 == 0) goto L77
        L3d:
            java.lang.CharSequence r6 = r4.mMessage
            if (r6 == 0) goto L56
            android.support.v4.widget.NestedScrollView r5 = r4.mScrollView
            android.support.v7.app.AlertController$2 r6 = new android.support.v7.app.AlertController$2
            r6.<init>(r4, r0, r1)
            r5.setOnScrollChangeListener(r6)
            android.support.v4.widget.NestedScrollView r5 = r4.mScrollView
            android.support.v7.app.AlertController$3 r6 = new android.support.v7.app.AlertController$3
            r6.<init>(r4, r0, r1)
            r5.post(r6)
            goto L77
        L56:
            android.widget.ListView r6 = r4.mListView
            if (r6 == 0) goto L6d
            android.support.v7.app.AlertController$4 r5 = new android.support.v7.app.AlertController$4
            r5.<init>(r4, r0, r1)
            r6.setOnScrollListener(r5)
            android.widget.ListView r5 = r4.mListView
            android.support.v7.app.AlertController$5 r6 = new android.support.v7.app.AlertController$5
            r6.<init>(r4, r0, r1)
            r5.post(r6)
            goto L77
        L6d:
