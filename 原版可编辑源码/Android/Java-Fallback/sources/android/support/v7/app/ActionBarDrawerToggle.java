...
public class ActionBarDrawerToggle implements android.support.v4.widget.DrawerLayout.DrawerListener {
    ...
    public ActionBarDrawerToggle(android.app.Activity r8, android.support.v4.widget.DrawerLayout r9, int r10, int r11) {
            r7 = this;
            r2 = 0
            r4 = 0
            r0 = r7
    ...
    public ActionBarDrawerToggle(android.app.Activity r8, android.support.v4.widget.DrawerLayout r9, android.support.v7.widget.Toolbar r10, int r11, int r12) {
            r7 = this;
            r4 = 0
            r0 = r7
            r1 = r8
    ...
    ActionBarDrawerToggle(android.app.Activity r2, android.support.v7.widget.Toolbar r3, android.support.v4.widget.DrawerLayout r4, android.support.v7.graphics.drawable.DrawerArrowDrawable r5, int r6, int r7) {
            r1 = this;
            r1.<init>()
            r0 = 1
    ...
    public void setDrawerArrowDrawable(android.support.v7.graphics.drawable.DrawerArrowDrawable r1) {
            r0 = this;
            r0.mSlider = r1
            r0.syncState()
            return
