...
final class CascadingMenuPopup extends android.support.v7.view.menu.MenuPopup implements android.support.v7.view.menu.MenuPresenter, android.view.View.OnKeyListener, android.widget.PopupWindow.OnDismissListener {
    ...
    private static class CascadingMenuInfo {
        ...
        public CascadingMenuInfo(android.support.v7.widget.MenuPopupWindow r1, android.support.v7.view.menu.MenuBuilder r2, int r3) {
                r0 = this;
                r0.<init>()
                r0.window = r1
                r0.menu = r2
    ...
    private int findIndexOfAddedMenu(android.support.v7.view.menu.MenuBuilder r4) {
            r3 = this;
    ...
    private android.view.MenuItem findMenuItemForSubmenu(android.support.v7.view.menu.MenuBuilder r5, android.support.v7.view.menu.MenuBuilder r6) {
            r4 = this;
            int r0 = r5.size()
            r1 = 0
        L5:
    ...
    private android.view.View findParentViewForSubmenu(android.support.v7.view.menu.CascadingMenuPopup.CascadingMenuInfo r8, android.support.v7.view.menu.MenuBuilder r9) {
            r7 = this;
    ...
    private void showMenu(android.support.v7.view.menu.MenuBuilder r15) {
            r14 = this;
    ...
    public void setAnchorView(android.view.View r2) {
            ...
            int r2 = android.support.v4.view.GravityCompat.getAbsoluteGravity(r0, r2)
    ...
    public void show() {
        ...
        L2f:
            ...
            r2.mTreeObserver = r1
            if (r0 == 0) goto L3e
            android.view.ViewTreeObserver$OnGlobalLayoutListener r0 = r2.mGlobalLayoutListener
