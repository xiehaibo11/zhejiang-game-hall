...
public final class UByteArray implements java.util.Collection<kotlin.UByte>, kotlin.jvm.internal.markers.KMappedMarker {
    ...
    public static final kotlin.UByteArray box-impl(byte[] r1) {
            kotlin.UByteArray r0 = new kotlin.UByteArray
            r0.<init>(r1)
            return r0
    }

    public static byte[] constructor-impl(int r0) {
            byte[] r0 = new byte[r0]
            byte[] r0 = constructor-impl(r0)
            return r0
    }

    public static byte[] constructor-impl(byte[] r1) {
            java.lang.String r0 = "storage"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r1, r0)
            return r1
    }

    public static boolean contains-7apg3OU(byte[] r0, byte r1) {
            boolean r0 = kotlin.collections.ArraysKt.contains(r0, r1)
            return r0
    }

    public static boolean containsAll-impl(byte[] r4, java.util.Collection<kotlin.UByte> r5) {
    ...
    public static final byte get-w2LRezQ(byte[] r0, int r1) {
            r0 = r0[r1]
            byte r0 = kotlin.UByte.constructor-impl(r0)
            return r0
    }

    public static int getSize-impl(byte[] r0) {
            int r0 = r0.length
            return r0
    }
    ...
    public static boolean isEmpty-impl(byte[] r0) {
            int r0 = r0.length
            if (r0 != 0) goto L5
            r0 = 1
            goto L6
    ...
    public static java.util.Iterator<kotlin.UByte> iterator-impl(byte[] r1) {
    ...
    public static final void set-VurrAj0(byte[] r0, int r1, byte r2) {
            r0[r1] = r2
            return
    }

    public static java.lang.String toString-impl(byte[] r2) {
    ...
    @Override
    public boolean add(kotlin.UByte r2) {
            r1 = this;
    ...
    public boolean add-7apg3OU(byte r2) {
            r1 = this;
            java.lang.UnsupportedOperationException r2 = new java.lang.UnsupportedOperationException
            java.lang.String r0 = "Operation is not supported for read-only collection"
            r2.<init>(r0)
    ...
    public boolean contains-7apg3OU(byte r2) {
            r1 = this;
            byte[] r0 = r1.storage
            boolean r2 = contains-7apg3OU(r0, r2)
            return r2
    }
