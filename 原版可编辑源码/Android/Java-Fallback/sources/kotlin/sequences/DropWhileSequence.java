...
public final class DropWhileSequence<T> implements kotlin.sequences.Sequence<T> {
    ...
    public static final class 1 implements java.util.Iterator<T>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        private T nextItem;
        final kotlin.sequences.DropWhileSequence<T> this$0;

        1(kotlin.sequences.DropWhileSequence<T> r1) {
                r0 = this;
                r0.this$0 = r1
                r0.<init>()
                kotlin.sequences.Sequence r1 = kotlin.sequences.DropWhileSequence.access$getSequence$p(r1)
    ...
    public static final kotlin.jvm.functions.Function1 access$getPredicate$p(kotlin.sequences.DropWhileSequence r0) {
            kotlin.jvm.functions.Function1<T, java.lang.Boolean> r0 = r0.predicate
            return r0
    }

    public static final kotlin.sequences.Sequence access$getSequence$p(kotlin.sequences.DropWhileSequence r0) {
