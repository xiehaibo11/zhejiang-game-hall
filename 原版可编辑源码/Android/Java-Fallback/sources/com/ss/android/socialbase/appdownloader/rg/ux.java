...
public class ux extends com.ss.android.socialbase.appdownloader.rg.rg {
    public ux(android.content.Context r1, com.ss.android.socialbase.downloader.setting.DownloadSetting r2, java.lang.String r3) {
            r0 = this;
            r0.<init>(r1, r2, r3)
            return
    }
    ...
    public android.content.Intent df() {
            ...
            r1.append(r2)
            java.lang.String r2 = ".intent.action.OPEN_FILEMANAGER"
            r1.append(r2)
