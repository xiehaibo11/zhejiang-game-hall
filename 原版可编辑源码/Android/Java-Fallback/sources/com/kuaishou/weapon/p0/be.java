...
public class be {
    ...
    public be(android.content.Context r4, int r5) {
            r3 = this;
            r3.<init>()
    ...
    public org.json.JSONObject a(org.json.JSONArray r7) {
            r6 = this;
            r0 = 0
            if (r7 == 0) goto L6f
            int r1 = r7.length()
        ...
        Lf:
            ...
            if (r2 >= r3) goto L68
            java.lang.String r3 = r7.getString(r2)     // Catch: java.lang.Exception -> L6f
            java.lang.String r4 = "data/data"
            boolean r4 = r3.contains(r4)     // Catch: java.lang.Exception -> L6f
            if (r4 == 0) goto L65
            java.lang.String r4 = "libjnigraphics.so"
            boolean r4 = r3.contains(r4)     // Catch: java.lang.Exception -> L6f
            r5 = 1
            if (r4 == 0) goto L35
            java.lang.String r4 = "0"
            r1.put(r4, r5)     // Catch: java.lang.Exception -> L6f
            java.lang.String r4 = "0-p"
        L31:
            r1.put(r4, r3)     // Catch: java.lang.Exception -> L6f
            goto L65
        L35:
            java.lang.String r4 = "libandroid.so"
            boolean r4 = r3.contains(r4)     // Catch: java.lang.Exception -> L6f
            if (r4 == 0) goto L45
            java.lang.String r4 = "1"
            r1.put(r4, r5)     // Catch: java.lang.Exception -> L6f
            java.lang.String r4 = "1-p"
            goto L31
        L45:
            java.lang.String r4 = "libjavacrypto.so"
            boolean r4 = r3.contains(r4)     // Catch: java.lang.Exception -> L6f
            if (r4 == 0) goto L55
            java.lang.String r4 = "2"
            r1.put(r4, r5)     // Catch: java.lang.Exception -> L6f
            java.lang.String r4 = "2-p"
            goto L31
        L55:
            java.lang.String r4 = "libRSCpuRef.so"
            boolean r4 = r3.contains(r4)     // Catch: java.lang.Exception -> L6f
            if (r4 == 0) goto L65
            java.lang.String r4 = "3"
            r1.put(r4, r5)     // Catch: java.lang.Exception -> L6f
            java.lang.String r4 = "3-p"
            goto L31
        L65:
            int r2 = r2 + 1
            goto Lf
        L68:
            int r7 = r1.length()     // Catch: java.lang.Exception -> L6f
            if (r7 <= 0) goto L6f
            return r1
        L6f:
            return r0
