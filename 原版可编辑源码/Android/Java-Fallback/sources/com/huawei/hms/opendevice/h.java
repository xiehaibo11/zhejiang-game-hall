...
public class h {
    ...
    public static android.os.Messenger a(com.huawei.hms.opendevice.h r0) {
            android.os.Messenger r0 = r0.b
            return r0
    }

    public static android.os.Messenger a(com.huawei.hms.opendevice.h r0, android.os.Messenger r1) {
            r0.b = r1
            return r1
    }

    public static android.content.ServiceConnection b(com.huawei.hms.opendevice.h r0) {
    ...
    public boolean a(android.content.Context r2, android.os.Bundle r3, android.content.Intent r4) {
            ...
            com.huawei.hms.opendevice.g r0 = new com.huawei.hms.opendevice.g
            r0.<init>(r1, r3, r2)
            r1.a = r0
