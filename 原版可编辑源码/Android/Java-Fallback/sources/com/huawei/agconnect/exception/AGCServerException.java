...
public class AGCServerException extends com.huawei.agconnect.exception.AGCException {
    ...
    public AGCServerException(java.lang.String r1, int r2) {
            r0 = this;
            r0.<init>(r1, r2)
            return
    }

    public AGCServerException(java.lang.String r1, int r2, int r3) {
            r0 = this;
            r0.<init>(r1, r2)
            r0.retCode = r3
            return
