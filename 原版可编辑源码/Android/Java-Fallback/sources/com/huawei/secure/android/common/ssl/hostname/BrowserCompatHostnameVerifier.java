...
public class BrowserCompatHostnameVerifier implements javax.net.ssl.HostnameVerifier {
    ...
    public boolean verify(java.lang.String r5, javax.net.ssl.SSLSession r6) {
            ...
            com.huawei.secure.android.common.ssl.hostname.b.a(r5, r6, r1)     // Catch: javax.net.ssl.SSLException -> L2c
            r5 = 1
            return r5
        L2c:
            r5 = move-exception
