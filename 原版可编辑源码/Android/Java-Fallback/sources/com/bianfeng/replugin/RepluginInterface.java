...
public class RepluginInterface extends com.bianfeng.ymnsdk.feature.YmnPluginWrapper {
    private static final java.lang.String CHECK_HAS_REPLUGIN = "check_has_replugin";
    ...
    @com.bianfeng.ymnsdk.feature.protocol.YFunction(name = "check_has_replugin")
    public void checkHasReplugin() {
            r2 = this;
            r0 = 139000(0x21ef8, float:1.9478E-40)
            java.lang.String r1 = "存在replugin"
            r2.sendResult(r0, r1)
            return
    }
