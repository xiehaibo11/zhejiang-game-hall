...
public class NubiaDeviceIDHelper {
    ...
    public NubiaDeviceIDHelper(android.content.Context r1) {
            r0 = this;
            r0.<init>()
            r0.mConetxt = r1
            return
    ...
    public java.lang.String getNubiaID() {
            r5 = this;
            ...
            if (r2 <= r3) goto L2d
            android.content.Context r2 = r5.mConetxt     // Catch: java.lang.Exception -> L4d
