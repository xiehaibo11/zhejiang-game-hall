...
public class UrlConfig {
    ...
    public java.lang.String getBackupHost() {
            r2 = this;
            com.bianfeng.ymnsdk.entity.UrlConfig$Backup r0 = r2.getBackup()
            if (r0 != 0) goto L8
            r1 = 0
            return r1
        L8:
    ...
    public int getMaxBackupFails() {
            ...
            return r1
        L8:
            int r1 = r0.getMax_fails()
            return r1
    }

    public int getMaxNormalFails() {
            r2 = this;
            com.bianfeng.ymnsdk.entity.UrlConfig$Normal r0 = r2.getNormal()
            if (r0 != 0) goto L8
            r1 = 0
            return r1
        L8:
