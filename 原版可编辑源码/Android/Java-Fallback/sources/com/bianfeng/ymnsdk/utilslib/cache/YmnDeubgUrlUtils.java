...
public class YmnDeubgUrlUtils {
    ...
    public java.lang.String getDebugUrl() {
        ...
        L28:
            ...
            java.lang.String r0 = r2.getProperty(r3)     // Catch: java.lang.Exception -> L3c
            return r0
        L3c:
            r1 = move-exception
            r1.printStackTrace()
    ...
    public java.lang.String getDebugUrl(java.lang.String r3) {
            r2 = this;
            java.util.Map<java.lang.String, java.lang.String> r0 = r2.urlMap     // Catch: java.lang.Exception -> L9
            java.lang.Object r0 = r0.get(r3)     // Catch: java.lang.Exception -> L9
    ...
    public void initDebugUrl() {
            r4 = this;
            java.lang.String r0 = r4.getDebugUrl()
            boolean r1 = android.text.TextUtils.isEmpty(r0)
            if (r1 == 0) goto Lb
            return
        Lb:
            com.bianfeng.ymnsdk.utilslib.gson.GsonUtils r1 = com.bianfeng.ymnsdk.utilslib.UtilsSdk.getGsonUtils()     // Catch: java.lang.Exception -> L30
            boolean r1 = r1.isJsonObject(r0)     // Catch: java.lang.Exception -> L30
            if (r1 != 0) goto L16
            return
        L16:
            com.bianfeng.ymnsdk.utilslib.gson.GsonUtils r1 = com.bianfeng.ymnsdk.utilslib.UtilsSdk.getGsonUtils()     // Catch: java.lang.Exception -> L30
            java.util.Map r1 = r1.getMapFrom(r0)     // Catch: java.lang.Exception -> L30
            java.lang.String r2 = "data"
            java.lang.Object r2 = r1.get(r2)     // Catch: java.lang.Exception -> L30
            com.bianfeng.ymnsdk.utilslib.gson.GsonUtils r3 = com.bianfeng.ymnsdk.utilslib.UtilsSdk.getGsonUtils()     // Catch: java.lang.Exception -> L30
            java.util.Map r3 = r3.getMapFrom(r2)     // Catch: java.lang.Exception -> L30
            r4.urlMap = r3     // Catch: java.lang.Exception -> L30
            return
        L30:
            r1 = move-exception
            r1.printStackTrace()
            java.lang.String r2 = "ymnsdk"
            java.lang.String r3 = "测试路径格式配置错误"
