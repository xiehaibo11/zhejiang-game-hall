...
public class g extends android.widget.HorizontalScrollView implements com.sigmob.sdk.mraid2.i {
    ...
    static int a(com.sigmob.sdk.mraid2.g r0) {
            int r0 = r0.i
            return r0
    }

    static int a(com.sigmob.sdk.mraid2.g r0, int r1) {
            r0.i = r1
            return r1
    }
    ...
    static com.sigmob.sdk.mraid2.b.c b(com.sigmob.sdk.mraid2.g r0) {
    ...
    public void a(com.sigmob.sdk.mraid2.e r7, int r8, int r9) {
            ...
            r8.<init>()
            r8.append(r4)
            java.lang.String r0 = "------是否翻页----"
            r8.append(r0)
            r8.append(r2)
            java.lang.String r8 = r8.toString()
            android.util.Log.d(r9, r8)
            com.sigmob.sdk.mraid2.g$2 r8 = new com.sigmob.sdk.mraid2.g$2
            r0 = r8
            r1 = r6
            r5 = r7
    ...
    public void b(int r2, int r3) {
            ...
            int r2 = r2.getWidth()
            com.sigmob.sdk.mraid2.g$1 r0 = new com.sigmob.sdk.mraid2.g$1
            r0.<init>(r1, r3, r2)
            r1.post(r0)
            return
    }
