...
public abstract class SaxAsyncHttpResponseHandler<T extends org.xml.sax.helpers.DefaultHandler> extends com.loopj.android.http.AsyncHttpResponseHandler {
    private static final java.lang.String LOG_TAG = "SaxAsyncHttpRH";
    private T handler;

    public SaxAsyncHttpResponseHandler(T r2) {
            r1 = this;
            r1.<init>()
            r0 = 0
            r1.handler = r0
        ...
        Lb:
            ...
            java.lang.String r0 = "null instance of <T extends DefaultHandler> passed to constructor"
            r2.<init>(r0)
            throw r2
    }
    ...
    public abstract void onFailure(int r1, cz.msebera.android.httpclient.Header[] r2, T r3);

    @Override
    public void onFailure(int r1, cz.msebera.android.httpclient.Header[] r2, byte[] r3, java.lang.Throwable r4) {
            r0 = this;
            T extends org.xml.sax.helpers.DefaultHandler r3 = r0.handler
            r0.onFailure(r1, r2, r3)
            return
    }

    public abstract void onSuccess(int r1, cz.msebera.android.httpclient.Header[] r2, T r3);
