...
/* JADX WARN: Classes with same name are omitted, all sources:
  ...
  classes4.dex
 */
public class DownloadApkResponseEvent extends com.ymnsdk.replugin.event.base.SepperllitaEvent {
    public DownloadApkResponseEvent(android.app.Activity r1) {
            r0 = this;
            r0.<init>(r1)
            ...
            r0.setBl(r1)
            java.lang.String r1 = "下载整包结束"
            r0.setLabel(r1)
            return
    }

    public DownloadApkResponseEvent(android.app.Activity r2, int r3, java.lang.String r4, java.lang.String r5, long r6, int r8, java.lang.String r9, int r10, long r11) {
            r1 = this;
            r1.<init>(r2)
