...
/* JADX WARN: Classes with same name are omitted, all sources:
  ...
  classes4.dex
 */
public class MergePatchResponseEvent extends com.ymnsdk.replugin.event.base.SepperllitaEvent {
    public MergePatchResponseEvent(android.app.Activity r1) {
            r0 = this;
            r0.<init>(r1)
            ...
            r0.setBl(r1)
            java.lang.String r1 = "合并patch"
            r0.setLabel(r1)
            return
    }

    public MergePatchResponseEvent(android.app.Activity r2, int r3, java.lang.String r4, int r5, java.lang.String r6, long r7) {
            r1 = this;
            r1.<init>(r2)
