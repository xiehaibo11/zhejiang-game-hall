...
/* JADX WARN: Classes with same name are omitted, all sources:
  ...
  classes4.dex
 */
public class NotStartSilentDownloadEvent extends com.ymnsdk.replugin.event.base.SepperllitaEvent {
    public NotStartSilentDownloadEvent(android.app.Activity r2, int r3) {
            r1 = this;
            r1.<init>(r2)
