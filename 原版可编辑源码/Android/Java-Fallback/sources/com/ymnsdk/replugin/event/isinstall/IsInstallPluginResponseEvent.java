...
/* JADX WARN: Classes with same name are omitted, all sources:
  ...
  classes4.dex
 */
public class IsInstallPluginResponseEvent extends com.ymnsdk.replugin.event.base.SepperllitaEvent {
    public IsInstallPluginResponseEvent(android.app.Activity r1) {
            r0 = this;
            r0.<init>(r1)
            ...
            r0.setBl(r1)
            java.lang.String r1 = "请求判断插件安装情况响应"
            r0.setLabel(r1)
            return
    }

    public IsInstallPluginResponseEvent(android.app.Activity r2, int r3, java.lang.String r4, java.lang.String r5, int r6, java.lang.String r7, long r8) {
            r1 = this;
            r1.<init>(r2)
