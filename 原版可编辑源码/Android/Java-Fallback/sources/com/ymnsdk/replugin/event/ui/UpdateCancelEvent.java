...
/* JADX WARN: Classes with same name are omitted, all sources:
  ...
  classes4.dex
 */
public class UpdateCancelEvent extends com.ymnsdk.replugin.event.base.SepperllitaEvent {
    public UpdateCancelEvent(android.app.Activity r2, java.lang.String r3) {
            r1 = this;
            r1.<init>(r2)
            ...
            r1.setBl(r0)
            java.lang.String r0 = "插件更新弹窗用户取消"
            r1.setLabel(r0)
