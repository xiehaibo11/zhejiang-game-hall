...
/* JADX WARN: Classes with same name are omitted, all sources:
  ...
  classes4.dex
 */
public class QueryPluginInfoDetailRequestEvent extends com.ymnsdk.replugin.event.base.SepperllitaEvent {
    public QueryPluginInfoDetailRequestEvent(android.app.Activity r1) {
            r0 = this;
            r0.<init>(r1)
            ...
            r0.setBl(r1)
            java.lang.String r1 = "请求插件详情"
            r0.setLabel(r1)
            return
    }

    public QueryPluginInfoDetailRequestEvent(android.app.Activity r2, int r3, java.lang.String r4) {
            r1 = this;
            r1.<init>(r2)
