...
/* JADX WARN: Classes with same name are omitted, all sources:
  ...
  classes4.dex
 */
public class QueryPluginInfoDetailResponseEvent extends com.ymnsdk.replugin.event.base.SepperllitaEvent {
    public QueryPluginInfoDetailResponseEvent(android.app.Activity r1) {
            r0 = this;
            r0.<init>(r1)
            ...
            r0.setBl(r1)
            java.lang.String r1 = "请求插件详情响应"
            r0.setLabel(r1)
            return
    }

    public QueryPluginInfoDetailResponseEvent(android.app.Activity r2, int r3, java.lang.String r4, java.lang.String r5, int r6, java.lang.String r7, int r8, long r9) {
            r1 = this;
            r1.<init>(r2)
