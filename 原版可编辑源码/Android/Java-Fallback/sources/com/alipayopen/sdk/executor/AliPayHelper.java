package com.alipayopen.sdk.executor;
...
public class AliPayHelper implements android.os.Handler.Callback {
    ...
    private com.alipayopen.sdk.OnPayListener listener;
    private java.lang.String orderInfo;



    static {
            com.alipayopen.sdk.executor.AliPayHelper$1 r0 = new com.alipayopen.sdk.executor.AliPayHelper$1
            r0.<init>()
            com.alipayopen.sdk.executor.AliPayHelper.resultStatus = r0
            return
    }
    ...
    static boolean access$000(com.alipayopen.sdk.executor.AliPayHelper r0, java.lang.String r1) {
    ...
    private boolean onPay(java.lang.String r5) {
            r4 = this;
            r0 = 0
            com.alipayopen.sdk.executor.AliPayHelper.onPaying = r0
            r1 = 1
    ...
    public boolean handleMessage(android.os.Message r4) {
            ...
            goto L6f
        Lf:
            com.alipayopen.sdk.OnPayListener r4 = r3.listener
            r1 = 150(0x96, float:2.1E-43)
            r4.onFailure(r1, r0)
            goto L6f
        L17:
            com.alipayopen.sdk.executor.AlipayResult r4 = new com.alipayopen.sdk.executor.AlipayResult
            r4.<init>(r0)
            java.lang.String r4 = r4.getResultStatus()
            int r0 = com.alipayopen.sdk.executor.AlipayRsa.checkSign(r0)
            if (r0 != r1) goto L38
            com.alipayopen.sdk.OnPayListener r4 = r3.listener
            java.util.Map<java.lang.String, java.lang.String> r1 = com.alipayopen.sdk.executor.AliPayHelper.resultStatus
        ...
        L48:
            ...
            com.alipayopen.sdk.OnPayListener r0 = r3.listener
            int r1 = r3.toInt(r4)
            java.util.Map<java.lang.String, java.lang.String> r2 = com.alipayopen.sdk.executor.AliPayHelper.resultStatus
    ...
    public void start(java.lang.String r2, com.alipayopen.sdk.OnPayListener r3) {
            r1 = this;
            boolean r0 = com.alipayopen.sdk.executor.AliPayHelper.onPaying
            if (r0 == 0) goto Lc
        ...
        Lc:
            ...
            com.alipayopen.sdk.executor.AliPayHelper$2 r0 = new com.alipayopen.sdk.executor.AliPayHelper$2
            r0.<init>(r1, r2)
            r3.<init>(r0)
            r3.start()
            return
