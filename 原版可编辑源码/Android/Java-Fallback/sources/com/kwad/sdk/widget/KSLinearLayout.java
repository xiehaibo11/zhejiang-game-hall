...
public class KSLinearLayout extends android.widget.LinearLayout implements com.kwad.sdk.widget.i {
    ...
    public KSLinearLayout(android.content.Context r3) {
            r2 = this;
            r2.<init>(r3)
    ...
    public KSLinearLayout(android.content.Context r3, android.util.AttributeSet r4) {
            r2 = this;
            r2.<init>(r3, r4)
            java.util.concurrent.atomic.AtomicBoolean r0 = new java.util.concurrent.atomic.AtomicBoolean
            r1 = 1
    ...
    public KSLinearLayout(android.content.Context r2, android.util.AttributeSet r3, int r4) {
            r1 = this;
            r1.<init>(r2, r3, r4)
    ...
    private void sn() {
            ...
            if (r0 == 0) goto L13
            java.lang.String r0 = "KSLinearLayout"
