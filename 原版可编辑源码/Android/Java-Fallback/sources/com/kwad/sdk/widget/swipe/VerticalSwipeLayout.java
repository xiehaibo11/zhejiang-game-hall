...
public class VerticalSwipeLayout extends android.widget.FrameLayout {
    private int aMr;
    private int aMs;
    private com.kwad.sdk.widget.swipe.a aMt;
    private java.util.List<com.kwad.sdk.widget.swipe.VerticalSwipeLayout.a> aMu;
    private float fx;
    private float fy;
    ...
    public VerticalSwipeLayout(android.content.Context r2) {
            r1 = this;
            r1.<init>(r2)
            r0 = 0
            r1.aMs = r0
    ...
    public VerticalSwipeLayout(android.content.Context r1, android.util.AttributeSet r2) {
            r0 = this;
            r0.<init>(r1, r2)
            r2 = 0
            r0.aMs = r2
    ...
    public VerticalSwipeLayout(android.content.Context r1, android.util.AttributeSet r2, int r3) {
            r0 = this;
            r0.<init>(r1, r2, r3)
            r2 = 0
            r0.aMs = r2
    ...
    private synchronized void KM() {
            r2 = this;
            monitor-enter(r2)
            java.util.List<com.kwad.sdk.widget.swipe.VerticalSwipeLayout$a> r0 = r2.aMu     // Catch: java.lang.Throwable -> L19
        ...
        L7:
            ...
            com.kwad.sdk.widget.swipe.VerticalSwipeLayout$a r1 = (com.kwad.sdk.widget.swipe.VerticalSwipeLayout.a) r1     // Catch: java.lang.Throwable -> L19
            r1.dZ()     // Catch: java.lang.Throwable -> L19
            goto L7
        L17:
            monitor-exit(r2)
            return
    ...
    private synchronized void KN() {
        ...
        L7:
            ...
            java.lang.Object r1 = r0.next()     // Catch: java.lang.Throwable -> L19
            com.kwad.sdk.widget.swipe.VerticalSwipeLayout$a r1 = (com.kwad.sdk.widget.swipe.VerticalSwipeLayout.a) r1     // Catch: java.lang.Throwable -> L19
            r1.dY()     // Catch: java.lang.Throwable -> L19
            goto L7
        L17:
            monitor-exit(r2)
            return
    ...
    public final synchronized void a(com.kwad.sdk.widget.swipe.VerticalSwipeLayout.a r2) {
            r1 = this;
            monitor-enter(r1)
            java.util.List<com.kwad.sdk.widget.swipe.VerticalSwipeLayout$a> r0 = r1.aMu     // Catch: java.lang.Throwable -> L8
    ...
    public final synchronized void b(com.kwad.sdk.widget.swipe.VerticalSwipeLayout.a r2) {
            r1 = this;
            monitor-enter(r1)
            java.util.List<com.kwad.sdk.widget.swipe.VerticalSwipeLayout$a> r0 = r1.aMu     // Catch: java.lang.Throwable -> L8
    ...
    public boolean dispatchTouchEvent(android.view.MotionEvent r3) {
            r2 = this;
            java.util.List<com.kwad.sdk.widget.swipe.VerticalSwipeLayout$a> r0 = r2.aMu
            if (r0 == 0) goto L24
    ...
    public synchronized java.util.List<com.kwad.sdk.widget.swipe.VerticalSwipeLayout.a> getOnSwipedListeners() {
            r1 = this;
            monitor-enter(r1)
            java.util.List<com.kwad.sdk.widget.swipe.VerticalSwipeLayout$a> r0 = r1.aMu     // Catch: java.lang.Throwable -> L5
            monitor-exit(r1)
            return r0
        L5:
            r0 = move-exception
    ...
    public boolean onInterceptTouchEvent(android.view.MotionEvent r3) {
            ...
            if (r0 == 0) goto L13
            java.lang.String r3 = "VerticalSwipeLayout"
