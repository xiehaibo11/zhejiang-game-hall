...
abstract class DelegateDialogFragment extends android.support.v4.app.DialogFragment implements com.kwad.sdk.api.core.fragment.IDelegateFragment {
    private com.kwad.sdk.api.core.fragment.IDialogFragmentLifecycle mBase;

    DelegateDialogFragment(com.kwad.sdk.api.core.fragment.KsDialogFragment r1) {
            r0 = this;
            r0.<init>()
            r0.mBase = r1
            return
    ...
    public com.kwad.sdk.api.core.fragment.KsFragment getBase() {
            r1 = this;
            com.kwad.sdk.api.core.fragment.IDialogFragmentLifecycle r0 = r1.mBase
    ...
    public void onAttachFragment(android.support.v4.app.Fragment r3) {
            ...
            if (r0 == 0) goto L10
            com.kwad.sdk.api.core.fragment.IDialogFragmentLifecycle r0 = r2.mBase
        ...
        L10:
            if (r3 != 0) goto L19
            com.kwad.sdk.api.core.fragment.IDialogFragmentLifecycle r3 = r2.mBase
            r0 = 0
    ...
    void setBase(com.kwad.sdk.api.core.fragment.KsDialogFragment r1) {
            r0 = this;
            r0.mBase = r1
            return
    }

    void superOnCancel(android.content.DialogInterface r1) {
            r0 = this;
            super.onCancel(r1)
            return
    }

    android.app.Dialog superOnCreateDialog(android.os.Bundle r1) {
            r0 = this;
            android.app.Dialog r1 = super.onCreateDialog(r1)
            return r1
    }

    void superOnDismiss(android.content.DialogInterface r1) {
            r0 = this;
            super.onDismiss(r1)
            return
    }
