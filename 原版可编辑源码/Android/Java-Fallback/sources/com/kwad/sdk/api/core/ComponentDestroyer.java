...
public class ComponentDestroyer {
    private static final java.lang.String TAG = "ComponentDestroyer";
    ...
    public static void destroyActivity(android.app.Activity r1) {
            if (r1 != 0) goto L3
            return
        L3:
            android.view.Window r0 = r1.getWindow()
            destroyActivity(r1, r0)
            return
    }
    ...
    public static void destroyFragment(android.support.v4.app.Fragment r2) {
            if (r2 != 0) goto L3
            return
        L3:
            ...
            fixInputMethodManagerLeak(r2, r0)
            return
    }

    private static synchronized void destroyWebViewInTree(android.view.View r4) {
            java.lang.Class<com.kwad.sdk.api.core.ComponentDestroyer> r0 = com.kwad.sdk.api.core.ComponentDestroyer.class
            monitor-enter(r0)
            if (r4 != 0) goto L7
            monitor-exit(r0)
            return
