...
public class KSCornerButton extends android.widget.Button {
    private com.kwad.sdk.widget.h mViewRCHelper;

    public KSCornerButton(android.content.Context r2) {
            r1 = this;
            r1.<init>(r2)
            r0 = 0
            r1.a(r2, r0)
    ...
    public KSCornerButton(android.content.Context r1, android.util.AttributeSet r2) {
            r0 = this;
            r0.<init>(r1, r2)
            r0.a(r1, r2)
            return
    ...
    public KSCornerButton(android.content.Context r1, android.util.AttributeSet r2, int r3) {
            r0 = this;
            r0.<init>(r1, r2, r3)
            r0.a(r1, r2)
            return
    ...
    public KSCornerButton(android.content.Context r1, android.util.AttributeSet r2, int r3, int r4) {
            r0 = this;
            r0.<init>(r1, r2, r3, r4)
            r0.a(r1, r2)
            return
