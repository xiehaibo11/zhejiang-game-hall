...
public final class rg implements javax.net.ssl.HostnameVerifier {
    private static final java.util.regex.Pattern df = null;
    public static final com.bykv.vk.openvk.api.plugin.rg.rg rg = null;

    static {
            com.bykv.vk.openvk.api.plugin.rg.rg r0 = new com.bykv.vk.openvk.api.plugin.rg.rg
            r0.<init>()
            com.bykv.vk.openvk.api.plugin.rg.rg.rg = r0
            java.lang.String r0 = "([0-9a-fA-F]*:[0-9a-fA-F:.]*)|([\\d.]+)"
            java.util.regex.Pattern r0 = java.util.regex.Pattern.compile(r0)
            com.bykv.vk.openvk.api.plugin.rg.rg.df = r0
            return
    }
    ...
    private boolean df(java.lang.String r5, java.security.cert.X509Certificate r6) {
            r4 = this;
            r0 = 7
            java.util.List r6 = rg(r6, r0)
            int r0 = r6.size()
            r1 = 0
            r2 = r1
        Lb:
    ...
    private boolean q(java.lang.String r7, java.security.cert.X509Certificate r8) {
            r6 = this;
            java.util.Locale r0 = java.util.Locale.US
            java.lang.String r7 = r7.toLowerCase(r0)
            r0 = 2
            java.util.List r0 = rg(r8, r0)
            int r1 = r0.size()
            r2 = 1
            r3 = 0
            r4 = r3
        ...
        L26:
            ...
            com.bykv.vk.openvk.api.plugin.rg.df r0 = new com.bykv.vk.openvk.api.plugin.rg.df
            r0.<init>(r8)
            java.lang.String r8 = "cn"
            java.lang.String r8 = r0.rg(r8)
            if (r8 == 0) goto L3e
            boolean r7 = r6.rg(r7, r8)
            return r7
        L3e:
            return r3
    }

    private static java.util.List<java.lang.String> rg(java.security.cert.X509Certificate r4, int r5) {
    ...
    private static boolean rg(java.lang.String r1) {
            java.util.regex.Pattern r0 = com.bykv.vk.openvk.api.plugin.rg.rg.df
            java.util.regex.Matcher r1 = r0.matcher(r1)
            boolean r1 = r1.matches()
            return r1
    }

    private boolean rg(java.lang.String r8, java.lang.String r9) {
            r7 = this;
            r0 = 0
            if (r8 == 0) goto Lb4
            int r1 = r8.length()
    ...
    private boolean rg(java.lang.String r2, java.security.cert.X509Certificate r3) {
            r1 = this;
            boolean r0 = rg(r2)
            if (r0 == 0) goto Lb
            boolean r2 = r1.df(r2, r3)
            goto Lf
        Lb:
            boolean r2 = r1.q(r2, r3)
        Lf:
            return r2
    }
    ...
    public boolean verify(java.lang.String r2, javax.net.ssl.SSLSession r3) {
            ...
            boolean r2 = r1.rg(r2, r3)     // Catch: javax.net.ssl.SSLException -> Le
            return r2
        Le:
            return r0
    }
