...
public final class f<T extends android.view.View, K> implements com.mbridge.msdk.dycreator.binding.base.BaseStrategy {
    public f() {
            r0 = this;
            r0.<init>()
            return
    ...
    public final void bindClickData(android.view.View r1, com.mbridge.msdk.dycreator.f.a.a r2) {
            ...
            com.mbridge.msdk.dycreator.listener.action.EAction r2 = com.mbridge.msdk.dycreator.listener.action.EAction.PERMISSION_INFO
            r1.seteAction(r2)
