...
public final class c<T extends android.view.View, K> implements com.mbridge.msdk.dycreator.binding.base.BaseStrategy {
    public c() {
            r0 = this;
            r0.<init>()
            return
    ...
    public final void bindClickData(android.view.View r1, com.mbridge.msdk.dycreator.f.a.a r2) {
            ...
            com.mbridge.msdk.dycreator.listener.action.EAction r2 = com.mbridge.msdk.dycreator.listener.action.EAction.CLOSE
            r1.seteAction(r2)
