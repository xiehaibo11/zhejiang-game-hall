...
final class Mp4WebvttSubtitle implements com.mbridge.msdk.playercommon.exoplayer2.text.Subtitle {
    private final java.util.List<com.mbridge.msdk.playercommon.exoplayer2.text.Cue> cues;

    public Mp4WebvttSubtitle(java.util.List<com.mbridge.msdk.playercommon.exoplayer2.text.Cue> r1) {
            r0 = this;
            r0.<init>()
