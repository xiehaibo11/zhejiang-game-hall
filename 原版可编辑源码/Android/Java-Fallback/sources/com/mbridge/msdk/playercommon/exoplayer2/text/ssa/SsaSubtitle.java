...
final class SsaSubtitle implements com.mbridge.msdk.playercommon.exoplayer2.text.Subtitle {
    private final long[] cueTimesUs;
    private final com.mbridge.msdk.playercommon.exoplayer2.text.Cue[] cues;

    public SsaSubtitle(com.mbridge.msdk.playercommon.exoplayer2.text.Cue[] r1, long[] r2) {
            r0 = this;
            r0.<init>()
            r0.cues = r1
            r0.cueTimesUs = r2
