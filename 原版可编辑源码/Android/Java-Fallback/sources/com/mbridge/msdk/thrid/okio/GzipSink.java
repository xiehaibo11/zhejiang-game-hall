...
public final class GzipSink implements com.mbridge.msdk.thrid.okio.Sink {
    private boolean closed;
    private final java.util.zip.CRC32 crc;
    private final java.util.zip.Deflater deflater;
    private final com.mbridge.msdk.thrid.okio.DeflaterSink deflaterSink;
    private final com.mbridge.msdk.thrid.okio.BufferedSink sink;

    public GzipSink(com.mbridge.msdk.thrid.okio.Sink r4) {
            r3 = this;
            r3.<init>()
            ...
            r0.<init>(r1, r2)
            r3.deflater = r0
            com.mbridge.msdk.thrid.okio.BufferedSink r4 = com.mbridge.msdk.thrid.okio.Okio.buffer(r4)
            r3.sink = r4
            com.mbridge.msdk.thrid.okio.DeflaterSink r0 = new com.mbridge.msdk.thrid.okio.DeflaterSink
    ...
    private void updateCrc(com.mbridge.msdk.thrid.okio.Buffer r5, long r6) {
            r4 = this;
    ...
    private void writeHeader() {
            r2 = this;
            com.mbridge.msdk.thrid.okio.BufferedSink r0 = r2.sink
    ...
    public void close() throws java.io.IOException {
        ...
        L5:
            r0 = 0
            com.mbridge.msdk.thrid.okio.DeflaterSink r1 = r2.deflaterSink     // Catch: java.lang.Throwable -> Lf
        ...
        L16:
            ...
            r0 = r1
        L1a:
            com.mbridge.msdk.thrid.okio.BufferedSink r1 = r2.sink     // Catch: java.lang.Throwable -> L20
    ...
    public void flush() throws java.io.IOException {
            r1 = this;
            com.mbridge.msdk.thrid.okio.DeflaterSink r0 = r1.deflaterSink
            r0.flush()
            return
    }
    ...
    public void write(com.mbridge.msdk.thrid.okio.Buffer r3, long r4) throws java.io.IOException {
        ...
        L9:
            r2.updateCrc(r3, r4)
            com.mbridge.msdk.thrid.okio.DeflaterSink r0 = r2.deflaterSink
            r0.write(r3, r4)
            return
        L12:
