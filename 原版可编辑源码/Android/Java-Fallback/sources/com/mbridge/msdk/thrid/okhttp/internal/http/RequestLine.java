...
public final class RequestLine {
    ...
    public static java.lang.String get(com.mbridge.msdk.thrid.okhttp.Request r2, java.net.Proxy.Type r3) {
    ...
    private static boolean includeAuthorityInRequestLine(com.mbridge.msdk.thrid.okhttp.Request r0, java.net.Proxy.Type r1) {
    ...
    public static java.lang.String requestPath(com.mbridge.msdk.thrid.okhttp.HttpUrl r2) {
