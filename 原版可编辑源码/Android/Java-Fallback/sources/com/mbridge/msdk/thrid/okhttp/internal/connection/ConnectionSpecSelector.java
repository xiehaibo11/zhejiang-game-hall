...
public final class ConnectionSpecSelector {
    private final java.util.List<com.mbridge.msdk.thrid.okhttp.ConnectionSpec> connectionSpecs;
    private boolean isFallback;
    private boolean isFallbackPossible;
    private int nextModeIndex;

    public ConnectionSpecSelector(java.util.List<com.mbridge.msdk.thrid.okhttp.ConnectionSpec> r2) {
            r1 = this;
            r1.<init>()
            r0 = 0
            r1.nextModeIndex = r0
    ...
    private boolean isFallbackPossible(javax.net.ssl.SSLSocket r3) {
        ...
        L2:
            java.util.List<com.mbridge.msdk.thrid.okhttp.ConnectionSpec> r1 = r2.connectionSpecs
            int r1 = r1.size()
            if (r0 >= r1) goto L1d
            java.util.List<com.mbridge.msdk.thrid.okhttp.ConnectionSpec> r1 = r2.connectionSpecs
            java.lang.Object r1 = r1.get(r0)
            com.mbridge.msdk.thrid.okhttp.ConnectionSpec r1 = (com.mbridge.msdk.thrid.okhttp.ConnectionSpec) r1
    ...
    public com.mbridge.msdk.thrid.okhttp.ConnectionSpec configureSecureSocket(javax.net.ssl.SSLSocket r5) throws java.io.IOException {
            r4 = this;
            int r0 = r4.nextModeIndex
            java.util.List<com.mbridge.msdk.thrid.okhttp.ConnectionSpec> r1 = r4.connectionSpecs
            int r1 = r1.size()
        L8:
            if (r0 >= r1) goto L20
            java.util.List<com.mbridge.msdk.thrid.okhttp.ConnectionSpec> r2 = r4.connectionSpecs
            java.lang.Object r2 = r2.get(r0)
            com.mbridge.msdk.thrid.okhttp.ConnectionSpec r2 = (com.mbridge.msdk.thrid.okhttp.ConnectionSpec) r2
