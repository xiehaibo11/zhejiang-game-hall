...
public final class Route {
    final com.mbridge.msdk.thrid.okhttp.Address address;
    final java.net.InetSocketAddress inetSocketAddress;
    final java.net.Proxy proxy;

    public Route(com.mbridge.msdk.thrid.okhttp.Address r1, java.net.Proxy r2, java.net.InetSocketAddress r3) {
            r0 = this;
            r0.<init>()
            if (r1 == 0) goto L20
            if (r2 == 0) goto L18
    ...
    public com.mbridge.msdk.thrid.okhttp.Address address() {
            r1 = this;
    ...
    public boolean equals(@javax.annotation.Nullable java.lang.Object r3) {
            r2 = this;
            boolean r0 = r3 instanceof com.mbridge.msdk.thrid.okhttp.Route
            if (r0 == 0) goto L26
            com.mbridge.msdk.thrid.okhttp.Route r3 = (com.mbridge.msdk.thrid.okhttp.Route) r3
            com.mbridge.msdk.thrid.okhttp.Address r0 = r3.address
            com.mbridge.msdk.thrid.okhttp.Address r1 = r2.address
    ...
    public int hashCode() {
            r2 = this;
            com.mbridge.msdk.thrid.okhttp.Address r0 = r2.address
            int r0 = r0.hashCode()
