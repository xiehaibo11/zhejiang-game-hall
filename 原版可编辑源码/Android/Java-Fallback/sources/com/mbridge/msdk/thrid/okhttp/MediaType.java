...
public final class MediaType {
    ...
    static {
            ...
            com.mbridge.msdk.thrid.okhttp.MediaType.TYPE_SUBTYPE = r0
            java.lang.String r0 = ";\\s*(?:([a-zA-Z0-9-!#$%&'*+.^_`{|}~]+)=(?:([a-zA-Z0-9-!#$%&'*+.^_`{|}~]+)|\"([^\"]*)\"))?"
            java.util.regex.Pattern r0 = java.util.regex.Pattern.compile(r0)
            com.mbridge.msdk.thrid.okhttp.MediaType.PARAMETER = r0
            return
    }
    ...
    public static com.mbridge.msdk.thrid.okhttp.MediaType get(java.lang.String r11) {
            java.util.regex.Pattern r0 = com.mbridge.msdk.thrid.okhttp.MediaType.TYPE_SUBTYPE
            ...
            r6 = 0
            java.util.regex.Pattern r7 = com.mbridge.msdk.thrid.okhttp.MediaType.PARAMETER
        ...
        Lb4:
            ...
            throw r1
        Ld8:
            com.mbridge.msdk.thrid.okhttp.MediaType r0 = new com.mbridge.msdk.thrid.okhttp.MediaType
    ...
    @javax.annotation.Nullable
    public static com.mbridge.msdk.thrid.okhttp.MediaType parse(java.lang.String r0) {
            com.mbridge.msdk.thrid.okhttp.MediaType r0 = get(r0)     // Catch: java.lang.IllegalArgumentException -> L5
            return r0
        L5:
            r0 = 0
            return r0
    ...
    public boolean equals(@javax.annotation.Nullable java.lang.Object r2) {
            r1 = this;
            boolean r0 = r2 instanceof com.mbridge.msdk.thrid.okhttp.MediaType
            if (r0 == 0) goto L12
            com.mbridge.msdk.thrid.okhttp.MediaType r2 = (com.mbridge.msdk.thrid.okhttp.MediaType) r2
