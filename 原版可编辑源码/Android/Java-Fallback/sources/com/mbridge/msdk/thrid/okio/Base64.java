...
final class Base64 {
    ...
    static {
            ...
            com.mbridge.msdk.thrid.okio.Base64.MAP = r1
            byte[] r0 = new byte[r0]
            ...
            com.mbridge.msdk.thrid.okio.Base64.URL_MAP = r0
            return
    }
    ...
    public static java.lang.String encode(byte[] r1) {
            byte[] r0 = com.mbridge.msdk.thrid.okio.Base64.MAP
    ...
    public static java.lang.String encodeUrl(byte[] r1) {
            byte[] r0 = com.mbridge.msdk.thrid.okio.Base64.URL_MAP
            java.lang.String r1 = encode(r1, r0)
            return r1
    }
}
