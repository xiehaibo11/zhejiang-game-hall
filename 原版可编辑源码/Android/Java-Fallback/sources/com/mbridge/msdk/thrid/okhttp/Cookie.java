...
public final class Cookie {
    ...
    public static final class Builder {
        ...
        private com.mbridge.msdk.thrid.okhttp.Cookie.Builder domain(java.lang.String r3, boolean r4) {
                r2 = this;
                if (r3 == 0) goto L24
                java.lang.String r0 = com.mbridge.msdk.thrid.okhttp.internal.Util.canonicalizeHost(r3)
                if (r0 == 0) goto Ld
                r2.domain = r0
                r2.hostOnly = r4
                return r2
        ...
        public com.mbridge.msdk.thrid.okhttp.Cookie build() {
                r1 = this;
        ...
        public com.mbridge.msdk.thrid.okhttp.Cookie.Builder domain(java.lang.String r2) {
                r1 = this;
                r0 = 0
                com.mbridge.msdk.thrid.okhttp.Cookie$Builder r2 = r1.domain(r2, r0)
                return r2
        }

        public com.mbridge.msdk.thrid.okhttp.Cookie.Builder expiresAt(long r4) {
                r3 = this;
                r0 = 0
        ...
        public com.mbridge.msdk.thrid.okhttp.Cookie.Builder hostOnlyDomain(java.lang.String r2) {
                r1 = this;
                r0 = 1
                com.mbridge.msdk.thrid.okhttp.Cookie$Builder r2 = r1.domain(r2, r0)
                return r2
        ...
        public com.mbridge.msdk.thrid.okhttp.Cookie.Builder httpOnly() {
                r1 = this;
                r0 = 1
                r1.httpOnly = r0
                return r1
        ...
        public com.mbridge.msdk.thrid.okhttp.Cookie.Builder name(java.lang.String r2) {
                r1 = this;
                if (r2 == 0) goto L17
        ...
        public com.mbridge.msdk.thrid.okhttp.Cookie.Builder path(java.lang.String r2) {
                r1 = this;
                java.lang.String r0 = "/"
        ...
        public com.mbridge.msdk.thrid.okhttp.Cookie.Builder secure() {
                r1 = this;
                r0 = 1
                r1.secure = r0
                return r1
        ...
        public com.mbridge.msdk.thrid.okhttp.Cookie.Builder value(java.lang.String r2) {
                r1 = this;
                if (r2 == 0) goto L17
                java.lang.String r0 = r2.trim()
                boolean r0 = r0.equals(r2)
    ...
    static {
            ...
            com.mbridge.msdk.thrid.okhttp.Cookie.YEAR_PATTERN = r0
            java.lang.String r0 = "(?i)(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec).*"
            java.util.regex.Pattern r0 = java.util.regex.Pattern.compile(r0)
            com.mbridge.msdk.thrid.okhttp.Cookie.MONTH_PATTERN = r0
            java.lang.String r0 = "(\\d{1,2})[^\\d]*"
            java.util.regex.Pattern r0 = java.util.regex.Pattern.compile(r0)
            com.mbridge.msdk.thrid.okhttp.Cookie.DAY_OF_MONTH_PATTERN = r0
            java.lang.String r0 = "(\\d{1,2}):(\\d{1,2}):(\\d{1,2})[^\\d]*"
            java.util.regex.Pattern r0 = java.util.regex.Pattern.compile(r0)
            com.mbridge.msdk.thrid.okhttp.Cookie.TIME_PATTERN = r0
            return
    }

    Cookie(com.mbridge.msdk.thrid.okhttp.Cookie.Builder r3) {
            r2 = this;
            r2.<init>()
    ...
    private static boolean domainMatch(java.lang.String r2, java.lang.String r3) {
        ...
        L8:
            ...
            r0 = 46
            if (r3 != r0) goto L27
            boolean r2 = com.mbridge.msdk.thrid.okhttp.internal.Util.verifyAsIpAddress(r2)
            if (r2 != 0) goto L27
            return r1
        L27:
            r2 = 0
    ...
    static com.mbridge.msdk.thrid.okhttp.Cookie parse(long r23, com.mbridge.msdk.thrid.okhttp.HttpUrl r25, java.lang.String r26) {
            ...
            r2 = 59
            r3 = 0
            int r4 = com.mbridge.msdk.thrid.okhttp.internal.Util.delimiterOffset(r0, r3, r1, r2)
            r5 = 61
            int r6 = com.mbridge.msdk.thrid.okhttp.internal.Util.delimiterOffset(r0, r3, r4, r5)
            r7 = 0
            if (r6 != r4) goto L17
            return r7
        L17:
            java.lang.String r9 = com.mbridge.msdk.thrid.okhttp.internal.Util.trimSubstring(r0, r3, r6)
        ...
        L4c:
            if (r4 >= r1) goto Lba
            int r7 = com.mbridge.msdk.thrid.okhttp.internal.Util.delimiterOffset(r0, r4, r1, r2)
            int r2 = com.mbridge.msdk.thrid.okhttp.internal.Util.delimiterOffset(r0, r4, r7, r5)
            java.lang.String r4 = com.mbridge.msdk.thrid.okhttp.internal.Util.trimSubstring(r0, r4, r2)
            if (r2 >= r7) goto L63
            int r2 = r2 + 1
            java.lang.String r2 = com.mbridge.msdk.thrid.okhttp.internal.Util.trimSubstring(r0, r2, r7)
            goto L65
        L63:
            java.lang.String r2 = ""
        L65:
            ...
            long r21 = parseExpires(r2, r3, r4)     // Catch: java.lang.Throwable -> Lb2
            goto L82
        L76:
            java.lang.String r5 = "max-age"
            boolean r5 = r4.equalsIgnoreCase(r5)
            if (r5 == 0) goto L85
            long r19 = parseMaxAge(r2)
        L82:
            r18 = 1
            goto Lb2
        L85:
            ...
            boolean r5 = r4.equalsIgnoreCase(r5)
            if (r5 == 0) goto L94
            java.lang.String r14 = parseDomain(r2)     // Catch: java.lang.Throwable -> Lb2
            r17 = r3
            goto Lb2
        L94:
    ...
    @javax.annotation.Nullable
    public static com.mbridge.msdk.thrid.okhttp.Cookie parse(com.mbridge.msdk.thrid.okhttp.HttpUrl r2, java.lang.String r3) {
            long r0 = java.lang.System.currentTimeMillis()
            com.mbridge.msdk.thrid.okhttp.Cookie r2 = parse(r0, r2, r3)
            return r2
    }

    public static java.util.List<com.mbridge.msdk.thrid.okhttp.Cookie> parseAll(com.mbridge.msdk.thrid.okhttp.HttpUrl r4, com.mbridge.msdk.thrid.okhttp.Headers r5) {
        ...
        Lc:
            ...
            com.mbridge.msdk.thrid.okhttp.Cookie r3 = parse(r4, r3)
            if (r3 != 0) goto L1b
            goto L25
        L1b:
            if (r1 != 0) goto L22
    ...
    private static java.lang.String parseDomain(java.lang.String r2) {
        ...
        L13:
            java.lang.String r2 = com.mbridge.msdk.thrid.okhttp.internal.Util.canonicalizeHost(r2)
            if (r2 == 0) goto L1a
            return r2
        L1a:
            java.lang.IllegalArgumentException r2 = new java.lang.IllegalArgumentException
    ...
    private static long parseExpires(java.lang.String r12, int r13, int r14) {
            ...
            java.util.regex.Pattern r1 = com.mbridge.msdk.thrid.okhttp.Cookie.TIME_PATTERN
        ...
        L12:
            ...
            r1.region(r13, r11)
            if (r4 != r2) goto L47
            java.util.regex.Pattern r13 = com.mbridge.msdk.thrid.okhttp.Cookie.TIME_PATTERN
        ...
        L47:
            if (r5 != r2) goto L5e
            java.util.regex.Pattern r13 = com.mbridge.msdk.thrid.okhttp.Cookie.DAY_OF_MONTH_PATTERN
            java.util.regex.Matcher r13 = r1.usePattern(r13)
            boolean r13 = r13.matches()
            if (r13 == 0) goto L5e
            java.lang.String r13 = r1.group(r10)
        ...
        L5e:
            if (r6 != r2) goto L83
            java.util.regex.Pattern r13 = com.mbridge.msdk.thrid.okhttp.Cookie.MONTH_PATTERN
            java.util.regex.Matcher r13 = r1.usePattern(r13)
            boolean r13 = r13.matches()
            if (r13 == 0) goto L83
            java.lang.String r13 = r1.group(r10)
            ...
            java.util.regex.Pattern r6 = com.mbridge.msdk.thrid.okhttp.Cookie.MONTH_PATTERN
        ...
        L83:
            if (r3 != r2) goto L99
            java.util.regex.Pattern r13 = com.mbridge.msdk.thrid.okhttp.Cookie.YEAR_PATTERN
            java.util.regex.Matcher r13 = r1.usePattern(r13)
            boolean r13 = r13.matches()
            if (r13 == 0) goto L99
            java.lang.String r13 = r1.group(r10)
        ...
        Lb3:
            ...
            java.util.TimeZone r13 = com.mbridge.msdk.thrid.okhttp.internal.Util.UTC
            r12.<init>(r13)
            r12.setLenient(r0)
            r12.set(r10, r3)
            int r6 = r6 - r10
    ...
    private static boolean pathMatch(com.mbridge.msdk.thrid.okhttp.HttpUrl r2, java.lang.String r3) {
    ...
    public boolean equals(@javax.annotation.Nullable java.lang.Object r7) {
            r6 = this;
            boolean r0 = r7 instanceof com.mbridge.msdk.thrid.okhttp.Cookie
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            com.mbridge.msdk.thrid.okhttp.Cookie r7 = (com.mbridge.msdk.thrid.okhttp.Cookie) r7
    ...
    public boolean matches(com.mbridge.msdk.thrid.okhttp.HttpUrl r3) {
            r2 = this;
    ...
    java.lang.String toString(boolean r6) {
        ...
        L26:
            ...
            r1.<init>(r2)
            java.lang.String r1 = com.mbridge.msdk.thrid.okhttp.internal.http.HttpDate.format(r1)
            r0.append(r1)
        L39:
