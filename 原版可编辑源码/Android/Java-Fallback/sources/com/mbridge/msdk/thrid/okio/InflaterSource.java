...
public final class InflaterSource implements com.mbridge.msdk.thrid.okio.Source {
    private int bufferBytesHeldByInflater;
    private boolean closed;
    private final java.util.zip.Inflater inflater;
    private final com.mbridge.msdk.thrid.okio.BufferedSource source;

    InflaterSource(com.mbridge.msdk.thrid.okio.BufferedSource r1, java.util.zip.Inflater r2) {
            r0 = this;
            r0.<init>()
            if (r1 == 0) goto L14
            if (r2 == 0) goto Lc
    ...
    public InflaterSource(com.mbridge.msdk.thrid.okio.Source r1, java.util.zip.Inflater r2) {
            r0 = this;
    ...
    private void releaseInflatedBytes() throws java.io.IOException {
        ...
        L5:
            ...
            com.mbridge.msdk.thrid.okio.BufferedSource r1 = r4.source
            long r2 = (long) r0
            r1.skip(r2)
            return
    }
    ...
    public long read(com.mbridge.msdk.thrid.okio.Buffer r7, long r8) throws java.io.IOException {
        ...
        Ld:
            ...
            r1 = 1
            com.mbridge.msdk.thrid.okio.Segment r1 = r7.writableSegment(r1)     // Catch: java.util.zip.DataFormatException -> L69
        ...
        L54:
            ...
            if (r8 != r9) goto L66
            com.mbridge.msdk.thrid.okio.Segment r8 = r1.pop()     // Catch: java.util.zip.DataFormatException -> L69
            r7.head = r8     // Catch: java.util.zip.DataFormatException -> L69
            com.mbridge.msdk.thrid.okio.SegmentPool.recycle(r1)     // Catch: java.util.zip.DataFormatException -> L69
        L66:
            r7 = -1
            return r7
        L69:
    ...
    public final boolean refill() throws java.io.IOException {
        ...
        L1f:
            ...
            com.mbridge.msdk.thrid.okio.Segment r0 = r0.head
            int r2 = r0.limit
            int r3 = r0.pos
            int r2 = r2 - r3
