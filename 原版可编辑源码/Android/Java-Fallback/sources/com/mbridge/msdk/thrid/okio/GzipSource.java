...
public final class GzipSource implements com.mbridge.msdk.thrid.okio.Source {
    ...
    private final com.mbridge.msdk.thrid.okio.InflaterSource inflaterSource;
    private int section;
    private final com.mbridge.msdk.thrid.okio.BufferedSource source;

    public GzipSource(com.mbridge.msdk.thrid.okio.Source r3) {
            r2 = this;
            r2.<init>()
            r0 = 0
            r2.section = r0
            ...
            r0.<init>(r1)
            r2.inflater = r0
            com.mbridge.msdk.thrid.okio.BufferedSource r3 = com.mbridge.msdk.thrid.okio.Okio.buffer(r3)
            r2.source = r3
            com.mbridge.msdk.thrid.okio.InflaterSource r0 = new com.mbridge.msdk.thrid.okio.InflaterSource
            java.util.zip.Inflater r1 = r2.inflater
            r0.<init>(r3, r1)
            r2.inflaterSource = r0
            return
        L27:
    ...
    private void consumeHeader() throws java.io.IOException {
        ...
        L1f:
            if (r10 == 0) goto L30
            com.mbridge.msdk.thrid.okio.BufferedSource r0 = r6.source
            com.mbridge.msdk.thrid.okio.Buffer r1 = r0.buffer()
            r2 = 0
            r4 = 10
            r0 = r17
    ...
    private void updateCrc(com.mbridge.msdk.thrid.okio.Buffer r5, long r6, long r8) {
            r4 = this;
    ...
    public void close() throws java.io.IOException {
            r1 = this;
            com.mbridge.msdk.thrid.okio.InflaterSource r0 = r1.inflaterSource
            r0.close()
            return
    }

    @Override
    public long read(com.mbridge.msdk.thrid.okio.Buffer r12, long r13) throws java.io.IOException {
            r11 = this;
            r0 = 0
        ...
        L13:
            ...
            if (r0 != r1) goto L2f
            long r7 = r12.size
            com.mbridge.msdk.thrid.okio.InflaterSource r0 = r11.inflaterSource
        ...
        L2f:
            ...
            r12 = 3
            r11.section = r12
            com.mbridge.msdk.thrid.okio.BufferedSource r12 = r11.source
