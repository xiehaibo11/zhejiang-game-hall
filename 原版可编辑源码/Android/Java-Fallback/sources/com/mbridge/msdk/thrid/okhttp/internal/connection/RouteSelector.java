...
public final class RouteSelector {
    private final com.mbridge.msdk.thrid.okhttp.Address address;
    ...
    private final java.util.List<com.mbridge.msdk.thrid.okhttp.Route> postponedRoutes;
    private java.util.List<java.net.Proxy> proxies;
    private final com.mbridge.msdk.thrid.okhttp.internal.connection.RouteDatabase routeDatabase;

    public static final class Selection {
        private int nextRouteIndex;
        private final java.util.List<com.mbridge.msdk.thrid.okhttp.Route> routes;

        Selection(java.util.List<com.mbridge.msdk.thrid.okhttp.Route> r2) {
                r1 = this;
                r1.<init>()
                r0 = 0
        ...
        public java.util.List<com.mbridge.msdk.thrid.okhttp.Route> getAll() {
                r2 = this;
                java.util.ArrayList r0 = new java.util.ArrayList
                java.util.List<com.mbridge.msdk.thrid.okhttp.Route> r1 = r2.routes
                r0.<init>(r1)
                return r0
        }
        ...
        public com.mbridge.msdk.thrid.okhttp.Route next() {
                r3 = this;
                boolean r0 = r3.hasNext()
                if (r0 == 0) goto L15
                java.util.List<com.mbridge.msdk.thrid.okhttp.Route> r0 = r3.routes
                int r1 = r3.nextRouteIndex
                int r2 = r1 + 1
                r3.nextRouteIndex = r2
                java.lang.Object r0 = r0.get(r1)
                com.mbridge.msdk.thrid.okhttp.Route r0 = (com.mbridge.msdk.thrid.okhttp.Route) r0
                return r0
            L15:
    ...
    public RouteSelector(com.mbridge.msdk.thrid.okhttp.Address r2, com.mbridge.msdk.thrid.okhttp.internal.connection.RouteDatabase r3, com.mbridge.msdk.thrid.okhttp.Call r4, com.mbridge.msdk.thrid.okhttp.EventListener r5) {
            r1 = this;
            r1.<init>()
            ...
            r1.call = r4
            r1.eventListener = r5
            com.mbridge.msdk.thrid.okhttp.HttpUrl r3 = r2.url()
    ...
    private java.net.Proxy nextProxy() throws java.io.IOException {
        ...
        L18:
            ...
            r1.append(r2)
            com.mbridge.msdk.thrid.okhttp.Address r2 = r3.address
    ...
    private void resetNextInetSocketAddress(java.net.Proxy r7) throws java.io.IOException {
        ...
        L2b:
            ...
            throw r7
        L46:
            com.mbridge.msdk.thrid.okhttp.Address r0 = r6.address
        ...
        L74:
            ...
            com.mbridge.msdk.thrid.okhttp.Call r2 = r6.call
            r7.dnsStart(r2, r1)
            com.mbridge.msdk.thrid.okhttp.Address r7 = r6.address
            com.mbridge.msdk.thrid.okhttp.Dns r7 = r7.dns()
            java.util.List r7 = r7.lookup(r1)
            boolean r2 = r7.isEmpty()
            if (r2 != 0) goto Lad
            com.mbridge.msdk.thrid.okhttp.EventListener r2 = r6.eventListener
            com.mbridge.msdk.thrid.okhttp.Call r3 = r6.call
            r2.dnsEnd(r3, r1, r7)
            r1 = 0
            int r2 = r7.size()
        L97:
        ...
        Lad:
            ...
            r0.<init>()
            com.mbridge.msdk.thrid.okhttp.Address r2 = r6.address
            com.mbridge.msdk.thrid.okhttp.Dns r2 = r2.dns()
            r0.append(r2)
    ...
    private void resetNextProxy(com.mbridge.msdk.thrid.okhttp.HttpUrl r2, java.net.Proxy r3) {
            r1 = this;
            r0 = 0
            if (r3 == 0) goto La
            ...
            goto L32
        La:
            com.mbridge.msdk.thrid.okhttp.Address r3 = r1.address
            ...
            if (r3 != 0) goto L25
            java.util.List r2 = com.mbridge.msdk.thrid.okhttp.internal.Util.immutableList(r2)
            goto L30
        L25:
            r2 = 1
    ...
    public void connectFailed(com.mbridge.msdk.thrid.okhttp.Route r4, java.io.IOException r5) {
            r3 = this;
            java.net.Proxy r0 = r4.proxy()
            java.net.Proxy$Type r0 = r0.type()
            java.net.Proxy$Type r1 = java.net.Proxy.Type.DIRECT
            if (r0 == r1) goto L2f
            com.mbridge.msdk.thrid.okhttp.Address r0 = r3.address
            java.net.ProxySelector r0 = r0.proxySelector()
            if (r0 == 0) goto L2f
            com.mbridge.msdk.thrid.okhttp.Address r0 = r3.address
            java.net.ProxySelector r0 = r0.proxySelector()
            com.mbridge.msdk.thrid.okhttp.Address r1 = r3.address
        ...
        L2f:
            com.mbridge.msdk.thrid.okhttp.internal.connection.RouteDatabase r5 = r3.routeDatabase
            r5.failed(r4)
            return
    }
    ...
    public boolean hasNext() {
            ...
            if (r0 != 0) goto L11
            java.util.List<com.mbridge.msdk.thrid.okhttp.Route> r0 = r1.postponedRoutes
    ...
    public com.mbridge.msdk.thrid.okhttp.internal.connection.RouteSelector.Selection next() throws java.io.IOException {
            r7 = this;
        ...
        L1c:
            if (r2 >= r3) goto L41
            com.mbridge.msdk.thrid.okhttp.Route r4 = new com.mbridge.msdk.thrid.okhttp.Route
            com.mbridge.msdk.thrid.okhttp.Address r5 = r7.address
            ...
            r4.<init>(r5, r1, r6)
            com.mbridge.msdk.thrid.okhttp.internal.connection.RouteDatabase r5 = r7.routeDatabase
            boolean r5 = r5.shouldPostpone(r4)
            if (r5 == 0) goto L3b
            java.util.List<com.mbridge.msdk.thrid.okhttp.Route> r5 = r7.postponedRoutes
            r5.add(r4)
            goto L3e
        L3b:
            r0.add(r4)
        ...
        L47:
            boolean r1 = r0.isEmpty()
            if (r1 == 0) goto L57
            java.util.List<com.mbridge.msdk.thrid.okhttp.Route> r1 = r7.postponedRoutes
            r0.addAll(r1)
            java.util.List<com.mbridge.msdk.thrid.okhttp.Route> r1 = r7.postponedRoutes
            r1.clear()
        L57:
            com.mbridge.msdk.thrid.okhttp.internal.connection.RouteSelector$Selection r1 = new com.mbridge.msdk.thrid.okhttp.internal.connection.RouteSelector$Selection
            r1.<init>(r0)
            return r1
        L5d:
            java.util.NoSuchElementException r0 = new java.util.NoSuchElementException
