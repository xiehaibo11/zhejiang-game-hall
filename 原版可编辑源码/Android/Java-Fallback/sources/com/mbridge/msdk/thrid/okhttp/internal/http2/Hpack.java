...
final class Hpack {
    static final java.util.Map<com.mbridge.msdk.thrid.okio.ByteString, java.lang.Integer> NAME_TO_FIRST_INDEX = null;
    private static final int PREFIX_4_BITS = 15;
    private static final int PREFIX_5_BITS = 31;
    private static final int PREFIX_6_BITS = 63;
    private static final int PREFIX_7_BITS = 127;
    static final com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] STATIC_HEADER_TABLE = null;

    static final class Reader {
        com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] dynamicTable;
        int dynamicTableByteCount;
        int headerCount;
        private final java.util.List<com.mbridge.msdk.thrid.okhttp.internal.http2.Header> headerList;
        private final int headerTableSizeSetting;
        private int maxDynamicTableByteCount;
        int nextHeaderIndex;
        private final com.mbridge.msdk.thrid.okio.BufferedSource source;

        Reader(int r2, int r3, com.mbridge.msdk.thrid.okio.Source r4) {
                r1 = this;
                r1.<init>()
                ...
                r1.headerList = r0
                r0 = 8
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r0 = new com.mbridge.msdk.thrid.okhttp.internal.http2.Header[r0]
                r1.dynamicTable = r0
                int r0 = r0.length
                int r0 = r0 + (-1)
                ...
                com.mbridge.msdk.thrid.okio.BufferedSource r2 = com.mbridge.msdk.thrid.okio.Okio.buffer(r4)
                r1.source = r2
                return
        }

        Reader(int r1, com.mbridge.msdk.thrid.okio.Source r2) {
                r0 = this;
                r0.<init>(r1, r1, r2)
                return
        }
        ...
        private void clearDynamicTable() {
                r2 = this;
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r0 = r2.dynamicTable
                r1 = 0
        ...
        private int evictToRecoverBytes(int r5) {
                ...
                r0 = 0
                if (r5 <= 0) goto L3e
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r1 = r4.dynamicTable
                int r1 = r1.length
                int r1 = r1 + (-1)
            L8:
                ...
                if (r1 < r2) goto L2b
                if (r5 <= 0) goto L2b
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r2 = r4.dynamicTable
                r2 = r2[r1]
                int r2 = r2.hpackSize
                int r5 = r5 - r2
                int r2 = r4.dynamicTableByteCount
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r3 = r4.dynamicTable
                r3 = r3[r1]
                int r3 = r3.hpackSize
                int r2 = r2 - r3
                ...
                goto L8
            L2b:
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r5 = r4.dynamicTable
        ...
        private com.mbridge.msdk.thrid.okio.ByteString getName(int r4) throws java.io.IOException {
                r3 = this;
                boolean r0 = r3.isStaticHeader(r4)
                if (r0 == 0) goto Ld
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r0 = com.mbridge.msdk.thrid.okhttp.internal.http2.Hpack.STATIC_HEADER_TABLE
                r4 = r0[r4]
                com.mbridge.msdk.thrid.okio.ByteString r4 = r4.name
                return r4
            Ld:
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r0 = com.mbridge.msdk.thrid.okhttp.internal.http2.Hpack.STATIC_HEADER_TABLE
                int r0 = r0.length
                ...
                if (r0 < 0) goto L22
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r1 = r3.dynamicTable
                int r2 = r1.length
                if (r0 >= r2) goto L22
                r4 = r1[r0]
                com.mbridge.msdk.thrid.okio.ByteString r4 = r4.name
        ...
        private void insertIntoDynamicTable(int r6, com.mbridge.msdk.thrid.okhttp.internal.http2.Header r7) {
                r5 = this;
                java.util.List<com.mbridge.msdk.thrid.okhttp.internal.http2.Header> r0 = r5.headerList
                r0.add(r7)
                int r0 = r7.hpackSize
                r1 = -1
                if (r6 == r1) goto L15
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r2 = r5.dynamicTable
            ...
            L1d:
                ...
                int r6 = r6 + 1
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r1 = r5.dynamicTable
                int r2 = r1.length
                if (r6 <= r2) goto L44
                int r6 = r1.length
                int r6 = r6 * 2
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r6 = new com.mbridge.msdk.thrid.okhttp.internal.http2.Header[r6]
                r2 = 0
                int r3 = r1.length
                int r4 = r1.length
        ...
        private boolean isStaticHeader(int r3) {
                ...
                r0 = 1
                if (r3 < 0) goto La
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r1 = com.mbridge.msdk.thrid.okhttp.internal.http2.Hpack.STATIC_HEADER_TABLE
                int r1 = r1.length
                int r1 = r1 - r0
                if (r3 > r1) goto La
                goto Lb
        ...
        private void readIndexedHeader(int r4) throws java.io.IOException {
                ...
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r0 = com.mbridge.msdk.thrid.okhttp.internal.http2.Hpack.STATIC_HEADER_TABLE
                r4 = r0[r4]
                java.util.List<com.mbridge.msdk.thrid.okhttp.internal.http2.Header> r0 = r3.headerList
                r0.add(r4)
                goto L27
            L10:
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r0 = com.mbridge.msdk.thrid.okhttp.internal.http2.Hpack.STATIC_HEADER_TABLE
                ...
                int r2 = r1.length
                if (r0 >= r2) goto L28
                java.util.List<com.mbridge.msdk.thrid.okhttp.internal.http2.Header> r4 = r3.headerList
                r0 = r1[r0]
                r4.add(r0)
            L27:
                return
        ...
        private void readLiteralHeaderWithIncrementalIndexingIndexedName(int r3) throws java.io.IOException {
                r2 = this;
                com.mbridge.msdk.thrid.okio.ByteString r3 = r2.getName(r3)
                com.mbridge.msdk.thrid.okio.ByteString r0 = r2.readByteString()
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header r1 = new com.mbridge.msdk.thrid.okhttp.internal.http2.Header
                r1.<init>(r3, r0)
                r3 = -1
        ...
        private void readLiteralHeaderWithIncrementalIndexingNewName() throws java.io.IOException {
                r3 = this;
                com.mbridge.msdk.thrid.okio.ByteString r0 = r3.readByteString()
                com.mbridge.msdk.thrid.okio.ByteString r0 = com.mbridge.msdk.thrid.okhttp.internal.http2.Hpack.checkLowercase(r0)
                com.mbridge.msdk.thrid.okio.ByteString r1 = r3.readByteString()
        ...
        private void readLiteralHeaderWithoutIndexingIndexedName(int r4) throws java.io.IOException {
                r3 = this;
                com.mbridge.msdk.thrid.okio.ByteString r4 = r3.getName(r4)
                com.mbridge.msdk.thrid.okio.ByteString r0 = r3.readByteString()
                java.util.List<com.mbridge.msdk.thrid.okhttp.internal.http2.Header> r1 = r3.headerList
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header r2 = new com.mbridge.msdk.thrid.okhttp.internal.http2.Header
                r2.<init>(r4, r0)
                r1.add(r2)
                return
        ...
        private void readLiteralHeaderWithoutIndexingNewName() throws java.io.IOException {
                r4 = this;
                com.mbridge.msdk.thrid.okio.ByteString r0 = r4.readByteString()
                com.mbridge.msdk.thrid.okio.ByteString r0 = com.mbridge.msdk.thrid.okhttp.internal.http2.Hpack.checkLowercase(r0)
                com.mbridge.msdk.thrid.okio.ByteString r1 = r4.readByteString()
                java.util.List<com.mbridge.msdk.thrid.okhttp.internal.http2.Header> r2 = r4.headerList
        ...
        public java.util.List<com.mbridge.msdk.thrid.okhttp.internal.http2.Header> getAndResetHeaderList() {
                r2 = this;
                java.util.ArrayList r0 = new java.util.ArrayList
                java.util.List<com.mbridge.msdk.thrid.okhttp.internal.http2.Header> r1 = r2.headerList
                r0.<init>(r1)
                java.util.List<com.mbridge.msdk.thrid.okhttp.internal.http2.Header> r1 = r2.headerList
                r1.clear()
                return r0
        ...
        com.mbridge.msdk.thrid.okio.ByteString readByteString() throws java.io.IOException {
            ...
            Ld:
                ...
                if (r1 == 0) goto L29
                com.mbridge.msdk.thrid.okhttp.internal.http2.Huffman r1 = com.mbridge.msdk.thrid.okhttp.internal.http2.Huffman.get()
                ...
                return r0
            L29:
                com.mbridge.msdk.thrid.okio.BufferedSource r1 = r5.source
                long r2 = (long) r0
                com.mbridge.msdk.thrid.okio.ByteString r0 = r1.readByteString(r2)
                return r0
        }
    ...
    static final class Writer {
        ...
        int maxDynamicTableByteCount;
        int nextHeaderIndex;
        private final com.mbridge.msdk.thrid.okio.Buffer out;
        private int smallestHeaderTableSizeSetting;
        private final boolean useCompression;

        Writer(int r2, boolean r3, com.mbridge.msdk.thrid.okio.Buffer r4) {
                r1 = this;
                r1.<init>()
        ...
        Writer(com.mbridge.msdk.thrid.okio.Buffer r3) {
                r2 = this;
        ...
        private void insertIntoDynamicTable(com.mbridge.msdk.thrid.okhttp.internal.http2.Header r7) {
                r6 = this;
                int r0 = r7.hpackSize
            ...
            La:
                ...
                int r1 = r1 + 1
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r2 = r6.dynamicTable
                int r3 = r2.length
                if (r1 <= r3) goto L2e
                int r1 = r2.length
                int r1 = r1 * 2
                com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r1 = new com.mbridge.msdk.thrid.okhttp.internal.http2.Header[r1]
                r3 = 0
                int r4 = r2.length
                int r5 = r2.length
        ...
        void writeByteString(com.mbridge.msdk.thrid.okio.ByteString r4) throws java.io.IOException {
                r3 = this;
                boolean r0 = r3.useCompression
                r1 = 127(0x7f, float:1.78E-43)
                if (r0 == 0) goto L33
                com.mbridge.msdk.thrid.okhttp.internal.http2.Huffman r0 = com.mbridge.msdk.thrid.okhttp.internal.http2.Huffman.get()
                int r0 = r0.encodedLength(r4)
                int r2 = r4.size()
                if (r0 >= r2) goto L33
                com.mbridge.msdk.thrid.okio.Buffer r0 = new com.mbridge.msdk.thrid.okio.Buffer
                r0.<init>()
                com.mbridge.msdk.thrid.okhttp.internal.http2.Huffman r2 = com.mbridge.msdk.thrid.okhttp.internal.http2.Huffman.get()
                r2.encode(r4, r0)
                com.mbridge.msdk.thrid.okio.ByteString r4 = r0.readByteString()
                int r0 = r4.size()
                r2 = 128(0x80, float:1.8E-43)
                r3.writeInt(r0, r1, r2)
                com.mbridge.msdk.thrid.okio.Buffer r0 = r3.out
                r0.write(r4)
                goto L40
            L33:
                int r0 = r4.size()
        ...
        void writeHeaders(java.util.List<com.mbridge.msdk.thrid.okhttp.internal.http2.Header> r14) throws java.io.IOException {
                r13 = this;
        ...
        void writeInt(int r2, int r3, int r4) {
                r1 = this;
                if (r2 >= r3) goto L9
                com.mbridge.msdk.thrid.okio.Buffer r3 = r1.out
                r2 = r2 | r4
                r3.writeByte(r2)
                return
            L9:
                com.mbridge.msdk.thrid.okio.Buffer r0 = r1.out
                r4 = r4 | r3
                r0.writeByte(r4)
                int r2 = r2 - r3
            L10:
    ...
    static {
            ...
            com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r0 = new com.mbridge.msdk.thrid.okhttp.internal.http2.Header[r0]
            com.mbridge.msdk.thrid.okhttp.internal.http2.Header r1 = new com.mbridge.msdk.thrid.okhttp.internal.http2.Header
            com.mbridge.msdk.thrid.okio.ByteString r2 = com.mbridge.msdk.thrid.okhttp.internal.http2.Header.TARGET_AUTHORITY
            java.lang.String r3 = ""
            r1.<init>(r2, r3)
            r2 = 0
            r0[r2] = r1
            com.mbridge.msdk.thrid.okhttp.internal.http2.Header r1 = new com.mbridge.msdk.thrid.okhttp.internal.http2.Header
            com.mbridge.msdk.thrid.okio.ByteString r2 = com.mbridge.msdk.thrid.okhttp.internal.http2.Header.TARGET_METHOD
            ...
            r0[r2] = r1
            com.mbridge.msdk.thrid.okhttp.internal.http2.Header r1 = new com.mbridge.msdk.thrid.okhttp.internal.http2.Header
            com.mbridge.msdk.thrid.okio.ByteString r2 = com.mbridge.msdk.thrid.okhttp.internal.http2.Header.TARGET_PATH
            java.lang.String r4 = "/"
            r1.<init>(r2, r4)
            r2 = 3
            r0[r2] = r1
            ...
            r0[r2] = r1
            com.mbridge.msdk.thrid.okhttp.internal.http2.Header r1 = new com.mbridge.msdk.thrid.okhttp.internal.http2.Header
            com.mbridge.msdk.thrid.okio.ByteString r2 = com.mbridge.msdk.thrid.okhttp.internal.http2.Header.TARGET_SCHEME
            ...
            r0[r2] = r1
            com.mbridge.msdk.thrid.okhttp.internal.http2.Header r1 = new com.mbridge.msdk.thrid.okhttp.internal.http2.Header
            com.mbridge.msdk.thrid.okio.ByteString r2 = com.mbridge.msdk.thrid.okhttp.internal.http2.Header.RESPONSE_STATUS
            ...
            r2 = 60
            r0[r2] = r1
            com.mbridge.msdk.thrid.okhttp.internal.http2.Hpack.STATIC_HEADER_TABLE = r0
            java.util.Map r0 = nameToFirstIndex()
            com.mbridge.msdk.thrid.okhttp.internal.http2.Hpack.NAME_TO_FIRST_INDEX = r0
            return
    }
    ...
    static com.mbridge.msdk.thrid.okio.ByteString checkLowercase(com.mbridge.msdk.thrid.okio.ByteString r4) throws java.io.IOException {
            int r0 = r4.size()
            r1 = 0
        L5:
            if (r1 >= r0) goto L32
    ...
    private static java.util.Map<com.mbridge.msdk.thrid.okio.ByteString, java.lang.Integer> nameToFirstIndex() {
            ...
            r1 = 0
        L9:
            com.mbridge.msdk.thrid.okhttp.internal.http2.Header[] r2 = com.mbridge.msdk.thrid.okhttp.internal.http2.Hpack.STATIC_HEADER_TABLE
            int r3 = r2.length
            if (r1 >= r3) goto L28
            r2 = r2[r1]
            com.mbridge.msdk.thrid.okio.ByteString r2 = r2.name
