...
public class MBRoundRectImageViewC extends com.mbridge.msdk.widget.custom.baseview.MBImageView {
    ...
    protected void onDraw(android.graphics.Canvas r6) {
            r5 = this;
            android.graphics.drawable.Drawable r0 = r5.getDrawable()     // Catch: java.lang.Exception -> L4c
            if (r0 != 0) goto La
            super.onDraw(r6)     // Catch: java.lang.Exception -> L4c
            return
        La:
            android.graphics.drawable.BitmapDrawable r0 = (android.graphics.drawable.BitmapDrawable) r0     // Catch: java.lang.Exception -> L4c
            android.graphics.Bitmap r0 = r0.getBitmap()     // Catch: java.lang.Exception -> L4c
            android.graphics.Bitmap r0 = r5.a(r0)     // Catch: java.lang.Exception -> L4c
            r1 = 0
            if (r0 == 0) goto L2b
            boolean r2 = r0.isRecycled()     // Catch: java.lang.Exception -> L4c
            if (r2 != 0) goto L2b
            android.content.Context r1 = r5.getContext()     // Catch: java.lang.Exception -> L4c
            r2 = 1092616192(0x41200000, float:10.0)
            int r1 = com.mbridge.msdk.widget.custom.b.a.a(r1, r2)     // Catch: java.lang.Exception -> L4c
            android.graphics.Bitmap r1 = r5.a(r0, r1)     // Catch: java.lang.Exception -> L4c
        L2b:
            if (r1 == 0) goto L56
            boolean r0 = r1.isRecycled()     // Catch: java.lang.Exception -> L4c
            if (r0 != 0) goto L56
            android.graphics.Rect r0 = new android.graphics.Rect     // Catch: java.lang.Exception -> L4c
            int r2 = r1.getWidth()     // Catch: java.lang.Exception -> L4c
            int r3 = r1.getHeight()     // Catch: java.lang.Exception -> L4c
            r4 = 0
            r0.<init>(r4, r4, r2, r3)     // Catch: java.lang.Exception -> L4c
            android.graphics.Paint r2 = r5.a     // Catch: java.lang.Exception -> L4c
            r2.reset()     // Catch: java.lang.Exception -> L4c
            android.graphics.Paint r2 = r5.a     // Catch: java.lang.Exception -> L4c
            r6.drawBitmap(r1, r0, r0, r2)     // Catch: java.lang.Exception -> L4c
            goto L56
        L4c:
            r6 = move-exception
