...
/* JADX WARN: Classes with same name are omitted, all sources:
  ...
  classes3.dex
 */
public class LocalBroadcastManagerAndroidX extends com.qihoo360.replugin.compat.LocalBroadcastManager {
    private final androidx.localbroadcastmanager.content.LocalBroadcastManager localBroadcastManager;

    public LocalBroadcastManagerAndroidX(android.content.Context r1) {
            r0 = this;
            r0.<init>()
    ...
    public void registerReceiver(android.content.BroadcastReceiver r2, android.content.IntentFilter r3) {
            r1 = this;
            androidx.localbroadcastmanager.content.LocalBroadcastManager r0 = r1.localBroadcastManager
