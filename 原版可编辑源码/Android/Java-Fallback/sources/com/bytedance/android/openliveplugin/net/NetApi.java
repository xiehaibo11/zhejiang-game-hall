...
public class NetApi {
    ...
    private static final class Holder {
        private static final com.bytedance.android.openliveplugin.net.NetApi INSTANCE = null;

        static {
                com.bytedance.android.openliveplugin.net.NetApi r0 = new com.bytedance.android.openliveplugin.net.NetApi
                r1 = 0
                r0.<init>(r1)
                com.bytedance.android.openliveplugin.net.NetApi.Holder.INSTANCE = r0
                return
        }
        ...
        static com.bytedance.android.openliveplugin.net.NetApi access$100() {
                com.bytedance.android.openliveplugin.net.NetApi r0 = com.bytedance.android.openliveplugin.net.NetApi.Holder.INSTANCE
                return r0
        }
    }
    ...
    NetApi(com.bytedance.android.openliveplugin.net.NetApi.1 r1) {
            r0 = this;
            r0.<init>()
            return
    }

    private byte[] getBody(org.json.JSONObject r3) {
            r2 = this;
            r0 = 0
            if (r3 != 0) goto L4
            goto Le
        L4:
            ...
            byte[] r0 = r3.getBytes(r1)     // Catch: java.io.UnsupportedEncodingException -> Lf
        Le:
            return r0
        Lf:
            r3 = move-exception
    ...
    public static com.bytedance.android.openliveplugin.net.NetApi getInstance() {
            com.bytedance.android.openliveplugin.net.NetApi r0 = com.bytedance.android.openliveplugin.net.NetApi.Holder.access$100()
            return r0
    }

    private static byte[] inputStreamToByteArray(java.io.InputStream r3, int r4) {
            if (r3 != 0) goto L4
            r3 = 0
            return r3
        L4:
    ...
    private static java.lang.String parseCharset(java.lang.String r6, java.lang.String r7) {
            if (r6 == 0) goto L2e
            r0 = 0
            java.lang.String r1 = ";"
    ...
    public java.lang.String request(boolean r4, java.lang.String r5, byte[] r6) {
            ...
            javax.net.ssl.X509TrustManager r5 = r3.systemDefaultTrustManager()     // Catch: java.lang.Throwable -> L82 java.lang.Exception -> L84
            javax.net.ssl.SSLSocketFactory r5 = r3.systemDefaultSslSocketFactory(r5)     // Catch: java.lang.Throwable -> L82 java.lang.Exception -> L84
            ...
            com.bytedance.android.openliveplugin.net.DefaultHostnameVerifier r1 = com.bytedance.android.openliveplugin.net.DefaultHostnameVerifier.INSTANCE     // Catch: java.lang.Exception -> L80 java.lang.Throwable -> L8d
        ...
        L4d:
            ...
            java.lang.String r4 = parseCharset(r4, r6)     // Catch: java.lang.Exception -> L80 java.lang.Throwable -> L8d
            ...
            byte[] r1 = inputStreamToByteArray(r1, r2)     // Catch: java.lang.Exception -> L80 java.lang.Throwable -> L8d
