...
public class RoundFrameLayout extends android.widget.FrameLayout {
    ...
    public RoundFrameLayout(android.content.Context r2) {
            r1 = this;
            r1.<init>(r2)
    ...
    public RoundFrameLayout(android.content.Context r1, android.util.AttributeSet r2) {
            r0 = this;
            r0.<init>(r1, r2)
    ...
    public RoundFrameLayout(android.content.Context r1, android.util.AttributeSet r2, int r3) {
            r0 = this;
            r0.<init>(r1, r2, r3)
            android.content.Context r1 = r0.getContext()
            r2 = 1092616192(0x41200000, float:10.0)
