...
public class TkayPlayableView extends com.tkay.expressad.video.module.TkayH5EndCardView {
    public TkayPlayableView(android.content.Context r1) {
            r0 = this;
            r0.<init>(r1)
            return
    }

    public TkayPlayableView(android.content.Context r1, android.util.AttributeSet r2) {
            r0 = this;
            r0.<init>(r1, r2)
            return
    }
