...
public class TkayClickMiniCardView extends com.tkay.expressad.video.module.TkayH5EndCardView {
    private static final float A = 0.7f;
    private boolean B;


    public TkayClickMiniCardView(android.content.Context r1) {
            r0 = this;
            r0.<init>(r1)
            r1 = 0
            r0.B = r1
    ...
    public TkayClickMiniCardView(android.content.Context r1, android.util.AttributeSet r2) {
            r0 = this;
            r0.<init>(r1, r2)
            r1 = 0
            r0.B = r1
    ...
    protected final void e() {
            ...
            boolean r0 = r1.f
            if (r0 == 0) goto L19
            java.lang.String r0 = "tkay_reward_minicard_bg"
    ...
    public void setRadius(int r3) {
            ...
            float r3 = (float) r3
            int r3 = com.tkay.expressad.foundation.h.t.b(r1, r3)
            float r3 = (float) r3
            ...
            r1 = 16
            if (r3 < r1) goto L24
            com.tkay.expressad.atsignalcommon.windvane.WindVaneWebView r3 = r2.s
            r3.setBackground(r0)
            goto L29
        L24:
            com.tkay.expressad.atsignalcommon.windvane.WindVaneWebView r3 = r2.s
    ...
    public void setTkayClickMiniCardViewClickable(boolean r1) {
            r0 = this;
            r0.setClickable(r1)
            return
    }
    ...
    public void webviewshow() {
            ...
            if (r0 == 0) goto Le
            com.tkay.expressad.atsignalcommon.windvane.WindVaneWebView r0 = r2.s
            com.tkay.expressad.video.module.TkayClickMiniCardView$1 r1 = new com.tkay.expressad.video.module.TkayClickMiniCardView$1
            r1.<init>(r2)
            r0.post(r1)
        Le:
            return
