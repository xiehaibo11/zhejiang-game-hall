...
public interface CoreConnectionPNames {
    ...
    public static final java.lang.String MIN_CHUNK_LIMIT = "http.connection.min-chunk-limit";
    public static final java.lang.String SOCKET_BUFFER_SIZE = "http.socket.buffer-size";
    public static final java.lang.String SO_KEEPALIVE = "http.socket.keepalive";
    public static final java.lang.String SO_LINGER = "http.socket.linger";
    public static final java.lang.String SO_REUSEADDR = "http.socket.reuseaddr";
