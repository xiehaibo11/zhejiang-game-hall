...
public class DefaultHttpResponseParserFactory implements cz.msebera.android.httpclient.io.HttpMessageParserFactory<cz.msebera.android.httpclient.HttpResponse> {
    public static final cz.msebera.android.httpclient.impl.conn.DefaultHttpResponseParserFactory INSTANCE = null;
    ...
    static {
            cz.msebera.android.httpclient.impl.conn.DefaultHttpResponseParserFactory r0 = new cz.msebera.android.httpclient.impl.conn.DefaultHttpResponseParserFactory
            r0.<init>()
            cz.msebera.android.httpclient.impl.conn.DefaultHttpResponseParserFactory.INSTANCE = r0
            return
    }
    ...
    public DefaultHttpResponseParserFactory(cz.msebera.android.httpclient.HttpResponseFactory r2) {
            r1 = this;
            r0 = 0
            r1.<init>(r0, r2)
            return
