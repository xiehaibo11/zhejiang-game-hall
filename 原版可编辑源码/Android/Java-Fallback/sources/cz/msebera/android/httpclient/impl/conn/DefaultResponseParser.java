...
public class DefaultResponseParser extends cz.msebera.android.httpclient.impl.io.AbstractMessageParser<cz.msebera.android.httpclient.HttpMessage> {
    ...
    public DefaultResponseParser(cz.msebera.android.httpclient.io.SessionInputBuffer r1, cz.msebera.android.httpclient.message.LineParser r2, cz.msebera.android.httpclient.HttpResponseFactory r3, cz.msebera.android.httpclient.params.HttpParams r4) {
            r0 = this;
            r0.<init>(r1, r2, r4)
            ...
            r1.<init>(r2)
            r0.lineBuf = r1
            int r1 = r0.getMaxGarbageLines(r4)
            r0.maxGarbageLines = r1
            return
    }

    protected int getMaxGarbageLines(cz.msebera.android.httpclient.params.HttpParams r3) {
            r2 = this;
            java.lang.String r0 = "http.connection.max-status-line-garbage"
            r1 = 2147483647(0x7fffffff, float:NaN)
            int r3 = r3.getIntParameter(r0, r1)
            return r3
    }
