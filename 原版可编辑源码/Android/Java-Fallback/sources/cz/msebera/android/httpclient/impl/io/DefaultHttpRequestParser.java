...
public class DefaultHttpRequestParser extends cz.msebera.android.httpclient.impl.io.AbstractMessageParser<cz.msebera.android.httpclient.HttpRequest> {
    ...
    public DefaultHttpRequestParser(cz.msebera.android.httpclient.io.SessionInputBuffer r3) {
            r2 = this;
    ...
    public DefaultHttpRequestParser(cz.msebera.android.httpclient.io.SessionInputBuffer r2, cz.msebera.android.httpclient.config.MessageConstraints r3) {
            r1 = this;
            r0 = 0
            r1.<init>(r2, r0, r0, r3)
            return
    ...
    public DefaultHttpRequestParser(cz.msebera.android.httpclient.io.SessionInputBuffer r1, cz.msebera.android.httpclient.message.LineParser r2, cz.msebera.android.httpclient.HttpRequestFactory r3, cz.msebera.android.httpclient.config.MessageConstraints r4) {
            r0 = this;
            r0.<init>(r1, r2, r4)
            if (r3 == 0) goto L6
            goto L8
        L6:
            cz.msebera.android.httpclient.impl.DefaultHttpRequestFactory r3 = cz.msebera.android.httpclient.impl.DefaultHttpRequestFactory.INSTANCE
        L8:
            r0.requestFactory = r3
    ...
    public DefaultHttpRequestParser(cz.msebera.android.httpclient.io.SessionInputBuffer r1, cz.msebera.android.httpclient.message.LineParser r2, cz.msebera.android.httpclient.HttpRequestFactory r3, cz.msebera.android.httpclient.params.HttpParams r4) {
            r0 = this;
            r0.<init>(r1, r2, r4)
    ...
    protected cz.msebera.android.httpclient.HttpMessage parseHead(cz.msebera.android.httpclient.io.SessionInputBuffer r1) throws java.io.IOException, cz.msebera.android.httpclient.HttpException, cz.msebera.android.httpclient.ParseException {
            r0 = this;
            cz.msebera.android.httpclient.HttpRequest r1 = r0.parseHead(r1)
            return r1
    }

    @Override
    protected cz.msebera.android.httpclient.HttpRequest parseHead(cz.msebera.android.httpclient.io.SessionInputBuffer r3) throws java.io.IOException, cz.msebera.android.httpclient.HttpException, cz.msebera.android.httpclient.ParseException {
            r2 = this;
