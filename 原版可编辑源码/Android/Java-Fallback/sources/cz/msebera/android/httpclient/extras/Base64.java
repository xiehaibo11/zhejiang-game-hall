...
public class Base64 {
    ...
    static class Decoder extends cz.msebera.android.httpclient.extras.Base64.Coder {
        ...
        static {
                ...
                cz.msebera.android.httpclient.extras.Base64.Decoder.DECODE = r1
                int[] r0 = new int[r0]
                ...
                cz.msebera.android.httpclient.extras.Base64.Decoder.DECODE_WEBSAFE = r0
                return
        }
        ...
        public Decoder(int r1, byte[] r2) {
                ...
                r1 = r1 & 8
                if (r1 != 0) goto Lc
                int[] r1 = cz.msebera.android.httpclient.extras.Base64.Decoder.DECODE
                goto Le
            Lc:
                int[] r1 = cz.msebera.android.httpclient.extras.Base64.Decoder.DECODE_WEBSAFE
            Le:
                r0.alphabet = r1
                r1 = 0
                r0.state = r1
    ...
    static class Encoder extends cz.msebera.android.httpclient.extras.Base64.Coder {
        static final boolean $assertionsDisabled = false;
        ...
        static {
                ...
                cz.msebera.android.httpclient.extras.Base64.Encoder.ENCODE = r1
                byte[] r0 = new byte[r0]
                ...
                cz.msebera.android.httpclient.extras.Base64.Encoder.ENCODE_WEBSAFE = r0
                return
        }
        ...
        public Encoder(int r3, byte[] r4) {
            ...
            L1f:
                ...
                r3 = r3 & 8
                if (r3 != 0) goto L28
                byte[] r3 = cz.msebera.android.httpclient.extras.Base64.Encoder.ENCODE
                goto L2a
            L28:
                byte[] r3 = cz.msebera.android.httpclient.extras.Base64.Encoder.ENCODE_WEBSAFE
            L2a:
                r2.alphabet = r3
                r3 = 2
                byte[] r3 = new byte[r3]
    ...
    public static byte[] decode(byte[] r2, int r3, int r4, int r5) {
            cz.msebera.android.httpclient.extras.Base64$Decoder r0 = new cz.msebera.android.httpclient.extras.Base64$Decoder
            int r1 = r4 * 3
            int r1 = r1 / 4
            byte[] r1 = new byte[r1]
            r0.<init>(r5, r1)
    ...
    public static byte[] encode(byte[] r5, int r6, int r7, int r8) {
            cz.msebera.android.httpclient.extras.Base64$Encoder r0 = new cz.msebera.android.httpclient.extras.Base64$Encoder
            r1 = 0
            r0.<init>(r8, r1)
            int r8 = r7 / 3
            int r8 = r8 * 4
