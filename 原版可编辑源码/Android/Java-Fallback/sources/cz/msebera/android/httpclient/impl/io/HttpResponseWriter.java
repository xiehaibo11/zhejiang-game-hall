...
public class HttpResponseWriter extends cz.msebera.android.httpclient.impl.io.AbstractMessageWriter<cz.msebera.android.httpclient.HttpResponse> {
    public HttpResponseWriter(cz.msebera.android.httpclient.io.SessionOutputBuffer r1, cz.msebera.android.httpclient.message.LineFormatter r2, cz.msebera.android.httpclient.params.HttpParams r3) {
            r0 = this;
            r0.<init>(r1, r2, r3)
            return
    }
