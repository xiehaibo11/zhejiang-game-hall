...
public class ElGamalKeyPairGenerator implements org.bouncycastle.crypto.AsymmetricCipherKeyPairGenerator {
    ...
    public org.bouncycastle.crypto.AsymmetricCipherKeyPair generateKeyPair() {
            r5 = this;
            org.bouncycastle.crypto.params.ElGamalKeyGenerationParameters r0 = r5.param
            ...
            org.bouncycastle.crypto.params.ElGamalKeyGenerationParameters r3 = r5.param
            ...
            org.bouncycastle.crypto.params.ElGamalPublicKeyParameters r4 = new org.bouncycastle.crypto.params.ElGamalPublicKeyParameters
            r4.<init>(r1, r0)
    ...
    public void init(org.bouncycastle.crypto.KeyGenerationParameters r1) {
            r0 = this;
            org.bouncycastle.crypto.params.ElGamalKeyGenerationParameters r1 = (org.bouncycastle.crypto.params.ElGamalKeyGenerationParameters) r1
            r0.param = r1
            return
    }
}
