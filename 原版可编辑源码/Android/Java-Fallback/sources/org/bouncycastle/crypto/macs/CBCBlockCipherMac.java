...
public class CBCBlockCipherMac implements org.bouncycastle.crypto.Mac {
    ...
    public CBCBlockCipherMac(org.bouncycastle.crypto.BlockCipher r3) {
            r2 = this;
    ...
    public CBCBlockCipherMac(org.bouncycastle.crypto.BlockCipher r2, int r3) {
            r1 = this;
            r0 = 0
            r1.<init>(r2, r3, r0)
            return
    ...
    public CBCBlockCipherMac(org.bouncycastle.crypto.BlockCipher r2, int r3, org.bouncycastle.crypto.paddings.BlockCipherPadding r4) {
            r1 = this;
            r1.<init>()
            int r0 = r3 % 8
            if (r0 != 0) goto L28
    ...
    public CBCBlockCipherMac(org.bouncycastle.crypto.BlockCipher r2, org.bouncycastle.crypto.paddings.BlockCipherPadding r3) {
            r1 = this;
    ...
    @Override
    public void init(org.bouncycastle.crypto.CipherParameters r3) {
            r2 = this;
            r2.reset()
