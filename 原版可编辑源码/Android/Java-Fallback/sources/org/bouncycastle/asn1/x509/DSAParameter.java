...
public class DSAParameter extends org.bouncycastle.asn1.ASN1Encodable {
    org.bouncycastle.asn1.DERInteger g;
    org.bouncycastle.asn1.DERInteger p;
    org.bouncycastle.asn1.DERInteger q;

    public DSAParameter(java.math.BigInteger r2, java.math.BigInteger r3, java.math.BigInteger r4) {
            r1 = this;
            r1.<init>()
    ...
    public DSAParameter(org.bouncycastle.asn1.ASN1Sequence r4) {
            r3 = this;
            r3.<init>()
            int r0 = r4.size()
            r1 = 3
    ...
    public static org.bouncycastle.asn1.x509.DSAParameter getInstance(java.lang.Object r3) {
            if (r3 == 0) goto L32
            boolean r0 = r3 instanceof org.bouncycastle.asn1.x509.DSAParameter
            if (r0 == 0) goto L7
            goto L32
        L7:
        ...
        L13:
            ...
            java.lang.StringBuilder r1 = new java.lang.StringBuilder
            r1.<init>()
            java.lang.String r2 = "Invalid DSAParameter: "
            r1.append(r2)
            ...
            throw r0
        L32:
            org.bouncycastle.asn1.x509.DSAParameter r3 = (org.bouncycastle.asn1.x509.DSAParameter) r3
            return r3
    }

    public static org.bouncycastle.asn1.x509.DSAParameter getInstance(org.bouncycastle.asn1.ASN1TaggedObject r0, boolean r1) {
            org.bouncycastle.asn1.ASN1Sequence r0 = org.bouncycastle.asn1.ASN1Sequence.getInstance(r0, r1)
            org.bouncycastle.asn1.x509.DSAParameter r0 = getInstance(r0)
            return r0
    }
