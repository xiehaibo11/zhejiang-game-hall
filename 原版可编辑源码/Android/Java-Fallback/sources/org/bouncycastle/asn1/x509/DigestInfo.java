...
public class DigestInfo extends org.bouncycastle.asn1.ASN1Encodable {
    private org.bouncycastle.asn1.x509.AlgorithmIdentifier algId;
    private byte[] digest;

    public DigestInfo(org.bouncycastle.asn1.ASN1Sequence r2) {
            r1 = this;
            r1.<init>()
    ...
    public DigestInfo(org.bouncycastle.asn1.x509.AlgorithmIdentifier r1, byte[] r2) {
            r0 = this;
            r0.<init>()
            r0.digest = r2
            r0.algId = r1
    ...
    public static org.bouncycastle.asn1.x509.DigestInfo getInstance(java.lang.Object r3) {
            boolean r0 = r3 instanceof org.bouncycastle.asn1.x509.DigestInfo
            if (r0 == 0) goto L7
            org.bouncycastle.asn1.x509.DigestInfo r3 = (org.bouncycastle.asn1.x509.DigestInfo) r3
            return r3
        L7:
    ...
    public static org.bouncycastle.asn1.x509.DigestInfo getInstance(org.bouncycastle.asn1.ASN1TaggedObject r0, boolean r1) {
            org.bouncycastle.asn1.ASN1Sequence r0 = org.bouncycastle.asn1.ASN1Sequence.getInstance(r0, r1)
            org.bouncycastle.asn1.x509.DigestInfo r0 = getInstance(r0)
            return r0
    }
    ...
    public org.bouncycastle.asn1.DERObject toASN1Object() {
            ...
            r0.<init>()
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r1 = r3.algId
            r0.add(r1)
