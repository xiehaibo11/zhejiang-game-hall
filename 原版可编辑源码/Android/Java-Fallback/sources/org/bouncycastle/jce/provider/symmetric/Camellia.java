...
public final class Camellia {
    ...
    public static class AlgParams extends org.bouncycastle.jce.provider.JDKAlgorithmParameters.IVAlgorithmParameters {
        ...
        protected java.lang.String engineToString() {
                r1 = this;
                java.lang.String r0 = "Camellia IV"
                return r0
        }
    }
    ...
    public static class CBC extends org.bouncycastle.jce.provider.JCEBlockCipher {
        public CBC() {
                ...
                org.bouncycastle.crypto.engines.CamelliaEngine r1 = new org.bouncycastle.crypto.engines.CamelliaEngine
                r1.<init>()
                r0.<init>(r1)
    ...
    public static class ECB extends org.bouncycastle.jce.provider.JCEBlockCipher {
        public ECB() {
                r1 = this;
                org.bouncycastle.crypto.engines.CamelliaEngine r0 = new org.bouncycastle.crypto.engines.CamelliaEngine
                r0.<init>()
                r1.<init>(r0)
                return
        }
    ...
    public static class KeyGen128 extends org.bouncycastle.jce.provider.symmetric.Camellia.KeyGen {
        public KeyGen128() {
                r1 = this;
    ...
    public static class KeyGen192 extends org.bouncycastle.jce.provider.symmetric.Camellia.KeyGen {
        public KeyGen192() {
                r1 = this;
    ...
    public static class KeyGen256 extends org.bouncycastle.jce.provider.symmetric.Camellia.KeyGen {
        public KeyGen256() {
                r1 = this;
                r0 = 256(0x100, float:3.59E-43)
                r1.<init>(r0)
    ...
    public static class Wrap extends org.bouncycastle.jce.provider.WrapCipherSpi {
        public Wrap() {
                r1 = this;
                org.bouncycastle.crypto.engines.CamelliaWrapEngine r0 = new org.bouncycastle.crypto.engines.CamelliaWrapEngine
                r0.<init>()
                r1.<init>(r0)
                return
        }
