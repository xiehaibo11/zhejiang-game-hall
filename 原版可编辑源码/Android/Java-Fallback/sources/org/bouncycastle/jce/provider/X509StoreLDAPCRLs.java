...
public class X509StoreLDAPCRLs extends org.bouncycastle.x509.X509StoreSpi {
    ...
    public java.util.Collection engineGetMatches(org.bouncycastle.util.Selector r3) throws org.bouncycastle.util.StoreException {
            r2 = this;
            boolean r0 = r3 instanceof org.bouncycastle.x509.X509CRLStoreSelector
            if (r0 != 0) goto L7
            java.util.Set r3 = java.util.Collections.EMPTY_SET
            return r3
        L7:
            org.bouncycastle.x509.X509CRLStoreSelector r3 = (org.bouncycastle.x509.X509CRLStoreSelector) r3
            java.util.HashSet r0 = new java.util.HashSet
            r0.<init>()
            boolean r1 = r3.isDeltaCRLIndicatorEnabled()
            if (r1 == 0) goto L1b
            org.bouncycastle.x509.util.LDAPStoreHelper r1 = r2.helper
            java.util.Collection r3 = r1.getDeltaCertificateRevocationLists(r3)
            goto L45
        L1b:
            org.bouncycastle.x509.util.LDAPStoreHelper r1 = r2.helper
            java.util.Collection r1 = r1.getDeltaCertificateRevocationLists(r3)
            r0.addAll(r1)
            org.bouncycastle.x509.util.LDAPStoreHelper r1 = r2.helper
            java.util.Collection r1 = r1.getAttributeAuthorityRevocationLists(r3)
            r0.addAll(r1)
            org.bouncycastle.x509.util.LDAPStoreHelper r1 = r2.helper
            java.util.Collection r1 = r1.getAttributeCertificateRevocationLists(r3)
            r0.addAll(r1)
            org.bouncycastle.x509.util.LDAPStoreHelper r1 = r2.helper
            java.util.Collection r1 = r1.getAuthorityRevocationLists(r3)
            r0.addAll(r1)
            org.bouncycastle.x509.util.LDAPStoreHelper r1 = r2.helper
            java.util.Collection r3 = r1.getCertificateRevocationLists(r3)
        L45:
            r0.addAll(r3)
            return r0
    }
