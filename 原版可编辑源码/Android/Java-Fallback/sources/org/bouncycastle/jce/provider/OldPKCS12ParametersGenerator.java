...
class OldPKCS12ParametersGenerator extends org.bouncycastle.crypto.PBEParametersGenerator {
    ...
    public OldPKCS12ParametersGenerator(org.bouncycastle.crypto.Digest r4) {
            ...
            r3.<init>()
            r3.digest = r4
            boolean r0 = r4 instanceof org.bouncycastle.crypto.digests.MD5Digest
            r1 = 64
            if (r0 == 0) goto L12
            r4 = 16
            r3.u = r4
        Lf:
            ...
            goto L20
        L12:
            boolean r0 = r4 instanceof org.bouncycastle.crypto.digests.SHA1Digest
            r2 = 20
            if (r0 == 0) goto L1b
        L18:
            r3.u = r2
            goto Lf
        L1b:
            boolean r0 = r4 instanceof org.bouncycastle.crypto.digests.RIPEMD160Digest
            if (r0 == 0) goto L21
            goto L18
        L20:
            return
