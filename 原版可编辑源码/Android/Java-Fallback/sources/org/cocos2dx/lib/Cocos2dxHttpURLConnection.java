...
public class Cocos2dxHttpURLConnection {
    ...
    static int connect(java.net.HttpURLConnection r2) {
            r2.connect()     // Catch: java.io.IOException -> L5
            r2 = 0
            goto L15
        L5:
            r2 = move-exception
            java.lang.String r0 = "cocos2d-x debug info"
            java.lang.String r1 = "come in connect"
    ...
    static java.net.HttpURLConnection createHttpURLConnection(java.lang.String r2) {
            java.net.URL r0 = new java.net.URL     // Catch: java.lang.Exception -> L17
            r0.<init>(r2)     // Catch: java.lang.Exception -> L17
            java.net.URLConnection r2 = r0.openConnection()     // Catch: java.lang.Exception -> L17
            java.net.HttpURLConnection r2 = (java.net.HttpURLConnection) r2     // Catch: java.lang.Exception -> L17
            java.lang.String r0 = "Accept-Encoding"
            java.lang.String r1 = "identity"
            r2.setRequestProperty(r0, r1)     // Catch: java.lang.Exception -> L17
            r0 = 1
            r2.setDoInput(r0)     // Catch: java.lang.Exception -> L17
            return r2
        L17:
            r2 = move-exception
            java.lang.String r2 = r2.toString()
            java.lang.String r0 = "URLConnection exception"
            android.util.Log.e(r0, r2)
            r2 = 0
            return r2
    }
    ...
    static int getResponseCode(java.net.HttpURLConnection r1) {
            int r1 = r1.getResponseCode()     // Catch: java.io.IOException -> L5
            goto L10
        L5:
            r1 = move-exception
    ...
    static byte[] getResponseContent(java.net.HttpURLConnection r8) {
            java.lang.String r0 = "URLConnection exception"
            r1 = 0
            java.io.InputStream r2 = r8.getInputStream()     // Catch: java.lang.Exception -> L31 java.io.IOException -> L3a
            java.lang.String r3 = r8.getContentEncoding()     // Catch: java.lang.Exception -> L31 java.io.IOException -> L3a
            if (r3 == 0) goto L3e
            java.lang.String r4 = "gzip"
            boolean r4 = r3.equalsIgnoreCase(r4)     // Catch: java.lang.Exception -> L31 java.io.IOException -> L3a
            if (r4 == 0) goto L1f
            java.util.zip.GZIPInputStream r2 = new java.util.zip.GZIPInputStream     // Catch: java.lang.Exception -> L31 java.io.IOException -> L3a
            java.io.InputStream r3 = r8.getInputStream()     // Catch: java.lang.Exception -> L31 java.io.IOException -> L3a
            r2.<init>(r3)     // Catch: java.lang.Exception -> L31 java.io.IOException -> L3a
            goto L3e
        L1f:
            java.lang.String r4 = "deflate"
            boolean r3 = r3.equalsIgnoreCase(r4)     // Catch: java.lang.Exception -> L31 java.io.IOException -> L3a
            if (r3 == 0) goto L3e
            java.util.zip.InflaterInputStream r2 = new java.util.zip.InflaterInputStream     // Catch: java.lang.Exception -> L31 java.io.IOException -> L3a
            java.io.InputStream r3 = r8.getInputStream()     // Catch: java.lang.Exception -> L31 java.io.IOException -> L3a
            r2.<init>(r3)     // Catch: java.lang.Exception -> L31 java.io.IOException -> L3a
            goto L3e
        L31:
        ...
        L3e:
            ...
            byte[] r3 = new byte[r8]     // Catch: java.lang.Exception -> L5b
            java.io.ByteArrayOutputStream r4 = new java.io.ByteArrayOutputStream     // Catch: java.lang.Exception -> L5b
            r4.<init>()     // Catch: java.lang.Exception -> L5b
        L47:
            r5 = 0
            int r6 = r2.read(r3, r5, r8)     // Catch: java.lang.Exception -> L5b
            r7 = -1
            if (r6 == r7) goto L53
            r4.write(r3, r5, r6)     // Catch: java.lang.Exception -> L5b
            goto L47
        L53:
            byte[] r8 = r4.toByteArray()     // Catch: java.lang.Exception -> L5b
    ...
    static java.lang.String getResponseMessage(java.net.HttpURLConnection r1) {
            java.lang.String r1 = r1.getResponseMessage()     // Catch: java.io.IOException -> L5
            goto Lf
        L5:
            r1 = move-exception
            java.lang.String r1 = r1.toString()
    ...
    static void sendRequest(java.net.HttpURLConnection r0, byte[] r1) {
            java.io.OutputStream r0 = r0.getOutputStream()     // Catch: java.io.IOException -> L10
            if (r1 == 0) goto Lc
            r0.write(r1)     // Catch: java.io.IOException -> L10
            r0.flush()     // Catch: java.io.IOException -> L10
        Lc:
    ...
    static void setRequestMethod(java.net.HttpURLConnection r1, java.lang.String r2) {
            r1.setRequestMethod(r2)     // Catch: java.net.ProtocolException -> L18
            java.lang.String r0 = "POST"
            boolean r0 = r2.equalsIgnoreCase(r0)     // Catch: java.net.ProtocolException -> L18
            if (r0 != 0) goto L13
            java.lang.String r0 = "PUT"
            boolean r2 = r2.equalsIgnoreCase(r0)     // Catch: java.net.ProtocolException -> L18
            if (r2 == 0) goto L22
        L13:
            r2 = 1
            r1.setDoOutput(r2)     // Catch: java.net.ProtocolException -> L18
            goto L22
        L18:
            r1 = move-exception
            java.lang.String r1 = r1.toString()
            java.lang.String r2 = "URLConnection exception"
    ...
    static void setVerifySSL(java.net.HttpURLConnection r4, java.lang.String r5) {
        ...
        L8b:
            ...
            java.lang.String r5 = "URLConnection exception"
