...
public class URLCodec implements org.apache.commons.codec1.BinaryEncoder, org.apache.commons.codec1.BinaryDecoder, org.apache.commons.codec1.StringEncoder, org.apache.commons.codec1.StringDecoder {
    ...
    static {
            ...
            r0.<init>(r1)
            org.apache.commons.codec1.net.URLCodec.WWW_FORM_URL = r0
            r0 = 97
        Lb:
        ...
        L17:
            r1 = 57
            if (r0 <= r1) goto L3f
            java.util.BitSet r0 = org.apache.commons.codec1.net.URLCodec.WWW_FORM_URL
            r1 = 45
            r0.set(r1)
            java.util.BitSet r0 = org.apache.commons.codec1.net.URLCodec.WWW_FORM_URL
            r1 = 95
            ...
            return
        L3f:
            java.util.BitSet r1 = org.apache.commons.codec1.net.URLCodec.WWW_FORM_URL
            r1.set(r0)
            int r0 = r0 + 1
            goto L17
        L47:
    ...
    public static final byte[] decodeUrl(byte[] r4) throws org.apache.commons.codec1.DecoderException {
            if (r4 != 0) goto L4
            r4 = 0
            return r4
        L4:
        ...
        L1e:
            ...
            if (r2 != r3) goto L43
            int r1 = r1 + 1
            r2 = r4[r1]     // Catch: java.lang.ArrayIndexOutOfBoundsException -> L3a
            int r2 = org.apache.commons.codec1.net.Utils.digit16(r2)     // Catch: java.lang.ArrayIndexOutOfBoundsException -> L3a
            int r1 = r1 + 1
            r3 = r4[r1]     // Catch: java.lang.ArrayIndexOutOfBoundsException -> L3a
            int r3 = org.apache.commons.codec1.net.Utils.digit16(r3)     // Catch: java.lang.ArrayIndexOutOfBoundsException -> L3a
            int r2 = r2 << 4
            int r2 = r2 + r3
            char r2 = (char) r2     // Catch: java.lang.ArrayIndexOutOfBoundsException -> L3a
            r0.write(r2)     // Catch: java.lang.ArrayIndexOutOfBoundsException -> L3a
            goto L46
        L3a:
            r4 = move-exception
    ...
    public static final byte[] encodeUrl(java.util.BitSet r6, byte[] r7) {
        ...
        L4:
            if (r6 != 0) goto L8
            java.util.BitSet r6 = org.apache.commons.codec1.net.URLCodec.WWW_FORM_URL
        L8:
            java.io.ByteArrayOutputStream r0 = new java.io.ByteArrayOutputStream
            r0.<init>()
            int r1 = r7.length
    ...
    @Override
    public java.lang.String encode(java.lang.String r3) throws org.apache.commons.codec1.EncoderException {
            r2 = this;
            if (r3 != 0) goto L4
            r3 = 0
            return r3
