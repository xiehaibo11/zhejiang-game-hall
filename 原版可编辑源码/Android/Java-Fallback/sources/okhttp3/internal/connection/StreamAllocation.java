...
public final class StreamAllocation {
    ...
    private java.net.Socket deallocate(boolean r2, boolean r3, boolean r4) {
        ...
        L20:
            ...
            r1.release(r2)
            okhttp3.internal.connection.RealConnection r2 = r1.connection
            java.util.List r2 = r2.allocations
    ...
    private okhttp3.internal.connection.RealConnection findConnection(int r19, int r20, int r21, int r22, boolean r23) throws java.io.IOException {
            ...
            monitor-enter(r2)
            boolean r0 = r1.released     // Catch: java.lang.Throwable -> L138
            if (r0 != 0) goto L130
            okhttp3.internal.http.HttpCodec r0 = r1.codec     // Catch: java.lang.Throwable -> L138
            if (r0 != 0) goto L128
            boolean r0 = r1.canceled     // Catch: java.lang.Throwable -> L138
            if (r0 != 0) goto L120
            okhttp3.internal.connection.RealConnection r0 = r1.connection     // Catch: java.lang.Throwable -> L138
            java.net.Socket r3 = r18.releaseIfNoNewStreams()     // Catch: java.lang.Throwable -> L138
            okhttp3.internal.connection.RealConnection r4 = r1.connection     // Catch: java.lang.Throwable -> L138
            r5 = 0
            if (r4 == 0) goto L20
            okhttp3.internal.connection.RealConnection r0 = r1.connection     // Catch: java.lang.Throwable -> L138
            r4 = r5
        ...
        L20:
            ...
            r0 = r5
        L22:
            boolean r6 = r1.reportedAcquired     // Catch: java.lang.Throwable -> L138
            if (r6 != 0) goto L27
            r4 = r5
        L27:
            r6 = 1
            r7 = 0
            if (r0 != 0) goto L40
            okhttp3.internal.Internal r8 = okhttp3.internal.Internal.instance     // Catch: java.lang.Throwable -> L138
            okhttp3.ConnectionPool r9 = r1.connectionPool     // Catch: java.lang.Throwable -> L138
            okhttp3.Address r10 = r1.address     // Catch: java.lang.Throwable -> L138
            r8.get(r9, r10, r1, r5)     // Catch: java.lang.Throwable -> L138
            okhttp3.internal.connection.RealConnection r8 = r1.connection     // Catch: java.lang.Throwable -> L138
            if (r8 == 0) goto L3d
            okhttp3.internal.connection.RealConnection r0 = r1.connection     // Catch: java.lang.Throwable -> L138
            r8 = r5
            r9 = 1
            goto L42
        L3d:
            okhttp3.Route r8 = r1.route     // Catch: java.lang.Throwable -> L138
            goto L41
        L40:
            r8 = r5
        L41:
            r9 = 0
        L42:
            monitor-exit(r2)     // Catch: java.lang.Throwable -> L138
        ...
        L72:
            okhttp3.ConnectionPool r3 = r1.connectionPool
            monitor-enter(r3)
            boolean r4 = r1.canceled     // Catch: java.lang.Throwable -> L11d
            if (r4 != 0) goto L115
            if (r2 == 0) goto La4
            okhttp3.internal.connection.RouteSelector$Selection r2 = r1.routeSelection     // Catch: java.lang.Throwable -> L11d
            java.util.List r2 = r2.getAll()     // Catch: java.lang.Throwable -> L11d
            int r4 = r2.size()     // Catch: java.lang.Throwable -> L11d
            r10 = 0
        L86:
            if (r10 >= r4) goto La4
            java.lang.Object r11 = r2.get(r10)     // Catch: java.lang.Throwable -> L11d
            okhttp3.Route r11 = (okhttp3.Route) r11     // Catch: java.lang.Throwable -> L11d
            okhttp3.internal.Internal r12 = okhttp3.internal.Internal.instance     // Catch: java.lang.Throwable -> L11d
            okhttp3.ConnectionPool r13 = r1.connectionPool     // Catch: java.lang.Throwable -> L11d
            okhttp3.Address r14 = r1.address     // Catch: java.lang.Throwable -> L11d
            r12.get(r13, r14, r1, r11)     // Catch: java.lang.Throwable -> L11d
            okhttp3.internal.connection.RealConnection r12 = r1.connection     // Catch: java.lang.Throwable -> L11d
            if (r12 == 0) goto La1
            okhttp3.internal.connection.RealConnection r0 = r1.connection     // Catch: java.lang.Throwable -> L11d
            r1.route = r11     // Catch: java.lang.Throwable -> L11d
            r9 = 1
            goto La4
        La1:
            int r10 = r10 + 1
        ...
        La4:
            if (r9 != 0) goto Lbc
            if (r8 != 0) goto Lae
            okhttp3.internal.connection.RouteSelector$Selection r0 = r1.routeSelection     // Catch: java.lang.Throwable -> L11d
            okhttp3.Route r8 = r0.next()     // Catch: java.lang.Throwable -> L11d
        Lae:
            r1.route = r8     // Catch: java.lang.Throwable -> L11d
            r1.refusedStreamCount = r7     // Catch: java.lang.Throwable -> L11d
            okhttp3.internal.connection.RealConnection r0 = new okhttp3.internal.connection.RealConnection     // Catch: java.lang.Throwable -> L11d
            okhttp3.ConnectionPool r2 = r1.connectionPool     // Catch: java.lang.Throwable -> L11d
            r0.<init>(r2, r8)     // Catch: java.lang.Throwable -> L11d
            r1.acquire(r0, r7)     // Catch: java.lang.Throwable -> L11d
        Lbc:
            monitor-exit(r3)     // Catch: java.lang.Throwable -> L11d
            if (r9 == 0) goto Lc7
            okhttp3.EventListener r2 = r1.eventListener
            okhttp3.Call r3 = r1.call
            r2.connectionAcquired(r3, r0)
        ...
        Lc7:
            ...
            okhttp3.internal.connection.RouteDatabase r2 = r18.routeDatabase()
            okhttp3.Route r3 = r0.route()
            r2.connected(r3)
            okhttp3.ConnectionPool r2 = r1.connectionPool
            monitor-enter(r2)
            r1.reportedAcquired = r6     // Catch: java.lang.Throwable -> L112
            okhttp3.internal.Internal r3 = okhttp3.internal.Internal.instance     // Catch: java.lang.Throwable -> L112
            okhttp3.ConnectionPool r4 = r1.connectionPool     // Catch: java.lang.Throwable -> L112
            r3.put(r4, r0)     // Catch: java.lang.Throwable -> L112
            boolean r3 = r0.isMultiplexed()     // Catch: java.lang.Throwable -> L112
            if (r3 == 0) goto L106
            okhttp3.internal.Internal r0 = okhttp3.internal.Internal.instance     // Catch: java.lang.Throwable -> L112
            okhttp3.ConnectionPool r3 = r1.connectionPool     // Catch: java.lang.Throwable -> L112
            okhttp3.Address r4 = r1.address     // Catch: java.lang.Throwable -> L112
            java.net.Socket r5 = r0.deduplicate(r3, r4, r1)     // Catch: java.lang.Throwable -> L112
            okhttp3.internal.connection.RealConnection r0 = r1.connection     // Catch: java.lang.Throwable -> L112
        L106:
        ...
        L115:
            ...
            r0.<init>(r2)     // Catch: java.lang.Throwable -> L11d
        ...
        L11d:
            ...
            throw r0
        L120:
            java.io.IOException r0 = new java.io.IOException     // Catch: java.lang.Throwable -> L138
            java.lang.String r3 = "Canceled"
            r0.<init>(r3)     // Catch: java.lang.Throwable -> L138
            throw r0     // Catch: java.lang.Throwable -> L138
        L128:
            java.lang.IllegalStateException r0 = new java.lang.IllegalStateException     // Catch: java.lang.Throwable -> L138
    ...
    private void release(okhttp3.internal.connection.RealConnection r4) {
            r3 = this;
            java.util.List r0 = r4.allocations
            int r0 = r0.size()
            r1 = 0
        L7:
            if (r1 >= r0) goto L20
            java.util.List r2 = r4.allocations
            java.lang.Object r2 = r2.get(r1)
            java.lang.ref.Reference r2 = (java.lang.ref.Reference) r2
            java.lang.Object r2 = r2.get()
            if (r2 != r3) goto L1d
            java.util.List r4 = r4.allocations
            r4.remove(r1)
            return
        L1d:
            int r1 = r1 + 1
    ...
    public void release() {
            ...
            okhttp3.ConnectionPool r0 = r4.connectionPool
            monitor-enter(r0)
            okhttp3.internal.connection.RealConnection r1 = r4.connection     // Catch: java.lang.Throwable -> L25
            r2 = 1
            r3 = 0
            java.net.Socket r2 = r4.deallocate(r3, r2, r3)     // Catch: java.lang.Throwable -> L25
            okhttp3.internal.connection.RealConnection r3 = r4.connection     // Catch: java.lang.Throwable -> L25
            if (r3 == 0) goto L10
            r1 = 0
        L10:
    ...
    public void streamFailed(java.io.IOException r7) {
            ...
            monitor-enter(r0)
            boolean r1 = r7 instanceof okhttp3.internal.http2.StreamResetException     // Catch: java.lang.Throwable -> L69
            r2 = 0
            r3 = 0
            r4 = 1
            if (r1 == 0) goto L23
            okhttp3.internal.http2.StreamResetException r7 = (okhttp3.internal.http2.StreamResetException) r7     // Catch: java.lang.Throwable -> L69
            okhttp3.internal.http2.ErrorCode r7 = r7.errorCode     // Catch: java.lang.Throwable -> L69
            okhttp3.internal.http2.ErrorCode r1 = okhttp3.internal.http2.ErrorCode.REFUSED_STREAM     // Catch: java.lang.Throwable -> L69
            if (r7 != r1) goto L1c
            ...
            goto L48
        L1c:
            okhttp3.internal.http2.ErrorCode r1 = okhttp3.internal.http2.ErrorCode.CANCEL     // Catch: java.lang.Throwable -> L69
            if (r7 == r1) goto L4a
            r6.route = r3     // Catch: java.lang.Throwable -> L69
            goto L48
        L23:
            okhttp3.internal.connection.RealConnection r1 = r6.connection     // Catch: java.lang.Throwable -> L69
            if (r1 == 0) goto L4a
            okhttp3.internal.connection.RealConnection r1 = r6.connection     // Catch: java.lang.Throwable -> L69
            boolean r1 = r1.isMultiplexed()     // Catch: java.lang.Throwable -> L69
            if (r1 == 0) goto L33
            boolean r1 = r7 instanceof okhttp3.internal.http2.ConnectionShutdownException     // Catch: java.lang.Throwable -> L69
            if (r1 == 0) goto L4a
        L33:
            okhttp3.internal.connection.RealConnection r1 = r6.connection     // Catch: java.lang.Throwable -> L69
            int r1 = r1.successCount     // Catch: java.lang.Throwable -> L69
            if (r1 != 0) goto L48
            okhttp3.Route r1 = r6.route     // Catch: java.lang.Throwable -> L69
            if (r1 == 0) goto L46
            if (r7 == 0) goto L46
            okhttp3.internal.connection.RouteSelector r1 = r6.routeSelector     // Catch: java.lang.Throwable -> L69
            okhttp3.Route r5 = r6.route     // Catch: java.lang.Throwable -> L69
        ...
        L4b:
            ...
            okhttp3.internal.connection.RealConnection r2 = r6.connection     // Catch: java.lang.Throwable -> L69
            if (r2 != 0) goto L5b
    ...
    public void streamFinished(boolean r3, okhttp3.internal.http.HttpCodec r4, long r5, java.io.IOException r7) {
            ...
            monitor-enter(r5)
            if (r4 == 0) goto L49
            okhttp3.internal.http.HttpCodec r6 = r2.codec     // Catch: java.lang.Throwable -> L6a
            if (r4 != r6) goto L49
            r4 = 1
            if (r3 != 0) goto L1a
            okhttp3.internal.connection.RealConnection r6 = r2.connection     // Catch: java.lang.Throwable -> L6a
            int r0 = r6.successCount     // Catch: java.lang.Throwable -> L6a
            int r0 = r0 + r4
            r6.successCount = r0     // Catch: java.lang.Throwable -> L6a
        L1a:
            okhttp3.internal.connection.RealConnection r6 = r2.connection     // Catch: java.lang.Throwable -> L6a
            r0 = 0
            java.net.Socket r3 = r2.deallocate(r3, r0, r4)     // Catch: java.lang.Throwable -> L6a
            okhttp3.internal.connection.RealConnection r4 = r2.connection     // Catch: java.lang.Throwable -> L6a
            if (r4 == 0) goto L26
            r6 = 0
        L26:
            boolean r4 = r2.released     // Catch: java.lang.Throwable -> L6a
        ...
        L49:
            ...
            okhttp3.internal.http.HttpCodec r7 = r2.codec     // Catch: java.lang.Throwable -> L6a
            r6.append(r7)     // Catch: java.lang.Throwable -> L6a
