...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/kwad/components/ad/interstitial/f/c;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput p2, p0, Lcom/kwad/components/ad/interstitial/f/c;->ju:I

    new-instance p2, Lcom/kwad/components/ad/interstitial/f/c$1;

    invoke-direct {p2, p0}, Lcom/kwad/components/ad/interstitial/f/c$1;-><init>(Lcom/kwad/components/ad/interstitial/f/c;)V

    iput-object p2, p0, Lcom/kwad/components/ad/interstitial/f/c;->gt:Lcom/kwad/components/core/webview/b/e/e;

    invoke-virtual {p0}, Lcom/kwad/components/ad/interstitial/f/c;->getLayoutId()I
    ...
    iput-object p1, p0, Lcom/kwad/components/ad/interstitial/f/c;->lJ:Landroid/view/ViewGroup;
...
.method private a(Landroid/content/Context;Lcom/kwad/sdk/core/response/model/AdInfo;Lcom/kwad/components/ad/interstitial/d/c;)Lcom/kwad/components/ad/interstitial/f/f;
    ...
    iget-object v0, p0, Lcom/kwad/components/ad/interstitial/f/c;->mContext:Landroid/content/Context;
...
.method static synthetic a(Lcom/kwad/components/ad/interstitial/f/c;Z)Z
    .locals 0

    const/4 p1, 0x0

    iput-boolean p1, p0, Lcom/kwad/components/ad/interstitial/f/c;->lI:Z
...
.method private eq()Lcom/kwad/components/ad/interstitial/d/c;
    ...
    iget-object v1, p0, Lcom/kwad/components/ad/interstitial/f/c;->hz:Lcom/kwad/sdk/api/KsInterstitialAd$AdInteractionListener;

    iput-object v1, v0, Lcom/kwad/components/ad/interstitial/d/c;->hz:Lcom/kwad/sdk/api/KsInterstitialAd$AdInteractionListener;

    iget-object v1, p0, Lcom/kwad/components/ad/interstitial/f/c;->hG:Lcom/kwad/components/ad/interstitial/d;
    ...
    iget-object v1, p0, Lcom/kwad/components/ad/interstitial/f/c;->dJ:Lcom/kwad/sdk/api/KsAdVideoPlayConfig;
    ...
    iget-object v2, p0, Lcom/kwad/components/ad/interstitial/f/c;->mContext:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/kwad/components/ad/interstitial/f/c;->lJ:Landroid/view/ViewGroup;
    ...
    iget v1, p0, Lcom/kwad/components/ad/interstitial/f/c;->ju:I

    iput v1, v0, Lcom/kwad/components/ad/interstitial/d/c;->ju:I

    iget-boolean v1, p0, Lcom/kwad/components/ad/interstitial/f/c;->jk:Z

    iput-boolean v1, v0, Lcom/kwad/components/ad/interstitial/d/c;->jk:Z

    iget-object v1, p0, Lcom/kwad/components/ad/interstitial/f/c;->jl:Lcom/kwad/components/ad/interstitial/d/c$a;

    iput-object v1, v0, Lcom/kwad/components/ad/interstitial/d/c;->jl:Lcom/kwad/components/ad/interstitial/d/c$a;

    iget-object v1, p0, Lcom/kwad/components/ad/interstitial/f/c;->gt:Lcom/kwad/components/core/webview/b/e/e;
    ...
    invoke-direct {p0, v2, v1, v0}, Lcom/kwad/components/ad/interstitial/f/c;->a(Landroid/content/Context;Lcom/kwad/sdk/core/response/model/AdInfo;Lcom/kwad/components/ad/interstitial/d/c;)Lcom/kwad/components/ad/interstitial/f/f;
...
.method public final a(Lcom/kwad/sdk/core/response/model/AdTemplate;Lcom/kwad/components/ad/interstitial/d;Lcom/kwad/sdk/api/KsAdVideoPlayConfig;Lcom/kwad/sdk/api/KsInterstitialAd$AdInteractionListener;)V
    ...
    iput-object v0, p0, Lcom/kwad/components/ad/interstitial/f/c;->mAdInfo:Lcom/kwad/sdk/core/response/model/AdInfo;

    const/4 v0, 0x2

    iput v0, p1, Lcom/kwad/sdk/core/response/model/AdTemplate;->realShowType:I

    iput-object p3, p0, Lcom/kwad/components/ad/interstitial/f/c;->dJ:Lcom/kwad/sdk/api/KsAdVideoPlayConfig;

    iput-object p2, p0, Lcom/kwad/components/ad/interstitial/f/c;->hG:Lcom/kwad/components/ad/interstitial/d;
    ...
    iput-object p4, p0, Lcom/kwad/components/ad/interstitial/f/c;->hz:Lcom/kwad/sdk/api/KsInterstitialAd$AdInteractionListener;

    invoke-direct {p0}, Lcom/kwad/components/ad/interstitial/f/c;->eq()Lcom/kwad/components/ad/interstitial/d/c;

    move-result-object p1

    iput-object p1, p0, Lcom/kwad/components/ad/interstitial/f/c;->jf:Lcom/kwad/components/ad/interstitial/d/c;

    iget-object p1, p0, Lcom/kwad/components/ad/interstitial/f/c;->lH:Lcom/kwad/components/ad/interstitial/d/b;

    if-nez p1, :cond_0

    invoke-virtual {p0}, Lcom/kwad/components/ad/interstitial/f/c;->er()Lcom/kwad/components/ad/interstitial/d/b;

    move-result-object p1

    iput-object p1, p0, Lcom/kwad/components/ad/interstitial/f/c;->lH:Lcom/kwad/components/ad/interstitial/d/b;

    :cond_0
    iget-object p1, p0, Lcom/kwad/components/ad/interstitial/f/c;->lH:Lcom/kwad/components/ad/interstitial/d/b;

    iget-object p2, p0, Lcom/kwad/components/ad/interstitial/f/c;->lJ:Landroid/view/ViewGroup;

    invoke-virtual {p1, p2}, Lcom/kwad/components/ad/interstitial/d/b;->F(Landroid/view/View;)V

    iget-object p1, p0, Lcom/kwad/components/ad/interstitial/f/c;->lH:Lcom/kwad/components/ad/interstitial/d/b;

    iget-object p2, p0, Lcom/kwad/components/ad/interstitial/f/c;->jf:Lcom/kwad/components/ad/interstitial/d/c;
...
.method public final cn()V
    ...
    iget-object v0, p0, Lcom/kwad/components/ad/interstitial/f/c;->lH:Lcom/kwad/components/ad/interstitial/d/b;
...
.method public final er()Lcom/kwad/components/ad/interstitial/d/b;
    ...
    iget-boolean v1, p0, Lcom/kwad/components/ad/interstitial/f/c;->lI:Z
    ...
    iget-object v1, p0, Lcom/kwad/components/ad/interstitial/f/c;->mAdInfo:Lcom/kwad/sdk/core/response/model/AdInfo;
    ...
    :cond_2
    iget-object v1, p0, Lcom/kwad/components/ad/interstitial/f/c;->jf:Lcom/kwad/components/ad/interstitial/d/c;

    invoke-virtual {p0}, Lcom/kwad/components/ad/interstitial/f/c;->getContext()Landroid/content/Context;
...
.method public final es()V
    ...
    iget-object v0, p0, Lcom/kwad/components/ad/interstitial/f/c;->jf:Lcom/kwad/components/ad/interstitial/d/c;

    if-eqz v0, :cond_0

    iget-boolean v0, v0, Lcom/kwad/components/ad/interstitial/d/c;->jt:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/kwad/components/ad/interstitial/f/c;->jf:Lcom/kwad/components/ad/interstitial/d/c;

    invoke-virtual {v0}, Lcom/kwad/components/ad/interstitial/d/c;->cQ()V
...
.method public final et()V
    ...
    invoke-virtual {v0}, Lcom/kwad/components/ad/interstitial/d/c;->cR()V
...
.method public final eu()V
    ...
    iget-object v1, p0, Lcom/kwad/components/ad/interstitial/f/c;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v0, v1}, Lcom/kwad/components/ad/interstitial/d/c$b;->z(I)Lcom/kwad/components/ad/interstitial/d/c$b;

    move-result-object v0

    invoke-virtual {v0, v1}, Lcom/kwad/components/ad/interstitial/d/c$b;->m(Z)Lcom/kwad/components/ad/interstitial/d/c$b;

    move-result-object v0

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Lcom/kwad/components/ad/interstitial/d/c$b;->y(I)Lcom/kwad/components/ad/interstitial/d/c$b;

    move-result-object v0

    iget-object v1, p0, Lcom/kwad/components/ad/interstitial/f/c;->jf:Lcom/kwad/components/ad/interstitial/d/c;

    invoke-virtual {v1, v0}, Lcom/kwad/components/ad/interstitial/d/c;->a(Lcom/kwad/components/ad/interstitial/d/c$b;)V
...
.method public final setAdConvertListener(Lcom/kwad/components/ad/interstitial/d/c$a;)V
    ...
    iput-object p1, p0, Lcom/kwad/components/ad/interstitial/f/c;->jl:Lcom/kwad/components/ad/interstitial/d/c$a;
...
.method public final setAdInteractionListener(Lcom/kwad/sdk/api/KsInterstitialAd$AdInteractionListener;)V
    ...
    iput-object p1, p0, Lcom/kwad/components/ad/interstitial/f/c;->hz:Lcom/kwad/sdk/api/KsInterstitialAd$AdInteractionListener;
...
.method public final setAggregateAdView(Z)V
    ...
    iput-boolean p1, p0, Lcom/kwad/components/ad/interstitial/f/c;->jk:Z
...
.method public final setAggregateShowTriggerType(I)V
    ...
    iput p1, p0, Lcom/kwad/components/ad/interstitial/f/c;->ju:I
