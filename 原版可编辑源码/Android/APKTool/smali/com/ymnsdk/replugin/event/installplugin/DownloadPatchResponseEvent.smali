.class public Lcom/ymnsdk/replugin/event/installplugin/DownloadPatchResponseEvent;
.super Lcom/ymnsdk/replugin/event/base/SepperllitaEvent;
.source "DownloadPatchResponseEvent.java"
...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    .line 12
    invoke-virtual {p0, p1}, Lcom/ymnsdk/replugin/event/installplugin/DownloadPatchResponseEvent;->setAct(Ljava/lang/String;)V

    const-string p1, "P1069"

    .line 13
    invoke-virtual {p0, p1}, Lcom/ymnsdk/replugin/event/installplugin/DownloadPatchResponseEvent;->setPg(Ljava/lang/String;)V

    const-string p1, "BHF002"

    .line 14
    invoke-virtual {p0, p1}, Lcom/ymnsdk/replugin/event/installplugin/DownloadPatchResponseEvent;->setBlk(Ljava/lang/String;)V

    const-string p1, "\u70b9\u51fb\u63d2\u4ef6icon"

    .line 15
    invoke-virtual {p0, p1}, Lcom/ymnsdk/replugin/event/installplugin/DownloadPatchResponseEvent;->setBl(Ljava/lang/String;)V

    const-string p1, "\u4e0b\u8f7dpatch\u7ed3\u675f"

    .line 16
    invoke-virtual {p0, p1}, Lcom/ymnsdk/replugin/event/installplugin/DownloadPatchResponseEvent;->setLabel(Ljava/lang/String;)V
...
.method public constructor <init>(Landroid/app/Activity;ILjava/lang/String;Ljava/lang/String;JILjava/lang/String;IJ)V
    ...
    .line 20
    invoke-direct {p0, p1}, Lcom/ymnsdk/replugin/event/installplugin/DownloadPatchResponseEvent;-><init>(Landroid/app/Activity;)V
    ...
    invoke-virtual {p0, v0}, Lcom/ymnsdk/replugin/event/installplugin/DownloadPatchResponseEvent;->setEid(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/ymnsdk/replugin/event/installplugin/DownloadPatchResponseEvent;->setDur(Ljava/lang/String;)V

    .line 23
    invoke-virtual {p0, p4}, Lcom/ymnsdk/replugin/event/installplugin/DownloadPatchResponseEvent;->setRv(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/ymnsdk/replugin/event/installplugin/DownloadPatchResponseEvent;->setCust(Ljava/lang/String;)V
