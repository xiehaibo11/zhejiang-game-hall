.class public final Lcom/bianfeng/afext/read/ApkUtil;
...
.method public static findApkSigningBlock(Ljava/nio/channels/FileChannel;)Lcom/bianfeng/afext/read/Pair;
    .locals 2
    ...
    .line 126
    invoke-static {p0}, Lcom/bianfeng/afext/read/ApkUtil;->findCentralDirStartOffset(Ljava/nio/channels/FileChannel;)J

    move-result-wide v0

    .line 127
    invoke-static {p0, v0, v1}, Lcom/bianfeng/afext/read/ApkUtil;->findApkSigningBlock(Ljava/nio/channels/FileChannel;J)Lcom/bianfeng/afext/read/Pair;
...
.method public static findApkSigningBlock(Ljava/nio/channels/FileChannel;J)Lcom/bianfeng/afext/read/Pair;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p0}, Lcom/bianfeng/afext/read/Pair;->of(Ljava/lang/Object;Ljava/lang/Object;)Lcom/bianfeng/afext/read/Pair;
    ...
    .line 178
    :cond_0
    new-instance p0, Lcom/bianfeng/afext/read/SignatureNotFoundException;
    ...
    invoke-direct {p0, p1}, Lcom/bianfeng/afext/read/SignatureNotFoundException;-><init>(Ljava/lang/String;)V
...
.method public static findCentralDirStartOffset(Ljava/nio/channels/FileChannel;)J
    ...
    .line 97
    invoke-static {p0}, Lcom/bianfeng/afext/read/ApkUtil;->getCommentLength(Ljava/nio/channels/FileChannel;)J

    move-result-wide v0

    invoke-static {p0, v0, v1}, Lcom/bianfeng/afext/read/ApkUtil;->findCentralDirStartOffset(Ljava/nio/channels/FileChannel;J)J
...
.method public static findIdValues(Ljava/nio/ByteBuffer;)Ljava/util/Map;
    ...
    .line 186
    invoke-static {p0}, Lcom/bianfeng/afext/read/ApkUtil;->checkByteOrderLittleEndian(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, v1, v0}, Lcom/bianfeng/afext/read/ApkUtil;->sliceFromTo(Ljava/nio/ByteBuffer;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, v4}, Lcom/bianfeng/afext/read/ApkUtil;->getByteBuffer(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    ...
    .line 213
    :cond_0
    new-instance v0, Lcom/bianfeng/afext/read/SignatureNotFoundException;
    ...
    invoke-direct {v0, p0}, Lcom/bianfeng/afext/read/SignatureNotFoundException;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lcom/bianfeng/afext/read/SignatureNotFoundException;-><init>(Ljava/lang/String;)V
