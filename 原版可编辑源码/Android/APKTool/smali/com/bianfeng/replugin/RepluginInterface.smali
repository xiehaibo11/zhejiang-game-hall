.class public Lcom/bianfeng/replugin/RepluginInterface;
...
# static fields
.field private static final CHECK_HAS_REPLUGIN:Ljava/lang/String; = "check_has_replugin"
...
.method public checkHasReplugin()V
    ...
    .annotation runtime Lcom/bianfeng/ymnsdk/feature/protocol/YFunction;
        name = "check_has_replugin"
    .end annotation

    const v0, 0x21ef8

    const-string v1, "\u5b58\u5728replugin"

    .line 47
    invoke-virtual {p0, v0, v1}, Lcom/bianfeng/replugin/RepluginInterface;->sendResult(ILjava/lang/String;)V
