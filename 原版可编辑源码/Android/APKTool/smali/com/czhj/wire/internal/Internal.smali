.class public final Lcom/czhj/wire/internal/Internal;
...
.method public static copyOf(Ljava/lang/String;Ljava/util/List;)Ljava/util/List;
    ...
    instance-of p0, p1, Lcom/czhj/wire/internal/ImmutableList;
    ...
    :cond_1
    :goto_0
    new-instance p0, Lcom/czhj/wire/internal/MutableOnWriteList;

    invoke-direct {p0, p1}, Lcom/czhj/wire/internal/MutableOnWriteList;-><init>(Ljava/util/List;)V
...
.method public static immutableCopyOf(Ljava/lang/String;Ljava/util/List;)Ljava/util/List;
    ...
    instance-of v0, p1, Lcom/czhj/wire/internal/MutableOnWriteList;

    if-eqz v0, :cond_0

    check-cast p1, Lcom/czhj/wire/internal/MutableOnWriteList;

    iget-object p1, p1, Lcom/czhj/wire/internal/MutableOnWriteList;->a:Ljava/util/List;
    ...
    instance-of v0, p1, Lcom/czhj/wire/internal/ImmutableList;
    ...
    :cond_1
    new-instance v0, Lcom/czhj/wire/internal/ImmutableList;

    invoke-direct {v0, p1}, Lcom/czhj/wire/internal/ImmutableList;-><init>(Ljava/util/List;)V

    const/4 p1, 0x0

    invoke-virtual {v0, p1}, Lcom/czhj/wire/internal/ImmutableList;->contains(Ljava/lang/Object;)Z
...
.method public static newMutableList()Ljava/util/List;
    ...
    new-instance v0, Lcom/czhj/wire/internal/MutableOnWriteList;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/czhj/wire/internal/MutableOnWriteList;-><init>(Ljava/util/List;)V
...
.method public static redactElements(Ljava/util/List;Lcom/czhj/wire/ProtoAdapter;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-virtual {p1, v2}, Lcom/czhj/wire/ProtoAdapter;->redact(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static redactElements(Ljava/util/Map;Lcom/czhj/wire/ProtoAdapter;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-virtual {p1, v1}, Lcom/czhj/wire/ProtoAdapter;->redact(Ljava/lang/Object;)Ljava/lang/Object;
