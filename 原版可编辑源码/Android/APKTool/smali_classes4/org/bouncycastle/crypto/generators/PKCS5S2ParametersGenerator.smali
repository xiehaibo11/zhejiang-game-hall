...
.method private F([B[BI[B[BI)V
    ...
    invoke-interface {p1, v2}, Lorg/bouncycastle/crypto/Mac;->init(Lorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {v3, p2, p1, v4}, Lorg/bouncycastle/crypto/Mac;->update([BII)V
    ...
    invoke-interface {p2, p4, p1, v3}, Lorg/bouncycastle/crypto/Mac;->update([BII)V

    iget-object p2, p0, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->hMac:Lorg/bouncycastle/crypto/Mac;

    invoke-interface {p2, v1, p1}, Lorg/bouncycastle/crypto/Mac;->doFinal([BI)I

    invoke-static {v1, p1, p5, p6, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-interface {p4, v2}, Lorg/bouncycastle/crypto/Mac;->init(Lorg/bouncycastle/crypto/CipherParameters;)V

    iget-object p4, p0, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->hMac:Lorg/bouncycastle/crypto/Mac;

    invoke-interface {p4, v1, p1, v0}, Lorg/bouncycastle/crypto/Mac;->update([BII)V

    iget-object p4, p0, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->hMac:Lorg/bouncycastle/crypto/Mac;

    invoke-interface {p4, v1, p1}, Lorg/bouncycastle/crypto/Mac;->doFinal([BI)I
