...
.method public verifySignature([B)Z
    ...
    invoke-direct {p0, p1, v6, v7, v8}, Lorg/bouncycastle/crypto/signers/ISO9796d2PSSSigner;->maskGeneratorFunction1([BIII)[B
    ...
    :goto_4
    iput-boolean v8, p0, Lorg/bouncycastle/crypto/signers/ISO9796d2PSSSigner;->fullMessage:Z
    ...
    iput-object v6, p0, Lorg/bouncycastle/crypto/signers/ISO9796d2PSSSigner;->recoveredMessage:[B

    array-length v8, v6

    invoke-static {p1, v7, v6, v0, v8}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-interface {v8, v6, v0, v4}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {v6, v4, v0, v8}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    :cond_c
    iget-object v4, p0, Lorg/bouncycastle/crypto/signers/ISO9796d2PSSSigner;->digest:Lorg/bouncycastle/crypto/Digest;

    invoke-interface {v4, v5, v0, v1}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {v1, p1, v7, v4}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {v5, v4, v0}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I
