...
.method public static a(Landroid/content/Context;Lcom/xiaomi/push/hh;)V
    .locals 2
    ...
    new-instance v1, Lcom/xiaomi/push/he$a;

    invoke-direct {v1, p0, p1}, Lcom/xiaomi/push/he$a;-><init>(Landroid/content/Context;Lcom/xiaomi/push/hh;)V
...
.method private static a(Landroid/content/Context;Lcom/xiaomi/push/hh;Ljava/io/File;[B)V
    .locals 12
    ...
    :cond_2
    invoke-static {v2}, Lcom/xiaomi/push/af;->a([B)I
    ...
    :cond_5
    new-instance v9, Lcom/xiaomi/push/hn;

    invoke-direct {v9}, Lcom/xiaomi/push/hn;-><init>()V

    invoke-static {v9, v7}, Lcom/xiaomi/push/it;->a(Lcom/xiaomi/push/iu;[B)V
    ...
    invoke-virtual {v9, v10, v11}, Lcom/xiaomi/push/hn;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_6
    invoke-static {p0, p1, v0}, Lcom/xiaomi/push/hf;->a(Landroid/content/Context;Lcom/xiaomi/push/hh;Ljava/util/List;)V
    ...
    :cond_9
    invoke-static {v4}, Lcom/xiaomi/push/ab;->a(Ljava/io/Closeable;)V
...
.method static synthetic b(Landroid/content/Context;Lcom/xiaomi/push/hh;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/xiaomi/push/he;->c(Landroid/content/Context;Lcom/xiaomi/push/hh;)V

    return-void
.end method

.method private static c(Landroid/content/Context;Lcom/xiaomi/push/hh;)V
    .locals 11
    ...
    sget-boolean v2, Lcom/xiaomi/push/he;->a:Z

    if-nez v2, :cond_4

    const/4 v2, 0x1

    sput-boolean v2, Lcom/xiaomi/push/he;->a:Z
    ...
    :cond_0
    invoke-static {p0}, Lcom/xiaomi/push/he;->a(Landroid/content/Context;)V
    ...
    invoke-static {v7}, Lcom/xiaomi/push/ab;->a(Ljava/io/File;)Z
    ...
    :cond_2
    invoke-static {p0, p1, v2, v3}, Lcom/xiaomi/push/he;->a(Landroid/content/Context;Lcom/xiaomi/push/hh;Ljava/io/File;[B)V

    const/4 p1, 0x0

    invoke-static {p1}, Lcom/xiaomi/push/hd;->a(Z)V

    invoke-static {p0}, Lcom/xiaomi/push/he;->b(Landroid/content/Context;)V

    sput-boolean p1, Lcom/xiaomi/push/he;->a:Z
