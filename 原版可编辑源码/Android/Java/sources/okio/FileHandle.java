...
public abstract class FileHandle implements Closeable {
    ...
    public static Source source$default(FileHandle fileHandle, long j, int i, Object obj) throws IOException {
        if (obj != null) {
    ...
    public static Sink sink$default(FileHandle fileHandle, long j, int i, Object obj) throws IOException {
        if (obj != null) {
    ...
    private final long readNoCloseCheck(long fileOffset, Buffer sink, long byteCount) throws IOException {
        if (!(byteCount >= 0)) {
    ...
    private final void writeNoCloseCheck(long fileOffset, Buffer source, long byteCount) throws IOException {
