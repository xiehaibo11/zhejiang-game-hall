...
public final class ResourceFileSystem extends FileSystem {
    ...
    public ResourceFileSystem(final ClassLoader classLoader, boolean z) {
        ...
        this.roots = LazyKt.lazy(new Function0<List<? extends Pair<? extends FileSystem, ? extends Path>>>() {
    ...
    private static final class Companion {
        ...
        public final Path removeBase(Path path, Path base) {
            ...
            return getROOT().resolve(StringsKt.replace$default(StringsKt.removePrefix(path.toString(), (CharSequence) base.toString()), TokenParser.ESCAPE, '/', false, 4, (Object) null));
        }
        ...
        public final Pair<FileSystem, Path> toFileRoot(URL url) {
            ...
            if (Intrinsics.areEqual(url.getProtocol(), h.x)) {
        ...
        public final Pair<FileSystem, Path> toJarRoot(URL url) {
            ...
            return TuplesKt.to(ZipKt.openZip(Path.Companion.get$default(companion, new File(URI.create(strSubstring)), false, 1, (Object) null), FileSystem.SYSTEM, new Function1<ZipEntry, Boolean>() {
                @Override
