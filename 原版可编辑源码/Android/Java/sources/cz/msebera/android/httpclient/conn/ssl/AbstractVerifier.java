...
public abstract class AbstractVerifier implements X509HostnameVerifier {
    static final String[] BAD_COUNTRY_2LDS = {b.da, "co", "com", "ed", "edu", "go", "gouv", "gov", DBDefinition.SEGMENT_INFO, "lg", "ne", "net", "or", "org"};
    ...
    public final void verify(String str, X509Certificate x509Certificate) throws SSLException {
        ...
        String strFindMostSpecific = new DistinguishedNameParser(x509Certificate.getSubjectX500Principal()).findMostSpecific(AdvanceSetting.CLEAR_NOTIFICATION);
        String[] strArr = null;
