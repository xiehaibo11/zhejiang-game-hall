    ...
    public CloseableHttpClient build() {
        ...
        if (httpClientConnectionManager2 == null) {
            ...
            if (sSLConnectionSocketFactory == null) {
                ...
                if (sSLContext != null) {
                    sSLConnectionSocketFactory = new SSLConnectionSocketFactory(sSLContext, strArrSplit, strArrSplit2, defaultHostnameVerifier);
