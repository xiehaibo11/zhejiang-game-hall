...
public class ResponseAuthCache implements HttpResponseInterceptor {
    ...
    public void process(HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        ...
        if (httpHost != null && authState != null) {
            ...
            if (isCachable(authState)) {
                ...
                int i = 1.$SwitchMap$cz$msebera$android$httpclient$auth$AuthProtocolState[authState.getState().ordinal()];
                if (i == 1) {
        ...
        if (isCachable(authState2)) {
            ...
            int i2 = 1.$SwitchMap$cz$msebera$android$httpclient$auth$AuthProtocolState[authState2.getState().ordinal()];
            if (i2 == 1) {
    ...
    static class 1 {
        static final int[] $SwitchMap$cz$msebera$android$httpclient$auth$AuthProtocolState = new int[AuthProtocolState.values().length];
