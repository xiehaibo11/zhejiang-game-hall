...
public class MultipartEntityBuilder {
    ...
    MultipartFormEntity buildEntity() {
        ...
        int i = 1.$SwitchMap$cz$msebera$android$httpclient$entity$mime$HttpMultipartMode[httpMultipartMode.ordinal()];
        if (i == 1) {
    ...
    static class 1 {
        static final int[] $SwitchMap$cz$msebera$android$httpclient$entity$mime$HttpMultipartMode = new int[HttpMultipartMode.values().length];
