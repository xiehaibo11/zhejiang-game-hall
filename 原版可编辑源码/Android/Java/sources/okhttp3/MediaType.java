...
public final class MediaType {
    ...
    public static Charset charset$default(MediaType mediaType, Charset charset, int i, Object obj) {
        if ((i & 1) != 0) {
            charset = null;
        }
    ...
    public static final class Companion {
        ...
        public final MediaType -deprecated_get(String mediaType) {
        ...
        public final MediaType -deprecated_parse(String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
