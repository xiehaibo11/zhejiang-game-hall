    ...
    */
    ...
    private final Request createTunnel(int readTimeout, int writeTimeout, Request tunnelRequest, HttpUrl url) throws IOException {
        ...
        while (true) {
            ...
            bufferedSink.getThis$0().timeout(writeTimeout, TimeUnit.MILLISECONDS);
    ...
    class 1 extends RealWebSocket.Streams {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        1(boolean z, BufferedSource bufferedSource, BufferedSink bufferedSink, StreamAllocation streamAllocation) {
    ...
    public final ExchangeCodec newCodec$okhttp(OkHttpClient client, RealInterceptorChain chain) throws SocketException {
        ...
        bufferedSink.getThis$0().timeout(chain.getWriteTimeoutMillis(), TimeUnit.MILLISECONDS);
