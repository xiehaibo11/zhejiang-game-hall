...
public final class HostnamesKt {
    public static final String toCanonicalHost(String str) {
        ...
        try {
            ...
            return containsInvalidHostnameAsciiCodes(lowerCase) ? (String) null : lowerCase;
        ...
        while (true) {
            if (i4 < i2) {
                if (i7 != 16) {
                    ...
                    if (i7 != 0) {
                        if (StringsKt.startsWith$default(str, Constants.COLON_SEPARATOR, i4, false, 4, (Object) null)) {
                            i4++;
                        } else {
