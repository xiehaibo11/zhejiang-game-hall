...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class 1 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() {
            @Override
            public void run() {
                SyncQueueItem next = 1.this.mQueue.next();
                while (next != null) {
                    int i = next.what;
                    if (i == 1) {
                        1.this.val$callback.updateItemCount(next.arg1, next.arg2);
                    } else if (i == 2) {
                        1.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                    } else if (i == 3) {
                        1.this.val$callback.removeTile(next.arg1, next.arg2);
                    } else {
                        Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                    }
                    next = 1.this.mQueue.next();
                }
            }
        };
    ...
    class 2 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() {
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = 2.this.mQueue.next();
                    if (next != null) {
                        int i = next.what;
                        if (i == 1) {
                            2.this.mQueue.removeMessages(1);
                            2.this.val$callback.refresh(next.arg1);
                        } else if (i == 2) {
                            2.this.mQueue.removeMessages(2);
                            2.this.mQueue.removeMessages(3);
                            2.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                        } else if (i == 3) {
                            2.this.val$callback.loadTile(next.arg1, next.arg2);
                        } else if (i == 4) {
                            2.this.val$callback.recycleTile((TileList.Tile) next.data);
                        } else {
                            Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                        }
                    } else {
