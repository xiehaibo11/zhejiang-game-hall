...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v1, types: [android.support.v7.widget.ActionMenuPresenter] */
    ...
    /* JADX WARN: Type inference failed for: r14v1, types: [android.support.v7.view.menu.MenuItemImpl] */
    ...
    public boolean flagActionItems() {
        ...
        while (i10 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                View itemView = r02.getItemView(menuItemImpl2, r02.mScrapActionButtonView, viewGroup);
                if (r02.mScrapActionButtonView == null) {
                    r02.mScrapActionButtonView = itemView;
                }
                ...
                boolean z4 = z3;
                if (z3) {
                    View itemView2 = r02.getItemView(menuItemImpl2, r02.mScrapActionButtonView, viewGroup);
                    i2 = size;
                    if (r02.mScrapActionButtonView == null) {
                        r02.mScrapActionButtonView = itemView2;
                    }
                    if (r02.mStrictWidthLimit) {
                    ...
                    z3 = z4 & (!r02.mStrictWidthLimit ? i4 + i11 <= 0 : i4 < 0);
                } else {
                    i2 = size;
                }
                if (z3 && groupId2 != 0) {
