    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void animateOffsetWithDuration(final CoordinatorLayout coordinatorLayout, final T t, int i, int i2) {
            ...
            if (valueAnimator2 == null) {
                ...
                valueAnimator3.setInterpolator(android.support.design.animation.AnimationUtils.DECELERATE_INTERPOLATOR);
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, T t) {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    animateOffsetTo(coordinatorLayout, t, android.support.v4.math.MathUtils.clamp(i, -t.getTotalScrollRange(), 0), 0.0f);
                }
            }
        }
