...
public class EC5Util {
    static EllipticCurve convertCurve(ECCurve eCCurve, byte[] bArr) {
    ...
    static ECCurve convertCurve(EllipticCurve ellipticCurve) {
    ...
    static ECPoint convertPoint(ECParameterSpec eCParameterSpec, java.security.spec.ECPoint eCPoint, boolean z) {
        return convertPoint(convertCurve(eCParameterSpec.getCurve()), eCPoint, z);
    }

    static ECPoint convertPoint(ECCurve eCCurve, java.security.spec.ECPoint eCPoint, boolean z) {
    ...
    static org.bouncycastle.jce.spec.ECParameterSpec convertSpec(ECParameterSpec eCParameterSpec, boolean z) {
