        ...
        if (size != 1) {
            if (size == 2) {
                ...
                if (tagNo == 0) {
                    ...
                    dERInteger = DERInteger.getInstance(aSN1TaggedObject, false);
                }
            } else {
                if (size != 3) {
                ...
                dERInteger = DERInteger.getInstance(ASN1TaggedObject.getInstance(aSN1Sequence.getObjectAt(2)));
            }
            this.maximum = dERInteger;
        }
    }
