        ...
        this.mErrorListener = new MediaPlayer.OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mediaPlayer, int i2, int i3) {
                ...
                if ((Cocos2dxVideoView.this.mOnErrorListener == null || !Cocos2dxVideoView.this.mOnErrorListener.onError(Cocos2dxVideoView.this.mMediaPlayer, i2, i3)) && Cocos2dxVideoView.this.getWindowToken() != null) {
                    ...
                    new AlertDialog.Builder(Cocos2dxVideoView.this.mCocos2dxActivity).setTitle(resources.getString(resources.getIdentifier("VideoView_error_title", i.g, "android"))).setMessage(identifier).setPositiveButton(resources.getString(resources.getIdentifier("VideoView_error_button", i.g, "android")), new DialogInterface.OnClickListener() {
                        @Override
