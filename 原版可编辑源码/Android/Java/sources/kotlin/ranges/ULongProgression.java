...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        int i = ((((int) ULong.constructor-impl(getFirst() ^ ULong.constructor-impl(getFirst() >>> 32))) * 31) + ((int) ULong.constructor-impl(getLast() ^ ULong.constructor-impl(getLast() >>> 32)))) * 31;
        long j = this.step;
        return i + ((int) (j ^ (j >>> 32)));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.toString-impl(getFirst()));
            sb.append("..");
            sb.append((Object) ULong.toString-impl(getLast()));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
