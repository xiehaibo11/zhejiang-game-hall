...
public final class DurationKt {
    ...
    */
    private static final long parseDuration(String str, boolean z) {
            ...
            while (i < length) {
                if (str.charAt(i) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long j2 = Duration.plus-LRDsOJo(j, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        ...
                        j = Duration.plus-LRDsOJo(j2, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        j = Duration.plus-LRDsOJo(j, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                ...
                while (length2 < length) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long j3 = Duration.plus-LRDsOJo(j, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        ...
                        j = Duration.plus-LRDsOJo(j3, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        j = Duration.plus-LRDsOJo(j, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z2 ? Duration.unaryMinus-UwyO8pc(j) : j;
    }
    ...
    */
    ...
    private static final long durationOf(long j, int i) {
        return Duration.constructor-impl((j << 1) + ((long) i));
    }
