...
public final class UnsignedKt {
    ...
    public static final int uintDivide-J1ME1BU(int i, int i2) {
        return UInt.constructor-impl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }
    ...
    public static final long ulongDivide-eb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return ulongCompare(j, j2) < 0 ? ULong.constructor-impl(0L) : ULong.constructor-impl(1L);
        }
        if (j >= 0) {
            return ULong.constructor-impl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.constructor-impl(j3 + ((long) (ulongCompare(ULong.constructor-impl(j - (j3 * j2)), ULong.constructor-impl(j2)) < 0 ? 0 : 1)));
    }

    public static final long ulongRemainder-eb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return ulongCompare(j, j2) < 0 ? j : ULong.constructor-impl(j - j2);
        }
        if (j >= 0) {
            return ULong.constructor-impl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (ulongCompare(ULong.constructor-impl(j3), ULong.constructor-impl(j2)) < 0) {
            j2 = 0;
        }
    ...
    public static final int doubleToUInt(double d) {
        ...
        return UInt.constructor-impl(UInt.constructor-impl((int) (d - ((double) Integer.MAX_VALUE))) + UInt.constructor-impl(Integer.MAX_VALUE));
    }
