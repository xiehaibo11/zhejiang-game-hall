...
public final class URandomKt {
    ...
    public static final int nextUInt-qCasIEU(Random nextUInt, int i) {
        Intrinsics.checkNotNullParameter(nextUInt, "$this$nextUInt");
        return nextUInt-a8DCA5k(nextUInt, 0, i);
    }

    public static final int nextUInt-a8DCA5k(Random nextUInt, int i, int i2) {
        Intrinsics.checkNotNullParameter(nextUInt, "$this$nextUInt");
    ...
    public static final int nextUInt(Random random, UIntRange range) {
        ...
        if (!range.isEmpty()) {
            return UnsignedKt.uintCompare(range.getLast(), -1) < 0 ? nextUInt-a8DCA5k(random, range.getFirst(), UInt.constructor-impl(range.getLast() + 1)) : UnsignedKt.uintCompare(range.getFirst(), 0) > 0 ? UInt.constructor-impl(nextUInt-a8DCA5k(random, UInt.constructor-impl(range.getFirst() - 1), range.getLast()) + 1) : nextUInt(random);
        }
    ...
    public static final long nextULong-V1Xi4fY(Random nextULong, long j) {
        Intrinsics.checkNotNullParameter(nextULong, "$this$nextULong");
        return nextULong-jmpaW-c(nextULong, 0L, j);
    }

    public static final long nextULong-jmpaW-c(Random nextULong, long j, long j2) {
        Intrinsics.checkNotNullParameter(nextULong, "$this$nextULong");
    ...
    public static final long nextULong(Random random, ULongRange range) {
        ...
        if (UnsignedKt.ulongCompare(range.getLast(), -1L) < 0) {
            return nextULong-jmpaW-c(random, range.getFirst(), ULong.constructor-impl(range.getLast() + ULong.constructor-impl(((long) 1) & 4294967295L)));
        }
    ...
    public static final byte[] nextUBytes-EVgfTAA(Random nextUBytes, byte[] array) {
    ...
    public static byte[] nextUBytes-Wvrt4B4$default(Random random, byte[] bArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
    ...
    public static final byte[] nextUBytes-Wvrt4B4(Random nextUBytes, byte[] array, int i, int i2) {
        Intrinsics.checkNotNullParameter(nextUBytes, "$this$nextUBytes");
        Intrinsics.checkNotNullParameter(array, "array");
