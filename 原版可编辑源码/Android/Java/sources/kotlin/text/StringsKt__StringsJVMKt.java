...
class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    static char[] toCharArray$default(String str, char[] destination, int i, int i2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            i = 0;
        }
        if ((i4 & 4) != 0) {
