...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    public static final UByteArray box-impl(byte[] bArr) {
        return new UByteArray(bArr);
    }

    public static byte[] constructor-impl(byte[] storage) {
    ...
    public static java.util.Iterator<UByte> iterator-impl(byte[] bArr) {
    ...
    public static boolean containsAll-impl(byte[] bArr, Collection<UByte> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
