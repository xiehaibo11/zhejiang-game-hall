...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        int i = 0;
        while (it.hasNext()) {
            UByteArray.set-VurrAj0(bArr, i, it.next().getData());
            i++;
        }
        return bArr;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        ...
        int i = 0;
        while (it.hasNext()) {
            UIntArray.set-VXSXFK8(iArr, i, it.next().getData());
            i++;
        }
        return iArr;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        ...
        int i = 0;
        while (it.hasNext()) {
            ULongArray.set-k8EXiF4(jArr, i, it.next().getData());
            i++;
        }
        return jArr;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        ...
        int i = 0;
        while (it.hasNext()) {
            UShortArray.set-01HTLdE(sArr, i, it.next().getData());
            i++;
        }
        return sArr;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.constructor-impl(i + it.next().getData());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        long j = 0;
        while (it.hasNext()) {
            j = ULong.constructor-impl(j + it.next().getData());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.constructor-impl(i + UInt.constructor-impl(it.next().getData() & UByte.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.constructor-impl(i + UInt.constructor-impl(it.next().getData() & UShort.MAX_VALUE));
        }
        return i;
    }
}
