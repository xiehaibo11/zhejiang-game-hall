...
public class pt {
    ...
    static {
        ...
        fw = new com.ss.android.download.api.download.rg.rg() {
            @Override
    ...
    private static ITTDownloadVisitor pp() {
    ...
    private static boolean df(Context context) {
        ...
        rgVarRg.rg(new q()).rg(new rg()).rg(new pt(applicationContext)).rg(new df()).rg(new com.ss.android.download.api.config.bm() {
            @Override
        ...
        }).rg(new com.ss.android.download.api.config.df() {
            @Override
            public boolean rg() {
                if (pt.pp() != null) {
        ...
        }).rg(new rg.rg().df("143").rg(TTVfConstant.APP_NAME).q("5.1.1.4").pt(String.valueOf(5114)).rg()).rg(new z() {
            @Override
        ...
        com.ss.android.socialbase.appdownloader.pt.bm().rg(new IInstallAppHandler() {
            @Override
    ...
    private static class q implements rz {
        ...
        public void rg(Activity activity, String[] strArr, final n nVar) {
            if (pt.pp() != null) {
                pt.pp().requestPermission(activity, strArr, new ITTPermissionCallback() {
                    @Override
    ...
    private static class df implements com.ss.android.download.api.config.ux {
        ...
        */
        public void rg(String str, String str2, Map<String, Object> map, final r rVar) {
            byte b;
            int iHashCode = str.hashCode();
            if (iHashCode != 70454) {
                b = (iHashCode == 2461856 && str.equals("POST")) ? (byte) 1 : (byte) -1;
            } else if (str.equals("GET")) {
                b = 0;
            }
            int i = (b == 0 || b != 1) ? 0 : 1;
            if (pt.pp() != null) {
                pt.pp().execute(i, str2, map, new ITTHttpCallback() {
                    @Override
        ...
        public void rg(String str, byte[] bArr, String str2, int i, final r rVar) {
            if (pt.pp() != null) {
                pt.pp().postBody(str, bArr, str2, new ITTHttpCallback() {
                    @Override
                    public void onResponse(String str3) {
                        r rVar2 = rVar;
                        if (rVar2 != null) {
    ...
    public static class pt implements hq {
        ...
        private DialogBuilder q(final DownloadAlertDialogInfo downloadAlertDialogInfo) {
            return DialogBuilder.builder().setTitle(downloadAlertDialogInfo.df).setMessage(downloadAlertDialogInfo.q).setNegativeBtnText(downloadAlertDialogInfo.pp).setPositiveBtnText(downloadAlertDialogInfo.pt).setIcon(downloadAlertDialogInfo.fw).setDialogStatusChangedListener(new IDialogStatusChangedListener() {
                @Override
    ...
    private static JSONObject df(com.ss.android.download.api.model.df dfVar) {
    ...
    public static boolean rg(Activity activity, final ExitInstallListener exitInstallListener) {
        return com.ss.android.downloadlib.addownload.rg.rg.rg().rg(activity, false, new rg.rg() {
            @Override
            public void rg() {
