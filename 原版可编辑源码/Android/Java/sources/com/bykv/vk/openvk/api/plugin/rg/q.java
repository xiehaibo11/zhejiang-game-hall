...
public class q {
    ...
    */
    public String rg(boolean z, String str, byte[] bArr) throws Throwable {
        HttpsURLConnection httpsURLConnection;
        int responseCode;
        HttpsURLConnection httpsURLConnection2 = null;
        try {
            URL url = new URL(str);
            HttpsURLConnection.setDefaultSSLSocketFactory(rg(df()));
            httpsURLConnection = (HttpsURLConnection) url.openConnection();
            try {
                try {
                    httpsURLConnection.setConnectTimeout(5000);
                    httpsURLConnection.setHostnameVerifier(com.bykv.vk.openvk.api.plugin.rg.rg.rg);
        ...
        if (responseCode >= 200 && responseCode < 300) {
            String str2 = new String(rg(httpsURLConnection.getInputStream(), 1024), rg(httpsURLConnection.getHeaderField("Content-Type"), "utf-8"));
            if (httpsURLConnection != null) {
                try {
