...
public class c {
    ...
    private void df(Context context) {
        try {
            IZeusReporter iZeusReporter = new IZeusReporter() {
                @Override
            ...
            Zeus.registerPluginStateListener(new ZeusPluginStateListener() {
                ...
                public void onPluginStateChange(final String str, final int i, Object... objArr) {
                    ...
                    if (i == 7) {
                        ...
                        com.bykv.vk.openvk.df.rg.rg().rg(new Runnable() {
                            @Override
                            public void run() {
                                c.this.df(str, i);
                            }
    ...
    private static com.bykv.vk.openvk.api.plugin.df q(String str) {
        try {
    ...
    private static void df(Plugin plugin) {
        if (plugin == null) {
    ...
    private static boolean df(com.bykv.vk.openvk.api.plugin.df dfVar) {
