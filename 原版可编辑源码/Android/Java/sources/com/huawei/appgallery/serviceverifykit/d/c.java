...
public class c {
    ...
    */
    public static X509Certificate a(Context context) throws Throwable {
        ...
        try {
            try {
                inputStreamOpen = context.getResources().getAssets().open("ag_sdk_cbg_root.cer");
                try {
                    X509Certificate x509Certificate2 = (X509Certificate) CertificateFactory.getInstance("X.509").generateCertificate(inputStreamOpen);
                    if (inputStreamOpen != null) {
                        try {
                            inputStreamOpen.close();
                        } catch (IOException unused) {
                            x509Certificate = x509Certificate2;
                            com.huawei.appgallery.serviceverifykit.d.d.b.b.a("X509CertUtil", "close stream failed");
                        }
                    }
                    x509Certificate = x509Certificate2;
                    context = inputStreamOpen;
                } catch (Resources.NotFoundException unused2) {
                    com.huawei.appgallery.serviceverifykit.d.d.b.b.a("X509CertUtil", "can not found cbg root cer");
                    context = inputStreamOpen;
                    inputStream = inputStreamOpen;
                    if (inputStreamOpen != null) {
                        try {
                    ...
                    com.huawei.appgallery.serviceverifykit.d.d.b.b.a("X509CertUtil", "can not open cbg root cer");
                    context = inputStreamOpen;
                    if (inputStreamOpen != null) {
                        inputStream = inputStreamOpen;
                        inputStream.close();
                    ...
                    com.huawei.appgallery.serviceverifykit.d.d.b.b.a("X509CertUtil", "CertificateException");
                    context = inputStreamOpen;
                    inputStream = inputStreamOpen;
                    if (inputStreamOpen != null) {
                    }
