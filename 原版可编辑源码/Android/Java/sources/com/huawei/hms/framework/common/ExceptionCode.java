    ...
    private static int getErrorCodeSocketTimeout(Exception exc) {
        ...
        if (iHashCode != 3496342) {
            if (iHashCode != 113399775) {
                b = (iHashCode == 951351530 && strCheckExceptionContainsKey.equals(CONNECT)) ? (byte) 0 : (byte) -1;
        ...
        return b != 0 ? b != 1 ? b != 2 ? SOCKET_TIMEOUT : SOCKET_WRITE_TIMEOUT : SOCKET_READ_TIMEOUT : SOCKET_CONNECT_TIMEOUT;
    }
}
