...
public class a {
    ...
    private static class a implements com.huawei.hms.framework.network.grs.b {
        ...
        a(String str, Map<String, String> map, IQueryUrlsCallBack iQueryUrlsCallBack, Context context, GrsBaseInfo grsBaseInfo, com.huawei.hms.framework.network.grs.a.a aVar) {
            this.a = str;
            this.b = map;
    ...
    private void a(String str, Map<String, String> map, IQueryUrlsCallBack iQueryUrlsCallBack, Context context) {
        this.d.a(new com.huawei.hms.framework.network.grs.c.b.c(this.b, context), new a(str, map, iQueryUrlsCallBack, context, this.b, this.c), str, this.e);
    }
