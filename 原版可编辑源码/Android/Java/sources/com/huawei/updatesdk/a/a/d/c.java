...
public class c {
    ...
    static {
        ...
        a.put("android.hardware.vulkan.compute", at.f);
        a.put("android.hardware.vulkan.level", at.g);
        a.put("android.hardware.vulkan.version", t.e);
        a.put("android.hardware.wifi", at.j);
        ...
        a.put("android.software.app_widgets", t.h);
        ...
        a.put("android.software.device_admin", t.i);
        ...
        a.put("android.software.live_wallpaper", com.sigmob.sdk.archives.tar.e.V);
        a.put("android.software.managed_users", HiAnalyticsConstant.KeyAndValue.NUMBER_01);
