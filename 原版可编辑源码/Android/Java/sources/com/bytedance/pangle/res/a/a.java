...
public class a {
    ...
    public static class a {
        ...
        private a(short s, int i, int i2, int i3) {
            this.a = s;
            this.b = i;
            this.c = i2;
            this.d = i3;
        ...
        public static a a(g gVar, e eVar) {
            int iA = eVar.a();
            try {
                return new a(gVar.readShort(), gVar.readShort(), gVar.readInt(), iA);
            } catch (EOFException unused) {
                return new a((short) -1, 0, 0, eVar.a());
            }
        }
    }
