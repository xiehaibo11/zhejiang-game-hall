...
public class ZeusProviderTransform {
    ...
    public static int update(Object obj, Uri uri, ContentValues contentValues, String str, String[] strArr, String str2) {
        ...
        try {
            return ((Integer) MethodUtils.invokeMethod(obj, h.o, new Object[]{uri, contentValues, str, strArr}, new Class[]{Uri.class, ContentValues.class, String.class, String[].class})).intValue();
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public static int update(Object obj, Uri uri, ContentValues contentValues, Bundle bundle, String str) {
        ...
        try {
            return ((Integer) MethodUtils.invokeMethod(obj, h.o, new Object[]{uri, contentValues, bundle}, new Class[]{Uri.class, ContentValues.class, Bundle.class})).intValue();
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
