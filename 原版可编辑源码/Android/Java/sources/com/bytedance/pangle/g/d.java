                        ...
                        try {
                            try {
                                try {
                                    ...
                                    c.c cVarA = c.a(randomAccessFile2, mVar);
                                    Signature[] signatureArrA = a(new Certificate[][]{cVarA.a});
                                    if (cVarA.b != null) {
                                        int size = cVarA.b.a.size();
                                        Signature[] signatureArr2 = new Signature[size];
                                        iArr = new int[cVarA.b.b.size()];
                                        for (int i = 0; i < size; i++) {
                                            signatureArr2[i] = new Signature(cVarA.b.a.get(i).getEncoded());
                                            iArr[i] = cVarA.b.b.get(i).intValue();
                                        }
                            ...
                            m mVar2 = f.a.get(str).get(ApkUtil.APK_SIGNATURE_SCHEME_V2_BLOCK_ID);
                            if (mVar2 == null) {
