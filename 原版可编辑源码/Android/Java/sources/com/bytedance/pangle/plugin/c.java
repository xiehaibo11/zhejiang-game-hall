...
public final class c {
    ...
    private PackageInfo a(String str, final Plugin plugin, StringBuilder sb, String str2, File file) {
        long jCurrentTimeMillis = System.currentTimeMillis();
        ...
        Zeus.getAppApplication().registerComponentCallbacks(new ComponentCallbacks() {
            @Override
    ...
    private void a(final Plugin plugin, String str, File file, File file2, StringBuilder sb) throws IllegalAccessException, IOException {
        long jCurrentTimeMillis = System.currentTimeMillis();
