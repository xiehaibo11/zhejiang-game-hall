...
public class a {
    ...
    private synchronized void a(int i, String str, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        c.a().a(new 1(str, jSONObject, jSONObject2, i), iNextInt);
    }
    ...
    final class 1 implements Runnable {
        ...
        1(String str, JSONObject jSONObject, JSONObject jSONObject2, int i) {
            this.a = str;
            this.b = jSONObject;
            this.c = jSONObject2;
            this.d = i;
        ...
        public final void run() {
            new e(c.a().b(), this.a, this.b, this.c).a(this.d, new com.tramini.plugin.a.d.b() {
                @Override
                public final void a() {
                }
    ...
    private void a(int i, String str, JSONObject jSONObject, JSONObject jSONObject2, int i2) {
        c.a().a(new 1(str, jSONObject, jSONObject2, i), i2);
    }
}
