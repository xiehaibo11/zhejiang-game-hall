...
/* JADX WARN: Classes with same name are omitted, all sources:
  ...
  classes4.dex
 */
public class AllowStartPluginResponseEvent extends SepperllitaEvent {
    public AllowStartPluginResponseEvent(Activity activity, String str, int i, String str2) {
        super(activity);
        setAct("push");
        setPg("P1069");
        setBlk("BHF010");
