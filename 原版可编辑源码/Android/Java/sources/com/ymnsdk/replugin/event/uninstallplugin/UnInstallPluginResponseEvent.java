...
/* JADX WARN: Classes with same name are omitted, all sources:
  ...
  classes4.dex
 */
public class UnInstallPluginResponseEvent extends SepperllitaEvent {
    public UnInstallPluginResponseEvent(Activity activity, int i, String str, int i2, String str2, long j) {
        super(activity);
        setAct("push");
        setPg("P1069");
        setBlk("BHF004");
