...
/* JADX WARN: Classes with same name are omitted, all sources:
  ...
  classes4.dex
 */
public class ApkSilentDownloadingEvent extends SepperllitaEvent {
    public ApkSilentDownloadingEvent(Activity activity) {
        super(activity);
        setAct("push");
        setPg("P1069");
        setBlk("BHF001");
    ...
    public ApkSilentDownloadingEvent(Activity activity, String str, String str2, long j, long j2, long j3) {
        this(activity);
        setRv(str2);
        setDur(j3 + "");
