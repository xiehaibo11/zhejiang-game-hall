...
public final class h implements BaseNotifyDataAdapter {
        ...
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
            ...
            try {
                for (int i = Integer.parseInt(str); i > 0; i--) {
                    ...
                    int identifier = this.a.getIdentifier(str3, com.tkay.expressad.foundation.h.i.c, this.b);
                    if (identifier > 0) {
    ...
    public final int getDefaultNotifyIcon() {
        ...
        for (String strSubstring = this.c; !TextUtils.isEmpty(strSubstring); strSubstring = strSubstring.substring(0, strSubstring.length() - 1)) {
            int identifier = this.a.getIdentifier("vivo_push_rom" + strSubstring + "_notifyicon", com.tkay.expressad.foundation.h.i.c, this.b);
            if (identifier > 0) {
                return identifier;
            }
        }
        return this.a.getIdentifier("vivo_push_notifyicon", com.tkay.expressad.foundation.h.i.c, this.b);
    }
    ...
    public final int getDefaultSmallIconId() {
        ...
        for (String strSubstring = this.c; !TextUtils.isEmpty(strSubstring); strSubstring = strSubstring.substring(0, strSubstring.length() - 1)) {
            int identifier = this.a.getIdentifier("vivo_push_rom" + strSubstring + "_icon", com.tkay.expressad.foundation.h.i.c, this.b);
            if (identifier > 0) {
                return identifier;
            }
        }
        return this.a.getIdentifier("vivo_push_icon", com.tkay.expressad.foundation.h.i.c, this.b);
    }
