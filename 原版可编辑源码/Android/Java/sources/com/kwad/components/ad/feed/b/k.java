...
public final class k extends a implements View.OnClickListener, com.kwad.sdk.widget.c {
    ...
    private void c(View view, final int i) {
        if (view == this.em) {
            ...
            com.kwad.components.core.e.d.a.a(new a.a(getContext()).am(5).an(i).P(this.mAdTemplate).b(this.mApkDownloadHelper).ao(view == this.er ? 1 : 2).am(view == this.er).a(new a.b() {
                @Override
