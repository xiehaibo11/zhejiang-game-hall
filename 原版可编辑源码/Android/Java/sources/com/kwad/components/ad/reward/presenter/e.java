...
public final class e {
    ...
    private static void a(final com.kwad.components.ad.reward.j jVar, final k.b bVar) {
        ...
        com.kwad.components.ad.reward.j.a(jVar, cVarA, new k.b() {
            @Override
    ...
    private static void q(final com.kwad.components.ad.reward.j jVar) {
    ...
    private static void x(final com.kwad.components.ad.reward.j jVar) {
        final AdTemplate adTemplate = jVar.mAdTemplate;
        com.kwad.components.ad.reward.j.a(jVar, com.kwad.components.ad.reward.k.a(jVar, (String) null), new k.b() {
            @Override
            public final void H(boolean z) {
                jVar.F(false);
                if (!z) {
    ...
    private static void y(com.kwad.components.ad.reward.j jVar) {
