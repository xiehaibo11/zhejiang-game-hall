...
public abstract class c extends a implements View.OnClickListener, com.kwad.sdk.widget.c {
    ...
    public c(Context context) {
        ...
        this.cs = false;
        this.ct = new com.kwad.sdk.widget.j() {
            @Override
        ...
        this.eC = new a.a() {
            ...
            public final void a(int i, ac.a aVar) {
                ...
                bVar.jG = i2;
                c.this.aY();
                com.kwad.components.core.e.d.a.a(new a.a(c.this.getContext()).P(c.this.mAdTemplate).b(c.this.mApkDownloadHelper).ao(i3).am(z).ao(true).am(5).an(i2).aq(true).a(bVar).a(new a.b() {
                    @Override
    ...
    private void a(com.kwad.sdk.core.video.videoview.a aVar, boolean z, final int i) {
        if (aVar != null || this.eG) {
            ...
            aY();
            a.a aVarAm = new a.a(getContext()).P(this.mAdTemplate).b(this.mApkDownloadHelper).am(z);
            IAdLivePlayModule iAdLivePlayModule = this.eF;
            com.kwad.components.core.e.d.a.a(aVarAm.s(iAdLivePlayModule == null ? 0L : iAdLivePlayModule.getPlayDuration()).ao(i2).aq(true).a(new a.b() {
                @Override
                public final void onAdClicked() {
                    c.this.aK(i);
                }
    ...
    */
    public void onClick(View view) {
        ...
        if (view == this.ev && (aVar = this.ex) != null && aVar.isIdle()) {
        ...
        if (view == this.ek) {
            ...
            if (view == this.er || view == this.dC || view == this.eq) {
                i = 1;
            } else if (view == this.du) {
                i = 13;
            } else if (view == this.dv) {
                i = 14;
            } else if (view == this.eo || view == this.ep) {
                i = 101;
            } else if (view == this.ex) {
                i = 100;
            }
        }
        a(this.ex, view == this.er, i);
    }
