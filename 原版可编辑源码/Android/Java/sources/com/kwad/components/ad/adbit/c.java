...
public final class c {
    ...
    public static String a(SceneImpl sceneImpl) {
        ...
        final com.kwad.components.core.p.a.a aVarPI = new a.a().e(new com.kwad.components.core.p.a.b(sceneImpl)).a(new com.kwad.components.core.p.c()).pI();
        b bVar = (b) a(new com.kwad.sdk.g.c<b>() {
            @Override
            private b get() {
                return new b(aVarPI);
            }
    ...
    private static void a(final List<String> list, final AdBitResultData adBitResultData, final com.kwad.components.core.p.a.a aVar) {
        new m<com.kwad.components.ad.a.b, AdBitResultData>() {
            @Override
            private com.kwad.components.ad.a.b createRequest() {
                return new com.kwad.components.ad.a.b(adBitResultData.adxId, list);
            }

            @Override
            private AdBitResultData parseData(String str) {
                JSONObject jSONObject = new JSONObject(str);
        ...
        }.request(new p<com.kwad.components.ad.a.b, AdBitResultData>() {
    ...
    public static String getBidRequestTokenV2(KsScene ksScene) {
        final com.kwad.components.core.p.a.a aVarPI = new a.a().e(new com.kwad.components.core.p.a.b(SceneImpl.covert(ksScene))).a(new com.kwad.components.core.p.c()).pI();
        com.kwad.components.ad.a.a aVar = (com.kwad.components.ad.a.a) a(new com.kwad.sdk.g.c<com.kwad.components.ad.a.a>() {
            @Override
            private com.kwad.components.ad.a.a get() {
