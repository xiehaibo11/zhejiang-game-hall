...
public final class s extends a implements View.OnClickListener, com.kwad.components.ad.reward.e.m, com.kwad.sdk.core.g.b {
    ...
    private Animator a(float f, float f2) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new com.kwad.components.ad.widget.a(this.gU) {
            @Override
        ...
        valueAnimatorOfFloat2.addUpdateListener(new com.kwad.components.ad.widget.a(this.gS) {
            @Override
            public final void a(ViewGroup.LayoutParams layoutParams, Object obj) {
                float fFloatValue = ((Float) obj).floatValue();
                if (layoutParams != null) {
        ...
        valueAnimatorOfFloat4.addUpdateListener(new com.kwad.components.ad.widget.a(this.gQ) {
            @Override
            public final void a(ViewGroup.LayoutParams layoutParams, Object obj) {
        ...
        valueAnimatorOfFloat5.addUpdateListener(new com.kwad.components.ad.widget.a(this.gR) {
            @Override
            public final void a(ViewGroup.LayoutParams layoutParams, Object obj) {
                layoutParams.height = (int) ((Float) obj).floatValue();
            }
        ...
        animatorClone.addListener(new AnimatorListenerAdapter() {
