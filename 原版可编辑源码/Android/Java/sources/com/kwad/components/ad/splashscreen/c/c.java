...
public final class c extends e implements com.kwad.sdk.core.h.c {
    ...
    private void s(AdInfo adInfo) {
        ...
        this.CI.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        this.CI.post(new Runnable() {
            ...
            public final void run() {
                ((View) c.this.CF).post(new Runnable() {
                    @Override
                    public final void run() {
    ...
    public final void ah() {
        ...
        this.CF.setOnViewListener(new SkipView.a() {
            @Override
    ...
    public final void kS() {
        this.CM.mRootContainer.post(new Runnable() {
            @Override
            public final void run() {
