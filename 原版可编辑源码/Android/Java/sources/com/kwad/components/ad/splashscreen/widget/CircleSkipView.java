...
public class CircleSkipView extends KSFrameLayout implements a {
    ...
    static boolean a(CircleSkipView circleSkipView, boolean z) {
    ...
    private void c(final int i, final boolean z) {
        ...
        this.EU.addListener(new AnimatorListenerAdapter() {
            @Override
        ...
        this.EU.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
