...
public class KSRewardVideoActivityProxy extends com.kwad.components.core.l.b<j> implements j.b, o.a, c.b, OnAdLiveResumeInterceptor {
    ...
    private com.kwad.components.ad.reward.e.b mAdOpenInteractionListener = new com.kwad.components.ad.reward.e.c() {
        @Override
    ...
    private com.kwad.components.ad.reward.e.d mAdRewardStepListener = new com.kwad.components.ad.reward.e.d() {
        @Override
    ...
    protected j onCreateCallerContext() {
        ...
        if (com.kwad.sdk.core.response.b.b.bk(adTemplate)) {
            ...
            jVar.oZ.a(new com.kwad.components.ad.reward.c.d() {
                @Override
