...
public final class e extends KSRelativeLayout implements com.kwad.sdk.core.h.c {
    ...
    public e(Context context) {
        ...
        this.mNetworking = new m<com.kwad.components.core.liveEnd.a, AdLiveEndCommonResultData>() {
            @Override
        ...
        this.eJ = new AdLivePlayStateListenerAdapter() {
            ...
            public final void onLivePlayEnd() {
                ...
                e.this.mNetworking.request(new p<com.kwad.components.core.liveEnd.a, AdLiveEndCommonResultData>() {
                    @Override
    ...
    private void bh() {
        ...
        if (TextUtils.isEmpty(url)) {
            ...
            KSImageLoader.loadImage(this.mO, url, this.mAdTemplate, new DisplayImageOptionsCompat.Builder().setBlurRadius(50).build(), new SimpleImageLoadingListener() {
                @Override
    ...
    private com.kwad.sdk.core.webview.d.a.a getClickListener() {
        return new com.kwad.sdk.core.webview.d.a.a() {
            ...
            public final void a(com.kwad.sdk.core.webview.d.b.a aVar) {
                ...
                com.kwad.components.core.e.d.a.a(new a.a(e.this.getContext()).P(e.this.mAdTemplate).b(e.this.mApkDownloadHelper).am(false).ao(i).as(aVar.JC).aq(zAU).s(e.this.eF == null ? 0L : e.this.eF.getPlayDuration()).a(bVar).ao(true).a(new a.b() {
                    @Override
    ...
    private af.a getOpenNewPageListener() {
        return new af.a() {
            ...
            public final void a(com.kwad.components.core.webview.a.b bVar) {
                AdWebViewActivityProxy.launch(e.this.mContext, new AdWebViewActivityProxy.a.a().aq(bVar.title).ar(bVar.url).S(e.this.mAdTemplate).oA());
            }
        };
    }
