...
public final class l extends s implements View.OnClickListener {
    ...
    static Animator a(l lVar, View view) {
        return r(view);
    }

    static Animator a(l lVar, View view, long j, float f) {
    ...
    private void kf() {
        this.zB.postDelayed(new Runnable() {
            @Override
            public final void run() {
                l lVar = l.this;
                lVar.zF = l.a(lVar, lVar.zB, 100L, 8.0f);
                l.this.zF.addListener(new AnimatorListenerAdapter() {
                    @Override
