...
public final class b extends com.kwad.components.ad.splashscreen.c.e implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        if (view == this.Eg) {
            AdWebViewActivityProxy.launch(getContext(), new AdWebViewActivityProxy.a.a().aq("隐私政策").ar(this.Ei.appPrivacyUrl).ay(true).S(this.CM.mAdTemplate).oA());
        } else if (view == this.Ef) {
            AdWebViewActivityProxy.launch(getContext(), new AdWebViewActivityProxy.a.a().aq("权限信息").ay(true).ar(this.Ei.appPermissionInfoUrl).S(this.CM.mAdTemplate).oA());
        }
    }
