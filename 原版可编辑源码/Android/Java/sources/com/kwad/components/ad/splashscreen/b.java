...
public final class b {
    ...
    private static void a(com.kwad.components.core.p.a.b bVar) {
        ...
        if (TextUtils.isEmpty(sceneImpl.getBidResponse()) && TextUtils.isEmpty(sceneImpl.getBidResponseV2())) {
            ...
            KsAdLoadManager.M();
            KsAdLoadManager.a(new a.a().e(bVar).aF(false).a(new com.kwad.components.core.p.c() {
                @Override
    ...
    public static void loadSplashScreenAd(KsScene ksScene, final KsLoadManager.SplashScreenAdListener splashScreenAdListener) {
        ...
        KsAdLoadManager.M();
        KsAdLoadManager.a(new a.a().e(bVar).aE(true).aF(zA).a(new com.kwad.components.core.p.c() {
            @Override
