...
public final class h extends com.kwad.sdk.mvp.a {
    ...
    public final void a(int i, Context context, final int i2, int i3, final a aVar) {
        ...
        com.kwad.components.core.e.d.a.a(new a.a(context).P(this.mAdTemplate).b(this.mApkDownloadHelper).ao(i3).am(false).an(i2).am(i).a(new a.b() {
            @Override
    ...
    public final void kM() {
        this.mRootContainer.post(new Runnable() {
            @Override
