...
public class FeedVideoView extends b<AdTemplate> implements NestedScrollingChild {
    ...
    private void a(com.kwad.components.core.video.a aVar, final com.kwad.sdk.core.video.videoview.a aVar2) {
        this.Yz.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        aVar.setVideoPlayCallback(new a.c() {
        ...
        this.Ox.setAdClickListener(new a.a() {
            @Override
            public final void a(int i, ac.a aVar3) {
                ...
                bVar.jI = aVar3;
                bVar.jG = i2;
                com.kwad.components.core.e.d.a.a(new a.a(FeedVideoView.this.getContext()).P(FeedVideoView.this.mAdTemplate).ar(true).b(FeedVideoView.this.mApkDownloadHelper).ao(i3).am(z).ao(true).a(bVar).a(new a.b() {
                    @Override
        ...
        this.Ys.setOnSeekBarChangeListener(new ScaleAnimSeekBar.a() {
            @Override
        ...
        this.Yt.setOnClickListener(new View.OnClickListener() {
            ...
            */
            public final void onClick(View view) {
                ...
                if (!aVar2.isPaused() && !aVar2.isIdle()) {
                    if (aVar2.isPlaying()) {
                        FeedVideoView.this.Ox.qU();
                        FeedVideoView.this.Yv.setVisibility(0);
                        FeedVideoView.this.Yv.setImageDrawable(FeedVideoView.this.getContext().getResources().getDrawable(R.drawable.ksad_video_play_176));
                        imageView = FeedVideoView.this.Yt;
                        resources = FeedVideoView.this.getContext().getResources();
                ...
                FeedVideoView.this.Ox.qV();
                FeedVideoView.this.Yt.setImageDrawable(FeedVideoView.this.getResources().getDrawable(R.drawable.ksad_video_player_pause_btn));
                imageView = FeedVideoView.this.Yv;
                resources = FeedVideoView.this.getResources();
        ...
        this.Yv.setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view) {
        ...
        this.Yx.setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view) {
                FeedVideoView.this.sr();
            }
        });
        this.Yu.setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view) {
    ...
    static boolean a(FeedVideoView feedVideoView, boolean z) {
    ...
    public final void a(KsAdVideoPlayConfig ksAdVideoPlayConfig, com.kwad.components.core.e.d.c cVar) {
        ...
        if (com.kwad.sdk.core.response.b.a.ai(this.mAdInfo)) {
            ...
            if (view != null) {
                ...
                this.Yo.setOnClickListener(new View.OnClickListener() {
                    @Override
