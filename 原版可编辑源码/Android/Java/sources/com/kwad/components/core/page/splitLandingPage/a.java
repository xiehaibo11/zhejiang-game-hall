...
public final class a extends e {
    ...
    private void initView() {
        ...
        this.Mt.post(new Runnable() {
            @Override
            public final void run() {
                a.this.Om.setTranslationY(a.this.Om.getTranslationY() + a.this.Mt.getHeight());
            }
        });
        this.Om.setSplitScrollWebViewListener(new SplitScrollWebView.a() {
            @Override
    ...
    private void v(View view) {
        ...
        ((ImageView) view.findViewById(R.id.ksad_web_tip_close_btn)).setOnClickListener(new View.OnClickListener() {
            @Override
