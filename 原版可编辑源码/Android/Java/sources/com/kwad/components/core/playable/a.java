...
public final class a implements i {
    ...
    static class a implements au.b {
    ...
    public a(KsAdWebView ksAdWebView) {
        this.Pb = ksAdWebView;
        ksAdWebView.setOnTouchListener(new View.OnTouchListener() {
            @Override
    ...
    private void a(b bVar, com.kwad.components.core.webview.a aVar, c cVar) {
        aVar.a(new au(bVar, cVar, new a(this)));
    ...
    private void az(int i) {
        ...
        if (jZM <= 0 || SystemClock.elapsedRealtime() - this.Pc <= jZM) {
            ...
            com.kwad.components.core.e.d.a.a(new a.a(this.mContext).P(this.mAdTemplate).b(this.mApkDownloadHelper).am(false).a(bVar).ao(true));
        }
    }
