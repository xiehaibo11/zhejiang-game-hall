...
public final class c implements NetworkMonitor.a, com.kwad.sdk.core.download.d, com.kwad.sdk.core.webview.a {
    ...
    private void a(KsAppDownloadListener ksAppDownloadListener) {
    ...
    private int n(a.a aVar) {
        ...
        if (aVar.ns() && com.kwad.sdk.core.config.d.zj()) {
            return o(aVar);
        }
        if (com.kwad.sdk.core.response.b.d.cw(this.JU) && aVar.nu() != 2) {
            d(aVar.getContext(), aVar.getAdTemplate());
            return 0;
        }
        if (aVar.no()) {
            return p(aVar);
    ...
    private boolean nG() {
        a aVar = this.JX;
        if (aVar != null) {
            return aVar.handleDownloadDialog(new DialogInterface.OnClickListener() {
                @Override
    ...
    private boolean nI() {
        Context context = KsAdSDKImpl.get().getContext();
        if (d.b(new a.a(context).P(this.JU), 1) == 1) {
            return true;
        }
    ...
    private boolean q(a.a aVar) {
        if (aVar.nm() || this.mAdInfo.status == 4 || !com.kwad.sdk.core.response.b.b.bK(this.JU) || !r(aVar)) {
            return false;
        }
        return com.kwad.components.core.e.c.b.a(aVar.getContext(), new b.a().O(this.JU).ak(com.kwad.sdk.core.response.b.b.bJ(this.JU)).a(this.JY).c(this.mOnDismissListener).nc());
    }

    private static boolean r(a.a aVar) {
        AdInfo adInfoCg = com.kwad.sdk.core.response.b.d.cg(aVar.getAdTemplate());
        if (com.kwad.sdk.core.response.b.a.bk(adInfoCg) && (DownloadLandPageActivity.showingAdWebViewLandPage || AdWebViewVideoActivityProxy.showingAdWebViewVideoActivity || aVar.getAdTemplate().isWebViewDownload)) {
            return true;
        }
        return com.kwad.sdk.core.response.b.a.bl(adInfoCg) && !ag.isWifiConnected(aVar.getContext());
    }

    public static int s(a.a aVar) {
        AdInfo adInfoCg = com.kwad.sdk.core.response.b.d.cg(aVar.getAdTemplate());
    ...
    public final void a(String str, int i, String str2, f fVar) {
        if (this.mAdInfo.downloadId.equals(str)) {
            ...
            nA();
            if (fVar.Az()) {
                a.a aVar = new a.a(i, str2);
                com.kwad.sdk.core.report.a.a(this.JU, aVar);
                com.kwad.components.core.o.a.pA().a(this.JU, this.mAdInfo.adConversionInfo.appDownloadUrl, aVar.toJson().toString());
                fVar.Ay();
            }
    ...
    public final int m(a.a aVar) {
        ...
        switch (this.mAdInfo.status) {
            ...
            case 2:
            case 3:
                if (!aVar.nk() || !this.downloadPauseEnable) {
                    return 0;
                }
