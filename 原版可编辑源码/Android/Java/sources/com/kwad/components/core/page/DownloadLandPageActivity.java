        ...
        if (com.kwad.sdk.core.response.b.a.ax(adInfo)) {
            ...
            downloadProgressBar.setOnClickListener(new View.OnClickListener() {
                ...
                public final void onClick(View view) {
                    ...
                    DownloadLandPageActivity.this.mApkDownloadHelper.m(new a.a(DownloadLandPageActivity.this.getActivity()).am(true).an(false).P(DownloadLandPageActivity.this.mAdTemplate).ap(false));
