...
public final class b extends com.kwad.components.core.offline.init.a {
    ...
    final class 1 implements InitCallBack {
        final boolean Lq;
        final ITkOfflineCompo ZB;
        final long ZC;
        final long ZD;
        final Context jz;

        1(ITkOfflineCompo iTkOfflineCompo, boolean z, long j, long j2, Context context) {
                ...
                public final void a(final SdkConfigData sdkConfigData) {
                    ...
                    com.kwad.sdk.utils.g.execute(new Runnable() {
                        ...
                        public final void run() {
                            tkCompoImpl.onConfigRefresh(1.this.jz, sdkConfigData.toJson());
                        }
                    });
                }
            });
    ...
    public final boolean b(Context context, ClassLoader classLoader) {
        ...
        iTkOfflineCompo.initReal(context, ServiceProvider.HE(), new c(), new 1(iTkOfflineCompo, zH, jElapsedRealtime2, jElapsedRealtime, context));
        return true;
    }
