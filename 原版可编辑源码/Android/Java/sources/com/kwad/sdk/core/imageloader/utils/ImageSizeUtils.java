...
public final class ImageSizeUtils {
    ...
    static class 1 {
        static final int[] $SwitchMap$com$kwad$sdk$core$imageloader$core$assist$ViewScaleType;
    ...
    public static int computeImageSampleSize(ImageSize imageSize, ImageSize imageSize2, ViewScaleType viewScaleType, boolean z) {
        ...
        int i = 1.$SwitchMap$com$kwad$sdk$core$imageloader$core$assist$ViewScaleType[viewScaleType.ordinal()];
        if (i != 1) {
            if (i != 2) {
                iMax = 1;
            } else if (z) {
