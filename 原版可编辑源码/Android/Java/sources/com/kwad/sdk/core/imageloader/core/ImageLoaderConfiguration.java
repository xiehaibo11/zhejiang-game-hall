...
public final class ImageLoaderConfiguration {
    ...
    static class 1 {
        static final int[] $SwitchMap$com$kwad$sdk$core$imageloader$core$download$ImageDownloader$Scheme;
    ...
    static class NetworkDeniedImageDownloader implements ImageDownloader {
        ...
        public InputStream getStream(String str, Object obj) {
            int i = 1.$SwitchMap$com$kwad$sdk$core$imageloader$core$download$ImageDownloader$Scheme[ImageDownloader.Scheme.ofUri(str).ordinal()];
            if (i == 1 || i == 2) {
    ...
    ImageLoaderConfiguration(Builder builder, 1 r2) {
        this(builder);
    }
