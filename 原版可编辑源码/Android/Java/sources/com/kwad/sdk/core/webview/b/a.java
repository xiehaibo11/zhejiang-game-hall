...
public class a {
    ...
    private final NetworkMonitor.a ayC = new NetworkMonitor.a() {
        @Override
    ...
    private void a(com.kwad.sdk.h.a.b bVar) {
        if (this.ayB.contains(bVar.aCb) || TextUtils.isEmpty(bVar.packageUrl)) {
            return;
        }
        com.kwad.sdk.core.webview.b.b.a.a(bVar, new a.a() {
            @Override
        ...
        synchronized (this.ayz) {
            ...
            try {
                ...
                if (q.L(fileBs)) {
                    ...
                    try {
                        try {
                            listA = t.a(h.b(new InputStreamReader(fileInputStream)), new com.kwad.sdk.core.c<com.kwad.sdk.h.a.b>() {
