...
public final class ax {
    ...
    static class a extends j<com.kwad.sdk.k.a.b> {
        ...
        @Override
        private com.kwad.sdk.k.a.b bP(Context context) {
            int lac;
            int cid;
    ...
    static class e extends j<com.kwad.sdk.k.a.f> {
        ...
        @Override
        protected final com.kwad.sdk.k.a.f bP(Context context) {
            return cU(context);
        }
    }
