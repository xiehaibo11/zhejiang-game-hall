...
public class f {
    ...
    private static ServiceConnection aql = new ServiceConnection() {
        @Override
    ...
    static class 2 implements Runnable {
        ...
        public final void run() {
            com.kwad.sdk.collector.c.a(this.jz, new c.a() {
                @Override
                public final void b(AppStatusRules appStatusRules) {
                    appStatusRules.initStatus(2.this.jz);
                    AppStatusRules unused = f.aHN = appStatusRules;
                    f.b(2.this.jz, f.aHN);
                    f.bH(2.this.jz);
                    boolean zDl = be.dl(2.this.jz);
                    ...
                    if (zDl && zIsAppStatusTargetNotEmpty) {
                        ...
                        if (jObtainDefaultScanInterval > 0) {
                            f.c(2.this.jz, jObtainDefaultScanInterval);
                        } else {
                            f.bJ(2.this.jz);
                        }
                    }
                    ...
                    if (zIsUploadTargetNotEmpty && z && zDl) {
                        f.HI();
                        f.aHM.submit(new Runnable() {
                            @Override
                            public final void run() {
                                try {
                                    com.kwad.sdk.collector.j.a(2.this.jz, f.aHN);
                                } catch (Throwable th) {
        ...
        private void c(Message message) {
            ...
            if (data != null) {
                try {
                    if (data.containsKey("resultJson")) {
                        listA = t.a(data.getString("resultJson"), new com.kwad.sdk.core.c<a>() {
                            private static a HR() {
                                return new a();
                            }
            ...
            if (f.aHO != null && f.aHO.get() != null && data != null) {
                if (data.containsKey("allStrategyJson")) {
                    ...
                    if (string != null) {
                        listA2 = t.a(string, new com.kwad.sdk.core.c<AppStatusRules.Strategy>() {
    ...
    public static void a(Context context, long j, com.kwad.sdk.collector.h hVar) {
        ...
        if (zIsInMainProcess) {
            ...
            VH.postDelayed(new 2(context), 30000L);
        }
    }
