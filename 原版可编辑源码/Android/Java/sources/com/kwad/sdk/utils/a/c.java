...
public final class c {
    ...
    public static class a {
        ...
        public final c Kz() {
            ...
            Integer num = c.aLq.get(str);
            if (num != null) {
                c.aLq.put(str, Integer.valueOf(num.intValue() + 1));
            } else {
                c.aLq.put(str, 1);
            }
            return cVarFX;
    ...
    c(String str, String str2, b[] bVarArr, int i) {
        ...
        synchronized (this.aKX) {
            com.kwad.sdk.utils.a.d.getExecutor().execute(new Runnable() {
                @Override
    ...
    private void Ki() {
        ...
        try {
            if (h.ad(file) && h.ad(file2)) {
                this.aKQ = new RandomAccessFile(file, "rw");
                this.aKR = new RandomAccessFile(file2, "rw");
                long length = this.aKQ.length();
                long length2 = this.aKR.length();
                this.aKO = this.aKQ.getChannel();
                this.aKP = this.aKR.getChannel();
                try {
                    MappedByteBuffer map = this.aKO.map(FileChannel.MapMode.READ_WRITE, 0L, length > 0 ? length : PAGE_SIZE);
                    this.aKS = map;
                    map.order(ByteOrder.LITTLE_ENDIAN);
                    MappedByteBuffer map2 = this.aKP.map(FileChannel.MapMode.READ_WRITE, 0L, length2 > 0 ? length2 : PAGE_SIZE);
                    this.aKT = map2;
                    map2.order(ByteOrder.LITTLE_ENDIAN);
                    this.aKU = new com.kwad.sdk.utils.a.b(this.aKS.capacity());
                    if (length == 0 && length2 == 0) {
                        this.aKV = 12;
                        return;
                    }
                    int i = this.aKS.getInt();
                    long j = this.aKS.getLong();
                    int i2 = this.aKT.getInt();
                    long j2 = this.aKT.getLong();
                    if (i < 0 || i > length - 12) {
                        z = false;
                    } else {
                        this.aKV = i + 12;
                        this.aKS.rewind();
                        this.aKS.get(this.aKU.aKG, 0, this.aKV);
                        if (j == this.aKU.A(12, i) && Kl() == 0) {
                            this.aKW = j;
                            z = true;
                        }
                    }
                    if (z) {
                        if (length == length2 && Kj()) {
                            return;
                        }
                        g(new Exception("B file error"));
                        a(this.aKS, this.aKT, this.aKV);
                        return;
                    }
                    if (i2 < 0 || i2 > length2 - 12) {
                        ...
                        Ky();
                        this.aKV = i2 + 12;
                        if (this.aKU.aKG.length != this.aKT.capacity()) {
                            this.aKU = new com.kwad.sdk.utils.a.b(this.aKT.capacity());
                        }
                        this.aKT.rewind();
                        this.aKT.get(this.aKU.aKG, 0, this.aKV);
                        if (j2 == this.aKU.A(12, i2) && Kl() == 0) {
                            g(new Exception("A file error"));
                            a(this.aKT, this.aKS, this.aKV);
                            this.aKW = j2;
                            z2 = true;
                        }
                    }
    ...
    private int Kl() {
        ...
        while (true) {
            try {
                ...
                if (b2 < 0) {
                    bVar.position += i2;
                    int i3 = b3 <= 5 ? aKH[b3] : bVar.getShort() & UShort.MAX_VALUE;
                    this.aKU.position += i3;
                    C(i, this.aKU.position);
                } else {
                    ...
                    if (b3 > 5) {
                        ...
                        d(i5, z);
                        if (b3 == 6) {
                            String strDi = z ? bVar.di(i5) : bVar.getString(i5);
                            map = this.aKX;
                            cVar = new a.i(i, i4 + 2, strDi, i5, z);
                        } else if (b3 == 7) {
                            Object string2 = z ? bVar.getString(i5) : bVar.getBytes(i5);
                            map = this.aKX;
                            cVar = new a.a(i, i4 + 2, string2, i5, z);
                        } else if (z) {
                            ...
                            if (bVar2 != null) {
                                try {
                                    Object objG = bVar2.g(bVar.aKG, bVar.position, i7);
                                    if (objG != null) {
                                        this.aKX.put(string, new a.h(i, i4 + 2, objG, i5, false));
                                    }
                                } catch (Exception e2) {
                                    r(e2);
                                }
                            } else {
                                fW("object with tag: " + string4 + " without encoder");
                            }
                            bVar.position += i7;
                        }
                    } else if (b3 == 1) {
    ...
    */
    private synchronized boolean Ko() {
        File file;
        try {
            file = new File(this.Tt, this.name + bh.k);
        } catch (Exception e2) {
            r(e2);
        }
        if (h.ad(file)) {
    ...
    private void a(String str, Object obj, byte[] bArr, byte b2) {
        ...
        if (iA != 0) {
            ...
            this.aKX.put(str, b2 == 6 ? new a.i(this.aKZ, iA, (String) obj2, length, z) : b2 == 7 ? new a.a(this.aKZ, iA, obj2, length, z) : new a.h(this.aKZ, iA, obj2, length, z));
            Kt();
        }
    }
    ...
    private byte[] a(a.a aVar) {
        try {
            byte[] bArrAe = h.ae(new File(this.Tt + this.name, (String) aVar.value));
    ...
    private synchronized void b(String str, byte[] bArr) {
        ...
        if (bArr == null) {
            ...
            a(str, bArr, bArr, (a.a) this.aKX.get(str), (byte) 7);
        }
    }
    ...
    public final synchronized Map<String, Object> getAll() {
        ...
        for (Map.Entry<String, a.b> entry : this.aKX.entrySet()) {
            ...
            switch (value.Kf()) {
                ...
                case 7:
                    a.a aVar = (a.a) value;
                    objValueOf = aVar.aKE ? a(aVar) : aVar.value;
                    break;
                case 8:
                    a.h hVar = (a.h) value;
