...
public class Presenter {
    ...
    static abstract class PresenterState {
        private static final PresenterState[] $VALUES;
        ...
        static {
            int i = 0;
            INIT = new PresenterState("INIT", i, i) {
                @Override
                public final void performCallState(Presenter presenter) {
                }
            };
            int i2 = 1;
            CREATE = new PresenterState("CREATE", i2, i2) {
                @Override
                public final void performCallState(Presenter presenter) {
            ...
            int i3 = 2;
            BIND = new PresenterState("BIND", i3, i3) {
                @Override
            ...
            int i4 = 3;
            UNBIND = new PresenterState("UNBIND", i4, i4) {
                @Override
                final void performCallState(Presenter presenter) {
                    Iterator it = presenter.aDf.iterator();
                    while (it.hasNext()) {
            ...
            int i5 = 4;
            PresenterState presenterState = new PresenterState("DESTROY", i5, i5) {
                @Override
                final void performCallState(Presenter presenter) {
                    Iterator it = presenter.aDf.iterator();
                    while (it.hasNext()) {
