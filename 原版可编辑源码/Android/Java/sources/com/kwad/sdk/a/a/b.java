...
public class b {
    ...
    private synchronized void ad(AdTemplate adTemplate) {
    ...
    private synchronized void ae(AdTemplate adTemplate) {
        ObjectOutputStream objectOutputStream;
        Throwable th;
        Exception e;
    ...
    private static File ah(AdTemplate adTemplate) {
