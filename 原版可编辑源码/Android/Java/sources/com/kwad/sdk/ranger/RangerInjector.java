...
public class RangerInjector {
    ...
    public static void a(String str, final String str2, final b bVar) {
        try {
            ...
            if (pluginListener != null) {
                try {
                    s.a(pluginByClass, "pluginListener", Proxy.newProxyInstance(pluginByClass.getClass().getClassLoader(), new Class[]{Class.forName(str)}, new InvocationHandler() {
                        @Override
    ...
    public static void tryProxyOtherOutput(String str, String str2, String str3, final String str4, final a aVar) {
        try {
            ...
            s.a(Class.forName(str), str2, (Object) new Logger.ILogWritter() {
