...
public class f {
    public static MessageSnapshot a(byte b, com.kwad.framework.filedownloader.d.c cVar, d.a aVar) {
        ...
        if (b == -1) {
            dVar = cVar.td() ? new d.d(id, cVar.vm(), aVar.getException()) : new h.d(id, (int) cVar.vm(), aVar.getException());
        } else {
            if (b == 1) {
            ...
            if (b != 5) {
                ...
                return cVar.td() ? new d.d(id, cVar.vm(), illegalStateException) : new h.d(id, (int) cVar.vm(), illegalStateException);
            }
            dVar = cVar.td() ? new d.h(id, cVar.vm(), aVar.getException(), aVar.tb()) : new h.h(id, (int) cVar.vm(), aVar.getException(), aVar.tb());
        }
        return dVar;
    }
    ...
    public static MessageSnapshot a(int i, long j, Throwable th) {
        return j > 2147483647L ? new d.d(i, j, th) : new h.d(i, (int) j, th);
    }
