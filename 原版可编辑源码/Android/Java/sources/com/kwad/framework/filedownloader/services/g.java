...
final class g implements y {
    ...
    */
    public final synchronized void b(String str, String str2, boolean z, int i, int i2, int i3, boolean z2, com.kwad.framework.filedownloader.d.b bVar, boolean z3) {
        ...
        List<com.kwad.framework.filedownloader.d.a> listBg;
        boolean z4 = false;
        if (com.kwad.framework.filedownloader.f.d.aeI) {
        ...
        if (com.kwad.framework.filedownloader.f.c.a(iG, cVar != null ? cVar.vm() : 0L, cVar != null ? cVar.uE() : com.kwad.framework.filedownloader.f.f.bo(targetFilePath), targetFilePath, this)) {
            if (com.kwad.framework.filedownloader.f.d.aeI) {
        ...
        if (cVar == null || !(cVar.sX() == -2 || cVar.sX() == -1 || cVar.sX() == 1 || cVar.sX() == 6 || cVar.sX() == 2)) {
            if (cVar == null) {
            ...
            if (cVar.getId() == iG) {
                ...
                this.aex.a(new DownloadLaunchRunnable.a().e(cVar).b(bVar).a(this).a(Integer.valueOf(i2)).b(Integer.valueOf(i)).a(Boolean.valueOf(z2)).b(Boolean.valueOf(z3)).c(Integer.valueOf(i3)).uF());
            }
            this.aew.bi(cVar.getId());
            this.aew.bh(cVar.getId());
            cVar.setId(iG);
            cVar.c(str2, z);
            if (listBg != null) {
