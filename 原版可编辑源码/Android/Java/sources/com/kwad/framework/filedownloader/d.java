...
public final class d implements a.c, x, x.a, x.b {
    ...
    public final boolean pause() {
        ...
        b((byte) -2);
        a.a aVarTt = this.aaI.tt();
        com.kwad.framework.filedownloader.a aVarTf = aVarTt.tf();
        q.tU().b(this);
        if (com.kwad.framework.filedownloader.f.d.aeI) {
        ...
        h.tD().b(aVarTt);
        h.tD().a(aVarTt, com.kwad.framework.filedownloader.message.f.e(aVarTf));
        r.tW().ua().e(aVarTt);
        return true;
    }
    ...
    public final void start() {
        ...
        try {
            ...
            synchronized (this.aaD) {
                ...
                h.tD().a(aVarTt, messageSnapshotG);
            }
        } catch (Throwable th) {
            th.printStackTrace();
            h.tD().a(aVarTt, g(th));
