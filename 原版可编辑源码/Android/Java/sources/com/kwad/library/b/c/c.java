...
final class c extends ContextThemeWrapper implements b {
    ...
    public final Context getApplicationContext() {
        return a.g(this.afl.getApplicationContext(), this.afo);
    }
    ...
    public final Resources getResources() {
        return a.a(this.afl.getResources(), this.afo);
    }

    @Override
    public final Object getSystemService(String str) {
        return a.wrapSystemService(this.afl.getSystemService(str), str, this);
    }
