...
public class e {
    ...
    public static SpannableString a(final Context context, String str, String str2, final d dVar, final ArrayList<d> arrayList, ArrayList<String> arrayList2) {
        ...
        try {
            ...
            ClickableSpan clickableSpan2 = arrayList.size() >= 1 ? new ClickableSpan() {
                @Override
                public void updateDrawState(TextPaint textPaint) {
                    super.updateDrawState(textPaint);
                    textPaint.setUnderlineText(false);
            ...
            ClickableSpan clickableSpan3 = arrayList.size() >= 2 ? new ClickableSpan() {
                @Override
                public void updateDrawState(TextPaint textPaint) {
                    super.updateDrawState(textPaint);
                    textPaint.setUnderlineText(false);
            ...
            ClickableSpan clickableSpan4 = arrayList.size() >= 3 ? new ClickableSpan() {
                @Override
                public void updateDrawState(TextPaint textPaint) {
                    super.updateDrawState(textPaint);
                    textPaint.setUnderlineText(false);
            ...
            ClickableSpan clickableSpan5 = arrayList.size() == 4 ? new ClickableSpan() {
                @Override
                public void updateDrawState(TextPaint textPaint) {
                    super.updateDrawState(textPaint);
                    textPaint.setUnderlineText(false);
