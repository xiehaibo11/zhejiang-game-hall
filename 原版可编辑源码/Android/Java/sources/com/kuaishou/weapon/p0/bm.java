...
public class bm {
    ...
    public String b(String str, String str2) {
        try {
            ...
            return new String(d.b(Engine.loadSuccess ? Engine.getInstance(this.a).dr(Engine.getInstance(this.a).dc(bArrA, str2.substring(0, 16).getBytes()), str2.getBytes()) : i.a(b.b(str2.substring(0, 16), str2.substring(0, 16), bArrA), str2.substring(0, 16))));
        } catch (Exception unused) {
            return null;
        }
    }
