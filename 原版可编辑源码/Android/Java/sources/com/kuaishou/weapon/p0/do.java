...
public class do {
    ...
    static final class a {
        ...
        private static void b(ClassLoader classLoader, File file) throws IllegalAccessException, NoSuchFieldException {
    ...
    static final class c {
        ...
        private static void b(ClassLoader classLoader, File file) throws IllegalAccessException {
            Object obj = dq.a(classLoader, "pathList").get(classLoader);
