...
public class dd {
    ...
    public void a(final int i) {
        n.a().a(new Runnable() {
            ...
            public void run() {
                try {
                    h hVarA = h.a(dd.this.a, "re_po_rt");
                    if (hVarA.b(df.B, 0) == 1) {
                        long jA = df.a(dd.this.a).a(df.bh);
                        long jCurrentTimeMillis = System.currentTimeMillis();
                        if (jCurrentTimeMillis - jA >= ((long) hVarA.b(df.E, 2)) * 3600000 || i == 106) {
                            try {
                                String strA = new cn(dd.this.a).a(cj.h);
                                int iIntValue = Integer.valueOf(cj.h).intValue();
                                if (strA != null && strA.length() > 10) {
                                    new bb(dd.this.a, strA, iIntValue).a("1000");
                                }
                            } catch (Throwable unused) {
                            }
                            df.a(dd.this.a).a(df.bh, jCurrentTimeMillis);
                        }
                    }
