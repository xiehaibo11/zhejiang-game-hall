...
public class CRC64 implements Checksum {
    ...
    public void update(byte[] bArr, int i, int i2) {
        ...
        while (i4 >= 8) {
            ...
            long[] jArr2 = jArr[7];
            long j = this.value;
            this.value = ((((((jArr2[(int) (((long) (bArr[i3] & UByte.MAX_VALUE)) ^ (j & 255))] ^ jArr[6][(int) (((long) (bArr[i3 + 1] & UByte.MAX_VALUE)) ^ ((j >>> 8) & 255))]) ^ jArr[5][(int) (((j >>> 16) & 255) ^ ((long) (bArr[i3 + 2] & UByte.MAX_VALUE)))]) ^ jArr[4][(int) (((j >>> 24) & 255) ^ ((long) (bArr[i3 + 3] & UByte.MAX_VALUE)))]) ^ jArr[3][(int) (((j >>> 32) & 255) ^ ((long) (bArr[i3 + 4] & UByte.MAX_VALUE)))]) ^ jArr[2][(int) (((j >>> 40) & 255) ^ ((long) (bArr[i3 + 5] & UByte.MAX_VALUE)))]) ^ jArr[1][(int) (((j >>> 48) & 255) ^ ((long) (bArr[i3 + 6] & UByte.MAX_VALUE)))]) ^ jArr[0][(int) ((j >>> 56) ^ ((long) (bArr[i3 + 7] & UByte.MAX_VALUE)))];
            i3 += 8;
            i4 -= 8;
        }
        while (i4 > 0) {
