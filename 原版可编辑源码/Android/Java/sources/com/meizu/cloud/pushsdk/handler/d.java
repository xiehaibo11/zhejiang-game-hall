        ...
        try {
            ...
            try {
                ...
                if (!jSONObject.isNull(PushConstants.PARAMS)) {
                    ...
                    HashMap map = new HashMap(jSONObject2.length());
                    Iterator<String> itKeys = jSONObject2.keys();
                    while (itKeys.hasNext()) {
                        String next = itKeys.next();
                        map.put(next, jSONObject2.getString(next));
                    }
                    messageV3.setParamsMap(map);
                }
    ...
    public static String a(MessageV3 messageV3) {
        ...
        try {
            ...
            if (messageV3.getParamsMap() != null && messageV3.getParamsMap().size() > 0) {
                jSONObject.put(PushConstants.PARAMS, new JSONObject((Map<String, Object>) messageV3.getParamsMap()));
            }
            ...
            DebugLogger.i("MessageSerialize", "message serialize messageV3ToString success, msgText=" + string);
            return string;
        } catch (JSONException e) {
