...
public class d extends com.meizu.cloud.pushsdk.handler.a.a<SubAliasStatus> {
    ...
    @Override
    protected void a(SubAliasStatus subAliasStatus, com.meizu.cloud.pushsdk.notification.c cVar) {
    ...
    @Override
    protected SubAliasStatus c(Intent intent) {
        String stringExtra = intent.getStringExtra(PushConstants.MZ_MESSAGE_VALUE);
        SubAliasStatus subAliasStatusD = !TextUtils.isEmpty(stringExtra) ? com.meizu.cloud.pushsdk.platform.message.a.d(stringExtra) : (SubAliasStatus) intent.getSerializableExtra(PushConstants.EXTRA_APP_PUSH_SUBALIAS_STATUS);
        if (BasicPushStatus.SUCCESS_CODE.equals(subAliasStatusD.getCode())) {
            c(subAliasStatusD.getAlias());
        }
        return subAliasStatusD;
    }
}
