...
public class e extends com.meizu.cloud.pushsdk.handler.a.a<com.meizu.cloud.pushsdk.handler.a.c.c> {
    ...
    @Override
    protected void b(com.meizu.cloud.pushsdk.handler.a.c.c cVar) {
        int iC = cVar.c();
        if (iC == -2) {
    ...
    @Override
    protected void a(com.meizu.cloud.pushsdk.handler.a.c.c cVar, com.meizu.cloud.pushsdk.notification.c cVar2) {
    ...
    @Override
    protected com.meizu.cloud.pushsdk.handler.a.c.c c(Intent intent) {
