...
public class a {
    ...
    public static String b(Context context) {
        ...
        a = com.reyun.tracking.utils.f.a(context, "tracking_device_id_cache", "device_id");
        b = com.reyun.tracking.utils.f.a(context, "tracking_device_id_cache", "device_id_type");
        if ("_default_".equals(a)) {
            f fVarR = r(context);
            a = fVarR.a;
            b = fVarR.b;
            com.reyun.tracking.utils.f.b(context, "tracking_device_id_cache", "device_id", a);
    ...
    public static f f(Context context) {
        ...
        try {
            fVar.a = g(context);
            fVar.b = "imei";
            if (!b(fVar.a) && !EnvironmentCompat.MEDIA_UNKNOWN.equals(fVar.a)) {
                return fVar;
            }
            if (h.a == null || h.a.equals(EnvironmentCompat.MEDIA_UNKNOWN) || h.a.length() <= 0) {
                fVar.b = "androidid";
                fVar.a = c(context);
                return fVar;
            }
            if (Pattern.matches("^[0]+-[0]+-[0]+-[0]+-[0]+$", h.a) || Pattern.matches("^[0]+$", h.a)) {
                fVar.b = "androidid";
                strC2 = c(context);
            } else {
                fVar.b = "oaid";
            ...
            if (Pattern.matches("^[0]+-[0]+-[0]+-[0]+-[0]+$", h.a)) {
                fVar.b = "androidid";
                strC = c(context);
            } else {
                fVar.b = "oaid";
    ...
    public static String j(Context context) {
        if (!a(context, com.kuaishou.weapon.p0.g.a)) {
            if (i.a) {
    ...
    private static f r(Context context) {
        ...
        try {
            ...
            if (Pattern.matches("^[0]+-[0]+-[0]+-[0]+-[0]+$", h.a) || Pattern.matches("^[0]+$", h.a)) {
                ...
                fVar.b = "oaid";
                fVar.a = h.a;
                com.reyun.tracking.utils.f.b(context, "tracking_device_id_cache", "oaid", fVar.a);
            }
            return fVar;
        } catch (Exception unused) {
            if (h.a == null || h.a.equals(EnvironmentCompat.MEDIA_UNKNOWN) || h.a.length() <= 0) {
