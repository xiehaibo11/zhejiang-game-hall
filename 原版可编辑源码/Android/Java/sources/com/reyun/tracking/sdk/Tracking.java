...
public class Tracking {
    ...
    static {
        HEART_BEAT_TIME = com.reyun.tracking.a.i.a ? 10000 : 3000;
        isSDKInited = false;
    ...
    private static void afterInit(Map map, Map map2, boolean z) {
        if (m_context == null) {
    ...
    private static int sendFailureRecord(int i) {
        try {
            ...
            if (kVarQueryRecordFromDatabase != null && kVarQueryRecordFromDatabase.a != null && kVarQueryRecordFromDatabase.a.size() != 0) {
                com.reyun.tracking.a.a.a(TAG, "sendFailureRecord :" + kVarQueryRecordFromDatabase.a.size());
                mydbhandler.sendMessage(mydbhandler.obtainMessage(1, i, 0, kVarQueryRecordFromDatabase));
                return kVarQueryRecordFromDatabase.a.size();
            }
    ...
    private static void sendOrSava(String str, String str2, JSONObject jSONObject, String str3, int i, Map map) {
