...
public class s implements n {
    ...
    public void a(int i, Object obj) {
        ...
        if ("install".equals(this.b)) {
            ...
            f.b(this.a, Tracking.XML_INSTALL, Tracking.KEY_INSTALL_SEND_SUCCESS_TIME, System.currentTimeMillis());
        ...
        a();
        if (this.c >= 0) {
            i.a(this.a, Tracking.TAG).a(String.valueOf(this.c));
        }
    ...
    public void a(Throwable th, String str) {
        ...
        i.a(this.a, Tracking.TAG).b(String.valueOf(this.c), 0);
        if (com.reyun.tracking.a.a.b(this.b)) {
            return;
        }
