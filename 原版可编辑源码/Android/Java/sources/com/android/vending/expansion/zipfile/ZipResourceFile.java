...
public class ZipResourceFile {
    ...
    public static final class ZipEntryRO {
        ...
        public AssetFileDescriptor getAssetFileDescriptor() {
            ...
            try {
                return new AssetFileDescriptor(ParcelFileDescriptor.open(this.mFile, DownloadExpSwitchCode.BUGFIX_GETPACKAGEINFO_BY_UNZIP), getOffset(), this.mUncompressedLength);
            } catch (FileNotFoundException e) {
                e.printStackTrace();
                return null;
            }
