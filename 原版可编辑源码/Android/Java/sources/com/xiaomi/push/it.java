...
public class it {
    public static short a(Context context, if ifVar) {
        return a(context, ifVar.b);
    }

    public static short a(Context context, String str) {
        return (short) (h.a(context, str, false).a() + 0 + (ak.b(context) ? 4 : 0) + (ak.a(context) ? 8 : 0) + (com.xiaomi.push.service.ax.a(context) ? 16 : 0));
    }
