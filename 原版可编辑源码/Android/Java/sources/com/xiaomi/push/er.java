...
public class er extends es {
    ...
    public void a() {
        ...
        if (this.a == null) {
            ...
            a().setImageViewBitmap(iA, this.a);
        }
        int iA2 = a(resources, "title", "id", packageName);
        int iA3 = a(resources, "content", "id", packageName);
        a().setTextViewText(iA2, this.a);
        a().setTextViewText(iA3, this.b);
        if (!TextUtils.isEmpty(this.c)) {
            ...
            a().setViewVisibility(iA4, 0);
            a().setTextViewText(iA5, this.c);
            a().setOnClickPendingIntent(iA4, this.a);
            if (this.b != 16777216) {
                int iA7 = a(70.0f);
                int iA8 = a(29.0f);
                a().setImageViewBitmap(iA6, com.xiaomi.push.service.al.a(a(this.b, iA7, iA8, iA8 / 2.0f)));
                a().setTextColor(iA5, a(this.b) ? -1 : -16777216);
            }
        }
        ...
        if (this.a != 16777216) {
            if (m.a(a()) >= 10) {
                remoteViewsA3 = a();
                drawableA = a(this.a, 984, PsExtractor.AUDIO_STREAM, 30.0f);
            } else {
                remoteViewsA3 = a();
                drawableA = a(this.a, 984, PsExtractor.AUDIO_STREAM, 0.0f);
            }
            ...
            if (this.b == null) {
                if (Build.VERSION.SDK_INT >= 24) {
                    a().setViewVisibility(iA, 8);
                    a().setViewVisibility(iA9, 8);
                    try {
            ...
            if (this.a != null && this.c == 16777216) {
                c(this.a.get("notification_image_text_color"));
            }
            int i = this.c;
            zA = i == 16777216 || !a(i);
            remoteViewsA2 = a();
