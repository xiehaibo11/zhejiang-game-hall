...
public class is implements iu<is, Object>, Serializable, Cloneable {
    ...
    public String f;
    public String g;
    private static final jk a = new jk("XmPushActionUnSubscriptionResult");
    ...
    public int compareTo(is isVar) {
        ...
        int iCompareTo = Boolean.valueOf(a()).compareTo(Boolean.valueOf(isVar.a()));
        if (iCompareTo != 0) {
            return iCompareTo;
        }
        if (a() && (iA9 = iv.a(this.a, isVar.a)) != 0) {
            return iA9;
        }
        int iCompareTo2 = Boolean.valueOf(b()).compareTo(Boolean.valueOf(isVar.b()));
        if (iCompareTo2 != 0) {
            return iCompareTo2;
        }
        if (b() && (iA8 = iv.a(this.a, isVar.a)) != 0) {
            return iA8;
        }
        int iCompareTo3 = Boolean.valueOf(c()).compareTo(Boolean.valueOf(isVar.c()));
        if (iCompareTo3 != 0) {
            return iCompareTo3;
        }
        if (c() && (iA7 = iv.a(this.b, isVar.b)) != 0) {
            return iA7;
        }
        ...
        if (d() && (iA6 = iv.a(this.c, isVar.c)) != 0) {
            return iA6;
        }
        ...
        if (e() && (iA5 = iv.a(this.a, isVar.a)) != 0) {
            return iA5;
        }
        ...
        if (f() && (iA4 = iv.a(this.d, isVar.d)) != 0) {
            return iA4;
        }
        ...
        if (g() && (iA3 = iv.a(this.e, isVar.e)) != 0) {
            return iA3;
        }
        ...
        if (h() && (iA2 = iv.a(this.f, isVar.f)) != 0) {
            return iA2;
        }
    ...
    */
    ...
    public boolean a(is isVar) {
        ...
        boolean zA = a();
        boolean zA2 = isVar.a();
        if ((zA || zA2) && !(zA && zA2 && this.a.equals(isVar.a))) {
            return false;
        }
        boolean zB = b();
        boolean zB2 = isVar.b();
        if ((zB || zB2) && !(zB && zB2 && this.a.a(isVar.a))) {
            return false;
        }
        boolean zC = c();
        boolean zC2 = isVar.c();
        if ((zC || zC2) && !(zC && zC2 && this.b.equals(isVar.b))) {
            return false;
        }
        boolean zD = d();
        boolean zD2 = isVar.d();
        if ((zD || zD2) && !(zD && zD2 && this.c.equals(isVar.c))) {
            return false;
        }
        boolean zE = e();
        boolean zE2 = isVar.e();
        if ((zE || zE2) && !(zE && zE2 && this.a == isVar.a)) {
            return false;
        }
        boolean zF = f();
        boolean zF2 = isVar.f();
        if ((zF || zF2) && !(zF && zF2 && this.d.equals(isVar.d))) {
            return false;
        }
        boolean zG = g();
        boolean zG2 = isVar.g();
        if ((zG || zG2) && !(zG && zG2 && this.e.equals(isVar.e))) {
            return false;
        }
        boolean zH = h();
        boolean zH2 = isVar.h();
        if ((zH || zH2) && !(zH && zH2 && this.f.equals(isVar.f))) {
            return false;
        }
        boolean zI = i();
        boolean zI2 = isVar.i();
        if (zI || zI2) {
            return zI && zI2 && this.g.equals(isVar.g);
        }
        return true;
    }
