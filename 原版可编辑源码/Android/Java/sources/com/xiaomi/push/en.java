...
public class en {
    private static a a;
    private static Map<String, ht> a;
    ...
    public static Config a(Context context) {
        boolean zA = com.xiaomi.push.service.ba.a(context).a(ho.aA.a(), false);
        boolean zA2 = com.xiaomi.push.service.ba.a(context).a(ho.aU.a(), false);
        return Config.getBuilder().setEventUploadSwitchOpen(zA2).setEventUploadFrequency(com.xiaomi.push.service.ba.a(context).a(ho.aB.a(), 86400)).setPerfUploadSwitchOpen(zA).setPerfUploadFrequency(com.xiaomi.push.service.ba.a(context).a(ho.aC.a(), 86400)).build(context);
    }
            ...
            synchronized (ht.class) {
                if (a == null) {
                    ...
                    for (ht htVar : ht.values()) {
                        a.put(htVar.a.toLowerCase(), htVar);
                    }
                }
            }
        }
        ht htVar2 = a.get(str.toLowerCase());
