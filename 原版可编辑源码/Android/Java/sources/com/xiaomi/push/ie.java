...
public class ie implements iu<ie, Object>, Serializable, Cloneable {
    ...
    public String e;
    public String f;
    private static final jk a = new jk("XmPushActionCommandResult");
    ...
    public int compareTo(ie ieVar) {
        ...
        int iCompareTo = Boolean.valueOf(a()).compareTo(Boolean.valueOf(ieVar.a()));
        if (iCompareTo != 0) {
            return iCompareTo;
        }
        if (a() && (iA10 = iv.a(this.a, ieVar.a)) != 0) {
            return iA10;
        }
        int iCompareTo2 = Boolean.valueOf(b()).compareTo(Boolean.valueOf(ieVar.b()));
        if (iCompareTo2 != 0) {
            return iCompareTo2;
        }
        if (b() && (iA9 = iv.a(this.a, ieVar.a)) != 0) {
            return iA9;
        }
        int iCompareTo3 = Boolean.valueOf(c()).compareTo(Boolean.valueOf(ieVar.c()));
        if (iCompareTo3 != 0) {
            return iCompareTo3;
        }
        if (c() && (iA8 = iv.a(this.b, ieVar.b)) != 0) {
            return iA8;
        }
        ...
        if (d() && (iA7 = iv.a(this.c, ieVar.c)) != 0) {
            return iA7;
        }
        ...
        if (e() && (iA6 = iv.a(this.a, ieVar.a)) != 0) {
            return iA6;
        }
        ...
        if (f() && (iA5 = iv.a(this.d, ieVar.d)) != 0) {
            return iA5;
        }
        ...
        if (g() && (iA4 = iv.a(this.e, ieVar.e)) != 0) {
            return iA4;
        }
        ...
        if (h() && (iA3 = iv.a(this.a, ieVar.a)) != 0) {
            return iA3;
        }
        ...
        if (i() && (iA2 = iv.a(this.f, ieVar.f)) != 0) {
            return iA2;
        }
    ...
    */
    ...
    public boolean a(ie ieVar) {
        ...
        boolean zA = a();
        boolean zA2 = ieVar.a();
        if ((zA || zA2) && !(zA && zA2 && this.a.a(ieVar.a))) {
            return false;
        }
        boolean zB = b();
        boolean zB2 = ieVar.b();
        if ((zB || zB2) && !(zB && zB2 && this.a.equals(ieVar.a))) {
            return false;
        }
        boolean zC = c();
        boolean zC2 = ieVar.c();
        if ((zC || zC2) && !(zC && zC2 && this.b.equals(ieVar.b))) {
            return false;
        }
        boolean zD = d();
        boolean zD2 = ieVar.d();
        if (((zD || zD2) && !(zD && zD2 && this.c.equals(ieVar.c))) || this.a != ieVar.a) {
            return false;
        }
        boolean zF = f();
        boolean zF2 = ieVar.f();
        if ((zF || zF2) && !(zF && zF2 && this.d.equals(ieVar.d))) {
            return false;
        }
        boolean zG = g();
        boolean zG2 = ieVar.g();
        if ((zG || zG2) && !(zG && zG2 && this.e.equals(ieVar.e))) {
            return false;
        }
        boolean zH = h();
        boolean zH2 = ieVar.h();
        if ((zH || zH2) && !(zH && zH2 && this.a.equals(ieVar.a))) {
            return false;
        }
        boolean zI = i();
        boolean zI2 = ieVar.i();
        if ((zI || zI2) && !(zI && zI2 && this.f.equals(ieVar.f))) {
            return false;
        }
        boolean zJ = j();
        boolean zJ2 = ieVar.j();
        if (zJ || zJ2) {
            return zJ && zJ2 && this.a == ieVar.a;
        }
        return true;
    }
