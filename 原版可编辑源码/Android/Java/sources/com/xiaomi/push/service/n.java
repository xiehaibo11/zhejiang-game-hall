...
public class n {
    ...
    public static byte[] a(byte[] bArr, String str) {
        ...
        try {
            return com.xiaomi.push.i.b(com.xiaomi.push.bm.a(str), bArr);
        } catch (Exception e) {
    ...
    public static byte[] b(byte[] bArr, String str) {
        ...
        try {
            return com.xiaomi.push.i.a(com.xiaomi.push.bm.a(str), bArr);
        } catch (Exception e) {
