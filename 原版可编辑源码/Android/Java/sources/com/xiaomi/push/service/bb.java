...
public class bb {
        ...
        for (hu huVar : list) {
            ...
            if (hqVarA != null) {
                if (z && huVar.a) {
                    ...
                    arrayList.add(i != 1 ? i != 2 ? i != 3 ? i != 4 ? null : new Pair(Integer.valueOf(iA), Boolean.valueOf(huVar.g())) : new Pair(Integer.valueOf(iA), huVar.a()) : new Pair(Integer.valueOf(iA), Long.valueOf(huVar.a())) : new Pair(Integer.valueOf(iA), Integer.valueOf(huVar.c())));
                }
            }
        }
        return arrayList;
    ...
    public static void a(ba baVar, ih ihVar) {
        ...
        for (hs hsVar : ihVar.a()) {
            arrayList.add(new Pair<>(hsVar.a(), Integer.valueOf(hsVar.a())));
            List<Pair<Integer, Object>> listA = a(hsVar.a, false);
