...
class au {
    ...
    private List<StatusBarNotification> a(ax axVar) {
        List<StatusBarNotification> listB = axVar != null ? axVar.b() : null;
            ...
            if (listA != null) {
                ...
                for (Map.Entry<String, a> entry : map.entrySet()) {
                    ...
                    if (!TextUtils.isEmpty(key)) {
                        ...
                        if (z && key.equals(strB) && !b(notification)) {
                            (a(notification) ? value.b : value.a).add(new b(i, notification));
                        }
                        int size = value.a.size();
                        if (value.b.size() <= 0) {
                            if (z && size >= 2) {
                                a(context, strC, key, value.a.get(0).a);
                            }
                        } else if (size <= 0) {
                            a(context, strC, key);
                        }
    ...
    private void a(Context context, String str, String str2, Notification notification) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                ...
                NotificationChannel notificationChannelA = axVarA.a(strB);
                if ("groupSummary".equals(strB) && notificationChannelA == null) {
            ...
            if (!com.xiaomi.push.m.c() && "com.xiaomi.xmsf".equals(context.getPackageName())) {
                ay.a(notificationBuild, str);
            }
            int iA2 = a(str, str2);
    ...
    private void a(Map<String, a> map, StatusBarNotification statusBarNotification) {
        ...
        (a(statusBarNotification.getNotification()) ? aVar.b : aVar.a).add(new b(statusBarNotification.getId(), statusBarNotification.getNotification()));
    }
            ...
            if (listA != null) {
                for (StatusBarNotification statusBarNotification : listA) {
                    ...
                    if (notification2 != null && b(notification2) && statusBarNotification.getId() != i) {
                        ...
                        ay.a(builderRecoverBuilder, a(notification2));
    ...
    private boolean b(Context context) {
        return ba.a(context).a(ho.aW.a(), true);
    }
        ...
        if (a()) {
            if (a(context)) {
                try {
                    ...
                    com.xiaomi.channel.commonutils.logger.b.a("group notify handle restore error " + e);
                }
            }
            if (b(context)) {
                try {
                    ...
                    com.xiaomi.channel.commonutils.logger.b.a("group notify handle auto error " + e2);
                }
            }
        }
    }
