...
public class MiPushClient4Hybrid {
    ...
    public static void onReceiveRegisterResult(Context context, ik ikVar) {
        ...
        if (ikVar.a() == 0 && (aVar = dataMap.get(strC)) != null) {
            aVar.a(ikVar.e, ikVar.f);
            b.a(context).a(strC, aVar);
        }
        ...
        MiPushCommandMessage miPushCommandMessageGenerateCommandMessage = PushMessageHelper.generateCommandMessage(ey.a.a, arrayList, ikVar.a, ikVar.d, null, null);
    ...
    public static void onReceiveUnregisterResult(Context context, iq iqVar) {
        MiPushCommandMessage miPushCommandMessageGenerateCommandMessage = PushMessageHelper.generateCommandMessage(ey.b.a, null, iqVar.a, iqVar.d, null, null);
        String strA = iqVar.a();
        MiPushCallback miPushCallback = sCallback;
        if (miPushCallback != null) {
    ...
    public static void registerPush(Context context, String str, String str2, String str3) {
        if (b.a(context).a(str2, str3, str)) {
            ...
            b.a aVarA = b.a(context).a(str);
            if (aVarA != null) {
                arrayList.add(aVarA.c);
                MiPushCommandMessage miPushCommandMessageGenerateCommandMessage = PushMessageHelper.generateCommandMessage(ey.a.a, arrayList, 0L, null, null, null);
                MiPushCallback miPushCallback = sCallback;
                if (miPushCallback != null) {
    ...
    public static void reportMessageArrived(Context context, MiPushMessage miPushMessage, boolean z) {
        ...
        try {
            ...
            ao.a(context).a(hzVar, hj.f, false, br.a(PushMessageHelper.generateMessage(miPushMessage)));
