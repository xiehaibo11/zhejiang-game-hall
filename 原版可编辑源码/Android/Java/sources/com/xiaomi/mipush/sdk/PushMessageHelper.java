...
public class PushMessageHelper {
    ...
    public static MiPushMessage generateMessage(im imVar, hw hwVar, boolean z) {
        ...
        miPushMessage.setMessageId(imVar.a());
