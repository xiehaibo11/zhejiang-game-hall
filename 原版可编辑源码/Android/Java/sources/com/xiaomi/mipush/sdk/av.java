...
public class av {
    public static void a(Context context) {
        ...
        long jA = ba.a(context).a(ho.B.a(), 1209600);
        if (j != -1) {
    ...
    public static void a(Context context, ii iiVar) {
        com.xiaomi.channel.commonutils.logger.b.a("need to update local info with: " + iiVar.a());
        String str = iiVar.a().get(Constants.EXTRA_KEY_ACCEPT_TIME);
        if (str != null) {
        ...
        String str2 = iiVar.a().get(Constants.EXTRA_KEY_ALIASES);
        if (str2 != null) {
        ...
        String str4 = iiVar.a().get(Constants.EXTRA_KEY_TOPICS);
        if (str4 != null) {
        ...
        String str6 = iiVar.a().get(Constants.EXTRA_KEY_ACCOUNTS);
        if (str6 != null) {
