...
public class rg {
    ...
    public static String df(Uri uri) {
        ...
        return df.rg(uri.getQueryParameter("id"), uri.getQueryParameter("packagename"), uri.getQueryParameter(a.a.A), uri.getQueryParameter("package_name"), uri.getQueryParameter(b.u));
    }
}
