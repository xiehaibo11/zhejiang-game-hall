...
public class c {
    ...
    private static void df(final com.ss.android.downloadad.api.rg.df dfVar, final int i) {
        if (i <= 0) {
            return;
        }
        com.ss.android.downloadlib.pt.rg().rg(new Runnable() {
    ...
    private static long ux(com.ss.android.downloadad.api.rg.df dfVar) {
    ...
    private static int bm(com.ss.android.downloadad.api.rg.df dfVar) {
