...
public class pt extends LruCache<Long, Bitmap> {
    ...
    public void rg(final long j, final long j2, final String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            Chain.rg((Chain.rg<Object, R>) new Chain.rg<Object, Object>() {
                @Override
            ...
            }, (Object) null).rg(new Chain.rg<Object, Object>() {
                @Override
    ...
    private static int df(int i, int i2, BitmapFactory.Options options) {
