...
public class pt {
    ...
    void rg(final int i, final long j, long j2, final pp.rg rgVar) {
        ...
        if (j2 > 0) {
            ...
            rg(downloadUrl, dfVar, new pp.df() {
                @Override
        ...
        this.rg.postDelayed(new Runnable() {
            @Override
            public void run() {
                if (pt.this.q.get()) {
                    return;
    ...
    private void rg(String str, com.ss.android.downloadad.api.rg.df dfVar, final pp.df dfVar2) {
        ...
        DownloadPreconnecter.asyncFetchHttpHeadInfo(str, new IFetchHttpHeadInfoListener() {
            @Override
    ...
    private long rg(Map<String, String> map) {
    ...
    private void rg(int i, String str, long j, final com.ss.android.downloadad.api.rg.df dfVar, long j2, final pp.rg rgVar) throws Throwable {
        this.q.set(true);
        boolean zRg = false;
        if (j > 0) {
            JSONObject jSONObject = new JSONObject();
            ...
            if (jPt < jLongValue) {
                ...
                if (jPt2 < jLongValue) {
                    ...
                    com.ss.android.downloadlib.addownload.df.pt.rg().rg(strRg, new com.ss.android.downloadlib.addownload.df.pp() {
                    });
    ...
    public static boolean rg(final DownloadInfo downloadInfo, long j) {
        ...
        if (bm.hq() != null && (zRg = bm.hq().rg(id, downloadInfo.getUrl(), false, j))) {
            com.ss.android.downloadlib.addownload.df.pt.rg().rg(downloadInfo.getUrl(), new com.ss.android.downloadlib.addownload.df.pp() {
            });
        }
        return zRg;
    }
