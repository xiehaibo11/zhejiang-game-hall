...
public class rg {
    ...
    private static void q() {
        ...
        try {
            ...
            declaredField2.set(obj, Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), new Class[]{cls}, new rg(obj2)));
    ...
    private static class rg implements InvocationHandler {
        private Object rg;

        private rg(Object obj) {
            this.rg = obj;
        }
