...
public class DownloadPreconnecter {
    ...
    private static List<HttpHeader> getExtraHeaders(long j, DownloadInfo downloadInfo, List<HttpHeader> list) {
    ...
    private static void createConnection(int i, String str, List<HttpHeader> list, long j) {
    ...
    private static void fetchHeadInfo(String str, List<HttpHeader> list, long j) {
