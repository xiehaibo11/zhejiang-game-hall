...
public abstract class AbsDownloadEngine implements WeakDownloadHandler.IHandler {
    ...
    public void clearDownloadData(final int i, final boolean z) {
        ...
        DownloadComponentManager.submitCPUTask(new Runnable() {
            @Override
            public void run() {
                DownloadTask downloadTask;
    ...
    private synchronized void clearDownloadDataInSubThread(int i, boolean z) {
    ...
    private void resetDownloadDataInSubThread(int i, boolean z) {
        try {
            DownloadInfo downloadInfo = this.downloadCache.getDownloadInfo(i);
            if (downloadInfo != null) {
