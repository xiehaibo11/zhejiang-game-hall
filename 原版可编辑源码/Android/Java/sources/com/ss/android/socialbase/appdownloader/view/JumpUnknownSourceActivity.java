...
public class JumpUnknownSourceActivity extends Activity {
    ...
    private void df() {
        ...
        try {
            ...
            hqVarRg.rg(iRg).rg(strOptString).rg(iRg2, new DialogInterface.OnClickListener() {
                @Override
            ...
            }).df(iRg3, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
            ...
            }).rg(new DialogInterface.OnCancelListener() {
                @Override
