...
public class NetTrafficManager {
    ...
    private boolean significantlyOutsideCurrentBand() {
        ...
        try {
            int i = 1.$SwitchMap$com$ss$android$socialbase$downloader$network$NetworkQuality[this.currentNetworkQuality.get().ordinal()];
            double d = 2000.0d;
            double d2 = 550.0d;
            if (i == 1) {
                d2 = 0.0d;
    ...
    static class 1 {
        static final int[] $SwitchMap$com$ss$android$socialbase$downloader$network$NetworkQuality;
