...
public class RetryScheduler implements Handler.Callback, AppStatusManager.AppStatusChangeListener {
        ...
        DownloadComponentManager.getCPUThreadExecutor().execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    RetryScheduler.this.mConnectivityManager.registerNetworkCallback(new NetworkRequest.Builder().build(), new ConnectivityManager.NetworkCallback() {
                        @Override
    ...
    private void scheduleAllTaskRetry(int i, boolean z) {
    ...
    private void doSchedulerRetryInSubThread(int i, int i2, boolean z) {
