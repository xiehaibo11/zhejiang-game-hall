        ...
        if (activity != null) {
            ...
            if (!activity.isFinishing()) {
                ...
                if (pt == null || !pt.isShowing()) {
                    pt = new AlertDialog.Builder(activity).setTitle(iRg).setMessage(iRg2).setPositiveButton(iRg3, new DialogInterface.OnClickListener() {
                        @Override
                    ...
                    }).setNegativeButton(iRg4, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            pt.rg(false);
                        }
