...
public interface IOIfaceNotifier extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IOIfaceNotifier {
        private static final String DESCRIPTOR = "com.oppo.oiface.IOIfaceNotifier";
        ...
        public static IOIfaceNotifier asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IOIfaceNotifier)) {
                return (IOIfaceNotifier) iInterfaceQueryLocalInterface;
            }
