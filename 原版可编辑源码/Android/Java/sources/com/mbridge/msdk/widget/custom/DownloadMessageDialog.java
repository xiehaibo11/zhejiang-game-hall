...
public class DownloadMessageDialog extends Dialog {
    ...
    public DownloadMessageDialog(Context context, boolean z, DialogInterface.OnCancelListener onCancelListener, CustomViewMessageWrap customViewMessageWrap, com.mbridge.msdk.widget.custom.a aVar) {
        ...
        this.f = false;
        this.g = null;
        this.k = new com.mbridge.msdk.widget.custom.a() {
            @Override
            ...
            @Override
            public final void a(DownloadMessageDialog downloadMessageDialog, CustomViewMessageWrap customViewMessageWrap2, a.a aVar2) {
                if (DownloadMessageDialog.this.e != null) {
                    if (aVar2 == a.a.b && DownloadMessageDialog.this.i != null) {
                        DownloadMessageDialog.this.i.cancel();
                    }
                    DownloadMessageDialog.this.e.a(downloadMessageDialog, customViewMessageWrap2, aVar2);
                }
            }
        };
        setCancelable(z);
        ...
        try {
            if (this.f) {
                ...
                try {
                    ...
                    int i = 1;
                    if (this.g == null) {
                        OrientationEventListener orientationEventListener = new OrientationEventListener(getContext(), i) {
                            @Override
