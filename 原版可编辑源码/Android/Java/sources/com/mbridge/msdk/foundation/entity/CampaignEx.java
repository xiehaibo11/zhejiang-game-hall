...
public class CampaignEx extends DomainCampaignEx implements NoProGuard, Serializable {
    ...
    public static CampaignEx parseSettingCampaign(JSONObject jSONObject) {
        ...
        campaignEx.setAdCall(jSONObject.optString(a.a.k));
    ...
    */
    public static CampaignEx parseCampaign(JSONObject jSONObject, String str, String str2, String str3, boolean z, CampaignUnit campaignUnit, String str4) {
        ...
        try {
            CampaignEx campaignEx = new CampaignEx();
            try {
                String strOptString = jSONObjectDealV5Temp.optString("aks");
                if (!TextUtils.isEmpty(strOptString)) {
                ...
                try {
                    campaignEx.setReady_rate(jSONObjectDealV5Temp.optInt("ready_rate", -1));
                    JSONObject jSONObjectOptJSONObject = jSONObjectDealV5Temp.optJSONObject("ext_data");
                    if (jSONObjectOptJSONObject != null) {
                        campaignEx.setExt_data(jSONObjectOptJSONObject.toString());
                    }
                    campaignEx.setMof_tplid(jSONObjectDealV5Temp.optInt("mof_tplid"));
                    campaignEx.setMof_template_url(jSONObjectDealV5Temp.optString("mof_template_url"));
                    campaignEx.setNscpt(jSONObjectDealV5Temp.optInt("nscpt"));
                    new JSONArray();
                    JSONArray jSONArrayOptJSONArray3 = jSONObjectDealV5Temp.optJSONArray("pv_urls");
                    if (jSONArrayOptJSONArray3 == null || jSONArrayOptJSONArray3.length() <= 0) {
                        arrayList2 = null;
                    } else {
                        arrayList2 = new ArrayList(jSONArrayOptJSONArray3.length());
                        for (int i2 = 0; i2 < jSONArrayOptJSONArray3.length(); i2++) {
                            arrayList2.add(jSONArrayOptJSONArray3.optString(i2));
                        }
                    }
                    campaignEx.setPv_urls(arrayList2);
                    JSONObject jSONObjectOptJSONObject2 = jSONObjectDealV5Temp.optJSONObject("req_ext_data");
                    if (jSONObjectOptJSONObject2 != null) {
                        campaignEx.setReq_ext_data(jSONObjectOptJSONObject2.toString());
                    }
                } catch (Exception unused) {
                ...
                campaignEx.setAppDesc(jSONObjectDealV5Temp.optString("desc"));
                campaignEx.setPackageName(jSONObjectDealV5Temp.optString("package_name"));
                campaignEx.setRtinsType(jSONObjectDealV5Temp.optInt("rtins_type"));
                campaignEx.setIconUrl(jSONObjectDealV5Temp.optString("icon_url"));
                campaignEx.setImageUrl(jSONObjectDealV5Temp.optString("image_url"));
                campaignEx.setSize(jSONObjectDealV5Temp.optString("app_size"));
                campaignEx.setImageSize(jSONObjectDealV5Temp.optString("image_size"));
                campaignEx.setImpressionURL(replaceValueByKey(campaignUnit, campaignEx, jSONObjectDealV5Temp.optString("impression_url")));
                campaignEx.setClickURL(replaceValueByKey(campaignUnit, campaignEx, jSONObjectDealV5Temp.optString("click_url")));
                campaignEx.setRewardPlus(RewardPlus.parseByString(jSONObjectDealV5Temp.optString("rw_pl")));
                campaignEx.setWtick(jSONObjectDealV5Temp.optInt("wtick"));
                campaignEx.setDeepLinkUrl(replaceValueByKey(campaignUnit, campaignEx, jSONObjectDealV5Temp.optString("deep_link")));
                campaignEx.setUserActivation(jSONObjectDealV5Temp.optBoolean("user_activation", false));
                campaignEx.setNoticeUrl(replaceValueByKey(campaignUnit, campaignEx, jSONObjectDealV5Temp.optString("notice_url")));
                campaignEx.setTemplate(jSONObjectDealV5Temp.optInt("template"));
                campaignEx.setType(jSONObjectDealV5Temp.optInt("ad_source_id", 1));
                campaignEx.setFca(jSONObjectDealV5Temp.optInt("fca"));
                campaignEx.setFcb(jSONObjectDealV5Temp.optInt("fcb"));
                campaignEx.setEndcard_click_result(jSONObjectDealV5Temp.optInt("endcard_click_result"));
                ...
                if (!TextUtils.isEmpty(jSONObjectDealV5Temp.optString("number_rating"))) {
                    campaignEx.setNumberRating(jSONObjectDealV5Temp.optInt("number_rating", 333333));
                }
                campaignEx.setClick_mode(jSONObjectDealV5Temp.optString("click_mode"));
                campaignEx.setLandingType(jSONObjectDealV5Temp.optString("landing_type"));
                campaignEx.setLinkType(jSONObjectDealV5Temp.optInt("link_type", 4));
                campaignEx.setClickInterval(jSONObjectDealV5Temp.optInt("c_ct"));
                campaignEx.setAdCall(jSONObjectDealV5Temp.optString("ctatext"));
                campaignEx.setAd_url_list(jSONObjectDealV5Temp.optString("ad_url_list"));
                campaignEx.setRetarget_offer(jSONObjectDealV5Temp.optInt("retarget_offer", 2));
                String strOptString2 = jSONObjectDealV5Temp.optString("video_url");
                if (!TextUtils.isEmpty(strOptString2)) {
                    if (z) {
                        campaignEx.setVideoUrlEncode(strOptString2);
                    } else {
                        campaignEx.setVideoUrlEncode(t.b(strOptString2));
                    }
                }
                campaignEx.setVideoCompleteTime(jSONObjectDealV5Temp.optInt("view_com_time"));
                campaignEx.setVideoLength(jSONObjectDealV5Temp.optInt("video_length"));
                campaignEx.setVideoSize(jSONObjectDealV5Temp.optInt("video_size"));
                campaignEx.setVideoResolution(jSONObjectDealV5Temp.optString("video_resolution"));
                campaignEx.setWatchMile(jSONObjectDealV5Temp.optInt("watch_mile"));
                campaignEx.setTimestamp(System.currentTimeMillis());
                campaignEx.setOnlyImpressionURL(replaceValueByKey(campaignUnit, campaignEx, str));
                campaignEx.setBty(jSONObjectDealV5Temp.optInt("ctype"));
                campaignEx.setAdvImp(jSONObjectDealV5Temp.optString("adv_imp"));
                campaignEx.setTImp(jSONObjectDealV5Temp.optInt("t_imp"));
                campaignEx.setHtmlUrl(str2);
                campaignEx.setEndScreenUrl(str3);
                campaignEx.setGuidelines(jSONObjectDealV5Temp.optString("guidelines"));
                campaignEx.setOfferType(jSONObjectDealV5Temp.optInt("offer_type"));
                ...
                try {
                    String strReplaceValueByKey = replaceValueByKey(campaignUnit, campaignEx, jSONObjectDealV5Temp.optString("ad_tracking"));
                ...
                if (jSONObjectDealV5Temp.has("md5_file")) {
                    campaignEx.setVideoMD5Value(jSONObjectDealV5Temp.optString("md5_file"));
                }
                if (jSONObjectDealV5Temp.has("nv_t2")) {
                    campaignEx.setNvT2(jSONObjectDealV5Temp.optInt("nv_t2"));
                }
                if (jSONObjectDealV5Temp.has("gif_url")) {
                    campaignEx.setGifUrl(jSONObjectDealV5Temp.optString("gif_url"));
                }
                campaignEx.setRewardTemplateMode(c.a(jSONObjectDealV5Temp.optJSONObject("rv")));
                campaignEx.setClickTimeOutInterval(jSONObjectDealV5Temp.optInt("c_toi", 2));
                campaignEx.setImpUA(jSONObjectDealV5Temp.optInt("imp_ua", 1));
                campaignEx.setcUA(jSONObjectDealV5Temp.optInt("c_ua", 1));
                campaignEx.setJmPd(jSONObjectDealV5Temp.optInt("jm_pd"));
                ...
                campaignEx.setTpOffer(jSONObjectDealV5Temp.optInt("tp_offer"));
                campaignEx.setFac(jSONObjectDealV5Temp.optInt("fac"));
                campaignEx.setIa_ext1(jSONObjectDealV5Temp.optString("ia_ext1"));
                campaignEx.setIa_ext2(jSONObjectDealV5Temp.optString("ia_ext2"));
                campaignEx.setIsDownLoadZip(jSONObjectDealV5Temp.optInt("is_download_zip"));
                campaignEx.setInteractiveCache(jSONObjectDealV5Temp.optString("ia_cache"));
                campaignEx.setOc_time(jSONObjectDealV5Temp.optInt("oc_time"));
                campaignEx.setOc_type(jSONObjectDealV5Temp.optInt("oc_type"));
                campaignEx.setT_list(jSONObjectDealV5Temp.optString("t_list"));
                campaignEx.setAdchoice(a.a(jSONObjectDealV5Temp.optString("adchoice", "")));
                campaignEx.setPlct(jSONObjectDealV5Temp.optLong("plct"));
                campaignEx.setPlctb(jSONObjectDealV5Temp.optLong("plctb"));
                ...
                try {
                    if (!TextUtils.isEmpty(strOptString4)) {
                        ...
                        i = 0;
                        campaignEx.setIsMraid(false);
                        jSONArrayOptJSONArray = jSONObjectDealV5Temp.optJSONArray("omid");
                        if (jSONArrayOptJSONArray != null) {
                            if (!TextUtils.isEmpty(jSONObjectDealV5Temp.optString("omid"))) {
                                campaignEx.setOmid(jSONObjectDealV5Temp.optString("omid"));
                            } else {
                                campaignEx.setOmid(null);
                            }
                        } else {
                            campaignEx.setOmid(jSONArrayOptJSONArray.toString());
                        }
                        campaignEx.setPlacementId(jSONObjectDealV5Temp.optString(MBridgeConstans.PLACEMENT_ID));
                        campaignEx.setMaitve(jSONObjectDealV5Temp.optInt("maitve"));
                        campaignEx.setMaitve_src(jSONObjectDealV5Temp.optString("maitve_src"));
                        campaignEx.setFlb(jSONObjectDealV5Temp.optInt("flb"));
                        campaignEx.setCbd(jSONObjectDealV5Temp.optInt("cbd", -2));
                        campaignEx.setVst(jSONObjectDealV5Temp.optInt("vst", -2));
                        campaignEx.setAdSpaceT(jSONObjectDealV5Temp.optInt("adspace_t", 1));
                        campaignEx.setFlbSkipTime(jSONObjectDealV5Temp.optInt("flb_skiptime"));
                        campaign = parseCampaign(jSONObjectDealV5Temp, campaignEx);
                        campaign.setImpressionURL(ae.a(com.mbridge.msdk.foundation.controller.a.f().j(), campaign.getPackageName(), campaign.getImpressionURL()));
                        campaign.setVideoCheckType(jSONObjectDealV5Temp.optInt("vck_t", 2));
                        campaign.setVideoCtnType(jSONObjectDealV5Temp.optInt("vctn_t", 1));
                        jSONArrayOptJSONArray2 = jSONObjectDealV5Temp.optJSONArray("rs_ignc_r");
                        if (jSONArrayOptJSONArray2 != null && jSONArrayOptJSONArray2.length() > 0) {
                            arrayList = new ArrayList<>();
                            while (i < jSONArrayOptJSONArray2.length()) {
                                arrayList.add(Integer.valueOf(jSONArrayOptJSONArray2.optInt(i)));
                                i++;
                            }
                            if (arrayList.size() > 0) {
                                campaign.setRsIgnoreCheckRule(arrayList);
                            }
                        }
    ...
    public static final class c implements Serializable {
        ...
        public static c a(JSONObject jSONObject) {
            ...
            try {
                ...
                cVar.b = jSONObject.optInt(c.c.a, 1);
                cVar.e = jSONObject.optString("template_url");
                cVar.c = jSONObject.optInt("orientation");
                cVar.d = jSONObject.optString(c.c.d);
                JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(c.c.e);
                if (jSONObjectOptJSONObject != null) {
                    ArrayList arrayList = new ArrayList();
        ...
        private static a a(JSONObject jSONObject) {
            ...
            try {
                ...
                try {
                    ...
                    aVar2.a = jSONObject.optString(c.a.a);
