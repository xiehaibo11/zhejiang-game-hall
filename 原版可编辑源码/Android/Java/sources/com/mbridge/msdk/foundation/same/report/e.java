...
public class e extends a {
    ...
    public static com.mbridge.msdk.foundation.same.net.g.d a(String str, String str2, Context context, String str3) {
        ...
        try {
            if (!TextUtils.isEmpty(str2)) {
                z.a(a, "8.5.0 add channel ,before value : " + str2);
                String strA = Aa.a();
                if (strA == null) {
                    strA = "";
                }
                ...
                z.a(a, "8.5.0 add channel ,update value : " + str2);
            } else {
                JSONObject jSONObject2 = new JSONObject();
    ...
    private static void d(Context context, String str) {
        ...
        try {
            new com.mbridge.msdk.foundation.same.report.d.a(context).post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, a(str, context, ""), new com.mbridge.msdk.foundation.same.report.d.b() {
                @Override
    ...
    private static void a(final Context context, final String str, String str2) {
        ...
        try {
            new com.mbridge.msdk.foundation.same.report.d.a(context).post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, a(str, context, str2), new com.mbridge.msdk.foundation.same.report.d.b() {
                @Override
    ...
    public static void a(int i, String str, String str2) {
        try {
            new com.mbridge.msdk.foundation.same.report.d.a(com.mbridge.msdk.foundation.controller.a.f().j()).post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, a("key=2000080&reason=" + str2 + "&ad_type=" + i + "&url=" + URLEncoder.encode(str, "utf-8"), com.mbridge.msdk.foundation.controller.a.f().j(), ""), null);
        } catch (Exception e) {
            z.d(a, e.getMessage());
        }
    }
    ...
    public static void a(CampaignEx campaignEx, String str, int i, int i2, String str2, int i3, int i4, int i5) {
        try {
            ...
            if (b.a().c()) {
                ...
                aVar.post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, a(sb.toString(), com.mbridge.msdk.foundation.controller.a.f().j(), str), new com.mbridge.msdk.foundation.same.report.d.b() {
                    @Override
                    public final void onSuccess(String str3) {
