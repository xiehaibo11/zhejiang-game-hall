...
public final class ae extends h {
    ...
    */
    ...
    public static int a(Object obj) {
        ...
        try {
            ...
            z.c(com.tkay.expressad.foundation.h.t.a, th.getMessage(), th);
            return 0;
        }
    }
    ...
    public static JSONArray a(Context context, String str) throws Throwable {
        ...
        try {
            ...
            if (aVarB != null && aVarB.ai() == 1) {
                z.b(com.tkay.expressad.foundation.h.t.a, "fqci cfc:" + aVarB.ai());
                long[] jArrA = com.mbridge.msdk.foundation.db.l.a(com.mbridge.msdk.foundation.db.i.a(context)).a();
                if (jArrA != null) {
                    for (long j2 : jArrA) {
                        z.b(com.tkay.expressad.foundation.h.t.a, "cfc campaignIds:" + jArrA);
                        jSONArray.put(j2);
                    }
                }
            }
    ...
    public static String b(Context context, String str) throws Throwable {
        ...
        try {
            ...
            z.b(com.tkay.expressad.foundation.h.t.a, "get excludes:" + strA);
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        return strA;
    ...
    public static boolean c() {
        ...
        try {
            ...
            z.d(com.tkay.expressad.foundation.h.t.a, e2.getMessage());
            return false;
        }
    }
    ...
    public static Object d(String str) {
        ...
        try {
            ...
            z.d(com.tkay.expressad.foundation.h.t.a, e3.getMessage());
            return null;
        } catch (NoSuchMethodException e4) {
            z.d(com.tkay.expressad.foundation.h.t.a, e4.getMessage());
            return null;
        } catch (InvocationTargetException e5) {
            z.d(com.tkay.expressad.foundation.h.t.a, e5.getMessage());
            return null;
        }
    }
    ...
    public static int d() {
        try {
            ...
            z.d(com.tkay.expressad.foundation.h.t.a, th.getMessage());
            return 0;
        }
    }
    ...
    public static boolean h(String str) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(queryParameter)) {
                ...
                z = i2 % 2 == 0;
                try {
                    if (TextUtils.isEmpty(uri.getQueryParameter("natmp"))) {
                        return z;
                    }
                    return true;
                } catch (Exception e3) {
            ...
            z.d(com.tkay.expressad.foundation.h.t.a, e.getMessage());
            return false;
    ...
    */
    public static String m(String str) {
        ...
        List<String> listC;
        if (TextUtils.isEmpty(str) || (concurrentHashMapC = com.mbridge.msdk.foundation.same.a.d.c(str)) == null || concurrentHashMapC.size() <= 0) {
            return "";
        }
        ArrayList arrayList = new ArrayList();
        for (com.mbridge.msdk.foundation.entity.c cVar : concurrentHashMapC.values()) {
            if (cVar != null) {
                ...
                boolean z = true;
                if (jD > 0) {
                    if (jE + (jD * 1000) < jCurrentTimeMillis) {
                        z = false;
                    }
                    if (!z && (listC = cVar.c()) != null && listC.size() > 0) {
                    ...
                    if (jE + (aVarB.W() * 1000) < jCurrentTimeMillis) {
                    }
                    if (!z) {
                    }
                }
