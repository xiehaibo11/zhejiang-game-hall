...
public class d {
    ...
    public final void a(int i, String str) {
        new com.mbridge.msdk.foundation.same.report.d.a(this.b).post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, e.a("event", e.a((Campaign) null, i, "request"), this.b, str), new com.mbridge.msdk.foundation.same.report.d.b() {
            @Override
    ...
    public final void a(final n nVar, final Boolean bool) {
        if (nVar != null) {
            if (nVar.c().equals("GET")) {
                new com.mbridge.msdk.foundation.same.report.d.a(this.b).get(0, nVar.b(), null, new com.mbridge.msdk.foundation.same.report.d.b() {
                    @Override
            ...
            if (nVar.c().equals("POST")) {
                ...
                aVar.post(0, nVar.b(), dVarA, new com.mbridge.msdk.foundation.same.report.d.b() {
                    @Override
                    public final void onSuccess(String str) {
                        z.b(d.a, "report success");
    ...
    public final void a(final n nVar) {
        new com.mbridge.msdk.foundation.same.report.d.a(this.b).post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, e.a(this.b, nVar), new com.mbridge.msdk.foundation.same.report.d.b() {
            @Override
            public final void onFailed(String str) {
            }
    ...
    private void c(String str) {
        try {
            new com.mbridge.msdk.foundation.same.report.d.a(this.b).post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, e.a(str, this.b, ""), new com.mbridge.msdk.foundation.same.report.d.b() {
                @Override
                public final void onSuccess(String str2) {
                    z.b(d.a, "reportPB success data:" + str2);
                }

                @Override
                public final void onFailed(String str2) {
                    z.b(d.a, "reportPB onFailed msg:" + str2);
                }
            });
        } catch (Throwable th) {
            th.printStackTrace();
    ...
    public final void a(String str, String str2, String str3, String str4) {
        try {
            ...
            if (b.a().c()) {
                ...
                aVar.post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, e.a(str5, this.b, str3), new com.mbridge.msdk.foundation.same.report.d.b() {
                    @Override
            ...
            z.d(a, "ssl  error report failed");
        }
    }

    public final void a(String str, final File file) {
        new com.mbridge.msdk.foundation.same.report.d.a(this.b).post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, e.a(this.b, str), new com.mbridge.msdk.foundation.same.report.d.b() {
            @Override
            public final void onSuccess(String str2) {
                z.b(d.a, "report success exception");
                File file2 = file;
                if (file2 != null) {
                    file2.delete();
                }
            ...
            @Override
            public final void onFailed(String str2) {
                z.b(d.a, "report failed exception");
            }
        });
    }
    ...
    public final void a(String str, com.mbridge.msdk.foundation.entity.e eVar, String str2) {
        ...
        if (b.a().c()) {
            ...
            aVar.post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, e.a(strA, this.b, str2), new com.mbridge.msdk.foundation.same.report.d.b() {
                @Override
    ...
    public final void a(int i, int i2, String str, String str2) {
        try {
            ...
            if (b.a().c()) {
                ...
                aVar.post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, e.a(sb.toString(), this.b, ""), new com.mbridge.msdk.foundation.same.report.d.b() {
                    @Override
                    public final void onSuccess(String str3) {
            ...
            z.d(a, "reportSettingLoadFailed onFailed");
        }
    }
    ...
    public final void a() {
        try {
            if (e.a()) {
                ...
                z.a(a, "reportPrivateAuthorityStatus  data:" + str2);
                if (b.a().c()) {
                    b.a().a(str2);
                    return;
                }
                aVar.post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, e.a(str2, this.b, ""), new com.mbridge.msdk.foundation.same.report.d.b() {
                    @Override
                    public final void onSuccess(String str3) {
            ...
            z.d(a, "PrivateAuthorityStatus onFailed");
        }
    }
    ...
    public final void a(int i, int i2, String str, String str2, String str3) {
        try {
            ...
            sb.append("dl_pkg");
            sb.append(ContainerUtils.KEY_VALUE_DELIMITER);
            sb.append(URLEncoder.encode(aj.a + "", "utf-8"));
            sb.append("&");
            sb.append("dl_pkg_rs");
            sb.append(ContainerUtils.KEY_VALUE_DELIMITER);
    ...
    public final void a(String str, String str2, String str3, String str4, String str5, boolean z) {
        try {
            ...
            if (b.a().c()) {
                ...
                aVar.post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, e.a(sb.toString(), this.b, str4), new com.mbridge.msdk.foundation.same.report.d.b() {
                    @Override
                    public final void onSuccess(String str6) {
