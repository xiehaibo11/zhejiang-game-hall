...
public final class Ac3Util {
    ...
    private static final int[] BITRATE_BY_HALF_FRMSIZECOD = {32, 40, 48, 56, 64, 80, 96, 112, 128, 160, PsExtractor.AUDIO_STREAM, 224, 256, 320, ChunkType.XML_RESOURCE_MAP, 448, 512, 576, 640};
    private static final int[] SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = {69, 87, 104, a.L, 139, 174, AdEventType.VIDEO_CLICKED, 243, com.tkay.expressad.foundation.g.a.aS, 348, 417, 487, 557, 696, 835, 975, SysfuncInterface.SYSFUNC_NO_INSTALL_VIVO, 1253, 1393};
    ...
    public static int parseEAc3SyncframeAudioSampleCount(ByteBuffer byteBuffer) {
        return (((byteBuffer.get(byteBuffer.position() + 4) & 192) >> 6) != 3 ? BLOCKS_PER_SYNCFRAME_BY_NUMBLKSCOD[(byteBuffer.get(byteBuffer.position() + 4) & e.H) >> 4] : 6) * 256;
    }
