...
final class AtomParsers {
    ...
    private static final int TYPE_meta = Util.getIntegerCodeForString(TTDownloadField.TT_META);
    ...
    */
    public static TrackSampleTable parseStbl(Track track, Atom.ContainerAtom containerAtom, GaplessInfoHolder gaplessInfoHolder) throws ParserException {
        ...
        if (parsableByteArray5 != null) {
            ...
            long j3 = 0;
            if (!stz2SampleSizeBox.isFixedSampleSize() && "audio/raw".equals(track.format.sampleMimeType) && unsignedIntToInt3 == 0 && unsignedIntToInt == 0 && unsignedIntToInt2 == 0) {
                long[] jArr5 = new long[sampleCount];
                int[] iArr5 = new int[sampleCount];
                int i7 = unsignedIntToInt2;
                long[] jArr6 = new long[sampleCount];
                int[] iArr6 = new int[sampleCount];
                int i8 = unsignedIntToInt5;
                long j4 = 0;
                long j5 = 0;
                int i9 = unsignedIntToInt3;
                int i10 = 0;
                int i11 = 0;
                ...
                while (i10 < sampleCount) {
                    ...
                    int i18 = i16;
                    if (parsableByteArray6 != null) {
                        while (unsignedIntToInt6 == 0 && i15 > 0) {
                    ...
                    int i19 = i12;
                    jArr5[i10] = j5;
                    iArr5[i10] = stz2SampleSizeBox.readNextSampleSize();
                    if (iArr5[i10] > i11) {
                        i11 = iArr5[i10];
                    }
                    SampleSizeBox sampleSizeBox = stz2SampleSizeBox;
                    long[] jArr7 = jArr5;
                    jArr6[i10] = j4 + ((long) i19);
                    iArr6[i10] = parsableByteArray4 == null ? 1 : 0;
                    if (i10 == unsignedIntToInt7) {
                        iArr6[i10] = 1;
                        i14--;
                        if (i14 > 0) {
                ...
                track2 = track;
                str = TAG;
                long[] jArr9 = new long[chunkIterator.length];
                int[] iArr7 = new int[chunkIterator.length];
                while (chunkIterator.moveNext()) {
                    jArr9[chunkIterator.index] = chunkIterator.offset;
                    iArr7[chunkIterator.index] = chunkIterator.numSamples;
                }
                FixedSampleSizeRechunker.Results resultsRechunk = FixedSampleSizeRechunker.rechunk(Util.getPcmFrameSize(track2.format.pcmEncoding, track2.format.channelCount), jArr9, iArr7, unsignedIntToInt5);
            ...
            if (track2.editListDurations != null || gaplessInfoHolder.hasGaplessInfo()) {
                ...
                return new TrackSampleTable(track, jArr, iArr, i, jArr2, iArr2, jScaleLargeTimestamp);
            }
            if (track2.editListDurations.length == 1 && track2.type == 1 && jArr2.length >= 2) {
                long j6 = track2.editListMediaTimes[0];
                long jScaleLargeTimestamp2 = j6 + Util.scaleLargeTimestamp(track2.editListDurations[0], track2.timescale, track2.movieTimescale);
                str2 = str;
                if (canApplyEditWithGaplessInfo(jArr2, j, j6, jScaleLargeTimestamp2)) {
                    long jScaleLargeTimestamp3 = Util.scaleLargeTimestamp(j6 - jArr2[0], track2.format.sampleRate, track2.timescale);
                    i2 = i;
                    ...
                    if ((jScaleLargeTimestamp3 != 0 || jScaleLargeTimestamp4 != 0) && jScaleLargeTimestamp3 <= 2147483647L && jScaleLargeTimestamp4 <= 2147483647L) {
                        ...
                        Util.scaleLargeTimestampsInPlace(jArr2, 1000000L, track2.timescale);
                        return new TrackSampleTable(track, jArr, iArr, i2, jArr2, iArr2, jScaleLargeTimestamp);
                    }
                }
                if (track2.editListDurations.length != 1 && track2.editListDurations[0] == 0) {
                    ...
                    for (int i24 = 0; i24 < jArr2.length; i24++) {
                        jArr2[i24] = Util.scaleLargeTimestamp(jArr2[i24] - j7, 1000000L, track2.timescale);
                    }
                    return new TrackSampleTable(track, jArr, iArr, i2, jArr2, iArr2, Util.scaleLargeTimestamp(j - j7, 1000000L, track2.timescale));
                }
                ...
                while (true) {
                    j2 = -1;
                    if (i3 < track2.editListDurations.length) {
                        break;
                    }
                    ...
                    if (j8 != -1) {
                        jArr4 = jArr;
                        iArr4 = iArr;
                        long jScaleLargeTimestamp5 = Util.scaleLargeTimestamp(track2.editListDurations[i3], track2.timescale, track2.movieTimescale);
                        int iBinarySearchCeil = Util.binarySearchCeil(jArr2, j8, true, true);
                        int iBinarySearchCeil2 = Util.binarySearchCeil(jArr2, j8 + jScaleLargeTimestamp5, z4, false);
                        i25 += iBinarySearchCeil2 - iBinarySearchCeil;
                        z5 |= i26 != iBinarySearchCeil;
                        i26 = iBinarySearchCeil2;
                    } else {
                        jArr4 = jArr;
                        iArr4 = iArr;
                    }
                ...
                long[] jArr10 = jArr;
                int[] iArr8 = iArr;
                z2 = z5 | (i25 == sampleCount);
                long[] jArr11 = !z2 ? new long[i25] : jArr10;
                int[] iArr9 = !z2 ? new int[i25] : iArr8;
                if (z2) {
                    i2 = 0;
                }
                int[] iArr10 = !z2 ? new int[i25] : iArr2;
                long[] jArr12 = new long[i25];
                i4 = 0;
                int i27 = 0;
                while (i4 < track2.editListDurations.length) {
                    long j9 = track2.editListMediaTimes[i4];
                    long j10 = track2.editListDurations[i4];
                    if (j9 != j2) {
                        jArr3 = jArr12;
                        i5 = i4;
                        long jScaleLargeTimestamp6 = Util.scaleLargeTimestamp(j10, track2.timescale, track2.movieTimescale) + j9;
                        int iBinarySearchCeil3 = Util.binarySearchCeil(jArr2, j9, true, true);
                        int iBinarySearchCeil4 = Util.binarySearchCeil(jArr2, jScaleLargeTimestamp6, z4, false);
                        if (z2) {
                            int i28 = iBinarySearchCeil4 - iBinarySearchCeil3;
                            System.arraycopy(jArr10, iBinarySearchCeil3, jArr11, i27, i28);
                            iArr3 = iArr8;
                            System.arraycopy(iArr3, iBinarySearchCeil3, iArr9, i27, i28);
                            System.arraycopy(iArr2, iBinarySearchCeil3, iArr10, i27, i28);
                        } else {
                            iArr3 = iArr8;
                        }
                        if (iBinarySearchCeil3 < iBinarySearchCeil4 && (iArr10[i27] & 1) == 0) {
                        ...
                        while (iBinarySearchCeil3 < iBinarySearchCeil4) {
                            int i30 = iBinarySearchCeil4;
                            String str5 = str4;
                            long j11 = j9;
                            jArr3[i27] = Util.scaleLargeTimestamp(j3, 1000000L, track2.movieTimescale) + Util.scaleLargeTimestamp(jArr2[iBinarySearchCeil3] - j9, 1000000L, track2.timescale);
                            if (z2 && iArr9[i27] > i29) {
                                i29 = iArr3[iBinarySearchCeil3];
                            }
                            i27++;
                            iBinarySearchCeil3++;
                            iBinarySearchCeil4 = i30;
                            j9 = j11;
                            str4 = str5;
                        }
                        str3 = str4;
                ...
                return new TrackSampleTable(track, jArr11, iArr9, i2, jArr12, iArr10, Util.scaleLargeTimestamp(j3, 1000000L, track2.timescale));
            }
            str2 = str;
            i2 = i;
            ...
            long[] jArr122 = new long[i252];
            i4 = 0;
            int i272 = 0;
            while (i4 < track2.editListDurations.length) {
            }
            return new TrackSampleTable(track, jArr11, iArr9, i2, jArr122, iArr10, Util.scaleLargeTimestamp(j3, 1000000L, track2.timescale));
        }
        unsignedIntToInt2 = 0;
