...
final class SeiReader {
    ...
    public final void createTracks(ExtractorOutput extractorOutput, TsPayloadReader.TrackIdGenerator trackIdGenerator) {
        for (int i = 0; i < this.outputs.length; i++) {
            ...
            trackOutputTrack.format(Format.createTextSampleFormat(format.id != null ? format.id : trackIdGenerator.getFormatId(), str, (String) null, -1, format.selectionFlags, format.language, format.accessibilityChannel, (DrmInitData) null));
