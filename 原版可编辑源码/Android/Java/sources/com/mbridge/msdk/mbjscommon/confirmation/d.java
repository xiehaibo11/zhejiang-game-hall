...
public final class d {
            ...
            this.a.post(new Runnable() {
                ...
                public final void run() {
                    ...
                    if (i2 == 2) {
                        d dVar = d.this;
                        if (dVar.a != null) {
                            dVar.a.setText(s.a(dVar.a.getContext(), "mbridge_cm_progress_status_descri_pause", i.g));
                            return;
                        }
                        return;
                    }
                    if (i2 == 3) {
                        ...
                        if (dVar2.a != null) {
                            ...
                            try {
                                ...
                                dVar2.a.setText(context.getResources().getString(s.a(context, "mbridge_cm_progress_status_descri_ins", i.g)));
                                return;
                            } catch (Exception e) {
                                e.printStackTrace();
                                return;
                    ...
                    if (dVar3.a != null) {
                        ...
                        try {
                            ...
                            dVar3.a.setText(context2.getResources().getString(s.a(context2, "mbridge_cm_progress_status_descri_open", i.g)));
                        } catch (Exception e2) {
                            e2.printStackTrace();
                        }
                    }
    ...
    public final void a() {
        if (this.g == 3) {
            ...
            try {
                String strB = com.mbridge.msdk.foundation.db.e.a(com.mbridge.msdk.foundation.db.i.a(this.a.getContext())).b(this.f);
                Class<?> cls = Class.forName("com.mbridge.msdk.mbdownload.manager.ADownloadManager");
        ...
        if (mBButton != null) {
            ...
            if (dVar.d == 100) {
                try {
                    ...
                    dVar.a.setText(context.getResources().getString(s.a(context, "mbridge_cm_progress_status_descri_ins", i.g)));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
