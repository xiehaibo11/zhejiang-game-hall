...
public class c {
    ...
    public static String a(String str, String str2, String str3) {
        ...
        try {
            ...
            Iterator<Map.Entry<String, a.a>> it = mapAA.entrySet().iterator();
            while (it.hasNext()) {
                String key = it.next().getKey();
                if (!TextUtils.isEmpty(key) && host.contains(key)) {
                    a.a aVar = mapAA.get(key);
                    return a(a(a(a(str, aVar.d(), String.valueOf(v.y(com.mbridge.msdk.foundation.controller.a.f().j()))), aVar.c(), String.valueOf(v.x(com.mbridge.msdk.foundation.controller.a.f().j()))), aVar.a(), str2), aVar.b(), str3);
                }
            }
            return str;
        } catch (Exception e) {
