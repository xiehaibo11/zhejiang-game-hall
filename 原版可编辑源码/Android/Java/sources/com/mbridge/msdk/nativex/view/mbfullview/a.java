...
public class a {
    ...
    private class a implements c {
        ...
        public a(MBridgeTopFullView mBridgeTopFullView) {
    ...
    static class 2 {
        ...
        static {
            ...
            a = iArr;
            try {
                iArr[BaseView.a.a.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                a[BaseView.a.b.ordinal()] = 2;
    ...
    public final void a(BaseView.a aVar, CampaignEx campaignEx, BaseView baseView) {
        ...
        if (mBridgeTopFullView != null) {
            ...
            if (context != null) {
                b.a(context).a(campaignEx.getIconUrl(), new a(mBridgeTopFullView));
            }
    ...
    public final void a(final boolean z, boolean z2, final BaseView baseView) {
        ...
        Context context = this.a.get();
        if (!z) {
            if (baseView.style != BaseView.a.b) {
                if (context != null) {
            ...
            if (baseView.style == BaseView.a.a && context != null) {
    ...
    static Bitmap a(a aVar, Bitmap bitmap, int i) {
