...
public final class c {
    ...
    private com.mbridge.msdk.mbjscommon.c.b D = new com.mbridge.msdk.mbjscommon.c.b() {
        @Override
    ...
    */
    public final void a(CampaignUnit campaignUnit) {
        ...
        if (campaignUnit != null) {
            ...
            this.s = ads;
            campaignEx = (ads == null || ads.size() <= 0) ? null : this.s.get(0);
        }
        this.e = campaignEx;
        if (campaignEx == null) {
            a(com.tkay.expressad.mbbanner.a.a.h);
        ...
        if (this.d && this.i == null) {
            ImageView imageView = new ImageView(com.mbridge.msdk.foundation.controller.a.f().j());
            this.i = imageView;
            imageView.setBackgroundResource(s.a(com.mbridge.msdk.foundation.controller.a.f().j(), "mbridge_banner_close", com.tkay.expressad.foundation.h.i.c));
        ...
        if (!TextUtils.isEmpty(this.e.getBannerHtml()) || !TextUtils.isEmpty(this.e.getBannerUrl())) {
            com.mbridge.msdk.mbbanner.common.a.a aVarA = com.mbridge.msdk.mbbanner.common.a.a.a().c(this.e.getId()).d(this.e.getRequestId()).e(this.e.getRequestIdNotice()).b(this.q).a(this.e.isBidCampaign());
            String str = this.q;
            if (aVarA != null) {
                aVarA.a(com.tkay.expressad.mbbanner.a.b.c.a);
        ...
        if (!TextUtils.isEmpty(this.e.getBannerHtml()) || !TextUtils.isEmpty(this.e.getBannerUrl())) {
            a(com.tkay.expressad.mbbanner.a.a.m, 2);
        }
        d();
    }
