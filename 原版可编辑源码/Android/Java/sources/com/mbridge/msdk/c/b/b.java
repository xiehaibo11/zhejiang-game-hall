...
public class b {
    ...
    public final void a(Context context, final String str) {
        ...
        String strB = com.mbridge.msdk.foundation.a.a.a.a().b("MraidJSController");
        if (TextUtils.isEmpty(strB) || !strB.equals(str)) {
            try {
                new com.mbridge.msdk.c.a.a(context).get(0, str, null, new com.mbridge.msdk.foundation.same.net.b.a() {
                    @Override
                    public final void a(String str2) {
                        z.a("MraidJSController", "request mraid js success, content = " + str2);
                    ...
                    public final void b(String str2) {
                        z.a("MraidJSController", "fail request mraid js. " + str2);
                    }
                });
            } catch (Exception e) {
                z.d("MraidJSController", e.getMessage());
            }
        }
    }
    ...
    private String c() {
        try {
            File file = new File(e.b(com.mbridge.msdk.foundation.same.b.c.j), "mraid_js.txt");
            return (file.exists() && file.canRead()) ? x.a(file) : "";
        } catch (Exception e) {
            z.a("MraidJSController", e.getMessage());
            return "";
        }
    }
    ...
    public final String b() {
        try {
            ...
            if (TextUtils.isEmpty(this.c)) {
                ...
                if (aVarB != null && !TextUtils.isEmpty(aVarB.aR())) {
                    a(com.mbridge.msdk.foundation.controller.a.f().j(), aVarB.aR());
                }
                return a;
            }
            return this.c;
    ...
    static void b(b bVar, final String str) {
