...
public class b {
    ...
    public final boolean a(String str) {
        ...
        if (aVarB != null) {
            ...
            if (jAn > jCurrentTimeMillis) {
                z.b(a, "app setting nexttime is not ready  [settingNextRequestTime= " + jAn + " currentTime = " + jCurrentTimeMillis + "]");
                return false;
            }
        }
        z.b(a, "app setting timeout or not exists");
        return true;
    }
    ...
    public final boolean a(String str, String str2) {
        ...
        if (aVarB != null && dVarE != null) {
            ...
            if (jU > jCurrentTimeMillis) {
                z.b(a, "unit setting  nexttime is not ready  [settingNextRequestTime= " + jU + " currentTime = " + jCurrentTimeMillis + "]");
                return false;
            }
        }
        z.b(a, "unit setting timeout or not exists");
        return true;
    }
    ...
    public static void a(Context context, String str) {
        ...
        if (com.mbridge.msdk.foundation.controller.b.a().d()) {
            try {
                fastKVBuild = new FastKV.Builder(e.b(com.mbridge.msdk.foundation.same.b.c.m), "mbridge").build();
            } catch (Exception unused) {
                fastKVBuild = null;
            }
        } else {
