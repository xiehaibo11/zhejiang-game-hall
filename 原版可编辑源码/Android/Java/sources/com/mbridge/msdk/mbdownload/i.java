...
public class i {
    ...
    public final void a(int i) {
        if (this.c && this.d == null) {
            try {
                this.d = new FastKV.Builder(com.mbridge.msdk.foundation.same.b.e.b(com.mbridge.msdk.foundation.same.b.c.m), "MB_RUNTIME_CACHE").build();
        ...
        try {
            ...
            z.b(a, "add nid [" + i + "] to runtime cache.");
    ...
    public final void b(int i) {
        try {
            ...
            z.b(a, "remove nid [" + i + "] to runtime cache.");
        } catch (Exception unused) {
        }
    }
}
