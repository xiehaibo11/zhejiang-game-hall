...
public class MBridgeBTNativeEC extends BTBaseView {
    ...
    public void preLoadData() {
        ...
        try {
            ...
            b.a(this.a.getApplicationContext()).a(this.b.getIconUrl(), new i(this.u, ae.b(a.f().j(), 8.0f)));
            ...
            if (aVarB != null) {
                ...
                this.w.setOnClickListener(new View.OnClickListener() {
                    ...
                    public final void onClick(View view) {
                        c.b(MBridgeBTNativeEC.this.a, strAz);
                    }
                });
            } else {
                this.w.setVisibility(8);
    ...
    static void a(MBridgeBTNativeEC mBridgeBTNativeEC, int i, Context context) {
    ...
    static void a(MBridgeBTNativeEC mBridgeBTNativeEC, float f, float f2) {
