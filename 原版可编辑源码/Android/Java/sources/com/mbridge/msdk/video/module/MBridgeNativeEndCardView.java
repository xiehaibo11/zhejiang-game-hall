...
public class MBridgeNativeEndCardView extends MBridgeBaseView {
            ...
            if (this.b != null && this.b.isDynamicView()) {
                ...
                if (!TextUtils.isEmpty(strA3) && strA3.equals("1") && this.aa == null) {
                    ...
                    if (this.p != null && this.p.isShown()) {
                        ...
                        this.ab = new com.mbridge.msdk.shake.b(i4, i5) {
                            @Override
                            public final void a() {
    ...
    */
    public void setLayout() {
        ...
        boolean zB;
        if (this.i) {
            com.mbridge.msdk.video.dynview.b.a().a(new c().a(getContext(), this.b, this.j, "cn_"), new g() {
                @Override
                public final void a(com.mbridge.msdk.video.dynview.a aVar) {
                    if (aVar != null) {
                        MBridgeNativeEndCardView.this.addView(aVar.a());
                        MBridgeNativeEndCardView.this.Q = aVar.c();
        ...
        int i = this.ad;
        String str2 = "mbridge_reward_endcard_native_half_landscape";
        str = "mbridge_reward_endcard_native_half_portrait";
        if (i == 0) {
            str = this.U ? "mbridge_reward_endcard_native_half_portrait" : "mbridge_reward_endcard_native_hor";
            if (isLandscape()) {
                if (!this.U) {
                    str2 = "mbridge_reward_endcard_native_land";
                }
                str = str2;
            }
        } else {
        ...
        int iFindLayout = findLayout(str);
        if (iFindLayout > 0) {
            if (isLandscape()) {
    ...
    public void preLoadData(b bVar) {
        ...
        try {
            ...
            com.mbridge.msdk.foundation.same.c.b.a(this.a.getApplicationContext()).a(this.b.getImageUrl(), new com.mbridge.msdk.foundation.same.c.c() {
                @Override
            ...
            com.mbridge.msdk.foundation.same.c.b.a(this.a.getApplicationContext()).a(this.b.getIconUrl(), new i(this.t, ae.b(com.mbridge.msdk.foundation.controller.a.f().j(), 8.0f)));
            ...
            if (aVarB != null) {
                ...
                this.v.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public final void onClick(View view) {
                        com.mbridge.msdk.click.c.b(MBridgeNativeEndCardView.this.a, strAz);
                    }
                });
            } else {
                this.v.setVisibility(8);
    ...
    protected final void c() {
        if (this.f) {
            ...
            if (mBDownloadProgressBar != null) {
                mBDownloadProgressBar.setOnClickListener(new com.mbridge.msdk.widget.a() {
                    @Override
    ...
    private static class a implements Runnable {
        ...
        public final void run() throws Throwable {
            ...
            String requestId;
            strA = "";
            if (TextUtils.isEmpty(this.a) || (campaignEx = this.b) == null) {
                return;
            }
            try {
                String str7 = this.a;
    ...
    static void a(MBridgeNativeEndCardView mBridgeNativeEndCardView, final Bitmap bitmap) {
        try {
    ...
    static void a(MBridgeNativeEndCardView mBridgeNativeEndCardView, int i) {
        ...
        if (mBridgeNativeEndCardView.b != null && mBridgeNativeEndCardView.b.isDynamicView()) {
            try {
                ...
                com.mbridge.msdk.foundation.same.report.e.a(mBridgeNativeEndCardView.a, "end_card_click", mBridgeNativeEndCardView.b.getCampaignUnitId(), mBridgeNativeEndCardView.b.isBidCampaign(), mBridgeNativeEndCardView.b.getRequestId(), mBridgeNativeEndCardView.b.getRequestIdNotice(), mBridgeNativeEndCardView.b.getId(), str);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    static void p(MBridgeNativeEndCardView mBridgeNativeEndCardView) {
        if (com.mbridge.msdk.foundation.b.b.a().b()) {
            mBridgeNativeEndCardView.b.setCampaignUnitId(mBridgeNativeEndCardView.V);
            com.mbridge.msdk.foundation.b.b.a().a(mBridgeNativeEndCardView.V + "_2", new com.mbridge.msdk.foundation.b.a() {
                @Override
                public final void a() {
