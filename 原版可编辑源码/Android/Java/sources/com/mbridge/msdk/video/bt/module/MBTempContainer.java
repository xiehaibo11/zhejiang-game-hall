...
public class MBTempContainer extends AbstractJSContainer {
                ...
                if (windVaneWebView.getObject() instanceof j) {
                    ...
                    try {
                        if (this.d != null) {
                            ...
                            getJSCommon().b(true);
                            if (this.K == null) {
                                this.K = new com.mbridge.msdk.video.bt.module.a.b() {
                                    @Override
                                    public final void a() {
    ...
    public WindVaneWebView findWindVaneWebView() {
        ...
        try {
            if (this.w) {
                ...
                z.a(y, "当前大模板，存在播放模板");
                a.a aVarA2 = com.mbridge.msdk.videocommon.a.a(this.k + "_" + this.A.getId() + "_" + this.A.getRequestId() + "_" + this.A.getRewardTemplateMode().e());
                if (aVarA2 != null) {
                    return aVarA2.a();
                }
                return null;
            ...
            z.a(y, "当前非大模板");
            if (this.r) {
                aVarA = com.mbridge.msdk.videocommon.a.a(com.tkay.expressad.foundation.g.a.aU, this.A);
            } else {
                aVarA = com.mbridge.msdk.videocommon.a.a(94, this.A);
            }
                            ...
                            switch (i) {
                                ...
                                case 105:
                                    if (MBTempContainer.this.K == null) {
                                        MBTempContainer.this.K = new com.mbridge.msdk.video.bt.module.a.b() {
                                            @Override
                                            public final void a() {
                                                MBTempContainer.this.getJSVideoModule().setInstallDialogState(true);
                                                MBTempContainer.this.getJSVideoModule().setCover(true);
    ...
    static void m(MBTempContainer mBTempContainer) {
        try {
    ...
    static void O(MBTempContainer mBTempContainer) {
        if (mBTempContainer.isLoadSuccess()) {
            mBTempContainer.j.runOnUiThread(new Runnable() {
                @Override
                public final void run() {
