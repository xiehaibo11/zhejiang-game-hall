...
public class MBridgeVideoView extends MBridgeBaseView implements i {
    ...
    static int L(MBridgeVideoView mBridgeVideoView) {
    ...
    public void setVideoLayout(CampaignEx campaignEx) {
        ...
        if (this.i) {
            ...
            com.mbridge.msdk.video.dynview.b.a().a(cVarA, new g() {
                @Override
                public final void a(com.mbridge.msdk.video.dynview.a aVar) {
                    if (aVar != null) {
                        ...
                        if (aVar.b() != null) {
                            ...
                            while (it.hasNext()) {
                                it.next().setOnClickListener(new com.mbridge.msdk.widget.a() {
                                    @Override
    ...
    public void hideAlertView(int i) {
        if (this.L) {
            ...
            e.a(this.a, this.b, com.mbridge.msdk.videocommon.d.c.a, this.U, 1, i, 1);
            if (i == 0) {
                g();
                if (this.ak) {
    ...
    public void showAlertView() {
        ...
        if (this.T == null) {
            this.T = new com.mbridge.msdk.widget.dialog.a() {
                ...
                public final void a() {
                    ...
                    e.a(MBridgeVideoView.this.a, MBridgeVideoView.this.b, MBridgeVideoView.this.ap, MBridgeVideoView.this.U, 1, 0, 1);
                }
                ...
                public final void b() {
                    ...
                    MBridgeVideoView mBridgeVideoView = MBridgeVideoView.this;
                    mBridgeVideoView.setShowingAlertViewCover(mBridgeVideoView.L);
                    e.a(MBridgeVideoView.this.a, MBridgeVideoView.this.b, MBridgeVideoView.this.ap, MBridgeVideoView.this.U, 1, 1, 1);
        ...
        e.a(this.a, this.b, this.ap, this.U, 1, 1);
    }
    ...
    public void defaultShow() {
        super.defaultShow();
        this.aa = true;
        showVideoLocation(0, 0, ae.h(this.a), ae.g(this.a), 0, 0, 0, 0, 0);
        videoOperate(1);
        if (this.P == 0) {
    ...
    public void showVideoLocation(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        if (this.f) {
            ...
            if ((i3 > 0 && i4 > 0 && ae.h(this.a) >= i3 && ae.g(this.a) >= i4) && !this.aa) {
                o = i6;
                p = i7;
                q = i8 + 4;
                r = i9 + 4;
    ...
    public boolean isH5Canvas() {
        return getLayoutParams().height < ae.g(this.a.getApplicationContext());
    }
    ...
    private void h() {
        float f;
        float fH = ae.h(this.a);
        float fG = ae.g(this.a);
    ...
    private static final class b extends DefaultVideoPlayerStatusListener {
                ...
                if (this.m.isDynamicView()) {
                    ...
                    if (mBridgeVideoView2 != null && mBridgeVideoView2.u != null) {
                        if (this.m.getDynamicTempCode() != 5 || this.a.mCurrPlayNum <= 1 || videoCompleteTime > 0) {
                            ...
                            this.a.u.setBackgroundResource(s.a(com.mbridge.msdk.foundation.controller.a.f().j(), str, com.tkay.expressad.foundation.h.i.c));
                        } else {
                            this.a.u.setBackgroundResource(s.a(com.mbridge.msdk.foundation.controller.a.f().j(), "mbridge_reward_video_time_count_num_bg", com.tkay.expressad.foundation.h.i.c));
                            d();
                        }
                    }
                    ...
                    this.a.u.setPadding(iB, 0, iB, 0);
                    this.a.u.setLayoutParams(layoutParams);
                } else {
                    this.a.u.setBackgroundResource(s.a(com.mbridge.msdk.foundation.controller.a.f().j(), "mbridge_reward_shape_progress", com.tkay.expressad.foundation.h.i.c));
                }
            }
            if (this.a.y != null) {
                this.a.y.setMax(i);
        ...
        public final void onPlayCompleted() {
            ...
            this.a.ax = true;
            if (this.m != null) {
                this.a.u.setText(s.a(com.mbridge.msdk.foundation.controller.a.f().j(), "mbridge_reward_video_view_reward_time_complete", com.tkay.expressad.foundation.h.i.g));
        ...
        public final void onPlayProgress(int i, int i2) {
            ...
            if (this.a.f) {
                ...
                if (this.m.isDynamicView() && this.m.getDynamicTempCode() == 5) {
                    try {
                        int i7 = this.a.D;
                        if (this.a != null) {
                            String string2 = (String) this.a.getContext().getResources().getText(s.a(com.mbridge.msdk.foundation.controller.a.f().j(), "mbridge_reward_video_view_reward_time_complete", com.tkay.expressad.foundation.h.i.g));
                            String str3 = (String) this.a.getContext().getResources().getText(s.a(com.mbridge.msdk.foundation.controller.a.f().j(), "mbridge_reward_video_view_reward_time_left", com.tkay.expressad.foundation.h.i.g));
                            if (videoCompleteTime >= 0) {
                                ...
                                if (i4 <= 0) {
                                    ...
                                    if (i4 < this.a.aG && this.a.aI != null && this.a.N) {
                                        this.a.aI.onTimeLessThanReduce(i4);
                                    }
                                } else {
                                    if (videoCompleteTime <= 0) {
                    ...
                    if (this.a != null) {
                        if (this.k) {
                            ...
                            if (i8 <= 0) {
                                string = videoCompleteTime > 0 ? (String) this.a.getContext().getResources().getText(s.a(com.mbridge.msdk.foundation.controller.a.f().j(), "mbridge_reward_video_view_reward_time_complete", com.tkay.expressad.foundation.h.i.g)) : "0";
                            } else {
                                if (videoCompleteTime <= 0) {
                                    ...
                                    sb = new StringBuilder();
                                    sb.append(i8);
                                    sb.append((String) this.a.getContext().getResources().getText(s.a(com.mbridge.msdk.foundation.controller.a.f().j(), "mbridge_reward_video_view_reward_time_left", com.tkay.expressad.foundation.h.i.g)));
                                }
                                string = sb.toString();
                                i6 = i8;
                            }
                            if (i6 < this.a.aG && this.a.aI != null && this.a.N) {
                                this.a.aI.onTimeLessThanReduce(i6);
                            }
                        }
            ...
            if (this.a.ak && !this.a.at && this.a.aq == com.mbridge.msdk.foundation.same.a.x) {
                this.a.b();
            }
            try {
                if (this.a != null && this.a.B != null) {
                    int i11 = (i * 100) / i2;
                    this.a.B.setProgress(i11, this.a.mCurrPlayNum - 1);
                    this.m.setVideoPlayProgress(i11);
                }
                if (this.a != null && this.a.H != -1 && i == this.a.H && this.a.b != null && this.a.b.isDynamicView()) {
                    this.a.setCTALayoutVisibleOrGone();
                }
            } catch (Throwable th) {
    ...
    static void a(MBridgeVideoView mBridgeVideoView, String str) {
        ...
        if (mBridgeVideoView.K != null) {
            if (mBridgeVideoView.b != null) {
                try {
                    ...
                    e.a(mBridgeVideoView.a, str, mBridgeVideoView.b.getCampaignUnitId(), mBridgeVideoView.b.isBidCampaign(), mBridgeVideoView.b.getRequestId(), mBridgeVideoView.b.getRequestIdNotice(), mBridgeVideoView.b.getId(), str2);
                } catch (Exception e2) {
                    e2.printStackTrace();
                }
            }
    ...
    static void r(MBridgeVideoView mBridgeVideoView) {
        String strE;
        ...
        try {
            ...
            if (mBridgeVideoView.aD > 0 && mBridgeVideoView.aD <= 2) {
                ...
                if (iK == 0 || iK > mBridgeVideoView.aE) {
                    ...
                    mBridgeVideoView.aH = new AcquireRewardPopViewParameters.Builder("", mBridgeVideoView.U, mBridgeVideoView.aD, aVarG != null ? aVarG.ah() : "US").setAutoDismissTime(mBridgeVideoView.aF).setReduceTime(mBridgeVideoView.aG).setBehaviourListener(new AcquireRewardPopViewBehaviourListener() {
                        @Override
