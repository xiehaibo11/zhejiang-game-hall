...
public final class a extends BaseAdapter {
    ...
    public final View getView(int i, View view, ViewGroup viewGroup) {
        ...
        try {
            this.b.a = (RelativeLayout) viewA.findViewById(d("mbridge_lv_item_rl"));
    ...
    private View a(int i) {
        ...
        if (file.isFile() && file.exists()) {
            ...
            if (viewCreateDynamicView != null) {
                ...
                a aVar = new a();
                this.b = aVar;
                aVar.l = (MBCusRoundImageView) viewCreateDynamicView.findViewById(c("mbridge_lv_iv"));
            ...
            return this.a ? viewCreateDynamicView : a();
        }
        return a();
    }
    ...
    private View a() {
        ...
        a aVar = new a();
        this.b = aVar;
        aVar.c = (MBridgeImageView) viewInflate.findViewById(b("mbridge_lv_iv"));
    ...
    private void a(final ImageView imageView, String str, final boolean z) {
        ...
        if (!TextUtils.isEmpty(str)) {
            com.mbridge.msdk.foundation.same.c.b.a(imageView.getContext()).a(str, new c() {
                @Override
