...
public class MBridgeContainerView extends MBridgeBaseView implements e, g {
                ...
                this.n.setNotifyListener(new h(this.e) {
                    ...
                    public final void a(int i, Object obj) {
                        ...
                        if (i == 100) {
                            ...
                            c.a(pVar, MBridgeContainerView.this.a, MBridgeContainerView.this.w);
                        }
                    }
                });
    ...
    public void showOrderCampView() {
        ...
        this.R.setCampOrderViewBuildCallback(new com.mbridge.msdk.video.dynview.e.b() {
            @Override
            public final void a() {
    ...
    private void a(b bVar, Integer num) {
        ...
        if (this.b != null) {
            ...
            if (iIntValue != 1) {
                if (iIntValue == 3) {
                    if (this.t == null) {
                        this.t = new MBridgeVastEndCardView(this.a);
                    }
                ...
                if (iIntValue == 4) {
                    if (this.u == null) {
                        this.u = new MBridgeLandingPageView(this.a);
                    }
                ...
                if (iIntValue != 5) {
                    ...
                    if (this.q == null) {
                        if (this.b.isDynamicView()) {
                            ...
                            MBridgeNativeEndCardView mBridgeNativeEndCardView = new MBridgeNativeEndCardView(this.a, null, false, -1, this.b.getAdSpaceT() == 2, iC, this.b.getMof_tplid());
    ...
    private void i() {
        ...
        this.q = new MBridgeNativeEndCardView(this.a, null, true, i, this.b.getAdSpaceT() == 2, this.l, this.b.getMof_tplid());
