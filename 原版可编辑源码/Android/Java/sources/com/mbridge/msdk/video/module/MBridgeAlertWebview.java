...
public class MBridgeAlertWebview extends MBridgeH5EndCardView {
        ...
        if (this.f && this.b != null && !TextUtils.isEmpty(strA)) {
            ...
            this.q.setWebViewListener(new com.mbridge.msdk.mbjscommon.c.b() {
                ...
                public final void a(WebView webView, int i, String str, String str2) {
                    ...
                    e.a(MBridgeAlertWebview.this.a, MBridgeAlertWebview.this.b, MBridgeAlertWebview.this.y, MBridgeAlertWebview.this.v, 2, str, 1);
                ...
                public final void a(WebView webView, int i) {
                    ...
                    e.a(MBridgeAlertWebview.this.a, MBridgeAlertWebview.this.b, MBridgeAlertWebview.this.y, MBridgeAlertWebview.this.v, i, str, 1);
                }
            });
    ...
    public void webviewshow() {
        ...
        super.webviewshow();
        e.a(this.a, this.b, this.y, this.v, 2, 1);
    }
