        ...
        if (mBNativeAdvancedWebview3 != null) {
            ...
            this.b.post(new Runnable() {
                ...
                public final void run() {
                    try {
                        z.a(MBNativeAdvancedView.a, "webviewshow");
                        String string = "";
                        try {
                            int[] iArr2 = new int[2];
                            MBNativeAdvancedView.this.b.getLocationOnScreen(iArr2);
                            z.d(MBNativeAdvancedView.a, "coordinate:" + iArr2[0] + "--" + iArr2[1]);
                            JSONObject jSONObject = new JSONObject();
                            ...
                            z.c(MBNativeAdvancedView.a, th.getMessage(), th);
                        }
