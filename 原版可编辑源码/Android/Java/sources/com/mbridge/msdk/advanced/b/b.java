...
public final class b {
    ...
    private com.mbridge.msdk.advanced.c.a p = new com.mbridge.msdk.advanced.c.a() {
        @Override
    ...
    public final void a(final CampaignEx campaignEx, final MBNativeAdvancedView mBNativeAdvancedView, boolean z) {
        ...
        com.mbridge.msdk.foundation.b.b.a().a(this.k, new com.mbridge.msdk.foundation.b.a() {
            @Override
            public final void a() {
                String string;
                b.this.e();
            ...
            if (campaignEx5 != null) {
                try {
                    if (campaignEx5.isMraid()) {
                        ...
                        pVar.a(campaignEx5.isMraid() ? p.a : p.b);
    ...
    public final void a(final CampaignEx campaignEx, final boolean z, final String str) {
        ...
        this.f.a(new NativeListener.TrackingExListener() {
            @Override
    ...
    public final void e() {
        ...
        h.a().a((WebView) advancedNativeWebview, NativeAdvancedJsUtils.a, "");
    }
