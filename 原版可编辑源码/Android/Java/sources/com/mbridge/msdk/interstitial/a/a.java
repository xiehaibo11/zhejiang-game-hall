...
public final class a {
    ...
    public final void b() {
        if (this.a == null) {
            b(com.tkay.expressad.foundation.g.b.b.a);
            return;
        }
        if (TextUtils.isEmpty(this.b)) {
            b("unitid is null");
    ...
    private com.mbridge.msdk.foundation.same.net.g.d e() {
        ...
        com.mbridge.msdk.foundation.same.net.f.b.a(dVar, com.mbridge.msdk.foundation.same.net.g.d.a, strL);
    ...
    private String f() throws Throwable {
        ...
        strA = "";
        try {
            JSONArray jSONArrayA = ae.a(this.a, this.b);
                ...
                if (list.size() > 0) {
                    ...
                    for (int i = 0; i < list.size() && i < this.f && arrayList.size() < iQ; i++) {
                        ...
                        if (campaignEx != null && campaignEx.getOfferType() == 1 && TextUtils.isEmpty(campaignEx.getVideoUrlEncode())) {
                            ...
                            if (ae.b(campaignEx)) {
                                campaignEx.setRtinsType(ae.c(this.a, campaignEx.getPackageName()) ? 1 : 2);
                            }
                            if (campaignEx.getWtick() == 1 || !ae.c(this.a, campaignEx.getPackageName())) {
    ...
    private List<CampaignEx> b(List<CampaignEx> list) throws Throwable {
        File file;
    ...
    public class a implements Runnable {
        ...
        public final void run() {
            ...
            try {
                ...
                if (a.this.a != null && (iVarA = i.a(a.this.a)) != null) {
    ...
    static void a(a aVar, CampaignUnit campaignUnit) {
        ...
        if (ads != null && ads.size() > 0) {
            ...
            if (ads == null || ads.size() == 0 || aVar.k == null || aVar.a == null) {
    ...
    static void b(a aVar, List list) {
        ...
        l lVarA = l.a(i.a(aVar.a));
        boolean z = false;
        for (int i = 0; i < list.size(); i++) {
            CampaignEx campaignEx = (CampaignEx) list.get(i);
            if (campaignEx != null) {
                if (ae.c(aVar.a, campaignEx.getPackageName())) {
