...
public class MBAcquireRewardPopView extends RelativeLayout {
    ...
    static int i(MBAcquireRewardPopView mBAcquireRewardPopView) {
    ...
    static void a(MBAcquireRewardPopView mBAcquireRewardPopView, final View view) {
    ...
    static View e(MBAcquireRewardPopView mBAcquireRewardPopView) {
        String str;
    ...
    static View f(MBAcquireRewardPopView mBAcquireRewardPopView) {
        LinearLayout linearLayout = new LinearLayout(mBAcquireRewardPopView.getContext());
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(13);
        linearLayout.setLayoutParams(layoutParams);
    ...
    static void a(MBAcquireRewardPopView mBAcquireRewardPopView, View view, View view2) {
