...
public final class c {
    ...
    private void b(final CampaignEx campaignEx, final int i, final boolean z) {
    ...
    public final void a(int i, int i2, int i3, int i4) {
        try {
            ...
            if (this.n != null) {
                h.a().a((WebView) this.n, "oncutoutfetched", Base64.encodeToString(m.a(com.tkay.expressad.video.bt.a.c.a, i, i2, i3, i4).getBytes(), 0));
            }
        } catch (Throwable th) {
            z.d(b, th.getMessage());
        }
