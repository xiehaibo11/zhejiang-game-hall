...
public class MBSplashNativeView extends RelativeLayout {
    ...
    public MBSplashNativeView(Context context, MBSplashView mBSplashView, c cVar) {
        ...
        try {
            ...
            addView(viewInflate);
            this.a = (MBNoRecycledCrashImageView) viewInflate.findViewById(s.a(getContext().getApplicationContext(), "mbridge_splash_iv_image_bg", "id"));
        ...
        if (!TextUtils.isEmpty(this.M.getImageUrl())) {
            com.mbridge.msdk.foundation.same.c.b.a(com.mbridge.msdk.foundation.controller.a.f().j()).a(this.M.getImageUrl(), new com.mbridge.msdk.foundation.same.c.c() {
                @Override
                    ...
                    if (bitmap != null) {
                        try {
                            ...
                            try {
                                ...
                                MBSplashNativeView.this.a.setScaleType(ImageView.ScaleType.CENTER_CROP);
                                MBSplashNativeView.this.a.setImageBitmap(bitmapA3);
        ...
        this.p.setOnClickListener(new View.OnClickListener() {
            ...
            public final void onClick(View view) {
                ...
                e.a().a("", MBSplashNativeView.this.M, MBSplashNativeView.this.getContext(), MBSplashNativeView.this.J, new com.mbridge.msdk.widget.dialog.a() {
                    @Override
                    public final void a() {
                        MBSplashNativeView.a(MBSplashNativeView.this, 0);
                    }
        ...
        if (this.w == 1) {
            ...
            this.R = new b(this.x, this.y * 1000) {
                @Override
                public final void a() {
    ...
    static void g(MBSplashNativeView mBSplashNativeView) {
        if (!TextUtils.isEmpty(mBSplashNativeView.M.getIconUrl())) {
            com.mbridge.msdk.foundation.same.c.b.a(com.mbridge.msdk.foundation.controller.a.f().j()).a(mBSplashNativeView.M.getIconUrl(), new com.mbridge.msdk.foundation.same.c.c() {
                @Override
                public final void onSuccessLoad(Bitmap bitmap, String str) {
                    Bitmap bitmapA;
                    if (bitmap != null) {
    ...
    static void a(MBSplashNativeView mBSplashNativeView, int i) {
    ...
    static void c(MBSplashNativeView mBSplashNativeView, boolean z) {
        if (mBSplashNativeView.L.getSplashJSBridgeImpl() == null || mBSplashNativeView.L.getSplashJSBridgeImpl().a() == null) {
            return;
        }
