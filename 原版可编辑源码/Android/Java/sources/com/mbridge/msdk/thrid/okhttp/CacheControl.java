        ...
        while (i2 < size) {
            ...
            if (!strName.equalsIgnoreCase("Cache-Control")) {
                ...
                for (i = 0; i < strValue.length(); i = iSkipUntil) {
                    ...
                    if (HeaderConstants.CACHE_CONTROL_NO_CACHE.equalsIgnoreCase(strTrim2)) {
                        z2 = true;
                    } else if (HeaderConstants.CACHE_CONTROL_NO_STORE.equalsIgnoreCase(strTrim2)) {
                        z3 = true;
                        ...
                        z4 = true;
                    } else if (HeaderConstants.PUBLIC.equalsIgnoreCase(strTrim2)) {
                        z5 = true;
                    } else if (HeaderConstants.CACHE_CONTROL_MUST_REVALIDATE.equalsIgnoreCase(strTrim2)) {
                        z6 = true;
                    } else if (HeaderConstants.CACHE_CONTROL_MAX_STALE.equalsIgnoreCase(strTrim2)) {
                        seconds3 = HttpHeaders.parseSeconds(strTrim, Integer.MAX_VALUE);
                    } else if (HeaderConstants.CACHE_CONTROL_MIN_FRESH.equalsIgnoreCase(strTrim2)) {
