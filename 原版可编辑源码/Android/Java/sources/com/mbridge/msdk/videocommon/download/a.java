...
public final class a implements Serializable {
    ...
    private int F = 1;
    private OnDownloadStateListener N = new OnDownloadStateListener() {
        @Override
    ...
    private OnProgressStateListener O = new OnProgressStateListener() {
        @Override
    ...
    private OnDownloadStateListener P = new OnDownloadStateListener() {
        @Override
        public final void onCancelDownload(DownloadMessage downloadMessage) {
        }
        ...
        public final void onDownloadComplete(DownloadMessage downloadMessage) {
            try {
                ...
                try {
                    ...
                    com.mbridge.msdk.foundation.same.f.b.b().execute(new a(a.this.j.getId(), a.this.n, a.this.k, a.this.p, a.this.j.getRequestId(), a.this.j.getRequestIdNotice()));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            } catch (Exception e2) {
    ...
    private OnProgressStateListener Q = new OnProgressStateListener() {
        @Override
        public final void onProgress(DownloadMessage downloadMessage, DownloadProgress downloadProgress) {
            try {
                a.this.p = downloadProgress.getCurrent();
    ...
    public a(Context context, CampaignEx campaignEx, String str, int i) {
        ...
        this.x = x.d(this.n);
        this.o = e.b(com.mbridge.msdk.foundation.same.b.c.c) + File.separator;
        this.q = this.o + this.x;
        this.a = ab.a().a("u_n_d_r_r", false);
    ...
    private void c(String str) {
        ...
        try {
            ...
            aVar.post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, dVarA, null);
        } catch (Exception e) {
            z.d("CampaignDownLoadTask", e.getMessage());
        }
    }
    ...
    private static final class a implements Runnable {
        ...
        public final void run() {
            ...
            if (TextUtils.isEmpty(this.c) || TextUtils.isEmpty(this.b) || TextUtils.isEmpty(this.a) || TextUtils.isEmpty(this.e) || TextUtils.isEmpty(this.f) || this.d <= 0) {
                return;
            }
            try {
            ...
            if (com.mbridge.msdk.foundation.same.report.b.a().c()) {
                ...
                try {
                    new com.mbridge.msdk.foundation.same.report.d.a(com.mbridge.msdk.foundation.controller.a.f().j()).post(0, com.mbridge.msdk.foundation.same.net.f.d.a().a, dVarA, new com.mbridge.msdk.foundation.same.report.d.b() {
                        @Override
