...
public class NativeController {
    ...
    public NativeController(com.mbridge.msdk.mbnative.c.a aVar, NativeListener.NativeTrackingListener nativeTrackingListener, Map<String, Object> map, Context context) {
        ...
        try {
            ...
            this.a = listR;
            List<Campaign> listB = (listR == null || listR.size() <= 0 || !this.a.contains(1) || (bVarA = com.mbridge.msdk.mbnative.a.f.a(1)) == null) ? null : bVarA.b(str2, iA);
            if (listB != null) {
    ...
    public final void a(int i, String str) {
        ...
        if (this.a.contains(1) && i == 0 && this.a.get(0).intValue() != 1) {
            int iIntValue = this.a.get(0).intValue();
    ...
    public final synchronized void a(int i, long j, int i2, String str) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(this.n)) {
                ...
                if (i == 1 && !com.mbridge.msdk.click.b.a) {
                    dVar.a("tnum", this.M + "");
                }
            } else if (i == 1 && !com.mbridge.msdk.click.b.a) {
                dVar.a("tnum", this.s + "");
            }
            if (i == 1 && !TextUtils.isEmpty(this.N)) {
                dVar.a("ttc_ids", this.N);
            }
            String strA = com.mbridge.msdk.foundation.same.a.d.a(this.j, com.tkay.expressad.foundation.g.a.f.a);
    ...
    public final void a(Campaign campaign, View view, List<View> list) {
        try {
            ...
            com.mbridge.msdk.foundation.same.a.d.a(this.j, campaignEx, com.tkay.expressad.foundation.g.a.f.a);
            if (campaignEx != null) {
                if (view != null) {
    ...
    public final void a(Campaign campaign, View view) {
        try {
            ...
            com.mbridge.msdk.foundation.same.a.d.a(this.j, campaignEx, com.tkay.expressad.foundation.g.a.f.a);
            if (campaignEx != null) {
                com.mbridge.msdk.widget.a aVar = new com.mbridge.msdk.widget.a() {
                    @Override
                    protected final void a(View view2) {
                        NativeController.a(NativeController.this, view2.getContext(), campaignEx);
                    }
        ...
        try {
            ...
            fVar.setonStateChangeListener(new a.b() {
                ...
                public final void a(a.a aVar) {
                    if (aVar != a.a.e || NativeController.this.K == null || NativeController.this.K.size() <= 0 || !NativeController.this.K.contains(fVar)) {
                        return;
                    }
            ...
            if (campaignUnit != null && campaignUnit.getAds() != null && campaignUnit.getAds().size() > 0) {
                ...
                if (arrayList.size() == 0) {
                    if (NativeController.this.x || type != 1) {
                        NativeController.this.a(com.tkay.expressad.reward.a.d.a, b(), a());
                        return;
                    }
                    return;
                }
    ...
    private void a(final List<Campaign> list, final int i, final NativeListener.NativeAdListener nativeAdListener) {
    ...
    private List<Campaign> a(int i, List<Campaign> list) {
    ...
    private void a(final long j, final int i, final boolean z, final String str, final String str2) {
        ...
        final com.mbridge.msdk.foundation.same.e.a aVar = new com.mbridge.msdk.foundation.same.e.a() {
            @Override
            public final void cancelTask() {
            }
        ...
        public final void onSuccess(String str) {
            try {
                if (this.d) {
                    ...
                    p pVar = new p(r.k, 20, jCurrentTimeMillis + "", str, this.b.getId(), this.a, "", "2");
        ...
        public final void onFailed(String str, String str2) {
            try {
                if (this.d) {
                    long jCurrentTimeMillis = System.currentTimeMillis() - this.c;
                    com.mbridge.msdk.foundation.db.t.a(i.a(com.mbridge.msdk.foundation.controller.a.f().j()));
                    p pVar = new p(r.k, 21, jCurrentTimeMillis + "", str, this.b.getId(), this.a, str2, "2");
                    pVar.k(this.b.getRequestId());
                    pVar.l(this.b.getRequestIdNotice());
                    if (this.b != null && !TextUtils.isEmpty(this.b.getId())) {
                        pVar.n(this.b.getId());
        ...
        public final void onSuccess(String str) {
            try {
                if (this.d) {
                    long jCurrentTimeMillis = System.currentTimeMillis() - this.c;
                    com.mbridge.msdk.foundation.db.t.a(i.a(com.mbridge.msdk.foundation.controller.a.f().j()));
                    p pVar = new p(r.k, 14, jCurrentTimeMillis + "", str, this.b.getId(), this.a, "", "1");
                    if (this.b != null && !TextUtils.isEmpty(this.b.getId())) {
                        pVar.n(this.b.getId());
                    }
                    if (this.b != null) {
        ...
        public final void onFailed(String str, String str2) {
            try {
                if (this.d) {
                    long jCurrentTimeMillis = System.currentTimeMillis() - this.c;
                    com.mbridge.msdk.foundation.db.t.a(i.a(com.mbridge.msdk.foundation.controller.a.f().j()));
                    p pVar = new p(r.k, 3, jCurrentTimeMillis + "", str2, this.b.getId(), this.a, str, "1");
                    if (this.b != null && !TextUtils.isEmpty(this.b.getId())) {
                        pVar.n(this.b.getId());
                    }
                    if (this.b != null) {
    ...
    */
    static void a(NativeController nativeController, Context context, final CampaignEx campaignEx) {
        if (campaignEx != null) {
            try {
            } catch (Throwable th) {
                z.a(e, th.getMessage());
    ...
    static void a(NativeController nativeController, final CampaignEx campaignEx, View view, List list, AdSession adSession) {
        try {
            ...
            com.mbridge.msdk.mbnative.controller.a aVar2 = new com.mbridge.msdk.mbnative.controller.a(list, aVar, new Handler(Looper.getMainLooper()));
            aVar2.a(view);
            if (nativeController.I != null) {
                nativeController.I.add(aVar2);
            }
            if (nativeController.J != null) {
                nativeController.J.add(aVar);
            }
            if (adSession != null) {
    ...
    static void b(NativeController nativeController, List list) {
        if (list != null) {
            try {
                if (list.size() > 0) {
                    z.b(e, "===创建下载任务");
    ...
    static List a(NativeController nativeController, List list, boolean z) {
        if (list != null) {
            for (int size = list.size() - 1; size >= 0; size--) {
