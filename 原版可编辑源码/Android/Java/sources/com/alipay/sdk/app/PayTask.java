...
public class PayTask {
    ...
    public class c {
        ...
        public c(PayTask payTask, a aVar) {
            this();
        }
    }
    ...
    */
    private synchronized String a(com.alipay.sdk.m.s.a aVar, String str, boolean z) {
        String strA;
        if (z) {
            showLoading();
            ...
            strA = "";
            try {
                com.alipay.sdk.m.u.e.d(com.alipay.sdk.m.l.a.A, "pay prepared: " + str);
                strA = a(str, aVar);
                com.alipay.sdk.m.u.e.d(com.alipay.sdk.m.l.a.A, "pay raw result: " + strA);
                com.alipay.sdk.m.u.i.a(aVar, this.a.getApplicationContext(), strA);
            ...
            dismissLoading();
            com.alipay.sdk.m.k.a.b(this.a.getApplicationContext(), aVar, str, aVar.d);
            com.alipay.sdk.m.u.e.d(com.alipay.sdk.m.l.a.A, "pay returning: " + strA);
        } else {
            if (str.contains("payment_inst=")) {
            }
            if (str.contains("service=alipay.acquire.mr.ord.createandpay")) {
    ...
    private String a(String str, com.alipay.sdk.m.s.a aVar) {
        ...
        if (n.a(aVar, (Context) this.a, listL, true)) {
            ...
            if (!TextUtils.isEmpty(strA2)) {
                if (strA2.contains("resultStatus={" + com.alipay.sdk.m.j.c.g.b() + "}")) {
                    n.a("alipaySdk", com.alipay.sdk.m.l.b.q, this.a, aVar);
                    if (com.alipay.sdk.m.m.a.D().A()) {
                        strA2 = hVar.a(strA, true);
                    } else {
                        strA2 = strA2.replace("resultStatus={" + com.alipay.sdk.m.j.c.g.b() + "}", "resultStatus={" + com.alipay.sdk.m.j.c.e.b() + "}");
                    }
                }
            }
            ...
            if (!TextUtils.equals(strA2, "failed") && !TextUtils.equals(strA2, "scheme_failed") && (!zW || !aVar.e())) {
                ...
                return a(aVar, strA, listL, strA2, this.a);
            }
    ...
    private String a(com.alipay.sdk.m.s.a aVar, String str) {
        ...
        try {
            try {
                try {
                    JSONObject jSONObjectC = new com.alipay.sdk.m.q.f().a(aVar, this.a.getApplicationContext(), str).c();
                    ...
                    for (int i2 = 0; i2 < listA.size(); i2++) {
                        if (listA.get(i2).a() == com.alipay.sdk.m.r.a.d) {
                    ...
                    for (int i3 = 0; i3 < listA.size(); i3++) {
                        ...
                        if (bVar.a() == com.alipay.sdk.m.r.a.c) {
                            String strA = a(aVar, bVar);
                            dismissLoading();
                            com.alipay.sdk.m.k.a.a(this.a, aVar, str, aVar.d);
                            return strA;
                        }
                        if (bVar.a() == com.alipay.sdk.m.r.a.e) {
        ...
        try {
            ...
            if (zC) {
                ...
                for (i2 = 0; i2 < listA.size(); i2++) {
                    ...
                    if (bVar2.a() == com.alipay.sdk.m.r.a.f) {
