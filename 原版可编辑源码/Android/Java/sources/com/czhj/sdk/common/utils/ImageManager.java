...
public class ImageManager {
    ...
    public class RequestCreatorRunnable implements Runnable {
        ...
        private void b() {
            ImageManager.this.f.post(new Runnable() {
                @Override
                public void run() {
        ...
        public void into(ImageView imageView) {
            ...
            Bitmap bitmap = (Bitmap) ImageManager.this.e.get(this.a);
            if (bitmap != null) {
            ...
            if (bitmapA == null) {
                ...
                ImageManager.this.e.put(this.a, bitmapA);
            }
        }
        ...
        public void run() {
            try {
                ...
                if (httpURLConnection.getResponseCode() == 200) {
                    ...
                    ImageManager.this.e.put(this.a, bitmapDecodeStream);
                    bitmapDecodeStream.compress(Bitmap.CompressFormat.PNG, 100, new FileOutputStream(new File(ImageManager.this.a(), Md5Util.md5(this.a.substring(this.a.lastIndexOf("/") + 1)))));
                } else {
                    b();
                }
