...
public class IdentifierManager {
    ...
    private static synchronized void a(Context context, AdvertisingId advertisingId) {
        ...
        editorEdit.putLong(f, advertisingId.a.getTimeInMillis());
        editorEdit.apply();
    }
        ...
        if (d()) {
            ...
            if (advertisingIdInfo != null) {
                ...
                if (advertisingIdInfo.limitAdTracking && advertisingId.b()) {
                    ...
                    a(advertisingIdInfo.advertisingId, advertisingId.b, advertisingIdInfo.limitAdTracking, advertisingId.a.getTimeInMillis());
                }
            }
        }
    }
