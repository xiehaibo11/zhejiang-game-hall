...
public class a extends com.sigmob.sdk.base.common.h implements Serializable {
    ...
    public static a f(BaseAdUnit baseAdUnit) {
        ...
        aVar.c(baseAdUnit.getMaterial().creative_type.intValue() != com.sigmob.sdk.base.common.l.e.a());
    ...
    public static h g(BaseAdUnit baseAdUnit) {
        ...
        return new h(768, 1024, baseAdUnit.getInteractionType(), material.landing_page, material.deeplink_url, new com.sigmob.sdk.base.views.k(baseAdUnit.resourcePath(), baseAdUnit.getCreativeResourceType(), material.click_type.intValue() == 2 ? k.a.b : k.a.c, 720, 1024));
    }
