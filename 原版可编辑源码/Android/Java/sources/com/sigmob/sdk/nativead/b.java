...
public class b extends com.sigmob.sdk.base.common.h {
    ...
    public void a(BaseAdUnit baseAdUnit, final int i, final int i2) {
        com.sigmob.sdk.base.common.z.a(PointCategory.VIDEO_START, (String) null, baseAdUnit, new z.a() {
            @Override
    ...
    public void a(BaseAdUnit baseAdUnit, final int i, final int i2, final int i3) {
        com.sigmob.sdk.base.common.z.a(PointCategory.VIDEO_PAUSE, (String) null, baseAdUnit, new z.a() {
            @Override
            public void a(Object obj) {
                if (obj instanceof PointEntitySigmob) {
                    HashMap map = new HashMap();
        ...
        macroCommon.addMarcoKey(SigMacroCommon._ENDTIME_, String.valueOf(i));
        macroCommon.addMarcoKey(SigMacroCommon._ENDTIME_, String.valueOf(i));
        com.sigmob.sdk.base.network.f.a(baseAdUnit, com.sigmob.sdk.base.common.a.R);
    }
    ...
    public void b(BaseAdUnit baseAdUnit) {
        ...
        arrayList.add(new com.sigmob.sdk.videoAd.f(g.a.b, com.sigmob.sdk.base.common.a.n, 0.25f));
        arrayList.add(new com.sigmob.sdk.videoAd.f(g.a.b, com.sigmob.sdk.base.common.a.o, 0.5f));
        arrayList.add(new com.sigmob.sdk.videoAd.f(g.a.b, com.sigmob.sdk.base.common.a.p, 0.75f));
        a(arrayList);
    }
