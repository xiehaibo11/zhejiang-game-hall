...
public class t implements d.a {
    ...
    private void a(final List<WindNativeAdData> list, final int i, final String str) {
        this.g = false;
    ...
    public void a(final List<BaseAdUnit> list, LoadAdRequest loadAdRequest) {
        ...
        com.sigmob.sdk.base.common.z.a(PointCategory.RESPOND, "1", (BaseAdUnit) null, loadAdRequest, new z.a() {
            @Override
