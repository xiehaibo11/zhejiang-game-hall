...
public class b {
    ...
    private static class a implements AdLifecycleManager.LifecycleListener {
        ...
        a() {
            ...
            SigmobLog.i("session_start: " + this.b + Constants.COLON_SEPARATOR + this.a);
        ...
        public void onDestroy(Activity activity) {
            ...
            if (this.c.size() == 0 && this.f) {
                ...
                SigmobLog.i("onActivityDestroyed session_end: " + jCurrentTimeMillis + Constants.COLON_SEPARATOR + this.a + Constants.COLON_SEPARATOR + j);
        ...
        public void onResume(Activity activity) {
            ...
            if (!this.f || this.h) {
                ...
                this.b = System.currentTimeMillis();
                this.f = true;
                SigmobLog.i("onActivityResumed session_start: " + this.b + Constants.COLON_SEPARATOR + this.a);
                PointEntityActive.ActiveTracking(PointCategory.SESSION_START, this.a, "0", String.valueOf(this.b));
            }
        }
        ...
        public void onStop(Activity activity) {
            ...
            if (activity.getClass().getSimpleName().equals(this.d)) {
                if (!this.g || this.c.size() == 1) {
                    long jCurrentTimeMillis = System.currentTimeMillis();
                    long j = (jCurrentTimeMillis - this.b) / 1000;
                    SigmobLog.i("onActivityStopped session_end: " + jCurrentTimeMillis + Constants.COLON_SEPARATOR + this.a + Constants.COLON_SEPARATOR + j);
                    PointEntityActive.ActiveTracking(PointCategory.SESSION_END, this.a, String.valueOf(j), String.valueOf(jCurrentTimeMillis));
                    this.b = System.currentTimeMillis();
                    this.f = false;
                }
    ...
    public static void a(Context context) {
        if (b == null) {
            ...
            if (options == null || options.getCustomController() == null) {
                ...
                ClientMetadata.getInstance().initializeWithController(b, new CustomController() {
                    @Override
