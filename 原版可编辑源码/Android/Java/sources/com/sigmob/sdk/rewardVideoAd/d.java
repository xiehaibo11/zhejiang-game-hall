...
public class d implements f.b, d.a, e.a {
    ...
    private void a(BaseAdUnit baseAdUnit, String str, final int i, final String str2, final String str3, WindAdError windAdError) {
        z.a(str, windAdError, baseAdUnit, new z.a() {
            @Override
    ...
    private void b(LoadAdRequest loadAdRequest) {
        a(loadAdRequest, a.b, new d.a() {
            @Override
            ...
            public void a(final List<BaseAdUnit> list, LoadAdRequest loadAdRequest2) {
                ...
                d.this.e = list;
                z.a(PointCategory.RESPOND, "1", (BaseAdUnit) null, loadAdRequest2, new z.a() {
                    @Override
                    public void a(Object obj) {
                ...
                f.b bVar = new f.b() {
                    ...
                    public void a(BaseAdUnit baseAdUnit2) {
                        ...
                        com.sigmob.sdk.base.network.f.a(baseAdUnit2, com.sigmob.sdk.base.common.a.y);
                    }

                    @Override
                    public void a(BaseAdUnit baseAdUnit2, String str) {
                        com.sigmob.sdk.base.network.f.a(baseAdUnit2, TextUtils.isEmpty(str) ? com.sigmob.sdk.base.common.a.z : com.sigmob.sdk.base.common.a.A);
                        d.this.a.removeMessages(8193);
                ...
                if (baseAdUnit.getCreativeType() == l.i.a()) {
    ...
    private void c(final WindAdError windAdError) {
    ...
    */
    private e k(BaseAdUnit baseAdUnit) {
        boolean z;
        String message;
        ...
        } else if (this.d != AdStatus.AdStatusReady) {
            message = "ad status is not ready";
        } else if (e()) {
            message = "ad unit is expired";
        } else {
            if (j(baseAdUnit)) {
                z = true;
                if (!z) {
                ...
                a(windAdError);
                z.a(PointCategory.PLAY, windAdError, baseAdUnit, this.i);
                return null;
            }
            message = "check ad unit endcard is invalid";
        }
    ...
    public void a(BaseAdUnit baseAdUnit) {
        ...
        com.sigmob.sdk.base.network.f.a(baseAdUnit, com.sigmob.sdk.base.common.a.y);
    }

    @Override
    public void a(BaseAdUnit baseAdUnit, String str) {
        SigmobLog.d("onInterstitialLoaded() called");
        com.sigmob.sdk.base.network.f.a(baseAdUnit, TextUtils.isEmpty(str) ? com.sigmob.sdk.base.common.a.z : com.sigmob.sdk.base.common.a.A);
    ...
    void a(LoadAdRequest loadAdRequest) {
        ...
        if (!a()) {
            ...
            this.a.sendEmptyMessageDelayed(8193, i.a().p());
            a(loadAdRequest, a.c, this);
            return;
        }
        this.j++;
    ...
    public void a(LoadAdRequest loadAdRequest, g gVar) {
        ...
        if (this.f.getCreativeType() == l.i.a()) {
        ...
        if (list != null) {
            try {
                if (list.size() > 0) {
                    BaseAdUnit baseAdUnit = list.get(0);
                    this.e = list;
                    z.a(PointCategory.RESPOND, "1", (BaseAdUnit) null, loadAdRequest, new z.a() {
                        @Override
                        public void a(Object obj) {
                            if (obj instanceof PointEntitySigmob) {
                                HashMap map = new HashMap();
