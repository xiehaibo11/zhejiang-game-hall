...
public final class i extends RelativeLayout {
    ...
    private void a(final BaseAdUnit baseAdUnit, final String str) {
        ...
        new ag.a().a(af.a, af.e, af.d, af.f, af.c, af.b).a(new ag.b() {
            @Override
            public void a(final String str2, af afVar) {
                ...
                if (i == 2 || i == 3) {
                    ...
                    if (i == 4) {
                        ...
                        z.a("open_market", (String) null, i.this.f, new z.a() {
                            @Override
                            public void a(Object obj) {
                                if (obj instanceof PointEntitySigmob) {
                ...
                com.sigmob.sdk.base.network.f.a(i.this.f, com.sigmob.sdk.base.common.a.c);
    ...
    private void b(final Context context) {
        ...
        int iDipsToIntPixels = Dips.dipsToIntPixels(a, this.d);
    ...
    public void a(Context context) {
        ...
        imageView.setImageBitmap(o.i.a());
    ...
    protected void onAttachedToWindow() {
        ...
        this.g.a(ViewUtil.getActivityFromViewTop(this), this.f, new q.b() {
            @Override
            public void a() {
                i.this.t = false;
                if (i.this.v) {
