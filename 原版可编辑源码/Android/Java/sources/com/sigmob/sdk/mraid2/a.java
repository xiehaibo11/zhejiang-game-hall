...
abstract class a extends WebView {
    public static HashMap<String, com.sigmob.sdk.mraid.i> a = new LinkedHashMap();
    ...
    public void a(BaseAdUnit baseAdUnit) {
        ...
        APKStatusBroadcastReceiver aPKStatusBroadcastReceiver = new APKStatusBroadcastReceiver(new m.a() {
            @Override
    ...
    public void destroy() {
        ...
        HashMap<String, com.sigmob.sdk.mraid.i> map2 = a;
        if (map2 != null && map2.size() > 0) {
            for (com.sigmob.sdk.mraid.i iVar : a.values()) {
                if (iVar != null) {
                    iVar.c();
                }
            }
