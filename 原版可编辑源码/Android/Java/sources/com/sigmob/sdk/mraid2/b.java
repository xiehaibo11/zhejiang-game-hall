...
public class b {
    ...
    static class a {
        ...
        public String addDclog(JSONObject jSONObject) {
            try {
                ...
                z.a(strOptString, baseAdUnitB, baseAdUnitB == null ? a().j() : null, new z.a() {
                    @Override
    ...
    private BidResponse a(List<BaseAdUnit> list) {
        ...
        try {
            ...
            switch (b2) {
                ...
                case 1:
                    ...
                    bVar.a().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                ...
                case 2:
                    ...
                    if (this.b.get(0) != null) {
                        ...
                        com.sigmob.sdk.base.network.d.a(adRequest, new d.a() {
                            @Override
                            public void a(int i, String str2, String str3, LoadAdRequest loadAdRequest) {
                                Log.d(b.a, "-----------onErrorResponse---------" + i + Constants.COLON_SEPARATOR + str2);
                            ...
                            public void a(final List<BaseAdUnit> list, LoadAdRequest loadAdRequest) {
                                ...
                                z.a(PointCategory.RESPOND, "1", (BaseAdUnit) null, new z.a() {
                                    @Override
                                    public void a(Object obj) {
                                        if (obj instanceof PointEntitySigmob) {
