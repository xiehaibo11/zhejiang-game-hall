...
public class e extends com.sigmob.sdk.mraid2.a {
    ...
    public e(Context context, List<BaseAdUnit> list, FrameLayout frameLayout, e eVar, JSONObject jSONObject) {
        ...
        this.t = new b.b() {
            ...
            public void a(String str, JSONObject jSONObject2) {
                ...
                com.sigmob.sdk.mraid.i iVar = com.sigmob.sdk.mraid2.a.a.get(strOptString2);
                ...
                switch (str) {
                    case "init":
                        ...
                        com.sigmob.sdk.mraid2.a.a.put(strOptString2, nVar2);
                        break;
                    case "assetURL":
                        if (nVar != null) {
                            nVar.a(jSONObject2);
            ...
            */
            public void a(JSONObject jSONObject2) {
                ...
                String str;
                int i;
                Log.d(e.o, "----------onAnimationEvent-------------" + jSONObject2.toString());
                final String strOptString2 = jSONObject2.optString("event");
                String strOptString3 = jSONObject2.optString("uniqueId");
                double dOptDouble = jSONObject2.optDouble(r.ag);
                JSONObject jSONObjectOptJSONObject = jSONObject2.optJSONObject("from");
                JSONObject jSONObjectOptJSONObject2 = jSONObject2.optJSONObject(RemoteMessageConst.TO);
                if (jSONObjectOptJSONObject != null) {
                    iDipsToIntPixels2 = Dips.dipsToIntPixels(jSONObjectOptJSONObject.optInt("x"), e.this.getContext());
                    iDipsToIntPixels3 = Dips.dipsToIntPixels(jSONObjectOptJSONObject.optInt("y"), e.this.getContext());
                    iDipsToIntPixels4 = Dips.dipsToIntPixels(jSONObjectOptJSONObject.optInt("w"), e.this.getContext());
                    iDipsToIntPixels = Dips.dipsToIntPixels(jSONObjectOptJSONObject.optInt(at.g), e.this.getContext());
                } else {
                    iDipsToIntPixels = 0;
                    iDipsToIntPixels2 = 0;
                    iDipsToIntPixels3 = 0;
                ...
                if (jSONObjectOptJSONObject2 != null) {
                    iDipsToIntPixels8 = Dips.dipsToIntPixels(jSONObjectOptJSONObject2.optInt("x"), e.this.getContext());
                    iDipsToIntPixels7 = Dips.dipsToIntPixels(jSONObjectOptJSONObject2.optInt("y"), e.this.getContext());
                    iDipsToIntPixels6 = Dips.dipsToIntPixels(jSONObjectOptJSONObject2.optInt("w"), e.this.getContext());
                    iDipsToIntPixels5 = Dips.dipsToIntPixels(jSONObjectOptJSONObject2.optInt(at.g), e.this.getContext());
                } else {
                    iDipsToIntPixels5 = 0;
                    iDipsToIntPixels6 = 0;
                    iDipsToIntPixels7 = 0;
                ...
                com.sigmob.sdk.mraid.i iVar = com.sigmob.sdk.mraid2.a.a.get(strOptString3);
                if (iVar != null) {
                    iVar.a(e.this.e);
                    View viewB = iVar.b();
                    if (viewB != null) {
                        ...
                        d dVar = new d(viewB);
                        str = "height";
                        animatorSet.playTogether(ObjectAnimator.ofFloat(viewB, "translationX", iDipsToIntPixels2, iDipsToIntPixels8), ObjectAnimator.ofFloat(viewB, "translationY", iDipsToIntPixels3, iDipsToIntPixels7), ObjectAnimator.ofInt(dVar, "width", iDipsToIntPixels4, iDipsToIntPixels6), ObjectAnimator.ofInt(dVar, str, iDipsToIntPixels, iDipsToIntPixels5));
                ...
                e eVar2 = (e) e.this.r.get(strOptString3);
                if (eVar2 != null) {
                    AnimatorSet animatorSet2 = new AnimatorSet();
                    d dVar2 = new d(eVar2);
                    animatorSet2.playTogether(ObjectAnimator.ofFloat(eVar2, "translationX", iDipsToIntPixels2, iDipsToIntPixels8), ObjectAnimator.ofFloat(eVar2, "translationY", iDipsToIntPixels3, iDipsToIntPixels7), ObjectAnimator.ofInt(dVar2, "width", iDipsToIntPixels4, iDipsToIntPixels6), ObjectAnimator.ofInt(dVar2, str, iDipsToIntPixels, i));
    ...
    private void d(String str) {
        ...
        p.a().add(downloadItem, new FileDownloadRequest.FileDownloadListener() {
            @Override
