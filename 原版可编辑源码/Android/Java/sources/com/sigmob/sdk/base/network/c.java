...
public class c {
    ...
    public static class b {
        ...
        public a a(byte[] bArr) {
            ...
            aVar.a = aVar.a.replace(this.d, this.b);
            if (this.a == -1) {
                strReplace = aVar.a.replace(Constants.COLON_SEPARATOR + this.c, "");
            } else {
                strReplace = aVar.a.replace(Constants.COLON_SEPARATOR + this.c, Constants.COLON_SEPARATOR + this.a);
            }
            aVar.a = strReplace;
            if (!aVar.a.contains(c.i)) {
                aVar.a = aVar.a.replace(c.c, "\r\nRange: bytes=0-\r\n\r\n");
            }
            Log.e(c.h, aVar.a);
            int iIndexOf = aVar.a.indexOf(c.i) + 13;
            String strSubstring = aVar.a.substring(iIndexOf, aVar.a.indexOf(Constants.ACCEPT_TIME_SEPARATOR_SERVER, iIndexOf));
