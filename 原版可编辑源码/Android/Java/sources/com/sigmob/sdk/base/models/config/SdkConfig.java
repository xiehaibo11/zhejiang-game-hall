...
public final class SdkConfig extends AndroidMessage<SdkConfig, Builder> {
    ...
    public static final class Builder extends Message.Builder<SdkConfig, Builder> {
        ...
        public Builder android_config(Android android) {
    ...
    public SdkConfig(Common common, Android android) {
        this(common, android, ByteString.EMPTY);
    }

    public SdkConfig(Common common, Android android, ByteString byteString) {
    ...
    public int hashCode() {
        ...
        Android android = this.android_config;
        int iHashCode3 = iHashCode2 + (android != null ? android.hashCode() : 0);
