...
public class PluginManagerServer {
    ...
    private List<PluginInfo> updateAllLocked() throws Throwable {
        updateAllIfNeeded();
        return this.mList.cloneList();
    }

    private void traceInstallPlugin(String str, boolean z) {
    ...
    private PluginInfo installLocked(String str, boolean z) throws Throwable {
    ...
    private void updateUsedLocked(String str, boolean z) throws Throwable {
    ...
    private boolean uninstallLocked(PluginInfo pluginInfo) {
        if (pluginInfo == null) {
            return false;
        }
        if (RePlugin.isPluginRunning(pluginInfo.getName())) {
    ...
    private boolean isPluginRunningLocked(String str, String str2) {
    ...
    private void syncRunningPluginsLocked(PluginRunningList pluginRunningList) {
    ...
    private void addToRunningPluginsLocked(String str, int i, String str2) {
    ...
    private String[] getRunningProcessesByPluginLocked(String str) {
