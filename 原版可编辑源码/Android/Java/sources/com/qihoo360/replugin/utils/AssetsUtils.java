...
public class AssetsUtils {
    ...
    public static final boolean quickExtractTo(Context context, PluginInfo pluginInfo, String str, String str2, String str3) {
        int i = 1.$SwitchMap$com$qihoo360$replugin$utils$AssetsUtils$QuickExtractResult[quickExtractTo(context, pluginInfo.getPath(), str, str2, str3).ordinal()];
        if (i == 1) {
            return false;
        }
        if (i != 2) {
     ...
     */
    static class 1 {
        static final int[] $SwitchMap$com$qihoo360$replugin$utils$AssetsUtils$QuickExtractResult;
