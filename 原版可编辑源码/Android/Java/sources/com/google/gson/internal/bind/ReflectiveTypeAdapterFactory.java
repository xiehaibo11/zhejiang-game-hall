        ...
        while (raw2 != Object.class) {
            ...
            while (i < length) {
                ...
                if (serialize || deserialize) {
                    ...
                    Type fieldType = $Gson$Types.resolve(type2.getType(), raw2, field.getGenericType());
            ...
            type2 = TypeToken.get($Gson$Types.resolve(type2.getType(), raw2, raw2.getGenericSuperclass()));
