...
class e {
    ...
    public static final int[] a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
        ...
        if (!name.equals("null")) {
            if (name.equals(i.g)) {
                ...
                if (name.equals("int-array")) {
                    xmlPullParser.next();
                    int[] iArrA = a(xmlPullParser, "int-array", strArr);
                    strArr[0] = attributeValue;
                    return iArrA;
                }
                if (name.equals("map")) {
                    xmlPullParser.next();
                    HashMap mapA = a(xmlPullParser, "map", strArr);
                    strArr[0] = attributeValue;
                    return mapA;
                }
                if (name.equals("list")) {
