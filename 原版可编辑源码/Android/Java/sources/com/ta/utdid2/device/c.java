...
public class c {
    ...
    private c(Context context) {
        ...
        this.a = new com.ta.utdid2.b.a.c(context, ".DataStorage", "ContextData", false, true);
        this.a = new d();
    ...
    private void e(String str) {
        com.ta.utdid2.b.a.c cVar;
        if (str == null || (cVar = this.a) == null || str.equals(cVar.getString(this.h))) {
            return;
        }
    ...
    private String c() {
        ...
        if (f.isEmpty(string) || this.a.c(string) == null) {
            return null;
        }
        return string;
    }
    ...
    public synchronized String e() {
        ...
        String string3 = this.a.getString(this.h);
        if (!f.isEmpty(string3)) {
            String strD3 = eVar.d(string3);
            if (!a(strD3)) {
                strD3 = this.a.d(string3);
            }
            if (a(strD3)) {
                String strC4 = this.a.c(strD3);
                if (!f.isEmpty(strD3)) {
                    this.g = strD3;
                    if (z) {
                        h(strC4);
