...
public class SplitScreenSdk {
    ...
    private void show(ShowType showType) {
        int i = 1.$SwitchMap$com$bianfeng$splitscreenwindow$ShowType[showType.ordinal()];
    ...
    public void show(String str) {
        switch (1.$SwitchMap$com$bianfeng$splitscreenwindow$ShowType[this.showtype.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
