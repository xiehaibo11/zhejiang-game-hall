...
public class SplitScreenWindowManager {
    ...
    private ViewWebGroup.ViewWebInterface webInterface = new ViewWebGroup.ViewWebInterface() {
        @Override
    ...
    static class 3 {
        static final int[] $SwitchMap$com$bianfeng$splitscreenwindow$ShowType;
    ...
    private void show() {
        int i = 3.$SwitchMap$com$bianfeng$splitscreenwindow$ShowType[this.showType.ordinal()];
        if (i == 1 || i == 2) {
            showFenping();
        } else if (i == 3 || i == 4) {
            showQuanping();
