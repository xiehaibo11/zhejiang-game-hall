...
public class l<T> {
        ...
        synchronized (l.class) {
            try {
                try {
                    ...
                    lValueOf = Long.valueOf(this.a.insert(this.d, null, contentValues));
                } catch (Exception e) {
    ...
    public List<T> a(String str, String str2) throws n {
        ...
        try {
            ...
            Cursor cursorQuery = this.a.query(this.d, null, "db_datafun_dataTime between ? and ?", new String[]{str, str2}, null, null, null, "100");
        ...
        synchronized (l.class) {
            try {
                try {
                    ...
                    iDelete = this.a.delete(this.d, "_id=?", new String[]{string + ""});
                } catch (Exception e) {
                    x.a("delete出现异常");
                    throw new n(e);
                }
