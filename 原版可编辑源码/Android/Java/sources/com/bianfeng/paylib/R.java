...
public final class R {
    ...
    public static final class drawable {
        ...
        public static final int webpaysdk_arrow_back = com.bianfeng.splitscreenlib.R.drawable.webpaysdk_arrow_back;
        public static final int webpaysdk_bg_base_view = com.bianfeng.splitscreenlib.R.drawable.webpaysdk_bg_base_view;
        public static final int webpaysdk_button_close = com.bianfeng.splitscreenlib.R.drawable.webpaysdk_button_close;
        public static final int webpaysdk_button_color_selecter = com.bianfeng.splitscreenlib.R.drawable.webpaysdk_button_color_selecter;
        public static final int webpaysdk_button_green = com.bianfeng.splitscreenlib.R.drawable.webpaysdk_button_green;
        public static final int webpaysdk_frame_def = com.bianfeng.splitscreenlib.R.drawable.webpaysdk_frame_def;
        public static final int webpaysdk_itempressed = com.bianfeng.splitscreenlib.R.drawable.webpaysdk_itempressed;
        public static final int webpaysdk_pay_choose_type = com.bianfeng.splitscreenlib.R.drawable.webpaysdk_pay_choose_type;
        public static final int webpaysdk_pay_right = com.bianfeng.splitscreenlib.R.drawable.webpaysdk_pay_right;
        public static final int webpaysdk_pay_type_alipay = com.bianfeng.splitscreenlib.R.drawable.webpaysdk_pay_type_alipay;
        public static final int webpaysdk_pay_type_wx = com.bianfeng.splitscreenlib.R.drawable.webpaysdk_pay_type_wx;
    }

    public static final class id {
        public static final int payment_web_bridge_webView = com.bianfeng.splitscreenlib.R.id.payment_web_bridge_webView;
        public static final int progressBar = com.bianfeng.splitscreenlib.R.id.progressBar;
        public static final int webpaypay_bodyContainer = com.bianfeng.splitscreenlib.R.id.webpaypay_bodyContainer;
        public static final int webpaypay_btnLeft = com.bianfeng.splitscreenlib.R.id.webpaypay_btnLeft;
        public static final int webpaypay_layoutTop = com.bianfeng.splitscreenlib.R.id.webpaypay_layoutTop;
        public static final int webpaypay_next_stepbtn = com.bianfeng.splitscreenlib.R.id.webpaypay_next_stepbtn;
        public static final int webpaypay_pageMainLayout = com.bianfeng.splitscreenlib.R.id.webpaypay_pageMainLayout;
        public static final int webpaypay_paytype_alipay = com.bianfeng.splitscreenlib.R.id.webpaypay_paytype_alipay;
        public static final int webpaypay_paytype_alipay_ok = com.bianfeng.splitscreenlib.R.id.webpaypay_paytype_alipay_ok;
        public static final int webpaypay_paytype_wx = com.bianfeng.splitscreenlib.R.id.webpaypay_paytype_wx;
        public static final int webpaypay_paytype_wx_ok = com.bianfeng.splitscreenlib.R.id.webpaypay_paytype_wx_ok;
        public static final int webpaypay_tvGoodsDesc = com.bianfeng.splitscreenlib.R.id.webpaypay_tvGoodsDesc;
        public static final int webpaypay_tvTitle = com.bianfeng.splitscreenlib.R.id.webpaypay_tvTitle;
        public static final int webpaypay_webview = com.bianfeng.splitscreenlib.R.id.webpaypay_webview;
        public static final int webpaypay_webview_wx = com.bianfeng.splitscreenlib.R.id.webpaypay_webview_wx;
        public static final int webpaypay_webview_wx_close = com.bianfeng.splitscreenlib.R.id.webpaypay_webview_wx_close;
        public static final int webpaypay_webview_wx_dialog = com.bianfeng.splitscreenlib.R.id.webpaypay_webview_wx_dialog;
    }

    public static final class layout {
        public static final int activity_payment_web = com.bianfeng.splitscreenlib.R.layout.activity_payment_web;
        public static final int activity_webpaysdk_ali = com.bianfeng.splitscreenlib.R.layout.activity_webpaysdk_ali;
        public static final int activity_webpaysdk_payment = com.bianfeng.splitscreenlib.R.layout.activity_webpaysdk_payment;
        public static final int activity_webpaysdk_wx = com.bianfeng.splitscreenlib.R.layout.activity_webpaysdk_wx;
        public static final int include_webpaysdk_payment_view = com.bianfeng.splitscreenlib.R.layout.include_webpaysdk_payment_view;
    }

    public static final class string {
        public static final int app_baseLib_name = com.bianfeng.splitscreenlib.R.string.app_baseLib_name;
        public static final int app_payLib_name = com.bianfeng.splitscreenlib.R.string.app_payLib_name;
        ...
        public static final int webpaypay_text_alipay = com.bianfeng.splitscreenlib.R.string.webpaypay_text_alipay;
        public static final int webpaypay_text_wxpay = com.bianfeng.splitscreenlib.R.string.webpaypay_text_wxpay;
        public static final int webpaysdk_text_goods_desc = com.bianfeng.splitscreenlib.R.string.webpaysdk_text_goods_desc;
        public static final int webpaysdk_text_loading = com.bianfeng.splitscreenlib.R.string.webpaysdk_text_loading;
        public static final int webpaysdk_text_starth5game = com.bianfeng.splitscreenlib.R.string.webpaysdk_text_starth5game;
    }

    public static final class style {
        public static final int WebpaysdkCustomLargeTextViewStyle = com.bianfeng.splitscreenlib.R.style.WebpaysdkCustomLargeTextViewStyle;
        public static final int WebpaysdkCustomMediumButtonTextStyle = com.bianfeng.splitscreenlib.R.style.WebpaysdkCustomMediumButtonTextStyle;
        public static final int WebpaysdkCustomMediumHintStyle = com.bianfeng.splitscreenlib.R.style.WebpaysdkCustomMediumHintStyle;
        public static final int WebpaysdkCustomSmallTextViewStyle = com.bianfeng.splitscreenlib.R.style.WebpaysdkCustomSmallTextViewStyle;
        public static final int WebpaysdkCustomTinyTextViewStyle = com.bianfeng.splitscreenlib.R.style.WebpaysdkCustomTinyTextViewStyle;
        public static final int WebpaysdkProgressDialogStyle = com.bianfeng.splitscreenlib.R.style.WebpaysdkProgressDialogStyle;
