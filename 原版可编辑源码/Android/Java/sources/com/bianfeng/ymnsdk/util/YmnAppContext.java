...
public class YmnAppContext {
    ...
    public static String getMetaDataValueString(String key) {
        try {
            return AppContext.getInstance().getMetaDataValueString(key);
        } catch (Exception e) {
            return "";
        }
    }

    public static int getMetaDataValueInt(String key) {
        try {
            return AppContext.getInstance().getMetaDataValueInt(key);
        } catch (Exception e) {
            return 0;
        }
    }
    ...
    public static void setAppId(String sdkAppId2) {
        sdkAppId = sdkAppId2;
    }
    ...
    public static void setSdkAppKey(String sdkAppKey2) {
        sdkAppKey = sdkAppKey2;
    }

    public static void setConfigId(int configId2) {
        configId = configId2;
    }
