...
public class GsonUtils {
    ...
    public <T> Map<String, T> getMapFrom(String data) throws YmnException {
        ...
        try {
            return (Map) this.gson.fromJson(data, new TypeToken<Map<String, T>>() {
            }.getType());
        } catch (Exception e) {
    ...
    public <T> Map<String, T> getMapFrom(Object data) throws YmnException {
        ...
        try {
            return (Map) this.gson.fromJson(toJson(data), new TypeToken<Map<String, T>>() {
            }.getType());
        } catch (Exception e) {
            throw new YmnException(this.TAG, e);
        }
    ...
    public <T> Map<String, T> getMapFrom(Context context, String fileName) throws YmnException {
        ...
        try {
            try {
                ...
                Map<String, T> map = (Map) this.gson.fromJson(reader, new TypeToken<Map<String, T>>() {
                }.getType());
                try {
                    reader.close();
                } catch (IOException e) {
    ...
    public <T> List<T> getListFrom(String data) throws YmnException {
        ...
        try {
            return (List) this.gson.fromJson(data, new TypeToken<List<T>>() {
            }.getType());
        } catch (Exception e) {
            throw new YmnException(this.TAG, e);
        }
    ...
    public <T> List<T> getListFrom(Object data) throws YmnException {
        ...
        try {
            return (List) this.gson.fromJson(toJson(data), new TypeToken<List<T>>() {
            }.getType());
        } catch (Exception e) {
            throw new YmnException(this.TAG, e);
        }
    ...
    public LinkedHashMap<String, String> getLinkedHashMapFromStr(String data) throws YmnException {
        ...
        try {
            return (LinkedHashMap) this.gson.fromJson(data, new TypeToken<LinkedHashMap<String, String>>() {
            }.getType());
        } catch (Exception e) {
            throw new YmnException(this.TAG, e);
        }
