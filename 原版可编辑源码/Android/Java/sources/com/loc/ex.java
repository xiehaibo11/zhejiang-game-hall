...
public abstract class ex<T> {
    ...
    private void e() {
        ...
        for (Map.Entry<String, a> entry : this.d.entrySet()) {
            try {
                sb.append(p.b(fg.a((entry.getKey() + Constants.ACCEPT_TIME_SEPARATOR_SP + entry.getValue().a + Constants.ACCEPT_TIME_SEPARATOR_SP + entry.getValue().b + Constants.ACCEPT_TIME_SEPARATOR_SP + entry.getValue().c).getBytes("UTF-8"), this.f)) + "\n");
