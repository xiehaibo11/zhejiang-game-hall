...
public final class ff {
    ...
    private void d(boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (fz.a(egVar != null ? eg.a(egVar.a) : "") && (size <= 20 || a(egVar.c))) {
                if (this.s && z) {
                    this.c.add(egVar);
                }
    ...
    */
                ...
                if (Build.VERSION.SDK_INT >= 17) {
                    ...
                    if (scanResults != null && scanResults.size() > 0) {
                        ...
                        for (i = 0; i < size; i++) {
                            ...
                            eg egVar = new eg(!TextUtils.isEmpty(this.u) && this.u.equals(scanResult2.BSSID));
                            egVar.b = scanResult2.SSID;
                            egVar.d = scanResult2.frequency;
                            egVar.e = scanResult2.timestamp;
                            egVar.a = eg.a(scanResult2.BSSID);
                            egVar.c = (short) scanResult2.level;
                            if (Build.VERSION.SDK_INT >= 17) {
                                egVar.g = (short) ((SystemClock.elapsedRealtime() - (scanResult2.timestamp / 1000)) / 1000);
                                if (egVar.g < 0) {
                                    egVar.g = (short) 0;
                                }
                            }
    ...
    public final void a(boolean z) {
        ...
        if (!fq.n() || !this.n || this.a == null || context == null || !z || fz.c() <= 17) {
            return;
        }
    ...
    public final String o() {
        ...
        boolean z3 = false;
        while (i < size) {
            String strA = eg.a(this.b.get(i).a);
