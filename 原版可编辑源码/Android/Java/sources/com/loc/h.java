...
public final class h {
    ...
    private void b(AMapLocation aMapLocation) {
        if (fz.a(aMapLocation) && this.a != null) {
            long jB = fz.b();
    ...
    */
    public final AMapLocation a(AMapLocation aMapLocation, String str) {
        ...
        if ((!this.c.isMockEnable() && this.i.isMock()) || !fz.a(this.i)) {
            return aMapLocation;
        }
        AMapLocation aMapLocationP = p();
        if (aMapLocationP != null && fz.a(aMapLocationP)) {
        ...
        if (aMapLocation == null || !fz.a(aMapLocation)) {
            j2 = 30000;
            ...
            j2 = speed > 5.0f ? com.heytap.mcssdk.constant.a.q : MBInterstitialActivity.WEB_LOAD_TIME;
        } else {
        ...
        if (jB < j2) {
            ...
            AMapLocation aMapLocationClone = this.i.clone();
            aMapLocationClone.setTrustedLevel(2);
            return aMapLocationClone;
        }
        if (this.H && b(str)) {
            AMapLocation aMapLocationClone2 = this.i.clone();
            aMapLocationClone2.setTrustedLevel(3);
            return aMapLocationClone2;
        }
        this.G = null;
        this.I = 0;
        synchronized (this.p) {
