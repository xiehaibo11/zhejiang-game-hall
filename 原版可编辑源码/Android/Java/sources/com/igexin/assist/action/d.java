...
class d {
    ...
    public boolean a(boolean z) {
        return ((this.a == null && (this.g == null || !z)) || TextUtils.isEmpty(this.b) || TextUtils.isEmpty(this.e) || TextUtils.isEmpty(this.d) || TextUtils.isEmpty(this.f) || TextUtils.isEmpty(this.c)) ? false : true;
    }
