...
public class a {
    ...
    public static boolean a(long j) {
        ...
        int i2 = com.igexin.push.config.j.a + com.igexin.push.config.j.b;
        if (i2 >= 24) {
            i2 -= 24;
        }
        if (com.igexin.push.config.j.a < i2) {
            if (i >= com.igexin.push.config.j.a && i < i2) {
                return true;
            }
        } else if (com.igexin.push.config.j.a > i2) {
            if (i >= 0 && i < i2) {
                return true;
            }
            if (i >= com.igexin.push.config.j.a && i < 24) {
                return true;
            }
        }
        return false;
    ...
    public static boolean a(JSONObject jSONObject) {
        ...
        try {
            ...
            com.igexin.b.a.c.b.a(a + "|action_chains have loop nodeMap not empty", new Object[0]);
            return true;
        } catch (Throwable th) {
            com.igexin.b.a.c.b.a(a + "|isHaveLoop exception :" + th.toString(), new Object[0]);
            return false;
        }
    }
    ...
    public static void c(Context context) {
        ...
        try {
            ...
            if (packageInfo != null) {
                ...
                if (!listAsList.contains(com.kuaishou.weapon.p0.g.a)) {
    ...
    public static boolean f() {
        ...
        try {
            ...
            com.igexin.b.a.c.b.a(a + "|network available ex =" + th.toString(), new Object[0]);
        }
        if (connectivityManager == null) {
            com.igexin.b.a.c.b.a(a + "|ConnectivityManager is null", new Object[0]);
            return false;
        }
        NetworkInfo activeNetworkInfo = connectivityManager.getActiveNetworkInfo();
        com.igexin.b.a.c.b.a(a + "|activeNetworkInfo = " + activeNetworkInfo, new Object[0]);
        if (activeNetworkInfo == null || activeNetworkInfo.getState() != NetworkInfo.State.CONNECTED) {
            com.igexin.b.a.c.b.a(a + "|network available = false", new Object[0]);
            return false;
        }
        com.igexin.b.a.c.b.a(a + (activeNetworkInfo.getType() == 0 ? Device.NETWORN_MOBILE : activeNetworkInfo.getType() == 1 ? Device.NETWORN_WIFI : Device.NETWORN_NONE) + "|connected", new Object[0]);
        return true;
    }
