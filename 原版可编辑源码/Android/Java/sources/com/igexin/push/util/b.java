    ...
    */
            ...
            if ((i & 3) != 0) {
                try {
                    ...
                    try {
                        ...
                        while (true) {
                            if (iLastIndexOf < 0 || str.startsWith(TtmlNode.END, iLastIndexOf)) {
                                break;
                            }
                            ...
                            if (str.startsWith("action=", iLastIndexOf)) {
                                ...
                                if ((i & 4) == 0) {
                                    int i3 = Build.VERSION.SDK_INT >= 19 ? 67 : 3;
                                    if (Build.VERSION.SDK_INT >= 21) {
                                        i3 |= 128;
                                    }
                                    intent3.setFlags((~i3) & intent3.getFlags());
                                }
                                ...
                                if (z2) {
                                    intent3.setData(Uri.parse(strDecode + Constants.COLON_SEPARATOR));
                                } else {
                                ...
                                if (str.startsWith("S.", iLastIndexOf)) {
                                    ...
                                    if (str.startsWith("c.", iLastIndexOf)) {
                                        z = false;
    ...
    public static boolean a() {
        try {
            ...
            a = Boolean.valueOf((!"Xiaomi".equalsIgnoreCase(j.a()) && TextUtils.isEmpty(a("ro.miui.ui.version.name")) && TextUtils.isEmpty(a("ro.miui.ui.version.code"))) ? false : true);
            return a.booleanValue();
        } catch (Throwable unused) {
            return false;
        }
