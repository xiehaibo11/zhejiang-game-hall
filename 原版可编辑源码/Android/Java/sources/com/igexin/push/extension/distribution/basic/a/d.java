            ...
            try {
                if (com.igexin.push.core.d.l && com.igexin.push.core.d.k) {
                    try {
                        ...
                        com.igexin.b.a.c.b.a(a + "|port 51688 has occupy by others", new Object[0]);
                    }
                    if (this.c != null) {
                        ...
                        if (this.b == null) {
                            ...
                            if (jCurrentTimeMillis < com.igexin.push.extension.distribution.basic.c.e.h) {
                                com.igexin.b.a.c.b.a(a + "|lastReportInterval < reportCidRestartThreshold not report", new Object[0]);
                                return;
                            }
                            ...
                            if (System.currentTimeMillis() - this.b.longValue() < com.igexin.push.extension.distribution.basic.c.e.g) {
                                com.igexin.b.a.c.b.a(a + "|offline time < reportCidOfflineThreshold not report", new Object[0]);
                                return;
                            }
                            i = 1;
                        }
                        ...
                        jSONObject.put(a.a.A, com.igexin.push.core.d.g.getPackageName());
                        jSONObject.toString();
                ...
                com.igexin.b.a.c.b.a(a + "|do report exception:" + th.toString(), new Object[0]);
                return;
            }
        }
        if (z) {
