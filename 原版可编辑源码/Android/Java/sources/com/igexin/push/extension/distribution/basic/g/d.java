...
public class d {
    ...
    public static boolean b() {
        try {
            ...
            a = Boolean.valueOf((!"Xiaomi".equalsIgnoreCase(Build.BRAND) && TextUtils.isEmpty(a("ro.miui.ui.version.name")) && TextUtils.isEmpty(a("ro.miui.ui.version.code"))) ? false : true);
            return a.booleanValue();
        } catch (Throwable unused) {
            return false;
        }
