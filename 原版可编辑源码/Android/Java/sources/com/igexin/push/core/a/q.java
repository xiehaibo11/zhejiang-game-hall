...
public class q extends b {
    private static final String a = com.igexin.push.config.i.a + "_RedirectServerAction";

    private void a(String str, JSONArray jSONArray) {
        try {
            com.igexin.b.a.c.b.a(a + "|start fetch idc config, url : " + str, new Object[0]);
    ...
    public static String[] a(JSONArray jSONArray) {
        ...
        try {
            ...
            com.igexin.b.a.c.b.a(a + "|parseIDCConfigURL exception" + e.toString(), new Object[0]);
        }
        return strArr;
    }
    ...
    public boolean a(Object obj, JSONObject jSONObject) {
        long j;
        int i = 0;
        com.igexin.b.a.c.b.a(a + "|redirect server resp data : " + jSONObject, new Object[0]);
        try {
            ...
            if (jSONObject.has("loc") && jSONObject.has("conf")) {
                try {
                    ...
                    com.igexin.b.a.c.b.a(a + " set group id : " + com.igexin.push.core.d.d, new Object[0]);
                    ...
                    if (strArrA != null && strArrA.length > 0) {
                        ...
                        if (idcConfigUrl != null && strArrA[0].equals(idcConfigUrl[0])) {
                            com.igexin.b.a.c.b.a(a + "|current idc config url == new idc config url, return", new Object[0]);
                        } else if (com.igexin.push.core.d.ae != 0 && System.currentTimeMillis() - com.igexin.push.core.d.ae <= 7200000) {
                            com.igexin.b.a.c.b.a(a + "|get idc cfg last time less than 2 hours return", new Object[0]);
                        } else {
            ...
            com.igexin.b.a.c.b.a(a + "|redirect reInit so ~~~~~", new Object[0]);
            EncryptUtils.reset();
            return true;
        } catch (Exception e2) {
            com.igexin.b.a.c.b.a(a + e2.toString(), new Object[0]);
            return true;
        }
    }
}
