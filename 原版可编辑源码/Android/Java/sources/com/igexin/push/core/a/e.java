...
public class e extends a {
    ...
    void b(String str) {
        ...
        nVar.b();
        ((com.igexin.push.d.c.b) nVar).a = (int) System.currentTimeMillis();
        nVar.d = "17258000";
        nVar.e = string;
    ...
    public void c(PushTaskBean pushTaskBean, String str) {
        this.a.execute(new h(this, pushTaskBean, str));
    }
