...
public final class c {
    ...
    private View.OnClickListener t = new View.OnClickListener() {
        ...
        public final void onClick(View view) {
            if (view instanceof TextView) {
                com.tkay.core.common.k.c.a(c.this.a, c.this.b, ((TextView) view).getTag().toString(), "");
                c.b(c.this);
                if (c.this.s != null) {
                    c.this.s.a();
                }
    ...
    public final void a(Context context, h hVar, i iVar, a aVar) {
        try {
            ...
            this.g.setOnClickListener(new 2());
    ...
    final class 1 implements DialogInterface.OnCancelListener {
        1() {
        }
        ...
        public final void onClick(View view) {
            if (c.this.f != null) {
                ...
                if (TextUtils.isEmpty(string)) {
                    ...
                    c.this.f.postDelayed(new Runnable() {
                        @Override
                ...
                com.tkay.core.common.k.c.a(c.this.a, c.this.b, "0", string);
                c.b(c.this);
                if (c.this.s != null) {
                    c.this.s.a();
                }
    ...
    private void e() {
        new Handler().postDelayed(new 4(), 30L);
    }
    ...
    static void b(c cVar) {
        new Handler().postDelayed(cVar.new 4(), 30L);
    }
}
