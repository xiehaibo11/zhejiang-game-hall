...
public final class c {
    ...
    static boolean b(c cVar, com.tkay.basead.c.i iVar) {
    ...
    public final void a(com.tkay.basead.c.i iVar) {
        ...
        this.m = true;
        this.n = false;
        com.tkay.core.common.l.b.a.a().a(new 3(iVar));
    }

    final class 3 implements Runnable {
        final com.tkay.basead.c.i a;

        3(com.tkay.basead.c.i iVar) {
            this.a = iVar;
        }
        ...
        public final void run() throws Throwable {
            ...
            if (c.this.l.D() == 4 && 1 == c.this.r.m.o() && iExHandlerB != null && i != 1) {
                iExHandlerB.openApkConfirmDialog(c.this.p, c.this.l, c.this.r, new com.tkay.core.common.g.a() {
                    @Override
                    public final void a(boolean z) {
                        if (z) {
    ...
    private void a(int i2, com.tkay.basead.c.i iVar) throws Throwable {
        ...
        if (iD == 4) {
            if (g() && TextUtils.isEmpty(dVar.a) && (dVarA = com.tkay.basead.d.b.a.a.a(this.r, this.l, strA)) != null) {
                dVar.a = dVarA.a;
                dVar.c = dVarA.c;
            }
            a aVar2 = this.u;
    ...
    static boolean a(c cVar, com.tkay.basead.c.i iVar) {
        iVar.i = new com.tkay.basead.c.b();
    ...
    static void a(c cVar, int i2, com.tkay.basead.c.i iVar) throws Throwable {
        String strB;
        com.tkay.basead.c.d dVar;
        String strB2;
        String strB3;
        ...
        if (iD == 4) {
            if (cVar.g() && TextUtils.isEmpty(dVar.a) && (dVarA = com.tkay.basead.d.b.a.a.a(cVar.r, cVar.l, strA)) != null) {
                dVar.a = dVarA.a;
                dVar.c = dVarA.c;
            }
            a aVar2 = cVar.u;
