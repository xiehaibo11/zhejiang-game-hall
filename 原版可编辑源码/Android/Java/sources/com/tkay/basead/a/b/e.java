...
final class e extends com.tkay.core.common.res.image.b {
    ...
    protected final void c() {
        if (this.j) {
            ...
            com.tkay.core.common.k.c.a(this.a, this.k, this.c, "1", this.i, (String) null, this.e, this.g, this.l, this.h - this.f);
        }
        d.a().a(this.c, 100);
    }
    ...
    protected final void a(String str, String str2) {
        if (this.j) {
            com.tkay.core.common.k.c.a(this.a, this.k, this.c, "0", this.i, str2, this.e, 0L, this.l, this.h - this.f);
        }
