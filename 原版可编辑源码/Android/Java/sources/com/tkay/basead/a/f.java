...
public class f {
    ...
    public static void a(String str, com.tkay.core.common.f.h hVar, com.tkay.core.common.f.i iVar, b.b bVar) {
        a(str, false, hVar, iVar, bVar);
    }

    public static void a(String str, boolean z, com.tkay.core.common.f.h hVar, com.tkay.core.common.f.i iVar, b.b bVar) {
        new com.tkay.basead.a.b.b(str, z, hVar, iVar).a(bVar);
    }
