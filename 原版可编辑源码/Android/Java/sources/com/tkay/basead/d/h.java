...
public class h {
    ...
    private View b(Context context, boolean z, boolean z2, BaseMediaATView.a aVar) {
        ...
        if (z) {
            ...
            mraidMediaView.setMraidWebViewListener(new MraidMediaView.a() {
                @Override
                public final void a(String str) {
                    if (h.this.g != null) {
                        h.this.g.v(str);
    ...
    private void o() {
        ...
        if (this.g instanceof y) {
            com.tkay.basead.d.c.c.a().a(this.a, com.tkay.basead.d.c.c.a(this.h.b, this.h.c), this.g, this.h.m);
        }
        com.tkay.expressad.advanced.d.c cVar = this.k;
    ...
    private void q() {
        ...
        final View viewP = p();
        this.p = new com.tkay.basead.a.a(viewP, this.h, new a.a() {
            @Override
