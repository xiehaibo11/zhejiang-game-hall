        ...
        try {
            ...
            textView2.setOnClickListener(new View.OnClickListener() {
                ...
                public final void onClick(View view) {
                    com.tkay.core.common.k.c.a(g.this.b, g.this.c.p(), g.this.a, 7, (String) null, 0L, 0L);
                    try {
                        dialog.dismiss();
            ...
            textView3.setOnClickListener(new View.OnClickListener() {
                ...
                public final void onClick(View view) {
                    try {
                        com.tkay.core.common.k.c.a(g.this.b, g.this.c.p(), g.this.a, 8, (String) null, 0L, 0L);
                        if (com.tkay.basead.a.b.a(contextF, g.this.c)) {
                            com.tkay.core.common.k.c.a(g.this.b, g.this.c.p(), g.this.a, 9, (String) null, 0L, 0L);
                        }
                        dialog.dismiss();
                    } catch (Throwable unused) {
                    }
