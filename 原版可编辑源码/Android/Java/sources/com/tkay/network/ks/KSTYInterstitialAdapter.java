...
public class KSTYInterstitialAdapter extends CustomInterstitialAdapter {
    ...
    static int H(KSTYInterstitialAdapter kSTYInterstitialAdapter) {
        kSTYInterstitialAdapter.mDismissType = 2;
        return 2;
    }

    static int u(KSTYInterstitialAdapter kSTYInterstitialAdapter) {
        kSTYInterstitialAdapter.mDismissType = 2;
        return 2;
    }
    ...
    private void a() {
        ...
        if (this.d == 0) {
            KsAdSDK.getLoadManager().loadInterstitialAd(ksSceneBuild, new 2());
        } else {
            KsAdSDK.getLoadManager().loadFullScreenVideoAd(ksSceneBuild, new 3());
        }
    }

    final class 2 implements KsLoadManager.InterstitialAdListener {
        2() {
        }
    ...
    final class 3 implements KsLoadManager.FullScreenVideoAdListener {
        3() {
        }
    ...
    static void a(KSTYInterstitialAdapter kSTYInterstitialAdapter) {
        KsScene.Builder builderScreenOrientation = new KsScene.Builder(kSTYInterstitialAdapter.a).adNum(1).screenOrientation(kSTYInterstitialAdapter.b == 2 ? 2 : 1);
        ...
        if (kSTYInterstitialAdapter.d == 0) {
            KsAdSDK.getLoadManager().loadInterstitialAd(ksSceneBuild, kSTYInterstitialAdapter.new 2());
        } else {
            KsAdSDK.getLoadManager().loadFullScreenVideoAd(ksSceneBuild, kSTYInterstitialAdapter.new 3());
        }
    }
}
