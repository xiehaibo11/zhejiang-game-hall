...
public class TTTYAdapter extends CustomNativeAdapter {
    ...
    private void a(Context context, Map<String, Object> map, Map<String, Object> map2, int i) {
        ...
        if (TextUtils.isEmpty(this.c)) {
            ...
            runOnNetworkRequestThread(new 2(applicationContext, map2, map, i));
        }
    }
    ...
    final class 2 implements Runnable {
        ...
        2(Context context, Map map, Map map2, int i) {
            this.a = context;
            this.b = map;
            this.c = map2;
            this.d = i;
        ...
        public final void run() {
            ...
            TTVfNative tTVfNativeCreateVfNative = vfManager.createVfNative(this.a);
            TTTYCustomAdSlotBuilder tTTYCustomAdSlotBuilder = new TTTYCustomAdSlotBuilder(TTTYAdapter.this.a, this.c, this.b);
            ...
            if (TextUtils.equals("0", TTTYAdapter.this.c) && TextUtils.equals("0", TTTYAdapter.this.b)) {
                ...
                tTTYCustomAdSlotBuilder.setExpressViewAcceptedSize(TTTYAdapter.a(this.a, i4), TTTYAdapter.a(this.a, i5));
                tTVfNativeCreateVfNative.loadNtExpressVn(tTTYCustomAdSlotBuilder.build(), new TTVfNative.NtExpressVfListener() {
                    @Override
                    ...
                    public final void onNtExpressVnLoad(List<TTNtExpressObject> list) {
                        TTTYAdapter.a(TTTYAdapter.this, 2.this.a, (List) list, z, false);
                    }
                });
                return;
            }
            if (TextUtils.equals("1", TTTYAdapter.this.c) && TextUtils.equals("0", TTTYAdapter.this.b)) {
                ...
                tTTYCustomAdSlotBuilder.setExpressViewAcceptedSize(TTTYAdapter.a(this.a, i4), TTTYAdapter.a(this.a, i5));
                tTVfNativeCreateVfNative.loadExpressDrawVf(tTTYCustomAdSlotBuilder.build(), new TTVfNative.NtExpressVfListener() {
                    @Override
                    public final void onError(int i6, String str) {
                    ...
                    @Override
                    public final void onNtExpressVnLoad(List<TTNtExpressObject> list) {
                        TTTYAdapter.a(TTTYAdapter.this, 2.this.a, (List) list, z, true);
                    }
                });
                return;
            }
            ...
            if (b == 0) {
                tTVfNativeCreateVfNative.loadVfList(tTTYCustomAdSlotBuilder.build(), new TTVfNative.VfListListener() {
                    @Override
                    ...
                    public final void onVfListLoad(List<TTVfObject> list) {
                        ...
                        while (it.hasNext()) {
                            arrayList.add(new TTTYNativeAd(2.this.a, TTTYAdapter.this.a, it.next(), z, bitmap, i));
                        }
            ...
            if (b == 1) {
                tTVfNativeCreateVfNative.loadDrawVfList(tTTYCustomAdSlotBuilder.build(), new TTVfNative.DrawVfListListener() {
                    @Override
                    public final void onError(int i6, String str2) {
                        TTTYAdapter.this.notifyATLoadFail(String.valueOf(i6), str2);
                    }
            ...
            if (b == 2) {
                ...
                tTVfNativeCreateVfNative.loadNativeVn(tTTYCustomAdSlotBuilder.build(), new TTVfNative.NtVfListener() {
                    @Override
                    public final void onError(int i6, String str2) {
                        TTTYAdapter.this.notifyATLoadFail(String.valueOf(i6), str2);
                    }
                ...
                tTVfNativeCreateVfNative.loadStream(tTTYCustomAdSlotBuilder.build(), new TTVfNative.VfListListener() {
                    @Override
                    public final void onError(int i6, String str2) {
                        TTTYAdapter.this.notifyATLoadFail(String.valueOf(i6), str2);
                    }
                    ...
                    public final void onVfListLoad(List<TTVfObject> list) {
                        ...
                        Iterator<TTVfObject> it = list.iterator();
                        while (it.hasNext()) {
                            arrayList.add(new TTTYNativePatchAd(2.this.a, TTTYAdapter.this.a, it.next(), z, bitmap, i));
                        }
                        TTTYAdapter.a(TTTYAdapter.this, list, (CustomNativeAd[]) arrayList.toArray(new CustomNativeAd[arrayList.size()]));
                    }
                });
    ...
    final class 3 implements TTTYNativeExpressHandler.RenderCallback {
        final Context a;
        final boolean b;
        final boolean c;

        3(Context context, boolean z, boolean z2) {
            this.a = context;
            this.b = z;
            this.c = z2;
        }
        ...
        public final void onRenderSuccess(List<TTNtExpressObject> list) {
            ...
            while (it.hasNext()) {
                arrayList.add(new TTTYNativeExpressAd(this.a, TTTYAdapter.this.a, it.next(), this.b, this.c));
            }
            TTTYAdapter.a(TTTYAdapter.this, list, (CustomNativeAd[]) arrayList.toArray(new CustomNativeAd[arrayList.size()]));
        }
    ...
    private void a(Context context, List<TTNtExpressObject> list, boolean z, boolean z2) {
        new TTTYNativeExpressHandler(list).startRender(new 3(context, z, z2));
    }
    ...
    static void a(TTTYAdapter tTTYAdapter, Context context, Map map, Map map2, int i) {
        Context applicationContext = context.getApplicationContext();
        if (TextUtils.isEmpty(tTTYAdapter.c)) {
            tTTYAdapter.notifyATLoadFail("", "nativeType is empty");
        } else {
            tTTYAdapter.runOnNetworkRequestThread(tTTYAdapter.new 2(applicationContext, map2, map, i));
        }
    }
    ...
    static void a(TTTYAdapter tTTYAdapter, Context context, List list, boolean z, boolean z2) {
        new TTTYNativeExpressHandler(list).startRender(tTTYAdapter.new 3(context, z, z2));
    }

    static void a(TTTYAdapter tTTYAdapter, List list, CustomNativeAd[] customNativeAdArr) {
        if (list.size() == 0 || customNativeAdArr.length == 0) {
