...
public class MintegralTYSplashAdapter extends CustomSplashAdapter {
    ...
    static int m(MintegralTYSplashAdapter mintegralTYSplashAdapter) {
        mintegralTYSplashAdapter.mDismissType = 99;
        return 99;
    }

    static int t(MintegralTYSplashAdapter mintegralTYSplashAdapter) {
        mintegralTYSplashAdapter.mDismissType = 2;
        return 2;
    }

    static int v(MintegralTYSplashAdapter mintegralTYSplashAdapter) {
        mintegralTYSplashAdapter.mDismissType = 3;
        return 3;
    }

    static int x(MintegralTYSplashAdapter mintegralTYSplashAdapter) {
    ...
    private void a(Map<String, Object> map) {
        ...
        this.i.setSplashLoadListener(new 2());
        this.i.setSplashShowListener(new 3());
        if (b()) {
            MintegralTYInitManager.getInstance().setCustomInfo(7, map);
            this.i.preLoadByToken(this.a);
        } else {
    ...
    final class 2 implements MBSplashLoadListener {
        @Override
        ...
        public final void onLoadSuccessed(MBridgeIds mBridgeIds, int i) {
            ...
            MintegralTYSplashAdapter.this.postOnMainThreadDelayed(new Runnable() {
                @Override
    ...
    final class 3 implements MBSplashShowListener {
        @Override
    ...
    public boolean isAdReady() {
        if (this.i != null) {
            return b() ? this.i.isReady(this.a) : this.i.isReady();
        }
        return false;
    }
    ...
    static void a(MintegralTYSplashAdapter mintegralTYSplashAdapter, Map map) {
        ...
        mintegralTYSplashAdapter.i.setSplashLoadListener(mintegralTYSplashAdapter.new 2());
        mintegralTYSplashAdapter.i.setSplashShowListener(mintegralTYSplashAdapter.new 3());
        if (mintegralTYSplashAdapter.b()) {
            MintegralTYInitManager.getInstance().setCustomInfo(7, map);
            mintegralTYSplashAdapter.i.preLoadByToken(mintegralTYSplashAdapter.a);
        } else {
            MintegralTYInitManager.getInstance().setCustomInfo(8, map);
