...
public final class c {
        ...
        com.tkay.core.common.l.b.a.a().a(new Runnable() {
            ...
            */
            public final void run() {
                boolean z;
                String strAl;
                Map<String, String> mapAj;
                Map<String, String> mapAh;
                ...
                if (!TextUtils.isEmpty(gVar.d)) {
                    gVar.f = m.a().g(gVar.d);
                    g gVar2 = gVar;
                    com.tkay.core.c.d dVarB = com.tkay.core.c.e.a(m.a().f()).b(gVar2.d);
                    if (dVarB != null) {
                        gVar2.E = dVarB.ax();
                    }
                }
                ...
                boolean zContainsKey2 = false;
                if (aVarB != null) {
                    g gVar3 = gVar;
                    if (TextUtils.isEmpty(gVar3.a) || TextUtils.isEmpty(gVar3.B) || TextUtils.isEmpty(gVar3.A) || (mapE = aVarB.e(gVar3.a)) == null) {
                        z = false;
                        strAl = aVarB.al();
                        if (TextUtils.isEmpty(strAl) && c.b(gVar, strAl)) {
                            return;
                        }
                        mapAj = aVarB.aj();
                        if (mapAj != null) {
                            if (TextUtils.isEmpty(gVar.A)) {
                                zContainsKey = mapAj.containsKey(gVar.a);
                            } else if (mapAj.containsKey(gVar.a)) {
                                String str = mapAj.get(gVar.a);
                                zContainsKey = !TextUtils.isEmpty(str) && str.contains(gVar.A);
                            }
                            if (zContainsKey) {
                                return;
                            }
                        ...
                        if (mapAh != null) {
                            if (TextUtils.isEmpty(gVar.A)) {
                                zContainsKey2 = mapAh.containsKey(gVar.a);
                            } else if (mapAh.containsKey(gVar.a)) {
                                String str2 = mapAh.get(gVar.a);
                        ...
                        if (mapE.containsKey("0")) {
                            String str3 = mapE.get("0");
                            if (!TextUtils.isEmpty(str3) && str3.contains(gVar3.A)) {
                                z = true;
                            }
                        } else {
                            if (mapE.containsKey(gVar3.B)) {
                                String str4 = mapE.get(gVar3.B);
                                if (TextUtils.isEmpty(str4) || !str4.contains(gVar3.A)) {
                                }
                            }
                            z = false;
                        }
    ...
    private static boolean a(g gVar, com.tkay.core.c.a aVar) {
        Map<String, String> mapE;
        if (TextUtils.isEmpty(gVar.a) || TextUtils.isEmpty(gVar.B) || TextUtils.isEmpty(gVar.A) || (mapE = aVar.e(gVar.a)) == null) {
            return false;
        }
        if (mapE.containsKey("0")) {
    ...
    private static boolean b(g gVar, com.tkay.core.c.a aVar) {
        Map<String, String> mapE;
        if (TextUtils.isEmpty(gVar.a) || TextUtils.isEmpty(gVar.B) || TextUtils.isEmpty(gVar.A) || (mapE = aVar.e(gVar.a)) == null) {
            return false;
        }
