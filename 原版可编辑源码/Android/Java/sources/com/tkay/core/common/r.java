...
public class r {
    ...
    public final void a(final int i, final com.tkay.core.common.f.e eVar, final com.tkay.core.c.a aVar) {
        try {
            ...
            com.tkay.core.common.b.m.b(new Runnable() {
                @Override
    ...
    public final void a(final com.tkay.core.c.a aVar) {
        com.tkay.core.common.b.m.a();
        com.tkay.core.common.b.m.d(new Runnable() {
            @Override
            public final void run() {
                try {
                    if (r.this.c == null) {
    ...
    static void a(r rVar, int i, String str, String str2, String str3, String str4, com.tkay.core.common.f.d dVar) {
        if (rVar.c != null) {
            try {
                Intent intent = new Intent(str);
                intent.putExtra("common", str2);
