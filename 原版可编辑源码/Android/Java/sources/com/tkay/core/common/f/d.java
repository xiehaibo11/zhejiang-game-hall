...
public class d extends ai implements Cloneable {
    ...
    */
    public final JSONObject A(int i2) {
        String str;
        String str2;
        JSONObject jSONObjectA = super.A(i2);
        try {
            jSONObjectA.put("nw_ver", this.u);
            if (this.aD != -1) {
                jSONObjectA.put("refresh", this.aD);
            }
            if (!TextUtils.isEmpty(this.ba)) {
                jSONObjectA.put("tp_bid_id", this.ba);
            }
            if ("4".equals(this.am)) {
                jSONObjectA.put("ad_type", this.bk);
            }
            if (i2 == 1 || i2 == 2 || i2 == 4 || i2 == 6 || i2 == 13) {
                jSONObjectA.put("extra", this.aZ);
            }
            switch (i2) {
                case 1:
                    jSONObjectA.put("unit_id", this.aJ);
                    jSONObjectA.put("nw_firm_id", this.o);
                    jSONObjectA.put("gro_id", this.aw);
                    jSONObjectA.put("auto_req", this.q);
                    jSONObjectA.put("aprn_auto_req", y());
                    jSONObjectA.put("bidtype", this.w);
                    jSONObjectA.put("bidprice", String.valueOf(this.x));
                    jSONObjectA.put("ad_reqt", this.bj);
                    break;
                case 2:
                    jSONObjectA.put("unit_id", this.aJ);
                    jSONObjectA.put("nw_firm_id", this.o);
                    ...
                    jSONObjectA.put("auto_req", this.q);
                    jSONObjectA.put("aprn_auto_req", y());
                    jSONObjectA.put("status", this.r);
                    jSONObjectA.put("filledtime", this.aI);
                    jSONObjectA.put("flag", this.s);
                    jSONObjectA.put("bidtype", this.w);
                    jSONObjectA.put("bidprice", String.valueOf(this.x));
                    jSONObjectA.put("data_ft", this.aH);
                    jSONObjectA.put(TYAdConst.KEY.CP_LOAD_MODE, O());
                    break;
                case 4:
                    str = "aprn_auto_req";
                    jSONObjectA.put("ads", this.D);
                    jSONObjectA.put("ahs", this.E);
                    jSONObjectA.put("pds", this.F);
                    jSONObjectA.put("phs", this.G);
                    str2 = "phs";
                    jSONObjectA.put("cl_imp", this.bb);
                    if (!TextUtils.isEmpty(this.bp)) {
                        jSONObjectA.put(d.a.i, this.bp);
                    }
                    jSONObjectA.put("unit_id", this.aJ);
                    jSONObjectA.put("nw_firm_id", this.o);
                    jSONObjectA.put("gro_id", this.aw);
                    jSONObjectA.put("auto_req", this.q);
                    jSONObjectA.put(str, y());
                    jSONObjectA.put("bidtype", this.w);
                    jSONObjectA.put("bidprice", String.valueOf(this.x));
                    jSONObjectA.put(com.tkay.core.common.l.am, String.valueOf(this.H));
                    jSONObjectA.put("myoffer_showtype", this.z);
                    if (!TextUtils.isEmpty(this.C)) {
                        jSONObjectA.put("scenario", this.C);
                    }
                    jSONObjectA.put("ads", this.D);
                    jSONObjectA.put("ahs", this.E);
                    jSONObjectA.put("pds", this.F);
                    jSONObjectA.put(str2, this.G);
                    if (i2 == 6) {
                        jSONObjectA.put("cl_s_type", this.bn);
                    }
                    break;
                case 6:
                    str = "aprn_auto_req";
                ...
                case 7:
                    ...
                    jSONObjectA.put("auto_req", this.q);
                    jSONObjectA.put("aprn_auto_req", y());
                    jSONObjectA.put(NotificationCompat.CATEGORY_PROGRESS, this.t);
                    jSONObjectA.put("bidtype", this.w);
                    jSONObjectA.put("bidprice", String.valueOf(this.x));
                    break;
                case 8:
                case 9:
                    ...
                    break;
                case 10:
                    jSONObjectA.put("isload", this.I ? 1 : 0);
                    jSONObjectA.put(com.tkay.expressad.foundation.d.r.ac, this.J);
                    jSONObjectA.put("gro_id", this.aw);
                    jSONObjectA.put("req_par", this.bl);
                    jSONObjectA.put("req_par_num", this.bm);
                    break;
                case 11:
                    jSONObjectA.put("auto_req", this.q);
                    jSONObjectA.put("gro_id", this.aw);
                    jSONObjectA.put("bidrequesttime", this.L);
                    jSONObjectA.put("bidresponsetime", this.M);
                    jSONObjectA.put("bidresponselist", TextUtils.isEmpty(this.N) ? HttpUrl.PATH_SEGMENT_ENCODE_SET_URI : new JSONArray(this.N));
                    break;
                case 12:
                    jSONObjectA.put("loadtime", this.aI);
                    jSONObjectA.put("gro_id", this.aw);
                    int i3 = this.J;
                    if (i3 == 5 || i3 == 9) {
                        jSONObjectA.put(com.tkay.expressad.foundation.d.r.ac, this.J);
                ...
                case 13:
                    ...
                    jSONObjectA.put("bidprice", String.valueOf(this.x));
                    jSONObjectA.put(com.tkay.core.common.l.am, String.valueOf(this.H));
                    jSONObjectA.put("as_result", !TextUtils.isEmpty(this.K) ? HttpUrl.PATH_SEGMENT_ENCODE_SET_URI : new JSONArray(this.K));
                    jSONObjectA.put("new_req_id", this.v);
                    jSONObjectA.put("auto_req", this.q);
                    if (this.v == null && this.al == null) {
                        jSONObjectA.put("req_id_match", 0);
                    }
                    if (this.v == null && this.al != null && this.v.equals(this.al)) {
                        jSONObjectA.put("req_id_match", 0);
                    } else {
                        jSONObjectA.put("req_id_match", 1);
                    }
                    jSONObjectA.put("myoffer_showtype", this.z);
                    if (!TextUtils.isEmpty(this.C)) {
                        jSONObjectA.put("scenario", this.C);
                ...
                case 15:
                    ...
                    break;
                case 16:
                    jSONObjectA.put("ad_ch_st", this.bh);
                    jSONObjectA.put("unit_id", this.aJ);
                    jSONObjectA.put("nw_firm_id", this.o);
                    jSONObjectA.put("gro_id", this.aw);
                    jSONObjectA.put("bidtype", this.w);
                ...
                case 20:
                    jSONObjectA.put("unit_id", this.aJ);
                    jSONObjectA.put("nw_firm_id", this.o);
                    jSONObjectA.put("app_nm", this.bd);
                    break;
                case 19:
                    jSONObjectA.put("dl_ts", this.be);
                    jSONObjectA.put("unit_id", this.aJ);
                    jSONObjectA.put("nw_firm_id", this.o);
                    jSONObjectA.put("app_nm", this.bd);
                    break;
