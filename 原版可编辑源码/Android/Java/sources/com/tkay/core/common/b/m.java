...
public class m {
    ...
    private void M() {
        com.tkay.core.common.l.b.a.a().a(new 1());
    }
    ...
    public final synchronized void a(final Context context, final String str, String str2, final TYNetworkConfig tYNetworkConfig) {
        ...
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
            ...
            try {
                ...
                com.tkay.core.common.l.b.a.a().a(new 11(context, str));
            } catch (Exception unused3) {
            }
        }
    }
    ...
    */
    ...
    private void g(Context context) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(strB)) {
                ...
                long jOptLong = jSONObject.optLong(d.a);
    ...
    final class 10 extends BroadcastReceiver {
        10() {
        }
    ...
    final class 11 implements Runnable {
        ...
        @Override
        public final void run() {
            com.tkay.core.c.a aVarB = com.tkay.core.c.b.a(this.a.getApplicationContext()).b(this.b);
            if (aVarB != null) {
                if (!aVarB.G()) {
                    r.a(m.this.k).a(aVarB);
                }
                if (com.tkay.core.c.b.a(this.a.getApplicationContext()).a(this.b)) {
                    return;
                }
                com.tkay.core.c.b.a(this.a.getApplicationContext());
            }
        }
    }
    ...
    public final void a(Context context, final String str, Map<String, Object> map) {
        if (z()) {
            ...
            new com.tkay.core.common.h.l(context, a().o(), a().p(), str, "", map, new HashMap(1)).a(0, new com.tkay.core.common.h.k() {
                @Override
    ...
    private void a(Context context, TYNetworkConfig tYNetworkConfig) {
        ...
        for (TYInitConfig tYInitConfig3 : tYInitConfigList) {
            if (tYInitConfig3 != null) {
                ...
                com.tkay.core.common.l.b.a.a().a(new 5(tYInitConfig3, context));
            }
        }
    }

    final class 5 implements Runnable {
        final TYInitConfig a;
        final Context b;

        5(TYInitConfig tYInitConfig, Context context) {
            this.a = tYInitConfig;
            this.b = context;
        }
        ...
        public final void run() {
            ...
            boolean zD;
            try {
                TYInitMediation initMediation = this.a.getInitMediation();
    ...
    static void a(m mVar, Context context) {
    ...
    static void a(m mVar, Context context, TYNetworkConfig tYNetworkConfig) {
        if (tYNetworkConfig == null) {
            tYNetworkConfig = new TYNetworkConfig();
        }
        List<TYInitConfig> tYInitConfigList = tYNetworkConfig.getTYInitConfigList();
        ...
        for (TYInitConfig tYInitConfig3 : tYInitConfigList) {
            if (tYInitConfig3 != null) {
                ...
                com.tkay.core.common.l.b.a.a().a(mVar.new 5(tYInitConfig3, context));
            }
        }
    }
}
