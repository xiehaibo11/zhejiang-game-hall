...
public class g extends a {
    ...
    public g(ag agVar) {
        super(agVar);
        this.e = Collections.synchronizedList(new ArrayList(this.a.j));
    }
    ...
    protected final void a(com.tkay.core.b.b.a aVar) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (tYBaseAdAdapterA == null) {
                ...
                try {
                    com.tkay.core.b.b.b bVar = new com.tkay.core.b.b.b(tYBaseAdAdapterA) {
                        @Override
                    ...
                    com.tkay.core.c.d dVarA = com.tkay.core.c.e.a(this.a.b).a(this.a.e);
                    Map<String, Object> mapA = dVarA.a(this.a.e, this.a.d, ajVar);
                    try {
                    ...
                    com.tkay.core.common.f.d dVarN = this.a.t.N();
                    s.a(dVarN, ajVar, 0, false);
                    com.tkay.core.common.l.g.a(mapA, dVarN);
                    if (this.a.v == 8) {
                        mapA.put(f.k.j, this.a.w < 0.0d ? "0" : Double.valueOf(this.a.w));
                    }
                    Context contextA = this.a.c != null ? this.a.c.a() : null;
                    if (contextA == null) {
                        contextA = this.a.b;
                    }
                    boolean zInternalStartBiddingRequest = tYBaseAdAdapterA.internalStartBiddingRequest(contextA, mapA, this.a.r, bVar);
    ...
    private void a(aj ajVar, k kVar, long j, int i, com.tkay.core.b.c.a aVar) {
        if (kVar.isSuccessWithUseType()) {
            ...
            if (dA <= 0.0d) {
                Log.w(n.a, "NetworkName:" + ajVar.d() + ",AdSoruceId:" + ajVar.t() + " c2s price return 0,please check network placement c2s config");
            ...
            a(ajVar.c(), lVar, 0.0d);
            a(ajVar, lVar);
            n.a(f.i.l, this.a.e, com.tkay.core.common.l.g.d(String.valueOf(this.a.f)), ajVar);
            return;
        }
        a(ajVar, kVar.errorMsg, j, i);
        n.a(f.i.m, this.a.e, com.tkay.core.common.l.g.d(String.valueOf(this.a.f)), ajVar);
    }
    ...
    private synchronized void a(boolean z, TYBiddingResult tYBiddingResult, aj ajVar, int i, com.tkay.core.b.c.a aVar) {
        boolean z2;
        if (z) {
            c cVarA = c.a();
            String strT = ajVar.t();
            if (cVarA.e != null) {
                if (cVarA.e.get(strT + "_c2sfirstStatus") == null) {
                    z2 = true;
                    com.tkay.core.common.k.c.a(this.a.e, ajVar, z2, SystemClock.elapsedRealtime() - this.g, this.a);
                } else {
                    z2 = false;
                    com.tkay.core.common.k.c.a(this.a.e, ajVar, z2, SystemClock.elapsedRealtime() - this.g, this.a);
                }
