...
public final class i extends b {
    ...
    protected final void a(List<JSONObject> list, k kVar) {
        ...
        bVar.e = string2;
        bVar.g = this.a.o.f();
        int iB = w.a(this.a.b).b(this.a.e);
        if (this.a.y != null) {
            boolC = this.a.y.c();
            strA = this.a.y.a();
            zB = this.a.y.b();
        ...
        com.tkay.core.common.f.d dVar = this.a.t;
        int i = this.a.c.d;
        int i2 = this.a.v;
        boolean z = this.z;
        boolean z2 = this.A;
        boolean zA = com.tkay.core.common.l.h.a(this.a.b);
