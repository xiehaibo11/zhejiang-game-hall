...
public class WebLandPageActivity extends Activity {
    ...
    public static void a(Context context, com.tkay.core.basead.b.a aVar) {
        ...
        intent.putExtra(a.a.j, aVar.f);
        if (aVar.g != null) {
            intent.putExtra(a.a.l, aVar.g);
        }
    ...
    private void b() {
        ...
        if (intent != null) {
            try {
                Serializable serializableExtra = intent.getSerializableExtra(a.a.c);
            ...
            try {
                Serializable serializableExtra2 = intent.getSerializableExtra(a.a.e);
            ...
            try {
                Serializable serializableExtra3 = intent.getSerializableExtra(a.a.l);
            ...
            try {
                this.o = intent.getStringExtra(a.a.j);
            } catch (Throwable th4) {
                th4.printStackTrace();
            }
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.i.setOnClickListener(new 3());
        this.j.setBackgroundColor(0);
        this.j.setOnClickListener(new 4());
        this.k.setBackgroundColor(0);
        this.k.setOnClickListener(new 5());
        ...
        this.g.setDownloadListener(new 1());
    ...
    final class 1 implements DownloadListener {
        1() {
        }
    ...
    protected void onDestroy() {
        ...
        c.a(iVar.b, this.n.d, this.m.d(), this.m.p(), this.b, this.c, this.d, this.a, this.o, this.n.j);
    }
