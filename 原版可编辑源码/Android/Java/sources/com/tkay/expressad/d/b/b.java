...
public class b {
    ...
    private void a(Context context, String str) {
        ...
        if (TextUtils.isEmpty(strA) || !strA.equals(str)) {
            try {
                new com.tkay.expressad.d.a.a(context).a(str, (com.tkay.expressad.foundation.g.f.h.b) null, new 1(str));
            } catch (Exception e2) {
                e2.getMessage();
            }
        }
    ...
    final class 1 extends com.tkay.expressad.foundation.g.f.b.b {
        ...
        public final void a(String str) {
            ...
            b.this.f = str;
            b.b(b.this, str);
            com.tkay.expressad.foundation.a.a.a.a().a(b.b, this.a);
        }
    }
    ...
    final class 2 implements Runnable {
        ...
        public final void run() throws Throwable {
            try {
                File file = new File(f.b(c.k), b.c);
                if (file.exists()) {
                    file.delete();
                }
                m.a(this.a.getBytes(), file);
            } catch (Exception e) {
                String unused = b.a;
                e.getMessage();
            }
    ...
    private void a(String str) {
        new Thread(new 2(str)).start();
    }

    private static String e() {
        try {
            File file = new File(f.b(c.k), c);
                ...
                if (aVarB != null && !TextUtils.isEmpty(aVarB.M())) {
                    ...
                    if (contextD != null) {
                        ...
                        if (TextUtils.isEmpty(strA) || !strA.equals(strM)) {
                            try {
                                new com.tkay.expressad.d.a.a(contextD).a(strM, (com.tkay.expressad.foundation.g.f.h.b) null, new 1(strM));
                            } catch (Exception e2) {
                                e2.getMessage();
                            }
                        }
    ...
    static void b(b bVar, String str) {
        new Thread(bVar.new 2(str)).start();
    }
}
