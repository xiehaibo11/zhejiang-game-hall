...
public final class a {
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                try {
                    ...
                    aVar2.aT = jSONObject.optInt(com.tkay.expressad.d.a.b.cz, 21600);
                    ...
                    aVar2.a = jSONObject.optInt(com.tkay.expressad.d.a.b.cO, 0);
    ...
    */
                ...
                while (true) {
                    if (it.hasNext()) {
                        ...
                        if (!TextUtils.isEmpty(host) && host.contains(key)) {
                            ...
                            String strReplace2 = str2.replace("{gaid}", d.f());
                            if (strReplace2.contains(com.tkay.expressad.d.a.b.I)) {
                                strReplace = d.d(context) != null ? strReplace2.replace(com.tkay.expressad.d.a.b.I, d.d(context)) : strReplace2;
                            } else if (strReplace2.contains(com.tkay.expressad.d.a.b.H) && d.e(context) != null) {
                                strReplace = strReplace2.replace(com.tkay.expressad.d.a.b.H, d.e(context));
                            }
                        }
                    }
                }
    ...
    private static Map<String, a> y(String str) {
        try {
            if (TextUtils.isEmpty(str)) {
                return null;
            }
    ...
    public static class b {
        ...
        public static b a(JSONObject jSONObject) {
            ...
            bVar.a = jSONObject.optString("title", contextF.getString(i.a(contextF, "tkay_cm_feedback_dialog_title", i.g)));
    ...
    public final String R() {
        try {
            ...
            jSONObject.put(com.tkay.expressad.d.a.b.cO, this.a);
