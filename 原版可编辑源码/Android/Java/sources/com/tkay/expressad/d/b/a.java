...
public class a {
    ...
    private void a(Context context, final String str) {
        ...
        String strA = com.tkay.expressad.foundation.a.a.a.a().a(a);
        if (TextUtils.isEmpty(strA) || !strA.equals(str)) {
            try {
                new com.tkay.expressad.d.a.a(context).a(str, (com.tkay.expressad.foundation.g.f.h.b) null, new com.tkay.expressad.foundation.g.f.b.b() {
                    @Override
                    public final void f() {
                    }
                    ...
                    public final void a(String str2) {
                        ...
                        a.this.d = str2;
                        a.b(a.this, str2);
                        com.tkay.expressad.foundation.a.a.a.a().a(a.a, str);
                    }
                });
            } catch (Exception e) {
                e.getMessage();
    ...
    final class 2 implements Runnable {
        ...
        public final void run() throws Throwable {
            try {
                File file = new File(f.b(c.k), "mraid_js.txt");
                if (file.exists()) {
                    file.delete();
                }
    ...
    private void a(String str) {
        com.tkay.core.common.l.b.a.a().a(new 2(str));
    }
    ...
    static void b(a aVar, String str) {
        com.tkay.core.common.l.b.a.a().a(aVar.new 2(str));
    }
}
