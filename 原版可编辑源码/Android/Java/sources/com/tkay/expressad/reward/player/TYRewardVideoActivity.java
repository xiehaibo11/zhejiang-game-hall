...
public class TYRewardVideoActivity extends AbstractJSActivity {
    ...
    private int W = 0;
    private int X = 0;
    private com.tkay.expressad.video.dynview.f.a Y = new com.tkay.expressad.video.dynview.f.a() {
        @Override
    ...
    private com.tkay.expressad.video.dynview.f.d Z = new com.tkay.expressad.video.dynview.f.d() {
        @Override
    ...
    static int b(TYRewardVideoActivity tYRewardVideoActivity) {
        int i2 = tYRewardVideoActivity.R;
        tYRewardVideoActivity.R = i2 + 1;
        return i2;
    }

    static int b(TYRewardVideoActivity tYRewardVideoActivity, int i2) {
        int i3 = tYRewardVideoActivity.S - i2;
        tYRewardVideoActivity.S = i3;
        return i3;
    }

    static boolean f(TYRewardVideoActivity tYRewardVideoActivity) {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        try {
            ...
            a.a aVarA = com.tkay.expressad.videocommon.a.a(this.q + "_" + this.O + "_" + strAr);
    ...
    private static WindVaneWebView a(String str) {
        a.a aVarA = com.tkay.expressad.videocommon.a.a(str);
        if (aVarA != null) {
            return aVarA.a();
        }
        return null;
    ...
    private com.tkay.expressad.video.bt.module.a.a d() {
        if (this.N == null) {
            this.N = new com.tkay.expressad.video.bt.module.a.a() {
                @Override
                public final void a() {
    ...
    protected void onStart() {
        super.onStart();
        new com.tkay.expressad.foundation.f.a() {
            @Override
            public final void a() {
    ...
    private static final class a implements Runnable {
        private final List<com.tkay.expressad.videocommon.b.a> a;
        ...
        public final void run() {
            try {
                ...
                for (com.tkay.expressad.videocommon.b.a aVar : this.a) {
    ...
    public final void a(int i2, int i3, int i4, int i5, int i6) {
        ...
        com.tkay.expressad.video.dynview.a.b.a = i3;
