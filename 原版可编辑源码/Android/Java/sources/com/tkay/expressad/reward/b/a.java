...
public class a implements g {
    ...
    private final class d implements h {
        ...
        d(a aVar, a aVar2, Handler handler) {
    ...
    private final class c {
        ...
        c(a aVar, com.tkay.expressad.videocommon.d.a aVar2, Handler handler, String str, byte b2) {
    ...
    */
    public final void a(Activity activity, String str, String str2, String str3, i iVar) {
        Map<String, Integer> mapI;
        try {
            this.v = str;
            this.r = str2;
        ...
        synchronized (this.S) {
            if (this.R) {
                if (this.p != null) {
                    try {
                        this.p.b(com.tkay.expressad.foundation.g.b.b.g);
                    } catch (Exception e2) {
                        if (com.tkay.expressad.b.a) {
                            e2.printStackTrace();
                        }
            ...
            if (this.q != null && this.q.h.get() == 1) {
                if (this.p != null) {
                    try {
                        this.p.b(com.tkay.expressad.foundation.g.b.b.c);
                    } catch (Exception e3) {
                        if (com.tkay.expressad.b.a) {
                            e3.printStackTrace();
                        }
            ...
            if (this.k == null) {
                if (this.p != null) {
                    try {
                        this.p.b(com.tkay.expressad.foundation.g.b.b.a);
                    } catch (Exception e4) {
                        if (com.tkay.expressad.b.a) {
                            e4.printStackTrace();
                        }
            ...
            if (this.J && !t.b(this.k)) {
                if (this.p != null) {
                    try {
                        this.p.b(com.tkay.expressad.foundation.g.b.b.d);
                    } catch (Exception e5) {
                        if (com.tkay.expressad.b.a) {
                            e5.printStackTrace();
                        }
            ...
            try {
                ...
                String str5 = (String) v.b(this.k, com.tkay.expressad.foundation.g.a.bK, "0");
                if (!TextUtils.isEmpty(str5) && !TextUtils.isEmpty(str4) && !str5.equals(str4)) {
                    v.a(this.k, com.tkay.expressad.foundation.g.a.bK, str4);
    ...
    public class a implements Runnable {
        ...
        public a(com.tkay.expressad.reward.a.a aVar) {
            this.b = aVar;
        }
