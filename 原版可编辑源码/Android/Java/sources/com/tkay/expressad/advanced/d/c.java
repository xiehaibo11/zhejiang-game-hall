...
public class c implements g {
    ...
    private ViewTreeObserver.OnScrollChangedListener J = new ViewTreeObserver.OnScrollChangedListener() {
        @Override
        public final void onScrollChanged() {
            if (c.this.I) {
                c.this.I = false;
                if (c.this.E != null) {
                    c.this.E.postDelayed(new Runnable() {
                        @Override
    ...
    private void g() {
        ...
        if (cVarArr[0] != null) {
            ...
            this.e = true;
            com.tkay.expressad.advanced.c.c.a(this.o, cVarArr[0], this.i, this.h, this.t, new c.a() {
                @Override
                public final void a() {
                    String unused = c.g;
