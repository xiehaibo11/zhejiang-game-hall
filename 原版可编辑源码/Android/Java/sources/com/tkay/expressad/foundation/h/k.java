...
public final class k extends d {
        ...
        try {
            ...
            try {
                ...
                if (com.tkay.expressad.foundation.g.h.a.b().getActiveCount() <= 0) {
                    com.tkay.expressad.foundation.g.h.a.b().execute(r2);
                }
            } catch (Throwable th2) {
                th2.getMessage();
            }
    ...
    final class 2 implements Runnable {
        ...
        public final void run() {
            ...
            try {
                ...
                try {
                    if (!com.tkay.core.common.b.p.a(com.tkay.core.common.b.m.a().f()).b() || this.a == null || (connectivityManager = (ConnectivityManager) this.a.getSystemService("connectivity")) == null) {
                        return;
                    }
    ...
    private static void l(Context context) {
        try {
            2 r0 = new 2(context);
            if (com.tkay.expressad.foundation.g.h.a.b().getActiveCount() <= 0) {
                com.tkay.expressad.foundation.g.h.a.b().execute(r0);
            }
        } catch (Throwable th) {
            th.getMessage();
        }
