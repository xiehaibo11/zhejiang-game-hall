...
public final class a {
    ...
    private int o = n;
    private com.tkay.expressad.widget.a.c r = new com.tkay.expressad.widget.a.c() {
        @Override
        public final void a() {
            a.a(a.this);
        }
    ...
    private void g() {
        if (this.r == null) {
            this.r = new com.tkay.expressad.widget.a.c() {
                @Override
                public final void a() {
                    a.a(a.this);
                }
    ...
    public static class a implements com.tkay.expressad.widget.a.c {
        ...
        public a(String str, com.tkay.expressad.foundation.f.a aVar) {
            this.a = aVar;
            this.b = str;
        }
        ...
        public final void a() {
            b.c = false;
            com.tkay.expressad.foundation.f.a aVar = this.a;
            if (aVar != null) {
                String unused = a.s;
                aVar.c();
            }
