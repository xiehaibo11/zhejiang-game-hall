...
public abstract class r extends com.tkay.expressad.exoplayer.a implements com.tkay.expressad.exoplayer.k.n {
    ...
    */
    public final void a(long j, long j2) throws com.tkay.expressad.exoplayer.g {
        ...
        if (this.x == null) {
            ...
            if (iA != -5) {
                if (iA == -4) {
                    com.tkay.expressad.exoplayer.k.a.b(this.v.c());
                    this.L = true;
                    E();
                    return;
                }
            ...
            try {
                ...
                do {
                    if (this.A == null || this.F == 2 || this.L) {
                        ...
                        com.tkay.expressad.exoplayer.c.e eVarB = this.A.b();
                        this.B = eVarB;
                        if (eVarB != null) {
                            if (this.F == 1) {
                                this.B.a(4);
                                ...
                                if (iA2 != -3) {
                                    if (iA2 == -5) {
                                        ...
                                        boolean zG = this.B.g();
                                        if (this.D == null || (!zG && this.r)) {
                                            z3 = false;
                                            this.N = z3;
                                            if (z3) {
                                                this.B.h();
                                                com.tkay.expressad.exoplayer.c.e eVar = this.B;
                                                if (this.J && !eVar.b()) {
    ...
    */
    private boolean D() throws com.tkay.expressad.exoplayer.g {
        ...
        if (this.B == null) {
            com.tkay.expressad.exoplayer.c.e eVarB = gVar.b();
            this.B = eVarB;
            if (eVarB == null) {
                return false;
            }
