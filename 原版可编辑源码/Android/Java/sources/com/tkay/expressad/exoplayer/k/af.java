...
public final class af {
    ...
    public static boolean a(Uri uri) {
        ...
        return TextUtils.isEmpty(scheme) || com.sigmob.sdk.base.h.x.equals(scheme);
    }
    ...
    public static void a(com.tkay.expressad.exoplayer.j.h hVar) {
        if (hVar != null) {
            try {
                hVar.b();
    ...
    private static long j(String str) throws com.tkay.expressad.exoplayer.t {
        Matcher matcher = g.matcher(str);
        if (!matcher.matches()) {
            throw new com.tkay.expressad.exoplayer.t("Invalid date/time format: ".concat(String.valueOf(str)));
        }
        int i2 = 0;
    ...
    public static long a(long j2, com.tkay.expressad.exoplayer.ac acVar, long j3, long j4) {
        if (com.tkay.expressad.exoplayer.ac.a.equals(acVar)) {
            return j2;
        }
        long j5 = acVar.f;
        long j6 = j2 - j5;
        ...
        return (z && z2) ? Math.abs(j3 - j2) <= Math.abs(j4 - j2) ? j3 : j4 : z ? j3 : z2 ? j4 : j6;
    }
    ...
    */
    private static UUID k(String str) {
        ...
        if (iHashCode != -1860423953) {
            if (iHashCode != -1400551171) {
                b2 = (iHashCode == 790309106 && strD.equals("clearkey")) ? (byte) 2 : (byte) -1;
            } else if (strD.equals("widevine")) {
                b2 = 0;
            }
        } else if (strD.equals("playready")) {
            b2 = 1;
        }
        if (b2 == 0) {
            return com.tkay.expressad.exoplayer.b.bk;
        }
        if (b2 == 1) {
            return com.tkay.expressad.exoplayer.b.bl;
        }
        if (b2 == 2) {
            return com.tkay.expressad.exoplayer.b.bj;
        }
        try {
    ...
    private static String a(StringBuilder sb, Formatter formatter, long j2) {
        ...
        long j4 = j3 % 60;
        long j5 = (j3 / 60) % 60;
        long j6 = j3 / com.tkay.expressad.d.a.b.P;
        sb.setLength(0);
