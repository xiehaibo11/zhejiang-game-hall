...
final class f {
        ...
        try {
            ...
            if (i2 == m) {
                ...
                if (sVar.i() == a.aK) {
                    ...
                    if (str2 == null) {
                        Log.w(a, "Unrecognized cover art flags: ".concat(String.valueOf(iB)));
                    } else {
                        sVar.d(4);
                        int i7 = i6 - 16;
    ...
    */
    private static com.tkay.expressad.exoplayer.g.b.k b(s sVar) {
        String str;
        int iD = d(sVar);
        if (iD > 0) {
            String[] strArr = E;
        ...
        if (str != null) {
            return new com.tkay.expressad.exoplayer.g.b.k("TCON", null, str);
        }
        Log.w(a, "Failed to parse standard genre code");
        return null;
    }
