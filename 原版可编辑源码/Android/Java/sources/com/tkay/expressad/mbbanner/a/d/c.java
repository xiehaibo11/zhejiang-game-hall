...
public final class c {
    ...
    private com.tkay.expressad.foundation.g.g.a y = new com.tkay.expressad.foundation.g.g.a() {
        @Override
        public final void b() {
        }
    ...
    private com.tkay.expressad.mbbanner.a.c.a C = new com.tkay.expressad.mbbanner.a.c.a() {
        @Override
    ...
    private com.tkay.expressad.atsignalcommon.a.b D = new com.tkay.expressad.atsignalcommon.a.b() {
        @Override
    ...
    private void e() {
        if (this.g != null) {
            ...
            if (!TextUtils.isEmpty(strBe)) {
                com.tkay.expressad.foundation.g.d.b.a(m.a().f()).a(strBe, new com.tkay.expressad.foundation.g.d.c() {
                    @Override
    ...
    private void h() {
        ...
        if (this.m && this.k && this.l && this.n && this.f != null && !i()) {
            ...
            if (!z && (templateBannerView = this.g) != null) {
                templateBannerView.postDelayed(new Runnable() {
                    @Override
    ...
    public final void a(com.tkay.expressad.foundation.d.c cVar, boolean z, String str) {
        if (this.q) {
            if (this.a == null) {
                this.a = new com.tkay.expressad.a.a(m.a().f(), this.r);
            }
            this.a.a(new j.e() {
                @Override
    ...
    private void d(boolean z) {
        if (this.g != null) {
            ...
            com.tkay.expressad.foundation.f.b.a().a(this.r, new com.tkay.expressad.foundation.f.a() {
                @Override
                public final void a() {
                    String string;
                    c.this.g.onPause();
    ...
    */
    public final void a(com.tkay.expressad.foundation.d.d dVar) throws Throwable {
        ...
        if (!TextUtils.isEmpty(strA)) {
            if (this.g != null) {
                ...
                l();
                com.tkay.expressad.mbbanner.a.a.c cVar2 = new com.tkay.expressad.mbbanner.a.a.c(this.g.getContext(), this.s, this.r);
                this.w = cVar2;
                cVar2.a(this.t);
                this.w.a(this.C);
                this.w.a(this.u);
