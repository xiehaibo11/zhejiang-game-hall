...
public class LoadingActivity extends Activity {
    ...
    private com.tkay.expressad.foundation.g.d.c g = new com.tkay.expressad.foundation.g.d.c() {
        @Override
    ...
    protected void onResume() {
        ...
        if (this.a != null) {
            com.tkay.core.common.b.j.a(this).a(this.a, intentFilter);
        }
    }
    ...
    protected void onDestroy() {
        if (this.a != null) {
            com.tkay.core.common.b.j.a(this).a(this.a);
        }
