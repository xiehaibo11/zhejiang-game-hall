...
public final class d {
    ...
    private com.tkay.expressad.splash.d.a x = new com.tkay.expressad.splash.d.a() {
        @Override
        public final void b() {
        }
    ...
    public final void a(com.tkay.expressad.foundation.d.c cVar, TYSplashView tYSplashView) {
        ...
        tYSplashView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
            @Override
        ...
        com.tkay.expressad.foundation.f.b.a().a(this.k, new 6());
    ...
    static boolean a(d dVar, View view) {
