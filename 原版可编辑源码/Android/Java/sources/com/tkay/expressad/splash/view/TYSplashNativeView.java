...
public class TYSplashNativeView extends RelativeLayout {
    ...
    static boolean a(TYSplashNativeView tYSplashNativeView) {
    ...
    public TYSplashNativeView(Context context, TYSplashView tYSplashView, com.tkay.expressad.splash.a.b bVar) {
        ...
        if (com.tkay.expressad.foundation.f.b.a().b()) {
            this.M.l(this.J);
            com.tkay.expressad.foundation.f.b.a().a(this.J, new 11());
        ...
        if (!TextUtils.isEmpty(this.M.be())) {
            com.tkay.expressad.foundation.g.d.b.a(m.a().f()).a(this.M.be(), new 1());
        } else {
        ...
        if (this.u == 1) {
            setOnClickListener(new 6());
        } else {
            this.r.setOnClickListener(new 7());
        }
        this.p.setOnClickListener(new 8());
        this.q.setOnClickListener(new 9());
        this.g.setOnClickListener(new 10());
        if (this.x == 1) {
            ...
            this.R = new 3(this.y, this.z * 1000);
        }
    ...
    private void d() {
        if (!TextUtils.isEmpty(this.M.bd())) {
            com.tkay.expressad.foundation.g.d.b.a(m.a().f()).a(this.M.bd(), new 4());
        } else {
    ...
    final class 9 implements View.OnClickListener {
        9() {
        }
    ...
    final class 10 implements View.OnClickListener {
        10() {
        }
    ...
    static void h(TYSplashNativeView tYSplashNativeView) {
        if (!TextUtils.isEmpty(tYSplashNativeView.M.bd())) {
            com.tkay.expressad.foundation.g.d.b.a(m.a().f()).a(tYSplashNativeView.M.bd(), tYSplashNativeView.new 4());
        } else {
            tYSplashNativeView.i.setVisibility(4);
        }
    }

    static void a(TYSplashNativeView tYSplashNativeView, int i) {
    ...
    static void b(TYSplashNativeView tYSplashNativeView, boolean z) {
        if (tYSplashNativeView.L.getSplashJSBridgeImpl() == null || tYSplashNativeView.L.getSplashJSBridgeImpl().getSplashBridgeListener() == null) {
            return;
        }
