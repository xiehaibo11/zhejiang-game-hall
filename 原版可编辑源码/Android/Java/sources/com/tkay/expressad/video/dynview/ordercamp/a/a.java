...
public final class a extends BaseAdapter {
    ...
    private View b() {
        ...
        a aVar = new a();
        this.c = aVar;
        aVar.c = (TYImageView) viewInflate.findViewById(b(f));
    ...
    private void a(final ImageView imageView, String str, final boolean z) {
        ...
        if (!TextUtils.isEmpty(str)) {
            b.a(imageView.getContext()).a(str, new com.tkay.expressad.foundation.g.d.c() {
                @Override
        ...
        if (this.c != null) {
            ...
            if (this.c.j != null) {
                try {
                    ...
                    b.a(contextF).a(cVar.aE(), new 2(contextF));
                } catch (Exception e2) {
                    e2.getMessage();
                }
            }
