...
public class TkayBTNativeEC extends BTBaseView {
    ...
    static boolean a(TkayBTNativeEC tkayBTNativeEC) {
    ...
    public void preLoadData() {
        ...
        try {
            ...
            b.a(this.a.getApplicationContext()).a(this.b.bd(), new com.tkay.expressad.video.module.a.a.j(this.w, t.b(com.tkay.expressad.foundation.b.b.b().d(), 8.0f)));
            ...
            b.a(this.a.getApplicationContext()).a(TextUtils.isEmpty(this.b.aE()) ? com.tkay.expressad.b.ab : this.b.aE(), new c() {
                @Override
                ...
                public final void a(Bitmap bitmap, String str) {
                    ...
                    try {
                        int iB = t.b(TkayBTNativeEC.this.a, 12.0f);
            ...
            if (aVarB != null) {
                ...
                this.y.setOnClickListener(new View.OnClickListener() {
                    ...
                    public final void onClick(View view) {
                        l.a(TkayBTNativeEC.this.a, strJ);
                    }
                });
            } else {
                this.y.setVisibility(8);
    ...
    protected final void a() {
        if (this.h) {
            ...
            this.I.setOnClickListener(new com.tkay.expressad.widget.a() {
                @Override
            ...
            this.v.setOnClickListener(new com.tkay.expressad.widget.a() {
                @Override
                protected final void a(View view) {
                    TkayBTNativeEC.a(TkayBTNativeEC.this, 0);
                    TkayBTNativeEC.a(TkayBTNativeEC.this, view.getX(), view.getY());
    ...
    static void a(TkayBTNativeEC tkayBTNativeEC, int i) {
        JSONObject jSONObject;
        JSONObject jSONObject2 = null;
        try {
            try {
    ...
    static void a(TkayBTNativeEC tkayBTNativeEC, float f, float f2) {
