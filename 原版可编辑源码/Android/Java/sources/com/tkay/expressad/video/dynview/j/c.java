...
public final class c {
    ...
    public static com.tkay.expressad.video.dynview.c a(Context context, com.tkay.expressad.foundation.d.c cVar, int i) {
        ...
        try {
            return new c.a().a(k.b(context) == 1 ? com.tkay.expressad.video.dynview.a.a.b : com.tkay.expressad.video.dynview.a.a.a).a(4).a(context).b(k.b(context)).b("").e(cVar.k()).d(i).a();
        } catch (Exception e) {
            e.getMessage();
            return null;
        }
