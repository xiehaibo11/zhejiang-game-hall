...
public final class a {
    ...
    private void a(com.tkay.expressad.video.dynview.c cVar, final h hVar, Map<String, Object> map) {
        ...
        if (cVar == null) {
            hVar.a(com.tkay.expressad.video.dynview.c.b.a);
            return;
        }
        if (cVar.a() == null) {
            hVar.a(com.tkay.expressad.video.dynview.c.b.b);
            return;
        }
        if (TextUtils.isEmpty(cVar.b())) {
            hVar.a(com.tkay.expressad.video.dynview.c.b.c);
            return;
        }
        ...
        com.tkay.expressad.video.dynview.b.a.a().a(viewInflate, cVar, map, new e() {
            @Override
