    ...
    public void preLoadData(b bVar) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(this.b.bd()) && this.p != null) {
                com.tkay.expressad.foundation.g.d.b.a(this.a.getApplicationContext()).a(this.b.bd(), new j(this.p, t.b(m.a().f(), 8.0f)));
            }
            if (this.r != null) {
    ...
    private void e() {
        ...
        if (this.b != null) {
            if (!TextUtils.isEmpty(this.b.bd()) && (imageView = this.p) != null) {
                com.tkay.expressad.foundation.g.d.b.a(this.a.getApplicationContext()).a(this.b.bd(), new j(imageView, t.b(m.a().f(), 8.0f)));
            }
