...
public class BaseVideoBridge extends AbsFeedBackForH5 implements IVideoBridge {
    ...
    public void init(Object obj, String str) {
        try {
            ...
            if (obj != null) {
                a aVar = (a) obj;
                if (aVar.a.getObject() instanceof com.tkay.expressad.video.signal.a.j) {
                    com.tkay.expressad.video.signal.a.j jVar = (com.tkay.expressad.video.signal.a.j) aVar.a.getObject();
                    String strI2 = jVar.i();
                    if (!TextUtils.isEmpty(str)) {
    ...
    public void click(Object obj, String str) {
        ...
        try {
            ...
            if (obj != null) {
                a aVar = (a) obj;
                if (!(aVar.a.getObject() instanceof com.tkay.expressad.video.signal.a.j) || (jVar = (com.tkay.expressad.video.signal.a.j) aVar.a.getObject()) == null) {
                    return;
                }
    ...
    public void handlerH5Exception(Object obj, String str) {
        try {
            ...
            JSONObject jSONObject = new JSONObject(str);
            this.i.getJSCommon().handlerH5Exception(jSONObject.optInt("code", com.tkay.expressad.video.bt.a.c.a), jSONObject.optString("message", "h5 error"));
        } catch (Throwable unused) {
        }
    }
    ...
    public void readyStatus(Object obj, String str) {
        if (obj != null) {
            try {
                ...
                if (aVar.a.getObject() instanceof com.tkay.expressad.video.signal.a.j) {
                    ((com.tkay.expressad.video.signal.a.j) aVar.a.getObject()).j(iOptInt);
                }
                if (aVar.a != null) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                if (this.i != null) {
                    ...
                    while (i < jSONArray.length()) {
                        ...
                        a aVar = (a) obj;
                        if (aVar.a.getObject() instanceof com.tkay.expressad.video.signal.a.j) {
                            jSONObject.put(a(i3), ((com.tkay.expressad.video.signal.a.j) aVar.a.getObject()).h(i3));
                        }
                        i++;
                    }
                }
    ...
    */
    public void setCacheItem(Object obj, String str) {
        ...
        try {
            sharedPreferences = m.a().f().getSharedPreferences(com.tkay.expressad.foundation.g.a.p, 0);
        } catch (Throwable th) {
