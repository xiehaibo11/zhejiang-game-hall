...
public class TkayBTContainer extends AbstractJSContainer implements b {
    ...
    public void onCreate() {
        ...
        try {
            ...
            a.a aVarA = com.tkay.expressad.videocommon.a.a(this.m + "_" + this.N + "_" + strAr);
            ...
            if (this.i != null) {
                ...
                if (linkedHashMapB != null && linkedHashMapB.containsKey(this.E)) {
                    ...
                    if (view instanceof TkayBTLayout) {
                        ...
                        com.tkay.expressad.foundation.f.b.a().a(this.m + "_1", new com.tkay.expressad.foundation.f.a() {
                            @Override
                            public final void a() {
                                String string;
                                try {
            ...
            if (this.G != null && this.G.size() > 0 && (cVar = this.G.get(0)) != null && cVar.j()) {
                ...
                com.tkay.expressad.video.dynview.b.a(context, this.G, new 2(), map);
                return;
            }
    ...
    private com.tkay.expressad.video.bt.module.a.b c() {
        if (this.L == null) {
            this.L = new com.tkay.expressad.video.bt.module.a.b() {
                @Override
                public final void a() {
                }
    ...
    private class a extends c.a {
        ...
        a(TkayBTContainer tkayBTContainer, byte b) {
            this();
        }
