...
public class TkayBTVideoView extends BTBaseView {
    ...
    private static final class a extends DefaultVideoPlayerStatusListener {
        ...
        public final void onPlayCompleted() {
            ...
            if (this.a.b == null || this.a.b.i() <= 0) {
                this.a.s.setText("0");
            } else {
                this.a.s.setText(i.a(m.a().f(), "tkay_reward_video_view_reward_time_complete", i.g));
            }
        ...
        public final void onPlayProgress(int i, int i2) {
            ...
            if (this.a.h) {
                ...
                if (i5 <= 0) {
                    strValueOf = i4 <= 0 ? "0" : (String) this.a.getContext().getResources().getText(i.a(m.a().f(), "tkay_reward_video_view_reward_time_complete", i.g));
                } else if (i4 <= 0) {
                    strValueOf = String.valueOf(i5);
                } else {
                    strValueOf = i5 + ((String) this.a.getContext().getResources().getText(i.a(m.a().f(), "tkay_reward_video_view_reward_time_left", i.g)));
                }
