...
public class TkayContainerView extends TkayBaseView implements e, h {
    ...
    public void showVideoEndCover() {
        ...
        if (tkayVideoEndCoverView == null) {
            ...
            this.Q = bVar;
            if (tkayVideoEndCoverView == null) {
                TkayVideoEndCoverView tkayVideoEndCoverView2 = new TkayVideoEndCoverView(this.a);
    ...
    public void showOrderCampView() {
        TYOrderCampView tYOrderCampView = new TYOrderCampView(this.a);
        ...
        this.R.setCampOrderViewBuildCallback(new com.tkay.expressad.video.dynview.f.b() {
            @Override
            public final void a() {
    ...
    final class 4 extends i {
        4(com.tkay.expressad.video.module.a.a aVar) {
            super(aVar);
        }
    ...
    private void o() {
        if (this.v == null) {
            TkayAlertWebview tkayAlertWebview = new TkayAlertWebview(this.a);
    ...
    private void b(b bVar) {
        this.Q = bVar;
        if (this.s == null) {
            TkayVideoEndCoverView tkayVideoEndCoverView = new TkayVideoEndCoverView(this.a);
    ...
    private void a(b bVar, Integer num) {
        ...
        if (this.b != null) {
            ...
            if (iIntValue != 1) {
                if (iIntValue == 3) {
                    if (this.t == null) {
                        this.t = new TkayVastEndCardView(this.a);
                    }
                ...
                if (iIntValue == 4) {
                    if (this.u == null) {
                        this.u = new TkayLandingPageView(this.a);
                    }
                ...
                if (iIntValue != 5) {
                    if (this.y == 2) {
                        ...
                        if ((this.b == null || !zJ || zF) && this.b.f() != 2) {
                            if (this.r == null) {
                                this.r = new TkayH5EndCardView(this.a);
                            }
                    ...
                    if (tkayNativeEndCardView == null && tkayNativeEndCardView == null) {
                        if (this.b.j()) {
                            ...
                            TkayNativeEndCardView tkayNativeEndCardView2 = new TkayNativeEndCardView(this.a, null, false, -1, this.b.f() == 2, iC, this.b.as());
    ...
    private void b(int i) {
        if (i != -3) {
            if (i == -2) {
                ...
                if (this.p == null) {
                    this.p = new TkayClickMiniCardView(this.a);
                }
            ...
            if (this.o == null) {
                this.o = new TkayClickCTAView(this.a);
            }
    ...
    private void q() {
        ...
        this.q = new TkayNativeEndCardView(this.a, null, true, i, this.b.f() == 2, this.l, this.b.as());
        if (this.b.k() == 5) {
            if (this.e != null && (this.e instanceof k)) {
                ((k) this.e).a(this.b);
            }
