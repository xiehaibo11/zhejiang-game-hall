...

{
  ...
  BIO_printf(param_2,"%*sSigned Certificate Timestamp:",(ulong)param_3,&DAT_013c996e);
  uVar1 = param_3 + 4;
  BIO_printf(param_2,"\n%*sVersion   : ",(ulong)uVar1,&DAT_013c996e);
  if (*param_1 != 0) {
    BIO_printf(param_2,"unknown\n%*s",(ulong)(param_3 + 0x10),&DAT_013c996e);
  ...
  if (lVar4 != 0) {
    ...
    BIO_printf(param_2,"\n%*sLog       : %s",(ulong)uVar1,&DAT_013c996e,uVar5);
  }
  BIO_printf(param_2,"\n%*sLog ID    : ",(ulong)uVar1,&DAT_013c996e);
  iVar2 = param_3 + 0x10;
  BIO_hex_string(param_2,iVar2,0x10,*(undefined8 *)(param_1 + 6),param_1[8]);
  BIO_printf(param_2,"\n%*sTimestamp : ",(ulong)uVar1,&DAT_013c996e);
  ...
  BIO_printf(param_2,"\n%*sExtensions: ",(ulong)uVar1,&DAT_013c996e);
  ...
  BIO_printf(param_2,"\n%*sSignature : ",(ulong)uVar1,&DAT_013c996e);
