...

{
  ...
  uVar9 = CONCAT17(POPCOUNT((char)(uVar3 >> 0x38)),
                   CONCAT16(POPCOUNT((char)(uVar3 >> 0x30)),
                    ...
                    /* try { // try from 00f4bf38 to 0104bf3b has its CatchHandler @ 00f4d514 */
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar6 < 2) {
      ...
      uVar7 = uVar7 - uVar1 * uVar3;
                    ...
                    /* try { // try from 00f4bfbc to 0104bfd3 has its CatchHandler @ 00f4d5b4 */
    if (uVar7 == uVar4) goto LAB_00f4c004;
  }
  if (*param_3 != 0) {
    ...
    if (uVar6 < 2) {
      ...
      uVar7 = uVar7 - uVar1 * uVar3;
                    /* try { // try from 00f4bfe4 to 0104bfeb has its CatchHandler @ 00f4d4dc */
    }
    if (uVar7 == uVar4) goto LAB_00f4c004;
  }
                    /* try { // try from 00f4c000 to 0104c007 has its CatchHandler @ 00f4d4d0 */
  ...
  if (*param_3 != 0) {
    ...
    if (uVar6 < 2) {
      ...
      uVar7 = uVar7 - uVar6 * uVar3;
                    /* try { // try from 00f4c02c to 0104c047 has its CatchHandler @ 00f4d5e8 */
    }
    if (uVar7 != uVar4) {
