...
undefined8 FUN_01145eec(uint param_1,int param_2,int param_3,undefined4 *param_4,long *param_5)

{
  ...
  if (param_3 == 0) {
LAB_01146134:
    iVar9 = FUN_0115f344(puVar3,1);
    if (iVar9 == 0) {
      uVar12 = 0;
    }
    else {
      uVar12 = FUN_0115f344(puVar3,4);
      if (10 < uVar12 - 1) goto LAB_01146980;
    }
    local_2b8 = (uint *)0x0;
    if (param_3 == 0) {
LAB_01146224:
...
joined_r0x01146210:
      ...
      __ptr = (byte *)WebPSafeMalloc((long)(int)uVar10 * (long)(int)(&DAT_01498864)[(int)uVar12],4);
      lVar35 = FUN_0115f4a0(uVar10);
...
LAB_011462f0:
          ...
          do {
            ...
            *(byte **)(lVar35 + lVar17 * 0x238 + lVar31 * 8) = pbVar18;
            ...
            uVar19 = (ulong)uVar30;
            iVar13 = FUN_0115f344(puVar3,1);
            memset(__s_00,0,-(ulong)(uVar30 >> 0x1f) & 0xfffffffc00000000 | uVar19 << 2);
            if (iVar13 == 0) {
              memset(auStack_2ac,0,0x4c);
              iVar13 = FUN_0115f344(puVar3,4);
              uVar33 = iVar13 + 4;
              if ((int)uVar33 < 0x14) {
                if (0 < (int)uVar33) {
                  uVar32 = (ulong)uVar33;
                  pbVar34 = &DAT_0149889e;
                  do {
                    uVar14 = FUN_0115f344(puVar3,3);
                    uVar32 = uVar32 - 1;
                    auStack_2ac[*pbVar34] = uVar14;
                    pbVar34 = pbVar34 + 1;
                  } while (uVar32 != 0);
                }
                iVar13 = FUN_0115f4b8(abStack_260,7,auStack_2ac,0x13);
                if (iVar13 != 0) {
                  iVar13 = FUN_0115f344(puVar3,1);
                  uVar32 = uVar19;
                  if (iVar13 != 0) {
                    iVar13 = FUN_0115f344(puVar3,3);
                    iVar13 = FUN_0115f344(puVar3,iVar13 * 2 + 2);
                    uVar32 = (ulong)(iVar13 + 2U);
                    if ((int)uVar30 < (int)(iVar13 + 2U)) goto LAB_0114694c;
                  }
                  if (0 < (int)uVar30) {
                    local_2e4 = 8;
                    uVar36 = 0;
                    ...
                    do {
                      while( true ) {
                        ...
                        if ((int)uVar30 <= (int)(iVar13 + 1U)) goto LAB_01146668;
                      }
                      uVar25 = uVar8 - 0x10;
                      uVar22 = -(ulong)(uVar25 >> 0x1f) & 0xfffffffc00000000 | (ulong)uVar25 << 2;
                      iVar11 = *(int *)(&DAT_014988c0 + uVar22);
                      iVar15 = FUN_0115f344(puVar3,*(undefined4 *)(&DAT_014988b4 + uVar22));
                      uVar25 = iVar15 + iVar11;
                      if ((int)uVar30 < (int)(uVar25 + iVar13)) goto LAB_0114694c;
                      uVar6 = local_2e4;
                      if (uVar24 != 0x10) {
                        uVar6 = 0;
                      }
...
LAB_01146958:
            ...
            iVar13 = FUN_0115f344(puVar3,1);
            iVar11 = FUN_0115f344(puVar3,1);
            uVar14 = 8;
            if (iVar11 == 0) {
              uVar14 = 1;
            }
            iVar11 = FUN_0115f344(puVar3,uVar14);
            __s_00[iVar11] = 1;
            if (iVar13 == 1) {
              iVar13 = FUN_0115f344(puVar3,8);
              __s_00[iVar13] = 1;
              iVar13 = param_4[0x13];
            }
            else {
LAB_01146668:
            ...
            if ((iVar13 != 0) || (iVar13 = FUN_0115f4b8(pbVar18,8,__s_00,uVar19), iVar13 == 0))
            goto LAB_01146958;
            if (local_300 == 0) {
              local_300 = 0;
            }
...
LAB_01146a3c:
            ...
            if (param_3 == 0) {
              ...
              FUN_0115f4ac(*(undefined8 *)(param_4 + 0x38));
              FUN_0115f458(param_4 + 0x28);
              FUN_0115f458(param_4 + 0x2c);
              memset(__s,0,0x58);
            }
            return 1;
          }
          ...
          if (__ptr_00 != (void *)0x0) {
            iVar9 = FUN_011473d4(param_4,__ptr_00,param_1,param_2,param_2,0);
            if ((iVar9 != 0) && (param_4[0x13] == 0)) goto LAB_01146a3c;
            goto LAB_01146990;
          }
        }
        else {
          param_4[0x26] = iVar9;
          iVar9 = FUN_0115f40c(param_4 + 0x28);
          if (iVar9 != 0) goto LAB_011469fc;
          __ptr_00 = (void *)0x0;
        }
        *param_4 = 1;
        goto LAB_01146990;
...
LAB_0114620c:
        iVar9 = param_4[0x13];
        goto joined_r0x01146210;
      }
      iVar9 = FUN_0115f344(puVar3,3);
      uVar10 = iVar9 + 2;
      iVar9 = 1 << (ulong)(uVar10 & 0x1f);
      uVar30 = (param_1 + iVar9) - 1 >> (ulong)(uVar10 & 0x1f);
      uVar33 = (param_2 + iVar9) - 1U >> (ulong)(uVar10 & 0x1f);
      iVar9 = FUN_01145eec(uVar30,uVar33,0,param_4,&local_2b8);
      if (iVar9 != 0) {
        uVar30 = uVar30 * uVar33;
        param_4[0x31] = uVar10;
        if ((int)uVar30 < 1) goto LAB_01146224;
        uVar19 = (ulong)uVar30;
        uVar10 = 1;
        puVar20 = local_2b8;
        do {
...
LAB_01146214:
    ...
    do {
      while( true ) {
        iVar9 = FUN_0115f344(puVar3,1);
        if (iVar9 == 0) goto LAB_01146134;
        lVar35 = (long)(int)param_4[0x3c];
        uVar10 = FUN_0115f344(puVar3,2);
        uVar12 = 1 << (ulong)(uVar10 & 0x1f);
        if ((param_4[0x56] & uVar12) != 0) goto LAB_01146980;
        ...
        *(undefined8 *)(param_4 + lVar35 * 6 + 0x42) = 0;
        ...
        if (uVar10 == 3) {
          ...
          iVar11 = FUN_01145eec(iVar9,1,0,param_4,puVar4);
          if (iVar11 == 0) goto LAB_01146980;
          iVar11 = 1 << (ulong)(8U >> (ulong)(param_4[lVar35 * 6 + 0x3f] & 0x1f) & 0x1f);
          puVar16 = (undefined4 *)WebPSafeMalloc((long)iVar11,4);
          if (puVar16 == (undefined4 *)0x0) goto LAB_01146980;
      ...
      iVar9 = 1 << (ulong)(uVar12 & 0x1f);
      iVar9 = FUN_01145eec((param_4[lVar35 * 6 + 0x40] + iVar9) - 1U >> (ulong)(uVar12 & 0x1f),
...
LAB_011468e8:
  ...
  if ((int)uVar10 <= lVar17) goto LAB_01146904;
  goto LAB_011462f0;
}
