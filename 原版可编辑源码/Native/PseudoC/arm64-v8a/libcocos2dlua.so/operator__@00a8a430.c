...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void (fairygui::GRoot::*)(int),
   ...
   std::__ndk1::placeholders::__ph<1> const&> >, void (int)>::TEMPNAMEPLACEHOLDERVALUE(int&&) */
...
::operator()(__func<std::__ndk1::__bind<void(fairygui::GRoot::*)(int),fairygui::GRoot*,std::__ndk1::placeholders::__ph<1>const&>,std::__ndk1::allocator<std::__ndk1::__bind<void(fairygui::GRoot::*)(int),fairygui::GRoot*,std::__ndk1::placeholders::__ph<1>const&>>,void(int)>
             *this,int *param_1)

{
  ...
  if ((*(ulong *)(this + 0x10) & 1) != 0) {
    UNRECOVERED_JUMPTABLE = *(code **)(UNRECOVERED_JUMPTABLE + *plVar1);
                    ...
                    /* WARNING: Could not recover jumptable at 0x00a8a44c. Too many branches */
