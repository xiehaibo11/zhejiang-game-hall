...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::ui::LayoutParameter*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::LayoutParameter*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::LayoutParameter*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::ui::LayoutParameter*>>>
           *this,ulong param_1)

{
  ...
  if (param_1 == 0) {
                    /* try { // try from 00dadd24 to 00eadd33 has its CatchHandler @ 00dae30c */
    pvVar2 = *(void **)this;
    *(undefined8 *)this = 0;
    if (pvVar2 != (void *)0x0) {
      operator_delete(pvVar2);
    }
                    /* try { // try from 00dadd34 to 00eadd9b has its CatchHandler @ 00dad6f4 */
    *(undefined8 *)(this + 8) = 0;
  }
  else {
                    /* try { // try from 00dadcac to 00eadcbb has its CatchHandler @ 00dae310 */
    if (param_1 >> 0x3d != 0) {
                    /* WARNING: Subroutine does not return */
                    /* try { // try from 00dade14 to 00eade23 has its CatchHandler @ 00dae304 */
      FUN_007c2210("allocator<T>::allocate(size_t n) \'n\' exceeds maximum supported size");
    }
    pvVar2 = operator_new(param_1 << 3);
    pvVar3 = *(void **)this;
                    /* try { // try from 00dadcbc to 00eadd23 has its CatchHandler @ 00dad6f4 */
    *(void **)this = pvVar2;
    if (pvVar3 != (void *)0x0) {
      ...
      *(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::ui::LayoutParameter*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::LayoutParameter*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::LayoutParameter*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::ui::LayoutParameter*>>>
      ...
      if ((long *)*plVar5 != (long *)0x0) {
        ...
        do {
          ...
          if (uVar7 != uVar4) {
                    /* try { // try from 00dadd9c to 00eaddab has its CatchHandler @ 00dae308 */
            plVar9 = plVar6;
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) {
              *(long **)(*(long *)this + uVar7 * 8) = plVar5;
              ...
              do {
                    /* try { // try from 00daddac to 00eade13 has its CatchHandler @ 00dad6f4 */
                plVar8 = plVar9;
                plVar9 = (long *)*plVar8;
