          ...
          if (uVar9 == uVar7) {
            ...
            if ((bVar3 & 1) != 0) {
              sVar1 = plVar8[3];
                    ...
                    /* try { // try from 00fd60bc to 010d60c3 has its CatchHandler @ 00fd6180 */
            if (sVar1 == __n) {
              __s1 = (void *)plVar8[4];
              if ((bVar3 & 1) == 0) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                pbVar11 = pbVar2;
                    /* try { // try from 00fd60e4 to 010d60e7 has its CatchHandler @ 00fd6170 */
                    /* try { // try from 00fd60e8 to 010d619b has its CatchHandler @ 00fd6080 */
                while (*pbVar10 == *pbVar11) {
                  uVar9 = uVar9 - 1;
                  pbVar10 = pbVar10 + 1;
                  pbVar11 = pbVar11 + 1;
                  if (uVar9 == 0) goto LAB_00fd6144;
                }
              }
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00fd6090;
              goto LAB_00fd6140;
            }
            if (uVar9 != uVar14) goto LAB_00fd6140;
          }
LAB_00fd6090:
          plVar8 = (long *)*plVar8;
...
LAB_00fd6144:
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* catch() { ... } // from try @ 00fd60e4 with catch @ 00fd6170 */
    return plVar8;
  }
