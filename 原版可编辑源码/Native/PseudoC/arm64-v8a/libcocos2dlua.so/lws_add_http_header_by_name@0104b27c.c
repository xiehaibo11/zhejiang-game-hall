...

{
    ...
    for (; (pcVar2 < param_6 && (cVar1 = *param_2, cVar1 != '\0')); param_2 = param_2 + 1) {
      ...
      *pcVar2 = cVar1;
      pcVar2 = (char *)*param_5;
                    ...
                    /* try { // try from 0104b2c4 to 0114b2cb has its CatchHandler @ 0104b440 */
    if (pcVar2 == param_6) {
      return 1;
    }
    *param_5 = (long)(pcVar2 + 1);
  ...
  if (param_6 <= (char *)(*param_5 + __n + 3)) {
                    /* try { // try from 0104b33c to 0114b457 has its CatchHandler @ 0104b114 */
    return 1;
  }
  ...
  *puVar4 = 10;
                    /* try { // try from 0104b334 to 0114b33b has its CatchHandler @ 0104b41c */
  return 0;
}
