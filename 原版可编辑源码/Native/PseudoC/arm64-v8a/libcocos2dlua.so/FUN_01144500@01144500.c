...
bool FUN_01144500(long param_1,long param_2)

{
  ...
  if ((*(int *)(param_1 + 0xaf0) == 0) ||
    ...
    if (*(char *)((long)__s + 0x300) == '\0') {
      ...
      uStack_68 = 0;
      uStack_70 = 0;
      iVar24 = FUN_01144ed0(param_2,param_1 + 0x958,
    ...
    do {
      ...
      iVar20 = FUN_01144ed0(param_2,lVar33,(uVar34 & 1) + (uVar29 & 1),lVar1,iVar24,psVar3);
      sVar14 = *psVar3;
      uVar27 = uVar29 >> 1 & 1;
      if (iVar24 < iVar20) {
        uVar27 = uVar27 + 1;
      }
      iVar21 = FUN_01144ed0(param_2,lVar33,uVar27,lVar1,iVar24,psVar3 + 0x10);
      uVar27 = 8;
      if (iVar20 < 2) {
      ...
      iVar22 = FUN_01144ed0(param_2,lVar33,uVar6,lVar1,iVar24,psVar3 + 0x20);
      uVar27 = 2;
      if (iVar22 < 2) {
      ...
      iVar23 = FUN_01144ed0(param_2,lVar33,uVar29,lVar1,iVar24,psVar3 + 0x30);
      lVar32 = lVar32 + 0x80;
    ...
    iVar24 = FUN_01144ed0(param_2,lVar33,(bVar15 >> 4 & 1) + (bVar13 >> 4 & 1),lVar1,0,
                          lVar39 + 0x200);
    ...
    iVar20 = FUN_01144ed0(bVar18,param_2,lVar33,bVar13,lVar1,0,lVar39 + 0x220);
    uVar27 = 8;
    if (iVar24 < 2) {
      uVar27 = (uint)(sVar14 != 0) << 2;
    }
    ...
    iVar24 = FUN_01144ed0(param_2,lVar33,bVar15,lVar1,0,lVar39 + 0x240);
    uVar28 = 2;
    uVar27 = uVar28;
    if (iVar24 < 2) {
    ...
    iVar21 = FUN_01144ed0(param_2,lVar33,uVar27,lVar1,0,lVar39 + 0x260);
    bVar13 = *pbVar2;
    bVar15 = *(byte *)(lVar37 + -2);
    uVar28 = 2;
    uVar27 = uVar28;
    ...
    iVar22 = FUN_01144ed0(param_2,lVar33,(bVar15 >> 6 & 1) + (bVar13 >> 6 & 1),lVar1,0,
                          lVar39 + 0x280);
    ...
    iVar23 = FUN_01144ed0(cVar17,param_2,lVar33,cVar19,lVar1,0,lVar39 + 0x2a0);
    uVar27 = 8;
    if (iVar22 < 2) {
      uVar27 = (uint)(sVar14 != 0) << 2;
    }
    ...
    iVar22 = FUN_01144ed0(param_2,lVar33,cVar5,lVar1,0,lVar39 + 0x2c0);
    uVar31 = 2;
    uVar28 = uVar31;
    if (iVar22 < 2) {
    ...
    iVar25 = FUN_01144ed0(param_2,lVar33,uVar28,lVar1,0,lVar39 + 0x2e0);
