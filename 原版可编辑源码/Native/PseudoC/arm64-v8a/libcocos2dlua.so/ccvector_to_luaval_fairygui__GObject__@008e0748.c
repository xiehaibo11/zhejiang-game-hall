...
/* void ccvector_to_luaval<fairygui::GObject*>(lua_State*, cocos2d::Vector<fairygui::GObject*>
   const&) */

void ccvector_to_luaval<fairygui::GObject*>(lua_State *param_1,Vector *param_2)
