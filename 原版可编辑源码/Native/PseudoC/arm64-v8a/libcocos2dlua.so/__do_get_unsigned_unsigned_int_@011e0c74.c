...

{
  ...
  plVar10 = param_2;
  local_1b8 = pcVar11;
  if (param_2 != (long *)0x0) goto LAB_011e0d58;
LAB_011e0d6c:
  bVar3 = true;
  if (param_3 != (long *)0x0) goto LAB_011e0d98;
  do {
    param_3 = (long *)0x0;
    if (bVar3) {
LAB_011e0ec4:
      ...
      uVar6 = FUN_01208964(pcVar11,local_1b8,param_5,iVar7);
      *param_6 = uVar6;
      __check_grouping(local_198,local_178,local_1c0,param_5);
      if (param_2 == (long *)0x0) {
        bVar3 = true;
        if (param_3 == (long *)0x0) goto LAB_011e0f50;
LAB_011e0f78:
        ...
        if (bVar3 != (iVar7 == -1)) goto LAB_011e0fb8;
      }
      else {
        ...
        param_2 = plVar10;
        if (param_3 != (long *)0x0) goto LAB_011e0f78;
LAB_011e0f50:
        if (!bVar3) goto LAB_011e0fb8;
      }
      *param_5 = *param_5 | 2;
LAB_011e0fb8:
      if ((local_1b0 & 1) != 0) {
    ...
    while( true ) {
      ...
      iVar5 = __num_get<wchar_t>::__stage2_int_loop
                        (wVar4,iVar7,pcVar11,&local_1b8,&local_1c4,local_17c,local_198,local_178,
                         &local_1c0,(wchar_t *)aiStack_d8);
      if (iVar5 != 0) goto LAB_011e0ec4;
      ...
      plVar10 = param_2;
      if (param_2 == (long *)0x0) goto LAB_011e0d6c;
LAB_011e0d58:
