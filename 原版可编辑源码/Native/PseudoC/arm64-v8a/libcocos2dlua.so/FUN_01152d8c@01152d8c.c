...
void FUN_01152d8c(byte *param_1,byte *param_2,byte *param_3,byte *param_4,byte *param_5,
...

{
  ...
  uVar6 = uVar17 >> 0x12 & 0xff;
  uVar3 = (uint)*param_1 * 0x4a85 >> 8;
  uVar13 = (uVar3 + (uVar6 * 0x6625 >> 8)) - 0x379a;
  ...
  uVar13 = ((uVar3 + 0x2204) - (uVar17 * 0x1913 >> 8)) - (uVar6 * 0x3408 >> 8);
  *param_7 = cVar10;
  if (uVar13 >> 0xe == 0) {
    cVar10 = (char)(uVar13 >> 6);
  }
  ...
  if (param_2 != (byte *)0x0) {
    ...
    uVar13 = ((0x2204 - (uVar17 * 0x1913 >> 8)) - (uVar6 * 0x3408 >> 8)) + uVar3;
    *param_8 = cVar10;
    if (uVar13 >> 0xe == 0) {
      cVar10 = (char)(uVar13 >> 6);
    }
  ...
  if (0 < iVar2) {
    ...
    do {
      ...
      uVar3 = uVar4 + uVar17;
      uVar7 = uVar3 >> 0x11 & 0xff;
      uVar5 = (uint)pbVar9[1] * 0x4a85 >> 8;
      uVar6 = (uVar5 + (uVar7 * 0x6625 >> 8)) - 0x379a;
      ...
      uVar6 = ((uVar5 + 0x2204) - (uVar3 * 0x1913 >> 8)) - (uVar7 * 0x3408 >> 8);
      *pcVar1 = cVar10;
      if (uVar6 >> 0xe == 0) {
        cVar10 = (char)(uVar6 >> 6);
      }
      ...
      uVar3 = (uVar5 + (uVar3 * 0x811a >> 8)) - 0x4515;
      uVar6 = uVar17 + uVar11;
      pcVar1[1] = cVar10;
      if (uVar3 >> 0xe == 0) {
        cVar10 = (char)(uVar3 >> 6);
      ...
      pcVar1[2] = cVar10;
      pcVar1[3] = -1;
      uVar7 = uVar6 >> 0x11 & 0xff;
      uVar5 = (uint)pbVar9[2] * 0x4a85 >> 8;
      uVar3 = (uVar5 + (uVar7 * 0x6625 >> 8)) - 0x379a;
      ...
      uVar3 = ((0x2204 - (uVar6 * 0x1913 >> 8)) - (uVar7 * 0x3408 >> 8)) + uVar5;
      *pcVar1 = cVar10;
      if (uVar3 >> 0xe == 0) {
        cVar10 = (char)(uVar3 >> 6);
      }
      ...
      uVar3 = (uVar5 + (uVar6 * 0x811a >> 8)) - 0x4515;
      pcVar1[1] = cVar10;
      if (uVar3 >> 0xe == 0) {
        cVar10 = (char)(uVar3 >> 6);
      }
      ...
      if (param_2 != (byte *)0x0) {
        ...
        *pcVar1 = cVar10;
        ...
        pcVar1[2] = cVar10;
        pcVar1[3] = -1;
        uVar3 = uVar4 >> 0x11 & 0xff;
        pcVar1 = param_8 + (iVar16 + 4);
        uVar13 = (uint)pbVar8[2] * 0x4a85 >> 8;
        uVar17 = (uVar13 + (uVar3 * 0x6625 >> 8)) - 0x379a;
        uVar6 = uVar4 >> 1 & 0xff;
        if (uVar17 >> 0xe == 0) {
          cVar10 = (char)(uVar17 >> 6);
        }
        ...
        uVar17 = ((0x2204 - (uVar6 * 0x1913 >> 8)) - (uVar3 * 0x3408 >> 8)) + uVar13;
        *pcVar1 = cVar10;
        if (uVar17 >> 0xe == 0) {
          cVar10 = (char)(uVar17 >> 6);
        }
        ...
        uVar17 = (uVar13 + (uVar6 * 0x811a >> 8)) - 0x4515;
        pcVar1[1] = cVar10;
        if (uVar17 >> 0xe == 0) {
          cVar10 = (char)(uVar17 >> 6);
        }
  ...
  if (((long)param_9 & 1U) == 0) {
    ...
    *param_7 = cVar10;
    ...
    if (param_2 != (byte *)0x0) {
      ...
      uVar17 = uVar11 + 0x20002 + uVar12 * 3;
      uVar12 = uVar17 >> 0x12 & 0xff;
      uVar11 = (uint)param_2[lVar14] * 0x4a85 >> 8;
      uVar13 = (uVar11 + (uVar12 * 0x6625 >> 8)) - 0x379a;
      uVar17 = uVar17 >> 2 & 0xff;
      if (uVar13 >> 0xe == 0) {
        cVar10 = (char)(uVar13 >> 6);
      }
      ...
      uVar13 = ((0x2204 - (uVar17 * 0x1913 >> 8)) - (uVar12 * 0x3408 >> 8)) + uVar11;
      *param_8 = cVar10;
      if (uVar13 >> 0xe == 0) {
        cVar10 = (char)(uVar13 >> 6);
      }
      ...
      uVar17 = (uVar11 + (uVar17 * 0x811a >> 8)) - 0x4515;
      param_8[1] = cVar10;
      if (uVar17 >> 0xe == 0) {
        cVar10 = (char)(uVar17 >> 6);
      }
