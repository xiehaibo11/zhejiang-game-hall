...
undefined8 FUN_008e9a64(lua_State *param_1)

{
  ...
  if (iVar1 + -1 == 1) {
    if (((param_1 == (lua_State *)0x0) || (iVar1 = lua_gettop(param_1), iVar1 < 2)) ||
      ...
      tolua_error(param_1,"invalid arguments in function \'lua_fairygui_GRoot_hideWindow\'",0);
    }
    else {
      pWVar3 = (Window *)tolua_tousertype(param_1,2,0);
      fairygui::GRoot::hideWindow(this,pWVar3);
    }
  }
  else {
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "fairygui.GRoot:hideWindow",iVar1 + -1,1);
  }
  return 0;
}
