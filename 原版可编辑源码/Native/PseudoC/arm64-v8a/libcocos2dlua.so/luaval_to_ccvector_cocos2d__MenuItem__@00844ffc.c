...
/* bool luaval_to_ccvector<cocos2d::MenuItem*>(lua_State*, int,
   cocos2d::Vector<cocos2d::MenuItem*>*, char const*) */

bool luaval_to_ccvector<cocos2d::MenuItem*>
