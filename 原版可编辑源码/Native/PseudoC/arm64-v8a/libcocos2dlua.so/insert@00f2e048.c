...
/* std::__ndk1::vector<cocos2d::Node*, std::__ndk1::allocator<cocos2d::Node*>
   >::insert(std::__ndk1::__wrap_iter<cocos2d::Node* const*>, cocos2d::Node* const&) */

undefined8 * __thiscall
std::__ndk1::vector<cocos2d::Node*,std::__ndk1::allocator<cocos2d::Node*>>::insert
          (vector<cocos2d::Node*,std::__ndk1::allocator<cocos2d::Node*>> *this,undefined8 *param_2,
          undefined8 *param_3)

{
  ...
  puVar10 = *(undefined8 **)(this + 8);
                    /* catch() { ... } // from try @ 00f2dfbc with catch @ 00f2e068 */
  if (puVar10 < *(undefined8 **)(this + 0x10)) {
    if (param_2 != puVar10) {
      ...
      for (puVar5 = puVar10 + -1; puVar5 < puVar10; puVar5 = puVar5 + 1) {
        *puVar8 = *puVar5;
                    /* try { // try from 00f2e0a8 to 0102e0d7 has its CatchHandler @ 00f2e0a8
                       catch() { ... } // from try @ 00f2e0a8 with catch @ 00f2e0a8
                       catch() { ... } // from try @ 00f2e0e4 with catch @ 00f2e0a8 */
        puVar8 = puVar8 + 1;
      }
      *(undefined8 **)(this + 8) = puVar8;
      ...
      puVar10 = param_3;
                    /* try { // try from 00f2e0d8 to 0102e0e3 has its CatchHandler @ 00f2e0f4 */
      if ((param_2 <= param_3) && (puVar10 = param_3 + 1, *(undefined8 **)(this + 8) <= param_3)) {
        puVar10 = param_3;
      }
      *param_2 = *puVar10;
      return param_2;
                    /* try { // try from 00f2e0e4 to 0102e107 has its CatchHandler @ 00f2e0a8 */
    }
    *param_2 = *param_3;
  ...
  pvVar9 = *(void **)this;
                    /* catch() { ... } // from try @ 00f2e0d8 with catch @ 00f2e0f4 */
