...
/* void std::__ndk1::vector<cocos2d::Sprite3D*, std::__ndk1::allocator<cocos2d::Sprite3D*>
   >::__push_back_slow_path<cocos2d::Sprite3D* const&>(cocos2d::Sprite3D* const&) */

void __thiscall
std::__ndk1::vector<cocos2d::Sprite3D*,std::__ndk1::allocator<cocos2d::Sprite3D*>>::
__push_back_slow_path<cocos2d::Sprite3D*const&>
          (vector<cocos2d::Sprite3D*,std::__ndk1::allocator<cocos2d::Sprite3D*>> *this,
          Sprite3D **param_1)
