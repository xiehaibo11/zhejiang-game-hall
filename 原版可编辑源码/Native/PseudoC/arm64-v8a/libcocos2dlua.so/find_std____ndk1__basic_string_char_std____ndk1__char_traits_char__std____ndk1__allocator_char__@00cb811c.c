...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, cocostudio::timeline::BoneNode*>,
   ...
   std::__ndk1::allocator<char> >, cocostudio::timeline::BoneNode*>,
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00cb81f8;
              goto LAB_00cb82a8;
            }
            if (uVar9 != uVar14) goto LAB_00cb82a8;
          }
LAB_00cb81f8:
          plVar8 = (long *)*plVar8;
