...
/* lua_cocos2dx_MenuItemAtlasFont_constructor(lua_State*) */

bool lua_cocos2dx_MenuItemAtlasFont_constructor(lua_State *param_1)
  ...
  if (iVar1 == 0) {
    ...
    *(undefined ***)this = &PTR__MenuItem_01698b68;
    ...
    toluafix_pushusertype_ccobject
              (param_1,*(int *)(this + 0xc),(int *)(this + 0x10),this,"cc.MenuItemAtlasFont");
  }
  else {
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "cc.MenuItemAtlasFont:MenuItemAtlasFont",iVar1,0);
  }
  return iVar1 == 0;
}
