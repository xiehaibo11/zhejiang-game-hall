...
/* void std::__ndk1::vector<flatbuffers::Position, std::__ndk1::allocator<flatbuffers::Position>
   >::__push_back_slow_path<flatbuffers::Position const&>(flatbuffers::Position const&) */
...
__push_back_slow_path<flatbuffers::Position_const&>
          (vector<flatbuffers::Position,std::__ndk1::allocator<flatbuffers::Position>> *this,
          Position *param_1)
