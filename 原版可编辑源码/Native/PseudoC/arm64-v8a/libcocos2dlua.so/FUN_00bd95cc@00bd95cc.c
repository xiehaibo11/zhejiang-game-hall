...
undefined8 FUN_00bd95cc(undefined8 param_1,uchar *param_2,uchar *param_3,ulong param_4)

{
  ...
  if (param_4 >> 0x3e != 0) {
    ...
    do {
      ...
      BF_ofb64_encrypt(param_3,out,0x4000000000000000,pBVar3,ivec,&local_64);
  ...
  if (param_4 != 0) {
    ...
    BF_ofb64_encrypt(param_3,param_2,param_4,pBVar3,puVar4,&local_68);
