...
/* void std::__ndk1::vector<cocos2d::PUEmitter*, std::__ndk1::allocator<cocos2d::PUEmitter*>
   >::__push_back_slow_path<cocos2d::PUEmitter* const&>(cocos2d::PUEmitter* const&) */

void __thiscall
std::__ndk1::vector<cocos2d::PUEmitter*,std::__ndk1::allocator<cocos2d::PUEmitter*>>::
__push_back_slow_path<cocos2d::PUEmitter*const&>
          (vector<cocos2d::PUEmitter*,std::__ndk1::allocator<cocos2d::PUEmitter*>> *this,
          PUEmitter **param_1)
