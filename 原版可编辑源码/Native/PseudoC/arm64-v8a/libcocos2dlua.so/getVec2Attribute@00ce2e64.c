...
/* cocostudio::UserCameraReader::getVec2Attribute(tinyxml2::XMLAttribute const*) const */

float __thiscall
cocostudio::UserCameraReader::getVec2Attribute(UserCameraReader *this,XMLAttribute *param_1)
