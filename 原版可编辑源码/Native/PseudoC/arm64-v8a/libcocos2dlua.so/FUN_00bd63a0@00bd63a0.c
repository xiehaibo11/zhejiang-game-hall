...
bool FUN_00bd63a0(ENGINE *param_1,undefined4 param_2,ulong param_3,char *param_4)

{
  ...
  if (DAT_0176f3b8 < 0) {
    iVar1 = CRYPTO_get_ex_new_index
                      (10,0,(void *)0x0,(undefined1 *)0x0,(undefined1 *)0x0,FUN_00bd6ac0);
    if (iVar1 != -1) {
...
LAB_00bd6430:
  arg = ENGINE_get_ex_data(param_1,DAT_0176f3b8);
  if (arg != (long *)0x0) {
    lVar8 = *arg;
    goto joined_r0x00bd6500;
  }
...
LAB_00bd65a4:
  ...
  *(undefined4 *)(arg + 9) = 1;
  ...
  arg[7] = (long)"v_check";
  CRYPTO_THREAD_write_lock(global_engine_lock);
  plVar2 = ENGINE_get_ex_data(param_1,DAT_0176f3b8);
  if (plVar2 == (long *)0x0) {
    iVar1 = ENGINE_set_ex_data(param_1,DAT_0176f3b8,arg);
    CRYPTO_THREAD_unlock(global_engine_lock);
    if (iVar1 == 0) {
...
LAB_00bd6948:
      ...
      if ((int)arg[9] == 0) goto LAB_00bd68b8;
    }
