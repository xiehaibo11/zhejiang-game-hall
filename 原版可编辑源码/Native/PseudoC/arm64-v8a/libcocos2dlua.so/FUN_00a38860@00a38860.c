...
void FUN_00a38860(long param_1,uint param_2,void *param_3,size_t param_4,long param_5)

{
  ...
  FUN_00a241ac(acStack_e8,0xa0,"[%s %s %s]",pcVar3,pcVar4);
  ...
  if (*(code **)(param_1 + 0x2e8) == (code *)0x0) {
    ...
    if ((int)uVar2 != 0) goto LAB_00a389dc;
switchD_00a388d4_default:
    pcVar5 = *(code **)(param_1 + 0x2e8);
  }
  if (pcVar5 == (code *)0x0) {
    if (param_2 < 3) {
      fwrite(&DAT_013c44af + (ulong)param_2 + (ulong)param_2 * 2,2,1,*(FILE **)(param_1 + 0x220));
