...
{
  return &__bind<void(cocos2d::extension::AssetsManagerEx::*)(cocos2d::network::DownloadTask_const&,int,int,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&),cocos2d::extension::AssetsManagerEx*,std::__ndk1::placeholders::__ph<1>const&,std::__ndk1::placeholders::__ph<2>const&,std::__ndk1::placeholders::__ph<3>const&,std::__ndk1::placeholders::__ph<4>const&>
          ::typeinfo;
}
