...

{
  ...
  if (this != *(list<int,std::__ndk1::allocator<int>> **)(this + 8)) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00df5b84 with catch @ 00df5cec
                        */
    iVar1 = *param_1;
    lVar6 = 0;
    plVar9 = *(list<int,std::__ndk1::allocator<int>> **)(this + 8);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00df5b4c with catch @ 00df5cf8
                        */
    do {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00df5a84 with catch @ 00df5d18
                        */
      if (*(int *)(plVar9 + 0x10) == iVar1) {
        for (plVar8 = *(list<int,std::__ndk1::allocator<int>> **)(plVar9 + 8); this != plVar8;
            plVar8 = *(list<int,std::__ndk1::allocator<int>> **)(plVar8 + 8)) {
                    /* catch() { ... } // from try @ 00df5d5c with catch @ 00df5d2c */
          if (*(int *)(plVar8 + 0x10) != iVar1) {
            bVar3 = true;
            plVar4 = plVar8;
                    /* try { // try from 00df5d5c to 00ef5dc3 has its CatchHandler @ 00df5d2c */
            goto joined_r0x00df5d64;
          }
        }
        bVar3 = false;
        plVar4 = this;
joined_r0x00df5d64:
          ...
          if ((list<int,std::__ndk1::allocator<int>> *)&local_50 != this) {
            ...
            *(long *)(this + 0x10) = *(long *)(this + 0x10) - lVar10;
            local_40 = lVar6;
                    ...
                    /* catch() { ... } // from try @ 00df5d54 with catch @ 00df5da8 */
          lVar10 = *(long *)plVar9;
        ...
        plVar9 = plVar4;
        if (bVar3) goto LAB_00df5d00;
      }
      else {
LAB_00df5d00:
        plVar8 = *(list<int,std::__ndk1::allocator<int>> **)(plVar9 + 8);
      }
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00df5b10 with catch @ 00df5d04
                        */
      plVar9 = plVar8;
    } while (this != plVar8);
    if (lVar6 != 0) {
                    /* try { // try from 00df5de8 to 00ef5deb has its CatchHandler @ 00df5e2c */
      lVar6 = *local_48;
  ...
  if (*(long *)(lVar2 + 0x28) == local_38) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00df5de8 with catch @ 00df5e2c
                        */
    return;
  }
