...
/* cocos2d::PUParticle3DEntityRender::initRender(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

undefined8 __thiscall
cocos2d::PUParticle3DEntityRender::initRender(PUParticle3DEntityRender *this,basic_string *param_1)

{
  ...
  *(Ref **)(this + 0x80) = this_02;
  this_03 = operator_new(0xc0,(nothrow_t *)&std::nothrow);
  if (this_03 != (MeshCommand *)0x0) {
    MeshCommand::MeshCommand(this_03);
  }
  *(MeshCommand **)(this + 0x68) = this_03;
  *(undefined2 *)(this_03 + 0x10) = 0x101;
  RenderState::StateBlock::setDepthTest(*(StateBlock **)(this + 0x70),(bool)this[0x48]);
  RenderState::StateBlock::setDepthWrite(*(StateBlock **)(this + 0x70),(bool)this[0x49]);
  RenderState::StateBlock::setCullFaceSide(*(StateBlock **)(this + 0x70),0x405);
  RenderState::StateBlock::setCullFace(*(StateBlock **)(this + 0x70),true);
