...

{
  ...
  if (UNRECOVERED_JUMPTABLE != (_func_1628 *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00be2680. Too many branches */
  ...
  if (ctx != (BN_CTX *)0x0) {
    ...
    if (pBVar5 != (BIGNUM *)0x0) {
      ...
      if (rsa->n == (BIGNUM *)0x0) {
        pBVar5 = BN_new();
        rsa->n = pBVar5;
        if (pBVar5 == (BIGNUM *)0x0) goto LAB_00be2aa0;
      }
      if (rsa->d == (BIGNUM *)0x0) {
...
LAB_00be2824:
  ...
  if ((iVar1 == 0) || (iVar1 = BN_gcd(pBVar4,r,rsa->e,ctx), iVar1 == 0)) goto LAB_00be2aa0;
              ...
              if ((iVar1 == 0) || (iVar1 = BN_div((BIGNUM *)0x0,rsa->dmq1,pBVar3,r,ctx), iVar1 == 0)
                ...
                if (pBVar3 != (BIGNUM *)0x0) {
                  ...
                  if (pBVar4 != (BIGNUM *)0x0) {
                    iVar1 = 1;
                    if (ctx == (BN_CTX *)0x0) goto LAB_00be2acc;
                    goto LAB_00be2ac4;
                  }
                }
              }
