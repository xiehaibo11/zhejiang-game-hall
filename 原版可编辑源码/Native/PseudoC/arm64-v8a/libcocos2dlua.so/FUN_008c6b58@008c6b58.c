...
undefined8 FUN_008c6b58(undefined8 param_1)

{
  ...
  if ((((iVar2 == 0) || (iVar2 = tolua_isnumber(param_1,2,0,auStack_58), iVar2 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glVertexAttrib3f\'.",auStack_58);
  }
  else {
    ...
    glVertexAttrib3f((float)dVar4,(float)dVar5,(float)dVar6,(int)dVar3);
  }
