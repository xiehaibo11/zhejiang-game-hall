...
/* cocos2d::DataManager::setProcessID(int) */

void cocos2d::DataManager::setProcessID(int param_1)

{
  ...
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string<decltype(nullptr)>(local_58,"setProcessID");
  JniHelper::callStaticVoidMethod<int>((basic_string *)local_40,(basic_string *)local_58,param_1);
