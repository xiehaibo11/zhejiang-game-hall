...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 0103ee74 to 0113ee83 has its CatchHandler @ 0103eebc */
  lVar5 = tpidr_el0;
  ...
  if (((byte)*param_1 & 1) == 0) {
    ...
    uVar7 = (ulong)((byte)*param_1 >> 1);
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 0103ee74 with catch @ 0103eebc
                        */
        ...
        do {
          ...
          if (uVar7 == uVar9) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_0103ef4c;
              goto LAB_0103effc;
            }
            if (uVar9 != uVar14) goto LAB_0103effc;
          }
LAB_0103ef4c:
          plVar8 = (long *)*plVar8;
...
LAB_0103f000:
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* try { // try from 0103f010 to 0113f053 has its CatchHandler @ 0103f010
                       catch() { ... } // from try @ 0103f010 with catch @ 0103f010
                       catch() { ... } // from try @ 0103f074 with catch @ 0103f010
                       catch() { ... } // from try @ 0103f0e8 with catch @ 0103f010
                       catch() { ... } // from try @ 0103f138 with catch @ 0103f010 */
    return plVar8;
  }
