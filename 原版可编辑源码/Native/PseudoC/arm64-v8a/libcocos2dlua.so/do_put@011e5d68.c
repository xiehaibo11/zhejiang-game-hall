...

{
  ...
  iVar5 = __libcpp_snprintf_l(local_7c,0x14,(__locale_t *)DAT_017942d0,local_ac,param_5);
  pcVar1 = local_7c + iVar5;
  uVar2 = *(uint *)(param_3 + 8) & 0xb0;
  pcVar7 = pcVar1;
  if (uVar2 == 0x20) goto LAB_011e5e58;
  if (uVar2 == 0x10) {
...
LAB_011e5e58:
  ...
  if (ctype<char>::id != -1) {
    local_b8 = &local_d8;
    local_c0 = &local_b8;
    __call_once((ulong *)&ctype<char>::id,&local_c0,FUN_01208130);
  }
  if (((ulong)(*(long *)(local_e0 + 0x18) - *(long *)(local_e0 + 0x10) >> 3) <=
       (long)DAT_01794330 - 1U) ||
     (plVar6 = *(long **)(*(long *)(local_e0 + 0x10) + ((long)DAT_01794330 - 1U) * 8),
     plVar6 == (long *)0x0)) {
  ...
  FUN_00914b68(param_2,acStack_a4,pcVar3,acStack_a4 + iVar5,param_3,param_4);
