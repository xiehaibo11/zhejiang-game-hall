...
/* void std::__ndk1::vector<cocos2d::SchedulerScriptHandlerEntry*,
   std::__ndk1::allocator<cocos2d::SchedulerScriptHandlerEntry*>
   >::__push_back_slow_path<cocos2d::SchedulerScriptHandlerEntry*
   const&>(cocos2d::SchedulerScriptHandlerEntry* const&) */
...
::__push_back_slow_path<cocos2d::SchedulerScriptHandlerEntry*const&>
          (vector<cocos2d::SchedulerScriptHandlerEntry*,std::__ndk1::allocator<cocos2d::SchedulerScriptHandlerEntry*>>
           *this,SchedulerScriptHandlerEntry **param_1)
