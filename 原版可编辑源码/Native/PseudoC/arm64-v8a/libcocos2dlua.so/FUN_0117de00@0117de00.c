...
undefined4 * FUN_0117de00(char *param_1,int param_2,byte *param_3)
...
switchD_0117dec0_caseD_2c:
        bVar2 = *param_3;
      }
      else {
        switch(uVar11) {
        case 0x2b:
          goto switchD_0117dec0_caseD_2b;
        default:
          goto switchD_0117dec0_caseD_2c;
        case 0x46:
          __ptr[0x17] = 4;
          bVar2 = *param_3;
          break;
    ...
    if (iVar8 == 0x1c4f) {
      if (bVar3) goto switchD_0117dec0_caseD_2b;
      __ptr[0x10] = 1;
    }
    else if (iVar8 == 0) goto switchD_0117dec0_caseD_2b;
