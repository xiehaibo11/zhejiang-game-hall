...
LAB_00b63360:
            ...
            pcVar18 = str->data;
            if (pcVar18[lVar20] == '\0') goto LAB_00b63490;
            if ((iVar6 == 0) && (*pcVar18 == '#')) goto LAB_00b63348;
...
LAB_00b63404:
              ...
              do {
                cVar2 = *pcVar18;
                if (cVar2 == '\t') {
                  if (!bVar3) goto LAB_00b6343c;
                  pcVar13 = pcVar13 + -1;
                }
                else if (cVar2 == '\0') goto LAB_00b63450;
                bVar3 = cVar2 == '\\';
                pcVar18 = pcVar18 + 1;
                *pcVar13 = cVar2;
                pcVar13 = pcVar13 + 1;
...
LAB_00b6343c:
  ...
  *pcVar13 = '\0';
  pcVar18 = pcVar18 + 1;
  pcVar13 = pcVar14;
  if (num <= lVar15) goto LAB_00b63450;
