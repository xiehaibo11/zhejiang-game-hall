...
Block * __thiscall tinyxml2::XMLDocument::NewDeclaration(XMLDocument *this,char *param_1)

{
  ...
  *(undefined ***)__s = &PTR_ToElement_017274c0;
  pcVar2 = "xml version=\"1.0\" encoding=\"UTF-8\"";
  if (param_1 != (char *)0x0) {
    pcVar2 = param_1;
  }
  ...
  *(XMLDocument **)(__s + 0x50) = this + 0x200;
  StrPair::SetStr((StrPair *)(__s + 0x18),pcVar2,0);
  return __s;
}
