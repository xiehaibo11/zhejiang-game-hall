...
/* cocostudio::DictionaryHelper::getArrayCount_json(rapidjson::GenericValue<rapidjson::UTF8<char>,
   rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator> > const&, char const*, int) */

int __thiscall
cocostudio::DictionaryHelper::getArrayCount_json
