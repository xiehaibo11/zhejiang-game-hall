...
void cocosbuilder::CCBReader::getOwnerCallbackNames(void)

{
  ...
  *(undefined8 *)(in_x8 + 0x10) = 0;
  std::__ndk1::vector<cocos2d::Value,std::__ndk1::allocator<cocos2d::Value>>::reserve
            (in_x8,(*(long *)(in_x0 + 0x128) - *(long *)(in_x0 + 0x120) >> 3) * -0x5555555555555555)
  ;
  pbVar2 = *(basic_string **)(in_x0 + 0x120);
  if (pbVar2 != *(basic_string **)(in_x0 + 0x128)) {
    do {
      ...
      pbVar2 = pbVar2 + 0x18;
    } while (pbVar2 != *(basic_string **)(in_x0 + 0x128));
  }
