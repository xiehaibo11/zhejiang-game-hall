...
void FUN_00fa7b4c(long *param_1,long *param_2)

{
  ...
  long local_38;
                    ...
                    /* catch() { ... } // from try @ 00fa77ac with catch @ 00fa7b4c */
                    /* catch() { ... } // from try @ 00fa79c0 with catch @ 00fa7b50 */
                    /* catch() { ... } // from try @ 00fa79ec with catch @ 00fa7b60 */
  lVar1 = tpidr_el0;
  local_38 = *(long *)(lVar1 + 0x28);
  if (param_2 != param_1) {
    plVar2 = (long *)param_1[4];
    if (plVar2 == param_1) {
                    /* catch() { ... } // from try @ 00fa7ecc with catch @ 00fa7ba8 */
      if ((long *)param_2[4] == param_2) {
                    /* try { // try from 00fa7c18 to 010a7c23 has its CatchHandler @ 00fa7f50 */
