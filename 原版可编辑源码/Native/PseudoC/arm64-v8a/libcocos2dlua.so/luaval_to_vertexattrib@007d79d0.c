...
/* luaval_to_vertexattrib(lua_State*, int, cocos2d::VertexAttrib*, char const*) */

void luaval_to_vertexattrib(lua_State *param_1,int param_2,VertexAttrib *param_3,char *param_4)

{
  ...
  uVar4 = 0;
  if (((param_1 != (lua_State *)0x0) && (param_3 != (VertexAttrib *)0x0)) &&
