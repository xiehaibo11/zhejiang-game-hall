...
/* std::__ndk1::enable_if<__is_forward_iterator<cocostudio::FrameData**>::value&&is_constructible<cocostudio::FrameData*,
   std::__ndk1::iterator_traits<cocostudio::FrameData**>::reference>::value, void>::type
   std::__ndk1::vector<cocostudio::FrameData*, std::__ndk1::allocator<cocostudio::FrameData*>
   >::assign<cocostudio::FrameData**>(cocostudio::FrameData**, cocostudio::FrameData**) */

void __thiscall
std::__ndk1::vector<cocostudio::FrameData*,std::__ndk1::allocator<cocostudio::FrameData*>>::
assign<cocostudio::FrameData**>
          (vector<cocostudio::FrameData*,std::__ndk1::allocator<cocostudio::FrameData*>> *this,
          FrameData **param_1,FrameData **param_2)
...
LAB_00c54518:
    ...
    if ((ulong)(lVar1 >> 3) < 0xfffffffffffffff) {
      uVar2 = lVar1 >> 2;
      if ((uVar5 <= uVar2) && (uVar5 = uVar2, uVar2 >> 0x3d != 0)) goto LAB_00c54518;
    }
    else {
    ...
    *(void **)(this + 8) = pvVar4;
    ...
    __src = (FrameData **)((long)param_1 + (*(long *)(this + 8) - (long)pvVar4));
    if (uVar5 <= uVar2) {
      __src = param_2;
    }
