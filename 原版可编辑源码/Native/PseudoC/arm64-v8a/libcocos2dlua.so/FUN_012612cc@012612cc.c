...
void FUN_012612cc(long param_1,undefined8 *param_2)

{
  ...
  if (*(char *)(param_1 + 0x20) == '\0') {
    if (uVar3 <= uVar4) {
      ...
      *param_2 = pvVar1;
      if (pvVar1 == (void *)0x0) goto LAB_012614c4;
      lVar2 = param_2[1];
      uVar4 = lVar2 + 1;
    }
    else {
...
LAB_012614c4:
  ...
  if (*(char *)((long)plVar5 + 9) == '\x01') {
    return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x012614c0. Too many branches */
