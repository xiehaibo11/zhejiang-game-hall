...
EventListener * cocos2d::EventListenerKeyboard::create(void)

{
  ...
  if (this == (EventListener *)0x0) goto LAB_00fa9484;
  ...
  *(undefined ***)this = &PTR__EventListenerKeyboard_017233f8;
  ...
  uVar2 = EventListener::init(this,3,&LISTENER_ID,&local_70);
