  ...
  if (lVar3 != 0) {
    if ((*(byte *)(lVar3 + 0x70) & 1) == 0) {
      ...
      if ((lVar3 == 0) && (p_Var4 = *(__assoc_sub_state **)this, 0 < *(long *)(p_Var4 + 8))) {
        if (((DAT_01795360 & 1) == 0) && (iVar2 = __cxa_guard_acquire(&DAT_01795360), iVar2 != 0)) {
        ...
        local_80 = local_50;
        local_90[0] = &PTR__future_error_017313a8;
        FUN_01213d58(aeStack_70,local_90);
