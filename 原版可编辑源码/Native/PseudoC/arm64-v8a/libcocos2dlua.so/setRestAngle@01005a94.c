...
/* cocos2d::PhysicsJointRotarySpring::setRestAngle(float) */

void __thiscall
cocos2d::PhysicsJointRotarySpring::setRestAngle(PhysicsJointRotarySpring *this,float param_1)

{
  ...
  if (this[100] == (PhysicsJointRotarySpring)0x0) {
    cpDampedRotarySpringSetRestAngle(**(undefined8 **)(this + 8));
  }
  else {
    lVar2 = *(long *)(this + 0x50);
    *(undefined1 *)(lVar2 + 0x50) = 1;
    *(float *)(lVar2 + 0x54) = param_1;
    local_70 = &PTR_FUN_01725a98;
    ...
    if (lVar2 == *(long *)(this + 0x30)) {
      ...
      *(long *)(lVar2 + 0x20) = lVar2;
      local_50 = (long *)&local_70;
      FUN_01007f28(FUN_01007f28,&local_70,lVar2);
    ...
    if (&local_70 == (undefined ***)local_50) {
      ...
      if (local_50 == (long *)0x0) goto LAB_01005acc;
