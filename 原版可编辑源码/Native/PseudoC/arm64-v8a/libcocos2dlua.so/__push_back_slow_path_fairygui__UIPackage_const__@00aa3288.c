...
/* void std::__ndk1::vector<fairygui::UIPackage*, std::__ndk1::allocator<fairygui::UIPackage*>
   >::__push_back_slow_path<fairygui::UIPackage* const&>(fairygui::UIPackage* const&) */
...
__push_back_slow_path<fairygui::UIPackage*const&>
          (vector<fairygui::UIPackage*,std::__ndk1::allocator<fairygui::UIPackage*>> *this,
          UIPackage **param_1)
