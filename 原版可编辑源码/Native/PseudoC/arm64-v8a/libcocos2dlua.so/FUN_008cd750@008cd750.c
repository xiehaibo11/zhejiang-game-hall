...
void * FUN_008cd750(long param_1,ulong param_2,long param_3,uint *param_4)

{
  ...
  if ((uint)param_2 != 0) {
    ...
    uVar12 = 0;
    do {
      uVar14 = uVar12 >> 2 & 0x3fffffff;
      pbVar1 = (byte *)(param_1 + uVar12);
      uVar4 = uVar10 & 0x18;
      uVar12 = uVar12 + 1;
      uVar10 = uVar10 + 8;
      __s[uVar14] = (uint)*pbVar1 << (ulong)uVar4 | __s[uVar14];
    } while ((param_2 & 0xffffffff) != uVar12);
  }
  __ptr = malloc(0x10);
  uVar10 = 0;
  uVar12 = 0;
  *__ptr = 0;
  __ptr[1] = 0;
  do {
    pbVar1 = (byte *)(param_3 + uVar12);
    lVar13 = (uVar12 >> 2 & 0x3fffffff) * 4;
    uVar4 = uVar10 & 0x18;
    uVar12 = uVar12 + 1;
    uVar10 = uVar10 + 8;
    *(uint *)((long)__ptr + lVar13) =
         (uint)*pbVar1 << (ulong)uVar4 | *(uint *)((long)__ptr + lVar13);
  } while (uVar12 != 0x10);
  if (uVar9 != 0) {
    uVar10 = __s[uVar18];
    uVar4 = 0;
