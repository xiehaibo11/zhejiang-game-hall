...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>>>
           *this,ulong param_1)
    ...
    *(ulong *)(this + 8) = param_1;
    ...
    if (plVar5 != (long *)0x0) {
      ...
      uVar12 = CONCAT62((int6)((ulong)uVar11 >> 0x10),uVar10);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00e0e2e8 with catch @ 00e0e294
                        */
      ...
      *(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>>>
        **)(*(long *)this + uVar4 * 8) = this + 0x10;
                    /* try { // try from 00e0e2e0 to 00f0e2e7 has its CatchHandler @ 00e0e45c */
      if ((long *)*plVar5 != (long *)0x0) {
        plVar6 = (long *)*plVar5;
                    /* try { // try from 00e0e2e8 to 00f0e45f has its CatchHandler @ 00e0e294 */
        do {
          uVar7 = plVar6[1];
          if ((uVar12 & 0xffffffff) < 2) {
