...
undefined4 FUN_01145d14(uint *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (puVar4 == (undefined8 *)0x0) goto LAB_01145e4c;
  *puVar4 = 0x200000000;
  FUN_011500b4();
  ...
  *(uint *)(puVar4 + 0x11) = uVar2;
  FUN_01143af4(puVar1,0x208);
  FUN_011426a0(0,puVar1);
  *(undefined8 *)(param_1 + 0x16) = param_4;
  param_1[8] = *param_1;
  param_1[9] = param_1[1];
  *(undefined4 *)puVar4 = 0;
  FUN_0115f1e0(puVar4 + 5,param_2,param_3);
  iVar3 = FUN_01145eec(*param_1,param_1[1],1,puVar4,0);
  if (iVar3 == 0) {
LAB_01145e34:
    ...
    if (0 < *(int *)(puVar4 + 0x1b)) {
      ...
      do {
        if (((*(char *)puVar6[-2] != '\0') || (*(char *)puVar6[-1] != '\0')) ||
           (*(char *)*puVar6 != '\0')) goto LAB_01145de8;
        lVar5 = lVar5 + 1;
        puVar6 = puVar6 + 0x47;
