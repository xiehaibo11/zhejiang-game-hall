...
/* void std::__ndk1::__stable_sort_move<bool (*&)(cocos2d::RenderCommand*, cocos2d::RenderCommand*),
    ...
    if (param_4 == 2) {
      ...
      if ((uVar1 & 1) == 0) {
        *param_5 = *param_1;
        uVar2 = param_2[-1];
                    ...
                    /* try { // try from 00fe5fd0 to 010e5fd7 has its CatchHandler @ 00fe5ff4 */
        *param_5 = param_2[-1];
        uVar2 = *param_1;
      }
      param_5[1] = uVar2;
      ...
      *param_5 = *param_1;
      ...
      if (param_1 != param_2) {
        puVar6 = param_1 + 1;
        uVar2 = *param_1;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fe5fd0 with catch @ 00fe5ff4
                        */
        *param_5 = uVar2;
        if (puVar6 != param_2) {
          lVar8 = 0;
          ...
          do {
            ...
            if ((uVar1 & 1) == 0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fe603c with catch @ 00fe6068
                        */
              *puVar7 = *puVar6;
            }
            else {
              ...
              if (puVar9 != param_5) {
                ...
                do {
                  puVar4 = (undefined8 *)((long)puVar9 + lVar11);
                    /* try { // try from 00fe603c to 010e6043 has its CatchHandler @ 00fe6068 */
