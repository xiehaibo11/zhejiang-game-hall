...
undefined8 FUN_011172a8(undefined8 param_1,undefined2 *param_2,uint param_3,undefined8 *param_4)

{
  ...
  iVar1 = FUN_01118b58(param_1,param_2,&local_48);
  if (iVar1 == 0) {
    uVar5 = (ulong)param_3;
    ...
    *param_4 = local_48;
    ...
    FUN_01116d2c(param_1,iVar1,"TIFFFetchStripThing",pcVar4,0);
    uVar3 = 0;
  }
  return uVar3;
}
