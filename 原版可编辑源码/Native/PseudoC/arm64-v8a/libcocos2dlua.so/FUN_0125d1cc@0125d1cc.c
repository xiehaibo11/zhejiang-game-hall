...
void FUN_0125d1cc(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  lVar1 = FUN_01259b70();
  if ((lVar1 != 0) && (lVar2 = FUN_01259b70(param_1), lVar2 != 0)) {
    ...
    *(undefined ***)((long)puVar3 + lVar4 + 0x10) = &PTR_FUN_01735e98;
