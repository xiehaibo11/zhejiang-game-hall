...
/* luaval_to_quaternion(lua_State*, int, cocos2d::Quaternion*, char const*) */

bool luaval_to_quaternion(lua_State *param_1,int param_2,Quaternion *param_3,char *param_4)

{
  ...
  bVar3 = false;
  if ((param_1 != (lua_State *)0x0) && (param_3 != (Quaternion *)0x0)) {
