...
/* std::__ndk1::__function::__func<LUA_TableViewDataSource::tableCellSizeForIndex(cocos2d::extension::TableView*,
   ...
   long)::{lambda(lua_State*, int)#1}>, void (lua_State*, int)>::target_type() const */
...
{
  return &LUA_TableViewDataSource::tableCellSizeForIndex(cocos2d::extension::TableView*,long)::
          {lambda(lua_State*,int)#1}::typeinfo;
}
