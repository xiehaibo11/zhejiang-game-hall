...
/* void std::__ndk1::vector<cocos2d::PURibbonTrailVisualData*,
   std::__ndk1::allocator<cocos2d::PURibbonTrailVisualData*>
   >::__push_back_slow_path<cocos2d::PURibbonTrailVisualData*
   const&>(cocos2d::PURibbonTrailVisualData* const&) */
...
::__push_back_slow_path<cocos2d::PURibbonTrailVisualData*const&>
          (vector<cocos2d::PURibbonTrailVisualData*,std::__ndk1::allocator<cocos2d::PURibbonTrailVisualData*>>
           *this,PURibbonTrailVisualData **param_1)
