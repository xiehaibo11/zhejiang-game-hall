...
/* void cocos2d::experimental::volumeMulti<4, 5, float, float, float, int, short>(float*, unsigned
   long, float const*, int*, float const*, short) */

void cocos2d::experimental::volumeMulti<4,5,float,float,float,int,short>
