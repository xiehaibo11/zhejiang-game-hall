...
/* unsigned long std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int, int>,
   ...
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<int, int> > >::__erase_unique<int>(int
   const&) */
