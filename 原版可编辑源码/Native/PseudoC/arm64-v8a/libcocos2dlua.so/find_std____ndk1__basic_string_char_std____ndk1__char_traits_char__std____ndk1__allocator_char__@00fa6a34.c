...
/* std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   cocos2d::EventDispatcher::EventListenerVector*>, void*>*>
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::EventDispatcher::EventListenerVector*> > >::find<std::__ndk1::basic_string<char,
...

{
  ...
  local_68 = *(long *)(lVar5 + 0x28);
                    /* try { // try from 00fa6a68 to 010a6a6f has its CatchHandler @ 00fa6fc0 */
        ...
        do {
          ...
          if (uVar7 == uVar9) {
            ...
            if (sVar1 == __n) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                while (*pbVar10 == *pbVar11) {
                  ...
                  pbVar10 = pbVar10 + 1;
                  pbVar11 = pbVar11 + 1;
                  if (uVar9 == 0) goto LAB_00fa6bc4;
                }
              }
              else {
                    /* try { // try from 00fa6bac to 010a6bb3 has its CatchHandler @ 00fa6fbc */
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00fa6b10;
              goto LAB_00fa6bc0;
            }
            if (uVar9 != uVar14) goto LAB_00fa6bc0;
          }
LAB_00fa6b10:
          plVar8 = (long *)*plVar8;
