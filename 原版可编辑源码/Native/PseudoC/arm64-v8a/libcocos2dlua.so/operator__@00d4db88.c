...
::operator()(__func<std::__ndk1::__bind<void(cocos2d::Skybox::*)(cocos2d::Mat4_const&,unsigned_int),cocos2d::Skybox*,cocos2d::Mat4_const&,unsigned_int&>,std::__ndk1::allocator<std::__ndk1::__bind<void(cocos2d::Skybox::*)(cocos2d::Mat4_const&,unsigned_int),cocos2d::Skybox*,cocos2d::Mat4_const&,unsigned_int&>>,void()>
             *this)

{
  ...
  if ((*(ulong *)(this + 0x10) & 1) != 0) {
    UNRECOVERED_JUMPTABLE = *(code **)(UNRECOVERED_JUMPTABLE + *plVar1);
                    ...
                    /* WARNING: Could not recover jumptable at 0x00d4dbac. Too many branches */
