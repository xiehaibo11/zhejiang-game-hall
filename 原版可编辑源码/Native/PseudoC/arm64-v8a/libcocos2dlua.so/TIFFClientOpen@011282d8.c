...
/* WARNING: Removing unreachable block (ram,0x01128568) */
/* WARNING: Removing unreachable block (ram,0x01128540) */
...

{
  ...
  *(undefined4 *)((long)__s + 0x27c) = 0xffffffff;
  ...
  if (param_9 == (code *)0x0) {
    param_9 = FUN_011288e0;
  }
  if (param_10 == (code *)0x0) {
    param_10 = FUN_011288e8;
  }
  __s[0x78] = param_4;
  __s[0x79] = param_5;
  __s[0x7a] = param_6;
  ...
  *(uint *)(__s + 2) = uVar11;
  ...
  if (uVar9 == 0) {
    do {
      switch(*pcVar7) {
      case '\0':
        goto switchD_0112852c_caseD_0;
      default:
        goto switchD_0112852c_caseD_1;
      case '8':
        goto switchD_0112852c_caseD_1;
      case 'B':
      case 'H':
...
LAB_01128498:
      *(uint *)(__s + 2) = uVar11;
      break;
    default:
      if (*pcVar7 == '\0') goto switchD_0112852c_caseD_0;
    }
    pcVar7 = pcVar7 + 1;
  } while( true );
switchD_0112852c_caseD_0:
  if (uVar9 >> 9 == 0) {
    lVar4 = (*(code *)__s[0x78])(__s[0x77],__s + 0x4d,8);
    if (lVar4 != 8) goto LAB_011285e8;
    ...
    if (uVar8 != 0x4949) {
      ...
      if (uVar8 == 0x5045) goto LAB_011286e8;
      uVar5 = __s[0x77];
...
LAB_011285e8:
    if (*(int *)((long)__s + 0xc) == 0) goto LAB_011287f4;
    uVar9 = *(uint *)(__s + 2);
    uVar12 = 0x4d4d;
    if ((uVar9 & 0x80) == 0) {
      uVar12 = 0x4949;
