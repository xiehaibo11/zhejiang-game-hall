...
/* lua_cocos2dx_FileUtils_getSearchResolutionsOrder(lua_State*) */

void lua_cocos2dx_FileUtils_getSearchResolutionsOrder(lua_State *param_1)

{
  ...
  if (iVar6 + -1 == 0) {
    (**(code **)(*plVar7 + 0x80))(&local_50,plVar7);
    ...
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "cc.FileUtils:getSearchResolutionsOrder",iVar6 + -1,0);
    uVar8 = 0;
  }
