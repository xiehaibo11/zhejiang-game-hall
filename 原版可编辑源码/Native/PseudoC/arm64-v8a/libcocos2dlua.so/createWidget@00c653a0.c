...
/* cocostudio::WidgetPropertiesReader0300::createWidget(rapidjson::GenericValue<rapidjson::UTF8<char>,
   rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator> > const&, char const*, char const*) */

Ref * __thiscall
cocostudio::WidgetPropertiesReader0300::createWidget
          (WidgetPropertiesReader0300 *this,GenericValue *param_1,char *param_2,char *param_3)
