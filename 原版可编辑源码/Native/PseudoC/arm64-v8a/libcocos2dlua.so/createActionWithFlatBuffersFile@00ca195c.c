...
/* cocostudio::timeline::ActionTimelineCache::createActionWithFlatBuffersFile(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

void __thiscall
cocostudio::timeline::ActionTimelineCache::createActionWithFlatBuffersFile
...

{
  ...
  if ((lVar1 == 0) || (plVar2 = *(long **)(lVar1 + 0x28), plVar2 == (long *)0x0)) {
    plVar2 = (long *)loadAnimationActionWithFlatBuffersFile(this,param_1);
  }
                    /* WARNING: Could not recover jumptable at 0x00ca19a0. Too many branches */
