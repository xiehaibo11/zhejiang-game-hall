...
/* std::__ndk1::__function::__func<LUA_TableViewDataSource::numberOfCellsInTableView(cocos2d::extension::TableView*)::{lambda(lua_State*,
   ...
   int)#1}>, void (lua_State*, int)>::~__func() */
...
::~__func(__func<LUA_TableViewDataSource::numberOfCellsInTableView(cocos2d::extension::TableView*)::_lambda(lua_State*,int)_1_,std::__ndk1::allocator<LUA_TableViewDataSource::numberOfCellsInTableView(cocos2d::extension::TableView*)::_lambda(lua_State*,int)_1_>,void(lua_State*,int)>
          *this)
