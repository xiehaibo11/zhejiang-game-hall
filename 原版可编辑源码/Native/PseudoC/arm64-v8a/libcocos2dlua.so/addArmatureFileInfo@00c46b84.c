...

{
  ...
  this[0xa0] = (ArmatureDataManager)0x1;
  this_00 = (DataReaderHelper *)DataReaderHelper::getInstance();
  DataReaderHelper::addDataFromFile(this_00,param_1);
