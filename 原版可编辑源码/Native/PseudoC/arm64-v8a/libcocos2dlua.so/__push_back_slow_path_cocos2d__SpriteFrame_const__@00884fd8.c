...
/* void std::__ndk1::vector<cocos2d::SpriteFrame*, std::__ndk1::allocator<cocos2d::SpriteFrame*>
   >::__push_back_slow_path<cocos2d::SpriteFrame* const&>(cocos2d::SpriteFrame* const&) */
