...
undefined4
FUN_00afa64c(ulong param_1,uint param_2,undefined1 *param_3,code *param_4,undefined8 param_5)
  ...
  if (param_1 < 0x10000) {
    if (param_1 < 0x100) {
      ...
      if ((param_1 & 0x80) < 0x80) {
        uVar4 = *(ushort *)(&DAT_013d8f44 + (param_1 & 0xff) * 2) & param_2 & 0xff;
      }
      else {
        uVar4 = param_2 & 4;
      }
      if ((uVar4 & 0x61) != 0) {
        if ((uVar4 >> 3 & 1) == 0) {
          iVar1 = (*param_4)(param_5,&DAT_012f2b5b,1);
          if (iVar1 == 0) {
            return 0xffffffff;
          }
...
LAB_00afa7b0:
      ...
      if ((uVar4 & 6) == 0) {
        if (((param_2 & 0xf) == 0) || (((uint)param_1 & 0xff) != 0x5c)) goto LAB_00afa7b0;
        pcVar2 = "\\\\";
        uVar3 = 2;
        uVar5 = 2;
      }
