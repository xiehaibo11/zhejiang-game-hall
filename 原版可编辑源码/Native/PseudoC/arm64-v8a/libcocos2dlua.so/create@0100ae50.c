...
/* cocos2d::PhysicsShapeEdgePolygon::create(cocos2d::Vec2 const*, int, cocos2d::PhysicsMaterial
   const&, float) */

Ref * cocos2d::PhysicsShapeEdgePolygon::create
...

{
  ...
  if (this != (Ref *)0x0) {
    ...
    *(undefined ***)this = &PTR__PhysicsShapeEdgeSegment_017261f8;
    uVar2 = init((PhysicsShapeEdgePolygon *)this,param_1,param_2,param_3,param_4);
    if ((uVar2 & 1) == 0) {
