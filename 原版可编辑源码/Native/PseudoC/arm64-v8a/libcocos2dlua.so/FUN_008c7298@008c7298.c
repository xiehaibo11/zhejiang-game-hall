...
undefined8 FUN_008c7298(undefined8 param_1)

{
  ...
  if ((((iVar2 == 0) || (iVar2 = tolua_isnumber(param_1,2,0,auStack_58), iVar2 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glViewport\'.",auStack_58);
  }
  else {
    ...
    glViewport((int)dVar3,(int)dVar4,(int)dVar5,(int)dVar6);
  }
