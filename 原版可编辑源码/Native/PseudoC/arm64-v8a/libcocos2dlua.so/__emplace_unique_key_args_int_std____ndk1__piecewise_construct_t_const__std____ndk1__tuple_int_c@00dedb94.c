...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<int,
   cocos2d::ui::EditBoxImplAndroid*>, void*>*>, bool>
...

{
  ...
  undefined8 uVar11;
                    ...
                    /* try { // try from 00dedb94 to 00eedb9f has its CatchHandler @ 00dee018 */
                    /* try { // try from 00dedba0 to 00eedbab has its CatchHandler @ 00dedfec */
  ...
  if (uVar8 != 0) {
    ...
    uVar4 = CONCAT62((int6)((ulong)uVar11 >> 0x10),uVar10) & 0xffffffff;
                    /* try { // try from 00dedbd0 to 00eedbd7 has its CatchHandler @ 00dee01c */
    if (uVar4 < 2) {
      ...
      for (plVar7 = (long *)*plVar7; plVar7 != (long *)0x0; plVar7 = (long *)*plVar7) {
        ...
        if (uVar6 != uVar9) {
          if (uVar4 < 2) {
            ...
            if (uVar6 - uVar2 * uVar8 == unaff_x24) goto LAB_00dedc20;
            break;
          }
...
LAB_00dedc20:
  ...
  *(undefined4 *)(plVar7 + 2) = uVar1;
                    /* try { // try from 00dedc84 to 00eedc8b has its CatchHandler @ 00dedfa4 */
                    /* try { // try from 00dedc98 to 00eedcab has its CatchHandler @ 00dee01c */
    ...
    if ((uVar8 & uVar8 - 1) == 0) {
      ...
      if (uVar8 != 0) {
        uVar4 = uVar9 / uVar8;
                    ...
                    /* try { // try from 00dedd60 to 00eedd67 has its CatchHandler @ 00dedf9c */
...
LAB_00dedd78:
  *(long *)(param_1 + 6) = *(long *)(param_1 + 6) + 1;
                    /* try { // try from 00dedd90 to 00eedda3 has its CatchHandler @ 00dedfac */
  return plVar7;
}
