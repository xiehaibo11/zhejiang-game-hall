...
/* std::__ndk1::enable_if<__is_forward_iterator<cocos2d::AnimationFrame**>::value&&is_constructible<cocos2d::AnimationFrame*,
   std::__ndk1::iterator_traits<cocos2d::AnimationFrame**>::reference>::value, void>::type
   std::__ndk1::vector<cocos2d::AnimationFrame*, std::__ndk1::allocator<cocos2d::AnimationFrame*>
   >::assign<cocos2d::AnimationFrame**>(cocos2d::AnimationFrame**, cocos2d::AnimationFrame**) */

void __thiscall
std::__ndk1::vector<cocos2d::AnimationFrame*,std::__ndk1::allocator<cocos2d::AnimationFrame*>>::
assign<cocos2d::AnimationFrame**>
          (vector<cocos2d::AnimationFrame*,std::__ndk1::allocator<cocos2d::AnimationFrame*>> *this,
          AnimationFrame **param_1,AnimationFrame **param_2)

{
  AnimationFrame **__src;
  long lVar1;
  ulong uVar2;
  size_t sVar3;
  void *pvVar4;
...
LAB_00883f38:
    ...
    if ((ulong)(lVar1 >> 3) < 0xfffffffffffffff) {
      uVar2 = lVar1 >> 2;
      if ((uVar5 <= uVar2) && (uVar5 = uVar2, uVar2 >> 0x3d != 0)) goto LAB_00883f38;
    }
    else {
    ...
    *(void **)(this + 8) = pvVar4;
    ...
    __src = (AnimationFrame **)((long)param_1 + (*(long *)(this + 8) - (long)pvVar4));
    if (uVar5 <= uVar2) {
      __src = param_2;
    }
