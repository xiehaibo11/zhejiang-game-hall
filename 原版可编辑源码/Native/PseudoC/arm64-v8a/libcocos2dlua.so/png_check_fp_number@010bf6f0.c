...

{
  ...
  for (uVar1 = *param_4; uVar1 < param_2; uVar1 = uVar1 + 1) {
    ...
    case 0x2b:
      break;
    default:
      goto switchD_010bf750_caseD_2c;
    case 0x2d:
      uVar3 = 0x84;
      break;
    case 0x2e:
    ...
    case 4:
      if ((uVar2 & 0x3c) != 0) goto switchD_010bf750_caseD_2c;
LAB_010bf7ec:
      uVar2 = uVar3 | uVar2;
      break;
    default:
    ...
    case 10:
      ...
      break;
    case 0x10:
      if ((uVar2 >> 4 & 1) != 0) goto switchD_010bf750_caseD_2c;
      if ((uVar2 >> 3 & 1) != 0) goto LAB_010bf7ec;
      uVar2 = uVar2 & 0x1c0 | uVar3 | 1;
      break;
    case 0x20:
    case 0x21:
      if ((uVar2 >> 3 & 1) == 0) goto switchD_010bf750_caseD_2c;
      uVar2 = uVar2 & 0x1c0 | 2;
    }
  }
switchD_010bf750_caseD_2c:
  *param_3 = uVar2;
  *param_4 = uVar1;
  return uVar2 >> 3 & 1;
}
