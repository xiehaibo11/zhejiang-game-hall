...
undefined8 FUN_010c563c(long *param_1)

{
  ...
  lVar2 = png_create_png_struct(&DAT_01447da8,param_1,png_safe_error,png_safe_warning,0,0,0);
  if (lVar2 == 0) {
    local_28 = 0;
    ...
    *(uint *)(lVar2 + 0x168) = *(uint *)(lVar2 + 0x168) | 0x300000;
    ...
    local_28 = lVar2;
                    /* try { // try from 010c56e0 to 011c57db has its CatchHandler @ 010c5898 */
    memset(param_1,0,0x68);
    *(undefined4 *)(param_1 + 1) = 1;
