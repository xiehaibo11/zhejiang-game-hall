...
/* std::__ndk1::vector<dragonBones::EventObject*, std::__ndk1::allocator<dragonBones::EventObject*>
   >::insert(std::__ndk1::__wrap_iter<dragonBones::EventObject* const*>, dragonBones::EventObject*
   const&) */

undefined8 * __thiscall
std::__ndk1::vector<dragonBones::EventObject*,std::__ndk1::allocator<dragonBones::EventObject*>>::
insert(vector<dragonBones::EventObject*,std::__ndk1::allocator<dragonBones::EventObject*>> *this,
...

{
  ...
  if (uVar4 >> 0x3d != 0) goto LAB_00d7c89c;
...
LAB_00d7c774:
  ...
  if (uVar7 == uVar4) {
    if (lVar6 < 1) {
      uVar4 = lVar6 >> 2;
                    /* try { // try from 00d7c7e0 to 00e7caa7 has its CatchHandler @ 00d7d92c */
      if (lVar6 == 0) {
        uVar4 = 1;
      }
      if (uVar4 >> 0x3d != 0) {
