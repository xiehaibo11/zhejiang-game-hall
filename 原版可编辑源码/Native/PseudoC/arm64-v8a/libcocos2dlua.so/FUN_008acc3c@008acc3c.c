...
undefined8 FUN_008acc3c(lua_State *param_1)

{
  ...
  if (param_1 != (lua_State *)0x0) {
    ...
    if (iVar1 + -1 == 1) {
      ...
      cocos2d::ScriptHandlerMgr::addObjectHandler(pSVar4,uVar3,uVar2,6);
    }
    else {
      luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d\n",
                 "cc.Layer:registerScriptAccelerateHandler",iVar1 + -1,1);
    }
  }
  return 0;
}
