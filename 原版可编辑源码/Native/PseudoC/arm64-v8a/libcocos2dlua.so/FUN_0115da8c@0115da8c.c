...
void FUN_0115da8c(byte *param_1,byte *param_2,byte *param_3,byte *param_4,uint param_5)

{
  ...
  pbVar48 = param_2;
  if ((param_5 & 0x7ffffffe) == 0) goto LAB_0115e3d4;
...
LAB_0115e200:
    ...
    if ((param_4 < param_1 + (uVar51 >> 1) + 2 && param_1 < pbVar45) ||
       ((param_4 < param_2 + lVar2 && param_2 < pbVar45 ||
        (param_4 < param_3 + lVar2 && param_3 < pbVar45)))) goto LAB_0115e200;
    pbVar47 = param_2;
    pbVar46 = param_4;
    pbVar49 = param_3;
    uVar53 = uVar52;
    ...
    if (uVar1 != uVar52) goto LAB_0115e200;
  }
