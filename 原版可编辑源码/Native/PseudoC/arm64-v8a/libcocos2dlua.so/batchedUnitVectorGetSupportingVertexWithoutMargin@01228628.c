...

{
  ...
  if (0 < param_3) {
    ...
    do {
      ...
      fVar5 = *(float *)pbVar3 * *(float *)pbVar3 + *(float *)(pbVar3 + 4) * *(float *)(pbVar3 + 4);
      fVar4 = SQRT(fVar5);
      if (NAN(fVar4)) {
        fVar4 = sqrtf(fVar5);
        if (fVar4 != 0.0) goto LAB_0122867c;
LAB_012286b0:
        fVar5 = -fVar7;
        ...
        if (fVar4 == 0.0) goto LAB_012286b0;
LAB_0122867c:
        fVar4 = fVar6 / fVar4;
        fVar6 = fVar4 * *(float *)pbVar3;
        fVar5 = -fVar7;
        if (0.0 <= *(float *)(pbVar3 + -4)) {
          fVar5 = fVar7;
        }
        fVar4 = fVar4 * *(float *)(pbVar3 + 4);
      }
