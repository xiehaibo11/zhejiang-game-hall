...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   fairygui::GearLook::GearLookValue>, void*>*>
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   fairygui::GearLook::GearLookValue> > >::find<std::__ndk1::basic_string<char,
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00ab4214;
              goto LAB_00ab42c4;
            }
            if (uVar9 != uVar14) goto LAB_00ab42c4;
          }
LAB_00ab4214:
          plVar8 = (long *)*plVar8;
