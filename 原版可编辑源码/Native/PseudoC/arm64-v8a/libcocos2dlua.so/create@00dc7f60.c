...
/* cocos2d::ui::Text::create(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&, std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, float) */

Widget * cocos2d::ui::Text::create(basic_string *param_1,basic_string *param_2,float param_3)

{
  ...
  if (this != (Widget *)0x0) {
    ...
    *(undefined4 *)(this + 0x534) = 0;
    uVar1 = (**(code **)(*(long *)this + 0x6a0))
                      (CONCAT44(in_register_00005004,param_3),this,param_1,param_2);
    if ((uVar1 & 1) == 0) {
