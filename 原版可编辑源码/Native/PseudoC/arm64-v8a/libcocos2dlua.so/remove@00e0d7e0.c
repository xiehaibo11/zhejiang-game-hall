...

{
  ...
  do {
    plVar5 = plVar2;
                    /* try { // try from 00e0d82c to 00f0d83b has its CatchHandler @ 00e0db08 */
    plVar2 = (long *)*plVar5;
  } while ((long *)*plVar5 != param_3);
                    /* try { // try from 00e0d83c to 00f0d97f has its CatchHandler @ 00e0d3f0 */
  if (plVar5 != param_2 + 2) {
    uVar7 = plVar5[1];
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
    ...
    if (uVar7 == uVar4) goto LAB_00e0d8bc;
  }
  if (*param_3 != 0) {
