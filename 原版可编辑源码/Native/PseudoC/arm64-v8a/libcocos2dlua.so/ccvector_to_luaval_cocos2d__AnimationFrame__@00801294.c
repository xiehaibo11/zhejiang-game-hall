...
/* void ccvector_to_luaval<cocos2d::AnimationFrame*>(lua_State*,
   cocos2d::Vector<cocos2d::AnimationFrame*> const&) */

void ccvector_to_luaval<cocos2d::AnimationFrame*>(lua_State *param_1,Vector *param_2)
