...
LAB_00bdd430:
        ...
        if ((iVar1 == 0) || (iVar1 = strcmp(pcVar10,"X509 CERTIFICATE"), iVar1 == 0)) {
          if (pXVar4->x509 != (X509 *)0x0) goto LAB_00bdd510;
          pcVar11 = d2i_X509;
LAB_00bdd304:
          iVar1 = 0;
          a = pXVar4;
...
LAB_00bdd398:
        ...
        if (iVar1 == 0) {
          ...
          if (iVar1 == 0) {
            ...
            if (iVar1 == 0) goto LAB_00bdd598;
            pXVar4 = X509_INFO_new();
            goto joined_r0x00bdd230;
          }
...
LAB_00bdd2cc:
            ...
            if (iVar1 == 0) {
              if (pXVar4->x_pkey != (X509_PKEY *)0x0) goto LAB_00bdd510;
              pXVar4->enc_data = (char *)0x0;
              pXVar4->enc_len = 0;
              pXVar7 = X509_PKEY_new();
              pcVar10 = local_70;
              ...
              if (pXVar7 != (X509_PKEY *)0x0) {
                sVar8 = strlen(local_70);
                if (10 < (int)sVar8) goto LAB_00bdd2cc;
...
LAB_00bdd510:
        ...
        pXVar4 = X509_INFO_new();
joined_r0x00bdd230:
        if (pXVar4 == (X509_INFO *)0x0) goto LAB_00bdd598;
        goto LAB_00bdd430;
      }
LAB_00bdd524:
