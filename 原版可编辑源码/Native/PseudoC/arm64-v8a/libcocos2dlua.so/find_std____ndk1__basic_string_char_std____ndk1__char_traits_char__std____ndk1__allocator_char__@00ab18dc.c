...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   fairygui::GearColor::GearColorValue>, void*>*>
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   fairygui::GearColor::GearColorValue> > >::find<std::__ndk1::basic_string<char,
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (sVar1 == __n) {
              ...
              if ((bVar3 & 1) == 0) {
                if (__n == 0) break;
                    /* try { // try from 00ab1a00 to 00bb1a33 has its CatchHandler @ 00ab1b00 */
            ...
            if (uVar13 < 2) {
              uVar9 = uVar9 & uVar12 - 1;
                    ...
                    /* try { // try from 00ab1a34 to 00bb1a47 has its CatchHandler @ 00ab1acc */
              if (uVar12 <= uVar9) {
                uVar4 = 0;
                if (uVar12 != 0) {
                  uVar4 = uVar9 / uVar12;
                }
                if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00ab19b8;
                goto LAB_00ab1a68;
              }
            }
            if (uVar9 != uVar14) goto LAB_00ab1a68;
          }
LAB_00ab19b8:
          plVar8 = (long *)*plVar8;
...
LAB_00ab1a6c:
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* try { // try from 00ab1a80 to 00bb1b1b has its CatchHandler @ 00ab1840 */
    return plVar8;
  }
