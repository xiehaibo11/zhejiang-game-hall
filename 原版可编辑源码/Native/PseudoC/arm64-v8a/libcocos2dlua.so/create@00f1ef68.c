...
Node * cocos2d::MenuItemSprite::create(Node *param_1,Node *param_2,Node *param_3,function *param_4)

{
  ...
  initWithNormalSprite((MenuItemSprite *)this,param_1,param_2,param_3,param_4);
