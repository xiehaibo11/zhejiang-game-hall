...
/* flatbuffers::CreateEasingData(flatbuffers::FlatBufferBuilder&, int,
   flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Position const*> >) */

undefined4 flatbuffers::CreateEasingData(FlatBufferBuilder *param_1,int param_2,int param_3)

{
  ...
  if ((param_2 != -1) || (param_1[0x60] != (FlatBufferBuilder)0x0)) {
    local_50 = param_2;
    FlatBufferBuilder::Align(param_1,4);
    FlatBufferBuilder::PushBytes(param_1,(uchar *)&local_50,4);
    uStack_4c = 4;
