...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<uv_write_s*, uv_write_s*>,
   ...
   >::remove(std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<uv_write_s*,
   uv_write_s*>, void*>*>) */
...

{
  ...
  undefined8 uVar9;
                    ...
                    /* try { // try from 00a0cd2c to 00b0cd3b has its CatchHandler @ 00a0cda0 */
  uVar3 = param_2[1];
  uVar4 = param_3[1];
  uVar9 = CONCAT17(POPCOUNT((char)(uVar3 >> 0x38)),
                   CONCAT16(POPCOUNT((char)(uVar3 >> 0x30)),
                    ...
                    /* try { // try from 00a0cd3c to 00b0cdbb has its CatchHandler @ 00a0ccf4 */
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
                    ...
                    /* catch() { ... } // from try @ 00a0cd2c with catch @ 00a0cda0 */
      uVar1 = 0;
      if (uVar3 != 0) {
        uVar1 = uVar7 / uVar3;
      }
    ...
    if (uVar7 == uVar4) goto LAB_00a0ce08;
  }
  if (*param_3 != 0) {
