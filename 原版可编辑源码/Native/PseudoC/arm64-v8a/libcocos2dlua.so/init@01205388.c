...

{
  ...
  __s = (moneypunct_byname<char,false> *)plVar5->mon_decimal_point;
  mVar8 = *__s;
  if (mVar8 == (moneypunct_byname<char,false>)0x0) goto LAB_01205444;
...
LAB_012054a8:
    ...
    if (sVar6 < 0xfffffffffffffffe) {
      ...
      if (((uVar3 != 0xffffffff) || (uVar3 = 0x20, local_88[0] == L'\xa0')) ||
         (local_88[0] == L'\x202f')) goto LAB_012054ac;
    }
    goto LAB_012054a8;
  }
LAB_012054ac:
  ...
  this_00 = (basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
            (this + 0x30);
  basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::assign
            (this_00,plVar5->currency_symbol);
  uVar3 = 0;
  if ((byte)plVar5->frac_digits != 0xff) {
    uVar3 = (uint)(byte)plVar5->frac_digits;
  }
  *(uint *)(this + 0x78) = uVar3;
  if (plVar5->p_sign_posn == '\0') {
    basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::assign
              ((basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
               (this + 0x48),"()");
  }
  ...
  FUN_012057a4(this + 0x7c,&local_70,0,plVar5->p_cs_precedes,plVar5->p_sep_by_space,
               plVar5->p_sign_posn);
  FUN_012057a4(this + 0x80,this_00,0,plVar5->n_cs_precedes,plVar5->n_sep_by_space,
               plVar5->n_sign_posn);
