...
void FUN_00eac2e0(long param_1,undefined4 param_2)

{
  ...
  if (*(char *)(param_1 + 0xa5) != '\0') {
    ...
    uVar7 = sVar5 + 1;
    if ((long)uVar7 < 0) goto LAB_00eac490;
...
LAB_00eac3c8:
    ...
    *(ulong *)(param_1 + 0x38) = (long)pvVar6 + uVar7;
    goto joined_r0x00eac400;
  }
  puVar1 = *(undefined1 **)(param_1 + 0x30);
  puVar2 = *(undefined1 **)(param_1 + 0x38);
  if (*(char *)(param_1 + 0xa6) == '\0') {
    if (puVar1 != puVar2) goto LAB_00eac410;
  }
