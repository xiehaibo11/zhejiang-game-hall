...
uint * FUN_01272e58(long param_1,uint *param_2,long param_3)

{
  ...
  uVar7 = uVar3 & 0xff;
  uVar1 = FUN_01272b1c(uVar3 & 0xff,param_1);
  lVar2 = 0;
  do {
    if (*param_2 == 0) {
      return (uint *)0x0;
    ...
    if (param_2[1] != 0) {
      ...
      if (((*(byte *)(param_1 + 0x20) >> 2 & 1) != 0) &&
        ...
        uVar3 = FUN_01272d5c(lVar6);
        uVar7 = uVar3 & 0xffffffff;
        uVar1 = FUN_01272b1c(uVar3,param_1);
      }
      if ((uint)uVar7 == 0) {
        ...
        uVar4 = FUN_01272bdc(uVar7 & 0xff,uVar1,param_2 + 2,&local_10);
        FUN_01272bdc((uint)uVar7 & 0xf,0,uVar4,&local_8);
        uVar3 = FUN_01272abc(uVar7 & 0xff);
