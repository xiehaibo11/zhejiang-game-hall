...

{
  ...
  uint uVar8;
                    ...
                    /* try { // try from 00bad1e8 to 00cad1f3 has its CatchHandler @ 00bad2b8 */
                    /* try { // try from 00bad1f8 to 00cad1ff has its CatchHandler @ 00bad2b4 */
                    /* try { // try from 00bad200 to 00cad213 has its CatchHandler @ 00bad2a4 */
  if (param_4 == 0) {
    iVar4 = 100;
    line = 0x105;
LAB_00bad338:
  ...
  uVar8 = (uint)bVar2;
  uVar5 = uVar8 & 0xfe;
                    /* try { // try from 00bad21c to 00cad223 has its CatchHandler @ 00bad2b8 */
  if ((6 < uVar5) || ((1 << (ulong)(uVar8 & 0x1e) & 0x55U) == 0)) {
                    /* catch() { ... } // from try @ 00bad1e8 with catch @ 00bad2b8
                       catch() { ... } // from try @ 00bad21c with catch @ 00bad2b8 */
                    /* catch() { ... } // from try @ 00bad228 with catch @ 00bad2bc */
                    /* catch() { ... } // from try @ 00bad0cc with catch @ 00bad2c0
                       catch() { ... } // from try @ 00bad248 with catch @ 00bad2c0 */
                    /* catch() { ... } // from try @ 00bad02c with catch @ 00bad2c4 */
    iVar4 = 0x66;
    line = 0x10e;
    goto LAB_00bad338;
  }
                    /* try { // try from 00bad228 to 00cad247 has its CatchHandler @ 00bad2bc */
  if (((bVar2 & 1) != 0) && ((uVar5 | 4) == 4)) {
                    /* try { // try from 00bad248 to 00cad253 has its CatchHandler @ 00bad2c0 */
    iVar4 = 0x66;
    line = 0x112;
                    /* try { // try from 00bad254 to 00cad2d7 has its CatchHandler @ 00bace40 */
    goto LAB_00bad338;
  }
  if ((bVar2 & 0xfe) == 0) {
    if (param_4 == 1) {
  ...
  lVar3 = (long)((ulong)uVar1 << 0x20) >> 0x23;
                    /* catch() { ... } // from try @ 00bad200 with catch @ 00bad2a4 */
  ...
  if (param_5 == (BN_CTX *)0x0) {
    ...
    c = (BN_CTX *)0x0;
                    /* catch() { ... } // from try @ 00bad1f8 with catch @ 00bad2b4 */
  }
    ...
    if (pBVar7 != (BIGNUM *)0x0) {
      ...
      if (iVar4 < 0) {
        if (uVar5 == 2) {
          ...
          if (pBVar7 == (BIGNUM *)0x0) goto LAB_00bad3e8;
