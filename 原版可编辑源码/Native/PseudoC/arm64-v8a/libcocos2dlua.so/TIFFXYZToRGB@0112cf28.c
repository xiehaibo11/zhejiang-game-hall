...

{
  ...
  if (iVar2 <= *param_4) {
    iVar3 = iVar2;
                    ...
                    /* catch() { ... } // from try @ 0112d140 with catch @ 0112cfec */
  fVar5 = 0.5;
  ...
  *param_5 = (int)(fVar5 + (float)param_4[(long)iVar3 + 0x1c]);
  ...
  if (iVar3 <= *param_4) {
    iVar2 = iVar3;
                    ...
                    /* try { // try from 0112d018 to 0122d023 has its CatchHandler @ 0112d178 */
  fVar5 = 0.5;
  ...
  *param_5 = uVar1;
                    /* try { // try from 0112d084 to 0122d08f has its CatchHandler @ 0112d17c */
  uVar1 = *param_6;
