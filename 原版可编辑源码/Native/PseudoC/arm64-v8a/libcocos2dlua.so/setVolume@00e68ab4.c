...
/* cocos2d::experimental::AudioEngine::setVolume(int, float) */

void cocos2d::experimental::AudioEngine::setVolume(int param_1,float param_2)
      ...
      do {
        ...
        if (uVar5 == uVar2) {
          if ((int)plVar4[2] == param_1) {
            fVar9 = 0.0;
            if ((0.0 <= param_2) && (fVar9 = param_2, 1.0 < param_2)) {
              fVar9 = 1.0;
            }
            if (*(float *)(plVar4 + 5) == fVar9) {
              return;
            }
            AudioEngineImpl::setVolume((int)_audioEngineImpl,fVar9);
            *(float *)(plVar4 + 5) = fVar9;
            return;
          }
        }
        else {
