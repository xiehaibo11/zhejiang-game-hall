...
/* cocos2d::Console::createCommandDebugMsg() */

void __thiscall cocos2d::Console::createCommandDebugMsg(Console *this)

{
  ...
  basic_string<decltype(nullptr)>(local_128,"debugmsg");
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
...
LAB_00f8dbf4:
  ...
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string<decltype(nullptr)>(local_158,"enable debug logging");
  local_110 = &PTR_FUN_017223e0;
  local_f0 = &local_110;
  uStack_100 = 0;
  local_108 = commandDebugMsgSubCommandOnOff;
  local_f8 = this;
...
LAB_00f8dcd0:
  ...
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string<decltype(nullptr)>(local_158,"disable debug logging");
  local_110 = &PTR_FUN_017223e0;
  local_f0 = &local_110;
  uStack_100 = 0;
  local_108 = commandDebugMsgSubCommandOnOff;
  ...
  if (&local_110 == local_f0) {
    ...
    if (local_f0 == (undefined ***)0x0) goto LAB_00f8ddc8;
    pcVar3 = (code *)(*local_f0)[5];
  }
  (*pcVar3)();
LAB_00f8ddc8:
