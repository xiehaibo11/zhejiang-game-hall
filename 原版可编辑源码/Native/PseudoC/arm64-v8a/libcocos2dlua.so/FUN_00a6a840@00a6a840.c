...
void FUN_00a6a840(byte *param_1,byte *param_2)

{
  ...
  local_68 = *(long *)(lVar10 + 0x28);
                    /* try { // try from 00a6a868 to 00b6a8c3 has its CatchHandler @ 00a6a968 */
...
LAB_00a6a8d4:
  if (0x3e < bVar15) {
    ...
    if (bVar15 == 0x5b) {
      uVar8 = 0;
                    /* try { // try from 00a6a8f8 to 00b6a90b has its CatchHandler @ 00a6a964 */
      uVar5 = 0;
      bVar2 = false;
      param_1 = param_1 + 1;
      uVar7 = 0;
...
LAB_00a6a920:
        uVar13 = uVar3;
        iVar6 = (int)uVar13;
                    /* try { // try from 00a6a924 to 00b6a983 has its CatchHandler @ 00a6a7cc */
        switch(uVar8) {
        case 0:
          iVar4 = isalnum(iVar6);
          if (iVar4 != 0) {
          ...
          case 0x5e:
            ...
            *pcVar9 = '\x01';
            ...
            break;
          case 0x5b:
            goto switchD_00a6ab34_caseD_5b;
          case 0x5c:
            uVar7 = (ulong)param_1[1];
            iVar6 = isprint((uint)param_1[1]);
            lVar10 = local_190;
            if (iVar6 == 0) goto LAB_00a6b110;
            uVar8 = 1;
        ...
        case 1:
          uVar8 = 0;
          uVar3 = 0x5b;
          if (iVar6 != 0x5b) goto code_r0x00a6a950;
          goto LAB_00a6a920;
        case 2:
          if (iVar6 == 0x5c) {
            param_1 = param_1 + 1;
          ...
          if ((int)uVar13 == 0x5c) {
            ...
            if ((int)uVar13 == 0x5d) goto LAB_00a6af7c;
            uVar8 = 2;
          }
          uVar16 = (uint)uVar7;
          uVar1 = uVar16 & 0xff;
          ...
          if ((((iVar6 == 0) || (iVar6 = islower(uVar1), iVar6 == 0)) &&
             ...
             ((iVar6 = isupper(uVar12), lVar10 = local_190, iVar6 == 0 ||
              (iVar6 = isupper(uVar1), lVar10 = local_190, iVar6 == 0)))) goto LAB_00a6b110;
          acStack_188[uVar5] = '\0';
          uVar1 = uVar16 + 1 & 0xff;
          uVar16 = uVar16 + 2;
        ...
        case 3:
          ...
          lVar10 = local_190;
          if (uVar13 == 0) goto LAB_00a6b110;
          if (iVar6 == 0x5d) goto LAB_00a6af7c;
          iVar6 = isprint(iVar6);
          lVar10 = local_190;
          if (iVar6 == 0) goto LAB_00a6b110;
          uVar8 = 0;
        ...
        case 4:
          ...
          break;
        default:
          goto switchD_00a6a938_default;
        }
      } while( true );
    }
    if (bVar15 != 0x5c) goto LAB_00a6af5c;
    bVar15 = param_1[1];
    iVar6 = isprint((uint)bVar15);
    if (iVar6 == 0) {
LAB_00a6b110:
    ...
    if ((uint)bVar15 == (uint)*param_2) goto code_r0x00a6a8b4;
    goto LAB_00a6b0ac;
  }
  pbVar14 = param_1;
  if (bVar15 == 0x2a) {
    ...
    uVar7 = FUN_00a6a840(pbVar14,param_2);
    if ((int)uVar7 == 0) goto LAB_00a6b114;
    if (*param_2 != 0) goto LAB_00a6a8cc;
    goto LAB_00a6b0ac;
  }
  if (bVar15 == 0) {
...
code_r0x00a6a950:
  if (iVar6 == 0x2d) {
    acStack_188[0x2d] = 1;
                    /* try { // try from 00a6a910 to 00b6a923 has its CatchHandler @ 00a6a968 */
    param_1 = param_1 + 1;
    uVar5 = 0x2d;
    uVar8 = 2;
    goto LAB_00a6a91c;
  ...
  iVar4 = isalnum(iVar6);
                    /* catch() { ... } // from try @ 00a6a820 with catch @ 00a6a964
                       catch() { ... } // from try @ 00a6a8f8 with catch @ 00a6a964 */
  if (iVar4 != 0) {
                    /* catch() { ... } // from try @ 00a6a868 with catch @ 00a6a968
                       catch() { ... } // from try @ 00a6a910 with catch @ 00a6a968 */
    uVar8 = 1;
    acStack_188[uVar13] = '\x01';
    param_1 = param_1 + 1;
    goto LAB_00a6a91c;
  ...
  lVar10 = local_190;
  if (iVar6 != 0x5d) goto LAB_00a6b110;
LAB_00a6af7c:
  bVar15 = *param_2;
...
switchD_00a6ab34_caseD_5b:
  ...
  if ((iVar6 == 0) || (iVar6 = islower((uint)bVar15), iVar6 == 0)) {
    lVar10 = local_190;
    if (bVar15 != 0x3a) goto LAB_00a6b110;
    pbVar14 = param_1 + 3;
    lVar11 = 4;
  }
  else {
  ...
  lVar10 = local_190;
  if (*pbVar14 != 0x5d) goto LAB_00a6b110;
...
code_r0x00a6a8b4:
  ...
  param_1 = param_1 + 2;
  bVar15 = *param_1;
                    /* try { // try from 00a6a8c4 to 00b6a8f7 has its CatchHandler @ 00a6a7cc */
  goto LAB_00a6a8d4;
}
