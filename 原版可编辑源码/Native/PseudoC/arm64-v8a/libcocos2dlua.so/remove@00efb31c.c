...

{
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar7 == uVar4) goto LAB_00efb3f8;
  }
  if (*param_3 != 0) {
    ...
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
                    ...
                    /* try { // try from 00efb3c8 to 00ffb3d7 has its CatchHandler @ 00efb75c */
      if (uVar3 <= uVar7) {
        uVar1 = 0;
        if (uVar3 != 0) {
          uVar1 = uVar7 / uVar3;
        ...
        uVar7 = uVar7 - uVar1 * uVar3;
                    /* try { // try from 00efb3d8 to 00ffb3eb has its CatchHandler @ 00efb718 */
      }
    }
    if (uVar7 == uVar4) goto LAB_00efb3f8;
  }
