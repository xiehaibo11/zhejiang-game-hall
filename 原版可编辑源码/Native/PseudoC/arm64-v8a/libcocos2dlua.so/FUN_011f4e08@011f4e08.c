...
void FUN_011f4e08(long param_1,__shared_count *param_2)

{
  ...
  local_70 = &std::__ndk1::ctype<char>::id;
  uStack_60 = 0;
  local_68 = std::__ndk1::locale::id::__init;
  if (std::__ndk1::ctype<char>::id != -1) {
    local_58 = &local_50;
    local_50 = (undefined1 *)&local_70;
    std::__ndk1::__call_once((ulong *)&std::__ndk1::ctype<char>::id,&local_58,FUN_01208130);
  }
  uVar2 = (ulong)DAT_01794330;
  uVar6 = uVar2 - 1;
