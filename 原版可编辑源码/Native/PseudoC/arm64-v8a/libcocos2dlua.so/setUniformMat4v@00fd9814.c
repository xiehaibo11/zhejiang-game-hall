...
/* cocos2d::GLProgramState::setUniformMat4v(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, long, cocos2d::Mat4
   const*) */

void __thiscall
cocos2d::GLProgramState::setUniformMat4v
          (GLProgramState *this,basic_string *param_1,long param_2,Mat4 *param_3)
