...
void FUN_0115ad38(byte *param_1,byte *param_2,byte *param_3,byte *param_4,uint param_5)

{
  ...
  auVar25 = _DAT_01499830;
  auVar24 = _DAT_01499820;
  auVar23 = _DAT_01499810;
  auVar22 = _DAT_01499800;
  auVar21 = _DAT_014997d0;
  auVar20 = _DAT_014997b0;
  pbVar3 = param_4;
  pbVar5 = param_3;
  pbVar4 = param_2;
  pbVar2 = param_1;
  if ((param_5 & 0xfffffffe) != 0) {
    ...
    if ((7 < uVar1) && (uVar45 = uVar1 & 0x7ffffffffffffff8, uVar45 != 0)) {
      ...
      if ((param_1 + uVar44 * 2 + 2 <= param_4 || pbVar2 <= param_1) &&
        ...
        if (uVar1 == uVar45) goto joined_r0x0115b364;
      }
    }
    do {
      bVar46 = *param_2;
