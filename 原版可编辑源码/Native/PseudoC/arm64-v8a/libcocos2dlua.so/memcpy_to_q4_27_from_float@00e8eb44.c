...
void memcpy_to_q4_27_from_float(int *param_1,float *param_2,ulong param_3)
  ...
  if (param_3 != 0) {
    if (param_3 == 1) {
      ...
      do {
        ...
        iVar12 = -(uint)(fVar9 <= (float)uVar6);
        fVar11 = (float)((ulong)*(undefined8 *)param_2 >> 0x20);
        iVar14 = -(uint)(fVar11 <= (float)((ulong)uVar6 >> 0x20));
        iVar16 = -(uint)((float)uVar7 <= fVar9);
        iVar22 = -(uint)((float)((ulong)uVar7 >> 0x20) <= fVar11);
        auVar27._0_8_ = (long)(int)-(uint)(0.0 < fVar9 * 1.3421773e+08);
        auVar27._8_8_ = (long)(int)-(uint)(0.0 < fVar11 * 1.3421773e+08);
        auVar27 = auVar8 ^ (auVar8 ^ auVar10) & auVar27;
        uVar13 = CONCAT44((int)(long)(auVar27._8_8_ + (double)(fVar11 * 1.3421773e+08)),
                          (int)(long)(auVar27._0_8_ + (double)(fVar9 * 1.3421773e+08)));
    ...
    do {
      while( true ) {
        ...
        if (16.0 <= fVar9) {
          ...
          *piVar3 = (int)(fVar11 + fVar9 * 1.3421773e+08);
        }
        pfVar2 = pfVar2 + 1;
        piVar3 = piVar3 + 1;
        if (lVar1 == 0) {
