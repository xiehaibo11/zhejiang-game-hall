...
/* cocos2d::Console::Command::getSubCommand(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) const */

undefined8 __thiscall cocos2d::Console::Command::getSubCommand(Command *this,basic_string *param_1)
