...

{
  ...
  if (uVar7 == 0) {
    ...
    uVar11 = uVar7 & 0x3fffffffffffffff;
    uStack_78 = 0;
...
LAB_00fc5984:
    ...
    *(undefined4 *)(pAVar9 + uVar7 * 4) = 0;
    ...
    cVar5 = (*param_3)((ArgType **)&local_88,(ArgType *)(local_88 + uVar10),&local_90,
                       local_90 + uVar7 * 4,0);
    if (cVar5 != '\0') {
      if ((local_80 & 1) != 0) {
    ...
    if (uVar8 < uVar7 || uVar12 == 0) {
      ...
      *(undefined4 *)(local_70 + uVar8 * 4) = 0;
      uStack_78 = uVar8;
      if (((byte)*param_2 & 1) != 0) goto LAB_00fc5b14;
LAB_00fc5a74:
      *(undefined4 *)(param_2 + 4) = 0;
      *param_2 = (basic_string)0x0;
    }
...
LAB_00fc5a6c:
        ...
        if (uVar6 - uVar10 < uVar12) {
          ...
          ::__grow_by((basic_string<char32_t,std::__ndk1::char_traits<char32_t>,std::__ndk1::allocator<char32_t>>
                       *)&local_80,uVar6,uVar1 - uVar6,uVar10,uVar10,0,0);
          uVar8 = local_80 & 0xff;
        }
        pAVar9 = (ArgType *)((ulong)&local_80 | 4);
        if ((uVar8 & 1) != 0) {
        ...
        memset(pAVar9 + uVar10 * 4,0,uVar11 + uVar7 * -4);
        uVar7 = uVar1;
        if ((local_80 & 1) == 0) {
      ...
      if (((byte)bVar2 & 1) == 0) goto LAB_00fc5a74;
LAB_00fc5b14:
      **(undefined4 **)(param_2 + 0x10) = 0;
      *(undefined8 *)(param_2 + 8) = 0;
      if (((byte)*param_2 & 1) != 0) {
