...

{
  ...
  *(undefined8 *)param_1 = 0;
  if (pvVar1 != (void *)0x0) {
                    /* try { // try from 00e02394 to 00f0239f has its CatchHandler @ 00e0246c */
