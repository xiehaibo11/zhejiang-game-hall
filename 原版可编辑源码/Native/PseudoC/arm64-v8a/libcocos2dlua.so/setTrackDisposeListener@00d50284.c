...
/* spine::SkeletonAnimation::setTrackDisposeListener(spTrackEntry*, std::__ndk1::function<void
   (spTrackEntry*)> const&) */
...

{
  ...
  FUN_00d505ec(alStack_70,puVar2 + 0x12);
  if (alStack_70 == local_50) {
    pcVar4 = *(code **)(*local_50 + 0x20);
  }
  else {
    if (local_50 == (long *)0x0) goto LAB_00d5037c;
