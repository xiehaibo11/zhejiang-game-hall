...
/* luaval_to_color4b(lua_State*, int, cocos2d::Color4B*, char const*) */

bool luaval_to_color4b(lua_State *param_1,int param_2,Color4B *param_3,char *param_4)

{
  ...
  bVar2 = false;
  if ((param_1 != (lua_State *)0x0) && (param_3 != (Color4B *)0x0)) {
