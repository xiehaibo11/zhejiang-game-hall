...

{
  ...
  if (uVar12 != 0) {
    ...
    if (plVar8 != (long *)0x0) {
      plVar8 = (long *)*plVar8;
      if (plVar8 != (long *)0x0) {
                    /* catch() { ... } // from try @ 00f4a648 with catch @ 00f49f8c */
          ...
          if (uVar7 == uVar9) {
            ...
            if (sVar1 == __n) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                pbVar11 = pbVar2;
                    /* try { // try from 00f4a00c to 0104a013 has its CatchHandler @ 00f4a810 */
                    /* try { // try from 00f4a014 to 0104a06f has its CatchHandler @ 00f4a850 */
                while (*pbVar10 == *pbVar11) {
                  uVar9 = uVar9 - 1;
                  pbVar10 = pbVar10 + 1;
                  pbVar11 = pbVar11 + 1;
                  if (uVar9 == 0) goto LAB_00f4a070;
                }
              }
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00f49fbc;
              goto LAB_00f4a06c;
            }
            if (uVar9 != uVar14) goto LAB_00f4a06c;
          }
LAB_00f49fbc:
          plVar8 = (long *)*plVar8;
...
LAB_00f4a070:
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* try { // try from 00f4a080 to 0104a083 has its CatchHandler @ 00f4a7f8 */
                    /* try { // try from 00f4a0a0 to 0104a0df has its CatchHandler @ 00f4a808 */
    return plVar8;
  }
