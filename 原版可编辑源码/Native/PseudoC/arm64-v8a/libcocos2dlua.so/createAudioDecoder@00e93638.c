...
/* cocos2d::experimental::AudioDecoderProvider::createAudioDecoder(SLEngineItf_ const* const*,
...

{
  ...
  (**(code **)(*plVar3 + 0x138))(local_70,plVar3,param_2);
  ...
  if (uVar4 == 4) {
    ...
    if (*piVar1 == 0x67676f2e) {
      ...
      if (*piVar1 != 0x7661772e) goto LAB_00e936f8;
      this = operator_new(0x70);
