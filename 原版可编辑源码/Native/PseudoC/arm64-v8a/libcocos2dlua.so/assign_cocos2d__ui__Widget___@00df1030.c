...
/* std::__ndk1::enable_if<__is_forward_iterator<cocos2d::ui::Widget**>::value&&is_constructible<cocos2d::ui::Widget*,
   std::__ndk1::iterator_traits<cocos2d::ui::Widget**>::reference>::value, void>::type
   std::__ndk1::vector<cocos2d::ui::Widget*, std::__ndk1::allocator<cocos2d::ui::Widget*>
   >::assign<cocos2d::ui::Widget**>(cocos2d::ui::Widget**, cocos2d::ui::Widget**) */

void __thiscall
std::__ndk1::vector<cocos2d::ui::Widget*,std::__ndk1::allocator<cocos2d::ui::Widget*>>::
assign<cocos2d::ui::Widget**>
          (vector<cocos2d::ui::Widget*,std::__ndk1::allocator<cocos2d::ui::Widget*>> *this,
          Widget **param_1,Widget **param_2)

{
  ...
  ulong uVar5;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00df1080 with catch @ 00df1030
                        */
  ...
  if ((ulong)(lVar1 - (long)pvVar4 >> 3) < uVar5) {
    if (pvVar4 != (void *)0x0) {
                    /* try { // try from 00df1074 to 00ef107f has its CatchHandler @ 00df11b0 */
      *(void **)(this + 8) = pvVar4;
      operator_delete(pvVar4);
      lVar1 = 0;
                    /* try { // try from 00df1080 to 00ef11b3 has its CatchHandler @ 00df1030 */
      *(undefined8 *)this = 0;
      *(undefined8 *)(this + 8) = 0;
...
LAB_00df10b4:
    ...
    if ((ulong)(lVar1 >> 3) < 0xfffffffffffffff) {
      uVar2 = lVar1 >> 2;
      if ((uVar5 <= uVar2) && (uVar5 = uVar2, uVar2 >> 0x3d != 0)) goto LAB_00df10b4;
    }
    else {
    ...
    *(void **)(this + 8) = pvVar4;
    ...
    __src = (Widget **)((long)param_1 + (*(long *)(this + 8) - (long)pvVar4));
    if (uVar5 <= uVar2) {
      __src = param_2;
    }
