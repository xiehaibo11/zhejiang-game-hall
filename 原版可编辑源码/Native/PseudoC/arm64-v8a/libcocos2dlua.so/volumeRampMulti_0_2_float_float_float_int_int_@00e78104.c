...
/* void cocos2d::experimental::volumeRampMulti<0, 2, float, float, float, int, int>(float*, unsigned
   long, float const*, int*, float*, float const*, int*, int) */

void cocos2d::experimental::volumeRampMulti<0,2,float,float,float,int,int>
