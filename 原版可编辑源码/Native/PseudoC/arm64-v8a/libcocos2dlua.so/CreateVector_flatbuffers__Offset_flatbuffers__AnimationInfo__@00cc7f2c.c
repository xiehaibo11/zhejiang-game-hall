...
/* flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::AnimationInfo> > >
   flatbuffers::FlatBufferBuilder::CreateVector<flatbuffers::Offset<flatbuffers::AnimationInfo>
   >(flatbuffers::Offset<flatbuffers::AnimationInfo> const*, unsigned long) */
