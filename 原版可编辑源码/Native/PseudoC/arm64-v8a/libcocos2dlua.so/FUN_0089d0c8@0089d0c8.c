...
void FUN_0089d0c8(lua_State *param_1)

{
  ...
  iVar3 = tolua_isusertable(param_1,1,"CCArray",0,auStack_48);
  if (((iVar3 == 0) || (iVar3 = tolua_isstring(param_1,2,0,auStack_48), iVar3 == 0)) ||
    ...
    pvVar5 = (void *)cocos2d::__Array::createWithContentsOfFile((basic_string *)local_60);
