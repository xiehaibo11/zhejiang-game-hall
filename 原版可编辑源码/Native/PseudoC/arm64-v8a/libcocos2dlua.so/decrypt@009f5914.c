...
/* universe::network::Encryption::decrypt(unsigned char const*, unsigned char*, unsigned long,
   unsigned char const*, int*) */

void __thiscall
universe::network::Encryption::decrypt
...

{
  ...
  AES_cfb128_encrypt(param_1,param_2,param_3,&AStack_158,(uchar *)&local_60,param_5,0);
