...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<cocos2d::GLProgram*,
   ...
   cocos2d::GLProgramState*> > >::__rehash(unsigned long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<cocos2d::GLProgram*,cocos2d::GLProgramState*>,std::__ndk1::__unordered_map_hasher<cocos2d::GLProgram*,std::__ndk1::__hash_value_type<cocos2d::GLProgram*,cocos2d::GLProgramState*>,std::__ndk1::hash<cocos2d::GLProgram*>,true>,std::__ndk1::__unordered_map_equal<cocos2d::GLProgram*,std::__ndk1::__hash_value_type<cocos2d::GLProgram*,cocos2d::GLProgramState*>,std::__ndk1::equal_to<cocos2d::GLProgram*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<cocos2d::GLProgram*,cocos2d::GLProgramState*>>>
           *this,ulong param_1)

{
  ...
  if (param_1 == 0) {
    ...
    *(undefined8 *)(this + 8) = 0;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fdd668 with catch @ 00fdd684
                        */
    if (param_1 >> 0x3d != 0) {
    ...
    pvVar2 = operator_new(param_1 << 3);
                    /* catch() { ... } // from try @ 00fdd6c8 with catch @ 00fdd698 */
    pvVar3 = *(void **)this;
    *(void **)this = pvVar2;
    if (pvVar3 != (void *)0x0) {
    ...
    *(ulong *)(this + 8) = param_1;
    do {
      *(undefined8 *)(*(long *)this + uVar4 * 8) = 0;
      uVar4 = uVar4 + 1;
                    /* try { // try from 00fdd6c0 to 010dd6c7 has its CatchHandler @ 00fdd734 */
    } while (param_1 != uVar4);
                    /* try { // try from 00fdd6c8 to 010dd74f has its CatchHandler @ 00fdd698 */
    ...
    if (plVar5 != (long *)0x0) {
      ...
      *(__hash_table<std::__ndk1::__hash_value_type<cocos2d::GLProgram*,cocos2d::GLProgramState*>,std::__ndk1::__unordered_map_hasher<cocos2d::GLProgram*,std::__ndk1::__hash_value_type<cocos2d::GLProgram*,cocos2d::GLProgramState*>,std::__ndk1::hash<cocos2d::GLProgram*>,true>,std::__ndk1::__unordered_map_equal<cocos2d::GLProgram*,std::__ndk1::__hash_value_type<cocos2d::GLProgram*,cocos2d::GLProgramState*>,std::__ndk1::equal_to<cocos2d::GLProgram*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<cocos2d::GLProgram*,cocos2d::GLProgramState*>>>
      ...
      if ((long *)*plVar5 != (long *)0x0) {
                    /* catch() { ... } // from try @ 00fdd6c0 with catch @ 00fdd734 */
        plVar6 = (long *)*plVar5;
        do {
          uVar7 = plVar6[1];
          if ((uVar12 & 0xffffffff) < 2) {
