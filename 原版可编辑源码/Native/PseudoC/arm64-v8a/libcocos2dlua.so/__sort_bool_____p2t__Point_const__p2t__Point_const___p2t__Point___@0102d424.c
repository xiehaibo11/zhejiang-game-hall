...
/* void std::__ndk1::__sort<bool (*&)(p2t::Point const*, p2t::Point const*),
   p2t::Point**>(p2t::Point**, p2t::Point**, bool (*&)(p2t::Point const*, p2t::Point const*)) */

void std::__ndk1::__sort<bool(*&)(p2t::Point_const*,p2t::Point_const*),p2t::Point**>
...
LAB_0102d464:
  param_1 = (Point **)pauVar12;
  lVar7 = (long)param_2 - (long)param_1;
  uVar6 = lVar7 >> 3;
  switch(uVar6) {
  case 0:
  case 1:
    goto switchD_0102d7c8_caseD_0;
  case 2:
    uVar6 = (**(code **)param_3)
  ...
  case 4:
    __sort4<bool(*&)(p2t::Point_const*,p2t::Point_const*),p2t::Point**>
              (param_1,(Point **)(*(undefined1 (*) [16])param_1 + 8),
               (Point **)((long)param_1 + 0x10),(Point **)pauVar11,param_3);
    return;
  case 5:
    FUN_0102dac0(param_1,*(undefined1 (*) [16])param_1 + 8,
                 (undefined1 (*) [16])((long)param_1 + 0x10),
                 *(undefined1 (*) [16])((long)param_1 + 0x10) + 8,pauVar11,param_3);
    return;
  default:
    if (lVar7 < 0xf8) {
      __insertion_sort_3<bool(*&)(p2t::Point_const*,p2t::Point_const*),p2t::Point**>
      ...
      if ((uVar6 & 1) == 0) {
        if ((uVar5 & 1) == 0) {
          ...
          *(undefined8 *)*pauVar11 = uVar8;
          uVar6 = (**(code **)param_3)
                            (*(undefined8 *)*pauVar12,*(undefined8 *)*(undefined1 (*) [16])param_1);
          if ((uVar6 & 1) == 0) goto LAB_0102d720;
          uVar8 = *(undefined8 *)*(undefined1 (*) [16])param_1;
...
LAB_0102d720:
      ...
      iVar4 = FUN_0102dac0(param_1,*(undefined1 (*) [16])param_1 + lVar7,pauVar12,*pauVar12 + lVar7,
                           pauVar11,param_3);
    }
    uVar6 = (**(code **)param_3)
                      (*(undefined8 *)*(undefined1 (*) [16])param_1,*(undefined8 *)*pauVar12);
  ...
  while (pauVar13 = pauVar10, (undefined1 (*) [16])param_1 != pauVar13) {
    ...
    if ((uVar6 & 1) != 0) goto code_r0x0102d554;
  }
...
LAB_0102d568:
  ...
  if (iVar4 == 0) {
    bVar2 = __insertion_sort_incomplete<bool(*&)(p2t::Point_const*,p2t::Point_const*),p2t::Point**>
                      (param_1,(Point **)pauVar10,param_3);
    bVar3 = __insertion_sort_incomplete<bool(*&)(p2t::Point_const*,p2t::Point_const*),p2t::Point**>
                      ((Point **)(*pauVar10 + 8),param_2,param_3);
    if (bVar3) goto LAB_0102d7a8;
    pauVar12 = (undefined1 (*) [16])(*pauVar10 + 8);
    if (bVar2) goto LAB_0102d464;
  }
  if ((long)param_2 - (long)pauVar10 <= (long)pauVar10 - (long)param_1) {
    __sort<bool(*&)(p2t::Point_const*,p2t::Point_const*),p2t::Point**>
              ((Point **)(*pauVar10 + 8),param_2,param_3);
    param_2 = (Point **)pauVar10;
    goto LAB_0102d450;
  }
  __sort<bool(*&)(p2t::Point_const*,p2t::Point_const*),p2t::Point**>
            (param_1,(Point **)pauVar10,param_3);
