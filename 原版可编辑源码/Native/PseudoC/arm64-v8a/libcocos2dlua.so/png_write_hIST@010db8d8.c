...

{
  ...
  if ((int)(uint)*(ushort *)(param_1 + 0x2a0) < (int)param_3) {
    ...
    if (0 < (int)param_3) {
      ...
      do {
        local_54 = (undefined1)((ushort)*param_2 >> 8);
                    /* try { // try from 010db9c4 to 011dba0b has its CatchHandler @ 010db9c4
                       catch(type#1 @ 00000000) { ... } // from try @ 010db9c4 with catch @ 010db9c4
                       catch(type#1 @ 00000000) { ... } // from try @ 010dba48 with catch @ 010db9c4
                        */
    ...
    *(undefined4 *)(param_1 + 0x4e4) = 0x82;
    local_50 = (undefined1)((uint)uVar1 >> 0x18);
                    /* try { // try from 010dba0c to 011dba13 has its CatchHandler @ 010dba7c */
  ...
  if (*(long *)(lVar2 + 0x28) == local_48) {
                    /* try { // try from 010dba40 to 011dba47 has its CatchHandler @ 010dba78 */
    return;
  }
