...
/* cocostudio::FlatBuffersSerialize::createBoolFrame(tinyxml2::XMLElement const*) */

undefined4 __thiscall
cocostudio::FlatBuffersSerialize::createBoolFrame(FlatBuffersSerialize *this,XMLElement *param_1)

{
  ...
  if (lVar15 == 0) {
    ...
    do {
      ...
      if (uVar2 == 10) {
        ...
        iVar8 = memcmp(pvVar1,"FrameIndex",10);
        if (iVar8 == 0) {
          piVar3 = piVar13;
  ...
  uVar10 = flatbuffers::CreateBoolFrame(uVar14,iVar9,bVar6,bVar7,uVar10);
