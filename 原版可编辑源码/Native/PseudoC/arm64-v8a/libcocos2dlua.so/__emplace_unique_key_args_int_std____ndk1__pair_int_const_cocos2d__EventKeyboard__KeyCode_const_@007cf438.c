...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<int,
   cocos2d::EventKeyboard::KeyCode>, void*>*>, bool>
   ...
   >::__emplace_unique_key_args<int, std::__ndk1::pair<int const, cocos2d::EventKeyboard::KeyCode>
   const&>(int const&, std::__ndk1::pair<int const, cocos2d::EventKeyboard::KeyCode> const&) */
...
::__emplace_unique_key_args<int,std::__ndk1::pair<int_const,cocos2d::EventKeyboard::KeyCode>const&>
          (__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::EventKeyboard::KeyCode>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::EventKeyboard::KeyCode>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::EventKeyboard::KeyCode>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::EventKeyboard::KeyCode>>>
      ...
      for (plVar7 = (long *)*plVar7; plVar7 != (long *)0x0; plVar7 = (long *)*plVar7) {
        ...
        if (uVar6 != uVar9) {
          if (uVar5 < 2) {
            ...
            if (uVar6 - uVar1 * uVar8 == unaff_x24) goto LAB_007cf4c4;
            break;
          }
