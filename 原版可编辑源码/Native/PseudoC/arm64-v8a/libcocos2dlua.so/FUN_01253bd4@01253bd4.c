...
void FUN_01253bd4(long param_1,long param_2,long param_3,long param_4,int param_5,uint param_6)

{
  ...
  if ((param_6 & 1) == 0) {
    if (*(long *)(param_1 + 8) != *(long *)(lVar2 + 8)) goto LAB_01253c58;
  }
  else if ((param_1 != lVar2) &&
          (iVar1 = strcmp(*(char **)(param_1 + 8),*(char **)(lVar2 + 8)), iVar1 != 0)) {
LAB_01253c58:
                    /* WARNING: Could not recover jumptable at 0x01253c88. Too many branches */
