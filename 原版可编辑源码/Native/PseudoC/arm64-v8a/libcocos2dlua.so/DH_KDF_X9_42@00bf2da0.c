...
/* WARNING: Removing unreachable block (ram,0x00bf2fac) */
/* WARNING: Removing unreachable block (ram,0x00bf2f48) */
               ...
               puVar3 = local_68, (uVar6 >> 7 & 1) == 0)) && (local_6c == 0x10)) && (local_70 == 0))
          {
            ...
            if ((((uVar6 >> 7 & 1) == 0) && (local_6c == 6)) && (local_70 == 0)) {
              ...
              if (((uVar6 >> 7 & 1) == 0) && (local_6c == 4 && local_70 == 0)) {
                iVar7 = CRYPTO_memcmp(local_68,&DAT_017754e0,4);
                if (iVar7 != 0) {
                  iVar5 = 0;
                }
                if ((iVar5 != 0) &&
...
LAB_00bf30e8:
                    ...
                    if (iVar4 == 0) break;
                    if (len == param_2) goto LAB_00bf30e8;
                    param_1 = param_1 + len;
