...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void (fairygui::GearXY::*)(),
   ...
   fairygui::GearXY*> >, void ()>::__clone() const */
...
::__clone(__func<std::__ndk1::__bind<void(fairygui::GearXY::*)(),fairygui::GearXY*>,std::__ndk1::allocator<std::__ndk1::__bind<void(fairygui::GearXY::*)(),fairygui::GearXY*>>,void()>
          *this)

{
  ...
  undefined8 uVar3;
                    ...
                    /* catch() { ... } // from try @ 00ab62ac with catch @ 00ab6564
                       catch() { ... } // from try @ 00ab6478 with catch @ 00ab6564 */
  puVar1 = operator_new(0x20);
  *puVar1 = &PTR_FUN_016aa7c8;
