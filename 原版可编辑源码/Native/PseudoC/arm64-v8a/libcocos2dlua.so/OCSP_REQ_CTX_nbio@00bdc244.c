...
LAB_00bdc294:
  ...
  if ((int)uVar5 < 0x1005) {
    if (uVar5 - 1 < 2) goto LAB_00bdc4b4;
    if (uVar5 == 3) goto LAB_00bdc578;
    if (uVar5 != 4) {
      return 0;
    }
    goto LAB_00bdc630;
  ...
  case 0x1005:
    break;
  case 0x1006:
    goto switchD_00bdc2f4_caseD_1006;
  case 0x1007:
    goto switchD_00bdc2f4_caseD_1007;
  case 0x1008:
    goto switchD_00bdc2f4_default;
  case 0x1009:
    iVar3 = BIO_write(*(BIO **)(param_1 + 8),&DAT_013ecf75,2);
    if (iVar3 != 2) goto LAB_00bdc6f8;
    *param_1 = 0x1005;
    break;
  default:
    goto switchD_00bdc2f4_default;
...
switchD_00bdc2f4_caseD_1006:
  ...
  if (0 < iVar3) {
    ...
    *(long *)(param_1 + 10) = lVar8 - iVar3;
    pbVar11 = local_70;
    if (lVar8 - iVar3 != 0) goto LAB_00bdc294;
    *param_1 = 0x1007;
    BIO_ctrl(*(BIO **)(param_1 + 8),1,0,(void *)0x0);
switchD_00bdc2f4_caseD_1007:
  ...
  do {
    while( true ) {
      ...
      if ((iVar3 < 1) || (pvVar7 = memchr(local_70,10,(long)iVar3), pvVar7 == (void *)0x0)) {
        pbVar11 = local_70;
        if (iVar3 < (int)param_1[4]) goto LAB_00bdc294;
        goto LAB_00bdc6f8;
      }
      ...
      if ((int)uVar5 < 1) {
        ...
        pbVar11 = local_70;
        if (iVar3 != 0) goto LAB_00bdc294;
        goto LAB_00bdc6f8;
      }
      if (uVar5 == param_1[4]) goto LAB_00bdc6f8;
...
LAB_00bdc6f0:
      ...
      *pbVar13 = 0;
      ...
      if (*local_68 != 0) goto LAB_00bdc6f8;
      do {
        pbVar13 = pbVar12;
        if (pbVar13[2] == 0) goto LAB_00bdc42c;
...
LAB_00bdc578:
  ...
  if (1 < (int)lVar8) {
    pbVar11 = local_70 + 1;
    if (*local_70 != 0x30) goto LAB_00bdc6f8;
    bVar2 = *pbVar11;
    if ((char)bVar2 < '\0') {
      if ((int)lVar8 < 6) goto LAB_00bdc294;
      uVar5 = bVar2 & 0x7f;
      if (3 < uVar5 - 1) goto LAB_00bdc6f8;
      uVar9 = 0;
      param_1[10] = 0;
      param_1[0xb] = 0;
      pbVar11 = local_70 + 3;
      ...
      if (*(ulong *)(param_1 + 0xc) < uVar9) goto LAB_00bdc6f8;
      lVar8 = uVar9 + (uVar5 + 2);
    }
    else {
      lVar8 = (ulong)bVar2 + 2;
