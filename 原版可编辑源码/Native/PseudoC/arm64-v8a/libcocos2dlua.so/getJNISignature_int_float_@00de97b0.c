...
/* std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   cocos2d::JniHelper::getJNISignature<int, float>(int, float) */

void cocos2d::JniHelper::getJNISignature<int,float>(int param_1,float param_2)

{
  ...
  lVar2 = tpidr_el0;
                    /* try { // try from 00de97cc to 00ee97d3 has its CatchHandler @ 00de99f8 */
  local_38 = *(long *)(lVar2 + 0x28);
                    /* try { // try from 00de97d4 to 00ee9883 has its CatchHandler @ 00de9a4c */
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
