...

{
  ...
  if (uVar8 != 0) {
    ...
    uVar10 = NEON_uaddlv(uVar11,1);
                    /* try { // try from 00fde1d0 to 010de1d7 has its CatchHandler @ 00fde240 */
    uVar4 = CONCAT62((int6)((ulong)uVar11 >> 0x10),uVar10) & 0xffffffff;
                    /* try { // try from 00fde1d8 to 010de25b has its CatchHandler @ 00fde16c */
    if (uVar4 < 2) {
    ...
    if (plVar7 != (long *)0x0) {
      for (plVar7 = (long *)*plVar7; plVar7 != (long *)0x0; plVar7 = (long *)*plVar7) {
        uVar6 = plVar7[1];
                    /* catch() { ... } // from try @ 00fde1d0 with catch @ 00fde240 */
        if (uVar6 != uVar9) {
          if (uVar4 < 2) {
            uVar6 = uVar6 & uVar8 - 1;
          }
            ...
            if (uVar6 - uVar2 * uVar8 == unaff_x24) goto LAB_00fde228;
            break;
          }
  ...
  *(undefined4 *)(plVar7 + 2) = uVar1;
  if ((uVar8 == 0) || ((float)param_1[8] * (float)uVar8 < (float)(*(long *)(param_1 + 6) + 1))) {
    ...
    if ((uVar8 & uVar8 - 1) == 0) {
      unaff_x24 = uVar8 - 1 & uVar9;
                    ...
                    /* try { // try from 00fde2f0 to 010de2ff has its CatchHandler @ 00fde310 */
      unaff_x24 = uVar9;
      if (uVar8 <= uVar9) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fde2f0 with catch @ 00fde310
                        */
        uVar4 = 0;
        if (uVar8 != 0) {
          uVar4 = uVar9 / uVar8;
  ...
  if (plVar3 == (long *)0x0) {
    ...
    *(long **)(lVar5 + unaff_x24 * 8) = plVar3;
    if (*plVar7 == 0) goto LAB_00fde380;
    uVar9 = *(ulong *)(*plVar7 + 8);
                    /* try { // try from 00fde358 to 010de367 has its CatchHandler @ 00fde378 */
    if ((uVar8 & uVar8 - 1) == 0) {
      uVar9 = uVar9 & uVar8 - 1;
    }
    else if (uVar8 <= uVar9) {
      ...
      uVar9 = uVar9 - uVar4 * uVar8;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fde358 with catch @ 00fde378
                        */
