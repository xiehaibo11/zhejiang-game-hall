...
/* cocos2d::TransitionFlipX::onEnter() */

void __thiscall cocos2d::TransitionFlipX::onEnter(TransitionFlipX *this)

{
  ...
  uVar6 = Show::create();
  uVar7 = OrbitCamera::create(*(float *)(this + 0x380) * 0.5,1.0,0.0,fVar2,fVar3,0.0,0.0);
                    /* try { // try from 00f5b83c to 0105b843 has its CatchHandler @ 00f5b884 */
                    /* try { // try from 00f5b844 to 0105b88b has its CatchHandler @ 00f5b628 */
  local_a0 = &PTR_FUN_0171cba0;
  uStack_90 = 0;
  local_98 = TransitionScene::finish;
  local_88 = this;
  local_80 = (long *)&local_a0;
  uVar8 = CallFunc::create((function *)&local_a0);
                    /* catch() { ... } // from try @ 00f5b728 with catch @ 00f5b87c */
  uVar6 = Sequence::create(pFVar5,uVar6,uVar7,uVar8,0);
                    /* catch() { ... } // from try @ 00f5b83c with catch @ 00f5b884 */
  if (&local_a0 == (undefined ***)local_80) {
    pcVar9 = *(code **)(*local_80 + 0x20);
  }
  else {
    if (local_80 == (long *)0x0) goto LAB_00f5b8b0;
