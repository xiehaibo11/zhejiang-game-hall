...
/* cocostudio::FlatBuffersSerialize::createScaleFrame(tinyxml2::XMLElement const*) */

undefined4 __thiscall
cocostudio::FlatBuffersSerialize::createScaleFrame(FlatBuffersSerialize *this,XMLElement *param_1)

{
  ...
  uVar8 = flatbuffers::CreateScaleFrame(uVar11,iVar7,bVar5,&local_90,uVar8);
