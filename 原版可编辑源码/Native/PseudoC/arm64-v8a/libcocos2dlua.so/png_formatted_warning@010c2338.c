    ...
    do {
      ...
      if (cVar6 == '@') {
        ...
        do {
          ...
          pcVar5 = pcVar5 + 0x20;
          if (lVar7 == 9) break;
          pcVar8 = &DAT_012f5a38 + lVar7;
          lVar7 = lVar1;
        } while (*pcVar8 != cVar6);
        pcVar8 = param_3 + 1;
        if (7 < (int)lVar1 + -1) goto LAB_010c23f4;
        if (uVar4 < 0xbf) {
          lVar7 = 0;
          do {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010c22d4 with catch @ 010c23bc
                        */
            ...
            local_e8[lVar7 + uVar4] = cVar6;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010c2270 with catch @ 010c23d4
                        */
            lVar7 = lVar7 + 1;
            uVar3 = uVar4 + lVar7;
          } while (uVar3 < 0xbf);
