...
long FUN_01273714(ulong *param_1,ulong param_2)

{
  ...
  if (((byte)param_1[4] & 1) != 0) goto LAB_01273740;
  uVar17 = (ulong)((uint)param_1[4] >> 0xb);
  if (uVar17 == 0) {
    if (((byte)param_1[4] >> 1 & 1) == 0) {
      uVar17 = FUN_01273480(param_1,param_1[3]);
      if (uVar17 != 0xffffffffffffffff) goto LAB_012737b8;
LAB_01273778:
      param_1[4] = 0;
      *(undefined2 *)(param_1 + 4) = 0x7f8;
      param_1[3] = (ulong)&DAT_01795de0;
    }
    else {
      for (plVar12 = (long *)param_1[3]; *plVar12 != 0; plVar12 = plVar12 + 1) {
        lVar10 = FUN_01273480(param_1);
        if (lVar10 == -1) goto LAB_01273778;
...
LAB_012737e0:
    ...
    if (local_10 != (ulong *)0x0) {
      ...
      if (((byte)param_1[4] >> 1 & 1) == 0) {
        FUN_012735e0(param_1,&local_10,param_1[3]);
      }
      else {
        for (plVar12 = (long *)param_1[3]; *plVar12 != 0; plVar12 = plVar12 + 1) {
          FUN_012735e0(param_1,&local_10);
        }
      }
      pvVar4 = local_8;
      puVar3 = local_10;
...
LAB_01273b38:
      ...
      if (((byte)param_1[4] >> 2 & 1) == 0) {
        if ((param_1[4] & 0x7f8) == 0) {
          pcVar16 = FUN_0127292c;
        }
        else {
          pcVar16 = FUN_01272ccc;
        }
      }
      else {
        pcVar16 = FUN_012733e4;
      }
      if (local_8 == (void *)0x0) {
        FUN_01272a08(param_1,pcVar16,local_10);
      }
      else {
        puVar18 = local_10 + 2;
        uVar20 = local_10[1];
        puVar14 = &DAT_01795dd8;
        puVar21 = puVar18;
        for (uVar13 = 0; uVar13 != uVar20; uVar13 = uVar13 + 1) {
          while ((puVar14 != &DAT_01795dd8 &&
        ...
        *(long *)((long)pvVar4 + 8) = lVar10;
        if (*(long *)((long)local_8 + 8) + local_10[1] != uVar17) goto LAB_01273b38;
        FUN_01272a08(param_1,pcVar16);
        pvVar4 = local_8;
        puVar3 = local_10;
...
LAB_01273740:
  ...
  if ((bVar5 & 1) == 0) {
    if ((bVar5 >> 1 & 1) == 0) {
      lVar10 = FUN_01272e58(param_1,param_1[3],param_2);
      return lVar10;
    }
    for (plVar12 = (long *)param_1[3]; *plVar12 != 0; plVar12 = plVar12 + 1) {
      lVar10 = FUN_01272e58(param_1,*plVar12,param_2);
      if (lVar10 != 0) {
        return lVar10;
      }
    }
    ...
    if (((ushort)param_1[4] & 0x7f8) == 0) {
      ...
      uVar20 = param_1[3];
      uVar17 = 0;
      uVar8 = FUN_01272b1c(uVar2,param_1);
      uVar13 = *(ulong *)(uVar20 + 8);
      while (uVar11 = uVar13, uVar17 < uVar11) {
        uVar13 = uVar11 + uVar17 >> 1;
        lVar10 = *(long *)(uVar20 + (uVar13 + 2) * 8);
        uVar9 = FUN_01272bdc(uVar2,uVar8,lVar10 + 8,&local_18);
        FUN_01272bdc(uVar1 & 0xf,0,uVar9,&local_10);
        if (local_18 <= param_2) {
    ...
    while (uVar11 = uVar13, uVar17 < uVar11) {
      uVar13 = uVar11 + uVar17 >> 1;
      lVar10 = *(long *)(uVar20 + (uVar13 + 2) * 8);
      bVar5 = FUN_01272fb8(lVar10);
      uVar8 = FUN_01272b1c(bVar5,param_1);
      uVar8 = FUN_01272bdc(bVar5,uVar8,lVar10 + 8,&local_18);
      FUN_01272bdc(bVar5 & 0xf,0,uVar8,&local_10);
      if (local_18 <= param_2) {
        if (param_2 < local_18 + (long)local_10) {
          return lVar10;
        }
