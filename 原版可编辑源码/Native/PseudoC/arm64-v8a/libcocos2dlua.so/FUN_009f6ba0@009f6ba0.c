...
undefined8 FUN_009f6ba0(undefined8 param_1)

{
  ...
  uVar6 = FUN_009f9b80(param_1,1,local_58);
  if (local_58[0] == 0) {
    uVar4 = lua_type(param_1,1);
    uVar7 = lua_typename(param_1,uVar4);
  ...
  uVar9 = -(uVar6 & 1) ^ uVar6 >> 1;
  if ((bVar2 == 0) || (uVar9 + 0x80000000 >> 0x20 == 0)) {
    lua_pushnumber((double)(long)uVar9,param_1);
  }
  else {
    uVar10 = -uVar9;
    if (-1 < (long)uVar9) {
    ...
    if (bVar2 == 2) {
      ...
      do {
        uVar9 = uVar10 & 0xf;
        uVar10 = uVar10 >> 4;
        *(char *)((long)puVar8 + 1) = "0123456789ABCDEF"[uVar9];
      ...
      *puVar8 = 0x7830;
      ...
      if (bVar2 == 1) {
        ...
        do {
          bVar3 = 9 < uVar10;
          puVar8 = (undefined2 *)((long)puVar8 + -1);
          *(undefined *)puVar8 = (&DAT_012f5a37)[uVar10 % 10];
          uVar10 = uVar10 / 10;
        } while (bVar3);
      }
    }
