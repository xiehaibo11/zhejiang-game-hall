...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void (cocos2d::StencilStateManager::*)(),
   ...
   (cocos2d::StencilStateManager::*)(), cocos2d::StencilStateManager*&> >, void ()>::target_type()
   const */
...
{
  return &__bind<void(cocos2d::StencilStateManager::*)(),cocos2d::StencilStateManager*&>::typeinfo;
}
