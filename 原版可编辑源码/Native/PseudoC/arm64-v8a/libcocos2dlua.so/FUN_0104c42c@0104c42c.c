...
void FUN_0104c42c(long *param_1,char *param_2)

{
  ...
  lVar11 = param_1[0x44];
  local_130 = param_2;
  pcVar5 = (char *)FUN_01047fa0(param_1,0x54);
  pcVar6 = (char *)FUN_01047fa0(param_1,0x59);
  ...
  *(uint *)((long)param_1 + 0x2f4) = uVar1;
  ...
  if (iVar3 == 0) {
    ...
    if (pcVar5 != (char *)0x0) {
                    /* try { // try from 0104c5c8 to 0114c5f7 has its CatchHandler @ 0104c5c8
                       catch() { ... } // from try @ 0104c5c8 with catch @ 0104c5c8
                       catch() { ... } // from try @ 0104c648 with catch @ 0104c5c8 */
      lVar11 = lws_vhost_name_to_protocol(param_1[0x45],pcVar5);
      if (lVar11 == 0) {
        pcVar12 = "protocol %s not enabled on vhost\n";
        goto LAB_0104c810;
      }
      FUN_01042188(param_1,lVar11);
    }
                    /* try { // try from 0104c5f8 to 0114c607 has its CatchHandler @ 0104c67c */
    iVar3 = (**(code **)(param_1[0x49] + 8))(param_1,0x3e,param_1[0x4e],0,0);
    if (iVar3 == 0) {
      FUN_01047a8c(param_1);
      lws_union_transition(param_1,0xc);
                    /* try { // try from 0104c62c to 0114c647 has its CatchHandler @ 0104c684 */
...
LAB_0104c814:
    ...
    if ((uVar1 >> 0x19 & 1) != 0) {
      ...
      if (iVar3 != 0x10) {
        ...
        pcVar5 = "/dev/urandom";
                    /* try { // try from 0104c648 to 0114c6a7 has its CatchHandler @ 0104c5c8 */
LAB_0104c810:
    ...
    uVar7 = FUN_01047fa0(param_1,0x56);
    ...
    uVar7 = FUN_01047fa0(param_1,0x57);
    iVar3 = sprintf(pcVar5 + 0x2b,"Host: %s\r\n",uVar7);
    local_130 = local_130 + iVar3;
    lVar8 = FUN_01047fa0(param_1,0x58);
    pcVar5 = local_130;
    if (lVar8 != 0) {
      uVar1 = *(uint *)(lVar11 + 0xc78);
      uVar7 = FUN_01047fa0(param_1,0x58);
      if ((uVar1 >> 0x13 & 1) == 0) {
    ...
    if ((*(byte *)((long)param_1 + 0x2f7) >> 1 & 1) != 0) {
                    /* catch() { ... } // from try @ 0104c5f8 with catch @ 0104c67c */
                    /* catch() { ... } // from try @ 0104c62c with catch @ 0104c684 */
      ...
      lVar8 = FUN_01047fa0(param_1,0x54);
      pcVar5 = local_130;
                    /* try { // try from 0104c6dc to 0114c6f7 has its CatchHandler @ 0104c77c */
      if (lVar8 != 0) {
        uVar7 = FUN_01047fa0(param_1,0x54);
      ...
      if (plVar10 != (long *)0x0) {
        if (plVar10[1] == 0) {
          ...
          do {
            plVar13 = plVar10 + 4;
            while ((iVar4 = FUN_010567dc(lVar11,param_1,7,plVar13[-4],0), iVar4 != 0 ||
                   (iVar4 = (**(code **)(*(long *)(param_1[0x45] + 0x188) + 8))
                                      (param_1,0x1a,param_1[0x4e],plVar13[-4],0), iVar4 != 0))) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 0104c6dc with catch @ 0104c77c
                        */
              lVar8 = *plVar13;
              plVar13 = plVar13 + 3;
              if (lVar8 == 0) goto LAB_0104c830;
            }
            if (iVar3 == 0) {
