...
/* cocos2d::ui::AbstractCheckButton::getCrossNormalFile() */

void cocos2d::ui::AbstractCheckButton::getCrossNormalFile(void)

{
  ...
  *in_x8 = *(undefined4 *)(in_x0 + 0x524);
  if (this != (basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
              (in_x0 + 0x578)) {
    pcVar1 = *(char **)(in_x0 + 0x588);
    uVar2 = *(ulong *)(in_x0 + 0x580);
    if ((*(byte *)(in_x0 + 0x578) & 1) == 0) {
      pcVar1 = (char *)(in_x0 + 0x579);
      uVar2 = (ulong)(*(byte *)(in_x0 + 0x578) >> 1);
    }
