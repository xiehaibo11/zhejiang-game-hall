...
void FUN_00fcb3e8(undefined8 param_1,undefined4 param_2,byte *param_3,uint *param_4,uint param_5)
  ...
  *param_4 = uVar11;
  ...
  if ((uVar5 + 4 | uVar12 + 4 | uVar6 + 4) < 8) {
    ...
    uVar11 = uVar11 | (uVar16 >> 8) << 0x1c;
                    ...
                    /* try { // try from 00fcb610 to 010cb613 has its CatchHandler @ 00fcb63c */
  uVar16 = 0;
  uVar14 = uVar11 | uVar10 | uVar9 | uVar12 | uVar13 | uVar14;
  puVar15 = &DAT_0144c3d8;
  *param_4 = uVar14;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fcb610 with catch @ 00fcb63c
                        */
  do {
    local_80 = uVar16 | uVar14;
                    /* try { // try from 00fcb684 to 010cb687 has its CatchHandler @ 00fcb6b0 */
    uStack_7c = 0;
    local_78 = 0;
    FUN_00fcbf20(param_1,param_2,&local_80,param_5 & 1,0,&local_70,puVar15);
    if (local_78 < param_4[2]) {
      param_4[2] = local_78;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fcb684 with catch @ 00fcb6b0
                        */
  ...
  do {
    local_80 = uVar16 | uVar13;
                    /* try { // try from 00fcb6f4 to 010cb6f7 has its CatchHandler @ 00fcb728 */
    uStack_7c = (undefined4)uVar17;
    local_78 = (uint)((ulong)uVar17 >> 0x20);
    FUN_00fcbf20(param_1,param_2,&local_80,param_5 & 1,1,(ulong)&local_70 | 3,puVar15);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fcb6f4 with catch @ 00fcb728
                        */
