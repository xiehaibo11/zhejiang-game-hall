...
/* cocostudio::timeline::ActionTimelineCache::createActionFromJson(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

void __thiscall
cocostudio::timeline::ActionTimelineCache::createActionFromJson
...

{
  ...
  if ((lVar1 == 0) || (plVar2 = *(long **)(lVar1 + 0x28), plVar2 == (long *)0x0)) {
    plVar2 = (long *)loadAnimationActionWithFile(this,param_1);
  }
                    /* WARNING: Could not recover jumptable at 0x00ca19e8. Too many branches */
