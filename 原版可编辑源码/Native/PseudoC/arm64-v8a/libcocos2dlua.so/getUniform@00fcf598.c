...
/* cocos2d::GLProgram::getUniform(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&) */

long __thiscall cocos2d::GLProgram::getUniform(GLProgram *this,basic_string *param_1)

{
  ...
  if (lVar2 != 0) {
    lVar1 = lVar2 + 0x28;
                    ...
                    /* try { // try from 00fcf5b4 to 010cf5bb has its CatchHandler @ 00fcf624 */
  return lVar1;
}
