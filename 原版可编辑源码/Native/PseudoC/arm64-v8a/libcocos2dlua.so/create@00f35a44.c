...
/* cocos2d::ParticleSystemQuad::create(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

ParticleSystem * cocos2d::ParticleSystemQuad::create(basic_string *param_1)

{
  ...
  if (this != (ParticleSystem *)0x0) {
    ...
    *(undefined8 *)(this + 0x544) = 0;
    uVar1 = ParticleSystem::initWithFile(this,param_1);
    if ((uVar1 & 1) == 0) {
