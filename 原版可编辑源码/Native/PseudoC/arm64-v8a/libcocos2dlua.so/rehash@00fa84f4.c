...

{
  ...
  undefined8 uVar4;
                    ...
                    /* catch() { ... } // from try @ 00fa83ac with catch @ 00fa8504 */
                    /* catch() { ... } // from try @ 00fa83c0 with catch @ 00fa850c */
  if (param_1 - 1 == 0) {
    param_1 = 2;
  }
  else if ((param_1 & param_1 - 1) != 0) {
    param_1 = __next_prime(param_1);
                    /* catch() { ... } // from try @ 00fa84ac with catch @ 00fa852c */
  }
  uVar2 = *(ulong *)(this + 8);
                    /* catch() { ... } // from try @ 00fa84c0 with catch @ 00fa8534 */
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00fa85b8;
    }
    return;
  }
LAB_00fa85b8:
