...
/* lua_cocos2dx_extension_EventAssetsManagerEx_getMessage(lua_State*) */

void lua_cocos2dx_extension_EventAssetsManagerEx_getMessage(lua_State *param_1)

{
  ...
  if (iVar4 + -1 == 0) {
    ...
    basic_string(local_50,(basic_string *)(lVar5 + 0x68));
    ...
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "cc.EventAssetsManagerEx:getMessage",iVar4 + -1,0);
    uVar6 = 0;
  }
