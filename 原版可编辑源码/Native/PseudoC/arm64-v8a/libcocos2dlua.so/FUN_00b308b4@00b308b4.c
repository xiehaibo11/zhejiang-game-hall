...
ulong FUN_00b308b4(long param_1,undefined8 *param_2,void *param_3,size_t param_4)

{
  ...
  if (*(int *)(lVar6 + 0xac) == 0) {
    ...
    *(undefined4 *)(lVar6 + 0xac) = 1;
    if (param_3 == (void *)0x0) goto LAB_00b309dc;
LAB_00b308f8:
    ...
    if (*piVar9 != 0) {
      ...
      if (uVar5 != 0) {
        Poly1305_Update(lVar6 + 0xc0,&DAT_013e1308,0x10 - uVar5);
      }
      *piVar9 = 0;
    }
    *(undefined8 *)(lVar6 + 0xb8) = 0xffffffffffffffff;
    ...
    if ((__n == 0xffffffffffffffff) || (sVar7 = __n, __n + 0x10 == param_4)) {
      if (*(int *)(param_1 + 0x10) == 0) {
        ...
        FUN_00b30488(param_1,param_2,param_3,sVar7);
      }
      else {
        FUN_00b30488(param_1,param_2,param_3,sVar7);
      ...
      *(size_t *)(lVar6 + 0xa0) = *(long *)(lVar6 + 0xa0) + sVar7;
      if (sVar7 == param_4) goto LAB_00b30b58;
      bVar3 = false;
      param_2 = (undefined8 *)((long)param_2 + sVar7);
      param_3 = (void *)((long)param_3 + sVar7);
      iVar4 = *piVar9;
      __n = sVar7;
      goto joined_r0x00b30a68;
    }
  }
  else {
    if (param_3 != (void *)0x0) goto LAB_00b308f8;
LAB_00b309dc:
    bVar3 = __n == param_4;
...
joined_r0x00b30a68:
    ...
    if (uVar5 != 0) {
      Poly1305_Update(lVar1,&DAT_013e1308,0x10 - uVar5);
    }
