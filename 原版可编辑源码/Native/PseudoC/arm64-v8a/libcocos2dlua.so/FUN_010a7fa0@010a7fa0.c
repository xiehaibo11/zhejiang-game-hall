...
ulong FUN_010a7fa0(long param_1,long param_2,long param_3,long param_4,int param_5)

{
  ...
  uVar5 = FUN_010a816c(param_1,param_5,lVar13 - lVar14);
  lVar2 = lVar14 + lVar13;
  if (lVar2 < 0) {
    lVar2 = lVar2 + 1;
  }
  ...
  if ((uVar12 != 0) &&
    ...
    if ((long)uVar7 < (long)uVar5) {
      if ((0x3f < uVar7) ||
        ...
        if (uVar12 < 0x20) {
          uVar6 = 0;
          if ((uVar10 <= uVar12) || (uVar9 <= uVar12)) goto joined_r0x010a8130;
        }
        else {
          uVar12 = 0x40 - uVar7;
        }
