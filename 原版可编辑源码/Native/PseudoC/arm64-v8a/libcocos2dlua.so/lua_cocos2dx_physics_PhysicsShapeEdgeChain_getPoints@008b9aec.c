...
/* lua_cocos2dx_physics_PhysicsShapeEdgeChain_getPoints(lua_State*) */

undefined8 lua_cocos2dx_physics_PhysicsShapeEdgeChain_getPoints(lua_State *param_1)

{
  ...
  if (iVar1 + -1 == 0) {
    uVar3 = cocos2d::PhysicsShapeEdgeChain::getPointsCount(this);
    iVar1 = (int)uVar3;
    ...
    cocos2d::PhysicsShapeEdgeChain::getPoints(this);
