...
/* void std::__ndk1::vector<cocos2d::MeshData*, std::__ndk1::allocator<cocos2d::MeshData*>
   >::__push_back_slow_path<cocos2d::MeshData* const&>(cocos2d::MeshData* const&) */

void __thiscall
std::__ndk1::vector<cocos2d::MeshData*,std::__ndk1::allocator<cocos2d::MeshData*>>::
__push_back_slow_path<cocos2d::MeshData*const&>
          (vector<cocos2d::MeshData*,std::__ndk1::allocator<cocos2d::MeshData*>> *this,
          MeshData **param_1)
