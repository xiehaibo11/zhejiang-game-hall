...
/* std::__ndk1::vector<cocos2d::Particle3DQuadRender::posuvcolor,
   std::__ndk1::allocator<cocos2d::Particle3DQuadRender::posuvcolor> >::__append(unsigned long) */

void __thiscall
std::__ndk1::
vector<cocos2d::Particle3DQuadRender::posuvcolor,std::__ndk1::allocator<cocos2d::Particle3DQuadRender::posuvcolor>>
::__append(vector<cocos2d::Particle3DQuadRender::posuvcolor,std::__ndk1::allocator<cocos2d::Particle3DQuadRender::posuvcolor>>
           *this,ulong param_1)
