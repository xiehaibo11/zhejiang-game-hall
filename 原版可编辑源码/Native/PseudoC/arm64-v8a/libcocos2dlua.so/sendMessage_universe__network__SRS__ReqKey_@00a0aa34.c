...
/* bool 
   universe::network::GuoPengFei::sendMessage<universe::network::SRS::ReqKey>(universe::network::SRS::ReqKey&,
   int, int) */

bool __thiscall
universe::network::GuoPengFei::sendMessage<universe::network::SRS::ReqKey>
          (GuoPengFei *this,ReqKey *param_1,int param_2,int param_3)

{
  ...
  if (this[0x4a0] != (GuoPengFei)0x0) {
    pcVar4 = (char *)Translated::getInstance();
                    /* try { // try from 00a0aa80 to 00b0aacf has its CatchHandler @ 00a0aa80
                       catch() { ... } // from try @ 00a0aa80 with catch @ 00a0aa80
                       catch() { ... } // from try @ 00a0ab08 with catch @ 00a0aa80 */
  ...
  *(undefined8 *)(pZVar5 + 0x20) = uVar6;
  ...
  if (*(long *)(lVar1 + 0x28) == local_48) {
    return (bool)(bVar2 & 1);
                    ...
                    /* catch() { ... } // from try @ 00a0aad0 with catch @ 00a0ab7c */
  __stack_chk_fail();
}
