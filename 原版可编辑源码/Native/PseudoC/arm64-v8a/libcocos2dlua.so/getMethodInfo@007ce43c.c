...
/* cocos2d::JniHelper::getMethodInfo(cocos2d::JniMethodInfo_&, char const*, char const*, char
   const*) */

undefined8
cocos2d::JniHelper::getMethodInfo(JniMethodInfo_ *param_1,char *param_2,char *param_3,char *param_4)

{
  ...
  if (((param_2 != (char *)0x0) && (param_3 != (char *)0x0)) && (param_4 != (char *)0x0)) {
    plVar1 = pthread_getspecific(DAT_01781ca8);
    if (plVar1 == (long *)0x0) {
