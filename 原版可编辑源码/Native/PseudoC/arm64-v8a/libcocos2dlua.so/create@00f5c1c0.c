...
/* cocos2d::TransitionFlipAngular::create(float, cocos2d::Scene*,
   cocos2d::TransitionScene::Orientation) */

Scene * cocos2d::TransitionFlipAngular::create(undefined4 param_1,Ref *param_2,undefined4 param_3)

{
  ...
  if (this != (Scene *)0x0) {
    ...
    *(undefined ***)this = &PTR__TransitionFlipX_01717e68;
  }
  uVar1 = Scene::init(this);
  if ((uVar1 & 1) != 0) {
                    /* try { // try from 00f5c22c to 0105c233 has its CatchHandler @ 00f5c378 */
    ...
    *(Ref **)(this + 0x378) = this_00;
    ...
    Ref::retain(this_00);
                    /* try { // try from 00f5c268 to 0105c26b has its CatchHandler @ 00f5c354 */
