...
undefined8 FUN_00b31040(undefined8 param_1,uchar *param_2,uchar *param_3,ulong param_4)

{
  ...
  if (param_4 >> 0x3e != 0) {
    ...
    do {
      ...
      DES_cfb64_encrypt(param_3,out,0x4000000000000000,pDVar5,pauVar6,&local_64,iVar4);
  ...
  if (param_4 != 0) {
    ...
    pauVar6 = (DES_cblock *)EVP_CIPHER_CTX_iv_noconst(param_1);
    iVar4 = EVP_CIPHER_CTX_encrypting(param_1);
    DES_cfb64_encrypt(param_3,param_2,param_4,pDVar5,pauVar6,&local_68,iVar4);
