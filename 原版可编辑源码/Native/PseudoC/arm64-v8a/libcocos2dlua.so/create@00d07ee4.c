...
/* cocos2d::Animate3D::create(cocos2d::Animation3D*, float, float) */

Action * cocos2d::Animate3D::create(Animation3D *param_1,float param_2,float param_3)

{
  ...
  *(Animation3D **)(this + 0x60) = param_1;
  fVar5 = fVar4 - param_2;
  if (param_3 <= fVar4 - param_2) {
    fVar5 = param_3;
  }
  *(float *)(this + 0x4c) = fVar5;
  *(float *)(this + 0x70) = param_2 / fVar4;
  *(float *)(this + 0x74) = fVar5 / fVar4;
