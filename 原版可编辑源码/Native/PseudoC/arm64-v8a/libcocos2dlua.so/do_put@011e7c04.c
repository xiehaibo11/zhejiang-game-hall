...

{
  ...
  if (((DAT_017942d8 & 1) == 0) && (iVar8 = __cxa_guard_acquire(&DAT_017942d8), iVar8 != 0)) {
    ...
    if (!bVar6) goto LAB_011e7da0;
LAB_011e7d38:
    iVar8 = __libcpp_snprintf_l(local_90,0x1e,(__locale_t *)DAT_017942d0,(char *)&local_180,param_1,
                                (ulong)*(uint *)(param_4 + 0x10));
    if (iVar8 < 0x1e) goto LAB_011e7d58;
LAB_011e7dbc:
    if (bVar6) {
      if (((DAT_017942d8 & 1) == 0) && (iVar8 = __cxa_guard_acquire(&DAT_017942d8), iVar8 != 0)) {
        DAT_017942d0 = newlocale(0x1fbf,"C",(__locale_t)0x0);
      ...
      iVar8 = __libcpp_asprintf_l(&local_188,(__locale_t *)DAT_017942d0,(char *)&local_180,param_1,
                                  (ulong)*(uint *)(param_4 + 0x10));
    }
    else {
      if (((DAT_017942d8 & 1) == 0) && (iVar8 = __cxa_guard_acquire(&DAT_017942d8), iVar8 != 0)) {
    ...
    __ptr_00 = local_188;
    if (local_188 == (char *)0x0) goto LAB_011e7fc0;
  }
  else {
    if (bVar6) goto LAB_011e7d38;
LAB_011e7da0:
    iVar8 = __libcpp_snprintf_l(local_90,0x1e,(__locale_t *)DAT_017942d0,(char *)&local_180,param_1)
    ;
    if (0x1d < iVar8) goto LAB_011e7dbc;
LAB_011e7d58:
    __ptr_00 = (char *)0x0;
  }
  pcVar7 = local_188;
...
LAB_011e7fc0:
  ...
  uVar9 = FUN_011e6874(param_3,pwVar13,pwStack_190,local_198,param_4,param_5);
  if (__ptr != (wchar_t *)0x0) {
    free(__ptr);
  }
  if (__ptr_00 != (char *)0x0) {
