...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<int,
   cocos2d::Sprite*>, void*>*>, bool> std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int,
   cocos2d::Sprite*>, std::__ndk1::__unordered_map_hasher<int, std::__ndk1::__hash_value_type<int,
   cocos2d::Sprite*>, std::__ndk1::hash<int>, true>, std::__ndk1::__unordered_map_equal<int,
   std::__ndk1::__hash_value_type<int, cocos2d::Sprite*>, std::__ndk1::equal_to<int>, true>,
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<int, cocos2d::Sprite*> >
      ...
      for (plVar7 = (long *)*plVar7; plVar7 != (long *)0x0; plVar7 = (long *)*plVar7) {
        ...
        if (uVar6 != uVar9) {
          if (uVar4 < 2) {
            ...
            if (uVar6 - uVar2 * uVar8 == unaff_x24) goto LAB_00f102dc;
            break;
          }
...
LAB_00f102dc:
  ...
  *(undefined4 *)(plVar7 + 2) = uVar1;
                    /* catch() { ... } // from try @ 00f10398 with catch @ 00f1035c */
  if ((uVar8 == 0) || ((float)param_1[8] * (float)uVar8 < (float)(*(long *)(param_1 + 6) + 1))) {
    ...
    if (uVar4 <= uVar8) {
      uVar4 = uVar8;
                    ...
                    /* try { // try from 00f10390 to 01010397 has its CatchHandler @ 00f103f4 */
    rehash((__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::Sprite*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::Sprite*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::Sprite*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::Sprite*>>>
            *)param_1,uVar4);
    uVar8 = *(ulong *)(param_1 + 2);
                    /* try { // try from 00f10398 to 0101040f has its CatchHandler @ 00f1035c */
    if ((uVar8 & uVar8 - 1) == 0) {
      unaff_x24 = uVar8 - 1 & uVar9;
    }
    else {
  ...
  if (plVar3 == (long *)0x0) {
    ...
    *plVar7 = *plVar3;
    *plVar3 = (long)plVar7;
                    /* catch() { ... } // from try @ 00f10390 with catch @ 00f103f4 */
    *(long **)(lVar5 + unaff_x24 * 8) = plVar3;
    if (*plVar7 == 0) goto LAB_00f10434;
