...
/* WARNING: Removing unreachable block (ram,0x01262e48) */

void FUN_01262e04(long param_1,long param_2)

{
  ...
  if (*(long *)(param_1 + 0x18) != 0) {
    ...
    while( true ) {
      ...
      lVar2 = lVar5;
      if (!bVar1) {
        lVar2 = __strlen_chk(&DAT_01458dec,3);
        FUN_01258064(param_2,&DAT_01458dec,&DAT_01458dec + lVar2);
