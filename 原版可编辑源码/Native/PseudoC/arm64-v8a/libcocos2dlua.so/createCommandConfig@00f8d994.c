...
/* cocos2d::Console::createCommandConfig() */

void __thiscall cocos2d::Console::createCommandConfig(Console *this)

{
  ...
  basic_string<decltype(nullptr)>(local_118,"config");
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string<decltype(nullptr)>(local_130,"Print the Configuration object. Args: [-h | help | ]");
  local_e0 = &local_100;
  local_100 = &PTR_FUN_017223e0;
  uStack_f0 = 0;
  local_f8 = commandConfig;
  local_e8 = this;
  ...
  if (&local_100 == local_e0) {
    ...
    if (local_e0 == (undefined ***)0x0) goto LAB_00f8da58;
