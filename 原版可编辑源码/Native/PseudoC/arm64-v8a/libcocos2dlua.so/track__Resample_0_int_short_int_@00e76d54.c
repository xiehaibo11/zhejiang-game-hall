...
/* void cocos2d::experimental::AudioMixer::track__Resample<0, int, short,
   int>(cocos2d::experimental::AudioMixer::track_t*, int*, unsigned long, int*, int*) */

void cocos2d::experimental::AudioMixer::track__Resample<0,int,short,int>
  ...
  if ((param_5 == (int *)0x0) && ((iVar2 == 0 && iVar1 == 0) && iVar3 == 0)) {
    (**(code **)(**(long **)(param_1 + 0x58) + 0x20))
              (*(undefined4 *)(param_1 + 0x94),*(undefined4 *)(param_1 + 0x98));
                    /* WARNING: Could not recover jumptable at 0x00e76de8. Too many branches */
