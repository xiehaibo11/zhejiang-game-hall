...
/* cocos2d::Texture2D::convertRGB888ToI8(unsigned char const*, long, unsigned char*) */

void cocos2d::Texture2D::convertRGB888ToI8(uchar *param_1,long param_2,uchar *param_3)
    ...
    if ((uVar1 < 0x10) || ((param_3 < param_1 + uVar43 * 3 + 3 && (param_1 < param_3 + uVar43 + 1)))
      ...
      do {
        ...
        auVar59 = NEON_umull(auVar63._0_8_,0x10624dd310624dd3,4);
                    /* catch() { ... } // from try @ 00fe8fa0 with catch @ 00fe8f3c */
