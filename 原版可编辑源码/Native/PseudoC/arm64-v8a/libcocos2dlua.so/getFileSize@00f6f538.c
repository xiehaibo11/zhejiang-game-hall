...
/* cocos2d::FileUtils::getFileSize(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&, std::__ndk1::function<void (long)>) const */

void __thiscall cocos2d::FileUtils::getFileSize(FileUtils *this,undefined8 param_2,long *param_3)

{
  ...
  if ((local_198 & 1) == 0) {
    ...
    if (uStack_190 < 0x17) {
      ...
      if (uStack_190 != 0) goto LAB_00f6f5e8;
    }
    else {
...
LAB_00f6f7e4:
  ...
  if (alStack_90 == local_70) {
    ...
    if (local_70 == (long *)0x0) goto LAB_00f6f810;
