...
/* cocostudio::Armature::getBone(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&) const */

undefined8 __thiscall cocostudio::Armature::getBone(Armature *this,basic_string *param_1)
