...
/* luaval_to_vec4(lua_State*, int, cocos2d::Vec4*, char const*) */

bool luaval_to_vec4(lua_State *param_1,int param_2,Vec4 *param_3,char *param_4)

{
  ...
  bVar3 = false;
  if ((param_1 != (lua_State *)0x0) && (param_3 != (Vec4 *)0x0)) {
