...

{
  ...
  iVar3 = dtls1_process_buffered_records();
                    /* catch() { ... } // from try @ 00accf74 with catch @ 00acd010 */
  if (iVar3 == 0) {
                    /* try { // try from 00acd220 to 00bcd23f has its CatchHandler @ 00acd4e8 */
    return 0xffffffff;
  }
                    /* catch() { ... } // from try @ 00accee4 with catch @ 00acd018 */
  do {
    iVar3 = dtls1_retrieve_buffered_record(param_1,*(long *)(param_1 + 0x44a) + 0x38);
    if (iVar3 != 0) {
      return 1;
    }
                    /* catch() { ... } // from try @ 00acce90 with catch @ 00acd054 */
      ...
      if (param_1[0x1f8] != 0) {
        if (local_54 == 0) {
          ...
          iVar3 = SSL_in_init(param_1);
                    /* try { // try from 00acd1ac to 00bcd203 has its CatchHandler @ 00acd1ac
                       catch() { ... } // from try @ 00acd1ac with catch @ 00acd1ac
                       catch() { ... } // from try @ 00acd404 with catch @ 00acd1ac
                       catch() { ... } // from try @ 00acd498 with catch @ 00acd1ac */
      ...
      if (param_1[0x438] == 0xd) {
        ...
        if (*(code **)(param_1 + 0x28) != (code *)0x0) {
          (**(code **)(param_1 + 0x28))
                    ...
                    /* catch() { ... } // from try @ 00acce6c with catch @ 00acd0bc */
        param_1[0x1f7] = (uint)*pbVar8;
                    /* catch() { ... } // from try @ 00accec4 with catch @ 00acd0c0
                       catch() { ... } // from try @ 00accfac with catch @ 00acd0c0 */
        bVar1 = pbVar8[1];
        bVar2 = pbVar8[2];
        ...
        *(undefined4 *)((long)param_1 + 0x1112) = *(undefined4 *)(pbVar8 + 5);
        ...
        if (param_1[0x80] == 0) {
          ...
          if (uVar4 == *param_1) goto LAB_00acd124;
        }
        else {
          uVar4 = *param_1;
LAB_00acd124:
