...
/* cocosbuilder::Scale9SpriteLoader::onHandlePropTypeByte(cocos2d::Node*, cocos2d::Node*, char
   const*, unsigned char, cocosbuilder::CCBReader*) */

void cocosbuilder::Scale9SpriteLoader::onHandlePropTypeByte
...

{
  ...
  if (iVar1 != 0) {
    ...
    return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00cfe8fc. Too many branches */
