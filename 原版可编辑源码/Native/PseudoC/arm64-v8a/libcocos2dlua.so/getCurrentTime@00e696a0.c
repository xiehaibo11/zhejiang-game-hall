...
/* cocos2d::experimental::AudioEngine::getCurrentTime(int) */

undefined1  [16] cocos2d::experimental::AudioEngine::getCurrentTime(int param_1)
        ...
        if (uVar5 == uVar2) {
          if ((int)plVar4[2] == param_1) {
            if (*(int *)((long)plVar4 + 0x34) != 0) {
              auVar9 = AudioEngineImpl::getCurrentTime(_audioEngineImpl,param_1);
              return auVar9;
            }
            break;
          }
