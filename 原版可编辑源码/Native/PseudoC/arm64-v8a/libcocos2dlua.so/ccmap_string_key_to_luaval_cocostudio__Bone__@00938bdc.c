...
/* void ccmap_string_key_to_luaval<cocostudio::Bone*>(lua_State*,
   cocos2d::Map<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> >, cocostudio::Bone*> const&) */

void ccmap_string_key_to_luaval<cocostudio::Bone*>(lua_State *param_1,Map *param_2)
      ...
      if (plVar5 != (long *)0x0) {
        ...
        if (lVar3 != 0) {
          ...
          if (((byte)local_70[0] & 1) != 0) {
            pvVar1 = local_60;
                    ...
                    /* try { // try from 00938c90 to 00a38cdf has its CatchHandler @ 00938c90
                       catch() { ... } // from try @ 00938c90 with catch @ 00938c90
                       catch() { ... } // from try @ 00938d20 with catch @ 00938c90
                       catch() { ... } // from try @ 00938d64 with catch @ 00938c90 */
        ...
        if (((byte)local_88[0] & 1) != 0) {
          operator_delete(local_78);
                    ...
                    /* try { // try from 00938ce0 to 00a38d1f has its CatchHandler @ 00938da4 */
      if (((byte)local_70[0] & 1) != 0) {
