...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<float,
   ...
   std::__ndk1::piecewise_construct_t const&, std::__ndk1::tuple<float&&>, std::__ndk1::tuple<>
   >(float const&, std::__ndk1::piecewise_construct_t const&, std::__ndk1::tuple<float&&>&&,
   std::__ndk1::tuple<>&&) */
      ...
      for (plVar9 = (long *)*plVar9; plVar9 != (long *)0x0; plVar9 = (long *)*plVar9) {
        ...
        if (uVar8 != uVar5) {
          if (uVar6 < 2) {
            ...
            if (uVar8 - uVar2 * uVar10 == unaff_x24) goto LAB_00fa1938;
            break;
          }
...
LAB_00fa1938:
  ...
  *plVar9 = 0;
  ...
  if (plVar3 == (long *)0x0) {
    ...
    *(float **)(lVar7 + unaff_x24 * 8) = pfVar4;
    if (*plVar9 == 0) goto LAB_00fa1a9c;
                    /* try { // try from 00fa1a68 to 010a1a73 has its CatchHandler @ 00fa1aa8 */
    uVar5 = *(ulong *)(*plVar9 + 8);
                    /* try { // try from 00fa1a74 to 010a1ac3 has its CatchHandler @ 00fa1a28 */
    if ((uVar10 & uVar10 - 1) == 0) {
  ...
  *plVar3 = (long)plVar9;
LAB_00fa1a9c:
                    /* catch() { ... } // from try @ 00fa1a68 with catch @ 00fa1aa8 */
