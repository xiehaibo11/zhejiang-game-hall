...
{
  return &__bind<void(cocos2d::extension::ScrollView::*)(cocos2d::Touch*,cocos2d::Event*),cocos2d::extension::ScrollView*,std::__ndk1::placeholders::__ph<1>const&,std::__ndk1::placeholders::__ph<2>const&>
          ::typeinfo;
}
