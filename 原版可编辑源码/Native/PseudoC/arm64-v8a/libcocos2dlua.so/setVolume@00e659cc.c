...
/* cocos2d::experimental::AudioEngineImpl::setVolume(int, float) */

void cocos2d::experimental::AudioEngineImpl::setVolume(int param_1,float param_2)

{
  ...
  uVar2 = *(ulong *)((ulong)(uint)param_1 + 0x48);
  if (uVar2 != 0) {
    ...
    plVar5 = *(long **)(*(long *)((ulong)(uint)param_1 + 0x40) + uVar4 * 8);
    if ((plVar5 != (long *)0x0) && (plVar5 = (long *)*plVar5, plVar5 != (long *)0x0)) {
      do {
        uVar6 = plVar5[1];
        if (uVar6 == uVar3) {
          if ((int)plVar5[2] == in_w1) {
                    /* WARNING: Could not recover jumptable at 0x00e65a84. Too many branches */
                    /* WARNING: Treating indirect jump as call */
            (**(code **)(*(long *)plVar5[3] + 0x58))();
            return;
          }
        }
        else {
