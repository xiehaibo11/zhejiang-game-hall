...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::Sprite3DCache::Sprite3DData*> > >::__rehash(unsigned long) */
...

{
  ...
  if (param_1 == 0) {
    ...
    *(undefined8 *)(this + 8) = 0;
    ...
    if (param_1 >> 0x3d != 0) {
                    /* try { // try from 00d42de8 to 00e42def has its CatchHandler @ 00d42f18 */
    ...
    *(void **)this = pvVar8;
    if (pvVar9 != (void *)0x0) {
                    /* catch() { ... } // from try @ 00d42b58 with catch @ 00d42bcc */
              ...
              if (plVar11 != (long *)0x0) {
                ...
                do {
                  ...
                  bVar1 = *(byte *)(plVar12 + 2);
                    /* try { // try from 00d42cfc to 00e42dd3 has its CatchHandler @ 00d42cfc
                       catch() { ... } // from try @ 00d42cfc with catch @ 00d42cfc
                       catch() { ... } // from try @ 00d42f08 with catch @ 00d42cfc
                       catch() { ... } // from try @ 00d42f18 with catch @ 00d42cfc */
                  sVar3 = (ulong)(bVar1 >> 1);
                  if ((bVar1 & 1) != 0) {
                    sVar3 = plVar12[3];
                  }
                  ...
                  if ((bVar2 & 1) == 0) {
                    while (sVar6 != 0) {
                      if (*pcVar5 != *__s2) goto LAB_00d42d88;
                      __s2 = __s2 + 1;
                      sVar3 = sVar3 - 1;
                      pcVar5 = pcVar5 + 1;
                      sVar6 = sVar3;
...
LAB_00d42d88:
          ...
          plVar16 = plVar11;
                    ...
                    /* try { // try from 00d42dd4 to 00e42de7 has its CatchHandler @ 00d42f48 */
  return;
}
