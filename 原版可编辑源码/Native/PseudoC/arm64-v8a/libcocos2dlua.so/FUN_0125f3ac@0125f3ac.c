...
/* WARNING: Removing unreachable block (ram,0x0125f470) */

void FUN_0125f3ac(long param_1,long param_2)

{
  ...
  lVar2 = __strlen_chk(&DAT_014a8032,3);
  FUN_01258064(param_2,&DAT_014a8032,&DAT_014a8032 + lVar2);
  if (*(long *)(param_1 + 0x20) != 0) {
    ...
    lVar3 = lVar5;
    while( true ) {
      plVar4 = *(long **)(*(long *)(param_1 + 0x18) + lVar2 * 8);
      (**(code **)(*plVar4 + 0x20))(plVar4,param_2);
      if (*(char *)((long)plVar4 + 9) != '\x01') {
        (**(code **)(*plVar4 + 0x28))(plVar4,param_2);
      }
      ...
      lVar2 = lVar2 + 1;
      if (lVar2 == *(long *)(param_1 + 0x20)) break;
      lVar3 = lVar5;
      if (!bVar1) {
