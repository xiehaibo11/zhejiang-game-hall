...
/* cocostudio::BatchNode::visit(cocos2d::Renderer*, cocos2d::Mat4 const&, unsigned int) */

void __thiscall
cocostudio::BatchNode::visit(BatchNode *this,Renderer *param_1,Mat4 *param_2,uint param_3)
