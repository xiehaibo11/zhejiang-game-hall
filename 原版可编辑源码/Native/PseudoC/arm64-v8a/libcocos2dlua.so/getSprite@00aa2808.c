...
/* fairygui::UIPackage::getSprite(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&) */

undefined8 __thiscall fairygui::UIPackage::getSprite(UIPackage *this,basic_string *param_1)

{
  long lVar1;
  undefined8 uVar2;
  
                    /* try { // try from 00aa2810 to 00ba2927 has its CatchHandler @ 00aa2810
                       catch() { ... } // from try @ 00aa2810 with catch @ 00aa2810
                       catch() { ... } // from try @ 00aa29b8 with catch @ 00aa2810
                       catch() { ... } // from try @ 00aa2b64 with catch @ 00aa2810 */
  lVar1 = std::__ndk1::
