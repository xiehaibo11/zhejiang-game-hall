...
/* void ccvector_to_luaval<cocos2d::ParticleSystem*>(lua_State*,
   cocos2d::Vector<cocos2d::ParticleSystem*> const&) */

void ccvector_to_luaval<cocos2d::ParticleSystem*>(lua_State *param_1,Vector *param_2)
