...
/* std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   cocos2d::JniHelper::getJNISignature<float, float, float>(float, float, float) */

void cocos2d::JniHelper::getJNISignature<float,float,float>
...

{
  ...
  local_30 = (void *)0x0;
  local_40 = &DAT_00004602;
  local_50 = 0;
  local_48 = (void *)0x0;
  local_58 = &DAT_00004602;
  ...
  *puVar5 = 0;
  if ((local_90 & 1) != 0) {
                    /* try { // try from 00df685c to 00ef685f has its CatchHandler @ 00df6b5c */
