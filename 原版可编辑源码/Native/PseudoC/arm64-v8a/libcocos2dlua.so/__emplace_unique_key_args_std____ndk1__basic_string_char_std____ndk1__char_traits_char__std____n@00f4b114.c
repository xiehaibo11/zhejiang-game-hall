...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::allocator<char> >, std::__ndk1::set<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
    ...
    if (uVar13 < 2) {
      ...
      if (uVar16 <= uVar7) {
        ...
        unaff_x27 = uVar7 - uVar10 * uVar16;
                    ...
                    /* try { // try from 00f4b1b4 to 0104b1bf has its CatchHandler @ 00f4d5e8 */
    puVar9 = *(undefined8 **)(*(long *)param_1 + unaff_x27 * 8);
    if ((puVar9 != (undefined8 *)0x0) && (plVar15 = (long *)*puVar9, plVar15 != (long *)0x0)) {
                    /* try { // try from 00f4b1cc to 0104b1cf has its CatchHandler @ 00f4d5a8 */
      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if (uVar13 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00f4b238;
            break;
          }
...
LAB_00f4b238:
        ...
        if ((bVar3 & 1) != 0) {
          sVar1 = plVar15[3];
                    ...
                    /* try { // try from 00f4b250 to 0104b267 has its CatchHandler @ 00f4d5b4 */
        if (sVar1 == __n) {
          __s1 = (void *)plVar15[4];
          if ((bVar3 & 1) == 0) {
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
                    /* try { // try from 00f4b26c to 0104b273 has its CatchHandler @ 00f4d598 */
              uVar10 = 0;
                    /* try { // try from 00f4b27c to 0104b28b has its CatchHandler @ 00f4d588 */
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00f4b2a8;
              }
              goto LAB_00f4b1f0;
            }
          }
          else if (__n != 0) {
                    /* try { // try from 00f4b298 to 0104b29f has its CatchHandler @ 00f4d598 */
            uVar6 = memcmp(__s1,ppVar2,__n);
            __s1 = (void *)(ulong)uVar6;
            if (uVar6 != 0) goto LAB_00f4b1f0;
          }
LAB_00f4b2a8:
          uVar8 = 0;
          goto LAB_00f4b3e4;
...
LAB_00f4b1f0:
  ...
  plVar15[6] = 0;
  plVar15[5] = (long)(plVar15 + 6);
  plVar15[7] = 0;
  *plVar15 = 0;
  plVar15[1] = uVar7;
  if ((uVar16 == 0) ||
     (*(float *)(param_1 + 0x20) * (float)uVar16 < (float)(*(long *)(param_1 + 0x18) + 1))) {
                    /* try { // try from 00f4b324 to 0104b32f has its CatchHandler @ 00f4d5e8 */
    ...
    __s1 = (void *)rehash((__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::set<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,std::__ndk1::allocator<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>>>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::set<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,std::__ndk1::allocator<std::__ndk1::basic_string<char,s___tor<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>>>>>
                           *)param_1,uVar13);
                    /* try { // try from 00f4b33c to 0104b33f has its CatchHandler @ 00f4d59c */
    uVar16 = *(ulong *)(param_1 + 8);
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar12;
    if (*plVar15 == 0) goto LAB_00f4b3d4;
    ...
    if ((uVar16 & uVar16 - 1) == 0) {
      ...
      uVar7 = uVar7 - uVar13 * uVar16;
                    /* try { // try from 00f4b3c0 to 0104b3d7 has its CatchHandler @ 00f4d5b4 */
    }
...
LAB_00f4b3d4:
  uVar8 = 1;
                    /* try { // try from 00f4b3dc to 0104b3e3 has its CatchHandler @ 00f4d57c */
  *(long *)(param_1 + 0x18) = *(long *)(param_1 + 0x18) + 1;
LAB_00f4b3e4:
                    /* try { // try from 00f4b3ec to 0104b3fb has its CatchHandler @ 00f4d564 */
  if (*(long *)(lVar5 + 0x28) != local_68) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail(__s1,uVar8);
  }
                    /* try { // try from 00f4b408 to 0104b40f has its CatchHandler @ 00f4d550 */
  return plVar15;
}
