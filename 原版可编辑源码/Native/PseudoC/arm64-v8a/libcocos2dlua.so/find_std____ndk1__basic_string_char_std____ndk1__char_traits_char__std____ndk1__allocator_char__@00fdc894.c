            ...
            if (sVar1 == __n) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                while (*pbVar10 == *pbVar11) {
                  ...
                  pbVar10 = pbVar10 + 1;
                  pbVar11 = pbVar11 + 1;
                  if (uVar9 == 0) goto LAB_00fdca24;
                }
              }
              else {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fdc9e8 with catch @ 00fdca08
                        */
                if ((__n == 0) || (iVar6 = memcmp(__s1,pbVar2,__n), iVar6 == 0)) break;
                    ...
                    /* try { // try from 00fdc9e8 to 010dc9f7 has its CatchHandler @ 00fdca08 */
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00fdc970;
              goto LAB_00fdca20;
            }
            if (uVar9 != uVar14) goto LAB_00fdca20;
          }
LAB_00fdc970:
          plVar8 = (long *)*plVar8;
...
LAB_00fdca24:
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* try { // try from 00fdca50 to 010dca5f has its CatchHandler @ 00fdca70 */
    return plVar8;
  }
