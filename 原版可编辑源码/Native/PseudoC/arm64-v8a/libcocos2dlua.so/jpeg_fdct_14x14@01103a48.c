...

{
  ...
  while( true ) {
    do {
      ...
      lVar17 = lVar15 + lVar9;
      lVar9 = lVar9 - lVar15;
                    /* catch() { ... } // from try @ 01103a8c with catch @ 01103b64 */
      ...
      lVar15 = lVar14 * -0x2000 + (lVar19 - lVar18) * 0x2cf8 + (lVar12 + lVar29) * -0x511;
                    /* catch() { ... } // from try @ 01103cd0 with catch @ 01103c28 */
    ...
    if (iVar27 == 0xd) break;
                    /* try { // try from 01103a8c to 01203a93 has its CatchHandler @ 01103b64 */
                    /* try { // try from 01103a94 to 01203b7f has its CatchHandler @ 011039f8 */
    piVar26 = piVar25 + 8;
    iVar11 = iVar27 + 1;
  }
  iVar11 = 8;
  piVar26 = local_c0;
  do {
                    /* try { // try from 01103cc8 to 01203ccf has its CatchHandler @ 01103da0 */
                    /* try { // try from 01103cd0 to 01203dbb has its CatchHandler @ 01103c28 */
    ...
    lVar19 = (long)iVar27;
                    /* catch() { ... } // from try @ 01103cc8 with catch @ 01103da0 */
    ...
    *param_1 = (int)((lVar17 + (int)uVar1 + lVar9 + lVar16) * 0x14e6 + 0x2000U >> 0xe);
    ...
    piVar26 = piVar26 + 1;
                    /* try { // try from 01103ef0 to 01203f93 has its CatchHandler @ 01103ef0
                       catch() { ... } // from try @ 01103ef0 with catch @ 01103ef0
                       catch() { ... } // from try @ 01103fb4 with catch @ 01103ef0 */
    param_1 = param_1 + 1;
  } while (0 < iVar11);
  return;
}
