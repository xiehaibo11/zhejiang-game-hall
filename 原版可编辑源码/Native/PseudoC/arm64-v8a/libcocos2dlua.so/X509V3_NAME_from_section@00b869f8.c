...

{
  ...
  byte *pbVar7;
                    ...
                    /* try { // try from 00b86a14 to 00c86a1b has its CatchHandler @ 00b86af8 */
  iVar3 = 0;
  if (nm != (X509_NAME *)0x0) {
                    /* try { // try from 00b86a1c to 00c86b23 has its CatchHandler @ 00b867fc */
      ...
      do {
        ...
        do {
          while( true ) {
            ...
            pbVar1 = pbVar7;
            if (bVar2 < 0x2e) break;
            if ((bVar2 == 0x2e) || (bVar2 == 0x3a)) goto LAB_00b86a74;
          }
          if (bVar2 == 0) goto LAB_00b86a80;
        } while (bVar2 != 0x2c);
LAB_00b86a74:
        if (*pbVar7 != 0) {
          pbVar6 = pbVar7;
