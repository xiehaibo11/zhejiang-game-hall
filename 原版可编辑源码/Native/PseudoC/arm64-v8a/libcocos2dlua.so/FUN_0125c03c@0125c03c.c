...
undefined8 * FUN_0125c03c(long *param_1)

{
  ...
  uVar3 = __strlen_chk(&DAT_0140098e,3);
  pcVar1 = (char *)*param_1;
  pbVar7 = (byte *)param_1[1];
  if ((ulong)((long)pbVar7 - (long)pcVar1) < uVar3) {
LAB_0125c10c:
    uVar3 = __strlen_chk(&DAT_014a800e,3);
    pcVar1 = (char *)*param_1;
    pbVar7 = (byte *)param_1[1];
    if ((ulong)((long)pbVar7 - (long)pcVar1) < uVar3) {
    ...
    *param_1 = (long)pbVar10;
    ...
    if ((pbVar7 != pbVar14) && (*pbVar14 - 0x30 < 10)) {
      ...
      do {
        pbVar12 = pbVar10;
        *param_1 = (long)pbVar12;
        if (pbVar7 == pbVar12) goto LAB_0125c380;
        pbVar10 = pbVar12 + 1;
      } while (*pbVar12 - 0x30 < 10);
LAB_0125c200:
    ...
    if (uVar3 != 0) {
      ...
      pcVar11 = pcVar1;
      do {
        if (*pcVar8 != *pcVar11) goto LAB_0125c10c;
        pcVar8 = pcVar8 + 1;
        uVar9 = uVar9 - 1;
        pcVar11 = pcVar11 + 1;
      } while (uVar9 != 0);
