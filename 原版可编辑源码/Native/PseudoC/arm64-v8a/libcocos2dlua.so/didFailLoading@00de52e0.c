...
/* cocos2d::experimental::ui::WebViewImpl::didFailLoading(int, std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

void cocos2d::experimental::ui::WebViewImpl::didFailLoading(int param_1,basic_string *param_2)
      ...
      do {
        ...
        if (uVar8 == uVar5) {
          if ((int)plVar7[2] == param_1) {
            plVar3 = *(long **)(*(long *)(plVar7[3] + 0x10) + 0x570);
            if (plVar3 != (long *)0x0) {
