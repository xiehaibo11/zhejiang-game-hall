...
void FUN_008a3a0c(lua_State *param_1)

{
  ...
  iVar5 = tolua_isusertable(param_1,1,&DAT_0128a454,0,auStack_48);
  if (((iVar5 == 0) || (iVar5 = tolua_isusertype(param_1,2,"CCArray",0,auStack_48), iVar5 == 0)) ||
    ...
    array_to_vector_t_deprecated<cocos2d::MenuItem*>(p_Var6,(Vector *)&local_60);
    pvVar7 = (void *)cocos2d::Menu::createWithArray((Vector *)&local_60);
    ...
    toluafix_pushusertype_ccobject(param_1,iVar5,piVar2,pvVar7,"cc.Menu");
    puVar4 = local_58;
