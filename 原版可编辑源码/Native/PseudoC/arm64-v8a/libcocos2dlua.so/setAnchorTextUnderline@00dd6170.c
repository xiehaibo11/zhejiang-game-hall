...
/* cocos2d::ui::RichText::setAnchorTextUnderline(bool) */

void __thiscall cocos2d::ui::RichText::setAnchorTextUnderline(RichText *this,bool param_1)
  ...
  if (param_1) {
    ...
    if (__n == sVar1) {
      ...
      if (((ulong)local_70 & 1) == 0) {
        if (__n != 0) {
          do {
            if (*pcVar8 != *__s2) goto LAB_00dd6298;
            uVar7 = uVar7 - 1;
            pcVar8 = pcVar8 + 1;
            __s2 = __s2 + 1;
          } while (uVar7 != 0);
          bVar3 = true;
          goto joined_r0x00dd629c;
        }
      }
      else if (__n == 0) {
...
LAB_00dd6298:
      bVar3 = false;
joined_r0x00dd629c:
                    /* try { // try from 00dd629c to 00ed62a3 has its CatchHandler @ 00dd64e8 */
      if (((ulong)local_70 & 1) != 0) {
        operator_delete(local_60);
      }
      if (!bVar3) goto LAB_00dd62fc;
    }
    local_70 = KEY_ANCHOR_TEXT_LINE;
    lVar5 = std::__ndk1::
            __hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::Value>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::Value>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::Value>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::Value>>>
