...

{
  ...
  lVar5 = tpidr_el0;
                    /* try { // try from 00aa29b8 to 00ba2b5b has its CatchHandler @ 00aa2810 */
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00aa2a70;
              goto LAB_00aa2b20;
            }
            if (uVar9 != uVar14) goto LAB_00aa2b20;
          }
LAB_00aa2a70:
          plVar8 = (long *)*plVar8;
