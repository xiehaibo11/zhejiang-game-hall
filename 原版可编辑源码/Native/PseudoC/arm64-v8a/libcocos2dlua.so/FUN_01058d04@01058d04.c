...
void FUN_01058d04(ulong *param_1)

{
  ...
  *piVar3 = 6;
  __fd = socket(2,2,0);
  if (-1 < __fd) {
    pcVar4 = (char *)FUN_0104b1fc(0x2000,"getifaddrs2");
    if (pcVar4 != (char *)0x0) {
      lVar9 = 0x2000;
      do {
        ...
        if ((iVar2 < 0) && (iVar2 = *piVar3, iVar2 != 0x16)) goto LAB_01058de8;
        if ((int)local_a0[0] < (int)(uint)lVar9) {
          uVar8 = (ulong)local_a0[0];
          if ((int)local_a0[0] < 1) goto LAB_01058f18;
          puVar10 = &local_a8;
                    /* try { // try from 01058e58 to 01158e83 has its CatchHandler @ 01058ee0 */
          __s = local_98;
          goto LAB_01058e5c;
        }
        thunk_FUN_0104b1cc(pcVar4,0,"lws_free");
        lVar9 = lVar9 << 1;
        pcVar4 = (char *)FUN_0104b1fc(lVar9,"getifaddrs2");
...
LAB_01058de8:
  ...
  goto LAB_01058f4c;
  while( true ) {
                    /* try { // try from 01058e84 to 01158f17 has its CatchHandler @ 01058cb8 */
    puVar6 = (undefined8 *)thunk_FUN_0104b1cc(0,0x38,"getifaddrs");
    *puVar10 = (ulong)puVar6;
    *puVar6 = 0;
    pcVar7 = strdup(__s);
    *(char **)(*puVar10 + 8) = pcVar7;
    *(int *)(*puVar10 + 0x10) = (int)(short)local_80;
    uVar5 = thunk_FUN_0104b1cc(0,0x10,"getifaddrs");
    ...
    *puVar6 = uVar5;
                    /* catch() { ... } // from try @ 01058e58 with catch @ 01058ee0 */
