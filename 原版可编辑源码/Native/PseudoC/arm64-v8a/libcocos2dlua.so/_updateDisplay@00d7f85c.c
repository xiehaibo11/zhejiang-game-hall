...
LAB_00d7f8e8:
  ...
  if (plVar11 == plVar8) goto LAB_00d7fb04;
  if (plVar8 != (long *)0x0) {
    plVar8[6] = 0;
  ...
  if (plVar11 == (long *)0x0) goto LAB_00d7fb04;
  plVar11[6] = (long)this;
  uVar4 = (**(code **)(**(long **)(this + 0x68) + 0x28))();
  (**(code **)(*plVar11 + 0x30))(plVar11,uVar4);
  this_00 = *(Armature **)(this + 0x178);
  if (this_00[0xd] == (Armature)0x0) goto LAB_00d7fb04;
...
LAB_00d7facc:
        if (*(int *)(lVar10 + 0x10) == 1) goto LAB_00d7fa04;
      }
      else {
