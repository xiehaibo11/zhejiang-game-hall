...
/* int cocos2d::JniHelper::callStaticIntMethod<char const*, int>(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&, char const*, int) */

int cocos2d::JniHelper::callStaticIntMethod<char_const*,int>
              (basic_string *param_1,basic_string *param_2,char *param_3,int param_4)

{
  ...
  getJNISignature<char_const*,int>(param_3,param_4);
  ...
  *puVar8 = 0;
  ...
  if ((uVar9 & 1) == 0) {
    ...
    iVar7 = _JNIEnv::CallStaticIntMethod(p_Var5,p_Var6,local_78,uVar10,(ulong)(uint)param_4);
