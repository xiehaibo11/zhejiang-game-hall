...
/* void std::__ndk1::vector<cocos2d::Vector<cocostudio::ActionFrame*>*,
   std::__ndk1::allocator<cocos2d::Vector<cocostudio::ActionFrame*>*>
   >::__push_back_slow_path<cocos2d::Vector<cocostudio::ActionFrame*>*>(cocos2d::Vector<cocostudio::ActionFrame*>*&&)
    */
