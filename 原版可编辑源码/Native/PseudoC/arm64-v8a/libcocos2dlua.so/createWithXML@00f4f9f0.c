...
/* cocos2d::TMXMapInfo::createWithXML(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&) */

Ref * cocos2d::TMXMapInfo::createWithXML(basic_string *param_1,basic_string *param_2)

{
  ...
  if (this != (Ref *)0x0) {
    ...
    *(undefined8 *)(this + 0x30) = 0x100000000;
    ...
    Size::Size((Size *)(this + 0x48),(Size *)&Size::ZERO);
                    /* try { // try from 00f4fa7c to 0104fa83 has its CatchHandler @ 00f50908 */
                    /* try { // try from 00f4fa84 to 0104fb93 has its CatchHandler @ 00f4f410 */
  ...
  internalInit((TMXMapInfo *)this,(basic_string *)local_50,param_2);
  if (((byte)local_50[0] & 1) != 0) {
    operator_delete(local_40);
  }
  uVar2 = parseXMLString((TMXMapInfo *)this,param_1);
  if ((uVar2 & 1) == 0) {
    if (this != (Ref *)0x0) {
