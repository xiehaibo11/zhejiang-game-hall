...
/* std::__ndk1::__split_buffer<cocostudio::FrameEvent**,
   std::__ndk1::allocator<cocostudio::FrameEvent**> >::push_back(cocostudio::FrameEvent**&&) */

void __thiscall
std::__ndk1::
__split_buffer<cocostudio::FrameEvent**,std::__ndk1::allocator<cocostudio::FrameEvent**>>::push_back
          (__split_buffer<cocostudio::FrameEvent**,std::__ndk1::allocator<cocostudio::FrameEvent**>>
           *this,FrameEvent ***param_1)
