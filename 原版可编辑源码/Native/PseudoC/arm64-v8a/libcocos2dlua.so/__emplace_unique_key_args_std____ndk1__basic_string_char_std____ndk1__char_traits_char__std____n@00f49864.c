...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, bool>, void*>*>, bool>
   std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, bool>,
   std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> >, bool>, std::__ndk1::hash<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > >, true>,
   std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> >, bool>, std::__ndk1::equal_to<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > >, true>,
...

{
  ...
  if (uVar16 != 0) {
    ...
    if ((puVar9 != (undefined8 *)0x0) && (plVar15 = (long *)*puVar9, plVar15 != (long *)0x0)) {
      ...
      do {
                    /* try { // try from 00f49948 to 0104994f has its CatchHandler @ 00f49a44 */
        uVar10 = plVar15[1];
                    /* try { // try from 00f49950 to 01049993 has its CatchHandler @ 00f49a50 */
        if (uVar10 != uVar7) {
          if (uVar13 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00f49988;
            break;
          }
...
LAB_00f49988:
        bVar3 = *(byte *)(plVar15 + 2);
                    /* try { // try from 00f49994 to 010499ab has its CatchHandler @ 00f49a4c */
        sVar1 = (ulong)(bVar3 >> 1);
        if ((bVar3 & 1) != 0) {
          sVar1 = plVar15[3];
        }
        if (sVar1 == __n) {
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
                    /* try { // try from 00f499bc to 010499ef has its CatchHandler @ 00f49a50 */
              uVar10 = 0;
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00f499f8;
              }
              goto LAB_00f49940;
            }
          }
          else if (__n != 0) {
                    /* try { // try from 00f499f0 to 01049a6b has its CatchHandler @ 00f49840 */
            uVar6 = memcmp(__s1,ppVar2,__n);
            __s1 = (void *)(ulong)uVar6;
            if (uVar6 != 0) goto LAB_00f49940;
          }
LAB_00f499f8:
          uVar8 = 0;
          goto LAB_00f49b24;
...
LAB_00f49940:
  ...
  *plVar15 = 0;
  plVar15[1] = uVar7;
                    /* catch() { ... } // from try @ 00f49948 with catch @ 00f49a44 */
  if ((uVar16 == 0) ||
     (*(float *)(param_1 + 0x20) * (float)uVar16 < (float)(*(long *)(param_1 + 0x18) + 1))) {
                    /* catch() { ... } // from try @ 00f49994 with catch @ 00f49a4c */
                    /* catch() { ... } // from try @ 00f49950 with catch @ 00f49a50
                       catch() { ... } // from try @ 00f499bc with catch @ 00f49a50 */
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar12;
    if (*plVar15 == 0) goto LAB_00f49b14;
