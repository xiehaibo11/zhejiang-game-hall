...
void FUN_010fce4c(long param_1,long *param_2,uint param_3,undefined8 *param_4,int param_5)

{
  ...
  undefined8 uVar27;
                    ...
                    /* try { // try from 010fce4c to 011fce5b has its CatchHandler @ 010fd198 */
  if (0 < param_5) {
    uVar3 = *(uint *)(param_1 + 0x88);
    uVar7 = (ulong)uVar3;
                    /* try { // try from 010fce5c to 011fce67 has its CatchHandler @ 010fd16c */
    if (uVar3 != 0) {
      uVar2 = uVar3 & 0x1f;
      lVar8 = uVar7 - uVar2;
      do {
                    /* try { // try from 010fce7c to 011fce87 has its CatchHandler @ 010fd17c */
...
LAB_010fcf5c:
          ...
          do {
            ...
            *puVar13 = *puVar12;
            ...
            puVar13[2] = *puVar10;
            puVar13 = puVar13 + 3;
                    /* try { // try from 010fcf8c to 011fcf93 has its CatchHandler @ 010fd0c4 */
            puVar10 = puVar10 + 1;
            puVar11 = puVar11 + 1;
            puVar12 = puVar12 + 1;
          } while (lVar15 != 0);
                    ...
                    /* try { // try from 010fceac to 011fceb3 has its CatchHandler @ 010fd164 */
          puVar14 = puVar13 + uVar7 * 3;
                    /* try { // try from 010fceb4 to 011fcebf has its CatchHandler @ 010fd110 */
          if ((puVar13 < puVar12 + uVar7 && puVar12 < puVar14) ||
             ((puVar13 < puVar11 + uVar7 && puVar11 < puVar14 ||
              (puVar13 < puVar10 + uVar7 && puVar10 < puVar14)))) goto LAB_010fcf58;
          ...
          do {
            ...
            uVar27 = puVar4[1];
            uVar26 = *puVar4;
                    /* try { // try from 010fcf28 to 011fcf2f has its CatchHandler @ 010fd10c */
            lVar9 = lVar9 + -0x20;
                    /* try { // try from 010fcf30 to 011fcf3b has its CatchHandler @ 010fd0c8 */
            puVar5 = puVar5 + 4;
            *puVar14 = (char)uVar16;
          ...
          if (uVar2 != 0) goto LAB_010fcf5c;
        }
                    /* try { // try from 010fcf94 to 011fcf9f has its CatchHandler @ 010fd0c0 */
        param_4 = param_4 + 1;
        bVar1 = 1 < param_5;
        param_5 = param_5 + -1;
      } while (bVar1);
