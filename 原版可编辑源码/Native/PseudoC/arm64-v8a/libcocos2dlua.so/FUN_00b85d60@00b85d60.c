...
undefined8 FUN_00b85d60(X509_NAME *param_1,undefined8 param_2)

{
  ...
  while (iVar1 = X509_NAME_get_index_by_NID(param_1,0x30,iVar1), -1 < iVar1) {
    ...
    iVar2 = FUN_00b85ee8(&local_28,pAVar3);
    if (iVar2 == 0) {
      return 0;
    }
  }
  ...
  if (0 < iVar1) {
    ...
    while ((piVar4 = (int *)OPENSSL_sk_value(param_2,iVar1), *piVar4 != 1 ||
           (iVar2 = FUN_00b85ee8(&local_28,*(undefined8 *)(piVar4 + 2)), iVar2 != 0))) {
      iVar1 = iVar1 + 1;
      iVar2 = OPENSSL_sk_num(param_2);
                    /* try { // try from 00b85e08 to 00c85e0f has its CatchHandler @ 00b85ec8 */
      if (iVar2 <= iVar1) {
        return local_28;
      }
    }
