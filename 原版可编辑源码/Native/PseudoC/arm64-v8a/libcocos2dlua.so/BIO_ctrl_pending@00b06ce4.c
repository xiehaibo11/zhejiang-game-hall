  ...
  if (b != (BIO *)0x0) {
    if ((b->method == (BIO_METHOD *)0x0) ||
      ...
      if (UNRECOVERED_JUMPTABLE_00 == (_func_603 *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00b06dc0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                    /* try { // try from 00b06dc0 to 00c06e5b has its CatchHandler @ 00b06dc0
                       catch() { ... } // from try @ 00b06dc0 with catch @ 00b06dc0
                       catch() { ... } // from try @ 00b06e68 with catch @ 00b06dc0 */
      ...
      if (0 < (long)sVar1) {
        lVar2 = (*b->method->ctrl)(b,10,0,(void *)0x0);
                    /* WARNING: Could not recover jumptable at 0x00b06d78. Too many branches */
                    /* WARNING: Treating indirect jump as call */
