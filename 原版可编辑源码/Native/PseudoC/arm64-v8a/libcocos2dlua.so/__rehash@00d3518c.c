...

{
  ...
  if (param_1 == 0) {
                    /* try { // try from 00d35234 to 00e3533b has its CatchHandler @ 00d35014 */
    pvVar8 = *(void **)this;
    *(undefined8 *)this = 0;
    if (pvVar8 != (void *)0x0) {
    ...
    *(undefined8 *)(this + 8) = 0;
    ...
    if (param_1 >> 0x3d != 0) {
      ...
      FUN_007c2210("allocator<T>::allocate(size_t n) \'n\' exceeds maximum supported size");
                    ...
                    /* try { // try from 00d351c4 to 00e351cb has its CatchHandler @ 00d35324 */
      ...
      if (uVar13 < 2) {
        ...
        if (param_1 != 0) {
          uVar17 = uVar10 / param_1;
                    ...
                    /* try { // try from 00d3522c to 00e35233 has its CatchHandler @ 00d35310 */
              ...
              if (plVar11 != (long *)0x0) {
                ...
                do {
                  ...
                  bVar1 = *(byte *)(plVar12 + 2);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d3522c with catch @ 00d35310
                        */
                  sVar3 = (ulong)(bVar1 >> 1);
                  if ((bVar1 & 1) != 0) {
                    sVar3 = plVar12[3];
                  ...
                  if (__n != sVar3) break;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d351c4 with catch @ 00d35324
                        */
                  __s2 = (char *)plVar12[4];
                  ...
                  if ((bVar1 & 1) == 0) {
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d35064 with catch @ 00d35338
                        */
                  ...
                  if ((bVar2 & 1) == 0) {
                    while (sVar6 != 0) {
                      if (*pcVar5 != *__s2) goto LAB_00d35394;
                      __s2 = __s2 + 1;
                      sVar3 = sVar3 - 1;
                      pcVar5 = pcVar5 + 1;
                      sVar6 = sVar3;
