...
/* dtMergeCorridorStartMoved(unsigned int*, int, int, unsigned int const*, int) */

int dtMergeCorridorStartMoved(uint *param_1,int param_2,int param_3,uint *param_4,int param_5)

{
  ...
  if ((int)uVar5 < 1) goto LAB_011934ac;
  uVar10 = (ulong)uVar5;
  if (uVar5 < 4) {
LAB_01193480:
    uVar14 = 0;
    ...
    if (((int)(uVar4 - (int)(uVar10 - 1)) <= (int)uVar4) && (uVar13 = 0, uVar10 - 1 >> 0x20 == 0)) {
      if ((param_1 < param_4 + (long)(int)uVar4 + 1) &&
         (param_4 + (((long)(int)uVar4 + 1) - uVar10) < param_1 + uVar10)) goto LAB_01193480;
      ...
      uVar13 = (uint)uVar14;
      if (uVar14 == uVar10) goto LAB_011934ac;
    }
  }
