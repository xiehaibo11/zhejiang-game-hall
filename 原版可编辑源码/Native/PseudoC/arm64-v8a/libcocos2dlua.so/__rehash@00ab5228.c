...

{
  ...
  undefined8 uVar19;
                    ...
                    /* try { // try from 00ab524c to 00bb524f has its CatchHandler @ 00ab5284 */
  if (param_1 == 0) {
    pvVar8 = *(void **)this;
    *(undefined8 *)this = 0;
    if (pvVar8 != (void *)0x0) {
    ...
    *(undefined8 *)(this + 8) = 0;
                    ...
                    /* try { // try from 00ab5250 to 00bb5297 has its CatchHandler @ 00ab5200 */
    if (param_1 >> 0x3d != 0) {
    ...
    *(ulong *)(this + 8) = param_1;
    do {
                    /* catch() { ... } // from try @ 00ab524c with catch @ 00ab5284 */
      *(undefined8 *)(*(long *)this + uVar10 * 8) = 0;
      uVar10 = uVar10 + 1;
    } while (param_1 != uVar10);
                    /* try { // try from 00ab5298 to 00bb573f has its CatchHandler @ 00ab5298
                       catch() { ... } // from try @ 00ab5298 with catch @ 00ab5298
                       catch() { ... } // from try @ 00ab57c0 with catch @ 00ab5298 */
              ...
              *(long **)(*(long *)this + uVar17 * 8) = plVar15;
              ...
              if (plVar11 != (long *)0x0) {
                ...
                do {
                  ...
                  if ((bVar2 & 1) == 0) {
                    while (sVar6 != 0) {
                      if (*pcVar5 != *__s2) goto LAB_00ab5430;
                      __s2 = __s2 + 1;
                      sVar3 = sVar3 - 1;
                      pcVar5 = pcVar5 + 1;
                      sVar6 = sVar3;
