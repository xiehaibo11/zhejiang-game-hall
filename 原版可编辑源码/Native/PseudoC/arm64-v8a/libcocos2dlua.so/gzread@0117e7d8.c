    ...
    if (param_1[0x1a] != 0) {
      ...
      for (; lVar8 != 0; lVar8 = lVar8 - uVar9) {
        while( true ) {
          uVar1 = *param_1;
          if (uVar1 != 0) break;
          if ((param_1[0x14] != 0) && (param_1[0x20] == 0)) goto LAB_0117e8e0;
...
LAB_0117e8e0:
    ...
    do {
      while (uVar1 = *param_1, uVar1 == 0) {
            ...
            do {
              ...
              if (iVar3 < 1) {
                if (iVar3 < 0) {
                  ...
                  FUN_0117e474(param_1,0xffffffff,pcVar6);
                  return -1;
                }
                param_1[0x14] = 1;
                break;
        ...
        iVar3 = FUN_0117ea3c(param_1);
        if (iVar3 == -1) goto LAB_0117e9e8;
        if (param_3 == 0) {
          return iVar2;
        }
      }
