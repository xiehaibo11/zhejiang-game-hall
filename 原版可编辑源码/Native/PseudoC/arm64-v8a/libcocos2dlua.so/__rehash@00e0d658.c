...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::Color3B>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::Color3B>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::Color3B>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::Color3B>>>
           *this,ulong param_1)
    ...
    if (plVar5 != (long *)0x0) {
      ...
      *(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::Color3B>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::Color3B>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::Color3B>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::Color3B>>>
      ...
      if ((long *)*plVar5 != (long *)0x0) {
        plVar6 = (long *)*plVar5;
        do {
                    /* try { // try from 00e0d730 to 00f0d7ef has its CatchHandler @ 00e0db18 */
          uVar7 = plVar6[1];
          if ((uVar12 & 0xffffffff) < 2) {
