...
/* fairygui::GList::getIndexOnPos2(float&, bool) */

int __thiscall fairygui::GList::getIndexOnPos2(GList *this,float *param_1,bool param_2)
...
LAB_00a7ace0:
  ...
  if ((iVar2 < 1) || (param_2)) {
    ...
    if (iVar2 < 1) {
      ...
      fVar6 = 0.0;
      do {
        fVar8 = fVar6 + *(float *)(*(long *)(this + 0x368) + (long)iVar3 * 0x18);
    ...
    if (fVar7 < fVar6 + fVar8) {
      ...
      do {
        ...
        if (iVar2 < 0) goto LAB_00a7ace0;
        iVar3 = iVar3 - *(int *)(this + 0x348);
        fVar6 = fVar6 - (*(float *)(*(long *)(this + 0x368) + (long)iVar2 * 0x18) +
                        (float)(int)uVar1);
      } while (fVar7 < fVar6);
      goto LAB_00a7ae44;
    }
