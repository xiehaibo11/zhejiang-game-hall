...
void FUN_00bac75c(int *param_1,int *param_2)

{
  ...
  FUN_00bab77c();
  FUN_00bab77c(param_1 + 0x14,param_2 + 10);
  ...
  lVar50 = lVar24 * 0x13;
  lVar47 = lVar28 * 2;
                    /* try { // try from 00bac864 to 00cac887 has its CatchHandler @ 00bac9a8 */
  lVar41 = lVar43 * 0x26;
                    /* try { // try from 00bac888 to 00cac95f has its CatchHandler @ 00bac664 */
  ...
  lVar21 = (lVar28 >> 0x1a) +
           ...
           * 2;
                    /* try { // try from 00bac960 to 00cac973 has its CatchHandler @ 00bac9a8 */
  lVar22 = lVar21 + 0x1000000;
  lVar23 = (lVar48 - (uVar12 & 0xfffffffffc000000)) + (lVar22 >> 0x19);
                    /* try { // try from 00bac974 to 00caca07 has its CatchHandler @ 00bac664 */
  ...
  param_1[0x25] = (int)lVar17 - ((uint)lVar18 & 0xfe000000);
                    /* catch() { ... } // from try @ 00bac6a4 with catch @ 00bac9a0 */
  param_1[0x22] = (int)lVar23 - ((uint)uVar11 & 0xfc000000);
  param_1[0x23] = ((int)lVar13 - ((uint)lVar15 & 0xfe000000)) + (int)(uVar11 >> 0x1a);
                    /* catch() { ... } // from try @ 00bac6b8 with catch @ 00bac9a8
                       catch() { ... } // from try @ 00bac864 with catch @ 00bac9a8
                       catch() { ... } // from try @ 00bac960 with catch @ 00bac9a8 */
  ...
  param_1[0xc] = param_2[0xc] + param_2[2];
                    /* try { // try from 00baca08 to 00cacb9f has its CatchHandler @ 00baca08
                       catch() { ... } // from try @ 00baca08 with catch @ 00baca08
                       catch() { ... } // from try @ 00bacbcc with catch @ 00baca08 */
  ...
  FUN_00bab77c(&local_78,param_1 + 10);
  ...
  *param_1 = local_78 - iVar1;
  ...
  param_1[7] = local_5c - iVar8;
                    /* try { // try from 00bacba0 to 00cacbcb has its CatchHandler @ 00bacc08 */
  param_1[8] = local_58 - iVar9;
  param_1[0x1e] = param_1[0x1e] - iVar29;
  param_1[0x1f] = param_1[0x1f] - iVar30;
                    /* try { // try from 00bacbcc to 00cacc1b has its CatchHandler @ 00baca08 */
