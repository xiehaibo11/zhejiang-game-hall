...
longlong std::__ndk1::stoll(basic_string *param_1,ulong *param_2,int param_3)

{
  ...
  basic_string<decltype(nullptr)>(local_80,"stoll");
  ...
  iVar1 = *piVar4;
  *piVar4 = 0;
  lVar5 = wcstoll((wchar_t *)__nptr,&local_68,param_3);
  iVar2 = *piVar4;
  *piVar4 = iVar1;
  if (iVar2 == 0x22) {
