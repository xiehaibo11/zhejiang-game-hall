...

{
  ...
  if (lVar16 == 0) {
                    ...
                    /* catch() { ... } // from try @ 010cdda4 with catch @ 010cdfec */
    png_error(param_1,"NULL row buffer");
  }
  if ((*(uint *)(param_1 + 0x168) & 0x4040) == 0x4000) {
                    /* WARNING: Subroutine does not return */
                    /* catch() { ... } // from try @ 010cde8c with catch @ 010cdffc */
  ...
  if ((*(uint *)(param_1 + 0x16c) >> 0xc & 1) != 0) {
    if ((char)param_2[4] == '\x03') {
      ...
      else if (bVar44 != 8) goto LAB_010cb7d0;
      if (uVar13 == 0) {
      ...
      *(undefined1 *)((long)param_2 + 0x12) = uVar45;
      ...
      FUN_010ce010(param_2,lVar16 + 1,lVar35);
    }
  }
LAB_010cb7d0:
...
LAB_010cb9c0:
    ...
    if (bVar12) {
      ...
      *(undefined1 *)(param_1 + 0x448) = 1;
      ...
      if ((uVar38 & 0x600000) == 0x200000) {
                    /* catch() { ... } // from try @ 010cdd60 with catch @ 010ce000
                       catch() { ... } // from try @ 010cded4 with catch @ 010ce000 */
                    /* WARNING: Subroutine does not return */
  ...
  if (((uVar38 >> 0xe & 1) != 0) && ((*(byte *)(param_1 + 0x165) >> 3 & 1) == 0)) {
    FUN_010ce440(param_2,*(long *)(param_1 + 0x260) + 1);
    uVar38 = *(uint *)(param_1 + 0x16c);
  }
        ...
        do {
          if (CONCAT11(pbVar43[-2],pbVar43[-1]) == sVar7) {
            ...
            if ((CONCAT11(*pbVar43,pbVar43[1]) != *(short *)(param_1 + 0x33c)) ||
               (CONCAT11(pbVar43[2],pbVar43[3]) != *(short *)(param_1 + 0x33e))) goto LAB_010cc3d0;
            uVar21 = *(undefined2 *)(param_1 + 0x2c2);
            pbVar43[-1] = (byte)uVar21;
            pbVar43[-2] = (byte)((ushort)uVar21 >> 8);
            uVar21 = *(undefined2 *)(param_1 + 0x2c4);
...
LAB_010cc6f4:
    ...
    if (*(char *)((long)param_2 + 0x11) == '\x10') {
      ...
      if ((*(char *)((long)param_2 + 0x11) != '\b') ||
         (lVar16 = *(long *)(param_1 + 0x300), lVar16 == 0)) goto LAB_010cc6f4;
      if (uVar38 != 0) {
    ...
    if (bVar44 == 4) {
      if (uVar38 != 0) {
        ...
        do {
          bVar12 = uVar32 != 4;
          pbVar43 = pbVar33 + -1;
                    /* try { // try from 010cd918 to 011cd91b has its CatchHandler @ 010cd934 */
          if (bVar12) {
            pbVar43 = pbVar33;
          }
                    /* try { // try from 010cd91c to 011cd947 has its CatchHandler @ 010cd8dc */
      ...
      if (uVar38 != 0) {
                    /* catch() { ... } // from try @ 010cd918 with catch @ 010cd934 */
        uVar32 = ~(uVar38 * 2 + 6) & 6;
      ...
      do {
        ...
        *(byte *)(lVar35 + uVar27) = *pbVar33 >> (ulong)(uVar32 & 0x1f) & 1;
        uVar27 = uVar27 - 1;
                    /* try { // try from 010cd8dc to 011cd917 has its CatchHandler @ 010cd8dc
                       catch() { ... } // from try @ 010cd8dc with catch @ 010cd8dc
                       catch() { ... } // from try @ 010cd91c with catch @ 010cd8dc */
        uVar29 = 0;
        if (uVar32 != 7) {
          uVar29 = uVar32 + 1;
        }
  ...
  if ((uVar38 >> 0xf & 1) != 0) {
    ...
    if ((char)param_2[4] == '\x02') {
      if (*(char *)((long)param_2 + 0x11) == '\x10') {
          ...
          *(undefined1 *)(lVar16 + -2) = uVar45;
          if (1 < uVar32) {
            ...
            do {
              ...
              *puVar28 = *puVar31;
              puVar28[-1] = puVar31[-1];
                    /* catch() { ... } // from try @ 010cdc68 with catch @ 010cdcd4 */
              puVar28[-2] = puVar31[-2];
              uVar47 = puVar31[-3];
              puVar28[-4] = uVar46;
              puVar28[-5] = uVar45;
              puVar31 = puVar31 + -6;
              puVar28[-3] = uVar47;
                    /* try { // try from 010cdcf0 to 011cdd5f has its CatchHandler @ 010cdcf0
                       catch() { ... } // from try @ 010cdcf0 with catch @ 010cdcf0
                       catch() { ... } // from try @ 010cdf30 with catch @ 010cdcf0 */
              puVar28 = puVar28 + -8;
            } while (iVar15 != 0);
          }
        }
        ...
        if (*(char *)((long)param_2 + 0x11) != '\b') goto LAB_010cdd08;
        if ((uVar38 >> 7 & 1) == 0) {
          if (uVar32 != 0) {
      ...
      if ((char)param_2[4] != '\0') goto LAB_010cdd08;
      if (*(char *)((long)param_2 + 0x11) == '\x10') {
        if ((uVar38 >> 7 & 1) == 0) {
          if (uVar32 != 0) {
          ...
          lVar16 = lVar16 + uVar27 * 4;
                    /* catch() { ... } // from try @ 010cdc70 with catch @ 010cdc2c */
          *(undefined1 *)(lVar16 + -1) = uVar46;
          *(undefined1 *)(lVar16 + -2) = uVar45;
          if (1 < uVar32) {
            puVar31 = (undefined1 *)(lVar35 + uVar27 * 2);
            ...
            do {
              ...
              *puVar28 = *puVar31;
              ...
              puVar28[-3] = uVar45;
              puVar31 = puVar31 + -2;
                    /* try { // try from 010cdc68 to 011cdc6f has its CatchHandler @ 010cdcd4 */
              puVar28[-1] = uVar47;
              puVar28 = puVar28 + -4;
                    /* try { // try from 010cdc70 to 011cdcef has its CatchHandler @ 010cdc2c */
            } while (iVar15 != 0);
          }
        }
        uVar21 = 0x2002;
...
LAB_010cdd08:
  if ((*(byte *)(param_1 + 0x16e) >> 1 & 1) != 0) {
    ...
    uVar38 = *param_2;
    if ((char)param_2[4] == '\x04') {
                    /* try { // try from 010cdd60 to 011cdd6f has its CatchHandler @ 010ce000 */
      ...
      if (*(char *)((long)param_2 + 0x11) == '\b') {
          ...
          if (uVar27 < 0x20) {
            ...
            if (lVar30 != 0) {
              ...
              do {
                ...
                uVar76 = puVar31[-2];
                lVar16 = lVar16 + -0x20;
                    /* try { // try from 010cde8c to 011cde9f has its CatchHandler @ 010cdffc */
                *puVar31 = puVar31[1];
                puVar31[1] = uVar45;
                puVar31[2] = puVar31[3];
                puVar31[3] = uVar46;
              ...
              if ((uVar38 & 0x1f) == 0) goto LAB_010cdf34;
            }
          }
          iVar15 = uVar38 - (int)lVar30;
        ...
        if (uVar27 < 0x10) {
          ...
          lVar30 = uVar27 - (uVar38 & 0xf);
                    /* try { // try from 010cded4 to 011cdf2f has its CatchHandler @ 010ce000 */
          if (lVar30 != 0) {
            ...
            if ((uVar38 & 0xf) == 0) goto LAB_010cdf34;
          }
        }
        iVar15 = uVar38 - (int)lVar30;
        ...
        do {
          ...
          *puVar24 = puVar24[-1];
          puVar24[-1] = uVar21;
          puVar24 = puVar24 + -2;
                    /* try { // try from 010cdf30 to 011ce08f has its CatchHandler @ 010cdcf0 */
        } while (iVar15 != 0);
      }
    }
    else if ((char)param_2[4] == '\x06') {
      ...
      if (*(char *)((long)param_2 + 0x11) == '\b') {
        if (uVar38 != 0) {
          ...
          if (uVar27 < 0x10) {
            ...
            lVar30 = uVar27 - (uVar38 & 0xf);
            if (lVar30 != 0) {
                    /* try { // try from 010cddf0 to 011cddfb has its CatchHandler @ 010ce054 */
              lVar22 = lVar22 + lVar30 * -4;
          ...
          iVar15 = uVar38 - (int)lVar30;
          do {
                    /* try { // try from 010cde2c to 011cde3b has its CatchHandler @ 010ce050 */
            uVar45 = puVar31[1];
            iVar15 = iVar15 + -1;
            puVar31[1] = *puVar31;
            *puVar31 = puVar31[-1];
            ...
            puVar31[-2] = uVar45;
            puVar31 = puVar31 + -4;
                    /* try { // try from 010cde54 to 011cde5b has its CatchHandler @ 010ce010 */
          } while (iVar15 != 0);
        }
      }
      else if (uVar38 != 0) {
        ...
        do {
                    /* try { // try from 010cdda4 to 011cddb3 has its CatchHandler @ 010cdfec */
          uVar38 = uVar38 - 1;
