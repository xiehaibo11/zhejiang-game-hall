...
/* non-virtual thunk to ArmatureNodeReader::createNodeWithFlatBuffers(flatbuffers::Table const*) */

undefined8 __thiscall
ArmatureNodeReader::createNodeWithFlatBuffers(ArmatureNodeReader *this,Table *param_1)

{
  ...
  uVar1 = cocostudio::Armature::create();
