...
undefined8 WebPDecodeBGR(long param_1,undefined8 param_2,undefined4 *param_3,undefined4 *param_4)

{
  ...
  if (param_1 != 0) {
    local_48 = 0;
                    /* try { // try from 0113fb44 to 0123fb4b has its CatchHandler @ 0113fb5c */
    uStack_60 = 0;
    local_68 = 0;
    uStack_50 = 0;
    uStack_58 = 0;
    ...
    if (iVar1 == 0) {
      ...
      if (param_3 != (undefined4 *)0x0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 0113fb44 with catch @ 0113fb5c
                        */
      ...
      if (iVar1 == 0) {
        return local_2c0;
                    ...
                    /* try { // try from 0113fb94 to 0123fb9b has its CatchHandler @ 0113fbb4 */
  return 0;
}
