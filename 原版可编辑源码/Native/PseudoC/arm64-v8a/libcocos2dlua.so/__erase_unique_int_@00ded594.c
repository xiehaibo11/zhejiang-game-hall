...
/* unsigned long std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int,
   cocos2d::ui::EditBoxImplAndroid*>, std::__ndk1::__unordered_map_hasher<int,
   std::__ndk1::__hash_value_type<int, cocos2d::ui::EditBoxImplAndroid*>, std::__ndk1::hash<int>,
...

{
  ...
  ulong uVar11;
                    ...
                    /* try { // try from 00ded59c to 00eed5d3 has its CatchHandler @ 00ded4a4 */
  lVar2 = tpidr_el0;
  ...
  if (uVar4 != 0) {
    ...
    if ((uVar11 & 0xffffffff) < 2) {
      uVar6 = uVar4 - 1 & uVar5;
                    ...
                    /* try { // try from 00ded5d4 to 00eed5f7 has its CatchHandler @ 00ded698 */
      uVar6 = uVar5;
      if (uVar4 <= uVar5) {
        uVar6 = 0;
        if (uVar4 != 0) {
        ...
        uVar6 = uVar5 - uVar6 * uVar4;
                    ...
                    /* try { // try from 00ded5f8 to 00eed627 has its CatchHandler @ 00ded4a4 */
    plVar7 = *(long **)(*(long *)this + uVar6 * 8);
    if ((plVar7 != (long *)0x0) && (plVar7 = (long *)*plVar7, plVar7 != (long *)0x0)) {
      do {
        uVar8 = plVar7[1];
                    /* try { // try from 00ded628 to 00eed643 has its CatchHandler @ 00ded694 */
        if (uVar8 == uVar5) {
          if ((int)plVar7[2] == *param_1) {
            remove(local_40);
            pvVar3 = local_40[0];
            local_40[0] = (void *)0x0;
                    /* catch() { ... } // from try @ 00ded628 with catch @ 00ded694 */
            if (pvVar3 != (void *)0x0) {
                    /* catch() { ... } // from try @ 00ded5d4 with catch @ 00ded698 */
              operator_delete(pvVar3);
            }
                    /* catch() { ... } // from try @ 00ded564 with catch @ 00ded69c */
            uVar4 = 1;
                    /* catch() { ... } // from try @ 00ded508 with catch @ 00ded6a0 */
            goto LAB_00ded664;
          }
        }
        else {
          if ((uVar11 & 0xffffffff) < 2) {
            ...
            if (uVar4 != 0) {
              uVar1 = uVar8 / uVar4;
                    ...
                    /* try { // try from 00ded644 to 00eed6bb has its CatchHandler @ 00ded4a4 */
