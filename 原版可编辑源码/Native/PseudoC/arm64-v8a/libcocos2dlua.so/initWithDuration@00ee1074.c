...
/* cocos2d::JumpTo::initWithDuration(float, cocos2d::Vec2 const&, float, int) */

undefined4 __thiscall
cocos2d::JumpTo::initWithDuration
          (JumpTo *this,float param_1,Vec2 *param_2,float param_3,int param_4)
