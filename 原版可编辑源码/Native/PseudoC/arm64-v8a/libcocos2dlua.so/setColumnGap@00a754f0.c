...
/* fairygui::GGroup::setColumnGap(int) */

void __thiscall fairygui::GGroup::setColumnGap(GGroup *this,int param_1)

{
  long lVar1;
  ulong uVar2;
  
  if ((((*(int *)(this + 0x1e4) != param_1) &&
       (*(int *)(this + 0x1e4) = param_1, *(int *)(this + 0x1d8) == 0)) &&
      (*(long *)(this + 0xa0) != 0)) &&
