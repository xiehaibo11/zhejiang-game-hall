...
/* fairygui::GearSize::init() */

void __thiscall fairygui::GearSize::init(GearSize *this)

{
  ...
  lVar3 = *(long *)(this + 8);
  cocos2d::Vec4::Vec4((Vec4 *)&local_48,*(float *)(lVar3 + 200),*(float *)(lVar3 + 0xcc),
                      *(float *)(lVar3 + 0xe0),*(float *)(lVar3 + 0xe4));
