...
/* cocostudio::timeline::ActionTimelineCache::loadScaleFrameWithFlatBuffers(flatbuffers::ScaleFrame
   const*) */

Frame * __thiscall
cocostudio::timeline::ActionTimelineCache::loadScaleFrameWithFlatBuffers
...

{
  ...
  pFVar4 = (Frame *)ScaleFrame::create();
  iVar2 = *(int *)param_1;
