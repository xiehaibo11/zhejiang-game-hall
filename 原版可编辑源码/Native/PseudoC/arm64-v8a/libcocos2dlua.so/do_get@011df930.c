...
num_get<wchar_t,std::__ndk1::istreambuf_iterator<wchar_t,std::__ndk1::char_traits<wchar_t>>>::do_get
           ...
           *this,undefined8 param_2,undefined8 param_3,long param_4,undefined4 *param_5,
          undefined1 *param_6)

{
  ...
  if ((*(byte *)(param_4 + 8) & 1) == 0) {
    ...
    ios_base::getloc();
    local_88 = &ctype<wchar_t>::id;
    pvStack_78 = (void *)0x0;
    local_80 = locale::id::__init;
    if (ctype<wchar_t>::id != -1) {
      local_90 = &local_88;
      local_98 = &local_90;
      __call_once((ulong *)&ctype<wchar_t>::id,&local_98,FUN_01208130);
    }
    if (((ulong)(*(long *)(local_a8 + 0x18) - *(long *)(local_a8 + 0x10) >> 3) <=
         (long)DAT_01794320 - 1U) ||
       (lVar4 = *(long *)(*(long *)(local_a8 + 0x10) + ((long)DAT_01794320 - 1U) * 8), lVar4 == 0))
    {
    ...
    pvStack_78 = (void *)0x0;
    local_80 = locale::id::__init;
    local_88 = &numpunct<wchar_t>::id;
    if (numpunct<wchar_t>::id != -1) {
      local_90 = &local_88;
      local_98 = &local_90;
      __call_once((ulong *)&numpunct<wchar_t>::id,&local_98,FUN_01208130);
    }
    if (((ulong)(*(long *)(local_a8 + 0x18) - *(long *)(local_a8 + 0x10) >> 3) <=
         (long)DAT_01794390 - 1U) ||
       (plVar5 = *(long **)(*(long *)(local_a8 + 0x10) + ((long)DAT_01794390 - 1U) * 8),
       plVar5 == (long *)0x0)) {
                    /* WARNING: Subroutine does not return */
      FUN_00cc7c00();
    }
    ...
    ppuVar3 = (undefined8 **)FUN_011dfbf8(&local_a0,param_3,&local_88,&local_58,lVar4,param_5,1);
    uVar2 = local_a0;
