...

{
  ...
  uint uStack_64;
                    ...
                    /* try { // try from 00ba6614 to 00ca6617 has its CatchHandler @ 00ba6634 */
                    /* try { // try from 00ba6618 to 00ca6647 has its CatchHandler @ 00ba65e8 */
  uVar9 = *(uint *)*ivec;
  uVar11 = *(uint *)(*ivec + 4);
                    /* catch() { ... } // from try @ 00ba6614 with catch @ 00ba6634 */
  if (enc == 0) {
    puVar6 = (uint *)input;
    if (7 < length) {
