...
/* cocos2d::experimental::AudioDecoderSLES::init(SLEngineItf_ const* const*,
...
void __thiscall
cocos2d::experimental::AudioDecoderSLES::init
...

{
  ...
  *(int *)(this + 0x130) = param_3;
  ...
  FUN_00e94fa0(alStack_80,this + 0x140);
