...
/* void ccmap_string_key_to_luaval<cocostudio::AnimationData*>(lua_State*,
   cocos2d::Map<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> >, cocostudio::AnimationData*> const&) */

void ccmap_string_key_to_luaval<cocostudio::AnimationData*>(lua_State *param_1,Map *param_2)
