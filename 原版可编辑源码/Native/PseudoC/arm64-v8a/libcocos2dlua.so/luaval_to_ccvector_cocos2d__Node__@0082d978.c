...
/* bool luaval_to_ccvector<cocos2d::Node*>(lua_State*, int, cocos2d::Vector<cocos2d::Node*>*, char
   const*) */

bool luaval_to_ccvector<cocos2d::Node*>
        ...
        if (((iVar4 != 0) && (iVar4 = lua_isuserdata(param_1,0xffffffff), iVar4 != 0)) &&
          ...
          if (plVar1 == *(long **)(param_3 + 0x10)) {
            ...
            __push_back_slow_path<cocos2d::Node*const&>
                      ((vector<cocos2d::Node*,std::__ndk1::allocator<cocos2d::Node*>> *)param_3,
                       (Node **)&local_60);
          }
          else {
            *plVar1 = (long)pRVar6;
