...

{
  ...
  if ((param_3 < 7) && ((1 << (ulong)(param_3 & 0x1f) & 0x54U) != 0)) {
    ...
    if (uVar1 <= param_5) {
      ...
      {
                    /* try { // try from 00bad02c to 00cad08f has its CatchHandler @ 00bad2c4 */
        *param_4 = (char)param_3;
        if ((param_3 != 4) && (iVar4 = BN_is_zero(a), iVar4 == 0)) {
          iVar4 = (**(code **)(*(long *)param_1 + 0x118))(param_1,pBVar5,a_00,a,param_6);
          if (iVar4 == 0) goto LAB_00bad1c0;
          iVar4 = BN_is_odd(pBVar5);
                    /* try { // try from 00bad0cc to 00cad16f has its CatchHandler @ 00bad2c0 */
          if (iVar4 != 0) {
            *param_4 = *param_4 + '\x01';
          }
        }
