...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00d34374 to 00e3438b has its CatchHandler @ 00d3456c */
  lVar5 = tpidr_el0;
  ...
  uVar7 = __murmur2_or_cityhash<unsigned_long,64ul>::operator()(a_Stack_70,pbVar2,uVar7);
                    /* try { // try from 00d343c0 to 00e343c7 has its CatchHandler @ 00d34570 */
  uVar12 = *(ulong *)(this + 8);
  if (uVar12 != 0) {
                    /* try { // try from 00d343c8 to 00e343cf has its CatchHandler @ 00d34590 */
    uVar16 = CONCAT17(POPCOUNT((char)(uVar12 >> 0x38)),
                    ...
                    /* try { // try from 00d343d0 to 00e34423 has its CatchHandler @ 00d34598 */
          ...
          if (uVar9 == uVar7) {
            ...
            if ((bVar3 & 1) != 0) {
              sVar1 = plVar8[3];
                    ...
                    /* try { // try from 00d34478 to 00e3447b has its CatchHandler @ 00d3458c */
            if (sVar1 == __n) {
              __s1 = (void *)plVar8[4];
              if ((bVar3 & 1) == 0) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                pbVar10 = (basic_string *)((long)plVar8 + 0x11);
                    /* try { // try from 00d34494 to 00e3449b has its CatchHandler @ 00d3456c */
                pbVar11 = pbVar2;
                while (*pbVar10 == *pbVar11) {
                  uVar9 = uVar9 - 1;
                    /* try { // try from 00d344ac to 00e344af has its CatchHandler @ 00d34588 */
                  pbVar10 = pbVar10 + 1;
                  pbVar11 = pbVar11 + 1;
                  if (uVar9 == 0) goto LAB_00d344fc;
                }
              }
            ...
            if (uVar13 < 2) {
                    /* try { // try from 00d3443c to 00e34453 has its CatchHandler @ 00d3456c */
              uVar9 = uVar9 & uVar12 - 1;
            }
            else if (uVar12 <= uVar9) {
                    /* try { // try from 00d344cc to 00e344cf has its CatchHandler @ 00d34594 */
              uVar4 = 0;
              if (uVar12 != 0) {
                uVar4 = uVar9 / uVar12;
              }
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00d34448;
              goto LAB_00d344f8;
            }
            if (uVar9 != uVar14) goto LAB_00d344f8;
          }
LAB_00d34448:
          plVar8 = (long *)*plVar8;
