...

{
  ...
  if (uVar16 != 0) {
    uVar8 = CONCAT17(POPCOUNT((char)(uVar16 >> 0x38)),
                    ...
                    /* try { // try from 00ddc954 to 00edc95b has its CatchHandler @ 00ddd29c */
    ...
    if (uVar13 < 2) {
      unaff_x27 = uVar16 - 1 & uVar7;
                    ...
                    /* try { // try from 00ddc964 to 00edc97b has its CatchHandler @ 00ddd2d8 */
      unaff_x27 = uVar7;
      if (uVar16 <= uVar7) {
        uVar10 = 0;
        if (uVar16 != 0) {
      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if (uVar13 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00ddca0c;
            break;
          }
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00ddca7c;
              }
              goto LAB_00ddc9c4;
            }
          }
  ...
  *plVar15 = 0;
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar12;
    if (*plVar15 == 0) goto LAB_00ddcba0;
