...
/* void std::__ndk1::vector<cocos2d::Properties*, std::__ndk1::allocator<cocos2d::Properties*>
   >::__push_back_slow_path<cocos2d::Properties* const&>(cocos2d::Properties* const&) */
...
__push_back_slow_path<cocos2d::Properties*const&>
          (vector<cocos2d::Properties*,std::__ndk1::allocator<cocos2d::Properties*>> *this,
          Properties **param_1)
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 == 0) {
      ...
      goto LAB_00fb1b44;
                    ...
                    /* try { // try from 00fb1b20 to 010b1b33 has its CatchHandler @ 00fb1d58 */
    if (uVar3 >> 0x3d != 0) {
                    /* WARNING: Subroutine does not return */
