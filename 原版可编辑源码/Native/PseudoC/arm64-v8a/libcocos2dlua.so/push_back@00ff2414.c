...
/* std::__ndk1::__split_buffer<cocos2d::TextureCache::AsyncStruct**,
   std::__ndk1::allocator<cocos2d::TextureCache::AsyncStruct**>&>::push_back(cocos2d::TextureCache::AsyncStruct**&&)
    */
    ...
    if (__src < puVar6 || (long)__src - (long)puVar6 == 0) {
      ...
      *(void **)(this + 0x18) = (void *)((long)pvVar3 + uVar5 * 8);
      ...
      __n = (long)puVar7 - (long)__src;
                    /* try { // try from 00ff2464 to 010f25cf has its CatchHandler @ 00ff2464
                       catch() { ... } // from try @ 00ff2464 with catch @ 00ff2464
                       catch() { ... } // from try @ 00ff25dc with catch @ 00ff2464 */
      if (__n != 0) {
