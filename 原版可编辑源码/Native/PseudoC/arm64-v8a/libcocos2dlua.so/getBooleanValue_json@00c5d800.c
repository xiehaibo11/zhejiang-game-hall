...
/* cocostudio::DictionaryHelper::getBooleanValue_json(rapidjson::GenericValue<rapidjson::UTF8<char>,
   rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator> > const&, char const*, bool) */

bool __thiscall
cocostudio::DictionaryHelper::getBooleanValue_json
          (DictionaryHelper *this,GenericValue *param_1,char *param_2,bool param_3)
...
LAB_00c5da0c:
              if (piVar7 != piVar8 + (ulong)uVar1 * 0xc) {
                return *(short *)((long)piVar7 + 0x2e) == 10;
              }
            }
            else {
