...
/* cocos2d::Vec2::isLineParallel(cocos2d::Vec2 const&, cocos2d::Vec2 const&, cocos2d::Vec2 const&,
   cocos2d::Vec2 const&) */

undefined8 cocos2d::Vec2::isLineParallel(Vec2 *param_1,Vec2 *param_2,Vec2 *param_3,Vec2 *param_4)
  ...
  if ((fVar1 != *(float *)param_2) || (*(float *)(param_1 + 4) != *(float *)(param_2 + 4))) {
    ...
    if (fVar2 * (fVar7 - fVar5) - fVar8 * fVar4 == 0.0) {
      ...
      if ((fVar8 * fVar6 - (fVar1 - fVar3) * (fVar7 - fVar5) != 0.0) &&
         (fVar2 * fVar6 - (fVar1 - fVar3) * fVar4 != 0.0)) {
        return 1;
      }
    }
  }
