...
/* non-virtual thunk to BoneNodeReader::createNodeWithFlatBuffers(flatbuffers::Table const*) */

undefined8 __thiscall BoneNodeReader::createNodeWithFlatBuffers(BoneNodeReader *this,Table *param_1)

{
  ...
  uVar1 = cocostudio::timeline::BoneNode::create();
