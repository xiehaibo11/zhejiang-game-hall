...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<float,
   ...
   std::__ndk1::allocator<cocos2d::Node*> > > > >::rehash(unsigned long) */
...

{
  ...
  undefined8 uVar4;
                    ...
                    /* try { // try from 00fa1b00 to 010a1b07 has its CatchHandler @ 00fa1c18 */
  if (param_1 - 1 == 0) {
    param_1 = 2;
                    /* try { // try from 00fa1b0c to 010a1b13 has its CatchHandler @ 00fa1bec */
  }
  else {
                    /* try { // try from 00fa1b14 to 010a1cd3 has its CatchHandler @ 00fa1ac4 */
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00fa1bb0;
    }
    return;
  }
LAB_00fa1bb0:
