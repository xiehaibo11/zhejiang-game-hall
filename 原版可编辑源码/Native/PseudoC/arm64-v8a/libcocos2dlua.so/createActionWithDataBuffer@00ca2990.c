...
/* cocostudio::timeline::ActionTimelineCache::createActionWithDataBuffer(cocos2d::Data,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&) */

void __thiscall
cocostudio::timeline::ActionTimelineCache::createActionWithDataBuffer
          (ActionTimelineCache *this,Data *param_2,basic_string *param_3)

{
  ...
  if ((lVar1 == 0) || (plVar2 = *(long **)(lVar1 + 0x28), plVar2 == (long *)0x0)) {
    plVar2 = (long *)loadAnimationWithDataBuffer(this,param_2,param_3);
  }
                    /* WARNING: Could not recover jumptable at 0x00ca29e8. Too many branches */
