...
/* void cocos2d::experimental::volumeMulti<3, 6, float, float, float, int, short>(float*, unsigned
   long, float const*, int*, float const*, short) */

void cocos2d::experimental::volumeMulti<3,6,float,float,float,int,short>
