...
/* void std::__ndk1::vector<cocostudio::DecorativeDisplay*,
   std::__ndk1::allocator<cocostudio::DecorativeDisplay*>
   >::__push_back_slow_path<cocostudio::DecorativeDisplay* const&>(cocostudio::DecorativeDisplay*
   const&) */
...
__push_back_slow_path<cocostudio::DecorativeDisplay*const&>
          (vector<cocostudio::DecorativeDisplay*,std::__ndk1::allocator<cocostudio::DecorativeDisplay*>>
           *this,DecorativeDisplay **param_1)
