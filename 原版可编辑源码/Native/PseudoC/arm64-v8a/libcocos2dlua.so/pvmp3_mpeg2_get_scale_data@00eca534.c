...

{
  ...
  local_68 = *(long *)(lVar6 + 0x28);
                    /* try { // try from 00eca564 to 00fca583 has its CatchHandler @ 00eca4cc */
  local_78 = 0;
  local_70 = 0;
                    /* catch() { ... } // from try @ 00eca518 with catch @ 00eca570 */
  ...
  if ((param_3 == 1) && ((*(uint *)(param_4 + 0x20) & 1) != 0)) {
    ...
    if (uVar4 < 0x168) {
      ...
      uVar15 = uVar15 - 0xb4;
                    /* catch() { ... } // from try @ 00eca6fc with catch @ 00eca6bc */
    ...
    uVar17 = uVar4 + 0xc & 0xff;
                    /* try { // try from 00eca6f4 to 00fca6fb has its CatchHandler @ 00eca764 */
    uVar18 = (ulong)uVar17 / 3;
                    /* try { // try from 00eca6fc to 00fca77f has its CatchHandler @ 00eca6bc */
    uVar15 = 0;
    uVar7 = 1;
...
LAB_00eca75c:
  local_70 = CONCAT44(uVar15,(undefined4)local_70);
                    /* catch() { ... } // from try @ 00eca6f4 with catch @ 00eca764 */
...
LAB_00eca774:
  ...
  uVar13 = 0;
  do {
    uVar5 = *(ushort *)(&UNK_01438880 + lVar8 * 4 + lVar9 * 0x10 + lVar14 * 0x30);
...
LAB_00eca85c:
          ...
          if (((short)uVar17 < 1) || (uVar17 - 1 >> 0x10 != 0)) goto LAB_00eca85c;
          iVar11 = (int)uVar13;
          sVar19 = (short)uVar13;
          if ((short)(sVar19 + (short)(uVar17 - 1)) < sVar19) goto LAB_00eca85c;
          uVar17 = uVar15;
          if (uVar15 < 2) {
            uVar17 = 1;
          }
          ...
          if ((param_5 + uVar18 < (ulong)(param_6 + 4 + lVar12)) &&
             (param_6 + uVar18 < (ulong)(param_5 + 4 + lVar12))) goto LAB_00eca85c;
          uVar17 = uVar4 & 0xfff8;
          uVar16 = 0;
          ...
          if (uVar4 == uVar17) goto LAB_00eca884;
        }
        do {
          uVar17 = uVar17 + 1;
          uVar18 = -(uVar13 >> 0xf & 1) & 0xfffffffffffc0000 | (uVar13 & 0xffff) << 2;
