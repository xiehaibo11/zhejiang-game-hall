...
/* flatbuffers::CreateNodeAction(flatbuffers::FlatBufferBuilder&, int, float,
   flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::TimeLine> > >,
   flatbuffers::Offset<flatbuffers::String>) */

undefined4
flatbuffers::CreateNodeAction
          (float param_3,FlatBufferBuilder *param_1,float param_2,int param_4,undefined4 param_5)

{
  ...
  if (param_4 != 0) {
    ...
    if ((fVar1 != 0.0) || (param_1[0x60] != (FlatBufferBuilder)0x0)) {
      ...
      uStack_5c = 8;
      local_60 = (float)((*(int *)(param_1 + 8) - *(int *)(param_1 + 0x18)) +
                        *(int *)(param_1 + 0x10));
  ...
  if ((param_3 != 0.0) || (param_1[0x60] != (FlatBufferBuilder)0x0)) {
    local_60 = param_3;
    FlatBufferBuilder::Align(param_1,4);
    FlatBufferBuilder::PushBytes(param_1,(uchar *)&local_60,4);
    uStack_5c = 6;
    local_60 = (float)((*(int *)(param_1 + 8) - *(int *)(param_1 + 0x18)) + *(int *)(param_1 + 0x10)
                      );
    puVar2 = *(undefined8 **)(param_1 + 0x30);
    if (puVar2 == *(undefined8 **)(param_1 + 0x38)) {
      std::__ndk1::
  ...
  if ((param_2 != 0.0) || (param_1[0x60] != (FlatBufferBuilder)0x0)) {
    local_60 = param_2;
    FlatBufferBuilder::Align(param_1,4);
    FlatBufferBuilder::PushBytes(param_1,(uchar *)&local_60,4);
    uStack_5c = 4;
