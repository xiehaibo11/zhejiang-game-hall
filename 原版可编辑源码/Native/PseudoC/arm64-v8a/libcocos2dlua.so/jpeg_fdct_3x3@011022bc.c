...

{
  ...
  long lVar18;
                    ...
                    /* try { // try from 011022c0 to 012022c7 has its CatchHandler @ 01102324 */
                    /* try { // try from 011022c8 to 0120233f has its CatchHandler @ 0110229c */
  ...
  iVar1 = ((int)lVar7 + (uint)bVar6) * 0x10 + -0x1800;
                    /* catch() { ... } // from try @ 011022c0 with catch @ 01102324 */
