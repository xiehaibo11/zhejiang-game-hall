...
LAB_00ac95ec:
      ...
      if ((param_5 & 7) != 0) goto LAB_00ac95ec;
    }
    uVar4 = *(uint *)((long)&param_1[1].cert + 4);
  }
  ...
  if (((param_1->ctx == (SSL_CTX *)0x0) || (param_1->generate_session_id == (GEN_SESSION_CB)0x0)) ||
    ...
    local_b80 = 0;
    if (param_1->generate_session_id != (GEN_SESSION_CB)0x0 && param_6 == 0) goto LAB_00ac96dc;
LAB_00ac96e8:
    local_b84 = 0;
    if (param_6 != 0) goto LAB_00ac96f4;
LAB_00ac9790:
    if (local_b84 == 0) {
      if (param_5 != 0) {
        uVar11 = uVar19;
    ...
    if (param_6 != 0) goto LAB_00ac96e8;
LAB_00ac96dc:
    lVar10 = *(long *)&param_1->read_ahead;
    if (*(int *)(lVar10 + 0xd4) != 0) goto LAB_00ac96e8;
    local_b84 = 0;
    ...
    *(undefined4 *)(lVar10 + 0xd4) = 1;
    if (param_6 == 0) goto LAB_00ac9790;
LAB_00ac96f4:
  ...
  if (param_5 == 0) {
    ...
    do {
      ...
      *(uchar **)(puVar23 + 8) = param_3->oiv + ((ulong)uVar24 - 0x18);
      ...
      if (*(long *)(param_1->sid_ctx + 0x1c) == 0) {
        ...
        memcpy(puVar21 + iVar5,param_3->oiv + ((ulong)uVar24 - 0x18),(ulong)uVar4);
                    /* try { // try from 00ac9ae8 to 00bc9afb has its CatchHandler @ 00ac9b80 */
        puVar21 = (undefined1 *)*plVar14;
        *(undefined8 *)(puVar23 + 8) = *(undefined8 *)(puVar23 + 6);
      }
      else {
                    /* try { // try from 00ac9ab4 to 00bc9ae7 has its CatchHandler @ 00ac9bb4 */
        iVar6 = ssl3_do_compress(param_1,puVar23);
        if (iVar6 == 0) goto LAB_00ac9c84;
      ...
      *plVar17 = (long)puVar21;
                    /* try { // try from 00ac9b00 to 00bc9b33 has its CatchHandler @ 00ac9b84 */
      if (iVar5 != 0) {
    ...
    do {
      ...
      *puVar21 = (char)param_2;
      puVar23[1] = param_2;
      iVar6 = param_1->version;
                    /* try { // try from 00ac98a4 to 00bc98ef has its CatchHandler @ 00ac98a4
                       catch() { ... } // from try @ 00ac98a4 with catch @ 00ac98a4
                       catch() { ... } // from try @ 00ac98f4 with catch @ 00ac98a4 */
      *plVar14 = (long)(puVar21 + 2);
      puVar21[1] = (char)((uint)iVar6 >> 8);
      iVar6 = SSL_get_state(param_1);
      if (((iVar6 == 0xc) && (param_1[1].init_off == 0)) &&
         ((uVar4 = SSL_version(param_1), (uVar4 & 0xffffff00) == 0x300 &&
          (iVar6 = SSL_version(param_1), 0x301 < iVar6)))) {
        uVar8 = 1;
                    /* try { // try from 00ac98f0 to 00bc98f3 has its CatchHandler @ 00ac9928 */
      }
      else {
                    /* try { // try from 00ac98f4 to 00bc993b has its CatchHandler @ 00ac98a4 */
        uVar8 = (undefined1)param_1->version;
      }
      puVar21[2] = uVar8;
      local_260[uVar11] = (long)(puVar21 + 3);
      ...
      *(undefined1 **)(puVar23 + 6) = puVar21 + iVar5;
      uVar4 = *(uint *)(param_4 + uVar11 * 4);
                    /* catch() { ... } // from try @ 00ac98f0 with catch @ 00ac9928 */
      *(uchar **)(puVar23 + 8) = param_3->oiv + ((ulong)uVar24 - 0x18);
      puVar23[2] = uVar4;
      if (*(long *)(param_1->sid_ctx + 0x1c) == 0) {
        memcpy(puVar21 + iVar5,param_3->oiv + ((ulong)uVar24 - 0x18),(ulong)uVar4);
        *(undefined8 *)(puVar23 + 8) = *(undefined8 *)(puVar23 + 6);
                    ...
                    /* try { // try from 00ac993c to 00bc9ab3 has its CatchHandler @ 00ac993c
                       catch() { ... } // from try @ 00ac993c with catch @ 00ac993c
                       catch() { ... } // from try @ 00ac9b34 with catch @ 00ac993c */
        iVar6 = ssl3_do_compress(param_1,puVar23);
        if (iVar6 == 0) goto LAB_00ac9c84;
      }
    ...
    if (local_b80 == 0) {
      ...
      do {
        ...
        *puVar21 = (char)(*puVar20 >> 8);
        ...
        puVar20[-1] = param_2;
        *puVar20 = uVar4 + 5;
        if (param_6 != 0) goto LAB_00ac9d58;
        uVar11 = uVar11 + 1;
        ...
        *(uint *)((long)&param_1->version + lVar10) = uVar4 + 5 + local_b84;
        lVar10 = lVar10 + 0x20;
                    ...
                    /* catch() { ... } // from try @ 00ac9ae8 with catch @ 00ac9b80 */
      uVar11 = 0;
                    /* catch() { ... } // from try @ 00ac9b00 with catch @ 00ac9b84 */
      lVar10 = 0x3f4;
      puVar20 = local_b58;
      do {
        if ((*(byte *)(*(long *)&param_1->read_ahead + 1) & 1) == 0) {
          ...
          puVar22 = puVar20;
                    ...
                    /* catch() { ... } // from try @ 00ac9ab4 with catch @ 00ac9bb4 */
