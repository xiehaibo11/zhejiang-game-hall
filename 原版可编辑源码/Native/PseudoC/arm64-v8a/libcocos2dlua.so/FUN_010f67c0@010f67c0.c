...
void FUN_010f67c0(long param_1)

{
  ...
  if ((*(int *)(param_1 + 0x15c) != 0) && (iVar5 = *(int *)(lVar10 + 0xe4), iVar5 != 0)) {
    ...
    if (*(int *)(lVar10 + 0xc0) == 0) {
      ...
      FUN_010f97a4(lVar10,*(undefined4 *)(lVar7 + (long)(int)uVar1 * 4),
    ...
    if (iVar3 != 0) {
      FUN_010f97a4(lVar10,*(undefined4 *)(lVar10 + 0xe4),iVar3);
    }
  ...
  if (0 < *(int *)(param_1 + 0x174)) {
    ...
    do {
      ...
      if (((*(int *)(param_1 + 0x1cc) == 0) && (*(int *)(param_1 + 0x1d4) == 0)) &&
        ...
        FUN_010f94d0(param_1,lVar4,*(undefined8 *)(lVar10 + lVar15 * 8 + 0x80));
      ...
      if ((iVar5 != 0) &&
        ...
        FUN_010f94d0(param_1,lVar15,*(undefined8 *)(lVar10 + lVar14 * 8 + 0xa0));
