...

{
  ...
  EVP_MD_CTX *pEVar2;
                    ...
                    /* try { // try from 00ad9c4c to 00bd9c63 has its CatchHandler @ 00ad9cd4 */
  if (*param_1 != 0) {
    EVP_MD_CTX_free();
  }
  *param_1 = 0;
  ...
  if (ctx != (EVP_MD_CTX *)0x0) {
    if (param_2 == (EVP_MD *)0x0) {
      return ctx;
                    ...
                    /* try { // try from 00ad9c70 to 00bd9c83 has its CatchHandler @ 00ad9cd0 */
    iVar1 = EVP_DigestInit_ex(ctx,param_2,(ENGINE *)0x0);
    pEVar2 = (EVP_MD_CTX *)*param_1;
                    /* try { // try from 00ad9c84 to 00bd9cef has its CatchHandler @ 00ad9c04 */
    if (0 < iVar1) {
      return pEVar2;
    }
  }
