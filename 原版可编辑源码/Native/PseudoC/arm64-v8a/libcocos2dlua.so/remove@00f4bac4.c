...

{
  ...
  if (uVar6 < 2) {
                    /* try { // try from 00f4baf8 to 0104bb0f has its CatchHandler @ 00f4d5b4 */
    uVar4 = uVar3 - 1 & uVar4;
  }
  else {
    uVar7 = 0;
  ...
  do {
    ...
    plVar2 = (long *)*plVar5;
                    ...
                    /* try { // try from 00f4bb20 to 0104bb27 has its CatchHandler @ 00f4d518 */
  if (plVar5 != param_2 + 2) {
    uVar7 = plVar5[1];
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
      ...
      uVar7 = uVar7 - uVar1 * uVar3;
                    /* try { // try from 00f4bb44 to 0104bb4b has its CatchHandler @ 00f4d4e0 */
    }
                    /* try { // try from 00f4bb58 to 0104bb6f has its CatchHandler @ 00f4d51c */
    if (uVar7 == uVar4) goto LAB_00f4bba0;
  }
  if (*param_3 != 0) {
...
LAB_00f4bba0:
  ...
  *plVar5 = *param_3;
                    /* try { // try from 00f4bbf4 to 0104bbff has its CatchHandler @ 00f4d5e8 */
  *param_3 = 0;
  param_2[3] = param_2[3] + -1;
  *param_1 = param_3;
  param_1[1] = param_2 + 2;
  *(undefined1 *)(param_1 + 2) = 1;
                    /* try { // try from 00f4bc0c to 0104bc0f has its CatchHandler @ 00f4d534 */
  return;
}
