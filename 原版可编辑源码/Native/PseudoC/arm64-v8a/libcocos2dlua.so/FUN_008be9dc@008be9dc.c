...
undefined8 FUN_008be9dc(undefined8 param_1)

{
  ...
  if (((iVar2 == 0) || (iVar2 = tolua_isnumber(param_1,2,0,auStack_48), iVar2 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glBindBuffer\'.",auStack_48);
  }
  else {
    dVar3 = (double)tolua_tonumber(0,param_1,1);
    dVar4 = (double)tolua_tonumber(0,param_1,2);
                    /* try { // try from 008bea64 to 009bea6f has its CatchHandler @ 008beda0 */
    glBindBuffer((int)dVar3,(int)dVar4);
  }
