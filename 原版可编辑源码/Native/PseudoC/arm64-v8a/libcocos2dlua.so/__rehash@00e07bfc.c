...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, double> > >::__rehash(unsigned
   long) */
...

{
  ...
  if (param_1 == 0) {
                    /* catch() { ... } // from try @ 00e07b08 with catch @ 00e07ca4 */
    pvVar8 = *(void **)this;
    *(undefined8 *)this = 0;
    if (pvVar8 != (void *)0x0) {
    ...
    *(undefined8 *)(this + 8) = 0;
                    /* catch() { ... } // from try @ 00e07b00 with catch @ 00e07cb8 */
  }
  else {
    if (param_1 >> 0x3d != 0) {
    ...
    *(ulong *)(this + 8) = param_1;
    ...
    if (plVar15 != (long *)0x0) {
      ...
      uVar13 = CONCAT62((int6)((ulong)uVar19 >> 0x10),uVar18) & 0xffffffff;
                    /* catch() { ... } // from try @ 00e07be4 with catch @ 00e07c88 */
      if (uVar13 < 2) {
        uVar10 = uVar10 & param_1 - 1;
      }
      else if (param_1 <= uVar10) {
                    /* catch() { ... } // from try @ 00e07bdc with catch @ 00e07c98 */
        uVar17 = 0;
        if (param_1 != 0) {
          uVar17 = uVar10 / param_1;
        }
                    /* catch() { ... } // from try @ 00e07bd4 with catch @ 00e07c9c */
        uVar10 = uVar10 - uVar17 * param_1;
                    /* catch() { ... } // from try @ 00e07bcc with catch @ 00e07ca0 */
      }
                    /* catch() { ... } // from try @ 00e07b88 with catch @ 00e07cc4 */
                    /* catch() { ... } // from try @ 00e07b5c with catch @ 00e07cc8 */
      *(__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,double>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,double>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,double>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,double>>>
        **)(*(long *)this + uVar10 * 8) = this + 0x10;
                    /* catch() { ... } // from try @ 00e07b30 with catch @ 00e07ccc */
                    /* catch() { ... } // from try @ 00e07bb4 with catch @ 00e07cd0 */
      if ((long *)*plVar15 != (long *)0x0) {
        ...
        do {
          ...
          if (uVar17 != uVar10) {
                    /* catch() { ... } // from try @ 00e07d60 with catch @ 00e07d30 */
            if (*(long *)(*(long *)this + uVar17 * 8) == 0) {
              *(long **)(*(long *)this + uVar17 * 8) = plVar15;
              ...
              if (plVar11 != (long *)0x0) {
                ...
                __n = (ulong)(bVar2 >> 1);
                    /* try { // try from 00e07d58 to 00f07d5f has its CatchHandler @ 00e07e50 */
                if ((bVar2 & 1) != 0) {
                  __n = plVar16[3];
                }
                do {
                  ...
                  if ((bVar2 & 1) == 0) {
                    while (sVar6 != 0) {
                      if (*pcVar5 != *__s2) goto LAB_00e07e04;
                      __s2 = __s2 + 1;
                      sVar3 = sVar3 - 1;
                      pcVar5 = pcVar5 + 1;
                      sVar6 = sVar3;
                    ...
                    /* try { // try from 00e07d60 to 00f07e6b has its CatchHandler @ 00e07d30 */
...
LAB_00e07e04:
          ...
          plVar16 = plVar11;
                    ...
                    /* catch() { ... } // from try @ 00e07d58 with catch @ 00e07e50 */
  return;
}
