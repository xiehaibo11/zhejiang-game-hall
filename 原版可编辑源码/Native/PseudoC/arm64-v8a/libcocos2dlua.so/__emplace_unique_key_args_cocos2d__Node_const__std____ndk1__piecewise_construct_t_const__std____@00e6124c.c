...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<cocos2d::Node
   const*, unsigned long>, void*>*>, bool>
   std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<cocos2d::Node const*, unsigned long>,
   std::__ndk1::__unordered_map_hasher<cocos2d::Node const*,
   std::__ndk1::__hash_value_type<cocos2d::Node const*, unsigned long>,
   std::__ndk1::hash<cocos2d::Node const*>, true>, std::__ndk1::__unordered_map_equal<cocos2d::Node
   const*, std::__ndk1::__hash_value_type<cocos2d::Node const*, unsigned long>,
   std::__ndk1::equal_to<cocos2d::Node const*>, true>,
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<cocos2d::Node const*, unsigned long> >
   >::__emplace_unique_key_args<cocos2d::Node const*, std::__ndk1::piecewise_construct_t const&,
   std::__ndk1::tuple<cocos2d::Node const*&&>, std::__ndk1::tuple<> >(cocos2d::Node const* const&,
...

{
  ...
  undefined2 uVar10;
                    ...
                    /* try { // try from 00e6125c to 00f6126f has its CatchHandler @ 00e61344 */
  uVar2 = *(ulong *)param_2;
                    /* try { // try from 00e61270 to 00f612df has its CatchHandler @ 00e6118c */
  ...
  if (pNVar8 != (Node *)0x0) {
    ...
    if (uVar6 < 2) {
                    /* try { // try from 00e612e0 to 00f612f3 has its CatchHandler @ 00e61334 */
    ...
    if (*(long **)(*param_1 + (long)unaff_x24 * 8) != (long *)0x0) {
                    /* try { // try from 00e612f4 to 00f61363 has its CatchHandler @ 00e6118c */
      for (pNVar7 = (Node *)**(long **)(*param_1 + (long)unaff_x24 * 8); pNVar7 != (Node *)0x0;
          pNVar7 = *(Node **)pNVar7) {
        pNVar5 = *(Node **)(pNVar7 + 8);
        if (pNVar5 != pNVar9) {
                    /* catch() { ... } // from try @ 00e612e0 with catch @ 00e61334 */
          if (uVar6 < 2) {
            ...
            if (pNVar8 != (Node *)0x0) {
              uVar1 = (ulong)pNVar5 / (ulong)pNVar8;
                    ...
                    /* catch() { ... } // from try @ 00e6125c with catch @ 00e61344 */
            if (pNVar5 + -(uVar1 * (long)pNVar8) == unaff_x24) goto LAB_00e61310;
            break;
          }
...
LAB_00e61310:
  ...
  *(undefined8 *)(pNVar7 + 0x18) = 0;
  if ((pNVar8 == (Node *)0x0) || (*(float *)(param_1 + 4) * (float)pNVar8 < (float)(param_1[3] + 1))
    ...
    rehash((__hash_table<std::__ndk1::__hash_value_type<cocos2d::Node_const*,unsigned_long>,std::__ndk1::__unordered_map_hasher<cocos2d::Node_const*,std::__ndk1::__hash_value_type<cocos2d::Node_const*,unsigned_long>,std::__ndk1::hash<cocos2d::Node_const*>,true>,std::__ndk1::__unordered_map_equal<cocos2d::Node_const*,std::__ndk1::__hash_value_type<cocos2d::Node_const*,unsigned_long>,std::__ndk1::equal_to<cocos2d::Node_const*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<cocos2d::Node_const*,unsigned_long>>>
            *)param_1,uVar6);
    pNVar8 = param_1[1];
  ...
  if (pNVar9 == (Node *)0x0) {
    ...
    *(Node ***)(pNVar5 + (long)unaff_x24 * 8) = ppNVar4;
    if (*(long *)pNVar7 == 0) goto LAB_00e61464;
