...
/* flatbuffers::CreateTabItemOption(flatbuffers::FlatBufferBuilder&,
   flatbuffers::Offset<flatbuffers::TabHeaderOption>, flatbuffers::Offset<flatbuffers::NodeTree>) */

undefined4 flatbuffers::CreateTabItemOption(FlatBufferBuilder *param_1,int param_2,int param_3)
