...
void FUN_01136270(long param_1,undefined8 param_2,uint param_3)

{
  ...
  uVar4 = 0;
  do {
    iVar2 = FUN_011368ac(param_2,uVar4,param_3);
    FUN_01136a28(param_1,iVar2,TIFFFaxWhiteCodes);
    uVar4 = iVar2 + uVar4;
    if (param_3 <= uVar4) break;
    iVar2 = FUN_01136dac(param_2,uVar4,param_3);
    FUN_01136a28(param_1,iVar2,TIFFFaxBlackCodes);
    uVar4 = iVar2 + uVar4;
  } while (uVar4 < param_3);
  uVar4 = *(uint *)(lVar5 + 4);
  if ((uVar4 & 0xc) != 0) {
