...
void FUN_00900068(long param_1,undefined8 *param_2)

{
  ...
  if (pvVar4 == (void *)0x0) {
    piVar1 = (int *)0x0;
                    ...
                    /* try { // try from 009000a0 to 00a000cf has its CatchHandler @ 008ffff8 */
  toluafix_pushusertype_ccobject(*(lua_State **)(param_1 + 8),iVar3,piVar1,pvVar4,"cc.Sprite3D");
  lVar2 = cocos2d::LuaEngine::getInstance();
                    /* WARNING: Could not recover jumptable at 0x009000c8. Too many branches */
