...
void FUN_0089eb18(undefined8 param_1)

{
  ...
  if ((iVar2 == 0) || (iVar2 = tolua_isnoobj(param_1,2,auStack_48), iVar2 == 0)) {
    tolua_error(param_1,"#ferror in function \'uintValue\'.",auStack_48);
    uVar4 = 0;
  }
  else {
    this = (__String *)tolua_tousertype(param_1,1,0);
    if (this == (__String *)0x0) {
      tolua_error(param_1,"invalid \'self\' in function \'uintValue\'",0);
    }
    uVar3 = cocos2d::__String::uintValue(this);
