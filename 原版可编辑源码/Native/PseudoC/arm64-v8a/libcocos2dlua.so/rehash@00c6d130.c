...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<cocos2d::Ref*, void
   (cocos2d::Ref::*)(cocostudio::Armature*, cocostudio::MovementEventType,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&)>, std::__ndk1::__unordered_map_hasher<cocos2d::Ref*,
   std::__ndk1::__hash_value_type<cocos2d::Ref*, void (cocos2d::Ref::*)(cocostudio::Armature*,
   cocostudio::MovementEventType, std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&)>, std::__ndk1::hash<cocos2d::Ref*>, true>,
   std::__ndk1::__unordered_map_equal<cocos2d::Ref*, std::__ndk1::__hash_value_type<cocos2d::Ref*,
   void (cocos2d::Ref::*)(cocostudio::Armature*, cocostudio::MovementEventType,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&)>, std::__ndk1::equal_to<cocos2d::Ref*>, true>,
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<cocos2d::Ref*, void
   (cocos2d::Ref::*)(cocostudio::Armature*, cocostudio::MovementEventType,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
...
::rehash(__hash_table<std::__ndk1::__hash_value_type<cocos2d::Ref*,void(cocos2d::Ref::*)(cocostudio::Armature*,cocostudio::MovementEventType,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&)>,std::__ndk1::__unordered_map_hasher<cocos2d::Ref*,std::__ndk1::__hash_value_type<cocos2d::Ref*,void(cocos2d::Ref::*)(cocostudio::Armature*,cocostudio::MovementEventType,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&)>,std::__ndk1::hash<cocos2d::Ref*>,true>,std::__ndk1::__unordered_map_equal<cocos2d::Ref*,std::__ndk1::__hash_value_type<cocos2d::Ref*,void(cocos2d::Ref::*)(cocostudio::Armature*,cocostudio::MovementEventType,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&)>,std::__ndk1::equal_to<cocos2d::Ref*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<cocos2d::Ref*,void(cocos2d::Ref::*)(cocostudio::Armature*,cocostudio::MovementEventType,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&)>>>
         *this,ulong param_1)

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00c6d1f4;
    }
    return;
  }
LAB_00c6d1f4:
