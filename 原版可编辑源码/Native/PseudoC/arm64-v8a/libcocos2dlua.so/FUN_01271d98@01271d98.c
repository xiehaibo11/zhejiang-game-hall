...
void FUN_01271d98(void *param_1,long *param_2)

{
  ...
  if ((((local_80 >> 0x3e & 1) == 0) || (local_49 == '\0')) && (local_2c8 == 0)) {
    FUN_01270be4(alStack_3c0,*(undefined8 *)((long)param_1 + 0x310),auStack_3d0);
  }
...
LAB_01271ee0:
    ...
    lVar2 = FUN_01270978(param_2[199],&local_3c8);
    lVar2 = FUN_012717e4(lVar2,lVar2 + local_3c8,alStack_3c0,0);
  }
  *(long *)((long)param_1 + 0x310) = lVar2;
  ...
  do {
    ...
    case 2:
      ...
      break;
    case 3:
      lVar3 = FUN_01270978(*plVar6,&local_3c8);
      lVar3 = FUN_012717e4(lVar3,lVar3 + local_3c8,alStack_3c0,lVar2);
      break;
    case 4:
      lVar3 = lVar2 + *plVar6;
      goto LAB_01271ed0;
    case 5:
      ...
      lVar3 = FUN_012717e4(lVar3,lVar3 + local_3c8,alStack_3c0,lVar2);
LAB_01271ed0:
      if ((byte)(&DAT_01795be0)[lVar4] < 9) {
        *puVar5 = 1;
        goto LAB_01271f50;
      }
      goto LAB_01271ee0;
    default:
      goto switchD_01271ea8_default;
    }
    if ((*(ulong *)((long)param_1 + 0x340) >> 0x3e & 1) != 0) {
      *puVar5 = 0;
    }
