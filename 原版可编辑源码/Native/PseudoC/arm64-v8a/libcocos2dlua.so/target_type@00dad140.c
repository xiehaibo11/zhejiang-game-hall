...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void
   ...
   cocos2d::ui::Widget*)>::target_type() const */
...
{
  return &__bind<void(cocos2d::ui::Widget::*)(cocos2d::ui::Widget*,cocos2d::ui::Widget*),cocos2d::ui::Widget*,std::__ndk1::placeholders::__ph<1>const&,std::__ndk1::placeholders::__ph<2>const&>
          ::typeinfo;
}
