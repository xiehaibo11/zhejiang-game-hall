...
/* fairygui::ScrollPane::setPosX(float, bool) */

void __thiscall fairygui::ScrollPane::setPosX(ScrollPane *this,float param_1,bool param_2)

{
  ...
  if (*(int *)(this + 0xc0) == 1) {
    loopCheckingNewPos(this,&local_24,0);
    param_1 = local_24;
  }
  ...
  if (local_24 == *(float *)(this + 0x5c)) {
    return;
  }
  *(float *)(this + 0x5c) = local_24;
  if (*(int *)(this + 0xbc) == 1) {
    if (param_2) goto LAB_00a9362c;
    uVar3 = 0xffffffff;
  }
  else {
    if (*(int *)(this + 0xbc) != 0) goto LAB_00a9362c;
    uVar3 = 0xffffffff;
    if (param_2) {
      uVar3 = 1;
    }
