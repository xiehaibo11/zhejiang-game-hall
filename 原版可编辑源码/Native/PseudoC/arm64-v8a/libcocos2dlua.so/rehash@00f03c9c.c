...

{
  ...
  undefined8 uVar4;
                    ...
                    /* catch() { ... } // from try @ 00f03bf4 with catch @ 00f03cb0 */
  if (param_1 - 1 == 0) {
    param_1 = 2;
  }
  else if ((param_1 & param_1 - 1) != 0) {
                    /* catch() { ... } // from try @ 00f03be4 with catch @ 00f03cd0 */
    param_1 = __next_prime(param_1);
                    /* catch() { ... } // from try @ 00f03af0 with catch @ 00f03cd4 */
  }
  uVar2 = *(ulong *)(this + 8);
  if (param_1 <= uVar2) {
                    /* try { // try from 00f03cf0 to 01003d7b has its CatchHandler @ 00f03cf0
                       catch() { ... } // from try @ 00f03cf0 with catch @ 00f03cf0
                       catch() { ... } // from try @ 00f03da4 with catch @ 00f03cf0
                       catch() { ... } // from try @ 00f03df8 with catch @ 00f03cf0
                       catch() { ... } // from try @ 00f03e58 with catch @ 00f03cf0 */
    if (param_1 < uVar2) {
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00f03d60;
    }
                    /* try { // try from 00f03d7c to 01003d87 has its CatchHandler @ 00f03ee0 */
    return;
  }
LAB_00f03d60:
