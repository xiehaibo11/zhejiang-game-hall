...
{
  return &__bind<cocos2d::Node*(cocos2d::CSLoader::*)(rapidjson::GenericValue<rapidjson::UTF8<char>,rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator>>const&),cocos2d::CSLoader*,std::__ndk1::placeholders::__ph<1>const&>
          ::typeinfo;
}
