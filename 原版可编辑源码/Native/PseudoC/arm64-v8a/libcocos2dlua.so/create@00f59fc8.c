...
/* cocos2d::TransitionMoveInB::create(float, cocos2d::Scene*) */

Scene * cocos2d::TransitionMoveInB::create(float param_1,Scene *param_2)

{
  ...
  if (this != (Scene *)0x0) {
    ...
    *(undefined ***)this = &PTR__TransitionMoveInR_01715238;
    *(undefined ***)(this + 0x388) = &PTR__TransitionMoveInB_017157a8;
