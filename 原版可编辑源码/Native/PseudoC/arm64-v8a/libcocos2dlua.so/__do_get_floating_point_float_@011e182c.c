...

{
  ...
  local_1d8 = local_190;
  local_1d0 = pcVar8;
  if (param_2 != (long *)0x0) goto LAB_011e18ec;
LAB_011e1900:
  bVar2 = true;
  if (param_3 != (long *)0x0) goto LAB_011e192c;
  do {
    param_3 = (long *)0x0;
    if (bVar2) {
LAB_011e1a58:
      ...
      uVar9 = FUN_01208d8c(pcVar8,local_1d0,param_5);
      *param_6 = uVar9;
      __check_grouping(local_1b0,local_190,local_1d8,(uint *)param_5);
      if (param_2 == (long *)0x0) {
        bVar2 = true;
        if (param_3 == (long *)0x0) goto LAB_011e1ae8;
LAB_011e1b14:
        ...
        if (bVar2 != (iVar4 == -1)) goto LAB_011e1b58;
      }
      else {
        ...
        param_2 = plVar7;
        if (param_3 != (long *)0x0) goto LAB_011e1b14;
LAB_011e1ae8:
        if (!bVar2) goto LAB_011e1b58;
      }
      *param_5 = *param_5 | 2;
LAB_011e1b58:
      if ((local_1c8 & 1) != 0) {
    ...
    while( true ) {
      ...
      plVar7 = param_2;
      if (param_2 == (long *)0x0) goto LAB_011e1900;
LAB_011e18ec:
