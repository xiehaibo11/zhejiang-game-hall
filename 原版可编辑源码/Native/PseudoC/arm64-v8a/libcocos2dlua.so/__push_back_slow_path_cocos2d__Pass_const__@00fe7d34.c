...
/* void std::__ndk1::vector<cocos2d::Pass*, std::__ndk1::allocator<cocos2d::Pass*>
   >::__push_back_slow_path<cocos2d::Pass* const&>(cocos2d::Pass* const&) */

void __thiscall
std::__ndk1::vector<cocos2d::Pass*,std::__ndk1::allocator<cocos2d::Pass*>>::
__push_back_slow_path<cocos2d::Pass*const&>
          (vector<cocos2d::Pass*,std::__ndk1::allocator<cocos2d::Pass*>> *this,Pass **param_1)
