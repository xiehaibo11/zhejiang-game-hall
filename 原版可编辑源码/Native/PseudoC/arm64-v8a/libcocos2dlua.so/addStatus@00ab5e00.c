...
/* fairygui::GearXY::addStatus(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&, fairygui::ByteBuffer*) */

void __thiscall fairygui::GearXY::addStatus(GearXY *this,basic_string *param_1,ByteBuffer *param_2)

{
  ...
  if (uVar1 == 0) {
    ...
    *(ulong *)(this + 0x50) = CONCAT44(fStack_54,local_58);
  }
  else {
    local_40 = param_1;
    lVar4 = std::__ndk1::
    ...
    *(undefined8 *)(lVar4 + 0x30) = uStack_50;
