...
LAB_01108568:
      ...
      iVar9 = (iVar25 + iVar4) * 0x2000;
                    /* try { // try from 011085a0 to 012085ff has its CatchHandler @ 011085a0
                       catch() { ... } // from try @ 011085a0 with catch @ 011085a0
                       catch() { ... } // from try @ 01108604 with catch @ 011085a0 */
      ...
      *pbVar2 = *(byte *)(lVar16 + ((ulong)((uint)(iVar19 + iVar20) >> 0x12) & 0x3ff));
      ...
      pbVar2[7] = *(byte *)(lVar16 + ((ulong)((uint)(iVar20 - iVar19) >> 0x12) & 0x3ff));
                    /* try { // try from 01108600 to 01208603 has its CatchHandler @ 01108614 */
                    /* try { // try from 01108604 to 0120863b has its CatchHandler @ 011085a0 */
      iVar25 = iVar25 - iVar27;
                    /* catch() { ... } // from try @ 01108600 with catch @ 01108614 */
    ...
    pbVar2[lVar24] = bVar7;
    if (lVar21 == 0x40) {
                    /* try { // try from 01108690 to 01208693 has its CatchHandler @ 011086c8 */
      return;
    }
  } while( true );
}
