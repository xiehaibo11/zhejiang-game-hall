...
void FUN_0125df10(long param_1,undefined8 param_2)

{
  ...
  if (8 < (*(long *)(param_1 + 0x18) - (long)pbVar7) + 1U) {
    ...
    uStack_40 = 0;
    local_50 = 0;
    iVar11 = FUN_0125e0a8((double)local_58[0],&local_50,0x18,0x18,&DAT_014a8005);
    FUN_01258064(param_2,&local_50,(long)&local_50 + (long)iVar11);
  }
