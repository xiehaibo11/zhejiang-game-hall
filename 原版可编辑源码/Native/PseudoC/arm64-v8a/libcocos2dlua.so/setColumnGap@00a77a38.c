...
/* fairygui::GList::setColumnGap(int) */

void __thiscall fairygui::GList::setColumnGap(GList *this,int param_1)

{
  long lVar1;
  ulong uVar2;
  
                    /* try { // try from 00a77a38 to 00b77a63 has its CatchHandler @ 00a77b4c */
  if (*(int *)(this + 0x2f4) != param_1) {
    *(int *)(this + 0x2f4) = param_1;
    GComponent::setBoundsChangedFlag((GComponent *)this);
    if (this[0x338] != (GList)0x0) {
                    /* try { // try from 00a77a64 to 00b77af3 has its CatchHandler @ 00a777d8 */
