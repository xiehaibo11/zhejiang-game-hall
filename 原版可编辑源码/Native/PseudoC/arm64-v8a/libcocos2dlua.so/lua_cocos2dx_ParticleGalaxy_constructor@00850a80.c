...
/* lua_cocos2dx_ParticleGalaxy_constructor(lua_State*) */

bool lua_cocos2dx_ParticleGalaxy_constructor(lua_State *param_1)
  ...
  if (iVar1 == 0) {
    ...
    *(undefined ***)(this + 0x2f8) = &PTR__ParticleGalaxy_0170a720;
    ...
    toluafix_pushusertype_ccobject
              (param_1,*(int *)(this + 0xc),(int *)(this + 0x10),this,"cc.ParticleGalaxy");
  }
  else {
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "cc.ParticleGalaxy:ParticleGalaxy",iVar1,0);
  }
  return iVar1 == 0;
}
