...
/* bool array_to_vector_t_deprecated<cocos2d::FiniteTimeAction*>(cocos2d::__Array&,
   cocos2d::Vector<cocos2d::FiniteTimeAction*>&) */

bool array_to_vector_t_deprecated<cocos2d::FiniteTimeAction*>(__Array *param_1,Vector *param_2)
      ...
      do {
        ...
        if ((lVar4 != 0) &&
           (pRVar5 = (Ref *)__dynamic_cast(lVar4,&cocos2d::Ref::typeinfo,
                                           &cocos2d::FiniteTimeAction::typeinfo,0),
           pRVar5 != (Ref *)0x0)) {
          ...
          if (plVar9 == *(long **)(param_2 + 0x10)) {
            ...
            __push_back_slow_path<cocos2d::FiniteTimeAction*const&>
                      ((vector<cocos2d::FiniteTimeAction*,std::__ndk1::allocator<cocos2d::FiniteTimeAction*>>
                        *)param_2,(FiniteTimeAction **)&local_60);
          }
          else {
            *plVar9 = (long)pRVar5;
