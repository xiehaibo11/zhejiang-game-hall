      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if (uVar14 < 2) {
            ...
            if (uVar10 - uVar4 * uVar17 == unaff_x27) goto LAB_007c4e68;
            break;
          }
...
LAB_007c4e68:
        ...
        if (sVar1 == __n) {
          ...
          if ((bVar3 & 1) == 0) {
            plVar11 = (long *)((long)plVar16 + 0x11);
          }
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              uVar10 = 0;
              while (*(piecewise_construct_t *)((long)plVar16 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_007c4ed8;
              }
              goto LAB_007c4e20;
            }
          }
          else if (__n != 0) {
            uVar6 = memcmp(plVar11,ppVar2,__n);
            plVar11 = (long *)(ulong)uVar6;
            if (uVar6 != 0) goto LAB_007c4e20;
          }
LAB_007c4ed8:
          uVar8 = 0;
          goto LAB_007c501c;
...
LAB_007c4e20:
  ...
  *plVar16 = 0;
  ...
  if ((uVar17 == 0) ||
    ...
    uVar14 = (ulong)((float)(*(long *)(param_1 + 0x18) + 1) / *(float *)(param_1 + 0x20));
    if (uVar14 <= uVar17) {
      uVar14 = uVar17;
    }
    plVar11 = (long *)rehash((__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>>>
                              *)param_1,uVar14);
    uVar17 = *(ulong *)(param_1 + 8);
    if ((uVar17 & uVar17 - 1) == 0) {
      ...
      if (uVar17 <= uVar7) {
        ...
        unaff_x27 = uVar7 - uVar14 * uVar17;
      }
    }
  }
  lVar15 = *(long *)param_1;
  plVar12 = *(long **)(lVar15 + unaff_x27 * 8);
  if (plVar12 == (long *)0x0) {
    pbVar13 = param_1 + 0x10;
    *plVar16 = *(long *)pbVar13;
    *(long **)pbVar13 = plVar16;
    *(basic_string **)(lVar15 + unaff_x27 * 8) = pbVar13;
    if (*plVar16 == 0) goto LAB_007c500c;
    ...
    plVar12 = (long *)(*(long *)param_1 + uVar7 * 8);
  }
  else {
    *plVar16 = *plVar12;
  }
...
LAB_007c501c:
  if (*(long *)(lVar5 + 0x28) != local_68) {
    ...
    __stack_chk_fail(plVar11,uVar8);
  }
  return plVar16;
}
