...
/* std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   cocos2d::JniHelper::getJNISignature<char const*, char const*>(char const*, char const*) */

void cocos2d::JniHelper::getJNISignature<char_const*,char_const*>(char *param_1,char *param_2)
