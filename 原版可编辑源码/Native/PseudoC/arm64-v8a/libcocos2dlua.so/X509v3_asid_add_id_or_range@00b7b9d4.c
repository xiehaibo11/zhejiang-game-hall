...

{
  ...
  if (param_2 == 1) {
    param_1 = param_1 + 1;
    piVar5 = (int *)*param_1;
    if (piVar5 == (int *)0x0) goto LAB_00b7ba20;
LAB_00b7ba08:
    if (*piVar5 == 0) {
      return 0;
    }
    ...
    piVar5 = (int *)*param_1;
    if (piVar5 != (int *)0x0) goto LAB_00b7ba08;
LAB_00b7ba20:
                    /* try { // try from 00b7ba28 to 00c7bbaf has its CatchHandler @ 00b7be84 */
    ...
    *param_1 = (long)pAVar3;
    ...
    uVar2 = OPENSSL_sk_new(FUN_00b7bb20);
  ...
  if (param_4 == 0) {
    ...
    *(ASN1_VALUE **)(pAVar3 + 8) = pAVar4;
    if (pAVar4 == (ASN1_VALUE *)0x0) goto LAB_00b7bae4;
