...
long * FUN_01250fe4(undefined8 *param_1,uint param_2)
...
switchD_0125101c_caseD_5:
  ...
  uVar3 = uVar1 >> 4 & 7;
  if (uVar3 != 0) {
    if (uVar3 != 1) goto switchD_0125101c_caseD_5;
    if (plVar4 == (long *)0x0) goto LAB_01251084;
