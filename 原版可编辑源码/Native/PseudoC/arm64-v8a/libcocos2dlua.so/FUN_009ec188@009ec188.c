...
void FUN_009ec188(long *param_1,ulong param_2)

{
  ...
  if (param_2 == 0) {
    ...
    *param_1 = 0;
    if (pvVar2 != (void *)0x0) {
                    /* try { // try from 009ec228 to 00aec29b has its CatchHandler @ 009ec314 */
    ...
    if (param_2 >> 0x3d != 0) {
                    ...
                    /* try { // try from 009ec30c to 00aec32f has its CatchHandler @ 009ec1d4 */
    ...
    *param_1 = (long)pvVar2;
    ...
    do {
      *(undefined8 *)(*param_1 + uVar4 * 8) = 0;
                    /* try { // try from 009ec1d4 to 00aec227 has its CatchHandler @ 009ec1d4
                       catch() { ... } // from try @ 009ec1d4 with catch @ 009ec1d4
                       catch() { ... } // from try @ 009ec29c with catch @ 009ec1d4
                       catch() { ... } // from try @ 009ec30c with catch @ 009ec1d4 */
      uVar4 = uVar4 + 1;
    } while (param_2 != uVar4);
      ...
      *(long **)(*param_1 + uVar4 * 8) = param_1 + 2;
      if ((long *)*plVar5 != (long *)0x0) {
        ...
        do {
          ...
          if (uVar7 != uVar4) {
                    /* try { // try from 009ec29c to 00aec2f7 has its CatchHandler @ 009ec1d4 */
            plVar9 = plVar6;
            if (*(long *)(*param_1 + uVar7 * 8) == 0) {
          ...
          plVar6 = plVar9;
                    ...
                    /* try { // try from 009ec2f8 to 00aec30b has its CatchHandler @ 009ec314 */
  return;
}
