...
/* std::__ndk1::__split_buffer<cocos2d::Mat4*,
   std::__ndk1::allocator<cocos2d::Mat4*>&>::push_back(cocos2d::Mat4*&&) */

void __thiscall
std::__ndk1::__split_buffer<cocos2d::Mat4*,std::__ndk1::allocator<cocos2d::Mat4*>&>::push_back
...

{
  ...
  if (puVar7 == *(undefined8 **)(this + 0x18)) {
    ...
    __src = *(undefined8 **)(this + 8);
                    /* try { // try from 00f9bb38 to 0109bb43 has its CatchHandler @ 00f9c1b8 */
      ...
      *(void **)(this + 0x18) = (void *)((long)pvVar3 + uVar5 * 8);
      ...
      if (-1 < lVar4 + 1) {
        lVar1 = lVar4 + 1;
                    ...
                    /* try { // try from 00f9bb54 to 0109bb5f has its CatchHandler @ 00f9c24c */
