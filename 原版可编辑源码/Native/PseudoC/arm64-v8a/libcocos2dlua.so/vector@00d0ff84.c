...
/* std::__ndk1::vector<cocos2d::MeshVertexAttrib, std::__ndk1::allocator<cocos2d::MeshVertexAttrib>
   >::vector(std::__ndk1::vector<cocos2d::MeshVertexAttrib,
   std::__ndk1::allocator<cocos2d::MeshVertexAttrib> > const&) */

void __thiscall
std::__ndk1::vector<cocos2d::MeshVertexAttrib,std::__ndk1::allocator<cocos2d::MeshVertexAttrib>>::
vector(vector<cocos2d::MeshVertexAttrib,std::__ndk1::allocator<cocos2d::MeshVertexAttrib>> *this,
      vector *param_1)
