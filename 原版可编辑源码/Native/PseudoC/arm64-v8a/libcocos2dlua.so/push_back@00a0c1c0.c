...
/* std::__ndk1::__split_buffer<universe::network::ZhouLuJun**,
   std::__ndk1::allocator<universe::network::ZhouLuJun**>
   >::push_back(universe::network::ZhouLuJun**&&) */
...

{
  ...
  undefined8 *puVar7;
                    ...
                    /* try { // try from 00a0c1cc to 00b0c1df has its CatchHandler @ 00a0c228 */
  puVar7 = *(undefined8 **)(this + 0x10);
                    /* try { // try from 00a0c1e0 to 00b0c243 has its CatchHandler @ 00a0c048 */
  if (puVar7 == *(undefined8 **)(this + 0x18)) {
    ...
    if (__src < puVar6 || (long)__src - (long)puVar6 == 0) {
      ...
      *(void **)(this + 0x18) = (void *)((long)pvVar3 + uVar5 * 8);
      ...
      if (__n != 0) {
                    /* catch() { ... } // from try @ 00a0c0a0 with catch @ 00a0c224
                       catch() { ... } // from try @ 00a0c1b4 with catch @ 00a0c224 */
                    /* catch() { ... } // from try @ 00a0c104 with catch @ 00a0c228
                       catch() { ... } // from try @ 00a0c1cc with catch @ 00a0c228 */
