...

{
  ...
  uVar12 = *(ulong *)(param_1 + 8);
                    /* catch() { ... } // from try @ 00e43264 with catch @ 00e43218
                       catch() { ... } // from try @ 00e43514 with catch @ 00e43218 */
  if ((uVar12 == 0) ||
     (*(float *)(param_1 + 0x20) * (float)uVar12 < (float)(*(long *)(param_1 + 0x18) + 1))) {
                    /* try { // try from 00e4325c to 00f43263 has its CatchHandler @ 00e43560 */
    uVar12 = (ulong)(uVar12 < 3 || (uVar12 & uVar12 - 1) != 0) | uVar12 << 1;
                    /* try { // try from 00e43264 to 00f4340f has its CatchHandler @ 00e43218 */
        ...
        if (sVar1 == __n) {
          ...
          if ((bVar2 & 1) == 0) {
            if (__n != 0) {
              ...
              pbVar10 = __s2;
              do {
                if (*pbVar8 != *pbVar10) goto LAB_00e432f0;
                uVar6 = uVar6 - 1;
                pbVar8 = pbVar8 + 1;
                pbVar10 = pbVar10 + 1;
              } while (uVar6 != 0);
