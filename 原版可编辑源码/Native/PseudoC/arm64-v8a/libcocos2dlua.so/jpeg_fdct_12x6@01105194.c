...

{
  ...
  lVar4 = 0;
                    /* catch() { ... } // from try @ 01105258 with catch @ 011051b4 */
  param_1[0x3a] = 0;
  param_1[0x3b] = 0;
  param_1[0x38] = 0;
  param_1[0x39] = 0;
  ...
  do {
    ...
    lVar8 = (ulong)pbVar1[7] + (ulong)pbVar1[4];
                    /* try { // try from 01105250 to 01205257 has its CatchHandler @ 01105330 */
    lVar11 = (ulong)pbVar1[5] - (ulong)pbVar1[6];
    lVar9 = lVar20 + lVar6;
                    /* try { // try from 01105258 to 0120534b has its CatchHandler @ 011051b4 */
    lVar6 = lVar6 - lVar20;
    lVar19 = lVar5 - lVar10;
    lVar10 = lVar10 + lVar5;
    iVar7 = (int)uVar2;
    ...
    *piVar3 = ((int)lVar10 + iVar7 + iVar15 + (int)lVar9) * 4 + -0x1800;
                    /* catch() { ... } // from try @ 01105250 with catch @ 01105330 */
  ...
  do {
    ...
    lVar5 = (lVar9 + lVar20) * 0x14d3;
                    /* try { // try from 01105410 to 012054bb has its CatchHandler @ 01105410
                       catch() { ... } // from try @ 01105410 with catch @ 01105410
                       catch() { ... } // from try @ 011054dc with catch @ 01105410 */
