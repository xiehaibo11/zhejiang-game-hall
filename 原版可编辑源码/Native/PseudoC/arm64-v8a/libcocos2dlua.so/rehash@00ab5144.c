...

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
                    /* try { // try from 00ab519c to 00bb51a3 has its CatchHandler @ 00ab51b8 */
                    /* try { // try from 00ab51a4 to 00bb51ff has its CatchHandler @ 00ab4fa4 */
      uVar1 = (ulong)((float)*(ulong *)(this + 0x18) / *(float *)(this + 0x20));
                    /* catch() { ... } // from try @ 00ab508c with catch @ 00ab51b8
                       catch() { ... } // from try @ 00ab519c with catch @ 00ab51b8 */
                    /* catch() { ... } // from try @ 00ab5070 with catch @ 00ab51bc */
      if ((uVar2 < 3) ||
        ...
        uVar1 = __next_prime(uVar1);
                    ...
                    /* catch() { ... } // from try @ 00ab5008 with catch @ 00ab51dc
                       catch() { ... } // from try @ 00ab5190 with catch @ 00ab51dc */
                    /* catch() { ... } // from try @ 00ab504c with catch @ 00ab51e0 */
                    /* catch() { ... } // from try @ 00ab4fec with catch @ 00ab51e4 */
      ...
      param_1 = uVar1;
                    /* try { // try from 00ab5200 to 00bb524b has its CatchHandler @ 00ab5200
                       catch() { ... } // from try @ 00ab5200 with catch @ 00ab5200
                       catch() { ... } // from try @ 00ab5250 with catch @ 00ab5200 */
      if (uVar1 < uVar2) goto LAB_00ab5208;
    }
    return;
  }
LAB_00ab5208:
