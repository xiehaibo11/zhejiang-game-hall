...
/* void std::__ndk1::vector<cocostudio::timeline::Timeline*,
   std::__ndk1::allocator<cocostudio::timeline::Timeline*>
   >::__push_back_slow_path<cocostudio::timeline::Timeline* const&>(cocostudio::timeline::Timeline*
   const&) */
