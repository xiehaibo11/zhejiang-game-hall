...
uint FUN_010bb234(long param_1,uint param_2)

{
  ...
  do {
    ...
    puVar3 = puVar1;
                    /* try { // try from 010bb26c to 011bb277 has its CatchHandler @ 010bb2f8 */
    if (*puVar1 == param_2) break;
    uVar2 = *puVar1 & 0x7fffffff;
                    /* try { // try from 010bb278 to 011bb3a3 has its CatchHandler @ 010bb180 */
    if (uVar2 != param_2) {
      puVar3 = puVar6;
    }
