...
/* void std::__ndk1::vector<cocos2d::MeshVertexData*,
   std::__ndk1::allocator<cocos2d::MeshVertexData*>
   >::__push_back_slow_path<cocos2d::MeshVertexData* const&>(cocos2d::MeshVertexData* const&) */
...

{
  ...
  ulong uVar3;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d41004 with catch @ 00d412e4
                        */
  __src = *(void **)this;
