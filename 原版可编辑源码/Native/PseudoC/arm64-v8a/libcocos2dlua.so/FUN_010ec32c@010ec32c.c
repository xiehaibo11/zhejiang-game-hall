...
void FUN_010ec32c(long param_1,long *param_2,uint param_3,long *param_4)

{
  ...
  uVar7 = *(uint *)(param_1 + 0x88);
                    /* try { // try from 010ec348 to 011ec37f has its CatchHandler @ 010ec47c */
  ...
  if (uVar4 != 0) {
    ...
    do {
      ...
      lVar27 = (long)*(int *)(lVar2 + (ulong)*pbVar9 * 4);
                    /* try { // try from 010ec3dc to 011ec42b has its CatchHandler @ 010ec480 */
      ...
      *puVar24 = *(undefined1 *)(lVar10 + lVar27 + uVar26);
      ...
      puVar24[3] = *(undefined1 *)(lVar10 + lVar27 + uVar26);
                    /* try { // try from 010ec42c to 011ec49b has its CatchHandler @ 010ec2d4 */
      ...
      *puVar23 = *(undefined1 *)(lVar10 + lVar27 + uVar26);
      ...
      pbVar17 = pbVar17 + 2;
                    /* catch() { ... } // from try @ 010ec348 with catch @ 010ec47c */
                    /* catch() { ... } // from try @ 010ec3dc with catch @ 010ec480 */
      ...
      pbVar20 = pbVar20 + 1;
                    ...
                    /* try { // try from 010ec49c to 011ec5a3 has its CatchHandler @ 010ec49c
                       catch() { ... } // from try @ 010ec49c with catch @ 010ec49c
                       catch() { ... } // from try @ 010ec6e4 with catch @ 010ec49c */
