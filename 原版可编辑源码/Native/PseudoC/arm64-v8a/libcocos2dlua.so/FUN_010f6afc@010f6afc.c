...
void FUN_010f6afc(long *param_1)

{
  ...
  if (*(int *)((long)param_1 + 0x15c) == 0) {
    ...
    uVar18 = *(undefined8 *)(lVar10 + 0x24);
                    /* catch() { ... } // from try @ 010f6d04 with catch @ 010f6d74 */
    if (iVar11 < 1) {
      uVar15 = 0;
      iVar11 = 0;
    }
    else {
                    /* catch() { ... } // from try @ 010f6de8 with catch @ 010f6d90
                       catch() { ... } // from try @ 010f6e94 with catch @ 010f6d90 */
      iVar4 = iVar11 + 0xf;
...
LAB_010f6dcc:
        ...
        if ((((uint)uVar16 >> 0x10 ^ 0xffffffff) & 0xff) == 0) {
          ...
          *puVar13 = 0;
          if (lVar8 == 0) {
                    /* try { // try from 010f6de4 to 011f6de7 has its CatchHandler @ 010f6f90 */
            puVar7 = (undefined8 *)param_1[5];
                    /* try { // try from 010f6de8 to 011f6e87 has its CatchHandler @ 010f6d90 */
            iVar5 = (*(code *)puVar7[3])(param_1);
            if (iVar5 == 0) goto LAB_010f6e44;
            puVar12 = (undefined1 *)*puVar7;
            lVar8 = puVar7[1];
          }
        }
    ...
    *(undefined8 *)(lVar10 + 0xd0) = puVar7[1];
    if (iVar11 != 0) {
      ...
      if (*(int *)(lVar10 + 0xc0) == 0) {
        ...
        FUN_010f97a4(lVar10,*(undefined4 *)(lVar8 + (long)(int)uVar1 * 4),
      ...
      if (iVar4 != 0) {
        FUN_010f97a4(lVar10,*(undefined4 *)(lVar10 + 0xe4),iVar4);
      }
              ...
              *(long *)(lVar10 + 0xd0) = lVar8;
              if (lVar8 == 0) {
                ...
                *(undefined8 *)(lVar10 + 200) = uVar18;
                    ...
                    /* catch() { ... } // from try @ 010f6d0c with catch @ 010f6cd0 */
              if ((((uint)uVar15 >> 0x10 ^ 0xffffffff) & 0xff) == 0) {
                ...
                *(long *)(lVar10 + 0xd0) = lVar8;
                if (lVar8 == 0) {
                  puVar7 = *(undefined8 **)(*(long *)(lVar10 + 0xd8) + 0x28);
                    /* try { // try from 010f6d04 to 011f6d0b has its CatchHandler @ 010f6d74 */
                  iVar4 = (*(code *)puVar7[3])();
                  if (iVar4 == 0) {
                    /* try { // try from 010f6d0c to 011f6d8f has its CatchHandler @ 010f6cd0 */
                    puVar9 = (undefined8 *)**(long **)(lVar10 + 0xd8);
                    *(undefined4 *)(puVar9 + 5) = 0x19;
                    (*(code *)*puVar9)();
                  }
...
LAB_010f6d3c:
    ...
    *puVar7 = uVar18;
                    ...
                    /* try { // try from 010f6e88 to 011f6e93 has its CatchHandler @ 010f6f48 */
  if (*(long *)(lVar3 + 0x28) == lVar6) {
                    /* try { // try from 010f6e94 to 011f6fab has its CatchHandler @ 010f6d90 */
    return;
  }
