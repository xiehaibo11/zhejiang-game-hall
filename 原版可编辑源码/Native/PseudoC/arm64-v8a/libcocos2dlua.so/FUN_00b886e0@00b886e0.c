...
void FUN_00b886e0(undefined8 param_1,undefined8 param_2,undefined8 *param_3,int param_4)

{
  ...
  pauVar3 = (undefined1 (*) [16])FUN_00b886a0();
  auVar7 = *pauVar3;
  auVar6 = FUN_00b888f0(pauVar3 + 1);
  pVar5 = (unkbyte9 *)(&DAT_00b87e80 + extraout_x8);
  if (param_4 == 0) {
    *param_3 = auVar6._0_8_;
    param_3[1] = auVar6._8_8_;
  }
  else {
    uVar2 = *(undefined8 *)(&DAT_00b87e88 + extraout_x8);
    ...
    *param_3 = auVar7._0_8_;
    ...
    pVar5 = (unkbyte9 *)((ulong)pVar5 ^ 0x30);
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b88648 with catch @ 00b88724
                        */
  if (extraout_w1 < 0xc1) {
    if (extraout_w1 == 0xc0) {
      auVar7 = FUN_00b888f0(pVar5);
      uVar16 = auVar7[8];
      uVar17 = auVar7[9];
      uVar18 = auVar7[10];
      uVar19 = auVar7[0xb];
      ...
      lVar4 = 10;
      while (lVar4 = FUN_00b88870(lVar4 + -1), pVar5 = extraout_x8_00, auVar7 = extraout_q0,
            lVar4 != 0) {
        lVar4 = FUN_00b88910();
      }
    }
