...
/* WARNING: Removing unreachable block (ram,0x00bf64ac) */

int FUN_00bf632c(BIO *param_1,void *param_2,uint param_3)
...
joined_r0x00bf63b8:
  if (uVar3 < 5) {
LAB_00bf63f0:
    switch((long)&switchD_00bf63fc::switchdataD_0140edf0 +
           (long)(int)(&switchD_00bf63fc::switchdataD_0140edf0)[uVar3]) {
    case 0xbf6400:
      goto switchD_00bf63fc_caseD_bf6400;
    case 0xbf643c:
    ...
    case 0xbf6464:
      ...
      if (uVar3 - iVar1 == 0) goto code_r0x00bf6498;
      puVar2[5] = puVar2[5] + iVar1;
      goto LAB_00bf63b0;
    case 0xbf64b0:
      iVar1 = FUN_00bf6934(param_1,puVar2,*(undefined8 *)(puVar2 + 0xc),2);
      if (0 < iVar1) goto LAB_00bf63b0;
      break;
    case 0xbf64d4:
      uVar3 = puVar2[7];
      ...
      if (param_3 != 0) goto LAB_00bf63b0;
    }
