...
/* WARNING: Removing unreachable block (ram,0x00aff294) */

undefined8 FUN_00aff138(BUF_MEM *param_1,long *param_2,uchar *param_3,ulong param_4,int param_5)
...
LAB_00aff3c0:
        ...
        if ((uVar4 & 0x20) == 0) {
          ...
          uVar6 = FUN_00aff138(param_1,&local_80,local_70,uVar4 & 1,param_5 + 1);
          if ((int)uVar6 == 0) {
            return uVar6;
          }
        }
  ...
  if ((param_4 & 1) == 0) goto LAB_00aff3e4;
  iVar7 = 0x6a;
  iVar5 = 0x89;
  line = 0x3f8;
LAB_00aff46c:
