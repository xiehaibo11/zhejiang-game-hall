...
/* cocos2d::GLProgramState::getVertexAttribValue(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

long __thiscall
cocos2d::GLProgramState::getVertexAttribValue(GLProgramState *this,basic_string *param_1)
