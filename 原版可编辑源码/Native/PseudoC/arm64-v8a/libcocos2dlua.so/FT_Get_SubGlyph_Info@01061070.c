...

{
  ...
  if (*(long *)(param_1 + 0xf8) == 0) {
    return 6;
                    ...
                    /* catch() { ... } // from try @ 010610b8 with catch @ 01061080 */
  ...
  if (param_2 < *(uint *)(param_1 + 0xf0)) {
    ...
    *param_3 = *puVar1;
                    /* try { // try from 010610b0 to 011610b7 has its CatchHandler @ 0106111c */
    *param_4 = (uint)*(ushort *)(puVar1 + 1);
                    /* try { // try from 010610b8 to 01161137 has its CatchHandler @ 01061080 */
    *param_5 = puVar1[2];
    *param_6 = puVar1[3];
    uVar2 = *(undefined8 *)(puVar1 + 8);
    param_7[3] = *(undefined8 *)(puVar1 + 10);
    param_7[2] = uVar2;
