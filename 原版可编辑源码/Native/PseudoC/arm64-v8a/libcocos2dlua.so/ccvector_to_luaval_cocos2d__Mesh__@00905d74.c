...
/* void ccvector_to_luaval<cocos2d::Mesh*>(lua_State*, cocos2d::Vector<cocos2d::Mesh*> const&) */

void ccvector_to_luaval<cocos2d::Mesh*>(lua_State *param_1,Vector *param_2)

{
  ...
  lua_createtable(param_1,0,0);
                    /* catch() { ... } // from try @ 00905d18 with catch @ 00905db0 */
  if (param_1 != (lua_State *)0x0) {
                    /* catch() { ... } // from try @ 00905d30 with catch @ 00905db4 */
    plVar2 = *(long **)param_2;
    ...
    if (plVar2 != plVar3) {
      ...
      while( true ) {
        ...
        plVar9 = (long *)*plVar2;
                    /* catch() { ... } // from try @ 00905ce4 with catch @ 00905de4 */
      }
    }
  }
