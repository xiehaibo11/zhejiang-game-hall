...

{
  ...
  if ((int)uVar1 < 0) {
    if (uVar1 != 0xffffffff) goto LAB_00b1333c;
...
LAB_00b1333c:
  ...
  x = (X509 *)0x0;
  if ((-1 < (int)(uVar3 | uVar1)) || (uVar4 != 0)) goto LAB_00b1355c;
  if (uVar3 != 0xffffffff) {
    uVar1 = uVar3;
  }
  if ((int)uVar1 < 0) {
    ...
    x = X509_dup(param_2);
    if (x == (X509 *)0x0) goto LAB_00b1355c;
    ...
    if (param_3 != (X509 *)0x0) {
      ...
      if (((((-1 < iVar5 && lastpos == -1) || (iVar5 < -1)) || (lastpos < -1)) ||
          (uVar3 != 0 || uVar1 != 0)) || ((iVar5 == -1 && (-1 < lastpos)))) goto LAB_00b1355c;
