...
/* rapidjson::Writer<rapidjson::GenericStringBuffer<rapidjson::UTF8<char>, rapidjson::CrtAllocator>,
   rapidjson::UTF8<char>, rapidjson::UTF8<char>, rapidjson::CrtAllocator, 0u>::Int(int) */
...

{
  ...
  *(long *)(*(long *)this + 0x18) = (lVar1 - (long)pcVar5) + *(long *)(*(long *)this + 0x18) + -0xb;
                    /* try { // try from 009240a4 to 00a2416f has its CatchHandler @ 009240a4
                       catch() { ... } // from try @ 009240a4 with catch @ 009240a4
                       catch() { ... } // from try @ 009241f0 with catch @ 009240a4 */
  return 1;
}
