...
/* bool luaval_to_ccvector<cocos2d::SpriteFrame*>(lua_State*, int,
   cocos2d::Vector<cocos2d::SpriteFrame*>*, char const*) */

bool luaval_to_ccvector<cocos2d::SpriteFrame*>
