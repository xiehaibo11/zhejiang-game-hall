...
ulong FUN_00a306d0(long *param_1)

{
  ...
  auVar27 = FUN_00a2e828();
  lVar22 = auVar27._0_8_;
                    /* catch() { ... } // from try @ 00a30674 with catch @ 00a3070c */
                    /* catch() { ... } // from try @ 00a3068c with catch @ 00a30710 */
  uVar9 = FUN_00a2e8b8(lVar22,auVar27._8_8_,*(undefined8 *)(lVar20 + 0x9c8),
  ...
  *(double *)(lVar20 + 0x980) = extraout_d0;
  ...
  auVar26 = NEON_scvtf(*pauVar1,8);
                    /* catch() { ... } // from try @ 00a30640 with catch @ 00a30740 */
  ...
  if (*(long *)(lVar20 + 0x940) == lVar22) {
    ...
    *(int *)(lVar20 + 0xac8) = iVar21 + 1;
    if (iVar21 == 0) {
      ...
      uVar9 = FUN_00a2e888(lVar22,auVar27._8_8_,*(undefined8 *)(lVar3 + 0x128),
  ...
  if ((uVar8 >> 4 & 1) == 0) {
    if (*(code **)(lVar20 + 0x2e0) == (code *)0x0) {
      if (*(code **)(lVar20 + 0x2d8) == (code *)0x0) {
        if (!bVar7) goto LAB_00a308e8;
        if ((uVar8 >> 7 & 1) == 0) {
          if (*(long *)(lVar20 + 0x8cd8) != 0) {
            FUN_00a2462c(*(undefined8 *)(lVar20 + 0x220),
...
joined_r0x00a30b0c:
          if (0 < (long)uVar9) goto LAB_00a30b7c;
LAB_00a30be8:
          builtin_strncpy(local_98,"--:--:--",9);
joined_r0x00a30c00:
          if ((long)uVar18 < 1) goto LAB_00a30cd4;
LAB_00a30c70:
          if ((long)uVar18 < 360000) {
            FUN_00a241ac(local_a8,9,"%2ld:%02ld:%02ld",uVar18 / 0xe10,(uVar18 % 0xe10) / 0x3c,
                         (uVar18 % 0xe10) % 0x3c);
          }
          else if ((long)uVar18 < 86400000) {
            FUN_00a241ac(local_a8,9,"%3ldd %02ldh",uVar18 / 0x15180,(uVar18 % 0x15180) / 0xe10);
          }
          else {
            FUN_00a241ac(local_a8,9,"%7ldd");
          }
        }
        else {
          if ((long)uVar17 < 360000) {
            FUN_00a241ac(local_88,9,"%2ld:%02ld:%02ld",uVar17 / 0xe10,(uVar17 % 0xe10) / 0x3c,
                         (uVar17 % 0xe10) % 0x3c);
            goto joined_r0x00a30b0c;
          }
          if ((long)uVar17 < 86400000) {
            FUN_00a241ac(local_88,9,"%3ldd %02ldh",uVar17 / 0x15180,(uVar17 % 0x15180) / 0xe10);
            goto joined_r0x00a30b0c;
          }
          FUN_00a241ac(local_88,9,"%7ldd");
          if ((long)uVar9 < 1) goto LAB_00a30be8;
LAB_00a30b7c:
          if ((long)uVar9 < 360000) {
            FUN_00a241ac(local_98,9,"%2ld:%02ld:%02ld",uVar9 / 0xe10,(uVar9 % 0xe10) / 0x3c,
                         (uVar9 % 0xe10) % 0x3c);
            goto joined_r0x00a30c00;
          }
          if (86399999 < (long)uVar9) {
            FUN_00a241ac(local_98,9,"%7ldd");
            goto joined_r0x00a30c00;
          }
          FUN_00a241ac(local_98,9,"%3ldd %02ldh",uVar9 / 0x15180,(uVar9 % 0x15180) / 0xe10);
          if (0 < (long)uVar18) goto LAB_00a30c70;
LAB_00a30cd4:
        ...
        uVar10 = FUN_00a311c4(uVar9,auStack_d0);
        uVar11 = FUN_00a311c4(*(undefined8 *)(lVar20 + 0x958),auStack_e4);
        uVar12 = FUN_00a311c4(*(undefined8 *)(lVar20 + 0x960),auStack_da);
        uVar13 = FUN_00a311c4(*(undefined8 *)(lVar20 + 0x988),auStack_c6);
        uVar14 = FUN_00a311c4(*(undefined8 *)(lVar20 + 0x990),auStack_bc);
        uVar15 = FUN_00a311c4(*(undefined8 *)(lVar20 + 0x968),auStack_b2);
        FUN_00a2462c(uVar23,"\r%3ld %s  %3ld %s  %3ld %s  %s  %s %s %s %s %s",lVar22,uVar10,local_f8
    ...
    if (iVar21 != 0) {
      uVar9 = FUN_00a38a08(lVar20,"Callback aborted");
    }
  }
  else {
LAB_00a308e8:
