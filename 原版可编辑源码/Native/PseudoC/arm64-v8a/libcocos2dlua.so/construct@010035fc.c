...
/* cocos2d::PhysicsJointFixed::construct(cocos2d::PhysicsBody*, cocos2d::PhysicsBody*, cocos2d::Vec2
   const&) */

PhysicsJoint *
cocos2d::PhysicsJointFixed::construct(PhysicsBody *param_1,PhysicsBody *param_2,Vec2 *param_3)

{
  ...
  if (pPVar2 != (PhysicsJoint *)0x0) {
    ...
    *(undefined ***)pPVar2 = &PTR__PhysicsJoint_017250c8;
