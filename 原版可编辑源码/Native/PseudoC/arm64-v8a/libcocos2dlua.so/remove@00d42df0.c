...

{
  ...
  uVar6 = CONCAT62((int6)((ulong)uVar9 >> 0x10),uVar8) & 0xffffffff;
                    /* try { // try from 00d42e08 to 00e42e5f has its CatchHandler @ 00d42f50 */
  if (uVar6 < 2) {
    uVar4 = uVar3 - 1 & uVar4;
  }
  else {
    ...
    if (uVar6 < 2) {
      ...
      if (uVar3 != 0) {
        uVar1 = uVar7 / uVar3;
                    ...
                    /* try { // try from 00d42e68 to 00e42f07 has its CatchHandler @ 00d42f4c */
      uVar7 = uVar7 - uVar1 * uVar3;
    }
    if (uVar7 == uVar4) goto LAB_00d42ecc;
  }
  if (*param_3 != 0) {
  ...
  if (*param_3 != 0) {
    ...
    if (uVar6 < 2) {
      ...
      uVar7 = uVar7 - uVar6 * uVar3;
                    ...
                    /* try { // try from 00d42f08 to 00e42f0f has its CatchHandler @ 00d42cfc */
    if (uVar7 != uVar4) {
                    /* try { // try from 00d42f10 to 00e42f17 has its CatchHandler @ 00d42f50 */
      *(long **)(*param_2 + uVar7 * 8) = plVar5;
    }
  }
                    /* catch() { ... } // from try @ 00d42de8 with catch @ 00d42f18
                       try { // try from 00d42f18 to 00e42f6b has its CatchHandler @ 00d42cfc */
  *plVar5 = *param_3;
  *param_3 = 0;
