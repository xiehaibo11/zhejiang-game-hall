...
/* cocos2d::Camera::unproject(cocos2d::Size const&, cocos2d::Vec3 const*, cocos2d::Vec3*) const */

void __thiscall cocos2d::Camera::unproject(Camera *this,Size *param_1,Vec3 *param_2,Vec3 *param_3)

{
  ...
  Vec4::Vec4((Vec4 *)&local_88,*(float *)param_2 / *(float *)param_1,
             (*(float *)(param_1 + 4) - *(float *)(param_2 + 4)) / *(float *)(param_1 + 4),
             *(float *)(param_2 + 8),1.0);
