  ...
  if (*(long *)(this + 0x10) == 0) {
    ...
    *(Armature **)(this + 0x28) = param_2;
    uVar1 = Armature::getBone(param_2,(basic_string *)(*(long *)(param_1 + 0x30) + 0x18));
                    /* try { // try from 00da0eb0 to 00ea0eb7 has its CatchHandler @ 00da1258 */
    ...
    *(long *)(this + 0x20) = lVar2;
    if (*(long *)(lVar3 + 0x40) == 0) {
      uVar1 = 0;
                    ...
                    /* try { // try from 00da0edc to 00ea0edf has its CatchHandler @ 00da122c */
    ...
    *(undefined8 *)(this + 0x30) = uVar1;
    ...
    this[0x40] = *(IKConstraint *)(lVar3 + 0x48);
                    /* try { // try from 00da0f08 to 00ea0f13 has its CatchHandler @ 00da1244 */
    *(undefined4 *)(this + 0x3c) = *(undefined4 *)(lVar3 + 0x4c);
    *(undefined1 *)(lVar2 + 0x92) = 1;
  }
                    /* try { // try from 00da0f1c to 00ea0f23 has its CatchHandler @ 00da1254 */
  return;
}
