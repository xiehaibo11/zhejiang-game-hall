...

{
  ...
  if (*(char *)(param_1 + 0x12) == '\x04') {
    if (*(char *)(param_1 + 0x11) == '\x10') {
                    /* try { // try from 010d579c to 011d57cb has its CatchHandler @ 010d579c
                       catch() { ... } // from try @ 010d579c with catch @ 010d579c
                       catch() { ... } // from try @ 010d57d4 with catch @ 010d579c */
      puVar2 = param_2 + 6;
      puVar7 = param_2 + 8;
      if (param_3 != 0) {
        puVar2 = param_2;
      ...
      if (puVar7 < puVar1) {
        lVar4 = (lVar4 + -1) - (long)puVar7;
                    /* try { // try from 010d57cc to 011d57d3 has its CatchHandler @ 010d5844 */
        puVar6 = puVar2;
        do {
                    /* try { // try from 010d57d4 to 011d587b has its CatchHandler @ 010d579c */
          *puVar6 = *puVar7;
          puVar6[1] = puVar7[1];
          puVar6[2] = puVar7[2];
          puVar6[3] = puVar7[3];
  ...
  *(long *)(param_1 + 8) = (long)puVar2 - (long)param_2;
                    /* catch() { ... } // from try @ 010d57cc with catch @ 010d5844 */
  return;
}
