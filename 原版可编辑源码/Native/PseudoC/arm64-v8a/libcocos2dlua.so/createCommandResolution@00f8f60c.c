...
/* cocos2d::Console::createCommandResolution() */

void __thiscall cocos2d::Console::createCommandResolution(Console *this)

{
  ...
  basic_string<decltype(nullptr)>(local_118,"resolution");
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
...
LAB_00f8f6cc:
  ...
  local_e0 = &local_100;
  uStack_f0 = 0;
  local_f8 = commandResolutionSubCommandEmpty;
  local_e8 = this;
  ...
  if (&local_100 == local_e0) {
    ...
    if (local_e0 == (undefined ***)0x0) goto LAB_00f8f7a8;
    pcVar3 = (code *)(*local_e0)[5];
  }
  (*pcVar3)();
LAB_00f8f7a8:
