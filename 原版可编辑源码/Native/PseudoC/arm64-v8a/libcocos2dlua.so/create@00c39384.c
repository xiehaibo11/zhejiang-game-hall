...
/* cocostudio::Bone::create(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&) */

Node * cocostudio::Bone::create(basic_string *param_1)

{
  ...
  if (this != (Node *)0x0) {
    ...
    *(undefined4 *)(this + 0x398) = 0;
    uVar9 = (**(code **)(*(long *)this + 0x530))(this,param_1);
    if ((uVar9 & 1) == 0) {
