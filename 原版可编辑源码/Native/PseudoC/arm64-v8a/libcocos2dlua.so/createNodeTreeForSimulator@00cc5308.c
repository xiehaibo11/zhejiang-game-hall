...
/* cocostudio::FlatBuffersSerialize::createNodeTreeForSimulator(tinyxml2::XMLElement const*,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >)
    */

undefined4 __thiscall
cocostudio::FlatBuffersSerialize::createNodeTreeForSimulator
          (FlatBuffersSerialize *this,XMLElement *param_1,byte *param_3)
...
LAB_00cc5424:
  ...
  if (uVar16 == 0xb) {
    ...
    if (iVar5 == 0) {
      uVar7 = createProjectNodeOptionsForSimulator(this,param_1);
      uVar7 = flatbuffers::CreateOptions(*(undefined8 *)(this + 0x38),uVar7);
      goto LAB_00cc5598;
    }
...
LAB_00cc5598:
  pXVar15 = (XMLNode *)tinyxml2::XMLNode::FirstChildElement((XMLNode *)param_1,(char *)0x0);
  while( true ) {
    if (pXVar15 == (XMLNode *)0x0) goto LAB_00cc5818;
      ...
      if (uVar16 == 5) {
        ...
        if (((byte)local_e8 & 1) == 0) {
          ...
          if (uStack_e0 < 0x17) {
            ...
            if (uStack_e0 != 0) goto LAB_00cc5738;
          }
          else {
...
LAB_00cc5738:
        ...
        local_130[0] = createNodeTreeForSimulator(this,pXVar15,&local_100);
...
LAB_00cc569c:
    ...
    if (!bVar21) {
      ...
      local_d0[0] = createNodeTreeForSimulator(this,pXVar15,local_118);
      if (local_b0 < puStack_a8) {
        *local_b0 = local_d0[0];
        local_b0 = local_b0 + 1;
      }
