...
void cocos2d::ui::Button::getDisabledFile(void)

{
  ...
  *in_x8 = *(undefined4 *)(in_x0 + 0x5b8);
  if (this != (basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
              (in_x0 + 0x598)) {
    pcVar1 = *(char **)(in_x0 + 0x5a8);
    uVar2 = *(ulong *)(in_x0 + 0x5a0);
    if ((*(byte *)(in_x0 + 0x598) & 1) == 0) {
      pcVar1 = (char *)(in_x0 + 0x599);
      uVar2 = (ulong)(*(byte *)(in_x0 + 0x598) >> 1);
    }
