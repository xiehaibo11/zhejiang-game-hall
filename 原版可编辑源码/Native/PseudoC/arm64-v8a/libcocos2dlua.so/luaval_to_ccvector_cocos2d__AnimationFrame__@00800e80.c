...
/* bool luaval_to_ccvector<cocos2d::AnimationFrame*>(lua_State*, int,
   cocos2d::Vector<cocos2d::AnimationFrame*>*, char const*) */

bool luaval_to_ccvector<cocos2d::AnimationFrame*>
        ...
        if (((iVar4 != 0) && (iVar4 = lua_isuserdata(param_1,0xffffffff), iVar4 != 0)) &&
          ...
          if (plVar1 == *(long **)(param_3 + 0x10)) {
            ...
            __push_back_slow_path<cocos2d::AnimationFrame*const&>
                      ((vector<cocos2d::AnimationFrame*,std::__ndk1::allocator<cocos2d::AnimationFrame*>>
                        *)param_3,(AnimationFrame **)&local_60);
          }
          else {
            *plVar1 = (long)pRVar6;
