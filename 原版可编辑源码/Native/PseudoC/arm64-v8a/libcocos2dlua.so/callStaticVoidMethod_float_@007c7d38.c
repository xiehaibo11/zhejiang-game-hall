...
/* void cocos2d::JniHelper::callStaticVoidMethod<float>(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&, float) */

void cocos2d::JniHelper::callStaticVoidMethod<float>
...

{
  ...
  *puVar5 = 0;
  ...
  if ((uVar6 & 1) == 0) {
    ...
    local_50 = (void *)0x0;
    local_40 = 0x3f800000;
    _JNIEnv::CallStaticVoidMethod(local_78,p_Stack_70,(double)param_3,local_68);
