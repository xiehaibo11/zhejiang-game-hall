...

{
  ...
  if (param_1 == (void *)0x0) {
    ...
    if (*(long *)((long)param_1 + 0x90) != 0) {
                    /* try { // try from 0102975c to 01129767 has its CatchHandler @ 0102982c */
                    /* try { // try from 01029768 to 0112983f has its CatchHandler @ 010296ec */
      ...
      if ((*(long *)((long)param_1 + 0x68) == 0xffff) || (lVar1 != *(long *)((long)param_1 + 0x68)))
      {
        ...
        *(long *)((long)param_1 + 0x88) =
        ...
        uVar2 = FUN_01028a58(param_1,(undefined8 *)((long)param_1 + 0xb0),(long)param_1 + 0x138,
