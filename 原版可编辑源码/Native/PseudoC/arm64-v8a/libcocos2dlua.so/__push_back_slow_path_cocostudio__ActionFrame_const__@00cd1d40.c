...
/* void std::__ndk1::vector<cocostudio::ActionFrame*,
   std::__ndk1::allocator<cocostudio::ActionFrame*>
   >::__push_back_slow_path<cocostudio::ActionFrame* const&>(cocostudio::ActionFrame* const&) */
...
__push_back_slow_path<cocostudio::ActionFrame*const&>
          (vector<cocostudio::ActionFrame*,std::__ndk1::allocator<cocostudio::ActionFrame*>> *this,
          ActionFrame **param_1)
