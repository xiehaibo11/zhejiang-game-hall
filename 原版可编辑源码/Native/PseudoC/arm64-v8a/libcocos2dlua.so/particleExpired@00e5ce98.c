...
/* non-virtual thunk to cocos2d::PURibbonTrailRender::particleExpired(cocos2d::PUParticleSystem3D*,
...

{
  ...
  if (plVar1 != (long *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00e5ceac. Too many branches */
