...

{
  ...
  undefined8 *puVar5;
                    ...
                    /* try { // try from 01060a0c to 01160a13 has its CatchHandler @ 01060a78 */
                    /* try { // try from 01060a14 to 01160a93 has its CatchHandler @ 010609dc */
  if (param_1 == 0) {
    uVar2 = 0x21;
  }
  else {
    ...
    if (((param_2 != (char *)0x0) && (param_3 != 0)) && (param_4 != 0)) {
      ...
      if (puVar5 == puVar3) {
        ...
        pcVar4 = *(code **)(*(long *)*puVar5 + 0x40);
                    /* catch() { ... } // from try @ 01060a0c with catch @ 01060a78 */
        if (((pcVar4 != (code *)0x0) &&
            (puVar3 = (undefined8 *)(*pcVar4)((long *)*puVar5,"properties"),
            puVar3 != (undefined8 *)0x0)) && ((code *)*puVar3 != (code *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x01060ab0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          uVar2 = (*(code *)*puVar3)(*puVar5,param_3,param_4);
          return uVar2;
        }
        uVar2 = 7;
      }
