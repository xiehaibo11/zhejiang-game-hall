...

{
  ...
  long local_38;
                    ...
                    /* try { // try from 010ceb1c to 011ceb33 has its CatchHandler @ 010ceb78 */
  lVar2 = tpidr_el0;
                    /* try { // try from 010ceb34 to 011ceb93 has its CatchHandler @ 010cead8 */
  ...
  if (param_3 == 0xd) {
    *(uint *)(param_1 + 0x164) = *(uint *)(param_1 + 0x164) | 1;
    png_read_data(param_1,&local_48,0xd);
                    /* catch() { ... } // from try @ 010ceb1c with catch @ 010ceb78 */
    ...
    if (-1 < (int)uVar1) {
                    /* catch() { ... } // from try @ 010ced1c with catch @ 010ceb94 */
      ...
      if (-1 < (int)uVar3) {
        ...
        *(char *)(param_1 + 0x2b3) = (char)uVar3;
                    /* try { // try from 010cec04 to 011cec2b has its CatchHandler @ 010ced40 */
        ...
        *(ulong *)(param_1 + 0x240) = uVar4;
        ...
        if (*(long *)(lVar2 + 0x28) == local_38) {
                    /* try { // try from 010cec64 to 011cec97 has its CatchHandler @ 010ced44 */
          return;
        }
                    /* WARNING: Subroutine does not return */
        __stack_chk_fail();
