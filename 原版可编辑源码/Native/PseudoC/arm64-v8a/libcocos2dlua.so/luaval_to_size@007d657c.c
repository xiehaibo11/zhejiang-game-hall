...
/* luaval_to_size(lua_State*, int, cocos2d::Size*, char const*) */

bool luaval_to_size(lua_State *param_1,int param_2,Size *param_3,char *param_4)

{
  ...
  bVar3 = false;
  if ((param_1 != (lua_State *)0x0) && (param_3 != (Size *)0x0)) {
