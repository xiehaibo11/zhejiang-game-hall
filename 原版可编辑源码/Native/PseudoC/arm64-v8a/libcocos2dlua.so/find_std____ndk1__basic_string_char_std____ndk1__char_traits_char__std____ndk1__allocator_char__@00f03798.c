...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00f037a0 to 010037a7 has its CatchHandler @ 00f03884 */
  lVar5 = tpidr_el0;
  local_68 = *(long *)(lVar5 + 0x28);
                    /* try { // try from 00f037c0 to 010037d7 has its CatchHandler @ 00f03888 */
  uVar7 = *(ulong *)(param_1 + 8);
  pbVar2 = *(basic_string **)(param_1 + 0x10);
                    /* try { // try from 00f037d8 to 0100391f has its CatchHandler @ 00f036b0 */
  if (((byte)*param_1 & 1) == 0) {
    pbVar2 = param_1 + 1;
  ...
  if (uVar12 != 0) {
    ...
    if (plVar8 != (long *)0x0) {
      ...
      if (plVar8 != (long *)0x0) {
        ...
        do {
          uVar9 = plVar8[1];
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00f037a0 with catch @ 00f03884
                        */
          if (uVar9 == uVar7) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00f037c0 with catch @ 00f03888
                        */
            bVar3 = *(byte *)(plVar8 + 2);
            uVar9 = (ulong)(bVar3 >> 1);
            sVar1 = uVar9;
              ...
              if ((bVar3 & 1) == 0) {
                ...
                while (*pbVar10 == *pbVar11) {
                  ...
                  if (uVar9 == 0) goto LAB_00f03928;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00f03760 with catch @ 00f038e8
                        */
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00f03874;
              goto LAB_00f03924;
            }
            if (uVar9 != uVar14) goto LAB_00f03924;
          }
LAB_00f03874:
          plVar8 = (long *)*plVar8;
