...
void cocos2d::ui::AbstractCheckButton::getBackDisabledFile(void)

{
  ...
  *in_x8 = *(undefined4 *)(in_x0 + 0x528);
  if (this != (basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
              (in_x0 + 0x590)) {
    pcVar1 = *(char **)(in_x0 + 0x5a0);
    uVar2 = *(ulong *)(in_x0 + 0x598);
    if ((*(byte *)(in_x0 + 0x590) & 1) == 0) {
      pcVar1 = (char *)(in_x0 + 0x591);
      uVar2 = (ulong)(*(byte *)(in_x0 + 0x590) >> 1);
    }
