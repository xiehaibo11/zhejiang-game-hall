...
undefined8 FUN_00b30488(long param_1,ulong param_2,ulong param_3,ulong param_4)
      ...
      *(uint *)(lVar20 + 0x70) = uVar7;
      ...
      if ((0x1f < uVar8) && (uVar15 = uVar8 & 0x1ffffffe0, uVar15 != 0)) {
        ...
        if ((param_3 - uVar9 <= param_2 || param_2 - uVar9 <= param_3) &&
          ...
          param_2 = uVar14;
          param_3 = uVar10;
          if (uVar15 == uVar8) goto LAB_00b305b8;
        }
      }
      lVar12 = 0;
      do {
    ...
    do {
      while( true ) {
        ...
        *(uint *)(lVar20 + 0x20) = uVar21;
        if (uVar21 == 0) break;
        if (uVar8 < 0x40) goto LAB_00b30678;
      }
      *(int *)(lVar20 + 0x24) = *(int *)(lVar20 + 0x24) + 1;
    } while (0x3f < uVar8);
  }
  ...
  if (uVar7 < 0x20) {
    ...
    if (lVar6 != 0) {
      if ((param_3 + uVar5 <= param_2 || param_2 + uVar5 <= param_3) &&
        ...
        lVar12 = lVar6;
        if ((param_4 & 0x1f) == 0) goto LAB_00b307d8;
      }
    }
  }
  lVar6 = uVar5 - lVar12;
