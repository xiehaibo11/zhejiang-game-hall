...
/* lua_cocos2dx_Shaky3D_constructor(lua_State*) */

bool lua_cocos2dx_Shaky3D_constructor(lua_State *param_1)
  ...
  if (iVar1 == 0) {
    ...
    *(undefined ***)(this + 0x28) = &PTR_clone_016f7b48;
    ...
    toluafix_pushusertype_ccobject
              (param_1,*(int *)(this + 0xc),(int *)(this + 0x10),this,"cc.Shaky3D");
  }
  else {
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "cc.Shaky3D:Shaky3D",iVar1,0);
  }
  return iVar1 == 0;
}
