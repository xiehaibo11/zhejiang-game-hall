...
/* void 
   universe::network::GuoPengFei::receiveMessageFromPack<universe::network::SRS::CheckAct>(universe::network::SRS::CheckAct&,
   universe::network::ZhouLuJun const*) */

void __thiscall
universe::network::GuoPengFei::receiveMessageFromPack<universe::network::SRS::CheckAct>
          (GuoPengFei *this,CheckAct *param_1,ZhouLuJun *param_2)
