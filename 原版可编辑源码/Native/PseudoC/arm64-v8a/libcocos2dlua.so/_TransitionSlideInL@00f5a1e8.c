...
/* non-virtual thunk to cocos2d::TransitionSlideInL::~TransitionSlideInL() */

void __thiscall cocos2d::TransitionSlideInL::~TransitionSlideInL(TransitionSlideInL *this)
