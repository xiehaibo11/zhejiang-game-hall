...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void
   ...
   (cocos2d::Scene::*)(cocos2d::EventCustom*), cocos2d::Scene*, std::__ndk1::placeholders::__ph<1>
   const&> >, void (cocos2d::EventCustom*)>::TEMPNAMEPLACEHOLDERVALUE(cocos2d::EventCustom*&&) */
...
::operator()(__func<std::__ndk1::__bind<void(cocos2d::Scene::*)(cocos2d::EventCustom*),cocos2d::Scene*,std::__ndk1::placeholders::__ph<1>const&>,std::__ndk1::allocator<std::__ndk1::__bind<void(cocos2d::Scene::*)(cocos2d::EventCustom*),cocos2d::Scene*,std::__ndk1::placeholders::__ph<1>const&>>,void(cocos2d::EventCustom*)>
...

{
  ...
  code *UNRECOVERED_JUMPTABLE;
                    ...
                    /* catch() { ... } // from try @ 00f3d434 with catch @ 00f3d530 */
  UNRECOVERED_JUMPTABLE = *(code **)(this + 8);
                    /* catch() { ... } // from try @ 00f3d4ac with catch @ 00f3d538 */
  ...
  if ((*(ulong *)(this + 0x10) & 1) != 0) {
    UNRECOVERED_JUMPTABLE = *(code **)(UNRECOVERED_JUMPTABLE + *plVar1);
                    ...
                    /* WARNING: Could not recover jumptable at 0x00f3d54c. Too many branches */
