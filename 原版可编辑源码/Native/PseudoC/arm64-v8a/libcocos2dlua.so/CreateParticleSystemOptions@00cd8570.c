...
/* flatbuffers::CreateParticleSystemOptions(flatbuffers::FlatBufferBuilder&,
   flatbuffers::Offset<flatbuffers::WidgetOptions>, flatbuffers::Offset<flatbuffers::ResourceData>,
   flatbuffers::BlendFunc const*) */

undefined4
flatbuffers::CreateParticleSystemOptions
          (FlatBufferBuilder *param_1,int param_2,int param_3,BlendFunc *param_4)
