...
/* void std::__ndk1::vector<cocostudio::DisplayData*,
   std::__ndk1::allocator<cocostudio::DisplayData*>
   >::__push_back_slow_path<cocostudio::DisplayData* const&>(cocostudio::DisplayData* const&) */
...
__push_back_slow_path<cocostudio::DisplayData*const&>
          (vector<cocostudio::DisplayData*,std::__ndk1::allocator<cocostudio::DisplayData*>> *this,
          DisplayData **param_1)
