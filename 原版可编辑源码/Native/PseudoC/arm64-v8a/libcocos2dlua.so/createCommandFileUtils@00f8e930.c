...
/* cocos2d::Console::createCommandFileUtils() */

void __thiscall cocos2d::Console::createCommandFileUtils(Console *this)

{
  ...
  basic_string<decltype(nullptr)>(local_118,"fileutils");
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string<decltype(nullptr)>
            (local_130,"Flush or print the FileUtils info. Args: [-h | help | flush | ]");
  local_e0 = &local_100;
  local_100 = &PTR_FUN_017223e0;
  uStack_f0 = 0;
  local_f8 = commandFileUtils;
  local_e8 = this;
...
LAB_00f8e9f0:
  ...
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string<decltype(nullptr)>(local_148,"Purges the file searching cache.");
  local_100 = &PTR_FUN_017223e0;
  local_e0 = &local_100;
  uStack_f0 = 0;
  local_f8 = commandFileUtilsSubCommandFlush;
  local_e8 = this;
  ...
  if (&local_100 == local_e0) {
    ...
    if (local_e0 == (undefined ***)0x0) goto LAB_00f8eacc;
    pcVar3 = (code *)(*local_e0)[5];
  }
  (*pcVar3)();
LAB_00f8eacc:
