...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::Primitive*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::Primitive*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::Primitive*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::Primitive*>>>
           *this,ulong param_1)

{
  ...
  ulong uVar12;
                    ...
                    /* try { // try from 00efb788 to 00ffb86b has its CatchHandler @ 00efb788
                       catch() { ... } // from try @ 00efb788 with catch @ 00efb788
                       catch() { ... } // from try @ 00efb8bc with catch @ 00efb788
                       catch() { ... } // from try @ 00efbb70 with catch @ 00efb788 */
  if (param_1 == 0) {
    pvVar2 = *(void **)this;
    *(undefined8 *)this = 0;
    if (pvVar2 != (void *)0x0) {
        ...
        do {
          ...
          if ((uVar12 & 0xffffffff) < 2) {
            ...
            uVar7 = uVar7 - uVar1 * param_1;
                    /* try { // try from 00efb86c to 00ffb873 has its CatchHandler @ 00efbb90 */
          }
          if (uVar7 != uVar4) {
            plVar9 = plVar6;
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) {
              ...
              *plVar5 = (long)plVar9;
                    /* try { // try from 00efb8b4 to 00ffb8bb has its CatchHandler @ 00efbba0 */
                    /* try { // try from 00efb8bc to 00ffbb57 has its CatchHandler @ 00efb788 */
