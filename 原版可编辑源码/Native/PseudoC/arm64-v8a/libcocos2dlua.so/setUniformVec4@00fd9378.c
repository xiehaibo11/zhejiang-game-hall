...
/* cocos2d::GLProgramState::setUniformVec4(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, cocos2d::Vec4 const&) */

void __thiscall
cocos2d::GLProgramState::setUniformVec4(GLProgramState *this,basic_string *param_1,Vec4 *param_2)
