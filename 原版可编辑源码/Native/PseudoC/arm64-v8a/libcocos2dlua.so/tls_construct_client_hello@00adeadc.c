...

{
  ...
  iVar2 = ssl_set_client_hello_version();
                    /* try { // try from 00adeb14 to 00bdeb1f has its CatchHandler @ 00adeb5c */
  if (iVar2 == 0) {
    ...
    p_Var7 = param_1->method->get_timeout;
                    /* catch() { ... } // from try @ 00adee20 with catch @ 00adec40 */
    ...
    *(undefined8 *)(puVar1 + 2) = uVar14;
    if (param_1->new_session == 0) {
                    /* try { // try from 00aded68 to 00bded73 has its CatchHandler @ 00adee78 */
    ...
    if (((byte)param_1->method->get_timeout[0x68] >> 3 & 1) != 0) {
                    /* try { // try from 00aded40 to 00bded63 has its CatchHandler @ 00adee80 */
      ...
      *__dest = (char)*(uint *)(param_1->msg_callback + 0x100);
                    /* try { // try from 00adeda8 to 00bdedcb has its CatchHandler @ 00adee7c */
...
LAB_00adeea8:
        ...
        do {
          ...
          if (iVar4 == 0) {
                    /* try { // try from 00adee18 to 00bdee1f has its CatchHandler @ 00adee84 */
                    /* try { // try from 00adee20 to 00bdeebf has its CatchHandler @ 00adec40 */
        ...
        if (lVar8 == 2) goto LAB_00adeea8;
        puVar12 = __dest + lVar8;
        if (iVar2 == 0) {
          iVar2 = (*param_1->method->put_cipher_by_char)((SSL_CIPHER *)&DAT_0176c4c0,puVar12);
          puVar12 = puVar12 + iVar2;
        }
        if (-1 < *(char *)&param_1->tlsext_hostname) goto LAB_00adeea8;
                    /* catch() { ... } // from try @ 00aded68 with catch @ 00adee78 */
                    /* catch() { ... } // from try @ 00adeda8 with catch @ 00adee7c */
                    /* catch() { ... } // from try @ 00aded40 with catch @ 00adee80 */
                    /* catch() { ... } // from try @ 00adee18 with catch @ 00adee84 */
        iVar2 = (*param_1->method->put_cipher_by_char)((SSL_CIPHER *)&DAT_0176c508,puVar12);
    ...
    iVar3 = 0x32f;
                    ...
                    /* try { // try from 00adeb20 to 00bdeb5f has its CatchHandler @ 00adea40 */
    iVar3 = 0x2c5;
  }
LAB_00adeb34:
...
LAB_00adeb38:
  ossl_statem_set_error(param_1);
                    /* catch() { ... } // from try @ 00adeb14 with catch @ 00adeb5c */
  return 0;
}
