...
undefined8 FUN_008c5244(undefined8 param_1)

{
  ...
  long local_68;
                    ...
                    /* try { // try from 008c5260 to 009c5273 has its CatchHandler @ 008c52f8 */
  lVar2 = tpidr_el0;
  local_68 = *(long *)(lVar2 + 0x28);
                    /* try { // try from 008c5278 to 009c52ab has its CatchHandler @ 008c52fc */
  iVar3 = tolua_isnumber(param_1,1,0,auStack_78);
                    /* try { // try from 008c52ac to 009c5347 has its CatchHandler @ 008c5178 */
  if ((((iVar3 == 0) || (iVar3 = tolua_isnumber(param_1,2,0,auStack_78), iVar3 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glUniform2iv\'.",auStack_78);
  }
  else {
    dVar7 = (double)tolua_tonumber(0,param_1,1);
                    /* catch() { ... } // from try @ 008c5260 with catch @ 008c52f8 */
                    /* catch() { ... } // from try @ 008c5278 with catch @ 008c52fc */
    dVar8 = (double)tolua_tonumber(0,param_1,2);
    dVar9 = (double)tolua_tonumber(0,param_1,3);
    uVar6 = (uint)dVar9;
                    /* catch() { ... } // from try @ 008c522c with catch @ 008c532c */
    ...
    if (pvVar4 != (void *)0x0) {
      ...
      glUniform2iv((int)dVar7,(int)dVar8,pvVar4);
