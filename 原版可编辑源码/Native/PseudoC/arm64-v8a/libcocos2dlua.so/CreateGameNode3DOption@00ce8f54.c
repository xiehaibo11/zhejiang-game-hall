...
/* flatbuffers::CreateGameNode3DOption(flatbuffers::FlatBufferBuilder&,
   flatbuffers::Offset<flatbuffers::String>, int, unsigned char,
   flatbuffers::Offset<flatbuffers::ResourceData>, flatbuffers::Offset<flatbuffers::ResourceData>,
   flatbuffers::Offset<flatbuffers::ResourceData>, flatbuffers::Offset<flatbuffers::ResourceData>,
   flatbuffers::Offset<flatbuffers::ResourceData>, flatbuffers::Offset<flatbuffers::ResourceData>,
   flatbuffers::Offset<flatbuffers::String>, flatbuffers::Offset<flatbuffers::String>, unsigned
   char) */

undefined4
flatbuffers::CreateGameNode3DOption
          (FlatBufferBuilder *param_1,int param_2,int param_3,uchar param_4,int param_5,int param_6,
          int param_7,int param_8,int param_9,int param_10,int param_11,int param_12,uchar param_13)

{
  ...
  FlatBufferBuilder::AddElement<int>(param_1,6,param_3,0);
  if (param_2 != 0) {
    FlatBufferBuilder::Align(param_1,4);
    uVar1 = (((*(int *)(param_1 + 8) - *(int *)(param_1 + 0x18)) + *(int *)(param_1 + 0x10)) -
            param_2) + 4;
