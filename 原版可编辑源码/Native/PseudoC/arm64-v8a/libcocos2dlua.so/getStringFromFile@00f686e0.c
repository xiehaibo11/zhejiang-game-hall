...
void __thiscall
cocos2d::FileUtils::getStringFromFile(FileUtils *this,undefined8 param_2,long *param_3)

{
  ...
  if ((local_198 & 1) == 0) {
    ...
    if (uStack_190 < 0x17) {
      ...
      if (uStack_190 != 0) goto LAB_00f68790;
    }
    else {
...
LAB_00f6898c:
  ...
  if (alStack_90 == local_70) {
    ...
    if (local_70 == (long *)0x0) goto LAB_00f689b8;
