  ...
  if (s != (uchar *)0x0) {
    ...
    if ((uint)(*(int *)(param_3 + 1) << 3) < 0x61) {
      ...
      if (pBVar5 != (BIGNUM *)0x0) {
                    /* try { // try from 00b99420 to 00c99427 has its CatchHandler @ 00b998fc */
...
LAB_00b99434:
  bVar2 = false;
LAB_00b99438:
                    /* try { // try from 00b99440 to 00c99447 has its CatchHandler @ 00b998c8 */
  CRYPTO_free(s);
  OPENSSL_cleanse(auStack_21c,0x60);
                    /* try { // try from 00b99464 to 00c9946b has its CatchHandler @ 00b99894 */
                    /* try { // try from 00b9946c to 00c994f3 has its CatchHandler @ 00b99230 */
  return bVar2;
}
