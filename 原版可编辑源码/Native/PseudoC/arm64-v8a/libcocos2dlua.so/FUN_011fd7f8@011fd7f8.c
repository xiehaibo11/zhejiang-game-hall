...
int FUN_011fd7f8(byte *param_1,byte *param_2,ulong param_3,ulong param_4,uint param_5)
      ...
      if ((char)bVar3 < '\0') {
        ...
        if (bVar3 < 0xe0) {
          if ((((long)param_2 - (long)pbVar4 < 2) || ((pbVar4[1] & 0xc0) != 0x80)) ||
             (param_4 < (((ulong)bVar3 & 0x1f) << 6 | (ulong)pbVar4[1] & 0x3f))) break;
          pbVar4 = pbVar4 + 2;
        }
        else if (bVar3 < 0xf0) {
...
joined_r0x011fd950:
            ...
            if (bVar3 != 0xe0) {
              bVar1 = bVar2 & 0xc0;
              goto joined_r0x011fd950;
            }
            if ((bVar2 & 0xe0) != 0xa0) break;
          }
          if (((pbVar4[2] & 0xc0) != 0x80) ||
             (param_4 < (((ulong)bVar3 & 0xf) << 0xc | ((ulong)bVar2 & 0x3f) << 6 |
                        (ulong)pbVar4[2] & 0x3f))) break;
          pbVar4 = pbVar4 + 3;
        }
        else {
          if ((0xf4 < bVar3) || ((long)param_2 - (long)pbVar4 < 4)) break;
          bVar2 = pbVar4[1];
          if (bVar3 == 0xf4) {
            bVar1 = bVar2 & 0xf0;
joined_r0x011fd9a4:
            ...
            if (bVar3 != 0xf0) {
              bVar1 = bVar2 & 0xc0;
              goto joined_r0x011fd9a4;
            }
            if (0x2f < (byte)(bVar2 + 0x70)) break;
          }
          if ((((pbVar4[2] & 0xc0) != 0x80) || ((pbVar4[3] & 0xc0) != 0x80)) ||
             (param_4 < (((ulong)bVar3 & 7) << 0x12 | ((ulong)bVar2 & 0x3f) << 0xc |
                         ((ulong)pbVar4[2] & 0x3f) << 6 | (ulong)pbVar4[3] & 0x3f))) break;
          pbVar4 = pbVar4 + 4;
        }
      }
      else {
        if (param_4 < bVar3) break;
        pbVar4 = pbVar4 + 1;
      }
      if ((param_3 <= uVar5) || (uVar5 = uVar5 + 1, param_2 <= pbVar4)) break;
    } while( true );
  }
