...
/* cocos2d::ui::Slider::loadSlidBallTexturePressed(std::__ndk1::basic_string<char,
...

{
  ...
  if ((basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
    ...
    assign((basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
           (this + 0x640),(char *)pbVar2,uVar1);
  }
  bVar3 = *param_1;
  uVar6 = *(ulong *)(param_1 + 8);
  *(int *)(this + 0x5ec) = param_3;
  uVar1 = (ulong)((byte)bVar3 >> 1);
  if (((byte)bVar3 & 1) != 0) {
    uVar1 = uVar6;
  }
  this[0x56c] = (Slider)(uVar1 != 0);
  uVar1 = (ulong)((byte)*param_1 >> 1);
  if (((byte)*param_1 & 1) != 0) {
    uVar1 = *(ulong *)(param_1 + 8);
  }
  if (uVar1 == 0) {
    (**(code **)(**(long **)(this + 0x538) + 0x500))();
  }
  else {
    if (param_3 == 1) {
      ...
      if (param_3 != 0) goto LAB_00dcc774;
      plVar4 = *(long **)(this + 0x538);
