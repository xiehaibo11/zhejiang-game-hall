...
void FUN_00dda2d0(undefined8 *param_1)

{
  ...
  local_50 = (void *)0x0;
  local_40 = 0x3f800000;
  local_90 = cocos2d::ui::RichText::KEY_TEXT_ITALIC;
                    /* try { // try from 00dda310 to 00eda31b has its CatchHandler @ 00dda4d4 */
  lVar6 = std::__ndk1::
          ...
          __emplace_unique_key_args<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&>,std::__ndk1::tuple<>>
                    ((basic_string *)&local_60,
                     (piecewise_construct_t *)cocos2d::ui::RichText::KEY_TEXT_ITALIC,
  ...
  while (puVar3 != (void *)0x0) {
    ...
    if ((*(byte *)(puVar3 + 2) & 1) != 0) {
      operator_delete((void *)puVar3[4]);
                    ...
                    /* try { // try from 00dda354 to 00eda3eb has its CatchHandler @ 00dda488 */
  ...
  *(undefined4 *)(param_1 + 4) = local_70;
  ...
  if (*(long *)(lVar2 + 0x28) == local_38) {
                    /* catch() { ... } // from try @ 00dda184 with catch @ 00dda460 */
    return;
  }
                    /* WARNING: Subroutine does not return */
                    /* catch() { ... } // from try @ 00dd9fe4 with catch @ 00dda464 */
  __stack_chk_fail();
}
