...
/* cocos2d::ui::Scale9Sprite::create(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&, cocos2d::Rect const&, cocos2d::Rect const&) */

Sprite * cocos2d::ui::Scale9Sprite::create(basic_string *param_1,Rect *param_2,Rect *param_3)

{
  ...
  if (this != (Sprite *)0x0) {
    ...
    *(undefined8 *)(this + 0x540) = 0x100000000;
    uVar1 = initWithFile((Scale9Sprite *)this,param_1,param_2,param_3);
    if ((uVar1 & 1) == 0) {
