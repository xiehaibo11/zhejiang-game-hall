...
/* cocos2d::PUBillboardChain::init(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&) */

void __thiscall cocos2d::PUBillboardChain::init(PUBillboardChain *this,basic_string *param_1)

{
  ...
  *(undefined2 *)(this_03 + 0x10) = 0x101;
  ...
  RenderState::StateBlock::setCullFace(*(StateBlock **)(this + 0x78),true);
