...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00fd1b0c to 010d1b13 has its CatchHandler @ 00fd1b84 */
                    /* try { // try from 00fd1b14 to 010d1b9f has its CatchHandler @ 00fd1adc */
  lVar5 = tpidr_el0;
  ...
  if (uVar12 != 0) {
    ...
    if (uVar13 < 2) {
                    /* catch() { ... } // from try @ 00fd1b0c with catch @ 00fd1b84 */
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00fd1bd0;
              goto LAB_00fd1c80;
            }
            if (uVar9 != uVar14) goto LAB_00fd1c80;
          }
LAB_00fd1bd0:
          plVar8 = (long *)*plVar8;
...
LAB_00fd1c80:
  plVar8 = (long *)0x0;
LAB_00fd1c84:
                    /* catch() { ... } // from try @ 00fd1cbc with catch @ 00fd1c84 */
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* try { // try from 00fd1cb4 to 010d1cbb has its CatchHandler @ 00fd1d2c */
    return plVar8;
  }
