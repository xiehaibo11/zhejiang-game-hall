...
/* std::__ndk1::__tree<std::__ndk1::__value_type<unsigned long, unsigned int>,
   std::__ndk1::__map_value_compare<unsigned long, std::__ndk1::__value_type<unsigned long, unsigned
   int>, std::__ndk1::less<unsigned long>, true>,
   std::__ndk1::allocator<std::__ndk1::__value_type<unsigned long, unsigned int> >
   >::destroy(std::__ndk1::__tree_node<std::__ndk1::__value_type<unsigned long, unsigned int>,
   void*>*) */
