...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void (cocos2d::TransitionScene::*)(),
   ...
   (cocos2d::TransitionScene::*)(), cocos2d::TransitionZoomFlipY*> >, void ()>::target_type() const
    */
...
{
  return &__bind<void(cocos2d::TransitionScene::*)(),cocos2d::TransitionZoomFlipY*>::typeinfo;
}
