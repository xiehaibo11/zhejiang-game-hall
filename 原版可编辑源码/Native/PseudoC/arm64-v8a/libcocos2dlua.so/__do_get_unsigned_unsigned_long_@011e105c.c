...

{
  ...
  plVar10 = param_2;
  local_1b8 = pcVar11;
  if (param_2 != (long *)0x0) goto LAB_011e1140;
LAB_011e1154:
  bVar3 = true;
  if (param_3 != (long *)0x0) goto LAB_011e1180;
  do {
    param_3 = (long *)0x0;
    if (bVar3) {
LAB_011e12ac:
      ...
      uVar7 = FUN_01208acc(pcVar11,local_1b8,param_5,iVar6);
      *param_6 = uVar7;
      __check_grouping(local_198,local_178,local_1c0,param_5);
      if (param_2 == (long *)0x0) {
        bVar3 = true;
        if (param_3 == (long *)0x0) goto LAB_011e1338;
LAB_011e1360:
        ...
        if (bVar3 != (iVar6 == -1)) goto LAB_011e13a0;
      }
      else {
        ...
        param_2 = plVar10;
        if (param_3 != (long *)0x0) goto LAB_011e1360;
LAB_011e1338:
        if (!bVar3) goto LAB_011e13a0;
      }
      *param_5 = *param_5 | 2;
LAB_011e13a0:
      if ((local_1b0 & 1) != 0) {
    ...
    while( true ) {
      ...
      plVar10 = param_2;
      if (param_2 == (long *)0x0) goto LAB_011e1154;
LAB_011e1140:
