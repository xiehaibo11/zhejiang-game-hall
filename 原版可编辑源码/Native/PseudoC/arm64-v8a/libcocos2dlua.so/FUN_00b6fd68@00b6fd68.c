...
uint FUN_00b6fd68(long param_1,int param_2)

{
  ...
  long lVar9;
                    ...
                    /* try { // try from 00b6fd6c to 00c6fd6f has its CatchHandler @ 00b6fdb0 */
  lVar9 = *(long *)(param_1 + 0xe8);
  iVar2 = OPENSSL_sk_num(*(undefined8 *)(param_1 + 0x98));
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b6fd6c with catch @ 00b6fdb0
                        */
  if (((((lVar9 != 0) && (param_2 < iVar2)) && (0 < param_2)) &&
     ...
     (((*(byte *)(*(long *)(param_1 + 0xe8) + 0x28) & 5) != 0 &&
      (lVar5 = OPENSSL_sk_value(*(undefined8 *)(param_1 + 0x98),param_2), lVar5 != 0)))) {
                    /* try { // try from 00b6fde8 to 00c6fdeb has its CatchHandler @ 00b6fe2c */
    iVar3 = FUN_00b7003c(*(undefined4 *)(param_1 + 0x94),*(undefined8 *)(param_1 + 0xe8),lVar5,
                         param_2);
    if (iVar3 < 0) {
      return 2;
    }
  ...
  if (param_2 < iVar2) {
    do {
      x = (X509 *)OPENSSL_sk_value(*(undefined8 *)(param_1 + 0x98),iVar3);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b6fde8 with catch @ 00b6fe2c
                        */
      iVar4 = X509_check_trust(x,*(int *)(*(long *)(param_1 + 0x20) + 0x24),0);
      if (iVar4 == 1) goto LAB_00b6fff0;
      if (iVar4 == 2) goto LAB_00b6ff68;
      iVar3 = iVar3 + 1;
    } while (iVar3 < iVar2);
    if (param_2 < iVar2) {
      uVar7 = (uint)*(undefined8 *)(*(long *)(param_1 + 0x20) + 0x18);
                    /* try { // try from 00b6fe64 to 00c6fe67 has its CatchHandler @ 00b6fea8 */
  ...
  pXVar6 = X509_get_subject_name(x);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b6fe64 with catch @ 00b6fea8
                        */
  ...
  if (iVar2 < 1) {
    ...
    do {
      ...
      iVar3 = OPENSSL_sk_num(lVar5);
                    ...
                    /* try { // try from 00b6ff14 to 00c6ff17 has its CatchHandler @ 00b700bc */
  iVar3 = OPENSSL_sk_num(lVar5);
  if (iVar3 <= iVar2) {
  ...
  if (a == (X509 *)0x0) {
    return 3;
                    ...
                    /* try { // try from 00b6ff40 to 00c6ff43 has its CatchHandler @ 00b70100 */
...
LAB_00b6ff68:
    *(int *)(param_1 + 0xac) = iVar3;
    if (x == (X509 *)0x0) {
                    /* try { // try from 00b6ff70 to 00c6ff73 has its CatchHandler @ 00b700fc */
      x = (X509 *)OPENSSL_sk_value(*(undefined8 *)(param_1 + 0x98),iVar3);
    }
                    /* try { // try from 00b6ff90 to 00c6fff3 has its CatchHandler @ 00b700b8 */
    *(X509 **)(param_1 + 0xb8) = x;
...
LAB_00b6fff4:
  ...
  if (iVar2 < 1) {
    return 1;
                    ...
                    /* try { // try from 00b70008 to 00c7000b has its CatchHandler @ 00b700e8 */
  if (*(int *)(lVar9 + 0x30) < 0) {
