...

{
  ...
  if (param_2 == param_3) goto LAB_00f28dd4;
  cVar3 = *param_2;
  if (cVar3 < '\\') {
    if (cVar3 != '$') {
      if ((((cVar3 != '(') || (param_2 + 1 == param_3)) || (param_2[1] != '?')) ||
         (param_2 + 2 == param_3)) goto LAB_00f28dd4;
      cVar3 = param_2[2];
      if (cVar3 == '!') {
        ...
        *puVar7 = &PTR____lookahead_016f4f60;
        puVar7[1] = uVar8;
        ...
        *(undefined8 *)(this + 0x38) = uVar8;
        ...
        param_2 = param_2 + 1;
        if (local_78 != (__shared_weak_count *)0x0) {
                    /* try { // try from 00f28fc8 to 01028fcf has its CatchHandler @ 00f290a8 */
          p_Var1 = local_78 + 8;
          do {
            lVar9 = *(long *)p_Var1;
                    /* try { // try from 00f28fd0 to 0102903b has its CatchHandler @ 00f28e24 */
            cVar3 = '\x01';
            bVar4 = (bool)ExclusiveMonitorPass(p_Var1,0x10);
            if (bVar4) {
              *(long *)p_Var1 = lVar9 + -1;
...
LAB_00f28fdc:
        ...
        *(undefined8 **)(*(long *)(this + 0x38) + 8) = puVar7;
        uVar8 = *(undefined8 *)(*(long *)(this + 0x38) + 8);
        *(int *)(this + 0x1c) = *(int *)(this + 0x1c) + iVar6;
                    /* catch() { ... } // from try @ 00f28d68 with catch @ 00f28d3c */
        *(undefined8 *)(this + 0x38) = uVar8;
        if ((param_2 == param_3) || (*param_2 != ')')) {
                    /* WARNING: Subroutine does not return */
          FUN_00ea9db4();
        ...
        if (local_78 != (__shared_weak_count *)0x0) {
          p_Var1 = local_78 + 8;
          do {
                    /* try { // try from 00f28d60 to 01028d67 has its CatchHandler @ 00f28d80 */
            lVar9 = *(long *)p_Var1;
                    /* try { // try from 00f28d68 to 01028d9b has its CatchHandler @ 00f28d3c */
            cVar3 = '\x01';
            bVar4 = (bool)ExclusiveMonitorPass(p_Var1,0x10);
            if (bVar4) {
              *(long *)p_Var1 = lVar9 + -1;
...
LAB_00f28db8:
    ...
    *(undefined8 **)(lVar9 + 8) = puVar7;
    ...
    if (cVar3 != '\\') {
                    /* catch() { ... } // from try @ 00f28d60 with catch @ 00f28d80 */
      if (cVar3 != '^') goto LAB_00f28dd4;
      puVar7 = operator_new(0x10);
      lVar9 = *(long *)(this + 0x38);
      uVar8 = *(undefined8 *)(lVar9 + 8);
    ...
    if (param_2 + 1 == param_3) goto LAB_00f28dd4;
    cVar3 = param_2[1];
    if (cVar3 == 'B') {
      puVar7 = operator_new(0x30);
      uVar8 = *(undefined8 *)(*(long *)(this + 0x38) + 8);
      *puVar7 = &PTR____word_boundary_016f4f18;
      puVar7[1] = uVar8;
      ...
      *(undefined1 *)(puVar7 + 5) = 1;
                    ...
                    /* try { // try from 00f28e24 to 01028fc7 has its CatchHandler @ 00f28e24
                       catch() { ... } // from try @ 00f28e24 with catch @ 00f28e24
                       catch() { ... } // from try @ 00f28fd0 with catch @ 00f28e24
                       catch() { ... } // from try @ 00f29044 with catch @ 00f28e24 */
      if (cVar3 != 'b') goto LAB_00f28dd4;
      puVar7 = operator_new(0x30);
      uVar8 = *(undefined8 *)(*(long *)(this + 0x38) + 8);
      *puVar7 = &PTR____word_boundary_016f4f18;
      puVar7[1] = uVar8;
