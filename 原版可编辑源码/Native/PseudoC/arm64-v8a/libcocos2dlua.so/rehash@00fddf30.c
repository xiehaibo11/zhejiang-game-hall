...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int, bool>,
   ...
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<int, bool> > >::rehash(unsigned long) */
...

{
  ...
  if (param_1 - 1 == 0) {
    param_1 = 2;
                    ...
                    /* try { // try from 00fddf60 to 010ddf67 has its CatchHandler @ 00fde0a4 */
    param_1 = __next_prime(param_1);
                    /* try { // try from 00fddf68 to 010ddfff has its CatchHandler @ 00fddedc */
  }
  uVar2 = *(ulong *)(this + 8);
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00fddff4;
    }
                    /* try { // try from 00fde008 to 010de0bf has its CatchHandler @ 00fddedc */
    return;
  }
LAB_00fddff4:
                    /* try { // try from 00fde000 to 010de007 has its CatchHandler @ 00fde090 */
