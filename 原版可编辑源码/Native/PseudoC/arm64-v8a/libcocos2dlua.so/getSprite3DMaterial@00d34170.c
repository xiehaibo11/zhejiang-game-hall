...
/* cocos2d::Sprite3DMaterialCache::getSprite3DMaterial(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

undefined8 __thiscall
cocos2d::Sprite3DMaterialCache::getSprite3DMaterial
          (Sprite3DMaterialCache *this,basic_string *param_1)
