...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, MyXMLVisitor::TagBehavior>,
   std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> >, MyXMLVisitor::TagBehavior>,
...

{
  ...
  if (plVar5 != param_2 + 2) {
    uVar7 = plVar5[1];
                    /* try { // try from 00ddd004 to 00edd047 has its CatchHandler @ 00ddd284 */
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
    }
    else if (uVar3 <= uVar7) {
    ...
    if (uVar7 == uVar4) goto LAB_00ddd078;
  }
  if (*param_3 != 0) {
    ...
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
                    ...
                    /* try { // try from 00ddd048 to 00edd08b has its CatchHandler @ 00ddbfd8 */
      if (uVar3 <= uVar7) {
        uVar1 = 0;
        if (uVar3 != 0) {
          uVar1 = uVar7 / uVar3;
...
LAB_00ddd078:
  if (*param_3 != 0) {
    uVar7 = *(ulong *)(*param_3 + 8);
    if (uVar6 < 2) {
                    /* try { // try from 00ddd0ac to 00edd0b3 has its CatchHandler @ 00ddd25c */
      uVar7 = uVar7 & uVar3 - 1;
    }
    else {
                    /* try { // try from 00ddd08c to 00edd093 has its CatchHandler @ 00ddd26c */
      if (uVar3 <= uVar7) {
                    /* try { // try from 00ddd094 to 00edd09b has its CatchHandler @ 00ddd264 */
        uVar6 = 0;
        if (uVar3 != 0) {
          uVar6 = uVar7 / uVar3;
        }
        uVar7 = uVar7 - uVar6 * uVar3;
                    /* try { // try from 00ddd09c to 00edd0a3 has its CatchHandler @ 00ddd270 */
      }
    }
                    /* try { // try from 00ddd0b4 to 00edd0bb has its CatchHandler @ 00ddd270 */
    if (uVar7 != uVar4) {
                    /* try { // try from 00ddd0bc to 00edd0c3 has its CatchHandler @ 00ddd258 */
      *(long **)(*param_2 + uVar7 * 8) = plVar5;
    }
  }
                    /* try { // try from 00ddd0c4 to 00edd0cb has its CatchHandler @ 00ddd254 */
  *plVar5 = *param_3;
                    /* try { // try from 00ddd0cc to 00edd0d3 has its CatchHandler @ 00ddd250 */
  *param_3 = 0;
                    /* try { // try from 00ddd0d4 to 00edd0db has its CatchHandler @ 00ddd24c */
  param_2[3] = param_2[3] + -1;
                    /* try { // try from 00ddd0dc to 00edd0e3 has its CatchHandler @ 00ddd248 */
  *param_1 = param_3;
  param_1[1] = param_2 + 2;
  *(undefined1 *)(param_1 + 2) = 1;
                    /* try { // try from 00ddd0e4 to 00edd0eb has its CatchHandler @ 00ddd244 */
  return;
}
