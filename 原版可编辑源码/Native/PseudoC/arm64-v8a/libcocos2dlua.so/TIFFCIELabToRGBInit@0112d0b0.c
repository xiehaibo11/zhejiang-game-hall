...

{
  ...
  float fVar8;
                    ...
                    /* try { // try from 0112d0d0 to 0122d13f has its CatchHandler @ 0112d180 */
  *param_1 = 0x5dc;
  ...
  if (-1 < (int)uVar2) {
    ...
    do {
      ...
      dVar6 = pow((double)(int)lVar4 / (double)(int)uVar3,1.0 / (double)fVar8);
                    /* try { // try from 0112d140 to 0122d19b has its CatchHandler @ 0112cfec */
  ...
  if (-1 < (int)uVar3) {
                    /* catch() { ... } // from try @ 0112d018 with catch @ 0112d178 */
                    /* catch() { ... } // from try @ 0112d084 with catch @ 0112d17c */
                    /* catch() { ... } // from try @ 0112d0d0 with catch @ 0112d180 */
    lVar4 = 0;
    do {
