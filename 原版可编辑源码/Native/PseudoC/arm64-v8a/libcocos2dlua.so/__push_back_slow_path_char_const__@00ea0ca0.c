...
/* void std::__ndk1::vector<char*, std::__ndk1::allocator<char*> >::__push_back_slow_path<char*
   const&>(char* const&) */

void __thiscall
std::__ndk1::vector<char*,std::__ndk1::allocator<char*>>::__push_back_slow_path<char*const&>
          (vector<char*,std::__ndk1::allocator<char*>> *this,char **param_1)
