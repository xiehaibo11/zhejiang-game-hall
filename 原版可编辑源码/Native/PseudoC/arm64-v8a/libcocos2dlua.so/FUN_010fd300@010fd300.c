...
void FUN_010fd300(long *param_1)

{
  ...
  undefined1 auVar53 [16];
                    ...
                    /* catch() { ... } // from try @ 010fd26c with catch @ 010fd320 */
                    /* catch() { ... } // from try @ 010fd290 with catch @ 010fd334 */
  if (0 < (int)param_1[7]) {
    lVar29 = param_1[0x4f];
    lVar30 = param_1[0x26];
                    /* try { // try from 010fd368 to 011fd38f has its CatchHandler @ 010fd368
                       catch() { ... } // from try @ 010fd368 with catch @ 010fd368
                       catch() { ... } // from try @ 010fd3a0 with catch @ 010fd368 */
                    /* try { // try from 010fd390 to 011fd39f has its CatchHandler @ 010fd3ac */
                    /* try { // try from 010fd3a0 to 011fd3bf has its CatchHandler @ 010fd368 */
                    /* catch() { ... } // from try @ 010fd390 with catch @ 010fd3ac */
                    /* try { // try from 010fd3e4 to 011fd3e7 has its CatchHandler @ 010fd3f8 */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010fd3e4 with catch @ 010fd3f8
                        */
                    /* try { // try from 010fd430 to 011fd433 has its CatchHandler @ 010fd44c */
    lVar28 = 0;
    uVar32 = 0;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010fd430 with catch @ 010fd44c
                        */
    pcVar31 = (code *)0x0;
                    /* catch() { ... } // from try @ 010fd4bc with catch @ 010fd460 */
                    /* try { // try from 010fd490 to 011fd497 has its CatchHandler @ 010fd4d0 */
                    /* try { // try from 010fd4ac to 011fd4bb has its CatchHandler @ 010fd4d8 */
    do {
      iVar3 = *(int *)(lVar30 + 0x24);
                    /* try { // try from 010fd4bc to 011fd4fb has its CatchHandler @ 010fd460 */
      iVar2 = *(int *)(lVar30 + 0x28) + iVar3 * 0x100;
      if (iVar2 < 0x70e) {
        if (iVar2 < 0x404) {
                    /* catch() { ... } // from try @ 010fd490 with catch @ 010fd4d0 */
          if (iVar2 < 0x204) {
                    /* catch() { ... } // from try @ 010fd4ac with catch @ 010fd4d8 */
            if (iVar2 < 0x201) {
              if (iVar2 == 0x101) {
...
LAB_010fd850:
              ...
              if (iVar2 != 0x202) goto LAB_010fd850;
            ...
            if (iVar2 == 0x204) {
              ...
              if (iVar2 != 0x303) goto LAB_010fd850;
            ...
            if (iVar2 != 0x402) goto LAB_010fd850;
          ...
          if (iVar2 < 0x505) {
            if (iVar2 == 0x404) {
              ...
              if (iVar2 != 0x408) goto LAB_010fd850;
            ...
            if (iVar2 != 0x50a) goto LAB_010fd850;
          ...
          if (iVar2 == 0x603) {
            ...
            if (iVar2 != 0x606) goto LAB_010fd850;
          ...
          uVar32 = 0;
                    ...
                    /* try { // try from 010fd700 to 011fd717 has its CatchHandler @ 010fd758 */
          if (iVar2 != 0x707) goto LAB_010fd850;
        ...
        if (iVar2 < 0x909) {
          if (iVar2 < 0x808) {
            if (iVar2 == 0x70e) {
              ...
              uVar32 = 0;
                    /* catch() { ... } // from try @ 010fd700 with catch @ 010fd758 */
            }
            else {
              if (iVar2 != 0x804) goto LAB_010fd850;
            ...
            if (uVar4 < 3) {
              pcVar31 = (code *)(&PTR_jpeg_idct_islow_0172cea0)[(int)uVar4];
              uVar32 = uVar4;
            }
            else {
              puVar21 = (undefined8 *)*param_1;
            ...
            if (iVar2 != 0x810) goto LAB_010fd850;
          ...
          if (iVar2 == 0x909) {
            ...
            if (iVar2 != 0xa05) goto LAB_010fd850;
          ...
          if (iVar2 != 0xb0b) goto LAB_010fd850;
        ...
        if (iVar2 < 0xd0d) {
          if (iVar2 == 0xc06) {
            ...
            if (iVar2 != 0xc0c) goto LAB_010fd850;
          ...
          if (iVar2 != 0xe07) goto LAB_010fd850;
                    /* catch() { ... } // from try @ 010fd718 with catch @ 010fd6a8 */
        ...
        if (iVar2 == 0xe0e) {
          ...
          if (iVar2 != 0xf0f) goto LAB_010fd850;
          pcVar31 = jpeg_idct_15x15;
          uVar32 = 0;
        }
      }
      else {
                    /* try { // try from 010fd718 to 011fd773 has its CatchHandler @ 010fd6a8 */
        if (iVar2 == 0x1008) {
          pcVar31 = jpeg_idct_16x8;
          uVar32 = 0;
        }
        else {
          if (iVar2 != 0x1010) goto LAB_010fd850;
      ...
      if (((*(int *)(lVar30 + 0x34) != 0) &&
        ...
        *puVar23 = uVar32;
        if (uVar32 == 2) {
          ...
          do {
            dVar36 = *(double *)((long)&DAT_01478cf0 + lVar25);
            lVar25 = lVar25 + 8;
                    /* try { // try from 010fd9ac to 011fd9af has its CatchHandler @ 010fda5c */
            ...
            dVar51 = (double)NEON_ucvtf((ulong)puVar22[-2]);
                    /* try { // try from 010fd9f8 to 011fd9ff has its CatchHandler @ 010fda3c */
            pfVar27[-2] = (float)(dVar36 * dVar51 * 1.306562965 * 0.125);
                    /* try { // try from 010fda00 to 011fda77 has its CatchHandler @ 010fd960 */
            ...
            *pfVar27 = (float)(dVar36 * dVar51 * 0.125);
            dVar51 = (double)NEON_ucvtf((ulong)puVar22[1]);
                    /* catch() { ... } // from try @ 010fd9f8 with catch @ 010fda3c */
            pfVar27[1] = (float)(dVar36 * dVar51 * 0.785694958 * 0.125);
            dVar51 = (double)NEON_ucvtf((ulong)puVar22[2]);
                    /* catch() { ... } // from try @ 010fd9ac with catch @ 010fda5c */
          ...
          *puVar24 = uVar35;
          ...
          puVar24[0x16] = uVar35;
          uVar34 = puVar21[0xc];
                    /* catch() { ... } // from try @ 010fda00 with catch @ 010fd960 */
          uVar35 = CONCAT26(0,CONCAT24((short)((ulong)uVar34 >> 0x10),(uint)(ushort)uVar34));
