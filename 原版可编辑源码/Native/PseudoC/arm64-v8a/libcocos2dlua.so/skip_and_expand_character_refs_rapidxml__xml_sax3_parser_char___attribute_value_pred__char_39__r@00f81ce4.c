...
/* char* 
   rapidxml::xml_sax3_parser<char>::skip_and_expand_character_refs<rapidxml::xml_sax3_parser<char>::attribute_value_pred<(char)39>,
   rapidxml::xml_sax3_parser<char>::attribute_value_pure_pred<(char)39>, 1>(char*&) */

char * rapidxml::xml_sax3_parser<char>::
       skip_and_expand_character_refs<rapidxml::xml_sax3_parser<char>::attribute_value_pred<(char)39>,rapidxml::xml_sax3_parser<char>::attribute_value_pure_pred<(char)39>,1>
                 (char **param_1)

{
  ...
  do {
    pbVar5 = pbVar5 + 1;
  } while (internal::lookup_tables<0>::lookup_attribute_data_1_pure[*pbVar5] != '\0');
  *param_1 = (char *)pbVar5;
  local_70 = pbVar5;
LAB_00f81d74:
  bVar6 = *pbVar5;
  if (bVar6 != 0x26) {
    ...
    goto switchD_00f81dac_caseD_62;
  }
