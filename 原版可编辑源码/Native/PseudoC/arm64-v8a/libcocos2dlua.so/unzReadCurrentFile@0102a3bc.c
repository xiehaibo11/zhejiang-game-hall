...

{
  ...
  int iVar9;
                    ...
                    /* catch() { ... } // from try @ 0102a298 with catch @ 0102a3d0 */
                    /* catch() { ... } // from try @ 0102a07c with catch @ 0102a3d4 */
                    /* catch() { ... } // from try @ 0102a304 with catch @ 0102a3d8 */
  if ((param_1 == (void *)0x0) ||
    ...
    if (param_3 != 0) {
      ...
      *(uint *)(plVar8 + 5) = param_3;
      ...
      uVar5 = *(uint *)(plVar8 + 2);
      uVar6 = (ulong)uVar5;
                    /* catch() { ... } // from try @ 0102a198 with catch @ 0102a428 */
                    /* catch() { ... } // from try @ 0102a01c with catch @ 0102a42c
                       catch() { ... } // from try @ 0102a1bc with catch @ 0102a42c */
                    /* catch() { ... } // from try @ 0102a178 with catch @ 0102a430
                       catch() { ... } // from try @ 0102a234 with catch @ 0102a430 */
      ...
      if (param_3 != 0) {
        iVar9 = 0;
                    /* try { // try from 0102a44c to 0112a557 has its CatchHandler @ 0102a44c
                       catch() { ... } // from try @ 0102a44c with catch @ 0102a44c
                       catch() { ... } // from try @ 0102a6a8 with catch @ 0102a44c
                       catch() { ... } // from try @ 0102a6e8 with catch @ 0102a44c
                       catch() { ... } // from try @ 0102a6f8 with catch @ 0102a44c */
        if (uVar5 != 0) goto LAB_0102a568;
LAB_0102a464:
        uVar6 = plVar8[0x17];
        if (uVar6 == 0) {
                    /* try { // try from 0102a558 to 0112a567 has its CatchHandler @ 0102a730 */
          uVar6 = 0;
          lVar3 = plVar8[0x25];
        }
        else {
        ...
        uVar5 = (uint)uVar6;
        if (lVar3 == 0) goto LAB_0102a570;
        do {
          uVar5 = (uint)uVar6;
          if ((int)plVar8[0x27] != 0) goto LAB_0102a570;
          if (lVar3 != 0xc) {
            lVar7 = plVar8[6];
            lVar3 = plVar8[4];
          ...
          while( true ) {
            ...
            if (*(uint *)(plVar8 + 2) == 0) goto LAB_0102a464;
LAB_0102a568:
            uVar5 = (uint)uVar6;
            lVar3 = plVar8[0x25];
            if (lVar3 != 0) break;
LAB_0102a570:
            ...
            lVar3 = crc32(plVar8[0x15],plVar8[4],uVar1);
                    /* try { // try from 0102a5e4 to 0112a693 has its CatchHandler @ 0102a710 */
            plVar8[0x18] = plVar8[0x18] - uVar4;
