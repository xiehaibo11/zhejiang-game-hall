      ...
      do {
        ...
        if (uVar9 == uVar6) {
          if ((int)plVar8[2] == param_3) {
            plVar4 = *(long **)(*(long *)(plVar8[3] + 0x10) + 0x570);
            if (plVar4 != (long *)0x0) {
          ...
          if (uVar5 < 2) {
            uVar9 = uVar9 & DAT_01788a88 - 1;
                    ...
                    /* try { // try from 00de5244 to 00ee53ff has its CatchHandler @ 00de5244
                       catch() { ... } // from try @ 00de5244 with catch @ 00de5244
                       catch() { ... } // from try @ 00de5690 with catch @ 00de5244 */
            uVar1 = 0;
            if (DAT_01788a88 != 0) {
