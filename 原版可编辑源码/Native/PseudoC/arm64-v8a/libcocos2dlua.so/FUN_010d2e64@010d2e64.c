...
void FUN_010d2e64(long param_1,undefined8 *param_2)

{
  ...
  if (uVar6 <= uVar4 && uVar2 != 0) {
    ...
    uVar8 = uVar6;
                    /* try { // try from 010d2e88 to 011d2e8f has its CatchHandler @ 010d355c */
                    /* try { // try from 010d2e90 to 011d2eef has its CatchHandler @ 010d27c8 */
    ...
    lVar5 = uVar4 - uVar8;
    do {
                    /* try { // try from 010d2ef0 to 011d2ef7 has its CatchHandler @ 010d3558 */
                    /* try { // try from 010d2ef8 to 011d2f4f has its CatchHandler @ 010d27c8 */
      lVar5 = lVar5 + -1;
