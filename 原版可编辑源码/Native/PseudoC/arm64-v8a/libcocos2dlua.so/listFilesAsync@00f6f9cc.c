...
/* cocos2d::FileUtils::listFilesAsync(std::__ndk1::basic_string<char,
...
void __thiscall cocos2d::FileUtils::listFilesAsync(FileUtils *this,undefined8 param_2,long *param_3)

{
  ...
  if ((local_198 & 1) == 0) {
    ...
    if (uStack_190 < 0x17) {
      ...
      if (uStack_190 != 0) goto LAB_00f6fa7c;
    }
    else {
...
LAB_00f6fc78:
  ...
  if (alStack_90 == local_70) {
    ...
    if (local_70 == (long *)0x0) goto LAB_00f6fca4;
