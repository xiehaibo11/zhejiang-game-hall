...
void FUN_0125e3a8(long param_1,undefined8 param_2)

{
  ...
  if (0x20 < (*(long *)(param_1 + 0x18) - (long)pbVar11) + 1U) {
    ...
    local_60[0x16] = 0;
    local_60[0x17] = 0;
    iVar7 = FUN_0125e0a8(local_70,local_60,0x28,0x28,&DAT_014a8009);
    FUN_01258064(param_2,local_60,local_60 + iVar7);
  }
