...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   fairygui::GearAnimation::GearAnimationValue>, void*>*>, bool>
   std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   fairygui::GearAnimation::GearAnimationValue>,
   std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> >, fairygui::GearAnimation::GearAnimationValue>,
...

{
  ...
  if (((byte)*param_2 & 1) == 0) {
    ...
    uVar7 = (ulong)((byte)*param_2 >> 1);
                    ...
                    /* try { // try from 00ac516c to 00bc51bb has its CatchHandler @ 00ac516c
                       catch() { ... } // from try @ 00ac516c with catch @ 00ac516c
                       catch() { ... } // from try @ 00ac5228 with catch @ 00ac516c
                       catch() { ... } // from try @ 00ac5264 with catch @ 00ac516c */
  ...
  if (uVar16 != 0) {
    ...
    if (uVar13 < 2) {
                    /* try { // try from 00ac51bc to 00bc51c3 has its CatchHandler @ 00ac52a4 */
      ...
      if (uVar16 <= uVar7) {
        ...
        unaff_x27 = uVar7 - uVar10 * uVar16;
                    ...
                    /* try { // try from 00ac51c4 to 00bc5227 has its CatchHandler @ 00ac52ac */
          ...
          if (uVar13 < 2) {
            ...
            if (uVar16 != 0) {
              uVar4 = uVar10 / uVar16;
                    ...
                    /* try { // try from 00ac5228 to 00bc524f has its CatchHandler @ 00ac516c */
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00ac5244;
            break;
          }
...
LAB_00ac5244:
        bVar3 = *(byte *)(plVar15 + 2);
                    /* try { // try from 00ac5250 to 00bc5263 has its CatchHandler @ 00ac52ac */
        sVar1 = (ulong)(bVar3 >> 1);
        if ((bVar3 & 1) != 0) {
          sVar1 = plVar15[3];
        }
        if (sVar1 == __n) {
                    /* try { // try from 00ac5264 to 00bc52c7 has its CatchHandler @ 00ac516c */
          __s1 = (void *)plVar15[4];
          if ((bVar3 & 1) == 0) {
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00ac52b4;
              }
              goto LAB_00ac51fc;
            }
          }
          else if (__n != 0) {
                    /* catch() { ... } // from try @ 00ac51bc with catch @ 00ac52a4 */
                    /* catch() { ... } // from try @ 00ac51c4 with catch @ 00ac52ac
                       catch() { ... } // from try @ 00ac5250 with catch @ 00ac52ac */
            uVar6 = memcmp(__s1,ppVar2,__n);
            __s1 = (void *)(ulong)uVar6;
            if (uVar6 != 0) goto LAB_00ac51fc;
          }
LAB_00ac52b4:
          uVar8 = 0;
          goto LAB_00ac53e4;
  ...
  *plVar15 = 0;
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar12;
    if (*plVar15 == 0) goto LAB_00ac53d4;
