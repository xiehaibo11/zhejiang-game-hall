...
int FUN_00affe74(undefined8 param_1,uchar **param_2,long param_3,int param_4,int param_5)

{
  ...
  iVar2 = FUN_00afffec(param_1,0,&local_54,param_3);
  ...
  if (iVar2 != -1) {
    ...
    if (param_2 != (uchar **)0x0) {
      ...
      FUN_00afffec(param_1,*param_2,&local_54,param_3);
      if (constructed == 0) {
