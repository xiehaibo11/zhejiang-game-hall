...
/* bool array_to_vector_t_deprecated<cocos2d::MenuItem*>(cocos2d::__Array&,
   cocos2d::Vector<cocos2d::MenuItem*>&) */

bool array_to_vector_t_deprecated<cocos2d::MenuItem*>(__Array *param_1,Vector *param_2)
      ...
      do {
        ...
        if ((lVar4 != 0) &&
           (pRVar5 = (Ref *)__dynamic_cast(lVar4,&cocos2d::Ref::typeinfo,
                                           &cocos2d::MenuItem::typeinfo,0), pRVar5 != (Ref *)0x0)) {
