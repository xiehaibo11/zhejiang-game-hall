...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int, int>,
   ...
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<int, int> > >::__rehash(unsigned long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<int,int>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,int>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,int>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,int>>>
           *this,ulong param_1)

{
  ...
  ulong uVar12;
                    ...
                    /* try { // try from 009ed794 to 00aed7bf has its CatchHandler @ 009ed834 */
  if (param_1 == 0) {
    pvVar2 = *(void **)this;
    *(undefined8 *)this = 0;
    if (pvVar2 != (void *)0x0) {
      operator_delete(pvVar2);
                    ...
                    /* try { // try from 009ed82c to 00aed84f has its CatchHandler @ 009ed744 */
    *(undefined8 *)(this + 8) = 0;
  }
  else {
    if (param_1 >> 0x3d != 0) {
    ...
    *(void **)this = pvVar2;
    if (pvVar3 != (void *)0x0) {
                    /* try { // try from 009ed7c0 to 00aed817 has its CatchHandler @ 009ed744 */
    ...
    *(ulong *)(this + 8) = param_1;
    ...
    if (plVar5 != (long *)0x0) {
      ...
      if ((uVar12 & 0xffffffff) < 2) {
                    /* catch() { ... } // from try @ 009ed794 with catch @ 009ed834
                       catch() { ... } // from try @ 009ed818 with catch @ 009ed834 */
        ...
        uVar4 = uVar4 - uVar7 * param_1;
                    /* try { // try from 009ed818 to 00aed82b has its CatchHandler @ 009ed834 */
      }
      *(__hash_table<std::__ndk1::__hash_value_type<int,int>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,int>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,int>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,int>>>
