...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::UniformValue>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::UniformValue>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::UniformValue>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::UniformValue>>>
           *this,ulong param_1)

{
  ...
  ulong uVar12;
                    ...
                    /* try { // try from 00fdbf44 to 010dbf4b has its CatchHandler @ 00fdbf80 */
                    /* try { // try from 00fdbf4c to 010dbf9b has its CatchHandler @ 00fdbf10 */
  if (param_1 == 0) {
                    /* try { // try from 00fdbfd8 to 010dc02f has its CatchHandler @ 00fdbf9c */
    pvVar2 = *(void **)this;
    *(undefined8 *)this = 0;
    if (pvVar2 != (void *)0x0) {
    ...
    *(void **)this = pvVar2;
    if (pvVar3 != (void *)0x0) {
      operator_delete(pvVar3);
                    ...
                    /* catch() { ... } // from try @ 00fdbf44 with catch @ 00fdbf80 */
    uVar4 = 0;
    ...
    do {
      *(undefined8 *)(*(long *)this + uVar4 * 8) = 0;
      uVar4 = uVar4 + 1;
                    ...
                    /* catch() { ... } // from try @ 00fdbfd8 with catch @ 00fdbf9c */
      ...
      if ((uVar12 & 0xffffffff) < 2) {
        ...
        if (param_1 != 0) {
          uVar7 = uVar4 / param_1;
                    ...
                    /* try { // try from 00fdbfd0 to 010dbfd7 has its CatchHandler @ 00fdc014 */
        ...
        do {
          ...
          if ((uVar12 & 0xffffffff) < 2) {
            uVar7 = uVar7 & param_1 - 1;
                    ...
                    /* catch() { ... } // from try @ 00fdc06c with catch @ 00fdc030 */
            uVar1 = 0;
            if (param_1 != 0) {
              uVar1 = uVar7 / param_1;
            }
          ...
          if (uVar7 != uVar4) {
            ...
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) {
              *(long **)(*(long *)this + uVar7 * 8) = plVar5;
              ...
              do {
                plVar8 = plVar9;
                    /* try { // try from 00fdc064 to 010dc06b has its CatchHandler @ 00fdc0a0 */
                plVar9 = (long *)*plVar8;
                if (plVar9 == (long *)0x0) break;
                    /* try { // try from 00fdc06c to 010dc0bb has its CatchHandler @ 00fdc030 */
              } while ((int)plVar6[2] == (int)plVar9[2]);
              *plVar5 = (long)plVar9;
              *plVar8 = **(long **)(*(long *)this + uVar7 * 8);
              **(undefined8 **)(*(long *)this + uVar7 * 8) = plVar6;
              plVar6 = plVar5;
                    /* catch() { ... } // from try @ 00fdc064 with catch @ 00fdc0a0 */
            }
          }
                    /* catch() { ... } // from try @ 00fdbfd0 with catch @ 00fdc014 */
          plVar9 = (long *)*plVar6;
          plVar5 = plVar6;
          plVar6 = plVar9;
