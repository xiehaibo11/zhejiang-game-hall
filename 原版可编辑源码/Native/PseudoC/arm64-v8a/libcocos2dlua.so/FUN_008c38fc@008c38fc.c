...
undefined8 FUN_008c38fc(undefined8 param_1)

{
  ...
  iVar2 = tolua_isnumber(param_1,1,0,auStack_58);
                    /* try { // try from 008c3974 to 009c3a53 has its CatchHandler @ 008c3974
                       catch() { ... } // from try @ 008c3974 with catch @ 008c3974
                       catch() { ... } // from try @ 008c3b80 with catch @ 008c3974 */
  if ((((iVar2 == 0) || (iVar2 = tolua_isnumber(param_1,2,0,auStack_58), iVar2 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glScissor\'.",auStack_58);
  }
  else {
    ...
    glScissor((int)dVar3,(int)dVar4,(int)dVar5,(int)dVar6);
  }
