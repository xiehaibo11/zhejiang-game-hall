...
/* cocos2d::ui::RichText::isAnchorTextGlowEnabled() */

bool __thiscall cocos2d::ui::RichText::isAnchorTextGlowEnabled(RichText *this)

{
  ...
  if (__n == sVar1) {
    ...
    if (((ulong)local_58 & 1) == 0) {
      ...
      do {
        if (*pcVar6 != *__s2) goto LAB_00dd3734;
        uVar5 = uVar5 - 1;
        pcVar6 = pcVar6 + 1;
        __s2 = __s2 + 1;
      } while (uVar5 != 0);
      bVar3 = true;
      goto joined_r0x00dd3738;
    }
    if (__n == 0) {
      bVar3 = true;
    }
...
LAB_00dd3734:
    bVar3 = false;
joined_r0x00dd3738:
    if (((ulong)local_58 & 1) == 0) goto LAB_00dd376c;
  }
