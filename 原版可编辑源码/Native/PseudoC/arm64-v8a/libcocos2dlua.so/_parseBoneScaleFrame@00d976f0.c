...

{
  ...
  *(undefined4 *)(*(long *)this + uVar3 * 4) = uVar4;
  uVar4 = _getNumber(pGVar2,DataParser::Y,1.0);
                    /* try { // try from 00d977a0 to 00e97857 has its CatchHandler @ 00d977a0
                       catch() { ... } // from try @ 00d977a0 with catch @ 00d977a0
                       catch() { ... } // from try @ 00d984a8 with catch @ 00d977a0
                       catch() { ... } // from try @ 00d98c4c with catch @ 00d977a0
                       catch() { ... } // from try @ 00d98e54 with catch @ 00d977a0 */
