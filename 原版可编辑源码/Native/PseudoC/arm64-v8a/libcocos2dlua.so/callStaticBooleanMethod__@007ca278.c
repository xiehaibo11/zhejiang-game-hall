...
bool cocos2d::JniHelper::callStaticBooleanMethod<>(basic_string *param_1,basic_string *param_2)

{
  ...
  *puVar7 = 0;
  ...
  if ((uVar8 & 1) == 0) {
    ...
    local_50 = (void *)0x0;
    local_40 = 0x3f800000;
    cVar6 = _JNIEnv::CallStaticBooleanMethod(local_78,local_70,local_68);
