...
/* void cocos2d::JniHelper::callStaticVoidMethod<char const*, float>(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&, char const*, float) */

void cocos2d::JniHelper::callStaticVoidMethod<char_const*,float>
...

{
  ...
  *puVar7 = 0;
  ...
  if ((uVar8 & 1) == 0) {
    ...
    _JNIEnv::CallStaticVoidMethod(p_Var5,p_Var6,(double)param_4,local_78,uVar9);
