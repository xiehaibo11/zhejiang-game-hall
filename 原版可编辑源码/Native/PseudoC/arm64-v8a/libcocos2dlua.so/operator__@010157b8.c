...
::operator()(__func<std::__ndk1::__bind<void(cocos2d::Physics3DDebugDrawer::*)(cocos2d::Mat4_const&,unsigned_int),cocos2d::Physics3DDebugDrawer*,cocos2d::Mat4_const&,int>,std::__ndk1::allocator<std::__ndk1::__bind<void(cocos2d::Physics3DDebugDrawer::*)(cocos2d::Mat4_const&,unsigned_int),cocos2d::Physics3DDebugDrawer*,cocos2d::Mat4_const&,int>>,void()>
             *this)

{
  ...
  if ((*(ulong *)(this + 0x10) & 1) != 0) {
    UNRECOVERED_JUMPTABLE = *(code **)(UNRECOVERED_JUMPTABLE + *plVar1);
                    ...
                    /* WARNING: Could not recover jumptable at 0x010157dc. Too many branches */
