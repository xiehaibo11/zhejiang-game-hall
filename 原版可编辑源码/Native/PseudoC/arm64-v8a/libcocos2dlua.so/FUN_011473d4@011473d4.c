...
undefined8
FUN_011473d4(undefined4 *param_1,long param_2,int param_3,int param_4,int param_5,code *param_6)
...
LAB_01147f64:
        ...
        *puVar2 = *(undefined8 *)(param_1 + 0x16);
        ...
        if (0 < (int)param_1[0x26]) {
          FUN_0115f484(param_1 + 0x2c,plVar3);
        }
        uVar12 = 1;
      }
      return uVar12;
    ...
    if ((int)local_70 <= (int)uVar30) {
      ...
      *(undefined8 *)(param_1 + 0x16) = *puVar2;
      ...
      if (0 < (int)param_1[0x26]) {
        FUN_0115f484(plVar3,param_1 + 0x2c);
      }
      local_70 = uVar30 + 8;
    }
    if ((uVar31 & uVar5) == 0) {
...
LAB_01147e64:
    ...
    if (*(int *)((long)plVar32 + 0x34) != 0) {
      ...
      if (uVar28 == 0) goto LAB_01147e64;
      if (uVar21 == 0) goto LAB_011476b8;
      goto LAB_01147efc;
    }
    uVar22 = param_1[0x12];
    uVar14 = *(ulong *)(param_1 + 10);
...
LAB_01147c80:
      ...
      if (uVar22 == 0) {
        if (*(long *)(param_1 + 0x10) == *(long *)(param_1 + 0xe)) {
          param_1[0x13] = (uint)(0x40 < iVar11);
          if (0x40 < iVar11) goto LAB_01147efc;
        }
        else {
          param_1[0x13] = 0;
        }
    ...
    if ((int)(uVar28 + 1) < 0x79) {
      iVar11 = (8 - ((byte)(&DAT_014988cc)[(int)uVar28] & 0xf)) +
               (uint)((byte)(&DAT_014988cc)[(int)uVar28] >> 4) * param_3;
      if (iVar11 < 2) {
        iVar11 = 1;
      }
      iVar7 = param_1[0x13];
    ...
    if (iVar7 != 0) goto LAB_01147efc;
    lVar13 = (long)iVar11;
    if ((long)puVar33 - param_2 >> 2 < lVar13) goto LAB_01147f64;
    uVar28 = uVar21 + 1;
    lVar29 = (long)(int)uVar28;
    if ((long)puVar1 - (long)puVar33 >> 2 < lVar29) goto LAB_01147f64;
...
LAB_0114797c:
          ...
          if (lVar23 != 0) {
            ...
            if ((uVar28 & 7) == 0) goto LAB_01147a48;
          }
        }
