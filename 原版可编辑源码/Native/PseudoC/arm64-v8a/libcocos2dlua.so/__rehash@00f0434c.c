...

{
  ...
  if (param_1 == 0) {
    ...
    *(undefined8 *)this = 0;
    if (pvVar2 != (void *)0x0) {
                    /* try { // try from 00f043ec to 010043f3 has its CatchHandler @ 00f04888 */
    ...
    *(void **)this = pvVar2;
    ...
    uVar4 = 0;
                    /* try { // try from 00f0438c to 0100439b has its CatchHandler @ 00f047e0 */
    *(ulong *)(this + 8) = param_1;
    do {
      *(undefined8 *)(*(long *)this + uVar4 * 8) = 0;
      uVar4 = uVar4 + 1;
    } while (param_1 != uVar4);
                    /* try { // try from 00f043a8 to 010043ab has its CatchHandler @ 00f047dc */
    ...
    if (plVar5 != (long *)0x0) {
      ...
      if ((uVar12 & 0xffffffff) < 2) {
                    /* try { // try from 00f043f8 to 010043ff has its CatchHandler @ 00f04898 */
        ...
        do {
          ...
          if (uVar7 != uVar4) {
            ...
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) {
              ...
              *plVar5 = (long)plVar9;
                    /* try { // try from 00f04494 to 0100449b has its CatchHandler @ 00f047e8 */
              *plVar8 = **(long **)(*(long *)this + uVar7 * 8);
                    /* try { // try from 00f0449c to 0100450f has its CatchHandler @ 00f04134 */
