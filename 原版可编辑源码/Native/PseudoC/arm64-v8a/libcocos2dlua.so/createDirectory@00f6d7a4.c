...
void __thiscall
cocos2d::FileUtils::createDirectory(undefined8 param_1_00,basic_string *param_1,long *param_3)

{
  ...
  if (((byte)local_1a8 & 1) == 0) {
    ...
    if (uStack_1a0 < 0x17) {
      ...
      if (uStack_1a0 != 0) goto LAB_00f6d854;
    }
    else {
...
LAB_00f6d854:
  ...
  if ((local_c0 & 1) == 0) {
    ...
    if (uStack_b8 < 0x17) {
      ...
      if (uStack_b8 != 0) goto LAB_00f6d93c;
    }
    else {
...
LAB_00f6d93c:
  ...
  *plVar3 = (long)&PTR_FUN_01721128;
  ...
  if ((local_180 & 1) == 0) {
    ...
    plVar3[5] = uStack_178;
    plVar3[4] = local_180;
    if (local_140 == (long *)0x0) goto LAB_00f6da50;
LAB_00f6d9d4:
    ...
    if (uStack_178 < 0x17) {
      ...
      *(char *)(plVar3 + 4) = (char)((int)uStack_178 << 1);
      if (uStack_178 != 0) goto LAB_00f6da34;
    }
    else {
...
LAB_00f6da34:
    ...
    *(undefined1 *)((long)pvVar5 + uVar7) = 0;
    if (local_140 != (long *)0x0) goto LAB_00f6d9d4;
LAB_00f6da50:
    plVar3[0xc] = 0;
  }
  local_110 = plVar3;
...
LAB_00f6db14:
  ...
  if (alStack_a0 == local_80) {
    ...
    if (local_80 == (long *)0x0) goto LAB_00f6db40;
