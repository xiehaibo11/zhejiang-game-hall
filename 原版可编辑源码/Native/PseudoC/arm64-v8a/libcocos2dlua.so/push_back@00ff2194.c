...
/* std::__ndk1::__split_buffer<cocos2d::TextureCache::AsyncStruct**,
   std::__ndk1::allocator<cocos2d::TextureCache::AsyncStruct**>
   >::push_back(cocos2d::TextureCache::AsyncStruct**&&) */
...

{
  ...
  undefined8 *puVar7;
                    ...
                    /* try { // try from 00ff2194 to 010f21f7 has its CatchHandler @ 00ff2164 */
  ...
  if (puVar7 == *(undefined8 **)(this + 0x18)) {
    ...
    if (__src < puVar6 || (long)__src - (long)puVar6 == 0) {
      ...
      *(void **)(this + 0x18) = (void *)((long)pvVar3 + uVar5 * 8);
      ...
      lVar1 = lVar4 + 2;
                    /* catch() { ... } // from try @ 00ff218c with catch @ 00ff21dc */
      if (-1 < lVar4 + 1) {
        lVar1 = lVar4 + 1;
      }
