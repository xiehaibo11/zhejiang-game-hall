...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void
   ...
   (cocos2d::Scene::*)(cocos2d::EventCustom*), cocos2d::Scene*, std::__ndk1::placeholders::__ph<1>
   const&> >, void (cocos2d::EventCustom*)>::__clone() const */
...

{
  ...
  undefined8 uVar3;
                    ...
                    /* try { // try from 00f3d4d4 to 0103d4db has its CatchHandler @ 00f3d4f0 */
  puVar1 = operator_new(0x20);
                    /* try { // try from 00f3d4dc to 0103d563 has its CatchHandler @ 00f3d3e8 */
  *puVar1 = &PTR_FUN_01710378;
  uVar3 = *(undefined8 *)(this + 8);
                    /* catch() { ... } // from try @ 00f3d4d4 with catch @ 00f3d4f0 */
  uVar2 = *(undefined8 *)(this + 0x18);
                    /* catch() { ... } // from try @ 00f3d454 with catch @ 00f3d4f4 */
