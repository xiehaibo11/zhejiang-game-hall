...
undefined8 FUN_008e4640(lua_State *param_1)

{
  ...
  if (iVar5 + -1 == 1) {
    ...
    uStack_50 = 0;
    local_60 = (byte *)0x0;
    uVar7 = luaval_to_std_vector_string(param_1,2,(vector *)&local_60,"fairygui.GComboBox:setIcons")
    ;
    if ((uVar7 & 1) != 0) {
      pbVar9 = *(byte **)(lVar6 + 0x2c8);
      pbVar8 = *(byte **)(lVar6 + 0x2d0);
      if (pbVar8 != pbVar9) {
        bVar1 = pbVar8[-0x18];
        pbVar3 = pbVar8 + -0x18;
        while( true ) {
    ...
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "fairygui.GComboBox:setIcons",iVar5 + -1,1);
  }
