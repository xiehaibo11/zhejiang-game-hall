...
/* cocos2d::FileUtils::listFilesRecursivelyAsync(std::__ndk1::basic_string<char,
...
void __thiscall
cocos2d::FileUtils::listFilesRecursivelyAsync(FileUtils *this,undefined8 param_2,long *param_3)

{
  ...
  (**(code **)(*(long *)this + 0x208))(&local_198);
  pvVar2 = local_188;
  uStack_1a8 = 0;
  local_1a0 = (void *)0x0;
  local_1b0 = 0;
  if ((local_198 & 1) == 0) {
    ...
    if (uStack_190 < 0x17) {
      ...
      if (uStack_190 != 0) goto LAB_00f6ff10;
    }
    else {
...
LAB_00f7010c:
  ...
  if (alStack_90 == local_70) {
    ...
    if (local_70 == (long *)0x0) goto LAB_00f70138;
