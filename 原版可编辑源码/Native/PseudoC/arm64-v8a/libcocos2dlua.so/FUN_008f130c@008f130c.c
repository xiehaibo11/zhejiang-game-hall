...
undefined8 FUN_008f130c(lua_State *param_1)

{
  ...
  if (iVar1 + -1 == 1) {
    if (((param_1 == (lua_State *)0x0) || (iVar1 = lua_gettop(param_1), iVar1 < 2)) ||
      ...
      tolua_error(param_1,"invalid arguments in function \'lua_fairygui_Window_setDragArea\'",0);
    }
    else {
      pGVar3 = (GObject *)tolua_tousertype(param_1,2,0);
      fairygui::Window::setDragArea(this,pGVar3);
    }
  }
  else {
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "fairygui.Window:setDragArea",iVar1 + -1,1);
  }
  return 0;
}
