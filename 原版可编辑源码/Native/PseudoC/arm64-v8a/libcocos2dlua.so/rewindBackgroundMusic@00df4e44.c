...
/* CocosDenshion::android::AndroidJavaEngine::rewindBackgroundMusic() */

void CocosDenshion::android::AndroidJavaEngine::rewindBackgroundMusic(void)
