...
/* std::__ndk1::vector<cocostudio::ActionFrame*, std::__ndk1::allocator<cocostudio::ActionFrame*>
   >::insert(std::__ndk1::__wrap_iter<cocostudio::ActionFrame* const*>, cocostudio::ActionFrame*
   const&) */

undefined8 * __thiscall
std::__ndk1::vector<cocostudio::ActionFrame*,std::__ndk1::allocator<cocostudio::ActionFrame*>>::
insert(vector<cocostudio::ActionFrame*,std::__ndk1::allocator<cocostudio::ActionFrame*>> *this,
