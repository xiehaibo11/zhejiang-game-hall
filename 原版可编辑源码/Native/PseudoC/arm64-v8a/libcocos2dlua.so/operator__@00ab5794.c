...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void (fairygui::GearSize::*)(),
   ...
   fairygui::GearSize*> >, void ()>::TEMPNAMEPLACEHOLDERVALUE() */
...
::operator()(__func<std::__ndk1::__bind<void(fairygui::GearSize::*)(),fairygui::GearSize*>,std::__ndk1::allocator<std::__ndk1::__bind<void(fairygui::GearSize::*)(),fairygui::GearSize*>>,void()>
             *this)
    ...
    UNRECOVERED_JUMPTABLE =
         *(code **)(UNRECOVERED_JUMPTABLE +
                   *(long *)(*(long *)(this + 0x18) + ((long)*(ulong *)(this + 0x10) >> 1)));
                    ...
                    /* WARNING: Could not recover jumptable at 0x00ab57ac. Too many branches */
