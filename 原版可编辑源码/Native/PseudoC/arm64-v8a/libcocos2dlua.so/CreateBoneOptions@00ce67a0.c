...
/* flatbuffers::CreateBoneOptions(flatbuffers::FlatBufferBuilder&,
   flatbuffers::Offset<flatbuffers::WidgetOptions>, float, flatbuffers::BlendFunc const*) */

undefined4
flatbuffers::CreateBoneOptions
          (float param_1_00,FlatBufferBuilder *param_1,int param_3,BlendFunc *param_4)

{
  ...
  FlatBufferBuilder::AddStruct<flatbuffers::BlendFunc>(param_1,8,param_4);
