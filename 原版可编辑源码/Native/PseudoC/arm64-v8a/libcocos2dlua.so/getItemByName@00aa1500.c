...
/* fairygui::UIPackage::getItemByName(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

undefined8 __thiscall fairygui::UIPackage::getItemByName(UIPackage *this,basic_string *param_1)

{
  ...
  if (lVar1 != 0) {
    uVar2 = *(undefined8 *)(lVar1 + 0x28);
                    ...
                    /* catch() { ... } // from try @ 00aa1460 with catch @ 00aa1518 */
                    /* catch() { ... } // from try @ 00aa13f4 with catch @ 00aa151c
                       catch() { ... } // from try @ 00aa14b0 with catch @ 00aa151c */
  return uVar2;
}
