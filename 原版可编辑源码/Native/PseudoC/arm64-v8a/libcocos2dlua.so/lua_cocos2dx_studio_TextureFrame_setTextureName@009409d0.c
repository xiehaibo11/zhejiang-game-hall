...
/* lua_cocos2dx_studio_TextureFrame_setTextureName(lua_State*) */

undefined4 lua_cocos2dx_studio_TextureFrame_setTextureName(lua_State *param_1)

{
  ...
  if (iVar4 + -1 != 1) {
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "ccs.TextureFrame:setTextureName",iVar4 + -1,1);
    uVar7 = 0;
    goto LAB_00940b74;
  }
  uStack_68 = 0;
  ...
  uVar6 = luaval_to_std_string
                    (param_1,2,(basic_string *)&local_70,"ccs.TextureFrame:setTextureName");
  pcVar3 = local_60;
  uVar1 = uStack_68;
  if ((uVar6 & 1) == 0) {
    tolua_error(param_1,
                "invalid arguments in function \'lua_cocos2dx_studio_TextureFrame_setTextureName\'",
                0);
    uVar7 = 0;
  }
  else {
    ...
    if ((local_70 & 1) == 0) {
      ...
      if (uStack_68 < 0x17) {
        ...
        if (uStack_68 != 0) goto LAB_00940b00;
      }
      else {
