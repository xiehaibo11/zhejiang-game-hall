...
/* void std::__ndk1::vector<fairygui::GTreeNode*, std::__ndk1::allocator<fairygui::GTreeNode*>
   >::__push_back_slow_path<fairygui::GTreeNode* const&>(fairygui::GTreeNode* const&) */
...
__push_back_slow_path<fairygui::GTreeNode*const&>
          (vector<fairygui::GTreeNode*,std::__ndk1::allocator<fairygui::GTreeNode*>> *this,
          GTreeNode **param_1)
  ...
  *(void **)(this + 0x10) = (void *)((long)__dest + uVar3 * 8);
  if (__src != (void *)0x0) {
    ...
    return;
                    ...
                    /* try { // try from 00a8ea90 to 00b8eac3 has its CatchHandler @ 00a8eb90 */
  return;
}
