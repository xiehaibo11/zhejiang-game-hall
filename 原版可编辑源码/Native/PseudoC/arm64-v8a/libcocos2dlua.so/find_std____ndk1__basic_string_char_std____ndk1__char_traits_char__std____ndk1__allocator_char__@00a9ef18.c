...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::function<fairygui::GComponent* ()> >, void*>*>
   ...
   std::__ndk1::allocator<char> >, std::__ndk1::function<fairygui::GComponent* ()> >,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   std::__ndk1::function<fairygui::GComponent* ()> > > >::find<std::__ndk1::basic_string<char,
...

{
  ...
  pbVar2 = *(basic_string **)(param_1 + 0x10);
                    /* try { // try from 00a9ef5c to 00b9ef6f has its CatchHandler @ 00a9efe0 */
  if (((byte)*param_1 & 1) == 0) {
    pbVar2 = param_1 + 1;
  ...
  uVar12 = *(ulong *)(this + 8);
                    /* try { // try from 00a9ef70 to 00b9f017 has its CatchHandler @ 00a9eed8 */
  if (uVar12 != 0) {
    ...
    if (plVar8 != (long *)0x0) {
      ...
      if (plVar8 != (long *)0x0) {
        ...
        pbVar2 = param_1 + 1;
        if (((byte)*param_1 & 1) != 0) {
                    /* catch() { ... } // from try @ 00a9ef5c with catch @ 00a9efe0 */
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            bVar3 = *(byte *)(plVar8 + 2);
            uVar9 = (ulong)(bVar3 >> 1);
                    /* try { // try from 00a9f018 to 00b9f08b has its CatchHandler @ 00a9f018
                       catch() { ... } // from try @ 00a9f018 with catch @ 00a9f018
                       catch() { ... } // from try @ 00a9f0a0 with catch @ 00a9f018 */
            sVar1 = uVar9;
            if ((bVar3 & 1) != 0) {
              sVar1 = plVar8[3];
            }
            if (sVar1 == __n) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                while (*pbVar10 == *pbVar11) {
                  ...
                  pbVar10 = pbVar10 + 1;
                  pbVar11 = pbVar11 + 1;
                  if (uVar9 == 0) goto LAB_00a9f0a8;
                }
              }
              else {
                    /* try { // try from 00a9f08c to 00b9f09f has its CatchHandler @ 00a9f0f8 */
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00a9eff4;
              goto LAB_00a9f0a4;
            }
            if (uVar9 != uVar14) goto LAB_00a9f0a4;
          }
LAB_00a9eff4:
          plVar8 = (long *)*plVar8;
