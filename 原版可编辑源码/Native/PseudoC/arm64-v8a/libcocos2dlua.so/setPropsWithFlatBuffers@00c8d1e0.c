...
/* cocostudio::ScrollViewReader::setPropsWithFlatBuffers(cocos2d::Node*, flatbuffers::Table const*)
    */

void __thiscall
cocostudio::ScrollViewReader::setPropsWithFlatBuffers
          (ScrollViewReader *this,Node *param_1,Table *param_2)
...
joined_r0x00c8d3b4:
    ...
    if ((ulong)uVar1 == 0) goto LAB_00c8d3cc;
  ...
  if (*(ushort *)pTVar11 < 9) {
    iVar13 = 0;
    if (4 < *(ushort *)pTVar11) goto LAB_00c8d484;
    pTVar11 = (Table *)0x0;
  }
  else {
      ...
      if ((uVar9 & 1) == 0) {
        ...
        lVar5 = std::__ndk1::
                ...
                __emplace_unique_key_args<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>&&>,std::__ndk1::tuple<>>
                          ((basic_string *)local_80,(piecewise_construct_t *)local_138,
                           (tuple *)&DAT_0141547f,(tuple *)local_150);
        ...
        __emplace_unique_key_args<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>&&>,std::__ndk1::tuple<>>
                  ((basic_string *)local_a8,(piecewise_construct_t *)local_150,
                   (tuple *)&DAT_0141547f,(tuple *)&local_b0);
...
LAB_00c8d578:
  ...
  cocos2d::Color3B::Color3B(local_138,(uchar)pTVar11[1],(uchar)pTVar11[2],(uchar)pTVar11[3]);
  (**(code **)(*(long *)param_1 + 0x4c0))(param_1,local_138);
  ...
  if ((*(ushort *)(param_2 + -(long)*(int *)param_2) < 0x1d) ||
     (uVar9 = (ulong)*(ushort *)(param_2 + -(long)*(int *)param_2 + 0x1c), uVar9 == 0)) {
    pTVar11 = (Table *)0x0;
  }
  else {
    pTVar11 = param_2 + uVar9;
  }
  cocos2d::Size::Size((Size *)local_a8,*(float *)pTVar11,*(float *)(pTVar11 + 4));
  cocos2d::ui::ScrollView::setInnerContainerSize((ScrollView *)param_1,(Size *)local_a8);
  if ((*(ushort *)(param_2 + -(long)*(int *)param_2) < 0x1f) ||
     (uVar9 = (ulong)*(ushort *)(param_2 + -(long)*(int *)param_2 + 0x1e), uVar9 == 0)) {
    uVar8 = 0;
  }
  else {
    uVar8 = *(undefined4 *)(param_2 + uVar9);
  }
  (**(code **)(*(long *)param_1 + 0x6d0))(param_1,uVar8);
  if (*(ushort *)(param_2 + -(long)*(int *)param_2) < 0x21) {
    TVar12 = (Table)0x0;
  }
  else {
    uVar9 = (ulong)*(ushort *)(param_2 + -(long)*(int *)param_2 + 0x20);
    TVar12 = (Table)0x0;
    if (uVar9 != 0) {
      TVar12 = param_2[uVar9];
    }
  }
  cocos2d::ui::ScrollView::setBounceEnabled((ScrollView *)param_1,TVar12 != (Table)0x0);
  if ((*(ushort *)(param_2 + -(long)*(int *)param_2) < 0x23) ||
     (uVar9 = (ulong)*(ushort *)(param_2 + -(long)*(int *)param_2 + 0x22), uVar9 == 0)) {
    TVar12 = (Table)0x1;
  }
  else {
    TVar12 = param_2[uVar9];
  }
  cocos2d::ui::ScrollView::setScrollBarEnabled((ScrollView *)param_1,TVar12 != (Table)0x0);
  if (TVar12 != (Table)0x0) {
    if ((*(ushort *)(param_2 + -(long)*(int *)param_2) < 0x25) ||
       (uVar9 = (ulong)*(ushort *)(param_2 + -(long)*(int *)param_2 + 0x24), uVar9 == 0)) {
      TVar12 = (Table)0x1;
    }
    else {
      TVar12 = param_2[uVar9];
    }
    cocos2d::ui::ScrollView::setScrollBarAutoHideEnabled((ScrollView *)param_1,TVar12 != (Table)0x0)
    ;
    if ((*(ushort *)(param_2 + -(long)*(int *)param_2) < 0x27) ||
       (uVar9 = (ulong)*(ushort *)(param_2 + -(long)*(int *)param_2 + 0x26), uVar9 == 0)) {
      fVar17 = 0.2;
    }
    else {
      fVar17 = *(float *)(param_2 + uVar9);
    }
    cocos2d::ui::ScrollView::setScrollBarAutoHideTime((ScrollView *)param_1,fVar17);
  }
  ...
  if (TVar14 == (Table)0x0) {
    ...
    cocos2d::Size::Size((Size *)local_120,*(float *)pTVar10,*(float *)(pTVar10 + 4));
    (**(code **)(*(long *)param_1 + 0x160))(param_1,local_120);
  }
  if (((byte)local_108[0] & 1) != 0) {
