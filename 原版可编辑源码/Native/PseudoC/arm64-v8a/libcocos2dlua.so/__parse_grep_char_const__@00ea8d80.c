...
/* char const* std::__ndk1::basic_regex<char, std::__ndk1::regex_traits<char> >::__parse_grep<char
   const*>(char const*, char const*) */

char * __thiscall
std::__ndk1::basic_regex<char,std::__ndk1::regex_traits<char>>::__parse_grep<char_const*>
...

{
  ...
  if (param_1 != param_2) {
    ...
    if (pcVar5 != param_1) {
      __parse_basic_reg_exp<char_const*>(this,param_1,pcVar5);
      param_1 = pcVar5;
      goto LAB_00ea8e20;
    }
  }
  ...
  *puVar1 = &PTR____owns_one_state_016f4de0;
  puVar1[1] = uVar2;
...
LAB_00ea8e20:
  ...
  do {
    ...
    *puVar1 = &PTR____owns_two_states_016f5350;
    puVar1[1] = uVar2;
    puVar1[2] = uVar3;
    *(undefined8 **)(lVar6 + 8) = puVar1;
