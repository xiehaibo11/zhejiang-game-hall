...
/* float cocos2d::JniHelper::callStaticFloatMethod<char const*,
   float>(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&, std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, char const*, float) */

float cocos2d::JniHelper::callStaticFloatMethod<char_const*,float>
                (basic_string *param_1,basic_string *param_2,char *param_3,float param_4)

{
  ...
  getJNISignature<char_const*,float>(param_3,param_4);
  ...
  *puVar7 = 0;
  ...
  if ((uVar8 & 1) == 0) {
    ...
    fVar14 = (float)_JNIEnv::CallStaticFloatMethod(p_Var5,p_Var6,(double)param_4,local_78,uVar9);
