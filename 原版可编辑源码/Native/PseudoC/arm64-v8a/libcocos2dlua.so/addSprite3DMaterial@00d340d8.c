...
/* cocos2d::Sprite3DMaterialCache::addSprite3DMaterial(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, cocos2d::Texture2D*) */

void __thiscall
cocos2d::Sprite3DMaterialCache::addSprite3DMaterial
          (Sprite3DMaterialCache *this,basic_string *param_1,Texture2D *param_2)

{
  ...
  long local_38;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d33fc8 with catch @ 00d340dc
                        */
  lVar1 = tpidr_el0;
                    /* try { // try from 00d340f0 to 00e340f3 has its CatchHandler @ 00d34118 */
  ...
  if (lVar2 == 0) {
    if (param_2 != (Texture2D *)0x0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d340f0 with catch @ 00d34118
                        */
    ...
    lVar2 = std::__ndk1::
            ...
            __emplace_unique_key_args<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&>,std::__ndk1::tuple<>>
                      ((basic_string *)this,(piecewise_construct_t *)param_1,(tuple *)&DAT_01419444,
                       (tuple *)&local_40);
    *(Texture2D **)(lVar2 + 0x28) = param_2;
    uVar3 = 1;
  }
  else {
    uVar3 = 0;
