...

{
  ...
  if (param_1 == 0) {
    pvVar8 = *(void **)this;
    *(undefined8 *)this = 0;
                    /* try { // try from 00fd5df4 to 010d5df7 has its CatchHandler @ 00fd5e6c */
    if (pvVar8 != (void *)0x0) {
                    /* try { // try from 00fd5df8 to 010d5e97 has its CatchHandler @ 00fd5d90 */
    ...
    *(void **)this = pvVar8;
    if (pvVar9 != (void *)0x0) {
                    /* catch() { ... } // from try @ 00fd5df8 with catch @ 00fd5d90 */
    ...
    *(ulong *)(this + 8) = param_1;
    ...
    if (plVar15 != (long *)0x0) {
      ...
      uVar18 = NEON_uaddlv(uVar19,1);
                    /* try { // try from 00fd5dcc to 010d5dd3 has its CatchHandler @ 00fd5e7c */
        ...
        do {
          ...
          if (uVar13 < 2) {
            ...
            uVar17 = uVar17 - uVar4 * param_1;
                    ...
                    /* catch() { ... } // from try @ 00fd5df4 with catch @ 00fd5e6c */
          if (uVar17 != uVar10) {
            if (*(long *)(*(long *)this + uVar17 * 8) == 0) {
              *(long **)(*(long *)this + uVar17 * 8) = plVar15;
              uVar10 = uVar17;
                    ...
                    /* catch() { ... } // from try @ 00fd5dcc with catch @ 00fd5e7c */
              ...
              if (plVar11 != (long *)0x0) {
                ...
                do {
                  ...
                  if ((bVar2 & 1) == 0) {
                    while (sVar6 != 0) {
                      if (*pcVar5 != *__s2) goto LAB_00fd5f4c;
                      __s2 = __s2 + 1;
                      sVar3 = sVar3 - 1;
                      pcVar5 = pcVar5 + 1;
                      sVar6 = sVar3;
