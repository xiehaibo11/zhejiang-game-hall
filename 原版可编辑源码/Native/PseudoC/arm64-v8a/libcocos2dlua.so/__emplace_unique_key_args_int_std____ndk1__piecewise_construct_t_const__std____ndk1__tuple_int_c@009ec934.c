...

{
  ...
  if (uVar8 != 0) {
    ...
    if (uVar4 < 2) {
                    /* try { // try from 009ec990 to 00aeca4b has its CatchHandler @ 009ec5f8 */
      ...
      if (uVar8 <= uVar9) {
        ...
        if (uVar8 != 0) {
          uVar6 = uVar9 / uVar8;
                    ...
                    /* try { // try from 009ec984 to 00aec98f has its CatchHandler @ 009ec9ec */
        ...
        if (uVar6 != uVar9) {
          if (uVar4 < 2) {
            uVar6 = uVar6 & uVar8 - 1;
                    ...
                    /* catch() { ... } // from try @ 009ec984 with catch @ 009ec9ec */
            if (uVar8 <= uVar6) {
              uVar2 = 0;
              if (uVar8 != 0) {
                uVar2 = uVar6 / uVar8;
              }
                    /* catch() { ... } // from try @ 009ec86c with catch @ 009ec9f4 */
                    /* catch() { ... } // from try @ 009ec7c8 with catch @ 009ec9fc */
              if (uVar6 - uVar2 * uVar8 == unaff_x24) goto LAB_009ec9c0;
              break;
            }
          }
...
LAB_009ec9c0:
        if (*(int *)(plVar7 + 2) == *(int *)param_2) {
          return plVar7;
                    ...
                    /* catch() { ... } // from try @ 009ec768 with catch @ 009eca04 */
  plVar7 = operator_new(0x50);
                    /* catch() { ... } // from try @ 009ec6fc with catch @ 009eca0c */
  uVar1 = **(undefined4 **)param_4;
                    /* catch() { ... } // from try @ 009ec668 with catch @ 009eca14 */
  plVar7[8] = 0;
  *plVar7 = 0;
  plVar7[1] = uVar9;
