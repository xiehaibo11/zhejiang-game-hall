...

{
  ...
  long local_68;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d34d58 with catch @ 00d34d8c
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d34bc8 with catch @ 00d34d90
                        */
  lVar5 = tpidr_el0;
  local_68 = *(long *)(lVar5 + 0x28);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d34c74 with catch @ 00d34dbc
                        */
      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if (uVar13 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00d34ea4;
            break;
          }
                    /* try { // try from 00d34e9c to 00e34e9f has its CatchHandler @ 00d34ef0 */
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d34e9c with catch @ 00d34ef0
                        */
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00d34f14;
              }
              goto LAB_00d34e5c;
            }
          }
  ...
  *plVar15 = 0;
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar12;
    if (*plVar15 == 0) goto LAB_00d35030;
    uVar7 = *(ulong *)(*plVar15 + 8);
    if ((uVar16 & uVar16 - 1) == 0) {
      uVar7 = uVar7 & uVar16 - 1;
    }
    else if (uVar16 <= uVar7) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d3506c with catch @ 00d35014
                       catch(type#1 @ 00000000) { ... } // from try @ 00d35234 with catch @ 00d35014
                        */
      uVar13 = 0;
      if (uVar16 != 0) {
        uVar13 = uVar7 / uVar16;
...
LAB_00d35040:
  if (*(long *)(lVar5 + 0x28) != local_68) {
    ...
    __stack_chk_fail(__s1,uVar8);
                    ...
                    /* try { // try from 00d35064 to 00e3506b has its CatchHandler @ 00d35338 */
                    /* try { // try from 00d3506c to 00e351c3 has its CatchHandler @ 00d35014 */
  return plVar15;
}
