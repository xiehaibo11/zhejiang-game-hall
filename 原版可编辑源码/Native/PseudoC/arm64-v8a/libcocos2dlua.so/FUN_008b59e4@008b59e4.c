...
undefined8 FUN_008b59e4(lua_State *param_1)

{
  ...
  iVar3 = lua_gettop();
  if (iVar3 == 3) {
    if ((param_1 != (lua_State *)0x0) && (lVar4 = __strlen_chk("cc.MotionStreak",0x10), lVar4 != 0))
    {
      plVar5 = (long *)tolua_tousertype(param_1,1,0);
      iVar3 = lua_gettop(param_1);
      if (iVar3 + -1 == 2) {
        cocos2d::StringUtils::format("%s%s",&local_58,"cc.MotionStreak",":setBlendFunc");
...
LAB_008b5b8c:
    ...
    uVar7 = lua_cocos2dx_MotionStreak_setBlendFunc(param_1);
    if (*(long *)(lVar2 + 0x28) != local_38) goto LAB_008b5b8c;
  }
  return uVar7;
}
