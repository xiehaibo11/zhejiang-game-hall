...

{
  ...
  case 0x19:
    ...
    if (puVar3 == (undefined8 *)0x0) goto LAB_00b9e9dc;
    goto LAB_00b9e9c8;
  case 0x17:
switchD_00b9e968_caseD_17:
    puVar3 = *(undefined8 **)(*(long *)(cms + 8) + 0x18);
    break;
  case 0x18:
switchD_00b9e968_caseD_18:
  ...
  default:
    if (iVar1 != 0xcd) {
      if (iVar1 != 0x312) goto switchD_00b9e968_caseD_18;
      goto switchD_00b9e968_caseD_17;
    }
