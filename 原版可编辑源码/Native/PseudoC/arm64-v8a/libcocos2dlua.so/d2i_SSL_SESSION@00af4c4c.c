...

{
  ...
  local_38 = *pp;
  val = ASN1_item_d2i((ASN1_VALUE **)0x0,&local_38,length,(ASN1_ITEM *)&DAT_016ad9b0);
  if (val == (ASN1_VALUE *)0x0) {
    ses = (SSL_SESSION *)0x0;
    goto LAB_00af4d84;
  }
  if (((a == (SSL_SESSION **)0x0) || (ses = *a, ses == (SSL_SESSION *)0x0)) &&
     (ses = SSL_SESSION_new(), ses == (SSL_SESSION *)0x0)) goto LAB_00af4d84;
  if (*(long *)val == 1) {
    lVar5 = *(long *)(val + 8);
      ...
      if (**(int **)(val + 0x10) == 2) {
        ...
        *(ulong *)(ses->krb5_client_princ + 0x50) = (ulong)CONCAT11(uVar1,uVar2) | 0x3000000;
        ...
        if (piVar7 == (int *)0x0) {
          ...
          if (0x20 < *piVar7) goto LAB_00af4d84;
        ...
        *(int *)(ses->master_key + 0x24) = iVar3;
        ...
        if (puVar8 == (uint *)0x0) {
          ...
          if (0x30 < (int)*puVar8) goto LAB_00af4d84;
...
LAB_00af4fc0:
          *(int *)(ses->krb5_client_princ + 0xc0) = (int)*(undefined8 *)(val + 0x90);
          ASN1_item_free(val,(ASN1_ITEM *)&DAT_016ad9b0);
