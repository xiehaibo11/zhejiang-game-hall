...

{
  ...
  plVar9 = param_2;
  local_168 = pcVar10;
  if (param_2 != (long *)0x0) goto LAB_011de284;
LAB_011de290:
  if (param_3 == (long *)0x0) goto LAB_011de2dc;
  while( true ) {
    ...
    while( true ) {
      ...
      plVar9 = param_2;
      if (param_2 == (long *)0x0) goto LAB_011de290;
LAB_011de284:
      param_2 = plVar9;
      if (plVar9[3] != plVar9[4]) goto LAB_011de290;
...
LAB_011de2dc:
      param_3 = (long *)0x0;
      if (param_2 == (long *)0x0) goto LAB_011de3cc;
    }
  }
LAB_011de3cc:
  ...
  uVar6 = FUN_01208c2c(pcVar10,local_168,param_5,iVar5);
  *param_6 = uVar6;
  __check_grouping(local_148,local_12c,local_170,param_5);
  plVar9 = param_2;
  if ((param_2 == (long *)0x0) || (param_2[3] != param_2[4])) {
    if (param_3 != (long *)0x0) goto LAB_011de44c;
LAB_011de4f0:
    if (plVar9 != (long *)0x0) goto LAB_011de480;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_011de4f0;
LAB_011de44c:
