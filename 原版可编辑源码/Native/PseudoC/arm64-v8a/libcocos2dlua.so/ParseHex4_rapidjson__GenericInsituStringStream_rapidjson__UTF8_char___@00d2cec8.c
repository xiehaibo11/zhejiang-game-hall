...
/* unsigned int rapidjson::GenericReader<rapidjson::UTF8<char>, rapidjson::UTF8<char>,
   rapidjson::CrtAllocator>::ParseHex4<rapidjson::GenericInsituStringStream<rapidjson::UTF8<char> >
   >(rapidjson::GenericInsituStringStream<rapidjson::UTF8<char> >&, unsigned long) */

uint __thiscall
rapidjson::GenericReader<rapidjson::UTF8<char>,rapidjson::UTF8<char>,rapidjson::CrtAllocator>::
ParseHex4<rapidjson::GenericInsituStringStream<rapidjson::UTF8<char>>>
          (GenericReader<rapidjson::UTF8<char>,rapidjson::UTF8<char>,rapidjson::CrtAllocator> *this,
          GenericInsituStringStream *param_1,ulong param_2)

{
  ...
  if ((int)cVar1 - 0x30U < 10) {
    ...
    if (5 < (int)cVar1 - 0x61U) goto LAB_00d2d00c;
    iVar6 = -0x57;
  }
  *(char **)param_1 = pcVar5 + 1;
  ...
  if ((int)(char)bVar2 - 0x30U < 10) {
    ...
    if (5 < bVar2 - 0x61) goto LAB_00d2d00c;
    iVar7 = -0x57;
  }
  *(char **)param_1 = pcVar5 + 2;
  ...
  if ((int)(char)bVar3 - 0x30U < 10) {
    ...
    if (5 < bVar3 - 0x61) goto LAB_00d2d00c;
    iVar8 = -0x57;
  }
