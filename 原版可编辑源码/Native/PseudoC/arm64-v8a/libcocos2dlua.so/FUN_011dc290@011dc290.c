...
void FUN_011dc290(long param_1,int param_2)

{
  ...
  if (param_2 != -1) {
    ...
    if (*(char *)(param_1 + 0x58) == '\0') {
      ...
      do {
        uVar2 = (**(code **)(**(long **)(param_1 + 0x48) + 0x18))
                          (*(long **)(param_1 + 0x48),*(undefined8 *)(param_1 + 0x50),__ptr,
                           auStack_60,&local_78,auStack_60,&local_58,&local_70);
        if (local_78 == __ptr) goto LAB_011dc38c;
        if (uVar2 == 3) {
      ...
      sVar4 = 4;
LAB_011dc2e4:
      sVar4 = fwrite(__ptr,sVar4,1,__s);
      if (sVar4 != 1) {
LAB_011dc38c:
        iVar3 = -1;
        goto LAB_011dc390;
