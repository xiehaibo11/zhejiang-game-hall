...
/* void ccvector_to_luaval<cocos2d::Technique*>(lua_State*, cocos2d::Vector<cocos2d::Technique*>
   const&) */

void ccvector_to_luaval<cocos2d::Technique*>(lua_State *param_1,Vector *param_2)
