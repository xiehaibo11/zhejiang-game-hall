...
/* std::__ndk1::enable_if<__is_forward_iterator<dragonBones::ActionData**>::value&&is_constructible<dragonBones::ActionData*,
   std::__ndk1::iterator_traits<dragonBones::ActionData**>::reference>::value, void>::type
   std::__ndk1::vector<dragonBones::ActionData*, std::__ndk1::allocator<dragonBones::ActionData*>
   >::assign<dragonBones::ActionData**>(dragonBones::ActionData**, dragonBones::ActionData**) */

void __thiscall
std::__ndk1::vector<dragonBones::ActionData*,std::__ndk1::allocator<dragonBones::ActionData*>>::
assign<dragonBones::ActionData**>
          (vector<dragonBones::ActionData*,std::__ndk1::allocator<dragonBones::ActionData*>> *this,
          ActionData **param_1,ActionData **param_2)
...
LAB_00d9caac:
    ...
    if ((ulong)(lVar1 >> 3) < 0xfffffffffffffff) {
      uVar2 = lVar1 >> 2;
      if ((uVar5 <= uVar2) && (uVar5 = uVar2, uVar2 >> 0x3d != 0)) goto LAB_00d9caac;
    }
    else {
    ...
    *(void **)(this + 8) = pvVar4;
    ...
    __src = (ActionData **)((long)param_1 + (*(long *)(this + 8) - (long)pvVar4));
    if (uVar5 <= uVar2) {
      __src = param_2;
    }
