...

{
  ...
  local_68 = *(long *)(lVar2 + 0x28);
                    /* try { // try from 010dc43c to 011dc443 has its CatchHandler @ 010dc5ec */
  if (3 < param_5) {
                    /* WARNING: Subroutine does not return */
    png_error(param_1,"Unrecognized equation type for pCAL chunk");
  }
  iVar4 = FUN_010da8f4(param_1,param_2,auStack_c4);
  if (iVar4 == 0) {
                    /* WARNING: Subroutine does not return */
  ...
  if (0 < (int)param_6) {
    uVar11 = (ulong)param_6;
                    /* try { // try from 010dc4ac to 011dc4b3 has its CatchHandler @ 010dc594 */
    plVar8 = param_8;
    psVar10 = psVar6;
    do {
                    /* try { // try from 010dc4b4 to 011dc603 has its CatchHandler @ 010dc28c */
  ...
  if (param_1 == 0) {
    ...
    *(undefined4 *)(param_1 + 0x4e4) = 0x42;
    ...
    bVar3 = true;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010dc4ac with catch @ 010dc594
                        */
  ...
  if (bVar3) {
    ...
    if ((sVar5 != 0) && (param_7 != (char *)0x0)) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010dc43c with catch @ 010dc5ec
                        */
      png_write_data(param_1,param_7,sVar5);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010dc2dc with catch @ 010dc600
                        */
                    /* try { // try from 010dc604 to 011dc76f has its CatchHandler @ 010dc604
                       catch() { ... } // from try @ 010dc604 with catch @ 010dc604
                       catch() { ... } // from try @ 010dc778 with catch @ 010dc604 */
