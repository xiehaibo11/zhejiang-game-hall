...
/* void* 
   ...
   std::__ndk1::default_delete<std::__ndk1::__thread_struct> >, void (universe::Downloader2::*)(),
   universe::Downloader2*> >(void*) */

void * std::__ndk1::
       __thread_proxy<std::__ndk1::tuple<std::__ndk1::unique_ptr<std::__ndk1::__thread_struct,std::__ndk1::default_delete<std::__ndk1::__thread_struct>>,void(universe::Downloader2::*)(),universe::Downloader2*>>
                 (void *param_1)
