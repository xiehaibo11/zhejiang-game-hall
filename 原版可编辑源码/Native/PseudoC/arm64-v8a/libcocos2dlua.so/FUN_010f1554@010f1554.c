...
long FUN_010f1554(long *param_1,long *param_2,uint param_3,uint param_4,int param_5)

{
  ...
  long lVar13;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010f1504 with catch @ 010f155c
                        */
  uVar1 = param_4 + param_3;
                    /* catch() { ... } // from try @ 010f1604 with catch @ 010f1594 */
    ...
    if (*(int *)((long)param_2 + 0x2c) == 0) {
      ...
      *(undefined4 *)(puVar6 + 5) = 0x47;
      (*(code *)*puVar6)(param_1);
                    ...
                    /* try { // try from 010f15f8 to 011f1603 has its CatchHandler @ 010f1640 */
    if ((int)param_2[5] != 0) {
      uVar8 = *(uint *)((long)param_2 + 0x14);
                    /* try { // try from 010f1604 to 011f165b has its CatchHandler @ 010f1594 */
      if (uVar8 != 0) {
        ...
        if (0 < (long)uVar7) {
          uVar8 = *(uint *)((long)param_2 + 0xc);
                    /* catch() { ... } // from try @ 010f15f8 with catch @ 010f1640 */
          lVar13 = 0;
          lVar11 = uVar9 * uVar8;
          do {
            lVar12 = uVar7 * uVar8;
  ...
  if (uVar1 <= uVar8) goto LAB_010f1874;
  if (uVar8 < param_3) {
    uVar8 = param_3;
    if (param_5 == 0) {
      bVar5 = false;
...
LAB_010f17f4:
    ...
    if (param_5 != 0) goto LAB_010f17f4;
    bVar5 = false;
    iVar4 = *(int *)((long)param_2 + 0x24);
  }
  if (iVar4 == 0) {
    ...
    if (uVar8 < uVar1) {
      ...
      uVar7 = (ulong)uVar8;
      do {
        memset(*(void **)(*param_2 + uVar7 * 8),0,(ulong)uVar3);
        uVar7 = uVar7 + 1;
      } while (uVar1 != uVar7);
    }
  }
