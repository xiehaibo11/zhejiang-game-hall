...
/* std::__ndk1::__tree_node_base<void*>*&
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocostudio::timeline::AnimationInfo> > >::__find_equal<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
  ...
  *__s1_00;
  ...
  do {
    while( true ) {
      ...
      if (iVar4 == 0) break;
      if (iVar4 < 0) goto LAB_00cac1c4;
LAB_00cac1dc:
      if (((byte)_Var3 & 1) == 0) {
        __s1_00 = p_Var7 + 0x21;
      }
      iVar4 = memcmp(__s1_00,__s1,__n);
      if (iVar4 == 0) goto LAB_00cac15c;
      if (-1 < iVar4) goto LAB_00cac1f8;
LAB_00cac164:
      p_Var5 = p_Var7 + 8;
      p_Var6 = *(__tree<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocostudio::timeline::AnimationInfo>,std::__ndk1::__map_value_compare<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocostudio::timeline::AnimationInfo>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocostudio::timeline::AnimationInfo>>>
                 **)p_Var5;
...
LAB_00cac15c:
      if (uVar2 <= uVar1) goto LAB_00cac1f8;
      goto LAB_00cac164;
    }
LAB_00cac1c4:
    p_Var5 = p_Var7;
