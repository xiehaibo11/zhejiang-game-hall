...
/* void std::__ndk1::vector<tinyxml2::XMLElement*, std::__ndk1::allocator<tinyxml2::XMLElement*>
   >::__push_back_slow_path<tinyxml2::XMLElement* const&>(tinyxml2::XMLElement* const&) */
...
__push_back_slow_path<tinyxml2::XMLElement*const&>
          (vector<tinyxml2::XMLElement*,std::__ndk1::allocator<tinyxml2::XMLElement*>> *this,
          XMLElement **param_1)
