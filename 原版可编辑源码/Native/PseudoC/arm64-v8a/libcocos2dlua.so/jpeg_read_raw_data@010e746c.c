...

{
  ...
  if (iVar2 != 0xce) {
                    /* try { // try from 010e7494 to 011e749b has its CatchHandler @ 010e749c */
    puVar4 = (undefined8 *)*param_1;
                    /* catch() { ... } // from try @ 010e744c with catch @ 010e749c
                       catch() { ... } // from try @ 010e7494 with catch @ 010e749c
                       try { // try from 010e749c to 011e74bb has its CatchHandler @ 010e7414 */
