...
undefined8 * FUN_01263a84(long *param_1)
...
LAB_01263d0c:
        ...
        if (0xfef < lVar8 + 0x30U) {
          ...
          if (puVar5 == (void *)0x0) goto LAB_01263e40;
          lVar8 = 0;
          *puVar5 = puVar17;
          puVar5[1] = 0;
      ...
      if (uVar10 != 0) {
        ...
        pbVar7 = pbVar16;
        do {
          if (*pcVar6 != *pbVar7) goto LAB_01263d0c;
          pcVar6 = pcVar6 + 1;
          uVar10 = uVar10 - 1;
          pbVar7 = pbVar7 + 1;
        } while (uVar10 != 0);
        ...
        if (pbVar7 == pbVar15) {
          ...
          do {
            ...
            *param_1 = (long)pbVar7;
            ...
            pbVar16 = pbVar7;
            if ((pbVar15 == pbVar7) || (9 < *pbVar7 - 0x30)) goto LAB_01263d88;
            lVar11 = uVar10 * 10;
...
LAB_01263d88:
        if ((ulong)((long)pbVar15 - (long)pbVar7) < uVar10) goto LAB_01263d94;
        pbVar15 = pbVar16 + uVar10;
        *param_1 = (long)pbVar15;
      }
      param_1[1] = lVar8;
      *param_1 = lVar4;
      if ((pbVar16 == pbVar15) || (lVar4 = FUN_01263a84(param_1), lVar4 == 0)) {
        return (undefined8 *)0x0;
      }
      puVar17 = (undefined8 *)param_1[0x25c];
      lVar8 = puVar17[1];
      ...
      if (0xfef < lVar8 + 0x30U) {
        puVar5 = malloc(0x1000);
        if (puVar5 == (undefined8 *)0x0) goto LAB_01263e40;
        lVar8 = 0;
        *puVar5 = puVar17;
        puVar5[1] = 0;
        param_1[0x25c] = (long)puVar5;
...
LAB_01263dfc:
    ...
    if (*pbVar16 != 0x72) goto LAB_01263b48;
    pbVar16 = pbVar16 + 1;
    uVar13 = 4;
  ...
  puVar17 = (undefined8 *)FUN_012557ec(param_1);
  puVar5 = puVar17;
