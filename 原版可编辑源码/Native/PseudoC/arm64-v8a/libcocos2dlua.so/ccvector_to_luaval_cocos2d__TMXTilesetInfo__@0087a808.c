...
/* void ccvector_to_luaval<cocos2d::TMXTilesetInfo*>(lua_State*,
   cocos2d::Vector<cocos2d::TMXTilesetInfo*> const&) */

void ccvector_to_luaval<cocos2d::TMXTilesetInfo*>(lua_State *param_1,Vector *param_2)
