...

{
  ...
  uVar6 = CONCAT62((int6)((ulong)uVar9 >> 0x10),uVar8) & 0xffffffff;
                    /* catch() { ... } // from try @ 00eee2ec with catch @ 00eee3b4 */
  if (uVar6 < 2) {
                    /* catch() { ... } // from try @ 00eee458 with catch @ 00eee3d0 */
    uVar4 = uVar3 - 1 & uVar4;
  }
  else {
    uVar7 = 0;
  ...
  if (plVar5 != param_2 + 2) {
    uVar7 = plVar5[1];
    if (uVar6 < 2) {
                    /* try { // try from 00eee424 to 00fee457 has its CatchHandler @ 00eee468 */
      uVar7 = uVar7 & uVar3 - 1;
    }
    else if (uVar3 <= uVar7) {
      uVar1 = 0;
    ...
    if (uVar7 == uVar4) goto LAB_00eee478;
  }
  if (*param_3 != 0) {
    uVar7 = *(ulong *)(*param_3 + 8);
    if (uVar6 < 2) {
                    /* catch() { ... } // from try @ 00eee424 with catch @ 00eee468 */
      uVar7 = uVar7 & uVar3 - 1;
    }
    else if (uVar3 <= uVar7) {
      uVar1 = 0;
      ...
      uVar7 = uVar7 - uVar1 * uVar3;
                    /* try { // try from 00eee458 to 00fee4d3 has its CatchHandler @ 00eee3d0 */
    }
    if (uVar7 == uVar4) goto LAB_00eee478;
  }
