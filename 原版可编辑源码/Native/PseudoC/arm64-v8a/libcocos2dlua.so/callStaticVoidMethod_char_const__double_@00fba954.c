...
/* void cocos2d::JniHelper::callStaticVoidMethod<char const*,
...
void cocos2d::JniHelper::callStaticVoidMethod<char_const*,double>
...

{
  ...
  *puVar7 = 0;
  ...
  if ((uVar8 & 1) == 0) {
    ...
    _JNIEnv::CallStaticVoidMethod(p_Var5,p_Var6,param_4,local_78,uVar9);
