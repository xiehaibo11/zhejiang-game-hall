...
void FUN_00dc6b40(long *param_1,long *param_2)
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
        (**(code **)(*plVar2 + 0x18))(plVar2,local_60);
                    /* try { // try from 00dc6c14 to 00ec6c1b has its CatchHandler @ 00dc6d34 */
        (**(code **)(*(long *)param_1[4] + 0x20))();
        param_1[4] = 0;
        (**(code **)(*(long *)param_2[4] + 0x18))((long *)param_2[4],param_1);
                    /* try { // try from 00dc6c38 to 00ec6c3b has its CatchHandler @ 00dc6d24 */
                    /* try { // try from 00dc6c3c to 00ec6d4b has its CatchHandler @ 00dc6ba4 */
        ...
        (**(code **)(local_60[0] + 0x20))(local_60);
                    ...
                    /* catch() { ... } // from try @ 00dc6c3c with catch @ 00dc6ba4 */
      ...
      if (param_2 == plVar3) {
        (**(code **)(*plVar3 + 0x18))(plVar3,param_1);
                    /* try { // try from 00dc6be4 to 00ec6bef has its CatchHandler @ 00dc6d38 */
        (**(code **)(*(long *)param_2[4] + 0x20))();
        param_2[4] = param_1[4];
        param_1[4] = (long)param_1;
      }
