...
void FUN_01140a50(long param_1,long param_2)

{
  ...
  if (-1 < iVar2) {
    if (iVar2 < 0x65) {
      if (iVar2 * 0xff < 100) goto LAB_01140b8c;
    ...
    if ((int)uVar1 < 0xc) {
      iVar4 = *(int *)(&DAT_014985b4 + (ulong)(uVar1 & ((int)uVar1 >> 0x1f ^ 0xffffffffU)) * 4) *
              iVar2 >> 3;
    ...
    if ((int)uVar1 < 0xc) {
      iVar5 = *(int *)(&DAT_014985b4 + (ulong)(uVar1 & ((int)uVar1 >> 0x1f ^ 0xffffffffU)) * 4) *
              iVar2 >> 3;
    ...
    if ((int)uVar1 < 0xc) {
      iVar6 = *(int *)(&DAT_014985b4 + (ulong)(uVar1 & ((int)uVar1 >> 0x1f ^ 0xffffffffU)) * 4) *
              iVar2 >> 3;
    ...
    if ((int)uVar1 < 0xc) {
      iVar2 = *(int *)(&DAT_014985b4 + (ulong)(uVar1 & ((int)uVar1 >> 0x1f ^ 0xffffffffU)) * 4) *
              iVar2 >> 3;
    ...
    if (iVar2 != 0 || (iVar6 != 0 || (iVar5 != 0 || iVar4 != 0))) {
      FUN_0115faac(0x3f800000,param_2 + 0x33c);
