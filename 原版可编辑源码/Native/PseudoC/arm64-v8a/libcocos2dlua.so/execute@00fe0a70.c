...
/* cocos2d::MeshCommand::execute() */

void __thiscall cocos2d::MeshCommand::execute(MeshCommand *this)

{
  ...
  if (*(long *)(this + 0x98) == 0) {
    GLProgramState::apply(*(GLProgramState **)(this + 0xa0),(Mat4 *)(this + 0x58));
    ...
    *(long *)((long)&__DT_SYMTAB[0xa30].st_name + lVar4) = lVar3 + *(long *)(this + 0x50);
    ...
    if (puVar5 != puVar2) {
                    /* catch() { ... } // from try @ 00fe0a2c with catch @ 00fe0ab8 */
                    /* catch() { ... } // from try @ 00fe0a54 with catch @ 00fe0ac0 */
      do {
        Pass::bind((Pass *)*puVar5,(Mat4 *)(this + 0x58),true);
        glDrawElements(*(undefined4 *)(this + 0x44),*(undefined4 *)(this + 0x50),
                       *(undefined4 *)(this + 0x48),0);
        lVar3 = Director::getInstance();
        lVar4 = *(long *)(lVar3 + 0x1b0);
