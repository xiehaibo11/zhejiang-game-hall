...
/* void std::__ndk1::vector<cocos2d::Terrain::TerrainVertexData,
   std::__ndk1::allocator<cocos2d::Terrain::TerrainVertexData>
   >::__push_back_slow_path<cocos2d::Terrain::TerrainVertexData
   const&>(cocos2d::Terrain::TerrainVertexData const&) */
...
::__push_back_slow_path<cocos2d::Terrain::TerrainVertexData_const&>
          (vector<cocos2d::Terrain::TerrainVertexData,std::__ndk1::allocator<cocos2d::Terrain::TerrainVertexData>>
           *this,TerrainVertexData *param_1)

{
  ...
  if (uVar3 >> 0x3b != 0) {
    ...
    __vector_base_common<true>::__throw_length_error();
                    ...
                    /* try { // try from 00d4bc00 to 00e4bc0b has its CatchHandler @ 00d4c10c */
                    /* try { // try from 00d4bc0c to 00e4bd7f has its CatchHandler @ 00d4bbb0 */
