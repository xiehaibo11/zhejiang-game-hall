...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void (cocos2d::Skybox::*)(cocos2d::Mat4
   ...
   unsigned int), cocos2d::Skybox*, cocos2d::Mat4 const&, unsigned int&> >, void ()>::target_type()
   const */
...
{
  return &__bind<void(cocos2d::Skybox::*)(cocos2d::Mat4_const&,unsigned_int),cocos2d::Skybox*,cocos2d::Mat4_const&,unsigned_int&>
          ::typeinfo;
}
