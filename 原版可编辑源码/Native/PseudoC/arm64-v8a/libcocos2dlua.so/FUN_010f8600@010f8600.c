...
undefined8 FUN_010f8600(long *param_1,long param_2)

{
  ...
  long lVar18;
                    ...
                    /* catch() { ... } // from try @ 010f85d4 with catch @ 010f8620 */
  lVar11 = param_1[0x46];
  if (*(int *)((long)param_1 + 0x13c) != 0) {
    ...
    if (iVar9 == 0) {
      ...
      *(int *)(lVar11 + 0x38) = iVar9;
                    ...
                    /* catch() { ... } // from try @ 010f86fc with catch @ 010f8674 */
    ...
    do {
      ...
      if (iVar9 == 0) {
        ...
        if (10 < iVar4) {
          puVar7 = (undefined8 *)*param_1;
                    /* try { // try from 010f86f4 to 011f86fb has its CatchHandler @ 010f87c0 */
                    /* try { // try from 010f86fc to 011f87db has its CatchHandler @ 010f8674 */
      ...
      *(long *)(lVar13 + uVar14) = *(long *)(lVar13 + uVar14) + 1;
      if (0 < (int)lVar2) {
        ...
        do {
          ...
          if (sVar1 == 0) {
            ...
            uVar8 = -(ulong)(uVar12 >> 0x1f) & 0xfffffff800000000 | (ulong)uVar12 << 3;
                    /* catch() { ... } // from try @ 010f86f4 with catch @ 010f87c0 */
            uVar12 = 0;
        ...
        if (0 < (int)uVar12) {
                    /* catch() { ... } // from try @ 010f8820 with catch @ 010f87f0 */
          *plVar17 = *plVar17 + 1;
        }
      }
      lVar2 = lVar5 * 8;
      ...
      *piVar15 = (int)**(short **)(param_2 + lVar2);
                    ...
                    /* try { // try from 010f8818 to 011f881f has its CatchHandler @ 010f885c */
                    /* try { // try from 010f8820 to 011f8877 has its CatchHandler @ 010f87f0 */
  return 1;
}
