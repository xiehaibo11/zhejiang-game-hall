...
/* cocos2d::GLProgram::getVertexAttrib(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

long __thiscall cocos2d::GLProgram::getVertexAttrib(GLProgram *this,basic_string *param_1)

{
  long lVar1;
  long lVar2;
  
                    /* try { // try from 00fcf5bc to 010cf63f has its CatchHandler @ 00fcf58c */
  lVar2 = std::__ndk1::
