...

{
  ...
  uchar *puVar6;
                    ...
                    /* try { // try from 00adc1a0 to 00bdc1d7 has its CatchHandler @ 00adc1ec */
  ...
  if (ses != (SSL_SESSION *)0x0) {
    ...
    puVar6 = ses->sid_ctx + 0x14;
                    /* try { // try from 00adc1d8 to 00bdc207 has its CatchHandler @ 00adc100 */
    *(undefined8 *)(ses->sid_ctx + 0x1c) = 0;
    ...
    puVar4[6] = '\0';
    puVar4[7] = '\0';
                    /* catch() { ... } // from try @ 00adc1a0 with catch @ 00adc1ec */
    ...
    if (lVar2 != 0) {
      if (*(long *)((long)param_1 + 0x98) != 0) {
        X509_up_ref();
                    ...
                    /* try { // try from 00adc218 to 00bdc2b7 has its CatchHandler @ 00adc218
                       catch() { ... } // from try @ 00adc218 with catch @ 00adc218
                       catch() { ... } // from try @ 00adc2f0 with catch @ 00adc218 */
      if (*(long *)((long)param_1 + 0xa8) != 0) {
        lVar2 = X509_chain_up_ref();
        *(long *)(ses->krb5_client_princ + 0x18) = lVar2;
        if (lVar2 == 0) goto LAB_00adc344;
      }
      if (*(char **)((long)param_1 + 0x80) != (char *)0x0) {
        pcVar3 = CRYPTO_strdup(*(char **)((long)param_1 + 0x80),"ssl/ssl_sess.c",0xa3);
        *(char **)puVar6 = pcVar3;
        if (pcVar3 == (char *)0x0) goto LAB_00adc344;
      }
      ...
      if (iVar1 != 0) {
        if (*(char **)((long)param_1 + 0x108) != (char *)0x0) {
          ...
          *(char **)(ses->krb5_client_princ + 0x78) = pcVar3;
          if (pcVar3 == (char *)0x0) goto LAB_00adc344;
                    ...
                    /* try { // try from 00adc2b8 to 00bdc2ef has its CatchHandler @ 00adc304 */
        ...
        if (*(long *)((long)param_1 + 0x128) != 0) {
                    /* try { // try from 00adc2f0 to 00bdc31f has its CatchHandler @ 00adc218 */
        ...
        if (param_2 == 0) {
                    /* try { // try from 00adc320 to 00bdc3bf has its CatchHandler @ 00adc320
                       catch() { ... } // from try @ 00adc320 with catch @ 00adc320
                       catch() { ... } // from try @ 00adc3f8 with catch @ 00adc320 */
          ...
          ses->krb5_client_princ[0xb7] = '\0';
                    ...
                    /* catch() { ... } // from try @ 00adc2b8 with catch @ 00adc304 */
