...
uint __thiscall
cocos2d::GLProgram::compileShader(GLProgram *this,uint *param_1,uint param_2,char *param_3)

{
  ...
  local_48 = *(long *)(lVar1 + 0x28);
                    /* catch() { ... } // from try @ 00fcf5b4 with catch @ 00fcf624 */
  ...
  uVar2 = compileShader(this_00,param_1,param_2,param_3,(basic_string *)local_60,
