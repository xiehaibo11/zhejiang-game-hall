...

{
  ...
  undefined8 *puVar6;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00da13e0 with catch @ 00da13c0
                        */
  pAVar5 = *(AnimationData **)(this + 0x68);
                    /* try { // try from 00da13d8 to 00ea13df has its CatchHandler @ 00da14b0 */
  ...
  while (pAVar5 != this + 0x88) {
    ...
    if (*(AnimationData **)(pAVar5 + 8) == (AnimationData *)0x0) {
      pAVar3 = pAVar5 + 0x10;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00da13d8 with catch @ 00da14b0
                        */
      bVar2 = *(AnimationData **)*(AnimationData **)pAVar3 != pAVar5;
      pAVar5 = *(AnimationData **)pAVar3;
      if (bVar2) {
