...

{
  ...
  if (plVar5 != param_2 + 2) {
    uVar7 = plVar5[1];
                    /* try { // try from 00f4b810 to 0104b827 has its CatchHandler @ 00f4d5b4 */
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
    }
    else if (uVar3 <= uVar7) {
      ...
      uVar7 = uVar7 - uVar1 * uVar3;
                    /* try { // try from 00f4b82c to 0104b833 has its CatchHandler @ 00f4d53c */
    }
                    /* try { // try from 00f4b83c to 0104b84b has its CatchHandler @ 00f4d538 */
    if (uVar7 == uVar4) goto LAB_00f4b888;
  }
  if (*param_3 != 0) {
    ...
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
                    ...
                    /* try { // try from 00f4b858 to 0104b85f has its CatchHandler @ 00f4d520 */
      if (uVar3 <= uVar7) {
        uVar1 = 0;
        if (uVar3 != 0) {
          uVar1 = uVar7 / uVar3;
...
LAB_00f4b888:
  ...
  *plVar5 = *param_3;
  *param_3 = 0;
                    /* try { // try from 00f4b8e4 to 0104b8ef has its CatchHandler @ 00f4d5e8 */
