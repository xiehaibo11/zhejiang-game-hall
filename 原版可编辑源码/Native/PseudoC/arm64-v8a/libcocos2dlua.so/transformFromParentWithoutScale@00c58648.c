...
/* cocostudio::TransformHelp::transformFromParentWithoutScale(cocostudio::BaseData&,
   cocostudio::BaseData const&) */

void __thiscall
cocostudio::TransformHelp::transformFromParentWithoutScale
...

{
  ...
  if (fVar5 == -*(float *)(this + 0x34)) {
    ...
    fVar7 = -(fStack_94 * *(float *)(this + 0x38));
  ...
  _helpMatrix2 = CONCAT44(fStack_9c,local_b0);
  _DAT_0178578c = CONCAT44(local_a8,fStack_ac);
