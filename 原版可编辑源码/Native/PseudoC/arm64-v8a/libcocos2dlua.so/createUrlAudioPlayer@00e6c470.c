...
/* cocos2d::experimental::AudioPlayerProvider::createUrlAudioPlayer(cocos2d::experimental::AudioPlayerProvider::AudioFileInfo
   const&) */

UrlAudioPlayer * __thiscall
cocos2d::experimental::AudioPlayerProvider::createUrlAudioPlayer
...

{
  ...
  if (uVar3 == 0) {
    ...
    if ((this_00 == (UrlAudioPlayer *)0x0) || (((uVar8 ^ 1) & 1) == 0)) goto LAB_00e6c5ac;
