  ...
  if (param_3 != 0) {
    if (param_3 == 1) {
      ...
      do {
        ...
        auVar27._0_8_ = (long)(int)-(uint)(0.0 < fVar9 * 2.1474836e+09);
        ...
        uVar13 = CONCAT44((int)(long)(auVar27._8_8_ + (double)(fVar11 * 2.1474836e+09)),
                          (int)(long)(auVar27._0_8_ + (double)(fVar9 * 2.1474836e+09)));
      ...
      while( true ) {
        ...
        if (1.0 <= fVar9) {
          *piVar3 = 0x7fffffff;
          ...
          fVar11 = 0.5;
          if (fVar9 * 2.1474836e+09 <= 0.0) {
            fVar11 = -0.5;
          }
          *piVar3 = (int)(fVar11 + fVar9 * 2.1474836e+09);
        }
        pfVar2 = pfVar2 + 1;
        piVar3 = piVar3 + 1;
        if (lVar1 == 0) {
