...
void FUN_00dda074(undefined8 *param_1)

{
  ...
  local_50 = (void *)0x0;
  local_40 = 0x3f800000;
  local_90 = cocos2d::ui::RichText::KEY_TEXT_BOLD;
                    /* try { // try from 00dda0c8 to 00eda0cf has its CatchHandler @ 00dda484 */
  lVar6 = std::__ndk1::
          ...
          __emplace_unique_key_args<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&>,std::__ndk1::tuple<>>
                    ((basic_string *)&local_60,
                     (piecewise_construct_t *)cocos2d::ui::RichText::KEY_TEXT_BOLD,
  ...
  if (lStack_78 == 0) {
    ...
    if ((uVar5 & uVar5 - 1) == 0) {
      ...
      uVar7 = uVar7 - uVar1 * uVar5;
                    /* try { // try from 00dda184 to 00eda18f has its CatchHandler @ 00dda460 */
    }
    *(undefined8 **)(puVar4 + uVar7 * 8) = param_1 + 2;
    ...
    param_1[5] = 0;
                    ...
                    /* try { // try from 00dda1d4 to 00eda1e3 has its CatchHandler @ 00dda4d8 */
  puVar4 = local_90;
