    ...
    if (param_2 != 0) {
      ...
      if (0 < *(int *)(param_2 + 0x128)) {
        uVar5 = *(ulong *)(param_2 + 0x120);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010d6324 with catch @ 010d62cc
                       catch(type#1 @ 00000000) { ... } // from try @ 010d64e4 with catch @ 010d62cc
                        */
        ...
        do {
          if ((((*(byte *)(uVar5 + 0x18) >> 3 & 1) != 0) &&
            ...
            if (lVar7 == 0) {
                    /* try { // try from 010d631c to 011d6323 has its CatchHandler @ 010d65f0 */
              png_warning(param_1,"Writing zero-length unknown chunk");
              lVar7 = *(long *)(uVar5 + 0x10);
            }
                    /* try { // try from 010d6324 to 011d647b has its CatchHandler @ 010d62cc */
