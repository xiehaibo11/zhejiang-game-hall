...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int, cocos2d::ui::LayoutParameter*>,
   ...
   cocos2d::ui::LayoutParameter*>, void*>*>) */
...

{
  ...
  if (uVar6 < 2) {
                    /* try { // try from 00dad86c to 00ead8db has its CatchHandler @ 00dad6f4 */
    uVar4 = uVar3 - 1 & uVar4;
  }
  else {
    uVar7 = 0;
    if (uVar3 != 0) {
      uVar7 = uVar4 / uVar3;
                    ...
                    /* try { // try from 00dad85c to 00ead86b has its CatchHandler @ 00dae34c */
    if (uVar3 <= uVar4) {
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar7 == uVar4) goto LAB_00dad910;
  }
  if (*param_3 != 0) {
    uVar7 = *(ulong *)(*param_3 + 8);
                    /* try { // try from 00dad8dc to 00ead8eb has its CatchHandler @ 00dae348 */
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
    }
    else if (uVar3 <= uVar7) {
      ...
      if (uVar3 != 0) {
        uVar1 = uVar7 / uVar3;
                    ...
                    /* try { // try from 00dad8ec to 00ead95b has its CatchHandler @ 00dad6f4 */
      uVar7 = uVar7 - uVar1 * uVar3;
    }
    if (uVar7 == uVar4) goto LAB_00dad910;
  }
  ...
  if (*param_3 != 0) {
    ...
    if (uVar7 != uVar4) {
      *(long **)(*param_2 + uVar7 * 8) = plVar5;
                    ...
                    /* try { // try from 00dad95c to 00ead96b has its CatchHandler @ 00dae344 */
  *plVar5 = *param_3;
  *param_3 = 0;
                    /* try { // try from 00dad96c to 00ead9db has its CatchHandler @ 00dad6f4 */
