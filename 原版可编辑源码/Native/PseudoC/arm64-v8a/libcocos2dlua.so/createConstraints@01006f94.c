...
/* cocos2d::PhysicsJointMotor::createConstraints() */

void __thiscall cocos2d::PhysicsJointMotor::createConstraints(PhysicsJointMotor *this)

{
  ...
  local_30 = (cpConstraint *)
             cpSimpleMotorNew(*(undefined4 *)(this + 0x68),
