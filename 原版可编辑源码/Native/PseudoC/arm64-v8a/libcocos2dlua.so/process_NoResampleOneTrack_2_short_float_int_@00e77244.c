...
/* void cocos2d::experimental::AudioMixer::process_NoResampleOneTrack<2, short, float,
   int>(cocos2d::experimental::AudioMixer::state_t*, long) */

void cocos2d::experimental::AudioMixer::process_NoResampleOneTrack<2,short,float,int>
