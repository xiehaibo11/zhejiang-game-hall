...

{
  ...
  if (param_1 - 1 == 0) {
    ...
    param_1 = __next_prime(param_1);
                    ...
                    /* try { // try from 00d3489c to 00e348b3 has its CatchHandler @ 00d349d8 */
  uVar2 = *(ulong *)(this + 8);
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      uVar1 = (ulong)((float)*(ulong *)(this + 0x18) / *(float *)(this + 0x20));
                    /* try { // try from 00d348d8 to 00e348db has its CatchHandler @ 00d349f8 */
      if ((uVar2 < 3) ||
         ...
         uVar3 = NEON_uaddlv(uVar4,1), 1 < (uint)CONCAT62((int6)((ulong)uVar4 >> 0x10),uVar3))) {
                    /* try { // try from 00d3490c to 00e3490f has its CatchHandler @ 00d349f4 */
        uVar1 = __next_prime(uVar1);
      }
      else if (1 < uVar1) {
                    /* try { // try from 00d348f4 to 00e348fb has its CatchHandler @ 00d349d8 */
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00d34924;
    }
    return;
  }
LAB_00d34924:
                    /* try { // try from 00d3492c to 00e3492f has its CatchHandler @ 00d34a00 */
