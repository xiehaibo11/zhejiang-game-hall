...

{
  ...
  plVar10 = param_2;
  local_1b8 = pcVar11;
  if (param_2 != (long *)0x0) goto LAB_011e1528;
LAB_011e153c:
  bVar3 = true;
  if (param_3 != (long *)0x0) goto LAB_011e1568;
  do {
    param_3 = (long *)0x0;
    if (bVar3) {
LAB_011e1694:
      ...
      uVar7 = FUN_01208c2c(pcVar11,local_1b8,param_5,iVar6);
      *param_6 = uVar7;
      __check_grouping(local_198,local_178,local_1c0,param_5);
      if (param_2 == (long *)0x0) {
        bVar3 = true;
        if (param_3 == (long *)0x0) goto LAB_011e1720;
LAB_011e1748:
        ...
        if (bVar3 != (iVar6 == -1)) goto LAB_011e1788;
      }
      else {
        ...
        param_2 = plVar10;
        if (param_3 != (long *)0x0) goto LAB_011e1748;
LAB_011e1720:
        if (!bVar3) goto LAB_011e1788;
      }
      *param_5 = *param_5 | 2;
LAB_011e1788:
      if ((local_1b0 & 1) != 0) {
    ...
    while( true ) {
      ...
      plVar10 = param_2;
      if (param_2 == (long *)0x0) goto LAB_011e153c;
LAB_011e1528:
