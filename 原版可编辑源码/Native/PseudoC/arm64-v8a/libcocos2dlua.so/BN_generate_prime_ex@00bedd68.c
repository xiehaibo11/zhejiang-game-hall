                  ...
                  if (bits < 0xfa) {
                    if (bits < 200) {
                      if (bits < 2) {
                        ...
                        if ((bits != 2) || (safe == 0)) goto LAB_00bede40;
                        iVar10 = 0x75;
                      }
...
LAB_00bee404:
            ...
            do {
              lVar12 = 0;
              do {
                uVar9 = BN_mod_word(ret,(ulong)(ushort)(&DAT_014033f6)[lVar12]);
                if (uVar9 == 0xffffffffffffffff) goto LAB_00bee404;
              ...
              do {
                ...
                lVar12 = 0;
LAB_00bee03c:
                uVar7 = (ulong)(ushort)(&DAT_014033f6)[lVar12];
                if (uVar11 <= uVar7) goto LAB_00bee080;
                uVar1 = uVar9 + *(ushort *)((long)ptr + lVar12 * 2 + 2);
                uVar3 = 0;
                if (uVar7 != 0) {
                  uVar3 = uVar1 / uVar7;
                }
                if (uVar1 != uVar3 * uVar7) goto code_r0x00bee060;
                uVar9 = uVar9 + 2;
                uVar11 = uVar8;
              } while (uVar9 <= uVar8);
LAB_00bee0a0:
            ...
            do {
              lVar12 = 0;
              do {
                uVar8 = BN_mod_word(ret,(ulong)(ushort)(&DAT_014033f6)[lVar12]);
                if (uVar8 == 0xffffffffffffffff) goto LAB_00bee404;
              ...
              do {
                ...
                while( true ) {
                  ...
                  if (0x7fe < lVar12) {
                    ...
                    if (iVar4 == 0) goto LAB_00bee404;
                    iVar4 = BN_num_bits(ret);
                    if (iVar4 == bits) goto joined_r0x00bee25c;
                    goto LAB_00bee158;
                  }
                }
                uVar8 = uVar8 + 2;
          ...
          if (cb == (BN_GENCB *)0x0) {
            ...
            while( true ) {
              ...
              if (cb->ver == 2) {
                ...
                if (iVar6 == 0) goto LAB_00bee404;
              }
              else {
                if (cb->ver != 1) goto LAB_00bee404;
                if ((cb->cb).cb_1 != (_func_414 *)0x0) {
