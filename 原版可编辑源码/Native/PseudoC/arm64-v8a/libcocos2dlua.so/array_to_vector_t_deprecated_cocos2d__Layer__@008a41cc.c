...
/* bool array_to_vector_t_deprecated<cocos2d::Layer*>(cocos2d::__Array&,
   cocos2d::Vector<cocos2d::Layer*>&) */

bool array_to_vector_t_deprecated<cocos2d::Layer*>(__Array *param_1,Vector *param_2)
    ...
    *(undefined8 **)(param_2 + 8) = puVar8;
    if (0 < lVar6) {
      ...
      do {
        ...
        if ((lVar4 != 0) &&
           (pRVar5 = (Ref *)__dynamic_cast(lVar4,&cocos2d::Ref::typeinfo,&cocos2d::Layer::typeinfo,0
                                          ), pRVar5 != (Ref *)0x0)) {
          ...
          if (plVar9 == *(long **)(param_2 + 0x10)) {
            ...
            __push_back_slow_path<cocos2d::Layer*const&>
                      ((vector<cocos2d::Layer*,std::__ndk1::allocator<cocos2d::Layer*>> *)param_2,
                       (Layer **)&local_60);
          }
          else {
            *plVar9 = (long)pRVar5;
