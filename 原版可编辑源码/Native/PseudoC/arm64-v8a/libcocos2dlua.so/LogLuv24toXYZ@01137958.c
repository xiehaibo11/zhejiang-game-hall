        ...
        do {
          ...
          if ((int)(uVar5 - uVar3) < 2) {
            ...
            goto LAB_01137a34;
                    ...
                    /* try { // try from 011379fc to 01237a07 has its CatchHandler @ 01137a20 */
          uVar1 = (int)(uVar3 + uVar5) >> 1;
          uVar4 = (ulong)uVar1;
                    /* try { // try from 01137a08 to 01237a33 has its CatchHandler @ 011378a8 */
          sVar2 = *(short *)(&DAT_0149781e + (long)(int)uVar1 * 8);
        } while (0 < (int)(param_1 - (int)sVar2));
        uVar5 = uVar1;
      } while ((int)(param_1 - (int)sVar2) < 0);
LAB_01137a34:
                    /* try { // try from 01137a34 to 01237c8f has its CatchHandler @ 01137a34
                       catch() { ... } // from try @ 01137a34 with catch @ 01137a34
                       catch() { ... } // from try @ 01137c9c with catch @ 01137a34 */
