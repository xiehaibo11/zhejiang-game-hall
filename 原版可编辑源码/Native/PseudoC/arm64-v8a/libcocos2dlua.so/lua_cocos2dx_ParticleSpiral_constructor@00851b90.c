...
/* lua_cocos2dx_ParticleSpiral_constructor(lua_State*) */

bool lua_cocos2dx_ParticleSpiral_constructor(lua_State *param_1)
  ...
  if (iVar1 == 0) {
    ...
    *(undefined ***)(this + 0x2f8) = &PTR__ParticleSpiral_0170bd40;
    ...
    toluafix_pushusertype_ccobject
              (param_1,*(int *)(this + 0xc),(int *)(this + 0x10),this,"cc.ParticleSpiral");
  }
  else {
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "cc.ParticleSpiral:ParticleSpiral",iVar1,0);
  }
  return iVar1 == 0;
}
