...
ulong FUN_010fbb04(long param_1,long param_2)
          ...
          do {
            ...
            do {
              ...
              if ((uVar9 != 0) && (local_de == 0)) {
                ...
                if (lVar17 < 0) {
                  iVar12 = 0;
                    /* try { // try from 010fbe48 to 011fbec3 has its CatchHandler @ 010fbe48
                       catch() { ... } // from try @ 010fbe48 with catch @ 010fbe48
                       catch() { ... } // from try @ 010fbed0 with catch @ 010fbe48 */
                  if (uVar19 != 0) {
              ...
              if ((uVar9 != 0) && (local_d0 == 0)) {
                ...
                if (lVar17 < 0) {
                    /* try { // try from 010fbec4 to 011fbecf has its CatchHandler @ 010fbf0c */
                  iVar12 = 0;
                    /* try { // try from 010fbed0 to 011fbf27 has its CatchHandler @ 010fbe48 */
                  if (uVar20 != 0) {
              ...
              if ((uVar9 != 0) && (local_c0 == 0)) {
                    /* catch() { ... } // from try @ 010fbec4 with catch @ 010fbf0c */
                ...
                if (lVar17 < 0) {
                  ...
                  iVar13 = -iVar13;
                    ...
                    /* try { // try from 010fbf28 to 011fbfc3 has its CatchHandler @ 010fbf28
                       catch() { ... } // from try @ 010fbf28 with catch @ 010fbf28
                       catch() { ... } // from try @ 010fbfd0 with catch @ 010fbf28 */
                  iVar13 = 0;
                  if (uVar21 != 0) {
              ...
              if ((uVar9 != 0) && (local_ce == 0)) {
                ...
                if (lVar17 < 0) {
                  ...
                  if (uVar22 != 0) {
                    ...
                    /* catch() { ... } // from try @ 010fc034 with catch @ 010fc008 */
                  ...
                  iVar29 = -iVar29;
                    ...
                    /* try { // try from 010fbfc4 to 011fbfcf has its CatchHandler @ 010fbfec */
                  iVar29 = 0;
                    /* try { // try from 010fbfd0 to 011fc007 has its CatchHandler @ 010fbf28 */
                  if (uVar22 != 0) {
                    iVar29 = (int)((long)(lVar17 + uVar22 * 0x80) / (long)(uVar22 << 8));
                  }
                    /* catch() { ... } // from try @ 010fbfc4 with catch @ 010fbfec */
                  if ((0 < (int)uVar9) && (iVar13 = 1 << (ulong)(uVar9 & 0x1f), iVar13 <= iVar29)) {
                    iVar29 = iVar13 + -1;
                  }
                }
              ...
              uVar9 = *(uint *)(lVar33 + 0x14);
                    /* try { // try from 010fc02c to 011fc033 has its CatchHandler @ 010fc068 */
                    /* try { // try from 010fc034 to 011fc083 has its CatchHandler @ 010fc008 */
              if ((uVar9 != 0) && (local_dc == 0)) {
                lVar17 = uVar10 * 9 * (long)(local_e4 + iVar26 * -2 + iVar27);
                if (lVar17 < 0) {
                  iVar29 = 0;
                    /* try { // try from 010fc098 to 011fc0d7 has its CatchHandler @ 010fc098
                       catch() { ... } // from try @ 010fc098 with catch @ 010fc098
                       catch() { ... } // from try @ 010fc0f0 with catch @ 010fc098 */
                  if (uVar16 != 0) {
                  ...
                  iVar29 = 0;
                    /* catch() { ... } // from try @ 010fc02c with catch @ 010fc068 */
                  if (uVar16 != 0) {
                ...
                local_dc = (short)iVar29;
                    ...
                    /* try { // try from 010fc0d8 to 011fc0e7 has its CatchHandler @ 010fc1e8 */
              (*pcVar18)(param_1,lVar28,auStack_e0,local_100,iVar31);
                    /* try { // try from 010fc0e8 to 011fc0ef has its CatchHandler @ 010fc17c */
              uVar32 = uVar32 + 1;
              psVar30 = psVar30 + 0x40;
                    /* try { // try from 010fc0f0 to 011fc203 has its CatchHandler @ 010fc098 */
  ...
  *(uint *)(param_1 + 0xb8) = uVar32;
  ...
  if (*(uint *)(param_1 + 0x1b0) <= uVar32) {
    uVar11 = 4;
                    ...
                    /* catch() { ... } // from try @ 010fc0e8 with catch @ 010fc17c */
  return (ulong)uVar11;
}
