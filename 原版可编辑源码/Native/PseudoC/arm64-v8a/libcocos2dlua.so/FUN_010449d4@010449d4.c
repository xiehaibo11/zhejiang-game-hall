...
void FUN_010449d4(long param_1,long *param_2)

{
  ...
  lVar1 = *(long *)(param_1 + 0x830);
                    /* try { // try from 010449d8 to 011449fb has its CatchHandler @ 01045844 */
  if (lVar1 != 0) {
    lVar5 = param_2[1];
    lVar4 = *param_2;
    lVar7 = param_2[3];
    ...
    do {
      ...
      *param_2 = lVar4;
      ...
      lVar7 = lVar7 + *(long *)(lVar1 + 0x118);
                    /* try { // try from 010449fc to 01144a73 has its CatchHandler @ 01044928 */
      param_2[3] = lVar7;
      param_2[2] = lVar6;
