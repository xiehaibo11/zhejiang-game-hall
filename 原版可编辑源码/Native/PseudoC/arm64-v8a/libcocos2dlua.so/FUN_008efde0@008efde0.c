...
void FUN_008efde0(long param_1,undefined8 *param_2)

{
  long lVar1;
  
                    /* catch() { ... } // from try @ 008efce0 with catch @ 008efde0 */
  ...
  lVar1 = cocos2d::LuaEngine::getInstance();
                    /* WARNING: Could not recover jumptable at 0x008efe24. Too many branches */
