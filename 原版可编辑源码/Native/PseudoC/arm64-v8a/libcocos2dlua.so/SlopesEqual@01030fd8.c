...
/* ClipperLib::SlopesEqual(ClipperLib::IntPoint, ClipperLib::IntPoint, ClipperLib::IntPoint, bool)
    */
...

{
  ...
  if ((param_7 & 1) == 0) {
    return uVar2 * uVar5 - (param_4 - param_6) * (param_1 - param_3) == 0;
  }
  uVar8 = -uVar5;
  if (-1 < (long)uVar5) {
    uVar8 = uVar5;
