...
/* void ccvector_to_luaval<cocos2d::TMXObjectGroup*>(lua_State*,
   cocos2d::Vector<cocos2d::TMXObjectGroup*> const&) */

void ccvector_to_luaval<cocos2d::TMXObjectGroup*>(lua_State *param_1,Vector *param_2)
