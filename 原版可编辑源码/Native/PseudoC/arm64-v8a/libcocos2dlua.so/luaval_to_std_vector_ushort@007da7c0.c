...
/* luaval_to_std_vector_ushort(lua_State*, int, std::__ndk1::vector<unsigned short,
   std::__ndk1::allocator<unsigned short> >*, char const*) */

bool luaval_to_std_vector_ushort(lua_State *param_1,int param_2,vector *param_3,char *param_4)
      ...
      if ((iVar4 != 0) && (uVar5 = lua_objlen(param_1,param_2), uVar5 != 0)) {
        ...
        do {
          ...
          if (iVar4 != 0) {
            ...
            local_6c[0] = (ushort)(int)dVar7;
            puVar1 = *(ushort **)(param_3 + 8);
            if (puVar1 < *(ushort **)(param_3 + 0x10)) {
              *puVar1 = local_6c[0];
              *(ushort **)(param_3 + 8) = puVar1 + 1;
            }
            else {
              std::__ndk1::vector<unsigned_short,std::__ndk1::allocator<unsigned_short>>::
              __push_back_slow_path<unsigned_short>
                        ((vector<unsigned_short,std::__ndk1::allocator<unsigned_short>> *)param_3,
                         local_6c);
            }
          }
