...
/* duDebugDrawCylinderWire(duDebugDraw*, float, float, float, float, float, float, unsigned int,
   float) */
...

{
  ...
  if (param_1 != (duDebugDraw *)0x0) {
    ...
    duAppendCylinderWire(param_1,param_2,param_3,param_4,param_5,param_6,param_7,param_8);
                    /* WARNING: Could not recover jumptable at 0x01180c04. Too many branches */
