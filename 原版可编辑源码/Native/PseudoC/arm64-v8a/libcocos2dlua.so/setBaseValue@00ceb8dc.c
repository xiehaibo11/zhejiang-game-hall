...
/* cocosbuilder::CCBAnimationManager::setBaseValue(cocos2d::Value const&, cocos2d::Node*,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&) */

void __thiscall
cocosbuilder::CCBAnimationManager::setBaseValue
          (CCBAnimationManager *this,Value *param_1,Node *param_2,basic_string *param_3)
