...
/* void std::__ndk1::vector<cocos2d::extension::Invocation*,
   std::__ndk1::allocator<cocos2d::extension::Invocation*>
   >::__push_back_slow_path<cocos2d::extension::Invocation* const&>(cocos2d::extension::Invocation*
   const&) */
