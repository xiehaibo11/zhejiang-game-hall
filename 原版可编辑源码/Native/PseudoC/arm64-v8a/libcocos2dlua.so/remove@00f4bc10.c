  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar6 < 2) {
      ...
      uVar7 = uVar7 - uVar1 * uVar3;
                    /* try { // try from 00f4bc90 to 0104bca7 has its CatchHandler @ 00f4d5b4 */
    }
    if (uVar7 == uVar4) goto LAB_00f4bcec;
  }
  if (*param_3 != 0) {
    uVar7 = *(ulong *)(*param_3 + 8);
                    /* try { // try from 00f4bcb8 to 0104bcbf has its CatchHandler @ 00f4d50c */
    if (uVar6 < 2) {
                    /* try { // try from 00f4bcdc to 0104bce3 has its CatchHandler @ 00f4d4d8 */
      uVar7 = uVar7 & uVar3 - 1;
    }
    else if (uVar3 <= uVar7) {
      uVar1 = 0;
...
LAB_00f4bcec:
                    /* try { // try from 00f4bcf0 to 0104bd07 has its CatchHandler @ 00f4d508 */
  if (*param_3 != 0) {
    uVar7 = *(ulong *)(*param_3 + 8);
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
