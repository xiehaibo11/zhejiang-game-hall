...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, cocos2d::_DataRef>, void*>*>,
      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if (uVar13 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00f06a94;
            break;
          }
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00f06b04;
              }
              goto LAB_00f06a4c;
            }
          }
...
LAB_00f06a4c:
  ...
  *(undefined8 *)(plVar15 + 5) = 0;
  plVar15[6] = 0;
  plVar15[7] = 0;
  __s1 = (void *)cocos2d::Data::Data((Data *)(plVar15 + 5));
  *plVar15 = 0;
  plVar15[1] = uVar7;
  if ((uVar16 == 0) ||
     (*(float *)(param_1 + 0x20) * (float)uVar16 < (float)(*(long *)(param_1 + 0x18) + 1))) {
                    /* try { // try from 00f06b6c to 01006bd7 has its CatchHandler @ 00f06b6c
                       catch() { ... } // from try @ 00f06b6c with catch @ 00f06b6c
                       catch() { ... } // from try @ 00f06c34 with catch @ 00f06b6c */
  ...
  if (plVar11 == (long *)0x0) {
                    /* try { // try from 00f06be0 to 01006bef has its CatchHandler @ 00f06cc4 */
    pbVar12 = param_1 + 0x10;
    *plVar15 = *(long *)pbVar12;
    *(long **)pbVar12 = plVar15;
                    /* try { // try from 00f06bf0 to 01006c0b has its CatchHandler @ 00f06c94 */
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar12;
    if (*plVar15 == 0) goto LAB_00f06c30;
    ...
    if ((uVar16 & uVar16 - 1) == 0) {
      ...
      uVar7 = uVar7 - uVar13 * uVar16;
                    /* try { // try from 00f06c1c to 01006c33 has its CatchHandler @ 00f06cc8 */
    }
    plVar11 = (long *)(*(long *)param_1 + uVar7 * 8);
  }
  else {
                    /* try { // try from 00f06bd8 to 01006bdf has its CatchHandler @ 00f06cc8 */
    *plVar15 = *plVar11;
  }
  *plVar11 = (long)plVar15;
LAB_00f06c30:
                    /* try { // try from 00f06c34 to 01006ce3 has its CatchHandler @ 00f06b6c */
  uVar8 = 1;
