...
/* cocos2d::experimental::AudioEngineImpl::resume(int) */

void __thiscall cocos2d::experimental::AudioEngineImpl::resume(AudioEngineImpl *this,int param_1)
      ...
      do {
        ...
        if (uVar6 == uVar3) {
          if ((int)plVar5[2] == param_1) {
                    /* WARNING: Could not recover jumptable at 0x00e65cbc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
            (**(code **)(*(long *)plVar5[3] + 0x40))();
            return;
          }
        }
        else {
