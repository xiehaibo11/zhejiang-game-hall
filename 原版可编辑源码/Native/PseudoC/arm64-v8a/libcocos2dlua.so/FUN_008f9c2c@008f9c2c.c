...
void FUN_008f9c2c(long *param_1,long *param_2)
    ...
    if (plVar2 == param_1) {
      ...
      if (param_2 == plVar3) {
        ...
        param_2[4] = (long)plVar2;
                    ...
                    /* try { // try from 008f9d6c to 009f9dbb has its CatchHandler @ 008f9d6c
                       catch() { ... } // from try @ 008f9d6c with catch @ 008f9d6c
                       catch() { ... } // from try @ 008f9df0 with catch @ 008f9d6c
                       catch() { ... } // from try @ 008f9e38 with catch @ 008f9d6c */
