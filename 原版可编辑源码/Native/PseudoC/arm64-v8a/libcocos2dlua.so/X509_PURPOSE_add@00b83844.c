...

{
  ...
  if (8 < uVar5) {
    local_90[0] = id;
    if (((DAT_01784fa8 == 0) || (iVar3 = OPENSSL_sk_find(DAT_01784fa8,local_90), iVar3 == -1)) ||
      ...
      ptr[2] = 1;
      bVar1 = *(byte *)(ptr + 2);
      goto joined_r0x00b83a60;
    }
    if ((int)uVar5 < 0) {
      bVar2 = false;
      ptr = (int *)0x0;
      bVar1 = bRam0000000000000008;
      goto joined_r0x00b83a60;
    }
    if (8 < (int)uVar5) {
      ptr = (int *)OPENSSL_sk_value(DAT_01784fa8,iVar3);
      bVar2 = false;
      bVar1 = *(byte *)(ptr + 2);
      goto joined_r0x00b83a60;
    }
  ...
  bVar2 = false;
  ptr = (int *)(&DAT_0176f000 + (long)(int)uVar5 * 0x30);
  bVar1 = (&DAT_0176f008)[(long)(int)uVar5 * 0x30];
joined_r0x00b83a60:
  if ((bVar1 >> 1 & 1) != 0) {
  ...
  *(char **)(ptr + 8) = pcVar4;
  if ((pcVar4 == (char *)0x0) || (*(long *)(ptr + 6) == 0)) {
    ...
    *(void **)(ptr + 10) = arg;
    ...
    if ((DAT_01784fa8 == 0) && (DAT_01784fa8 = OPENSSL_sk_new(&LAB_00b83ae0), DAT_01784fa8 == 0)) {
      iVar3 = 199;
    }
    else {
      iVar3 = OPENSSL_sk_push(DAT_01784fa8,ptr);
      if (iVar3 != 0) {
        return 1;
      }
      iVar3 = 0xcb;
