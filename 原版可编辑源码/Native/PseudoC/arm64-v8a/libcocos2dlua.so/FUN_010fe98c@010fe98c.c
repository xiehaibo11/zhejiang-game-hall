...
undefined8 FUN_010fe98c(long param_1,long param_2)

{
  ...
  if ((*(int *)(param_1 + 0x174) != 0) && (*(int *)(lVar10 + 0x40) == 0)) {
    ...
    iVar2 = *(int *)(lVar10 + 0x20);
                    /* try { // try from 010fea8c to 011fea9f has its CatchHandler @ 010feb10 */
    iVar5 = iVar2 + 7;
    if (-1 < iVar2) {
      iVar5 = iVar2;
    }
    ...
    *(undefined4 *)(lVar10 + 0x28) = 0;
                    /* try { // try from 010feae8 to 011feaf7 has its CatchHandler @ 010feb08 */
    *(undefined4 *)(lVar10 + 0x40) = *(undefined4 *)(param_1 + 0x174);
    if (*(int *)(param_1 + 0x23c) == 0) {
      *(undefined4 *)(lVar10 + 0x3c) = 0;
                    /* try { // try from 010feaf8 to 011feaff has its CatchHandler @ 010feb04 */
    }
  }
  ...
  if (0 < *(int *)(param_1 + 0x1f0)) {
    uVar1 = *(uint *)(param_1 + 0x228);
                    /* try { // try from 010fe9ec to 011fe9f3 has its CatchHandler @ 010feb14 */
    lVar11 = 0;
                    /* try { // try from 010fe9f4 to 011fea8b has its CatchHandler @ 010fe7fc */
    local_48 = param_1;
    do {
      iVar5 = (int)uVar7;
      if (((int)uVar7 < 1) &&
         (uVar3 = FUN_011001c4(&local_68,uVar4,uVar7,1), uVar4 = local_58, iVar5 = local_50,
         (int)uVar3 == 0)) {
        return uVar3;
      }
      uVar6 = iVar5 - 1;
