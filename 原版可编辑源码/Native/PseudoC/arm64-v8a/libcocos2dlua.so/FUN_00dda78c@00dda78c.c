...
void FUN_00dda78c(undefined8 *param_1)

{
  ...
  cocos2d::Value::operator=
            ((Value *)(lVar6 + 0x28),(basic_string *)&cocos2d::ui::RichText::VALUE_TEXT_LINE_UNDER);
  std::__ndk1::
  ...
  uVar5 = uStack_88;
  puVar4 = local_90;
                    /* try { // try from 00dda858 to 00eda91f has its CatchHandler @ 00dda858
                       catch() { ... } // from try @ 00dda858 with catch @ 00dda858
                       catch() { ... } // from try @ 00dda928 with catch @ 00dda858
                       catch() { ... } // from try @ 00dda9c4 with catch @ 00dda858 */
  *param_1 = local_90;
  param_1[1] = uStack_88;
  param_1[2] = local_80;
  local_90 = (void *)0x0;
  ...
  *(undefined4 *)(param_1 + 4) = local_70;
  ...
  if (*(long *)(lVar2 + 0x28) == local_38) {
                    /* try { // try from 00dda920 to 00eda927 has its CatchHandler @ 00ddaa00 */
    return;
  }
