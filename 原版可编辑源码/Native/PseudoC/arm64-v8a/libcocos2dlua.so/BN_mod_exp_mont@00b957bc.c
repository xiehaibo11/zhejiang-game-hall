...
LAB_00b958b4:
    if (((a->neg != 0) || (iVar4 = BN_ucmp(a,m), -1 < iVar4)) &&
       (iVar4 = BN_nnmod(pBVar8,a,m,ctx), a = pBVar8, iVar4 == 0)) goto LAB_00b95d60;
    iVar4 = BN_is_zero(a);
    if (iVar4 == 0) {
      iVar4 = BN_to_montgomery(pBVar8,a,mont,ctx);
      if (iVar4 == 0) goto LAB_00b95d60;
      if (iVar3 < 0x2a0) {
        if (0xef < iVar3) {
          uVar14 = 5;
          goto LAB_00b959f8;
...
joined_r0x00b9590c:
    if (m_ctx != (BN_MONT_CTX *)0x0) goto LAB_00b95d68;
  }
  uVar16 = uVar14;
