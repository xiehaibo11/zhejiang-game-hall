...
void _spTranslateTimeline_apply
...
LAB_00d56418:
    ...
    lVar7 = *plVar4;
    if (param_8 == 0) {
      *(float *)(plVar4 + 5) = fVar16 * param_3 + *(float *)(lVar7 + 0x1c);
      fVar14 = fVar14 * param_3 + *(float *)(lVar7 + 0x20);
    }
    else {
      *(float *)(plVar4 + 5) =
           *(float *)(plVar4 + 5) +
           ((fVar16 + *(float *)(lVar7 + 0x1c)) - *(float *)(plVar4 + 5)) * param_3;
      fVar14 = *(float *)((long)plVar4 + 0x2c) +
               ((fVar14 + *(float *)(lVar7 + 0x20)) - *(float *)((long)plVar4 + 0x2c)) * param_3;
    }
    *(float *)((long)plVar4 + 0x2c) = fVar14;
  }
  else {
    if (param_8 - 1U < 2) {
      fVar14 = (float)plVar4[5];
      fVar16 = (float)((ulong)plVar4[5] >> 0x20);
      plVar4[5] = CONCAT44(fVar16 + ((float)((ulong)*(undefined8 *)(*plVar4 + 0x1c) >> 0x20) -
                                    fVar16) * param_3,
                           fVar14 + ((float)*(undefined8 *)(*plVar4 + 0x1c) - fVar14) * param_3);
      return;
    }
    if (param_8 == 0) {
      plVar4[5] = *(long *)(*plVar4 + 0x1c);
      return;
    }
  }
  return;
