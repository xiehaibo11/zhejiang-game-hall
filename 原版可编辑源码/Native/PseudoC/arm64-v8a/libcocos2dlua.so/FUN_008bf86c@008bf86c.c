...
undefined8 FUN_008bf86c(undefined8 param_1)

{
  ...
  local_48 = *(long *)(lVar1 + 0x28);
                    /* catch() { ... } // from try @ 008bf7dc with catch @ 008bf88c */
  ...
  if ((((iVar2 == 0) || (iVar2 = tolua_isnumber(param_1,2,0,auStack_58), iVar2 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glColorMask\'.",auStack_58);
  }
  else {
    ...
    glColorMask((int)dVar3,(int)dVar4,(int)dVar5,(int)dVar6);
  }
