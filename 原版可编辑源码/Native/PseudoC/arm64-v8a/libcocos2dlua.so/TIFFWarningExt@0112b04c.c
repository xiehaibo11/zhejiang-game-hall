...
void TIFFWarningExt(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if (_TIFFwarningHandler != (undefined *)0x0) {
    ...
    (*(code *)_TIFFwarningHandler)(param_2,param_3,&local_70);
  }
  if (_TIFFwarningHandlerExt != (code *)0x0) {
    ...
    (*_TIFFwarningHandlerExt)(param_1,param_2,param_3,&local_90);
  }
  return;
}
