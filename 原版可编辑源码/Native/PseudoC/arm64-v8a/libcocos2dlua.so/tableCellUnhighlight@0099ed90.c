...
/* non-virtual thunk to LUA_TableViewDelegate::tableCellUnhighlight(cocos2d::extension::TableView*,
   cocos2d::extension::TableViewCell*) */

void __thiscall
LUA_TableViewDelegate::tableCellUnhighlight
...

{
  ...
  if ((param_1 != (TableView *)0x0) && (param_2 != (TableViewCell *)0x0)) {
    ...
    iVar2 = cocos2d::ScriptHandlerMgr::getObjectHandler(pSVar5._0_4_,param_1,0x19);
    uVar3 = 0;
    if (iVar2 != 0) {
      local_48 = &local_40;
      local_50 = param_1;
      ...
      uVar3 = (**(code **)(*plVar4 + 0x128))((int)plVar4,0x19,&local_50);
    }
  }
