...

{
  ...
  undefined8 uVar4;
                    ...
                    /* catch() { ... } // from try @ 010c9504 with catch @ 010c94b4 */
  ...
  if (param_1 != 0) {
    ...
    *(uint *)(param_1 + 0x168) = uVar3 | 0x4000;
    if (param_2 != (undefined8 *)0x0) {
      if (param_3 == 0) {
                    /* catch() { ... } // from try @ 010c94fc with catch @ 010c9554 */
      ...
      *(uint *)(param_1 + 0x168) = uVar3 & 0xffffdfff | 0x4000;
                    /* try { // try from 010c94fc to 011c9503 has its CatchHandler @ 010c9554 */
      uVar3 = uVar1 & 0xff7bff7f;
                    /* try { // try from 010c9504 to 011c95ab has its CatchHandler @ 010c94b4 */
