...
/* void std::__ndk1::vector<ClipperLib::IntersectNode*,
   std::__ndk1::allocator<ClipperLib::IntersectNode*>
   >::__push_back_slow_path<ClipperLib::IntersectNode* const&>(ClipperLib::IntersectNode* const&) */

void __thiscall
std::__ndk1::vector<ClipperLib::IntersectNode*,std::__ndk1::allocator<ClipperLib::IntersectNode*>>::
