...

{
  ...
  if (((iVar1 != 0) && (iVar1 = ENGINE_set_name(e,"Software engine support"), iVar1 != 0)) &&
     (iVar1 = ENGINE_set_destroy_function(e,(ENGINE_GEN_INT_FUNC_PTR)&LAB_00bd6c74), iVar1 != 0)) {
      ...
      if (iVar1 != 0) {
        ...
        if (iVar1 != 0) {
          ...
          if (iVar1 != 0) {
            ...
            if (((iVar1 != 0) && (iVar1 = ENGINE_set_ciphers(e,FUN_00bd6cbc), iVar1 != 0)) &&
               ((iVar1 = ENGINE_set_digests(e,FUN_00bd6db8), iVar1 != 0 &&
                (iVar1 = ENGINE_set_load_privkey_function(e,FUN_00bd6e84), iVar1 != 0)))) {
              ENGINE_add(e);
              ENGINE_free(e);
              ERR_clear_error();
              return extraout_x0;
