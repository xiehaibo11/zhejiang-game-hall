...
void FUN_00f7a27c(long param_1)

{
  ...
  bVar2 = (**(code **)(*plVar4 + 0x198))(plVar4,param_1 + 0x20,param_1 + 0x38);
  plVar4 = *(long **)(param_1 + 0x70);
  bVar2 = bVar2 & 1;
  if (plVar4 == (long *)0x0) {
    local_90 = (long *)0x0;
  }
  else if ((long *)(param_1 + 0x50) == plVar4) {
    local_90 = alStack_b0;
...
LAB_00f7a3b8:
  ...
  if (alStack_b0 == local_90) {
    ...
    if (local_90 == (long *)0x0) goto LAB_00f7a3ec;
