...
/* std::__ndk1::__split_buffer<universe::network::AUpdates**,
   ...
   >::push_front(universe::network::AUpdates**&&) */
...

{
  ...
  undefined8 *__dest;
                    ...
                    /* try { // try from 00a073a0 to 00b073b3 has its CatchHandler @ 00a073f4 */
                    /* try { // try from 00a073b4 to 00b0740f has its CatchHandler @ 00a072e8 */
    ...
    if (uVar2 < uVar5) {
      ...
      if (-1 < lVar4 + 1) {
        lVar1 = lVar4 + 1;
                    ...
                    /* catch() { ... } // from try @ 00a07338 with catch @ 00a073f4
                       catch() { ... } // from try @ 00a073a0 with catch @ 00a073f4 */
