...
ulong FUN_01129b04(long param_1,ulong param_2,void *param_3,ulong param_4,undefined8 param_5)

{
  ...
  else if ((-1 < (long)(uVar4 | param_4)) && ((long)(uVar4 + param_4) <= lVar2)) goto LAB_01129c40;
  if (uVar3 != param_4) {
    TIFFErrorExt(*(undefined8 *)(param_1 + 0x3b8),param_5,
