...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<cocos2d::Node*,
   std::__ndk1::unordered_map<int, cocos2d::Map<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocosbuilder::CCBSequenceProperty*>, std::__ndk1::hash<int>, std::__ndk1::equal_to<int>,
   std::__ndk1::allocator<std::__ndk1::pair<int const, cocos2d::Map<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   ...
   std::__ndk1::allocator<std::__ndk1::pair<int const, cocos2d::Map<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocosbuilder::CCBSequenceProperty*> > > > >, std::__ndk1::__unordered_map_hasher<cocos2d::Node*,
   std::__ndk1::__hash_value_type<cocos2d::Node*, std::__ndk1::unordered_map<int,
   ...
   std::__ndk1::allocator<std::__ndk1::pair<int const, cocos2d::Map<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocosbuilder::CCBSequenceProperty*> > > > > > >::__emplace_unique_key_args<cocos2d::Node*,
   std::__ndk1::piecewise_construct_t const&, std::__ndk1::tuple<cocos2d::Node* const&>,
   std::__ndk1::tuple<> >(cocos2d::Node* const&, std::__ndk1::piecewise_construct_t const&,
   std::__ndk1::tuple<cocos2d::Node* const&>&&, std::__ndk1::tuple<>&&) */
      ...
      for (pNVar7 = (Node *)**(long **)(*param_1 + (long)unaff_x24 * 8); pNVar7 != (Node *)0x0;
        ...
        if (pNVar5 != pNVar9) {
          if (uVar6 < 2) {
            ...
            if (pNVar5 + -(uVar1 * (long)pNVar8) == unaff_x24) goto LAB_00cf0704;
            break;
          }
...
LAB_00cf0704:
  ...
  pNVar7 = operator_new(0x40);
  uVar3 = **(undefined8 **)param_4;
  *(undefined8 *)(pNVar7 + 0x30) = 0;
  *(undefined8 *)(pNVar7 + 0x28) = 0;
  *(Node **)(pNVar7 + 8) = pNVar9;
  *(undefined8 *)(pNVar7 + 0x10) = uVar3;
  *(undefined8 *)(pNVar7 + 0x20) = 0;
  *(undefined8 *)(pNVar7 + 0x18) = 0;
  *(undefined4 *)(pNVar7 + 0x38) = 0x3f800000;
  *(undefined8 *)pNVar7 = 0;
  if ((pNVar8 == (Node *)0x0) || (*(float *)(param_1 + 4) * (float)pNVar8 < (float)(param_1[3] + 1))
    ...
    rehash((__hash_table<std::__ndk1::__hash_value_type<cocos2d::Node*,std::__ndk1::unordered_map<int,cocos2d::Map<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocosbuilder::CCBSequenceProperty*>,std::__ndk1::hash<int>,std::__ndk1::equal_to<int>,std::__ndk1::allocator<std::__ndk1::pair<int_const,cocos2d::Map<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocosbuilder::CCBSequenceProperty*>>>>>,std::__ndk1::__unordered_map_hasher<cocos2d::Node*,std::__ndk1::__hash_value_type<cocos2d::Node*,std::__ndk1::unordered_map<int,cocos2d::Map<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocosbuilder::CCBSequenceProperty*>,std::__ndk1::hash<int>,std::__ndk1::equal_to<int>,std::__ndk1::allocator<std::__ndk1::pair<int_const,cocos2d::Map<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocosbuilder::CCBSequenceProperty*>>>>>,std::__n___d::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocosbuilder::CCBSequenceProperty*>>>>>>>
            *)param_1,uVar6);
    pNVar8 = param_1[1];
  ...
  if (pNVar9 == (Node *)0x0) {
    ...
    *(Node ***)(pNVar5 + (long)unaff_x24 * 8) = ppNVar4;
    if (*(long *)pNVar7 == 0) goto LAB_00cf0870;
