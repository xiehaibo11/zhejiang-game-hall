...
undefined8 FUN_0089da30(undefined8 param_1)

{
  ...
  if (((iVar2 == 0) || (iVar2 = tolua_isusertype(param_1,2,&DAT_012769c7,0,auStack_48), iVar2 == 0))
    ...
    tolua_error(param_1,"#ferror in function \'addObject\'.",auStack_48);
  }
  else {
    this = (__Array *)tolua_tousertype(param_1,1,0);
    pRVar3 = (Ref *)tolua_tousertype(param_1,2,0);
    if (this == (__Array *)0x0) {
      tolua_error(param_1,"invalid \'self\' in function \'addObject\'",0);
    }
    cocos2d::__Array::addObject(this,pRVar3);
  }
