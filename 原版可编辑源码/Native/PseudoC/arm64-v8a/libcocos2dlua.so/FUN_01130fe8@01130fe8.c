...
ulong FUN_01130fe8(long param_1,int *param_2,long param_3,undefined4 param_4,uint param_5,
                  long param_6)
  ...
  if (param_3 == 0) {
    ...
    *param_2 = *param_2 + 1;
    ...
    if ((*(uint *)(param_1 + 0x10) >> 0x13 & 1) != 0) {
      ...
      uVar3 = FUN_011317b0(param_1,param_2,param_3,param_4,0x10,uVar3,param_5 << 3,param_6);
      return uVar3;
    }
...
LAB_01131140:
      ...
      uVar3 = FUN_011317b0(param_1,param_2,param_3,param_4,4,uVar3,param_5 << 2,__ptr);
