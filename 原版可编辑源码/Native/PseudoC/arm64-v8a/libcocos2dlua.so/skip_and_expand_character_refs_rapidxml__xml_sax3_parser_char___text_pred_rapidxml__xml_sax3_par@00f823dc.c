...
/* char* 
   rapidxml::xml_sax3_parser<char>::skip_and_expand_character_refs<rapidxml::xml_sax3_parser<char>::text_pred,
   rapidxml::xml_sax3_parser<char>::text_pure_no_ws_pred, 1>(char*&) */

char * rapidxml::xml_sax3_parser<char>::
       skip_and_expand_character_refs<rapidxml::xml_sax3_parser<char>::text_pred,rapidxml::xml_sax3_parser<char>::text_pure_no_ws_pred,1>
                 (char **param_1)

{
  ...
  do {
    pbVar5 = pbVar5 + 1;
  } while (internal::lookup_tables<0>::lookup_text_pure_no_ws[*pbVar5] != '\0');
  *param_1 = (char *)pbVar5;
  local_70 = pbVar5;
LAB_00f8246c:
  bVar6 = *pbVar5;
  if (bVar6 != 0x26) {
    ...
    goto switchD_00f824a4_caseD_62;
  }
