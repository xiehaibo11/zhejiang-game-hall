...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<cocos2d::Node*,
   int>, void*>*>, bool> std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<cocos2d::Node*,
   int>, std::__ndk1::__unordered_map_hasher<cocos2d::Node*,
   std::__ndk1::__hash_value_type<cocos2d::Node*, int>, std::__ndk1::hash<cocos2d::Node*>, true>,
   std::__ndk1::__unordered_map_equal<cocos2d::Node*, std::__ndk1::__hash_value_type<cocos2d::Node*,
   int>, std::__ndk1::equal_to<cocos2d::Node*>, true>,
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<cocos2d::Node*, int> >
      ...
      if (pNVar8 <= pNVar9) {
        ...
        if (pNVar8 != (Node *)0x0) {
          uVar1 = (ulong)pNVar9 / (ulong)pNVar8;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fa2d08 with catch @ 00fa2c44
                        */
      ...
      for (pNVar7 = (Node *)**(long **)(*param_1 + (long)unaff_x24 * 8); pNVar7 != (Node *)0x0;
        ...
        if (pNVar5 != pNVar9) {
          if (uVar6 < 2) {
            ...
            if (pNVar5 + -(uVar1 * (long)pNVar8) == unaff_x24) goto LAB_00fa2c80;
            break;
          }
          if (pNVar5 != unaff_x24) break;
        }
LAB_00fa2c80:
                    /* try { // try from 00fa2c80 to 010a2cd7 has its CatchHandler @ 00fa2dd4 */
  ...
  *(undefined4 *)(pNVar7 + 0x18) = 0;
                    /* try { // try from 00fa2cd8 to 010a2ce7 has its CatchHandler @ 00fa2dc0 */
  *(undefined8 *)pNVar7 = 0;
  *(Node **)(pNVar7 + 8) = pNVar9;
  *(undefined8 *)(pNVar7 + 0x10) = uVar3;
                    /* try { // try from 00fa2cf4 to 010a2d07 has its CatchHandler @ 00fa2dd4 */
  if ((pNVar8 == (Node *)0x0) || (*(float *)(param_1 + 4) * (float)pNVar8 < (float)(param_1[3] + 1))
     ) {
                    /* try { // try from 00fa2d08 to 010a2def has its CatchHandler @ 00fa2c44 */
    ...
    rehash((__hash_table<std::__ndk1::__hash_value_type<cocos2d::Node*,int>,std::__ndk1::__unordered_map_hasher<cocos2d::Node*,std::__ndk1::__hash_value_type<cocos2d::Node*,int>,std::__ndk1::hash<cocos2d::Node*>,true>,std::__ndk1::__unordered_map_equal<cocos2d::Node*,std::__ndk1::__hash_value_type<cocos2d::Node*,int>,std::__ndk1::equal_to<cocos2d::Node*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<cocos2d::Node*,int>>>
            *)param_1,uVar6);
    pNVar8 = param_1[1];
  ...
  if (pNVar9 == (Node *)0x0) {
    ...
    *(Node ***)(pNVar5 + (long)unaff_x24 * 8) = ppNVar4;
    if (*(long *)pNVar7 == 0) goto LAB_00fa2dd8;
    ...
    if (((ulong)pNVar8 & (ulong)(pNVar8 + -1)) == 0) {
      ...
      if (pNVar8 != (Node *)0x0) {
        uVar2 = (ulong)pNVar9 / (ulong)pNVar8;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fa2cd8 with catch @ 00fa2dc0
                        */
    ...
    *(undefined8 *)pNVar7 = *(undefined8 *)pNVar9;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fa2c80 with catch @ 00fa2dd4
                       catch(type#1 @ 00000000) { ... } // from try @ 00fa2cf4 with catch @ 00fa2dd4
                        */
  *(Node **)pNVar9 = pNVar7;
LAB_00fa2dd8:
