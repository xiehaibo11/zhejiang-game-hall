...

{
  ...
  long local_68;
                    ...
                    /* catch() { ... } // from try @ 00fd196c with catch @ 00fd1934 */
  lVar5 = tpidr_el0;
  local_68 = *(long *)(lVar5 + 0x28);
  uVar7 = *(ulong *)(param_1 + 8);
  pbVar2 = *(basic_string **)(param_1 + 0x10);
                    /* try { // try from 00fd1964 to 010d196b has its CatchHandler @ 00fd19dc */
                    /* try { // try from 00fd196c to 010d19f7 has its CatchHandler @ 00fd1934 */
  if (((byte)*param_1 & 1) == 0) {
    pbVar2 = param_1 + 1;
  ...
  if (uVar12 != 0) {
    ...
    if (plVar8 != (long *)0x0) {
      plVar8 = (long *)*plVar8;
      if (plVar8 != (long *)0x0) {
                    /* catch() { ... } // from try @ 00fd1964 with catch @ 00fd19dc */
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00fd1a04;
              goto LAB_00fd1ab4;
            }
            if (uVar9 != uVar14) goto LAB_00fd1ab4;
          }
LAB_00fd1a04:
          plVar8 = (long *)*plVar8;
...
LAB_00fd1ab8:
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* catch() { ... } // from try @ 00fd1b14 with catch @ 00fd1adc */
    return plVar8;
  }
