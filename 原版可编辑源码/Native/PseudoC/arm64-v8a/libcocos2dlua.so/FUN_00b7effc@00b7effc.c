...
undefined8 FUN_00b7effc(undefined8 param_1,undefined8 param_2,BIO *param_3,uint param_4)
...
LAB_00b7f15c:
        ...
        if (*piVar8 == 0) {
          ...
          if (0 < iVar3) {
            iVar3 = 0;
            do {
              BIO_printf(param_3,"%*s",(ulong)uVar1,&DAT_013c996e);
        ...
        BIO_printf(param_3,"%*sRelative Name:\n%*s",(ulong)param_4,&DAT_013c996e,(ulong)uVar1,
                   &DAT_013c996e);
      ...
      if (lVar7 != 0) {
        FUN_00b7fd28(param_3,"Reasons",lVar7,param_4);
      }
      if (puVar5[2] != 0) {
      ...
      iVar3 = OPENSSL_sk_num(param_2);
                    ...
                    /* try { // try from 00b7f21c to 00c7f34b has its CatchHandler @ 00b7f21c
                       catch() { ... } // from try @ 00b7f21c with catch @ 00b7f21c
                       catch() { ... } // from try @ 00b7f360 with catch @ 00b7f21c */
  return 1;
}
