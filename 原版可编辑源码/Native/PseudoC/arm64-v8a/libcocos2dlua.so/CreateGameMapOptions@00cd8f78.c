...
/* flatbuffers::CreateGameMapOptions(flatbuffers::FlatBufferBuilder&,
   flatbuffers::Offset<flatbuffers::WidgetOptions>, flatbuffers::Offset<flatbuffers::ResourceData>)
    */

undefined4 flatbuffers::CreateGameMapOptions(FlatBufferBuilder *param_1,int param_2,int param_3)
