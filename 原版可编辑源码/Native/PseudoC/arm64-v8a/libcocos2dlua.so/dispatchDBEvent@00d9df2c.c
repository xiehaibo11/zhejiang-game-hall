...
/* dragonBones::CCArmatureDisplay::dispatchDBEvent(std::__ndk1::basic_string<char,
...
{
  cocos2d::EventDispatcher::dispatchCustomEvent(*(EventDispatcher **)(this + 0x308),param_1,param_2)
  ;
  return;
}
