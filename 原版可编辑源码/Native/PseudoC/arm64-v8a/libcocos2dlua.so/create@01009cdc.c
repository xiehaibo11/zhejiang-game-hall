...
/* cocos2d::PhysicsShapeBox::create(cocos2d::Size const&, cocos2d::PhysicsMaterial const&,
   cocos2d::Vec2 const&, float) */

Ref * cocos2d::PhysicsShapeBox::create
...

{
  ...
  if (this != (Ref *)0x0) {
    ...
    *(undefined ***)this = &PTR__PhysicsShapeBox_017260b8;
    uVar2 = init((Size *)this,(PhysicsMaterial *)param_1,param_2,param_4);
    if ((uVar2 & 1) == 0) {
