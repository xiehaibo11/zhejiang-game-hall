...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<unsigned
   int, cocostudio::TriggerObj*>, void*>*>, bool>
   std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned int, cocostudio::TriggerObj*>,
   std::__ndk1::__unordered_map_hasher<unsigned int, std::__ndk1::__hash_value_type<unsigned int,
   cocostudio::TriggerObj*>, std::__ndk1::hash<unsigned int>, true>,
   std::__ndk1::__unordered_map_equal<unsigned int, std::__ndk1::__hash_value_type<unsigned int,
   cocostudio::TriggerObj*>, std::__ndk1::equal_to<unsigned int>, true>,
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<unsigned int, cocostudio::TriggerObj*> >
   >::__emplace_unique_key_args<unsigned int, std::__ndk1::pair<unsigned int,
   cocostudio::TriggerObj*> >(unsigned int const&, std::__ndk1::pair<unsigned int,
   cocostudio::TriggerObj*>&&) */
      ...
      for (plVar8 = (long *)*plVar8; plVar8 != (long *)0x0; plVar8 = (long *)*plVar8) {
        ...
        if (uVar7 != uVar10) {
          if (uVar6 < 2) {
            ...
            if (uVar7 - uVar2 * uVar9 == unaff_x24) goto LAB_00c6bea0;
            break;
          }
