...
/* void std::__ndk1::vector<std::__ndk1::pair<cocos2d::ScriptHandlerMgr::HandlerType, int>,
   std::__ndk1::allocator<std::__ndk1::pair<cocos2d::ScriptHandlerMgr::HandlerType, int> >
   >::__push_back_slow_path<std::__ndk1::pair<cocos2d::ScriptHandlerMgr::HandlerType, int>
   const&>(std::__ndk1::pair<cocos2d::ScriptHandlerMgr::HandlerType, int> const&) */
