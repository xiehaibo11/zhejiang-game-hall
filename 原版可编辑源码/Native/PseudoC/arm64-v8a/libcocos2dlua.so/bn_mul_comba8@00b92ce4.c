  ...
  *param_1 = uVar132 * uVar130;
  ...
  if (CARRY8(uVar136,uVar130)) {
    uVar133 = uVar133 + 1;
                    ...
                    /* try { // try from 00b92d6c to 00c930af has its CatchHandler @ 00b92d6c
                       catch() { ... } // from try @ 00b92d6c with catch @ 00b92d6c
                       catch() { ... } // from try @ 00b930c4 with catch @ 00b92d6c
                       catch() { ... } // from try @ 00b93128 with catch @ 00b92d6c */
  ...
  uVar132 = uVar136 + uVar133;
                    /* try { // try from 00b930b0 to 00c930c3 has its CatchHandler @ 00b932dc */
  uVar134 = *param_3;
  uVar137 = param_2[7];
  if (CARRY8(uVar136,uVar133)) {
    uVar131 = uVar131 + 1;
  ...
  auVar34._0_8_ = param_2[5];
                    /* try { // try from 00b930c4 to 00c93113 has its CatchHandler @ 00b92d6c */
  auVar98._8_8_ = 0;
  ...
  uVar134 = uVar132 + uVar130;
                    /* try { // try from 00b93114 to 00c93127 has its CatchHandler @ 00b932bc */
  ...
  uVar133 = param_3[2] * param_2[6];
                    /* try { // try from 00b93128 to 00c93303 has its CatchHandler @ 00b92d6c */
  ...
  uVar130 = uVar136 + uVar132;
                    /* catch() { ... } // from try @ 00b93114 with catch @ 00b932bc */
  if (CARRY8(uVar136,uVar132)) {
    uVar131 = uVar131 + 1;
  }
  ...
  if (CARRY8(uVar131,uVar138 + uVar134)) {
    uVar129 = uVar132;
                    ...
                    /* catch() { ... } // from try @ 00b930b0 with catch @ 00b932dc */
  uVar132 = uVar133 + uVar130;
  if (CARRY8(uVar133,uVar130)) {
    uVar137 = uVar137 + 1;
  }
