...
/* cocos2d::Console::getCommand(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&) */

undefined8 __thiscall cocos2d::Console::getCommand(Console *this,basic_string *param_1)
