...
/* void std::__ndk1::vector<cocos2d::TMXTilesetInfo*,
   std::__ndk1::allocator<cocos2d::TMXTilesetInfo*>
   >::__push_back_slow_path<cocos2d::TMXTilesetInfo* const&>(cocos2d::TMXTilesetInfo* const&) */
