...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<cocostudio::Armature*,
   ...
   cocostudio::ArmatureMovementDispatcher*> > >::__rehash(unsigned long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<cocostudio::Armature*,cocostudio::ArmatureMovementDispatcher*>,std::__ndk1::__unordered_map_hasher<cocostudio::Armature*,std::__ndk1::__hash_value_type<cocostudio::Armature*,cocostudio::ArmatureMovementDispatcher*>,std::__ndk1::hash<cocostudio::Armature*>,true>,std::__ndk1::__unordered_map_equal<cocostudio::Armature*,std::__ndk1::__hash_value_type<cocostudio::Armature*,cocostudio::ArmatureMovementDispatcher*>,std::__ndk1::equal_to<cocostudio::Armature*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<cocostudio::Armature*,cocostudio::ArmatureMovementDispatcher*>>>
           *this,ulong param_1)
