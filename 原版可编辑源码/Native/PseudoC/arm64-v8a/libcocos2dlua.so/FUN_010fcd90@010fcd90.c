...
void FUN_010fcd90(long param_1,long *param_2,uint param_3,undefined8 *param_4,int param_5)
    ...
    do {
      ...
      do {
        ...
        *puVar16 = *(undefined1 *)(lVar10 + (long)*(int *)(lVar2 + (ulong)bVar6 * 4) + uVar9);
                    /* try { // try from 010fce04 to 011fce0f has its CatchHandler @ 010fd168 */
        ...
        puVar16[2] = *(undefined1 *)(lVar10 + (long)*(int *)(lVar4 + (ulong)bVar7 * 4) + uVar9);
                    /* try { // try from 010fce2c to 011fce33 has its CatchHandler @ 010fd188 */
        puVar16 = puVar16 + 3;
        pbVar12 = pbVar12 + 1;
        pbVar13 = pbVar13 + 1;
        pbVar14 = pbVar14 + 1;
