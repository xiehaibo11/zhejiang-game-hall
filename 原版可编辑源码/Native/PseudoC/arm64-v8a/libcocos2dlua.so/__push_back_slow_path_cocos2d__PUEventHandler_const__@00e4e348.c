...
/* void std::__ndk1::vector<cocos2d::PUEventHandler*,
   std::__ndk1::allocator<cocos2d::PUEventHandler*>
   >::__push_back_slow_path<cocos2d::PUEventHandler* const&>(cocos2d::PUEventHandler* const&) */
...
__push_back_slow_path<cocos2d::PUEventHandler*const&>
          (vector<cocos2d::PUEventHandler*,std::__ndk1::allocator<cocos2d::PUEventHandler*>> *this,
          PUEventHandler **param_1)
