...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   cocostudio::timeline::ActionTimeline*>, void*>*>
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocostudio::timeline::ActionTimeline*> > >::find<std::__ndk1::basic_string<char,
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00ca5164;
              goto LAB_00ca5214;
            }
            if (uVar9 != uVar14) goto LAB_00ca5214;
          }
LAB_00ca5164:
          plVar8 = (long *)*plVar8;
