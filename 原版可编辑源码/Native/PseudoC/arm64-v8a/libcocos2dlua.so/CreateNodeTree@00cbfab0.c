...
/* flatbuffers::CreateNodeTree(flatbuffers::FlatBufferBuilder&,
   flatbuffers::Offset<flatbuffers::String>,
   flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::NodeTree> > >,
   flatbuffers::Offset<flatbuffers::Options>, flatbuffers::Offset<flatbuffers::String>) */

undefined4
flatbuffers::CreateNodeTree
          (FlatBufferBuilder *param_1,undefined4 param_2,int param_3,int param_4,undefined4 param_5)
