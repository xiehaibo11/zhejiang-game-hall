...
/* cocostudio::FlatBuffersSerialize::getWidgetReaderClassName(cocos2d::ui::Widget*) */

Widget * cocostudio::FlatBuffersSerialize::getWidgetReaderClassName(Widget *param_1)
