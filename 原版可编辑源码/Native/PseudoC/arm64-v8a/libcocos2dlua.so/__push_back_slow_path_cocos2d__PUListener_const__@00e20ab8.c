...
/* void std::__ndk1::vector<cocos2d::PUListener*, std::__ndk1::allocator<cocos2d::PUListener*>
   >::__push_back_slow_path<cocos2d::PUListener* const&>(cocos2d::PUListener* const&) */
...
__push_back_slow_path<cocos2d::PUListener*const&>
          (vector<cocos2d::PUListener*,std::__ndk1::allocator<cocos2d::PUListener*>> *this,
          PUListener **param_1)
