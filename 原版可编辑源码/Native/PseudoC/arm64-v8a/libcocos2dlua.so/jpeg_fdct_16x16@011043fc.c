...

{
  ...
  int local_80 [8];
                    ...
                    /* try { // try from 01104404 to 0120440b has its CatchHandler @ 01104440 */
                    /* try { // try from 0110440c to 01204487 has its CatchHandler @ 01104340 */
  piVar35 = param_1;
  iVar17 = 0;
  while( true ) {
    do {
      iVar21 = iVar17;
      piVar19 = piVar35;
                    /* catch() { ... } // from try @ 01104404 with catch @ 01104440 */
                    /* catch() { ... } // from try @ 011043ec with catch @ 01104448 */
      pbVar1 = (byte *)(*(long *)(param_2 + (long)iVar21 * 8) + (param_3 & 0xffffffff));
                    /* catch() { ... } // from try @ 01104524 with catch @ 01104488 */
      ...
      lVar25 = lVar25 - lVar33;
                    /* try { // try from 0110451c to 01204523 has its CatchHandler @ 011045ec */
      lVar33 = lVar10 + lVar27;
                    /* try { // try from 01104524 to 01204607 has its CatchHandler @ 01104488 */
      ...
      lVar10 = (lVar23 + lVar9) * -0x2b4e + (lVar12 - lVar11) * 0xd23;
                    /* catch() { ... } // from try @ 0110451c with catch @ 011045ec */
      ...
      *piVar19 = ((int)lVar14 + (int)lVar33 + (int)lVar16 + (int)lVar20) * 4 + -0x2000;
      ...
      piVar19[7] = (int)(lVar11 * 0x4560 + lVar23 * 0x2218 + lVar10 + lVar32 + lVar29 + 0x400U >>
                        0xb);
                    /* try { // try from 011046b4 to 01204757 has its CatchHandler @ 011046b4
                       catch() { ... } // from try @ 011046b4 with catch @ 011046b4
                       catch() { ... } // from try @ 01104778 with catch @ 011046b4 */
      piVar35 = local_160;
      iVar17 = 8;
    } while (iVar21 == 7);
    if (iVar21 == 0xf) break;
  ...
  do {
    ...
    lVar9 = (long)(piVar35[0x18] + *param_1);
                    /* try { // try from 01104758 to 0120475f has its CatchHandler @ 011047b4 */
    ...
    lVar24 = (long)(piVar35[-0x18] + param_1[0x30]);
                    /* try { // try from 01104770 to 01204777 has its CatchHandler @ 011047ac */
    lVar25 = (long)(piVar35[-0x20] + param_1[0x38]);
    lVar33 = (long)iVar21;
                    /* try { // try from 01104778 to 012047f3 has its CatchHandler @ 011046b4 */
    lVar13 = (long)iVar2;
    lVar18 = (long)iVar3;
    lVar22 = (long)iVar4;
    lVar23 = (long)iVar5;
    ...
    lVar24 = lVar27 + lVar12;
                    /* catch() { ... } // from try @ 01104770 with catch @ 011047ac */
    lVar12 = lVar12 - lVar27;
    lVar27 = lVar16 + lVar10;
                    /* catch() { ... } // from try @ 01104758 with catch @ 011047b4 */
    lVar10 = lVar10 - lVar16;
                    /* catch() { ... } // from try @ 0110489c with catch @ 011047f4 */
    lVar15 = (lVar18 + lVar33) * 0x27e9 + (lVar30 + lVar28) * 0x1555;
    lVar14 = (lVar22 + lVar33) * 0x22fc + (lVar23 - lVar30) * 0x1cb6;
                    /* try { // try from 01104894 to 0120489b has its CatchHandler @ 0110496c */
                    /* try { // try from 0110489c to 01204987 has its CatchHandler @ 011047f4 */
    ...
    *param_1 = (int)(lVar27 + lVar24 + lVar25 + lVar26 + 8U >> 4);
    ...
    param_1[0x28] =
         (int)((long)iVar6 * 0x2747 + (long)iVar3 * -0x2406 + lVar18 + lVar20 + lVar15 + 0x10000U >>
              0x11);
                    /* catch() { ... } // from try @ 01104894 with catch @ 0110496c */
    iVar17 = iVar17 + -1;
    param_1[0x18] =
