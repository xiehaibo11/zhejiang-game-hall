...
/* cocos2d::ObjectFactory::createObject(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

undefined8 __thiscall
cocos2d::ObjectFactory::createObject(ObjectFactory *this,basic_string *param_1)

{
  ...
  lVar2 = std::__ndk1::
          ...
          __emplace_unique_key_args<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&>,std::__ndk1::tuple<>>
                    ((basic_string *)(this + 8),(piecewise_construct_t *)param_1,
                     (tuple *)&DAT_0144b9a0,(tuple *)&local_88);
  TInfo::TInfo(aTStack_80,(TInfo *)(lVar2 + 0x30));
  if (local_68 == (code *)0x0) {
    if (local_40 == (long *)0x0) {
      uVar3 = 0;
    }
    else {
      uVar3 = (**(code **)(*local_40 + 0x30))();
    }
  }
  else {
    uVar3 = (*local_68)();
  }
  TInfo::~TInfo(aTStack_80);
