...
void FUN_010f6218(long param_1,long param_2,long param_3,long param_4,uint param_5,int param_6,
                 uint param_7)
  ...
  if (param_7 != 0) {
    ...
    do {
      ...
      puVar4[-5] = CONCAT26((short)(int)(SUB84(auStack_150._56_8_,4) *
                    ...
                    /* try { // try from 010f6320 to 011f6323 has its CatchHandler @ 010f63a0 */
      ...
      puVar4[-1] = CONCAT26((short)(int)(SUB84(auStack_150._120_8_,4) *
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010f6320 with catch @ 010f63a0
                        */
