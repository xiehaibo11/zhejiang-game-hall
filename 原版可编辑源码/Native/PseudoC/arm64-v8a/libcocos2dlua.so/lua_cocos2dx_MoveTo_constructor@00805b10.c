...
/* lua_cocos2dx_MoveTo_constructor(lua_State*) */

bool lua_cocos2dx_MoveTo_constructor(lua_State *param_1)

{
  ...
  if (iVar1 == 0) {
    ...
    *(undefined ***)(this + 0x28) = &PTR_clone_016f8c70;
    cocos2d::Vec3::Vec3((Vec3 *)(this + 0x7c));
    cocos2d::Ref::autorelease((Ref *)this);
    toluafix_pushusertype_ccobject
              (param_1,*(int *)(this + 0xc),(int *)(this + 0x10),this,"cc.MoveTo");
  }
  else {
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "cc.MoveTo:MoveTo",iVar1,0);
  }
  return iVar1 == 0;
}
