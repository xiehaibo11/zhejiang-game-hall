...
LAB_00b1f808:
  ...
  if (param_7 == (BN_CTX *)0x0) {
    c = BN_CTX_new();
    param_7 = c;
    if (c != (BN_CTX *)0x0) goto joined_r0x00b1f8dc;
LAB_00b1fb40:
    points = (EC_POINT **)0x0;
          ...
          do {
            ...
            *(EC_POINT ***)((long)ptr_01 + uVar12 * 8) = ppEVar23;
            do {
              ...
              *ppEVar23 = pEVar8;
              if (pEVar8 == (EC_POINT *)0x0) goto LAB_00b20010;
              uVar25 = uVar25 + 1;
              ppEVar23 = ppEVar23 + 1;
            ...
            if (local_c8 == 0) {
              ...
              if (uVar20 + uVar4 < 0xfffffffe) {
                ...
                if (uVar11 != 0) {
                  ...
                  if (uVar20 == uVar11) goto LAB_00b203a8;
                }
              }
              iVar3 = uVar4 + 1;
              do {
...
LAB_00b202e8:
            ...
            if (bVar19) goto LAB_00b203a8;
            if (uVar20 != 0) {
              iVar3 = EC_POINT_invert(param_1,param_2,param_7);
              goto joined_r0x00b203b4;
            }
          }
          iVar3 = 1;
        }
      ...
      if (local_a8 == 0) {
        if ((int)local_98 != 0) goto LAB_00b1ff30;
        iVar3 = 0x106;
LAB_00b1fcf4:
