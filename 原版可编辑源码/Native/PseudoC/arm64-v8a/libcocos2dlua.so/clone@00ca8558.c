...
/* cocostudio::timeline::BlendFuncFrame::clone() */

Ref * __thiscall cocostudio::timeline::BlendFuncFrame::clone(BlendFuncFrame *this)

{
  ...
  *(undefined8 *)(this_00 + 0x58) = 0x30300000001;
  *(undefined ***)this_00 = &PTR__Frame_016cc0e0;
