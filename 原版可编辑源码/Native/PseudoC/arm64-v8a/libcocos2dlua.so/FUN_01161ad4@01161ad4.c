...
void FUN_01161ad4(undefined1 *param_1,uint param_2,int param_3,int param_4,undefined1 *param_5)

{
  ...
  *param_5 = *param_1;
  if ((int)param_2 < 2) goto LAB_01161b50;
  uVar4 = param_2 - 1;
  uVar8 = (ulong)uVar4;
  if (uVar4 < 0x10) {
LAB_01161b20:
    ...
    if (lVar14 != 0) {
      lVar9 = lVar14;
      if ((puVar12 < param_1 + uVar8 + 1) && (param_1 < param_5 + uVar8 + 1)) goto LAB_01161b20;
      do {
        uVar21 = puVar10[1];
        uVar20 = *puVar10;
      ...
      if ((uVar4 & 0xf) == 0) goto LAB_01161b50;
    }
  }
  lVar9 = uVar8 - lVar14;
...
LAB_01161c54:
        ...
        if ((param_5 + lVar7 + lVar9 < param_1 + lVar7 + uVar8 && param_1 + lVar7 < param_5 + lVar2)
           || (param_5 + lVar7 + lVar9 < param_1 + lVar2 &&
               param_1 + lVar7 + lVar9 < param_5 + lVar2)) goto LAB_01161c54;
        uVar5 = 0;
        do {
        ...
        uVar5 = uVar15;
        if ((param_2 & 0x1f) != 0) goto LAB_01161c54;
      }
      iVar18 = iVar18 + 1;
      lVar14 = lVar14 + 1;
      puVar6 = puVar6 + lVar9;
