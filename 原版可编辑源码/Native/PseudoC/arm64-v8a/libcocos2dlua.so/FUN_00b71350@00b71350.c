...
undefined8 FUN_00b71350(long param_1,int param_2,char *param_3,size_t param_4)
...
joined_r0x00b71444:
  if (param_2 == 0) {
    OPENSSL_sk_pop_free(*(undefined8 *)(param_1 + 0x38),&LAB_00b710a0);
