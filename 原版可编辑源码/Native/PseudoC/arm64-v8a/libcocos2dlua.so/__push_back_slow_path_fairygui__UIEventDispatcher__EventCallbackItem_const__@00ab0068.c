...
/* void std::__ndk1::vector<fairygui::UIEventDispatcher::EventCallbackItem*,
   std::__ndk1::allocator<fairygui::UIEventDispatcher::EventCallbackItem*>
   >::__push_back_slow_path<fairygui::UIEventDispatcher::EventCallbackItem*
   const&>(fairygui::UIEventDispatcher::EventCallbackItem* const&) */
...
::__push_back_slow_path<fairygui::UIEventDispatcher::EventCallbackItem*const&>
          (vector<fairygui::UIEventDispatcher::EventCallbackItem*,std::__ndk1::allocator<fairygui::UIEventDispatcher::EventCallbackItem*>>
           *this,EventCallbackItem **param_1)

{
  ...
  ulong uVar3;
                    ...
                    /* try { // try from 00ab0070 to 00bb015b has its CatchHandler @ 00ab03fc */
  __src = *(void **)this;
