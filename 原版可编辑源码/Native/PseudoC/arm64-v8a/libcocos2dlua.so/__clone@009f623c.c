...
::__clone(__func<std::__ndk1::__bind<void(universe::network::Network::*)(float),universe::network::Network*&,std::__ndk1::placeholders::__ph<1>const&>,std::__ndk1::allocator<std::__ndk1::__bind<void(universe::network::Network::*)(float),universe::network::Network*&,std::__ndk1::placeholders::__ph<1>const&>>,void(float)>
          *this)
