...
/* void std::__ndk1::vector<cocos2d::MeshIndexData*, std::__ndk1::allocator<cocos2d::MeshIndexData*>
   >::__push_back_slow_path<cocos2d::MeshIndexData* const&>(cocos2d::MeshIndexData* const&) */
...
__push_back_slow_path<cocos2d::MeshIndexData*const&>
          (vector<cocos2d::MeshIndexData*,std::__ndk1::allocator<cocos2d::MeshIndexData*>> *this,
          MeshIndexData **param_1)
