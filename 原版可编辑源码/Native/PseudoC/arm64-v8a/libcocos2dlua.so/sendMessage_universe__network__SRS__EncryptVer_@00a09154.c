...
/* bool 
   universe::network::GuoPengFei::sendMessage<universe::network::SRS::EncryptVer>(universe::network::SRS::EncryptVer&,
   int, int) */

bool __thiscall
universe::network::GuoPengFei::sendMessage<universe::network::SRS::EncryptVer>
          (GuoPengFei *this,EncryptVer *param_1,int param_2,int param_3)

{
  ...
  local_48 = *(long *)(lVar1 + 0x28);
                    /* catch() { ... } // from try @ 00a090c0 with catch @ 00a0917c
                       catch() { ... } // from try @ 00a09128 with catch @ 00a0917c */
