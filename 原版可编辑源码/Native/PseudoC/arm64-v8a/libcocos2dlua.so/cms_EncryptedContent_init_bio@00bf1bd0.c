...

{
  ...
  if (lVar8 == 0) {
    ...
    if (pEVar3 != (EVP_CIPHER *)0x0) goto LAB_00bf1c74;
    iVar2 = 0x94;
    iVar5 = 0x3a;
LAB_00bf1e90:
...
LAB_00bf1d5c:
      ...
      if (key == (uchar *)0x0) {
        ...
        if (iVar2 < 1) goto LAB_00bf1f58;
        if (*(long *)(param_1 + 0x20) != 0) goto LAB_00bf1d98;
...
LAB_00bf1d3c:
      iVar2 = EVP_CIPHER_CTX_key_length(local_68);
      lVar6 = (long)iVar2;
      if (*(long *)(param_1 + 0x20) == 0) goto LAB_00bf1d5c;
      key = (uchar *)0x0;
LAB_00bf1d98:
      bVar1 = false;
      goto LAB_00bf1da0;
