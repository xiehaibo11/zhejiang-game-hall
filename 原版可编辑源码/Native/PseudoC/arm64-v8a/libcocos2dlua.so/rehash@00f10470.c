...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int, cocos2d::Sprite*>,
   std::__ndk1::__unordered_map_hasher<int, std::__ndk1::__hash_value_type<int, cocos2d::Sprite*>,
   ...
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<int, cocos2d::Sprite*> > >::rehash(unsigned
   long) */
...

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00f10534;
    }
    return;
  }
LAB_00f10534:
