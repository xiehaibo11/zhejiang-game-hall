...
/* cocos2d::AnimationCache::getAnimation(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

undefined8 __thiscall
cocos2d::AnimationCache::getAnimation(AnimationCache *this,basic_string *param_1)

{
  ...
  if (lVar1 != 0) {
    uVar2 = *(undefined8 *)(lVar1 + 0x28);
                    ...
                    /* catch() { ... } // from try @ 00eecb5c with catch @ 00eecba8 */
  return uVar2;
}
