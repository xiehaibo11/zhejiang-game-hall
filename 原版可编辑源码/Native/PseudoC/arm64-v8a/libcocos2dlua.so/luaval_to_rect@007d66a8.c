...
/* luaval_to_rect(lua_State*, int, cocos2d::Rect*, char const*) */

bool luaval_to_rect(lua_State *param_1,int param_2,Rect *param_3,char *param_4)

{
  ...
  bVar3 = false;
  if ((param_1 != (lua_State *)0x0) && (param_3 != (Rect *)0x0)) {
