...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, cocos2d::AttachNode*>, void*>*>,
   bool> std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, cocos2d::AttachNode*>,
   std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> >, cocos2d::AttachNode*>,
...

{
  ...
  ppVar2 = *(piecewise_construct_t **)(param_2 + 0x10);
                    /* try { // try from 00d41b5c to 00e41b63 has its CatchHandler @ 00d41e3c */
                    /* try { // try from 00d41b64 to 00e41cbf has its CatchHandler @ 00d41b08 */
  if (((byte)*param_2 & 1) == 0) {
    ppVar2 = param_2 + 1;
      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if (uVar13 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00d41c40;
            break;
          }
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00d41cb0;
              }
              goto LAB_00d41bf8;
            }
          }
...
LAB_00d41bf8:
  ...
  plVar15 = operator_new(0x30);
                    /* try { // try from 00d41cc0 to 00e41ccb has its CatchHandler @ 00d41e28 */
  ...
  *plVar15 = 0;
  ...
  if ((uVar16 == 0) ||
    ...
    uVar13 = (ulong)((float)(*(long *)(param_1 + 0x18) + 1) / *(float *)(param_1 + 0x20));
                    /* try { // try from 00d41d28 to 00e41d2f has its CatchHandler @ 00d41e10 */
    if (uVar13 <= uVar16) {
      uVar13 = uVar16;
    }
                    /* try { // try from 00d41d30 to 00e41e3f has its CatchHandler @ 00d41b08 */
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar12;
    if (*plVar15 == 0) goto LAB_00d41dcc;
...
LAB_00d41ddc:
  if (*(long *)(lVar5 + 0x28) != local_68) {
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d41d28 with catch @ 00d41e10
                        */
