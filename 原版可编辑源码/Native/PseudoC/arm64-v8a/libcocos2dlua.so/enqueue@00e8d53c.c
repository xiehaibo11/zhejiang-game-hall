...
/* cocos2d::experimental::PcmAudioService::enqueue() */

undefined8 __thiscall cocos2d::experimental::PcmAudioService::enqueue(PcmAudioService *this)

{
  ...
  if (((uVar2 & 1) == 0) || ((*(byte *)(*(long *)(this + 0x48) + 0x68) & 1) != 0)) {
    iVar1 = (**(code **)**(undefined8 **)(this + 0x30))
                      (*(undefined8 **)(this + 0x30),DAT_0178f3d8,
                       (int)DAT_0178f3e0 - (int)DAT_0178f3d8);
    if (iVar1 == 0) {
      return 1;
    }
