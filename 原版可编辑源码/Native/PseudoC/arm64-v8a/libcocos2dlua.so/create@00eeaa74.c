...
/* cocos2d::JumpTiles3D::create(float, cocos2d::Size const&, unsigned int, float) */

Action * cocos2d::JumpTiles3D::create(float param_1,Size *param_2,uint param_3,float param_4)
