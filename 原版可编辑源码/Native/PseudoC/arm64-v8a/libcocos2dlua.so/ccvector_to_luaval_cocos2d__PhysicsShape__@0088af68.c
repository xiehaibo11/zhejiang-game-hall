...
/* void ccvector_to_luaval<cocos2d::PhysicsShape*>(lua_State*,
   cocos2d::Vector<cocos2d::PhysicsShape*> const&) */

void ccvector_to_luaval<cocos2d::PhysicsShape*>(lua_State *param_1,Vector *param_2)
