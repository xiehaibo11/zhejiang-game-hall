...
void FUN_01123d98(long param_1,uint *param_2,undefined8 param_3,undefined8 param_4,uint param_5,
      ...
      if (7 < param_5) {
        ...
        do {
          ...
          *param_2 = ((~(uint)pbVar5[-3] & 0xff) * uVar4) / 0xff |
          ...
          pbVar3 = pbVar2 + uVar7;
          uVar4 = ~(uint)*pbVar2 & 0xff;
                    /* try { // try from 01123f98 to 01223fdf has its CatchHandler @ 01123f98
                       catch(type#1 @ 00000000) { ... } // from try @ 01123f98 with catch @ 01123f98
                        */
          param_2[3] = ((~(uint)pbVar2[-3] & 0xff) * uVar4) / 0xff |
                       ...
                       0x7f80) << 9 | 0xff000000;
          pbVar2 = pbVar3 + uVar7;
                    /* try { // try from 01123fe0 to 01223fe7 has its CatchHandler @ 01124008 */
          uVar4 = ~(uint)*pbVar3 & 0xff;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 01123fe0 with catch @ 01124008
                        */
                    /* try { // try from 0112401c to 01224063 has its CatchHandler @ 0112401c
                       catch(type#1 @ 00000000) { ... } // from try @ 0112401c with catch @ 0112401c
                        */
          param_2[4] = ((~(uint)pbVar3[-3] & 0xff) * uVar4) / 0xff |
                       ...
                       0x7f80) << 9 | 0xff000000;
          pbVar3 = pbVar2 + uVar7;
                    /* try { // try from 01124064 to 0122406b has its CatchHandler @ 01124094 */
          uVar4 = ~(uint)*pbVar2 & 0xff;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 01124064 with catch @ 01124094
                        */
