...

{
  ...
  if (uVar12 != 0) {
    uVar16 = CONCAT17(POPCOUNT((char)(uVar12 >> 0x38)),
                    ...
                    /* try { // try from 00f4a110 to 0104a1f7 has its CatchHandler @ 00f4a860 */
        ...
        do {
          ...
          if (uVar7 == uVar9) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00f4a188;
              goto LAB_00f4a238;
            }
            if (uVar9 != uVar14) goto LAB_00f4a238;
          }
LAB_00f4a188:
          plVar8 = (long *)*plVar8;
