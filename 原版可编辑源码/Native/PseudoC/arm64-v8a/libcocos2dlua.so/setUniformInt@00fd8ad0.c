...
/* cocos2d::GLProgramState::setUniformInt(int, int) */

void __thiscall cocos2d::GLProgramState::setUniformInt(GLProgramState *this,int param_1,int param_2)

{
  ...
  ulong uVar9;
                    ...
                    /* try { // try from 00fd8ad4 to 010d8b23 has its CatchHandler @ 00fd8aa8 */
  ...
  if (uVar2 != 0) {
    ...
    uVar9 = CONCAT62((int6)((ulong)uVar8 >> 0x10),uVar7);
                    /* catch() { ... } // from try @ 00fd8acc with catch @ 00fd8b08 */
    uVar3 = (ulong)param_1;
    ...
    if ((plVar5 != (long *)0x0) && (plVar5 = (long *)*plVar5, plVar5 != (long *)0x0)) {
      do {
        uVar6 = plVar5[1];
                    /* catch() { ... } // from try @ 00fd8b98 with catch @ 00fd8b6c */
        if (uVar6 == uVar3) {
          if ((int)plVar5[2] == param_1) {
            *(int *)(plVar5 + 6) = param_2;
          ...
          if ((uVar9 & 0xffffffff) < 2) {
            ...
            uVar6 = uVar6 - uVar1 * uVar2;
                    ...
                    /* try { // try from 00fd8b90 to 010d8b97 has its CatchHandler @ 00fd8bcc */
          if (uVar6 != uVar4) {
            return;
          }
        }
