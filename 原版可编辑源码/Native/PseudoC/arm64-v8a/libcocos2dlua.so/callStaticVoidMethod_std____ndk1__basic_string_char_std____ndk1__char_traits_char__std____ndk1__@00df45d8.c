...

{
  ...
  long local_48;
                    ...
                    /* try { // try from 00df45ec to 00ef45f7 has its CatchHandler @ 00df4730 */
  lVar2 = tpidr_el0;
  ...
  puVar8 = (ulong *)std::__ndk1::
                    ...
                    insert(&local_88,0,"(",1);
                    /* try { // try from 00df464c to 00ef4653 has its CatchHandler @ 00df4720 */
  uStack_68 = puVar8[1];
  local_70 = (void *)*puVar8;
  local_60 = (void *)puVar8[2];
                    /* try { // try from 00df4654 to 00ef4743 has its CatchHandler @ 00df4504 */
  *puVar8 = 0;
  puVar8[1] = 0;
  puVar8[2] = 0;
  puVar8 = (ulong *)std::__ndk1::
  ...
  *puVar8 = 0;
  ...
  if ((uVar9 & 1) == 0) {
    ...
    uVar10 = convert((unordered_map *)&local_70,(JniMethodInfo_ *)&local_88,param_3);
                    /* catch() { ... } // from try @ 00df464c with catch @ 00df4720 */
    _JNIEnv::CallStaticVoidMethod(p_Var3,p_Var4,uVar5,uVar10);
                    /* catch() { ... } // from try @ 00df45ec with catch @ 00df4730 */
    (**(code **)(*(long *)CONCAT71(uStack_87,local_88) + 0xb8))
              ((long *)CONCAT71(uStack_87,local_88),CONCAT71(uStack_7f,uStack_80));
                    /* try { // try from 00df4744 to 00ef4893 has its CatchHandler @ 00df4744
                       catch() { ... } // from try @ 00df4744 with catch @ 00df4744
                       catch() { ... } // from try @ 00df489c with catch @ 00df4744 */
