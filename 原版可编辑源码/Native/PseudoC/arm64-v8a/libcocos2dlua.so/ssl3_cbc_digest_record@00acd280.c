...

{
  ...
  SHA512_CTX SStack_138;
                    ...
                    /* try { // try from 00acd2b4 to 00bcd2cb has its CatchHandler @ 00acd4e4 */
  if (0xfffff < param_7) {
                    /* WARNING: Subroutine does not return */
                    /* catch() { ... } // from try @ 00acda3c with catch @ 00acdac4 */
  ...
  iVar11 = EVP_MD_type(pEVar12);
                    /* try { // try from 00acd2d8 to 00bcd36b has its CatchHandler @ 00acd4f8 */
  switch(iVar11) {
  case 0x2a0:
  ...
  case 0x2a1:
    ...
    if (iVar11 < 1) {
      return 0;
                    ...
                    /* try { // try from 00acd388 to 00bcd39b has its CatchHandler @ 00acd4dc */
    cnt = 0x30;
    goto LAB_00acd3c8;
  case 0x2a2:
    iVar11 = SHA512_Init(&SStack_138);
                    /* try { // try from 00acd3a8 to 00bcd3db has its CatchHandler @ 00acd4f0 */
    if (iVar11 < 1) {
      return 0;
    }
    cnt = 0x40;
LAB_00acd3c8:
    local_350 = (code *)&DAT_00acdd68;
  ...
  case 0x2a3:
    iVar11 = SHA224_Init((SHA256_CTX *)&SStack_138);
                    /* try { // try from 00acd3e8 to 00bcd403 has its CatchHandler @ 00acd4e0 */
    if (iVar11 < 1) {
      return 0;
    }
    local_350 = FUN_00acdc44;
    pcVar33 = SHA256_Transform;
                    /* try { // try from 00acd404 to 00bcd43b has its CatchHandler @ 00acd1ac */
    cnt = 0x1c;
    break;
  default:
    if (iVar11 == 0x40) {
    ...
    goto LAB_00acd444;
                    ...
                    /* try { // try from 00acd43c to 00bcd44f has its CatchHandler @ 00acd4f8 */
  __n_00 = 0x28;
  bVar7 = true;
LAB_00acd444:
  __n = 0x40;
  sVar31 = 8;
LAB_00acd448:
                    /* try { // try from 00acd454 to 00bcd467 has its CatchHandler @ 00acd4ec */
  uVar26 = (uint)__n;
  iVar11 = (int)sVar31;
                    /* try { // try from 00acd46c to 00bcd47f has its CatchHandler @ 00acd4f0 */
  ...
  uVar25 = (uint)cnt;
                    /* try { // try from 00acd484 to 00bcd497 has its CatchHandler @ 00acd4f4 */
  uVar2 = (param_6 - uVar25) + uVar1;
                    /* try { // try from 00acd498 to 00bcd513 has its CatchHandler @ 00acd1ac */
  uVar4 = 0;
  if (uVar26 != 0) {
  ...
  if (param_10 == '\0') {
    ...
    if (0x80 < param_9) {
                    /* try { // try from 00acdae0 to 00bcdb1b has its CatchHandler @ 00acdae0
                       catch() { ... } // from try @ 00acdae0 with catch @ 00acdae0
                       catch() { ... } // from try @ 00acdb54 with catch @ 00acdae0 */
                    /* WARNING: Subroutine does not return */
    ...
    if (!bVar7) goto LAB_00acd588;
LAB_00acd4dc:
                    /* catch() { ... } // from try @ 00acd388 with catch @ 00acd4dc */
    uVar27 = (ulong)(iVar11 - 4);
                    /* catch() { ... } // from try @ 00acd3e8 with catch @ 00acd4e0 */
                    /* catch() { ... } // from try @ 00acd2b4 with catch @ 00acd4e4 */
                    /* catch() { ... } // from try @ 00acd220 with catch @ 00acd4e8 */
                    /* catch() { ... } // from try @ 00acd204 with catch @ 00acd4ec
                       catch() { ... } // from try @ 00acd454 with catch @ 00acd4ec */
    memset(local_148,0,uVar27);
                    /* catch() { ... } // from try @ 00acd3a8 with catch @ 00acd4f0
                       catch() { ... } // from try @ 00acd46c with catch @ 00acd4f0 */
    iVar13 = -1;
                    /* catch() { ... } // from try @ 00acd24c with catch @ 00acd4f4
                       catch() { ... } // from try @ 00acd484 with catch @ 00acd4f4 */
    iVar16 = -2;
                    /* catch() { ... } // from try @ 00acd2d8 with catch @ 00acd4f8
                       catch() { ... } // from try @ 00acd43c with catch @ 00acd4f8 */
    iVar19 = -3;
  }
  else {
    if (bVar7) goto LAB_00acd4dc;
LAB_00acd588:
...
LAB_00acd958:
        ...
        uVar14 = uVar27;
        if ((cnt & 0x1c) != 0) goto LAB_00acd958;
      }
      uVar22 = uVar22 + 1;
    } while (uVar22 <= uVar4);
  }
  ...
  if (ctx != (EVP_MD_CTX *)0x0) {
    ...
    if (0 < iVar11) {
      if (param_10 == '\0') {
                    /* try { // try from 00acd9fc to 00bcda3b has its CatchHandler @ 00acd9fc
                       catch() { ... } // from try @ 00acd9fc with catch @ 00acd9fc
                       catch() { ... } // from try @ 00acda4c with catch @ 00acd9fc */
        puVar15 = local_1c8 + 2;
        sVar31 = __n;
        do {
          sVar31 = sVar31 - 0x20;
        ...
        if (iVar11 < 1) goto LAB_00acda84;
      }
      iVar11 = EVP_DigestUpdate(ctx,local_1c8,__n_00);
                    /* try { // try from 00acda3c to 00bcda4b has its CatchHandler @ 00acdac4 */
                    /* try { // try from 00acda4c to 00bcdadf has its CatchHandler @ 00acd9fc */
