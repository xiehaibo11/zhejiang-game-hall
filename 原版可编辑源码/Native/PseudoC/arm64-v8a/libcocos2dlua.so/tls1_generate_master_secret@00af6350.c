...

{
  ...
  if ((*(byte *)(*(long *)(param_1 + 0x178) + 0x150) & 1) == 0) {
    uVar2 = 0x30;
    FUN_00af6178(param_1,"master secret",0xd,*(long *)(param_1 + 0x90) + 0xb0,0x20,0,0,
    ...
    if (iVar1 == 0) {
      ...
      uVar2 = 0x30;
      FUN_00af6178(param_1,"extended master secret",0x16,auStack_c0,iVar1,0,0,0,0,param_3,param_4,
                   *(long *)(param_1 + 0x178) + 8,0x30);
