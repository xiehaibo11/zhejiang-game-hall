...

{
  ...
  if (*(int *)(param_1 + 0x170) != 0x49444154) {
    ...
    uVar10 = FUN_010da140(param_1);
    iVar7 = FUN_010d9ec8(param_1,0x49444154,uVar10);
    if (iVar7 != 0) {
LAB_010d9eac:
    ...
    *(undefined4 *)(param_1 + 0x180) = 0;
    ...
    if (iVar7 == 0) {
      ...
      if (((((*(byte *)(param_1 + 0x164) >> 2 & 1) == 0) && (*(char *)(param_1 + 0x490) == '\0')) &&
          (uVar11 = FUN_010da140(param_1), uVar11 < 0x4001)) &&
      ...
      *(uint *)(param_1 + 0x164) = *(uint *)(param_1 + 0x164) | 4;
      if ((param_4 != 0) && (iVar8 == 0)) goto LAB_010d9c40;
    }
    if (iVar8 != 0) {
      ...
      if (((((*(byte *)(param_1 + 0x164) >> 2 & 1) != 0) || (*(char *)(param_1 + 0x490) != '\0')) ||
          (uVar11 = FUN_010da140(param_1), 0x4000 < uVar11)) ||
         ((bVar4 = *pbVar1, (bVar4 & 0xf) != 8 || (0x70 < (bVar4 & 0xf0))))) goto LAB_010d9d5c;
      bVar6 = bVar4 >> 4;
      uVar14 = (ulong)(uint)(0x80 << (ulong)bVar6);
      if (uVar14 < uVar11) goto LAB_010d9d5c;
      cVar16 = (bVar4 & 0xf0) + 8;
      uVar15 = (uint)bVar6 << 0xc | 0x800;
      iVar8 = -(uint)bVar6;
      goto LAB_010d9cfc;
