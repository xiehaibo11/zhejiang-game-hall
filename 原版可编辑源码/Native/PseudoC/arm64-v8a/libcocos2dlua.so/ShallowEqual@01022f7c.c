...

{
  ...
  char cVar6;
                    ...
                    /* try { // try from 01022f94 to 01122f97 has its CatchHandler @ 01023054 */
...
LAB_0102303c:
    ...
    if (cVar6 == '\0') {
LAB_0102302c:
      if (*pcVar4 == '\0') goto LAB_0102303c;
    }
    else {
      lVar2 = 0;
      do {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 01022dac with catch @ 01022ff0
                        */
...
LAB_0102301c:
      pcVar4 = pcVar4 + lVar2;
      if ((int)lVar2 == 0x7fffffff) goto LAB_0102303c;
      if (bVar1) goto LAB_0102302c;
    }
    uVar5 = 0;
  }
  return uVar5;
