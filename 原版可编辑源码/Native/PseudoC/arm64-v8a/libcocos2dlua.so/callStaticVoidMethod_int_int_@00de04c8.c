  ...
  *puVar5 = 0;
  ...
  if (((byte)local_b8[0] & 1) != 0) {
    operator_delete(local_a8);
                    ...
                    /* try { // try from 00de0588 to 00ee05e7 has its CatchHandler @ 00de0588
                       catch() { ... } // from try @ 00de0588 with catch @ 00de0588
                       catch() { ... } // from try @ 00de0618 with catch @ 00de0588 */
  ...
  if ((uVar6 & 1) == 0) {
    ...
    local_60 = (void *)0x0;
    local_50 = 0x3f800000;
                    /* try { // try from 00de05e8 to 00ee0603 has its CatchHandler @ 00de0740 */
    ...
    (**(code **)(*(long *)local_88 + 0xb8))(local_88,p_Stack_80);
                    /* try { // try from 00de0608 to 00ee0617 has its CatchHandler @ 00de073c */
    ...
    while (puVar4 != (void *)0x0) {
      ...
      if (pvVar7 != (void *)0x0) {
        ...
        operator_delete(pvVar7);
                    ...
                    /* try { // try from 00de0618 to 00ee075b has its CatchHandler @ 00de0588 */
