...
/* flatbuffers::CreateBoolFrame(flatbuffers::FlatBufferBuilder&, int, unsigned char, unsigned char,
   flatbuffers::Offset<flatbuffers::EasingData>) */

undefined4
flatbuffers::CreateBoolFrame
          (FlatBufferBuilder *param_1,int param_2,char param_3,char param_4,undefined4 param_5)

{
  ...
  if ((param_4 != '\x01') || (param_1[0x60] != (FlatBufferBuilder)0x0)) {
    local_60 = CONCAT31(local_60._1_3_,param_4);
