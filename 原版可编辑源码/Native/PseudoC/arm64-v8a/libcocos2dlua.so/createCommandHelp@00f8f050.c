...
/* cocos2d::Console::createCommandHelp() */

void __thiscall cocos2d::Console::createCommandHelp(Console *this)

{
  ...
  basic_string<decltype(nullptr)>(local_118,"help");
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string<decltype(nullptr)>(local_130,"Print this message. Args: [ ]");
  local_e0 = &local_100;
  local_100 = &PTR_FUN_017223e0;
  uStack_f0 = 0;
  local_f8 = commandHelp;
  local_e8 = this;
  ...
  if (&local_100 == local_e0) {
    ...
    if (local_e0 == (undefined ***)0x0) goto LAB_00f8f114;
