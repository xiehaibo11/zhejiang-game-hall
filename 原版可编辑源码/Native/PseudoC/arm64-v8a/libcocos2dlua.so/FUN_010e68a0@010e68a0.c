...
void FUN_010e68a0(long param_1,long param_2,long *param_3,long param_4)
    ...
    if (iVar5 == 0) {
      ...
      do {
        ...
        do {
          ...
          iVar2 = uVar12 + *pbVar9;
          iVar11 = iVar11 + -1;
                    /* try { // try from 010e698c to 011e6a8b has its CatchHandler @ 010e698c
                       catch() { ... } // from try @ 010e698c with catch @ 010e698c
                       catch() { ... } // from try @ 010e6ac8 with catch @ 010e698c */
          pbVar9 = pbVar9 + 2;
          uVar12 = uVar12 ^ 3;
