...

{
  ...
  local_68 = *(long *)(lVar5 + 0x28);
                    /* try { // try from 00f4bd8c to 0104bd97 has its CatchHandler @ 00f4d5e8 */
  ...
  if (((byte)*param_1 & 1) == 0) {
    ...
    uVar7 = (ulong)((byte)*param_1 >> 1);
                    ...
                    /* try { // try from 00f4bda4 to 0104bda7 has its CatchHandler @ 00f4d524 */
    ...
    if (plVar8 != (long *)0x0) {
      ...
      if (plVar8 != (long *)0x0) {
        ...
        do {
          uVar9 = plVar8[1];
          if (uVar9 == uVar7) {
                    /* try { // try from 00f4be50 to 0104be57 has its CatchHandler @ 00f4d504 */
            bVar3 = *(byte *)(plVar8 + 2);
            uVar9 = (ulong)(bVar3 >> 1);
            sVar1 = uVar9;
            if ((bVar3 & 1) != 0) {
            ...
            if (sVar1 == __n) {
              __s1 = (void *)plVar8[4];
                    /* try { // try from 00f4be74 to 0104be7b has its CatchHandler @ 00f4d4cc */
              if ((bVar3 & 1) == 0) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                pbVar11 = pbVar2;
                    /* try { // try from 00f4be88 to 0104be9f has its CatchHandler @ 00f4d500 */
                while (*pbVar10 == *pbVar11) {
                  uVar9 = uVar9 - 1;
                  pbVar10 = pbVar10 + 1;
                  pbVar11 = pbVar11 + 1;
                  if (uVar9 == 0) goto LAB_00f4beec;
                }
              }
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00f4be38;
              goto LAB_00f4bee8;
            }
            if (uVar9 != uVar14) goto LAB_00f4bee8;
          }
LAB_00f4be38:
          plVar8 = (long *)*plVar8;
...
LAB_00f4beec:
  if (*(long *)(lVar5 + 0x28) == local_68) {
    return plVar8;
                    ...
                    /* try { // try from 00f4bf20 to 0104bf2b has its CatchHandler @ 00f4d5e8 */
  __stack_chk_fail();
}
