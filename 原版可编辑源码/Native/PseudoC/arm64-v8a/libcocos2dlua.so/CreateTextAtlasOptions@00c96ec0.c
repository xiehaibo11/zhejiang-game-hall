...
/* flatbuffers::CreateTextAtlasOptions(flatbuffers::FlatBufferBuilder&,
   flatbuffers::Offset<flatbuffers::WidgetOptions>, flatbuffers::Offset<flatbuffers::ResourceData>,
   flatbuffers::Offset<flatbuffers::String>, flatbuffers::Offset<flatbuffers::String>, int, int) */

undefined4
flatbuffers::CreateTextAtlasOptions
