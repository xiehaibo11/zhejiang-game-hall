...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void
   ...
   (cocos2d::EventCustom*)>::target_type() const */
...
{
  return &__bind<void(cocos2d::experimental::AudioEngineImpl::*)(cocos2d::EventCustom*),cocos2d::experimental::AudioEngineImpl*,std::__ndk1::placeholders::__ph<1>const&>
          ::typeinfo;
}
