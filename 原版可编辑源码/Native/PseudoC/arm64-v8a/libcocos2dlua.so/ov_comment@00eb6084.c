...

{
  ...
  if ((int)param_1[1] == 0) goto LAB_00eb61f0;
  if ((int)param_1[5] <= param_2) {
    return (long *)0x0;
  }
  if (param_2 < 0) goto LAB_00eb61f0;
  lVar2 = param_1[2];
  iVar1 = (int)param_1[0x16];
  if ((int)param_1[0x17] == param_2) {
    if (iVar1 < 3) goto LAB_00eb6128;
  }
  else {
    if (iVar1 == 5) {
    ...
    else if (iVar1 < 3) goto LAB_00eb6128;
...
LAB_00eb6128:
    ...
    *(int *)(param_1 + 0x17) = param_2;
    iVar1 = FUN_00eb5334(param_1,param_1 + 10,param_1 + 0x11,(undefined4 *)((long)param_1 + 0xb4),0)
    ;
    if (iVar1 != 0) {
      return (long *)0x0;
    }
