...
/* std::__ndk1::vector<cocostudio::timeline::Frame*,
   std::__ndk1::allocator<cocostudio::timeline::Frame*>
   >::insert(std::__ndk1::__wrap_iter<cocostudio::timeline::Frame* const*>,
   cocostudio::timeline::Frame* const&) */
