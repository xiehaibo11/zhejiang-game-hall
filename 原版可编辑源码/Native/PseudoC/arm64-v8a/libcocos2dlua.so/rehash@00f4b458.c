...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > >,
   std::__ndk1::allocator<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > > > > > >::rehash(unsigned long) */
...

{
  ...
  if (param_1 - 1 == 0) {
    ...
    param_1 = __next_prime(param_1);
                    ...
                    /* try { // try from 00f4b494 to 0104b49f has its CatchHandler @ 00f4d5e8 */
  uVar2 = *(ulong *)(this + 8);
  if (param_1 <= uVar2) {
                    /* try { // try from 00f4b4ac to 0104b4af has its CatchHandler @ 00f4d58c */
    if (param_1 < uVar2) {
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00f4b51c;
    }
                    /* try { // try from 00f4b530 to 0104b547 has its CatchHandler @ 00f4d5b4 */
    return;
  }
LAB_00f4b51c:
