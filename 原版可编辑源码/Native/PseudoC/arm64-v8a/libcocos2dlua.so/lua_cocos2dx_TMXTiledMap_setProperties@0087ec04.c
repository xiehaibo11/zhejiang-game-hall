...
/* lua_cocos2dx_TMXTiledMap_setProperties(lua_State*) */

undefined4 lua_cocos2dx_TMXTiledMap_setProperties(lua_State *param_1)

{
  ...
  if (iVar4 + -1 == 1) {
    ...
    uVar6 = luaval_to_ccvaluemap
                      (param_1,2,(unordered_map *)&local_60,"cc.TMXTiledMap:setProperties");
    if ((uVar6 & 1) == 0) {
      tolua_error(param_1,"invalid arguments in function \'lua_cocos2dx_TMXTiledMap_setProperties\'"
                  ,0);
      uVar7 = 0;
      pvVar2 = local_60;
      puVar3 = local_50;
    ...
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "cc.TMXTiledMap:setProperties",iVar4 + -1,1);
    uVar7 = 0;
  }
