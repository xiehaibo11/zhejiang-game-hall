...
/* void std::__ndk1::vector<cocos2d::extension::TableViewCell*,
   std::__ndk1::allocator<cocos2d::extension::TableViewCell*>
   >::__push_back_slow_path<cocos2d::extension::TableViewCell*
   const&>(cocos2d::extension::TableViewCell* const&) */
...

{
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
                    /* try { // try from 00e197c8 to 00f197cf has its CatchHandler @ 00e19dbc */
