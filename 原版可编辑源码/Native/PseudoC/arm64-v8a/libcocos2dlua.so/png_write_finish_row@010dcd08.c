    ...
    *(undefined4 *)(param_1 + 0x24c) = 0;
    if ((*(byte *)(param_1 + 0x16c) >> 1 & 1) == 0) {
      bVar7 = *(byte *)(param_1 + 0x2ad);
                    /* catch() { ... } // from try @ 010dce74 with catch @ 010dcd4c */
      do {
        bVar7 = bVar7 + 1;
        if (6 < bVar7) break;
        bVar2 = (&DAT_01476672)[bVar7];
        bVar3 = (&DAT_01476664)[bVar7];
        uVar1 = (*(int *)(param_1 + 0x230) + (uint)bVar2 + -1) - (uint)(byte)(&DAT_0147666b)[bVar7];
        uVar4 = (*(int *)(param_1 + 0x234) + (uint)bVar3 + -1) - (uint)(byte)(&DAT_0147665d)[bVar7];
        uVar5 = 0;
        if (bVar2 != 0) {
          uVar5 = uVar1 / bVar2;
        }
