...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int,
   ...
   cocos2d::experimental::ui::VideoPlayer*> > >::rehash(unsigned long) */
    ...
    if (param_1 < uVar2) {
      ...
      if ((uVar2 < 3) ||
        ...
        uVar1 = __next_prime(uVar1);
                    ...
                    /* try { // try from 00de0fac to 00ee107b has its CatchHandler @ 00de11b8 */
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00de0fd0;
    }
    return;
  }
LAB_00de0fd0:
