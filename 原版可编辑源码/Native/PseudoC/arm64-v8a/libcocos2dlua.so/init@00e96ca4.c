...

{
  ...
  *(mp3_callbacks **)(this + 8) = param_1;
  local_38 = 0;
  uVar3 = FUN_00e96d60(param_1,param_2,0,&local_38,&local_2c);
  if ((uVar3 & 1) == 0) {
    __android_log_print(6,"mp3reader","%s, resync failed","init");
    uVar2 = 0;
  }
  else {
    *(undefined8 *)(this + 0x18) = local_38;
    *(undefined4 *)(this + 0x10) = local_2c;
    uVar2 = FUN_00e971bc(local_2c,auStack_40,this + 0x20,this + 0x24,this + 0x28,0);
  }
