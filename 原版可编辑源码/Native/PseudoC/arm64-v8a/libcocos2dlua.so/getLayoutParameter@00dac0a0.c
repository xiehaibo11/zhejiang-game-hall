...
/* non-virtual thunk to cocos2d::ui::Widget::getLayoutParameter() const */
...

{
  ...
  if (uVar2 != 0) {
    ...
    plVar5 = *(long **)(*(long *)(this + 0xd0) + uVar4 * 8);
    if ((plVar5 != (long *)0x0) && (plVar5 = (long *)*plVar5, plVar5 != (long *)0x0)) {
                    /* catch() { ... } // from try @ 00dac078 with catch @ 00dac0fc */
      do {
        uVar6 = plVar5[1];
        if (uVar6 == uVar3) {
          if ((int)plVar5[2] == *(int *)(this + 0xf8)) {
            return plVar5[3];
          }
        }
        else {
