...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::Vector<fairygui::GObject*> > > >::__rehash(unsigned long) */
              ...
              *(long **)(*(long *)this + uVar17 * 8) = plVar15;
              ...
              if (plVar11 != (long *)0x0) {
                ...
                do {
                  ...
                  if ((bVar2 & 1) == 0) {
                    while (sVar6 != 0) {
                      if (*pcVar5 != *__s2) goto LAB_00a86e10;
                      __s2 = __s2 + 1;
                      sVar3 = sVar3 - 1;
                      pcVar5 = pcVar5 + 1;
                      sVar6 = sVar3;
...
LAB_00a86e10:
              ...
              *plVar14 = **(long **)(*(long *)this + uVar17 * 8);
                    /* try { // try from 00a86e30 to 00b86e7b has its CatchHandler @ 00a86e30
                       catch() { ... } // from try @ 00a86e30 with catch @ 00a86e30
                       catch() { ... } // from try @ 00a86e98 with catch @ 00a86e30 */
