...
/* cocos2d::experimental::AudioResamplerOrder1::resampleMono16(int*, unsigned long,
   cocos2d::experimental::AudioBufferProvider*) */

ulong __thiscall
cocos2d::experimental::AudioResamplerOrder1::resampleMono16
...
LAB_00e961b4:
  ...
  do {
    if (uVar17 != 0) {
      if (uVar16 <= uVar14) goto LAB_00e96270;
      lVar9 = 0;
      goto LAB_00e9621c;
    }
    uVar14 = uVar14 + 2;
...
joined_r0x00e96274:
  ...
  if (uVar16 <= uVar14) goto LAB_00e962b8;
  uVar10 = *(ulong *)(this + 0x20);
  if (uVar10 == 0) goto LAB_00e96124;
  goto LAB_00e961b4;
}
