...

{
  ...
  local_38 = *(long *)(lVar1 + 0x28);
                    /* catch() { ... } // from try @ 009dd0d8 with catch @ 009dd138 */
  uVar2 = JniAssistant::getStaticMethodInfo
                    ((JniMethodInfo_ *)&local_50,"com/bianfeng/libuniverse/Device","getHardwareCode"
                     ,"()Ljava/lang/String;");
  if ((uVar2 & 1) == 0) {
                    /* try { // try from 009dd1d8 to 00add20f has its CatchHandler @ 009dd1d8
                       catch() { ... } // from try @ 009dd1d8 with catch @ 009dd1d8
                       catch() { ... } // from try @ 009dd220 with catch @ 009dd1d8 */
