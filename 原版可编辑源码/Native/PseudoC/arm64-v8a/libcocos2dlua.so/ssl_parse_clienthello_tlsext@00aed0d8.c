  ...
  if ((((*(byte *)((long)&param_1->tlsext_debug_arg + 4) >> 6 & 1) != 0) &&
    ...
    if ((uVar34 <= uVar20 - 6) &&
      ...
      if ((uVar7 & 0xffffff00) == 0x300) {
        ...
        if (sVar32 != sVar1) goto LAB_00aed218;
LAB_00aed1f4:
        iVar8 = CRYPTO_memcmp((void *)(lVar28 + uVar34 + 6),&DAT_013d385b,sVar32);
        bVar5 = iVar8 == 0;
      }
      else {
        if (sVar32 == 0x12) goto LAB_00aed1f4;
LAB_00aed218:
        bVar5 = false;
      }
      lVar14 = *(long *)&param_1->read_ahead;
  ...
  *puVar15 = *puVar15 & 0xfffffffffffffeff;
  ...
  if (lVar14 != 0) {
    pbVar26 = local_80;
    uVar20 = local_78;
    if (lVar14 == 1) goto LAB_00aeda70;
    puVar21 = (undefined1 *)*param_2;
    uVar34 = (ulong)CONCAT11(*puVar21,puVar21[1]);
    if (lVar14 - 2U != uVar34) goto LAB_00aeda70;
    pbVar29 = puVar21 + 2;
    *param_2 = (long)(pbVar29 + uVar34);
    param_2[1] = 0;
    local_70 = pbVar29;
    local_68 = uVar34;
    iVar8 = FUN_00af06b8(&local_70);
    pbVar26 = local_80;
    uVar20 = local_78;
    if (iVar8 == 0) goto LAB_00aeda70;
    if (uVar34 < 2) {
      bVar5 = false;
    }
    else {
      ...
      do {
        ...
        pbVar26 = local_80;
        uVar20 = local_78;
        if (local_68 < 2) goto LAB_00aeda70;
        local_78 = (ulong)CONCAT11(pbVar29[2],pbVar29[3]);
        uVar22 = uVar34 - 4;
        uVar34 = uVar22 - local_78;
        if (uVar22 < local_78) goto LAB_00aeda70;
        local_80 = pbVar29 + 4;
          ...
          case 0:
            ...
            if (*(int *)&param_1->param == 0) {
              if ((0xff < uVar23) || (pvVar11 = memchr(pbVar31,0,uVar23), pvVar11 != (void *)0x0)) {
                ...
                pbVar26 = local_80;
                uVar20 = local_78;
                    /* try { // try from 00aedb68 to 00bedb6b has its CatchHandler @ 00aedc5c */
                goto LAB_00aeda70;
              }
              pSVar27 = param_1->ctx;
              ...
              if (p_Var33 == (_func_3094 *)0x0) goto LAB_00aed2c4;
...
switchD_00aed3a4_caseD_1:
            if ((((byte)param_1->method->get_timeout[0x68] >> 3 & 1) == 0) ||
              ...
              if (sVar3 == 0x16) {
                **(ulong **)&param_1->read_ahead = **(ulong **)&param_1->read_ahead | 0x100;
                      ...
                      pbVar26 = local_80, uVar20 = local_78, iVar8 < 1)) goto LAB_00aeda70;
            }
            else {
            ...
            break;
          case 5:
            if (local_78 == 0) goto LAB_00aeda70;
            uVar20 = local_78 - 1;
                    /* try { // try from 00aed488 to 00bed5bf has its CatchHandler @ 00aed488
                       catch() { ... } // from try @ 00aed488 with catch @ 00aed488
                       catch() { ... } // from try @ 00aed5c8 with catch @ 00aed488 */
            pbVar26 = local_80 + 1;
            bVar2 = *local_80;
            *(uint *)((long)&param_1->tlsext_ellipticcurvelist_length + 4) = (uint)bVar2;
            if (bVar2 == 1) {
              if (uVar20 < 2) goto LAB_00aeda70;
              uVar23 = local_78 - 3;
              uVar22 = (ulong)CONCAT11(local_80[1],local_80[2]);
              local_78 = uVar23 - uVar22;
              if (uVar23 < uVar22) goto LAB_00aeda70;
              pbVar31 = local_80 + 3;
              ...
              if (uVar22 == 0) {
                ...
                if (ptVar9 == (tls_session_secret_cb_fn)0x0) goto LAB_00aed2c4;
                do {
                  pbVar26 = local_80;
                  uVar20 = local_78;
                  if (uVar22 == 1) goto LAB_00aeda70;
                  uVar23 = (ulong)CONCAT11(*pbVar31,pbVar31[1]);
                  uVar16 = uVar22 - 2;
                  uVar22 = uVar16 - uVar23;
                  if ((uVar16 < uVar23) || (uVar23 == 0)) goto LAB_00aeda70;
                  local_90 = pbVar31 + 2;
                  a = d2i_OCSP_RESPID((OCSP_RESPID **)0x0,&local_90,uVar23);
                  pbVar26 = local_80;
                  uVar20 = local_78;
                  if (a == (OCSP_RESPID *)0x0) goto LAB_00aeda70;
              ...
              if (uVar22 != 0) {
                ...
                pbVar26 = local_80;
                uVar20 = local_78;
                if ((pXVar13 == (X509_EXTENSIONS *)0x0) || (local_88 != pbVar31)) goto LAB_00aeda70;
              }
            }
            else {
            ...
            break;
          case 10:
            if (local_78 < 2) goto LAB_00aeda70;
            pbVar31 = local_80 + 1;
            psVar30 = (stack_st_X509_NAME *)(ulong)CONCAT11(*local_80,*pbVar31);
            if ((stack_st_X509_NAME *)(local_78 - 2) != psVar30) goto LAB_00aeda70;
            pbVar18 = local_80 + 2;
            local_80 = pbVar18 + (long)psVar30;
            local_78 = 0;
            pbVar26 = local_80;
            uVar20 = local_78;
            if ((psVar30 == (stack_st_X509_NAME *)0x0) || ((*pbVar31 & 1) != 0)) goto LAB_00aeda70;
            if (*(int *)&param_1->param == 0) {
              pSVar27 = param_1->ctx;
              CRYPTO_free((void *)pSVar27->max_cert_list);
                    /* try { // try from 00aed5c0 to 00bed5c7 has its CatchHandler @ 00aed690 */
              pSVar27->mode = 0;
              pSVar27->max_cert_list = 0;
                    /* try { // try from 00aed5c8 to 00bed6a3 has its CatchHandler @ 00aed488 */
              lVar14 = CRYPTO_memdup(pbVar18,psVar30,"ssl/packet_locl.h",0x181);
              pSVar27->max_cert_list = lVar14;
              if (lVar14 == 0) goto LAB_00aed2c4;
...
LAB_00aed650:
          ...
          case 0xb:
            ...
            pbVar31 = local_80 + 1;
            bVar2 = *local_80;
            if (psVar30 != (stack_st_X509_NAME *)(ulong)bVar2) goto LAB_00aeda70;
            local_80 = local_80 + local_78;
            local_78 = 0;
            pbVar26 = local_80;
            uVar20 = local_78;
            if (bVar2 == 0) goto LAB_00aeda70;
            if (*(int *)&param_1->param == 0) {
              pSVar27 = param_1->ctx;
          ...
          case 0xc:
            ...
            sVar32 = local_78 - 1;
            pbVar31 = local_80 + 1;
            if (sVar32 != *local_80) goto LAB_00aeda70;
            local_80 = local_80 + local_78;
                    /* catch() { ... } // from try @ 00aed5c0 with catch @ 00aed690 */
            local_78 = 0;
            pvVar11 = memchr(pbVar31,0,sVar32);
            pbVar26 = local_80;
            uVar20 = local_78;
            if (pvVar11 != (void *)0x0) goto LAB_00aeda70;
            CRYPTO_free(param_1[1].d1);
            pdVar10 = (dtls1_state_st *)CRYPTO_strndup(pbVar31,sVar32,"ssl/packet_locl.h",0x198);
            param_1[1].d1 = pdVar10;
            if (pdVar10 == (dtls1_state_st *)0x0) goto LAB_00aed2c4;
            break;
          case 0xd:
            if (local_78 < 2) goto LAB_00aeda70;
            pbVar31 = local_80 + 1;
            ...
            uVar22 = (ulong)uVar4;
            if (local_78 - 2 != uVar22) goto LAB_00aeda70;
            pbVar18 = local_80 + 2;
            local_80 = pbVar18 + uVar22;
            local_78 = 0;
            pbVar26 = local_80;
            uVar20 = local_78;
            if (((*pbVar31 & 1) != 0) || (uVar22 == 0)) goto LAB_00aeda70;
            if ((*(int *)&param_1->param == 0) &&
               (((byte)param_1->method->get_timeout[0x68] >> 1 & 1) != 0)) {
              if (param_1->verify_callback == (_func_3151 *)0x0) goto LAB_00aeda70;
          ...
          case 0x10:
            lVar14 = *(long *)&param_1->read_ahead;
            if (*(int *)(lVar14 + 400) != 0) goto switchD_00aed3a4_caseD_1;
            local_94 = 0x32;
            if ((local_78 < 2) ||
               (uVar22 = (ulong)CONCAT11(*local_80,local_80[1]), local_78 - 2 != uVar22))
            goto LAB_00aeda70;
            ...
            pbVar26 = local_80;
            uVar20 = local_78;
            if (uVar22 < 2) goto LAB_00aeda70;
            do {
              uVar25 = (ulong)*pbVar18;
              uVar16 = (uVar23 - 1) - uVar25;
              if ((uVar23 - 1 < uVar25) || (*pbVar18 == 0)) goto LAB_00aeda70;
          ...
          case 0x23:
            if ((*(code **)(param_1 + 1) != (code *)0x0) &&
               ...
               iVar8 == 0)) goto LAB_00aed2c4;
            break;
          default:
            if ((sVar3 != 0x3374) || (*(int *)(*(long *)&param_1->read_ahead + 400) != 0))
            goto switchD_00aed3a4_caseD_1;
...
LAB_00aedaa4:
    ...
    if (iVar8 != 1) {
      return 1;
                    ...
                    /* try { // try from 00aedaf8 to 00bedb1b has its CatchHandler @ 00aedc60 */
...
LAB_00aeda70:
  ...
  ssl3_send_alert(param_1,2,local_94);
                    /* try { // try from 00aeda88 to 00bedaf7 has its CatchHandler @ 00aeda88
                       catch() { ... } // from try @ 00aeda88 with catch @ 00aeda88
                       catch() { ... } // from try @ 00aedb6c with catch @ 00aeda88
                       catch() { ... } // from try @ 00aedba0 with catch @ 00aeda88
                       catch() { ... } // from try @ 00aedbdc with catch @ 00aeda88 */
  return 0;
}
