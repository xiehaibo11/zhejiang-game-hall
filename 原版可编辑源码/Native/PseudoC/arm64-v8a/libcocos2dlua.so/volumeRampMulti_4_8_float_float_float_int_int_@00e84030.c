...
/* void cocos2d::experimental::volumeRampMulti<4, 8, float, float, float, int, int>(float*, unsigned
   long, float const*, int*, float*, float const*, int*, int) */

void cocos2d::experimental::volumeRampMulti<4,8,float,float,float,int,int>
