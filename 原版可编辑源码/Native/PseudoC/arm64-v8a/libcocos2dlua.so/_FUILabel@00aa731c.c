...

{
  ...
  *(undefined ***)(this + -0x300) = &PTR__FUILabel_016a8180;
  pbVar1 = *(byte **)(this + 0x3a0);
  *(undefined ***)this = &PTR__FUILabel_016a87d0;
  *(undefined ***)(this + -8) = &PTR__FUILabel_016a87a0;
  if (pbVar1 != (byte *)0x0) {
    if ((*pbVar1 & 1) != 0) {
  ...
  cocos2d::Label::~Label((Label *)(this + -0x300));
  return;
}
