...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::EventDispatcher::DirtyFlag> > >::__rehash(unsigned long) */
...

{
  ...
  undefined8 uVar19;
                    ...
                    /* catch() { ... } // from try @ 00fa5e6c with catch @ 00fa701c
                       catch() { ... } // from try @ 00fa6f24 with catch @ 00fa701c */
                    /* catch() { ... } // from try @ 00fa5c04 with catch @ 00fa7020
                       catch() { ... } // from try @ 00fa6f1c with catch @ 00fa7020 */
                    /* catch() { ... } // from try @ 00fa59f0 with catch @ 00fa7030
                       catch() { ... } // from try @ 00fa6f14 with catch @ 00fa7030 */
                    /* catch() { ... } // from try @ 00fa6330 with catch @ 00fa7040 */
  if (param_1 == 0) {
    pvVar8 = *(void **)this;
    *(undefined8 *)this = 0;
                    /* catch() { ... } // from try @ 00fa5b04 with catch @ 00fa70cc */
    if (pvVar8 != (void *)0x0) {
    ...
    *(undefined8 *)(this + 8) = 0;
    ...
    if (param_1 >> 0x3d != 0) {
      ...
      FUN_007c2210("allocator<T>::allocate(size_t n) \'n\' exceeds maximum supported size");
                    ...
                    /* catch() { ... } // from try @ 00fa6210 with catch @ 00fa7054 */
    pvVar8 = operator_new(param_1 << 3);
    pvVar9 = *(void **)this;
                    /* catch() { ... } // from try @ 00fa56bc with catch @ 00fa705c */
    *(void **)this = pvVar8;
    if (pvVar9 != (void *)0x0) {
    ...
    *(ulong *)(this + 8) = param_1;
    do {
                    /* catch() { ... } // from try @ 00fa6298 with catch @ 00fa7078 */
    ...
    if (plVar15 != (long *)0x0) {
      ...
      *(__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::EventDispatcher::DirtyFlag>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::EventDispatcher::DirtyFlag>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::EventDispatcher::DirtyFlag>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::EventDispatcher::DirtyFlag>>>
        **)(*(long *)this + uVar10 * 8) = this + 0x10;
                    /* catch() { ... } // from try @ 00fa5740 with catch @ 00fa70f0 */
      if ((long *)*plVar15 != (long *)0x0) {
        plVar16 = (long *)*plVar15;
        do {
          uVar17 = plVar16[1];
                    /* catch() { ... } // from try @ 00fa5b8c with catch @ 00fa7114
                       catch() { ... } // from try @ 00fa5f9c with catch @ 00fa7114
                       catch() { ... } // from try @ 00fa6370 with catch @ 00fa7114 */
          if (uVar13 < 2) {
              ...
              *(long **)(*(long *)this + uVar17 * 8) = plVar15;
              ...
              if (plVar11 != (long *)0x0) {
                ...
                do {
                  ...
                  if ((bVar2 & 1) == 0) {
                    while (sVar6 != 0) {
                      if (*pcVar5 != *__s2) goto LAB_00fa7224;
                      __s2 = __s2 + 1;
                      sVar3 = sVar3 - 1;
                      pcVar5 = pcVar5 + 1;
                      sVar6 = sVar3;
