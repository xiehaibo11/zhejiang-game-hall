...

{
  ...
  if ((*(char *)(param_1 + 0x2ac) != '\0') && ((*(byte *)(param_1 + 0x16c) >> 1 & 1) != 0)) {
    ...
    case 0:
      if ((uVar4 & 7) != 0) {
LAB_010c4918:
        if (param_3 == 0) goto LAB_010c492c;
LAB_010c491c:
...
LAB_010c492c:
      ...
      break;
    case 1:
      if (((uVar4 & 7) != 0) || (*(uint *)(param_1 + 0x230) < 5)) goto LAB_010c4918;
      break;
    case 2:
      if ((uVar4 & 7) != 4) {
        if (param_3 == 0) goto LAB_010c492c;
        uVar4 = uVar4 >> 2;
joined_r0x010c4900:
        if ((uVar4 & 1) == 0) goto LAB_010c492c;
        goto LAB_010c491c;
      }
      break;
    case 3:
      if (((uVar4 & 3) != 0) || (*(uint *)(param_1 + 0x230) < 3)) goto LAB_010c4918;
      break;
    case 4:
      if ((uVar4 & 3) != 2) {
        if (param_3 == 0) goto LAB_010c492c;
        uVar4 = uVar4 >> 1;
        goto joined_r0x010c4900;
      }
      break;
    case 5:
      if (((uVar4 & 1) != 0) || (*(uint *)(param_1 + 0x230) < 2)) goto LAB_010c4918;
      break;
    default:
      if ((uVar4 & 1) == 0) goto LAB_010c492c;
    }
  ...
  if ((((*(byte *)(param_1 + 0x450) >> 2 & 1) != 0) && (*(char *)(param_1 + 0x454) == '@')) &&
    ...
    if (local_37 == '\x10') {
      if (local_38 == 2) {
        ...
        if (local_38 != 6) goto LAB_010c49e8;
        lVar7 = 8;
      }
      if (local_48[0] != 0) {
...
LAB_010c49e8:
  ...
  if ((*(char *)(param_1 + 0x2ac) == '\0') || ((*(uint *)(param_1 + 0x16c) >> 1 & 1) == 0)) {
    ...
    if (param_3 == 0) goto LAB_010c4aac;
    uVar3 = 0xffffffff;
    param_2 = param_3;
  }
  else {
    ...
    if (param_2 == 0) goto LAB_010c4aac;
    uVar3 = 0;
  }
