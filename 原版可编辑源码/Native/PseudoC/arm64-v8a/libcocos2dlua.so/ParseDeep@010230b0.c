...
/* tinyxml2::XMLComment::ParseDeep(char*, tinyxml2::StrPair*) */

StrPair * tinyxml2::XMLComment::ParseDeep(char *param_1,StrPair *param_2)

{
  ...
  __n = __strlen_chk(&DAT_01458a88,4);
  SVar1 = *param_2;
  __s1 = param_2;
  do {
...
LAB_01023148:
      ...
      *(undefined4 *)(lVar3 + 0x5c) = 0xc;
      *(StrPair **)(lVar3 + 0x68) = param_2;
      *(undefined8 *)(lVar3 + 0x70) = 0;
      return (StrPair *)0x0;
    }
    if ((SVar1 == (StrPair)0x2d) && (iVar2 = strncmp((char *)__s1,"-->",__n), iVar2 == 0)) {
