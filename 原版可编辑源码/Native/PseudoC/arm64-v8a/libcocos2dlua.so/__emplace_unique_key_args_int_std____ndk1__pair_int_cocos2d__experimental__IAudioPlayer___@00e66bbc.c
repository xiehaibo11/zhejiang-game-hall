...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<int,
   ...
   cocos2d::experimental::IAudioPlayer*> > >::__emplace_unique_key_args<int, std::__ndk1::pair<int,
   cocos2d::experimental::IAudioPlayer*> >(int const&, std::__ndk1::pair<int,
      ...
      for (plVar7 = (long *)*plVar7; plVar7 != (long *)0x0; plVar7 = (long *)*plVar7) {
        ...
        if (uVar6 != uVar9) {
          if (uVar5 < 2) {
            ...
            if (uVar6 - uVar1 * uVar8 == unaff_x24) goto LAB_00e66c48;
            break;
          }
