...
LAB_011fee98:
  ...
  if (param_2 < param_3) {
    ...
    do {
      wVar2 = *param_2;
      pbVar4 = pbVar5;
      if (((uint)wVar2 >> 0xb == 0x1b) || (uVar6 < (uint)wVar2)) goto LAB_011fee9c;
      if ((wVar2 & 0xffff0000U) == 0) {
        if ((long)param_6 - (long)pbVar5 < 2) goto LAB_011fee98;
        pbVar4 = pbVar5 + 2;
        *(short *)pbVar5 = (short)wVar2;
      }
      else {
        if ((long)param_6 - (long)pbVar5 < 4) goto LAB_011fee98;
