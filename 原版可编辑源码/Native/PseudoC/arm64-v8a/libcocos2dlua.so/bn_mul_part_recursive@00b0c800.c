...

{
  ...
  if ((int)param_4 < 8) {
                    /* try { // try from 00b0c86c to 00c0c9db has its CatchHandler @ 00b0c86c
                       catch() { ... } // from try @ 00b0c86c with catch @ 00b0c86c
                       catch() { ... } // from try @ 00b0c9e4 with catch @ 00b0c86c */
  ...
  case 3:
  case 4:
                    /* try { // try from 00b0c9dc to 00c0c9e3 has its CatchHandler @ 00b0caac */
                    /* try { // try from 00b0c9e4 to 00c0cabf has its CatchHandler @ 00b0c86c */
...
LAB_00b0c950:
    ...
    bVar6 = true;
    goto joined_r0x00b0c960;
  default:
    goto switchD_00b0c8e8_default;
  }
  bn_sub_part_words(param_7 + lVar12,lVar14,lVar11,param_6,iVar5);
switchD_00b0c8e8_default:
  bVar6 = false;
joined_r0x00b0c960:
  if (param_4 == 8) {
    rp = param_7 + uVar13;
    ...
    if ((int)param_5 <= (int)param_6) {
      uVar4 = param_6;
                    ...
                    /* catch() { ... } // from try @ 00b0c9dc with catch @ 00b0caac */
    if (uVar4 == uVar15) {
      bp = param_1 + lVar14;
