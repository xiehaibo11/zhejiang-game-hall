...
long FUN_00fdac20(long *param_1,long *param_2)

{
  ...
  param_2[1] = lVar4;
  plVar5 = (long *)FUN_00fdada4(param_1,lVar4,param_2 + 2);
  uVar6 = param_1[1];
  uVar7 = param_2[1];
  ...
  if (plVar5 == (long *)0x0) {
    plVar5 = param_1 + 2;
                    /* catch() { ... } // from try @ 00fdad3c with catch @ 00fdacfc */
    *param_2 = *plVar5;
    *plVar5 = (long)param_2;
      ...
      if (uVar8 < 2) {
        ...
        if (uVar6 != 0) {
          uVar8 = uVar7 / uVar6;
                    ...
                    /* try { // try from 00fdad34 to 010dad3b has its CatchHandler @ 00fdadac */
    ...
    *plVar5 = (long)param_2;
    if (*param_2 != 0) {
      ...
      if (uVar8 < 2) {
                    /* try { // try from 00fdad3c to 010dadc7 has its CatchHandler @ 00fdacfc */
        uVar9 = uVar9 & uVar6 - 1;
      }
      else if (uVar6 <= uVar9) {
        uVar8 = 0;
