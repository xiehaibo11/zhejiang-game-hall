...

{
  ...
  int local_80 [8];
                    ...
                    /* try { // try from 01103514 to 0120351b has its CatchHandler @ 011035bc */
                    /* try { // try from 0110351c to 01203553 has its CatchHandler @ 011034a8 */
  piVar19 = param_1;
  iVar18 = 0;
  while( true ) {
    do {
      iVar21 = iVar18;
      piVar20 = piVar19;
                    /* try { // try from 01103554 to 0120355b has its CatchHandler @ 011035b4 */
      pbVar1 = (byte *)(*(long *)(param_2 + (long)iVar21 * 8) + (param_3 & 0xffffffff));
                    /* try { // try from 0110355c to 012035fb has its CatchHandler @ 011034a8 */
      ...
      lVar9 = (ulong)pbVar1[8] + (ulong)pbVar1[4];
                    /* catch() { ... } // from try @ 01103554 with catch @ 011035b4 */
      lVar23 = (ulong)pbVar1[4] - (ulong)pbVar1[8];
      lVar24 = (ulong)pbVar1[5] - (ulong)pbVar1[7];
                    /* catch() { ... } // from try @ 01103514 with catch @ 011035bc */
      ...
      lVar15 = lVar13 + uVar22 * -2;
                    /* catch() { ... } // from try @ 01103694 with catch @ 011035fc */
      ...
      lVar27 = (lVar25 + lVar26) * -0x1508;
                    /* try { // try from 0110368c to 01203693 has its CatchHandler @ 01103754 */
                    /* try { // try from 01103694 to 0120376f has its CatchHandler @ 011035fc */
      ...
      *piVar20 = (int)lVar7 + (int)lVar8 + (int)lVar17 + (int)lVar13 + (int)lVar9 + (uint)pbVar1[6]
      ...
      piVar20[5] = (int)(lVar37 + lVar26 * -0x324f + lVar27 + lVar24 * 0x4853 + lVar32 + 0x1000U >>
                        0xd);
                    /* catch() { ... } // from try @ 0110368c with catch @ 01103754 */
  ...
  do {
    ...
    lVar7 = (long)(piVar19[8] + param_1[8]);
                    /* catch() { ... } // from try @ 01103918 with catch @ 01103880 */
    ...
    lVar32 = (lVar24 + lVar17) * 0x1c35;
                    /* try { // try from 01103910 to 01203917 has its CatchHandler @ 011039dc */
                    /* try { // try from 01103918 to 012039f7 has its CatchHandler @ 01103880 */
    ...
    *param_1 = (int)((lVar7 + lVar15 + lVar9 + lVar13 + lVar14 + lVar27 + lVar26) * 0x183d + 0x2000U
    ...
    param_1[0x30] = (int)((ulong)((0x2000 - lVar17) + lVar12) >> 0xe);
                    /* catch() { ... } // from try @ 01103910 with catch @ 011039dc */
    ...
    param_1[0x18] =
         (int)(lVar31 + (long)iVar2 * 0x144b + lVar24 + (long)iVar5 * -0x38c1 + lVar29 + 0x2000U >>
              0xe);
                    /* catch() { ... } // from try @ 01103a94 with catch @ 011039f8 */
    param_1[0x28] =
