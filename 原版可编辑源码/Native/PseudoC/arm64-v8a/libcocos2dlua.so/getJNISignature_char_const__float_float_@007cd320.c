...
/* std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   cocos2d::JniHelper::getJNISignature<char const*, float, float>(char const*, float, float) */

void cocos2d::JniHelper::getJNISignature<char_const*,float,float>
               (char *param_1,float param_2,float param_3)
