...

{
  ...
  if (psVar2 == (stack_st_X509_ALGOR *)0x0) {
    ...
    *algs = psVar2;
    if (psVar2 == (stack_st_X509_ALGOR *)0x0) goto LAB_00ba1934;
  }
...
LAB_00ba1934:
  X509_ALGOR_free(alg);
                    /* try { // try from 00ba194c to 00ca19bb has its CatchHandler @ 00ba194c
                       catch() { ... } // from try @ 00ba194c with catch @ 00ba194c
                       catch() { ... } // from try @ 00ba19c4 with catch @ 00ba194c */
  return 0;
}
