...
/* void cocos2d::experimental::volumeMulti<1, 4, float, float, float, int, short>(float*, unsigned
   long, float const*, int*, float const*, short) */

void cocos2d::experimental::volumeMulti<1,4,float,float,float,int,short>
  ...
  if (param_4 == (int *)0x0) {
    if (3 < param_2) {
      if ((param_3 + param_2 <= param_1 || param_1 + param_2 * 4 <= param_3) &&
        ...
        do {
          ...
          uVar6 = uVar6 - 4;
          fVar50 = param_5[1];
          fVar12 = (float)*(undefined8 *)pfVar4;
          fVar13 = (float)((ulong)*(undefined8 *)pfVar4 >> 0x20);
          fVar14 = (float)*(undefined8 *)(pfVar4 + 2);
          fVar15 = (float)((ulong)*(undefined8 *)(pfVar4 + 2) >> 0x20);
          *param_1 = *param_1 + fVar12 * fVar18;
          param_1[1] = param_1[1] + fVar12 * fVar50;
          param_1[2] = param_1[2] + fVar12 * fVar44;
          param_1[3] = param_1[3] + fVar12 * fVar49;
          param_1[4] = param_1[4] + fVar13 * fVar18;
          param_1[5] = param_1[5] + fVar13 * fVar50;
          param_1[6] = param_1[6] + fVar13 * fVar44;
          param_1[7] = param_1[7] + fVar13 * fVar49;
          param_1[8] = param_1[8] + fVar14 * fVar18;
          param_1[9] = param_1[9] + fVar14 * fVar50;
          param_1[10] = param_1[10] + fVar14 * fVar44;
          param_1[0xb] = param_1[0xb] + fVar14 * fVar49;
          param_1[0xc] = param_1[0xc] + fVar15 * fVar18;
    ...
    if (3 < param_2) {
      if ((param_3 + param_2 <= param_1 || param_1 + param_2 * 4 <= param_3) &&
        ...
        auVar19 = NEON_fmov(0xbfe0000000000000,8);
        ...
        do {
          ...
          auVar45._0_8_ = (long)(int)-(uint)(0.0 < fVar12 * 1.3421773e+08);
          auVar45._8_8_ = (long)(int)-(uint)(0.0 < fVar13 * 1.3421773e+08);
          auVar46 = auVar19 ^ (auVar19 ^ auVar20) & auVar45;
          auVar48 = auVar19 ^ (auVar19 ^ auVar20) & auVar47;
          auVar22._0_4_ = (undefined4)(long)(auVar46._0_8_ + (double)(fVar12 * 1.3421773e+08));
          ...
          fVar49 = param_5[2];
          fVar50 = param_5[3];
          auVar48._0_4_ = -(uint)(fVar12 <= auVar16._0_4_);
          auVar48._4_4_ = -(uint)(fVar13 <= auVar16._4_4_);
          auVar48._8_4_ = -(uint)(fVar14 <= auVar16._8_4_);
          auVar48._12_4_ = -(uint)(fVar15 <= auVar16._12_4_);
          iVar8 = -(uint)(auVar17._0_4_ <= fVar12);
          iVar9 = -(uint)(auVar17._4_4_ <= fVar13);
          iVar10 = -(uint)(auVar17._8_4_ <= fVar14);
          iVar11 = -(uint)(auVar17._12_4_ <= fVar15);
          ...
          bVar29 = (byte)iVar9 & ~(byte)auVar48._4_4_;
          bVar31 = (byte)((uint)iVar9 >> 8) & ~(byte)((uint)auVar48._4_4_ >> 8);
          bVar32 = (byte)((uint)iVar9 >> 0x10) & ~(byte)((uint)auVar48._4_4_ >> 0x10);
          bVar33 = (byte)((uint)iVar9 >> 0x18) & ~(byte)((uint)auVar48._4_4_ >> 0x18);
          bVar34 = (byte)iVar10 & ~(byte)auVar48._8_4_;
          bVar36 = (byte)((uint)iVar10 >> 8) & ~(byte)((uint)auVar48._8_4_ >> 8);
          bVar37 = (byte)((uint)iVar10 >> 0x10) & ~(byte)((uint)auVar48._8_4_ >> 0x10);
          bVar38 = (byte)((uint)iVar10 >> 0x18) & ~(byte)((uint)auVar48._8_4_ >> 0x18);
          bVar39 = (byte)iVar11 & ~(byte)auVar48._12_4_;
          bVar41 = (byte)((uint)iVar11 >> 8) & ~(byte)((uint)auVar48._12_4_ >> 8);
          bVar42 = (byte)((uint)iVar11 >> 0x10) & ~(byte)((uint)auVar48._12_4_ >> 0x10);
          bVar43 = (byte)((uint)iVar11 >> 0x18) & ~(byte)((uint)auVar48._12_4_ >> 0x18);
          ...
          iVar8 = iVar8 * 4;
          iVar9 = (int)((ulong)auVar21._0_8_ >> 0x20) * 4;
          iVar10 = auVar21._8_4_ * 4;
          iVar11 = auVar23._12_4_ * 4;
          *param_1 = fVar12 * fVar18 + *param_1;
          param_1[1] = fVar12 * fVar44 + param_1[1];
          param_1[2] = fVar12 * fVar49 + param_1[2];
          param_1[3] = fVar12 * fVar50 + param_1[3];
          param_1[4] = fVar13 * fVar18 + param_1[4];
          param_1[5] = fVar13 * fVar44 + param_1[5];
          param_1[6] = fVar13 * fVar49 + param_1[6];
          param_1[7] = fVar13 * fVar50 + param_1[7];
          param_1[8] = fVar14 * fVar18 + param_1[8];
          param_1[9] = fVar14 * fVar44 + param_1[9];
          param_1[10] = fVar14 * fVar49 + param_1[10];
          param_1[0xb] = fVar14 * fVar50 + param_1[0xb];
          param_1[0xc] = fVar15 * fVar18 + param_1[0xc];
          ...
          *(ulong *)piVar5 =
               CONCAT44((int)((ulong)*(undefined8 *)piVar5 >> 0x20) +
                        ((int)(iVar9 + ((uint)(iVar9 >> 0x1f) >> 0x1e)) >> 0xe) * iVar2,
                        (int)*(undefined8 *)piVar5 +
    ...
    do {
      ...
      if (fVar18 <= -16.0) {
        ...
        iVar8 = (int)((double)((ulong)uVar30 << 0x20) + (double)(fVar18 * 1.3421773e+08));
      }
      *param_1 = fVar18 * *param_5 + *param_1;
      ...
      if (fVar18 <= -16.0) {
        ...
        iVar9 = (int)((double)((ulong)uVar30 << 0x20) + (double)(fVar18 * 1.3421773e+08));
      }
      ...
      if (fVar18 <= -16.0) {
        ...
        iVar10 = (int)((double)((ulong)uVar30 << 0x20) + (double)(fVar18 * 1.3421773e+08));
      }
      ...
      if (fVar18 <= -16.0) {
        ...
        iVar11 = (int)((double)((ulong)uVar30 << 0x20) + (double)(fVar18 * 1.3421773e+08));
      }
      iVar11 = iVar11 + iVar10 + iVar9 + iVar8;
      param_1[3] = fVar18 * param_5[3] + param_1[3];
      iVar8 = iVar11 + 3;
      if (-1 < iVar11) {
        iVar8 = iVar11;
      }
