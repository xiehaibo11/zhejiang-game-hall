...
void FUN_00a9edb0(long *param_1,long *param_2)
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
        ...
        (**(code **)(local_60[0] + 0x18))(local_60,param_2);
                    /* try { // try from 00a9eed8 to 00b9ef5b has its CatchHandler @ 00a9eed8
                       catch() { ... } // from try @ 00a9eed8 with catch @ 00a9eed8
                       catch() { ... } // from try @ 00a9ef70 with catch @ 00a9eed8 */
