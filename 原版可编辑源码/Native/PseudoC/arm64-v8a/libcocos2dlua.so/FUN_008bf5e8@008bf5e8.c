...
undefined8 FUN_008bf5e8(undefined8 param_1)

{
  ...
  if ((((iVar2 == 0) || (iVar2 = tolua_isnumber(param_1,2,0,auStack_58), iVar2 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glClearColor\'.",auStack_58);
  }
  else {
    ...
    glClearColor((float)dVar3,(float)dVar4,(float)dVar5,(float)dVar6);
  }
