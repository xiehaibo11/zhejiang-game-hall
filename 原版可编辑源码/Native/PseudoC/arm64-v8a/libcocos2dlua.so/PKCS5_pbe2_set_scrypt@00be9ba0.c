...
LAB_00be9d50:
          ...
          if (pAVar4 == (ASN1_TYPE *)0x0) goto LAB_00be9d4c;
          iVar2 = EVP_CIPHER_iv_length(param_1);
          if (iVar2 == 0) {
LAB_00be9cf0:
            ctx = EVP_CIPHER_CTX_new();
            if (ctx == (EVP_CIPHER_CTX *)0x0) goto LAB_00be9d4c;
...
LAB_00be9dd4:
            ...
            val = ASN1_item_new((ASN1_ITEM *)&DAT_016c7728);
...
LAB_00be9f28:
              ASN1_item_free(val,(ASN1_ITEM *)&DAT_016c7728);
              ...
              if (((iVar1 == 0) ||
                  (iVar1 = ASN1_INTEGER_set_uint64(*(undefined8 *)(val + 0x10),param_6), iVar1 == 0)
                       ...
                       iVar1 == 0)) goto LAB_00be9f08;
              if (lVar7 != 0) {
                pAVar5 = ASN1_INTEGER_new();
                *(ASN1_INTEGER **)(val + 0x20) = pAVar5;
                if ((pAVar5 == (ASN1_INTEGER *)0x0) ||
                   (iVar1 = ASN1_INTEGER_set_int64(pAVar5,lVar7), iVar1 == 0)) goto LAB_00be9f08;
              }
              pXVar6 = X509_ALGOR_new();
              if (pXVar6 == (X509_ALGOR *)0x0) goto LAB_00be9f0c;
              pAVar3 = OBJ_nid2obj(0x3cd);
              pXVar6->algorithm = pAVar3;
              lVar7 = ASN1_TYPE_pack_sequence(&DAT_016c7728,val,&pXVar6->parameter);
              if (lVar7 == 0) goto LAB_00be9f0c;
              ASN1_item_free(val,(ASN1_ITEM *)&DAT_016c7728);
              a->keyfunc = pXVar6;
              pXVar6 = X509_ALGOR_new();
