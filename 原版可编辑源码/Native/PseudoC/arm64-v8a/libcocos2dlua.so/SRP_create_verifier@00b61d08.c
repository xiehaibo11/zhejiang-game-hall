...

{
  ...
  a = (BIGNUM *)0x0;
  a_00 = (BIGNUM *)0x0;
  if (param_4 == (undefined8 *)0x0) goto LAB_00b61f64;
  if (param_5 == 0) {
    puVar7 = (undefined8 *)SRP_get_default_gN(param_6);
    if (puVar7 == (undefined8 *)0x0) goto LAB_00b61f38;
    pBVar18 = (BIGNUM *)puVar7[1];
    pBVar19 = (BIGNUM *)puVar7[2];
    puVar16 = (undefined *)*puVar7;
    a = (BIGNUM *)0x0;
    a_00 = (BIGNUM *)0x0;
    if (*param_3 == 0) goto LAB_00b61ddc;
LAB_00b61e2c:
    iVar4 = FUN_00b621a4(&local_13f8);
    iVar5 = iVar4;
joined_r0x00b61e3c:
    if (0 < iVar5) {
...
LAB_00b61fd8:
            if ((uVar15 >> 2 != 0) || (bVar2 = false, pcVar9 = pcVar10, bVar3)) {
              pcVar9 = pcVar10 + 1;
              *pcVar10 = s_0123456789ABCDEFGHIJKLMNOPQRSTUV_0176eba8[uVar15 >> 2];
              bVar2 = true;
            }
            uVar15 = uVar11 >> 4 | (uVar15 & 3) << 4;
            if ((uVar15 != 0) || (bVar3 = false, pcVar10 = pcVar9, bVar2)) {
              pcVar10 = pcVar9 + 1;
              *pcVar9 = s_0123456789ABCDEFGHIJKLMNOPQRSTUV_0176eba8[uVar15];
              bVar3 = true;
            }
            uVar15 = uVar13 >> 6 | (uVar11 & 0xf) << 2;
            if ((uVar15 != 0) || (bVar3)) {
              pcVar9 = pcVar10 + 1;
              *pcVar10 = s_0123456789ABCDEFGHIJKLMNOPQRSTUV_0176eba8[uVar15];
LAB_00b62164:
              bVar3 = true;
              pcVar10 = pcVar9 + 1;
              *pcVar9 = s_0123456789ABCDEFGHIJKLMNOPQRSTUV_0176eba8[uVar13 & 0x3f];
            }
            else {
              pcVar9 = pcVar10;
              if ((uVar13 & 0x3f) != 0) goto LAB_00b62164;
              bVar3 = false;
            }
            if (iVar5 >> 3 <= iVar6) goto LAB_00b62050;
    ...
    iVar4 = FUN_00b621a4(local_a34,param_5);
    if (iVar4 < 1) {
LAB_00b61f38:
      a = (BIGNUM *)0x0;
    }
      ...
      iVar4 = FUN_00b621a4(local_a34,param_6);
      if (0 < iVar4) {
        a_00 = BN_bin2bn(local_a34,iVar4,(BIGNUM *)0x0);
        puVar16 = &DAT_013c86f0;
        pBVar18 = a_00;
        pBVar19 = a;
        if (*param_3 != 0) goto LAB_00b61e2c;
LAB_00b61ddc:
        iVar4 = 0x14;
        iVar5 = RAND_bytes(&local_13f8,0x14);
        goto joined_r0x00b61e3c;
      }
    }
    a_00 = (BIGNUM *)0x0;
  }
    ...
    if (pcVar10 != (char *)0x0) {
      ...
      do {
        ...
        if ((uVar15 >> 2 != 0) || (bVar2 = false, pcVar12 = pcVar9, bVar3)) {
          pcVar12 = pcVar9 + 1;
          *pcVar9 = s_0123456789ABCDEFGHIJKLMNOPQRSTUV_0176eba8[uVar15 >> 2];
          bVar2 = true;
        }
        uVar15 = (uint)(local_13f8 >> 4) | (uVar15 & 3) << 4;
        if ((uVar15 != 0) || (bVar3 = false, pcVar9 = pcVar12, bVar2)) {
          pcVar9 = pcVar12 + 1;
          *pcVar12 = s_0123456789ABCDEFGHIJKLMNOPQRSTUV_0176eba8[uVar15];
          bVar3 = true;
        }
...
LAB_00b62128:
          bVar3 = true;
          pcVar9 = pcVar12 + 1;
          *pcVar12 = s_0123456789ABCDEFGHIJKLMNOPQRSTUV_0176eba8[bVar1 & 0x3f];
        }
        else {
          pcVar12 = pcVar9;
          if ((bVar1 & 0x3f) != 0) goto LAB_00b62128;
          bVar3 = false;
        }
        if (0x13 < lVar8 + 2) goto LAB_00b6213c;
