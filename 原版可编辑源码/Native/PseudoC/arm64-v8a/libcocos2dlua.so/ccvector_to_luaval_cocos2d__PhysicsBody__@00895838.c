...
/* void ccvector_to_luaval<cocos2d::PhysicsBody*>(lua_State*, cocos2d::Vector<cocos2d::PhysicsBody*>
   const&) */

void ccvector_to_luaval<cocos2d::PhysicsBody*>(lua_State *param_1,Vector *param_2)
