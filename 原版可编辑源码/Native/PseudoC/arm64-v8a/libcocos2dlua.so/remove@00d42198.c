...

{
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar7 == uVar4) goto LAB_00d42274;
  }
  if (*param_3 != 0) {
...
LAB_00d42274:
  if (*param_3 != 0) {
    uVar7 = *(ulong *)(*param_3 + 8);
    if (uVar6 < 2) {
                    /* catch() { ... } // from try @ 00d422d0 with catch @ 00d422a4 */
      uVar7 = uVar7 & uVar3 - 1;
    }
    else if (uVar3 <= uVar7) {
      uVar6 = 0;
  ...
  *plVar5 = *param_3;
                    /* try { // try from 00d422c8 to 00e422cf has its CatchHandler @ 00d42320 */
  *param_3 = 0;
                    /* try { // try from 00d422d0 to 00e4233b has its CatchHandler @ 00d422a4 */
