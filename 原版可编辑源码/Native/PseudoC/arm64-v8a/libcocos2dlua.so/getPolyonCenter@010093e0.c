...
/* cocos2d::PhysicsShape::getPolyonCenter(cocos2d::Vec2 const*, int) */

undefined1  [16] cocos2d::PhysicsShape::getPolyonCenter(Vec2 *param_1,int param_2)

{
  ...
  if (0 < param_2) {
    ...
    if ((uint)param_2 < 8) {
      ...
      uVar7 = uVar4;
      do {
                    /* try { // try from 01009448 to 011094cf has its CatchHandler @ 0100951c */
        uVar8 = puVar5[-4];
        uVar11 = puVar5[-1];
        uVar10 = puVar5[-2];
        uVar13 = puVar5[1];
      ...
      if (uVar4 == uVar3) goto LAB_01009488;
    }
    lVar2 = uVar3 - uVar4;
