...
LAB_00b6c960:
        ...
        *(long *)&ctx->error = lVar3;
        ...
        if (0 < iVar1) {
          ...
          if (iVar2 < *(int *)(&UNK_013efab4 + (long)iVar1 * 4)) goto LAB_00b6c960;
        }
      }
      if ((psVar10 == (stack_st_void *)0x0) ||
         (iVar1 = OPENSSL_sk_num((psVar10->stack).data), iVar1 < 1)) {
LAB_00b6cab4:
        iVar1 = FUN_00b6cb94(ctx);
joined_r0x00b6cac0:
        if (0 < iVar1) {
          return iVar1;
        }
        ...
        *(undefined8 *)((long)&psVar10[1].stack.data + 4) = 0xffffffffffffffff;
        iVar1 = FUN_00b7003c(*(undefined4 *)((long)&ctx->cleanup + 4),(ctx->ex_data).sk,
                             *(undefined8 *)&ctx->current_method,0);
        if (iVar1 == 0) {
          if (((psVar10 != (stack_st_void *)0x0) && (((ulong)psVar10[1].stack.data & 5) != 0)) ||
             (-1 < *(int *)((long)&psVar10[1].stack.data + 4))) goto LAB_00b6cab4;
...
LAB_00b6cb70:
        ...
        if (iVar1 < 1) {
          ...
          *(undefined8 *)((long)&ctx->tree + 4) = 0x1100000000;
          ...
          goto joined_r0x00b6cb84;
        }
        iVar1 = X509_chain_check_suiteb(0,lVar3,0,(ctx->crls->stack).comp);
        if (iVar1 == 0) {
LAB_00b6ca4c:
          if (((ulong)psVar10[1].stack.comp & 1) == 0) {
            iVar2 = FUN_00b6fbcc(ctx);
            iVar1 = 0;
            if (iVar2 == 0) goto LAB_00b6cb80;
          }
          p_Var9 = ctx->verify;
