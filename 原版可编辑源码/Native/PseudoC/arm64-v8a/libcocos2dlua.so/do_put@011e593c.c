...
/* WARNING: Removing unreachable block (ram,0x011e5cf4) */
...

{
  ...
  if (((DAT_017942d8 & 1) == 0) && (iVar8 = __cxa_guard_acquire(&DAT_017942d8), iVar8 != 0)) {
    ...
    if (bVar6) goto LAB_011e5a6c;
LAB_011e5ad4:
    iVar8 = __libcpp_snprintf_l(local_88,0x1e,(__locale_t *)DAT_017942d0,(char *)&local_d0,param_1);
    if (iVar8 < 0x1e) goto LAB_011e5a8c;
LAB_011e5af0:
    if (bVar6) {
      if (((DAT_017942d8 & 1) == 0) && (iVar8 = __cxa_guard_acquire(&DAT_017942d8), iVar8 != 0)) {
        DAT_017942d0 = newlocale(0x1fbf,"C",(__locale_t)0x0);
      ...
      iVar8 = __libcpp_asprintf_l(&local_d8,(__locale_t *)DAT_017942d0,(char *)&local_d0,param_1,
    ...
    if (!bVar6) goto LAB_011e5ad4;
LAB_011e5a6c:
    iVar8 = __libcpp_snprintf_l(local_88,0x1e,(__locale_t *)DAT_017942d0,(char *)&local_d0,param_1,
                                (ulong)*(uint *)(param_4 + 0x10));
    if (0x1d < iVar8) goto LAB_011e5af0;
LAB_011e5a8c:
    __ptr_00 = (char *)0x0;
  }
  pcVar7 = local_d8;
  ...
  if (local_d8 != local_88) {
    ...
    pcVar13 = __ptr;
    if (__ptr != (char *)0x0) goto LAB_011e5bd8;
    __throw_bad_alloc();
  }
  __ptr = (char *)0x0;
  pcVar13 = acStack_c4;
LAB_011e5bd8:
  ...
  uVar9 = FUN_00914b68(param_3,pcVar13,pcStack_e0,local_e8,param_4,param_5);
  if (__ptr != (char *)0x0) {
    free(__ptr);
  }
