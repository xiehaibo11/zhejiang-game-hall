...
undefined8 FT_GlyphLoader_CreateExtra(long *param_1)

{
  ...
  *(undefined1 *)((long)param_1 + 0x14) = 1;
  ...
  param_1[9] = (long)pvVar1;
                    /* try { // try from 0105b1d0 to 0115b1df has its CatchHandler @ 0105b1f0 */
  ...
  param_1[0x12] = (long)((long)pvVar1 + lVar3);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 0105b1d0 with catch @ 0105b1f0
                        */
