...
{
  return &__bind<void(cocostudio::InputDelegate::*)(cocos2d::Acceleration*,cocos2d::Event*),cocostudio::InputDelegate*,std::__ndk1::placeholders::__ph<1>const&,std::__ndk1::placeholders::__ph<2>const&>
          ::typeinfo;
}
