...

{
  ...
  do {
                    /* catch() { ... } // from try @ 00d8b290 with catch @ 00d8b258 */
    pcVar3 = pcVar3 + 1;
  } while (*pcVar3 != '\0');
  uVar1 = *(uint *)param_1;
  ...
  if (uVar1 == 0) {
LAB_00d8b2e0:
                    /* catch() { ... } // from try @ 00d8b31c with catch @ 00d8b2e4 */
      ...
      if (iVar2 == (int)uVar8) {
        ...
        if ((*(ushort *)((long)piVar4 + 0x16) & 0x1000) != 0) {
          __s2 = piVar4;
                    ...
                    /* catch() { ... } // from try @ 00d8b288 with catch @ 00d8b2c8 */
        if ((__s2 == (int *)__s1) || (iVar2 = memcmp(__s1,__s2,uVar8 & 0xffffffff), iVar2 == 0))
        goto LAB_00d8b2e0;
      }
                    /* try { // try from 00d8b288 to 00e8b28f has its CatchHandler @ 00d8b2c8 */
      lVar9 = lVar9 + -0x30;
      piVar4 = piVar4 + 0xc;
                    /* try { // try from 00d8b290 to 00e8b2e3 has its CatchHandler @ 00d8b258 */
    } while (lVar9 != 0);
  }
...
LAB_00d8b308:
  ...
  *(long *)(lVar6 + 0xa8) = lVar5;
                    /* try { // try from 00d8b314 to 00e8b31b has its CatchHandler @ 00d8b354 */
                    /* try { // try from 00d8b31c to 00e8b36f has its CatchHandler @ 00d8b2e4 */
  uVar1 = **(uint **)(piVar4 + 2);
  ...
  *(long *)(this + 0x260) = lVar9;
                    /* catch() { ... } // from try @ 00d8b314 with catch @ 00d8b354 */
