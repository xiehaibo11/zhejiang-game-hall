...

{
  ...
  SkinData *pSVar6;
                    ...
                    /* try { // try from 00d88f80 to 00e88faf has its CatchHandler @ 00d891fc */
  pSVar6 = *(SkinData **)(this + 0x28);
  while (pSVar6 != this + 0x30) {
    puVar2 = *(undefined8 **)(pSVar6 + 0x40);
                    /* try { // try from 00d88fc0 to 00e88fd3 has its CatchHandler @ 00d89164 */
    ...
    if (*(SkinData **)(pSVar6 + 8) == (SkinData *)0x0) {
      ...
      if (bVar3) {
        do {
          lVar5 = *(long *)pSVar4;
                    /* try { // try from 00d89010 to 00e8904f has its CatchHandler @ 00d8919c */
