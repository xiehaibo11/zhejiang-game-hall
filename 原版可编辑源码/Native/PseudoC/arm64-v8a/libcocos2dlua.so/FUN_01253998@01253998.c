...
void FUN_01253998(long param_1,long param_2,long param_3,long *param_4,int param_5,uint param_6)

{
  ...
  if ((param_6 & 1) == 0) {
    if (*(long *)(param_1 + 8) != *(long *)(lVar5 + 8)) goto LAB_01253a3c;
  }
