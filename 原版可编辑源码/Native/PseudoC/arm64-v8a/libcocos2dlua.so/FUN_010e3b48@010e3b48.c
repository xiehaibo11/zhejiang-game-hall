...
void FUN_010e3b48(long *param_1)

{
  ...
  long lVar10;
                    ...
                    /* try { // try from 010e3b58 to 011e3bcb has its CatchHandler @ 010e3998 */
  ...
  if (iVar6 == 1) {
    ...
    *(undefined4 *)(lVar8 + 0x44) = *(undefined4 *)(lVar8 + 0x24);
    ...
    if (uVar2 != 0) {
      uVar3 = uVar1 / uVar2;
                    ...
                    /* catch() { ... } // from try @ 010e3b3c with catch @ 010e3b98 */
    ...
    *(uint *)(lVar8 + 0x4c) = uVar2;
                    /* catch() { ... } // from try @ 010e3ab8 with catch @ 010e3ba8 */
    param_1[0x34] = 1;
  }
  else {
                    /* catch() { ... } // from try @ 010e3a2c with catch @ 010e3bb4 */
    if (3 < iVar6 - 1U) {
