...
::operator()(__func<std::__ndk1::__bind<void(fairygui::PopupMenu::*)(fairygui::EventContext*),fairygui::PopupMenu*,std::__ndk1::placeholders::__ph<1>const&>,std::__ndk1::allocator<std::__ndk1::__bind<void(fairygui::PopupMenu::*)(fairygui::EventContext*),fairygui::PopupMenu*,std::__ndk1::placeholders::__ph<1>const&>>,void(fairygui::EventContext*)>
...

{
  ...
  if ((*(ulong *)(this + 0x10) & 1) != 0) {
    UNRECOVERED_JUMPTABLE = *(code **)(UNRECOVERED_JUMPTABLE + *plVar1);
                    ...
                    /* WARNING: Could not recover jumptable at 0x00a9105c. Too many branches */
