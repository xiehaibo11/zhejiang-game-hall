...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   fairygui::GearColor::GearColorValue> > >::__rehash(unsigned long) */
...

{
  ...
  if (param_1 == 0) {
    ...
    *(undefined8 *)(this + 8) = 0;
                    /* try { // try from 00ab1728 to 00bb1733 has its CatchHandler @ 00ab17f4 */
  }
  else {
    if (param_1 >> 0x3d != 0) {
      ...
      FUN_007c2210("allocator<T>::allocate(size_t n) \'n\' exceeds maximum supported size");
                    ...
                    /* try { // try from 00ab16a0 to 00bb16df has its CatchHandler @ 00ab16a0
                       catch() { ... } // from try @ 00ab16a0 with catch @ 00ab16a0
                       catch() { ... } // from try @ 00ab1758 with catch @ 00ab16a0
                       catch() { ... } // from try @ 00ab17a0 with catch @ 00ab16a0 */
    ...
    *(ulong *)(this + 8) = param_1;
    ...
    plVar15 = *(long **)(this + 0x10);
                    /* try { // try from 00ab16e0 to 00bb1723 has its CatchHandler @ 00ab180c */
    if (plVar15 != (long *)0x0) {
      uVar10 = plVar15[1];
      ...
      if (uVar13 < 2) {
        ...
        uVar10 = uVar10 - uVar17 * param_1;
                    ...
                    /* try { // try from 00ab1734 to 00bb173b has its CatchHandler @ 00ab180c */
      *(__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,fairygui::GearColor::GearColorValue>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,fairygui::GearColor::GearColorValue>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,fairygui::GearColor::GearColorValue>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,fairygui::GearColor::GearColorValue>>>
        **)(*(long *)this + uVar10 * 8) = this + 0x10;
      if ((long *)*plVar15 != (long *)0x0) {
                    /* try { // try from 00ab1744 to 00bb1757 has its CatchHandler @ 00ab17f0 */
        plVar16 = (long *)*plVar15;
        do {
          uVar17 = plVar16[1];
          if (uVar13 < 2) {
                    /* try { // try from 00ab178c to 00bb179f has its CatchHandler @ 00ab180c */
          ...
          if (uVar17 != uVar10) {
                    /* try { // try from 00ab17a0 to 00bb183f has its CatchHandler @ 00ab16a0 */
              ...
              if (plVar11 != (long *)0x0) {
                ...
                do {
                  ...
                  bVar1 = *(byte *)(plVar12 + 2);
                    /* catch() { ... } // from try @ 00ab1744 with catch @ 00ab17f0 */
                  sVar3 = (ulong)(bVar1 >> 1);
                    /* catch() { ... } // from try @ 00ab1728 with catch @ 00ab17f4 */
                  if ((bVar1 & 1) != 0) {
                    sVar3 = plVar12[3];
                  }
                  if (__n != sVar3) break;
                  ...
                  __s1 = (char *)((long)plVar16 + 0x11);
                    /* catch() { ... } // from try @ 00ab16e0 with catch @ 00ab180c
                       catch() { ... } // from try @ 00ab1734 with catch @ 00ab180c
                       catch() { ... } // from try @ 00ab178c with catch @ 00ab180c */
                  if ((bVar2 & 1) != 0) {
                    __s1 = (char *)plVar16[4];
                  }
                  if ((bVar1 & 1) == 0) {
                  ...
                  if ((bVar2 & 1) == 0) {
                    while (sVar6 != 0) {
                      if (*pcVar5 != *__s2) goto LAB_00ab1874;
                    /* try { // try from 00ab1840 to 00bb19ff has its CatchHandler @ 00ab1840
                       catch() { ... } // from try @ 00ab1840 with catch @ 00ab1840
                       catch() { ... } // from try @ 00ab1a80 with catch @ 00ab1840 */
                      __s2 = __s2 + 1;
                      sVar3 = sVar3 - 1;
                      pcVar5 = pcVar5 + 1;
                      sVar6 = sVar3;
...
LAB_00ab1874:
              ...
              **(undefined8 **)(*(long *)this + uVar17 * 8) = plVar16;
              plVar16 = plVar15;
                    ...
                    /* try { // try from 00ab1758 to 00bb178b has its CatchHandler @ 00ab16a0 */
          plVar11 = (long *)*plVar16;
          plVar15 = plVar16;
          plVar16 = plVar11;
