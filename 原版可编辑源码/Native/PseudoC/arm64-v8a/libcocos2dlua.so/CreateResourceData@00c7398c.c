...
/* flatbuffers::CreateResourceData(flatbuffers::FlatBufferBuilder&,
   flatbuffers::Offset<flatbuffers::String>, flatbuffers::Offset<flatbuffers::String>, int) */

undefined4
flatbuffers::CreateResourceData(FlatBufferBuilder *param_1,int param_2,int param_3,int param_4)
