...
::operator()(__func<std::__ndk1::__bind<void(fairygui::GScrollBar::*)(fairygui::EventContext*),fairygui::GScrollBar*,std::__ndk1::placeholders::__ph<1>const&>,std::__ndk1::allocator<std::__ndk1::__bind<void(fairygui::GScrollBar::*)(fairygui::EventContext*),fairygui::GScrollBar*,std::__ndk1::placeholders::__ph<1>const&>>,void(fairygui::EventContext*)>
...

{
  ...
  plVar1 = (long *)(*(long *)(this + 0x18) + ((long)*(ulong *)(this + 0x10) >> 1));
                    /* try { // try from 00a8ad40 to 00b8ad43 has its CatchHandler @ 00a8ad90 */
  if ((*(ulong *)(this + 0x10) & 1) != 0) {
                    /* try { // try from 00a8ad44 to 00b8adb3 has its CatchHandler @ 00a8acdc */
    UNRECOVERED_JUMPTABLE = *(code **)(UNRECOVERED_JUMPTABLE + *plVar1);
  }
                    /* WARNING: Could not recover jumptable at 0x00a8ad50. Too many branches */
