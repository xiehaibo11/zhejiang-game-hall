...
undefined4
FUN_00b57110(EVP_MD_CTX *param_1,EVP_PKEY_CTX *param_2,undefined8 *param_3,EVP_PKEY *param_4)

{
  ...
  if (a == (RSA_PSS_PARAMS *)0x0) {
    ...
    p2 = (void *)FUN_00b573d8(a->maskGenAlgorithm,a_00);
    if (p2 != (void *)0x0) {
      if (a->hashAlgorithm == (X509_ALGOR *)0x0) {
        md = EVP_sha1();
        if (md != (EVP_MD *)0x0) goto LAB_00b57244;
      }
      else {
