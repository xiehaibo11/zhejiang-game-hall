...

{
  ...
  size_t __n;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fe3dcc with catch @ 00fe3de8
                        */
  __src = *(void **)this;
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < param_1) {
    ...
    __dest = operator_new(param_1 * 8);
                    /* try { // try from 00fe3e30 to 010e3e33 has its CatchHandler @ 00fe3e4c */
    if (0 < (long)__n) {
    ...
    *(void **)(this + 0x10) = (void *)((long)__dest + param_1 * 8);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fe3e30 with catch @ 00fe3e4c
                        */
    if (__src != (void *)0x0) {
