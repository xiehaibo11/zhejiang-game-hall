...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<unsigned
   long, int>, void*>*>, bool> std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned
   long, int>, std::__ndk1::__unordered_map_hasher<unsigned long,
   std::__ndk1::__hash_value_type<unsigned long, int>, std::__ndk1::hash<unsigned long>, true>,
   std::__ndk1::__unordered_map_equal<unsigned long, std::__ndk1::__hash_value_type<unsigned long,
   int>, std::__ndk1::equal_to<unsigned long>, true>,
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<unsigned long, int> >
   >::__emplace_unique_key_args<unsigned long, std::__ndk1::piecewise_construct_t const&,
   std::__ndk1::tuple<unsigned long const&>, std::__ndk1::tuple<> >(unsigned long const&,
...

{
  ...
  if (uVar7 != 0) {
    ...
    uVar2 = CONCAT62((int6)((ulong)uVar10 >> 0x10),uVar9) & 0xffffffff;
                    /* try { // try from 00f04510 to 01004517 has its CatchHandler @ 00f04804 */
    if (uVar2 < 2) {
      unaff_x24 = uVar7 - 1 & uVar8;
    }
    else {
      unaff_x24 = uVar8;
                    /* try { // try from 00f04518 to 01004527 has its CatchHandler @ 00f047fc */
      if (uVar7 <= uVar8) {
        uVar4 = 0;
        if (uVar7 != 0) {
          uVar4 = uVar8 / uVar7;
      ...
      for (puVar6 = (ulong *)*plVar5; puVar6 != (ulong *)0x0; puVar6 = (ulong *)*puVar6) {
        ...
        if (uVar4 != uVar8) {
          if (uVar2 < 2) {
            ...
            if (uVar4 - uVar1 * uVar7 == unaff_x24) goto LAB_00f04560;
            break;
          }
          if (uVar4 != unaff_x24) break;
        }
LAB_00f04560:
                    /* try { // try from 00f04568 to 01004577 has its CatchHandler @ 00f047f8 */
        if (puVar6[2] == uVar8) {
          return puVar6;
        }
      }
  ...
  *puVar6 = 0;
  puVar6[1] = uVar8;
  puVar6[2] = uVar2;
                    /* try { // try from 00f045c0 to 010045d3 has its CatchHandler @ 00f04804 */
                    /* try { // try from 00f045dc to 010045e7 has its CatchHandler @ 00f04800 */
  ...
  if (puVar3 == (ulong *)0x0) {
    ...
    *(ulong **)(uVar8 + unaff_x24 * 8) = puVar3;
                    /* try { // try from 00f04680 to 01004687 has its CatchHandler @ 00f047dc */
    if (*puVar6 == 0) goto LAB_00f046b8;
    uVar8 = *(ulong *)(*puVar6 + 8);
                    /* try { // try from 00f0468c to 0100469b has its CatchHandler @ 00f047d8 */
    if ((uVar7 & uVar7 - 1) == 0) {
      uVar8 = uVar8 & uVar7 - 1;
    }
    else if (uVar7 <= uVar8) {
      ...
      if (uVar7 != 0) {
        uVar2 = uVar8 / uVar7;
                    ...
                    /* try { // try from 00f046a0 to 010046af has its CatchHandler @ 00f047c4 */
      uVar8 = uVar8 - uVar2 * uVar7;
    }
                    /* try { // try from 00f046b0 to 010046cb has its CatchHandler @ 00f047a4 */
