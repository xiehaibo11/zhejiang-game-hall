...
undefined8 FUN_0109e15c(long param_1,long param_2,long param_3,undefined8 param_4,long *param_5)

{
  ...
  uVar2 = FT_Stream_ReadAt(*(undefined8 *)(param_1 + 0xc0),param_3,param_4,lVar4);
  return uVar2;
}
