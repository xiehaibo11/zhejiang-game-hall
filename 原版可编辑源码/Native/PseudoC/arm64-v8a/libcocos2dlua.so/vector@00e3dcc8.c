...
/* std::__ndk1::vector<cocos2d::Vec3, std::__ndk1::allocator<cocos2d::Vec3>
   >::vector(std::__ndk1::vector<cocos2d::Vec3, std::__ndk1::allocator<cocos2d::Vec3> > const&) */

void __thiscall
std::__ndk1::vector<cocos2d::Vec3,std::__ndk1::allocator<cocos2d::Vec3>>::vector
          (vector<cocos2d::Vec3,std::__ndk1::allocator<cocos2d::Vec3>> *this,vector *param_1)
