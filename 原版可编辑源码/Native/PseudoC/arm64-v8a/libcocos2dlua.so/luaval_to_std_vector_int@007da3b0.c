...
/* luaval_to_std_vector_int(lua_State*, int, std::__ndk1::vector<int, std::__ndk1::allocator<int>
   >*, char const*) */

bool luaval_to_std_vector_int(lua_State *param_1,int param_2,vector *param_3,char *param_4)
        ...
        do {
          ...
          if (iVar4 != 0) {
            ...
            if (piVar1 < *(int **)(param_3 + 0x10)) {
              *piVar1 = local_6c;
              *(int **)(param_3 + 8) = piVar1 + 1;
            }
            else {
              std::__ndk1::vector<int,std::__ndk1::allocator<int>>::__push_back_slow_path<int>
                        ((vector<int,std::__ndk1::allocator<int>> *)param_3,&local_6c);
            }
          }
