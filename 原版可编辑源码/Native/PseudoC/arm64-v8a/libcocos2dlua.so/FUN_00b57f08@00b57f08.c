...
int FUN_00b57f08(int param_1,uchar *param_2,void *param_3,long param_4,undefined4 param_5)
...
LAB_00b580b4:
    ...
    if (iVar1 < 1) goto LAB_00b580b4;
LAB_00b58184:
    pBVar3 = BN_bin2bn(to,iVar5,ret);
    if (pBVar3 == (BIGNUM *)0x0) goto LAB_00b580b4;
    ...
    if ((((*(byte *)(param_4 + 0x6c) >> 1 & 1) != 0) &&
       ...
       (iVar1 = (**(code **)(*(long *)(param_4 + 0x10) + 0x30))
                          (a,ret,*(undefined8 *)(param_4 + 0x28),*(undefined8 *)(param_4 + 0x20),ctx
                           ,*(undefined8 *)(param_4 + 0x70)), iVar1 == 0)) goto LAB_00b580b4;
    iVar2 = BN_num_bits(a);
    iVar1 = iVar2 + 0xe;
    if (-1 < iVar2 + 7) {
      iVar1 = iVar2 + 7;
