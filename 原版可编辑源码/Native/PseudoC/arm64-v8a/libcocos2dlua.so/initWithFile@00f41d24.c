...
/* cocos2d::SpriteBatchNode::initWithFile(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, long) */

void __thiscall
cocos2d::SpriteBatchNode::initWithFile(SpriteBatchNode *this,basic_string *param_1,long param_2)
