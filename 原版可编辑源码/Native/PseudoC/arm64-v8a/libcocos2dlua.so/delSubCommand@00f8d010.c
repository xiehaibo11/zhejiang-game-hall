...
/* cocos2d::Console::Command::delSubCommand(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

void __thiscall cocos2d::Console::Command::delSubCommand(Command *this,basic_string *param_1)
