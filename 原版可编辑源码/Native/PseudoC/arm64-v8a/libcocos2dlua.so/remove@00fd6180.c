...

{
  ...
  undefined8 uVar9;
                    ...
                    /* catch() { ... } // from try @ 00fd60bc with catch @ 00fd6180 */
  uVar3 = param_2[1];
  uVar4 = param_3[1];
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar7 == uVar4) goto LAB_00fd625c;
  }
  if (*param_3 != 0) {
    ...
    if (uVar6 < 2) {
      ...
      if (uVar3 != 0) {
        uVar1 = uVar7 / uVar3;
                    ...
                    /* catch() { ... } // from try @ 00fd628c with catch @ 00fd6238 */
      uVar7 = uVar7 - uVar1 * uVar3;
    }
    if (uVar7 == uVar4) goto LAB_00fd625c;
  }
...
LAB_00fd625c:
                    /* try { // try from 00fd6260 to 010d6267 has its CatchHandler @ 00fd62e4 */
  if (*param_3 != 0) {
    uVar7 = *(ulong *)(*param_3 + 8);
    if (uVar6 < 2) {
                    /* try { // try from 00fd628c to 010d62ff has its CatchHandler @ 00fd6238 */
      uVar7 = uVar7 & uVar3 - 1;
    }
    else if (uVar3 <= uVar7) {
      uVar6 = 0;
