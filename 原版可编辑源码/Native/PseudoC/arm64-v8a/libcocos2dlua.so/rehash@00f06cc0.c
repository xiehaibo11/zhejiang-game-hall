...

{
  ...
  undefined8 uVar4;
                    ...
                    /* catch() { ... } // from try @ 00f06be0 with catch @ 00f06cc4 */
                    /* catch() { ... } // from try @ 00f06bd8 with catch @ 00f06cc8
                       catch() { ... } // from try @ 00f06c1c with catch @ 00f06cc8 */
  if (param_1 - 1 == 0) {
    param_1 = 2;
  }
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00f06d84;
    }
    return;
  }
LAB_00f06d84:
