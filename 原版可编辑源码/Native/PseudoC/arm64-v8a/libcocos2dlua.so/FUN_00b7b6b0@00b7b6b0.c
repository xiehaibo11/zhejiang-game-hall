...
undefined8 FUN_00b7b6b0(int *param_1,undefined8 param_2,int param_3)

{
  ...
  if (param_1 != (int *)0x0) {
    ...
    if (*(X509 **)(param_1 + 4) == (X509 *)0x0) {
      if (*(long *)(param_1 + 6) == 0) goto LAB_00b7b808;
    ...
    if (param_3 == 0) {
      do {
        ...
        pAVar4 = X509_NAME_ENTRY_get_data(pXVar3);
                    /* try { // try from 00b7b7b4 to 00c7b7bb has its CatchHandler @ 00b7be7c */
      ...
      do {
        ...
        if (iVar1 < 0) {
          return 1;
                    ...
                    /* try { // try from 00b7b72c to 00c7b73f has its CatchHandler @ 00b7be84 */
        pXVar3 = X509_NAME_get_entry(name,iVar1);
        pAVar4 = X509_NAME_ENTRY_get_data(pXVar3);
        pAVar4 = ASN1_STRING_dup(pAVar4);
