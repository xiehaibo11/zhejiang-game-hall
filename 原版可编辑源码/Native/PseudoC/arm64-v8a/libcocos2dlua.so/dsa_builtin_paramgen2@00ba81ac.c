    ...
    if (r_00 != (BIGNUM *)0x0) {
      ...
      if ((r_01 == (BIGNUM *)0x0) ||
        ...
        if (iVar7 != 0) {
          ...
          len = (int)(param_3 >> 3);
          iVar16 = (int)__n + -1;
                    /* try { // try from 00ba8470 to 00ca8797 has its CatchHandler @ 00ba8470
                       catch() { ... } // from try @ 00ba8470 with catch @ 00ba8470
                       catch() { ... } // from try @ 00ba87a8 with catch @ 00ba8470 */
            ...
            if (param_5 == (void *)0x0) {
              while( true ) {
                ...
                *s = *s | 0x80;
                ...
                if (pBVar13 == (BIGNUM *)0x0) goto LAB_00ba8c04;
                iVar7 = BN_is_prime_fasttest_ex(local_f8,0x32,ctx_00,0,param_11);
                if (0 < iVar7) break;
                b = b + 1;
                if (iVar7 != 0) goto LAB_00ba8b24;
              }
            }
            else {
              while( true ) {
                ...
                *s = *s | 0x80;
                ...
                if (iVar7 == 0 && param_5 != (void *)0x0) {
                    /* catch() { ... } // from try @ 00ba8930 with catch @ 00ba8a70 */
            ...
            do {
              ...
              if (-1 < iVar4) {
                if (iVar16 < 0) {
                  ...
                  iVar8 = -1;
                  do {
                    /* try { // try from 00ba8798 to 00ca87a7 has its CatchHandler @ 00ba8840 */
                    iVar10 = EVP_Digest(local_b0,__n,local_a0,(uint *)0x0,param_4,(ENGINE *)0x0);
                    /* try { // try from 00ba87a8 to 00ca885b has its CatchHandler @ 00ba8470 */
                    if ((((iVar10 == 0) ||
                         (pBVar13 = BN_bin2bn(local_a0,iVar5,pBVar11), pBVar13 == (BIGNUM *)0x0)) ||
                        (iVar10 = BN_lshift(pBVar11,pBVar11,iVar9), iVar10 == 0)) ||
                       (iVar10 = BN_add(pBVar12,pBVar12,pBVar11), iVar10 == 0)) goto LAB_00ba8a84;
                    iVar8 = iVar8 + 1;
                    iVar9 = iVar9 + iVar3;
                  } while (iVar8 < iVar4);
                }
...
LAB_00ba86f4:
              ...
              iVar8 = BN_mask_bits(pBVar12,iVar6);
                    /* catch() { ... } // from try @ 00ba8798 with catch @ 00ba8840 */
              ...
              if ((iVar8 == 0) || (iVar8 = BN_sub(r_01,a,pBVar11), iVar8 == 0)) goto LAB_00ba8c04;
                    /* try { // try from 00ba88ac to 00ca892f has its CatchHandler @ 00ba88ac
                       catch() { ... } // from try @ 00ba88ac with catch @ 00ba88ac
                       catch() { ... } // from try @ 00ba8944 with catch @ 00ba88ac */
              iVar8 = BN_cmp(r_01,r_00);
              if (-1 < iVar8) {
                iVar8 = BN_is_prime_fasttest_ex(r_01,0x32,ctx_00,1,param_11);
                if (0 < iVar8) {
                  iVar6 = BN_GENCB_call(param_11,2,1);
                  if (iVar6 == 0) goto LAB_00ba8c04;
                  goto LAB_00ba8390;
                }
                if (iVar8 != 0) goto LAB_00ba8c04;
              }
              iVar7 = iVar7 + 1;
        ...
        if ((iVar6 != 0) && (iVar6 = BN_div(pBVar11,(BIGNUM *)0x0,r_00,local_f8,ctx_00), iVar6 != 0)
          ...
          if (param_7 < 0) {
            ...
            uVar18 = 1;
                    ...
                    /* try { // try from 00ba8930 to 00ca8943 has its CatchHandler @ 00ba8a70 */
          iVar6 = BN_MONT_CTX_set(mont,r_01,ctx_00);
          if (iVar6 != 0) {
            if (param_7 < 0) {
              iVar5 = BN_mod_exp_mont(r,r_00,pBVar11,r_01,ctx_00,mont);
              if (iVar5 == 0) goto LAB_00ba8c04;
              do {
                iVar5 = BN_is_one(r);
                if (iVar5 == 0) goto LAB_00ba8b50;
                if (param_7 < 0) {
                  pBVar12 = BN_value_one();
              ...
              do {
                ...
                if ((((iVar6 == 0) || (iVar6 = EVP_DigestUpdate(ctx,local_c0,__n), iVar6 == 0)) ||
                    (iVar6 = EVP_DigestUpdate(ctx,&DAT_013f470b,4), iVar6 == 0)) ||
                   (iVar6 = EVP_DigestUpdate(ctx,local_a0,3), iVar6 == 0)) goto LAB_00ba8c04;
                iVar6 = EVP_DigestFinal_ex(ctx,local_a0,(uint *)0x0);
                if (iVar6 == 0) goto LAB_00ba8a84;
                pBVar12 = BN_bin2bn(local_a0,iVar5,r_00);
                if ((pBVar12 == (BIGNUM *)0x0) ||
                   (iVar6 = BN_mod_exp_mont(r,r_00,pBVar11,r_01,ctx_00,mont), iVar6 == 0))
                goto LAB_00ba8c04;
                iVar6 = BN_is_one(r);
                if (iVar6 == 0) goto LAB_00ba8b50;
                if (param_7 < 0) {
                  pBVar12 = BN_value_one();
