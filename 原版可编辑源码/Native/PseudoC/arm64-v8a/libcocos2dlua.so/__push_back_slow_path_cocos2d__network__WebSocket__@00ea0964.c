...
/* void std::__ndk1::vector<cocos2d::network::WebSocket*,
   std::__ndk1::allocator<cocos2d::network::WebSocket*>
   >::__push_back_slow_path<cocos2d::network::WebSocket*>(cocos2d::network::WebSocket*&&) */

void __thiscall
std::__ndk1::
vector<cocos2d::network::WebSocket*,std::__ndk1::allocator<cocos2d::network::WebSocket*>>::
__push_back_slow_path<cocos2d::network::WebSocket*>
          (vector<cocos2d::network::WebSocket*,std::__ndk1::allocator<cocos2d::network::WebSocket*>>
           *this,WebSocket **param_1)
