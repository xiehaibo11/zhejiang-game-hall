...
/* cocos2d::experimental::AudioEngine::pause(int) */

void cocos2d::experimental::AudioEngine::pause(int param_1)
      ...
      do {
        ...
        if (uVar5 == uVar2) {
          if ((int)plVar4[2] == param_1) {
            if (*(int *)((long)plVar4 + 0x34) != 1) {
              return;
            }
            AudioEngineImpl::pause(_audioEngineImpl,param_1);
            *(undefined4 *)((long)plVar4 + 0x34) = 2;
            return;
          }
        }
        else {
