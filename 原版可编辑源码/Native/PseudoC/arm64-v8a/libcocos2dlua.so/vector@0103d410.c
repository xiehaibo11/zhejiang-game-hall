...
/* std::__ndk1::vector<ClipperLib::IntPoint, std::__ndk1::allocator<ClipperLib::IntPoint>
   >::vector(std::__ndk1::vector<ClipperLib::IntPoint, std::__ndk1::allocator<ClipperLib::IntPoint>
   > const&) */

void __thiscall
std::__ndk1::vector<ClipperLib::IntPoint,std::__ndk1::allocator<ClipperLib::IntPoint>>::vector
