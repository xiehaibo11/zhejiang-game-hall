...
/* void ccvector_to_luaval<cocostudio::timeline::Frame*>(lua_State*,
   cocos2d::Vector<cocostudio::timeline::Frame*> const&) */

void ccvector_to_luaval<cocostudio::timeline::Frame*>(lua_State *param_1,Vector *param_2)
