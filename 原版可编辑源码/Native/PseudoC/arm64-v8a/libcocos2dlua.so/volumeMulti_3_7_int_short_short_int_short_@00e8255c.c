...
/* void cocos2d::experimental::volumeMulti<3, 7, int, short, short, int, short>(int*, unsigned long,
   short const*, int*, short const*, short) */

void cocos2d::experimental::volumeMulti<3,7,int,short,short,int,short>
