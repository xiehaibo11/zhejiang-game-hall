...
/* cocos2d::PhysicsJointSpring::setRestLength(float) */

void __thiscall cocos2d::PhysicsJointSpring::setRestLength(PhysicsJointSpring *this,float param_1)

{
  ...
  long local_38;
                    ...
                    /* try { // try from 01004dc4 to 01104fab has its CatchHandler @ 01004ccc */
  lVar1 = tpidr_el0;
  local_38 = *(long *)(lVar1 + 0x28);
  if (this[100] == (PhysicsJointSpring)0x0) {
    cpDampedSpringSetRestLength(**(undefined8 **)(this + 8));
  }
  else {
    lVar2 = *(long *)(this + 0x50);
    *(undefined1 *)(lVar2 + 0x48) = 1;
    *(float *)(lVar2 + 0x4c) = param_1;
    local_70 = &PTR_FUN_01725798;
    ...
    if (lVar2 == *(long *)(this + 0x30)) {
      ...
      *(long *)(lVar2 + 0x20) = lVar2;
      local_50 = (long *)&local_70;
      FUN_01007b80(FUN_01007b80,&local_70,lVar2);
    ...
    if (&local_70 == (undefined ***)local_50) {
      ...
      if (local_50 == (long *)0x0) goto LAB_01004dec;
