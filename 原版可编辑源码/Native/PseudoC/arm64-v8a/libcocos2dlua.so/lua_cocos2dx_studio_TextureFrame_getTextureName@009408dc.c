...
/* lua_cocos2dx_studio_TextureFrame_getTextureName(lua_State*) */

void lua_cocos2dx_studio_TextureFrame_getTextureName(lua_State *param_1)

{
  ...
  if (iVar4 + -1 == 0) {
    ...
    basic_string(local_50,(basic_string *)(lVar5 + 0x60));
    ...
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "ccs.TextureFrame:getTextureName",iVar4 + -1,0);
    uVar6 = 0;
  }
