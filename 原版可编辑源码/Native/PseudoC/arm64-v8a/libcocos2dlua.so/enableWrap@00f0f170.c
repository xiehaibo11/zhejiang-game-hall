...
/* cocos2d::Label::enableWrap(bool) */

void __thiscall cocos2d::Label::enableWrap(Label *this,bool param_1)

{
  ...
  if (((Label)param_1 != this[0x678]) && (*(int *)(this + 0x684) != 3)) {
    iVar1 = *(int *)(this + 0x308);
    this[0x678] = (Label)param_1;
    if (iVar1 == 0) {
