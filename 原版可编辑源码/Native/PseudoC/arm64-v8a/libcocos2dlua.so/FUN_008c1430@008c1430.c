...
undefined8 FUN_008c1430(undefined8 param_1)

{
  ...
  if ((((iVar2 == 0) || (iVar2 = tolua_isnumber(param_1,2,0,auStack_58), iVar2 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glFramebufferRenderbuffer\'.",auStack_58);
  }
  else {
    ...
    glFramebufferRenderbuffer((int)dVar3,(int)dVar4,(int)dVar5,(int)dVar6);
  }
