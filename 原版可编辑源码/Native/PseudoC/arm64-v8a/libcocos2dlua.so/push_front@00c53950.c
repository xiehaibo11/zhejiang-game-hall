...
/* std::__ndk1::__split_buffer<cocostudio::DataReaderHelper::_DataInfo**,
   std::__ndk1::allocator<cocostudio::DataReaderHelper::_DataInfo**>&>::push_front(cocostudio::DataReaderHelper::_DataInfo**
   const&) */
