...
/* cocos2d::Animate3D::setKeyFrameUserInfo(int,
...
void __thiscall
cocos2d::Animate3D::setKeyFrameUserInfo(Animate3D *this,int param_1,unordered_map *param_2)

{
  ...
  lVar2 = std::__ndk1::
          ...
          __emplace_unique_key_args<int,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<int_const&>,std::__ndk1::tuple<>>
                    ((int *)(this + 0xf0),(piecewise_construct_t *)local_3c,(tuple *)&DAT_0141889a,
                     (tuple *)&local_30);
