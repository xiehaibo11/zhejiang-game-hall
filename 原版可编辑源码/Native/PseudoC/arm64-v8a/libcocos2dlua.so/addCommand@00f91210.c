...
/* cocos2d::Console::addCommand(cocos2d::Console::Command const&) */

void __thiscall cocos2d::Console::addCommand(Console *this,Command *param_1)

{
  ...
  *this_00;
  ...
  this_01 = operator_new(0x90,(nothrow_t *)&std::nothrow);
  if (this_01 != (Command *)0x0) {
    Command::Command(this_01,param_1);
  }
