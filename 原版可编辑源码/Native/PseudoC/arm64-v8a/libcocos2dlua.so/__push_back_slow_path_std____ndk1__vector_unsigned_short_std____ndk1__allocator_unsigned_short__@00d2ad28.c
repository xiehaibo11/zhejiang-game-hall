...
/* void std::__ndk1::vector<std::__ndk1::vector<unsigned short, std::__ndk1::allocator<unsigned
   ...
   short, std::__ndk1::allocator<unsigned short> > const&>(std::__ndk1::vector<unsigned short,
...
LAB_00d2adb4:
  this_00 = (vector<unsigned_short,std::__ndk1::allocator<unsigned_short>> *)
            ((long)pvVar5 + lVar6 * 8);
  vector<unsigned_short,std::__ndk1::allocator<unsigned_short>>::vector(this_00,param_1);
  ...
  *(vector<unsigned_short,std::__ndk1::allocator<unsigned_short>> **)this = this_00;
  *(vector<unsigned_short,std::__ndk1::allocator<unsigned_short>> **)(this + 8) = pvVar2;
