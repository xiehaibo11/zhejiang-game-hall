...
/* cocos2d::EventDispatcher::resumeEventListenersForTarget(cocos2d::Node*, bool) */

void __thiscall
cocos2d::EventDispatcher::resumeEventListenersForTarget
...

{
  ...
  if (uVar5 != 0) {
      ...
      if (uVar5 <= uVar8) {
        ...
        if (uVar5 != 0) {
          uVar9 = uVar8 / uVar5;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00f9e22c with catch @ 00f9e1f8
                       catch(type#1 @ 00000000) { ... } // from try @ 00f9e320 with catch @ 00f9e1f8
                        */
    ...
    if ((plVar10 != (long *)0x0) && (plVar10 = (long *)*plVar10, plVar10 != (long *)0x0)) {
                    /* try { // try from 00f9e220 to 0109e22b has its CatchHandler @ 00f9e414 */
      do {
        uVar12 = plVar10[1];
        if (uVar12 == uVar8) {
                    /* try { // try from 00f9e22c to 0109e2cb has its CatchHandler @ 00f9e1f8 */
          if ((Node *)plVar10[2] == param_1) {
            ...
            if (plVar6 != plVar10) {
              ...
              do {
                plVar11 = plVar6 + 1;
                    /* try { // try from 00f9e2cc to 0109e31f has its CatchHandler @ 00f9e41c */
                *(undefined1 *)(*plVar6 + 0x90) = 0;
                plVar6 = plVar11;
  ...
  for (plVar10 = *(long **)(this + 0xf0); plVar10 != plVar6; plVar10 = plVar10 + 1) {
    if (*(Node **)(*plVar10 + 0x88) == param_1) {
      *(undefined1 *)(*plVar10 + 0x90) = 0;
    }
  }
  setDirtyForNode(this,param_1);
  if (param_2) {
                    /* try { // try from 00f9e320 to 0109e483 has its CatchHandler @ 00f9e1f8 */
    ...
    for (puVar13 = (undefined8 *)*plVar10; puVar13 != puVar3; puVar13 = puVar13 + 1) {
      resumeEventListenersForTarget(this,(Node *)*puVar13,true);
    }
  }
  return;
}
