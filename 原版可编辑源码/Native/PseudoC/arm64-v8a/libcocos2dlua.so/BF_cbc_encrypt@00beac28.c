...

{
  ...
  uVar2 = (*(uint *)ivec & 0xff00ff00) >> 8 | (*(uint *)ivec & 0xff00ff) << 8;
  local_68 = uVar2 >> 0x10 | uVar2 << 0x10;
  uVar2 = (*(uint *)(ivec + 4) & 0xff00ff00) >> 8 | (*(uint *)(ivec + 4) & 0xff00ff) << 8;
  ...
  ivec[3] = (uchar)uVar12;
  *ivec = (uchar)(uVar12 >> 0x18);
  ivec[1] = (uchar)(uVar12 >> 0x10);
  ivec[2] = (uchar)(uVar12 >> 8);
  ivec[4] = (uchar)(uVar10 >> 0x18);
  ivec[5] = (uchar)(uVar10 >> 0x10);
  ivec[6] = (uchar)(uVar10 >> 8);
  ivec[7] = (uchar)uVar10;
  return;
}
