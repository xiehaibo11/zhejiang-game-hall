...

{
  ...
  *(uint *)(param_2 + 1) = uVar1 ^ *(uint *)(param_2 + 1);
                    /* try { // try from 00b0ab44 to 00c0ab93 has its CatchHandler @ 00b0aa34 */
  *(uint *)(param_3 + 1) = uVar1 ^ *(uint *)(param_3 + 1);
  ...
  case 3:
    puVar4 = (ulong *)*param_2;
    puVar6 = (ulong *)*param_3;
                    /* try { // try from 00b0ac48 to 00c0ac8b has its CatchHandler @ 00b0ab94 */
    goto LAB_00b0ad68;
  case 4:
    puVar4 = (ulong *)*param_2;
    puVar6 = (ulong *)*param_3;
  ...
  case 7:
    puVar4 = (ulong *)*param_2;
    puVar6 = (ulong *)*param_3;
                    /* catch() { ... } // from try @ 00b0ac08 with catch @ 00b0ac78 */
    goto LAB_00b0acd8;
  case 8:
    puVar4 = (ulong *)*param_2;
    puVar6 = (ulong *)*param_3;
  ...
  default:
    if (10 < (int)param_4) {
      lVar7 = *param_2;
                    /* catch() { ... } // from try @ 00b0ab10 with catch @ 00b0ab80 */
      lVar5 = *param_3;
      uVar3 = (ulong)param_4;
      if (uVar3 - 10 < 2) {
LAB_00b0abc4:
        lVar8 = 10;
                    ...
                    /* try { // try from 00b0ab94 to 00c0ac07 has its CatchHandler @ 00b0ab94
                       catch() { ... } // from try @ 00b0ab94 with catch @ 00b0ab94
                       catch() { ... } // from try @ 00b0ac48 with catch @ 00b0ab94 */
        lVar9 = (uVar3 - 10) - (ulong)(param_4 & 1);
        if (lVar9 == 0) goto LAB_00b0abc4;
        if (((undefined8 *)(lVar7 + 0x50U) < (undefined8 *)(lVar5 + uVar3 * 8)) &&
           ((undefined8 *)(lVar5 + 0x50U) < (undefined8 *)(lVar7 + uVar3 * 8))) goto LAB_00b0abc4;
        lVar8 = lVar9 + 10;
        ...
        if ((param_4 & 1) == 0) goto switchD_00b0ab64_caseD_a;
      }
      lVar9 = uVar3 - lVar8;
  ...
  case 10:
switchD_00b0ab64_caseD_a:
    puVar4 = (ulong *)*param_2;
                    /* try { // try from 00b0ac08 to 00c0ac47 has its CatchHandler @ 00b0ac78 */
    puVar6 = (ulong *)*param_3;
...
LAB_00b0adb0:
  uVar2 = (*puVar6 ^ *puVar4) & uVar2;
                    /* try { // try from 00b0adc0 to 00c0ae13 has its CatchHandler @ 00b0adc0
                       catch() { ... } // from try @ 00b0adc0 with catch @ 00b0adc0
                       catch() { ... } // from try @ 00b0ae24 with catch @ 00b0adc0
                       catch() { ... } // from try @ 00b0ae7c with catch @ 00b0adc0 */
  *puVar4 = uVar2 ^ *puVar4;
  *puVar6 = *puVar6 ^ uVar2;
  return;
}
