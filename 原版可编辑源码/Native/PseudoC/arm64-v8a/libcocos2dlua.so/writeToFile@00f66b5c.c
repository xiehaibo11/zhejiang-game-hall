...
/* cocos2d::FileUtils::writeToFile(std::__ndk1::unordered_map<std::__ndk1::basic_string<char,
...
void cocos2d::FileUtils::writeToFile(unordered_map *param_1,basic_string *param_2)

{
                    /* WARNING: Could not recover jumptable at 0x00f66b64. Too many branches */
