...

{
  ...
  if ((DAT_01784a28 == 0) &&
     (DAT_01784a28 = OPENSSL_LH_new(&LAB_00b486c4,&LAB_00b48828), DAT_01784a28 == 0)) {
    return 0;
  }
  ptr = OBJ_dup(obj);
  ...
  if (ptr_00 == (undefined4 *)0x0) {
    ...
    if (ptr->sn == (char *)0x0) {
      ...
      if (puStack_58 == (undefined4 *)0x0) goto LAB_00b472e4;
      ppcVar2 = ptr->ln;
    }
    if ((ppcVar2 == (char **)0x0) ||
      ...
      if (ptr_01 != (undefined4 *)0x0) {
        ...
        *(ASN1_OBJECT **)(ptr_01 + 2) = ptr;
        pvVar1 = (void *)OPENSSL_LH_insert(DAT_01784a28,ptr_01);
        CRYPTO_free(pvVar1);
      }
      if (puStack_58 != (undefined4 *)0x0) {
        *puStack_58 = 1;
        *(ASN1_OBJECT **)(puStack_58 + 2) = ptr;
        pvVar1 = (void *)OPENSSL_LH_insert(DAT_01784a28);
        CRYPTO_free(pvVar1);
      }
