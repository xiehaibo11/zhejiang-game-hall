...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<cocos2d::Node*, int>,
   ...
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<cocos2d::Node*, int> > >::__rehash(unsigned
   long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<cocos2d::Node*,int>,std::__ndk1::__unordered_map_hasher<cocos2d::Node*,std::__ndk1::__hash_value_type<cocos2d::Node*,int>,std::__ndk1::hash<cocos2d::Node*>,true>,std::__ndk1::__unordered_map_equal<cocos2d::Node*,std::__ndk1::__hash_value_type<cocos2d::Node*,int>,std::__ndk1::equal_to<cocos2d::Node*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<cocos2d::Node*,int>>>
           *this,ulong param_1)
        ...
        do {
          ...
          if ((uVar12 & 0xffffffff) < 2) {
            ...
            uVar7 = uVar7 - uVar1 * param_1;
                    ...
                    /* catch() { ... } // from try @ 00fa3100 with catch @ 00fa2ffc
                       catch() { ... } // from try @ 00fa3150 with catch @ 00fa2ffc */
          if (uVar7 != uVar4) {
            plVar9 = plVar6;
