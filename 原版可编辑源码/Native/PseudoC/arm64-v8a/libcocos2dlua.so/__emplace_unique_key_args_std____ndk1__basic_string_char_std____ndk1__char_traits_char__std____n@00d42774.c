...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   cocos2d::Sprite3DCache::Sprite3DData*>, void*>*>, bool>
  ...
  if (uVar16 != 0) {
    ...
    if ((puVar9 != (undefined8 *)0x0) && (plVar15 = (long *)*puVar9, plVar15 != (long *)0x0)) {
      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if (uVar13 < 2) {
                    /* catch() { ... } // from try @ 00d428d8 with catch @ 00d4288c */
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00d42898;
            break;
          }
...
LAB_00d42898:
        ...
        if (sVar1 == __n) {
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              uVar10 = 0;
                    /* try { // try from 00d428d4 to 00e428d7 has its CatchHandler @ 00d42968 */
                    /* try { // try from 00d428d8 to 00e42983 has its CatchHandler @ 00d4288c */
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00d42908;
              }
              goto LAB_00d42850;
            }
          }
  ...
  *plVar15 = 0;
  ...
  if ((uVar16 == 0) ||
    ...
    if ((uVar16 & uVar16 - 1) == 0) {
      ...
      unaff_x27 = uVar7;
      if (uVar16 <= uVar7) {
                    /* try { // try from 00d429b4 to 00e429b7 has its CatchHandler @ 00d42a00 */
        uVar13 = 0;
        if (uVar16 != 0) {
          uVar13 = uVar7 / uVar16;
        }
                    /* try { // try from 00d429b8 to 00e42a1b has its CatchHandler @ 00d42984 */
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar12;
    if (*plVar15 == 0) goto LAB_00d42a24;
    uVar7 = *(ulong *)(*plVar15 + 8);
    if ((uVar16 & uVar16 - 1) == 0) {
      uVar7 = uVar7 & uVar16 - 1;
    }
    else {
                    /* catch() { ... } // from try @ 00d429b4 with catch @ 00d42a00 */
      if (uVar16 <= uVar7) {
        uVar13 = 0;
        if (uVar16 != 0) {
          uVar13 = uVar7 / uVar16;
        ...
        uVar7 = uVar7 - uVar13 * uVar16;
                    ...
                    /* catch() { ... } // from try @ 00d42a58 with catch @ 00d42a1c */
...
LAB_00d42a34:
  if (*(long *)(lVar5 + 0x28) != local_68) {
    ...
    __stack_chk_fail(__s1,uVar8);
                    ...
                    /* try { // try from 00d42a50 to 00e42a57 has its CatchHandler @ 00d42b08 */
                    /* try { // try from 00d42a58 to 00e42b23 has its CatchHandler @ 00d42a1c */
  return plVar15;
}
