...
void FUN_00d505ec(long *param_1,long *param_2)
  ...
  if (param_2 != param_1) {
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
                    /* catch() { ... } // from try @ 00d505d4 with catch @ 00d506b4 */
        (**(code **)(*plVar2 + 0x18))(plVar2,local_60);
        (**(code **)(*(long *)param_1[4] + 0x20))();
        param_1[4] = 0;
                    /* catch() { ... } // from try @ 00d50728 with catch @ 00d506d0
                       catch() { ... } // from try @ 00d508c0 with catch @ 00d506d0 */
        ...
        param_1[4] = param_2[4];
                    ...
                    /* try { // try from 00d50720 to 00e50727 has its CatchHandler @ 00d5091c */
      ...
      if (param_2 == plVar3) {
        ...
        param_2[4] = (long)plVar2;
                    ...
                    /* try { // try from 00d50728 to 00e5077f has its CatchHandler @ 00d506d0 */
