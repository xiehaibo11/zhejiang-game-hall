...
/* cocostudio::ArmatureDataManager::addSpriteFrameFromFile(std::__ndk1::basic_string<char,
...
cocostudio::ArmatureDataManager::addSpriteFrameFromFile
          (ArmatureDataManager *this,basic_string *param_1,basic_string *param_2,
...

{
  ...
  long lVar1;
  long lVar2;
  SpriteFrameCacheHelper *this_01;
  ...
  if (this_00 ==
    ...
    *(basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> **)
     (lVar2 + 0x30) = this_00 + 0x18;
  }
  this_01 = (SpriteFrameCacheHelper *)SpriteFrameCacheHelper::getInstance();
  SpriteFrameCacheHelper::addSpriteFrameFromFile(this_01,param_1,param_2);
