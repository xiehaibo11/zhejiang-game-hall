...
/* void std::__ndk1::vector<char const*, std::__ndk1::allocator<char const*>
   >::__push_back_slow_path<char const* const&>(char const* const&) */

void __thiscall
std::__ndk1::vector<char_const*,std::__ndk1::allocator<char_const*>>::
__push_back_slow_path<char_const*const&>
          (vector<char_const*,std::__ndk1::allocator<char_const*>> *this,char **param_1)
