...

{
  ...
  EVP_MD *pEVar5;
                    ...
                    /* try { // try from 00ba04e8 to 00ca04fb has its CatchHandler @ 00ba09e8 */
  ...
  if ((pEVar4 == (EVP_CIPHER *)0x0) ||
    ...
    pEVar5 = EVP_get_digestbyname(pcVar3);
                    /* try { // try from 00ba0520 to 00ca0527 has its CatchHandler @ 00ba09ac */
      ...
      if ((pEVar5 == (EVP_MD *)0x0) ||
        ...
        if ((pEVar5 == (EVP_MD *)0x0) ||
          ...
          if ((pEVar4 == (EVP_CIPHER *)0x0) ||
            ...
            pEVar4 = EVP_get_cipherbyname(pcVar3);
                    /* try { // try from 00ba05a8 to 00ca0617 has its CatchHandler @ 00ba0a34 */
            if ((pEVar4 == (EVP_CIPHER *)0x0) ||
              ...
              if ((pEVar4 == (EVP_CIPHER *)0x0) ||
                ...
                if ((pEVar4 == (EVP_CIPHER *)0x0) ||
                  ...
                  pEVar4 = EVP_get_cipherbyname(pcVar3);
                    /* try { // try from 00ba061c to 00ca0653 has its CatchHandler @ 00ba0a38 */
                  if ((pEVar4 == (EVP_CIPHER *)0x0) ||
                    ...
                    /* try { // try from 00ba0684 to 00ca06b3 has its CatchHandler @ 00ba0aec */
