...
undefined8 FUN_00b307fc(long param_1,long param_2,void *param_3,undefined4 param_4)

{
  ...
  if (param_2 != 0 || param_3 != (void *)0x0) {
    ...
    *(undefined8 *)(lVar2 + 0xb8) = 0xffffffffffffffff;
    if (param_3 == (void *)0x0) {
      FUN_00b30410(param_1,param_2,0,param_4);
    }
    else {
      local_40 = 0;
      uStack_38 = 0;
      ...
      FUN_00b30410(param_1,param_2,&local_40,param_4);
