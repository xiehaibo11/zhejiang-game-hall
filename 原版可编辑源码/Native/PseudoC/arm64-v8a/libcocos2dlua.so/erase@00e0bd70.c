...
/* cocos2d::Map<int, cocos2d::ui::Scale9Sprite*>::erase(int const&) */

void __thiscall
cocos2d::Map<int,cocos2d::ui::Scale9Sprite*>::erase
          (Map<int,cocos2d::ui::Scale9Sprite*> *this,int *param_1)

{
  ...
  ulong uVar11;
                    ...
                    /* try { // try from 00e0bd70 to 00f0bd77 has its CatchHandler @ 00e0be80 */
                    /* try { // try from 00e0bd78 to 00f0be93 has its CatchHandler @ 00e0bc04 */
  lVar2 = tpidr_el0;
        ...
        if (uVar9 == uVar6) {
          if ((int)plVar8[2] == *param_1) {
            Ref::release((Ref *)plVar8[3]);
                    /* catch() { ... } // from try @ 00e0bd70 with catch @ 00e0be80 */
            std::__ndk1::
