...
/* cocostudio::WidgetPropertiesReader0250::setPropsForScrollViewFromJsonDictionary(cocos2d::ui::Widget*,
   rapidjson::GenericValue<rapidjson::UTF8<char>,
   rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator> > const&) */

void __thiscall
cocostudio::WidgetPropertiesReader0250::setPropsForScrollViewFromJsonDictionary
...

{
  ...
  fVar4 = (float)DictionaryHelper::getFloatValue_json(pDVar3,param_2,"innerWidth",0.0);
  pDVar3 = (DictionaryHelper *)DictionaryHelper::getInstance();
  fVar5 = (float)DictionaryHelper::getFloatValue_json(pDVar3,param_2,"innerHeight",0.0);
  cocos2d::Size::Size(aSStack_50,fVar4,fVar5);
  cocos2d::ui::ScrollView::setInnerContainerSize((ScrollView *)param_1,aSStack_50);
  pDVar3 = (DictionaryHelper *)DictionaryHelper::getInstance();
  fVar4 = (float)DictionaryHelper::getFloatValue_json(pDVar3,param_2,"direction",0.0);
