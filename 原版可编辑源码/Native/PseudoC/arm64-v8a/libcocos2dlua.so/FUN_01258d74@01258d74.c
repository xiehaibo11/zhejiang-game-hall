...
undefined8 * FUN_01258d74(long *param_1,long *param_2,undefined1 *param_3)

{
  ...
  if ((*(char *)(*param_2 + 8) == '$') && (iVar4 = *(int *)(*param_2 + 0xc), iVar4 - 2U < 4)) {
    ...
    if (0xfef < lVar7 + 0x10U) {
      ...
      if (puVar6 == (void *)0x0) goto LAB_01258fe0;
      lVar7 = 0;
      *puVar6 = pvVar11;
      puVar6[1] = 0;
    ...
    if (pbVar1 != pbVar3) {
      ...
      if ((pbVar3 != pbVar1) && (uVar10 = (uint)*pbVar1, uVar10 - 0x31 < 5)) {
        *param_1 = (long)(pbVar1 + 1);
        ...
        if ((bVar5 == 0x49) && (lVar7 = FUN_01256e6c(param_1,param_3), lVar7 == 0)) {
          return (undefined8 *)0x0;
        }
        pvVar11 = (void *)param_1[0x25c];
        lVar7 = *(long *)((long)pvVar11 + 8);
