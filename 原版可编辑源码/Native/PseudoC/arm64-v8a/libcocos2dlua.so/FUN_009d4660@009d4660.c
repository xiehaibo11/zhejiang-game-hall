...
undefined8 FUN_009d4660(lua_State *param_1)

{
  ...
  if (iVar2 + -1 == 1) {
    ...
    cocos2d::experimental::ui::WebView::setOnDidFinishLoading(this,(function *)&local_80);
    if (&local_80 == (undefined ***)local_60) {
      pcVar4 = *(code **)(*local_60 + 0x20);
    }
    else {
      if (local_60 == (long *)0x0) goto LAB_009d4744;
    ...
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d\n ",
               "ccexp.WebView:setOnDidFinishLoading",iVar2 + -1,1);
  }
LAB_009d4744:
