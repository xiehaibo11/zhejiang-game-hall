...

{
  ...
  int local_80 [8];
                    ...
                    /* catch() { ... } // from try @ 01106ec0 with catch @ 01106e28 */
  ...
  while( true ) {
    do {
      ...
      lVar16 = lVar3 + (ulong)(uint)bVar5 * -4;
                    /* try { // try from 01106eb8 to 01206ebf has its CatchHandler @ 01106f78 */
      lVar12 = (lVar12 - lVar13) * 0x194c + 0x400;
      lVar13 = (lVar11 + lVar10) * 0x1a9a;
                    /* try { // try from 01106ec0 to 01206f93 has its CatchHandler @ 01106e28 */
  ...
  do {
    piVar4 = (int *)((long)param_1 + lVar12);
                    /* catch() { ... } // from try @ 01106eb8 with catch @ 01106f78 */
    ...
    lVar17 = (lVar13 + lVar16) * 0x220c;
                    /* try { // try from 0110703c to 012070df has its CatchHandler @ 0110703c
                       catch() { ... } // from try @ 0110703c with catch @ 0110703c
                       catch() { ... } // from try @ 01107100 with catch @ 0110703c */
    ...
    *piVar4 = (int)((lVar10 + (int)uVar1 + lVar3) * 0x28f6 + 0x4000U >> 0xf);
    ...
    piVar4[0x38] = (int)((ulong)(lVar13 - lVar18) >> 0xf);
                    ...
                    /* try { // try from 011070e0 to 012070e7 has its CatchHandler @ 0110713c */
  return;
}
