  ...
  *(undefined4 *)(param_1 + 0x88) = 0;
  ...
  case 0x12:
    iVar1 = statem_flush(param_1);
                    /* try { // try from 00ade7d0 to 00bde833 has its CatchHandler @ 00ade7d0
                       catch() { ... } // from try @ 00ade7d0 with catch @ 00ade7d0
                       catch() { ... } // from try @ 00ade848 with catch @ 00ade7d0
                       catch() { ... } // from try @ 00ade89c with catch @ 00ade7d0 */
    if (iVar1 != 1) {
      return 4;
    }
  }
