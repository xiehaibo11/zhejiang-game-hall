...
LAB_00884454:
    ...
    if ((ulong)(lVar1 >> 4) < 0x7ffffffffffffff) {
      uVar2 = lVar1 >> 3;
      if ((uVar6 <= uVar2) && (uVar6 = uVar2, uVar2 >> 0x3c != 0)) goto LAB_00884454;
    }
    else {
    ...
    *(Value **)(this + 0x10) = pVVar4 + uVar6 * 0x10;
    for (; param_1 != param_2; param_1 = param_1 + 0x10) {
      cocos2d::Value::Value(pVVar4,param_1);
      pVVar4 = pVVar4 + 0x10;
    }
  }
  else {
    ...
    if (uVar2 < uVar6) {
      ...
      while (pVVar5 != param_2) {
        cocos2d::Value::Value(pVVar4,pVVar3);
        pVVar4 = pVVar4 + 0x10;
        pVVar3 = pVVar3 + 0x10;
        pVVar5 = pVVar3;
      }
