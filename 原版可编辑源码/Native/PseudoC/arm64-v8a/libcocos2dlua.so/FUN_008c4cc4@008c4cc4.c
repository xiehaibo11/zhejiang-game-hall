...
undefined8 FUN_008c4cc4(undefined8 param_1)

{
  ...
  iVar3 = tolua_isnumber(param_1,1,0,auStack_78);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 008c4d9c with catch @ 008c4d44
                       catch(type#1 @ 00000000) { ... } // from try @ 008c4f74 with catch @ 008c4d44
                        */
  if ((((iVar3 == 0) || (iVar3 = tolua_isnumber(param_1,2,0,auStack_78), iVar3 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glUniform1fv\'.",auStack_78);
  }
  else {
    dVar7 = (double)tolua_tonumber(0,param_1,1);
    dVar8 = (double)tolua_tonumber(0,param_1,2);
                    /* try { // try from 008c4d94 to 009c4d9b has its CatchHandler @ 008c5088 */
    dVar9 = (double)tolua_tonumber(0,param_1,3);
                    /* try { // try from 008c4d9c to 009c4f6b has its CatchHandler @ 008c4d44 */
    uVar6 = (uint)dVar9;
    ...
    if (pvVar4 != (void *)0x0) {
      ...
      glUniform1iv((int)dVar7,(int)dVar8,pvVar4);
