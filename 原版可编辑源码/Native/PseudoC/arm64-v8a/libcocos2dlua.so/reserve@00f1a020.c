...
/* std::__ndk1::vector<cocos2d::Layer*, std::__ndk1::allocator<cocos2d::Layer*> >::reserve(unsigned
   long) */

void __thiscall
std::__ndk1::vector<cocos2d::Layer*,std::__ndk1::allocator<cocos2d::Layer*>>::reserve
          (vector<cocos2d::Layer*,std::__ndk1::allocator<cocos2d::Layer*>> *this,ulong param_1)
