...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void
   ...
   cocosbuilder::CCBAnimationManager*> >, void ()>::__clone() const */
...
::__clone(__func<std::__ndk1::__bind<void(cocosbuilder::CCBAnimationManager::*)(),cocosbuilder::CCBAnimationManager*>,std::__ndk1::allocator<std::__ndk1::__bind<void(cocosbuilder::CCBAnimationManager::*)(),cocosbuilder::CCBAnimationManager*>>,void()>
          *this)
