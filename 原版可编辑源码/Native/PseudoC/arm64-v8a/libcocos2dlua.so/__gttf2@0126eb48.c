...
undefined4 __gttf2(undefined1 param_1 [16],undefined1 param_2 [16])

{
  ...
  if (uVar8 == 0x7fff) {
    if (uVar4 != 0 || uVar10 != 0) goto LAB_0126ec54;
    bVar6 = false;
    if (uVar9 == 0x7fff) goto LAB_0126eba4;
  }
  else {
    if (uVar9 == 0x7fff) {
LAB_0126eba4:
...
LAB_0126ec20:
    ...
    if (uVar9 <= uVar8) {
      if ((uVar5 < uVar4) || ((uVar4 == uVar5 && (uVar12 < uVar10)))) goto LAB_0126ec20;
