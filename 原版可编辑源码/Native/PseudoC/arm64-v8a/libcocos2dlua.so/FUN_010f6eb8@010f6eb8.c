...
undefined8 FUN_010f6eb8(long *param_1,long param_2)
  ...
  if (0 < (int)param_1[0x34]) {
    ...
    do {
      ...
      *(int *)(lVar5 + 0x24) = iVar10;
      if (uVar2 == 0) {
        uVar11 = 0;
        if (*(int *)(lVar9 + 0xc0) == 0) goto LAB_010f6f28;
LAB_010f6fc8:
        ...
        *(long *)(lVar5 + uVar8) = *(long *)(lVar5 + uVar8) + 1;
        iVar10 = (int)uVar11;
                    ...
                    /* catch() { ... } // from try @ 010f6de4 with catch @ 010f6f90 */
        iVar10 = -1;
        do {
          iVar6 = iVar10;
          uVar2 = (int)uVar2 >> 1;
        ...
        if (*(int *)(lVar9 + 0xc0) != 0) goto LAB_010f6fc8;
LAB_010f6f28:
        lVar5 = *(long *)(lVar9 + (long)iVar7 * 8 + 0x40);
        iVar10 = (int)uVar11;
        FUN_010f97a4(lVar9,*(undefined4 *)(lVar5 + (long)iVar10 * 4),
                     *(undefined1 *)(lVar5 + iVar10 + 0x400));
      }
      if (iVar10 != 0) {
        FUN_010f97a4(lVar9,uVar1,uVar11);
      }
      lVar12 = lVar12 + 1;
  ...
  *puVar4 = uVar13;
                    /* try { // try from 010f7010 to 011f7027 has its CatchHandler @ 010f7038 */
    ...
    if (*(int *)(lVar9 + 0x38) == 0) {
      ...
      *(uint *)(lVar9 + 0x3c) = *(int *)(lVar9 + 0x3c) + 1U & 7;
      iVar7 = iVar10;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010f7010 with catch @ 010f7038
                        */
