...
/* luaval_to_tex2f(lua_State*, int, cocos2d::Tex2F*, char const*) */

bool luaval_to_tex2f(lua_State *param_1,int param_2,Tex2F *param_3,char *param_4)

{
  ...
  bVar3 = false;
  if ((param_1 != (lua_State *)0x0) && (param_3 != (Tex2F *)0x0)) {
    iVar4 = tolua_istable(param_1,param_2,0,auStack_58);
    bVar3 = iVar4 != 0;
    if (iVar4 != 0) {
      lua_pushstring(param_1,"u");
