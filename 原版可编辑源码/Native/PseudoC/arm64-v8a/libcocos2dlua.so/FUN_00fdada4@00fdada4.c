...

{
  ...
  undefined8 uVar16;
                    ...
                    /* catch() { ... } // from try @ 00fdad34 with catch @ 00fdadac */
...
LAB_00fdaea8:
    do {
      bVar3 = bVar4;
      plVar11 = plVar14;
                    /* catch() { ... } // from try @ 00fdaef4 with catch @ 00fdaeac */
      ...
      bVar4 = bVar3;
      if (uVar6 == param_2) {
                    /* try { // try from 00fdaeec to 010daef3 has its CatchHandler @ 00fdaffc */
        bVar2 = *(byte *)(plVar14 + 2);
                    /* try { // try from 00fdaef4 to 010db017 has its CatchHandler @ 00fdaeac */
        uVar6 = (ulong)(bVar2 >> 1);
        sVar1 = uVar6;
        if ((bVar2 & 1) != 0) {
          sVar1 = plVar14[3];
        ...
        if (sVar1 == __n) {
          ...
          if ((bVar2 & 1) == 0) {
            if (__n != 0) {
              ...
              pbVar10 = __s2;
              do {
                if (*pbVar8 != *pbVar10) goto LAB_00fdaea0;
                uVar6 = uVar6 - 1;
                pbVar8 = pbVar8 + 1;
                pbVar10 = pbVar10 + 1;
              } while (uVar6 != 0);
