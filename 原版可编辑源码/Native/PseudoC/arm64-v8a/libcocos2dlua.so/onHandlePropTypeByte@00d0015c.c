...
/* cocosbuilder::LabelTTFLoader::onHandlePropTypeByte(cocos2d::Node*, cocos2d::Node*, char const*,
   unsigned char, cocosbuilder::CCBReader*) */

void cocosbuilder::LabelTTFLoader::onHandlePropTypeByte
...

{
  ...
  if (iVar1 != 0) {
    ...
    return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00d001e8. Too many branches */
