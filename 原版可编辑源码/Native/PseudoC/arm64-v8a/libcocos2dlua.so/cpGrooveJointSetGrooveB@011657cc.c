...
void cpGrooveJointSetGrooveB(float param_1,float param_2,undefined8 *param_3)

{
  float fVar1;
  
  if ((undefined **)*param_3 == &PTR_FUN_0172d178) {
    *(float *)(param_3 + 0xd) = param_1;
    *(float *)((long)param_3 + 0x6c) = param_2;
    param_1 = param_1 - *(float *)(param_3 + 0xc);
    param_2 = param_2 - *(float *)((long)param_3 + 100);
  ...
  cpMessage("cpConstraintIsGrooveJoint(constraint)",
            ...
            ,0xaf,1,1,"Constraint is not a groove joint.");
