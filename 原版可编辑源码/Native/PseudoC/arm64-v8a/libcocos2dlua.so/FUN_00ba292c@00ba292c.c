...
undefined8 FUN_00ba292c(CONF *param_1,byte *param_2,undefined8 *param_3,byte *param_4)

{
  ...
  if (str != (BUF_MEM *)0x0) {
    ...
    if (iVar4 != 0) {
      uVar20 = 0;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ba29e8 with catch @ 00ba2994
                        */
      bVar3 = 0;
LAB_00ba2a50:
      do {
        ...
        if ((uVar2 >> 10 & 1) != 0) {
          ...
          if ((*(byte *)((long)pvVar10 + uVar19 * 2) >> 3 & 1) == 0) {
            ...
            do {
              ...
              pbVar13 = param_4 + 1;
              uVar19 = (ulong)*pbVar13;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ba29e0 with catch @ 00ba2b5c
                        */
              uVar11 = uVar20;
              pbVar14 = param_4;
...
LAB_00ba2c18:
            ...
            *pbVar17 = bVar12;
            if (__s == (char *)0x0) {
              ...
              iVar5 = BUF_MEM_grow_clean(str,(size_t)(param_4 +
                    ...
                    /* try { // try from 00ba2c5c to 00ca2c63 has its CatchHandler @ 00ba2f30 */
              if (iVar5 != 0) {
                cVar7 = *__s;
                    /* try { // try from 00ba2c64 to 00ca2dbb has its CatchHandler @ 00ba2c0c */
                param_4 = pbVar14;
                if (cVar7 == '\0') {
                  *pbVar17 = bVar12;
                }
              ...
              iVar5 = 0x204;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ba2c64 with catch @ 00ba2c0c
                       catch(type#1 @ 00000000) { ... } // from try @ 00ba2e24 with catch @ 00ba2c0c
                        */
            if (iVar1 == (int)uVar19) {
              pbVar14 = pbVar17 + 1;
              goto LAB_00ba2c18;
        ...
        bVar12 = param_4[1];
        if ((*(byte *)((long)pvVar10 + (ulong)bVar12 * 2) >> 3 & 1) != 0) goto LAB_00ba2cb4;
        uVar9 = (bVar12 - 0x62) * 0x80;
        uVar8 = bVar12 - 0x62 >> 1 & 0x7f;
        if ((uVar9 & 0xff | uVar8) < 10) {
                    /* try { // try from 00ba29e0 to 00ca29e7 has its CatchHandler @ 00ba2b5c */
                    /* try { // try from 00ba29e8 to 00ca2b5f has its CatchHandler @ 00ba2994 */
          bVar16 = 0xd;
