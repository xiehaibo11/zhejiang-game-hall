...
/* cocostudio::timeline::AnchorPointFrame::clone() */

Ref * __thiscall cocostudio::timeline::AnchorPointFrame::clone(AnchorPointFrame *this)

{
  ...
  *(undefined ***)this_00 = &PTR__Frame_016cbc60;
  *(undefined8 *)(this_00 + 0x60) = 0x3f0000003f000000;
  *(undefined8 *)(this_00 + 0x58) = 0;
  cocos2d::Ref::autorelease(this_00);
  *(undefined8 *)(this_00 + 0x60) = *(undefined8 *)(this + 0x60);
