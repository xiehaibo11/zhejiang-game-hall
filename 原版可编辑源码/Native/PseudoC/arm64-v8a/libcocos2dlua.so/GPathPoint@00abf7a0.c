...
/* fairygui::GPathPoint::GPathPoint(cocos2d::Vec3 const&, cocos2d::Vec3 const&) */

void __thiscall fairygui::GPathPoint::GPathPoint(GPathPoint *this,Vec3 *param_1,Vec3 *param_2)
