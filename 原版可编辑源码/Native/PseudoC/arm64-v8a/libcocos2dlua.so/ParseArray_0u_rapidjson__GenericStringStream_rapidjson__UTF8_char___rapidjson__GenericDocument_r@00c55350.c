...

{
  ...
  *(long *)param_1 = *(long *)param_1 + 1;
  ...
  if (puVar2 < puVar12 + 3) {
    ...
    uVar7 = ((long)puVar12 - (long)pvVar9) + 0x18;
    if (uVar7 <= uVar8) {
      uVar7 = uVar8;
    }
    if (uVar7 == 0) {
    ...
    puVar12 = (undefined8 *)((long)pvVar3 + ((long)puVar12 - (long)pvVar9));
    *(void **)(param_2 + 0x38) = pvVar3;
    *(undefined8 **)(param_2 + 0x40) = puVar12;
    *(ulong *)(param_2 + 0x48) = (long)pvVar3 + uVar7;
  }
  *(undefined8 **)(param_2 + 0x40) = puVar12 + 3;
  *puVar12 = 0;
  puVar12[1] = 0;
  puVar12[2] = 0x4000000000000;
  pbVar5 = *(byte **)param_1;
  ...
  if (*(int *)(this + 0x30) == 0) {
    if (*pbVar5 == 0x5d) {
      ...
      *(undefined8 *)(lVar6 + -0x10) = 0;
      ...
      uVar11 = 0;
      while (ParseValue<0u,rapidjson::GenericStringStream<rapidjson::UTF8<char>>,rapidjson::GenericDocument<rapidjson::UTF8<char>,rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator>,rapidjson::CrtAllocator>>
