...
/* void cocos2d::experimental::volumeRampMulti<4, 6, float, short, int, int, int>(float*, unsigned
   long, short const*, int*, int*, int const*, int*, int) */

void cocos2d::experimental::volumeRampMulti<4,6,float,short,int,int,int>
