...
/* void std::__ndk1::vector<cocos2d::_listEntry*, std::__ndk1::allocator<cocos2d::_listEntry*>
   >::__push_back_slow_path<cocos2d::_listEntry* const&>(cocos2d::_listEntry* const&) */
...
__push_back_slow_path<cocos2d::_listEntry*const&>
          (vector<cocos2d::_listEntry*,std::__ndk1::allocator<cocos2d::_listEntry*>> *this,
          _listEntry **param_1)
