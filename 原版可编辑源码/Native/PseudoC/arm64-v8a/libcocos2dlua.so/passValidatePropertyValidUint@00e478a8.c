...
/* cocos2d::PUScriptTranslator::passValidatePropertyValidUint(cocos2d::PUScriptCompiler*,
   cocos2d::PUPropertyAbstractNode*) */

void __thiscall
cocos2d::PUScriptTranslator::passValidatePropertyValidUint
