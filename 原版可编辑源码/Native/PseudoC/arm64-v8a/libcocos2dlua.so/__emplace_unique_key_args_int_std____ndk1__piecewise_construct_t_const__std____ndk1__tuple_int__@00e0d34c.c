...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<int,
   cocos2d::Color3B>, void*>*>, bool> std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int,
   cocos2d::Color3B>, std::__ndk1::__unordered_map_hasher<int, std::__ndk1::__hash_value_type<int,
   cocos2d::Color3B>, std::__ndk1::hash<int>, true>, std::__ndk1::__unordered_map_equal<int,
...

{
  ...
  uVar8 = (ulong)*(int *)param_2;
                    /* catch() { ... } // from try @ 00e0d228 with catch @ 00e0d368 */
  if (uVar7 != 0) {
    ...
    uVar9 = NEON_uaddlv(uVar10,1);
                    /* catch() { ... } // from try @ 00e0d1fc with catch @ 00e0d380 */
    uVar3 = CONCAT62((int6)((ulong)uVar10 >> 0x10),uVar9) & 0xffffffff;
                    /* catch() { ... } // from try @ 00e0d294 with catch @ 00e0d384 */
    if (uVar3 < 2) {
                    /* catch() { ... } // from try @ 00e0d1c8 with catch @ 00e0d3ac
                       catch() { ... } // from try @ 00e0d2f4 with catch @ 00e0d3ac */
      ...
      if (uVar7 <= uVar8) {
        ...
        if (uVar7 != 0) {
          uVar5 = uVar8 / uVar7;
                    ...
                    /* catch() { ... } // from try @ 00e0d190 with catch @ 00e0d39c */
    ...
    if (plVar6 != (long *)0x0) {
      for (plVar6 = (long *)*plVar6; plVar6 != (long *)0x0; plVar6 = (long *)*plVar6) {
        uVar5 = plVar6[1];
                    /* try { // try from 00e0d3f0 to 00f0d50b has its CatchHandler @ 00e0d3f0
                       catch() { ... } // from try @ 00e0d3f0 with catch @ 00e0d3f0
                       catch() { ... } // from try @ 00e0d5ec with catch @ 00e0d3f0
                       catch() { ... } // from try @ 00e0d83c with catch @ 00e0d3f0
                       catch() { ... } // from try @ 00e0da60 with catch @ 00e0d3f0 */
        if (uVar5 != uVar8) {
          if (uVar3 < 2) {
            uVar5 = uVar5 & uVar7 - 1;
          }
            ...
            if (uVar5 - uVar1 * uVar7 == unaff_x24) goto LAB_00e0d3d8;
            break;
          }
...
LAB_00e0d3d8:
  ...
  *(undefined4 *)(plVar6 + 2) = **(undefined4 **)param_4;
  cocos2d::Color3B::Color3B((Color3B *)((long)plVar6 + 0x14));
  *plVar6 = 0;
  plVar6[1] = uVar8;
  if ((uVar7 == 0) || ((float)param_1[8] * (float)uVar7 < (float)(*(long *)(param_1 + 6) + 1))) {
    ...
    rehash((__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::Color3B>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::Color3B>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::Color3B>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::Color3B>>>
            *)param_1,uVar3);
    uVar7 = *(ulong *)(param_1 + 2);
    if ((uVar7 & uVar7 - 1) == 0) {
      unaff_x24 = uVar7 - 1 & uVar8;
  ...
  if (plVar2 == (long *)0x0) {
    ...
    *(long **)(lVar4 + unaff_x24 * 8) = plVar2;
    if (*plVar6 == 0) goto LAB_00e0d534;
    uVar8 = *(ulong *)(*plVar6 + 8);
                    /* try { // try from 00e0d50c to 00f0d59f has its CatchHandler @ 00e0db14 */
    if ((uVar7 & uVar7 - 1) == 0) {
      uVar8 = uVar8 & uVar7 - 1;
    }
    else if (uVar7 <= uVar8) {
