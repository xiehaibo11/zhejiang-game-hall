...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, cocos2d::experimental::PcmData>,
   ...
   std::__ndk1::allocator<char> >, cocos2d::experimental::PcmData>,
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00e6d904;
              goto LAB_00e6d9b4;
            }
            if (uVar9 != uVar14) goto LAB_00e6d9b4;
          }
LAB_00e6d904:
          plVar8 = (long *)*plVar8;
