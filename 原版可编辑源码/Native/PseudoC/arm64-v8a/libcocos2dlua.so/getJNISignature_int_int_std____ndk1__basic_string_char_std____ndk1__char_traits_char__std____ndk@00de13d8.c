...
getJNISignature<int,int,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>
          (undefined8 *param_1_00,undefined8 param_2,undefined4 param_1,basic_string *param_4)

{
  ...
  puVar4 = (undefined8 *)
           ...
           basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::append
                    ...
                    /* try { // try from 00de145c to 00ee145f has its CatchHandler @ 00de1544 */
  uVar6 = puVar4[1];
  uVar5 = *puVar4;
  param_1_00[2] = puVar4[2];
  param_1_00[1] = uVar6;
  *param_1_00 = uVar5;
  puVar4[1] = 0;
  puVar4[2] = 0;
  *puVar4 = 0;
                    /* try { // try from 00de1470 to 00ee1473 has its CatchHandler @ 00de1548 */
  if ((local_68[0] & 1) != 0) {
