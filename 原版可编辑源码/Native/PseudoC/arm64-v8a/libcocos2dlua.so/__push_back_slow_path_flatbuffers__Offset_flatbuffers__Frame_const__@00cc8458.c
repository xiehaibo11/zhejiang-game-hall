...
/* void std::__ndk1::vector<flatbuffers::Offset<flatbuffers::Frame>,
   std::__ndk1::allocator<flatbuffers::Offset<flatbuffers::Frame> >
   >::__push_back_slow_path<flatbuffers::Offset<flatbuffers::Frame>
   const&>(flatbuffers::Offset<flatbuffers::Frame> const&) */
