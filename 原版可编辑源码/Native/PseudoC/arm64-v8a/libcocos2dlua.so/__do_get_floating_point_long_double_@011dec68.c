...

{
  ...
  local_178 = local_130;
  local_170 = pcVar7;
  if (param_2 != (long *)0x0) goto LAB_011ded28;
LAB_011ded34:
  if (param_3 == (long *)0x0) goto LAB_011ded80;
  while( true ) {
    ...
    while( true ) {
      ...
      plVar6 = param_2;
      if (param_2 == (long *)0x0) goto LAB_011ded34;
LAB_011ded28:
      param_2 = plVar6;
      if (plVar6[3] != plVar6[4]) goto LAB_011ded34;
...
LAB_011ded80:
      param_3 = (long *)0x0;
      if (param_2 == (long *)0x0) goto LAB_011dee74;
    }
  }
LAB_011dee74:
  ...
  auVar8 = FUN_01208f8c(pcVar7,local_170,param_5);
  *param_6 = auVar8;
  __check_grouping(local_150,local_130,local_178,param_5);
  plVar6 = param_2;
  if ((param_2 == (long *)0x0) || (param_2[3] != param_2[4])) {
    if (param_3 != (long *)0x0) goto LAB_011deef8;
LAB_011defa0:
    if (plVar6 != (long *)0x0) goto LAB_011def2c;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_011defa0;
LAB_011deef8:
    if ((param_3[3] == param_3[4]) && (iVar3 = (**(code **)(*param_3 + 0x48))(param_3), iVar3 == -1)
       ) goto LAB_011defa0;
    if (plVar6 == (long *)0x0) goto LAB_011def2c;
