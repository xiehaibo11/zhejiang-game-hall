...
/* cocos2d::PUParticleSystem3D::getAffector(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

long __thiscall
cocos2d::PUParticleSystem3D::getAffector(PUParticleSystem3D *this,basic_string *param_1)
