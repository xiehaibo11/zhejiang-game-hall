...
/* cocostudio::CheckBoxReader::getResourceType(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >) */

bool __thiscall cocostudio::CheckBoxReader::getResourceType(undefined8 param_1,byte *param_2)
