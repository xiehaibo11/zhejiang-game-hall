...
::rehash(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>>>
         *this,ulong param_1)

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
                    /* try { // try from 00e0e1a8 to 00f0e1ab has its CatchHandler @ 00e0e20c */
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00e0e200;
    }
    return;
  }
LAB_00e0e200:
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00e0e1a8 with catch @ 00e0e20c
                        */
