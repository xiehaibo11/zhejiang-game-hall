...
undefined8 FUN_00b799c4(long param_1,long param_2,int param_3)
...
LAB_00b79ab8:
      ...
      if (iVar1 < 1) {
        ...
        do {
          ...
          iVar2 = FUN_00b78528(uVar3,auStack_70,auStack_80,param_3);
          if (iVar2 == 0) {
            return 0xffffffff;
          }
          while( true ) {
            iVar2 = OPENSSL_sk_num(param_1);
            if (iVar2 <= iVar1) goto LAB_00b79ab8;
            uVar3 = OPENSSL_sk_value(param_1,iVar1);
            uVar3 = FUN_00b78528(uVar3,auStack_50,auStack_60,param_3);
            if ((int)uVar3 == 0) {
              return uVar3;
            }
