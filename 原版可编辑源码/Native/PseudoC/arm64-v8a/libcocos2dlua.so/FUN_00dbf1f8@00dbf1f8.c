...
void FUN_00dbf1f8(long *param_1,long *param_2)

{
  ...
  if (param_2 != param_1) {
                    /* try { // try from 00dbf224 to 00ebf22b has its CatchHandler @ 00dbf360 */
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
        ...
        (**(code **)(*(long *)param_2[4] + 0x18))((long *)param_2[4],param_1);
                    /* try { // try from 00dbf2f8 to 00ebf313 has its CatchHandler @ 00dbf398 */
        (**(code **)(*(long *)param_2[4] + 0x20))();
        param_2[4] = 0;
        param_1[4] = (long)param_1;
                    /* try { // try from 00dbf314 to 00ebf3d7 has its CatchHandler @ 00dbf114 */
