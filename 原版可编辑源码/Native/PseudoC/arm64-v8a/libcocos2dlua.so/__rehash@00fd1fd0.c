...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<int,std::__ndk1::pair<void*,unsigned_int>>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,std::__ndk1::pair<void*,unsigned_int>>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,std::__ndk1::pair<void*,unsigned_int>>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,std::__ndk1::pair<void*,unsigned_int>>>>
           *this,ulong param_1)
  ...
  if (param_1 == 0) {
    ...
    *(undefined8 *)(this + 8) = 0;
    ...
    if (param_1 >> 0x3d != 0) {
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fd2138 with catch @ 00fd2154
                        */
          ...
          if (uVar7 != uVar4) {
            ...
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) {
              *(long **)(*(long *)this + uVar7 * 8) = plVar5;
              uVar4 = uVar7;
                    /* try { // try from 00fd2138 to 010d213b has its CatchHandler @ 00fd2154 */
            }
            else {
              do {
                plVar8 = plVar9;
