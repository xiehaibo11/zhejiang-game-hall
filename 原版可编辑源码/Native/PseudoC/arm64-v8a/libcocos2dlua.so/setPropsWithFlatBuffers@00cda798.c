...
/* cocostudio::ComAudioReader::setPropsWithFlatBuffers(cocos2d::Node*, flatbuffers::Table const*) */
...

{
  ...
  if ((*(ushort *)(param_2 + -(long)*(int *)param_2) < 5) ||
    ...
    pTVar2 = param_2 + uVar3 + *(uint *)(param_2 + uVar3);
                    ...
                    /* WARNING: Could not recover jumptable at 0x00cda7f4. Too many branches */
