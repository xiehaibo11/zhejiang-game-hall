...
/* void std::__ndk1::vector<p2t::Point*, std::__ndk1::allocator<p2t::Point*>
   >::__push_back_slow_path<p2t::Point* const&>(p2t::Point* const&) */

void __thiscall
std::__ndk1::vector<p2t::Point*,std::__ndk1::allocator<p2t::Point*>>::
__push_back_slow_path<p2t::Point*const&>
          (vector<p2t::Point*,std::__ndk1::allocator<p2t::Point*>> *this,Point **param_1)
