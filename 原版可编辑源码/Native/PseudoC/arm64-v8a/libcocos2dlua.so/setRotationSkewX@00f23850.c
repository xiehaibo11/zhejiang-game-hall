...
/* cocos2d::Node::setRotationSkewX(float) */
...

{
  ...
  if (*(float *)(this + 0x2c) != param_1) {
    ...
    *(float *)(this + 0x34) = fStack_54 * local_50 * local_48 - local_58 * fStack_4c * fStack_44;
    *(float *)(this + 0x38) = local_58 * fStack_4c * local_48 + fStack_54 * local_50 * fStack_44;
    *(float *)(this + 0x3c) = local_58 * local_50 * fStack_44 - fStack_54 * fStack_4c * local_48;
    *(float *)(this + 0x40) = local_58 * local_50 * local_48 + fStack_54 * fStack_4c * fStack_44;
  }
  return;
}
