...
void FUN_00df9160(long *param_1,long *param_2)
  ...
  if (param_2 != param_1) {
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
        ...
        param_2[4] = 0;
                    /* try { // try from 00df926c to 00ef9277 has its CatchHandler @ 00df92a0 */
        param_1[4] = (long)param_1;
                    /* try { // try from 00df9278 to 00ef92bb has its CatchHandler @ 00df91fc */
      ...
      if (param_2 == plVar3) {
                    /* try { // try from 00df91fc to 00ef926b has its CatchHandler @ 00df91fc
                       catch() { ... } // from try @ 00df91fc with catch @ 00df91fc
                       catch() { ... } // from try @ 00df9278 with catch @ 00df91fc */
        ...
        param_2[4] = (long)plVar2;
                    ...
                    /* catch() { ... } // from try @ 00df926c with catch @ 00df92a0 */
