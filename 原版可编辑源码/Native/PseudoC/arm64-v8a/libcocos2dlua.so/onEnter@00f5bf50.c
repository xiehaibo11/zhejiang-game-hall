...
/* cocos2d::TransitionFlipAngular::onEnter() */

void __thiscall cocos2d::TransitionFlipAngular::onEnter(TransitionFlipAngular *this)

{
  ...
  TransitionFlipAngular *local_88;
  long *local_80;
  long local_68;
  
                    /* catch() { ... } // from try @ 00f5be58 with catch @ 00f5bf5c */
                    /* catch() { ... } // from try @ 00f5bdd0 with catch @ 00f5bf64 */
  lVar1 = tpidr_el0;
  ...
  uVar6 = Show::create();
  uVar7 = OrbitCamera::create(*(float *)(this + 0x380) * 0.5,1.0,0.0,fVar2,fVar3,-45.0,0.0);
  local_a0 = &PTR_FUN_0171ccb0;
  uStack_90 = 0;
  ...
  if (&local_a0 == (undefined ***)local_80) {
    ...
    if (local_80 == (long *)0x0) goto LAB_00f5c0d0;
...
LAB_00f5c0d0:
  ...
  uVar7 = Sequence::create(pFVar5,uVar7,uVar8,0);
                    /* try { // try from 00f5c124 to 0105c22b has its CatchHandler @ 00f5c124
                       catch() { ... } // from try @ 00f5c124 with catch @ 00f5c124
                       catch() { ... } // from try @ 00f5c2bc with catch @ 00f5c124 */
