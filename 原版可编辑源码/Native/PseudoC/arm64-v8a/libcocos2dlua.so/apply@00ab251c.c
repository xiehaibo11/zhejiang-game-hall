...
/* fairygui::GearFontSize::apply() */

void __thiscall fairygui::GearFontSize::apply(GearFontSize *this)

{
  ...
  *(undefined1 *)(*(long *)(this + 8) + 0x99) = 1;
  pbVar2 = (basic_string *)GController::getSelectedPageId(*(GController **)(this + 0x10));
  lVar3 = std::__ndk1::
  ...
  plVar4 = *(long **)(this + 8);
  if (lVar3 == 0) {
    cocos2d::Value::Value(aVStack_48,*(int *)(this + 0x48));
    (**(code **)(*plVar4 + 0x38))(plVar4,8,aVStack_48);
  }
  else {
    cocos2d::Value::Value(aVStack_48,*(int *)(lVar3 + 0x28));
    (**(code **)(*plVar4 + 0x38))(plVar4,8,aVStack_48);
  }
