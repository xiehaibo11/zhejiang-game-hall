...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<int,
   cocos2d::Animate3D::Animate3DDisplayedEventInfo>, void*>*>, bool>
   std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int,
   cocos2d::Animate3D::Animate3DDisplayedEventInfo>, std::__ndk1::__unordered_map_hasher<int,
   ...
   cocos2d::Animate3D::Animate3DDisplayedEventInfo> > >::__emplace_unique_key_args<int,
      ...
      for (plVar7 = (long *)*plVar7; plVar7 != (long *)0x0; plVar7 = (long *)*plVar7) {
        ...
        if (uVar6 != uVar9) {
          if (uVar4 < 2) {
            ...
            if (uVar6 - uVar2 * uVar8 == unaff_x24) goto LAB_00d0b800;
            break;
          }
...
LAB_00d0b800:
  ...
  *(undefined4 *)(plVar7 + 2) = uVar1;
  if ((uVar8 == 0) || ((float)param_1[8] * (float)uVar8 < (float)(*(long *)(param_1 + 6) + 1))) {
    ...
    rehash((__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::Animate3D::Animate3DDisplayedEventInfo>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::Animate3D::Animate3DDisplayedEventInfo>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::Animate3D::Animate3DDisplayedEventInfo>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::Animate3D::Animate3DDisplayedEventInfo>>>
            *)param_1,uVar4);
    uVar8 = *(ulong *)(param_1 + 2);
    if ((uVar8 & uVar8 - 1) == 0) {
      unaff_x24 = uVar8 - 1 & uVar9;
