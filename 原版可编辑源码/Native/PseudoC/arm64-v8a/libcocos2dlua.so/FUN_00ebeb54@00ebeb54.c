...
undefined8 FUN_00ebeb54(long param_1,undefined8 param_2,int *param_3,int param_4)
  ...
  if (iVar5 == 3) {
    ...
    if (*(int *)(param_1 + 0x18) < 9) {
      ...
      if (uVar7 < 8) {
        ...
        puVar10 = (undefined8 *)(uVar14 + *(long *)(param_1 + 0x40) + 8);
        ...
        if (uVar7 == uVar12) goto LAB_00ebed04;
      }
      do {
...
LAB_00ebed04:
  ...
  if (uVar7 < 8) {
    ...
    if (uVar7 == uVar12) goto LAB_00ebedcc;
  }
  do {
    uVar14 = uVar12 + 1;
