...
joined_r0x00b9e4f8:
                    /* catch() { ... } // from try @ 00b9e400 with catch @ 00b9e4f8 */
    if (piVar3 != (int *)0x0) goto LAB_00b9e518;
    goto LAB_00b9e4fc;
  default:
    if (iVar1 == 0xcd) {
      ...
      if (iVar1 != 0x312) goto switchD_00b9e464_caseD_18;
...
LAB_00b9e518:
    ...
    type = BIO_s_mem();
                    ...
                    /* catch() { ... } // from try @ 00b9e3e0 with catch @ 00b9e52c */
  pBVar2 = BIO_new(type);
  return pBVar2;
}
