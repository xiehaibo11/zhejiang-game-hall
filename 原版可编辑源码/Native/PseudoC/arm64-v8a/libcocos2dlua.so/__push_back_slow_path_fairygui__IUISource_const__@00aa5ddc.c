...
/* void std::__ndk1::vector<fairygui::IUISource*, std::__ndk1::allocator<fairygui::IUISource*>
   >::__push_back_slow_path<fairygui::IUISource* const&>(fairygui::IUISource* const&) */
...
__push_back_slow_path<fairygui::IUISource*const&>
          (vector<fairygui::IUISource*,std::__ndk1::allocator<fairygui::IUISource*>> *this,
          IUISource **param_1)
