...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int, bool>,
   ...
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<int, bool> > >::__rehash(unsigned long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<int,bool>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,bool>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,bool>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,bool>>>
           *this,ulong param_1)
    ...
    *(ulong *)(this + 8) = param_1;
    ...
    if (plVar5 != (long *)0x0) {
      ...
      uVar12 = CONCAT62((int6)((ulong)uVar11 >> 0x10),uVar10);
                    /* catch() { ... } // from try @ 00fde000 with catch @ 00fde090 */
      if ((uVar12 & 0xffffffff) < 2) {
                    /* catch() { ... } // from try @ 00fde0f4 with catch @ 00fde0c0 */
        ...
        uVar4 = uVar4 - uVar7 * param_1;
                    /* catch() { ... } // from try @ 00fddf60 with catch @ 00fde0a4 */
      }
      *(__hash_table<std::__ndk1::__hash_value_type<int,bool>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,bool>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,bool>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,bool>>>
      ...
      if ((long *)*plVar5 != (long *)0x0) {
        plVar6 = (long *)*plVar5;
        do {
                    /* try { // try from 00fde0ec to 010de0f3 has its CatchHandler @ 00fde150 */
          uVar7 = plVar6[1];
                    /* try { // try from 00fde0f4 to 010de16b has its CatchHandler @ 00fde0c0 */
          if ((uVar12 & 0xffffffff) < 2) {
          ...
          if (uVar7 != uVar4) {
            ...
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) {
              ...
              *plVar5 = (long)plVar9;
                    /* catch() { ... } // from try @ 00fde0ec with catch @ 00fde150 */
              *plVar8 = **(long **)(*(long *)this + uVar7 * 8);
                    /* try { // try from 00fde16c to 010de1cf has its CatchHandler @ 00fde16c
                       catch() { ... } // from try @ 00fde16c with catch @ 00fde16c
                       catch() { ... } // from try @ 00fde1d8 with catch @ 00fde16c */
