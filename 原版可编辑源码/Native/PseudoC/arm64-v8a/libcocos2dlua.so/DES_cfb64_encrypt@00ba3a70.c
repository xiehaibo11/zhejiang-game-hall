...

{
  ...
  if (enc == 0) {
    for (; length != 0; length = length + -1) {
      if (uVar3 == 0) {
        local_48 = *(uint *)*ivec;
                    /* try { // try from 00ba3b4c to 00ca3b53 has its CatchHandler @ 00ba3cb0 */
        ...
        (*ivec)[7] = (uchar)((uint)local_44 >> 0x18);
                    ...
                    /* try { // try from 00ba3ba8 to 00ca3baf has its CatchHandler @ 00ba3c90 */
      bVar1 = *in;
      bVar2 = (*ivec)[(int)uVar3];
                    /* try { // try from 00ba3bb0 to 00ca3cdf has its CatchHandler @ 00ba398c */
