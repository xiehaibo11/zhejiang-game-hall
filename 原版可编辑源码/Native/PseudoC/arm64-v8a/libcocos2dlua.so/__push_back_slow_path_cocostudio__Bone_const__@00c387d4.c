...
/* void std::__ndk1::vector<cocostudio::Bone*, std::__ndk1::allocator<cocostudio::Bone*>
   >::__push_back_slow_path<cocostudio::Bone* const&>(cocostudio::Bone* const&) */

void __thiscall
std::__ndk1::vector<cocostudio::Bone*,std::__ndk1::allocator<cocostudio::Bone*>>::
__push_back_slow_path<cocostudio::Bone*const&>
          (vector<cocostudio::Bone*,std::__ndk1::allocator<cocostudio::Bone*>> *this,Bone **param_1)
