...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void (cocos2d::ui::TabControl::*)(int,
   ...
   cocos2d::ui::TabHeader::EventType)>::__clone() const */
...
::__clone(__func<std::__ndk1::__bind<void(cocos2d::ui::TabControl::*)(int,cocos2d::ui::TabHeader::EventType),cocos2d::ui::TabControl*,std::__ndk1::placeholders::__ph<1>const&,std::__ndk1::placeholders::__ph<2>const&>,std::__ndk1::allocator<std::__ndk1::__bind<void(cocos2d::ui::TabControl::*)(int,cocos2d::ui::TabHeader::EventType),cocos2d::ui::TabControl*,std::__ndk1::placeholders::__ph<1>const&,std::__ndk1::placeholders::__ph<2>const&>>,void(int,cocos2d::ui::TabHeader::EventType)>
          *this)

{
  ...
  undefined8 uVar3;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00df3df4 with catch @ 00df3e38
                        */
  puVar1 = operator_new(0x20);
  *puVar1 = &PTR_FUN_016e7368;
