...
/* cocos2d::ActionFloat::clone() const */

undefined8 __thiscall cocos2d::ActionFloat::clone(ActionFloat *this)

{
  ...
  if (alStack_80 == local_60) {
    ...
    if (local_60 == (long *)0x0) goto LAB_00ee5260;
    pcVar4 = *(code **)(*local_60 + 0x28);
  }
  (*pcVar4)();
LAB_00ee5260:
  if (*(long *)(lVar1 + 0x28) == local_48) {
                    /* try { // try from 00ee5288 to 00fe52df has its CatchHandler @ 00ee5140 */
    return uVar3;
  }
