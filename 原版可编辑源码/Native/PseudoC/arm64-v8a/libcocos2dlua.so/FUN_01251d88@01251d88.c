...
bool FUN_01251d88(long param_1,long param_2)

{
  ...
  while( true ) {
    ...
    if (*(long *)(lVar2 + 8) == *(long *)(*(long *)(lVar1 + 0x18) + 8)) {
      return true;
    }
  ...
  if (lVar1 != 0) {
    ...
    if (*(long *)(*(long *)(lVar2 + 0x18) + 8) != *(long *)(*(long *)(lVar1 + 0x18) + 8)) {
      return false;
    }
    return *(long *)(*(long *)(lVar2 + 0x20) + 8) == *(long *)(*(long *)(lVar1 + 0x20) + 8);
  }
  return false;
}
