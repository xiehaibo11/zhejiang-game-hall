...

{
  ...
  undefined8 uVar13;
                    ...
                    /* try { // try from 010d39b4 to 011d39bf has its CatchHandler @ 010d415c */
  if (param_1 == 0) {
    return;
  }
  if (param_2 == 0) {
  ...
  if (*(ushort *)(param_2 + 0x20) - 1 < 0x100) {
    png_free_data(param_1,param_2,8,0);
                    /* try { // try from 010d39f4 to 011d39fb has its CatchHandler @ 010d4158 */
    lVar4 = png_malloc_warn(param_1,0x200);
    *(long *)(param_2 + 0xf0) = lVar4;
    if (lVar4 != 0) {
                    /* try { // try from 010d3a14 to 011d3a1f has its CatchHandler @ 010d4154 */
      *(uint *)(param_2 + 0x11c) = *(uint *)(param_2 + 0x11c) | 8;
      if (*(short *)(param_2 + 0x20) != 0) {
        ...
        if (uVar1 < 0x10) {
          ...
          uVar6 = uVar1 & 0xfff0;
          if (uVar6 != 0) {
                    /* try { // try from 010d3a5c to 011d3aa3 has its CatchHandler @ 010d35bc */
            ...
            if (uVar1 == uVar6) goto LAB_010d3aa0;
          }
        }
        do {
          lVar7 = uVar6 * 2;
...
LAB_010d3aa0:
                    /* try { // try from 010d3aa4 to 011d3ab3 has its CatchHandler @ 010d414c */
      *(uint *)(param_2 + 8) = *(uint *)(param_2 + 8) | 0x40;
                    /* try { // try from 010d3ab4 to 011d3ac3 has its CatchHandler @ 010d4138 */
      return;
    }
    ...
    pcVar5 = "Invalid palette size, hIST allocation skipped";
                    ...
                    /* try { // try from 010d3a50 to 011d3a5b has its CatchHandler @ 010d4150 */
