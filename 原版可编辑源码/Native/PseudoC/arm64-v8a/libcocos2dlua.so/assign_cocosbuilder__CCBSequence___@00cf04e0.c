...
/* std::__ndk1::enable_if<__is_forward_iterator<cocosbuilder::CCBSequence**>::value&&is_constructible<cocosbuilder::CCBSequence*,
   std::__ndk1::iterator_traits<cocosbuilder::CCBSequence**>::reference>::value, void>::type
   std::__ndk1::vector<cocosbuilder::CCBSequence*,
   std::__ndk1::allocator<cocosbuilder::CCBSequence*>
   >::assign<cocosbuilder::CCBSequence**>(cocosbuilder::CCBSequence**, cocosbuilder::CCBSequence**)
    */
...
assign<cocosbuilder::CCBSequence**>
           ...
           *this,CCBSequence **param_1,CCBSequence **param_2)
...
LAB_00cf0564:
    ...
    if ((ulong)(lVar1 >> 3) < 0xfffffffffffffff) {
      uVar2 = lVar1 >> 2;
      if ((uVar5 <= uVar2) && (uVar5 = uVar2, uVar2 >> 0x3d != 0)) goto LAB_00cf0564;
    }
    else {
    ...
    *(void **)(this + 8) = pvVar4;
    ...
    __src = (CCBSequence **)((long)param_1 + (*(long *)(this + 8) - (long)pvVar4));
    if (uVar5 <= uVar2) {
      __src = param_2;
    }
