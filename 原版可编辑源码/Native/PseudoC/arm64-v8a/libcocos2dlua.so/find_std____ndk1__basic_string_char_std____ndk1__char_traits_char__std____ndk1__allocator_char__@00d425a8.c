...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00d425c8 to 00e425cf has its CatchHandler @ 00d425e0 */
  lVar5 = tpidr_el0;
  local_68 = *(long *)(lVar5 + 0x28);
                    /* try { // try from 00d425d0 to 00e425fb has its CatchHandler @ 00d4255c */
                    /* catch() { ... } // from try @ 00d425c8 with catch @ 00d425e0 */
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00d42684;
              goto LAB_00d42734;
            }
            if (uVar9 != uVar14) goto LAB_00d42734;
          }
LAB_00d42684:
          plVar8 = (long *)*plVar8;
