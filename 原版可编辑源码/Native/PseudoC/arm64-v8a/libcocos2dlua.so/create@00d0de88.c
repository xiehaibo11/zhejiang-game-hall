...
/* cocos2d::AnimationCurve<4>::create(float*, float*, int) */

Ref * cocos2d::AnimationCurve<4>::create(float *param_1,float *param_2,int param_3)

{
  ...
  *(void **)(this + 0x30) = pvVar2;
  memcpy(pvVar2,param_1,(long)(int)uVar1);
  uVar3 = -(ulong)((param_3 & 0x3fffffffU) >> 0x1d) & 0xfffffffc00000000 | (ulong)uVar1 << 2;
  if ((ulong)(long)(int)uVar1 >> 0x3e != 0) {
    uVar3 = 0xffffffffffffffff;
  }
  pvVar2 = operator_new__(uVar3);
  *(void **)(this + 0x28) = pvVar2;
  memcpy(pvVar2,param_2,(long)(param_3 << 4));
  *(int *)(this + 0x38) = param_3;
  *(undefined4 *)(this + 0x3c) = 0x10;
