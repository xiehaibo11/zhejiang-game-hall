...
/* cocos2d::MathUtilNeon64::multiplyMatrix(float const*, float const*, float*) */

void cocos2d::MathUtilNeon64::multiplyMatrix(float *param_1,float *param_2,float *param_3)
