...
/* flatbuffers::FlatBufferBuilder::Align(unsigned long) */

void __thiscall flatbuffers::FlatBufferBuilder::Align(FlatBufferBuilder *this,ulong param_1)

{
  ...
  if (*(ulong *)(this + 0x58) < param_1) {
    *(ulong *)(this + 0x58) = param_1;
  }
  lVar2 = *(long *)(this + 0x18);
  uVar3 = *(ulong *)(this + 8);
  iVar4 = (int)*(ulong *)(this + 0x10);
  __n = param_1 - 1 & -(ulong)(uint)(((int)uVar3 - (int)lVar2) + iVar4);
  if (lVar2 - __n < *(ulong *)(this + 0x10)) {
    ...
    *(ulong *)(this + 8) = uVar5 + uVar3;
    uVar3 = (ulong)(uint)(((int)uVar3 + iVar4) - (int)lVar2);
