...
LAB_00ac7ce0:
            if ((int)uVar19 == 0) goto LAB_00ac7cf0;
          }
          else {
            uVar19 = 0;
            iVar10 = param_5 + 1;
            do {
              if (iVar5 == 0) goto LAB_00ac7ce0;
              iVar10 = iVar10 + -1;
...
LAB_00ac7cf0:
      ...
      if ((iVar5 == 0) && (iVar5 = SSL_in_init(param_1), iVar5 != 0)) {
        ...
        uVar19 = (ulong)uVar6;
        if ((int)uVar6 < 0) goto LAB_00ac7c2c;
        if (uVar6 == 0) {
          iVar5 = 0xe5;
          iVar10 = 0x186;
          goto LAB_00ac7c24;
...
LAB_00ac7d30:
      ...
      if (((*(int *)&param_1[2].next_proto_negotiated == 0) ||
        ...
        if ((int)uVar15 < 1) goto LAB_00ac7c2c;
        goto LAB_00ac7d30;
      }
      ...
      if ((uVar6 == param_2) ||
        ...
        switch(uVar6) {
        case 0x14:
          goto switchD_00ac7e84_caseD_14;
        case 0x15:
          uVar19 = 2;
        ...
        if (1 < *(uint *)(lVar11 + 0x5c)) {
          ...
          *(undefined4 *)(lVar11 + 0x5c) = 0;
          ...
          if (pcVar18 == (code *)0x0) {
            ...
            if (pcVar18 != (code *)0x0) goto LAB_00ac7fb4;
            pcVar18 = (code *)0x0;
          }
          else {
LAB_00ac7fb4:
