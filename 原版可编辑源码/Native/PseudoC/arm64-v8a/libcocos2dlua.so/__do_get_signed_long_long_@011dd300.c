...

{
  ...
  plVar9 = param_2;
  local_168 = pcVar10;
  if (param_2 != (long *)0x0) goto LAB_011dd3e4;
LAB_011dd3f0:
  if (param_3 == (long *)0x0) goto LAB_011dd43c;
  while( true ) {
    ...
    while( true ) {
      ...
      plVar9 = param_2;
      if (param_2 == (long *)0x0) goto LAB_011dd3f0;
LAB_011dd3e4:
      param_2 = plVar9;
      if (plVar9[3] != plVar9[4]) goto LAB_011dd3f0;
...
LAB_011dd43c:
      param_3 = (long *)0x0;
      if (param_2 == (long *)0x0) goto LAB_011dd52c;
    }
  }
LAB_011dd52c:
  ...
  uVar6 = FUN_012086c0(pcVar10,local_168,param_5,iVar5);
  *param_6 = uVar6;
  __check_grouping(local_148,local_12c,local_170,param_5);
  plVar9 = param_2;
  if ((param_2 == (long *)0x0) || (param_2[3] != param_2[4])) {
    if (param_3 != (long *)0x0) goto LAB_011dd5ac;
LAB_011dd650:
    if (plVar9 != (long *)0x0) goto LAB_011dd5e0;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_011dd650;
LAB_011dd5ac:
