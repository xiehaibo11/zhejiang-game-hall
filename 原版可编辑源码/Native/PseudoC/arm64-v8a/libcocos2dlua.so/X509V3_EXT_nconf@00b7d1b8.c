...

{
  ...
  sVar2 = strlen(value);
  if (3 < sVar2) {
                    /* try { // try from 00b7d22c to 00c7d237 has its CatchHandler @ 00b7d384 */
    lVar7 = 4;
...
LAB_00b7d300:
      ...
      do {
                    /* try { // try from 00b7d308 to 00c7d31b has its CatchHandler @ 00b7d38c */
        pbVar4 = pbVar4 + 1;
        iVar1 = isspace((uint)*pbVar4);
      } while (iVar1 != 0);
      pXVar3 = (X509_EXTENSION *)FUN_00b7d340(name,pbVar4,uVar6,uVar5,ctx);
      return pXVar3;
    }
    if (4 < sVar2) {
      lVar7 = 5;
  ...
  pXVar3 = (X509_EXTENSION *)FUN_00b7d4e4(conf,ctx,iVar1,uVar6,value);
