...
/* void std::__ndk1::vector<ClipperLib::TEdge*, std::__ndk1::allocator<ClipperLib::TEdge*>
   >::__push_back_slow_path<ClipperLib::TEdge* const&>(ClipperLib::TEdge* const&) */

void __thiscall
std::__ndk1::vector<ClipperLib::TEdge*,std::__ndk1::allocator<ClipperLib::TEdge*>>::
__push_back_slow_path<ClipperLib::TEdge*const&>
          (vector<ClipperLib::TEdge*,std::__ndk1::allocator<ClipperLib::TEdge*>> *this,
          TEdge **param_1)
