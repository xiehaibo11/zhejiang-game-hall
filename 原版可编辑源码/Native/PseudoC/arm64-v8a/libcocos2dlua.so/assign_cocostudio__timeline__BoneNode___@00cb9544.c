...
/* std::__ndk1::enable_if<__is_forward_iterator<cocostudio::timeline::BoneNode**>::value&&is_constructible<cocostudio::timeline::BoneNode*,
   std::__ndk1::iterator_traits<cocostudio::timeline::BoneNode**>::reference>::value, void>::type
   std::__ndk1::vector<cocostudio::timeline::BoneNode*,
   std::__ndk1::allocator<cocostudio::timeline::BoneNode*>
   >::assign<cocostudio::timeline::BoneNode**>(cocostudio::timeline::BoneNode**,
...
assign<cocostudio::timeline::BoneNode**>
          (vector<cocostudio::timeline::BoneNode*,std::__ndk1::allocator<cocostudio::timeline::BoneNode*>>
           *this,BoneNode **param_1,BoneNode **param_2)
...
LAB_00cb95c8:
    ...
    if ((ulong)(lVar1 >> 3) < 0xfffffffffffffff) {
      uVar2 = lVar1 >> 2;
      if ((uVar5 <= uVar2) && (uVar5 = uVar2, uVar2 >> 0x3d != 0)) goto LAB_00cb95c8;
    }
    else {
    ...
    *(void **)(this + 8) = pvVar4;
    ...
    __src = (BoneNode **)((long)param_1 + (*(long *)(this + 8) - (long)pvVar4));
    if (uVar5 <= uVar2) {
      __src = param_2;
    }
