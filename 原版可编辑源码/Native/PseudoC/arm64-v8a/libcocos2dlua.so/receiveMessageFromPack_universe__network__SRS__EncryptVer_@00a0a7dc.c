...
/* void 
   universe::network::GuoPengFei::receiveMessageFromPack<universe::network::SRS::EncryptVer>(universe::network::SRS::EncryptVer&,
   universe::network::ZhouLuJun const*) */

void __thiscall
universe::network::GuoPengFei::receiveMessageFromPack<universe::network::SRS::EncryptVer>
          (GuoPengFei *this,EncryptVer *param_1,ZhouLuJun *param_2)
