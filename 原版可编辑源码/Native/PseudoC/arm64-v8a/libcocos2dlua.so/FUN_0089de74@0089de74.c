...
undefined8 FUN_0089de74(undefined8 param_1)

{
  ...
  if ((((iVar2 == 0) || (iVar2 = tolua_isusertype(param_1,2,&DAT_012769c7,0,auStack_58), iVar2 == 0)
    ...
    tolua_error(param_1,"#ferror in function \'removeObject\'.",auStack_58);
  }
  else {
    ...
    if (this == (__Array *)0x0) {
      tolua_error(param_1,"invalid \'self\' in function \'removeObject\'",0);
    }
    cocos2d::__Array::removeObject(this,pRVar3,iVar2 != 0);
  }
