...
void FUN_010eeae0(long *param_1,int param_2)

{
  ...
  if (param_2 != 0) {
    *(code **)(lVar6 + 8) = FUN_010ef064;
    *(code **)(lVar6 + 0x10) = FUN_010ef0e4;
    *(undefined4 *)(lVar6 + 0x38) = 1;
    iVar3 = *(int *)(lVar6 + 0x38);
    goto joined_r0x010eec00;
  }
  pcVar2 = FUN_010ef6ac;
  if (!bVar1) {
    pcVar2 = FUN_010ef9b8;
