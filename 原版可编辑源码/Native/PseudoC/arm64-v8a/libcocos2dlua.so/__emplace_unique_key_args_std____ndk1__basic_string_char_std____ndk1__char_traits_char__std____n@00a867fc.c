...

{
  ...
  if (uVar16 != 0) {
    ...
    if (uVar13 < 2) {
                    /* try { // try from 00a86894 to 00b86a07 has its CatchHandler @ 00a86894
                       catch() { ... } // from try @ 00a86894 with catch @ 00a86894
                       catch() { ... } // from try @ 00a86a88 with catch @ 00a86894 */
      ...
      do {
        ...
        if (uVar11 != uVar8) {
          if (uVar13 < 2) {
            ...
            if (uVar11 - uVar5 * uVar16 == unaff_x27) goto LAB_00a86920;
            break;
          }
          ...
          if ((bVar4 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(piecewise_construct_t *)((long)plVar15 + uVar11 + 0x11) == ppVar3[uVar11]) {
                uVar11 = uVar11 + 1;
                if (bVar4 >> 1 == uVar11) goto LAB_00a86990;
              }
              goto LAB_00a868d8;
            }
          }
  ...
  *plVar15 = 0;
  ...
  if ((uVar16 == 0) ||
    ...
    uVar16 = (ulong)(uVar16 < 3 || (uVar16 & uVar16 - 1) != 0) | uVar16 << 1;
                    /* try { // try from 00a86a08 to 00b86a3b has its CatchHandler @ 00a86b08 */
    ...
    if ((uVar16 & uVar16 - 1) == 0) {
                    /* try { // try from 00a86a3c to 00b86a4f has its CatchHandler @ 00a86ad4 */
      unaff_x27 = uVar16 - 1 & uVar8;
    }
    else {
      unaff_x27 = uVar8;
  ...
  plVar12 = *(long **)(lVar14 + unaff_x27 * 8);
                    /* try { // try from 00a86a54 to 00b86a87 has its CatchHandler @ 00a86ad8 */
  if (plVar12 == (long *)0x0) {
    *plVar15 = *(long *)pbVar1;
    *(long **)pbVar1 = plVar15;
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar1;
    if (*plVar15 == 0) goto LAB_00a86ab0;
    uVar8 = *(ulong *)(*plVar15 + 8);
                    /* try { // try from 00a86a88 to 00b86b23 has its CatchHandler @ 00a86894 */
    if ((uVar16 & uVar16 - 1) == 0) {
...
LAB_00a86ac0:
  if (*(long *)(lVar6 + 0x28) != local_68) {
    ...
    __stack_chk_fail(__s1,uVar9);
                    ...
                    /* catch() { ... } // from try @ 00a86a3c with catch @ 00a86ad4 */
                    /* catch() { ... } // from try @ 00a86a54 with catch @ 00a86ad8 */
  return plVar15;
}
