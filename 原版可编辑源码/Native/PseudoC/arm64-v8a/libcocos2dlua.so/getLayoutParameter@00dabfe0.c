...
/* cocos2d::ui::Widget::getLayoutParameter() const */

long __thiscall cocos2d::ui::Widget::getLayoutParameter(Widget *this)

{
  ...
  uVar2 = *(ulong *)(this + 0x3f0);
  if (uVar2 != 0) {
    uVar3 = (ulong)*(int *)(this + 0x410);
    ...
    if ((uVar9 & 0xffffffff) < 2) {
      ...
      if (uVar2 <= uVar3) {
        ...
        uVar4 = uVar3 - uVar4 * uVar2;
                    /* try { // try from 00dac018 to 00eac077 has its CatchHandler @ 00dac018
                       catch() { ... } // from try @ 00dac018 with catch @ 00dac018
                       catch() { ... } // from try @ 00dac07c with catch @ 00dac018 */
      }
    }
    plVar5 = *(long **)(*(long *)(this + 1000) + uVar4 * 8);
    if ((plVar5 != (long *)0x0) && (plVar5 = (long *)*plVar5, plVar5 != (long *)0x0)) {
      do {
        uVar6 = plVar5[1];
        if (uVar6 == uVar3) {
          if ((int)plVar5[2] == *(int *)(this + 0x410)) {
            return plVar5[3];
          }
        }
        else {
