        ...
        if (sVar1 == __n) {
          ...
          if ((bVar2 & 1) == 0) {
            if (__n != 0) {
              ...
              pbVar10 = __s2;
              do {
                if (*pbVar8 != *pbVar10) goto LAB_00883c1c;
                uVar6 = uVar6 - 1;
                pbVar8 = pbVar8 + 1;
                pbVar10 = pbVar10 + 1;
              } while (uVar6 != 0);
