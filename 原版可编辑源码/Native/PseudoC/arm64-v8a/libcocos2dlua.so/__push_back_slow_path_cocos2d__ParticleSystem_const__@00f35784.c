...
/* void std::__ndk1::vector<cocos2d::ParticleSystem*,
   std::__ndk1::allocator<cocos2d::ParticleSystem*>
   >::__push_back_slow_path<cocos2d::ParticleSystem* const&>(cocos2d::ParticleSystem* const&) */
...
__push_back_slow_path<cocos2d::ParticleSystem*const&>
          (vector<cocos2d::ParticleSystem*,std::__ndk1::allocator<cocos2d::ParticleSystem*>> *this,
          ParticleSystem **param_1)
