...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<cocos2d::GLProgram*,
   ...
   >::remove(std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<cocos2d::GLProgram*,
   cocos2d::GLProgramState*>, void*>*>) */
...

{
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar7 == uVar4) goto LAB_00fdd2b8;
  }
  if (*param_3 != 0) {
