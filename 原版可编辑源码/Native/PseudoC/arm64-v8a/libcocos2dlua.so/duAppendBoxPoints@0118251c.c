...
/* duAppendBoxPoints(duDebugDraw*, float, float, float, float, float, float, unsigned int) */

void duAppendBoxPoints(duDebugDraw *param_1,float param_2,float param_3,float param_4,float param_5,
...

{
  ...
  if (param_1 != (duDebugDraw *)0x0) {
    ...
    (**(code **)(*(long *)param_1 + 0x30))(uVar4,uVar2,uVar3,param_1,param_8);
                    /* WARNING: Could not recover jumptable at 0x01182754. Too many branches */
