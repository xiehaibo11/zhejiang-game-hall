  ...
  if (param_1 != 0) {
    ...
    *(undefined4 *)(param_1 + 0x4e4) = 0x82;
    ...
    png_write_data(param_1,&local_40,4);
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010da548 with catch @ 010da4d8
                       catch(type#1 @ 00000000) { ... } // from try @ 010da578 with catch @ 010da4d8
                       catch(type#1 @ 00000000) { ... } // from try @ 010da5a8 with catch @ 010da4d8
                       catch(type#1 @ 00000000) { ... } // from try @ 010da5d0 with catch @ 010da4d8
                       catch(type#1 @ 00000000) { ... } // from try @ 010da5fc with catch @ 010da4d8
                        */
