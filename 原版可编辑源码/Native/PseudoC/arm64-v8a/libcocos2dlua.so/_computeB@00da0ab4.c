...

{
  ...
  if (((fVar16 + fVar12 <= fVar14) || (fVar14 + fVar16 <= fVar12)) || (fVar14 + fVar12 <= fVar16)) {
    ...
    if ((fVar16 < fVar14) && (fVar12 < fVar14 + fVar16)) {
                    /* try { // try from 00da0c24 to 00ea0c47 has its CatchHandler @ 00da1264 */
  ...
  fVar8 = fmodf((fVar10 - fVar9) + 3.1415927,6.2831855);
                    /* try { // try from 00da0c80 to 00ea0c87 has its CatchHandler @ 00da1240 */
  fVar10 = -3.1415927;
  if (fVar8 <= 0.0) {
    fVar10 = 3.1415927;
  }
  fVar8 = fVar8 + fVar10;
                    /* try { // try from 00da0c88 to 00ea0c93 has its CatchHandler @ 00da1230 */
  fVar12 = fVar7 + *(float *)(this + 0x3c) * fVar8;
  *(float *)(lVar2 + 0x34) = fVar12;
  sincosf(fVar12,&fStack_44,&local_48);
  fVar10 = 0.0;
  fVar11 = 1.0;
  if (fVar12 != 0.0) {
    fVar10 = fStack_44;
    fVar11 = local_48;
                    ...
                    /* try { // try from 00da0ccc to 00ea0cd3 has its CatchHandler @ 00da1260 */
  *(float *)(lVar2 + 0x10) = fVar11;
  *(float *)(lVar2 + 0x14) = fVar10;
  fVar13 = fVar11;
  fVar14 = fVar10;
  if (*(float *)(lVar2 + 0x30) != 0.0) {
    sincosf(*(float *)(lVar2 + 0x30) + fVar12,&fStack_94,&local_98);
    fVar13 = local_98;
    fVar14 = fStack_94;
  }
  ...
  *(float *)(lVar2 + 0x1c) = fVar13;
                    /* try { // try from 00da0cfc to 00ea0d03 has its CatchHandler @ 00da125c */
  if (fVar15 != 1.0) {
  ...
  *(float *)(lVar2 + 0x24) = fVar17;
  ...
  sincosf(fVar9 + fVar8 * fVar11,&fStack_9c,&local_a0);
                    /* try { // try from 00da0d54 to 00ea0d8f has its CatchHandler @ 00da11b8 */
  fVar18 = fVar18 + fVar16 * local_a0;
  fVar17 = fVar17 + fVar16 * fStack_9c;
  ...
  *(float *)(lVar5 + 0x34) = fVar8;
  sincosf(fVar8,&fStack_a4,&local_a8);
  fVar9 = 0.0;
  fVar10 = 1.0;
                    /* try { // try from 00da0de0 to 00ea0de7 has its CatchHandler @ 00da11b0 */
  if (fVar8 != 0.0) {
    fVar9 = fStack_a4;
    fVar10 = local_a8;
  }
  ...
  *(float *)(lVar5 + 0x14) = fVar9;
  ...
  if (*(float *)(lVar5 + 0x30) != 0.0) {
    sincosf(*(float *)(lVar5 + 0x30) + fVar8,&fStack_ac,&local_b0);
    fVar6 = local_b0;
    fVar7 = fStack_ac;
  }
  ...
  *(float *)(lVar5 + 0x1c) = fVar6;
  ...
  fVar9 = *(float *)(lVar5 + 0x3c);
                    /* try { // try from 00da0e38 to 00ea0e77 has its CatchHandler @ 00da11b4 */
  if (fVar9 != 1.0) {
