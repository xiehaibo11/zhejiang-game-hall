...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, cocos2d::Component*>, void*>*>
   std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, cocos2d::Component*>,
   std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> >, cocos2d::Component*>,
...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 0103f054 to 0113f073 has its CatchHandler @ 0103f1e8 */
  lVar5 = tpidr_el0;
  local_68 = *(long *)(lVar5 + 0x28);
                    /* try { // try from 0103f074 to 0113f0a3 has its CatchHandler @ 0103f010 */
  ...
  if (uVar12 != 0) {
    ...
    uVar15 = NEON_uaddlv(uVar16,1);
                    /* try { // try from 0103f0a4 to 0113f0af has its CatchHandler @ 0103f1e4 */
    ...
    if (plVar8 != (long *)0x0) {
                    /* try { // try from 0103f0e0 to 0113f0e7 has its CatchHandler @ 0103f1c4 */
      plVar8 = (long *)*plVar8;
      if (plVar8 != (long *)0x0) {
                    /* try { // try from 0103f0e8 to 0113f127 has its CatchHandler @ 0103f010 */
        ...
        do {
          uVar9 = plVar8[1];
                    /* try { // try from 0103f128 to 0113f137 has its CatchHandler @ 0103f1e0 */
          if (uVar9 == uVar7) {
            bVar3 = *(byte *)(plVar8 + 2);
                    /* try { // try from 0103f138 to 0113f20b has its CatchHandler @ 0103f010 */
            uVar9 = (ulong)(bVar3 >> 1);
            sVar1 = uVar9;
            if ((bVar3 & 1) != 0) {
              sVar1 = plVar8[3];
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_0103f118;
              goto LAB_0103f1c8;
            }
            if (uVar9 != uVar14) goto LAB_0103f1c8;
          }
LAB_0103f118:
          plVar8 = (long *)*plVar8;
...
LAB_0103f1cc:
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* catch() { ... } // from try @ 0103f128 with catch @ 0103f1e0 */
                    /* catch() { ... } // from try @ 0103f0a4 with catch @ 0103f1e4 */
                    /* catch() { ... } // from try @ 0103f054 with catch @ 0103f1e8 */
    return plVar8;
  }
