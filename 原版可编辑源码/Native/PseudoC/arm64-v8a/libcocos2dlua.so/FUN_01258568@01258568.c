...
void FUN_01258568(long *param_1,ulong param_2)

{
  ...
  if ((pcVar12 == (char *)param_1[1]) || (*pcVar12 != 'I')) {
    ...
    *param_1 = (long)pcVar12;
    ...
    plVar1 = param_1 + 0x4b;
    plVar2 = param_1 + 0x49;
    if (pcVar12 == (char *)param_1[1]) goto LAB_01258628;
LAB_01258608:
    if (*pcVar12 != 'E') {
LAB_01258628:
      if ((param_2 & 1) == 0) {
        local_c0 = (long *)FUN_01257aa8(param_1);
        puVar11 = (undefined8 *)0x0;
        if (local_c0 != (long *)0x0) {
          FUN_01257c80(plVar20,&local_c0);
          goto LAB_0125861c;
        }
        goto LAB_012589dc;
      }
      ...
      puVar11 = (undefined8 *)FUN_01257aa8(param_1);
      plVar13 = (long *)param_1[0x48];
      local_c8 = puVar11;
      if (local_c0 == alStack_a8) {
        ...
        local_b8 = local_c0;
joined_r0x01258884:
        if (puVar11 != (undefined8 *)0x0) goto LAB_0125870c;
LAB_012588c0:
        bVar6 = true;
        local_c0 = local_b8;
        goto joined_r0x012588c8;
      }
      ...
      *plVar2 = (long)local_b8;
      local_b8 = plVar13;
      plStack_b0 = plVar17;
      if (puVar11 == (undefined8 *)0x0) goto LAB_012588c0;
LAB_0125870c:
      local_c0 = local_b8;
      FUN_01257c80(plVar20,&local_c8);
      if (*(char *)(puVar11 + 1) != '\x1c') goto LAB_01258804;
      ...
      if (0xfef < lVar14 + 0x20U) {
        ...
        if (puVar10 == (void *)0x0) goto LAB_01258a0c;
        lVar14 = 0;
        *puVar10 = pvVar21;
        puVar10[1] = 0;
      ...
      *(long *)((long)puVar10 + lVar14 + 0x28) = lVar16;
      ...
      while (plVar7 = plVar13, lVar4 = lVar15, lVar9 = lVar16, lVar8 != 0) {
        if (*(char *)(*plVar17 + 10) != '\x01') goto joined_r0x012587b0;
        lVar3 = lVar3 + -8;
        plVar17 = plVar17 + 1;
        lVar8 = lVar3;
      }
...
joined_r0x012587b0:
      do {
        if (lVar9 == 0) goto LAB_012587d4;
        if (*(char *)(*plVar7 + 0xb) != '\x01') goto joined_r0x012587dc;
        lVar4 = lVar4 + -8;
        plVar7 = plVar7 + 1;
        lVar9 = lVar4;
      } while( true );
    ...
    *param_1 = (long)(pcVar12 + 1);
    ...
    auVar22 = FUN_0125f2dc(param_1,param_1[2] + lVar18,param_1[3]);
    pvVar21 = (void *)param_1[0x25c];
...
joined_r0x012587dc:
  do {
    if (lVar16 == 0) break;
    if (*(char *)(*plVar13 + 9) != '\x01') goto LAB_01258804;
    lVar15 = lVar15 + -8;
    plVar13 = plVar13 + 1;
    lVar16 = lVar15;
  } while( true );
...
LAB_01258804:
  ...
  if (puVar10 == (undefined8 *)param_1[0x4a]) {
    ...
    if (plVar1 == plVar13) {
      ...
      if (pvVar21 == (void *)0x0) goto LAB_01258a0c;
      if (__n != 0) {
...
LAB_0125861c:
  pcVar12 = (char *)*param_1;
  if (pcVar12 != (char *)param_1[1]) goto LAB_01258608;
  goto LAB_01258628;
}
