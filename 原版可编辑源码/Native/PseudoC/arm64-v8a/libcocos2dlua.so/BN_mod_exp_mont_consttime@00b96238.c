...
LAB_00b9652c:
        local_78.top = uVar15;
        if (a->neg != 0) goto LAB_00b96548;
LAB_00b96538:
        iVar4 = BN_ucmp(a,m);
        if (-1 < iVar4) goto LAB_00b96548;
      }
      else {
        pBVar7 = BN_value_one();
        ...
        mont = local_98;
        in_mont = local_b8;
        if (iVar4 == 0) goto joined_r0x00b96580;
        if (a->neg == 0) goto LAB_00b96538;
LAB_00b96548:
      ...
      if (iVar4 != 0) {
        ...
        puVar14 = puStack_d8;
        iVar4 = FUN_00b9690c(&local_78,uVar15,puStack_d8,iVar16,uVar18);
        while (ptr = local_c0, iVar4 != 0) {
          if (iVar3 < 0) {
            iVar3 = BN_from_montgomery(local_d0,&local_78,mont,ctx);
            uVar15 = (uint)(iVar3 != 0);
            ptr = local_c0;
            goto joined_r0x00b96904;
          }
          iVar4 = 0;
          iVar16 = 0;
          do {
            ...
            ptr = local_c0;
            puVar14 = puStack_d8;
            if (iVar5 == 0) goto joined_r0x00b96580;
            iVar5 = BN_is_bit_set(p,iVar3);
            puVar14 = puStack_d8;
            iVar4 = iVar4 + 1;
            iVar16 = iVar5 + iVar16 * 2;
          ...
          iVar4 = FUN_00b9690c(&local_90,uVar15,puStack_d8,iVar16,uVar18);
          ptr = local_c0;
          if (iVar4 == 0) break;
      ...
      if (puVar6 != (undefined1 *)0x0) goto LAB_00b963dc;
      ptr = (undefined1 *)0x0;
      puVar14 = (ulong *)0x0;
      mont = local_98;
    }
joined_r0x00b96580:
    uVar15 = 0;
joined_r0x00b96904:
    if (in_mont != (BN_MONT_CTX *)0x0) goto LAB_00b96854;
  }
