...

{
  ...
  void *local_38;
                    ...
                    /* try { // try from 00b9e754 to 00c9e75b has its CatchHandler @ 00b9ea58 */
  iVar1 = OBJ_obj2nid(*(ASN1_OBJECT **)cms);
                    /* try { // try from 00b9e75c to 00c9e8b3 has its CatchHandler @ 00b9e704 */
  switch(iVar1) {
  case 0x15:
    pCVar5 = cms + 8;
    lVar4 = *(long *)pCVar5;
    goto joined_r0x00b9e8a0;
  case 0x16:
  case 0x19:
...
LAB_00b9e864:
  ...
  default:
    if (iVar1 == 0xcd) {
      ...
      if (iVar1 != 0x312) goto switchD_00b9e774_caseD_18;
...
LAB_00b9e8a4:
    iVar1 = OBJ_obj2nid(*(ASN1_OBJECT **)cms);
                    /* try { // try from 00b9e8b4 to 00c9e8bb has its CatchHandler @ 00b9ea44 */
    iVar2 = 1;
    switch(iVar1) {
    case 0x15:
    case 0x17:
    ...
    case 0x16:
      ...
      break;
    case 0x19:
                    /* try { // try from 00b9e914 to 00c9e91b has its CatchHandler @ 00b9e9fc */
                    /* try { // try from 00b9e91c to 00c9ea5b has its CatchHandler @ 00b9e704 */
...
LAB_00b9e7d8:
    if ((*(byte *)(lVar4 + 0x10) >> 5 & 1) == 0) goto LAB_00b9e8a4;
