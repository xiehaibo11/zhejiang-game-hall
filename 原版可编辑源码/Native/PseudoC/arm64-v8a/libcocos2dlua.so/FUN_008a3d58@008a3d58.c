...
undefined8 FUN_008a3d58(undefined8 param_1)

{
  ...
  if (((iVar4 == 0) || (iVar4 = tolua_isusertype(param_1,2,"CCArray",0,auStack_48), iVar4 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'alignItemsInRowsWithArray\'.",auStack_48);
  }
  else {
    this = (Menu *)tolua_tousertype(param_1,1,0);
    p_Var5 = (__Array *)tolua_tousertype(param_1,2,0);
    if (this == (Menu *)0x0) {
      tolua_error(param_1,"invalid \'self\' in function \'alignItemsInRowsWithArray\'",0);
    }
    local_58 = (Value *)0x0;
    uStack_50 = 0;
    local_60 = (Value *)0x0;
    array_to_valuevector_deprecated(p_Var5,(vector *)&local_60);
    cocos2d::Menu::alignItemsInRowsWithArray(this,(vector *)&local_60);
    pVVar3 = local_60;
    pVVar2 = local_58;
