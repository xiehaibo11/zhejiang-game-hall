...
/* double cocos2d::JniHelper::callStaticDoubleMethod<char const*,
   double>(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&, std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, char const*, double) */

double cocos2d::JniHelper::callStaticDoubleMethod<char_const*,double>
                 (basic_string *param_1,basic_string *param_2,char *param_3,double param_4)

{
  ...
  getJNISignature<char_const*,double>(param_3,param_4);
  ...
  *puVar7 = 0;
  ...
  if ((uVar8 & 1) == 0) {
    ...
    dVar14 = (double)_JNIEnv::CallStaticDoubleMethod(p_Var5,p_Var6,param_4,local_78,uVar9);
