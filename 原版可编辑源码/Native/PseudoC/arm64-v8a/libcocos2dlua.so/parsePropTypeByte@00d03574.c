...
/* cocosbuilder::NodeLoader::parsePropTypeByte(cocos2d::Node*, cocos2d::Node*,
   cocosbuilder::CCBReader*, char const*) */

undefined4 __thiscall
cocosbuilder::NodeLoader::parsePropTypeByte
...

{
  ...
  *this_00;
  ...
  uVar2 = CCBReader::readByte(param_3);
  ...
  if (lVar4 + 8 != lVar3) {
    ...
    cocos2d::Value::Value(aVStack_68,(uchar)uVar2);
    std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
    basic_string<decltype(nullptr)>(local_80,param_4);
