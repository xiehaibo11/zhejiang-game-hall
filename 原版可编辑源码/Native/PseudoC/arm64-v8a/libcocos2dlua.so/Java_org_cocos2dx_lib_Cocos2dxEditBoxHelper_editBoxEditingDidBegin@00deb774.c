...
void Java_org_cocos2dx_lib_Cocos2dxEditBoxHelper_editBoxEditingDidBegin
...

{
  ...
  lVar2 = tpidr_el0;
                    /* try { // try from 00deb788 to 00eeb78f has its CatchHandler @ 00deb7c0 */
  local_28 = *(long *)(lVar2 + 0x28);
                    /* try { // try from 00deb790 to 00eeb7df has its CatchHandler @ 00deb734 */
  local_3c[0] = param_3;
  if (DAT_01788ae8 != 0) {
    ...
    if (uVar4 < 2) {
      uVar6 = DAT_01788ae8 - 1 & uVar5;
                    ...
                    /* catch() { ... } // from try @ 00deb788 with catch @ 00deb7c0 */
      uVar6 = uVar5;
      if (DAT_01788ae8 <= uVar5) {
                    /* catch() { ... } // from try @ 00deb76c with catch @ 00deb7c8 */
        uVar6 = 0;
        if (DAT_01788ae8 != 0) {
