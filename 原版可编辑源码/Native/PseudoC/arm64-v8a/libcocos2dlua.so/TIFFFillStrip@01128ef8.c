  ...
  if ((uVar5 >> 0x11 & 1) == 0) {
    ...
    if (*(long *)(param_1 + 0x370) < (long)uVar12) {
      ...
      *(uint *)(param_1 + 0x10) = uVar5;
      if (pvVar4 == (void *)0x0) goto LAB_011291d4;
    }
    if ((uVar5 >> 0x17 & 1) == 0) {
...
LAB_011291d4:
    ...
    uVar11 = FUN_011292f4(param_1,uVar11,pvVar4,uVar12,"TIFFFillStrip");
    if (uVar11 != uVar12) {
      return 0;
    }
    *(undefined8 *)(param_1 + 0x378) = 0;
...
LAB_01129108:
  ...
  if ((iVar3 != 0) && (*(long *)(param_1 + 0xf0) != 0)) {
    ...
    *(undefined8 *)(param_1 + 0x390) = uVar6;
                    /* WARNING: Could not recover jumptable at 0x011291a0. Too many branches */
