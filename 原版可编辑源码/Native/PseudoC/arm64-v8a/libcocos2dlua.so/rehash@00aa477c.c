...

{
  ...
  undefined8 uVar4;
                    ...
                    /* try { // try from 00aa4788 to 00ba479b has its CatchHandler @ 00aa4820 */
  if (param_1 - 1 == 0) {
    param_1 = 2;
  }
  else {
                    /* try { // try from 00aa47a0 to 00ba47d3 has its CatchHandler @ 00aa4824 */
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
                    /* try { // try from 00aa47d4 to 00ba486f has its CatchHandler @ 00aa45dc */
      ...
      if ((uVar2 < 3) ||
        ...
        uVar1 = __next_prime(uVar1);
                    ...
                    /* catch() { ... } // from try @ 00aa4788 with catch @ 00aa4820 */
        uVar1 = 1L << ((ulong)(uint)-(int)LZCOUNT(uVar1 - 1) & 0x3f);
                    /* catch() { ... } // from try @ 00aa47a0 with catch @ 00aa4824 */
      }
      if (uVar1 <= param_1) {
        uVar1 = param_1;
      }
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00aa4840;
    }
                    /* catch() { ... } // from try @ 00aa4754 with catch @ 00aa4854 */
    return;
  }
LAB_00aa4840:
