...
/* void std::__ndk1::vector<cocostudio::Tween*, std::__ndk1::allocator<cocostudio::Tween*>
   >::__push_back_slow_path<cocostudio::Tween* const&>(cocostudio::Tween* const&) */

void __thiscall
std::__ndk1::vector<cocostudio::Tween*,std::__ndk1::allocator<cocostudio::Tween*>>::
__push_back_slow_path<cocostudio::Tween*const&>
          (vector<cocostudio::Tween*,std::__ndk1::allocator<cocostudio::Tween*>> *this,
          Tween **param_1)
