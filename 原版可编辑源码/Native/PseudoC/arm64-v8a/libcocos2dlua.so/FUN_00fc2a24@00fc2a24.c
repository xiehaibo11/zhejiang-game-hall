...
void FUN_00fc2a24(long *param_1,int *param_2,ulong param_3,ulong param_4,ulong param_5,int param_6)

{
  ...
  *param_1 = (long)(puVar14 + 2);
  uVar17 = uVar5 & 0x300 | (uVar5 >> 4 & 0x3f) << 10;
  uVar9 = ((uint)uVar5 << 3 | (uint)uVar5 << 9) & 0xf800f8;
  uVar15 = ((uint)uVar4 << 3 | (uint)uVar4 << 8) & 0xf800f8;
  uVar19 = (uVar4 & 0x7e0) >> 1 & 0x300 | (uVar4 >> 5 & 0x3f) << 10;
  local_28[2] = uVar17 | uVar13 | uVar9;
  if ((short)uVar5 < 0) {
    uVar10 = uVar9 - (uVar15 >> 2) & 0xff00fe;
    uVar16 = uVar17 - (uVar19 >> 2);
    local_28[0] = 0;
  }
  else {
    uVar10 = (uVar15 + uVar9 * 2) * 0x15 >> 6 & 0xff00ff;
    uVar16 = (uVar19 + uVar17 * 2) * 0x15 >> 6;
    local_28[0] = local_28[2];
    local_28[2] = (uVar9 + uVar15 * 2) * 0x15 >> 6 & 0xff00ff | uVar13 |
                  (uVar17 + uVar19 * 2) * 0x15 >> 6 & 0xff00;
  }
  local_28[3] = uVar15 | uVar13 | uVar19;
  local_28[1] = uVar10 | uVar13 | uVar16 & 0xff00;
