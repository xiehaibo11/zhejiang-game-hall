...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<cocos2d::Node*,
   ...
   cocos2d::Animation3D::Curve*>, std::__ndk1::__unordered_map_hasher<cocos2d::Node*,
   ...
   cocos2d::Animation3D::Curve*> > >::__emplace_unique_key_args<cocos2d::Node*,
      ...
      for (pNVar7 = (Node *)**(long **)(*param_1 + (long)unaff_x24 * 8); pNVar7 != (Node *)0x0;
        ...
        if (pNVar5 != pNVar9) {
          if (uVar6 < 2) {
            ...
            if (pNVar5 + -(uVar1 * (long)pNVar8) == unaff_x24) goto LAB_00d0a8e0;
            break;
          }
...
LAB_00d0a8e0:
  ...
  *(undefined8 *)(pNVar7 + 0x18) = 0;
  if ((pNVar8 == (Node *)0x0) || (*(float *)(param_1 + 4) * (float)pNVar8 < (float)(param_1[3] + 1))
    ...
    rehash((__hash_table<std::__ndk1::__hash_value_type<cocos2d::Node*,cocos2d::Animation3D::Curve*>,std::__ndk1::__unordered_map_hasher<cocos2d::Node*,std::__ndk1::__hash_value_type<cocos2d::Node*,cocos2d::Animation3D::Curve*>,std::__ndk1::hash<cocos2d::Node*>,true>,std::__ndk1::__unordered_map_equal<cocos2d::Node*,std::__ndk1::__hash_value_type<cocos2d::Node*,cocos2d::Animation3D::Curve*>,std::__ndk1::equal_to<cocos2d::Node*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<cocos2d::Node*,cocos2d::Animation3D::Curve*>>>
            *)param_1,uVar6);
    pNVar8 = param_1[1];
  ...
  if (pNVar9 == (Node *)0x0) {
    ...
    *(Node ***)(pNVar5 + (long)unaff_x24 * 8) = ppNVar4;
    if (*(long *)pNVar7 == 0) goto LAB_00d0aa34;
