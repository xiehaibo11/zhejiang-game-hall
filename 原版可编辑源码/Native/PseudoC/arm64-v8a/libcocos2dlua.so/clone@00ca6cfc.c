...
/* cocostudio::timeline::RotationSkewFrame::clone() */

Ref * __thiscall cocostudio::timeline::RotationSkewFrame::clone(RotationSkewFrame *this)

{
  ...
  *(undefined8 *)(this_00 + 0x4c) = 0;
  *(undefined ***)this_00 = &PTR__Frame_016cba20;
