...

{
  ...
  *(undefined8 *)&ctx->error = 0;
  ...
  if (store == (X509_STORE *)0x0) {
    ...
    ctx->get_issuer = (_func_1857 *)&LAB_00b6ed88;
    ctx->other_ctx = FUN_00b6ee70;
    ctx->verify = (_func_1855 *)&DAT_00b6ee6c;
    ctx->get_crl = (_func_1860 *)&DAT_00b6f328;
    ctx->check_crl = (_func_1861 *)&LAB_00b6f644;
    ctx->check_issued = FUN_00b6f068;
    ctx->check_revocation = (_func_1859 *)0x0;
    ctx->cert_crl = (_func_1862 *)&DAT_00b6f6ec;
...
LAB_00b6ec18:
    ...
    p_Var1 = (_func_1846 *)&LAB_00b6ed88;
    ...
    p_Var3 = (_func_1844 *)&DAT_00b6ee6c;
    ...
    if (pcVar12 == (_func_1864 *)0x0) goto LAB_00b6ec18;
  }
