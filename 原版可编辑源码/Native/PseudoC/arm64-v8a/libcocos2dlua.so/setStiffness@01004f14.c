...
/* cocos2d::PhysicsJointSpring::setStiffness(float) */

void __thiscall cocos2d::PhysicsJointSpring::setStiffness(PhysicsJointSpring *this,float param_1)

{
  ...
  if (this[100] == (PhysicsJointSpring)0x0) {
    cpDampedSpringSetStiffness(**(undefined8 **)(this + 8));
  }
  else {
    lVar2 = *(long *)(this + 0x50);
    *(undefined1 *)(lVar2 + 0x58) = 1;
    *(float *)(lVar2 + 0x5c) = param_1;
    local_70 = &PTR_FUN_01725818;
                    /* catch() { ... } // from try @ 01004da0 with catch @ 01004f98 */
    ...
    if (lVar2 == *(long *)(this + 0x30)) {
      ...
      *(long *)(lVar2 + 0x20) = lVar2;
      local_50 = (long *)&local_70;
      FUN_01007c1c(FUN_01007c1c,&local_70,lVar2);
    ...
    if (&local_70 == (undefined ***)local_50) {
      ...
      if (local_50 == (long *)0x0) goto LAB_01004f4c;
