...

{
  ...
  long lVar3;
                    ...
                    /* try { // try from 0110fb34 to 0120fb87 has its CatchHandler @ 0110fb34
                       catch() { ... } // from try @ 0110fb34 with catch @ 0110fb34
                       catch() { ... } // from try @ 0110fb90 with catch @ 0110fb34 */
  ...
  if (*(void **)(param_1 + 0xc0) != (void *)0x0) {
    ...
    *(undefined8 *)(param_1 + 0xc0) = 0;
                    ...
                    /* try { // try from 0110fb88 to 0120fb8f has its CatchHandler @ 0110fbb0 */
  if (*(void **)(param_1 + 200) != (void *)0x0) {
    _TIFFfree(*(void **)(param_1 + 200));
                    /* try { // try from 0110fb90 to 0120fbcb has its CatchHandler @ 0110fb34 */
  ...
  if (*(void **)(param_1 + 0x100) != (void *)0x0) {
    _TIFFfree(*(void **)(param_1 + 0x100));
                    /* catch() { ... } // from try @ 0110fb88 with catch @ 0110fbb0 */
