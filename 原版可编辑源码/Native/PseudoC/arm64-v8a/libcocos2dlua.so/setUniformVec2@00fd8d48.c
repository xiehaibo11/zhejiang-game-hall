...
/* cocos2d::GLProgramState::setUniformVec2(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, cocos2d::Vec2 const&) */

void __thiscall
cocos2d::GLProgramState::setUniformVec2(GLProgramState *this,basic_string *param_1,Vec2 *param_2)

{
  ...
  long local_38;
                    ...
                    /* catch() { ... } // from try @ 00fd8d10 with catch @ 00fd8d54 */
  lVar1 = tpidr_el0;
  ...
  if (lVar2 != 0) {
    local_40 = (piecewise_construct_t *)(lVar2 + 0x28);
                    /* catch() { ... } // from try @ 00fd8dd4 with catch @ 00fd8da4 */
    lVar2 = std::__ndk1::
  ...
  if (*(long *)(lVar1 + 0x28) == local_38) {
                    /* try { // try from 00fd8dcc to 010d8dd3 has its CatchHandler @ 00fd8e0c */
                    /* try { // try from 00fd8dd4 to 010d8e27 has its CatchHandler @ 00fd8da4 */
    return;
  }
