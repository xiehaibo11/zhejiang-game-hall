      ...
      if (plVar8 != (long *)0x0) {
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (sVar1 == __n) {
              __s1 = (void *)plVar8[4];
                    /* try { // try from 00dffe84 to 00efff0b has its CatchHandler @ 00dffe84
                       catch() { ... } // from try @ 00dffe84 with catch @ 00dffe84
                       catch() { ... } // from try @ 00dfff24 with catch @ 00dffe84 */
              if ((bVar3 & 1) == 0) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00dffe4c;
              goto LAB_00dffefc;
            }
            if (uVar9 != uVar14) goto LAB_00dffefc;
          }
LAB_00dffe4c:
          plVar8 = (long *)*plVar8;
...
LAB_00dffefc:
  plVar8 = (long *)0x0;
LAB_00dfff00:
                    /* try { // try from 00dfff0c to 00efff23 has its CatchHandler @ 00dfff64 */
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* try { // try from 00dfff24 to 00efff7f has its CatchHandler @ 00dffe84 */
    return plVar8;
  }
