...
/* bool cocos2d::StringUtils::utfConvert<char16_t, char,
   cocos2d::StringUtils::ConvertTrait<char16_t>, cocos2d::StringUtils::ConvertTrait<char>
   >(std::__ndk1::basic_string<char16_t, std::__ndk1::char_traits<char16_t>,
   std::__ndk1::allocator<char16_t> > const&, std::__ndk1::basic_string<char,
...
bool cocos2d::StringUtils::
     utfConvert<char16_t,char,cocos2d::StringUtils::ConvertTrait<char16_t>,cocos2d::StringUtils::ConvertTrait<char>>
               ...
               _func_ConversionResult_ArgType_ptr_ptr_ArgType_ptr_ArgType_ptr_ptr_ArgType_ptr_ConversionFlags_conflict1
               *param_3)

{
  ...
  if (uVar5 == 0) {
    ...
    if (uVar6 < 0x17) {
      ...
      if (uVar6 != 0) goto LAB_00fc5c80;
      *pAVar7 = (ArgType)0x0;
      if (((byte)bVar1 & 1) != 0) goto LAB_00fc5c98;
LAB_00fc5c44:
      local_78 = param_1 + 2;
      uVar5 = (ulong)((byte)bVar1 >> 1);
    }
...
LAB_00fc5c80:
      ...
      if (((byte)bVar1 & 1) == 0) goto LAB_00fc5c44;
LAB_00fc5c98:
      uVar5 = *(ulong *)(param_1 + 8);
    ...
    cVar3 = (*param_3)((ArgType **)&local_78,(ArgType *)(local_78 + uVar5 * 2),&local_80,
                       local_80 + uVar6,0);
    if (cVar3 != '\0') {
      if ((local_70 & 1) != 0) {
...
LAB_00fc5d84:
      ...
      *(undefined8 *)(param_2 + 8) = 0;
      ...
      bVar1 = *param_2;
joined_r0x00fc5d80:
      if (((byte)bVar1 & 1) != 0) goto LAB_00fc5d84;
LAB_00fc5d38:
      *(undefined2 *)param_2 = 0;
    }
