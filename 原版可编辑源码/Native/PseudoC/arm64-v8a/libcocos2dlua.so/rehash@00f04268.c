...

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
                    /* try { // try from 00f042d0 to 010042df has its CatchHandler @ 00f04784 */
      uVar1 = (ulong)((float)*(ulong *)(this + 0x18) / *(float *)(this + 0x20));
                    /* try { // try from 00f042e0 to 010042fb has its CatchHandler @ 00f04764 */
      if ((uVar2 < 3) ||
        ...
        uVar1 = __next_prime(uVar1);
                    ...
                    /* try { // try from 00f042fc to 0100438b has its CatchHandler @ 00f04134 */
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00f0432c;
    }
    return;
  }
LAB_00f0432c:
