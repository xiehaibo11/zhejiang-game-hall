...
::__clone(__func<std::__ndk1::__bind<void(cocostudio::InputDelegate::*)(cocos2d::Acceleration*,cocos2d::Event*),cocostudio::InputDelegate*,std::__ndk1::placeholders::__ph<1>const&,std::__ndk1::placeholders::__ph<2>const&>,std::__ndk1::allocator<std::__ndk1::__bind<void(cocostudio::InputDelegate::*)(cocos2d::Acceleration*,cocos2d::Event*),cocostudio::InputDelegate*,std::__ndk1::placeholders::__ph<1>const&,std::__ndk1::placeholders::__ph<2>const&>>,void(cocos2d::Acceleration*,cocos2d::Event*)>
          *this,__base *param_1)

{
  ...
  *(undefined ***)param_1 = &PTR_FUN_016ca538;
