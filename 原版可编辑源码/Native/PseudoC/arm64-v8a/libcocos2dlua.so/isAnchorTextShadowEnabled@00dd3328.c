...
/* cocos2d::ui::RichText::isAnchorTextShadowEnabled() */

bool __thiscall cocos2d::ui::RichText::isAnchorTextShadowEnabled(RichText *this)

{
  ...
  sVar1 = (ulong)(VALUE_TEXT_STYLE_SHADOW >> 1);
  ...
  if (__n == sVar1) {
    ...
    if (((ulong)local_58 & 1) == 0) {
      ...
      do {
        if (*pcVar6 != *__s2) goto LAB_00dd3404;
        uVar5 = uVar5 - 1;
        pcVar6 = pcVar6 + 1;
        __s2 = __s2 + 1;
      } while (uVar5 != 0);
      bVar3 = true;
      goto joined_r0x00dd3408;
    }
    if (__n == 0) {
      bVar3 = true;
    }
...
LAB_00dd3404:
    bVar3 = false;
joined_r0x00dd3408:
    if (((ulong)local_58 & 1) == 0) goto LAB_00dd343c;
  }
