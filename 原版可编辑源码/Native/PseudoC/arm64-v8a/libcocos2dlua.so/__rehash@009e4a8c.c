...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<void*, int>,
   ...
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<void*, int> > >::__rehash(unsigned long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<void*,int>,std::__ndk1::__unordered_map_hasher<void*,std::__ndk1::__hash_value_type<void*,int>,std::__ndk1::hash<void*>,true>,std::__ndk1::__unordered_map_equal<void*,std::__ndk1::__hash_value_type<void*,int>,std::__ndk1::equal_to<void*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<void*,int>>>
           *this,ulong param_1)

{
  ...
  if (param_1 == 0) {
    ...
    *(undefined8 *)(this + 8) = 0;
                    ...
                    /* catch() { ... } // from try @ 009e4b78 with catch @ 009e4aa4
                       catch() { ... } // from try @ 009e4c98 with catch @ 009e4aa4 */
    if (param_1 >> 0x3d != 0) {
    ...
    if (plVar5 != (long *)0x0) {
      ...
      *(__hash_table<std::__ndk1::__hash_value_type<void*,int>,std::__ndk1::__unordered_map_hasher<void*,std::__ndk1::__hash_value_type<void*,int>,std::__ndk1::hash<void*>,true>,std::__ndk1::__unordered_map_equal<void*,std::__ndk1::__hash_value_type<void*,int>,std::__ndk1::equal_to<void*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<void*,int>>>
      ...
      if ((long *)*plVar5 != (long *)0x0) {
        ...
        do {
          uVar7 = plVar6[1];
                    /* try { // try from 009e4b6c to 00ae4b77 has its CatchHandler @ 009e4ccc */
          if ((uVar12 & 0xffffffff) < 2) {
            uVar7 = uVar7 & param_1 - 1;
          }
          else if (param_1 <= uVar7) {
                    /* try { // try from 009e4b78 to 00ae4c8b has its CatchHandler @ 009e4aa4 */
            uVar1 = 0;
            if (param_1 != 0) {
              uVar1 = uVar7 / param_1;
            }
