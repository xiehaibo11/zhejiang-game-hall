...
undefined4 FUN_00eb5514(long *param_1)
    ...
    if (iVar3 == 5) {
      while( true ) {
        ...
        if (iVar3 == 0) {
          ...
          if ((uVar15 == 0xffffffffffffffff) || (lStack_a8 != 0)) goto LAB_00eb59a4;
          if ((int)param_1[1] == 0) {
            uVar14 = 0;
          }
          else {
          ...
          if ((int)uVar14 < 1) goto LAB_00eb59a0;
          uVar15 = (ulong)uVar14;
          if (uVar14 != 1) {
...
LAB_00eb564c:
      if ((int)param_1[1] == 0) {
        iVar3 = FUN_00eb5334(param_1,plVar7,plVar1,lVar6,&local_90);
        if (iVar3 == 0) {
...
LAB_00eb59b8:
            ...
            if ((int)param_1[0x17] == iVar5) {
              ...
              else if (iVar3 < 3) goto LAB_00eb57ac;
...
LAB_00eb57ac:
              ...
              *(int *)(param_1 + 0x17) = iVar5;
              iVar3 = FUN_00eb5334(param_1,plVar7,plVar1,lVar6,0);
              if (iVar3 != 0) goto LAB_00eb590c;
            }
            if (*param_1 != 0) {
...
LAB_00eb59a8:
    ...
    iVar3 = FUN_00eb4510(param_1,&local_90,0xffffffffffffffff);
    if (iVar3 < 0) goto LAB_00eb5904;
    iVar3 = (int)param_1[0x16];
    param_1[0x18] = param_1[0x18] + (long)(int)uStack_88 * 8;
    if (iVar3 != 5) {
LAB_00eb5604:
      if (iVar3 < 3) goto LAB_00eb564c;
      goto LAB_00eb56ec;
    }
    ...
    if (iVar5 != iVar4) {
      ...
      else if (iVar3 < 3) goto LAB_00eb564c;
      vorbis_info_clear(plVar7);
      vorbis_comment_clear(plVar1);
      *(undefined4 *)(param_1 + 0x16) = 2;
      goto LAB_00eb564c;
    }
    if (iVar3 != 5) goto LAB_00eb5604;
LAB_00eb5888:
