...
/* void std::__ndk1::vector<fairygui::GTweener*, std::__ndk1::allocator<fairygui::GTweener*>
   >::__push_back_slow_path<fairygui::GTweener* const&>(fairygui::GTweener* const&) */

void __thiscall
std::__ndk1::vector<fairygui::GTweener*,std::__ndk1::allocator<fairygui::GTweener*>>::
__push_back_slow_path<fairygui::GTweener*const&>
          (vector<fairygui::GTweener*,std::__ndk1::allocator<fairygui::GTweener*>> *this,
          GTweener **param_1)
