    ...
    if (param_1 != 0) {
      ...
      *(undefined4 *)(param_1 + 0x4e4) = 0x82;
      ...
      png_write_data(param_1,&local_60,4);
                    ...
                    /* try { // try from 010dc770 to 011dc777 has its CatchHandler @ 010dc880 */
                    /* try { // try from 010dc778 to 011dc893 has its CatchHandler @ 010dc604 */
    png_warning(param_1,"Can\'t write sCAL (buffer too small)");
  }
                    /* catch() { ... } // from try @ 010dc770 with catch @ 010dc880 */
  if (*(long *)(lVar3 + 0x28) == local_58) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010dc8e8 with catch @ 010dc894
                        */
    return;
  }
