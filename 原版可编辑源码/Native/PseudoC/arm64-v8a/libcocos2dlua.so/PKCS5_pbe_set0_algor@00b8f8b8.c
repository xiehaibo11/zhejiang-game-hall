...
LAB_00b8fa58:
  CRYPTO_free(buf);
                    /* try { // try from 00b8fa78 to 00c8fbe7 has its CatchHandler @ 00b8fa78
                       catch() { ... } // from try @ 00b8fa78 with catch @ 00b8fa78
                       catch() { ... } // from try @ 00b8fbec with catch @ 00b8fa78
                       catch() { ... } // from try @ 00b8fca0 with catch @ 00b8fa78 */
  ASN1_item_free(val,(ASN1_ITEM *)PBEPARAM_it);
