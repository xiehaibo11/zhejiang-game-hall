...
undefined4 FUN_011404b8(uint param_1,ulong param_2,long param_3,uint *param_4)

{
  ...
  if (param_3 != 0) {
    ...
    if (*(int *)(param_3 + 0x1c) != 0) {
      ...
      iVar20 = FUN_01140220(param_1,param_2,&local_64,&local_68);
      if (iVar20 == 0) {
        return 2;
      }
  ...
  if ((param_4[3] == 0) && (*(long *)(param_4 + 0x1c) == 0)) {
    iVar20 = *(int *)(&DAT_01498580 + (ulong)uVar15 * 4);
  ...
  if (uVar22 < 0xb) {
    ...
    bVar4 = (int)uVar14 < (int)(*(int *)(&DAT_01498580 + (ulong)uVar22 * 4) * uVar15);
    uVar26 = 0;
