...
/* void std::__ndk1::vector<cocos2d::Component*, std::__ndk1::allocator<cocos2d::Component*>
   >::__push_back_slow_path<cocos2d::Component* const&>(cocos2d::Component* const&) */

void __thiscall
std::__ndk1::vector<cocos2d::Component*,std::__ndk1::allocator<cocos2d::Component*>>::
__push_back_slow_path<cocos2d::Component*const&>
          (vector<cocos2d::Component*,std::__ndk1::allocator<cocos2d::Component*>> *this,
          Component **param_1)
