...

{
      ...
      if (*(int *)plVar6[1] == 1) {
        ...
        if (1 < iVar4) {
          ...
          do {
            ...
            iVar5 = FUN_00b78528(val,auStack_70,auStack_80,__n);
            if (iVar5 == 0) {
              return 0;
            }
            iVar5 = FUN_00b78528(val_00,acStack_91 + 1,auStack_a0,__n);
            if (iVar5 == 0) {
              return 0;
            }
            ...
            iVar5 = memcmp(auStack_80,acStack_91 + 1,__n);
            if (iVar5 == 0) {
              uVar7 = FUN_00b78250(&local_a8,auStack_70,auStack_a0,__n);
              if ((int)uVar7 == 0) {
                return uVar7;
              }
        ...
        if (((piVar8 != (int *)0x0) && (*piVar8 == 1)) &&
           ((iVar4 = FUN_00b78528(piVar8,auStack_70,auStack_80,__n), iVar4 == 0 ||
  ...
  OPENSSL_sk_set_cmp_func(param_1,&LAB_00b789dc);
