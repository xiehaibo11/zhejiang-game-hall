...
/* bool 
   universe::network::GuoPengFei::sendMessage<universe::network::SRS::ReqKey32>(universe::network::SRS::ReqKey32&,
   int, int) */

bool __thiscall
universe::network::GuoPengFei::sendMessage<universe::network::SRS::ReqKey32>
          (GuoPengFei *this,ReqKey32 *param_1,int param_2,int param_3)
