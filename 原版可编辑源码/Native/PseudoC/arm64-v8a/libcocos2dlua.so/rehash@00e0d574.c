...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int, cocos2d::Color3B>,
   ...
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<int, cocos2d::Color3B> > >::rehash(unsigned
   long) */
...

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
                    /* try { // try from 00e0d5dc to 00f0d5eb has its CatchHandler @ 00e0db0c */
      uVar1 = (ulong)((float)*(ulong *)(this + 0x18) / *(float *)(this + 0x20));
                    /* try { // try from 00e0d5ec to 00f0d72f has its CatchHandler @ 00e0d3f0 */
      if ((uVar2 < 3) ||
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00e0d638;
    }
    return;
  }
LAB_00e0d638:
