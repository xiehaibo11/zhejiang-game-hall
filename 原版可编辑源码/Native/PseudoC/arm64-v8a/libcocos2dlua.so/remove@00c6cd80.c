...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<cocostudio::Armature*,
   ...
   cocostudio::ArmatureMovementDispatcher*> >
   >::remove(std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<cocostudio::Armature*,
   cocostudio::ArmatureMovementDispatcher*>, void*>*>) */
...

{
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar7 == uVar4) goto LAB_00c6ce5c;
  }
  if (*param_3 != 0) {
