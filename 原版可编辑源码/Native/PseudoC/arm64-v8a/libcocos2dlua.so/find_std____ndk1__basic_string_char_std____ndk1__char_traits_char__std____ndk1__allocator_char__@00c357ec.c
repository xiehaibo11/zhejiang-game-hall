...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   cocos2d::Vector<cocostudio::ActionObject*> >, void*>*>
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::Vector<cocostudio::ActionObject*> > > >::find<std::__ndk1::basic_string<char,
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00c358c8;
              goto LAB_00c35978;
            }
            if (uVar9 != uVar14) goto LAB_00c35978;
          }
LAB_00c358c8:
          plVar8 = (long *)*plVar8;
