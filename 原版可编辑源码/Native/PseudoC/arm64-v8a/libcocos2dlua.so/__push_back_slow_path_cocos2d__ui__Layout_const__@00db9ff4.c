...
/* void std::__ndk1::vector<cocos2d::ui::Layout*, std::__ndk1::allocator<cocos2d::ui::Layout*>
   >::__push_back_slow_path<cocos2d::ui::Layout* const&>(cocos2d::ui::Layout* const&) */

void __thiscall
std::__ndk1::vector<cocos2d::ui::Layout*,std::__ndk1::allocator<cocos2d::ui::Layout*>>::
__push_back_slow_path<cocos2d::ui::Layout*const&>
          (vector<cocos2d::ui::Layout*,std::__ndk1::allocator<cocos2d::ui::Layout*>> *this,
          Layout **param_1)
