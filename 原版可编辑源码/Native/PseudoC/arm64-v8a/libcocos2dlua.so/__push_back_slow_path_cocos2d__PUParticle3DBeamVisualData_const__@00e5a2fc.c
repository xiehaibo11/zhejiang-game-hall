...
/* void std::__ndk1::vector<cocos2d::PUParticle3DBeamVisualData*,
   std::__ndk1::allocator<cocos2d::PUParticle3DBeamVisualData*>
   >::__push_back_slow_path<cocos2d::PUParticle3DBeamVisualData*
   const&>(cocos2d::PUParticle3DBeamVisualData* const&) */
...
::__push_back_slow_path<cocos2d::PUParticle3DBeamVisualData*const&>
          (vector<cocos2d::PUParticle3DBeamVisualData*,std::__ndk1::allocator<cocos2d::PUParticle3DBeamVisualData*>>
           *this,PUParticle3DBeamVisualData **param_1)
