...
undefined4 FUN_011780e0(long *param_1,int param_2)
      ...
      if (uVar4 == 0) {
        *(undefined4 *)((long)param_1 + 0x171c) = 0;
        if (param_2 == 4) {
          ...
          FUN_0117c24c(param_1,lVar5,*(uint *)((long)param_1 + 0x9c) - uVar2,1);
          lVar7 = *param_1;
        ...
        if ((long)uVar2 < (long)(ulong)*(uint *)((long)param_1 + 0x9c)) {
          ...
          FUN_0117c24c(param_1,lVar5,*(uint *)((long)param_1 + 0x9c) - uVar2,0);
          lVar7 = *param_1;
          param_1[0x11] = (ulong)*(uint *)((long)param_1 + 0x9c);
          lVar5 = *(long *)(lVar7 + 0x38);
          FUN_0117c078(lVar5);
    ...
    *(uint *)((long)param_1 + 0x9c) = uVar4;
    if ((uVar4 == 0) || (uVar6 <= uVar4)) {
      ...
      *(int *)((long)param_1 + 0x9c) = (int)uVar6;
      ...
      FUN_0117c24c(param_1,lVar5,(uVar6 & 0xffffffff) - uVar3,0);
      lVar7 = *param_1;
      param_1[0x11] = (ulong)*(uint *)((long)param_1 + 0x9c);
      lVar5 = *(long *)(lVar7 + 0x38);
      FUN_0117c078(lVar5);
    ...
    if (*(int *)((long)param_1 + 0x44) - 0x106U <= uVar4 - (int)uVar3) {
      ...
      FUN_0117c24c(param_1,lVar5,uVar4 - uVar3,0);
      lVar7 = *param_1;
      param_1[0x11] = (ulong)*(uint *)((long)param_1 + 0x9c);
      lVar5 = *(long *)(lVar7 + 0x38);
      FUN_0117c078(lVar5);
