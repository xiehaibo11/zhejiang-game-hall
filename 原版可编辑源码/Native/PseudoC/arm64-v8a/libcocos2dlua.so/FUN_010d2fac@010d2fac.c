...
void FUN_010d2fac(long param_1,byte *param_2,byte *param_3)

{
  ...
  undefined8 uVar33;
                    ...
                    /* try { // try from 010d2fb0 to 011d2fb7 has its CatchHandler @ 010d3550 */
  lVar7 = *(long *)(param_1 + 8);
  uVar10 = (ulong)*(byte *)(param_1 + 0x13) + 7;
                    /* try { // try from 010d2fb8 to 011d2ff7 has its CatchHandler @ 010d27c8 */
  uVar6 = uVar10 >> 3;
  uVar8 = lVar7 - uVar6;
  pbVar5 = param_3;
  if (uVar6 == 0) goto LAB_010d3018;
...
LAB_010d2ff4:
    lVar11 = uVar6 - uVar10;
    do {
                    /* try { // try from 010d2ff8 to 011d2fff has its CatchHandler @ 010d354c */
                    /* try { // try from 010d3000 to 011d303f has its CatchHandler @ 010d27c8 */
      lVar11 = lVar11 + -1;
    ...
    if (uVar6 != uVar10) goto LAB_010d2ff4;
  }
...
LAB_010d3018:
  if (uVar8 != 0) {
    ...
    if ((0x1f < uVar8) && (uVar10 = uVar8 & 0xffffffffffffffe0, uVar10 != 0)) {
                    /* try { // try from 010d3040 to 011d3047 has its CatchHandler @ 010d3548 */
                    /* try { // try from 010d3048 to 011d3087 has its CatchHandler @ 010d27c8 */
      if ((param_2 < pbVar5 + uVar8 && pbVar5 < param_2 + uVar8) ||
        ...
        uVar13 = uVar10;
        do {
                    /* try { // try from 010d3088 to 011d308f has its CatchHandler @ 010d3544 */
          pbVar1 = pbVar4 + lVar11;
          uVar17 = *(undefined8 *)(pbVar4 + 8);
          uVar16 = *(undefined8 *)pbVar4;
          uVar19 = *(undefined8 *)(pbVar4 + 0x18);
          uVar18 = *(undefined8 *)(pbVar4 + 0x10);
                    /* try { // try from 010d3090 to 011d30cf has its CatchHandler @ 010d27c8 */
          ...
          uVar30 = (ushort)(byte)((ulong)uVar32 >> 0x10) + (ushort)(byte)((ulong)uVar24 >> 0x10);
                    /* try { // try from 010d30d0 to 011d30d7 has its CatchHandler @ 010d3540 */
                    /* try { // try from 010d30d8 to 011d3117 has its CatchHandler @ 010d27c8 */
          uVar13 = uVar13 - 0x20;
          *(ulong *)(pbVar4 + 8) =
    ...
    do {
      lVar7 = lVar7 + -1;
                    /* try { // try from 010d3118 to 011d311f has its CatchHandler @ 010d352c */
                    /* try { // try from 010d3120 to 011d317f has its CatchHandler @ 010d27c8 */
