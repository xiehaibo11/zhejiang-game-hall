...
/* void std::__ndk1::vector<cocos2d::PUMaterial*, std::__ndk1::allocator<cocos2d::PUMaterial*>
   >::__push_back_slow_path<cocos2d::PUMaterial* const&>(cocos2d::PUMaterial* const&) */
