...
undefined4 FUN_010c7520(undefined8 *param_1)

{
  ...
  if ((uVar9 >> 1 & 1) == 0) {
    uVar19 = 0;
    if (uVar11 >> 2 == 0) goto LAB_010c7600;
LAB_010c75f0:
    uVar8 = 100000;
    if ((*(byte *)(puVar13 + 3) >> 2 & 1) != 0) goto LAB_010c7600;
  }
  else {
    if ((uVar3 >> 1 & 1) == 0) {
                    /* try { // try from 010c75c0 to 011c77bf has its CatchHandler @ 010c73bc */
      uVar19 = uVar11 & 1;
    ...
    if (uVar11 >> 2 != 0) goto LAB_010c75f0;
LAB_010c7600:
    uVar8 = 0xffffffff;
  }
  uVar18 = uVar3 & 4;
...
LAB_010c7730:
  ...
  if (uVar11 != 0) {
    ...
    png_error(lVar1,"png_read_image: unsupported transformation");
                    ...
                    /* catch() { ... } // from try @ 010c75b4 with catch @ 010c775c */
  png_set_keep_unknown_chunks(lVar1,1,0,0xffffffff);
                    /* catch() { ... } // from try @ 010c74ac with catch @ 010c776c */
  png_set_keep_unknown_chunks(lVar1,0,&DAT_01474716,6);
  iVar5 = 0;
  if (uVar20 == 2) {
    if ((*(byte *)(lVar1 + 0x168) >> 6 & 1) == 0) goto LAB_010c77a8;
LAB_010c7838:
    ...
    if ((*(byte *)(lVar1 + 0x168) >> 6 & 1) != 0) goto LAB_010c7838;
LAB_010c77a8:
  ...
  if ((uVar19 >> 0x11 & 1) == 0) {
    if ((uVar19 >> 0x18 & 1) != 0) {
      ...
      if (uVar20 == 2 && (*(uint *)(lVar1 + 0x168) & 0x80) == 0) goto LAB_010c78dc;
    }
  }
  else {
    uVar11 = uVar9;
...
LAB_010c78dc:
  ...
  if (bVar14) {
    ...
    param_1[5] = uVar8;
                    ...
                    /* try { // try from 010c7960 to 011c79a3 has its CatchHandler @ 010c7960
                       catch() { ... } // from try @ 010c7960 with catch @ 010c7960
                       catch() { ... } // from try @ 010c79a8 with catch @ 010c7960 */
    if (uVar20 != 2) {
      if (0 < iVar5) {
        while( true ) {
                    /* catch() { ... } // from try @ 010c79a4 with catch @ 010c79ec */
          for (iVar4 = *(int *)(puVar13 + 2); iVar4 != 0; iVar4 = iVar4 + -1) {
            png_read_row(lVar1,lVar16,0);
            lVar16 = lVar16 + lVar17;
                    /* catch() { ... } // from try @ 010c7a7c with catch @ 010c7a08 */
          }
          if (iVar5 < 2) break;
          lVar16 = param_1[6];
          iVar5 = iVar5 + -1;
  ...
  uVar6 = png_safe_execute(puVar13,pcVar7,param_1);
                    /* try { // try from 010c79a4 to 011c79a7 has its CatchHandler @ 010c79ec */
                    /* try { // try from 010c79a8 to 011c7a07 has its CatchHandler @ 010c7960 */
  param_1[5] = 0;
