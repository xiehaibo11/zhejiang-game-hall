...

{
  ...
  __n = (long)pvVar1 - (long)pvVar4;
                    /* try { // try from 00d8b9b8 to 00e8b9c7 has its CatchHandler @ 00d8cc30 */
...
LAB_00d8b9f0:
  ...
  lVar2 = *(long *)(this + 0x10) - (long)pvVar4;
                    /* try { // try from 00d8b9cc to 00e8b9db has its CatchHandler @ 00d8cc5c */
  if ((ulong)(lVar2 >> 2) < 0x1fffffffffffffff) {
    ...
    if (uVar5 >> 0x3e != 0) goto LAB_00d8b9f0;
  }
  else {
