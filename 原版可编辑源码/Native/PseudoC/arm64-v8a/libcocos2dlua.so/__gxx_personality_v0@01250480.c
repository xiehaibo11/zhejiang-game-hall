    ...
    if ((param_2 & 1) == 0) {
      if (((uint)param_2 >> 1 & 1) == 0) {
        ...
        if (((uint)param_2 >> 2 & 1) == 0) {
          FUN_01250620(&local_60,param_2,param_3 == 0x434c4e47432b2b00,param_4,param_5);
          if (local_38 != 6) {
            return local_38;
          }
          _Unwind_SetGR(param_5,0,param_4);
          _Unwind_SetGR(param_5,1,local_60);
          uVar3 = local_48;
        }
        else {
          if (param_3 == 0x434c4e47432b2b00) {
            ...
            FUN_01250620(&local_60,param_2,0,param_4,param_5);
            if (local_38 != 6) {
          ...
          lVar1 = local_60;
          _Unwind_SetGR(param_5,0,param_4);
          _Unwind_SetGR(param_5,1,lVar1);
        }
        _Unwind_SetIP(param_5,uVar3);
        iVar2 = 7;
      }
    }
    else {
