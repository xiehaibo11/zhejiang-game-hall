...
void FUN_010c7a3c(undefined8 *param_1,uint param_2,uint param_3,uint param_4,uint param_5,
...

{
  ...
  uVar15 = (ulong)param_4;
                    /* try { // try from 010c7a70 to 011c7a7b has its CatchHandler @ 010c7afc */
  uVar5 = *(uint *)((long)puVar19 + 0x14);
  uVar18 = (ulong)param_3;
                    /* try { // try from 010c7a7c to 011c7b1b has its CatchHandler @ 010c7a08 */
  bVar3 = (uVar5 >> 1 & 1) == 0;
  ...
  if (0xff < param_2) {
    ...
    png_error(*(undefined8 *)*puVar19,"color-map index out of range");
  }
  uVar13 = uVar5 >> 2 & 1;
  uVar5 = uVar5 & 4;
  iVar2 = uVar13 + 1;
  if ((param_7 == 3) && (param_7 = *(int *)(param_1 + 8), param_7 == 0)) {
    ...
    if (iVar10 != 0) {
                    /* catch() { ... } // from try @ 010c7a70 with catch @ 010c7afc */
                    /* catch() { ... } // from try @ 010c7b8c with catch @ 010c7b1c */
      if ((99999 < iVar6) ||
      ...
      *(undefined4 *)(param_1 + 8) = 1;
      goto switchD_010c7b6c_caseD_1;
    }
    *(undefined4 *)(param_1 + 8) = 4;
switchD_010c7b6c_caseD_4:
...
LAB_010c7e5c:
      if (uVar13 == 0) {
        ...
        uVar14 = param_5 * 0xff >> 0xf;
                    /* try { // try from 010c7ee8 to 011c7efb has its CatchHandler @ 010c7fb8 */
        ...
        uVar17 = (uint)*(ushort *)(png_sRGB_base + (ulong)uVar17 * 2) +
                 ((param_4 * 0xff & 0x7fff) * (uint)(byte)png_sRGB_delta[uVar17] >> 0xc);
                    /* try { // try from 010c7efc to 011c8003 has its CatchHandler @ 010c7dd4 */
      ...
      if (iVar2 != 2) goto LAB_010c7e6c;
    }
    else {
LAB_010c7c08:
      iVar6 = uVar17 * 0x1b38 + uVar14 * 0x5b8a + uVar12 * 0x93e;
      if (uVar5 == 0) {
                    /* try { // try from 010c7c4c to 011c7c6b has its CatchHandler @ 010c7d88 */
        uVar13 = (iVar6 + 0x80U >> 8) * 0xff + 0x40;
        uVar17 = uVar13 >> 0x16;
        param_7 = 1;
                    /* try { // try from 010c7c6c to 011c7c8f has its CatchHandler @ 010c7bd8 */
...
switchD_010c7b6c_default:
      if (param_7 != iVar2) goto LAB_010c7e6c;
    }
  }
  else {
LAB_010c7b50:
    switch(param_7) {
    case 1:
switchD_010c7b6c_caseD_1:
                    /* try { // try from 010c7b80 to 011c7b8b has its CatchHandler @ 010c7bb8 */
      if (uVar5 != 0 || bVar3 && (bVar8 || bVar9)) {
                    /* try { // try from 010c7b8c to 011c7bd7 has its CatchHandler @ 010c7b1c */
        ...
        param_6 = param_6 * 0x101;
        if (bVar7) goto LAB_010c7c08;
        goto LAB_010c7e5c;
      }
      break;
    case 2:
switchD_010c7b6c_caseD_2:
      bVar3 = !bVar3 || !bVar8 && !bVar9;
      uVar17 = param_3;
      uVar14 = param_4;
      uVar12 = param_5;
      goto joined_r0x010c7e58;
    case 3:
      uVar11 = *(undefined4 *)((long)param_1 + 0x44);
                    /* catch() { ... } // from try @ 010c7b80 with catch @ 010c7bb8 */
      param_3 = png_gamma_16bit_correct(param_3 * 0x101,uVar11);
      param_3 = param_3 & 0xffff;
      param_4 = png_gamma_16bit_correct(param_4 * 0x101,uVar11);
                    /* catch() { ... } // from try @ 010c7c6c with catch @ 010c7bd8
                       catch() { ... } // from try @ 010c7ca4 with catch @ 010c7bd8
                       catch() { ... } // from try @ 010c7d88 with catch @ 010c7bd8 */
      param_4 = param_4 & 0xffff;
      param_5 = png_gamma_16bit_correct(param_5 * 0x101,uVar11);
      param_5 = param_5 & 0xffff;
      if (uVar5 != 0 || bVar7) {
        param_6 = param_6 * 0x101;
        goto switchD_010c7b6c_caseD_2;
      }
                    /* catch() { ... } // from try @ 010c7efc with catch @ 010c7dd4 */
      uVar13 = param_3 * 0xff >> 0xf;
      uVar17 = param_4 * 0xff >> 0xf;
      uVar14 = param_5 * 0xff >> 0xf;
      uVar13 = (uint)*(ushort *)(png_sRGB_base + (ulong)uVar13 * 2) +
...
LAB_010c7f04:
      ...
      break;
    case 4:
      goto switchD_010c7b6c_caseD_4;
    default:
      goto switchD_010c7b6c_default;
    }
    if (iVar2 != 1) {
LAB_010c7e6c:
                    /* try { // try from 010c7e74 to 011c7e8f has its CatchHandler @ 010c7fe8 */
                    /* WARNING: Subroutine does not return */
      png_error(*(undefined8 *)*puVar19,"bad encoding (internal error)");
    }
  }
  uVar17 = *(uint *)((long)puVar19 + 0x14);
                    /* try { // try from 010c7c90 to 011c7ca3 has its CatchHandler @ 010c7d98 */
  uVar14 = uVar17 & 0x21;
  uVar12 = (uint)(uVar14 == 0x21);
  uVar13 = uVar17 >> 3 & 2;
                    /* try { // try from 010c7ca4 to 011c7d7f has its CatchHandler @ 010c7bd8 */
  if (uVar5 == 0) {
    uVar17 = uVar17 & 3;
    ...
    if (uVar17 != 1) {
      ...
      *(short *)(lVar1 + lVar4) = (short)param_4;
      ...
      goto LAB_010c7f50;
                    ...
                    /* try { // try from 010c7d80 to 011c7d87 has its CatchHandler @ 010c7d88 */
    *(short *)(lVar1 + (ulong)(uVar12 ^ 1) * 2) = (short)param_6;
  }
                    /* catch() { ... } // from try @ 010c7c4c with catch @ 010c7d88
                       catch() { ... } // from try @ 010c7d80 with catch @ 010c7d88
                       try { // try from 010c7d88 to 011c7dd3 has its CatchHandler @ 010c7bd8 */
  if (param_6 < 0xffff) {
    if (param_6 == 0) {
      param_4 = 0;
    }
    else {
                    /* catch() { ... } // from try @ 010c7c90 with catch @ 010c7d98 */
      param_4 = (param_4 * param_6 + 0x7fff) / 0xffff;
    }
  }
LAB_010c7f50:
