...
ulong FUN_011415d8(long param_1,int *param_2)

{
  ...
  bVar10 = (&DAT_014985e4)[*(int *)(param_1 + 0xb68)];
  uVar18 = (uint)bVar10;
  if (*(int *)(param_1 + 200) == 2) {
    FUN_01140d04(param_1);
  }
      ...
      do {
        ...
        if (bVar10 != 0) {
          ...
          if (*(int *)(param_1 + 0xb68) == 1) {
            if (0 < lVar20) {
              (*DAT_01796000)(lVar26,iVar5,uVar22 + 4);
            }
            if (*(char *)(lVar21 + lVar19 + 2) != '\0') {
              (*DAT_01796100)(lVar26,iVar5,uVar22);
            }
            if (0 < iVar4) {
              (*DAT_01796090)(lVar26,iVar5,uVar22 + 4);
            }
            if (*(char *)(lVar21 + lVar19 + 2) != '\0') {
              (*DAT_017960c0)(lVar26,iVar5,bVar10);
            }
          }
          else {
            ...
            if (0 < lVar20) {
              iVar1 = bVar10 + 4;
              (*DAT_01795fd0)(lVar26,iVar5,iVar1,bVar8,uVar9);
              (*DAT_01796108)(lVar25,lVar13,iVar6,iVar1,bVar8,uVar9);
            }
            if (*(char *)(lVar21 + 2) != '\0') {
              (*DAT_01796098)(lVar26,iVar5,bVar10,bVar8,uVar9);
              (*DAT_01795fc0)(lVar25,lVar13,iVar6,bVar10,bVar8,uVar9);
            }
            if (0 < iVar4) {
              (*DAT_017960a0)(lVar26,iVar5,uVar22 + 4,bVar8,uVar9);
              (*DAT_01795fd8)(lVar25,lVar13,iVar6,uVar22 + 4,bVar8,uVar9);
            }
            if (*(char *)(lVar21 + 2) != '\0') {
              (*DAT_01795fe0)(lVar26,iVar5,uVar22,bVar8,uVar9);
              (*DAT_01795ff8)(lVar25,lVar13,iVar6,uVar22,bVar8,uVar9);
            }
          }
        }
        lVar20 = lVar20 + 1;
    ...
    if (iVar23 < iVar12) {
      ...
      do {
        ...
        if (3 < *(byte *)(lVar25 + lVar26)) {
          ...
          FUN_011422d0(param_1 + 0x33c,*(long *)(param_1 + 0xb30) + lVar13 + (long)iVar23,iVar12);
          FUN_011422d0(param_1 + 0x33c,lVar14 + lVar13 + (long)iVar23,iVar12,
  ...
  if (*(long *)(param_2 + 0x10) != 0) {
    ...
    *(long *)(param_2 + 10) = lVar19;
    ...
    if ((*(long *)(param_1 + 0xb98) != 0) && (iVar24 - iVar23 != 0 && iVar23 <= iVar24)) {
      lVar20 = FUN_011600d0(param_1,iVar23,iVar24 - iVar23);
      *(long *)(param_2 + 0x26) = lVar20;
      if (lVar20 == 0) {
        uVar11 = FUN_01143c94(param_1,3,"Could not decode alpha data.");
        return uVar11;
      }
    }
    iVar12 = param_2[0x20];
