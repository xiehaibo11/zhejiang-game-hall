...

{
  ...
  if ((param_2 == 2) && (iVar1 != 0)) {
    ...
    dVar5 = param_5[4];
    if (1.0 <= dVar5) {
                    /* try { // try from 010d6eb8 to 011d7017 has its CatchHandler @ 010d6eb8
                       catch(type#1 @ 00000000) { ... } // from try @ 010d6eb8 with catch @ 010d6eb8
                       catch(type#1 @ 00000000) { ... } // from try @ 010d7038 with catch @ 010d6eb8
                       catch(type#1 @ 00000000) { ... } // from try @ 010d7070 with catch @ 010d6eb8
                       catch(type#1 @ 00000000) { ... } // from try @ 010d70a8 with catch @ 010d6eb8
                       catch(type#1 @ 00000000) { ... } // from try @ 010d7104 with catch @ 010d6eb8
                        */
