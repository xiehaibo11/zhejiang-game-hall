...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00d8482c to 00e8483b has its CatchHandler @ 00d84fcc */
  lVar2 = tpidr_el0;
  ...
  if (uVar5 == 0) {
    ...
    pvStack_80 = (void *)((long)__dest + ((long)uVar5 >> 4) * 0x10);
    local_90 = __dest;
    local_88 = __dest;
    if (0 < (long)uVar5) {
  ...
  if (uVar5 <= uVar8) {
    uVar7 = (ulong)(uVar1 + 1);
                    /* try { // try from 00d84914 to 00e8492f has its CatchHandler @ 00d84ff0 */
    local_78 = 0;
    local_70 = 0;
    if (uVar5 < uVar7) {
      std::__ndk1::
  ...
  if (param_2 == (DisplayData *)0x0) {
                    /* try { // try from 00d84934 to 00e84943 has its CatchHandler @ 00d85004 */
    uVar3 = 0;
