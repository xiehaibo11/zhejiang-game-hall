...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<float,
   ...
   std::__ndk1::allocator<cocos2d::Node*> > > > >::__rehash(unsigned long) */
...

{
  ...
  if (param_1 == 0) {
    ...
    *(undefined8 *)(this + 8) = 0;
                    ...
                    /* catch() { ... } // from try @ 00fa1b0c with catch @ 00fa1bec */
    if (param_1 >> 0x3d != 0) {
    ...
    *(ulong *)(this + 8) = param_1;
    do {
                    /* catch() { ... } // from try @ 00fa1b00 with catch @ 00fa1c18 */
          ...
          if (uVar7 != uVar4) {
            ...
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) {
              *(long **)(*(long *)this + uVar7 * 8) = plVar5;
              ...
              } while (*(float *)(plVar6 + 2) == *(float *)(plVar9 + 2));
              *plVar5 = (long)plVar9;
