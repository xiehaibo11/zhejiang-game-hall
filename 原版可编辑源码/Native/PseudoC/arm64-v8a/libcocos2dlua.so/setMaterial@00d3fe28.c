...
/* cocos2d::Sprite3D::setMaterial(cocos2d::Material*, int) */

void __thiscall cocos2d::Sprite3D::setMaterial(Sprite3D *this,Material *param_1,int param_2)

{
  ...
  if (param_2 == -1) {
    ...
    Mesh::setMaterial(*(Mesh **)(*(long *)(this + 0x350) + (long)param_2 * 8),param_1);
  }
