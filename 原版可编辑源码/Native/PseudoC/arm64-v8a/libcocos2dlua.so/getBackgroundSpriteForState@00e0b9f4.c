...
/* cocos2d::extension::ControlButton::getBackgroundSpriteForState(cocos2d::extension::Control::State)
    */

long __thiscall
cocos2d::extension::ControlButton::getBackgroundSpriteForState(ControlButton *this,int param_2)

{
  ...
  if (uVar2 != 0) {
    ...
    plVar5 = *(long **)(*(long *)(this + 0x420) + uVar4 * 8);
    ...
    plVar5 = *(long **)(*(long *)(this + 0x420) + uVar3 * 8);
    if (plVar5 != (long *)0x0) {
