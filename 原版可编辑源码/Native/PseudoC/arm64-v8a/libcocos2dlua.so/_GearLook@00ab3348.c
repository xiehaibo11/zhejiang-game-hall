  ...
  *(undefined8 *)(this + 0x20) = 0;
  if (pvVar2 != (void *)0x0) {
    operator_delete(pvVar2);
                    ...
                    /* try { // try from 00ab33c0 to 00bb3413 has its CatchHandler @ 00ab33c0
                       catch() { ... } // from try @ 00ab33c0 with catch @ 00ab33c0
                       catch() { ... } // from try @ 00ab346c with catch @ 00ab33c0
                       catch() { ... } // from try @ 00ab34b4 with catch @ 00ab33c0 */
