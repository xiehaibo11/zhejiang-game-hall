...
undefined8 FUN_00b30bb0(long param_1,uint param_2,int param_3,uint *param_4)
...
LAB_00b30c20:
    ...
    *(long *)(param_1 + 0x78) = lVar4;
    if (lVar4 != 0) goto LAB_00b30c20;
    reason = 0x86;
    line = 0x14e;
    goto LAB_00b30de4;
  default:
    goto switchD_00b30bf4_caseD_17;
  case 8:
    if (lVar4 == 0) {
      return 1;
    }
  ...
  case 0x16:
    if (param_3 == 0xd) {
      ...
      *(uint *)(lVar4 + 0x2c) = uVar3 ^ *(uint *)(lVar4 + 0x80);
      FUN_00b308b4(param_1,0,param_4,0xd);
      return 0x10;
    }
    break;
  case 0x17:
