...

{
  ...
  fVar2 = (*(float *)(this + 0x50) + *(float *)(this + 0x40)) * 0.5;
  fVar3 = (*(float *)(this + 0x54) + *(float *)(this + 0x44)) * 0.5;
  fVar4 = (*(float *)(this + 0x58) + *(float *)(this + 0x48)) * 0.5;
  fVar7 = fVar1 + (*(float *)(this + 0x50) - *(float *)(this + 0x40)) * 0.5;
  fVar8 = fVar1 + (*(float *)(this + 0x54) - *(float *)(this + 0x44)) * 0.5;
  fVar1 = fVar1 + (*(float *)(this + 0x58) - *(float *)(this + 0x48)) * 0.5;
