...
/* cocos2d::experimental::ThreadPool::newSingleThreadPool() */

ThreadPool * cocos2d::experimental::ThreadPool::newSingleThreadPool(void)

{
  ...
  if (this != (ThreadPool *)0x0) {
    ...
    *(undefined8 *)(this + 0x140) = 0x100000001;
