...
/* void std::__ndk1::vector<cocos2d::RenderCommand*, std::__ndk1::allocator<cocos2d::RenderCommand*>
   >::__push_back_slow_path<cocos2d::RenderCommand* const&>(cocos2d::RenderCommand* const&) */
