...
/* cocostudio::MovementData::getMovementBoneData(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

undefined8 __thiscall
cocostudio::MovementData::getMovementBoneData(MovementData *this,basic_string *param_1)
