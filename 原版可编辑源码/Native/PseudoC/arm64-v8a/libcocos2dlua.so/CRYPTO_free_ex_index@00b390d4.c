...

{
  ...
  if (param_1 < 0xe) {
    iVar2 = CRYPTO_THREAD_run_once(&DAT_01784820,FUN_00b39af4);
    if ((iVar2 != 0) && (DAT_01784824 != 0)) {
      if (DAT_01784828 == 0) {
        return 0;
      }
      puVar1 = &DAT_01784830 + (int)param_1;
      ...
      if (((param_2 < 0) || (iVar2 = OPENSSL_sk_num(*puVar1), iVar2 <= param_2)) ||
        ...
        uVar4 = 1;
        *(undefined1 **)(lVar3 + 0x20) = &LAB_00b391e8;
        *(undefined **)(lVar3 + 0x18) = &UNK_00b391f0;
        *(undefined **)(lVar3 + 0x10) = &UNK_00b391e4;
      }
