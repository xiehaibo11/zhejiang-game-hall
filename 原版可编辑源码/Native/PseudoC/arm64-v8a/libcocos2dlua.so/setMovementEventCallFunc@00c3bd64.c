...
/* cocostudio::ArmatureAnimation::setMovementEventCallFunc(std::__ndk1::function<void
   (cocostudio::Armature*, cocostudio::MovementEventType, std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&)>) */

void __thiscall
cocostudio::ArmatureAnimation::setMovementEventCallFunc(ArmatureAnimation *this,long *param_2)

{
  ...
  FUN_00c3c588(alStack_60,this + 0x180);
  if (alStack_60 == local_40) {
    pcVar3 = *(code **)(*local_40 + 0x20);
  }
  else {
    if (local_40 == (long *)0x0) goto LAB_00c3be08;
