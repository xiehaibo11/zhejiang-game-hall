...
LAB_00be8070:
  ...
  if (((iVar6 < 0) || (lVar11 = OPENSSL_sk_value(lVar10,iVar6), lVar11 == 0)) ||
    ...
    OPENSSL_sk_pop_free(lVar10,FUN_00be8d30);
    iVar6 = 0xd1;
    iVar7 = 0x187;
    goto LAB_00be8070;
  }
  ...
  if (iVar6 != 0) {
    ...
    if ((iVar6 == 0) || (iVar6 = strcmp(pcVar18,"application/pkcs7-mime"), iVar6 == 0)) {
      OPENSSL_sk_pop_free(lVar10,FUN_00be8d30);
      pAVar12 = (ASN1_VALUE *)FUN_00be8da8(bio,it);
...
LAB_00be82dc:
      ...
      if (bVar2) {
        BIO_write(local_478,&DAT_013ecf75,2);
      }
LAB_00be8234:
      bVar4 = false;
      bVar2 = bVar3;
  ...
  if (iVar6 != 0) {
    ...
    if (lVar10 == 0) {
      ...
      if ((iVar6 == 0) || (iVar6 = strcmp(pcVar18,"application/pkcs7-signature"), iVar6 == 0)) {
        OPENSSL_sk_pop_free(lVar10,FUN_00be8d30);
        pAVar12 = (ASN1_VALUE *)FUN_00be8da8(a,it);
        if (pAVar12 == (ASN1_VALUE *)0x0) {
