...
/* flatbuffers::CreateColorFrame(flatbuffers::FlatBufferBuilder&, int, unsigned char,
   flatbuffers::Color const*, flatbuffers::Offset<flatbuffers::EasingData>) */

undefined4
flatbuffers::CreateColorFrame
...

{
  ...
  if (param_4 != (uchar *)0x0) {
    ...
    FlatBufferBuilder::PushBytes(param_1,param_4,4);
    uStack_5c = 8;
