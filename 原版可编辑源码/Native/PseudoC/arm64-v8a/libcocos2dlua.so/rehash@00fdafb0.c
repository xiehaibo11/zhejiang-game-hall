    ...
    if (param_1 < uVar2) {
      ...
      if ((uVar2 < 3) ||
        ...
        uVar1 = __next_prime(uVar1);
                    ...
                    /* catch() { ... } // from try @ 00fdb080 with catch @ 00fdb03c */
        if (1 < uVar1) {
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00fdb074;
    }
    return;
  }
LAB_00fdb074:
                    /* try { // try from 00fdb078 to 010db07f has its CatchHandler @ 00fdb0f0 */
                    /* try { // try from 00fdb080 to 010db10b has its CatchHandler @ 00fdb03c */
