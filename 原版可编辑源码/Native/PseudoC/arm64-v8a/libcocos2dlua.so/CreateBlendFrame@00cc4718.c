...
/* flatbuffers::CreateBlendFrame(flatbuffers::FlatBufferBuilder&, int, unsigned char,
   flatbuffers::BlendFunc const*, flatbuffers::Offset<flatbuffers::EasingData>) */

undefined4
flatbuffers::CreateBlendFrame
