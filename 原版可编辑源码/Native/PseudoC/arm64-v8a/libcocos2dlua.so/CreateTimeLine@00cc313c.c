...
/* flatbuffers::CreateTimeLine(flatbuffers::FlatBufferBuilder&,
   flatbuffers::Offset<flatbuffers::String>, int,
   flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::Frame> > >) */

undefined4
flatbuffers::CreateTimeLine(FlatBufferBuilder *param_1,undefined4 param_2,int param_3,int param_4)
