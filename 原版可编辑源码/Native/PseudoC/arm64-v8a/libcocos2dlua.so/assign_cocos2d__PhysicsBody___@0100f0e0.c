...
/* std::__ndk1::enable_if<__is_forward_iterator<cocos2d::PhysicsBody**>::value&&is_constructible<cocos2d::PhysicsBody*,
   std::__ndk1::iterator_traits<cocos2d::PhysicsBody**>::reference>::value, void>::type
   std::__ndk1::vector<cocos2d::PhysicsBody*, std::__ndk1::allocator<cocos2d::PhysicsBody*>
   >::assign<cocos2d::PhysicsBody**>(cocos2d::PhysicsBody**, cocos2d::PhysicsBody**) */

void __thiscall
std::__ndk1::vector<cocos2d::PhysicsBody*,std::__ndk1::allocator<cocos2d::PhysicsBody*>>::
assign<cocos2d::PhysicsBody**>
          (vector<cocos2d::PhysicsBody*,std::__ndk1::allocator<cocos2d::PhysicsBody*>> *this,
          PhysicsBody **param_1,PhysicsBody **param_2)
...
LAB_0100f164:
    ...
    if ((ulong)(lVar1 >> 3) < 0xfffffffffffffff) {
      uVar2 = lVar1 >> 2;
      if ((uVar5 <= uVar2) && (uVar5 = uVar2, uVar2 >> 0x3d != 0)) goto LAB_0100f164;
    }
    else {
    ...
    *(void **)(this + 8) = pvVar4;
    ...
    __src = (PhysicsBody **)((long)param_1 + (*(long *)(this + 8) - (long)pvVar4));
    if (uVar5 <= uVar2) {
      __src = param_2;
    }
