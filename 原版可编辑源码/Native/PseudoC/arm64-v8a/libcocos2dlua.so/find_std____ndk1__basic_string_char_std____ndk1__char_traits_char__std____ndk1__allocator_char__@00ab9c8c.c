...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   const&, bool, std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00ab9d68;
              goto LAB_00ab9e18;
            }
            if (uVar9 != uVar14) goto LAB_00ab9e18;
          }
LAB_00ab9d68:
          plVar8 = (long *)*plVar8;
