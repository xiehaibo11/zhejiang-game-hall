...
/* cocos2d::GLProgramState::setUniformMat3v(int, long, cocos2d::Mat3 const*) */

void __thiscall
cocos2d::GLProgramState::setUniformMat3v
          (GLProgramState *this,int param_1,long param_2,Mat3 *param_3)
