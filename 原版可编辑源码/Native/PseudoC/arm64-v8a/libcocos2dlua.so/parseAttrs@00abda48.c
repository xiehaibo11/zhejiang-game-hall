...
/* fairygui::HtmlParser::parseAttrs(char const**) */

void fairygui::HtmlParser::parseAttrs(char **param_1)

{
  ...
  *(undefined4 *)(in_x8 + 0x20) = 0x3f800000;
  ...
  if (pcVar3 != (char *)0x0) {
    plVar5 = in_x1 + 2;
    pcVar4 = (char *)in_x1[1];
    if (pcVar4 != (char *)0x0) goto LAB_00abdab4;
LAB_00abdaa4:
    pcVar3 = (char *)*plVar5;
    plVar6 = plVar5;
    if (pcVar3 != (char *)0x0) {
...
LAB_00abdab4:
        ...
        lVar2 = std::__ndk1::
                ...
                __emplace_unique_key_args<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>&&>,std::__ndk1::tuple<>>
                          (in_x8,(piecewise_construct_t *)local_70,(tuple *)&DAT_013cfe3e,
                           (tuple *)&local_50);
        ...
        pcVar3 = (char *)*plVar5;
        plVar6 = plVar5;
        if (pcVar3 == (char *)0x0) goto LAB_00abdafc;
      }
      goto LAB_00abdaa4;
    }
  }
