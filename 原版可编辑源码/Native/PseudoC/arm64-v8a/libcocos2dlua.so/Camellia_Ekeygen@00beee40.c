...

{
  ...
  *param_3 = uVar50;
  ...
  uVar32 = *(uint *)(&DAT_014057a0 + (ulong)(uVar32 >> 8 & 0xff) * 4) ^
           *(uint *)(&DAT_01404fa0 + (ulong)(uVar32 & 0xff) * 4) ^
           *(uint *)(&DAT_014053a0 + (ulong)(uVar32 >> 0x10 & 0xff) * 4) ^
           *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar32 >> 0x18) * 4);
  uVar39 = *(uint *)(&DAT_01404fa0 + (ulong)(uVar39 >> 8 & 0xff) * 4) ^
           *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar39 & 0xff) * 4) ^ uVar32 ^
           *(uint *)(&DAT_014057a0 + (ulong)(uVar39 >> 0x10 & 0xff) * 4) ^
           *(uint *)(&DAT_014053a0 + (ulong)(uVar39 >> 0x18) * 4);
  uVar41 = uVar39 ^ uVar41;
  uVar39 = uVar48 ^ (uVar32 >> 8 | uVar32 << 0x18) ^ uVar39;
  uVar48 = uVar41 ^ 0xb67ae858;
  uVar32 = uVar39 ^ 0x4caa73b2;
  uVar48 = *(uint *)(&DAT_014057a0 + (ulong)(uVar48 >> 8 & 0xff) * 4) ^
           *(uint *)(&DAT_01404fa0 + (ulong)(uVar48 & 0xff) * 4) ^
           *(uint *)(&DAT_014053a0 + (ulong)(uVar48 >> 0x10 & 0xff) * 4) ^
           *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar48 >> 0x18) * 4);
  uVar32 = *(uint *)(&DAT_01404fa0 + (ulong)(uVar32 >> 8 & 0xff) * 4) ^
           *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar32 & 0xff) * 4) ^ uVar48 ^
           *(uint *)(&DAT_014057a0 + (ulong)(uVar32 >> 0x10 & 0xff) * 4) ^
           *(uint *)(&DAT_014053a0 + (ulong)(uVar32 >> 0x18) * 4);
  ...
  uVar43 = *(uint *)(&DAT_014057a0 + (ulong)(uVar43 >> 8 & 0xff) * 4) ^
           *(uint *)(&DAT_01404fa0 + (ulong)(uVar43 & 0xff) * 4) ^
           *(uint *)(&DAT_014053a0 + (ulong)(uVar43 >> 0x10 & 0xff) * 4) ^
           *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar43 >> 0x18) * 4);
  uVar32 = *(uint *)(&DAT_01404fa0 + (ulong)(uVar48 >> 8 & 0xff) * 4) ^
           *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar48 & 0xff) * 4) ^ uVar43 ^
           *(uint *)(&DAT_014057a0 + (ulong)(uVar48 >> 0x10 & 0xff) * 4) ^
           *(uint *)(&DAT_014053a0 + (ulong)(uVar48 >> 0x18) * 4);
  ...
  uVar43 = *(uint *)(&DAT_014057a0 + (ulong)(uVar43 >> 8 & 0xff) * 4) ^
           ...
           *(uint *)(&DAT_014053a0 + (ulong)(uVar43 >> 0x10 & 0xff) * 4) ^
           *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar43 >> 0x18) * 4);
  uVar41 = *(uint *)(&DAT_01404fa0 + (ulong)(uVar41 >> 8 & 0xff) * 4) ^
           *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar41 & 0xff) * 4) ^ uVar43 ^
           *(uint *)(&DAT_014057a0 + (ulong)(uVar41 >> 0x10 & 0xff) * 4) ^
           *(uint *)(&DAT_014053a0 + (ulong)(uVar41 >> 0x18) * 4);
  ...
  if (param_1 == 0x80) {
    ...
    uVar22 = *(uint *)(&DAT_01404fa0 + (ulong)(uVar51 & 0xff) * 4);
    uVar36 = uVar36 << 0xf;
    uVar27 = uVar30 & 0x7fff | uVar36;
    uVar23 = *(uint *)(&DAT_014057a0 + (ulong)(uVar51 >> 8 & 0xff) * 4);
    param_3[0x24] = (uint)(CONCAT44(uVar30,uVar43) >> 2);
    param_3[0x25] = (uint)(CONCAT44(uVar29,uVar50) >> 2);
    uVar24 = *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar15 & 0xff) * 4);
    uVar25 = *(uint *)(&DAT_01404fa0 + (ulong)(uVar15 >> 8 & 0xff) * 4);
    ...
    uVar26 = *(uint *)(&DAT_014053a0 + (ulong)(uVar51 >> 0x10 & 0xff) * 4);
    param_3[0x10] = uVar27;
    param_3[0x11] = uVar43;
    param_3[0x12] = uVar50;
    param_3[0x13] = uVar10;
    uVar50 = *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar51 >> 0x18) * 4);
    ...
    uVar27 = uVar25 ^ uVar24 ^ uVar50 ^
             *(uint *)(&DAT_014057a0 + (ulong)(uVar15 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_014053a0 + (ulong)(uVar15 >> 0x18) * 4);
    ...
    uVar50 = *(uint *)(&DAT_014057a0 + (ulong)(uVar50 >> 8 & 0xff) * 4) ^
             *(uint *)(&DAT_01404fa0 + (ulong)(uVar50 & 0xff) * 4) ^
             *(uint *)(&DAT_014053a0 + (ulong)(uVar50 >> 0x10 & 0xff) * 4) ^
             *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar50 >> 0x18) * 4);
    uVar32 = *(uint *)(&DAT_01404fa0 + (ulong)(uVar48 >> 8 & 0xff) * 4) ^
             *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar48 & 0xff) * 4) ^ uVar50 ^
             *(uint *)(&DAT_014057a0 + (ulong)(uVar48 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_014053a0 + (ulong)(uVar48 >> 0x18) * 4);
