...
/* cocos2d::AnimationCurve<4>::evaluate(float, float*, cocos2d::EvaluateType) const */

void __thiscall
cocos2d::AnimationCurve<4>::evaluate
          (float param_1,AnimationCurve<4> *this,float *param_2,uint param_4)
...
LAB_00d09a18:
    ...
    fVar10 = *pfVar8;
    if (param_1 <= fVar10) goto LAB_00d09a18;
    if (param_1 < pfVar8[(int)uVar6]) {
      ...
      do {
        ...
        if ((fVar11 <= param_1) && (param_1 <= pfVar8[uVar3 + 1])) {
          ...
          if (param_4 < 4) goto LAB_00d09a78;
          goto LAB_00d09a28;
        }
        uVar2 = uVar3 - 1;
        if (fVar11 <= param_1) {
      ...
      uVar7 = 0xfffffffc;
      if (3 < param_4) goto LAB_00d09a28;
LAB_00d09a78:
      pfVar1 = (float *)(*(long *)(this + 0x28) + uVar7 * 4);
      fVar10 = (param_1 - fVar11) / (fVar10 - fVar11);
      pfVar8 = pfVar1 + 4;
      switch((ulong)(&switchD_00d09aa8::switchdataD_01418854)[param_4] * 4 + 0xd09aac) {
      case 0xd09aac:
        *param_2 = *pfVar1 + fVar10 * (pfVar1[4] - *pfVar1);
        param_2[1] = pfVar1[1] + fVar10 * (pfVar1[5] - pfVar1[1]);
        param_2[2] = pfVar1[2] + fVar10 * (pfVar1[6] - pfVar1[2]);
        param_2[3] = pfVar1[3] + fVar10 * (pfVar1[7] - pfVar1[3]);
        break;
      case 0xd09b10:
        __n = (size_t)*(int *)(this + 0x3c);
        if (ABS(fVar10) <= 0.5) {
    ...
    __n = (size_t)*(int *)(this + 0x3c);
    pfVar8 = (float *)(*(long *)(this + 0x28) + (long)(int)uVar6 * 0x10);
  }
LAB_00d09a20:
