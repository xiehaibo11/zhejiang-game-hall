...
/* void std::__ndk1::vector<cocos2d::EventListenerCustom*,
   std::__ndk1::allocator<cocos2d::EventListenerCustom*>
   >::__push_back_slow_path<cocos2d::EventListenerCustom* const&>(cocos2d::EventListenerCustom*
   const&) */
...
__push_back_slow_path<cocos2d::EventListenerCustom*const&>
          (vector<cocos2d::EventListenerCustom*,std::__ndk1::allocator<cocos2d::EventListenerCustom*>>
           *this,EventListenerCustom **param_1)
