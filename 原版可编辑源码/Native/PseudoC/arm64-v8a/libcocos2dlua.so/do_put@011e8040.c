...

{
  ...
  iVar5 = __libcpp_snprintf_l(local_84,0x14,(__locale_t *)DAT_017942d0,local_120,param_5);
  pcVar1 = local_84 + iVar5;
  uVar2 = *(uint *)(param_3 + 8) & 0xb0;
  pcVar7 = pcVar1;
  if (uVar2 == 0x20) goto LAB_011e8130;
  if (uVar2 == 0x10) {
...
LAB_011e8130:
  ios_base::getloc();
  local_148 = &ctype<wchar_t>::id;
  uStack_138 = 0;
  local_140 = locale::id::__init;
  if (ctype<wchar_t>::id != -1) {
    local_128 = &local_148;
    local_130 = &local_128;
    __call_once((ulong *)&ctype<wchar_t>::id,&local_130,FUN_01208130);
  }
  if (((ulong)(*(long *)(local_150 + 0x18) - *(long *)(local_150 + 0x10) >> 3) <=
       (long)DAT_01794320 - 1U) ||
     (plVar6 = *(long **)(*(long *)(local_150 + 0x10) + ((long)DAT_01794320 - 1U) * 8),
     plVar6 == (long *)0x0)) {
                    /* WARNING: Subroutine does not return */
    FUN_00cc7c00();
  }
  __shared_count::__release_shared(local_150);
  ...
  FUN_011e6874(param_2,auStack_118,puVar3,auStack_118 + (long)iVar5 * 4,param_3,param_4);
