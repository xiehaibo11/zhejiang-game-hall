...
/* cocos2d::ObjectFactory::TInfo::TEMPNAMEPLACEHOLDERVALUE(cocos2d::ObjectFactory::TInfo const&) */

TInfo * __thiscall cocos2d::ObjectFactory::TInfo::operator=(TInfo *this,TInfo *param_1)

{
  ...
  *(undefined8 *)(this + 0x18) = *(undefined8 *)(param_1 + 0x18);
  ...
  if (alStack_70 == local_50) {
    ...
    if (local_50 == (long *)0x0) goto LAB_00fbf138;
