...
LAB_00acefd0:
  ...
  case 0x51:
    ...
    *(undefined1 **)(param_1 + 0x260) = &LAB_00acf014;
    return 1;
  case 0x52:
    lVar3 = *(long *)(param_1 + 0xe8);
    if ((param_3 == 0) && (lVar3 == 0)) goto switchD_00aceab0_caseD_73;
    goto LAB_00acee74;
  case 0x53:
