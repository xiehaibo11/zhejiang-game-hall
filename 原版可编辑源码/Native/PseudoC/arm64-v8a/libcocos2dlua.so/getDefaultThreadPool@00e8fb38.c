...
/* cocos2d::experimental::ThreadPool::getDefaultThreadPool() */

ThreadPool * cocos2d::experimental::ThreadPool::getDefaultThreadPool(void)

{
  ...
  if ((DAT_0178f3f0 == (ThreadPool *)0x0) &&
    ...
    *(undefined8 *)(this + 0x140) = 0x1400000004;
