...

{
  ...
  long local_38;
                    ...
                    /* try { // try from 00d846d8 to 00e84763 has its CatchHandler @ 00d84f20 */
  lVar1 = tpidr_el0;
  ...
  if ((uVar2 & 1) != 0) {
    this_00 = (Armature *)(**(code **)(*(long *)this + 0x50))(this,&local_80);
                    /* try { // try from 00d84788 to 00e8478f has its CatchHandler @ 00d84f00 */
  ...
  if (*(long *)(lVar1 + 0x28) == local_38) {
                    /* try { // try from 00d84764 to 00e84787 has its CatchHandler @ 00d83d48 */
    return this_00;
  }
