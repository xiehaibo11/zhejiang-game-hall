...
/* void std::__ndk1::vector<cocos2d::Camera*, std::__ndk1::allocator<cocos2d::Camera*>
   >::__push_back_slow_path<cocos2d::Camera*>(cocos2d::Camera*&&) */

void __thiscall
std::__ndk1::vector<cocos2d::Camera*,std::__ndk1::allocator<cocos2d::Camera*>>::
__push_back_slow_path<cocos2d::Camera*>
          (vector<cocos2d::Camera*,std::__ndk1::allocator<cocos2d::Camera*>> *this,Camera **param_1)
