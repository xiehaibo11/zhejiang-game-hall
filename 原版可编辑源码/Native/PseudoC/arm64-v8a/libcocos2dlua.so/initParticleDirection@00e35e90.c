...
/* cocos2d::PULineEmitter::initParticleDirection(cocos2d::PUParticle3D*) */

void cocos2d::PULineEmitter::initParticleDirection(PUParticle3D *param_1)

{
  ...
  if (param_1[0x1a5] == (PUParticle3D)0x0) {
    ...
    pVVar1 = (Vec3 *)(param_1 + 0x208);
    if (local_3c == 0.0) {
      uVar3 = *(undefined8 *)pVVar1;
      *(undefined4 *)(in_x1 + 0xb4) = *(undefined4 *)(param_1 + 0x210);
      *(undefined8 *)(in_x1 + 0xac) = uVar3;
      uVar3 = *(undefined8 *)pVVar1;
      *(undefined4 *)(in_x1 + 0xc0) = *(undefined4 *)(param_1 + 0x210);
