...

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00cf1fc0;
    }
    return;
  }
LAB_00cf1fc0:
