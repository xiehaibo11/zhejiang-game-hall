...
/* cocos2d::PhysicsJointLimit::createConstraints() */

void __thiscall cocos2d::PhysicsJointLimit::createConstraints(PhysicsJointLimit *this)

{
  ...
  local_30 = (cpConstraint *)
             cpSlideJointNew(*(undefined4 *)(this + 0x68),*(undefined4 *)(this + 0x6c),
