...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int,
   ...
   cocos2d::experimental::ui::VideoPlayer*>, void*>*>) */
...

{
  ...
  do {
    ...
    plVar2 = (long *)*plVar5;
                    ...
                    /* try { // try from 00de12e4 to 00ee12ff has its CatchHandler @ 00de1584 */
  if (plVar5 != param_2 + 2) {
    uVar7 = plVar5[1];
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
      ...
      if (uVar3 != 0) {
        uVar1 = uVar7 / uVar3;
                    ...
                    /* try { // try from 00de1304 to 00ee1313 has its CatchHandler @ 00de1580 */
      uVar7 = uVar7 - uVar1 * uVar3;
    }
    if (uVar7 == uVar4) goto LAB_00de1368;
  }
  if (*param_3 != 0) {
...
LAB_00de1368:
  if (*param_3 != 0) {
    ...
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
                    ...
                    /* try { // try from 00de1380 to 00ee138b has its CatchHandler @ 00de153c */
      if (uVar3 <= uVar7) {
        uVar6 = 0;
        if (uVar3 != 0) {
          uVar6 = uVar7 / uVar3;
  ...
  *plVar5 = *param_3;
  *param_3 = 0;
                    /* try { // try from 00de13c0 to 00ee13cf has its CatchHandler @ 00de157c */
