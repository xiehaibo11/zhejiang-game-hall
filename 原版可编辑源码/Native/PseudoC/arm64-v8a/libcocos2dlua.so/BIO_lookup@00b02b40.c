...

{
  ...
  case 10:
    ...
    if (iVar2 != 0xb) {
                    /* catch() { ... } // from try @ 00b02c70 with catch @ 00b02c98 */
  ...
  case 1:
    ...
    if (param_6 == (addrinfo **)0x0) {
      ...
      OPENSSL_die("assertion failed: bai != NULL","crypto/bio/b_addr.c",0x238);
                    ...
                    /* try { // try from 00b02c38 to 00c02c6f has its CatchHandler @ 00b02c38
                       catch() { ... } // from try @ 00b02c38 with catch @ 00b02c38
                       catch() { ... } // from try @ 00b02c74 with catch @ 00b02c38 */
...
LAB_00b02cbc:
    ...
    break;
  default:
                    /* try { // try from 00b02c70 to 00c02c73 has its CatchHandler @ 00b02c98 */
                    /* try { // try from 00b02c74 to 00c02cab has its CatchHandler @ 00b02c38 */
    iVar2 = 0x83;
    line = 0x289;
  }
