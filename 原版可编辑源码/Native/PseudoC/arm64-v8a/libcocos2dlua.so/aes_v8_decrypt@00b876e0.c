...

{
  ...
  uVar27 = *(undefined4 *)((long)puVar6 + 0x2c);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b87848 with catch @ 00b87720
                       catch(type#1 @ 00000000) { ... } // from try @ 00b878cc with catch @ 00b87720
                       catch(type#1 @ 00000000) { ... } // from try @ 00b878dc with catch @ 00b87720
                        */
