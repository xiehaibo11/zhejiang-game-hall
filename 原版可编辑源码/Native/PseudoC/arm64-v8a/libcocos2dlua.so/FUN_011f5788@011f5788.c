...
void FUN_011f5788(long param_1,__shared_count *param_2)

{
  ...
  local_70 = &std::__ndk1::moneypunct<char,false>::id;
  uStack_60 = 0;
  ...
  if (std::__ndk1::moneypunct<char,false>::id != -1) {
    ...
    std::__ndk1::__call_once
              ((ulong *)&std::__ndk1::moneypunct<char,false>::id,&local_58,FUN_01208130);
  }
  uVar2 = (ulong)DAT_01794238;
  uVar6 = uVar2 - 1;
