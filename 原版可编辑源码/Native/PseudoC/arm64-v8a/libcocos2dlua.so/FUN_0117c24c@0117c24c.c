...
void FUN_0117c24c(long *param_1,long param_2,long param_3,int param_4)
    ...
    if (*(int *)(*param_1 + 0x58) == 2) {
      if (((((((*(short *)((long)param_1 + 0xc4) == 0) && ((short)param_1[0x19] == 0)) &&
        ...
        if ((((short)param_1[0x1d] == 0) && (*(short *)((long)param_1 + 0xec) == 0)) &&
          ...
          lVar20 = 0x1f;
          do {
            if (*psVar19 != 0) goto LAB_0117cae4;
            lVar20 = lVar20 + 1;
            psVar19 = psVar19 + 2;
          } while (lVar20 < 0xff);
          uVar16 = 0;
...
LAB_0117cae4:
    ...
    FUN_0117caec(param_1,param_1 + 0x169);
    FUN_0117caec(param_1,param_1 + 0x16c);
    lVar6 = param_1[0x16a];
  ...
  if ((param_2 == 0) || (uVar22 < param_3 + 4U)) {
    ...
    if ((uVar17 == uVar22) || ((int)param_1[0x17] == 4)) {
      ...
      *(int *)((long)param_1 + 0x1724) = iVar14;
      puVar10 = &DAT_0149f2a0;
      plVar11 = (long *)&DAT_0149f720;
    }
    else {
      ...
      *(uint *)((long)param_1 + 0x1724) = uVar7;
      ...
      FUN_0117d82c(param_1,puVar10);
      plVar11 = param_1 + 0x137;
      FUN_0117d82c(param_1,plVar11,uVar2);
    }
    FUN_0117d3c0(param_1,puVar10,plVar11);
  }
  else {
    FUN_0117bf20(param_1,param_2,param_3,param_4);
  }
  FUN_0117be20(param_1);
  if (param_4 == 0) {
    return;
  }
  if (*(int *)((long)param_1 + 0x1724) < 9) {
    if (*(int *)((long)param_1 + 0x1724) < 1) goto LAB_0117ca8c;
...
LAB_0117c520:
  ...
  do {
    iVar12 = iVar1;
    if ((int)lVar6 < lVar20) {
      FUN_0117caec(param_1,param_1 + 0x16f);
