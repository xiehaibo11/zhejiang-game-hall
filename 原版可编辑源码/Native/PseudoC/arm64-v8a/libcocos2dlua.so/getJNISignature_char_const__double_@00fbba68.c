...
/* std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   cocos2d::JniHelper::getJNISignature<char const*, double>(char const*, double) */

void cocos2d::JniHelper::getJNISignature<char_const*,double>(char *param_1,double param_2)

{
  ...
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string<decltype(nullptr)>(local_68,"D");
