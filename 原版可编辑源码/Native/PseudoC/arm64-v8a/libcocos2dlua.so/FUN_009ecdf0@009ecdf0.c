...
void FUN_009ecdf0(long *param_1,long *param_2)
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
        ...
        (**(code **)(local_60[0] + 0x18))(local_60,param_2);
                    /* try { // try from 009ecf18 to 00aecf97 has its CatchHandler @ 009ecf18
                       catch() { ... } // from try @ 009ecf18 with catch @ 009ecf18
                       catch() { ... } // from try @ 009ecfa8 with catch @ 009ecf18 */
