...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, fairygui::AtlasSprite*>,
   void*>*>, bool>
   ...
   std::__ndk1::allocator<char> >, fairygui::AtlasSprite*>,
  ...
  if (uVar16 != 0) {
    ...
    if ((puVar9 != (undefined8 *)0x0) && (plVar15 = (long *)*puVar9, plVar15 != (long *)0x0)) {
      ...
      do {
        uVar10 = plVar15[1];
        if (uVar10 != uVar7) {
                    /* try { // try from 00aa4544 to 00ba458f has its CatchHandler @ 00aa4544
                       catch() { ... } // from try @ 00aa4544 with catch @ 00aa4544
                       catch() { ... } // from try @ 00aa4594 with catch @ 00aa4544 */
          if (uVar13 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00aa4578;
            break;
          }
...
LAB_00aa4578:
        ...
        if ((bVar3 & 1) != 0) {
          sVar1 = plVar15[3];
                    ...
                    /* try { // try from 00aa4590 to 00ba4593 has its CatchHandler @ 00aa45c8 */
                    /* try { // try from 00aa4594 to 00ba45db has its CatchHandler @ 00aa4544 */
        if (sVar1 == __n) {
          __s1 = (void *)plVar15[4];
          if ((bVar3 & 1) == 0) {
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                    /* catch() { ... } // from try @ 00aa4590 with catch @ 00aa45c8 */
                if (bVar3 >> 1 == uVar10) goto LAB_00aa45e8;
              }
              goto LAB_00aa4530;
            }
          }
          else if (__n != 0) {
                    /* try { // try from 00aa45dc to 00ba4753 has its CatchHandler @ 00aa45dc
                       catch() { ... } // from try @ 00aa45dc with catch @ 00aa45dc
                       catch() { ... } // from try @ 00aa47d4 with catch @ 00aa45dc */
            uVar6 = memcmp(__s1,ppVar2,__n);
            __s1 = (void *)(ulong)uVar6;
            if (uVar6 != 0) goto LAB_00aa4530;
          }
LAB_00aa45e8:
          uVar8 = 0;
          goto LAB_00aa4714;
  ...
  *plVar15 = 0;
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar12;
    if (*plVar15 == 0) goto LAB_00aa4704;
