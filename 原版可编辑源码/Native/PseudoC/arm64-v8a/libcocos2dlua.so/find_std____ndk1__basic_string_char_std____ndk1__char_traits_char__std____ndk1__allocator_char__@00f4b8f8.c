...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00f4b8fc to 0104b8ff has its CatchHandler @ 00f4d554 */
  lVar5 = tpidr_el0;
      ...
      if (uVar12 <= uVar7) {
        ...
        if (uVar12 != 0) {
          uVar14 = uVar7 / uVar12;
                    ...
                    /* try { // try from 00f4b980 to 0104b997 has its CatchHandler @ 00f4d5b4 */
        uVar14 = uVar7 - uVar14 * uVar12;
      }
    }
    plVar8 = *(long **)(*(long *)this + uVar14 * 8);
    if (plVar8 != (long *)0x0) {
                    /* try { // try from 00f4b99c to 0104b9a3 has its CatchHandler @ 00f4d52c */
      plVar8 = (long *)*plVar8;
      if (plVar8 != (long *)0x0) {
                    /* try { // try from 00f4b9ac to 0104b9bb has its CatchHandler @ 00f4d528 */
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (sVar1 == __n) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                while (*pbVar10 == *pbVar11) {
                  ...
                  pbVar10 = pbVar10 + 1;
                  pbVar11 = pbVar11 + 1;
                  if (uVar9 == 0) goto LAB_00f4ba88;
                }
              }
              else {
                    /* try { // try from 00f4ba74 to 0104ba77 has its CatchHandler @ 00f4d544 */
            ...
            if (uVar13 < 2) {
                    /* try { // try from 00f4b9c8 to 0104b9cf has its CatchHandler @ 00f4d510 */
              ...
              if (uVar12 != 0) {
                uVar4 = uVar9 / uVar12;
                    ...
                    /* try { // try from 00f4ba5c to 0104ba67 has its CatchHandler @ 00f4d5e8 */
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00f4b9d4;
              goto LAB_00f4ba84;
            }
            if (uVar9 != uVar14) goto LAB_00f4ba84;
          }
LAB_00f4b9d4:
          plVar8 = (long *)*plVar8;
