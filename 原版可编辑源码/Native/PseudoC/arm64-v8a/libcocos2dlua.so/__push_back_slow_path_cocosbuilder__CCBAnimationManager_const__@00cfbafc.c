...
/* void std::__ndk1::vector<cocosbuilder::CCBAnimationManager*,
   std::__ndk1::allocator<cocosbuilder::CCBAnimationManager*>
   >::__push_back_slow_path<cocosbuilder::CCBAnimationManager*
   const&>(cocosbuilder::CCBAnimationManager* const&) */
...
::__push_back_slow_path<cocosbuilder::CCBAnimationManager*const&>
          (vector<cocosbuilder::CCBAnimationManager*,std::__ndk1::allocator<cocosbuilder::CCBAnimationManager*>>
           *this,CCBAnimationManager **param_1)
