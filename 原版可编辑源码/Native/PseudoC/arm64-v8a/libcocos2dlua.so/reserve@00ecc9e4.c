...
/* std::__ndk1::vector<cocos2d::Vec2, std::__ndk1::allocator<cocos2d::Vec2> >::reserve(unsigned
   long) */

void __thiscall
std::__ndk1::vector<cocos2d::Vec2,std::__ndk1::allocator<cocos2d::Vec2>>::reserve
          (vector<cocos2d::Vec2,std::__ndk1::allocator<cocos2d::Vec2>> *this,ulong param_1)
