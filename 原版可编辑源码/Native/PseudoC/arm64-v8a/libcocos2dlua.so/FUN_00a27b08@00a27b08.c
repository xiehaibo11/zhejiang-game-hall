...
void FUN_00a27b08(long param_1,long param_2)

{
  ...
  uVar5 = FUN_00a282e4(param_2,&local_80);
  lVar2 = param_1 + 0x88;
  uVar7 = 0;
  do {
    ...
    if (iVar12 == -1) {
      ...
      plVar6 = (long *)FUN_00a4b04c(lVar2,&local_64,4);
    }
    ...
    if (plVar6 == (long *)0x0) {
      ...
      local_64 = iVar12;
      if ((iVar12 == -1) ||
         (plVar6 = (long *)FUN_00a4b04c(lVar2,&local_64,4), plVar6 == (long *)0x0)) {
        ...
        *(int *)((long)plVar6 + 0xc) = local_68;
        lVar14 = FUN_00a4ae64(lVar2,&local_68,4,plVar6);
        if (lVar14 == 0) {
...
LAB_00a27c4c:
    ...
    else if (*(uint *)(plVar6 + 1) != uVar8) goto LAB_00a27c4c;
    uVar13 = uVar7 + 1;
    bVar1 = (long)uVar7 < 4;
    uVar7 = uVar13;
  } while (bVar1);
...
LAB_00a27ee8:
            ...
            if ((*(long *)(lVar10 + 0x480) == 0) ||
              ...
              uVar7 = FUN_00a2d1b0(param_2,lVar10);
            ...
            if ((lVar11 == 0) || (*(ulong *)(lVar11 + 0x18) < 2)) {
              if (bVar1) goto LAB_00a27ee8;
            }
            else if (*plVar6 == param_2) {
              uVar7 = FUN_00a2d1e0(param_2,lVar10);
