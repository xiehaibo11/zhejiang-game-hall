...
/* cocos2d::PhysicsJointLimit::construct(cocos2d::PhysicsBody*, cocos2d::PhysicsBody*, cocos2d::Vec2
   const&, cocos2d::Vec2 const&, float, float) */
...

{
  ...
  local_58 = *(long *)(lVar1 + 0x28);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 01003b84 with catch @ 01003c6c
                        */
  pPVar2 = operator_new(0x80,(nothrow_t *)&std::nothrow);
  if (pPVar2 != (PhysicsJoint *)0x0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 01003b1c with catch @ 01003c84
                        */
    pPVar2[0x58] = (PhysicsJoint)0x0;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010039b8 with catch @ 01003c98
                        */
    ...
    *(undefined ***)pPVar2 = &PTR__PhysicsJoint_01725118;
