...
undefined8 FUN_008bfa4c(undefined8 param_1)

{
  ...
  local_a8 = *(long *)(lVar1 + 0x28);
                    /* try { // try from 008bfa94 to 009bfafb has its CatchHandler @ 008bfa94
                       catch() { ... } // from try @ 008bfa94 with catch @ 008bfa94
                       catch() { ... } // from try @ 008bfc0c with catch @ 008bfa94 */
  iVar2 = tolua_isnumber(param_1,1,0,auStack_b8);
                    /* try { // try from 008bfafc to 009bfc0b has its CatchHandler @ 008bfc54 */
  if ((((((iVar2 == 0) || (iVar2 = tolua_isnumber(param_1,2,0,auStack_b8), iVar2 == 0)) ||
     ...
     ((iVar2 = tolua_istable(param_1,9,0,auStack_b8), iVar2 == 0 ||
      (iVar2 = tolua_isnoobj(param_1,10,auStack_b8), iVar2 == 0)))) {
    tolua_error(param_1,"#ferror in function \'glCompressedTexImage2D\'.",auStack_b8);
  }
  else {
    ...
    dVar12 = (double)tolua_tonumber(0,param_1,7);
                    /* try { // try from 008bfc0c to 009bfc8b has its CatchHandler @ 008bfa94 */
    ...
    if (pvVar3 != (void *)0x0) {
                    /* catch() { ... } // from try @ 008bfafc with catch @ 008bfc54 */
      if (0 < (long)uVar5) {
        uVar4 = 0;
        do {
          dVar13 = (double)tolua_tofieldnumber(0,param_1,9,uVar4 + 1 & 0xffffffff);
          iVar2 = (int)uVar4;
          *(float *)((long)pvVar3 + uVar4 * 4) = (float)dVar13;
          uVar4 = uVar4 + 1;
