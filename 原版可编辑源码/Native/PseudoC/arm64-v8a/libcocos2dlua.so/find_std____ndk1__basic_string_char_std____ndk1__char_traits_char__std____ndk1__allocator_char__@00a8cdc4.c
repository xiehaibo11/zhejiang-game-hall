...

{
  ...
  local_68 = *(long *)(lVar5 + 0x28);
                    /* try { // try from 00a8cdec to 00b8cdff has its CatchHandler @ 00a8ce40 */
  uVar7 = *(ulong *)(param_1 + 8);
  pbVar2 = *(basic_string **)(param_1 + 0x10);
                    /* try { // try from 00a8ce00 to 00b8ce5b has its CatchHandler @ 00a8cd34 */
  if (((byte)*param_1 & 1) == 0) {
    pbVar2 = param_1 + 1;
  ...
  if (uVar12 != 0) {
    ...
    if (uVar13 < 2) {
      ...
      uVar14 = uVar7;
                    /* catch() { ... } // from try @ 00a8cd84 with catch @ 00a8ce40
                       catch() { ... } // from try @ 00a8cdec with catch @ 00a8ce40 */
      if (uVar12 <= uVar7) {
        uVar14 = 0;
        if (uVar12 != 0) {
          uVar14 = uVar7 / uVar12;
      ...
      if (plVar8 != (long *)0x0) {
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (sVar1 == __n) {
                    /* try { // try from 00a8ced4 to 00b8cf47 has its CatchHandler @ 00a8ced4
                       catch() { ... } // from try @ 00a8ced4 with catch @ 00a8ced4
                       catch() { ... } // from try @ 00a8cf54 with catch @ 00a8ced4 */
              __s1 = (void *)plVar8[4];
              if ((bVar3 & 1) == 0) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                while (*pbVar10 == *pbVar11) {
                  ...
                  pbVar10 = pbVar10 + 1;
                  pbVar11 = pbVar11 + 1;
                  if (uVar9 == 0) goto LAB_00a8cf54;
                }
              }
              else {
                    /* try { // try from 00a8cf48 to 00b8cf53 has its CatchHandler @ 00a8cfcc */
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00a8cea0;
              goto LAB_00a8cf50;
            }
            if (uVar9 != uVar14) goto LAB_00a8cf50;
          }
LAB_00a8cea0:
          plVar8 = (long *)*plVar8;
...
LAB_00a8cf50:
  plVar8 = (long *)0x0;
LAB_00a8cf54:
                    /* try { // try from 00a8cf54 to 00b8d023 has its CatchHandler @ 00a8ced4 */
