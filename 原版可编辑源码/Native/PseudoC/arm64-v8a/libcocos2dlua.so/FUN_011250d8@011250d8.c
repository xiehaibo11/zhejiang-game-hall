...
void FUN_011250d8(long param_1,long param_2,undefined8 param_3,undefined8 param_4,uint param_5,
      ...
      do {
        ...
        do {
          ...
          TIFFYCbCrtoRGB(*(undefined8 *)(param_1 + 0x68),puVar15[-6],uVar6,uVar7,&local_64,
                         &iStack_68,&local_6c);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 011255c4 with catch @ 011257bc
                        */
          ...
          if (param_6 != 1) {
            if (param_6 != 2) {
              if (param_6 != 3) {
                ...
                *(uint *)(lVar11 + lVar13) =
                     local_64 | iStack_68 << 8 | local_6c << 0x10 | 0xff000000;
                    /* try { // try from 01125548 to 012255c3 has its CatchHandler @ 01125548
                       catch(type#1 @ 00000000) { ... } // from try @ 01125548 with catch @ 01125548
                        */
              }
              TIFFYCbCrtoRGB(*(undefined8 *)(param_1 + 0x68),puVar15[8],uVar6,uVar7,&local_64,
                             &iStack_68,&local_6c);
            ...
            *(uint *)(lVar17 + lVar13) = local_64 | iStack_68 << 8 | local_6c << 0x10 | 0xff000000;
                    ...
                    /* try { // try from 011255c4 to 012255cf has its CatchHandler @ 011257bc */
          TIFFYCbCrtoRGB(*(undefined8 *)(param_1 + 0x68),*puVar15,uVar6,uVar7,&local_64,&iStack_68,
                         &local_6c);
