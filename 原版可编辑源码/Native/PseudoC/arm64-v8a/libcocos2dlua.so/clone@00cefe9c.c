...
/* covariant return thunk to cocosbuilder::CCBRotateYTo::clone() const */

Action * __thiscall cocosbuilder::CCBRotateYTo::clone(CCBRotateYTo *this)

{
  ...
  if (this_00 != (Action *)0x0) {
    ...
    *(undefined ***)this_00 = &PTR__Action_016cf3b0;
    *(undefined ***)(this_00 + 0x28) = &PTR_clone_016cf410;
  }
