  ...
  if (lVar5 != 0) {
    ...
    *(undefined8 *)(this + 0x18) = 0;
    while (plVar7 != (long *)0x0) {
      if (param_2 == param_3) goto LAB_00cf0f38;
      if (param_2 != plVar7) {
        uVar1 = param_2[3];
...
LAB_00cf0f54:
  for (; param_2 != param_3; param_2 = (long *)*param_2) {
    __construct_node<std::__ndk1::pair<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const,cocosbuilder::CCBSequenceProperty*>const&>
              (this);
    FUN_00cf1030(this,local_60);
  }
