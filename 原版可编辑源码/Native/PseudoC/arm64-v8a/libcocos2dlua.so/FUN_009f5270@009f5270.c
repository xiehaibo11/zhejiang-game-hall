...
void * FUN_009f5270(long param_1,ulong param_2,long param_3,uint *param_4)

{
  ...
  *__ptr = 0;
  ...
  uVar9 = (ulong)uVar8;
  pvVar13 = (void *)0x0;
  if ((uVar8 < uVar5 - 7) || (uVar5 - 4 < uVar8)) goto LAB_009f54f0;
  ...
  if (uVar8 == 0) {
    ...
    if (uVar8 == 1) {
      ...
      if (uVar12 == uVar9) goto LAB_009f54e8;
    }
    uVar14 = (int)uVar12 << 3;
    do {
      uVar5 = uVar14 & 0x18;
