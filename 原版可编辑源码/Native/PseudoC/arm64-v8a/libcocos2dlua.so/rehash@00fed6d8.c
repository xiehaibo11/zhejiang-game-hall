  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      uVar1 = (ulong)((float)*(ulong *)(this + 0x18) / *(float *)(this + 0x20));
                    /* try { // try from 00fed748 to 010ed74b has its CatchHandler @ 00fed894 */
                    /* try { // try from 00fed74c to 010ed783 has its CatchHandler @ 00fed67c */
      if ((uVar2 < 3) ||
         ...
         uVar3 = NEON_uaddlv(uVar4,1), 1 < (uint)CONCAT62((int6)((ulong)uVar4 >> 0x10),uVar3))) {
                    /* try { // try from 00fed784 to 010ed787 has its CatchHandler @ 00fed890 */
        uVar1 = __next_prime(uVar1);
      }
      else if (1 < uVar1) {
        uVar1 = 1L << ((ulong)(uint)-(int)LZCOUNT(uVar1 - 1) & 0x3f);
      }
                    /* try { // try from 00fed788 to 010ed7f3 has its CatchHandler @ 00fed67c */
      if (uVar1 <= param_1) {
        uVar1 = param_1;
      }
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00fed79c;
    }
    return;
  }
LAB_00fed79c:
