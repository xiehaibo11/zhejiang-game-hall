...
bool FUN_008bba44(long param_1,PhysicsWorld *param_2,void *param_3)

{
  ...
  toluafix_pushusertype_ccobject
            (*(lua_State **)(param_1 + 0x10),*(int *)((long)param_3 + 0xc),
             (int *)((long)param_3 + 0x10),param_3,"cc.PhysicsShape");
