  ...
  if (uVar6 < 2) {
    ...
    if (uVar3 != 0) {
      uVar7 = uVar4 / uVar3;
                    ...
                    /* try { // try from 00e0d228 to 00f0d22f has its CatchHandler @ 00e0d368 */
    if (uVar3 <= uVar4) {
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar6 < 2) {
      ...
      uVar7 = uVar7 - uVar1 * uVar3;
                    ...
                    /* try { // try from 00e0d294 to 00f0d2db has its CatchHandler @ 00e0d384 */
    if (uVar7 == uVar4) goto LAB_00e0d2dc;
  }
  if (*param_3 != 0) {
  ...
  if (*param_3 != 0) {
    ...
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
                    ...
                    /* try { // try from 00e0d2f4 to 00f0d2fb has its CatchHandler @ 00e0d3ac */
      if (uVar3 <= uVar7) {
        uVar6 = 0;
        if (uVar3 != 0) {
          uVar6 = uVar7 / uVar3;
        }
                    /* try { // try from 00e0d2fc to 00f0d3ef has its CatchHandler @ 00e0d148 */
