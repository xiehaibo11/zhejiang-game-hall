...
undefined8 FUN_008c5cfc(undefined8 param_1)

{
  ...
  long local_48;
                    ...
                    /* try { // try from 008c5d08 to 009c5da3 has its CatchHandler @ 008c5b8c */
  lVar1 = tpidr_el0;
  local_48 = *(long *)(lVar1 + 0x28);
  iVar2 = tolua_isnumber(param_1,1,0,auStack_58);
                    /* catch() { ... } // from try @ 008c5cbc with catch @ 008c5d54 */
                    /* catch() { ... } // from try @ 008c5cd4 with catch @ 008c5d58 */
                    /* catch() { ... } // from try @ 008c5c88 with catch @ 008c5d88 */
  if ((((iVar2 == 0) || (iVar2 = tolua_isnumber(param_1,2,0,auStack_58), iVar2 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glUniform4i\'.",auStack_58);
  }
  else {
    ...
    glUniform4i((int)dVar3,(int)dVar4,(int)dVar5,(int)dVar6,(int)dVar7);
  }
