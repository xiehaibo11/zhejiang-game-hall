...

{
  ...
  local_1d8 = local_190;
  local_1d0 = pcVar8;
  if (param_2 != (long *)0x0) goto LAB_011e1cbc;
LAB_011e1cd0:
  bVar2 = true;
  if (param_3 != (long *)0x0) goto LAB_011e1cfc;
  do {
    param_3 = (long *)0x0;
    if (bVar2) {
LAB_011e1e28:
      ...
      uVar9 = FUN_01208e8c(pcVar8,local_1d0,param_5);
      *param_6 = uVar9;
      __check_grouping(local_1b0,local_190,local_1d8,(uint *)param_5);
      if (param_2 == (long *)0x0) {
        bVar2 = true;
        if (param_3 == (long *)0x0) goto LAB_011e1eb8;
LAB_011e1ee4:
        ...
        if (bVar2 != (iVar4 == -1)) goto LAB_011e1f28;
      }
      else {
        ...
        param_2 = plVar7;
        if (param_3 != (long *)0x0) goto LAB_011e1ee4;
LAB_011e1eb8:
        if (!bVar2) goto LAB_011e1f28;
      }
      *param_5 = *param_5 | 2;
LAB_011e1f28:
      if ((local_1c8 & 1) != 0) {
    ...
    while( true ) {
      ...
      plVar7 = param_2;
      if (param_2 == (long *)0x0) goto LAB_011e1cd0;
LAB_011e1cbc:
