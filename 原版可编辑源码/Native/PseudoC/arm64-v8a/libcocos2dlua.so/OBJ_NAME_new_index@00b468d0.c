...

{
  ...
  if (DAT_01784a20 == 0) {
    ...
    DAT_01784a20 = OPENSSL_sk_new_null(iVar2);
    CRYPTO_mem_ctrl(2);
    if (DAT_01784a20 == 0) {
      return 0;
    }
  ...
  iVar1 = DAT_0176ea88;
  DAT_0176ea88 = DAT_0176ea88 + 1;
  iVar2 = OPENSSL_sk_num(DAT_01784a20);
  if (iVar2 < DAT_0176ea88) {
    do {
      CRYPTO_mem_ctrl(3);
      ...
      *puVar4 = OPENSSL_LH_strhash;
      puVar4[1] = strcmp;
      CRYPTO_mem_ctrl(3);
      iVar3 = OPENSSL_sk_push(DAT_01784a20,puVar4);
      CRYPTO_mem_ctrl(2);
      if (iVar3 == 0) {
      ...
      iVar2 = iVar2 + 1;
    } while (iVar2 < DAT_0176ea88);
  }
  puVar4 = (undefined8 *)OPENSSL_sk_value(DAT_01784a20,iVar1);
