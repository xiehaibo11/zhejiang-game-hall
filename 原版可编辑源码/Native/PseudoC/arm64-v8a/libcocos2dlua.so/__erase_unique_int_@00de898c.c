...
/* unsigned long std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int,
   ...
   cocos2d::experimental::ui::WebViewImpl*> > >::__erase_unique<int>(int const&) */
      ...
      do {
        ...
        if (uVar8 == uVar5) {
          if ((int)plVar7[2] == *param_1) {
                    /* try { // try from 00de8a80 to 00ee8a87 has its CatchHandler @ 00de8a8c */
            remove(local_40);
            pvVar3 = local_40[0];
                    /* try { // try from 00de8a88 to 00ee8e7b has its CatchHandler @ 00de7154 */
            local_40[0] = (void *)0x0;
                    /* catch() { ... } // from try @ 00de8a80 with catch @ 00de8a8c */
            if (pvVar3 != (void *)0x0) {
                    /* catch() { ... } // from try @ 00de8a78 with catch @ 00de8a90 */
              operator_delete(pvVar3);
            }
                    /* catch() { ... } // from try @ 00de8a70 with catch @ 00de8a94 */
            uVar4 = 1;
                    /* catch() { ... } // from try @ 00de8a68 with catch @ 00de8a98 */
            goto LAB_00de8a5c;
          }
        }
        else {
        ...
        plVar7 = (long *)*plVar7;
                    ...
                    /* try { // try from 00de8a58 to 00ee8a5f has its CatchHandler @ 00de8aa0 */
  uVar4 = 0;
LAB_00de8a5c:
                    /* try { // try from 00de8a60 to 00ee8a67 has its CatchHandler @ 00de8a9c */
                    /* try { // try from 00de8a68 to 00ee8a6f has its CatchHandler @ 00de8a98 */
  if (*(long *)(lVar2 + 0x28) != local_28) {
                    /* WARNING: Subroutine does not return */
                    /* catch() { ... } // from try @ 00de8a60 with catch @ 00de8a9c */
    __stack_chk_fail();
  }
                    /* try { // try from 00de8a70 to 00ee8a77 has its CatchHandler @ 00de8a94 */
                    /* try { // try from 00de8a78 to 00ee8a7f has its CatchHandler @ 00de8a90 */
  return uVar4;
}
