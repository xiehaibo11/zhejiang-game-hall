...
/* lua_cocos2dx_experimental_TMXTiledMap_setObjectGroups(lua_State*) */

undefined4 lua_cocos2dx_experimental_TMXTiledMap_setObjectGroups(lua_State *param_1)

{
  ...
  if (iVar6 + -1 == 1) {
    ...
    bVar5 = luaval_to_ccvector<cocos2d::TMXObjectGroup*>
                      (param_1,2,(Vector *)&local_60,"ccexp.TMXTiledMap:setObjectGroups");
    if (bVar5) {
      ...
      tolua_error(param_1,
                  "invalid arguments in function \'lua_cocos2dx_experimental_TMXTiledMap_setObjectGroups\'"
                  ,0);
      uVar8 = 0;
      ppTVar2 = local_60;
      ppTVar3 = local_58;
    ...
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "ccexp.TMXTiledMap:setObjectGroups",iVar6 + -1,1);
    uVar8 = 0;
  }
