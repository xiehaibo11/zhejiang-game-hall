...

{
    ...
    if ((cmd == 0x66) || (cmd == 0x62)) {
      ...
      if (cmd != 0x5c) {
        return 0;
                    ...
                    /* try { // try from 00ad7b00 to 00bd7b07 has its CatchHandler @ 00ad7b44 */
      iVar2 = tls1_set_curves_list(0,0,parg);
                    /* try { // try from 00ad7b08 to 00bd7b5f has its CatchHandler @ 00ad7a98 */
    }
    goto LAB_00ad7b1c;
  }
  uVar5 = (uint)larg;
  ...
  case 0x10:
    *(void **)&ctx->read_ahead = parg;
    return 1;
  default:
                    /* try { // try from 00ad7bc8 to 00bd7bcf has its CatchHandler @ 00ad7c0c */
                    /* try { // try from 00ad7bd0 to 00bd7c27 has its CatchHandler @ 00ad7b60 */
                    /* WARNING: Could not recover jumptable at 0x00ad7bd4. Too many branches */
  ...
  case 0x18:
                    /* catch() { ... } // from try @ 00ad7bc8 with catch @ 00ad7c0c */
  ...
  case 0x21:
    uVar1 = *(uint *)((long)&ctx->info_callback + 4);
                    /* catch() { ... } // from try @ 00ad7b00 with catch @ 00ad7b44 */
  ...
  case 0x29:
    ...
    *(uint *)&ctx->max_cert_list = uVar5;
                    /* try { // try from 00ad7c74 to 00bd7cdb has its CatchHandler @ 00ad7c74
                       catch() { ... } // from try @ 00ad7c74 with catch @ 00ad7c74
                       catch() { ... } // from try @ 00ad7ce4 with catch @ 00ad7c74 */
  ...
  case 0x2c:
    ...
    ctx->session_cache_mode = uVar5;
                    /* try { // try from 00ad7b60 to 00bd7bc7 has its CatchHandler @ 00ad7b60
                       catch() { ... } // from try @ 00ad7b60 with catch @ 00ad7b60
                       catch() { ... } // from try @ 00ad7bd0 with catch @ 00ad7b60 */
    return (ulong)uVar1;
  case 0x2d:
  ...
  case 99:
    ...
    *(uint *)(ctx->mode + 0x1c) = uVar1 | uVar5;
                    /* try { // try from 00ad7cdc to 00bd7ce3 has its CatchHandler @ 00ad7d20 */
    return (ulong)uVar1 | larg & 0xffffffffU;
  case 100:
    ...
    *(uint *)(ctx->mode + 0x1c) = uVar5;
    return (ulong)uVar5;
  case 0x7b:
                    /* try { // try from 00ad7ce4 to 00bd7d3b has its CatchHandler @ 00ad7c74 */
    pSVar7 = ctx->method;
...
LAB_00ad7d34:
    *(uint *)&ctx->tlsext_servername_callback = uVar5;
                    /* try { // try from 00ad7d3c to 00bd7da3 has its CatchHandler @ 00ad7d3c
                       catch() { ... } // from try @ 00ad7d3c with catch @ 00ad7d3c
                       catch() { ... } // from try @ 00ad7dac with catch @ 00ad7d3c */
    return 1;
  case 0x7e:
    if (larg - 1U < 0x20) {
      *(uint *)&ctx->tlsext_servername_arg = uVar5;
      return 1;
                    ...
                    /* catch() { ... } // from try @ 00ad7cdc with catch @ 00ad7d20 */
    return 0;
  }
