      ...
      do {
        if (((byte)(cVar2 - 1U) < 0x3f) && (pXVar1[(long)cVar2 & 0xffffffff] != (XMLPrinter)0x0)) {
          ...
          case '\"':
            break;
          default:
            goto switchD_010265b0_caseD_23;
          case '&':
            lVar3 = 1;
            break;
          case '\'':
          ...
          Print((char *)this,&DAT_01458a5b,(&PTR_DAT_01727320)[lVar3 * 2]);
switchD_010265b0_caseD_23:
          param_1 = param_1 + 1;
        }
        pcVar5 = pcVar5 + 1;
        cVar2 = *pcVar5;
      } while (cVar2 != '\0');
      if (this[0x20] == (XMLPrinter)0x0) goto LAB_010265e8;
    }
