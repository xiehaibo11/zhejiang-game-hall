...
/* cocostudio::timeline::BoneNode::onDraw(cocos2d::Mat4 const&, unsigned int) */

void cocostudio::timeline::BoneNode::onDraw(Mat4 *param_1,uint param_2)

{
  ...
  glVertexAttribPointer(0,3,0x1406,0,0,param_1 + 0x410);
  glVertexAttribPointer(1,4,0x1406,0,0,param_1 + 0x3d0);
