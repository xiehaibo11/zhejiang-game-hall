...
/* void std::__ndk1::vector<fairygui::GPath::Segment,
   std::__ndk1::allocator<fairygui::GPath::Segment>
   >::__push_back_slow_path<fairygui::GPath::Segment const&>(fairygui::GPath::Segment const&) */
...
__push_back_slow_path<fairygui::GPath::Segment_const&>
          (vector<fairygui::GPath::Segment,std::__ndk1::allocator<fairygui::GPath::Segment>> *this,
          Segment *param_1)
