...

{
  ...
  if ((iVar1 == 0) && (iVar1 = BN_get_flags(param_3,4), iVar1 == 0)) {
    ...
    pBVar4 = BN_CTX_get(param_4);
                    /* catch() { ... } // from try @ 00b979c4 with catch @ 00b97a38 */
    pBVar7 = BN_CTX_get(param_4);
    pBVar5 = BN_CTX_get(param_4);
    pBVar8 = BN_CTX_get(param_4);
    pBVar3 = BN_CTX_get(param_4);
                    /* try { // try from 00b97a70 to 00c97aeb has its CatchHandler @ 00b97a70
                       catch() { ... } // from try @ 00b97a70 with catch @ 00b97a70
                       catch() { ... } // from try @ 00b97b10 with catch @ 00b97a70 */
    ...
    if ((pBVar10 == (BIGNUM *)0x0) ||
       ...
       )) goto joined_r0x00b97c88;
    BN_set_word(pBVar5,1);
    BN_set_word(pBVar6,0);
    pBVar11 = BN_copy(pBVar7,param_2);
                    /* try { // try from 00b97aec to 00c97b0f has its CatchHandler @ 00b97b64 */
    if ((pBVar11 == (BIGNUM *)0x0) ||
       ((pBVar11 = BN_copy(pBVar4,param_3), pBVar11 == (BIGNUM *)0x0 ||
        (((pBVar4->neg = 0, pBVar7->neg != 0 || (iVar1 = BN_ucmp(pBVar7,pBVar4), -1 < iVar1)) &&
         (iVar1 = BN_nnmod(pBVar7,pBVar7,pBVar4,param_4), iVar1 == 0)))))) goto joined_r0x00b97c88;
                    /* try { // try from 00b97b10 to 00c97b9b has its CatchHandler @ 00b97a70 */
    iVar1 = BN_is_odd(param_3);
    if ((iVar1 == 0) || (iVar1 = BN_num_bits(param_3), 0x800 < iVar1)) {
      iVar1 = BN_is_zero(pBVar7);
      if (iVar1 != 0) goto LAB_00b97d0c;
      pBVar11 = pBVar4;
      iVar1 = -1;
      local_a0 = pBVar6;
      do {
        ...
        if (iVar1 == iVar2) {
                    /* catch() { ... } // from try @ 00b97d9c with catch @ 00b97dfc */
                    /* catch() { ... } // from try @ 00b97d20 with catch @ 00b97e00 */
                    /* catch() { ... } // from try @ 00b97c94 with catch @ 00b97e04 */
          iVar1 = BN_set_word(pBVar8,1);
          if (iVar1 == 0) goto joined_r0x00b97c88;
          iVar1 = BN_sub(pBVar3,pBVar5,pBVar4);
        }
        else {
          iVar1 = BN_num_bits(pBVar5);
                    /* try { // try from 00b97e3c to 00c97f43 has its CatchHandler @ 00b97e3c
                       catch() { ... } // from try @ 00b97e3c with catch @ 00b97e3c
                       catch() { ... } // from try @ 00b97f48 with catch @ 00b97e3c
                       catch() { ... } // from try @ 00b97fa0 with catch @ 00b97e3c */
          iVar2 = BN_num_bits(pBVar4);
          if (iVar1 == iVar2 + 1) {
...
joined_r0x00b97f28:
        ...
        pBVar7 = pBVar6;
        if (iVar1 == 0) {
                    /* try { // try from 00b97f44 to 00c97f47 has its CatchHandler @ 00b97fa0 */
                    /* try { // try from 00b97f48 to 00c97f9b has its CatchHandler @ 00b97e3c */
          iVar1 = BN_is_word(pBVar8,2);
          if (iVar1 == 0) {
            iVar1 = BN_is_word(pBVar8,4);
            if (iVar1 == 0) {
                    /* try { // try from 00b97f9c to 00c97f9f has its CatchHandler @ 00b97fa0 */
              if (pBVar8->top == 1) {
                    /* catch() { ... } // from try @ 00b97f44 with catch @ 00b97fa0
                       catch() { ... } // from try @ 00b97f9c with catch @ 00b97fa0
                       try { // try from 00b97fa0 to 00c97fdb has its CatchHandler @ 00b97e3c */
                pBVar7 = BN_copy(pBVar5,pBVar6);
                if (pBVar7 == (BIGNUM *)0x0) goto joined_r0x00b97c88;
          ...
          if (iVar1 == 0) goto joined_r0x00b97c88;
                    ...
                    /* try { // try from 00b97fe4 to 00c98067 has its CatchHandler @ 00b97fe4
                       catch() { ... } // from try @ 00b97fe4 with catch @ 00b97fe4
                       catch() { ... } // from try @ 00b98078 with catch @ 00b97fe4 */
      ...
      while (iVar1 == 0) {
        ...
        while (iVar2 = BN_is_bit_set(pBVar7,iVar1), iVar2 == 0) {
          iVar2 = BN_is_odd(pBVar5);
                    /* catch() { ... } // from try @ 00b97aec with catch @ 00b97b64 */
          if ((iVar2 != 0) && (iVar2 = BN_uadd(pBVar5,pBVar5,param_3), iVar2 == 0))
          goto joined_r0x00b97c88;
          iVar1 = iVar1 + 1;
          iVar2 = BN_rshift1(pBVar5,pBVar5);
          if (iVar2 == 0) goto joined_r0x00b97c88;
        }
                    /* try { // try from 00b97b9c to 00c97c93 has its CatchHandler @ 00b97b9c
                       catch() { ... } // from try @ 00b97b9c with catch @ 00b97b9c
                       catch() { ... } // from try @ 00b97da0 with catch @ 00b97b9c */
...
LAB_00b97d0c:
      ...
      if (iVar1 == 0) goto joined_r0x00b97c88;
                    ...
                    /* try { // try from 00b97d20 to 00c97d6b has its CatchHandler @ 00b97e00 */
    ...
    if ((pBVar6->neg == 0) && (iVar1 = BN_ucmp(pBVar6,param_3), iVar1 < 0)) {
                    /* try { // try from 00b98068 to 00c98077 has its CatchHandler @ 00b980c0 */
      pBVar7 = BN_copy(pBVar9,pBVar6);
      if (pBVar7 == (BIGNUM *)0x0) {
LAB_00b98078:
                    /* try { // try from 00b98078 to 00c980f7 has its CatchHandler @ 00b97fe4 */
        pBVar5 = (BIGNUM *)0x0;
      }
    }
    else {
      iVar1 = BN_nnmod(pBVar9,pBVar6,param_3,param_4);
      if (iVar1 == 0) goto LAB_00b98078;
    }
    if (param_1 != (BIGNUM *)0x0 || pBVar5 != (BIGNUM *)0x0) goto LAB_00b97d9c;
  }
  else {
    BN_CTX_start(param_4);
    pBVar3 = BN_CTX_get(param_4);
                    /* try { // try from 00b978a0 to 00c978c3 has its CatchHandler @ 00b9791c */
    pBVar4 = BN_CTX_get(param_4);
    pBVar5 = BN_CTX_get(param_4);
    pBVar6 = BN_CTX_get(param_4);
                    /* try { // try from 00b978c4 to 00c97953 has its CatchHandler @ 00b97818 */
    pBVar7 = BN_CTX_get(param_4);
    pBVar8 = BN_CTX_get(param_4);
    ...
    if (pBVar9 == (BIGNUM *)0x0) {
      ...
      if ((param_1 != (BIGNUM *)0x0) || (pBVar9 = BN_new(), pBVar9 != (BIGNUM *)0x0)) {
        ...
        BN_set_word(pBVar8,0);
                    /* catch() { ... } // from try @ 00b978a0 with catch @ 00b9791c */
        pBVar10 = BN_copy(pBVar4,param_2);
        if ((pBVar10 != (BIGNUM *)0x0) &&
           (pBVar10 = BN_copy(pBVar3,param_3), pBVar10 != (BIGNUM *)0x0)) {
          pBVar3->neg = 0;
                    /* try { // try from 00b97954 to 00c979c3 has its CatchHandler @ 00b97954
                       catch() { ... } // from try @ 00b97954 with catch @ 00b97954
                       catch() { ... } // from try @ 00b979e8 with catch @ 00b97954 */
          ...
          while (pBVar11 = pBVar7, pBVar10 = pBVar5, iVar2 = BN_is_zero(pBVar4), iVar2 == 0) {
            ...
            BN_with_flags(&BStack_78,pBVar3,4);
                    /* try { // try from 00b979c4 to 00c979e7 has its CatchHandler @ 00b97a38 */
            iVar2 = BN_div(pBVar6,pBVar11,&BStack_78,pBVar4,param_4);
                    /* try { // try from 00b979e8 to 00c97a6f has its CatchHandler @ 00b97954 */
            ...
            if (iVar2 == 0) goto joined_r0x00b97c88;
                    ...
                    /* try { // try from 00b97c94 to 00c97cdf has its CatchHandler @ 00b97e04 */
...
LAB_00b97ce8:
                pBVar5 = pBVar9;
                if (param_1 != (BIGNUM *)0x0 || pBVar9 != (BIGNUM *)0x0) goto LAB_00b97d9c;
                goto LAB_00b97d98;
              }
            }
            else {
              iVar1 = BN_nnmod(pBVar9,pBVar8,param_3,param_4);
              if (iVar1 != 0) goto LAB_00b97ce8;
            }
          }
        }
      }
...
joined_r0x00b97c88:
    pBVar5 = (BIGNUM *)0x0;
    if (param_1 != (BIGNUM *)0x0) goto LAB_00b97d9c;
  }
LAB_00b97d98:
  BN_free(pBVar9);
LAB_00b97d9c:
                    /* try { // try from 00b97d9c to 00c97d9f has its CatchHandler @ 00b97dfc */
                    /* try { // try from 00b97da0 to 00c97e3b has its CatchHandler @ 00b97b9c */
  BN_CTX_end(param_4);
  return pBVar5;
}
