...
/* cocosbuilder::LabelBMFontLoader::onHandlePropTypeColor3(cocos2d::Node*, cocos2d::Node*, char
   const*, cocos2d::Color3B, cocosbuilder::CCBReader*) */

void __thiscall
cocosbuilder::LabelBMFontLoader::onHandlePropTypeColor3
          (LabelBMFontLoader *this,long *param_1,undefined8 param_2,char *param_3,ulong param_5,
          undefined8 param_6)
