...
void FUN_011f4ba8(long param_1,__shared_count *param_2)

{
  ...
  if (std::__ndk1::collate<char>::id != -1) {
    ...
    std::__ndk1::__call_once((ulong *)&std::__ndk1::collate<char>::id,&local_58,FUN_01208130);
  }
  uVar2 = (ulong)DAT_01794198;
  uVar6 = uVar2 - 1;
