...
/* cocos2d::experimental::AudioEngine::setLoop(int, bool) */

void cocos2d::experimental::AudioEngine::setLoop(int param_1,bool param_2)
      ...
      do {
        ...
        if (uVar5 == uVar2) {
          if ((int)plVar4[2] == param_1) {
            if ((bool)*(char *)((long)plVar4 + 0x2c) == param_2) {
              return;
            }
            AudioEngineImpl::setLoop(_audioEngineImpl,param_1,param_2);
            *(bool *)((long)plVar4 + 0x2c) = param_2;
            return;
          }
        }
        else {
