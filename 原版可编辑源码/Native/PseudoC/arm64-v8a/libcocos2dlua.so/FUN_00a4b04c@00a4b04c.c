...
undefined8 FUN_00a4b04c(long *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  undefined8 *puVar4;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00a4b028 with catch @ 00a4b058
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00a4afc0 with catch @ 00a4b05c
                        */
  if (param_1 != (long *)0x0) {
    lVar2 = *param_1;
