...
/* cocostudio::PageViewReader::createOptionsWithFlatBuffers(tinyxml2::XMLElement const*,
   flatbuffers::FlatBufferBuilder*) */

undefined4 __thiscall
cocostudio::PageViewReader::createOptionsWithFlatBuffers
          (PageViewReader *this,XMLElement *param_1,FlatBufferBuilder *param_2)
              ...
              if ((int)*plVar1 == 0x68746150) {
                ...
                if (((byte)local_148 & 1) == 0) {
                  ...
                  if (uStack_140 < 0x17) {
                    ...
                    if (uStack_140 != 0) goto LAB_00c89e28;
                  }
                  else {
                    ...
                    local_150 = __dest;
LAB_00c89e28:
                    pPVar17 = memcpy(__dest,pcVar16,__n);
                  }
                  __dest[__n] = '\0';
                }
                iVar10 = getResourceType(pPVar17,&local_160);
                if ((local_160 & 1) != 0) {
  ...
  uVar9 = flatbuffers::CreatePageViewOptions
