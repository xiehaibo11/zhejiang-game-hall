...
/* cocos2d::TransitionZoomFlipX::create(float, cocos2d::Scene*,
   cocos2d::TransitionScene::Orientation) */

Scene * cocos2d::TransitionZoomFlipX::create(undefined4 param_1,Ref *param_2,undefined4 param_3)

{
  ...
  if (this != (Scene *)0x0) {
    ...
    *(undefined ***)this = &PTR__TransitionFlipX_017183c0;
  }
