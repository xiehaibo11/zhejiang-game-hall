...

{
  ...
  *(ulong *)(param_1 + 0x38) = uVar10;
  ...
  if (uVar11 != 0) {
    if (param_4 == 0) goto LAB_00b435f4;
    pbVar7 = param_3;
    pbVar8 = param_2;
    uVar10 = param_4;
    do {
      ...
      uVar11 = uVar11 + 1 & 0xf;
      param_4 = uVar10 - 1;
      bVar1 = *(byte *)(param_1 + 0x10 + uVar6) ^ *pbVar8;
      param_3 = pbVar7 + 1;
      *pbVar7 = bVar1;
      *(byte *)(param_1 + 0x40 + uVar6) = *(byte *)(param_1 + 0x40 + uVar6) ^ bVar1;
      if (uVar11 == 0) break;
      bVar5 = uVar10 != 1;
      pbVar7 = param_3;
      pbVar8 = param_2;
    ...
    if (uVar11 != 0) goto LAB_00b435f4;
    (*pcVar2)(param_1 + 0x40,param_1 + 0x60);
  }
  uVar11 = (uVar4 & 0xff00ff00) >> 8 | (uVar4 & 0xff00ff) << 8;
  ...
  if (0xbff < param_4) {
    do {
      ...
      *(uint *)(param_1 + 0xc) = uVar4 >> 0x10 | uVar4 << 0x10;
      (*pcVar3)(param_1 + 0x40,param_1 + 0x60,param_3,0xc00);
  ...
  if (uVar10 != 0) {
    ...
    *(uint *)(param_1 + 0xc) = uVar4 >> 0x10 | uVar4 << 0x10;
    (*pcVar3)(param_1 + 0x40,param_1 + 0x60,param_3,uVar10);
  ...
  if (param_4 == 0) {
    ...
    *(uint *)(param_1 + 0xc) = uVar11 >> 0x10 | uVar11 << 0x10;
    do {
      ...
      uVar10 = uVar10 + 1;
      bVar1 = *(byte *)(param_1 + 0x10 + uVar6) ^ param_2[uVar6];
      param_3[uVar6] = bVar1;
      *(byte *)(param_1 + 0x40 + uVar6) = *(byte *)(param_1 + 0x40 + uVar6) ^ bVar1;
