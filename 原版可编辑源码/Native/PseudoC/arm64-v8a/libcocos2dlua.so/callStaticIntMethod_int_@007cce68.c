...
/* int cocos2d::JniHelper::callStaticIntMethod<int>(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&, int) */

int cocos2d::JniHelper::callStaticIntMethod<int>
...

{
  ...
  *puVar6 = 0;
  ...
  if ((uVar7 & 1) == 0) {
    ...
    local_50 = (void *)0x0;
    local_40 = 0x3f800000;
    iVar5 = _JNIEnv::CallStaticIntMethod(local_78,p_Stack_70,local_68,(ulong)(uint)param_3);
