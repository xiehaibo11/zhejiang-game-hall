...
LAB_00b4d0e0:
    ...
    if (local_168[0] == 10) goto LAB_00b4d1f0;
  ...
  *pBVar6->data = '\0';
  ...
  if (!bVar1) {
    do {
      ...
      iVar4 = strncmp((char *)local_168,"-----END ",9);
      iVar3 = local_68;
      if ((0x3f < iVar10) || (iVar4 == 0)) goto LAB_00b4d408;
