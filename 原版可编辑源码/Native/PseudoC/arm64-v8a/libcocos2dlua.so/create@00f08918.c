...
/* cocos2d::TiledGrid3D::create(cocos2d::Size const&, cocos2d::Texture2D*, bool, cocos2d::Rect
   const&) */

Ref * cocos2d::TiledGrid3D::create(Size *param_1,Texture2D *param_2,bool param_3,Rect *param_4)
