...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, cocos2d::Vec4>, void*>*>, bool>
   std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, cocos2d::Vec4>,
   std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> >, cocos2d::Vec4>, std::__ndk1::hash<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > >, true>,
   std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> >, cocos2d::Vec4>,
      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if (uVar13 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00ab4f20;
            break;
          }
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00ab4f90;
              }
              goto LAB_00ab4ed8;
            }
          }
...
LAB_00ab4ed8:
  ...
  plVar15 = operator_new(0x38);
                    /* try { // try from 00ab4fa4 to 00bb4feb has its CatchHandler @ 00ab4fa4
                       catch() { ... } // from try @ 00ab4fa4 with catch @ 00ab4fa4
                       catch() { ... } // from try @ 00ab50b8 with catch @ 00ab4fa4
                       catch() { ... } // from try @ 00ab51a4 with catch @ 00ab4fa4 */
  ...
  __s1 = (void *)cocos2d::Vec4::Vec4((Vec4 *)(plVar15 + 5));
  *plVar15 = 0;
  plVar15[1] = uVar7;
  if ((uVar16 == 0) ||
     (*(float *)(param_1 + 0x20) * (float)uVar16 < (float)(*(long *)(param_1 + 0x18) + 1))) {
                    /* try { // try from 00ab4fec to 00bb5003 has its CatchHandler @ 00ab51e4 */
    uVar16 = (ulong)(uVar16 < 3 || (uVar16 & uVar16 - 1) != 0) | uVar16 << 1;
                    /* try { // try from 00ab5008 to 00bb502f has its CatchHandler @ 00ab51dc */
    ...
    if ((uVar16 & uVar16 - 1) == 0) {
      ...
      if (uVar16 <= uVar7) {
        ...
        unaff_x27 = uVar7 - uVar13 * uVar16;
                    ...
                    /* try { // try from 00ab504c to 00bb5063 has its CatchHandler @ 00ab51e0 */
  lVar14 = *(long *)param_1;
  plVar11 = *(long **)(lVar14 + unaff_x27 * 8);
  if (plVar11 == (long *)0x0) {
    pbVar12 = param_1 + 0x10;
    *plVar15 = *(long *)pbVar12;
                    /* try { // try from 00ab5070 to 00bb5087 has its CatchHandler @ 00ab51bc */
    *(long **)pbVar12 = plVar15;
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar12;
    if (*plVar15 == 0) goto LAB_00ab50b4;
    uVar7 = *(ulong *)(*plVar15 + 8);
                    /* try { // try from 00ab508c to 00bb50b7 has its CatchHandler @ 00ab51b8 */
    if ((uVar16 & uVar16 - 1) == 0) {
...
LAB_00ab50b4:
                    /* try { // try from 00ab50b8 to 00bb518f has its CatchHandler @ 00ab4fa4 */
  uVar8 = 1;
