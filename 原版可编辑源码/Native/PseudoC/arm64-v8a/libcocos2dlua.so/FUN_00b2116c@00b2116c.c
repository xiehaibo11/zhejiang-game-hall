...
undefined4
FUN_00b2116c(EC_KEY *param_1,BN_CTX *param_2,undefined8 *param_3,undefined8 *param_4,long param_5,
            int param_6)
...
LAB_00b214e0:
      ...
      do {
        ...
        if (iVar1 == 0) goto LAB_00b214f0;
        iVar1 = BN_num_bits(rnd);
        iVar2 = BN_num_bits(pBVar3);
        if ((iVar1 <= iVar2) && (iVar1 = BN_add(rnd,rnd,pBVar3), iVar1 == 0)) goto LAB_00b214f0;
