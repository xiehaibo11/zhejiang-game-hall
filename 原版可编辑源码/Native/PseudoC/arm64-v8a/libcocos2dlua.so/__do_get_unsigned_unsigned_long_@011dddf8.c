...

{
  ...
  plVar9 = param_2;
  local_168 = pcVar10;
  if (param_2 != (long *)0x0) goto LAB_011ddedc;
LAB_011ddee8:
  if (param_3 == (long *)0x0) goto LAB_011ddf34;
  while( true ) {
    ...
    while( true ) {
      ...
      plVar9 = param_2;
      if (param_2 == (long *)0x0) goto LAB_011ddee8;
LAB_011ddedc:
      param_2 = plVar9;
      if (plVar9[3] != plVar9[4]) goto LAB_011ddee8;
...
LAB_011ddf34:
      param_3 = (long *)0x0;
      if (param_2 == (long *)0x0) goto LAB_011de024;
    }
  }
LAB_011de024:
  ...
  uVar6 = FUN_01208acc(pcVar10,local_168,param_5,iVar5);
  *param_6 = uVar6;
  __check_grouping(local_148,local_12c,local_170,param_5);
  plVar9 = param_2;
  if ((param_2 == (long *)0x0) || (param_2[3] != param_2[4])) {
    if (param_3 != (long *)0x0) goto LAB_011de0a4;
LAB_011de148:
    if (plVar9 != (long *)0x0) goto LAB_011de0d8;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_011de148;
LAB_011de0a4:
