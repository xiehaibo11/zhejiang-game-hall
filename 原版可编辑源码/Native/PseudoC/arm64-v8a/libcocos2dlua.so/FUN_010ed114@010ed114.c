...
void FUN_010ed114(long param_1,long param_2,long param_3,long *param_4)
...
LAB_010ed2e4:
                ...
                if ((bVar4 & 1) != 0) goto LAB_010ed2e4;
              }
              pbVar12 = pbVar12 + 1;
      ...
      uVar8 = iVar6 + uVar16 + 1;
                    /* catch() { ... } // from try @ 010ed1d4 with catch @ 010ed18c */
      sVar1 = (ulong)uVar8 + 1;
      uVar8 = ~uVar8 & 1;
      lVar14 = sVar1 - uVar8;
      lVar17 = 0;
      ...
      do {
        if (*(uint *)(param_1 + 0x88) == 0) {
          ...
          pvVar15 = *(void **)(lVar11 + uVar13 * 8);
                    /* try { // try from 010ed1b8 to 011ed1bb has its CatchHandler @ 010ed1ec */
          if (uVar16 == 0) {
            do {
                    /* WARNING: Do nothing block with infinite loop */
            } while( true );
          ...
          pbVar12 = *(byte **)(param_3 + lVar17 * 8);
          do {
                    /* try { // try from 010ed1c8 to 011ed1d3 has its CatchHandler @ 010ed1f0 */
                    /* try { // try from 010ed1d4 to 011ed223 has its CatchHandler @ 010ed18c */
            memset(pvVar15,(uint)*pbVar12,sVar1);
            if ((sVar1 < 2) || (lVar14 == 0)) {
              uVar7 = (uint)bVar4;
LAB_010ed204:
              ...
              lVar9 = lVar14;
              do {
                    /* catch() { ... } // from try @ 010ed1b8 with catch @ 010ed1ec */
                lVar9 = lVar9 + -2;
                    /* catch() { ... } // from try @ 010ed1c8 with catch @ 010ed1f0 */
              } while (lVar9 != 0);
              uVar7 = uVar16 - (int)lVar14;
              if (uVar8 != 0) goto LAB_010ed204;
            }
            pbVar12 = pbVar12 + 1;
          } while (pvVar15 < pvVar2);
