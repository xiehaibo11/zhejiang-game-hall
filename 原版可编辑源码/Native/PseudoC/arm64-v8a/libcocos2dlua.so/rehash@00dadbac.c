...
::rehash(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::ui::LayoutParameter*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::LayoutParameter*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::LayoutParameter*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::ui::LayoutParameter*>>>
         *this,ulong param_1)

{
  ...
  undefined8 uVar4;
                    ...
                    /* try { // try from 00dadbbc to 00eadbcb has its CatchHandler @ 00dae318 */
  if (param_1 - 1 == 0) {
    param_1 = 2;
                    /* try { // try from 00dadbcc to 00eadc33 has its CatchHandler @ 00dad6f4 */
  }
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      uVar1 = (ulong)((float)*(ulong *)(this + 0x18) / *(float *)(this + 0x20));
                    /* try { // try from 00dadc34 to 00eadc43 has its CatchHandler @ 00dae314 */
      if ((uVar2 < 3) ||
        ...
        uVar1 = __next_prime(uVar1);
                    ...
                    /* try { // try from 00dadc44 to 00eadcab has its CatchHandler @ 00dad6f4 */
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00dadc70;
    }
    return;
  }
LAB_00dadc70:
