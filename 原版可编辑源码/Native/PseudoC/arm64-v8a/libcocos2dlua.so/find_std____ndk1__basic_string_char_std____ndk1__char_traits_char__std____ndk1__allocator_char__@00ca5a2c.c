...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::function<cocostudio::timeline::Frame*
   (rapidjson::GenericValue<rapidjson::UTF8<char>,
   rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator> > const&)> >, void*>*>
   ...
   std::__ndk1::allocator<char> >, std::__ndk1::function<cocostudio::timeline::Frame*
   (rapidjson::GenericValue<rapidjson::UTF8<char>,
   rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator> > const&)> >,
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00ca5b08;
              goto LAB_00ca5bb8;
            }
            if (uVar9 != uVar14) goto LAB_00ca5bb8;
          }
LAB_00ca5b08:
          plVar8 = (long *)*plVar8;
