...
void FUN_01158fb8(byte *param_1,byte *param_2,byte *param_3,byte *param_4,byte *param_5,
...

{
  ...
  bVar48 = *param_1;
  *param_7 = 0xff;
  iVar41 = ((uint)bVar45 + (uint)bVar44 >> 1) + 1;
  iVar1 = ((uint)bVar47 + (uint)bVar46 >> 1) + 1;
  uVar7 = iVar1 + (uint)bVar46 >> 1 & 0xff;
  uVar5 = (uint)bVar48 * 0x4a85 >> 8;
  uVar38 = (uVar5 + (uVar7 * 0x6625 >> 8)) - 0x379a;
  uVar39 = iVar41 + (uint)bVar44 >> 1 & 0xff;
  if (uVar38 >> 0xe == 0) {
  ...
  uVar38 = ((uVar5 + 0x2204) - (uVar39 * 0x1913 >> 8)) - (uVar7 * 0x3408 >> 8);
  param_7[1] = cVar42;
  if (uVar38 >> 0xe == 0) {
    cVar42 = (char)(uVar38 >> 6);
  }
  ...
  param_7[3] = cVar42;
  if (param_2 != (byte *)0x0) {
    uVar39 = iVar1 + (uint)*param_6 >> 1 & 0xff;
    uVar5 = (uint)*param_2 * 0x4a85 >> 8;
    uVar38 = (uVar5 + (uVar39 * 0x6625 >> 8)) - 0x379a;
    uVar8 = iVar41 + (uint)*param_5 >> 1 & 0xff;
    *param_8 = 0xff;
    if (uVar38 >> 0xe == 0) {
      cVar42 = (char)(uVar38 >> 6);
    }
    ...
    uVar38 = ((uVar5 + 0x2204) - (uVar8 * 0x1913 >> 8)) - (uVar39 * 0x3408 >> 8);
    param_8[1] = cVar42;
    if (uVar38 >> 0xe == 0) {
      cVar42 = (char)(uVar38 >> 6);
    }
    ...
    uVar38 = (uVar5 + (uVar8 * 0x811a >> 8)) - 0x4515;
    param_8[2] = cVar42;
    if (uVar38 >> 0xe == 0) {
      cVar42 = (char)(uVar38 >> 6);
    }
  ...
  if (0 < (int)uVar7) {
    ...
    do {
      ...
      in_d4 = NEON_sqshrun(in_d4,auVar83,6,2);
      auVar60 = NEON_sqadd(auVar60,auVar65,2);
      in_d5 = NEON_sqshrun(in_d5,auVar71,6,2);
      puVar4 = param_7 + (iVar41 + -0x20);
      in_d6 = NEON_sqshrun(in_d6,auVar60,6,2);
      *puVar4 = 0xff;
      puVar4[1] = (char)in_d4;
      puVar4[2] = (char)in_d5;
      puVar4[3] = (char)in_d6;
      puVar4[4] = 0xff;
      puVar4[5] = (char)((ulong)in_d4 >> 8);
      puVar4[6] = (char)((ulong)in_d5 >> 8);
      puVar4[7] = (char)((ulong)in_d6 >> 8);
      puVar4[8] = 0xff;
      puVar4[9] = (char)((ulong)in_d4 >> 0x10);
      puVar4[10] = (char)((ulong)in_d5 >> 0x10);
      puVar4[0xb] = (char)((ulong)in_d6 >> 0x10);
      puVar4[0xc] = 0xff;
      puVar4[0xd] = (char)((ulong)in_d4 >> 0x18);
      puVar4[0xe] = (char)((ulong)in_d5 >> 0x18);
      puVar4[0xf] = (char)((ulong)in_d6 >> 0x18);
      puVar4[0x10] = 0xff;
      puVar4[0x11] = (char)((ulong)in_d4 >> 0x20);
      puVar4[0x12] = (char)((ulong)in_d5 >> 0x20);
      puVar4[0x13] = (char)((ulong)in_d6 >> 0x20);
      puVar4[0x14] = 0xff;
      puVar4[0x15] = (char)((ulong)in_d4 >> 0x28);
      puVar4[0x16] = (char)((ulong)in_d5 >> 0x28);
      puVar4[0x17] = (char)((ulong)in_d6 >> 0x28);
      puVar4[0x18] = 0xff;
      puVar4[0x19] = (char)((ulong)in_d4 >> 0x30);
      puVar4[0x1a] = (char)((ulong)in_d5 >> 0x30);
      puVar4[0x1b] = (char)((ulong)in_d6 >> 0x30);
      puVar4[0x1c] = 0xff;
      puVar4[0x1d] = (char)((ulong)in_d4 >> 0x38);
      puVar4[0x1e] = (char)((ulong)in_d5 >> 0x38);
      puVar4[0x1f] = (char)((ulong)in_d6 >> 0x38);
      ...
      auVar60 = NEON_sqadd(auVar94,auVar60,2);
      auVar71 = NEON_sqsub(auVar106,auVar71,2);
      uVar58 = NEON_sqshrun(auVar92._0_8_,auVar83,6,2);
      auVar60 = NEON_sqadd(auVar60,auVar66,2);
      uVar64 = NEON_sqshrun(auVar94._0_8_,auVar71,6,2);
      uVar69 = NEON_sqshrun(auVar97._0_8_,auVar60,6,2);
      puVar4 = param_7 + iVar41;
      *puVar4 = 0xff;
      puVar4[1] = (char)uVar58;
      puVar4[2] = (char)uVar64;
      puVar4[3] = (char)uVar69;
      puVar4[4] = 0xff;
      puVar4[5] = (char)((ulong)uVar58 >> 8);
      puVar4[6] = (char)((ulong)uVar64 >> 8);
      puVar4[7] = (char)((ulong)uVar69 >> 8);
      puVar4[8] = 0xff;
      puVar4[9] = (char)((ulong)uVar58 >> 0x10);
      puVar4[10] = (char)((ulong)uVar64 >> 0x10);
      puVar4[0xb] = (char)((ulong)uVar69 >> 0x10);
      puVar4[0xc] = 0xff;
      puVar4[0xd] = (char)((ulong)uVar58 >> 0x18);
      puVar4[0xe] = (char)((ulong)uVar64 >> 0x18);
      puVar4[0xf] = (char)((ulong)uVar69 >> 0x18);
      puVar4[0x10] = 0xff;
      puVar4[0x11] = (char)((ulong)uVar58 >> 0x20);
      puVar4[0x12] = (char)((ulong)uVar64 >> 0x20);
      puVar4[0x13] = (char)((ulong)uVar69 >> 0x20);
      puVar4[0x14] = 0xff;
      puVar4[0x15] = (char)((ulong)uVar58 >> 0x28);
      puVar4[0x16] = (char)((ulong)uVar64 >> 0x28);
      puVar4[0x17] = (char)((ulong)uVar69 >> 0x28);
      puVar4[0x18] = 0xff;
      puVar4[0x19] = (char)((ulong)uVar58 >> 0x30);
      puVar4[0x1a] = (char)((ulong)uVar64 >> 0x30);
      puVar4[0x1b] = (char)((ulong)uVar69 >> 0x30);
      puVar4[0x1c] = 0xff;
      puVar4[0x1d] = (char)((ulong)uVar58 >> 0x38);
      puVar4[0x1e] = (char)((ulong)uVar64 >> 0x38);
      puVar4[0x1f] = (char)((ulong)uVar69 >> 0x38);
      if (param_2 != (byte *)0x0) {
        uVar58 = *(undefined8 *)(param_2 + (lVar36 >> 0x20));
        puVar4 = param_8 + (iVar41 + -0x20);
        ...
        uVar58 = NEON_sqshrun(auVar92._0_8_,auVar92,6,2);
        uVar64 = NEON_sqshrun(auVar94._0_8_,auVar71,6,2);
        uVar69 = NEON_sqshrun(auVar97._0_8_,auVar60,6,2);
        *puVar4 = 0xff;
        puVar4[1] = (char)uVar58;
  ...
  if (0 < (int)uVar5) {
    ...
    do {
      ...
      *puVar4 = 0xff;
      ...
      uVar8 = ((uVar6 + 0x2204) - ((uint)bVar45 * 0x1913 >> 8)) - ((uint)bVar44 * 0x3408 >> 8);
      puVar4[1] = cVar42;
      if (uVar8 >> 0xe == 0) {
        cVar42 = (char)(uVar8 >> 6);
      }
      ...
      uVar8 = (uVar6 + ((uint)bVar45 * 0x811a >> 8)) - 0x4515;
      puVar4[2] = cVar42;
      if (uVar8 >> 0xe == 0) {
        cVar42 = (char)(uVar8 >> 6);
      }
    ...
    if ((param_2 != (byte *)0x0) && (0 < (int)uVar5)) {
      ...
      do {
        ...
        *puVar4 = 0xff;
        ...
        uVar5 = ((uVar7 + 0x2204) - ((uint)bVar45 * 0x1913 >> 8)) - ((uint)bVar44 * 0x3408 >> 8);
        puVar4[1] = cVar42;
        if (uVar5 >> 0xe == 0) {
          cVar42 = (char)(uVar5 >> 6);
        }
        ...
        uVar5 = (uVar7 + ((uint)bVar45 * 0x811a >> 8)) - 0x4515;
        puVar4[2] = cVar42;
        if (uVar5 >> 0xe == 0) {
          cVar42 = (char)(uVar5 >> 6);
        }
