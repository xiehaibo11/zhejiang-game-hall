...
undefined8 FUN_01134a6c(long param_1,void *param_2,long param_3)
...
LAB_01134ba0:
            uVar13 = uVar12;
            if ((*(byte *)(lVar10 + 0x20) & 1) == 0) goto LAB_01134ba8;
LAB_01134c04:
            uVar6 = 0xd;
            uVar9 = *(int *)(lVar10 + 0x78) == 0 | 2;
            uVar8 = 0xd - uVar11;
            if (uVar11 < 0xe && uVar8 != 0) goto LAB_01134c20;
          }
          else {
            iVar1 = -4;
            if ((int)uVar11 < 4) {
            ...
            *(long *)(param_1 + 0x390) = *(long *)(param_1 + 0x390) + 1;
            if ((*(byte *)(lVar10 + 0x20) & 1) != 0) goto LAB_01134c04;
LAB_01134ba8:
            uVar6 = 0xc;
            uVar9 = 1;
            uVar8 = 0xc - uVar11;
...
LAB_01134c20:
          ...
          uVar11 = uVar11 - uVar6;
          uVar13 = (*(uint *)(&DAT_0147ec9c + (ulong)uVar6 * 4) & uVar9) << (ulong)(uVar11 & 0x1f) |
                   uVar13;
          if (uVar11 == 0) {
            if (*(long *)(param_1 + 0x370) <= *(long *)(param_1 + 0x390)) {
              TIFFFlushData1(param_1);
        ...
        if ((*(byte *)(lVar7 + 0x20) & 1) == 0) {
          FUN_01136270(param_1,param_2,*(undefined4 *)(lVar7 + 0x10));
        }
        else {
          if (*(int *)(lVar7 + 0x78) == 0) {
            FUN_01136270(param_1,param_2,*(undefined4 *)(lVar7 + 0x10));
            ...
            *(undefined4 *)(lVar7 + 0x78) = 1;
            ...
            FUN_011363cc(param_1,param_2,*(undefined8 *)(lVar7 + 0x80),*(undefined4 *)(lVar7 + 0x10)
                        );
