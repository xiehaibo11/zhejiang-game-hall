...
undefined8 FUN_008be7f8(undefined8 param_1)

{
  ...
  if (((iVar2 == 0) || (iVar2 = tolua_isnumber(param_1,2,0,auStack_48), iVar2 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glAttachShader\'.",auStack_48);
  }
  else {
    dVar3 = (double)tolua_tonumber(0,param_1,1);
    dVar4 = (double)tolua_tonumber(0,param_1,2);
                    /* catch() { ... } // from try @ 008becf4 with catch @ 008be884 */
    glAttachShader((int)dVar3,(int)dVar4);
  }
