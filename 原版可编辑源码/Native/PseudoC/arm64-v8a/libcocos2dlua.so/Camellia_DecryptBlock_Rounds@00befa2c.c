...

{
  ...
  while( true ) {
    ...
    uVar2 = *(uint *)(&DAT_014057a0 + (ulong)(uVar2 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_01404fa0 + (ulong)(uVar2 & 0xff) * 4) ^
            *(uint *)(&DAT_014053a0 + (ulong)(uVar2 >> 0x10 & 0xff) * 4) ^
            *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar2 >> 0x18) * 4);
    uVar3 = *(uint *)(&DAT_01404fa0 + (ulong)(uVar3 >> 8 & 0xff) * 4) ^
            *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar3 & 0xff) * 4) ^ uVar2 ^
            *(uint *)(&DAT_014057a0 + (ulong)(uVar3 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&DAT_014053a0 + (ulong)(uVar3 >> 0x18) * 4);
    uVar9 = uVar3 ^ uVar9;
    ...
    uVar8 = *(uint *)(&DAT_014057a0 + (ulong)(uVar8 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_01404fa0 + (ulong)(uVar8 & 0xff) * 4) ^
            *(uint *)(&DAT_014053a0 + (ulong)(uVar8 >> 0x10 & 0xff) * 4) ^
            *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar8 >> 0x18) * 4);
    uVar4 = *(uint *)(&DAT_01404fa0 + (ulong)(uVar10 >> 8 & 0xff) * 4) ^
            *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar10 & 0xff) * 4) ^ uVar8 ^
    ...
    uVar8 = *(uint *)(&DAT_014057a0 + (ulong)(uVar8 >> 8 & 0xff) * 4) ^
            ...
            *(uint *)(&DAT_014053a0 + (ulong)(uVar8 >> 0x10 & 0xff) * 4) ^
            *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar8 >> 0x18) * 4);
    uVar3 = *(uint *)(&DAT_01404fa0 + (ulong)(uVar10 >> 8 & 0xff) * 4) ^
            *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar10 & 0xff) * 4) ^ uVar8 ^
            *(uint *)(&DAT_014057a0 + (ulong)(uVar10 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&DAT_014053a0 + (ulong)(uVar10 >> 0x18) * 4);
    uVar7 = uVar3 ^ uVar7;
    ...
    uVar2 = *(uint *)(&DAT_014057a0 + (ulong)(uVar10 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_01404fa0 + (ulong)(uVar10 & 0xff) * 4) ^
            *(uint *)(&DAT_014053a0 + (ulong)(uVar10 >> 0x10 & 0xff) * 4) ^
            *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar10 >> 0x18) * 4);
    uVar10 = *(uint *)(&DAT_01404fa0 + (ulong)(uVar8 >> 8 & 0xff) * 4) ^
             *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar8 & 0xff) * 4) ^ uVar2 ^
    ...
    uVar4 = *(uint *)(&DAT_014057a0 + (ulong)(uVar8 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_01404fa0 + (ulong)(uVar8 & 0xff) * 4) ^
            *(uint *)(&DAT_014053a0 + (ulong)(uVar8 >> 0x10 & 0xff) * 4) ^
            *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar8 >> 0x18) * 4);
    uVar8 = *(uint *)(&DAT_01404fa0 + (ulong)(uVar2 >> 8 & 0xff) * 4) ^
            *(uint *)((long)&DAT_01404ba0 + (ulong)(uVar2 & 0xff) * 4) ^ uVar4 ^
            *(uint *)(&DAT_014057a0 + (ulong)(uVar2 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&DAT_014053a0 + (ulong)(uVar2 >> 0x18) * 4);
    uVar7 = uVar8 ^ uVar7;
