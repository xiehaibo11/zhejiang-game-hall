...
/* std::__ndk1::__deque_base<cocostudio::FrameEvent*,
   std::__ndk1::allocator<cocostudio::FrameEvent*> >::clear() */

void __thiscall
std::__ndk1::__deque_base<cocostudio::FrameEvent*,std::__ndk1::allocator<cocostudio::FrameEvent*>>::
clear(__deque_base<cocostudio::FrameEvent*,std::__ndk1::allocator<cocostudio::FrameEvent*>> *this)
  ...
  if (lVar4 != 0) {
    ...
    while (lVar1 != lVar7) {
      while (lVar7 = lVar7 + 8, lVar7 - *plVar5 == 0x1000) {
        plVar5 = plVar5 + 1;
        lVar7 = *plVar5;
        if (lVar1 == lVar7) goto LAB_00c3c264;
      }
    }
  }
LAB_00c3c264:
