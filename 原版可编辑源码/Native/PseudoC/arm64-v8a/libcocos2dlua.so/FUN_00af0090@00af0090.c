...
int FUN_00af0090(long param_1,undefined8 param_2,int param_3)

{
  ...
  undefined1 local_34 [4];
                    ...
                    /* catch() { ... } // from try @ 00af003c with catch @ 00af0090 */
                    /* catch() { ... } // from try @ 00aefed4 with catch @ 00af00a8 */
  pkey = (EVP_PKEY *)X509_get0_pubkey(param_2);
  if (pkey == (EVP_PKEY *)0x0) {
    return 0;
  }
                    /* catch() { ... } // from try @ 00aeff60 with catch @ 00af00bc */
  ...
  if (group != (EC_GROUP *)0x0) {
    ...
    if ((int)uVar7 != 0) {
      ...
      if (pEVar4 != (EC_POINT *)0x0) {
        ...
        iVar2 = FUN_00aeaa54(param_1,pcVar1,local_34);
        if (iVar2 == 0) {
          return 0;
        }
        if (param_3 == 0) {
