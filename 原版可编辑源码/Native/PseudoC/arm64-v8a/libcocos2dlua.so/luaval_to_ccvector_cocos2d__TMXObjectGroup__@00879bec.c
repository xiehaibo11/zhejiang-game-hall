...
/* bool luaval_to_ccvector<cocos2d::TMXObjectGroup*>(lua_State*, int,
   cocos2d::Vector<cocos2d::TMXObjectGroup*>*, char const*) */

bool luaval_to_ccvector<cocos2d::TMXObjectGroup*>
        ...
        if (((iVar4 != 0) && (iVar4 = lua_isuserdata(param_1,0xffffffff), iVar4 != 0)) &&
          ...
          if (plVar1 == *(long **)(param_3 + 0x10)) {
            ...
            __push_back_slow_path<cocos2d::TMXObjectGroup*const&>
                      ((vector<cocos2d::TMXObjectGroup*,std::__ndk1::allocator<cocos2d::TMXObjectGroup*>>
                        *)param_3,(TMXObjectGroup **)&local_60);
          }
          else {
            *plVar1 = (long)pRVar6;
