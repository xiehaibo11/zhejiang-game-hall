...
/* cocos2d::FlipY3D::create(float) */

Action * cocos2d::FlipY3D::create(float param_1)

{
  ...
  lVar1 = tpidr_el0;
                    /* try { // try from 00ed6650 to 00fd684b has its CatchHandler @ 00ed6650
                       catch() { ... } // from try @ 00ed6650 with catch @ 00ed6650
                       catch() { ... } // from try @ 00ed6870 with catch @ 00ed6650 */
