...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   cocos2d::EventDispatcher::DirtyFlag>, void*>*>
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::EventDispatcher::DirtyFlag> > >::find<std::__ndk1::basic_string<char,
...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00fa4048 to 010a405f has its CatchHandler @ 00fa4078 */
                    /* try { // try from 00fa4060 to 010a409b has its CatchHandler @ 00fa3dc4 */
  lVar5 = tpidr_el0;
  local_68 = *(long *)(lVar5 + 0x28);
                    /* catch() { ... } // from try @ 00fa4048 with catch @ 00fa4078 */
  uVar7 = *(ulong *)(param_1 + 8);
  pbVar2 = *(basic_string **)(param_1 + 0x10);
                    /* catch() { ... } // from try @ 00fa3f7c with catch @ 00fa407c
                       catch() { ... } // from try @ 00fa400c with catch @ 00fa407c */
                    /* catch() { ... } // from try @ 00fa3f28 with catch @ 00fa4080 */
  if (((byte)*param_1 & 1) == 0) {
    pbVar2 = param_1 + 1;
  ...
  uVar12 = *(ulong *)(this + 8);
  if (uVar12 != 0) {
                    /* try { // try from 00fa409c to 010a41d7 has its CatchHandler @ 00fa409c
                       catch() { ... } // from try @ 00fa409c with catch @ 00fa409c
                       catch() { ... } // from try @ 00fa41e0 with catch @ 00fa409c */
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00fa411c;
              goto LAB_00fa41cc;
            }
            if (uVar9 != uVar14) goto LAB_00fa41cc;
          }
LAB_00fa411c:
          plVar8 = (long *)*plVar8;
...
LAB_00fa41cc:
  plVar8 = (long *)0x0;
LAB_00fa41d0:
                    /* try { // try from 00fa41d8 to 010a41df has its CatchHandler @ 00fa42a8 */
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* try { // try from 00fa41e0 to 010a42bb has its CatchHandler @ 00fa409c */
    return plVar8;
  }
