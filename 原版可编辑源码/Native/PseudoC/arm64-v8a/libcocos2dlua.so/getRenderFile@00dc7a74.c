...
void cocos2d::ui::ImageView::getRenderFile(void)

{
  ...
  *in_x8 = *(undefined4 *)(in_x0 + 0x518);
  if (this != (basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
              (in_x0 + 0x528)) {
    pcVar1 = *(char **)(in_x0 + 0x538);
    uVar2 = *(ulong *)(in_x0 + 0x530);
    if ((*(byte *)(in_x0 + 0x528) & 1) == 0) {
      pcVar1 = (char *)(in_x0 + 0x529);
      uVar2 = (ulong)(*(byte *)(in_x0 + 0x528) >> 1);
    }
