...
undefined8 FUN_008c6e14(undefined8 param_1)

{
  ...
  if ((((iVar2 == 0) || (iVar2 = tolua_isnumber(param_1,2,0,auStack_58), iVar2 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glVertexAttrib4f\'.",auStack_58);
  }
  else {
    ...
    glVertexAttrib4f((float)dVar4,(float)dVar5,(float)dVar6,(float)dVar7,(int)dVar3);
  }
