...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<int,
   cocos2d::experimental::ui::VideoPlayer*>, void*>*>, bool>
   ...
   cocos2d::experimental::ui::VideoPlayer*> > >::__emplace_unique_key_args<int,
        ...
        if (uVar6 != uVar9) {
          if (uVar4 < 2) {
            uVar6 = uVar6 & uVar8 - 1;
                    ...
                    /* try { // try from 00de0da8 to 00ee0db7 has its CatchHandler @ 00de11d8 */
            uVar2 = 0;
            if (uVar8 != 0) {
              uVar2 = uVar6 / uVar8;
            }
            if (uVar6 - uVar2 * uVar8 == unaff_x24) goto LAB_00de0d78;
            break;
          }
...
LAB_00de0d78:
        if (*(int *)(plVar7 + 2) == *(int *)param_2) {
          return plVar7;
                    ...
                    /* try { // try from 00de0d88 to 00ee0da3 has its CatchHandler @ 00de11dc */
      }
    }
  }
  ...
  *(undefined4 *)(plVar7 + 2) = uVar1;
  if ((uVar8 == 0) || ((float)param_1[8] * (float)uVar8 < (float)(*(long *)(param_1 + 6) + 1))) {
    ...
    rehash((__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::experimental::ui::VideoPlayer*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::experimental::ui::VideoPlayer*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::experimental::ui::VideoPlayer*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::experimental::ui::VideoPlayer*>>>
            *)param_1,uVar4);
    uVar8 = *(ulong *)(param_1 + 2);
    if ((uVar8 & uVar8 - 1) == 0) {
      unaff_x24 = uVar8 - 1 & uVar9;
  ...
  if (plVar3 == (long *)0x0) {
    plVar3 = (long *)(param_1 + 4);
                    /* try { // try from 00de0e84 to 00ee0e8f has its CatchHandler @ 00de11bc */
    *plVar7 = *plVar3;
    *plVar3 = (long)plVar7;
    *(long **)(lVar5 + unaff_x24 * 8) = plVar3;
    if (*plVar7 == 0) goto LAB_00de0ed0;
