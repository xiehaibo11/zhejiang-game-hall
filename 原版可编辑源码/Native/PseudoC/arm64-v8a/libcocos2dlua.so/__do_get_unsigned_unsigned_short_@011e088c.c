...

{
  ...
  plVar10 = param_2;
  local_1b8 = pcVar11;
  if (param_2 != (long *)0x0) goto LAB_011e0970;
LAB_011e0984:
  bVar3 = true;
  if (param_3 != (long *)0x0) goto LAB_011e09b0;
  do {
    param_3 = (long *)0x0;
    if (bVar3) {
LAB_011e0adc:
      ...
      uVar4 = FUN_012087fc(pcVar11,local_1b8,param_5,iVar7);
      *param_6 = uVar4;
      __check_grouping(local_198,local_178,local_1c0,param_5);
      if (param_2 == (long *)0x0) {
        bVar3 = true;
        if (param_3 == (long *)0x0) goto LAB_011e0b68;
LAB_011e0b90:
        ...
        if (bVar3 != (iVar7 == -1)) goto LAB_011e0bd0;
      }
      else {
        ...
        param_2 = plVar10;
        if (param_3 != (long *)0x0) goto LAB_011e0b90;
LAB_011e0b68:
        if (!bVar3) goto LAB_011e0bd0;
      }
      *param_5 = *param_5 | 2;
LAB_011e0bd0:
      if ((local_1b0 & 1) != 0) {
    ...
    while( true ) {
      ...
      iVar6 = __num_get<wchar_t>::__stage2_int_loop
                        (wVar5,iVar7,pcVar11,&local_1b8,&local_1c4,local_17c,local_198,local_178,
                         &local_1c0,(wchar_t *)aiStack_d8);
      if (iVar6 != 0) goto LAB_011e0adc;
      ...
      plVar10 = param_2;
      if (param_2 == (long *)0x0) goto LAB_011e0984;
LAB_011e0970:
