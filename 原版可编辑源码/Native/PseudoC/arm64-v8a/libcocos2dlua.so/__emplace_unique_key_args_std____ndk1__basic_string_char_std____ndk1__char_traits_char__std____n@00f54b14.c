...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::allocator<char> >&, cocos2d::Value>(std::__ndk1::basic_string<char,
...
__emplace_unique_key_args<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>&,cocos2d::Value>
          (__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::Value>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::Value>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::Value>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::Value>>>
           *this,basic_string *param_1,basic_string *param_2,Value *param_3)
      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if (uVar13 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x28) goto LAB_00f54c3c;
            break;
          }
...
LAB_00f54c3c:
        ...
        if (sVar1 == __n) {
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
                    /* catch() { ... } // from try @ 00f54670 with catch @ 00f54c70 */
              uVar10 = 0;
                    /* catch() { ... } // from try @ 00f54630 with catch @ 00f54c74 */
              while (*(basic_string *)((long)plVar15 + uVar10 + 0x11) == pbVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00f54cac;
              }
              goto LAB_00f54bf4;
            }
          }
...
LAB_00f54bf4:
  ...
  basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::basic_string
            ((basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
             (plVar15 + 2),param_2);
                    /* catch() { ... } // from try @ 00f54d5c with catch @ 00f54ce4 */
  __s1 = (void *)cocos2d::Value::Value((Value *)(plVar15 + 5),param_3);
  *plVar15 = 0;
  plVar15[1] = uVar7;
                    /* try { // try from 00f54d0c to 01054d13 has its CatchHandler @ 00f54dbc */
  if ((uVar16 == 0) ||
     (*(float *)(this + 0x20) * (float)uVar16 < (float)(*(long *)(this + 0x18) + 1))) {
    uVar16 = (ulong)(uVar16 < 3 || (uVar16 & uVar16 - 1) != 0) | uVar16 << 1;
    uVar13 = (ulong)((float)(*(long *)(this + 0x18) + 1) / *(float *)(this + 0x20));
                    /* try { // try from 00f54d38 to 01054d5b has its CatchHandler @ 00f54dc4 */
    if (uVar13 <= uVar16) {
      uVar13 = uVar16;
    }
    __s1 = (void *)rehash(this,uVar13);
    uVar16 = *(ulong *)(this + 8);
    if ((uVar16 & uVar16 - 1) == 0) {
      ...
      if (uVar16 <= uVar7) {
        ...
        unaff_x28 = uVar7 - uVar13 * uVar16;
      }
    }
  }
  lVar14 = *(long *)this;
  plVar11 = *(long **)(lVar14 + unaff_x28 * 8);
  if (plVar11 == (long *)0x0) {
    p_Var12 = this + 0x10;
    *plVar15 = *(long *)p_Var12;
    *(long **)p_Var12 = plVar15;
    *(__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::Value>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::Value>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::Value>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::Value>>>
      **)(lVar14 + unaff_x28 * 8) = p_Var12;
    if (*plVar15 == 0) goto LAB_00f54ddc;
    uVar7 = *(ulong *)(*plVar15 + 8);
    if ((uVar16 & uVar16 - 1) == 0) {
      uVar7 = uVar7 & uVar16 - 1;
    }
    else {
                    /* catch() { ... } // from try @ 00f54d0c with catch @ 00f54dbc */
      if (uVar16 <= uVar7) {
        uVar13 = 0;
        if (uVar16 != 0) {
          uVar13 = uVar7 / uVar16;
        }
                    /* catch() { ... } // from try @ 00f54d38 with catch @ 00f54dc4 */
...
LAB_00f54ddc:
  uVar8 = 1;
                    /* try { // try from 00f54de8 to 01054e2b has its CatchHandler @ 00f54de8
                       catch() { ... } // from try @ 00f54de8 with catch @ 00f54de8
                       catch() { ... } // from try @ 00f54e38 with catch @ 00f54de8
                       catch() { ... } // from try @ 00f54ea4 with catch @ 00f54de8
                       catch() { ... } // from try @ 00f54f5c with catch @ 00f54de8 */
