...
/* void std::__ndk1::vector<spine::TwoColorTrianglesCommand*,
   std::__ndk1::allocator<spine::TwoColorTrianglesCommand*>
   >::__push_back_slow_path<spine::TwoColorTrianglesCommand*>(spine::TwoColorTrianglesCommand*&&) */
...
__push_back_slow_path<spine::TwoColorTrianglesCommand*>
          (vector<spine::TwoColorTrianglesCommand*,std::__ndk1::allocator<spine::TwoColorTrianglesCommand*>>
           *this,TwoColorTrianglesCommand **param_1)
