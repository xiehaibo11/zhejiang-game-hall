...
/* void cocos2d::JniHelper::callStaticVoidMethod<char const*, int>(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&, char const*, int) */

void cocos2d::JniHelper::callStaticVoidMethod<char_const*,int>
...

{
  ...
  *puVar7 = 0;
  ...
  if ((uVar8 & 1) == 0) {
    ...
    _JNIEnv::CallStaticVoidMethod(p_Var5,p_Var6,local_78,uVar9,(ulong)(uint)param_4);
