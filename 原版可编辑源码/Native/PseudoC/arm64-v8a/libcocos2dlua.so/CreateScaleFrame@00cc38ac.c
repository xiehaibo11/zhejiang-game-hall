...
/* flatbuffers::CreateScaleFrame(flatbuffers::FlatBufferBuilder&, int, unsigned char,
   flatbuffers::Scale const*, flatbuffers::Offset<flatbuffers::EasingData>) */

undefined4
flatbuffers::CreateScaleFrame
