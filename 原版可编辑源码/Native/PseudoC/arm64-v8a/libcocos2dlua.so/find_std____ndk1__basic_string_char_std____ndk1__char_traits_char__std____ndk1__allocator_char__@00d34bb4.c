...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00d34bc8 to 00e34bcb has its CatchHandler @ 00d34d90 */
  lVar5 = tpidr_el0;
  ...
  if (uVar12 != 0) {
    ...
    uVar13 = CONCAT62((int6)((ulong)uVar16 >> 0x10),uVar15) & 0xffffffff;
                    /* try { // try from 00d34c28 to 00e34c33 has its CatchHandler @ 00d34d44 */
    if (uVar13 < 2) {
    ...
    if (plVar8 != (long *)0x0) {
      plVar8 = (long *)*plVar8;
      if (plVar8 != (long *)0x0) {
                    /* try { // try from 00d34c74 to 00e34c77 has its CatchHandler @ 00d34dbc */
            ...
            if (sVar1 == __n) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                while (*pbVar10 == *pbVar11) {
                    /* try { // try from 00d34cf0 to 00e34cff has its CatchHandler @ 00d34d08 */
                  uVar9 = uVar9 - 1;
                  pbVar10 = pbVar10 + 1;
                  pbVar11 = pbVar11 + 1;
                  if (uVar9 == 0) goto LAB_00d34d44;
                }
              }
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d34bb0 with catch @ 00d34d04
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d34b58 with catch @ 00d34d08
                       catch(type#1 @ 00000000) { ... } // from try @ 00d34cf0 with catch @ 00d34d08
                        */
            if (uVar13 < 2) {
              ...
              if (uVar12 != 0) {
                uVar4 = uVar9 / uVar12;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d34b88 with catch @ 00d34d18
                        */
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00d34c90;
              goto LAB_00d34d40;
            }
            if (uVar9 != uVar14) goto LAB_00d34d40;
          }
LAB_00d34c90:
          plVar8 = (long *)*plVar8;
...
LAB_00d34d40:
  plVar8 = (long *)0x0;
LAB_00d34d44:
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d34c28 with catch @ 00d34d44
                        */
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* try { // try from 00d34d58 to 00e34d5b has its CatchHandler @ 00d34d8c */
                    /* try { // try from 00d34d5c to 00e34dcf has its CatchHandler @ 00d34a8c */
    return plVar8;
  }
