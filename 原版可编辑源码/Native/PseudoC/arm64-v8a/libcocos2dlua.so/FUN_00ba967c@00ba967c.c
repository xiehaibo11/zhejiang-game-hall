...
char * FUN_00ba967c(undefined8 param_1,char *param_2,char *param_3)
    ...
    if (param_2 == (char *)0x0) {
      ...
      if (pcVar1 != (char *)0x0) {
        return pcVar1;
                    ...
                    /* try { // try from 00ba9744 to 00ca97eb has its CatchHandler @ 00ba9744
                       catch() { ... } // from try @ 00ba9744 with catch @ 00ba9744
                       catch() { ... } // from try @ 00ba98dc with catch @ 00ba9744
                       catch() { ... } // from try @ 00ba994c with catch @ 00ba9744 */
    ...
    if (*param_2 != '/') {
      ...
      if (pcVar1 != (char *)0x0) {
        ...
        return pcVar1;
                    ...
                    /* try { // try from 00ba97ec to 00ca97f7 has its CatchHandler @ 00ba99e4 */
