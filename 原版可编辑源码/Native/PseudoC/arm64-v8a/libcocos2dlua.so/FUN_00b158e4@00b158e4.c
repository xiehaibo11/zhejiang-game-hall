...
undefined4 FUN_00b158e4(long param_1)
  ...
  if (ctx == (BN_CTX *)0x0) {
    ...
    if ((a != (BIGNUM *)0x0) || (a = BN_new(), a != (BIGNUM *)0x0)) {
      if ((*(byte *)(param_1 + 0x30) & 1) == 0) {
        ...
        if (pBVar6 == (BN_MONT_CTX *)0x0) goto LAB_00b15a44;
      }
      if (bVar1) {
        ...
        if (pBVar3 == (BIGNUM *)0x0) {
          ...
          if (iVar2 != 0) goto LAB_00b159e4;
        }
        else {
          while (iVar2 = BN_rand_range(rnd,pBVar3), iVar2 != 0) {
            iVar2 = BN_is_zero(rnd);
            if ((iVar2 == 0) && (iVar2 = BN_is_one(rnd), iVar2 == 0)) goto LAB_00b159e4;
            pBVar3 = *(BIGNUM **)(param_1 + 0x40);
          }
        }
      }
