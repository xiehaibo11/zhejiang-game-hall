...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned long long,
   ...
   std::__ndk1::function<void (universe::network::ZhouLuJun*)> > > >::rehash(unsigned long) */
...

{
  ...
  undefined8 uVar4;
                    ...
                    /* catch() { ... } // from try @ 00a0b74c with catch @ 00a0b824
                       catch() { ... } // from try @ 00a0b7d0 with catch @ 00a0b824 */
  if (param_1 - 1 == 0) {
    param_1 = 2;
  }
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00a0b8d8;
    }
    return;
  }
LAB_00a0b8d8:
