...
/* void std::__ndk1::vector<cocos2d::Value, std::__ndk1::allocator<cocos2d::Value>
   >::__push_back_slow_path<cocos2d::Value const&>(cocos2d::Value const&) */
...
LAB_00ffd268:
  ...
  cocos2d::Value::Value(this_00,param_1);
  this_01 = *(Value **)this;
  pVVar6 = *(Value **)(this + 8);
  pVVar1 = this_00 + 0x10;
  pVVar7 = this_01;
  if (pVVar6 != this_01) {
    do {
      pVVar6 = pVVar6 + -0x10;
      cocos2d::Value::Value(this_00 + -0x10,pVVar6);
