...
/* bool 
   universe::network::GuoPengFei::sendMessage<universe::network::SRS::CheckAct32>(universe::network::SRS::CheckAct32&,
   int, int) */

bool __thiscall
universe::network::GuoPengFei::sendMessage<universe::network::SRS::CheckAct32>
          (GuoPengFei *this,CheckAct32 *param_1,int param_2,int param_3)

{
  ...
  long local_48;
                    ...
                    /* catch() { ... } // from try @ 00a0ada8 with catch @ 00a0aea8 */
  lVar1 = tpidr_el0;
