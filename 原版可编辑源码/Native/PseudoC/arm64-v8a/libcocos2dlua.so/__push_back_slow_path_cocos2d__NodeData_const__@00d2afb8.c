...
/* void std::__ndk1::vector<cocos2d::NodeData*, std::__ndk1::allocator<cocos2d::NodeData*>
   >::__push_back_slow_path<cocos2d::NodeData* const&>(cocos2d::NodeData* const&) */

void __thiscall
std::__ndk1::vector<cocos2d::NodeData*,std::__ndk1::allocator<cocos2d::NodeData*>>::
__push_back_slow_path<cocos2d::NodeData*const&>
          (vector<cocos2d::NodeData*,std::__ndk1::allocator<cocos2d::NodeData*>> *this,
          NodeData **param_1)
