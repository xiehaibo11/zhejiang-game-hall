...
/* fairygui::UBBParser::onTag_FONT(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
...

{
  ...
  if (param_2) {
    ...
    std::__ndk1::operator+((__ndk1 *)"<font face=\"",(char *)param_3,(basic_string *)(ulong)param_2)
    ;
    pbVar4 = (basic_string *)
             std::__ndk1::
    ...
    uVar1 = *(undefined8 *)(pbVar4 + 0x10);
                    /* try { // try from 00ab907c to 00bb9087 has its CatchHandler @ 00ab90bc */
    bVar2 = *pbVar4;
    uStack_40 = (undefined7)((ulong)*(undefined8 *)(pbVar4 + 8) >> 8);
                    /* try { // try from 00ab9088 to 00bb90cf has its CatchHandler @ 00ab9000 */
    ...
    *(undefined8 *)(pbVar4 + 0x10) = 0;
    if (((byte)*param_4 & 1) == 0) {
      ...
      *(undefined8 *)(param_4 + 8) = 0;
      if (((byte)*param_4 & 1) != 0) {
                    /* catch() { ... } // from try @ 00ab907c with catch @ 00ab90bc */
