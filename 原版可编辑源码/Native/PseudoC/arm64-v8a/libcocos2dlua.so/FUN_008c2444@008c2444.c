...
void FUN_008c2444(undefined8 param_1)

{
  ...
  if ((iVar2 == 0) || (iVar2 = tolua_isnoobj(param_1,2,auStack_58), iVar2 == 0)) {
    tolua_error(param_1,"#ferror in function \'glGetShaderSource\'.",auStack_58);
    uVar4 = 0;
  }
  else {
    dVar6 = (double)tolua_tonumber(0,param_1,1);
    glGetShaderiv((int)dVar6,0x8b88,&local_5c);
    uVar5 = (ulong)local_5c;
    if ((long)uVar5 < 0) {
      uVar5 = 0xffffffffffffffff;
    }
    pvVar3 = operator_new__(uVar5,(nothrow_t *)&std::nothrow);
    glGetShaderSource((int)dVar6,local_5c,0,pvVar3);
