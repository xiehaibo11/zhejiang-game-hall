...
/* std::__ndk1::__split_buffer<cocos2d::Mat4*,
   std::__ndk1::allocator<cocos2d::Mat4*>&>::push_front(cocos2d::Mat4* const&) */

void __thiscall
std::__ndk1::__split_buffer<cocos2d::Mat4*,std::__ndk1::allocator<cocos2d::Mat4*>&>::push_front
    ...
    if (uVar2 < uVar5) {
      ...
      *(long *)(this + 0x10) = *(long *)(this + 0x10) + (lVar1 >> 1) * 8;
      ...
      if (lVar1 != 0) {
        ...
        do {
          lVar4 = lVar4 + -8;
                    /* try { // try from 00f9bd20 to 0109bd27 has its CatchHandler @ 00f9c16c */
          *puVar6 = *__src;
          puVar6 = puVar6 + 1;
          __src = __src + 1;
                    /* try { // try from 00f9bd28 to 0109bdb3 has its CatchHandler @ 00f9b268 */
        } while (lVar4 != 0);
