...

{
  ...
  if ((param_6 & 7) == 0) {
    if (param_2 == param_3) {
                    /* try { // try from 00b91210 to 00c91213 has its CatchHandler @ 00b9129c */
                    /* try { // try from 00b91214 to 00c912af has its CatchHandler @ 00b91190 */
      uVar227 = *param_2;
      uVar224 = param_2[1];
      uVar238 = param_2[2];
      uVar228 = param_2[3];
      ...
      uVar234 = 0;
      uVar258 = 0;
                    /* catch() { ... } // from try @ 00b91210 with catch @ 00b9129c */
      uVar247 = 0;
      uVar229 = 0;
      puVar218 = param_2 + 8;
      puVar248 = puVar221;
      while( true ) {
        ...
        *puVar248 = uVar244;
        ...
        auVar40._0_8_ = uVar240;
                    /* try { // try from 00b91470 to 00c91523 has its CatchHandler @ 00b91470
                       catch() { ... } // from try @ 00b91470 with catch @ 00b91470
                       catch() { ... } // from try @ 00b91528 with catch @ 00b91470 */
        auVar144._8_8_ = 0;
        ...
        while( true ) {
          do {
            ...
            uVar250 = uVar259 + uVar249 + (ulong)bVar216;
                    /* try { // try from 00b91524 to 00c91527 has its CatchHandler @ 00b91580 */
            uVar237 = uVar235 * uVar227;
                    /* try { // try from 00b91528 to 00c91593 has its CatchHandler @ 00b91470 */
            ...
            *puVar220 = uVar244 + uVar232;
            ...
            uVar234 = uVar251 + uVar234 + (ulong)bVar210;
                    /* catch() { ... } // from try @ 00b91524 with catch @ 00b91580 */
        ...
        puVar241 = (ulong *)((long)puVar222 - ((long)puVar219 - (long)puVar242));
                    /* try { // try from 00b91608 to 00c916db has its CatchHandler @ 00b91608
                       catch() { ... } // from try @ 00b91608 with catch @ 00b91608
                       catch() { ... } // from try @ 00b916e0 with catch @ 00b91608 */
        uVar235 = puVar218[6];
        uVar240 = puVar218[7];
        puVar218 = puVar242;
        puVar248 = puVar222;
      ...
      *puVar222 = uVar238;
      ...
      do {
        ...
        *puVar218 = uVar224;
        ...
        uVar253 = puVar218[10];
                    /* try { // try from 00b916dc to 00c916df has its CatchHandler @ 00b91794 */
        uVar227 = uVar228 * uVar228;
                    /* try { // try from 00b916e0 to 00c917a7 has its CatchHandler @ 00b91608 */
        uVar259 = puVar220[6];
        uVar258 = puVar220[7];
        auVar54._8_8_ = 0;
      ...
      uVar230 = *(ulong *)(&stack0xffffffffffffffb8 + lVar246);
                    /* catch() { ... } // from try @ 00b916dc with catch @ 00b91794 */
      param_4 = param_4 + 8;
      uVar227 = 0;
      lVar231 = 8;
      puVar218 = puVar221;
      do {
        ...
        if (puVar219 == param_4) {
                    /* try { // try from 00b91b40 to 00c91b8f has its CatchHandler @ 00b918a0 */
          uVar238 = ~uVar234;
          ...
          *(undefined8 *)(&stack0xfffffffffffffff8 + lVar246) = 0;
          ...
          if (bVar216 || bVar210) {
            ...
            uVar232 = uVar232 - uVar226;
                    ...
                    /* try { // try from 00b91b90 to 00c91ba3 has its CatchHandler @ 00b91cec */
          *param_1 = uVar232;
          param_1[1] = uVar255;
          uVar238 = uVar229;
          if (bVar216 || bVar210) {
          ...
          if (bVar216 || bVar210) {
            ...
            uVar237 = uVar237 - (uVar228 + (!CARRY8(uVar229,uVar230) && !bVar214));
                    ...
                    /* try { // try from 00b91ba4 to 00c91bf3 has its CatchHandler @ 00b918a0 */
          param_1[4] = uVar240;
          param_1[5] = uVar238;
          param_1[6] = uVar237;
          param_1[7] = uVar244;
        ...
        while( true ) {
          do {
            ...
            uVar230 = uVar226 * uVar247;
                    /* try { // try from 00b918a0 to 00c918df has its CatchHandler @ 00b918a0
                       catch() { ... } // from try @ 00b918a0 with catch @ 00b918a0
                       catch() { ... } // from try @ 00b919e8 with catch @ 00b918a0
                       catch() { ... } // from try @ 00b91adc with catch @ 00b918a0
                       catch() { ... } // from try @ 00b91b40 with catch @ 00b918a0
                       catch() { ... } // from try @ 00b91ba4 with catch @ 00b918a0
                       catch() { ... } // from try @ 00b91c08 with catch @ 00b918a0
                       catch() { ... } // from try @ 00b91c5c with catch @ 00b918a0 */
            ...
            auVar69._0_8_ = uVar239;
                    /* try { // try from 00b918e0 to 00c919ab has its CatchHandler @ 00b91d18 */
            auVar173._8_8_ = 0;
        ...
        uVar253 = puVar242[7];
        param_4 = puVar242 + 8;
                    /* try { // try from 00b919c4 to 00c919cb has its CatchHandler @ 00b91cac */
        ...
        *puVar220 = uVar232 + uVar239 + (ulong)bVar210;
        ...
        puVar222[4] = uVar252 + uVar256 + (ulong)bVar211;
                    /* try { // try from 00b919d4 to 00c919e7 has its CatchHandler @ 00b91d18 */
        uVar239 = puVar248[3];
        uVar258 = puVar248[4];
        ...
        puVar222[8] = uVar244 + uVar1 + (ulong)bVar215;
                    /* try { // try from 00b919e8 to 00c91a0b has its CatchHandler @ 00b918a0 */
        uVar244 = puVar248[7];
        uVar230 = puVar248[8];
        lVar231 = 8;
      ...
      lVar246 = lVar223 + -0x40;
                    /* try { // try from 00b91a0c to 00c91a97 has its CatchHandler @ 00b91d18 */
      puVar219 = param_1;
      do {
        puVar218 = puVar219;
      ...
      do {
        ...
        if (bVar210 || bVar213) {
          uVar227 = uVar234;
                    ...
                    /* try { // try from 00b91ac8 to 00c91adb has its CatchHandler @ 00b91cf4 */
        *puVar248 = 0;
        puVar248[1] = 0;
        uVar224 = uVar226;
        if (bVar210 || bVar213) {
        ...
        if (bVar210 || bVar213) {
          uVar228 = uVar259;
                    ...
                    /* try { // try from 00b91adc to 00c91b2b has its CatchHandler @ 00b918a0 */
        puVar248[2] = 0;
        puVar248[3] = 0;
        uVar240 = uVar235;
        if (bVar210 || bVar213) {
      ...
      puVar220[6] = uVar239;
      puVar220[7] = uVar235;
                    /* try { // try from 00b91b2c to 00c91b3f has its CatchHandler @ 00b91cf0 */
LAB_00b91bb0:
    ...
    *puVar219 = uVar238 + uVar228;
    ...
    do {
      ...
      uVar226 = *puVar219;
      lVar246 = lVar246 + -8;
                    /* try { // try from 00b91190 to 00c9120f has its CatchHandler @ 00b91190
                       catch() { ... } // from try @ 00b91190 with catch @ 00b91190
                       catch() { ... } // from try @ 00b91214 with catch @ 00b91190 */
      uVar238 = *puVar218;
      *puVar220 = uVar235;
      puVar221 = puVar220 + 1;
    } while (lVar246 != 0);
    ...
    *puVar221 = uVar238;
    ...
    return auVar260;
                    ...
                    /* try { // try from 00b91bf4 to 00c91c07 has its CatchHandler @ 00b91ccc */
  lVar246 = param_6 * -8;
  puVar221 = (ulong *)(&stack0xffffffffffffff80 + lVar246);
  lVar231 = *param_5;
                    /* try { // try from 00b91c08 to 00c91c47 has its CatchHandler @ 00b918a0 */
  puVar219 = param_2 + param_6;
  uVar253 = *param_3;
  uVar235 = *param_2;
  uVar240 = param_2[1];
  ...
  uVar227 = 0;
                    /* try { // try from 00b91c48 to 00c91c5b has its CatchHandler @ 00b91cc8 */
  uVar258 = 0;
  ...
  do {
    ...
    uVar232 = uVar240 * uVar253;
                    /* try { // try from 00b91c5c to 00c91d2b has its CatchHandler @ 00b918a0 */
    ...
    *puVar218 = uVar255;
    ...
    uVar249 = uVar233 + uVar245 + (ulong)bVar210;
                    /* catch() { ... } // from try @ 00b919c4 with catch @ 00b91cac */
    ...
    uVar247 = SUB168(auVar79 * auVar183,8);
                    /* catch() { ... } // from try @ 00b91c48 with catch @ 00b91cc8 */
    ...
    auVar80._0_8_ = uVar239;
                    /* catch() { ... } // from try @ 00b91bf4 with catch @ 00b91ccc */
    auVar184._8_8_ = 0;
  ...
  if (puVar219 == param_2 + 4) {
    ...
    *param_1 = uVar238;
    ...
    while( true ) {
      do {
        puVar218 = puVar248;
                    /* catch() { ... } // from try @ 00b918e0 with catch @ 00b91d18
                       catch() { ... } // from try @ 00b919d4 with catch @ 00b91d18
                       catch() { ... } // from try @ 00b91a0c with catch @ 00b91d18 */
