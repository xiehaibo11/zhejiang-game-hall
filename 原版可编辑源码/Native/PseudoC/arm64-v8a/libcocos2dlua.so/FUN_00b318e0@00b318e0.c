...
undefined8 FUN_00b318e0(undefined8 param_1,uchar *param_2,uchar *param_3,ulong param_4)

{
  ...
  if (param_4 >> 0x3e != 0) {
    ...
    do {
      ...
      DES_ede3_cfb64_encrypt
                (param_3,out,0x4000000000000000,pDVar4,(DES_key_schedule *)(lVar5 + 0x80),
                 (DES_key_schedule *)(lVar6 + 0x100),pauVar7,&local_64,iVar3);
  ...
  if (param_4 != 0) {
    ...
    iVar3 = EVP_CIPHER_CTX_encrypting(param_1);
    DES_ede3_cfb64_encrypt
              (param_3,param_2,param_4,pDVar4,(DES_key_schedule *)(lVar8 + 0x80),
               (DES_key_schedule *)(lVar5 + 0x100),pauVar7,&local_68,iVar3);
