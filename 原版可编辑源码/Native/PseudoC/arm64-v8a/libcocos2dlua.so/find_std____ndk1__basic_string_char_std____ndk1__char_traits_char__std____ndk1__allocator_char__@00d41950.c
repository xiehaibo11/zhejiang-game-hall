...

{
  ...
  if (uVar12 != 0) {
    ...
    uVar15 = NEON_uaddlv(uVar16,1);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d4183c with catch @ 00d419b8
                        */
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00d41a2c;
              goto LAB_00d41adc;
            }
            if (uVar9 != uVar14) goto LAB_00d41adc;
          }
LAB_00d41a2c:
          plVar8 = (long *)*plVar8;
...
LAB_00d41ae0:
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00d41b64 with catch @ 00d41b08
                       catch(type#1 @ 00000000) { ... } // from try @ 00d41d30 with catch @ 00d41b08
                        */
    return plVar8;
  }
