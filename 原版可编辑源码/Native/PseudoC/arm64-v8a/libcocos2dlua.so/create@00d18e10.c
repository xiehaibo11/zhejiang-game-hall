...
/* cocos2d::BillBoard::create(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&, cocos2d::Rect const&, cocos2d::BillBoard::Mode) */

BillBoard * cocos2d::BillBoard::create(undefined8 param_1,undefined8 param_2,undefined4 param_3)
