...

{
  ...
  uint local_64;
                    ...
                    /* catch() { ... } // from try @ 00ba6278 with catch @ 00ba6298 */
  local_68 = *(uint *)*ivec;
  local_64 = *(uint *)(*ivec + 4);
                    /* catch() { ... } // from try @ 00ba6248 with catch @ 00ba62a8 */
  if (enc == 0) {
    uVar3 = local_68;
    uVar7 = local_64;
    if (7 < length) {
      ...
      do {
        ...
        DES_encrypt1(&local_68,schedule,0);
                    /* catch() { ... } // from try @ 00ba63bc with catch @ 00ba64ac */
        lVar8 = lVar8 + -8;
        ...
        *puVar5 = (uchar)local_68;
        ...
        puVar5[4] = (uchar)local_64;
                    /* try { // try from 00ba64d8 to 00ca6503 has its CatchHandler @ 00ba64d8
                       catch() { ... } // from try @ 00ba64d8 with catch @ 00ba64d8
                       catch() { ... } // from try @ 00ba6508 with catch @ 00ba64d8 */
        ...
        uVar10 = uVar7;
                    ...
                    /* try { // try from 00ba6504 to 00ca6507 has its CatchHandler @ 00ba6558 */
      length = (length + -8) - uVar11;
                    /* try { // try from 00ba6508 to 00ca656b has its CatchHandler @ 00ba64d8 */
      output = output + lVar1;
      input = (uchar *)puVar2;
    }
    uVar9 = uVar3;
    ...
    if (length != 0) {
      ...
      if (length - 1U < 7) {
        ...
        local_64 = local_64 ^ uVar7;
                    /* catch() { ... } // from try @ 00ba6504 with catch @ 00ba6558 */
    ...
    puVar5 = input;
    if (7 < length) {
                    /* try { // try from 00ba62d4 to 00ca62ff has its CatchHandler @ 00ba62d4
                       catch() { ... } // from try @ 00ba62d4 with catch @ 00ba62d4
                       catch() { ... } // from try @ 00ba6334 with catch @ 00ba62d4 */
      uVar11 = 0xfffffffffffffff0;
      if (-0x10 < ~length) {
        uVar11 = ~length;
      }
    ...
    if (length != 0) {
      uVar3 = 0;
      if (length - 1U < 7) {
                    /* try { // try from 00ba638c to 00ca63bb has its CatchHandler @ 00ba638c
                       catch() { ... } // from try @ 00ba638c with catch @ 00ba638c
                       catch() { ... } // from try @ 00ba63c0 with catch @ 00ba638c */
        ...
        case 5:
          pbVar4 = pbVar4 + -1;
                    /* try { // try from 00ba63bc to 00ca63bf has its CatchHandler @ 00ba64ac */
          uVar9 = uVar3 | *pbVar4;
        case 4:
                    /* try { // try from 00ba63c0 to 00ca64bf has its CatchHandler @ 00ba638c */
          pbVar4 = pbVar4 + -1;
  ...
  (*ivec)[7] = (uchar)(uVar10 >> 0x18);
                    /* try { // try from 00ba65e8 to 00ca6613 has its CatchHandler @ 00ba65e8
                       catch() { ... } // from try @ 00ba65e8 with catch @ 00ba65e8
                       catch() { ... } // from try @ 00ba6618 with catch @ 00ba65e8 */
  return;
}
