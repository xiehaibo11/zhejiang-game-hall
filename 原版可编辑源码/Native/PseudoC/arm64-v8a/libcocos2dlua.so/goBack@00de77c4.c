...
/* cocos2d::experimental::ui::WebViewImpl::goBack() */

void __thiscall cocos2d::experimental::ui::WebViewImpl::goBack(WebViewImpl *this)

{
  ...
  basic_string<decltype(nullptr)>(local_40,"goBack");
