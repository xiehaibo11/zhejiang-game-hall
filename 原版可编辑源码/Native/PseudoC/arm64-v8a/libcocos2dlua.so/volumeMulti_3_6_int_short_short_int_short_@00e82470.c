...
/* void cocos2d::experimental::volumeMulti<3, 6, int, short, short, int, short>(int*, unsigned long,
   short const*, int*, short const*, short) */

void cocos2d::experimental::volumeMulti<3,6,int,short,short,int,short>
