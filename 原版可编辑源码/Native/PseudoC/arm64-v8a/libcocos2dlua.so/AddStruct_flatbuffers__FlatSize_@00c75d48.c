...
/* void flatbuffers::FlatBufferBuilder::AddStruct<flatbuffers::FlatSize>(unsigned short,
   flatbuffers::FlatSize const*) */

void __thiscall
flatbuffers::FlatBufferBuilder::AddStruct<flatbuffers::FlatSize>
          (FlatBufferBuilder *this,ushort param_1,FlatSize *param_2)

{
  ...
  if (param_2 != (FlatSize *)0x0) {
    Align(this,4);
    pFVar3 = (FlatSize *)vector_downward::make_space((vector_downward *)(this + 8),8);
    *pFVar3 = *param_2;
    pFVar3[1] = param_2[1];
    pFVar3[2] = param_2[2];
    pFVar3[3] = param_2[3];
