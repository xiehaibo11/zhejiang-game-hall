...
LAB_00b9caa4:
          ...
          if (keylen != 0x10) goto LAB_00b9ca88;
        }
      }
      else if (nid == 0x315) {
                    /* try { // try from 00b9ca80 to 00c9ca87 has its CatchHandler @ 00b9cbec */
        if (keylen != 0x18) {
LAB_00b9ca88:
          iVar1 = 100;
          reason = 0x76;
        ...
        if (nid != 0x316) goto LAB_00b9caa4;
        if (keylen != 0x20) goto LAB_00b9ca88;
      }
      ...
      if (val != (ASN1_VALUE *)0x0) {
        ...
        *(ASN1_VALUE **)(val + 8) = pAVar2;
                    /* try { // try from 00b9caf4 to 00c9cafb has its CatchHandler @ 00b9cbd8 */
        if (pAVar2 != (ASN1_VALUE *)0x0) {
                    /* try { // try from 00b9cafc to 00c9cc03 has its CatchHandler @ 00b9c8d0 */
          *(undefined4 *)val = 2;
          if (otherTypeId != (ASN1_OBJECT *)0x0) {
            ...
            *(ASN1_VALUE **)(*(long *)(pAVar2 + 8) + 0x10) = pAVar3;
            if (pAVar3 == (ASN1_VALUE *)0x0) goto LAB_00b9cb88;
          }
