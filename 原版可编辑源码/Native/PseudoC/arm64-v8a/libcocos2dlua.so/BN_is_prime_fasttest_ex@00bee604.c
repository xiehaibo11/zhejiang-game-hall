                    ...
                    do {
                      ...
                      if (iVar3 == 0) {
                        ...
                        while (iVar3 != 0) {
                          iVar1 = iVar1 + 1;
                          iVar3 = 0;
                          if (iVar1 == 0) goto joined_r0x00beeb94;
                          iVar3 = BN_mod_mul(rnd,rnd,rnd,pBVar5,ctx_00);
                          if (iVar3 == 0) goto LAB_00bee9ac;
                          iVar3 = BN_is_one(rnd);
                          if (iVar3 != 0) goto LAB_00beeb90;
                          iVar3 = BN_cmp(rnd,a);
                        }
                      }
                      iVar9 = iVar9 + 1;
                    ...
                    do {
                      ...
                      if (iVar3 == 0) {
                        ...
                        while (iVar3 != 0) {
                          iVar9 = iVar9 + 1;
                          iVar3 = 0;
                          if (iVar9 == 0) goto joined_r0x00beeb94;
                          iVar3 = BN_mod_mul(rnd,rnd,rnd,pBVar5,ctx_00);
                          if (iVar3 == 0) goto LAB_00bee9ac;
                          iVar3 = BN_is_one(rnd);
                          if (iVar3 != 0) goto LAB_00beeb90;
...
LAB_00bee9ac:
    ...
    lVar8 = 0;
    do {
      uVar6 = BN_mod_word(p,(ulong)(ushort)(&DAT_014033f6)[lVar8]);
      cVar2 = '\x05';
    ...
    if (cb == (BN_GENCB *)0x0) goto joined_r0x00bee840;
    if (cb->ver == 2) {
      iVar3 = -1;
...
LAB_00beeb90:
  iVar3 = 0;
joined_r0x00beeb94:
  if (ctx_00 == (BN_CTX *)0x0) goto LAB_00bee90c;
LAB_00bee8f8:
  BN_CTX_end(ctx_00);
  if (ctx == (BN_CTX *)0x0) {
    BN_CTX_free(ctx_00);
