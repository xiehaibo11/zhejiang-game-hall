...
/* std::__ndk1::vector<cocos2d::PhysicsJoint*, std::__ndk1::allocator<cocos2d::PhysicsJoint*>
   >::vector(std::__ndk1::vector<cocos2d::PhysicsJoint*,
   std::__ndk1::allocator<cocos2d::PhysicsJoint*> > const&) */
  ...
  *(undefined8 *)(this + 0x10) = 0;
  ...
  if (uVar1 != 0) {
    ...
    *(void **)(this + 8) = __dest;
                    ...
                    /* try { // try from 0100c730 to 0110c793 has its CatchHandler @ 0100c7f0 */
  return;
}
