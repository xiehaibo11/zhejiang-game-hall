...
/* cocosbuilder::LabelBMFontLoader::onHandlePropTypeByte(cocos2d::Node*, cocos2d::Node*, char
   const*, unsigned char, cocosbuilder::CCBReader*) */

void cocosbuilder::LabelBMFontLoader::onHandlePropTypeByte
...

{
  ...
  if (iVar1 != 0) {
    ...
    return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00cffdc4. Too many branches */
