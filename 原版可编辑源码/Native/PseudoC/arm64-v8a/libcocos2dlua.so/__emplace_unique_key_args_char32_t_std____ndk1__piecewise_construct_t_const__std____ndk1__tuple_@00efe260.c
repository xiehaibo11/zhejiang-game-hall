...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<char32_t,
   ...
   std::__ndk1::tuple<char32_t const&>, std::__ndk1::tuple<> >(char32_t const&,
   std::__ndk1::piecewise_construct_t const&, std::__ndk1::tuple<char32_t const&>&&,
   std::__ndk1::tuple<>&&) */
      ...
      for (plVar9 = (long *)*plVar9; plVar9 != (long *)0x0; plVar9 = (long *)*plVar9) {
        ...
        if (uVar8 != uVar11) {
          if (uVar6 < 2) {
            ...
            if (uVar8 - uVar3 * uVar10 == unaff_x24) goto LAB_00efe2ec;
            break;
          }
