...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<int,
   cocos2d::ui::Scale9Sprite*>, void*>*>, bool>
   ...
   >::__emplace_unique_key_args<int, int const&, cocos2d::ui::Scale9Sprite*&>(int const&, int
   const&, cocos2d::ui::Scale9Sprite*&) */
...
::__emplace_unique_key_args<int,int_const&,cocos2d::ui::Scale9Sprite*&>
          (__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>>>
           *this,int *param_1,int *param_2,Scale9Sprite **param_3)
  ...
  if (uVar9 != 0) {
    ...
    if (uVar5 < 2) {
      unaff_x25 = uVar9 - 1 & uVar10;
                    ...
                    /* catch() { ... } // from try @ 00e0dec0 with catch @ 00e0df5c */
      unaff_x25 = uVar10;
      if (uVar9 <= uVar10) {
        uVar7 = 0;
        if (uVar9 != 0) {
      ...
      for (plVar8 = (long *)*plVar8; plVar8 != (long *)0x0; plVar8 = (long *)*plVar8) {
        ...
        if (uVar7 != uVar10) {
          if (uVar5 < 2) {
            ...
            if (uVar7 - uVar1 * uVar9 == unaff_x25) goto LAB_00e0dfa4;
            break;
          }
...
LAB_00e0dfa4:
        if (*(int *)(plVar8 + 2) == *param_1) {
          return plVar8;
                    ...
                    /* try { // try from 00e0dfb4 to 00f0e013 has its CatchHandler @ 00e0dfb4
                       catch() { ... } // from try @ 00e0dfb4 with catch @ 00e0dfb4
                       catch() { ... } // from try @ 00e0e018 with catch @ 00e0dfb4 */
      }
    }
  }
  ...
  *plVar8 = 0;
  plVar8[1] = uVar10;
  plVar8[3] = (long)pSVar2;
                    /* try { // try from 00e0e014 to 00f0e017 has its CatchHandler @ 00e0e0a4 */
                    /* try { // try from 00e0e018 to 00f0e0bf has its CatchHandler @ 00e0dfb4 */
  ...
  if (plVar3 == (long *)0x0) {
    ...
    *(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::ui::Scale9Sprite*>>>
    ...
    plVar3 = (long *)(*(long *)this + uVar10 * 8);
                    ...
                    /* catch() { ... } // from try @ 00e0e014 with catch @ 00e0e0a4 */
    *plVar8 = *plVar3;
  }
  *plVar3 = (long)plVar8;
LAB_00e0e0fc:
