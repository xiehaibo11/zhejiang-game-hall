...
/* void std::__ndk1::vector<ClipperLib::Join*, std::__ndk1::allocator<ClipperLib::Join*>
   >::__push_back_slow_path<ClipperLib::Join* const&>(ClipperLib::Join* const&) */

void __thiscall
std::__ndk1::vector<ClipperLib::Join*,std::__ndk1::allocator<ClipperLib::Join*>>::
__push_back_slow_path<ClipperLib::Join*const&>
          (vector<ClipperLib::Join*,std::__ndk1::allocator<ClipperLib::Join*>> *this,Join **param_1)
