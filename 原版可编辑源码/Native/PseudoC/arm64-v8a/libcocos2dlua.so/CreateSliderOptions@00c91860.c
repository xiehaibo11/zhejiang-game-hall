...
/* flatbuffers::CreateSliderOptions(flatbuffers::FlatBufferBuilder&,
...
undefined4
flatbuffers::CreateSliderOptions
...

{
  ...
  FlatBufferBuilder::AddElement<int>(param_1,0x10,param_8,0x32);
  if (param_7 != 0) {
  ...
  if ((param_9 != '\x01') || (param_1[0x60] != (FlatBufferBuilder)0x0)) {
