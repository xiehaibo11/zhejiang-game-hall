              ...
              *(long **)(*(long *)this + uVar17 * 8) = plVar15;
              ...
              if (plVar11 != (long *)0x0) {
                bVar2 = *(byte *)(plVar16 + 2);
                    /* try { // try from 00ab2c18 to 00bb2c63 has its CatchHandler @ 00ab2c18
                       catch() { ... } // from try @ 00ab2c18 with catch @ 00ab2c18
                       catch() { ... } // from try @ 00ab2c68 with catch @ 00ab2c18 */
                __n = (ulong)(bVar2 >> 1);
                if ((bVar2 & 1) != 0) {
                  __n = plVar16[3];
                }
                do {
                  ...
                  if (__n != sVar3) break;
                    /* try { // try from 00ab2c64 to 00bb2c67 has its CatchHandler @ 00ab2c9c */
                    /* try { // try from 00ab2c68 to 00bb2caf has its CatchHandler @ 00ab2c18 */
                  __s2 = (char *)plVar12[4];
                  ...
                  if ((bVar2 & 1) == 0) {
                    while (sVar6 != 0) {
                      if (*pcVar5 != *__s2) goto LAB_00ab2cd8;
                      __s2 = __s2 + 1;
                    /* catch() { ... } // from try @ 00ab2c64 with catch @ 00ab2c9c */
                      sVar3 = sVar3 - 1;
                      pcVar5 = pcVar5 + 1;
                      sVar6 = sVar3;
                    }
                    ...
                    /* try { // try from 00ab2cb0 to 00bb2f2f has its CatchHandler @ 00ab2cb0
                       catch() { ... } // from try @ 00ab2cb0 with catch @ 00ab2cb0
                       catch() { ... } // from try @ 00ab2fb0 with catch @ 00ab2cb0 */
