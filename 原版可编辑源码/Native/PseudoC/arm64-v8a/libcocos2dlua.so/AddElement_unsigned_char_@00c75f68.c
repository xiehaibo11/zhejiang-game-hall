...
/* void flatbuffers::FlatBufferBuilder::AddElement<unsigned char>(unsigned short, unsigned char,
   unsigned char) */

void __thiscall
flatbuffers::FlatBufferBuilder::AddElement<unsigned_char>
          (FlatBufferBuilder *this,ushort param_1,uchar param_2,uchar param_3)

{
  ...
  if ((param_2 != param_3) || (this[0x60] != (FlatBufferBuilder)0x0)) {
    ...
    *(long *)(this + 0x18) = lVar4 + -1;
    *(uchar *)(lVar4 + -1) = param_2;
