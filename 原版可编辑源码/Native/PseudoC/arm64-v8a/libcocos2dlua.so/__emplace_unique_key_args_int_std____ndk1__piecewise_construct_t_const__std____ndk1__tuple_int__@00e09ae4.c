...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<int,
   cocos2d::Vector<cocos2d::extension::Invocation*>*>, void*>*>, bool>
   std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int,
   cocos2d::Vector<cocos2d::extension::Invocation*>*>, std::__ndk1::__unordered_map_hasher<int,
   ...
   cocos2d::Vector<cocos2d::extension::Invocation*>*> > >::__emplace_unique_key_args<int,
   std::__ndk1::piecewise_construct_t const&, std::__ndk1::tuple<int&&>, std::__ndk1::tuple<> >(int
   const&, std::__ndk1::piecewise_construct_t const&, std::__ndk1::tuple<int&&>&&,
   std::__ndk1::tuple<>&&) */
...

{
  ...
  if (uVar8 != 0) {
    ...
    if (uVar4 < 2) {
                    /* try { // try from 00e09b44 to 00f09b4f has its CatchHandler @ 00e09c10 */
      ...
      if (uVar8 <= uVar9) {
        ...
        unaff_x24 = uVar9 - uVar6 * uVar8;
                    /* try { // try from 00e09b38 to 00f09b43 has its CatchHandler @ 00e09c20 */
      }
    }
    plVar7 = *(long **)(*(long *)param_1 + unaff_x24 * 8);
    if (plVar7 != (long *)0x0) {
                    /* try { // try from 00e09b58 to 00f09b6b has its CatchHandler @ 00e09c00 */
        ...
        if (uVar6 != uVar9) {
          if (uVar4 < 2) {
            uVar6 = uVar6 & uVar8 - 1;
                    ...
                    /* try { // try from 00e09b98 to 00f09ba3 has its CatchHandler @ 00e09bfc */
            if (uVar8 <= uVar6) {
              uVar2 = 0;
              if (uVar8 != 0) {
                uVar2 = uVar6 / uVar8;
              }
                    /* try { // try from 00e09ba4 to 00f09baf has its CatchHandler @ 00e09bf8 */
              if (uVar6 - uVar2 * uVar8 == unaff_x24) goto LAB_00e09b70;
              break;
            }
          }
                    /* try { // try from 00e09b6c to 00f09b97 has its CatchHandler @ 00e09970 */
...
LAB_00e09b70:
  ...
  plVar7 = operator_new(0x20);
                    /* try { // try from 00e09bb8 to 00f09bcb has its CatchHandler @ 00e09bf4 */
  uVar1 = **(undefined4 **)param_4;
  plVar7[3] = 0;
  *plVar7 = 0;
  plVar7[1] = uVar9;
                    /* try { // try from 00e09bcc to 00f09c33 has its CatchHandler @ 00e09970 */
  *(undefined4 *)(plVar7 + 2) = uVar1;
  if ((uVar8 == 0) || ((float)param_1[8] * (float)uVar8 < (float)(*(long *)(param_1 + 6) + 1))) {
                    /* catch() { ... } // from try @ 00e09bb8 with catch @ 00e09bf4 */
                    /* catch() { ... } // from try @ 00e09ba4 with catch @ 00e09bf8 */
                    /* catch() { ... } // from try @ 00e09b98 with catch @ 00e09bfc */
                    /* catch() { ... } // from try @ 00e09b58 with catch @ 00e09c00 */
                    /* catch() { ... } // from try @ 00e09b44 with catch @ 00e09c10 */
    uVar8 = (ulong)(uVar8 < 3 || (uVar8 & uVar8 - 1) != 0) | uVar8 << 1;
    uVar4 = (ulong)((float)(*(long *)(param_1 + 6) + 1) / (float)param_1[8]);
    if (uVar4 <= uVar8) {
      uVar4 = uVar8;
    }
                    /* catch() { ... } // from try @ 00e09b38 with catch @ 00e09c20 */
    rehash((__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::Vector<cocos2d::extension::Invocation*>*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::Vector<cocos2d::extension::Invocation*>*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::Vector<cocos2d::extension::Invocation*>*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::Vector<cocos2d::extension::Invocation*>*>>>
            *)param_1,uVar4);
    uVar8 = *(ulong *)(param_1 + 2);
    if ((uVar8 & uVar8 - 1) == 0) {
      unaff_x24 = uVar8 - 1 & uVar9;
