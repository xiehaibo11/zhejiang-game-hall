...
/* cocos2d::experimental::AudioDecoderSLES::decodeToPcmCallback(SLAndroidSimpleBufferQueueItf_
   const* const*) */

void __thiscall
cocos2d::experimental::AudioDecoderSLES::decodeToPcmCallback
...

{
  ...
  *(int *)(this + 0x8c) = iVar3 + 1;
  if (((iVar3 + 1) % 1000 == 0) &&
    ...
    iVar3 = (**(code **)*param_1)(param_1,*(undefined8 *)(this + 0x128),DAT_0178f43c);
    if (iVar3 == 0) {
      uVar1 = *(long *)(this + 0x128) + (long)DAT_0178f43c;
      if (*(ulong *)(this + 0x120) + (long)DAT_0178f43c * 4 <= uVar1) {
