...

{
  ...
  if (*param_1 == 0) {
    lVar2 = OPENSSL_LH_new(&LAB_00bd77d8,&LAB_00bd77e0);
    if (lVar2 == 0) goto LAB_00bd74a0;
    *param_1 = lVar2;
    ...
    if (param_6 != 0) {
      ...
      do {
        ...
        if (ptr == (undefined4 *)0x0) {
          ...
          if (ptr == (undefined4 *)0x0) goto LAB_00bd74a0;
          ptr[6] = 1;
          *ptr = *param_4;
          lVar2 = OPENSSL_sk_new_null();
          *(long *)(ptr + 2) = lVar2;
          if (lVar2 == 0) goto LAB_00bd748c;
          *(undefined8 *)(ptr + 4) = 0;
