...
undefined8 FUN_011340cc(long param_1,long param_2,long param_3)
...
LAB_01134360:
    ...
    puVar6 = puVar5;
    local_88 = param_2;
    if (0xb < (int)uVar18) goto LAB_011343f0;
LAB_0113436c:
    if (pbVar9 < pbVar13) {
      pbVar10 = pbVar9 + 1;
...
LAB_011343f0:
    ...
    case 7:
      ...
      puVar6 = puVar5 + 1;
      *puVar5 = uVar19;
      if ((int)local_64 <= (int)uVar17) goto LAB_01134208;
      uVar14 = 0;
      goto joined_r0x01134448;
    default:
      ...
      local_9c = 0;
      goto joined_r0x01134558;
    case 9:
    case 0xb:
      goto switchD_0113441c_caseD_9;
    case 0xc:
      goto LAB_01134570;
    }
  }
...
LAB_01134764:
  ...
  goto LAB_01134910;
switchD_0113441c_caseD_9:
  uVar17 = *(int *)(TIFFFaxWhiteTable + uVar11 * 8 + 4) + uVar17;
  uVar14 = *(int *)(TIFFFaxWhiteTable + uVar11 * 8 + 4) + uVar14;
  uVar19 = uVar18;
  if ((int)uVar18 < 0xc) goto LAB_0113436c;
  goto LAB_011343f0;
joined_r0x01134448:
  pbVar10 = pbVar9;
  uVar12 = uVar18;
  ...
  if (1 < uVar12 - 10) goto LAB_01134324;
...
LAB_011346ec:
  ...
  if (uVar17 == local_64) goto LAB_0113490c;
  ...
  if (((int)uVar17 <= (int)local_64) || (puVar6 <= local_70)) goto joined_r0x011348e8;
  goto LAB_0113488c;
LAB_01134324:
  if (uVar12 == 0xc) {
LAB_01134570:
...
joined_r0x01134558:
  ...
  lVar15 = local_78;
  if (uVar17 == local_64) goto LAB_01134688;
  goto LAB_01134594;
LAB_01134208:
  local_9c = 0;
  bVar4 = local_64 <= uVar17;
...
LAB_01134688:
  ...
  *(int *)(lVar15 + 0x90) = *(int *)(lVar15 + 0x90) + 1;
  if (param_3 < 1) goto code_r0x011346d8;
  goto LAB_01134220;
code_r0x011346d8:
...
LAB_0113488c:
    ...
    uVar17 = uVar17 - *puVar6;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 01134918 with catch @ 01134894
                       catch(type#1 @ 00000000) { ... } // from try @ 011349ec with catch @ 01134894
                       catch(type#1 @ 00000000) { ... } // from try @ 01134a0c with catch @ 01134894
                        */
    bVar4 = (int)local_64 < (int)uVar17;
  ...
  if ((int)uVar17 < (int)local_64) {
    ...
    if (((uint)((int)puVar6 - (int)local_70) >> 2 & 1) != 0) {
      ...
      *puVar6 = 0;
                    ...
                    /* try { // try from 011348cc to 012348d3 has its CatchHandler @ 01134958 */
    local_9c = 0;
...
LAB_0113490c:
                    /* try { // try from 0113490c to 01234917 has its CatchHandler @ 01134960 */
    local_9c = 0;
    param_2 = local_88;
  }
LAB_01134910:
                    /* try { // try from 01134918 to 012349c7 has its CatchHandler @ 01134894 */
  ...
  *(long *)(lVar7 + 0x390) = (lVar8 - (long)pbVar9) + *(long *)(lVar7 + 0x390);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 011348cc with catch @ 01134958
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 011348b0 with catch @ 0113495c
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 0113490c with catch @ 01134960
                        */
  return 0xffffffff;
}
