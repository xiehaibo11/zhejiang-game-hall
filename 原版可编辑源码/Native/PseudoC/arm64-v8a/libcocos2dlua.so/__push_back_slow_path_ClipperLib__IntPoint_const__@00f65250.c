...
/* void std::__ndk1::vector<ClipperLib::IntPoint, std::__ndk1::allocator<ClipperLib::IntPoint>
   >::__push_back_slow_path<ClipperLib::IntPoint const&>(ClipperLib::IntPoint const&) */
