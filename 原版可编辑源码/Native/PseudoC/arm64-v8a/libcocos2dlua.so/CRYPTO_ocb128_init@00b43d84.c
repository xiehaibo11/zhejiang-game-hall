...
LAB_00b43e18:
    do {
      ...
      if (lVar5 == 0) {
        ...
        *pbVar6 = bVar10;
        lVar2 = 0xe;
        if (lVar5 == 0xf) goto LAB_00b43e18;
      }
...
LAB_00b43ea0:
    do {
      ...
      if (lVar5 == 0) {
        ...
        *pbVar11 = bVar10;
        lVar2 = 0xe;
        if (lVar5 == 0xf) goto LAB_00b43ea0;
      }
...
LAB_00b43f2c:
    do {
      ...
      if (lVar5 == 0) {
        ...
        *pbVar12 = bVar10;
        lVar2 = 0xe;
        if (lVar5 == 0xf) goto LAB_00b43f2c;
      }
...
LAB_00b43fb8:
    do {
      ...
      if (lVar8 == 0) {
        ...
        *pbVar6 = bVar10;
        lVar2 = 0xe;
        if (lVar8 == 0xf) goto LAB_00b43fb8;
      }
...
LAB_00b44044:
    do {
      ...
      if (lVar8 == 0) {
        ...
        *pbVar6 = bVar10;
        lVar2 = 0xe;
        if (lVar8 == 0xf) goto LAB_00b44044;
      }
      *pbVar6 = bVar10 ^ abStack_51[lVar8 + 1];
      lVar2 = lVar9;
    } while (0 < lVar8);
...
LAB_00b440d0:
    do {
      ...
      if (lVar8 == 0) {
        ...
        *pbVar6 = bVar10;
        lVar2 = 0xe;
        if (lVar8 == 0xf) goto LAB_00b440d0;
      }
      *pbVar6 = bVar10 ^ abStack_51[lVar8 + 1];
      lVar2 = lVar9;
    } while (0 < lVar8);
