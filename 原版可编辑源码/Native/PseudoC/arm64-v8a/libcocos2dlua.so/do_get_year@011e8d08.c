...

{
  ...
  local_78 = param_2;
  ios_base::getloc();
  local_70 = &ctype<char>::id;
  uStack_60 = 0;
  local_68 = locale::id::__init;
  if (ctype<char>::id != -1) {
    local_50 = &local_70;
    local_58 = &local_50;
    __call_once((ulong *)&ctype<char>::id,&local_58,FUN_01208130);
  }
  if (((ulong)(*(long *)(local_80 + 0x18) - *(long *)(local_80 + 0x10) >> 3) <=
       (long)DAT_01794330 - 1U) ||
     (lVar4 = *(long *)(*(long *)(local_80 + 0x10) + ((long)DAT_01794330 - 1U) * 8), lVar4 == 0)) {
                    /* WARNING: Subroutine does not return */
    FUN_00cc7c00();
  }
  __shared_count::__release_shared(local_80);
  iVar2 = FUN_011e9c7c(&local_78,param_3,param_5,lVar4,4);
  if ((*param_5 >> 2 & 1) == 0) {
    if (iVar2 < 0x45) {
      iVar3 = iVar2 + 2000;
    }
