  ...
  if (numbits - 1U < 0x40) {
    ...
    if (enc == 0) {
      if (uVar29 <= (ulong)length) {
        ...
        uVar17 = 8 - uVar12;
        uVar19 = uVar32;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ba3ef0 with catch @ 00ba3fd8
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ba3e90 with catch @ 00ba3ff0
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ba3d30 with catch @ 00ba4004
                        */
        do {
          local_68 = uVar19;
          uStack_64 = uVar30;
      ...
      lVar20 = (long)(iVar3 >> 3);
      uVar13 = 8 - uVar12;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ba3ba8 with catch @ 00ba3c90
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ba3b4c with catch @ 00ba3cb0
                        */
      do {
        local_68 = uVar32;
        uStack_64 = uVar30;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ba39dc with catch @ 00ba3cdc
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ba3d38 with catch @ 00ba3ce0
                       catch(type#1 @ 00000000) { ... } // from try @ 00ba3ef8 with catch @ 00ba3ce0
                        */
        DES_encrypt1(&local_68,schedule,1);
        uVar17 = 0;
        pbVar18 = in + uVar29;
        ...
        case 4:
                    /* try { // try from 00ba3d30 to 00ca3d37 has its CatchHandler @ 00ba4004 */
          pbVar18 = pbVar18 + -1;
          uVar17 = uVar17 | *pbVar18;
        case 3:
                    /* try { // try from 00ba3d38 to 00ca3e8f has its CatchHandler @ 00ba3ce0 */
          pbVar18 = pbVar18 + -1;
        ...
        case 0:
          ...
          break;
        default:
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ba3b38 with catch @ 00ba3cc8
                        */
          uVar19 = 0;
        }
        ...
        if ((numbits != 0x20) && (uVar17 = local_68, uVar19 = uStack_64, numbits != 0x40)) {
          ...
          if (uVar12 == 0) {
            ...
            uVar5 = (undefined1)uVar32;
            local_78 = CONCAT71(local_78._1_7_,uVar5);
                    /* try { // try from 00ba3e90 to 00ca3e97 has its CatchHandler @ 00ba3ff0 */
            ...
            local_78 = CONCAT35(uVar16,(uint5)local_78);
                    /* try { // try from 00ba3ef0 to 00ca3ef7 has its CatchHandler @ 00ba3fd8 */
                    /* try { // try from 00ba3ef8 to 00ca4007 has its CatchHandler @ 00ba3ce0 */
