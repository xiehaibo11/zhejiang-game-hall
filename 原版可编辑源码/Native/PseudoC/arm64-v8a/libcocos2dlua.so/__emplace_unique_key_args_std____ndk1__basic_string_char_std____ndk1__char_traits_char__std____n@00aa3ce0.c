...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, fairygui::PackageItem*>,
   void*>*>, bool>
   ...
   std::__ndk1::allocator<char> >, fairygui::PackageItem*>,
...

{
  ...
  if (uVar16 != 0) {
    ...
    uVar17 = NEON_uaddlv(uVar8,1);
                    /* try { // try from 00aa3d50 to 00ba3d83 has its CatchHandler @ 00aa3e50 */
    ...
    if (uVar13 < 2) {
      ...
      if (uVar16 <= uVar7) {
        ...
        unaff_x27 = uVar7 - uVar10 * uVar16;
                    ...
                    /* try { // try from 00aa3d84 to 00ba3d97 has its CatchHandler @ 00aa3e1c */
    puVar9 = *(undefined8 **)(*(long *)param_1 + unaff_x27 * 8);
    if ((puVar9 != (undefined8 *)0x0) && (plVar15 = (long *)*puVar9, plVar15 != (long *)0x0)) {
                    /* try { // try from 00aa3d9c to 00ba3dcf has its CatchHandler @ 00aa3e20 */
      ...
      do {
        uVar10 = plVar15[1];
        if (uVar10 != uVar7) {
                    /* try { // try from 00aa3dd0 to 00ba3e6b has its CatchHandler @ 00aa3ba8 */
          if (uVar13 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00aa3e04;
            break;
          }
...
LAB_00aa3e04:
        ...
        if ((bVar3 & 1) != 0) {
          sVar1 = plVar15[3];
                    ...
                    /* catch() { ... } // from try @ 00aa3d84 with catch @ 00aa3e1c */
                    /* catch() { ... } // from try @ 00aa3d9c with catch @ 00aa3e20 */
        if (sVar1 == __n) {
          __s1 = (void *)plVar15[4];
          if ((bVar3 & 1) == 0) {
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                    /* catch() { ... } // from try @ 00aa3d50 with catch @ 00aa3e50 */
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00aa3e74;
              }
              goto LAB_00aa3dbc;
            }
          }
  ...
  *plVar15 = 0;
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar12;
    if (*plVar15 == 0) goto LAB_00aa3f90;
