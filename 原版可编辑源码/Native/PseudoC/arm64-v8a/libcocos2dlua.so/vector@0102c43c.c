...
/* std::__ndk1::vector<p2t::Triangle*, std::__ndk1::allocator<p2t::Triangle*>
   >::vector(std::__ndk1::vector<p2t::Triangle*, std::__ndk1::allocator<p2t::Triangle*> > const&) */

void __thiscall
std::__ndk1::vector<p2t::Triangle*,std::__ndk1::allocator<p2t::Triangle*>>::vector
          (vector<p2t::Triangle*,std::__ndk1::allocator<p2t::Triangle*>> *this,vector *param_1)
