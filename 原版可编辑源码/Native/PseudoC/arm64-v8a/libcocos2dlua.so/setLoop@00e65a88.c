...
/* cocos2d::experimental::AudioEngineImpl::setLoop(int, bool) */

void __thiscall
cocos2d::experimental::AudioEngineImpl::setLoop(AudioEngineImpl *this,int param_1,bool param_2)

{
  ...
  if (uVar2 != 0) {
    ...
    plVar5 = *(long **)(*(long *)(this + 0x40) + uVar4 * 8);
    if ((plVar5 != (long *)0x0) && (plVar5 = (long *)*plVar5, plVar5 != (long *)0x0)) {
      do {
        uVar6 = plVar5[1];
        if (uVar6 == uVar3) {
          if ((int)plVar5[2] == param_1) {
                    /* WARNING: Could not recover jumptable at 0x00e65b44. Too many branches */
                    /* WARNING: Treating indirect jump as call */
            (**(code **)(*(long *)plVar5[3] + 0x70))((long *)plVar5[3],param_2);
            return;
          }
        }
        else {
