...
/* cocostudio::WidgetPropertiesReader::getGUIClassName(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

void cocostudio::WidgetPropertiesReader::getGUIClassName(basic_string *param_1)

{
  ...
  switch(uVar1) {
  case 5:
    pbVar4 = *(basic_string **)(in_x1 + 0x10);
    if (((byte)bVar2 & 1) == 0) {
      pbVar4 = in_x1 + 1;
    }
