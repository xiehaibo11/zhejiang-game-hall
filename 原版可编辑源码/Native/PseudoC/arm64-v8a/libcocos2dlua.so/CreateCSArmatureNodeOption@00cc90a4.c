...
/* flatbuffers::CreateCSArmatureNodeOption(flatbuffers::FlatBufferBuilder&,
   flatbuffers::Offset<flatbuffers::WidgetOptions>,
   flatbuffers::Offset<flatbuffers::ResourceItemData>, unsigned char, unsigned char,
   flatbuffers::Offset<flatbuffers::String>) */

undefined4
flatbuffers::CreateCSArmatureNodeOption
...

{
  ...
  FlatBufferBuilder::AddElement<unsigned_char>(param_1,10,param_5,'\x01');
  FlatBufferBuilder::AddElement<unsigned_char>(param_1,8,param_4,'\x01');
