...
/* void std::__ndk1::vector<cocos2d::ModelData*, std::__ndk1::allocator<cocos2d::ModelData*>
   >::__push_back_slow_path<cocos2d::ModelData* const&>(cocos2d::ModelData* const&) */

void __thiscall
std::__ndk1::vector<cocos2d::ModelData*,std::__ndk1::allocator<cocos2d::ModelData*>>::
__push_back_slow_path<cocos2d::ModelData*const&>
          (vector<cocos2d::ModelData*,std::__ndk1::allocator<cocos2d::ModelData*>> *this,
          ModelData **param_1)
