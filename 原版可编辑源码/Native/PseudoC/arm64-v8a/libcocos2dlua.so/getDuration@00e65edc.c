...
/* cocos2d::experimental::AudioEngineImpl::getDuration(int) */

undefined1  [16] __thiscall
cocos2d::experimental::AudioEngineImpl::getDuration(AudioEngineImpl *this,int param_1)
      ...
      do {
        ...
        if (uVar6 == uVar3) {
          if ((int)plVar5[2] == param_1) {
                    /* WARNING: Could not recover jumptable at 0x00e65f98. Too many branches */
                    /* WARNING: Treating indirect jump as call */
            auVar10 = (**(code **)(*(long *)plVar5[3] + 0x80))();
            return auVar10;
          }
        }
        else {
