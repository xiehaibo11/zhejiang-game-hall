...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int, cocos2d::Node*>,
   std::__ndk1::__unordered_map_hasher<int, std::__ndk1::__hash_value_type<int, cocos2d::Node*>,
   ...
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<int, cocos2d::Node*> > >::__rehash(unsigned
   long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::Node*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::Node*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::Node*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::Node*>>>
           *this,ulong param_1)
    ...
    do {
      *(undefined8 *)(*(long *)this + uVar4 * 8) = 0;
      uVar4 = uVar4 + 1;
                    ...
                    /* try { // try from 00e0dc98 to 00f0dcbb has its CatchHandler @ 00e0dd18 */
    ...
    if (plVar5 != (long *)0x0) {
      ...
      *(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::Node*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::Node*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::Node*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::Node*>>>
      ...
      if ((long *)*plVar5 != (long *)0x0) {
        ...
        do {
          uVar7 = plVar6[1];
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00e0dc98 with catch @ 00e0dd18
                        */
          if ((uVar12 & 0xffffffff) < 2) {
          ...
          if (uVar7 != uVar4) {
            ...
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) {
                    /* catch() { ... } // from try @ 00e0ddd8 with catch @ 00e0dd9c */
              *(long **)(*(long *)this + uVar7 * 8) = plVar5;
              ...
              do {
                ...
                if (plVar9 == (long *)0x0) break;
                    /* try { // try from 00e0dd64 to 00f0dd87 has its CatchHandler @ 00e0dd98 */
              } while ((int)plVar6[2] == (int)plVar9[2]);
              *plVar5 = (long)plVar9;
              *plVar8 = **(long **)(*(long *)this + uVar7 * 8);
              **(undefined8 **)(*(long *)this + uVar7 * 8) = plVar6;
              plVar6 = plVar5;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00e0dd64 with catch @ 00e0dd98
                        */
            }
          }
          plVar9 = (long *)*plVar6;
