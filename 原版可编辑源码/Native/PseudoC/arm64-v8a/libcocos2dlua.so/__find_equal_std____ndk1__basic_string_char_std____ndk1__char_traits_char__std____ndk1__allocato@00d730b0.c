...

{
  ...
  *__s1_00;
                    ...
                    /* catch() { ... } // from try @ 00d71610 with catch @ 00d730bc */
                    /* catch() { ... } // from try @ 00d71600 with catch @ 00d730cc */
  p_Var5 = this + 8;
  p_Var6 = *(__tree<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::AnimationData*>,std::__ndk1::__map_value_compare<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::AnimationData*>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::AnimationData*>>>
             **)p_Var5;
  if (p_Var6 == (__tree<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::AnimationData*>,std::__ndk1::__map_value_compare<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::AnimationData*>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::AnimationData*>>>
    ...
    *param_1 = (__tree_end_node *)p_Var5;
                    /* catch() { ... } // from try @ 00d72c24 with catch @ 00d731c4 */
                    /* catch() { ... } // from try @ 00d72b48 with catch @ 00d731c8 */
                    /* catch() { ... } // from try @ 00d7251c with catch @ 00d731cc */
    return (__tree_node_base **)p_Var5;
                    /* catch() { ... } // from try @ 00d71f74 with catch @ 00d731a4 */
  }
                    /* catch() { ... } // from try @ 00d715f0 with catch @ 00d730dc */
  uVar2 = *(ulong *)(param_2 + 8);
  __s1 = *(basic_string **)(param_2 + 0x10);
                    /* catch() { ... } // from try @ 00d715e0 with catch @ 00d730ec */
  p_Var5 = this + 8;
                    /* catch() { ... } // from try @ 00d715c8 with catch @ 00d730f0 */
  if (((byte)*param_2 & 1) == 0) {
                    /* catch() { ... } // from try @ 00d715c0 with catch @ 00d730f4 */
    __s1 = param_2 + 1;
    uVar2 = (ulong)((byte)*param_2 >> 1);
  }
  do {
    while( true ) {
                    /* catch() { ... } // from try @ 00d72810 with catch @ 00d73114 */
      p_Var7 = p_Var6;
      _Var3 = p_Var7[0x20];
      uVar1 = (ulong)((byte)_Var3 >> 1);
                    /* catch() { ... } // from try @ 00d729d8 with catch @ 00d73128 */
      if (((byte)_Var3 & 1) != 0) {
      ...
      __s1_00 = *(__tree<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::AnimationData*>,std::__ndk1::__map_value_compare<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::AnimationData*>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::AnimationData*>>>
                  **)(p_Var7 + 0x30);
                    /* catch() { ... } // from try @ 00d72360 with catch @ 00d7313c */
      p_Var6 = __s1_00;
      if (((byte)_Var3 & 1) == 0) {
        p_Var6 = p_Var7 + 0x21;
      }
      iVar4 = memcmp(__s1,p_Var6,__n);
                    /* catch() { ... } // from try @ 00d7202c with catch @ 00d73150 */
      if (iVar4 == 0) break;
      if (iVar4 < 0) goto LAB_00d73164;
LAB_00d7317c:
                    /* catch() { ... } // from try @ 00d72948 with catch @ 00d73180 */
      if (((byte)_Var3 & 1) == 0) {
        __s1_00 = p_Var7 + 0x21;
      }
      iVar4 = memcmp(__s1_00,__s1,__n);
                    /* catch() { ... } // from try @ 00d722a8 with catch @ 00d73190 */
      if (iVar4 == 0) goto LAB_00d730fc;
                    /* catch() { ... } // from try @ 00d72758 with catch @ 00d73194 */
      if (-1 < iVar4) goto LAB_00d73198;
LAB_00d73104:
                    /* catch() { ... } // from try @ 00d715b4 with catch @ 00d73104 */
      p_Var5 = p_Var7 + 8;
      p_Var6 = *(__tree<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::AnimationData*>,std::__ndk1::__map_value_compare<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::AnimationData*>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::AnimationData*>>>
                 **)p_Var5;
...
LAB_00d730fc:
      if (uVar2 <= uVar1) goto LAB_00d73198;
      goto LAB_00d73104;
    }
LAB_00d73164:
    p_Var5 = p_Var7;
