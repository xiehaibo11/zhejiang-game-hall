...
/* cocos2d::experimental::ThreadPool::setThread(int) */

void __thiscall cocos2d::experimental::ThreadPool::setThread(ThreadPool *this,int param_1)

{
  ...
  if (__newthread != (pthread_t *)0x0) {
    ...
    *(int *)(puVar6 + 2) = param_1;
    puVar6[3] = uVar2;
    puVar6[4] = this_00;
    iVar5 = pthread_create(__newthread,(pthread_attr_t *)0x0,FUN_00e922d4,puVar6);
    if (iVar5 != 0) {
