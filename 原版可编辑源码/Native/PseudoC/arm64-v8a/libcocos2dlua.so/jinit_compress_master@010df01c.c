...

{
  ...
  undefined8 *puVar5;
                    ...
                    /* try { // try from 010df02c to 011df03b has its CatchHandler @ 010df3f8 */
  lVar1 = param_1[0xb];
  if ((int)lVar1 != 8) {
    puVar5 = (undefined8 *)*param_1;
                    /* try { // try from 010df03c to 011df11f has its CatchHandler @ 010defc8 */
  ...
  if ((int)param_1[0x22] < 2) {
                    /* try { // try from 010df120 to 011df12b has its CatchHandler @ 010df3e4 */
    bVar2 = (int)param_1[0x25] != 0;
  }
  else {
    bVar2 = true;
  }
                    /* try { // try from 010df12c to 011df38b has its CatchHandler @ 010defc8 */
  ...
  (**(code **)(param_1[1] + 0x30))(param_1);
                    /* WARNING: Could not recover jumptable at 0x010df16c. Too many branches */
