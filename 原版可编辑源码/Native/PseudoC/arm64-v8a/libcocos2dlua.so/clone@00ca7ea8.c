...
/* cocostudio::timeline::AlphaFrame::clone() */

Ref * __thiscall cocostudio::timeline::AlphaFrame::clone(AlphaFrame *this)

{
  ...
  *(undefined ***)this_00 = &PTR__Frame_016cbea0;
  this_00[0x58] = (Ref)0xff;
  cocos2d::Ref::autorelease(this_00);
  *(AlphaFrame *)(this_00 + 0x58) = this[0x58];
