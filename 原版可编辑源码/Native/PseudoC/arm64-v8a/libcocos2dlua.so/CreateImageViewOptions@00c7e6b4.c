...
/* flatbuffers::CreateImageViewOptions(flatbuffers::FlatBufferBuilder&,
   flatbuffers::Offset<flatbuffers::WidgetOptions>, flatbuffers::Offset<flatbuffers::ResourceData>,
   flatbuffers::CapInsets const*, flatbuffers::FlatSize const*, unsigned char) */

undefined4
flatbuffers::CreateImageViewOptions
          (FlatBufferBuilder *param_1,int param_2,int param_3,CapInsets *param_4,FlatSize *param_5,
          char param_6)

{
  ...
  FlatBufferBuilder::AddStruct<flatbuffers::FlatSize>(param_1,10,param_5);
  FlatBufferBuilder::AddStruct<flatbuffers::CapInsets>(param_1,8,param_4);
  if (param_3 != 0) {
  ...
  if ((param_6 != '\0') || (param_1[0x60] != (FlatBufferBuilder)0x0)) {
    ...
    *(char *)(lVar9 + -1) = param_6;
    ...
    if (puVar2 == *(undefined8 **)(param_1 + 0x38)) {
      ...
      *puVar2 = CONCAT26(uStack_5a,CONCAT24(0xc,local_60));
      *(undefined8 **)(param_1 + 0x30) = puVar2 + 1;
    }
  }
