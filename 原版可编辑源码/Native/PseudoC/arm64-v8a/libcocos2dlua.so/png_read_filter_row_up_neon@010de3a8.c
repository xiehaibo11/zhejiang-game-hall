...

{
  ...
  undefined8 uVar7;
                    ...
                    /* catch() { ... } // from try @ 010de2d8 with catch @ 010de3a8 */
  ...
  if (0 < lVar3) {
    ...
    do {
      uVar5 = puVar1[1];
      uVar4 = *puVar1;
                    /* try { // try from 010de3bc to 011de42b has its CatchHandler @ 010de3bc
                       catch() { ... } // from try @ 010de3bc with catch @ 010de3bc
                       catch() { ... } // from try @ 010de488 with catch @ 010de3bc */
      uVar7 = param_3[1];
      uVar6 = *param_3;
      puVar2 = puVar1 + 2;
