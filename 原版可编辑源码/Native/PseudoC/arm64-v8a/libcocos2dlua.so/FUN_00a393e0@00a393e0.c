...
undefined4 FUN_00a393e0(long *param_1,int param_2,void *param_3,ulong param_4,size_t *param_5)

{
  ...
  undefined4 local_34;
                    ...
                    /* catch() { ... } // from try @ 00a39364 with catch @ 00a393fc */
  local_34 = 0x38;
                    /* catch() { ... } // from try @ 00a3937c with catch @ 00a39400 */
  uVar4 = FUN_00a27f7c(*(undefined8 *)(*param_1 + 0x60),1);
  if ((uVar4 & 1) == 0) {
    ...
    *param_5 = 0;
    ...
    iVar2 = *(int *)param_1[0xe3];
                    /* catch() { ... } // from try @ 00a39330 with catch @ 00a39430 */
...
LAB_00a394c0:
  ...
  if (-1 < (long)sVar6) {
    if (bVar3) {
                    /* try { // try from 00a394ec to 00b3955f has its CatchHandler @ 00a394ec
                       catch() { ... } // from try @ 00a394ec with catch @ 00a394ec
                       catch() { ... } // from try @ 00a3956c with catch @ 00a394ec */
