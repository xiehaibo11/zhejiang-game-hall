...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<int,
   ...
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<int, int> >
      ...
      for (plVar7 = (long *)*plVar7; plVar7 != (long *)0x0; plVar7 = (long *)*plVar7) {
        ...
        if (uVar6 != uVar9) {
          if (uVar4 < 2) {
            ...
            if (uVar6 - uVar2 * uVar8 == unaff_x24) goto LAB_009ed514;
            break;
          }
...
LAB_009ed514:
  ...
  *(undefined4 *)((long)plVar7 + 0x14) = 0;
  ...
  if (plVar3 == (long *)0x0) {
    plVar3 = (long *)(param_1 + 4);
                    /* try { // try from 009ed618 to 00aed667 has its CatchHandler @ 009ed618
                       catch() { ... } // from try @ 009ed618 with catch @ 009ed618
                       catch() { ... } // from try @ 009ed69c with catch @ 009ed618
                       catch() { ... } // from try @ 009ed6e4 with catch @ 009ed618 */
    *plVar7 = *plVar3;
    *plVar3 = (long)plVar7;
    *(long **)(lVar5 + unaff_x24 * 8) = plVar3;
    if (*plVar7 == 0) goto LAB_009ed668;
  ...
  *plVar3 = (long)plVar7;
LAB_009ed668:
                    /* try { // try from 009ed668 to 00aed67f has its CatchHandler @ 009ed728 */
  *(long *)(param_1 + 6) = *(long *)(param_1 + 6) + 1;
                    /* try { // try from 009ed684 to 00aed69b has its CatchHandler @ 009ed724 */
  return plVar7;
}
