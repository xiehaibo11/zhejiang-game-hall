  ...
  if (param_1 == 0) {
    ...
    *(ulong *)(this + 8) = param_1;
    ...
    if (plVar15 != (long *)0x0) {
      ...
      if (uVar13 < 2) {
                    /* try { // try from 00eee020 to 00fee05f has its CatchHandler @ 00eee020
                       catch() { ... } // from try @ 00eee020 with catch @ 00eee020
                       catch() { ... } // from try @ 00eee0a4 with catch @ 00eee020 */
        ...
        do {
          ...
          if (uVar13 < 2) {
            uVar17 = uVar17 & param_1 - 1;
                    ...
                    /* try { // try from 00eee060 to 00fee06b has its CatchHandler @ 00eee184 */
            if (param_1 <= uVar17) {
              uVar4 = 0;
              if (param_1 != 0) {
                uVar4 = uVar17 / param_1;
              }
                    /* try { // try from 00eee06c to 00fee07f has its CatchHandler @ 00eee164 */
          ...
          if (uVar17 != uVar10) {
            if (*(long *)(*(long *)this + uVar17 * 8) == 0) {
              *(long **)(*(long *)this + uVar17 * 8) = plVar15;
              uVar10 = uVar17;
                    /* try { // try from 00eee1a0 to 00fee1d3 has its CatchHandler @ 00eee1a0
                       catch() { ... } // from try @ 00eee1a0 with catch @ 00eee1a0
                       catch() { ... } // from try @ 00eee20c with catch @ 00eee1a0 */
            }
            else {
              plVar11 = (long *)*plVar16;
                    /* try { // try from 00eee09c to 00fee0a3 has its CatchHandler @ 00eee12c */
              plVar14 = plVar16;
              if (plVar11 != (long *)0x0) {
                    /* try { // try from 00eee0a4 to 00fee19f has its CatchHandler @ 00eee020 */
                ...
                do {
                  ...
                  if ((bVar2 & 1) == 0) {
                    while (sVar6 != 0) {
                      if (*pcVar5 != *__s2) goto LAB_00eee168;
                      __s2 = __s2 + 1;
                    /* catch() { ... } // from try @ 00eee09c with catch @ 00eee12c */
                      sVar3 = sVar3 - 1;
                      pcVar5 = pcVar5 + 1;
                      sVar6 = sVar3;
                    }
                    ...
                    /* catch() { ... } // from try @ 00eee06c with catch @ 00eee164 */
...
LAB_00eee168:
              ...
              *plVar14 = **(long **)(*(long *)this + uVar17 * 8);
                    /* catch() { ... } // from try @ 00eee060 with catch @ 00eee184 */
