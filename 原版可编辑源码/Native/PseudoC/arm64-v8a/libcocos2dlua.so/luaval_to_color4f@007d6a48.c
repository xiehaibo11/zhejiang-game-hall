...
/* luaval_to_color4f(lua_State*, int, cocos2d::Color4F*, char const*) */

bool luaval_to_color4f(lua_State *param_1,int param_2,Color4F *param_3,char *param_4)

{
  ...
  bVar3 = false;
  if ((param_1 != (lua_State *)0x0) && (param_3 != (Color4F *)0x0)) {
