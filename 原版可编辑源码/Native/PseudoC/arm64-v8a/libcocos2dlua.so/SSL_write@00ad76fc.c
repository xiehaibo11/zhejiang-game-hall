...

{
  ...
  else if ((ssl->shutdown & 1) == 0) {
    if ((((ulong)ssl->tlsext_hostname & 0x100) == 0) ||
       (lVar4 = ASYNC_get_current_job(), lVar4 != 0)) {
                    /* WARNING: Could not recover jumptable at 0x00ad7760. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      iVar2 = (*ssl->method->ssl_shutdown)(ssl);
      return iVar2;
    }
    uStack_3c = 1;
    local_38 = ssl->method->ssl_shutdown;
