...
/* void std::__ndk1::vector<cocos2d::PUScriptToken*, std::__ndk1::allocator<cocos2d::PUScriptToken*>
   >::__push_back_slow_path<cocos2d::PUScriptToken* const&>(cocos2d::PUScriptToken* const&) */
...
__push_back_slow_path<cocos2d::PUScriptToken*const&>
          (vector<cocos2d::PUScriptToken*,std::__ndk1::allocator<cocos2d::PUScriptToken*>> *this,
          PUScriptToken **param_1)
