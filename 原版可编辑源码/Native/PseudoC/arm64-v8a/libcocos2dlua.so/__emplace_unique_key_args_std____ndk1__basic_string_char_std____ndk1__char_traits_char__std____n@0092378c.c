...
/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, cocos2d::Ref*>, void*>*, long>,
...

{
  ...
  if (p_Var5 == (__tree_node_base *)0x0) {
                    /* catch() { ... } // from try @ 00923780 with catch @ 009237d8 */
    p_Var5 = operator_new(0x40);
                    /* try { // try from 009237ec to 00a238a3 has its CatchHandler @ 009237ec
                       catch() { ... } // from try @ 009237ec with catch @ 009237ec
                       catch() { ... } // from try @ 00923924 with catch @ 009237ec */
