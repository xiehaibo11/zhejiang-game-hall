...
void FUN_0113d0d4(long param_1,short *param_2,long param_3)

{
  ...
  param_3 = param_3 >> 1;
                    /* catch() { ... } // from try @ 0113d1bc with catch @ 0113d0e4 */
  ...
  if (lVar5 != 0 && lVar3 <= param_3) {
    if (lVar3 == 3) {
      ...
      psVar2 = param_2 + 5;
      do {
                    /* try { // try from 0113d17c to 0123d18b has its CatchHandler @ 0113d200 */
        param_3 = param_3 + -3;
      ...
      uVar7 = uVar6 & 0xfffffffffffffff0;
                    /* try { // try from 0113d1ac to 0123d1bb has its CatchHandler @ 0113d1fc */
      do {
        if (lVar3 != 0) {
                    /* try { // try from 0113d1bc to 0123d213 has its CatchHandler @ 0113d0e4 */
          if (lVar3 != 1) {
            if (lVar3 != 2) {
              if (4 < lVar3) {
                psVar2 = param_2;
...
LAB_0113d228:
                  ...
                  uVar8 = uVar6 - uVar7;
                  if (uVar6 != uVar7) goto LAB_0113d228;
                }
              ...
              param_2 = param_2 + 2;
                    ...
                    /* try { // try from 0113d278 to 0123d30b has its CatchHandler @ 0113d278
                       catch() { ... } // from try @ 0113d278 with catch @ 0113d278
                       catch() { ... } // from try @ 0113d318 with catch @ 0113d278 */
            param_2[lVar3] = param_2[lVar3] + *param_2;
            param_2 = param_2 + 1;
          }
          param_2[lVar3] = param_2[lVar3] + *param_2;
