...
/* void std::__ndk1::vector<cocos2d::Layer*, std::__ndk1::allocator<cocos2d::Layer*>
   >::__push_back_slow_path<cocos2d::Layer* const&>(cocos2d::Layer* const&) */

void __thiscall
std::__ndk1::vector<cocos2d::Layer*,std::__ndk1::allocator<cocos2d::Layer*>>::
__push_back_slow_path<cocos2d::Layer*const&>
          (vector<cocos2d::Layer*,std::__ndk1::allocator<cocos2d::Layer*>> *this,Layer **param_1)
