...
/* std::__ndk1::vector<cocos2d::AnimationFrame*, std::__ndk1::allocator<cocos2d::AnimationFrame*>
   >::insert(std::__ndk1::__wrap_iter<cocos2d::AnimationFrame* const*>, cocos2d::AnimationFrame*
   const&) */

undefined8 * __thiscall
std::__ndk1::vector<cocos2d::AnimationFrame*,std::__ndk1::allocator<cocos2d::AnimationFrame*>>::
insert(vector<cocos2d::AnimationFrame*,std::__ndk1::allocator<cocos2d::AnimationFrame*>> *this,
...

{
  ...
  uVar4 = ((long)puVar10 - (long)pvVar9 >> 3) + 1;
                    /* try { // try from 00a82bf4 to 00b82bfb has its CatchHandler @ 00a82c10 */
  if (uVar4 >> 0x3d != 0) {
                    /* WARNING: Subroutine does not return */
    __vector_base_common<true>::__throw_length_error();
  }
  lVar6 = (long)*(undefined8 **)(this + 0x10) - (long)pvVar9;
                    /* try { // try from 00a82bfc to 00b82c63 has its CatchHandler @ 00a82a64 */
  if ((ulong)(lVar6 >> 3) < 0xfffffffffffffff) {
    uVar7 = lVar6 >> 2;
                    /* catch() { ... } // from try @ 00a82b04 with catch @ 00a82c10
                       catch() { ... } // from try @ 00a82bf4 with catch @ 00a82c10 */
    if (uVar4 <= uVar7) {
      uVar4 = uVar7;
    }
                    /* catch() { ... } // from try @ 00a82ae4 with catch @ 00a82c14 */
    if (uVar4 == 0) {
      pvVar1 = (void *)0x0;
      goto LAB_00a82c3c;
    }
                    /* catch() { ... } // from try @ 00a82ac8 with catch @ 00a82c18 */
    if (uVar4 >> 0x3d != 0) {
                    /* WARNING: Subroutine does not return */
...
LAB_00a82c3c:
  ...
  puVar10 = (undefined8 *)((long)pvVar1 + uVar7 * 8);
                    /* catch() { ... } // from try @ 00a82aa4 with catch @ 00a82c48 */
  ...
  puVar8 = puVar10 + 1;
                    /* try { // try from 00a82ce4 to 00b82d2f has its CatchHandler @ 00a82ce4
                       catch() { ... } // from try @ 00a82ce4 with catch @ 00a82ce4
                       catch() { ... } // from try @ 00a82d34 with catch @ 00a82ce4 */
  *puVar10 = *param_3;
  if (0 < (long)sVar3) {
  ...
  *(void **)(this + 0x10) = pvVar2;
  if (pvVar9 != (void *)0x0) {
                    /* try { // try from 00a82d30 to 00b82d33 has its CatchHandler @ 00a82d68 */
