...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::Controller::_keyStatus>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::Controller::_keyStatus>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::Controller::_keyStatus>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::Controller::_keyStatus>>>
           *this,ulong param_1)
    ...
    if (plVar5 != (long *)0x0) {
      ...
      *(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::Controller::_keyStatus>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::Controller::_keyStatus>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::Controller::_keyStatus>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::Controller::_keyStatus>>>
      ...
      if ((long *)*plVar5 != (long *)0x0) {
                    /* try { // try from 00fa869c to 010a86d7 has its CatchHandler @ 00fa869c
                       catch() { ... } // from try @ 00fa869c with catch @ 00fa869c
                       catch() { ... } // from try @ 00fa86fc with catch @ 00fa869c */
        plVar6 = (long *)*plVar5;
        do {
          uVar7 = plVar6[1];
          if ((uVar12 & 0xffffffff) < 2) {
                    /* try { // try from 00fa86d8 to 010a86df has its CatchHandler @ 00fa8860 */
          ...
          if (uVar7 != uVar4) {
            ...
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) {
              *(long **)(*(long *)this + uVar7 * 8) = plVar5;
              ...
              do {
                    /* try { // try from 00fa86f4 to 010a86fb has its CatchHandler @ 00fa8834 */
                plVar8 = plVar9;
                plVar9 = (long *)*plVar8;
                    /* try { // try from 00fa86fc to 010a8877 has its CatchHandler @ 00fa869c */
