...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::EventDispatcher::EventListenerVector*> > >::rehash(unsigned long) */
...

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00fa3db0;
    }
                    /* try { // try from 00fa3dc4 to 010a3f27 has its CatchHandler @ 00fa3dc4
                       catch() { ... } // from try @ 00fa3dc4 with catch @ 00fa3dc4
                       catch() { ... } // from try @ 00fa3fb0 with catch @ 00fa3dc4
                       catch() { ... } // from try @ 00fa4060 with catch @ 00fa3dc4 */
    return;
  }
LAB_00fa3db0:
