...

{
  ...
  lVar5 = tpidr_el0;
                    /* try { // try from 00fdc2b0 to 010dc2b7 has its CatchHandler @ 00fdc370 */
  local_68 = *(long *)(lVar5 + 0x28);
                    /* try { // try from 00fdc2b8 to 010dc38b has its CatchHandler @ 00fdc280 */
  ...
  if (uVar16 != 0) {
    ...
    if ((puVar9 != (undefined8 *)0x0) && (plVar15 = (long *)*puVar9, plVar15 != (long *)0x0)) {
      ...
      do {
                    /* catch() { ... } // from try @ 00fdc2b0 with catch @ 00fdc370 */
        uVar10 = plVar15[1];
        if (uVar10 != uVar7) {
          if (uVar13 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00fdc3b0;
            break;
          }
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00fdc420;
              }
              goto LAB_00fdc368;
            }
          }
  ...
  *plVar15 = 0;
  ...
  if ((uVar16 == 0) ||
    ...
    __s1 = (void *)rehash((__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::VertexAttribValue>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::VertexAttribValue>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::VertexAttribValue>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::VertexAttribValue>>>
                           *)param_1,uVar13);
    uVar16 = *(ulong *)(param_1 + 8);
                    /* try { // try from 00fdc4b8 to 010dc557 has its CatchHandler @ 00fdc4b8
                       catch() { ... } // from try @ 00fdc4b8 with catch @ 00fdc4b8
                       catch() { ... } // from try @ 00fdc560 with catch @ 00fdc4b8 */
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar12;
    if (*plVar15 == 0) goto LAB_00fdc54c;
...
LAB_00fdc54c:
  uVar8 = 1;
                    /* try { // try from 00fdc558 to 010dc55f has its CatchHandler @ 00fdc5a8 */
  *(long *)(param_1 + 0x18) = *(long *)(param_1 + 0x18) + 1;
LAB_00fdc55c:
                    /* try { // try from 00fdc560 to 010dc5c3 has its CatchHandler @ 00fdc4b8 */
