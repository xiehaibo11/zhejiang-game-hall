...
/* cocos2d::Map<int, cocos2d::Node*>::erase(int const&) */

void __thiscall cocos2d::Map<int,cocos2d::Node*>::erase(Map<int,cocos2d::Node*> *this,int *param_1)
  ...
  if (uVar5 != 0) {
    ...
    if ((plVar8 != (long *)0x0) && (plVar8 = (long *)*plVar8, plVar8 != (long *)0x0)) {
      do {
        ...
        plVar8 = (long *)*plVar8;
                    /* catch() { ... } // from try @ 00e0b424 with catch @ 00e0b4f4 */
