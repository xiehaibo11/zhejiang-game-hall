...
{
  return &__bind<bool(cocos2d::extension::Control::*)(cocos2d::Touch*,cocos2d::Event*),cocos2d::extension::Control*,std::__ndk1::placeholders::__ph<1>const&,std::__ndk1::placeholders::__ph<2>const&>
          ::typeinfo;
}
