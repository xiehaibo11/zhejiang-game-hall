...

{
  ...
  if (param_1 - 1 == 0) {
    ...
    param_1 = __next_prime(param_1);
                    ...
                    /* try { // try from 00e43c9c to 00f43cc3 has its CatchHandler @ 00e43e94 */
  uVar2 = *(ulong *)(this + 8);
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      uVar1 = (ulong)((float)*(ulong *)(this + 0x18) / *(float *)(this + 0x20));
                    /* try { // try from 00e43cdc to 00f43d6b has its CatchHandler @ 00e43e90 */
      if ((uVar2 < 3) ||
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00e43d24;
    }
    return;
  }
LAB_00e43d24:
