...
/* tolua_cocos2d_DrawPrimitives_drawCardinalSpline00(lua_State*) */

undefined8 tolua_cocos2d_DrawPrimitives_drawCardinalSpline00(lua_State *param_1)

{
  ...
  if ((((iVar2 == 0) || (iVar2 = tolua_isnumber(param_1,2,0,auStack_58), iVar2 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'drawCardinalSpline\'.",auStack_58);
  }
  else {
    local_5c = 0;
    local_68 = (Vec2 *)0x0;
    ...
    if ((uVar3 & 1) != 0) {
      ...
      if (this == (PointArray *)0x0) {
        ...
        cocos2d::DrawPrimitives::drawCardinalSpline(this,(float)dVar6,(int)dVar7);
      }
    }
  }
