...
/* void std::__ndk1::vector<cocos2d::TMXObjectGroup*,
   std::__ndk1::allocator<cocos2d::TMXObjectGroup*>
   >::__push_back_slow_path<cocos2d::TMXObjectGroup* const&>(cocos2d::TMXObjectGroup* const&) */
