...
undefined8 FUN_0113e88c(long param_1,byte *param_2,long param_3)
        ...
        if ((*(uint *)(param_1 + 0x58) != 0) && (0 < lVar14)) {
          ...
          do {
            ...
            if (bVar12 == 1) {
              uVar8 = bVar13 >> 4 & 3;
              if (uVar8 != 2) {
                uVar7 = *(int *)(&DAT_0149853c + (ulong)uVar8 * 4) + uVar7 & 0xf;
                if ((uVar15 & 1) == 0) {
                  bVar12 = (byte)(uVar7 << 4);
                }
                else {
                ...
                *pbVar5 = bVar12;
                    /* try { // try from 0113eac0 to 0123eaf3 has its CatchHandler @ 0113eac0
                       catch() { ... } // from try @ 0113eac0 with catch @ 0113eac0
                       catch() { ... } // from try @ 0113eb94 with catch @ 0113eac0 */
                uVar15 = uVar15 + 1;
              }
              uVar8 = bVar13 >> 2 & 3;
              if ((uVar8 != 2) &&
                ...
                if ((uVar15 & 1) == 0) {
                    /* try { // try from 0113eaf4 to 0123eaff has its CatchHandler @ 0113eba8 */
                  *pbVar6 = (byte)(uVar7 << 4);
                  uVar15 = uVar15 + 1;
                }
                else {
              ...
              if ((uVar17 & 3) != 2) {
                iVar11 = *(int *)(&DAT_0149853c + (ulong)(uVar17 & 3) * 4);
LAB_0113eb38:
                uVar7 = iVar11 + uVar7 & 0xf;
                if ((long)uVar15 < (long)uVar16) {
                    /* try { // try from 0113eb48 to 0123eb93 has its CatchHandler @ 0113ebac */
                  if ((uVar15 & 1) == 0) {
                    *pbVar6 = (byte)(uVar7 << 4);
                    uVar15 = uVar15 + 1;
                  }
              ...
              uVar8 = bVar13 >> 3 & 7;
              if (uVar8 != 4) {
                uVar7 = *(int *)(&DAT_0149854c + (ulong)uVar8 * 4) + uVar7 & 0xf;
                if ((uVar15 & 1) == 0) {
                  bVar13 = (byte)(uVar7 << 4);
                }
                else {
              ...
              if ((uVar17 & 7) != 4) {
                iVar11 = *(int *)(&DAT_0149854c + (ulong)(uVar17 & 7) * 4);
                goto LAB_0113eb38;
              }
            }
            else if (bVar12 == 3) {
        ...
        *(long *)(param_1 + 0x390) = lVar14;
        if (uVar15 != uVar16) {
          ...
          goto LAB_0113e8d8;
                    ...
                    /* try { // try from 0113eb94 to 0123ebc7 has its CatchHandler @ 0113eac0 */
        param_3 = param_3 - *(long *)(param_1 + 0x358);
        param_2 = param_2 + *(long *)(param_1 + 0x358);
      } while (0 < param_3);
    }
                    /* catch() { ... } // from try @ 0113eaf4 with catch @ 0113eba8 */
    uVar4 = 1;
  }
  else {
...
LAB_0113e8d8:
    uVar4 = 0;
                    ...
                    /* catch() { ... } // from try @ 0113eb48 with catch @ 0113ebac */
  return uVar4;
}
