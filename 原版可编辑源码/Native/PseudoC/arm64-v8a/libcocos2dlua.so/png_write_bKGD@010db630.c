...

{
  ...
  long local_38;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010db684 with catch @ 010db634
                        */
  lVar3 = tpidr_el0;
  ...
  if (param_3 == 3) {
    if ((*(ushort *)(param_1 + 0x2a0) == 0) && ((*(byte *)(param_1 + 0x450) & 1) != 0)) {
      ...
      bVar6 = *param_2;
                    /* try { // try from 010db678 to 011db683 has its CatchHandler @ 010db7b4 */
      if (*(ushort *)(param_1 + 0x2a0) <= (ushort)bVar6) {
                    /* try { // try from 010db684 to 011db7b7 has its CatchHandler @ 010db634 */
    ...
    *(undefined4 *)(param_1 + 0x4e4) = 0x82;
    ...
    if ((param_3 >> 1 & 1) == 0) {
      ...
      if ((*(char *)(param_1 + 0x2b0) != '\b') ||
        ...
        *(undefined4 *)(param_1 + 0x250) = 0x624b4744;
        png_reset_crc(param_1);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010db678 with catch @ 010db7b4
                        */
        png_calculate_crc(param_1,(long)&local_40 + 4,4);
        *(undefined4 *)(param_1 + 0x4e4) = 0x42;
