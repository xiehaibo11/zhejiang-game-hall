...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   fairygui::GearColor::GearColorValue>, void*>*>, bool>
      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if (uVar13 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00ab1374;
            break;
          }
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00ab13e4;
              }
              goto LAB_00ab132c;
            }
          }
...
LAB_00ab132c:
  ...
  cocos2d::Color3B::Color3B((Color3B *)(plVar15 + 5));
  __s1 = (void *)cocos2d::Color3B::Color3B((Color3B *)((long)plVar15 + 0x2b));
  *plVar15 = 0;
  plVar15[1] = uVar7;
  if ((uVar16 == 0) ||
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar12;
    if (*plVar15 == 0) goto LAB_00ab150c;
...
LAB_00ab150c:
  uVar8 = 1;
                    /* try { // try from 00ab1514 to 00bb1553 has its CatchHandler @ 00ab1514
                       catch() { ... } // from try @ 00ab1514 with catch @ 00ab1514
                       catch() { ... } // from try @ 00ab15bc with catch @ 00ab1514
                       catch() { ... } // from try @ 00ab164c with catch @ 00ab1514 */
