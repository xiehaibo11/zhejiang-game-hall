...
/* cocos2d::Animate3D::getKeyFrameUserInfo(int) const */

long * __thiscall cocos2d::Animate3D::getKeyFrameUserInfo(Animate3D *this,int param_1)

{
  ...
  if (uVar2 != 0) {
    ...
    plVar5 = *(long **)(*(long *)(this + 0xf0) + uVar4 * 8);
