...

{
  ...
  if (((param_4 & 0x18) == 0) || ((param_3 == 1 && ((param_4 & 0x18) == 0x18)))) goto LAB_007decb4;
  if (uVar4 == 0) {
    lVar6 = 0;
joined_r0x007dece8:
    if (param_3 == 0) goto LAB_007decdc;
LAB_007decec:
    lVar7 = lVar6;
    if (param_3 != 2) {
      if (param_3 != 1) goto LAB_007decb4;
      if ((param_4 >> 3 & 1) == 0) {
    ...
    if (((byte)this[0x40] & 1) != 0) {
      ...
      goto joined_r0x007dece8;
    }
    lVar6 = uVar4 - (long)(this + 0x41);
    if (param_3 != 0) goto LAB_007decec;
LAB_007decdc:
    lVar7 = 0;
  }
  uVar1 = lVar7 + param_1;
  ...
  if ((-1 < (long)uVar1) && ((long)uVar1 <= lVar6)) {
    if ((uVar1 != 0) &&
       ((((param_4 >> 3 & 1) != 0 && (*(long *)(this + 0x18) == 0)) ||
