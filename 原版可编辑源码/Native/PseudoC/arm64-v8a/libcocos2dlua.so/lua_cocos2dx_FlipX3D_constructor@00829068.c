...
/* lua_cocos2dx_FlipX3D_constructor(lua_State*) */

bool lua_cocos2dx_FlipX3D_constructor(lua_State *param_1)
  ...
  if (iVar1 == 0) {
    ...
    *(undefined ***)(this + 0x28) = &PTR_clone_016f78a0;
    ...
    toluafix_pushusertype_ccobject
              (param_1,*(int *)(this + 0xc),(int *)(this + 0x10),this,"cc.FlipX3D");
  }
  else {
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "cc.FlipX3D:FlipX3D",iVar1,0);
  }
  return iVar1 == 0;
}
