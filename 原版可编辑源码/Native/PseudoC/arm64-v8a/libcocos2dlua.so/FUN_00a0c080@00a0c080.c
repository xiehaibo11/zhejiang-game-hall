...
void FUN_00a0c080(ulong *param_1,undefined8 *param_2)

{
  ...
  puVar7 = (undefined8 *)param_1[2];
                    /* try { // try from 00a0c0a0 to 00b0c0f7 has its CatchHandler @ 00a0c224 */
  if (puVar7 == (undefined8 *)param_1[3]) {
    puVar6 = (undefined8 *)*param_1;
    __src = (undefined8 *)param_1[1];
    if (__src < puVar6 || (long)__src - (long)puVar6 == 0) {
                    /* try { // try from 00a0c104 to 00b0c17f has its CatchHandler @ 00a0c228 */
      ...
      if (uVar5 >> 0x3d != 0) {
                    /* try { // try from 00a0c1b4 to 00b0c1c7 has its CatchHandler @ 00a0c224 */
      ...
      *param_1 = (ulong)pvVar3;
      ...
      if (puVar6 != (undefined8 *)0x0) {
                    /* try { // try from 00a0c180 to 00b0c1b3 has its CatchHandler @ 00a0c048 */
