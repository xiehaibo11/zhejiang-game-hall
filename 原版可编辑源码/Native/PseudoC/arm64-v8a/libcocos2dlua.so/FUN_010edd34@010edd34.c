...
void FUN_010edd34(long param_1)
  ...
  *(uint *)(lVar14 + 0x38) = (uint)(iVar5 == 1);
  ...
  if (iVar5 != 1) {
    uVar6 = 0x100;
                    ...
                    /* try { // try from 010edd74 to 011eddc3 has its CatchHandler @ 010eddd4 */
    ...
    if (iVar5 == 1) {
      ...
      while( true ) {
        ...
        *(long *)(lVar4 + lVar8) = *(long *)(lVar4 + lVar8) + 0xff;
        ...
        puVar9 = *(undefined1 **)(*(long *)(lVar14 + 0x30) + lVar8);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010edd74 with catch @ 010eddd4
                        */
      ...
      while( true ) {
        ...
        lVar13 = (long)((int)lVar8 << 1);
                    /* try { // try from 010edeac to 011edeb3 has its CatchHandler @ 010edf30 */
        lVar12 = 0;
        if (lVar13 != 0) {
          lVar12 = ((long)iVar2 + 0xfe) / lVar13;
        }
        do {
                    /* try { // try from 010edeb4 to 011edf4b has its CatchHandler @ 010ede7c */
          if ((int)lVar12 < lVar4) {
            uVar1 = iVar10 * 2 + 3;
            do {
              lVar12 = 0;
        ...
        lVar7 = lVar7 + 1;
                    /* catch() { ... } // from try @ 010edeb4 with catch @ 010ede7c */
        if (*(int *)(param_1 + 0x90) <= lVar7) break;
        lVar4 = *(long *)(lVar14 + 0x30);
        iVar5 = iVar3;
      }
