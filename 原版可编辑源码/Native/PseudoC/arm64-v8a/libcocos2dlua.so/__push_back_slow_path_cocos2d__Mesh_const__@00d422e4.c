...
/* void std::__ndk1::vector<cocos2d::Mesh*, std::__ndk1::allocator<cocos2d::Mesh*>
   >::__push_back_slow_path<cocos2d::Mesh* const&>(cocos2d::Mesh* const&) */

void __thiscall
std::__ndk1::vector<cocos2d::Mesh*,std::__ndk1::allocator<cocos2d::Mesh*>>::
__push_back_slow_path<cocos2d::Mesh*const&>
          (vector<cocos2d::Mesh*,std::__ndk1::allocator<cocos2d::Mesh*>> *this,Mesh **param_1)

{
  ...
  if (uVar3 >> 0x3d != 0) {
    ...
    __vector_base_common<true>::__throw_length_error();
                    ...
                    /* catch() { ... } // from try @ 00d422c8 with catch @ 00d42320 */
