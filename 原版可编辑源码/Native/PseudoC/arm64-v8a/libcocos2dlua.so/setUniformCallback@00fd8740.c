...
/* cocos2d::GLProgramState::setUniformCallback(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, std::__ndk1::function<void
   (cocos2d::GLProgram*, cocos2d::Uniform*)> const&) */

void __thiscall
cocos2d::GLProgramState::setUniformCallback
          (GLProgramState *this,basic_string *param_1,function *param_2)

{
  ...
  long local_38;
                    ...
                    /* try { // try from 00fd8740 to 010d878f has its CatchHandler @ 00fd8714 */
  lVar1 = tpidr_el0;
  local_38 = *(long *)(lVar1 + 0x28);
  updateUniformsAndAttributes(this);
                    /* catch() { ... } // from try @ 00fd8738 with catch @ 00fd8774 */
  lVar2 = std::__ndk1::
  ...
  if (lVar2 != 0) {
    local_40 = (piecewise_construct_t *)(lVar2 + 0x28);
                    /* catch() { ... } // from try @ 00fd87bc with catch @ 00fd8790 */
    lVar2 = std::__ndk1::
    ...
    UniformValue::setCallback((UniformValue *)(lVar2 + 0x18),param_2);
  }
                    /* try { // try from 00fd87b4 to 010d87bb has its CatchHandler @ 00fd87f0 */
  if (*(long *)(lVar1 + 0x28) == local_38) {
                    /* try { // try from 00fd87bc to 010d880b has its CatchHandler @ 00fd8790 */
    return;
  }
