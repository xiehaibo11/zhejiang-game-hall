...
/* void std::__ndk1::vector<p2t::Node*, std::__ndk1::allocator<p2t::Node*>
   >::__push_back_slow_path<p2t::Node* const&>(p2t::Node* const&) */

void __thiscall
std::__ndk1::vector<p2t::Node*,std::__ndk1::allocator<p2t::Node*>>::
__push_back_slow_path<p2t::Node*const&>
          (vector<p2t::Node*,std::__ndk1::allocator<p2t::Node*>> *this,Node **param_1)
