...

{
  ...
  if ((iVar1 == 0) ||
     ((((local_a0 = 0, iStack_9c = iVar1, DAT_01785190 == 0 ||
        (iVar1 = OPENSSL_sk_find(DAT_01785190,&local_a0), iVar1 == -1)) ||
       (pvVar2 = (void *)OPENSSL_sk_value(DAT_01785190,iVar1), pvVar2 == (void *)0x0)) &&
      (pvVar2 = OBJ_bsearch_(&local_a0,&DAT_016c6708,0x19,0x18,(cmp *)&LAB_00bdafcc),
      pvVar2 == (void *)0x0)))) {
...
LAB_00bdabd4:
    ...
    if (passlen == -1) {
      uVar7 = strlen(pass);
      goto joined_r0x00bdabd0;
    }
    if (iVar1 == -1) goto LAB_00bdabd4;
LAB_00bdab1c:
