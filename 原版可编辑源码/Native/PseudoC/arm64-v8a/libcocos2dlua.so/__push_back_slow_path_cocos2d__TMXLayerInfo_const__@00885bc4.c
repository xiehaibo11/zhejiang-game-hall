...
/* void std::__ndk1::vector<cocos2d::TMXLayerInfo*, std::__ndk1::allocator<cocos2d::TMXLayerInfo*>
   >::__push_back_slow_path<cocos2d::TMXLayerInfo* const&>(cocos2d::TMXLayerInfo* const&) */
