...
void FUN_0100cc30(undefined8 param_1,undefined8 *param_2)

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"cocos2d-x assert","%s function:%s line:%d",
                        ...
                        "queryRectCallbackFunc",0x9e);
  }
  if (cocos2d::PhysicsWorldCallback::continues != 0) {
    local_40 = param_2[8];
    plVar4 = (long *)param_2[6];
                    /* try { // try from 0100ccac to 0110ccb3 has its CatchHandler @ 0100cd30 */
    if (plVar4 == (long *)0x0) {
    ...
    cocos2d::PhysicsWorldCallback::continues = bVar2 & 1;
                    ...
                    /* try { // try from 0100cccc to 0110cceb has its CatchHandler @ 0100cd58 */
  if (*(long *)(lVar1 + 0x28) == local_38) {
                    /* try { // try from 0100ccec to 0110cd73 has its CatchHandler @ 0100cad8 */
    return;
  }
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail();
