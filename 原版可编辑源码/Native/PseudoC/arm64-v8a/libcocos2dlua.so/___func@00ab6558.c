...
::~__func(__func<std::__ndk1::__bind<void(fairygui::GearXY::*)(),fairygui::GearXY*>,std::__ndk1::allocator<std::__ndk1::__bind<void(fairygui::GearXY::*)(),fairygui::GearXY*>>,void()>
          *this)
