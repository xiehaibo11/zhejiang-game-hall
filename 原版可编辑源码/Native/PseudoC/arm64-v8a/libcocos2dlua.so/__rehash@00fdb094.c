...

{
  ...
  if (param_1 == 0) {
    ...
    *(ulong *)(this + 8) = param_1;
    do {
                    /* catch() { ... } // from try @ 00fdb078 with catch @ 00fdb0f0 */
        ...
        do {
          ...
          if (uVar13 < 2) {
            ...
            uVar17 = uVar17 - uVar4 * param_1;
                    /* catch() { ... } // from try @ 00fdb1e0 with catch @ 00fdb1a8 */
          }
          if (uVar17 != uVar10) {
            if (*(long *)(*(long *)this + uVar17 * 8) == 0) {
              *(long **)(*(long *)this + uVar17 * 8) = plVar15;
              ...
              plVar14 = plVar16;
              if (plVar11 != (long *)0x0) {
                    /* try { // try from 00fdb1d8 to 010db1df has its CatchHandler @ 00fdb258 */
                bVar2 = *(byte *)(plVar16 + 2);
                    /* try { // try from 00fdb1e0 to 010db273 has its CatchHandler @ 00fdb1a8 */
                __n = (ulong)(bVar2 >> 1);
                if ((bVar2 & 1) != 0) {
                  __n = plVar16[3];
                }
                do {
                  ...
                  if ((bVar2 & 1) == 0) {
                    while (sVar6 != 0) {
                    /* catch() { ... } // from try @ 00fdb1d8 with catch @ 00fdb258 */
                      if (*pcVar5 != *__s2) goto LAB_00fdb29c;
                      __s2 = __s2 + 1;
                      sVar3 = sVar3 - 1;
                      pcVar5 = pcVar5 + 1;
                      sVar6 = sVar3;
