...
undefined8 FUN_008c0b58(undefined8 param_1)

{
  ...
  if (((iVar2 == 0) || (iVar2 = tolua_isnumber(param_1,2,0,auStack_48), iVar2 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glDepthRangef\'.",auStack_48);
  }
  else {
    dVar3 = (double)tolua_tonumber(0,param_1,1);
    dVar4 = (double)tolua_tonumber(0,param_1,2);
    glDepthRangef((float)(int)dVar3,(float)(int)dVar4);
  }
