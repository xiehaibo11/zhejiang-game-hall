...

{
  ...
  if (*(long *)(this + 0x58) == 0) {
    ...
    if (*(uint *)(this + 0xd0) != 0) {
      if (uVar10 < 2) {
        uVar10 = 1;
                    ...
                    /* try { // try from 00d7a540 to 00e7a54f has its CatchHandler @ 00d7b9dc */
    ...
    lVar8 = *(long *)(this + 0x88);
                    /* try { // try from 00d7a3b8 to 00e7a3bf has its CatchHandler @ 00d7b900 */
    uVar1 = *(int *)(this + 0x24) + *(int *)(*(long *)(this + 0x50) + 0x14);
                    /* try { // try from 00d7a3c0 to 00e7a3cb has its CatchHandler @ 00d7b930 */
    uVar5 = uVar1 + uVar4 * *(int *)(this + 0x30);
    if (*(int *)(this + 0x1c) == 2) {
      if (uVar4 != 0) {
        puVar12 = *(undefined8 **)(this + 0xd8);
        puVar14 = *(undefined8 **)(this + 0xf0);
                    /* try { // try from 00d7a3e0 to 00e7a3ef has its CatchHandler @ 00d7b9ec */
        if (*(int *)(this + 0x30) != *(int *)(this + 0x28) + -1) {
          uVar1 = uVar5 + uVar4;
        }
        uVar19 = (ulong)uVar1;
        uVar16 = (ulong)uVar5;
                    /* try { // try from 00d7a3f0 to 00e7a3ff has its CatchHandler @ 00d7b974 */
        uVar20 = 0;
        if (3 < uVar4) {
          ...
          puVar3 = (undefined8 *)(lVar8 + uVar19 * 4);
                    /* try { // try from 00d7a48c to 00e7a493 has its CatchHandler @ 00d7b964 */
          if ((((puVar6 <= puVar12 || puVar7 <= puVar14) &&
            ...
            do {
              ...
              *puVar7 = CONCAT44(fVar27,fVar26);
                    /* try { // try from 00d7a4cc to 00e7a50b has its CatchHandler @ 00d7b9dc */
        ...
        do {
          ...
          *pfVar13 = fVar23 * fVar27;
                    /* try { // try from 00d7a518 to 00e7a51f has its CatchHandler @ 00d7b8fc */
      ...
      uVar19 = *(ulong *)(this + 0xd8);
                    /* try { // try from 00d7a550 to 00e7a55f has its CatchHandler @ 00d7b960 */
      uVar16 = (ulong)uVar5;
      if ((uVar4 < 8) ||
