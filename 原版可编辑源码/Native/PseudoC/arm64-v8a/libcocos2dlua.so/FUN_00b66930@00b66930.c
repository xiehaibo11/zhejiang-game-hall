...
undefined8 FUN_00b66930(long param_1,char *param_2,undefined4 param_3)
      ...
      if (__n != 0) {
        ...
        if (iVar4 <= iVar3) {
          ...
          *(undefined4 *)(ptr + 1) = param_3;
          lVar7 = OPENSSL_sk_new(&LAB_00b66b50);
          ptr[2] = lVar7;
...
LAB_00b66afc:
            CRYPTO_free(ptr_00);
            OPENSSL_sk_pop_free(ptr[2],&LAB_00b66920);
            CRYPTO_free(ptr);
            return 0;
          }
