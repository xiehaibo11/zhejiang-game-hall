...
/* cocostudio::timeline::SkeletonNode::getBoneNode(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

undefined8 __thiscall
cocostudio::timeline::SkeletonNode::getBoneNode(SkeletonNode *this,basic_string *param_1)
