...
void cocos2d::JniHelper::callStaticVoidMethod<char_const*>
               (basic_string *param_1,basic_string *param_2,char *param_3)

{
  ...
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string<decltype(nullptr)>(local_b8,"Ljava/lang/String;");
  ...
  *puVar7 = 0;
  ...
  if ((uVar8 & 1) == 0) {
    ...
    _JNIEnv::CallStaticVoidMethod(p_Var5,p_Var6,local_78,uVar9);
