...
/* void std::__ndk1::vector<cocostudio::ContourData*,
   std::__ndk1::allocator<cocostudio::ContourData*>
   >::__push_back_slow_path<cocostudio::ContourData* const&>(cocostudio::ContourData* const&) */
...
__push_back_slow_path<cocostudio::ContourData*const&>
          (vector<cocostudio::ContourData*,std::__ndk1::allocator<cocostudio::ContourData*>> *this,
          ContourData **param_1)
