...

{
  ...
  double dVar4;
                    ...
                    /* try { // try from 010be594 to 011be5ab has its CatchHandler @ 010be7d4 */
  ...
  if (-1 < (short)uVar3) {
    if (param_3 < 4) {
      if (((uVar3 >> 2 & 1) == 0) || (*(ushort *)(param_2 + 0x12) == param_3)) {
        ...
        if (((uVar3 >> 1 & 1) != 0) &&
           (iVar1 = FUN_010be9b8(&DAT_014733f4,param_2 + 1,100), iVar1 == 0)) {
          png_chunk_report(param_1,"cHRM chunk does not match sRGB",2);
          uVar3 = *(ushort *)((long)param_2 + 0x4a);
        }
                    /* try { // try from 010be648 to 011be64b has its CatchHandler @ 010be770 */
                    /* try { // try from 010be688 to 011be69f has its CatchHandler @ 010be7d0 */
        if (((uVar3 & 1) != 0) &&
           ((((*param_2 == 0 ||
              ...
              2147483647.0 < dVar4)) || (dVar4 < -2147483648.0)) || (10000 < (int)dVar4 - 95000U))))
        {
          ...
          uVar3 = *(ushort *)((long)param_2 + 0x4a);
                    ...
                    /* try { // try from 010be6b0 to 011be6bb has its CatchHandler @ 010be7bc */
        *param_2 = 0xb18f;
        param_2[7] = 0x7a26;
        param_2[8] = 0x8084;
        param_2[5] = 15000;
      ...
      pcVar2 = "inconsistent rendering intents";
                    ...
                    /* try { // try from 010be5bc to 011be5c7 has its CatchHandler @ 010be784 */
      pcVar2 = "invalid sRGB rendering intent";
    }
    FUN_010be73c(param_1,param_2,"sRGB",param_3,pcVar2);
  }
  return 0;
}
