...
void __thiscall btDbvtNodeEnumerator::Process(btDbvtNodeEnumerator *this,btDbvtNode *param_1)

{
    ...
    if (iVar3 < (int)uVar1) {
      ...
      if (0 < iVar3) {
        ...
        do {
          lVar5 = lVar4 * 8;
          lVar4 = lVar4 + 1;
          *(undefined8 *)(lVar2 + lVar5) = *(undefined8 *)(*(long *)(this + 0x18) + lVar5);
        } while (iVar3 != lVar4);
      }
  ...
  *(btDbvtNode **)(*(long *)(this + 0x18) + (long)iVar3 * 8) = param_1;
