...
/* void ccvector_to_luaval<cocos2d::ui::Widget*>(lua_State*, cocos2d::Vector<cocos2d::ui::Widget*>
   const&) */

void ccvector_to_luaval<cocos2d::ui::Widget*>(lua_State *param_1,Vector *param_2)
