...
/* lua_cocos2dx_spine_SkeletonAnimation_setStartListener(lua_State*) */

void lua_cocos2dx_spine_SkeletonAnimation_setStartListener(lua_State *param_1)

{
  ...
  if (iVar2 + -1 != 1) {
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "sp.SkeletonAnimation:setStartListener",iVar2 + -1,1);
    uVar3 = 0;
    goto LAB_00952c20;
  }
  local_50 = (long *)0x0;
