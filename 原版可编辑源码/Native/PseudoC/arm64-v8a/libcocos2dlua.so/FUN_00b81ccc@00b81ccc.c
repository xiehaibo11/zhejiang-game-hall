...
undefined8 FUN_00b81ccc(CONF_VALUE *param_1,long *param_2,ASN1_INTEGER **param_3,long *param_4)
  ...
  if (iVar3 == 0) {
    if (*param_2 == 0) {
      ...
      *param_2 = (long)pAVar4;
      ...
      iVar3 = 0x9b;
      iVar7 = 0x5a;
                    /* try { // try from 00b81d68 to 00c81e27 has its CatchHandler @ 00b81d68
                       catch(type#1 @ 00000000) { ... } // from try @ 00b81d68 with catch @ 00b81d68
                       catch(type#1 @ 00000000) { ... } // from try @ 00b81ef4 with catch @ 00b81d68
                        */
    }
LAB_00b81f40:
    ERR_put_error(0x22,0x96,iVar3,"crypto/x509v3/v3_pci.c",iVar7);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b81e28 with catch @ 00b81f4c
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b81e40 with catch @ 00b81f50
                        */
    ERR_add_error_data(6,"section:",param_1->section,",name:",param_1->name,",value:",param_1->value
                      );
    return 0;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b81ef0 with catch @ 00b81f6c
                        */
  }
  ...
  if (iVar3 == 0) {
    ...
    if (pvVar6 == (void *)0x0) goto LAB_00b82204;
    ...
    if (pvVar5 != (void *)0x0) {
      *(void **)(*param_4 + 8) = pvVar5;
      ...
      iVar3 = (int)local_58 + *piVar8;
                    /* try { // try from 00b81ef0 to 00c81ef3 has its CatchHandler @ 00b81f6c */
      *piVar8 = iVar3;
                    /* try { // try from 00b81ef4 to 00c81f7f has its CatchHandler @ 00b81d68 */
...
LAB_00b821fc:
    ...
    *puVar9 = 0;
                    ...
                    /* try { // try from 00b81e28 to 00c81e2f has its CatchHandler @ 00b81f4c */
    ...
    if (iVar3 == 0) {
      ...
      if (b == (BIO *)0x0) {
        ...
        do {
          while (iVar3 = BIO_read(b,auStack_858,0x800), 0 < iVar3) {
            ...
            if (pvVar6 == (void *)0x0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b82144 with catch @ 00b82110
                        */
              CRYPTO_free(*(void **)(*param_4 + 8));
              *(undefined8 *)(*param_4 + 8) = 0;
              *(undefined4 *)*param_4 = 0;
              ERR_put_error(0x22,0x96,0x41,"crypto/x509v3/v3_pci.c",0xb2);
                    /* try { // try from 00b82140 to 00c82143 has its CatchHandler @ 00b82180 */
                    /* try { // try from 00b82144 to 00c8219b has its CatchHandler @ 00b82110 */
              ERR_add_error_data(6,"section:",param_1->section,",name:",param_1->name,",value:",
                                 param_1->value);
              BIO_free_all(b);
              goto joined_r0x00b8216c;
            }
          ...
          if (iVar3 != 0) {
            BIO_free_all(b);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b82140 with catch @ 00b82180
                        */
            iVar7 = 0x20;
            iVar3 = 0xc0;
            goto LAB_00b82200;
        ...
        if (pvVar6 != (void *)0x0) {
          return 1;
                    ...
                    /* try { // try from 00b8224c to 00c82253 has its CatchHandler @ 00b82534 */
        iVar7 = 0x41;
        iVar3 = 0xe1;
      }
    }
    else {
                    /* try { // try from 00b81e40 to 00c81e43 has its CatchHandler @ 00b81f50 */
      ...
      if (iVar3 == 0) {
        ...
        *(undefined8 *)(*param_4 + 8) = 0;
        puVar9 = (undefined4 *)*param_4;
        iVar3 = 0xd6;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b824e0 with catch @ 00b821f8
                       catch(type#1 @ 00000000) { ... } // from try @ 00b8250c with catch @ 00b821f8
                        */
        goto LAB_00b821fc;
      }
      iVar7 = 0x98;
