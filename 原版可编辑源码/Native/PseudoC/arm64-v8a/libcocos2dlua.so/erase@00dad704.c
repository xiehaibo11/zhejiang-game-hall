...
/* cocos2d::Map<int, cocos2d::ui::LayoutParameter*>::erase(int const&) */

void __thiscall
cocos2d::Map<int,cocos2d::ui::LayoutParameter*>::erase
          (Map<int,cocos2d::ui::LayoutParameter*> *this,int *param_1)

{
      ...
      if (uVar5 <= uVar6) {
        ...
        if (uVar5 != 0) {
          uVar7 = uVar6 / uVar5;
                    ...
                    /* try { // try from 00dad75c to 00ead76b has its CatchHandler @ 00dae354 */
        uVar7 = uVar6 - uVar7 * uVar5;
      }
    }
                    /* try { // try from 00dad76c to 00ead7db has its CatchHandler @ 00dad6f4 */
  ...
  uVar4 = 0;
LAB_00dad7dc:
                    /* try { // try from 00dad7dc to 00ead7eb has its CatchHandler @ 00dae350 */
  if (*(long *)(lVar2 + 0x28) != local_38) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail(uVar4);
  }
                    /* try { // try from 00dad7ec to 00ead85b has its CatchHandler @ 00dad6f4 */
  return;
}
