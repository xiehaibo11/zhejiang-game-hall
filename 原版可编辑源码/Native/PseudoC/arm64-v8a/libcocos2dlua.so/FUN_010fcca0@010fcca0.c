...
void FUN_010fcca0(long param_1,long *param_2,uint param_3,ulong *param_4,int param_5)
    ...
    if (uVar3 != 0) {
      ...
      do {
        ...
        puVar6 = *(undefined1 **)(*param_2 + (ulong)param_3 * 8);
                    /* catch() { ... } // from try @ 010fcc44 with catch @ 010fcd30 */
                    /* catch() { ... } // from try @ 010fcce0 with catch @ 010fcd44 */
...
LAB_010fcd50:
          ...
          do {
                    /* catch() { ... } // from try @ 010fccd4 with catch @ 010fcd5c */
            uVar12 = *puVar7;
            lVar8 = lVar8 + -1;
            *puVar9 = uVar12;
            puVar9[-1] = uVar12;
          ...
          lVar11 = lVar5;
          do {
                    /* try { // try from 010fccd4 to 011fccdf has its CatchHandler @ 010fcd5c */
            uVar14 = puVar10[-1];
            uVar13 = puVar10[-2];
            uVar16 = puVar10[1];
            uVar15 = *puVar10;
            lVar11 = lVar11 + -0x20;
                    /* try { // try from 010fcce0 to 011fcceb has its CatchHandler @ 010fcd44 */
            puVar10 = puVar10 + 4;
            uVar12 = (undefined1)uVar13;
                    /* try { // try from 010fccec to 011fcd77 has its CatchHandler @ 010fcc04 */
            *puVar7 = uVar12;
            puVar7[1] = uVar12;
            puVar7[2] = uVar12;
          ...
          lVar11 = lVar5;
          if (uVar2 != 0) goto LAB_010fcd50;
        }
                    /* catch() { ... } // from try @ 010fd070 with catch @ 010fcd78 */
        param_3 = param_3 + 1;
        param_4 = param_4 + 1;
        bVar1 = 1 < param_5;
        param_5 = param_5 + -1;
