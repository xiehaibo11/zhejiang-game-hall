...
void vpaes_ecb_decrypt(undefined1 param_1 [16],undefined1 param_2 [16],undefined8 param_3,
...

{
  ...
  uVar3 = param_2[1];
  uVar2 = param_2[0];
  auVar18 = FUN_00b883c0(param_3,param_4,param_6);
  if ((extraout_x17 & 0x10) != 0) {
    ...
    *puVar1 = extraout_b0;
    ...
    auVar18._0_8_ = auVar19._0_8_;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b88abc with catch @ 00b88bd8
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b88b0c with catch @ 00b88bdc
                        */
  ...
  do {
    auVar19 = FUN_00b88500(auVar18._0_8_ + 0x20,auVar18._8_8_);
    puVar1 = auVar19._8_8_;
    *puVar1 = extraout_b0_00;
    ...
    auVar18._0_8_ = auVar19._0_8_;
                    /* try { // try from 00b88bf0 to 00c88bf3 has its CatchHandler @ 00b88c18 */
  } while (0x20 < extraout_x17_01);
                    /* try { // try from 00b88bf4 to 00c88c4b has its CatchHandler @ 00b88a74 */
  return;
}
