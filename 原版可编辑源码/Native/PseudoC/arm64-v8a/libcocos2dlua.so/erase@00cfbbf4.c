...
/* cocos2d::Map<cocos2d::Node*, cocosbuilder::CCBAnimationManager*>::erase(cocos2d::Node* const&) */

void __thiscall
cocos2d::Map<cocos2d::Node*,cocosbuilder::CCBAnimationManager*>::erase
          (Map<cocos2d::Node*,cocosbuilder::CCBAnimationManager*> *this,Node **param_1)

{
  ...
  if (uVar5 != 0) {
    pNVar6 = *param_1;
    uVar7 = ((ulong)(uint)((int)pNVar6 << 3) + 8 ^ (ulong)pNVar6 >> 0x20) * -0x622015f714c7d297;
    ...
    uVar8 = (uVar7 ^ (ulong)pNVar6 >> 0x20 ^ uVar7 >> 0x2f) * -0x622015f714c7d297;
