...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<cocos2d::Node*, int>,
   ...
   >::remove(std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<cocos2d::Node*,
   int>, void*>*>) */
...

{
  ...
  if (plVar5 != param_2 + 2) {
    uVar7 = plVar5[1];
                    /* try { // try from 00fa30e8 to 010a30ff has its CatchHandler @ 00fa3150 */
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
    }
    else if (uVar3 <= uVar7) {
      ...
      uVar7 = uVar7 - uVar1 * uVar3;
                    /* try { // try from 00fa3100 to 010a314b has its CatchHandler @ 00fa2ffc */
    }
    if (uVar7 == uVar4) goto LAB_00fa315c;
  }
  if (*param_3 != 0) {
    uVar7 = *(ulong *)(*param_3 + 8);
    if (uVar6 < 2) {
                    /* try { // try from 00fa314c to 010a314f has its CatchHandler @ 00fa3150 */
      uVar7 = uVar7 & uVar3 - 1;
    }
    else if (uVar3 <= uVar7) {
      uVar1 = 0;
...
LAB_00fa315c:
  if (*param_3 != 0) {
    uVar7 = *(ulong *)(*param_3 + 8);
    if (uVar6 < 2) {
                    /* try { // try from 00fa318c to 010a32d7 has its CatchHandler @ 00fa318c
                       catch() { ... } // from try @ 00fa318c with catch @ 00fa318c
                       catch() { ... } // from try @ 00fa32ec with catch @ 00fa318c
                       catch() { ... } // from try @ 00fa336c with catch @ 00fa318c */
      uVar7 = uVar7 & uVar3 - 1;
    }
    else if (uVar3 <= uVar7) {
      uVar6 = 0;
