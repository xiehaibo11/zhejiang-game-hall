...
/* void std::__ndk1::vector<cocostudio::ColliderBody*,
   std::__ndk1::allocator<cocostudio::ColliderBody*>
   >::__push_back_slow_path<cocostudio::ColliderBody* const&>(cocostudio::ColliderBody* const&) */
...
__push_back_slow_path<cocostudio::ColliderBody*const&>
          (vector<cocostudio::ColliderBody*,std::__ndk1::allocator<cocostudio::ColliderBody*>> *this
          ,ColliderBody **param_1)
