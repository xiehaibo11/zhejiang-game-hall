...
/* cocos2d::ParticleFireworks::createWithTotalParticles(int) */

ParticleSystemQuad * cocos2d::ParticleFireworks::createWithTotalParticles(int param_1)

{
  ...
  if (this != (ParticleSystemQuad *)0x0) {
    ...
    *(undefined ***)(this + 0x2f8) = &PTR__ParticleFireworks_01709860;
    uVar1 = initWithTotalParticles((ParticleFireworks *)this,param_1);
    if ((uVar1 & 1) == 0) {
