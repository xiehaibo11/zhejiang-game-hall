...
undefined8 FUN_008c0238(undefined8 param_1)

{
  ...
  if ((((((iVar2 == 0) || (iVar2 = tolua_isnumber(param_1,2,0,auStack_78), iVar2 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glCopyTexSubImage2D\'.",auStack_78);
  }
  else {
    ...
    glCopyTexSubImage2D((int)dVar3,(int)dVar4,(int)dVar5,(int)dVar6,(int)dVar7,(int)dVar8,(int)dVar9
                        ,(int)dVar10);
  }
