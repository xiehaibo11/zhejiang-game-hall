...

{
  ...
  undefined4 local_48;
                    ...
                    /* try { // try from 010bd60c to 011bd60f has its CatchHandler @ 010bd734 */
                    /* try { // try from 010bd620 to 011bd637 has its CatchHandler @ 010bd740 */
  iVar3 = FUN_010bd740(&local_68,param_3);
  if (iVar3 == 1) {
...
LAB_010bd6e4:
  ...
  if (iVar3 != 0) {
                    /* catch() { ... } // from try @ 010bd674 with catch @ 010bd730 */
                    /* catch() { ... } // from try @ 010bd60c with catch @ 010bd734 */
                    /* catch() { ... } // from try @ 010bd50c with catch @ 010bd738 */
  ...
  if ((param_4 < 2) && ((uVar2 >> 1 & 1) != 0)) {
    iVar3 = FUN_010be9b8(param_3,(undefined8 *)(param_2 + 4),100);
    if (iVar3 == 0) {
  ...
  uVar5 = param_3[2];
                    /* try { // try from 010bd674 to 011bd677 has its CatchHandler @ 010bd730 */
  ...
  *(undefined8 *)(param_2 + 0x24) = local_68;
                    /* try { // try from 010bd6a8 to 011bd6b7 has its CatchHandler @ 010bd740 */
  iVar3 = FUN_010be9b8(param_3,&DAT_014733f4,1000);
                    /* try { // try from 010bd6b8 to 011bd78f has its CatchHandler @ 010bd480 */
  uVar1 = uVar2 | 0x42;
  if (iVar3 == 0) {
