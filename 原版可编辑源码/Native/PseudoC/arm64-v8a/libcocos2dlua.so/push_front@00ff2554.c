...
/* std::__ndk1::__split_buffer<cocos2d::TextureCache::AsyncStruct**,
   std::__ndk1::allocator<cocos2d::TextureCache::AsyncStruct**>&>::push_front(cocos2d::TextureCache::AsyncStruct**
   const&) */
    ...
    if (uVar2 < uVar5) {
      ...
      if (__n != 0) {
        ...
        memmove(__dest,__src,__n);
                    ...
                    /* try { // try from 00ff25d0 to 010f25db has its CatchHandler @ 00ff28ac */
      *(undefined8 **)(this + 8) = __dest;
      *(long *)(this + 0x10) = *(long *)(this + 0x10) + (lVar1 >> 1) * 8;
    }
    else {
      lVar1 = uVar5 - (long)*(undefined8 **)this;
                    /* try { // try from 00ff25dc to 010f28c7 has its CatchHandler @ 00ff2464 */
      uVar5 = lVar1 >> 2;
      if (lVar1 == 0) {
        uVar5 = 1;
      }
