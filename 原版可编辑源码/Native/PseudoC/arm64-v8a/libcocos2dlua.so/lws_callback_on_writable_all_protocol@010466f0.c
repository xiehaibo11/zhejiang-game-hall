...

{
  ...
  long *plVar6;
                    ...
                    /* try { // try from 010466f0 to 01146707 has its CatchHandler @ 0104680c */
                    /* try { // try from 01046708 to 0114671b has its CatchHandler @ 010467a0 */
  if (param_1 == 0) {
                    /* catch() { ... } // from try @ 010466f0 with catch @ 0104680c */
    return 0;
  }
...
LAB_01046780:
        ...
        for (lVar4 = *(long *)(*(long *)(lVar3 + 0x1a8) + (long)iVar2 * 8); lVar4 != 0;
            lVar4 = *(long *)(lVar4 + 600)) {
                    /* catch() { ... } // from try @ 01046708 with catch @ 010467a0 */
