...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00f4a278 to 0104a28f has its CatchHandler @ 00f4a84c */
  lVar5 = tpidr_el0;
  local_68 = *(long *)(lVar5 + 0x28);
                    /* try { // try from 00f4a2a4 to 0104a2ab has its CatchHandler @ 00f4a80c */
  ...
  if (uVar12 != 0) {
    ...
    if (plVar8 != (long *)0x0) {
      ...
      if (plVar8 != (long *)0x0) {
        ...
        pbVar2 = param_1 + 1;
                    /* try { // try from 00f4a33c to 0104a353 has its CatchHandler @ 00f4a84c */
        if (((byte)*param_1 & 1) != 0) {
        ...
        do {
          uVar9 = plVar8[1];
                    /* try { // try from 00f4a360 to 0104a367 has its CatchHandler @ 00f4a800 */
          if (uVar9 == uVar7) {
            bVar3 = *(byte *)(plVar8 + 2);
                    /* try { // try from 00f4a370 to 0104a37f has its CatchHandler @ 00f4a7fc */
            uVar9 = (ulong)(bVar3 >> 1);
            sVar1 = uVar9;
            if ((bVar3 & 1) != 0) {
              sVar1 = plVar8[3];
            ...
            if (uVar13 < 2) {
              ...
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00f4a354;
              goto LAB_00f4a404;
            }
            if (uVar9 != uVar14) goto LAB_00f4a404;
          }
LAB_00f4a354:
          plVar8 = (long *)*plVar8;
...
LAB_00f4a408:
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* try { // try from 00f4a418 to 0104a42f has its CatchHandler @ 00f4a84c */
    return plVar8;
  }
