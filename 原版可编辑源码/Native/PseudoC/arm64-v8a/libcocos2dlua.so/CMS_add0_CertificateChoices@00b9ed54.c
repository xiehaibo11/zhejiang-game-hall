    ...
    *plVar3 = lVar2;
    if (lVar2 == 0) {
      return (CMS_CertificateChoices *)0x0;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b9ee20 with catch @ 00b9edb0
                       catch(type#1 @ 00000000) { ... } // from try @ 00b9ee50 with catch @ 00b9edb0
                       catch(type#1 @ 00000000) { ... } // from try @ 00b9ee80 with catch @ 00b9edb0
                       catch(type#1 @ 00000000) { ... } // from try @ 00b9eea8 with catch @ 00b9edb0
                       catch(type#1 @ 00000000) { ... } // from try @ 00b9eed4 with catch @ 00b9edb0
                        */
