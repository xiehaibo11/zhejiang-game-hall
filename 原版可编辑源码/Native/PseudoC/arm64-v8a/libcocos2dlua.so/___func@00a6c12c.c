...
::~__func(__func<std::__ndk1::__bind<void(fairygui::DragDropManager::*)(fairygui::EventContext*),fairygui::DragDropManager*,std::__ndk1::placeholders::__ph<1>const&>,std::__ndk1::allocator<std::__ndk1::__bind<void(fairygui::DragDropManager::*)(fairygui::EventContext*),fairygui::DragDropManager*,std::__ndk1::placeholders::__ph<1>const&>>,void(fairygui::EventContext*)>
          *this)
