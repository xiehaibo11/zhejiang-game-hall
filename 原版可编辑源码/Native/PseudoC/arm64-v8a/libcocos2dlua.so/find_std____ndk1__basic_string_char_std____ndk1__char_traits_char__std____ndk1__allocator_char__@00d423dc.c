...
/* std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   cocos2d::Sprite3DCache::Sprite3DData*>, void*>*>
   std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::Sprite3DCache::Sprite3DData*>,
   std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> >, cocos2d::Sprite3DCache::Sprite3DData*>,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::Sprite3DCache::Sprite3DData*> > >::find<std::__ndk1::basic_string<char,
...

{
  ...
  local_68 = *(long *)(lVar5 + 0x28);
                    /* try { // try from 00d42408 to 00e42447 has its CatchHandler @ 00d42408
                       catch() { ... } // from try @ 00d42408 with catch @ 00d42408
                       catch() { ... } // from try @ 00d42464 with catch @ 00d42408 */
  ...
  if (uVar12 != 0) {
    ...
    uVar13 = CONCAT62((int6)((ulong)uVar16 >> 0x10),uVar15) & 0xffffffff;
                    /* try { // try from 00d42448 to 00e42463 has its CatchHandler @ 00d424a0 */
    if (uVar13 < 2) {
      ...
      if (uVar12 <= uVar7) {
        ...
        if (uVar12 != 0) {
          uVar14 = uVar7 / uVar12;
                    ...
                    /* try { // try from 00d42464 to 00e424bb has its CatchHandler @ 00d42408 */
    ...
    if (plVar8 != (long *)0x0) {
      ...
      if (plVar8 != (long *)0x0) {
        ...
        pbVar2 = param_1 + 1;
                    /* catch() { ... } // from try @ 00d42448 with catch @ 00d424a0 */
        if (((byte)*param_1 & 1) != 0) {
            ...
            if (sVar1 == __n) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                while (*pbVar10 == *pbVar11) {
                  ...
                  pbVar10 = pbVar10 + 1;
                  pbVar11 = pbVar11 + 1;
                  if (uVar9 == 0) goto LAB_00d4256c;
                }
              }
              else {
                    /* try { // try from 00d4255c to 00e425c7 has its CatchHandler @ 00d4255c
                       catch() { ... } // from try @ 00d4255c with catch @ 00d4255c
                       catch() { ... } // from try @ 00d425d0 with catch @ 00d4255c */
                if ((__n == 0) || (iVar6 = memcmp(__s1,pbVar2,__n), iVar6 == 0)) break;
              }
            }
          }
          else {
                    /* try { // try from 00d42530 to 00e4255b has its CatchHandler @ 00d424bc */
            if (uVar13 < 2) {
              ...
              if (uVar12 != 0) {
                uVar4 = uVar9 / uVar12;
                    ...
                    /* catch() { ... } // from try @ 00d42528 with catch @ 00d42540 */
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00d424b8;
              goto LAB_00d42568;
            }
            if (uVar9 != uVar14) goto LAB_00d42568;
          }
LAB_00d424b8:
          plVar8 = (long *)*plVar8;
                    /* try { // try from 00d424bc to 00e42527 has its CatchHandler @ 00d424bc
                       catch() { ... } // from try @ 00d424bc with catch @ 00d424bc
                       catch() { ... } // from try @ 00d42530 with catch @ 00d424bc */
