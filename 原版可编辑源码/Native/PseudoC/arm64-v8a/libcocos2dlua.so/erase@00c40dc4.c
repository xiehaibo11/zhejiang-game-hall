...
/* cocos2d::Map<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   ...
   cocostudio::MovementBoneData*>::erase(std::__ndk1::basic_string<char,
...
::erase(Map<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocostudio::MovementBoneData*>
