        ...
        if (iVar2 != 0) {
          ...
          while (pBVar4 = a_00, iVar3 == 0) {
            ...
            if ((uVar5 & 1) != 0) {
              ...
              iVar3 = (&DAT_013f229c)[uVar6 & 7] * iVar2;
            }
            if (pBVar4->neg == 0) {
              if (pBVar4->top == 0) {
                uVar5 = 0;
                iVar2 = a_01->top;
                goto joined_r0x00b98720;
              }
              uVar5 = (uint)*pBVar4->d;
              if (a_01->top == 0) goto LAB_00b986b4;
LAB_00b986cc:
              uVar7 = (uint)*a_01->d;
            }
            else {
