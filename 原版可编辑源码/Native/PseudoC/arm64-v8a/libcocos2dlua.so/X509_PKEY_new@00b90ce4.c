...

{
  ...
  if (ptr != (X509_PKEY *)0x0) {
    ...
    ptr->enc_pkey = pAVar2;
                    /* try { // try from 00b90d20 to 00c90d2b has its CatchHandler @ 00b90d84 */
    if ((pAVar2 != (ASN1_OCTET_STRING *)0x0) && (ptr->enc_algor != (X509_ALGOR *)0x0)) {
      return ptr;
    }
                    /* try { // try from 00b90d2c to 00c90d9f has its CatchHandler @ 00b90cbc */
    ...
    CRYPTO_free(ptr);
                    ...
                    /* catch() { ... } // from try @ 00b90d20 with catch @ 00b90d84 */
