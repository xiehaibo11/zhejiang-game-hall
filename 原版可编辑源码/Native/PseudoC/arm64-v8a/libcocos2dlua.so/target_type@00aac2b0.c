...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void (fairygui::FUIInput::*)(cocos2d::Ref*,
   ...
   cocos2d::ui::Widget::TouchEventType)>::target_type() const */
...
{
  return &__bind<void(fairygui::FUIInput::*)(cocos2d::Ref*,cocos2d::ui::Widget::TouchEventType),fairygui::FUIInput*,std::__ndk1::placeholders::__ph<1>const&,std::__ndk1::placeholders::__ph<2>const&>
          ::typeinfo;
}
