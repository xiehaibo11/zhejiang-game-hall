...
void FUN_009ec7cc(long *param_1,long *param_2)

{
  ...
  long local_38;
                    ...
                    /* try { // try from 009ec7d4 to 00aec86b has its CatchHandler @ 009ec5f8 */
  lVar1 = tpidr_el0;
    ...
    if (plVar2 == param_1) {
      ...
      if (param_2 == plVar3) {
        (**(code **)(*plVar3 + 0x18))(plVar3,param_1);
                    /* try { // try from 009ec86c to 00aec877 has its CatchHandler @ 009ec9f4 */
                    /* try { // try from 009ec878 to 00aec983 has its CatchHandler @ 009ec5f8 */
        (**(code **)(*(long *)param_2[4] + 0x20))();
        param_2[4] = param_1[4];
        param_1[4] = (long)param_1;
      }
