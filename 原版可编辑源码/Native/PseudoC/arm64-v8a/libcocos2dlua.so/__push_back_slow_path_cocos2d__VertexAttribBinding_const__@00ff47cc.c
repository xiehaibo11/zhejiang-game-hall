...
/* void std::__ndk1::vector<cocos2d::VertexAttribBinding*,
   std::__ndk1::allocator<cocos2d::VertexAttribBinding*>
   >::__push_back_slow_path<cocos2d::VertexAttribBinding* const&>(cocos2d::VertexAttribBinding*
   const&) */
...
__push_back_slow_path<cocos2d::VertexAttribBinding*const&>
          (vector<cocos2d::VertexAttribBinding*,std::__ndk1::allocator<cocos2d::VertexAttribBinding*>>
           *this,VertexAttribBinding **param_1)

{
  ...
  if (uVar3 >> 0x3d != 0) {
    ...
    __vector_base_common<true>::__throw_length_error();
                    ...
                    /* catch() { ... } // from try @ 00ff4640 with catch @ 00ff480c */
                    /* catch() { ... } // from try @ 00ff4684 with catch @ 00ff4810 */
