...
/* void std::__ndk1::vector<cocostudio::ActionNode*, std::__ndk1::allocator<cocostudio::ActionNode*>
   >::__push_back_slow_path<cocostudio::ActionNode* const&>(cocostudio::ActionNode* const&) */
...
__push_back_slow_path<cocostudio::ActionNode*const&>
          (vector<cocostudio::ActionNode*,std::__ndk1::allocator<cocostudio::ActionNode*>> *this,
          ActionNode **param_1)
