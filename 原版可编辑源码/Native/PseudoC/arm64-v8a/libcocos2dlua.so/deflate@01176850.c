  ...
  *(uint *)(plVar21 + 8) = param_2;
  if (iVar11 == 0x2a) {
    ...
    *(int *)(plVar21 + 1) = iVar11;
    if (iVar11 == 0x45) goto LAB_01176ba0;
LAB_01176ebc:
    if (iVar11 != 0x49) goto LAB_01177014;
LAB_01176ec4:
...
LAB_01177194:
    if (*(int *)(plVar21[6] + 0x44) != 0) {
      ...
      uVar8 = *(uint *)(plVar21 + 5);
      if ((ulong)plVar21[3] < (ulong)(uVar8 + 2)) goto LAB_01177290;
      lVar9 = param_1[0xc];
      *(uint *)(plVar21 + 5) = uVar8 + 1;
      *(char *)(plVar21[2] + (ulong)uVar8) = (char)lVar9;
      lVar9 = param_1[0xc];
...
LAB_01176b98:
    if (iVar11 != 0x45) goto LAB_01176ebc;
LAB_01176ba0:
    lVar9 = plVar21[6];
    if (*(long *)(lVar9 + 0x18) == 0) {
LAB_01176d10:
    ...
    iVar11 = (int)plVar21[1];
    if (iVar11 == 0x49) goto LAB_01176ec4;
LAB_01177014:
    if (iVar11 == 0x5b) goto LAB_01177030;
LAB_0117717c:
    if (iVar11 == 0x67) goto LAB_01177194;
  }
LAB_01177290:
  if ((int)plVar21[5] == 0) {
    if ((int)param_1[1] == 0) {
    ...
    if (uVar17 == 0) goto LAB_01177b60;
  }
  if ((int)plVar21[1] == 0x29a) {
    if ((int)param_1[1] != 0) goto LAB_011774ec;
LAB_01177340:
    if ((*(int *)((long)plVar21 + 0xa4) == 0) && (param_2 == 0 || (int)plVar21[1] == 0x29a))
    goto LAB_01177b50;
  }
  else if ((int)param_1[1] == 0) goto LAB_01177340;
...
LAB_01177518:
      do {
        if (uVar8 < 0x103) {
          FUN_01176140(plVar21);
          uVar8 = *(uint *)((long)plVar21 + 0xa4);
          if ((param_2 == 0) && (uVar8 < 0x103)) goto LAB_0117796c;
          if (uVar8 == 0) {
            *(undefined4 *)((long)plVar21 + 0x171c) = 0;
            if (param_2 == 4) {
              uVar23 = plVar21[0x11];
              goto joined_r0x01177874;
            }
            if (*(int *)((long)plVar21 + 0x16fc) == 0) goto LAB_01177a6c;
            uVar23 = plVar21[0x11];
            goto joined_r0x011779bc;
          }
          *(undefined4 *)(plVar21 + 0x12) = 0;
          if (2 < uVar8) goto LAB_01177554;
...
LAB_01177668:
              ...
              *(uint *)(plVar21 + 0x12) = uVar8;
              if (2 < uVar8) {
                ...
                bVar6 = (&DAT_0149f1a0)[uVar8 + 0xfd & 0xff];
      ...
      FUN_0117c24c(plVar21,lVar22,uVar17 - uVar23,0);
      lVar9 = *plVar21;
...
LAB_01177378:
      if ((iVar11 != 0) || (FUN_01176140(plVar21), *(int *)((long)plVar21 + 0xa4) != 0))
      goto LAB_0117738c;
      if (param_2 == 0) goto LAB_0117796c;
      *(undefined4 *)((long)plVar21 + 0x171c) = 0;
      if (param_2 == 4) {
        uVar23 = plVar21[0x11];
joined_r0x01177874:
        ...
        FUN_0117c24c(plVar21,lVar22,*(uint *)((long)plVar21 + 0x9c) - uVar23,1);
        lVar9 = *plVar21;
        plVar21[0x11] = (ulong)*(uint *)((long)plVar21 + 0x9c);
        lVar22 = *(long *)(lVar9 + 0x38);
        FUN_0117c078(lVar22);
...
joined_r0x011779bc:
        ...
        FUN_0117c24c(plVar21,lVar22,*(uint *)((long)plVar21 + 0x9c) - uVar23,0);
        lVar9 = *plVar21;
        plVar21[0x11] = (ulong)*(uint *)((long)plVar21 + 0x9c);
        lVar22 = *(long *)(lVar9 + 0x38);
        FUN_0117c078(lVar22);
        ...
        if (*(int *)(*plVar21 + 0x20) != 0) goto LAB_01177a6c;
        goto LAB_0117796c;
      }
      goto LAB_01177a6c;
    }
    uVar8 = (*(code *)(&PTR_FUN_0172d360)[(long)*(int *)((long)plVar21 + 0xb4) * 2])
                      (plVar21,param_2);
LAB_0117794c:
    if ((uVar8 | 1) == 3) {
...
LAB_0117738c:
  ...
  *(uint *)((long)plVar21 + 0x9c) = uVar8;
  if (*(int *)((long)plVar21 + 0x16fc) == (int)plVar21[0x2df] + -1) goto code_r0x011773f4;
  goto LAB_01177378;
code_r0x011773f4:
  uVar23 = plVar21[0x11];
  if ((long)uVar23 < 0) {
  ...
  FUN_0117c24c(plVar21,lVar22,uVar8 - uVar23,0);
  lVar9 = *plVar21;
  plVar21[0x11] = (ulong)*(uint *)((long)plVar21 + 0x9c);
  lVar22 = *(long *)(lVar9 + 0x38);
  FUN_0117c078(lVar22);
  ...
  if (*(int *)(*plVar21 + 0x20) == 0) goto LAB_0117796c;
  goto LAB_01177374;
}
