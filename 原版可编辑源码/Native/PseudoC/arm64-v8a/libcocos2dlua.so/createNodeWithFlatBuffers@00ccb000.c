...
/* non-virtual thunk to TabControlReader::createNodeWithFlatBuffers(flatbuffers::Table const*) */

undefined8 __thiscall
TabControlReader::createNodeWithFlatBuffers(TabControlReader *this,Table *param_1)

{
  ...
  uVar1 = cocos2d::ui::TabControl::create();
