...
long FUN_00fdbbcc(long *param_1,long *param_2)

{
  ...
  param_2[1] = lVar2;
  plVar1 = (long *)FUN_00fdbd00(param_1,lVar2,param_2 + 2);
  uVar3 = param_1[1];
  uVar4 = param_2[1];
  ...
  if (uVar5 < 2) {
                    /* try { // try from 00fdbc6c to 010dbc6f has its CatchHandler @ 00fdbcac */
    uVar4 = uVar3 - 1 & uVar4;
  }
  else if (uVar3 <= uVar4) {
    uVar6 = 0;
    ...
    uVar4 = uVar4 - uVar6 * uVar3;
                    ...
                    /* try { // try from 00fdbc70 to 010dbcc7 has its CatchHandler @ 00fdbc3c */
  if (plVar1 == (long *)0x0) {
    plVar1 = param_1 + 2;
    *param_2 = *plVar1;
    *plVar1 = (long)param_2;
      ...
      if (uVar5 < 2) {
        ...
        if (uVar3 != 0) {
          uVar5 = uVar4 / uVar3;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fdbc6c with catch @ 00fdbcac
                        */
    ...
    *param_2 = *plVar1;
    *plVar1 = (long)param_2;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fdbc70 with catch @ 00fdbc3c
                        */
    if (*param_2 != 0) {
