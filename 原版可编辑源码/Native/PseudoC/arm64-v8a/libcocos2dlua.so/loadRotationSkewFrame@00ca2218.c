...
/* cocostudio::timeline::ActionTimelineCache::loadRotationSkewFrame(rapidjson::GenericValue<rapidjson::UTF8<char>,
   rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator> > const&) */

long __thiscall
cocostudio::timeline::ActionTimelineCache::loadRotationSkewFrame
...

{
  ...
  lVar1 = RotationSkewFrame::create();
