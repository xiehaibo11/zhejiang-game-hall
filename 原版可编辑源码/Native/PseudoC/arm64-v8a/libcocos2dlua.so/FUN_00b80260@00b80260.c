...
stack_st_CONF_VALUE *
FUN_00b80260(X509V3_EXT_METHOD *param_1,undefined8 param_2,stack_st_CONF_VALUE *param_3)
...
LAB_00b80398:
    ...
    do {
      ...
      if (param_3 == (stack_st_CONF_VALUE *)0x0) goto LAB_00b80398;
      ...
      OPENSSL_strlcat(pvVar8,&DAT_012f2eb7,lVar9);
