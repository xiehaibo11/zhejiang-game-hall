...
void FUN_0089d3b8(undefined8 param_1)

{
  ...
  if (((iVar2 == 0) || (iVar2 = tolua_isusertype(param_1,2,&DAT_012769c7,0,auStack_48), iVar2 == 0))
    ...
    tolua_error(param_1,"#ferror in function \'indexOfObject\'.",auStack_48);
    uVar5 = 0;
  }
  else {
    ...
    if (this == (__Array *)0x0) {
      tolua_error(param_1,"invalid \'self\' in function \'indexOfObject\'",0);
    }
    uVar3 = cocos2d::__Array::getIndexOfObject(this,pRVar4);
