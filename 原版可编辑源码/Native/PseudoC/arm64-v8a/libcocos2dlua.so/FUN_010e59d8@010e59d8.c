...
void FUN_010e59d8(long param_1,long param_2,uint *param_3,uint param_4,undefined8 param_5,
  ...
  if (*param_6 < param_7) {
    ...
    do {
      ...
      if (uVar1 < param_4) {
        ...
        *(int *)(lVar8 + 100) = iVar7;
LAB_010e5bbc:
        if (iVar7 == iVar10) goto LAB_010e5bc8;
      }
      else {
        if (*(int *)(lVar8 + 0x60) != 0) {
          return;
        ...
        iVar7 = *(int *)(lVar8 + 100);
        iVar10 = *(int *)(lVar8 + 0x6c);
        if (iVar10 <= iVar7) goto LAB_010e5bbc;
        iVar6 = *(int *)(param_1 + 0x5c);
        if (0 < iVar6) {
          lVar9 = 0;
          if (iVar10 <= iVar7) goto LAB_010e5ba0;
          do {
            uVar5 = *(undefined8 *)(lVar8 + lVar9 * 8 + 0x10);
