...
/* std::__ndk1::vector<cocos2d::Camera*, std::__ndk1::allocator<cocos2d::Camera*>
   >::vector(std::__ndk1::vector<cocos2d::Camera*, std::__ndk1::allocator<cocos2d::Camera*> >
   const&) */

void __thiscall
std::__ndk1::vector<cocos2d::Camera*,std::__ndk1::allocator<cocos2d::Camera*>>::vector
          (vector<cocos2d::Camera*,std::__ndk1::allocator<cocos2d::Camera*>> *this,vector *param_1)
