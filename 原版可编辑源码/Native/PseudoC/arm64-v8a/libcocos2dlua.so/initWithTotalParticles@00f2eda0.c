...
/* cocos2d::ParticleGalaxy::initWithTotalParticles(int) */

undefined4 __thiscall
cocos2d::ParticleGalaxy::initWithTotalParticles(ParticleGalaxy *this,int param_1)

{
  ...
  if ((uVar2 & 1) == 0) {
    ...
    *(undefined4 *)(this + 0x47c) = 0xbf800000;
    ...
    (**(code **)(*(long *)this + 0x570))(0x42700000,this);
    (**(code **)(*(long *)this + 0x580))(0x41200000,this);
                    /* try { // try from 00f2ee30 to 0102f3e3 has its CatchHandler @ 00f2ee30
                       catch() { ... } // from try @ 00f2ee30 with catch @ 00f2ee30
                       catch() { ... } // from try @ 00f2f3ec with catch @ 00f2ee30
                       catch() { ... } // from try @ 00f2f668 with catch @ 00f2ee30 */
    (**(code **)(*(long *)this + 0x5b0))(0xc2a00000,this);
    (**(code **)(*(long *)this + 0x5c0))(0,this);
    (**(code **)(*(long *)this + 0x590))(0x42a00000,this);
    ...
    *(undefined8 *)(this + 0x4a4) = 0x4120000042140000;
    *(float *)(this + 0x504) = (float)*(int *)(this + 0x508) * 0.25;
    *(undefined4 *)(this + 0x4ac) = 0xbf800000;
    *(undefined8 *)(this + 0x4bc) = 0x3f8000003f428f5c;
    *(undefined8 *)(this + 0x4b4) = 0x3e8000003df5c28f;
