...
ulong FUN_011292f4(long param_1,ulong param_2,void *param_3,ulong param_4,undefined8 param_5)

{
  ...
  if ((*(byte *)(param_1 + 0x11) >> 3 & 1) == 0) {
    ...
    if (lVar2 != *(long *)(*(long *)(param_1 + 0xe8) + param_2 * 8)) {
      TIFFErrorExt(*(undefined8 *)(param_1 + 0x3b8),param_5,"Seek error at scanline %lu, strip %lu",
    ...
    if (uVar3 != param_4) {
      TIFFErrorExt(*(undefined8 *)(param_1 + 0x3b8),param_5,
                   ...
                   *(undefined4 *)(param_1 + 0x27c),uVar3,param_4);
      return 0xffffffffffffffff;
    }
    return param_4;
  }
  ...
  else if ((-1 < (long)(uVar4 | param_4)) && ((long)(uVar4 + param_4) <= lVar2)) goto LAB_01129424;
  if (uVar3 != param_4) {
    TIFFErrorExt(*(undefined8 *)(param_1 + 0x3b8),param_5,
                 "Read error at scanline %lu, strip %lu; got %llu bytes, expected %llu",
                 *(undefined4 *)(param_1 + 0x27c),param_2,uVar3,param_4);
    return 0xffffffffffffffff;
  }
LAB_01129424:
