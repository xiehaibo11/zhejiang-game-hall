...

{
  ...
  *(float *)(lVar1 + 0x1c) = fVar3;
  ...
  if (fVar5 != 1.0) {
                    /* try { // try from 00da0a8c to 00ea0c23 has its CatchHandler @ 00da0a8c
                       catch() { ... } // from try @ 00da0a8c with catch @ 00da0a8c
                       catch() { ... } // from try @ 00da1134 with catch @ 00da0a8c
                       catch() { ... } // from try @ 00da117c with catch @ 00da0a8c
                       catch() { ... } // from try @ 00da11ac with catch @ 00da0a8c */
