...
/* cocos2d::MotionStreak3D::draw(cocos2d::Renderer*, cocos2d::Mat4 const&, unsigned int) */

void __thiscall
cocos2d::MotionStreak3D::draw(MotionStreak3D *this,Renderer *param_1,Mat4 *param_2,uint param_3)

{
  long lVar1;
  code *local_c0;
  undefined8 uStack_b8;
  MotionStreak3D *local_b0;
  Mat4 aMStack_a8 [64];
  uint local_68;
  long local_58;
