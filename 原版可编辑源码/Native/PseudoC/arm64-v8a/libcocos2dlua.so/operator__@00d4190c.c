...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void (cocos2d::Sprite3D::*)(),
   ...
   cocos2d::Sprite3D*> >, void ()>::TEMPNAMEPLACEHOLDERVALUE() */
...
::operator()(__func<std::__ndk1::__bind<void(cocos2d::Sprite3D::*)(),cocos2d::Sprite3D*>,std::__ndk1::allocator<std::__ndk1::__bind<void(cocos2d::Sprite3D::*)(),cocos2d::Sprite3D*>>,void()>
             *this)
    ...
    UNRECOVERED_JUMPTABLE =
         *(code **)(UNRECOVERED_JUMPTABLE +
                   *(long *)(*(long *)(this + 0x18) + ((long)*(ulong *)(this + 0x10) >> 1)));
                    ...
                    /* WARNING: Could not recover jumptable at 0x00d41924. Too many branches */
