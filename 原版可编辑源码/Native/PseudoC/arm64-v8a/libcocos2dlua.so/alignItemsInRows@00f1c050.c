...
/* cocos2d::Menu::alignItemsInRows(int, std::__va_list) */

void __thiscall cocos2d::Menu::alignItemsInRows(Menu *this,int param_1,long *param_3)

{
  ...
  while (param_1 != 0) {
    while( true ) {
      ...
      if (param_1 == 0) goto LAB_00f1c104;
    }
    piVar5 = (int *)*param_3;
...
LAB_00f1c104:
  alignItemsInRowsWithArray(this,(vector *)&local_60);
  pVVar4 = local_60;
  pVVar3 = local_58;
