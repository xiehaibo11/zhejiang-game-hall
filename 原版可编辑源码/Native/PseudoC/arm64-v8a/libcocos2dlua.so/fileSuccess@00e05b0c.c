...

{
  ...
  local_50[0] = 2;
  Manifest::setAssetDownloadState(*(Manifest **)(param_1 + 0x108),param_2,(DownloadState *)local_50)
  ;
  lVar3 = std::__ndk1::
  ...
  if (lVar3 != 0) {
    ...
    *(int *)(param_1 + 0x1d4) = iVar1 + -1;
    fVar4 = ((float)(*(int *)(param_1 + 0x1d0) - (iVar1 + -1)) * 100.0) /
            (float)*(int *)(param_1 + 0x1d0);
