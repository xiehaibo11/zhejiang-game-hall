...
/* std::__ndk1::__split_buffer<cocos2d::Mat4*, std::__ndk1::allocator<cocos2d::Mat4*>
   >::push_back(cocos2d::Mat4*&&) */
    ...
    if (__src < puVar6 || (long)__src - (long)puVar6 == 0) {
      ...
      if (uVar5 >> 0x3d != 0) {
        ...
        FUN_007c2210("allocator<T>::allocate(size_t n) \'n\' exceeds maximum supported size");
                    ...
                    /* try { // try from 00f9b924 to 0109b92b has its CatchHandler @ 00f9c198 */
                    /* try { // try from 00f9b92c to 0109ba03 has its CatchHandler @ 00f9b268 */
