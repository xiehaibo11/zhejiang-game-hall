...
LAB_00b51eb4:
      ...
      bp = (BIO *)0x0;
      if (cipher != (EVP_CIPHER *)0x0) goto LAB_00b51d94;
LAB_00b51e40:
      iVar2 = 0;
      bp_00 = bp;
joined_r0x00b52098:
...
LAB_00b51e4c:
      ...
      if (pAVar17->length < 1) {
        ...
        if (in_bio != (BIO *)0x0) goto LAB_00b51e4c;
      }
      a = (BIO *)0x0;
      bp_00 = (BIO *)0x0;
      key = (uchar *)0x0;
    ...
    bp = (BIO *)0x0;
LAB_00b51d90:
    if (cipher == (EVP_CIPHER *)0x0) goto LAB_00b51e40;
LAB_00b51d94:
    pBVar7 = BIO_f_cipher();
    ...
    if (bp_00 != (BIO *)0x0) {
        ...
        if (0 < iVar2) {
          ...
          do {
            ...
            if (iVar3 == 0) {
              ...
              if (iVar3 == 0) {
                iVar2 = FUN_00b52108(&local_70,&local_74,lVar9,pkey);
                if (iVar2 < 0) goto LAB_00b51fc4;
                ERR_clear_error();
                goto LAB_00b51f24;
              }
            }
      ...
      if (0 < iVar2) {
        ...
        do {
          ...
          iVar3 = FUN_00b52108(&local_70,&local_74,uVar10,pkey);
          if (iVar3 < 0) goto LAB_00b51fc4;
          ERR_clear_error();
          iVar2 = iVar2 + 1;
          iVar3 = OPENSSL_sk_num(psVar16);
        } while (iVar2 < iVar3);
