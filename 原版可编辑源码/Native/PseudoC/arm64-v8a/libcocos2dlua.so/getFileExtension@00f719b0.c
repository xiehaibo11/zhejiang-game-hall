...

{
  ...
  *in_x8 = 0;
  ...
  uVar8 = uVar7;
  if (uVar7 == 0) goto LAB_00f71aec;
  do {
    if (uVar8 == 0) goto LAB_00f71aec;
    lVar2 = uVar8 - 1;
    uVar8 = uVar8 - 1;
  } while (pbVar4[lVar2] != 0x2e);
  if (uVar8 == 0xffffffffffffffff) goto LAB_00f71aec;
  uStack_68 = 0;
  local_60 = (void *)0x0;
  local_70 = 0;
  if (uVar7 < uVar8) {
...
LAB_00f71a84:
  ...
  *in_x8 = local_70;
  ...
  if (((byte)*in_x8 & 1) == 0) {
    ...
    if (pbVar4 == pbVar6) goto LAB_00f71aec;
  }
  else {
    pbVar4 = (byte *)in_x8[2];
