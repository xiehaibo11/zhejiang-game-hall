...
/* void ccvector_to_luaval<cocosbuilder::CCBSequence*>(lua_State*,
   cocos2d::Vector<cocosbuilder::CCBSequence*> const&) */

void ccvector_to_luaval<cocosbuilder::CCBSequence*>(lua_State *param_1,Vector *param_2)
