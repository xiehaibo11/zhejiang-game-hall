...
/* fairygui::PopupMenu::setItemCheckable(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, bool) */

void __thiscall
fairygui::PopupMenu::setItemCheckable(PopupMenu *this,basic_string *param_1,bool param_2)

{
  ...
  if (this_01 != (GController *)0x0) {
    if (param_2) {
      if (*(int *)(this_01 + 0x70) != 0) goto LAB_00a90c78;
      iVar3 = 1;
    }
    else {
      iVar3 = 0;
