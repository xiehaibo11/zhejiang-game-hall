...
/* cocostudio::Sprite3DReader::createNodeWithFlatBuffers(flatbuffers::Table const*) */

Sprite3D * __thiscall
cocostudio::Sprite3DReader::createNodeWithFlatBuffers(Sprite3DReader *this,Table *param_1)

{
  ...
  this_00 = (Sprite3D *)cocos2d::Sprite3D::create();
  plVar2 = (long *)cocos2d::FileUtils::getInstance();
  uVar3 = (**(code **)(*plVar2 + 0x128))(plVar2,local_50);
  if ((uVar3 & 1) != 0) {
    cocos2d::Sprite3D::initWithFile(this_00,(basic_string *)local_50);
  }
