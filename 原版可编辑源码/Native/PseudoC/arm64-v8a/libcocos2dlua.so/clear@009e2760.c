...

{
  ...
  if (puVar6 != puVar3) {
    uVar7 = *(ulong *)(this + 0x20);
                    /* try { // try from 009e27c8 to 00ae2847 has its CatchHandler @ 009e27c8
                       catch() { ... } // from try @ 009e27c8 with catch @ 009e27c8
                       catch() { ... } // from try @ 009e2858 with catch @ 009e27c8 */
...
LAB_009e280c:
  ...
  *(undefined8 *)(this + 0x28) = 0;
  lVar5 = (long)puVar6 - (long)puVar3;
                    /* try { // try from 009e2848 to 00ae2857 has its CatchHandler @ 009e28e8 */
  while (uVar7 = lVar5 >> 3, 2 < uVar7) {
    operator_delete((void *)*puVar3);
                    /* try { // try from 009e2858 to 00ae2903 has its CatchHandler @ 009e27c8 */
