...
/* std::__ndk1::enable_if<__is_forward_iterator<cocos2d::SpriteFrame**>::value&&is_constructible<cocos2d::SpriteFrame*,
   std::__ndk1::iterator_traits<cocos2d::SpriteFrame**>::reference>::value, void>::type
   std::__ndk1::vector<cocos2d::SpriteFrame*, std::__ndk1::allocator<cocos2d::SpriteFrame*>
   >::assign<cocos2d::SpriteFrame**>(cocos2d::SpriteFrame**, cocos2d::SpriteFrame**) */

void __thiscall
std::__ndk1::vector<cocos2d::SpriteFrame*,std::__ndk1::allocator<cocos2d::SpriteFrame*>>::
assign<cocos2d::SpriteFrame**>
          (vector<cocos2d::SpriteFrame*,std::__ndk1::allocator<cocos2d::SpriteFrame*>> *this,
          SpriteFrame **param_1,SpriteFrame **param_2)
...
LAB_00c57db0:
    ...
    if ((ulong)(lVar1 >> 3) < 0xfffffffffffffff) {
      uVar2 = lVar1 >> 2;
      if ((uVar5 <= uVar2) && (uVar5 = uVar2, uVar2 >> 0x3d != 0)) goto LAB_00c57db0;
    }
    else {
    ...
    *(void **)(this + 8) = pvVar4;
    ...
    __src = (SpriteFrame **)((long)param_1 + (*(long *)(this + 8) - (long)pvVar4));
    if (uVar5 <= uVar2) {
      __src = param_2;
    }
