...
/* void std::__ndk1::vector<ClipperLib::OutRec*, std::__ndk1::allocator<ClipperLib::OutRec*>
   >::__push_back_slow_path<ClipperLib::OutRec* const&>(ClipperLib::OutRec* const&) */

void __thiscall
std::__ndk1::vector<ClipperLib::OutRec*,std::__ndk1::allocator<ClipperLib::OutRec*>>::
__push_back_slow_path<ClipperLib::OutRec*const&>
          (vector<ClipperLib::OutRec*,std::__ndk1::allocator<ClipperLib::OutRec*>> *this,
          OutRec **param_1)
