...
undefined8 FUN_00b6bca4(int param_1,X509 *param_2,uint param_3)

{
  ...
  if (pAVar5 != (AUTHORITY_KEYID *)0x0) {
        ...
        do {
          ...
          if (iVar2 == param_1) {
            return 2;
                    ...
                    /* try { // try from 00b6bd34 to 00c6bd67 has its CatchHandler @ 00b6bd34
                       catch() { ... } // from try @ 00b6bd34 with catch @ 00b6bd34
                       catch() { ... } // from try @ 00b6be24 with catch @ 00b6bd34 */
          if (iVar2 == 0x38e) {
            return 2;
          }
          iVar1 = iVar1 + 1;
    ...
    if (pAVar5->keyid != (ASN1_OCTET_STRING *)0x0) {
      ...
      if (0 < iVar1) {
        if ((param_3 >> 4 & 1) == 0) {
                    /* try { // try from 00b6bd68 to 00c6bddf has its CatchHandler @ 00b6bea8 */
          iVar1 = 0;
          do {
            pAVar3 = (ASN1_OBJECT *)OPENSSL_sk_value(pAVar5->keyid,iVar1);
            iVar2 = OBJ_obj2nid(pAVar3);
            if (iVar2 == param_1) goto LAB_00b6be04;
            iVar1 = iVar1 + 1;
          ...
          do {
            pAVar3 = (ASN1_OBJECT *)OPENSSL_sk_value(pAVar5->keyid,iVar1);
            iVar2 = OBJ_obj2nid(pAVar3);
            if ((iVar2 == param_1) || (iVar2 == 0x38e)) goto LAB_00b6be04;
            iVar1 = iVar1 + 1;
            iVar2 = OPENSSL_sk_num(pAVar5->keyid);
          } while (iVar1 < iVar2);
        }
...
LAB_00b6be04:
    uVar4 = 1;
                    ...
                    /* try { // try from 00b6be10 to 00c6be23 has its CatchHandler @ 00b6be74 */
  return uVar4;
}
