...
/* cocostudio::timeline::ActionTimeline::IsAnimationInfoExists(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

bool __thiscall
cocostudio::timeline::ActionTimeline::IsAnimationInfoExists
          (ActionTimeline *this,basic_string *param_1)

{
  ActionTimeline *pAVar1;
  
  pAVar1 = (ActionTimeline *)
           std::__ndk1::
