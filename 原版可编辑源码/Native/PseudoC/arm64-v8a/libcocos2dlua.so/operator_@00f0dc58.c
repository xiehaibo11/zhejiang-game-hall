...
/* std::__ndk1::function<void ()>& std::__ndk1::function<void
   ()>::TEMPNAMEPLACEHOLDERVALUE(std::__ndk1::__bind<void (cocos2d::Label::*)(cocos2d::Mat4 const&,
   bool), cocos2d::Label*, cocos2d::Mat4 const&, bool&>&&) */
...

{
  ...
  local_78 = param_1[0x58];
  local_50 = (long *)0x0;
  plVar2 = operator_new(0x68);
  *plVar2 = (long)&PTR____func_016fe290;
  plVar2[2] = lVar6;
  plVar2[1] = lVar5;
  plVar2[3] = lVar3;
  cocos2d::Mat4::Mat4((Mat4 *)(plVar2 + 4),aMStack_b8);
  *(__bind *)(plVar2 + 0xc) = local_78;
  local_50 = plVar2;
  ...
  if (alStack_70 == local_50) {
    ...
    if (local_50 == (long *)0x0) goto LAB_00f0dd2c;
