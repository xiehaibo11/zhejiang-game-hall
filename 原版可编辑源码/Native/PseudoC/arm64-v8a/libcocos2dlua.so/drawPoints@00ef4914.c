...
/* cocos2d::DrawNode::drawPoints(cocos2d::Vec2 const*, unsigned int, cocos2d::Color4F const&) */

void __thiscall
cocos2d::DrawNode::drawPoints(DrawNode *this,Vec2 *param_1,uint param_2,Color4F *param_3)
  ...
  if (param_2 != 0) {
    ...
    do {
      ...
      *(undefined4 *)(puVar7 + 2) = 0;
      puVar7[1] = CONCAT44(0x3f800000,uStack_78);
      *puVar7 = uVar5;
