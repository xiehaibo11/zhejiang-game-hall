...
/* luaval_to_blendfunc(lua_State*, int, cocos2d::BlendFunc*, char const*) */

bool luaval_to_blendfunc(lua_State *param_1,int param_2,BlendFunc *param_3,char *param_4)

{
  ...
  bVar2 = false;
  if ((param_1 != (lua_State *)0x0) && (param_3 != (BlendFunc *)0x0)) {
