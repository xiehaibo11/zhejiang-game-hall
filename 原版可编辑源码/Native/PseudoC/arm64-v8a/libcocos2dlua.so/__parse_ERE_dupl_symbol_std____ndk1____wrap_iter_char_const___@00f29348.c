...
LAB_00f29510:
    if (pbVar9 != pbVar1) {
      if (pbVar9 == param_3) goto LAB_00f296e8;
      if (*pbVar9 == 0x2c) {
        pbVar1 = pbVar9 + 1;
        if (pbVar1 != param_3) {
          bVar3 = *pbVar1;
          if (bVar3 == 0x7d) {
            ...
            if ((((bVar3 & 0xf8) != 0x30) && ((bVar3 & 0xfe) != 0x38)) ||
               (iVar4 = bVar3 - 0x30, iVar4 == -1)) goto LAB_00f296e8;
            for (pbVar9 = pbVar9 + 2;
                ((pbVar10 = param_3, pbVar9 != param_3 &&
                 ((bVar3 = *pbVar9, pbVar10 = pbVar9, (bVar3 & 0xf8) == 0x30 ||
                  ((bVar3 & 0xfe) == 0x38)))) && (bVar3 - 0x30 != -1)); pbVar9 = pbVar9 + 1) {
                    /* catch() { ... } // from try @ 00f29660 with catch @ 00f29634 */
              if (0xccccccb < iVar4) goto LAB_00f296e4;
              iVar4 = (bVar3 - 0x30) + iVar4 * 10;
            }
                    /* try { // try from 00f29658 to 0102965f has its CatchHandler @ 00f296bc */
                    /* try { // try from 00f29660 to 010296d7 has its CatchHandler @ 00f29634 */
            if (((pbVar10 == pbVar1) || (pbVar10 == param_3)) || (*pbVar10 != 0x7d))
            goto LAB_00f296e8;
            if (iVar4 < iVar8) goto LAB_00f296e4;
            param_2 = pbVar10 + 1;
            if (((uVar2 == 0) && (param_2 != param_3)) && (*param_2 == 0x3f)) {
              param_2 = pbVar10 + 2;
              uVar5 = (ulong)iVar8;
              ...
              goto LAB_00f296d0;
                    ...
                    /* catch() { ... } // from try @ 00f29658 with catch @ 00f296bc */
            uVar6 = (ulong)iVar4;
          }
          uVar5 = (ulong)iVar8;
          bVar7 = true;
LAB_00f296d0:
    ...
    if ((((bVar3 & 0xf8) == 0x30) || ((bVar3 & 0xfe) == 0x38)) &&
      ...
      for (param_2 = param_2 + 2;
        ...
        if (0xccccccb < iVar8) goto LAB_00f296e4;
