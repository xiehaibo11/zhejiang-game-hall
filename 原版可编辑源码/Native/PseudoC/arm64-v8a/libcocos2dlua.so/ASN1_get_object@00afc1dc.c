    ...
    if (uVar10 == 0x1f) {
      if (lVar6 != 0) {
        ...
        do {
          ...
          if (-1 < (char)*pbVar5) goto LAB_00afc248;
      ...
      if (lVar6 != 0) {
        ...
        *pclass = bVar1 & 0xc0;
        if (0 < lVar6) {
          ...
          if (bVar2 == 0x80) {
            *plength = 0;
            if ((bVar1 & 0x20) == 0) goto LAB_00afc318;
            uVar8 = 0;
            pbVar5 = pbVar4 + 1;
            uVar11 = 1;
          }
            ...
            pbVar5 = pbVar4 + 1;
            if ((char)bVar2 < '\0') {
              if (lVar6 <= (long)(uVar8 + 1)) goto LAB_00afc318;
              if ((bVar2 & 0x7f) != 0) {
                pbVar4 = pbVar4 + 2;
                uVar7 = uVar8;
LAB_00afc2b0:
                uVar8 = (ulong)*pbVar5;
                if (uVar8 == 0) goto code_r0x00afc2b8;
                if (8 < uVar7) goto LAB_00afc318;
                if (uVar7 != 0) {
                  if (uVar7 != 1) {
                    uVar9 = 1;
                    do {
                  ...
                  if ((long)uVar8 < 0) goto LAB_00afc318;
                  pbVar5 = pbVar5 + uVar7;
                  goto LAB_00afc2cc;
                }
              }
