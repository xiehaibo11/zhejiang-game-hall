...

{
  ...
  if ((data == (BIO *)0x0) || (((uint)flags >> 6 & 1) == 0)) {
    ...
    iVar9 = FUN_00be785c(bio,val,data,flags,it);
    if (iVar9 == 0) {
      return 0;
    }
...
LAB_00be7ae0:
            if (iVar10 < 0x2a1) {
              if (iVar10 == 4) {
                ...
                if (iVar10 != 0x2a0) goto LAB_00be7b7c;
