...
::__clone(__func<std::__ndk1::__bind<void(fairygui::InputProcessor::*)(cocos2d::EventKeyboard::KeyCode,cocos2d::Event*),fairygui::InputProcessor*,std::__ndk1::placeholders::__ph<1>const&,std::__ndk1::placeholders::__ph<2>const&>,std::__ndk1::allocator<std::__ndk1::__bind<void(fairygui::InputProcessor::*)(cocos2d::EventKeyboard::KeyCode,cocos2d::Event*),fairygui::InputProcessor*,std::__ndk1::placeholders::__ph<1>const&,std::__ndk1::placeholders::__ph<2>const&>>,void(cocos2d::EventKeyboard::KeyCode,cocos2d::Event*)>
          *this,__base *param_1)

{
  ...
  *(undefined ***)param_1 = &PTR_FUN_016a9e70;
  uVar2 = *(undefined8 *)(this + 0x10);
  uVar1 = *(undefined8 *)(this + 8);
                    /* try { // try from 00aaf0dc to 00baf0ef has its CatchHandler @ 00aaf174 */
