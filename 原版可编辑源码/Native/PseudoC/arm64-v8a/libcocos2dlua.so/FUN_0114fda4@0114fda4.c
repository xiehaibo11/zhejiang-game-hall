...
void FUN_0114fda4(uint *param_1,uint param_2,undefined4 param_3,uint *param_4)

{
  ...
  switch(param_3) {
  case 0:
    UNRECOVERED_JUMPTABLE = DAT_017961d0;
    break;
  case 1:
    UNRECOVERED_JUMPTABLE = DAT_01796128;
    break;
  case 2:
    UNRECOVERED_JUMPTABLE = DAT_01796110;
    break;
  case 3:
  ...
  case 4:
    ...
    return;
  case 5:
    UNRECOVERED_JUMPTABLE = DAT_017961c8;
    break;
  case 6:
    UNRECOVERED_JUMPTABLE = DAT_01796118;
    break;
  case 7:
    (*DAT_01796128)(param_1,uVar10,param_4);
    goto LAB_0114fea8;
  case 8:
    memcpy(param_4,param_1,-(ulong)(param_2 >> 0x1f) & 0xfffffffc00000000 | uVar10 << 2);
LAB_0114fea8:
    uVar4 = 0;
LAB_0114ff64:
                    /* WARNING: Could not recover jumptable at 0x0114ff78. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*DAT_01795fa0)(param_4,uVar4,uVar10,1,0);
    return;
  case 9:
    if (0 < (int)param_2) {
      puVar2 = param_1 + (int)param_2;
      ...
      if ((3 < uVar7) && (uVar8 = uVar7 & 0x7ffffffffffffffc, uVar8 != 0)) {
        ...
        if (((uint *)((long)param_1 + ((long)puVar5 + ~(ulong)param_1 & 0xfffffffffffffffc) + 4) <=
          ...
          if (uVar7 == uVar8) goto LAB_0114ff50;
        }
      }
      do {
        puVar5 = param_1 + 1;
...
LAB_0114ff50:
    ...
    goto LAB_0114ff64;
  case 10:
    (*DAT_017961c8)(param_1,uVar10,param_4);
                    /* WARNING: Could not recover jumptable at 0x0114ffb8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*DAT_01795fb8)(param_4,uVar10,1,0);
    return;
  default:
    return;
  }
                    /* WARNING: Could not recover jumptable at 0x0114fe78. Too many branches */
                    /* WARNING: Treating indirect jump as call */
