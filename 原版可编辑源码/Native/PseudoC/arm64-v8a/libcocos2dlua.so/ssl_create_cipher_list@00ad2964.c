...
LAB_00ad2a5c:
  ...
  uVar4 = DAT_01782c48._4_4_;
  uVar3 = (uint)DAT_01782c48;
  uVar2 = DAT_01782c44;
  uVar12 = DAT_01782c40;
...
LAB_00ad2cd0:
  ...
  iVar8 = FUN_00ad3be4(&local_68,&local_70);
  if (iVar8 != 0) {
    plVar18 = local_68;
    plVar21 = local_70;
    if (local_68 != (long *)0x0) {
    ...
    *plVar18 = 0;
    ...
    pcVar22 = param_4;
    if (iVar6 == 0) {
      iVar6 = FUN_00ad3d68("ALL:!COMPLEMENTOFDEFAULT:!eNULL",&local_68,&local_70,plVar20,param_5);
      pcVar22 = param_4 + 7;
      if (*pcVar22 == ':') {
        pcVar22 = param_4 + 8;
      }
    ...
    if (*pcVar22 == '\0') {
      ...
      iVar6 = FUN_00ad3d68(pcVar22,&local_68,&local_70,plVar20,param_5);
      CRYPTO_free(plVar20);
      if (iVar6 == 0) goto LAB_00ad38a0;
    }
...
LAB_00ad38e4:
      ...
      if ((int)plVar21[1] != 0) {
        ...
        if (iVar6 == 0) {
          ...
          lVar10 = *plVar21;
          if ((*(byte *)(lVar10 + 0x34) >> 4 & 1) == 0) goto LAB_00ad3804;
        }
