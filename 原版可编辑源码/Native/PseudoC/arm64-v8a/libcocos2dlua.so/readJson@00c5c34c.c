...
/* cocostudio::ComRender::readJson(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
...
void __thiscall
cocostudio::ComRender::readJson(ComRender *this,basic_string *param_1,GenericDocument *param_2)
