...
/* void std::__ndk1::vector<cocos2d::PUObserver*, std::__ndk1::allocator<cocos2d::PUObserver*>
   >::__push_back_slow_path<cocos2d::PUObserver* const&>(cocos2d::PUObserver* const&) */
...
__push_back_slow_path<cocos2d::PUObserver*const&>
          (vector<cocos2d::PUObserver*,std::__ndk1::allocator<cocos2d::PUObserver*>> *this,
          PUObserver **param_1)
