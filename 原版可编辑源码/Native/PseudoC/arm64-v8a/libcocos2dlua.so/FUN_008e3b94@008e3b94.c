...
void FUN_008e3b94(long *param_1,long *param_2)
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
        ...
        (**(code **)(local_60[0] + 0x18))(local_60,param_2);
                    /* try { // try from 008e3cbc to 009e3d07 has its CatchHandler @ 008e3cbc
                       catch() { ... } // from try @ 008e3cbc with catch @ 008e3cbc
                       catch() { ... } // from try @ 008e3d0c with catch @ 008e3cbc */
