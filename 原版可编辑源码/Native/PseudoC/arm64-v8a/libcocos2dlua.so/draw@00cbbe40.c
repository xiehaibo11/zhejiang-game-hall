...
/* cocostudio::timeline::SkeletonNode::draw(cocos2d::Renderer*, cocos2d::Mat4 const&, unsigned int)
    */

void __thiscall
cocostudio::timeline::SkeletonNode::draw
...

{
  ...
  do {
    ...
    local_c0 = *(undefined8 *)(this + lVar3 + 0x468);
    ...
    cocos2d::Vec3::Vec3((Vec3 *)&local_d0,local_e0 / fStack_b4,fStack_dc / fStack_b4,
                        local_d8 / fStack_b4);
    *(undefined8 *)(this + lVar2 + 0x528) = local_d0;
    *(undefined4 *)(this + lVar2 + 0x530) = local_c8;
    cocos2d::Vec4::~Vec4((Vec4 *)&local_c0);
    lVar3 = lVar3 + 8;
    lVar2 = lVar2 + 0xc;
  } while (lVar3 != 0x40);
