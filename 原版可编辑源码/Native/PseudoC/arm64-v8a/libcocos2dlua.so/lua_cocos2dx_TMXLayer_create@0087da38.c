...
/* lua_cocos2dx_TMXLayer_create(lua_State*) */

undefined8 lua_cocos2dx_TMXLayer_create(lua_State *param_1)
  ...
  if (iVar1 + -1 == 3) {
    if (param_1 != (lua_State *)0x0) {
      ...
      if (((3 < iVar1) &&
        ...
        pvVar4 = (void *)cocos2d::TMXLayer::create(unaff_x20,unaff_x21,pTVar3);
        if (pvVar4 != (void *)0x0) {
    ...
    tolua_error(param_1,"invalid arguments in function \'lua_cocos2dx_TMXLayer_create\'",0);
  }
  else {
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d\n ",
               "cc.TMXLayer:create",iVar1 + -1,3);
  }
  return 0;
}
