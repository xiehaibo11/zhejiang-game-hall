...
/* void ccvector_to_luaval<cocostudio::timeline::Timeline*>(lua_State*,
   cocos2d::Vector<cocostudio::timeline::Timeline*> const&) */

void ccvector_to_luaval<cocostudio::timeline::Timeline*>(lua_State *param_1,Vector *param_2)
