  ...
  while( true ) {
    do {
      ...
      lVar17 = (lVar33 + lVar16) * -0x2ccb;
                    /* catch() { ... } // from try @ 01102e04 with catch @ 01102dd4 */
      lVar25 = (lVar33 + lVar34) * 0x1877;
                    /* try { // try from 01102dfc to 01202e03 has its CatchHandler @ 01102e68 */
                    /* try { // try from 01102e04 to 01202e83 has its CatchHandler @ 01102dd4 */
      *piVar30 = ((int)lVar8 + (int)lVar6 + (int)lVar10 + (int)lVar11 + (uint)pbVar1[5] +
      ...
      piVar30[4] = (int)(lVar26 * 0x1ff + lVar28 * -0x2b6c + lVar21 * 0x12cd + lVar27 + lVar22 +
                         0x800U >> 0xc);
                    /* catch() { ... } // from try @ 01102dfc with catch @ 01102e68 */
