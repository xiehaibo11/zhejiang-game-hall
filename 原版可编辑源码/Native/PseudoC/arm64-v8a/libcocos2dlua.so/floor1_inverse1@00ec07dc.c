...

{
  ...
  lVar14 = oggpack_read(plVar19,1);
  if (lVar14 == 1) {
    iVar4 = *(int *)(&DAT_0143574c + (long)(int)lVar21 * 4);
    iVar10 = iVar4 + -1;
    iVar13 = 0;
    if (iVar10 != 0) {
      iVar13 = 0x20 - (int)LZCOUNT(iVar10);
    }
    uVar11 = oggpack_read(plVar19,iVar13);
    *param_3 = uVar11;
    uVar11 = oggpack_read(plVar19,iVar13);
    param_3[1] = uVar11;
    if (0 < (int)param_2[6]) {
      ...
      local_6c = 2;
      do {
        uVar20 = (ulong)*(byte *)(param_2[1] + lVar21);
        pbVar18 = (byte *)(*param_2 + uVar20 * 0xb);
        bVar5 = pbVar18[1];
        bVar6 = *pbVar18;
        uVar22 = (ulong)bVar6;
        if (bVar5 == 0) {
          ...
          uVar12 = vorbis_book_decode(lVar15 + (ulong)*(byte *)(*param_2 + uVar20 * 0xb + 2) * 0x68,
                                      plVar19);
          if (uVar12 == 0xffffffff) goto LAB_00ec0980;
        }
        if (bVar6 != 0) {
          piVar23 = param_3 + local_6c;
          do {
            uVar16 = (ulong)*(byte *)(*param_2 + uVar20 * 0xb +
                                      (long)(int)(uVar12 & ~(-1 << (ulong)(bVar5 & 0x1f))) + 3);
            if (uVar16 == 0xff) {
              *piVar23 = 0;
            }
            else {
              iVar13 = vorbis_book_decode(lVar15 + uVar16 * 0x68,plVar19);
              *piVar23 = iVar13;
              if (iVar13 == -1) goto LAB_00ec0980;
            }
    ...
    if (2 < *(int *)((long)param_2 + 0x34)) {
      ...
      do {
        ...
        uVar20 = (ulong)*(byte *)(lVar14 + lVar21);
        uVar12 = (uint)*(ushort *)(lVar17 + uVar22 * 2);
        iVar10 = *(ushort *)(lVar17 + uVar20 * 2) - uVar12;
        iVar8 = (param_3[uVar20] & 0x7fff) - (param_3[uVar22] & 0x7fff);
        iVar13 = -iVar8;
        if (-1 < iVar8) {
          iVar13 = iVar8;
        }
