...
void FUN_008bb880(long *param_1,long *param_2)

{
  ...
  if (param_2 != param_1) {
    ...
    if (plVar2 == param_1) {
                    /* try { // try from 008bb8d4 to 009bb8ff has its CatchHandler @ 008bb8d4
                       catch() { ... } // from try @ 008bb8d4 with catch @ 008bb8d4
                       catch() { ... } // from try @ 008bdde4 with catch @ 008bb8d4 */
      if ((long *)param_2[4] == param_2) {
        ...
        (**(code **)(*(long *)param_1[4] + 0x20))();
                    /* try { // try from 008bb900 to 009bdde3 has its CatchHandler @ 008bde1c */
        param_1[4] = param_2[4];
      }
