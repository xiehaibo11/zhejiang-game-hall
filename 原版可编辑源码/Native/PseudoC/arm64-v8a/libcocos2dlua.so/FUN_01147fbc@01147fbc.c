...
void FUN_01147fbc(long param_1,int param_2)

{
  ...
  if (0 < iVar4) {
    ...
    if ((0 < iVar2) &&
       (FUN_0114f290(param_1 + lVar9 * 0x18 + 0xe0,iVar1,param_2,__src,__dest), iVar2 != 1)) {
      lVar8 = param_1 + lVar9 * 0x18 + 200;
      do {
        FUN_0114f290(lVar8,iVar1,param_2,__dest,__dest);
        lVar9 = lVar9 + -1;
        lVar8 = lVar8 + -0x18;
      } while (1 < lVar9);
    }
