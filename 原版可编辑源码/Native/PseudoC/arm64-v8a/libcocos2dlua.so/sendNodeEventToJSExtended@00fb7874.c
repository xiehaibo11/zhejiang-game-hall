...
/* cocos2d::ScriptEngineManager::sendNodeEventToJSExtended(cocos2d::Node*, int) */

void cocos2d::ScriptEngineManager::sendNodeEventToJSExtended(Node *param_1,int param_2)
