...
/* void std::__ndk1::vector<flatbuffers::Offset<flatbuffers::TabItemOption>,
   std::__ndk1::allocator<flatbuffers::Offset<flatbuffers::TabItemOption> >
   >::__push_back_slow_path<flatbuffers::Offset<flatbuffers::TabItemOption>
   const&>(flatbuffers::Offset<flatbuffers::TabItemOption> const&) */
