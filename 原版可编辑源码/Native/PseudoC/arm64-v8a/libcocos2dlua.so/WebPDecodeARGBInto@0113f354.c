...
long WebPDecodeARGBInto(undefined8 param_1,undefined8 param_2,long param_3,undefined8 param_4,
                       undefined4 param_5)

{
  ...
  if (param_3 == 0) {
    ...
    memset(auStack_238,0,0x1e8);
                    /* try { // try from 0113f3b8 to 0123f3bf has its CatchHandler @ 0113f518 */
    local_2b8[0] = 4;
    local_2ac = 1;
    local_2a8 = param_3;
    local_2a0 = param_5;
