...
/* void ccvector_to_luaval<fairygui::Transition*>(lua_State*, cocos2d::Vector<fairygui::Transition*>
   const&) */

void ccvector_to_luaval<fairygui::Transition*>(lua_State *param_1,Vector *param_2)
      ...
      while( true ) {
        if (plVar9 != (long *)0x0) {
          ...
          if (((byte)local_70[0] & 1) != 0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 008e0744 with catch @ 008e06f0
                        */
