...

{
  ...
  if (param_1 - 1 == 0) {
    ...
    param_1 = __next_prime(param_1);
                    /* try { // try from 00e0ceb8 to 00f0cef7 has its CatchHandler @ 00e0ceb8
                       catch() { ... } // from try @ 00e0ceb8 with catch @ 00e0ceb8
                       catch() { ... } // from try @ 00e0d004 with catch @ 00e0ceb8 */
  }
  uVar2 = *(ulong *)(this + 8);
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      uVar1 = (ulong)((float)*(ulong *)(this + 0x18) / *(float *)(this + 0x20));
                    /* try { // try from 00e0cef8 to 00f0cf0b has its CatchHandler @ 00e0d0a0 */
      if ((uVar2 < 3) ||
        ...
        uVar1 = __next_prime(uVar1);
                    ...
                    /* try { // try from 00e0cf24 to 00f0cf2b has its CatchHandler @ 00e0d08c */
      ...
      param_1 = uVar1;
      if (uVar1 < uVar2) goto LAB_00e0cf44;
    }
    return;
  }
LAB_00e0cf44:
