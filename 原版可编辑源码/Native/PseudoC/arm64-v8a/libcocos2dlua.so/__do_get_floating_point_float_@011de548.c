...

{
  ...
  local_178 = local_130;
  local_170 = pcVar7;
  if (param_2 != (long *)0x0) goto LAB_011de608;
LAB_011de614:
  if (param_3 == (long *)0x0) goto LAB_011de660;
  while( true ) {
    ...
    while( true ) {
      ...
      plVar6 = param_2;
      if (param_2 == (long *)0x0) goto LAB_011de614;
LAB_011de608:
      param_2 = plVar6;
      if (plVar6[3] != plVar6[4]) goto LAB_011de614;
...
LAB_011de660:
      param_3 = (long *)0x0;
      if (param_2 == (long *)0x0) goto LAB_011de754;
    }
  }
LAB_011de754:
  ...
  uVar8 = FUN_01208d8c(pcVar7,local_170,param_5);
  *param_6 = uVar8;
  __check_grouping(local_150,local_130,local_178,param_5);
  plVar6 = param_2;
  if ((param_2 == (long *)0x0) || (param_2[3] != param_2[4])) {
    if (param_3 != (long *)0x0) goto LAB_011de7d8;
LAB_011de880:
    if (plVar6 != (long *)0x0) goto LAB_011de80c;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_011de880;
LAB_011de7d8:
    if ((param_3[3] == param_3[4]) && (iVar3 = (**(code **)(*param_3 + 0x48))(param_3), iVar3 == -1)
       ) goto LAB_011de880;
    if (plVar6 == (long *)0x0) goto LAB_011de80c;
