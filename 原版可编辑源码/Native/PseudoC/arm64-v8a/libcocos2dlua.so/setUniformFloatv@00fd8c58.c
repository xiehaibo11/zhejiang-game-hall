...
/* cocos2d::GLProgramState::setUniformFloatv(int, long, float const*) */

void __thiscall
cocos2d::GLProgramState::setUniformFloatv
          (GLProgramState *this,int param_1,long param_2,float *param_3)

{
  ...
  ulong uVar9;
                    ...
                    /* catch() { ... } // from try @ 00fd8c90 with catch @ 00fd8c64 */
  updateUniformsAndAttributes(this);
  uVar2 = *(ulong *)(this + 0x58);
  if (uVar2 != 0) {
                    /* try { // try from 00fd8c88 to 010d8c8f has its CatchHandler @ 00fd8ccc */
    ...
    uVar9 = CONCAT62((int6)((ulong)uVar8 >> 0x10),uVar7);
                    /* try { // try from 00fd8c90 to 010d8ce7 has its CatchHandler @ 00fd8c64 */
    uVar3 = (ulong)param_1;
    ...
    plVar5 = *(long **)(*(long *)(this + 0x50) + uVar4 * 8);
                    /* catch() { ... } // from try @ 00fd8c88 with catch @ 00fd8ccc */
    if ((plVar5 != (long *)0x0) && (plVar5 = (long *)*plVar5, plVar5 != (long *)0x0)) {
      do {
        ...
        if (uVar6 == uVar3) {
          ...
          if ((uVar9 & 0xffffffff) < 2) {
                    /* try { // try from 00fd8d18 to 010d8d6f has its CatchHandler @ 00fd8ce8 */
            uVar6 = uVar6 & uVar2 - 1;
          }
          else if (uVar2 <= uVar6) {
            uVar1 = 0;
            if (uVar2 != 0) {
              uVar1 = uVar6 / uVar2;
                    ...
                    /* try { // try from 00fd8d10 to 010d8d17 has its CatchHandler @ 00fd8d54 */
          ...
          if (uVar6 != uVar4) {
            return;
                    ...
                    /* catch() { ... } // from try @ 00fd8d18 with catch @ 00fd8ce8 */
        plVar5 = (long *)*plVar5;
