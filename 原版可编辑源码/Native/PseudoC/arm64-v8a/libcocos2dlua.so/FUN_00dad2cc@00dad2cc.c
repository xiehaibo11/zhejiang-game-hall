...
void FUN_00dad2cc(long *param_1,long *param_2)
  ...
  if (param_2 != param_1) {
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
        ...
        param_1[4] = 0;
                    /* try { // try from 00dad3b0 to 00ead3e3 has its CatchHandler @ 00dad3b0
                       catch() { ... } // from try @ 00dad3b0 with catch @ 00dad3b0
                       catch() { ... } // from try @ 00dad438 with catch @ 00dad3b0 */
        (**(code **)(*(long *)param_2[4] + 0x18))((long *)param_2[4],param_1);
        (**(code **)(*(long *)param_2[4] + 0x20))();
        param_2[4] = 0;
        param_1[4] = (long)param_1;
                    /* try { // try from 00dad3e4 to 00ead3ef has its CatchHandler @ 00dad468 */
      ...
      if (param_2 == plVar3) {
        ...
        param_2[4] = (long)plVar2;
                    ...
                    /* try { // try from 00dad40c to 00ead437 has its CatchHandler @ 00dad450 */
