  ...
  if (uVar8 != 0) {
    ...
    if (uVar4 < 2) {
      unaff_x24 = uVar8 - 1 & uVar9;
                    ...
                    /* try { // try from 00fd219c to 010d219f has its CatchHandler @ 00fd21b0 */
      unaff_x24 = uVar9;
      if (uVar8 <= uVar9) {
        uVar6 = 0;
        if (uVar8 != 0) {
    ...
    if (plVar7 != (long *)0x0) {
      for (plVar7 = (long *)*plVar7; plVar7 != (long *)0x0; plVar7 = (long *)*plVar7) {
                    /* try { // try from 00fd21f8 to 010d21fb has its CatchHandler @ 00fd2214 */
        uVar6 = plVar7[1];
        if (uVar6 != uVar9) {
          if (uVar4 < 2) {
            uVar6 = uVar6 & uVar8 - 1;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fd21f8 with catch @ 00fd2214
                        */
            uVar2 = 0;
            if (uVar8 != 0) {
              uVar2 = uVar6 / uVar8;
            }
            if (uVar6 - uVar2 * uVar8 == unaff_x24) goto LAB_00fd21e4;
            break;
          }
...
LAB_00fd21e4:
  ...
  *(undefined4 *)(plVar7 + 2) = uVar1;
                    /* try { // try from 00fd2258 to 010d225b has its CatchHandler @ 00fd2274 */
  if ((uVar8 == 0) || ((float)param_1[8] * (float)uVar8 < (float)(*(long *)(param_1 + 6) + 1))) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fd2258 with catch @ 00fd2274
                        */
    ...
    rehash((__hash_table<std::__ndk1::__hash_value_type<int,std::__ndk1::pair<void*,unsigned_int>>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,std::__ndk1::pair<void*,unsigned_int>>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,std::__ndk1::pair<void*,unsigned_int>>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,std::__ndk1::pair<void*,unsigned_int>>>>
            *)param_1,uVar4);
    uVar8 = *(ulong *)(param_1 + 2);
    if ((uVar8 & uVar8 - 1) == 0) {
      unaff_x24 = uVar8 - 1 & uVar9;
      ...
      unaff_x24 = uVar9;
      if (uVar8 <= uVar9) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fd22bc with catch @ 00fd22d0
                        */
        uVar4 = 0;
        if (uVar8 != 0) {
          uVar4 = uVar9 / uVar8;
  ...
  if (plVar3 == (long *)0x0) {
    ...
    *(long **)(lVar5 + unaff_x24 * 8) = plVar3;
    if (*plVar7 == 0) goto LAB_00fd2340;
    uVar9 = *(ulong *)(*plVar7 + 8);
                    /* try { // try from 00fd2318 to 010d231b has its CatchHandler @ 00fd2334 */
    if ((uVar8 & uVar8 - 1) == 0) {
      uVar9 = uVar9 & uVar8 - 1;
    }
    else if (uVar8 <= uVar9) {
      ...
      uVar9 = uVar9 - uVar4 * uVar8;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00fd2318 with catch @ 00fd2334
                        */
