...
/* cocos2d::PhysicsJointDistance::construct(cocos2d::PhysicsBody*, cocos2d::PhysicsBody*,
   cocos2d::Vec2 const&, cocos2d::Vec2 const&) */
...

{
  ...
  if (pPVar2 != (PhysicsJoint *)0x0) {
                    /* try { // try from 010044d4 to 0110460f has its CatchHandler @ 010044d4
                       catch() { ... } // from try @ 010044d4 with catch @ 010044d4
                       catch() { ... } // from try @ 01004618 with catch @ 010044d4 */
    ...
    *(undefined ***)pPVar2 = &PTR__PhysicsJoint_01725198;
