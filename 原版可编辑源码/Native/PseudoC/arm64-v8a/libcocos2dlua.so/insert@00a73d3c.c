...
/* std::__ndk1::vector<fairygui::GObject*, std::__ndk1::allocator<fairygui::GObject*>
   >::insert(std::__ndk1::__wrap_iter<fairygui::GObject* const*>, fairygui::GObject* const&) */
...

{
  ...
  if (puVar10 < *(undefined8 **)(this + 0x10)) {
    if (param_2 != puVar10) {
      ...
      for (puVar5 = puVar10 + -1; puVar5 < puVar10; puVar5 = puVar5 + 1) {
                    /* try { // try from 00a73d98 to 00b73de3 has its CatchHandler @ 00a73d98
                       catch() { ... } // from try @ 00a73d98 with catch @ 00a73d98
                       catch() { ... } // from try @ 00a73de8 with catch @ 00a73d98 */
        *puVar8 = *puVar5;
        puVar8 = puVar8 + 1;
      }
  ...
  pvVar9 = *(void **)this;
                    /* try { // try from 00a73de4 to 00b73de7 has its CatchHandler @ 00a73e1c */
                    /* try { // try from 00a73de8 to 00b73e2f has its CatchHandler @ 00a73d98 */
  ...
  if ((ulong)(lVar6 >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar4 >> 0x3d != 0) {
                    /* catch() { ... } // from try @ 00a73de4 with catch @ 00a73e1c */
                    /* WARNING: Subroutine does not return */
    ...
    uVar4 = 0x1fffffffffffffff;
                    ...
                    /* try { // try from 00a73e30 to 00b73fef has its CatchHandler @ 00a73e30
                       catch() { ... } // from try @ 00a73e30 with catch @ 00a73e30
                       catch() { ... } // from try @ 00a74070 with catch @ 00a73e30 */
