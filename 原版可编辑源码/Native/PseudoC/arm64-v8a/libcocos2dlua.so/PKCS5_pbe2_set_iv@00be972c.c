...
LAB_00be993c:
    ...
    *puVar7 = pAVar3;
    ...
    puVar7[1] = pAVar4;
    if (pAVar4 == (ASN1_TYPE *)0x0) goto LAB_00be9938;
    iVar2 = EVP_CIPHER_iv_length(cipher);
    if (iVar2 == 0) {
LAB_00be9814:
      ctx = EVP_CIPHER_CTX_new();
      if (ctx == (EVP_CIPHER_CTX *)0x0) goto LAB_00be9938;
...
LAB_00be98c0:
      ...
      *(X509_ALGOR **)val = pXVar5;
      if (pXVar5 == (X509_ALGOR *)0x0) goto LAB_00be9938;
