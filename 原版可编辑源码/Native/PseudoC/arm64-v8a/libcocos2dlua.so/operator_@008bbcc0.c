...
/* std::__ndk1::function<void ()>& std::__ndk1::function<void
   ()>::TEMPNAMEPLACEHOLDERVALUE(std::__ndk1::__bind<void (GLNode::*)(cocos2d::Mat4 const&, unsigned
   int), GLNode*, cocos2d::Mat4 const&, unsigned int&>&&) */
...

{
  ...
  *plVar2 = (long)&PTR____func_0169b268;
  plVar2[2] = lVar6;
  plVar2[1] = lVar5;
  plVar2[3] = lVar3;
  ...
  *(undefined4 *)(plVar2 + 0xc) = local_78;
  ...
  if (alStack_70 == local_50) {
    ...
    if (local_50 == (long *)0x0) goto LAB_008bbd94;
