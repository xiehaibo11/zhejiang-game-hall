...
undefined8 FUN_01139934(long param_1,void *param_2,long param_3)

{
  ...
  if (lVar3 < 1) {
    ...
    uVar6 = 0x10;
    do {
      if ((int)uVar6 < 8) goto LAB_01139b78;
      uVar6 = uVar6 - 8;
      lVar8 = 0;
      pbVar4 = pbVar17;
      do {
        ...
        if ((char)*pbVar4 < '\0') {
          ...
          if ((lVar8 < lVar3) && (iVar9 = uVar1 - 0x7e, iVar9 != 0)) {
            ...
            if ((0xf < uVar11) && (uVar13 = uVar11 & 0x1fffffff0, uVar13 != 0)) {
              ...
              lVar8 = lVar12;
              if (uVar13 == uVar11) goto joined_r0x01139af8;
            }
            iVar9 = -iVar9;
            do {
              iVar9 = iVar9 + 1;
