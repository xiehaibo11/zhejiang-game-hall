...
void FUN_0114f1dc(long param_1,int param_2,int param_3,byte *param_4,long param_5)

{
  ...
  if ((int)uVar4 < 8) {
    ...
    return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0114f28c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*DAT_01796120)(param_4,lVar6,param_5,param_2,param_3);
  return;
}
