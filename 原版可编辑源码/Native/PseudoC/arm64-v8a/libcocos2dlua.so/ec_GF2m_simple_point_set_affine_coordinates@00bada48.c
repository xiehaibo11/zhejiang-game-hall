...

{
  ...
  if ((param_3 == (BIGNUM *)0x0) || (param_4 == (BIGNUM *)0x0)) {
                    /* try { // try from 00badad4 to 00cadb03 has its CatchHandler @ 00badc54 */
    ERR_put_error(0x10,0xa3,0x43,"crypto/ec/ec2_smpl.c",0x169);
    uVar2 = 0;
  }
  else {
    pBVar1 = BN_copy(*(BIGNUM **)(param_2 + 8),param_3);
                    /* try { // try from 00bada70 to 00cada77 has its CatchHandler @ 00badc04 */
    uVar2 = 0;
    if (pBVar1 != (BIGNUM *)0x0) {
      ...
      if (pBVar1 != (BIGNUM *)0x0) {
        ...
        pBVar1 = BN_value_one();
                    /* try { // try from 00badaa4 to 00cadaaf has its CatchHandler @ 00badc08 */
