...
/* cocos2d::DrawNode::onDrawGLLine(cocos2d::Mat4 const&, unsigned int) */

void cocos2d::DrawNode::onDrawGLLine(Mat4 *param_1,uint param_2)

{
  ...
  basic_string<decltype(nullptr)>(local_50,GLProgram::SHADER_NAME_POSITION_LENGTH_TEXTURE_COLOR);
  ...
  if (param_1[0x452] != (Mat4)0x0) {
    glBindBuffer(0x8892,*(undefined4 *)(param_1 + 0x30c));
    glBufferData(0x8892,(long)*(int *)(param_1 + 0x344) * 0x14,*(undefined8 *)(param_1 + 0x350),
                 0x88e0);
    param_1[0x452] = (Mat4)0x0;
  }
  ...
  if ((uVar5 & 1) == 0) {
    ...
    GL::bindVAO(*(uint *)(param_1 + 0x308));
  }
  glLineWidth(*(undefined4 *)(param_1 + 0x454));
  glDrawArrays(1,0,*(undefined4 *)(param_1 + 0x348));
  pCVar4 = (Configuration *)Configuration::getInstance();
  uVar5 = Configuration::supportsShareableVAO(pCVar4);
  if ((uVar5 & 1) != 0) {
    GL::bindVAO(0);
  ...
  *plVar1 = *plVar1 + 1;
  *(long *)((long)&__DT_SYMTAB[0xa30].st_name + lVar7) = lVar6 + *(int *)(param_1 + 0x348);
