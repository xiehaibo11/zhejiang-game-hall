...
/* cocos2d::Console::getSubCommand(cocos2d::Console::Command const&, std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

undefined8 __thiscall
cocos2d::Console::getSubCommand(Console *this,Command *param_1,basic_string *param_2)
