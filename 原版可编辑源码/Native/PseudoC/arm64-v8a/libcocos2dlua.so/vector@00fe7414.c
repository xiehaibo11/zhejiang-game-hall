...
/* std::__ndk1::vector<cocos2d::RenderCommand*, std::__ndk1::allocator<cocos2d::RenderCommand*>
   >::vector(std::__ndk1::vector<cocos2d::RenderCommand*,
   std::__ndk1::allocator<cocos2d::RenderCommand*> > const&) */

void __thiscall
std::__ndk1::vector<cocos2d::RenderCommand*,std::__ndk1::allocator<cocos2d::RenderCommand*>>::vector
