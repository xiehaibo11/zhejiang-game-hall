...
/* flatbuffers::CreatePageViewOptions(flatbuffers::FlatBufferBuilder&,
   ...
   flatbuffers::FlatSize const*, unsigned char) */

undefined4
flatbuffers::CreatePageViewOptions
          ...
          CapInsets *param_11,FlatSize *param_12,uchar param_13)
