...
/* cocos2d::unzGoToFilePos(void*, cocos2d::unz_file_pos_s*) */

undefined8 cocos2d::unzGoToFilePos(void *param_1,unz_file_pos_s *param_2)

{
  ...
  uVar1 = 0xffffff9a;
  if ((param_1 != (void *)0x0) && (param_2 != (unz_file_pos_s *)0x0)) {
