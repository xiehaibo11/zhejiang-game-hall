...
void FUN_00f3c3c0(long *param_1,long *param_2)

{
  ...
  if (param_2 != param_1) {
    ...
    if (plVar2 == param_1) {
      ...
      if (param_2 == plVar3) {
                    /* try { // try from 00f3c44c to 0103c5cf has its CatchHandler @ 00f3c44c
                       catch() { ... } // from try @ 00f3c44c with catch @ 00f3c44c
                       catch() { ... } // from try @ 00f3c5d8 with catch @ 00f3c44c
                       catch() { ... } // from try @ 00f3c7e0 with catch @ 00f3c44c */
