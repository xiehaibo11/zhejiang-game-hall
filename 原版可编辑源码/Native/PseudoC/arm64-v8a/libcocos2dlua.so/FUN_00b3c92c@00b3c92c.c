...
ulong FUN_00b3c92c(long param_1,ulong param_2,ulong *param_3)

{
  ...
  if (iVar2 != 0x72) {
    iVar2 = FUN_00b3cd68(pEVar10,lVar12,uVar13,puVar5,lVar11,param_2,uVar9);
    return (ulong)(iVar2 != 0);
  }
  pEVar10 = EVP_md5();
  lVar1 = (uVar13 >> 1) + (uVar13 & 1);
  uVar3 = FUN_00b3cd68(pEVar10,lVar12,lVar1,puVar5,lVar11,param_2,uVar9);
  if ((int)uVar3 == 0) {
    return uVar3;
  }
  ...
  pEVar10 = EVP_sha1();
  iVar2 = FUN_00b3cd68(pEVar10,lVar12 + (uVar13 >> 1),lVar1,puVar5,lVar11,pvVar4,uVar9);
  if (iVar2 == 0) {
    CRYPTO_clear_free(pvVar4,uVar9,"crypto/kdf/tls1_prf.c",0xfd);
    return 0;
  }
  if (uVar9 == 0) goto LAB_00b3ca44;
  if (uVar9 < 0x20) {
LAB_00b3ca1c:
    uVar13 = 0;
  }
    ...
    if (uVar13 != 0) {
      ...
      if (uVar9 == uVar13) goto LAB_00b3ca44;
    }
  }
  lVar12 = uVar9 - uVar13;
