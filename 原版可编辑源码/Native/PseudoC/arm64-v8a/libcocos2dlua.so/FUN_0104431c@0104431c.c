...
uint FUN_0104431c(long param_1,int param_2,uint param_3,long param_4)

{
  ...
  lVar2 = tpidr_el0;
                    /* try { // try from 01044338 to 0114433f has its CatchHandler @ 010443dc */
  local_48 = *(long *)(lVar2 + 0x28);
                    /* try { // try from 01044340 to 011443f7 has its CatchHandler @ 01044304 */
  local_ec = 0x80;
...
joined_r0x01044454:
    ...
    puVar5 = (undefined4 *)__errno();
                    /* catch() { ... } // from try @ 01044338 with catch @ 010443dc */
