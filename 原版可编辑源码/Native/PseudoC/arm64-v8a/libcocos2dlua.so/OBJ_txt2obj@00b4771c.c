...
LAB_00b47834:
      ...
      do {
        ...
        iVar3 = iVar3 >> 1;
        puVar9 = (uint *)(&DAT_013e4094 + (long)iVar3 * 4);
        iVar4 = strcmp((char *)puVar5,(&PTR_s_UNDEF_016b3c38)[(ulong)*puVar9 * 5]);
      } while ((iVar4 < 0) || (iVar2 = iVar3 + 1, iVar3 = iVar10, iVar4 != 0));
      if (puVar9 != (uint *)0x0) {
        ppuVar8 = &PTR_s_UNDEF_016b3c38 + (ulong)*puVar9 * 5;
        goto LAB_00b478b4;
      }
LAB_00b478c0:
      local_90 = s;
...
LAB_00b478f8:
        ...
        do {
          ...
          iVar3 = iVar3 >> 1;
          puVar9 = (uint *)(&DAT_013e3024 + (long)iVar3 * 4);
          iVar4 = strcmp(__s1,(&PTR_s_undefined_016b3c40)[(ulong)*puVar9 * 5]);
        } while ((iVar4 < 0) || (iVar2 = iVar3 + 1, iVar3 = iVar10, iVar4 != 0));
        if (puVar9 == (uint *)0x0) goto LAB_00b47744;
        ppuVar8 = &PTR_s_UNDEF_016b3c38 + (ulong)*puVar9 * 5;
      }
      else {
        local_68 = &local_98;
        local_70 = (uchar *)CONCAT44(local_70._4_4_,2);
        lVar7 = OPENSSL_LH_retrieve(DAT_01784a28,&local_70);
        if (lVar7 == 0) goto LAB_00b478f8;
        ppuVar8 = *(undefined ***)(lVar7 + 8);
      }
      uVar1 = *(uint *)(ppuVar8 + 2);
      if (uVar1 == 0) goto LAB_00b47744;
    }
    else {
      local_68 = &local_98;
      local_70 = (uchar *)CONCAT44(local_70._4_4_,1);
      lVar7 = OPENSSL_LH_retrieve(DAT_01784a28,&local_70);
      if (lVar7 == 0) goto LAB_00b47834;
      ppuVar8 = *(undefined ***)(lVar7 + 8);
LAB_00b478b4:
      uVar1 = *(uint *)(ppuVar8 + 2);
      if (uVar1 == 0) goto LAB_00b478c0;
    }
    if (uVar1 < 0x425) {
      if (*(int *)(&DAT_016b3c48 + (long)(int)uVar1 * 0x28) != 0) {
        return (ASN1_OBJECT *)(&PTR_s_UNDEF_016b3c38 + (long)(int)uVar1 * 5);
      }
      iVar2 = 0xe3;
    }
    else {
