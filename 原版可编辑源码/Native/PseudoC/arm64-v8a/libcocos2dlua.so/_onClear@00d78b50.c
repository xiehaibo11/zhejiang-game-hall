...
/* dragonBones::BoneTimelineState::_onClear() */

void __thiscall dragonBones::BoneTimelineState::_onClear(BoneTimelineState *this)

{
  *(undefined8 *)(this + 0x10) = 0xffffffffffffffff;
                    /* try { // try from 00d78b5c to 00e78b8b has its CatchHandler @ 00d78638 */
  ...
  *(undefined4 *)(this + 0x18) = 0xbf800000;
                    /* try { // try from 00d78b8c to 00e78b97 has its CatchHandler @ 00d79af8 */
  *(undefined8 *)(this + 0x24) = 0;
  *(undefined8 *)(this + 0x1c) = 0;
  *(undefined8 *)(this + 0x2c) = 0xffffffff00000000;
