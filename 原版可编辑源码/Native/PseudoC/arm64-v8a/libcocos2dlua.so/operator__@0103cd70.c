...
std::__ndk1::basic_ostream<char,std::__ndk1::char_traits<char>>::operator<<
          (basic_ostream<char,std::__ndk1::char_traits<char>> *this,longlong param_1)

{
  ...
  local_58 = *(long *)(lVar3 + 0x28);
                    /* catch() { ... } // from try @ 0103cd34 with catch @ 0103cd94 */
  ...
  if (*(int *)(this + *(long *)(*(long *)this + -0x18) + 0x20) == 0) {
    ...
    ios_base::getloc();
                    /* try { // try from 0103cdf0 to 0113cf37 has its CatchHandler @ 0103cdf0
                       catch() { ... } // from try @ 0103cdf0 with catch @ 0103cdf0
                       catch() { ... } // from try @ 0103cf5c with catch @ 0103cdf0
                       catch() { ... } // from try @ 0103cf8c with catch @ 0103cdf0
                       catch() { ... } // from try @ 0103d0f8 with catch @ 0103cdf0
                       catch() { ... } // from try @ 0103d124 with catch @ 0103cdf0 */
    ...
    lVar7 = (**(code **)(*plVar5 + 0x28))(plVar5,uVar8,pbVar1,iVar2,param_1);
    if (lVar7 == 0) {
