...
long FUN_010f18bc(long *param_1,long *param_2,uint param_3,uint param_4,int param_5)

{
  ...
  if ((param_3 < *(uint *)((long)param_2 + 0x1c)) ||
    ...
    if ((int)param_2[5] != 0) {
      ...
      *(undefined4 *)(param_2 + 5) = 0;
                    ...
                    /* try { // try from 010f1a34 to 011f1b2b has its CatchHandler @ 010f1a34
                       catch() { ... } // from try @ 010f1a34 with catch @ 010f1a34
                       catch() { ... } // from try @ 010f1b74 with catch @ 010f1a34 */
  ...
  uVar8 = *(uint *)(param_2 + 4);
                    /* try { // try from 010f1b2c to 011f1b37 has its CatchHandler @ 010f1c44 */
  if (uVar1 <= uVar8) goto LAB_010f1be8;
  if (uVar8 < param_3) {
    uVar8 = param_3;
    if (param_5 == 0) {
      bVar5 = false;
      ...
      *(undefined4 *)(puVar6 + 5) = 0x17;
      (*(code *)*puVar6)(param_1);
LAB_010f1b64:
                    /* try { // try from 010f1b64 to 011f1b73 has its CatchHandler @ 010f1c58 */
      bVar5 = true;
    ...
    if (param_5 != 0) goto LAB_010f1b64;
    bVar5 = false;
    iVar4 = *(int *)((long)param_2 + 0x24);
  }
  if (iVar4 == 0) {
    if (!bVar5) {
      ...
      *(undefined4 *)(puVar6 + 5) = 0x17;
      (*(code *)*puVar6)(param_1);
                    ...
                    /* try { // try from 010f1b74 to 011f1c73 has its CatchHandler @ 010f1a34 */
