...
undefined8 FUN_008c4f8c(undefined8 param_1)

{
  ...
  if ((((iVar3 == 0) || (iVar3 = tolua_isnumber(param_1,2,0,auStack_78), iVar3 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glUniform2fv\'.",auStack_78);
  }
  else {
    dVar7 = (double)tolua_tonumber(0,param_1,1);
    dVar8 = (double)tolua_tonumber(0,param_1,2);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 008c4f6c with catch @ 008c5054
                        */
    ...
    if (pvVar4 != (void *)0x0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 008c4d94 with catch @ 008c5088
                        */
      if (0 < (int)uVar6) {
        uVar5 = 0;
        do {
