...
/* fairygui::UBBParser::onTag_COLOR(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
...
void __thiscall
fairygui::UBBParser::onTag_COLOR
...

{
  ...
  if (param_2) {
    ...
    std::__ndk1::operator+
              ((__ndk1 *)"<font color=\"",(char *)param_3,(basic_string *)(ulong)param_2);
    pbVar4 = (basic_string *)
             std::__ndk1::
    ...
    *(ulong *)(param_4 + 1) = CONCAT17(local_51,uStack_58);
    ...
    param_4 = (basic_string *)(this + 0x10);
    if (param_4 == param_3) goto LAB_00ab8fc8;
