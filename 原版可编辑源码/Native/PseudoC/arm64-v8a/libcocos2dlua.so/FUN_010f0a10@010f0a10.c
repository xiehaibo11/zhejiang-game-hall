...
long FUN_010f0a10(long *param_1,uint param_2,ulong param_3)

{
  ...
  if (puVar5 == (undefined8 *)0x0) {
    ...
    do {
      puVar3 = puVar5;
      uVar6 = puVar3[2];
      if (param_3 <= uVar6) goto LAB_010f0b74;
  ...
  *puVar3 = 0;
  puVar3[1] = 0;
                    /* try { // try from 010f0b6c to 011f0b9f has its CatchHandler @ 010f0b6c
                       catch() { ... } // from try @ 010f0b6c with catch @ 010f0b6c
                       catch() { ... } // from try @ 010f0c28 with catch @ 010f0b6c */
  puVar3[2] = uVar6;
  *puVar4 = puVar3;
LAB_010f0b74:
  lVar7 = puVar3[1];
  ...
  puVar3[2] = uVar6 - param_3;
                    /* try { // try from 010f0ba0 to 011f0bab has its CatchHandler @ 010f0ca4 */
