...
void FUN_011f5994(long param_1,__shared_count *param_2)

{
  ...
  local_70 = &std::__ndk1::moneypunct<char,true>::id;
  uStack_60 = 0;
  ...
  if (std::__ndk1::moneypunct<char,true>::id != -1) {
    ...
    std::__ndk1::__call_once
              ((ulong *)&std::__ndk1::moneypunct<char,true>::id,&local_58,FUN_01208130);
  }
  uVar2 = (ulong)DAT_01794248;
  uVar6 = uVar2 - 1;
