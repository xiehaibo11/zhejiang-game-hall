...
/* lua_cocos2dx_extension_AssetsManager_getVersion(lua_State*) */

void lua_cocos2dx_extension_AssetsManager_getVersion(lua_State *param_1)

{
  ...
  if (iVar4 + -1 == 0) {
    ...
    luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d \n",
               "cc.AssetsManager:getVersion",iVar4 + -1,0);
    uVar5 = 0;
  }
