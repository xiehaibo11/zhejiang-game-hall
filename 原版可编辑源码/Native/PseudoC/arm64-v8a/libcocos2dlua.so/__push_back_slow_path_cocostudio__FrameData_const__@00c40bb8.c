...
/* void std::__ndk1::vector<cocostudio::FrameData*, std::__ndk1::allocator<cocostudio::FrameData*>
   >::__push_back_slow_path<cocostudio::FrameData* const&>(cocostudio::FrameData* const&) */
