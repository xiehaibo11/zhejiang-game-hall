...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > >,
   std::__ndk1::allocator<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > > > > > >::__rehash(unsigned long) */
...

{
  ...
  undefined8 uVar19;
                    ...
                    /* try { // try from 00f4b54c to 0104b553 has its CatchHandler @ 00f4d55c */
                    /* try { // try from 00f4b55c to 0104b56b has its CatchHandler @ 00f4d558 */
  if (param_1 == 0) {
    pvVar8 = *(void **)this;
    *(undefined8 *)this = 0;
    if (pvVar8 != (void *)0x0) {
    ...
    *(undefined8 *)(this + 8) = 0;
    ...
    pvVar8 = operator_new(param_1 << 3);
                    /* try { // try from 00f4b578 to 0104b57f has its CatchHandler @ 00f4d540 */
    pvVar9 = *(void **)this;
    *(void **)this = pvVar8;
    if (pvVar9 != (void *)0x0) {
    ...
    if (plVar15 != (long *)0x0) {
      ...
      if (uVar13 < 2) {
        ...
        uVar10 = uVar10 - uVar17 * param_1;
                    ...
                    /* try { // try from 00f4b604 to 0104b60f has its CatchHandler @ 00f4d5e8 */
      *(__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::set<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,std::__ndk1::allocator<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>>>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::set<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,std::__ndk1::allocator<std::__ndk1::basic_string<char,s___tor<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>>>>>
        **)(*(long *)this + uVar10 * 8) = this + 0x10;
      if ((long *)*plVar15 != (long *)0x0) {
        plVar16 = (long *)*plVar15;
                    /* try { // try from 00f4b61c to 0104b61f has its CatchHandler @ 00f4d584 */
        do {
          uVar17 = plVar16[1];
          if (uVar13 < 2) {
          ...
          if (uVar17 != uVar10) {
            if (*(long *)(*(long *)this + uVar17 * 8) == 0) {
              *(long **)(*(long *)this + uVar17 * 8) = plVar15;
              uVar10 = uVar17;
                    /* try { // try from 00f4b774 to 0104b77f has its CatchHandler @ 00f4d5e8 */
            }
            else {
              ...
              if (plVar11 != (long *)0x0) {
                ...
                do {
                  ...
                  bVar1 = *(byte *)(plVar12 + 2);
                    /* try { // try from 00f4b6bc to 0104b6c3 has its CatchHandler @ 00f4d54c */
                  sVar3 = (ulong)(bVar1 >> 1);
                  if ((bVar1 & 1) != 0) {
                    sVar3 = plVar12[3];
                  }
                    /* try { // try from 00f4b6cc to 0104b6db has its CatchHandler @ 00f4d548 */
                  if (__n != sVar3) break;
                  __s2 = (char *)plVar12[4];
                  ...
                  if ((bVar1 & 1) == 0) {
                    ...
                    /* try { // try from 00f4b6e8 to 0104b6ef has its CatchHandler @ 00f4d530 */
                  pcVar5 = (char *)((long)plVar16 + 0x11);
                  sVar3 = (ulong)(bVar2 >> 1);
                  sVar6 = __n;
                  if ((bVar2 & 1) == 0) {
                    while (sVar6 != 0) {
                      if (*pcVar5 != *__s2) goto LAB_00f4b744;
                      __s2 = __s2 + 1;
                      sVar3 = sVar3 - 1;
                      pcVar5 = pcVar5 + 1;
                      sVar6 = sVar3;
                    ...
                    /* try { // try from 00f4b6a0 to 0104b6b7 has its CatchHandler @ 00f4d5b4 */
...
LAB_00f4b744:
          ...
          plVar16 = plVar11;
                    ...
                    /* try { // try from 00f4b78c to 0104b78f has its CatchHandler @ 00f4d560 */
  return;
}
