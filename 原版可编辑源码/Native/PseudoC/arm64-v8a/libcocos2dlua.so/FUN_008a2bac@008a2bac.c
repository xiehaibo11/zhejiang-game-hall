...
void FUN_008a2bac(lua_State *param_1)

{
  ...
  if ((((iVar5 == 0) || (iVar5 = tolua_isusertype(param_1,2,"CCArray",0,auStack_48), iVar5 == 0)) ||
      (iVar5 = tolua_isnumber(param_1,3,0,auStack_48), iVar5 == 0)) ||
     (iVar5 = tolua_isnoobj(param_1,4,auStack_48), iVar5 == 0)) {
    uVar8 = lua_cocos2dx_Animation_createWithSpriteFrames(param_1);
  }
  else {
    ...
    pvVar7 = (void *)cocos2d::Animation::createWithSpriteFrames((Vector *)&local_60,(float)dVar9,1);
