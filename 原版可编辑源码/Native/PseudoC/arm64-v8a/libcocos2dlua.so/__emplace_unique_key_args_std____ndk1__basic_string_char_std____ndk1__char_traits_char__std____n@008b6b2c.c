      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if (uVar14 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_008b6c50;
            break;
          }
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_008b6cc0;
              }
              goto LAB_008b6c08;
            }
          }
...
LAB_008b6c08:
  ...
  plVar11[2] = 0;
  *plVar11 = 0;
  __s1 = (void *)cocos2d::Value::Value((Value *)(plVar15 + 5));
  *plVar15 = 0;
  plVar15[1] = uVar7;
  if ((uVar16 == 0) ||
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(basic_string **)(lVar13 + unaff_x27 * 8) = pbVar12;
    if (*plVar15 == 0) goto LAB_008b6df4;
