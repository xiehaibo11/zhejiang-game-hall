...

{
  ...
  if (a == (CMS_ContentInfo *)0x0) goto LAB_00b9c4c4;
  if (*(long *)(a + 8) == 0) {
    ...
    *(ASN1_VALUE **)(a + 8) = pAVar2;
    ...
    iVar1 = OBJ_obj2nid(*(ASN1_OBJECT **)a);
                    /* try { // try from 00b9c420 to 00c9c427 has its CatchHandler @ 00b9c7bc */
    if (iVar1 == 0x17) {
LAB_00b9c484:
      if ((*(long *)(a + 8) != 0) &&
      ...
      goto LAB_00b9c4c4;
                    ...
                    /* try { // try from 00b9c428 to 00c9c4f3 has its CatchHandler @ 00b9b8d4 */
    iVar1 = 0x83;
    reason = 0x6b;
    line = 0x1b;
  }
...
LAB_00b9c4c4:
  ...
  ERR_put_error(0x2e,0x7c,0x41,"crypto/cms/cms_env.c",0x78);
                    /* try { // try from 00b9c4f4 to 00c9c4ff has its CatchHandler @ 00b9c5b8 */
