    ...
    if (pXVar2 != (X509_NAME *)0x0) {
      if (urls != (char **)0x0) {
        if (*urls != (char *)0x0) {
          ...
          a->locator = psVar3;
          if (psVar3 == (stack_st_ACCESS_DESCRIPTION *)0x0) goto LAB_00b49e58;
        }
        pcVar7 = *urls;
...
LAB_00b49e94:
          ...
          a_00->method = pAVar4;
          if (pAVar4 == (ASN1_OBJECT *)0x0) goto LAB_00b49e94;
          pGVar5 = GENERAL_NAME_new();
          a_00->location = pGVar5;
          if (pGVar5 == (GENERAL_NAME *)0x0) goto LAB_00b49e94;
