...

{
  ...
  __hash_node_base *p_Var2;
  
  do {
    if (param_1 == (__hash_node_base *)0x0) {
      return;
    }
    p_Var2 = *(__hash_node_base **)param_1;
    if (((byte)param_1[0x58] & 1) == 0) {
      if (((byte)param_1[0x40] & 1) == 0) goto LAB_00e06824;
LAB_00e06848:
      operator_delete(*(void **)(param_1 + 0x50));
      if (((byte)param_1[0x28] & 1) != 0) goto LAB_00e06858;
LAB_00e0682c:
      _Var1 = param_1[0x10];
    }
    else {
                    /* try { // try from 00e06838 to 00f06863 has its CatchHandler @ 00e06ee4 */
      operator_delete(*(void **)(param_1 + 0x68));
      if (((byte)param_1[0x40] & 1) != 0) goto LAB_00e06848;
LAB_00e06824:
      if (((byte)param_1[0x28] & 1) == 0) goto LAB_00e0682c;
LAB_00e06858:
