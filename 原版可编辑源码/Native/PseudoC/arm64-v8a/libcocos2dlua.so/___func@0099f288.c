...
/* std::__ndk1::__function::__func<LUA_TableViewDataSource::tableCellSizeForIndex(cocos2d::extension::TableView*,
   ...
   long)::{lambda(lua_State*, int)#1}>, void (lua_State*, int)>::~__func() */
...
::~__func(__func<LUA_TableViewDataSource::tableCellSizeForIndex(cocos2d::extension::TableView*,long)::_lambda(lua_State*,int)_1_,std::__ndk1::allocator<LUA_TableViewDataSource::tableCellSizeForIndex(cocos2d::extension::TableView*,long)::_lambda(lua_State*,int)_1_>,void(lua_State*,int)>
          *this)
