...
/* cocos2d::ComponentContainer::remove(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

void __thiscall cocos2d::ComponentContainer::remove(ComponentContainer *this,basic_string *param_1)

{
  ...
  if (lVar3 != 0) {
    ...
    (**(code **)(*(long *)this_00 + 0x28))(this_00,0);
    Ref::release(this_00);
    uVar4 = 1;
  }
