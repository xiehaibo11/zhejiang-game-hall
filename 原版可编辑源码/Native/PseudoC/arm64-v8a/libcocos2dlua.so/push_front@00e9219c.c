...
/* std::__ndk1::__split_buffer<cocos2d::experimental::ThreadPool::Task*,
   std::__ndk1::allocator<cocos2d::experimental::ThreadPool::Task*>&>::push_front(cocos2d::experimental::ThreadPool::Task*
   const&) */
