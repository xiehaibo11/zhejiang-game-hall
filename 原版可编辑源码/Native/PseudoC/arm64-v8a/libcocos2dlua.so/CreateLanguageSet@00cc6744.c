...
/* flatbuffers::CreateLanguageSet(flatbuffers::FlatBufferBuilder&,
   flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<flatbuffers::LanguageItem> > >) */

undefined4 flatbuffers::CreateLanguageSet(FlatBufferBuilder *param_1,int param_2)

{
  ...
  uVar7 = FlatBufferBuilder::EndTable(param_1,(iVar3 - iVar4) + iVar5,1);
