...
/* cocos2d::PhysicsJointGear::construct(cocos2d::PhysicsBody*, cocos2d::PhysicsBody*, float, float)
    */

PhysicsJoint *
cocos2d::PhysicsJointGear::construct
          (PhysicsBody *param_1,PhysicsBody *param_2,float param_3,float param_4)

{
  ...
  long local_48;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010069c8 with catch @ 01006970
                       catch(type#1 @ 00000000) { ... } // from try @ 01006b98 with catch @ 01006970
                        */
  lVar1 = tpidr_el0;
  local_48 = *(long *)(lVar1 + 0x28);
  pPVar2 = operator_new(0x70,(nothrow_t *)&std::nothrow);
  if (pPVar2 != (PhysicsJoint *)0x0) {
                    /* try { // try from 010069c0 to 011069c7 has its CatchHandler @ 01006cbc */
    pPVar2[0x58] = (PhysicsJoint)0x0;
                    /* try { // try from 010069c8 to 01106b1f has its CatchHandler @ 01006970 */
    ...
    *(undefined ***)pPVar2 = &PTR__PhysicsJoint_01725318;
