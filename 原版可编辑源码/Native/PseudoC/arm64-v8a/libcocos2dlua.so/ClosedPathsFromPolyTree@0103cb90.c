...
/* ClipperLib::ClosedPathsFromPolyTree(ClipperLib::PolyTree const&,
...
void ClipperLib::ClosedPathsFromPolyTree(PolyTree *param_1,vector *param_2)

{
  ...
  puVar2 = *(undefined8 **)(param_2 + 8);
                    /* try { // try from 0103cba8 to 0113cbaf has its CatchHandler @ 0103cbf4 */
                    /* try { // try from 0103cbb0 to 0113cc0f has its CatchHandler @ 0103cb84 */
  if (puVar2 != puVar1) {
    if (puVar1 != puVar2) {
    ...
    *(undefined8 **)(param_2 + 8) = puVar1;
                    ...
                    /* catch() { ... } // from try @ 0103cba8 with catch @ 0103cbf4 */
  std::__ndk1::
  ...
  ;
                    /* catch() { ... } // from try @ 0103cc40 with catch @ 0103cc10 */
  AddPolyNodeToPolygons(param_1,2,param_2);
  return;
}
