...

{
  ...
  uVar6 = CONCAT62((int6)((ulong)uVar9 >> 0x10),uVar8) & 0xffffffff;
                    /* try { // try from 00f4aca8 to 0104acaf has its CatchHandler @ 00f4d5a4 */
  if (uVar6 < 2) {
    uVar4 = uVar3 - 1 & uVar4;
  }
  else {
                    /* try { // try from 00f4acb0 to 0104ad0f has its CatchHandler @ 00f4d600 */
    uVar7 = 0;
    if (uVar3 != 0) {
      uVar7 = uVar4 / uVar3;
    }
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar6 < 2) {
      ...
      uVar7 = uVar7 - uVar1 * uVar3;
                    ...
                    /* try { // try from 00f4ad24 to 0104ad27 has its CatchHandler @ 00f4d580 */
    if (uVar7 == uVar4) goto LAB_00f4ad6c;
  }
  if (*param_3 != 0) {
    ...
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
                    ...
                    /* try { // try from 00f4ad44 to 0104ad87 has its CatchHandler @ 00f4d5a0 */
      uVar1 = 0;
      if (uVar3 != 0) {
        uVar1 = uVar7 / uVar3;
      }
  ...
  if (*param_3 != 0) {
    ...
    if (uVar7 != uVar4) {
      *(long **)(*param_2 + uVar7 * 8) = plVar5;
                    ...
                    /* try { // try from 00f4adbc to 0104adcb has its CatchHandler @ 00f4d5b8 */
  *plVar5 = *param_3;
  *param_3 = 0;
