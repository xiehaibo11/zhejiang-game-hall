...
/* void std::__ndk1::vector<cocostudio::BaseTriggerCondition*,
   std::__ndk1::allocator<cocostudio::BaseTriggerCondition*>
   >::__push_back_slow_path<cocostudio::BaseTriggerCondition*
   const&>(cocostudio::BaseTriggerCondition* const&) */
...
::__push_back_slow_path<cocostudio::BaseTriggerCondition*const&>
          (vector<cocostudio::BaseTriggerCondition*,std::__ndk1::allocator<cocostudio::BaseTriggerCondition*>>
           *this,BaseTriggerCondition **param_1)
