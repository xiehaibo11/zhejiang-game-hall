...
undefined8 FUN_01138fc0(long param_1,void *param_2,long param_3)

{
  ...
  if (lVar2 < 1) {
    ...
    uVar5 = 0x20;
    do {
      if ((int)uVar5 < 8) goto LAB_01139204;
      uVar5 = uVar5 - 8;
      lVar7 = 0;
      pbVar3 = pbVar16;
      do {
        ...
        if ((char)*pbVar3 < '\0') {
          ...
          if ((lVar7 < lVar2) && (iVar8 = uVar1 - 0x7e, iVar8 != 0)) {
            ...
            if ((7 < uVar10) && (uVar12 = uVar10 & 0x1fffffff8, uVar12 != 0)) {
              ...
              lVar7 = lVar11;
              if (uVar12 == uVar10) goto joined_r0x01139184;
            }
            iVar8 = -iVar8;
            do {
              iVar8 = iVar8 + 1;
