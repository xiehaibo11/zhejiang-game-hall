...

{
  ...
  if ((puVar2 == (undefined8 *)0x0) || (plVar7 = (long *)*puVar2, plVar7 == (long *)0x0)) {
    ...
    FUN_012542ec("terminating");
  }
  uVar3 = __cxxabiv1::__isOurExceptionClass((_Unwind_Exception *)(plVar7 + 0xc));
  if ((uVar3 & 1) == 0) {
                    /* WARNING: Subroutine does not return */
    FUN_012542ec("terminating with %s foreign exception",PTR_s_uncaught_01781948);
  }
  ...
  uVar3 = FUN_01251618(&std::exception::typeinfo,lVar4,&local_28);
  puVar1 = PTR_s_uncaught_01781948;
  if ((uVar3 & 1) == 0) {
                    /* WARNING: Subroutine does not return */
    FUN_012542ec("terminating with %s exception of type %s",PTR_s_uncaught_01781948,uVar5);
  }
  uVar6 = (**(code **)(*local_28 + 0x10))();
                    /* WARNING: Subroutine does not return */
  FUN_012542ec("terminating with %s exception of type %s: %s",puVar1,uVar5,uVar6);
}
