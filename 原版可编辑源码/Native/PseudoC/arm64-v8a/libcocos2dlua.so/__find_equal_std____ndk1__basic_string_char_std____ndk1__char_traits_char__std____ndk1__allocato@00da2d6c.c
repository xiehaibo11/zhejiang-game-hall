...

{
  ...
  *__s1_00;
  ...
  __s1 = *(basic_string **)(param_2 + 0x10);
                    /* try { // try from 00da2da0 to 00ea2e27 has its CatchHandler @ 00da2b74 */
  p_Var5 = this + 8;
  if (((byte)*param_2 & 1) == 0) {
    __s1 = param_2 + 1;
  ...
  do {
    while( true ) {
      ...
      if (iVar4 == 0) break;
      if (iVar4 < 0) goto LAB_00da2e20;
LAB_00da2e38:
      if (((byte)_Var3 & 1) == 0) {
        __s1_00 = p_Var7 + 0x21;
      }
      iVar4 = memcmp(__s1_00,__s1,__n);
                    /* try { // try from 00da2e4c to 00ea2e53 has its CatchHandler @ 00da2f54 */
      if (iVar4 == 0) goto LAB_00da2db8;
      if (-1 < iVar4) goto LAB_00da2e54;
LAB_00da2dc0:
      p_Var5 = p_Var7 + 8;
      p_Var6 = *(__tree<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::vector<dragonBones::TimelineData*,std::__ndk1::allocator<dragonBones::TimelineData*>>>,std::__ndk1::__map_value_compare<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::vector<dragonBones::TimelineData*,std::__ndk1::allocator<dragonBones::TimelineData*>>>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::vector<dragonBones::TimelineData*,std::__ndk1::allocator<dragonBones::TimelineData*>>>>>
                 **)p_Var5;
...
LAB_00da2db8:
      if (uVar2 <= uVar1) goto LAB_00da2e54;
      goto LAB_00da2dc0;
    }
LAB_00da2e20:
    p_Var5 = p_Var7;
