...
/* cocostudio::SpriteFrameCacheHelper::removeSpriteFrameFromFile(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

void __thiscall
cocostudio::SpriteFrameCacheHelper::removeSpriteFrameFromFile
...

{
  ...
  cocos2d::SpriteFrameCache::removeSpriteFramesFromFile(this_00,param_1);
