...

{
  ...
  if (uVar6 < 2) {
    ...
    if (uVar3 != 0) {
      uVar7 = uVar4 / uVar3;
                    ...
                    /* try { // try from 00f04a00 to 01004a0f has its CatchHandler @ 00f04e9c */
    if (uVar3 <= uVar4) {
  ...
  do {
    plVar5 = plVar2;
                    /* try { // try from 00f04a20 to 01004a43 has its CatchHandler @ 00f04eb0 */
    plVar2 = (long *)*plVar5;
  } while ((long *)*plVar5 != param_3);
  if (plVar5 != param_2 + 2) {
    uVar7 = plVar5[1];
    if (uVar6 < 2) {
                    /* try { // try from 00f04a5c to 01004a67 has its CatchHandler @ 00f04e54 */
      uVar7 = uVar7 & uVar3 - 1;
    }
    else if (uVar3 <= uVar7) {
      uVar1 = 0;
    ...
    if (uVar7 == uVar4) goto LAB_00f04ab0;
  }
  if (*param_3 != 0) {
...
LAB_00f04ab0:
  if (*param_3 != 0) {
    uVar7 = *(ulong *)(*param_3 + 8);
                    /* try { // try from 00f04abc to 01004ac3 has its CatchHandler @ 00f04ee0 */
    if (uVar6 < 2) {
      uVar7 = uVar7 & uVar3 - 1;
    }
    else if (uVar3 <= uVar7) {
