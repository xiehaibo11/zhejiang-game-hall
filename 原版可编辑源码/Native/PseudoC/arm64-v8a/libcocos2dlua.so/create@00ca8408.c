...
/* cocostudio::timeline::BlendFuncFrame::create() */

Ref * cocostudio::timeline::BlendFuncFrame::create(void)

{
  ...
  if (this != (Ref *)0x0) {
    ...
    *(undefined8 *)(this + 0x58) = 0x30300000001;
    *(undefined ***)this = &PTR__Frame_016cc0e0;
