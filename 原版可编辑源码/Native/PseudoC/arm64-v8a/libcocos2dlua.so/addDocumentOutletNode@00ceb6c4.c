...
/* cocosbuilder::CCBAnimationManager::addDocumentOutletNode(cocos2d::Node*) */

void __thiscall
cocosbuilder::CCBAnimationManager::addDocumentOutletNode(CCBAnimationManager *this,Node *param_1)

{
  ...
  if (puVar1 == *(undefined8 **)(this + 0x110)) {
    ...
    __push_back_slow_path<cocos2d::Node*const&>
              ((vector<cocos2d::Node*,std::__ndk1::allocator<cocos2d::Node*>> *)(this + 0x100),
               &local_30);
  }
  else {
    *puVar1 = param_1;
