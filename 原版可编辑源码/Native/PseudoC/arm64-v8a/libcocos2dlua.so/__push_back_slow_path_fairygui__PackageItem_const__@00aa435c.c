...
/* void std::__ndk1::vector<fairygui::PackageItem*, std::__ndk1::allocator<fairygui::PackageItem*>
   >::__push_back_slow_path<fairygui::PackageItem* const&>(fairygui::PackageItem* const&) */
...
__push_back_slow_path<fairygui::PackageItem*const&>
          (vector<fairygui::PackageItem*,std::__ndk1::allocator<fairygui::PackageItem*>> *this,
          PackageItem **param_1)
