...
/* std::__ndk1::vector<cocos2d::Touch*, std::__ndk1::allocator<cocos2d::Touch*>
   >::vector(std::__ndk1::vector<cocos2d::Touch*, std::__ndk1::allocator<cocos2d::Touch*> > const&)
    */

void __thiscall
std::__ndk1::vector<cocos2d::Touch*,std::__ndk1::allocator<cocos2d::Touch*>>::vector
          (vector<cocos2d::Touch*,std::__ndk1::allocator<cocos2d::Touch*>> *this,vector *param_1)
