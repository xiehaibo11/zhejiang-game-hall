...
/* void ccvector_to_luaval<cocos2d::TMXLayerInfo*>(lua_State*,
   cocos2d::Vector<cocos2d::TMXLayerInfo*> const&) */

void ccvector_to_luaval<cocos2d::TMXLayerInfo*>(lua_State *param_1,Vector *param_2)
