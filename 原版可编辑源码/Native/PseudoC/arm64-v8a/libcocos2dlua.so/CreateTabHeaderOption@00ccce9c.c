...
/* flatbuffers::CreateTabHeaderOption(flatbuffers::FlatBufferBuilder&,
   flatbuffers::Offset<flatbuffers::WidgetOptions>, flatbuffers::Offset<flatbuffers::ResourceData>,
   int, flatbuffers::Offset<flatbuffers::String>, flatbuffers::Color const*,
   flatbuffers::Offset<flatbuffers::ResourceData>, flatbuffers::Offset<flatbuffers::ResourceData>,
   flatbuffers::Offset<flatbuffers::ResourceData>, flatbuffers::Offset<flatbuffers::ResourceData>,
   flatbuffers::Offset<flatbuffers::ResourceData>) */

undefined4
flatbuffers::CreateTabHeaderOption
          (FlatBufferBuilder *param_1,int param_2,int param_3,int param_4,int param_5,
          undefined1 *param_6,int param_7,int param_8,int param_9,int param_10,int param_11)

{
  ...
  if (param_6 != (undefined1 *)0x0) {
    ...
    *(undefined1 *)(lVar9 + -4) = *param_6;
    *(undefined1 *)(lVar9 + -3) = param_6[1];
    *(undefined1 *)(lVar9 + -2) = param_6[2];
    *(undefined1 *)(lVar9 + -1) = param_6[3];
    uStack_6c = 0xc;
  ...
  FlatBufferBuilder::AddElement<int>(param_1,8,param_4,0);
  if (param_3 != 0) {
    FlatBufferBuilder::Align(param_1,4);
    uVar1 = (((*(int *)(param_1 + 8) - *(int *)(param_1 + 0x18)) + *(int *)(param_1 + 0x10)) -
            param_3) + 4;
  ...
  uVar7 = FlatBufferBuilder::EndTable(param_1,(iVar3 - iVar4) + iVar5,10);
