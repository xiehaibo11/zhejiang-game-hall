...
undefined8
FUN_011fcaf0(long param_1,ushort *param_2,long *param_3,undefined1 *param_4,long param_5,
      ...
      if (uVar2 < 0x800) {
        ...
        if (uVar2 >> 0xb < 0x1b) {
          ...
          if (uVar2 >> 10 < 0x37) {
            ...
            if (param_7 < (((ulong)uVar2 & 0x3ff) << 10 | (ulong)uVar3 & 0x3ff) + 0x10000) {
              return 2;
            }
            ...
            *pbVar6 = (byte)(uVar1 >> 2) | 0xf0;
            pbVar6 = (byte *)*param_6;
            *param_6 = (long)(pbVar6 + 1);
            *pbVar6 = (byte)(uVar2 >> 2) & 0xf | (byte)((uVar1 & 3) << 4) | 0x80;
            pbVar6 = (byte *)*param_6;
            *param_6 = (long)(pbVar6 + 1);
