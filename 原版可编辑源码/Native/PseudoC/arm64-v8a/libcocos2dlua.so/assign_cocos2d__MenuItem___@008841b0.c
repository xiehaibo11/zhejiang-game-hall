...
/* std::__ndk1::enable_if<__is_forward_iterator<cocos2d::MenuItem**>::value&&is_constructible<cocos2d::MenuItem*,
   std::__ndk1::iterator_traits<cocos2d::MenuItem**>::reference>::value, void>::type
   std::__ndk1::vector<cocos2d::MenuItem*, std::__ndk1::allocator<cocos2d::MenuItem*>
   >::assign<cocos2d::MenuItem**>(cocos2d::MenuItem**, cocos2d::MenuItem**) */

void __thiscall
std::__ndk1::vector<cocos2d::MenuItem*,std::__ndk1::allocator<cocos2d::MenuItem*>>::
assign<cocos2d::MenuItem**>
          (vector<cocos2d::MenuItem*,std::__ndk1::allocator<cocos2d::MenuItem*>> *this,
          MenuItem **param_1,MenuItem **param_2)
...
LAB_00884234:
    ...
    if ((ulong)(lVar1 >> 3) < 0xfffffffffffffff) {
      uVar2 = lVar1 >> 2;
      if ((uVar5 <= uVar2) && (uVar5 = uVar2, uVar2 >> 0x3d != 0)) goto LAB_00884234;
    }
    else {
    ...
    *(void **)(this + 8) = pvVar4;
    ...
    __src = (MenuItem **)((long)param_1 + (*(long *)(this + 8) - (long)pvVar4));
    if (uVar5 <= uVar2) {
      __src = param_2;
    }
