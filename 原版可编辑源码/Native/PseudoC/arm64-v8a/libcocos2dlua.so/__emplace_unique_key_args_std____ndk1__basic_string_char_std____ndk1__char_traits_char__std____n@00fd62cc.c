...

{
  ...
  long local_68;
                    ...
                    /* catch() { ... } // from try @ 00fd6288 with catch @ 00fd62d4 */
                    /* catch() { ... } // from try @ 00fd6260 with catch @ 00fd62e4 */
  lVar5 = tpidr_el0;
      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if (uVar13 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00fd63f0;
            break;
          }
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(piecewise_construct_t *)((long)plVar15 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00fd6460;
              }
              goto LAB_00fd63a8;
            }
          }
  ...
  *plVar15 = 0;
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(basic_string **)(lVar14 + unaff_x27 * 8) = pbVar12;
                    /* catch() { ... } // from try @ 00fd658c with catch @ 00fd6540 */
    if (*plVar15 == 0) goto LAB_00fd657c;
    ...
    if ((uVar16 & uVar16 - 1) == 0) {
      ...
      if (uVar16 != 0) {
        uVar13 = uVar7 / uVar16;
                    ...
                    /* try { // try from 00fd6564 to 010d6567 has its CatchHandler @ 00fd65f8 */
...
LAB_00fd657c:
  uVar8 = 1;
                    /* try { // try from 00fd6588 to 010d658b has its CatchHandler @ 00fd65e8 */
  *(long *)(param_1 + 0x18) = *(long *)(param_1 + 0x18) + 1;
LAB_00fd658c:
                    /* try { // try from 00fd658c to 010d6613 has its CatchHandler @ 00fd6540 */
