...
/* void std::__ndk1::vector<cocostudio::ActionObject*,
   std::__ndk1::allocator<cocostudio::ActionObject*>
   >::__push_back_slow_path<cocostudio::ActionObject* const&>(cocostudio::ActionObject* const&) */
