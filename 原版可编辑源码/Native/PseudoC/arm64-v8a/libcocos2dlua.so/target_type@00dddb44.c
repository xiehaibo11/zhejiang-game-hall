...
{
  return &__bind<void(cocos2d::ui::RichText::*)(std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&),cocos2d::ui::RichText*,std::__ndk1::placeholders::__ph<1>const&>
          ::typeinfo;
}
