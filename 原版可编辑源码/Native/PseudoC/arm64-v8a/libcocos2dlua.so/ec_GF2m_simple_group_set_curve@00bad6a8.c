...

{
  ...
  long lVar7;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00bad5d4 with catch @ 00bad6c4
                        */
  ...
  if (pBVar4 != (BIGNUM *)0x0) {
    ...
    if ((uVar3 | 2) == 6) {
      ...
      if ((int)uVar5 != 0) {
        ...
        uVar5 = 0;
        if (lVar6 != 0) {
                    /* try { // try from 00bad72c to 00cad7db has its CatchHandler @ 00bad72c
                       catch() { ... } // from try @ 00bad72c with catch @ 00bad72c
                       catch() { ... } // from try @ 00bad7e0 with catch @ 00bad72c */
