...

{
  ...
  lVar2 = tpidr_el0;
                    /* try { // try from 00de1d8c to 00ee1da7 has its CatchHandler @ 00de1ea0 */
  local_38 = *(long *)(lVar2 + 0x28);
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string<decltype(nullptr)>(local_50,"I");
                    /* try { // try from 00de1dac to 00ee1dbb has its CatchHandler @ 00de1e9c */
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string<decltype(nullptr)>(local_68,"Z");
                    /* try { // try from 00de1dbc to 00ee1ebb has its CatchHandler @ 00de1d30 */
