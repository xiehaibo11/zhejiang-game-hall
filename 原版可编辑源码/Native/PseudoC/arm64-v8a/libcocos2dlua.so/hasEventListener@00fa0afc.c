...
/* cocos2d::EventDispatcher::hasEventListener(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) const */

bool __thiscall
cocos2d::EventDispatcher::hasEventListener(EventDispatcher *this,basic_string *param_1)
