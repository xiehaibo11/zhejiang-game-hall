...
undefined8 FUN_01143168(int *param_1,undefined8 *param_2)

{
  ...
  if (lVar7 != 0) {
    ...
    iVar6 = (*DAT_01795f90)(lVar7,*param_1,iVar4,iVar9,lVar1 + lVar2);
    if ((iVar5 - 7U < 4) && (iVar6 != 0)) {
      (*DAT_01795fa0)(lVar1,iVar5 == 4 || iVar5 == 9,iVar4,iVar9,piVar10[6]);
    }
  }
  return 0;
}
