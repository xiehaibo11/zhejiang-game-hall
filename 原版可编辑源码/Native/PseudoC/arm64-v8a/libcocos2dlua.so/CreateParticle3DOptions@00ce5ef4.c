...
/* flatbuffers::CreateParticle3DOptions(flatbuffers::FlatBufferBuilder&,
   flatbuffers::Offset<flatbuffers::Node3DOption>, flatbuffers::Offset<flatbuffers::ResourceData>)
    */

undefined4 flatbuffers::CreateParticle3DOptions(FlatBufferBuilder *param_1,int param_2,int param_3)
