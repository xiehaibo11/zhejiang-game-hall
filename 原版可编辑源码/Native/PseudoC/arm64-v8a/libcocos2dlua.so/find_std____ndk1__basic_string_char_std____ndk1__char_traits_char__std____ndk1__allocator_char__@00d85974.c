...
/* std::__ndk1::__tree_iterator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, dragonBones::DragonBonesData*>,
...

{
  ...
  *p_Var9;
  ...
  if (p_Var9 != (__tree<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::DragonBonesData*>,std::__ndk1::__map_value_compare<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::DragonBonesData*>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::DragonBonesData*>>>
    ...
    do {
      _Var4 = p_Var9[0x20];
                    /* try { // try from 00d859e8 to 00e859fb has its CatchHandler @ 00d861f4 */
      ...
      if (sVar2 == 0) {
LAB_00d859b4:
                    /* try { // try from 00d859b4 to 00e859bb has its CatchHandler @ 00d861d8 */
    ...
    if (p_Var8 != p_Var7) {
      _Var4 = p_Var8[0x20];
                    /* try { // try from 00d85a2c to 00e85a33 has its CatchHandler @ 00d861d4 */
      uVar1 = (ulong)((byte)_Var4 >> 1);
      if (((byte)_Var4 & 1) != 0) {
      ...
      if (sVar2 != 0) {
        ...
        if (iVar6 != 0) {
          ...
          return p_Var8;
                    ...
                    /* try { // try from 00d85a68 to 00e85a6f has its CatchHandler @ 00d861d0 */
      if (uVar1 <= uVar3) {
        return p_Var8;
      }
    }
