...
/* cocos2d::experimental::AudioMixer::setChannelMasks(int, unsigned int, unsigned int) */

undefined4 __thiscall
cocos2d::experimental::AudioMixer::setChannelMasks
          (AudioMixer *this,int param_1,uint param_2,uint param_3)
