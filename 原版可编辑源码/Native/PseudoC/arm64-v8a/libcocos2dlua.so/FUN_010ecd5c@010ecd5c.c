...
void FUN_010ecd5c(long param_1,long param_2,int *param_3,undefined8 param_4,long param_5,
...

{
  ...
  long lVar8;
                    ...
                    /* try { // try from 010ecd70 to 011ecd77 has its CatchHandler @ 010ecdcc */
                    /* try { // try from 010ecd78 to 011ecde7 has its CatchHandler @ 010eccec */
  ...
  if (iVar4 <= iVar3) {
    if (0 < *(int *)(param_1 + 0x38)) {
      ...
      lVar6 = lVar7 + 0x18;
      do {
                    /* catch() { ... } // from try @ 010ecd70 with catch @ 010ecdcc */
