...
void FUN_00db8378(long *param_1,long *param_2)

{
  ...
  if (*(long *)(lVar1 + 0x28) == local_38) {
    return;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00db8530 with catch @ 00db84d4
                       catch(type#1 @ 00000000) { ... } // from try @ 00db86fc with catch @ 00db84d4
                        */
  __stack_chk_fail();
}
