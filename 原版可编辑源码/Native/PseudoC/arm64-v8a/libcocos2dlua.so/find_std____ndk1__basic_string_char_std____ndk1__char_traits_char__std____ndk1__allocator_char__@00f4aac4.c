...

{
  ...
  local_68 = *(long *)(lVar5 + 0x28);
                    /* try { // try from 00f4aafc to 0104ab3b has its CatchHandler @ 00f4aafc
                       catch() { ... } // from try @ 00f4aafc with catch @ 00f4aafc
                       catch() { ... } // from try @ 00f4ab40 with catch @ 00f4aafc */
  ...
  if (uVar12 != 0) {
    ...
    if (uVar13 < 2) {
                    /* catch() { ... } // from try @ 00f4ab3c with catch @ 00f4ab54 */
      uVar14 = uVar12 - 1 & uVar7;
    }
    else {
                    /* try { // try from 00f4ab3c to 0104ab3f has its CatchHandler @ 00f4ab54 */
      uVar14 = uVar7;
                    /* try { // try from 00f4ab40 to 0104ab67 has its CatchHandler @ 00f4aafc */
      if (uVar12 <= uVar7) {
        uVar14 = 0;
        if (uVar12 != 0) {
          uVar14 = uVar7 / uVar12;
            ...
            if (uVar13 < 2) {
              ...
              if (uVar12 != 0) {
                uVar4 = uVar9 / uVar12;
                    ...
                    /* catch() { ... } // from try @ 00f4d368 with catch @ 00f4ac28 */
              if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_00f4aba0;
              goto LAB_00f4ac50;
            }
            if (uVar9 != uVar14) goto LAB_00f4ac50;
          }
LAB_00f4aba0:
          plVar8 = (long *)*plVar8;
