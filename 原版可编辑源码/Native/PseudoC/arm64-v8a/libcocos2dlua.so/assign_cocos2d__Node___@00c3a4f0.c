...
/* std::__ndk1::enable_if<__is_forward_iterator<cocos2d::Node**>::value&&is_constructible<cocos2d::Node*,
   std::__ndk1::iterator_traits<cocos2d::Node**>::reference>::value, void>::type
   std::__ndk1::vector<cocos2d::Node*, std::__ndk1::allocator<cocos2d::Node*>
   >::assign<cocos2d::Node**>(cocos2d::Node**, cocos2d::Node**) */

void __thiscall
std::__ndk1::vector<cocos2d::Node*,std::__ndk1::allocator<cocos2d::Node*>>::assign<cocos2d::Node**>
          (vector<cocos2d::Node*,std::__ndk1::allocator<cocos2d::Node*>> *this,Node **param_1,
          Node **param_2)
...
LAB_00c3a574:
    ...
    if ((ulong)(lVar1 >> 3) < 0xfffffffffffffff) {
      uVar2 = lVar1 >> 2;
      if ((uVar5 <= uVar2) && (uVar5 = uVar2, uVar2 >> 0x3d != 0)) goto LAB_00c3a574;
    }
    else {
    ...
    *(void **)(this + 8) = pvVar4;
    ...
    __src = (Node **)((long)param_1 + (*(long *)(this + 8) - (long)pvVar4));
    if (uVar5 <= uVar2) {
      __src = param_2;
    }
