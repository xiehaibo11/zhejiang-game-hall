...
void FUN_0125d8a8(long *param_1)
  ...
  if ((((char *)param_1[1] != pcVar1) && (param_1[1] - (long)pcVar1 != 1)) && (*pcVar1 == 'd')) {
    ...
    if (cVar2 == 'X') {
      *param_1 = (long)(pcVar1 + 2);
      lVar3 = FUN_01259b70(param_1);
      if (((lVar3 != 0) && (lVar4 = FUN_01259b70(param_1), lVar4 != 0)) &&
         (lVar6 = FUN_0125d8a8(param_1), lVar6 != 0)) {
...
LAB_0125dad0:
        ...
        *(undefined ***)((long)puVar5 + lVar7 + 0x10) = &PTR_FUN_017364b8;
      ...
      *param_1 = (long)(pcVar1 + 2);
      lVar3 = FUN_01259b70(param_1);
      if ((lVar3 != 0) && (lVar4 = FUN_0125d8a8(param_1), lVar4 != 0)) {
        pvVar8 = (void *)param_1[0x25c];
        lVar6 = *(long *)((long)pvVar8 + 8);
        puVar5 = pvVar8;
        if (0xfef < lVar6 + 0x30U) {
          puVar5 = malloc(0x1000);
          if (puVar5 == (void *)0x0) goto LAB_0125dad0;
          lVar6 = 0;
          *puVar5 = pvVar8;
          puVar5[1] = 0;
          param_1[0x25c] = (long)puVar5;
        ...
        *(undefined ***)((long)puVar5 + lVar6 + 0x10) = &PTR_FUN_01736448;
      ...
      if (cVar2 != 'i') goto LAB_0125d984;
      *param_1 = (long)(pcVar1 + 2);
      lVar3 = FUN_0125f98c(param_1);
      if ((lVar3 != 0) && (lVar4 = FUN_0125d8a8(param_1), lVar4 != 0)) {
        pvVar8 = (void *)param_1[0x25c];
        lVar6 = *(long *)((long)pvVar8 + 8);
        puVar5 = pvVar8;
