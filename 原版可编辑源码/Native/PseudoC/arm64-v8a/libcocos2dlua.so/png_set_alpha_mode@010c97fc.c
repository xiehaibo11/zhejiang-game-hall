...

{
  ...
  dVar45 = (double)(long)(dVar45 + 0.5);
                    /* try { // try from 010c9844 to 011c9883 has its CatchHandler @ 010c9844
                       catch() { ... } // from try @ 010c9844 with catch @ 010c9844
                       catch() { ... } // from try @ 010c9890 with catch @ 010c9844
                       catch() { ... } // from try @ 010c98e4 with catch @ 010c9844
                       catch() { ... } // from try @ 010c9930 with catch @ 010c9844 */
...
LAB_010c9da8:
  ...
  lVar29 = lVar29 + 0x60;
  if ((int)param_4 <= iVar42) goto code_r0x010c9de8;
  goto LAB_010c9ae0;
code_r0x010c9de8:
