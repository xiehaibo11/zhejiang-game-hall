...
/* duDebugDrawArrow(duDebugDraw*, float, float, float, float, float, float, float, float, unsigned
   int, float) */

void duDebugDrawArrow(duDebugDraw *param_1,float param_2,float param_3,float param_4,float param_5,
