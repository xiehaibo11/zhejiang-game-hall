...
undefined4 * spPathConstraintSpacingTimeline_create(int param_1)

{
  ...
  *puVar2 = _spPathConstraintSpacingTimeline_apply;
  puVar2[1] = _spPathConstraintSpacingTimeline_getPropertyId;
