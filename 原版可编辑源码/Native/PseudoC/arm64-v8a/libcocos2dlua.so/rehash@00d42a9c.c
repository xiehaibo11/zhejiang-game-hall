...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::Sprite3DCache::Sprite3DData*> > >::rehash(unsigned long) */
...

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
                    /* catch() { ... } // from try @ 00d42a50 with catch @ 00d42b08 */
      uVar1 = (ulong)((float)*(ulong *)(this + 0x18) / *(float *)(this + 0x20));
                    /* catch() { ... } // from try @ 00d42b60 with catch @ 00d42b24 */
      if ((uVar2 < 3) ||
      ...
      param_1 = uVar1;
                    /* try { // try from 00d42b58 to 00e42b5f has its CatchHandler @ 00d42bcc */
      if (uVar1 < uVar2) goto LAB_00d42b60;
    }
    return;
  }
LAB_00d42b60:
                    /* try { // try from 00d42b60 to 00e42be7 has its CatchHandler @ 00d42b24 */
