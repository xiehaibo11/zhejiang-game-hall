...
/* cocos2d::EnhanceAPI::getTemperature() */

undefined4 cocos2d::EnhanceAPI::getTemperature(void)

{
  ...
  uVar3 = JniHelper::getStaticMethodInfo
                    ((JniMethodInfo_ *)&local_40,"org.cocos2dx.lib.Cocos2dxHelper","getTemperature",
                     "()I");
  if ((uVar3 & 1) == 0) {
    uVar2 = 0xffffffff;
  }
