...
void cpDampedRotarySpringSetRestAngle(undefined4 param_1,undefined8 *param_2)

{
  if ((undefined **)*param_2 == &PTR_FUN_0172d198) {
  ...
  cpMessage("cpConstraintIsDampedRotarySpring(constraint)",
            ...
            ,0x82,1,1,"Constraint is not a damped rotary spring.");
