...

{
  ...
  if (iVar1 == 0) {
    ...
    iVar1 = FUN_00ba3024(param_2,&local_48);
    if (iVar1 < 0) {
      iVar1 = 0x76;
      line = 0x50;
    }
      ...
      if (iVar1 == 0) goto LAB_00ba2fe8;
      local_48 = (void *)0x0;
      iVar1 = FUN_00ba3024(param_5,&local_48);
      if (iVar1 < 0) {
        iVar1 = 0x76;
        line = 0x59;
      }
        ...
        local_48 = (void *)0x0;
        iVar1 = FUN_00ba3024(param_6,&local_48);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ba2e1c with catch @ 00ba2f04
                        */
        if (-1 < iVar1) {
          iVar1 = o2i_SCT_signature(lVar2,&local_48,(long)iVar1);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ba2dbc with catch @ 00ba2f1c
                        */
          if (0 < iVar1) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ba2c5c with catch @ 00ba2f30
                        */
