...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<char const*, int>,
   ...
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<char const*, int> > >::__rehash(unsigned
   long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<char_const*,int>,std::__ndk1::__unordered_map_hasher<char_const*,std::__ndk1::__hash_value_type<char_const*,int>,std::__ndk1::hash<char_const*>,true>,std::__ndk1::__unordered_map_equal<char_const*,std::__ndk1::__hash_value_type<char_const*,int>,std::__ndk1::equal_to<char_const*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<char_const*,int>>>
           *this,ulong param_1)

{
  ...
  if (param_1 == 0) {
    ...
    *(undefined8 *)(this + 8) = 0;
                    ...
                    /* catch() { ... } // from try @ 009e4550 with catch @ 009e45dc */
                    /* catch() { ... } // from try @ 009e44cc with catch @ 009e45e0 */
    if (param_1 >> 0x3d != 0) {
    ...
    *(ulong *)(this + 8) = param_1;
    ...
    if (plVar5 != (long *)0x0) {
      ...
      uVar12 = CONCAT62((int6)((ulong)uVar11 >> 0x10),uVar10);
                    /* try { // try from 009e4640 to 00ae4693 has its CatchHandler @ 009e4640
                       catch() { ... } // from try @ 009e4640 with catch @ 009e4640
                       catch() { ... } // from try @ 009e46ac with catch @ 009e4640
                       catch() { ... } // from try @ 009e4720 with catch @ 009e4640 */
        ...
        do {
          ...
          if ((uVar12 & 0xffffffff) < 2) {
            uVar7 = uVar7 & param_1 - 1;
                    ...
                    /* try { // try from 009e46ac to 00ae4717 has its CatchHandler @ 009e4640 */
            if (param_1 <= uVar7) {
              uVar1 = 0;
              if (param_1 != 0) {
                uVar1 = uVar7 / param_1;
          ...
          if (uVar7 != uVar4) {
            ...
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) {
              ...
              *plVar8 = **(long **)(*(long *)this + uVar7 * 8);
                    /* try { // try from 009e4718 to 00ae471f has its CatchHandler @ 009e47a4 */
                    /* try { // try from 009e4720 to 00ae4807 has its CatchHandler @ 009e4640 */
