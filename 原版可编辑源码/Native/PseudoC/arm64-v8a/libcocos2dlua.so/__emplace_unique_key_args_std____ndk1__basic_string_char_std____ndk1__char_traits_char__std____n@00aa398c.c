      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if (uVar13 < 2) {
            ...
            if (uVar10 - uVar4 * uVar16 == unaff_x27) goto LAB_00aa3ab0;
            break;
          }
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(basic_string *)((long)plVar15 + uVar10 + 0x11) == pbVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00aa3b20;
              }
              goto LAB_00aa3a68;
            }
          }
          else if (__n != 0) {
                    /* try { // try from 00aa3b10 to 00ba3b5b has its CatchHandler @ 00aa3b10
                       catch() { ... } // from try @ 00aa3b10 with catch @ 00aa3b10
                       catch() { ... } // from try @ 00aa3b60 with catch @ 00aa3b10 */
            uVar6 = memcmp(__s1,pbVar2,__n);
            __s1 = (void *)(ulong)uVar6;
            if (uVar6 != 0) goto LAB_00aa3a68;
          }
LAB_00aa3b20:
          uVar8 = 0;
          goto LAB_00aa3c58;
...
LAB_00aa3a68:
  ...
  __s1 = (void *)basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
                 basic_string((basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>
                               *)(plVar15 + 5),(basic_string *)(param_2 + 0x18));
  *plVar15 = 0;
  plVar15[1] = uVar7;
                    /* try { // try from 00aa3b5c to 00ba3b5f has its CatchHandler @ 00aa3b94 */
                    /* try { // try from 00aa3b60 to 00ba3ba7 has its CatchHandler @ 00aa3b10 */
  if ((uVar16 == 0) ||
     (*(float *)(this + 0x20) * (float)uVar16 < (float)(*(long *)(this + 0x18) + 1))) {
                    /* catch() { ... } // from try @ 00aa3b5c with catch @ 00aa3b94 */
    uVar16 = (ulong)(uVar16 < 3 || (uVar16 & uVar16 - 1) != 0) | uVar16 << 1;
    uVar13 = (ulong)((float)(*(long *)(this + 0x18) + 1) / *(float *)(this + 0x20));
    if (uVar13 <= uVar16) {
      uVar13 = uVar16;
    }
                    /* try { // try from 00aa3ba8 to 00ba3d4f has its CatchHandler @ 00aa3ba8
                       catch() { ... } // from try @ 00aa3ba8 with catch @ 00aa3ba8
                       catch() { ... } // from try @ 00aa3dd0 with catch @ 00aa3ba8 */
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>>>
      **)(lVar14 + unaff_x27 * 8) = p_Var12;
    if (*plVar15 == 0) goto LAB_00aa3c48;
