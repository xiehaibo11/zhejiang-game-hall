...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<cocos2d::Node*,
   ...
   cocosbuilder::CCBAnimationManager*> > >::__rehash(unsigned long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<cocos2d::Node*,cocosbuilder::CCBAnimationManager*>,std::__ndk1::__unordered_map_hasher<cocos2d::Node*,std::__ndk1::__hash_value_type<cocos2d::Node*,cocosbuilder::CCBAnimationManager*>,std::__ndk1::hash<cocos2d::Node*>,true>,std::__ndk1::__unordered_map_equal<cocos2d::Node*,std::__ndk1::__hash_value_type<cocos2d::Node*,cocosbuilder::CCBAnimationManager*>,std::__ndk1::equal_to<cocos2d::Node*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<cocos2d::Node*,cocosbuilder::CCBAnimationManager*>>>
           *this,ulong param_1)
