...
undefined8 FUN_008acccc(long param_1)
  ...
  if (param_1 != 0) {
    ...
    if (iVar2 + -1 == 0) {
      ...
      if (this != (__Dictionary *)0x0) {
        ...
        ::basic_string<decltype(nullptr)>(local_50,"accListener");
      ...
      cocos2d::ScriptHandlerMgr::removeObjectHandler(pSVar5,plVar3,6);
    }
    else {
      luaL_error(param_1,"%s has wrong number of arguments: %d, was expecting %d\n",
                 "cc.Layer:unregisterScriptAccelerateHandler",iVar2 + -1,0);
    }
  }
