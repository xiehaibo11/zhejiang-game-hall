...

{
  ...
  if (uVar5 < param_2) {
    ...
    if ((long)__n <= lVar6) {
      ...
      do {
        pbVar7 = pbVar2;
        if (((0xfffffffffffffffe < lVar6 - __n) ||
            (pbVar4 = (basic_string<wchar_t,std::__ndk1::char_traits<wchar_t>,std::__ndk1::allocator<wchar_t>>
                       *)wmemchr((wchar_t *)pbVar4,__c,(lVar6 - __n) + 1),
            pbVar4 == (basic_string<wchar_t,std::__ndk1::char_traits<wchar_t>,std::__ndk1::allocator<wchar_t>>
                       *)0x0)) ||
           (iVar3 = wmemcmp((wchar_t *)pbVar4,param_1,__n), pbVar7 = pbVar4, iVar3 == 0)) break;
        pbVar4 = pbVar4 + 4;
        lVar6 = (long)pbVar2 - (long)pbVar4 >> 2;
        pbVar7 = pbVar2;
      } while ((long)__n <= lVar6);
    }
