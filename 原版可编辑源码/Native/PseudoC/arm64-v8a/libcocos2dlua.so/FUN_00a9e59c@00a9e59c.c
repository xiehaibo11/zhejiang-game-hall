...
void FUN_00a9e59c(long *param_1,long *param_2)
  ...
  if (param_2 != param_1) {
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
                    /* catch() { ... } // from try @ 00a9e568 with catch @ 00a9e65c */
                    /* catch() { ... } // from try @ 00a9e580 with catch @ 00a9e660 */
        (**(code **)(*plVar2 + 0x18))(plVar2,local_60);
        (**(code **)(*(long *)param_1[4] + 0x20))();
                    /* catch() { ... } // from try @ 00a9e4ac with catch @ 00a9e67c */
        param_1[4] = 0;
