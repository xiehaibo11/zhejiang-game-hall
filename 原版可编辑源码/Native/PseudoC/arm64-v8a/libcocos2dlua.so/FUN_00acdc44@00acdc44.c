...
void FUN_00acdc44(undefined4 *param_1,undefined1 *param_2)

{
  *param_2 = *(undefined1 *)((long)param_1 + 3);
  ...
  param_2[6] = (char)((uint)param_1[1] >> 8);
                    /* try { // try from 00acdc88 to 00bcdf93 has its CatchHandler @ 00acdc88
                       catch() { ... } // from try @ 00acdc88 with catch @ 00acdc88
                       catch() { ... } // from try @ 00ace014 with catch @ 00acdc88 */
