...
/* void cocos2d::experimental::volumeRampMulti<1, 5, int, short, int, int, int>(int*, unsigned long,
   short const*, int*, int*, int const*, int*, int) */

void cocos2d::experimental::volumeRampMulti<1,5,int,short,int,int,int>
