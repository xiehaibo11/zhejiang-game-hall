...
/* cocos2d::experimental::AudioDecoderMp3::decodeToPcm() */

void __thiscall cocos2d::experimental::AudioDecoderMp3::decodeToPcm(AudioDecoderMp3 *this)

{
  ...
  (**(code **)(*plVar4 + 0x28))(&pcStack_58,plVar4,this + 8);
