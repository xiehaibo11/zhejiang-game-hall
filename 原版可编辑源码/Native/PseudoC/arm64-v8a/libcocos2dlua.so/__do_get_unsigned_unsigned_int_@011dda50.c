...

{
  ...
  plVar9 = param_2;
  local_168 = pcVar10;
  if (param_2 != (long *)0x0) goto LAB_011ddb34;
LAB_011ddb40:
  if (param_3 == (long *)0x0) goto LAB_011ddb8c;
  while( true ) {
    ...
    while( true ) {
      ...
      plVar9 = param_2;
      if (param_2 == (long *)0x0) goto LAB_011ddb40;
LAB_011ddb34:
      param_2 = plVar9;
      if (plVar9[3] != plVar9[4]) goto LAB_011ddb40;
...
LAB_011ddb8c:
      param_3 = (long *)0x0;
      if (param_2 == (long *)0x0) goto LAB_011ddc7c;
    }
  }
LAB_011ddc7c:
  ...
  uVar5 = FUN_01208964(pcVar10,local_168,param_5,iVar6);
  *param_6 = uVar5;
  __check_grouping(local_148,local_12c,local_170,param_5);
  plVar9 = param_2;
  if ((param_2 == (long *)0x0) || (param_2[3] != param_2[4])) {
    if (param_3 != (long *)0x0) goto LAB_011ddcfc;
LAB_011ddda0:
    if (plVar9 != (long *)0x0) goto LAB_011ddd30;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_011ddda0;
LAB_011ddcfc:
