...

{
  ...
  if (bVar11 == 0) {
    ...
    png_error(param_1,"internal row logic error");
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010d197c with catch @ 010d1928
                        */
  ...
  uVar16 = uVar23 * bVar11;
                    /* try { // try from 010d1974 to 011d197b has its CatchHandler @ 010d1af0 */
  uVar8 = (uint)uVar16 & 7;
  pbVar7 = (byte *)(lVar25 + 1);
                    /* try { // try from 010d197c to 011d1af3 has its CatchHandler @ 010d1928 */
  uVar12 = (uint)bVar11;
  if ((uVar16 & 7) == 0) {
    bVar22 = 0;
    bVar26 = 0;
...
LAB_010d1a68:
      ...
      if (7 < uVar12) {
        ...
        pbVar7 = pbVar7 + uVar23;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010d1974 with catch @ 010d1af0
                        */
        uVar27 = uVar12;
        if (param_3 != 0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 010d1b48 with catch @ 010d1af4
                        */
        ...
        if (((((uint)pbVar21 | (uint)pbVar7) & 3) == 0) && (((uVar27 | uVar8) & 3) == 0)) {
          ...
          while( true ) {
            do {
              uVar19 = uVar23;
                    /* try { // try from 010d1cc0 to 011d1e03 has its CatchHandler @ 010d1cc0
                       catch() { ... } // from try @ 010d1cc0 with catch @ 010d1cc0
                       catch() { ... } // from try @ 010d1e0c with catch @ 010d1cc0 */
              pbVar18 = pbVar7 + 4;
              uVar20 = uVar20 - 4;
              pbVar17 = pbVar21 + 4;
              ...
              if (((0x1f < uVar16) && (uVar23 = uVar16 & 0xffffffffffffffe0, uVar23 != 0)) &&
                ...
                do {
                  ...
                  *(undefined8 *)pbVar2 = uVar28;
                    /* catch() { ... } // from try @ 010d1e04 with catch @ 010d1ed8 */
          ...
          return;
                    ...
                    /* try { // try from 010d1e04 to 011d1e0b has its CatchHandler @ 010d1ed8 */
      ...
      if ((*(uint *)(param_1 + 0x16c) >> 0x10 & 1) == 0) {
        if (param_3 == 0) {
          puVar10 = (uint *)(&UNK_014750a0 + lVar15 * 0x18 + (ulong)bVar3 * 4);
        }
        else {
          puVar10 = (uint *)(&UNK_0147510c + lVar15 * 0xc + (ulong)(bVar3 >> 1) * 4);
        }
      }
      else {
        puVar10 = (uint *)(&UNK_014750e8 + (ulong)(bVar3 >> 1) * 4 + lVar15 * 0xc);
                    /* try { // try from 010d1b40 to 011d1b47 has its CatchHandler @ 010d1cbc */
        if (param_3 == 0) {
          puVar10 = (uint *)(&UNK_01475058 + (ulong)bVar3 * 4 + lVar15 * 0x18);
        }
      }
      uVar8 = *puVar10;
      uVar12 = uVar8;
