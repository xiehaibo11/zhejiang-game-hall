      ...
      if (1 < (int)uVar5) {
        ...
        do {
          ...
          uVar7 = X509_get_extension_flags();
                    /* try { // try from 00b773f0 to 00c77487 has its CatchHandler @ 00b773f0
                       catch() { ... } // from try @ 00b773f0 with catch @ 00b773f0
                       catch() { ... } // from try @ 00b774a4 with catch @ 00b773f0 */
          plVar14 = (long *)policy_cache_set(uVar13);
          X509_up_ref(uVar13);
          *(undefined8 *)(puVar16 + -6) = uVar13;
          if (*plVar14 == 0) {
            *puVar16 = *puVar16 | 0x200;
            if (uVar24 == 0) goto LAB_00b7746c;
LAB_00b77414:
            uVar23 = plVar14[2];
...
LAB_00b77438:
            ...
            if (uVar24 != 0) goto LAB_00b77414;
LAB_00b7746c:
            if ((iVar8 == 0) || ((uVar7 >> 5 & 1) == 0)) {
                    /* try { // try from 00b77488 to 00c7749b has its CatchHandler @ 00b774d4 */
              *puVar16 = *puVar16 | 0x200;
              uVar24 = 0;
              goto joined_r0x00b77490;
            }
            uVar24 = 0;
            if (uVar31 != 0) goto LAB_00b77438;
LAB_00b77494:
            *puVar16 = *puVar16 | 0x400;
          }
                    /* try { // try from 00b774a0 to 00c774a3 has its CatchHandler @ 00b774b8 */
                    /* try { // try from 00b774a4 to 00c7755f has its CatchHandler @ 00b773f0 */
          puVar16 = puVar16 + 8;
          bVar1 = 0 < iVar8;
          iVar8 = iVar8 + -1;
        } while (bVar1);
    ...
    if (uVar6 >> 2 == 0) {
      if ((uVar6 >> 1 & 1) != 0) goto LAB_00b77240;
      bVar1 = true;
    }
    else {
                    /* catch() { ... } // from try @ 00b774a0 with catch @ 00b774b8 */
      *pexplicit_policy = 1;
      if ((uVar6 >> 1 & 1) != 0) {
        return -2;
      }
    ...
    puVar29 = *(undefined8 **)tree;
                    /* catch() { ... } // from try @ 00b77488 with catch @ 00b774d4 */
    if (1 < iVar8) {
      iVar11 = 1;
      puVar30 = puVar29;
      do {
...
LAB_00b77594:
        ...
        if ((*(byte *)((long)puVar30 + 0x39) >> 1 & 1) == 0) {
          iVar8 = OPENSSL_sk_num(puVar30[1]);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b77634 with catch @ 00b775d8
                        */
          if (0 < iVar8) {
            iVar8 = 0;
            do {
              ...
              if (((*(byte *)((long)puVar30 + 0x19) >> 2 & 1) == 0) &&
                ...
                if ((iVar9 != iVar10) && (iVar9 = OPENSSL_sk_num(uVar13), 0 < iVar9)) {
                  ...
                  do {
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b77618 with catch @ 00b776c4
                        */
...
LAB_00b77724:
              ...
              else if (*(int *)(puVar29 + 2) == 0) {
                    /* try { // try from 00b77618 to 00c77633 has its CatchHandler @ 00b776c4 */
                puVar16 = (uint *)policy_data_new(0,*(undefined8 *)((uint *)*puVar29 + 2),
                                                  *(uint *)*puVar29 & 0x10);
                if (puVar16 == (uint *)0x0) goto LAB_00b77c44;
                    /* try { // try from 00b77634 to 00c776f7 has its CatchHandler @ 00b775d8 */
        ...
        if (plVar14 == (long *)0x0) {
          ...
          do {
            ...
            if (lVar12 == 0) {
              ...
              if (puVar22 == (undefined4 *)0x0) goto LAB_00b77c44;
              uVar21 = *(undefined8 *)(*plVar14 + 0x10);
              *puVar22 = 0xc;
