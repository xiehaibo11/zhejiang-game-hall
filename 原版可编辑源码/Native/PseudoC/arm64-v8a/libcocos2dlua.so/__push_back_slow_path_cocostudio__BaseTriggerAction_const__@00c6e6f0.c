...
/* void std::__ndk1::vector<cocostudio::BaseTriggerAction*,
   std::__ndk1::allocator<cocostudio::BaseTriggerAction*>
   >::__push_back_slow_path<cocostudio::BaseTriggerAction* const&>(cocostudio::BaseTriggerAction*
   const&) */
...
__push_back_slow_path<cocostudio::BaseTriggerAction*const&>
          (vector<cocostudio::BaseTriggerAction*,std::__ndk1::allocator<cocostudio::BaseTriggerAction*>>
           *this,BaseTriggerAction **param_1)
