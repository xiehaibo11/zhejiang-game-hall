...

{
  ...
  if (((byte)*param_1 & 1) == 0) {
    ...
    uVar7 = (ulong)((byte)*param_1 >> 1);
                    ...
                    /* catch() { ... } // from try @ 009144a0 with catch @ 00914844 */
  ...
  if (uVar12 != 0) {
    ...
    plVar8 = *(long **)(*(long *)this + uVar14 * 8);
                    /* catch() { ... } // from try @ 009148e4 with catch @ 0091489c */
    if (plVar8 != (long *)0x0) {
      plVar8 = (long *)*plVar8;
      if (plVar8 != (long *)0x0) {
        ...
        do {
          uVar9 = plVar8[1];
                    /* try { // try from 009148e4 to 00a14957 has its CatchHandler @ 0091489c */
          if (uVar7 == uVar9) {
            bVar3 = *(byte *)(plVar8 + 2);
            uVar9 = (ulong)(bVar3 >> 1);
                    /* catch() { ... } // from try @ 009148c8 with catch @ 009148fc */
            sVar1 = uVar9;
                    /* catch() { ... } // from try @ 009148d8 with catch @ 00914900 */
            if ((bVar3 & 1) != 0) {
              sVar1 = plVar8[3];
            }
            if (sVar1 == __n) {
            ...
            if (uVar13 < 2) {
              uVar9 = uVar9 & uVar12 - 1;
                    ...
                    /* try { // try from 00914958 to 00a149a7 has its CatchHandler @ 00914958
                       catch() { ... } // from try @ 00914958 with catch @ 00914958
                       catch() { ... } // from try @ 00914a04 with catch @ 00914958
                       catch() { ... } // from try @ 00914a5c with catch @ 00914958 */
              if (uVar12 <= uVar9) {
                uVar4 = 0;
                if (uVar12 != 0) {
                  uVar4 = uVar9 / uVar12;
                }
                if (uVar9 - uVar4 * uVar12 == uVar14) goto LAB_009148d8;
                goto LAB_00914988;
              }
            }
            if (uVar9 != uVar14) goto LAB_00914988;
          }
LAB_009148d8:
                    /* try { // try from 009148d8 to 00a148e3 has its CatchHandler @ 00914900 */
          plVar8 = (long *)*plVar8;
...
LAB_0091498c:
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* try { // try from 009149a8 to 00a149bf has its CatchHandler @ 00914ad0 */
    return plVar8;
  }
