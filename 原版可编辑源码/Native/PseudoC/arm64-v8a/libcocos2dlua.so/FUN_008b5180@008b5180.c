...
void FUN_008b5180(long param_1,long param_2,undefined4 param_3)

{
  ...
  if ((param_1 != 0) && (param_2 != 0)) {
    ...
    if (iVar2 != 0) {
      ...
      switch(param_3) {
      case 0x30:
        local_70 = &PTR_FUN_0169a3f0;
        local_60 = 0x30;
        lVar6 = param_2 + 0xa0;
        break;
      case 0x31:
        local_70 = &PTR_FUN_0169a470;
        local_60 = 0x31;
        lVar6 = param_2 + 0xd0;
        break;
      case 0x32:
        local_70 = &PTR_FUN_0169a4f0;
        local_60 = 0x32;
        lVar6 = param_2 + 0x100;
        break;
      case 0x33:
        local_70 = &PTR_FUN_0169a570;
        local_60 = 0x33;
        lVar6 = param_2 + 0x130;
        break;
      default:
        goto switchD_008b521c_default;
      }
      lStack_68 = param_2;
      local_50 = (long *)&local_70;
      FUN_008b4d3c(&local_70,lVar6);
      if (&local_70 == (undefined ***)local_50) {
        pcVar7 = *(code **)(*local_50 + 0x20);
      }
      else {
        if (local_50 == (long *)0x0) goto switchD_008b521c_default;
        pcVar7 = *(code **)(*local_50 + 0x28);
      }
      (*pcVar7)();
    }
  }
switchD_008b521c_default:
