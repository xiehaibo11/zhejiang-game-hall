...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void (cocos2d::TransitionScene::*)(),
   ...
   (cocos2d::TransitionScene::*)(), cocos2d::TransitionJumpZoom*> >, void ()>::__clone() const */
...

{
  ...
  puVar1 = operator_new(0x20);
                    /* try { // try from 00f5f2f4 to 0105f2fb has its CatchHandler @ 00f5f5a8 */
  *puVar1 = &PTR_FUN_0171c980;
