...
void * FUN_01058634(undefined8 *param_1,char *param_2,char *param_3,uint *param_4)

{
  ...
  local_12c = 0;
  __ptr = (void *)FUN_0104b1fc(0x170,"fops_zip priv");
  if (__ptr != (void *)0x0) {
    *(undefined ***)((long)__ptr + 8) = &PTR_FUN_0177ed08;
    ...
    *plVar10 = lVar5;
    if (lVar5 == 0) {
      ...
      sVar11 = strlen(__s);
      uVar3 = FUN_010581f4(__ptr,__s,sVar11);
      if (uVar3 == 0) {
