...

{
  ...
  while( true ) {
    do {
      iVar6 = iVar13;
      piVar3 = piVar14;
                    /* catch() { ... } // from try @ 0110260c with catch @ 011025d4 */
      pbVar1 = (byte *)(*(long *)(param_2 + (long)iVar6 * 8) + (param_3 & 0xffffffff));
                    /* try { // try from 01102604 to 0120260b has its CatchHandler @ 01102674 */
      lVar2 = (ulong)pbVar1[8] + (ulong)*pbVar1;
      lVar7 = (ulong)pbVar1[7] + (ulong)pbVar1[1];
                    /* try { // try from 0110260c to 0120268f has its CatchHandler @ 011025d4 */
      ...
      lVar10 = (lVar16 + lVar9) * 0xf7a;
                    /* catch() { ... } // from try @ 01102604 with catch @ 01102674 */
