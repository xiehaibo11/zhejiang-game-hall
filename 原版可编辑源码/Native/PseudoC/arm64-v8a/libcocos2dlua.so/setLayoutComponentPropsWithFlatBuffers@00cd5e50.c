...
/* cocostudio::NodeReader::setLayoutComponentPropsWithFlatBuffers(cocos2d::Node*, flatbuffers::Table
   const*) */

void __thiscall
cocostudio::NodeReader::setLayoutComponentPropsWithFlatBuffers
          (NodeReader *this,Node *param_1,Table *param_2)
...
LAB_00cd6034:
    ...
    if (uVar4 < 0x11) goto LAB_00cd602c;
    fVar28 = 0.0;
    fVar21 = 0.0;
...
LAB_00cd6110:
  ...
  puVar6 = Layout_LeftEdge;
  sVar15 = strlen(Layout_LeftEdge);
  bVar7 = local_c0[0];
  ...
  if (sVar15 == sVar2) {
    if (sVar15 != 0) {
      ...
      if (iVar14 != 0) goto LAB_00cd61f0;
    }
    uVar16 = 1;
  }
  else {
LAB_00cd61f0:
    puVar6 = Layout_RightEdge;
    sVar15 = strlen(Layout_RightEdge);
    if (sVar15 == sVar2) {
      if (sVar2 != 0) {
        ...
        if (iVar14 != 0) goto LAB_00cd623c;
      }
      uVar16 = 2;
    }
    else {
LAB_00cd623c:
      puVar6 = Layout_BothEdge;
      sVar15 = strlen(Layout_BothEdge);
      if (sVar15 == sVar2) {
        if (sVar2 != 0) {
          if (sVar2 == 0xffffffffffffffff) {
                    /* WARNING: Subroutine does not return */
...
LAB_00cd6280:
  ...
  puVar6 = Layout_TopEdge;
  sVar15 = strlen(Layout_TopEdge);
  bVar7 = local_d8[0];
  ...
  if (sVar15 == sVar2) {
    if (sVar15 != 0) {
      ...
      iVar14 = memcmp(pvVar3,puVar6,sVar15);
      if (iVar14 != 0) goto LAB_00cd6304;
    }
    uVar16 = 2;
  }
  else {
LAB_00cd6304:
    puVar6 = Layout_BottomEdge;
    sVar15 = strlen(Layout_BottomEdge);
    if (sVar15 == sVar2) {
      if (sVar2 != 0) {
        if (sVar2 == 0xffffffffffffffff) {
                    /* WARNING: Subroutine does not return */
