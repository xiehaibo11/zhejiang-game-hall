...
void FUN_00d50754(long *param_1,long *param_2)

{
  ...
  if (param_2 != param_1) {
                    /* try { // try from 00d50780 to 00e50827 has its CatchHandler @ 00d50940 */
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
        ...
        param_1[4] = (long)param_1;
                    /* try { // try from 00d50870 to 00e50877 has its CatchHandler @ 00d5093c */
        (**(code **)(local_60[0] + 0x18))(local_60,param_2);
                    /* try { // try from 00d5087c to 00e50887 has its CatchHandler @ 00d50938 */
      ...
      if (param_2 == plVar3) {
        ...
        param_2[4] = (long)plVar2;
                    ...
                    /* try { // try from 00d50898 to 00e508bf has its CatchHandler @ 00d50944 */
