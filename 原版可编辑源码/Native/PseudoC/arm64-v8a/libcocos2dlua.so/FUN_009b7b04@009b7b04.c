...
void FUN_009b7b04(long *param_1,long *param_2)

{
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
        ...
        param_1[4] = (long)param_1;
                    /* try { // try from 009b7c18 to 00ab7c4f has its CatchHandler @ 009b7c18
                       catch() { ... } // from try @ 009b7c18 with catch @ 009b7c18
                       catch() { ... } // from try @ 009b7c60 with catch @ 009b7c18 */
  ...
  if (*(long *)(lVar1 + 0x28) == local_38) {
                    /* try { // try from 009b7c50 to 00ab7c5f has its CatchHandler @ 009b7cc4 */
    return;
  }
                    /* WARNING: Subroutine does not return */
                    /* try { // try from 009b7c60 to 00ab7cdf has its CatchHandler @ 009b7c18 */
  __stack_chk_fail();
}
