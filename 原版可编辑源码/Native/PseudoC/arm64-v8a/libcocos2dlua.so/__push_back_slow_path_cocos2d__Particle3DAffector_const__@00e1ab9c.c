...
/* void std::__ndk1::vector<cocos2d::Particle3DAffector*,
   std::__ndk1::allocator<cocos2d::Particle3DAffector*>
   >::__push_back_slow_path<cocos2d::Particle3DAffector* const&>(cocos2d::Particle3DAffector*
   const&) */
...
__push_back_slow_path<cocos2d::Particle3DAffector*const&>
          (vector<cocos2d::Particle3DAffector*,std::__ndk1::allocator<cocos2d::Particle3DAffector*>>
           *this,Particle3DAffector **param_1)

{
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 == 0) {
      __dest = (void *)0x0;
                    /* try { // try from 00e1ac88 to 00f1ac93 has its CatchHandler @ 00e1be9c */
      goto LAB_00e1ac1c;
    }
    if (uVar3 >> 0x3d != 0) {
                    /* WARNING: Subroutine does not return */
