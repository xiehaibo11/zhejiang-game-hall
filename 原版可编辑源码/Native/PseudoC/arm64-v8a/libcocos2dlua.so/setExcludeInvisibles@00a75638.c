...
/* fairygui::GGroup::setExcludeInvisibles(bool) */

void __thiscall fairygui::GGroup::setExcludeInvisibles(GGroup *this,bool param_1)

{
  long lVar1;
  ulong uVar2;
  
  if ((((this[0x1e8] != (GGroup)param_1) &&
       (this[0x1e8] = (GGroup)param_1, *(int *)(this + 0x1d8) == 0)) &&
      (*(long *)(this + 0xa0) != 0)) &&
