...
undefined8 FUN_00ba9024(long param_1,int param_2,uint param_3,EVP_MD *param_4)
...
LAB_00ba9188:
        *(EVP_MD **)(puVar4 + 6) = param_4;
        return 1;
                    ...
                    /* catch() { ... } // from try @ 00ba9138 with catch @ 00ba90e4
                       catch() { ... } // from try @ 00ba9270 with catch @ 00ba90e4
                       catch() { ... } // from try @ 00ba9330 with catch @ 00ba90e4
                       catch() { ... } // from try @ 00ba9488 with catch @ 00ba90e4 */
      iVar2 = 0x96;
      goto LAB_00ba91e0;
    case 2:
                    /* try { // try from 00ba9130 to 00ca9137 has its CatchHandler @ 00ba9568 */
                    /* try { // try from 00ba9138 to 00ca925f has its CatchHandler @ 00ba90e4 */
      ERR_put_error(10,0x78,0x96,"crypto/dsa/dsa_pmeth.c",0xa7);
    default:
switchD_00ba9060_caseD_3:
      uVar3 = 0xfffffffe;
      break;
    case 5:
    case 7:
    ...
    if (param_2 != 0x1003) {
      ...
      goto switchD_00ba9060_caseD_3;
    }
    iVar2 = EVP_MD_type(param_4);
    if (((iVar2 == 0x40) || (iVar2 = EVP_MD_type(param_4), iVar2 == 0x2a3)) ||
       (iVar2 = EVP_MD_type(param_4), iVar2 == 0x2a0)) goto LAB_00ba9188;
    iVar2 = 0x88;
LAB_00ba91e0:
