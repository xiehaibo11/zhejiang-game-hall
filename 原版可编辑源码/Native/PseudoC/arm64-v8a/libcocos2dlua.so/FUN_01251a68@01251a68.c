...
ulong FUN_01251a68(long param_1,long param_2,long *param_3)
...
LAB_01251ab8:
      ...
      goto LAB_01251b50;
LAB_01251ad0:
      if ((long *)*param_3 == (long *)0x0) goto LAB_01251ae8;
      lVar4 = *(long *)*param_3;
LAB_01251adc:
      *param_3 = lVar4;
      goto LAB_01251ae8;
    ...
    if (lVar4 != 0) {
      if ((*(byte *)(lVar4 + 0x10) & 0x18) != 0) goto LAB_01251ab8;
      if (*(long *)(param_1 + 8) != *(long *)(param_2 + 8)) goto LAB_01251b50;
      goto LAB_01251ad0;
    }
LAB_01251b50:
    lVar4 = __dynamic_cast(param_2,&__cxxabiv1::__shim_type_info::typeinfo,
    ...
    if (*(char **)(lVar5 + 8) == *(char **)(lVar7 + 8)) goto LAB_01251ae8;
    if (*(char **)(lVar5 + 8) == "v") {
      if (lVar7 == 0) goto LAB_01251ae8;
        ...
        if (lVar5 == 0) {
          ...
          if (*(long *)(param_1 + 0x18) != 0) {
            ...
            if (lVar5 == 0) {
                ...
                if (lVar5 != 0) {
                  ...
                  if (*(long *)(lVar4 + 0x18) != 0) {
                    ...
                    if (plVar6 != (long *)0x0) {
                      ...
                      if ((int)local_68 == 1) {
                        lVar4 = local_78;
                        if (*param_3 != 0) goto LAB_01251adc;
                        goto LAB_01251ae8;
                      }
                      goto LAB_01251ba4;
                    }
              ...
              if ((*(byte *)(param_1 + 0x10) & 1) == 0) goto LAB_01251ba4;
              uVar3 = 0;
              if (*(long *)(lVar4 + 0x18) != 0) {
                ...
                if (lVar4 != 0) {
                  if (((*(uint *)(lVar4 + 0x10) & (*(uint *)(lVar5 + 0x10) ^ 0xffffffff)) != 0) ||
                      ...
                      *(long *)(*(long *)(lVar4 + 0x18) + 8))) goto LAB_01251ba4;
          ...
          if ((*(byte *)(param_1 + 0x10) & 1) != 0) {
            uVar3 = FUN_01251d88(lVar5,*(undefined8 *)(lVar4 + 0x18));
