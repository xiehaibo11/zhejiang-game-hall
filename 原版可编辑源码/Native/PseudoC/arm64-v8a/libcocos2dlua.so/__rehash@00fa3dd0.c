...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::EventDispatcher::EventListenerVector*> > >::__rehash(unsigned long) */
          ...
          if (uVar17 != uVar10) {
            if (*(long *)(*(long *)this + uVar17 * 8) == 0) {
              *(long **)(*(long *)this + uVar17 * 8) = plVar15;
              uVar10 = uVar17;
                    /* try { // try from 00fa400c to 010a4047 has its CatchHandler @ 00fa407c */
            }
            else {
              ...
              if (plVar11 != (long *)0x0) {
                bVar2 = *(byte *)(plVar16 + 2);
                    /* try { // try from 00fa3f28 to 010a3f6b has its CatchHandler @ 00fa4080 */
                __n = (ulong)(bVar2 >> 1);
                if ((bVar2 & 1) != 0) {
                  __n = plVar16[3];
                }
                do {
                  ...
                  if ((bVar1 & 1) == 0) {
                    ...
                    /* try { // try from 00fa3f7c to 010a3faf has its CatchHandler @ 00fa407c */
                  pcVar5 = (char *)((long)plVar16 + 0x11);
                  sVar3 = (ulong)(bVar2 >> 1);
                  sVar6 = __n;
                  if ((bVar2 & 1) == 0) {
                    while (sVar6 != 0) {
                      if (*pcVar5 != *__s2) goto LAB_00fa3fd8;
                      __s2 = __s2 + 1;
                      sVar3 = sVar3 - 1;
                      pcVar5 = pcVar5 + 1;
                      sVar6 = sVar3;
                    ...
                    /* try { // try from 00fa3fb0 to 010a400b has its CatchHandler @ 00fa3dc4 */
