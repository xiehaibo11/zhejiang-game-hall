...
/* void std::__ndk1::vector<p2t::Edge*, std::__ndk1::allocator<p2t::Edge*>
   >::__push_back_slow_path<p2t::Edge*>(p2t::Edge*&&) */

void __thiscall
std::__ndk1::vector<p2t::Edge*,std::__ndk1::allocator<p2t::Edge*>>::
__push_back_slow_path<p2t::Edge*>
          (vector<p2t::Edge*,std::__ndk1::allocator<p2t::Edge*>> *this,Edge **param_1)

{
  ...
  if (uVar3 >> 0x3d != 0) {
    ...
    __vector_base_common<true>::__throw_length_error();
                    ...
                    /* catch() { ... } // from try @ 0102d268 with catch @ 0102d360 */
