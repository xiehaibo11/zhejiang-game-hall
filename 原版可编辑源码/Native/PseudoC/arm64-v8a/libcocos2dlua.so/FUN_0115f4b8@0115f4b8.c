...
int FUN_0115f4b8(long param_1,uint param_2,long param_3,uint param_4)

{
  ...
  if (iVar27 != 1) {
    ...
    if ((int)param_2 < 1) {
      ...
      if (0xe < (int)param_2) goto LAB_0115fa68;
    }
    iVar21 = 2;
    uVar9 = 0xffffffff;
    uVar23 = iVar26 - 1;
...
LAB_0115fa68:
  ...
  if ((7 < uVar13) && (uVar18 = uVar13 & 0xfffffffffffffff8, uVar18 != 0)) {
    ...
    if (uVar13 == uVar18) goto LAB_0115f844;
  }
  do {
