...

{
  ...
  lVar25 = *(long *)(param_2 + 0x58);
                    /* catch() { ... } // from try @ 011099f4 with catch @ 0110995c */
  lVar24 = 0;
  do {
    psVar4 = (short *)(param_3 + lVar24 * 2);
    piVar5 = (int *)(lVar25 + lVar24 * 4);
                    /* try { // try from 0110999c to 012099a3 has its CatchHandler @ 01109a84 */
    ...
    lVar22 = (long)piVar5[0x38] * (long)psVar4[0x38];
                    /* try { // try from 011099f0 to 012099f3 has its CatchHandler @ 01109a60 */
                    /* try { // try from 011099f4 to 01209a9f has its CatchHandler @ 0110995c */
    ...
    lVar7 = lVar31 + (long)piVar5[0x18] * (long)psVar4[0x18] * 0x2731 + lVar32;
                    /* catch() { ... } // from try @ 011099f0 with catch @ 01109a60 */
    ...
    lVar28 = lVar24 + 1;
                    /* catch() { ... } // from try @ 0110999c with catch @ 01109a84 */
