...
undefined8 ov_time_seek_page(long *param_1,long param_2)

{
  ...
  if ((int)param_1[0x17] == iVar6) {
    ...
    else if (iVar1 < 3) goto LAB_00eb5d14;
...
LAB_00eb5d14:
  ...
  *(int *)(param_1 + 0x17) = iVar6;
  uVar5 = FUN_00eb5334(param_1,param_1 + 10,param_1 + 0x11,(undefined4 *)((long)param_1 + 0xb4),0);
  if ((int)uVar5 != 0) {
    return uVar5;
  }
LAB_00eb5da4:
  uVar5 = ov_pcm_seek_page(param_1,(param_1[0xb] * (param_2 - lVar3)) / 1000 + lVar2);
  return uVar5;
}
