...
/* cocos2d::experimental::ui::VideoPlayer::setUserInputEnabled(bool) */

void __thiscall
cocos2d::experimental::ui::VideoPlayer::setUserInputEnabled(VideoPlayer *this,bool param_1)

{
  ...
  this[0x4f2] = (VideoPlayer)param_1;
  uVar2 = *(uint *)(this + 0x51c);
  pcVar1 = DAT_017889e8;
  if ((DAT_017889d8 & 1) == 0) {
    pcVar1 = &DAT_017889d9;
  }
                    /* try { // try from 00ddf6b8 to 00edf6bf has its CatchHandler @ 00ddfb2c */
