...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<cocos2d::Node*,
   ...
   std::__ndk1::tuple<cocos2d::Node*&&>, std::__ndk1::tuple<> >(cocos2d::Node* const&,
   std::__ndk1::piecewise_construct_t const&, std::__ndk1::tuple<cocos2d::Node*&&>&&,
   std::__ndk1::tuple<>&&) */
...

{
  ...
  uVar2 = *(ulong *)param_2;
                    /* try { // try from 00fa5b8c to 010a5b8f has its CatchHandler @ 00fa7114 */
  ...
  if (pNVar8 != (Node *)0x0) {
    ...
    if (uVar6 < 2) {
                    /* try { // try from 00fa5c04 to 010a5c0b has its CatchHandler @ 00fa7020 */
      ...
      for (pNVar7 = (Node *)**(long **)(*param_1 + (long)unaff_x24 * 8); pNVar7 != (Node *)0x0;
        ...
        if (pNVar5 != pNVar9) {
          if (uVar6 < 2) {
            ...
            if (pNVar5 + -(uVar1 * (long)pNVar8) == unaff_x24) goto LAB_00fa5c34;
            break;
          }
...
LAB_00fa5c34:
  ...
  *(undefined8 *)(pNVar7 + 0x10) = uVar3;
  if ((pNVar8 == (Node *)0x0) || (*(float *)(param_1 + 4) * (float)pNVar8 < (float)(param_1[3] + 1))
                    ...
                    /* try { // try from 00fa5cc8 to 010a5cff has its CatchHandler @ 00fa6ff4 */
  ...
  if (pNVar9 == (Node *)0x0) {
    ...
    *(Node ***)(pNVar5 + (long)unaff_x24 * 8) = ppNVar4;
    if (*(long *)pNVar7 == 0) goto LAB_00fa5d8c;
