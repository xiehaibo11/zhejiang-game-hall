...
/* cocos2d::experimental::PcmData::TEMPNAMEPLACEHOLDERVALUE(cocos2d::experimental::PcmData const&)
    */

PcmData * __thiscall cocos2d::experimental::PcmData::operator=(PcmData *this,PcmData *param_1)
