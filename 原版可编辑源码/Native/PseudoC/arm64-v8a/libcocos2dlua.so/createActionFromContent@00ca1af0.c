...
/* cocostudio::timeline::ActionTimelineCache::createActionFromContent(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&) */

void __thiscall
cocostudio::timeline::ActionTimelineCache::createActionFromContent
...

{
  ...
  if ((lVar1 == 0) || (plVar2 = *(long **)(lVar1 + 0x28), plVar2 == (long *)0x0)) {
    plVar2 = (long *)loadAnimationActionWithContent(this,param_1,param_2);
  }
                    /* WARNING: Could not recover jumptable at 0x00ca1b44. Too many branches */
