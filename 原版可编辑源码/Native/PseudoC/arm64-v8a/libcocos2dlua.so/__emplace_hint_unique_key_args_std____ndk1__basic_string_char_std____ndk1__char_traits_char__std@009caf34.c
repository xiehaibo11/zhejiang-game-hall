...
/* WARNING: Heritage AFTER dead removal. Example location: x0 : 0x009caf6c */
...
/* std::__ndk1::__tree_iterator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const, cocos2d::LuaValue> const&)
    */
  ...
  if (p_Var4 == (__tree_node_base *)0x0) {
    ...
    basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::basic_string
              ((basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
               (p_Var4 + 0x20),param_4);
    cocos2d::LuaValue::copy((LuaValue *)(p_Var4 + 0x38),(LuaValue *)(param_4 + 0x18));
    *(undefined8 *)p_Var4 = 0;
