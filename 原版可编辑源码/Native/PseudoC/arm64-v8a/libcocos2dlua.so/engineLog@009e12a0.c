...
/* WARNING: Removing unreachable block (ram,0x009e137c) */
...

{
  ...
  *local_50 = (long)&PTR____func_016a0268;
  local_50[2] = 0;
  local_50[1] = (long)_log;
  local_50[5] = CONCAT71(uStack_8f,uStack_90);
  local_50[6] = local_88;
  *(ulong *)((long)local_50 + 0x21) = CONCAT17(uStack_90,uStack_97);
  core::Flags::post((Flags *)(this + 8),(function *)alStack_70);
  if (alStack_70 == local_50) {
    pcVar2 = *(code **)(*local_50 + 0x20);
  }
  else {
    if (local_50 == (long *)0x0) goto LAB_009e1374;
