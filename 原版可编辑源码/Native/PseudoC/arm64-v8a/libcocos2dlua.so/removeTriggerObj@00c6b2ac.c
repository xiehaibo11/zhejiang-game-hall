...
/* cocostudio::TriggerMng::removeTriggerObj(unsigned int) */

void __thiscall cocostudio::TriggerMng::removeTriggerObj(TriggerMng *this,uint param_1)

{
  ...
  if (uVar4 != 0) {
    ...
    uVar6 = (ulong)param_1;
    if (uVar5 < 2) {
      uVar7 = (ulong)((int)uVar4 - 1U & param_1);
    }
    else {
      uVar7 = uVar6;
      if (uVar4 <= uVar6) {
