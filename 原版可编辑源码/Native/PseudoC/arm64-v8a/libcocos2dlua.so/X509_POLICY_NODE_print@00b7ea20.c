...

{
  ...
  puVar12 = *(uint **)node;
  BIO_printf(out,"%*sPolicy: ",(ulong)(uint)indent,&DAT_013c996e);
  ...
  BIO_printf(out,"%*s%s\n",(ulong)uVar1,&DAT_013c996e,pcVar7);
  lVar8 = *(long *)(puVar12 + 4);
  if (lVar8 == 0) {
    BIO_printf(out,"%*sNo Qualifiers\n",(ulong)uVar1,&DAT_013c996e);
    return;
  }
    ...
    do {
      ...
      if (iVar4 == 0xa5) {
        ...
        if (plVar13 != (long *)0x0) {
          ...
          BIO_printf(out,"%*sNumber%s: ",(ulong)uVar2,&DAT_013c996e,pcVar7);
          iVar4 = OPENSSL_sk_num(plVar13[1]);
          if (0 < iVar4) {
            iVar4 = 0;
            do {
...
LAB_00b7ecbc:
        BIO_printf(out,pcVar7,uVar9,&DAT_013c996e,uVar10);
      }
      else {
        BIO_printf(out,"%*sUnknown Qualifier: ",(ulong)uVar2,&DAT_013c996e);
