...
void FUN_0114a104(long param_1,ulong param_2,int param_3)

{
  ...
  do {
    ...
    if ((int)((uint)(byte)(&DAT_0149961c)[lVar7] +
             (uint)(byte)(&DAT_0149961c)[(ulong)bVar3 - (ulong)bVar4] * 4) <= (int)uVar2) {
      iVar1 = ((uint)bVar4 - (uint)bVar3) * 3 + (int)(char)(&DAT_01498d40)[lVar7];
      cVar5 = (&DAT_014991ad)[iVar1 + 4 >> 3];
      *(undefined *)((param_1 - lVar9) + lVar12) =
           (&DAT_0149931d)[(long)(char)(&DAT_014991ad)[iVar1 + 3 >> 3] + (ulong)bVar3];
      *(undefined *)(param_1 + lVar12) = (&DAT_0149931d)[(ulong)bVar4 - (long)cVar5];
    }
    lVar12 = lVar12 + 1;
  } while (lVar12 != 0x10);
  param_1 = param_1 + uVar10;
  ...
  do {
    ...
    ;
    if ((int)((uint)(byte)(&DAT_0149961c)[lVar8] +
             (uint)(byte)(&DAT_0149961c)[(ulong)bVar3 - (ulong)bVar4] * 4) <= (int)uVar2) {
      iVar1 = ((uint)bVar4 - (uint)bVar3) * 3 + (int)(char)(&DAT_01498d40)[lVar8];
      cVar5 = (&DAT_014991ad)[iVar1 + 4 >> 3];
