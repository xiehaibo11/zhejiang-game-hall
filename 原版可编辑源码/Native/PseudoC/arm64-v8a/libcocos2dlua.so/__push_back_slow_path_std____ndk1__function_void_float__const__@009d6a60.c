...

{
  ...
  if (0x555555555555555 < uVar1) {
    ...
    __vector_base_common<true>::__throw_length_error();
                    ...
                    /* try { // try from 009d6aa8 to 00ad6b17 has its CatchHandler @ 009d8188 */
...
LAB_009d6af0:
  ...
  if (plVar3 == (long *)0x0) {
    *(undefined8 *)((long)pvVar2 + lVar6 * 0x10 + 0x20) = 0;
                    /* try { // try from 009d6b30 to 00ad6b9f has its CatchHandler @ 009d8184 */
  }
    ...
    *(void **)((long)pvVar2 + lVar6 * 0x10 + 0x20) = pvVar10;
    ...
    uVar4 = (**(code **)(*plVar3 + 0x10))();
                    /* try { // try from 009d6b18 to 00ad6b2b has its CatchHandler @ 009d7fd8 */
      ...
      if (lVar8 == 0) {
        ...
        *(long *)((long)pvVar10 + lVar6 + -0x10) = (long)pvVar10 + lVar6 + -0x30;
        ...
        (**(code **)(*plVar5 + 0x18))(plVar5,(long)pvVar10 + lVar6 + -0x30);
                    ...
                    /* try { // try from 009d6ba0 to 00ad6cef has its CatchHandler @ 009cee70 */
...
joined_r0x009d6be8:
    if (plVar12 != plVar3) {
      ...
      plVar12 = plVar12 + -6;
      if (plVar12 != plVar5) goto code_r0x009d6c30;
