...
void FUN_010f97a4(long param_1,uint param_2,uint param_3)

{
  ...
  undefined8 uVar10;
                    ...
                    /* try { // try from 010f97b4 to 011f97bf has its CatchHandler @ 010f980c */
                    /* try { // try from 010f97c0 to 011f981f has its CatchHandler @ 010f9784 */
  if (param_3 == 0) {
  ...
  if (iVar8 == 0) {
                    /* catch() { ... } // from try @ 010f97b4 with catch @ 010f980c */
