...
undefined8 FUN_008c601c(undefined8 param_1)

{
  ...
  if ((((iVar3 == 0) || (iVar3 = tolua_isnumber(param_1,2,0,auStack_78), iVar3 == 0)) ||
    ...
    tolua_error(param_1,"#ferror in function \'glUniformMatrix2fv\'.",auStack_78);
  }
  else {
    ...
    if (pvVar4 != (void *)0x0) {
      ...
      glUniformMatrix2fv((int)dVar7,1,(int)dVar8,pvVar4);
