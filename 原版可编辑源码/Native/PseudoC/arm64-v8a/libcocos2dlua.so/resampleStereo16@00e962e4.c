...
/* cocos2d::experimental::AudioResamplerOrder1::resampleStereo16(int*, unsigned long,
   cocos2d::experimental::AudioBufferProvider*) */

ulong __thiscall
cocos2d::experimental::AudioResamplerOrder1::resampleStereo16
...
LAB_00e9637c:
  do {
    ...
    *(ulong *)(this + 0x20) = uVar9;
    ...
    if (*(long *)pAVar1 == 0) goto LAB_00e96560;
    uVar11 = *(ulong *)(this + 0x20);
    uVar8 = uVar14 - uVar11;
...
LAB_00e96424:
  ...
  do {
    if (uVar14 != 0) {
      if (uVar16 < uVar17) goto LAB_00e964ac;
      goto LAB_00e96514;
    }
    uVar7 = uVar15 >> 0xf;
...
joined_r0x00e96518:
  ...
  if (uVar17 <= uVar16) goto LAB_00e96560;
  uVar11 = *(ulong *)(this + 0x20);
  if (uVar11 == 0) goto LAB_00e9637c;
  goto LAB_00e96424;
}
