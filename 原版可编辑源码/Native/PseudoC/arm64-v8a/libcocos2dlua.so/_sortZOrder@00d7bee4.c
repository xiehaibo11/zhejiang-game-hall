...

{
  ...
  lVar7 = *(long *)(this + 0x20);
                    /* try { // try from 00d7bf14 to 00e7bf2b has its CatchHandler @ 00d7d948 */
  if ((this[0x5b] != (Armature)0x0) || (param_1 != (short *)0x0)) {
    lVar5 = *(long *)(lVar7 + 0x80) - *(long *)(lVar7 + 0x78);
    if (lVar5 != 0) {
      uVar10 = 0;
      uVar12 = lVar5 >> 3;
      do {
        ...
        if (param_1 != (short *)0x0) {
          uVar6 = (ulong)param_1[uVar10 + param_2];
        }
        if (uVar6 < uVar12) {
          puVar11 = *(undefined8 **)(this + 0x78);
          puVar2 = *(undefined8 **)(this + 0x80);
          if (puVar11 != puVar2) {
            lVar5 = *(long *)(*(long *)(lVar7 + 0x78) + uVar6 * 8);
            __n = *(size_t *)(lVar5 + 0x28);
            __s2 = *(char **)(lVar5 + 0x30);
            if ((*(byte *)(lVar5 + 0x20) & 1) == 0) {
              __s2 = (char *)(lVar5 + 0x21);
              __n = (ulong)(*(byte *)(lVar5 + 0x20) >> 1);
            }
            do {
              this_00 = (Slot *)*puVar11;
              lVar5 = *(long *)(this_00 + 200);
              bVar3 = *(byte *)(lVar5 + 0x20);
              uVar6 = (ulong)(bVar3 >> 1);
              sVar1 = uVar6;
              if ((bVar3 & 1) != 0) {
                sVar1 = *(size_t *)(lVar5 + 0x28);
              }
              if (sVar1 == __n) {
...
LAB_00d7c038:
                  ...
                  pcVar8 = (char *)(lVar5 + 0x21);
                  pcVar9 = __s2;
                  while (*pcVar8 == *pcVar9) {
                    uVar6 = uVar6 - 1;
                    pcVar8 = pcVar8 + 1;
                    pcVar9 = pcVar9 + 1;
                    if (uVar6 == 0) goto LAB_00d7c038;
                  }
                }
