...

{
  ...
  if (param_1 == 0) {
    uVar3 = 0x21;
                    /* try { // try from 01060b9c to 01160ba3 has its CatchHandler @ 01060c08 */
  }
  else {
    uVar3 = 6;
    if (((param_2 != (char *)0x0) && (param_3 != 0)) && (param_4 != 0)) {
      ...
      if (puVar6 == puVar1) {
        ...
        pcVar5 = *(code **)(*(long *)*puVar6 + 0x40);
                    /* catch() { ... } // from try @ 01060ba4 with catch @ 01060b6c */
        if (((pcVar5 != (code *)0x0) &&
            (lVar4 = (*pcVar5)((long *)*puVar6,"properties"), lVar4 != 0)) &&
           (*(code **)(lVar4 + 8) != (code *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x01060b94. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          uVar3 = (**(code **)(lVar4 + 8))(*puVar6,param_3,param_4);
          return uVar3;
        }
        uVar3 = 7;
                    /* try { // try from 01060ba4 to 01160c23 has its CatchHandler @ 01060b6c */
      }
    }
  }
  return uVar3;
