...
void FUN_01072548(long param_1,long param_2,undefined8 param_3)
  ...
  if (lVar14 == 0) {
    ...
    if (sVar6 == 0) {
      ...
      if (sVar7 == 0) {
        ...
        lVar14 = FT_Hypot((long)iVar2,(long)iVar3);
      }
    }
    *(long *)(param_1 + 0x1d8) = lVar14;
  }
  uVar12 = FT_DivFix(param_3,lVar14);
  *(undefined8 *)(*(long *)(param_1 + 0x2a8) + param_2 * 8) = uVar12;
  return;
}
