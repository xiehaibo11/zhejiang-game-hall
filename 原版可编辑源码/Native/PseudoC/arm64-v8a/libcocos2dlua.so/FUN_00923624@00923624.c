...
void FUN_00923624(long *param_1,long *param_2)

{
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
        ...
        param_1[4] = (long)param_1;
                    /* try { // try from 00923734 to 00a2377f has its CatchHandler @ 00923734
                       catch() { ... } // from try @ 00923734 with catch @ 00923734
                       catch() { ... } // from try @ 00923784 with catch @ 00923734 */
  ...
  if (*(long *)(lVar1 + 0x28) == local_38) {
    return;
                    ...
                    /* try { // try from 00923780 to 00a23783 has its CatchHandler @ 009237d8 */
  __stack_chk_fail();
}
