...

{
  ...
  puVar4 = (undefined1 *)FUN_0104b1fc(0x208,"create vhost");
  if (puVar4 != (undefined1 *)0x0) {
    ppuVar7 = *(undefined ***)(param_2 + 4);
    if (ppuVar7 == (undefined **)0x0) {
      ppuVar7 = &PTR_s_http_only_01727cb8;
      *(undefined ***)(param_2 + 4) = &PTR_s_http_only_01727cb8;
    }
    ...
    *(undefined8 *)(puVar4 + 0x1c8) = *(undefined8 *)(param_2 + 0x1a);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 0104a0f8 with catch @ 0104a274
                        */
    *(undefined4 *)(puVar4 + 500) = param_2[0x56];
                    /* catch(type#1 @ 00000000) { ... } // from try @ 0104a2cc with catch @ 0104a278
                        */
    iVar2 = 5;
    if (param_2[0x2e] != 0) {
      iVar2 = param_2[0x2e];
    ...
    *(int *)(puVar4 + 0x1f0) = iVar2;
    __dest = (void *)FUN_0104b1fc((long)(*(short *)(param_1 + 0xca8) + iVar3) * 0x38,
                                  "vhost-specific plugin table");
    if (__dest == (void *)0x0) {
      _lws_log(1,"OOM\n");
    }
    else {
                    /* try { // try from 0104a2c4 to 0114a2cb has its CatchHandler @ 0104a440 */
                    /* try { // try from 0104a2cc to 0114a443 has its CatchHandler @ 0104a278 */
      ...
      uVar5 = FUN_0104b1fc((long)*(int *)(puVar4 + 0x1dc) << 3,"same vh list");
      ...
      *(undefined8 *)(puVar4 + 0x160) = *(undefined8 *)(param_2 + 0x32);
      ...
      for (plVar10 = *(long **)(param_2 + 0x32); plVar10 != (long *)0x0; plVar10 = (long *)*plVar10)
      {
        _lws_log(4,"   mounting %s%s to %s\n",
                 (&PTR_s_http____01727d28)[*(byte *)((long)plVar10 + 0x4d)],plVar10[2],plVar10[1]);
        for (plVar12 = (long *)plVar10[7]; plVar12 != (long *)0x0; plVar12 = (long *)*plVar12) {
          iVar3 = *(int *)(puVar4 + 0x1dc);
          if (iVar3 < 1) {
            if (iVar3 == 0) goto LAB_0104a3f4;
          }
          else {
...
LAB_0104a3f4:
              _lws_log(1,"ignoring unknown interpret protocol %s\n",plVar12[3]);
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 0104a2c4 with catch @ 0104a440
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 0104a49c with catch @ 0104a444
                       catch(type#1 @ 00000000) { ... } // from try @ 0104a660 with catch @ 0104a444
                        */
      ...
      *(undefined4 *)(puVar4 + 0x1d0) = uVar1;
      if (*(long *)(param_2 + 0x14) == 0) {
        ...
        if (pcVar6 != (char *)0x0) {
                    /* try { // try from 0104a494 to 0114a49b has its CatchHandler @ 0104a76c */
                    /* try { // try from 0104a49c to 0114a5ef has its CatchHandler @ 0104a444 */
      ...
      *(undefined8 *)(puVar4 + 0x1e0) = *(undefined8 *)(param_2 + 0x1c);
      ...
      if ((iVar3 == 0) && (iVar3 = FUN_0105093c(param_2,puVar4), iVar3 == 0)) {
        iVar3 = FUN_0105253c(param_2,puVar4);
      ...
      thunk_FUN_0104b1cc(puVar4,0,"lws_free");
    }
  }
