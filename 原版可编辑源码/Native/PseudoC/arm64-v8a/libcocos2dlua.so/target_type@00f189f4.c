...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void
   ...
   std::__ndk1::allocator<cocos2d::Touch*> > const&, cocos2d::Event*)>::target_type() const */
...
{
  return &__bind<void(cocos2d::Layer::*)(std::__ndk1::vector<cocos2d::Touch*,std::__ndk1::allocator<cocos2d::Touch*>>const&,cocos2d::Event*),cocos2d::Layer*,std::__ndk1::placeholders::__ph<1>const&,std::__ndk1::placeholders::__ph<2>const&>
          ::typeinfo;
}
