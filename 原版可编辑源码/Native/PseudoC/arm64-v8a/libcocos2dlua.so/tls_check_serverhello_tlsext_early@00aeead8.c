...

{
  ...
  **(ulong **)(param_1 + 0x24) = **(ulong **)(param_1 + 0x24) & 0xfffffffffffffdff;
                    /* try { // try from 00aeeb54 to 00beeb5f has its CatchHandler @ 00aeef54 */
  if (uVar13 < 2) {
    return 0;
  }
  if (*param_1 < 0x301) {
...
LAB_00aeefe0:
    ...
    if (bVar2) {
      uVar7 = uVar9;
                    ...
                    /* try { // try from 00aef00c to 00bef09f has its CatchHandler @ 00aef00c
                       catch() { ... } // from try @ 00aef00c with catch @ 00aef00c
                       catch() { ... } // from try @ 00aef20c with catch @ 00aef00c */
    return uVar7;
  }
  bVar2 = false;
  uVar9 = 0xffffffff;
...
LAB_00aeebf0:
                    /* try { // try from 00aeebf0 to 00beebf7 has its CatchHandler @ 00aeef5c */
        puVar16 = data + uVar14;
                    /* try { // try from 00aeebf8 to 00beec03 has its CatchHandler @ 00aeef50 */
      }
      else {
                    /* try { // try from 00aeebd4 to 00beebdb has its CatchHandler @ 00aeef5c */
        if (CONCAT11(*puVar16,puVar16[1]) != 0x23) goto LAB_00aeebf0;
        if (bVar2) {
          return 0xffffffff;
        }
                    /* try { // try from 00aeec04 to 00beedab has its CatchHandler @ 00aee650 */
        if (uVar1 == 0) {
          uVar9 = 1;
          param_1[0xa1] = 1;
        }
        else {
          if (*(long *)(param_1 + 0xb0) == 0) goto LAB_00aeec30;
          uVar9 = 2;
        }
        bVar2 = true;
        uVar13 = uVar12;
  ...
  do {
    ...
    if (uVar12 < uVar13) {
      return 0;
                    ...
                    /* catch() { ... } // from try @ 00aee8e4 with catch @ 00aeefb0 */
    if (CONCAT11(*puVar16,puVar16[1]) == 0x17) {
      **(ulong **)(param_1 + 0x24) = **(ulong **)(param_1 + 0x24) | 0x200;
    }
    bVar2 = false;
...
LAB_00aeed20:
    ...
    if ((int)uVar1 <= iVar4 + iVar5 + 0x10) goto LAB_00aeedcc;
    iVar5 = uVar1 - iVar4;
    ...
    iVar4 = CRYPTO_memcmp(auStack_b0,data + iVar5,(long)iVar4);
                    /* try { // try from 00aeedac to 00beedb7 has its CatchHandler @ 00aeef48 */
    if (iVar4 != 0) {
      EVP_CIPHER_CTX_free(ctx_00);
                    /* try { // try from 00aeedb8 to 00beefd3 has its CatchHandler @ 00aee650 */
      goto LAB_00aeee00;
    }
    ...
    if (0 < iVar4) {
      ...
      *param_4 = pSVar8;
      ...
      goto LAB_00aeede4;
                    ...
                    /* catch() { ... } // from try @ 00aeea34 with catch @ 00aeef4c */
                    /* catch() { ... } // from try @ 00aeebf8 with catch @ 00aeef50 */
    EVP_CIPHER_CTX_free(ctx_00);
                    /* catch() { ... } // from try @ 00aeeb54 with catch @ 00aeef54 */
                    /* catch() { ... } // from try @ 00aeebd4 with catch @ 00aeef5c
                       catch() { ... } // from try @ 00aeebf0 with catch @ 00aeef5c */
    CRYPTO_free(out);
LAB_00aeee00:
    param_1[0xa1] = 1;
    uVar9 = 2;
