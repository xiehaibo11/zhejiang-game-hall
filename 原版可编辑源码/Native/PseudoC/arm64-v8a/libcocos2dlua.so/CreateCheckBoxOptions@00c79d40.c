...
/* flatbuffers::CreateCheckBoxOptions(flatbuffers::FlatBufferBuilder&,
...

{
  ...
  FlatBufferBuilder::AddElement<unsigned_char>(param_1,0x12,param_9,'\x01');
  FlatBufferBuilder::AddElement<unsigned_char>(param_1,0x10,param_8,'\x01');
