...
/* std::__ndk1::vector<cocos2d::Sprite*, std::__ndk1::allocator<cocos2d::Sprite*>
   >::insert(std::__ndk1::__wrap_iter<cocos2d::Sprite* const*>, cocos2d::Sprite* const&) */

undefined8 * __thiscall
std::__ndk1::vector<cocos2d::Sprite*,std::__ndk1::allocator<cocos2d::Sprite*>>::insert
          (vector<cocos2d::Sprite*,std::__ndk1::allocator<cocos2d::Sprite*>> *this,
...

{
  ...
  puVar10 = *(undefined8 **)(this + 8);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00f430b4 with catch @ 00f431f0
                        */
