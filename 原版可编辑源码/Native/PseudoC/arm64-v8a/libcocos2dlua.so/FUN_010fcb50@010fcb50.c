...
void FUN_010fcb50(long param_1,long *param_2,uint param_3,undefined8 *param_4,int param_5)

{
  ...
  ulong uVar9;
                    ...
                    /* try { // try from 010fcb58 to 011fcbdf has its CatchHandler @ 010fc9d0 */
  if ((0 < param_5) && (uVar2 = *(uint *)(param_1 + 0x88), uVar2 != 0)) {
    ...
    do {
      ...
      uVar9 = (ulong)uVar2;
      do {
                    /* catch() { ... } // from try @ 010fca14 with catch @ 010fcba0 */
        uVar9 = uVar9 - 1;
                    /* catch() { ... } // from try @ 010fcb48 with catch @ 010fcbbc */
