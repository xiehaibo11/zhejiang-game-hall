...
int FUN_011eba0c(long *param_1,long *param_2,uint *param_3,long *param_4,int param_5)
...
LAB_011eba90:
    bVar2 = true;
    if (param_2 != (long *)0x0) goto LAB_011eba98;
LAB_011eba6c:
    if (bVar2) goto LAB_011ebae8;
    plVar8 = (long *)0x0;
  }
  else {
    ...
    bVar2 = *param_1 == 0;
    if (param_2 == (long *)0x0) goto LAB_011eba6c;
LAB_011eba98:
...
LAB_011ebae8:
  ...
  if ((uVar10 & 1) != 0) {
    ...
    param_5 = param_5 + -1;
    plVar9 = (long *)*param_1;
    if (plVar9 != (long *)0x0) goto LAB_011ebba0;
LAB_011ebc00:
    plVar9 = (long *)0x0;
    bVar2 = true;
    iVar5 = uVar4 - 0x30;
    if (plVar8 == (long *)0x0) goto LAB_011ebbcc;
LAB_011ebc0c:
    if ((int *)plVar8[3] == (int *)plVar8[4]) {
...
LAB_011ebd30:
          bVar2 = true;
          if (plVar8 != (long *)0x0) goto LAB_011ebd38;
LAB_011ebd0c:
          if (!bVar2) {
            return iVar5;
          }
          ...
          bVar2 = *param_1 == 0;
          if (plVar8 == (long *)0x0) goto LAB_011ebd0c;
LAB_011ebd38:
          if ((int *)plVar8[3] == (int *)plVar8[4]) {
            iVar7 = (**(code **)(*plVar8 + 0x48))(plVar8);
          }
      ...
      if (plVar9 == (long *)0x0) goto LAB_011ebc00;
LAB_011ebba0:
      if ((int *)plVar9[3] == (int *)plVar9[4]) {
      ...
      iVar5 = uVar4 - 0x30;
      if (plVar8 != (long *)0x0) goto LAB_011ebc0c;
LAB_011ebbcc:
      bVar3 = true;
      plVar1 = plVar8;
    } while( true );
