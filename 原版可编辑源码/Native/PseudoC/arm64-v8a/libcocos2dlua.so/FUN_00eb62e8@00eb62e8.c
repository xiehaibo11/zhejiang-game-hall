...
void FUN_00eb62e8(long *param_1,undefined8 param_2,long param_3,long param_4,int param_5,
                 long param_6)

{
  ...
  if (param_3 < param_4) {
    do {
      ...
      lVar5 = FUN_00eb4510(param_1,&local_90,0xffffffffffffffff);
      if (lVar5 == -0x80) goto LAB_00eb64d8;
  ...
  if (lVar5 != -0x80) {
    if ((param_3 < param_4) && (-1 < lVar5)) {
      ...
      iVar3 = FUN_00eb62e8(param_1,lVar9,lVar7,param_4,uVar4,param_6 + 1);
      ogg_page_release(&local_90);
      if (iVar3 == -0x80) {
        lVar5 = 0xffffff80;
        goto LAB_00eb64d8;
