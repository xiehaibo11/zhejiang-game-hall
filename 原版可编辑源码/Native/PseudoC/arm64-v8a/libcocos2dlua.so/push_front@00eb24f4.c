...

{
  ...
  if (__src == *(undefined8 **)this) {
    ...
    if (uVar2 < uVar5) {
      ...
      *(long *)(this + 0x10) = *(long *)(this + 0x10) + (lVar1 >> 1) * 8;
      ...
      if (uVar5 >> 0x3d != 0) {
                    /* try { // try from 00eb2628 to 00fb264b has its CatchHandler @ 00eb25b8 */
      ...
      puVar6 = __dest;
      if (lVar1 != 0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00eb2628 with catch @ 00eb25b8
                       catch(type#1 @ 00000000) { ... } // from try @ 00eb2658 with catch @ 00eb25b8
                       catch(type#1 @ 00000000) { ... } // from try @ 00eb2688 with catch @ 00eb25b8
                       catch(type#1 @ 00000000) { ... } // from try @ 00eb26b0 with catch @ 00eb25b8
                       catch(type#1 @ 00000000) { ... } // from try @ 00eb26dc with catch @ 00eb25b8
                        */
        lVar4 = (lVar1 >> 3) << 3;
        do {
          lVar4 = lVar4 + -8;
  ...
  *(long *)(this + 8) = *(long *)(this + 8) + -8;
                    /* try { // try from 00eb2620 to 00fb2627 has its CatchHandler @ 00eb271c */
  return;
}
