...
/* void std::__ndk1::vector<std::__ndk1::function<void ()>,
   ...
   >::__push_back_slow_path<std::__ndk1::function<void ()> const&>(std::__ndk1::function<void ()>
   const&) */
...

{
  ...
  if (0x555555555555555 < uVar1) {
    ...
    __vector_base_common<true>::__throw_length_error();
                    ...
                    /* try { // try from 009d6874 to 00ad6913 has its CatchHandler @ 009cee70 */
...
LAB_009d68b8:
  ...
  if (plVar3 == (long *)0x0) {
    ...
    *(void **)((long)pvVar2 + lVar6 * 0x10 + 0x20) = pvVar10;
                    /* try { // try from 009d6914 to 00ad6983 has its CatchHandler @ 009d8190 */
  ...
  if (plVar12 == plVar3) {
    ...
    *(long *)(this + 8) = (long)pvVar10 + 0x30;
                    /* try { // try from 009d6a0c to 00ad6aa7 has its CatchHandler @ 009cee70 */
    ...
    do {
      ...
      if (lVar8 == 0) {
        ...
        *(long *)((long)pvVar10 + lVar6 + -0x10) = (long)pvVar10 + lVar6 + -0x30;
                    /* try { // try from 009d6984 to 00ad6997 has its CatchHandler @ 009d7fdc */
      ...
      lVar6 = lVar6 + -0x30;
                    ...
                    /* try { // try from 009d699c to 00ad6a0b has its CatchHandler @ 009d818c */
    plVar3 = *(long **)this;
    plVar12 = *(long **)(this + 8);
...
joined_r0x009d69b0:
    if (plVar12 != plVar3) {
      ...
      plVar12 = plVar12 + -6;
      if (plVar12 != plVar5) goto code_r0x009d69f8;
