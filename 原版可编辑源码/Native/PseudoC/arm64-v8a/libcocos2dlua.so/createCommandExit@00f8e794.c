...
/* cocos2d::Console::createCommandExit() */

void __thiscall cocos2d::Console::createCommandExit(Console *this)

{
  ...
  basic_string<decltype(nullptr)>(local_118,"exit");
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  basic_string<decltype(nullptr)>(local_130,"Close connection to the console. Args: [-h | help | ]")
  ;
  local_e0 = &local_100;
  local_100 = &PTR_FUN_017223e0;
  uStack_f0 = 0;
  local_f8 = commandExit;
  local_e8 = this;
  ...
  if (&local_100 == local_e0) {
    ...
    if (local_e0 == (undefined ***)0x0) goto LAB_00f8e858;
