...

{
  ...
  if (DAT_0011d1c0 == 0) {
    DAT_0011d1c0 = thunk_EXT_FUN_00002bb0(0x40);
    iVar2 = thunk_EXT_FUN_00002bb0(DAT_0011d1c0,0x100);
    if (iVar2 != 0) {
      thunk_EXT_FUN_00002bb0(DAT_0011d1c0);
      pcVar5 = "init http aes lru cache failed";
      goto LAB_00104c04;
    }
  }
  ...
  if (iVar2 == 0) {
    ...
    *(undefined1 *)(lVar4 + 8) = 0;
    ...
    pcVar5 = "http put aes key to cache failed.";
  }
  else {
    thunk_EXT_FUN_00002bb0(uVar3);
