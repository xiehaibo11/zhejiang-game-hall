...
ulong cryptor_aes_dec(long param_1,undefined4 param_2,undefined8 *param_3,int param_4,long param_5,
  ...
  if ((((param_1 != 0) && (param_3 != (undefined8 *)0x0)) && (param_5 != 0)) && (param_7 != 0)) {
    ...
    if (iVar2 == 0) {
      if (param_4 == 0x10) {
        ...
        puVar3[1] = param_3[1];
        *puVar3 = uVar5;
        iVar2 = thunk_EXT_FUN_00002bb0(auStack_188,0,param_6,&local_190,puVar3,param_5,param_7);
