...
bool FUN_00129b10(long param_1,long param_2,undefined8 *param_3)
...
LAB_00129ba4:
    ...
    if ((*(byte *)(param_1 + 0x10) & 0x18) == 0) {
      ...
      if (lVar3 != 0) {
        if ((*(byte *)(lVar3 + 0x10) & 0x18) != 0) goto LAB_00129b48;
        if (*(long *)(param_1 + 8) == *(long *)(param_2 + 8)) goto LAB_00129ba4;
      }
    }
    else {
LAB_00129b48:
