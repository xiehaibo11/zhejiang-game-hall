...
undefined8 * FUN_00118900(long *param_1)

{
  ...
  if ((pcVar16 == pcVar25) || ((cVar2 = *pcVar25, cVar2 != 'T' && (cVar2 != 'G')))) {
    ...
    puVar11 = (undefined8 *)FUN_0011aac8(param_1,&local_80);
    puVar27 = puVar11;
    if (puVar11 == (undefined8 *)0x0) goto LAB_00119400;
    lVar10 = param_1[0x53];
    ...
    if (local_70 < uVar9) {
      ...
      do {
        ...
        if ((ulong)(lVar21 - lVar12 >> 3) <= uVar9) goto LAB_001193fc;
        lVar14 = lVar14 + -1;
        plVar23 = plVar23 + 1;
    ...
    if (((byte *)param_1[1] == (byte *)*param_1) ||
       ((uVar4 = *(byte *)*param_1 - 0x2e, uVar4 < 0x32 &&
        ((1L << ((ulong)uVar4 & 0x3f) & 0x2000000800001U) != 0)))) goto LAB_00119400;
...
LAB_00118bf8:
      ...
      if (uVar9 != 0) {
        ...
        pcVar22 = pcVar25;
        do {
          if (*pcVar16 != *pcVar22) goto LAB_00118bf8;
          pcVar16 = pcVar16 + 1;
          uVar18 = uVar18 - 1;
          pcVar22 = pcVar22 + 1;
        } while (uVar18 != 0);
      ...
      *param_1 = (long)pcVar25;
      lVar10 = param_1[2];
      lVar14 = param_1[3];
      if (pcVar25 == (char *)param_1[1]) goto LAB_00118b30;
      while (*pcVar25 != 'E') {
LAB_00118b30:
        do {
          local_88 = FUN_0011b704(param_1);
          if (local_88 == 0) goto LAB_001193fc;
          FUN_0011b8dc(param_1 + 2,&local_88);
          pcVar25 = (char *)*param_1;
        } while (pcVar25 == (char *)param_1[1]);
      }
      lVar10 = (lVar14 - lVar10 >> 3) * 8;
      *param_1 = (long)(pcVar25 + 1);
      auVar29 = FUN_00122f38(param_1,param_1[2] + lVar10,param_1[3]);
      ...
      if (0xfef < lVar10 + 0x20U) {
        ...
        if (puVar27 == (void *)0x0) goto LAB_00119444;
        lVar10 = 0;
        *puVar27 = pvVar26;
        puVar27[1] = 0;
    ...
    if ((((char)local_80 != '\0') || (local_80._1_1_ == '\0')) ||
       (lVar10 = FUN_00119448(param_1), lVar10 != 0)) {
      pcVar25 = (char *)*param_1;
      if ((pcVar25 == (char *)param_1[1]) || (*pcVar25 != 'v')) {
        lVar14 = param_1[2];
        lVar12 = param_1[3];
        do {
          local_88 = FUN_00119448(param_1);
          if (local_88 == 0) goto LAB_001193fc;
          FUN_0011b8dc(param_1 + 2,&local_88);
        ...
        auVar29 = FUN_00122f38(param_1,param_1[2] + lVar14,param_1[3]);
        pvVar26 = (void *)param_1[0x25c];
        ...
        if (0xfef < lVar14 + 0x40U) {
          ...
          if (puVar8 == (void *)0x0) goto LAB_00119444;
          lVar14 = 0;
          *puVar8 = pvVar26;
          puVar8[1] = 0;
          ...
          *param_1 = (long)(pcVar25 + 2);
          ...
          if (lVar10 != 0) {
            ...
            if (((pbVar1 == pbVar15) || (bVar3 = *pbVar15, bVar3 < 0x30)) ||
              ...
              pbVar19 = pbVar15;
joined_r0x0011937c:
              if (pbVar19 != pbVar1) goto LAB_00118e80;
LAB_00119380:
              if (!bVar7) goto LAB_001193fc;
            }
            else {
              do {
                pbVar19 = pbVar15 + 1;
                if ((0x39 < bVar3) && (0x19 < (byte)(bVar3 + 0xbf))) {
                  bVar7 = false;
                  pbVar19 = pbVar15;
                  goto joined_r0x0011937c;
                }
                *param_1 = (long)pbVar19;
              } while ((pbVar1 != pbVar19) && (bVar3 = *pbVar19, pbVar15 = pbVar19, 0x2f < bVar3));
              bVar7 = false;
              if (pbVar19 == pbVar1) goto LAB_00119380;
LAB_00118e80:
              if (*pbVar19 != 0x5f) goto LAB_00119380;
      ...
      if (cVar2 != 'T') goto LAB_001193fc;
      if ((ulong)((long)pcVar16 - (long)pcVar25) < 2) {
switchD_00118994_caseD_44:
        pcVar25 = pcVar25 + 1;
        *param_1 = (long)pcVar25;
        if (pcVar16 == pcVar25) {
          bVar7 = false;
        ...
        uVar9 = FUN_0011b998(param_1);
        if (((uVar9 & 1) == 0) && (lVar10 = FUN_00118900(param_1), lVar10 != 0)) {
...
LAB_00119444:
            ...
            if (bVar6) {
              puVar11 = malloc(0x1000);
              if (puVar11 == (undefined8 *)0x0) goto LAB_00119444;
              lVar14 = 0;
              *puVar11 = puVar27;
              puVar11[1] = 0;
              param_1[0x25c] = (long)puVar11;
...
LAB_001193cc:
          ...
          *(undefined8 *)(lVar14 + 0x10) = &PTR_FUN_00136ec8;
        ...
        case 'C':
          *param_1 = (long)(pcVar25 + 2);
          lVar10 = FUN_00119448(param_1);
          if (lVar10 != 0) {
            pbVar15 = (byte *)*param_1;
            pbVar1 = (byte *)param_1[1];
            if ((pbVar15 == pbVar1) || (*pbVar15 != 0x6e)) {
              pbVar19 = pbVar15;
              if (pbVar15 != pbVar1) goto LAB_00119298;
LAB_001192d4:
              pbVar15 = (byte *)0x0;
              pbVar17 = pbVar19;
              pbVar20 = (byte *)0x0;
              ...
              pbVar19 = pbVar15 + 1;
              *param_1 = (long)pbVar19;
              if (pbVar19 == pbVar1) goto LAB_001192d4;
LAB_00119298:
              if (9 < *pbVar19 - 0x30) goto LAB_001192d4;
              do {
                pbVar19 = pbVar19 + 1;
                *param_1 = (long)pbVar19;
                pbVar17 = pbVar1;
            ...
            if ((pbVar15 == pbVar20) || (pbVar17 == pbVar1)) goto LAB_00119400;
            if (*pbVar17 == 0x5f) {
              *param_1 = (long)(pbVar17 + 1);
              lVar14 = FUN_00119448(param_1);
              if (lVar14 != 0) {
                pvVar26 = (void *)param_1[0x25c];
                ...
                if (0xfef < lVar12 + 0x20U) {
                  puVar11 = malloc(0x1000);
                  if (puVar11 == (void *)0x0) goto LAB_00119444;
                  lVar12 = 0;
                  *puVar11 = pvVar26;
                  puVar11[1] = 0;
                  param_1[0x25c] = (long)puVar11;
          ...
          break;
        default:
          goto switchD_00118994_caseD_44;
        case 'H':
          *param_1 = (long)(pcVar25 + 2);
          lVar10 = FUN_0011aac8(param_1,0);
          if (lVar10 != 0) {
        ...
        case 'c':
          *param_1 = (long)(pcVar25 + 2);
          uVar9 = FUN_0011b998(param_1);
          if ((((uVar9 & 1) == 0) && (uVar9 = FUN_0011b998(param_1), (uVar9 & 1) == 0)) &&
             (lVar10 = FUN_00118900(param_1), lVar10 != 0)) {
            pvVar26 = (void *)param_1[0x25c];
            lVar14 = *(long *)((long)pvVar26 + 8);
            puVar27 = pvVar26;
            if (0xfef < lVar14 + 0x30U) {
