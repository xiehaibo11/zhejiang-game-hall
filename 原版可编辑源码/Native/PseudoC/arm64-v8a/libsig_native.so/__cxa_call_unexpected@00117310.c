...

{
  ...
  if ((uVar6 & 1) != 0) {
    ...
    FUN_0011768c(&local_70,*unaff_x22);
    pbVar17 = local_70 + 1;
    bVar4 = *local_70;
    uVar6 = (ulong)bVar4;
    local_70 = pbVar17;
      ...
      if (p_Var13 != (_Unwind_Exception *)0x0) {
        ...
        if ((p_Var13 != p_Var18) && (((uVar5 ^ 1) & 1) == 0)) {
          ...
          while( true ) {
            ...
            if (uVar15 == 0) break;
            if ((0xc < (uint)uVar20) || ((0x1c1dU >> uVar20 & 1) == 0)) goto LAB_001175c8;
            local_68 = p_Var2 + -(uVar15 << (*(ulong *)(&DAT_0012e3a0 + uVar20 * 8) & 0x3f));
            plVar10 = (long *)FUN_0011768c(&local_68,uVar6);
            local_68 = p_Var18;
        ...
        local_78 = &PTR__bad_alloc_00136c18;
...
LAB_001175c8:
          local_68 = p_Var2;
                    /* WARNING: Subroutine does not return */
          FUN_001172e4(1,param_1);
        }
        local_68 = p_Var2 + -(uVar19 << (*(ulong *)(&DAT_0012e408 + uVar15 * 8) & 0x3f));
        plVar10 = (long *)FUN_0011768c(&local_68,uVar6);
...
LAB_001175e8:
  ...
  *puVar8 = &PTR__bad_alloc_00136c18;
                    /* WARNING: Subroutine does not return */
  __cxa_throw(puVar8,&std::bad_exception::typeinfo,std::bad_alloc::~bad_alloc);
}
