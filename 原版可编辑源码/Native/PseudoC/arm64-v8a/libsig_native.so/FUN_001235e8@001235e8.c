...
undefined8 * FUN_001235e8(long *param_1)
    ...
    if (pbVar9 == pbVar5) {
      ...
      do {
        ...
        *param_1 = (long)pbVar9;
        ...
        if ((pbVar5 == pbVar9) || (9 < *pbVar9 - 0x30)) goto LAB_0012367c;
        lVar6 = uVar11 * 10;
      } while (pbVar5 != pbVar9);
      pbVar9 = pbVar8 + 1;
      uVar11 = lVar6 - 0x30;
...
LAB_00123768:
        ...
        if (0xfef < lVar6 + 0x20U) {
          ...
          if (puVar2 == (void *)0x0) goto LAB_001237c4;
          lVar6 = 0;
          *puVar2 = pvVar10;
          puVar2[1] = 0;
      ...
      if (uVar1 != 0) {
        ...
        pbVar5 = pbVar9;
        do {
          if (*pcVar4 != *pbVar5) goto LAB_00123768;
          pcVar4 = pcVar4 + 1;
          uVar1 = uVar1 - 1;
          pbVar5 = pbVar5 + 1;
        } while (uVar1 != 0);
