...
undefined8 * FUN_00123310(long *param_1)

{
  ...
  if (((byte *)param_1[1] == (byte *)*param_1) || (9 < *(byte *)*param_1 - 0x30)) {
    uVar4 = __strlen_chk(&DAT_0012f06c,3);
    pcVar2 = (char *)*param_1;
    if (uVar4 <= (ulong)(param_1[1] - (long)pcVar2)) {
      if (uVar4 != 0) {
        ...
        pcVar11 = pcVar2;
        do {
          if (*pcVar9 != *pcVar11) goto LAB_00123464;
          pcVar9 = pcVar9 + 1;
          uVar10 = uVar10 - 1;
          pcVar11 = pcVar11 + 1;
        } while (uVar10 != 0);
      ...
      *param_1 = (long)pbVar1;
      if (((byte *)param_1[1] == pbVar1) || (9 < *pbVar1 - 0x30)) {
        puVar3 = (undefined8 *)FUN_00123288(param_1);
        if (puVar3 == (undefined8 *)0x0) {
          return (undefined8 *)0x0;
        }
      }
      else {
        puVar6 = (undefined8 *)FUN_001235e8(param_1);
        if (puVar6 == (undefined8 *)0x0) {
          return (undefined8 *)0x0;
        }
        puVar3 = puVar6;
        if (((char *)param_1[1] != (char *)*param_1) && (*(char *)*param_1 == 'I')) {
          lVar5 = FUN_0011c1c4(param_1,0);
          if (lVar5 == 0) {
            return (undefined8 *)0x0;
          }
          ...
          if (0xfef < lVar7 + 0x20U) {
            ...
            if (puVar8 == (void *)0x0) goto LAB_001235e4;
            lVar7 = 0;
            *puVar8 = pvVar12;
            puVar8[1] = 0;
...
LAB_00123464:
    ...
    if (uVar4 <= (ulong)(param_1[1] - (long)pcVar2)) {
      if (uVar4 != 0) {
        ...
        pcVar11 = pcVar2;
        do {
          if (*pcVar9 != *pcVar11) goto LAB_001234c0;
          pcVar9 = pcVar9 + 1;
          uVar10 = uVar10 - 1;
          pcVar11 = pcVar11 + 1;
        } while (uVar10 != 0);
...
LAB_001234c0:
    puVar3 = (undefined8 *)FUN_001238a0(param_1,0);
  }
  else {
    puVar3 = (undefined8 *)FUN_001235e8(param_1);
  }
  if (puVar3 == (undefined8 *)0x0) {
    return (undefined8 *)0x0;
  }
