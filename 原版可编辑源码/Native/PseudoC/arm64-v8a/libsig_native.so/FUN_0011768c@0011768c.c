...
long * FUN_0011768c(undefined8 *param_1,uint param_2)
...
switchD_001176c4_caseD_5:
  ...
  uVar3 = uVar1 >> 4 & 7;
  if (uVar3 != 0) {
    if (uVar3 != 1) goto switchD_001176c4_caseD_5;
    if (plVar4 == (long *)0x0) goto LAB_0011772c;
