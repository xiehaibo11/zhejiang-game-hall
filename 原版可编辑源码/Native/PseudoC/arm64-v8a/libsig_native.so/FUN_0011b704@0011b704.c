...
undefined8 * FUN_0011b704(long *param_1)

{
  ...
  if (pcVar1 == pcVar5) {
LAB_0011b77c:
    puVar4 = (undefined8 *)FUN_00119448(param_1);
    return puVar4;
  }
  cVar2 = *pcVar5;
  if (cVar2 == 'J') {
    ...
    *param_1 = (long)pcVar5;
    lVar6 = param_1[2];
    lVar7 = param_1[3];
    if (pcVar5 == pcVar1) goto LAB_0011b7f0;
    while (*pcVar5 != 'E') {
LAB_0011b7f0:
      do {
        local_38 = FUN_0011b704(param_1);
        if (local_38 == 0) {
          return (undefined8 *)0x0;
        }
        FUN_0011b8dc(param_1 + 2,&local_38);
        pcVar5 = (char *)*param_1;
      } while (pcVar5 == (char *)param_1[1]);
    }
    lVar6 = (lVar7 - lVar6 >> 3) * 8;
    *param_1 = (long)(pcVar5 + 1);
    auVar9 = FUN_00122f38(param_1,param_1[2] + lVar6,param_1[3]);
    ...
    *(undefined1 (*) [16])((long)puVar4 + lVar6 + 0x20) = auVar9;
    ...
    if (cVar2 == 'L') {
      if (((ulong)((long)pcVar1 - (long)pcVar5) < 2) || (pcVar5[1] != 'Z')) {
        puVar4 = (undefined8 *)FUN_0011f4a4(param_1);
        return puVar4;
      }
      *param_1 = (long)(pcVar5 + 2);
      puVar3 = (undefined8 *)FUN_00118900(param_1);
    }
    else {
      if (cVar2 != 'X') goto LAB_0011b77c;
      *param_1 = (long)(pcVar5 + 1);
      puVar3 = (undefined8 *)FUN_0011d7cc(param_1);
    }
