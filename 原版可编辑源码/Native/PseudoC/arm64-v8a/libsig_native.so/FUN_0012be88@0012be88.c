...
void FUN_0012be88(void *param_1,long *param_2)

{
  ...
  if ((((local_80 >> 0x3e & 1) == 0) || (local_49 == '\0')) && (local_2c8 == 0)) {
    FUN_0012acd4(alStack_3c0,*(undefined8 *)((long)param_1 + 0x310),auStack_3d0);
  }
  ...
  *(undefined8 *)((long)param_1 + 0xf8) = 0;
  if ((int)lVar2 == 1) {
    lVar2 = FUN_0012ad10(alStack_3c0,(int)param_2[0xc6]);
...
LAB_0012bfd0:
    ...
    lVar2 = FUN_0012aa68(param_2[199],&local_3c8);
    lVar2 = FUN_0012b8d4(lVar2,lVar2 + local_3c8,alStack_3c0,0);
  }
  ...
  do {
    ...
    case 2:
      if (acStack_68[(int)*plVar6] != '\0') {
        lVar3 = FUN_0012ad10(alStack_3c0);
        goto LAB_0012bfc0;
      }
      lVar3 = alStack_3c0[(int)*plVar6];
      break;
    case 3:
      lVar3 = FUN_0012aa68(*plVar6,&local_3c8);
      lVar3 = FUN_0012b8d4(lVar3,lVar3 + local_3c8,alStack_3c0,lVar2);
      break;
    case 4:
      lVar3 = lVar2 + *plVar6;
      goto LAB_0012bfc0;
    case 5:
      ...
      lVar3 = FUN_0012b8d4(lVar3,lVar3 + local_3c8,alStack_3c0,lVar2);
LAB_0012bfc0:
      if ((byte)(&DAT_0013a300)[lVar4] < 9) {
        *puVar5 = 1;
        goto LAB_0012c040;
      }
      goto LAB_0012bfd0;
    default:
      goto switchD_0012bf98_default;
    }
    if ((*(ulong *)((long)param_1 + 0x340) >> 0x3e & 1) != 0) {
      *puVar5 = 0;
    }
