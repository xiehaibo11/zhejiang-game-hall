...

{
  ...
  if ((puVar2 == (undefined8 *)0x0) || (plVar7 = (long *)*puVar2, plVar7 == (long *)0x0)) {
    ...
    FUN_00117f48("terminating");
  }
  uVar3 = __cxxabiv1::__isOurExceptionClass((_Unwind_Exception *)(plVar7 + 0xc));
  if ((uVar3 & 1) == 0) {
                    /* WARNING: Subroutine does not return */
    FUN_00117f48("terminating with %s foreign exception",PTR_s_uncaught_0013a0b0);
  }
  ...
  uVar3 = FUN_001291cc(&std::exception::typeinfo,lVar4,&local_28);
  puVar1 = PTR_s_uncaught_0013a0b0;
  if ((uVar3 & 1) == 0) {
                    /* WARNING: Subroutine does not return */
    FUN_00117f48("terminating with %s exception of type %s",PTR_s_uncaught_0013a0b0,uVar5);
  }
  uVar6 = (**(code **)(*local_28 + 0x10))();
                    /* WARNING: Subroutine does not return */
  FUN_00117f48("terminating with %s exception of type %s: %s",puVar1,uVar5,uVar6);
}
