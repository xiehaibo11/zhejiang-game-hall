...
undefined8 FUN_0012b4b0(long param_1,long *param_2)

{
  ...
  *(undefined8 *)(param_1 + 800) = 0;
  ...
  puVar3 = (uint *)FUN_0012e050(*(long *)(param_1 + 0x318) +
...
LAB_0012b8ac:
    ...
    if ((byte)puVar16[2] < 4) {
LAB_0012b688:
      uVar11 = FUN_0012aa68(plVar7,&local_18);
      param_2[0xcc] = local_18;
      pbVar8 = (byte *)FUN_0012aa90(uVar11,&local_10);
      ...
      if ((char)puVar16[2] == '\x01') {
        ...
        pbVar9 = (byte *)FUN_0012aa68(pbVar8,&local_18);
        uVar12 = local_18;
      }
      param_2[0xcd] = uVar12;
      *(undefined1 *)((long)param_2 + 0x671) = 0xff;
      ...
      if (*pcVar18 == 'z') {
        pcVar18 = pcVar18 + 1;
        pbVar9 = (byte *)FUN_0012aa68(pbVar9,&local_18);
...
LAB_0012b744:
          ...
          if (cVar2 == 'P') {
            bVar1 = *pbVar9;
            uVar11 = FUN_0012af40(bVar1,param_1);
            pbVar9 = (byte *)FUN_0012aad0(bVar1,uVar11,pbVar9 + 1,&local_8);
            param_2[0xca] = local_8;
          }
          else {
            if (cVar2 != 'S') goto LAB_0012b7b4;
            *(undefined1 *)((long)param_2 + 0x673) = 1;
          }
        }
      }
...
LAB_0012b7b4:
      if (pbVar8 != (byte *)0x0) {
        FUN_0012afb8(pbVar8,(long)puVar16 + (ulong)*puVar16 + 4,param_1,param_2);
        ...
        if (*(char *)((long)param_2 + 0x672) != '\0') {
          lVar10 = FUN_0012aa68(lVar10,&local_8);
          lVar4 = lVar10 + local_8;
        }
        cVar2 = *(char *)((long)param_2 + 0x671);
        if (cVar2 != -1) {
          uVar11 = FUN_0012af40(cVar2,param_1);
          lVar10 = FUN_0012aad0(cVar2,uVar11,lVar10,&local_8);
          *(long *)(param_1 + 800) = local_8;
        }
        if (lVar4 == 0) {
          lVar4 = lVar10;
        }
        FUN_0012afb8(lVar4,(long)puVar3 + (ulong)*puVar3 + 4,param_1,param_2);
        goto LAB_0012b8ac;
      }
    }
