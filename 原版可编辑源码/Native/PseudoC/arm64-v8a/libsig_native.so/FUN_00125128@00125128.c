...
void FUN_00125128(long param_1,undefined8 *param_2)

{
  ...
  if (uVar4 < (ulong)param_2[2]) {
    ...
    *param_2 = pvVar1;
    if (pvVar1 == (void *)0x0) goto LAB_001252f8;
    lVar2 = param_2[1];
    uVar4 = lVar2 + 1;
  }
  param_2[1] = uVar4;
  *(undefined1 *)((long)pvVar1 + lVar2) = 0x5b;
  ...
  lVar2 = __strlen_chk(&DAT_0012f26d,6);
  FUN_0011bcc0(param_2,&DAT_0012f26d,&DAT_0012f26d + lVar2);
  ...
  *(undefined1 *)((long)pvVar1 + lVar2) = 0x5d;
  ...
  if (*(char *)((long)plVar5 + 9) == '\x01') {
    return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x001252f4. Too many branches */
