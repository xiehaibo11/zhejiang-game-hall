...
/* WARNING: Removing unreachable block (ram,0x001256c8) */
/* WARNING: Removing unreachable block (ram,0x001257f0) */

void FUN_00125584(long param_1,undefined8 *param_2)

{
  ...
  if (*(char *)(param_1 + 0x38) != '\0') {
    ...
    FUN_0011bcc0(param_2,"::operator ","::operator " + lVar2);
  }
  lVar2 = __strlen_chk("new",4);
  FUN_0011bcc0(param_2,"new","operator new" + lVar2 + 9);
  if (*(char *)(param_1 + 0x39) != '\0') {
    lVar2 = __strlen_chk("[]",3);
    FUN_0011bcc0(param_2,"[]","operator delete[]" + lVar2 + 0xf);
  }
  lVar2 = param_2[1];
  __size = lVar2 + 1;
