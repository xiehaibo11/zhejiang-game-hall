...
void FUN_00121da8(long param_1,undefined8 param_2)

{
  ...
  if (0x10 < (*(long *)(param_1 + 0x18) - (long)pbVar3) + 1U) {
    ...
    uStack_48 = 0;
    uStack_50 = 0;
    iVar7 = FUN_00121d04(CONCAT17(cStack_61,
                                  CONCAT16(cStack_62,
                                           CONCAT15(cStack_63,
                                                    CONCAT14(cStack_64,
                                                             CONCAT13(cStack_65,
                                                                      CONCAT12(cStack_66,
                                                                               CONCAT11(cStack_67,
                                                                                        local_68))))
                                                   ))),&local_60,0x20,0x20,&DAT_0012efca);
    FUN_0011bcc0(param_2,&local_60,(long)&local_60 + (long)iVar7);
  }
