...
undefined8 * FUN_0011c690(long *param_1)
  ...
  *param_1 = (long)(pbVar6 + 1);
  if (*(char *)((long)param_1 + 0x2d2) != '\0') {
    ...
    if (0xfef < lVar5 + 0x20U) {
      ...
      if (puVar3 == (void *)0x0) goto LAB_0011c91c;
      lVar5 = 0;
      *puVar3 = pvVar8;
      puVar3[1] = 0;
    ...
    *(long *)((long)puVar3 + 8) = lVar5 + 0x20;
    lVar4 = __strlen_chk(&DAT_0012eeda,5);
    puVar9 = (undefined8 *)((long)puVar3 + lVar5 + 0x10);
    *puVar9 = &PTR_FUN_00136fb8;
    *(undefined4 *)((long)puVar3 + lVar5 + 0x18) = 0x1010107;
    *(undefined **)((long)puVar3 + lVar5 + 0x20) = &DAT_0012eeda;
    *(undefined **)((long)puVar3 + lVar5 + 0x28) = &DAT_0012eeda + lVar4;
    return puVar9;
  }
  ...
  *(undefined1 *)((long)puVar3 + lVar5 + 0x30) = 0;
  ...
  if (puVar3 == (undefined8 *)param_1[0x55]) {
    ...
    if (param_1 + 0x56 == __src) {
      pvVar8 = malloc(__n * 2);
      if (pvVar8 == (void *)0x0) goto LAB_0011c91c;
      if (__n != 0) {
