...
uint * FUN_0012cf48(long param_1,uint *param_2,long param_3)
  ...
  do {
    ...
    if (param_2[1] != 0) {
      ...
      if ((uint)uVar7 == 0) {
        ...
        uVar4 = FUN_0012cccc(uVar7 & 0xff,uVar1,param_2 + 2,&local_10);
        FUN_0012cccc((uint)uVar7 & 0xf,0,uVar4,&local_8);
        uVar3 = FUN_0012cbac(uVar7 & 0xff);
