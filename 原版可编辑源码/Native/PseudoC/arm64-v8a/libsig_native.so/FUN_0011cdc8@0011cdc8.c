...
undefined8 FUN_0011cdc8(long *param_1,undefined8 param_2)
...
LAB_0011cdf8:
    uVar3 = __strlen_chk(&DAT_0012f3e0,3);
    pcVar1 = (char *)*param_1;
    if (uVar3 <= (ulong)(param_1[1] - (long)pcVar1)) {
      if (uVar3 != 0) {
        ...
        pcVar14 = pcVar1;
        do {
          if (*pcVar11 != *pcVar14) goto LAB_0011cff4;
          pcVar11 = pcVar11 + 1;
          uVar12 = uVar12 - 1;
          pcVar14 = pcVar14 + 1;
        } while (uVar12 != 0);
      ...
      *param_1 = (long)(pcVar1 + 1);
      auVar20 = FUN_00122f38(param_1,param_1[2] + lVar15,param_1[3]);
      ...
      if (0xfef < lVar15 + 0x20U) {
        ...
        if (puVar4 == (void *)0x0) goto LAB_0011d48c;
        lVar15 = 0;
        *puVar4 = pvVar17;
        puVar4[1] = 0;
        param_1[0x25c] = (long)puVar4;
      }
      ppuVar8 = &PTR_FUN_001381a8;
...
LAB_0011cff4:
    puVar4 = (undefined8 *)FUN_001238a0(param_1,param_2);
  }
  else {
    uVar7 = (uint)*(byte *)*param_1;
    if (uVar7 == 0x55) {
      uVar3 = __strlen_chk(&DAT_0012f3e3,3);
      pcVar1 = (char *)*param_1;
      pbVar9 = (byte *)param_1[1];
      if ((ulong)((long)pbVar9 - (long)pcVar1) < uVar3) {
LAB_0011d024:
        uVar3 = __strlen_chk(&DAT_0012f3e6,3);
        pcVar1 = (char *)*param_1;
        if (uVar3 <= (ulong)(param_1[1] - (long)pcVar1)) {
          if (uVar3 != 0) {
            pcVar11 = "Ul";
            ...
            pcVar14 = pcVar1;
            do {
              if (*pcVar11 != *pcVar14) goto LAB_0011d0fc;
              pcVar11 = pcVar11 + 1;
              uVar12 = uVar12 - 1;
              pcVar14 = pcVar14 + 1;
            } while (uVar12 != 0);
          ...
          *(undefined1 *)((long)param_1 + 0x2d2) = 1;
          uVar3 = __strlen_chk(&DAT_0012f3e9,3);
          pcVar1 = (char *)*param_1;
          pbVar9 = (byte *)param_1[1];
          if ((ulong)((long)pbVar9 - (long)pcVar1) < uVar3) {
LAB_0011d2b0:
            ...
            do {
              ...
              if (local_58 == 0) goto LAB_0011d43c;
              FUN_0011b8dc(param_1 + 2,&local_58);
              pcVar1 = (char *)*param_1;
            ...
            *param_1 = (long)(pcVar1 + 1);
            ...
            param_1[3] = param_1[2] + lVar15;
            pbVar13 = pbVar18;
            if (pbVar9 == pbVar18) goto LAB_0011d384;
LAB_0011d334:
            pbVar13 = pbVar18;
            if (9 < *pbVar18 - 0x30) goto LAB_0011d384;
            do {
              pbVar13 = pbVar13 + 1;
            ...
            if (pbVar13 == pbVar9) goto LAB_0011d43c;
          }
          else {
            if (uVar3 != 0) {
              pcVar11 = "vE";
              ...
              pcVar14 = pcVar1;
              do {
                if (*pcVar11 != *pcVar14) goto LAB_0011d2b0;
                pcVar11 = pcVar11 + 1;
                uVar12 = uVar12 - 1;
                pcVar14 = pcVar14 + 1;
              } while (uVar12 != 0);
            ...
            *param_1 = (long)pbVar18;
            pbVar13 = pbVar18;
            if (pbVar9 != pbVar18) goto LAB_0011d334;
LAB_0011d384:
            pbVar18 = (byte *)0x0;
            pbVar19 = (byte *)0x0;
            if (pbVar13 == pbVar9) goto LAB_0011d43c;
...
LAB_0011d48c:
          ...
          *(undefined1 *)((long)param_1 + 0x2d2) = uVar10;
          goto joined_r0x0011d408;
        }
LAB_0011d0fc:
        uVar3 = __strlen_chk(&DAT_0012f3ec,3);
        pcVar1 = (char *)*param_1;
        pbVar9 = (byte *)param_1[1];
        if ((ulong)((long)pbVar9 - (long)pcVar1) < uVar3) {
          return 0;
        ...
        *(long *)((long)puVar4 + 8) = lVar15 + 0x20;
        ...
        if (uVar3 != 0) {
          ...
          pcVar14 = pcVar1;
          do {
            if (*pcVar11 != *pcVar14) goto LAB_0011d024;
            pcVar11 = pcVar11 + 1;
            uVar12 = uVar12 - 1;
            pcVar14 = pcVar14 + 1;
          } while (uVar12 != 0);
...
LAB_0011d290:
    ...
    if (8 < uVar7 - 0x31) goto LAB_0011cdf8;
    puVar4 = (undefined8 *)FUN_001235e8(param_1);
  }
joined_r0x0011d408:
...
LAB_0011d448:
  uVar6 = FUN_0011cc40(param_1,puVar4);
  return uVar6;
}
