...
/* WARNING: Removing unreachable block (ram,0x00126bbc) */

void FUN_00126b54(long param_1,undefined8 *param_2)

{
  ...
  lVar2 = __strlen_chk(" [enable_if:",0xd);
  FUN_0011bcc0(param_2," [enable_if:"," [enable_if:" + lVar2);
  ...
  param_2[1] = __size;
  *(undefined1 *)((long)pvVar4 + lVar7) = 0x5d;
  return;
}
