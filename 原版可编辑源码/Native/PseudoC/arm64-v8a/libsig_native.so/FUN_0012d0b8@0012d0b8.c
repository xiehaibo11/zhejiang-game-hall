...
undefined8 FUN_0012d0b8(ulong *param_1,ulong param_2,ulong *param_3)

{
  ...
  if ((param_2 < 0x30) || ((int)param_3[5] == 0)) {
    ...
    if ((param_1[4] == DAT_0013a0b8) && (param_1[5] == DAT_0013a368)) {
      puVar19 = DAT_0013a370;
      puVar13 = (ulong *)0x0;
      puVar15 = (ulong *)0x0;
      while (puVar10 = puVar19, puVar10 != (ulong *)0x0) {
        if ((*puVar10 <= *param_3) && (*param_3 < puVar10[1])) {
          ...
          if (puVar10 != DAT_0013a370) {
            puVar15[5] = puVar10[5];
            puVar10[5] = (ulong)DAT_0013a370;
            DAT_0013a370 = puVar10;
          }
          goto LAB_0012d2c8;
        }
        puVar13 = puVar10;
    ...
    puVar11 = &DAT_0013a3a8;
    DAT_0013a0b8 = param_1[4];
    DAT_0013a368 = param_1[5];
    do {
      puVar11[-6] = 0;
      puVar11[-5] = 0;
      puVar11[-1] = puVar11;
      puVar11 = puVar11 + 6;
    } while (puVar11 != (undefined8 *)0x13a528);
    DAT_0013a4f0 = 0;
    DAT_0013a370 = &DAT_0013a378;
...
LAB_0012d1e8:
  ...
  if (param_2 >= 0x30) {
    if ((puVar15 != (ulong *)0x0) && (puVar13 != (ulong *)0x0)) {
      puVar15[5] = puVar13[5];
      puVar13[5] = (ulong)DAT_0013a370;
      DAT_0013a370 = puVar13;
    }
    puVar13 = DAT_0013a370;
    DAT_0013a370[2] = uVar17;
...
LAB_0012d2c8:
  ...
  uVar7 = FUN_0012cc6c(uVar6,param_3);
  uVar7 = FUN_0012cccc(uVar6,uVar7,lVar1 + 4,&local_40);
  cVar2 = *(char *)(lVar1 + 2);
  if ((cVar2 != -1) && (*(char *)(lVar1 + 3) == ';')) {
    uVar8 = FUN_0012cc6c(cVar2,param_3);
    piVar16 = (int *)FUN_0012cccc(cVar2,uVar8,uVar7,&local_38);
    if (local_38 == 0) {
      return 1;
    }
    if (((ulong)piVar16 & 3) == 0) {
      ...
      bVar5 = FUN_0012d0a8(uVar17);
      uVar14 = FUN_0012cbac(bVar5);
      FUN_0012cccc(bVar5 & 0xf,0,uVar17 + (uVar14 & 0xffffffff) + 8,&local_30);
  ...
  local_30 = 0;
  local_18 = local_40;
  uVar17 = FUN_0012cf48(&local_30,local_40,*param_3);
  param_3[4] = uVar17;
  if (uVar17 != 0) {
    uVar6 = FUN_0012d0a8();
    uVar7 = FUN_0012cc6c(uVar6,param_3);
    FUN_0012cccc(uVar6,uVar7,param_3[4] + 8,&local_38);
    param_3[3] = local_38;
  }
  return 1;
}
