...
undefined8 * FUN_0011f4a4(long *param_1)

{
  ...
  *param_1 = (long)pcVar19;
  if (pcVar20 == pcVar19) {
switchD_0011f50c_caseD_55:
    puVar8 = (undefined8 *)FUN_00119448(param_1);
    ...
    if ((pbVar4 == pbVar3) || (9 < *pbVar3 - 0x30)) {
      pbVar21 = (byte *)0x0;
      pbVar22 = (byte *)0x0;
      if (pbVar3 != pbVar4) goto LAB_0011f618;
LAB_0011f658:
      bVar5 = false;
      bVar6 = false;
      if (pbVar21 == pbVar22) {
LAB_0011f638:
      ...
      pbVar21 = pbVar3;
      if (pbVar18 == pbVar4) goto LAB_0011f658;
LAB_0011f618:
      if (*pbVar18 != 0x45) goto LAB_0011f658;
      *param_1 = (long)(pbVar18 + 1);
      bVar5 = true;
      bVar6 = bVar5;
      if (pbVar21 == pbVar22) goto LAB_0011f638;
    }
    if (!bVar6) {
      return (undefined8 *)0x0;
    }
...
LAB_0011fc94:
  ...
  case 'T':
    return (undefined8 *)0x0;
  default:
    goto switchD_0011f50c_caseD_55;
  case '_':
    uVar11 = __strlen_chk(&DAT_0012eda1,3);
    pcVar2 = (char *)*param_1;
    ...
    *param_1 = (long)(pcVar2 + uVar11);
    puVar8 = (undefined8 *)FUN_00118900(param_1);
    if (puVar8 == (undefined8 *)0x0) {
      return (undefined8 *)0x0;
    }
    pcVar2 = (char *)*param_1;
  ...
  case 'a':
    *param_1 = (long)(pcVar2 + 2);
    ...
    break;
  case 'b':
    uVar11 = __strlen_chk(&DAT_0012ef7d,4);
    pcVar2 = (char *)*param_1;
    if ((ulong)(param_1[1] - (long)pcVar2) < uVar11) {
LAB_0011fbc0:
      uVar11 = __strlen_chk(&DAT_0012ef81,4);
      pcVar2 = (char *)*param_1;
      if ((ulong)(param_1[1] - (long)pcVar2) < uVar11) {
        return (undefined8 *)0x0;
      }
      ...
      *param_1 = (long)(pcVar2 + uVar11);
      ...
      if (0xfef < lVar13 + 0x10U) {
        ...
        if (puVar8 == (void *)0x0) goto LAB_0011fc94;
        lVar13 = 0;
        *puVar8 = pvVar23;
        puVar8[1] = 0;
    ...
    if (uVar11 != 0) {
      ...
      pcVar19 = pcVar2;
      do {
        if (*pcVar20 != *pcVar19) goto LAB_0011fbc0;
        pcVar20 = pcVar20 + 1;
        uVar17 = uVar17 - 1;
        pcVar19 = pcVar19 + 1;
      } while (uVar17 != 0);
  ...
  case 'e':
    ...
    *param_1 = (long)(pcVar2 + 0x23);
    ...
    if (0xfef < lVar13 + 0x20U) {
      puVar8 = malloc(0x1000);
      if (puVar8 == (undefined8 *)0x0) goto LAB_0011fc94;
      lVar13 = 0;
      *puVar8 = puVar9;
      puVar8[1] = 0;
      param_1[0x25c] = (long)puVar8;
...
LAB_0011f8a4:
  ...
  puVar8 = (undefined8 *)FUN_001218c0(param_1,pcVar20,pcVar20 + lVar13);
  return puVar8;
}
