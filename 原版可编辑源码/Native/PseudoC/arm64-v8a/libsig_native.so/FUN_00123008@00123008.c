...
/* WARNING: Removing unreachable block (ram,0x001230cc) */

void FUN_00123008(long param_1,long param_2)

{
  ...
  lVar2 = __strlen_chk(&DAT_0012f03d,3);
  FUN_0011bcc0(param_2,&DAT_0012f03d,&DAT_0012f03d + lVar2);
