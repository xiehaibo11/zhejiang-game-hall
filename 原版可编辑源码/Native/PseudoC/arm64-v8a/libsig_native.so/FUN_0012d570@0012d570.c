...
long FUN_0012d570(ulong *param_1,uint *param_2)

{
  ...
  do {
    ...
    if (param_2[1] != 0) {
      ...
      if (lVar6 != lVar4) {
        uVar2 = FUN_0012ce4c(lVar6);
        if (uVar2 == 0xff) {
          return -1;
        }
        uVar8 = FUN_0012cc0c((char)uVar2,param_1);
      ...
      FUN_0012cccc(uVar2 & 0xff,uVar8,param_2 + 2,&local_8);
      uVar3 = FUN_0012cbac(uVar2 & 0xff);
