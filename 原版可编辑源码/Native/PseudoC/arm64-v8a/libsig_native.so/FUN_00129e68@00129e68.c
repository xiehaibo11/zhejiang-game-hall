...
void FUN_00129e68(long param_1,long *param_2,long *param_3,int param_4,uint param_5)
            ...
            *(undefined2 *)((long)param_2 + 0x4c) = 0;
            ...
            if (*(char *)((long)param_2 + 0x4d) != '\0') {
              if (*(char *)((long)param_2 + 0x4c) == '\0') {
                if ((*(byte *)(param_1 + 0x10) & 1) == 0) goto LAB_0012a1c4;
                bVar3 = true;
              }
              else {
                if ((int)param_2[6] == 1) {
                ...
                bVar4 = bVar3;
                bVar5 = true;
                if ((*(byte *)(param_1 + 0x10) >> 1 & 1) == 0) goto LAB_0012a1c4;
              }
            }
            bVar4 = bVar5;
            puVar11 = puVar11 + 2;
