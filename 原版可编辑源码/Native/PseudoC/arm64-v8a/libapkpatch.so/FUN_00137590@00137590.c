...
void FUN_00137590(pthread_cond_t *param_1)

{
  ...
  if (param_1 != (pthread_cond_t *)0x0) {
    iVar2 = pthread_cond_destroy(param_1);
    ...
    if (iVar2 != 0) {
      ...
      puVar3 = (undefined8 *)
               ...
               insert(abStack_88,0,"pthread_cond_destroy() return ");
      local_60 = puVar3[2];
      uStack_68 = puVar3[1];
      local_70 = *puVar3;
      puVar3[1] = 0;
