...
void FUN_0015e060(long param_1,undefined8 *param_2)
  ...
  if (((char)plVar2[1] == '\n') && (lVar7 = plVar2[2], *(char *)(lVar7 + 8) == '\a')) {
    ...
    if ((long)pcVar1 - (long)pcVar5 == 0xb) {
      if (pcVar5 != pcVar1) {
        pcVar8 = "objc_object";
        do {
          if (*pcVar5 != *pcVar8) goto LAB_0015e0e8;
          pcVar5 = pcVar5 + 1;
          pcVar8 = pcVar8 + 1;
        } while (pcVar5 != pcVar1);
      }
...
LAB_0015e0e8:
  if (*(char *)((long)plVar2 + 10) != '\0') {
    if (*(char *)((long)plVar2 + 10) == '\x02') {
      ...
      if ((uVar3 & 1) != 0) goto LAB_0015e134;
      plVar2 = *(long **)(param_1 + 0x10);
    }
...
LAB_0015e184:
                    /* WARNING: Could not recover jumptable at 0x0015e1a0. Too many branches */
