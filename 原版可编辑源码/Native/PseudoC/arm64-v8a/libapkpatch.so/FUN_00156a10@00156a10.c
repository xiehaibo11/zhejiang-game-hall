...
void FUN_00156a10(long param_1,undefined8 *param_2)

{
  ...
  if (__n != 0) {
    ...
    if (uVar1 < (ulong)param_2[2]) {
      ...
      *param_2 = pvVar2;
      if (pvVar2 == (void *)0x0) goto LAB_00156b80;
      lVar4 = param_2[1];
    }
  ...
  if (uVar1 < (ulong)param_2[2]) {
    ...
    *param_2 = pvVar3;
    if (pvVar3 == (void *)0x0) goto LAB_00156b80;
    lVar4 = param_2[1];
  }
  *(undefined1 *)((long)pvVar3 + lVar4) = 0x28;
  ...
  (**(code **)(lVar4 + 0x20))(plVar6,param_2);
