...
void FUN_00153b10(long param_1,undefined8 *param_2,undefined8 *param_3)

{
  ...
  *(long *)((long)puVar1 + 8) = lVar2 + 0x30;
  ...
  uVar6 = param_3[1];
  uVar5 = *param_3;
  *(undefined ***)((long)puVar1 + lVar2 + 0x10) = &PTR_FUN_00167960;
  *(undefined4 *)((long)puVar1 + lVar2 + 0x18) = 0x1010144;
