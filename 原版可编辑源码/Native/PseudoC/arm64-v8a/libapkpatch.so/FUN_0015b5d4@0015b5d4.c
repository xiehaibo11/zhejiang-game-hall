...
void FUN_0015b5d4(long param_1,undefined8 *param_2)

{
  ...
  if (uVar1 < (ulong)param_2[2]) {
    ...
    *param_2 = pvVar2;
    if (pvVar2 == (void *)0x0) goto LAB_0015b73c;
    lVar5 = param_2[1];
  }
  *(undefined2 *)((long)pvVar2 + lVar5) = 0x2820;
  lVar5 = param_2[1] + 2;
  param_2[1] = lVar5;
  ...
  if (__n != 0) {
    ...
    if (uVar1 < (ulong)param_2[2]) {
      ...
      *param_2 = pvVar3;
      if (pvVar3 == (void *)0x0) goto LAB_0015b73c;
      lVar5 = param_2[1];
    }
...
LAB_0015b73c:
  ...
  *(undefined1 *)((long)pvVar2 + lVar5) = 0x29;
