...
void FUN_001588a8(long param_1,undefined8 *param_2)

{
  ...
  builtin_strncpy((char *)((long)pvVar1 + lVar3),"operator ",9);
  ...
  if (*(char *)((long)plVar4 + 9) == '\x01') {
    return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00158974. Too many branches */
