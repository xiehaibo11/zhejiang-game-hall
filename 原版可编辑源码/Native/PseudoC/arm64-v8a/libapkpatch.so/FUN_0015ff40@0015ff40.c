...
bool FUN_0015ff40(long param_1,long param_2,undefined8 *param_3)
  ...
  if (*(char **)(param_2 + 8) == "Dn") {
    if ((*(long *)(param_1 + 0x18) == 0) ||
       (lVar3 = __dynamic_cast(*(long *)(param_1 + 0x18),&__cxxabiv1::__shim_type_info::typeinfo,
                               &__cxxabiv1::__function_type_info::typeinfo,0), lVar3 == 0)) {
      puVar4 = &DAT_001206c8;
    }
    else {
      puVar4 = &DAT_001206b8;
...
LAB_00160074:
    ...
    if ((*(byte *)(param_1 + 0x10) & 0x18) == 0) {
      ...
      if (lVar3 != 0) {
        if ((*(byte *)(lVar3 + 0x10) & 0x18) != 0) goto LAB_0015ff7c;
        if (*(long *)(param_1 + 8) == *(long *)(param_2 + 8)) goto LAB_00160074;
      }
    }
    else {
LAB_0015ff7c:
