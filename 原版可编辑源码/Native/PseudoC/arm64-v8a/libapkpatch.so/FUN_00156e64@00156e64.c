...
undefined1  [16] FUN_00156e64(long param_1,void *param_2,long param_3)

{
  ...
  puVar3 = *(undefined8 **)(param_1 + 0x1330);
...
LAB_00156f30:
      ...
      *puVar1 = *puVar3;
      puVar1[1] = 0;
      *puVar3 = puVar1;
      goto joined_r0x00156efc;
    }
    puVar1 = malloc(0x1000);
    if (puVar1 == (undefined8 *)0x0) goto LAB_00156f30;
    lVar2 = 0;
    *puVar1 = puVar3;
    puVar1[1] = 0;
