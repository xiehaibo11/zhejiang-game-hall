...
void FUN_001376fc(pthread_cond_t *param_1,undefined8 *param_2)

{
  ...
  iVar2 = pthread_cond_wait(param_1,(pthread_mutex_t *)*param_2);
  if (iVar2 != 0) {
    ...
    puVar3 = (undefined8 *)
             ...
             basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::insert
                       (abStack_88,0,"pthread_cond_wait() return ");
    local_60 = puVar3[2];
    uStack_68 = puVar3[1];
    local_70 = *puVar3;
    puVar3[1] = 0;
