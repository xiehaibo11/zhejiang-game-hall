...
void FUN_0014cd3c(long param_1,undefined8 *param_2)

{
  ...
  if (uVar1 < (ulong)param_2[2]) {
    ...
    *param_2 = pvVar2;
    if (pvVar2 == (void *)0x0) goto LAB_0014cea4;
    lVar4 = param_2[1];
  }
  ...
  *(undefined4 *)((long)pvVar2 + lVar4) = 0x2d6e692d;
  ...
  if (*(char *)((long)plVar5 + 9) == '\x01') {
    return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0014cea0. Too many branches */
