...
void FUN_00158df8(long param_1,undefined8 *param_2)

{
  ...
  if (*(char *)(param_1 + 0x20) == '\0') {
    if (uVar2 <= uVar4) {
      ...
      *param_2 = pvVar1;
      if (pvVar1 == (void *)0x0) goto LAB_00159034;
      lVar3 = param_2[1];
      uVar4 = lVar3 + 1;
    }
    else {
...
LAB_00159034:
  ...
  if (*(char *)((long)plVar5 + 9) == '\x01') {
    return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00159030. Too many branches */
