...
undefined1
jni_appendNativeLog(long *param_1,undefined8 param_2,long param_3,long param_4,long param_5)

{
  ...
  if ((((param_1 != (long *)0x0) && (param_3 != 0)) && (param_4 != 0)) && (param_5 != 0)) {
    ...
    if (lVar2 == 0) {
      log2Console(5,"CrashReport-Native","jni_appendNativeLog: level is null.");
    }
    else {
      lVar3 = (**(code **)(*param_1 + 0x548))(param_1,param_4,0);
      if (lVar3 == 0) {
        log2Console(5,"CrashReport-Native","jni_appendNativeLog: tag is null.");
      }
      else {
        ...
        log2Console(5,"CrashReport-Native","jni_appendNativeLog: log is null.");
      }
    }
  }
  return 0;
