...
undefined1  [16] FUN_001145e0(undefined8 param_1,long *param_2)

{
  ...
  if ((int)param_2[0xd8] == 0) {
    auVar7._0_8_ = *(undefined8 *)(lVar2 + 0x1b0);
    auVar7._8_8_ = local_60;
    return auVar7;
  }
  ...
  *(undefined8 *)(lVar3 + 0xb0) = *(undefined8 *)(lVar2 + 0x160);
  uVar6 = *(undefined8 *)(lVar2 + 0x1b0);
  *(undefined8 *)(lVar3 + 0xb8) = *(undefined8 *)(lVar2 + 0x168);
  uVar5 = *(undefined8 *)(lVar2 + 0x1b8);
  ...
  *(undefined8 *)(lVar3 + 0xf0) = *(undefined8 *)(lVar2 + 0x1a0);
  auVar8._0_8_ = *(undefined8 *)(lVar2 + 0x1a8);
  *(undefined8 *)(lVar3 + 0xf8) = auVar8._0_8_;
  *(undefined8 *)(lVar3 + 0x100) = uVar6;
  *(undefined8 *)(lVar3 + 0x108) = uVar5;
