...
local ServerMainRule = g_gameConstant.GAME_PLAY_RULE_SCMJ_XZ_JOKER              -- Hown 游戏类型————主玩法
local NameStr = "癞子血战"                  -- Hown 创建房间选择按钮标题
...
local XZddMjIni = {
    ...
    HelpImg = {
        {"bigImg/help_mj_xzddlz_%d.png", 1, NameStr},
    },
    
    CreationViewTable = {
        [g_gameConstant.GAME_PLAY_RULE_SCMJ_XZ_JOKER] = "newgold.MatchGames.subMjGame.xzddMjGame.lobby.GameCreationViewXZJoker",      -- Hown 对应的csb创建面板中选择解析文件
    },
    ...
    WanfaCreateTable = {
        {
            {
                -- 常规玩法所有选项
                {g_gameConstant.GAME_PLAY_RULE_SCMJ_XZ_JOKER,                       {4,3,2} },
    ...
    WanfaDescTable = {
        ...
        [g_gameConstant.GAME_PLAY_RULE_XZ_JIAFAN_NOJOKER]           =   {"无癞子加番", "当胡牌时手中没有癞子，则胡牌额外加1番"},
        [g_gameConstant.GAME_PLAY_RULE_XZ_2FEN_HU]                  =   {"2分起胡", "玩家满足胡牌条件时，判断该牌型赢取分数是否大于等于2分，若不满足则不允许胡牌。"},
        ...
        [g_gameConstant.GAME_SUB_RULE_HUAN_3_ZHANG_ANIM]            =   {"换三/四张动画", "勾选后，换三张时播放动画。"},
