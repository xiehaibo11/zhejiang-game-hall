...
local UIMahConfigBase = NG.GAME.gameRequire("Modules.GameMain.MahLayer.Config.UIMahConfigBase")

local UIMahOutAreaBase = NG.GAME.gameClass("UIMahOutAreaBase", NG.ViewBase)
...
function UIMahOutAreaBase:addOutMahs(mahValues)
