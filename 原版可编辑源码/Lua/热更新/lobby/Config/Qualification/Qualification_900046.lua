...
local tab = {
	QualificationConfig = {
		...
		{ ConfID = 1003, index = 103, Show = true, Abbreviation = "边锋绍兴麻将",ApprovalNumber ="新广出审[2018]1878号",ISBN = "ISBN 978-7-498-05208-7",Author = "杭州边趣网络技术有限公司"},
		{ ConfID = 1004, index = 104, Show = true, Abbreviation = "上虞花麻将",ApprovalNumber ="新广出审[2017]9843号",ISBN = "ISBN 978-7-498-00216-7",Author = "杭州边趣网络技术有限公司"},
	},
	AgreementConfig = {
		...
		{ConfID = 1002,Show = true,Platform = 3,DevicePlatform = "android",AgreementType = "VIP_SERVER",url = "https://weixinhlmj.37gjw.com/zhanlong/awl_tweets/htmls/bq-hyfwxy.html"},
		{ConfID = 1002,Show = true,Platform = 3,DevicePlatform = "android",AgreementType = "VIP_RESTORE",url = "https://weixinhlmj.37gjw.com/zhanlong/awl_tweets/htmls/bq-zdxfxy.html"},
	},
	CompanyNameConfig  = {
