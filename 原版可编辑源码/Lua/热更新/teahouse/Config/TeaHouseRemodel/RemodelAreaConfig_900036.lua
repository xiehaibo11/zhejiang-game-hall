...
RemodelAreaConfig.CREATESETUPCONFIG = {
    ...
    creatInfoWithLevel = {
        ...
        [2] = {
            modeType = TeaHouse.TeaHouseProtocol.ReqSetPayType.PayModePype.TYPE_PAY_MODEL_FRON,
            payTypeTable = {TeaHouse.TeaHouseProtocol.ReqSetPayType.PayType.TYPE_TEA_OWNER},
        },
        [3] = {
            modeType = TeaHouse.TeaHouseProtocol.ReqSetPayType.PayModePype.TYPE_PAY_MODEL_FRON,
            payTypeTable = {TeaHouse.TeaHouseProtocol.ReqSetPayType.PayType.TYPE_TEA_OWNER},
...
RemodelAreaConfig.CREATECONDITION = {
    ...
    },
    {
        ...
        tLevelCardNum = 500, -- 创建第n个需要的卡数量n*2000,
        tCanCreateTeaCount = 3,--未解锁前可以创建的比赛场数量
