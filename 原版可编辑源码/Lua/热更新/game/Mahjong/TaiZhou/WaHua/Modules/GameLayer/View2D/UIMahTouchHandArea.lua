...
local UIMahTouchHandArea = CF.gameClass("UIMahTouchHandArea", "game.Mahjong.TaiZhou.WaHua.Modules.GameLayer.View2D.UIMahHandArea")
...
function UIMahTouchHandArea:_updateHandMahsPosition(bShowAction, bHuMah)
    UIMahTouchHandArea.super._updateHandMahsPosition(self, bShowAction, bHuMah)
...
function UIMahTouchHandArea:_setMahDraging(mah, isDraging)
    ...
    if mah:isMahTouchLimit() or mah:isMahActionMask() then
        return
    end
    if isDraging then
