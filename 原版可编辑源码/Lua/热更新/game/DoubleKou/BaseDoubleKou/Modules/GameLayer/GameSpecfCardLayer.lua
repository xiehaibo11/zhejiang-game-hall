...
function GameSpecfCardLayer:getCSBPath()
    return "res/cocosStudio/DoubleKou/GameLayer/CSB/SpecfCardLayer.csb"
end
...
function GameSpecfCardLayer:getBindingInfo()
    return {
        ...
        ["_KW_HAND_CARD_"] = {varName = "_handCard_", type = CF.UI_TYPE.IMAGE_TOBUTTON, beginIndex = 1, endIndex = 28, onTouchEnded = "onTouchEventHandCard"},
    }
end
...
function GameSpecfCardLayer:showSpecfLayer(bShow)
    ...
    if not bTest then
        bTest = CF.roomData:getGameID() == 42038 and (CF.roomData:getSRSGroupID() == 10033 or CF.roomData:getSRSGroupID() == 10031)
    end
