...
public class MediatorLiveData<T> extends android.arch.lifecycle.MutableLiveData<T> {
    ...
    private static class Source<V> implements android.arch.lifecycle.Observer<V> {
        ...
        @Override
        public void onChanged(@android.support.annotation.Nullable V r3) {
                r2 = this;
                int r0 = r2.mVersion
    ...
    public <S> void addSource(@android.support.annotation.NonNull android.arch.lifecycle.LiveData<S> r3, @android.support.annotation.NonNull android.arch.lifecycle.Observer<S> r4) {
            r2 = this;
    ...
    @android.support.annotation.MainThread
    public <S> void removeSource(@android.support.annotation.NonNull android.arch.lifecycle.LiveData<S> r2) {
            r1 = this;
