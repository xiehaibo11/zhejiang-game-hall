...
public abstract class Lifecycle {
    ...
    public enum Event extends java.lang.Enum<android.arch.lifecycle.Lifecycle.Event> {
        ...
        static {
                ...
                r0 = 7
                android.arch.lifecycle.Lifecycle$Event[] r0 = new android.arch.lifecycle.Lifecycle.Event[r0]
                android.arch.lifecycle.Lifecycle$Event r8 = android.arch.lifecycle.Lifecycle.Event.ON_CREATE
                r0[r1] = r8
                ...
                r0[r7] = r1
                android.arch.lifecycle.Lifecycle.Event.$VALUES = r0
                return
        }
    ...
    public enum State extends java.lang.Enum<android.arch.lifecycle.Lifecycle.State> {
        ...
        static {
                ...
                r0 = 5
                android.arch.lifecycle.Lifecycle$State[] r0 = new android.arch.lifecycle.Lifecycle.State[r0]
                android.arch.lifecycle.Lifecycle$State r6 = android.arch.lifecycle.Lifecycle.State.DESTROYED
                r0[r1] = r6
                ...
                r0[r5] = r1
                android.arch.lifecycle.Lifecycle.State.$VALUES = r0
                return
        }
        ...
        public boolean isAtLeast(@android.support.annotation.NonNull android.arch.lifecycle.Lifecycle.State r1) {
                r0 = this;
    ...
    public abstract void addObserver(@android.support.annotation.NonNull android.arch.lifecycle.LifecycleObserver r1);
    ...
    @android.support.annotation.MainThread
    public abstract void removeObserver(@android.support.annotation.NonNull android.arch.lifecycle.LifecycleObserver r1);
}
