...
public class NestedScrollingChildHelper {
    ...
    public NestedScrollingChildHelper(@android.support.annotation.NonNull android.view.View r1) {
            r0 = this;
            r0.<init>()
            r0.mView = r1
            return
    ...
    public boolean dispatchNestedPreScroll(int r7, int r8, @android.support.annotation.Nullable int[] r9, @android.support.annotation.Nullable int[] r10) {
            r6 = this;
            r5 = 0
            r0 = r6
            r1 = r7
    ...
    public boolean dispatchNestedPreScroll(int r11, int r12, @android.support.annotation.Nullable int[] r13, @android.support.annotation.Nullable int[] r14, int r15) {
            r10 = this;
    ...
    public boolean dispatchNestedScroll(int r8, int r9, int r10, int r11, @android.support.annotation.Nullable int[] r12) {
            r7 = this;
            r6 = 0
            r0 = r7
            r1 = r8
    ...
    public void onStopNestedScroll(@android.support.annotation.NonNull android.view.View r1) {
            r0 = this;
