...
public final class ViewGroupCompat {
    ...
    public static int getLayoutMode(@android.support.annotation.NonNull android.view.ViewGroup r2) {
    ...
    public static int getNestedScrollAxes(@android.support.annotation.NonNull android.view.ViewGroup r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto Lb
    ...
    public static boolean isTransitionGroup(@android.support.annotation.NonNull android.view.ViewGroup r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto Lb
    ...
    public static void setLayoutMode(@android.support.annotation.NonNull android.view.ViewGroup r2, int r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 18
            if (r0 < r1) goto L9
            r2.setLayoutMode(r3)
    ...
    public static void setTransitionGroup(@android.support.annotation.NonNull android.view.ViewGroup r2, boolean r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto La
