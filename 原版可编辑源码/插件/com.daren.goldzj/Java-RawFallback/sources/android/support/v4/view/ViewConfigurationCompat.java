...
public final class ViewConfigurationCompat {
    ...
    public static float getScaledHorizontalScrollFactor(@android.support.annotation.NonNull android.view.ViewConfiguration r2, @android.support.annotation.NonNull android.content.Context r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 26
            if (r0 < r1) goto Lb
    ...
    public static float getScaledVerticalScrollFactor(@android.support.annotation.NonNull android.view.ViewConfiguration r2, @android.support.annotation.NonNull android.content.Context r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 26
            if (r0 < r1) goto Lb
    ...
    public static boolean shouldShowMenuShortcutsWhenKeyboardPresent(android.view.ViewConfiguration r2, @android.support.annotation.NonNull android.content.Context r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 28
            if (r0 < r1) goto Lb
