...
public final class TextViewCompat {
    ...
    private static class OreoCallback implements android.view.ActionMode.Callback {
        ...
        private void recomputeProcessTextMenuItems(android.view.Menu r9) {
                ...
                r8.mMenuBuilderClass = r2     // Catch: java.lang.Throwable -> L2d
                java.lang.Class r2 = r8.mMenuBuilderClass     // Catch: java.lang.Throwable -> L2d
                java.lang.Class[] r6 = new java.lang.Class[r5]     // Catch: java.lang.Throwable -> L2d
                java.lang.Class r7 = java.lang.Integer.TYPE     // Catch: java.lang.Throwable -> L2d
                r6[r4] = r7     // Catch: java.lang.Throwable -> L2d
                java.lang.reflect.Method r2 = r2.getDeclaredMethod(r3, r6)     // Catch: java.lang.Throwable -> L2d
                r8.mMenuBuilderRemoveItemAtMethod = r2     // Catch: java.lang.Throwable -> L2d
                r8.mCanUseMenuBuilderReferences = r5     // Catch: java.lang.Throwable -> L2d
                goto L34
            L2d:
                r2 = 0
            ...
            L34:
                boolean r2 = r8.mCanUseMenuBuilderReferences     // Catch: java.lang.Throwable -> Lab
                if (r2 == 0) goto L43
                java.lang.Class r2 = r8.mMenuBuilderClass     // Catch: java.lang.Throwable -> Lab
                boolean r2 = r2.isInstance(r9)     // Catch: java.lang.Throwable -> Lab
                if (r2 == 0) goto L43
                java.lang.reflect.Method r2 = r8.mMenuBuilderRemoveItemAtMethod     // Catch: java.lang.Throwable -> Lab
                goto L51
            L43:
                java.lang.Class r2 = r9.getClass()     // Catch: java.lang.Throwable -> Lab
                ...
                r6[r4] = r7     // Catch: java.lang.Throwable -> Lab
                java.lang.reflect.Method r2 = r2.getDeclaredMethod(r3, r6)     // Catch: java.lang.Throwable -> Lab
            L51:
                int r3 = r9.size()     // Catch: java.lang.Throwable -> Lab
                int r3 = r3 - r5
            L56:
                if (r3 < 0) goto L80
                android.view.MenuItem r6 = r9.getItem(r3)     // Catch: java.lang.Throwable -> Lab
                android.content.Intent r7 = r6.getIntent()     // Catch: java.lang.Throwable -> Lab
                if (r7 == 0) goto L7d
                ...
                java.lang.String r6 = r6.getAction()     // Catch: java.lang.Throwable -> Lab
                boolean r6 = r7.equals(r6)     // Catch: java.lang.Throwable -> Lab
                if (r6 == 0) goto L7d
                java.lang.Object[] r6 = new java.lang.Object[r5]     // Catch: java.lang.Throwable -> Lab
                java.lang.Integer r7 = java.lang.Integer.valueOf(r3)     // Catch: java.lang.Throwable -> Lab
                r6[r4] = r7     // Catch: java.lang.Throwable -> Lab
                r2.invoke(r9, r6)     // Catch: java.lang.Throwable -> Lab
            L7d:
                int r3 = r3 + (-1)
                goto L56
            L80:
    ...
    public static int getAutoSizeMaxTextSize(@android.support.annotation.NonNull android.widget.TextView r2) {
    ...
    public static int getAutoSizeMinTextSize(@android.support.annotation.NonNull android.widget.TextView r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 27
            if (r0 < r1) goto Lb
    ...
    public static int getAutoSizeStepGranularity(@android.support.annotation.NonNull android.widget.TextView r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 27
            if (r0 < r1) goto Lb
    ...
    public static int[] getAutoSizeTextAvailableSizes(@android.support.annotation.NonNull android.widget.TextView r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 27
            if (r0 < r1) goto Lb
    ...
    public static int getAutoSizeTextType(@android.support.annotation.NonNull android.widget.TextView r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 27
            if (r0 < r1) goto Lb
    ...
    @android.support.annotation.NonNull
    public static android.graphics.drawable.Drawable[] getCompoundDrawablesRelative(@android.support.annotation.NonNull android.widget.TextView r4) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 18
            if (r0 < r1) goto Lb
    ...
    public static int getFirstBaselineToTopHeight(@android.support.annotation.NonNull android.widget.TextView r1) {
    ...
    public static int getLastBaselineToBottomHeight(@android.support.annotation.NonNull android.widget.TextView r1) {
    ...
    public static int getMaxLines(@android.support.annotation.NonNull android.widget.TextView r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 16
            if (r0 < r1) goto Lb
    ...
    public static int getMinLines(@android.support.annotation.NonNull android.widget.TextView r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 16
            if (r0 < r1) goto Lb
    ...
    private static int getTextDirection(@android.support.annotation.NonNull android.text.TextDirectionHeuristic r2) {
    ...
    @android.support.annotation.RequiresApi(18)
    private static android.text.TextDirectionHeuristic getTextDirectionHeuristic(@android.support.annotation.NonNull android.widget.TextView r4) {
    ...
    @android.support.annotation.NonNull
    public static android.support.v4.text.PrecomputedTextCompat.Params getTextMetricsParams(@android.support.annotation.NonNull android.widget.TextView r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 28
            if (r0 < r1) goto L10
    ...
    public static void setAutoSizeTextTypeUniformWithConfiguration(@android.support.annotation.NonNull android.widget.TextView r2, int r3, int r4, int r5, int r6) throws java.lang.IllegalArgumentException {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 27
            if (r0 < r1) goto La
    ...
    public static void setAutoSizeTextTypeUniformWithPresetSizes(@android.support.annotation.NonNull android.widget.TextView r2, @android.support.annotation.NonNull int[] r3, int r4) throws java.lang.IllegalArgumentException {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 27
            if (r0 < r1) goto La
    ...
    public static void setAutoSizeTextTypeWithDefaults(@android.support.annotation.NonNull android.widget.TextView r2, int r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 27
            if (r0 < r1) goto La
    ...
    public static void setCompoundDrawablesRelative(@android.support.annotation.NonNull android.widget.TextView r2, @android.support.annotation.Nullable android.graphics.drawable.Drawable r3, @android.support.annotation.Nullable android.graphics.drawable.Drawable r4, @android.support.annotation.Nullable android.graphics.drawable.Drawable r5, @android.support.annotation.Nullable android.graphics.drawable.Drawable r6) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 18
            if (r0 < r1) goto La
    ...
    public static void setCompoundDrawablesRelativeWithIntrinsicBounds(@android.support.annotation.NonNull android.widget.TextView r2, @android.support.annotation.DrawableRes int r3, @android.support.annotation.DrawableRes int r4, @android.support.annotation.DrawableRes int r5, @android.support.annotation.DrawableRes int r6) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 18
            if (r0 < r1) goto La
    ...
    public static void setCustomSelectionActionModeCallback(@android.support.annotation.NonNull android.widget.TextView r0, @android.support.annotation.NonNull android.view.ActionMode.Callback r1) {
    ...
    public static void setFirstBaselineToTopHeight(@android.support.annotation.NonNull android.widget.TextView r3, @android.support.annotation.IntRange(from = 0) @android.support.annotation.Px int r4) {
    ...
    public static void setLastBaselineToBottomHeight(@android.support.annotation.NonNull android.widget.TextView r3, @android.support.annotation.IntRange(from = 0) @android.support.annotation.Px int r4) {
            android.support.v4.util.Preconditions.checkArgumentNonnegative(r4)
            android.text.TextPaint r0 = r3.getPaint()
            android.graphics.Paint$FontMetricsInt r0 = r0.getFontMetricsInt()
            int r1 = android.os.Build.VERSION.SDK_INT
    ...
    public static void setLineHeight(@android.support.annotation.NonNull android.widget.TextView r2, @android.support.annotation.IntRange(from = 0) @android.support.annotation.Px int r3) {
    ...
    public static void setPrecomputedText(@android.support.annotation.NonNull android.widget.TextView r2, @android.support.annotation.NonNull android.support.v4.text.PrecomputedTextCompat r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 28
            if (r0 < r1) goto Le
    ...
    public static void setTextAppearance(@android.support.annotation.NonNull android.widget.TextView r2, @android.support.annotation.StyleRes int r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 23
            if (r0 < r1) goto La
    ...
    public static void setTextMetricsParams(@android.support.annotation.NonNull android.widget.TextView r2, @android.support.annotation.NonNull android.support.v4.text.PrecomputedTextCompat.Params r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 18
            if (r0 < r1) goto L11
    ...
    @android.support.annotation.NonNull
    @android.support.annotation.RestrictTo({android.support.annotation.RestrictTo.Scope.LIBRARY_GROUP})
    public static android.view.ActionMode.Callback wrapCustomSelectionActionModeCallback(@android.support.annotation.NonNull android.widget.TextView r2, @android.support.annotation.NonNull android.view.ActionMode.Callback r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 26
            if (r0 < r1) goto L17
            int r0 = android.os.Build.VERSION.SDK_INT
