...
public class CircularProgressDrawable extends android.graphics.drawable.Drawable implements android.graphics.drawable.Animatable {
    ...
    private static class Ring {
        ...
        void setColorIndex(int r2) {
                ...
                r1.mColorIndex = r2
                int[] r2 = r1.mColors
                int r0 = r1.mColorIndex
                r2 = r2[r0]
                r1.mCurrentColor = r2
                return
        }

        void setColors(@android.support.annotation.NonNull int[] r1) {
                r0 = this;
                r0.mColors = r1
                r1 = 0
                r0.setColorIndex(r1)
    ...
    public CircularProgressDrawable(@android.support.annotation.NonNull android.content.Context r2) {
            r1 = this;
            r1.<init>()
    ...
    void applyTransformation(float r8, android.support.v4.widget.CircularProgressDrawable.Ring r9, boolean r10) {
        ...
        L10:
            ...
            android.view.animation.Interpolator r4 = android.support.v4.widget.CircularProgressDrawable.MATERIAL_INTERPOLATOR
    ...
    public void setColorSchemeColors(@android.support.annotation.NonNull int... r2) {
            r1 = this;
            android.support.v4.widget.CircularProgressDrawable$Ring r0 = r1.mRing
            r0.setColors(r2)
            android.support.v4.widget.CircularProgressDrawable$Ring r2 = r1.mRing
    ...
    public void setStrokeCap(@android.support.annotation.NonNull android.graphics.Paint.Cap r2) {
            r1 = this;
            android.support.v4.widget.CircularProgressDrawable$Ring r0 = r1.mRing
            r0.setStrokeCap(r2)
            r1.invalidateSelf()
