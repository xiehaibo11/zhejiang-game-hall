...
public final class NotificationManagerCompat {
    ...
    @android.support.annotation.GuardedBy("sEnabledNotificationListenersLock")
    ...
    private static class SideChannelManager implements android.os.Handler.Callback, android.content.ServiceConnection {
        ...
        SideChannelManager(android.content.Context r2) {
                ...
                android.os.HandlerThread r2 = r1.mHandlerThread
                r2.start()
        ...
        private void processListenerQueue(android.support.v4.app.NotificationManagerCompat.SideChannelManager.ListenerRecord r6) {
            ...
            L47:
                ...
                goto Lae
            L52:
                boolean r3 = android.util.Log.isLoggable(r1, r0)     // Catch: android.os.RemoteException -> L77 android.os.DeadObjectException -> L79
                if (r3 == 0) goto L6c
                java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch: android.os.RemoteException -> L77 android.os.DeadObjectException -> L79
                r3.<init>()     // Catch: android.os.RemoteException -> L77 android.os.DeadObjectException -> L79
                java.lang.String r4 = "Sending task "
                r3.append(r4)     // Catch: android.os.RemoteException -> L77 android.os.DeadObjectException -> L79
                r3.append(r2)     // Catch: android.os.RemoteException -> L77 android.os.DeadObjectException -> L79
                java.lang.String r3 = r3.toString()     // Catch: android.os.RemoteException -> L77 android.os.DeadObjectException -> L79
                android.util.Log.d(r1, r3)     // Catch: android.os.RemoteException -> L77 android.os.DeadObjectException -> L79
            L6c:
                android.support.v4.app.INotificationSideChannel r3 = r6.service     // Catch: android.os.RemoteException -> L77 android.os.DeadObjectException -> L79
                r2.send(r3)     // Catch: android.os.RemoteException -> L77 android.os.DeadObjectException -> L79
                java.util.ArrayDeque<android.support.v4.app.NotificationManagerCompat$Task> r2 = r6.taskQueue     // Catch: android.os.RemoteException -> L77 android.os.DeadObjectException -> L79
                r2.remove()     // Catch: android.os.RemoteException -> L77 android.os.DeadObjectException -> L79
                goto L47
            L77:
                r0 = move-exception
                goto L7b
    ...
    public static android.support.v4.app.NotificationManagerCompat from(@android.support.annotation.NonNull android.content.Context r1) {
    ...
    public void cancel(@android.support.annotation.Nullable java.lang.String r3, int r4) {
            r2 = this;
    ...
    public void notify(int r2, @android.support.annotation.NonNull android.app.Notification r3) {
            r1 = this;
            r0 = 0
            r1.notify(r0, r2, r3)
            return
    ...
    public void notify(@android.support.annotation.Nullable java.lang.String r3, int r4, @android.support.annotation.NonNull android.app.Notification r5) {
            r2 = this;
