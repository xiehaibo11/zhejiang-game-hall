...
public class FontsContractCompat {
    ...
    public static class FontFamilyResult {
        ...
        @android.support.annotation.RestrictTo({android.support.annotation.RestrictTo.Scope.LIBRARY_GROUP})
        public FontFamilyResult(int r1, @android.support.annotation.Nullable android.support.v4.provider.FontsContractCompat.FontInfo[] r2) {
                r0 = this;
                r0.<init>()
                r0.mStatusCode = r1
                r0.mFonts = r2
    ...
    public static class FontInfo {
        ...
        @android.support.annotation.RestrictTo({android.support.annotation.RestrictTo.Scope.LIBRARY_GROUP})
        public FontInfo(@android.support.annotation.NonNull android.net.Uri r1, @android.support.annotation.IntRange(from = 0) int r2, @android.support.annotation.IntRange(from = 1, to = 1000) int r3, boolean r4, int r5) {
                r0 = this;
                r0.<init>()
        ...
        @android.support.annotation.IntRange(from = 1, to = 1000)
    ...
    private static final class TypefaceResult {
        ...
        TypefaceResult(@android.support.annotation.Nullable android.graphics.Typeface r1, int r2) {
                r0 = this;
                r0.<init>()
                r0.mTypeface = r1
                r0.mResult = r2
    ...
    public static android.graphics.Typeface buildTypeface(@android.support.annotation.NonNull android.content.Context r1, @android.support.annotation.Nullable android.os.CancellationSignal r2, @android.support.annotation.NonNull android.support.v4.provider.FontsContractCompat.FontInfo[] r3) {
            r0 = 0
    ...
    @android.support.annotation.NonNull
    public static android.support.v4.provider.FontsContractCompat.FontFamilyResult fetchFonts(@android.support.annotation.NonNull android.content.Context r2, @android.support.annotation.Nullable android.os.CancellationSignal r3, @android.support.annotation.NonNull android.support.v4.provider.FontRequest r4) throws android.content.pm.PackageManager.NameNotFoundException {
    ...
    static android.support.v4.provider.FontsContractCompat.FontInfo[] getFontFromProvider(android.content.Context r20, android.support.v4.provider.FontRequest r21, java.lang.String r22, android.os.CancellationSignal r23) {
            ...
            r3 = 0
            int r4 = android.os.Build.VERSION.SDK_INT     // Catch: java.lang.Throwable -> L124
            r5 = 16
            r11 = 1
            r12 = 0
            if (r4 <= r5) goto L66
            r20.getContentResolver()     // Catch: java.lang.Throwable -> L124
            ...
            java.lang.String[] r6 = new java.lang.String[]{r13, r14, r15, r16, r17, r18, r19}     // Catch: java.lang.Throwable -> L124
            java.lang.String r7 = "query = ?"
            java.lang.String[] r8 = new java.lang.String[r11]     // Catch: java.lang.Throwable -> L124
            java.lang.String r4 = r21.getQuery()     // Catch: java.lang.Throwable -> L124
            r8[r12] = r4     // Catch: java.lang.Throwable -> L124
            r9 = 0
            android.content.Context r4 = com.qihoo360.replugin.RePlugin.getPluginContext()     // Catch: java.lang.Throwable -> L124
            r5 = r2
            r10 = r23
            android.database.Cursor r3 = com.qihoo360.replugin.loader.p.PluginProviderClient.query(r4, r5, r6, r7, r8, r9, r10)     // Catch: java.lang.Throwable -> L124
            goto L8f
        L66:
            r20.getContentResolver()     // Catch: java.lang.Throwable -> L124
            ...
            java.lang.String[] r6 = new java.lang.String[]{r4, r5, r6, r7, r8, r9, r10}     // Catch: java.lang.Throwable -> L124
            java.lang.String r7 = "query = ?"
            java.lang.String[] r8 = new java.lang.String[r11]     // Catch: java.lang.Throwable -> L124
            java.lang.String r4 = r21.getQuery()     // Catch: java.lang.Throwable -> L124
            r8[r12] = r4     // Catch: java.lang.Throwable -> L124
            ...
            android.content.Context r4 = com.qihoo360.replugin.RePlugin.getPluginContext()     // Catch: java.lang.Throwable -> L124
            r5 = r2
            android.database.Cursor r3 = com.qihoo360.replugin.loader.p.PluginProviderClient.query(r4, r5, r6, r7, r8, r9)     // Catch: java.lang.Throwable -> L124
        L8f:
            if (r3 == 0) goto L116
            int r4 = r3.getCount()     // Catch: java.lang.Throwable -> L124
            if (r4 <= 0) goto L116
            java.lang.String r1 = "result_code"
            int r1 = r3.getColumnIndex(r1)     // Catch: java.lang.Throwable -> L124
            java.util.ArrayList r4 = new java.util.ArrayList     // Catch: java.lang.Throwable -> L124
            r4.<init>()     // Catch: java.lang.Throwable -> L124
            java.lang.String r5 = "_id"
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Throwable -> L124
            java.lang.String r6 = "file_id"
            int r6 = r3.getColumnIndex(r6)     // Catch: java.lang.Throwable -> L124
            java.lang.String r7 = "font_ttc_index"
            int r7 = r3.getColumnIndex(r7)     // Catch: java.lang.Throwable -> L124
            java.lang.String r8 = "font_weight"
            int r8 = r3.getColumnIndex(r8)     // Catch: java.lang.Throwable -> L124
            java.lang.String r9 = "font_italic"
            int r9 = r3.getColumnIndex(r9)     // Catch: java.lang.Throwable -> L124
        Lc0:
            boolean r10 = r3.moveToNext()     // Catch: java.lang.Throwable -> L124
            if (r10 == 0) goto L115
            r10 = -1
            if (r1 == r10) goto Ld0
            int r13 = r3.getInt(r1)     // Catch: java.lang.Throwable -> L124
            r19 = r13
            goto Ld2
        Ld0:
            r19 = 0
        Ld2:
            if (r7 == r10) goto Ldb
            int r13 = r3.getInt(r7)     // Catch: java.lang.Throwable -> L124
            r16 = r13
            goto Ldd
        Ldb:
            r16 = 0
        Ldd:
            if (r6 != r10) goto Le8
            long r13 = r3.getLong(r5)     // Catch: java.lang.Throwable -> L124
            android.net.Uri r13 = android.content.ContentUris.withAppendedId(r2, r13)     // Catch: java.lang.Throwable -> L124
            goto Lf0
        Le8:
            long r13 = r3.getLong(r6)     // Catch: java.lang.Throwable -> L124
            android.net.Uri r13 = android.content.ContentUris.withAppendedId(r0, r13)     // Catch: java.lang.Throwable -> L124
        Lf0:
            r15 = r13
            if (r8 == r10) goto Lfa
            int r13 = r3.getInt(r8)     // Catch: java.lang.Throwable -> L124
            r17 = r13
            goto Lfe
        Lfa:
        ...
        Lfe:
            if (r9 == r10) goto L109
            int r10 = r3.getInt(r9)     // Catch: java.lang.Throwable -> L124
        ...
        L109:
            r18 = 0
        L10b:
            android.support.v4.provider.FontsContractCompat$FontInfo r10 = new android.support.v4.provider.FontsContractCompat$FontInfo     // Catch: java.lang.Throwable -> L124
            r14 = r10
            r14.<init>(r15, r16, r17, r18, r19)     // Catch: java.lang.Throwable -> L124
            r4.add(r10)     // Catch: java.lang.Throwable -> L124
            goto Lc0
        L115:
            r1 = r4
        L116:
    ...
    @android.support.annotation.RestrictTo({android.support.annotation.RestrictTo.Scope.LIBRARY_GROUP})
    public static android.graphics.Typeface getFontSync(android.content.Context r2, android.support.v4.provider.FontRequest r3, @android.support.annotation.Nullable android.support.v4.content.res.ResourcesCompat.FontCallback r4, @android.support.annotation.Nullable android.os.Handler r5, boolean r6, int r7, int r8) {
    ...
    public static void requestFont(@android.support.annotation.NonNull android.content.Context r2, @android.support.annotation.NonNull android.support.v4.provider.FontRequest r3, @android.support.annotation.NonNull android.support.v4.provider.FontsContractCompat.FontRequestCallback r4, @android.support.annotation.NonNull android.os.Handler r5) {
