...
public class ArrayMap<K, V> extends android.support.v4.util.SimpleArrayMap<K, V> implements java.util.Map<K, V> {
    ...
    public boolean containsAll(@android.support.annotation.NonNull java.util.Collection<?> r1) {
            r0 = this;
    ...
    public boolean removeAll(@android.support.annotation.NonNull java.util.Collection<?> r1) {
            r0 = this;
            boolean r1 = android.support.v4.util.MapCollections.removeAllHelper(r0, r1)
            return r1
    }

    public boolean retainAll(@android.support.annotation.NonNull java.util.Collection<?> r1) {
            r0 = this;
