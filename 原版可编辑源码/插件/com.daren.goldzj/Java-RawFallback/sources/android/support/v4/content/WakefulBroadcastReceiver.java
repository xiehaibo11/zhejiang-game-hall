...
public abstract class WakefulBroadcastReceiver extends android.content.BroadcastReceiver {
    ...
    public static android.content.ComponentName startWakefulService(android.content.Context r5, android.content.Intent r6) {
            android.util.SparseArray<android.os.PowerManager$WakeLock> r0 = android.support.v4.content.WakefulBroadcastReceiver.sActiveWakeLocks
            monitor-enter(r0)
            int r1 = android.support.v4.content.WakefulBroadcastReceiver.mNextId     // Catch: java.lang.Throwable -> L51
            int r2 = android.support.v4.content.WakefulBroadcastReceiver.mNextId     // Catch: java.lang.Throwable -> L51
            r3 = 1
            int r2 = r2 + r3
            android.support.v4.content.WakefulBroadcastReceiver.mNextId = r2     // Catch: java.lang.Throwable -> L51
            int r2 = android.support.v4.content.WakefulBroadcastReceiver.mNextId     // Catch: java.lang.Throwable -> L51
            if (r2 > 0) goto L11
            android.support.v4.content.WakefulBroadcastReceiver.mNextId = r3     // Catch: java.lang.Throwable -> L51
        L11:
            java.lang.String r2 = "android.support.content.wakelockid"
            r6.putExtra(r2, r1)     // Catch: java.lang.Throwable -> L51
            android.content.ComponentName r6 = r5.startService(r6)     // Catch: java.lang.Throwable -> L51
            if (r6 != 0) goto L1f
            r5 = 0
        ...
        L1f:
            ...
            android.os.PowerManager r5 = (android.os.PowerManager) r5     // Catch: java.lang.Throwable -> L51
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch: java.lang.Throwable -> L51
            r2.<init>()     // Catch: java.lang.Throwable -> L51
            java.lang.String r4 = "androidx.core:wake:"
            r2.append(r4)     // Catch: java.lang.Throwable -> L51
            java.lang.String r4 = r6.flattenToShortString()     // Catch: java.lang.Throwable -> L51
            r2.append(r4)     // Catch: java.lang.Throwable -> L51
            java.lang.String r2 = r2.toString()     // Catch: java.lang.Throwable -> L51
            android.os.PowerManager$WakeLock r5 = r5.newWakeLock(r3, r2)     // Catch: java.lang.Throwable -> L51
            r2 = 0
            r5.setReferenceCounted(r2)     // Catch: java.lang.Throwable -> L51
            r2 = 60000(0xea60, double:2.9644E-319)
            r5.acquire(r2)     // Catch: java.lang.Throwable -> L51
            android.util.SparseArray<android.os.PowerManager$WakeLock> r2 = android.support.v4.content.WakefulBroadcastReceiver.sActiveWakeLocks     // Catch: java.lang.Throwable -> L51
            r2.put(r1, r5)     // Catch: java.lang.Throwable -> L51
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L51
            return r6
        L51:
            r5 = move-exception
