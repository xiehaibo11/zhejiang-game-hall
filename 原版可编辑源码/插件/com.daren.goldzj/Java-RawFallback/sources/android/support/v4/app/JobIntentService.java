...
public abstract class JobIntentService extends android.app.Service {
    ...
    static final class CompatWorkEnqueuer extends android.support.v4.app.JobIntentService.WorkEnqueuer {
        ...
        CompatWorkEnqueuer(android.content.Context r4, android.content.ComponentName r5) {
                ...
                android.os.PowerManager$WakeLock r0 = r3.mLaunchWakeLock
                r2 = 0
                ...
                r3.mRunWakeLock = r4
                android.os.PowerManager$WakeLock r4 = r3.mRunWakeLock
    ...
    public static void enqueueWork(@android.support.annotation.NonNull android.content.Context r2, @android.support.annotation.NonNull android.content.ComponentName r3, int r4, @android.support.annotation.NonNull android.content.Intent r5) {
            if (r5 == 0) goto L15
    ...
    public static void enqueueWork(@android.support.annotation.NonNull android.content.Context r1, @android.support.annotation.NonNull java.lang.Class r2, int r3, @android.support.annotation.NonNull android.content.Intent r4) {
    ...
    @Override
    public android.os.IBinder onBind(@android.support.annotation.NonNull android.content.Intent r1) {
            r0 = this;
    ...
    protected abstract void onHandleWork(@android.support.annotation.NonNull android.content.Intent r1);

    @Override
    public int onStartCommand(@android.support.annotation.Nullable android.content.Intent r3, int r4, int r5) {
            r2 = this;
