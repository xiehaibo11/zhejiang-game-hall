...
public abstract class FragmentPagerAdapter extends android.support.v4.view.PagerAdapter {
    ...
    public java.lang.Object instantiateItem(@android.support.annotation.NonNull android.view.ViewGroup r5, int r6) {
            r4 = this;
    ...
    @Override
    public boolean isViewFromObject(@android.support.annotation.NonNull android.view.View r1, @android.support.annotation.NonNull java.lang.Object r2) {
            r0 = this;
    ...
    @Override
    public void startUpdate(@android.support.annotation.NonNull android.view.ViewGroup r3) {
            r2 = this;
            int r3 = r3.getId()
            r0 = -1
            if (r3 == r0) goto L8
