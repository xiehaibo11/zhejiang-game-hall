...
public final class TextUtilsCompat {
    ...
    private static int getLayoutDirectionFromFirstChar(@android.support.annotation.NonNull java.util.Locale r3) {
    ...
    public static int getLayoutDirectionFromLocale(@android.support.annotation.Nullable java.util.Locale r2) {
    ...
    public static java.lang.String htmlEncode(@android.support.annotation.NonNull java.lang.String r4) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 17
            if (r0 < r1) goto Lb
