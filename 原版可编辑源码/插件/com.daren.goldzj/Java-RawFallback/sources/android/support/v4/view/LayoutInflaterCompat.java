...
public final class LayoutInflaterCompat {
    ...
    private static void forceSetFactory2(android.view.LayoutInflater r6, android.view.LayoutInflater.Factory2 r7) {
            ...
            android.support.v4.view.LayoutInflaterCompat.sLayoutInflaterFactory2Field = r3     // Catch: java.lang.NoSuchFieldException -> L19
            java.lang.reflect.Field r3 = android.support.v4.view.LayoutInflaterCompat.sLayoutInflaterFactory2Field     // Catch: java.lang.NoSuchFieldException -> L19
        ...
        L39:
            ...
            if (r0 == 0) goto L59
            r0.set(r6, r7)     // Catch: java.lang.IllegalAccessException -> L41
            goto L59
        L41:
            r7 = move-exception
            java.lang.StringBuilder r0 = new java.lang.StringBuilder
    ...
    @java.lang.Deprecated
    public static void setFactory(@android.support.annotation.NonNull android.view.LayoutInflater r3, @android.support.annotation.NonNull android.support.v4.view.LayoutInflaterFactory r4) {
    ...
    public static void setFactory2(@android.support.annotation.NonNull android.view.LayoutInflater r2, @android.support.annotation.NonNull android.view.LayoutInflater.Factory2 r3) {
            r2.setFactory2(r3)
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 >= r1) goto L1a
