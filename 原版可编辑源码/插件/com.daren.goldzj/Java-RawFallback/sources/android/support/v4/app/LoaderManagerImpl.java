...
class LoaderManagerImpl extends android.support.v4.app.LoaderManager {
    ...
    public static class LoaderInfo<D> extends android.arch.lifecycle.MutableLiveData<D> implements android.support.v4.content.Loader.OnLoadCompleteListener<D> {
        ...
        LoaderInfo(int r1, @android.support.annotation.Nullable android.os.Bundle r2, @android.support.annotation.NonNull android.support.v4.content.Loader<D> r3, @android.support.annotation.Nullable android.support.v4.content.Loader<D> r4) {
                r0 = this;
                r0.<init>()
                r0.mId = r1
                r0.mArgs = r2
                r0.mLoader = r3
                r0.mPriorLoader = r4
                android.support.v4.content.Loader<D> r2 = r0.mLoader
                r2.registerListener(r1, r0)
                return
        }
        ...
        @Override
        public void onLoadComplete(@android.support.annotation.NonNull android.support.v4.content.Loader<D> r3, @android.support.annotation.Nullable D r4) {
                r2 = this;
        ...
        @Override
        public void removeObserver(@android.support.annotation.NonNull android.arch.lifecycle.Observer<? super D> r1) {
                r0 = this;
                super.removeObserver(r1)
                r1 = 0
        ...
        @android.support.annotation.NonNull
        @android.support.annotation.MainThread
        android.support.v4.content.Loader<D> setCallback(@android.support.annotation.NonNull android.arch.lifecycle.LifecycleOwner r3, @android.support.annotation.NonNull android.support.v4.app.LoaderManager.LoaderCallbacks<D> r4) {
                r2 = this;
    ...
    static class LoaderObserver<D> implements android.arch.lifecycle.Observer<D> {
        ...
        LoaderObserver(@android.support.annotation.NonNull android.support.v4.content.Loader<D> r2, @android.support.annotation.NonNull android.support.v4.app.LoaderManager.LoaderCallbacks<D> r3) {
                r1 = this;
                r1.<init>()
                r0 = 0
        ...
        @Override
        public void onChanged(@android.support.annotation.Nullable D r3) {
                r2 = this;
                boolean r0 = android.support.v4.app.LoaderManagerImpl.DEBUG
                if (r0 == 0) goto L2a
                java.lang.StringBuilder r0 = new java.lang.StringBuilder
    ...
    static class LoaderViewModel extends android.arch.lifecycle.ViewModel {
        ...
        void putLoader(int r2, @android.support.annotation.NonNull android.support.v4.app.LoaderManagerImpl.LoaderInfo r3) {
                r1 = this;
                android.support.v4.util.SparseArrayCompat<android.support.v4.app.LoaderManagerImpl$LoaderInfo> r0 = r1.mLoaders
                r0.put(r2, r3)
                return
    ...
    LoaderManagerImpl(@android.support.annotation.NonNull android.arch.lifecycle.LifecycleOwner r1, @android.support.annotation.NonNull android.arch.lifecycle.ViewModelStore r2) {
            r0 = this;
            r0.<init>()
            r0.mLifecycleOwner = r1
    ...
    @android.support.annotation.NonNull
    @android.support.annotation.MainThread
    private <D> android.support.v4.content.Loader<D> createAndInstallLoader(int r3, @android.support.annotation.Nullable android.os.Bundle r4, @android.support.annotation.NonNull android.support.v4.app.LoaderManager.LoaderCallbacks<D> r5, @android.support.annotation.Nullable android.support.v4.content.Loader<D> r6) {
            r2 = this;
    ...
    @android.support.annotation.NonNull
    @android.support.annotation.MainThread
    public <D> android.support.v4.content.Loader<D> initLoader(int r5, @android.support.annotation.Nullable android.os.Bundle r6, @android.support.annotation.NonNull android.support.v4.app.LoaderManager.LoaderCallbacks<D> r7) {
            r4 = this;
    ...
    @android.support.annotation.NonNull
    @android.support.annotation.MainThread
    public <D> android.support.v4.content.Loader<D> restartLoader(int r3, @android.support.annotation.Nullable android.os.Bundle r4, @android.support.annotation.NonNull android.support.v4.app.LoaderManager.LoaderCallbacks<D> r5) {
            r2 = this;
            android.support.v4.app.LoaderManagerImpl$LoaderViewModel r0 = r2.mLoaderViewModel
            boolean r0 = r0.isCreatingLoader()
            if (r0 != 0) goto L4f
