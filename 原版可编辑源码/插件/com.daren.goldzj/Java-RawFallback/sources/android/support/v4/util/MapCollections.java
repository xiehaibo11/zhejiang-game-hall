...
abstract class MapCollections<K, V> {
    ...
    final class ArrayIterator<T> implements java.util.Iterator<T> {
        ...
        ArrayIterator(android.support.v4.util.MapCollections r2, int r3) {
                r1 = this;
                r1.this$0 = r2
                r1.<init>()
                r0 = 0
        ...
        public T next() {
                ...
                if (r0 == 0) goto L19
                android.support.v4.util.MapCollections r0 = r3.this$0
                int r1 = r3.mIndex
                int r2 = r3.mOffset
        ...
        public void remove() {
                ...
                r0 = 0
                r2.mCanRemove = r0
                android.support.v4.util.MapCollections r0 = r2.this$0
                int r1 = r2.mIndex
                r0.colRemoveAt(r1)
                return
            L1b:
    ...
    final class EntrySet implements java.util.Set<java.util.Map.Entry<K, V>> {
        ...
        EntrySet(android.support.v4.util.MapCollections r1) {
                r0 = this;
                r0.this$0 = r1
                r0.<init>()
                return
        ...
        public boolean addAll(java.util.Collection<? extends java.util.Map.Entry<K, V>> r5) {
                r4 = this;
                android.support.v4.util.MapCollections r0 = r4.this$0
            ...
            La:
                ...
                java.util.Map$Entry r1 = (java.util.Map.Entry) r1
                android.support.v4.util.MapCollections r2 = r4.this$0
                java.lang.Object r3 = r1.getKey()
                java.lang.Object r1 = r1.getValue()
                r2.colPut(r3, r1)
                goto La
            L24:
                android.support.v4.util.MapCollections r5 = r4.this$0
        ...
        public void clear() {
                r1 = this;
                android.support.v4.util.MapCollections r0 = r1.this$0
                r0.colClear()
                return
        }
        ...
        public boolean contains(java.lang.Object r4) {
            ...
            L6:
                ...
                return r1
            L15:
                android.support.v4.util.MapCollections r1 = r3.this$0
                r2 = 1
                java.lang.Object r0 = r1.colGetEntry(r0, r2)
                java.lang.Object r4 = r4.getValue()
                boolean r4 = android.support.v4.util.ContainerHelpers.equal(r0, r4)
                return r4
        }
        ...
        public boolean equals(java.lang.Object r1) {
                r0 = this;
                boolean r1 = android.support.v4.util.MapCollections.equalsSetHelper(r0, r1)
                return r1
        }
        ...
        public int hashCode() {
                r6 = this;
                android.support.v4.util.MapCollections r0 = r6.this$0
                int r0 = r0.colGetSize()
                r1 = 1
                int r0 = r0 - r1
                r2 = 0
            ...
            La:
                if (r0 < 0) goto L2d
                android.support.v4.util.MapCollections r4 = r6.this$0
                java.lang.Object r4 = r4.colGetEntry(r0, r2)
                android.support.v4.util.MapCollections r5 = r6.this$0
        ...
        public java.util.Iterator<java.util.Map.Entry<K, V>> iterator() {
                r2 = this;
                android.support.v4.util.MapCollections$MapIterator r0 = new android.support.v4.util.MapCollections$MapIterator
                android.support.v4.util.MapCollections r1 = r2.this$0
                r0.<init>(r1)
                return r0
        }
    ...
    final class KeySet implements java.util.Set<K> {
        ...
        KeySet(android.support.v4.util.MapCollections r1) {
                r0 = this;
                r0.this$0 = r1
                r0.<init>()
                return
        ...
        public boolean containsAll(java.util.Collection<?> r2) {
                ...
                boolean r2 = android.support.v4.util.MapCollections.containsAllHelper(r0, r2)
                return r2
        }
        ...
        public int hashCode() {
            ...
            La:
                if (r0 < 0) goto L1e
                android.support.v4.util.MapCollections r3 = r4.this$0
        ...
        public java.util.Iterator<K> iterator() {
                r3 = this;
                android.support.v4.util.MapCollections$ArrayIterator r0 = new android.support.v4.util.MapCollections$ArrayIterator
                android.support.v4.util.MapCollections r1 = r3.this$0
                r2 = 0
                r0.<init>(r1, r2)
                return r0
        ...
        public boolean removeAll(java.util.Collection<?> r2) {
                ...
                android.support.v4.util.MapCollections r0 = r1.this$0
                java.util.Map r0 = r0.colGetMap()
                boolean r2 = android.support.v4.util.MapCollections.removeAllHelper(r0, r2)
                return r2
        }
        ...
        public boolean retainAll(java.util.Collection<?> r2) {
                ...
                android.support.v4.util.MapCollections r0 = r1.this$0
                java.util.Map r0 = r0.colGetMap()
                boolean r2 = android.support.v4.util.MapCollections.retainAllHelper(r0, r2)
                return r2
        }
    ...
    final class MapIterator implements java.util.Iterator<java.util.Map.Entry<K, V>>, java.util.Map.Entry<K, V> {
        ...
        MapIterator(android.support.v4.util.MapCollections r2) {
                r1 = this;
                r1.this$0 = r2
                r1.<init>()
                r0 = 0
        ...
        public boolean equals(java.lang.Object r5) {
            ...
            La:
                ...
                boolean r0 = android.support.v4.util.ContainerHelpers.equal(r0, r2)
                r2 = 1
                if (r0 == 0) goto L32
                ...
                boolean r5 = android.support.v4.util.ContainerHelpers.equal(r5, r0)
                if (r5 == 0) goto L32
                r1 = 1
            L32:
                return r1
        ...
        public int hashCode() {
                ...
                if (r0 == 0) goto L27
                android.support.v4.util.MapCollections r0 = r5.this$0
                int r1 = r5.mIndex
                r2 = 0
                java.lang.Object r0 = r0.colGetEntry(r1, r2)
                android.support.v4.util.MapCollections r1 = r5.this$0
                int r3 = r5.mIndex
                r4 = 1
    ...
    final class ValuesCollection implements java.util.Collection<V> {
        ...
        ValuesCollection(android.support.v4.util.MapCollections r1) {
                r0 = this;
                r0.this$0 = r1
                r0.<init>()
                return
        ...
        public boolean removeAll(java.util.Collection<?> r6) {
            ...
            L8:
                if (r1 >= r0) goto L23
                android.support.v4.util.MapCollections r3 = r5.this$0
                r4 = 1
                java.lang.Object r3 = r3.colGetEntry(r1, r4)
                boolean r3 = r6.contains(r3)
                if (r3 == 0) goto L21
                android.support.v4.util.MapCollections r2 = r5.this$0
                r2.colRemoveAt(r1)
                int r1 = r1 + (-1)
                int r0 = r0 + (-1)
                r2 = 1
    ...
    public java.util.Set<java.util.Map.Entry<K, V>> getEntrySet() {
            r1 = this;
            android.support.v4.util.MapCollections<K, V>$EntrySet r0 = r1.mEntrySet
            if (r0 != 0) goto Lb
            android.support.v4.util.MapCollections$EntrySet r0 = new android.support.v4.util.MapCollections$EntrySet
            r0.<init>(r1)
            r1.mEntrySet = r0
        Lb:
            android.support.v4.util.MapCollections<K, V>$EntrySet r0 = r1.mEntrySet
    ...
    public java.util.Set<K> getKeySet() {
            r1 = this;
            android.support.v4.util.MapCollections<K, V>$KeySet r0 = r1.mKeySet
            if (r0 != 0) goto Lb
            android.support.v4.util.MapCollections$KeySet r0 = new android.support.v4.util.MapCollections$KeySet
            r0.<init>(r1)
            r1.mKeySet = r0
        Lb:
            android.support.v4.util.MapCollections<K, V>$KeySet r0 = r1.mKeySet
    ...
    public java.util.Collection<V> getValues() {
            r1 = this;
            android.support.v4.util.MapCollections<K, V>$ValuesCollection r0 = r1.mValues
            if (r0 != 0) goto Lb
            android.support.v4.util.MapCollections$ValuesCollection r0 = new android.support.v4.util.MapCollections$ValuesCollection
            r0.<init>(r1)
            r1.mValues = r0
        Lb:
            android.support.v4.util.MapCollections<K, V>$ValuesCollection r0 = r1.mValues
