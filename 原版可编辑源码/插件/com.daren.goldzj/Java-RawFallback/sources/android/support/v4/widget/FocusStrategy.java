...
class FocusStrategy {
    ...
    private static boolean beamBeats(int r3, @android.support.annotation.NonNull android.graphics.Rect r4, @android.support.annotation.NonNull android.graphics.Rect r5, @android.support.annotation.NonNull android.graphics.Rect r6) {
    ...
    private static boolean beamsOverlap(int r3, @android.support.annotation.NonNull android.graphics.Rect r4, @android.support.annotation.NonNull android.graphics.Rect r5) {
            r0 = 17
            r1 = 1
            r2 = 0
            if (r3 == r0) goto L2a
    ...
    public static <L, T> T findNextFocusInRelativeDirection(@android.support.annotation.NonNull L r4, @android.support.annotation.NonNull android.support.v4.widget.FocusStrategy.CollectionAdapter<L, T> r5, @android.support.annotation.NonNull android.support.v4.widget.FocusStrategy.BoundsAdapter<T> r6, @android.support.annotation.Nullable T r7, int r8, boolean r9, boolean r10) {
            int r0 = r5.size(r4)
    ...
    private static boolean isBetterCandidate(int r3, @android.support.annotation.NonNull android.graphics.Rect r4, @android.support.annotation.NonNull android.graphics.Rect r5, @android.support.annotation.NonNull android.graphics.Rect r6) {
    ...
    private static boolean isCandidate(@android.support.annotation.NonNull android.graphics.Rect r3, @android.support.annotation.NonNull android.graphics.Rect r4, int r5) {
            r0 = 17
            r1 = 1
            r2 = 0
            if (r5 == r0) goto L59
    ...
    private static boolean isToDirectionOf(int r3, @android.support.annotation.NonNull android.graphics.Rect r4, @android.support.annotation.NonNull android.graphics.Rect r5) {
            r0 = 17
            r1 = 1
            r2 = 0
            if (r3 == r0) goto L35
    ...
    private static int majorAxisDistance(int r0, @android.support.annotation.NonNull android.graphics.Rect r1, @android.support.annotation.NonNull android.graphics.Rect r2) {
    ...
    private static int majorAxisDistanceRaw(int r1, @android.support.annotation.NonNull android.graphics.Rect r2, @android.support.annotation.NonNull android.graphics.Rect r3) {
            r0 = 17
            if (r1 == r0) goto L28
            r0 = 33
            if (r1 == r0) goto L23
    ...
    private static int majorAxisDistanceToFarEdge(int r0, @android.support.annotation.NonNull android.graphics.Rect r1, @android.support.annotation.NonNull android.graphics.Rect r2) {
    ...
    private static int majorAxisDistanceToFarEdgeRaw(int r1, @android.support.annotation.NonNull android.graphics.Rect r2, @android.support.annotation.NonNull android.graphics.Rect r3) {
            r0 = 17
            if (r1 == r0) goto L28
            r0 = 33
            if (r1 == r0) goto L23
    ...
    private static int minorAxisDistance(int r1, @android.support.annotation.NonNull android.graphics.Rect r2, @android.support.annotation.NonNull android.graphics.Rect r3) {
            r0 = 17
            if (r1 == r0) goto L31
            r0 = 33
            if (r1 == r0) goto L19
