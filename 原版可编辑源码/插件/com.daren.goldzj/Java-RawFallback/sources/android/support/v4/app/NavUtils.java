...
public final class NavUtils {
    ...
    public static android.content.Intent getParentActivityIntent(@android.support.annotation.NonNull android.app.Activity r3) {
    ...
    @android.support.annotation.Nullable
    public static android.content.Intent getParentActivityIntent(@android.support.annotation.NonNull android.content.Context r2, @android.support.annotation.NonNull android.content.ComponentName r3) throws android.content.pm.PackageManager.NameNotFoundException {
    ...
    @android.support.annotation.Nullable
    public static android.content.Intent getParentActivityIntent(@android.support.annotation.NonNull android.content.Context r1, @android.support.annotation.NonNull java.lang.Class<?> r2) throws android.content.pm.PackageManager.NameNotFoundException {
    ...
    @android.support.annotation.Nullable
    public static java.lang.String getParentActivityName(@android.support.annotation.NonNull android.app.Activity r1) {
    ...
    @android.support.annotation.Nullable
    public static java.lang.String getParentActivityName(@android.support.annotation.NonNull android.content.Context r2, @android.support.annotation.NonNull android.content.ComponentName r3) throws android.content.pm.PackageManager.NameNotFoundException {
    ...
    public static void navigateUpFromSameTask(@android.support.annotation.NonNull android.app.Activity r3) {
    ...
    public static void navigateUpTo(@android.support.annotation.NonNull android.app.Activity r2, @android.support.annotation.NonNull android.content.Intent r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 16
            if (r0 < r1) goto La
            r2.navigateUpTo(r3)
    ...
    public static boolean shouldUpRecreateTask(@android.support.annotation.NonNull android.app.Activity r2, @android.support.annotation.NonNull android.content.Intent r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 16
            if (r0 < r1) goto Lb
