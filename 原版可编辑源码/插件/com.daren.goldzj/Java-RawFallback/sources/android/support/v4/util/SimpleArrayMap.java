...
public class SimpleArrayMap<K, V> {
    ...
    public boolean containsKey(@android.support.annotation.Nullable java.lang.Object r1) {
            r0 = this;
    ...
    public int indexOfKey(@android.support.annotation.Nullable java.lang.Object r2) {
            r1 = this;
            if (r2 != 0) goto L7
    ...
    public void putAll(@android.support.annotation.NonNull android.support.v4.util.SimpleArrayMap<? extends K, ? extends V> r5) {
            r4 = this;
            int r0 = r5.mSize
            int r1 = r4.mSize
            int r1 = r1 + r0
