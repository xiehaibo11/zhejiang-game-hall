...
public class FontResourcesParserCompat {
    ...
    public static final class FontFamilyFilesResourceEntry implements android.support.v4.content.res.FontResourcesParserCompat.FamilyResourceEntry {
        ...
        public FontFamilyFilesResourceEntry(@android.support.annotation.NonNull android.support.v4.content.res.FontResourcesParserCompat.FontFileResourceEntry[] r1) {
                r0 = this;
                r0.<init>()
                r0.mEntries = r1
                return
    ...
    public static final class FontFileResourceEntry {
        ...
        public FontFileResourceEntry(@android.support.annotation.NonNull java.lang.String r1, int r2, boolean r3, @android.support.annotation.Nullable java.lang.String r4, int r5, int r6) {
                r0 = this;
                r0.<init>()
                r0.mFileName = r1
                r0.mWeight = r2
    ...
    public static final class ProviderResourceEntry implements android.support.v4.content.res.FontResourcesParserCompat.FamilyResourceEntry {
        ...
        public ProviderResourceEntry(@android.support.annotation.NonNull android.support.v4.provider.FontRequest r1, int r2, int r3) {
                r0 = this;
                r0.<init>()
                r0.mRequest = r1
                r0.mStrategy = r2
