...
public final class FingerprintManagerCompat {
    ...
    public static class CryptoObject {
        ...
        public CryptoObject(@android.support.annotation.NonNull java.security.Signature r1) {
                r0 = this;
                r0.<init>()
                r0.mSignature = r1
                r1 = 0
        ...
        public CryptoObject(@android.support.annotation.NonNull javax.crypto.Cipher r1) {
                r0 = this;
                r0.<init>()
                r0.mCipher = r1
                r1 = 0
        ...
        public CryptoObject(@android.support.annotation.NonNull javax.crypto.Mac r1) {
                r0 = this;
                r0.<init>()
                r0.mMac = r1
                r1 = 0
    ...
    public static android.support.v4.hardware.fingerprint.FingerprintManagerCompat from(@android.support.annotation.NonNull android.content.Context r1) {
    ...
    @android.support.annotation.Nullable
    private static android.hardware.fingerprint.FingerprintManager getFingerprintManagerOrNull(@android.support.annotation.NonNull android.content.Context r2) {
    ...
    public void authenticate(@android.support.annotation.Nullable android.support.v4.hardware.fingerprint.FingerprintManagerCompat.CryptoObject r8, int r9, @android.support.annotation.Nullable android.support.v4.os.CancellationSignal r10, @android.support.annotation.NonNull android.support.v4.hardware.fingerprint.FingerprintManagerCompat.AuthenticationCallback r11, @android.support.annotation.Nullable android.os.Handler r12) {
            r7 = this;
