...
public final class ResourcesCompat {
    ...
    public static abstract class FontCallback {
        ...
        public final void callbackFailAsync(int r2, @android.support.annotation.Nullable android.os.Handler r3) {
                r1 = this;
                if (r3 != 0) goto Lb
        ...
        @android.support.annotation.RestrictTo({android.support.annotation.RestrictTo.Scope.LIBRARY_GROUP})
        public final void callbackSuccessAsync(android.graphics.Typeface r2, @android.support.annotation.Nullable android.os.Handler r3) {
                r1 = this;
                if (r3 != 0) goto Lb
                android.os.Handler r3 = new android.os.Handler
                android.os.Looper r0 = android.os.Looper.getMainLooper()
        ...
        public abstract void onFontRetrieved(@android.support.annotation.NonNull android.graphics.Typeface r1);
    }
    ...
    public static int getColor(@android.support.annotation.NonNull android.content.res.Resources r2, @android.support.annotation.ColorRes int r3, @android.support.annotation.Nullable android.content.res.Resources.Theme r4) throws android.content.res.Resources.NotFoundException {
    ...
    public static android.content.res.ColorStateList getColorStateList(@android.support.annotation.NonNull android.content.res.Resources r2, @android.support.annotation.ColorRes int r3, @android.support.annotation.Nullable android.content.res.Resources.Theme r4) throws android.content.res.Resources.NotFoundException {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 23
            if (r0 < r1) goto Lb
    ...
    @android.support.annotation.Nullable
    public static android.graphics.Typeface getFont(@android.support.annotation.NonNull android.content.Context r7, @android.support.annotation.FontRes int r8) throws android.content.res.Resources.NotFoundException {
    ...
    @android.support.annotation.RestrictTo({android.support.annotation.RestrictTo.Scope.LIBRARY_GROUP})
    public static android.graphics.Typeface getFont(@android.support.annotation.NonNull android.content.Context r7, @android.support.annotation.FontRes int r8, android.util.TypedValue r9, int r10, @android.support.annotation.Nullable android.support.v4.content.res.ResourcesCompat.FontCallback r11) throws android.content.res.Resources.NotFoundException {
            boolean r0 = r7.isRestricted()
            if (r0 == 0) goto L8
            r7 = 0
            return r7
    ...
    public static void getFont(@android.support.annotation.NonNull android.content.Context r7, @android.support.annotation.FontRes int r8, @android.support.annotation.NonNull android.support.v4.content.res.ResourcesCompat.FontCallback r9, @android.support.annotation.Nullable android.os.Handler r10) throws android.content.res.Resources.NotFoundException {
