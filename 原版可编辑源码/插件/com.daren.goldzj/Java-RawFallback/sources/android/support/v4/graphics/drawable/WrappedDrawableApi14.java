...
class WrappedDrawableApi14 extends android.graphics.drawable.Drawable implements android.graphics.drawable.Drawable.Callback, android.support.v4.graphics.drawable.WrappedDrawable, android.support.v4.graphics.drawable.TintAwareDrawable {
    ...
    protected static abstract class DrawableWrapperState extends android.graphics.drawable.Drawable.ConstantState {
        ...
        DrawableWrapperState(@android.support.annotation.Nullable android.support.v4.graphics.drawable.WrappedDrawableApi14.DrawableWrapperState r1, @android.support.annotation.Nullable android.content.res.Resources r2) {
                r0 = this;
                r0.<init>()
                r2 = 0
                r0.mTint = r2
        ...
        @Override
        @android.support.annotation.NonNull
        public abstract android.graphics.drawable.Drawable newDrawable(@android.support.annotation.Nullable android.content.res.Resources r1);
    }
    ...
    private static class DrawableWrapperStateBase extends android.support.v4.graphics.drawable.WrappedDrawableApi14.DrawableWrapperState {
        DrawableWrapperStateBase(@android.support.annotation.Nullable android.support.v4.graphics.drawable.WrappedDrawableApi14.DrawableWrapperState r1, @android.support.annotation.Nullable android.content.res.Resources r2) {
                r0 = this;
                r0.<init>(r1, r2)
                return
        }
    ...
    WrappedDrawableApi14(@android.support.annotation.Nullable android.graphics.drawable.Drawable r2) {
            r1 = this;
            r1.<init>()
    ...
    WrappedDrawableApi14(@android.support.annotation.NonNull android.support.v4.graphics.drawable.WrappedDrawableApi14.DrawableWrapperState r1, @android.support.annotation.Nullable android.content.res.Resources r2) {
            r0 = this;
            r0.<init>()
            r0.mState = r1
    ...
    private void updateLocalState(@android.support.annotation.Nullable android.content.res.Resources r2) {
            r1 = this;
    ...
    @Override
    public boolean getPadding(@android.support.annotation.NonNull android.graphics.Rect r2) {
            r1 = this;
            android.graphics.drawable.Drawable r0 = r1.mDrawable
    ...
    @Override
    public boolean setState(@android.support.annotation.NonNull int[] r2) {
            r1 = this;
            android.graphics.drawable.Drawable r0 = r1.mDrawable
    ...
    @Override
    public void setTintMode(@android.support.annotation.NonNull android.graphics.PorterDuff.Mode r2) {
            r1 = this;
            android.support.v4.graphics.drawable.WrappedDrawableApi14$DrawableWrapperState r0 = r1.mState
            r0.mTintMode = r2
            int[] r2 = r1.getState()
