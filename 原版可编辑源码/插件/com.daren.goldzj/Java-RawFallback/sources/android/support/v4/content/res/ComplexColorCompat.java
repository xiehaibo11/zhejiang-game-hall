...
public final class ComplexColorCompat {
    ...
    private ComplexColorCompat(android.graphics.Shader r1, android.content.res.ColorStateList r2, @android.support.annotation.ColorInt int r3) {
            r0 = this;
            r0.<init>()
            r0.mShader = r1
    ...
    static android.support.v4.content.res.ComplexColorCompat from(@android.support.annotation.ColorInt int r2) {
    ...
    static android.support.v4.content.res.ComplexColorCompat from(@android.support.annotation.NonNull android.content.res.ColorStateList r3) {
            android.support.v4.content.res.ComplexColorCompat r0 = new android.support.v4.content.res.ComplexColorCompat
    ...
    static android.support.v4.content.res.ComplexColorCompat from(@android.support.annotation.NonNull android.graphics.Shader r3) {
            android.support.v4.content.res.ComplexColorCompat r0 = new android.support.v4.content.res.ComplexColorCompat
            r1 = 0
            r2 = 0
            r0.<init>(r3, r1, r2)
    ...
    public static android.support.v4.content.res.ComplexColorCompat inflate(@android.support.annotation.NonNull android.content.res.Resources r0, @android.support.annotation.ColorRes int r1, @android.support.annotation.Nullable android.content.res.Resources.Theme r2) {
    ...
    public void setColor(@android.support.annotation.ColorInt int r1) {
            r0 = this;
            r0.mColor = r1
            return
    }
