...
public final class AsyncLayoutInflater {
    ...
    public interface OnInflateFinishedListener {
        void onInflateFinished(@android.support.annotation.NonNull android.view.View r1, @android.support.annotation.LayoutRes int r2, @android.support.annotation.Nullable android.view.ViewGroup r3);
    }

    public AsyncLayoutInflater(@android.support.annotation.NonNull android.content.Context r2) {
            r1 = this;
            r1.<init>()
    ...
    public void inflate(@android.support.annotation.LayoutRes int r2, @android.support.annotation.Nullable android.view.ViewGroup r3, @android.support.annotation.NonNull android.support.v4.view.AsyncLayoutInflater.OnInflateFinishedListener r4) {
            r1 = this;
            if (r4 == 0) goto L16
