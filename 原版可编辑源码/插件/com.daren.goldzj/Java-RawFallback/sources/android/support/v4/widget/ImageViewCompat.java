...
public class ImageViewCompat {
    ...
    public static android.content.res.ColorStateList getImageTintList(@android.support.annotation.NonNull android.widget.ImageView r2) {
    ...
    @android.support.annotation.Nullable
    public static android.graphics.PorterDuff.Mode getImageTintMode(@android.support.annotation.NonNull android.widget.ImageView r2) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto Lb
    ...
    public static void setImageTintList(@android.support.annotation.NonNull android.widget.ImageView r2, @android.support.annotation.Nullable android.content.res.ColorStateList r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto L35
    ...
    public static void setImageTintMode(@android.support.annotation.NonNull android.widget.ImageView r2, @android.support.annotation.Nullable android.graphics.PorterDuff.Mode r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 21
            if (r0 < r1) goto L35
