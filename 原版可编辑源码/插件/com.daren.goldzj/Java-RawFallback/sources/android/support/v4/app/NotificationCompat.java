...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(@android.support.annotation.NonNull android.content.Context r4, @android.support.annotation.NonNull java.lang.String r5) {
                r3 = this;
                r3.<init>()
                java.util.ArrayList r0 = new java.util.ArrayList
                r0.<init>()
        ...
        public android.support.v4.app.NotificationCompat.Builder setChannelId(@android.support.annotation.NonNull java.lang.String r1) {
                r0 = this;
                r0.mChannelId = r1
                return r0
        }

        public android.support.v4.app.NotificationCompat.Builder setColor(@android.support.annotation.ColorInt int r1) {
                r0 = this;
                r0.mColor = r1
                return r0
        }
        ...
        public android.support.v4.app.NotificationCompat.Builder setLights(@android.support.annotation.ColorInt int r2, int r3, int r4) {
                r1 = this;
                android.app.Notification r0 = r1.mNotification
                r0.ledARGB = r2
                r0.ledOnMS = r3
        ...
        public android.support.v4.app.NotificationCompat.Builder setStyle(android.support.v4.app.NotificationCompat.Style r2) {
                ...
                if (r0 == r2) goto Ld
                r1.mStyle = r2
                android.support.v4.app.NotificationCompat$Style r2 = r1.mStyle
                if (r2 == 0) goto Ld
                r2.setBuilder(r1)
            Ld:
                return r1
    ...
    public static final class CarExtender implements android.support.v4.app.NotificationCompat.Extender {
        ...
        @android.support.annotation.RequiresApi(21)
        private static android.os.Bundle getBundleForUnreadConversation(@android.support.annotation.NonNull android.support.v4.app.NotificationCompat.CarExtender.UnreadConversation r7) {
                android.os.Bundle r0 = new android.os.Bundle
                r0.<init>()
                java.lang.String[] r1 = r7.getParticipants()
                r2 = 0
                if (r1 == 0) goto L1b
                java.lang.String[] r1 = r7.getParticipants()
                int r1 = r1.length
            ...
            L1b:
                r1 = 0
            L1c:
                java.lang.String[] r3 = r7.getMessages()
                int r3 = r3.length
            ...
            L23:
                ...
                android.os.Bundle r4 = new android.os.Bundle
                r4.<init>()
                java.lang.String[] r5 = r7.getMessages()
                r5 = r5[r2]
            ...
            L40:
                ...
                android.support.v4.app.RemoteInput r1 = r7.getRemoteInput()
                if (r1 == 0) goto L7d
            ...
            L7d:
                android.app.PendingIntent r1 = r7.getReplyPendingIntent()
                java.lang.String r2 = "on_reply"
                r0.putParcelable(r2, r1)
                android.app.PendingIntent r1 = r7.getReadPendingIntent()
                java.lang.String r2 = "on_read"
                r0.putParcelable(r2, r1)
                java.lang.String[] r1 = r7.getParticipants()
                java.lang.String r2 = "participants"
                r0.putStringArray(r2, r1)
                long r1 = r7.getLatestTimestamp()
        ...
        @android.support.annotation.RequiresApi(21)
        private static android.support.v4.app.NotificationCompat.CarExtender.UnreadConversation getUnreadConversationFromBundle(@android.support.annotation.Nullable android.os.Bundle r19) {
                r0 = r19
                r1 = 0
                if (r0 != 0) goto L6
                return r1
        ...
        public android.support.v4.app.NotificationCompat.CarExtender setColor(@android.support.annotation.ColorInt int r1) {
                r0 = this;
                r0.mColor = r1
                return r0
        }
    ...
    public static class MessagingStyle extends android.support.v4.app.NotificationCompat.Style {
        ...
        public static final class Message {
            ...
            public Message(java.lang.CharSequence r2, long r3, @android.support.annotation.Nullable android.support.v4.app.Person r5) {
                    r1 = this;
                    r1.<init>()
                    android.os.Bundle r0 = new android.os.Bundle
                    r0.<init>()
        ...
        public MessagingStyle(@android.support.annotation.NonNull android.support.v4.app.Person r2) {
                r1 = this;
                r1.<init>()
                java.util.ArrayList r0 = new java.util.ArrayList
                r0.<init>()
        ...
        @java.lang.Deprecated
        public MessagingStyle(@android.support.annotation.NonNull java.lang.CharSequence r2) {
                r1 = this;
                r1.<init>()
                java.util.ArrayList r0 = new java.util.ArrayList
                r0.<init>()
        ...
        public android.support.v4.app.NotificationCompat.MessagingStyle setConversationTitle(@android.support.annotation.Nullable java.lang.CharSequence r1) {
                r0 = this;
    ...
    public static abstract class Style {
        ...
        public void setBuilder(android.support.v4.app.NotificationCompat.Builder r2) {
                ...
                if (r0 == r2) goto Ld
                r1.mBuilder = r2
                android.support.v4.app.NotificationCompat$Builder r2 = r1.mBuilder
                if (r2 == 0) goto Ld
                r2.setStyle(r1)
            Ld:
                return
    ...
    public static final class WearableExtender implements android.support.v4.app.NotificationCompat.Extender {
        ...
        public WearableExtender(android.app.Notification r12) {
                ...
                r4 = 80
                r11.mGravity = r4
                android.os.Bundle r12 = android.support.v4.app.NotificationCompat.getExtras(r12)
                if (r12 == 0) goto L30
                java.lang.String r5 = "android.wearable.EXTENSIONS"
                android.os.Bundle r12 = r12.getBundle(r5)
                goto L31
            L30:
                r12 = 0
            L31:
                ...
                java.util.ArrayList r5 = r12.getParcelableArrayList(r5)
                int r6 = android.os.Build.VERSION.SDK_INT
                r7 = 16
                if (r6 < r7) goto L78
                if (r5 == 0) goto L78
                int r6 = r5.size()
                android.support.v4.app.NotificationCompat$Action[] r6 = new android.support.v4.app.NotificationCompat.Action[r6]
                r8 = 0
            L48:
                int r9 = r6.length
                if (r8 >= r9) goto L71
                ...
                android.support.v4.app.NotificationCompat$Action r9 = android.support.v4.app.NotificationCompat.getActionCompatFromAction(r9)
                r6[r8] = r9
                goto L6e
            L5e:
                int r9 = android.os.Build.VERSION.SDK_INT
                ...
                android.support.v4.app.NotificationCompat$Action r9 = android.support.v4.app.NotificationCompatJellybean.getActionFromBundle(r9)
                r6[r8] = r9
            L6e:
                int r8 = r8 + 1
                goto L48
            L71:
                java.util.ArrayList<android.support.v4.app.NotificationCompat$Action> r5 = r11.mActions
            ...
            L78:
                ...
                android.app.Notification[] r0 = android.support.v4.app.NotificationCompat.getNotificationArrayFromBundle(r12, r0)
                if (r0 == 0) goto L97
                java.util.ArrayList<android.app.Notification> r5 = r11.mPages
