...
public final class ListViewCompat {
    ...
    public static boolean canScrollList(@android.support.annotation.NonNull android.widget.ListView r4, int r5) {
    ...
    public static void scrollListBy(@android.support.annotation.NonNull android.widget.ListView r2, int r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 19
            if (r0 < r1) goto La
            r2.scrollListBy(r3)
