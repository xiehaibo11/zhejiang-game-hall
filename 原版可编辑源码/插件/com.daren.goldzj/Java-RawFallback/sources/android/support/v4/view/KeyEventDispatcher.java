...
public class KeyEventDispatcher {
    ...
    private static boolean actionBarOnMenuKeyEventPre28(android.app.ActionBar r6, android.view.KeyEvent r7) {
            boolean r0 = android.support.v4.view.KeyEventDispatcher.sActionBarFieldsFetched
            r1 = 1
            r2 = 0
            if (r0 != 0) goto L1a
            ...
            android.support.v4.view.KeyEventDispatcher.sActionBarOnMenuKeyMethod = r0     // Catch: java.lang.NoSuchMethodException -> L18
        L18:
            android.support.v4.view.KeyEventDispatcher.sActionBarFieldsFetched = r1
        L1a:
            java.lang.reflect.Method r0 = android.support.v4.view.KeyEventDispatcher.sActionBarOnMenuKeyMethod
            if (r0 == 0) goto L2d
    ...
    private static boolean activitySuperDispatchKeyEventPre28(android.app.Activity r5, android.view.KeyEvent r6) {
        ...
        L2c:
            ...
            boolean r1 = android.support.v4.view.ViewCompat.dispatchUnhandledKeyEventBeforeCallback(r0, r6)
            if (r1 == 0) goto L37
            return r2
        L37:
            if (r0 == 0) goto L3e
    ...
    private static boolean dialogSuperDispatchKeyEventPre28(android.app.Dialog r3, android.view.KeyEvent r4) {
        ...
        L1d:
            android.view.View r0 = r0.getDecorView()
            boolean r2 = android.support.v4.view.ViewCompat.dispatchUnhandledKeyEventBeforeCallback(r0, r4)
            if (r2 == 0) goto L28
            return r1
        L28:
            if (r0 == 0) goto L2f
    ...
    public static boolean dispatchBeforeHierarchy(@android.support.annotation.NonNull android.view.View r0, @android.support.annotation.NonNull android.view.KeyEvent r1) {
            boolean r0 = android.support.v4.view.ViewCompat.dispatchUnhandledKeyEventBeforeHierarchy(r0, r1)
            return r0
    }
    ...
    public static boolean dispatchKeyEvent(@android.support.annotation.NonNull android.support.v4.view.KeyEventDispatcher.Component r3, @android.support.annotation.Nullable android.view.View r4, @android.support.annotation.Nullable android.view.Window.Callback r5, @android.support.annotation.NonNull android.view.KeyEvent r6) {
        ...
        L25:
            if (r4 == 0) goto L2d
            boolean r4 = android.support.v4.view.ViewCompat.dispatchUnhandledKeyEventBeforeCallback(r4, r6)
            if (r4 != 0) goto L33
        L2d:
            boolean r3 = r3.superDispatchKeyEvent(r6)
            if (r3 == 0) goto L34
    ...
    private static android.content.DialogInterface.OnKeyListener getDialogKeyListenerPre28(android.app.Dialog r3) {
            boolean r0 = android.support.v4.view.KeyEventDispatcher.sDialogFieldsFetched
            if (r0 != 0) goto L16
            r0 = 1
            java.lang.Class<android.app.Dialog> r1 = android.app.Dialog.class
            java.lang.String r2 = "mOnKeyListener"
            java.lang.reflect.Field r1 = r1.getDeclaredField(r2)     // Catch: java.lang.NoSuchFieldException -> L14
            android.support.v4.view.KeyEventDispatcher.sDialogKeyListenerField = r1     // Catch: java.lang.NoSuchFieldException -> L14
            java.lang.reflect.Field r1 = android.support.v4.view.KeyEventDispatcher.sDialogKeyListenerField     // Catch: java.lang.NoSuchFieldException -> L14
            r1.setAccessible(r0)     // Catch: java.lang.NoSuchFieldException -> L14
        L14:
            android.support.v4.view.KeyEventDispatcher.sDialogFieldsFetched = r0
        L16:
            java.lang.reflect.Field r0 = android.support.v4.view.KeyEventDispatcher.sDialogKeyListenerField
            if (r0 == 0) goto L21
            java.lang.Object r3 = r0.get(r3)     // Catch: java.lang.IllegalAccessException -> L21
            android.content.DialogInterface$OnKeyListener r3 = (android.content.DialogInterface.OnKeyListener) r3     // Catch: java.lang.IllegalAccessException -> L21
            return r3
        L21:
            r3 = 0
            return r3
