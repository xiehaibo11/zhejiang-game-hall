...
public class Fragment implements android.content.ComponentCallbacks, android.view.View.OnCreateContextMenuListener, android.arch.lifecycle.LifecycleOwner, android.arch.lifecycle.ViewModelStoreOwner {
    ...
    public static class SavedState implements android.os.Parcelable {
        ...
        SavedState(android.os.Parcel r1, java.lang.ClassLoader r2) {
                ...
                r0.mState = r1
                if (r2 == 0) goto L12
                android.os.Bundle r1 = r0.mState
                if (r1 == 0) goto L12
    ...
    public static android.support.v4.app.Fragment instantiate(android.content.Context r5, java.lang.String r6, @android.support.annotation.Nullable android.os.Bundle r7) {
    ...
    public android.view.LayoutInflater getLayoutInflater(@android.support.annotation.Nullable android.os.Bundle r2) {
            r1 = this;
    ...
    @android.support.annotation.NonNull
    public final java.lang.String getString(@android.support.annotation.StringRes int r2) {
            r1 = this;
    ...
    @android.support.annotation.NonNull
    public final java.lang.String getString(@android.support.annotation.StringRes int r2, java.lang.Object... r3) {
            r1 = this;
            android.content.res.Resources r0 = r1.getResources()
    ...
    @android.support.annotation.NonNull
    public final java.lang.CharSequence getText(@android.support.annotation.StringRes int r2) {
            r1 = this;
            android.content.res.Resources r0 = r1.getResources()
    ...
    public void onActivityCreated(@android.support.annotation.Nullable android.os.Bundle r1) {
            r0 = this;
            r1 = 1
            r0.mCalled = r1
            return
    ...
    @android.support.annotation.Nullable
    public android.view.View onCreateView(@android.support.annotation.NonNull android.view.LayoutInflater r1, @android.support.annotation.Nullable android.view.ViewGroup r2, @android.support.annotation.Nullable android.os.Bundle r3) {
            r0 = this;
            r1 = 0
            return r1
    }
    ...
    @android.support.annotation.NonNull
    public android.view.LayoutInflater onGetLayoutInflater(@android.support.annotation.Nullable android.os.Bundle r1) {
            r0 = this;
    ...
    public void onSaveInstanceState(@android.support.annotation.NonNull android.os.Bundle r1) {
            r0 = this;
            return
    }
    ...
    @android.support.annotation.CallSuper
    public void onViewStateRestored(@android.support.annotation.Nullable android.os.Bundle r1) {
            r0 = this;
            r1 = 1
            r0.mCalled = r1
            return
    ...
    void performCreateView(@android.support.annotation.NonNull android.view.LayoutInflater r2, @android.support.annotation.Nullable android.view.ViewGroup r3, @android.support.annotation.Nullable android.os.Bundle r4) {
            r1 = this;
            android.support.v4.app.FragmentManagerImpl r0 = r1.mChildFragmentManager
            if (r0 == 0) goto L7
            r0.noteStateNotSaved()
    ...
    @android.support.annotation.NonNull
    android.view.LayoutInflater performGetLayoutInflater(@android.support.annotation.Nullable android.os.Bundle r1) {
            r0 = this;
    ...
    public final void requestPermissions(@android.support.annotation.NonNull java.lang.String[] r2, int r3) {
            r1 = this;
            android.support.v4.app.FragmentHostCallback r0 = r1.mHost
            if (r0 == 0) goto L8
    ...
    void restoreChildFragmentState(@android.support.annotation.Nullable android.os.Bundle r3) {
            r2 = this;
            if (r3 == 0) goto L20
    ...
    public void setArguments(@android.support.annotation.Nullable android.os.Bundle r2) {
            r1 = this;
            int r0 = r1.mIndex
            if (r0 < 0) goto L13
    ...
    public void setEnterTransition(@android.support.annotation.Nullable java.lang.Object r2) {
            r1 = this;
            android.support.v4.app.Fragment$AnimationInfo r0 = r1.ensureAnimationInfo()
    ...
    public void setExitTransition(@android.support.annotation.Nullable java.lang.Object r2) {
            r1 = this;
            android.support.v4.app.Fragment$AnimationInfo r0 = r1.ensureAnimationInfo()
    ...
    public void setInitialSavedState(@android.support.annotation.Nullable android.support.v4.app.Fragment.SavedState r2) {
            r1 = this;
            int r0 = r1.mIndex
            if (r0 >= 0) goto L11
            if (r2 == 0) goto Ld
    ...
    public void setReenterTransition(@android.support.annotation.Nullable java.lang.Object r2) {
            r1 = this;
            android.support.v4.app.Fragment$AnimationInfo r0 = r1.ensureAnimationInfo()
    ...
    public void setReturnTransition(@android.support.annotation.Nullable java.lang.Object r2) {
            r1 = this;
            android.support.v4.app.Fragment$AnimationInfo r0 = r1.ensureAnimationInfo()
    ...
    public void setSharedElementEnterTransition(@android.support.annotation.Nullable java.lang.Object r2) {
            r1 = this;
            android.support.v4.app.Fragment$AnimationInfo r0 = r1.ensureAnimationInfo()
    ...
    public void setSharedElementReturnTransition(@android.support.annotation.Nullable java.lang.Object r2) {
            r1 = this;
            android.support.v4.app.Fragment$AnimationInfo r0 = r1.ensureAnimationInfo()
    ...
    public void setTargetFragment(@android.support.annotation.Nullable android.support.v4.app.Fragment r3, int r4) {
            r2 = this;
    ...
    public boolean shouldShowRequestPermissionRationale(@android.support.annotation.NonNull java.lang.String r2) {
            r1 = this;
            android.support.v4.app.FragmentHostCallback r0 = r1.mHost
            if (r0 == 0) goto L9
    ...
    public void startActivity(android.content.Intent r3, @android.support.annotation.Nullable android.os.Bundle r4) {
            r2 = this;
            android.support.v4.app.FragmentHostCallback r0 = r2.mHost
            if (r0 == 0) goto L9
            r1 = -1
    ...
    public void startIntentSenderForResult(android.content.IntentSender r11, int r12, @android.support.annotation.Nullable android.content.Intent r13, int r14, int r15, int r16, android.os.Bundle r17) throws android.content.IntentSender.SendIntentException {
            r10 = this;
            r9 = r10
