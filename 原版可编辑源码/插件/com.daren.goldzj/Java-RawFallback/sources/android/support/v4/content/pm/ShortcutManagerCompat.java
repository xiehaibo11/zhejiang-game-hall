...
public class ShortcutManagerCompat {
    ...
    public static android.content.Intent createShortcutResultIntent(@android.support.annotation.NonNull android.content.Context r2, @android.support.annotation.NonNull android.support.v4.content.pm.ShortcutInfoCompat r3) {
    ...
    public static boolean requestPinShortcut(@android.support.annotation.NonNull android.content.Context r10, @android.support.annotation.NonNull android.support.v4.content.pm.ShortcutInfoCompat r11, @android.support.annotation.Nullable android.content.IntentSender r12) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 26
            if (r0 < r1) goto L17
            java.lang.Class<android.content.pm.ShortcutManager> r0 = android.content.pm.ShortcutManager.class
