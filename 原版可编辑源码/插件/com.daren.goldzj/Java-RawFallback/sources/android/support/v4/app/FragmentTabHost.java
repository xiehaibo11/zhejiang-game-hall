...
public class FragmentTabHost extends android.widget.TabHost implements android.widget.TabHost.OnTabChangeListener {
    ...
    static final class TabInfo {
        ...
        TabInfo(@android.support.annotation.NonNull java.lang.String r1, @android.support.annotation.NonNull java.lang.Class<?> r2, @android.support.annotation.Nullable android.os.Bundle r3) {
                r0 = this;
                r0.<init>()
                r0.tag = r1
                r0.clss = r2
    ...
    @android.support.annotation.Nullable
    private android.support.v4.app.FragmentTransaction doTabChanged(@android.support.annotation.Nullable java.lang.String r4, @android.support.annotation.Nullable android.support.v4.app.FragmentTransaction r5) {
            r3 = this;
    ...
    private void ensureHierarchy(android.content.Context r8) {
            ...
            android.widget.FrameLayout r8 = r7.mRealTabContent
    ...
    private void initFragmentTabHost(android.content.Context r4, android.util.AttributeSet r5) {
            ...
            int[] r0 = new int[r0]
            r1 = 0
            r2 = 16842995(0x10100f3, float:2.369424E-38)
            r0[r1] = r2
    ...
    public void addTab(@android.support.annotation.NonNull android.widget.TabHost.TabSpec r3, @android.support.annotation.NonNull java.lang.Class<?> r4, @android.support.annotation.Nullable android.os.Bundle r5) {
            r2 = this;
