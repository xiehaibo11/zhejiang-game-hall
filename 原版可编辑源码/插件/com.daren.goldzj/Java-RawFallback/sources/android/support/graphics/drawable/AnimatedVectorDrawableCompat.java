...
public class AnimatedVectorDrawableCompat extends android.support.graphics.drawable.VectorDrawableCommon implements android.support.graphics.drawable.Animatable2Compat {
    ...
    private AnimatedVectorDrawableCompat(@android.support.annotation.Nullable android.content.Context r2) {
            r1 = this;
            r0 = 0
            r1.<init>(r2, r0, r0)
            return
    ...
    private AnimatedVectorDrawableCompat(@android.support.annotation.Nullable android.content.Context r3, @android.support.annotation.Nullable android.support.graphics.drawable.AnimatedVectorDrawableCompat.AnimatedVectorDrawableCompatState r4, @android.support.annotation.Nullable android.content.res.Resources r5) {
            r2 = this;
            r2.<init>()
            r0 = 0
    ...
    private static void registerPlatformCallback(@android.support.annotation.NonNull android.graphics.drawable.AnimatedVectorDrawable r0, @android.support.annotation.NonNull android.support.graphics.drawable.Animatable2Compat.AnimationCallback r1) {
    ...
    @Override
    public void registerAnimationCallback(@android.support.annotation.NonNull android.support.graphics.drawable.Animatable2Compat.AnimationCallback r2) {
            r1 = this;
            android.graphics.drawable.Drawable r0 = r1.mDelegateDrawable
            if (r0 == 0) goto Lc
            android.graphics.drawable.Drawable r0 = r1.mDelegateDrawable
    ...
    @Override
    public boolean unregisterAnimationCallback(@android.support.annotation.NonNull android.support.graphics.drawable.Animatable2Compat.AnimationCallback r2) {
            r1 = this;
            android.graphics.drawable.Drawable r0 = r1.mDelegateDrawable
            if (r0 == 0) goto Lb
            android.graphics.drawable.Drawable r0 = r1.mDelegateDrawable
