...
public final class EditorInfoCompat {
    ...
    public static void setContentMimeTypes(@android.support.annotation.NonNull android.view.inputmethod.EditorInfo r2, @android.support.annotation.Nullable java.lang.String[] r3) {
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 25
            if (r0 < r1) goto L9
