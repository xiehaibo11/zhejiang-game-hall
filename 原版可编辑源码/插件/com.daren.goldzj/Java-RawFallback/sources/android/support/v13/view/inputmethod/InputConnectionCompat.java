...
public final class InputConnectionCompat {
    ...
    public static boolean commitContent(@android.support.annotation.NonNull android.view.inputmethod.InputConnection r5, @android.support.annotation.NonNull android.view.inputmethod.EditorInfo r6, @android.support.annotation.NonNull android.support.v13.view.inputmethod.InputContentInfoCompat r7, int r8, @android.support.annotation.Nullable android.os.Bundle r9) {
    ...
    public static android.view.inputmethod.InputConnection createWrapper(@android.support.annotation.NonNull android.view.inputmethod.InputConnection r3, @android.support.annotation.NonNull android.view.inputmethod.EditorInfo r4, @android.support.annotation.NonNull android.support.v13.view.inputmethod.InputConnectionCompat.OnCommitContentListener r5) {
            if (r3 == 0) goto L31
            if (r4 == 0) goto L29
            if (r5 == 0) goto L21
