...
public final class AppCompatResources {
    ...
    private static class ColorStateListCacheEntry {
        ...
        ColorStateListCacheEntry(@android.support.annotation.NonNull android.content.res.ColorStateList r1, @android.support.annotation.NonNull android.content.res.Configuration r2) {
                r0 = this;
                r0.<init>()
                r0.value = r1
                r0.configuration = r2
    ...
    private static void addColorStateListToCache(@android.support.annotation.NonNull android.content.Context r3, @android.support.annotation.ColorRes int r4, @android.support.annotation.NonNull android.content.res.ColorStateList r5) {
    ...
    @android.support.annotation.Nullable
    public static android.graphics.drawable.Drawable getDrawable(@android.support.annotation.NonNull android.content.Context r1, @android.support.annotation.DrawableRes int r2) {
    ...
    private static boolean isColorInt(@android.support.annotation.NonNull android.content.Context r2, @android.support.annotation.ColorRes int r3) {
