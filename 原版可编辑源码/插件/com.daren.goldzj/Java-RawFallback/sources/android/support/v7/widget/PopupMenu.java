...
public class PopupMenu {
    ...
    public PopupMenu(@android.support.annotation.NonNull android.content.Context r2, @android.support.annotation.NonNull android.view.View r3) {
            r1 = this;
            r0 = 0
            r1.<init>(r2, r3, r0)
            return
    ...
    public PopupMenu(@android.support.annotation.NonNull android.content.Context r7, @android.support.annotation.NonNull android.view.View r8, int r9) {
            r6 = this;
    ...
    public PopupMenu(@android.support.annotation.NonNull android.content.Context r10, @android.support.annotation.NonNull android.view.View r11, int r12, @android.support.annotation.AttrRes int r13, @android.support.annotation.StyleRes int r14) {
            r9 = this;
            r9.<init>()
            r9.mContext = r10
            r9.mAnchor = r11
    ...
    public void inflate(@android.support.annotation.MenuRes int r3) {
            r2 = this;
    ...
    public void setOnDismissListener(@android.support.annotation.Nullable android.support.v7.widget.PopupMenu.OnDismissListener r1) {
            r0 = this;
            r0.mOnDismissListener = r1
            return
    }

    public void setOnMenuItemClickListener(@android.support.annotation.Nullable android.support.v7.widget.PopupMenu.OnMenuItemClickListener r1) {
            r0 = this;
