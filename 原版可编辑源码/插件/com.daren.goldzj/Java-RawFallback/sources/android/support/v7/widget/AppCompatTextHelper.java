...
class AppCompatTextHelper {
    ...
    private void updateTypefaceAndStyle(android.content.Context r5, android.support.v7.widget.TintTypedArray r6) {
        ...
        L55:
            ...
            r3.<init>(r4, r5)
            int r5 = r4.mStyle     // Catch: java.lang.Throwable -> L77
            android.graphics.Typeface r5 = r6.getFont(r0, r5, r3)     // Catch: java.lang.Throwable -> L77
            r4.mFontTypeface = r5     // Catch: java.lang.Throwable -> L77
            android.graphics.Typeface r5 = r4.mFontTypeface     // Catch: java.lang.Throwable -> L77
            if (r5 != 0) goto L74
            r1 = 1
        L74:
            r4.mAsyncFontPending = r1     // Catch: java.lang.Throwable -> L77
            goto L78
        L77:
        L78:
    ...
    void loadFromAttributes(android.util.AttributeSet r18, int r19) {
        ...
        L10d:
            ...
            if (r15 == 0) goto L124
            int r11 = android.support.v7.appcompat.R.styleable.TextAppearance_textAllCaps
            boolean r12 = r7.getBoolean(r11, r6)
            goto L125
        L124:
            r5 = r11
        L125:
    ...
    void setAutoSizeTextTypeUniformWithPresetSizes(@android.support.annotation.NonNull int[] r2, int r3) throws java.lang.IllegalArgumentException {
            r1 = this;
            android.support.v7.widget.AppCompatTextViewAutoSizeHelper r0 = r1.mAutoSizeTextHelper
