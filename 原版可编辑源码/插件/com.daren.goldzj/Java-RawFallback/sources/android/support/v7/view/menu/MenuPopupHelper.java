...
public class MenuPopupHelper implements android.support.v7.view.menu.MenuHelper {
    ...
    public MenuPopupHelper(@android.support.annotation.NonNull android.content.Context r8, @android.support.annotation.NonNull android.support.v7.view.menu.MenuBuilder r9) {
            r7 = this;
    ...
    public MenuPopupHelper(@android.support.annotation.NonNull android.content.Context r8, @android.support.annotation.NonNull android.support.v7.view.menu.MenuBuilder r9, @android.support.annotation.NonNull android.view.View r10) {
            r7 = this;
            int r5 = android.support.v7.appcompat.R.attr.popupMenuStyle
            r4 = 0
            r6 = 0
    ...
    public MenuPopupHelper(@android.support.annotation.NonNull android.content.Context r8, @android.support.annotation.NonNull android.support.v7.view.menu.MenuBuilder r9, @android.support.annotation.NonNull android.view.View r10, boolean r11, @android.support.annotation.AttrRes int r12) {
            r7 = this;
            r6 = 0
            r0 = r7
            r1 = r8
    ...
    public MenuPopupHelper(@android.support.annotation.NonNull android.content.Context r2, @android.support.annotation.NonNull android.support.v7.view.menu.MenuBuilder r3, @android.support.annotation.NonNull android.view.View r4, boolean r5, @android.support.annotation.AttrRes int r6, @android.support.annotation.StyleRes int r7) {
            r1 = this;
            r1.<init>()
    ...
    public void setAnchorView(@android.support.annotation.NonNull android.view.View r1) {
            r0 = this;
            r0.mAnchorView = r1
            return
    }
    ...
    public void setOnDismissListener(@android.support.annotation.Nullable android.widget.PopupWindow.OnDismissListener r1) {
            r0 = this;
    ...
    @Override
    public void setPresenterCallback(@android.support.annotation.Nullable android.support.v7.view.menu.MenuPresenter.Callback r2) {
            r1 = this;
