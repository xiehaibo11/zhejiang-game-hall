...
public class AppCompatTextView extends android.widget.TextView implements android.support.v4.view.TintableBackgroundView, android.support.v4.widget.AutoSizeableTextView {
    ...
    public AppCompatTextView(android.content.Context r1, android.util.AttributeSet r2, int r3) {
            ...
            android.support.v7.widget.AppCompatBackgroundHelper r1 = r0.mBackgroundTintHelper
    ...
    @Override
    @android.support.annotation.RestrictTo({android.support.annotation.RestrictTo.Scope.LIBRARY_GROUP})
    public void setAutoSizeTextTypeUniformWithPresetSizes(@android.support.annotation.NonNull int[] r2, int r3) throws java.lang.IllegalArgumentException {
            r1 = this;
            boolean r0 = android.support.v7.widget.AppCompatTextView.PLATFORM_SUPPORTS_AUTOSIZE
            if (r0 == 0) goto L8
    ...
    @Override
    public void setFirstBaselineToTopHeight(@android.support.annotation.IntRange(from = 0) @android.support.annotation.Px int r3) {
            r2 = this;
    ...
    @Override
    public void setLastBaselineToBottomHeight(@android.support.annotation.IntRange(from = 0) @android.support.annotation.Px int r3) {
            r2 = this;
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 28
            if (r0 < r1) goto La
    ...
    @Override
    public void setLineHeight(@android.support.annotation.IntRange(from = 0) @android.support.annotation.Px int r1) {
            r0 = this;
            android.support.v4.widget.TextViewCompat.setLineHeight(r0, r1)
            return
    }

    public void setPrecomputedText(@android.support.annotation.NonNull android.support.v4.text.PrecomputedTextCompat r1) {
            r0 = this;
    ...
    public void setTextFuture(@android.support.annotation.NonNull java.util.concurrent.Future<android.support.v4.text.PrecomputedTextCompat> r1) {
            r0 = this;
    ...
    public void setTextMetricsParamsCompat(@android.support.annotation.NonNull android.support.v4.text.PrecomputedTextCompat.Params r1) {
            r0 = this;
