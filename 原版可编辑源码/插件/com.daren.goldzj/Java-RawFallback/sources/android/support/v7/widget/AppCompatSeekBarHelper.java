...
class AppCompatSeekBarHelper extends android.support.v7.widget.AppCompatProgressBarHelper {
    ...
    void setTickMark(@android.support.annotation.Nullable android.graphics.drawable.Drawable r3) {
            r2 = this;
            android.graphics.drawable.Drawable r0 = r2.mTickMark
            if (r0 == 0) goto L8
            r1 = 0
    ...
    void setTickMarkTintList(@android.support.annotation.Nullable android.content.res.ColorStateList r1) {
            r0 = this;
    ...
    void setTickMarkTintMode(@android.support.annotation.Nullable android.graphics.PorterDuff.Mode r1) {
            r0 = this;
