...
public class SwitchCompat extends android.widget.CompoundButton {
    ...
    public SwitchCompat(android.content.Context r6, android.util.AttributeSet r7, int r8) {
            ...
            android.graphics.drawable.Drawable r8 = r5.mThumbDrawable
            if (r8 == 0) goto L4d
            r8.setCallback(r5)
        L4d:
            ...
            android.graphics.drawable.Drawable r8 = r5.mTrackDrawable
            if (r8 == 0) goto L5c
            r8.setCallback(r5)
        L5c:
    ...
    private void stopDrag(android.view.MotionEvent r7) {
        ...
        L43:
            ...
            goto L4b
        L45:
            boolean r1 = r6.getTargetCheckedState()
            goto L4b
        L4a:
            r1 = r3
        L4b:
    ...
    public void setThumbTintList(@android.support.annotation.Nullable android.content.res.ColorStateList r1) {
            r0 = this;
    ...
    public void setThumbTintMode(@android.support.annotation.Nullable android.graphics.PorterDuff.Mode r1) {
            r0 = this;
    ...
    public void setTrackTintList(@android.support.annotation.Nullable android.content.res.ColorStateList r1) {
            r0 = this;
    ...
    public void setTrackTintMode(@android.support.annotation.Nullable android.graphics.PorterDuff.Mode r1) {
            r0 = this;
