...
public class AppCompatActivity extends android.support.v4.app.FragmentActivity implements android.support.v7.app.AppCompatCallback, android.support.v4.app.TaskStackBuilder.SupportParentable, android.support.v7.app.ActionBarDrawerToggle.DelegateProvider {
    ...
    @Override
    public <T extends android.view.View> T findViewById(@android.support.annotation.IdRes int r2) {
            r1 = this;
            android.support.v7.app.AppCompatDelegate r0 = r1.getDelegate()
    ...
    public void onCreateSupportNavigateUpTaskStack(@android.support.annotation.NonNull android.support.v4.app.TaskStackBuilder r1) {
            r0 = this;
    ...
    @Override
    protected void onPostCreate(@android.support.annotation.Nullable android.os.Bundle r2) {
            r1 = this;
    ...
    public void onPrepareSupportNavigateUpTaskStack(@android.support.annotation.NonNull android.support.v4.app.TaskStackBuilder r1) {
            r0 = this;
            return
    }
    ...
    public void onSupportActionModeFinished(@android.support.annotation.NonNull android.support.v7.view.ActionMode r1) {
            r0 = this;
            return
    }
    ...
    @Override
    @android.support.annotation.CallSuper
    public void onSupportActionModeStarted(@android.support.annotation.NonNull android.support.v7.view.ActionMode r1) {
            r0 = this;
            return
    }
    ...
    @Override
    @android.support.annotation.Nullable
    public android.support.v7.view.ActionMode onWindowStartingSupportActionMode(@android.support.annotation.NonNull android.support.v7.view.ActionMode.Callback r1) {
            r0 = this;
            r1 = 0
            return r1
    }
    ...
    @Override
    public void setContentView(@android.support.annotation.LayoutRes int r2) {
            r1 = this;
            android.support.v7.app.AppCompatDelegate r0 = r1.getDelegate()
    ...
    public void setSupportActionBar(@android.support.annotation.Nullable android.support.v7.widget.Toolbar r2) {
            r1 = this;
            android.support.v7.app.AppCompatDelegate r0 = r1.getDelegate()
    ...
    @Override
    public void setTheme(@android.support.annotation.StyleRes int r1) {
            r0 = this;
            super.setTheme(r1)
            r0.mThemeId = r1
            return
    ...
    @android.support.annotation.Nullable
    public android.support.v7.view.ActionMode startSupportActionMode(@android.support.annotation.NonNull android.support.v7.view.ActionMode.Callback r2) {
            r1 = this;
            android.support.v7.app.AppCompatDelegate r0 = r1.getDelegate()
    ...
    public void supportNavigateUpTo(@android.support.annotation.NonNull android.content.Intent r1) {
            r0 = this;
    ...
    public boolean supportShouldUpRecreateTask(@android.support.annotation.NonNull android.content.Intent r1) {
            r0 = this;
