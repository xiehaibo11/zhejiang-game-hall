...
public class AppCompatViewInflater {
    ...
    private static class DeclaredOnClickListener implements android.view.View.OnClickListener {
        ...
        public DeclaredOnClickListener(@android.support.annotation.NonNull android.view.View r1, @android.support.annotation.NonNull java.lang.String r2) {
                r0 = this;
                r0.<init>()
                r0.mHostView = r1
                r0.mMethodName = r2
        ...
        @Override
        public void onClick(@android.support.annotation.NonNull android.view.View r5) {
                r4 = this;
    ...
    final android.view.View createView(android.view.View r1, java.lang.String r2, @android.support.annotation.NonNull android.content.Context r3, @android.support.annotation.NonNull android.util.AttributeSet r4, boolean r5, boolean r6, boolean r7, boolean r8) {
            r0 = this;
            if (r5 == 0) goto L9
            if (r1 == 0) goto L9
