...
class AppCompatDelegateImpl extends android.support.v7.app.AppCompatDelegate implements android.support.v7.view.menu.MenuBuilder.Callback, android.view.LayoutInflater.Factory2 {
    ...
    final class AutoNightModeManager {
        ...
        AutoNightModeManager(@android.support.annotation.NonNull android.support.v7.app.AppCompatDelegateImpl r1, android.support.v7.app.TwilightManager r2) {
                r0 = this;
                r0.this$0 = r1
                r0.<init>()
    ...
    AppCompatDelegateImpl(android.content.Context r3, android.view.Window r4, android.support.v7.app.AppCompatCallback r5) {
            ...
            android.view.Window r4 = r2.mWindow
            android.view.Window$Callback r5 = r2.mAppCompatWindowCallback
            r4.setCallback(r5)
    ...
    private void initWindowDecorActionBar() {
        ...
        Lc:
            ...
            if (r1 == 0) goto L1e
            android.support.v7.app.WindowDecorActionBar r1 = new android.support.v7.app.WindowDecorActionBar
    ...
    @Override
    public android.view.View createView(android.view.View r12, java.lang.String r13, @android.support.annotation.NonNull android.content.Context r14, @android.support.annotation.NonNull android.util.AttributeSet r15) {
            r11 = this;
    ...
    @Override
    public android.support.v7.view.ActionMode startSupportActionMode(@android.support.annotation.NonNull android.support.v7.view.ActionMode.Callback r3) {
            r2 = this;
            if (r3 == 0) goto L32
            android.support.v7.view.ActionMode r0 = r2.mActionMode
            if (r0 == 0) goto L9
    ...
    int updateStatusGuard(int r8) {
            ...
            android.support.v7.widget.ActionBarContextView r2 = r7.mActionModeView
            boolean r2 = r2.isShown()
            r3 = 1
            if (r2 == 0) goto L95
            android.graphics.Rect r2 = r7.mTempRect1
            if (r2 != 0) goto L30
        ...
        L30:
            android.graphics.Rect r2 = r7.mTempRect1
            android.graphics.Rect r4 = r7.mTempRect2
            r2.set(r1, r8, r1, r1)
            android.view.ViewGroup r5 = r7.mSubDecor
        ...
        L43:
            ...
            if (r4 == r2) goto L86
            r0.topMargin = r8
            android.view.View r2 = r7.mStatusGuard
            if (r2 != 0) goto L75
            ...
            android.view.ViewGroup r2 = r7.mSubDecor
            android.view.View r4 = r7.mStatusGuard
        ...
        L8c:
            r3 = 0
        L8d:
            boolean r4 = r7.mOverlayActionMode
            if (r4 != 0) goto L9f
            if (r3 == 0) goto L9f
            r8 = 0
            goto L9f
        ...
        La7:
            r3 = 0
        La8:
            android.view.View r0 = r7.mStatusGuard
            if (r0 == 0) goto Lb4
            if (r3 == 0) goto Laf
            goto Lb1
        Laf:
