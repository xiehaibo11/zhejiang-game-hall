...
public class AppCompatImageButton extends android.widget.ImageButton implements android.support.v4.view.TintableBackgroundView, android.support.v4.widget.TintableImageSourceView {
    ...
    @Override
    public void setImageDrawable(@android.support.annotation.Nullable android.graphics.drawable.Drawable r1) {
            r0 = this;
    ...
    @Override
    public void setImageResource(@android.support.annotation.DrawableRes int r2) {
            r1 = this;
            android.support.v7.widget.AppCompatImageHelper r0 = r1.mImageHelper
    ...
    @Override
    public void setImageURI(@android.support.annotation.Nullable android.net.Uri r1) {
            r0 = this;
    ...
    @Override
    @android.support.annotation.RestrictTo({android.support.annotation.RestrictTo.Scope.LIBRARY_GROUP})
    public void setSupportImageTintList(@android.support.annotation.Nullable android.content.res.ColorStateList r2) {
            r1 = this;
            android.support.v7.widget.AppCompatImageHelper r0 = r1.mImageHelper
            if (r0 == 0) goto L7
    ...
    @Override
    @android.support.annotation.RestrictTo({android.support.annotation.RestrictTo.Scope.LIBRARY_GROUP})
    public void setSupportImageTintMode(@android.support.annotation.Nullable android.graphics.PorterDuff.Mode r2) {
            r1 = this;
            android.support.v7.widget.AppCompatImageHelper r0 = r1.mImageHelper
            if (r0 == 0) goto L7
