...
class TwilightManager {
    ...
    TwilightManager(@android.support.annotation.NonNull android.content.Context r2, @android.support.annotation.NonNull android.location.LocationManager r3) {
            r1 = this;
            r1.<init>()
    ...
    static android.support.v7.app.TwilightManager getInstance(@android.support.annotation.NonNull android.content.Context r2) {
    ...
    private android.location.Location getLastKnownLocation() {
            ...
            android.location.Location r0 = r7.getLastKnownLocationForProvider(r0)
            goto L13
        L12:
            r0 = r1
        L13:
            ...
            android.location.Location r1 = r7.getLastKnownLocationForProvider(r1)
        L23:
            if (r1 == 0) goto L35
            if (r0 == 0) goto L35
            long r2 = r1.getTime()
    ...
    private boolean isStateValid() {
            r5 = this;
            android.support.v7.app.TwilightManager$TwilightState r0 = r5.mTwilightState
    ...
    private void updateState(@android.support.annotation.NonNull android.location.Location r23) {
            r22 = this;
            r0 = r22
