...
public final class R {
    ...
    public static final class styleable {
        ...
        static {
                r0 = 29
                int[] r1 = new int[r0]
                r1 = {x015a: FILL_ARRAY_DATA , data: [2130837553, 2130837554, 2130837555, 2130837591, 2130837592, 2130837593, 2130837594, 2130837595, 2130837596, 2130837599, 2130837604, 2130837605, 2130837616, 2130837632, 2130837633, 2130837634, 2130837635, 2130837636, 2130837641, 2130837644, 2130837666, 2130837673, 2130837684, 2130837687, 2130837688, 2130837715, 2130837718, 2130837745, 2130837754} // fill-array
                ...
                r2 = 6
                int[] r4 = new int[r2]
                r4 = {x0198: FILL_ARRAY_DATA , data: [2130837553, 2130837554, 2130837575, 2130837632, 2130837718, 2130837754} // fill-array
                android.support.v7.appcompat.R.styleable.ActionMode = r4
                r4 = 2
                int[] r5 = new int[r4]
                r5 = {x01a8: FILL_ARRAY_DATA , data: [2130837617, 2130837642} // fill-array
                android.support.v7.appcompat.R.styleable.ActivityChooserView = r5
                r5 = 8
                int[] r6 = new int[r5]
                r6 = {x01b0: FILL_ARRAY_DATA , data: [16842994, 2130837566, 2130837567, 2130837657, 2130837658, 2130837670, 2130837704, 2130837705} // fill-array
                ...
                int[] r7 = new int[r6]
                r7 = {x01e8: FILL_ARRAY_DATA , data: [16843033, 2130837710, 2130837743, 2130837744} // fill-array
                android.support.v7.appcompat.R.styleable.AppCompatImageView = r7
                int[] r7 = new int[r6]
                r7 = {x01f4: FILL_ARRAY_DATA , data: [16843074, 2130837740, 2130837741, 2130837742} // fill-array
                ...
                r8 = 3
                int[] r9 = new int[r8]
                r9 = {x0322: FILL_ARRAY_DATA , data: [16843173, 16843551, 2130837543} // fill-array
                android.support.v7.appcompat.R.styleable.ColorStateListItem = r9
                int[] r9 = new int[r8]
                r9 = {x032c: FILL_ARRAY_DATA , data: [16843015, 2130837570, 2130837571} // fill-array
                android.support.v7.appcompat.R.styleable.CompoundButton = r9
                int[] r9 = new int[r4]
                r9 = {x0336: FILL_ARRAY_DATA , data: [2130837645, 2130837712} // fill-array
                android.support.v7.appcompat.R.styleable.CoordinatorLayout = r9
                int[] r7 = new int[r7]
                r7 = {x033e: FILL_ARRAY_DATA , data: [16842931, 2130837648, 2130837649, 2130837650, 2130837651, 2130837652, 2130837653} // fill-array
                android.support.v7.appcompat.R.styleable.CoordinatorLayout_Layout = r7
                int[] r5 = new int[r5]
                r5 = {x0350: FILL_ARRAY_DATA , data: [2130837545, 2130837546, 2130837558, 2130837578, 2130837609, 2130837630, 2130837706, 2130837736} // fill-array
                android.support.v7.appcompat.R.styleable.DrawerArrowToggle = r5
                int[] r5 = new int[r2]
                r5 = {x0364: FILL_ARRAY_DATA , data: [2130837621, 2130837622, 2130837623, 2130837624, 2130837625, 2130837626} // fill-array
                android.support.v7.appcompat.R.styleable.FontFamily = r5
                r5 = 10
                int[] r5 = new int[r5]
                r5 = {x0374: FILL_ARRAY_DATA , data: [16844082, 16844083, 16844095, 16844143, 16844144, 2130837619, 2130837627, 2130837628, 2130837629, 2130837763} // fill-array
                ...
                r5 = 9
                int[] r7 = new int[r5]
                r7 = {x03b0: FILL_ARRAY_DATA , data: [16842927, 16842948, 16843046, 16843047, 16843048, 2130837605, 2130837607, 2130837669, 2130837702} // fill-array
                ...
                r6 = 23
                int[] r6 = new int[r6]
                r6 = {x03ea: FILL_ARRAY_DATA , data: [16842754, 16842766, 16842960, 16843014, 16843156, 16843230, 16843231, 16843233, 16843234, 16843235, 16843236, 16843237, 16843375, 2130837517, 2130837535, 2130837536, 2130837544, 2130837590, 2130837637, 2130837638, 2130837674, 2130837701, 2130837759} // fill-array
                android.support.v7.appcompat.R.styleable.MenuItem = r6
                int[] r5 = new int[r5]
                r5 = {x041c: FILL_ARRAY_DATA , data: [16842926, 16843052, 16843053, 16843054, 16843055, 16843056, 16843057, 2130837686, 2130837713} // fill-array
                android.support.v7.appcompat.R.styleable.MenuView = r5
                int[] r5 = new int[r8]
                r5 = {x0432: FILL_ARRAY_DATA , data: [16843126, 16843465, 2130837675} // fill-array
                ...
                int[] r4 = new int[r4]
                r4 = {x043c: FILL_ARRAY_DATA , data: [2130837676, 2130837679} // fill-array
                android.support.v7.appcompat.R.styleable.RecycleListView = r4
                r4 = 17
                int[] r4 = new int[r4]
                r4 = {x0444: FILL_ARRAY_DATA , data: [16842970, 16843039, 16843296, 16843364, 2130837574, 2130837589, 2130837600, 2130837631, 2130837639, 2130837647, 2130837689, 2130837690, 2130837695, 2130837696, 2130837714, 2130837719, 2130837765} // fill-array
                android.support.v7.appcompat.R.styleable.SearchView = r4
                r4 = 5
                int[] r5 = new int[r4]
                r5 = {x046a: FILL_ARRAY_DATA , data: [16842930, 16843126, 16843131, 16843362, 2130837684} // fill-array
                ...
                r1 = 14
                int[] r1 = new int[r1]
                r1 = {x0488: FILL_ARRAY_DATA , data: [16843044, 16843045, 16843074, 2130837703, 2130837709, 2130837720, 2130837721, 2130837723, 2130837737, 2130837738, 2130837739, 2130837760, 2130837761, 2130837762} // fill-array
                android.support.v7.appcompat.R.styleable.SwitchCompat = r1
                r1 = 13
                int[] r1 = new int[r1]
                r1 = {x04a8: FILL_ARRAY_DATA , data: [16842901, 16842902, 16842903, 16842904, 16842906, 16842907, 16843105, 16843106, 16843107, 16843108, 16843692, 2130837620, 2130837724} // fill-array
                android.support.v7.appcompat.R.styleable.TextAppearance = r1
                int[] r0 = new int[r0]
                r0 = {x04c6: FILL_ARRAY_DATA , data: [16842927, 16843072, 2130837565, 2130837576, 2130837577, 2130837591, 2130837592, 2130837593, 2130837594, 2130837595, 2130837596, 2130837666, 2130837667, 2130837668, 2130837671, 2130837672, 2130837684, 2130837715, 2130837716, 2130837717, 2130837745, 2130837746, 2130837747, 2130837748, 2130837749, 2130837750, 2130837751, 2130837752, 2130837753} // fill-array
                android.support.v7.appcompat.R.styleable.Toolbar = r0
                int[] r0 = new int[r4]
                r0 = {x0504: FILL_ARRAY_DATA , data: [16842752, 16842970, 2130837677, 2130837678, 2130837735} // fill-array
                android.support.v7.appcompat.R.styleable.View = r0
                int[] r0 = new int[r8]
                r0 = {x0512: FILL_ARRAY_DATA , data: [16842964, 2130837556, 2130837557} // fill-array
