...
class TintResources extends android.support.v7.widget.ResourcesWrapper {
    ...
    public TintResources(@android.support.annotation.NonNull android.content.Context r1, @android.support.annotation.NonNull android.content.res.Resources r2) {
            r0 = this;
            r0.<init>(r2)
