...
public class AppCompatAutoCompleteTextView extends android.widget.AutoCompleteTextView implements android.support.v4.view.TintableBackgroundView {
    ...
    static {
            ...
            r0[r1] = r2
            android.support.v7.widget.AppCompatAutoCompleteTextView.TINT_ATTRS = r0
            return
    }
    ...
    public AppCompatAutoCompleteTextView(android.content.Context r3, android.util.AttributeSet r4, int r5) {
            ...
            int[] r0 = android.support.v7.widget.AppCompatAutoCompleteTextView.TINT_ATTRS
            r1 = 0
        ...
        L1f:
            ...
            android.support.v7.widget.AppCompatBackgroundHelper r3 = r2.mBackgroundTintHelper
    ...
    @Override
    public void setDropDownBackgroundResource(@android.support.annotation.DrawableRes int r2) {
            r1 = this;
