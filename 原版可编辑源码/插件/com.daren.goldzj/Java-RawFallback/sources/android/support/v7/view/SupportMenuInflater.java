...
public class SupportMenuInflater extends android.view.MenuInflater {
    ...
    static {
            ...
            java.lang.Class<?>[] r0 = android.support.v7.view.SupportMenuInflater.ACTION_VIEW_CONSTRUCTOR_SIGNATURE
    ...
    public SupportMenuInflater(android.content.Context r3) {
            ...
            java.lang.Object[] r3 = r2.mActionViewConstructorArguments
    ...
    @Override
    public void inflate(@android.support.annotation.LayoutRes int r4, android.view.Menu r5) {
            r3 = this;
