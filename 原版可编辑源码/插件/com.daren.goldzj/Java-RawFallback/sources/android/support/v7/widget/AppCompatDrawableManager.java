...
public final class AppCompatDrawableManager {
    ...
    private void addDelegate(@android.support.annotation.NonNull java.lang.String r2, @android.support.annotation.NonNull android.support.v7.widget.AppCompatDrawableManager.InflateDelegate r3) {
            r1 = this;
    ...
    private synchronized boolean addDrawableToCache(@android.support.annotation.NonNull android.content.Context r3, long r4, @android.support.annotation.NonNull android.graphics.drawable.Drawable r6) {
            r2 = this;
            monitor-enter(r2)
    ...
    private void addTintListToCache(@android.support.annotation.NonNull android.content.Context r3, @android.support.annotation.DrawableRes int r4, @android.support.annotation.NonNull android.content.res.ColorStateList r5) {
            r2 = this;
    ...
    private void checkVectorDrawableSetup(@android.support.annotation.NonNull android.content.Context r2) {
            r1 = this;
    ...
    private android.content.res.ColorStateList createBorderlessButtonColorStateList(@android.support.annotation.NonNull android.content.Context r2) {
            r1 = this;
            r0 = 0
    ...
    private android.content.res.ColorStateList createButtonColorStateList(@android.support.annotation.NonNull android.content.Context r6, @android.support.annotation.ColorInt int r7) {
            r5 = this;
            r0 = 4
            int[][] r1 = new int[r0][]
            int[] r0 = new int[r0]
    ...
    private android.content.res.ColorStateList createColoredButtonColorStateList(@android.support.annotation.NonNull android.content.Context r2) {
            r1 = this;
    ...
    private android.content.res.ColorStateList createDefaultButtonColorStateList(@android.support.annotation.NonNull android.content.Context r2) {
            r1 = this;
    ...
    private android.graphics.drawable.Drawable createDrawableIfNeeded(@android.support.annotation.NonNull android.content.Context r8, @android.support.annotation.DrawableRes int r9) {
            r7 = this;
    ...
    public static synchronized android.support.v7.widget.AppCompatDrawableManager get() {
            ...
            monitor-enter(r0)
            android.support.v7.widget.AppCompatDrawableManager r1 = android.support.v7.widget.AppCompatDrawableManager.INSTANCE     // Catch: java.lang.Throwable -> L17
            if (r1 != 0) goto L13
            android.support.v7.widget.AppCompatDrawableManager r1 = new android.support.v7.widget.AppCompatDrawableManager     // Catch: java.lang.Throwable -> L17
            r1.<init>()     // Catch: java.lang.Throwable -> L17
            android.support.v7.widget.AppCompatDrawableManager.INSTANCE = r1     // Catch: java.lang.Throwable -> L17
            android.support.v7.widget.AppCompatDrawableManager r1 = android.support.v7.widget.AppCompatDrawableManager.INSTANCE     // Catch: java.lang.Throwable -> L17
    ...
    private android.content.res.ColorStateList getTintListFromCache(@android.support.annotation.NonNull android.content.Context r3, @android.support.annotation.DrawableRes int r4) {
            r2 = this;
            java.util.WeakHashMap<android.content.Context, android.support.v4.util.SparseArrayCompat<android.content.res.ColorStateList>> r0 = r2.mTintLists
            r1 = 0
            if (r0 == 0) goto L14
    ...
    private static void installDefaultInflateDelegates(@android.support.annotation.NonNull android.support.v7.widget.AppCompatDrawableManager r2) {
    ...
    private static boolean isVectorDrawable(@android.support.annotation.NonNull android.graphics.drawable.Drawable r1) {
    ...
    private void removeDelegate(@android.support.annotation.NonNull java.lang.String r2, @android.support.annotation.NonNull android.support.v7.widget.AppCompatDrawableManager.InflateDelegate r3) {
            r1 = this;
            android.support.v4.util.ArrayMap<java.lang.String, android.support.v7.widget.AppCompatDrawableManager$InflateDelegate> r0 = r1.mDelegates
            if (r0 == 0) goto Lf
    ...
    private android.graphics.drawable.Drawable tintDrawable(@android.support.annotation.NonNull android.content.Context r5, @android.support.annotation.DrawableRes int r6, boolean r7, @android.support.annotation.NonNull android.graphics.drawable.Drawable r8) {
            r4 = this;
    ...
    public synchronized android.graphics.drawable.Drawable getDrawable(@android.support.annotation.NonNull android.content.Context r2, @android.support.annotation.DrawableRes int r3) {
            r1 = this;
            monitor-enter(r1)
            r0 = 0
    ...
    synchronized android.graphics.drawable.Drawable getDrawable(@android.support.annotation.NonNull android.content.Context r2, @android.support.annotation.DrawableRes int r3, boolean r4) {
            r1 = this;
            monitor-enter(r1)
    ...
    synchronized android.content.res.ColorStateList getTintList(@android.support.annotation.NonNull android.content.Context r3, @android.support.annotation.DrawableRes int r4) {
            r2 = this;
            monitor-enter(r2)
    ...
    public synchronized void onConfigurationChanged(@android.support.annotation.NonNull android.content.Context r2) {
            r1 = this;
            monitor-enter(r1)
    ...
    synchronized android.graphics.drawable.Drawable onDrawableLoadedFromResources(@android.support.annotation.NonNull android.content.Context r2, @android.support.annotation.NonNull android.support.v7.widget.VectorEnabledTintResources r3, @android.support.annotation.DrawableRes int r4) {
            r1 = this;
            monitor-enter(r1)
