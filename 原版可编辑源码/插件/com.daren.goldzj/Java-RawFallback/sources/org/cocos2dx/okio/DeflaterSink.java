...
public final class DeflaterSink implements org.cocos2dx.okio.Sink {
    private boolean closed;
    private final java.util.zip.Deflater deflater;
    private final org.cocos2dx.okio.BufferedSink sink;

    DeflaterSink(org.cocos2dx.okio.BufferedSink r1, java.util.zip.Deflater r2) {
            r0 = this;
            r0.<init>()
            if (r1 == 0) goto L14
            if (r2 == 0) goto Lc
    ...
    public DeflaterSink(org.cocos2dx.okio.Sink r1, java.util.zip.Deflater r2) {
            r0 = this;
            org.cocos2dx.okio.BufferedSink r1 = org.cocos2dx.okio.Okio.buffer(r1)
            r0.<init>(r1, r2)
            return
    }
    ...
    private void deflate(boolean r8) throws java.io.IOException {
        ...
        L6:
            r1 = 1
            org.cocos2dx.okio.Segment r1 = r0.writableSegment(r1)
            if (r8 == 0) goto L1d
        ...
        L3e:
            ...
            int r2 = r1.limit
            if (r8 != r2) goto L55
            org.cocos2dx.okio.Segment r8 = r1.pop()
            r0.head = r8
            org.cocos2dx.okio.SegmentPool.recycle(r1)
        L55:
            return
    }
    ...
    public void close() throws java.io.IOException {
        ...
        L11:
            ...
            r0 = r1
        L15:
            org.cocos2dx.okio.BufferedSink r1 = r2.sink     // Catch: java.lang.Throwable -> L1b
    ...
    public java.lang.String toString() {
            ...
            r0.append(r1)
            org.cocos2dx.okio.BufferedSink r1 = r2.sink
            r0.append(r1)
            java.lang.String r1 = ")"
            r0.append(r1)
    ...
    public void write(org.cocos2dx.okio.Buffer r8, long r9) throws java.io.IOException {
        ...
        L8:
            ...
            int r2 = (int) r1
            java.util.zip.Deflater r1 = r7.deflater
            byte[] r3 = r0.data
            int r4 = r0.pos
            r1.setInput(r3, r4, r2)
            r1 = 0
            r7.deflate(r1)
            long r3 = r8.size
            long r5 = (long) r2
