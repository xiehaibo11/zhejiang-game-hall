...
public class ByteString implements java.io.Serializable, java.lang.Comparable<org.cocos2dx.okio.ByteString> {
    public static final org.cocos2dx.okio.ByteString EMPTY = null;
    ...
    static {
            ...
            org.cocos2dx.okio.ByteString.HEX_DIGITS = r0
            r0 = 0
            byte[] r0 = new byte[r0]
            org.cocos2dx.okio.ByteString r0 = of(r0)
            org.cocos2dx.okio.ByteString.EMPTY = r0
            return
    }
    ...
    public static org.cocos2dx.okio.ByteString decodeBase64(java.lang.String r1) {
            if (r1 == 0) goto L10
            byte[] r1 = org.cocos2dx.okio.Base64.decode(r1)
            if (r1 == 0) goto Le
    ...
    public static org.cocos2dx.okio.ByteString decodeHex(java.lang.String r4) {
            if (r4 == 0) goto L4f
            int r0 = r4.length()
            int r0 = r0 % 2
            if (r0 != 0) goto L38
        ...
        L13:
            ...
            goto L13
        L33:
            org.cocos2dx.okio.ByteString r4 = of(r0)
            return r4
        L38:
    ...
    private org.cocos2dx.okio.ByteString digest(java.lang.String r2) {
            r1 = this;
            ...
            org.cocos2dx.okio.ByteString r2 = of(r2)     // Catch: java.security.NoSuchAlgorithmException -> Lf
            return r2
        Lf:
            r2 = move-exception
    ...
    public static org.cocos2dx.okio.ByteString encodeString(java.lang.String r1, java.nio.charset.Charset r2) {
            if (r1 == 0) goto L16
            if (r2 == 0) goto Le
            org.cocos2dx.okio.ByteString r0 = new org.cocos2dx.okio.ByteString
    ...
    public static org.cocos2dx.okio.ByteString encodeUtf8(java.lang.String r2) {
            if (r2 == 0) goto L10
            org.cocos2dx.okio.ByteString r0 = new org.cocos2dx.okio.ByteString
            java.nio.charset.Charset r1 = org.cocos2dx.okio.Util.UTF_8
    ...
    private org.cocos2dx.okio.ByteString hmac(java.lang.String r3, org.cocos2dx.okio.ByteString r4) {
            r2 = this;
            ...
            org.cocos2dx.okio.ByteString r3 = of(r3)     // Catch: java.security.InvalidKeyException -> L1b java.security.NoSuchAlgorithmException -> L22
            return r3
        L1b:
            r3 = move-exception
            java.lang.IllegalArgumentException r4 = new java.lang.IllegalArgumentException
    ...
    public static org.cocos2dx.okio.ByteString of(java.nio.ByteBuffer r1) {
            if (r1 == 0) goto L11
            int r0 = r1.remaining()
            byte[] r0 = new byte[r0]
            r1.get(r0)
            org.cocos2dx.okio.ByteString r1 = new org.cocos2dx.okio.ByteString
            r1.<init>(r0)
            return r1
        L11:
            java.lang.IllegalArgumentException r1 = new java.lang.IllegalArgumentException
    ...
    public static org.cocos2dx.okio.ByteString of(byte... r1) {
            if (r1 == 0) goto Le
            org.cocos2dx.okio.ByteString r0 = new org.cocos2dx.okio.ByteString
    ...
    public static org.cocos2dx.okio.ByteString of(byte[] r7, int r8, int r9) {
            if (r7 == 0) goto L15
            int r0 = r7.length
            long r1 = (long) r0
            long r3 = (long) r8
            ...
            org.cocos2dx.okio.ByteString r7 = new org.cocos2dx.okio.ByteString
            r7.<init>(r0)
            return r7
        L15:
    ...
    public static org.cocos2dx.okio.ByteString read(java.io.InputStream r4, int r5) throws java.io.IOException {
            if (r4 == 0) goto L37
            if (r5 < 0) goto L20
            byte[] r0 = new byte[r5]
            r1 = 0
        ...
        L14:
            ...
            throw r4
        L1a:
            org.cocos2dx.okio.ByteString r4 = new org.cocos2dx.okio.ByteString
            r4.<init>(r0)
            return r4
        L20:
            java.lang.IllegalArgumentException r4 = new java.lang.IllegalArgumentException
    ...
    private void readObject(java.io.ObjectInputStream r3) throws java.io.IOException {
            r2 = this;
            int r0 = r3.readInt()
            org.cocos2dx.okio.ByteString r3 = read(r3, r0)
            java.lang.Class<org.cocos2dx.okio.ByteString> r0 = org.cocos2dx.okio.ByteString.class
    ...
    public java.lang.String base64() {
            r1 = this;
            byte[] r0 = r1.data
            java.lang.String r0 = org.cocos2dx.okio.Base64.encode(r0)
            return r0
    }
    ...
    public java.lang.String base64Url() {
            r1 = this;
            byte[] r0 = r1.data
            java.lang.String r0 = org.cocos2dx.okio.Base64.encodeUrl(r0)
            return r0
    }

    @Override
    public int compareTo(org.cocos2dx.okio.ByteString r1) {
            r0 = this;
    ...
    public int compareTo(org.cocos2dx.okio.ByteString r10) {
            r9 = this;
            int r0 = r9.size()
            int r1 = r10.size()
    ...
    public final boolean endsWith(org.cocos2dx.okio.ByteString r4) {
            r3 = this;
            int r0 = r3.size()
            int r1 = r4.size()
            int r0 = r0 - r1
    ...
    public boolean equals(java.lang.Object r6) {
            ...
            return r0
        L4:
            boolean r1 = r6 instanceof org.cocos2dx.okio.ByteString
            r2 = 0
            if (r1 == 0) goto L1c
            org.cocos2dx.okio.ByteString r6 = (org.cocos2dx.okio.ByteString) r6
            int r1 = r6.size()
            byte[] r3 = r5.data
            int r4 = r3.length
            if (r1 != r4) goto L1c
    ...
    public java.lang.String hex() {
        ...
        La:
            ...
            r5 = r0[r3]
            int r6 = r4 + 1
            char[] r7 = org.cocos2dx.okio.ByteString.HEX_DIGITS
            int r8 = r5 >> 4
            r8 = r8 & 15
            char r8 = r7[r8]
            r1[r4] = r8
    ...
    public org.cocos2dx.okio.ByteString hmacSha1(org.cocos2dx.okio.ByteString r2) {
            r1 = this;
    ...
    public org.cocos2dx.okio.ByteString hmacSha256(org.cocos2dx.okio.ByteString r2) {
            r1 = this;
    ...
    public org.cocos2dx.okio.ByteString hmacSha512(org.cocos2dx.okio.ByteString r2) {
            r1 = this;
    ...
    public final int indexOf(org.cocos2dx.okio.ByteString r2) {
            r1 = this;
    ...
    public final int indexOf(org.cocos2dx.okio.ByteString r1, int r2) {
            r0 = this;
    ...
    public int indexOf(byte[] r5, int r6) {
        ...
        La:
            ...
            byte[] r2 = r4.data
            int r3 = r5.length
            boolean r2 = org.cocos2dx.okio.Util.arrayRangeEquals(r2, r6, r5, r0, r3)
            if (r2 == 0) goto L16
            return r6
        L16:
            int r6 = r6 + 1
    ...
    public final int lastIndexOf(org.cocos2dx.okio.ByteString r2) {
            r1 = this;
            byte[] r2 = r2.internalArray()
            int r0 = r1.size()
    ...
    public final int lastIndexOf(org.cocos2dx.okio.ByteString r1, int r2) {
            r0 = this;
            byte[] r1 = r1.internalArray()
    ...
    public int lastIndexOf(byte[] r4, int r5) {
        ...
        L9:
            ...
            r1 = 0
            int r2 = r4.length
            boolean r0 = org.cocos2dx.okio.Util.arrayRangeEquals(r0, r5, r4, r1, r2)
            if (r0 == 0) goto L16
            return r5
        L16:
            int r5 = r5 + (-1)
    ...
    public org.cocos2dx.okio.ByteString md5() {
            r1 = this;
    ...
    public boolean rangeEquals(int r2, org.cocos2dx.okio.ByteString r3, int r4, int r5) {
            r1 = this;
            byte[] r0 = r1.data
    ...
    public boolean rangeEquals(int r3, byte[] r4, int r5, int r6) {
            ...
            int r1 = r1 - r6
            if (r5 > r1) goto L16
            boolean r3 = org.cocos2dx.okio.Util.arrayRangeEquals(r0, r3, r4, r5, r6)
            if (r3 == 0) goto L16
            r3 = 1
            goto L17
        L16:
    ...
    public org.cocos2dx.okio.ByteString sha1() {
            r1 = this;
    ...
    public org.cocos2dx.okio.ByteString sha256() {
            r1 = this;
    ...
    public org.cocos2dx.okio.ByteString sha512() {
            r1 = this;
    ...
    public final boolean startsWith(org.cocos2dx.okio.ByteString r3) {
            r2 = this;
            int r0 = r3.size()
            r1 = 0
    ...
    public org.cocos2dx.okio.ByteString substring(int r2) {
            r1 = this;
            byte[] r0 = r1.data
            int r0 = r0.length
            org.cocos2dx.okio.ByteString r2 = r1.substring(r2, r0)
            return r2
    }

    public org.cocos2dx.okio.ByteString substring(int r4, int r5) {
            r3 = this;
            if (r4 < 0) goto L46
            byte[] r0 = r3.data
            int r1 = r0.length
    ...
    public org.cocos2dx.okio.ByteString toAsciiLowercase() {
            r6 = this;
            r0 = 0
        L1:
            byte[] r1 = r6.data
    ...
    public org.cocos2dx.okio.ByteString toAsciiUppercase() {
            r6 = this;
            r0 = 0
        L1:
            byte[] r1 = r6.data
    ...
    public java.lang.String toString() {
        ...
        L3a:
            ...
            r0.append(r2)
            org.cocos2dx.okio.ByteString r1 = r8.substring(r7, r1)
    ...
    public java.lang.String utf8() {
        ...
        L5:
            java.lang.String r0 = new java.lang.String
            byte[] r1 = r3.data
            java.nio.charset.Charset r2 = org.cocos2dx.okio.Util.UTF_8
            r0.<init>(r1, r2)
            r3.utf8 = r0
        L10:
            return r0
    ...
    void write(org.cocos2dx.okio.Buffer r4) {
            r3 = this;
            byte[] r0 = r3.data
            int r1 = r0.length
            r2 = 0
