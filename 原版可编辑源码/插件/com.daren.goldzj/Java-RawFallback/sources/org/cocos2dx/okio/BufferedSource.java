...
public interface BufferedSource extends org.cocos2dx.okio.Source, java.nio.channels.ReadableByteChannel {
    ...
    long indexOf(org.cocos2dx.okio.ByteString r1) throws java.io.IOException;

    long indexOf(org.cocos2dx.okio.ByteString r1, long r2) throws java.io.IOException;

    long indexOfElement(org.cocos2dx.okio.ByteString r1) throws java.io.IOException;

    long indexOfElement(org.cocos2dx.okio.ByteString r1, long r2) throws java.io.IOException;

    java.io.InputStream inputStream();

    boolean rangeEquals(long r1, org.cocos2dx.okio.ByteString r3) throws java.io.IOException;

    boolean rangeEquals(long r1, org.cocos2dx.okio.ByteString r3, int r4, int r5) throws java.io.IOException;

    int read(byte[] r1) throws java.io.IOException;

    int read(byte[] r1, int r2, int r3) throws java.io.IOException;

    long readAll(org.cocos2dx.okio.Sink r1) throws java.io.IOException;
    ...
    org.cocos2dx.okio.ByteString readByteString(long r1) throws java.io.IOException;

    long readDecimalLong() throws java.io.IOException;

    void readFully(org.cocos2dx.okio.Buffer r1, long r2) throws java.io.IOException;
    ...
    int select(org.cocos2dx.okio.Options r1) throws java.io.IOException;
