...
final class Http2Writer implements java.io.Closeable {
    ...
    private final org.cocos2dx.okio.Buffer hpackBuffer;
    final org.cocos2dx.okhttp3.internal.http2.Hpack.Writer hpackWriter;
    ...
    static {
            ...
            org.cocos2dx.okhttp3.internal.http2.Http2Writer.logger = r0
            return
    }

    Http2Writer(org.cocos2dx.okio.BufferedSink r1, boolean r2) {
            r0 = this;
            r0.<init>()
            r0.sink = r1
            r0.client = r2
            ...
            r1.<init>()
            r0.hpackBuffer = r1
            org.cocos2dx.okhttp3.internal.http2.Hpack$Writer r1 = new org.cocos2dx.okhttp3.internal.http2.Hpack$Writer
            org.cocos2dx.okio.Buffer r2 = r0.hpackBuffer
            r1.<init>(r2)
            r0.hpackWriter = r1
    ...
    private void writeContinuationFrames(int r8, long r9) throws java.io.IOException {
        ...
        L19:
            ...
            org.cocos2dx.okio.BufferedSink r0 = r7.sink
            org.cocos2dx.okio.Buffer r1 = r7.hpackBuffer
            r0.write(r1, r4)
            goto L0
        L24:
            return
    ...
    private static void writeMedium(org.cocos2dx.okio.BufferedSink r1, int r2) throws java.io.IOException {
            int r0 = r2 >>> 16
    ...
    public synchronized void applyAndAckSettings(org.cocos2dx.okhttp3.internal.http2.Settings r3) throws java.io.IOException {
            r2 = this;
            monitor-enter(r2)
            ...
            r1 = -1
            if (r0 == r1) goto L1d
            org.cocos2dx.okhttp3.internal.http2.Hpack$Writer r0 = r2.hpackWriter     // Catch: java.lang.Throwable -> L32
        ...
        L1d:
            ...
            org.cocos2dx.okio.BufferedSink r3 = r2.sink     // Catch: java.lang.Throwable -> L32
    ...
    public synchronized void close() throws java.io.IOException {
            ...
            org.cocos2dx.okio.BufferedSink r0 = r1.sink     // Catch: java.lang.Throwable -> Lb
    ...
    public synchronized void connectionPreface() throws java.io.IOException {
            ...
            return
        Lb:
            java.util.logging.Logger r0 = org.cocos2dx.okhttp3.internal.http2.Http2Writer.logger     // Catch: java.lang.Throwable -> L46
            ...
            r3 = 0
            org.cocos2dx.okio.ByteString r4 = org.cocos2dx.okhttp3.internal.http2.Http2.CONNECTION_PREFACE     // Catch: java.lang.Throwable -> L46
            java.lang.String r4 = r4.hex()     // Catch: java.lang.Throwable -> L46
            r2[r3] = r4     // Catch: java.lang.Throwable -> L46
            java.lang.String r1 = org.cocos2dx.okhttp3.internal.Util.format(r1, r2)     // Catch: java.lang.Throwable -> L46
            r0.fine(r1)     // Catch: java.lang.Throwable -> L46
        L2c:
            org.cocos2dx.okio.BufferedSink r0 = r5.sink     // Catch: java.lang.Throwable -> L46
            org.cocos2dx.okio.ByteString r1 = org.cocos2dx.okhttp3.internal.http2.Http2.CONNECTION_PREFACE     // Catch: java.lang.Throwable -> L46
    ...
    public synchronized void data(boolean r2, int r3, org.cocos2dx.okio.Buffer r4, int r5) throws java.io.IOException {
            r1 = this;
            monitor-enter(r1)
    ...
    void dataFrame(int r3, byte r4, org.cocos2dx.okio.Buffer r5, int r6) throws java.io.IOException {
            r2 = this;
            r0 = 0
            r2.frameHeader(r3, r6, r0, r4)
            if (r6 <= 0) goto Lc
            org.cocos2dx.okio.BufferedSink r3 = r2.sink
            long r0 = (long) r6
            r3.write(r5, r0)
        Lc:
            return
    ...
    public synchronized void flush() throws java.io.IOException {
            ...
            if (r0 != 0) goto Lc
            org.cocos2dx.okio.BufferedSink r0 = r2.sink     // Catch: java.lang.Throwable -> L14
    ...
    public void frameHeader(int r4, int r5, byte r6, byte r7) throws java.io.IOException {
            r3 = this;
            java.util.logging.Logger r0 = org.cocos2dx.okhttp3.internal.http2.Http2Writer.logger
            java.util.logging.Level r1 = java.util.logging.Level.FINE
            boolean r0 = r0.isLoggable(r1)
            r1 = 0
            if (r0 == 0) goto L14
            java.util.logging.Logger r0 = org.cocos2dx.okhttp3.internal.http2.Http2Writer.logger
            java.lang.String r2 = org.cocos2dx.okhttp3.internal.http2.Http2.frameLog(r1, r4, r5, r6, r7)
            r0.fine(r2)
        L14:
            ...
            writeMedium(r0, r5)
            org.cocos2dx.okio.BufferedSink r5 = r3.sink
        ...
        L3b:
            ...
            java.lang.IllegalArgumentException r4 = org.cocos2dx.okhttp3.internal.http2.Http2.illegalArgument(r4, r5)
            throw r4
        L4a:
            r4 = 2
            ...
            java.lang.IllegalArgumentException r4 = org.cocos2dx.okhttp3.internal.http2.Http2.illegalArgument(r5, r4)
            throw r4
    }

    public synchronized void goAway(int r4, org.cocos2dx.okhttp3.internal.http2.ErrorCode r5, byte[] r6) throws java.io.IOException {
            r3 = this;
            monitor-enter(r3)
            ...
            org.cocos2dx.okio.BufferedSink r0 = r3.sink     // Catch: java.lang.Throwable -> L3e
            r0.writeInt(r4)     // Catch: java.lang.Throwable -> L3e
            org.cocos2dx.okio.BufferedSink r4 = r3.sink     // Catch: java.lang.Throwable -> L3e
        ...
        L2d:
            ...
            java.lang.IllegalArgumentException r4 = org.cocos2dx.okhttp3.internal.http2.Http2.illegalArgument(r4, r5)     // Catch: java.lang.Throwable -> L3e
    ...
    public synchronized void headers(int r2, java.util.List<org.cocos2dx.okhttp3.internal.http2.Header> r3) throws java.io.IOException {
            r1 = this;
            monitor-enter(r1)
    ...
    void headers(boolean r7, int r8, java.util.List<org.cocos2dx.okhttp3.internal.http2.Header> r9) throws java.io.IOException {
            r6 = this;
            boolean r0 = r6.closed
            if (r0 != 0) goto L36
            org.cocos2dx.okhttp3.internal.http2.Hpack$Writer r0 = r6.hpackWriter
            r0.writeHeaders(r9)
            org.cocos2dx.okio.Buffer r9 = r6.hpackBuffer
            long r0 = r9.size()
    ...
    public synchronized void ping(boolean r4, int r5, int r6) throws java.io.IOException {
        ...
        Le:
            ...
            org.cocos2dx.okio.BufferedSink r4 = r3.sink     // Catch: java.lang.Throwable -> L2a
    ...
    public synchronized void pushPromise(int r9, int r10, java.util.List<org.cocos2dx.okhttp3.internal.http2.Header> r11) throws java.io.IOException {
            r8 = this;
            monitor-enter(r8)
            boolean r0 = r8.closed     // Catch: java.lang.Throwable -> L47
            if (r0 != 0) goto L3f
            org.cocos2dx.okhttp3.internal.http2.Hpack$Writer r0 = r8.hpackWriter     // Catch: java.lang.Throwable -> L47
            r0.writeHeaders(r11)     // Catch: java.lang.Throwable -> L47
            org.cocos2dx.okio.Buffer r11 = r8.hpackBuffer     // Catch: java.lang.Throwable -> L47
        ...
        L23:
            ...
            org.cocos2dx.okio.BufferedSink r11 = r8.sink     // Catch: java.lang.Throwable -> L47
            r2 = 2147483647(0x7fffffff, float:NaN)
            r10 = r10 & r2
            r11.writeInt(r10)     // Catch: java.lang.Throwable -> L47
            org.cocos2dx.okio.BufferedSink r10 = r8.sink     // Catch: java.lang.Throwable -> L47
            org.cocos2dx.okio.Buffer r11 = r8.hpackBuffer     // Catch: java.lang.Throwable -> L47
    ...
    public synchronized void rstStream(int r4, org.cocos2dx.okhttp3.internal.http2.ErrorCode r5) throws java.io.IOException {
            r3 = this;
            monitor-enter(r3)
            ...
            org.cocos2dx.okio.BufferedSink r4 = r3.sink     // Catch: java.lang.Throwable -> L2c
    ...
    public synchronized void settings(org.cocos2dx.okhttp3.internal.http2.Settings r5) throws java.io.IOException {
            r4 = this;
            monitor-enter(r4)
        ...
        L24:
            r0 = r1
        L25:
            org.cocos2dx.okio.BufferedSink r3 = r4.sink     // Catch: java.lang.Throwable -> L45
            r3.writeShort(r0)     // Catch: java.lang.Throwable -> L45
            org.cocos2dx.okio.BufferedSink r0 = r4.sink     // Catch: java.lang.Throwable -> L45
        ...
        L33:
            ...
            goto L10
        L36:
            org.cocos2dx.okio.BufferedSink r5 = r4.sink     // Catch: java.lang.Throwable -> L45
    ...
    public synchronized void synReply(boolean r2, int r3, java.util.List<org.cocos2dx.okhttp3.internal.http2.Header> r4) throws java.io.IOException {
            r1 = this;
            monitor-enter(r1)
    ...
    public synchronized void synStream(boolean r1, int r2, int r3, java.util.List<org.cocos2dx.okhttp3.internal.http2.Header> r4) throws java.io.IOException {
            r0 = this;
            monitor-enter(r0)
    ...
    public synchronized void windowUpdate(int r5, long r6) throws java.io.IOException {
            ...
            org.cocos2dx.okio.BufferedSink r5 = r4.sink     // Catch: java.lang.Throwable -> L3e
        ...
        L26:
            ...
            java.lang.IllegalArgumentException r5 = org.cocos2dx.okhttp3.internal.http2.Http2.illegalArgument(r5, r0)     // Catch: java.lang.Throwable -> L3e
