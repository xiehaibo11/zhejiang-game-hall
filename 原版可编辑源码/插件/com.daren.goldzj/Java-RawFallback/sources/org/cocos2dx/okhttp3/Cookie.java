...
public final class Cookie {
    ...
    public static final class Builder {
        ...
        private org.cocos2dx.okhttp3.Cookie.Builder domain(java.lang.String r3, boolean r4) {
                r2 = this;
                if (r3 == 0) goto L24
                java.lang.String r0 = org.cocos2dx.okhttp3.internal.Util.canonicalizeHost(r3)
                if (r0 == 0) goto Ld
                r2.domain = r0
                r2.hostOnly = r4
                return r2
        ...
        public org.cocos2dx.okhttp3.Cookie build() {
                r1 = this;
        ...
        public org.cocos2dx.okhttp3.Cookie.Builder domain(java.lang.String r2) {
                r1 = this;
                r0 = 0
                org.cocos2dx.okhttp3.Cookie$Builder r2 = r1.domain(r2, r0)
                return r2
        }

        public org.cocos2dx.okhttp3.Cookie.Builder expiresAt(long r4) {
                r3 = this;
                r0 = 0
        ...
        public org.cocos2dx.okhttp3.Cookie.Builder hostOnlyDomain(java.lang.String r2) {
                r1 = this;
                r0 = 1
                org.cocos2dx.okhttp3.Cookie$Builder r2 = r1.domain(r2, r0)
                return r2
        ...
        public org.cocos2dx.okhttp3.Cookie.Builder httpOnly() {
                r1 = this;
                r0 = 1
                r1.httpOnly = r0
                return r1
        ...
        public org.cocos2dx.okhttp3.Cookie.Builder name(java.lang.String r2) {
                r1 = this;
                if (r2 == 0) goto L17
        ...
        public org.cocos2dx.okhttp3.Cookie.Builder path(java.lang.String r2) {
                r1 = this;
                java.lang.String r0 = "/"
        ...
        public org.cocos2dx.okhttp3.Cookie.Builder secure() {
                r1 = this;
                r0 = 1
                r1.secure = r0
                return r1
        ...
        public org.cocos2dx.okhttp3.Cookie.Builder value(java.lang.String r2) {
                r1 = this;
                if (r2 == 0) goto L17
                java.lang.String r0 = r2.trim()
                boolean r0 = r0.equals(r2)
    ...
    static {
            ...
            org.cocos2dx.okhttp3.Cookie.YEAR_PATTERN = r0
            java.lang.String r0 = "(?i)(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec).*"
            java.util.regex.Pattern r0 = java.util.regex.Pattern.compile(r0)
            org.cocos2dx.okhttp3.Cookie.MONTH_PATTERN = r0
            java.lang.String r0 = "(\\d{1,2})[^\\d]*"
            java.util.regex.Pattern r0 = java.util.regex.Pattern.compile(r0)
            org.cocos2dx.okhttp3.Cookie.DAY_OF_MONTH_PATTERN = r0
            java.lang.String r0 = "(\\d{1,2}):(\\d{1,2}):(\\d{1,2})[^\\d]*"
            java.util.regex.Pattern r0 = java.util.regex.Pattern.compile(r0)
            org.cocos2dx.okhttp3.Cookie.TIME_PATTERN = r0
            return
    }
    ...
    Cookie(org.cocos2dx.okhttp3.Cookie.Builder r3) {
            r2 = this;
            r2.<init>()
    ...
    private static boolean domainMatch(java.lang.String r2, java.lang.String r3) {
        ...
        L8:
            ...
            r0 = 46
            if (r3 != r0) goto L27
            boolean r2 = org.cocos2dx.okhttp3.internal.Util.verifyAsIpAddress(r2)
            if (r2 != 0) goto L27
            return r1
        L27:
            r2 = 0
    ...
    @javax.annotation.Nullable
    static org.cocos2dx.okhttp3.Cookie parse(long r24, org.cocos2dx.okhttp3.HttpUrl r26, java.lang.String r27) {
            r0 = r27
            int r1 = r27.length()
            r2 = 59
            r3 = 0
            int r4 = org.cocos2dx.okhttp3.internal.Util.delimiterOffset(r0, r3, r1, r2)
            r5 = 61
            int r6 = org.cocos2dx.okhttp3.internal.Util.delimiterOffset(r0, r3, r4, r5)
            r7 = 0
            if (r6 != r4) goto L17
            return r7
        L17:
            java.lang.String r9 = org.cocos2dx.okhttp3.internal.Util.trimSubstring(r0, r3, r6)
        ...
        L4d:
            if (r4 >= r1) goto Lc1
            int r7 = org.cocos2dx.okhttp3.internal.Util.delimiterOffset(r0, r4, r1, r2)
            int r2 = org.cocos2dx.okhttp3.internal.Util.delimiterOffset(r0, r4, r7, r5)
            java.lang.String r4 = org.cocos2dx.okhttp3.internal.Util.trimSubstring(r0, r4, r2)
            if (r2 >= r7) goto L64
            int r2 = r2 + 1
            java.lang.String r2 = org.cocos2dx.okhttp3.internal.Util.trimSubstring(r0, r2, r7)
            goto L66
        L64:
            java.lang.String r2 = ""
        L66:
    ...
    @javax.annotation.Nullable
    public static org.cocos2dx.okhttp3.Cookie parse(org.cocos2dx.okhttp3.HttpUrl r2, java.lang.String r3) {
            long r0 = java.lang.System.currentTimeMillis()
            org.cocos2dx.okhttp3.Cookie r2 = parse(r0, r2, r3)
            return r2
    }

    public static java.util.List<org.cocos2dx.okhttp3.Cookie> parseAll(org.cocos2dx.okhttp3.HttpUrl r4, org.cocos2dx.okhttp3.Headers r5) {
        ...
        Lc:
            ...
            org.cocos2dx.okhttp3.Cookie r3 = parse(r4, r3)
            if (r3 != 0) goto L1b
            goto L25
        L1b:
            if (r1 != 0) goto L22
    ...
    private static java.lang.String parseDomain(java.lang.String r2) {
        ...
        L13:
            java.lang.String r2 = org.cocos2dx.okhttp3.internal.Util.canonicalizeHost(r2)
            if (r2 == 0) goto L1a
            return r2
        L1a:
            java.lang.IllegalArgumentException r2 = new java.lang.IllegalArgumentException
    ...
    private static long parseExpires(java.lang.String r12, int r13, int r14) {
            ...
            java.util.regex.Pattern r1 = org.cocos2dx.okhttp3.Cookie.TIME_PATTERN
        ...
        L12:
            ...
            r1.region(r13, r11)
            if (r4 != r2) goto L4a
            java.util.regex.Pattern r13 = org.cocos2dx.okhttp3.Cookie.TIME_PATTERN
        ...
        L4a:
            if (r5 != r2) goto L62
            java.util.regex.Pattern r13 = org.cocos2dx.okhttp3.Cookie.DAY_OF_MONTH_PATTERN
            java.util.regex.Matcher r13 = r1.usePattern(r13)
            boolean r13 = r13.matches()
            if (r13 == 0) goto L62
            java.lang.String r13 = r1.group(r10)
        ...
        L62:
            if (r6 != r2) goto L88
            java.util.regex.Pattern r13 = org.cocos2dx.okhttp3.Cookie.MONTH_PATTERN
            java.util.regex.Matcher r13 = r1.usePattern(r13)
            boolean r13 = r13.matches()
            if (r13 == 0) goto L88
            java.lang.String r13 = r1.group(r10)
            ...
            java.util.regex.Pattern r6 = org.cocos2dx.okhttp3.Cookie.MONTH_PATTERN
        ...
        L88:
            if (r3 != r2) goto L9f
            java.util.regex.Pattern r13 = org.cocos2dx.okhttp3.Cookie.YEAR_PATTERN
            java.util.regex.Matcher r13 = r1.usePattern(r13)
            boolean r13 = r13.matches()
            if (r13 == 0) goto L9f
            java.lang.String r13 = r1.group(r10)
        ...
        Lb9:
            ...
            java.util.TimeZone r13 = org.cocos2dx.okhttp3.internal.Util.UTC
            r12.<init>(r13)
            r12.setLenient(r0)
            r12.set(r10, r3)
            int r6 = r6 - r10
    ...
    private static boolean pathMatch(org.cocos2dx.okhttp3.HttpUrl r2, java.lang.String r3) {
    ...
    public boolean equals(@javax.annotation.Nullable java.lang.Object r7) {
            r6 = this;
            boolean r0 = r7 instanceof org.cocos2dx.okhttp3.Cookie
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            org.cocos2dx.okhttp3.Cookie r7 = (org.cocos2dx.okhttp3.Cookie) r7
    ...
    public boolean matches(org.cocos2dx.okhttp3.HttpUrl r3) {
            r2 = this;
    ...
    java.lang.String toString(boolean r7) {
        ...
        L26:
            ...
            long r2 = r6.expiresAt
            r1.<init>(r2)
            java.lang.String r1 = org.cocos2dx.okhttp3.internal.http.HttpDate.format(r1)
            r0.append(r1)
        L39:
