...
public class ConscryptPlatform extends org.cocos2dx.okhttp3.internal.platform.Platform {
    ...
    public static org.cocos2dx.okhttp3.internal.platform.ConscryptPlatform buildIfSupported() {
            r0 = 0
            ...
            return r0
        Ld:
            org.cocos2dx.okhttp3.internal.platform.ConscryptPlatform r1 = new org.cocos2dx.okhttp3.internal.platform.ConscryptPlatform     // Catch: java.lang.ClassNotFoundException -> L13
    ...
    @Override
    public void configureTlsExtensions(javax.net.ssl.SSLSocket r2, java.lang.String r3, java.util.List<org.cocos2dx.okhttp3.Protocol> r4) {
            r1 = this;
            boolean r0 = org.conscrypt.Conscrypt.isConscrypt(r2)
            if (r0 == 0) goto L20
            if (r3 == 0) goto Lf
        ...
        Lf:
            java.util.List r3 = org.cocos2dx.okhttp3.internal.platform.Platform.alpnProtocolNames(r4)
            r4 = 0
