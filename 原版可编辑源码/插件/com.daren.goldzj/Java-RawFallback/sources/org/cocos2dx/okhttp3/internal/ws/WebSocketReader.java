...
final class WebSocketReader {
    boolean closed;
    private final org.cocos2dx.okio.Buffer controlFrameBuffer;
    final org.cocos2dx.okhttp3.internal.ws.WebSocketReader.FrameCallback frameCallback;
    long frameLength;
    ...
    private final org.cocos2dx.okio.Buffer messageFrameBuffer;
    int opcode;
    ...
    public interface FrameCallback {
        ...
        void onReadMessage(org.cocos2dx.okio.ByteString r1) throws java.io.IOException;

        void onReadPing(org.cocos2dx.okio.ByteString r1);

        void onReadPong(org.cocos2dx.okio.ByteString r1);
    }

    WebSocketReader(boolean r2, org.cocos2dx.okio.BufferedSource r3, org.cocos2dx.okhttp3.internal.ws.WebSocketReader.FrameCallback r4) {
            r1 = this;
            r1.<init>()
    ...
    private void readControlFrame() throws java.io.IOException {
            ...
            if (r4 <= 0) goto L2b
            org.cocos2dx.okio.BufferedSource r4 = r8.source
            org.cocos2dx.okio.Buffer r5 = r8.controlFrameBuffer
            r4.readFully(r5, r0)
            boolean r0 = r8.isClient
            if (r0 != 0) goto L2b
            org.cocos2dx.okio.Buffer r0 = r8.controlFrameBuffer
            org.cocos2dx.okio.Buffer$UnsafeCursor r1 = r8.maskCursor
            r0.readAndWriteUnsafe(r1)
            org.cocos2dx.okio.Buffer$UnsafeCursor r0 = r8.maskCursor
            r0.seek(r2)
            org.cocos2dx.okio.Buffer$UnsafeCursor r0 = r8.maskCursor
            byte[] r1 = r8.maskKey
            org.cocos2dx.okhttp3.internal.ws.WebSocketProtocol.toggleMask(r0, r1)
            org.cocos2dx.okio.Buffer$UnsafeCursor r0 = r8.maskCursor
            r0.close()
        L2b:
            int r0 = r8.opcode
        ...
        L30:
            ...
            throw r0
        L4d:
            org.cocos2dx.okhttp3.internal.ws.WebSocketReader$FrameCallback r0 = r8.frameCallback
            org.cocos2dx.okio.Buffer r1 = r8.controlFrameBuffer
            org.cocos2dx.okio.ByteString r1 = r1.readByteString()
            r0.onReadPong(r1)
            goto L9a
        L59:
            org.cocos2dx.okhttp3.internal.ws.WebSocketReader$FrameCallback r0 = r8.frameCallback
        ...
        L65:
            ...
            java.lang.String r2 = org.cocos2dx.okhttp3.internal.ws.WebSocketProtocol.closeCodeExceptionMessage(r0)
            if (r2 != 0) goto L8a
            goto L92
        L8a:
            java.net.ProtocolException r0 = new java.net.ProtocolException
        ...
        L90:
            java.lang.String r1 = ""
        L92:
            org.cocos2dx.okhttp3.internal.ws.WebSocketReader$FrameCallback r2 = r8.frameCallback
    ...
    private void readHeader() throws java.io.IOException {
            ...
            org.cocos2dx.okio.Timeout r2 = r2.timeout()
            r2.clearTimeout()
            org.cocos2dx.okio.BufferedSource r2 = r6.source     // Catch: java.lang.Throwable -> L108
            byte r2 = r2.readByte()     // Catch: java.lang.Throwable -> L108
            r2 = r2 & 255(0xff, float:3.57E-43)
            org.cocos2dx.okio.BufferedSource r3 = r6.source
            org.cocos2dx.okio.Timeout r3 = r3.timeout()
    ...
    private void readMessage() throws java.io.IOException {
        ...
        L0:
            ...
            org.cocos2dx.okio.Buffer r3 = r5.messageFrameBuffer
            r2.readFully(r3, r0)
            boolean r0 = r5.isClient
            if (r0 != 0) goto L38
            org.cocos2dx.okio.Buffer r0 = r5.messageFrameBuffer
            org.cocos2dx.okio.Buffer$UnsafeCursor r1 = r5.maskCursor
            r0.readAndWriteUnsafe(r1)
            org.cocos2dx.okio.Buffer$UnsafeCursor r0 = r5.maskCursor
            org.cocos2dx.okio.Buffer r1 = r5.messageFrameBuffer
            long r1 = r1.size()
    ...
    private void readMessageFrame() throws java.io.IOException {
        ...
        L24:
            r4.readMessage()
            if (r0 != r1) goto L35
            org.cocos2dx.okhttp3.internal.ws.WebSocketReader$FrameCallback r0 = r4.frameCallback
            org.cocos2dx.okio.Buffer r1 = r4.messageFrameBuffer
            java.lang.String r1 = r1.readUtf8()
            r0.onReadMessage(r1)
            goto L40
        L35:
