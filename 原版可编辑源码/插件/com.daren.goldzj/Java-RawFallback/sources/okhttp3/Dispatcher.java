...
public final class Dispatcher {
    ...
    private int runningCallsForHost(okhttp3.RealCall.AsyncCall r5) {
            r4 = this;
            java.util.Deque<okhttp3.RealCall$AsyncCall> r0 = r4.runningAsyncCalls
        ...
        L7:
            ...
            okhttp3.RealCall$AsyncCall r2 = (okhttp3.RealCall.AsyncCall) r2
            okhttp3.RealCall r3 = r2.get()
    ...
    void enqueue(okhttp3.RealCall.AsyncCall r2) {
            r1 = this;
            monitor-enter(r1)
            java.util.Deque<okhttp3.RealCall$AsyncCall> r0 = r1.readyAsyncCalls     // Catch: java.lang.Throwable -> Lb
