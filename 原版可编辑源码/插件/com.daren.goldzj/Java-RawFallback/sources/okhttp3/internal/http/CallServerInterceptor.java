...
public final class CallServerInterceptor implements okhttp3.Interceptor {
    ...
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r12) throws java.io.IOException {
            ...
            okhttp3.internal.http.HttpCodec r0 = r12.httpStream()
            okhttp3.internal.connection.StreamAllocation r1 = r12.streamAllocation()
            okhttp3.Connection r2 = r12.connection()
            ...
            boolean r6 = okhttp3.internal.http.HttpMethod.permitsRequestBody(r6)
            r7 = 0
            if (r6 == 0) goto La6
            ...
            r6 = 1
            okhttp3.Response$Builder r7 = r0.readResponseHeaders(r6)
        L63:
            if (r7 != 0) goto L9d
            okhttp3.EventListener r2 = r12.eventListener()
            okhttp3.Call r6 = r12.call()
            ...
            okio.Sink r6 = r0.createRequestBody(r3, r8)
            r2.<init>(r6)
            okio.BufferedSink r6 = okio.Okio.buffer(r2)
            okhttp3.RequestBody r8 = r3.body()
            r8.writeTo(r6)
            r6.close()
            okhttp3.EventListener r6 = r12.eventListener()
            okhttp3.Call r8 = r12.call()
        ...
        La6:
            ...
            okhttp3.Call r7 = r12.call()
            r6.responseHeadersStart(r7)
            okhttp3.Response$Builder r7 = r0.readResponseHeaders(r2)
        Lbb:
            okhttp3.Response$Builder r6 = r7.request(r3)
            okhttp3.internal.connection.RealConnection r7 = r1.connection()
            okhttp3.Handshake r7 = r7.handshake()
            okhttp3.Response$Builder r6 = r6.handshake(r7)
            okhttp3.Response$Builder r6 = r6.sentRequestAtMillis(r4)
            long r7 = java.lang.System.currentTimeMillis()
            okhttp3.Response$Builder r6 = r6.receivedResponseAtMillis(r7)
            ...
            okhttp3.Response$Builder r2 = r2.handshake(r3)
            okhttp3.Response$Builder r2 = r2.sentRequestAtMillis(r4)
            long r3 = java.lang.System.currentTimeMillis()
            okhttp3.Response$Builder r2 = r2.receivedResponseAtMillis(r3)
            okhttp3.Response r6 = r2.build()
            int r7 = r6.code()
        L10b:
            okhttp3.EventListener r2 = r12.eventListener()
            okhttp3.Call r12 = r12.call()
            r2.responseHeadersEnd(r12, r6)
            boolean r12 = r11.forWebSocket
            if (r12 == 0) goto L12d
            r12 = 101(0x65, float:1.42E-43)
            if (r7 != r12) goto L12d
            okhttp3.Response$Builder r12 = r6.newBuilder()
