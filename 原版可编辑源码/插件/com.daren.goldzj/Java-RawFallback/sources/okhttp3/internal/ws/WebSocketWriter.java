...
final class WebSocketWriter {
    ...
    private void writeControlFrame(int r7, okio.ByteString r8) throws java.io.IOException {
            r6 = this;
            ...
            r7.write(r8)
            okio.Buffer r7 = r6.sinkBuffer
            okio.Buffer$UnsafeCursor r8 = r6.maskCursor
            r7.readAndWriteUnsafe(r8)
            okio.Buffer$UnsafeCursor r7 = r6.maskCursor
            r7.seek(r0)
            okio.Buffer$UnsafeCursor r7 = r6.maskCursor
            byte[] r8 = r6.maskKey
            okhttp3.internal.ws.WebSocketProtocol.toggleMask(r7, r8)
            okio.Buffer$UnsafeCursor r7 = r6.maskCursor
            r7.close()
            goto L5f
        L55:
    ...
    void writeClose(int r2, okio.ByteString r3) throws java.io.IOException {
        ...
        L6:
            if (r2 == 0) goto Lb
            okhttp3.internal.ws.WebSocketProtocol.validateCloseCode(r2)
        Lb:
            okio.Buffer r0 = new okio.Buffer
            r0.<init>()
            r0.writeShort(r2)
    ...
    void writeMessageFrame(int r2, long r3, boolean r5, boolean r6) throws java.io.IOException {
        ...
        L47:
            ...
            okio.Buffer$UnsafeCursor r2 = r1.maskCursor
            byte[] r3 = r1.maskKey
            okhttp3.internal.ws.WebSocketProtocol.toggleMask(r2, r3)
            okio.Buffer$UnsafeCursor r2 = r1.maskCursor
            r2.close()
            goto L8c
        L85:
