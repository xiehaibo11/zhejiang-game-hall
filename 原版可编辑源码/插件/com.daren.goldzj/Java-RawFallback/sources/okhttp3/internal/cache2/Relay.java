    ...
    class RelaySource implements okio.Source {
        ...
        public long read(okio.Buffer r22, long r23) throws java.io.IOException {
            ...
            Lb:
                ...
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch: java.lang.Throwable -> L137
                long r7 = r0.upstreamPos     // Catch: java.lang.Throwable -> L137
                r0 = 2
                r9 = -1
                int r11 = (r5 > r7 ? 1 : (r5 == r7 ? 0 : -1))
                if (r11 != 0) goto L39
                okhttp3.internal.cache2.Relay r5 = r1.this$0     // Catch: java.lang.Throwable -> L137
            ...
            L20:
                ...
                if (r5 == 0) goto L2e
                okio.Timeout r0 = r1.timeout     // Catch: java.lang.Throwable -> L137
                okhttp3.internal.cache2.Relay r5 = r1.this$0     // Catch: java.lang.Throwable -> L137
            ...
            L39:
                okhttp3.internal.cache2.Relay r5 = r1.this$0     // Catch: java.lang.Throwable -> L137
                okio.Buffer r5 = r5.buffer     // Catch: java.lang.Throwable -> L137
            ...
            L94:
                ...
                okio.Buffer r18 = r0.clone()     // Catch: java.lang.Throwable -> L109
                r19 = r5
            ...
            L11b:
                ...
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch: java.lang.Throwable -> L137
                okio.Buffer r9 = r0.buffer     // Catch: java.lang.Throwable -> L137
