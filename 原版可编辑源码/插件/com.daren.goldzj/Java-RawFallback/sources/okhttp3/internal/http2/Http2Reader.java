...
final class Http2Reader implements java.io.Closeable {
    ...
    Http2Reader(okio.BufferedSource r2, boolean r3) {
            ...
            okhttp3.internal.http2.Http2Reader$ContinuationSource r3 = r1.continuation
    ...
    private void readGoAway(okhttp3.internal.http2.Http2Reader.Handler r4, int r5, byte r6, int r7) throws java.io.IOException {
            r3 = this;
            r6 = 1
            r0 = 8
            r1 = 0
            ...
            int r2 = r2.readInt()
            int r5 = r5 - r0
            okhttp3.internal.http2.ErrorCode r0 = okhttp3.internal.http2.ErrorCode.fromHttp2(r2)
            if (r0 == 0) goto L2a
            okio.ByteString r6 = okio.ByteString.EMPTY
            if (r5 <= 0) goto L26
            okio.BufferedSource r6 = r3.source
            long r1 = (long) r5
            okio.ByteString r6 = r6.readByteString(r1)
        L26:
            r4.goAway(r7, r0, r6)
            return
        L2a:
    ...
    private void readRstStream(okhttp3.internal.http2.Http2Reader.Handler r3, int r4, byte r5, int r6) throws java.io.IOException {
            ...
            int r4 = r4.readInt()
            okhttp3.internal.http2.ErrorCode r1 = okhttp3.internal.http2.ErrorCode.fromHttp2(r4)
            if (r1 == 0) goto L17
            r3.rstStream(r6, r1)
            return
        L17:
    ...
    private void readSettings(okhttp3.internal.http2.Http2Reader.Handler r6, int r7, byte r8, int r9) throws java.io.IOException {
        ...
        Ld:
            ...
            java.io.IOException r6 = okhttp3.internal.http2.Http2.ioException(r7, r6)
            throw r6
        L16:
            int r8 = r7 % 6
            if (r8 != 0) goto L76
            okhttp3.internal.http2.Settings r8 = new okhttp3.internal.http2.Settings
            r8.<init>()
            r1 = 0
        L20:
            if (r1 >= r7) goto L72
    ...
    private void readWindowUpdate(okhttp3.internal.http2.Http2Reader.Handler r6, int r7, byte r8, int r9) throws java.io.IOException {
            r5 = this;
            r8 = 0
            r0 = 1
            r1 = 4
            if (r7 != r1) goto L29
            okio.BufferedSource r7 = r5.source
            int r7 = r7.readInt()
            long r1 = (long) r7
    ...
    public boolean nextFrame(boolean r7, okhttp3.internal.http2.Http2Reader.Handler r8) throws java.io.IOException {
            r6 = this;
            r0 = 0
            okio.BufferedSource r1 = r6.source     // Catch: java.io.IOException -> L96
            r2 = 9
    ...
    public void readConnectionPreface(okhttp3.internal.http2.Http2Reader.Handler r6) throws java.io.IOException {
        ...
        Ld:
            ...
            java.io.IOException r6 = okhttp3.internal.http2.Http2.ioException(r0, r6)
            throw r6
        L16:
