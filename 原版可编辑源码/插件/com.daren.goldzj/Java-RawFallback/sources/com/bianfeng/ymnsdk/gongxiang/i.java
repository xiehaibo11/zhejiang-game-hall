...
public final class i {
    ...
    public static void a(java.io.File r2, java.lang.String r3, java.util.Map<java.lang.String, java.lang.String> r4, boolean r5) throws java.io.IOException, com.bianfeng.ymnsdk.gongxiang.f {
            java.util.HashMap r0 = new java.util.HashMap
            r0.<init>()
            java.util.Map r1 = com.bianfeng.ymnsdk.gongxiang.c.b(r2)
            if (r1 == 0) goto Le
            r0.putAll(r1)
        Le:
