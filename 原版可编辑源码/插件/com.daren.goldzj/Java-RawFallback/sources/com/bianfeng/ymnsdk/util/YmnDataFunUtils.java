...
public class YmnDataFunUtils {
    ...
    public void initContext(android.content.Context r4) {
            ...
            r1.setPostUrl(r0)
        L30:
            com.bianfeng.ymnsdk.ymndatalib.YmnDatafunSdk r0 = com.bianfeng.ymnsdk.ymndatalib.YmnDatafunSdk.getInstance()
            r0.onInit(r4)
            return
    }

    public void initLogin(com.bianfeng.ymnsdk.feature.YmnPluginWrapper r5) {
            r4 = this;
            java.lang.String r0 = r5.getPluginId()     // Catch: java.lang.Exception -> L9
        ...
        L9:
            ...
            r0 = 0
        Le:
            com.bianfeng.ymnsdk.ymndatalib.YmnDatafunSdk r1 = com.bianfeng.ymnsdk.ymndatalib.YmnDatafunSdk.getInstance()     // Catch: java.lang.Exception -> L2f
            java.lang.String r2 = r5.getSdkVersion()     // Catch: java.lang.Exception -> L2f
            ...
            int r5 = r5.getPluginVersion()     // Catch: java.lang.Exception -> L2f
            r3.append(r5)     // Catch: java.lang.Exception -> L2f
            java.lang.String r5 = ""
            r3.append(r5)     // Catch: java.lang.Exception -> L2f
            java.lang.String r5 = r3.toString()     // Catch: java.lang.Exception -> L2f
            r1.setLoginPlatformInfo(r0, r2, r5)     // Catch: java.lang.Exception -> L2f
            goto L33
        L2f:
            r5 = move-exception
            r5.printStackTrace()
    ...
    public void loginFinishEvent(int r2, java.lang.String r3) {
            r1 = this;
            ...
            r0.loginFinishEvent(r2, r3)     // Catch: java.lang.Exception -> L10
            goto L14
        L10:
            r2 = move-exception
            r2.printStackTrace()
    ...
    public void loginNewResponseEvent(int r4, java.lang.String r5) {
            r3 = this;
        ...
        La:
            ...
            java.lang.Integer r1 = java.lang.Integer.valueOf(r4)     // Catch: java.lang.Exception -> L33
            ...
            java.lang.String r4 = r2.toString()     // Catch: java.lang.Exception -> L33
            r0.loginNewResponseEvent(r1, r4)     // Catch: java.lang.Exception -> L33
            goto L37
        L33:
            r4 = move-exception
            r4.printStackTrace()
    ...
    public void loginOldResponseEvent(int r5, java.lang.String r6) {
        ...
        Lc:
            ...
            r1.loginOldResponseEvent(r5, r6, r0, r0)     // Catch: java.lang.Exception -> L31
            goto L35
        L31:
            r5 = move-exception
            r5.printStackTrace()
    ...
    public void loginSdkReturn(int r3, java.lang.String r4) {
        ...
        Le:
            ...
            r0.loginSdkReturnEvent(r3, r4)     // Catch: java.lang.Exception -> L3a
            goto L3e
        L3a:
            r3 = move-exception
            r3.printStackTrace()
    ...
    public void loginStart(com.bianfeng.ymnsdk.feature.YmnPluginWrapper r2) {
            ...
            com.bianfeng.ymnsdk.util.Logger.i(r0)
            r1.initLogin(r2)
            com.bianfeng.ymnsdk.ymndatalib.YmnDatafunSdk r2 = com.bianfeng.ymnsdk.ymndatalib.YmnDatafunSdk.getInstance()     // Catch: java.lang.Exception -> L14
            com.bianfeng.ymnsdk.ymndatalib.bean.login.LoginEventMap r2 = r2.getLoginEvent()     // Catch: java.lang.Exception -> L14
            r2.loginStartEvent()     // Catch: java.lang.Exception -> L14
            goto L18
        L14:
            r2 = move-exception
            r2.printStackTrace()
    ...
    public void onCreate(android.content.Context r1) {
            r0 = this;
            java.lang.String r1 = "YmnDataFunUtils onCreate"
            com.bianfeng.ymnsdk.util.Logger.i(r1)     // Catch: java.lang.Exception -> L6
            goto La
        L6:
            r1 = move-exception
            r1.printStackTrace()
    ...
    public void payInit(com.bianfeng.ymnsdk.feature.YmnPluginWrapper r5) {
            r4 = this;
            java.lang.String r0 = r5.getPluginId()     // Catch: java.lang.Exception -> L9
            int r0 = java.lang.Integer.parseInt(r0)     // Catch: java.lang.Exception -> L9
            goto Le
        ...
        Le:
            ...
            r3.append(r5)     // Catch: java.lang.Exception -> L2f
            java.lang.String r5 = r3.toString()     // Catch: java.lang.Exception -> L2f
            r1.setPayPlatformInfo(r0, r2, r5)     // Catch: java.lang.Exception -> L2f
            goto L33
        L2f:
            r5 = move-exception
            r5.printStackTrace()
    ...
    public void payResponseNotity(int r4, java.lang.String r5) {
            r3 = this;
        ...
        Le:
            ...
            r0.payResponseNotityEvent(r1, r4)     // Catch: java.lang.Exception -> L32
            goto L36
        L32:
            r4 = move-exception
            r4.printStackTrace()
    ...
    public void payResponseNotity(int r4, java.lang.String r5, java.lang.String r6) {
            r3 = this;
            r0 = 200(0xc8, float:2.8E-43)
            if (r4 == r0) goto Ld
            r0 = 201(0xc9, float:2.82E-43)
        ...
        Le:
            ...
            java.lang.String r4 = r2.toString()     // Catch: java.lang.Exception -> L32
            r0.payResponseNotityEvent(r1, r5, r4)     // Catch: java.lang.Exception -> L32
            goto L36
        L32:
            r4 = move-exception
            r4.printStackTrace()
    ...
    public void payResponseOrder(int r4, java.lang.String r5, java.lang.String r6) {
            r3 = this;
        ...
        L9:
            ...
            r2.append(r5)     // Catch: java.lang.Exception -> L32
            java.lang.String r4 = r2.toString()     // Catch: java.lang.Exception -> L32
            r0.payResponseOrderEvent(r1, r4, r6)     // Catch: java.lang.Exception -> L32
            goto L36
        L32:
            r4 = move-exception
            r4.printStackTrace()
    ...
    public void paySdkReturn(int r3, java.lang.String r4) {
        ...
        L5:
            ...
            r0.paySdkReturnEvent(r3, r4)     // Catch: java.lang.Exception -> L31
            goto L35
        L31:
            r3 = move-exception
            r3.printStackTrace()
    ...
    public void pluginFinish(java.lang.String r10, java.lang.String r11, java.lang.String r12, java.lang.String r13, int r14, java.lang.String r15) {
            r9 = this;
            com.bianfeng.ymnsdk.ymndatalib.YmnDatafunSdk r0 = com.bianfeng.ymnsdk.ymndatalib.YmnDatafunSdk.getInstance()     // Catch: java.lang.Exception -> L13
            com.bianfeng.ymnsdk.ymndatalib.bean.plugin.PluginEventMap r1 = r0.getPluginEvent()     // Catch: java.lang.Exception -> L13
            java.lang.String r8 = ""
            r2 = r10
            r3 = r11
            r4 = r12
            ...
            r6 = r14
            r7 = r15
            r1.end(r2, r3, r4, r5, r6, r7, r8)     // Catch: java.lang.Exception -> L13
        L13:
            return
    }
    ...
    public void pluginStart(java.lang.String r8, java.lang.String r9, java.lang.String r10, java.lang.String r11) {
            r7 = this;
            com.bianfeng.ymnsdk.ymndatalib.YmnDatafunSdk r0 = com.bianfeng.ymnsdk.ymndatalib.YmnDatafunSdk.getInstance()     // Catch: java.lang.Exception -> L11
            com.bianfeng.ymnsdk.ymndatalib.bean.plugin.PluginEventMap r1 = r0.getPluginEvent()     // Catch: java.lang.Exception -> L11
            java.lang.String r6 = ""
            r2 = r8
            r3 = r9
            r4 = r10
            r5 = r11
            r1.start(r2, r3, r4, r5, r6)     // Catch: java.lang.Exception -> L11
        L11:
            return
    }
    ...
    public void pluginStart(java.lang.String r8, java.lang.String r9, java.lang.String r10, java.lang.String r11, java.lang.Object[] r12) {
            r7 = this;
            if (r12 == 0) goto L19
            int r0 = r12.length     // Catch: java.lang.Exception -> L1c
            if (r0 == 0) goto L19
            com.bianfeng.ymnsdk.ymndatalib.YmnDatafunSdk r0 = com.bianfeng.ymnsdk.ymndatalib.YmnDatafunSdk.getInstance()     // Catch: java.lang.Exception -> L1c
            com.bianfeng.ymnsdk.ymndatalib.bean.plugin.PluginEventMap r1 = r0.getPluginEvent()     // Catch: java.lang.Exception -> L1c
            java.lang.String r6 = java.util.Arrays.toString(r12)     // Catch: java.lang.Exception -> L1c
            r2 = r8
            r3 = r9
            r4 = r10
            r5 = r11
            r1.start(r2, r3, r4, r5, r6)     // Catch: java.lang.Exception -> L1c
            goto L1c
        L19:
            r7.pluginStart(r8, r9, r10, r11)     // Catch: java.lang.Exception -> L1c
        L1c:
            return
    }
}
