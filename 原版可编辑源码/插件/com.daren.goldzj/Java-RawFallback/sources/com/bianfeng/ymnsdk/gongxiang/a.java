...
public final class a {
    public static com.bianfeng.ymnsdk.gongxiang.d<java.nio.ByteBuffer, java.lang.Long> a(java.nio.channels.FileChannel r2) throws java.io.IOException, com.bianfeng.ymnsdk.gongxiang.f {
            long r0 = b(r2)
            com.bianfeng.ymnsdk.gongxiang.d r2 = a(r2, r0)
            return r2
    }

    public static com.bianfeng.ymnsdk.gongxiang.d<java.nio.ByteBuffer, java.lang.Long> a(java.nio.channels.FileChannel r7, long r8) throws java.io.IOException, com.bianfeng.ymnsdk.gongxiang.f {
            r0 = 32
            ...
            com.bianfeng.ymnsdk.gongxiang.d r7 = com.bianfeng.ymnsdk.gongxiang.d.a(r0, r7)
            return r7
        L7a:
            com.bianfeng.ymnsdk.gongxiang.f r7 = new com.bianfeng.ymnsdk.gongxiang.f
    ...
    private static java.nio.ByteBuffer a(java.nio.ByteBuffer r3, int r4) throws java.nio.BufferUnderflowException {
            if (r4 < 0) goto L2f
            int r0 = r3.limit()
            int r1 = r3.position()
            int r4 = r4 + r1
    ...
    private static java.nio.ByteBuffer a(java.nio.ByteBuffer r3, int r4, int r5) {
            if (r4 < 0) goto L7e
            if (r5 < r4) goto L5f
            int r0 = r3.capacity()
            int r1 = r3.capacity()
    ...
    private static void a(java.nio.ByteBuffer r1) {
    ...
    public static long b(java.nio.channels.FileChannel r3, long r4) throws java.io.IOException {
            r0 = 4
            java.nio.ByteBuffer r0 = java.nio.ByteBuffer.allocate(r0)
            java.nio.ByteOrder r1 = java.nio.ByteOrder.LITTLE_ENDIAN
            r0.order(r1)
    ...
    public static java.util.Map<java.lang.Integer, java.nio.ByteBuffer> b(java.nio.ByteBuffer r10) throws com.bianfeng.ymnsdk.gongxiang.f {
            a(r10)
            int r0 = r10.capacity()
            int r0 = r0 + (-24)
            r1 = 8
            java.nio.ByteBuffer r10 = a(r10, r1, r0)
        ...
        L15:
            ...
            int r4 = r4 + (-4)
            java.nio.ByteBuffer r4 = a(r10, r4)
            r0.put(r5, r4)
            r10.position(r3)
            goto L15
        L59:
            ...
            throw r0
        L80:
            com.bianfeng.ymnsdk.gongxiang.f r10 = new com.bianfeng.ymnsdk.gongxiang.f
            java.lang.StringBuilder r0 = new java.lang.StringBuilder
            r0.<init>()
            r0.append(r8)
            r0.append(r2)
    ...
    public static long c(java.nio.channels.FileChannel r11) throws java.io.IOException {
            long r0 = r11.size()
            r2 = 22
