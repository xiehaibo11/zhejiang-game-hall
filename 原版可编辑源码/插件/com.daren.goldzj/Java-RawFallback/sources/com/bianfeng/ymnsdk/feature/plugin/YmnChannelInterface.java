...
public abstract class YmnChannelInterface extends com.bianfeng.ymnsdk.feature.YmnPluginWrapper implements com.bianfeng.ymnsdk.feature.protocol.IUserFeature, com.bianfeng.ymnsdk.feature.protocol.IPaymentFeature, com.bianfeng.ymnsdk.YmnCode {
    ...
    public float getOrderTotalPrice(java.util.Map<java.lang.String, java.lang.String> r4) {
            ...
            java.lang.Object r1 = r4.get(r1)     // Catch: com.bianfeng.ymnsdk.util.exception.YmnsdkException -> L23
            java.lang.String r1 = (java.lang.String) r1     // Catch: com.bianfeng.ymnsdk.util.exception.YmnsdkException -> L23
            boolean r2 = com.bianfeng.ymnsdk.util.thridsdk.YmnGsonUtil.isJsonObject(r1)     // Catch: com.bianfeng.ymnsdk.util.exception.YmnsdkException -> L23
            if (r2 == 0) goto L27
            ...
            java.lang.Object r1 = com.bianfeng.ymnsdk.util.thridsdk.YmnGsonUtil.fromJson(r1, r2)     // Catch: com.bianfeng.ymnsdk.util.exception.YmnsdkException -> L23
            com.bianfeng.ymnsdk.entity.PlatformCallbackEntity r1 = (com.bianfeng.ymnsdk.entity.PlatformCallbackEntity) r1     // Catch: com.bianfeng.ymnsdk.util.exception.YmnsdkException -> L23
            float r1 = r1.getTotal_fee()     // Catch: com.bianfeng.ymnsdk.util.exception.YmnsdkException -> L23
            r2 = 0
        ...
        L23:
            ...
            r1.printStackTrace()
        L27:
            boolean r1 = com.bianfeng.ymnsdk.util.YmnsdkTypeUtils.isNewTrade()     // Catch: java.lang.Exception -> L62
            java.lang.String r2 = "product_price"
            if (r1 == 0) goto L49
            java.lang.Object r1 = r4.get(r2)     // Catch: java.lang.Exception -> L62
            java.lang.String r1 = (java.lang.String) r1     // Catch: java.lang.Exception -> L62
            float r1 = java.lang.Float.parseFloat(r1)     // Catch: java.lang.Exception -> L62
            ...
            float r4 = java.lang.Float.parseFloat(r4)     // Catch: java.lang.Exception -> L62
            float r1 = r1 * r4
            float r1 = r1 / r0
            return r1
        L49:
            java.lang.Object r0 = r4.get(r2)     // Catch: java.lang.Exception -> L62
            java.lang.String r0 = (java.lang.String) r0     // Catch: java.lang.Exception -> L62
            float r0 = java.lang.Float.parseFloat(r0)     // Catch: java.lang.Exception -> L62
            java.lang.String r1 = "product_count"
            java.lang.Object r4 = r4.get(r1)     // Catch: java.lang.Exception -> L62
            java.lang.String r4 = (java.lang.String) r4     // Catch: java.lang.Exception -> L62
            float r4 = java.lang.Float.parseFloat(r4)     // Catch: java.lang.Exception -> L62
            float r0 = r0 * r4
            return r0
