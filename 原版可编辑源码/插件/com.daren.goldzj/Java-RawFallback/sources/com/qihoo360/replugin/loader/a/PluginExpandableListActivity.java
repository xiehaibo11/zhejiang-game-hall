...
public abstract class PluginExpandableListActivity extends android.app.ExpandableListActivity {
    private library.e a;

    public PluginExpandableListActivity() {
            r0 = this;
            r0.<init>()
            return
    }
    ...
    protected void onRestoreInstanceState(android.os.Bundle r3) {
        ...
        L7:
            ...
            java.lang.String r1 = "PluginExpandableListActivity"
