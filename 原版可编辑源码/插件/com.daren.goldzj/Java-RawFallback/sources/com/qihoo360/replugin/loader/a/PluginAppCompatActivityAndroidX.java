...
public abstract class PluginAppCompatActivityAndroidX extends androidx.appcompat.app.AppCompatActivity {
    private library.e a;

    public PluginAppCompatActivityAndroidX() {
            r0 = this;
            r0.<init>()
            return
    }
    ...
    protected void onRestoreInstanceState(android.os.Bundle r3) {
        ...
        L7:
            ...
            java.lang.String r1 = "PluginAppCompatActivityAndroidX"
    ...
    public void startActivityFromFragment(androidx.fragment.app.Fragment r5, android.content.Intent r6, int r7) {
            r4 = this;
            r0 = -1
            if (r7 != r0) goto L7
        L3:
