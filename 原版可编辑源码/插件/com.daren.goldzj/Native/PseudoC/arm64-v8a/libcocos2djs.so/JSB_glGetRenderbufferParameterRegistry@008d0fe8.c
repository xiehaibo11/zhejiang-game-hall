...
/* JSB_glGetRenderbufferParameterRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glGetRenderbufferParameterRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if ((plVar7[1] - *plVar7 & 0xffffffff0U) == 0x20) {
    ...
    if ((uVar4 & uVar5 & 1) != 0) {
      glGetRenderbufferParameteriv(uStack_64,local_68,&local_6c);
      iVar3 = local_6c;
