...
/* v8::internal::interpreter::BytecodeArrayBuilder::LoadTrue() */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::LoadTrue(BytecodeArrayBuilder *this)
