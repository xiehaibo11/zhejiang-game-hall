...
/* void 
   v8::internal::JSTypedArray::BodyDescriptor::IterateBody<v8::internal::IterateAndScavengePromotedObjectsVisitor>(v8::internal::Map,
    ...
    while( true ) {
      if ((uVar2 & 1) != 0) {
        ...
        if ((*(byte *)(uVar4 + 8) >> 3 & 1) == 0) {
          if (((char)param_4[2] != '\0') && ((*(byte *)(uVar4 + 8) >> 6 & 1) != 0)) {
      ...
      puVar1 = puVar1 + 1;
      if ((uint *)(param_2 + 0xf) <= puVar1) break;
      uVar2 = *puVar1;
    }
  }
  (**(code **)(*param_4 + 0x10))(param_4,param_2,param_2 + 0x2f,param_2 + 0x33);
  BodyDescriptorBase::
