...
/* v8::internal::compiler::EffectControlLinearizer::LowerConvertTaggedHoleToUndefined(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerConvertTaggedHoleToUndefined
...

{
  ...
  pNVar2 = (Node *)GraphAssembler::TaggedEqual(this_00,pNVar4,pNVar2);
  ...
  *(undefined8 *)(this + 0x60) = 0;
  ...
  uVar3 = GraphAssembler::UndefinedConstant(this_00);
  GraphAssembler::MergeState<v8::internal::TNode<v8::internal::Oddball>>(this_00,local_c0,uVar3);
  GraphAssembler::GotoBasicBlock(this_00,local_b8);
  *(undefined8 *)(this + 0x58) = 0;
  *(undefined8 *)(this + 0x60) = 0;
