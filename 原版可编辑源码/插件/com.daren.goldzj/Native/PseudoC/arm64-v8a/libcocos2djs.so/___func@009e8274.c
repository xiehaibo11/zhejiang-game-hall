...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void
   ...
   (cocos2d::network::SIOClientImpl::*)(float), cocos2d::network::SIOClientImpl*,
   std::__ndk1::placeholders::__ph<1> const&> >, void (float)>::~__func() */
...
::~__func(__func<std::__ndk1::__bind<void(cocos2d::network::SIOClientImpl::*)(float),cocos2d::network::SIOClientImpl*,std::__ndk1::placeholders::__ph<1>const&>,std::__ndk1::allocator<std::__ndk1::__bind<void(cocos2d::network::SIOClientImpl::*)(float),cocos2d::network::SIOClientImpl*,std::__ndk1::placeholders::__ph<1>const&>>,void(float)>
          *this)
