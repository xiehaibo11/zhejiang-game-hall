...
/* v8::internal::Worklist<v8::internal::Ephemeron, 64>::FlushToGlobal(int) */

void __thiscall
v8::internal::Worklist<v8::internal::Ephemeron,64>::FlushToGlobal
          (Worklist<v8::internal::Ephemeron,64> *this,int param_1)
