...
/* void std::__ndk1::vector<cocos2d::Ref*, std::__ndk1::allocator<cocos2d::Ref*>
   >::__push_back_slow_path<cocos2d::Ref* const&>(cocos2d::Ref* const&) */

void __thiscall
std::__ndk1::vector<cocos2d::Ref*,std::__ndk1::allocator<cocos2d::Ref*>>::
__push_back_slow_path<cocos2d::Ref*const&>
          (vector<cocos2d::Ref*,std::__ndk1::allocator<cocos2d::Ref*>> *this,Ref **param_1)
