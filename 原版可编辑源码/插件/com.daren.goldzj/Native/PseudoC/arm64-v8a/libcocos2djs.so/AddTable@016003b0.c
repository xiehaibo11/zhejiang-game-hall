...
v8::internal::wasm::WasmModuleBuilder::AddTable
          (WasmModuleBuilder *this,undefined1 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (puVar3 < *(undefined1 **)(this + 0xb8)) {
    ...
    *(undefined4 *)(puVar3 + 8) = param_4;
    puVar3[0xc] = 1;
    puVar3[3] = local_42;
    *(undefined2 *)(puVar3 + 1) = local_44;
    puVar3[0xf] = local_46;
    *(undefined2 *)(puVar3 + 0xd) = local_48;
    ...
    *(undefined4 *)(puVar5 + 8) = param_4;
    puVar5[0xc] = 1;
    puVar5[3] = local_42;
    *(undefined2 *)(puVar5 + 1) = local_44;
    puVar5[0xf] = local_46;
    *(undefined2 *)(puVar5 + 0xd) = local_48;
