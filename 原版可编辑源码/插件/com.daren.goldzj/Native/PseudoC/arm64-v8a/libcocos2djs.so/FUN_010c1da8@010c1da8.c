...
void FUN_010c1da8(undefined8 param_1,ulong param_2,ulong param_3,long param_4,long param_5)

{
  ...
  default:
    ...
    FUN_010c2030();
    param_5 = extraout_x8;
switchD_010c1e1c_caseD_17:
    if (param_5 != 0) {
      FUN_010c2058();
      param_5 = extraout_x8_00;
switchD_010c1e1c_caseD_15:
      if (param_5 != 0) {
        FUN_010c2044();
        param_2 = extraout_x1;
        param_5 = extraout_x8_01;
        puVar2 = extraout_x9;
switchD_010c1e1c_caseD_1a:
        if (param_5 != 0) {
          puVar3 = (undefined8 *)
    ...
    return;
  case 0x15:
    goto switchD_010c1e1c_caseD_15;
  case 0x17:
  case 0x18:
    goto switchD_010c1e1c_caseD_17;
  case 0x1a:
    goto switchD_010c1e1c_caseD_1a;
  case 0x1b:
    if (param_5 == 0) {
      return;
    }
