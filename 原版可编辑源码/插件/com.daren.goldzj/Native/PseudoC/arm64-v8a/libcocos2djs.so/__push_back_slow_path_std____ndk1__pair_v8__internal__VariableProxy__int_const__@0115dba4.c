...
/* void std::__ndk1::vector<std::__ndk1::pair<v8::internal::VariableProxy*, int>,
   std::__ndk1::allocator<std::__ndk1::pair<v8::internal::VariableProxy*, int> >
   >::__push_back_slow_path<std::__ndk1::pair<v8::internal::VariableProxy*, int>
   const&>(std::__ndk1::pair<v8::internal::VariableProxy*, int> const&) */
...

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_0115dc90;
