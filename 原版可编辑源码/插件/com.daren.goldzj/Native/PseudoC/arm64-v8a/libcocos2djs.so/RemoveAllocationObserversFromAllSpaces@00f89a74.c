...
/* v8::internal::Heap::RemoveAllocationObserversFromAllSpaces(v8::internal::AllocationObserver*,
   v8::internal::AllocationObserver*) */

void __thiscall
v8::internal::Heap::RemoveAllocationObserversFromAllSpaces
...

{
  ...
  (**(code **)(*plVar2 + 0x18))(plVar2,pAVar1);
  ...
  if (plVar2 != *(long **)(this + 0xe8)) {
    param_2 = param_1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00f89b5c. Too many branches */
