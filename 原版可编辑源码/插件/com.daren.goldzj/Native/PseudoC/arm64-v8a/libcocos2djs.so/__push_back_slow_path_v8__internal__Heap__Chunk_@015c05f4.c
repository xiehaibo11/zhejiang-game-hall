...
/* void std::__ndk1::vector<v8::internal::Heap::Chunk,
   std::__ndk1::allocator<v8::internal::Heap::Chunk>
   >::__push_back_slow_path<v8::internal::Heap::Chunk>(v8::internal::Heap::Chunk&&) */

void __thiscall
std::__ndk1::vector<v8::internal::Heap::Chunk,std::__ndk1::allocator<v8::internal::Heap::Chunk>>::
__push_back_slow_path<v8::internal::Heap::Chunk>
          (vector<v8::internal::Heap::Chunk,std::__ndk1::allocator<v8::internal::Heap::Chunk>> *this
          ,Chunk *param_1)

{
  ...
  if (uVar1 < 0xaaaaaaaaaaaaaab) {
    ...
    if (uVar1 == 0) {
      ...
      if (0xaaaaaaaaaaaaaaa < uVar1) goto LAB_015c0700;
