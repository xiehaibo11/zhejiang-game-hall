...
/* v8::internal::compiler::JSNativeContextSpecialization::ReduceJSStoreDataPropertyInLiteral(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::JSNativeContextSpecialization::ReduceJSStoreDataPropertyInLiteral
