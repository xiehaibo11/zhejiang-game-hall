...

{
  ...
  *(undefined1 *)(puVar7 + 1) = uVar8;
  uVar11 = (ulong)(*(uint *)(param_3 + 8) >> 9) & 1;
  uVar1 = uVar11 + 0x17;
  lVar5 = -((ulong)((int)uVar1 + 0xf) & 0x70);
  pcVar9 = (char *)((long)&uStack_90 + lVar5);
  if (((DAT_01d52dc8 & 1) == 0) && (iVar6 = __cxa_guard_acquire(&DAT_01d52dc8), iVar6 != 0)) {
    DAT_01d52dc0 = newlocale(0x1fbf,"C",(__locale_t)0x0);
    __cxa_guard_release(&DAT_01d52dc8);
  }
  iVar6 = __libcpp_snprintf_l(pcVar9,uVar1,(__locale_t *)DAT_01d52dc0,(char *)&local_70,param_5);
  ...
  __num_put<wchar_t>::__widen_and_group_int
            (pcVar9,pcVar10,pcVar9 + iVar6,
             (wchar_t *)
             (pcVar9 + -((ulong)(((int)uVar11 << 1 | 0x2cU) - 1) * 4 + 0xf & 0x7fffffff0)),
             &pwStack_78,&local_80,(locale *)&local_88);
  __shared_count::__release_shared(local_88);
  FUN_01804780(param_2,pcVar9 + -((ulong)(((int)uVar11 << 1 | 0x2cU) - 1) * 4 + 0xf & 0x7fffffff0),
               pwStack_78,local_80,param_3,param_4);
