...
/* v8::internal::compiler::Operator1<char const*, v8::internal::compiler::OpEqualTo<char const*>,
   v8::internal::compiler::OpHash<char const*> >::PrintToImpl(std::__ndk1::basic_ostream<char,
...
::PrintToImpl(Operator1<char_const*,v8::internal::compiler::OpEqualTo<char_const*>,v8::internal::compiler::OpHash<char_const*>>
...

{
  ...
  std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>(param_1,__s,sVar1);
                    /* WARNING: Could not recover jumptable at 0x01791530. Too many branches */
