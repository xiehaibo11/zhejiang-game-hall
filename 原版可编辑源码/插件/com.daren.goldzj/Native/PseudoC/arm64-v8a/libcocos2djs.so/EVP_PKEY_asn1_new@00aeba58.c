  ...
  *(long *)(ptr + 8) = (long)(int)(flags | 2);
  if (info != (char *)0x0) {
    ...
    *(char **)(ptr + 0x18) = pcVar1;
    if (pcVar1 == (char *)0x0) goto LAB_00aebae8;
  }
  if (pem_str == (char *)0x0) {
    return ptr;
  }
...
LAB_00aebae8:
                    /* try { // try from 00aebaec to 00bebc47 has its CatchHandler @ 00aebaec
                       catch() { ... } // from try @ 00aebaec with catch @ 00aebaec
                       catch() { ... } // from try @ 00aebc58 with catch @ 00aebaec
                       catch() { ... } // from try @ 00aebde8 with catch @ 00aebaec */
  if (((byte)ptr[8] >> 1 & 1) != 0) {
