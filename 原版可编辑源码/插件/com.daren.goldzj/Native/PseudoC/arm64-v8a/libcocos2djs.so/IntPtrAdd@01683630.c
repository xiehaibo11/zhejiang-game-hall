...
/* v8::internal::compiler::CodeAssembler::IntPtrAdd(v8::internal::SloppyTNode<v8::internal::WordT>,
   v8::internal::SloppyTNode<v8::internal::WordT>) */

long * __thiscall
v8::internal::compiler::CodeAssembler::IntPtrAdd(CodeAssembler *this,Node *param_2,long *param_3)
...
LAB_016836a4:
  ...
  if (uVar1 == 0x18) {
    ...
    bVar4 = 1;
joined_r0x01683714:
    if (!bVar2) goto LAB_01683718;
LAB_01683734:
    if (bVar3) {
      this_00 = (RawMachineAssembler *)**(undefined8 **)this;
      pOVar5 = (Operator *)
               CommonOperatorBuilder::Int64Constant
                         ((CommonOperatorBuilder *)(this_00 + 0x48),lVar11 + lVar9);
      iVar7 = 0;
      ppNVar8 = (Node **)0x0;
      goto LAB_01683788;
    }
    ...
    if (uVar1 != 0x17) {
      bVar3 = false;
      bVar4 = 0;
      goto joined_r0x01683714;
    }
    lVar11 = (long)*(int *)(lVar11 + 0x2c);
    bVar3 = true;
    bVar4 = 1;
    if (bVar2) goto LAB_01683734;
LAB_01683718:
  ...
  this_00 = (RawMachineAssembler *)**(undefined8 **)this;
  pOVar5 = (Operator *)MachineOperatorBuilder::Int64Add((MachineOperatorBuilder *)(this_00 + 0x20));
  iVar7 = 2;
  local_40 = param_2;
  plStack_38 = param_3;
LAB_01683788:
