...
/* void JSBClassType::registerClass<dragonBones::ArmatureCacheMgr>(se::Class*) */

void JSBClassType::registerClass<dragonBones::ArmatureCacheMgr>(Class *param_1)
