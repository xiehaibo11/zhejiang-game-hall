...
/* void std::__ndk1::vector<dragonBones::ArmatureCache::BoneData*,
   std::__ndk1::allocator<dragonBones::ArmatureCache::BoneData*>
   >::__push_back_slow_path<dragonBones::ArmatureCache::BoneData*
   const&>(dragonBones::ArmatureCache::BoneData* const&) */
...
LAB_00d55020:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d55020;
  }
  else {
