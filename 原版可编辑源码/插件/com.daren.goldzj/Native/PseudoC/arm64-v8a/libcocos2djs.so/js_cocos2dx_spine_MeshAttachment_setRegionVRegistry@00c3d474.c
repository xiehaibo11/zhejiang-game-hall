...
/* js_cocos2dx_spine_MeshAttachment_setRegionVRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_MeshAttachment_setRegionVRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (MeshAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x184c,"js_cocos2dx_spine_MeshAttachment_setRegionV");
    pcVar6 = "js_cocos2dx_spine_MeshAttachment_setRegionV : Invalid Native Object";
LAB_00c3d5e8:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::MeshAttachment::setRegionV(this,local_64);
        goto LAB_00c3d620;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1853,"js_cocos2dx_spine_MeshAttachment_setRegionV");
      pcVar6 = "js_cocos2dx_spine_MeshAttachment_setRegionV : Error processing arguments";
      goto LAB_00c3d5e8;
    }
    __android_log_print(6,"jswrapper",&DAT_01905b54,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_MeshAttachment_setRegionV",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x185a);
LAB_00c3d620:
