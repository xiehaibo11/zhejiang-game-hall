...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitCallProperty1(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::VisitCallProperty1
...

{
  ...
  if ((uVar3 & 1) == 0) {
    ...
    if ((uVar3 & 1) == 0) {
      local_60[0] = CONCAT44(local_60[0]._4_4_,local_28[0]);
      if (local_28[0] < 0) {
        uVar1 = interpreter::Register::ToParameterIndex((Register *)local_60,*(int *)(lVar5 + 0x18))
        ;
        lVar6 = *(long *)(lVar5 + 0x30);
      }
      else {
        uVar1 = *(int *)(lVar5 + 0x18) + local_28[0];
        lVar6 = *(long *)(lVar5 + 0x30);
      }
      if ((-1 < (int)uVar1) && ((ulong)(*(long *)(lVar5 + 0x38) - lVar6 >> 3) <= (ulong)uVar1))
      goto LAB_012c2788;
      puVar7 = (undefined8 *)(lVar6 + (long)(int)uVar1 * 8);
    }
    else {
  ...
  if ((uVar3 & 1) == 0) {
    ...
    if ((uVar3 & 1) == 0) {
      local_60[0] = CONCAT44(local_60[0]._4_4_,local_28[0]);
      if (local_28[0] < 0) {
        uVar1 = interpreter::Register::ToParameterIndex((Register *)local_60,*(int *)(lVar6 + 0x18))
        ;
        lVar4 = *(long *)(lVar6 + 0x30);
      }
      else {
        uVar1 = *(int *)(lVar6 + 0x18) + local_28[0];
        lVar4 = *(long *)(lVar6 + 0x30);
      }
...
LAB_012c2788:
  ...
  uVar2 = interpreter::BytecodeArrayAccessor::GetSlotOperand((BytecodeArrayAccessor *)param_1,3);
  ...
  FUN_012cf738(lVar4,local_60,lVar5,lVar6);
  ProcessCallOrConstruct(this,*puVar7,0,0,local_60,uVar2,0);
  return;
}
