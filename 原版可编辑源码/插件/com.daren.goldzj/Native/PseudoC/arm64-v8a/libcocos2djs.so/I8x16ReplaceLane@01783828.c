...
/* v8::internal::compiler::MachineOperatorBuilder::I8x16ReplaceLane(int) */

Operator * __thiscall
v8::internal::compiler::MachineOperatorBuilder::I8x16ReplaceLane
...

{
  ...
  Operator::Operator(pOVar1,0x282,0x7c,"Replace lane",2,0,0,1,0,0);
