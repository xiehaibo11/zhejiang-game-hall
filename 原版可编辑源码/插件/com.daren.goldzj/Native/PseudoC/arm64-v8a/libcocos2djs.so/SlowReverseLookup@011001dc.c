...
/* v8::internal::Dictionary<v8::internal::NumberDictionary,
   v8::internal::NumberDictionaryShape>::SlowReverseLookup(v8::internal::Object) */

ulong __thiscall
v8::internal::Dictionary<v8::internal::NumberDictionary,v8::internal::NumberDictionaryShape>::
SlowReverseLookup(Dictionary<v8::internal::NumberDictionary,v8::internal::NumberDictionaryShape>
                  *this,int param_2)
