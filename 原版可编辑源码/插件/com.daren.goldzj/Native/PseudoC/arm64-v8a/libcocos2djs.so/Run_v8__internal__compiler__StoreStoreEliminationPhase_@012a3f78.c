...
/* void 
   v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::StoreStoreEliminationPhase>()
    */
...

{
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFStoreStoreElimination");
  StoreStoreEliminationPhase::Run(aSStack_18,pPVar5,pZVar2);
