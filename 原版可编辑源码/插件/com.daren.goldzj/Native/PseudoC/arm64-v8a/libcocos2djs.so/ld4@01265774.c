...
/* v8::internal::Assembler::ld4(v8::internal::VRegister const&, v8::internal::VRegister const&,
   v8::internal::VRegister const&, v8::internal::VRegister const&, int, v8::internal::MemOperand
   const&) */

void v8::internal::Assembler::ld4
...

{
  ...
  if (iVar2 - 1U < 4) {
    uVar4 = *(uint *)(&DAT_019f35e0 + (long)(int)(iVar2 - 1U) * 4);
  }
  else {
    uVar4 = 0xd60a400;
  }
