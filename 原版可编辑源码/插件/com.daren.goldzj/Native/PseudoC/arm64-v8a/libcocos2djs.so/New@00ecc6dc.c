...
/* v8::SharedArrayBuffer::New(v8::Isolate*, std::__ndk1::shared_ptr<v8::BackingStore>) */

undefined8 v8::SharedArrayBuffer::New(Factory *param_1,long *param_2)

{
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_70,(ulong)&local_70 | 8,0x3d1);
  }
  this = *(Logger **)(param_1 + 0x9558);
  uVar7 = internal::Logger::is_logging(this);
  if ((uVar7 & 1) != 0) {
    internal::Logger::ApiEntryCall(this,"v8::SharedArrayBuffer::New");
  }
...
LAB_00ecc7fc:
  local_80 = lVar10;
  local_78 = p_Var2;
  uVar8 = internal::Factory::NewJSSharedArrayBuffer(param_1,&local_80);
  p_Var2 = local_78;
