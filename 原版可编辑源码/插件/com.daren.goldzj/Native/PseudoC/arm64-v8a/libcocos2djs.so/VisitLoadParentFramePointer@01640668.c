...
/* v8::internal::compiler::InstructionSelector::VisitLoadParentFramePointer(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::InstructionSelector::VisitLoadParentFramePointer
...

{
  ...
  local_18 = (ulong)uVar1 << 3 | 0xd800000001;
  *(ulong *)(*(long *)(this + 0xb8) + uVar2) =
       *(ulong *)(*(long *)(this + 0xb8) + uVar2) | 1L << (uVar3 & 0x3f);
  ...
  Instruction::Instruction
            (this_01,0x19,1,(InstructionOperand *)&local_18,0,(InstructionOperand *)0x0,0,
