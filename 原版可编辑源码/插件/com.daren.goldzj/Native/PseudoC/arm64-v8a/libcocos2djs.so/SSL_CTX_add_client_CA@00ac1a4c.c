...

{
  ...
  X509_NAME *pXVar3;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ac1664 with catch @ 00ac1a50
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ac18ec with catch @ 00ac1a54
                        */
  if (x != (X509 *)0x0) {
    if (ctx->comp_methods == (stack_st_SSL_COMP *)0x0) {
      psVar2 = (stack_st_SSL_COMP *)OPENSSL_sk_new_null();
      ctx->comp_methods = psVar2;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ac1784 with catch @ 00ac1a74
                        */
