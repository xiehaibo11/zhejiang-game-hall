...
/* spine::Vector<spine::IkConstraintData*>::~Vector() */

void __thiscall
spine::Vector<spine::IkConstraintData*>::~Vector(Vector<spine::IkConstraintData*> *this)

{
  ...
  *(undefined ***)this = &PTR__Vector_01c8d2e8;
  *(undefined8 *)(this + 8) = 0;
  if (lVar2 != 0) {
