...
/* v8::internal::compiler::OperationTyper::SpeculativeNumberSubtract(v8::internal::compiler::Type,
   v8::internal::compiler::Type) */

void __thiscall
v8::internal::compiler::OperationTyper::SpeculativeNumberSubtract
...

{
  ...
  NumberSubtract(this,uVar1,uVar2);
  return;
}
