...
undefined8 FUN_010b8210(undefined8 param_1,ulong *param_2,ulong *param_3,ulong param_4,long param_5)

{
  ...
  if (param_4 == 0) goto LAB_010b83d0;
  uVar7 = *param_2;
  if ((uVar7 & 1) != 0) {
    ...
    if (*(short *)((uVar9 | 7) + (ulong)*(uint *)(uVar7 - 1)) == 0x41b) {
      if ((((byte)(*(byte *)((uVar9 | 10) + (ulong)*(uint *)(uVar7 - 1)) >> 3 | 1) != 0x1b) &&
        ...
        FUN_0107d368(uVar7,uVar8,param_4,param_5);
        goto LAB_010b83d0;
      }
    }
...
joined_r0x010b84c0:
          if (param_4 <= uVar9) {
            uVar8 = FUN_0107a110(*(undefined8 *)(this + 0x2bc8),uVar7,uVar8,param_4,param_5);
            if ((uVar8 & 1) != 0) goto LAB_010b83d0;
  ...
  do {
    ...
    uVar2 = FUN_010b8cdc(*puVar3);
    *(undefined4 *)(lVar10 + (ulong)uVar1 + param_5 * 4 + uVar8 * 4) = uVar2;
    uVar8 = uVar8 + 1;
  } while (param_4 != uVar8);
LAB_010b83d0:
