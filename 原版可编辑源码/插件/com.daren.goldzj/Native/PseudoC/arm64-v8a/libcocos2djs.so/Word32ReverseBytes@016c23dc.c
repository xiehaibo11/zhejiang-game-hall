...
/* v8::internal::compiler::GraphAssembler::Word32ReverseBytes(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Word32ReverseBytes(GraphAssembler *this,Node *param_1)
