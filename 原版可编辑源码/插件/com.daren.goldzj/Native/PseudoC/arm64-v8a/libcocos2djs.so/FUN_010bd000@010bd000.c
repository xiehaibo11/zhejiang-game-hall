...
undefined8
FUN_010bd000(undefined8 param_1,Isolate *param_2,ulong *param_3,ulong *param_4,uint param_5,
...

{
  ...
  if ((param_7 >> 2 & 1) == 0) {
    ...
    if (((*(uint *)((uVar9 & 0xffffffff00000000 | (ulong)*(uint *)(uVar9 + 0xb)) + 0x1b) >> 2 & 1)
      ...
      uVar10 = 0;
      while( true ) {
        puVar2 = (ulong *)v8::internal::Factory::NewNumber<(v8::internal::AllocationType)0>
                                    ((Factory *)(uVar9 & 0xffffffff00000000),
                                     *(double *)
                                      (*(long *)(uVar9 + 0x27) + (ulong)*(uint *)(uVar9 + 0x2f) +
                                      uVar10 * 8));
        if ((param_5 & 1) != 0) {
