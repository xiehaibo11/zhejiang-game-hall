...
/* void std::__ndk1::vector<v8::HeapStatsUpdate, std::__ndk1::allocator<v8::HeapStatsUpdate>
   >::__emplace_back_slow_path<unsigned int, unsigned int&, unsigned int&>(unsigned int&&, unsigned
   int&, unsigned int&) */
...
__emplace_back_slow_path<unsigned_int,unsigned_int&,unsigned_int&>
          (vector<v8::HeapStatsUpdate,std::__ndk1::allocator<v8::HeapStatsUpdate>> *this,
...

{
  ...
  if (uVar1 < 0x1555555555555556) {
    ...
    if (uVar1 == 0) {
      ...
      if (0x1555555555555555 < uVar1) goto LAB_011aac90;
