...
/* cocos2d::AudioDecoder::start() */

undefined8 __thiscall cocos2d::AudioDecoder::start(AudioDecoder *this)
  ...
  if ((uVar2 & 1) == 0) {
    if (((byte)this[8] & 1) == 0) {
      pAVar6 = this + 9;
                    ...
                    /* try { // try from 00a99d98 to 00b99e53 has its CatchHandler @ 00a99d98
                       catch() { ... } // from try @ 00a99d98 with catch @ 00a99d98
                       catch() { ... } // from try @ 00a99ec8 with catch @ 00a99d98 */
    ...
    if ((uVar2 & 1) != 0) {
      ...
      if (((byte)*pAVar6 & 1) == 0) {
        ...
        pAVar6 = *(AudioDecoder **)(this + 0x18);
                    ...
                    /* try { // try from 00a99e54 to 00b99e77 has its CatchHandler @ 00a99f60 */
      __android_log_print((double)((float)((lVar3 - lVar1) / 1000) / 1000.0),3,"AudioDecoder",
