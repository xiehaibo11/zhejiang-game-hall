...
/* v8::internal::compiler::EffectControlLinearizer::LowerChangeTaggedToInt64(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerChangeTaggedToInt64
...

{
  ...
  if (*(char *)(*(long *)(*(long *)this + 0x10) + 0x10) == '\x05') {
    ...
    *(undefined8 *)(this + 0x60) = 0;
    ...
    pNVar4 = (Node *)GraphAssembler::ChangeFloat64ToInt64(this_00,pNVar4);
