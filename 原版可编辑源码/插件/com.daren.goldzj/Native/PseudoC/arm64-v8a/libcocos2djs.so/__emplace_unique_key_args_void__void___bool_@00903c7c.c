...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<void*,
   bool>, void*>*>, bool> std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<void*, bool>,
   ...
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<void*, bool> >
   >::__emplace_unique_key_args<void*, void*&, bool>(void* const&, void*&, bool&&) */
...
::__emplace_unique_key_args<void*,void*&,bool>
          (__hash_table<std::__ndk1::__hash_value_type<void*,bool>,std::__ndk1::__unordered_map_hasher<void*,std::__ndk1::__hash_value_type<void*,bool>,std::__ndk1::hash<void*>,true>,std::__ndk1::__unordered_map_equal<void*,std::__ndk1::__hash_value_type<void*,bool>,std::__ndk1::equal_to<void*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<void*,bool>>>
           *this,void **param_1,void **param_2,bool *param_3)

{
  ...
  *p_Var6;
  ...
  pvVar4 = *param_1;
  uVar9 = (((ulong)pvVar4 & 0x1fffffff) * 8 + 8 ^ (ulong)pvVar4 >> 0x20) * -0x622015f714c7d297;
  uVar12 = *(ulong *)(this + 8);
  uVar9 = (uVar9 ^ (ulong)pvVar4 >> 0x20 ^ uVar9 >> 0x2f) * -0x622015f714c7d297;
  ...
  if (uVar12 != 0) {
    ...
    if (plVar11 != (long *)0x0) {
      do {
        ...
        if (plVar11 == (long *)0x0) goto LAB_00903d70;
        uVar10 = plVar11[1];
        if (uVar10 != uVar9) {
          if ((uVar7 & uVar12) == 0) {
            uVar10 = uVar10 & uVar7;
            ...
            if (uVar10 - uVar2 * uVar12 == unaff_x25) goto LAB_00903d5c;
            goto LAB_00903d70;
          }
          if (uVar10 != unaff_x25) goto LAB_00903d70;
        }
LAB_00903d5c:
      } while ((void *)plVar11[2] != pvVar4);
      uVar3 = 0;
      goto LAB_00903e98;
    }
  }
