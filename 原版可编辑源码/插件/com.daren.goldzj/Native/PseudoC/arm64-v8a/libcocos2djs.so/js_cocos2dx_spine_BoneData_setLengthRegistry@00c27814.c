...
/* js_cocos2dx_spine_BoneData_setLengthRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_BoneData_setLengthRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (BoneData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xc32,"js_cocos2dx_spine_BoneData_setLength");
    pcVar6 = "js_cocos2dx_spine_BoneData_setLength : Invalid Native Object";
LAB_00c27988:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::BoneData::setLength(this,local_64);
        goto LAB_00c279c0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0xc39,"js_cocos2dx_spine_BoneData_setLength");
      pcVar6 = "js_cocos2dx_spine_BoneData_setLength : Error processing arguments";
      goto LAB_00c27988;
    }
    __android_log_print(6,"jswrapper",&DAT_018fb1ef,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_BoneData_setLength",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0xc40);
LAB_00c279c0:
