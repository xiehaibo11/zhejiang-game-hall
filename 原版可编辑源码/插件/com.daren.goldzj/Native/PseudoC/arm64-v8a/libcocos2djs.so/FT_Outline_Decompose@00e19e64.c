...
LAB_00e1a278:
    ...
    if (0 < *param_1) {
      ...
      local_c4 = 0;
      do {
        sVar2 = *(short *)(*(long *)(param_1 + 0xc) + lVar15 * 2);
        if (sVar2 < 0) goto LAB_00e1a278;
        pauVar17 = (undefined1 (*) [16])(*(long *)(param_1 + 4) + (long)(int)sVar2 * 0x10);
        pauVar10 = (undefined1 (*) [16])(*(long *)(param_1 + 4) + (ulong)local_c4 * 0x10);
        pbVar12 = (byte *)(*(long *)(param_1 + 8) + (ulong)local_c4);
        ...
        if ((*pbVar12 & 3) == 0) {
          ...
          local_80 = local_70;
          lStack_78 = lStack_68;
          if ((*pbVar12 & 3) == 2) goto LAB_00e1a278;
        }
        uVar8 = (*(code *)*param_2)(&local_80,param_3);
        if ((int)uVar8 != 0) {
          return uVar8;
        }
        if (pauVar10 < pauVar17) {
          ...
          do {
            while( true ) {
              ...
              auVar4._0_8_ = uVar13;
              auVar4._12_4_ = 0;
              auVar18 = NEON_ushl(*pauVar16,auVar4,8);
              ...
              do {
                while( true ) {
                  if (pauVar17 <= pauVar16) {
                    uVar8 = (*(code *)param_2[2])(&local_70,&local_80,param_3);
                    goto LAB_00e1a1e0;
                  }
                  pauVar10 = pauVar16 + 1;
                  pbVar12 = pbVar12 + 1;
                  ...
                  lStack_98 = lStack_98 >> 1;
                  uVar8 = (*(code *)param_2[2])(&local_70,&local_a0,param_3);
                  if ((int)uVar8 != 0) {
                    iVar9 = 10;
                    goto LAB_00e1a270;
                  }
                ...
                if ((*pbVar12 & 3) != 1) {
                  iVar9 = 7;
                  goto joined_r0x00e1a224;
                }
                uVar8 = (*(code *)param_2[2])(&local_70,&local_90,param_3);
                iVar9 = 10;
                if ((int)uVar8 == 0) {
                  iVar9 = 0xb;
                }
              ...
              if (iVar9 != 0xb) goto joined_r0x00e1a224;
              if (pauVar17 <= pauVar10) goto LAB_00e1a1b4;
            }
            if ((*pbVar11 & 3) == 1) {
              auVar3._8_4_ = uVar1;
              auVar3._0_8_ = uVar13;
              ...
              uVar8 = (*(code *)param_2[1])(&local_90,param_3);
              pauVar10 = pauVar16;
              pbVar12 = pbVar11;
              if ((int)uVar8 != 0) {
                return uVar8;
              ...
              if ((pauVar17 < pauVar10 + 2) || ((pbVar12[2] & 3) != 2)) goto LAB_00e1a278;
              auVar6._8_4_ = uVar1;
              auVar6._0_8_ = uVar13;
              auVar6._12_4_ = 0;
              auVar5._8_4_ = uVar1;
              ...
              auVar18._12_4_ = 0;
              pauVar16 = pauVar10 + 3;
              auVar18 = NEON_ushl(pauVar10[1],auVar18,8);
              local_90 = auVar18._0_8_ - lVar14;
              lStack_88 = auVar18._8_8_ - lVar14;
              ...
              if (pauVar17 < pauVar16) {
                uVar8 = (*(code *)param_2[3])(&local_90,&local_a0,&local_80,param_3);
                goto LAB_00e1a1e0;
              }
              auVar18 = NEON_ushl(*pauVar16,auVar6,8);
              local_b0 = auVar18._0_8_ - lVar14;
              lStack_a8 = auVar18._8_8_ - lVar14;
              uVar8 = (*(code *)param_2[3])(&local_90,&local_a0,&local_b0,param_3);
              if ((int)uVar8 != 0) {
                return uVar8;
              }
              pauVar10 = pauVar16;
...
LAB_00e1a1b4:
        uVar8 = (*(code *)param_2[1])(&local_80,param_3);
LAB_00e1a1e0:
        bVar7 = (int)uVar8 == 0;
        if (bVar7) {
          local_c4 = (int)sVar2 + 1;
        }
        iVar9 = 0;
        if (!bVar7) {
          iVar9 = 10;
