...
/* v8::internal::Heap::GenerationalBarrierSlow(v8::internal::HeapObject, unsigned long,
   v8::internal::HeapObject) */

void v8::internal::Heap::GenerationalBarrierSlow(ulong param_1,ulong param_2)
