...
/* v8::internal::compiler::JSHeapBroker::GetFeedbackForCall(v8::internal::compiler::FeedbackSource
   const&) */

undefined8 __thiscall
v8::internal::compiler::JSHeapBroker::GetFeedbackForCall(JSHeapBroker *this,FeedbackSource *param_1)

{
  ...
  if (FLAG_concurrent_inlining == '\0') {
    uVar2 = ProcessFeedbackForCall(this,param_1);
    return uVar2;
  }
  lVar1 = std::__ndk1::
