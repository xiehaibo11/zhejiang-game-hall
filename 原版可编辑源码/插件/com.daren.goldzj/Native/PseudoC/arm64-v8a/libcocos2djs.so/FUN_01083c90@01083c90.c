...
void FUN_01083c90(ulong *param_1,ulong *param_2,long param_3,int param_4,int param_5)

{
  ...
  if (uVar2 <= (uint)(*(int *)(*param_2 + 3) >> 1)) {
    if (param_5 == 0) {
      FUN_01083f5c(this,param_1,param_2,param_4,0,iVar17);
    }
    goto LAB_01083e54;
  }
  iVar18 = param_4;
  ...
  if (0 < (int)uVar6) {
    ...
    if (uVar6 < 8) {
      ...
      if (uVar15 == uVar13) goto LAB_01083dd0;
    }
