...
/* JSB_glUniformMatrix2fvRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glUniformMatrix2fvRegistry(FunctionCallbackInfo *param_1)
...
joined_r0x008c73c4:
      ...
      if (local_90[0] != 0) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                            ,0xa40,"JSB_glUniformMatrix2fv");
LAB_008c74bc:
        DAT_01d36f40 = 0x501;
        goto joined_r0x008c73c4;
      }
      if ((local_58 & 3) != 0) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                            ,0xa42,"JSB_glUniformMatrix2fv");
        goto LAB_008c74bc;
      }
      glUniformMatrix2fv(local_8c,local_58 >> 2,0,local_60);
      bVar2 = true;
    }
    if (local_50 != '\0') {
      free(local_60);
    }
    if (bVar2) goto LAB_008c7400;
  }
  else {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                        ,0xa36,"JSB_glUniformMatrix2fv");
    __android_log_print(6,"jswrapper","Invalid number of arguments");
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "JSB_glUniformMatrix2fv",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                      ,0xa48);
LAB_008c7400:
