...
/* void std::__ndk1::vector<spine::SkeletonCache::BoneData*,
   std::__ndk1::allocator<spine::SkeletonCache::BoneData*>
   >::__push_back_slow_path<spine::SkeletonCache::BoneData* const&>(spine::SkeletonCache::BoneData*
   const&) */
...
LAB_00d1892c:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d1892c;
  }
  else {
