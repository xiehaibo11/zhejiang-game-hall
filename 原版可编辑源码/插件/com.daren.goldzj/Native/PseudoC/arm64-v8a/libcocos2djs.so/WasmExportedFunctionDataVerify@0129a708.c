...
/* v8::internal::TorqueGeneratedClassVerifiers::WasmExportedFunctionDataVerify(v8::internal::WasmExportedFunctionData,
   v8::internal::Isolate*) */

void v8::internal::TorqueGeneratedClassVerifiers::WasmExportedFunctionDataVerify
...

{
  ...
  if (*(short *)(uVar3 + *(uint *)(local_38 - 1)) != 0x73) {
                    /* WARNING: Subroutine does not return */
    V8_Fatal("Check failed: %s.","o.IsWasmExportedFunctionData()");
  }
  ...
  if (((uVar1 & 1) == 0) || (*(short *)((uVar2 | 7) + (ulong)*(uint *)(uVar3 - 1)) != 0x434)) {
                    /* WARNING: Subroutine does not return */
  ...
  if ((uVar1 & 1) != 0) {
                    /* WARNING: Subroutine does not return */
    V8_Fatal("Check failed: %s.","jump_table_offset__value.IsSmi()");
  }
  ...
  if ((uVar1 & 1) == 0) {
    ...
    if (((uVar1 & 1) != 0) && (*(short *)((uVar2 | 7) + (ulong)*(uint *)(uVar3 - 1)) != 0x46)) {
      ...
      V8_Fatal("Check failed: %s.",
               "wasm_call_target__value.IsSmi() || wasm_call_target__value.IsForeign()");
    }
    ...
    if ((uVar1 & 1) == 0) {
      return;
                    ...
                    /* WARNING: Subroutine does not return */
    V8_Fatal("Check failed: %s.","packed_args_size__value.IsSmi()");
  }
                    /* WARNING: Subroutine does not return */
  V8_Fatal("Check failed: %s.","function_index__value.IsSmi()");
}
