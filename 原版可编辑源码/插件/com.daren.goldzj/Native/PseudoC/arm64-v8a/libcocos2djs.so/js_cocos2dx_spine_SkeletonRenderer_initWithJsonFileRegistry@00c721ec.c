...
/* js_cocos2dx_spine_SkeletonRenderer_initWithJsonFileRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonRenderer_initWithJsonFileRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonRenderer *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3363,"js_cocos2dx_spine_SkeletonRenderer_initWithJsonFile");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonRenderer_initWithJsonFile : Invalid Native Object"
                       );
  }
  else {
...
LAB_00c72404:
          ...
          if ((uVar8 & 1) == 0) goto LAB_00c72404;
...
LAB_00c724dc:
      ...
      if (iVar15 != 10) goto LAB_00c725c4;
    }
    else if (lVar12 == 2) {
      local_88 = 0;
      uStack_80 = 0;
...
LAB_00c72560:
        ...
        if (bVar3 == 5) {
          ...
          pAVar10 = (Atlas *)se::Object::getPrivateData(pOVar9);
          if (pAVar10 == (Atlas *)0x0) goto LAB_00c72560;
        }
        else {
          if (1 < bVar3) goto LAB_00c72560;
          pAVar10 = (Atlas *)0x0;
        }
        spine::SkeletonRenderer::initWithJsonFile(this,(basic_string *)&local_88,pAVar10,1.0);
        iVar13 = 1;
        iVar15 = 1;
      }
      if ((local_88 & 1) != 0) {
      ...
      if (iVar15 != 8) goto LAB_00c725c4;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 13216): wrong number of arguments: %d\n"
                        ,(ulong)(lVar2 - lVar1) >> 4);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonRenderer_initWithJsonFile",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x33a3);
LAB_00c725c4:
