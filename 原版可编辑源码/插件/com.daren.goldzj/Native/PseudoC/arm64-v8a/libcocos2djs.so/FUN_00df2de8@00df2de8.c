...
void FUN_00df2de8(uint *param_1,uint param_2,uint param_3,uint *param_4,uint *param_5)

{
  ...
  if (*param_1 < 4) {
          ...
          if ((int)uVar2 < 2) {
            ...
            do {
              uVar4 = (*puVar21 & 0xff00ff00) + (puVar21[-lVar6] & 0xff00ff00) & 0xff00ff00 |
                      (*puVar21 & 0xff00ff) + (puVar21[-lVar6] & 0xff00ff) & 0xff00ff;
              *puVar21 = uVar4;
              pcVar15 = *(code **)(&DAT_01d54660 + (ulong)(*puVar20 >> 8 & 0xf) * 8);
              lVar13 = (ulong)uVar2 - 1;
              puVar8 = puVar18;
              do {
            ...
            *puVar21 = (*puVar21 & 0xff00ff00) + (puVar21[-lVar6] & 0xff00ff00) & 0xff00ff00 |
            ...
            do {
              ...
              if (iVar22 != 0 && iVar9 <= iVar10) {
                pcVar15 = *(code **)(&DAT_01d54660 + (ulong)(*puVar11 >> 8 & 0xf) * 8);
            ...
            if ((int)uVar5 < (int)uVar2) {
              pcVar15 = *(code **)(&DAT_01d54660 + (ulong)(*puVar12 >> 8 & 0xf) * 8);
              iVar22 = iVar9;
              if (iVar9 <= iVar10) {
                iVar22 = iVar10;
              }
    ...
    case 1:
        ...
        if ((int)uVar7 < 1) {
          do {
            if (0 < (int)uVar2) {
              ...
              (*DAT_01d546e0)(&local_68,local_90,iVar22);
          ...
          do {
            ...
            do {
              ...
              (*DAT_01d546e0)(&local_68,puVar21,iVar10);
            ...
            if (puVar21 < puVar20) {
              ...
              (*DAT_01d546e0)(&local_68,puVar21,iVar22);
      ...
      break;
    case 2:
                    /* WARNING: Could not recover jumptable at 0x00df3274. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      (*DAT_01d54658)(param_5,uVar2 * (param_3 - param_2));
      return;
    case 3:
      uVar7 = param_1[1];
      if ((param_4 == param_5) && (0 < (int)uVar7)) {
        ...
        if (7 < (int)uVar4) {
LAB_00df3500:
                    /* WARNING: Could not recover jumptable at 0x00df3524. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (*DAT_01d546e8)(puVar21,lVar6,param_5,param_2,param_3);
          return;
        }
        ...
        puVar21 = param_4;
        if (7 < (int)uVar4) goto LAB_00df3500;
