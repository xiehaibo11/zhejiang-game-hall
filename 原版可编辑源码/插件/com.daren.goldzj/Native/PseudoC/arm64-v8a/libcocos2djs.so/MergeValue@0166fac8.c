...
/* v8::internal::compiler::BytecodeGraphBuilder::MergeValue(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*, v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::BytecodeGraphBuilder::MergeValue
...

{
  ...
  if ((*(short *)(*(long *)param_1 + 0x10) == 0x23) &&
    ...
    param_1 = (Node *)NewPhi(this,iVar1,param_1,param_3);
    pNVar2 = param_1 + 0x20;
    pNVar5 = pNVar2;
