...
/* v8::internal::compiler::GraphAssembler::Allocate(v8::internal::AllocationType,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Allocate
          (GraphAssembler *this,undefined4 param_2,Node *param_3)

{
  ...
  pOVar2 = (Operator *)
           SimplifiedOperatorBuilder::AllocateRaw
                     ((SimplifiedOperatorBuilder *)(*(undefined8 **)(this + 0x18))[0x2f],0xffffffff,
                      param_2,0);
