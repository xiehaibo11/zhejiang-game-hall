...

{
  ...
  do {
    ...
    if (((byte)param_1[0x58] & 1) == 0) {
      if (((byte)param_1[0x40] & 1) == 0) goto LAB_00a68b7c;
LAB_00a68b44:
      operator_delete(*(void **)(param_1 + 0x50));
      if (((byte)param_1[0x28] & 1) != 0) goto LAB_00a68b54;
LAB_00a68b84:
      _Var1 = param_1[0x10];
    }
    else {
      operator_delete(*(void **)(param_1 + 0x68));
      if (((byte)param_1[0x40] & 1) != 0) goto LAB_00a68b44;
LAB_00a68b7c:
                    /* try { // try from 00a68b7c to 00b68c5f has its CatchHandler @ 00a689c0 */
      if (((byte)param_1[0x28] & 1) == 0) goto LAB_00a68b84;
LAB_00a68b54:
