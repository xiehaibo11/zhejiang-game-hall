...
/* v8::internal::compiler::OperationTyper::NumberMax(v8::internal::compiler::Type,
   v8::internal::compiler::Type) */

undefined8 __thiscall
v8::internal::compiler::OperationTyper::NumberMax(OperationTyper *this,long param_2,long param_3)
