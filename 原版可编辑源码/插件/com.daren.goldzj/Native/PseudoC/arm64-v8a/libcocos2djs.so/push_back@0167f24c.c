...
/* std::__ndk1::__split_buffer<v8::internal::compiler::BytecodeGraphBuilder::OsrIteratorState::IteratorsStates*,
   v8::internal::RecyclingZoneAllocator<v8::internal::compiler::BytecodeGraphBuilder::OsrIteratorState::IteratorsStates*>&>::push_back(v8::internal::compiler::BytecodeGraphBuilder::OsrIteratorState::IteratorsStates*&&)
    */
...

{
  ...
  if (puVar8 != *(undefined8 **)(this + 0x18)) goto LAB_0167f41c;
  pvVar14 = *(void **)this;
  __src = *(void **)(this + 8);
  ...
  if (puVar10 != puVar2) {
    ...
    if ((3 < uVar4) && ((puVar10 + uVar6 + 1 <= puVar1 || (puVar3 + uVar11 + uVar6 + 1 <= puVar10)))
      ...
      puVar8 = puVar1 + uVar6;
      puVar7 = puVar1 + uVar6;
      if (uVar4 == uVar6) goto LAB_0167f3d0;
    }
    do {
      puVar13 = puVar10 + 1;
      *puVar7 = *puVar10;
