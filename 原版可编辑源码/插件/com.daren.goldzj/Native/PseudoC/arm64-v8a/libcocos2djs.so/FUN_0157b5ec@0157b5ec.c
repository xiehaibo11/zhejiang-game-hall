...
undefined8 FUN_0157b5ec(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0x1d9);
  }
  if (DAT_01d47238 == (byte *)0x0) {
    plVar6 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d47238 = (byte *)(**(code **)(*plVar6 + 0x10))(plVar6,"disabled-by-default-v8.runtime");
  }
  pbVar4 = DAT_01d47238;
  local_a0 = (byte **)0x0;
  if ((*DAT_01d47238 & 5) != 0) {
    ...
    uVar7 = (**(code **)(*plVar6 + 0x18))
                      (plVar6,0x58,pbVar4,"V8.Runtime_Runtime_CheckProxyHasTrapResult",0,0,0,0,0,0,0
                       ,&local_50,0);
    plVar6 = local_48;
    local_48 = (long *)0x0;
    if (plVar6 != (long *)0x0) {
    ...
    local_a0 = &local_98;
    local_90 = "V8.Runtime_Runtime_CheckProxyHasTrapResult";
    local_98 = pbVar4;
    local_88 = uVar7;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar8 & 1) != 0) &&
    ...
    if (((uVar8 & 1) != 0) &&
      ...
      uVar5 = v8::internal::JSProxy::CheckHasTrap(param_3,param_2);
      pIVar1 = param_3 + 0xb8;
      if (uVar5 < 0x100) {
        pIVar1 = param_3 + 0xc0;
      }
