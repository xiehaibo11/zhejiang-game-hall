...
undefined8 __thiscall v8::Message::GetScriptResourceName(Message *this)
  ...
  *(undefined4 *)(pIVar4 + 0x2c60) = 5;
  ...
  if (this_00 == (CanonicalHandleScope *)0x0) {
    ...
    *puVar3 = uVar5;
    ...
    puVar3 = (ulong *)internal::CanonicalHandleScope::Lookup(this_00,uVar5);
  }
  FUN_00ead49c(local_68,pIVar4,puVar3);
