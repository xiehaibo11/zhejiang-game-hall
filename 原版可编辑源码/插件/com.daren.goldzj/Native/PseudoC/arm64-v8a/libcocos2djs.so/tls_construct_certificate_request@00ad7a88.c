...

{
  ...
  *puVar1 = (char)iVar4;
  ...
  if (((byte)param_1->method->get_timeout[0x68] >> 1 & 1) == 0) {
    iVar4 = iVar4 + 1;
                    ...
                    /* try { // try from 00ad7afc to 00bd7b03 has its CatchHandler @ 00ad7c10 */
    local_58 = puVar11;
    iVar5 = tls12_get_psigalgs(param_1,&local_68);
    local_58 = local_58 + 2;
    iVar5 = tls12_copy_sigalgs(param_1,local_58,local_68,(long)iVar5);
                    /* try { // try from 00ad7b24 to 00bd7b47 has its CatchHandler @ 00ad7c20 */
  ...
  if ((psVar9 == (stack_st_X509_NAME *)0x0) || (iVar6 = OPENSSL_sk_num(psVar9), iVar6 < 1)) {
    ...
    do {
      ...
      iVar7 = i2d_X509_NAME(a,(uchar **)0x0);
                    /* try { // try from 00ad7b90 to 00bd7b9f has its CatchHandler @ 00ad7c10 */
                    /* try { // try from 00ad7ba0 to 00bd7c77 has its CatchHandler @ 00ad7a04 */
      ...
      lVar2 = *(long *)&param_1->s2->escape + (ulong)*(uint *)(param_1->method->get_timeout + 0x6c);
                    /* catch() { ... } // from try @ 00ad7a78 with catch @ 00ad7bdc */
      lVar3 = lVar2 + iVar5;
      *(char *)(lVar2 + iVar5) = (char)((uint)iVar7 >> 8);
      *(char *)(lVar3 + 1) = (char)iVar7;
      local_58 = (uchar *)(lVar3 + 2);
                    /* catch() { ... } // from try @ 00ad7a48 with catch @ 00ad7bfc */
      i2d_X509_NAME(a,&local_58);
      iVar5 = iVar7 + 2 + iVar5;
                    /* catch() { ... } // from try @ 00ad7afc with catch @ 00ad7c10
                       catch() { ... } // from try @ 00ad7b90 with catch @ 00ad7c10 */
      iVar13 = iVar7 + 2 + iVar13;
      uVar12 = (undefined2)iVar13;
      iVar6 = iVar6 + 1;
      iVar7 = OPENSSL_sk_num(psVar9);
                    /* catch() { ... } // from try @ 00ad7b24 with catch @ 00ad7c20 */
    } while (iVar6 < iVar7);
  }
  lVar2 = *(long *)&param_1->s2->escape + (ulong)*(uint *)(param_1->method->get_timeout + 0x6c);
  lVar3 = lVar2 + iVar4;
  ...
  *(char *)(lVar3 + 1) = (char)uVar12;
  local_58 = (uchar *)(lVar3 + 2);
                    /* try { // try from 00ad7c78 to 00bd7ce7 has its CatchHandler @ 00ad7c78
                       catch() { ... } // from try @ 00ad7c78 with catch @ 00ad7c78
                       catch() { ... } // from try @ 00ad7cfc with catch @ 00ad7c78 */
...
LAB_00ad7cd0:
    ...
    *(undefined4 *)(*(long *)&param_1->read_ahead + 0x288) = 1;
                    ...
                    /* try { // try from 00ad7ce8 to 00bd7cfb has its CatchHandler @ 00ad7d34 */
                    /* try { // try from 00ad7cfc to 00bd7d4f has its CatchHandler @ 00ad7c78 */
  return uVar10;
}
