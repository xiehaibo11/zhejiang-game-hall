...

{
  ...
  if (param_1 - 1 == 0) {
    param_1 = 2;
                    ...
                    /* try { // try from 00a6f780 to 00b6f81b has its CatchHandler @ 00a6f594 */
  ...
  if (uVar2 < param_1) {
LAB_00a6f79c:
                    /* catch() { ... } // from try @ 00a6f660 with catch @ 00a6f79c
                       catch() { ... } // from try @ 00a6f73c with catch @ 00a6f79c */
    __rehash(this,uVar1);
    return;
  }
  if (param_1 < uVar2) {
                    /* catch() { ... } // from try @ 00a6f5e8 with catch @ 00a6f7b4 */
    ...
    if (uVar1 < uVar2) goto LAB_00a6f79c;
  }
  return;
}
