...
/* js_renderer_Effect_copyRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Effect_copyRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Effect *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2a1,"js_renderer_Effect_copy");
    __android_log_print(6,"jswrapper","js_renderer_Effect_copy : Invalid Native Object");
  }
  else {
...
LAB_00939980:
          cocos2d::renderer::Effect::copy(this,pEVar6);
          goto LAB_009399fc;
        }
      }
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0x2a8,"js_renderer_Effect_copy");
      __android_log_print(6,"jswrapper","js_renderer_Effect_copy : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 684): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(puVar4[1] - (long)pVVar5) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Effect_copy",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0x2af);
LAB_009399fc:
