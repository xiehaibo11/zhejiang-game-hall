...
LAB_00ad70ac:
    ...
    if ((uVar1 & 0x48) == 0) {
      if ((uVar1 & 0x102) != 0) {
                    /* try { // try from 00ad7160 to 00bd7167 has its CatchHandler @ 00ad7200 */
...
joined_r0x00ad74a4:
          if (pEVar16 == (EVP_PKEY *)0x0) {
            ...
            if (pcVar12 != (code *)0x0) {
                    /* try { // try from 00ad71a8 to 00bd71f7 has its CatchHandler @ 00ad6f94 */
              ...
              goto LAB_00ad74b0;
                    ...
                    /* try { // try from 00ad79b4 to 00bd7a03 has its CatchHandler @ 00ad7940 */
            ERR_put_error(0x14,0x179,0xab,"ssl/statem/statem_srvr.c",0x69f);
            uVar11 = 0x28;
          }
          else {
LAB_00ad74b0:
                    /* try { // try from 00ad74b4 to 00bd74c3 has its CatchHandler @ 00ad7578 */
            uVar5 = EVP_PKEY_security_bits(pEVar16);
                    /* try { // try from 00ad74c4 to 00bd75df has its CatchHandler @ 00ad724c */
            ...
            if (iVar6 != 0) {
              ...
              *(long *)(*(long *)(param_1 + 0x90) + 0x230) = lVar14;
              if (lVar14 == 0) {
                    /* try { // try from 00ad7a48 to 00bd7a5f has its CatchHandler @ 00ad7bfc */
                ERR_put_error(0x14,0x179,6,"ssl/statem/statem_srvr.c",0x6b2);
                goto LAB_00ad7404;
              }
                    /* catch() { ... } // from try @ 00ad79b4 with catch @ 00ad7940 */
              ...
              goto LAB_00ad70e0;
                    ...
                    /* catch() { ... } // from try @ 00ad7730 with catch @ 00ad78a4 */
            ERR_put_error(0x14,0x179,0x18a,"ssl/statem/statem_srvr.c",0x6a6);
            uVar11 = 0x28;
          }
          goto LAB_00ad70b0;
        }
                    /* try { // try from 00ad7168 to 00bd718b has its CatchHandler @ 00ad6f94 */
        dh = (DH *)ssl_get_auto_dh(param_1);
        pEVar15 = EVP_PKEY_new();
        if ((dh != (DH *)0x0) && (pEVar15 != (EVP_PKEY *)0x0)) {
                    /* try { // try from 00ad718c to 00bd71a7 has its CatchHandler @ 00ad7210 */
          EVP_PKEY_assign(pEVar15,0x1c,dh);
          pEVar16 = pEVar15;
          goto joined_r0x00ad74a4;
        }
        DH_free(dh);
        iVar7 = 0x689;
LAB_00ad782c:
      ...
      if ((uVar1 & 0x84) != 0) {
        if (*(long *)(lVar14 + 0x230) == 0) {
          ...
          iVar6 = tls1_ec_nid2curve_id();
                    /* catch() { ... } // from try @ 00ad77b4 with catch @ 00ad78d8
                       catch() { ... } // from try @ 00ad7854 with catch @ 00ad78d8 */
          if (iVar6 == 0) {
            iVar7 = 0x13b;
            iVar6 = 0x6ce;
          }
            ...
            lVar14 = ssl_generate_pkey_curve(iVar6);
                    /* catch() { ... } // from try @ 00ad77d8 with catch @ 00ad78e8 */
            *(long *)(*(long *)(param_1 + 0x90) + 0x230) = lVar14;
            if (lVar14 == 0) {
              iVar7 = 6;
              iVar6 = 0x6d5;
            ...
            if (iVar8 != 0) {
              ...
              goto LAB_00ad70e8;
                    ...
                    /* try { // try from 00ad7a78 to 00bd7a8b has its CatchHandler @ 00ad7bdc */
            iVar7 = 0x10;
            iVar6 = 0x6dd;
          }
        }
      ...
      if ((uVar1 >> 5 & 1) != 0) {
        if ((((*(BIGNUM **)(param_1 + 0x340) == (BIGNUM *)0x0) || (*(long *)(param_1 + 0x348) == 0))
           ...
           (*(BIGNUM **)(param_1 + 0x358) == (BIGNUM *)0x0)) {
                    /* try { // try from 00ad7a04 to 00bd7a47 has its CatchHandler @ 00ad7a04
                       catch() { ... } // from try @ 00ad7a04 with catch @ 00ad7a04
                       catch() { ... } // from try @ 00ad7ba0 with catch @ 00ad7a04 */
          iVar7 = 0x166;
          iVar6 = 0x6f8;
          goto LAB_00ad73fc;
        }
        uVar17 = 0;
        iVar6 = 0;
                    /* try { // try from 00ad79a4 to 00bd79b3 has its CatchHandler @ 00ad79e8 */
        iVar8 = 0;
        ...
        goto LAB_00ad70e8;
                    ...
                    /* try { // try from 00ad7854 to 00bd7863 has its CatchHandler @ 00ad78d8 */
                    /* try { // try from 00ad7864 to 00bd793f has its CatchHandler @ 00ad76a0 */
      iVar7 = 0xfa;
      iVar6 = 0x704;
    }
    else {
...
LAB_00ad70e8:
      ...
      if ((uVar1 >> 5 & 1) == 0) {
        ...
        if (uVar17 == 0) {
          do {
            ...
            if (-1 < iVar3 + 7) {
              iVar4 = iVar3 + 7;
                    ...
                    /* try { // try from 00ad7314 to 00bd7327 has its CatchHandler @ 00ad7564 */
            iVar3 = 1;
            if (local_74 != 2) {
              iVar3 = 2;
            }
            local_a8[(int)local_74] = iVar4 >> 3;
                    /* try { // try from 00ad7328 to 00bd733f has its CatchHandler @ 00ad7544 */
          ...
          while (a != (BIGNUM *)0x0) {
            while( true ) {
                    /* try { // try from 00ad71f8 to 00bd71ff has its CatchHandler @ 00ad7200 */
              iVar3 = BN_num_bits(a);
              uVar2 = local_74;
                    /* catch() { ... } // from try @ 00ad7160 with catch @ 00ad7200
                       catch() { ... } // from try @ 00ad71f8 with catch @ 00ad7200
                       try { // try from 00ad7200 to 00bd724b has its CatchHandler @ 00ad6f94 */
              iVar4 = iVar3 + 0xe;
              if (-1 < iVar3 + 7) {
                iVar4 = iVar3 + 7;
              }
                    /* catch() { ... } // from try @ 00ad718c with catch @ 00ad7210 */
              iVar4 = iVar4 >> 3;
              local_a8[(int)local_74] = iVar4;
              if (local_74 == 2) break;
              local_74 = local_74 + 1;
                    /* try { // try from 00ad724c to 00bd7313 has its CatchHandler @ 00ad724c
                       catch() { ... } // from try @ 00ad724c with catch @ 00ad724c
                       catch() { ... } // from try @ 00ad74c4 with catch @ 00ad724c */
              iVar7 = iVar7 + iVar4 + 2;
...
LAB_00ad733c:
      lVar14 = *(long *)(*(long *)(param_1 + 0x90) + 0x228);
                    /* try { // try from 00ad7358 to 00bd736b has its CatchHandler @ 00ad7510 */
      if (((*(byte *)(lVar14 + 0x18) & 0x44) == 0) && ((*(ushort *)(lVar14 + 0x14) & 0x1c8) == 0)) {
        ...
        pEVar15 = (EVP_PKEY *)0x0;
        uVar11 = 0x32;
                    /* catch() { ... } // from try @ 00ad7700 with catch @ 00ad78c4 */
        goto LAB_00ad70b0;
      }
      iVar4 = 0;
      pEVar15 = (EVP_PKEY *)0x0;
...
LAB_00ad73fc:
        ERR_put_error(0x14,0x179,iVar7,"ssl/statem/statem_srvr.c",iVar6);
                    /* try { // try from 00ad7400 to 00bd7447 has its CatchHandler @ 00ad7588 */
        pEVar15 = (EVP_PKEY *)0x0;
        goto LAB_00ad7404;
      }
      ...
      if ((uVar1 & 0x1c8) != 0) {
        ...
        if (pcVar9 == (char *)0x0) {
          ...
          if (0x80 < sVar10) {
            iVar7 = 0x44;
                    /* try { // try from 00ad73dc to 00bd73e3 has its CatchHandler @ 00ad7578 */
            iVar6 = 0x73e;
            goto LAB_00ad73fc;
          }
          *d = (uchar)(sVar10 >> 8);
          d[1] = (uchar)sVar10;
                    /* catch() { ... } // from try @ 00ad7358 with catch @ 00ad7510 */
      ...
      if ((uVar1 >> 5 & 1) == 0) {
        do {
                    /* catch() { ... } // from try @ 00ad7328 with catch @ 00ad7544 */
          if ((&local_98)[(int)local_74] == (BIGNUM *)0x0) break;
          if ((uVar17 == 0) || (local_74 != 2)) {
            ...
            *puVar18 = (uchar)((uint)local_a8[0] >> 8);
                    /* catch() { ... } // from try @ 00ad7314 with catch @ 00ad7564 */
            puVar18[1] = (uchar)local_a8[0];
            puVar18 = puVar18 + 2;
                    /* catch() { ... } // from try @ 00ad73dc with catch @ 00ad7578
                       catch() { ... } // from try @ 00ad74b4 with catch @ 00ad7578 */
            if (local_a8[2] < local_a8[0]) {
              lVar14 = 0;
              do {
                puVar18[lVar14] = '\0';
                    /* catch() { ... } // from try @ 00ad7400 with catch @ 00ad7588 */
                lVar14 = lVar14 + 1;
          ...
          uVar2 = local_74;
          lVar14 = (long)(int)local_74;
                    /* catch() { ... } // from try @ 00ad7650 with catch @ 00ad75e0 */
          local_74 = local_74 + 1;
          ...
          if (local_74 == 2) {
            ...
            *puVar18 = (uchar)((uint)local_a8[(int)local_74] >> 8);
            ...
            lVar14 = 2;
                    ...
                    /* try { // try from 00ad7640 to 00bd764f has its CatchHandler @ 00ad7684 */
          BN_bn2bin((&local_98)[(int)local_74],puVar18 + lVar14);
          uVar17 = local_74;
          lVar13 = (long)(int)local_74;
                    /* try { // try from 00ad7650 to 00bd769f has its CatchHandler @ 00ad75e0 */
          local_74 = local_74 + 1;
      ...
      if ((uVar1 & 0x84) != 0) {
        puVar18[0] = '\x03';
        puVar18[1] = '\0';
                    /* catch() { ... } // from try @ 00ad7640 with catch @ 00ad7684 */
        puVar18[2] = (uchar)iVar6;
        puVar18[3] = (uchar)iVar8;
                    /* try { // try from 00ad76a0 to 00bd76ff has its CatchHandler @ 00ad76a0
                       catch() { ... } // from try @ 00ad76a0 with catch @ 00ad76a0
                       catch() { ... } // from try @ 00ad7864 with catch @ 00ad76a0 */
      ...
      if (pEVar15 == (EVP_PKEY *)0x0) {
        ...
        if ((*(byte *)(*(long *)(*(long *)(param_1 + 8) + 0xc0) + 0x68) >> 1 & 1) != 0) {
          ...
          if (iVar6 == 0) {
                    /* catch() { ... } // from try @ 00ad79a4 with catch @ 00ad79e8 */
            iVar7 = 0x44;
            iVar6 = 0x788;
            goto LAB_00ad70a4;
          }
          puVar18 = puVar18 + 2;
                    ...
                    /* try { // try from 00ad7700 to 00bd7717 has its CatchHandler @ 00ad78c4 */
        iVar6 = EVP_DigestInit_ex(ctx,local_70,(ENGINE *)0x0);
                    /* try { // try from 00ad7730 to 00bd7743 has its CatchHandler @ 00ad78a4 */
        if ((((iVar6 < 1) ||
        ...
        *puVar18 = (uchar)(local_74 >> 8);
        ...
        lVar14 = *(long *)(*(long *)(param_1 + 8) + 0xc0);
                    /* try { // try from 00ad77b4 to 00bd77bb has its CatchHandler @ 00ad78d8 */
        iVar6 = iVar7 + local_74 + 2;
        if ((*(byte *)(lVar14 + 0x68) & 2) != 0) {
          iVar6 = iVar7 + local_74 + 4;
        }
      }
                    /* try { // try from 00ad77d8 to 00bd780b has its CatchHandler @ 00ad78e8 */
