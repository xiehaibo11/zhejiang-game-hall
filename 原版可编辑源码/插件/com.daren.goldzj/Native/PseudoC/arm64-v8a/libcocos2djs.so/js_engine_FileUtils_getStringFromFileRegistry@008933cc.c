...
/* js_engine_FileUtils_getStringFromFileRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_engine_FileUtils_getStringFromFileRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar5 == (long *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x39,"js_engine_FileUtils_getStringFromFile");
    __android_log_print(6,"jswrapper",
                        "js_engine_FileUtils_getStringFromFile : Invalid Native Object");
  }
  else {
    ...
    if (plVar6[1] - *plVar6 == 0x10) {
      ...
      if ((uVar7 & 1) == 0) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                            ,0x40,"js_engine_FileUtils_getStringFromFile");
        __android_log_print(6,"jswrapper",
                            "js_engine_FileUtils_getStringFromFile : Error processing arguments");
        bVar1 = false;
      }
      else {
        (**(code **)(*plVar5 + 0x18))(local_90,plVar5,&local_78);
        ...
        if (bVar1) {
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                              ,0x43,"js_engine_FileUtils_getStringFromFile");
          __android_log_print(6,"jswrapper",
                              "js_engine_FileUtils_getStringFromFile : Error processing arguments");
        }
        bVar1 = !bVar1;
      ...
      if (bVar1) goto LAB_00893630;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 70): wrong number of arguments: %d, was expecting %d\n"
