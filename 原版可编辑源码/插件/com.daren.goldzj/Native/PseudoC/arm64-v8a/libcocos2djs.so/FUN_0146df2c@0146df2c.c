...
void FUN_0146df2c(long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,long param_5
...

{
  ...
  *(int *)(param_5 + -0x20) = (unaff_w19 + -1) * 2;
  FUN_0139a8e0(param_2,param_8,param_4,param_5,*(undefined8 *)(param_5 + -8));
                    /* WARNING: Could not recover jumptable at 0x0146dfc8. Too many branches */
