...
/* v8::tracing::TracedValue::EndDictionary() */

void __thiscall v8::tracing::TracedValue::EndDictionary(TracedValue *this)

{
  ...
  if (((byte)bVar2 & 1) == 0) {
    ...
    uVar1 = 0x16;
    if (uVar4 != 0x16) goto LAB_011fa410;
  }
  else {
    uVar4 = *(ulong *)(this + 0x10);
    uVar1 = (*(ulong *)(this + 8) & 0xfffffffffffffffe) - 1;
    if (uVar4 != uVar1) goto LAB_011fa410;
  }
