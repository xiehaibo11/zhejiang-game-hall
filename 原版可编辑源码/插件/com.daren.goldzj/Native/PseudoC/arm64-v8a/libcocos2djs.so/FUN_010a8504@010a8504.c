...
undefined8 FUN_010a8504(undefined8 param_1,undefined8 param_2,uint param_3,ulong param_4)

{
  ...
  FUN_010a9bbc();
  pcStack_18 = FUN_010a8510;
  puStack_20 = &stack0xfffffffffffffff0;
  FUN_010a9bd0();
  pcStack_48 = FUN_010a851c;
  uStack_58 = *extraout_x1;
  if (((*(uint *)((uStack_58 & 0xffffffff00000000 | (ulong)*(uint *)(uStack_58 - 1)) + 0xb) >> 0x14
       & 1) != 0) ||
     (puStack_50 = (undefined1 *)&puStack_20,
     uVar3 = v8::internal::JSObject::WouldConvertToSlowElements((JSObject *)&uStack_58,param_3),
     (uVar3 & 1) != 0)) {
    return 0;
  }
