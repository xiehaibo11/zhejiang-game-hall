...
undefined1  [16] FUN_013bf2a8(ulong param_1,undefined8 param_2,code *param_3)

{
  ...
  *(undefined8 *)(unaff_x26 + 0x40) = 0x13bf3cc;
  ...
  *(undefined8 *)(unaff_x26 + 0x38) = 0;
  if (*(long *)(unaff_x26 + 0x2be0) != 0) {
    *(long *)(*(long *)(unaff_x26 + 0x2bf8) + -8) = *(long *)(unaff_x26 + 0x2be0);
                    ...
                    /* WARNING: Could not recover jumptable at 0x013bf438. Too many branches */
