...
/* js_cocos2dx_spine_Skeleton_findSlotRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Skeleton_findSlotRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Skeleton *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2549,"js_cocos2dx_spine_Skeleton_findSlot");
    __android_log_print(6,"jswrapper",&DAT_01911cf3);
  }
  else {
    ...
    if (plVar6[1] - *plVar6 == 0x10) {
      ...
      ptVar7 = (type *)spine::Skeleton::findSlot(this,(String *)&local_88);
      pVVar8 = (Value *)se::State::rval(aSStack_70);
      bVar4 = native_ptr_to_rooted_seval<spine::Slot>(ptVar7,pVVar8,(bool *)0x0);
      if (!bVar4) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                            ,0x2553,"js_cocos2dx_spine_Skeleton_findSlot");
        __android_log_print(6,"jswrapper",
                            "js_cocos2dx_spine_Skeleton_findSlot : Error processing arguments");
      }
      pvVar5 = local_78;
      local_88 = &PTR__String_01c67868;
      ...
      if (bVar4) goto LAB_00c58534;
    }
    else {
      __android_log_print(6,"jswrapper",&DAT_01911d70,(ulong)(plVar6[1] - *plVar6) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Skeleton_findSlot",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x2559);
LAB_00c58534:
  pVVar8 = (Value *)se::State::rval(aSStack_70);
