...
/* v8::internal::compiler::GraphAssembler::BitcastWordToTagged(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::BitcastWordToTagged(GraphAssembler *this,Node *param_1)

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::BitcastWordToTagged
