...
ulong * FUN_00ed7110(Factory *param_1,ulong *param_2,ulong param_3,code *param_4,Factory *param_5,
                    uint param_6,ulong *param_7,byte param_8)

{
  ...
  *(uint *)(*puVar3 + 7) = *(uint *)(*puVar3 + 7) & 0xffffffde;
  uVar8 = *param_2;
