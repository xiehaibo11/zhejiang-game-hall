            ...
            if (iVar10 == 0) {
              ...
              if (uVar31 == 0) {
                ...
                do {
                  ...
                  if (1 < param_5) {
                    do {
                      FUN_00be612c(puVar4,puVar4 + param_6 * -0x20,param_6);
                      uVar31 = uVar31 - 1;
                    } while (uVar31 != 0);
                  }
                  FUN_00be612c(puVar2,puVar4 + (param_5 * 0x20 + -0x20) * param_6,param_6);
                  for (uVar31 = param_5; uVar31 != 0; uVar31 = uVar31 - 1) {
                    FUN_00be612c(puVar2,puVar3,param_6);
                  }
                  uVar17 = uVar17 + 1;
                ...
                do {
                  ...
                  if (1 < param_5) {
                    do {
                      FUN_00be612c(puVar23 + param_6 * (lVar28 + 0x180),puVar23 + lVar27,param_6);
                      uVar13 = uVar13 - 1;
