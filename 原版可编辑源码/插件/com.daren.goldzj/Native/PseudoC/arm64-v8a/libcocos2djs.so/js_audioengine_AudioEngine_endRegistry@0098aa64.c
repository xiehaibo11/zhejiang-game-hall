...
/* js_audioengine_AudioEngine_endRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_audioengine_AudioEngine_endRegistry(FunctionCallbackInfo *param_1)

{
  ...
  __jsbInvocationCount = __jsbInvocationCount + 1;
                    /* catch() { ... } // from try @ 0098a8e0 with catch @ 0098aaa4 */
  ...
  std::__ndk1::vector<se::Value,std::__ndk1::allocator<se::Value>>::reserve
            ((vector<se::Value,std::__ndk1::allocator<se::Value>> *)&local_90,10);
                    /* try { // try from 0098aacc to 00a8abf7 has its CatchHandler @ 0098aacc
                       catch() { ... } // from try @ 0098aacc with catch @ 0098aacc
                       catch() { ... } // from try @ 0098acf4 with catch @ 0098aacc */
  ...
  if (plVar4[1] - *plVar4 == 0) {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_audioengine_auto.cpp, 267): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_audioengine_AudioEngine_end",
