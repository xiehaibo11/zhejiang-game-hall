...
/* v8::internal::Translation::StoreDoubleRegister(v8::internal::VRegister) */

void __thiscall v8::internal::Translation::StoreDoubleRegister(Translation *this,int param_2)
