...

{
  ...
  plVar5 = (long *)FUN_00b91570(cms);
  if (plVar5 == (long *)0x0) {
    si = (ASN1_VALUE *)0x0;
    goto LAB_00b91b60;
  }
  si = ASN1_item_new((ASN1_ITEM *)CMS_SignerInfo_it);
  if (si == (ASN1_VALUE *)0x0) goto LAB_00b91b44;
...
LAB_00b91a60:
          ...
          if (iVar2 == 0) goto LAB_00b91b44;
        }
        if ((flags >> 0xf & 1) != 0) {
          iVar2 = OBJ_obj2nid(*(ASN1_OBJECT **)cms);
          if (iVar2 == 0x16) {
            if (*(long *)(cms + 8) == 0) goto LAB_00b91bb4;
