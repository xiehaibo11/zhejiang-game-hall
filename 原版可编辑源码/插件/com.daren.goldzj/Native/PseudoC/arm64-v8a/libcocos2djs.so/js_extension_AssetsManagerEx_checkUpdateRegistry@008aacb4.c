...
/* js_extension_AssetsManagerEx_checkUpdateRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_extension_AssetsManagerEx_checkUpdateRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (AssetsManagerEx *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2c2,"js_extension_AssetsManagerEx_checkUpdate");
    __android_log_print(6,"jswrapper",
                        "js_extension_AssetsManagerEx_checkUpdate : Invalid Native Object");
  }
  else {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_extension_auto.cpp, 713): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_extension_AssetsManagerEx_checkUpdate",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_extension_auto.cpp"
                      ,0x2cc);
LAB_008aae04:
