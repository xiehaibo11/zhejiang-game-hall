...
/* void 
   v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::AllocateFPRegistersPhase<v8::internal::compiler::LinearScanAllocator>>()
    */
...

{
  ...
  *local_68;
  ...
  if (this_00 != (PipelineStatistics *)0x0) {
    PipelineStatistics::BeginPhase(this_00,"V8.TFAllocateFPRegisters");
  }
  this_01 = *(ZoneStats **)(lVar6 + 0x30);
  lVar5 = *(long *)(lVar6 + 0xb0);
  if (lVar5 != 0) {
    local_108 = *(undefined8 *)(lVar5 + 0x30);
    *(char **)(lVar5 + 0x30) = "V8.TFAllocateFPRegisters";
  }
  ...
  lVar3 = ZoneStats::NewEmptyZone(this_01,"V8.TFAllocateFPRegisters");
  LinearScanAllocator::LinearScanAllocator(aLStack_d8,*(undefined8 *)(lVar6 + 0x170),1,lVar3);
