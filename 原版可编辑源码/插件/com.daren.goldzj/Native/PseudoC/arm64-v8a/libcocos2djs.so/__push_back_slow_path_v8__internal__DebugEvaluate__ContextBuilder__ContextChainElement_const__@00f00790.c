...
/* void std::__ndk1::vector<v8::internal::DebugEvaluate::ContextBuilder::ContextChainElement,
   std::__ndk1::allocator<v8::internal::DebugEvaluate::ContextBuilder::ContextChainElement>
   >::__push_back_slow_path<v8::internal::DebugEvaluate::ContextBuilder::ContextChainElement
   const&>(v8::internal::DebugEvaluate::ContextBuilder::ContextChainElement const&) */
...
::__push_back_slow_path<v8::internal::DebugEvaluate::ContextBuilder::ContextChainElement_const&>
          (vector<v8::internal::DebugEvaluate::ContextBuilder::ContextChainElement,std::__ndk1::allocator<v8::internal::DebugEvaluate::ContextBuilder::ContextChainElement>>
           *this,ContextChainElement *param_1)

{
  ...
  if (uVar1 < 0xaaaaaaaaaaaaaab) {
    ...
    if (uVar1 == 0) {
      ...
      if (0xaaaaaaaaaaaaaaa < uVar1) goto LAB_00f0089c;
