...
/* js_cocos2dx_spine_Bone_setAScaleYRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_setAScaleYRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Bone *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x703,"js_cocos2dx_spine_Bone_setAScaleY");
    pcVar6 = "js_cocos2dx_spine_Bone_setAScaleY : Invalid Native Object";
LAB_00c1e1a0:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Bone::setAScaleY(this,local_64);
        goto LAB_00c1e1d8;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x70a,"js_cocos2dx_spine_Bone_setAScaleY");
      pcVar6 = "js_cocos2dx_spine_Bone_setAScaleY : Error processing arguments";
      goto LAB_00c1e1a0;
    }
    __android_log_print(6,"jswrapper",&DAT_018f6432,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_setAScaleY",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x711);
LAB_00c1e1d8:
