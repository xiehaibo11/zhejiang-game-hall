...
/* js_audioengine_AudioEngine_pauseRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_audioengine_AudioEngine_pauseRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (uVar6 == 0x10) {
    ...
    if ((uVar6 & 1) != 0) {
      cocos2d::AudioEngine::pause(local_64);
      goto LAB_0098a970;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_audioengine_auto.cpp"
                        ,0xfa,"js_audioengine_AudioEngine_pause");
    __android_log_print(6,"jswrapper",
                        "js_audioengine_AudioEngine_pause : Error processing arguments");
  }
  else {
                    /* try { // try from 0098a8e0 to 00a8a9db has its CatchHandler @ 0098aaa4 */
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_audioengine_auto.cpp, 254): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar6 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_audioengine_AudioEngine_pause",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_audioengine_auto.cpp"
                      ,0x101);
LAB_0098a970:
  ...
  if (*(long *)(lVar1 + 0x28) != local_38) {
    ...
    __stack_chk_fail();
                    ...
                    /* try { // try from 0098a9dc to 00a8aabf has its CatchHandler @ 0098a7b4 */
  return;
}
