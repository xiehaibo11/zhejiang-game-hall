...
/* js_cocos2dx_spine_IkConstraintData_setMixRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_IkConstraintData_setMixRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (IkConstraintData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x165b,"js_cocos2dx_spine_IkConstraintData_setMix");
    pcVar6 = "js_cocos2dx_spine_IkConstraintData_setMix : Invalid Native Object";
LAB_00c39e70:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::IkConstraintData::setMix(this,local_64);
        goto LAB_00c39ea8;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1662,"js_cocos2dx_spine_IkConstraintData_setMix");
      pcVar6 = "js_cocos2dx_spine_IkConstraintData_setMix : Error processing arguments";
      goto LAB_00c39e70;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 5734): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_IkConstraintData_setMix",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1669);
LAB_00c39ea8:
