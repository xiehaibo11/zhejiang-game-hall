...
void FUN_00debf08(long param_1,uint param_2)

{
  ...
  if (0 < (int)(param_2 - iVar10)) {
    ...
    if ((0 < iVar8) &&
       (FUN_00df2de8(param_1 + lVar9 * 0x18 + 0xe0,iVar10,param_2,__src,__dest), iVar8 != 1)) {
      lVar12 = param_1 + lVar9 * 0x18 + 200;
      do {
        FUN_00df2de8(lVar12,iVar10,param_2,__dest,__dest);
        lVar9 = lVar9 + -1;
        lVar12 = lVar12 + -0x18;
      } while (1 < lVar9);
    }
      ...
      if (uVar16 < 0xb) {
        ...
        if (piVar7[0x22] == 0) {
          ...
          if (0 < local_64) {
            ...
            iVar8 = -uVar3 - iVar8;
            do {
              FUN_00df38fc(local_70,iVar6,uVar16,lVar9);
              iVar8 = iVar8 + -1;
          ...
          do {
            ...
            iVar5 = FUN_00de3ddc(*(undefined8 *)(param_1 + 0x168),local_64 - iVar8);
            FUN_00dec60c(lVar14,iVar4,*(undefined4 *)(*(long *)(param_1 + 0x168) + 0x2c),iVar5,0);
            FUN_00de3dfc(*(undefined8 *)(param_1 + 0x168),local_64 - iVar8,lVar14,iVar4);
            ...
            if (*(int *)(lVar14 + 0x40) < *(int *)(lVar14 + 0x38)) {
              ...
              do {
                ...
                FUN_00df4754(lVar14);
                (*DAT_01d544c0)(uVar15,uVar2,1);
                FUN_00df38fc(uVar15,uVar2,uVar16,lVar11);
                iVar6 = iVar6 + 1;
        ...
        *(int *)(param_1 + 0x94) = *(int *)(param_1 + 0x94) + iVar10;
        ...
        if (piVar7[0x22] == 0) {
          ...
          iVar10 = 0;
          do {
            iVar6 = FUN_00de3ddc(*(undefined8 *)(param_1 + 0x168),local_64 - iVar10);
            FUN_00dec60c(local_70,iVar4,*(undefined4 *)(*(long *)(param_1 + 0x168) + 0x2c),iVar6,0);
            FUN_00de3dfc(*(undefined8 *)(param_1 + 0x168),local_64 - iVar10,local_70,iVar4);
            ...
            if (*(int *)(lVar9 + 0x40) < *(int *)(lVar9 + 0x38)) {
              ...
              do {
                ...
                uVar1 = uVar16 + iVar8;
                FUN_00df4754(lVar9);
                (*DAT_01d544c0)(lVar12,uVar2,1);
                lVar11 = *(long *)(param_1 + 0x10);
                (*DAT_01d547f0)(lVar12,*(long *)(lVar11 + 0x10) +
                                       (long)*(int *)(lVar11 + 0x30) * (long)(int)uVar1,uVar2);
                lVar14 = (long)((ulong)uVar1 << 0x20) >> 0x21;
                (*DAT_01d54868)(lVar12,*(long *)(lVar11 + 0x18) + *(int *)(lVar11 + 0x34) * lVar14,
                                *(long *)(lVar11 + 0x20) + *(int *)(lVar11 + 0x38) * lVar14,uVar2,
                                ~uVar1 & 1);
                if (*(long *)(lVar11 + 0x28) != 0) {
                  (*DAT_01d544b0)(lVar12 + 3,0,uVar2,1,
                                  *(long *)(lVar11 + 0x28) +
