...
undefined8 FUN_014d5014(undefined8 param_1,ulong *param_2,Isolate *param_3)
...
LAB_014d5050:
    ...
    if (((int)uVar6 == *(int *)(param_3 + 0xb0)) || ((int)uVar6 == *(int *)(param_3 + 0xa0))) {
      uStack_48 = __strlen_chk("String.prototype.toLocaleLowerCase",0x23);
      local_50 = "String.prototype.toLocaleLowerCase";
