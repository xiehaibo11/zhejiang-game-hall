...

{
  ...
  plVar4 = (long *)*param_1;
  if (plVar4 != (long *)0x0) goto LAB_01808e88;
LAB_01808ecc:
  bVar1 = true;
  if (param_3 == (long *)0x0) goto LAB_01808f0c;
  while( true ) {
    ...
    while( true ) {
      ...
      if ((uVar5 & 1) == 0) goto LAB_01808f7c;
      plVar4 = (long *)*param_1;
      ...
      if (plVar4 == (long *)0x0) goto LAB_01808ecc;
LAB_01808e88:
