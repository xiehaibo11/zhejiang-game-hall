...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<v8::internal::Isolate*,
   ...
   std::__ndk1::unique_ptr<v8::internal::wasm::WasmEngine::IsolateInfo,
   std::__ndk1::default_delete<v8::internal::wasm::WasmEngine::IsolateInfo> > > >
   >::remove(std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<v8::internal::Isolate*,
   std::__ndk1::unique_ptr<v8::internal::wasm::WasmEngine::IsolateInfo,
   std::__ndk1::default_delete<v8::internal::wasm::WasmEngine::IsolateInfo> > >, void*>*>) */
...

{
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar7 == uVar4) goto LAB_0120f594;
  }
  if (*param_3 != 0) {
