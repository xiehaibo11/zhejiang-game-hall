...
/* v8::internal::compiler::SimplifiedLowering::DoIntegerToUint8Clamped(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::SimplifiedLowering::DoIntegerToUint8Clamped
...

{
  ...
  pNVar1 = (Node *)MachineGraph::Float64Constant(*(MachineGraph **)this,0.0);
  uVar2 = MachineGraph::Float64Constant(*(MachineGraph **)this,255.0);
  ...
  Node::AppendInput(param_1,*(Zone **)**(undefined8 **)this,pNVar1);
  pOVar3 = (Operator *)
           CommonOperatorBuilder::Select(*(CommonOperatorBuilder **)(*(long *)this + 8),0xc,0);
