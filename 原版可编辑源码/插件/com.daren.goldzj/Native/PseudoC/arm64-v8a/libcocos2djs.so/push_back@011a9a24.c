...
/* std::__ndk1::__split_buffer<v8::internal::HeapEntry*,
   std::__ndk1::allocator<v8::internal::HeapEntry*>&>::push_back(v8::internal::HeapEntry*&&) */
...

{
  ...
  puVar12 = puVar4;
  if (puVar4 != *(undefined8 **)(this + 0x18)) goto LAB_011a9bac;
...
LAB_011a9b78:
      ...
      if (((void *)((long)pvVar6 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar6 + uVar13 * 8 + uVar9 + 8))) goto LAB_011a9b78;
      ...
      puVar11 = puVar12;
      if (uVar2 != uVar9) goto LAB_011a9b78;
    }
    puVar11 = *(undefined8 **)this;
  }
  *(void **)this = pvVar6;
