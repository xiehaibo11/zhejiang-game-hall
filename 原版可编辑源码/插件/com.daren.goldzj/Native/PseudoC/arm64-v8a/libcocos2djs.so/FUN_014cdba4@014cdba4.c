...
undefined8 FUN_014cdba4(int param_1,long param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_90,(ulong)&local_90 | 8,0x314);
  }
  if (DAT_01d46630 == (byte *)0x0) {
    plVar8 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d46630 = (byte *)(**(code **)(*plVar8 + 0x10))(plVar8,"disabled-by-default-v8.runtime");
  }
  pbVar4 = DAT_01d46630;
  local_b0 = (byte **)0x0;
  if ((*DAT_01d46630 & 5) != 0) {
    ...
    uVar9 = (**(code **)(*plVar8 + 0x18))
                      (plVar8,0x58,pbVar4,"V8.Builtin_ObjectIsFrozen",0,0,0,0,0,0,0,&local_60,0);
    plVar8 = local_58;
    local_58 = (long *)0x0;
    if (plVar8 != (long *)0x0) {
      (**(code **)(*plVar8 + 8))();
    ...
    local_b0 = &local_a8;
    local_a0 = "V8.Builtin_ObjectIsFrozen";
    local_a8 = pbVar4;
    local_98 = uVar9;
  }
  ...
  *(int *)(param_3 + 0x95b0) = iVar10;
  ...
  if (((uVar11 & 1) == 0) ||
    ...
    uVar7 = v8::internal::JSReceiver::TestIntegrityLevel(pIVar1,5);
