...
/* spine::EventData::setStringValue(spine::String const&) */

void __thiscall spine::EventData::setStringValue(EventData *this,String *param_1)

{
  ...
  if (this + 0x28 != (EventData *)param_1) {
