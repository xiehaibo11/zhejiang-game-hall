...
/* js_cocos2dx_spine_Event_setStringValueRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Event_setStringValueRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Event *)se::State::nativeThisObject(aSStack_70);
  if (this == (Event *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                        ,0x1242,"js_cocos2dx_spine_Event_setStringValue");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_Event_setStringValue : Invalid Native Object");
  }
  else {
    ...
    if (plVar5[1] - *plVar5 == 0x10) {
      ...
      spine::Event::setStringValue(this,(String *)&local_88);
      pvVar4 = local_78;
      local_88 = &PTR__String_01c67868;
    ...
    __android_log_print(6,"jswrapper",&DAT_01900133,(ulong)(plVar5[1] - *plVar5) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Event_setStringValue",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1250);
LAB_00c326a8:
