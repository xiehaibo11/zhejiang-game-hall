...
/* js_performance_nowRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_performance_nowRegistry(FunctionCallbackInfo *param_1)

{
  ...
  plVar5 = (long *)se::ScriptEngine::getInstance();
  lVar8 = *plVar5;
  pVVar6 = (Value *)se::State::rval(aSStack_60);
  se::Value::setNumber(pVVar6,(double)((lVar4 - lVar8) / 1000) * 0.001);
  pVVar6 = (Value *)se::State::rval(aSStack_60);
