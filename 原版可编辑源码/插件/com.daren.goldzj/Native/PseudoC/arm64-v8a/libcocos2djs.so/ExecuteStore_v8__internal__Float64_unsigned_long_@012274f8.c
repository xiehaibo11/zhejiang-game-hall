...
/* bool v8::internal::wasm::ThreadImpl::ExecuteStore<v8::internal::Float64, unsigned
   long>(v8::internal::wasm::Decoder*, v8::internal::wasm::InterpreterCode*, unsigned long, int*,
   v8::internal::MachineRepresentation, int) */

bool __thiscall
v8::internal::wasm::ThreadImpl::ExecuteStore<v8::internal::Float64,unsigned_long>
...

{
  ...
  *(long *)(this + 0x28) = lVar6 + -0x11;
  ...
  if (!CARRY4(local_97,uVar9)) {
    ...
    if (((7 < *(ulong *)(lVar6 + 0x13)) && ((ulong)uVar2 <= *(ulong *)(lVar6 + 0x13) - 8)) &&
       (puVar3 = (undefined8 *)((*(ulong *)(lVar6 + 0x1b) & (ulong)uVar2) + *(long *)(lVar6 + 0xb)),
