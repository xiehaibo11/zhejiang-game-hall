...

{
  ...
  long local_28;
                    ...
                    /* catch() { ... } // from try @ 009ab774 with catch @ 009ab934 */
  lVar1 = tpidr_el0;
  ...
  if (this[8] == (HttpClient)0x0) {
    ...
    local_40 = this;
    FUN_009ab9c8(atStack_30,&local_50);
    std::__ndk1::thread::detach(atStack_30);
    this[8] = (HttpClient)0x1;
    std::__ndk1::thread::~thread(atStack_30);
  }
                    /* try { // try from 009ab98c to 00aab9df has its CatchHandler @ 009ab98c
                       catch() { ... } // from try @ 009ab98c with catch @ 009ab98c
                       catch() { ... } // from try @ 009abaec with catch @ 009ab98c */
