...
void FUN_01525d50(Factory *param_1,ulong *param_2,ulong *param_3,int param_4,int param_5,
                 ulong param_6)

{
  ...
  local_58 = *param_3;
  uVar15 = *param_2;
  if ((*(uint *)(local_58 + 3) & 1) == 0) {
    uVar5 = *(uint *)(local_58 + 3) >> 3;
  }
  else {
    uVar5 = v8::internal::String::ComputeAndSetHash((String *)&local_58);
  }
...
LAB_01525ec4:
    ...
    if (param_5 == 0) {
      ...
      local_60 = *puVar6;
      v8::internal::AccessorPair::set((AccessorPair *)&local_60,param_5 != 1,param_6);
    }
    piVar7 = (int *)v8::internal::
                    ...
                    ::AddNoUpdateNextEnumerationIndex
                              (param_1,param_2,param_3,puVar6,
                               ((uint)(param_5 != 0) | param_4 << 8) + 0x6d0,&local_58);
  ...
  if (iVar13 != (int)*param_3) {
    iVar13 = 1;
    do {
      local_58 = (ulong)((int)local_58 + iVar13 & uVar4);
      lVar10 = local_58 * 0xc00000000;
  ...
  if (param_5 == 0) {
        ...
        if (iVar13 < param_4) {
          ...
          *puVar14 = (uint)param_6;
          ...
          if (((uint)uVar9 >> 0x12 & 1) != 0) {
            v8::internal::Heap_MarkingBarrierSlow(uVar15,puVar14,param_6);
            uVar9 = *(ulong *)(param_6 & 0xfffffffffffc0000 | 8);
          }
          if ((uVar9 & 0x18) == 0) {
            return;
          ...
          *puVar16 = (uint)param_6;
          ...
          uVar9 = *(ulong *)((param_6 & 0xfffffffffffc0000) + 8);
          if (((uint)uVar9 >> 0x12 & 1) != 0) {
            v8::internal::Heap_MarkingBarrierSlow(uVar15,puVar16,param_6);
            uVar9 = *(ulong *)(param_6 & 0xfffffffffffc0000 | 8);
          }
          if ((uVar9 & 0x18) == 0) {
            return;
    ...
    *(uint *)(lVar8 + lVar1) = uVar5 | 0x1a0;
    uVar15 = *param_2;
    lVar1 = uVar15 + ((long)(local_58 * 0xc00000000 + 0x1800000000) >> 0x20);
    *(int *)(lVar1 + 7) = (int)param_6;
    ...
    local_60 = *puVar6;
    v8::internal::AccessorPair::set((AccessorPair *)&local_60,param_5 != 1,param_6);
    *(uint *)(*param_2 + ((long)(local_58 * 0xc00000000 + 0x1c00000000) >> 0x20) + 7) =
         uVar5 | 0x1a2;
    uVar15 = *param_2;
    param_6 = *puVar6;
    lVar1 = uVar15 + ((long)(local_58 * 0xc00000000 + 0x1800000000) >> 0x20);
...
joined_r0x015261bc:
  if ((bVar3 & 0x18) == 0) {
    v8::internal::Heap_GenerationalBarrierSlow(uVar15,puVar14,param_6);
  }
  return;
}
