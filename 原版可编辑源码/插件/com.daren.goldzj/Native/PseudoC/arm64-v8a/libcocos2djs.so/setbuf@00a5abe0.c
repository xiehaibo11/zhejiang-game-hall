...

{
  ...
  *(undefined8 *)(this + 0x10) = 0;
                    /* catch() { ... } // from try @ 00a5ac8c with catch @ 00a5ac14 */
  ...
  *(long *)(this + 0x60) = param_2;
  if ((ulong)param_2 < 9) {
    ...
    *(basic_filebuf<char,std::__ndk1::char_traits<char>> **)(this + 0x40) = this + 0x58;
                    /* try { // try from 00a5ac60 to 00b5ac7f has its CatchHandler @ 00a5ace0 */
    ...
    if ((param_1 != (char *)0x0) &&
      ...
      *(char **)(this + 0x40) = param_1;
      ...
      goto LAB_00a5ac70;
                    ...
                    /* try { // try from 00a5ac8c to 00b5acfb has its CatchHandler @ 00a5ac14 */
  ...
  if (bVar1 == (basic_filebuf<char,std::__ndk1::char_traits<char>>)0x0) {
    ...
    *(long *)(this + 0x70) = param_2;
    if ((param_1 != (char *)0x0) && (7 < (ulong)param_2)) {
    ...
    *(void **)(this + 0x68) = pvVar2;
    ...
    return this;
                    /* catch() { ... } // from try @ 00a5ac84 with catch @ 00a5acdc */
  }
LAB_00a5ac70:
  this[0xa1] = (basic_filebuf<char,std::__ndk1::char_traits<char>>)0x0;
  *(undefined8 *)(this + 0x68) = 0;
  *(undefined8 *)(this + 0x70) = 0;
                    /* try { // try from 00a5ac84 to 00b5ac8b has its CatchHandler @ 00a5acdc */
  return this;
}
