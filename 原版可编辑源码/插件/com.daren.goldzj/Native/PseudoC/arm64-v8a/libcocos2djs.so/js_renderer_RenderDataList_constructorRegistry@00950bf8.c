...
/* js_renderer_RenderDataList_constructorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_RenderDataList_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Object *)
         se::Object::_createJSObject
                   (__jsb_cocos2d_renderer_RenderDataList_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_cocos2d_renderer_RenderDataList_finalizeRegistry);
  se::State::State(aSStack_60,this,(vector *)&local_a0);
                    /* try { // try from 00950c9c to 00a50ca3 has its CatchHandler @ 00951760 */
                    /* try { // try from 00950ca4 to 00a50d63 has its CatchHandler @ 009508b8 */
  ...
  if (this_00 != (Ref *)0x0) {
    ...
    *(undefined ***)this_00 = &PTR__RenderDataList_01c69758;
  }
  ...
  if (local_a0 != (Value *)0x0) {
    ...
    operator_delete(local_a0);
                    ...
                    /* try { // try from 00950d64 to 00a50d6b has its CatchHandler @ 0095175c */
  v8::HandleScope::~HandleScope(aHStack_88);
                    /* try { // try from 00950d6c to 00a50e2b has its CatchHandler @ 009508b8 */
