...
/* v8::internal::compiler::GraphAssembler::TypeGuard(v8::internal::compiler::Type,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::TypeGuard
          (GraphAssembler *this,undefined8 param_2,Node *param_3)
