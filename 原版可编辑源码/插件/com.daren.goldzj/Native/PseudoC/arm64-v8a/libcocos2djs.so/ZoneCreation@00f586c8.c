...
/* v8::internal::VerboseAccountingAllocator::ZoneCreation(v8::internal::Zone const*) */

void __thiscall
v8::internal::VerboseAccountingAllocator::ZoneCreation
...

{
  ...
  PrintF("{\"type\": \"%s\", \"isolate\": \"%p\", \"time\": %f, \"ptr\": \"%p\", \"name\": \"%s\", \"size\": %zu,\"nesting\": %zu}\n"
         ,dVar6 - *(double *)(lVar5 + 0x2e70),"zonecreation",lVar5 + -0x8850,param_1,
         *(undefined8 *)(param_1 + 0x30),*(long *)param_1 + lVar4,*(long *)pVVar1);
  do {
    cVar2 = '\x01';
