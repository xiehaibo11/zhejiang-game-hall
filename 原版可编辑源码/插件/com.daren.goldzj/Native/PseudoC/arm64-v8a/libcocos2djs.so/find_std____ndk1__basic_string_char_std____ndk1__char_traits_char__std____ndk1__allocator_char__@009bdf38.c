...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::allocator<cocos2d::renderer::BaseRenderer::StageItem> >&)> const>, void*>*>
...

{
  ...
  long local_68;
                    ...
                    /* catch() { ... } // from try @ 009bdcd4 with catch @ 009bdf48 */
                    /* catch() { ... } // from try @ 009bdd0c with catch @ 009bdf58
                       catch() { ... } // from try @ 009bdd60 with catch @ 009bdf58
                       catch() { ... } // from try @ 009bde30 with catch @ 009bdf58 */
  lVar5 = tpidr_el0;
  ...
  if (uVar13 != 0) {
    ...
    if ((uVar14 & uVar13) == 0) {
      ...
      uVar15 = uVar7;
      if (uVar13 <= uVar7) {
                    /* try { // try from 009bdfb0 to 00abe003 has its CatchHandler @ 009bdfb0
                       catch() { ... } // from try @ 009bdfb0 with catch @ 009bdfb0
                       catch() { ... } // from try @ 009be104 with catch @ 009bdfb0 */
        uVar15 = 0;
        if (uVar13 != 0) {
          uVar15 = uVar7 / uVar13;
        }
    ...
    if (plVar8 != (long *)0x0) {
      ...
      if (plVar8 != (long *)0x0) {
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            bVar3 = *(byte *)(plVar8 + 2);
                    /* try { // try from 009be004 to 00abe01b has its CatchHandler @ 009be180 */
            sVar1 = (ulong)(bVar3 >> 1);
            if ((bVar3 & 1) != 0) {
              sVar1 = plVar8[3];
            }
            if (sVar1 == __n) {
              __s1 = (void *)plVar8[4];
                    /* try { // try from 009be024 to 00abe02f has its CatchHandler @ 009be17c */
              if ((bVar3 & 1) == 0) {
                __s1 = (void *)((long)plVar8 + 0x11);
              }
              if ((bVar3 & 1) == 0) {
                if (__n == 0) break;
                    /* try { // try from 009be030 to 00abe03b has its CatchHandler @ 009be178 */
                pbVar10 = (basic_string *)((long)plVar8 + 0x11);
                lVar11 = -(ulong)(bVar3 >> 1);
                pbVar12 = pbVar2;
                    /* try { // try from 009be03c to 00abe103 has its CatchHandler @ 009be190 */
                while (*pbVar10 == *pbVar12) {
                  pbVar10 = pbVar10 + 1;
                  lVar11 = lVar11 + 1;
                  pbVar12 = pbVar12 + 1;
                  if (lVar11 == 0) goto LAB_009be0b4;
                }
              }
            ...
            if ((uVar14 & uVar13) == 0) {
              ...
              if (uVar9 - uVar4 * uVar13 == uVar15) goto LAB_009be08c;
              goto LAB_009be0b0;
            }
            if (uVar9 != uVar15) goto LAB_009be0b0;
          }
LAB_009be08c:
          plVar8 = (long *)*plVar8;
