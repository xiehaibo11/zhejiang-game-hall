...
/* js_cocos2dx_dragonbones_Matrix_get_aRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_Matrix_get_aRegistry(undefined8 param_1,PropertyCallbackInfo *param_2)

{
  ...
  if (pfVar3 == (float *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x5b,"js_cocos2dx_dragonbones_Matrix_get_a");
    __android_log_print(6,"jswrapper","js_cocos2dx_dragonbones_Matrix_get_a : Invalid Native Object"
                       );
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_dragonbones_Matrix_get_a",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,99);
  }
  else {
