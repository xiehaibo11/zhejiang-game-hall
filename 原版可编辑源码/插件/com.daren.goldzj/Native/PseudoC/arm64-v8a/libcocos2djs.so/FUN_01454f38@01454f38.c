...
void FUN_01454f38(undefined8 param_1,undefined8 param_2,undefined8 param_3,long param_4,
...

{
  ...
  *(undefined4 *)(lVar3 + 7) = uVar7;
                    /* WARNING: Could not recover jumptable at 0x01454f34. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + unaff_x19 + 3) * 8))(lVar3,auVar8._8_8_);
  return;
}
