...
undefined4 FUN_00e10844(long param_1,int param_2)

{
  ...
  if ((*(int *)(param_1 + 0x28) == 0) && (iVar3 = FUN_00e1075c(param_1), iVar3 == -1)) {
    return 0xffffffff;
  }
...
LAB_00e109f4:
            ...
            *(undefined8 *)(param_1 + 0x90) = uVar8;
            ...
            if (((int)sVar5 < 0) || ((int)sVar5 != iVar3)) goto LAB_00e10a44;
            iVar3 = *(int *)(param_1 + 0x98);
            if (iVar3 == 0) goto LAB_00e109f4;
            uVar8 = *(undefined8 *)(param_1 + 0x90);
          }
          *(undefined8 *)(param_1 + 8) = uVar8;
        }
        iVar4 = deflate(lVar1,0);
        if (iVar4 == -2) goto LAB_00e10a68;
      ...
      do {
        if ((iVar3 == 0) || (iVar4 == 1)) {
          ...
          if (iVar4 != 0) {
            sVar5 = write(*(int *)(param_1 + 0x1c),*(void **)(param_1 + 8),uVar9 & 0xffffffff);
            if (((int)sVar5 < 0) || ((int)sVar5 != iVar4)) goto LAB_00e10a44;
            iVar3 = *(int *)(param_1 + 0x98);
          }
          if (iVar3 == 0) {
            iVar3 = *(int *)(param_1 + 0x28);
        ...
        if (iVar4 == -2) {
LAB_00e10a68:
          FUN_00e0f54c(param_1,0xfffffffe,"internal error: deflate stream corrupt");
          return 0xffffffff;
        }
        bVar2 = iVar3 != *(int *)(param_1 + 0x98);
        iVar3 = *(int *)(param_1 + 0x98);
