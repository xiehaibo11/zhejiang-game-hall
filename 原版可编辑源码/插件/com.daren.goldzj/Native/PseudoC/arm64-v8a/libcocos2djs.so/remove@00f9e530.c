...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<v8::internal::JSArrayBuffer,
   ...
   std::__ndk1::shared_ptr<v8::internal::BackingStore> > >
   >::remove(std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<v8::internal::JSArrayBuffer,
   std::__ndk1::shared_ptr<v8::internal::BackingStore> >, void*>*>) */
...

{
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar7 == uVar4) goto LAB_00f9e60c;
  }
  if (*param_3 != 0) {
