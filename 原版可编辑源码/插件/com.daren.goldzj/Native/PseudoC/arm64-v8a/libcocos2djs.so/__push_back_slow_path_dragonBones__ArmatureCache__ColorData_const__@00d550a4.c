...
/* void std::__ndk1::vector<dragonBones::ArmatureCache::ColorData*,
   std::__ndk1::allocator<dragonBones::ArmatureCache::ColorData*>
   >::__push_back_slow_path<dragonBones::ArmatureCache::ColorData*
   const&>(dragonBones::ArmatureCache::ColorData* const&) */
...
LAB_00d55108:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d55108;
  }
  else {
