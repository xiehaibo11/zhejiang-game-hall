...
/* js_cocos2dx_dragonbones_ArmatureData_get_frameRateRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_ArmatureData_get_frameRateRegistry
...

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x54b,"js_cocos2dx_dragonbones_ArmatureData_get_frameRate");
    __android_log_print(6,"jswrapper",&DAT_01930906);
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_dragonbones_ArmatureData_get_frameRate",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x553);
  }
  else {
