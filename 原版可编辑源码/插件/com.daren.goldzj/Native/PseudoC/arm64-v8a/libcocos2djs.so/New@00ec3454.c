...
ulong * v8::NumberObject::New(Isolate *param_1,double param_2)

{
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_60,(ulong)&local_60 | 8,0x38d);
  }
  this = *(Logger **)(param_1 + 0x9558);
  uVar2 = internal::Logger::is_logging(this);
  if ((uVar2 & 1) != 0) {
    internal::Logger::ApiEntryCall(this,"v8::NumberObject::New");
  }
  uVar1 = *(undefined4 *)(param_1 + 0x2c60);
  *(undefined4 *)(param_1 + 0x2c60) = 5;
  puVar3 = (ulong *)internal::Factory::NewNumber<(v8::internal::AllocationType)0>
                              ((Factory *)param_1,param_2);
  uVar2 = *puVar3;
  if (((uVar2 & 1) == 0) ||
