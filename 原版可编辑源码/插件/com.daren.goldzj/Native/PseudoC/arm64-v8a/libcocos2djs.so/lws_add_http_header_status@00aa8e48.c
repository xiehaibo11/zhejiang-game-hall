...

{
  ...
  uVar5 = uVar1 - 400;
  if (uVar5 < 0x12) {
    ppuVar12 = &PTR_s_Bad_Request_01c6fcc8;
LAB_00aa8eb4:
...
LAB_00aa8f30:
    ...
    uVar5 = uVar1 - 500;
    if (uVar5 < 6) {
      ppuVar12 = &PTR_s_Internal_Server_Error_01c6fd58;
      goto LAB_00aa8eb4;
    }
    pcVar10 = "Continue";
    if (uVar1 != 100) {
    ...
    if (uVar1 != 0x130) goto LAB_00aa8ebc;
    pcVar10 = "Not Modified";
    uVar5 = *(uint *)(param_1 + 0x140);
    if (2 < uVar5) goto LAB_00aa8f30;
LAB_00aa8edc:
    pcVar6 = (&PTR_s_HTTP_1_0_01c6fcb0)[uVar5];
  }
  iVar3 = sprintf(acStack_a4,"%s %u %s",pcVar6,(ulong)uVar1,pcVar10);
  sVar13 = (size_t)iVar3;
  if (param_4 <= (char *)(*param_3 + sVar13 + 3)) goto LAB_00aa9200;
  ...
  *puVar8 = 10;
  for (plVar14 = *(long **)(*(long *)(param_1 + 0x228) + 0x1a0); plVar14 != (long *)0x0;
    ...
    if (pcVar10 != (char *)0x0) {
      ...
      if (pcVar9 == param_4) goto LAB_00aa9200;
      *param_3 = (long)(pcVar9 + 1);
      *pcVar9 = ' ';
    }
  ...
  if ((param_2 >> 0x1e & 1) == 0) {
    ...
    if (__src == (void *)0x0) goto LAB_00aa9118;
...
LAB_00aa9118:
                    /* catch() { ... } // from try @ 00aa95ac with catch @ 00aa9118 */
...
joined_r0x00aa9138:
    ...
    if (pcVar10 != param_4) {
                    /* try { // try from 00aa9188 to 00ba923f has its CatchHandler @ 00aa95cc */
      *param_3 = (long)(pcVar10 + 1);
      *pcVar10 = ' ';
