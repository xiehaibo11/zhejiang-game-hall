...
/* js_cls_set_globalCompositeOperationRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_cls_set_globalCompositeOperationRegistry
...

{
  ...
  pbVar6 = (basic_string *)se::State::nativeThisObject(aSStack_70);
  if (pbVar6 == (basic_string *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x19c,"js_cls_set_globalCompositeOperation");
    ...
    if (plVar7[1] - *plVar7 == 0x10) {
      ...
      if (bVar1) {
        ...
        cocos2d::CanvasRenderingContext2D::set_globalCompositeOperation(pbVar6);
      }
      if ((local_88 & 1) != 0) {
        operator_delete(local_78);
      }
      if (!bVar1) goto LAB_008e6d78;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_cocos2dx_manual.cpp, 412): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar7[1] - *plVar7) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cls_set_globalCompositeOperation",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_cocos2dx_manual.cpp"
                      ,0x19c);
LAB_008e6d78:
