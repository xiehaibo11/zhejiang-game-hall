...
/* void std::__ndk1::vector<v8::internal::wasm::WasmDataSegment,
   std::__ndk1::allocator<v8::internal::wasm::WasmDataSegment>
   >::__emplace_back_slow_path<v8::internal::wasm::WasmInitExpr&>(v8::internal::wasm::WasmInitExpr&)
    */
...

{
  ...
  if (uVar1 >> 0x3b == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3b != 0) goto LAB_015f5700;
