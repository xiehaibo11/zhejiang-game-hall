...
/* bool v8::internal::wasm::ThreadImpl::ExecuteLoad<int, short>(v8::internal::wasm::Decoder*,
   v8::internal::wasm::InterpreterCode*, unsigned long, int*, v8::internal::MachineRepresentation,
   int) */

bool __thiscall
v8::internal::wasm::ThreadImpl::ExecuteLoad<int,short>
...

{
  ...
  *(long *)(this + 0x28) = lVar7 + -0x11;
  ...
  if (!CARRY4(local_a0._1_4_,uVar11)) {
    ...
    if (((1 < *(ulong *)(lVar7 + 0x13)) && ((ulong)uVar2 <= *(ulong *)(lVar7 + 0x13) - 2)) &&
       (psVar3 = (short *)((*(ulong *)(lVar7 + 0x1b) & (ulong)uVar2) + *(long *)(lVar7 + 0xb)),
       psVar3 != (short *)0x0)) {
      uStack_98 = 0;
      local_a0 = (ulong)CONCAT41((int)*psVar3,1);
      local_90 = 0;
