...
/* void std::__ndk1::vector<dragonBones::EventObject*,
   std::__ndk1::allocator<dragonBones::EventObject*>
   >::__push_back_slow_path<dragonBones::EventObject* const&>(dragonBones::EventObject* const&) */
...
__push_back_slow_path<dragonBones::EventObject*const&>
          (vector<dragonBones::EventObject*,std::__ndk1::allocator<dragonBones::EventObject*>> *this
          ,EventObject **param_1)
...
LAB_00d29b84:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d29b84;
  }
  else {
