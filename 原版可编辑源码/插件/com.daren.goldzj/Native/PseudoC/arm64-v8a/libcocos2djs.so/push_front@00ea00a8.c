...
/* std::__ndk1::__split_buffer<std::__ndk1::unique_ptr<v8::Task,
   ...
   >*> >::push_front(std::__ndk1::unique_ptr<v8::Task, std::__ndk1::default_delete<v8::Task> >*&&)
    */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_00ea0234;
...
LAB_00ea0208:
      ...
      if (((void *)((long)pvVar4 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar4 + uVar9 + uVar13 * 8 + 8))) goto LAB_00ea0208;
      ...
      puVar7 = puVar8;
      if (uVar2 != uVar9) goto LAB_00ea0208;
    }
