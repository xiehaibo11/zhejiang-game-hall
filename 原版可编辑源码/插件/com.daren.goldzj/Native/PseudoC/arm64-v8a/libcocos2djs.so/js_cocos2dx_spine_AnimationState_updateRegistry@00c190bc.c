...
/* js_cocos2dx_spine_AnimationState_updateRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_AnimationState_updateRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (AnimationState *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x429,"js_cocos2dx_spine_AnimationState_update");
    pcVar6 = "js_cocos2dx_spine_AnimationState_update : Invalid Native Object";
LAB_00c19230:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::AnimationState::update(this,local_64);
        goto LAB_00c19268;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x430,"js_cocos2dx_spine_AnimationState_update");
      pcVar6 = "js_cocos2dx_spine_AnimationState_update : Error processing arguments";
      goto LAB_00c19230;
    }
    __android_log_print(6,"jswrapper",&DAT_018f40e7,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_AnimationState_update",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x437);
LAB_00c19268:
