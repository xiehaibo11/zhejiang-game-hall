...
/* v8::internal::TurboAssembler::Peek(v8::internal::CPURegister const&, v8::internal::Operand
   const&) */

void __thiscall
v8::internal::TurboAssembler::Peek(TurboAssembler *this,CPURegister *param_1,Operand *param_2)
...
LAB_012718bc:
  ...
  if (*(int *)(param_1 + 8) == 0) {
    ...
    if (uVar1 < 8) {
      uVar6 = *(undefined4 *)(&DAT_019f3888 + (long)(int)uVar1 * 4);
    }
    else {
      uVar6 = 0x4c00000;
    }
