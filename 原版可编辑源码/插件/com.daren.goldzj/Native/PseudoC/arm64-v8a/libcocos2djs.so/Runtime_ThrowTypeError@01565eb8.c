...
/* v8::internal::Runtime_ThrowTypeError(int, unsigned long*, v8::internal::Isolate*) */

undefined8 v8::internal::Runtime_ThrowTypeError(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar4 = FUN_01565fd0(param_1,param_2,param_3);
    return uVar4;
  }
