...
/* js_cocos2dx_spine_IkConstraintData_setStretchRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_IkConstraintData_setStretchRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (IkConstraintData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x15a3,"js_cocos2dx_spine_IkConstraintData_setStretch");
    pcVar6 = "js_cocos2dx_spine_IkConstraintData_setStretch : Invalid Native Object";
LAB_00c388a4:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::IkConstraintData::setStretch(this,local_64[0]);
        goto LAB_00c388dc;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x15aa,"js_cocos2dx_spine_IkConstraintData_setStretch");
      pcVar6 = "js_cocos2dx_spine_IkConstraintData_setStretch : Error processing arguments";
      goto LAB_00c388a4;
    }
    __android_log_print(6,"jswrapper",&DAT_01903139,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_IkConstraintData_setStretch",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x15b1);
LAB_00c388dc:
