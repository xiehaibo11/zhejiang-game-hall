...
/* double v8::internal::InternalStringToIntDouble<2, unsigned short const*, unsigned short
   const*>(unsigned short const*, unsigned short const*, bool, bool) */

double v8::internal::InternalStringToIntDouble<2,unsigned_short_const*,unsigned_short_const*>
...
LAB_01065f1c:
  ...
  while( true ) {
    lVar8 = lVar8 * 4 + (ulong)(ushort)uVar5 + -0x30;
    uVar7 = lVar8 >> 0x35;
    iVar6 = (int)(lVar8 >> 0x35);
    if (iVar6 != 0) break;
    param_1 = param_1 + 1;
    if (param_1 == param_2) goto LAB_01065f1c;
    uVar5 = (uint)*param_1;
    lVar4 = lVar4 + -2;
    if ((uVar5 & 0xfffc) != 0x30) goto joined_r0x01065eb8;
  }
  uVar9 = 1;
  if (1 < iVar6) {
    do {
  ...
  if (param_1 + 1 == param_2) {
    ...
    do {
      ...
      if ((0x33 < uVar2) || (9 < uVar2 - 0x30)) {
        uVar11 = (int)lVar12 + uVar5;
        if (!param_4) {
          lVar13 = 0;
          lVar4 = lVar4 - lVar12;
          do {
      ...
      lVar13 = lVar13 + -2;
      uVar10 = uVar10 & uVar2 == 0x30;
      lVar12 = lVar12 + 2;
    } while (lVar13 != 0);
    uVar11 = uVar5 + (int)lVar12;
  }
LAB_01066040:
  ...
  if ((int)uVar5 < (int)uVar1) {
    ...
    uVar7 = uVar7 + ((ulong)((uint)uVar7 | uVar10 ^ 0xffffffff) & 1);
  }
  uVar9 = uVar7 >> 0x35 & 1;
  ...
  dVar14 = ldexp((double)lVar8,uVar11 + (int)uVar9);
  return dVar14;
}
