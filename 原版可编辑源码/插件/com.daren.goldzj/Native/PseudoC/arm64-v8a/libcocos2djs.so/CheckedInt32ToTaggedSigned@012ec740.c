...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CheckedInt32ToTaggedSigned(v8::internal::compiler::FeedbackSource
   const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::CheckedInt32ToTaggedSigned
...

{
  ...
  if ((*(long *)param_1 == 0) || (*(int *)(param_1 + 8) == -1)) {
    pOVar3 = (Operator *)(*(long *)this + 0x1c38);
  }
  else {
    this_00 = *(Zone **)(this + 8);
    ...
    Operator::Operator(pOVar3,0x5c,0x38,"CheckedInt32ToTaggedSigned",1,1,1,1,1,0);
