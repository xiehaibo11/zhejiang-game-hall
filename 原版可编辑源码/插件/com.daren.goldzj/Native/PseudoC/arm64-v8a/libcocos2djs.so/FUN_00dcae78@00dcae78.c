...
undefined4 FUN_00dcae78(long *param_1,long param_2,uint param_3,uint param_4)
...
LAB_00dcb0c0:
      ...
      if ((uVar2 & 0x88) != 0) goto LAB_00dcb0b8;
      if ((1 << (ulong)(uVar7 & 0x1f) & 0x110U) != 0) goto LAB_00dcb0d0;
    }
    break;
  case 2:
  case 6:
    ...
    if (uVar7 < 9) {
      bVar13 = false;
      if ((1 << (ulong)(uVar7 & 0x1f) & 0x22U) != 0) goto LAB_00dcb0c0;
      uVar2 = 1 << (ulong)(uVar7 & 0x1f);
      if ((uVar2 & 0x88) != 0) goto LAB_00dcb0d4;
      if ((uVar2 & 0x110) != 0) goto LAB_00dcb0b8;
    }
    break;
  case 3:
  case 7:
        ...
        if ((lVar17 != -1) || ((int)param_1[1] == 0)) {
          ...
          lVar17 = TIFFReadEncodedStrip
                             (lVar24,uVar14,local_80,
                              lVar19 * (ulong)((uVar10 - uVar11 * local_64) + iVar4));
          if ((lVar17 != -1) || ((int)param_1[1] == 0)) goto LAB_00dcb28c;
        }
        goto LAB_00dcb398;
      }
LAB_00dcb28c:
      if (iVar5 != 0) {
        ...
        if ((lVar17 == -1) && ((int)param_1[1] != 0)) goto LAB_00dcb398;
      }
      uVar2 = (int)param_1[0x11] + uVar26;
      uVar10 = 0;
      if (local_64 != 0) {
