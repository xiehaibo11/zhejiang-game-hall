...
/* bool spine_Vector_T_ptr_to_seval<spine::Slot>(spine::Vector<spine::Slot*> const&, se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::Slot>(Vector *param_1,Value *param_2)
...
LAB_00c88a0c:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::Slot>
