...
/* void std::__ndk1::vector<v8::internal::wasm::NativeModule::CodeSpaceData,
   std::__ndk1::allocator<v8::internal::wasm::NativeModule::CodeSpaceData>
   >::__push_back_slow_path<v8::internal::wasm::NativeModule::CodeSpaceData>(v8::internal::wasm::NativeModule::CodeSpaceData&&)
    */
...

{
  ...
  if (uVar1 >> 0x3b == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3b != 0) goto LAB_01204774;
