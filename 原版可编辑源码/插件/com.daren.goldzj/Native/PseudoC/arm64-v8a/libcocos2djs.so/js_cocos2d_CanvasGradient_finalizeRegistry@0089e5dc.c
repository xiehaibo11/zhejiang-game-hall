...
/* js_cocos2d_CanvasGradient_finalizeRegistry(void*) */

void js_cocos2d_CanvasGradient_finalizeRegistry(void *param_1)

{
  ...
  if (param_1 != (void *)0x0) {
    ...
    if (lVar3 != lVar4) {
      ...
      this_00 = (CanvasGradient *)se::State::nativeThisObject(aSStack_60);
