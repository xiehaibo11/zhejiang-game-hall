...
/* v8::internal::compiler::EffectGraphReducer::Revisit(v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::EffectGraphReducer::Revisit(EffectGraphReducer *this,Node *param_1)
  ...
  if ((uVar1 & 0xff) == 3) {
    *(uint *)(param_1 + 0x10) = uVar3 + 1;
    ...
    if (*(long *)(this + 0x28) - lVar4 != 0) {
      uVar2 = (*(long *)(this + 0x28) - lVar4) * 0x40 - 1;
    }
