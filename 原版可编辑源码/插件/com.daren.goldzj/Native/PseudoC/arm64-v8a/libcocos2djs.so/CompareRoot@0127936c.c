...
/* v8::internal::MacroAssembler::CompareRoot(v8::internal::Register const&, v8::internal::RootIndex)
    */

void __thiscall
v8::internal::MacroAssembler::CompareRoot(MacroAssembler *this,Register *param_1,undefined4 param_3)
