...
/* v8::internal::ChunkedStream<unsigned short>::FindChunk(unsigned long,
   v8::internal::RuntimeCallStats*) */

void v8::internal::ChunkedStream<unsigned_short>::FindChunk(ulong param_1,RuntimeCallStats *param_2)
