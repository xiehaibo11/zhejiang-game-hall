...
/* v8::internal::compiler::TypedOptimization::ReduceSpeculativeToNumber(v8::internal::compiler::Node*)
    */

long __thiscall
v8::internal::compiler::TypedOptimization::ReduceSpeculativeToNumber
