...
/* v8::internal::Assembler::shrn2(v8::internal::VRegister const&, v8::internal::VRegister const&,
   int) */

void __thiscall
v8::internal::Assembler::shrn2(Assembler *this,VRegister *param_1,VRegister *param_2,int param_3)
