...
/* js_cocos2dx_spine_SkeletonAnimation_ctorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_SkeletonAnimation_ctorRegistry(FunctionCallbackInfo *param_1)
