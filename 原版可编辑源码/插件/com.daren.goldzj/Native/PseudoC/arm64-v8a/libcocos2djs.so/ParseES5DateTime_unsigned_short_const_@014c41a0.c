...
/* v8::internal::DateParser::DateToken v8::internal::DateParser::ParseES5DateTime<unsigned short
   const>(v8::internal::DateParser::DateStringTokenizer<unsigned short const>*,
   v8::internal::DateParser::DayComposer*, v8::internal::DateParser::TimeComposer*,
   v8::internal::DateParser::TimeZoneComposer*) */

long v8::internal::DateParser::ParseES5DateTime<unsigned_short_const>
...

{
  ...
  if ((int)lVar6 == -2) {
    if ((iVar5 != 0x2d) && (iVar5 != 0x2b)) goto LAB_014c45dc;
    auVar8 = DateStringTokenizer<unsigned_short_const>::Scan
                       ((DateStringTokenizer<unsigned_short_const> *)param_1);
    *(undefined1 (*) [12])(param_1 + 8) = auVar8;
    if (auVar8._0_8_ != 0x6fffffffd) {
      return lVar6;
    }
    auVar9 = DateStringTokenizer<unsigned_short_const>::Scan
                       ((DateStringTokenizer<unsigned_short_const> *)param_1);
...
LAB_014c428c:
    ...
    if (lVar6 != 0x4fffffffd) goto LAB_014c45dc;
    auVar8 = DateStringTokenizer<unsigned_short_const>::Scan
                       ((DateStringTokenizer<unsigned_short_const> *)param_1);
    *(undefined1 (*) [12])(param_1 + 8) = auVar8;
    if (*(int *)(param_2 + 0xc) < 3) {
  ...
  lVar6 = *(long *)(param_1 + 8);
  if ((int)lVar6 == -1) goto LAB_014c469c;
  if ((int)lVar6 != 3) {
LAB_014c45dc:
    auVar8 = DateStringTokenizer<unsigned_short_const>::Scan
                       ((DateStringTokenizer<unsigned_short_const> *)param_1);
  ...
  if (iVar5 == -2) {
    ...
    if ((uVar4 & 0xff) == 0x3a) {
      ...
      *(undefined1 (*) [12])(param_1 + 8) = auVar8;
      ...
      if (iVar5 == -2) {
        uVar4 = *(uint *)(param_1 + 0x10);
        if ((uVar4 & 0xff) != 0x2e) goto LAB_014c458c;
        auVar7 = DateStringTokenizer<unsigned_short_const>::Scan
                           ((DateStringTokenizer<unsigned_short_const> *)param_1);
