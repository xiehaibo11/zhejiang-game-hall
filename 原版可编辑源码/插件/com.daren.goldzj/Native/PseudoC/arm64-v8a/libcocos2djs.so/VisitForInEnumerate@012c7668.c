...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitForInEnumerate(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitForInEnumerate
