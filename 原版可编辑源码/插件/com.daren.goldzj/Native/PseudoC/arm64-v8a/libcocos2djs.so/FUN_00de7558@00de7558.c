...
undefined8 FUN_00de7558(int *param_1,long *param_2)

{
  ...
  if ((lVar8 != 0) && (iVar9 = param_1[4], 0 < iVar9)) {
    ...
    iVar1 = *param_1;
    do {
      iVar5 = FUN_00de3dfc(param_2 + 0x2d,iVar9,lVar8,iVar1);
      iVar9 = iVar9 - iVar5;
      lVar8 = lVar8 + iVar5 * iVar1;
      iVar5 = FUN_00de3ef8(param_2 + 0x2d);
      iVar7 = iVar5 + iVar7;
    } while (0 < iVar9);
    if (0 < iVar7) {
      FUN_00dec674(lVar6 + (long)iVar2 * (long)(int)lVar4,*(undefined4 *)(lVar10 + 0x30),
