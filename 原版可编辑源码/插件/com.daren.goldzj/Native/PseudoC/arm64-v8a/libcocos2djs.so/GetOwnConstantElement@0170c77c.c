...
/* v8::internal::compiler::JSObjectData::GetOwnConstantElement(v8::internal::compiler::JSHeapBroker*,
   unsigned int, v8::internal::compiler::SerializationPolicy) */

undefined8 __thiscall
v8::internal::compiler::JSObjectData::GetOwnConstantElement
          (JSObjectData *this,JSHeapBroker *param_1,uint param_2,int param_4)

{
  ...
  while (puVar2 = puVar1, puVar2 != *(uint **)(this + 0x60)) {
    puVar1 = puVar2 + 4;
    if (*puVar2 == param_2) {
  ...
  if (param_4 == 0) {
    if (param_1[0x74] != (JSHeapBroker)0x0) {
      ...
      pbVar6 = (basic_ostream *)
               std::__ndk1::basic_ostream<char,std::__ndk1::char_traits<char>>::operator<<
                         ((basic_ostream<char,std::__ndk1::char_traits<char>> *)pbVar6,0x17d);
      pbVar6 = std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>
                         (pbVar6,")",1);
  ...
  if (puVar1 < *(uint **)(this + 0x68)) {
    *puVar1 = param_2;
    *(undefined8 *)(puVar1 + 2) = uVar5;
    *(long *)(this + 0x60) = *(long *)(this + 0x60) + 0x10;
    return uVar5;
  }
  lVar11 = (long)puVar1 - *(long *)(this + 0x58) >> 4;
  uVar12 = lVar11 + 1;
  if (uVar12 >> 0x1b == 0) {
    lVar8 = (long)*(uint **)(this + 0x68) - *(long *)(this + 0x58);
    uVar9 = lVar8 >> 3;
    if (uVar12 <= uVar9) {
      uVar12 = uVar9;
    }
    ...
    *(undefined8 *)(puVar1 + 2) = uVar5;
    ...
    puVar2 = puVar1;
    for (lVar10 = *(long *)(this + 0x60); lVar10 != lVar11; lVar10 = lVar10 + -0x10) {
      uVar14 = *(undefined8 *)(lVar10 + -0x10);
      *(undefined8 *)(puVar2 + -2) = *(undefined8 *)(lVar10 + -8);
      *(undefined8 *)(puVar2 + -4) = uVar14;
      puVar2 = puVar2 + -4;
    }
    *(uint **)(this + 0x58) = puVar2;
    *(uint **)(this + 0x60) = puVar1 + 4;
    *(ulong *)(this + 0x68) = lVar8 + uVar12 * 0x10;
    return uVar5;
  }
