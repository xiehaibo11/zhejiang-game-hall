...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CheckedUint64ToInt32(v8::internal::compiler::FeedbackSource
   const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::CheckedUint64ToInt32
...

{
  ...
  if ((*(long *)param_1 == 0) || (*(int *)(param_1 + 8) == -1)) {
    pOVar3 = (Operator *)(*(long *)this + 0x1f08);
  }
  else {
    this_00 = *(Zone **)(this + 8);
    ...
    Operator::Operator(pOVar3,99,0x38,"CheckedUint64ToInt32",1,1,1,1,1,0);
