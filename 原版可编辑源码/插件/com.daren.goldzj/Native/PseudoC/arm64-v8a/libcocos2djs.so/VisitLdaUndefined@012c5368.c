...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitLdaUndefined(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitLdaUndefined
...

{
  ...
  local_28 = 0;
  Hints::AddConstant((Hints *)&local_28,lVar3 + 0xa0,lVar2);
