...
/* v8::internal::Protectors::InvalidatePromiseHook(v8::internal::Isolate*) */

void v8::internal::Protectors::InvalidatePromiseHook(Isolate *param_1)

{
  undefined8 *puVar1;
  
  if (FLAG_trace_protector_invalidation != '\0') {
    FUN_00f60ca4("PromiseHook");
  }
  ...
  PropertyCell::SetValueWithInvalidation(param_1,"promise_hook_protector",param_1 + 0xee8,puVar1);
  return;
}
