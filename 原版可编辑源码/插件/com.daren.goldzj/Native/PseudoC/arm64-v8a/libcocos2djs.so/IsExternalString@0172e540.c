...
/* v8::internal::compiler::StringRef::IsExternalString() const */

bool __thiscall v8::internal::compiler::StringRef::IsExternalString(StringRef *this)

{
  ...
  if (*(int *)(*(undefined8 **)this + 1) == 2) {
    ...
    if (*(ushort *)(uVar3 + *(uint *)(uVar2 - 1)) < 0x40) {
      return (*(ushort *)(uVar3 + *(uint *)(uVar2 - 1)) & 7) == 2;
    }
    return false;
  }
