...
/* js_cocos2dx_spine_TrackEntry_setAnimationEndRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_TrackEntry_setAnimationEndRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TrackEntry *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xcd,"js_cocos2dx_spine_TrackEntry_setAnimationEnd");
    puVar6 = &DAT_018f0c9c;
LAB_00c12ff8:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::TrackEntry::setAnimationEnd(this,local_64);
        goto LAB_00c13030;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0xd4,"js_cocos2dx_spine_TrackEntry_setAnimationEnd");
      puVar6 = &DAT_018f0ce1;
      goto LAB_00c12ff8;
    }
    __android_log_print(6,"jswrapper",&DAT_018f0d2b,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TrackEntry_setAnimationEnd",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0xdb);
LAB_00c13030:
