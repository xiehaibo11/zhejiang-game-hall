...
/* v8::internal::ObjectHashTableBase<v8::internal::EphemeronHashTable,
   v8::internal::EphemeronHashTableShape>::Put(v8::internal::Isolate*,
...
ulong * v8::internal::
        ...
        ::Put(long param_1,ulong *param_2,ulong *param_3,ulong *param_4,uint param_5)

{
  ...
  if (*piVar14 >> 1 < (int)(*(uint *)(uVar9 + 0xb) & 0xfffffffe)) {
    local_68 = uVar9;
    HashTable<v8::internal::EphemeronHashTable,v8::internal::EphemeronHashTableShape>::Rehash
  ...
  puVar8 = (ulong *)HashTable<v8::internal::EphemeronHashTable,v8::internal::EphemeronHashTableShape>
