...
/* std::__ndk1::__split_buffer<int*, v8::internal::RecyclingZoneAllocator<int*>&>::push_front(int*
   const&) */

void __thiscall
std::__ndk1::__split_buffer<int*,v8::internal::RecyclingZoneAllocator<int*>&>::push_front
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_01669520;
  ...
  if (puVar6 != puVar1) {
    ...
    if ((3 < uVar3) && ((puVar6 + uVar10 + 1 <= __src || (puVar2 + uVar10 + uVar7 + 1 <= puVar6))))
    {
      ...
      puVar8 = __src + uVar10;
      if (uVar3 == uVar10) goto LAB_016694d4;
    }
    do {
      puVar12 = puVar6 + 1;
      *puVar8 = *puVar6;
