...
/* v8::internal::compiler::GraphAssembler::BitcastTaggedToWordForTagAndSmiBits(v8::internal::compiler::Node*)
    */

Node * __thiscall
v8::internal::compiler::GraphAssembler::BitcastTaggedToWordForTagAndSmiBits
          (GraphAssembler *this,Node *param_1)
