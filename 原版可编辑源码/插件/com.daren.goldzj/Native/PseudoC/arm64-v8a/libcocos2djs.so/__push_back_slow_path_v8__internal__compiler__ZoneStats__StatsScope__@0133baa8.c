...
/* void std::__ndk1::vector<v8::internal::compiler::ZoneStats::StatsScope*,
   std::__ndk1::allocator<v8::internal::compiler::ZoneStats::StatsScope*>
   >::__push_back_slow_path<v8::internal::compiler::ZoneStats::StatsScope*>(v8::internal::compiler::ZoneStats::StatsScope*&&)
    */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_0133bb90;
