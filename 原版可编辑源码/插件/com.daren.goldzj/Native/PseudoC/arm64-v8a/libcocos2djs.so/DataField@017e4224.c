...
/* WARNING: Removing unreachable block (ram,0x017e4350) */
/* v8::internal::compiler::PropertyAccessInfo::DataField(v8::internal::Zone*,
...
void __thiscall
v8::internal::compiler::PropertyAccessInfo::DataField
