...
/* v8::internal::wasm::LiftoffAssembler::CacheState::Split(v8::internal::wasm::LiftoffAssembler::CacheState
   const&) */

void __thiscall
v8::internal::wasm::LiftoffAssembler::CacheState::Split(CacheState *this,CacheState *param_1)
