...
/* js_cocos2dx_dragonbones_EventObject_get_armatureRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_EventObject_get_armatureRegistry
...

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1958,"js_cocos2dx_dragonbones_EventObject_get_armature");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_EventObject_get_armature : Invalid Native Object");
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_dragonbones_EventObject_get_armature",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x1960);
  }
  else {
    se::Value::Value(aVStack_58);
    native_ptr_to_rooted_seval<dragonBones::Armature>
              (*(type **)(lVar3 + 0x48),aVStack_58,(bool *)0x0);
