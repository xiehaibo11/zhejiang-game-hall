...

{
  ...
  do {
    ...
    uVar3 = uVar6 - 1;
  } while (((&DAT_018ce116)[f[uVar6 - 1]] | 0x13) == 0xf3);
  if ((uVar6 & 3) != 0) {
    return -1;
  }
  if ((int)uVar6 < 1) {
  ...
  do {
    if ((char)uVar5 < '\0') {
      uVar5 = 0xff;
      bVar9 = f[lVar7 + 1];
      if ((char)bVar9 < '\0') goto LAB_00bcb444;
LAB_00bcb42c:
      uVar8 = (uint)(byte)(&DAT_018ce116)[bVar9];
    }
    else {
      uVar5 = (uint)(byte)(&DAT_018ce116)[uVar5 & 0xff];
      bVar9 = f[lVar7 + 1];
      if (-1 < (char)bVar9) goto LAB_00bcb42c;
LAB_00bcb444:
      uVar8 = 0xff;
    }
    if ((char)f[lVar7 + 2] < '\0') {
      uVar10 = 0xff;
      bVar9 = f[lVar7 + 3];
      if ((char)bVar9 < '\0') goto LAB_00bcb47c;
LAB_00bcb464:
      bVar9 = (&DAT_018ce116)[bVar9];
    }
    else {
      uVar10 = (uint)(byte)(&DAT_018ce116)[f[lVar7 + 2]];
      bVar9 = f[lVar7 + 3];
      if (-1 < (char)bVar9) goto LAB_00bcb464;
LAB_00bcb47c:
      bVar9 = 0xff;
    }
