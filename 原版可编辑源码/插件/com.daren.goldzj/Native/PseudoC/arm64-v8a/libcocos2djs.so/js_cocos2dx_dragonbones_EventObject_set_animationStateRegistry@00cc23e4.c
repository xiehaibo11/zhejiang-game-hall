...
/* js_cocos2dx_dragonbones_EventObject_set_animationStateRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_EventObject_set_animationStateRegistry
...

{
  ...
  if (lVar7 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x19ba,"js_cocos2dx_dragonbones_EventObject_set_animationState");
    pcVar9 = "js_cocos2dx_dragonbones_EventObject_set_animationState : Invalid Native Object";
  }
  else {
...
LAB_00cc251c:
    ...
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x19bf,"js_cocos2dx_dragonbones_EventObject_set_animationState");
    pcVar9 = "js_cocos2dx_dragonbones_EventObject_set_animationState : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar9);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_EventObject_set_animationState",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x19c3);
LAB_00cc2594:
