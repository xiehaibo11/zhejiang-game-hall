...
void FUN_00a048a4(long *param_1,ulong param_2)
...
joined_r0x00a04954:
      if (plVar7 != (long *)0x0) {
        do {
          ...
          if ((uVar6 & param_2) == 0) {
            uVar8 = uVar8 & uVar6;
            if (uVar8 != uVar4) goto LAB_00a04998;
LAB_00a0495c:
            plVar10 = (long *)*plVar7;
            plVar5 = plVar7;
          }
            ...
            if (uVar8 == uVar4) goto LAB_00a0495c;
LAB_00a04998:
            plVar10 = plVar7;
            if (*(long *)(*param_1 + uVar8 * 8) == 0) goto LAB_00a049f4;
            do {
              plVar9 = plVar10;
              plVar10 = (long *)*plVar9;
