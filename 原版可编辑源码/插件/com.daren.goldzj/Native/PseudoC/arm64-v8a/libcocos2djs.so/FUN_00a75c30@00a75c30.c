...
void FUN_00a75c30(long param_1,undefined1 *param_2,PcmData *param_3)

{
  ...
  uVar1 = *param_2;
  cocos2d::PcmData::PcmData(aPStack_120,param_3);
  local_f0 = *(long *)(param_1 + 0x10);
  plVar6 = *(long **)(local_f0 + 0x50);
  local_e8 = uVar1;
  cocos2d::PcmData::PcmData(aPStack_e0,aPStack_120);
  ...
  *plVar3 = (long)&PTR_FUN_01c6efc0;
  *(undefined1 *)(plVar3 + 3) = local_e8;
  plVar3[2] = local_f0;
  cocos2d::PcmData::PcmData((PcmData *)(plVar3 + 4),aPStack_e0);
...
LAB_00a75d90:
  ...
  if (alStack_b0 == local_90) {
    ...
    if (local_90 == (long *)0x0) goto LAB_00a75dc4;
    pcVar5 = *(code **)(*local_90 + 0x28);
  }
  (*pcVar5)();
LAB_00a75dc4:
  cocos2d::PcmData::~PcmData(aPStack_e0);
  cocos2d::PcmData::~PcmData(aPStack_120);
