...
/* void std::__ndk1::vector<cocos2d::renderer::IndexBuffer*,
   std::__ndk1::allocator<cocos2d::renderer::IndexBuffer*>
   >::__push_back_slow_path<cocos2d::renderer::IndexBuffer* const&>(cocos2d::renderer::IndexBuffer*
   const&) */
