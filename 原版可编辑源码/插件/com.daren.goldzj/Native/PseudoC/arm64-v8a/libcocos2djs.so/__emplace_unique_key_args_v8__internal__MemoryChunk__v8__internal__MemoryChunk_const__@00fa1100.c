...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<v8::internal::MemoryChunk*,
   void*>*>, bool> std::__ndk1::__hash_table<v8::internal::MemoryChunk*,
   std::__ndk1::hash<v8::internal::MemoryChunk*>, std::__ndk1::equal_to<v8::internal::MemoryChunk*>,
   std::__ndk1::allocator<v8::internal::MemoryChunk*>
   >::__emplace_unique_key_args<v8::internal::MemoryChunk*, v8::internal::MemoryChunk*
   const&>(v8::internal::MemoryChunk* const&, v8::internal::MemoryChunk* const&) */
...
::__emplace_unique_key_args<v8::internal::MemoryChunk*,v8::internal::MemoryChunk*const&>
          (__hash_table<v8::internal::MemoryChunk*,std::__ndk1::hash<v8::internal::MemoryChunk*>,std::__ndk1::equal_to<v8::internal::MemoryChunk*>,std::__ndk1::allocator<v8::internal::MemoryChunk*>>
           *this,MemoryChunk **param_1,MemoryChunk **param_2)

{
  ...
  *p_Var4;
  ...
  pMVar2 = *param_1;
  uVar7 = ((ulong)(uint)((int)pMVar2 << 3) + 8 ^ (ulong)pMVar2 >> 0x20) * -0x622015f714c7d297;
  uVar10 = *(ulong *)(this + 8);
  uVar7 = (uVar7 ^ (ulong)pMVar2 >> 0x20 ^ uVar7 >> 0x2f) * -0x622015f714c7d297;
      ...
      for (plVar9 = (long *)*plVar9; plVar9 != (long *)0x0; plVar9 = (long *)*plVar9) {
        ...
        if (uVar8 != uVar7) {
          if (uVar5 < 2) {
            ...
            if (uVar8 - uVar1 * uVar10 == unaff_x24) goto LAB_00fa11c4;
            break;
          }
          if (uVar8 != unaff_x24) break;
        }
LAB_00fa11c4:
        if ((MemoryChunk *)plVar9[2] == pMVar2) {
          return plVar9;
        }
      }
    }
