...
/* std::__ndk1::vector<v8::internal::compiler::TopLevelLiveRange*,
   v8::internal::ZoneAllocator<v8::internal::compiler::TopLevelLiveRange*> >::__append(unsigned
   long, v8::internal::compiler::TopLevelLiveRange* const&) */
...
::__append(vector<v8::internal::compiler::TopLevelLiveRange*,v8::internal::ZoneAllocator<v8::internal::compiler::TopLevelLiveRange*>>
           *this,ulong param_1,TopLevelLiveRange **param_2)

{
  ...
  if ((3 < param_1) &&
     (((undefined8 *)((long)param_2 + 1U) <= puVar4 ||
      ((TopLevelLiveRange **)(lVar5 + (lVar11 + param_1) * 8) <= param_2)))) {
    pTVar2 = *param_2;
