...
/* js_cocos2dx_particle_ParticleSimulator_set_rotationIsDirRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_particle_ParticleSimulator_set_rotationIsDirRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x472,"js_cocos2dx_particle_ParticleSimulator_set_rotationIsDir");
    pcVar8 = "js_cocos2dx_particle_ParticleSimulator_set_rotationIsDir : Invalid Native Object";
  }
  else {
    uVar7 = seval_to_boolean((Value *)*puVar5,local_74);
    if ((uVar7 & 1) != 0) {
      *(bool *)(lVar6 + 0x170) = local_74[0];
      goto LAB_00c0bde0;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                        ,0x477,"js_cocos2dx_particle_ParticleSimulator_set_rotationIsDir");
    pcVar8 = "js_cocos2dx_particle_ParticleSimulator_set_rotationIsDir : Error processing new value"
    ;
  }
  __android_log_print(6,"jswrapper",pcVar8);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_particle_ParticleSimulator_set_rotationIsDir",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                      ,0x47b);
LAB_00c0bde0:
