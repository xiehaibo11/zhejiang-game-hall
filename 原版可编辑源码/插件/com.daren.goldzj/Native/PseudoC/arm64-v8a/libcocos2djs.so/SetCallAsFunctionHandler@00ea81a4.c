...
/* v8::ObjectTemplate::SetCallAsFunctionHandler(void (*)(v8::FunctionCallbackInfo<v8::Value>
   const&), v8::Local<v8::Value>) */

void __thiscall
v8::ObjectTemplate::SetCallAsFunctionHandler(ObjectTemplate *this,ulong param_1,ulong *param_3)
...
LAB_00ea8288:
  puVar9 = (ulong *)internal::Factory::NewCallHandlerInfo(this_00,false);
  if (param_1 == 0) {
  ...
  *(int *)(uVar15 + 3) = (int)uVar11;
  ...
  local_68 = *puVar9;
  uVar11 = internal::CallHandlerInfo::redirected_callback((CallHandlerInfo *)&local_68);
  if (uVar11 == 0) {
    if (*(CanonicalHandleScope **)(this_00 + 0x95b8) == (CanonicalHandleScope *)0x0) {
      puVar10 = *(ulong **)(this_00 + 0x95a0);
      if (puVar10 == (ulong *)*plVar2) {
    ...
    puVar10 = (ulong *)internal::Factory::NewForeign(this_00,uVar11);
  }
  uVar15 = *puVar9;
  uVar11 = *puVar10;
  *(int *)(uVar15 + 7) = (int)uVar11;
  if ((uVar11 & 1) != 0) {
    uVar13 = *(ulong *)((uVar11 & 0xfffffffffffc0000) + 8);
    if (((uint)uVar13 >> 0x12 & 1) != 0) {
      internal::Heap_MarkingBarrierSlow(uVar15,uVar15 + 7,uVar11);
      uVar13 = *(ulong *)(uVar11 & 0xfffffffffffc0000 | 8);
    }
    if (((uVar13 & 0x18) != 0) && ((*(byte *)((uVar15 & 0xfffffffffffc0000) + 8) & 0x18) == 0)) {
      internal::Heap_GenerationalBarrierSlow(uVar15,uVar15 + 7,uVar11);
    }
  }
  uVar11 = *puVar9;
  ...
  uVar15 = *puVar10;
  *(int *)(uVar11 + 0xb) = (int)uVar15;
  if ((uVar15 & 1) != 0) {
    uVar13 = *(ulong *)((uVar15 & 0xfffffffffffc0000) + 8);
    if (((uint)uVar13 >> 0x12 & 1) != 0) {
      internal::Heap_MarkingBarrierSlow(uVar11,uVar11 + 0xb,uVar15);
      uVar13 = *(ulong *)(uVar15 & 0xfffffffffffc0000 | 8);
    }
    if (((uVar13 & 0x18) != 0) && ((*(byte *)((uVar11 & 0xfffffffffffc0000) + 8) & 0x18) == 0)) {
      internal::Heap_GenerationalBarrierSlow(uVar11,uVar11 + 0xb,uVar15);
    }
  }
  ...
  uVar15 = *puVar9;
  *(int *)(uVar11 + 0x1b) = (int)uVar15;
  if ((uVar15 & 1) != 0) {
    uVar13 = *(ulong *)((uVar15 & 0xfffffffffffc0000) + 8);
    if (((uint)uVar13 >> 0x12 & 1) != 0) {
      internal::Heap_MarkingBarrierSlow(uVar11,uVar11 + 0x1b,uVar15);
      uVar13 = *(ulong *)(uVar15 & 0xfffffffffffc0000 | 8);
    }
    if (((uVar13 & 0x18) != 0) && ((*(byte *)((uVar11 & 0xfffffffffffc0000) + 8) & 0x18) == 0)) {
      internal::Heap_GenerationalBarrierSlow(uVar11,uVar11 + 0x1b,uVar15);
    }
  }
  *puVar3 = uVar14;
  *piVar1 = *piVar1 + -1;
