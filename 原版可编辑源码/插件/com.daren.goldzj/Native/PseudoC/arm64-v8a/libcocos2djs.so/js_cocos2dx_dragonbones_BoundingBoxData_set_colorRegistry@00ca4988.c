...
/* js_cocos2dx_dragonbones_BoundingBoxData_set_colorRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_BoundingBoxData_set_colorRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x913,"js_cocos2dx_dragonbones_BoundingBoxData_set_color");
    pcVar8 = "js_cocos2dx_dragonbones_BoundingBoxData_set_color : Invalid Native Object";
  }
  else {
    local_74 = 0;
    ...
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x918,"js_cocos2dx_dragonbones_BoundingBoxData_set_color");
    pcVar8 = "js_cocos2dx_dragonbones_BoundingBoxData_set_color : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar8);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_BoundingBoxData_set_color",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x91c);
LAB_00ca4b24:
