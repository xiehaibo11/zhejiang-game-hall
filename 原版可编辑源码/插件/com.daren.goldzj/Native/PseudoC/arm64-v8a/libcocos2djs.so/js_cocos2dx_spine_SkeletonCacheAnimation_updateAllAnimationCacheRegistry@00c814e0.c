...
/* js_cocos2dx_spine_SkeletonCacheAnimation_updateAllAnimationCacheRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonCacheAnimation_updateAllAnimationCacheRegistry
...

{
  ...
  if (this == (SkeletonCacheAnimation *)0x0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonCacheAnimation_updateAllAnimationCache : Invalid Native Object"
                       );
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      spine::SkeletonCacheAnimation::updateAllAnimationCache(this);
      goto LAB_00c81630;
    }
    __android_log_print(6,"jswrapper",&DAT_01923f7b,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
