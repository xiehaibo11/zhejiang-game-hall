...
void FUN_0144c3d0(long param_1,ulong param_2,undefined8 param_3,long param_4,int param_5,
...
LAB_0144c52c:
    ...
    if (sVar3 != 0x43) goto LAB_0144c52c;
    if ((param_2 & 1) == 0) {
      uVar7 = 0x1e;
    }
    else {
      ...
      if ((int)lVar2 == (int)*(undefined8 *)(unaff_x26 + 0x140)) {
        ...
        if (*(short *)(lVar2 + 7) != 0x43) goto LAB_0144c52c;
        uVar7 = 0x1e;
      }
    }
  }
  ...
  if (param_5 == 0) {
    ...
    if (uVar6 != uVar7) {
      ...
      *(undefined4 *)(param_6 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0144c310. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(unaff_x21 + (ulong)*(byte *)(*(long *)(param_4 + -0x18) + unaff_x19 + 5) * 8))(uVar5)
  ;
  return;
}
