...
/* js_engine_FileUtils_getFileExtensionRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_engine_FileUtils_getFileExtensionRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar5 == (long *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2c9,"js_engine_FileUtils_getFileExtension");
    __android_log_print(6,"jswrapper","js_engine_FileUtils_getFileExtension : Invalid Native Object"
                       );
  }
  else {
    ...
    if (plVar6[1] - *plVar6 == 0x10) {
      ...
      if ((uVar7 & 1) == 0) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                            ,0x2d0,"js_engine_FileUtils_getFileExtension");
        __android_log_print(6,"jswrapper",
                            "js_engine_FileUtils_getFileExtension : Error processing arguments");
        bVar1 = false;
      }
      else {
        (**(code **)(*plVar5 + 0x100))(local_90,plVar5,&local_78);
        ...
        if (bVar1) {
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                              ,0x2d3,"js_engine_FileUtils_getFileExtension");
          __android_log_print(6,"jswrapper",
                              "js_engine_FileUtils_getFileExtension : Error processing arguments");
        }
        bVar1 = !bVar1;
      ...
      if (bVar1) goto LAB_00899fe8;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 726): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar6[1] - *plVar6) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_FileUtils_getFileExtension",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x2d9);
LAB_00899fe8:
  pVVar8 = (Value *)se::State::rval(aSStack_60);
