...
/* cocos2d::network::SocketIO::getSocket(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

undefined8 __thiscall cocos2d::network::SocketIO::getSocket(SocketIO *this,basic_string *param_1)
