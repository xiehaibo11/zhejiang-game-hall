...
/* js_register_renderer_SimpleSprite2D(se::Object*) */

undefined8 js_register_renderer_SimpleSprite2D(Object *param_1)

{
  ...
  this = (Class *)se::Class::create(&local_48,param_1,__jsb_cocos2d_renderer_AssemblerSprite_proto,
                                    js_renderer_SimpleSprite2D_constructorRegistry);
  if (((byte)local_48 & 1) != 0) {
    operator_delete(local_38);
  }
  se::Class::defineFunction(this,"ctor",js_renderer_SimpleSprite2D_ctorRegistry);
  se::Class::defineFinalizeFunction(this,js_cocos2d_renderer_SimpleSprite2D_finalizeRegistry);
  se::Class::install(this);
  local_30 = (Class *)0x188c37c;
  ...
  __jsb_cocos2d_renderer_SimpleSprite2D_proto = se::Class::getProto(this);
  __jsb_cocos2d_renderer_SimpleSprite2D_class = this;
