...
/* void JSBClassType::registerClass<spine::BoundingBoxAttachment>(se::Class*) */

void JSBClassType::registerClass<spine::BoundingBoxAttachment>(Class *param_1)
