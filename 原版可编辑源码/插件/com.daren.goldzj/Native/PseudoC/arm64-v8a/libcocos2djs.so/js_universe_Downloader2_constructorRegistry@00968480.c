...
/* js_universe_Downloader2_constructorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_universe_Downloader2_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Object *)
         se::Object::_createJSObject(__jsb_universe_Downloader2_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_universe_Downloader2_finalizeRegistry);
  se::State::State(aSStack_60,this,(vector *)&local_a0);
  this_00 = operator_new(0x1d8,(nothrow_t *)&std::nothrow);
  if (this_00 != (Downloader2 *)0x0) {
    universe::Downloader2::Downloader2(this_00);
  }
