...
/* js_engine_Device_setAccelerometerIntervalRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_engine_Device_setAccelerometerIntervalRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (uVar6 == 0x10) {
    ...
    if ((uVar6 & 1) != 0) {
      cocos2d::Device::setAccelerometerInterval(local_64);
      goto LAB_0089c664;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                        ,0x3f8,"js_engine_Device_setAccelerometerInterval");
    __android_log_print(6,"jswrapper",
                        "js_engine_Device_setAccelerometerInterval : Error processing arguments");
  }
  else {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 1020): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar6 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_Device_setAccelerometerInterval",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x3ff);
LAB_0089c664:
