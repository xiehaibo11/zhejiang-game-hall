    ...
    if (*piVar16 != 0) {
      ...
      if (1 < iVar3) {
        ...
        do {
          ...
          uVar10 = FUN_00b690a8(piVar16,auStack_70,auStack_80,__n);
          if ((int)uVar10 == 0) {
            return uVar10;
          }
          uVar9 = FUN_00b690a8(uVar9,acStack_91 + 1,auStack_a0,__n);
          if ((int)uVar9 == 0) {
            return uVar9;
          }
          ...
          if (-1 < iVar4) {
            return 0;
                    ...
                    /* try { // try from 00b69424 to 00c6942b has its CatchHandler @ 00b696d0 */
          iVar4 = memcmp(auStack_70,auStack_80,__n);
          if (0 < iVar4) {
            return 0;
          }
                    /* try { // try from 00b69434 to 00c6943f has its CatchHandler @ 00b696c0 */
          ...
          do {
                    /* try { // try from 00b69454 to 00c6945f has its CatchHandler @ 00b696d4 */
            if ((long)uVar14 < 1) break;
            cVar2 = acStack_91[uVar14];
                    /* try { // try from 00b69460 to 00c6971f has its CatchHandler @ 00b69274 */
          ...
          if ((*piVar16 == 1) && (iVar4 = FUN_00b695ac(auStack_70,auStack_80,__n), -1 < iVar4)) {
            return 0;
          }
      ...
      if ((piVar16 != (int *)0x0) && (*piVar16 == 1)) {
        uVar9 = FUN_00b690a8(piVar16,auStack_70,auStack_80,__n);
        if ((int)uVar9 == 0) {
          return uVar9;
        }
        ...
        iVar3 = FUN_00b695ac(auStack_70,auStack_80,__n);
        if (-1 < iVar3) {
          return 0;
        }
      }
