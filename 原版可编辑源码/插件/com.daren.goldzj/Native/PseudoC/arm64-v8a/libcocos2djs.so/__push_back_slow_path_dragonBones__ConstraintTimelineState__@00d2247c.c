...
/* void std::__ndk1::vector<dragonBones::ConstraintTimelineState*,
   std::__ndk1::allocator<dragonBones::ConstraintTimelineState*>
   >::__push_back_slow_path<dragonBones::ConstraintTimelineState*>(dragonBones::ConstraintTimelineState*&&)
    */
...
::__push_back_slow_path<dragonBones::ConstraintTimelineState*>
          (vector<dragonBones::ConstraintTimelineState*,std::__ndk1::allocator<dragonBones::ConstraintTimelineState*>>
           *this,ConstraintTimelineState **param_1)
...
LAB_00d224e0:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d224e0;
  }
  else {
