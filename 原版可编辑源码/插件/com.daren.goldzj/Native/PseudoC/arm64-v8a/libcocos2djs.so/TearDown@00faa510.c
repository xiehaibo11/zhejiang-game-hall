...
void __thiscall v8::internal::MarkCompactCollector::TearDown(MarkCompactCollector *this)

{
  ...
  AbortWeakObjects(this);
  if (1 < *(int *)(*(long *)(*(long *)(this + 8) + 0x828) + 0x58)) {
    MarkingWorklist::Clear((MarkingWorklist *)(this + 0x58));
    return;
  }
  return;
}
