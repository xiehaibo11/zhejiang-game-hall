...
/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<v8::internal::compiler::RpoNumber,
   ...
   v8::internal::compiler::BlockAssessments*>, void*>*, long>, bool>
   ...
   v8::internal::compiler::BlockAssessments*>, std::__ndk1::less<v8::internal::compiler::RpoNumber>,
   true>, v8::internal::ZoneAllocator<std::__ndk1::__value_type<v8::internal::compiler::RpoNumber,
   v8::internal::compiler::BlockAssessments*> >
   >::__emplace_unique_key_args<v8::internal::compiler::RpoNumber,
   std::__ndk1::piecewise_construct_t const&, std::__ndk1::tuple<v8::internal::compiler::RpoNumber
   const&>, std::__ndk1::tuple<> >(v8::internal::compiler::RpoNumber const&,
   std::__ndk1::piecewise_construct_t const&, std::__ndk1::tuple<v8::internal::compiler::RpoNumber
...
__emplace_unique_key_args<v8::internal::compiler::RpoNumber,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<v8::internal::compiler::RpoNumber_const&>,std::__ndk1::tuple<>>
          (RpoNumber *param_1,piecewise_construct_t *param_2,tuple *param_3,tuple *param_4)
