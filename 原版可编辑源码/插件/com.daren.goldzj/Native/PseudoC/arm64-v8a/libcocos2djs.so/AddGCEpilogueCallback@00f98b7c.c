...
/* v8::internal::Heap::AddGCEpilogueCallback(void (*)(v8::Isolate*, v8::GCType, v8::GCCallbackFlags,
   void*), v8::GCType, void*) */

void __thiscall
v8::internal::Heap::AddGCEpilogueCallback
...

{
  ...
  puVar1 = *(undefined8 **)(this + 0x600);
  if (puVar1 < *(undefined8 **)(this + 0x608)) {
    *puVar1 = param_1;
    *(undefined4 *)(puVar1 + 1) = param_3;
    puVar1[2] = param_4;
    *(long *)(this + 0x600) = *(long *)(this + 0x600) + 0x18;
  }
  else {
    local_28 = param_4;
    local_1c = param_3;
    ...
    __emplace_back_slow_path<void(*&)(v8::Isolate*,v8::GCType,v8::GCCallbackFlags,void*),v8::GCType&,void*&>
              ((vector<v8::internal::Heap::GCCallbackTuple,std::__ndk1::allocator<v8::internal::Heap::GCCallbackTuple>>
                *)(this + 0x5f8),(_func_void_Isolate_ptr_GCType_GCCallbackFlags_void_ptr *)&local_18
