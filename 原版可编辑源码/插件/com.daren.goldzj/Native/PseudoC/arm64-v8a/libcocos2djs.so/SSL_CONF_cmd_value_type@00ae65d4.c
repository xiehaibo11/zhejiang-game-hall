...

{
  ...
  __s2 = *(char **)(param_1 + 2);
  if (__s2 == (char *)0x0) {
    if ((*param_1 & 1) == 0) goto LAB_00ae666c;
    if (*param_2 != '-') {
      return 0;
    }
    if (param_2[1] == '\0') {
    ...
    __n = *(ulong *)(param_1 + 4);
                    /* try { // try from 00ae6608 to 00be660f has its CatchHandler @ 00ae66bc */
    if (sVar4 <= __n) {
      return 0;
    }
                    /* try { // try from 00ae6610 to 00be66fb has its CatchHandler @ 00ae6580 */
    uVar1 = *param_1;
  ...
  param_2 = param_2 + __n;
LAB_00ae666c:
  lVar5 = FUN_00ae63a8(param_1,param_2);
  uVar2 = 0;
  if (lVar5 != 0) {
