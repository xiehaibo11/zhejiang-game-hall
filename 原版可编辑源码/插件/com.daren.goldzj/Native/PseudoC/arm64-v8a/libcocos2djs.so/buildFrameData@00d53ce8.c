...
/* dragonBones::ArmatureCache::AnimationData::buildFrameData(unsigned long) */

void __thiscall
dragonBones::ArmatureCache::AnimationData::buildFrameData(AnimationData *this,ulong param_1)
    ...
    if (uVar4 == param_1) {
      ...
      *(undefined8 *)(local_50 + 0x108) = 0;
      if (*(undefined8 **)(this + 0x30) == puVar5) {
        std::__ndk1::
        vector<dragonBones::ArmatureCache::FrameData*,std::__ndk1::allocator<dragonBones::ArmatureCache::FrameData*>>
        ::__push_back_slow_path<dragonBones::ArmatureCache::FrameData*const&>(this_00,&local_50);
      }
      else {
        *puVar5 = local_50;
