  ...
  *(long *)(this + 0x28) = lVar7 + -0x11;
  ...
  if (!CARRY4(local_a0._1_4_,uVar11)) {
    ...
    if (((1 < *(ulong *)(lVar7 + 0x13)) && ((ulong)uVar2 <= *(ulong *)(lVar7 + 0x13) - 2)) &&
       (puVar3 = (undefined2 *)((*(ulong *)(lVar7 + 0x1b) & (ulong)uVar2) + *(long *)(lVar7 + 0xb)),
       puVar3 != (undefined2 *)0x0)) {
      uStack_98 = 0;
      local_a0 = (ulong)CONCAT21(*puVar3,1);
      local_90 = 0;
