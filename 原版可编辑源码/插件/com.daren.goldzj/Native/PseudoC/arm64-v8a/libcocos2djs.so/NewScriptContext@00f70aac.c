...
/* v8::internal::Factory::NewScriptContext(v8::internal::Handle<v8::internal::NativeContext>,
   v8::internal::Handle<v8::internal::ScopeInfo>) */

ulong * __thiscall
v8::internal::Factory::NewScriptContext(Factory *this,ulong *param_2,ulong *param_3)
