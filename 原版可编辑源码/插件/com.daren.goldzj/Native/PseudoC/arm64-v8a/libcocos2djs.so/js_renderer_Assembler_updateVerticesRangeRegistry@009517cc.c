...
/* js_renderer_Assembler_updateVerticesRangeRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Assembler_updateVerticesRangeRegistry(FunctionCallbackInfo *param_1)

{
  ...
  long local_58;
                    ...
                    /* catch() { ... } // from try @ 00952078 with catch @ 009517e4 */
  lVar1 = tpidr_el0;
  ...
  if (this == (Assembler *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xe03,"js_renderer_Assembler_updateVerticesRange");
    __android_log_print(6,"jswrapper",
                        "js_renderer_Assembler_updateVerticesRange : Invalid Native Object");
  }
  else {
    ...
    if (uVar10 == 0x30) {
      ...
      if ((uVar4 & uVar5 & uVar6 & 1) != 0) {
        cocos2d::renderer::Assembler::updateVerticesRange(this,local_88,iVar3,local_8c);
        goto LAB_009519d0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0xe0e,"js_renderer_Assembler_updateVerticesRange");
      __android_log_print(6,"jswrapper",
                          "js_renderer_Assembler_updateVerticesRange : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 3602): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar10 >> 4,3);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Assembler_updateVerticesRange",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0xe15);
LAB_009519d0:
