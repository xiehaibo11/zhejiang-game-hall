...
/* unsigned long
   v8::internal::GlobalHandles::InvokeFirstPassWeakCallbacks<v8::internal::GlobalHandles::TracedNode>(std::__ndk1::vector<std::__ndk1::pair<v8::internal::GlobalHandles::TracedNode*,
...
ulong __thiscall
v8::internal::GlobalHandles::InvokeFirstPassWeakCallbacks<v8::internal::GlobalHandles::TracedNode>
