...
/* void std::__ndk1::vector<cocos2d::renderer::RenderTarget*,
   std::__ndk1::allocator<cocos2d::renderer::RenderTarget*>
   >::__push_back_slow_path<cocos2d::renderer::RenderTarget*
   const&>(cocos2d::renderer::RenderTarget* const&) */
