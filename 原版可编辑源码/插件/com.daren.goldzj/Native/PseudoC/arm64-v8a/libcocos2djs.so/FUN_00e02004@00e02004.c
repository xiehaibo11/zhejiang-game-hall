...
void FUN_00e02004(uint *param_1,uint *param_2,uint *param_3,uint param_4,int param_5)
...
LAB_00e021b4:
    ...
    if ((((uint *)((long)param_3 + uVar2) <= param_2 || (uint *)((long)param_2 + uVar2) <= param_3)
      ...
      lVar3 = lVar6;
      if (uVar1 == 0) goto joined_r0x00e021ac;
    }
  }
  lVar6 = uVar2 - lVar3;
