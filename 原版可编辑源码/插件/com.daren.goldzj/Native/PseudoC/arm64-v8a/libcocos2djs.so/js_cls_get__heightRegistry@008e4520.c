...
/* js_cls_get__heightRegistry(v8::Local<v8::Name>, v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cls_get__heightRegistry(undefined8 param_1,PropertyCallbackInfo *param_2)

{
  ...
  if (lVar3 == 0) {
    ...
    se::Value::setFloat(pVVar4,*(float *)(lVar3 + 4));
  }
  pVVar4 = (Value *)se::State::rval(aSStack_60);
