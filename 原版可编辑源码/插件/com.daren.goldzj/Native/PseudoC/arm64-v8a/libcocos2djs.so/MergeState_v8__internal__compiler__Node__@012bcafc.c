...
/* void 
   v8::internal::compiler::GraphAssembler::MergeState<v8::internal::compiler::Node*>(v8::internal::compiler::GraphAssemblerLabel<1>*,
   v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::GraphAssembler::MergeState<v8::internal::compiler::Node*>
          (GraphAssembler *this,GraphAssemblerLabel *param_1,Node *param_2)
    ...
    *(undefined8 *)(param_1 + 0x18) = uVar6;
    ...
    pOVar5 = (Operator *)
             CommonOperatorBuilder::Phi
                       ((CommonOperatorBuilder *)(*(undefined8 **)(this + 0x18))[1],param_1[0x38],2)
    ;
    local_58 = *(undefined8 *)(param_1 + 0x20);
    local_68 = param_2;
  }
    ...
    if (iVar11 != 1) {
      ...
      pOVar5 = (Operator *)
               CommonOperatorBuilder::Phi
                         (*(CommonOperatorBuilder **)(*(long *)(this + 0x18) + 8),param_1[0x38],
                          iVar1);
      NodeProperties::ChangeOp(pNVar9,pOVar5);
      goto LAB_012bcfd4;
    }
