...
void FUN_0097c584(long param_1,int *param_2,int *param_3)

{
  ...
  int32_to_seval(iVar2,local_78 + 0x10);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 0097c490 with catch @ 0097c5f8
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 0097c650 with catch @ 0097c5fc
                        */
  ...
  if ((uVar8 & 1) == 0) {
    ...
    se::ScriptEngine::clearException();
                    ...
                    /* try { // try from 0097c648 to 00a7c64f has its CatchHandler @ 0097c7b0 */
  se::Value::~Value(aVStack_48);
  pVVar5 = local_78;
                    /* try { // try from 0097c650 to 00a7c7b3 has its CatchHandler @ 0097c5fc */
  pVVar4 = local_70;
