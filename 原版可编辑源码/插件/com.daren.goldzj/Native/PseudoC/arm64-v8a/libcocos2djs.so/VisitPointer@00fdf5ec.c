...
/* v8::internal::YoungGenerationMarkingVisitor::VisitPointer(v8::internal::HeapObject,
   v8::internal::CompressedMaybeObjectSlot) */

void __thiscall
v8::internal::YoungGenerationMarkingVisitor::VisitPointer
          (YoungGenerationMarkingVisitor *this,undefined8 param_2,uint *param_3)

{
  ...
  if ((uVar2 != 3) && ((uVar2 & 1) != 0)) {
    ...
    if ((*(byte *)(uVar7 + 8) & 0x18) != 0) {
      uVar9 = (ulong)param_3 & 0xffffffff00000000 | (ulong)uVar2 & 0xfffffffffffffffd;
      ...
      while( true ) {
        ...
        while (*puVar1 == uVar2) {
          ...
          if (cVar3 == '\0') {
            lVar11 = *(long *)(this + 8);
            puVar10 = (undefined8 *)(lVar11 + (long)*(int *)(this + 0x10) * 0x50);
