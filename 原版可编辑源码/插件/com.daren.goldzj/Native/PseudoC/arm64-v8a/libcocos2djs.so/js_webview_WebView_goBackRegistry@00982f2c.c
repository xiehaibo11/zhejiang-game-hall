...
/* js_webview_WebView_goBackRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_webview_WebView_goBackRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (WebView *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xb0,"js_webview_WebView_goBack");
    __android_log_print(6,"jswrapper","js_webview_WebView_goBack : Invalid Native Object");
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      cocos2d::WebView::goBack(this);
      goto LAB_0098307c;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_webview_auto.cpp, 183): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_webview_WebView_goBack",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_webview_auto.cpp"
                      ,0xba);
LAB_0098307c:
