...
void FUN_010bd6cc(undefined8 param_1,ulong *param_2,long *param_3)
...
switchD_010bd78c_caseD_1:
    bVar7 = bVar4;
    goto switchD_010bd78c_caseD_0;
  }
  bVar7 = 1;
  bVar10 = 7;
  switch(bVar4) {
  ...
  case 4:
    ...
    break;
  case 6:
    goto switchD_010bd78c_caseD_6;
  }
switchD_010bd78c_caseD_0:
  bVar10 = bVar7;
  if (bVar3 != bVar7) {
switchD_010bd78c_caseD_6:
    ...
    if ((uVar1 != *(uint *)(pIVar8 + 0x168)) && (((bVar2 & 0xf0) == 0x20) != ((bVar10 & 0x1e) == 4))
      ...
      FUN_010be6c0(param_2,puVar5,bVar3,
