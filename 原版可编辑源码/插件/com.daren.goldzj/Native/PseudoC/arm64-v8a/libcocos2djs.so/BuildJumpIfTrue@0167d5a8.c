...
/* v8::internal::compiler::BytecodeGraphBuilder::BuildJumpIfTrue() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::BuildJumpIfTrue(BytecodeGraphBuilder *this)

{
  ...
  if ((ulong)(long)*(int *)(lVar5 + 0x5c) <
    ...
    lVar5 = *(long *)(this + 0xa8);
    uVar4 = JSGraph::TrueConstant(*(JSGraph **)(this + 0x10));
    if ((ulong)(long)*(int *)(lVar5 + 0x5c) <
        (ulong)(*(long *)(lVar5 + 0x30) - *(long *)(lVar5 + 0x28) >> 3)) {
