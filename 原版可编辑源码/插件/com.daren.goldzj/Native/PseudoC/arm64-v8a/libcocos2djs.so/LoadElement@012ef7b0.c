...
/* v8::internal::compiler::SimplifiedOperatorBuilder::LoadElement(v8::internal::compiler::ElementAccess
   const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::LoadElement
...

{
  ...
  Operator::Operator(pOVar1,0xeb,0x70,"LoadElement",2,1,1,1,1,0);
