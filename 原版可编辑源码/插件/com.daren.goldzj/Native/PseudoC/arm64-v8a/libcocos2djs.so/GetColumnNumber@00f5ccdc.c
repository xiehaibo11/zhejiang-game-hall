...
/* v8::internal::AsmJsWasmStackFrame::GetColumnNumber() */

int __thiscall v8::internal::AsmJsWasmStackFrame::GetColumnNumber(AsmJsWasmStackFrame *this)

{
  ...
  iVar3 = Script::GetColumnNumber(puVar4,uVar2);
  return iVar3 + 1;
}
