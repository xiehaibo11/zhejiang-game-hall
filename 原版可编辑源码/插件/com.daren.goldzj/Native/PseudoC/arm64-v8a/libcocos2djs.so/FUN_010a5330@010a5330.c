...
void FUN_010a5330(undefined8 param_1,ulong *param_2,uint param_3,ulong param_4)

{
  ...
  if (param_3 < uVar3) {
    uVar6 = *(uint *)(uVar5 + 7 + (long)(int)(param_3 * 4 + 8));
    uVar3 = *(uint *)(uVar5 + 7);
  }
  else {
    uVar8 = uVar4 | *(uint *)(uVar5 + 0xb);
    lVar1 = uVar8 + (long)(int)((param_3 - uVar3) * 4);
    uVar3 = *(uint *)(lVar1 + 7);
    if (((uVar3 & 1) == 0) ||
