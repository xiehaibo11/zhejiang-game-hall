...
/* void JSBClassType::registerClass<spine::TransformConstraintData>(se::Class*) */

void JSBClassType::registerClass<spine::TransformConstraintData>(Class *param_1)
