...
/* XMLHttpRequest_getStatusRegistry(v8::Local<v8::Name>, v8::PropertyCallbackInfo<v8::Value> const&)
    */

void XMLHttpRequest_getStatusRegistry(undefined8 param_1,PropertyCallbackInfo *param_2)

{
  ...
  se::Value::setInt32(pVVar4,(uint)*(ushort *)(lVar3 + 0x260));
  pVVar4 = (Value *)se::State::rval(aSStack_60);
