...
/* v8::internal::Handle<v8::internal::SmallOrderedHashSet>
   v8::internal::Factory::AllocateSmallOrderedHashTable<v8::internal::SmallOrderedHashSet>(v8::internal::Handle<v8::internal::Map>,
   int, v8::internal::AllocationType) */

ulong * __thiscall
v8::internal::Factory::AllocateSmallOrderedHashTable<v8::internal::SmallOrderedHashSet>
...

{
  ...
  uVar1 = iVar4 * 5 + (iVar2 >> 1) + 0xbU & 0xfffffffc;
  uVar7 = (ulong)uVar1;
...
LAB_00f6d194:
  *(int *)(uVar5 - 1) = (int)uVar9;
  ...
  local_48 = uVar5;
  SmallOrderedHashTable<v8::internal::SmallOrderedHashSet>::Initialize
            ((SmallOrderedHashTable<v8::internal::SmallOrderedHashSet> *)&local_48,(Isolate *)this,
             iVar4);
  return puVar6;
}
