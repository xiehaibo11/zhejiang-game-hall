...
/* v8::internal::compiler::ObjectRef::AsArrayBoilerplateDescription() const */

undefined1  [16] __thiscall
v8::internal::compiler::ObjectRef::AsArrayBoilerplateDescription(ObjectRef *this)

{
  ...
  if (*(int *)(puVar1 + 1) == 2) {
    if ((*(byte *)*puVar1 & 1) == 0) goto LAB_017198d8;
  }
