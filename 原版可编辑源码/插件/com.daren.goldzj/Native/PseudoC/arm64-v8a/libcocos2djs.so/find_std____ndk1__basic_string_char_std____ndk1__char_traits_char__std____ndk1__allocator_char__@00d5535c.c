...
/* std::__ndk1::__tree_iterator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   ...
   dragonBones::ArmatureCache::AnimationData*>,
   std::__ndk1::__tree_node<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   dragonBones::ArmatureCache::AnimationData*>, void*>*, long>
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   dragonBones::ArmatureCache::AnimationData*>, std::__ndk1::less<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   dragonBones::ArmatureCache::AnimationData*> > >::find<std::__ndk1::basic_string<char,
