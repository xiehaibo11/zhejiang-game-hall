...
/* v8::internal::ExpressionScope<v8::internal::ParserTypes<v8::internal::Parser>
   >::NewVariable(v8::internal::AstRawString const*, int) */

VariableProxy * __thiscall
v8::internal::ExpressionScope<v8::internal::ParserTypes<v8::internal::Parser>>::NewVariable
          (ExpressionScope<v8::internal::ParserTypes<v8::internal::Parser>> *this,
...

{
  ...
  undefined8 *puVar2;
  int iVar3;
  ExpressionScope<v8::internal::ParserTypes<v8::internal::Parser>> EVar4;
  long lVar5;
  Zone *this_00;
    ...
    if ((byte)EVar4 == 3) {
      pVVar6 = (Variable *)
               Parser::DeclareVariable
                         (*(Parser **)this,param_1,1,2,1,*(undefined8 *)*(Parser **)this,&local_58,
                          param_2,0xffffffff);
      ...
      pVVar6 = (Variable *)
               ...
               Declare((VariableDeclarationParsingScope<v8::internal::ParserTypes<v8::internal::Parser>>
                        *)this,param_1,param_2);
    }
    if ((this[0x10] == (ExpressionScope<v8::internal::ParserTypes<v8::internal::Parser>>)0x4) &&
