...
/* js_cocos2dx_spine_MeshAttachment_setRegionOriginalWidthRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_MeshAttachment_setRegionOriginalWidthRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (MeshAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1917,"js_cocos2dx_spine_MeshAttachment_setRegionOriginalWidth");
    pcVar6 = "js_cocos2dx_spine_MeshAttachment_setRegionOriginalWidth : Invalid Native Object";
LAB_00c3ee58:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::MeshAttachment::setRegionOriginalWidth(this,local_64);
        goto LAB_00c3ee90;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x191e,"js_cocos2dx_spine_MeshAttachment_setRegionOriginalWidth");
      pcVar6 = 
      "js_cocos2dx_spine_MeshAttachment_setRegionOriginalWidth : Error processing arguments";
      goto LAB_00c3ee58;
    }
    __android_log_print(6,"jswrapper",&DAT_01906925,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_MeshAttachment_setRegionOriginalWidth",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1925);
LAB_00c3ee90:
