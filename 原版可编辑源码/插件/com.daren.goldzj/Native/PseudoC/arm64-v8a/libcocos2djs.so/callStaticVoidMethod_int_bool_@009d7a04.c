...

{
  ...
  long local_48;
                    ...
                    /* try { // try from 009d7a18 to 00ad7a27 has its CatchHandler @ 009d7b4c */
  lVar2 = tpidr_el0;
  local_48 = *(long *)(lVar2 + 0x28);
                    /* try { // try from 009d7a3c to 00ad7a6b has its CatchHandler @ 009d7b50 */
  ...
  local_70 = (void *)*puVar5;
                    /* try { // try from 009d7a6c to 00ad7b63 has its CatchHandler @ 009d79b0 */
  puVar5[1] = 0;
  puVar5[2] = 0;
  *puVar5 = 0;
  puVar5 = (ulong *)std::__ndk1::
  ...
  *puVar5 = 0;
  ...
  if ((uVar6 & 1) == 0) {
    ...
    pvVar3 = local_70;
    puVar4 = local_60;
                    /* catch() { ... } // from try @ 009d7a18 with catch @ 009d7b4c */
    while (puVar4 != (void *)0x0) {
                    /* catch() { ... } // from try @ 009d7a3c with catch @ 009d7b50 */
      ...
      if (pvVar7 != (void *)0x0) {
        ...
        operator_delete(pvVar7);
                    ...
                    /* try { // try from 009d7b64 to 00ad7bcf has its CatchHandler @ 009d7b64
                       catch() { ... } // from try @ 009d7b64 with catch @ 009d7b64
                       catch() { ... } // from try @ 009d7c1c with catch @ 009d7b64 */
  ...
  if (*(long *)(lVar2 + 0x28) == local_48) {
                    /* try { // try from 009d7bd0 to 00ad7c1b has its CatchHandler @ 009d7cfc */
    return;
  }
