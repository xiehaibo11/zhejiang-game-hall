...
/* bool 
   v8::internal::JSObject::UpdateAllocationSite<(v8::internal::AllocationSiteUpdateMode)1>(v8::internal::Handle<v8::internal::JSObject>,
   v8::internal::ElementsKind) */

bool v8::internal::JSObject::UpdateAllocationSite<(v8::internal::AllocationSiteUpdateMode)1>
  ...
  if (((*(short *)((uVar4 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar4 - 1)) == 0x423) &&
    ...
    if ((((uVar6 == ((ulong)(piVar1 + 1) & 0xfffffffffffc0000)) &&
      ...
      if ((*(short *)((uVar6 | 7) + (ulong)*(uint *)(uVar9 - 1)) == 0x55) &&
        ...
        bVar2 = AllocationSite::DigestTransitionFeedback<(v8::internal::AllocationSiteUpdateMode)1>
                          (puVar5,param_2);
        return bVar2;
      }
    }
