...

{
  ...
  FUN_010a14e0();
  pcStack_18 = FUN_010a0610;
  puStack_20 = &stack0xfffffffffffffff0;
  FUN_010a14f4();
  pcStack_68 = FUN_010a061c;
...
joined_r0x010a07f0:
  if (in_w3 != 0) {
    FUN_010a1508();
    pcStack_78 = FUN_010a08e8;
    puStack_80 = (undefined1 *)&puStack_70;
    FUN_010a151c();
    pcStack_88 = FUN_010a08f4;
    puStack_90 = (undefined1 *)&puStack_80;
    FUN_010a1530();
    pcStack_e8 = FUN_010a0900;
    ...
    pIVar8 = (Isolate *)(uStack_f8 & 0xffffffff00000000);
    iVar7 = v8::internal::JSObject::GetFastElementsUsage((JSObject *)&uStack_f8);
    puVar11 = (undefined8 *)
              v8::internal::
    ...
    if (0 < iVar7) {
      ...
      if (0 < iVar12) {
        ...
        v8::internal::NumberDictionary::UpdateMaxNumberKey
                  ((NumberDictionary *)&uStack_f8,iVar12,extraout_x1_00);
      }
    }
    return puVar11;
  }
