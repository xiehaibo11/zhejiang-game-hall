...
/* void 
   v8::internal::SmallOrderedHashTable<v8::internal::SmallOrderedHashMap>::BodyDescriptor::IterateBody<v8::internal::YoungGenerationMarkingVisitor>(v8::internal::Map,
   v8::internal::HeapObject, int, v8::internal::YoungGenerationMarkingVisitor*) */

void v8::internal::SmallOrderedHashTable<v8::internal::SmallOrderedHashMap>::BodyDescriptor::
...

{
  ...
  puVar10 = (uint *)(param_2 + ((ulong)*(byte *)(param_2 + 5) << 4 | 8) + -1);
  if (puVar10 <= puVar1) {
    return;
  }
  uVar3 = *puVar1;
