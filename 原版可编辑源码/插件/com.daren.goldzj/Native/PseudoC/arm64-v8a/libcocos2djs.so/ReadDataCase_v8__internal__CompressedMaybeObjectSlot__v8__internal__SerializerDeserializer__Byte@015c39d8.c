...
/* v8::internal::CompressedMaybeObjectSlot
   v8::internal::Deserializer::ReadDataCase<v8::internal::CompressedMaybeObjectSlot,
   (v8::internal::SerializerDeserializer::Bytecode)16,
   (v8::internal::SnapshotSpace)0>(v8::internal::Isolate*, v8::internal::CompressedMaybeObjectSlot,
   unsigned long, unsigned char, bool) */

int * __thiscall
v8::internal::Deserializer::
ReadDataCase<v8::internal::CompressedMaybeObjectSlot,(v8::internal::SerializerDeserializer::Bytecode)16,(v8::internal::SnapshotSpace)0>
          (Deserializer *this,long param_1,int *param_3,long param_4,undefined8 param_5,uint param_6
          )
