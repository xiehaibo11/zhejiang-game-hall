...
void FUN_015dd824(uchar *param_1,undefined4 param_2,char param_3,byte param_4)
  ...
  if (uVar9 < uVar10 || uVar9 - uVar10 == 0) {
    if (*(char *)(*(long *)(param_1 + 0xd8) + -0x78) != '\x02') {
      ...
      if (pbVar16 < *(byte **)(param_1 + 0x18)) {
        bVar2 = *pbVar16;
        uVar17 = (ushort)bVar2;
        uVar9 = v8::internal::wasm::WasmOpcodes::IsPrefixOpcode(uVar17);
        if ((uVar9 & 1) != 0) {
          if (*(byte **)(param_1 + 0x18) <= pbVar16 + 1) goto LAB_015dd8d8;
          uVar17 = CONCAT11(bVar2,pbVar16[1]);
        }
        pcVar4 = (char *)v8::internal::wasm::WasmOpcodes::OpcodeName(uVar17);
      }
      else {
LAB_015dd8d8:
        pcVar4 = "<end>";
      }
      v8::internal::wasm::Decoder::errorf(param_1,(char *)pbVar16,"%s found empty stack",pcVar4);
    }
    pbVar16 = *(byte **)(param_1 + 0x10);
    uVar13 = 0;
    uVar18 = 10;
    if (param_4 == 10) goto LAB_015dda8c;
  }
  else {
    pbVar16 = *(byte **)(lVar11 + -0x18);
    bVar2 = *(byte *)(lVar11 + -0x10);
    uVar18 = (uint)bVar2;
    uVar13 = *(undefined8 *)(lVar11 + -8);
    *(undefined8 **)(param_1 + 0xb8) = (undefined8 *)(lVar11 + -0x18);
    if (bVar2 == param_4) goto LAB_015dda8c;
  }
  if ((param_4 == 7 && uVar18 == 8) || (param_4 == 6 && uVar18 - 7 < 3)) goto LAB_015dda8c;
  if ((param_4 == 10) || ((uVar18 == 10 || (param_4 == 9 && uVar18 == 8)))) goto LAB_015dda8c;
  ...
  if (pbVar1 < *(byte **)(param_1 + 0x18)) {
    ...
    uVar9 = v8::internal::wasm::WasmOpcodes::IsPrefixOpcode(uVar17);
    if ((uVar9 & 1) != 0) {
      if (*(byte **)(param_1 + 0x18) <= pbVar1 + 1) goto LAB_015dd9b4;
      uVar17 = CONCAT11(bVar2,pbVar1[1]);
    }
    pcVar4 = (char *)v8::internal::wasm::WasmOpcodes::OpcodeName(uVar17);
  }
  else {
LAB_015dd9b4:
  ...
  if (pbVar16 < *(byte **)(param_1 + 0x18)) {
    ...
    uVar9 = v8::internal::wasm::WasmOpcodes::IsPrefixOpcode(uVar17);
    if ((uVar9 & 1) != 0) {
      if (*(byte **)(param_1 + 0x18) <= pbVar16 + 1) goto LAB_015dda2c;
      uVar17 = CONCAT11(bVar2,pbVar16[1]);
    }
    pcVar5 = (char *)v8::internal::wasm::WasmOpcodes::OpcodeName(uVar17);
    if (uVar18 < 0xb) goto LAB_015dda3c;
LAB_015dda64:
    pcVar6 = "<unknown>";
  }
  else {
LAB_015dda2c:
    pcVar5 = "<end>";
    if (10 < uVar18) goto LAB_015dda64;
LAB_015dda3c:
    pcVar6 = (&PTR_s_<stmt>_01cc9868)[(char)uVar18];
  }
  v8::internal::wasm::Decoder::errorf
            (param_1,(char *)pbVar16,"%s[%d] expected type %s, found %s of type %s",pcVar4,0,pcVar14
             ,pcVar5,pcVar6);
LAB_015dda8c:
  if (param_3 == '\0') {
  ...
  if ((uVar9 == 0) && (*(char *)(*(long *)(param_1 + 0xd8) + -0x78) == '\0')) {
    uVar13 = v8::internal::compiler::WasmGraphBuilder::Unop
                       (*(WasmGraphBuilder **)(param_1 + 0x80),param_2,uVar13,
