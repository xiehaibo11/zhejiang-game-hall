...
/* v8::internal::JsonParser<unsigned short>::JsonParser(v8::internal::Isolate*,
   v8::internal::Handle<v8::internal::String>) */

void __thiscall
v8::internal::JsonParser<unsigned_short>::JsonParser
          (JsonParser<unsigned_short> *this,Isolate *param_1,ulong *param_3)

{
  ...
  *(ulong **)(this + 0x28) = puVar4;
  uVar6 = *puVar4;
  JVar3 = (JsonParser<unsigned_short>)
  ...
  this[0x11] = JVar3;
  lVar10 = lVar5 + lVar10 * 2;
  *(long *)(this + 0x30) = lVar10;
  *(long *)(this + 0x38) = lVar10 + (long)iVar2 * 2;
