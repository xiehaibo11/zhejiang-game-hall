...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitJumpIfToBooleanTrue() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitJumpIfToBooleanTrue(BytecodeGraphBuilder *this)
