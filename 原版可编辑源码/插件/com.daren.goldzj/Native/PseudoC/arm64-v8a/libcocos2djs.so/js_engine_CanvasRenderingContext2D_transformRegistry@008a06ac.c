...
/* js_engine_CanvasRenderingContext2D_transformRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_engine_CanvasRenderingContext2D_transformRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar10 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x5f8,"js_engine_CanvasRenderingContext2D_transform");
    __android_log_print(6,"jswrapper",
                        "js_engine_CanvasRenderingContext2D_transform : Invalid Native Object");
  }
  else {
    ...
    if (uVar13 == 0x60) {
      ...
      if ((uVar3 & uVar4 & uVar5 & uVar6 & uVar7 & uVar8 & 1) != 0) {
        cocos2d::CanvasRenderingContext2D::transform
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                          ,0x609,"js_engine_CanvasRenderingContext2D_transform");
      __android_log_print(6,"jswrapper",
                          "js_engine_CanvasRenderingContext2D_transform : Error processing arguments"
                         );
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 1549): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar13 >> 4,6);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_CanvasRenderingContext2D_transform",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x610);
LAB_008a08f4:
