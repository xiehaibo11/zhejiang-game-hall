...

{
  ...
  byte abStack_e0 [128];
                    ...
                    /* try { // try from 00abbfc8 to 00bbbfcf has its CatchHandler @ 00abc22c */
                    /* try { // try from 00abbfd0 to 00bbc0f3 has its CatchHandler @ 00abbf28 */
  ...
  if (param_3 < 0x41) {
    ...
    if (param_3 != 0) {
                    /* try { // try from 00abc0f4 to 00bbc0fb has its CatchHandler @ 00abc210 */
      ...
      do {
        ...
        __n = __n - 1;
        *param_1 = __s[uVar10];
                    /* try { // try from 00abc134 to 00bbc177 has its CatchHandler @ 00abc240 */
