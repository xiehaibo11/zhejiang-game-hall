...
/* v8::internal::MakeCancelableIdleTask(v8::internal::Isolate*, std::__ndk1::function<void
   (double)>) */
...

{
  ...
  CancelableIdleTask::CancelableIdleTask(this_00,(Isolate *)this);
  ...
  if (local_60 == (long *)0x0) {
    ...
    *(CancelableIdleTask **)(this_00 + 0x50) = this_00 + 0x30;
    ...
    if (alStack_80 == local_60) {
      ...
      if (local_60 == (long *)0x0) goto LAB_011f8c20;
