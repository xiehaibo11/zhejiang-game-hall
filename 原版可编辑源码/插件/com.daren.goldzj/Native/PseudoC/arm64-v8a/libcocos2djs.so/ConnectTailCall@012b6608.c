...
/* v8::internal::compiler::CFGBuilder::ConnectTailCall(v8::internal::compiler::Node*) */

void __thiscall v8::internal::compiler::CFGBuilder::ConnectTailCall(CFGBuilder *this,Node *param_1)

{
  ...
  Schedule::AddTailCall(*(Schedule **)(this + 0x10),pBVar2,param_1);
  return;
}
