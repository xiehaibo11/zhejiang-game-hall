...
/* void 
   v8::internal::SmallOrderedHashTable<v8::internal::SmallOrderedNameDictionary>::BodyDescriptor::IterateBody<v8::internal::YoungGenerationMarkingVisitor>(v8::internal::Map,
   v8::internal::HeapObject, int, v8::internal::YoungGenerationMarkingVisitor*) */

void v8::internal::SmallOrderedHashTable<v8::internal::SmallOrderedNameDictionary>::BodyDescriptor::
...

{
  ...
  puVar10 = puVar1 + (ulong)*(byte *)(param_2 + 9) * 6;
  if (puVar10 <= puVar1) {
    return;
  }
  uVar3 = *puVar1;
