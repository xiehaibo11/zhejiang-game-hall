...

{
  ...
  local_60[0] = (sentry)0x0;
                    /* try { // try from 00a06f14 to 00b06f53 has its CatchHandler @ 00a06dfc */
                    /* catch() { ... } // from try @ 00a06e9c with catch @ 00a06f1c */
  local_58 = this;
  if (*(int *)(this + *(long *)(*(long *)this + -0x18) + 0x20) == 0) {
    if (*(basic_ostream<char,std::__ndk1::char_traits<char>> **)
      ...
      flush(*(basic_ostream<char,std::__ndk1::char_traits<char>> **)
             (this + *(long *)(*(long *)this + -0x18) + 0x88));
                    /* catch() { ... } // from try @ 00a06e70 with catch @ 00a06f34 */
                    /* catch() { ... } // from try @ 00a06e34 with catch @ 00a06f38
                       catch() { ... } // from try @ 00a06ed8 with catch @ 00a06f38 */
    }
