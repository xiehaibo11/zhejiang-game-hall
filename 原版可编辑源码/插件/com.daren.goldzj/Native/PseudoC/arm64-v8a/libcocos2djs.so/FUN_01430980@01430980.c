...
void FUN_01430980(undefined8 param_1)

{
  ...
  *(int *)(unaff_x29 + -0x20) = (int)unaff_x19 * 2;
  FUN_013860a0(param_1,uVar2,uVar4,lVar3,(uint)bVar1 * 2);
                    /* WARNING: Could not recover jumptable at 0x01430a3c. Too many branches */
