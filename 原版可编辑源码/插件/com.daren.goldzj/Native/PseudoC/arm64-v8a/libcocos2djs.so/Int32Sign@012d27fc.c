...
/* v8::internal::compiler::SimplifiedLowering::Int32Sign(v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::SimplifiedLowering::Int32Sign(SimplifiedLowering *this,Node *param_1)

{
  ...
  uVar3 = MachineGraph::Int32Constant(*(MachineGraph **)this,1);
  pNVar9 = param_1 + 0x20;
