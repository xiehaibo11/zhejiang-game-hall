...

{
  ...
  ulong uVar11;
  wchar_t wVar12;
  moneypunct_byname<wchar_t,false> *pmVar13;
  ulong uVar14;
  moneypunct_byname<wchar_t,false> *pmVar15;
  _union_27 *p_Var16;
  long lVar17;
  mbstate_t *pmVar18;
  mbstate_t *pmVar19;
...
LAB_01826288:
      ...
      if (0xfffffffffffffffd < sVar7) goto LAB_01826288;
...
LAB_018262ec:
      ...
      if (0xfffffffffffffffd < sVar7) goto LAB_018262ec;
      wVar12 = (wchar_t)local_218;
    }
    *(wchar_t *)(this + 0x14) = wVar12;
    ...
    local_228 = ((lconv *)param_1)->currency_symbol;
    ...
    if (((byte)bVar2 & 1) == 0) {
      ...
      uVar20 = uVar8 - 4;
      if (uVar8 < 4 || uVar20 == 0) goto LAB_01826368;
LAB_0182638c:
      if (((byte)bVar2 & 1) == 0) {
      ...
      if (((byte)*this_00 & 1) != 0) goto LAB_018263b8;
LAB_0182636c:
      pmVar13 = this + 0x34;
    }
    else {
      ...
      uVar20 = uVar8 - uVar11;
      if (uVar11 <= uVar8 && uVar20 != 0) goto LAB_0182638c;
LAB_01826368:
      if ((uVar14 & 1) == 0) goto LAB_0182636c;
LAB_018263b8:
      pmVar13 = *(moneypunct_byname<wchar_t,false> **)(this + 0x40);
    }
    if (sVar7 != 0) {
      lVar17 = sVar7 * 4;
      ...
      pmVar15 = pmVar13;
      if ((uVar20 < 8) ||
         ((pmVar13 < (moneypunct_byname<wchar_t,false> *)(&local_200[0].__count + sVar7) &&
...
LAB_0182645c:
        ...
        if (uVar20 != uVar14) goto LAB_0182645c;
      }
    ...
    *(int *)pmVar13 = 0;
    ...
    uVar1 = 0;
    if ((byte)((lconv *)param_1)->frac_digits != 0xff) {
      uVar1 = (uint)(byte)((lconv *)param_1)->frac_digits;
    }
    *(uint *)(this + 0x78) = uVar1;
    if (((lconv *)param_1)->p_sign_posn == '\0') {
      basic_string<wchar_t,std::__ndk1::char_traits<wchar_t>,std::__ndk1::allocator<wchar_t>>::
      assign((basic_string<wchar_t,std::__ndk1::char_traits<wchar_t>,std::__ndk1::allocator<wchar_t>>
              *)(this + 0x48),L"()");
      cVar3 = ((lconv *)param_1)->n_sign_posn;
joined_r0x01826530:
      if (cVar3 == '\0') {
LAB_018266f0:
        basic_string<wchar_t,std::__ndk1::char_traits<wchar_t>,std::__ndk1::allocator<wchar_t>>::
...
LAB_01826534:
        ...
        if (sVar7 == 0xffffffffffffffff) goto LAB_018268c8;
        ...
        if (((byte)bVar2 & 1) == 0) {
          ...
          uVar14 = (ulong)(byte)bVar2;
          uVar20 = uVar8 - 4;
          if (uVar8 < 4 || uVar20 == 0) goto LAB_01826594;
LAB_018265d8:
          if (((byte)bVar2 & 1) == 0) {
            uVar14 = (ulong)((byte)bVar2 >> 1);
          }
          ...
          if (((byte)*pbVar22 & 1) != 0) goto LAB_01826724;
LAB_01826598:
          pmVar13 = this + 100;
        }
        else {
          ...
          uVar11 = (uVar14 & 0xfffffffffffffffe) - 1;
          uVar20 = uVar8 - uVar11;
          if (uVar11 <= uVar8 && uVar20 != 0) goto LAB_018265d8;
LAB_01826594:
          if ((uVar14 & 1) == 0) goto LAB_01826598;
LAB_01826724:
          pmVar13 = *(moneypunct_byname<wchar_t,false> **)(this + 0x70);
        }
        if (sVar7 != 0) {
          lVar17 = sVar7 * 4;
          uVar20 = (lVar17 - 4U >> 2) + 1;
...
LAB_018267c8:
            ...
            if (uVar20 != uVar14) goto LAB_018267c8;
          }
          pmVar13 = pmVar13 + (long)local_200 + (lVar17 - (long)local_200);
        }
        *(int *)pmVar13 = 0;
      ...
      FUN_01826a88(this + 0x7c,&local_218,0,((lconv *)param_1)->p_cs_precedes,
                   ((lconv *)param_1)->p_sep_by_space,((lconv *)param_1)->p_sign_posn);
      FUN_01826a88(this + 0x80,this_00,0,((lconv *)param_1)->n_cs_precedes,
                   ((lconv *)param_1)->n_sep_by_space,((lconv *)param_1)->n_sign_posn);
...
LAB_018268b8:
    ...
    if (sVar7 != 0xffffffffffffffff) {
      ...
      if (((byte)bVar2 & 1) == 0) {
        ...
        uVar14 = (ulong)(byte)bVar2;
        uVar20 = uVar8 - 4;
        if (uVar8 < 4 || uVar20 == 0) goto LAB_0182650c;
LAB_018265b8:
        if (((byte)bVar2 & 1) == 0) {
          uVar14 = (ulong)((byte)bVar2 >> 1);
        }
        ...
        basic_string<wchar_t,std::__ndk1::char_traits<wchar_t>,std::__ndk1::allocator<wchar_t>>::
        __grow_by(pbVar22,uVar11,uVar20,uVar14,0,uVar14,0);
        if (((byte)*pbVar22 & 1) != 0) goto LAB_01826604;
LAB_01826510:
        pmVar13 = this + 0x4c;
      }
      else {
        ...
        uVar11 = (uVar14 & 0xfffffffffffffffe) - 1;
        uVar20 = uVar8 - uVar11;
        if (uVar11 <= uVar8 && uVar20 != 0) goto LAB_018265b8;
LAB_0182650c:
        if ((uVar14 & 1) == 0) goto LAB_01826510;
LAB_01826604:
        pmVar13 = *(moneypunct_byname<wchar_t,false> **)(this + 0x58);
      }
      if (sVar7 != 0) {
        lVar17 = sVar7 * 4;
        uVar20 = (lVar17 - 4U >> 2) + 1;
...
LAB_018266a8:
          ...
          if (uVar20 != uVar14) goto LAB_018266a8;
        }
        pmVar13 = pmVar13 + (long)local_200 + (lVar17 - (long)local_200);
      }
      *(int *)pmVar13 = 0;
      if (((byte)*pbVar22 & 1) != 0) {
        *(ulong *)(this + 0x50) = uVar8;
        cVar3 = ((lconv *)param_1)->n_sign_posn;
        goto joined_r0x01826530;
      }
      *pbVar22 = SUB41((int)sVar7 << 1,0);
      if (((lconv *)param_1)->n_sign_posn == '\0') goto LAB_018266f0;
      goto LAB_01826534;
    }
    __throw_runtime_error("locale not supported");
LAB_018268c8:
