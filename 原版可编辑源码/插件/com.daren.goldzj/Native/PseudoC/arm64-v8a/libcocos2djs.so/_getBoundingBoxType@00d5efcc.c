...

{
  ...
  if (((byte)*param_1 & 1) == 0) {
    ...
    uVar3 = local_60 & 0xff;
    if ((local_60 & 1) == 0) goto LAB_00d5f018;
LAB_00d5f09c:
    pcVar6 = local_50 + uStack_58;
    pcVar4 = local_50;
    if (local_50 == pcVar6) goto LAB_00d5f0c4;
  }
  else {
...
LAB_00d5f080:
    ...
    pcVar6[uVar3] = '\0';
    uVar3 = local_60 & 0xff;
    if ((local_60 & 1) != 0) goto LAB_00d5f09c;
LAB_00d5f018:
    pcVar4 = (char *)((ulong)&local_60 | 1);
    pcVar6 = pcVar4 + (uVar3 >> 1);
    if (pcVar4 == pcVar6) goto LAB_00d5f0c4;
  }
  do {
