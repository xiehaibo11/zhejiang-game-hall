...
/* js_renderer_Camera_setColorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Camera_setColorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Camera *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x791,"js_renderer_Camera_setColor");
    __android_log_print(6,"jswrapper","js_renderer_Camera_setColor : Invalid Native Object");
  }
  else {
    ...
    if (uVar10 == 0x40) {
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0x79e,"js_renderer_Camera_setColor");
      __android_log_print(6,"jswrapper","js_renderer_Camera_setColor : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 1954): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar10 >> 4,4);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Camera_setColor",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0x7a5);
LAB_00943f40:
