...

{
  ...
  fVar2 = *(float *)(this + 0x14);
                    /* try { // try from 0099a738 to 00a9a743 has its CatchHandler @ 0099a9a0 */
  fVar3 = *(float *)this;
  fVar4 = *(float *)(this + 4);
  ...
  fVar8 = *(float *)(this + 0xc);
                    /* try { // try from 0099a744 to 00a9a75b has its CatchHandler @ 0099a9b8 */
  ...
  fVar16 = *(float *)(this + 0x2c);
                    /* try { // try from 0099a778 to 00a9a77f has its CatchHandler @ 0099a988 */
                    /* try { // try from 0099a78c to 00a9a7af has its CatchHandler @ 0099a984 */
                    /* try { // try from 0099a7c4 to 00a9a82b has its CatchHandler @ 0099a9b8 */
