...
void v8::Uint8ClampedArray::CheckCast(Value *param_1)

{
  ...
  if ((((uVar3 & 1) != 0) &&
     ...
     (local_8 = uVar3, iVar1 = internal::JSTypedArray::type((JSTypedArray *)&local_8), iVar1 == 9))
  {
    return;
  }
  ...
  if (lVar2 != 0) {
    if (*(code **)(lVar2 + 0xb738) != (code *)0x0) {
      (**(code **)(lVar2 + 0xb738))
                ("v8::Uint8ClampedArray::Cast()","Could not convert to Uint8ClampedArray");
