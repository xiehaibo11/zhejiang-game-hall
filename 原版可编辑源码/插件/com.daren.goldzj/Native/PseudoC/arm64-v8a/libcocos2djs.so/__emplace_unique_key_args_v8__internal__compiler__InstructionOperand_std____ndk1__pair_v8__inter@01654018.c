...
/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<v8::internal::compiler::InstructionOperand,
   ...
   v8::internal::compiler::PendingAssessment*> >(v8::internal::compiler::InstructionOperand const&,
   std::__ndk1::pair<v8::internal::compiler::InstructionOperand,
   v8::internal::compiler::PendingAssessment*>&&) */
...

{
  ...
  *p_Var11;
  ...
  p_Var8 = this + 8;
  p_Var9 = *(__tree<std::__ndk1::__value_type<v8::internal::compiler::InstructionOperand,v8::internal::compiler::Assessment*>,std::__ndk1::__map_value_compare<v8::internal::compiler::InstructionOperand,std::__ndk1::__value_type<v8::internal::compiler::InstructionOperand,v8::internal::compiler::Assessment*>,v8::internal::compiler::OperandAsKeyLess,true>,v8::internal::ZoneAllocator<std::__ndk1::__value_type<v8::internal::compiler::InstructionOperand,v8::internal::compiler::Assessment*>>>
             **)p_Var8;
  p_Var11 = p_Var8;
  if (p_Var9 != (__tree<std::__ndk1::__value_type<v8::internal::compiler::InstructionOperand,v8::internal::compiler::Assessment*>,std::__ndk1::__map_value_compare<v8::internal::compiler::InstructionOperand,std::__ndk1::__value_type<v8::internal::compiler::InstructionOperand,v8::internal::compiler::Assessment*>,v8::internal::compiler::OperandAsKeyLess,true>,v8::internal::ZoneAllocator<std::__ndk1::__value_type<v8::internal::compiler::InstructionOperand,v8::internal::compiler::Assessment*>>>
                 *)0x0) {
    uVar3 = *(ulong *)param_1;
    uVar6 = 0x180;
...
joined_r0x01654108:
  if (p_Var7 == (__tree_node_base *)0x0) {
    ...
    p_Var7 = *(__tree_node_base **)(this_00 + 0x10);
    if ((ulong)(*(long *)(this_00 + 0x18) - (long)p_Var7) < 0x30) {
      p_Var7 = (__tree_node_base *)v8::internal::Zone::NewExpand(this_00,0x30);
    }
    else {
      *(__tree_node_base **)(this_00 + 0x10) = p_Var7 + 0x30;
    }
    *(undefined8 *)(p_Var7 + 0x20) = *(undefined8 *)param_2;
    uVar2 = *(undefined8 *)(param_2 + 8);
    *(undefined8 *)p_Var7 = 0;
    *(undefined8 *)(p_Var7 + 8) = 0;
    *(__tree<std::__ndk1::__value_type<v8::internal::compiler::InstructionOperand,v8::internal::compiler::Assessment*>,std::__ndk1::__map_value_compare<v8::internal::compiler::InstructionOperand,std::__ndk1::__value_type<v8::internal::compiler::InstructionOperand,v8::internal::compiler::Assessment*>,v8::internal::compiler::OperandAsKeyLess,true>,v8::internal::ZoneAllocator<std::__ndk1::__value_type<v8::internal::compiler::InstructionOperand,v8::internal::compiler::Assessment*>>>
      **)(p_Var7 + 0x10) = p_Var11;
    *(undefined8 *)(p_Var7 + 0x28) = uVar2;
    *(__tree_node_base **)p_Var10 = p_Var7;
    p_Var1 = p_Var7;
    if (**(long **)this != 0) {
      *(long *)this = **(long **)this;
