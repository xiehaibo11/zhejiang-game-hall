...
void FUN_01446f78(long param_1,undefined8 param_2,undefined8 param_3,long param_4,undefined8 param_5
...

{
  ...
  if (*(int *)(param_1 + -1) == (int)*(undefined8 *)(unaff_x26 + 0x120)) {
    *(int *)(param_6 + -0x20) = (iVar6 + -1) * 2;
    ...
    lVar9 = 0;
    if (((int)lVar1 != 0) && (*(int *)(lVar1 + 3) != 0)) goto LAB_01447db8;
    ...
    if (((lVar1 << 0x20) >> 0x21 & 0x30U) != 0) {
      if (((uint)((int)lVar1 >> 1) >> 4 & 1) == 0) {
        ...
        while( true ) {
          ...
          if (iVar2 == (int)param_4) {
            if ((ulong)((long)((ulong)*(uint *)(uVar10 + 3) << 0x20) >> 0x21) <= lVar1 + 6U) {
              ...
              pcVar7 = (code *)SoftwareBreakpoint(0,0x1447060);
              (*pcVar7)();
            }
            uVar11 = unaff_x26 + (ulong)*(uint *)(uVar10 + lVar12 + 0xb);
            if ((*(int *)(uVar10 + lVar12 + 0xf) >> 1 & 1U) == 0) goto LAB_01446eb8;
              ...
              if (sVar4 == 0x423) {
                ...
                if ((*(int *)(uVar11 + 3) != (int)*(undefined8 *)(unaff_x26 + 0x908)) ||
                   ((((bVar3 = *(byte *)(lVar9 + 9), (bVar3 & 0xc0) != 0xc0 &&
                    ...
                    (int)uVar11 == (int)*(undefined8 *)(unaff_x26 + 0xa8))))) goto LAB_01447db8;
            ...
            uVar11 = param_8;
            if ((int)lVar1 != (int)*(undefined8 *)(unaff_x26 + 0xca8)) goto LAB_01446eb8;
            if (*(int *)(lVar9 + 0x33) == (int)*(undefined8 *)(unaff_x26 + 0xa8)) {
              ...
              if ((uVar11 & 1) == 0) goto LAB_01447db8;
              ...
              if (sVar4 != 0x439) {
                if (sVar4 == 0x417) {
                  ...
                  uVar11 = param_9;
                  if ((int)lVar8 == (int)*(undefined8 *)(unaff_x26 + 0xca8)) goto LAB_01447db8;
                }
              }
              uVar5 = *(ushort *)
                       (unaff_x26 +
                        (ulong)*(uint *)(unaff_x26 + (ulong)*(uint *)(uVar11 + 0xf) + -1) + 7);
              if (uVar5 < 0x88 || 0x91 < uVar5) goto LAB_01447db8;
              *(int *)(param_6 + -0x20) = (iVar6 + -1) * 2;
        ...
        if ((int)uVar11 == 3) goto LAB_01447db8;
        ...
        if (((int)uVar11 != (int)lVar9) &&
           ((*(short *)(unaff_x26 + (ulong)*(uint *)(param_9 - 1) + 7) != 0xab ||
            (*(int *)(uVar11 + 0x27b) != *(int *)(lVar9 + 0x27b))))) goto LAB_01447db8;
      }
    }
...
LAB_01446eb8:
  ...
  (**(code **)(unaff_x21 + (ulong)*(byte *)(*(long *)(lVar8 + -0x18) + unaff_x19 + 7) * 8))(uVar11);
  return;
}
