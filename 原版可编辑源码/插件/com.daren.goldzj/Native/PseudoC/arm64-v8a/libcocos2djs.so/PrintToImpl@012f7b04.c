...
/* v8::internal::compiler::Operator1<int, v8::internal::compiler::OpEqualTo<int>,
   v8::internal::compiler::OpHash<int> >::PrintToImpl(std::__ndk1::basic_ostream<char,
...
PrintToImpl(Operator1<int,v8::internal::compiler::OpEqualTo<int>,v8::internal::compiler::OpHash<int>>
...

{
  ...
  std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>(param_1,__s,sVar1);
                    /* WARNING: Could not recover jumptable at 0x012f7b5c. Too many branches */
