...
/* v8::internal::compiler::EffectControlLinearizer::LowerObjectIsString(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerObjectIsString
...

{
  ...
  pNVar2 = (Node *)GraphAssembler::Uint32Constant(this_00,0x40);
