...
/* void 
   v8::internal::compiler::GraphAssembler::Bind<0ul>(v8::internal::compiler::GraphAssemblerLabel<0ul>*)
    */

void __thiscall
v8::internal::compiler::GraphAssembler::Bind<0ul>(GraphAssembler *this,GraphAssemblerLabel *param_1)
