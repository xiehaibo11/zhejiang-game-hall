...
undefined4 FUN_00dc6610(long *param_1,long param_2,uint param_3,uint param_4)
...
LAB_00dc67dc:
      ...
      if ((uVar2 & 0x88) != 0) goto LAB_00dc67d4;
      if ((1 << (ulong)(uVar6 & 0x1f) & 0x110U) != 0) goto LAB_00dc6808;
    }
    break;
  case 2:
  case 6:
    ...
    if (uVar6 < 9) {
      bVar12 = false;
      if ((1 << (ulong)(uVar6 & 0x1f) & 0x22U) != 0) goto LAB_00dc67dc;
      uVar2 = 1 << (ulong)(uVar6 & 0x1f);
      if ((uVar2 & 0x88) != 0) goto LAB_00dc680c;
      if ((uVar2 & 0x110) != 0) goto LAB_00dc67d4;
    }
    break;
  case 3:
  case 7:
...
LAB_00dc6820:
  ...
  if (bVar11) {
    do {
      ...
      if ((lVar17 == -1) && ((int)param_1[1] != 0)) goto LAB_00dc6a60;
      uVar2 = (int)param_1[0x11] + uVar22;
      uVar8 = 0;
      if (local_64 != 0) {
        uVar8 = uVar2 / local_64;
