...
/* std::__ndk1::vector<v8::internal::GlobalHandles::TracedNode*,
   std::__ndk1::allocator<v8::internal::GlobalHandles::TracedNode*> >::__append(unsigned long) */
...
LAB_00f69248:
  ...
  if (uVar1 == 0) {
    ...
    if (uVar1 >> 0x3d != 0) goto LAB_00f69248;
