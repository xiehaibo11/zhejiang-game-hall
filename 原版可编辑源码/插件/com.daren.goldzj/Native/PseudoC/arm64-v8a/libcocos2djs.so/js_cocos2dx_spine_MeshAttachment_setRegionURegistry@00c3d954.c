...
/* js_cocos2dx_spine_MeshAttachment_setRegionURegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_MeshAttachment_setRegionURegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (MeshAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1872,"js_cocos2dx_spine_MeshAttachment_setRegionU");
    pcVar6 = "js_cocos2dx_spine_MeshAttachment_setRegionU : Invalid Native Object";
LAB_00c3dac8:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::MeshAttachment::setRegionU(this,local_64);
        goto LAB_00c3db00;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1879,"js_cocos2dx_spine_MeshAttachment_setRegionU");
      pcVar6 = "js_cocos2dx_spine_MeshAttachment_setRegionU : Error processing arguments";
      goto LAB_00c3dac8;
    }
    __android_log_print(6,"jswrapper",&DAT_01905d8e,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_MeshAttachment_setRegionU",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1880);
LAB_00c3db00:
