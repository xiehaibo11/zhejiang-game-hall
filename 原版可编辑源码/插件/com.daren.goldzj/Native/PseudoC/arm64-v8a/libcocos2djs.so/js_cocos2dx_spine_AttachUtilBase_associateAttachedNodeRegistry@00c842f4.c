...
/* js_cocos2dx_spine_AttachUtilBase_associateAttachedNodeRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_AttachUtilBase_associateAttachedNodeRegistry(FunctionCallbackInfo *param_1)
...
LAB_00c8457c:
        ...
        lVar9 = 0;
        if (!bVar3 && (byte)pVVar11[0x18] < 2) goto LAB_00c8457c;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x3f4d,&DAT_018f0153);
      puVar10 = &DAT_01925390;
      goto LAB_00c844ac;
    }
    __android_log_print(6,"jswrapper",&DAT_019253e4,(ulong)(puVar6[1] - (long)pVVar11) >> 4,2);
  }
