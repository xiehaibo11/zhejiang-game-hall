...
/* v8::internal::Runtime_MapShrink(int, unsigned long*, v8::internal::Isolate*) */

undefined8 v8::internal::Runtime_MapShrink(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar7 = FUN_0155b860(param_1,param_2,param_3);
    return uVar7;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar5 & 1) != 0) &&
    ...
    puVar4 = (ulong *)OrderedHashTable<v8::internal::OrderedHashMap,2>::Shrink(param_3,puVar4);
    uVar8 = *param_2;
    uVar5 = *puVar4;
