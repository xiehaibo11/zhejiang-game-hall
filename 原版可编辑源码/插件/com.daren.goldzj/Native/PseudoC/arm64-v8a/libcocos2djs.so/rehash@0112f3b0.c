...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::Module>,
   ...
   v8::internal::UnorderedStringSet*> > >::rehash(unsigned long) */
...
::rehash(__hash_table<std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::Module>,v8::internal::UnorderedStringSet*>,std::__ndk1::__unordered_map_hasher<v8::internal::Handle<v8::internal::Module>,std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::Module>,v8::internal::UnorderedStringSet*>,v8::internal::ModuleHandleHash,true>,std::__ndk1::__unordered_map_equal<v8::internal::Handle<v8::internal::Module>,std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::Module>,v8::internal::UnorderedStringSet*>,v8::internal::ModuleHandleEqual,true>,v8::internal::ZoneAllocator<std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::Module>,v8::internal::UnorderedStringSet*>>>
         *this,ulong param_1)

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      if (uVar1 < uVar2) goto LAB_0112f474;
    }
    return;
  }
LAB_0112f474:
