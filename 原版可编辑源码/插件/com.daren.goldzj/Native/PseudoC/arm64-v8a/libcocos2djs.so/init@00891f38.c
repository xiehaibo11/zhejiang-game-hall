...
/* cocos2d::RenderTexture::init(int) */

void __thiscall cocos2d::RenderTexture::init(RenderTexture *this,int param_1)

{
  ...
  *(ulong *)(this + 0x30) =
       CONCAT44((int)((float)((ulong)*(undefined8 *)(this + 0x38) >> 0x20) / (float)param_1),
                (int)((float)*(undefined8 *)(this + 0x38) / (float)param_1));
  uVar2 = initProgram(this);
  if ((uVar2 & 1) != 0) {
    initTexture(this);
    Configuration::getInstance();
    uVar2 = Configuration::supportsShareableVAO();
    if ((uVar2 & 1) == 0) {
