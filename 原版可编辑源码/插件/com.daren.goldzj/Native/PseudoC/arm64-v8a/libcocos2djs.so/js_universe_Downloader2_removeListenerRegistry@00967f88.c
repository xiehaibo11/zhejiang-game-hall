...
/* js_universe_Downloader2_removeListenerRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_universe_Downloader2_removeListenerRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Downloader2 *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x13c,"js_universe_Downloader2_removeListener");
    __android_log_print(6,"jswrapper",
                        "js_universe_Downloader2_removeListener : Invalid Native Object");
  }
  else {
    ...
    if (uVar6 == 0x10) {
      ...
      if ((uVar6 & 1) != 0) {
        universe::Downloader2::removeListener(this,local_64);
        goto LAB_00968140;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp"
                          ,0x143,"js_universe_Downloader2_removeListener");
      __android_log_print(6,"jswrapper",
                          "js_universe_Downloader2_removeListener : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp, 327): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar6 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_universe_Downloader2_removeListener",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp"
                      ,0x14a);
LAB_00968140:
