...
/* spine::TransformConstraintTimeline::TransformConstraintTimeline(int) */

void __thiscall
spine::TransformConstraintTimeline::TransformConstraintTimeline
          (TransformConstraintTimeline *this,int param_1)

{
  ...
  *(undefined ***)this = &PTR__TransformConstraintTimeline_01c8f888;
  *(undefined ***)(this + 0x28) = &PTR__Vector_01c8d048;
  *(long *)(this + 0x30) = (long)(param_1 * 5);
  if (param_1 != 0) {
