...
/* v8::internal::StackTraceFrame::GetOneBasedLineNumber(v8::internal::Handle<v8::internal::StackTraceFrame>)
    */

int v8::internal::StackTraceFrame::GetOneBasedLineNumber(ulong *param_1)
