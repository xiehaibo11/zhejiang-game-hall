...
/* bool v8::internal::wasm::ThreadImpl::ExecuteLoad<int, signed char>(v8::internal::wasm::Decoder*,
   v8::internal::wasm::InterpreterCode*, unsigned long, int*, v8::internal::MachineRepresentation,
   int) */

bool __thiscall
v8::internal::wasm::ThreadImpl::ExecuteLoad<int,signed_char>
...

{
  ...
  *(long *)(this + 0x28) = lVar7 + -0x11;
  ...
  if (!CARRY4(local_a0._1_4_,uVar11)) {
    ...
    if (((*(long *)(lVar7 + 0x13) != 0) && ((ulong)uVar2 <= *(long *)(lVar7 + 0x13) - 1U)) &&
       (pcVar3 = (char *)((*(ulong *)(lVar7 + 0x1b) & (ulong)uVar2) + *(long *)(lVar7 + 0xb)),
       pcVar3 != (char *)0x0)) {
      uStack_98 = 0;
      local_a0 = (ulong)CONCAT41((int)*pcVar3,1);
      local_90 = 0;
