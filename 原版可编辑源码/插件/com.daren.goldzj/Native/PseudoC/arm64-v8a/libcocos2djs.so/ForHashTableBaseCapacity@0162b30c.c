...
/* v8::internal::compiler::AccessBuilder::ForHashTableBaseCapacity() */

void __thiscall v8::internal::compiler::AccessBuilder::ForHashTableBaseCapacity(AccessBuilder *this)
