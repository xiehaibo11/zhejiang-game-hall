...
/* v8::tracing::TracedValue::AppendString(char const*) */

void __thiscall v8::tracing::TracedValue::AppendString(TracedValue *this,char *param_1)

{
  ...
  if (((byte)bVar2 & 1) == 0) {
    ...
    uVar1 = 0x16;
    if (uVar4 == 0x16) goto LAB_011fa0d8;
  }
  else {
