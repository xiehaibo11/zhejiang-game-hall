...
::PrintToImpl(Operator1<v8::internal::compiler::RegionObservability,v8::internal::compiler::OpEqualTo<v8::internal::compiler::RegionObservability>,v8::internal::compiler::OpHash<v8::internal::compiler::RegionObservability>>
...

{
  ...
  std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>(param_1,__s,sVar1);
                    /* WARNING: Could not recover jumptable at 0x0169305c. Too many branches */
