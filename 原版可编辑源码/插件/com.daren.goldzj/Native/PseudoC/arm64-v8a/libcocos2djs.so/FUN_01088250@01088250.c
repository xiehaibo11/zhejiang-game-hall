...
undefined8 FUN_01088250(undefined8 param_1,ulong *param_2,uint param_3)

{
  ...
  if (0 < (int)uVar3) {
    ...
    if (uVar3 < 8) {
      ...
      if (uVar14 == uVar12) goto LAB_010883a8;
    }
...
LAB_010883a8:
  if (uVar2 != 0) {
    v8::internal::Heap::CopyRange<v8::internal::CompressedObjectSlot>
              ((Heap *)(this + 0x8850),uVar6,uVar6 + 7,uVar10 + 7,uVar2,4);
  }
