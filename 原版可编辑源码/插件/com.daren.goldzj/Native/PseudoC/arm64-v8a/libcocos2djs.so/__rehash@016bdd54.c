...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned int,
   ...
   v8::internal::compiler::VariableTracker::State> > >::__rehash(unsigned long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<unsigned_int,v8::internal::compiler::VariableTracker::State>,std::__ndk1::__unordered_map_hasher<unsigned_int,std::__ndk1::__hash_value_type<unsigned_int,v8::internal::compiler::VariableTracker::State>,v8::base::hash<unsigned_int>,true>,std::__ndk1::__unordered_map_equal<unsigned_int,std::__ndk1::__hash_value_type<unsigned_int,v8::internal::compiler::VariableTracker::State>,std::__ndk1::equal_to<unsigned_int>,true>,v8::internal::ZoneAllocator<std::__ndk1::__hash_value_type<unsigned_int,v8::internal::compiler::VariableTracker::State>>>
           *this,ulong param_1)
      ...
      if (plVar6 != (long *)0x0) {
        do {
          ...
          if ((uVar12 & 0xffffffff) < 2) {
            uVar7 = uVar7 & uVar3;
LAB_016bde48:
            if (uVar7 == uVar4) goto LAB_016bde10;
LAB_016bde50:
            plVar9 = plVar6;
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) goto LAB_016bdeac;
            do {
              plVar8 = plVar9;
              plVar9 = (long *)*plVar8;
            ...
            **(undefined8 **)(*(long *)this + uVar7 * 8) = plVar6;
            ...
            if (uVar7 < param_1) goto LAB_016bde48;
            uVar1 = 0;
            if (param_1 != 0) {
              uVar1 = uVar7 / param_1;
            }
            uVar7 = uVar7 - uVar1 * param_1;
            if (uVar7 != uVar4) goto LAB_016bde50;
LAB_016bde10:
            plVar9 = (long *)*plVar6;
            plVar5 = plVar6;
          }
