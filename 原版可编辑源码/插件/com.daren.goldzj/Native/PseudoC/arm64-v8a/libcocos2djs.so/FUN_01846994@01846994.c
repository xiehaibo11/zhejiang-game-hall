...
void FUN_01846994(long param_1,undefined8 *param_2)

{
  ...
  if (*(char *)(param_1 + 0x20) == '\0') {
    if (uVar2 <= uVar4) {
      ...
      *param_2 = pvVar1;
      if (pvVar1 == (void *)0x0) goto LAB_01846bc4;
      lVar3 = param_2[1];
      uVar4 = lVar3 + 1;
    }
    else {
    ...
    param_2[1] = uVar4;
    *(undefined1 *)((long)pvVar1 + lVar3) = 0x2e;
...
LAB_01846bc4:
  ...
  if (*(char *)((long)plVar5 + 9) == '\x01') {
    return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x01846bc0. Too many branches */
