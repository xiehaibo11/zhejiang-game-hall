...
LAB_00afcf84:
  ...
  case -2:
    ...
    goto LAB_00afcf84;
  default:
    goto switchD_00afcedc_default;
  }
  bn_sub_part_words(param_7 + lVar14,lVar12,lVar13,iVar2,iVar11);
switchD_00afcedc_default:
  bVar7 = false;
  bVar8 = false;
LAB_00afcfcc:
  if (((param_4 & 0xfffffffe) == 8) && (param_6 == 0 && param_5 == 0)) {
    ...
    bn_mul_recursive(bp,lVar3,lVar4,uVar15,param_5,param_6,puVar1);
                    ...
                    /* try { // try from 00afd144 to 00bfd233 has its CatchHandler @ 00afd144
                       catch() { ... } // from try @ 00afd144 with catch @ 00afd144
                       catch() { ... } // from try @ 00afd240 with catch @ 00afd144 */
