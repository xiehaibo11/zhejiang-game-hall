...
Value * __thiscall v8::Value::ToString(Value *this,long param_2)
    ...
    if ((*(int *)(pIVar7 + 0x2c20) == (int)uVar8) ||
      ...
      *(undefined8 *)local_48 = uVar8;
      ...
      if (internal::TracingFlags::runtime_stats != 0) {
        ...
        internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x3b5);
      }
      this_00 = *(Logger **)(pIVar7 + 0x9558);
      uVar5 = internal::Logger::is_logging(this_00);
      if ((uVar5 & 1) != 0) {
        internal::Logger::ApiEntryCall(this_00,"v8::Object::ToString");
      }
      ...
      *(undefined4 *)(pIVar7 + 0x2c60) = 5;
      ...
      if (((uVar5 & 1) == 0) ||
         (pVVar3 = this,
         0x3f < *(ushort *)((uVar5 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar5 - 1)))) {
        pVVar3 = (Value *)internal::Object::ConvertToString(pIVar7,this);
      }
      this = local_48;
      if (pVVar3 == (Value *)0x0) {
        local_a0 = '\x01';
...
LAB_00eb116c:
          ...
          if (*(code **)(lVar4 + 0xb738) == (code *)0x0) goto LAB_00eb116c;
