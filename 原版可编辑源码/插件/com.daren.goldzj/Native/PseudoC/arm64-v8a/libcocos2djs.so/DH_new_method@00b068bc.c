...

{
  ...
  if (dh == (DH *)0x0) {
                    /* try { // try from 00b06940 to 00c0694b has its CatchHandler @ 00b06b2c */
...
LAB_00b0699c:
      ...
      *(DH_METHOD **)&(dh->ex_data).dummy = pDVar3;
      if (pDVar3 != (DH_METHOD *)0x0) goto LAB_00b069e8;
      iVar1 = 0x26;
      line = 0x56;
                    /* try { // try from 00b069c4 to 00c06aab has its CatchHandler @ 00b06b34 */
    }
  }
