...
uint FUN_0108fa98(ulong *param_1,ulong *param_2,long param_3,int param_4,int param_5)

{
  ...
  if ((uint)(*(int *)(*param_2 + 3) >> 1) < uVar1) {
    ...
    *(int *)(uVar8 + 7) = (int)uVar7;
    ...
    FUN_0108fc58(this,param_1,param_2,param_4,0,iVar5);
  }
  iVar2 = 0;
  if (param_5 != 0) {
    iVar2 = iVar5;
...
LAB_0108fc0c:
        *pdVar6 = dVar9;
        ...
        pdVar6 = (double *)(uVar7 + (long)(iVar2 * 8 + iVar5));
        if (!NAN(dVar9)) goto LAB_0108fc0c;
        *pdVar6 = NAN;
      }
      param_4 = param_4 + -1;
      iVar5 = iVar5 + 8;
