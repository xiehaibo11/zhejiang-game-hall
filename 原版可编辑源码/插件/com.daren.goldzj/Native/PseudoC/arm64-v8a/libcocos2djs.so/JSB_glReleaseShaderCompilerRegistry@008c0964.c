...
/* JSB_glReleaseShaderCompilerRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glReleaseShaderCompilerRegistry(FunctionCallbackInfo *param_1)
