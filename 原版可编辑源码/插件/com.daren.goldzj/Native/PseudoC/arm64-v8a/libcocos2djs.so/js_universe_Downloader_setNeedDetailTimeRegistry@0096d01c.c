...
/* js_universe_Downloader_setNeedDetailTimeRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_universe_Downloader_setNeedDetailTimeRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Downloader *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3fd,"js_universe_Downloader_setNeedDetailTime");
    __android_log_print(6,"jswrapper",
                        "js_universe_Downloader_setNeedDetailTime : Invalid Native Object");
  }
  else {
    ...
    if (uVar6 == 0x10) {
      ...
      if ((uVar6 & 1) != 0) {
        universe::Downloader::setNeedDetailTime(this,local_64[0]);
        goto LAB_0096d1d0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp"
                          ,0x404,"js_universe_Downloader_setNeedDetailTime");
      __android_log_print(6,"jswrapper",
                          "js_universe_Downloader_setNeedDetailTime : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp, 1032): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar6 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_universe_Downloader_setNeedDetailTime",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp"
                      ,0x40b);
LAB_0096d1d0:
