...
/* js_gfx_IndexBuffer_setBytesRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_gfx_IndexBuffer_setBytesRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x48,"js_gfx_IndexBuffer_setBytes");
    __android_log_print(6,"jswrapper","js_gfx_IndexBuffer_setBytes : Invalid Native Object");
  }
  else {
    ...
    if (uVar7 == 0x10) {
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                          ,0x4f,"js_gfx_IndexBuffer_setBytes");
      __android_log_print(6,"jswrapper","js_gfx_IndexBuffer_setBytes : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp, 83): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar7 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_gfx_IndexBuffer_setBytes",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                      ,0x56);
LAB_00928894:
