...
/* v8::internal::interpreter::BytecodeArrayBuilder::PushContext(v8::internal::interpreter::Register)
    */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::PushContext(BytecodeArrayBuilder *this,int param_2)
