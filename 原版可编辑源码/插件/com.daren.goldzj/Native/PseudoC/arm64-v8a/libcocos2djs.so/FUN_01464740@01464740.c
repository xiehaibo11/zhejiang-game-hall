...
void FUN_01464740(ulong param_1)

{
  ...
  do {
    ...
    if ((param_1 & 1) == 0) {
      ...
      uVar12 = uVar13;
LAB_014648e8:
      uVar16 = uVar16 >> (ulong)(iVar6 * 2 >> 1 & 0x1f);
      ...
      if ((uVar13 == 0) &&
        ...
        *(undefined4 *)(lVar8 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x01464960. Too many branches */
