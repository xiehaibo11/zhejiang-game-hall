...
/* void std::__ndk1::vector<void*, std::__ndk1::allocator<void*>
   >::__push_back_slow_path<void*>(void*&&) */

void __thiscall
std::__ndk1::vector<void*,std::__ndk1::allocator<void*>>::__push_back_slow_path<void*>
          (vector<void*,std::__ndk1::allocator<void*>> *this,void **param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_0115e0a0;
