...
undefined8 FUN_01393ce4(ulong param_1)

{
    ...
    *unaff_x29 = *unaff_x29;
    ...
    if (uVar3 == 0x41) {
      if ((int)lVar2 == iVar6) {
        ...
        FUN_013be7e0(3,*(undefined8 *)(unaff_x26 + 0x1c00),0x24,*(undefined8 *)(unaff_x26 + 0x1c00))
        ;
      }
      ...
      if (uVar3 == 0x41) {
        ...
        unaff_x29[-8] = uVar5;
                    /* WARNING: Subroutine does not return */
        FUN_013be7e0(3,*(undefined8 *)(unaff_x26 + 0x1c08),0x28,3);
      }
      if (uVar3 < 0xa9) {
  ...
  if (bVar4) {
    if ((int)uVar5 < (int)param_1) goto LAB_01393d94;
  }
  else {
