...
/* v8::internal::compiler::JSTypedArrayData::JSTypedArrayData(v8::internal::compiler::JSHeapBroker*,
   v8::internal::compiler::ObjectData**, v8::internal::Handle<v8::internal::JSTypedArray>) */

void __thiscall
v8::internal::compiler::JSTypedArrayData::JSTypedArrayData
          (JSTypedArrayData *this,long param_1,undefined8 param_3,long *param_4)

{
  ...
  *(undefined8 *)(this + 0x30) = 0;
  this[0x48] = (JSTypedArrayData)0x0;
  ...
  *(undefined4 *)(this + 0xa8) = 0x3f800000;
  ...
  ::rehash((__hash_table<std::__ndk1::__hash_value_type<int,v8::internal::compiler::ObjectData*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,v8::internal::compiler::ObjectData*>,v8::base::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,v8::internal::compiler::ObjectData*>,std::__ndk1::equal_to<int>,true>,v8::internal::ZoneAllocator<std::__ndk1::__hash_value_type<int,v8::internal::compiler::ObjectData*>>>
            *)(this + 0x78),100);
  this[0xb0] = (JSTypedArrayData)(*(int *)(*param_4 + 0x2f) == *(int *)(*param_4 + 7));
  *(undefined8 *)(this + 0xb8) = *(undefined8 *)(*param_4 + 0x1f);
  lVar3 = *(long *)(*param_4 + 0x27);
  uVar1 = *(uint *)(*param_4 + 0x2f);
  this[200] = (JSTypedArrayData)0x0;
  *(undefined8 *)(this + 0xd0) = 0;
  *(ulong *)(this + 0xc0) = lVar3 + (ulong)uVar1;
  return;
}
