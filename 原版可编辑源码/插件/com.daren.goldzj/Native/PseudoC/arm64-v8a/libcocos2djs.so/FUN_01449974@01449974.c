...
void FUN_01449974(long param_1,undefined8 param_2,undefined8 param_3,long param_4,undefined8 param_5
  ...
  if ((int)param_6 != (int)*(undefined8 *)(unaff_x26 + 0xa0)) {
    ...
    if (uVar3 != uVar4) {
      ...
      *(undefined4 *)(param_6 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x01449970. Too many branches */
