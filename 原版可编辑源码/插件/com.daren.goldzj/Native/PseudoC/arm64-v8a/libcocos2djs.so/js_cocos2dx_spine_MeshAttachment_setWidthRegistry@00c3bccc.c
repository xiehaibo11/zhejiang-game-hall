...
/* js_cocos2dx_spine_MeshAttachment_setWidthRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_MeshAttachment_setWidthRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (MeshAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1781,"js_cocos2dx_spine_MeshAttachment_setWidth");
    pcVar6 = "js_cocos2dx_spine_MeshAttachment_setWidth : Invalid Native Object";
LAB_00c3be40:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::MeshAttachment::setWidth(this,local_64);
        goto LAB_00c3be78;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1788,"js_cocos2dx_spine_MeshAttachment_setWidth");
      pcVar6 = "js_cocos2dx_spine_MeshAttachment_setWidth : Error processing arguments";
      goto LAB_00c3be40;
    }
    __android_log_print(6,"jswrapper",&DAT_01904d91,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_MeshAttachment_setWidth",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x178f);
LAB_00c3be78:
