...

{
  ...
  if (*(long **)(this + 0x160) != (long *)0x0) {
    ...
    DAT_01d289ec = -fVar3 / fVar7;
    DAT_01d289f0 = -fVar4 / fVar7;
    DAT_01d289f4 = fVar2 / fVar7;
    DAT_01d289f8 = (fVar4 * fVar9 - fVar5 * fVar6) / fVar7;
    DAT_01d289fc = -(fVar2 * fVar9 - fVar3 * fVar6) / fVar7;
    TransformObject::_helpPoint =
         DAT_01d289f8 + TransformObject::_helpMatrix * param_1 + DAT_01d289f0 * param_2;
    DAT_01d3df94 = DAT_01d289fc + DAT_01d289ec * param_1 + DAT_01d289f4 * param_2;
                    /* WARNING: Could not recover jumptable at 0x00d2ce18. Too many branches */
