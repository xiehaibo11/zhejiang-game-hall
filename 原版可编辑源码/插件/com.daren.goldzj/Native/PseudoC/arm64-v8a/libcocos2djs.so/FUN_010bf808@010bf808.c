...
undefined8
FUN_010bf808(undefined8 param_1,long param_2,ulong *param_3,ulong *param_4,ulong param_5,
            ulong param_6)

{
  ...
  if ((((dVar7 <= 255.0) && (0.0 <= dVar7)) &&
      ((ABS(dVar7) != INFINITY && ((!NAN(ABS(dVar7)) && (param_5 < uVar1)))))) &&
     (dVar7 == (double)(uint)(int)dVar7)) {
    do {
      if ((uint)*(byte *)(*(long *)(uVar4 + 0x27) + (ulong)*(uint *)(uVar4 + 0x2f) + param_5) ==
          (int)dVar7) {
        return 0x101;
      }
      param_5 = param_5 + 1;
