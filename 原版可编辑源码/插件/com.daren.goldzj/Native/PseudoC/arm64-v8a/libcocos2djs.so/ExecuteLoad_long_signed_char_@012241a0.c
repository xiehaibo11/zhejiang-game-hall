...
/* bool v8::internal::wasm::ThreadImpl::ExecuteLoad<long, signed char>(v8::internal::wasm::Decoder*,
   v8::internal::wasm::InterpreterCode*, unsigned long, int*, v8::internal::MachineRepresentation,
   int) */

bool __thiscall
v8::internal::wasm::ThreadImpl::ExecuteLoad<long,signed_char>
...

{
  ...
  *(long *)(this + 0x28) = lVar8 + -0x11;
  ...
  if (!CARRY4(local_a0._1_4_,uVar12)) {
    ...
    if (((*(long *)(lVar8 + 0x13) != 0) && ((ulong)uVar2 <= *(long *)(lVar8 + 0x13) - 1U)) &&
       (pcVar3 = (char *)((*(ulong *)(lVar8 + 0x1b) & (ulong)uVar2) + *(long *)(lVar8 + 0xb)),
       pcVar3 != (char *)0x0)) {
      cVar4 = *pcVar3;
      iStack_b7 = (int7)cVar4;
      bStack_b0 = cVar4 >> 7;
