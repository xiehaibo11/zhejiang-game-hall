...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<_JNIEnv*, std::__ndk1::vector<_jobject*,
   ...
   std::__ndk1::allocator<_jobject*> > > > >::__rehash(unsigned long) */
...
joined_r0x00870800:
      if (plVar7 != (long *)0x0) {
        do {
          ...
          if ((uVar6 & param_1) == 0) {
            uVar8 = uVar8 & uVar6;
            if (uVar8 != uVar4) goto LAB_00870844;
LAB_00870808:
            plVar10 = (long *)*plVar7;
            plVar5 = plVar7;
          }
            ...
            if (uVar8 == uVar4) goto LAB_00870808;
LAB_00870844:
            plVar10 = plVar7;
            if (*(long *)(*(long *)this + uVar8 * 8) == 0) goto LAB_008708a0;
            do {
              plVar9 = plVar10;
              plVar10 = (long *)*plVar9;
