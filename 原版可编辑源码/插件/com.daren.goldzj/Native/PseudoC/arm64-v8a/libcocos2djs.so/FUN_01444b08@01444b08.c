...
void FUN_01444b08(ulong param_1,undefined8 param_2,long param_3,undefined8 param_4,long param_5,
  ...
  if ((int)uVar10 != (int)*(undefined8 *)(unaff_x26 + 0xc08)) {
    ...
    if (uVar16 == 4) {
      ...
      if ((uVar14 >> 6 & 1) == 0) {
        ...
        if (bVar9) {
                    /* WARNING: Could not recover jumptable at 0x0144562c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + in_x9) * 8))();
          return;
        }
...
LAB_01445694:
          ...
          *(undefined8 *)(lVar17 + 3) = uVar11;
                    /* WARNING: Could not recover jumptable at 0x014456fc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + in_x9) * 8))();
          return;
        }
        ...
        if (bVar9) {
                    /* WARNING: Could not recover jumptable at 0x01445670. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + in_x9) * 8))
      ...
      if (uVar16 == 5) {
                    /* WARNING: Could not recover jumptable at 0x014455d4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        ...
        while( true ) {
          ...
          if (iVar2 == (int)param_3) {
            if ((ulong)((long)((ulong)*(uint *)(uVar10 + 3) << 0x20) >> 0x21) <= lVar1 + 6U) {
              ...
              pcVar8 = (code *)SoftwareBreakpoint(0,0x14452f8);
              (*pcVar8)();
            }
            uVar12 = unaff_x26 + (ulong)*(uint *)(uVar10 + lVar18 + 0xb);
            lVar17 = param_5;
            if ((*(int *)(uVar10 + lVar18 + 0xf) >> 1 & 1U) == 0) goto LAB_01445540;
            if (*(int *)(uVar12 - 1) == (int)*(undefined8 *)(unaff_x26 + 0xcc8)) {
              ...
              uVar12 = in_x11;
              if ((int)lVar18 != (int)*(undefined8 *)(unaff_x26 + 0xca8)) goto LAB_01445540;
              if (*(int *)(lVar1 + 0x33) == (int)*(undefined8 *)(unaff_x26 + 0xa8)) {
                ...
                if ((uVar10 & 1) != 0) {
                  ...
                  *(undefined4 *)(param_5 + -0x20) = param_8;
                  ...
                  unaff_x21 = unaff_x20;
LAB_01445540:
                    /* WARNING: Could not recover jumptable at 0x01445564. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        ...
        if (uVar16 == 6) {
          ...
          *(undefined4 *)(param_5 + -0x20) = param_8;
          FUN_0133fcc0(0,unaff_x26 + (ulong)uVar14);
                    /* WARNING: Could not recover jumptable at 0x01445270. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        ...
        if (uVar16 == 7) {
          ...
          *(undefined4 *)(param_5 + -0x20) = param_8;
          FUN_01348300(uVar12,uVar13,param_3,unaff_x26 + (ulong)uVar14);
                    /* WARNING: Could not recover jumptable at 0x014451f4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x21 + (ulong)*(byte *)(*(long *)(param_5 + -0x18) + in_x9) * 8))();
          return;
        }
        if ((uVar16 == 8) || (uVar16 == 9)) {
          ...
          if ((int)(unaff_x26 + (ulong)uVar14) == 3) {
                    /* WARNING: Does not return */
            pcVar8 = (code *)SoftwareBreakpoint(0,0x144510c);
            (*pcVar8)();
          }
          ...
          *(undefined4 *)(param_5 + -0x20) = param_8;
          FUN_01348140(uVar13,uVar11,0,unaff_x26 + (ulong)uVar3,param_5,
                    ...
                    /* WARNING: Could not recover jumptable at 0x01445190. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x20 + (ulong)*(byte *)(*(long *)(local_40 + -0x18) + param_5) * 8))();
          return;
        }
        if (uVar16 != 3) {
          ...
          if (uVar16 == 0xc) {
            *(undefined4 *)(param_5 + -0x20) = param_8;
            FUN_013fc180(uVar12,param_3,uVar13);
                    /* WARNING: Could not recover jumptable at 0x01444e10. Too many branches */
                    /* WARNING: Treating indirect jump as call */
            (**(code **)(unaff_x21 + (ulong)*(byte *)(*(long *)(param_5 + -0x18) + in_x9) * 8))();
            return;
          }
          ...
          if ((ulong)((long)((ulong)*(uint *)(lVar17 + 3) << 0x20) >> 0x21) <= uVar10) {
                    /* WARNING: Does not return */
            pcVar8 = (code *)SoftwareBreakpoint(0,0x1444d40);
            (*pcVar8)();
          }
          if ((int)unaff_x26 + *(int *)(unaff_x26 + (ulong)*(uint *)(lVar17 + uVar10 * 4 + 7) + 3)
              != (int)*(undefined8 *)(unaff_x26 + 0xa8)) {
                    /* WARNING: Could not recover jumptable at 0x01444d7c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
            (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + in_x9) * 8))();
            return;
          }
...
LAB_014450bc:
                    /* WARNING: Could not recover jumptable at 0x014450e0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
