...
/* std::__ndk1::vector<v8::internal::compiler::Node*,
   v8::internal::ZoneAllocator<v8::internal::compiler::Node*> >::__append(unsigned long,
...
__append(vector<v8::internal::compiler::Node*,v8::internal::ZoneAllocator<v8::internal::compiler::Node*>>
         *this,ulong param_1,Node **param_2)

{
  ...
  if ((3 < param_1) &&
     (((undefined8 *)((long)param_2 + 1U) <= puVar4 ||
      ((Node **)(lVar5 + (lVar11 + param_1) * 8) <= param_2)))) {
    pNVar2 = *param_2;
