...
undefined4
FUN_00dd51a4(long param_1,int *param_2,long param_3,undefined4 param_4,int param_5,float *param_6)
...
LAB_00dd525c:
      ...
      uVar3 = FUN_00dd5308(param_1,param_2,param_3,param_4,5,param_5,param_5 << 3,__ptr);
      _TIFFfree(__ptr);
    }
  }
  return uVar3;
