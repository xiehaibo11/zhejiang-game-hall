...

{
  ...
  ulong *puVar4;
                    ...
                    /* try { // try from 00aff5c0 to 00bff5c7 has its CatchHandler @ 00aff604 */
                    /* try { // try from 00aff5c8 to 00bff623 has its CatchHandler @ 00aff540 */
  param_1[(long)param_3 * 2 + -1] = 0;
  *param_1 = 0;
  if (1 < param_3) {
                    /* catch() { ... } // from try @ 00aff5c0 with catch @ 00aff604 */
