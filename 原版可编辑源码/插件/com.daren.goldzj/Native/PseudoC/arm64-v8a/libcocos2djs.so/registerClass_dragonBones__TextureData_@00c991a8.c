...
/* void JSBClassType::registerClass<dragonBones::TextureData>(se::Class*) */

void JSBClassType::registerClass<dragonBones::TextureData>(Class *param_1)
