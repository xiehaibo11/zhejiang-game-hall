...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CompareMaps(v8::internal::ZoneHandleSet<v8::internal::Map>)
    */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::CompareMaps
...

{
  ...
  Operator::Operator(pOVar1,0xe3,0x30,"CompareMaps",1,1,1,1,1,0);
