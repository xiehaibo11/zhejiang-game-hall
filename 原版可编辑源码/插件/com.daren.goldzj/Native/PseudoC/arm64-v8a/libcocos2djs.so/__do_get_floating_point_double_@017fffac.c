...
__do_get_floating_point<double>
          ...
          wchar_t *param_5,undefined8 *param_6)
...
LAB_01800068:
  if (param_2 == (long *)0x0) {
    bVar4 = true;
    if (param_3 != (long *)0x0) goto LAB_018000ac;
LAB_018000e8:
    param_3 = (long *)0x0;
    if (bVar4) goto LAB_018001d8;
  }
  else {
    ...
    param_2 = plVar2;
    if (param_3 == (long *)0x0) goto LAB_018000e8;
LAB_018000ac:
...
LAB_018001d8:
  ...
  uVar17 = FUN_01829038(pcVar16,local_1d0,param_5);
  *param_6 = uVar17;
  uVar7 = (ulong)((byte)local_1b0[0] >> 1);
  if (((byte)local_1b0[0] & 1) != 0) {
    uVar7 = local_1a8;
  ...
  if (uVar7 != 0) {
    ...
    if (local_190 < puVar9) {
      ...
      do {
        if ((bVar4) && (*puVar15 != uVar10)) goto LAB_01800334;
...
LAB_01800334:
  ...
  if (param_2 == (long *)0x0) {
    bVar4 = true;
    if (param_3 != (long *)0x0) goto LAB_01800388;
LAB_0180035c:
    if (!bVar4) goto LAB_018003cc;
  }
  else {
    if ((int *)param_2[3] == (int *)param_2[4]) {
      iVar6 = (**(code **)(*param_2 + 0x48))(param_2);
    ...
    param_2 = plVar2;
    if (param_3 == (long *)0x0) goto LAB_0180035c;
LAB_01800388:
    if ((int *)param_3[3] == (int *)param_3[4]) {
      iVar6 = (**(code **)(*param_3 + 0x48))(param_3);
    }
    ...
    if (bVar4 != (iVar6 == -1)) goto LAB_018003cc;
  }
  *param_5 = *param_5 | 2;
LAB_018003cc:
  if ((local_1c8 & 1) != 0) {
