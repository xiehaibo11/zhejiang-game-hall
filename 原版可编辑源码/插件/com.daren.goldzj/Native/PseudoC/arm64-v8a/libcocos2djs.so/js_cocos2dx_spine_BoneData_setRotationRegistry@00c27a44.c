...
/* js_cocos2dx_spine_BoneData_setRotationRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_BoneData_setRotationRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (BoneData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xc45,"js_cocos2dx_spine_BoneData_setRotation");
    pcVar6 = "js_cocos2dx_spine_BoneData_setRotation : Invalid Native Object";
LAB_00c27bb8:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::BoneData::setRotation(this,local_64);
        goto LAB_00c27bf0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0xc4c,"js_cocos2dx_spine_BoneData_setRotation");
      pcVar6 = "js_cocos2dx_spine_BoneData_setRotation : Error processing arguments";
      goto LAB_00c27bb8;
    }
    __android_log_print(6,"jswrapper",&DAT_018fb328,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_BoneData_setRotation",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0xc53);
LAB_00c27bf0:
