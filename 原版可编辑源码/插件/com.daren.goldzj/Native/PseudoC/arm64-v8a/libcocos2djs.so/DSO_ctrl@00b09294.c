  ...
  if (dso == (DSO *)0x0) {
    ...
    if ((dso->meth != (DSO_METHOD *)0x0) &&
       (UNRECOVERED_JUMPTABLE = dso->meth->dso_bind_func, UNRECOVERED_JUMPTABLE != (_func_3877 *)0x0
                    ...
                    /* WARNING: Could not recover jumptable at 0x00b09310. Too many branches */
    ...
    line = 0xe0;
                    ...
                    /* try { // try from 00b0932c to 00c09337 has its CatchHandler @ 00b09ab8 */
  ERR_put_error(0x25,0x6e,reason,"crypto/dso/dso_lib.c",line);
                    /* try { // try from 00b09338 to 00c093d3 has its CatchHandler @ 00b091d8 */
  return -1;
}
