...
/* js_cocos2dx_dragonbones_CCArmatureDisplay_addDBEventListenerRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_CCArmatureDisplay_addDBEventListenerRegistry
...

{
  ...
  if (plVar6 == (long *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1c7e,"js_cocos2dx_dragonbones_CCArmatureDisplay_addDBEventListener");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_CCArmatureDisplay_addDBEventListener : Invalid Native Object"
                       );
  }
  else {
...
LAB_00cc76d0:
        ...
        if ((uVar8 & 1) != 0) goto LAB_00cc7708;
LAB_00cc7738:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                            ,0x1ca4,"js_cocos2dx_dragonbones_CCArmatureDisplay_addDBEventListener");
        __android_log_print(6,"jswrapper",
                            "js_cocos2dx_dragonbones_CCArmatureDisplay_addDBEventListener : Error processing arguments"
                           );
        bVar2 = false;
      }
      else {
        local_b0 = (long *)0x0;
joined_r0x00cc7694:
        if ((uVar8 & 1) == 0) goto LAB_00cc7738;
LAB_00cc7708:
        (**(code **)(*plVar6 + 0x48))(plVar6,&local_170,alStack_d0);
        bVar2 = true;
      }
...
LAB_00cc77a8:
      ...
      if (bVar2) goto LAB_00cc77ec;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp, 7336): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar7[1] - *plVar7) >> 4,2);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_CCArmatureDisplay_addDBEventListener",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x1cab);
LAB_00cc77ec:
