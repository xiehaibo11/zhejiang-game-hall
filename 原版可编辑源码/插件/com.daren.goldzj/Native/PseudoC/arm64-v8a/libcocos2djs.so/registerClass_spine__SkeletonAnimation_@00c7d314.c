...
/* void JSBClassType::registerClass<spine::SkeletonAnimation>(se::Class*) */

void JSBClassType::registerClass<spine::SkeletonAnimation>(Class *param_1)
