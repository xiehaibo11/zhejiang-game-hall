...
/* v8::internal::Runtime_PromiseHookBefore(int, unsigned long*, v8::internal::Isolate*) */

undefined8 v8::internal::Runtime_PromiseHookBefore(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar2 = FUN_01579b18(param_1,param_2,param_3);
    return uVar2;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar4 & 1) != 0) &&
    ...
    if (*(short *)(uVar3 + *puVar5) == 0x42d) {
      ...
      if (*(short *)(uVar3 + *puVar5) == 0x42d) {
        Isolate::RunPromiseHook(param_3,2,param_2,param_3 + 0xa0);
      }
    }
