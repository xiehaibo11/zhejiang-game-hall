...

{
  ...
  *(short *)(param_1 + 0x280) = *(short *)(param_1 + 0x280) + 1;
  uVar5 = FUN_00db7ee0(param_1,uVar25,&local_70,(long *)(param_1 + 0x20));
  __ptr = local_70;
  if ((uVar5 & 0xffff) == 0) {
  ...
  *(uint *)(param_1 + 0x10) = *(uint *)(param_1 + 0x10) & 0xffefffbf;
  ...
  do {
    if (*puVar17 == 0x115) {
      if (puVar17 != (ushort *)0x0) {
        iVar6 = FUN_00db8418(param_1,puVar17,0);
        if (iVar6 == 0) goto LAB_00db78f8;
        *puVar17 = 0;
      }
      break;
    }
  ...
  do {
    if (*puVar17 == 0x103) {
      if (puVar17 != (ushort *)0x0) {
        iVar6 = FUN_00dba6b4(param_1,puVar17,local_74);
        if (iVar6 != 1) goto LAB_00db7498;
        if (*(ulong *)(puVar17 + 4) < (ulong)*(ushort *)(param_1 + 0x82)) {
          iVar6 = 1;
          goto LAB_00db749c;
        }
        iVar6 = FUN_00dbaf38(param_1,puVar17,&local_68);
        if (iVar6 != 0) goto LAB_00db7498;
...
LAB_00db7204:
    ...
    goto switchD_00db7394_caseD_102;
  }
  goto LAB_00db78f8;
...
LAB_00db749c:
  pcVar10 = "Compression";
LAB_00db74b4:
  FUN_00dba884(param_1,iVar6,"TIFFReadDirectory",pcVar10,0);
  if (__ptr == (ushort *)0x0) {
    return 0;
  }
  goto LAB_00db78fc;
...
LAB_00db7260:
    uVar16 = uVar27;
    if (iVar6 == 0) goto LAB_00db735c;
  }
  if (iVar6 != 2) goto joined_r0x00db7360;
LAB_00db7284:
...
LAB_00db7334:
    uVar16 = uVar27;
    if (iVar20 == 0) goto LAB_00db735c;
  }
joined_r0x00db7360:
  if (uVar12 == 0) goto switchD_00db7394_caseD_102;
  uVar19 = *(ushort *)(*(long *)(*(long *)(param_1 + 0x3f0) + (uVar16 & 0xffffffff) * 8) + 0x18);
  if (uVar19 == 0) goto LAB_00db73ac;
  switch(uVar12) {
  case 0x102:
  case 0x103:
  case 0x104:
...
switchD_00db7394_caseD_102:
  uVar15 = uVar15 + 1;
  puVar17 = puVar17 + 0xc;
  if ((uVar5 & 0xffff) <= (uVar15 & 0xffff)) goto code_r0x00db73c4;
  goto LAB_00db7204;
LAB_00db735c:
  uVar16 = 0;
  uVar12 = uVar11;
...
LAB_00db75a8:
    ...
    do {
      ...
      switch(uVar19) {
      case 0xff:
        iVar6 = FUN_00dba6b4(param_1,puVar17,&local_68);
        if (iVar6 == 0) {
      ...
      case 0x151:
      case 0x152:
switchD_00db75dc_caseD_100:
        FUN_00db8418(param_1,puVar17,1);
        break;
      case 0x102:
      case 0x118:
      case 0x119:
      case 0x153:
switchD_00db75dc_caseD_102:
        iVar6 = FUN_00dba6b4(param_1,puVar17,local_74);
        if (iVar6 == 1) {
          if (*(ulong *)(puVar17 + 4) < (ulong)*(ushort *)(param_1 + 0x82)) {
            iVar6 = 1;
...
LAB_00db7820:
        ...
        uVar19 = *puVar17;
        if (iVar6 != 0) goto LAB_00db79ec;
        iVar6 = TIFFSetField(param_1,uVar19,local_74[0]);
        goto joined_r0x00db7668;
      case 0x111:
      case 0x144:
      ...
      case 0x145:
        ...
        lVar24 = param_1 + 0xf0;
LAB_00db7664:
        iVar6 = FUN_00dbae00(param_1,puVar17,uVar3,lVar24);
joined_r0x00db7668:
        if (iVar6 == 0) goto LAB_00db78f8;
        break;
      case 0x12d:
      case 0x140:
        ...
        FUN_00dba884(param_1,iVar6,"TIFFReadDirectory",pcVar10,1);
        break;
      case 0x154:
      case 0x155:
        if (*(ulong *)(puVar17 + 4) == (ulong)*(ushort *)(param_1 + 0x82)) {
          iVar6 = FUN_00dba9c4(param_1,puVar17,&local_68);
          psVar21 = local_68;
          if (iVar6 == 0) {
...
LAB_00db79ec:
      ...
      default:
        if (uVar19 != 0) {
          if (uVar19 == 0x80e4) goto switchD_00db75dc_caseD_102;
          goto switchD_00db75dc_caseD_100;
        }
      }
      uVar15 = uVar15 + 1;
      puVar17 = puVar17 + 0xc;
...
LAB_00db7a50:
      ...
      if (*(short *)(param_1 + 0x78) == 6) goto LAB_00db7bfc;
      if ((*(byte *)(param_1 + 0x3b) & 1) == 0) {
        if (*(short *)(param_1 + 0xaa) == 2) {
          if (*(uint *)(param_1 + 0xe4) != (uint)*(ushort *)(param_1 + 0x82)) goto LAB_00db7dec;
        }
...
LAB_00db7be4:
        ...
        iVar6 = FUN_00dbb288(param_1,__ptr,uVar5);
        if (iVar6 < 0) goto LAB_00db78f8;
      }
      else {
