...
/* cocos2d::Map<std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   ...
   cocos2d::network::SIOClientImpl*>::erase(std::__ndk1::basic_string<char,
...

{
  ...
  long local_38;
                    ...
                    /* try { // try from 009e73dc to 00ae73eb has its CatchHandler @ 009e74a8 */
  lVar1 = tpidr_el0;
  local_38 = *(long *)(lVar1 + 0x28);
                    /* try { // try from 009e73ec to 00ae754f has its CatchHandler @ 009e7058 */
  lVar3 = std::__ndk1::
  ...
  if (lVar3 != 0) {
    ...
    pvVar2 = local_50[0];
    local_50[0] = (void *)0x0;
                    /* catch() { ... } // from try @ 009e7210 with catch @ 009e7420 */
    if (pvVar2 != (void *)0x0) {
                    /* catch() { ... } // from try @ 009e7200 with catch @ 009e7430 */
      if ((local_40 != '\0') && ((*(byte *)((long)pvVar2 + 0x10) & 1) != 0)) {
        operator_delete(*(void **)((long)pvVar2 + 0x20));
      }
                    /* catch() { ... } // from try @ 009e71e4 with catch @ 009e7440 */
      operator_delete(pvVar2);
    }
    uVar4 = 1;
  }
                    /* catch() { ... } // from try @ 009e71d4 with catch @ 009e7450 */
  if (*(long *)(lVar1 + 0x28) == local_38) {
                    /* catch() { ... } // from try @ 009e7190 with catch @ 009e7460 */
                    /* catch() { ... } // from try @ 009e717c with catch @ 009e7468 */
    return;
  }
                    /* WARNING: Subroutine does not return */
                    /* catch() { ... } // from try @ 009e7154 with catch @ 009e746c */
