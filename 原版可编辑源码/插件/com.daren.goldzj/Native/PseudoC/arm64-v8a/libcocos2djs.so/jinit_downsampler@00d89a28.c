      ...
      *(int *)((long)puVar8 + lVar10 * 4 + 0x68) = iVar4;
      if ((iVar6 == iVar3) && (iVar2 == iVar4)) {
        if (*(int *)((long)param_1 + 0x134) == 0) {
          puVar8[lVar10 + 3] = FUN_00d89f6c;
        }
        else {
          puVar8[lVar10 + 3] = FUN_00d89d0c;
          *(undefined4 *)(puVar8 + 2) = 1;
        }
      }
      else if ((iVar6 == iVar3 * 2) && (iVar2 == iVar4)) {
        bVar7 = false;
        puVar8[lVar10 + 3] = FUN_00d8a020;
      }
      else if ((iVar6 == iVar3 * 2) && (iVar2 == iVar4 * 2)) {
        if (*(int *)((long)param_1 + 0x134) == 0) {
          puVar8[lVar10 + 3] = FUN_00d8a3f8;
        }
        else {
          puVar8[lVar10 + 3] = FUN_00d8a168;
          *(undefined4 *)(puVar8 + 2) = 1;
        }
      }
      else {
...
LAB_00d89bf4:
    ...
    if ((!bVar7) && (*(int *)((long)param_1 + 0x134) != 0)) {
      ...
      *(undefined4 *)(lVar10 + 0x28) = 0x65;
                    /* WARNING: Could not recover jumptable at 0x00d89c44. Too many branches */
