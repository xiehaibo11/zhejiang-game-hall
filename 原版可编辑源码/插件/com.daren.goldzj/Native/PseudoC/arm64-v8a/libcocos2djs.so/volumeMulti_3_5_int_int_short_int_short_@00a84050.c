...
/* void cocos2d::volumeMulti<3, 5, int, int, short, int, short>(int*, unsigned long, int const*,
   int*, short const*, short) */

void cocos2d::volumeMulti<3,5,int,int,short,int,short>
...

{
  ...
  if (param_4 == (int *)0x0) {
    do {
      param_2 = param_2 - 1;
                    /* try { // try from 00a84110 to 00b84153 has its CatchHandler @ 00a84168 */
      *param_1 = *param_1 + (*param_3 >> 0xc) * iVar8;
      ...
      piVar1 = param_3 + 4;
                    /* try { // try from 00a84154 to 00b841ef has its CatchHandler @ 00a83f08 */
      param_3 = param_3 + 5;
      param_1[4] = param_1[4] + (*piVar1 >> 0xc) * iVar8;
                    /* catch() { ... } // from try @ 00a83fc8 with catch @ 00a84168
                       catch() { ... } // from try @ 00a84110 with catch @ 00a84168 */
      param_1 = param_1 + 5;
    } while (param_2 != 0);
  }
  else {
