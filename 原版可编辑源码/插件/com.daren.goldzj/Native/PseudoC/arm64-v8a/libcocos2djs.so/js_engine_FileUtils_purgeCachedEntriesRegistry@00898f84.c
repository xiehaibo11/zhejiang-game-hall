...
/* js_engine_FileUtils_purgeCachedEntriesRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_engine_FileUtils_purgeCachedEntriesRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar4 == (long *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x277,"js_engine_FileUtils_purgeCachedEntries");
    __android_log_print(6,"jswrapper",
                        "js_engine_FileUtils_purgeCachedEntries : Invalid Native Object");
  }
  else {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 638): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar5[1] - *plVar5) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_FileUtils_purgeCachedEntries",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x281);
LAB_008990dc:
