...
::Equals(Operator1<v8::internal::ConvertReceiverMode,v8::internal::compiler::OpEqualTo<v8::internal::ConvertReceiverMode>,v8::internal::compiler::OpHash<v8::internal::ConvertReceiverMode>>
