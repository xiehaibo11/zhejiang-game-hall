...
bool FUN_00e040d4(ulong *param_1,long param_2)
  ...
  if (0 < *(int *)(param_2 + 0x198)) {
    ...
    do {
      ...
      if (*(int *)(param_2 + 0x84) == 0) {
        ...
        if (uVar18 < 0x7f) {
          uVar14 = (ulong)uVar18;
          uVar18 = (uint)(byte)(&DAT_01970d00)[uVar18];
          uVar9 = (int)uVar10 - (uint)(byte)(&DAT_01970c80)[uVar14];
          uVar10 = (ulong)uVar9;
        ...
        *(uint *)(param_1 + 1) = uVar18;
        ...
        if (uVar9 < 0x7f) {
          uVar10 = (ulong)uVar9;
          uVar9 = (uint)(byte)(&DAT_01970d00)[uVar9];
          *(uint *)((long)param_1 + 0xc) = iVar8 - (uint)(byte)(&DAT_01970c80)[uVar10];
        }
      ...
      *(undefined1 *)(lVar16 + lVar22 * 800 + 0x31e) = uVar11;
      ...
      if (uVar9 < 0x7f) {
        uVar13 = (ulong)uVar9;
        uVar9 = (uint)(byte)(&DAT_01970d00)[uVar9];
        uVar18 = (int)uVar10 - (uint)(byte)(&DAT_01970c80)[uVar13];
        uVar10 = (ulong)uVar18;
      ...
      if (bVar7) {
        ...
        do {
          ...
          do {
            ...
            uVar9 = *(uint *)((long)param_1 + 0xc);
            uVar10 = (ulong)uVar9;
            bVar5 = (&UNK_01971880)[(long)(int)uVar18 + (long)(int)uVar18 * 8 + (ulong)bVar4 * 0x5a]
            ;
            if ((int)uVar9 < 0) {
              puVar12 = (ulong *)param_1[2];
              if (puVar12 < (ulong *)param_1[4]) {
            ...
            if (uVar9 < 0x7f) {
              uVar15 = (ulong)uVar9;
              uVar9 = (uint)(byte)(&DAT_01970d00)[uVar9];
              uVar21 = (int)uVar10 - (uint)(byte)(&DAT_01970c80)[uVar15];
              uVar10 = (ulong)uVar21;
              *(uint *)((long)param_1 + 0xc) = uVar21;
            }
            cVar6 = (&DAT_01971c04)[uVar14];
            *(uint *)(param_1 + 1) = uVar9;
            for (; (0xa2eaUL >> uVar14 & 1) != 0; uVar14 = uVar14 & 0x3f) {
              bVar5 = (&UNK_01971880)[(long)cVar6 + (long)(int)uVar18 * 9 + (ulong)bVar4 * 0x5a];
              if ((int)uVar10 < 0) {
                puVar12 = (ulong *)param_1[2];
                if (puVar12 < (ulong *)param_1[4]) {
                  uVar14 = *puVar12;
              ...
              if (uVar21 < 0x7f) {
                uVar14 = (ulong)uVar21;
                uVar21 = (uint)(byte)(&DAT_01970d00)[uVar21];
                uVar9 = (int)uVar10 - (uint)(byte)(&DAT_01970c80)[uVar14];
                uVar10 = (ulong)uVar9;
                *(uint *)((long)param_1 + 0xc) = uVar9;
              }
        ...
        if (uVar18 < 0x7f) {
          uVar13 = (ulong)uVar18;
          uVar18 = (uint)(byte)(&DAT_01970d00)[uVar18];
          uVar9 = (int)uVar10 - (uint)(byte)(&DAT_01970c80)[uVar13];
          uVar10 = (ulong)uVar9;
          *(uint *)((long)param_1 + 0xc) = uVar9;
        }
        *(uint *)(param_1 + 1) = uVar18;
        ...
        if (bVar7) {
          ...
          if (uVar9 < 0x7f) {
            uVar14 = (ulong)uVar9;
            uVar9 = (uint)(byte)(&DAT_01970d00)[uVar9];
            *(uint *)((long)param_1 + 0xc) = (int)uVar10 - (uint)(byte)(&DAT_01970c80)[uVar14];
          }
          *(uint *)(param_1 + 1) = uVar9;
          iVar8 = (uint)bVar7 << 1;
        }
      ...
      *(uint *)(param_1 + 1) = uVar18;
      if (bVar7) {
        ...
        if (uVar9 < 0x7f) {
          uVar14 = (ulong)uVar9;
          uVar9 = (uint)(byte)(&DAT_01970d00)[uVar9];
          uVar18 = (int)uVar10 - (uint)(byte)(&DAT_01970c80)[uVar14];
          uVar10 = (ulong)uVar18;
          *(uint *)((long)param_1 + 0xc) = uVar18;
        }
        *(uint *)(param_1 + 1) = uVar9;
