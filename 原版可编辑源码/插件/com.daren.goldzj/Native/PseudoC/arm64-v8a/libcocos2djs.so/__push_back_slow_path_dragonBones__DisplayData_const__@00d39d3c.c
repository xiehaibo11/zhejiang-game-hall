...
/* void std::__ndk1::vector<dragonBones::DisplayData*,
   std::__ndk1::allocator<dragonBones::DisplayData*>
   >::__push_back_slow_path<dragonBones::DisplayData* const&>(dragonBones::DisplayData* const&) */
...
__push_back_slow_path<dragonBones::DisplayData*const&>
          (vector<dragonBones::DisplayData*,std::__ndk1::allocator<dragonBones::DisplayData*>> *this
          ,DisplayData **param_1)
...
LAB_00d39da0:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d39da0;
  }
  else {
