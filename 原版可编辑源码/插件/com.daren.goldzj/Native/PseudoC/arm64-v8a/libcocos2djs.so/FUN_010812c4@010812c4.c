...
void FUN_010812c4(undefined8 param_1,ulong *param_2,ulong *param_3,ulong param_4,ulong param_5)

{
  ...
  if ((uint)(*(int *)((uVar3 & 0xffffffff00000000 | (ulong)*(uint *)(uVar3 + 7)) + 3) >> 1) <
      param_5) {
    FUN_01082000(param_2,param_5 & 0xffffffff);
    uVar3 = *param_2;
    if (7 < *(byte *)((uVar3 & 0xffffffff00000000 | 10) + (ulong)*(uint *)(uVar3 - 1))) {
