...
/* v8::internal::interpreter::BytecodeGenerator::VisitWhileStatement(v8::internal::WhileStatement*)
    */

void __thiscall
v8::internal::interpreter::BytecodeGenerator::VisitWhileStatement
          (BytecodeGenerator *this,WhileStatement *param_1)

{
  ...
  uVar3 = Expression::ToBooleanIsFalse(*(Expression **)(param_1 + 0x20));
  if ((uVar3 & 1) == 0) {
    LoopBuilder::LoopHeader((LoopBuilder *)&local_108);
    uVar3 = Expression::ToBooleanIsTrue(*(Expression **)(param_1 + 0x20));
    if ((uVar3 & 1) == 0) {
      ...
      local_68 = (WhileStatement *)((ulong)local_68 & 0xffffffffffffff00);
