...
/* js_cocos2dx_dragonbones_BoneData_get_parentRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_BoneData_get_parentRegistry
...

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x627,"js_cocos2dx_dragonbones_BoneData_get_parent");
    __android_log_print(6,"jswrapper",&DAT_019311ff);
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_dragonbones_BoneData_get_parent",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x62f);
  }
  else {
    se::Value::Value(aVStack_58);
    native_ptr_to_rooted_seval<dragonBones::BoneData>
              (*(type **)(lVar3 + 0x50),aVStack_58,(bool *)0x0);
