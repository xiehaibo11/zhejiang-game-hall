...

{
  ...
  if (param_2[1] != 0) {
    ...
    uVar6 = (ulong)bVar5;
    lVar3 = uVar4 - uVar6;
                    /* try { // try from 00ada650 to 00bda657 has its CatchHandler @ 00ada940 */
    if (uVar6 <= uVar4) {
      pbVar1 = pbVar7 + uVar6;
                    /* try { // try from 00ada658 to 00bda6d7 has its CatchHandler @ 00ada4fc */
      *param_2 = (long)pbVar1;
      param_2[1] = lVar3;
      if (lVar3 != 0) {
        uVar4 = (ulong)*pbVar1;
...
LAB_00ada700:
              *(byte *)(param_1 + 0x2e0) = bVar5;
              return 3;
                    ...
                    /* try { // try from 00ada6d8 to 00bda6df has its CatchHandler @ 00ada930 */
                    /* try { // try from 00ada6e0 to 00bda75f has its CatchHandler @ 00ada4fc */
            lVar3 = CRYPTO_memdup(pbVar7,uVar6,"ssl/statem/../packet_locl.h",0x181);
            *(long *)(param_1 + 0x2d8) = lVar3;
            if (lVar3 != 0) goto LAB_00ada700;
