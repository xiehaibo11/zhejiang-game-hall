...
ulong FUN_00ab74ec(SSL *param_1,int param_2,ulong param_3,SSL *param_4)

{
  ...
  case 1:
    ...
    if ((_func_3058 *)pSVar8->handshake_func == pSVar8->method->ssl_read) {
      ...
      SSL_set_accept_state(pSVar8);
                    ...
                    /* catch() { ... } // from try @ 00ab7760 with catch @ 00ab7828 */
  ...
  case 0xe:
    break;
  case 6:
                    /* try { // try from 00ab75b0 to 00bb75c7 has its CatchHandler @ 00ab7620 */
    if ((append != (BIO *)0x0) && (append != pSVar8->rbio)) {
      BIO_up_ref(append);
                    /* try { // try from 00ab75c8 to 00bb763b has its CatchHandler @ 00ab73ec */
  ...
  case 10:
    ...
    break;
  case 0xb:
                    /* catch() { ... } // from try @ 00ab75b0 with catch @ 00ab7620 */
    BIO_clear_flags((BIO *)param_1,0xf);
                    /* try { // try from 00ab763c to 00bb775f has its CatchHandler @ 00ab763c
                       catch() { ... } // from try @ 00ab763c with catch @ 00ab763c
                       catch() { ... } // from try @ 00ab7768 with catch @ 00ab763c */
  ...
  case 0x6d:
    if (pSVar8 != (SSL *)0x0) {
      ...
      BIO_set_data(param_1,lVar5);
                    /* try { // try from 00ab7760 to 00bb7767 has its CatchHandler @ 00ab7828 */
      BIO_clear_flags((BIO *)param_1,-1);
    }
                    /* try { // try from 00ab7768 to 00bb783b has its CatchHandler @ 00ab763c */
    BIO_set_shutdown(param_1,param_3 & 0xffffffff);
    *puVar3 = param_4;
