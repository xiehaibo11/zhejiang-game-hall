...
/* bool spine_Vector_T_ptr_to_seval<spine::TrackEntry>(spine::Vector<spine::TrackEntry*> const&,
   se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::TrackEntry>(Vector *param_1,Value *param_2)
...
LAB_00c85c34:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::TrackEntry>
