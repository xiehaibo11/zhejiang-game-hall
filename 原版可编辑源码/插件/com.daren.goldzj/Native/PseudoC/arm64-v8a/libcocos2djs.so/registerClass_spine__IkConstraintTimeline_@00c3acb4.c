...
/* void JSBClassType::registerClass<spine::IkConstraintTimeline>(se::Class*) */

void JSBClassType::registerClass<spine::IkConstraintTimeline>(Class *param_1)
