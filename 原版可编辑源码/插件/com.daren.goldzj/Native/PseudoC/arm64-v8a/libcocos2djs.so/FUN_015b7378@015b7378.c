...
undefined8 FUN_015b7378(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_630,(ulong)&local_630 | 8,0x287);
  }
  if (DAT_01d477e0 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d477e0 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d477e0;
  local_650 = (byte **)0x0;
  if ((*DAT_01d477e0 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar3,"V8.Runtime_Runtime_WasmThrowCreate",0,0,0,0,0,0,0,
                       &local_608,0);
    plVar4 = local_600;
    local_600 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    local_650 = &local_648;
    local_640 = "V8.Runtime_Runtime_WasmThrowCreate";
    local_648 = pbVar3;
    local_638 = uVar5;
  }
  ...
  *(ulong *)(param_3 + 0x2bc8) = uVar6 & 0xffffffff00000000 | (ulong)*(uint *)(uVar6 + 0x77);
  uVar6 = *param_2;
  if (((uVar6 & 1) == 0) ||
     (*(short *)((uVar6 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar6 - 1)) != 0x72)) {
  ...
  puVar8 = (undefined8 *)v8::internal::Factory::NewWasmRuntimeError((Factory *)param_3,0x163,0,0,0);
  lVar9 = v8::internal::Object::SetProperty(param_3,puVar8,param_3 + 0xbf8,puVar7,0,1);
  if (lVar9 != 0) {
    uVar10 = v8::internal::Factory::NewFixedArray((Factory *)param_3,(int)uVar11 >> 1,0);
    lVar9 = v8::internal::Object::SetProperty(param_3,puVar8,param_3 + 0xc00,uVar10,0,1);
    if (lVar9 == 0) {
                    /* WARNING: Subroutine does not return */
