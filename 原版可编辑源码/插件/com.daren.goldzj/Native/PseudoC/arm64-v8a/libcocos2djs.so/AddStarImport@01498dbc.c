...
/* v8::internal::SourceTextModuleDescriptor::AddStarImport(v8::internal::AstRawString const*,
   v8::internal::AstRawString const*, v8::internal::Scanner::Location,
   v8::internal::Scanner::Location, v8::internal::Zone*) */

void __thiscall
v8::internal::SourceTextModuleDescriptor::AddStarImport
          (SourceTextModuleDescriptor *this,undefined8 param_1,AstRawString *param_2,
          undefined8 param_4,long param_5,Zone *param_6)

{
  ...
  puVar3 = *(undefined8 **)(param_6 + 0x10);
  if ((ulong)(*(long *)(param_6 + 0x18) - (long)puVar3) < 0x28) {
    puVar3 = (undefined8 *)Zone::NewExpand(param_6,0x28);
  }
  else {
    *(undefined8 **)(param_6 + 0x10) = puVar3 + 5;
  }
  *puVar3 = param_4;
  puVar3[1] = 0;
  puVar3[2] = param_1;
  puVar3[3] = 0;
  puVar3[4] = 0xffffffff;
  uStack_48 = (ulong)*(uint *)(this + 0x18) | param_5 << 0x20;
  local_50 = param_2;
  lVar2 = std::__ndk1::
  ...
  *(undefined4 *)(puVar3 + 4) = *(undefined4 *)(lVar2 + 0x28);
  ...
  if (puVar5 == *(undefined8 **)(this + 0x50)) {
    lVar2 = (long)puVar5 - *(long *)(this + 0x40) >> 3;
    uVar1 = lVar2 + 1;
    if (uVar1 >> 0x1c != 0) {
                    /* WARNING: Subroutine does not return */
      abort();
    }
    lVar4 = (long)*(undefined8 **)(this + 0x50) - *(long *)(this + 0x40);
    uVar7 = lVar4 >> 2;
    if (uVar1 <= uVar7) {
      uVar1 = uVar7;
    }
