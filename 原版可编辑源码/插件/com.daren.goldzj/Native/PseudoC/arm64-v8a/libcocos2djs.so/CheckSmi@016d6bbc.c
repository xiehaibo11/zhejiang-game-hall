...
/* v8::internal::compiler::JSCallReducerAssembler::CheckSmi(v8::internal::TNode<v8::internal::Object>)
    */

void __thiscall
v8::internal::compiler::JSCallReducerAssembler::CheckSmi(JSCallReducerAssembler *this,Node *param_2)

{
  ...
  pOVar2 = (Operator *)SimplifiedOperatorBuilder::CheckSmi(this_01,(FeedbackSource *)(lVar1 + 8));
