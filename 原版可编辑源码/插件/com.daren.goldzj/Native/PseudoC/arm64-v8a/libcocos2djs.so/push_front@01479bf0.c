...
/* std::__ndk1::__split_buffer<std::__ndk1::unique_ptr<v8::IdleTask,
   std::__ndk1::default_delete<v8::IdleTask> >*,
   std::__ndk1::allocator<std::__ndk1::unique_ptr<v8::IdleTask,
   std::__ndk1::default_delete<v8::IdleTask> >*>&>::push_front(std::__ndk1::unique_ptr<v8::IdleTask,
   std::__ndk1::default_delete<v8::IdleTask> >* const&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_01479d7c;
...
LAB_01479d50:
      ...
      if (((void *)((long)pvVar4 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar4 + uVar9 + uVar13 * 8 + 8))) goto LAB_01479d50;
      ...
      puVar7 = puVar8;
      if (uVar2 != uVar9) goto LAB_01479d50;
    }
