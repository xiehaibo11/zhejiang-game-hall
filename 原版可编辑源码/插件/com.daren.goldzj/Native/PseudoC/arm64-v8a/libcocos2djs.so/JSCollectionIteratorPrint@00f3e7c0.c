...
/* v8::internal::JSCollectionIterator::JSCollectionIteratorPrint(std::__ndk1::basic_ostream<char,
   std::__ndk1::char_traits<char> >&, char const*) */

void __thiscall
v8::internal::JSCollectionIterator::JSCollectionIteratorPrint
          (JSCollectionIterator *this,basic_ostream *param_1,char *param_2)

{
  basic_ostream *pbVar1;
  ulong local_28;
  
  FUN_00f3d5b0(param_1,*(undefined8 *)this);
