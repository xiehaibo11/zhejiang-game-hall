...
/* WARNING: Removing unreachable block (ram,0x013cbc8c) */
/* WARNING: Removing unreachable block (ram,0x013cbcb4) */
/* WARNING: Removing unreachable block (ram,0x013cbca8) */
/* WARNING: Removing unreachable block (ram,0x013cbcc0) */

undefined8
FUN_013cb220(undefined8 param_1,ulong param_2,ulong param_3,undefined8 param_4,ulong param_5)

{
  ...
  local_38 = param_3;
  local_90[4] = uVar13;
  uVar14 = *(undefined8 *)(unaff_x26 + 0xb8);
  puVar8 = local_90 + 4;
LAB_013cb270:
...
LAB_013cbdd4:
  ...
  if (uVar18 < 0xa9) goto LAB_013cbdd4;
  if (uVar18 == 0xa9) {
...
LAB_013cb380:
          ...
          do {
            iVar15 = (int)uVar22;
            if (uVar18 < 0x411) {
              if ((uVar18 != 0xaa) || ((*(byte *)(uVar21 + 9) & 0x24) != 0)) goto LAB_013cbdd4;
              ...
              while( true ) {
                ...
                if (*(int *)(lVar23 + 3) == iVar15) {
                  if ((ulong)((long)((ulong)*(uint *)(uVar17 + 3) << 0x20) >> 0x21) <= uVar1) {
                    ...
                    pcVar7 = (code *)SoftwareBreakpoint(0,0x13cbc48);
                    (*pcVar7)();
                  }
              ...
              if (uVar19 != 0) {
                if (uVar19 < 0x21) {
                  ...
                  while (lVar23 != 0) {
                    lVar23 = lVar23 + -3;
                    if (*(int *)(lVar20 + lVar23 * 4 + 0xf) == iVar15) goto LAB_013cbb24;
                  }
                }
                else {
                  ...
                  for (; iVar27 <= iVar4; iVar27 = iVar27 + 1) {
                    ...
                    if ((int)lVar23 == iVar15) {
                      if (uVar5 < uVar19) goto LAB_013cbb24;
                      break;
                    }
                  }
                }
              ...
              while( true ) {
                ...
                if (iVar27 == iVar15) goto LAB_013cbb24;
                lVar20 = lVar20 + 1;
                uVar25 = uVar25 + lVar20;
              }
            }
...
LAB_013cbc78:
                ...
                if (((uVar18 == 0x2d) || (uVar18 == 0x49)) ||
                   ((uVar18 == 0x4e || ((0x2f < uVar18 && (uVar18 < 0x3a)))))) goto LAB_013cbdd4;
              }
            }
            uVar17 = unaff_x26 + (ulong)*(uint *)(uVar21 + 0xf);
            if ((int)uVar17 == (int)*(undefined8 *)(unaff_x26 + 0xb0)) goto LAB_013cbb2c;
            uVar21 = unaff_x26 + (ulong)*(uint *)(uVar17 - 1);
            uVar18 = *(ushort *)(uVar21 + 7);
          } while( true );
        }
        if (0x3f < uVar3) {
          if (uVar3 != 0x43) goto LAB_013cbdd4;
          uVar22 = unaff_x26 + (ulong)*(uint *)(uVar11 + 0xb);
          goto LAB_013cb380;
        }
        uVar19 = *(uint *)(uVar11 + 3);
        if ((uVar19 & 0xc0000002) != 0) {
          if ((uVar19 >> 1 & 1) == 0) goto LAB_013cbdd4;
          if ((uVar3 == 0x25) || (uVar3 == 0x2d)) {
            uVar22 = unaff_x26 + (ulong)*(uint *)(uVar11 + 0xb);
          }
          else if ((uVar3 >> 5 & 1) != 0) goto LAB_013cbdd4;
          goto LAB_013cb380;
        }
    ...
    while( true ) {
      uVar11 = auVar30._0_8_;
      puVar8[3] = uVar21;
      if (uVar18 < 0x411) goto LAB_013cbdd4;
      bVar6 = *(byte *)(uVar21 + 10) >> 3;
      if (0xe < bVar6) break;
      if (bVar6 < 6) {
        if (bVar6 < 3) {
          if (((bVar6 == 0) || (bVar6 == 1)) || (bVar6 == 2)) goto LAB_013cb918;
          goto LAB_013cbdd4;
        }
        if (bVar6 == 3) goto LAB_013cb918;
        if ((bVar6 != 4) && (bVar6 != 5)) goto LAB_013cbdd4;
        lVar20 = unaff_x26 + (ulong)*(uint *)(uVar17 + 7);
        if (uVar22 < (ulong)((long)((ulong)*(uint *)(lVar20 + 3) << 0x20) >> 0x21)) {
          if (*(long *)(lVar20 + uVar22 * 8 + 7) == -0x8000000080001) goto LAB_013cba8c;
          goto LAB_013cbb24;
        }
LAB_013cb930:
        if (0xfffffffe < uVar22) goto LAB_013cbdd4;
      }
      else if (bVar6 < 9) {
        if (((bVar6 != 6) && (bVar6 != 7)) && (bVar6 != 8)) goto LAB_013cbdd4;
LAB_013cb918:
        lVar20 = unaff_x26 + (ulong)*(uint *)(uVar17 + 7);
        ...
        if (bVar6 < 0xb) {
          if ((bVar6 == 9) || (bVar6 == 10)) goto LAB_013cb918;
          goto LAB_013cbdd4;
        }
        if (bVar6 == 0xb) goto LAB_013cb918;
        if (bVar6 != 0xc) goto LAB_013cbdd4;
LAB_013cb970:
        if (0xfffffffe < uVar22) goto LAB_013cbdd4;
        ...
        puVar8[-1] = param_5;
        *(undefined8 *)(unaff_x26 + 0x40) = 0x13cb9b0;
...
LAB_013cba8c:
    ...
    if (bVar6 < 0x16) {
      if (bVar6 < 0x12) {
        ...
        if (bVar6 != 0x11) goto LAB_013cbdd4;
      }
      else if (bVar6 < 0x14) {
        if ((bVar6 != 0x12) && (bVar6 != 0x13)) goto LAB_013cbdd4;
      }
      else if ((bVar6 != 0x14) && (bVar6 != 0x15)) goto LAB_013cbdd4;
    }
    else if (bVar6 < 0x19) {
      if (((bVar6 != 0x16) && (bVar6 != 0x17)) && (bVar6 != 0x18)) goto LAB_013cbdd4;
    }
    else if (bVar6 < 0x1b) {
      if ((bVar6 != 0x19) && (bVar6 != 0x1a)) goto LAB_013cbdd4;
    }
    else if (bVar6 != 0x1b) {
      if (bVar6 == 0x1c) goto LAB_013cba8c;
      goto LAB_013cbdd4;
    }
    if (((*(uint *)(unaff_x26 + (ulong)*(uint *)(uVar17 + 0xb) + 0x1b) >> 2 & 1) == 0) &&
       (uVar22 < *(ulong *)(uVar17 + 0x1f))) goto LAB_013cbb24;
LAB_013cbb2c:
    iVar27 = (int)uVar16;
...
LAB_013cbb30:
  puVar9 = puVar8;
  if (iVar15 != (int)uVar14) goto LAB_013cbc00;
  uVar13 = FUN_013c0ba0(param_5,auVar30._0_8_);
  puVar9 = puVar8 + -4;
  puVar8[-2] = uVar13;
  puVar8[-1] = puVar8[7];
  puVar8[-4] = puVar8[6];
  puVar8[-3] = puVar8[10];
  auVar30 = FUN_0133fcc0(3,puVar8[8],puVar8[7],puVar8[6],puVar8[10]);
  uVar13 = auVar30._0_8_;
  iVar15 = auVar30._0_4_;
  if (iVar15 == (int)*(undefined8 *)(unaff_x26 + 0xc0)) {
LAB_013cbbcc:
    bVar10 = false;
  }
  else {
    if ((uVar13 & 1) == 0) {
      if (iVar15 != 0) goto LAB_013cbbc4;
      goto LAB_013cbbcc;
    }
    if ((iVar15 == (int)*(undefined8 *)(unaff_x26 + 200)) ||
       (lVar20 = unaff_x26 + (ulong)*(uint *)(uVar13 - 1), (*(byte *)(lVar20 + 9) >> 4 & 1) != 0))
    goto LAB_013cbbcc;
    if ((int)lVar20 == (int)*(undefined8 *)(unaff_x26 + 0x140)) {
      if (ABS(*(double *)(uVar13 + 3)) <= 0.0) goto LAB_013cbbcc;
    }
    else if ((*(short *)(lVar20 + 7) == 0x41) && ((*(uint *)(uVar13 + 3) >> 1 & 0x3fffffff) == 0))
    goto LAB_013cbbcc;
LAB_013cbbc4:
    bVar10 = true;
  }
