...
int FUN_00b14324(EC_GROUP *param_1,EC_POINT *param_2,BIGNUM *param_3,ulong param_4,void *param_5,
...
LAB_00b14670:
      ...
      if (((param_4 << 4 | 6) < 0x1555556) &&
        ...
        if ((ptr == (byte *)0x0) ||
           ...
           ptr_00 == (void *)0x0)) goto LAB_00b14c08;
        uVar22 = 0;
...
LAB_00b14acc:
            ...
            if ((int)lVar27 < 0x21) goto LAB_00b14acc;
          }
...
LAB_00b14c28:
      ...
      if (!bVar12) goto LAB_00b14f24;
LAB_00b14fc4:
      iVar14 = 0;
    }
    if (param_7 == (BN_CTX *)0x0) goto LAB_00b14fd4;
  }
  else {
          ...
          if (y == (BIGNUM *)0x0) {
            ...
            if (iVar14 != 0) {
              ...
              if (iVar14 == 0) {
                ...
                EC_POINT_free(p);
                if (puVar31 == (undefined1 *)0x0) goto LAB_00b14560;
LAB_00b14574:
                ...
                if ((0x100 < iVar14) ||
                  ...
                  pBVar15 = BN_CTX_get(param_7);
                  __dest = (void *)0x0;
                  if (pBVar15 == (BIGNUM *)0x0) goto LAB_00b14cac;
...
LAB_00b14cfc:
                  ...
                  if ((int)lVar30 < 0x21) goto LAB_00b14cfc;
                }
