...
/* v8::internal::JsonParser<unsigned char>::BuildJsonObject(v8::internal::JsonParser<unsigned
   char>::JsonContinuation const&, std::__ndk1::vector<v8::internal::JsonProperty,
   std::__ndk1::allocator<v8::internal::JsonProperty> > const&,
   v8::internal::Handle<v8::internal::Map>) */

ulong * __thiscall
v8::internal::JsonParser<unsigned_char>::BuildJsonObject
          (JsonParser<unsigned_char> *this,long param_1,long *param_2,ulong *param_4)
...
LAB_01044bbc:
    puVar13 = puVar7;
    if (param_4 != (ulong *)0x0) goto LAB_01044bc8;
LAB_01044cb4:
    uVar2 = 0;
  }
  else {
    ...
    if (param_4 == (ulong *)0x0) goto LAB_01044cb4;
LAB_01044bc8:
    uVar21 = *param_4;
      ...
      if ((*(byte *)(lVar32 + 8) >> 3 & 1) == 0) {
        ...
        if (iVar6 < (int)uVar2) {
          ...
          if (puVar9 == (ulong *)0x0) {
            ...
            if ((((ulong)pIVar25 & 1) == 0) || ((int)pIVar25 == 3)) goto LAB_01045990;
            if (((ulong)pIVar25 & 3) == 3) {
              ...
              if ((((ulong)pIVar25 & 3) != 1) ||
                 (*(short *)(((ulong)pIVar25 & 0xffffffff00000000 | 7) +
                            (ulong)*(uint *)(pIVar25 + -1)) != 0x98)) goto LAB_01045990;
        ...
        if ((puVar11 == puVar9) ||
          ...
          if (puVar9 == (ulong *)0x0) goto LAB_0104532c;
        }
        uVar26 = *puVar9;
        ...
        if ((uVar15 - 1 == 0) && (FLAG_track_fields != '\0')) {
          if ((uVar28 & 1) != 0) goto LAB_010450d8;
LAB_01045294:
          if (uVar15 == 2) {
...
LAB_01045168:
              ...
              if (FLAG_track_heap_object_fields == '\0') goto LAB_0104514c;
              bVar5 = uVar15 == 0;
              uVar22 = 3;
              if (uVar15 != 3) goto LAB_01045168;
            }
            if (uVar15 == 0) {
              if (uVar22 != 2) {
LAB_010451c4:
...
LAB_010451f4:
                ...
                goto LAB_010452b4;
                    ...
                    (FLAG_modify_field_representation_inplace != '\0')) goto LAB_010451c4;
            if (iVar6 != 0) {
              local_d8 = uVar26;
...
LAB_010452b4:
    ...
    uVar21 = (ulong)uVar16;
LAB_0104532c:
    if ((uint)uVar21 != uVar16) goto LAB_010453cc;
  }
