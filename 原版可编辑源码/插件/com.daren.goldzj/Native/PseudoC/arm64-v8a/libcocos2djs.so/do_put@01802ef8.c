...
/* WARNING: Removing unreachable block (ram,0x018032a8) */
...

{
  ...
  if (bVar6) {
    iVar8 = __libcpp_snprintf_l(local_98,0x1e,(__locale_t *)DAT_01d52dc0,(char *)&local_e0,param_1,
                                (ulong)*(uint *)(param_4 + 0x10));
    if (0x1d < iVar8) goto LAB_01803064;
LAB_0180303c:
    __ptr_00 = (char *)0x0;
  }
  else {
    iVar8 = __libcpp_snprintf_l(local_98,0x1e,(__locale_t *)DAT_01d52dc0,(char *)&local_e0,param_1);
    if (iVar8 < 0x1e) goto LAB_0180303c;
LAB_01803064:
    if (bVar6) {
      if (((DAT_01d52dc8 & 1) == 0) && (iVar8 = __cxa_guard_acquire(&DAT_01d52dc8), iVar8 != 0)) {
        DAT_01d52dc0 = newlocale(0x1fbf,"C",(__locale_t)0x0);
      ...
      iVar8 = __libcpp_asprintf_l(&local_e8,(__locale_t *)DAT_01d52dc0,(char *)&local_e0,param_1,
                                  (ulong)*(uint *)(param_4 + 0x10));
    }
    else {
      if (((DAT_01d52dc8 & 1) == 0) && (iVar8 = __cxa_guard_acquire(&DAT_01d52dc8), iVar8 != 0)) {
  ...
  if (local_e8 != local_98) {
    ...
    pcVar13 = __ptr;
    if (__ptr != (char *)0x0) goto LAB_0180314c;
    __throw_bad_alloc();
  }
  __ptr = (char *)0x0;
  pcVar13 = acStack_d4;
LAB_0180314c:
  ...
  uVar9 = FUN_00886dfc(param_3,pcVar13,pcStack_f0,local_f8,param_4,param_5);
  if (__ptr != (char *)0x0) {
    free(__ptr);
  }
