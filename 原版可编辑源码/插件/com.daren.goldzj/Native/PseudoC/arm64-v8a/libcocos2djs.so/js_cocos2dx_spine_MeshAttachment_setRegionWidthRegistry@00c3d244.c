...
/* js_cocos2dx_spine_MeshAttachment_setRegionWidthRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_MeshAttachment_setRegionWidthRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (MeshAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1839,"js_cocos2dx_spine_MeshAttachment_setRegionWidth");
    pcVar6 = "js_cocos2dx_spine_MeshAttachment_setRegionWidth : Invalid Native Object";
LAB_00c3d3b8:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::MeshAttachment::setRegionWidth(this,local_64);
        goto LAB_00c3d3f0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1840,"js_cocos2dx_spine_MeshAttachment_setRegionWidth");
      pcVar6 = "js_cocos2dx_spine_MeshAttachment_setRegionWidth : Error processing arguments";
      goto LAB_00c3d3b8;
    }
    __android_log_print(6,"jswrapper",&DAT_01905a11,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_MeshAttachment_setRegionWidth",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1847);
LAB_00c3d3f0:
