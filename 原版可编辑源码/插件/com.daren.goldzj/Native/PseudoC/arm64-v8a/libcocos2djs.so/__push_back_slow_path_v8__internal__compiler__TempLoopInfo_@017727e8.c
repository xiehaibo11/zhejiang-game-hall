...
/* void std::__ndk1::vector<v8::internal::compiler::TempLoopInfo,
   v8::internal::ZoneAllocator<v8::internal::compiler::TempLoopInfo>
   >::__push_back_slow_path<v8::internal::compiler::TempLoopInfo>(v8::internal::compiler::TempLoopInfo&&)
    */
...

{
  ...
  if (uVar1 < 0x3333334) {
    ...
    if ("ect::Cast" < (char *)(lVar3 * -0x3333333333333333)) {
      uVar1 = 0x3333333;
    }
    if (uVar1 == 0) {
      lVar3 = 0;
    ...
    *puVar4 = uVar8;
    ...
    lVar6 = *(long *)this;
    puVar2 = puVar4;
    for (lVar7 = *(long *)(this + 8); lVar7 != lVar6; lVar7 = lVar7 + -0x28) {
    ...
    *(undefined8 **)(this + 8) = puVar4 + 5;
    *(ulong *)(this + 0x10) = lVar3 + uVar1 * 0x28;
    return;
  }
