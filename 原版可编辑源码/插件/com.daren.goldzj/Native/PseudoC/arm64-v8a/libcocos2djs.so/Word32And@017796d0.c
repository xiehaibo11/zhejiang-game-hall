...
/* v8::internal::compiler::MachineOperatorReducer::Word32And(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::MachineOperatorReducer::Word32And
...

{
  ...
  pNVar3 = (Node *)ReduceWord32And(this,pNVar2);
  if (pNVar3 != (Node *)0x0) {
    pNVar2 = pNVar3;
  }
  return pNVar2;
