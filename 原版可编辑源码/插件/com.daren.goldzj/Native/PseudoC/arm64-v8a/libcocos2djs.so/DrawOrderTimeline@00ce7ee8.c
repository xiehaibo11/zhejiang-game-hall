...
/* spine::DrawOrderTimeline::DrawOrderTimeline(int) */

void __thiscall spine::DrawOrderTimeline::DrawOrderTimeline(DrawOrderTimeline *this,int param_1)
    ...
    *(long *)(this + 0x18) = (long)(int)uVar6;
    ...
    uVar4 = (**(code **)(*plVar3 + 0x20))
                      (plVar3,uVar4,-(ulong)(uVar6 >> 0x1f) & 0xfffffffc00000000 | (ulong)uVar6 << 2
                       ...
                       0x52);
    *(undefined8 *)(this + 0x20) = uVar4;
    lVar5 = *(ulong *)(this + 0x10) - uVar1;
    if (*(ulong *)(this + 0x10) < uVar1 || lVar5 == 0) goto joined_r0x00ce806c;
  }
  else {
    lVar5 = uVar7 - uVar1;
    if (uVar7 < uVar1 || lVar5 == 0) goto joined_r0x00ce806c;
  }
  memset((void *)(*(long *)(this + 0x20) + uVar1 * 4),0,lVar5 << 2);
joined_r0x00ce806c:
  if (0 < param_1) {
    do {
      local_70 = 0;
      ...
      Vector<spine::Vector<int>>::add
                ((Vector<spine::Vector<int>> *)(this + 0x28),(Vector *)&local_78);
      lVar5 = local_60;
      local_70 = 0;
      local_78 = &PTR__Vector_01c8e510;
      if (local_60 != 0) {
