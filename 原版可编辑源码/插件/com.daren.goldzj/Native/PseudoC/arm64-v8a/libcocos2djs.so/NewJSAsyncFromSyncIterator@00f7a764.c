...
/* v8::internal::Factory::NewJSAsyncFromSyncIterator(v8::internal::Handle<v8::internal::JSReceiver>,
   v8::internal::Handle<v8::internal::Object>) */

ulong * __thiscall
v8::internal::Factory::NewJSAsyncFromSyncIterator(Factory *this,ulong *param_2,ulong *param_3)

{
  ...
  uVar6 = uVar6 & 0xffffffff00000000 | (ulong)*(uint *)(uVar6 + 0x37);
  if (*(CanonicalHandleScope **)(this + 0x95b8) == (CanonicalHandleScope *)0x0) {
    puVar3 = *(ulong **)pFVar1;
    if (puVar3 == *(ulong **)(this + 0x95a8)) {
      puVar3 = (ulong *)HandleScope::Extend((Isolate *)this);
