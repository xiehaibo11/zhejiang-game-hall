...
/* js_cocos2dx_spine_TrackEntry_setAnimationLastRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_TrackEntry_setAnimationLastRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TrackEntry *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x329,"js_cocos2dx_spine_TrackEntry_setAnimationLast");
    pcVar6 = "js_cocos2dx_spine_TrackEntry_setAnimationLast : Invalid Native Object";
LAB_00c17764:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::TrackEntry::setAnimationLast(this,local_64);
        goto LAB_00c1779c;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x330,"js_cocos2dx_spine_TrackEntry_setAnimationLast");
      pcVar6 = "js_cocos2dx_spine_TrackEntry_setAnimationLast : Error processing arguments";
      goto LAB_00c17764;
    }
    __android_log_print(6,"jswrapper",&DAT_018f363f,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TrackEntry_setAnimationLast",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x337);
LAB_00c1779c:
