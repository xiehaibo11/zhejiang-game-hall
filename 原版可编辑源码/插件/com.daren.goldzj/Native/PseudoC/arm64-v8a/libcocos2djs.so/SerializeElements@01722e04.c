...
/* v8::internal::compiler::JSObjectRef::SerializeElements() */

void __thiscall v8::internal::compiler::JSObjectRef::SerializeElements(JSObjectRef *this)

{
  ...
  if (*(int *)(this_00 + 8) == 1) {
    if (0xa9 < *(ushort *)(*(long *)(this_00 + 0x10) + 0x18)) {
      JSObjectData::SerializeElements(this_00,*(JSHeapBroker **)(this + 8));
      return;
    }
                    /* WARNING: Subroutine does not return */
