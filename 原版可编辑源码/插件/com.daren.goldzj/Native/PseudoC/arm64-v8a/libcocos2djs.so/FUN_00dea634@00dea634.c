...
undefined8 FUN_00dea634(long param_1,int param_2)

{
  ...
  if (*(int *)(param_1 + 0xc0) == 0) {
    uVar14 = FUN_00deaf2c(puVar33,lVar42,iVar6,puVar33[0x22],param_2,FUN_00debb14);
    return uVar14;
  }
  uVar16 = puVar33[0x31];
  uVar35 = 0;
    ...
    while( true ) {
      ...
      if (((long)(iVar6 * param_2) <= iVar36 + lVar21) || (uVar16 != 0)) {
        ...
        if ((int)puVar33[0x23] < (int)uVar35) {
          FUN_00df2d34(puVar2,lVar42,uVar35,*(long *)(puVar33 + 6) + (int)puVar33[0x21] * lVar42,
      ...
      *(char *)(lVar42 + iVar36 + lVar21) = (char)uVar9;
      ...
      if (iVar6 <= (int)uVar40 + (int)lVar21) goto code_r0x00dea940;
    }
    if (0x117 < uVar25) {
LAB_00deaee0:
      uVar20 = 5;
    ...
    if ((int)(uVar16 + 1) < 0x79) {
      iVar13 = (8 - ((byte)(&DAT_0196fd0c)[(int)uVar16] & 0xf)) +
               (uint)((byte)(&DAT_0196fd0c)[(int)uVar16] >> 4) * iVar6;
      if (iVar13 < 2) {
        iVar13 = 1;
      }
    }
...
LAB_00deabc8:
      ...
      if ((int)uVar39 < 1) goto LAB_00deadf0;
      uVar41 = (ulong)uVar39;
      if (uVar39 < 0x20) {
LAB_00deac1c:
        lVar19 = 0;
      ...
      if (lVar19 == 0) goto LAB_00deac20;
      if (((ulong)(lVar42 + lVar29) < lVar42 + ((lVar29 + uVar41) - lVar30)) &&
         ((ulong)(lVar42 + (lVar29 - lVar30)) < lVar42 + lVar29 + uVar41)) goto LAB_00deac1c;
...
LAB_00dead48:
          ...
          if (uVar1 != 0) goto LAB_00dead48;
        }
        iVar36 = uVar26 * 4;
        if ((int)uVar39 <= iVar36) goto LAB_00deadf0;
      }
      lVar29 = (long)iVar36;
      ...
      if ((0x1f < uVar41) && (uVar18 = uVar41 & 0xffffffffffffffe0, uVar18 != 0)) {
        ...
        if (((byte *)((long)__src + lVar17) <= pbVar22) || (puVar15 + lVar17 <= pbVar23)) {
          ...
          if (uVar41 == uVar18) goto LAB_00deadf0;
        }
      }
...
LAB_00deadf0:
    ...
    while (uVar35 = uVar16, uVar25 = (uint)uVar40, iVar6 <= (int)uVar39) {
      ...
      if ((uVar16 & 0xf) == 0) {
        ...
        if ((int)puVar33[0x23] <= (int)uVar35) {
          FUN_00df2d34(puVar2,lVar21,uVar16,*(long *)(puVar33 + 6) + (int)puVar33[0x21] * lVar21,
