...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitCallProperty() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitCallProperty(BytecodeGraphBuilder *this)

{
  ...
  *puVar7 = uVar5;
  ...
  BuildCall(this,1,puVar7,(long)(int)uVar1,uVar2);
  return;
}
