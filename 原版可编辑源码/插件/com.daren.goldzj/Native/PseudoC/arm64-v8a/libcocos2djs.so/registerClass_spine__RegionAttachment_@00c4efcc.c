...
/* void JSBClassType::registerClass<spine::RegionAttachment>(se::Class*) */

void JSBClassType::registerClass<spine::RegionAttachment>(Class *param_1)
