...
/* v8::internal::compiler::JSTypedLowering::ReduceJSBitwiseNot(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::JSTypedLowering::ReduceJSBitwiseNot(JSTypedLowering *this,Node *param_1)

{
  ...
  if ((local_18 == 0x5fff) || (uVar2 = Type::SlowIs((Type *)&local_18,0x5fff), (uVar2 & 1) != 0)) {
    ...
    pNVar3 = (Node *)JSGraph::Constant(*(JSGraph **)(this + 0x10),-1.0);
    ...
    JSBinopReduction::ConvertInputsToUI32((JSBinopReduction *)&local_40,0,0);
    ...
    pNVar3 = local_38;
    uVar5 = Type::Intersect(*(undefined8 *)(local_38 + 8),1099,
