...
/* js_renderer_Camera_setFrameBufferRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Camera_setFrameBufferRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Camera *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x6ac,"js_renderer_Camera_setFrameBuffer");
    __android_log_print(6,"jswrapper","js_renderer_Camera_setFrameBuffer : Invalid Native Object");
  }
  else {
    ...
    if (puVar4[1] - (long)pVVar5 == 0x10) {
      if (pVVar5[8] == (Value)0x5) {
        ...
        pFVar6 = (FrameBuffer *)se::Object::getPrivateData(this_00);
        if (pFVar6 != (FrameBuffer *)0x0) {
LAB_00941da4:
          cocos2d::renderer::Camera::setFrameBuffer(this,pFVar6);
          goto LAB_00941e20;
        }
      }
      else if ((byte)pVVar5[8] < 2) {
        pFVar6 = (FrameBuffer *)0x0;
        goto LAB_00941da4;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0x6b3,"js_renderer_Camera_setFrameBuffer");
      __android_log_print(6,"jswrapper",
                          "js_renderer_Camera_setFrameBuffer : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 1719): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(puVar4[1] - (long)pVVar5) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Camera_setFrameBuffer",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0x6ba);
LAB_00941e20:
