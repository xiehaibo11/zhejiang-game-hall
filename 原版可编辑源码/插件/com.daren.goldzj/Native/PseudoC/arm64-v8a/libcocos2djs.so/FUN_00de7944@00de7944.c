...
undefined4 FUN_00de7944(int *param_1,uint *param_2)

{
  ...
  *(byte *)(param_1 + 0x10) = ~bVar3 & 1;
  ...
  piVar1 = param_1 + 4;
  FUN_00e02abc(piVar1,pbVar15);
  uVar14 = param_1[0x11];
  if ((char)param_1[0x10] != '\0') {
    uVar6 = FUN_00e02bd0(piVar1,1);
    *(undefined1 *)((long)param_1 + 0x4e) = uVar6;
    uVar6 = FUN_00e02bd0(piVar1,1);
    *(undefined1 *)((long)param_1 + 0x4f) = uVar6;
  }
  iVar7 = FUN_00e02bd0(piVar1,1);
  param_1[0x20] = iVar7;
  if (iVar7 == 0) {
    param_1[0x21] = 0;
    iVar7 = param_1[0xe];
...
joined_r0x00de7ce0:
  if (iVar7 == 0) {
    iVar7 = FUN_00e02bd0(piVar1,1);
    param_1[0x14] = iVar7;
    iVar7 = FUN_00e02bd0(piVar1,6);
    param_1[0x15] = iVar7;
    iVar7 = FUN_00e02bd0(piVar1,3);
    param_1[0x16] = iVar7;
    iVar7 = FUN_00e02bd0(piVar1,1);
    param_1[0x17] = iVar7;
    if ((iVar7 != 0) && (iVar7 = FUN_00e02bd0(piVar1,1), iVar7 != 0)) {
      iVar7 = FUN_00e02bd0(piVar1,1);
      if (iVar7 != 0) {
        iVar7 = FUN_00e02d00(piVar1,6);
        param_1[0x18] = iVar7;
      }
      iVar7 = FUN_00e02bd0(piVar1,1);
      if (iVar7 != 0) {
      ...
      if (uVar17 < uVar20 * 3) {
        ...
        if ((int)uVar20 != 0) {
          ...
          do {
            ...
            FUN_00e02abc(piVar19,pbVar16,uVar2);
            uVar17 = uVar17 + 1;
        ...
        FUN_00e02abc(param_1 + uVar20 * 0xc + 0x6e,pbVar16,uVar10);
        if (pbVar16 < pbVar15 + uVar18) {
          FUN_00e03e8c(param_1);
          if ((char)param_1[0x10] != '\0') {
            FUN_00e02bd0(piVar1,1);
            FUN_00e04c88(piVar1,param_1);
            param_1[1] = 1;
            return 1;
          }
          if (*param_1 != 0) {
