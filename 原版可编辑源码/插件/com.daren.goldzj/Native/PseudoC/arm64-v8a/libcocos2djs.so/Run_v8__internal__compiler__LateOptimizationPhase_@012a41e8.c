...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::LateOptimizationPhase>()
    */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::LateOptimizationPhase>
          (PipelineImpl *this)

{
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFLateOptimization");
  LateOptimizationPhase::Run(aLStack_18,pPVar5,pZVar2);
