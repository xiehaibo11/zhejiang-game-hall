...
/* v8::internal::HashTable<v8::internal::GlobalDictionary,
   v8::internal::GlobalDictionaryShape>::Swap(v8::internal::InternalIndex,
   v8::internal::InternalIndex, v8::internal::WriteBarrierMode) */

void __thiscall
v8::internal::HashTable<v8::internal::GlobalDictionary,v8::internal::GlobalDictionaryShape>::Swap
...

{
  ...
  uVar9 = *(ulong *)this;
  lVar1 = (long)(param_2 * 4 + 0x14) + 7;
  uVar3 = *(uint *)(lVar1 + uVar9);
  uVar6 = (ulong)uVar3;
  lVar2 = (long)(param_3 * 4 + 0x14) + 7;
