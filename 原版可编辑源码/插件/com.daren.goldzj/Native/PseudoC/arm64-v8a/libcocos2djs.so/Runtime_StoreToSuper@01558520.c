...
/* v8::internal::Runtime_StoreToSuper(int, unsigned long*, v8::internal::Isolate*) */

undefined8 v8::internal::Runtime_StoreToSuper(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar4 = FUN_0155864c(param_1,param_2,param_3);
    return uVar4;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar5 & 1) != 0) &&
    ...
    if (((uVar5 & 1) != 0) &&
      ...
      pIVar3 = (Isolate *)FUN_0155aa30(param_3);
