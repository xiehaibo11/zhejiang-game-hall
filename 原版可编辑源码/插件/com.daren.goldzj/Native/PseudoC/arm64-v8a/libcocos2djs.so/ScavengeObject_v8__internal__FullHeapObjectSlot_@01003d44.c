...
/* v8::internal::SlotCallbackResult
   v8::internal::Scavenger::ScavengeObject<v8::internal::FullHeapObjectSlot>(v8::internal::FullHeapObjectSlot,
   v8::internal::HeapObject) */

ulong __thiscall
v8::internal::Scavenger::ScavengeObject<v8::internal::FullHeapObjectSlot>
          (Scavenger *this,ulong *param_2,ulong *param_3)

{
  ...
  uVar29 = (ulong)uVar14;
  if (bVar5 == 0x27) {
    uVar33 = EvacuateShortcutCandidate<v8::internal::FullHeapObjectSlot>
                       (this,uVar33,param_2,local_88,uVar29);
    return uVar33;
  }
  if (bVar5 == 0x30) {
    uVar33 = EvacuateThinString<v8::internal::FullHeapObjectSlot>
                       (this,uVar33,param_2,local_88,uVar29);
    return uVar33;
  }
...
LAB_01003eb4:
        *(ulong *)(pNVar36 + 0x68) = uVar34;
        ...
        if (((ulong)puVar16 & 1) == 0) goto LAB_01003fd4;
      }
      ...
      if (6 < uVar14 - 1) {
        ...
        if ((uint)((int)uVar8 >> 2) < 0x10) {
          ...
          if ((7 < (uint)((int)uVar8 >> 2)) &&
            ...
            if (uVar27 == uVar22) goto LAB_01004430;
          }
          do {
            uVar34 = uVar34 - 1;
            *puVar17 = *puVar23;
...
LAB_01004430:
      do {
        if (*puVar31 != uVar20) {
          ...
          if ((*(long *)(this + 0x278) != 0) &&
             (*(long *)(this + 0x278) - (long)(int)uVar14 == lVar35)) goto LAB_01004570;
      ...
      if (this[0x2e1] != (Scavenger)0x0) {
        ...
        if ((*puVar24 & uVar20) != 0) {
          ...
          if ((puVar24[bVar13] & uVar8) != 0) goto LAB_01004a48;
        }
            ...
            while (uVar8 = *puVar24, (uVar20 & (uVar8 ^ 0xffffffff)) != 0) {
              while (*puVar24 == uVar8) {
                ...
                if (cVar9 == '\0') {
                  ...
                  local_80 = puVar16;
                  if ((*puVar24 & uVar20) == 0) goto LAB_01004a48;
                  uVar20 = uVar20 << 1;
                  bVar13 = uVar20 == 0;
                  puVar3 = puVar24;
                  if (bVar13) {
    ...
    if (6 < uVar14 - 1) {
      ...
      if ((uint)((int)uVar8 >> 2) < 0x10) {
        ...
        if ((7 < (uint)((int)uVar8 >> 2)) &&
          ...
          if (uVar27 == uVar22) goto LAB_010040f0;
        }
        do {
          uVar34 = uVar34 - 1;
          *puVar17 = *puVar23;
...
LAB_010040f0:
    ...
    if (SVar6 != (Scavenger)0x0) {
      ...
      if ((*puVar24 & uVar20) != 0) {
        ...
        if ((puVar24[bVar13] & uVar8) != 0) goto LAB_01004930;
      }
      uVar26 = (ulong)puVar12 & 0xfffffffffffc0000;
      uVar27 = (long)puVar12 - uVar26 >> 7 & 0x1ffffff;
      puVar24 = (uint *)(*(long *)(uVar26 + 0x10) + uVar27 * 4);
          ...
          while (uVar8 = *puVar24, (uVar20 & (uVar8 ^ 0xffffffff)) != 0) {
            while (*puVar24 == uVar8) {
              ...
              if (cVar9 == '\0') {
                ...
                uVar20 = 1 << (ulong)((uint)((long)puVar16 + ~uVar34 >> 2) & 0x1f);
                local_80 = puVar16;
                if ((*puVar24 & uVar20) == 0) goto LAB_01004930;
                uVar20 = uVar20 << 1;
                bVar13 = uVar20 == 0;
                puVar3 = puVar24;
                if (bVar13) {
...
LAB_01004930:
    ...
    *param_2 = *param_2 & 2 | (ulong)puVar16;
    if (5 < bVar5) {
  ...
  if (6 < uVar14 - 1) {
    ...
    if ((uint)((int)uVar8 >> 2) < 0x10) {
      ...
      if ((7 < (uint)((int)uVar8 >> 2)) &&
        ...
        if (uVar27 == uVar22) goto LAB_01004250;
      }
      do {
        uVar34 = uVar34 - 1;
        *puVar17 = *puVar23;
...
LAB_01004594:
      uVar33 = ((ulong)puVar12 & 0xffffffff00000000 | (ulong)*puVar31) + 1;
      uVar29 = uVar33 | *param_2 & 2;
      *param_2 = uVar29;
      if ((uVar33 & 1) == 0) {
        return 1;
      }
      ...
      return (ulong)((*(uint *)((uVar33 & 0xfffffffffffc0000) + 8) >> 4 ^ 0xffffffff) & 1);
    }
    cVar9 = '\x01';
    bVar13 = (bool)ExclusiveMonitorPass(puVar31,0x10);
    if (bVar13) {
...
LAB_01004828:
  ...
  if ((uVar20 & (uVar8 ^ 0xffffffff)) == 0) goto LAB_01004a48;
  while (*puVar3 == uVar8) {
    cVar9 = '\x01';
...
LAB_01004728:
  uVar8 = puVar24[bVar13];
  if ((uVar20 & (uVar8 ^ 0xffffffff)) == 0) goto LAB_01004930;
  while (*puVar3 == uVar8) {
    cVar9 = '\x01';
    bVar10 = (bool)ExclusiveMonitorPass(puVar3,0x10);
    if (bVar10) {
