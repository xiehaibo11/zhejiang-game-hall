...
void v8::ArrayBuffer::GetContents(bool param_1)
...
LAB_00ec9040:
      ...
      if (*(code **)(lVar8 + 0xb738) == (code *)0x0) goto LAB_00ec9040;
      (**(code **)(lVar8 + 0xb738))("v8_ArrayBuffer_Externalize","ArrayBuffer already externalized")
      ;
    ...
    *(uint *)(lVar8 + 0x1b) = *(uint *)(lVar8 + 0x1b) | 1;
    ...
    if (local_40 == (undefined8 *)0x0) {
      puVar7 = (undefined8 *)0x0;
      local_50 = local_38;
      if (local_38 == (__shared_weak_count *)0x0) goto joined_r0x00ec8f04;
    }
    else {
      ...
      *puVar7 = puVar5;
      puVar7[1] = p_Var2;
      local_50 = local_38;
      if (p_Var2 == (__shared_weak_count *)0x0) goto joined_r0x00ec8f04;
      p_Var1 = p_Var2 + 8;
      do {
        cVar3 = '\x01';
        bVar4 = (bool)ExclusiveMonitorPass(p_Var1,0x10);
