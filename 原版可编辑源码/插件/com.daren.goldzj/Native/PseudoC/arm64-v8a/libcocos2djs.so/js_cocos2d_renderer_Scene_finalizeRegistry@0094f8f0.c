...
/* js_cocos2d_renderer_Scene_finalizeRegistry(void*) */

void js_cocos2d_renderer_Scene_finalizeRegistry(void *param_1)

{
  ...
  if (param_1 != (void *)0x0) {
    ...
    if (lVar3 != lVar4) {
      ...
      this_00 = (Scene *)se::State::nativeThisObject(aSStack_60);
