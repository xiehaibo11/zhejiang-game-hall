...

{
  ...
  if (plVar7 != param_2 + 2) {
    uVar6 = plVar7[1];
    if (uVar3 == 0) {
                    /* try { // try from 00a77bc0 to 00b77cd3 has its CatchHandler @ 00a77924 */
      uVar6 = uVar6 & uVar8;
    }
    else if (uVar2 <= uVar6) {
                    /* try { // try from 00a77b84 to 00b77bbf has its CatchHandler @ 00a77c7c */
      uVar4 = 0;
      if (uVar2 != 0) {
        uVar4 = uVar6 / uVar2;
      }
    ...
    if (uVar6 == uVar1) goto LAB_00a77be0;
  }
  if (*param_3 != 0) {
...
LAB_00a77be0:
  if (*param_3 != 0) {
    uVar6 = *(ulong *)(*param_3 + 8);
    if (uVar3 == 0) {
                    /* catch() { ... } // from try @ 00a77a20 with catch @ 00a77c38
                       catch() { ... } // from try @ 00a77b10 with catch @ 00a77c38 */
      uVar6 = uVar6 & uVar8;
                    /* catch() { ... } // from try @ 00a779f4 with catch @ 00a77c3c
                       catch() { ... } // from try @ 00a77ac8 with catch @ 00a77c3c */
    }
    else if (uVar2 <= uVar6) {
      uVar3 = 0;
      if (uVar2 != 0) {
