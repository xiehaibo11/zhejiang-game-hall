...
/* js_engine_FileUtils_setSearchResolutionsOrderRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_engine_FileUtils_setSearchResolutionsOrderRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar7 == (long *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x200,"js_engine_FileUtils_setSearchResolutionsOrder");
    __android_log_print(6,"jswrapper",
                        "js_engine_FileUtils_setSearchResolutionsOrder : Invalid Native Object");
  }
  else {
    ...
    if (plVar8[1] - *plVar8 == 0x10) {
      ...
      if (bVar1) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                            ,0x207,"js_engine_FileUtils_setSearchResolutionsOrder");
        __android_log_print(6,"jswrapper",
                            "js_engine_FileUtils_setSearchResolutionsOrder : Error processing arguments"
                           );
        pbVar3 = local_88;
      }
      else {
      ...
      if (!bVar1) goto LAB_00897fac;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 523): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar8[1] - *plVar8) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_FileUtils_setSearchResolutionsOrder",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x20e);
LAB_00897fac:
