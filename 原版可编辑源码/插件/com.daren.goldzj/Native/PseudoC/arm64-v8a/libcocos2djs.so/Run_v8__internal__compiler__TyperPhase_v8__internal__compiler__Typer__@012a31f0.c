...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::TyperPhase,
   v8::internal::compiler::Typer*>(v8::internal::compiler::Typer*&&) */

void __thiscall
v8::internal::compiler::PipelineImpl::
Run<v8::internal::compiler::TyperPhase,v8::internal::compiler::Typer*>
          (PipelineImpl *this,Typer **param_1)

{
  ...
  if (local_88 != (PipelineStatistics *)0x0) {
    PipelineStatistics::BeginPhase(local_88,"V8.TFTyper");
  }
  ...
  if ((pRVar1 == (RuntimeCallStats *)0x0) || (TracingFlags::runtime_stats == 0)) {
    ...
    pPVar4 = *(PipelineData **)this;
    if (local_70 != (Zone *)0x0) goto LAB_012a3294;
  }
  local_70 = (Zone *)ZoneStats::NewEmptyZone(local_78,local_80);
LAB_012a3294:
  TyperPhase::Run(aTStack_90,pPVar4,local_70,*param_1);
