...
/* v8::Set::AsArray() const */

undefined8 __thiscall v8::Set::AsArray(Set *this)

{
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_60,(ulong)&local_60 | 8,0x3cc);
  }
  this_00 = *(Logger **)(lVar4 + 0x9558);
  uVar2 = internal::Logger::is_logging(this_00);
  if ((uVar2 & 1) != 0) {
    internal::Logger::ApiEntryCall(this_00,"v8::Set::AsArray");
  }
  uVar1 = *(undefined4 *)(lVar4 + 0x2c60);
  *(undefined4 *)(lVar4 + 0x2c60) = 5;
  uVar3 = FUN_00ec6e64(lVar4,*(ulong *)this & 0xffffffff00000000 |
                             (ulong)*(uint *)(*(ulong *)this + 0xb),0,0x416);
