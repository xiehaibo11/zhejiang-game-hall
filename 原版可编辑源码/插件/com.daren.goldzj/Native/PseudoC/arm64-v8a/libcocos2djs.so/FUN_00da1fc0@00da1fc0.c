...
undefined8 FUN_00da1fc0(long param_1,long param_2)
    ...
    if (0 < *(int *)(param_1 + 0x1f0)) {
      ...
      do {
        ...
        lVar13 = *(long *)(lVar14 + (long)*(int *)(*(long *)(param_1 + lVar16 * 8 + 0x1c8) + 0x14) *
                                    8 + 0x48);
        if ((int)uVar9 < 8) {
          uVar6 = FUN_00da3d1c(&local_88,lVar7,uVar9,0);
          if ((int)uVar6 == 0) {
            return uVar6;
          }
          uVar9 = (ulong)local_70;
          lVar7 = local_78;
          if (7 < (int)local_70) goto LAB_00da2094;
          uVar6 = 1;
LAB_00da20c8:
          uVar5 = FUN_00da3e70(&local_88,lVar7,uVar9,lVar13,uVar6);
          if ((int)uVar5 < 0) {
            return 0;
          }
          uVar9 = (ulong)local_70;
          lVar7 = local_78;
          if (uVar5 == 0) goto LAB_00da20bc;
LAB_00da20e8:
          uVar8 = (uint)uVar9;
          if (((int)(uint)uVar9 < (int)uVar5) &&
             (uVar6 = FUN_00da3d1c(&local_88,lVar7,uVar9,uVar5), lVar7 = local_78, uVar8 = local_70,
             (int)uVar6 == 0)) {
            return uVar6;
          }
          uVar9 = (ulong)(uVar8 - uVar5);
          uVar8 = *(uint *)(&DAT_01950530 + (long)(int)uVar5 * 4) & (uint)(lVar7 >> (uVar9 & 0x3f));
          uVar1 = 0;
          if ((int)uVar8 <= *(int *)(&DAT_0195052c + (long)(int)uVar5 * 4)) {
            uVar1 = *(uint *)(&DAT_01950530 + (long)(int)uVar5 * 4);
          }
          iVar10 = uVar8 - uVar1;
        }
        else {
