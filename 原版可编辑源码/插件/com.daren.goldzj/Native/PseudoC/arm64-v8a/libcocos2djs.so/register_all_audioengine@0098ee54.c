...
/* register_all_audioengine(se::Object*) */

undefined8 register_all_audioengine(Object *param_1)

{
  ...
  if ((uVar2 & 1) == 0) {
    pOVar3 = (Object *)se::Object::createPlainObject();
                    /* catch() { ... } // from try @ 0098ef70 with catch @ 0098ee9c */
  ...
  js_register_audioengine_AudioProfile(pOVar3);
  js_register_audioengine_AudioEngine(pOVar3);
  se::Value::~Value(aVStack_38);
