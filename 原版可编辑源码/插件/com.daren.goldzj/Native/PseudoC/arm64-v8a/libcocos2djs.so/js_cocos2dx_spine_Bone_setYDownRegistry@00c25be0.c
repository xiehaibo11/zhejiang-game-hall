...
/* js_cocos2dx_spine_Bone_setYDownRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_setYDownRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (uVar6 == 0x10) {
    ...
    if ((uVar6 & 1) != 0) {
      spine::Bone::setYDown(local_64[0]);
      goto LAB_00c25d38;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                        ,0xb34,"js_cocos2dx_spine_Bone_setYDown");
    __android_log_print(6,"jswrapper","js_cocos2dx_spine_Bone_setYDown : Error processing arguments"
                       );
  }
  else {
    __android_log_print(6,"jswrapper",&DAT_018fa629,uVar6 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_setYDown",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0xb3b);
LAB_00c25d38:
