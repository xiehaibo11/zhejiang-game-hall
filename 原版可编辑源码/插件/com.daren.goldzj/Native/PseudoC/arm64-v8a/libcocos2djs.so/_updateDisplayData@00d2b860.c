...
LAB_00d2ba1c:
      ...
      if (iVar5 != 3) goto joined_r0x00d2b97c;
    ...
    if ((pVVar11 == (VerticesData *)0x0) && (lVar17 = *(long *)(this + 0x168), lVar17 != 0)) {
      ...
      *(float *)(this + 0xa0) = fVar22;
      ...
      if ((lVar16 != lVar14) && (!bVar7 && lVar14 != 0)) {
        ...
        DAT_01d289f0 = -fVar19 / fVar20;
        DAT_01d289f4 = fVar25 / fVar20;
        DAT_01d289f8 = (fVar19 * *(float *)(lVar14 + 0x4c) - fVar18 * *(float *)(lVar14 + 0x48)) /
                       fVar20;
        DAT_01d289fc = -(fVar25 * *(float *)(lVar14 + 0x4c) - fVar24 * *(float *)(lVar14 + 0x48)) /
                       fVar20;
        TransformObject::_helpPoint = DAT_01d289f8 + (fVar18 / fVar20) * 0.0 + DAT_01d289f0 * 0.0;
        DAT_01d3df94 = DAT_01d289fc + (DAT_01d289f4 * 0.0 - (fVar24 / fVar20) * 0.0);
        fVar23 = fVar23 - TransformObject::_helpPoint;
        fVar22 = fVar22 - DAT_01d3df94;
        *(float *)(this + 0x9c) = fVar23;
        *(float *)(this + 0xa0) = fVar22;
        ...
        DAT_01d289ec = -fVar25 / fVar24;
        DAT_01d289f0 = -fVar19 / fVar24;
        DAT_01d289f4 = fVar20 / fVar24;
        DAT_01d289f8 = (fVar19 * *(float *)(lVar16 + 0x4c) - fVar18 * *(float *)(lVar16 + 0x48)) /
                       fVar24;
        DAT_01d289fc = -(fVar20 * *(float *)(lVar16 + 0x4c) - fVar25 * *(float *)(lVar16 + 0x48)) /
                       fVar24;
        TransformObject::_helpPoint =
             DAT_01d289f8 + TransformObject::_helpMatrix * 0.0 + DAT_01d289f0 * 0.0;
        DAT_01d3df94 = DAT_01d289fc + DAT_01d289ec * 0.0 + DAT_01d289f4 * 0.0;
        fVar22 = fVar22 + DAT_01d3df94;
