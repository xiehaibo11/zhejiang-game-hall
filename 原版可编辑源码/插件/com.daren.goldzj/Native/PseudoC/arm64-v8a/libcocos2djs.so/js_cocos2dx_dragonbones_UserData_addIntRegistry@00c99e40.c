...
/* js_cocos2dx_dragonbones_UserData_addIntRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_UserData_addIntRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (UserData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x34c,"js_cocos2dx_dragonbones_UserData_addInt");
    pcVar6 = "js_cocos2dx_dragonbones_UserData_addInt : Invalid Native Object";
LAB_00c99fb4:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        dragonBones::UserData::addInt(this,local_64);
        goto LAB_00c99fec;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                          ,0x353,"js_cocos2dx_dragonbones_UserData_addInt");
      pcVar6 = "js_cocos2dx_dragonbones_UserData_addInt : Error processing arguments";
      goto LAB_00c99fb4;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp, 855): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_UserData_addInt",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x35a);
LAB_00c99fec:
