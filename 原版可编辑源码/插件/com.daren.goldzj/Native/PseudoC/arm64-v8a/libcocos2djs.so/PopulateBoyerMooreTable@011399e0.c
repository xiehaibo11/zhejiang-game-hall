...
void __thiscall
v8::internal::StringSearch<unsigned_char,unsigned_char>::PopulateBoyerMooreTable
          (StringSearch<unsigned_char,unsigned_char> *this)

{
  ...
  if (iVar9 != 0 && iVar5 <= (int)uVar20) {
    ...
    if (7 < uVar10) {
      ...
      if (uVar10 == uVar12) goto LAB_01139a7c;
    }
