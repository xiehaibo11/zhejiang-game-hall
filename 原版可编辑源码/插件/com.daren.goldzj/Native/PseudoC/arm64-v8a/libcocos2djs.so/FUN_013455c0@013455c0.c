...
undefined8 FUN_013455c0(long param_1,long param_2)

{
  ...
  while ((int)param_2 != (int)param_1) {
    ...
    if ((uVar1 == 5) ||
      ...
      if ((uVar2 != 5) &&
        ...
        FUN_013be7e0(2,*(undefined8 *)(unaff_x26 + 0x2598));
      }
      param_1 = unaff_x26 + (ulong)*(uint *)(param_1 + 0xb);
    }
  }
  goto LAB_01345708;
LAB_013456c4:
  if (lVar6 == uVar5 + 0xb) goto LAB_013456e8;
  if (*(byte *)(param_2 + lVar6) != *(byte *)(param_1 + lVar6)) {
    if (*(byte *)(param_1 + lVar6) <= *(byte *)(param_2 + lVar6)) goto LAB_013456f8;
    goto LAB_01345700;
  }
  lVar6 = lVar6 + 1;
  goto LAB_013456c4;
