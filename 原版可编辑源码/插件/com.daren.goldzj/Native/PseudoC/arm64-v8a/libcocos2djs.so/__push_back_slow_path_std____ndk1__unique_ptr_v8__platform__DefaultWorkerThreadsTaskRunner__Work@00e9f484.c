...
/* void 
   std::__ndk1::vector<std::__ndk1::unique_ptr<v8::platform::DefaultWorkerThreadsTaskRunner::WorkerThread,
   std::__ndk1::default_delete<v8::platform::DefaultWorkerThreadsTaskRunner::WorkerThread> >,
   std::__ndk1::allocator<std::__ndk1::unique_ptr<v8::platform::DefaultWorkerThreadsTaskRunner::WorkerThread,
   std::__ndk1::default_delete<v8::platform::DefaultWorkerThreadsTaskRunner::WorkerThread> > >
   >::__push_back_slow_path<std::__ndk1::unique_ptr<v8::platform::DefaultWorkerThreadsTaskRunner::WorkerThread,
   std::__ndk1::default_delete<v8::platform::DefaultWorkerThreadsTaskRunner::WorkerThread> >
   >(std::__ndk1::unique_ptr<v8::platform::DefaultWorkerThreadsTaskRunner::WorkerThread,
   std::__ndk1::default_delete<v8::platform::DefaultWorkerThreadsTaskRunner::WorkerThread> >&&) */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00e9f594;
