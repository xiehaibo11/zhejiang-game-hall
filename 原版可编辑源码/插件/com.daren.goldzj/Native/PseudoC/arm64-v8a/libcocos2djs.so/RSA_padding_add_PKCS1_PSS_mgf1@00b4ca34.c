...
LAB_00b4cac4:
    ...
    if (uVar1 == 0) {
      ...
      *EM = '\0';
      iVar3 = iVar3 + -1;
      if (num == 0xfffffffe) goto LAB_00b4caec;
LAB_00b4cb0c:
      ...
      mask = EM;
      if (num != 0xfffffffe) goto LAB_00b4cb0c;
LAB_00b4caec:
      num = (-2 - uVar2) + iVar3;
    }
    if ((int)num < 1) {
...
LAB_00b4cb88:
      ...
      if (((ctx != (EVP_MD_CTX *)0x0) &&
         ...
         (iVar4 = EVP_DigestUpdate(ctx,&DAT_018bd3e8,8), iVar4 != 0)) {
...
LAB_00b4cd08:
                ...
                if (lVar7 != 0) {
                  ...
                  if ((num & 0x1f) == 0) goto LAB_00b4cd30;
                }
              }
              lVar9 = uVar6 - lVar7;
              pbVar8 = buf + lVar7;
