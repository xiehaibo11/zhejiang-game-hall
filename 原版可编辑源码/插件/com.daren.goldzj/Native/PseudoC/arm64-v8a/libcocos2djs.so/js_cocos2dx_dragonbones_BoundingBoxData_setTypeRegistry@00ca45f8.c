...
/* js_cocos2dx_dragonbones_BoundingBoxData_setTypeRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_BoundingBoxData_setTypeRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x8f2,&DAT_0192902b);
    pcVar7 = "js_cocos2dx_dragonbones_BoundingBoxData_setType : Invalid Native Object";
LAB_00ca4768:
    ...
    if (uVar8 == 0x10) {
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                          ,0x8f9,&DAT_0192902b);
      pcVar7 = "js_cocos2dx_dragonbones_BoundingBoxData_setType : Error processing arguments";
      goto LAB_00ca4768;
    }
    __android_log_print(6,"jswrapper",&DAT_019331d1,uVar8 >> 4,1);
  }
