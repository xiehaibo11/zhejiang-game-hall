...
void FUN_01812350(long param_1,__shared_count *param_2)

{
  ...
  if (std::__ndk1::ctype<char>::id != -1) {
    ...
    std::__ndk1::__call_once((ulong *)&std::__ndk1::ctype<char>::id,&local_58,FUN_01828620);
  }
  uVar2 = (ulong)DAT_01d52e20;
  uVar7 = uVar2 - 1;
