          ...
          if (uVar9 == uVar7) {
            ...
            if (sVar1 == __n) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                pbVar12 = pbVar2;
                    /* try { // try from 00a5f9a4 to 00b5f9df has its CatchHandler @ 00a5fa84 */
                while (*pbVar10 == *pbVar12) {
                  pbVar10 = pbVar10 + 1;
                  lVar11 = lVar11 + 1;
                  pbVar12 = pbVar12 + 1;
                  if (lVar11 == 0) goto LAB_00a5fa14;
                }
              }
            ...
            if ((uVar14 & uVar13) == 0) {
                    /* try { // try from 00a5f9e0 to 00b5fadb has its CatchHandler @ 00a5f6dc */
              uVar9 = uVar9 & uVar14;
            }
              ...
              if (uVar9 - uVar4 * uVar13 == uVar15) goto LAB_00a5f9ec;
              goto LAB_00a5fa10;
            }
            if (uVar9 != uVar15) goto LAB_00a5fa10;
          }
LAB_00a5f9ec:
          plVar8 = (long *)*plVar8;
