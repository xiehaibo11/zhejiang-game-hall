...
/* void v8::internal::CallIterateBody::apply<v8::internal::JSDataView::BodyDescriptor,
...
void v8::internal::CallIterateBody::
     apply<v8::internal::JSDataView::BodyDescriptor,v8::internal::ObjectVisitor>
...

{
  ...
  if (iVar1 < (int)lVar2) {
    lVar4 = (long)iVar1;
    (**(code **)(*param_4 + 0x10))(param_4,param_2,param_2 + 0x27,lVar3 + lVar4);
    do {
    ...
    lVar2 = 0x28;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0111d744. Too many branches */
