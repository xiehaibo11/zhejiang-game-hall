...

{
  ...
  if ((lVar5 == 0) &&
    ...
    if ((param_1[1].idp == (ISSUING_DIST_POINT *)0x0) ||
      ...
      iVar1 = 0x82;
                    /* catch() { ... } // from try @ 00b5fe4c with catch @ 00b5ff50
                       catch() { ... } // from try @ 00b5ff2c with catch @ 00b5ff50 */
      iVar2 = 0x79e;
    }
    else {
      ...
      if (iVar1 == 0) {
        iVar1 = FUN_00b601c0(param_1,param_2,0x5a);
        if (iVar1 == 0) {
          iVar1 = 0x6e;
          iVar2 = 0x7a8;
        }
        else {
          iVar1 = FUN_00b601c0(param_1,param_2,0x302);
          if (iVar1 == 0) {
            iVar1 = 0x80;
            iVar2 = 0x7ac;
          }
            ...
            if (iVar1 < 1) {
              ...
              iVar2 = 0x7b1;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b5fff4 with catch @ 00b5ff98
                       catch(type#1 @ 00000000) { ... } // from try @ 00b601ac with catch @ 00b5ff98
                        */
              if ((param_3 == (EVP_PKEY *)0x0) ||
                ...
                if ((x != (X509_CRL *)0x0) && (iVar1 = X509_CRL_set_version(x,1), iVar1 != 0)) {
                  pXVar3 = (X509_NAME *)X509_CRL_get_issuer(param_2);
                    /* try { // try from 00b5ffec to 00c5fff3 has its CatchHandler @ 00b60314 */
                  iVar1 = X509_CRL_set_issuer_name(x,pXVar3);
                  if (iVar1 != 0) {
                    /* try { // try from 00b5fff4 to 00c601a3 has its CatchHandler @ 00b5ff98 */
                        ...
                        if (0 < iVar1) {
                          ...
                          do {
                            ...
                            if (iVar2 == 0) {
                              ...
                              if (local_48 == (X509_REVOKED *)0x0) goto LAB_00b60198;
...
LAB_00b60198:
                    /* try { // try from 00b601a4 to 00c601ab has its CatchHandler @ 00b602a8 */
                    /* try { // try from 00b601ac to 00c60317 has its CatchHandler @ 00b5ff98 */
              ...
              iVar2 = 0x7b7;
                    ...
                    /* try { // try from 00b5ff2c to 00c5ff33 has its CatchHandler @ 00b5ff50 */
        iVar1 = 0x81;
                    /* try { // try from 00b5ff34 to 00c5ff37 has its CatchHandler @ 00b5ff38 */
        iVar2 = 0x7a3;
                    /* catch() { ... } // from try @ 00b5fed4 with catch @ 00b5ff38
                       catch() { ... } // from try @ 00b5ff34 with catch @ 00b5ff38
                       try { // try from 00b5ff38 to 00c5ff97 has its CatchHandler @ 00b5fdac */
      }
    }
  }
  else {
  ...
  ERR_put_error(0xb,0x69,iVar1,"crypto/x509/x509_vfy.c",iVar2);
                    /* try { // try from 00b5fed4 to 00c5fedb has its CatchHandler @ 00b5ff38 */
                    /* try { // try from 00b5fedc to 00c5ff2b has its CatchHandler @ 00b5fdac */
  return (X509_CRL *)0x0;
}
