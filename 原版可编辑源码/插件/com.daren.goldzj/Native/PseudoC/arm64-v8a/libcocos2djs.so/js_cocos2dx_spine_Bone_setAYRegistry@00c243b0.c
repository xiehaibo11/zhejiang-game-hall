...
/* js_cocos2dx_spine_Bone_setAYRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_setAYRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Bone *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xa4c,"js_cocos2dx_spine_Bone_setAY");
    pcVar6 = "js_cocos2dx_spine_Bone_setAY : Invalid Native Object";
LAB_00c24524:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Bone::setAY(this,local_64);
        goto LAB_00c2455c;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0xa53,"js_cocos2dx_spine_Bone_setAY");
      pcVar6 = "js_cocos2dx_spine_Bone_setAY : Error processing arguments";
      goto LAB_00c24524;
    }
    __android_log_print(6,"jswrapper",&DAT_018f99e4,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_setAY",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0xa5a);
LAB_00c2455c:
