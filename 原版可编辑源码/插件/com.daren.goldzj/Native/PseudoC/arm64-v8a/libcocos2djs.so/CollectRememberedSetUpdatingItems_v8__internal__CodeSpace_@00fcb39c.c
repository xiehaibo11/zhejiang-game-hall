...
/* int 
   v8::internal::MarkCompactCollectorBase::CollectRememberedSetUpdatingItems<v8::internal::CodeSpace>(v8::internal::ItemParallelJob*,
   v8::internal::CodeSpace*, v8::internal::RememberedSetUpdatingMode) */

int __thiscall
v8::internal::MarkCompactCollectorBase::CollectRememberedSetUpdatingItems<v8::internal::CodeSpace>
