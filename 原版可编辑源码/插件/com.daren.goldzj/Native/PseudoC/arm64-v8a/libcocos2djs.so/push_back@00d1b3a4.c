...
/* std::__ndk1::__split_buffer<spine::SkeletonCacheAnimation::AniQueueData**,
   std::__ndk1::allocator<spine::SkeletonCacheAnimation::AniQueueData**>&>::push_back(spine::SkeletonCacheAnimation::AniQueueData**&&)
    */
...

{
  ...
  if (puVar14 != *(undefined8 **)(this + 0x18)) goto LAB_00d1b52c;
...
LAB_00d1b4fc:
      ...
      if (uVar2 != uVar11) goto LAB_00d1b4fc;
    }
    puVar13 = *(undefined8 **)this;
