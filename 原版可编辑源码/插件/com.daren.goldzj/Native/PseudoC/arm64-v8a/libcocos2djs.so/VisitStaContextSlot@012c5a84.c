...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitStaContextSlot(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::VisitStaContextSlot
...

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    if ((uVar4 & 1) == 0) {
      ...
      if (local_48[0] < 0) {
        uVar3 = interpreter::Register::ToParameterIndex((Register *)local_28,*(int *)(lVar6 + 0x18))
        ;
        lVar5 = *(long *)(lVar6 + 0x30);
      }
      else {
        uVar3 = *(int *)(lVar6 + 0x18) + local_48[0];
        lVar5 = *(long *)(lVar6 + 0x30);
      }
  ...
  ProcessContextAccess(this,lVar6,uVar1,uVar2,0,0);
  return;
}
