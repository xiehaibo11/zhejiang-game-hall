...
/* v8::internal::compiler::EffectControlLinearizer::LowerObjectIsDetectableCallable(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerObjectIsDetectableCallable
...

{
  ...
  pNVar3 = (Node *)GraphAssembler::Int32Constant(this_00,0x12);
