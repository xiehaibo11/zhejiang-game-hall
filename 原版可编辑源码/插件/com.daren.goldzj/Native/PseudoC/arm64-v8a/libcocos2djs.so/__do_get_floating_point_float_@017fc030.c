...
LAB_017fc0ec:
  ...
  if ((param_2 == (long *)0x0) || (param_2[3] != param_2[4])) {
    if (param_3 != (long *)0x0) goto LAB_017fc100;
LAB_017fc148:
    param_3 = (long *)0x0;
    if (plVar15 == (long *)0x0) goto LAB_017fc23c;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_017fc148;
LAB_017fc100:
...
LAB_017fc23c:
  ...
  uVar18 = FUN_01828f10(pcVar17,local_170,param_5);
  *param_6 = uVar18;
  uVar5 = (ulong)((byte)local_150[0] >> 1);
  if (((byte)local_150[0] & 1) != 0) {
    uVar5 = local_148;
  ...
  if (uVar5 != 0) {
    ...
    if (local_130 < puVar7) {
      ...
      do {
        if ((bVar14) && (*puVar13 != uVar8)) goto LAB_017fc398;
...
LAB_017fc398:
  ...
  if ((plVar15 == (long *)0x0) || (plVar15[3] != plVar15[4])) {
    if (param_3 != (long *)0x0) goto LAB_017fc3b4;
LAB_017fc460:
    if (plVar16 != (long *)0x0) goto LAB_017fc3e8;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_017fc460;
LAB_017fc3b4:
    if ((param_3[3] == param_3[4]) && (iVar4 = (**(code **)(*param_3 + 0x48))(param_3), iVar4 == -1)
       ) goto LAB_017fc460;
    if (plVar16 == (long *)0x0) goto LAB_017fc3e8;
