...
/* std::__ndk1::__shared_ptr_pointer<v8::internal::Coverage*,
   ...
   std::__ndk1::allocator<v8::internal::Coverage> >::__on_zero_shared() */
...
::__on_zero_shared(__shared_ptr_pointer<v8::internal::Coverage*,std::__ndk1::default_delete<v8::internal::Coverage>,std::__ndk1::allocator<v8::internal::Coverage>>
                   *this)
