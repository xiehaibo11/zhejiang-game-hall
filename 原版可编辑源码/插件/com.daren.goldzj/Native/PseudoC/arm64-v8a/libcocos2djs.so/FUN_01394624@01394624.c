...
undefined8 FUN_01394624(ulong param_1)

{
    ...
    *unaff_x29 = *unaff_x29;
    ...
    if (uVar3 == 0x41) {
      if ((int)lVar2 == iVar6) {
        ...
        FUN_013be7e0(3,*(undefined8 *)(unaff_x26 + 0x1c00),0x28,*(undefined8 *)(unaff_x26 + 0x1c00))
        ;
      }
      ...
      if (uVar3 == 0x41) {
        ...
        unaff_x29[-8] = uVar5;
                    /* WARNING: Subroutine does not return */
        FUN_013be7e0(3,*(undefined8 *)(unaff_x26 + 0x1c08),0x24,3);
      }
      if (uVar3 < 0xa9) {
  ...
  if (bVar4) {
    if ((int)param_1 < (int)uVar5) goto LAB_013946d4;
  }
  else {
