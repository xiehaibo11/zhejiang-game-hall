...
/* v8::internal::Runtime_CreateArrayLiteral(int, unsigned long*, v8::internal::Isolate*) */

undefined8 v8::internal::Runtime_CreateArrayLiteral(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar18 = FUN_01570040(param_1,param_2,param_3);
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  uVar17 = *puVar10;
  if (((uVar17 & 1) == 0) ||
     (*(short *)((uVar17 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar17 - 1)) != 0x56)) {
                    /* WARNING: Subroutine does not return */
  ...
  if (*(short *)((uVar15 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar15 - 1)) == 0x9f) {
    ...
    if ((uVar15 & 1) == 0) {
      if (((int)uVar19 >> 1 & 4U) == 0 && (int)uVar15 == 0) {
        *(undefined4 *)(*param_2 + lVar14) = 2;
        pIVar13 = (Isolate *)FUN_01571a14(param_3,puVar10,0);
        if ((uVar7 != 0) && (FLAG_track_double_fields == '\0')) goto joined_r0x0156fe30;
        local_a0 = (Isolate *)&local_78;
        local_98 = (ulong *)((ulong)local_98 & 0xffffffff00000000);
        local_78 = param_3;
        lVar14 = FUN_01570f78(&local_a0,pIVar13);
        if (lVar14 != 0) goto LAB_0156fc88;
      }
      else {
        puVar10 = (ulong *)FUN_01571a14(param_3,puVar10,1);
        local_98 = (ulong *)0x0;
        local_90 = (ulong *)0x0;
        local_a0 = param_3;
...
LAB_0156fe6c:
      local_80 = ((byte)((uint)((int)uVar19 >> 1) >> 1) ^ 0xff) & 1;
      local_90 = (ulong *)0x0;
...
joined_r0x0156fe30:
      if (pIVar13 != (Isolate *)0x0) goto LAB_0156ff5c;
    }
LAB_0156ff58:
    ...
    if (((uVar19 >> 1 & 1) == 0) || (FLAG_track_double_fields != '\0')) {
      ...
      local_78 = param_3;
      lVar14 = FUN_01570f78(&local_a0,pIVar13);
      if (lVar14 == 0) goto LAB_0156ff58;
    }
LAB_0156fc88:
    if (pIVar13 == (Isolate *)0x0) goto LAB_0156ff58;
  }
LAB_0156ff5c:
