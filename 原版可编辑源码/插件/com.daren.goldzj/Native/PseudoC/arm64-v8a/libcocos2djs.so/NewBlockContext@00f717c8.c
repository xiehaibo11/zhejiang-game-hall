...
/* v8::internal::Factory::NewBlockContext(v8::internal::Handle<v8::internal::Context>,
   v8::internal::Handle<v8::internal::ScopeInfo>) */

ulong * __thiscall
v8::internal::Factory::NewBlockContext(Factory *this,ulong *param_2,ulong *param_3)

{
  ...
  local_48 = *param_3;
  iVar1 = ScopeInfo::ContextLength((ScopeInfo *)&local_48);
  ...
  puVar2 = (ulong *)NewContext(this,puVar2,iVar1 * 4 + 8,iVar1,0);
  uVar5 = *puVar2;
  uVar3 = *param_3;
