...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int,
   ...
   v8::internal::Handle<v8::internal::String> > > >::__rehash(unsigned long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<int,v8::internal::Handle<v8::internal::String>>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,v8::internal::Handle<v8::internal::String>>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,v8::internal::Handle<v8::internal::String>>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,v8::internal::Handle<v8::internal::String>>>>
           *this,ulong param_1)
