...
/* v8::debug::GetPrivateFields(v8::Local<v8::Context>, v8::Local<v8::Object>) */

ulong * v8::debug::GetPrivateFields(long param_1,undefined8 param_2)
  ...
  if ((*(int *)(pIVar7 + 0x2c20) == (int)uVar9) ||
    ...
    *local_48 = uVar9;
    ...
    if (internal::TracingFlags::runtime_stats != 0) {
      ...
      internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x36a);
    }
    this = *(Logger **)(pIVar7 + 0x9558);
    uVar9 = internal::Logger::is_logging(this);
    if ((uVar9 & 1) != 0) {
      internal::Logger::ApiEntryCall(this,"v8::debug::GetPrivateFields");
    }
    uVar1 = *(undefined4 *)(pIVar7 + 0x2c60);
    *(undefined4 *)(pIVar7 + 0x2c60) = 5;
    puVar3 = (ulong *)internal::Debug::GetPrivateFields(*(undefined8 *)(pIVar7 + 0xb6c8),param_2);
    puVar8 = local_48;
    if (puVar3 == (ulong *)0x0) {
      local_a0 = '\x01';
...
LAB_00ed030c:
        ...
        if (*(code **)(lVar4 + 0xb738) == (code *)0x0) goto LAB_00ed030c;
