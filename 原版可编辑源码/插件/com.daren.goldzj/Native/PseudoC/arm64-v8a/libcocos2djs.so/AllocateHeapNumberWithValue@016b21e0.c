...
/* v8::internal::compiler::EffectControlLinearizer::AllocateHeapNumberWithValue(v8::internal::compiler::Node*)
    */

AccessBuilder * __thiscall
v8::internal::compiler::EffectControlLinearizer::AllocateHeapNumberWithValue
...

{
  ...
  GraphAssembler::StoreField(this_00,aFStack_70,(Node *)this_01,param_1);
