...
/* v8::internal::Factory::NewWithContext(v8::internal::Handle<v8::internal::Context>,
   v8::internal::Handle<v8::internal::ScopeInfo>, v8::internal::Handle<v8::internal::JSReceiver>) */

ulong * __thiscall
v8::internal::Factory::NewWithContext(Factory *this,ulong *param_2,ulong *param_3,ulong *param_4)
