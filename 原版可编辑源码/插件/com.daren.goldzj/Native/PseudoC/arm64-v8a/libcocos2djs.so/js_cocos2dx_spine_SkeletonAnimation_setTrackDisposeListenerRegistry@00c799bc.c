...
/* js_cocos2dx_spine_SkeletonAnimation_setTrackDisposeListenerRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonAnimation_setTrackDisposeListenerRegistry
...

{
  ...
  if (this == (SkeletonAnimation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3899,"js_cocos2dx_spine_SkeletonAnimation_setTrackDisposeListener");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonAnimation_setTrackDisposeListener : Invalid Native Object"
                       );
  }
  else {
    ...
    if (plVar5[1] - (long)pVVar10 == 0x20) {
      ...
      if (pVVar10[0x18] == (Value)0x5) {
        ...
        if ((uVar8 & 1) == 0) goto LAB_00c79c30;
...
LAB_00c79c58:
        ...
        if (!bVar3) goto LAB_00c79c38;
LAB_00c79c90:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                            ,0x38bf,"js_cocos2dx_spine_SkeletonAnimation_setTrackDisposeListener");
        __android_log_print(6,"jswrapper",
                            "js_cocos2dx_spine_SkeletonAnimation_setTrackDisposeListener : Error processing arguments"
                           );
        bVar3 = false;
      }
      else {
LAB_00c79c30:
        local_b0 = (long *)0x0;
        if (bVar3) goto LAB_00c79c90;
LAB_00c79c38:
        spine::SkeletonAnimation::setTrackDisposeListener(this,pTVar7,(function *)alStack_d0);
        bVar3 = true;
      }
...
LAB_00c79d00:
      ...
      if (bVar3) goto LAB_00c79d34;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 14531): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar5[1] - (long)pVVar10) >> 4,2);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonAnimation_setTrackDisposeListener",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x38c6);
LAB_00c79d34:
