...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CheckFloat64Hole(v8::internal::compiler::CheckFloat64HoleMode,
   v8::internal::compiler::FeedbackSource const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::CheckFloat64Hole
...

{
  ...
  if ((*param_3 == 0) || ((int)param_3[1] == -1)) {
    ...
    Operator::Operator(pOVar2,0xdf,0x38,"CheckFloat64Hole",1,1,1,1,1,0);
    pOVar2[0x30] = param_2;
    *(undefined ***)pOVar2 = &PTR__Operator_01cc1ee8;
