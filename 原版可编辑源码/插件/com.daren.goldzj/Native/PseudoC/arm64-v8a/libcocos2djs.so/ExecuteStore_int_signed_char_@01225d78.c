...
/* bool v8::internal::wasm::ThreadImpl::ExecuteStore<int, signed char>(v8::internal::wasm::Decoder*,
   v8::internal::wasm::InterpreterCode*, unsigned long, int*, v8::internal::MachineRepresentation,
   int) */

bool __thiscall
v8::internal::wasm::ThreadImpl::ExecuteStore<int,signed_char>
  ...
  *(long *)(this + 0x28) = lVar6 + -0x11;
  ...
  if (!CARRY4(local_97,uVar9)) {
    ...
    if (((*(long *)(lVar6 + 0x13) != 0) && ((ulong)uVar2 <= *(long *)(lVar6 + 0x13) - 1U)) &&
       (puVar3 = (undefined1 *)((*(ulong *)(lVar6 + 0x1b) & (ulong)uVar2) + *(long *)(lVar6 + 0xb)),
       puVar3 != (undefined1 *)0x0)) {
      *puVar3 = (char)local_97;
