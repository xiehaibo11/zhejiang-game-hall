...
/* void std::__ndk1::vector<v8::internal::HeapObjectsMap::EntryInfo,
   std::__ndk1::allocator<v8::internal::HeapObjectsMap::EntryInfo>
   >::__push_back_slow_path<v8::internal::HeapObjectsMap::EntryInfo>(v8::internal::HeapObjectsMap::EntryInfo&&)
    */
...

{
  ...
  if (uVar1 < 0xaaaaaaaaaaaaaab) {
    ...
    if (uVar1 == 0) {
      ...
      if (0xaaaaaaaaaaaaaaa < uVar1) goto LAB_011aa5c0;
