...
/* js_cocos2dx_dragonbones_PolygonBoundingBoxData_get_yRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_PolygonBoundingBoxData_get_yRegistry
...

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xb65,"js_cocos2dx_dragonbones_PolygonBoundingBoxData_get_y");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_PolygonBoundingBoxData_get_y : Invalid Native Object"
                       );
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_dragonbones_PolygonBoundingBoxData_get_y",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0xb6d);
  }
  else {
    se::Value::Value(aVStack_58);
    float_to_seval(*(float *)(lVar3 + 0x24),aVStack_58);
