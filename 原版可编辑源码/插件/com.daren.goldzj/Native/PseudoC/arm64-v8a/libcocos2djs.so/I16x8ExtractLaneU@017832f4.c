...
/* v8::internal::compiler::MachineOperatorBuilder::I16x8ExtractLaneU(int) */

Operator * __thiscall
v8::internal::compiler::MachineOperatorBuilder::I16x8ExtractLaneU
...

{
  ...
  Operator::Operator(pOVar1,0x25c,0x7c,"Extract lane",1,0,0,1,0,0);
