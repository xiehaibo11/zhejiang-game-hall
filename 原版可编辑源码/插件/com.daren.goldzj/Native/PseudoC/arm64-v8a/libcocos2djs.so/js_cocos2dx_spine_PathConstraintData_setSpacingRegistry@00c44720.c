...
/* js_cocos2dx_spine_PathConstraintData_setSpacingRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_PathConstraintData_setSpacingRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (PathConstraintData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1c33,"js_cocos2dx_spine_PathConstraintData_setSpacing");
    pcVar6 = "js_cocos2dx_spine_PathConstraintData_setSpacing : Invalid Native Object";
LAB_00c44894:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::PathConstraintData::setSpacing(this,local_64);
        goto LAB_00c448cc;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1c3a,"js_cocos2dx_spine_PathConstraintData_setSpacing");
      pcVar6 = "js_cocos2dx_spine_PathConstraintData_setSpacing : Error processing arguments";
      goto LAB_00c44894;
    }
    __android_log_print(6,"jswrapper",&DAT_0190975d,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_PathConstraintData_setSpacing",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1c41);
LAB_00c448cc:
