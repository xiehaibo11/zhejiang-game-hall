...
/* v8::internal::ObjectHashTable::ObjectHashTablePrint(std::__ndk1::basic_ostream<char,
   std::__ndk1::char_traits<char> >&) */

void __thiscall
v8::internal::ObjectHashTable::ObjectHashTablePrint(ObjectHashTable *this,basic_ostream *param_1)

{
  ...
  uVar3 = *(ulong *)this;
  local_48 = uVar3;
  HeapObject::PrintHeader((HeapObject *)&local_48,param_1,"ObjectHashTable");
  ...
  if ((int)uVar1 >> 1 != 0) {
    ...
    do {
      ...
      *(undefined8 *)(pbVar2 + *(long *)(*(long *)pbVar2 + -0x18) + 0x18) = 0xc;
      ...
      pbVar2 = std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>
                         (pbVar2," -> ",4);
      local_70 = ObjectHashTableBase<v8::internal::ObjectHashTable,v8::internal::ObjectHashTableShape>
