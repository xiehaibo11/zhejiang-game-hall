...
/* js_network_Downloader_setOnTaskErrorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_network_Downloader_setOnTaskErrorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x87,"js_network_Downloader_setOnTaskError");
    __android_log_print(6,"jswrapper","js_network_Downloader_setOnTaskError : Invalid Native Object"
                       );
  }
  else {
      ...
      if (pVVar6[8] == (Value)0x5) {
        ...
        if ((uVar8 & 1) == 0) {
          ...
          if (alStack_c0 == plVar10) {
            ...
            if (plVar10 == (long *)0x0) goto LAB_009012e4;
...
LAB_00901398:
        ...
        if (local_a0 == (long *)0x0) goto LAB_009012e4;
...
LAB_009012e4:
      ...
      FUN_008f46ac(alStack_90,lVar4 + 0x90);
      if (alStack_90 == local_70) {
        pcVar11 = *(code **)(*local_70 + 0x20);
LAB_0090131c:
        (*pcVar11)();
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_cocos2dx_network_manual.cpp, 179): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(puVar5[1] - (long)pVVar6) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_network_Downloader_setOnTaskError",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_cocos2dx_network_manual.cpp"
                      ,0xb6);
LAB_00901258:
