...
void FUN_01467948(ulong param_1,undefined8 param_2,undefined8 param_3,uint param_4,long param_5,
...
code_r0x01467948:
  ...
  if ((int)uVar11 == (int)param_7) {
    if (bVar4) {
      ...
      if (iVar9 == param_8) {
        param_4 = param_4 | 6;
        if (NAN(*(double *)(uVar11 + 3))) goto LAB_01467c1c;
      }
      else {
...
LAB_01467bfc:
        param_4 = param_4 | 6;
        if (dVar14 == dVar15) goto LAB_01467c0c;
      }
      else {
        if (iVar13 == in_w8) {
          param_4 = 0x3fe;
...
LAB_01467e64:
          *(int *)(param_5 + -0x20) = (iVar9 + -1) * 2;
          FUN_01349ae0();
          FUN_01467948(*(undefined8 *)(unaff_x26 + 0x370));
          return;
        }
        if (uVar2 == 0x41) {
          *(int *)(param_5 + -0x20) = (iVar9 + -1) * 2;
    ...
    param_1 = uVar11;
    if (bVar5) goto code_r0x01467948;
    lVar10 = unaff_x26 + (ulong)*(uint *)(uVar11 - 1);
...
LAB_01467c20:
        ...
        if ((int)lVar10 != (int)*(undefined8 *)(unaff_x26 + 0xa0)) {
          lVar1 = (ulong)*(uint *)(lVar8 + unaff_x19 + 5) * 4 + 0x1f;
          ...
          if (uVar12 != param_4) {
            ...
            *(undefined4 *)(lVar10 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x01467c9c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (**(code **)(unaff_x21 + (ulong)*(byte *)(lVar8 + unaff_x19 + 9) * 8))(uVar6);
        return;
      }
      goto code_r0x01467948;
    }
    if (uVar2 == 0x40) {
      ...
      if (uVar2 == 0x42) {
        ...
        if (uVar3 < 0x40) goto LAB_01467e64;
        if (iVar13 == in_w8) {
          param_4 = 0x3fe;
          param_1 = unaff_x26 + (ulong)*(uint *)(param_7 + 0xf);
          param_7 = uVar11;
        ...
        if (iVar13 == in_w8) {
          FUN_01467948(unaff_x26 + (ulong)*(uint *)(param_7 + 0xf),param_2,param_3,0x3fe);
          return;
        }
        if (0xa8 < uVar3) goto code_r0x01467948;
      }
      else if (uVar3 < 0xa9) {
        if ((*(byte *)(lVar8 + 9) >> 4 & 1) == 0) {
          FUN_01467ca0();
