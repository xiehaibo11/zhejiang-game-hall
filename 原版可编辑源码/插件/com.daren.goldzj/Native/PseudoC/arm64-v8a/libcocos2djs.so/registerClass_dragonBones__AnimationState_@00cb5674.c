...
/* void JSBClassType::registerClass<dragonBones::AnimationState>(se::Class*) */

void JSBClassType::registerClass<dragonBones::AnimationState>(Class *param_1)
