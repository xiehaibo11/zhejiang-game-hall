...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitToString(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitToString
