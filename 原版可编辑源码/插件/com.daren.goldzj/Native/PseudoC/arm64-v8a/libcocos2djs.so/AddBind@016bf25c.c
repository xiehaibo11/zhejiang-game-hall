...
/* v8::internal::compiler::GraphAssembler::BasicBlockUpdater::AddBind(v8::internal::compiler::BasicBlock*)
    */

void __thiscall
v8::internal::compiler::GraphAssembler::BasicBlockUpdater::AddBind
