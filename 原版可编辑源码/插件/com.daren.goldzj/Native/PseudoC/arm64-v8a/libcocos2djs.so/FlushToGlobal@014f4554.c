...
/* v8::internal::Worklist<std::__ndk1::pair<v8::internal::HeapObject, v8::internal::Code>,
   64>::FlushToGlobal(int) */

void __thiscall
v8::internal::Worklist<std::__ndk1::pair<v8::internal::HeapObject,v8::internal::Code>,64>::
FlushToGlobal(Worklist<std::__ndk1::pair<v8::internal::HeapObject,v8::internal::Code>,64> *this,
             int param_1)
