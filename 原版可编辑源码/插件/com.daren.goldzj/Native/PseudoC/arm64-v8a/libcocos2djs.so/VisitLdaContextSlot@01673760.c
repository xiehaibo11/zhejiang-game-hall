...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitLdaContextSlot() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitLdaContextSlot(BytecodeGraphBuilder *this)

{
  ...
  pOVar4 = (Operator *)
           JSOperatorBuilder::LoadContext(this_01,uVar2 & 0xffffffff,uVar3 & 0xffffffff,false);
