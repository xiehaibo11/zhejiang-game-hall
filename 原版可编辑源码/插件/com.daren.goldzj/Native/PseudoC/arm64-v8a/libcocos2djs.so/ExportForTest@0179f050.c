...
/* v8::internal::compiler::RawMachineAssembler::ExportForTest() */

undefined8 __thiscall
v8::internal::compiler::RawMachineAssembler::ExportForTest(RawMachineAssembler *this)

{
  ...
  Schedule::PropagateDeferredMark(*(Schedule **)(this + 0x10));
  if (FLAG_trace_turbo_scheduler != '\0') {
  ...
  SourcePositionTable::RemoveDecorator(*(SourcePositionTable **)(this + 0x18));
