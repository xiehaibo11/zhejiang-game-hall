  ...
  if (ptr != (lhash_st_OPENSSL_STRING **)0x0) {
    ...
    if (0 < db->num_fields) {
      do {
        ...
        ptr = db->index;
                    /* try { // try from 00b55580 to 00c55d53 has its CatchHandler @ 00b55580
                       catch() { ... } // from try @ 00b55580 with catch @ 00b55580
                       catch() { ... } // from try @ 00b55dd8 with catch @ 00b55580
                       catch() { ... } // from try @ 00b55e1c with catch @ 00b55580
                       catch() { ... } // from try @ 00b5629c with catch @ 00b55580 */
        bVar1 = 1 < lVar6;
        lVar6 = lVar6 + -1;
      } while (bVar1);
    }
