...
/* v8::internal::compiler::MapRef::SerializeBackPointer() */

void __thiscall v8::internal::compiler::MapRef::SerializeBackPointer(MapRef *this)

{
  ...
  if (*(short *)(*(long *)(this_00 + 0x10) + 0x18) == 0xa2) {
    MapData::SerializeBackPointer(this_00,*(JSHeapBroker **)(this + 8));
    return;
  }
                    /* WARNING: Subroutine does not return */
