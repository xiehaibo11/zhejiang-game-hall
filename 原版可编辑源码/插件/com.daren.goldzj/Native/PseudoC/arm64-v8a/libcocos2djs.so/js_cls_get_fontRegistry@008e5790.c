...
/* js_cls_get_fontRegistry(v8::Local<v8::Name>, v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cls_get_fontRegistry(undefined8 param_1,PropertyCallbackInfo *param_2)

{
  ...
  if (lVar3 == 0) {
    ...
    se::Value::setString(pVVar4,(basic_string *)(lVar3 + 0x40));
  }
  pVVar4 = (Value *)se::State::rval(aSStack_60);
