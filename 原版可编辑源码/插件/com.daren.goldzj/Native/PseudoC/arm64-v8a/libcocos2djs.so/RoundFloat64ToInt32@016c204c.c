...
/* v8::internal::compiler::GraphAssembler::RoundFloat64ToInt32(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::RoundFloat64ToInt32(GraphAssembler *this,Node *param_1)

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::RoundFloat64ToInt32
