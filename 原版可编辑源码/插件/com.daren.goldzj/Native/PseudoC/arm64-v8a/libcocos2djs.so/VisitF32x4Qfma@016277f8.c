...
/* v8::internal::compiler::InstructionSelector::VisitF32x4Qfma(v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::InstructionSelector::VisitF32x4Qfma(InstructionSelector *this,Node *param_1)

{
  ...
  Emit(this,0x123,(uVar1 & 0xffffffff) << 3 | 0xf800000001,(uVar2 & 0xffffffff) << 3 | 0x5800000001,
