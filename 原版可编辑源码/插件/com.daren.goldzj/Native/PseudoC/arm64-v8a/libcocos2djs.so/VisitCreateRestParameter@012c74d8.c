...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitCreateRestParameter(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitCreateRestParameter
