...

{
  ...
  int iVar3;
                    ...
                    /* catch() { ... } // from try @ 00ad8174 with catch @ 00ad8288
                       catch() { ... } // from try @ 00ad8208 with catch @ 00ad8288 */
                    /* catch() { ... } // from try @ 00ad8198 with catch @ 00ad8298 */
  ...
  if (iVar3 != 0) {
    ...
    *puVar2 = (char)*(undefined4 *)(param_1 + 0x234);
    puVar2[1] = (char)*(undefined2 *)(param_1 + 0x282);
                    /* catch() { ... } // from try @ 00ad834c with catch @ 00ad82f0 */
  ...
  ossl_statem_set_error(param_1);
                    /* try { // try from 00ad8338 to 00bd834b has its CatchHandler @ 00ad8380 */
  return 0;
}
