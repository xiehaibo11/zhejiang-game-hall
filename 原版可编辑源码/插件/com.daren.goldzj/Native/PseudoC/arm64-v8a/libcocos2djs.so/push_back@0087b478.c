...
/* std::__ndk1::__split_buffer<std::__ndk1::vector<cocos2d::Value,
   ...
   >**>&>::push_back(std::__ndk1::vector<cocos2d::Value, std::__ndk1::allocator<cocos2d::Value>
   >**&&) */
...

{
  ...
  if (puVar14 != *(undefined8 **)(this + 0x18)) goto LAB_0087b600;
...
LAB_0087b5d0:
      ...
      if (uVar2 != uVar11) goto LAB_0087b5d0;
    }
    puVar13 = *(undefined8 **)this;
