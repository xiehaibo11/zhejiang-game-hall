...
long FUN_018513c0(ulong *param_1,uint *param_2)

{
  ...
  do {
    ...
    if (param_2[1] != 0) {
      ...
      if (lVar6 != lVar4) {
        uVar2 = FUN_01850c9c(lVar6);
        if (uVar2 == 0xff) {
          return -1;
        }
        uVar8 = FUN_01850a5c((char)uVar2,param_1);
      ...
      FUN_01850b1c(uVar2 & 0xff,uVar8,param_2 + 2,&local_8);
      uVar3 = FUN_018509fc(uVar2 & 0xff);
