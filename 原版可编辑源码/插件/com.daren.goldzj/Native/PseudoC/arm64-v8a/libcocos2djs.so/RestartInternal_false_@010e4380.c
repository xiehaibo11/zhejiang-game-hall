...
/* void 
   v8::internal::LookupIterator::RestartInternal<false>(v8::internal::LookupIterator::InterceptorState)
    */

void __thiscall
v8::internal::LookupIterator::RestartInternal<false>(LookupIterator *this,undefined4 param_2)
