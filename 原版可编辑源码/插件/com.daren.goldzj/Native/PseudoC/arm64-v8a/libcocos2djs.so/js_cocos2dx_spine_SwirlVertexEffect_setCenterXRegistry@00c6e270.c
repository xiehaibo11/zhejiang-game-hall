...
/* js_cocos2dx_spine_SwirlVertexEffect_setCenterXRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SwirlVertexEffect_setCenterXRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SwirlVertexEffect *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x312d,"js_cocos2dx_spine_SwirlVertexEffect_setCenterX");
    puVar6 = &DAT_0191c324;
LAB_00c6e3e4:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::SwirlVertexEffect::setCenterX(this,local_64);
        goto LAB_00c6e41c;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x3134,"js_cocos2dx_spine_SwirlVertexEffect_setCenterX");
      puVar6 = &DAT_0191c36b;
      goto LAB_00c6e3e4;
    }
    __android_log_print(6,"jswrapper",&DAT_0191c3b7,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SwirlVertexEffect_setCenterX",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x313b);
LAB_00c6e41c:
