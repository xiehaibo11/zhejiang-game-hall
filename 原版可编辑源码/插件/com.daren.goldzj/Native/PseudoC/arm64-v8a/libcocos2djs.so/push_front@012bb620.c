...
/* std::__ndk1::__split_buffer<v8::internal::compiler::Node**,
   v8::internal::RecyclingZoneAllocator<v8::internal::compiler::Node**>&>::push_front(v8::internal::compiler::Node**
   const&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_012bb800;
  ...
  if (puVar6 != puVar1) {
    ...
    if ((3 < uVar3) && ((puVar6 + uVar10 + 1 <= __src || (puVar2 + uVar10 + uVar7 + 1 <= puVar6))))
    {
      ...
      puVar8 = __src + uVar10;
      if (uVar3 == uVar10) goto LAB_012bb7b4;
    }
    do {
      puVar12 = puVar6 + 1;
      *puVar8 = *puVar6;
