...
/* v8::internal::JSWeakSet::JSWeakSetVerify(v8::internal::Isolate*) */

void __thiscall v8::internal::JSWeakSet::JSWeakSetVerify(JSWeakSet *this,Isolate *param_1)

{
  uint uVar1;
  ulong uVar2;
  
  TorqueGeneratedClassVerifiers::JSWeakSetVerify(*(undefined8 *)this);
