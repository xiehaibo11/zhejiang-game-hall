...
/* v8::internal::Translation::BeginJavaScriptBuiltinContinuationWithCatchFrame(v8::internal::BailoutId,
   int, unsigned int) */

void __thiscall
v8::internal::Translation::BeginJavaScriptBuiltinContinuationWithCatchFrame
