...
joined_r0x0109e6b8:
  if (in_w3 != 0) {
    FUN_0109f388();
    pcStack_68 = FUN_0109e7b0;
    puStack_70 = (undefined1 *)&puStack_60;
    FUN_0109f39c();
    pcStack_78 = FUN_0109e7bc;
    puStack_80 = (undefined1 *)&puStack_70;
    FUN_0109f3b0();
    pcStack_d8 = FUN_0109e7c8;
    ...
    pIVar7 = (Isolate *)(uStack_e8 & 0xffffffff00000000);
    uVar6 = v8::internal::JSObject::GetFastElementsUsage((JSObject *)&uStack_e8);
    puVar10 = (undefined8 *)
              v8::internal::
    ...
    if (0 < (int)uVar6) {
      ...
      if (0 < iVar17) {
        ...
        v8::internal::NumberDictionary::UpdateMaxNumberKey
                  ((NumberDictionary *)&uStack_e8,iVar17,extraout_x1_00);
      }
    }
    return puVar10;
  }
