...
undefined8 __thiscall v8::Value::InstanceOf(Value *this,long param_2,undefined8 param_3)

{
  ...
  *(int *)pIVar15 = *(int *)pIVar15 + 1;
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x3f0);
  }
  this_00 = *(Logger **)(pIVar10 + 0x9558);
  uVar3 = internal::Logger::is_logging(this_00);
  if ((uVar3 & 1) != 0) {
    internal::Logger::ApiEntryCall(this_00,"v8::Value::InstanceOf");
  }
  uVar1 = *(undefined4 *)(pIVar10 + 0x2c60);
  *(undefined4 *)(pIVar10 + 0x2c60) = 5;
  puVar4 = (ulong *)internal::Object::InstanceOf(pIVar10,this,param_3);
  if (puVar4 == (ulong *)0x0) {
    local_a0 = '\x01';
