...
bool FUN_00b8a5f8(int param_1,BIGNUM *param_2,int param_3,int param_4,int param_5)
...
LAB_00b8a75c:
  ...
  if ((param_3 < 0) || ((uVar8 = param_3 - 1, uVar8 == 0 && (0 < param_4)))) goto LAB_00b8a75c;
  uVar1 = param_3 + 0xe;
  if (-1 < (int)(param_3 + 7U)) {
    uVar1 = param_3 + 7U;
  }
