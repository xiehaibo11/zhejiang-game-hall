...
undefined8 FUN_015901d4(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_90,(ulong)&local_90 | 8,0x1f9);
  }
  if (DAT_01d47330 == (byte *)0x0) {
    plVar5 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d47330 = (byte *)(**(code **)(*plVar5 + 0x10))(plVar5,"disabled-by-default-v8.runtime");
  }
  pbVar4 = DAT_01d47330;
  local_b0 = (byte **)0x0;
  if ((*DAT_01d47330 & 5) != 0) {
    ...
    uVar6 = (**(code **)(*plVar5 + 0x18))
                      (plVar5,0x58,pbVar4,"V8.Runtime_Runtime_StoreLookupSlot_Sloppy",0,0,0,0,0,0,0,
                       &local_60,0);
    plVar5 = local_58;
    local_58 = (long *)0x0;
    if (plVar5 != (long *)0x0) {
    ...
    local_b0 = &local_a8;
    local_a0 = "V8.Runtime_Runtime_StoreLookupSlot_Sloppy";
    local_a8 = pbVar4;
    local_98 = uVar6;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar9 & 1) != 0) &&
    ...
    pIVar8 = (Isolate *)FUN_0159213c(param_3,puVar7,param_2,param_2 + -1,0,3);
