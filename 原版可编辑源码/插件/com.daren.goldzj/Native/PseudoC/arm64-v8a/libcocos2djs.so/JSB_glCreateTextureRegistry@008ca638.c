...
/* JSB_glCreateTextureRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glCreateTextureRegistry(FunctionCallbackInfo *param_1)

{
  ...
  glGenTextures(1,&local_a4);
  this = (Object *)se::Object::createObjectWithClass(DAT_01d36f08);
  ...
  if (this_00 != (Ref *)0x0) {
    ...
    *(undefined ***)this_00 = &PTR_FUN_01c67768;
    if (uVar10 != 0) {
      uVar9 = uVar10 - 1;
      if ((uVar9 & uVar10) == 0) {
      ...
      plVar7 = *(long **)(DAT_01d36e08 + unaff_x27 * 8);
      if (plVar7 != (long *)0x0) {
        do {
          plVar7 = (long *)*plVar7;
          if (plVar7 == (long *)0x0) goto LAB_008ca880;
          uVar12 = plVar7[1];
          if (uVar12 != uVar14) {
            if ((uVar9 & uVar10) == 0) {
              uVar12 = uVar12 & uVar9;
              ...
              if (uVar12 - uVar1 * uVar10 == unaff_x27) goto LAB_008ca870;
              goto LAB_008ca880;
            }
            if (uVar12 != unaff_x27) goto LAB_008ca880;
          }
LAB_008ca870:
...
LAB_008ca880:
    ...
    *plVar7 = 0;
    ...
    if ((uVar10 == 0) || (fVar4 * (float)uVar10 < (float)(lVar3 + 1))) {
      ...
      FUN_008d3530(&DAT_01d36e08,uVar10);
      uVar10 = DAT_01d36e10;
      if ((DAT_01d36e10 - 1 & DAT_01d36e10) == 0) {
        unaff_x27 = DAT_01d36e10 - 1 & uVar14;
      }
      else {
        unaff_x27 = uVar14;
        if (DAT_01d36e10 <= uVar14) {
          uVar9 = 0;
          if (DAT_01d36e10 != 0) {
            uVar9 = uVar14 / DAT_01d36e10;
          }
          unaff_x27 = uVar14 - uVar9 * DAT_01d36e10;
        }
      }
    }
    lVar3 = DAT_01d36e08;
    plVar11 = *(long **)(DAT_01d36e08 + unaff_x27 * 8);
    if (plVar11 == (long *)0x0) {
      plVar11 = plVar7;
      *plVar7 = (long)DAT_01d36e18;
      DAT_01d36e18 = plVar11;
      *(long ***)(lVar3 + unaff_x27 * 8) = &DAT_01d36e18;
      if (*plVar7 != 0) {
        ...
        plVar11 = (long *)(DAT_01d36e08 + uVar14 * 8);
        goto LAB_008ca9a0;
      }
    }
    else {
