...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitCallWithSpread(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::VisitCallWithSpread
...

{
  ...
  ProcessCallOrConstruct(this,*puVar8,0,0,local_60,uVar4,1);
  return;
}
