...
long FUN_010c1680(undefined8 param_1,long *param_2,undefined8 *param_3,long param_4,int param_5)

{
  ...
  local_18 = *param_3;
  uVar2 = v8::internal::BigInt::AsUint64((BigInt *)&local_18,(bool *)0x0);
  lVar3 = *param_2;
