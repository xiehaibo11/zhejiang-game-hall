...
/* js_universe_Unzipper_setListenerRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_universe_Unzipper_setListenerRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Unzipper *)se::State::nativeThisObject(aSStack_148);
  if (this == (Unzipper *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1f9,"js_universe_Unzipper_setListener");
    __android_log_print(6,"jswrapper","js_universe_Unzipper_setListener : Invalid Native Object");
  }
  else {
      ...
      if (pVVar5[8] == (Value)0x5) {
        ...
        if ((uVar7 & 1) == 0) {
          ...
          if (alStack_c0 == plVar9) {
            ...
            if (plVar9 == (long *)0x0) goto LAB_009699e8;
...
LAB_009699e8:
      universe::Unzipper::setListener(this,(function *)alStack_c0);
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp, 548): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(puVar4[1] - (long)pVVar5) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_universe_Unzipper_setListener",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp"
                      ,0x227);
LAB_009698e8:
