...
/* v8::internal::interpreter::BytecodeArrayBuilder::CreateBlockContext(v8::internal::Scope const*)
    */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::CreateBlockContext
