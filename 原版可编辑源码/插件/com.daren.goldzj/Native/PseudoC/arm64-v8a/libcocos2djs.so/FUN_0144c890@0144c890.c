...
void FUN_0144c890(long param_1,undefined8 param_2,undefined8 param_3,long param_4,ulong param_5,
...
LAB_0144c990:
    ...
    if (sVar3 != 0x43) goto LAB_0144c990;
    if ((param_5 & 1) == 0) {
      uVar5 = 0x1e;
    }
    else {
      ...
      if ((int)lVar4 == (int)*(undefined8 *)(unaff_x26 + 0x140)) {
        ...
        if (*(short *)(lVar4 + 7) != 0x43) goto LAB_0144c990;
        uVar5 = 0x1e;
      }
    }
  }
  *(int *)(param_4 + -0x20) = iVar7;
  lVar4 = FUN_01392240(param_5,param_1);
  iVar7 = (int)*(undefined8 *)(unaff_x26 + 0xa0);
LAB_0144c6f8:
  if ((int)param_6 != iVar7) {
    ...
    if (uVar6 != uVar5) {
      ...
      *(undefined4 *)(param_6 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0144c744. Too many branches */
