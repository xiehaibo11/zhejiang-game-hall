      ...
      do {
        ...
        while (param_1 = puVar3, uVar7 != 0) {
          while( true ) {
            ...
            uVar7 = uVar2 ^ uVar7;
            if ((uVar2 & param_2) == 0) break;
            param_1 = (undefined4 *)((long)puVar3 + 3);
            if ((uVar2 & param_4) == 0) {
              ...
              *(undefined1 *)((long)puVar3 + 2) = *puVar1;
              *(undefined2 *)puVar3 = uVar6;
            }
            puVar3 = param_1;
            if (uVar7 == 0) goto LAB_00a99514;
          }
          param_3 = (undefined4 *)((long)param_3 + 3);
        }
LAB_00a99514:
