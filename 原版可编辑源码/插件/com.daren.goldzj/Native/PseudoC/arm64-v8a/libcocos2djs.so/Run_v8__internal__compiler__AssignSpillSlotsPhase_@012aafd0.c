...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::AssignSpillSlotsPhase>()
    */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::AssignSpillSlotsPhase>
          (PipelineImpl *this)

{
  ...
  if (this_00 != (PipelineStatistics *)0x0) {
    PipelineStatistics::BeginPhase(this_00,"V8.TFAssignSpillSlots");
  }
  this_01 = *(ZoneStats **)(lVar5 + 0x30);
  lVar4 = *(long *)(lVar5 + 0xb0);
  if (lVar4 != 0) {
    local_60 = *(undefined8 *)(lVar4 + 0x30);
    *(char **)(lVar4 + 0x30) = "V8.TFAssignSpillSlots";
  }
  ...
  lVar2 = ZoneStats::NewEmptyZone(this_01,"V8.TFAssignSpillSlots");
  OperandAssigner::OperandAssigner(aOStack_18,*(RegisterAllocationData **)(lVar5 + 0x170));
  OperandAssigner::AssignSpillSlots(aOStack_18);
