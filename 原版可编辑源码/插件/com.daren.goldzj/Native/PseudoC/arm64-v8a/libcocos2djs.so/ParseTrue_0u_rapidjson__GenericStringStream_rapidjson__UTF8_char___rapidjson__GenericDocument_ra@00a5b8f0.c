...

{
  ...
  *(long *)param_1 = lVar4;
  if (*(char *)(lVar5 + 1) == 'r') {
                    /* catch() { ... } // from try @ 00a5b8b8 with catch @ 00a5b908 */
    lVar4 = lVar5 + 2;
                    /* catch() { ... } // from try @ 00a5b870 with catch @ 00a5b90c */
    *(long *)param_1 = lVar4;
                    /* catch() { ... } // from try @ 00a5b88c with catch @ 00a5b914 */
    if (*(char *)(lVar5 + 2) == 'u') {
      lVar4 = lVar5 + 3;
      *(long *)param_1 = lVar4;
      if (*(char *)(lVar5 + 3) == 'e') {
        ...
        *(undefined8 **)(param_2 + 0x40) = puVar6;
        ...
        puVar3[2] = 0;
        *puVar3 = 0;
        *(undefined2 *)((long)puVar3 + 0x16) = 10;
        return;
      }
    }
  }
