...
/* void JSBClassType::registerClass<spine::TwoColorTimeline>(se::Class*) */

void JSBClassType::registerClass<spine::TwoColorTimeline>(Class *param_1)
