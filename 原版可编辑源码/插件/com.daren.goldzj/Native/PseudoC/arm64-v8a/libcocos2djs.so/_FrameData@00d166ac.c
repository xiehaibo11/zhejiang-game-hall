...
/* spine::SkeletonCache::FrameData::~FrameData() */

void __thiscall spine::SkeletonCache::FrameData::~FrameData(FrameData *this)

{
  ...
  *(undefined8 **)(this + 0x20) = puVar6;
  if (lVar1 - (long)puVar4 != 0) {
    ...
    while( true ) {
      if (pvVar2 != (void *)0x0) {
        if (*(Ref **)((long)pvVar2 + 0x10) != (Ref *)0x0) {
          cocos2d::Ref::release(*(Ref **)((long)pvVar2 + 0x10));
        }
        operator_delete(pvVar2);
      }
      uVar7 = uVar7 + 1;
...
LAB_00d16860:
  ...
  if (this + 0x90 == pFVar3) {
    ...
    if (pFVar3 == (FrameData *)0x0) goto LAB_00d16890;
    pcVar5 = *(code **)(*(long *)pFVar3 + 0x28);
  }
  (*pcVar5)();
LAB_00d16890:
