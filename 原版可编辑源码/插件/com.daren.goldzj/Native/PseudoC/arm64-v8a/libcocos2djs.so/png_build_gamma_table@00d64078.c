...

{
  ...
  *(uint *)(param_1 + 0x2e8) = uVar8;
  if (uVar17 == 0) {
    ...
    FUN_00d6496c(param_1,param_1 + 0x2f8,uVar8,iVar15);
  }
  else {
    if (iVar16 < 1) {
      dVar25 = 1.0;
    ...
    do {
      ...
      if (uVar24 <= uVar6 / 0xffff) {
        ...
        if ((1 < uVar10) && (uVar20 = uVar10 & 0xfffffffe, uVar20 != 0)) {
          ...
          uVar24 = uVar6;
          if (uVar10 == uVar20) goto LAB_00d646a8;
        }
        do {
          uVar10 = uVar18 + 1;
          *(undefined2 *)
...
LAB_00d646a8:
    ...
    if (uVar24 <= uVar17 && uVar6 != 0) {
      if ((1 < uVar6) && (uVar18 = uVar6 & 0xfffffffe, uVar18 != 0)) {
        ...
        uVar24 = uVar10;
        if (uVar6 == uVar18) goto LAB_00d64878;
      }
      do {
        uVar6 = uVar24 + 1;
        *(undefined2 *)
...
LAB_00d64878:
  ...
  FUN_00d6496c(param_1,param_1 + 0x318,uVar8,iVar15);
  if (*(int *)(param_1 + 0x2ec) < 1) {
    iVar15 = *(int *)(param_1 + 0x510);
  }
  else {
  ...
  FUN_00d6496c(param_1,param_1 + 0x310,uVar8,iVar15);
  return;
}
