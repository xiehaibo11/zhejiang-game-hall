...
/* v8::internal::compiler::GraphAssembler::Float64SilenceNaN(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Float64SilenceNaN(GraphAssembler *this,Node *param_1)

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::Float64SilenceNaN
