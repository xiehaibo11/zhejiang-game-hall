...
/* v8::internal::compiler::BinopMatcher<v8::internal::compiler::IntMatcher<unsigned int,
   (v8::internal::compiler::IrOpcode::Value)23>, v8::internal::compiler::IntMatcher<unsigned int,
...

{
  ...
  *(long **)(this + 8) = plVar5;
  ...
  this[0x14] = (BinopMatcher<v8::internal::compiler::IntMatcher<unsigned_int,(v8::internal::compiler::IrOpcode::Value)23>,v8::internal::compiler::IntMatcher<unsigned_int,(v8::internal::compiler::IrOpcode::Value)23>>
                )(sVar1 == 0x17);
  if (sVar1 == 0x17) {
  ...
  *(long **)(this + 0x18) = plVar5;
  ...
  this[0x24] = (BinopMatcher<v8::internal::compiler::IntMatcher<unsigned_int,(v8::internal::compiler::IrOpcode::Value)23>,v8::internal::compiler::IntMatcher<unsigned_int,(v8::internal::compiler::IrOpcode::Value)23>>
                )(sVar2 == 0x17);
  if (sVar2 == 0x17) {
