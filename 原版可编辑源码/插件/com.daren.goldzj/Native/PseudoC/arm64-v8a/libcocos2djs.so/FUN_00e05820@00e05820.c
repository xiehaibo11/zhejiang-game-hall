...
void FUN_00e05820(char *param_1,uint param_2,int param_3,int param_4,char *param_5)

{
  ...
  pcVar30 = param_5 + 1;
  *param_5 = *param_1;
  if ((int)param_2 < 2) goto LAB_00e0589c;
  uVar3 = param_2 - 1;
  uVar27 = (ulong)uVar3;
  if (uVar3 < 0x10) {
LAB_00e0586c:
    ...
    if (lVar32 != 0) {
      lVar28 = lVar32;
      if ((pcVar30 < param_1 + uVar27 + 1) && (param_1 < param_5 + uVar27 + 1)) goto LAB_00e0586c;
      do {
      ...
      if ((uVar3 & 0xf) == 0) goto LAB_00e0589c;
    }
  }
...
LAB_00e05aa0:
          ...
          if (param_5 + lVar32 + 1 + lVar35 < param_1 + lVar35 + uVar27 &&
              param_1 + lVar35 < param_5 + lVar36) goto LAB_00e05aa0;
          lVar36 = 0;
          do {
