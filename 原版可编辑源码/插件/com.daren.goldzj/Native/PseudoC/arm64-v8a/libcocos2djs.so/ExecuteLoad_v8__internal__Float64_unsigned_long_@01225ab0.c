...
/* bool v8::internal::wasm::ThreadImpl::ExecuteLoad<v8::internal::Float64, unsigned
   long>(v8::internal::wasm::Decoder*, v8::internal::wasm::InterpreterCode*, unsigned long, int*,
   v8::internal::MachineRepresentation, int) */

bool __thiscall
v8::internal::wasm::ThreadImpl::ExecuteLoad<v8::internal::Float64,unsigned_long>
...

{
  ...
  *(long *)(this + 0x28) = lVar7 + -0x11;
  ...
  if (!CARRY4(local_a0._1_4_,uVar11)) {
    ...
    if (((7 < *(ulong *)(lVar7 + 0x13)) && ((ulong)uVar2 <= *(ulong *)(lVar7 + 0x13) - 8)) &&
       (puVar3 = (ulong *)((*(ulong *)(lVar7 + 0x1b) & (ulong)uVar2) + *(long *)(lVar7 + 0xb)),
       puVar3 != (ulong *)0x0)) {
      uStack_98 = *puVar3;
      uStack_b7 = (undefined7)uStack_98;
      uStack_98 = uStack_98 >> 0x38;
      local_a0 = CONCAT71(uStack_b7,4);
      local_90 = 0;
