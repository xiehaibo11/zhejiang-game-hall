...
/* v8::internal::Managed<v8::internal::wasm::SignatureMap>::FromSharedPtr(v8::internal::Isolate*,
   unsigned long, std::__ndk1::shared_ptr<v8::internal::wasm::SignatureMap> const&) */

undefined8 *
v8::internal::Managed<v8::internal::wasm::SignatureMap>::FromSharedPtr
