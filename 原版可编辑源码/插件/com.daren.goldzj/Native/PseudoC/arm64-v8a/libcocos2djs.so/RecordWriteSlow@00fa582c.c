...
/* v8::internal::IncrementalMarking::RecordWriteSlow(v8::internal::HeapObject,
   v8::internal::CompressedHeapObjectSlot, v8::internal::HeapObject) */

void __thiscall
v8::internal::IncrementalMarking::RecordWriteSlow
          (IncrementalMarking *this,ulong param_2,ulong param_3,ulong param_4)
...
LAB_00fa59ac:
      if (((param_3 != 0) && (this[0x5c] != (IncrementalMarking)0x0)) &&
         (((uint)*(undefined8 *)(uVar8 + 8) >> 6 & 1) != 0)) {
