...
void FUN_010884f4(undefined8 param_1,ulong *param_2,int param_3,ulong *param_4,undefined8 param_5,
                 int param_6)

{
  ...
  if ((bVar3 < 0xd && (1 << (ulong)bVar3 & 0x1030U) != 0) ||
    ...
    FUN_01089788(param_2,param_6);
  }
  else {
    if ((bVar2 < 0x30) && (bVar3 != 2)) {
      v8::internal::JSObject::TransitionElementsKind(param_2,2);
    }
    if (bVar2 < 0x20) {
