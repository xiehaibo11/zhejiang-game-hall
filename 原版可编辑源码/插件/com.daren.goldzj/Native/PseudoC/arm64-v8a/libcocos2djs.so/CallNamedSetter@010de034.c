...
/* v8::internal::PropertyCallbackArguments::CallNamedSetter(v8::internal::Handle<v8::internal::InterceptorInfo>,
   v8::internal::Handle<v8::internal::Name>, v8::internal::Handle<v8::internal::Object>) */

PropertyCallbackArguments * __thiscall
v8::internal::PropertyCallbackArguments::CallNamedSetter
...

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    ...
    RuntimeCallStats::Enter(local_a0,(ulong)&local_a0 | 8,0xa2);
  }
    ...
    *(long **)(lVar7 + 0x2c58) = &local_b8;
    ...
    if ((uVar6 & 1) != 0) {
      Logger::ApiNamedPropertyAccess
                (this_00,"interceptor-named-set",*(undefined8 *)(this + 0x20),*param_3);
    }
