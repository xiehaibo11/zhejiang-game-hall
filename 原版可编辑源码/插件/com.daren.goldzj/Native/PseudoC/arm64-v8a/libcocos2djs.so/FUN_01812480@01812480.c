...
void FUN_01812480(long param_1,__shared_count *param_2)

{
  ...
  if (std::__ndk1::ctype<wchar_t>::id != -1) {
    ...
    std::__ndk1::__call_once((ulong *)&std::__ndk1::ctype<wchar_t>::id,&local_58,FUN_01828620);
  }
  uVar2 = (ulong)DAT_01d52e10;
  uVar7 = uVar2 - 1;
