...
/* v8::internal::CircularStructureMessageBuilder::AppendClosingLine(v8::internal::Handle<v8::internal::Object>)
    */
    ...
    *(undefined1 *)(lVar5 + iVar3 + 0xb) = 0x20;
    ...
    do {
      ...
      *(ushort *)(lVar4 + (long)iVar3 * 2 + 0xb) = uVar2;
      ...
      uVar2 = (ushort)(byte)(&UNK_019cca18)[lVar5];
      lVar5 = lVar5 + 1;
    } while (lVar5 != 10);
  }
  ...
  if (*(int *)(this + 8) == 0) {
    ...
    do {
      ...
      *(ushort *)(lVar4 + (long)iVar3 * 2 + 0xb) = uVar2;
      ...
      uVar2 = (ushort)(byte)" closes the circle"[lVar5];
      lVar5 = lVar5 + 1;
    } while (lVar5 != 0x13);
  }
  return;
