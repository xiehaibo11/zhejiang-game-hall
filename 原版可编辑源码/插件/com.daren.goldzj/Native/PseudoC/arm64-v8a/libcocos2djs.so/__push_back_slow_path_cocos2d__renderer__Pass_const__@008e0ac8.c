...
/* void std::__ndk1::vector<cocos2d::renderer::Pass*,
   std::__ndk1::allocator<cocos2d::renderer::Pass*>
   >::__push_back_slow_path<cocos2d::renderer::Pass* const&>(cocos2d::renderer::Pass* const&) */
