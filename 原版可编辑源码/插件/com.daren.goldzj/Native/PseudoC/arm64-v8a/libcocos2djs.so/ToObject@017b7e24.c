...
/* v8::internal::interpreter::BytecodeArrayBuilder::ToObject(v8::internal::interpreter::Register) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::ToObject(BytecodeArrayBuilder *this,int param_2)
