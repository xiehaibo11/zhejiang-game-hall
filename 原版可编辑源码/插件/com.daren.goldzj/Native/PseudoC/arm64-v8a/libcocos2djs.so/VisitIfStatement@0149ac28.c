...
/* v8::internal::CallPrinter::VisitIfStatement(v8::internal::IfStatement*) */

void __thiscall v8::internal::CallPrinter::VisitIfStatement(CallPrinter *this,IfStatement *param_1)
