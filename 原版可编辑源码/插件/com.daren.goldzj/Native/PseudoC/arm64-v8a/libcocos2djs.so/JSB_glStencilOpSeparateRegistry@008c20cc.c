...
/* JSB_glStencilOpSeparateRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glStencilOpSeparateRegistry(FunctionCallbackInfo *param_1)
