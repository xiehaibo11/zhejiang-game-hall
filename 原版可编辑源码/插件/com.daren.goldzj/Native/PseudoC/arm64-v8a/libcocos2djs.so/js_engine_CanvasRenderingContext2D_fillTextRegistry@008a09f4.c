...
/* js_engine_CanvasRenderingContext2D_fillTextRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_engine_CanvasRenderingContext2D_fillTextRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (CanvasRenderingContext2D *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x615,"js_engine_CanvasRenderingContext2D_fillText");
    __android_log_print(6,"jswrapper",
                        "js_engine_CanvasRenderingContext2D_fillText : Invalid Native Object");
  }
  else {
    ...
    if (lVar10 == 4) {
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                          ,0x62d,"js_engine_CanvasRenderingContext2D_fillText");
      __android_log_print(6,"jswrapper",
                          "js_engine_CanvasRenderingContext2D_fillText : Error processing arguments"
                         );
LAB_008a0d64:
      bVar11 = false;
    }
      ...
      if (lVar10 != 3) {
        __android_log_print(6,"jswrapper",
                            "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 1585): wrong number of arguments: %d, was expecting %d\n"
      ...
      if ((uVar3 & uVar4 & uVar5 & 1) == 0) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                            ,0x620,"js_engine_CanvasRenderingContext2D_fillText");
        __android_log_print(6,"jswrapper",
                            "js_engine_CanvasRenderingContext2D_fillText : Error processing arguments"
                           );
        goto LAB_008a0d64;
...
LAB_008a0be8:
    ...
    if (bVar11) goto LAB_008a0c50;
  }
LAB_008a0c24:
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_CanvasRenderingContext2D_fillText",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x634);
LAB_008a0c50:
