...
/* js_renderer_AssemblerBase_setUseModelRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_AssemblerBase_setUseModelRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x38d,"js_renderer_AssemblerBase_setUseModel");
    __android_log_print(6,"jswrapper",
                        "js_renderer_AssemblerBase_setUseModel : Invalid Native Object");
  }
  else {
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        *(bool *)(lVar4 + 0x28) = local_64[0];
        goto LAB_0093b5d4;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0x394,"js_renderer_AssemblerBase_setUseModel");
      __android_log_print(6,"jswrapper",
                          "js_renderer_AssemblerBase_setUseModel : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 920): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar7 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_AssemblerBase_setUseModel",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0x39b);
LAB_0093b5d4:
