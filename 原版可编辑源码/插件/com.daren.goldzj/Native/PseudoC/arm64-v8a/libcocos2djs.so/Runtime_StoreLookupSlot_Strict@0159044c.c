...
/* v8::internal::Runtime_StoreLookupSlot_Strict(int, unsigned long*, v8::internal::Isolate*) */

undefined8 v8::internal::Runtime_StoreLookupSlot_Strict(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar8 = FUN_01590598(param_1,param_2,param_3);
    return uVar8;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar7 & 1) != 0) &&
    ...
    pIVar6 = (Isolate *)FUN_0159213c(param_3,puVar5,param_2,param_2 + -1,1,3);
