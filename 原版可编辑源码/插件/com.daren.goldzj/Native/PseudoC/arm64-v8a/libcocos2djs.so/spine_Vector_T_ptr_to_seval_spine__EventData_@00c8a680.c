...
/* bool spine_Vector_T_ptr_to_seval<spine::EventData>(spine::Vector<spine::EventData*> const&,
   se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::EventData>(Vector *param_1,Value *param_2)
...
LAB_00c8a748:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::EventData>
