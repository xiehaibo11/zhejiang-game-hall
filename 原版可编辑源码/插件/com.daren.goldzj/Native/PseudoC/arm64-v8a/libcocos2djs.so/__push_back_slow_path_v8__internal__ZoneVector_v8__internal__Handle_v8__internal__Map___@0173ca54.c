...
/* void std::__ndk1::vector<v8::internal::ZoneVector<v8::internal::Handle<v8::internal::Map> >,
   v8::internal::ZoneAllocator<v8::internal::ZoneVector<v8::internal::Handle<v8::internal::Map> > >
