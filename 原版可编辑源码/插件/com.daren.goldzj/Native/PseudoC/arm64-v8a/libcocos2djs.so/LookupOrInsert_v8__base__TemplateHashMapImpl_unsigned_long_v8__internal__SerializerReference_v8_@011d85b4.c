...
/* v8::base::TemplateHashMapEntry<unsigned long, v8::internal::SerializerReference>*
   ...
   v8::internal::SerializerReference, v8::base::KeyEqualityMatcher<long>,
   ...
   v8::base::TemplateHashMapImpl<unsigned long, v8::internal::SerializerReference,
   v8::base::KeyEqualityMatcher<long>, v8::base::DefaultAllocationPolicy>::LookupOrInsert(unsigned
   long const&, unsigned int, v8::base::DefaultAllocationPolicy)::{lambda()#1} const&,
...

{
  ...
  if ((pTVar2[0x14] != (TemplateHashMapEntry)0x0) && (*param_2 != *(long *)(lVar3 + uVar4 * 0x18)))
  {
    do {
  ...
  if (pTVar2[0x14] == (TemplateHashMapEntry)0x0) {
    lVar3 = *param_2;
    *(uint *)(pTVar2 + 0x10) = param_3;
    *(long *)pTVar2 = lVar3;
    *(undefined8 *)(pTVar2 + 8) = 6;
    pTVar2[0x14] = (TemplateHashMapEntry)0x1;
