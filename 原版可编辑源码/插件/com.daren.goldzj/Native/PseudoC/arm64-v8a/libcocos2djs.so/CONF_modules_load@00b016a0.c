    ...
    if (pcVar5 == (char *)0x0) {
      ...
      if (0 < iVar2) {
        ...
        do {
          ...
          iVar3 = OPENSSL_sk_num(DAT_01d390a0);
          if (iVar3 < 1) {
            lVar7 = 0;
            if ((uVar12 >> 3 & 1) != 0) goto LAB_00b01858;
LAB_00b017c4:
            if (lVar7 != 0) goto LAB_00b01858;
...
LAB_00b018e8:
            ...
            lVar7 = FUN_00b01ea8(dso,pcVar5,pDVar10,pDVar11);
            if (lVar7 == 0) {
              iVar13 = 0;
              goto LAB_00b018e8;
            }
...
LAB_00b019dc:
            ...
            bVar1 = false;
LAB_00b0196c:
            if ((DAT_01d390a8 == 0) && (DAT_01d390a8 = OPENSSL_sk_new_null(), DAT_01d390a8 == 0)) {
              iVar13 = 0x13d;
LAB_00b019d0:
              ERR_put_error(0xe,0x73,0x41,"crypto/conf/conf_mod.c",iVar13);
              goto LAB_00b019dc;
            }
            iVar13 = OPENSSL_sk_push(DAT_01d390a8,ptr);
            if (iVar13 == 0) {
              iVar13 = 0x143;
              goto LAB_00b019d0;
            }
            *(int *)(lVar7 + 0x20) = *(int *)(lVar7 + 0x20) + 1;
            ...
            iVar3 = 0;
            do {
              lVar7 = OPENSSL_sk_value(DAT_01d390a0,iVar3);
              iVar4 = strncmp(*(char **)(lVar7 + 8),pcVar5,(long)iVar13);
              if (iVar4 == 0) goto LAB_00b017c0;
              iVar3 = iVar3 + 1;
              iVar4 = OPENSSL_sk_num(DAT_01d390a0);
            } while (iVar3 < iVar4);
            lVar7 = 0;
LAB_00b017c0:
            if ((uVar12 >> 3 & 1) == 0) goto LAB_00b017c4;
LAB_00b01858:
            if (lVar7 != 0) goto LAB_00b0185c;
LAB_00b0192c:
            if ((uVar12 >> 2 & 1) == 0) {
