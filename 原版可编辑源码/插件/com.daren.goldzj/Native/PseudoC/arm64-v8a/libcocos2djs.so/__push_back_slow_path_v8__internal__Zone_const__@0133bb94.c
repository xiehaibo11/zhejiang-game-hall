...
/* void std::__ndk1::vector<v8::internal::Zone*, std::__ndk1::allocator<v8::internal::Zone*>
   >::__push_back_slow_path<v8::internal::Zone* const&>(v8::internal::Zone* const&) */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_0133bc7c;
