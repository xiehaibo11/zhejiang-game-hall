...
undefined8 FUN_00a23be4(long param_1,long param_2)

{
  ...
  do {
    ...
    (*(code *)PTR_free_01d1b748)(*(undefined8 *)((long)__s + lVar4));
    *(undefined8 *)((long)__s + lVar4) = 0;
    if (lVar2 != 0) {
      lVar2 = (*(code *)PTR_strdup_01d1b758)(lVar2);
      if (lVar2 == 0) goto LAB_00a23cb8;
  ...
  if (*(long *)(param_2 + 0x2a0) != 0) {
    ...
    if (lVar2 == 0) {
      ...
      uVar1 = FUN_00a16d14();
      lVar2 = FUN_00a37958(lVar2,uVar1);
