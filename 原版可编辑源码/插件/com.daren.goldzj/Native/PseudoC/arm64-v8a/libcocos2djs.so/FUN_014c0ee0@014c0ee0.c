...
undefined8 FUN_014c0ee0(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar9 & 1) == 0) ||
    ...
    local_e8 = __strlen_chk("Date.prototype.toTimeString",0x1c);
    local_f0 = "Date.prototype.toTimeString";
    ...
    FUN_014c21c8(&local_f0,dVar11,*(undefined8 *)(param_3 + 0xb638),1);
