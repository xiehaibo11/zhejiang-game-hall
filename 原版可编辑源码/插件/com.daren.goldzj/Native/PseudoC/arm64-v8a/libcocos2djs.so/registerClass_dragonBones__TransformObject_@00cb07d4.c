...
/* void JSBClassType::registerClass<dragonBones::TransformObject>(se::Class*) */

void JSBClassType::registerClass<dragonBones::TransformObject>(Class *param_1)
