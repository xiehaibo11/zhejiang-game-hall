...
/* cocos2d::MathUtil::multiplyMatrix(float const*, float, float*) */
...

{
  ...
  float fVar17;
                    ...
                    /* try { // try from 0099962c to 00a99643 has its CatchHandler @ 00999904 */
  lVar1 = tpidr_el0;
  lVar2 = *(long *)(lVar1 + 0x28);
                    /* try { // try from 0099964c to 00a99657 has its CatchHandler @ 00999900 */
                    /* try { // try from 00999658 to 00a99663 has its CatchHandler @ 009998fc */
  fVar6 = param_1[1];
  fVar10 = param_1[2];
  fVar14 = param_1[3];
  fVar3 = param_1[4];
  ...
  fVar13 = param_1[0xe];
  fVar17 = param_1[0xf];
                    /* try { // try from 00999664 to 00a9967b has its CatchHandler @ 00999914 */
