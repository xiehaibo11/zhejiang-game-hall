...
void FUN_0090b3f8(FunctionCallbackInfo *param_1)

{
  ...
  FUN_0090cfa0(aSStack_60,&DAT_018688b4,0);
  this = (Object *)se::Value::toObject((Value *)&DAT_01d371d0);
  pvVar4 = (vector *)se::State::args(aSStack_60);
  pOVar5 = (Object *)se::State::thisObject(aSStack_60);
  se::Object::call(this,pvVar4,pOVar5,(Value *)0x0);
