...
/* v8::internal::Factory::NewManyClosuresCell(v8::internal::Handle<v8::internal::HeapObject>) */

ulong * __thiscall v8::internal::Factory::NewManyClosuresCell(Factory *this,ulong *param_2)
