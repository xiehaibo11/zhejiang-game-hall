...
void FUN_00da1a20(long *param_1)
    ...
    *(code **)(lVar10 + 8) = pcVar2;
    if (0 < (int)param_1[0x38]) {
      ...
      do {
        ...
        FUN_00da2b14(param_1,1,lVar14,lVar10 + lVar14 * 8 + 0x70);
        if ((int)param_1[0x47] != 0) {
          lVar14 = (long)*(int *)(lVar7 + 0x18);
          FUN_00da2b14(param_1,0,lVar14,lVar10 + lVar14 * 8 + 0x90);
        }
        ...
        *(undefined8 *)(lVar14 + -0x50) =
        ...
        if (*(int *)(lVar7 + 0x34) == 0) {
          ...
          default:
            ...
            puVar13 = &UNK_01950430 + lVar14 * 0x20;
            break;
          case 3:
            lVar14 = (long)(int)(iVar3 - 1U);
            lVar7 = (long)(int)(iVar6 - 1U);
          ...
          case 8:
            ...
            puVar13 = &UNK_01950214 + lVar14 * 0xc;
            break;
          case 0xf:
            lVar14 = 3;
            if (iVar3 - 1U < 4) {
            ...
            puVar13 = &DAT_01950238 + lVar14 * 0x10;
            break;
          case 0x18:
            lVar14 = 4;
            if (iVar3 - 1U < 5) {
            ...
            puVar13 = &UNK_01950278 + lVar14 * 0x14;
            break;
          case 0x23:
            lVar14 = 5;
            if (iVar3 - 1U < 6) {
            ...
            puVar13 = &UNK_019502dc + lVar14 * 0x18;
            break;
          case 0x30:
            lVar14 = 6;
            if (iVar3 - 1U < 7) {
            ...
            puVar13 = &UNK_0195036c + lVar14 * 0x1c;
          }
          iVar12 = *(int *)(puVar13 + lVar7 * 4) + 1;
        }
switchD_00da1c28_caseD_0:
...
LAB_00da1a78:
    if (*(int *)((long)param_1 + 0x224) == 0) {
      ...
      if (iVar6 != (int)param_1[0x45]) goto LAB_00da1d6c;
    }
    if (0xd < iVar6) goto LAB_00da1d6c;
  }
    ...
    while( true ) {
      if (iVar6 == 0) {
        if (*(int *)((long)param_1 + 0x224) == 0) {
          ...
          FUN_00da2b14(param_1,1,lVar14,lVar10 + lVar14 * 8 + 0x48);
        }
      }
      else {
        lVar7 = (long)*(int *)(param_1[lVar11 + 0x39] + 0x18);
        lVar14 = lVar10 + lVar7 * 8;
        FUN_00da2b14(param_1,0,lVar7,lVar14 + 0x48);
