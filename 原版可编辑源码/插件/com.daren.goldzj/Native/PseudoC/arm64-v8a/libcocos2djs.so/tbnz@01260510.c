...
/* v8::internal::Assembler::tbnz(v8::internal::Register const&, unsigned int, int) */

void __thiscall
v8::internal::Assembler::tbnz(Assembler *this,Register *param_1,uint param_2,int param_3)
