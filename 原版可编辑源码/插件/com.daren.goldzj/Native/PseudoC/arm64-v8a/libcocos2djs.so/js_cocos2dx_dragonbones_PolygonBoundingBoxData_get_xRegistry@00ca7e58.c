...
/* js_cocos2dx_dragonbones_PolygonBoundingBoxData_get_xRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_PolygonBoundingBoxData_get_xRegistry
...

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xb49,"js_cocos2dx_dragonbones_PolygonBoundingBoxData_get_x");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_PolygonBoundingBoxData_get_x : Invalid Native Object"
                       );
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_dragonbones_PolygonBoundingBoxData_get_x",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0xb51);
  }
  else {
