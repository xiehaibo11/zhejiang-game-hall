...
/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<v8::internal::compiler::RpoNumber,
   ...
   std::__ndk1::tuple<v8::internal::compiler::RpoNumber&&>, std::__ndk1::tuple<>
   >(v8::internal::compiler::RpoNumber const&, std::__ndk1::piecewise_construct_t const&,
   std::__ndk1::tuple<v8::internal::compiler::RpoNumber&&>&&, std::__ndk1::tuple<>&&) */
