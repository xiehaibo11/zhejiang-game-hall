...
void FUN_00d96f60(long *param_1,byte *param_2,uint param_3)

{
  ...
  *(long *)(lVar10 + 0x20) = lVar9;
  if (bVar1 >> 7 == param_3) {
    ...
    uVar4 = uVar4 >> 8;
    if (lVar7 <= lVar9) goto LAB_00d96fd8;
  }
  else if (lVar9 < lVar7) goto LAB_00d96fd8;
