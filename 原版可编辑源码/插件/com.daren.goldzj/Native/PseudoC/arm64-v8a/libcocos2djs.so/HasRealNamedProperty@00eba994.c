...
/* v8::Object::HasRealNamedProperty(v8::Local<v8::Context>, v8::Local<v8::Name>) */

ushort __thiscall v8::Object::HasRealNamedProperty(Object *this,long param_2,undefined8 param_3)
  ...
  if ((*(int *)(pIVar8 + 0x2c20) == *(int *)(pIVar8 + 0xa8)) ||
    ...
    *(int *)pIVar12 = *(int *)pIVar12 + 1;
    ...
    if (internal::TracingFlags::runtime_stats != 0) {
      ...
      internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x3a4);
    }
    this_00 = *(Logger **)(pIVar8 + 0x9558);
    uVar4 = internal::Logger::is_logging(this_00);
    if ((uVar4 & 1) != 0) {
      internal::Logger::ApiEntryCall(this_00,"v8::Object::HasRealNamedProperty");
    }
    ...
    *(undefined4 *)(pIVar8 + 0x2c60) = 5;
         ...
         ((*(ulong *)this & 0xffffffff00000000 | 7) + (ulong)*(uint *)(*(ulong *)this - 1)) < 0xaa)
    {
      ...
      uVar3 = internal::JSObject::HasRealNamedProperty(this,param_3);
      if ((uVar3 & 0xff) == 0) {
        local_a0 = '\x01';
