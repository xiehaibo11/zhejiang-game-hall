...
void __thiscall
v8::internal::compiler::JSGenericLowering::LowerJSBitwiseXor(JSGenericLowering *this,Node *param_1)

{
  ...
  Builtins::CallableFor((Builtins *)local_58,*(undefined8 *)(*(long *)(this + 0x10) + 0x168),0x19a);
