...
/* v8::internal::compiler::EffectControlLinearizer::LowerTruncateTaggedToFloat64(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerTruncateTaggedToFloat64
...

{
  ...
  pNVar2 = (Node *)GraphAssembler::ChangeInt32ToFloat64(this_00,pNVar2);
