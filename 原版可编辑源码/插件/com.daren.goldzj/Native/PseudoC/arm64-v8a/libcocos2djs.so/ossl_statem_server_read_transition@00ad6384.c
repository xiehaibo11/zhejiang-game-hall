...
LAB_00ad641c:
    ...
    break;
  case 0x1b:
    if (param_2 == 0x10) goto LAB_00ad641c;
    break;
  case 0x1c:
    if ((*(long *)(*(long *)(param_1 + 0x5e) + 0x98) == 0) || (param_1[0x1b] != 0))
    goto switchD_00ad63a8_caseD_1d;
    if (param_2 == 0xf) {
      iVar1 = 0x1d;
      goto LAB_00ad6494;
    }
...
switchD_00ad63a8_caseD_1e:
    ...
    break;
  case 0x1f:
    if (*(int *)(*(long *)(param_1 + 0x24) + 0x3c8) == 0) goto switchD_00ad63a8_caseD_1e;
    if (param_2 == 0x43) {
      iVar1 = 0x1e;
      goto LAB_00ad6494;
    }
