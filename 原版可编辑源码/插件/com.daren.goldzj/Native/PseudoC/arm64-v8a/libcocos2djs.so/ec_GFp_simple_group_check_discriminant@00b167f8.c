...
LAB_00b16900:
    ...
    if ((pBVar3 == (BIGNUM *)0x0) ||
       (pBVar3 = BN_copy(a_00,(BIGNUM *)param_1[0xd]), pBVar3 == (BIGNUM *)0x0)) goto LAB_00b16900;
LAB_00b168e4:
    iVar1 = BN_is_zero(a);
      ...
      if (iVar2 == 0) {
        ...
        if ((((iVar1 == 0) || (iVar1 = BN_mod_mul(r_00,r,a,m,param_2), iVar1 == 0)) ||
           ...
           (((iVar1 = BN_mod_sqr(r_00,a_00,m,param_2), iVar1 == 0 ||
            ...
            (iVar1 = BN_mod_add(a,r,r_00,m,param_2), iVar1 == 0)))) goto LAB_00b16900;
        iVar2 = BN_is_zero(a);
        goto joined_r0x00b169f4;
      }
    }
    else {
joined_r0x00b169f4:
      if (iVar2 != 0) goto LAB_00b16900;
    }
    uVar4 = 1;
  }
  BN_CTX_end(param_2);
