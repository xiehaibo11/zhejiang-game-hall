...
/* v8::internal::compiler::InstructionSelector::VisitBitcastTaggedToWord(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::InstructionSelector::VisitBitcastTaggedToWord
