...
/* v8::internal::ModifyCodeGenerationFromStrings(v8::internal::Isolate*,
   v8::internal::Handle<v8::internal::Context>, v8::internal::Handle<v8::internal::Object>*) */

bool v8::internal::ModifyCodeGenerationFromStrings(long param_1,undefined8 param_2,long *param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x2c60) = 6;
  ...
  auVar3 = (*pcVar2)(param_2,*param_3);
  if ((auVar3._8_8_ != 0) && ((auVar3._0_8_ & 0xff) != 0)) {
    *param_3 = auVar3._8_8_;
  }
