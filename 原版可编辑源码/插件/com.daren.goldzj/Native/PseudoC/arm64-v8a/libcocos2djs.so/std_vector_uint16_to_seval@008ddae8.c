...
/* std_vector_uint16_to_seval(std::__ndk1::vector<unsigned short, std::__ndk1::allocator<unsigned
   short> > const&, se::Value*) */

undefined4 std_vector_uint16_to_seval(vector *param_1,Value *param_2)

{
  ...
  pOVar3 = (Object *)se::Object::createArrayObject(*(long *)(param_1 + 8) - *(long *)param_1 >> 1);
  ...
  if (puVar7 != puVar1) {
    ...
    do {
      pOVar3 = local_60;
      se::Value::Value(aVStack_58,*puVar7);
