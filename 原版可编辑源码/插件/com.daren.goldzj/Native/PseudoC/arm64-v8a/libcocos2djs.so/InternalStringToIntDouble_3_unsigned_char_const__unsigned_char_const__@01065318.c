...
/* double v8::internal::InternalStringToIntDouble<3, unsigned char const*, unsigned char
   const*>(unsigned char const*, unsigned char const*, bool, bool) */

double v8::internal::InternalStringToIntDouble<3,unsigned_char_const*,unsigned_char_const*>
...
joined_r0x010653c4:
    if ((param_1 != param_2) && (uVar5 = (uint)uVar6, !param_4)) {
      pbVar8 = param_1 + 1;
      if ((char)uVar6 < '\0') goto LAB_01065400;
      do {
        pbVar7 = pbVar8;
        ...
        while( true ) {
          if (param_2 == pbVar7) goto LAB_01065424;
          pbVar8 = pbVar7 + 1;
          bVar1 = *pbVar7;
          uVar6 = (ulong)bVar1;
          uVar5 = (uint)bVar1;
...
LAB_01065424:
  ...
  while( true ) {
    ...
    if (iVar4 != 0) break;
    param_1 = param_1 + 1;
    if (param_1 == param_2) goto LAB_01065424;
    uVar6 = (ulong)*param_1;
    lVar3 = lVar3 + -1;
    if ((*param_1 & 0xf8) != 0x30) goto joined_r0x010653c4;
  }
  uVar12 = 1;
  if (1 < iVar4) {
    do {
