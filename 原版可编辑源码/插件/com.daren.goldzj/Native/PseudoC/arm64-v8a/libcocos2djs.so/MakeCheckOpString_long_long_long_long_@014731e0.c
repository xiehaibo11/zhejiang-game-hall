...
/* std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >*
   v8::base::MakeCheckOpString<long long, long long>(long long, long long, char const*) */

basic_string *
v8::base::MakeCheckOpString<long_long,long_long>(longlong param_1,longlong param_2,char *param_3)
