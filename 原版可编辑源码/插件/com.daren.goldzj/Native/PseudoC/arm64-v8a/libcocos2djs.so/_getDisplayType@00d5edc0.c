...

{
  ...
  if (((byte)*param_1 & 1) == 0) {
    ...
    uVar4 = local_60 & 0xff;
    if ((local_60 & 1) == 0) goto LAB_00d5ee0c;
LAB_00d5ee90:
    plVar7 = (long *)((long)local_50 + uStack_58);
    plVar5 = local_50;
    if (local_50 == plVar7) goto LAB_00d5eeb8;
  }
  else {
...
LAB_00d5ee74:
    ...
    *(undefined1 *)((long)plVar7 + uVar4) = 0;
    uVar4 = local_60 & 0xff;
    if ((local_60 & 1) != 0) goto LAB_00d5ee90;
LAB_00d5ee0c:
    plVar5 = (long *)((ulong)&local_60 | 1);
    plVar7 = (long *)((long)plVar5 + (uVar4 >> 1));
    if (plVar5 == plVar7) goto LAB_00d5eeb8;
  }
  do {
