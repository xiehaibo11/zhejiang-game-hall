...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::TypedLoweringPhase>() */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::TypedLoweringPhase>
          (PipelineImpl *this)

{
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFTypedLowering");
  TypedLoweringPhase::Run(aTStack_18,pPVar5,pZVar2);
