...
/* void JSBClassType::registerClass<spine::PathConstraintPositionTimeline>(se::Class*) */

void JSBClassType::registerClass<spine::PathConstraintPositionTimeline>(Class *param_1)
