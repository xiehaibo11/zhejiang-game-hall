...
/* se::ScriptEngine::addBeforeInitHook(std::__ndk1::function<void ()> const&) */

void __thiscall se::ScriptEngine::addBeforeInitHook(ScriptEngine *this,function *param_1)

{
  ...
  if (lVar1 != *(long *)(this + 0x30)) {
    ...
    *(long *)(this + 0x28) = *(long *)(this + 0x28) + 0x30;
    return;
  }
  std::__ndk1::
