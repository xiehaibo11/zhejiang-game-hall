...
LAB_00b1244c:
    ...
    ret = BN_new();
    if (ret == (BIGNUM *)0x0) goto LAB_00b1244c;
...
LAB_00b12648:
      ...
      if ((param_3 == (BIGNUM *)0x0) || (param_4 == (BIGNUM *)0x0)) {
        do {
          iVar1 = FUN_00b11cec(param_5,ctx,&local_68,sig,param_1,param_2);
          pBVar5 = local_68;
          if (iVar1 == 0) {
          ...
          if (iVar1 == 0) goto LAB_00b126d8;
          iVar1 = BN_mod_add_quick(pBVar4,r,ret,a_00);
          if (iVar1 == 0) goto LAB_00b12700;
          iVar1 = BN_mod_mul(pBVar4,pBVar4,pBVar5,a_00,ctx);
          if (iVar1 == 0) goto LAB_00b12728;
          iVar1 = BN_is_zero(pBVar4);
          if (iVar1 == 0) goto LAB_00b1247c;
...
LAB_00b12590:
        ...
        if (param_3 == (BIGNUM *)0x0 || param_4 == (BIGNUM *)0x0) {
          do {
            ...
            if (pBVar5 == (BIGNUM *)0x0) goto LAB_00b1265c;
            iVar1 = BN_mod_mul(r,a,sig->r,a_00,ctx);
            if (iVar1 == 0) {
              pBVar5 = (BIGNUM *)0x0;
              goto LAB_00b126d8;
            ...
            iVar1 = BN_mod_add_quick(pBVar4,r,ret,a_00);
            if (iVar1 == 0) goto LAB_00b126fc;
            iVar1 = BN_mod_mul(pBVar4,pBVar4,param_3,a_00,ctx);
            if (iVar1 == 0) goto LAB_00b12724;
            iVar1 = BN_is_zero(pBVar4);
          } while (iVar1 != 0);
          pBVar5 = (BIGNUM *)0x0;
          goto LAB_00b1247c;
