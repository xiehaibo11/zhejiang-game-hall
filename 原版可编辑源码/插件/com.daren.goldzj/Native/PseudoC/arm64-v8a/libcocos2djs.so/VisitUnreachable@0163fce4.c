...
/* v8::internal::compiler::InstructionSelector::VisitUnreachable(v8::internal::compiler::Node*) */

void v8::internal::compiler::InstructionSelector::VisitUnreachable(Node *param_1)

{
  ...
  Instruction::Instruction
            (this_00,0x13,0,(InstructionOperand *)&local_28,0,(InstructionOperand *)0x0,0,
