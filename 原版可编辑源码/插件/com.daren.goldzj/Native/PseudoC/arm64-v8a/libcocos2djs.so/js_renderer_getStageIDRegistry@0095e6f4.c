...
/* js_renderer_getStageIDRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_getStageIDRegistry(FunctionCallbackInfo *param_1)
  ...
  if (plVar6[1] - *plVar6 == 0x10) {
    ...
    if (bVar1) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0x11f,"js_renderer_getStageID");
      __android_log_print(6,"jswrapper","Convert arg0 failed!");
    }
    else {
      iVar4 = cocos2d::renderer::Config::getStageID((basic_string *)&local_78);
      pVVar8 = (Value *)se::State::rval(aSStack_60);
      int32_to_seval(iVar4,pVVar8);
    }
    if ((local_78 & 1) != 0) {
      operator_delete(local_68);
    }
    if (!bVar1) goto LAB_0095e88c;
  }
  else {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp, 292): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar6[1] - *plVar6) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_getStageID",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp"
                      ,0x127);
LAB_0095e88c:
  pVVar8 = (Value *)se::State::rval(aSStack_60);
