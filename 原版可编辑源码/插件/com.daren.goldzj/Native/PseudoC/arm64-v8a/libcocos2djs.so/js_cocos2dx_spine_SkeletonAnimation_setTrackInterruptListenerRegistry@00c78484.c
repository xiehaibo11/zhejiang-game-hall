...
/* js_cocos2dx_spine_SkeletonAnimation_setTrackInterruptListenerRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonAnimation_setTrackInterruptListenerRegistry
...

{
  ...
  if (this == (SkeletonAnimation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x37a1,"js_cocos2dx_spine_SkeletonAnimation_setTrackInterruptListener");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonAnimation_setTrackInterruptListener : Invalid Native Object"
                       );
  }
  else {
    ...
    if (plVar5[1] - (long)pVVar10 == 0x20) {
      ...
      if (pVVar10[0x18] == (Value)0x5) {
        ...
        if ((uVar8 & 1) == 0) goto LAB_00c786f8;
...
LAB_00c78720:
        ...
        if (!bVar3) goto LAB_00c78700;
LAB_00c78758:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                            ,0x37c7,"js_cocos2dx_spine_SkeletonAnimation_setTrackInterruptListener")
        ;
        __android_log_print(6,"jswrapper",
                            "js_cocos2dx_spine_SkeletonAnimation_setTrackInterruptListener : Error processing arguments"
                           );
        bVar3 = false;
      }
      else {
LAB_00c786f8:
        local_b0 = (long *)0x0;
        if (bVar3) goto LAB_00c78758;
LAB_00c78700:
        spine::SkeletonAnimation::setTrackInterruptListener(this,pTVar7,(function *)alStack_d0);
        bVar3 = true;
      }
...
LAB_00c787c8:
      ...
      if (bVar3) goto LAB_00c787fc;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 14283): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar5[1] - (long)pVVar10) >> 4,2);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonAnimation_setTrackInterruptListener",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x37ce);
LAB_00c787fc:
