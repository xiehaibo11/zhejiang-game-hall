...
ulong FUN_013551ec(long param_1,ulong param_2,ulong param_3,undefined8 param_4,undefined8 param_5,
...

{
  ...
  *(int *)(param_3 + 7) = (int)in_x11;
  ...
  if (*(int *)(in_x11 - 1) == (int)*(undefined8 *)(unaff_x26 + 0xe8)) {
    ...
    uVar8 = (ulong)iVar2;
    if (0x7ffd < uVar8) {
      uVar4 = FUN_01355a60(param_2,param_3,param_4);
      return uVar4;
    }
  ...
  pcVar3 = (code *)SoftwareBreakpoint(0,0x1356624);
  (*pcVar3)();
}
