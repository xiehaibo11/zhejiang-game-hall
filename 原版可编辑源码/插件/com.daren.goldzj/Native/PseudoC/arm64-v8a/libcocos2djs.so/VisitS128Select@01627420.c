...
/* v8::internal::compiler::InstructionSelector::VisitS128Select(v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::InstructionSelector::VisitS128Select
...

{
  ...
  Emit(this,0x191,(uVar1 & 0xffffffff) << 3 | 0xf800000001,(uVar2 & 0xffffffff) << 3 | 0x5800000001,
