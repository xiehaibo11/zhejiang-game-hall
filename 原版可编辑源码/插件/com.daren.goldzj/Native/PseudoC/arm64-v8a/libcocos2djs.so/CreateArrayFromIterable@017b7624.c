...
/* v8::internal::interpreter::BytecodeArrayBuilder::CreateArrayFromIterable() */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::CreateArrayFromIterable(BytecodeArrayBuilder *this)
