...
/* js_register_universe_CMD5Checksum(se::Object*) */

undefined8 js_register_universe_CMD5Checksum(Object *param_1)

{
  ...
  se::Class::defineStaticFunction(this,"sign",js_universe_CMD5Checksum_GetMD5OfStringRegistry);
  se::Class::defineFinalizeFunction(this,js_universe_utils_CMD5Checksum_finalizeRegistry);
  se::Class::install(this);
  local_48 = SUB81(this,0);
  uStack_47 = (undefined7)((ulong)this >> 8);
  local_30 = (Class *)0x18830c8;
  std::__ndk1::
  ...
  __jsb_universe_utils_CMD5Checksum_proto = se::Class::getProto(this);
  __jsb_universe_utils_CMD5Checksum_class = this;
