...
/* js_cocos2dx_spine_SkeletonCacheAnimation_setSkinRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonCacheAnimation_setSkinRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonCacheAnimation *)0x0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonCacheAnimation_setSkin : Invalid Native Object");
  }
  else {
    ...
    if (lVar3 - lVar2 == 0x10) {
      ...
      if ((uVar9 & 1) == 0) {
        ...
        spine::SkeletonCacheAnimation::setSkin(this,pcVar1);
        bVar5 = false;
      }
      if ((local_88 & 1) != 0) {
        operator_delete(local_78);
      }
      if (!bVar5) goto LAB_00c83414;
      local_88 = 0;
      uStack_80 = 0;
      local_78 = (char *)0x0;
      uVar9 = seval_to_std_string((Value *)*plVar8,(basic_string *)&local_88);
      if ((uVar9 & 1) != 0) {
        spine::SkeletonCacheAnimation::setSkin(this,(basic_string *)&local_88);
        if ((local_88 & 1) != 0) {
          operator_delete(local_78);
        }
        goto LAB_00c83414;
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 16053): wrong number of arguments: %d\n"
                        ,(ulong)(lVar3 - lVar2) >> 4);
  }
