...
/* js_engine_CanvasRenderingContext2D_clearRectRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_engine_CanvasRenderingContext2D_clearRectRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (CanvasRenderingContext2D *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x5df,"js_engine_CanvasRenderingContext2D_clearRect");
    __android_log_print(6,"jswrapper",
                        "js_engine_CanvasRenderingContext2D_clearRect : Invalid Native Object");
  }
  else {
    ...
    if (uVar10 == 0x40) {
      ...
      if ((uVar3 & uVar4 & uVar5 & uVar6 & 1) != 0) {
        cocos2d::CanvasRenderingContext2D::clearRect
                  (this,local_88._4_4_,(float)local_88,local_90._4_4_,(float)local_90);
        goto LAB_008a05b0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                          ,0x5ec,"js_engine_CanvasRenderingContext2D_clearRect");
      __android_log_print(6,"jswrapper",
                          "js_engine_CanvasRenderingContext2D_clearRect : Error processing arguments"
                         );
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 1520): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar10 >> 4,4);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_CanvasRenderingContext2D_clearRect",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x5f3);
LAB_008a05b0:
