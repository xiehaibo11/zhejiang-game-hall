...
/* v8::internal::Factory::NewEnumCache(v8::internal::Handle<v8::internal::FixedArray>,
   v8::internal::Handle<v8::internal::FixedArray>) */

ulong * __thiscall v8::internal::Factory::NewEnumCache(Factory *this,ulong *param_2,ulong *param_3)

{
  ...
  puVar1 = (ulong *)NewStruct(this,0x5c,1);
  uVar4 = *puVar1;
  uVar3 = *param_2;
