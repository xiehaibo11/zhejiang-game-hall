...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitJumpIfJSReceiver() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitJumpIfJSReceiver(BytecodeGraphBuilder *this)
