...
/* v8::internal::interpreter::BytecodeArrayBuilder::GetTemplateObject(unsigned long, int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::GetTemplateObject
          (BytecodeArrayBuilder *this,ulong param_1,int param_2)
