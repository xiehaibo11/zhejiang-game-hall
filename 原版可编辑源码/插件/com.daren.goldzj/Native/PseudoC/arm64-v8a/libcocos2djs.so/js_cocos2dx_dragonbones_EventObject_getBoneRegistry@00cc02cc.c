...
/* js_cocos2dx_dragonbones_EventObject_getBoneRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_dragonbones_EventObject_getBoneRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar5 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x18b1,"js_cocos2dx_dragonbones_EventObject_getBone");
    puVar8 = &DAT_0193e522;
LAB_00cc0434:
    ...
    if (plVar6[1] - *plVar6 == 0) {
      ...
      if (bVar3) goto LAB_00cc046c;
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                          ,0x18b8,"js_cocos2dx_dragonbones_EventObject_getBone");
      puVar8 = &DAT_0193e566;
      goto LAB_00cc0434;
    }
    __android_log_print(6,"jswrapper",&DAT_0193e5af,(ulong)(plVar6[1] - *plVar6) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_EventObject_getBone",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x18be);
LAB_00cc046c:
  pVVar7 = (Value *)se::State::rval(aSStack_60);
