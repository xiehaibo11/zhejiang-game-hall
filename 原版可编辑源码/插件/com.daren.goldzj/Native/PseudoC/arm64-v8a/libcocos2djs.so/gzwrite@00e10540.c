  ...
  if ((*(int *)(param_1 + 0x18) == 0x79b1) && (*(int *)(param_1 + 0x6c) == 0)) {
    if ((int)param_3 < 0) {
      FUN_00e0f54c(param_1,0xfffffffd,"requested length does not fit in int");
            ...
            ((*(int *)(param_1 + 0x28) != 0 || (iVar5 = FUN_00e1075c(param_1), iVar5 != -1)))) {
      if (*(int *)(param_1 + 0x68) != 0) {
        lVar8 = *(long *)(param_1 + 0x60);
        *(undefined4 *)(param_1 + 0x68) = 0;
        if ((*(int *)(param_1 + 0x80) != 0) && (iVar5 = FUN_00e10844(param_1,0), iVar5 == -1)) {
          return 0;
        }
        if (lVar8 != 0) {
          bVar4 = false;
      ...
      if ((*(uint *)(param_1 + 0x80) == 0) || (iVar5 = FUN_00e10844(param_1,0), iVar5 != -1)) {
