...
/* v8::internal::Assembler::cbnz(v8::internal::Register const&, v8::internal::Label*) */

void __thiscall v8::internal::Assembler::cbnz(Assembler *this,Register *param_1,Label *param_2)
