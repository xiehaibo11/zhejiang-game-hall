...
/* std::__ndk1::__hash_table<v8::TracingController::TraceStateObserver*,
   ...
   std::__ndk1::allocator<v8::TracingController::TraceStateObserver*> >::__rehash(unsigned long) */
...
::__rehash(__hash_table<v8::TracingController::TraceStateObserver*,std::__ndk1::hash<v8::TracingController::TraceStateObserver*>,std::__ndk1::equal_to<v8::TracingController::TraceStateObserver*>,std::__ndk1::allocator<v8::TracingController::TraceStateObserver*>>
           *this,ulong param_1)
