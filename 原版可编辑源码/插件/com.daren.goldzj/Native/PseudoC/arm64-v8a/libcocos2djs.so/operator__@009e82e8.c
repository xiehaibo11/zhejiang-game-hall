...
/* std::__ndk1::__function::__func<std::__ndk1::__bind<void
   ...
   (cocos2d::network::SIOClientImpl::*)(float), cocos2d::network::SIOClientImpl*,
   std::__ndk1::placeholders::__ph<1> const&> >, void (float)>::TEMPNAMEPLACEHOLDERVALUE(float&&) */
...
::operator()(__func<std::__ndk1::__bind<void(cocos2d::network::SIOClientImpl::*)(float),cocos2d::network::SIOClientImpl*,std::__ndk1::placeholders::__ph<1>const&>,std::__ndk1::allocator<std::__ndk1::__bind<void(cocos2d::network::SIOClientImpl::*)(float),cocos2d::network::SIOClientImpl*,std::__ndk1::placeholders::__ph<1>const&>>,void(float)>
             *this,float *param_1)
    ...
    UNRECOVERED_JUMPTABLE =
         *(code **)(UNRECOVERED_JUMPTABLE +
                   *(long *)(*(long *)(this + 0x18) + ((long)*(ulong *)(this + 0x10) >> 1)));
                    ...
                    /* WARNING: Could not recover jumptable at 0x009e8304. Too many branches */
