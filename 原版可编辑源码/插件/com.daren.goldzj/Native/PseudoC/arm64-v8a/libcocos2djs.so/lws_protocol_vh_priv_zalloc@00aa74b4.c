...

{
  ...
  if (*(long *)(param_1 + 400) == 0) {
    lVar3 = FUN_00aa8a78((long)*(int *)(param_1 + 0x1dc) << 3,"protocol_vh_privs");
  ...
  if (iVar1 < 1) {
    ...
    if ((int)uVar5 != iVar1) goto LAB_00aa7594;
  }
  if (iVar1 < 1) {
    uVar5 = 0;
    if (iVar1 == 0) {
...
LAB_00aa7594:
  uVar4 = FUN_00aa8a78((long)param_3,"vh priv");
