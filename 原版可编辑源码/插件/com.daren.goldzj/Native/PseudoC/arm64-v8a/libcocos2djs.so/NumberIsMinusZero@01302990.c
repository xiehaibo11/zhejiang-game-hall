...
/* v8::internal::compiler::Typer::Visitor::NumberIsMinusZero(v8::internal::compiler::Type,
   v8::internal::compiler::Typer*) */

undefined8 v8::internal::compiler::Typer::Visitor::NumberIsMinusZero(long param_1,long param_2)
