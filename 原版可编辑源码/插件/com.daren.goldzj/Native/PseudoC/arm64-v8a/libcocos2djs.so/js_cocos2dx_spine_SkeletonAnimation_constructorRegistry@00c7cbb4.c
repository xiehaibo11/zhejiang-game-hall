...
/* js_cocos2dx_spine_SkeletonAnimation_constructorRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonAnimation_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Object *)
         se::Object::_createJSObject(__jsb_spine_SkeletonAnimation_class,*(long *)(param_1 + 8) + 8)
  ;
  se::Object::_setFinalizeCallback(this,js_spine_SkeletonAnimation_finalizeRegistry);
  se::State::State(aSStack_60,this,(vector *)&local_a0);
  this_00 = operator_new(0x1e0,(nothrow_t *)&std::nothrow);
  if (this_00 != (SkeletonAnimation *)0x0) {
    spine::SkeletonAnimation::SkeletonAnimation(this_00);
  }
