...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitJumpIfToBooleanFalse(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::VisitJumpIfToBooleanFalse
