...
void v8::ArrayBufferView::CheckCast(Value *param_1)

{
  ...
  uVar2 = *(ulong *)param_1;
  if (((uVar2 & 1) != 0) &&
     ((*(ushort *)((uVar2 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar2 - 1)) & 0xfffe) ==
      0x41a)) {
    return;
  }
  ...
  if (lVar1 != 0) {
    if (*(code **)(lVar1 + 0xb738) != (code *)0x0) {
      (**(code **)(lVar1 + 0xb738))
                ("v8::ArrayBufferView::Cast()","Could not convert to ArrayBufferView");
