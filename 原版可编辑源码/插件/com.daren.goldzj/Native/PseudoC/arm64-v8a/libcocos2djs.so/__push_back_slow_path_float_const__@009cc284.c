...
void __thiscall
std::__ndk1::vector<float*,std::__ndk1::allocator<float*>>::__push_back_slow_path<float*const&>
...

{
  ...
  ulong uVar3;
                    ...
                    /* try { // try from 009cc28c to 00acc297 has its CatchHandler @ 009cc460 */
                    /* try { // try from 009cc298 to 00acc3eb has its CatchHandler @ 009cc478 */
  __src = *(void **)this;
