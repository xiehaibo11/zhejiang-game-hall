...
/* v8::internal::HashTable<v8::internal::EphemeronHashTable,
   v8::internal::EphemeronHashTableShape>::Shrink(v8::internal::Isolate*,
   v8::internal::Handle<v8::internal::EphemeronHashTable>, int) */

ulong * v8::internal::
        HashTable<v8::internal::EphemeronHashTable,v8::internal::EphemeronHashTableShape>::Shrink
