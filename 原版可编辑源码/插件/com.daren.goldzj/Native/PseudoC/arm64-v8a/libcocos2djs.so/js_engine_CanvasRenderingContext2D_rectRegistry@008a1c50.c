...
/* js_engine_CanvasRenderingContext2D_rectRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_engine_CanvasRenderingContext2D_rectRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (CanvasRenderingContext2D *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x6a7,"js_engine_CanvasRenderingContext2D_rect");
    __android_log_print(6,"jswrapper",
                        "js_engine_CanvasRenderingContext2D_rect : Invalid Native Object");
  }
  else {
    ...
    if (uVar10 == 0x40) {
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                          ,0x6b4,"js_engine_CanvasRenderingContext2D_rect");
      __android_log_print(6,"jswrapper",
                          "js_engine_CanvasRenderingContext2D_rect : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 1720): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar10 >> 4,4);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_CanvasRenderingContext2D_rect",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x6bb);
LAB_008a1e5c:
