...
/* v8::internal::compiler::MachineOperatorBuilder::I64x2ExtractLane(int) */

Operator * __thiscall
v8::internal::compiler::MachineOperatorBuilder::I64x2ExtractLane
...

{
  ...
  Operator::Operator(pOVar1,0x228,0x7c,"Extract lane",1,0,0,1,0,0);
