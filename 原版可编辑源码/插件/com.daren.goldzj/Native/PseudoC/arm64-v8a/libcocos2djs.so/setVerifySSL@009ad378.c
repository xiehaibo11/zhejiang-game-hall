...

{
  ...
  lVar6 = *(long *)this;
  std::__ndk1::mutex::lock((mutex *)(lVar6 + 0x1a0));
  std::__ndk1::mutex::unlock((mutex *)(lVar6 + 0x1a0));
  if ((*(byte *)(lVar6 + 0x188) & 1) == 0) {
    if (*(byte *)(lVar6 + 0x188) >> 1 == 0) goto LAB_009ad4a8;
  }
  else if (*(long *)(lVar6 + 400) == 0) goto LAB_009ad4a8;
  plVar3 = (long *)FileUtils::getInstance();
  lVar6 = *(long *)this;
  this_00 = (mutex *)(lVar6 + 0x1a0);
  std::__ndk1::mutex::lock(this_00);
  std::__ndk1::mutex::unlock(this_00);
  (**(code **)(*plVar3 + 0x40))(local_60,plVar3,lVar6 + 0x188);
  ...
  if ((uVar4 & 1) != 0) {
    ...
    uVar5 = (**(code **)(*(long *)local_78 + 0x538))(local_78,pvVar1);
                    /* try { // try from 009ad464 to 00aad547 has its CatchHandler @ 009ad2a0 */
