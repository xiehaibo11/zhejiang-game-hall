...
/* void 
   v8::internal::BodyDescriptorBase::IterateMaybeWeakPointers<v8::internal::YoungGenerationMarkingVisitor>(v8::internal::HeapObject,
   int, int, v8::internal::YoungGenerationMarkingVisitor*) */

void v8::internal::BodyDescriptorBase::
     IterateMaybeWeakPointers<v8::internal::YoungGenerationMarkingVisitor>
...

{
  ...
  do {
    if ((uint *)(param_1 + -1 + (long)param_3) <= puVar1) {
      return;
    }
    uVar3 = *puVar1;
    if ((uVar3 != 3) && ((uVar3 & 1) != 0)) {
      ...
      if ((*(byte *)(uVar8 + 8) & 0x18) != 0) {
        uVar10 = (ulong)puVar1 & 0xffffffff00000000 | (ulong)uVar3 & 0xfffffffffffffffd;
        puVar2 = (uint *)(*(long *)(uVar8 + 0x108) + (uVar10 - uVar8 >> 7 & 0x1ffffff) * 4);
        while( true ) {
          uVar3 = *puVar2;
          uVar7 = (uint)(1L << (uVar10 - uVar8 >> 2 & 0x1f));
          ...
          while (*puVar2 == uVar3) {
            ...
            if (cVar4 == '\0') {
              ...
              puVar11 = (undefined8 *)(lVar13 + (long)*(int *)(param_4 + 0x10) * 0x50);
              ...
              if (lVar9 == 0x40) {
                ...
                *(ulong *)((long)pvVar6 + 0x10) = uVar10;
              }
              else {
                puVar12[1] = lVar9 + 1;
                puVar12[lVar9 + 2] = uVar10;
              }
              goto LAB_00fefdfc;
            }
          }
