...
/* std::__ndk1::__bit_iterator<std::__ndk1::vector<bool, v8::internal::ZoneAllocator<bool> >, false,
   0> std::__ndk1::__copy_aligned<std::__ndk1::vector<bool, v8::internal::ZoneAllocator<bool> >,
   true>(std::__ndk1::__bit_iterator<std::__ndk1::vector<bool, v8::internal::ZoneAllocator<bool> >,
   true, 0>, std::__ndk1::__bit_iterator<std::__ndk1::vector<bool, v8::internal::ZoneAllocator<bool>
   >, true, 0>, std::__ndk1::__bit_iterator<std::__ndk1::vector<bool,
   v8::internal::ZoneAllocator<bool> >, false, 0>) */

void std::__ndk1::__copy_aligned<std::__ndk1::vector<bool,v8::internal::ZoneAllocator<bool>>,true>
