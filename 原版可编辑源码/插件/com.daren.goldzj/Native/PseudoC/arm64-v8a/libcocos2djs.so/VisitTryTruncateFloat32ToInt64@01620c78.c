...
/* v8::internal::compiler::InstructionSelector::VisitTryTruncateFloat32ToInt64(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::InstructionSelector::VisitTryTruncateFloat32ToInt64
...

{
  ...
  Emit(this,0xd3,uVar3,(InstructionOperand *)&local_50,1,(InstructionOperand *)&local_28,0,
