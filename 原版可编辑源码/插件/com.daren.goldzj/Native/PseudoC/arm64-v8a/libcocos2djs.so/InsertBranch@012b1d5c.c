    ...
    do {
      ...
      if (puVar9 != puVar2) {
        ...
        if (3 < uVar6) {
          ...
          if (uVar6 == uVar8) goto LAB_012b1dbc;
        }
        do {
...
LAB_012b1dbc:
  ...
  *(undefined8 **)(param_1 + 0x68) = puVar13;
  ...
  BasicBlock::AddSuccessor(param_1,param_5);
  BasicBlock::AddPredecessor(param_5,param_1);
