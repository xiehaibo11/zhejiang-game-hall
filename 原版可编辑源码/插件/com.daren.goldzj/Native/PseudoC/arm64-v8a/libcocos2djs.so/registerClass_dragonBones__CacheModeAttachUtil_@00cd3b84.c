...
/* void JSBClassType::registerClass<dragonBones::CacheModeAttachUtil>(se::Class*) */

void JSBClassType::registerClass<dragonBones::CacheModeAttachUtil>(Class *param_1)
