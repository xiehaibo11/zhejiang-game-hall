...
/* void rapidjson::GenericReader<rapidjson::UTF8<char>, rapidjson::UTF8<char>,
   rapidjson::CrtAllocator>::ParseTrue<0u, rapidjson::EncodedInputStream<rapidjson::UTF8<char>,
...

{
  ...
  pcVar8 = pcVar6;
  if ((pcVar6 != pcVar10) && (*pcVar6 == 'r')) {
    pcVar8 = pcVar6 + 1;
    *plVar3 = (long)pcVar8;
    if ((pcVar8 != pcVar10) && (*pcVar8 == 'u')) {
      pcVar8 = pcVar6 + 2;
      *plVar3 = (long)pcVar8;
      if ((pcVar8 != pcVar10) && (*pcVar8 == 'e')) {
        ...
        *(undefined8 **)(param_2 + 0x40) = puVar7;
        ...
        puVar4[2] = 0;
        *puVar4 = 0;
        *(undefined2 *)((long)puVar4 + 0x16) = 10;
        return;
      }
    }
  }
