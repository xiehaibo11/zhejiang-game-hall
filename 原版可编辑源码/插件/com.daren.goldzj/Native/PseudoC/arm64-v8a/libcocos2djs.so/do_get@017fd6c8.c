...

{
  ...
  if ((*(byte *)(param_4 + 8) & 1) == 0) {
    ...
    ios_base::getloc();
    uVar2 = locale::use_facet((locale *)local_88,(id *)&ctype<wchar_t>::id);
    __shared_count::__release_shared(local_88[0]);
    ios_base::getloc();
    plVar3 = (long *)locale::use_facet((locale *)local_88,(id *)&numpunct<wchar_t>::id);
    __shared_count::__release_shared(local_88[0]);
    (**(code **)(*plVar3 + 0x30))(local_88,plVar3);
    (**(code **)(*plVar3 + 0x38))(local_70,plVar3);
    pp_Var4 = (__shared_count **)FUN_017fd8d0(&local_90,param_3,local_88,&local_58,uVar2,param_5,1);
    uVar2 = local_90;
