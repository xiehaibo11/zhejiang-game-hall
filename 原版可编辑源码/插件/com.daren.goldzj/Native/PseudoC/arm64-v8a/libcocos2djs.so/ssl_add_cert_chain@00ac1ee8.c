...

{
  ...
  X509_STORE *store;
                    ...
                    /* try { // try from 00ac1ee8 to 00bc1ef3 has its CatchHandler @ 00ac2768 */
  str = *(BUF_MEM **)(param_1 + 0x78);
                    /* try { // try from 00ac1f08 to 00bc1f33 has its CatchHandler @ 00ac2764 */
    ...
    if ((param_2 != (undefined8 *)0x0) && (x509 = (X509 *)*param_2, x509 != (X509 *)0x0)) {
      ...
      if (lVar6 == 0) {
        lVar6 = *(long *)(*(long *)(param_1 + 0x1b8) + 0xe8);
                    /* try { // try from 00ac1ffc to 00bc200b has its CatchHandler @ 00ac26fc */
        if ((lVar6 == 0) && ((*(uint *)(param_1 + 0x1e8) >> 3 & 1) == 0)) {
          ...
          if ((store != (X509_STORE *)0x0) ||
            ...
            if (ctx == (X509_STORE_CTX *)0x0) {
              ...
              iVar1 = X509_STORE_CTX_init(ctx,store,x509,(stack_st_X509 *)0x0);
                    /* try { // try from 00ac203c to 00bc2043 has its CatchHandler @ 00ac2644 */
              if (iVar1 == 0) {
                ...
                iVar1 = ssl_security_cert_chain(param_1,uVar4,0,0);
                    /* try { // try from 00ac206c to 00bc207f has its CatchHandler @ 00ac2764 */
                if (iVar1 == 1) {
                  ...
                  if (0 < iVar1) {
                    ...
                    do {
                      ...
                      iVar3 = FUN_00ac2154(str,param_3,uVar5);
                      if (iVar3 == 0) {
                        X509_STORE_CTX_free(ctx);
                        goto LAB_00ac1fec;
                      }
          ...
          lVar6 = 0;
                    ...
                    /* try { // try from 00ac1f38 to 00bc1f47 has its CatchHandler @ 00ac2760 */
      iVar1 = ssl_security_cert_chain(param_1,lVar6,x509,0);
      if (iVar1 != 1) {
                    /* try { // try from 00ac1fdc to 00bc1fe3 has its CatchHandler @ 00ac271c */
        iVar2 = 0x353;
        goto LAB_00ac1fe8;
      }
      uVar4 = FUN_00ac2154(str,param_3,x509);
      if ((int)uVar4 == 0) {
        return uVar4;
      }
      ...
      if (0 < iVar1) {
        ...
        do {
          uVar4 = OPENSSL_sk_value(lVar6,iVar1);
                    /* try { // try from 00ac1f88 to 00bc1f9b has its CatchHandler @ 00ac275c */
          uVar4 = FUN_00ac2154(str,param_3,uVar4);
          if ((int)uVar4 == 0) {
            return uVar4;
          }
                    /* try { // try from 00ac1f9c to 00bc1fab has its CatchHandler @ 00ac274c */
          iVar1 = iVar1 + 1;
