...
/* v8::internal::compiler::EffectControlLinearizer::LowerObjectIsNonCallable(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerObjectIsNonCallable
...

{
  ...
  this_02 = (AccessBuilder *)GraphAssembler::LoadField(this_00,aFStack_f8,pNVar4);
  AccessBuilder::ForMapInstanceType(this_02);
  pNVar4 = (Node *)GraphAssembler::LoadField(this_00,aFStack_f8,(Node *)this_02);
  pNVar2 = (Node *)GraphAssembler::Uint32Constant(this_00,0xa9);
  pNVar4 = (Node *)GraphAssembler::Uint32LessThanOrEqual(this_00,pNVar2,pNVar4);
  GraphAssembler::GotoIfNot<>(this_00,pNVar4,local_80);
  AccessBuilder::ForMapBitField(this_03);
  pNVar4 = (Node *)GraphAssembler::LoadField(this_00,aFStack_f8,(Node *)this_02);
  pNVar2 = (Node *)GraphAssembler::Int32Constant(this_00,0);
  pNVar3 = (Node *)GraphAssembler::Int32Constant(this_00,2);
  pNVar4 = (Node *)GraphAssembler::Word32And(this_00,pNVar4,pNVar3);
  pNVar4 = (Node *)GraphAssembler::Word32Equal(this_00,pNVar2,pNVar4);
