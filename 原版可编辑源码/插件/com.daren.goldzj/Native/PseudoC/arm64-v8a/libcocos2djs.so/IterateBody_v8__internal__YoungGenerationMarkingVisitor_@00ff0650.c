...
/* void 
   v8::internal::JSArrayBuffer::BodyDescriptor::IterateBody<v8::internal::YoungGenerationMarkingVisitor>(v8::internal::Map,
   v8::internal::HeapObject, int, v8::internal::YoungGenerationMarkingVisitor*) */

void v8::internal::JSArrayBuffer::BodyDescriptor::
          ...
          while( true ) {
            ...
            while (*puVar2 == uVar3) {
              ...
              if (cVar4 == '\0') {
                ...
                puVar10 = (undefined8 *)(lVar12 + (long)*(int *)(param_4 + 0x10) * 0x50);
