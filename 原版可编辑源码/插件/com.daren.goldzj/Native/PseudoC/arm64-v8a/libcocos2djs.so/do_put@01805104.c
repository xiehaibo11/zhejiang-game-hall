...

{
  ...
  if (bVar6) {
    iVar8 = __libcpp_snprintf_l(local_a0,0x1e,(__locale_t *)DAT_01d52dc0,(char *)&local_190,param_1,
                                (ulong)*(uint *)(param_4 + 0x10));
    if (iVar8 < 0x1e) goto LAB_0180524c;
LAB_01805274:
    if (bVar6) {
      if (((DAT_01d52dc8 & 1) == 0) && (iVar8 = __cxa_guard_acquire(&DAT_01d52dc8), iVar8 != 0)) {
        DAT_01d52dc0 = newlocale(0x1fbf,"C",(__locale_t)0x0);
      ...
      iVar8 = __libcpp_asprintf_l(&local_198,(__locale_t *)DAT_01d52dc0,(char *)&local_190,param_1,
                                  (ulong)*(uint *)(param_4 + 0x10));
    }
    else {
      if (((DAT_01d52dc8 & 1) == 0) && (iVar8 = __cxa_guard_acquire(&DAT_01d52dc8), iVar8 != 0)) {
    ...
    __ptr_00 = local_198;
    if (local_198 == (char *)0x0) goto LAB_018054b8;
  }
  else {
    iVar8 = __libcpp_snprintf_l(local_a0,0x1e,(__locale_t *)DAT_01d52dc0,(char *)&local_190,param_1)
    ;
    if (0x1d < iVar8) goto LAB_01805274;
LAB_0180524c:
    __ptr_00 = (char *)0x0;
  }
  pcVar7 = local_198;
...
LAB_018054b8:
  ...
  uVar9 = FUN_01804780(param_3,pwVar13,pwStack_1a0,local_1a8,param_4,param_5);
  if (__ptr != (wchar_t *)0x0) {
    free(__ptr);
  }
  if (__ptr_00 != (char *)0x0) {
