...
undefined8 FUN_014c66f0(int param_1,undefined8 param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_90,(ulong)&local_90 | 8,0x2fa);
  }
  if (DAT_01d46520 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d46520 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d46520;
  local_b0 = (byte **)0x0;
  if ((*DAT_01d46520 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar3,"V8.Builtin_FunctionConstructor",0,0,0,0,0,0,0,&local_60,0
                      );
    plVar4 = local_58;
    local_58 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    local_b0 = &local_a8;
    local_a0 = "V8.Builtin_FunctionConstructor";
    local_a8 = pbVar3;
    local_98 = uVar5;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  pIVar6 = (Isolate *)FUN_014c7d9c(param_3,(long)param_1,param_2,"function");
