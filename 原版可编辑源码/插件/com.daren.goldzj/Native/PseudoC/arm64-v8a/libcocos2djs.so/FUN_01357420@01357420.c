...
/* WARNING: Removing unreachable block (ram,0x01358920) */
/* WARNING: Removing unreachable block (ram,0x01358930) */

ulong FUN_01357420(ulong param_1,long param_2,ulong param_3)
    ...
    if (bVar2 < 5) {
      if (bVar2 < 2) {
          ...
          if (*(int *)(lVar1 + -1) != (int)*(undefined8 *)(unaff_x26 + 0xe8)) {
            if ((param_3 & 1) == 0) {
              uVar10 = (long)(param_3 << 0x20) >> 0x21;
                    ...
                    (0x3ffffffffffffe < uVar10 + 0x1fffffffffffff)) goto LAB_01358890;
            ...
            if (((param_1 & 1) == 0) &&
              ...
              pcVar3 = (code *)SoftwareBreakpoint(0,0x13588ec);
              (*pcVar3)();
            }
          }
        }
        else {
          if (bVar2 != 1) goto LAB_013588e4;
          lVar1 = unaff_x26 + (ulong)*(uint *)(param_2 + 7);
          if (*(int *)(lVar1 + -1) != (int)*(undefined8 *)(unaff_x26 + 0xe8)) {
            if ((param_3 & 1) == 0) {
              uVar10 = (long)(param_3 << 0x20) >> 0x21;
              ...
              if (uVar10 < (ulong)((long)((ulong)*(uint *)(lVar1 + 3) << 0x20) >> 0x21)) {
                *(int *)(lVar1 + uVar10 * 4 + 7) = iVar11;
                return param_1;
                    ...
                    /* WARNING: Does not return */
              pcVar3 = (code *)SoftwareBreakpoint(0,0x13588f4);
              (*pcVar3)();
            }
          }
        }
        ...
        if (*(int *)(uVar10 - 1) != (int)*(undefined8 *)(unaff_x26 + 0xe8)) {
          if ((param_3 & 1) == 0) {
            uVar5 = (long)(param_3 << 0x20) >> 0x21;
                  ...
                  (0x3ffffffffffffe < uVar5 + 0x1fffffffffffff)) goto LAB_01358890;
          if (*(short *)(lVar4 + 7) == 0x423) {
            uVar8 = *(uint *)(param_2 + 0xb);
          }
          else {
          ...
          if (uVar5 < (ulong)((long)(unaff_x26 + (ulong)uVar8 << 0x20) >> 0x21)) {
            if ((ulong)((long)((ulong)*(uint *)(uVar10 + 3) << 0x20) >> 0x21) <= uVar5) {
                    /* WARNING: Does not return */
              pcVar3 = (code *)SoftwareBreakpoint(0,0x13588fc);
              (*pcVar3)();
            }
            lVar4 = uVar5 * 4 + 7;
        ...
        if (*(int *)(uVar10 - 1) != (int)*(undefined8 *)(unaff_x26 + 0xe8)) {
          ...
          if (uVar5 < (ulong)((long)(unaff_x26 + (ulong)uVar8 << 0x20) >> 0x21)) {
            if ((ulong)((long)((ulong)*(uint *)(uVar10 + 3) << 0x20) >> 0x21) <= uVar5) {
                    /* WARNING: Does not return */
              pcVar3 = (code *)SoftwareBreakpoint(0,0x1358914);
              (*pcVar3)();
            }
            lVar4 = uVar5 * 4 + 7;
            *(int *)(uVar10 + lVar4) = iVar11;
        ...
        if ((param_1 & 1) == 0) {
          dVar15 = (double)(iVar11 >> 1);
        }
        else {
          if (*(int *)(param_1 - 1) != (int)*(undefined8 *)(unaff_x26 + 0x140)) goto LAB_01358890;
          dVar15 = *(double *)(param_1 + 3);
        }
        if (uVar10 < (ulong)((long)(unaff_x26 + (ulong)uVar8 << 0x20) >> 0x21)) {
          if (uVar10 < (ulong)((long)((ulong)*(uint *)(lVar1 + 3) << 0x20) >> 0x21)) {
            *(double *)(lVar1 + uVar10 * 8 + 7) = dVar15 - unaff_d15;
            return param_1;
          }
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0,0x135893c);
          (*pcVar3)();
        }
      }
    }
          ...
          if (uVar10 < (ulong)((long)((ulong)*(uint *)(lVar1 + 3) << 0x20) >> 0x21)) {
            *(double *)(lVar1 + uVar10 * 8 + 7) = dVar15 - unaff_d15;
            return param_1;
                    ...
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0,0x1358944);
          (*pcVar3)();
        }
      }
      else {
        if (bVar2 != 6) goto LAB_013588e4;
        uVar10 = unaff_x26 + (ulong)*(uint *)(param_2 + 7);
        if (*(int *)(uVar10 - 1) != (int)*(undefined8 *)(unaff_x26 + 0xe8)) {
          if ((param_3 & 1) == 0) {
            uVar5 = (long)(param_3 << 0x20) >> 0x21;
          ...
          if (uVar5 < (ulong)((long)(unaff_x26 + (ulong)uVar8 << 0x20) >> 0x21)) {
            if ((ulong)((long)((ulong)*(uint *)(uVar10 + 3) << 0x20) >> 0x21) <= uVar5) {
                    /* WARNING: Does not return */
              pcVar3 = (code *)SoftwareBreakpoint(0,0x1358904);
              (*pcVar3)();
            }
            lVar4 = uVar5 * 4 + 7;
            *(int *)(uVar10 + lVar4) = iVar11;
      ...
      if (*(int *)(uVar10 - 1) != (int)*(undefined8 *)(unaff_x26 + 0xe8)) {
        ...
        if (uVar5 < (ulong)((long)(unaff_x26 + (ulong)uVar8 << 0x20) >> 0x21)) {
          if ((ulong)((long)((ulong)*(uint *)(uVar10 + 3) << 0x20) >> 0x21) <= uVar5) {
                    /* WARNING: Does not return */
            pcVar3 = (code *)SoftwareBreakpoint(0,0x135891c);
            (*pcVar3)();
          }
          lVar4 = uVar5 * 4 + 7;
      ...
      if (*(int *)(uVar10 - 1) != (int)*(undefined8 *)(unaff_x26 + 0xe8)) {
        ...
        if (uVar5 < (ulong)((long)(unaff_x26 + (ulong)uVar8 << 0x20) >> 0x21)) {
          if ((ulong)((long)((ulong)*(uint *)(uVar10 + 3) << 0x20) >> 0x21) <= uVar5) {
                    /* WARNING: Does not return */
            pcVar3 = (code *)SoftwareBreakpoint(0,0x135890c);
            (*pcVar3)();
          }
          lVar4 = uVar5 * 4 + 7;
          *(int *)(uVar10 + lVar4) = iVar11;
      ...
      if (*(int *)(uVar10 - 1) != (int)*(undefined8 *)(unaff_x26 + 0xe8)) {
        ...
        if (uVar5 < (ulong)((long)(unaff_x26 + (ulong)uVar8 << 0x20) >> 0x21)) {
          if ((ulong)((long)((ulong)*(uint *)(uVar10 + 3) << 0x20) >> 0x21) <= uVar5) {
                    /* WARNING: Does not return */
            pcVar3 = (code *)SoftwareBreakpoint(0,0x135892c);
            (*pcVar3)();
          }
          lVar4 = uVar5 * 4 + 7;
          if (*(int *)(uVar10 + lVar4) != (int)*(undefined8 *)(unaff_x26 + 0xa8)) {
      ...
      if (bVar2 == 0x11) {
        ...
        while ((param_1 & 1) != 0) {
          ...
          if (((int)lVar4 == (int)*(undefined8 *)(unaff_x26 + 0x140)) ||
            ...
            dVar15 = (double)(long)dVar9;
            if (SBORROW8((long)dVar15,1) || SCARRY8((long)dVar15,1)) {
              auVar16 = FUN_013c0b40();
              dVar15 = dVar9;
            }
            uVar6 = SUB81(dVar15,0);
            goto LAB_01357d9c;
          }
...
LAB_013588e4:
                    /* WARNING: Does not return */
          pcVar3 = (code *)SoftwareBreakpoint(0,0x13588e8);
          (*pcVar3)();
        }
        if ((param_3 & 1) == 0) {
          uVar10 = (long)(param_3 << 0x20) >> 0x21;
...
LAB_013580c0:
      ...
      if (bVar2 != 0x15) goto LAB_013588e4;
      if ((param_3 & 1) == 0) {
        uVar10 = (long)(param_3 << 0x20) >> 0x21;
      }
      else if (((*(short *)(unaff_x26 + (ulong)*(uint *)(param_3 - 1) + 7) != 0x42) ||
...
LAB_013583c4:
      ...
      if (((param_1 & 1) != 0) &&
        ...
        *(int *)(lVar4 + -1) = iVar11;
        *(double *)(lVar4 + 3) = (double)fVar14;
      }
    }
    else {
      if (bVar2 != 0x18) goto LAB_013588e4;
      uVar10 = param_1;
      if ((param_3 & 1) == 0) {
        uVar5 = (long)(param_3 << 0x20) >> 0x21;
      }
...
LAB_013584ac:
    ...
    while ((param_1 & 1) != 0) {
      ...
      if (((int)lVar4 == (int)*(undefined8 *)(unaff_x26 + 0x140)) || (*(short *)(lVar4 + 7) == 0x43)
        ...
        else if (255.0 <= dVar15) {
          uVar6 = 0xff;
        }
        else {
          dVar9 = (double)(long)(double)(long)dVar15;
          if (SBORROW8((long)dVar9,1) || SCARRY8((long)dVar9,1)) {
            auVar16 = FUN_013c0b40();
            dVar9 = (double)(long)dVar15;
          }
          uVar6 = SUB81(dVar9,0);
        }
        goto LAB_0135860c;
...
LAB_0135860c:
    ...
    if (bVar2 != 0x1b) goto LAB_013588e4;
    if ((param_3 & 1) == 0) {
      uVar10 = (long)(param_3 << 0x20) >> 0x21;
    }
    else if (((*(short *)(unaff_x26 + (ulong)*(uint *)(param_3 - 1) + 7) != 0x42) ||
