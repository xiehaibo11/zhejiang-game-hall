...
/* js_gfx_VertexBuffer_destroyRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_gfx_VertexBuffer_destroyRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (VertexBuffer *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x156,"js_gfx_VertexBuffer_destroy");
    __android_log_print(6,"jswrapper","js_gfx_VertexBuffer_destroy : Invalid Native Object");
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      cocos2d::renderer::VertexBuffer::destroy(this);
      goto LAB_0092ac40;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp, 349): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_gfx_VertexBuffer_destroy",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                      ,0x160);
LAB_0092ac40:
