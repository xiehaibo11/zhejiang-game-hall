...
/* v8::internal::compiler::InstructionSelector::EmitIdentity(v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::InstructionSelector::EmitIdentity(InstructionSelector *this,Node *param_1)
