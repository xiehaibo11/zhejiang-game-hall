...
/* void std::__ndk1::vector<cocos2d::UrlAudioPlayer*,
   std::__ndk1::allocator<cocos2d::UrlAudioPlayer*>
   >::__push_back_slow_path<cocos2d::UrlAudioPlayer*>(cocos2d::UrlAudioPlayer*&&) */
...
__push_back_slow_path<cocos2d::UrlAudioPlayer*>
          (vector<cocos2d::UrlAudioPlayer*,std::__ndk1::allocator<cocos2d::UrlAudioPlayer*>> *this,
          UrlAudioPlayer **param_1)
...
LAB_00a79a5c:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00a79a5c;
  }
  else {
