...
/* v8::internal::compiler::Schedule::AddNode(v8::internal::compiler::BasicBlock*,
   v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::Schedule::AddNode(Schedule *this,BasicBlock *param_1,Node *param_2)
  ...
  *this_00;
  ...
  if (FLAG_trace_turbo_scheduler != '\0') {
    ...
    std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>
              ((basic_ostream *)&local_158,"Adding #",8);
    ...
    std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>
              ((basic_ostream *)&local_158," to B",5);
    std::__ndk1::basic_ostream<char,std::__ndk1::char_traits<char>>::operator<<
              ((basic_ostream<char,std::__ndk1::char_traits<char>> *)&local_158,
               *(ulong *)(param_1 + 0xa0));
    std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>
  ...
  BasicBlock::AddNode(param_1,param_2);
