...
/* void 
   v8::internal::MemoryAllocator::Free<(v8::internal::MemoryAllocator::FreeMode)2>(v8::internal::MemoryChunk*)
    */

void __thiscall
v8::internal::MemoryAllocator::Free<(v8::internal::MemoryAllocator::FreeMode)2>
