...

{
  ...
  if (((byte)*param_1 & 1) == 0) {
    ...
    uVar4 = local_60 & 0xff;
    if ((local_60 & 1) != 0) goto LAB_00d5ea58;
LAB_00d5e9d4:
    plVar5 = (long *)((ulong)&local_60 | 1);
    plVar7 = (long *)((long)plVar5 + (uVar4 >> 1));
    if (plVar5 == plVar7) goto LAB_00d5ea80;
  }
  else {
...
LAB_00d5ea3c:
    ...
    *(char *)((long)plVar7 + uVar4) = '\0';
    uVar4 = local_60 & 0xff;
    if ((local_60 & 1) == 0) goto LAB_00d5e9d4;
LAB_00d5ea58:
    plVar7 = (long *)((long)local_50 + uStack_58);
    plVar5 = local_50;
    if (local_50 == plVar7) goto LAB_00d5ea80;
  }
  do {
