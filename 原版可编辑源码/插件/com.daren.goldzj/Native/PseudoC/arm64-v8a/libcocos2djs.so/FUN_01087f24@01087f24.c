...
void FUN_01087f24(undefined8 param_1,ulong *param_2,long *param_3)
...
switchD_01087fe8_caseD_1:
    bVar8 = bVar4;
    goto switchD_01087fe8_caseD_0;
  }
  bVar8 = 1;
  bVar11 = 7;
  switch(bVar4) {
  ...
  case 4:
    ...
    break;
  case 6:
    goto switchD_01087fe8_caseD_6;
  }
switchD_01087fe8_caseD_0:
  bVar11 = bVar8;
  if (bVar3 != bVar8) {
switchD_01087fe8_caseD_6:
    ...
    if ((uVar1 == *(uint *)(pIVar9 + 0x168)) || (((bVar2 & 0xf0) == 0x20) == ((bVar11 & 0x1e) == 4))
      ...
      FUN_0108998c(this,*puVar5,0,*puVar6,bVar3,0,0xffffffff);
