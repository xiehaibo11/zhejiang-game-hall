...
/* v8::internal::Handle<v8::internal::ExternalTwoByteString>
   v8::internal::Factory::InternalizeExternalString<v8::internal::ExternalTwoByteString>(v8::internal::Handle<v8::internal::String>)
    */

ulong * __thiscall
v8::internal::Factory::InternalizeExternalString<v8::internal::ExternalTwoByteString>
