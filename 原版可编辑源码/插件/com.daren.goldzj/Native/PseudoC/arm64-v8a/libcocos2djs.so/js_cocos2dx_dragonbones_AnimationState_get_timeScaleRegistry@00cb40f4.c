...
/* js_cocos2dx_dragonbones_AnimationState_get_timeScaleRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_AnimationState_get_timeScaleRegistry
...

{
  ...
  if (lVar3 == 0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_AnimationState_get_timeScale : Invalid Native Object"
                       );
    ...
    float_to_seval(*(float *)(lVar3 + 0x1c),aVStack_58);
