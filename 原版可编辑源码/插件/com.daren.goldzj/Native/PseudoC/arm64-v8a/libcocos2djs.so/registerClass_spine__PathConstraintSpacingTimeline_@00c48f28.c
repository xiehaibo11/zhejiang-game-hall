...
/* void JSBClassType::registerClass<spine::PathConstraintSpacingTimeline>(se::Class*) */

void JSBClassType::registerClass<spine::PathConstraintSpacingTimeline>(Class *param_1)
