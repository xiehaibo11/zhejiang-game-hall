...
void FUN_0145ff34(long param_1,undefined8 param_2,undefined8 param_3,long param_4,undefined8 param_5
...

{
  ...
  *(int *)(param_4 + -0x20) = ((int)unaff_x19 + -1) * 2;
  uVar2 = FUN_01392540(param_1,param_5);
  if ((int)param_6 != (int)*(undefined8 *)(unaff_x26 + 0xa0)) {
    ...
    if (uVar3 != uVar4) {
      ...
      *(undefined4 *)(param_6 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0145ff30. Too many branches */
