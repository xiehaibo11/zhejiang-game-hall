...
/* v8::internal::compiler::JSObjectRef::elements() const */

undefined1  [16] __thiscall v8::internal::compiler::JSObjectRef::elements(JSObjectRef *this)

{
  ...
  if (*(int *)(*(undefined8 **)this + 1) == 2) {
    ...
    uVar7 = uVar7 & 0xffffffff00000000 | (ulong)*(uint *)(uVar7 + 7);
    ...
    if (*(ushort *)(*(long *)(lVar5 + 0x10) + 0x18) < 0xaa) {
                    /* WARNING: Subroutine does not return */
  ...
  if (*(int *)(puVar6 + 1) == 2) {
    uVar7 = *(ulong *)*puVar6;
    if ((uVar7 & 1) == 0) goto LAB_01723108;
    uVar1 = *(ushort *)((uVar7 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar7 - 1));
  }
  else {
    if (*(int *)(puVar6 + 1) == 0) goto LAB_01723108;
