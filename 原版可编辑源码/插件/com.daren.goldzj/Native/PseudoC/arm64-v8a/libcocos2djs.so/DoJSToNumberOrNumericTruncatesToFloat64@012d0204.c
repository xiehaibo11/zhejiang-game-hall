...
/* v8::internal::compiler::SimplifiedLowering::DoJSToNumberOrNumericTruncatesToFloat64(v8::internal::compiler::Node*,
   v8::internal::compiler::RepresentationSelector*) */

void __thiscall
v8::internal::compiler::SimplifiedLowering::DoJSToNumberOrNumericTruncatesToFloat64
...

{
  ...
  pNStack_b0 = pNVar7;
  local_a8 = this_00;
  uVar15 = Graph::NewNode(pGVar20,pOVar6,3,&local_b8,false);
  pGVar20 = (Graph *)**(undefined8 **)this;
  pOVar6 = (Operator *)
  ...
  pGVar20 = (Graph *)**(undefined8 **)this;
  pOVar6 = (Operator *)
           CommonOperatorBuilder::Phi((CommonOperatorBuilder *)(*(undefined8 **)this)[1],0xc,2);
  local_a0 = pNVar14;
  pNStack_98 = (Node *)uVar15;
  local_90 = (Node *)uVar16;
...
joined_r0x012d0934:
    ...
    if (*(short *)(*(long *)pUVar18 + 0x10) != 6) {
      ...
      if (pNVar8 != pNVar12) {
        ...
        *(Node **)pUVar1 = pNVar12;
        pNVar8 = pNVar12;
        goto joined_r0x012d0934;
      }
      goto joined_r0x012d08a8;
    }
    if ((uVar3 & 1) == 0) {
      pNVar8 = *(Node **)pNVar8;
    }
