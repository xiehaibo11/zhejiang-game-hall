...
/* v8::internal::HashTable<v8::internal::ObjectHashTable,
   v8::internal::ObjectHashTableShape>::EnsureCapacity(v8::internal::Isolate*,
   v8::internal::Handle<v8::internal::ObjectHashTable>, int, v8::internal::AllocationType) */
...

{
  ...
  if (((iVar2 - param_3 == 0 || iVar2 < param_3) ||
    ...
    puVar3 = (ulong *)Factory::NewFixedArrayWithMap<v8::internal::FixedArray>
                                (param_1,0xe,iVar2 * 2 + 3,bVar1);
    *(undefined4 *)(*puVar3 + 7) = 0;
    *(undefined4 *)(*puVar3 + 0xb) = 0;
    *(int *)(*puVar3 + 0xf) = iVar2 * 2;
    local_38 = *param_2;
    Rehash((HashTable<v8::internal::ObjectHashTable,v8::internal::ObjectHashTableShape> *)&local_38,
           param_1 + 0x80,*puVar3);
  }
  return puVar3;
}
