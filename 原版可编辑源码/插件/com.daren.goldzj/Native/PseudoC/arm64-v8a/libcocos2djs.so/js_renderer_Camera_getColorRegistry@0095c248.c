...
/* js_renderer_Camera_getColorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Camera_getColorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x28,"js_renderer_Camera_getColor");
    __android_log_print(6,"jswrapper","js_renderer_Camera_getColor : Invalid Native Object");
  }
  else {
    plVar5 = (long *)se::State::args(aSStack_70);
    if (plVar5[1] - *plVar5 == 0x10) {
      cocos2d::Color4F::Color4F((Color4F *)&local_80);
      uStack_78 = *(undefined8 *)(lVar4 + 0x24);
      local_80 = *(undefined8 *)(lVar4 + 0x1c);
      this = (Object *)se::Value::toObject((Value *)*plVar5);
      se::Value::Value(aVStack_48,(float)local_80);
      se::Object::setProperty(this,"r",aVStack_48);
      se::Value::~Value(aVStack_48);
      se::Value::Value(aVStack_48,local_80._4_4_);
      se::Object::setProperty(this,"g",aVStack_48);
      se::Value::~Value(aVStack_48);
      se::Value::Value(aVStack_48,(float)uStack_78);
      se::Object::setProperty(this,"b",aVStack_48);
      se::Value::~Value(aVStack_48);
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp, 54): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar5[1] - *plVar5) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Camera_getColor",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp"
                      ,0x39);
LAB_0095c440:
  pVVar6 = (Value *)se::State::rval(aSStack_70);
