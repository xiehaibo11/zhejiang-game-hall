...
undefined8 FUN_011d2a64(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_a0,(ulong)&local_a0 | 8,0x195);
  }
  if (DAT_01d3fb80 == (byte *)0x0) {
    plVar5 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d3fb80 = (byte *)(**(code **)(*plVar5 + 0x10))(plVar5,"disabled-by-default-v8.runtime");
  }
  pbVar4 = DAT_01d3fb80;
  local_c0 = (byte **)0x0;
  if ((*DAT_01d3fb80 & 5) != 0) {
    ...
    uVar6 = (**(code **)(*plVar5 + 0x18))
                      (plVar5,0x58,pbVar4,"V8.Runtime_Runtime_DefineSetterPropertyUnchecked",0,0,0,0
                       ,0,0,0,&local_70,0);
    plVar5 = local_68;
    local_68 = (long *)0x0;
    if (plVar5 != (long *)0x0) {
    ...
    local_c0 = &local_b8;
    local_b0 = "V8.Runtime_Runtime_DefineSetterPropertyUnchecked";
    local_b8 = pbVar4;
    local_a8 = uVar6;
  }
...
LAB_011d2e30:
  ...
  uVar16 = uVar15 | 7;
  if (*(short *)(uVar16 + *(uint *)(uVar10 - 1)) != 0x439) goto LAB_011d2e30;
  if ((param_2[-3] & 1) != 0) {
                    /* WARNING: Subroutine does not return */
  ...
  if (((uVar3 & 1) == 0) || (*(short *)(uVar16 + *(uint *)((long)plVar5 - 1)) != 0x83)) {
    if (uVar3 != 0) {
      if ((uVar3 & 1) != 0) goto LAB_011d2c60;
      goto LAB_011d2ca0;
    }
LAB_011d2c9c:
    plVar5 = *(long **)(uVar15 + 200);
LAB_011d2ca0:
    if (*(int *)((long)plVar5 + 7) != 0) goto LAB_011d2d1c;
LAB_011d2ca8:
    ...
    uVar10 = v8::internal::JSFunction::SetName(puVar14,puVar13,param_3 + 0x9b0);
    if ((uVar10 & 1) != 0) {
    ...
    if ((uVar7 & 1) == 0) goto LAB_011d2c9c;
    uVar3 = *(uint *)(uVar10 + 7);
    plVar5 = (long *)(uVar15 | uVar3);
    if ((uVar3 & 1) == 0) goto LAB_011d2ca0;
LAB_011d2c60:
    if (*(short *)(uVar16 + *(uint *)((long)plVar5 - 1)) != 0x83) goto LAB_011d2ca0;
    local_70 = plVar5;
    uVar10 = v8::internal::ScopeInfo::HasFunctionName((ScopeInfo *)&local_70);
    if ((uVar10 & 1) == 0) goto LAB_011d2c9c;
    local_70 = plVar5;
    lVar9 = v8::internal::ScopeInfo::FunctionName((ScopeInfo *)&local_70);
    if (*(int *)(lVar9 + 7) == 0) goto LAB_011d2ca8;
LAB_011d2d1c:
    lVar9 = v8::internal::JSObject::DefineAccessor(param_2,puVar13,param_3 + 0xb0,puVar14,uVar1);
    if (lVar9 != 0) {
