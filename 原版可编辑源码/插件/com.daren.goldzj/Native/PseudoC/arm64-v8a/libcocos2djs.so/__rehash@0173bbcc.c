...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<v8::internal::compiler::ObjectData*,
   ...
   v8::internal::compiler::BytecodeAnalysis*> > >::__rehash(unsigned long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<v8::internal::compiler::ObjectData*,v8::internal::compiler::BytecodeAnalysis*>,std::__ndk1::__unordered_map_hasher<v8::internal::compiler::ObjectData*,std::__ndk1::__hash_value_type<v8::internal::compiler::ObjectData*,v8::internal::compiler::BytecodeAnalysis*>,v8::base::hash<v8::internal::compiler::ObjectData*>,true>,std::__ndk1::__unordered_map_equal<v8::internal::compiler::ObjectData*,std::__ndk1::__hash_value_type<v8::internal::compiler::ObjectData*,v8::internal::compiler::BytecodeAnalysis*>,std::__ndk1::equal_to<v8::internal::compiler::ObjectData*>,true>,v8::internal::ZoneAllocator<std::__ndk1::__hash_value_type<v8::internal::compiler::ObjectData*,v8::internal::compiler::BytecodeAnalysis*>>>
           *this,ulong param_1)
      ...
      if (plVar6 != (long *)0x0) {
        do {
          ...
          if ((uVar12 & 0xffffffff) < 2) {
            uVar7 = uVar7 & uVar3;
LAB_0173bcc0:
            if (uVar7 == uVar4) goto LAB_0173bc88;
LAB_0173bcc8:
            plVar9 = plVar6;
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) goto LAB_0173bd24;
            do {
              plVar8 = plVar9;
              plVar9 = (long *)*plVar8;
            ...
            **(undefined8 **)(*(long *)this + uVar7 * 8) = plVar6;
            ...
            if (uVar7 < param_1) goto LAB_0173bcc0;
            uVar1 = 0;
            if (param_1 != 0) {
              uVar1 = uVar7 / param_1;
            }
            uVar7 = uVar7 - uVar1 * param_1;
            if (uVar7 != uVar4) goto LAB_0173bcc8;
LAB_0173bc88:
            plVar9 = (long *)*plVar6;
            plVar5 = plVar6;
          }
