...
/* v8::internal::compiler::CommonOperatorBuilder::DeadValue(v8::internal::MachineRepresentation) */

Operator * __thiscall
v8::internal::compiler::CommonOperatorBuilder::DeadValue
...

{
  ...
  Operator::Operator(pOVar1,0x3c,0x7c,"DeadValue",1,0,0,1,0,0);
  pOVar1[0x2c] = param_2;
