...
/* v8::internal::compiler::CodeAssembler::IntPtrEqual(v8::internal::TNode<v8::internal::WordT>,
   v8::internal::TNode<v8::internal::WordT>) */

void __thiscall
v8::internal::compiler::CodeAssembler::IntPtrEqual(CodeAssembler *this,Node *param_2,long *param_3)
...
LAB_016854e0:
    ...
    if (uVar1 == 0x18) {
      ...
      if (uVar1 != 0x17) goto LAB_01685534;
