...
/* void std::__ndk1::vector<v8::internal::ZoneVector<int>,
   v8::internal::ZoneAllocator<v8::internal::ZoneVector<int> >
   >::__emplace_back_slow_path<v8::internal::ZoneVector<int> >(v8::internal::ZoneVector<int>&&) */
