...
/* v8::internal::PropertyCallbackArguments::CallNamedDefiner(v8::internal::Handle<v8::internal::InterceptorInfo>,
   v8::internal::Handle<v8::internal::Name>, v8::PropertyDescriptor const&) */

PropertyCallbackArguments * __thiscall
v8::internal::PropertyCallbackArguments::CallNamedDefiner
...

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    ...
    RuntimeCallStats::Enter(local_a0,(ulong)&local_a0 | 8,0x9c);
  }
    ...
    *(long **)(lVar7 + 0x2c58) = &local_b8;
    ...
    if ((uVar6 & 1) != 0) {
      Logger::ApiNamedPropertyAccess
                (this_00,"interceptor-named-define",*(undefined8 *)(this + 0x20),*param_3);
    }
