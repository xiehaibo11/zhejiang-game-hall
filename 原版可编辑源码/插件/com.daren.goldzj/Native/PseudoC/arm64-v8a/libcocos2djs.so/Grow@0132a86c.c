...
/* v8::base::SmallVector<v8::internal::compiler::Node*, 16ul>::Grow(unsigned long) */

void __thiscall
v8::base::SmallVector<v8::internal::compiler::Node*,16ul>::Grow
          (SmallVector<v8::internal::compiler::Node*,16ul> *this,ulong param_1)

{
  long lVar1;
  void *__dest;
  ulong uVar2;
  SmallVector<v8::internal::compiler::Node*,16ul> *__src;
  size_t __n;
  ...
  __src = *(SmallVector<v8::internal::compiler::Node*,16ul> **)this;
