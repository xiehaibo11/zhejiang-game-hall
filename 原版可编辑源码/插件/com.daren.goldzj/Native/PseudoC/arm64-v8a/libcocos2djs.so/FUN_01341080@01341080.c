...
void FUN_01341080(undefined8 param_1,long param_2,long param_3)

{
  ...
  if (((*(byte *)(unaff_x26 + (ulong)*(uint *)(lVar4 + -1) + 9) >> 5 & 1) != 0) &&
     (((uint)(*(int *)(param_2 + 0x2b) >> 1) >> 5 & 1) == 0)) {
...
LAB_013410d8:
  ...
  do {
    ...
    if ((uVar6 & 1) == 0) goto LAB_013411d0;
  ...
  do {
    if ((int)uVar6 == *(int *)(param_2 + 0x1f)) goto LAB_0134115c;
