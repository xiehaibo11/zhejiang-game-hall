...
/* js_cocos2dx_dragonbones_RealTimeAttachUtil_constructorRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_RealTimeAttachUtil_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Object *)
         se::Object::_createJSObject
                   (__jsb_dragonBones_RealTimeAttachUtil_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_dragonBones_RealTimeAttachUtil_finalizeRegistry);
  ...
  if (this_00 != (Ref *)0x0) {
    ...
    *(undefined ***)this_00 = &PTR__AttachUtilBase_01c8e0c0;
  }
