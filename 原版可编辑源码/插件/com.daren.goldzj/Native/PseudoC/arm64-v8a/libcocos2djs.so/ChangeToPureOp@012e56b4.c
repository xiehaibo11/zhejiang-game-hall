...
/* v8::internal::compiler::RepresentationSelector::ChangeToPureOp(v8::internal::compiler::Node*,
   v8::internal::compiler::Operator const*) */

void __thiscall
v8::internal::compiler::RepresentationSelector::ChangeToPureOp
          (RepresentationSelector *this,Node *param_1,Operator *param_2)

{
  ...
  if (0 < *(int *)(*(long *)param_1 + 0x18)) {
    ...
    Node::TrimInputCount(param_1,*(int *)(param_2 + 0x14));
