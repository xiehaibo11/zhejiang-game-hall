...
/* v8::internal::compiler::GraphAssembler::TruncateFloat64ToWord32(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::TruncateFloat64ToWord32(GraphAssembler *this,Node *param_1)
