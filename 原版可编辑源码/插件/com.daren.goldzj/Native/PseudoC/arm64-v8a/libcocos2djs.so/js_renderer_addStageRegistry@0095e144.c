...
/* js_renderer_addStageRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_addStageRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar5[1] - *plVar5 == 0x10) {
    ...
    if (!bVar1) goto LAB_0095e270;
  }
  else {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp, 256): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar5[1] - *plVar5) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_addStage",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp"
                      ,0x103);
LAB_0095e270:
