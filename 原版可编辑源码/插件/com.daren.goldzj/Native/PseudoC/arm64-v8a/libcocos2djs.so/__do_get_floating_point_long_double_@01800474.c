...
LAB_01800530:
  if (param_2 == (long *)0x0) {
    bVar4 = true;
    if (param_3 != (long *)0x0) goto LAB_01800574;
LAB_018005b0:
    param_3 = (long *)0x0;
    if (bVar4) goto LAB_018006a0;
  }
  else {
    ...
    param_2 = plVar2;
    if (param_3 == (long *)0x0) goto LAB_018005b0;
LAB_01800574:
...
LAB_018006a0:
  ...
  auVar17 = FUN_01829160(pcVar16,local_1d0,param_5);
  *param_6 = auVar17;
  uVar7 = (ulong)((byte)local_1b0[0] >> 1);
  if (((byte)local_1b0[0] & 1) != 0) {
    uVar7 = local_1a8;
  ...
  if (uVar7 != 0) {
    ...
    if (local_190 < puVar9) {
      ...
      do {
        if ((bVar4) && (*puVar15 != uVar10)) goto LAB_018007fc;
...
LAB_018007fc:
  ...
  if (param_2 == (long *)0x0) {
    bVar4 = true;
    if (param_3 != (long *)0x0) goto LAB_01800850;
LAB_01800824:
    if (!bVar4) goto LAB_01800894;
  }
  else {
    if ((int *)param_2[3] == (int *)param_2[4]) {
      iVar6 = (**(code **)(*param_2 + 0x48))(param_2);
    ...
    param_2 = plVar2;
    if (param_3 == (long *)0x0) goto LAB_01800824;
LAB_01800850:
    if ((int *)param_3[3] == (int *)param_3[4]) {
      iVar6 = (**(code **)(*param_3 + 0x48))(param_3);
    }
    ...
    if (bVar4 != (iVar6 == -1)) goto LAB_01800894;
  }
  *param_5 = *param_5 | 2;
LAB_01800894:
  if ((local_1c8 & 1) != 0) {
