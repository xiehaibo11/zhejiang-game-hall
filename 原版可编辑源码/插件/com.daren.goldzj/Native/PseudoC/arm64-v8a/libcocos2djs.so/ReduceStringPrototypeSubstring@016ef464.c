...
/* v8::internal::compiler::JSCallReducer::ReduceStringPrototypeSubstring(v8::internal::compiler::Node*)
    */
...

{
  ...
  if ((*(int *)(*(Operator **)param_1 + 0x14) < 3) ||
    ...
    local_88 = local_88 & 1;
    uVar4 = JSCallReducerAssembler::ReduceStringPrototypeSubstring
                      ((JSCallReducerAssembler *)local_c8);
