...
/* js_cocos2dx_particle_ParticleSimulator_stopRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_particle_ParticleSimulator_stopRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (ParticleSimulator *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xde,"js_cocos2dx_particle_ParticleSimulator_stop");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_particle_ParticleSimulator_stop : Invalid Native Object");
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      cocos2d::ParticleSimulator::stop(this);
      goto LAB_00c04f94;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp, 229): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_particle_ParticleSimulator_stop",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                      ,0xe8);
LAB_00c04f94:
