...
/* void JSBClassType::registerClass<dragonBones::EllipseBoundingBoxData>(se::Class*) */

void JSBClassType::registerClass<dragonBones::EllipseBoundingBoxData>(Class *param_1)
