...
/* v8::internal::compiler::Graph::AddDecorator(v8::internal::compiler::GraphDecorator*) */

void __thiscall v8::internal::compiler::Graph::AddDecorator(Graph *this,GraphDecorator *param_1)
