...
/* universe::Device::getAppVersion() */

void __thiscall universe::Device::getAppVersion(Device *this)

{
  ...
  uVar3 = (**(code **)(*(long *)p_Var1 + 0x388))
                    (p_Var1,p_Var2,"getAppVersion","()Ljava/lang/String;");
