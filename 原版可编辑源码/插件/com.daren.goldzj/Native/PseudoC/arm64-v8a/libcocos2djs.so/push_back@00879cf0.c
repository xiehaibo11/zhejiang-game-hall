...
/* std::__ndk1::__split_buffer<cocos2d::SAXState*,
   std::__ndk1::allocator<cocos2d::SAXState*>&>::push_back(cocos2d::SAXState*&&) */

void __thiscall
std::__ndk1::__split_buffer<cocos2d::SAXState*,std::__ndk1::allocator<cocos2d::SAXState*>&>::
push_back(__split_buffer<cocos2d::SAXState*,std::__ndk1::allocator<cocos2d::SAXState*>&> *this,
         SAXState **param_1)

{
  ...
  if (puVar14 != *(undefined8 **)(this + 0x18)) goto LAB_00879e78;
...
LAB_00879e48:
      ...
      if (uVar2 != uVar11) goto LAB_00879e48;
    }
    puVar13 = *(undefined8 **)this;
