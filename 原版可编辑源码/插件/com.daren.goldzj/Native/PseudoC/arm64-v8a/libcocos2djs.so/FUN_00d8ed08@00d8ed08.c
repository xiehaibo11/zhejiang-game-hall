...
void FUN_00d8ed08(long *param_1,char *param_2,uint param_3,long param_4)

{
  ...
  if (param_3 < 0xe) {
    if ((5 < param_3) && (*param_2 == 'J')) goto LAB_00d8ee88;
LAB_00d8eeb4:
    lVar9 = *param_1;
    uVar8 = 0x4f;
  }
  else {
    if (*param_2 != 'J') goto LAB_00d8eeb4;
...
LAB_00d8ee88:
    if (((param_2[1] != 'F') || (param_2[2] != 'X')) ||
       ((param_2[3] != 'X' || (param_2[4] != '\0')))) goto LAB_00d8eeb4;
    cVar4 = param_2[5];
    if (cVar4 == '\x13') {
      lVar9 = *param_1;
      uVar8 = 0x70;
...
LAB_00d8eec8:
                    /* WARNING: Could not recover jumptable at 0x00d8eed8. Too many branches */
