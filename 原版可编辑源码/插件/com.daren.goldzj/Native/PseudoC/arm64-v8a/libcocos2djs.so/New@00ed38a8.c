...
/* v8::debug::WeakMap::New(v8::Isolate*) */

undefined8 v8::debug::WeakMap::New(Isolate *param_1)

{
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_50,(ulong)&local_50 | 8,0x3f7);
  }
  this = *(Logger **)(param_1 + 0x9558);
  uVar2 = internal::Logger::is_logging(this);
  if ((uVar2 & 1) != 0) {
    internal::Logger::ApiEntryCall(this,"v8::WeakMap::New");
  }
  uVar1 = *(undefined4 *)(param_1 + 0x2c60);
  *(undefined4 *)(param_1 + 0x2c60) = 5;
  uVar3 = internal::Factory::NewJSWeakMap((Factory *)param_1);
