...
/* v8::internal::BigInt::Subtract(v8::internal::Isolate*,
   v8::internal::Handle<v8::internal::BigInt>, v8::internal::Handle<v8::internal::BigInt>) */

void v8::internal::BigInt::Subtract(undefined8 param_1,long *param_2,long *param_3)

{
  ...
  uVar1 = *(uint *)(lVar4 + 3);
  lVar5 = *param_3;
  if ((uVar1 & 1) != (*(uint *)(lVar5 + 3) & 1)) {
    MutableBigInt::AbsoluteAdd(param_1,param_2);
    return;
  }
  ...
  if (uVar2 == uVar3) {
    ...
    do {
      lVar6 = lVar6 + -1;
      if (lVar6 < 1) goto LAB_0106da80;
      uVar9 = *(ulong *)(lVar4 + iVar7);
      uVar8 = *(ulong *)(lVar5 + iVar7);
      iVar7 = iVar7 + -8;
    } while (uVar9 == uVar8);
    if (uVar8 < uVar9) goto LAB_0106da80;
  }
