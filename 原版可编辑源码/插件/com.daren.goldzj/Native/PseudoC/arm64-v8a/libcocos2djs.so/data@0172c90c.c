...
/* v8::internal::compiler::CallHandlerInfoRef::data() const */

undefined1  [16] __thiscall
v8::internal::compiler::CallHandlerInfoRef::data(CallHandlerInfoRef *this)

{
  ...
  if (*(int *)(*(undefined8 **)this + 1) == 2) {
    ...
    if (*(short *)(*(long *)(lVar3 + 0x10) + 0x18) != 0x59) {
                    /* WARNING: Subroutine does not return */
