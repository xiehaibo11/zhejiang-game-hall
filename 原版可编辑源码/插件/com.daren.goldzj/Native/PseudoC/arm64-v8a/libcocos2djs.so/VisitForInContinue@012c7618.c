...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitForInContinue(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitForInContinue
