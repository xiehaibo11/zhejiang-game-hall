...
/* void 
   v8::internal::compiler::GraphAssembler::Bind<2ul>(v8::internal::compiler::GraphAssemblerLabel<2ul>*)
    */

void __thiscall
v8::internal::compiler::GraphAssembler::Bind<2ul>(GraphAssembler *this,GraphAssemblerLabel *param_1)

{
  ...
  *param_1 = (GraphAssemblerLabel)0x1;
  ...
  AddNode(this,*(Node **)(param_1 + 0x30));
  return;
}
