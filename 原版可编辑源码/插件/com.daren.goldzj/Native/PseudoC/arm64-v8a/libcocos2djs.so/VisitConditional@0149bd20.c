...
/* v8::internal::CallPrinter::VisitConditional(v8::internal::Conditional*) */

void __thiscall v8::internal::CallPrinter::VisitConditional(CallPrinter *this,Conditional *param_1)
