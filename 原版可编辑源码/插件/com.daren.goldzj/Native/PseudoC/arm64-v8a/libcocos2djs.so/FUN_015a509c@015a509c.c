...
undefined8 FUN_015a509c(undefined8 param_1,ulong *param_2,long param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0x24c);
  }
  if (DAT_01d475a8 == (byte *)0x0) {
    plVar3 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d475a8 = (byte *)(**(code **)(*plVar3 + 0x10))(plVar3,"disabled-by-default-v8.runtime");
  }
  pbVar2 = DAT_01d475a8;
  if ((*DAT_01d475a8 & 5) == 0) {
    ppbVar5 = (byte **)0x0;
    ...
    uVar4 = (**(code **)(*plVar3 + 0x18))
                      (plVar3,0x58,pbVar2,"V8.Runtime_Runtime_HaveSameMap",0,0,0,0,0,0,0,&local_50,0
                      );
    plVar3 = local_48;
    local_48 = (long *)0x0;
    if (plVar3 != (long *)0x0) {
    ...
    ppbVar5 = &local_98;
    local_90 = "V8.Runtime_Runtime_HaveSameMap";
    uVar6 = *param_2;
    local_98 = pbVar2;
    local_88 = uVar4;
  }
