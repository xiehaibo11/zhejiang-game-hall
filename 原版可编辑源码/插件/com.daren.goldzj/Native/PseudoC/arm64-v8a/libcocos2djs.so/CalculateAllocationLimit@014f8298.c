...
/* v8::internal::MemoryController<v8::internal::GlobalMemoryTrait>::CalculateAllocationLimit(v8::internal::Heap*,
   unsigned long, unsigned long, unsigned long, unsigned long, double,
   v8::internal::Heap::HeapGrowingMode) */

ulong v8::internal::MemoryController<v8::internal::GlobalMemoryTrait>::CalculateAllocationLimit
      ...
      if (FLAG_trace_gc_verbose != '\0') {
        Isolate::PrintWithTimestamp
                  ((char *)(param_1 + -0x8850),
                   ...
                   GlobalMemoryTrait::kName,param_2 >> 10,param_3 >> 10);
      }
      return param_3;
    }
