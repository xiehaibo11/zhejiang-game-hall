...
void __thiscall
v8::internal::compiler::InstructionSelector::VisitInt64Sub(InstructionSelector *this,Node *param_1)

{
  ...
  if ((*(short *)(*(long *)local_70 + 0x10) == 0x146) &&
    ...
    uVar5 = GetVirtualRegister(this,local_88);
    MarkAsUsed(this,local_88);
    Emit(this,0x7e,(uVar2 & 0xffffffff) << 3 | 0xd800000001,(uVar3 & 0xffffffff) << 3 | 0x5800000001
         ,(uVar4 & 0xffffffff) << 3 | 0x5800000001,(uVar5 & 0xffffffff) << 3 | 0x5800000001,0,0);
  }
  else {
LAB_016202c0:
    FUN_0161ff4c(this,param_1,0x76,0x60);
  }
