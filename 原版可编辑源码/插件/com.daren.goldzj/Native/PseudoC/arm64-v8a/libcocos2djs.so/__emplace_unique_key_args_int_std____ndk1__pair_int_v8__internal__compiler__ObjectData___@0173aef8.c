...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<int,
   v8::internal::compiler::ObjectData*>, void*>*>, bool>
   ...
   v8::internal::compiler::ObjectData*> > >::__emplace_unique_key_args<int, std::__ndk1::pair<int,
   v8::internal::compiler::ObjectData*> >(int const&, std::__ndk1::pair<int,
      ...
      for (plVar8 = (long *)*plVar8; plVar8 != (long *)0x0; plVar8 = (long *)*plVar8) {
        ...
        if (uVar7 != uVar2) {
          if (uVar6 < 2) {
            ...
            if (uVar7 - uVar1 * uVar9 == unaff_x25) goto LAB_0173af9c;
            break;
          }
