...
/* v8::internal::PropertyCallbackArguments::CallNamedQuery(v8::internal::Handle<v8::internal::InterceptorInfo>,
...

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    ...
    RuntimeCallStats::Enter(local_90,(ulong)&local_90 | 8,0xa1);
  }
  ...
  if (*(int *)(lVar8 + 0xb80c) == 0x20) {
    ...
    if ((uVar5 & 1) == 0) goto LAB_010ddcf4;
  }
  ...
  *(long **)(lVar8 + 0x2c58) = &local_a8;
  ...
  if ((uVar5 & 1) != 0) {
    Logger::ApiNamedPropertyAccess
              (this_00,"interceptor-named-query",*(undefined8 *)(this + 0x20),*param_3);
  }
