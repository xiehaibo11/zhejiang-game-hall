...
/* JSB_isObjectValidRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_isObjectValidRegistry(FunctionCallbackInfo *param_1)

{
  ...
  pVVar6 = (Value *)*puVar5;
  if ((int)((ulong)(puVar5[1] - (long)pVVar6) >> 4) == 1) {
    ...
    se::Value::setBoolean(pVVar6,bVar3);
  }
  else {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_global.cpp, 674): Invalid number of arguments: %d. Expecting: 1\n"
                       );
