...
undefined4 FUN_00dca8a4(long *param_1,long param_2,uint param_3,uint param_4)
...
LAB_00dca9f4:
  ...
  case 5:
    ...
    if ((uVar27 & 0x44) == 0) {
      if ((uVar27 & 0x88) != 0) goto LAB_00dcaaf8;
      if ((1 << (ulong)(uVar8 & 0x1f) & 0x110U) != 0) goto LAB_00dcab00;
      break;
    }
LAB_00dcaaf0:
    bVar13 = true;
  ...
  case 6:
    ...
    if (uVar8 < 9) {
      bVar13 = false;
      if ((1 << (ulong)(uVar8 & 0x1f) & 0x22U) != 0) goto LAB_00dcaaf0;
      uVar27 = 1 << (ulong)(uVar8 & 0x1f);
      if ((uVar27 & 0x88) != 0) goto LAB_00dcab04;
      if ((uVar27 & 0x110) != 0) goto LAB_00dcaaf8;
    }
    break;
  case 3:
  case 7:
    ...
    do {
      ...
      if (param_3 != 0) {
        ...
        while ((((lVar15 = TIFFReadTile(lVar25,__s,*(int *)((long)param_1 + 0x8c) + uVar26,
          ...
          if (param_3 <= uVar26) goto LAB_00dcad94;
          iVar19 = (int)param_1[0x11];
        }
        local_b8 = 0;
      }
