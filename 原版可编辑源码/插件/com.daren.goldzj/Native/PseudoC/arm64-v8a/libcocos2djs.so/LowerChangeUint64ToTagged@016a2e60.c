...
/* v8::internal::compiler::EffectControlLinearizer::LowerChangeUint64ToTagged(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerChangeUint64ToTagged
...

{
  ...
  pNVar2 = (Node *)GraphAssembler::Uint64LessThanOrEqual(this_00,pNVar4,pNVar2);
  ...
  *(undefined8 *)(this + 0x60) = 0;
  ...
  pNVar4 = (Node *)GraphAssembler::ChangeInt64ToFloat64(this_00,pNVar4);
