...
/* js_extension_Manifest_setUpdatingRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_extension_Manifest_setUpdatingRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Manifest *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x146,"js_extension_Manifest_setUpdating");
    __android_log_print(6,"jswrapper","js_extension_Manifest_setUpdating : Invalid Native Object");
  }
  else {
    ...
    if (uVar6 == 0x10) {
      ...
      if ((uVar6 & 1) != 0) {
        cocos2d::extension::Manifest::setUpdating(this,local_64[0]);
        goto LAB_008a7ad0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_extension_auto.cpp"
                          ,0x14d,"js_extension_Manifest_setUpdating");
      __android_log_print(6,"jswrapper",
                          "js_extension_Manifest_setUpdating : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_extension_auto.cpp, 337): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar6 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_extension_Manifest_setUpdating",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_extension_auto.cpp"
                      ,0x154);
LAB_008a7ad0:
