...
ulong FUN_00af0604(long *param_1,char *param_2,int param_3)

{
  ...
  if (param_2 == (char *)0x0) {
    return 0;
                    ...
                    /* catch() { ... } // from try @ 00aef298 with catch @ 00af061c
                       catch() { ... } // from try @ 00aef584 with catch @ 00af061c
                       catch() { ... } // from try @ 00aef714 with catch @ 00af061c
                       catch() { ... } // from try @ 00aef93c with catch @ 00af061c */
  if ((*(long *)(param_2 + 0x20) != 0) &&
     (UNRECOVERED_JUMPTABLE = *(code **)(*(long *)(param_2 + 0x20) + 0x10),
     UNRECOVERED_JUMPTABLE != (code *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x00af063c. Too many branches */
  ...
  if (*param_2 == '\x05') {
    type = -1;
switchD_00af0698_caseD_fffffffd:
    if (param_3 == 0) {
...
LAB_00af06f0:
    ...
    case -4:
      ...
      *param_1 = (long)puVar2;
      goto LAB_00af06f0;
    default:
      goto switchD_00af0698_caseD_fffffffd;
    }
  }
  return uVar1;
}
