...
/* v8::internal::RelocInfo::set_wasm_stub_call_address(unsigned long, v8::internal::ICacheFlushMode)
    */

void __thiscall
v8::internal::RelocInfo::set_wasm_stub_call_address
          (RelocInfo *this,Instruction *param_1,int param_3)
