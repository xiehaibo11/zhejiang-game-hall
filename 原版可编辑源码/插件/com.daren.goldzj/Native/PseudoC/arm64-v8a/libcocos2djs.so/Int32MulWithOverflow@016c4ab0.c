...
/* v8::internal::compiler::GraphAssembler::Int32MulWithOverflow(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Int32MulWithOverflow
...

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::Int32MulWithOverflow
