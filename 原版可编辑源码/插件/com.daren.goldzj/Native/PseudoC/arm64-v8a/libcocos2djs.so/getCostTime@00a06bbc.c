...

{
  ...
  pbVar2 = std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>(pbVar2,",",1);
                    /* catch() { ... } // from try @ 00a06f14 with catch @ 00a06dfc */
  std::__ndk1::basic_ostream<char,std::__ndk1::char_traits<char>>::operator<<
  ...
  local_120[0] = &PTR__basic_ostringstream_01c6c880;
  if ((local_148 & 1) != 0) {
                    /* try { // try from 00a06e34 to 00b06e67 has its CatchHandler @ 00a06f38 */
  ...
  if (*(long *)(lVar1 + 0x28) == lVar3) {
                    /* try { // try from 00a06e70 to 00b06e8b has its CatchHandler @ 00a06f34 */
    return;
  }
