...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitToNumeric() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitToNumeric(BytecodeGraphBuilder *this)

{
  ...
  if ((ulong)(*(long *)(lVar7 + 0x30) - *(long *)(lVar7 + 0x28) >> 3) <=
      (ulong)(long)*(int *)(lVar7 + 0x5c)) goto LAB_01677bac;
  ...
  if (local_58[0] == 2) {
    ...
    pNVar4 = local_50;
    if (local_58[0] != 1) goto LAB_01677b0c;
  }
...
LAB_01677b0c:
    pOVar3 = (Operator *)
             JSOperatorBuilder::ToNumeric(*(JSOperatorBuilder **)(*(long *)(this + 0x10) + 0x170));
    local_38 = pNVar8;
