...
/* v8::internal::compiler::JSTypedLowering::ReduceJSNegate(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::JSTypedLowering::ReduceJSNegate(JSTypedLowering *this,Node *param_1)
