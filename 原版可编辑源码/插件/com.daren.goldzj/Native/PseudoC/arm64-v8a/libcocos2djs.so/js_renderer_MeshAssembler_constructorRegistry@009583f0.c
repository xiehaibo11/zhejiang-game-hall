...
/* js_renderer_MeshAssembler_constructorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_MeshAssembler_constructorRegistry(FunctionCallbackInfo *param_1)
