...
undefined8 FUN_014be104(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar11 & 1) == 0) ||
    ...
    uStack_78 = __strlen_chk("Date.prototype.setUTCFullYear",0x1e);
    local_80 = "Date.prototype.setUTCFullYear";
...
LAB_014be298:
      ...
      v8::internal::DateCache::YearMonthDayFromDays
                (*(DateCache **)(param_3 + 0xb638),iVar1,(int *)&local_80,&iStack_34,&local_38);
      ...
      if (!NAN(dVar14)) goto LAB_014be298;
      dVar16 = 1.0;
      dVar14 = 0.0;
      dVar17 = 0.0;
    }
    if (1 < param_1 + -5) {
      ...
      if (puVar9 == (ulong *)0x0) goto LAB_014be3bc;
      uVar11 = *puVar9;
      if ((uVar11 & 1) == 0) {
