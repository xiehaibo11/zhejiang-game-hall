...
/* js_universe_Downloader2_commitRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_universe_Downloader2_commitRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Downloader2 *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x11a,"js_universe_Downloader2_commit");
    __android_log_print(6,"jswrapper","js_universe_Downloader2_commit : Invalid Native Object");
  }
  else {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp, 289): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_universe_Downloader2_commit",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp"
                      ,0x124);
LAB_00967be8:
