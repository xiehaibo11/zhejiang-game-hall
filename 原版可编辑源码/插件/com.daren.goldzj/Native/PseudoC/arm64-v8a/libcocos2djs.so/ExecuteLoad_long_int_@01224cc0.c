...
/* bool v8::internal::wasm::ThreadImpl::ExecuteLoad<long, int>(v8::internal::wasm::Decoder*,
   v8::internal::wasm::InterpreterCode*, unsigned long, int*, v8::internal::MachineRepresentation,
   int) */

bool __thiscall
v8::internal::wasm::ThreadImpl::ExecuteLoad<long,int>
...

{
  ...
  *(long *)(this + 0x28) = lVar8 + -0x11;
  ...
  if (!CARRY4(local_a0._1_4_,uVar12)) {
    ...
    if (((3 < *(ulong *)(lVar8 + 0x13)) && ((ulong)uVar2 <= *(ulong *)(lVar8 + 0x13) - 4)) &&
       (piVar3 = (int *)((*(ulong *)(lVar8 + 0x1b) & (ulong)uVar2) + *(long *)(lVar8 + 0xb)),
       piVar3 != (int *)0x0)) {
      iVar4 = *piVar3;
      iStack_b7 = (int7)iVar4;
      bStack_b0 = (byte)(iVar4 >> 0x1f);
