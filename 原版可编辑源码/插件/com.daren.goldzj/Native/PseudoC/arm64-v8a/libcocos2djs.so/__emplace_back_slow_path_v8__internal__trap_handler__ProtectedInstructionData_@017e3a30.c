...
/* void std::__ndk1::vector<v8::internal::trap_handler::ProtectedInstructionData,
   std::__ndk1::allocator<v8::internal::trap_handler::ProtectedInstructionData>
   >::__emplace_back_slow_path<v8::internal::trap_handler::ProtectedInstructionData>(v8::internal::trap_handler::ProtectedInstructionData&&)
    */
...
::__emplace_back_slow_path<v8::internal::trap_handler::ProtectedInstructionData>
          (vector<v8::internal::trap_handler::ProtectedInstructionData,std::__ndk1::allocator<v8::internal::trap_handler::ProtectedInstructionData>>
           *this,ProtectedInstructionData *param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_017e3b18;
