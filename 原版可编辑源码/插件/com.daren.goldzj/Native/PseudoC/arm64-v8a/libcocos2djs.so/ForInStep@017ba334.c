...
/* v8::internal::interpreter::BytecodeArrayBuilder::ForInStep(v8::internal::interpreter::Register)
    */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::ForInStep(BytecodeArrayBuilder *this,int param_2)
