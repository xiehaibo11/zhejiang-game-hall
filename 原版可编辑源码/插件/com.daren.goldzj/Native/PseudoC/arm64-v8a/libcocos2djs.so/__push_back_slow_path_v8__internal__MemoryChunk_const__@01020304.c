...
/* void std::__ndk1::vector<v8::internal::MemoryChunk*,
   std::__ndk1::allocator<v8::internal::MemoryChunk*>
   >::__push_back_slow_path<v8::internal::MemoryChunk* const&>(v8::internal::MemoryChunk* const&) */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_010203ec;
