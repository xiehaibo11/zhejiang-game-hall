...
void FUN_0108998c(long param_1,long param_2,int param_3,long param_4,byte param_5,int param_6,
                 uint param_7)
  ...
  if ((int)param_7 < 0) {
    ...
    if (0 < (int)uVar4) {
      ...
      if (uVar4 < 8) {
        ...
        if (uVar8 == uVar6) goto LAB_01089a60;
      }
      lVar7 = uVar6 - uVar8;
