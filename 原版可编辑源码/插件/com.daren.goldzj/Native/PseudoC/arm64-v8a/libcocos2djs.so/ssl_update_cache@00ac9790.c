...
joined_r0x00ac9860:
  if (((uVar2 >> 7 & 1) == 0) && ((uVar2 & param_2) == param_2)) {
    ...
    if ((~*piVar1 & 0xffU) == 0) {
      tm = time((time_t *)0x0);
                    /* try { // try from 00ac9808 to 00bc9813 has its CatchHandler @ 00ac98bc */
