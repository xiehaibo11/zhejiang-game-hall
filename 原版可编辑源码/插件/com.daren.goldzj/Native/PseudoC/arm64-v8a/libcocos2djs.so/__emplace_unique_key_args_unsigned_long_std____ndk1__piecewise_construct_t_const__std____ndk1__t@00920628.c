...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<unsigned
   ...
   cocos2d::renderer::Technique::Parameter> > >::__emplace_unique_key_args<unsigned long,
...

{
  ...
  if (uVar7 != 0) {
    ...
    if (puVar6 != (ulong *)0x0) {
      do {
        puVar6 = (ulong *)*puVar6;
        if (puVar6 == (ulong *)0x0) goto LAB_009206dc;
        uVar5 = puVar6[1];
        if (uVar5 != uVar8) {
          if ((uVar3 & uVar7) == 0) {
            uVar5 = uVar5 & uVar3;
            ...
            if (uVar5 - uVar1 * uVar7 == unaff_x24) goto LAB_009206c8;
            goto LAB_009206dc;
          }
          if (uVar5 != unaff_x24) goto LAB_009206dc;
        }
LAB_009206c8:
...
LAB_009206dc:
  ...
  puVar6[2] = **(ulong **)param_4;
  cocos2d::renderer::Technique::Parameter::Parameter((Parameter *)(puVar6 + 3));
  *puVar6 = 0;
  puVar6[1] = uVar8;
