...
/* js_cocos2dx_dragonbones_Animation_gotoAndStopByTimeRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_Animation_gotoAndStopByTimeRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Animation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x17dd,"js_cocos2dx_dragonbones_Animation_gotoAndStopByTime");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_Animation_gotoAndStopByTime : Invalid Native Object"
                       );
  }
  else {
...
LAB_00cbef54:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                            ,uVar10,"js_cocos2dx_dragonbones_Animation_gotoAndStopByTime");
        __android_log_print(6,"jswrapper",
                            "js_cocos2dx_dragonbones_Animation_gotoAndStopByTime : Error processing arguments"
                           );
        bVar3 = false;
      }
      else {
        ptVar7 = (type *)dragonBones::Animation::gotoAndStopByTime
...
LAB_00cbeea0:
      ...
      if (lVar11 == 1) {
        ...
        if ((uVar6 & 1) == 0) {
          ...
          bVar3 = native_ptr_to_rooted_seval<dragonBones::AnimationState>(ptVar7,pVVar8,(bool *)0x0)
          ;
          if (bVar3) goto LAB_00cbeea0;
          uVar10 = 0x17e7;
        }
        goto LAB_00cbef54;
      }
      __android_log_print(6,"jswrapper",&DAT_0193df72,(ulong)(plVar5[1] - *plVar5) >> 4,2);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_Animation_gotoAndStopByTime",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x17f8);
LAB_00cbefb4:
  pVVar8 = (Value *)se::State::rval(aSStack_70);
