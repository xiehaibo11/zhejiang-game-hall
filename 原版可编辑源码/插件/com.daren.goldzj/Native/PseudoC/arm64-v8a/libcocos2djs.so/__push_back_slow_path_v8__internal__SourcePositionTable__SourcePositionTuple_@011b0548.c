...
/* void std::__ndk1::vector<v8::internal::SourcePositionTable::SourcePositionTuple,
   std::__ndk1::allocator<v8::internal::SourcePositionTable::SourcePositionTuple>
   >::__push_back_slow_path<v8::internal::SourcePositionTable::SourcePositionTuple>(v8::internal::SourcePositionTable::SourcePositionTuple&&)
    */
...
::__push_back_slow_path<v8::internal::SourcePositionTable::SourcePositionTuple>
          (vector<v8::internal::SourcePositionTable::SourcePositionTuple,std::__ndk1::allocator<v8::internal::SourcePositionTable::SourcePositionTuple>>
           *this,SourcePositionTuple *param_1)

{
  ...
  if (uVar1 < 0x1555555555555556) {
    ...
    if (uVar1 == 0) {
      ...
      if (0x1555555555555555 < uVar1) goto LAB_011b0654;
