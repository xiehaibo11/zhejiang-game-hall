...
undefined8 FUN_011cbd7c(undefined8 param_1,ulong *param_2,Factory *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0x1a4);
  }
  if (DAT_01d3fab0 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d3fab0 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar2 = DAT_01d3fab0;
  local_a0 = (byte **)0x0;
  if ((*DAT_01d3fab0 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar2,"V8.Runtime_Runtime_JSReceiverSetPrototypeOfDontThrow",0,0
    ...
    local_a0 = &local_98;
    local_90 = "V8.Runtime_Runtime_JSReceiverSetPrototypeOfDontThrow";
    local_98 = pbVar2;
    local_88 = uVar5;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar7 & 1) != 0) &&
    ...
    uVar3 = v8::internal::JSReceiver::SetPrototype(param_2,param_2 + -1,1,1);
    if ((uVar3 & 0xff) == 0) {
