...
uint FUN_00b695ac(void *param_1,void *param_2,int param_3)

{
  ...
  if (iVar6 < iVar4 + -1) {
    ...
    case 7:
      ...
      break;
    case 0xf:
                    /* catch() { ... } // from try @ 00b69434 with catch @ 00b696c0 */
      uVar9 = 4;
      break;
    case 0x1f:
      uVar9 = 3;
    ...
    default:
      if (bVar3 == 0x3f) {
                    /* catch() { ... } // from try @ 00b69424 with catch @ 00b696d0 */
        uVar9 = 2;
      }
      else {
        if (bVar3 != 0x7f) {
        ...
        uVar9 = 1;
                    ...
                    /* catch() { ... } // from try @ 00b69454 with catch @ 00b696d4 */
    uVar5 = 0xffffffff;
