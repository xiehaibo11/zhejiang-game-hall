...
/* v8::internal::compiler::GraphAssembler::LoadField(v8::internal::compiler::FieldAccess const&,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::LoadField
          (GraphAssembler *this,FieldAccess *param_1,Node *param_2)
