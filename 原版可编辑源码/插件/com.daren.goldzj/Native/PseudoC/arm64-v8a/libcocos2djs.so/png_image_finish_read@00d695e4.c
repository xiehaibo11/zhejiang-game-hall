    ...
    if ((param_3 != 0) && (*param_1 != 0)) {
      ...
      if ((uint)(iVar3 * *(int *)((long)param_1 + 0xc)) <= uVar2) {
        if (((uVar1 >> 3 & 1) == 0) || ((param_5 != 0 && (*(int *)((long)param_1 + 0x1c) != 0)))) {
          ...
          uStack_70 = param_2;
          if ((uVar1 >> 3 & 1) == 0) {
            uVar2 = png_safe_execute(param_1,FUN_00d6b078,&local_90);
          }
          else {
            iVar3 = png_safe_execute(param_1,FUN_00d6976c,&local_90);
            if (iVar3 == 0) {
              uVar2 = 0;
            }
            else {
              iVar3 = png_safe_execute(param_1,FUN_00d6ae10,&local_90);
              uVar2 = (uint)(iVar3 != 0);
            }
          }
