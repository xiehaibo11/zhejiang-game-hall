...
/* bool 
   spine_Vector_T_ptr_to_seval<spine::PathConstraintData>(spine::Vector<spine::PathConstraintData*>
   const&, se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::PathConstraintData>(Vector *param_1,Value *param_2)
...
LAB_00c8a9c0:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::PathConstraintData>
