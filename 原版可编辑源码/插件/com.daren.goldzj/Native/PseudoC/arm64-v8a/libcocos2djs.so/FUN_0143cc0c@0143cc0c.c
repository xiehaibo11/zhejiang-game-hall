...
void FUN_0143cc0c(undefined8 param_1,long param_2,undefined8 param_3,uint param_4)

{
  ...
  if ((int)lVar3 != (int)*(undefined8 *)(unaff_x26 + 0xa0)) {
    lVar1 = (ulong)*(byte *)(lVar2 + unaff_x19 + 1) * 4 + 0x1f;
    ...
    if (uVar4 != param_4) {
      ...
      *(undefined4 *)(lVar3 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0143cc84. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(unaff_x21 + (ulong)*(byte *)(lVar2 + unaff_x19 + 2) * 8))();
  return;
}
