...
/* js_renderer_Scene_resetRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Scene_resetRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Scene *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xc9e,"js_renderer_Scene_reset");
    __android_log_print(6,"jswrapper","js_renderer_Scene_reset : Invalid Native Object");
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      cocos2d::renderer::Scene::reset(this);
      goto LAB_0094f000;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 3237): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Scene_reset",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0xca8);
LAB_0094f000:
