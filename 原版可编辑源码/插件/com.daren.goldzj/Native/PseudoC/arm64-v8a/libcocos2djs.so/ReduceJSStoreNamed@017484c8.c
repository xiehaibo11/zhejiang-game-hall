...
/* v8::internal::compiler::JSNativeContextSpecialization::ReduceJSStoreNamed(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::JSNativeContextSpecialization::ReduceJSStoreNamed
...

{
  ...
  if ((puVar2[1] == 0) || (*(int *)(puVar2 + 2) == -1)) {
    ...
    local_58 = puVar2[1];
    uVar3 = ReducePropertyAccess(this,param_1,0,local_70,uVar3,&local_58,1);
  }
