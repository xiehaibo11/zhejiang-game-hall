...
/* js_cocos2dx_spine_SkeletonCacheAnimation_setToSetupPoseRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonCacheAnimation_setToSetupPoseRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonCacheAnimation *)0x0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonCacheAnimation_setToSetupPose : Invalid Native Object"
                       );
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      spine::SkeletonCacheAnimation::setToSetupPose(this);
      goto LAB_00c80b1c;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 15657): wrong number of arguments: %d, was expecting %d\n"
