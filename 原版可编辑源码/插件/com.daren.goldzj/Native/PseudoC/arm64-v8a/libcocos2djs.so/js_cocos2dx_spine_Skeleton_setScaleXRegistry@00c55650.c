...
/* js_cocos2dx_spine_Skeleton_setScaleXRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Skeleton_setScaleXRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Skeleton *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x23d7,"js_cocos2dx_spine_Skeleton_setScaleX");
    pcVar6 = "js_cocos2dx_spine_Skeleton_setScaleX : Invalid Native Object";
LAB_00c557c4:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Skeleton::setScaleX(this,local_64);
        goto LAB_00c557fc;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x23de,"js_cocos2dx_spine_Skeleton_setScaleX");
      pcVar6 = "js_cocos2dx_spine_Skeleton_setScaleX : Error processing arguments";
      goto LAB_00c557c4;
    }
    __android_log_print(6,"jswrapper",&DAT_01910883,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Skeleton_setScaleX",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x23e5);
LAB_00c557fc:
