...
/* v8::internal::JSWeakCollection::Delete(v8::internal::Handle<v8::internal::JSWeakCollection>,
   v8::internal::Handle<v8::internal::Object>, int) */

undefined1
v8::internal::JSWeakCollection::Delete(ulong *param_1,undefined8 param_2,undefined4 param_3)

{
  ...
  puVar5 = (ulong *)ObjectHashTableBase<v8::internal::EphemeronHashTable,v8::internal::EphemeronHashTableShape>
                    ::Remove((ulong)*(uint *)((long)param_1 + 4) << 0x20,puVar4,param_2,local_44,
                             param_3);
  uVar8 = *param_1;
  uVar9 = *puVar5;
