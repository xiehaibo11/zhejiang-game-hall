...
void FUN_01848da8(long param_1,undefined8 *param_2)

{
  ...
  if (uVar1 < (ulong)param_2[2]) {
    ...
    *param_2 = pvVar2;
    if (pvVar2 == (void *)0x0) goto LAB_018490d0;
    lVar6 = param_2[1];
  }
  *(undefined1 *)((long)pvVar2 + lVar6) = 0x28;
  param_2[1] = param_2[1] + 1;
  FUN_01844180(param_1 + 0x20,param_2);
  lVar6 = param_2[1];
  uVar1 = lVar6 + 1;
  if (uVar1 < (ulong)param_2[2]) {
    pvVar2 = (void *)*param_2;
...
LAB_018490d0:
    ...
    *(undefined2 *)((long)pvVar2 + lVar6) = 0x2620;
    ...
    if (*(char *)(param_1 + 0x3c) != '\x01') goto LAB_01849080;
    lVar6 = param_2[1];
    uVar1 = lVar6 + 2;
    if (uVar1 < (ulong)param_2[2]) {
      pvVar2 = (void *)*param_2;
...
LAB_01849080:
  ...
  if ((plVar3 != (long *)0x0) &&
     ((**(code **)(*plVar3 + 0x20))(plVar3,param_2), *(char *)((long)plVar3 + 9) != '\x01')) {
                    /* WARNING: Could not recover jumptable at 0x018490cc. Too many branches */
