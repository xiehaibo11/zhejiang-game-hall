...
/* void std::__ndk1::vector<v8::JitCodeEvent::line_info_t,
   std::__ndk1::allocator<v8::JitCodeEvent::line_info_t>
   >::__push_back_slow_path<v8::JitCodeEvent::line_info_t>(v8::JitCodeEvent::line_info_t&&) */
...

{
  ...
  if (uVar1 < 0xaaaaaaaaaaaaaab) {
    ...
    if (uVar1 == 0) {
      ...
      if (0xaaaaaaaaaaaaaaa < uVar1) goto LAB_01061f18;
