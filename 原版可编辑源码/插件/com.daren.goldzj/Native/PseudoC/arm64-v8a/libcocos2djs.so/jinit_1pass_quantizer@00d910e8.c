...

{
  ...
  puVar7[0xe] = 0;
  *puVar7 = FUN_00d915c4;
  puVar7[3] = FUN_00d91878;
  puVar7[2] = FUN_00d91874;
  puVar7[10] = 0;
...
LAB_00d91260:
        ...
        uVar16 = uVar1 | 1;
        if (uVar13 != uVar1) goto LAB_00d91260;
      }
    } while (lVar18 <= lVar23);
    iVar29 = (int)lVar12;
  }
...
LAB_00d91324:
    ...
    if ((uVar2 & 7) == 0) goto LAB_00d91344;
  }
...
LAB_00d91344:
  ...
  do {
    ...
    do {
      uVar21 = uVar11 & 0xffffffff;
      piVar15 = (int *)(lVar22 + (long)(int)(&DAT_0194f930)[lVar12] * 4 + 0x3c);
      iVar29 = *piVar15;
      iVar14 = 0;
      if (iVar29 != 0) {
        iVar14 = (int)uVar11 / iVar29;
