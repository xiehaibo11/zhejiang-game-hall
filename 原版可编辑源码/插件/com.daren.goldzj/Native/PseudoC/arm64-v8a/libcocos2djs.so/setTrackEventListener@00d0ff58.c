...
/* spine::SkeletonAnimation::setTrackEventListener(spine::TrackEntry*, std::__ndk1::function<void
   (spine::TrackEntry*, spine::Event*)> const&) */
...

{
  ...
  if (lVar5 == 0) {
    ...
    *(undefined8 *)(param_1 + 0x18) = 0;
    ...
    if (plVar2 == (long *)0x0) goto LAB_00d0fffc;
LAB_00d0ff8c:
    ...
    plVar2 = *(long **)(param_2 + 0x20);
    if (plVar2 != (long *)0x0) goto LAB_00d0ff8c;
LAB_00d0fffc:
    local_50 = (long *)0x0;
  }
  FUN_00c8bf7c(alStack_70,lVar5 + 0xf0);
  if (alStack_70 == local_50) {
    pcVar4 = *(code **)(*local_50 + 0x20);
  }
  else {
    if (local_50 == (long *)0x0) goto LAB_00d10054;
