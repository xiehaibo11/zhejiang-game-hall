...
undefined4 FUN_00b721f0(long param_1,undefined4 *param_2)

{
  ...
  case 1:
    ...
    if (pcVar11 == (char *)0x0) goto LAB_00b724d8;
    if (pcVar5 == (char *)0x0) {
      if (*pcVar4 == '.') {
        iVar3 = *piVar12;
        iVar1 = *piVar10;
