...
/* void JSBClassType::registerClass<spine::CacheModeAttachUtil>(se::Class*) */

void JSBClassType::registerClass<spine::CacheModeAttachUtil>(Class *param_1)
