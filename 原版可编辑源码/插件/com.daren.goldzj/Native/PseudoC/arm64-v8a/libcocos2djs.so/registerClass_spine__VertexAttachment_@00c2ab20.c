...
/* void JSBClassType::registerClass<spine::VertexAttachment>(se::Class*) */

void JSBClassType::registerClass<spine::VertexAttachment>(Class *param_1)
