...
/* void 
   v8::internal::WeakCell::BodyDescriptor::IterateBody<v8::internal::IterateAndScavengePromotedObjectsVisitor>(v8::internal::Map,
   v8::internal::HeapObject, int, v8::internal::IterateAndScavengePromotedObjectsVisitor*) */

void v8::internal::WeakCell::BodyDescriptor::
...

{
  ...
  (**(code **)(*param_4 + 0x20))(param_4,param_2,puVar2,puVar3);
