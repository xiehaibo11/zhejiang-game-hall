...
undefined8 FUN_00b5e714(long param_1)

{
  ...
  if (((lVar24 == 0) || ((*(uint *)(lVar24 + 0x28) & 3) != 0)) ||
    ...
    {
      uVar26 = uVar26 | 2;
                    /* try { // try from 00b5e7e4 to 00c5e7eb has its CatchHandler @ 00b5e8e8 */
      bVar1 = true;
      local_8c = 0;
                    /* try { // try from 00b5e7ec to 00c5e957 has its CatchHandler @ 00b5e5d8 */
      if (lVar13 == 0) goto LAB_00b5e804;
    }
    else {
...
LAB_00b5e7f0:
    ...
    if (lVar13 != 0) goto joined_r0x00b5e7fc;
    iVar5 = 0x6a;
    iVar6 = 0xb6b;
LAB_00b5ec5c:
...
joined_r0x00b5e7fc:
    ...
    if (uVar26 != 0) {
      ...
      do {
        local_70 = (X509 *)0x0;
        uVar4 = uVar26;
        if (uVar19 == 0) goto joined_r0x00b5eb0c;
LAB_00b5e9b0:
        local_70 = (X509 *)0x0;
        ...
        if (iVar7 <= iVar5) {
          ...
          *(undefined8 *)(param_1 + 0x98) = 0;
                    /* try { // try from 00b5e9f8 to 00c5e9ff has its CatchHandler @ 00b5ea6c */
          iVar8 = (**(code **)(param_1 + 0x40))(&local_70,param_1,pXVar12);
          *(undefined8 *)(param_1 + 0x98) = uVar15;
                    /* try { // try from 00b5ea00 to 00c5ea27 has its CatchHandler @ 00b5e958 */
          if (iVar8 < 0) {
...
LAB_00b5ed10:
          ...
          if (iVar8 == 0) goto joined_r0x00b5eb44;
          if (uVar26 >> 2 == 0) {
LAB_00b5eb1c:
            if (uVar25 == 0) goto LAB_00b5eab0;
            if (iVar7 == *(int *)(param_1 + 0x94)) {
              iVar9 = X509_cmp(pXVar12,local_70);
              if (iVar9 != 0) {
                X509_free(local_70);
                goto joined_r0x00b5eb44;
              }
              X509_free(pXVar12);
              iVar7 = iVar7 + -1;
            ...
            uVar26 = uVar26 & 0xfffffffb;
                    /* try { // try from 00b5ea28 to 00c5ea2f has its CatchHandler @ 00b5ea74 */
            while( true ) {
            ...
            *(int *)(param_1 + 0x94) = iVar9;
            iVar7 = iVar9;
            if (lVar24 == 0) goto LAB_00b5eb1c;
            iVar9 = OPENSSL_sk_num(*(undefined8 *)(lVar24 + 8));
                    /* try { // try from 00b5ea64 to 00c5ea6b has its CatchHandler @ 00b5ea6c */
                    /* catch() { ... } // from try @ 00b5e9f8 with catch @ 00b5ea6c
                       catch() { ... } // from try @ 00b5ea64 with catch @ 00b5ea6c
                       try { // try from 00b5ea6c to 00c5eaef has its CatchHandler @ 00b5e958 */
            if ((0 < iVar9) && (*(int *)(param_1 + 0x94) <= *(int *)(lVar24 + 0x2c))) {
                    /* catch() { ... } // from try @ 00b5ea28 with catch @ 00b5ea74 */
...
LAB_00b5ed00:
          ...
          iVar10 = FUN_00b618e8(param_1,iVar7);
          if (iVar10 - 1U < 2) goto LAB_00b5ed14;
          uVar26 = uVar26 & 0xfffffffe;
          if (uVar25 == 0) goto joined_r0x00b5e970;
        }
joined_r0x00b5eb44:
        uVar4 = uVar26;
        if ((uVar26 & 1) != 0) {
joined_r0x00b5eb0c:
          uVar19 = uVar26 & 1;
          uVar26 = uVar4;
          if (uVar19 == 0) goto joined_r0x00b5e970;
          ...
          if (((uVar25 == 0) && (iVar9 <= iVar5)) && (iVar9 = OPENSSL_sk_num(lVar13), 0 < iVar9)) {
            ...
            do {
              ...
              if ((iVar7 != 0) &&
                ...
                local_70 = pXVar12;
                if (pXVar12 == (X509 *)0x0) goto LAB_00b5e98c;
                ...
                if (iVar10 == 0) {
                  ...
                  goto LAB_00b5ed00;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b5e7e4 with catch @ 00b5e8e8
                        */
                ...
                *(int *)(param_1 + 0x94) = *(int *)(param_1 + 0x94) + 1;
                ...
                if (*(long *)(param_1 + 0xe8) != 0) {
                  ...
                  goto joined_r0x00b5e970;
                  lVar14 = OPENSSL_sk_value(*(undefined8 *)(param_1 + 0x98),iVar7);
                  if (lVar14 != 0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b5e62c with catch @ 00b5e954
                        */
                    /* try { // try from 00b5e958 to 00c5e9f7 has its CatchHandler @ 00b5e958
                       catch() { ... } // from try @ 00b5e958 with catch @ 00b5e958
                       catch() { ... } // from try @ 00b5ea00 with catch @ 00b5e958
                       catch() { ... } // from try @ 00b5ea6c with catch @ 00b5e958 */
                    iVar10 = FUN_00b61bbc(*(undefined4 *)(param_1 + 0x94),
                                          *(undefined8 *)(param_1 + 0xe8),lVar14,iVar7);
                    if (iVar10 < 0) goto LAB_00b5ed10;
                    if (iVar10 != 0) {
                      iVar10 = 1;
...
LAB_00b5e98c:
          ...
          if (!bVar1) goto joined_r0x00b5e970;
          uVar26 = uVar26 | 2;
          goto LAB_00b5e9b0;
        }
        if (uVar26 >> 2 == 0) {
          if ((local_8c == 0) || (*(int *)(param_1 + 0x94) < 2)) goto LAB_00b5ed14;
          uVar25 = 0;
          iVar6 = *(int *)(param_1 + 0x94) + -1;
          uVar4 = uVar26 | 4;
          goto joined_r0x00b5eb0c;
        }
        iVar9 = iVar6 + -1;
        bVar2 = iVar6 < 1;
        iVar6 = iVar9;
        if (iVar9 == 0 || bVar2) goto LAB_00b5ed14;
joined_r0x00b5e970:
        if (uVar26 == 0) goto LAB_00b5ed14;
        uVar19 = uVar26 >> 1 & 1;
      } while( true );
    }
    iVar10 = 3;
...
LAB_00b5edf8:
      if (iVar10 != 1) {
        if (iVar10 == 2) goto LAB_00b5f5a4;
        goto LAB_00b5ee08;
      }
    }
    else {
      if ((lVar24 == 0) || (iVar10 != 3)) {
        if (iVar10 != 3) goto LAB_00b5edf8;
      }
      else if ((*(byte *)(lVar24 + 0x28) >> 2 & 1) != 0) {
...
LAB_00b5ed80:
          ...
          *(int *)(lVar13 + 0x2c) = iVar10;
                    /* catch() { ... } // from try @ 00b5f510 with catch @ 00b5f62c
                       catch() { ... } // from try @ 00b5f5ec with catch @ 00b5f62c */
...
LAB_00b5eddc:
      if (iVar6 == *(int *)(param_1 + 0x94)) {
        iVar10 = FUN_00b618e8(param_1,iVar6);
        goto LAB_00b5edf8;
      }
LAB_00b5ee08:
      iVar6 = OPENSSL_sk_num(*(undefined8 *)(param_1 + 0x98));
      if (iVar5 < iVar6) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b5ee80 with catch @ 00b5ee24
                       catch(type#1 @ 00000000) { ... } // from try @ 00b5f038 with catch @ 00b5ee24
                        */
        ...
        *(int *)(param_1 + 0xac) = iVar6 + -1;
                    /* try { // try from 00b5ee78 to 00c5ee7f has its CatchHandler @ 00b5f154 */
        uVar15 = OPENSSL_sk_value(*(undefined8 *)(param_1 + 0x98));
        pcVar20 = *(code **)(param_1 + 0x38);
                    /* try { // try from 00b5ee80 to 00c5f02f has its CatchHandler @ 00b5ee24 */
        *(undefined8 *)(param_1 + 0xb8) = uVar15;
        uVar22 = 0x41;
      }
      *(undefined4 *)(param_1 + 0xb0) = uVar22;
      iVar5 = (*pcVar20)(0,param_1);
      if (iVar5 == 0) goto LAB_00b5f5a4;
    }
LAB_00b5ef18:
    iVar5 = OPENSSL_sk_num(*(undefined8 *)(param_1 + 0x98));
...
LAB_00b5f044:
          ...
          if (1 < uVar26) {
LAB_00b5f034:
                    /* try { // try from 00b5f038 to 00c5f157 has its CatchHandler @ 00b5ee24 */
...
LAB_00b5f040:
          ...
          if (iVar9 + 1 < iVar5) {
            if (uVar26 != 1) goto LAB_00b5f040;
          }
          else {
                    /* try { // try from 00b5f030 to 00c5f037 has its CatchHandler @ 00b5f140 */
            if (uVar26 != 1) goto LAB_00b5f034;
          }
        }
        if (0 < iVar6) {
          if ((iVar9 < *(int *)(param_1 + 0x94)) ||
...
LAB_00b5f0e4:
              ...
              *(undefined4 *)(param_1 + 0xb0) = 0x1a;
              ...
              if (iVar8 == 0) goto LAB_00b5f5a4;
            }
          }
          else {
            iVar11 = X509_check_trust(pXVar12,*(int *)(*(long *)(param_1 + 0x20) + 0x24),4);
            if (iVar11 != 1) {
              if (iVar11 != 2) goto LAB_00b5f0b8;
              goto LAB_00b5f0e4;
            }
          }
        }
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b5f030 with catch @ 00b5f140
                        */
        if ((((1 < iVar9) && ((*(byte *)&pXVar12[1].sig_alg >> 5 & 1) == 0)) &&
           ...
           ((long)&pXVar12->aux->trust + (long)iVar10 + 1 < (long)iVar7)) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b5ee78 with catch @ 00b5f154
                        */
                    /* try { // try from 00b5f158 to 00c5f1f7 has its CatchHandler @ 00b5f158
                       catch() { ... } // from try @ 00b5f158 with catch @ 00b5f158
                       catch() { ... } // from try @ 00b5f200 with catch @ 00b5f158
                       catch() { ... } // from try @ 00b5f264 with catch @ 00b5f158 */
          *(X509 **)(param_1 + 0xb8) = pXVar12;
          *(int *)(param_1 + 0xac) = iVar9;
    ...
    if ((0 < iVar5) && (0 < *(int *)(*(long *)(param_1 + 0x20) + 0x2c))) {
                    /* try { // try from 00b5f1f8 to 00c5f1ff has its CatchHandler @ 00b5f264 */
      iVar6 = 0;
                    /* try { // try from 00b5f200 to 00c5f227 has its CatchHandler @ 00b5f158 */
      do {
        lVar24 = OPENSSL_sk_value(*(undefined8 *)(param_1 + 0x98),iVar6);
        if (0 < iVar6) {
                    /* try { // try from 00b5f228 to 00c5f22f has its CatchHandler @ 00b5f26c */
          lVar13 = X509_get0_pubkey(lVar24);
          if (lVar13 == 0) {
LAB_00b5f25c:
                    /* try { // try from 00b5f25c to 00c5f263 has its CatchHandler @ 00b5f264 */
                    /* catch() { ... } // from try @ 00b5f1f8 with catch @ 00b5f264
                       catch() { ... } // from try @ 00b5f25c with catch @ 00b5f264
                       try { // try from 00b5f264 to 00c5f28f has its CatchHandler @ 00b5f158 */
            *piVar3 = iVar6;
            lVar13 = lVar24;
            if (lVar24 == 0) {
                    /* catch() { ... } // from try @ 00b5f228 with catch @ 00b5f26c */
            ...
            *(undefined4 *)(param_1 + 0xb0) = 0x43;
            ...
            if (0 < iVar10) {
              ...
              if (iVar9 < (int)(&UINT_018bf4b8)[iVar10]) goto LAB_00b5f25c;
            }
          }
        }
        if (iVar6 < iVar5 + -1) {
...
LAB_00b5f2f4:
              ...
              if (md == (EVP_MD *)0x0) goto LAB_00b5f2f4;
              iVar9 = EVP_MD_size(md);
              iVar9 = iVar9 << 2;
            }
            if (iVar9 < (int)(&UINT_018bf4b8)[iVar10]) {
              *piVar3 = iVar6;
              if (lVar24 == 0) {
                lVar24 = OPENSSL_sk_value(*(undefined8 *)(param_1 + 0x98),iVar6);
              }
        ...
        if ((iVar6 == 0) || ((*(uint *)&pXVar12[1].sig_alg >> 5 & 1) == 0)) {
          if ((*(uint *)&pXVar12[1].sig_alg >> 10 & 1) != 0) {
            ...
            name = X509_get_issuer_name(pXVar12);
                    /* try { // try from 00b5f40c to 00c5f50f has its CatchHandler @ 00b5f40c
                       catch() { ... } // from try @ 00b5f40c with catch @ 00b5f40c
                       catch() { ... } // from try @ 00b5f518 with catch @ 00b5f40c
                       catch() { ... } // from try @ 00b5f5a0 with catch @ 00b5f40c
                       catch() { ... } // from try @ 00b5f5fc with catch @ 00b5f40c */
...
LAB_00b5f470:
              ...
              if (iVar9 != iVar7 + 1) goto LAB_00b5f470;
              ...
              if (iVar9 == iVar7) goto LAB_00b5f470;
...
LAB_00b5f490:
          ...
          while (iVar5 < iVar10) {
            ...
            if (nc != (NAME_CONSTRAINTS *)0x0) {
              ...
              if (iVar9 != 0) {
                if (iVar9 == 0x11) goto LAB_00b5f5a4;
                *(int *)(param_1 + 0xac) = iVar6;
                *(int *)(param_1 + 0xb0) = iVar9;
                *(X509 **)(param_1 + 0xb8) = pXVar12;
                iVar9 = (**(code **)(param_1 + 0x38))(0,param_1);
                if (iVar9 == 0) goto LAB_00b5f5a4;
              }
            }
          }
        }
                    /* try { // try from 00b5f510 to 00c5f517 has its CatchHandler @ 00b5f62c */
        bVar1 = 1 < iVar5;
        iVar5 = iVar6;
      } while (bVar1);
    }
                    /* try { // try from 00b5f518 to 00c5f597 has its CatchHandler @ 00b5f40c */
    iVar5 = FUN_00b6174c(param_1);
    X509_get_pubkey_parameters((EVP_PKEY *)0x0,*(stack_st_X509 **)(param_1 + 0x98));
    if (iVar5 != 0) {
      ...
      if (*(code **)(param_1 + 0x30) == (code *)0x0) {
        uVar15 = FUN_00b609f0(param_1);
        iVar5 = (int)uVar15;
      }
      else {
                    /* try { // try from 00b5f598 to 00c5f59f has its CatchHandler @ 00b5f5fc */
      ...
      if ((int)uVar15 == 0) {
        return uVar15;
                    ...
                    /* try { // try from 00b5f5ec to 00c5f5f3 has its CatchHandler @ 00b5f62c */
      uVar15 = X509v3_addr_validate_path(param_1);
                    /* try { // try from 00b5f5f4 to 00c5f5fb has its CatchHandler @ 00b5f5fc */
      if ((int)uVar15 == 0) {
        return uVar15;
      }
                    /* catch() { ... } // from try @ 00b5f598 with catch @ 00b5f5fc
                       catch() { ... } // from try @ 00b5f5f4 with catch @ 00b5f5fc
                       try { // try from 00b5f5fc to 00c5f647 has its CatchHandler @ 00b5f40c */
...
LAB_00b5edc4:
  iVar7 = iVar7 + 1;
  if (iVar9 <= iVar7) goto LAB_00b5eddc;
  goto LAB_00b5ed80;
}
