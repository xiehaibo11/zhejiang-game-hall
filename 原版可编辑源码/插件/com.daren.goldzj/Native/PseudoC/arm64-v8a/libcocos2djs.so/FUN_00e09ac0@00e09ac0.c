...
undefined4 FUN_00e09ac0(long *param_1,int param_2)
      ...
      if (uVar10 == 0) {
        ...
        *(uint *)((long)param_1 + 0x171c) = uVar10;
        if (param_2 == 4) {
          ...
          FUN_00e0d324(param_1,lVar14,uVar9 - uVar11,1);
          lVar8 = *param_1;
        ...
        if (*(int *)((long)param_1 + 0x16fc) != 0) {
          ...
          FUN_00e0d324(param_1,lVar14,uVar9 - uVar11,0);
          lVar8 = *param_1;
          param_1[0x11] = (ulong)*(uint *)((long)param_1 + 0x9c);
          lVar14 = *(long *)(lVar8 + 0x38);
          FUN_00e0d150(lVar14);
...
LAB_00e09be0:
      ...
      if ((int)param_1[0x13] == 0) {
        ...
        *(short *)((long)param_1 + (ulong)bVar4 * 4 + 0xc4) =
        ...
        if (*(int *)((long)param_1 + 0x16fc) == (int)param_1[0x2df] + -1) {
          ...
          FUN_00e0d324(param_1,lVar14,*(uint *)((long)param_1 + 0x9c) - uVar9,0);
          lVar8 = *param_1;
          param_1[0x11] = (ulong)*(uint *)((long)param_1 + 0x9c);
          lVar14 = *(long *)(lVar8 + 0x38);
          FUN_00e0d150(lVar14);
    ...
    bVar4 = (&DAT_01974b80)[uVar10 + 0xfd & 0xff];
    ...
    *(short *)((long)param_1 + (ulong)(byte)(&DAT_01974980)[uVar10] * 4 + 0x9b8) =
         *(short *)((long)param_1 + (ulong)(byte)(&DAT_01974980)[uVar10] * 4 + 0x9b8) + 1;
    ...
    *(uint *)((long)param_1 + 0x9c) = uVar10;
    if (iVar3 == (int)lVar14 + -1) {
      ...
      FUN_00e0d324(param_1,lVar14,uVar10 - uVar9,0);
      lVar8 = *param_1;
      param_1[0x11] = (ulong)*(uint *)((long)param_1 + 0x9c);
      lVar14 = *(long *)(lVar8 + 0x38);
      FUN_00e0d150(lVar14);
