...
/* v8::internal::AstTraversalVisitor<v8::internal::SourceRangeAstVisitor>::VisitNaryOperation(v8::internal::NaryOperation*)
    */

void __thiscall
v8::internal::AstTraversalVisitor<v8::internal::SourceRangeAstVisitor>::VisitNaryOperation
          (AstTraversalVisitor<v8::internal::SourceRangeAstVisitor> *this,NaryOperation *param_1)
