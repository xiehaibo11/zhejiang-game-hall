...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::InliningPhase>() */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::InliningPhase>(PipelineImpl *this)

{
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFInlining");
  InliningPhase::Run(aIStack_18,pPVar5,pZVar2);
