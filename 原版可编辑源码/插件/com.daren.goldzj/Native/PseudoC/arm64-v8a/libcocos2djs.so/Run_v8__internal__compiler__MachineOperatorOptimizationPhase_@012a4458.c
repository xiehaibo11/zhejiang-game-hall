...
/* void 
   v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::MachineOperatorOptimizationPhase>()
    */
...

{
  ...
  undefined8 local_38;
  MachineOperatorOptimizationPhase aMStack_18 [8];
  
  lVar6 = *(long *)this;
  this_00 = *(PipelineStatistics **)(lVar6 + 0x38);
  if (this_00 != (PipelineStatistics *)0x0) {
    PipelineStatistics::BeginPhase(this_00,"V8.TFMachineOperatorOptimization");
  }
  this_01 = *(ZoneStats **)(lVar6 + 0x30);
  lVar4 = *(long *)(lVar6 + 0xb0);
  if (lVar4 != 0) {
    local_60 = *(undefined8 *)(lVar4 + 0x30);
    *(char **)(lVar4 + 0x30) = "V8.TFMachineOperatorOptimization";
  }
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFMachineOperatorOptimization");
  MachineOperatorOptimizationPhase::Run(aMStack_18,pPVar5,pZVar2);
