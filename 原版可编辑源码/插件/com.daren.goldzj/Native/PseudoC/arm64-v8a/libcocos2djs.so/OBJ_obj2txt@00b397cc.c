...

{
  ...
  if ((no_name != 0) || (uVar5 = OBJ_obj2nid(a), uVar5 == 0)) goto LAB_00b39818;
  if (uVar5 < 0x425) {
    if (*(int *)(&DAT_01c78cf8 + (long)(int)uVar5 * 0x28) == 0) {
      ERR_put_error(8,0x66,0x65,"crypto/objects/obj_dat.c",0x119);
      goto joined_r0x00b39b30;
    }
    pcVar6 = (&PTR_s_undefined_019b2fcb_0x53_01c78cf0)[(long)(int)uVar5 * 5];
    if (pcVar6 == (char *)0x0) goto joined_r0x00b39b30;
LAB_00b39bc0:
    if (buf != (char *)0x0) {
    ...
    if (DAT_01d3aca8 != 0) {
      ...
      local_70[0] = 3;
      local_88 = uVar5;
      lVar15 = OPENSSL_LH_retrieve(DAT_01d3aca8,local_70);
      if (lVar15 == 0) {
        ERR_put_error(8,0x66,0x65,"crypto/objects/obj_dat.c",0x127);
      }
      else {
        pcVar6 = *(char **)(*(long *)(lVar15 + 8) + 8);
        if (pcVar6 != (char *)0x0) goto LAB_00b39bc0;
      }
    }
joined_r0x00b39b30:
    if (uVar5 < 0x425) {
...
LAB_00b39c38:
        ...
        pcVar6 = (&PTR_s_UNDEF_01c78ce8)[(long)(int)uVar5 * 5];
joined_r0x00b39b68:
        if (pcVar6 != (char *)0x0) goto LAB_00b39bc0;
      }
    }
    else if (DAT_01d3aca8 != 0) {
      local_68 = acStack_98;
      local_70[0] = 3;
      local_88 = uVar5;
      lVar15 = OPENSSL_LH_retrieve(DAT_01d3aca8,local_70);
...
joined_r0x00b39930:
          ...
          bVar2 = false;
          if (iVar16 < 1) goto LAB_00b39ac8;
          goto LAB_00b39834;
        }
        if ((bVar3) || (w >> 0x39 == 0)) {
          if (bVar3) goto LAB_00b398c8;
          puVar13 = puVar12 + 1;
          uVar1 = *puVar12;
          uVar9 = (ulong)(char)uVar1;
          w = w << 7;
