...
/* js_cocos2dx_spine_SkeletonAnimation_setInterruptListenerRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonAnimation_setInterruptListenerRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonAnimation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3945,"js_cocos2dx_spine_SkeletonAnimation_setInterruptListener");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonAnimation_setInterruptListener : Invalid Native Object"
                       );
  }
  else {
    ...
    if (puVar4[1] - (long)pVVar5 == 0x10) {
      ...
      if (pVVar5[8] == (Value)0x5) {
        ...
        if ((uVar7 & 1) == 0) goto LAB_00c7ab94;
...
LAB_00c7ab94:
      ...
      spine::SkeletonAnimation::setInterruptListener(this,(function *)alStack_c0);
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 14701): wrong number of arguments: %d, was expecting %d\n"
