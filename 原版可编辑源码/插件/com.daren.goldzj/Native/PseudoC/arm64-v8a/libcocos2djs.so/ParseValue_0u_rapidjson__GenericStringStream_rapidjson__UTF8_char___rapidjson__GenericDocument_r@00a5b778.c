...
{
                    /* try { // try from 00a5b79c to 00b5b7a3 has its CatchHandler @ 00a5b808 */
  switch((int)**(char **)param_1) {
  case 0x5b:
                    /* try { // try from 00a5b7a4 to 00b5b827 has its CatchHandler @ 00a5b6b8 */
  ...
  case 0x79:
  case 0x7a:
    goto switchD_00a5b7a0_caseD_5c;
  case 0x66:
