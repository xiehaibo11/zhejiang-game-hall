...
/* v8::internal::compiler::MapRef::SerializePrototype() */

void __thiscall v8::internal::compiler::MapRef::SerializePrototype(MapRef *this)

{
  ...
  if (*(short *)(*(long *)(this_00 + 0x10) + 0x18) == 0xa2) {
    MapData::SerializePrototype(this_00,*(JSHeapBroker **)(this + 8));
    return;
  }
                    /* WARNING: Subroutine does not return */
