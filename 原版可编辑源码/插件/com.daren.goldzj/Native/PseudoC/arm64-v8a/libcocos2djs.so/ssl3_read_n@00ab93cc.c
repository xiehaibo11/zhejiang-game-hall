...

{
  ...
  if (lVar6 == 0) {
    ...
    if (iVar3 == 0) {
      return -1;
                    ...
                    /* try { // try from 00ab9414 to 00bb941b has its CatchHandler @ 00ab949c */
    lVar6 = *(long *)(param_1 + 0x3b8);
  }
  iVar3 = *(int *)(param_1 + 0x3d4);
                    /* try { // try from 00ab941c to 00bb9487 has its CatchHandler @ 00ab936c */
  uVar2 = ~((int)lVar6 + 4U);
  ...
  if (iVar3 == 0) {
LAB_00ab9484:
                    /* try { // try from 00ab9488 to 00bb9497 has its CatchHandler @ 00ab9498 */
  ...
  *(void **)(param_1 + 0x10d8) = __src_00;
                    /* catch() { ... } // from try @ 00ab93a4 with catch @ 00ab9498
                       catch() { ... } // from try @ 00ab9488 with catch @ 00ab9498
                       try { // try from 00ab9498 to 00bb94ef has its CatchHandler @ 00ab936c */
  *(undefined4 *)(param_1 + 0x10e0) = 0;
LAB_00ab949c:
                    /* catch() { ... } // from try @ 00ab9414 with catch @ 00ab949c */
  ...
  if (iVar9 <= iVar3) {
                    /* try { // try from 00ab9538 to 00bb964b has its CatchHandler @ 00ab9538
                       catch(type#1 @ 00000000) { ... } // from try @ 00ab9538 with catch @ 00ab9538
                       catch(type#1 @ 00000000) { ... } // from try @ 00ab973c with catch @ 00ab9538
                       catch(type#1 @ 00000000) { ... } // from try @ 00ab993c with catch @ 00ab9538
                        */
    ...
    *(int *)(param_1 + 0x3d4) = iVar3;
    if ((*(byte *)(param_1 + 0x1e8) >> 4 & 1) != 0) {
      ...
      ssl3_release_read_buffer(param_1);
                    ...
                    /* try { // try from 00ab964c to 00bb973b has its CatchHandler @ 00ab9954 */
  return -1;
}
