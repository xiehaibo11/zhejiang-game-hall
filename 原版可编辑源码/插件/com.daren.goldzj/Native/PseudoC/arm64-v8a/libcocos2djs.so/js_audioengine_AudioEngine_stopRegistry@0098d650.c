...
/* js_audioengine_AudioEngine_stopRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_audioengine_AudioEngine_stopRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (uVar6 == 0x10) {
    ...
    if ((uVar6 & 1) != 0) {
      cocos2d::AudioEngine::stop(local_64);
      goto LAB_0098d7ac;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_audioengine_auto.cpp"
                        ,0x25c,"js_audioengine_AudioEngine_stop");
    __android_log_print(6,"jswrapper","js_audioengine_AudioEngine_stop : Error processing arguments"
                       );
  }
  else {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_audioengine_auto.cpp, 608): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar6 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_audioengine_AudioEngine_stop",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_audioengine_auto.cpp"
                      ,0x263);
LAB_0098d7ac:
