...
/* v8::internal::compiler::CallHandlerInfoData::Serialize(v8::internal::compiler::JSHeapBroker*) */

void __thiscall
v8::internal::compiler::CallHandlerInfoData::Serialize
          (CallHandlerInfoData *this,JSHeapBroker *param_1)

{
  ...
  if (*(long *)(this + 0x20) == 0) {
    TraceScope::TraceScope((TraceScope *)&local_38,param_1,this,"CallHandlerInfoData::Serialize");
