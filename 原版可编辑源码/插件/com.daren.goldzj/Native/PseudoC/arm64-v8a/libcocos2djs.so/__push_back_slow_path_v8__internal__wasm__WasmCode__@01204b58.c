...
/* void std::__ndk1::vector<v8::internal::wasm::WasmCode*,
   std::__ndk1::allocator<v8::internal::wasm::WasmCode*>
   >::__push_back_slow_path<v8::internal::wasm::WasmCode*>(v8::internal::wasm::WasmCode*&&) */

void __thiscall
std::__ndk1::
vector<v8::internal::wasm::WasmCode*,std::__ndk1::allocator<v8::internal::wasm::WasmCode*>>::
__push_back_slow_path<v8::internal::wasm::WasmCode*>
          (vector<v8::internal::wasm::WasmCode*,std::__ndk1::allocator<v8::internal::wasm::WasmCode*>>
           *this,WasmCode **param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_01204c40;
