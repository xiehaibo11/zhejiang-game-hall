...
/* js_renderer_Effect_clearRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Effect_clearRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Effect *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x27f,"js_renderer_Effect_clear");
    __android_log_print(6,"jswrapper","js_renderer_Effect_clear : Invalid Native Object");
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      cocos2d::renderer::Effect::clear(this);
      goto LAB_0093948c;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 646): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Effect_clear",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0x289);
LAB_0093948c:
