...
LAB_017fa9e0:
  ...
  if ((param_2 == (long *)0x0) || (param_2[3] != param_2[4])) {
    if (param_3 != (long *)0x0) goto LAB_017fa9f4;
LAB_017faa3c:
    param_3 = (long *)0x0;
    if (plVar17 == (long *)0x0) goto LAB_017fab2c;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_017faa3c;
LAB_017fa9f4:
...
LAB_017fab2c:
  ...
  uVar6 = FUN_01828850(pcVar19,local_168,param_5,iVar5);
  *param_6 = uVar6;
  uVar7 = (ulong)((byte)local_148[0] >> 1);
  if (((byte)local_148[0] & 1) != 0) {
    uVar7 = local_140;
  ...
  if (uVar7 != 0) {
    ...
    if (local_12c < puVar9) {
      ...
      do {
        if ((bVar16) && (*puVar15 != uVar10)) goto LAB_017fac80;
...
LAB_017fac80:
  ...
  if ((plVar17 == (long *)0x0) || (plVar17[3] != plVar17[4])) {
    if (param_3 != (long *)0x0) goto LAB_017fac9c;
LAB_017fad48:
    if (plVar18 != (long *)0x0) goto LAB_017facd0;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_017fad48;
LAB_017fac9c:
