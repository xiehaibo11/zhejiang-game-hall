...
void FUN_00d8e8a8(long *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
...
LAB_00d8eb70:
        if (*puVar13 != (uint)*pbVar23) goto code_r0x00d8eb7c;
        puVar13 = puVar27 + 0x18;
        uVar14 = *puVar27;
        if ((int)uVar19 < 2) goto LAB_00d8ec30;
        if (uVar1 < 2) {
          uVar15 = 1;
          goto LAB_00d8ec14;
        }
...
code_r0x00d8eb7c:
  iVar8 = iVar8 + 1;
  puVar13 = puVar13 + 0x18;
  if ((int)uVar19 <= iVar8) goto LAB_00d8eb90;
  goto LAB_00d8eb70;
}
