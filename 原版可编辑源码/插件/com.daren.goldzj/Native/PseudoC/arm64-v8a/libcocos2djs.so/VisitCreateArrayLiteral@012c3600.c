...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitCreateArrayLiteral(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::VisitCreateArrayLiteral
