...
/* js_cocos2dx_dragonbones_Animation_gotoAndPlayByTimeRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_Animation_gotoAndPlayByTimeRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Animation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x161d,"js_cocos2dx_dragonbones_Animation_gotoAndPlayByTime");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_Animation_gotoAndPlayByTime : Invalid Native Object"
                       );
  }
  else {
    ...
    if (lVar12 == 3) {
      ...
      ptVar7 = (type *)dragonBones::Animation::gotoAndPlayByTime
...
LAB_00cbbe58:
      ...
      if (lVar12 == 2) {
        ...
        if (lVar12 != 1) {
          __android_log_print(6,"jswrapper",
                              "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp, 5698): wrong number of arguments: %d, was expecting %d\n"
...
LAB_00cbbf38:
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                          ,uVar11,"js_cocos2dx_dragonbones_Animation_gotoAndPlayByTime");
      __android_log_print(6,"jswrapper",
                          "js_cocos2dx_dragonbones_Animation_gotoAndPlayByTime : Error processing arguments"
                         );
      bVar3 = false;
    }
    if ((local_88 & 1) != 0) {
    ...
    if (bVar3) goto LAB_00cbbf98;
  }
LAB_00cbbf6c:
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_Animation_gotoAndPlayByTime",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x1645);
LAB_00cbbf98:
  pVVar8 = (Value *)se::State::rval(aSStack_70);
