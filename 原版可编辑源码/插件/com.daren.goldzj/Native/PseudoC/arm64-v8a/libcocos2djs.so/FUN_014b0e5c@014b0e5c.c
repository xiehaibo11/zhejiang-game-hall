...
undefined8 FUN_014b0e5c(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar11 & 1) == 0) ||
    ...
    uStack_100 = __strlen_chk("getFunction",0xc);
    local_108 = "getFunction";
...
LAB_014b1050:
    ...
    if ((0xff < uVar4) && ((uVar4 & 0xff) != 0)) {
      ...
      if ((uVar11 & 1) == 0) {
        v8::internal::Isolate::CountUsage(param_3,0x4c);
        pIVar10 = (Isolate *)(**(code **)(*plVar7 + 0x18))(plVar7);
      }
      else {
