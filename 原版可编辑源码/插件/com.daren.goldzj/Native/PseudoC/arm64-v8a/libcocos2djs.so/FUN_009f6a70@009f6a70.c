...
void FUN_009f6a70(pthread_t *param_1,undefined8 *param_2,undefined8 *param_3,undefined4 *param_4)

{
  ...
  uVar1 = *param_4;
  *__arg = this;
                    /* catch() { ... } // from try @ 009f6ba0 with catch @ 009f6ac0
                       catch() { ... } // from try @ 009f6c28 with catch @ 009f6ac0
                       catch() { ... } // from try @ 009f6c9c with catch @ 009f6ac0 */
  __arg[2] = uVar5;
  __arg[1] = uVar4;
  __arg[3] = uVar3;
