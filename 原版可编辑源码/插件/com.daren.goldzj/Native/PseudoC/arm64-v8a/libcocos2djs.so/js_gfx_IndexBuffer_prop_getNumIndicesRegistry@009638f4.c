...
/* js_gfx_IndexBuffer_prop_getNumIndicesRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_gfx_IndexBuffer_prop_getNumIndicesRegistry(undefined8 param_1,PropertyCallbackInfo *param_2)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2a6,"js_gfx_IndexBuffer_prop_getNumIndices");
    __android_log_print(6,"jswrapper",
                        "js_gfx_IndexBuffer_prop_getNumIndices : Invalid Native Object");
  }
  else {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp, 688): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar5[1] - *plVar5) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_gfx_IndexBuffer_prop_getNumIndices",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp"
                      ,0x2b3);
LAB_00963a2c:
  pVVar6 = (Value *)se::State::rval(aSStack_60);
