...
/* js_cocos2dx_spine_TransformConstraint_setActiveRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_TransformConstraint_setActiveRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar4 == (long *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2cce,"js_cocos2dx_spine_TransformConstraint_setActive");
    pcVar7 = "js_cocos2dx_spine_TransformConstraint_setActive : Invalid Native Object";
LAB_00c666a8:
    ...
    if (uVar8 == 0x10) {
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x2cd5,"js_cocos2dx_spine_TransformConstraint_setActive");
      pcVar7 = "js_cocos2dx_spine_TransformConstraint_setActive : Error processing arguments";
      goto LAB_00c666a8;
    }
    __android_log_print(6,"jswrapper",&DAT_01918154,uVar8 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TransformConstraint_setActive",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x2cdc);
LAB_00c666e0:
