...

{
  ...
  undefined8 uVar17;
                    ...
                    /* try { // try from 0099fbc8 to 00a9fbd3 has its CatchHandler @ 0099fd1c */
                    /* try { // try from 0099fbd4 to 00a9fca7 has its CatchHandler @ 0099fd34 */
  puVar14 = *(undefined8 **)(this + 0x10);
  if (puVar14 != *(undefined8 **)(this + 0x18)) goto LAB_0099fd50;
  ...
  if (__src != puVar14) {
    ...
    uVar2 = uVar10 + 1;
    puVar13 = puVar3;
                    /* try { // try from 0099fca8 to 00a9fd8b has its CatchHandler @ 0099fb48 */
    if ((uVar2 < 4) ||
...
LAB_0099fd20:
      do {
        puVar9 = __src + 1;
                    /* catch() { ... } // from try @ 0099fbbc with catch @ 0099fd20 */
                    /* catch() { ... } // from try @ 0099fb9c with catch @ 0099fd24 */
        *puVar13 = *__src;
        puVar13 = puVar13 + 1;
        __src = puVar9;
      ...
      puVar13 = puVar3 + uVar11;
                    /* catch() { ... } // from try @ 0099fbc8 with catch @ 0099fd1c */
      if (uVar2 != uVar11) goto LAB_0099fd20;
    }
    puVar13 = *(undefined8 **)this;
                    /* catch() { ... } // from try @ 0099fbd4 with catch @ 0099fd34 */
