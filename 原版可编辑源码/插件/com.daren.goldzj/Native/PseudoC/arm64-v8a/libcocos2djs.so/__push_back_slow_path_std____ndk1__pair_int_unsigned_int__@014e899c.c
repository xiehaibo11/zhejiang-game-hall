...
/* void std::__ndk1::vector<std::__ndk1::pair<int, unsigned int>,
   std::__ndk1::allocator<std::__ndk1::pair<int, unsigned int> >
   >::__push_back_slow_path<std::__ndk1::pair<int, unsigned int> >(std::__ndk1::pair<int, unsigned
   int>&&) */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_014e8a84;
