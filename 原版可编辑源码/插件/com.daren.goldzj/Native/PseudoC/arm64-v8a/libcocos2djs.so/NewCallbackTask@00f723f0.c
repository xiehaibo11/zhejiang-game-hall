...
/* v8::internal::Factory::NewCallbackTask(v8::internal::Handle<v8::internal::Foreign>,
   v8::internal::Handle<v8::internal::Foreign>) */

ulong * __thiscall
v8::internal::Factory::NewCallbackTask(Factory *this,ulong *param_2,ulong *param_3)

{
  ...
  puVar1 = (ulong *)NewStruct(this,0x4a,0);
  uVar4 = *puVar1;
  uVar3 = *param_2;
