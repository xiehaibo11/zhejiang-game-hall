...
/* spine::TwoColorTimeline::TwoColorTimeline(int) */

void __thiscall spine::TwoColorTimeline::TwoColorTimeline(TwoColorTimeline *this,int param_1)

{
  ...
  *(undefined ***)this = &PTR__TwoColorTimeline_01c8f928;
