...
undefined8 FUN_00dd8aa8(long param_1,long param_2,long param_3)
      ...
      while( true ) {
        ...
        if ((int)uVar30 < 0xb) {
          if (pbVar18 < pbVar27) {
            ...
            uVar20 = uVar25;
            if (uVar30 == 0) goto joined_r0x00dd9a9c;
            uVar20 = 0xb;
          }
        }
        uVar30 = uVar20;
    ...
    while( true ) {
      if ((int)uVar30 < 8) {
        ...
        if (pbVar18 < pbVar27) {
          ...
          pbVar17 = pbVar18;
          if (uVar30 == 0) goto joined_r0x00dd9a14;
          uVar30 = 8;
        }
      }
...
LAB_00dd8d58:
      ...
      uVar31 = uVar30;
      local_90 = puVar14;
      if (0xb < (int)uVar30) goto LAB_00dd8de8;
LAB_00dd8d64:
      if (pbVar17 < pbVar27) {
        pbVar18 = pbVar17 + 1;
...
LAB_00dd8de8:
      ...
      case 7:
        ...
        local_90 = puVar14 + 1;
        *puVar14 = uVar31;
        if ((int)uVar3 <= (int)uVar20) goto LAB_00dd90b4;
        uVar26 = 0;
        uVar22 = uVar30;
        if (0xc < (int)uVar30) goto LAB_00dd8ec8;
        goto LAB_00dd8e44;
      default:
        ...
        iVar28 = 0;
        goto joined_r0x00dd9044;
      case 9:
      case 0xb:
        goto switchD_00dd8e14_caseD_9;
      case 0xc:
        iVar28 = 1;
        goto joined_r0x00dd9044;
      }
    ...
    if (puVar13 == puVar11) {
      ...
      do {
        ...
        case 1:
          ...
          local_90 = puVar11;
          puVar14 = puVar14 + 2;
          if ((int)uVar3 <= (int)uVar20) goto LAB_00dd96b8;
          break;
        case 2:
          goto switchD_00dd91e4_caseD_2;
        case 3:
          goto switchD_00dd9138_caseD_3;
        case 4:
          goto switchD_00dd9138_caseD_4;
        case 5:
          goto switchD_00dd9138_caseD_5;
        case 6:
          puVar13 = puVar11;
          goto LAB_00dd9754;
        default:
...
LAB_00dd90dc:
    ...
    switch(TIFFFaxMainTable[uVar23 * 8]) {
    case 1:
      goto switchD_00dd9138_caseD_1;
    case 2:
      goto switchD_00dd9138_caseD_2;
    case 3:
      goto switchD_00dd9138_caseD_3;
    case 4:
      goto switchD_00dd9138_caseD_4;
...
LAB_00dd8b70:
  ...
  *(byte **)(param_1 + 0x390) = pbVar27 + (lVar16 - (long)pbVar18);
  return 1;
switchD_00dd8e14_caseD_9:
  uVar20 = *(int *)(TIFFFaxWhiteTable + uVar23 * 8 + 4) + uVar20;
  uVar26 = *(int *)(TIFFFaxWhiteTable + uVar23 * 8 + 4) + uVar26;
  uVar31 = uVar30;
  if ((int)uVar30 < 0xc) goto LAB_00dd8d64;
  goto LAB_00dd8de8;
LAB_00dd8e44:
  if (pbVar17 < pbVar27) {
    pbVar18 = pbVar17 + 1;
...
LAB_00dd8ec8:
  while( true ) {
    ...
    pbVar17 = pbVar18;
    uVar22 = uVar30;
    if ((int)uVar30 < 0xd) goto LAB_00dd8e44;
  }
  if (uVar22 == 0xc) {
    iVar28 = 1;
    goto joined_r0x00dd9044;
...
joined_r0x00dd9044:
  ...
  puVar14 = local_90;
  param_1 = local_78;
  if (uVar20 != uVar3) goto LAB_00dd8f74;
  goto LAB_00dd9990;
LAB_00dd9abc:
  bVar8 = (*(uint *)(local_78 + 0x10) & 0x400) == 0;
  ppuVar7 = &local_88;
  ...
  if (uVar20 == uVar3) goto LAB_00dd9c64;
  bVar8 = (*(uint *)(local_78 + 0x10) & 0x400) == 0;
  ppuVar7 = &local_88;
  if (bVar8) {
    ppuVar7 = &local_80;
  ...
  param_2 = local_70;
  if ((puVar14 <= puVar11) || ((int)uVar20 <= (int)uVar3)) goto joined_r0x00dd9bd8;
  goto LAB_00dd9bac;
...
LAB_00dd9bac:
  ...
  goto joined_r0x00dd9bd8;
LAB_00dd90b4:
  iVar28 = 0;
  puVar14 = local_90;
  param_1 = local_78;
  if (uVar20 == uVar3) goto LAB_00dd9990;
LAB_00dd8f74:
  bVar8 = (*(uint *)(local_78 + 0x10) & 0x400) == 0;
  ppuVar7 = &local_88;
  if (bVar8) {
  ...
  goto joined_r0x00dd9948;
switchD_00dd91e4_caseD_2:
  puVar19 = puVar14;
  pbVar17 = pbVar18;
switchD_00dd9138_caseD_2:
  ...
  local_90 = puVar13;
  if ((byte)TIFFFaxBlackTable[uVar23 * 8] != 8) goto switchD_00dd9138_caseD_7;
...
switchD_00dd9138_caseD_c:
  ...
  *puVar13 = uVar3 - uVar20;
  ...
  uVar25 = uVar25 >> 4;
  iVar28 = 1;
  goto joined_r0x00dd986c;
switchD_00dd9138_caseD_5:
  if (puVar13 != puVar11) {
...
LAB_00dd96a0:
  ...
  local_90 = puVar13;
  puVar14 = puVar19;
  if ((int)uVar3 <= (int)uVar20) goto LAB_00dd9878;
  goto LAB_00dd90d0;
LAB_00dd9dbc:
  local_90 = puVar13 + 1;
  pbVar18 = pbVar17;
...
LAB_00dd9990:
  ...
  *(int *)(lVar29 + 0x90) = *(int *)(lVar29 + 0x90) + 1;
  ...
  if (local_68 < 1) goto code_r0x00dd9a04;
  goto LAB_00dd8b98;
code_r0x00dd9a04:
  pbVar27 = *(byte **)(param_1 + 0x388);
  lVar16 = *(long *)(param_1 + 0x390);
