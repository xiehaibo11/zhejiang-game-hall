...

{
  ...
  if (0 < iVar1) {
    ...
    if ((uVar4 < 7) && ((0x6fU >> (ulong)((uint)uVar4 & 0x1f) & 1) != 0)) {
      pcVar8 = *(char **)((&PTR_DAT_01c83f50)[uVar4] + 8);
    }
    else {
      pcVar8 = "(UNKNOWN)";
    }
                    ...
                    if (*puVar11 == 1) {
                      ...
                      if (a_00 != (ASN1_ENUMERATED *)0x0) {
                        ...
                        if ((uVar4 < 9) && ((0x17fU >> (ulong)((uint)uVar4 & 0x1f) & 1) != 0)) {
                          pcVar9 = *(char **)((&PTR_DAT_01c83fb0)[uVar4] + 8);
                        }
                    ...
                    if (((((iVar2 < 1) ||
                         ...
                         ((puVar6[3] != 0 &&
                          ((iVar2 = BIO_printf(bp,"\n    Next Update: "), iVar2 < 1 ||
                           ...
                           , iVar2 == 0)))))) || (iVar2 = BIO_write(bp,&DAT_018938a8,1), iVar2 < 1))
