...
/* v8::String::Write(v8::Isolate*, unsigned short*, int, int, int) const */

int __thiscall
v8::String::Write(String *this,Isolate *param_1,ushort *param_2,int param_3,int param_4,int param_5)
  ...
  *(undefined4 *)(param_1 + 0x2c60) = 5;
  ...
  if (iVar2 < 0) {
    ...
    if (iVar6 != 0 && param_3 <= iVar2) {
      internal::String::WriteToFlat<unsigned_short>(lVar5,param_2,param_3);
    }
