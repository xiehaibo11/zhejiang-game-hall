...
/* js_cocos2dx_dragonbones_BoneData_set_parentRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_BoneData_set_parentRegistry
...

{
  ...
  if (lVar7 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x635,"js_cocos2dx_dragonbones_BoneData_set_parent");
    pcVar9 = "js_cocos2dx_dragonbones_BoneData_set_parent : Invalid Native Object";
  }
  else {
...
LAB_00c9f854:
    ...
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x63a,"js_cocos2dx_dragonbones_BoneData_set_parent");
    pcVar9 = "js_cocos2dx_dragonbones_BoneData_set_parent : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar9);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_BoneData_set_parent",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x63e);
LAB_00c9f8cc:
