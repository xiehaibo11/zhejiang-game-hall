...
/* v8::internal::HashTable<v8::internal::StringTable,
   v8::internal::StringTableShape>::NewInternal(v8::internal::Isolate*, int,
   v8::internal::AllocationType) */

void v8::internal::HashTable<v8::internal::StringTable,v8::internal::StringTableShape>::NewInternal
