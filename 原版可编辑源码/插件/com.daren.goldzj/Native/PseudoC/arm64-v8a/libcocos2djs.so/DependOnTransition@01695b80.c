...
/* v8::internal::compiler::CompilationDependencies::DependOnTransition(v8::internal::compiler::MapRef
   const&) */

void __thiscall
v8::internal::compiler::CompilationDependencies::DependOnTransition
