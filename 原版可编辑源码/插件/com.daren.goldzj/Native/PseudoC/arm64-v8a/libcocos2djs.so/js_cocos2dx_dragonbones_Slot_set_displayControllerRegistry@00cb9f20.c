...
/* js_cocos2dx_dragonbones_Slot_set_displayControllerRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_Slot_set_displayControllerRegistry
...

{
  ...
  if (lVar8 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1522,"js_cocos2dx_dragonbones_Slot_set_displayController");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_Slot_set_displayController : Invalid Native Object"
                       );
  }
  else {
    local_88 = 0;
    ...
    if ((uVar9 & 1) == 0) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                          ,0x1527,"js_cocos2dx_dragonbones_Slot_set_displayController");
      __android_log_print(6,"jswrapper",
                          "js_cocos2dx_dragonbones_Slot_set_displayController : Error processing new value"
                         );
      bVar3 = false;
    }
    else {
    ...
    if (bVar3) goto LAB_00cba11c;
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_Slot_set_displayController",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x152b);
LAB_00cba11c:
