...
ulong FUN_01560700(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0x117);
  }
  if (DAT_01d46e78 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d46e78 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d46e78;
  local_a0 = (byte **)0x0;
  if ((*DAT_01d46e78 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar3,"V8.Runtime_Runtime_FunctionGetScriptSource",0,0,0,0,0,0,0
                       ,&local_50,0);
    plVar4 = local_48;
    local_48 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    local_a0 = &local_98;
    local_90 = "V8.Runtime_Runtime_FunctionGetScriptSource";
    local_98 = pbVar3;
    local_88 = uVar5;
  }
...
LAB_01560990:
  ...
  uVar9 = uVar7 | 7;
  if (*(ushort *)(uVar9 + *(uint *)(uVar8 - 1)) < 0xa9) goto LAB_01560990;
  if (*(short *)(uVar9 + *(uint *)(uVar8 - 1)) == 0x439) {
    uVar8 = uVar7 | *(uint *)((uVar7 | *(uint *)(uVar8 + 0xb)) + 0xf);
    if (*(short *)(uVar9 + *(uint *)(uVar8 - 1)) == 0x5b) {
