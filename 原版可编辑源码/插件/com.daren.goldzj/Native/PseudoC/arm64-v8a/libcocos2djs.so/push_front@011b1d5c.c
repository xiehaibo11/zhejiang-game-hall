...
/* std::__ndk1::__split_buffer<v8::internal::CpuProfile::SampleInfo*,
   ...
   >::push_front(v8::internal::CpuProfile::SampleInfo*&&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_011b1ee8;
...
LAB_011b1ebc:
      ...
      if (((void *)((long)pvVar4 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar4 + uVar9 + uVar13 * 8 + 8))) goto LAB_011b1ebc;
      ...
      puVar7 = puVar8;
      if (uVar2 != uVar9) goto LAB_011b1ebc;
    }
