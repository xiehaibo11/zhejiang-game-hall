...
/* v8::internal::compiler::CommonOperatorBuilder::CompressedHeapConstant(v8::internal::Handle<v8::internal::HeapObject>
   const&) */
...

{
  ...
  Operator::Operator(pOVar1,0x1f,0x7c,"CompressedHeapConstant",0,0,0,1,0,0);
