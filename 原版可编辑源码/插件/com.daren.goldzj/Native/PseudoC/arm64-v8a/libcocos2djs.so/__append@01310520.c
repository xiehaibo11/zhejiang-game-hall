...
/* std::__ndk1::vector<v8::internal::BitVector*,
   v8::internal::ZoneAllocator<v8::internal::BitVector*> >::__append(unsigned long,
   v8::internal::BitVector* const&) */

void __thiscall
std::__ndk1::vector<v8::internal::BitVector*,v8::internal::ZoneAllocator<v8::internal::BitVector*>>
::__append(vector<v8::internal::BitVector*,v8::internal::ZoneAllocator<v8::internal::BitVector*>>
           *this,ulong param_1,BitVector **param_2)

{
  ...
  if ((3 < param_1) &&
     (((undefined8 *)((long)param_2 + 1U) <= puVar4 ||
      ((BitVector **)(lVar5 + (lVar11 + param_1) * 8) <= param_2)))) {
    pBVar2 = *param_2;
