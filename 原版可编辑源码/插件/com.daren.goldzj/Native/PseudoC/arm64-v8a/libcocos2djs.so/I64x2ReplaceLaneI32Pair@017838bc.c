...
/* v8::internal::compiler::MachineOperatorBuilder::I64x2ReplaceLaneI32Pair(int) */

Operator * __thiscall
v8::internal::compiler::MachineOperatorBuilder::I64x2ReplaceLaneI32Pair
...

{
  ...
  Operator::Operator(pOVar1,0x22a,0x7c,"Replace lane",3,0,0,1,0,0);
