...
/* v8::internal::interpreter::BytecodeArrayBuilder::LoadIteratorProperty(v8::internal::interpreter::Register,
   int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::LoadIteratorProperty
...

{
  ...
  uVar2 = ConstantArrayBuilder::InsertIteratorSymbol();
