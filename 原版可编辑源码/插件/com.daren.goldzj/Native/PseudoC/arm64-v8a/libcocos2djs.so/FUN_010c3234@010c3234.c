...
undefined8 FUN_010c3234(undefined8 param_1,ulong *param_2,ulong *param_3,long param_4,long param_5)
  ...
  if (param_4 != 0) {
    ...
    if ((uVar2 & 1) != 0) {
      ...
      if ((((*(short *)((uVar9 | 7) + (ulong)*(uint *)(uVar2 - 1)) == 0x41b) &&
        ...
        FUN_0107f184(uVar2,uVar8,param_4,param_5);
        goto LAB_010c344c;
      }
    }
    uVar8 = 0;
    while( true ) {
      ...
      uVar7 = v8::internal::BigInt::AsInt64((BigInt *)&local_80,(bool *)0x0);
