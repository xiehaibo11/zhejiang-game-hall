...
/* void std::__ndk1::vector<v8::internal::Object, std::__ndk1::allocator<v8::internal::Object>
   >::__push_back_slow_path<v8::internal::Object const&>(v8::internal::Object const&) */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00f7fff4;
