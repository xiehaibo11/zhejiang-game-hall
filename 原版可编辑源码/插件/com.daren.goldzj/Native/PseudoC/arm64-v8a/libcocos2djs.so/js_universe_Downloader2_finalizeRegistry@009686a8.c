...
/* js_universe_Downloader2_finalizeRegistry(void*) */

void js_universe_Downloader2_finalizeRegistry(void *param_1)

{
  ...
  if (param_1 != (void *)0x0) {
    ...
    if (lVar3 != lVar4) {
      ...
      this_00 = (Downloader2 *)se::State::nativeThisObject(aSStack_60);
