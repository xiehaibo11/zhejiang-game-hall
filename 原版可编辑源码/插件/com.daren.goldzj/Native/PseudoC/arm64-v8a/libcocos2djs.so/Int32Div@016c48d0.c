...
/* v8::internal::compiler::GraphAssembler::Int32Div(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Int32Div(GraphAssembler *this,Node *param_1,Node *param_2)

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::Int32Div
