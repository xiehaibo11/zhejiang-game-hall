...
/* v8::internal::PagedSpace::SetReadAndExecutable() */

void __thiscall v8::internal::PagedSpace::SetReadAndExecutable(PagedSpace *this)
  ...
  if (uVar2 != 0) {
    ...
    if ((plVar6 != (long *)0x0) && (plVar6 = (long *)*plVar6, plVar6 != (long *)0x0)) {
      do {
        uVar7 = plVar6[1];
        if (uVar7 == uVar4) {
          if ((MemoryChunk *)plVar6[2] == pMVar8) goto LAB_010175f0;
        }
        else {
          if (uVar3 < 2) {
            uVar7 = uVar7 & uVar2 - 1;
...
LAB_010175f0:
  MemoryChunk::DecrementWriteUnprotectCounterAndMaybeSetPermissions(pMVar8,4);
  pMVar8 = *(MemoryChunk **)(pMVar8 + 0xe0);
  goto joined_r0x010175d4;
}
