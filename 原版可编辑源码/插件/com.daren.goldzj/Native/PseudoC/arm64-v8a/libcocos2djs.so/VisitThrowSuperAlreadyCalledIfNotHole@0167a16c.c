...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitThrowSuperAlreadyCalledIfNotHole() */
...

{
  ...
  if ((ulong)(long)*(int *)(lVar3 + 0x5c) <
    ...
    local_40 = pNVar4;
    pNVar4 = (Node *)MakeNode(this,pOVar1,2,&local_40,false);
    pOVar1 = (Operator *)
             SimplifiedOperatorBuilder::BooleanNot
                       (*(SimplifiedOperatorBuilder **)(*(long *)(this + 0x10) + 0x178));
    local_40 = pNVar4;
    uVar2 = MakeNode(this,pOVar1,1,&local_40,false);
    BuildHoleCheckAndThrow(this,uVar2,0x2b,0);
    return;
  }
