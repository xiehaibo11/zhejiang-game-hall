...
/* v8::internal::Object v8::internal::FutexEmulation::Wait<int>(v8::internal::Isolate*,
   v8::internal::Handle<v8::internal::JSArrayBuffer>, unsigned long, int, double) */

ulong v8::internal::FutexEmulation::Wait<int>
                (double param_1_00,Isolate *param_1,long *param_3,long param_4,int param_5)

{
  ...
  local_b8 = '\0';
  local_c0 = param_1;
  Isolate::RunAtomicsWaitCallback(param_1_00,param_1,0,param_3,param_4,(long)param_5,&local_c0);
...
LAB_00f4a824:
      ...
      if (mutex_ != '\x02') {
        ...
        if (&local_b0 == local_90) {
          ...
          if (local_90 == (undefined ***)0x0) goto LAB_00f4a88c;
...
LAB_00f4a88c:
      ...
      if (IVar4 != (Isolate)0x0) {
        ...
        if (((uVar7 & 1) != 0) && ((int)uVar7 == *(int *)(param_1 + 0x180))) goto LAB_00f4aa2c;
      }
      if (mutex_ != '\x02') {
        local_a0 = (undefined8 *)&DAT_01d3ec9c;
        local_b0 = &PTR_FUN_01c984d0;
        ...
        if (&local_b0 == local_90) {
          ...
          if (local_90 == (undefined ***)0x0) goto LAB_00f4a914;
          pcVar9 = (code *)(*local_90)[5];
        }
        (*pcVar9)();
      }
        ...
        if (bVar6) {
          ...
          if (mutex_ != '\x02') {
            ...
            if (&local_b0 == local_90) {
              ...
              if (local_90 == (undefined ***)0x0) goto LAB_00f4a9fc;
              pcVar9 = (code *)(*local_90)[5];
            }
            (*pcVar9)();
          }
LAB_00f4a9fc:
          ...
          if (mutex_ != '\x02') {
            ...
            if (&local_b0 == local_90) {
              ...
              if (local_90 == (undefined ***)0x0) goto LAB_00f4a818;
              pcVar9 = (code *)(*local_90)[5];
            }
            (*pcVar9)();
          }
...
LAB_00f4ab80:
  param_1[0xc6f8] = (Isolate)0x0;
  base::Mutex::Unlock((Mutex *)&DAT_01d3ec9c);
  Isolate::RunAtomicsWaitCallback(param_1_00,param_1,iVar11,param_3,param_4,(long)param_5,0);
  if (*(int *)(param_1 + 0x2c20) == *(int *)(param_1 + 0xa8)) goto LAB_00f4abd0;
  if (iVar11 == 3) {
