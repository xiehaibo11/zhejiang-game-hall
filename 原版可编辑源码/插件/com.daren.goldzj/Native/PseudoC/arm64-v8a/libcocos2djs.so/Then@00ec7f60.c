...
/* v8::Promise::Then(v8::Local<v8::Context>, v8::Local<v8::Function>, v8::Local<v8::Function>) */

ulong * __thiscall
v8::Promise::Then(Promise *this,long param_2,undefined8 param_3,undefined8 param_4)
  ...
  if ((*(int *)(pIVar7 + 0x2c20) == (int)uVar9) ||
    ...
    *local_58 = uVar9;
    ...
    if (internal::TracingFlags::runtime_stats != 0) {
      ...
      internal::RuntimeCallStats::Enter(local_f0,(ulong)&local_f0 | 8,0x3c1);
    }
...
LAB_00ec8298:
        ...
        if (*(code **)(lVar4 + 0xb738) == (code *)0x0) goto LAB_00ec8298;
