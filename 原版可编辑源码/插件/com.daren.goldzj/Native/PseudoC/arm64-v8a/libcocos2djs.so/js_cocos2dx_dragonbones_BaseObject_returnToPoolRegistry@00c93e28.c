...
/* js_cocos2dx_dragonbones_BaseObject_returnToPoolRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_BaseObject_returnToPoolRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (BaseObject *)se::State::nativeThisObject(aSStack_60);
  if (this == (BaseObject *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0xd,&DAT_01927be4);
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_BaseObject_returnToPool : Invalid Native Object");
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      dragonBones::BaseObject::returnToPool(this);
      goto LAB_00c93f78;
    }
    __android_log_print(6,"jswrapper",&DAT_0192c89c,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
