...
/* cocos2d::UrlAudioPlayer::prepare(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&, unsigned int, std::__ndk1::shared_ptr<cocos2d::AssetFd>,
   int, int) */

undefined4 __thiscall
cocos2d::UrlAudioPlayer::prepare
          (UrlAudioPlayer *this,
...

{
  ...
  long local_58;
                    ...
                    /* try { // try from 00a79330 to 00b7933b has its CatchHandler @ 00a7949c */
                    /* try { // try from 00a7933c to 00b79347 has its CatchHandler @ 00a79498 */
                    /* try { // try from 00a79348 to 00b79423 has its CatchHandler @ 00a794b0 */
  lVar7 = tpidr_el0;
  ...
  *(long *)(this + 0x48) = lVar13;
  ...
  if ((param_2 == -0x7ffff844) || (param_2 == 1)) {
    local_88 = &local_b0;
    local_a0 = 1;
                    /* try { // try from 00a79424 to 00b79507 has its CatchHandler @ 00a792bc */
    uStack_a8 = 0;
    local_b0 = 1;
    if (param_2 == 1) {
      if (((byte)*this_00 & 1) == 0) {
        ...
        local_c0 = *(UrlAudioPlayer **)(this + 0x38);
                    ...
                    /* catch() { ... } // from try @ 00a7933c with catch @ 00a79498 */
                    /* catch() { ... } // from try @ 00a79330 with catch @ 00a7949c */
      local_90 = &local_c8;
                    /* catch() { ... } // from try @ 00a79310 with catch @ 00a794a0 */
      local_c8 = 1;
    }
      ...
      local_c8 = 0x800007bc;
                    ...
                    /* catch() { ... } // from try @ 00a79348 with catch @ 00a794b0 */
    local_d8[0] = 4;
    local_70 = _SL_IID_SEEK;
    uStack_68 = _SL_IID_PREFETCHSTATUS;
    local_e8 = local_d8;
    local_d0 = *(undefined8 *)(this + 0x10);
    uStack_e0 = 0;
    local_60 = _SL_IID_VOLUME;
    local_78 = 1;
    local_80 = 0x100000001;
                    /* try { // try from 00a79508 to 00b7955b has its CatchHandler @ 00a79508
                       catch() { ... } // from try @ 00a79508 with catch @ 00a79508
                       catch() { ... } // from try @ 00a796c0 with catch @ 00a79508 */
    ...
    if (iVar9 == 0) {
      ...
      iVar9 = (**(code **)*puVar10)(puVar10,0);
                    /* try { // try from 00a7955c to 00b79573 has its CatchHandler @ 00a7972c */
      if (iVar9 == 0) {
                    /* try { // try from 00a7957c to 00b79587 has its CatchHandler @ 00a79710 */
                    /* try { // try from 00a79588 to 00b79593 has its CatchHandler @ 00a7970c */
                    /* try { // try from 00a79594 to 00b7959b has its CatchHandler @ 00a7973c */
        iVar9 = (**(code **)(**(long **)(this + 0x50) + 0x18))
                          (*(long **)(this + 0x50),_SL_IID_PLAY,this + 0x58);
        if (iVar9 == 0) {
                    /* try { // try from 00a795b8 to 00b795cb has its CatchHandler @ 00a79714 */
          iVar9 = (**(code **)(**(long **)(this + 0x50) + 0x18))
                            (*(long **)(this + 0x50),uVar3,this + 0x60);
          if (iVar9 == 0) {
                    /* try { // try from 00a795ec to 00b79643 has its CatchHandler @ 00a7973c */
            iVar9 = (**(code **)(**(long **)(this + 0x50) + 0x18))
              ...
              if (iVar9 == 0) {
                ...
                if (iVar9 == 0) {
                  *(undefined4 *)(this + 0x7c) = 1;
                    /* try { // try from 00a796c0 to 00b79793 has its CatchHandler @ 00a79508 */
  ...
  uVar14 = 0;
LAB_00a7967c:
                    /* try { // try from 00a7967c to 00b796bf has its CatchHandler @ 00a79714 */
