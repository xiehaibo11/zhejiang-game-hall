...
void __thiscall
v8::internal::Heap::CallGCEpilogueCallbacks(Heap *this,uint param_2,undefined4 param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    ...
    RuntimeCallStats::Enter(local_70,(ulong)&local_70 | 8,0x89);
  }
  puVar1 = *(undefined8 **)(this + 0x600);
  for (puVar2 = *(undefined8 **)(this + 0x5f8); puVar2 != puVar1; puVar2 = puVar2 + 3) {
