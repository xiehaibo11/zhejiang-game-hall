...
/* v8::internal::compiler::JSCreateLowering::AllocateRestArguments(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*, v8::internal::compiler::Node*, int) */

void __thiscall
v8::internal::compiler::JSCreateLowering::AllocateRestArguments
          (JSCreateLowering *this,Node *param_1,Node *param_2,Node *param_3,int param_4)

{
  ...
  if (iVar8 < 1) {
    ...
    if (0 < param_4) {
      do {
        StateValuesAccess::iterator::operator++((iterator *)&local_130);
        param_4 = param_4 + -1;
      } while (param_4 != 0);
    }
