...
undefined4 FUN_01079070(ulong param_1,ulong param_2,ulong param_3,long param_4,long param_5)
        ...
        case 0:
          if (param_4 != 0) {
            ...
            do {
              ...
              param_4 = param_4 + -1;
              iVar9 = iVar9 + 4;
              *puVar14 = (char)(*(uint *)(((ulong)pIVar12 | (ulong)uVar4) + 7 + lVar1) >> 1);
              puVar14 = puVar14 + 1;
            } while (param_4 != 0);
          }
          break;
          ...
          if (param_4 != 0) {
            ...
            do {
              ...
              if (((uVar4 & 1) == 0) || (uVar4 != *(uint *)(pIVar12 + 0xa8))) {
                uVar7 = (undefined1)(*(uint *)(iVar9 + lVar1) >> 1);
              }
              else {
                uVar7 = FUN_010b0908(uVar11);
              }
              *puVar14 = uVar7;
              param_4 = param_4 + -1;
              iVar9 = iVar9 + 4;
          ...
          if (param_4 != 0) {
            ...
            do {
              ...
              if (((dVar16 < -2147483648.0) || (2147483647.0 < dVar16)) ||
                ...
                if ((int)uVar2 < 0) {
                  if ((int)uVar2 < -0x34) goto LAB_0107920c;
            ...
            do {
              if (*(long *)(uVar13 + (long)iVar9) == -0x8000000080001) {
                ...
                if ((((dVar16 < -2147483648.0) || (2147483647.0 < dVar16)) ||
                  ...
                  if ((int)uVar4 < 0) {
                    if ((int)uVar4 < -0x34) goto LAB_01079410;
...
LAB_0107935c:
    ...
    if (*(short *)(((ulong)pIVar12 | 7) + (ulong)*(uint *)(((ulong)pIVar12 | (ulong)uVar4) - 1)) !=
        0xa9) goto LAB_01079100;
LAB_010791d4:
    v8::internal::PerIsolateAssertScope<(v8::internal::PerIsolateAssertType)0,false>::
    ~PerIsolateAssertScope(aPStack_78);
  }
  uVar15 = 0;
switchD_01079188_caseD_2:
  v8::internal::PerIsolateAssertScope<(v8::internal::PerIsolateAssertType)0,false>::
