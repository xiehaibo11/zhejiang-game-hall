...
/* JSB_glVertexAttrib3fvRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glVertexAttrib3fvRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if ((plVar7[1] - *plVar7 & 0xffffffff0U) == 0x20) {
    uVar4 = seval_to_uint32((Value *)*plVar7,&local_7c);
    local_50 = (void *)0x0;
    uStack_48 = 0;
    local_40 = '\0';
    uVar5 = FUN_008d3f94(*plVar7 + 0x10,&local_50);
    ...
    if (bVar1) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0xb0d,"JSB_glVertexAttrib3fv");
      __android_log_print(6,"jswrapper",&DAT_0190552e);
    }
    else {
      glVertexAttrib3fv(local_7c,local_50);
    }
    if (local_40 != '\0') {
      free(local_50);
    }
    if (!bVar1) goto LAB_008c90f8;
  }
  else {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                        ,0xb06,"JSB_glVertexAttrib3fv");
    __android_log_print(6,"jswrapper","Invalid number of arguments");
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "JSB_glVertexAttrib3fv",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                      ,0xb13);
LAB_008c90f8:
