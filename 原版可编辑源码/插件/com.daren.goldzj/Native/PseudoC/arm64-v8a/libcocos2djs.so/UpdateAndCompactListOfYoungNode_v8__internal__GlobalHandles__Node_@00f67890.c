...
/* void 
   v8::internal::GlobalHandles::UpdateAndCompactListOfYoungNode<v8::internal::GlobalHandles::Node>(std::__ndk1::vector<v8::internal::GlobalHandles::Node*,
   std::__ndk1::allocator<v8::internal::GlobalHandles::Node*> >*) */

void __thiscall
v8::internal::GlobalHandles::UpdateAndCompactListOfYoungNode<v8::internal::GlobalHandles::Node>
...

{
  ...
  if (__src == plVar2) {
    ...
    do {
      ...
      if ((bVar1 & 7) == 0) {
        *(byte *)((long)puVar5 + 0xb) = bVar1 & 0xf7;
    ...
    if (uVar4 <= uVar3 && uVar3 - uVar4 != 0) {
      ...
      ::__append((vector<v8::internal::GlobalHandles::Node*,std::__ndk1::allocator<v8::internal::GlobalHandles::Node*>>
                  *)param_1,uVar3 - uVar4);
      __src = *(long **)param_1;
      plVar2 = *(long **)(param_1 + 8);
      goto LAB_00f67990;
