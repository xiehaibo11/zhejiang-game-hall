...
long FUN_00be7648(BIO *param_1,int param_2,long param_3,undefined8 *param_4)

{
  ...
  default:
    if (param_2 == 0xb) {
      ...
      if (iVar1 == 5) {
        iVar1 = FUN_00be7934(param_1,piVar2,*(undefined8 *)(piVar2 + 0x10),6);
        if (iVar1 < 1) {
          return (long)iVar1;
        }
        iVar1 = *piVar2;
