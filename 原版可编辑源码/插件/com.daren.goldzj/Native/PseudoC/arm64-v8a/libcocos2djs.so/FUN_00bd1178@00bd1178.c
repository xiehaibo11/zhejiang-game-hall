...
undefined8 FUN_00bd1178(undefined1 *param_1,int param_2,int param_3)

{
  ...
  if (((ctx == (EVP_MD_CTX *)0x0) ||
      (iVar6 = CRYPTO_THREAD_run_once(&DAT_01d3b454,&LAB_00bd1a94), iVar6 == 0)) ||
     (DAT_01d3b458 == 0)) {
    iVar6 = 0x41;
    iVar8 = 0x205;
  }
    ...
    DAT_01d3b470 = CRYPTO_THREAD_get_current_id();
    uVar10 = CRYPTO_THREAD_unlock(DAT_01d3b468);
    DAT_01d3b420 = 1;
    if ((DAT_01d3b424 & 1) == 0) {
      uVar7 = RAND_poll();
      uVar10 = (ulong)uVar7;
    ...
    dVar4 = DAT_01d3b478;
    if ((DAT_01d3b478 < 32.0) && (DAT_01d3b478 = DAT_01d3b478 - (double)param_2, DAT_01d3b478 < 0.0)
       ) {
      DAT_01d3b478 = 0.0;
    }
    if (DAT_01d3b450 == 0) {
    ...
    uStack_78 = DAT_01d3b498;
    DAT_01d3b480 = DAT_01d3b480 +
                   (long)(param_2 + 9 + (((param_2 + -1) / 10) * 10 - (param_2 + -1)));
    local_90 = DAT_01d3b440;
    uStack_98 = uRam0000000001d3b438;
    local_a0 = _DAT_01d3b430;
    if (DAT_01d3b488 < DAT_01d3b480) {
      uVar3 = 0;
      if (DAT_01d3b488 != 0) {
        uVar3 = DAT_01d3b480 / DAT_01d3b488;
      }
      DAT_01d3b480 = DAT_01d3b480 - uVar3 * DAT_01d3b488;
    }
    DAT_01d3b490 = DAT_01d3b490 + 1;
    DAT_01d3b420 = 0;
    ...
    do {
      ...
      puVar12 = &DAT_01d3b4a0 + uVar14;
      if (iVar8 < 1) {
        cnt = 10;
      }
      else {
        iVar9 = EVP_DigestUpdate(ctx,puVar12,(long)(10 - iVar8));
        if (iVar9 == 0) goto LAB_00bd1a10;
        cnt = (size_t)iVar8;
        puVar12 = &DAT_01d3b4a0;
      }
      ...
      (&DAT_01d3b4a0)[uVar14] = (&DAT_01d3b4a0)[uVar14] ^ (byte)local_a0;
      puVar12 = param_1 + 1;
      *param_1 = uStack_98._2_1_;
      ...
      (&DAT_01d3b4a0)[lVar1] = (&DAT_01d3b4a0)[lVar1] ^ local_a0._1_1_;
      if (1 < iVar6) {
        puVar12 = param_1 + 2;
      ...
      (&DAT_01d3b4a0)[lVar2] = (&DAT_01d3b4a0)[lVar2] ^ local_a0._2_1_;
      puVar13 = puVar12;
      if (2 < iVar6) {
        puVar13 = puVar12 + 1;
      ...
      (&DAT_01d3b4a0)[lVar1] = (&DAT_01d3b4a0)[lVar1] ^ local_a0._3_1_;
      puVar12 = puVar13;
      if (3 < iVar6) {
        puVar12 = puVar13 + 1;
      ...
      (&DAT_01d3b4a0)[lVar2] = (&DAT_01d3b4a0)[lVar2] ^ local_a0._4_1_;
      puVar13 = puVar12;
      if (4 < iVar6) {
        puVar13 = puVar12 + 1;
      ...
      (&DAT_01d3b4a0)[lVar1] = (&DAT_01d3b4a0)[lVar1] ^ local_a0._5_1_;
      puVar12 = puVar13;
      if (5 < iVar6) {
        puVar12 = puVar13 + 1;
      ...
      (&DAT_01d3b4a0)[lVar2] = (&DAT_01d3b4a0)[lVar2] ^ local_a0._6_1_;
      puVar13 = puVar12;
      if (6 < iVar6) {
        puVar13 = puVar12 + 1;
      ...
      (&DAT_01d3b4a0)[lVar1] = (&DAT_01d3b4a0)[lVar1] ^ local_a0._7_1_;
      puVar12 = puVar13;
      if (7 < iVar6) {
        puVar12 = puVar13 + 1;
      ...
      (&DAT_01d3b4a0)[lVar2] = (&DAT_01d3b4a0)[lVar2] ^ (byte)uStack_98;
      puVar13 = puVar12;
      if (8 < iVar6) {
        puVar13 = puVar12 + 1;
      ...
      (&DAT_01d3b4a0)[lVar1] = (&DAT_01d3b4a0)[lVar1] ^ uStack_98._1_1_;
      param_1 = puVar13;
      if (9 < iVar6) {
        param_1 = puVar13 + 1;
    ...
    if (((iVar6 != 0) && (iVar6 = EVP_DigestUpdate(ctx,&local_80,0x10), iVar6 != 0)) &&
      ...
      CRYPTO_THREAD_write_lock(DAT_01d3b460);
      ASYNC_block_pause();
      iVar6 = EVP_DigestUpdate(ctx,&DAT_01d3b430,0x14);
      if ((iVar6 != 0) && (iVar6 = EVP_DigestFinal_ex(ctx,&DAT_01d3b430,(uint *)0x0), iVar6 != 0)) {
        ASYNC_unblock_pause();
        CRYPTO_THREAD_unlock(DAT_01d3b460);
        EVP_MD_CTX_free(ctx);
        if (32.0 <= dVar4) {
