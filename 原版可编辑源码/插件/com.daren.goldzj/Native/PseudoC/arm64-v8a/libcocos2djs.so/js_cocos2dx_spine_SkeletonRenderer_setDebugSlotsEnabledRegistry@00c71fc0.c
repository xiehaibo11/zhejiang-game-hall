...
/* js_cocos2dx_spine_SkeletonRenderer_setDebugSlotsEnabledRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonRenderer_setDebugSlotsEnabledRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonRenderer *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x334f,"js_cocos2dx_spine_SkeletonRenderer_setDebugSlotsEnabled");
    pcVar6 = "js_cocos2dx_spine_SkeletonRenderer_setDebugSlotsEnabled : Invalid Native Object";
LAB_00c72130:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::SkeletonRenderer::setDebugSlotsEnabled(this,local_64[0]);
        goto LAB_00c72168;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x3356,"js_cocos2dx_spine_SkeletonRenderer_setDebugSlotsEnabled");
      pcVar6 = 
      "js_cocos2dx_spine_SkeletonRenderer_setDebugSlotsEnabled : Error processing arguments";
      goto LAB_00c72130;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 13146): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
