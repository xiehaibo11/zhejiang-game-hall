...
/* v8::internal::compiler::OperationTyper::SpeculativeNumberBitwiseAnd(v8::internal::compiler::Type,
   v8::internal::compiler::Type) */

void __thiscall
v8::internal::compiler::OperationTyper::SpeculativeNumberBitwiseAnd
...

{
  ...
  NumberBitwiseAnd(this,uVar1,uVar2);
  return;
}
