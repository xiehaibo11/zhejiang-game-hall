...
/* v8::internal::Builtin_ObjectSeal(int, unsigned long*, v8::internal::Isolate*) */

ulong v8::internal::Builtin_ObjectSeal(int param_1,ulong *param_2,Isolate *param_3)

{
    ...
    *(int *)(param_3 + 0x95b0) = iVar6 + 1;
    ...
    if (((uVar8 & 1) == 0) ||
      ...
      *(int *)(param_3 + 0x95b0) = iVar6;
      ...
      cVar7 = JSReceiver::SetIntegrityLevel(pIVar2,4,0);
  ...
  uVar8 = FUN_014ce6bc(param_1,param_2,param_3);
  return uVar8;
}
