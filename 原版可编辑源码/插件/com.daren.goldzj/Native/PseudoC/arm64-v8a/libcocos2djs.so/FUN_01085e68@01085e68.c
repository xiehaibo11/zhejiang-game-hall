...
undefined1  [16]
FUN_01085e68(undefined8 param_1,undefined8 param_2,ulong *param_3,ulong *param_4,ulong param_5,
            ulong param_6)

{
  ...
  if (param_5 < param_6) {
    ...
    if ((((local_28 & 1) == 0) ||
        ((uVar3 = local_28 & 0xffffffff00000000 | 7,
         *(short *)(uVar3 + *(uint *)(local_28 - 1)) == 0x42 &&
         ((*(short *)(uVar3 + *(uint *)(local_28 - 1)) != 0x42 || (!NAN(*(double *)(local_28 + 3))))
         )))) && (param_5 < param_6)) {
      iVar4 = (int)param_5 << 2;
      ...
      do {
        ...
        ;
        if ((uVar2 & 1) != 0) goto LAB_01085f30;
        param_5 = param_5 + 1;
        iVar4 = iVar4 + 4;
