...
void FUN_00f26a10(ulong *param_1,undefined8 *param_2)

{
  ...
  puVar12 = puVar4;
  if (puVar4 != (undefined8 *)param_1[3]) goto LAB_00f26b98;
...
LAB_00f26b64:
      ...
      if (((void *)((long)pvVar6 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar6 + uVar13 * 8 + uVar9 + 8))) goto LAB_00f26b64;
      ...
      puVar11 = puVar12;
      if (uVar2 != uVar9) goto LAB_00f26b64;
    }
    puVar11 = (undefined8 *)*param_1;
  }
