...
/* v8::internal::compiler::EffectControlLinearizer::LowerNumberToString(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerNumberToString
...

{
  ...
  Builtins::CallableFor((Builtins *)local_80,*(undefined8 *)(*(long *)this + 0x168),0x68);
  local_68 = (Node *)&PTR__CallInterfaceDescriptor_01ca0fc8;
  piStack_60 = local_70;
  pCVar1 = (CallDescriptor *)
           Linkage::GetStubCallDescriptor
                     (*(undefined8 *)**(undefined8 **)this,&local_68,local_70[2] - *local_70,0,0x70,
                      0);
