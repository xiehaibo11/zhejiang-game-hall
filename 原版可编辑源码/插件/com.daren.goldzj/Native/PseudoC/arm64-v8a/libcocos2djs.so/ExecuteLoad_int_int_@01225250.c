...
/* bool v8::internal::wasm::ThreadImpl::ExecuteLoad<int, int>(v8::internal::wasm::Decoder*,
   v8::internal::wasm::InterpreterCode*, unsigned long, int*, v8::internal::MachineRepresentation,
   int) */

bool __thiscall
v8::internal::wasm::ThreadImpl::ExecuteLoad<int,int>
  ...
  *(long *)(this + 0x28) = lVar7 + -0x11;
  ...
  if (!CARRY4(local_a0._1_4_,uVar11)) {
    ...
    if (((3 < *(ulong *)(lVar7 + 0x13)) && ((ulong)uVar2 <= *(ulong *)(lVar7 + 0x13) - 4)) &&
      ...
      uStack_98 = 0;
      local_a0 = (ulong)CONCAT41(*puVar3,1);
      local_90 = 0;
