  ...
  if (this + 0xe0 == pAVar3) {
    ...
    lVar4 = std::__ndk1::
            ...
            __emplace_unique_key_args<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&>,std::__ndk1::tuple<>>
                      ((basic_string *)(this + 0xd8),(piecewise_construct_t *)pbVar1,
                       (tuple *)&DAT_0194880f,(tuple *)&local_50);
    *(SlotData **)(lVar4 + 0x38) = param_1;
    if (*(undefined8 **)(this + 0x80) == *(undefined8 **)(this + 0x88)) {
      ...
      __push_back_slow_path<dragonBones::SlotData*const&>
                ((vector<dragonBones::SlotData*,std::__ndk1::allocator<dragonBones::SlotData*>> *)
                 (this + 0x78),local_60);
    }
    else {
