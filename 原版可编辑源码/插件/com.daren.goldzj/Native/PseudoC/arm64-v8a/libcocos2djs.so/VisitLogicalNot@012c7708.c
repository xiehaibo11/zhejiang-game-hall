...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitLogicalNot(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitLogicalNot
