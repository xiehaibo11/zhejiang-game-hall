...
int FUN_00de7288(undefined8 *param_1,int param_2,int param_3)

{
  ...
  if (*(int *)(param_1 + 0x35) < *(int *)(param_1 + 0x34)) {
    ...
    do {
      ...
      FUN_00df4754(param_1 + 0x2d);
      uVar4 = (*DAT_01d544b8)(param_1[0x36],0,uVar3,1,lVar6,0);
      uVar7 = uVar4 | uVar7;
      lVar6 = lVar6 + piVar8[6];
      iVar5 = iVar5 + 1;
    } while (*(int *)(param_1 + 0x35) < *(int *)(param_1 + 0x34));
    if ((iVar2 - 7U < 4) && (uVar7 != 0)) {
      (*DAT_01d544c8)(lVar1,iVar2 == 4 || iVar2 == 9,uVar3,iVar5);
    }
  }
  else {
    iVar5 = 0;
