...
/* register_all_cocos2dx_editor_support(se::Object*) */

undefined8 register_all_cocos2dx_editor_support(Object *param_1)

{
  ...
  js_register_cocos2dx_editor_support_MiddlewareManager(pOVar3);
  js_register_cocos2dx_editor_support_Texture2D(pOVar3);
  se::Value::~Value(aVStack_38);
