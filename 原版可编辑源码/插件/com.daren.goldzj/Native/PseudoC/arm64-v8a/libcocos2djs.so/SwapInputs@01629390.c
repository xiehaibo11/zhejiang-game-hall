...
/* v8::internal::compiler::BinopMatcher<v8::internal::compiler::IntMatcher<unsigned long,
   ...
   (v8::internal::compiler::IrOpcode::Value)24> >::SwapInputs() */
...
::SwapInputs(BinopMatcher<v8::internal::compiler::IntMatcher<unsigned_long,(v8::internal::compiler::IrOpcode::Value)24>,v8::internal::compiler::IntMatcher<unsigned_long,(v8::internal::compiler::IrOpcode::Value)24>>
             *this)
