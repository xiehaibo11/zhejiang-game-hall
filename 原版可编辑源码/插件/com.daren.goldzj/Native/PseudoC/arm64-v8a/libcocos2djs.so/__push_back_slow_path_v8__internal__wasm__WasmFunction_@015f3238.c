...
/* void std::__ndk1::vector<v8::internal::wasm::WasmFunction,
   std::__ndk1::allocator<v8::internal::wasm::WasmFunction>
   >::__push_back_slow_path<v8::internal::wasm::WasmFunction>(v8::internal::wasm::WasmFunction&&) */
...

{
  ...
  if (uVar1 >> 0x3b == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3b != 0) goto LAB_015f3324;
