...
/* v8::internal::compiler::JSOperatorBuilder::StoreDataPropertyInLiteral(v8::internal::compiler::FeedbackSource
   const&) */

Operator * __thiscall
v8::internal::compiler::JSOperatorBuilder::StoreDataPropertyInLiteral
...

{
  ...
  Operator::Operator(pOVar3,0x2f0,0x20,"JSStoreDataPropertyInLiteral",4,1,1,0,1,1);
