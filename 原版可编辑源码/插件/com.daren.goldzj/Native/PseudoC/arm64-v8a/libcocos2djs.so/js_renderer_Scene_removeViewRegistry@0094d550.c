...
/* js_renderer_Scene_removeViewRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Scene_removeViewRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Scene *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xbf7,"js_renderer_Scene_removeView");
    __android_log_print(6,"jswrapper","js_renderer_Scene_removeView : Invalid Native Object");
  }
  else {
    ...
    if (puVar4[1] - (long)pVVar5 == 0x10) {
      if (pVVar5[8] == (Value)0x5) {
        ...
        if (pVVar6 != (View *)0x0) {
LAB_0094d6a4:
          cocos2d::renderer::Scene::removeView(this,pVVar6);
          goto LAB_0094d720;
        }
      }
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0xbfe,"js_renderer_Scene_removeView");
      __android_log_print(6,"jswrapper","js_renderer_Scene_removeView : Error processing arguments")
      ;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 3074): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(puVar4[1] - (long)pVVar5) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Scene_removeView",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0xc05);
LAB_0094d720:
