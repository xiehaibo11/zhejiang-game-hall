...
/* v8::internal::compiler::Graph::Print() const */

void __thiscall v8::internal::compiler::Graph::Print(Graph *this)

{
  ...
  local_130 = 0;
  local_38 = this;
  compiler::operator<<((basic_ostream *)&local_148,(AsRPO *)&local_38);
  local_148 = &PTR__StdoutStream_01ca1128;
  local_e8[0] = &PTR__StdoutStream_01ca1150;
