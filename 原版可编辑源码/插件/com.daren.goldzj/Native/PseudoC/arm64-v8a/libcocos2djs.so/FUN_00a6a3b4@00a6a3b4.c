...
long FUN_00a6a3b4(long *param_1,long *param_2)

{
  ...
  if ((bVar3 & 1) == 0) {
    ...
    uVar1 = (ulong)(bVar3 >> 1);
                    ...
                    /* try { // try from 00a6a3fc to 00b6a463 has its CatchHandler @ 00a6a5f8 */
  lVar5 = std::__ndk1::__murmur2_or_cityhash<unsigned_long,64ul>::operator()
                    (a_Stack_40,pvVar2,uVar1);
  param_2[1] = lVar5;
  plVar6 = (long *)FUN_00a6a518(param_1,lVar5,param_2 + 2);
  uVar7 = param_1[1];
  uVar8 = param_2[1];
  uVar9 = uVar7 - 1;
  uVar1 = uVar9 & uVar7;
    ...
    if (*param_2 != 0) {
      ...
      if (uVar10 != uVar8) {
        *(long **)(*param_1 + uVar10 * 8) = param_2;
                    /* try { // try from 00a6a4cc to 00b6a507 has its CatchHandler @ 00a6a5f8 */
      }
    }
  }
  ...
  if (*(long *)(lVar4 + 0x28) != local_38) {
    ...
    __stack_chk_fail();
                    ...
                    /* try { // try from 00a6a508 to 00b6a64f has its CatchHandler @ 00a6a2a8 */
  return (long)param_2;
}
