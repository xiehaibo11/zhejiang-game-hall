...
/* spine::Vector<spine::BoundingBoxAttachment*>::~Vector() */

void __thiscall
spine::Vector<spine::BoundingBoxAttachment*>::~Vector(Vector<spine::BoundingBoxAttachment*> *this)

{
  ...
  *(undefined ***)this = &PTR__Vector_01c8f4b8;
  *(undefined8 *)(this + 8) = 0;
  if (lVar2 != 0) {
