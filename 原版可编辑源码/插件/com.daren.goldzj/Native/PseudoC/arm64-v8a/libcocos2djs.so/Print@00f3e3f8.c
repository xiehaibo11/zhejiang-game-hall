...
/* v8::internal::FeedbackVectorSpec::Print() */

void __thiscall v8::internal::FeedbackVectorSpec::Print(FeedbackVectorSpec *this)

{
  ...
  local_130 = 0;
  local_f0 = 0;
  FeedbackVectorSpecPrint(this,(basic_ostream *)&local_148);
