...
void FUN_01453da0(ulong param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  uVar8 = *(undefined8 *)(unaff_x29 + (long)*(short *)(unaff_x20 + unaff_x19 + 1) * 8);
  uVar9 = unaff_x26 +
  ...
  if ((int)uVar9 != (int)*(undefined8 *)(unaff_x26 + 0xa0)) {
    lVar1 = (ulong)*(ushort *)(unaff_x20 + unaff_x19 + 3) * 4 + 0x1f;
...
LAB_01453e4c:
  ...
  *(undefined4 *)(unaff_x29 + -0x20) = uVar7;
  ...
  uVar6 = (uint)uVar9;
  puVar3 = &local_60;
  if (uVar6 == (uint)uVar8) goto LAB_01453f74;
  if ((uVar9 & 1) == 0) {
joined_r0x01453f34:
    puVar3 = &local_60;
    if (uVar6 == 0) goto LAB_01453f74;
  }
  else {
    puVar3 = &local_60;
    if ((uVar6 == (uint)*(undefined8 *)(unaff_x26 + 200)) ||
       (lVar10 = unaff_x26 + (ulong)*(uint *)(uVar9 - 1), puVar3 = &local_60,
       (*(byte *)(lVar10 + 9) >> 4 & 1) != 0)) goto LAB_01453f74;
    if ((int)lVar10 == (int)*(undefined8 *)(unaff_x26 + 0x140)) {
      puVar3 = &local_60;
      if (ABS(*(double *)(uVar9 + 3)) <= 0.0) goto LAB_01453f74;
    }
    else if (*(short *)(lVar10 + 7) == 0x41) {
      uVar6 = *(uint *)(uVar9 + 3) >> 1 & 0x3fffffff;
      goto joined_r0x01453f34;
    }
  }
  uVar8 = *(undefined8 *)(unaff_x26 + 0xb8);
  puVar3 = &local_60;
LAB_01453f74:
                    /* WARNING: Could not recover jumptable at 0x01453fa0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(puVar3[4] + (ulong)*(byte *)(*(long *)(puVar3[5] + -0x18) + puVar3[3] + 5) * 8))
            (uVar8);
  return;
}
