...
bool FUN_00b61eb0(long param_1,long *param_2,long *param_3,undefined8 *param_4,uint *param_5,
...
LAB_00b62278:
    ...
    if ((uVar15 >> 1 & 1) == 0) {
      ...
      if ((*(byte *)(*(long *)(param_1 + 0x20) + 0x19) >> 4 & 1) == 0) {
        if ((uVar15 & 0x60) == 0) goto LAB_00b622cc;
        goto LAB_00b62464;
      }
      if ((uVar15 >> 6 & 1) != 0) {
        if ((*(uint *)(lVar10 + 0x9c) & (uVar18 ^ 0xffffffff)) != 0) goto LAB_00b622cc;
        goto LAB_00b62464;
      }
      if (*(long *)(lVar10 + 0xa8) != 0) goto LAB_00b62464;
LAB_00b622cc:
      ...
      if (iVar4 == 0) {
        ...
        if ((*(byte *)(lVar10 + 0x98) >> 5 & 1) == 0) goto LAB_00b62464;
        uVar15 = 0;
      }
      uVar15 = (*(uint *)(lVar10 + 0x84) >> 1 & 0x100 | uVar15) ^ 0x100;
      iVar4 = FUN_00b625f0(param_1,lVar10,0);
      if (iVar4 != 0) {
        uVar15 = uVar15 | 0x40;
      }
...
LAB_00b62450:
  if ((uVar15 >> 2 & 1) == 0) goto LAB_00b62464;
...
LAB_00b62188:
                ...
                if ((uVar14 & (uVar18 ^ 0xffffffff)) != 0) goto LAB_00b621d0;
                goto LAB_00b62464;
              }
              if (*piVar7 == 1) {
...
LAB_00b62104:
                ...
                local_a8 = piVar7;
                if (local_b0 != (X509_NAME *)0x0) goto LAB_00b62104;
              }
              else {
      ...
      if (*(long **)(lVar10 + 0x90) == (long *)0x0) {
        if ((uVar15 >> 5 & 1) != 0) goto LAB_00b621c8;
      }
      else if (((uVar15 >> 5 & 1) != 0) && (**(long **)(lVar10 + 0x90) == 0)) {
LAB_00b621c8:
        if ((uVar14 & (uVar18 ^ 0xffffffff)) == 0) goto LAB_00b62464;
LAB_00b621d0:
  ...
  if (((int)uVar16 <= (int)uVar15) && (uVar15 != 0)) {
    if ((local_a0 != 0) && (uVar15 == uVar16)) {
      ...
      if ((iVar4 == 0) || ((local_64 < 1 && (local_68 < 1)))) goto LAB_00b62464;
    }
    local_b8 = local_98;
    uVar16 = uVar15;
    uVar17 = uVar18;
...
LAB_00b62464:
  ...
  if (iVar4 <= iVar1) goto code_r0x00b62478;
  goto LAB_00b62278;
code_r0x00b62478:
  if (local_a0 != 0) {
      ...
      if (0 < iVar1) {
        ...
        do {
          ...
          if ((*(long *)(lVar10 + 0xa8) != 0) && (*(long *)(local_a0 + 0xa0) != 0)) {
            ...
            iVar4 = X509_NAME_cmp(pXVar11,pXVar12);
            if (((iVar4 == 0) &&
                (((iVar4 = FUN_00b601c0(lVar10,local_a0,0x5a), iVar4 != 0 &&
                  (iVar4 = FUN_00b601c0(lVar10,local_a0,0x302), iVar4 != 0)) &&
              ...
              iVar1 = FUN_00b625f0(param_1,lVar10,0);
              if (iVar1 != 0) {
                *param_5 = *param_5 | 2;
              }
