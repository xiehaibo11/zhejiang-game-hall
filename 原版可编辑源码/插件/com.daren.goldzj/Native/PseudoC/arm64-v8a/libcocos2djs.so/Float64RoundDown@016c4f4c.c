...
/* v8::internal::compiler::GraphAssembler::Float64RoundDown(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Float64RoundDown(GraphAssembler *this,Node *param_1)

{
  ...
  if (cVar2 == '\0') {
    ...
    V8_Fatal("Check failed: %s.","machine()->Float64RoundDown().IsSupported()");
  }
