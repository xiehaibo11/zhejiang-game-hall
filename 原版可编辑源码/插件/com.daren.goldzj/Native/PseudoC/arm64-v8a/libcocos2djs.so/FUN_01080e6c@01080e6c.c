...
void FUN_01080e6c(undefined8 param_1,ulong *param_2,int param_3,ulong *param_4,undefined8 param_5,
                 int param_6)

{
  ...
  if ((bVar3 < 0xd && (1 << (ulong)bVar3 & 0x1030U) != 0) ||
    ...
    FUN_01082000(param_2,param_6);
  }
  else {
    if ((bVar2 < 0x30) && (bVar3 != 0)) {
      v8::internal::JSObject::TransitionElementsKind(param_2,0);
    }
    if (bVar2 < 0x20) {
