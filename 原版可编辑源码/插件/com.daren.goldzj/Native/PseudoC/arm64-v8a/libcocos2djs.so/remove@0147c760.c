...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<long,
   ...
   std::__ndk1::vector<v8::sampler::Sampler*, std::__ndk1::allocator<v8::sampler::Sampler*> > > >
   >::remove(std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<long,
   std::__ndk1::vector<v8::sampler::Sampler*, std::__ndk1::allocator<v8::sampler::Sampler*> > >,
   void*>*>) */
...

{
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar7 == uVar4) goto LAB_0147c83c;
  }
  if (*param_3 != 0) {
