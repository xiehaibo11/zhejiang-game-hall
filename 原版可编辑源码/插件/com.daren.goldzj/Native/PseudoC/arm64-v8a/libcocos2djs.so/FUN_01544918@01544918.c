...
void FUN_01544918(long param_1,long param_2)

{
  ...
  plVar4 = *(long **)**(undefined8 **)(param_2 + 0x38);
  ...
  if (lVar5 == 0) {
    ...
    *(byte *)(param_2 + 0x19) = bVar2 & 0xe0 | bVar1 | (*(byte *)(lVar5 + 0x19) | bVar2) & 0x10;
    lVar5 = *(long *)(param_1 + 8);
    plVar4 = *(long **)(**(long **)(param_2 + 0x38) + 0x10);
    uVar3 = v8::internal::GetCurrentStackPosition();
    if (uVar3 < *(ulong *)(lVar5 + 0x58)) {
      *(char **)(param_1 + 0x18) = "Stack overflow";
    }
      ...
      if (lVar5 == 0) {
        ...
        *(undefined2 *)(param_2 + 0x1a) =
             *(undefined2 *)(*(long *)(**(long **)(param_2 + 0x38) + 0x10) + 0x1a);
      }
    }
  }
  return;
