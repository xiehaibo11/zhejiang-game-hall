...
/* js_cocos2dx_spine_SkeletonBounds_aabbcontainsPointRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonBounds_aabbcontainsPointRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonBounds *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x25fc,"js_cocos2dx_spine_SkeletonBounds_aabbcontainsPoint");
    pcVar8 = "js_cocos2dx_spine_SkeletonBounds_aabbcontainsPoint : Invalid Native Object";
LAB_00c598d8:
    ...
    if (uVar10 == 0x20) {
      ...
      if (((uVar10 & 1) == 0) || ((uVar6 & 1) == 0)) {
        ...
        bVar3 = spine::SkeletonBounds::aabbcontainsPoint(this,local_78._4_4_,(float)local_78);
        pVVar7 = (Value *)se::State::rval(aSStack_70);
        uVar10 = boolean_to_seval((bool)(bVar3 & 1),pVVar7);
        if ((uVar10 & 1) != 0) goto LAB_00c59910;
        uVar9 = 0x2608;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,uVar9,"js_cocos2dx_spine_SkeletonBounds_aabbcontainsPoint");
      pcVar8 = "js_cocos2dx_spine_SkeletonBounds_aabbcontainsPoint : Error processing arguments";
      goto LAB_00c598d8;
    }
    __android_log_print(6,"jswrapper",&DAT_019124df,uVar10 >> 4,2);
  }
