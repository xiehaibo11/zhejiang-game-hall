...
/* bool 
   ...
   cocos2d::middleware::Texture2D>::value, cocos2d::middleware::Texture2D>::type*, se::Value*,
   bool*) */

bool native_ptr_to_seval<cocos2d::middleware::Texture2D>(type *param_1,Value *param_2,bool *param_3)

{
  ...
  if (param_1 == (type *)0x0) {
    ...
    if (lVar1 == lVar2) {
      pCVar3 = JSBClassType::findClass<cocos2d::middleware::Texture2D>((Texture2D *)param_1);
