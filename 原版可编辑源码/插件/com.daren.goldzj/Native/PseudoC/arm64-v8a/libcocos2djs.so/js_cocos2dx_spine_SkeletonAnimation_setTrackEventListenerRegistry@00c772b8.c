...
/* js_cocos2dx_spine_SkeletonAnimation_setTrackEventListenerRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonAnimation_setTrackEventListenerRegistry
...

{
  ...
  if (this == (SkeletonAnimation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x36d1,"js_cocos2dx_spine_SkeletonAnimation_setTrackEventListener");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonAnimation_setTrackEventListener : Invalid Native Object"
                       );
  }
  else {
    ...
    if (plVar5[1] - (long)pVVar10 == 0x20) {
      ...
      if (pVVar10[0x18] == (Value)0x5) {
        ...
        if ((uVar8 & 1) == 0) goto LAB_00c7752c;
...
LAB_00c77554:
        ...
        if (!bVar3) goto LAB_00c77534;
LAB_00c7758c:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                            ,0x36f8,"js_cocos2dx_spine_SkeletonAnimation_setTrackEventListener");
        __android_log_print(6,"jswrapper",
                            "js_cocos2dx_spine_SkeletonAnimation_setTrackEventListener : Error processing arguments"
                           );
        bVar3 = false;
      }
      else {
LAB_00c7752c:
        local_b0 = (long *)0x0;
        if (bVar3) goto LAB_00c7758c;
LAB_00c77534:
        spine::SkeletonAnimation::setTrackEventListener(this,pTVar7,(function *)alStack_d0);
        bVar3 = true;
      }
...
LAB_00c775fc:
      ...
      if (bVar3) goto LAB_00c77630;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 14076): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar5[1] - (long)pVVar10) >> 4,2);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonAnimation_setTrackEventListener",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x36ff);
LAB_00c77630:
