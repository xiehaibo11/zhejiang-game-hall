...
/* void std::__ndk1::vector<v8::internal::AllocationTracker::FunctionInfo*,
   std::__ndk1::allocator<v8::internal::AllocationTracker::FunctionInfo*>
   >::__push_back_slow_path<v8::internal::AllocationTracker::FunctionInfo*
   const&>(v8::internal::AllocationTracker::FunctionInfo* const&) */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_0152ce14;
