...
void FUN_01093b2c(undefined8 param_1,undefined8 param_2,long param_3,ulong param_4)

{
  ...
  if (uVar2 <= (uint)(*(int *)(uVar20 + 3) >> 1)) {
    FUN_010954fc(this,extraout_x1,puVar8,param_4 & 0xffffffff,0);
    puVar9 = puVar8;
    goto joined_r0x01093c74;
  }
  ...
  if (0 < (int)uVar5) {
    ...
    if (uVar5 < 8) {
      ...
      if (uVar15 == uVar13) goto LAB_01093cb8;
    }
