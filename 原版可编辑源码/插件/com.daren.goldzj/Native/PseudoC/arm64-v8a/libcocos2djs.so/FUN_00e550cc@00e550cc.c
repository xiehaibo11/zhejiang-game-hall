...
ulong FUN_00e550cc(long param_1,long param_2,uint param_3,uint param_4)

{
  ...
  } while ((param_4 < uVar10) || (uVar6 = uVar7 + 1, uVar7 = uVar8, uVar10 < param_4));
  ...
  if (uVar9 != 0) {
    ...
    while (uVar8 = uVar7, uVar6 < uVar8) {
      ...
      if ((uVar10 <= param_3) && (uVar6 = uVar7 + 1, uVar7 = uVar8, param_3 <= uVar10 + *pbVar3)) {
                    /* WARNING: Could not recover jumptable at 0x00e551dc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        uVar9 = (**(code **)(*(long *)(param_2 + 0x10) + 0x18))(param_2,param_3);
        return uVar9;
      }
    }
  }
  ...
  if (uVar9 != 0) {
    ...
    if (uVar6 != 0) {
      ...
      do {
        ...
        if (uVar10 <= param_3) {
          if (param_3 <= uVar10) {
            return (ulong)CONCAT11(*puVar4,puVar4[1]);
          }
          uVar7 = uVar8 + 1;
          uVar8 = uVar6;
        }
