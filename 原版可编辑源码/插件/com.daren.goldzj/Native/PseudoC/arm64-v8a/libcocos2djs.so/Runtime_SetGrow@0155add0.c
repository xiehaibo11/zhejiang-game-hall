...
/* v8::internal::Runtime_SetGrow(int, unsigned long*, v8::internal::Isolate*) */

undefined8 v8::internal::Runtime_SetGrow(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar8 = FUN_0155af94(param_1,param_2,param_3);
    return uVar8;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  uVar6 = *param_2;
  if (((uVar6 & 1) != 0) &&
     (*(short *)((uVar6 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar6 - 1)) == 0x41d)) {
    ...
    puVar4 = (ulong *)OrderedHashTable<v8::internal::OrderedHashSet,1>::EnsureGrowable
                                (param_3,puVar4);
    if (puVar4 == (ulong *)0x0) {
