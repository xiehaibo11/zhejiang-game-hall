...
void FUN_00e0e498(long param_1,long param_2,long param_3)
...
LAB_00e0e7a8:
        *puVar1 = uVar12;
        ...
        uVar13 = (ulong)(byte)(&DAT_01974b80)[bVar7];
        uVar12 = *puVar1;
        ...
        *puVar1 = uVar12;
        if (uVar13 - 8 < 0x14) {
          iVar6 = *(int *)(&DAT_01975178 + uVar13 * 4);
          uVar5 = (uint)bVar7 - *(int *)(&DAT_019752c4 + uVar13 * 4) & 0xffff;
        ...
        uVar13 = (ulong)(byte)(&DAT_01974980)[uVar5];
        ...
        *puVar1 = uVar12;
        if (uVar13 - 4 < 0x1a) {
          iVar6 = *(int *)(&DAT_019751ec + uVar13 * 4);
          uVar10 = uVar10 - *(int *)(&DAT_01975338 + uVar13 * 4) & 0xffff;
