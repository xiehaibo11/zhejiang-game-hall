...
/* spine::SkeletonAnimation::setTrackInterruptListener(spine::TrackEntry*,
   std::__ndk1::function<void (spine::TrackEntry*)> const&) */
...

{
  ...
  if (lVar5 == 0) {
    ...
    *(undefined8 *)(param_1 + 0x18) = 0;
    ...
    if (plVar2 == (long *)0x0) goto LAB_00d0fb6c;
LAB_00d0fafc:
    ...
    plVar2 = *(long **)(param_2 + 0x20);
    if (plVar2 != (long *)0x0) goto LAB_00d0fafc;
LAB_00d0fb6c:
    local_50 = (long *)0x0;
  }
  FUN_00c8c388(alStack_70,lVar5 + 0x30);
  if (alStack_70 == local_50) {
    pcVar4 = *(code **)(*local_50 + 0x20);
  }
  else {
    if (local_50 == (long *)0x0) goto LAB_00d0fbc4;
