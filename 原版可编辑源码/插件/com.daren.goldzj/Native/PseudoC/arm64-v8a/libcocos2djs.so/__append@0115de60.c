...
/* std::__ndk1::vector<void*, std::__ndk1::allocator<void*> >::__append(unsigned long) */

void __thiscall
std::__ndk1::vector<void*,std::__ndk1::allocator<void*>>::__append
          (vector<void*,std::__ndk1::allocator<void*>> *this,ulong param_1)
...
LAB_0115dfb4:
  ...
  if (uVar1 == 0) {
    ...
    if (uVar1 >> 0x3d != 0) goto LAB_0115dfb4;
