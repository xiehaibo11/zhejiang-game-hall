...
undefined8 FUN_00b24934(undefined8 param_1,uchar *param_2,uchar *param_3,ulong param_4)

{
  ...
  if (param_4 >> 0x3e != 0) {
    ...
    lVar3 = uVar5 + 0x4000000000000000;
    ...
    do {
      ...
      RC2_ofb64_encrypt(param_3,out,0x4000000000000000,(RC2_KEY *)(lVar2 + 4),ivec,&local_64);
  ...
  if (param_4 != 0) {
    ...
    RC2_ofb64_encrypt(param_3,param_2,param_4,(RC2_KEY *)(lVar3 + 4),puVar4,&local_68);
