...
joined_r0x00b415f8:
              if (psVar4 != (stack_st_PKCS12_SAFEBAG *)0x0) {
                iVar2 = FUN_00b41834(psVar4,pass,pkey,lVar6);
                OPENSSL_sk_pop_free(psVar4,PKCS12_SAFEBAG_free);
                if (iVar2 != 0) goto LAB_00b41624;
              }
              ...
              do {
                if (x509 != (X509 *)0x0) {
                  ...
                  if (psVar5 == (stack_st_X509 *)0x0) {
                    ...
                    *ca = psVar5;
                    if (psVar5 == (stack_st_X509 *)0x0) goto LAB_00b417e4;
                  }
                  iVar1 = OPENSSL_sk_push(psVar5,x509);
                  if (iVar1 == 0) goto LAB_00b417e4;
                }
                X509_free((X509 *)0x0);
                x509 = (X509 *)OPENSSL_sk_pop(lVar6);
              } while (x509 != (X509 *)0x0);
