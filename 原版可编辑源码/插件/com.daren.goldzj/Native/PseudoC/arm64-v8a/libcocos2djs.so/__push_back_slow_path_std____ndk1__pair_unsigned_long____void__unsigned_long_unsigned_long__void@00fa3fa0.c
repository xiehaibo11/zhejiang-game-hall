...
/* void std::__ndk1::vector<std::__ndk1::pair<unsigned long (*)(void*, unsigned long, unsigned
   long), void*>, std::__ndk1::allocator<std::__ndk1::pair<unsigned long (*)(void*, unsigned long,
   unsigned long), void*> > >::__push_back_slow_path<std::__ndk1::pair<unsigned long (*)(void*,
   unsigned long, unsigned long), void*> >(std::__ndk1::pair<unsigned long (*)(void*, unsigned long,
   unsigned long), void*>&&) */
...

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_00fa408c;
