...
/* v8::internal::TorqueGeneratedClassVerifiers::ExternalOneByteStringVerify(v8::internal::ExternalOneByteString,
   v8::internal::Isolate*) */

void v8::internal::TorqueGeneratedClassVerifiers::ExternalOneByteStringVerify
...

{
  ...
  V8_Fatal("Check failed: %s.","o.IsExternalOneByteString()");
}
