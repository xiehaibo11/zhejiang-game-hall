...
/* std::__ndk1::__split_buffer<cocos2d::SAXState*,
   std::__ndk1::allocator<cocos2d::SAXState*>&>::push_front(cocos2d::SAXState* const&) */

void __thiscall
std::__ndk1::__split_buffer<cocos2d::SAXState*,std::__ndk1::allocator<cocos2d::SAXState*>&>::
push_front(__split_buffer<cocos2d::SAXState*,std::__ndk1::allocator<cocos2d::SAXState*>&> *this,
          SAXState **param_1)

{
  ...
  puVar14 = __src;
  if (__src != *(undefined8 **)this) goto LAB_0087a044;
...
LAB_0087a014:
      ...
      if (uVar2 != uVar10) goto LAB_0087a014;
    }
