...
/* v8::internal::compiler::GraphAssembler::NumberIsFloat64Hole(v8::internal::TNode<v8::internal::UnionT<v8::internal::Smi,
   v8::internal::HeapNumber> >) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::NumberIsFloat64Hole(GraphAssembler *this,Node *param_2)
