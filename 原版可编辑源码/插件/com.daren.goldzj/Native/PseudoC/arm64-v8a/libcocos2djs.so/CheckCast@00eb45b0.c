...
/* v8::BigIntObject::CheckCast(v8::Value*) */

void v8::BigIntObject::CheckCast(Value *param_1)

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    if (((*(short *)(uVar2 + *(uint *)(uVar3 - 1)) == 0x411) && ((*(uint *)(uVar3 + 0xb) & 1) != 0))
       && (*(short *)(uVar2 + *(uint *)((uVar3 & 0xffffffff00000000 | (ulong)*(uint *)(uVar3 + 0xb))
                                       - 1)) == 0x41)) {
      return;
    }
  }
  ...
  if (lVar1 != 0) {
    if (*(code **)(lVar1 + 0xb738) != (code *)0x0) {
      (**(code **)(lVar1 + 0xb738))("v8::BigIntObject::Cast()","Could not convert to BigIntObject");
