...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<unsigned
   int, v8::internal::compiler::VirtualObject*>, void*>*>, bool>
   std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned int,
   v8::internal::compiler::VirtualObject*>, std::__ndk1::__unordered_map_hasher<unsigned int,
   std::__ndk1::__hash_value_type<unsigned int, v8::internal::compiler::VirtualObject*>,
   v8::base::hash<unsigned int>, true>, std::__ndk1::__unordered_map_equal<unsigned int,
   std::__ndk1::__hash_value_type<unsigned int, v8::internal::compiler::VirtualObject*>,
   std::__ndk1::equal_to<unsigned int>, true>,
   v8::internal::ZoneAllocator<std::__ndk1::__hash_value_type<unsigned int,
   v8::internal::compiler::VirtualObject*> > >::__emplace_unique_key_args<unsigned int,
   std::__ndk1::pair<unsigned int, v8::internal::compiler::VirtualObject*> >(unsigned int const&,
   std::__ndk1::pair<unsigned int, v8::internal::compiler::VirtualObject*>&&) */
      ...
      for (plVar8 = (long *)*plVar8; plVar8 != (long *)0x0; plVar8 = (long *)*plVar8) {
        ...
        if (uVar7 != uVar2) {
          if (uVar6 < 2) {
            ...
            if (uVar7 - uVar1 * uVar9 == unaff_x25) goto LAB_016bcb30;
            break;
          }
...
LAB_016bcb30:
  ...
  if ((ulong)(*(long *)(this_00 + 0x18) - (long)plVar8) < 0x20) {
    plVar8 = (long *)v8::internal::Zone::NewExpand(this_00,0x20);
  }
  else {
    *(long **)(this_00 + 0x10) = plVar8 + 4;
  }
