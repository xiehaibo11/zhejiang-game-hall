...
void FUN_01454800(ulong param_1)

{
  ...
  if ((((int)lVar9 == (int)*(undefined8 *)(unaff_x26 + 0xa0)) ||
      ((*(byte *)(unaff_x20 + unaff_x19 + 5) >> 5 & 1) == 0)) ||
     (uVar2 = unaff_x26 +
              (ulong)*(uint *)(lVar9 + (ulong)*(ushort *)(unaff_x20 + unaff_x19 + 3) * 4 + 0x1f),
     (uVar2 & 1) == 0)) {
  ...
  if (lVar9 == 0) {
    ...
    *puVar16 = uVar11;
    ...
    puVar16[1] = iVar4 * 2;
    *(undefined8 *)(unaff_x26 + 0x40) = 0x1454ab4;
    ...
    *(undefined8 *)(unaff_x26 + 0x38) = 0;
    ...
    if (uVar11 != (uint)*(undefined8 *)(unaff_x26 + 0xe8)) {
      ...
      *(int *)(uVar12 + 3) = iVar4 * 2;
      if (((uint)*(undefined8 *)((uVar12 & 0xfffffffffffc0000) + 8) >> 2 & 1) == 0) {
        *(undefined8 *)(unaff_x26 + 0x40) = 0x145498c;
        *(undefined1 **)(unaff_x26 + 0x38) = &stack0xfffffffffffffff0;
  ...
  *(int *)(lVar9 + 7) = (int)uVar12;
                    /* WARNING: Could not recover jumptable at 0x01454bc4. Too many branches */
