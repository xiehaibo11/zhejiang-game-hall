...
/* v8::internal::interpreter::BytecodeArrayBuilder::IncBlockCounter(int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::IncBlockCounter
