...
/* v8::internal::compiler::JSIntrinsicLowering::ReduceAsyncGeneratorResolve(v8::internal::compiler::Node*)
    */

Node * __thiscall
v8::internal::compiler::JSIntrinsicLowering::ReduceAsyncGeneratorResolve
...

{
  ...
  Builtins::CallableFor((Builtins *)local_58,*(undefined8 *)(*(long *)(this + 0x10) + 0x168),0x260);
