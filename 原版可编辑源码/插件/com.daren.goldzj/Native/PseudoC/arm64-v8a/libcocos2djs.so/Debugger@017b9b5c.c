...
/* v8::internal::interpreter::BytecodeArrayBuilder::Debugger() */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::Debugger(BytecodeArrayBuilder *this)
