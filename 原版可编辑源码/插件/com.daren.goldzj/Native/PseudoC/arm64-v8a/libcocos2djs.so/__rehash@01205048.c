...
/* std::__ndk1::__hash_table<v8::internal::wasm::WasmCode*,
   ...
   std::__ndk1::allocator<v8::internal::wasm::WasmCode*> >::__rehash(unsigned long) */
...
::__rehash(__hash_table<v8::internal::wasm::WasmCode*,std::__ndk1::hash<v8::internal::wasm::WasmCode*>,std::__ndk1::equal_to<v8::internal::wasm::WasmCode*>,std::__ndk1::allocator<v8::internal::wasm::WasmCode*>>
           *this,ulong param_1)
