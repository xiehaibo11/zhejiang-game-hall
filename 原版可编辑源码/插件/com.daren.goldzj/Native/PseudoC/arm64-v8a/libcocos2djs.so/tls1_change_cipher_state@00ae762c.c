    ...
    *(uint *)(param_1 + 0x110) = uVar1;
       ...
       (uVar2 = *(uint *)(*(long *)(*(long *)(param_1 + 8) + 0xc0) + 0x68), (uVar2 >> 3 & 1) != 0))
    {
      ...
      *(EVP_CIPHER_CTX **)(param_1 + 0x138) = pEVar12;
      if (pEVar12 == (EVP_CIPHER_CTX *)0x0) goto LAB_00ae785c;
      bVar4 = false;
      if ((*(uint *)(*(long *)(*(long *)(param_1 + 8) + 0xc0) + 0x68) >> 3 & 1) != 0)
      goto LAB_00ae76b0;
LAB_00ae770c:
      local_138 = (EVP_MD_CTX *)ssl_replace_hash(param_1 + 0x140,0);
      if (local_138 == (EVP_MD_CTX *)0x0) goto LAB_00ae785c;
    }
    else {
      bVar4 = true;
      if ((uVar2 >> 3 & 1) == 0) goto LAB_00ae770c;
LAB_00ae76b0:
  ...
  if (*(int *)(*(long *)(param_1 + 0x90) + 600) < iVar10) {
    ...
    if (((uint)uVar9 >> 0x15 & 1) == 0) {
      ...
      if ((pkey == (EVP_PKEY *)0x0) ||
        ...
        goto LAB_00ae7af8;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ae79a0 with catch @ 00ae794c
                        */
      EVP_PKEY_free(pkey);
    }
    ...
    if ((uVar9 & 0xf0007) == 6) {
      iVar6 = EVP_CipherInit_ex(pEVar12,cipher,(ENGINE *)0x0,key,(uchar *)0x0,param_2 & 2);
                    /* try { // try from 00ae7998 to 00be799f has its CatchHandler @ 00ae7b00 */
                    /* try { // try from 00ae79a0 to 00be7b03 has its CatchHandler @ 00ae794c */
      ...
      if ((uVar9 & 0xf0007) == 7) {
        ...
        if ((((iVar7 == 0) || (iVar7 = EVP_CIPHER_CTX_ctrl(pEVar12,9,0xc,(void *)0x0), iVar7 == 0))
          ...
          goto LAB_00ae7af8;
                    ...
                    /* try { // try from 00ae7b54 to 00be7b5b has its CatchHandler @ 00ae7e20 */
                    /* try { // try from 00ae7b5c to 00be7d07 has its CatchHandler @ 00ae7b04 */
...
LAB_00ae7af8:
  ERR_put_error(0x14,0xd1,iVar6,"ssl/t1_enc.c",iVar7);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ae7998 with catch @ 00ae7b00
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ae7b5c with catch @ 00ae7b04
                       catch(type#1 @ 00000000) { ... } // from try @ 00ae7d10 with catch @ 00ae7b04
                        */
  OPENSSL_cleanse(auStack_a0,0x40);
  OPENSSL_cleanse(auStack_e0,0x40);
  OPENSSL_cleanse(auStack_100,0x20);
