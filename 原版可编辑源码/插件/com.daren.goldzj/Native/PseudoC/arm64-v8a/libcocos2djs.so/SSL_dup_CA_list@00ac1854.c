    ...
    if (0 < iVar1) {
      ...
      do {
        ...
        if ((pXVar4 == (X509_NAME *)0x0) || (iVar2 = OPENSSL_sk_push(psVar3,pXVar4), iVar2 == 0)) {
                    /* try { // try from 00ac18ec to 00bc19af has its CatchHandler @ 00ac1a54 */
          OPENSSL_sk_pop_free(psVar3,X509_NAME_free);
          X509_NAME_free(pXVar4);
          return (stack_st_X509_NAME *)0x0;
        }
                    /* try { // try from 00ac18b0 to 00bc18b7 has its CatchHandler @ 00ac1a40 */
        iVar1 = iVar1 + 1;
                    /* try { // try from 00ac18b8 to 00bc18eb has its CatchHandler @ 00ac160c */
