...
void FUN_0143f9e0(undefined8 param_1,undefined8 param_2,undefined8 param_3,int param_4,
...

{
  ...
  *(int *)(param_7 + -0x20) = unaff_w19 * 2;
  FUN_01347860();
  lVar1 = unaff_x26 + (ulong)*(uint *)(*(long *)(param_7 + -0x10) + 0x13);
  param_4 = (*(int *)(lVar1 + 7) + -3) - param_4;
  if (param_4 < 0) {
    *(int *)(param_7 + -0x20) = unaff_w19 * 2;
  ...
  *(int *)(lVar1 + 7) = param_4;
                    /* WARNING: Could not recover jumptable at 0x0143faa8. Too many branches */
