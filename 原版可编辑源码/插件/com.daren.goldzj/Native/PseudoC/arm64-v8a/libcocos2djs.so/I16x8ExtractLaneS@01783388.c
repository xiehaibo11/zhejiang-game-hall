...
/* v8::internal::compiler::MachineOperatorBuilder::I16x8ExtractLaneS(int) */

Operator * __thiscall
v8::internal::compiler::MachineOperatorBuilder::I16x8ExtractLaneS
...

{
  ...
  Operator::Operator(pOVar1,0x25d,0x7c,"Extract lane",1,0,0,1,0,0);
