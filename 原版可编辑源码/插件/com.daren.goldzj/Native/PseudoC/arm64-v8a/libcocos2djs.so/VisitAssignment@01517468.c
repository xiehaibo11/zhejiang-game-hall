...
v8::internal::interpreter::BytecodeGenerator::VisitAssignment
          (BytecodeGenerator *this,Assignment *param_1)

{
  ...
  PrepareAssignmentLhs(auStack_88,this,*(undefined8 *)(param_1 + 8),0);
  ...
  *(int *)(pBStack_50 + 0x118) = local_48;
  ...
  BuildAssignment(this,auStack_88,*(uint *)(param_1 + 4) >> 7 & 0x7f,
                  *(uint *)(param_1 + 4) >> 0xe & 1);
