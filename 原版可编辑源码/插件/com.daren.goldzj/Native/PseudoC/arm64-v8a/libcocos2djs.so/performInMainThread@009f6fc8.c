...

{
  ...
  long local_38;
                    ...
                    /* try { // try from 009f6fc8 to 00af6fd3 has its CatchHandler @ 009f7188 */
                    /* try { // try from 009f6fdc to 00af7013 has its CatchHandler @ 009f71c4 */
  lVar1 = tpidr_el0;
  ...
  *(undefined ***)pPVar2 = &PTR__SimpleProvided_01c6c7f8;
  SimpleProvided::setCompleteFunction((SimpleProvided *)pPVar2,param_1);
                    /* try { // try from 009f7030 to 00af7073 has its CatchHandler @ 009f71c0 */
  local_40 = pPVar2;
