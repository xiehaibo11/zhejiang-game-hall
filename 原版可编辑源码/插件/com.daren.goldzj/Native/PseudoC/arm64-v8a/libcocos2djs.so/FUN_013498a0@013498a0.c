...
void FUN_013498a0(undefined8 param_1)

{
  ...
  if ((int)uVar3 != (int)*(undefined8 *)(unaff_x26 + 0xa0) &&
    ...
    auStack_60[4] = *(undefined8 *)(unaff_x26 + 0x890);
    auStack_60[5] = param_1;
  ...
  uVar4 = FUN_013c0ba0(param_1,*(undefined8 *)(unaff_x26 + 0xad0),unaff_x27,param_1);
  puVar1 = (undefined8 *)auStack_30;
  if (((uVar4 & 1) != 0) &&
     (puVar1 = (undefined8 *)auStack_30,
     (*(byte *)(unaff_x26 + (ulong)*(uint *)(uVar4 - 1) + 9) >> 1 & 1) != 0)) {
    puVar1 = auStack_60 + 4;
    auStack_60[5] = 0;
    auStack_60[4] = param_1;
  ...
  uVar4 = FUN_013c0ba0(*(undefined8 *)((long)puVar1 + 8),*(undefined8 *)(unaff_x26 + 0xa68));
