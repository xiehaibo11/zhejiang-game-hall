...
/* dragonBones::CCArmatureCacheDisplay::removeDBEventListener(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

void __thiscall
dragonBones::CCArmatureCacheDisplay::removeDBEventListener
...

{
  ...
  *this_00;
  ...
  p_Var2 = (__tree_node_base *)
           ...
           find<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>
                     (this_00,param_1);
  if (this + 0x60 == (CCArmatureCacheDisplay *)p_Var2) {
    return;
  }
  ...
  *(long *)(this + 0x68) = *(long *)(this + 0x68) + -1;
  std::__ndk1::__tree_remove<std::__ndk1::__tree_node_base<void*>*>
            (*(__tree_node_base **)(this + 0x60),p_Var2);
