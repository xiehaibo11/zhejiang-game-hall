...
/* bool v8::internal::wasm::ThreadImpl::DoSimdLoadSplat<v8::internal::wasm::int8, int,
   short>(v8::internal::wasm::Decoder*, v8::internal::wasm::InterpreterCode*, unsigned long, int*,
   v8::internal::MachineRepresentation) */

bool v8::internal::wasm::ThreadImpl::DoSimdLoadSplat<v8::internal::wasm::int8,int,short>
               (ulong param_1)

{
  ...
  if (bVar3) {
    ...
    *(long *)(param_1 + 0x28) = lVar4 + -0x11;
    ...
    uVar1 = *(undefined2 *)((ulong)&local_70 | 1);
    local_50 = CONCAT26(uVar1,CONCAT24(uVar1,CONCAT22(uVar1,uVar1)));
    uStack_48 = CONCAT26(uVar1,CONCAT24(uVar1,CONCAT22(uVar1,uVar1)));
    uStack_7f = (undefined7)uStack_48;
    uStack_78 = (undefined1)((ushort)uVar1 >> 8);
