...
/* v8::internal::WeakArrayList::WeakArrayListPrint(std::__ndk1::basic_ostream<char,
   std::__ndk1::char_traits<char> >&) */

void __thiscall
v8::internal::WeakArrayList::WeakArrayListPrint(WeakArrayList *this,basic_ostream *param_1)

{
  ...
  HeapObject::PrintHeader((HeapObject *)this,param_1,"WeakArrayList");
  ...
  uVar4 = *(ulong *)this;
  if (1 < (int)*(uint *)(uVar4 + 7)) {
    uVar6 = 0;
    uVar10 = 0;
    uVar9 = 0;
    uVar5 = *(uint *)(uVar4 + 7) >> 1;
    iVar8 = 4;
    uVar7 = uVar4 & 0xffffffff00000000 | (ulong)*(uint *)(uVar4 + 0xb);
    do {
      if ((long)(uVar6 + 1) < (long)(int)uVar5) {
        uVar9 = uVar4 & 0xffffffff00000000 | (ulong)*(uint *)(uVar4 + (long)iVar8 + 0xb);
      }
