...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitCreateRegExpLiteral(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::VisitCreateRegExpLiteral
...

{
  ...
  uVar5 = ObjectRef::IsString(aOStack_58);
  if ((uVar5 & 1) == 0) {
  ...
  JSHeapBroker::ProcessFeedbackForRegExpLiteral(*(JSHeapBroker **)this,aFStack_48);
