...
/* v8::internal::compiler::JSCallReducerAssembler::IfBuilder1<v8::internal::String>::Value() */

void __thiscall
v8::internal::compiler::JSCallReducerAssembler::IfBuilder1<v8::internal::String>::Value
          (IfBuilder1<v8::internal::String> *this)

{
  ...
  bVar2 = this[0x10] == (IfBuilder1<v8::internal::String>)0x2;
  local_88 = GraphAssembler::NewBasicBlock(*(GraphAssembler **)this,bVar2);
  local_90[0] = (GraphAssemblerLabel)0x0;
  local_8c = (uint)!bVar2;
  uStack_80 = 0;
  bVar3 = this[0x10] == (IfBuilder1<v8::internal::String>)0x1;
  uVar6 = 1;
  if (!bVar3) {
    uVar6 = 2;
  }
  ...
  if (*(long **)(this + 0x40) != (long *)0x0) {
    ...
    GraphAssembler::MergeState<v8::internal::TNode<v8::internal::String>>(pGVar5,local_108,uVar4);
