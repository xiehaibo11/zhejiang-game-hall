...
/* v8::internal::compiler::JSGenericLowering::LowerJSExponentiate(v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::JSGenericLowering::LowerJSExponentiate
...

{
  ...
  Builtins::CallableFor((Builtins *)local_58,*(undefined8 *)(*(long *)(this + 0x10) + 0x168),0x197);
