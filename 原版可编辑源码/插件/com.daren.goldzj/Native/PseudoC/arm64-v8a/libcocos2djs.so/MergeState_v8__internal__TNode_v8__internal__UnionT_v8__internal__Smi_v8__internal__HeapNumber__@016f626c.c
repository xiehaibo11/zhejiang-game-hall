...
/* void 
   v8::internal::compiler::GraphAssembler::MergeState<v8::internal::TNode<v8::internal::UnionT<v8::internal::Smi,
   v8::internal::HeapNumber> >, v8::internal::TNode<v8::internal::Object>
   >(v8::internal::compiler::GraphAssemblerLabel<2>*,
...
MergeState<v8::internal::TNode<v8::internal::UnionT<v8::internal::Smi,v8::internal::HeapNumber>>,v8::internal::TNode<v8::internal::Object>>
          (GraphAssembler *this,long param_1,Node *param_3,Node *param_4)
  ...
  if (*(int *)(param_1 + 4) == 2) {
    if (iVar11 != 0) {
      ...
      if (pNVar9 != param_4) {
        ...
        plVar10[1] = (long)param_4;
        if (param_4 != (Node *)0x0) {
          Node::AppendUse(param_4,(Use *)(lVar7 + -0x30));
        }
      }
      goto LAB_016f68e4;
    }
    ...
    *(undefined8 *)(param_1 + 0x28) = uVar6;
    ...
    if (iVar11 != 1) {
      ...
      if (pNVar9 != param_4) {
        ...
        plVar10[uVar12] = (long)param_4;
        if (param_4 != (Node *)0x0) {
          Node::AppendUse(param_4,pUVar13);
        }
      }
