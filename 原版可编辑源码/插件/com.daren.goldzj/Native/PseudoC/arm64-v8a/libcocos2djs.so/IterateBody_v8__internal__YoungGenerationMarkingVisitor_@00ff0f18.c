...
/* void 
   v8::internal::JSWeakRef::BodyDescriptor::IterateBody<v8::internal::YoungGenerationMarkingVisitor>(v8::internal::Map,
...

{
  ...
  if (puVar1 < puVar2) {
    ...
    do {
      if ((uVar4 & 1) != 0) {
        uVar14 = (ulong)puVar1 & 0xffffffff00000000 | (ulong)uVar4;
        uVar9 = (ulong)puVar1 & 0xffffffff00000000 | (ulong)uVar4 & 0xfffffffffffc0000;
        if ((*(byte *)(uVar9 + 8) & 0x18) != 0) {
          puVar3 = (uint *)(*(long *)(uVar9 + 0x108) + (uVar14 - uVar9 >> 7 & 0x1ffffff) * 4);
          while( true ) {
            uVar4 = *puVar3;
            uVar8 = (uint)(1L << (uVar14 - uVar9 >> 2 & 0x1f));
            ...
            while (*puVar3 == uVar4) {
              ...
              if (cVar5 == '\0') {
                lVar13 = param_4[1];
                puVar11 = (undefined8 *)(lVar13 + (long)(int)param_4[2] * 0x50);
                ...
                if (lVar10 == 0x40) {
                  ...
                  *(ulong *)((long)pvVar7 + 0x10) = uVar14;
                }
                else {
                  puVar12[1] = lVar10 + 1;
                  puVar12[lVar10 + 2] = uVar14;
                }
                goto LAB_00ff1008;
              }
            }
