...
/* v8::internal::compiler::SimplifiedOperatorBuilder::MaybeGrowFastElements(v8::internal::compiler::GrowFastElementsMode,
   v8::internal::compiler::FeedbackSource const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::MaybeGrowFastElements
...

{
  ...
  if ((*param_3 == 0) || ((int)param_3[1] == -1)) {
    if (param_2 == (Operator)0x1) {
      ...
      if (param_2 != (Operator)0x0) goto LAB_012ee59c;
      lVar4 = *(long *)this;
      lVar5 = 0x33e0;
    }
...
LAB_012ee59c:
    ...
    Operator::Operator(pOVar2,0x11b,0x20,"MaybeGrowFastElements",4,1,1,1,1,0);
    pOVar2[0x30] = param_2;
    *(undefined ***)pOVar2 = &PTR__Operator_01cc1fe0;
