...
{
  return &__bind<unsigned_int(dragonBones::JSONDataParser::*)(rapidjson::GenericValue<rapidjson::UTF8<char>,rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator>>const&,unsigned_int,unsigned_int),dragonBones::JSONDataParser*,std::__ndk1::placeholders::__ph<1>const&,std::__ndk1::placeholders::__ph<2>const&,std::__ndk1::placeholders::__ph<3>const&>
          ::typeinfo;
}
