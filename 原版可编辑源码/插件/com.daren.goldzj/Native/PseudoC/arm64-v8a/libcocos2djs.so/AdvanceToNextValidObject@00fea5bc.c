...
/* v8::internal::LiveObjectRange<(v8::internal::LiveObjectIterationMode)2>::iterator::AdvanceToNextValidObject()
    */

void __thiscall
v8::internal::LiveObjectRange<(v8::internal::LiveObjectIterationMode)2>::iterator::
          ...
          *(uint *)(this + 0x48) = uVar5;
          if (uVar8 < 0x1f) {
            ...
            *(uint *)(this + 0x34) = uVar5;
            if (uVar5 == *(uint *)(this + 0x30)) goto LAB_00fea7b4;
