...
void FUN_00df61a4(byte *param_1,byte *param_2,byte *param_3,byte *param_4,byte *param_5,
...

{
  ...
  uVar3 = uVar17 >> 0x12;
  uVar14 = (uVar2 + (uVar3 * 0x6625 >> 8)) - 0x379a;
  ...
  uVar14 = ((uVar2 + 0x2204) - (uVar3 * 0x3408 >> 8)) - (uVar17 * 0x1913 >> 8);
  *param_7 = cVar11;
  if (uVar14 >> 0xe == 0) {
    cVar11 = (char)(uVar14 >> 6);
  }
  ...
  uVar17 = (uVar2 + (uVar17 * 0x811a >> 8)) - 0x4515;
  param_7[1] = cVar11;
  if (uVar17 >> 0xe == 0) {
  ...
  if (0 < iVar1) {
    ...
    do {
      ...
      uVar4 = iVar1 + (uVar12 + uVar14) * 2 >> 3;
      uVar2 = uVar4 + uVar17;
      uVar5 = uVar2 >> 0x11;
      uVar6 = (uint)pbVar7[1] * 0x4a85 >> 8;
      uVar3 = (uVar6 + (uVar5 * 0x6625 >> 8)) - 0x379a;
      uVar2 = uVar2 >> 1 & 0xff;
      if (uVar3 >> 0xe == 0) {
        cVar11 = (char)(uVar3 >> 6);
      }
      else {
        cVar11 = ((byte)((int)uVar3 >> 0x1f) & 1) - 1;
      }
      uVar17 = iVar1 + (uVar13 + uVar17) * 2 >> 3;
      uVar3 = ((uVar6 + 0x2204) - (uVar5 * 0x3408 >> 8)) - (uVar2 * 0x1913 >> 8);
      pcVar9[-1] = cVar11;
      if (uVar3 >> 0xe == 0) {
        cVar11 = (char)(uVar3 >> 6);
      }
      ...
      uVar2 = (uVar6 + (uVar2 * 0x811a >> 8)) - 0x4515;
      uVar3 = uVar17 + uVar12;
      *pcVar9 = cVar11;
      if (uVar2 >> 0xe == 0) {
        cVar11 = (char)(uVar2 >> 6);
      ...
      pcVar9[1] = cVar11;
      uVar5 = uVar3 >> 0x11;
      uVar6 = (uint)pbVar7[2] * 0x4a85 >> 8;
      uVar2 = (uVar6 + (uVar5 * 0x6625 >> 8)) - 0x379a;
      uVar3 = uVar3 >> 1 & 0xff;
      if (uVar2 >> 0xe == 0) {
        cVar11 = (char)(uVar2 >> 6);
      }
      ...
      uVar2 = ((0x2204 - (uVar5 * 0x3408 >> 8)) - (uVar3 * 0x1913 >> 8)) + uVar6;
      pcVar9[2] = cVar11;
      if (uVar2 >> 0xe == 0) {
        cVar11 = (char)(uVar2 >> 6);
      }
      ...
      uVar2 = (uVar6 + (uVar3 * 0x811a >> 8)) - 0x4515;
      pcVar9[3] = cVar11;
      if (uVar2 >> 0xe == 0) {
      ...
      if (param_2 != (byte *)0x0) {
        ...
        uVar17 = (uVar2 + (uVar3 * 0x811a >> 8)) - 0x4515;
        uVar4 = uVar4 + uVar13;
        *pcVar10 = cVar11;
        if (uVar17 >> 0xe == 0) {
          cVar11 = (char)(uVar17 >> 6);
  ...
  if (((long)param_9 & 1U) == 0) {
    ...
    *param_7 = cVar11;
    ...
    if (param_2 != (byte *)0x0) {
      ...
      uVar17 = (uVar12 + (uVar14 * 0x6625 >> 8)) - 0x379a;
      ...
      uVar17 = ((0x2204 - (uVar14 * 0x3408 >> 8)) - (uVar13 * 0x1913 >> 8)) + uVar12;
      *param_8 = cVar11;
      if (uVar17 >> 0xe == 0) {
        cVar11 = (char)(uVar17 >> 6);
      }
      ...
      uVar17 = (uVar12 + (uVar13 * 0x811a >> 8)) - 0x4515;
      param_8[1] = cVar11;
      if (uVar17 >> 0xe == 0) {
        cVar11 = (char)(uVar17 >> 6);
      }
