...
/* js_extension_AssetsManagerEx_downloadFailedAssetsRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_extension_AssetsManagerEx_downloadFailedAssetsRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (AssetsManagerEx *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x41d,"js_extension_AssetsManagerEx_downloadFailedAssets");
    __android_log_print(6,"jswrapper",
                        "js_extension_AssetsManagerEx_downloadFailedAssets : Invalid Native Object")
    ;
  }
  else {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_extension_auto.cpp, 1060): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_extension_AssetsManagerEx_downloadFailedAssets",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_extension_auto.cpp"
                      ,0x427);
LAB_008ad8dc:
