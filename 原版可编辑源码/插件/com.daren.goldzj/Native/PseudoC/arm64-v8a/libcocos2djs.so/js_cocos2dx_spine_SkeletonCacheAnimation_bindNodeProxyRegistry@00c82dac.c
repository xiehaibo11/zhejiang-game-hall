...
/* js_cocos2dx_spine_SkeletonCacheAnimation_bindNodeProxyRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonCacheAnimation_bindNodeProxyRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonCacheAnimation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3e77,&DAT_018effc9);
    pcVar7 = "js_cocos2dx_spine_SkeletonCacheAnimation_bindNodeProxy : Invalid Native Object";
LAB_00c82f38:
...
LAB_00c82f00:
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              ...
                              ,0x3e7e,&DAT_018effc9);
          pcVar7 = 
          "js_cocos2dx_spine_SkeletonCacheAnimation_bindNodeProxy : Error processing arguments";
          goto LAB_00c82f38;
        }
      }
      else {
        if (1 < (byte)pVVar5[8]) goto LAB_00c82f00;
        pNVar6 = (NodeProxy *)0x0;
      }
      spine::SkeletonCacheAnimation::bindNodeProxy(this,pNVar6);
      goto LAB_00c82f70;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 16002): wrong number of arguments: %d, was expecting %d\n"
