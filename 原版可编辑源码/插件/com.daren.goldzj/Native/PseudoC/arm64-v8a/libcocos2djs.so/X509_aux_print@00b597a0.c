...

{
  ...
  if (iVar2 != 0) {
    ...
    if (lVar4 == 0) {
      ...
      BIO_printf(param_1,"%*sTrusted Uses:\n%*s",uVar8,&DAT_0189703a,(ulong)(param_3 + 2),
                 &DAT_0189703a);
    ...
    if (puVar7 != (uchar *)0x0) {
      BIO_printf(param_1,"%*sAlias: %s\n",uVar8,&DAT_0189703a,puVar7);
    }
    puVar7 = X509_keyid_get0(param_2,&local_44);
    if (puVar7 != (uchar *)0x0) {
      BIO_printf(param_1,"%*sKey Id: ",uVar8,&DAT_0189703a);
      if (0 < local_44) {
        lVar4 = 0;
        do {
          pcVar1 = ":";
          ...
          BIO_printf(param_1,"%s%02X",pcVar1,(ulong)puVar7[lVar4]);
          lVar4 = lVar4 + 1;
        } while (lVar4 < local_44);
      }
      BIO_write(param_1,&DAT_018938a8,1);
    }
    return 1;
  }
  return 1;
