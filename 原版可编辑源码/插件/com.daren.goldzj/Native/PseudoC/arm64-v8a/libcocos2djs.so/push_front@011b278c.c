...
/* std::__ndk1::__split_buffer<v8::internal::CodeMap::CodeEntrySlotInfo*,
   ...
   >::push_front(v8::internal::CodeMap::CodeEntrySlotInfo*&&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_011b2918;
...
LAB_011b28ec:
      ...
      if (((void *)((long)pvVar4 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar4 + uVar9 + uVar13 * 8 + 8))) goto LAB_011b28ec;
      ...
      puVar7 = puVar8;
      if (uVar2 != uVar9) goto LAB_011b28ec;
    }
