...
/* cocos2d::CanvasRenderingContext2D::strokeText(std::__ndk1::basic_string<char,
...

{
  ...
  if (uVar1 != 0) {
    ...
    CanvasRenderingContext2DImpl::strokeText
              (*(CanvasRenderingContext2DImpl **)(this + 0x100),param_1,param_2,param_3,param_4);
    plVar2 = *(long **)(this + 0xf0);
    if (plVar2 != (long *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x0085d960. Too many branches */
