...
/* v8::internal::HashTable<v8::internal::NameDictionary,
   v8::internal::NameDictionaryShape>::Swap(v8::internal::InternalIndex,
   v8::internal::InternalIndex, v8::internal::WriteBarrierMode) */

void __thiscall
v8::internal::HashTable<v8::internal::NameDictionary,v8::internal::NameDictionaryShape>::Swap
...

{
  ...
  lVar1 = (lVar13 + 0x1400000000 >> 0x20) + 7;
  uVar4 = *(uint *)(lVar1 + uVar12);
  uVar15 = (ulong)uVar4;
  lVar2 = (lVar13 + 0x1800000000 >> 0x20) + 7;
  uVar8 = uVar12 & 0xffffffff00000000;
  uVar5 = *(uint *)(lVar2 + uVar12);
  uVar14 = (ulong)uVar5;
  lVar13 = (lVar13 + 0x1c00000000 >> 0x20) + 7;
  uVar6 = *(uint *)(lVar13 + uVar12);
  uVar11 = (ulong)uVar6;
  lVar3 = (param_3 * 0xc00000000 + 0x1400000000 >> 0x20) + 7;
...
LAB_0111dcc8:
  ...
  uVar12 = *(ulong *)this;
  lVar1 = (param_3 * 0xc00000000 + 0x1800000000 >> 0x20) + 7;
...
LAB_0111dd68:
  ...
  uVar12 = *(ulong *)this;
  lVar2 = (param_3 * 0xc00000000 + 0x1c00000000 >> 0x20) + 7;
...
LAB_0111deb0:
    if ((uVar4 & 1) == 0) {
      *(uint *)(*(long *)this + lVar1) = uVar5;
      if ((uVar5 & 1) == 0) goto LAB_0111df50;
LAB_0111df64:
...
LAB_0111dfc0:
      *(uint *)(*(long *)this + lVar2) = uVar6;
      ...
      if (param_4 == 4) goto joined_r0x0111dfd8;
      if ((uVar6 & 1) == 0) {
        return;
      }
...
LAB_0111df34:
      *(uint *)(*(long *)this + lVar1) = uVar5;
      if (param_4 == 0) goto LAB_0111de84;
      if (param_4 != 4) {
        if ((uVar5 & 1) != 0) {
      ...
      if ((uVar5 & 1) != 0) goto LAB_0111df64;
LAB_0111df50:
      *(uint *)(*(long *)this + lVar2) = uVar6;
joined_r0x0111dfd8:
      if ((uVar6 & 1) == 0) {
...
LAB_0111de60:
      *(uint *)(*(long *)this + lVar3) = uVar4;
      if (param_4 == 4) goto LAB_0111deb0;
      if (param_4 == 0) goto LAB_0111de78;
      if ((uVar4 & 1) != 0) {
