...
/* v8::internal::Runtime_ToNumber(int, unsigned long*, v8::internal::Isolate*) */

ulong v8::internal::Runtime_ToNumber(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar5 = FUN_011d30b4(param_1,param_2,param_3);
    return uVar5;
  }
  ...
  *(int *)(param_3 + 0x95b0) = iVar4;
  ...
  if (((uVar5 & 1) != 0) &&
    ...
    param_2 = (ulong *)Object::ConvertToNumberOrNumeric(param_3,param_2,0);
