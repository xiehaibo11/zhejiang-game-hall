...
/* std::__ndk1::__split_buffer<int*, v8::internal::RecyclingZoneAllocator<int*> >::push_back(int*&&)
    */

void __thiscall
std::__ndk1::__split_buffer<int*,v8::internal::RecyclingZoneAllocator<int*>>::push_back
          (__split_buffer<int*,v8::internal::RecyclingZoneAllocator<int*>> *this,int **param_1)

{
  ...
  if (puVar8 != *(undefined8 **)(this + 0x18)) goto LAB_01668ed8;
  ...
  if (puVar3 != puVar11) {
    ...
    if ((3 < uVar4) && ((puVar3 + uVar6 + 1 <= puVar1 || (puVar2 + uVar13 + uVar6 + 1 <= puVar3))))
    {
      ...
      puVar7 = puVar1 + uVar6;
      puVar8 = puVar1 + uVar6;
      if (uVar4 == uVar6) goto LAB_01668e8c;
    }
    do {
      puVar5 = puVar3 + 1;
      puVar8 = puVar7 + 1;
