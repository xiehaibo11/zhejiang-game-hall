...
/* std::__ndk1::__split_buffer<cocos2d::ThreadPool::Task*,
   std::__ndk1::allocator<cocos2d::ThreadPool::Task*> >::push_back(cocos2d::ThreadPool::Task*&&) */
...

{
  ...
  undefined8 uVar17;
                    ...
                    /* try { // try from 0099f84c to 00a9f863 has its CatchHandler @ 0099fae0 */
  puVar14 = *(undefined8 **)(this + 0x10);
  if (puVar14 != *(undefined8 **)(this + 0x18)) goto LAB_0099f9c4;
  puVar13 = *(undefined8 **)this;
  __src = *(undefined8 **)(this + 8);
                    /* try { // try from 0099f86c to 00a9f877 has its CatchHandler @ 0099fadc */
  if (puVar13 <= __src && (long)__src - (long)puVar13 != 0) {
    lVar6 = (long)__src - (long)puVar13 >> 3;
                    /* try { // try from 0099f878 to 00a9f883 has its CatchHandler @ 0099fad8 */
    lVar1 = lVar6 + 2;
    if (-1 < lVar6 + 1) {
      lVar1 = lVar6 + 1;
    }
                    /* try { // try from 0099f884 to 00a9f89b has its CatchHandler @ 0099faf0 */
  ...
  lVar1 = (long)*(undefined8 **)(this + 0x18) - (long)puVar13;
                    /* try { // try from 0099f8b8 to 00a9f8bf has its CatchHandler @ 0099fac0 */
  uVar7 = lVar1 >> 2;
  if (lVar1 == 0) {
    uVar7 = 1;
  }
  if (uVar7 == 0) {
    pvVar5 = (void *)0x0;
                    ...
                    /* try { // try from 0099f8c4 to 00a9f8e7 has its CatchHandler @ 0099fabc */
    if (uVar7 >> 0x3d != 0) {
  ...
  puVar9 = puVar3;
                    /* try { // try from 0099f8fc to 00a9f963 has its CatchHandler @ 0099faf0 */
  if (__src != puVar14) {
...
LAB_0099f994:
      ...
      puVar13 = __src + 2;
                    /* try { // try from 0099f968 to 00a9f9ab has its CatchHandler @ 0099fac0 */
      __src = __src + uVar11;
      ...
      if (uVar2 != uVar11) goto LAB_0099f994;
    }
    puVar13 = *(undefined8 **)this;
  ...
  *(undefined8 **)(this + 8) = puVar3;
                    /* try { // try from 0099f9b0 to 00a9f9f3 has its CatchHandler @ 0099fabc */
  *(undefined8 **)(this + 0x10) = puVar14;
