...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<v8::internal::SamplingHeapProfiler::Sample*,
   ...
   std::__ndk1::unique_ptr<v8::internal::SamplingHeapProfiler::Sample,
   std::__ndk1::default_delete<v8::internal::SamplingHeapProfiler::Sample> > > >
   >::remove(std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<v8::internal::SamplingHeapProfiler::Sample*,
   std::__ndk1::unique_ptr<v8::internal::SamplingHeapProfiler::Sample,
   std::__ndk1::default_delete<v8::internal::SamplingHeapProfiler::Sample> > >, void*>*>) */
...

{
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar7 == uVar4) goto LAB_011b7850;
  }
  if (*param_3 != 0) {
