...
/* spine::Vector<spine::Vector<float> >::~Vector() */

void __thiscall spine::Vector<spine::Vector<float>>::~Vector(Vector<spine::Vector<float>> *this)

{
  ...
  uVar2 = *(ulong *)(this + 8);
  *(undefined ***)this = &PTR__Vector_01c8ec78;
  if (uVar2 != 0) {
    uVar3 = 0;
    lVar4 = -1;
    do {
