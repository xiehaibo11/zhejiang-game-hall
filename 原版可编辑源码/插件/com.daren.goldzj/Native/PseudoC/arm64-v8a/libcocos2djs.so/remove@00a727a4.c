...

{
  ...
  do {
                    /* try { // try from 00a727d0 to 00b72823 has its CatchHandler @ 00a727d0
                       catch() { ... } // from try @ 00a727d0 with catch @ 00a727d0
                       catch() { ... } // from try @ 00a7299c with catch @ 00a727d0 */
    plVar7 = plVar5;
    plVar5 = (long *)*plVar7;
  ...
  if (plVar7 != param_2 + 2) {
    ...
    if (uVar6 == uVar1) goto LAB_00a72858;
  }
  if (*param_3 != 0) {
    ...
    if (uVar3 == 0) {
      uVar6 = uVar6 & uVar8;
                    ...
                    /* try { // try from 00a72824 to 00b7283b has its CatchHandler @ 00a72a08 */
      uVar4 = 0;
      if (uVar2 != 0) {
        uVar4 = uVar6 / uVar2;
      }
      uVar6 = uVar6 - uVar4 * uVar2;
                    ...
                    /* try { // try from 00a72850 to 00b7285b has its CatchHandler @ 00a729e8 */
    if (uVar6 == uVar1) goto LAB_00a72858;
  }
  *(undefined8 *)(*param_2 + uVar1 * 8) = 0;
LAB_00a72858:
                    /* try { // try from 00a7285c to 00b72863 has its CatchHandler @ 00a72a18 */
  if (*param_3 != 0) {
    uVar6 = *(ulong *)(*param_3 + 8);
    if (uVar3 == 0) {
      uVar6 = uVar6 & uVar8;
    ...
    if (uVar6 != uVar1) {
                    /* try { // try from 00a72880 to 00b728a7 has its CatchHandler @ 00a729f0 */
