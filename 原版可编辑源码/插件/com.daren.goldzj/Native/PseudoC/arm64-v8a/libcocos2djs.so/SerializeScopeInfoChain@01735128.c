...
/* v8::internal::compiler::SharedFunctionInfoRef::SerializeScopeInfoChain() */

void __thiscall
v8::internal::compiler::SharedFunctionInfoRef::SerializeScopeInfoChain(SharedFunctionInfoRef *this)

{
  ...
  if (*(int *)(this_00 + 8) == 1) {
    if (*(short *)(*(long *)(this_00 + 0x10) + 0x18) == 0xa6) {
      SharedFunctionInfoData::SerializeScopeInfoChain(this_00,*(JSHeapBroker **)(this + 8));
      return;
    }
                    /* WARNING: Subroutine does not return */
