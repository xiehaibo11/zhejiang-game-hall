...
/* v8::internal::compiler::InstructionSelector::VisitUint32MulHigh(v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::InstructionSelector::VisitUint32MulHigh
...

{
  ...
  Emit(this,0x7b,uVar1,(uVar2 & 0xffffffff) << 3 | 0x5800000001,
  ...
  Emit(this,0x8e,(uVar2 & 0xffffffff) << 3 | 0xd800000001,uVar1,uVar4,0,0);
  return;
}
