...
/* js_cocos2dx_spine_PathConstraint_setSpacingRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_PathConstraint_setSpacingRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (PathConstraint *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1ac9,"js_cocos2dx_spine_PathConstraint_setSpacing");
    pcVar6 = "js_cocos2dx_spine_PathConstraint_setSpacing : Invalid Native Object";
LAB_00c41ed0:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::PathConstraint::setSpacing(this,local_64);
        goto LAB_00c41f08;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1ad0,"js_cocos2dx_spine_PathConstraint_setSpacing");
      pcVar6 = "js_cocos2dx_spine_PathConstraint_setSpacing : Error processing arguments";
      goto LAB_00c41ed0;
    }
    __android_log_print(6,"jswrapper",&DAT_0190811c,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_PathConstraint_setSpacing",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1ad7);
LAB_00c41f08:
