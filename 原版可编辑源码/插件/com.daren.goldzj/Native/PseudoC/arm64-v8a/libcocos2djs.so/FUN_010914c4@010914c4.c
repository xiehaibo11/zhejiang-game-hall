...
void FUN_010914c4(undefined8 param_1,ulong *param_2,ulong *param_3,ulong param_4,ulong param_5)

{
  ...
  if ((uint)(*(int *)((uVar1 & 0xffffffff00000000 | (ulong)*(uint *)(uVar1 + 7)) + 3) >> 1) <
      param_5) {
    FUN_01092140(param_2,param_5 & 0xffffffff);
    uVar1 = *param_2;
    if ((*(byte *)((uVar1 & 0xffffffff00000000 | 10) + (ulong)*(uint *)(uVar1 - 1)) & 0xf8) != 0x28)
    {
...
LAB_01091580:
        *pdVar5 = dVar6;
        ...
        pdVar5 = (double *)(uVar1 + (long)(int)uVar3);
        if (!NAN(dVar6)) goto LAB_01091580;
        *pdVar5 = NAN;
      }
      uVar1 = *param_2;
      lVar2 = lVar2 + -1;
