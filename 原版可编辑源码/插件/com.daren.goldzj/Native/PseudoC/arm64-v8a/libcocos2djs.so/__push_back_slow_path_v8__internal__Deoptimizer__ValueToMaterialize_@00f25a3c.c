...
/* void std::__ndk1::vector<v8::internal::Deoptimizer::ValueToMaterialize,
   std::__ndk1::allocator<v8::internal::Deoptimizer::ValueToMaterialize>
   >::__push_back_slow_path<v8::internal::Deoptimizer::ValueToMaterialize>(v8::internal::Deoptimizer::ValueToMaterialize&&)
    */
...
::__push_back_slow_path<v8::internal::Deoptimizer::ValueToMaterialize>
          (vector<v8::internal::Deoptimizer::ValueToMaterialize,std::__ndk1::allocator<v8::internal::Deoptimizer::ValueToMaterialize>>
           *this,ValueToMaterialize *param_1)

{
  ...
  if (uVar1 >> 0x3b == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3b != 0) goto LAB_00f25b28;
