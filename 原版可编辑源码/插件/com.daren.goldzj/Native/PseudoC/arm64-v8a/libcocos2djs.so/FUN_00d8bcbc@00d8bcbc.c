      ...
      if (0x77 < iVar2) {
        if (iVar2 < 0xc3) {
          if (iVar2 == 0x78) {
            ...
            if (iVar2 != 0xa8) goto switchD_00d8be8c_caseD_1;
            iVar2 = 0xd;
          }
        }
        else if (iVar2 == 0xc3) {
          ...
          if (iVar2 != 0xff) goto switchD_00d8be8c_caseD_1;
          iVar2 = 0x10;
        }
        goto LAB_00d8bd40;
      }
...
switchD_00d8be8c_caseD_1:
      ...
      case 0x30:
        ...
        *(undefined4 *)(param_1 + 0x47) = 0x30;
        break;
      case 0x3f:
        goto switchD_00d8be8c_caseD_3f;
      case 0x50:
        iVar2 = 9;
        goto LAB_00d8bd40;
      case 99:
...
joined_r0x00d8bd28:
    ...
    if (*(int *)(lVar10 + 0x20) == 0) goto LAB_00d8c038;
