...
/* v8::internal::wasm::ZoneBuffer::write_u32v(unsigned int) */

void __thiscall v8::internal::wasm::ZoneBuffer::write_u32v(ZoneBuffer *this,uint param_1)
