...
/* std::__ndk1::__split_buffer<v8::internal::TranslatedValue*,
   std::__ndk1::allocator<v8::internal::TranslatedValue*>
   >::push_back(v8::internal::TranslatedValue*&&) */
...

{
  ...
  puVar12 = puVar4;
  if (puVar4 != *(undefined8 **)(this + 0x18)) goto LAB_00f25348;
...
LAB_00f25314:
      ...
      if (((void *)((long)pvVar6 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar6 + uVar13 * 8 + uVar9 + 8))) goto LAB_00f25314;
      ...
      puVar11 = puVar12;
      if (uVar2 != uVar9) goto LAB_00f25314;
    }
    puVar11 = *(undefined8 **)this;
  }
  *(void **)this = pvVar6;
