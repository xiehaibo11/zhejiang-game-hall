...
/* v8::internal::OrderedHashTable<v8::internal::OrderedHashSet,
   1>::FindEntry(v8::internal::Isolate*, v8::internal::Object) */

int __thiscall
v8::internal::OrderedHashTable<v8::internal::OrderedHashSet,1>::FindEntry
          (OrderedHashTable<v8::internal::OrderedHashSet,1> *this,Isolate *param_1,ulong param_3)

{
  ...
  if (unaff_w22 != -1) {
    ...
    do {
      ...
      uVar6 = *(ulong *)this;
      unaff_w22 = *(int *)(uVar6 + (long)(int)((iVar1 + (*(uint *)(uVar6 + 0xf) >> 1)) * 4 + 4) + 7)
                  >> 1;
    } while (unaff_w22 != -1);
  }
  return unaff_w22;
