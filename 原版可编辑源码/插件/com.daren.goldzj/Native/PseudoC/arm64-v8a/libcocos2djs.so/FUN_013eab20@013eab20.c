...
ulong FUN_013eab20(ulong param_1,ulong param_2)

{
  ...
  if (((((param_1 & 1) != 0) && (*(short *)(unaff_x26 + (ulong)*(uint *)(param_1 - 1) + 7) == 0x41))
    ...
    if (uVar1 == (*(uint *)(param_2 + 3) & 1)) {
      *(undefined8 *)(unaff_x26 + 0x40) = 0x13eaba0;
      ...
      if (iVar5 < 0) {
        ...
        if (uVar9 != 0) {
          if ((*(uint *)(param_1 + 3) >> 1 & 0x3fffffff) == 0) {
            ...
            *(uint *)(uVar6 + 3) = uVar1;
            uVar3 = uVar1 | bVar2;
            *(uint *)(uVar6 + 3) = uVar3;
            *(undefined8 *)(unaff_x26 + 0x40) = 0x13eac80;
            *(undefined1 **)(unaff_x26 + 0x38) = &stack0xfffffffffffffff0;
        ...
        if (uVar9 != 0) {
          if ((*(uint *)(param_2 + 3) >> 1 & 0x3fffffff) == 0) {
            ...
            *(uint *)(uVar6 + 3) = uVar1;
            *(undefined8 *)(unaff_x26 + 0x40) = 0x13eadb0;
            *(undefined1 **)(unaff_x26 + 0x38) = &stack0xfffffffffffffff0;
      ...
      if (uVar9 != 0) {
        if (uVar7 == 0) {
          ...
          *(uint *)(uVar7 + 3) = uVar1;
          uVar3 = uVar1 | uVar3 & 1;
          *(uint *)(uVar7 + 3) = uVar3;
          *(undefined8 *)(unaff_x26 + 0x40) = 0x13eaeec;
          *(undefined1 **)(unaff_x26 + 0x38) = &stack0xfffffffffffffff0;
