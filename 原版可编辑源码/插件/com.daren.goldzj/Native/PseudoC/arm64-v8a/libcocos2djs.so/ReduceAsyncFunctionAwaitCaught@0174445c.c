...
/* v8::internal::compiler::JSIntrinsicLowering::ReduceAsyncFunctionAwaitCaught(v8::internal::compiler::Node*)
    */
...

{
  ...
  Builtins::CallableFor((Builtins *)local_58,*(undefined8 *)(*(long *)(this + 0x10) + 0x168),0xd3);
