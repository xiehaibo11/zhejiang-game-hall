...
Value * __thiscall v8::Value::ToInteger(Value *this,long param_2)
    ...
    if ((*(int *)(pIVar6 + 0x2c20) == (int)uVar8) ||
      ...
      *(undefined8 *)local_48 = uVar8;
      ...
      if (internal::TracingFlags::runtime_stats != 0) {
        ...
        internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x3b2);
      }
      this_00 = *(Logger **)(pIVar6 + 0x9558);
      uVar3 = internal::Logger::is_logging(this_00);
      if ((uVar3 & 1) != 0) {
        internal::Logger::ApiEntryCall(this_00,"v8::Object::ToInteger");
      }
      uVar1 = *(undefined4 *)(pIVar6 + 0x2c60);
      *(undefined4 *)(pIVar6 + 0x2c60) = 5;
      if (((byte)*this & 1) != 0) {
        this = (Value *)internal::Object::ConvertToInteger(pIVar6,this);
      }
      pVVar7 = local_48;
      if (this == (Value *)0x0) {
        local_a0 = '\x01';
...
LAB_00eb20d4:
          ...
          if (*(code **)(lVar4 + 0xb738) == (code *)0x0) goto LAB_00eb20d4;
