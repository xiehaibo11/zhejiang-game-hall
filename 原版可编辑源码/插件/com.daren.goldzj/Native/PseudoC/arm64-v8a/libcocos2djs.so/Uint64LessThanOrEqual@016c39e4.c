...
/* v8::internal::compiler::GraphAssembler::Uint64LessThanOrEqual(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Uint64LessThanOrEqual
...

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::Uint64LessThanOrEqual
