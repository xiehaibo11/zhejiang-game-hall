...
/* v8::internal::compiler::SimplifiedOperatorReducer::Change(v8::internal::compiler::Node*,
   v8::internal::compiler::Operator const*, v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::SimplifiedOperatorReducer::Change
          (SimplifiedOperatorReducer *this,Node *param_1,Operator *param_2,Node *param_3)
