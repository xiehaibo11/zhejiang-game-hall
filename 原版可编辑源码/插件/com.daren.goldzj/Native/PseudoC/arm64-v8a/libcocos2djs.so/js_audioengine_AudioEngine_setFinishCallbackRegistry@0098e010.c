...
/* js_audioengine_AudioEngine_setFinishCallbackRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_audioengine_AudioEngine_setFinishCallbackRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (uVar10 == 0x20) {
    ...
    if (*(char *)(*plVar6 + 0x18) == '\x05') {
      ...
      if ((uVar8 & 1) == 0) goto LAB_0098e200;
...
LAB_0098e250:
      ...
      if ((uVar10 & 1) != 0) goto LAB_0098e234;
LAB_0098e288:
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_audioengine_auto.cpp"
                          ,0x2c3,"js_audioengine_AudioEngine_setFinishCallback");
      __android_log_print(6,"jswrapper",
                          "js_audioengine_AudioEngine_setFinishCallback : Error processing arguments"
                         );
      bVar2 = false;
    }
    else {
...
LAB_0098e22c:
      ...
      if ((uVar10 & 1) == 0) goto LAB_0098e288;
LAB_0098e234:
      cocos2d::AudioEngine::setFinishCallback(iVar4,(function *)alStack_d0);
      bVar2 = true;
    }
...
LAB_0098e2f8:
    ...
    if (bVar2) goto LAB_0098e32c;
  }
  else {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_audioengine_auto.cpp, 711): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar10 >> 4,2);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_audioengine_AudioEngine_setFinishCallback",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_audioengine_auto.cpp"
                      ,0x2ca);
LAB_0098e32c:
