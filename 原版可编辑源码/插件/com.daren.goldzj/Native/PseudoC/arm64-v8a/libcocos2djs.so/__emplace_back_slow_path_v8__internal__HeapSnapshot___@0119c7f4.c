...
/* void std::__ndk1::vector<std::__ndk1::unique_ptr<v8::internal::HeapSnapshot,
   std::__ndk1::default_delete<v8::internal::HeapSnapshot> >,
   std::__ndk1::allocator<std::__ndk1::unique_ptr<v8::internal::HeapSnapshot,
   std::__ndk1::default_delete<v8::internal::HeapSnapshot> > >
   >::__emplace_back_slow_path<v8::internal::HeapSnapshot*&>(v8::internal::HeapSnapshot*&) */
...
LAB_0119c910:
  ...
  if (uVar1 == 0) {
    ...
    if (uVar1 >> 0x3d != 0) goto LAB_0119c910;
  ...
  *puVar5 = *param_1;
  if (puVar8 == puVar2) {
    ...
    *(void **)(this + 0x10) = pvVar3;
    while (puVar8 != puVar2) {
      puVar8 = puVar8 + -1;
      this_00 = (HeapSnapshot *)*puVar8;
      *puVar8 = 0;
      if (this_00 != (HeapSnapshot *)0x0) {
        v8::internal::HeapSnapshot::~HeapSnapshot(this_00);
