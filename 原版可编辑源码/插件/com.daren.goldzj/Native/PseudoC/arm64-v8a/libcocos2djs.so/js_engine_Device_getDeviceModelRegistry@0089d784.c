...
/* js_engine_Device_getDeviceModelRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_engine_Device_getDeviceModelRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar5[1] - *plVar5 == 0) {
    ...
    uVar6 = std_string_to_seval(local_78,pVVar7);
    bVar1 = (uVar6 & 1) == 0;
    if (bVar1) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                          ,0x47b,"js_engine_Device_getDeviceModel");
      __android_log_print(6,"jswrapper",
                          "js_engine_Device_getDeviceModel : Error processing arguments");
    }
    if (((byte)local_78[0] & 1) != 0) {
      operator_delete(local_68);
    }
    if (!bVar1) goto LAB_0089d8ac;
  }
  else {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 1150): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar5[1] - *plVar5) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_Device_getDeviceModel",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x481);
LAB_0089d8ac:
  pVVar7 = (Value *)se::State::rval(aSStack_60);
