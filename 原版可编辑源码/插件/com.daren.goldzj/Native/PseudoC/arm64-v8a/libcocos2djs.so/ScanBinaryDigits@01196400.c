...
/* v8::internal::Scanner::ScanBinaryDigits() */

undefined8 __thiscall v8::internal::Scanner::ScanBinaryDigits(Scanner *this)

{
  ...
  if ((uVar6 | 1) == 0x31) {
    ...
    do {
      while ((uVar6 | 1) == 0x31) {
        if (uVar6 == 0x5f) goto LAB_01196490;
        lVar9 = *(long *)(this + 8);
...
LAB_011964f0:
          ...
          if ((char)plVar7[6] == '\0') {
            ...
            if ((uVar2 & 1) != 0) goto LAB_011964f0;
          }
          bVar1 = false;
          uVar6 = 0xffffffff;
        }
...
LAB_01196490:
      ...
      if ((ushort *)plVar7[3] <= puVar4) {
        if ((char)plVar7[6] == '\0') {
          uVar2 = (**(code **)(*plVar7 + 0x28))(plVar7);
          puVar4 = (ushort *)plVar7[2];
          if ((uVar2 & 1) != 0) goto LAB_011964a8;
        }
        bVar1 = true;
        uVar6 = 0xffffffff;
        goto LAB_011964f8;
