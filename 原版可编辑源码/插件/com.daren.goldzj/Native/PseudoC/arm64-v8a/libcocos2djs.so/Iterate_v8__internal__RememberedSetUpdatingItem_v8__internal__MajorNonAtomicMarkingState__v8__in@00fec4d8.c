...
/* unsigned long
   ...
   (v8::internal::GarbageCollector)1>::UpdateUntypedPointers()::{lambda(v8::internal::CompressedMaybeObjectSlot)#3},
   v8::internal::SlotSet::Iterate<v8::internal::RememberedSetUpdatingItem<v8::internal::MajorNonAtomicMarkingState,
   (v8::internal::GarbageCollector)1>::UpdateUntypedPointers()::{lambda(v8::internal::CompressedMaybeObjectSlot)#3}>(unsigned
   long, unsigned long,
