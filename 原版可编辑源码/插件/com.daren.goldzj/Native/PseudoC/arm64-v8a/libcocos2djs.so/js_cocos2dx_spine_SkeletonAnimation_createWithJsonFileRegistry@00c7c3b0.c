...
/* js_cocos2dx_spine_SkeletonAnimation_createWithJsonFileRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonAnimation_createWithJsonFileRegistry(FunctionCallbackInfo *param_1)
...
LAB_00c7c5c4:
        ...
        if ((uVar11 & 1) == 0) goto LAB_00c7c5c4;
        ptVar12 = (type *)spine::SkeletonAnimation::createWithJsonFile
        ...
        if (bVar7) {
          ...
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              ...
                              ,15000,"js_cocos2dx_spine_SkeletonAnimation_createWithJsonFile");
          __android_log_print(6,"jswrapper",
                              "js_cocos2dx_spine_SkeletonAnimation_createWithJsonFile : Error processing arguments"
                             );
          uVar5 = false;
          unaff_x24 = 0;
          iVar20 = 1;
...
LAB_00c7c780:
            ...
            if ((uVar11 & 1) != 0) {
              ...
              if (bVar7) {
                ...
                __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                                    "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                                    ,0x3ab7,"js_cocos2dx_spine_SkeletonAnimation_createWithJsonFile"
                                   );
                __android_log_print(6,"jswrapper",
                                    "js_cocos2dx_spine_SkeletonAnimation_createWithJsonFile : Error processing arguments"
                                   );
...
joined_r0x00c7c8ec:
      ...
      if (iVar20 == 0xe) goto LAB_00c7c900;
    }
LAB_00c7c76c:
    if ((unaff_x24 & 1) != 0) goto LAB_00c7c948;
  }
  else {
    if (lVar16 == 2) {
      local_98 = 0;
...
joined_r0x00c7c644:
          ...
          if (bVar7) {
            iVar20 = 1;
            unaff_x24 = 1;
            goto joined_r0x00c7c644;
          }
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                              ,0x3a87,"js_cocos2dx_spine_SkeletonAnimation_createWithJsonFile");
          __android_log_print(6,"jswrapper",
                              "js_cocos2dx_spine_SkeletonAnimation_createWithJsonFile : Error processing arguments"
                             );
          uVar19 = 0;
      ...
      if (iVar20 == 2) {
        ...
        if ((uVar19 & uVar8) == 1) {
          ...
          if (bVar3 == 5) {
            ...
            pAVar15 = (Atlas *)se::Object::getPrivateData(pOVar14);
            if (pAVar15 == (Atlas *)0x0) goto LAB_00c7c750;
          }
          else {
            if (1 < bVar3) goto LAB_00c7c750;
            pAVar15 = (Atlas *)0x0;
          }
          ptVar12 = (type *)spine::SkeletonAnimation::createWithJsonFile
          ...
          if (bVar7) {
            ...
            __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                                "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                                ,0x3aa6,"js_cocos2dx_spine_SkeletonAnimation_createWithJsonFile");
            __android_log_print(6,"jswrapper",
                                "js_cocos2dx_spine_SkeletonAnimation_createWithJsonFile : Error processing arguments"
                               );
            unaff_x24 = 0;
...
LAB_00c7c750:
        ...
        if (iVar20 == 10) goto LAB_00c7c900;
      }
      goto LAB_00c7c76c;
    }
LAB_00c7c900:
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 15035): wrong number of arguments: %d\n"
                        ,(ulong)(lVar2 - lVar1) >> 4);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonAnimation_createWithJsonFile",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x3abe);
LAB_00c7c948:
  pVVar13 = (Value *)se::State::rval(aSStack_80);
