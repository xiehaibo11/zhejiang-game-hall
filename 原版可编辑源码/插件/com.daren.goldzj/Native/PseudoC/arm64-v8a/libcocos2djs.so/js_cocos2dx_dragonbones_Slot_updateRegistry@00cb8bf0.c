...
/* js_cocos2dx_dragonbones_Slot_updateRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_Slot_updateRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Slot *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x147c,"js_cocos2dx_dragonbones_Slot_update");
    pcVar6 = "js_cocos2dx_dragonbones_Slot_update : Invalid Native Object";
LAB_00cb8d64:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        dragonBones::Slot::update(this,local_64);
        goto LAB_00cb8d9c;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                          ,0x1483,"js_cocos2dx_dragonbones_Slot_update");
      pcVar6 = "js_cocos2dx_dragonbones_Slot_update : Error processing arguments";
      goto LAB_00cb8d64;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp, 5255): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_Slot_update",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x148a);
LAB_00cb8d9c:
