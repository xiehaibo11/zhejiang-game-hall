...
/* v8::internal::Worklist<v8::internal::TransitionArray, 64>::Pop(int,
   v8::internal::TransitionArray*) */

undefined8 __thiscall
v8::internal::Worklist<v8::internal::TransitionArray,64>::Pop
          (Worklist<v8::internal::TransitionArray,64> *this,int param_1,TransitionArray *param_2)

{
  Mutex *this_00;
  long lVar1;
  long lVar2;
  Worklist<v8::internal::TransitionArray,64> *pWVar3;
  undefined8 *puVar4;
