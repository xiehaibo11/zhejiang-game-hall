...
undefined8
FUN_00aed5c4(ASN1_VALUE **param_1,long *param_2,char *param_3,ASN1_ITEM *param_4,long param_5,
...
LAB_00aedbc0:
      uVar4 = FUN_00aedfd0(param_1,param_2,local_68,param_4,param_5,param_6,param_7,param_8);
      return uVar4;
    }
    if ((iVar3 == -1) && ((param_7 & 0xff) == 0)) {
      uVar4 = FUN_00aede14(param_1,param_2,param_3,param_4->templates,0,param_8);
      return uVar4;
    }
    iVar3 = 0xaa;
    iVar7 = 0x9f;
  ...
  case '\x06':
    ...
    uVar4 = FUN_00aee720(&local_68,0,0,local_78,local_7c,&local_70,param_3,iVar7,uVar9,(char)param_7
                         ,param_8);
    if ((int)uVar4 == -1) {
      return uVar4;
    }
        ...
        if (param_4->tcount < 1) {
          ...
          if (param_4->tcount < 1) {
            ...
            do {
              ...
              if (pAVar5 == (ASN1_TEMPLATE *)0x0) goto LAB_00aedda0;
              ppAVar6 = asn1_get_field_ptr(param_1,pAVar5);
              pcVar2 = local_70;
              ...
              iVar3 = FUN_00aede14(ppAVar6,&local_70,local_68,pAVar5,uVar8,param_8);
              if (iVar3 == -1) {
                asn1_template_free(ppAVar6,pAVar5);
              }
              else {
                if (iVar3 == 0) goto LAB_00aedb28;
        ...
        if ((cVar1 != '\0') || (local_68 == (char *)0x0)) {
          ...
          if (lVar12 < param_4->tcount) {
            do {
              ...
              lVar12 = lVar12 + 1;
              tt = tt + 1;
                    /* catch() { ... } // from try @ 00aeddac with catch @ 00aedd38 */
            } while (lVar12 < param_4->tcount);
          }
          pcVar2 = local_70;
...
LAB_00aedd84:
    ...
    if (param_4->tcount < 1) {
      iVar3 = 0;
      if (param_4->tcount == 0) goto LAB_00aedb58;
LAB_00aeda1c:
    ...
    pAVar5 = param_4->templates;
    ppAVar6 = asn1_get_field_ptr(param_1,pAVar5);
    iVar3 = FUN_00aede14(ppAVar6,&local_70,param_3,pAVar5,1,param_8);
    if (iVar3 == -1) {
      lVar12 = 1;
      do {
        lVar14 = lVar12;
        ...
        if (lVar12 <= lVar14) goto LAB_00aedb4c;
        pAVar5 = pAVar5 + 1;
        ppAVar6 = asn1_get_field_ptr(param_1,pAVar5);
        iVar3 = FUN_00aede14(ppAVar6,&local_70,pcVar2,pAVar5,1,param_8);
        lVar12 = lVar14 + 1;
      } while (iVar3 == -1);
    }
    else {
...
LAB_00aedb4c:
      iVar3 = (int)lVar14;
      if (lVar12 != lVar14) goto LAB_00aeda1c;
LAB_00aedb58:
      if ((param_7 & 0xff) != 0) {
...
LAB_00aedb28:
  ...
  case '\x05':
    local_70 = (char *)*param_2;
    iVar3 = FUN_00aee720(0,&local_80,local_74,0,0,&local_70,param_3,0xffffffff,0,1,param_8);
    if (iVar3 == 0) {
      iVar3 = 0x3a;
      iVar7 = 0xae;
    }
      ...
      if (local_80 < 0x1f) {
        uVar10 = *(ulong *)(&DAT_018a8df8 + param_5 * 8);
      }
      else {
        uVar10 = 0;
      }
...
LAB_00aedda0:
                    /* try { // try from 00aedda8 to 00beddab has its CatchHandler @ 00aeddc4 */
                    /* try { // try from 00aeddac to 00bedf17 has its CatchHandler @ 00aedd38 */
  ERR_add_error_data(2,"Type=",param_4->sname);
switchD_00aed638_caseD_3:
                    /* catch() { ... } // from try @ 00aedda8 with catch @ 00aeddc4 */
  return 0;
}
