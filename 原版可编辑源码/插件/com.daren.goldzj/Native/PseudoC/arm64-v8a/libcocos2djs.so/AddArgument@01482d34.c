...
/* v8::internal::wasm::AsmFunctionType::AddArgument(v8::internal::wasm::AsmType*) */

void __thiscall
v8::internal::wasm::AsmFunctionType::AddArgument(AsmFunctionType *this,AsmType *param_1)
