...
/* bool spine_Vector_T_ptr_to_seval<spine::Updatable>(spine::Vector<spine::Updatable*> const&,
   se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::Updatable>(Vector *param_1,Value *param_2)
...
LAB_00c88efc:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::Updatable>
