...
/* v8::internal::compiler::GraphAssembler::UnsafePointerAdd(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::UnsafePointerAdd
...

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::UnsafePointerAdd
