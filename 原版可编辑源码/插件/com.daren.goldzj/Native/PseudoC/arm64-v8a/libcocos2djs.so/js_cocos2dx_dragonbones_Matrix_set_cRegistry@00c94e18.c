...
/* js_cocos2dx_dragonbones_Matrix_set_cRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_Matrix_set_cRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xa1,"js_cocos2dx_dragonbones_Matrix_set_c");
    pcVar8 = "js_cocos2dx_dragonbones_Matrix_set_c : Invalid Native Object";
  }
  else {
    local_74 = 0.0;
    ...
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0xa6,"js_cocos2dx_dragonbones_Matrix_set_c");
    pcVar8 = "js_cocos2dx_dragonbones_Matrix_set_c : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar8);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_Matrix_set_c",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0xaa);
LAB_00c94fb4:
