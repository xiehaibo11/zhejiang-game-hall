...
/* js_gfx_DeviceGraphics_setViewportRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_gfx_DeviceGraphics_setViewportRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (DeviceGraphics *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x308,"js_gfx_DeviceGraphics_setViewport");
    __android_log_print(6,"jswrapper","js_gfx_DeviceGraphics_setViewport : Invalid Native Object");
  }
  else {
    ...
    if (uVar13 == 0x40) {
      ...
      if ((uVar6 & uVar7 & uVar8 & uVar9 & 1) != 0) {
        cocos2d::renderer::DeviceGraphics::setViewport(this,iVar3,iVar4,iVar5,local_94);
        goto LAB_0092e3c4;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                          ,0x315,"js_gfx_DeviceGraphics_setViewport");
      __android_log_print(6,"jswrapper",
                          "js_gfx_DeviceGraphics_setViewport : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp, 793): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar13 >> 4,4);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_gfx_DeviceGraphics_setViewport",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                      ,0x31c);
LAB_0092e3c4:
