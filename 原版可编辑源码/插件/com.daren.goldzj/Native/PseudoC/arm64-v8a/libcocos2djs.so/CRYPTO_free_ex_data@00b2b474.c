...

{
  ...
  if ((uint)class_index < 0xe) {
    iVar1 = CRYPTO_THREAD_run_once(&DAT_01d3aaa0,FUN_00b2b674);
    if ((iVar1 == 0) || (DAT_01d3aaa4 == 0)) {
      iVar1 = 0x71;
      reason = 0x41;
      line = 0x3c;
    }
      ...
      puVar4 = &DAT_01d3aab0 + class_index;
      ...
      if ((int)uVar2 < 1) {
        ptr = (undefined1 *)0x0;
              ...
              (ptr = CRYPTO_malloc(uVar2 << 3,"crypto/ex_data.c",0x141), ptr != (undefined1 *)0x0))
      {
        uVar5 = 0;
        do {
        ...
        if (0 < (int)uVar2) {
          ...
          do {
            if ((*(long *)(ptr + uVar5 * 8) != 0) &&
              ...
              (*(code *)puVar4[3])(obj,uVar3,ad,uVar5 & 0xffffffff,*puVar4,puVar4[1]);
            }
            uVar5 = uVar5 + 1;
          } while (uVar2 != uVar5);
        }
