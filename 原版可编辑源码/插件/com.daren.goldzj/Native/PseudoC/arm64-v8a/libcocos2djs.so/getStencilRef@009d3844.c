...
/* cocos2d::renderer::StencilManager::getStencilRef() */

int __thiscall cocos2d::renderer::StencilManager::getStencilRef(StencilManager *this)

{
  ...
  if (uVar2 < 8) {
    ...
    do {
      ...
      auVar1._12_4_ = 1;
      auVar19 = NEON_ushl(auVar1,auVar18,4);
      uVar5 = uVar5 - 8;
