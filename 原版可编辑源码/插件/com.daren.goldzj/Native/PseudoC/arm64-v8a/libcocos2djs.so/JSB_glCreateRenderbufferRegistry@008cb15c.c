...
/* JSB_glCreateRenderbufferRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glCreateRenderbufferRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if ((plVar7[1] - *plVar7 & 0xffffffff0U) != 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xc0b,"JSB_glCreateRenderbuffer");
    __android_log_print(6,"jswrapper","Invalid number of arguments");
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "JSB_glCreateRenderbuffer",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                        ,0xc16);
    goto LAB_008cb4e8;
  }
  glGenRenderbuffers(1,&local_a4);
  this = (Object *)se::Object::createObjectWithClass(DAT_01d36f20);
  ...
  if (this_00 != (Ref *)0x0) {
    ...
    *(undefined4 *)(this_00 + 0x10) = 2;
    *(undefined ***)this_00 = &PTR_FUN_01c677a8;
    if (uVar10 != 0) {
      uVar9 = uVar10 - 1;
      if ((uVar9 & uVar10) == 0) {
      ...
      plVar7 = *(long **)(DAT_01d36e58 + unaff_x27 * 8);
      if (plVar7 != (long *)0x0) {
        do {
          plVar7 = (long *)*plVar7;
          if (plVar7 == (long *)0x0) goto LAB_008cb3a8;
          uVar12 = plVar7[1];
          if (uVar12 != uVar14) {
            if ((uVar9 & uVar10) == 0) {
              uVar12 = uVar12 & uVar9;
              ...
              if (uVar12 - uVar1 * uVar10 == unaff_x27) goto LAB_008cb398;
              goto LAB_008cb3a8;
            }
            if (uVar12 != unaff_x27) goto LAB_008cb3a8;
          }
LAB_008cb398:
...
LAB_008cb3a8:
    ...
    *plVar7 = 0;
    ...
    if ((uVar10 == 0) || (fVar4 * (float)uVar10 < (float)(lVar3 + 1))) {
      ...
      FUN_008d3530(&DAT_01d36e58,uVar10);
      uVar10 = DAT_01d36e60;
      if ((DAT_01d36e60 - 1 & DAT_01d36e60) == 0) {
        unaff_x27 = DAT_01d36e60 - 1 & uVar14;
      }
      else {
        unaff_x27 = uVar14;
        if (DAT_01d36e60 <= uVar14) {
          uVar9 = 0;
          if (DAT_01d36e60 != 0) {
            uVar9 = uVar14 / DAT_01d36e60;
          }
          unaff_x27 = uVar14 - uVar9 * DAT_01d36e60;
        }
      }
    }
    lVar3 = DAT_01d36e58;
    plVar11 = *(long **)(DAT_01d36e58 + unaff_x27 * 8);
    if (plVar11 == (long *)0x0) {
      plVar11 = plVar7;
      *plVar7 = (long)DAT_01d36e68;
      DAT_01d36e68 = plVar11;
      *(long ***)(lVar3 + unaff_x27 * 8) = &DAT_01d36e68;
      if (*plVar7 != 0) {
        ...
        plVar11 = (long *)(DAT_01d36e58 + uVar14 * 8);
        goto LAB_008cb4c8;
      }
    }
    else {
