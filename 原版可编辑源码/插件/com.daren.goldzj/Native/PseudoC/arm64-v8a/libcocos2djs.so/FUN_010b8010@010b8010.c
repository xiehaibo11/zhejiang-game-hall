...
undefined8
FUN_010b8010(undefined8 param_1,undefined8 param_2,ulong *param_3,ulong *param_4,ulong param_5,
            ulong param_6)

{
  ...
  if ((*(uint *)((uVar1 & 0xffffffff00000000 | (ulong)*(uint *)(uVar1 + 0xb)) + 0x1b) >> 2 & 1) == 0
    ...
    if ((((4294967295.0 < dVar3) || (dVar3 < 0.0)) || (ABS(dVar3) == INFINITY)) || (NAN(ABS(dVar3)))
       ) {
      return 1;
    }
    if (dVar3 == (double)(uint)(int)dVar3) {
      ...
      if (param_5 < uVar2) {
        do {
          if (*(uint *)(*(long *)(uVar1 + 0x27) + (ulong)*(uint *)(uVar1 + 0x2f) + param_5 * 4) ==
              (int)dVar3) {
            return 1;
          }
          param_5 = param_5 + 1;
