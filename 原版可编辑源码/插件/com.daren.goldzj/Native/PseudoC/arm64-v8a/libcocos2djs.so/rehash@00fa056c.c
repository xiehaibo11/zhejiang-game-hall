...
/* std::__ndk1::__hash_table<v8::internal::HeapObject, v8::internal::Object::Hasher,
...
::rehash(__hash_table<v8::internal::HeapObject,v8::internal::Object::Hasher,std::__ndk1::equal_to<v8::internal::HeapObject>,std::__ndk1::allocator<v8::internal::HeapObject>>
         *this,ulong param_1)

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      if (uVar1 < uVar2) goto LAB_00fa0630;
    }
    return;
  }
LAB_00fa0630:
