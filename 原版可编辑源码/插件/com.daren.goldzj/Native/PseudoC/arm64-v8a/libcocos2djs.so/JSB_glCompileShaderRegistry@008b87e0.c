...
/* JSB_glCompileShaderRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glCompileShaderRegistry(FunctionCallbackInfo *param_1)
...
LAB_008b890c:
      ...
      if (1 < (byte)pVVar6[8]) goto LAB_008b890c;
      uVar3 = 0;
    }
    glCompileShader(uVar3);
  }
  else {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                        ,0x3b6,"JSB_glCompileShader");
