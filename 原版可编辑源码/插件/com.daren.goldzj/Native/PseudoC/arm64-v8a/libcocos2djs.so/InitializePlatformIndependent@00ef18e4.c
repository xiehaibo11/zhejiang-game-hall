...
/* v8::internal::TorqueInterfaceDescriptor<5>::InitializePlatformIndependent(v8::internal::CallInterfaceDescriptorData*)
    */

void __thiscall
v8::internal::TorqueInterfaceDescriptor<5>::InitializePlatformIndependent
          (TorqueInterfaceDescriptor<5> *this,CallInterfaceDescriptorData *param_1)
  ...
  *local_48 = uVar1;
  ...
  insert<v8::internal::MachineType*>
            ((vector<v8::internal::MachineType,std::__ndk1::allocator<v8::internal::MachineType>> *)
             &local_48,puVar2,&local_58,auStack_4e);
  CallInterfaceDescriptorData::InitializePlatformIndependent(param_1,0,1,5,local_48);
