...
/* v8::internal::compiler::RegisterAllocationData::PhiMapValue::AddOperand(v8::internal::compiler::InstructionOperand*)
    */

void __thiscall
v8::internal::compiler::RegisterAllocationData::PhiMapValue::AddOperand
...

{
  ...
  if (puVar4 == *(undefined8 **)(this + 0x20)) {
    lVar6 = (long)puVar4 - *(long *)(this + 0x10) >> 3;
    uVar1 = lVar6 + 1;
    if (uVar1 >> 0x1c != 0) {
                    /* WARNING: Subroutine does not return */
      abort();
    }
    lVar3 = (long)*(undefined8 **)(this + 0x20) - *(long *)(this + 0x10);
    uVar7 = lVar3 >> 2;
    if (uVar1 <= uVar7) {
      uVar1 = uVar7;
    }
