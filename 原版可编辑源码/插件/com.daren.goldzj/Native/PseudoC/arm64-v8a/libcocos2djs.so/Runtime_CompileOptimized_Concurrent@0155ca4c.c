...
/* v8::internal::Runtime_CompileOptimized_Concurrent(int, unsigned long*, v8::internal::Isolate*) */

ulong v8::internal::Runtime_CompileOptimized_Concurrent(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar3 = FUN_0155cb6c(param_1,param_2,param_3);
    return uVar3;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar3 & 1) != 0) &&
    ...
    if ((uVar3 & 1) == 0) {
      uVar3 = Compiler::CompileOptimized(param_2,1);
      if ((uVar3 & 1) == 0) {
