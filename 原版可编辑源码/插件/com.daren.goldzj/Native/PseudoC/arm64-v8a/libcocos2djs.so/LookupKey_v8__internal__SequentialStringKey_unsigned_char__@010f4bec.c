...
/* v8::internal::Handle<v8::internal::String>
   v8::internal::StringTable::LookupKey<v8::internal::SequentialStringKey<unsigned char>
   >(v8::internal::Isolate*, v8::internal::SequentialStringKey<unsigned char>*) */

void v8::internal::StringTable::LookupKey<v8::internal::SequentialStringKey<unsigned_char>>
