...
/* unsigned long std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned long, unsigned
   int>, std::__ndk1::__unordered_map_hasher<unsigned long, std::__ndk1::__hash_value_type<unsigned
   long, unsigned int>, std::__ndk1::hash<unsigned long>, true>,
