...
/* js_cocos2dx_dragonbones_BoundingBoxData_get_heightRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_BoundingBoxData_get_heightRegistry
...

{
  ...
  if (lVar3 == 0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_BoundingBoxData_get_height : Invalid Native Object"
                       );
