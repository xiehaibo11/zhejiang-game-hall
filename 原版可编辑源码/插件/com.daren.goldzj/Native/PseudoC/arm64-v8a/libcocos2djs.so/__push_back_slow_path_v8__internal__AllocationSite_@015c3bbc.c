...
/* void std::__ndk1::vector<v8::internal::AllocationSite,
   std::__ndk1::allocator<v8::internal::AllocationSite>
   >::__push_back_slow_path<v8::internal::AllocationSite>(v8::internal::AllocationSite&&) */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_015c3ca4;
