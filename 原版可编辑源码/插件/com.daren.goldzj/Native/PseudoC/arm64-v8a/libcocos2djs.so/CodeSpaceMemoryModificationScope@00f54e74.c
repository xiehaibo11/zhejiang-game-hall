...
/* v8::internal::CodeSpaceMemoryModificationScope::CodeSpaceMemoryModificationScope(v8::internal::Heap*)
    */

void __thiscall
v8::internal::CodeSpaceMemoryModificationScope::CodeSpaceMemoryModificationScope
          (CodeSpaceMemoryModificationScope *this,Heap *param_1)

{
  ...
  *(Heap **)this = param_1;
  if (param_1[0x168] != (Heap)0x0) {
    *(long *)(param_1 + 0x170) = *(long *)(param_1 + 0x170) + 1;
    PagedSpace::SetReadAndWritable(*(PagedSpace **)(*(long *)this + 0xf8));
    lVar2 = *(long *)this;
      ...
      if (uVar3 != 0) {
        ...
        if ((plVar7 != (long *)0x0) && (plVar7 = (long *)*plVar7, plVar7 != (long *)0x0)) {
          do {
            uVar8 = plVar7[1];
            if (uVar8 == uVar5) {
              if ((MemoryChunk *)plVar7[2] == this_00) goto LAB_00f54fa0;
            }
            else {
              if (uVar4 < 2) {
                uVar8 = uVar8 & uVar3 - 1;
