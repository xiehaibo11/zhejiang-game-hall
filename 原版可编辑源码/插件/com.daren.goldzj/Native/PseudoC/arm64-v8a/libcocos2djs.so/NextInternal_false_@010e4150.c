...
/* void v8::internal::LookupIterator::NextInternal<false>(v8::internal::Map,
   v8::internal::JSReceiver) */

void __thiscall
v8::internal::LookupIterator::NextInternal<false>
  ...
  if ((int)(pIVar3 + *(uint *)(param_2 + 0xf)) != *(int *)(pIVar3 + 0xb0)) {
    while (((pIVar6 = pIVar1, ((byte)*this >> 1 & 1) != 0 || (*(short *)(param_2 + 7) == 0xab)) &&
      ...
      if (*(ushort *)(param_2 + 7) < 0x411) {
        ...
        iVar2 = LookupInRegularHolder<false>(this,param_2,pIVar6);
      }
      pIVar3 = *(Isolate **)(this + 0x18);
      *(int *)(this + 4) = iVar2;
      if (iVar2 != 4) {
