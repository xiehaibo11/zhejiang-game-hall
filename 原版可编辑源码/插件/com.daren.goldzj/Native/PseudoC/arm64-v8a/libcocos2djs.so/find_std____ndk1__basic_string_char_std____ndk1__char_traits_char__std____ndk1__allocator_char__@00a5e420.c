...
/* std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   cocos2d::extension::ManifestAsset>, void*>*>
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::extension::ManifestAsset> > >::find<std::__ndk1::basic_string<char,
...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00a5e428 to 00b5e43f has its CatchHandler @ 00a5e68c */
  lVar5 = tpidr_el0;
  local_68 = *(long *)(lVar5 + 0x28);
                    /* try { // try from 00a5e448 to 00b5e453 has its CatchHandler @ 00a5e688 */
                    /* try { // try from 00a5e454 to 00b5e45f has its CatchHandler @ 00a5e684 */
  uVar7 = *(ulong *)(param_1 + 8);
  pbVar2 = *(basic_string **)(param_1 + 0x10);
                    /* try { // try from 00a5e460 to 00b5e467 has its CatchHandler @ 00a5e69c */
  if (((byte)*param_1 & 1) == 0) {
    pbVar2 = param_1 + 1;
  ...
  if (uVar13 != 0) {
    uVar14 = uVar13 - 1;
                    /* try { // try from 00a5e484 to 00b5e48b has its CatchHandler @ 00a5e634 */
    if ((uVar14 & uVar13) == 0) {
      uVar15 = uVar14 & uVar7;
    }
    else {
      uVar15 = uVar7;
                    /* try { // try from 00a5e490 to 00b5e4af has its CatchHandler @ 00a5e630 */
      if (uVar13 <= uVar7) {
        uVar15 = 0;
        if (uVar13 != 0) {
          uVar15 = uVar7 / uVar13;
    ...
    if (plVar8 != (long *)0x0) {
      plVar8 = (long *)*plVar8;
      if (plVar8 != (long *)0x0) {
                    /* try { // try from 00a5e4c8 to 00b5e4e3 has its CatchHandler @ 00a5e69c */
        ...
        do {
          uVar9 = plVar8[1];
          if (uVar7 == uVar9) {
                    /* try { // try from 00a5e4e8 to 00b5e52b has its CatchHandler @ 00a5e634 */
            bVar3 = *(byte *)(plVar8 + 2);
            sVar1 = (ulong)(bVar3 >> 1);
            if ((bVar3 & 1) != 0) {
              sVar1 = plVar8[3];
            ...
            if ((uVar14 & uVar13) == 0) {
              ...
              if (uVar9 - uVar4 * uVar13 == uVar15) goto LAB_00a5e574;
              goto LAB_00a5e598;
            }
            if (uVar9 != uVar15) goto LAB_00a5e598;
          }
LAB_00a5e574:
          plVar8 = (long *)*plVar8;
...
LAB_00a5e59c:
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* try { // try from 00a5e5b8 to 00b5e6f3 has its CatchHandler @ 00a5e3d0 */
    return plVar8;
  }
