...
/* v8::internal::compiler::GraphAssembler::WordSar(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::WordSar(GraphAssembler *this,Node *param_1,Node *param_2)
