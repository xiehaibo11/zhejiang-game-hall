...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitTestUndetectable(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitTestUndetectable
