...
void FUN_00d95bc8(long *param_1)
...
LAB_00d95e0c:
    ...
    *puVar5 = (char)iVar1;
    lVar6 = plVar7[1];
    plVar7[1] = lVar6 + -1;
    if ((lVar6 + -1 != 0) || (iVar1 = (*(code *)plVar7[3])(param_1), iVar1 != 0)) goto LAB_00d95e0c;
    puVar3 = (undefined8 *)*param_1;
    *(undefined4 *)(puVar3 + 5) = 0x19;
    (*(code *)*puVar3)(param_1);
    lVar6 = *(long *)(lVar9 + 0x28);
      ...
      if ((~*(uint *)(lVar9 + 0x18) & 0x7f800) == 0) {
        ...
        *puVar5 = 0;
        ...
        if ((lVar9 + -1 == 0) && (iVar1 = (*(code *)puVar3[3])(param_1), iVar1 == 0)) {
          puVar3 = (undefined8 *)*param_1;
          *(undefined4 *)(puVar3 + 5) = 0x19;
                    /* WARNING: Could not recover jumptable at 0x00d96110. Too many branches */
