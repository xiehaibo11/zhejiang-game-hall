...
/* v8::internal::compiler::MapInference::AllOfInstanceTypesUnsafe(std::__ndk1::function<bool
   (v8::internal::InstanceType)>) const */

undefined4 __thiscall
v8::internal::compiler::MapInference::AllOfInstanceTypesUnsafe(MapInference *this,long *param_2)
...
LAB_01791d84:
  ...
  if (local_70 == local_50) {
    ...
    if (local_50 == (long *)0x0) goto LAB_01791db8;
