...
/* v8::internal::compiler::GraphAssembler::LoadElement(v8::internal::compiler::ElementAccess const&,
   v8::internal::compiler::Node*, v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::LoadElement
          (GraphAssembler *this,ElementAccess *param_1,Node *param_2,Node *param_3)
