...
/* JSB_glUseProgramRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glUseProgramRegistry(FunctionCallbackInfo *param_1)
...
LAB_008c7ddc:
      ...
      if (1 < (byte)pVVar6[8]) goto LAB_008c7ddc;
      uVar3 = 0;
    }
    glUseProgram(uVar3);
  }
