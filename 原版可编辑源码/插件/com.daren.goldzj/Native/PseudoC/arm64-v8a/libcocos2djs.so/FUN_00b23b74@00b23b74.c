...
ulong FUN_00b23b74(undefined8 param_1,uchar *param_2,uchar *param_3,ulong param_4)
    ...
    if (iVar1 == 0) {
      if (0x17 < param_4) {
        ...
        *puVar2 = 0x521e8792ca2dd4a;
        ...
        siz = param_4 - 0x10;
        FUN_00b23260(param_1,param_2,param_3 + 8,siz);
        pDVar3 = (DES_key_schedule *)EVP_CIPHER_CTX_get_cipher_data(param_1);
        _Var7 = pDVar3[3].ks[0];
        if (_Var7 == (_union_772)0x0) {
          pauVar6 = (DES_cblock *)EVP_CIPHER_CTX_iv_noconst(param_1);
        ...
        FUN_00b23260(param_1,param_2,param_2,siz);
        pDVar3 = (DES_key_schedule *)EVP_CIPHER_CTX_get_cipher_data(param_1);
        _Var7 = pDVar3[3].ks[0];
        if (_Var7 == (_union_772)0x0) {
          pauVar6 = (DES_cblock *)EVP_CIPHER_CTX_iv_noconst(param_1);
        ...
        if (((int)siz != -1) && (iVar1 == 0)) goto LAB_00b23bac;
      ...
      *(undefined8 *)(param_2 + param_4 + 8) = local_78[0];
      ...
      if (0 < iVar1) {
        ...
        *(undefined8 *)param_2 = *puVar2;
        FUN_00b23260(param_1,puVar5,puVar5,param_4 + 8);
        siz = param_4 + 0x10;
        BUF_reverse(param_2,(uchar *)0x0,siz);
        puVar2 = (undefined8 *)EVP_CIPHER_CTX_iv_noconst(param_1);
        *puVar2 = 0x521e8792ca2dd4a;
