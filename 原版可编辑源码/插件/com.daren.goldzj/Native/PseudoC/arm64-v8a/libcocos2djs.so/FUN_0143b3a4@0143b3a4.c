...
void FUN_0143b3a4(ulong param_1)

{
  ...
  if (bVar3) {
    uVar4 = uVar4 | 2;
    if ((int)uVar11 <= (int)param_1) goto LAB_0143b480;
  }
  else {
...
LAB_0143b484:
  ...
  if ((int)lVar6 != (int)*(undefined8 *)(unaff_x26 + 0xa0)) {
    lVar1 = (ulong)*(byte *)(lVar5 + lVar15 + 2) * 4 + 0x1f;
    ...
    if (uVar8 != uVar4) {
      ...
      *(undefined4 *)(lVar6 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0143b500. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(lVar16 + (ulong)*(byte *)(lVar5 + lVar15 + 3) * 8))(uVar7);
  return;
}
