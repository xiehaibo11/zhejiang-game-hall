...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitCreateMappedArguments(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitCreateMappedArguments
