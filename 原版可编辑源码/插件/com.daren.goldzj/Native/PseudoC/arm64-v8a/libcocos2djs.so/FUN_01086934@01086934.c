...
ulong FUN_01086934(ulong *param_1,int param_2)

{
  ...
  FUN_01086b14(this,*puVar4,0,*puVar5,bVar1,0,0xffffffff);
  uVar6 = v8::internal::JSObject::GetElementsTransitionMap(param_1,1);
  ...
  *(int *)(uVar9 + 7) = (int)uVar7;
  ...
  uVar7 = v8::internal::JSObject::PrintElementsTransition(waitpid,param_1,bVar1,puVar4,1,puVar5);
  return uVar7;
}
