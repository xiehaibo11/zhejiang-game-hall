...
/* v8::internal::wasm::WasmFunctionBuilder::EmitF32Const(float) */

void __thiscall
v8::internal::wasm::WasmFunctionBuilder::EmitF32Const(WasmFunctionBuilder *this,float param_1)

{
  ...
  *puVar3 = 0x43;
  ZoneBuffer::write_u32((ZoneBuffer *)(this + 0x40),(uint)param_1);
  return;
}
