...
/* v8::internal::compiler::NativeContextRef::scope_info() const */

undefined1  [16] __thiscall
v8::internal::compiler::NativeContextRef::scope_info(NativeContextRef *this)

{
  ...
  if (*(int *)(*(undefined8 **)this + 1) == 2) {
    ...
    uVar3 = Context::scope_info((Context *)&local_18);
    ...
    if (*(int *)(puVar6 + 1) == 2) {
      uVar3 = *(ulong *)*puVar6;
      if ((uVar3 & 1) == 0) goto LAB_0172e8ec;
      sVar2 = *(short *)((uVar3 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar3 - 1));
    }
    else {
      if (*(int *)(puVar6 + 1) == 0) goto LAB_0172e8ec;
