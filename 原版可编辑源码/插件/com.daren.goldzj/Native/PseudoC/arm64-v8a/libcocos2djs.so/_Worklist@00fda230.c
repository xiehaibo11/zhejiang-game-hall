...
/* v8::internal::Worklist<v8::internal::SharedFunctionInfo, 64>::~Worklist() */

void __thiscall
v8::internal::Worklist<v8::internal::SharedFunctionInfo,64>::~Worklist
          (Worklist<v8::internal::SharedFunctionInfo,64> *this)

{
  uint uVar1;
  void *pvVar2;
  ulong uVar3;
  Worklist<v8::internal::SharedFunctionInfo,64> *pWVar4;
  long lVar5;
