...
void FUN_01442538(ulong param_1,undefined8 param_2,long param_3,undefined8 param_4,long param_5,
  ...
  if ((int)uVar12 != (int)*(undefined8 *)(unaff_x26 + 0xc08)) {
      ...
      if (*(int *)(uVar12 - 1) == (int)*(undefined8 *)(unaff_x26 + 0x120)) {
        *(int *)(param_5 + -0x20) = (iVar8 + -1) * 2;
        ...
        (*pcVar9)(in_w11 * 2,uVar13,param_3,param_6);
                    /* WARNING: Could not recover jumptable at 0x01442684. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (**(code **)(unaff_x21 + (ulong)*(byte *)(*(long *)(param_5 + -0x18) + unaff_x19 + 5) * 8))
                  ();
        return;
      }
      lVar18 = unaff_x26 + (ulong)*(uint *)(uVar12 + 7);
      if (((int)lVar18 != 0) && (*(int *)(lVar18 + 3) != 0)) goto FUN_014431dc;
      uVar16 = unaff_x26 + (ulong)*(uint *)(uVar12 + 3);
      param_1 = unaff_x26 + (ulong)*(uint *)(uVar12 + 0xb);
      if ((param_1 & 1) == 0) {
                    /* WARNING: Could not recover jumptable at 0x01442610. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + unaff_x19 + 5) * 8))();
        return;
      }
      if ((int)param_1 != (int)*(undefined8 *)(unaff_x26 + 0xb0)) {
        if ((int)param_1 == 3) goto FUN_014431dc;
    ...
    if (uVar17 == 4) {
      ...
      if ((uVar15 >> 6 & 1) == 0) {
        ...
        if (bVar10) {
                    /* WARNING: Could not recover jumptable at 0x01443104. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + unaff_x19 + 5) * 8))();
          return;
        }
...
LAB_0144316c:
          ...
          *(undefined8 *)(lVar18 + 3) = uVar11;
                    /* WARNING: Could not recover jumptable at 0x014431d8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + unaff_x19 + 5) * 8))();
          return;
        }
        ...
        if (bVar10) {
                    /* WARNING: Could not recover jumptable at 0x01443148. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + unaff_x19 + 5) * 8))
      ...
      if (uVar17 == 5) {
                    /* WARNING: Could not recover jumptable at 0x014430ac. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + unaff_x19 + 5) * 8))(uVar14);
        return;
      }
      if (uVar17 == 0xd) {
        *(int *)(param_5 + -0x20) = (iVar8 + -1) * 2;
        ...
        while( true ) {
          ...
          if (iVar2 == (int)param_3) {
            if ((ulong)((long)((ulong)*(uint *)(uVar12 + 3) << 0x20) >> 0x21) <= lVar1 + 6U) {
              ...
              pcVar9 = (code *)SoftwareBreakpoint(0,0x1442da8);
              (*pcVar9)();
            }
            uVar14 = unaff_x26 + (ulong)*(uint *)(uVar12 + lVar19 + 0xb);
            lVar18 = param_5;
            if ((*(int *)(uVar12 + lVar19 + 0xf) >> 1 & 1U) == 0) goto LAB_01443004;
            if (*(int *)(uVar14 - 1) == (int)*(undefined8 *)(unaff_x26 + 0xcc8)) {
              ...
              uVar14 = param_7;
              if ((int)lVar19 != (int)*(undefined8 *)(unaff_x26 + 0xca8)) goto LAB_01443004;
              if (*(int *)(lVar1 + 0x33) == (int)*(undefined8 *)(unaff_x26 + 0xa8)) {
                ...
                if ((uVar12 & 1) != 0) {
                  ...
                  *(int *)(param_5 + -0x20) = (iVar8 + -1) * 2;
                  ...
                  unaff_x21 = param_5;
LAB_01443004:
                    /* WARNING: Could not recover jumptable at 0x0144302c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                  (**(code **)(unaff_x21 +
        ...
        if (uVar17 == 6) {
          ...
          *(int *)(param_5 + -0x20) = (iVar8 + -1) * 2;
          FUN_0133fcc0(0,unaff_x26 + (ulong)uVar15);
                    /* WARNING: Could not recover jumptable at 0x01442d20. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        ...
        if (uVar17 == 7) {
          ...
          *(int *)(param_5 + -0x20) = (iVar8 + -1) * 2;
          FUN_01348300(uVar14,uVar13,param_3,unaff_x26 + (ulong)uVar15);
                    /* WARNING: Could not recover jumptable at 0x01442c94. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x21 + (ulong)*(byte *)(*(long *)(param_5 + -0x18) + unaff_x19 + 5) * 8)
          )();
          return;
        ...
        if ((uVar17 == 8) || (uVar17 == 9)) {
          ...
          if ((int)(unaff_x26 + (ulong)uVar15) == 3) {
                    /* WARNING: Does not return */
            pcVar9 = (code *)SoftwareBreakpoint(0,0x1442b90);
            (*pcVar9)();
          }
          ...
          *(int *)(param_5 + -0x20) = (iVar8 + -1) * 2;
          FUN_01348140(uVar13,uVar11,0,unaff_x26 + (ulong)uVar3,param_5,
                    ...
                    /* WARNING: Could not recover jumptable at 0x01442c20. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(param_5 + (ulong)*(byte *)(*(long *)(local_40 + -0x18) + unaff_x20) * 8))();
          return;
        }
        if (uVar17 != 3) {
          ...
          if (uVar17 == 0xc) {
            *(int *)(param_5 + -0x20) = (iVar8 + -1) * 2;
            FUN_013fc180(uVar14,param_3,uVar13,0);
                    /* WARNING: Could not recover jumptable at 0x01442878. Too many branches */
                    /* WARNING: Treating indirect jump as call */
            (**(code **)(unaff_x21 +
                        (ulong)*(byte *)(*(long *)(param_5 + -0x18) + unaff_x19 + 5) * 8))();
            return;
          }
          if (uVar17 != 0xe) {
            *(int *)(param_5 + -0x20) = (iVar8 + -1) * 2;
          ...
          if ((ulong)((long)((ulong)*(uint *)(lVar18 + 3) << 0x20) >> 0x21) <= uVar12) {
                    /* WARNING: Does not return */
            pcVar9 = (code *)SoftwareBreakpoint(0,0x144278c);
            (*pcVar9)();
          }
          if ((int)unaff_x26 + *(int *)(unaff_x26 + (ulong)*(uint *)(lVar18 + uVar12 * 4 + 7) + 3)
              != (int)*(undefined8 *)(unaff_x26 + 0xa8)) {
                    /* WARNING: Could not recover jumptable at 0x014427c8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
            (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + unaff_x19 + 5) * 8))();
            return;
          }
...
LAB_01442b3c:
                    /* WARNING: Could not recover jumptable at 0x01442b64. Too many branches */
                    /* WARNING: Treating indirect jump as call */
