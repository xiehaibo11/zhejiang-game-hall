...
LAB_00b7daec:
      if (algor2 != (X509_ALGOR *)0x0) {
        ...
        if (type->pkey_type == 0x71) {
          ...
          if (pAVar3 == (ASN1_TYPE *)0x0) goto LAB_00b7dc68;
          pAVar3->type = 5;
        }
...
LAB_00b7dc30:
        ...
        if (pAVar4->length == 0) goto LAB_00b7dc4c;
      }
...
LAB_00b7dacc:
      ...
      if (pAVar4 == (ASN1_OBJECT *)0x0) goto LAB_00b7dc30;
      if (pAVar4->length != 0) goto LAB_00b7daec;
LAB_00b7dc4c:
      iVar1 = 0x9a;
      iVar2 = 0x47;
      goto LAB_00b7dc64;
    }
    if ((pAVar3 != (ASN1_TYPE *)0x0) && (pAVar3->type == 5)) goto LAB_00b7dacc;
    ASN1_TYPE_free(pAVar3);
    pAVar3 = ASN1_TYPE_new();
