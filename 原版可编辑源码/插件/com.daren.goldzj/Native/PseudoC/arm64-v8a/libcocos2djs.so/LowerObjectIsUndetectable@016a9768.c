...
/* v8::internal::compiler::EffectControlLinearizer::LowerObjectIsUndetectable(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerObjectIsUndetectable
...

{
  ...
  pNVar3 = (Node *)GraphAssembler::Int32Constant(this_00,0x10);
