...
void FUN_014637e0(undefined8 param_1)

{
  ...
  iVar2 = *(int *)(unaff_x20 + unaff_x19 + 1);
  lVar4 = unaff_x26 +
  ...
  *(int *)(unaff_x29 + -0x20) = ((int)unaff_x19 + -1) * 2;
  FUN_01392a60(iVar2 * 2,param_1);
                    /* WARNING: Could not recover jumptable at 0x014638c0. Too many branches */
