...
/* v8::Int8Array::New(v8::Local<v8::SharedArrayBuffer>, unsigned long, unsigned long) */

undefined8 v8::Int8Array::New(long param_1,undefined8 param_2,ulong param_3)

{
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_70,(ulong)&local_70 | 8,0x379);
  }
  this = *(Logger **)(pFVar5 + 0x9558);
  uVar2 = internal::Logger::is_logging(this);
  if ((uVar2 & 1) != 0) {
    internal::Logger::ApiEntryCall(this,"v8::Int8Array::New");
  }
  uVar1 = *(undefined4 *)(pFVar5 + 0x2c60);
  *(undefined4 *)(pFVar5 + 0x2c60) = 5;
  if (param_3 >> 0x1f == 0) {
    uVar3 = internal::Factory::NewJSTypedArray(pFVar5,1,param_1,param_2,param_3);
LAB_00eca320:
