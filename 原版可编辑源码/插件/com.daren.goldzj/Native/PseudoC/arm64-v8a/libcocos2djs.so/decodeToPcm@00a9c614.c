...
/* cocos2d::AudioDecoderWav::decodeToPcm() */

undefined4 __thiscall cocos2d::AudioDecoderWav::decodeToPcm(AudioDecoderWav *this)

{
  ...
  (**(code **)(*plVar3 + 0x20))(&local_90,plVar3,this + 8);
