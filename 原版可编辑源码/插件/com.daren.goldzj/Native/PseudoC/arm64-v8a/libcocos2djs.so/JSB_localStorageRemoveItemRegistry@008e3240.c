...
/* JSB_localStorageRemoveItemRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_localStorageRemoveItemRegistry(FunctionCallbackInfo *param_1)
  ...
  if (plVar5[1] - *plVar5 == 0x10) {
    ...
    if (bVar1) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0x100,"JSB_localStorageRemoveItem");
      __android_log_print(6,"jswrapper",&DAT_0190552e);
    }
    else {
      localStorageRemoveItem((basic_string *)&local_78);
    }
    if ((local_78 & 1) != 0) {
      operator_delete(local_68);
    }
    if (!bVar1) goto LAB_008e3364;
  }
  else {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_cocos2dx_manual.cpp, 261): Invalid number of arguments\n"
                       );
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "JSB_localStorageRemoveItem",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_cocos2dx_manual.cpp"
                      ,0x108);
LAB_008e3364:
