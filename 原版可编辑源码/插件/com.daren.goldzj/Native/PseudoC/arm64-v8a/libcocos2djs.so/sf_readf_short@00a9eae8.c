...

{
  ...
  if ((((param_1 == 0) || (param_2 == (void *)0x0)) || (uVar4 = 0, param_3 < 1)) ||
     (uVar3 = *(ulong *)(param_1 + 0x18), uVar3 == 0)) goto switchD_00a9ebcc_caseD_2;
  iVar2 = (int)uVar3;
  ...
  __size = *(long *)(param_1 + 0x10) * (long)iVar2;
                    /* catch() { ... } // from try @ 00a9ec84 with catch @ 00a9eb44
                       catch() { ... } // from try @ 00a9ecc0 with catch @ 00a9eb44
                       catch() { ... } // from try @ 00a9ed18 with catch @ 00a9eb44 */
  if ((uVar1 < 0xb) && ((1 << (ulong)uVar1 & 0x540U) != 0)) {
    __ptr = malloc(__size);
    uVar3 = (**(code **)(param_1 + 0x38))(__ptr,1,__size,*(undefined8 *)(param_1 + 8));
                    /* try { // try from 00a9eb7c to 00b9eba3 has its CatchHandler @ 00a9ed18 */
  }
  else {
  ...
  *(ulong *)(param_1 + 0x18) = *(long *)(param_1 + 0x18) - uVar4;
  switch(uVar1) {
  case 2:
    goto switchD_00a9ebcc_caseD_2;
  case 4:
                    /* try { // try from 00a9ebd0 to 00b9ec83 has its CatchHandler @ 00a9ed20 */
