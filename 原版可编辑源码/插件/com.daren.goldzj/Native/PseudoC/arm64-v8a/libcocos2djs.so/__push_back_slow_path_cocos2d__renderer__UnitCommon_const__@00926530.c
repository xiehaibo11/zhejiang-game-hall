...
/* void std::__ndk1::vector<cocos2d::renderer::UnitCommon*,
   std::__ndk1::allocator<cocos2d::renderer::UnitCommon*>
   >::__push_back_slow_path<cocos2d::renderer::UnitCommon* const&>(cocos2d::renderer::UnitCommon*
   const&) */
