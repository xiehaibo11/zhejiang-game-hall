...

{
  ...
  undefined4 uVar6;
                    ...
                    /* try { // try from 00ac053c to 00bc0583 has its CatchHandler @ 00ac053c
                       catch() { ... } // from try @ 00ac053c with catch @ 00ac053c
                       catch() { ... } // from try @ 00ac05bc with catch @ 00ac053c */
  uVar6 = 0x11;
  ...
  if (*(long *)(*(long *)(param_1 + 0x90) + 0x260) == 0) {
    ...
    if ((lVar5 == 0) || (*(int *)(lVar5 + 4) == 0)) {
                    /* catch() { ... } // from try @ 00ac0590 with catch @ 00ac05f8 */
      iVar3 = 0x85;
      line = 0x1b;
      goto LAB_00ac0628;
    }
  ...
  lVar5 = *(long *)(*(long *)(param_1 + 8) + 0xc0);
                    /* try { // try from 00ac0584 to 00bc058b has its CatchHandler @ 00ac05f0 */
                    /* try { // try from 00ac0590 to 00bc05bb has its CatchHandler @ 00ac05f8 */
  ...
  if (iVar3 != 0) {
    *(int *)(*(long *)(param_1 + 0x90) + 0x214) = iVar3;
    return 1;
                    /* try { // try from 00ac05bc to 00bc0613 has its CatchHandler @ 00ac053c */
  }
  iVar3 = 0x44;
  line = 0x37;
LAB_00ac0628:
