...
/* v8::internal::compiler::SimplifiedOperatorBuilder::StoreDataViewElement(v8::internal::ExternalArrayType
   const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::StoreDataViewElement
...

{
  ...
  Operator::Operator(pOVar2,0xf6,0x68,"StoreDataViewElement",5,1,1,0,1,0);
