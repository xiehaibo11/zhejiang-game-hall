...
/* WARNING: Removing unreachable block (ram,0x00e0ab1c) */
/* WARNING: Removing unreachable block (ram,0x00e0ae9c) */
/* WARNING: Removing unreachable block (ram,0x00e0aa5c) */
/* WARNING: Removing unreachable block (ram,0x00e0bc7c) */
/* WARNING: Removing unreachable block (ram,0x00e0b608) */
/* WARNING: Removing unreachable block (ram,0x00e0bc9c) */
/* WARNING: Removing unreachable block (ram,0x00e0b080) */
/* WARNING: Removing unreachable block (ram,0x00e0b710) */
/* WARNING: Removing unreachable block (ram,0x00e0b6f8) */
...
LAB_00e0be9c:
  ...
  pbVar31 = pbVar30;
  iVar22 = 1;
  switch((long)&switchD_00e0beac::switchdataD_01973d64 +
         (long)(int)(&switchD_00e0beac::switchdataD_01973d64)[uVar16]) {
  case 0xe0ac14:
    if (uVar12 < 0x10) {
      uVar36 = uVar36 & 0xffffffff;
      do {
        uVar32 = 0;
        if ((int)uVar37 == 0) goto LAB_00e0bee8;
        pbVar31 = pbVar30 + 1;
...
LAB_00e0ad5c:
    ...
    goto LAB_00e0ad80;
  case 0xe0ad54:
    if (uVar12 < 0x10) goto LAB_00e0ad5c;
LAB_00e0ad80:
...
switchD_00e0beac_caseD_e0b714:
    ...
    *puVar38 = 5;
    pbVar30 = pbVar31;
switchD_00e0beac_caseD_e0b7b4:
    uVar16 = puVar38[4];
    if ((uVar16 >> 10 & 1) == 0) {
LAB_00e0b84c:
      puVar38[0x15] = 0;
      *puVar38 = 6;
switchD_00e0beac_caseD_e0b858:
      uVar12 = (uint)uVar36;
      uVar16 = (uint)uVar37;
...
switchD_00e0beac_caseD_e0b914:
        ...
        if ((*(byte *)((long)puVar38 + 0x11) >> 4 & 1) == 0) {
          ...
          if (bVar6 != 0) goto LAB_00e0c11c;
          uVar37 = (uVar37 & 0xffffffff) - uVar11;
        }
        *puVar38 = 8;
switchD_00e0beac_caseD_e0b9cc:
        if ((puVar38[4] >> 9 & 1) != 0) {
          if ((uint)uVar36 < 0x10) {
            uVar36 = uVar36 & 0xffffffff;
            do {
...
LAB_00e0c11c:
        ...
        iVar22 = local_7c;
        goto switchD_00e0beac_caseD_e0beec;
      }
    }
    else {
      uVar15 = puVar38[0x15];
...
LAB_00e0bee8:
  ...
  case 0xe0ae34:
    ...
    *puVar38 = 0xb;
    pbVar30 = pbVar31;
switchD_00e0beac_caseD_e0ae68:
    uVar32 = (uint)uVar37;
    if (param_2 - 5U < 2) goto LAB_00e0bee8;
switchD_00e0beac_caseD_e0ae74:
    uVar12 = (uint)uVar36;
    if (puVar38[1] == 0) {
      pbVar31 = pbVar30;
      if (uVar12 < 3) {
...
LAB_00e0af48:
        *puVar38 = uVar16;
        ...
        puVar38[0x1c] = 9;
        puVar38[0x1d] = 5;
        *(undefined **)(puVar38 + 0x1a) = &UNK_01974606;
        *(undefined **)(puVar38 + 0x18) = &UNK_01973e06;
        *puVar38 = 0x13;
        if (param_2 == 6) {
          uVar33 = uVar33 >> 3;
          uVar12 = uVar12 - 3;
    ...
    *puVar38 = 0x1a;
    ...
    goto LAB_00e0be9c;
  case 0xe0ae68:
    goto switchD_00e0beac_caseD_e0ae68;
  case 0xe0ae74:
    goto switchD_00e0beac_caseD_e0ae74;
  case 0xe0af64:
    ...
    if ((uVar33 & 0xffff) == (uVar33 >> 0x10 ^ 0xffff)) {
      ...
      *puVar38 = 0xe;
      if (param_2 != 6) goto switchD_00e0beac_caseD_e0afe4;
      goto LAB_00e0bee8;
    }
    pcVar14 = "invalid stored block lengths";
    break;
  case 0xe0afe4:
switchD_00e0beac_caseD_e0afe4:
    *puVar38 = 0xf;
  case 0xe0afec:
    uVar12 = (uint)uVar36;
    uVar32 = (uint)uVar37;
    ...
    if (uVar16 != 0) {
      ...
      iVar22 = local_7c;
      if (uVar16 == 0) goto switchD_00e0beac_caseD_e0beec;
      uVar11 = (ulong)uVar16;
...
LAB_00e0b11c:
      do {
        ...
        uVar12 = uVar15 + 1;
        uVar7 = *(ushort *)(&DAT_01973de0 + (ulong)uVar15 * 2);
        uVar9 = (ushort)uVar33;
        uVar33 = uVar33 >> 3;
        puVar38[0x21] = uVar12;
  ...
  case 0xe0b108:
    ...
    uVar16 = puVar38[0x1e];
    uVar15 = uVar12;
    if (uVar12 < uVar16) goto LAB_00e0b11c;
LAB_00e0b174:
    if (uVar12 < 0x13) {
      uVar11 = (ulong)uVar12;
      if (0x13 - uVar11 < 2) {
LAB_00e0b1e0:
        do {
          lVar34 = uVar11 * 2;
          uVar11 = uVar11 + 1;
          *(undefined2 *)((long)puVar38 + (ulong)*(ushort *)(&DAT_01973de0 + lVar34) * 2 + 0x90) = 0
          ;
        } while (uVar11 != 0x13);
      }
      else {
        ...
        if (lVar34 == 0) goto LAB_00e0b1e0;
        uVar19 = lVar34 + uVar11;
        puVar20 = (ushort *)(&DAT_01973de2 + uVar11 * 2);
        do {
          uVar7 = *puVar20;
          lVar34 = lVar34 + -2;
    ...
    *(uint **)(puVar38 + 0x18) = puVar1;
    puVar38[0x1c] = 7;
    local_7c = FUN_00e0c8b4(0,puVar38 + 0x24,0x13,puVar2,puVar38 + 0x1c,puVar3);
    if (local_7c == 0) {
      local_7c = 0;
      puVar38[0x21] = 0;
      *puVar38 = 0x12;
      ...
      do {
        while( true ) {
          ...
          *(ushort *)((long)puVar38 + uVar11 * 2 + 0x90) = uVar7;
          if (uVar12 <= uVar16) goto LAB_00e0b454;
        }
        if (uVar7 == 0x10) {
          if (uVar32 < iVar22 + 2U) {
            uVar36 = uVar36 & 0xffffffff;
...
LAB_00e0b428:
        uVar36 = (ulong)uVar32;
        if (uVar12 < uVar16 + iVar23) goto LAB_00e0b560;
        do {
          iVar23 = iVar23 + -1;
          uVar11 = (ulong)uVar16;
          uVar16 = uVar16 + 1;
...
LAB_00e0b454:
    ...
    if ((short)puVar38[0xa4] != 0) {
      ...
      *(uint **)(puVar38 + 0x18) = puVar1;
      puVar38[0x1c] = 9;
      local_7c = FUN_00e0c8b4(1,puVar38 + 0x24,uVar15,puVar2,puVar38 + 0x1c,puVar3);
      if (local_7c == 0) {
        puVar38[0x1d] = 6;
        *(undefined8 *)(puVar38 + 0x1a) = *(undefined8 *)(puVar38 + 0x22);
        local_7c = FUN_00e0c8b4(2,(long)puVar38 + (ulong)puVar38[0x1f] * 2 + 0x90,puVar38[0x20],
                                puVar2,puVar38 + 0x1d,puVar3);
        if (local_7c == 0) {
          local_7c = 0;
          *puVar38 = 0x13;
          if (param_2 != 6) goto switchD_00e0beac_caseD_e0baac;
          goto LAB_00e0bee8;
        }
  ...
  case 0xe0b56c:
    uVar16 = puVar38[0x17];
    if (uVar16 != 0) goto LAB_00e0b574;
    goto LAB_00e0bc54;
  case 0xe0b5d8:
    uVar16 = puVar38[0x17];
    if (uVar16 != 0) goto LAB_00e0bdd8;
    goto LAB_00e0be38;
  case 0xe0b5e4:
    if (uVar29 == 0) goto LAB_00e0bee8;
    uVar29 = uVar29 - 1;
...
LAB_00e0b6c8:
      *puVar38 = 0x1b;
      goto switchD_00e0beac_caseD_e0ba58;
    }
    if (uVar12 < 0x20) {
      uVar36 = uVar36 & 0xffffffff;
      do {
    ...
    *puVar38 = 0x1d;
    ...
    goto LAB_00e0be9c;
  case 0xe0b714:
    goto switchD_00e0beac_caseD_e0b714;
  case 0xe0b7b4:
    goto switchD_00e0beac_caseD_e0b7b4;
  case 0xe0b858:
    goto switchD_00e0beac_caseD_e0b858;
  case 0xe0b914:
    goto switchD_00e0beac_caseD_e0b914;
  case 0xe0b9cc:
    goto switchD_00e0beac_caseD_e0b9cc;
  case 0xe0ba58:
switchD_00e0beac_caseD_e0ba58:
    uVar12 = (uint)uVar36;
    uVar32 = (uint)uVar37;
    ...
    *puVar38 = 0x1c;
    ...
    goto switchD_00e0beac_caseD_e0beec;
  case 0xe0baac:
switchD_00e0beac_caseD_e0baac:
    *puVar38 = 0x14;
    pbVar31 = pbVar30;
  case 0xe0bab4:
    goto switchD_00e0beac_caseD_e0bab4;
  case 0xe0bcac:
    goto switchD_00e0beac_caseD_e0bcac;
  case 0xe0be50:
    goto switchD_00e0beac_caseD_e0be50;
  case 0xe0beb0:
    uVar16 = puVar38[2];
    if (uVar16 == 0) {
      *puVar38 = 0xc;
    ...
    if (((uVar16 & 1) != 0) &&
      ...
      if ((uVar33 & 0xf) != 8) goto LAB_00e0ac64;
...
switchD_00e0beac_caseD_e0be50:
  ...
  puVar17 = __dest_00;
  uVar12 = uVar16;
  if (uVar11 < 0x20) goto LAB_00e0aa14;
  uVar15 = uVar16 & 0x1f;
  lVar34 = uVar11 - uVar15;
  if (lVar34 == 0) goto LAB_00e0aa14;
  uVar35 = uVar29;
  if (uVar32 <= uVar29) {
    uVar35 = uVar32;
  }
  if ((__dest_00 < puVar24 + (ulong)(uVar35 - 1) + 1) &&
     (puVar24 < __dest_00 + (ulong)(uVar35 - 1) + 1)) goto LAB_00e0aa14;
