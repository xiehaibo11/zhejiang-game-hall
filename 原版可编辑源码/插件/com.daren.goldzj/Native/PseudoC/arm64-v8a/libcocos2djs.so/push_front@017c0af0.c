...
/* std::__ndk1::__split_buffer<v8::internal::interpreter::BytecodeRegisterOptimizer::RegisterInfo**,
   v8::internal::RecyclingZoneAllocator<v8::internal::interpreter::BytecodeRegisterOptimizer::RegisterInfo**>&>::push_front(v8::internal::interpreter::BytecodeRegisterOptimizer::RegisterInfo**
   const&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_017c0cd0;
  ...
  if (puVar6 != puVar1) {
    ...
    if ((3 < uVar3) && ((puVar6 + uVar10 + 1 <= __src || (puVar2 + uVar10 + uVar7 + 1 <= puVar6))))
    {
      ...
      puVar8 = __src + uVar10;
      if (uVar3 == uVar10) goto LAB_017c0c84;
    }
    do {
      puVar12 = puVar6 + 1;
      *puVar8 = *puVar6;
