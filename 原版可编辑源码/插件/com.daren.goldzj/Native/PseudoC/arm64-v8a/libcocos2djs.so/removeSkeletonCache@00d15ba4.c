...
/* spine::SkeletonCacheMgr::removeSkeletonCache(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

void __thiscall
spine::SkeletonCacheMgr::removeSkeletonCache(SkeletonCacheMgr *this,basic_string *param_1)
