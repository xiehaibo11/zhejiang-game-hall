...
/* js_cocos2dx_spine_Bone_setToSetupPoseRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_setToSetupPoseRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Bone *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x84b,"js_cocos2dx_spine_Bone_setToSetupPose");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_Bone_setToSetupPose : Invalid Native Object");
  }
  else {
    ...
    __android_log_print(6,"jswrapper",&DAT_018f792f,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_setToSetupPose",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x855);
LAB_00c20898:
