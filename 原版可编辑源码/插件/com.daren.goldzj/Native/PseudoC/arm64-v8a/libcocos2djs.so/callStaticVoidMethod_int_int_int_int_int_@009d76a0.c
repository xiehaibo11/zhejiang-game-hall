...

{
  ...
  puVar5[2] = 0;
  *puVar5 = 0;
                    /* catch() { ... } // from try @ 009d74d0 with catch @ 009d7740 */
  puVar5 = (ulong *)std::__ndk1::
                    basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
                    append((basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>
                            *)&local_80,")V",2);
                    /* catch() { ... } // from try @ 009d74f4 with catch @ 009d7744 */
  local_a0 = (char *)puVar5[2];
  uStack_a8 = puVar5[1];
  local_b0 = *puVar5;
  puVar5[1] = 0;
  puVar5[2] = 0;
                    /* try { // try from 009d7758 to 00ad77c7 has its CatchHandler @ 009d7758
                       catch() { ... } // from try @ 009d7758 with catch @ 009d7758
                       catch() { ... } // from try @ 009d781c with catch @ 009d7758 */
  *puVar5 = 0;
  ...
  if ((uVar6 & 1) == 0) {
    reportError(param_1,param_2,(basic_string *)&local_b0);
                    ...
                    /* try { // try from 009d77c8 to 00ad77d7 has its CatchHandler @ 009d7998 */
    uStack_78 = 0;
    local_80 = (void *)0x0;
    uStack_68 = 0;
    local_70 = (void *)0x0;
    local_60 = 0x3f800000;
                    /* try { // try from 009d77ec to 00ad781b has its CatchHandler @ 009d799c */
    ...
    while (puVar4 != (void *)0x0) {
      ...
      pvVar10 = (void *)*puVar4;
                    /* try { // try from 009d781c to 00ad79af has its CatchHandler @ 009d7758 */
      local_80 = pvVar3;
      if (pvVar7 != (void *)0x0) {
        puVar4[4] = pvVar7;
