...
/* v8::internal::StackTraceFrame::GetPromiseAllIndex(v8::internal::Handle<v8::internal::StackTraceFrame>)
    */

int v8::internal::StackTraceFrame::GetPromiseAllIndex(ulong *param_1)
