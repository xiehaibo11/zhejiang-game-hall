...
/* v8::internal::compiler::EffectControlLinearizer::LowerChangeInt64ToTagged(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerChangeInt64ToTagged
...

{
  ...
  pNVar3 = (Node *)GraphAssembler::Word64Equal(this_00,pNVar3,pNVar5);
  GraphAssembler::GotoIfNot<>(this_00,pNVar3,local_b8);
  pNVar2 = (Node *)GraphAssembler::Int32AddWithOverflow(this_00,pNVar2,pNVar2);
  ...
  *(undefined8 *)(this + 0x60) = 0;
  ...
  pNVar5 = (Node *)GraphAssembler::ChangeInt64ToFloat64(this_00,pNVar5);
