  ...
  if (uVar4 < 2) {
    ...
    if ((lVar11 != 0) && (local_58 == (SSL_SESSION *)0x0)) {
      lVar10 = *(long *)(param_1 + 0xb4);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00acdb00 with catch @ 00acdb4c
                        */
                    /* try { // try from 00acdb50 to 00bcdbc7 has its CatchHandler @ 00acdb50
                       catch(type#1 @ 00000000) { ... } // from try @ 00acdb50 with catch @ 00acdb50
                       catch(type#1 @ 00000000) { ... } // from try @ 00acdbcc with catch @ 00acdb50
                        */
      if ((*(byte *)(lVar10 + 0x41) & 1) == 0) {
        ...
        CRYPTO_THREAD_read_lock(*(undefined8 *)(lVar10 + 0x360));
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00acdbc8 with catch @ 00acdc34
                        */
        ...
        CRYPTO_THREAD_unlock(*(undefined8 *)(*(long *)(param_1 + 0xb4) + 0x360));
                    /* try { // try from 00acdc60 to 00bcdc63 has its CatchHandler @ 00acdc80 */
        pSVar9 = local_58;
        if (local_58 == (SSL_SESSION *)0x0) {
      ...
      bVar1 = true;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00acdc60 with catch @ 00acdc80
                        */
        ...
        if ((uVar4 == param_1[0x54]) &&
          ...
          if (*(long *)(pSVar9->krb5_client_princ + 0x48) == 0) {
            ...
            *(long *)(local_58->krb5_client_princ + 0x48) = lVar11;
            pSVar9 = local_58;
            if (lVar11 != 0) goto LAB_00acdd5c;
            bVar2 = 0;
            goto joined_r0x00acddec;
          }
LAB_00acdd5c:
          ...
          if (lVar11 < tVar6 - *(long *)(local_58->krb5_client_princ + 0x38)) {
            ...
            *(int *)(lVar11 + 0x84) = *(int *)(lVar11 + 0x84) + 1;
            if (bVar3) {
              FUN_00ace01c(lVar11,local_58,1);
            }
          }
          else {
            if ((local_58->krb5_client_princ[0xc0] & 1) != 0) {
              if (((uint)**(undefined8 **)(param_1 + 0x24) >> 9 & 1) != 0) goto LAB_00acddb8;
...
LAB_00acddb8:
      ...
      bVar3 = true;
      pSVar9 = local_58;
      if (*(code **)(*(long *)(param_1 + 0xb4) + 0x60) == (code *)0x0) goto LAB_00acdb04;
      local_44 = 1;
      local_58 = (SSL_SESSION *)
...
LAB_00acdcfc:
      ...
      if (((*(byte *)((long)&s->session_cache_mode + 1) >> 1 & 1) != 0) ||
         (iVar5 = SSL_CTX_add_session(s,local_58), iVar5 == 0)) goto LAB_00acdcfc;
    }
    bVar2 = 0;
  }
  else {
...
LAB_00acdbb0:
                    /* try { // try from 00acdbc8 to 00bcdbcb has its CatchHandler @ 00acdc34 */
                    /* try { // try from 00acdbcc to 00bcdc37 has its CatchHandler @ 00acdb50 */
  return -(uint)bVar2;
}
