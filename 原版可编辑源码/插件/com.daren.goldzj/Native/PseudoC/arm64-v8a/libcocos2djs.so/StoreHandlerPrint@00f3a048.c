...
/* v8::internal::StoreHandler::StoreHandlerPrint(std::__ndk1::basic_ostream<char,
   std::__ndk1::char_traits<char> >&) */

void __thiscall
v8::internal::StoreHandler::StoreHandlerPrint(StoreHandler *this,basic_ostream *param_1)

{
  ...
  HeapObject::PrintHeader((HeapObject *)this,param_1,"StoreHandler");
