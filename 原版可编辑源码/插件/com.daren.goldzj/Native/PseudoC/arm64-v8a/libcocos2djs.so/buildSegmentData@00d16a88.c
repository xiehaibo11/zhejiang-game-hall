...
/* spine::SkeletonCache::FrameData::buildSegmentData(unsigned long) */

void __thiscall spine::SkeletonCache::FrameData::buildSegmentData(FrameData *this,ulong param_1)

{
  ...
  *this_00;
  ...
  this_00 = (vector<spine::SkeletonCache::SegmentData*,std::__ndk1::allocator<spine::SkeletonCache::SegmentData*>>
             *)(this + 0x30);
  lVar3 = *(long *)this_00;
    ...
    if (uVar4 == param_1) {
      ...
      *(undefined8 *)(local_50 + 0x10) = 0;
      if (*(undefined8 **)(this + 0x40) == puVar5) {
        std::__ndk1::
        vector<spine::SkeletonCache::SegmentData*,std::__ndk1::allocator<spine::SkeletonCache::SegmentData*>>
        ::__push_back_slow_path<spine::SkeletonCache::SegmentData*const&>(this_00,&local_50);
      }
      else {
        *puVar5 = local_50;
