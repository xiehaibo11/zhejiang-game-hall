...
/* js_cocos2dx_spine_TrackEntry_setMixTimeRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_TrackEntry_setMixTimeRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TrackEntry *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x174,"js_cocos2dx_spine_TrackEntry_setMixTime");
    puVar6 = &DAT_018f17e4;
LAB_00c14394:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::TrackEntry::setMixTime(this,local_64);
        goto LAB_00c143cc;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x17b,"js_cocos2dx_spine_TrackEntry_setMixTime");
      puVar6 = &DAT_018f1824;
      goto LAB_00c14394;
    }
    __android_log_print(6,"jswrapper",&DAT_018f1869,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TrackEntry_setMixTime",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x182);
LAB_00c143cc:
