...
/* WARNING: Removing unreachable block (ram,0x017e4220) */
/* v8::internal::compiler::PropertyAccessInfo::NotFound(v8::internal::Zone*,
   v8::internal::Handle<v8::internal::Map>, v8::internal::MaybeHandle<v8::internal::JSObject>) */

void __thiscall
v8::internal::compiler::PropertyAccessInfo::NotFound
...

{
  ...
  *(undefined8 *)(param_1_00 + 0x16) = param_4;
