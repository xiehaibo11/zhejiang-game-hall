...
/* js_cocos2dx_spine_SkeletonRenderer_setAttachmentRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonRenderer_setAttachmentRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonRenderer *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x32d4,"js_cocos2dx_spine_SkeletonRenderer_setAttachment");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonRenderer_setAttachment : Invalid Native Object");
  }
  else {
...
joined_r0x00c7134c:
          ...
          bVar6 = spine::SkeletonRenderer::setAttachment(this,(basic_string *)&local_98,pcVar1);
          pVVar11 = (Value *)se::State::rval(aSStack_80);
          uVar10 = boolean_to_seval((bool)(bVar6 & 1),pVVar11);
          if ((uVar10 & 1) != 0) {
            iVar14 = 1;
            unaff_x22 = (ulong *)0x1;
            goto joined_r0x00c7134c;
          }
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                              ,0x32e1,"js_cocos2dx_spine_SkeletonRenderer_setAttachment");
          __android_log_print(6,"jswrapper",
                              "js_cocos2dx_spine_SkeletonRenderer_setAttachment : Error processing arguments"
                             );
          uVar13 = 0;
          unaff_x22 = (ulong *)0x0;
          iVar14 = 1;
      ...
      if (iVar14 == 4) {
        ...
        if ((uVar13 & uVar7) == 1) {
          ...
          if ((uVar10 & 1) == 0) {
            ...
            bVar6 = spine::SkeletonRenderer::setAttachment
            ...
            if ((uVar10 & 1) == 0) {
              __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                                  "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                                  ,0x32f0,"js_cocos2dx_spine_SkeletonRenderer_setAttachment");
              __android_log_print(6,"jswrapper",
                                  "js_cocos2dx_spine_SkeletonRenderer_setAttachment : Error processing arguments"
                                 );
              unaff_x22 = (ulong *)0x0;
        ...
        if (iVar14 == 8) goto LAB_00c71488;
      }
      if (((ulong)unaff_x22 & 1) != 0) goto LAB_00c714e8;
    }
    else {
LAB_00c71488:
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 13045): wrong number of arguments: %d\n"
                          ,(ulong)(lVar3 - lVar2) >> 4);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonRenderer_setAttachment",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x32f8);
LAB_00c714e8:
  pVVar11 = (Value *)se::State::rval(aSStack_80);
