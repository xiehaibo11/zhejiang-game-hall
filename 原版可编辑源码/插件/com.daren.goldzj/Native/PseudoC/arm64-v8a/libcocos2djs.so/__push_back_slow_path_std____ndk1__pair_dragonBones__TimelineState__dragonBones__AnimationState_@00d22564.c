...
/* void std::__ndk1::vector<std::__ndk1::pair<dragonBones::TimelineState*,
   dragonBones::AnimationState::BaseTimelineType>,
   std::__ndk1::allocator<std::__ndk1::pair<dragonBones::TimelineState*,
   dragonBones::AnimationState::BaseTimelineType> >
   >::__push_back_slow_path<std::__ndk1::pair<dragonBones::TimelineState*,
   dragonBones::AnimationState::BaseTimelineType> >(std::__ndk1::pair<dragonBones::TimelineState*,
   dragonBones::AnimationState::BaseTimelineType>&&) */
...
LAB_00d225c8:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 4) < 0x7ffffffffffffff) {
    ...
    if (uVar3 >> 0x3c != 0) goto LAB_00d225c8;
  }
  else {
