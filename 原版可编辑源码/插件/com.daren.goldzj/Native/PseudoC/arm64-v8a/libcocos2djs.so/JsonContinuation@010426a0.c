...
/* v8::internal::JsonParser<unsigned
   char>::JsonContinuation::JsonContinuation(v8::internal::Isolate*,
   v8::internal::JsonParser<unsigned char>::JsonContinuation::Type, unsigned long) */

void __thiscall
v8::internal::JsonParser<unsigned_char>::JsonContinuation::JsonContinuation
