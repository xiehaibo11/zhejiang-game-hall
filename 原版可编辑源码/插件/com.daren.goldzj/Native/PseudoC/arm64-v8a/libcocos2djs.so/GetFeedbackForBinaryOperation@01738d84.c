...
/* v8::internal::compiler::JSHeapBroker::GetFeedbackForBinaryOperation(v8::internal::compiler::FeedbackSource
   const&) */
...

{
  ...
  if (FLAG_concurrent_inlining == '\0') {
    piVar3 = (int *)ProcessFeedbackForBinaryOperation(this,param_1);
    iVar1 = *piVar3;
  }
  else {
    lVar2 = std::__ndk1::
