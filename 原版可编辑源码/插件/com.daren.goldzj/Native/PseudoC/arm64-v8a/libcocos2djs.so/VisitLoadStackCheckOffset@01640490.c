...
/* v8::internal::compiler::InstructionSelector::VisitLoadStackCheckOffset(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::InstructionSelector::VisitLoadStackCheckOffset
...

{
  ...
  *(ulong *)(*(long *)(this + 0xb8) + uVar2) =
  ...
  Instruction::Instruction
            (this_01,0x1f,1,(InstructionOperand *)&local_18,0,(InstructionOperand *)0x0,0,
