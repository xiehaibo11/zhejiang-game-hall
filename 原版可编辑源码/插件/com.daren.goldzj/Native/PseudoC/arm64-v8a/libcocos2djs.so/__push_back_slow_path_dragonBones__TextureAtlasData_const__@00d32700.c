...
/* void std::__ndk1::vector<dragonBones::TextureAtlasData*,
   std::__ndk1::allocator<dragonBones::TextureAtlasData*>
   >::__push_back_slow_path<dragonBones::TextureAtlasData* const&>(dragonBones::TextureAtlasData*
   const&) */
...
LAB_00d32764:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d32764;
  }
  else {
