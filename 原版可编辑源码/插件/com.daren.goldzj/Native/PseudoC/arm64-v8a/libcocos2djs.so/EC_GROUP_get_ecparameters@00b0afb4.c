    ...
    if (iVar5 != 0x197) {
      ...
      if (pBVar10 == (BIGNUM *)0x0) {
        ...
        if (iVar5 == 0) {
          ...
          puVar17[1] = pAVar11;
          if (pAVar11 != (ASN1_INTEGER *)0x0) goto LAB_00b0b088;
...
LAB_00b0b1f0:
    ...
    pAVar12 = ASN1_item_new((ASN1_ITEM *)&DAT_01c74e28);
    puVar17[1] = pAVar12;
...
LAB_00b0b1e8:
    ...
    if ((int)lVar16 == 0x15) {
      ...
      if ((int)lVar16 != 0x17) goto LAB_00b0b1d0;
      iVar5 = 0x2ab;
    }
    pAVar9 = OBJ_nid2obj(iVar5);
    *(ASN1_OBJECT **)(pAVar12 + 8) = pAVar9;
    ...
    pAVar14 = ASN1_item_new((ASN1_ITEM *)&DAT_01c74df0);
...
LAB_00b0b4a8:
      ...
      data_00 = local_78;
      if (0xe < uVar2) goto LAB_00b0b4a8;
LAB_00b0b498:
      local_80 = (uchar *)0x0;
      iVar6 = 1;
      data_01 = local_64;
