...
/* v8::internal::interpreter::BytecodeGenerator::VisitWithStatement(v8::internal::WithStatement*) */

void __thiscall
v8::internal::interpreter::BytecodeGenerator::VisitWithStatement
          (BytecodeGenerator *this,WithStatement *param_1)

{
  ...
  *(int *)(pBStack_50 + 0x118) = local_48;
  ...
  BuildNewLocalWithContext(this,*(Scope **)(param_1 + 8));
  VisitInScope(this,*(Statement **)(param_1 + 0x18),*(Scope **)(param_1 + 8));
