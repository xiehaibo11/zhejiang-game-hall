...
undefined8
FUN_010bbf6c(undefined8 param_1,undefined8 param_2,ulong *param_3,ulong *param_4,ulong param_5,
            ulong param_6)

{
  ...
  if ((*(uint *)((uVar1 & 0xffffffff00000000 | (ulong)*(uint *)(uVar1 + 0xb)) + 0x1b) >> 2 & 1) == 0
    ...
    if (((ABS(dVar3) < INFINITY) || (ABS(dVar3) != INFINITY)) &&
       ((dVar3 < -3.4028234663852886e+38 || (3.4028234663852886e+38 < dVar3)))) {
      return 1;
    }
    if (dVar3 == (double)(float)dVar3) {
      ...
      if (param_5 < uVar2) {
        do {
          if (*(float *)(*(long *)(uVar1 + 0x27) + (ulong)*(uint *)(uVar1 + 0x2f) + param_5 * 4) ==
              (float)dVar3) {
            return 1;
          }
          param_5 = param_5 + 1;
