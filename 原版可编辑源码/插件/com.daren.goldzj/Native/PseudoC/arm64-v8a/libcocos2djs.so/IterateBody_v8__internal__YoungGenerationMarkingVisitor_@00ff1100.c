...
/* void 
   v8::internal::Map::BodyDescriptor::IterateBody<v8::internal::YoungGenerationMarkingVisitor>(v8::internal::Map,
   v8::internal::HeapObject, int, v8::internal::YoungGenerationMarkingVisitor*) */

void v8::internal::Map::BodyDescriptor::IterateBody<v8::internal::YoungGenerationMarkingVisitor>
...

{
  ...
  puVar2 = (uint *)(param_2 + 0x23);
  if (puVar1 < puVar2) {
    uVar4 = *puVar1;
    do {
      if ((uVar4 & 1) != 0) {
        uVar11 = (ulong)puVar1 & 0xffffffff00000000 | (ulong)uVar4;
        uVar9 = (ulong)puVar1 & 0xffffffff00000000 | (ulong)uVar4 & 0xfffffffffffc0000;
        if ((*(byte *)(uVar9 + 8) & 0x18) != 0) {
          puVar3 = (uint *)(*(long *)(uVar9 + 0x108) + (uVar11 - uVar9 >> 7 & 0x1ffffff) * 4);
          while( true ) {
            uVar4 = *puVar3;
            uVar8 = (uint)(1L << (uVar11 - uVar9 >> 2 & 0x1f));
            ...
            while (*puVar3 == uVar4) {
              ...
              if (cVar5 == '\0') {
                ...
                puVar12 = (undefined8 *)(lVar14 + (long)*(int *)(param_4 + 0x10) * 0x50);
                puVar13 = (undefined8 *)*puVar12;
                lVar10 = puVar13[1];
                if (lVar10 == 0x40) {
                  base::Mutex::Lock((Mutex *)(lVar14 + 0x280));
                  *puVar13 = *(undefined8 *)(lVar14 + 0x2a8);
                  *(undefined8 **)(lVar14 + 0x2a8) = puVar13;
                  ...
                  *(ulong *)((long)pvVar7 + 0x10) = uVar11;
                }
                else {
                  puVar13[1] = lVar10 + 1;
                  puVar13[lVar10 + 2] = uVar11;
                }
                goto LAB_00ff11dc;
              }
            }
...
LAB_00ff11dc:
  ...
  if ((uVar4 != 3) && ((uVar4 & 1) != 0)) {
    ...
    if ((*(byte *)(uVar9 + 8) & 0x18) != 0) {
      uVar11 = (ulong)puVar2 & 0xffffffff00000000 | (ulong)uVar4 & 0xfffffffffffffffd;
      puVar1 = (uint *)(*(long *)(uVar9 + 0x108) + (uVar11 - uVar9 >> 7 & 0x1ffffff) * 4);
      while( true ) {
        uVar4 = *puVar1;
        uVar8 = (uint)(1L << (uVar11 - uVar9 >> 2 & 0x1f));
        if ((uVar8 & (uVar4 ^ 0xffffffff)) == 0) break;
