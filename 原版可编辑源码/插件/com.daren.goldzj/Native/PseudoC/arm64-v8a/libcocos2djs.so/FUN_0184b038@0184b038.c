...
void FUN_0184b038(long param_1,undefined8 *param_2)

{
  ...
  if (__n != 0) {
    ...
    if (uVar5 < (ulong)param_2[2]) {
      ...
      *param_2 = pvVar1;
      if (pvVar1 == (void *)0x0) goto LAB_0184b170;
      lVar3 = param_2[1];
    }
...
LAB_0184b170:
  ...
  *(undefined1 *)((long)pvVar2 + lVar3) = 0x20;
  ...
  if (*(char *)((long)plVar6 + 9) != '\x01') {
                    /* WARNING: Could not recover jumptable at 0x0184b16c. Too many branches */
