...
/* v8::internal::AstTraversalVisitor<v8::internal::AstFunctionLiteralIdReindexer>::VisitForOfStatement(v8::internal::ForOfStatement*)
    */

void v8::internal::AstTraversalVisitor<v8::internal::AstFunctionLiteralIdReindexer>::
     VisitForOfStatement(ForOfStatement *param_1)

{
  ...
  if (param_1[8] == (ForOfStatement)0x0) {
