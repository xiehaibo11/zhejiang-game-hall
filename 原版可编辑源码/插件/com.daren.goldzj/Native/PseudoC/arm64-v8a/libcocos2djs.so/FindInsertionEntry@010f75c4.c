...
/* v8::internal::HashTable<v8::internal::CompilationCacheTable,
   v8::internal::CompilationCacheShape>::FindInsertionEntry(unsigned int) */

ulong __thiscall
v8::internal::HashTable<v8::internal::CompilationCacheTable,v8::internal::CompilationCacheShape>::
FindInsertionEntry(HashTable<v8::internal::CompilationCacheTable,v8::internal::CompilationCacheShape>
                   *this,uint param_1)

{
  ...
  iVar7 = *(int *)(uVar6 + 7 + ((long)(uVar5 * 0xc00000000 + 0xc00000000) >> 0x20));
  ...
  if ((iVar7 != iVar1) && (iVar2 = *(int *)((uVar6 & 0xffffffff00000000) + 0xa0), iVar7 != iVar2)) {
    ...
    do {
      ...
      iVar3 = *(int *)(uVar6 + 7 + ((long)(uVar5 * 0xc00000000 + 0xc00000000) >> 0x20));
      if (iVar3 == iVar1) {
        return uVar5;
      }
      iVar7 = iVar7 + 1;
