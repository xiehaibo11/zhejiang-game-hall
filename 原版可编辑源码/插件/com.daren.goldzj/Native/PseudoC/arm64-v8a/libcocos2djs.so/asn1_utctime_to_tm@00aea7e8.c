...

{
  ...
  if (param_1 == (int *)0x0) {
    ...
    bVar2 = pbVar6[10];
    uVar8 = bVar2 - 0x2b;
    if ((uVar8 < 0x30) && ((1L << ((ulong)uVar8 & 0x3f) & 0x800000000005U) != 0)) goto LAB_00aeaac0;
                    /* try { // try from 00aeac18 to 00beac1f has its CatchHandler @ 00aead00 */
    if (9 < bVar2 - 0x30) {
      return false;
    }
    ...
    if (9 < pbVar6[4] - 0x30) {
      return false;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00aea770 with catch @ 00aea8bc
                        */
    if (9 < pbVar6[5] - 0x30) {
      return false;
    }
    iVar5 = (uint)pbVar6[5] + (uint)pbVar6[4] * 10;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00aea6c4 with catch @ 00aea8d0
                        */
    ...
    param_1[2] = iVar5 + -0x210;
                    /* try { // try from 00aea92c to 00beac17 has its CatchHandler @ 00aea92c
                       catch() { ... } // from try @ 00aea92c with catch @ 00aea92c
                       catch() { ... } // from try @ 00aeac9c with catch @ 00aea92c */
    if (9 < pbVar6[8] - 0x30) {
      return false;
    }
    if (9 < pbVar6[9] - 0x30) {
...
LAB_00aeaae4:
  ...
  if ((int)(uVar8 + 5) <= (int)uVar1) {
    ...
    uVar3 = bVar2 - 0x30;
    if (param_1 == (int *)0x0) {
                    /* try { // try from 00aeac8c to 00beac9b has its CatchHandler @ 00aeace4 */
                    /* try { // try from 00aeac9c to 00bead13 has its CatchHandler @ 00aea92c */
