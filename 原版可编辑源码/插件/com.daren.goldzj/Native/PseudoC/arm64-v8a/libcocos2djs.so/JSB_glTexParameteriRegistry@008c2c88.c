...
/* JSB_glTexParameteriRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glTexParameteriRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if ((plVar7[1] - *plVar7 & 0xffffffff0U) == 0x30) {
    ...
    uVar4 = seval_to_uint32((Value *)(*plVar7 + 0x10),&local_78);
    uVar5 = seval_to_int32((Value *)(*plVar7 + 0x20),&local_7c);
    if ((uVar3 & uVar4 & uVar5 & 1) == 0) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0x8a8,"JSB_glTexParameteri");
      __android_log_print(6,"jswrapper",&DAT_0190552e);
    }
    else {
      if ((local_74 == 0xde1) || (local_74 == 0x8513)) {
        if (local_78 >> 2 == 0xa00) {
          glTexParameteri(local_74,local_78,local_7c);
          goto LAB_008c2ed0;
        }
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                            ,0x8ad,"JSB_glTexParameteri");
      }
      else {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                            ,0x8aa,"JSB_glTexParameteri");
      }
      DAT_01d36f40 = 0x500;
    }
  }
