...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned long,
   ...
   cocos2d::renderer::DeviceGraphics::Uniform> > >::__rehash(unsigned long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<unsigned_long,cocos2d::renderer::DeviceGraphics::Uniform>,std::__ndk1::__unordered_map_hasher<unsigned_long,std::__ndk1::__hash_value_type<unsigned_long,cocos2d::renderer::DeviceGraphics::Uniform>,std::__ndk1::hash<unsigned_long>,true>,std::__ndk1::__unordered_map_equal<unsigned_long,std::__ndk1::__hash_value_type<unsigned_long,cocos2d::renderer::DeviceGraphics::Uniform>,std::__ndk1::equal_to<unsigned_long>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<unsigned_long,cocos2d::renderer::DeviceGraphics::Uniform>>>
           *this,ulong param_1)
...
joined_r0x009b5ba4:
      if (plVar7 != (long *)0x0) {
        do {
          ...
          if ((uVar6 & param_1) == 0) {
            uVar8 = uVar8 & uVar6;
            if (uVar8 != uVar4) goto LAB_009b5be8;
LAB_009b5bac:
            plVar10 = (long *)*plVar7;
            plVar5 = plVar7;
          }
            ...
            if (uVar8 == uVar4) goto LAB_009b5bac;
LAB_009b5be8:
            plVar10 = plVar7;
            if (*(long *)(*(long *)this + uVar8 * 8) == 0) goto LAB_009b5c44;
            do {
              plVar9 = plVar10;
              plVar10 = (long *)*plVar9;
          ...
          if (plVar7 == (long *)0x0) {
            return;
                    ...
                    /* try { // try from 009b5c5c to 00ab5cdf has its CatchHandler @ 009b59c8 */
  return;
LAB_009b5c44:
