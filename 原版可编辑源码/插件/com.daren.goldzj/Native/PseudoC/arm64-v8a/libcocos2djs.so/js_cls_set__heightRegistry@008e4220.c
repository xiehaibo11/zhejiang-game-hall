...
/* js_cls_set__heightRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_cls_set__heightRegistry(undefined8 param_1,undefined8 param_2,long *param_3)

{
  ...
  if (this == (CanvasRenderingContext2D *)0x0) {
    ...
    if (uVar6 == 0x10) {
      ...
      if ((uVar6 & 1) != 0) {
        cocos2d::CanvasRenderingContext2D::set__height(this,local_74);
        goto LAB_008e4418;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_cocos2dx_manual.cpp"
      ...
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_cocos2dx_manual.cpp, 403): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar6 >> 4,1);
    }
  }
