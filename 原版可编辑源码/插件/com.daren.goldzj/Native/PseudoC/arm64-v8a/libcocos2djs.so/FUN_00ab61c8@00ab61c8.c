...
undefined4 FUN_00ab61c8(long param_1,long *param_2,void *param_3,size_t param_4)
      ...
      *(undefined8 *)(param_1 + 0x60) = 0;
      ...
      if (lVar10 != lVar8) {
        do {
          ...
          iVar5 = FUN_00ab61c8(param_1,param_2,param_3,uVar7);
          if (iVar5 != 0) {
            return 0x11;
          }
LAB_00ab63cc:
  ...
  *param_2 = 0;
  ...
  if (uVar7 < 10) {
    ...
    memcpy(param_3,&UNK_018a1ce0 + uVar7,__n);
    param_4 = param_4 - __n;
...
LAB_00ab62d0:
  ...
  uVar9 = (ulong)*(uint *)(param_1 + 0x44);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ab64dc with catch @ 00ab6528
                        */
  if (uVar7 < uVar9 + 10) {
    return 0;
  }
...
LAB_00ab64e0:
  *(long *)(param_1 + 0x18) = lVar6;
                    /* try { // try from 00ab64e8 to 00bb6543 has its CatchHandler @ 00ab64b0 */
  return 0;
}
