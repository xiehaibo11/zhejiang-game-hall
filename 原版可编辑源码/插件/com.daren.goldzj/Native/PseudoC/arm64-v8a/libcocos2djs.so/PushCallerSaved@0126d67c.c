...
/* v8::internal::TurboAssembler::PushCallerSaved(v8::internal::SaveFPRegsMode,
   v8::internal::Register) */

int v8::internal::TurboAssembler::PushCallerSaved
...

{
  ...
  PushCPURegList(param_1,local_40,uStack_38);
  iVar1 = CountSetBits(local_40,0x40);
  iVar1 = iVar1 * 8;
  if (param_2 == 1) {
    auVar4 = CPURegList::GetCallerSavedV(0x40);
    PushCPURegList(param_1,auVar4._0_8_,auVar4._8_8_);
