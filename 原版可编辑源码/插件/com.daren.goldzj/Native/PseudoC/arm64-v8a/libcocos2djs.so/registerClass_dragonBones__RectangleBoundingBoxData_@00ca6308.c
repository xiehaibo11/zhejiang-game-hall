...
/* void JSBClassType::registerClass<dragonBones::RectangleBoundingBoxData>(se::Class*) */

void JSBClassType::registerClass<dragonBones::RectangleBoundingBoxData>(Class *param_1)
