...
undefined8 FUN_00bcac6c(undefined8 param_1,uchar *param_2,uchar *param_3,ulong param_4)

{
  ...
  if (param_4 >> 0x3e != 0) {
    ...
    do {
      ...
      DES_xcbc_encrypt(param_3,output,0x4000000000000000,pDVar4,pauVar5,
                       (const_DES_cblock *)(lVar6 + 0x80),(const_DES_cblock *)(lVar7 + 0x88),iVar3);
  ...
  if (param_4 != 0) {
    ...
    lVar6 = EVP_CIPHER_CTX_get_cipher_data(param_1);
    iVar3 = EVP_CIPHER_CTX_encrypting(param_1);
    DES_xcbc_encrypt(param_3,param_2,param_4,pDVar4,pauVar5,(const_DES_cblock *)(lVar8 + 0x80),
                     (const_DES_cblock *)(lVar6 + 0x88),iVar3);
  }
  return 1;
}
