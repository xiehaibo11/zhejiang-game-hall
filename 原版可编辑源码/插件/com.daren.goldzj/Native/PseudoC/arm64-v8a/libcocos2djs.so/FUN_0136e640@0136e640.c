...
long FUN_0136e640(undefined8 param_1,long param_2,long param_3)
    ...
    if (lVar6 == 0) {
      ...
      if (uVar1 < **(ulong **)(unaff_x26 + 0x1430)) {
        ...
        **(ulong **)(unaff_x26 + 0x1428) = uVar1;
        ...
        lVar4 = FUN_01348560(param_1,0x18);
      }
      ...
      *(int *)(lVar4 + 0x1b) = ((int)in_stack_00000000 >> 1) * 2;
      bVar3 = false;
    }
