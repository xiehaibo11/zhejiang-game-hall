...

{
  ...
  FUN_0184fee4(auStack_e00,&stack0x00000000);
  memcpy(auStack_a40,auStack_e00,0x3c0);
  do {
    iVar2 = FUN_0184f300(auStack_a40,auStack_680);
    if ((iVar2 == 5) || (iVar2 != 0)) goto LAB_018503e8;
    if (local_30 != (code *)0x0) {
      ...
      if (iVar2 == 6) {
        ...
        memcpy(auStack_a40,auStack_e00,0x3c0);
        iVar2 = FUN_0185000c(param_1,auStack_a40);
        if (iVar2 == 7) {
          FUN_0184ebb8(auStack_e00,auStack_a40);
          FUN_018502ac(local_730,local_728);
        }
LAB_018503e8:
