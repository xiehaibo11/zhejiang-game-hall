...
/* std::__ndk1::__hash_table<std::__ndk1::pair<v8::internal::compiler::WasmImportCallKind,
   ...
   v8::internal::Signature<v8::internal::wasm::ValueType>*> >
   >::remove(std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::pair<v8::internal::compiler::WasmImportCallKind,
   v8::internal::Signature<v8::internal::wasm::ValueType>*>, void*>*>) */
...

{
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar7 == uVar4) goto LAB_015fb3e8;
  }
  if (*param_3 != 0) {
