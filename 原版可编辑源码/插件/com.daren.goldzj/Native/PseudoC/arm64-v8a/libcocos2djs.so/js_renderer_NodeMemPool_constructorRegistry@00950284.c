...
/* js_renderer_NodeMemPool_constructorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_NodeMemPool_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Object *)
         se::Object::_createJSObject
                   (__jsb_cocos2d_renderer_NodeMemPool_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_cocos2d_renderer_NodeMemPool_finalizeRegistry);
  se::State::State(aSStack_60,this,(vector *)&local_a0);
                    /* try { // try from 00950324 to 00a5032b has its CatchHandler @ 009505b0 */
  this_00 = operator_new(0x50,(nothrow_t *)&std::nothrow);
  if (this_00 != (NodeMemPool *)0x0) {
    cocos2d::renderer::NodeMemPool::NodeMemPool(this_00);
  }
  ...
  se::Value::Value(aVStack_70);
                    /* try { // try from 0095036c to 00a50373 has its CatchHandler @ 009505ac */
