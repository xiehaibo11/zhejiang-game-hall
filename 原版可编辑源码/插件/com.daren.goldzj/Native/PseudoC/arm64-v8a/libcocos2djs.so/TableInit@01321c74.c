...
/* v8::internal::compiler::WasmGraphBuilder::TableInit(unsigned int, unsigned int,
   v8::internal::compiler::Node*, v8::internal::compiler::Node*, v8::internal::compiler::Node*, int)
    */

void v8::internal::compiler::WasmGraphBuilder::TableInit
...

{
  ...
  uVar3 = BuildCallToRuntimeWithContext
                    (this,0x1d3,uVar3,&local_70,5,*(undefined8 *)(this + 0x20),
