...
/* v8::internal::Runtime_PushWithContext(int, unsigned long*, v8::internal::Isolate*) */

undefined8 v8::internal::Runtime_PushWithContext(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar7 = FUN_0158e4ec(param_1,param_2,param_3);
    return uVar7;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar6 & 1) != 0) &&
    ...
    if (((uVar6 & 1) != 0) &&
      ...
      puVar5 = (undefined8 *)Factory::NewWithContext((Factory *)param_3,puVar4,param_2 + -1,param_2)
      ;
