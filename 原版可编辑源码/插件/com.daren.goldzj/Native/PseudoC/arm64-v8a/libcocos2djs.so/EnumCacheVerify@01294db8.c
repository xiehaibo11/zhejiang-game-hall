...
/* v8::internal::TorqueGeneratedClassVerifiers::EnumCacheVerify(v8::internal::EnumCache,
   v8::internal::Isolate*) */

void v8::internal::TorqueGeneratedClassVerifiers::EnumCacheVerify(ulong param_1,undefined8 param_2)

{
  ...
  if (*(short *)(uVar3 + *(uint *)(local_38 - 1)) != 0x5c) {
                    /* WARNING: Subroutine does not return */
    V8_Fatal("Check failed: %s.","o.IsEnumCache()");
  }
  ...
  if (((uVar1 & 1) != 0) && (*(ushort *)(uVar3 + *(uint *)(uVar2 - 1)) - 0x76 < 0xf)) {
    ...
    if (((uVar1 & 1) != 0) && (*(ushort *)((uVar2 | 7) + (ulong)*(uint *)(uVar3 - 1)) - 0x76 < 0xf))
    {
      return;
                    ...
                    /* WARNING: Subroutine does not return */
    V8_Fatal("Check failed: %s.","indices__value.IsFixedArray()");
  }
                    /* WARNING: Subroutine does not return */
  V8_Fatal("Check failed: %s.","keys__value.IsFixedArray()");
}
