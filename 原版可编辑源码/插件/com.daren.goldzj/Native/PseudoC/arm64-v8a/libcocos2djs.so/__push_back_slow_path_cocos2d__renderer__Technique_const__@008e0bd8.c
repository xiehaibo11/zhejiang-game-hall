...
/* void std::__ndk1::vector<cocos2d::renderer::Technique*,
   std::__ndk1::allocator<cocos2d::renderer::Technique*>
   >::__push_back_slow_path<cocos2d::renderer::Technique* const&>(cocos2d::renderer::Technique*
   const&) */
