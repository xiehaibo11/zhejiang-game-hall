...
/* void 
   v8::internal::WasmInstanceObject::BodyDescriptor::IterateBody<v8::internal::PointersUpdatingVisitor>(v8::internal::Map,
   v8::internal::HeapObject, int, v8::internal::PointersUpdatingVisitor*) */

void v8::internal::WasmInstanceObject::BodyDescriptor::
     IterateBody<v8::internal::PointersUpdatingVisitor>
...

{
  ...
  if (iVar1 < (int)lVar2) {
    ...
    lVar2 = 0xc4;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00feb9f4. Too many branches */
