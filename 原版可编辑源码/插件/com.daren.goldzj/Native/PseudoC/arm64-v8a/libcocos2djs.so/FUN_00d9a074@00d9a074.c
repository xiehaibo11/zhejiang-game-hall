...
void FUN_00d9a074(long *param_1,int param_2)
    ...
    if (param_2 == 0) {
      ...
      do {
        ...
        if ((*(int *)((long)param_1 + 0x1cc) == 0) && (*(int *)((long)param_1 + 0x1d4) == 0)) {
          ...
          FUN_00d9cdc4(param_1,1,lVar6,lVar10 + lVar6 * 8 + 0x40);
        ...
        if (iVar2 != 0) {
          ...
          FUN_00d9cdc4(param_1,0,lVar11,lVar10 + lVar11 * 8 + 0x60);
        }
        lVar9 = lVar9 + 1;
