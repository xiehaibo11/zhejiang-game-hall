...
/* v8::internal::compiler::JSHeapBroker::ProcessFeedbackForArrayOrObjectLiteral(v8::internal::compiler::FeedbackSource
   const&) */

undefined8 __thiscall
v8::internal::compiler::JSHeapBroker::ProcessFeedbackForArrayOrObjectLiteral
...

{
  ...
  *this_00;
  ...
  if (lVar2 == 0) {
    uVar3 = ReadFeedbackForArrayOrObjectLiteral(this,param_1);
