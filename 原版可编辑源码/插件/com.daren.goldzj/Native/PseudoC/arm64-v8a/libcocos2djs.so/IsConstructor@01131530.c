...
/* v8::internal::StackTraceFrame::IsConstructor(v8::internal::Handle<v8::internal::StackTraceFrame>)
    */

byte v8::internal::StackTraceFrame::IsConstructor(ulong *param_1)
