...
undefined8 FUN_010a851c(undefined8 param_1,ulong *param_2,uint param_3,ulong param_4)

{
  ...
  local_38 = *param_2;
  if (((*(uint *)((local_38 & 0xffffffff00000000 | (ulong)*(uint *)(local_38 - 1)) + 0xb) >> 0x14 &
       1) != 0) ||
     (uVar3 = v8::internal::JSObject::WouldConvertToSlowElements((JSObject *)&local_38,param_3),
     (uVar3 & 1) != 0)) {
    return 0;
  }
  pIVar4 = (Isolate *)(*param_2 & 0xffffffff00000000);
  uVar3 = (ulong)pIVar4 | (ulong)*(uint *)(*param_2 + 7);
  ...
  auVar12 = FUN_010a9be4(param_2,puVar5);
  uVar6 = auVar12._0_8_;
