...
void FUN_00dfef9c(byte *param_1,byte *param_2,byte *param_3,byte *param_4,uint param_5)

{
  ...
  pbVar36 = param_2;
  if ((param_5 & 0x3ffffffe) == 0) goto LAB_00dff5fc;
...
LAB_00dff440:
    do {
      ...
      uVar44 = (uVar45 + ((uint)*pbVar37 * 0x6625 >> 8)) - 0x379a;
      if (uVar44 >> 0xe == 0) {
      ...
      uVar44 = ((uVar45 + 0x2204) - ((uint)bVar75 * 0x1913 >> 8)) - ((uint)*pbVar37 * 0x3408 >> 8);
      *pbVar35 = bVar43;
      if (uVar44 >> 0xe == 0) {
        bVar43 = (byte)(uVar44 >> 6);
      }
      ...
      uVar44 = (uVar45 + ((uint)bVar75 * 0x811a >> 8)) - 0x4515;
      pbVar35[1] = bVar43;
      if (uVar44 >> 0xe == 0) {
    ...
    if ((param_4 < param_1 + (uVar40 >> 2) + 2 && param_1 < pbVar34) ||
       ((param_4 < param_2 + lVar2 && param_2 < pbVar34 ||
        (param_4 < param_3 + lVar2 && param_3 < pbVar34)))) goto LAB_00dff440;
    pbVar35 = param_2;
    pbVar37 = param_4;
    pbVar38 = param_3;
    uVar42 = uVar41;
    ...
    do {
      ...
      pbVar37[0x22] = bVar6 ^ (bVar6 ^ (byte)(uVar99 >> 6)) & -(uVar99 < 0x4000);
      pbVar37[0x23] = 0xff;
      pbVar37[0x24] = bVar8 ^ (bVar8 ^ (byte)(uVar68 >> 6)) & -(uVar68 < 0x4000);
      pbVar37[0x25] = bVar10 ^ (bVar10 ^ (byte)(uVar53 >> 6)) & -(uVar53 < 0x4000);
      pbVar37[0x26] = bVar15 ^ (bVar15 ^ -(char)((int)uVar126 >> 0x1f) - 1U) & -(0x3fff < uVar126);
      pbVar37[0x27] = 0xff;
      pbVar37[0x28] = bVar82 ^ (bVar82 ^ (byte)(uVar47 >> 6)) & -(uVar47 < 0x4000);
      pbVar37[0x29] = bVar78 ^ (bVar78 ^ (byte)(uVar122 >> 6)) & -(uVar122 < 0x4000);
      pbVar37[0x2a] = bVar79 ^ (bVar79 ^ (byte)(uVar101 >> 6)) & -(uVar101 < 0x4000);
      pbVar37[0x2b] = 0xff;
      pbVar37[0x2c] = bVar83 ^ (bVar83 ^ (byte)(uVar70 >> 6)) & -(uVar70 < 0x4000);
      pbVar37[0x2d] = bVar81 ^ (bVar81 ^ (byte)(uVar55 >> 6)) & -(uVar55 < 0x4000);
      pbVar37[0x2e] = bVar16 ^ (bVar16 ^ 0xffU - (char)((int)uVar128 >> 0x1f)) & -(0x3fff < uVar128)
      ;
      pbVar37[0x2f] = 0xff;
      *(ulong *)(pbVar37 + 0x38) =
           CONCAT17(0xff,CONCAT16(bVar18 ^ (bVar18 ^ 0xffU - (char)((int)uVar132 >> 0x1f)) &
                                           -(0x3fff < uVar132),
                                  CONCAT15(bVar95 ^ (bVar95 ^ (byte)(uVar57 >> 6)) &
                                                    -(uVar57 < 0x4000),
                                           CONCAT14(bVar97 ^ (bVar97 ^ (byte)(uVar74 >> 6)) &
                                                             -(uVar74 < 0x4000),
                                                    (int)CONCAT53(0xffffffffff,
                                                                  CONCAT12(bVar93 ^ (bVar93 ^ (byte)
                                                  (uVar103 >> 6)) & -(uVar103 < 0x4000),
                                                  CONCAT11(bVar92 ^ (bVar92 ^ (byte)(uVar124 >> 6))
                                                                    & -(uVar124 < 0x4000),
                                                           bVar96 ^ (bVar96 ^ (byte)(uVar51 >> 6)) &
                                                                    -(uVar51 < 0x4000))))))));
      *(ulong *)(pbVar37 + 0x30) =
           CONCAT17(0xff,CONCAT16(bVar17 ^ (bVar17 ^ 0xffU - (char)((int)uVar130 >> 0x1f)) &
                                           -(0x3fff < uVar130),
                                  CONCAT15(bVar88 ^ (bVar88 ^ (byte)(uVar56 >> 6)) &
                                                    -(uVar56 < 0x4000),
                                           CONCAT14(bVar90 ^ (bVar90 ^ (byte)(uVar72 >> 6)) &
                                                             -(uVar72 < 0x4000),
                                                    (int)CONCAT53(0xff000000ff,
                                                                  CONCAT12(bVar86 ^ (bVar86 ^ (byte)
                                                  (uVar102 >> 6)) & -(uVar102 < 0x4000),
                                                  CONCAT11(bVar85 ^ (bVar85 ^ (byte)(uVar123 >> 6))
                                                                    & -(uVar123 < 0x4000),
                                                           bVar89 ^ (bVar89 ^ (byte)(uVar49 >> 6)) &
                                                                    -(uVar49 < 0x4000))))))));
      *(ulong *)(pbVar37 + 8) =
           CONCAT17(0xff,CONCAT16(bVar12 ^ (bVar12 ^ 0xffU - (char)((int)uVar65 >> 0x1f)) &
                                           -(0x3fff < uVar65),
                                  CONCAT15(bVar107 ^ (bVar107 ^ (byte)(uVar118 >> 6)) &
                                                     -(uVar118 < 0x4000),
                                           CONCAT14(bVar80 ^ (bVar80 ^ (byte)(uVar60 >> 6)) &
                                                             -(uVar60 < 0x4000),
                                                    (int)CONCAT53(0xffffffffff,
                                                                  CONCAT12(bVar106 ^ (bVar106 ^
                                                                                     (byte)(uVar48 
                                                  >> 6)) & -(uVar48 < 0x4000),
                                                  CONCAT11(bVar69 ^ (bVar69 ^ (byte)(uVar127 >> 6))
                                                                    & -(uVar127 < 0x4000),
                                                           bVar108 ^ (bVar108 ^ (byte)(uVar84 >> 6))
                                                                     & -(uVar84 < 0x4000))))))));
      *(ulong *)pbVar37 =
           CONCAT17(0xff,CONCAT16(bVar11 ^ (bVar11 ^ -(char)((int)uVar63 >> 0x1f) - 1U) &
                                           -(0x3fff < uVar63),
                                  CONCAT15(bVar9 ^ (bVar9 ^ (byte)(uVar115 >> 6)) &
                                                   -(uVar115 < 0x4000),
                                           CONCAT14(bVar7 ^ (bVar7 ^ (byte)(uVar58 >> 6)) &
                                                            -(uVar58 < 0x4000),
                                                    (int)CONCAT53(0xff000000ff,
                                                  ...
                                                  CONCAT11(bVar3 ^ (bVar3 ^ (byte)(uVar125 >> 6)) &
                                                                   -(uVar125 < 0x4000),
                                                           bVar75 ^ (bVar75 ^ (byte)(uVar76 >> 6)) &
                                                                    -(uVar76 < 0x4000))))))));
      *(ulong *)(pbVar37 + 0x18) =
           CONCAT17(0xff,CONCAT16(bVar14 ^ (bVar14 ^ 0xffU - (char)((int)uVar67 >> 0x1f)) &
                                           -(0x3fff < uVar67),
                                  CONCAT15(bVar113 ^ (bVar113 ^ (byte)(uVar120 >> 6)) &
                                                     -(uVar120 < 0x4000),
                                           CONCAT14(bVar94 ^ (bVar94 ^ (byte)(uVar62 >> 6)) &
                                                             -(uVar62 < 0x4000),
                                                    (int)CONCAT53(0xffffffffff,
                                                                  CONCAT12(bVar112 ^ (bVar112 ^
                                                                                     (byte)(uVar52 
                                                  >> 6)) & -(uVar52 < 0x4000),
                                                  CONCAT11(bVar73 ^ (bVar73 ^ (byte)(uVar131 >> 6))
                                                                    & -(uVar131 < 0x4000),
                                                           bVar114 ^ (bVar114 ^ (byte)(uVar98 >> 6))
                                                                     & -(uVar98 < 0x4000))))))));
      *(ulong *)(pbVar37 + 0x10) =
           CONCAT17(0xff,CONCAT16(bVar13 ^ (bVar13 ^ 0xffU - (char)((int)uVar66 >> 0x1f)) &
                                           -(0x3fff < uVar66),
                                  CONCAT15(bVar110 ^ (bVar110 ^ (byte)(uVar119 >> 6)) &
                                                     -(uVar119 < 0x4000),
                                           CONCAT14(bVar87 ^ (bVar87 ^ (byte)(uVar61 >> 6)) &
                                                             -(uVar61 < 0x4000),
                                                    (int)CONCAT53(0xff000000ff,
                                                                  CONCAT12(bVar109 ^ (bVar109 ^
                                                                                     (byte)(uVar50 
                                                  >> 6)) & -(uVar50 < 0x4000),
                                                  CONCAT11(bVar71 ^ (bVar71 ^ (byte)(uVar129 >> 6))
                                                                    & -(uVar129 < 0x4000),
                                                           bVar111 ^ (bVar111 ^ (byte)(uVar91 >> 6))
                                                                     & -(uVar91 < 0x4000))))))));
      pbVar35 = pbVar35 + 8;
    ...
    if (uVar1 != uVar41) goto LAB_00dff440;
  }
...
LAB_00dff5fc:
  if ((param_5 & 1) != 0) {
    ...
    uVar44 = (uVar45 + ((uint)*param_3 * 0x6625 >> 8)) - 0x379a;
    if (uVar44 >> 0xe == 0) {
      bVar43 = (byte)(uVar44 >> 6);
    }
    else {
    ...
    uVar44 = ((uVar45 + 0x2204) - ((uint)bVar75 * 0x1913 >> 8)) - ((uint)*param_3 * 0x3408 >> 8);
    *param_4 = bVar43;
    if (uVar44 >> 0xe == 0) {
      bVar43 = (byte)(uVar44 >> 6);
    }
