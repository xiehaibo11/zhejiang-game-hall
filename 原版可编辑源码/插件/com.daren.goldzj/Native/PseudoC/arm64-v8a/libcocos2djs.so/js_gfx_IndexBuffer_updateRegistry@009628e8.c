...
/* js_gfx_IndexBuffer_updateRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_gfx_IndexBuffer_updateRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (IndexBuffer *)se::State::nativeThisObject(aSStack_60);
  if (this == (IndexBuffer *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x219,"js_gfx_IndexBuffer_update");
    ...
    if (uVar6 == 0x20) {
      ...
      if ((uVar6 & 1) == 0) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp"
                            ,0x220,"js_gfx_IndexBuffer_update");
        ...
        if ((uVar6 & 1) == 0) {
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp"
                              ,0x233,"js_gfx_IndexBuffer_update");
          ...
          if ((uVar6 & 1) != 0) {
            cocos2d::renderer::IndexBuffer::update(this,local_64,puStack_70,local_78);
            goto LAB_00962bb8;
          }
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp"
                              ,0x22e,"js_gfx_IndexBuffer_update");
        ...
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp"
                            ,0x238,"js_gfx_IndexBuffer_update");
        __android_log_print(6,"jswrapper","arg1 isn\'t an object!");
      }
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp, 574): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar6 >> 4,5);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_gfx_IndexBuffer_update",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp"
                      ,0x241);
LAB_00962bb8:
