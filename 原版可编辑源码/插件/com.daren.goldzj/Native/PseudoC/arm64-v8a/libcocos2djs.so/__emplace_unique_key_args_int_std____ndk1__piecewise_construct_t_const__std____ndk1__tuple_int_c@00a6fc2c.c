...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<int,
   cocos2d::AudioEngine::AudioInfo>, void*>*>, bool>
  ...
  if (uVar9 != 0) {
    ...
    if ((uVar4 & uVar9) == 0) {
      unaff_x24 = uVar4 & uVar10;
                    ...
                    /* try { // try from 00a6fc60 to 00b6fc77 has its CatchHandler @ 00a6fdec */
      unaff_x24 = uVar10;
      if (uVar9 <= uVar10) {
        uVar7 = 0;
        if (uVar9 != 0) {
        ...
        unaff_x24 = uVar10 - uVar7 * uVar9;
                    ...
                    /* try { // try from 00a6fc80 to 00b6fc8b has its CatchHandler @ 00a6fde8 */
    plVar8 = *(long **)(*(long *)param_1 + unaff_x24 * 8);
    if (plVar8 != (long *)0x0) {
      do {
                    /* try { // try from 00a6fc8c to 00b6fc97 has its CatchHandler @ 00a6fde4 */
        plVar8 = (long *)*plVar8;
        if (plVar8 == (long *)0x0) goto LAB_00a6fce0;
        uVar7 = plVar8[1];
                    /* try { // try from 00a6fc98 to 00b6fd6f has its CatchHandler @ 00a6fdfc */
        if (uVar7 != uVar10) {
          if ((uVar4 & uVar9) == 0) {
            uVar7 = uVar7 & uVar4;
          }
            ...
            if (uVar7 - uVar2 * uVar9 == unaff_x24) goto LAB_00a6fccc;
            goto LAB_00a6fce0;
          }
          if (uVar7 != unaff_x24) goto LAB_00a6fce0;
        }
LAB_00a6fccc:
  ...
  if ((uVar9 == 0) || ((float)param_1[8] * (float)uVar9 < (float)(*(long *)(param_1 + 6) + 1))) {
    ...
    if (uVar9 <= uVar4) {
      uVar9 = uVar4;
                    ...
                    /* try { // try from 00a6fd70 to 00b6fe53 has its CatchHandler @ 00a6fc0c */
    ...
    *(long **)(lVar6 + unaff_x24 * 8) = plVar5;
    if (*plVar8 != 0) {
      uVar10 = *(ulong *)(*plVar8 + 8);
                    /* catch() { ... } // from try @ 00a6fc8c with catch @ 00a6fde4 */
      if ((uVar9 - 1 & uVar9) == 0) {
                    /* catch() { ... } // from try @ 00a6fc98 with catch @ 00a6fdfc */
        uVar10 = uVar10 & uVar9 - 1;
      }
      else {
                    /* catch() { ... } // from try @ 00a6fc80 with catch @ 00a6fde8 */
                    /* catch() { ... } // from try @ 00a6fc60 with catch @ 00a6fdec */
        if (uVar9 <= uVar10) {
          uVar4 = 0;
          if (uVar9 != 0) {
            uVar4 = uVar10 / uVar9;
