...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<void*,unsigned_long>,std::__ndk1::__unordered_map_hasher<void*,std::__ndk1::__hash_value_type<void*,unsigned_long>,std::__ndk1::hash<void*>,true>,std::__ndk1::__unordered_map_equal<void*,std::__ndk1::__hash_value_type<void*,unsigned_long>,std::__ndk1::equal_to<void*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<void*,unsigned_long>>>
           *this,ulong param_1)
