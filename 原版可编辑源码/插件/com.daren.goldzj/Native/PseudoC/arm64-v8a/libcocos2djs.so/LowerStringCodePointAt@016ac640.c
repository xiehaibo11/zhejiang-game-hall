...
/* v8::internal::compiler::EffectControlLinearizer::LowerStringCodePointAt(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerStringCodePointAt
...

{
  ...
  Builtins::CallableFor((Builtins *)local_98,*(undefined8 *)(*(long *)this + 0x168),0x2e);
  local_80 = (Node *)&PTR__CallInterfaceDescriptor_01ca0fc8;
  piStack_78 = local_88;
  pCVar3 = (CallDescriptor *)
           Linkage::GetStubCallDescriptor
                     (*(undefined8 *)**(undefined8 **)this,&local_80,local_88[2] - *local_88,0,0x30,
                      0);
