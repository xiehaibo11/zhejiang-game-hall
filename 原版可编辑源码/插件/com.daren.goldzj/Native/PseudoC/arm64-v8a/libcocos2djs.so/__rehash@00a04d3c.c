...
joined_r0x00a04dec:
      if (plVar7 != (long *)0x0) {
        do {
          ...
          if ((uVar6 & param_1) == 0) {
            uVar8 = uVar8 & uVar6;
            if (uVar8 != uVar4) goto LAB_00a04e30;
LAB_00a04df4:
            plVar10 = (long *)*plVar7;
            plVar5 = plVar7;
          }
            ...
            if (uVar8 == uVar4) goto LAB_00a04df4;
LAB_00a04e30:
            plVar10 = plVar7;
            if (*(long *)(*(long *)this + uVar8 * 8) == 0) goto LAB_00a04e8c;
            do {
              plVar9 = plVar10;
              plVar10 = (long *)*plVar9;
          ...
          if (plVar7 == (long *)0x0) {
            return;
                    ...
                    /* catch() { ... } // from try @ 00a04fd0 with catch @ 00a04ea4 */
  return;
LAB_00a04e8c:
