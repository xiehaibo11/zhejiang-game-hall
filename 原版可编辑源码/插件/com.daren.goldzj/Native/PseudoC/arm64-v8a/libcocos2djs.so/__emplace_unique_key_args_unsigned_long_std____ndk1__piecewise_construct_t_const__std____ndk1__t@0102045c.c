...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<unsigned
   long, std::__ndk1::vector<unsigned long, std::__ndk1::allocator<unsigned long> > >, void*>*>,
   bool> std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned long,
   ...
   long, std::__ndk1::allocator<unsigned long> > > > >::__emplace_unique_key_args<unsigned long,
      ...
      for (puVar6 = (ulong *)*plVar5; puVar6 != (ulong *)0x0; puVar6 = (ulong *)*puVar6) {
        ...
        if (uVar4 != uVar8) {
          if (uVar2 < 2) {
            ...
            if (uVar4 - uVar1 * uVar7 == unaff_x24) goto LAB_010204e8;
            break;
          }
