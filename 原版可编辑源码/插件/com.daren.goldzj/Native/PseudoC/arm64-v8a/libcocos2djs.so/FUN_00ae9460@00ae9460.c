...
uint FUN_00ae9460(code *param_1,undefined8 param_2,X509_NAME *param_3,uint param_4,ulong param_5)

{
  ...
  if (0 < (int)param_4) {
    iVar18 = 0;
    do {
      iVar6 = (*param_1)(param_2,&DAT_019afa78,1);
      if (iVar6 == 0) {
        return 0xffffffff;
      }
      iVar18 = iVar18 + 1;
  ...
  if (0 < iVar7) {
    ...
    do {
      ...
      if (iVar9 != -1) {
        ...
        if (iVar9 == iVar8) {
          iVar9 = (*param_1)(param_2,pcVar20,iVar6);
          if (iVar9 == 0) {
            return 0xffffffff;
          }
          uVar15 = uVar15 + iVar6;
          ...
          iVar9 = (*param_1)(param_2,pcVar21,iVar18);
          if (iVar9 == 0) {
            return 0xffffffff;
          }
          if (uVar17 != 0) {
            iVar9 = 0;
            do {
              iVar8 = (*param_1)(param_2,&DAT_019afa78,1);
              if (iVar8 == 0) {
                return 0xffffffff;
              }
              iVar9 = iVar9 + 1;
      ...
      if (uVar1 != 0x600000) {
        if ((uVar1 == 0x400000) || (iVar8 == 0)) {
          ...
          __s = OBJ_nid2ln(iVar8);
                    /* try { // try from 00ae970c to 00be9713 has its CatchHandler @ 00ae9794 */
          iVar12 = 0x19;
        }
        ...
        if (((uVar16 >> 0x19 & 1) != 0) && (iVar5 = iVar12 - iVar10, iVar5 != 0 && iVar10 <= iVar12)
          ...
          if (0 < iVar5) {
            iVar12 = 0;
            do {
              iVar11 = (*param_1)(param_2,&DAT_019afa78,1);
              if (iVar11 == 0) {
                return 0xffffffff;
              }
              iVar12 = iVar12 + 1;
          ...
          uVar15 = iVar5 + uVar15;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ae970c with catch @ 00ae9794
                        */
      ...
      if (iVar8 == 0 && (param_5 & 0x1000000) != 0) {
        uVar3 = 0x80;
                    ...
                    /* catch() { ... } // from try @ 00ae9820 with catch @ 00ae97bc */
      iVar8 = FUN_00ae9950(param_1,param_2,uVar3 | param_5,pAVar13);
      if (iVar8 < 0) {
        return 0xffffffff;
      }
      iVar19 = iVar19 + 1;
      uVar15 = iVar8 + uVar15;
                    ...
                    /* try { // try from 00ae9810 to 00be981f has its CatchHandler @ 00ae9850 */
  return uVar15;
}
