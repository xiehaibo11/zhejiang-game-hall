...
/* unsigned int v8::internal::StringHasher::HashSequentialString<unsigned char>(unsigned char
   const*, int, unsigned long) */

uint v8::internal::StringHasher::HashSequentialString<unsigned_char>
               (uchar *param_1,int param_2,ulong param_3)

{
  ...
  uVar2 = (uint)param_3;
  if (param_2 < 1) {
    if (param_2 == 0) goto LAB_00ed1804;
    uVar5 = (ulong)param_2;
  }
  else {
    uVar3 = *param_1 - 0x30;
