...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitLdaImmutableCurrentContextSlot(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::VisitLdaImmutableCurrentContextSlot
...

{
  ...
  local_8 = 0;
  ProcessContextAccess(this,*(long *)(this + 0x28) + 0x28,uVar2,0,1,&local_8);
