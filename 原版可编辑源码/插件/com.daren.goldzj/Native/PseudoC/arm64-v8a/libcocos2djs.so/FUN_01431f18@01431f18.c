...
void FUN_01431f18(long param_1,undefined8 param_2,undefined8 param_3,long param_4,undefined8 param_5
...

{
  ...
  *(int *)(param_4 + -0x20) = (int)unaff_x19 * 2;
  ...
  (**(code **)(unaff_x21 + (ulong)*(byte *)(*(long *)(param_4 + -0x18) + unaff_x19 + 3) * 8))(uVar2)
  ;
  return;
}
