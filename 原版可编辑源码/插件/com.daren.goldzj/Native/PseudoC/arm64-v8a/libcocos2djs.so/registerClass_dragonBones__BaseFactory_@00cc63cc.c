...
/* void JSBClassType::registerClass<dragonBones::BaseFactory>(se::Class*) */

void JSBClassType::registerClass<dragonBones::BaseFactory>(Class *param_1)
