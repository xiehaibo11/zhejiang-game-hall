...

{
  ...
  long local_68;
                    ...
                    /* catch() { ... } // from try @ 00a75240 with catch @ 00a753b8 */
                    /* catch() { ... } // from try @ 00a75210 with catch @ 00a753bc */
                    /* catch() { ... } // from try @ 00a75204 with catch @ 00a753c0 */
                    /* catch() { ... } // from try @ 00a751e4 with catch @ 00a753c4 */
                    /* catch() { ... } // from try @ 00a7524c with catch @ 00a753d4
                       catch() { ... } // from try @ 00a75328 with catch @ 00a753d4 */
  lVar5 = tpidr_el0;
  local_68 = *(long *)(lVar5 + 0x28);
                    /* catch() { ... } // from try @ 00a7521c with catch @ 00a753ec
                       catch() { ... } // from try @ 00a75298 with catch @ 00a753ec */
  ...
  if (uVar13 != 0) {
    ...
    plVar8 = *(long **)(*(long *)this + uVar15 * 8);
                    /* try { // try from 00a75444 to 00b7549f has its CatchHandler @ 00a75444
                       catch() { ... } // from try @ 00a75444 with catch @ 00a75444
                       catch() { ... } // from try @ 00a757d0 with catch @ 00a75444 */
    if (plVar8 != (long *)0x0) {
      plVar8 = (long *)*plVar8;
      if (plVar8 != (long *)0x0) {
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (sVar1 == __n) {
              __s1 = (void *)plVar8[4];
                    /* try { // try from 00a754a0 to 00b754b7 has its CatchHandler @ 00a757ec */
              if ((bVar3 & 1) == 0) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                pbVar12 = pbVar2;
                    /* try { // try from 00a754c0 to 00b754cb has its CatchHandler @ 00a757e4 */
                while (*pbVar10 == *pbVar12) {
                  pbVar10 = pbVar10 + 1;
                    /* try { // try from 00a754cc to 00b754d7 has its CatchHandler @ 00a757e0 */
                  lVar11 = lVar11 + 1;
                  pbVar12 = pbVar12 + 1;
                  if (lVar11 == 0) goto LAB_00a75530;
                }
              }
            ...
            if ((uVar14 & uVar13) == 0) {
              ...
              if (uVar9 - uVar4 * uVar13 == uVar15) goto LAB_00a75508;
              goto LAB_00a7552c;
            }
            if (uVar9 != uVar15) goto LAB_00a7552c;
          }
LAB_00a75508:
                    /* try { // try from 00a75508 to 00b75523 has its CatchHandler @ 00a757dc */
          plVar8 = (long *)*plVar8;
...
LAB_00a75530:
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* try { // try from 00a75544 to 00b75563 has its CatchHandler @ 00a7583c */
    return plVar8;
  }
