...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitCreateWithContext() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitCreateWithContext(BytecodeGraphBuilder *this)

{
  ...
  ObjectRef::ObjectRef(aOStack_48,uVar8,uVar3,0);
  ...
  pOVar5 = (Operator *)JSOperatorBuilder::CreateWithContext(this_00,(Handle *)&local_38);
  local_38 = pNVar2;
