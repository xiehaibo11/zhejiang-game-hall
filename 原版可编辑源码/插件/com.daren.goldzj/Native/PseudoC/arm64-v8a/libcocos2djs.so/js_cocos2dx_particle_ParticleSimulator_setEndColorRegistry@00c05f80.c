...
/* js_cocos2dx_particle_ParticleSimulator_setEndColorRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_particle_ParticleSimulator_setEndColorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x16f,"js_cocos2dx_particle_ParticleSimulator_setEndColor");
    pcVar10 = "js_cocos2dx_particle_ParticleSimulator_setEndColor : Invalid Native Object";
LAB_00c06154:
    ...
    if (uVar11 == 0x40) {
      ...
      {
        *(uchar *)(lVar4 + 0x104) = local_84[0];
        *(uchar *)(lVar4 + 0x105) = local_88[0];
        *(uchar *)(lVar4 + 0x106) = local_8c[0];
        *(uchar *)(lVar4 + 0x107) = local_90[0];
        goto LAB_00c0618c;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                          ,0x17c,"js_cocos2dx_particle_ParticleSimulator_setEndColor");
      pcVar10 = "js_cocos2dx_particle_ParticleSimulator_setEndColor : Error processing arguments";
      goto LAB_00c06154;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp, 384): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar11 >> 4,4);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_particle_ParticleSimulator_setEndColor",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                      ,0x183);
LAB_00c0618c:
