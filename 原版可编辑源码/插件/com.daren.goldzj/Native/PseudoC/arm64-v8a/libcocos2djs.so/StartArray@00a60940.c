...

{
  ...
  puVar3 = puVar9 + 2;
  if (puVar1 < puVar3) {
                    /* try { // try from 00a609b0 to 00b60b9f has its CatchHandler @ 00a60c44 */
  ...
  *puVar9 = 0;
                    /* try { // try from 00a60978 to 00b6098f has its CatchHandler @ 00a60c34 */
  *(undefined1 *)(puVar9 + 1) = 1;
  ...
  plVar10[3] = (long)puVar6;
                    /* try { // try from 00a60998 to 00b609a3 has its CatchHandler @ 00a60c30 */
  *puVar4 = 0x5b;
                    /* try { // try from 00a609a4 to 00b609af has its CatchHandler @ 00a60c2c */
  return 1;
}
