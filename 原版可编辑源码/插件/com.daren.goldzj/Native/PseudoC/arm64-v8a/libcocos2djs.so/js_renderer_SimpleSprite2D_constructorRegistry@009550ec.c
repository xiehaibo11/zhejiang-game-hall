...
/* js_renderer_SimpleSprite2D_constructorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_SimpleSprite2D_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Object *)
         se::Object::_createJSObject
                   (__jsb_cocos2d_renderer_SimpleSprite2D_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_cocos2d_renderer_SimpleSprite2D_finalizeRegistry);
  se::State::State(aSStack_60,this,(vector *)&local_a0);
  this_00 = operator_new(0xa8,(nothrow_t *)&std::nothrow);
  if (this_00 != (SimpleSprite2D *)0x0) {
    cocos2d::renderer::SimpleSprite2D::SimpleSprite2D(this_00);
  }
