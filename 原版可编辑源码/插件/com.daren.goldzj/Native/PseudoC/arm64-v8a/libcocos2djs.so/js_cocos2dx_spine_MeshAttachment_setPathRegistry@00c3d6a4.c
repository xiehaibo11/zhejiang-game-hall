...
/* js_cocos2dx_spine_MeshAttachment_setPathRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_MeshAttachment_setPathRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (MeshAttachment *)se::State::nativeThisObject(aSStack_70);
  if (this == (MeshAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                        ,0x185f,"js_cocos2dx_spine_MeshAttachment_setPath");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_MeshAttachment_setPath : Invalid Native Object");
  }
  else {
    ...
    if (plVar5[1] - *plVar5 == 0x10) {
      ...
      spine::MeshAttachment::setPath(this,(String *)&local_88);
      pvVar4 = local_78;
      local_88 = &PTR__String_01c67868;
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 6250): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar5[1] - *plVar5) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_MeshAttachment_setPath",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x186d);
LAB_00c3d8cc:
