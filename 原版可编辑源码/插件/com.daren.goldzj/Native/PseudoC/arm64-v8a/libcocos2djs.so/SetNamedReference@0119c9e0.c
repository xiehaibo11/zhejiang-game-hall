...
/* v8::internal::HeapEntry::SetNamedReference(v8::internal::HeapGraphEdge::Type, char const*,
   v8::internal::HeapEntry*) */

void __thiscall
v8::internal::HeapEntry::SetNamedReference
          (HeapEntry *this,uint param_2,undefined8 param_3,undefined8 param_4)
