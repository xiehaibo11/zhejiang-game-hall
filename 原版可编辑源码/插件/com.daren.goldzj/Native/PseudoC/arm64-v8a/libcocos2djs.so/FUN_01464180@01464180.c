...
void FUN_01464180(ulong param_1)

{
  ...
  do {
    ...
    if ((param_1 & 1) == 0) {
      ...
      uVar12 = uVar13;
LAB_01464328:
      iVar16 = iVar16 << (ulong)(iVar6 * 2 >> 1 & 0x1f);
      if (SCARRY4(iVar16,iVar16)) {
        ...
        *(double *)(uVar7 + 3) = (double)iVar16;
      }
      else {
        uVar7 = (ulong)(iVar16 * 2);
        unaff_x29 = lVar5;
        lVar8 = lVar9;
        lVar11 = lVar10;
        uVar13 = uVar12;
      ...
      if ((uVar13 == 0) &&
        ...
        *(undefined4 *)(lVar8 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0146439c. Too many branches */
