...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitStaNamedOwnProperty(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::VisitStaNamedOwnProperty
...

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    ProcessNamedPropertyAccess(this,lVar6,local_48,uVar2,2);
    return;
  }
                    /* WARNING: Subroutine does not return */
