...

{
  ...
  undefined8 uVar13;
                    ...
                    /* try { // try from 009f1c24 to 00af1c2f has its CatchHandler @ 009f2060 */
                    /* try { // try from 009f1c30 to 00af1c43 has its CatchHandler @ 009f2050 */
  ...
  if ((ulong)(lVar5 * -0x5555555555555555) < 0x2aaaaaaaaaaaaaa) {
                    /* try { // try from 009f1c80 to 00af1c93 has its CatchHandler @ 009f20b4 */
    ...
    if (uVar11 == 0) {
      ...
      goto LAB_009f1c9c;
                    ...
                    /* try { // try from 009f1c94 to 00af1ce3 has its CatchHandler @ 009f1b08 */
...
LAB_009f1c9c:
  ...
  *(undefined8 *)param_2 = 0;
  ...
  pvVar8 = *(void **)(this + 8);
  puVar2 = puVar7 + 6;
                    /* try { // try from 009f1ce4 to 00af1cf7 has its CatchHandler @ 009f20b0 */
  pvVar10 = pvVar9;
  if (pvVar8 != pvVar9) {
    do {
      ...
      puVar7[-4] = *(undefined8 *)((long)pvVar8 + -0x20);
                    /* try { // try from 009f1cf8 to 00af1f43 has its CatchHandler @ 009f1b08 */
      puVar7[-5] = uVar13;
      puVar7[-6] = uVar12;
