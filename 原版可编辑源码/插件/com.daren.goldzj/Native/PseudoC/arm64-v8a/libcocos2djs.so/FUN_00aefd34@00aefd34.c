...
void FUN_00aefd34(ASN1_VALUE **param_1,ASN1_ITEM *param_2,int param_3)
      ...
      do {
        ...
        if (tt != (ASN1_TEMPLATE *)0x0) {
          ppAVar2 = asn1_get_field_ptr(param_1,tt);
                    /* try { // try from 00aefe20 to 00befe27 has its CatchHandler @ 00af04d0 */
  ...
  case '\x04':
    ...
    if (*(code **)((long)pvVar3 + 0x10) == (code *)0x0) {
      return;
                    ...
                    /* try { // try from 00aeff64 to 00beff6b has its CatchHandler @ 00af04cc */
                    /* WARNING: Could not recover jumptable at 0x00aeff74. Too many branches */
