...
/* js_cocos2dx_spine_SkeletonData_findSlotIndexRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_SkeletonData_findSlotIndexRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2955,"js_cocos2dx_spine_SkeletonData_findSlotIndex");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonData_findSlotIndex : Invalid Native Object");
  }
  else {
    ...
    if (plVar7[1] - *plVar7 == 0x10) {
      ...
      iVar5 = spine::SkeletonData::findSlotIndex(this,(String *)&local_88);
      ...
      if (bVar2) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                            ,0x295f,"js_cocos2dx_spine_SkeletonData_findSlotIndex");
        __android_log_print(6,"jswrapper",
                            "js_cocos2dx_spine_SkeletonData_findSlotIndex : Error processing arguments"
                           );
      }
      pvVar6 = local_78;
      local_88 = &PTR__String_01c67868;
      ...
      if (!bVar2) goto LAB_00c5fe7c;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 10594): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar7[1] - *plVar7) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonData_findSlotIndex",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x2965);
LAB_00c5fe7c:
  pVVar8 = (Value *)se::State::rval(aSStack_70);
