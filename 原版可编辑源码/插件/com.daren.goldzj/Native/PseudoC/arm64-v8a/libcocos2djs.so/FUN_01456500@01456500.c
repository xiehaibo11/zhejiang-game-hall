...
void FUN_01456500(undefined8 param_1,undefined8 param_2,undefined8 param_3,int param_4,
...

{
  ...
  *(int *)(lVar1 + 7) = param_4;
                    /* WARNING: Could not recover jumptable at 0x014565cc. Too many branches */
