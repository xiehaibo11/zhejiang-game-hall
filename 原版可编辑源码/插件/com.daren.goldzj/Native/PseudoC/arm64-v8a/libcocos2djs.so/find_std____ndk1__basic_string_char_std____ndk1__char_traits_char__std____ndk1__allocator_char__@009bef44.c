...

{
  ...
  local_68 = *(long *)(lVar5 + 0x28);
                    /* catch() { ... } // from try @ 009bed9c with catch @ 009bef78 */
                    /* catch() { ... } // from try @ 009bed90 with catch @ 009bef7c */
  uVar7 = *(ulong *)(param_1 + 8);
  pbVar2 = *(basic_string **)(param_1 + 0x10);
                    /* catch() { ... } // from try @ 009bed70 with catch @ 009bef80 */
  if (((byte)*param_1 & 1) == 0) {
    pbVar2 = param_1 + 1;
    uVar7 = (ulong)((byte)*param_1 >> 1);
  }
                    /* catch() { ... } // from try @ 009beda8 with catch @ 009bef90 */
  ...
  if (uVar13 != 0) {
    ...
    if (plVar8 != (long *)0x0) {
      plVar8 = (long *)*plVar8;
      if (plVar8 != (long *)0x0) {
                    /* try { // try from 009befe8 to 00abf03b has its CatchHandler @ 009befe8
                       catch() { ... } // from try @ 009befe8 with catch @ 009befe8
                       catch() { ... } // from try @ 009bf1d4 with catch @ 009befe8 */
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (sVar1 == __n) {
              ...
              if ((bVar3 & 1) == 0) {
                if (__n == 0) break;
                    /* try { // try from 009bf03c to 00abf053 has its CatchHandler @ 009bf250 */
                pbVar10 = (basic_string *)((long)plVar8 + 0x11);
                lVar11 = -(ulong)(bVar3 >> 1);
                pbVar12 = pbVar2;
                while (*pbVar10 == *pbVar12) {
                  pbVar10 = pbVar10 + 1;
                    /* try { // try from 009bf05c to 00abf067 has its CatchHandler @ 009bf24c */
                  lVar11 = lVar11 + 1;
                  pbVar12 = pbVar12 + 1;
                  if (lVar11 == 0) goto LAB_009bf0c0;
                }
              }
            ...
            if ((uVar14 & uVar13) == 0) {
              uVar9 = uVar9 & uVar14;
                    ...
                    /* try { // try from 009bf074 to 00abf1d3 has its CatchHandler @ 009bf260 */
              if (uVar13 <= uVar9) {
                uVar4 = 0;
                if (uVar13 != 0) {
                  uVar4 = uVar9 / uVar13;
                }
                if (uVar9 - uVar4 * uVar13 == uVar15) goto LAB_009bf098;
                goto LAB_009bf0bc;
              }
            }
            if (uVar9 != uVar15) goto LAB_009bf0bc;
          }
LAB_009bf098:
          plVar8 = (long *)*plVar8;
