...
/* js_universe_Device_showIosAppCommentRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_universe_Device_showIosAppCommentRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar4[1] - *plVar4 == 0) {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp, 1264): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_universe_Device_showIosAppComment",
