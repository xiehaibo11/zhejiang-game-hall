...
/* js_cocos2dx_particle_ParticleSimulator_setStartColorRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_particle_ParticleSimulator_setStartColorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x125,"js_cocos2dx_particle_ParticleSimulator_setStartColor");
    pcVar10 = "js_cocos2dx_particle_ParticleSimulator_setStartColor : Invalid Native Object";
LAB_00c058b0:
    ...
    if (uVar11 == 0x40) {
      ...
      {
        *(uchar *)(lVar4 + 0xfc) = local_84[0];
        *(uchar *)(lVar4 + 0xfd) = local_88[0];
        *(uchar *)(lVar4 + 0xfe) = local_8c[0];
        *(uchar *)(lVar4 + 0xff) = local_90[0];
        goto LAB_00c058e8;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                          ,0x132,"js_cocos2dx_particle_ParticleSimulator_setStartColor");
      pcVar10 = "js_cocos2dx_particle_ParticleSimulator_setStartColor : Error processing arguments";
      goto LAB_00c058b0;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp, 310): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar11 >> 4,4);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_particle_ParticleSimulator_setStartColor",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                      ,0x139);
LAB_00c058e8:
