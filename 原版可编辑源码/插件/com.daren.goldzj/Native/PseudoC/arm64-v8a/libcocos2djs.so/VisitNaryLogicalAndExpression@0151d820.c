...
/* v8::internal::interpreter::BytecodeGenerator::VisitNaryLogicalAndExpression(v8::internal::NaryOperation*)
    */

void __thiscall
v8::internal::interpreter::BytecodeGenerator::VisitNaryLogicalAndExpression
...

{
  ...
  if ((this_00 != (BlockCoverageBuilder *)0x0) &&
    ...
    uVar11 = 1;
    if (this_00 == (BlockCoverageBuilder *)0x0) goto LAB_0151d88c;
    do {
...
LAB_0151d8e4:
  ...
  if (*(int *)(lVar10 + 0x18) == 3) {
    uVar11 = Expression::ToBooleanIsFalse(this_01);
    if ((uVar11 & 1) == 0) {
      VisitNaryLogicalTest(this,0x21,param_1,&local_b0);
    }
    else {
      pBVar5 = (BytecodeLabel *)BytecodeLabels::New(*(BytecodeLabels **)(lVar10 + 0x30));
    ...
    *(undefined1 *)(lVar10 + 0x20) = 1;
    ...
    local_88 = local_90;
    uVar11 = VisitLogicalAndSubExpression(this,this_01,(BytecodeLabels *)&local_90,iVar4);
    if ((uVar11 & 1) == 0) {
      lVar10 = 0;
      uVar11 = 0;
      do {
        ...
        uVar8 = VisitLogicalAndSubExpression
