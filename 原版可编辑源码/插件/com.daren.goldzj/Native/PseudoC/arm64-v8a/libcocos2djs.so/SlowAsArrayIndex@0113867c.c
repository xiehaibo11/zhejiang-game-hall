...
bool __thiscall v8::internal::String::SlowAsArrayIndex(String *this,uint *param_1)

{
  ...
  if (*(int *)(uVar4 + 7) < 8) {
    ...
    if ((*puVar5 >> 1 & 1) == 0) {
      bVar3 = true;
      *param_1 = *puVar5 >> 3 & 0xffffff;
      goto LAB_01138880;
    }
  }
  else if (*(int *)(uVar4 + 7) < 0xb) {
    local_194 = 0;
    local_190[0x20] = 0;
    local_190[0x1d] = 0;
    local_190[0x1c] = 0;
...
LAB_0113874c:
    ...
    case 0:
      goto switchD_01138774_caseD_0;
    case 1:
    case 9:
      local_190[0x21] = local_190[0x21] & 0xffffffff00000000;
      if ((int)uVar4 == 0) goto switchD_011387f8_caseD_1;
      local_80 = 0;
      ...
      iVar6 = local_194;
      if ((int)uVar4 == 0) goto LAB_01138870;
      iVar1 = *(int *)(uVar4 + 7);
      iVar7 = local_194;
      goto LAB_011387d0;
    case 2:
    ...
    case 0xb:
      ...
      goto switchD_01138774_caseD_5;
    default:
      goto switchD_01138774_caseD_4;
    case 5:
    case 0xd:
      goto switchD_01138774_caseD_5;
    case 8:
  ...
  bVar3 = false;
  goto LAB_01138880;
switchD_01138774_caseD_5:
  uVar4 = uVar4 & 0xffffffff00000000 | (ulong)*(uint *)(uVar4 + 0xb);
  goto LAB_0113874c;
LAB_011387d0:
  switch(*(ushort *)((uVar4 & 0xffffffff00000000 | (ulong)*(uint *)(uVar4 - 1)) + 7) & 0xf) {
  case 0:
    goto switchD_011387f8_caseD_0;
  case 1:
  case 9:
    goto switchD_011387f8_caseD_1;
  case 2:
    local_70 = (**(code **)(**(long **)(uVar4 + 0xb) + 0x30))();
  ...
  goto switchD_011387f8_caseD_1;
switchD_011387f8_caseD_5:
  uVar4 = uVar4 & 0xffffffff00000000 | (ulong)*(uint *)(uVar4 + 0xb);
  goto LAB_011387d0;
switchD_01138774_caseD_0:
...
LAB_01138870:
  local_190[0x21] = local_190[0x21] & 0xffffffff00000000;
  goto switchD_011387f8_caseD_1;
switchD_01138774_caseD_4:
                    /* WARNING: Subroutine does not return */
  V8_Fatal("unreachable code");
switchD_011387f8_caseD_0:
  local_70 = uVar4 + (long)iVar7 * 2 + 0xb;
LAB_011388d8:
  local_78 = 0;
  lStack_68 = local_70 + (long)(iVar1 - iVar6) * 2;
switchD_011387f8_caseD_1:
  bVar3 = StringToIndex<v8::internal::StringCharacterStream,unsigned_int,(v8::internal::ToIndexMode)0>
