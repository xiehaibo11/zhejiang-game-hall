...
/* v8::internal::compiler::JSHeapBroker::ProcessFeedbackForCompareOperation(v8::internal::compiler::FeedbackSource
   const&) */

undefined4 * __thiscall
v8::internal::compiler::JSHeapBroker::ProcessFeedbackForCompareOperation
...

{
  ...
  *this_00;
  ...
  if (lVar4 == 0) {
    ...
    cVar2 = FeedbackNexus::GetCompareOperationFeedback((FeedbackNexus *)&local_60);
