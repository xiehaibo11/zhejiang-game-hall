...

{
  ...
  if (ctx->method == (SSL_METHOD *)0x0) {
    ...
    goto LAB_00ac5f04;
                    ...
                    /* try { // try from 00ac5be0 to 00bc5be7 has its CatchHandler @ 00ac5c5c */
                    /* try { // try from 00ac5be8 to 00bc5cab has its CatchHandler @ 00ac59a0 */
    ...
    if (p_Var7 != (_func_3151 *)0x0) {
      ...
      *(uint *)&s->info_callback = uVar3;
      ...
      uVar15 = *(undefined8 *)ctx->sid_ctx;
                    /* catch() { ... } // from try @ 00ac5aec with catch @ 00ac5c88 */
      ...
      *(undefined8 *)&s->debug = *(undefined8 *)(ctx->sid_ctx + 0x18);
                    /* try { // try from 00ac5cac to 00bc5df3 has its CatchHandler @ 00ac5cac
                       catch() { ... } // from try @ 00ac5cac with catch @ 00ac5cac
                       catch() { ... } // from try @ 00ac5e10 with catch @ 00ac5cac */
      ...
      if (to != (X509_VERIFY_PARAM *)0x0) {
        ...
        *(undefined4 *)&s->next_proto_negotiated = 0xffffffff;
        ...
        if (ctx[1].rsa_md5 != (EVP_MD *)0x0) {
          ...
          if (psVar8 == (stack_st_SRTP_PROTECTION_PROFILE *)0x0) goto LAB_00ac5eac;
        ...
        if (*(long *)(uVar11 + 0x2f8) != 0) {
          ...
          if (pvVar10 == (void *)0x0) goto LAB_00ac5eac;
                    /* try { // try from 00ac5df4 to 00bc5e0f has its CatchHandler @ 00ac5e60 */
        ...
        puVar16 = ctx->default_passwd_callback;
                    /* try { // try from 00ac5e10 to 00bc5e7b has its CatchHandler @ 00ac5cac */
        ...
        *(undefined1 **)(s[6].sid_ctx + 4) = puVar16;
        ...
        if (iVar5 != 0) {
          ...
          iVar5 = SSL_clear(s);
                    /* catch() { ... } // from try @ 00ac5df4 with catch @ 00ac5e60 */
          if ((iVar5 != 0) &&
