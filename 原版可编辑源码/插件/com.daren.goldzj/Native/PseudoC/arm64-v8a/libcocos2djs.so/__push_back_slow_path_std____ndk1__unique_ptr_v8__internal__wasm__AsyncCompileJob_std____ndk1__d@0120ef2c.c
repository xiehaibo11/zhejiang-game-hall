...
/* void std::__ndk1::vector<std::__ndk1::unique_ptr<v8::internal::wasm::AsyncCompileJob,
   std::__ndk1::default_delete<v8::internal::wasm::AsyncCompileJob> >,
   std::__ndk1::allocator<std::__ndk1::unique_ptr<v8::internal::wasm::AsyncCompileJob,
   std::__ndk1::default_delete<v8::internal::wasm::AsyncCompileJob> > >
   >::__push_back_slow_path<std::__ndk1::unique_ptr<v8::internal::wasm::AsyncCompileJob,
   std::__ndk1::default_delete<v8::internal::wasm::AsyncCompileJob> >
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_0120f040;
    ...
    *(void **)(this + 0x10) = (void *)((long)pvVar2 + uVar1 * 8);
    while (puVar11 != puVar9) {
      puVar11 = puVar11 + -1;
      this_00 = (AsyncCompileJob *)*puVar11;
      *puVar11 = 0;
