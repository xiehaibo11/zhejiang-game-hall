...
/* v8::internal::FrameSummary::WasmFrameSummary::byte_offset() const */

void __thiscall v8::internal::FrameSummary::WasmFrameSummary::byte_offset(WasmFrameSummary *this)
