...
/* js_cocos2dx_spine_SkeletonAnimation_setEndListenerRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonAnimation_setEndListenerRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonAnimation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3818,"js_cocos2dx_spine_SkeletonAnimation_setEndListener");
    __android_log_print(6,"jswrapper",&DAT_01920daf);
  }
  else {
    ...
    if (puVar4[1] - (long)pVVar5 == 0x10) {
      ...
      if (pVVar5[8] == (Value)0x5) {
        ...
        if ((uVar7 & 1) == 0) goto LAB_00c79180;
...
LAB_00c79180:
      ...
      spine::SkeletonAnimation::setEndListener(this,(function *)alStack_c0);
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 14400): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(puVar4[1] - (long)pVVar5) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonAnimation_setEndListener",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x3843);
LAB_00c79138:
