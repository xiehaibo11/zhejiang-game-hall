...
/* v8::internal::ActionNode::SetRegisterForLoop(int, int, v8::internal::RegExpNode*) */

undefined8 *
v8::internal::ActionNode::SetRegisterForLoop(int param_1,int param_2,RegExpNode *param_3)
