...
/* v8::internal::Worklist<std::__ndk1::pair<v8::internal::HeapObject, int>, 256>::~Worklist() */

void __thiscall
v8::internal::Worklist<std::__ndk1::pair<v8::internal::HeapObject,int>,256>::~Worklist
          (Worklist<std::__ndk1::pair<v8::internal::HeapObject,int>,256> *this)

{
  uint uVar1;
  void *pvVar2;
  ulong uVar3;
  Worklist<std::__ndk1::pair<v8::internal::HeapObject,int>,256> *pWVar4;
  long lVar5;
