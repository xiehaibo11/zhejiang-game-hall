...
LAB_0088ae98:
    ...
    cVar3 = (*param_3)((ArgType **)&local_88,(ArgType *)(local_88 + uVar6 * 2),&local_90,
                       local_90 + uVar7,0);
    if (cVar3 != '\0') {
      if ((local_80 & 1) != 0) {
...
LAB_0088afa8:
      ...
      *(undefined8 *)(param_2 + 8) = 0;
      ...
      bVar1 = *param_2;
joined_r0x0088afa4:
      if (((byte)bVar1 & 1) != 0) goto LAB_0088afa8;
LAB_0088af5c:
      *(undefined2 *)param_2 = 0;
    }
