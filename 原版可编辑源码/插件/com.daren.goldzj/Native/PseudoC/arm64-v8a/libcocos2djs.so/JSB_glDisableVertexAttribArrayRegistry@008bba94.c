...
/* JSB_glDisableVertexAttribArrayRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glDisableVertexAttribArrayRegistry(FunctionCallbackInfo *param_1)
