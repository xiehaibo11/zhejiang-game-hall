...
/* v8::internal::Debug::RemoveAllCoverageInfos() */

void __thiscall v8::internal::Debug::RemoveAllCoverageInfos(Debug *this)

{
  ...
  if (&local_90 == local_70) {
    ...
    if (local_70 == (undefined ***)0x0) goto LAB_00f06c0c;
