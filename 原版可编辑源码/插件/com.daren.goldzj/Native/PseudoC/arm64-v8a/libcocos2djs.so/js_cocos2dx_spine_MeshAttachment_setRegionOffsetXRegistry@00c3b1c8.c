...
/* js_cocos2dx_spine_MeshAttachment_setRegionOffsetXRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_MeshAttachment_setRegionOffsetXRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (MeshAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1725,"js_cocos2dx_spine_MeshAttachment_setRegionOffsetX");
    pcVar6 = "js_cocos2dx_spine_MeshAttachment_setRegionOffsetX : Invalid Native Object";
LAB_00c3b33c:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::MeshAttachment::setRegionOffsetX(this,local_64);
        goto LAB_00c3b374;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x172c,"js_cocos2dx_spine_MeshAttachment_setRegionOffsetX");
      pcVar6 = "js_cocos2dx_spine_MeshAttachment_setRegionOffsetX : Error processing arguments";
      goto LAB_00c3b33c;
    }
    __android_log_print(6,"jswrapper",&DAT_01904738,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_MeshAttachment_setRegionOffsetX",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1733);
LAB_00c3b374:
