...
/* js_engine_Device_vibrateRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_engine_Device_vibrateRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (uVar6 == 0x10) {
    ...
    if ((uVar6 & 1) != 0) {
      cocos2d::Device::vibrate(local_64);
      goto LAB_0089c8b4;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                        ,0x409,"js_engine_Device_vibrate");
    __android_log_print(6,"jswrapper","js_engine_Device_vibrate : Error processing arguments");
  }
  else {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 1037): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar6 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_Device_vibrate",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x410);
LAB_0089c8b4:
