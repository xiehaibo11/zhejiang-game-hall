...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<unsigned
   ...
   >::__emplace_unique_key_args<unsigned int, unsigned int&, se::Value&>(unsigned int const&,
   unsigned int&, se::Value&) */
...
::__emplace_unique_key_args<unsigned_int,unsigned_int&,se::Value&>
          (__hash_table<std::__ndk1::__hash_value_type<unsigned_int,se::Value>,std::__ndk1::__unordered_map_hasher<unsigned_int,std::__ndk1::__hash_value_type<unsigned_int,se::Value>,std::__ndk1::hash<unsigned_int>,true>,std::__ndk1::__unordered_map_equal<unsigned_int,std::__ndk1::__hash_value_type<unsigned_int,se::Value>,std::__ndk1::equal_to<unsigned_int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<unsigned_int,se::Value>>>
           *this,uint *param_1,uint *param_2,Value *param_3)
  ...
  *p_Var5;
  ...
  if (uVar9 != 0) {
    ...
    if (plVar8 != (long *)0x0) {
      do {
        plVar8 = (long *)*plVar8;
        if (plVar8 == (long *)0x0) goto LAB_008d3aa8;
        uVar7 = plVar8[1];
        if (uVar7 != uVar10) {
          if ((uVar3 & uVar9) == 0) {
            uVar7 = uVar7 & uVar3;
            ...
            if (uVar7 - uVar1 * uVar9 == unaff_x25) goto LAB_008d3a94;
            goto LAB_008d3aa8;
          }
          if (uVar7 != unaff_x25) goto LAB_008d3aa8;
        }
LAB_008d3a94:
...
LAB_008d3aa8:
  ...
  *(uint *)(plVar8 + 2) = *param_2;
  se::Value::Value((Value *)(plVar8 + 3),param_3);
  *plVar8 = 0;
  plVar8[1] = uVar10;
