...
/* v8::internal::compiler::RawMachineAssembler::CallNWithFrameState(v8::internal::compiler::CallDescriptor*,
   int, v8::internal::compiler::Node* const*) */

Node * __thiscall
v8::internal::compiler::RawMachineAssembler::CallNWithFrameState
