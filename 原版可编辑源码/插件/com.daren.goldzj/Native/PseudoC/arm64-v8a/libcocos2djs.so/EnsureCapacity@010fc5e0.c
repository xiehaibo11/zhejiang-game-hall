...
/* v8::internal::HashTable<v8::internal::NameDictionary,
   ...
   v8::internal::Handle<v8::internal::NameDictionary>, int, v8::internal::AllocationType) */

ulong * v8::internal::HashTable<v8::internal::NameDictionary,v8::internal::NameDictionaryShape>::
...

{
  ...
  if (((iVar2 - param_3 == 0 || iVar2 < param_3) ||
    ...
    puVar3 = (ulong *)Factory::NewFixedArrayWithMap<v8::internal::FixedArray>
                                (param_1,0x31,iVar2 * 3 + 5,bVar1);
    *(undefined4 *)(*puVar3 + 7) = 0;
    *(undefined4 *)(*puVar3 + 0xb) = 0;
    *(int *)(*puVar3 + 0xf) = iVar2 * 2;
    local_28 = *param_2;
    Rehash((HashTable<v8::internal::NameDictionary,v8::internal::NameDictionaryShape> *)&local_28,
           param_1 + 0x80,*puVar3);
  }
  return puVar3;
}
