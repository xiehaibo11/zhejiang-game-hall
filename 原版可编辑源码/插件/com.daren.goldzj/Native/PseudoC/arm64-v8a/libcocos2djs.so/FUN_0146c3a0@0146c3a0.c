...

{
  ...
  bVar1 = *(byte *)(unaff_x20 + unaff_x19 + 9);
  lVar4 = unaff_x26 +
  ...
  if ((ulong)((long)((ulong)*(uint *)(lVar4 + 3) << 0x20) >> 0x21) <=
      (ulong)*(uint *)(unaff_x20 + unaff_x19 + 5)) {
                    /* WARNING: Does not return */
    pcVar3 = (code *)SoftwareBreakpoint(0,0x146c494);
    (*pcVar3)();
  }
  ...
  if ((bVar1 >> 1 & 1) != 0) {
    *(int *)(unaff_x29 + -0x20) = iVar2;
    FUN_01342940();
                    /* WARNING: Could not recover jumptable at 0x0146c48c. Too many branches */
