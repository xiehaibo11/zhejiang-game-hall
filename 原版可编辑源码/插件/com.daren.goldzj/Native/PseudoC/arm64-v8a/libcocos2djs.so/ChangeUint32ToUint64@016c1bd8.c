...
/* v8::internal::compiler::GraphAssembler::ChangeUint32ToUint64(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::ChangeUint32ToUint64(GraphAssembler *this,Node *param_1)
