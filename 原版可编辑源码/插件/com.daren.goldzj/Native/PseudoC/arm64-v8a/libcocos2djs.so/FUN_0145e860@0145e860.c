...
void FUN_0145e860(undefined8 param_1)

{
  ...
  uVar2 = *(uint *)(unaff_x26 + (ulong)*(uint *)(unaff_x20 + 7) +
  ...
  *(int *)(unaff_x29 + -0x20) = ((int)unaff_x19 + -1) * 2;
  FUN_013849a0(*(undefined8 *)(unaff_x29 + -8),param_1,uVar3,unaff_x26 + (ulong)uVar2,lVar4,
               iVar1 * 2);
                    /* WARNING: Could not recover jumptable at 0x0145e930. Too many branches */
