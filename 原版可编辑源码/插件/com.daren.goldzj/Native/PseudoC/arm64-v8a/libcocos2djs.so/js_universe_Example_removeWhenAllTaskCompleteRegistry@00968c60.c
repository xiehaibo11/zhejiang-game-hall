...
/* js_universe_Example_removeWhenAllTaskCompleteRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_universe_Example_removeWhenAllTaskCompleteRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Example *)se::State::nativeThisObject(aSStack_60);
  if (this == (Example *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp"
                        ,0x1a5,"js_universe_Example_removeWhenAllTaskComplete");
    __android_log_print(6,"jswrapper",
                        "js_universe_Example_removeWhenAllTaskComplete : Invalid Native Object");
  }
  else {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp, 428): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_universe_Example_removeWhenAllTaskComplete",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp"
                      ,0x1af);
LAB_00968db0:
