...
/* void 
   v8::internal::RememberedSet<(v8::internal::RememberedSetType)1>::Insert<(v8::internal::AccessMode)0>(v8::internal::MemoryChunk*,
   unsigned long) */

void v8::internal::RememberedSet<(v8::internal::RememberedSetType)1>::
...

{
  ...
  pSVar4 = *(SlotSet **)(param_1 + 0x38);
  uVar6 = param_2;
  if (pSVar4 == (SlotSet *)0x0) {
    pSVar4 = MemoryChunk::AllocateSlotSet<(v8::internal::RememberedSetType)1>(param_1);
    uVar6 = extraout_x1;
  }
