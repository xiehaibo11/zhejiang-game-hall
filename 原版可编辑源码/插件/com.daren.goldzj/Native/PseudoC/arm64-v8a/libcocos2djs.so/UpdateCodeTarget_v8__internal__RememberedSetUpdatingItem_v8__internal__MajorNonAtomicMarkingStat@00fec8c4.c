...
/* v8::internal::SlotCallbackResult
   v8::internal::UpdateTypedSlotHelper::UpdateCodeTarget<v8::internal::RememberedSetUpdatingItem<v8::internal::MajorNonAtomicMarkingState,
   (v8::internal::GarbageCollector)1>::UpdateTypedPointers()::{lambda(v8::internal::FullMaybeObjectSlot)#1}>(v8::internal::RelocInfo*,
...
bool v8::internal::UpdateTypedSlotHelper::
     UpdateCodeTarget<v8::internal::RememberedSetUpdatingItem<v8::internal::MajorNonAtomicMarkingState,(v8::internal::GarbageCollector)1>::UpdateTypedPointers()::_lambda(v8::internal::FullMaybeObjectSlot)_1_>
               (RelocInfo *param_1)

{
  ...
  if ((uVar9 >> 3 & 1) == 0) {
    if ((uVar9 >> 4 & 1) != 0) {
      ...
      return (*(uint *)(*(long *)(uVar8 + 0x10) + (uVar5 >> 7 & 0x1ffffff) * 4) >>
