...
/* v8::internal::compiler::SimplifiedOperatorBuilder::LoadTypedElement(v8::internal::ExternalArrayType
   const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::LoadTypedElement
...

{
  ...
  Operator::Operator(pOVar2,0xed,0x70,"LoadTypedElement",4,1,1,1,1,0);
