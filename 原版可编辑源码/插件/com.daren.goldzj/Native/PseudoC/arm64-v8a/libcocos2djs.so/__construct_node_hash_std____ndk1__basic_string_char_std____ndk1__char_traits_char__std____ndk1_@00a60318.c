...
/* std::__ndk1::unique_ptr<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::extension::ManifestAsset> > >::__construct_node_hash<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >&,
   cocos2d::extension::ManifestAsset&>(unsigned long, std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >&,
   cocos2d::extension::ManifestAsset&) */
...
void std::__ndk1::
     ...
     ::
     __construct_node_hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>&,cocos2d::extension::ManifestAsset&>
               (ulong param_1,basic_string *param_2,ManifestAsset *param_3)

{
  ...
  undefined8 uVar5;
                    ...
                    /* try { // try from 00a6032c to 00b603cf has its CatchHandler @ 00a604a8 */
...
LAB_00a603e4:
                    /* try { // try from 00a603e8 to 00b603f7 has its CatchHandler @ 00a604d8 */
  cocos2d::extension::ManifestAsset::ManifestAsset((ManifestAsset *)((long)pvVar1 + 0x28),in_x3);
  puVar2 = (undefined8 *)*in_x8;
                    /* try { // try from 00a603f8 to 00b6052f has its CatchHandler @ 00a60078 */
