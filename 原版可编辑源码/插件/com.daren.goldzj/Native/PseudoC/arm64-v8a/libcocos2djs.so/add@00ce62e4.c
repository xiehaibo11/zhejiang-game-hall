...
/* spine::Vector<spine::Vector<float> >::add(spine::Vector<float> const&) */

void __thiscall
spine::Vector<spine::Vector<float>>::add(Vector<spine::Vector<float>> *this,Vector *param_1)
    ...
    if (lVar16 != 0) {
      ...
      if (uVar6 != 0) {
        ...
        if ((uVar6 < 8) || ((uVar17 < uVar9 + uVar6 * 4 && (uVar9 < uVar17 + uVar6 * 4)))) {
          ...
          if (uVar6 == uVar12) goto LAB_00ce659c;
        }
        lVar16 = uVar6 - uVar12;
  ...
  if (lVar16 != 0) {
    ...
    if (uVar17 != 0) {
      ...
      if ((uVar17 < 8) || ((local_60 < uVar6 + uVar17 * 4 && (uVar6 < local_60 + uVar17 * 4)))) {
        ...
        if (uVar17 == uVar9) goto LAB_00ce63b4;
      }
      lVar11 = uVar17 - uVar9;
  ...
  if (lVar16 != 0) {
    ...
    if (uVar6 != 0) {
      if ((uVar6 < 8) || ((uVar17 < local_60 + uVar6 * 4 && (local_60 < uVar17 + uVar6 * 4)))) {
        ...
        if (uVar6 == uVar9) goto LAB_00ce64a8;
      }
      lVar16 = uVar6 - uVar9;
