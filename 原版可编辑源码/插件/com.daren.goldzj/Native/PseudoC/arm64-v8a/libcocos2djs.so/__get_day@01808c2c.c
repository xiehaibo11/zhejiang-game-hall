...
__get_day(undefined8 param_1_00,int *param_1,undefined8 param_2,undefined8 param_4,uint *param_5,
         undefined8 param_6)

{
  int iVar1;
  
  iVar1 = FUN_018093f4(param_2,param_4,param_5,param_6,2);
  if ((iVar1 - 1U < 0x1f) && ((*param_5 >> 2 & 1) == 0)) {
    *param_1 = iVar1;
  }
  else {
    *param_5 = *param_5 | 4;
