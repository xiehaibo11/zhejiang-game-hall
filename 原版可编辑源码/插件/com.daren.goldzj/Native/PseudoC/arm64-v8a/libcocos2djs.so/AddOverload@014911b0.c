...
/* v8::internal::wasm::AsmOverloadedFunctionType::AddOverload(v8::internal::wasm::AsmType*) */

void __thiscall
v8::internal::wasm::AsmOverloadedFunctionType::AddOverload
          (AsmOverloadedFunctionType *this,AsmType *param_1)

{
  ...
  if (puVar4 == *(undefined8 **)(this + 0x18)) {
    lVar6 = (long)puVar4 - *(long *)(this + 8) >> 3;
    uVar1 = lVar6 + 1;
    if (uVar1 >> 0x1c != 0) {
                    /* WARNING: Subroutine does not return */
      abort();
    }
    lVar3 = (long)*(undefined8 **)(this + 0x18) - *(long *)(this + 8);
    uVar7 = lVar3 >> 2;
    if (uVar1 <= uVar7) {
      uVar1 = uVar7;
    }
