...
/* v8::internal::Isolate::AddCallCompletedCallback(void (*)(v8::Isolate*)) */

void __thiscall
v8::internal::Isolate::AddCallCompletedCallback(Isolate *this,_func_void_Isolate_ptr *param_1)

{
  ...
  if (puVar3 == puVar2) {
LAB_00f56234:
    if (puVar2 == *(undefined8 **)(this + 0xc650)) {
      local_18 = param_1;
      ...
      __push_back_slow_path<void(*const&)(v8::Isolate*)>
                ((vector<void(*)(v8::Isolate*),std::__ndk1::allocator<void(*)(v8::Isolate*)>> *)
                 (this + 0xc640),(_func_void_Isolate_ptr *)&local_18);
    }
    else {
      *puVar2 = param_1;
      *(long *)(this + 0xc648) = *(long *)(this + 0xc648) + 8;
    }
  }
  return;
}
