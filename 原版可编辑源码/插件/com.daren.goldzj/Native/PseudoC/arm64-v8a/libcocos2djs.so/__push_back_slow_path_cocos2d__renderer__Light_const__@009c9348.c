...
/* void std::__ndk1::vector<cocos2d::renderer::Light*,
   std::__ndk1::allocator<cocos2d::renderer::Light*>
   >::__push_back_slow_path<cocos2d::renderer::Light* const&>(cocos2d::renderer::Light* const&) */
