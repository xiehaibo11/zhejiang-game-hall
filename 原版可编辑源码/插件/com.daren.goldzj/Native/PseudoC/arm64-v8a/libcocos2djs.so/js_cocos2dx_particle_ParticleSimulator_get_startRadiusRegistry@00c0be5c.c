...
/* js_cocos2dx_particle_ParticleSimulator_get_startRadiusRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_particle_ParticleSimulator_get_startRadiusRegistry
...

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x480,"js_cocos2dx_particle_ParticleSimulator_get_startRadius");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_particle_ParticleSimulator_get_startRadius : Invalid Native Object"
                       );
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_particle_ParticleSimulator_get_startRadius",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                        ,0x488);
  }
  else {
    se::Value::Value(aVStack_58);
    float_to_seval(*(float *)(lVar3 + 0x174),aVStack_58);
