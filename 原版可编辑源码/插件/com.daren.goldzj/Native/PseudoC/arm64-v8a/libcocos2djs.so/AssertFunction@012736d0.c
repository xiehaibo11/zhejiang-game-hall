...
/* v8::internal::MacroAssembler::AssertFunction(v8::internal::Register) */

void v8::internal::MacroAssembler::AssertFunction
...

{
  ...
  if (param_1[0xc0] != (Label)0x0) {
    AssertNotSmi(param_1,param_2,param_3,0x15);
    ...
    CompareObjectType(param_1,param_2,param_3,uVar1,0,uVar1,0,0x439);
    local_28 = 0;
    TurboAssembler::B((TurboAssembler *)param_1,&local_28,0);
    TurboAssembler::Abort((TurboAssembler *)param_1,0x1a);
