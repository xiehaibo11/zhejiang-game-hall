...
void FUN_010a9e68(undefined8 param_1,ulong *param_2,uint param_3)
...
joined_r0x010a9f58:
    ...
    if ((((ulong)dVar14 >> 0x20 == 0x43300000) && (uVar11 = SUB84(dVar14,0), uVar11 != 0xffffffff))
       && (dVar13 == (double)((ulong)dVar14 & 0xffffffff))) goto joined_r0x010a9f58;
  }
                    /* WARNING: Subroutine does not return */
