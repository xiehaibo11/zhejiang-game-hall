...

{
  ...
  ulong uVar17;
                    ...
                    /* catch() { ... } // from try @ 009e7ee4 with catch @ 009e7f14 */
                    /* catch() { ... } // from try @ 009e7edc with catch @ 009e7f18 */
                    /* catch() { ... } // from try @ 009e7c4c with catch @ 009e7f1c
                       catch() { ... } // from try @ 009e7d34 with catch @ 009e7f1c */
                    /* catch() { ... } // from try @ 009e7e9c with catch @ 009e7f20 */
                    /* catch() { ... } // from try @ 009e7ea4 with catch @ 009e7f24 */
  if (param_1 == 0) {
                    /* catch() { ... } // from try @ 009e7ba8 with catch @ 009e7fa4 */
    pvVar9 = *(void **)this;
    *(undefined8 *)this = 0;
    if (pvVar9 != (void *)0x0) {
      operator_delete(pvVar9);
    }
                    /* catch() { ... } // from try @ 009e7be0 with catch @ 009e7fb4
                       catch() { ... } // from try @ 009e7c80 with catch @ 009e7fb4
                       catch() { ... } // from try @ 009e7dd8 with catch @ 009e7fb4 */
    *(undefined8 *)(this + 8) = 0;
  }
  else {
    if (param_1 >> 0x3d != 0) {
      ...
      FUN_00857170("allocator<T>::allocate(size_t n) \'n\' exceeds maximum supported size");
                    ...
                    /* catch() { ... } // from try @ 009e7c20 with catch @ 009e7f3c
                       catch() { ... } // from try @ 009e7cec with catch @ 009e7f3c */
      ...
      if ((uVar16 & param_1) == 0) {
        ...
        if (param_1 != 0) {
          uVar17 = uVar11 / param_1;
                    ...
                    /* catch() { ... } // from try @ 009e7bd4 with catch @ 009e7f9c */
        uVar11 = uVar11 - uVar17 * param_1;
                    /* catch() { ... } // from try @ 009e7bc8 with catch @ 009e7fa0 */
      }
      *(__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::network::SIOClient*>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::network::SIOClient*>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::network::SIOClient*>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::network::SIOClient*>>>
      ...
      for (plVar15 = (long *)*plVar14; plVar15 != (long *)0x0; plVar15 = (long *)*plVar15) {
        ...
        if (uVar17 != uVar11) {
                    /* try { // try from 009e800c to 00ae805f has its CatchHandler @ 009e800c
                       catch() { ... } // from try @ 009e800c with catch @ 009e800c
                       catch() { ... } // from try @ 009e8200 with catch @ 009e800c */
            ...
            *(long **)(*(long *)this + uVar17 * 8) = plVar14;
            ...
            if ((long *)*plVar15 != (long *)0x0) {
              ...
              do {
                ...
                sVar1 = (ulong)(bVar2 >> 1);
                    /* try { // try from 009e8060 to 00ae8077 has its CatchHandler @ 009e8270 */
                if ((bVar2 & 1) != 0) {
                  sVar1 = plVar12[3];
                }
                if (__n != sVar1) break;
                ...
                if ((bVar3 & 1) != 0) {
                  __s1 = (char *)plVar15[4];
                    ...
                    /* try { // try from 009e8080 to 00ae808b has its CatchHandler @ 009e826c */
                if ((bVar2 & 1) == 0) {
                ...
                if ((bVar3 & 1) == 0) {
                  while (sVar6 != 0) {
                    /* try { // try from 009e8098 to 00ae81e3 has its CatchHandler @ 009e8280 */
                    if (*pcVar5 != *__s2) goto LAB_009e80ec;
                    __s2 = __s2 + 1;
                    sVar1 = sVar1 + 1;
                    pcVar5 = pcVar5 + 1;
                    sVar6 = sVar1;
