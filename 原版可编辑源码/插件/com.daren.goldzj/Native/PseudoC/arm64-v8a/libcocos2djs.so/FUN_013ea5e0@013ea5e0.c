...
long FUN_013ea5e0(long param_1,long param_2)

{
  ...
  if (uVar1 == (*(uint *)(param_2 + 3) & 1)) {
    *(undefined8 *)(unaff_x26 + 0x40) = 0x13ea630;
    ...
    if (iVar5 < 0) {
      ...
      if (uVar10 != 0) {
        if ((*(uint *)(param_1 + 3) >> 1 & 0x3fffffff) == 0) {
          ...
          *(uint *)(lVar6 + 3) = uVar1;
          uVar3 = uVar1 | bVar2;
          *(uint *)(lVar6 + 3) = uVar3;
          *(undefined8 *)(unaff_x26 + 0x40) = 0x13ea710;
          *(undefined1 **)(unaff_x26 + 0x38) = &stack0xfffffffffffffff0;
      ...
      if (uVar10 != 0) {
        if ((*(uint *)(param_2 + 3) >> 1 & 0x3fffffff) == 0) {
          ...
          *(uint *)(lVar6 + 3) = uVar1;
          *(undefined8 *)(unaff_x26 + 0x40) = 0x13ea840;
          *(undefined1 **)(unaff_x26 + 0x38) = &stack0xfffffffffffffff0;
      ...
      if (uVar9 == 0) {
        ...
        if (uVar10 < 0x1000001) {
          ...
          *(uint *)(lVar7 + 3) = uVar1;
          uVar3 = uVar1 | uVar3 & 1;
          *(uint *)(lVar7 + 3) = uVar3;
          *(undefined8 *)(unaff_x26 + 0x40) = 0x13ea97c;
          *(undefined1 **)(unaff_x26 + 0x38) = &stack0xfffffffffffffff0;
