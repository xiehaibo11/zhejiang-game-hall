...
/* JSB_glIsFramebufferRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glIsFramebufferRegistry(FunctionCallbackInfo *param_1)
...
LAB_008bee84:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            ...
                            ,0x69c,"JSB_glIsFramebuffer");
        __android_log_print(6,"jswrapper",&DAT_0190552e);
        goto LAB_008beec8;
      }
      lVar9 = __dynamic_cast(lVar8,&PTR_PTR_01c67690,&PTR_PTR_01c67710,0);
      if (lVar9 == 0) goto LAB_008bee6c;
      cVar4 = glIsFramebuffer(*(undefined4 *)(lVar8 + 0xc));
      bVar3 = cVar4 != '\0';
    }
    else {
      if (1 < (byte)pVVar7[8]) goto LAB_008bee84;
LAB_008bee6c:
      bVar3 = false;
    }
