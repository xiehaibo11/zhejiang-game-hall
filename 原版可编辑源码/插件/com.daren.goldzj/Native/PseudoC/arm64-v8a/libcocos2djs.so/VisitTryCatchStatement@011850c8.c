...
void __thiscall
v8::internal::Processor::VisitTryCatchStatement(Processor *this,TryCatchStatement *param_1)

{
  ...
  *(undefined8 *)(param_1 + 0x18) = *(undefined8 *)(this + 8);
  if ((PVar2 == (Processor)0x0) || (this[0x52] == (Processor)0x0)) {
    param_1 = (TryCatchStatement *)AssignUndefinedBefore(this,(Statement *)param_1);
  }
  *(TryCatchStatement **)(this + 8) = param_1;
