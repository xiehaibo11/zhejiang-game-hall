...
void __thiscall
v8::internal::compiler::InstructionSelector::VisitTryTruncateFloat64ToInt64
...

{
  ...
  Emit(this,0xd4,uVar3,(InstructionOperand *)&local_50,1,(InstructionOperand *)&local_28,0,
