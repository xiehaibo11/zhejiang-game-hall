...
undefined8 v8::internal::compiler::NodeProperties::GetControlInput(Node *param_1,int param_2)

{
  ...
  return *(undefined8 *)
          (pNVar4 + (long)(int)(iVar1 + param_2 + (uVar2 & 1) + (uVar3 & 1) +
                               *(int *)(*(long *)param_1 + 0x18)) * 8);
}
