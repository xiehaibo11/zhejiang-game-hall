...
/* bool 
   native_ptr_to_seval<spine::SkeletonCache>(std::__ndk1::enable_if<std::is_base_of<cocos2d::Ref,
   spine::SkeletonCache>::value, spine::SkeletonCache>::type*, se::Value*, bool*) */

bool native_ptr_to_seval<spine::SkeletonCache>(type *param_1,Value *param_2,bool *param_3)

{
  ...
  if (param_1 == (type *)0x0) {
    ...
    if (lVar1 == lVar2) {
      pCVar3 = JSBClassType::findClass<spine::SkeletonCache>((SkeletonCache *)param_1);
