...
/* v8::internal::compiler::CFGBuilder::ConnectThrow(v8::internal::compiler::Node*) */

void __thiscall v8::internal::compiler::CFGBuilder::ConnectThrow(CFGBuilder *this,Node *param_1)

{
  ...
  Schedule::AddThrow(*(Schedule **)(this + 0x10),pBVar2,param_1);
  return;
}
