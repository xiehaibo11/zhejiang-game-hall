...

{
  ...
  if (param_1 - 1 == 0) {
    ...
    param_1 = __next_prime(param_1);
                    /* catch() { ... } // from try @ 00a6ae60 with catch @ 00a6af44 */
  }
  uVar2 = *(ulong *)(this + 8);
  uVar1 = param_1;
  if (uVar2 < param_1) {
LAB_00a6af5c:
                    /* try { // try from 00a6af60 to 00b6afb7 has its CatchHandler @ 00a6af60
                       catch() { ... } // from try @ 00a6af60 with catch @ 00a6af60
                       catch() { ... } // from try @ 00a6b210 with catch @ 00a6af60 */
    __rehash(this,uVar1);
    return;
  }
  if (param_1 < uVar2) {
    ...
    if (uVar2 < 3 || (uVar2 - 1 & uVar2) != 0) {
      uVar1 = __next_prime(uVar1);
                    ...
                    /* try { // try from 00a6afb8 to 00b6afcf has its CatchHandler @ 00a6b298 */
      uVar1 = 1L << ((ulong)(uint)-(int)LZCOUNT(uVar1 - 1) & 0x3f);
    }
    if (uVar1 <= param_1) {
      uVar1 = param_1;
    }
    if (uVar1 < uVar2) goto LAB_00a6af5c;
  }
                    /* try { // try from 00a6afe4 to 00b6afef has its CatchHandler @ 00a6b244 */
  return;
}
