...
/* std::__ndk1::vector<v8::internal::compiler::BranchElimination::ControlPathConditions,
   v8::internal::ZoneAllocator<v8::internal::compiler::BranchElimination::ControlPathConditions>
   >::__append(unsigned long, v8::internal::compiler::BranchElimination::ControlPathConditions
   const&) */
...
::__append(vector<v8::internal::compiler::BranchElimination::ControlPathConditions,v8::internal::ZoneAllocator<v8::internal::compiler::BranchElimination::ControlPathConditions>>
           *this,ulong param_1,ControlPathConditions *param_2)

{
  ...
  if ((3 < param_1) &&
     ((param_2 + 1 <= puVar4 ||
      ((ControlPathConditions *)(lVar5 + (lVar11 + param_1) * 8) <= param_2)))) {
