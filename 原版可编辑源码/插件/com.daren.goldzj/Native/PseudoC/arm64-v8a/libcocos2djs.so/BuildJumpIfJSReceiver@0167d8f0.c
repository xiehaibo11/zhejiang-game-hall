...
/* v8::internal::compiler::BytecodeGraphBuilder::BuildJumpIfJSReceiver() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::BuildJumpIfJSReceiver(BytecodeGraphBuilder *this)
