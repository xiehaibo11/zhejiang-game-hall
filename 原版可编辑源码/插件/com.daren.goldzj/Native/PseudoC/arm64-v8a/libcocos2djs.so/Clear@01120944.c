...
/* v8::internal::OrderedHashTable<v8::internal::OrderedHashMap, 2>::Clear(v8::internal::Isolate*,
   v8::internal::Handle<v8::internal::OrderedHashMap>) */

ulong * v8::internal::OrderedHashTable<v8::internal::OrderedHashMap,2>::Clear
...

{
  ...
  if (iVar3 < 0x1249249) {
    ...
    puVar4 = (ulong *)Factory::NewFixedArrayWithMap<v8::internal::FixedArray>
                                (param_1,0x35,uVar1 + iVar3 * 3 + 3,(uVar6 & 0x18) == 0);
    uVar6 = *puVar4;
    if (1 < iVar3) {
      iVar3 = 0xc;
      do {
