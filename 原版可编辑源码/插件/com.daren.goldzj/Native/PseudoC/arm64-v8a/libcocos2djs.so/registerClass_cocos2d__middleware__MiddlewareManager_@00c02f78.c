...
/* void JSBClassType::registerClass<cocos2d::middleware::MiddlewareManager>(se::Class*) */

void JSBClassType::registerClass<cocos2d::middleware::MiddlewareManager>(Class *param_1)
