...
undefined1  [16] __thiscall v8::Date::ValueOf(Date *this)

{
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_60,(ulong)&local_60 | 8,0x368);
  }
  this_00 = *(Logger **)(((ulong)uVar1 << 0x20) + 0x9558);
  uVar2 = internal::Logger::is_logging(this_00);
  if ((uVar2 & 1) != 0) {
    internal::Logger::ApiEntryCall(this_00,"v8::Date::NumberValue");
  }
