...
void __thiscall
v8::internal::StringSearch<unsigned_short,unsigned_char>::PopulateBoyerMooreTable
          (StringSearch<unsigned_short,unsigned_char> *this)

{
  ...
  if (iVar10 != 0 && iVar5 <= (int)uVar21) {
    ...
    if (7 < uVar11) {
      ...
      if (uVar11 == uVar13) goto LAB_0113aae0;
    }
