...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<v8::TracingController::TraceStateObserver*,
   void*>*>, bool> std::__ndk1::__hash_table<v8::TracingController::TraceStateObserver*,
   ...
   >::__emplace_unique_key_args<v8::TracingController::TraceStateObserver*,
   v8::TracingController::TraceStateObserver* const&>(v8::TracingController::TraceStateObserver*
   const&, v8::TracingController::TraceStateObserver* const&) */
...
__emplace_unique_key_args<v8::TracingController::TraceStateObserver*,v8::TracingController::TraceStateObserver*const&>
          (__hash_table<v8::TracingController::TraceStateObserver*,std::__ndk1::hash<v8::TracingController::TraceStateObserver*>,std::__ndk1::equal_to<v8::TracingController::TraceStateObserver*>,std::__ndk1::allocator<v8::TracingController::TraceStateObserver*>>
           *this,TraceStateObserver **param_1,TraceStateObserver **param_2)

{
  ulong uVar1;
  TraceStateObserver *pTVar2;
  long *plVar3;
  __hash_table<v8::TracingController::TraceStateObserver*,std::__ndk1::hash<v8::TracingController::TraceStateObserver*>,std::__ndk1::equal_to<v8::TracingController::TraceStateObserver*>,std::__ndk1::allocator<v8::TracingController::TraceStateObserver*>>
  *p_Var4;
  ulong uVar5;
  ...
  pTVar2 = *param_1;
  uVar7 = ((ulong)(uint)((int)pTVar2 << 3) + 8 ^ (ulong)pTVar2 >> 0x20) * -0x622015f714c7d297;
  uVar10 = *(ulong *)(this + 8);
  uVar7 = (uVar7 ^ (ulong)pTVar2 >> 0x20 ^ uVar7 >> 0x2f) * -0x622015f714c7d297;
      ...
      for (plVar9 = (long *)*plVar9; plVar9 != (long *)0x0; plVar9 = (long *)*plVar9) {
        ...
        if (uVar8 != uVar7) {
          if (uVar5 < 2) {
            ...
            if (uVar8 - uVar1 * uVar10 == unaff_x24) goto LAB_00ea19c4;
            break;
          }
          if (uVar8 != unaff_x24) break;
        }
LAB_00ea19c4:
        if ((TraceStateObserver *)plVar9[2] == pTVar2) {
          return plVar9;
        }
      }
    }
