...
/* spine::SkeletonAnimation::setTrackStartListener(spine::TrackEntry*, std::__ndk1::function<void
...

{
  ...
  if (lVar5 == 0) {
    ...
    *(undefined8 *)(param_1 + 0x18) = 0;
    ...
    if (plVar2 == (long *)0x0) goto LAB_00d0fa48;
LAB_00d0f9d8:
    ...
    plVar2 = *(long **)(param_2 + 0x20);
    if (plVar2 != (long *)0x0) goto LAB_00d0f9d8;
LAB_00d0fa48:
    local_50 = (long *)0x0;
  }
  FUN_00c8c388(alStack_70,lVar5);
  if (alStack_70 == local_50) {
    pcVar4 = *(code **)(*local_50 + 0x20);
  }
  else {
    if (local_50 == (long *)0x0) goto LAB_00d0faa0;
