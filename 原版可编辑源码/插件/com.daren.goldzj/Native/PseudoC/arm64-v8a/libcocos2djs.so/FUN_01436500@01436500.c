...
void FUN_01436500(ulong param_1)

{
  ...
  do {
    ...
    if ((param_1 & 1) == 0) {
      ...
      uVar13 = uVar14;
LAB_014366a0:
      uVar17 = uVar17 >> (ulong)(iVar7 * 2 >> 1 & 0x1f);
      ...
      if ((uVar14 == 0) &&
        ...
        *(undefined4 *)(lVar9 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x01436718. Too many branches */
