...
/* v8::internal::HeapNumber::HeapNumberPrint(std::__ndk1::basic_ostream<char,
   std::__ndk1::char_traits<char> >&) */

void __thiscall v8::internal::HeapNumber::HeapNumberPrint(HeapNumber *this,basic_ostream *param_1)

{
  ...
  if (((9007199254740991.0 < dVar2) || (dVar2 < -9007199254740992.0)) || (dVar2 != dVar3)) {
