...
spine::SkeletonRenderer::findBone(SkeletonRenderer *this,basic_string *param_1)

{
  ...
  uVar4 = 0;
  if (this_00 == (Skeleton *)0x0) goto LAB_00d148d8;
  if (((byte)*param_1 & 1) == 0) {
    __s = param_1 + 1;
LAB_00d14848:
    ...
    local_50 = &PTR__String_01c67868;
    if (__s != (basic_string *)0x0) goto LAB_00d14848;
    local_48 = 0;
    local_40 = (void *)0x0;
  }
  uVar4 = Skeleton::findBone(this_00,(String *)&local_50);
  pvVar2 = local_40;
  local_50 = &PTR__String_01c67868;
