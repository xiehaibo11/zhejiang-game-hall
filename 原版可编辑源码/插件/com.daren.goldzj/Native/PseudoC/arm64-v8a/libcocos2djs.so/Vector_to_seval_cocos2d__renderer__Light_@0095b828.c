...
/* bool Vector_to_seval<cocos2d::renderer::Light>(cocos2d::Vector<cocos2d::renderer::Light*> const&,
   se::Value*) */

bool Vector_to_seval<cocos2d::renderer::Light>(Vector *param_1,Value *param_2)

{
  ...
  if (puVar5 != puVar1) {
    uVar4 = 0;
    do {
      native_ptr_to_seval<cocos2d::renderer::Light>((type *)*puVar5,aVStack_58,(bool *)0x0);
