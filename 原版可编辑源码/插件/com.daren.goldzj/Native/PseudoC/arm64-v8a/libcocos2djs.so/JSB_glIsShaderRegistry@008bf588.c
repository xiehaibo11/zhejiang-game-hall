...
/* JSB_glIsShaderRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glIsShaderRegistry(FunctionCallbackInfo *param_1)
...
LAB_008bf6f4:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            ...
                            ,0x6dd,"JSB_glIsShader");
        __android_log_print(6,"jswrapper",&DAT_0190552e);
        goto LAB_008bf738;
      }
      lVar9 = __dynamic_cast(lVar8,&PTR_PTR_01c67690,&PTR_PTR_01c676e0,0);
      if (lVar9 == 0) goto LAB_008bf6dc;
      cVar4 = glIsShader(*(undefined4 *)(lVar8 + 0xc));
      bVar3 = cVar4 == '\x01';
    }
    else {
      if (1 < (byte)pVVar7[8]) goto LAB_008bf6f4;
LAB_008bf6dc:
      bVar3 = false;
    }
