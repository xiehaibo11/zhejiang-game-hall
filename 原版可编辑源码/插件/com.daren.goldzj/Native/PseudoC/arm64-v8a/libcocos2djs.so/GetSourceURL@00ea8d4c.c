...
ulong * __thiscall v8::UnboundScript::GetSourceURL(UnboundScript *this)

{
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_60,(ulong)&local_60 | 8,0x3ec);
  }
  this_00 = *(Logger **)(pIVar5 + 0x9558);
  uVar1 = internal::Logger::is_logging(this_00);
  if ((uVar1 & 1) != 0) {
    internal::Logger::ApiEntryCall(this_00,"v8::UnboundScript::GetSourceURL");
  }
  ...
  if (*(short *)((uVar1 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar1 - 1)) == 0x65) {
    ...
    uVar1 = uVar3 & 0xffffffff00000000 | (ulong)*(uint *)(uVar3 + 0x33);
