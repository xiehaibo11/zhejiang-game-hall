...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::LateGraphTrimmingPhase>()
    */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::LateGraphTrimmingPhase>
          (PipelineImpl *this)

{
  ...
  if (this_00 != (PipelineStatistics *)0x0) {
    PipelineStatistics::BeginPhase(this_00,"V8.TFLateGraphTrimming");
  }
  this_01 = *(ZoneStats **)(lVar5 + 0x30);
  lVar4 = *(long *)(lVar5 + 0xb0);
  if (lVar4 != 0) {
    local_b0 = *(undefined8 *)(lVar4 + 0x30);
    *(char **)(lVar4 + 0x30) = "V8.TFLateGraphTrimming";
  }
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFLateGraphTrimming");
  GraphTrimmer::GraphTrimmer(aGStack_60,pZVar2,*(Graph **)(lVar5 + 0xa0));
  local_80 = 0;
  local_78 = 0;
  local_70 = 0;
  pZStack_68 = pZVar2;
  if (*(JSGraph **)(lVar5 + 0xd8) != (JSGraph *)0x0) {
