...
/* cocos2d::EventDispatcher::removeAllCustomEventListeners(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

void cocos2d::EventDispatcher::removeAllCustomEventListeners(basic_string *param_1)
