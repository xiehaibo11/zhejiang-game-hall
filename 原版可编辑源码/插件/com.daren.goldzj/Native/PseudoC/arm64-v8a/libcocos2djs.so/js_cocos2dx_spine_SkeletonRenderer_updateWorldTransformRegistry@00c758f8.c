...
/* js_cocos2dx_spine_SkeletonRenderer_updateWorldTransformRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonRenderer_updateWorldTransformRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonRenderer *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x358b,"js_cocos2dx_spine_SkeletonRenderer_updateWorldTransform");
    __android_log_print(6,"jswrapper",0x191fc2b);
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      spine::SkeletonRenderer::updateWorldTransform(this);
      goto LAB_00c75a48;
    }
    __android_log_print(6,"jswrapper",&DAT_0191fc7b,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
