...
/* v8::internal::Factory::NewCatchContext(v8::internal::Handle<v8::internal::Context>,
   v8::internal::Handle<v8::internal::ScopeInfo>, v8::internal::Handle<v8::internal::Object>) */

ulong * __thiscall
v8::internal::Factory::NewCatchContext(Factory *this,ulong *param_2,ulong *param_3,ulong *param_4)

{
  ...
  puVar1 = (ulong *)NewContext(this,puVar1,0x14,3,0);
  uVar4 = *puVar1;
  uVar2 = *param_3;
  ...
  *(int *)(uVar4 + 0xb) = (int)uVar2;
  ...
  uVar4 = *puVar1;
  uVar2 = *param_4;
  *(int *)(uVar4 + 0xf) = (int)uVar2;
  if ((uVar2 & 1) != 0) {
    uVar3 = *(ulong *)((uVar2 & 0xfffffffffffc0000) + 8);
    if (((uint)uVar3 >> 0x12 & 1) != 0) {
      Heap_MarkingBarrierSlow(uVar4,uVar4 + 0xf,uVar2);
      uVar3 = *(ulong *)(uVar2 & 0xfffffffffffc0000 | 8);
    }
    if (((uVar3 & 0x18) != 0) && ((*(byte *)((uVar4 & 0xfffffffffffc0000) + 8) & 0x18) == 0)) {
      Heap_GenerationalBarrierSlow(uVar4,uVar4 + 0xf,uVar2);
    }
  }
  return puVar1;
}
