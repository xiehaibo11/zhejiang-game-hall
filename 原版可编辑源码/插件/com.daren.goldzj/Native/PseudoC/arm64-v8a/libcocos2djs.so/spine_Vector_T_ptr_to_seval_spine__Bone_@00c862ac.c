...
/* bool spine_Vector_T_ptr_to_seval<spine::Bone>(spine::Vector<spine::Bone*> const&, se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::Bone>(Vector *param_1,Value *param_2)
...
LAB_00c86374:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::Bone>
