...
/* v8::internal::interpreter::BytecodeGenerator::VisitNaryNullishExpression(v8::internal::NaryOperation*)
    */

void __thiscall
v8::internal::interpreter::BytecodeGenerator::VisitNaryNullishExpression
...

{
  ...
  if ((this_00 != (BlockCoverageBuilder *)0x0) &&
    ...
    uVar11 = 1;
    if (this_00 == (BlockCoverageBuilder *)0x0) goto LAB_0151dbb4;
    do {
...
LAB_0151dc0c:
  ...
  if (*(int *)(lVar10 + 0x18) == 3) {
    uVar11 = Expression::IsLiteralButNotNullOrUndefined(this_01);
    if (((uVar11 & 1) == 0) || (uVar11 = Expression::ToBooleanIsTrue(this_01), (uVar11 & 1) == 0)) {
      VisitNaryLogicalTest(this,0x1f,param_1,&local_b0);
    }
    else {
    ...
    *(undefined1 *)(lVar10 + 0x20) = 1;
    ...
    local_88 = local_90;
    uVar11 = VisitNullishSubExpression(this,this_01,(BytecodeLabels *)&local_90,iVar4);
    if ((uVar11 & 1) == 0) {
      lVar10 = 0;
      uVar11 = 0;
      do {
        ...
        uVar8 = VisitNullishSubExpression
