...
LAB_017fde58:
  if (param_2 == (long *)0x0) {
    bVar4 = true;
    if (param_3 != (long *)0x0) goto LAB_017fde9c;
LAB_017fded8:
    param_3 = (long *)0x0;
    if (bVar4) goto LAB_017fdfc8;
  }
  else {
    ...
    param_2 = plVar2;
    if (param_3 == (long *)0x0) goto LAB_017fded8;
LAB_017fde9c:
...
LAB_017fdfc8:
  ...
  uVar8 = FUN_01828710(pcVar18,local_1b8,param_5,iVar7);
  *param_6 = uVar8;
  uVar9 = (ulong)((byte)local_198[0] >> 1);
  if (((byte)local_198[0] & 1) != 0) {
    uVar9 = local_190;
  ...
  if (uVar9 != 0) {
    ...
    if (local_178 < puVar11) {
      ...
      do {
        if ((bVar4) && (*puVar17 != uVar12)) goto LAB_017fe11c;
...
LAB_017fe11c:
  ...
  if (param_2 == (long *)0x0) {
    bVar4 = true;
    if (param_3 != (long *)0x0) goto LAB_017fe170;
LAB_017fe144:
    if (!bVar4) goto LAB_017fe1b4;
  }
  else {
    if ((int *)param_2[3] == (int *)param_2[4]) {
    ...
    param_2 = plVar2;
    if (param_3 == (long *)0x0) goto LAB_017fe144;
LAB_017fe170:
    if ((int *)param_3[3] == (int *)param_3[4]) {
    ...
    if (bVar4 != (iVar7 == -1)) goto LAB_017fe1b4;
  }
  *param_5 = *param_5 | 2;
LAB_017fe1b4:
  if ((local_1b0 & 1) != 0) {
