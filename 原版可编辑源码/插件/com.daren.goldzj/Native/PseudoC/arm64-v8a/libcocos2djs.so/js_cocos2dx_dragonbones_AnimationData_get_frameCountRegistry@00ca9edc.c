...
/* js_cocos2dx_dragonbones_AnimationData_get_frameCountRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_AnimationData_get_frameCountRegistry
...

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xc5c,"js_cocos2dx_dragonbones_AnimationData_get_frameCount");
    __android_log_print(6,"jswrapper",&DAT_01934b91);
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_dragonbones_AnimationData_get_frameCount",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0xc64);
  }
  else {
    se::Value::Value(aVStack_58);
    uint32_to_seval(*(uint *)(lVar3 + 0x1c),aVStack_58);
