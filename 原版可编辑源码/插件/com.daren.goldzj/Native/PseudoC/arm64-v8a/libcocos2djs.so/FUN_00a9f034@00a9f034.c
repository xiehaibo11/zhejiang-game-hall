...
void FUN_00a9f034(long param_1,int param_2)
  ...
  if (bVar7 < 0x2e) {
    if ((1L << ((ulong)bVar7 & 0x3f) & 0x3bbd00000000U) != 0) {
      if (*(long *)(param_1 + 0x18) != 0) {
        thunk_FUN_00aa8a48(*(long *)(param_1 + 0x18),0,"free");
        bVar7 = *(byte *)(param_1 + 0x2fe);
        *(undefined8 *)(param_1 + 0x18) = 0;
      }
      goto LAB_00a9f0d8;
    }
    if ((ulong)bVar7 != 0xd) goto LAB_00a9f0d8;
    lVar9 = *(long *)(param_1 + 0x230);
    if (lVar9 != 0) {
      lVar14 = *(long *)(lVar9 + 0x238);
      if (lVar14 != 0) {
                    /* try { // try from 00a9f1ec to 00b9f20f has its CatchHandler @ 00a9f180 */
        ...
        do {
          ...
          plVar10 = (long *)(lVar14 + 0x240);
                    /* catch() { ... } // from try @ 00a9f1c8 with catch @ 00a9f1fc */
          lVar14 = *plVar10;
        } while (lVar14 != 0);
      }
...
LAB_00a9f170:
      ...
      if (cVar3 == '\x04') {
                    /* try { // try from 00a9f180 to 00b9f1c7 has its CatchHandler @ 00a9f180
                       catch() { ... } // from try @ 00a9f180 with catch @ 00a9f180
                       catch() { ... } // from try @ 00a9f1ec with catch @ 00a9f180 */
      ...
      if ((((cVar3 != '\f') && (param_2 != 9999)) && ((*(uint *)(param_1 + 0x2f4) >> 6 & 1) == 0))
        ...
        if (cVar3 == '\v') {
          if (*(int *)(param_1 + 0x2e8) != 0) goto LAB_00a9f1c8;
        }
        else {
          ...
          if ((cVar3 != '\"') && (cVar3 != '$')) {
            ...
            iVar4 = FUN_00ab3f44(param_1,6,0,0);
            if (0 < iVar4) {
              return;
            }
            do {
              local_50 = 0;
              local_48 = 0;
              iVar4 = FUN_00ab3f44(param_1,0xf,&local_50,0);
                    /* try { // try from 00a9f540 to 00b9f547 has its CatchHandler @ 00a9f7ec */
                    /* try { // try from 00a9f550 to 00b9f55b has its CatchHandler @ 00a9f7dc */
              if ((iVar4 < 0) ||
                 ((local_48 != 0 && (iVar5 = FUN_00aa408c(param_1,local_50), iVar5 != local_48))))
              goto LAB_00a9f298;
            } while (iVar4 != 0);
            if (*(char *)(param_1 + 0x300) == '\x05') {
                    /* try { // try from 00a9f570 to 00b9f57b has its CatchHandler @ 00a9f7f0 */
              if (*(char *)(param_1 + 0x102) == '\0') {
                if ((param_2 == 0) || (param_2 == 9999)) goto LAB_00a9f298;
                *(undefined1 *)(param_1 + 0x102) = 2;
                *(char *)(param_1 + 0x80) = (char)((uint)param_2 >> 8);
                *(char *)(param_1 + 0x81) = (char)param_2;
              }
                    /* try { // try from 00a9f57c to 00b9f83b has its CatchHandler @ 00a9f390 */
              lVar9 = *(long *)(param_1 + 0x220);
              bVar2 = *(byte *)(param_1 + 0x304);
...
LAB_00a9f1c8:
                    /* try { // try from 00a9f1c8 to 00b9f1eb has its CatchHandler @ 00a9f1fc */
...
LAB_00a9f298:
      ...
      if (bVar7 != 0xc) goto LAB_00a9f170;
...
LAB_00a9f308:
    ...
    if ((uVar8 >> 5 & 1) != 0) {
                    /* try { // try from 00a9f390 to 00b9f53f has its CatchHandler @ 00a9f390
                       catch() { ... } // from try @ 00a9f390 with catch @ 00a9f390
                       catch() { ... } // from try @ 00a9f57c with catch @ 00a9f390 */
      (**(code **)(*(long *)(*(long *)(param_1 + 0x228) + 0x188) + 8))
...
LAB_00a9f628:
        ...
        if (iVar4 == 0) {
          ...
          if (iVar4 == 3) {
            ...
            iVar4 = SSL_want(*(SSL **)(param_1 + 0x2b0));
            if (iVar4 != 2) goto LAB_00a9f624;
            uVar6 = 4;
          }
          FUN_00aa3be0(param_1,0,uVar6);
          bVar7 = *(byte *)(param_1 + 0x2f4);
        }
      }
...
LAB_00a9f278:
    ...
    *(undefined8 *)(param_1 + 0x280) = 0;
    if ((*(char *)(param_1 + 0x300) == '\x05') || (*(byte *)(param_1 + 0x2fe) - 3 < 2)) {
      ...
      thunk_FUN_00aa8a48(*(undefined8 *)(param_1 + 0x38),0,"free");
                    /* catch() { ... } // from try @ 00a9f550 with catch @ 00a9f7dc */
      *(undefined8 *)(param_1 + 0x38) = 0;
      if (*(long *)(param_1 + 0x288) != 0) {
                    /* catch() { ... } // from try @ 00a9f540 with catch @ 00a9f7ec */
                    /* catch() { ... } // from try @ 00a9f570 with catch @ 00a9f7f0 */
        thunk_FUN_00aa8a48(*(long *)(param_1 + 0x288),0,"free");
...
LAB_00a9f874:
    ...
    iVar4 = FUN_00ab3f44(param_1,8,0,0);
    if (iVar4 < 0) {
      _lws_log(2,"extension destruction failed\n");
    }
    iVar4 = FUN_00ab4058(lVar13,param_1,9,0,0);
    if (iVar4 < 0) {
  ...
  *(uint *)(param_1 + 0x2f4) = uVar8 | 0x40;
  if ((uVar8 >> 0x14 & 1) == 0) {
    if (*(int *)(param_1 + 0x2d0) < 0) goto LAB_00a9f94c;
    if ((*(byte *)(lVar13 + 0xc79) >> 2 & 1) != 0) {
      if ((uVar8 >> 4 & 1) != 0) {
        uv_poll_stop(param_1 + 0x168);
      }
      FUN_00ab55ac(param_1);
      return;
    }
  }
  else if (*(int *)(param_1 + 0x2d0) < 0) goto LAB_00a9f94c;
