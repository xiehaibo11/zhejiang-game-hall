...
undefined8 FUN_01552cf4(undefined8 param_1,ulong *param_2,Factory *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0xd1);
  }
  if (DAT_01d46d20 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d46d20 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar1 = DAT_01d46d20;
  local_a0 = (byte **)0x0;
  if ((*DAT_01d46d20 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar1,"V8.Runtime_Runtime_BigIntCompareToBigInt",0,0,0,0,0,0,0,
                       &local_50,0);
    plVar4 = local_48;
    local_48 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    local_a0 = &local_98;
    local_90 = "V8.Runtime_Runtime_BigIntCompareToBigInt";
    local_98 = pbVar1;
    local_88 = uVar5;
  }
  uVar7 = *param_2;
  ...
  if (((uVar8 & 1) != 0) &&
     (*(short *)((uVar8 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar8 - 1)) == 0x41)) {
    uVar3 = v8::internal::BigInt::CompareToBigInt(param_2 + -1,param_2 + -2);
