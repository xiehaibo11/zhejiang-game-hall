...
/* void 
   v8::internal::LiveObjectVisitor::VisitBlackObjectsNoFail<v8::internal::EvacuateNewSpacePageVisitor<(v8::internal::PageEvacuationMode)0>,
...
void v8::internal::LiveObjectVisitor::
     VisitBlackObjectsNoFail<v8::internal::EvacuateNewSpacePageVisitor<(v8::internal::PageEvacuationMode)0>,v8::internal::MajorNonAtomicMarkingState>
...

{
    ...
    if ((uVar12 & *puVar1) != 0) {
      ...
      if ((puVar1[bVar6] & uVar12) != 0) {
        ...
        EvacuateNewSpacePageVisitor<(v8::internal::PageEvacuationMode)0>::Visit
                  (param_3,plVar8,uVar7);
      }
    }
    goto joined_r0x00fc783c;
  }
  lVar2 = param_1[2];
  lVar11 = param_1[3];
  lVar3 = param_1[5];
  ...
  if (uVar14 == 0) {
    local_e0 = param_1;
    if (local_e8 != 0) goto LAB_00fc78c0;
LAB_00fc78e8:
    iVar10 = 0;
  }
  else {
    ...
    local_e4 = uVar14;
    if (local_e8 <= uVar14) goto LAB_00fc78e8;
LAB_00fc78c0:
