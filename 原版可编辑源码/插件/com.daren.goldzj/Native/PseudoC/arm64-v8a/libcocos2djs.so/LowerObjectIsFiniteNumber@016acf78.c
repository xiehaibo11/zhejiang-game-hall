...
/* v8::internal::compiler::EffectControlLinearizer::LowerObjectIsFiniteNumber(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerObjectIsFiniteNumber
...

{
  ...
  pNVar6 = (Node *)GraphAssembler::Float64Sub(this_00,pNVar6,pNVar6);
  pNVar6 = (Node *)GraphAssembler::Float64Equal(this_00,pNVar6,pNVar6);
