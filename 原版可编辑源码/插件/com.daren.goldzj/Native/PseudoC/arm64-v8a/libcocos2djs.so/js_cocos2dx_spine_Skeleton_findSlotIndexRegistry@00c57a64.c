...
/* js_cocos2dx_spine_Skeleton_findSlotIndexRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Skeleton_findSlotIndexRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Skeleton *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2502,"js_cocos2dx_spine_Skeleton_findSlotIndex");
    __android_log_print(6,"jswrapper",&DAT_01911986);
  }
  else {
    ...
    if (plVar7[1] - *plVar7 == 0x10) {
      ...
      iVar5 = spine::Skeleton::findSlotIndex(this,(String *)&local_88);
      ...
      if (bVar2) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                            ,0x250c,"js_cocos2dx_spine_Skeleton_findSlotIndex");
        __android_log_print(6,"jswrapper",
                            "js_cocos2dx_spine_Skeleton_findSlotIndex : Error processing arguments")
        ;
      }
      pvVar6 = local_78;
      local_88 = &PTR__String_01c67868;
      ...
      if (!bVar2) goto LAB_00c57cfc;
    }
    else {
      __android_log_print(6,"jswrapper",&DAT_01911a0d,(ulong)(plVar7[1] - *plVar7) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Skeleton_findSlotIndex",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x2512);
LAB_00c57cfc:
  pVVar8 = (Value *)se::State::rval(aSStack_70);
