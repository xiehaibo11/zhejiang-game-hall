...

{
  ...
  puVar3 = *(undefined8 **)(param_7 + 0x10);
  if ((ulong)(*(long *)(param_7 + 0x18) - (long)puVar3) < 0x28) {
    puVar3 = (undefined8 *)Zone::NewExpand(param_7,0x28);
  }
  else {
    *(undefined8 **)(param_7 + 0x10) = puVar3 + 5;
  }
  *puVar3 = param_5;
  puVar3[1] = param_2;
  puVar3[2] = 0;
  puVar3[3] = param_1;
  puVar3[4] = 0xffffffff;
  uStack_58 = (ulong)*(uint *)(this + 0x18) | param_6 << 0x20;
  local_60 = param_3;
  lVar2 = std::__ndk1::
