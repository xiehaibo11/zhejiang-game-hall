...
/* std::__ndk1::__split_buffer<std::__ndk1::pair<v8::internal::compiler::PendingAssessment const*,
   ...
   const*, int>*> >::push_front(std::__ndk1::pair<v8::internal::compiler::PendingAssessment const*,
   int>*&&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_01654a74;
  ...
  if (__src != puVar4) {
    ...
    if ((3 < uVar2) && ((__src + uVar11 + 1 <= puVar1 || (puVar12 + uVar11 + uVar8 + 1 <= __src))))
    {
      ...
      if (uVar2 == uVar11) goto LAB_01654a28;
    }
    do {
      puVar3 = __src + 1;
      puVar10 = puVar9 + 1;
