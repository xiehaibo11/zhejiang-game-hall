...
/* void std::__ndk1::vector<v8::internal::wasm::DebugSideTable::Entry::Constant,
   std::__ndk1::allocator<v8::internal::wasm::DebugSideTable::Entry::Constant>
   >::__push_back_slow_path<v8::internal::wasm::DebugSideTable::Entry::Constant>(v8::internal::wasm::DebugSideTable::Entry::Constant&&)
    */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_017e2b1c;
