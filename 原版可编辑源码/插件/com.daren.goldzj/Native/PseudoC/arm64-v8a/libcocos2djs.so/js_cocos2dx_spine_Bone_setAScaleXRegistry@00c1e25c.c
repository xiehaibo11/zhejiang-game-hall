...
/* js_cocos2dx_spine_Bone_setAScaleXRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_setAScaleXRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Bone *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x716,"js_cocos2dx_spine_Bone_setAScaleX");
    pcVar6 = "js_cocos2dx_spine_Bone_setAScaleX : Invalid Native Object";
LAB_00c1e3d0:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Bone::setAScaleX(this,local_64);
        goto LAB_00c1e408;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x71d,"js_cocos2dx_spine_Bone_setAScaleX");
      pcVar6 = "js_cocos2dx_spine_Bone_setAScaleX : Error processing arguments";
      goto LAB_00c1e3d0;
    }
    __android_log_print(6,"jswrapper",&DAT_018f6561,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_setAScaleX",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x724);
LAB_00c1e408:
