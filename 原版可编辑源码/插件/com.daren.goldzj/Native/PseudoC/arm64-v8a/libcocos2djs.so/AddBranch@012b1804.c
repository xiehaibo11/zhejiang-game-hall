...
/* v8::internal::compiler::Schedule::AddBranch(v8::internal::compiler::BasicBlock*,
   v8::internal::compiler::Node*, v8::internal::compiler::BasicBlock*,
   v8::internal::compiler::BasicBlock*) */

void __thiscall
v8::internal::compiler::Schedule::AddBranch
          (Schedule *this,BasicBlock *param_1,Node *param_2,BasicBlock *param_3,BasicBlock *param_4)

{
  ...
  *(undefined4 *)(param_1 + 0x34) = 3;
  BasicBlock::AddSuccessor(param_1,param_3);
  BasicBlock::AddPredecessor(param_3,param_1);
  BasicBlock::AddSuccessor(param_1,param_4);
  BasicBlock::AddPredecessor(param_4,param_1);
