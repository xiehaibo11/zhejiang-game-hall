...
void FUN_01452e68(ulong param_1)

{
      ...
      *(undefined4 *)(lVar6 + -0x20) = uVar9;
      ...
      if (uVar2 < 0x40) {
        *(undefined4 *)(lVar6 + -0x20) = uVar9;
        ...
        uVar7 = FUN_01345e80(param_1,uVar11);
        lVar6 = unaff_x29[-4];
  ...
  if (bVar3) {
    uVar4 = uVar4 | 2;
    if ((int)uVar11 <= (int)param_1) goto LAB_01452f44;
  }
  else {
...
LAB_01452f48:
  ...
  if ((int)lVar6 != (int)*(undefined8 *)(unaff_x26 + 0xa0)) {
    lVar1 = (ulong)*(ushort *)(lVar5 + lVar15 + 3) * 4 + 0x1f;
    ...
    if (uVar8 != uVar4) {
      ...
      *(undefined4 *)(lVar6 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x01452fc4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(lVar16 + (ulong)*(byte *)(lVar5 + lVar15 + 5) * 8))(uVar7);
  return;
}
