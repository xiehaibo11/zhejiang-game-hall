...
/* v8::internal::JSMap::Initialize(v8::internal::Handle<v8::internal::JSMap>,
   v8::internal::Isolate*) */

void v8::internal::JSMap::Initialize(ulong *param_1,Factory *param_2)

{
  ...
  puVar1 = (ulong *)Factory::NewOrderedHashMap(param_2);
  uVar4 = *param_1;
  uVar3 = *puVar1;
