...
v8::internal::compiler::InstructionSelector::Emit
          ...
          undefined8 param_9,ulong param_10,InstructionOperand *param_11)

{
  ...
  if (param_10 < 0x3f) {
    ...
    uVar2 = 0x30;
    if (lVar1 + param_10 != 0) {
      uVar2 = (long)((lVar1 + param_10 << 0x23) + 0x2800000000) >> 0x20;
    }
    local_78 = param_4;
    uStack_70 = param_5;
    local_68 = param_6;
    ...
    Instruction::Instruction
              (this_01,param_1,(ulong)((param_3 & 7) != 0),(InstructionOperand *)&local_48,6,
               (InstructionOperand *)&local_78,param_10,param_11);
