...
/* void std::__ndk1::vector<std::__ndk1::pair<int, v8::internal::Label*>,
   std::__ndk1::allocator<std::__ndk1::pair<int, v8::internal::Label*> >
   >::__push_back_slow_path<std::__ndk1::pair<int, v8::internal::Label*> >(std::__ndk1::pair<int,
   v8::internal::Label*>&&) */
...

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_0161c630;
