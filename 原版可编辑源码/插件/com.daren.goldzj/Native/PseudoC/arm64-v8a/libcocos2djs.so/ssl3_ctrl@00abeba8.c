...

{
  ...
  iVar6 = 0;
  iVar14 = (int)param_3;
                    /* catch() { ... } // from try @ 00abeb78 with catch @ 00abebdc */
  switch(param_2) {
  case 3:
                    /* catch() { ... } // from try @ 00abeb50 with catch @ 00abebec */
    ...
    if (param_4 == (dh_st *)0x0) {
      ...
      if (group != (EC_GROUP *)0x0) {
        ...
        goto LAB_00abf11c;
                    ...
                    /* try { // try from 00abf154 to 00bbf15b has its CatchHandler @ 00abf464 */
      iVar6 = 0x7c;
                    /* try { // try from 00abf15c to 00bbf31b has its CatchHandler @ 00abf0fc */
      iVar14 = 0xb85;
    }
    goto LAB_00abf160;
  case 6:
...
LAB_00abed24:
  ...
  case 0x58:
    if (param_3 == 0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00abef90 with catch @ 00abf0f8
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00abf15c with catch @ 00abf0fc
                       catch(type#1 @ 00000000) { ... } // from try @ 00abf324 with catch @ 00abf0fc
                        */
...
LAB_00abee70:
  ...
  case 0x6a:
    uVar12 = *(undefined8 *)(param_1 + 0x148);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00abef98 with catch @ 00abef44
                        */
    uVar9 = 0;
    goto LAB_00abef5c;
  case 0x6b:
  ...
  case 0x6c:
    ...
    if (md != (EVP_MD *)0x0) {
      iVar6 = EVP_MD_type(md);
                    /* try { // try from 00abef90 to 00bbef97 has its CatchHandler @ 00abf0f8 */
      param_4->pad = iVar6;
      return 1;
                    /* try { // try from 00abef98 to 00bbf0fb has its CatchHandler @ 00abef44 */
    }
    return 0;
  case 0x6d:
    if (*(int *)(param_1 + 0x38) != 0) {
