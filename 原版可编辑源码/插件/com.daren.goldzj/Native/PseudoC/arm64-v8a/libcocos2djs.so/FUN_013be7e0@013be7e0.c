...
void FUN_013be7e0(long param_1,code *param_2)

{
  ...
  *(undefined8 *)(unaff_x26 + 0x2bc8) = unaff_x27;
  iVar1 = (*param_2)(param_1,&stack0xfffffffffffffff8 + param_1 * 8);
  if (iVar1 != (int)*(undefined8 *)(unaff_x26 + 0x180)) {
    *(undefined8 *)(unaff_x26 + 0x2c28) = 0;
    return;
  }
  *(undefined8 *)(unaff_x26 + 0x40) = 0x13be8ac;
  ...
  *(undefined8 *)(unaff_x26 + 0x38) = 0;
  if (*(long *)(unaff_x26 + 0x2be0) != 0) {
    *(long *)(*(long *)(unaff_x26 + 0x2bf8) + -8) = *(long *)(unaff_x26 + 0x2be0);
                    ...
                    /* WARNING: Could not recover jumptable at 0x013be918. Too many branches */
