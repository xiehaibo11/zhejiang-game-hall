...

{
  ...
  *this_01;
  ...
  pbVar17 = *(basic_string **)(this + 0xa8);
  pbVar23 = pbVar22;
  if (pbVar22 != pbVar17) {
...
LAB_00d21138:
  if (pbVar23 != pbVar17) goto joined_r0x00d21328;
  if (*(basic_string **)(this + 0xb0) == pbVar17) {
    std::__ndk1::
    vector<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::allocator<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>>
    ::
    __push_back_slow_path<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&>
              (this_01,param_1);
    goto joined_r0x00d21328;
  }
  ...
  *(undefined8 *)pbVar17 = 0;
  if (((byte)*param_1 & 1) == 0) {
    ...
    *(undefined8 *)(pbVar17 + 0x10) = *(undefined8 *)(param_1 + 0x10);
...
LAB_00d213c0:
    ...
    pvVar18 = *(void **)(param_1 + 0x10);
    if (uVar10 < 0x17) {
      pbVar22 = pbVar17 + 1;
      *pbVar17 = SUB41((int)uVar10 << 1,0);
      if (uVar10 != 0) goto LAB_00d21378;
    }
    else {
...
joined_r0x00d21328:
  if (param_2) {
    puVar3 = *(undefined8 **)(*(long *)(this + 0x130) + 0x60);
    puVar5 = *(undefined8 **)(*(long *)(this + 0x130) + 0x68);
    while (puVar3 != puVar5) {
      pbVar19 = *(byte **)(this + 0xa0);
...
LAB_00d21218:
      if ((pbVar20 == pbVar6) && (uVar10 = Bone::contains(this_00,pBVar16), (uVar10 & 1) != 0)) {
        puVar4 = *(ulong **)(this + 0xa8);
        lVar13 = *(long *)(pBVar16 + 0xa8);
        pbVar22 = (basic_string *)(lVar13 + 0x18);
        if (puVar4 == *(ulong **)(this + 0xb0)) {
          std::__ndk1::
          vector<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::allocator<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>>
          ::
          __push_back_slow_path<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&>
