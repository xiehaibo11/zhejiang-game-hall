...
/* v8::Proxy::New(v8::Local<v8::Context>, v8::Local<v8::Object>, v8::Local<v8::Object>) */

ulong * v8::Proxy::New(long param_1,undefined8 param_2,undefined8 param_3)
  ...
  if ((*(int *)(pIVar7 + 0x2c20) == (int)uVar9) ||
    ...
    *local_48 = uVar9;
    ...
    if (internal::TracingFlags::runtime_stats != 0) {
      ...
      internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x3c2);
    }
    this = *(Logger **)(pIVar7 + 0x9558);
    uVar9 = internal::Logger::is_logging(this);
    if ((uVar9 & 1) != 0) {
      internal::Logger::ApiEntryCall(this,"v8::Proxy::New");
    }
    uVar1 = *(undefined4 *)(pIVar7 + 0x2c60);
    *(undefined4 *)(pIVar7 + 0x2c60) = 5;
    puVar3 = (ulong *)internal::JSProxy::New(pIVar7,param_2,param_3);
    puVar8 = local_48;
    if (puVar3 == (ulong *)0x0) {
      local_a0 = '\x01';
...
LAB_00ec89f4:
        ...
        if (*(code **)(lVar4 + 0xb738) == (code *)0x0) goto LAB_00ec89f4;
