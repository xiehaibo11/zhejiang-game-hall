...
/* void std::__ndk1::vector<v8::internal::GlobalHandles::TracedNode*,
   std::__ndk1::allocator<v8::internal::GlobalHandles::TracedNode*>
   >::__push_back_slow_path<v8::internal::GlobalHandles::TracedNode*
   const&>(v8::internal::GlobalHandles::TracedNode* const&) */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00f68f98;
