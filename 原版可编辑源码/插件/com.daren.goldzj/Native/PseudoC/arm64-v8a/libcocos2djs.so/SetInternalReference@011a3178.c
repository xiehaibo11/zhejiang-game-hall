...
/* v8::internal::V8HeapExplorer::SetInternalReference(v8::internal::HeapEntry*, int,
   v8::internal::Object, int) */

void __thiscall
v8::internal::V8HeapExplorer::SetInternalReference
          (V8HeapExplorer *this,uint *param_1,int param_2,void *param_4,uint param_5)
