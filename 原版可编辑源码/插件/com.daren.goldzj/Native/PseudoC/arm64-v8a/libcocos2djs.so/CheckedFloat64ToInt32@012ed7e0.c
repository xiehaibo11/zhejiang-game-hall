...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CheckedFloat64ToInt32(v8::internal::compiler::CheckForMinusZeroMode,
   v8::internal::compiler::FeedbackSource const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::CheckedFloat64ToInt32
...

{
  ...
  if ((*param_3 == 0) || ((int)param_3[1] == -1)) {
    if (param_2 == (Operator)0x1) {
      ...
      if (param_2 != (Operator)0x0) goto LAB_012ed838;
      lVar4 = *(long *)this;
      lVar5 = 0x2ea8;
    }
...
LAB_012ed838:
    ...
    Operator::Operator(pOVar2,0x65,0x38,"CheckedFloat64ToInt32",1,1,1,1,1,0);
    pOVar2[0x30] = param_2;
