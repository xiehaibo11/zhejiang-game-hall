...
/* v8::internal::compiler::GraphAssembler::IsZero(v8::internal::TNode<v8::internal::Object>) */

void __thiscall
v8::internal::compiler::GraphAssembler::IsZero(GraphAssembler *this,undefined8 param_2)
