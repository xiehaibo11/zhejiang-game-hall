...
void uv__run_prepare(long param_1)

{
  ...
  pppplVar1 = (long ****)(param_1 + 0x180);
  pppplVar2 = *(long *****)(param_1 + 0x180);
  if (pppplVar1 != pppplVar2) {
    local_10 = *(undefined8 **)(param_1 + 0x188);
    *local_10 = &local_18;
    ppplVar3 = pppplVar2[1];
    *(long ****)(param_1 + 0x188) = ppplVar3;
    *ppplVar3 = (long **)pppplVar1;
    ...
    while ((long ****)local_18 != &local_18) {
      ...
      *local_18 = (long **)pppplVar1;
      ppplVar3 = *(long ****)(param_1 + 0x188);
      local_18[1] = (long **)ppplVar3;
      *ppplVar3 = (long **)local_18;
      *(long ****)(param_1 + 0x188) = local_18;
