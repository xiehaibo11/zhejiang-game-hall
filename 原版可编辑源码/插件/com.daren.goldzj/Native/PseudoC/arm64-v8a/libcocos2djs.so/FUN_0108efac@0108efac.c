...
void FUN_0108efac(undefined8 param_1,ulong param_2,undefined8 param_3,uint param_4,
...

{
  ...
  FUN_0108f4c0(uVar2,uVar2 | *(uint *)(param_2 + 7),param_3,*param_5,param_4,param_6,uVar3);
  return;
}
