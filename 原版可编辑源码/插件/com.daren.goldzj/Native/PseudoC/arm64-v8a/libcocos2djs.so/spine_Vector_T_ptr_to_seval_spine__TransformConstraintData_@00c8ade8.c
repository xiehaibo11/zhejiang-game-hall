...
/* bool 
   spine_Vector_T_ptr_to_seval<spine::TransformConstraintData>(spine::Vector<spine::TransformConstraintData*>
   const&, se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::TransformConstraintData>(Vector *param_1,Value *param_2)
...
LAB_00c8aeb0:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::TransformConstraintData>
