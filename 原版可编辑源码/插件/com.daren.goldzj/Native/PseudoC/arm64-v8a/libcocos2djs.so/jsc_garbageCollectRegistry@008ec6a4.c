...
/* jsc_garbageCollectRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void jsc_garbageCollectRegistry(FunctionCallbackInfo *param_1)

{
  ...
  se::ScriptEngine::garbageCollect(this);
