...
/* v8::internal::Handle<v8::internal::Object>
   v8::internal::Factory::NewNumber<(v8::internal::AllocationType)1>(double) */

void __thiscall
v8::internal::Factory::NewNumber<(v8::internal::AllocationType)1>(Factory *this,double param_1)

{
  ...
  uVar5 = Heap::AllocateRawWithRetryOrFailSlowPath((Heap *)(this + 0x8850),0xc,1,1,2);
