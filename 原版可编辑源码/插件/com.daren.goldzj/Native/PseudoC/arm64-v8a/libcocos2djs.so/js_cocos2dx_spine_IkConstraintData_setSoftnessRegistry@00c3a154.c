...
/* js_cocos2dx_spine_IkConstraintData_setSoftnessRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_IkConstraintData_setSoftnessRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (IkConstraintData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1680,"js_cocos2dx_spine_IkConstraintData_setSoftness");
    pcVar6 = "js_cocos2dx_spine_IkConstraintData_setSoftness : Invalid Native Object";
LAB_00c3a2c8:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::IkConstraintData::setSoftness(this,local_64);
        goto LAB_00c3a300;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1687,"js_cocos2dx_spine_IkConstraintData_setSoftness");
      pcVar6 = "js_cocos2dx_spine_IkConstraintData_setSoftness : Error processing arguments";
      goto LAB_00c3a2c8;
    }
    __android_log_print(6,"jswrapper",&DAT_0190409d,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_IkConstraintData_setSoftness",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x168e);
LAB_00c3a300:
