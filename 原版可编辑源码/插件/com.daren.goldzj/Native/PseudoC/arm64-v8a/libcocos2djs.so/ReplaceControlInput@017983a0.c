...
/* v8::internal::compiler::NodeProperties::ReplaceControlInput(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*, int) */

void v8::internal::compiler::NodeProperties::ReplaceControlInput
...

{
  ...
  pNVar1 = param_1 + 0x20;
  uVar3 = iVar2 + param_3 + (uVar3 & 1) + (uVar4 & 1) + *(int *)(*(long *)param_1 + 0x18);
  pNVar5 = pNVar1;
