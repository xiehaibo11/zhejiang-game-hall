...
ulong * FUN_01091838(undefined8 param_1,undefined8 param_2,ulong *param_3,int param_4)

{
  ...
  FUN_01092838();
  puVar2 = (ulong *)v8::internal::Factory::NewFixedArray((Factory *)this,param_4,0);
    ...
    do {
      if (*(long *)(*puVar3 + (long)iVar5) != -0x8000000080001) {
        puVar4 = (ulong *)v8::internal::Factory::NewNumber<(v8::internal::AllocationType)0>
                                    ((Factory *)this,*(double *)((long)iVar5 + *puVar3));
        uVar7 = *puVar4;
        if ((uVar7 & 1) == 0) {
          uVar6 = 0;
        }
          ...
          if ((*(ushort *)(uVar6 + *(uint *)(uVar7 - 1)) < 0x41) &&
            ...
            puVar4 = (ulong *)v8::internal::StringTable::LookupString(this,puVar4);
            uVar7 = *puVar4;
            uVar6 = uVar7 & 1;
          }
          else {
