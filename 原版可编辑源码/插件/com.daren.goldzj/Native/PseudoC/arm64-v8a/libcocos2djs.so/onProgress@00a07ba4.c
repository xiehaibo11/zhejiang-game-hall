...

{
  ...
  if (plVar2 != (long *)0x0) {
    local_2c = param_2;
                    /* try { // try from 00a07bd8 to 00b07beb has its CatchHandler @ 00a07ddc */
    auVar4 = (**(code **)(*plVar2 + 0x30))(plVar2,param_1,&local_2c);
    param_1 = auVar4._8_8_;
    uVar3 = auVar4._0_8_;
  }
  if (*(long *)(lVar1 + 0x28) == local_28) {
                    /* try { // try from 00a07bf0 to 00b07bf7 has its CatchHandler @ 00a07dd8 */
    return;
  }
                    /* WARNING: Subroutine does not return */
                    /* try { // try from 00a07bfc to 00b07c03 has its CatchHandler @ 00a07dd4 */
