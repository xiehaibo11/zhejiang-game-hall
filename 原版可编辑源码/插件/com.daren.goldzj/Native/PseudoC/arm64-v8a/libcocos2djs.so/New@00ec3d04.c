...
/* v8::SymbolObject::New(v8::Isolate*, v8::Local<v8::Symbol>) */

ulong * v8::SymbolObject::New(long param_1,ulong *param_2)

{
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_60,(ulong)&local_60 | 8,0x3de);
  }
  this = *(Logger **)(param_1 + 0x9558);
  uVar2 = internal::Logger::is_logging(this);
  if ((uVar2 & 1) != 0) {
    internal::Logger::ApiEntryCall(this,"v8::SymbolObject::New");
  }
