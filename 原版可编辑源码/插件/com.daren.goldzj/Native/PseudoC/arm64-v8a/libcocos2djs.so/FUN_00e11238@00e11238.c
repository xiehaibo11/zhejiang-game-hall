...
void FUN_00e11238(long *param_1,int param_2)
...
LAB_00e1132c:
  ...
  puVar37 = puVar41 + 1;
  goto joined_r0x00e11a1c;
joined_r0x00e11450:
  if ((bVar14 >> 4 & 1) != 0) goto LAB_00e11488;
  if ((bVar14 >> 6 & 1) != 0) goto LAB_00e11a40;
...
LAB_00e1195c:
    ...
    if (uVar13 < uVar19) {
      ...
      if (uVar19 <= uVar44 && uVar26 != 0) {
        ...
        uVar43 = (ulong)uVar44;
        puVar37 = puVar41;
        if (uVar43 + 1 < 0x20) goto LAB_00e11898;
        uVar44 = uVar44 + 1 & 0x1f;
        lVar45 = (uVar43 + 1) - (ulong)uVar44;
        if (lVar45 == 0) goto LAB_00e11898;
        if ((puVar41 + 1 < puVar11 + uVar24 + uVar43 + 1) &&
           (puVar11 + uVar24 < puVar41 + uVar43 + 2)) goto LAB_00e11898;
        puVar37 = puVar41 + lVar45;
        uVar19 = uVar19 - (int)lVar45;
        puVar22 = puVar22 + lVar45;
        puVar39 = (undefined8 *)((long)puVar1 + uVar24);
...
LAB_00e11898:
        ...
        if (uVar13 <= uVar26 && uVar26 - uVar13 != 0) {
          uVar19 = uVar13;
          puVar37 = puVar47;
          if (uVar2 < 0x20) goto LAB_00e119d0;
          if (lVar46 == 0) goto LAB_00e119d0;
...
joined_r0x00e11a1c:
  puVar41 = puVar37;
  if ((puVar5 <= puVar41) || (pbVar4 <= pbVar28)) goto LAB_00e11a4c;
  goto LAB_00e1132c;
}
