...
/* void cocos2d::volumeMulti<4, 4, short, short, short, int, short>(short*, unsigned long, short
   const*, int*, short const*, short) */

void cocos2d::volumeMulti<4,4,short,short,short,int,short>
...

{
  ...
  if (param_4 == (int *)0x0) {
    if (7 < param_2) {
      uVar13 = (param_2 - 1) * 8;
                    /* try { // try from 00a95e04 to 00b95e63 has its CatchHandler @ 00a95d1c */
      if ((((uVar13 < ~(ulong)(param_1 + 2) || uVar13 - ~(ulong)(param_1 + 2) == 0) &&
           (param_2 - 1 >> 0x3d == 0)) &&
         ...
         ((uVar13 < ~(ulong)(param_1 + 1) || uVar13 - ~(ulong)(param_1 + 1) == 0 &&
          (uVar13 < ~(ulong)param_1 || uVar13 - ~(ulong)param_1 == 0)))) {
                    /* catch() { ... } // from try @ 00a95d7c with catch @ 00a95e3c */
                    /* catch() { ... } // from try @ 00a95d70 with catch @ 00a95e40 */
                    /* catch() { ... } // from try @ 00a95d84 with catch @ 00a95e48 */
                    /* catch() { ... } // from try @ 00a95ec8 with catch @ 00a95e64
                       catch() { ... } // from try @ 00a960c0 with catch @ 00a95e64 */
        if ((param_3 + param_2 * 4 <= param_1 || param_1 + param_2 * 4 <= param_3) &&
          ...
          do {
            ...
            auVar63 = NEON_ext(auVar34,auVar34,8,1);
            uVar72 = (int)sVar4 * (int)auVar34._0_2_;
            uVar77 = (int)sVar4 * (int)auVar34._2_2_;
            uVar79 = (int)sVar4 * (int)auVar34._4_2_;
            uVar81 = (int)sVar4 * (int)auVar34._6_2_;
            auVar85 = NEON_ext(auVar43,auVar43,8,1);
            ...
            uVar88 = (int)sVar4 * (int)auVar43._6_2_;
                    /* try { // try from 00a95eb0 to 00b95ec7 has its CatchHandler @ 00a960f4 */
            auVar95 = NEON_ext(auVar51,auVar51,8,1);
            ...
            auVar44._12_4_ = uVar70 >> 0xc;
                    /* try { // try from 00a95ec8 to 00b95fef has its CatchHandler @ 00a95e64 */
            uVar71 = (int)sVar4 * (int)auVar63._0_2_;
            uVar76 = (int)sVar4 * (int)auVar63._2_2_;
            uVar78 = (int)sVar4 * (int)auVar63._4_2_;
            uVar80 = (int)sVar4 * (int)auVar63._6_2_;
            auVar64._0_4_ = uVar72 >> 0xc;
            auVar64._4_4_ = uVar77 >> 0xc;
            auVar64._8_4_ = uVar79 >> 0xc;
            auVar64._12_4_ = uVar81 >> 0xc;
            ...
            auVar53[0xe] = bVar17;
            auVar53[0xf] = bVar17;
            auVar100._0_4_ = -(uint)((int)uVar72 >> 0x1b == (int)uVar72 >> 0x1f);
            auVar100._4_4_ = -(uint)((int)uVar77 >> 0x1b == (int)uVar77 >> 0x1f);
            auVar100._8_4_ = -(uint)((int)uVar79 >> 0x1b == (int)uVar79 >> 0x1f);
            auVar100._12_4_ = -(uint)((int)uVar81 >> 0x1b == (int)uVar81 >> 0x1f);
            ...
            auVar101[8] = bVar17 ^ 0xff;
            auVar101[9] = bVar17 ^ 0x7f;
            auVar101[10] = bVar17;
            auVar101[0xb] = bVar17;
            bVar17 = (byte)((int)uVar81 >> 0x1f);
            auVar101[0xc] = bVar17 ^ 0xff;
            auVar101[0xd] = bVar17 ^ 0x7f;
            auVar101[0xe] = bVar17;
            auVar101[0xf] = bVar17;
            ...
            auVar101 = auVar101 ^ (auVar101 ^ auVar64) & auVar100;
            auVar102._0_4_ =
            ...
            auVar65._0_4_ = -(uint)((int)uVar33 >> 0x1b == (int)uVar33 >> 0x1f);
            auVar65._4_4_ = -(uint)((int)uVar38 >> 0x1b == (int)uVar38 >> 0x1f);
            auVar65._8_4_ = -(uint)((int)uVar40 >> 0x1b == (int)uVar40 >> 0x1f);
            auVar65._12_4_ = -(uint)((int)uVar41 >> 0x1b == (int)uVar41 >> 0x1f);
            ...
            auVar66[0xe] = bVar17;
            auVar66[0xf] = bVar17;
            uVar33 = (int)sVar4 * (int)auVar85._0_2_;
            uVar38 = (int)sVar4 * (int)auVar85._2_2_;
            uVar40 = (int)sVar4 * (int)auVar85._4_2_;
            uVar41 = (int)sVar4 * (int)auVar85._6_2_;
            uVar60 = (int)sVar4 * (int)auVar95._0_2_;
            uVar67 = (int)sVar4 * (int)auVar95._2_2_;
            uVar69 = (int)sVar4 * (int)auVar95._4_2_;
            uVar70 = (int)sVar4 * (int)auVar95._6_2_;
            auVar96._0_4_ = uVar21 >> 0xc;
            auVar96._4_4_ = uVar28 >> 0xc;
            auVar96._8_4_ = uVar30 >> 0xc;
            auVar96._12_4_ = uVar31 >> 0xc;
            auVar75._0_4_ = uVar71 >> 0xc;
            auVar75._4_4_ = uVar76 >> 0xc;
            auVar75._8_4_ = uVar78 >> 0xc;
            auVar75._12_4_ = uVar80 >> 0xc;
            auVar8[6] = 0;
            ...
            auVar9._0_8_ = (ulong)CONCAT24((short)(uVar86 >> 0xc),uVar82 >> 0xc) &
                           0xffffffff0000ffff;
            ...
            cVar15 = (char)(uVar71 >> 0x18);
            cVar90 = cVar15 >> 7;
            cVar16 = (char)(uVar76 >> 0x18);
            cVar92 = cVar16 >> 7;
            cVar89 = (char)(uVar78 >> 0x18);
            bVar18 = cVar89 >> 7;
            cVar91 = (char)(uVar80 >> 0x18);
            bVar68 = cVar91 >> 7;
            auVar66 = auVar66 ^ (auVar66 ^ auVar58) & auVar65;
            ...
            auVar59._12_4_ =
                 -(uint)(CONCAT13(bVar68,CONCAT12(bVar68,CONCAT11(bVar68,cVar91 >> 3))) ==
                        CONCAT13(bVar68,CONCAT12(bVar68,CONCAT11(bVar68,bVar68))));
            auVar46 = auVar46 ^ (auVar46 ^ auVar96) & auVar45;
            auVar85[6] = 0;
            auVar85._0_6_ =
                 CONCAT15(cVar92,CONCAT14(cVar92,(uint)(ushort)(CONCAT11(cVar90,cVar90) ^ 0x7fff)))
                 ^ 0x7fff00000000;
            auVar85[7] = cVar92;
            auVar85[8] = bVar18 ^ 0xff;
            auVar85[9] = bVar18 ^ 0x7f;
            auVar85[10] = bVar18;
            auVar85[0xb] = bVar18;
            auVar85[0xc] = bVar68 ^ 0xff;
            auVar85[0xd] = bVar68 ^ 0x7f;
            auVar85[0xe] = bVar68;
            auVar85[0xf] = bVar68;
            auVar95[6] = 0;
            auVar95._0_6_ =
                 ...
                 ^ 0x7fff00000000;
            auVar95[7] = cVar92;
            auVar95[8] = bVar18 ^ 0xff;
            auVar95[9] = bVar18 ^ 0x7f;
            auVar95[10] = bVar18;
            auVar95[0xb] = bVar18;
            auVar95[0xc] = bVar68 ^ 0xff;
            auVar95[0xd] = bVar68 ^ 0x7f;
            auVar95[0xe] = bVar68;
            auVar95[0xf] = bVar68;
            auVar95 = auVar95 ^ (auVar85 ^ auVar75) & auVar59;
            ...
            auVar24[0xe] = bVar17;
            auVar24[0xf] = bVar17;
            auVar97._0_4_ = uVar60 >> 0xc;
            auVar97._4_4_ = uVar67 >> 0xc;
            auVar97._8_4_ = uVar69 >> 0xc;
            auVar97._12_4_ = uVar70 >> 0xc;
            cVar15 = (char)((int)uVar60 >> 0x1f);
            cVar16 = (char)((int)uVar67 >> 0x1f);
            bVar17 = (byte)((int)uVar69 >> 0x1f);
            ...
            auVar10._0_8_ =
                 (ulong)CONCAT24((short)(uVar38 >> 0xc),uVar33 >> 0xc) & 0xffffffff0000ffff;
            ...
            auVar63._0_6_ =
                 ...
                 ^ 0x7fff00000000;
            auVar63[7] = cVar16;
            auVar63[8] = bVar17 ^ 0xff;
            auVar63[9] = bVar17 ^ 0x7f;
            auVar63[10] = bVar17;
            auVar63[0xb] = bVar17;
            auVar63[0xc] = bVar18 ^ 0xff;
            auVar63[0xd] = bVar18 ^ 0x7f;
            auVar63[0xe] = bVar18;
            auVar63[0xf] = bVar18;
            auVar63 = auVar63 ^ (auVar57 ^ auVar97) & auVar35;
            *param_1 = auVar53._0_2_;
            param_1[1] = auVar101._0_2_;
            param_1[2] = auVar103._0_2_;
            param_1[3] = auVar46._0_2_;
            param_1[4] = auVar53._4_2_;
            param_1[5] = auVar101._4_2_;
            param_1[6] = auVar103._4_2_;
            param_1[7] = auVar46._4_2_;
            param_1[8] = auVar53._8_2_;
            param_1[9] = auVar101._8_2_;
            param_1[10] = auVar103._8_2_;
            param_1[0xb] = auVar46._8_2_;
            param_1[0xc] = auVar53._12_2_;
            param_1[0xd] = auVar101._12_2_;
            param_1[0xe] = auVar103._12_2_;
            param_1[0xf] = auVar46._12_2_;
            param_1[0x10] = auVar66._0_2_;
            param_1[0x11] = auVar95._0_2_;
            param_1[0x12] = auVar24._0_2_;
            param_1[0x13] = auVar63._0_2_;
            param_1[0x14] = auVar66._4_2_;
            param_1[0x15] = auVar95._4_2_;
            param_1[0x16] = auVar24._4_2_;
            param_1[0x17] = auVar63._4_2_;
            param_1[0x18] = auVar66._8_2_;
            param_1[0x19] = auVar95._8_2_;
            param_1[0x1a] = auVar24._8_2_;
            param_1[0x1b] = auVar63._8_2_;
            param_1[0x1c] = auVar66._12_2_;
            param_1[0x1d] = auVar95._12_2_;
            param_1[0x1e] = auVar24._12_2_;
            param_1[0x1f] = auVar63._12_2_;
    ...
    do {
                    /* catch() { ... } // from try @ 00a95af4 with catch @ 00a95bb8 */
      ...
      if ((int)uVar60 >> 0x1f != (int)uVar60 >> 0x1b) {
        uVar3 = (ushort)((int)uVar60 >> 0x1f) ^ 0x7fff;
                    ...
                    /* try { // try from 00a95bd4 to 00b95c27 has its CatchHandler @ 00a95bd4
                       catch() { ... } // from try @ 00a95bd4 with catch @ 00a95bd4
                       catch() { ... } // from try @ 00a95cbc with catch @ 00a95bd4 */
      *param_1 = uVar3;
      ...
      param_1[2] = uVar3;
                    /* try { // try from 00a95c28 to 00b95c33 has its CatchHandler @ 00a95cf8 */
      uVar60 = (int)*param_5 * (int)param_3[3];
                    /* try { // try from 00a95c34 to 00b95c3b has its CatchHandler @ 00a95cf4 */
                    /* try { // try from 00a95c3c to 00b95cbb has its CatchHandler @ 00a95d00 */
      uVar3 = (ushort)(uVar60 >> 0xc);
      if ((int)uVar60 >> 0x1f != (int)uVar60 >> 0x1b) {
        uVar3 = (ushort)((int)uVar60 >> 0x1f) ^ 0x7fff;
      }
    ...
    if (3 < param_2) {
      ...
      if (((uVar13 < ~(ulong)(param_1 + 2) || uVar13 - ~(ulong)(param_1 + 2) == 0) &&
         ...
         ((uVar13 < ~(ulong)(param_1 + 3) || uVar13 - ~(ulong)(param_1 + 3) == 0 &&
          ((uVar13 < ~(ulong)(param_1 + 1) || uVar13 - ~(ulong)(param_1 + 1) == 0 &&
           (uVar13 < ~(ulong)param_1 || uVar13 - ~(ulong)param_1 == 0)))))) {
                    /* try { // try from 00a95cbc to 00b95d1b has its CatchHandler @ 00a95bd4 */
        if ((param_3 + param_2 * 4 <= param_1 || param_1 + param_2 * 4 <= param_3) &&
           ((short *)((long)param_5 + 1U) <= param_1 || param_1 + param_2 * 4 <= param_5)) {
                    /* catch() { ... } // from try @ 00a95c34 with catch @ 00a95cf4 */
          uVar14 = param_2 & 0xfffffffffffffffc;
                    /* catch() { ... } // from try @ 00a95c28 with catch @ 00a95cf8 */
                    /* catch() { ... } // from try @ 00a95c3c with catch @ 00a95d00 */
          psVar1 = param_3 + uVar14 * 4;
          puVar2 = (ushort *)(param_1 + uVar14 * 4);
          piVar12 = param_4;
          uVar13 = uVar14;
          do {
            ...
            param_3 = param_3 + 0x10;
                    /* try { // try from 00a95d1c to 00b95d6f has its CatchHandler @ 00a95d1c
                       catch() { ... } // from try @ 00a95d1c with catch @ 00a95d1c
                       catch() { ... } // from try @ 00a95e04 with catch @ 00a95d1c */
            sVar4 = *param_5;
            uVar13 = uVar13 - 4;
            ...
            uVar71 = (int)sVar4 * (int)sVar32;
            uVar76 = (int)sVar4 * (int)sVar36;
            uVar78 = (int)sVar4 * (int)sVar37;
            uVar80 = (int)sVar4 * (int)sVar39;
            auVar93._0_4_ = -(uint)((int)uVar60 >> 0x1b == (int)uVar60 >> 0x1f);
            auVar93._4_4_ = -(uint)((int)uVar67 >> 0x1b == (int)uVar67 >> 0x1f);
            auVar93._8_4_ = -(uint)((int)uVar69 >> 0x1b == (int)uVar69 >> 0x1f);
            auVar93._12_4_ = -(uint)((int)uVar70 >> 0x1b == (int)uVar70 >> 0x1f);
            cVar15 = (char)((int)uVar60 >> 0x1f);
            cVar16 = (char)((int)uVar67 >> 0x1f);
            auVar94._0_6_ =
                 CONCAT15(cVar16,CONCAT14(cVar16,(uint)(ushort)(CONCAT11(cVar15,cVar15) ^ 0x7fff)))
            ...
            auVar94[8] = bVar68 ^ 0xff;
            auVar94[9] = bVar68 ^ 0x7f;
            auVar94[10] = bVar68;
            auVar94[0xb] = bVar68;
            bVar68 = (char)bVar18 >> 7;
            auVar94[0xc] = bVar68 ^ 0xff;
            auVar94[0xd] = bVar68 ^ 0x7f;
            auVar94[0xe] = bVar68;
            auVar94[0xf] = bVar68;
            auVar98._0_4_ = uVar71 >> 0xc;
            auVar98._4_4_ = uVar76 >> 0xc;
            auVar98._8_4_ = uVar78 >> 0xc;
            auVar98._12_4_ = uVar80 >> 0xc;
            auVar6._6_2_ = 0;
            ...
            auVar6[0xe] = bVar18 >> 4;
            auVar6[0xf] = 0;
            auVar94 = auVar94 ^ (auVar94 ^ auVar6) & auVar93;
            uVar82 = (int)sVar4 * (int)sVar42;
            uVar86 = (int)sVar4 * (int)sVar47;
            uVar87 = (int)sVar4 * (int)sVar48;
            uVar88 = (int)sVar4 * (int)sVar49;
            auVar61._0_4_ = -(uint)((int)uVar71 >> 0x1b == (int)uVar71 >> 0x1f);
            auVar61._4_4_ = -(uint)((int)uVar76 >> 0x1b == (int)uVar76 >> 0x1f);
            auVar61._8_4_ = -(uint)((int)uVar78 >> 0x1b == (int)uVar78 >> 0x1f);
            auVar61._12_4_ = -(uint)((int)uVar80 >> 0x1b == (int)uVar80 >> 0x1f);
            ...
            auVar62[8] = bVar17 ^ 0xff;
            auVar62[9] = bVar17 ^ 0x7f;
            auVar62[10] = bVar17;
            auVar62[0xb] = bVar17;
            bVar17 = (byte)((int)uVar80 >> 0x1f);
            auVar62[0xc] = bVar17 ^ 0xff;
            auVar62[0xd] = bVar17 ^ 0x7f;
            auVar62[0xe] = bVar17;
            auVar62[0xf] = bVar17;
            bVar17 = (byte)(uVar87 >> 0x18);
            bVar18 = (byte)(uVar88 >> 0x18);
            auVar62 = auVar62 ^ (auVar62 ^ auVar98) & auVar61;
                    /* try { // try from 00a95d70 to 00b95d7b has its CatchHandler @ 00a95e40 */
            uVar60 = (int)sVar4 * (int)sVar50;
            uVar67 = (int)sVar4 * (int)sVar54;
            uVar69 = (int)sVar4 * (int)sVar55;
            uVar70 = (int)sVar4 * (int)sVar56;
            auVar73._0_4_ = -(uint)((int)uVar82 >> 0x1b == (int)uVar82 >> 0x1f);
            auVar73._4_4_ = -(uint)((int)uVar86 >> 0x1b == (int)uVar86 >> 0x1f);
            auVar73._8_4_ = -(uint)((int)uVar87 >> 0x1b == (int)uVar87 >> 0x1f);
            auVar73._12_4_ = -(uint)((int)uVar88 >> 0x1b == (int)uVar88 >> 0x1f);
            ...
            auVar74[7] = cVar16;
            bVar68 = (char)bVar17 >> 7;
            auVar74[8] = bVar68 ^ 0xff;
            auVar74[9] = bVar68 ^ 0x7f;
            auVar74[10] = bVar68;
            auVar74[0xb] = bVar68;
            bVar68 = (char)bVar18 >> 7;
            auVar74[0xc] = bVar68 ^ 0xff;
            auVar74[0xd] = bVar68 ^ 0x7f;
            auVar74[0xe] = bVar68;
            auVar74[0xf] = bVar68;
                    /* try { // try from 00a95d7c to 00b95d83 has its CatchHandler @ 00a95e3c */
            auVar99._0_4_ = uVar60 >> 0xc;
            auVar99._4_4_ = uVar67 >> 0xc;
            auVar99._8_4_ = uVar69 >> 0xc;
            auVar99._12_4_ = uVar70 >> 0xc;
            auVar7._6_2_ = 0;
            ...
            auVar7[0xe] = bVar18 >> 4;
            auVar7[0xf] = 0;
            auVar74 = auVar74 ^ (auVar74 ^ auVar7) & auVar73;
                    /* try { // try from 00a95d84 to 00b95e03 has its CatchHandler @ 00a95e48 */
            auVar83._0_4_ = -(uint)((int)uVar60 >> 0x1b == (int)uVar60 >> 0x1f);
            auVar83._4_4_ = -(uint)((int)uVar67 >> 0x1b == (int)uVar67 >> 0x1f);
            auVar83._8_4_ = -(uint)((int)uVar69 >> 0x1b == (int)uVar69 >> 0x1f);
            auVar83._12_4_ = -(uint)((int)uVar70 >> 0x1b == (int)uVar70 >> 0x1f);
            cVar15 = (char)((int)uVar60 >> 0x1f);
            cVar16 = (char)((int)uVar67 >> 0x1f);
            auVar84._0_6_ =
                 CONCAT15(cVar16,CONCAT14(cVar16,(uint)(ushort)(CONCAT11(cVar15,cVar15) ^ 0x7fff)))
            ...
            auVar84[7] = cVar16;
            bVar17 = (byte)((int)uVar69 >> 0x1f);
            auVar84[8] = bVar17 ^ 0xff;
            auVar84[9] = bVar17 ^ 0x7f;
            auVar84[10] = bVar17;
            auVar84[0xb] = bVar17;
            bVar17 = (byte)((int)uVar70 >> 0x1f);
            auVar84[0xc] = bVar17 ^ 0xff;
            auVar84[0xd] = bVar17 ^ 0x7f;
            auVar84[0xe] = bVar17;
            auVar84[0xf] = bVar17;
            auVar84 = auVar84 ^ (auVar84 ^ auVar99) & auVar83;
            *param_1 = auVar94._0_2_;
            param_1[1] = auVar62._0_2_;
            param_1[2] = auVar74._0_2_;
            param_1[3] = auVar84._0_2_;
            param_1[4] = auVar94._4_2_;
            param_1[5] = auVar62._4_2_;
            param_1[6] = auVar74._4_2_;
            param_1[7] = auVar84._4_2_;
            param_1[8] = auVar94._8_2_;
            param_1[9] = auVar62._8_2_;
            param_1[10] = auVar74._8_2_;
            param_1[0xb] = auVar84._8_2_;
            param_1[0xc] = auVar94._12_2_;
            param_1[0xd] = auVar62._12_2_;
            param_1[0xe] = auVar74._12_2_;
            param_1[0xf] = auVar84._12_2_;
            ...
            *piVar12 = *piVar12 +
                       ((int)sVar32 + (int)sVar20 + (int)sVar42 + (int)sVar50 >> 2) * iVar5;
            piVar12[1] = piVar12[1] +
    ...
    do {
                    /* try { // try from 00a95ae0 to 00b95aeb has its CatchHandler @ 00a95bb0 */
      sVar4 = *param_3;
      uVar60 = (int)*param_5 * (int)sVar4;
                    /* try { // try from 00a95aec to 00b95af3 has its CatchHandler @ 00a95bac */
                    /* try { // try from 00a95af4 to 00b95b73 has its CatchHandler @ 00a95bb8 */
      uVar3 = (ushort)(uVar60 >> 0xc);
      if ((int)uVar60 >> 0x1f != (int)uVar60 >> 0x1b) {
        uVar3 = (ushort)((int)uVar60 >> 0x1f) ^ 0x7fff;
      }
      *param_1 = uVar3;
      ...
      uVar60 = (int)*param_5 * (int)sVar27;
                    /* try { // try from 00a95b74 to 00b95bd3 has its CatchHandler @ 00a95a8c */
      uVar3 = (ushort)(uVar60 >> 0xc);
      if ((int)uVar60 >> 0x1f != (int)uVar60 >> 0x1b) {
        uVar3 = (ushort)((int)uVar60 >> 0x1f) ^ 0x7fff;
      }
