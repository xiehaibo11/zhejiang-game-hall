...
/* js_cls_set_lineCapRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_cls_set_lineCapRegistry(undefined8 param_1,undefined8 param_2,long *param_3)
  ...
  if (this == (CanvasRenderingContext2D *)0x0) {
    ...
    if (plVar6[1] - *plVar6 == 0x10) {
      ...
      if (bVar1) {
        ...
        cocos2d::CanvasRenderingContext2D::set_lineCap(this,(basic_string *)&local_88);
      }
      if ((local_88 & 1) != 0) {
        operator_delete(local_78);
      }
      if (!bVar1) goto LAB_008e5170;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_cocos2dx_manual.cpp, 406): wrong number of arguments: %d, was expecting %d\n"
