...
/* js_cocos2dx_dragonbones_AnimationState_get_nameRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_AnimationState_get_nameRegistry
...

{
  ...
  if (lVar3 == 0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_AnimationState_get_name : Invalid Native Object");
