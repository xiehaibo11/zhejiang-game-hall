...
/* v8::internal::CompilationCacheScript::Put(v8::internal::Handle<v8::internal::String>,
   v8::internal::Handle<v8::internal::Context>, v8::internal::LanguageMode,
   v8::internal::Handle<v8::internal::SharedFunctionInfo>) */

void __thiscall
v8::internal::CompilationCacheScript::Put
          (CompilationCacheScript *this,undefined8 param_2,undefined8 param_3,uint param_4,
          undefined8 param_5)

{
  ...
  *(int *)(pIVar6 + 0x95b0) = *(int *)(pIVar6 + 0x95b0) + 1;
  ...
  puVar5 = (undefined8 *)
           CompilationCacheTable::PutScript(puVar4,param_2,param_3,param_4 & 1,param_5);
