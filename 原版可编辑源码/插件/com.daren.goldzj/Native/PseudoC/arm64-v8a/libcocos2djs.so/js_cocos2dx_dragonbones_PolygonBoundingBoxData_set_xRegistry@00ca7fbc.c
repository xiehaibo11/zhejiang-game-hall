...
/* js_cocos2dx_dragonbones_PolygonBoundingBoxData_set_xRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_PolygonBoundingBoxData_set_xRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xb57,"js_cocos2dx_dragonbones_PolygonBoundingBoxData_set_x");
    pcVar8 = "js_cocos2dx_dragonbones_PolygonBoundingBoxData_set_x : Invalid Native Object";
  }
  else {
    local_74 = 0.0;
    uVar7 = seval_to_float((Value *)*puVar5,&local_74);
    if ((uVar7 & 1) != 0) {
      *(float *)(lVar6 + 0x20) = local_74;
      goto LAB_00ca8158;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0xb5c,"js_cocos2dx_dragonbones_PolygonBoundingBoxData_set_x");
    pcVar8 = "js_cocos2dx_dragonbones_PolygonBoundingBoxData_set_x : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar8);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_PolygonBoundingBoxData_set_x",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0xb60);
LAB_00ca8158:
