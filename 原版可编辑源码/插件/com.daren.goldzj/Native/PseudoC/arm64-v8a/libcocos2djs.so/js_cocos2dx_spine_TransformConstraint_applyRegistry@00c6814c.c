...
/* js_cocos2dx_spine_TransformConstraint_applyRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_TransformConstraint_applyRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TransformConstraint *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2dba,"js_cocos2dx_spine_TransformConstraint_apply");
    __android_log_print(6,"jswrapper",&DAT_0191916f);
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      spine::TransformConstraint::apply(this);
      goto LAB_00c6829c;
    }
    __android_log_print(6,"jswrapper",&DAT_019191b3,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TransformConstraint_apply",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x2dc4);
LAB_00c6829c:
