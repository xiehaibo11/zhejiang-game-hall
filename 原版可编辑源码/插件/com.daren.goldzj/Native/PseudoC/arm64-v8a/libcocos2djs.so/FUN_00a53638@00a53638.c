...
undefined4
FUN_00a53638(byte *param_1,long param_2,ulong param_3,ulong param_4,undefined8 param_5,
            undefined8 param_6)

{
  ...
  lVar4 = (*(code *)PTR_malloc_01d1b740)(lVar12);
  if (lVar4 == 0) {
    return 0x1b;
  }
  if (param_2 != 0) {
      ...
      if ((!CARRY8(uVar11 * 2,lVar4 + uVar5)) &&
        ...
        if ((lVar4 + uVar5 < param_3 + param_4) && (param_3 < lVar4 + uVar5 + param_4 * 2)) {
          ...
          do {
            ...
            uVar8 = uVar8 - 0x20;
            puVar9 = puVar9 + 4;
                    /* try { // try from 00a5375c to 00b53843 has its CatchHandler @ 00a53508 */
          ...
          uVar8 = uVar7;
          if (uVar7 == param_4) goto LAB_00a537a4;
        }
      }
    }
...
LAB_00a537a4:
  uVar3 = FUN_00a16cf8(lVar12);
  lVar12 = FUN_00a52e14(&PTR_MD5_Init_01c6e520,param_5,0x10);
  if (lVar12 == 0) {
    uVar3 = 0x1b;
  }
  else {
                    /* catch() { ... } // from try @ 00a5358c with catch @ 00a537d4 */
                    /* catch() { ... } // from try @ 00a53580 with catch @ 00a537d8 */
    FUN_00a52fa8(lVar12,lVar4,uVar3);
                    /* catch() { ... } // from try @ 00a53560 with catch @ 00a537dc */
    FUN_00a52fc8(lVar12,param_6);
    uVar3 = 0;
                    /* catch() { ... } // from try @ 00a53598 with catch @ 00a537ec */
  }
