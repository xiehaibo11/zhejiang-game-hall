...

{
  ...
  puVar10[2] = FUN_00d874e0;
  puVar10[1] = FUN_00d874a4;
  *puVar10 = FUN_00d872b0;
...
LAB_00d86c5c:
          ...
          *(undefined4 *)(puVar14 + 6) = 4;
          (*(code *)*puVar14)(param_1);
          if (0 < (int)uVar13) goto LAB_00d86c5c;
          bVar1 = false;
        }
        uVar4 = puVar25[7];
        uVar3 = puVar25[5];
        ...
        if (*(int *)((long)param_1 + 0x15c) == 0) {
          ...
          if ((((uVar3 < 0x40) && (uVar5 < 0xb)) && (uVar4 < 0xb)) &&
            ...
            if (uVar3 == 0) goto LAB_00d86d00;
LAB_00d86db8:
            if (uVar13 != 1) goto LAB_00d86dc0;
          }
          else {
            puVar14 = (undefined8 *)*param_1;
            *(undefined4 *)(puVar14 + 5) = 0x12;
