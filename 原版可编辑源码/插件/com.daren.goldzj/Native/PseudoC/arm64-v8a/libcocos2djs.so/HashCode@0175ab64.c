...
/* v8::internal::compiler::Operator1<v8::internal::compiler::LoadGlobalParameters,
   ...
   v8::internal::compiler::OpHash<v8::internal::compiler::LoadGlobalParameters> >::HashCode() const
    */
...
::HashCode(Operator1<v8::internal::compiler::LoadGlobalParameters,v8::internal::compiler::OpEqualTo<v8::internal::compiler::LoadGlobalParameters>,v8::internal::compiler::OpHash<v8::internal::compiler::LoadGlobalParameters>>
           *this)

{
  ...
  uVar2 = base::hash_value(*(uint *)(this + 0x48));
