...
/* seval_to_Vec3(se::Value const&, cocos2d::Vec3*) */

undefined4 seval_to_Vec3(Value *param_1,Vec3 *param_2)
  ...
  if (param_1[8] == (Value)0x5) {
    ...
    if (((((uVar3 & 1) == 0) || (local_40 != '\x02')) ||
       ...
       (((local_50 != '\x02' ||
        ...
        (local_60 != '\x02')))) {
      uVar2 = cocos2d::Vec3::ZERO;
      uVar4 = 0;
      *(undefined4 *)(param_2 + 8) = DAT_01d37ca8;
    ...
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x115,"seval_to_Vec3");
    __android_log_print(6,"jswrapper","Convert parameter to Vec3 failed!");
    uVar4 = 0;
  }
