...

{
  ...
  if (ret != (BIGNUM *)0x0) {
    pBVar2 = BN_copy(&mont->N,mod);
                    /* try { // try from 00afc328 to 00bfc333 has its CatchHandler @ 00afc3a4 */
    if (pBVar2 != (BIGNUM *)0x0) {
      ...
      local_58.dmax = 2;
      local_58.neg = 0;
                    /* try { // try from 00afc34c to 00bfc353 has its CatchHandler @ 00afc3a8 */
      iVar1 = BN_num_bits(mod);
                    /* try { // try from 00afc354 to 00bfc3e3 has its CatchHandler @ 00afbfe8 */
      uVar5 = iVar1 + 0x7e;
      ...
      if (iVar1 != 0) {
        local_68 = *mod->d;
                    /* catch() { ... } // from try @ 00afc2b8 with catch @ 00afc3a0 */
                    /* catch() { ... } // from try @ 00afc328 with catch @ 00afc3a4 */
        uStack_60 = 0;
                    /* catch() { ... } // from try @ 00afc34c with catch @ 00afc3a8 */
