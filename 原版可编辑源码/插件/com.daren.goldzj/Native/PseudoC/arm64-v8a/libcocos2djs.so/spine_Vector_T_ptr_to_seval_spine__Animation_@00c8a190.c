...
/* bool spine_Vector_T_ptr_to_seval<spine::Animation>(spine::Vector<spine::Animation*> const&,
   se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::Animation>(Vector *param_1,Value *param_2)
...
LAB_00c8a258:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::Animation>
