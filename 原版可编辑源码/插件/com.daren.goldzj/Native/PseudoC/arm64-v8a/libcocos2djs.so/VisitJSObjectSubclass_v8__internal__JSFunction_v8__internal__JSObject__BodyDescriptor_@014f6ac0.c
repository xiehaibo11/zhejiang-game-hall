...
/* int v8::internal::ConcurrentMarkingVisitor::VisitJSObjectSubclass<v8::internal::JSFunction,
   v8::internal::JSObject::BodyDescriptor>(v8::internal::Map, v8::internal::JSFunction) */
