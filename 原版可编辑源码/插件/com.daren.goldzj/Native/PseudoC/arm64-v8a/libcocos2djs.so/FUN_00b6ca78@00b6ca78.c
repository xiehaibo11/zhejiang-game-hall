...
undefined4 FUN_00b6ca78(int *param_1)
  ...
  if ((param_1 == (int *)0x0) || (*param_1 == 0)) {
    ...
    if (iVar1 < 2) {
      ...
      do {
        ...
        if (piVar3 == (int *)0x0) goto LAB_00b6ce1c;
        if (*piVar3 == 1) {
          piVar7 = *(int **)(piVar3 + 2);
          piVar9 = piVar7 + 2;
LAB_00b6cb3c:
...
LAB_00b6cb80:
        ...
        if ((0 < iVar2) || (iVar2 = ASN1_INTEGER_cmp(y,y_01), 0 < iVar2)) goto LAB_00b6cdc8;
...
LAB_00b6cdc4:
        ...
        if (((pBVar4 == (BIGNUM *)0x0) || (iVar2 = BN_add_word(bn,1), iVar2 == 0)) ||
           (ai = BN_to_ASN1_INTEGER(bn,ai), ai == (ASN1_INTEGER *)0x0)) goto LAB_00b6cdac;
...
LAB_00b6ccac:
              *(undefined8 *)(pAVar8 + 8) = 0;
              ...
              pAVar8 = val;
              if (*(int *)val == 0) goto LAB_00b6ccac;
            }
