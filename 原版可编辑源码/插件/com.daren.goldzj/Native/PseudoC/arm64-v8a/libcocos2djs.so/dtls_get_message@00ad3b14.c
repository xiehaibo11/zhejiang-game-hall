...
/* WARNING: Removing unreachable block (ram,0x00ad3fd8) */
...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00ad3b20 to 00bd3b5b has its CatchHandler @ 00ad3bb8 */
  lVar14 = *(long *)(param_1 + 0x26);
  memset((void *)(lVar14 + 0x180),0,0x58);
                    /* try { // try from 00ad3b5c to 00bd3baf has its CatchHandler @ 00ad3ad4 */
LAB_00ad3d24:
  do {
...
LAB_00ad3db8:
      ...
      if (iVar7 < 1) {
        ...
        if (local_174 != '\x01') {
          iVar7 = 0x67;
                    /* catch() { ... } // from try @ 00ad415c with catch @ 00ad41e0 */
          line = 0x2e5;
          goto LAB_00ad41e4;
        }
        local_1d4 = iVar8;
        ...
        *(ulong *)(lVar15 + 0x218) = uVar18;
        ...
        if (iVar7 == 0xc) {
          ...
          if ((uVar11 & 0xffffffff) < uVar18) {
            local_1d4 = iVar8;
                    /* try { // try from 00ad4164 to 00bd41f3 has its CatchHandler @ 00ad40b0 */
          ...
          if (*(ushort *)(lVar15 + 0x10c) != uVar17) {
            if (uVar20 < uVar18 + uVar21) goto LAB_00ad4194;
            ...
            uVar2 = *(ushort *)(*(long *)(param_1 + 0x26) + 0x10c);
                    /* try { // try from 00ad4270 to 00bd4273 has its CatchHandler @ 00ad42b0 */
            if ((((uVar17 <= uVar2) || (uVar18 == uVar20 && ppVar10 != (pitem *)0x0)) ||
              ...
              for (; uVar18 != 0; uVar18 = uVar18 - (long)iVar7) {
                ...
                iVar7 = (**(code **)(*(long *)(param_1 + 2) + 0x68))
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ad4270 with catch @ 00ad42b0
                        */
                if (iVar7 < 1) goto LAB_00ad3cf8;
              }
LAB_00ad3b64:
            ...
            if (uVar18 != uVar20) {
              iVar8 = FUN_00ad4b3c(param_1,local_1d0,&local_1d4);
              uVar18 = (ulong)iVar8;
              iVar7 = local_1d4;
              goto LAB_00ad420c;
            }
            ...
            if (uVar18 < 0x454d) {
              uVar18 = 0x454c;
                    ...
                    /* try { // try from 00ad3bb0 to 00bd3bb7 has its CatchHandler @ 00ad3bb8 */
                    /* catch() { ... } // from try @ 00ad3b20 with catch @ 00ad3bb8
                       catch() { ... } // from try @ 00ad3bb0 with catch @ 00ad3bb8
                       try { // try from 00ad3bb8 to 00bd3bd3 has its CatchHandler @ 00ad3ad4 */
            if ((uVar18 < uVar20) ||
...
LAB_00ad3cf8:
          ...
          local_1d4 = iVar8;
                    /* try { // try from 00ad4060 to 00bd4063 has its CatchHandler @ 00ad409c */
                    /* try { // try from 00ad4064 to 00bd40af has its CatchHandler @ 00ad3ff0 */
          iVar8 = FUN_00ad4ec4(param_1,local_1d0);
          if (iVar8 == 0) {
            if (uVar18 == 0) {
              iVar8 = 0;
            }
            else {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ad4060 with catch @ 00ad409c
                        */
              iVar7 = (**(code **)(*(long *)(param_1 + 2) + 0x68))
                                (param_1,0x16,0,
              ...
              iVar8 = (int)uVar18;
                    /* try { // try from 00ad40b0 to 00bd415b has its CatchHandler @ 00ad40b0
                       catch() { ... } // from try @ 00ad40b0 with catch @ 00ad40b0
                       catch() { ... } // from try @ 00ad4164 with catch @ 00ad40b0 */
              if (iVar7 != iVar8) {
                iVar8 = 0x2f;
          ...
          iVar7 = 0xf4;
          line = 0x2f5;
                    /* try { // try from 00ad415c to 00bd4163 has its CatchHandler @ 00ad41e0 */
LAB_00ad41e4:
          local_1d4 = iVar8;
...
LAB_00ad41f0:
      ...
      iVar8 = 0;
      if (*(ushort *)(lVar15 + 0x10c) != *(ushort *)((long)pvVar19 + 0x10)) goto LAB_00ad3db8;
      if (*(long *)((long)pvVar19 + 0x60) != 0) goto LAB_00ad3db0;
      uVar17 = (uint)*(undefined8 *)((long)pvVar19 + 0x20);
      pqueue_pop(*(pqueue *)(lVar15 + 0x110));
      iVar8 = FUN_00ad4ec4(param_1,pvVar19);
      if (iVar8 == 0) {
                    /* try { // try from 00ad3ff0 to 00bd402f has its CatchHandler @ 00ad3ff0
                       catch(type#1 @ 00000000) { ... } // from try @ 00ad3ff0 with catch @ 00ad3ff0
                       catch(type#1 @ 00000000) { ... } // from try @ 00ad4064 with catch @ 00ad3ff0
                        */
        ...
        CRYPTO_free(*(void **)((long)pvVar19 + 0x58));
        CRYPTO_free(*(void **)((long)pvVar19 + 0x60));
                    /* try { // try from 00ad4030 to 00bd403b has its CatchHandler @ 00ad404c */
        CRYPTO_free(pvVar19);
        pitem_free(ppVar10);
        iVar8 = 1;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ad4030 with catch @ 00ad404c
                        */
        if ((uVar17 | 1) == 0) goto LAB_00ad3db8;
      }
      else {
        if (*(int *)((long)pvVar19 + 0x28) != 0) {
          EVP_CIPHER_CTX_free(*(EVP_CIPHER_CTX **)((long)pvVar19 + 0x30));
    ...
    if (1 < uVar18 + 3) {
      if (((long)uVar18 < 1) && (iVar7 == 0)) {
        ...
        *param_2 = iVar8;
        ...
        if (iVar8 == 0x101) {
          if (*(code **)(param_1 + 0x28) != (code *)0x0) {
                    /* try { // try from 00ad4300 to 00bd4303 has its CatchHandler @ 00ad4348 */
            (**(code **)(param_1 + 0x28))
          ...
          *puVar13 = *(undefined1 *)(lVar14 + 0x180);
          ...
          puVar13[1] = uVar3;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ad4300 with catch @ 00ad4348
                        */
          ...
          *(undefined2 *)(puVar13 + 6) = 0;
                    /* try { // try from 00ad435c to 00bd440f has its CatchHandler @ 00ad435c
                       catch() { ... } // from try @ 00ad435c with catch @ 00ad435c
                       catch() { ... } // from try @ 00ad4414 with catch @ 00ad435c */
          puVar13[8] = 0;
          puVar13[9] = uVar3;
          puVar13[10] = uVar4;
        ...
        uVar12 = 1;
                    ...
                    /* try { // try from 00ad4410 to 00bd4413 has its CatchHandler @ 00ad44d4 */
                    /* try { // try from 00ad4414 to 00bd44e7 has its CatchHandler @ 00ad435c */
      return uVar12;
    }
  } while( true );
}
