...
/* void std::__ndk1::vector<v8::internal::MigrationObserver*,
   std::__ndk1::allocator<v8::internal::MigrationObserver*>
   >::__push_back_slow_path<v8::internal::MigrationObserver*
   const&>(v8::internal::MigrationObserver* const&) */
...
__push_back_slow_path<v8::internal::MigrationObserver*const&>
          (vector<v8::internal::MigrationObserver*,std::__ndk1::allocator<v8::internal::MigrationObserver*>>
           *this,MigrationObserver **param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00fe9bec;
