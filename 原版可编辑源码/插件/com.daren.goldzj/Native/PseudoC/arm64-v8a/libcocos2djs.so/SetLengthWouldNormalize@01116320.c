...
/* v8::internal::JSArray::SetLengthWouldNormalize(unsigned int) */

bool __thiscall v8::internal::JSArray::SetLengthWouldNormalize(JSArray *this,uint param_1)

{
  ...
  if (((*(byte *)((local_8 & 0xffffffff00000000 | 10) + (ulong)*(uint *)(local_8 - 1)) < 0x30) &&
     ...
     uVar1 <= param_1 - 1)) {
    if (0x3ff < (param_1 - 1) - uVar1) {
      return true;
    }
    uVar1 = param_1 + (param_1 >> 1) + 0x10;
    if ((500 < uVar1) &&
       (((5000 < uVar1 || ((local_8 & 1) == 0)) ||
        ((*(byte *)((local_8 & 0xfffffffffffc0000) + 8) & 0x18) == 0)))) {
      iVar2 = JSObject::GetFastElementsUsage((JSObject *)&local_8);
