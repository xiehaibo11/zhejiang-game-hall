...
/* v8::Module::InstantiateModule(v8::Local<v8::Context>, v8::MaybeLocal<v8::Module>
   (*)(v8::Local<v8::Context>, v8::Local<v8::String>, v8::Local<v8::Module>)) */

undefined8 __thiscall v8::Module::InstantiateModule(Module *this,long param_2,undefined8 param_3)

{
  ...
  *(int *)pIVar14 = *(int *)pIVar14 + 1;
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x38b);
  }
  this_00 = *(Logger **)(pIVar9 + 0x9558);
  uVar3 = internal::Logger::is_logging(this_00);
  if ((uVar3 & 1) != 0) {
    internal::Logger::ApiEntryCall(this_00,"v8::Module::InstantiateModule");
  }
  uVar1 = *(undefined4 *)(pIVar9 + 0x2c60);
  *(undefined4 *)(pIVar9 + 0x2c60) = 5;
  uVar3 = internal::Module::Instantiate(pIVar9,this,param_2,param_3);
  if ((uVar3 & 1) == 0) {
    local_a0 = '\x01';
