...
/* js_universe_Device_getDeviceUserNameRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_universe_Device_getDeviceUserNameRegistry(FunctionCallbackInfo *param_1)
  ...
  if (*(long *)(this + 8) - *(long *)this == 0) {
    ...
    if (bVar1) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0x4bc,"js_universe_Device_getDeviceUserName");
      __android_log_print(6,"jswrapper",
                          "js_universe_Device_getDeviceUserName : Error processing arguments");
    }
    if (((byte)local_78[0] & 1) != 0) {
      operator_delete(local_68);
    }
    if (!bVar1) goto LAB_0096e790;
  }
  else {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp, 1215): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(*(long *)(this + 8) - *(long *)this) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_universe_Device_getDeviceUserName",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp"
                      ,0x4c2);
LAB_0096e790:
  pVVar6 = (Value *)se::State::rval(aSStack_60);
