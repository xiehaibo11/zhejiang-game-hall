...
ulong * FUN_01089ef0(ulong *param_1,int param_2)

{
  ...
  *piVar1 = *piVar1 + 1;
  ...
  if (pCVar7 == (CanonicalHandleScope *)0x0) {
    ...
    if (puVar9 == (ulong *)*plVar3) {
      puVar9 = (ulong *)v8::internal::HandleScope::Extend(pIVar10);
    }
    *(ulong **)(pIVar10 + 0x95a0) = puVar9 + 1;
    *puVar9 = uVar12;
  }
  else {
    puVar9 = (ulong *)v8::internal::CanonicalHandleScope::Lookup(pCVar7,uVar12);
  }
  if (param_2 == 0) {
    FUN_01089d94(pIVar10,param_1,puVar8,0,1,iVar6);
  }
  FUN_01089474(pIVar10,param_1,iVar6,puVar8);
  return puVar9;
}
