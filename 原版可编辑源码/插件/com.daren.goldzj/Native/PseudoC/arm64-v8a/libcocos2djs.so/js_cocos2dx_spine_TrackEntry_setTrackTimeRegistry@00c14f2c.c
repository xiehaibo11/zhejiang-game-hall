...
/* js_cocos2dx_spine_TrackEntry_setTrackTimeRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_TrackEntry_setTrackTimeRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TrackEntry *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1e2,"js_cocos2dx_spine_TrackEntry_setTrackTime");
    pcVar6 = "js_cocos2dx_spine_TrackEntry_setTrackTime : Invalid Native Object";
LAB_00c150a0:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::TrackEntry::setTrackTime(this,local_64);
        goto LAB_00c150d8;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1e9,"js_cocos2dx_spine_TrackEntry_setTrackTime");
      pcVar6 = "js_cocos2dx_spine_TrackEntry_setTrackTime : Error processing arguments";
      goto LAB_00c150a0;
    }
    __android_log_print(6,"jswrapper",&DAT_018f1fe1,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TrackEntry_setTrackTime",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1f0);
LAB_00c150d8:
