...
/* void cocos2d::AudioMixer::process_NoResampleOneTrack<2, float, short,
   int>(cocos2d::AudioMixer::state_t*, long) */

void cocos2d::AudioMixer::process_NoResampleOneTrack<2,float,short,int>
...

{
  ...
  long lVar15;
                    ...
                    /* try { // try from 00a7f22c to 00b7f243 has its CatchHandler @ 00a7f420 */
  lVar15 = *(long *)(param_1 + 8);
                    /* try { // try from 00a7f24c to 00b7f257 has its CatchHandler @ 00a7f41c */
  lVar10 = 0x1f - LZCOUNT(*(undefined4 *)param_1);
                    /* try { // try from 00a7f258 to 00b7f263 has its CatchHandler @ 00a7f418 */
  ...
  piVar12 = *(int **)(param_1 + lVar10 * 0xd0 + 0xb0);
                    /* try { // try from 00a7f264 to 00b7f3a3 has its CatchHandler @ 00a7f430 */
    ...
    do {
      ...
      *(long *)psVar2 = lVar15;
      ...
      if ((psVar13 == (short *)0x0) || (((ulong)psVar13 & 3) != 0)) {
                    /* try { // try from 00a7f3a4 to 00b7f487 has its CatchHandler @ 00a7f1d8 */
        ...
        if (((ulong)psVar13 & 3) == 0) {
          return;
                    ...
                    /* catch() { ... } // from try @ 00a7f258 with catch @ 00a7f418 */
                    /* catch() { ... } // from try @ 00a7f24c with catch @ 00a7f41c */
                    /* catch() { ... } // from try @ 00a7f22c with catch @ 00a7f420 */
                    /* catch() { ... } // from try @ 00a7f264 with catch @ 00a7f430 */
      ...
      uVar14 = *(ulong *)psVar2;
      volumeMix<2,false,false,float,short,int>
