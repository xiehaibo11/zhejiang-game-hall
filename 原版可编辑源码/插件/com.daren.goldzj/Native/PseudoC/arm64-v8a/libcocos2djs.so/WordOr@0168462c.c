...
/* v8::internal::compiler::CodeAssembler::WordOr(v8::internal::SloppyTNode<v8::internal::WordT>,
   v8::internal::SloppyTNode<v8::internal::WordT>) */

ulong * __thiscall
v8::internal::compiler::CodeAssembler::WordOr(CodeAssembler *this,Node *param_2,ulong *param_3)
...
LAB_016846a0:
  ...
  if (uVar1 == 0x18) {
    ...
    bVar4 = 1;
joined_r0x01684710:
    if (!bVar2) goto LAB_01684714;
LAB_01684730:
    if (bVar3) {
      this_00 = (RawMachineAssembler *)**(undefined8 **)this;
      pOVar5 = (Operator *)
               CommonOperatorBuilder::Int64Constant
                         ((CommonOperatorBuilder *)(this_00 + 0x48),uVar11 | uVar9);
      iVar7 = 0;
      ppNVar8 = (Node **)0x0;
      goto LAB_01684798;
    }
    ...
    if (uVar1 != 0x17) {
      bVar3 = false;
      bVar4 = 0;
      goto joined_r0x01684710;
    }
    uVar11 = (ulong)*(int *)(uVar11 + 0x2c);
    bVar3 = true;
    bVar4 = 1;
    if (bVar2) goto LAB_01684730;
LAB_01684714:
  ...
  if (this_00[0x30] == (RawMachineAssembler)0x4) {
    pOVar5 = (Operator *)
             MachineOperatorBuilder::Word32Or((MachineOperatorBuilder *)(this_00 + 0x20));
  }
  else {
    pOVar5 = (Operator *)
             MachineOperatorBuilder::Word64Or((MachineOperatorBuilder *)(this_00 + 0x20));
  }
  iVar7 = 2;
  local_40 = param_2;
  puStack_38 = param_3;
