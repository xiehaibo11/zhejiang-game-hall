...
/* v8::internal::Factory::NewJSWeakMap() */

ulong * __thiscall v8::internal::Factory::NewJSWeakMap(Factory *this)

{
  ...
  uVar6 = uVar6 | *(uint *)((uVar6 | *(uint *)((uVar6 | *(uint *)((uVar6 | *(uint *)(*(ulong *)(this
                                                                                               + 
                                                  0x2bc8) - 1)) + 0x13)) + 0x193)) + 0x1b);
  pFVar1 = this + 0x95a0;
  ...
  *(int *)(uVar4 - 1) = (int)*puVar3;
  ...
  lVar2 = *(long *)pFVar1;
  lVar7 = *(long *)(this + 0x95a8);
  *(int *)(this + 0x95b0) = *(int *)(this + 0x95b0) + 1;
  JSWeakCollection::Initialize(puVar3,this);
  *(long *)pFVar1 = lVar2;
  *(int *)(this + 0x95b0) = *(int *)(this + 0x95b0) + -1;
  if (*(long *)(this + 0x95a8) != lVar7) {
    *(long *)(this + 0x95a8) = lVar7;
