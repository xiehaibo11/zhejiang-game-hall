...
/* js_register_gfx_Program(se::Object*) */

undefined8 js_register_gfx_Program(Object *param_1)

{
  ...
  uStack_47 = 0x6d6172676f7250;
  uStack_40 = 0;
  this = (Class *)se::Class::create(&local_48,param_1,__jsb_cocos2d_renderer_GraphicsHandle_proto,
                                    js_gfx_Program_constructorRegistry);
  if (((byte)local_48 & 1) != 0) {
    operator_delete(local_38);
  }
  se::Class::defineFunction(this,"getID",js_gfx_Program_getIDRegistry);
  se::Class::defineFunction(this,"init",js_gfx_Program_initRegistry);
  se::Class::defineFunction(this,"link",js_gfx_Program_linkRegistry);
  se::Class::defineFinalizeFunction(this,js_cocos2d_renderer_Program_finalizeRegistry);
  se::Class::install(this);
  local_30 = (Class *)0x188aff5;
  ...
  __jsb_cocos2d_renderer_Program_proto = se::Class::getProto(this);
  __jsb_cocos2d_renderer_Program_class = this;
