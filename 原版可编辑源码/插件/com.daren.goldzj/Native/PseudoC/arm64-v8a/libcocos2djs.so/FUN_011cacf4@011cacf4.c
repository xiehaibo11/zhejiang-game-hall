...
undefined8 FUN_011cacf4(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0x1af);
  }
  if (DAT_01d3fa88 == (byte *)0x0) {
    plVar8 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d3fa88 = (byte *)(**(code **)(*plVar8 + 0x10))(plVar8,"disabled-by-default-v8.runtime");
  }
  pbVar4 = DAT_01d3fa88;
  local_a0 = (byte **)0x0;
  if ((*DAT_01d3fa88 & 5) != 0) {
    ...
    uVar9 = (**(code **)(*plVar8 + 0x18))
                      (plVar8,0x58,pbVar4,"V8.Runtime_Runtime_ObjectIsExtensible",0,0,0,0,0,0,0,
                       &local_50,0);
    plVar8 = local_48;
    local_48 = (long *)0x0;
    if (plVar8 != (long *)0x0) {
    ...
    local_a0 = &local_98;
    local_90 = "V8.Runtime_Runtime_ObjectIsExtensible";
    local_98 = pbVar4;
    local_88 = uVar9;
  }
  ...
  *(int *)(param_3 + 0x95b0) = iVar10;
  ...
  if (((uVar11 & 1) == 0) ||
    ...
    uVar7 = v8::internal::JSReceiver::IsExtensible(param_2);
