...
/* js_cocos2dx_spine_PathConstraintData_setPositionRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_PathConstraintData_setPositionRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (PathConstraintData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1d34,"js_cocos2dx_spine_PathConstraintData_setPosition");
    pcVar6 = "js_cocos2dx_spine_PathConstraintData_setPosition : Invalid Native Object";
LAB_00c47710:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::PathConstraintData::setPosition(this,local_64);
        goto LAB_00c47748;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1d3b,"js_cocos2dx_spine_PathConstraintData_setPosition");
      pcVar6 = "js_cocos2dx_spine_PathConstraintData_setPosition : Error processing arguments";
      goto LAB_00c47710;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 7487): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
