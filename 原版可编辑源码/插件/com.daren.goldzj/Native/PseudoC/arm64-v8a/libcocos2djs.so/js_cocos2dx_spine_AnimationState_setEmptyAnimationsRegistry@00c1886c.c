...
/* js_cocos2dx_spine_AnimationState_setEmptyAnimationsRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_AnimationState_setEmptyAnimationsRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (AnimationState *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3e3,"js_cocos2dx_spine_AnimationState_setEmptyAnimations");
    pcVar6 = "js_cocos2dx_spine_AnimationState_setEmptyAnimations : Invalid Native Object";
LAB_00c189e0:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::AnimationState::setEmptyAnimations(this,local_64);
        goto LAB_00c18a18;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x3ea,"js_cocos2dx_spine_AnimationState_setEmptyAnimations");
      pcVar6 = "js_cocos2dx_spine_AnimationState_setEmptyAnimations : Error processing arguments";
      goto LAB_00c189e0;
    }
    __android_log_print(6,"jswrapper",&DAT_018f3c73,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_AnimationState_setEmptyAnimations",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x3f1);
LAB_00c18a18:
