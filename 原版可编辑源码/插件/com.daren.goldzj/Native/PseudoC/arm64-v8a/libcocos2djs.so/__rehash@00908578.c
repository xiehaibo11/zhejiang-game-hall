...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<se::Object*, void*>,
   std::__ndk1::__unordered_map_hasher<se::Object*, std::__ndk1::__hash_value_type<se::Object*,
   void*>, std::__ndk1::hash<se::Object*>, true>, std::__ndk1::__unordered_map_equal<se::Object*,
   std::__ndk1::__hash_value_type<se::Object*, void*>, std::__ndk1::equal_to<se::Object*>, true>,
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<se::Object*, void*> > >::__rehash(unsigned
   long) */
...
joined_r0x00908628:
      if (plVar7 != (long *)0x0) {
        do {
          ...
          if ((uVar6 & param_1) == 0) {
            uVar8 = uVar8 & uVar6;
            if (uVar8 != uVar4) goto LAB_0090866c;
LAB_00908630:
            plVar10 = (long *)*plVar7;
            plVar5 = plVar7;
          }
            ...
            if (uVar8 == uVar4) goto LAB_00908630;
LAB_0090866c:
            plVar10 = plVar7;
            if (*(long *)(*(long *)this + uVar8 * 8) == 0) goto LAB_009086c8;
            do {
              plVar9 = plVar10;
              plVar10 = (long *)*plVar9;
