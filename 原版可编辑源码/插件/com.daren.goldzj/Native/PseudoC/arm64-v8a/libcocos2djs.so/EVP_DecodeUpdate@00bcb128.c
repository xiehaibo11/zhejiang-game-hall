...
joined_r0x00bcb320:
    ...
    do {
      bVar2 = in[lVar8];
      if (((char)bVar2 < '\0') || (bVar1 = (&DAT_018ce116)[bVar2], bVar1 == 0xff)) {
LAB_00bcb278:
        uVar5 = 0xffffffff;
        goto LAB_00bcb328;
      }
      if (bVar2 != 0x3d) {
        if (((iVar7 < 1) || ((bVar1 | 0x13) == 0xf3)) && (iVar7 < 3)) goto LAB_00bcb1ec;
        goto LAB_00bcb278;
      }
      iVar7 = iVar7 + 1;
      if (2 < iVar7) goto LAB_00bcb278;
LAB_00bcb1ec:
      if (bVar2 == 0x2d) {
        bVar3 = true;
        goto LAB_00bcb314;
      ...
      uVar5 = n;
      if ((bVar1 | 0x13) != 0xf3) {
        if (0x3f < (int)n) goto LAB_00bcb278;
        uVar5 = n + 1;
    ...
    bVar3 = false;
LAB_00bcb314:
    if ((int)n < 1) goto joined_r0x00bcb320;
LAB_00bcb2a8:
    if ((n & 3) == 0) {
      iVar4 = EVP_DecodeBlock(out,ctx->enc_data,n);
      n = 0;
      uVar5 = 0xffffffff;
      if ((iVar4 < 0) || (iVar4 < iVar7)) goto LAB_00bcb328;
      n = 0;
      iVar6 = (iVar6 - iVar7) + iVar4;
      goto joined_r0x00bcb320;
    }
    if (bVar3) {
      uVar5 = 0xffffffff;
      goto LAB_00bcb328;
