...
undefined8 FUN_015a62b0(undefined8 param_1,undefined8 param_2,long param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_70,(ulong)&local_70 | 8,0x256);
  }
  if (DAT_01d475e0 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d475e0 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d475e0;
  if ((*DAT_01d475e0 & 5) == 0) {
    bVar2 = true;
    ...
    local_78 = (**(code **)(*plVar4 + 0x18))
                         (plVar4,0x58,pbVar3,"V8.Runtime_Runtime_IsWasmTrapHandlerEnabled",0,0,0,0,0
                          ,0,0,&local_40,0);
    plVar4 = local_38;
    local_38 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    bVar2 = false;
    local_80 = "V8.Runtime_Runtime_IsWasmTrapHandlerEnabled";
    local_88 = pbVar3;
  }
  lVar1 = 0xc0;
