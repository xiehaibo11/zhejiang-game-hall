...
void FUN_00a23808(long *param_1,uint param_2,char *param_3,size_t param_4)

{
      ...
      if (psVar3 < (short *)((long)psVar2 + -1)) {
        do {
          ...
          psVar3 = (short *)((long)psVar3 + 1);
                    ...
                    /* try { // try from 00a23940 to 00b239c7 has its CatchHandler @ 00a23940
                       catch() { ... } // from try @ 00a23940 with catch @ 00a23940
                       catch() { ... } // from try @ 00a23ae0 with catch @ 00a23940 */
      if (psVar4 < psVar2) {
        if ((char)*psVar4 == '\r') {
          *(char *)psVar3 = '\n';
          *pcVar1 = '\x01';
  ...
  FUN_00a23524(param_1,param_2,param_3,param_4);
  return;
}
