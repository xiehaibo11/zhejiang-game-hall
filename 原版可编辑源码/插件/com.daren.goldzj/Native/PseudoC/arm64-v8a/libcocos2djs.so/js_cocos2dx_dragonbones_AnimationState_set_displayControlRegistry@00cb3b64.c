...
/* js_cocos2dx_dragonbones_AnimationState_set_displayControlRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_AnimationState_set_displayControlRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x11b7,&DAT_0192a32b);
    pcVar8 = "js_cocos2dx_dragonbones_AnimationState_set_displayControl : Invalid Native Object";
  }
  else {
    uVar7 = seval_to_boolean((Value *)*puVar5,local_74);
    if ((uVar7 & 1) != 0) {
      *(bool *)(lVar6 + 0xf) = local_74[0];
      goto LAB_00cb3cfc;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x11bc,&DAT_0192a32b);
    pcVar8 = 
    "js_cocos2dx_dragonbones_AnimationState_set_displayControl : Error processing new value";
  }
