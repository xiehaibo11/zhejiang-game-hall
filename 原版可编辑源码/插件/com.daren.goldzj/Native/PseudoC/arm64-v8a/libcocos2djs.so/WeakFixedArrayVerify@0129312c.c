...
/* v8::internal::TorqueGeneratedClassVerifiers::WeakFixedArrayVerify(v8::internal::WeakFixedArray,
   v8::internal::Isolate*) */

void v8::internal::TorqueGeneratedClassVerifiers::WeakFixedArrayVerify
...

{
  ...
  if (1 < *(ushort *)((uVar3 | 7) + (ulong)*(uint *)(param_1 - 1)) - 0x97) {
                    /* WARNING: Subroutine does not return */
    V8_Fatal("Check failed: %s.","o.IsWeakFixedArray()");
  }
