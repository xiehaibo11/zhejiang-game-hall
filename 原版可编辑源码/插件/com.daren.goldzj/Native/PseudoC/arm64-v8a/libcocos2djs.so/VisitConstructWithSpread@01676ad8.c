...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitConstructWithSpread() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitConstructWithSpread(BytecodeGraphBuilder *this)

{
  ...
  if ((ulong)(*(long *)(pEVar7 + 0x30) - *(long *)(pEVar7 + 0x28) >> 3) <=
      (ulong)(long)*(int *)(pEVar7 + 0x5c)) goto LAB_01676da0;
  ...
  uVar1 = uVar5 + 2;
  pOVar10 = (Operator *)
            JSOperatorBuilder::ConstructWithSpread
  ...
  *ppNVar12 = pNVar8;
  ...
  if (local_98[0] == 2) {
    ...
    if (local_98[0] == 2) goto LAB_01676d50;
    pNVar8 = local_90;
    if (local_98[0] != 1) goto LAB_01676cd4;
  }
