...
/* js_cocos2dx_dragonbones_CCArmatureDisplay_setDBEventCallbackRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_CCArmatureDisplay_setDBEventCallbackRegistry
...

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1d9e,"js_cocos2dx_dragonbones_CCArmatureDisplay_setDBEventCallback");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_CCArmatureDisplay_setDBEventCallback : Invalid Native Object"
                       );
  }
  else {
    ...
    if (puVar5[1] - (long)pVVar6 == 0x10) {
      ...
      if (pVVar6[8] == (Value)0x5) {
        ...
        if ((uVar8 & 1) == 0) goto LAB_00cc9594;
...
LAB_00cc9680:
        ...
        if (local_a0 == (long *)0x0) goto LAB_00cc9598;
        if (alStack_c0 != local_a0) {
          local_d0 = (long *)(**(code **)(*local_a0 + 0x10))();
          if (local_d0 != (long *)0x0) goto LAB_00cc9700;
          goto LAB_00cc959c;
        }
        local_d0 = local_f0;
        (**(code **)(*local_a0 + 0x18))(local_a0,local_f0);
        if (local_d0 == (long *)0x0) goto LAB_00cc959c;
LAB_00cc9700:
...
LAB_00cc959c:
      ...
      FUN_00cd7f88(alStack_90,lVar4 + 0x70);
      if (alStack_90 == local_70) {
        pcVar11 = *(code **)(*local_70 + 0x20);
LAB_00cc9614:
        (*pcVar11)();
...
LAB_00cc9640:
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp, 7622): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(puVar5[1] - (long)pVVar6) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_CCArmatureDisplay_setDBEventCallback",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x1dc9);
LAB_00cc954c:
