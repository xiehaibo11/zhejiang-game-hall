...
/* void JSBClassType::registerClass<spine::VertexEffectDelegate>(se::Class*) */

void JSBClassType::registerClass<spine::VertexEffectDelegate>(Class *param_1)
