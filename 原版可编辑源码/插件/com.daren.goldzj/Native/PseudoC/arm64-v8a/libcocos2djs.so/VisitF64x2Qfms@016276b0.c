...
/* v8::internal::compiler::InstructionSelector::VisitF64x2Qfms(v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::InstructionSelector::VisitF64x2Qfms(InstructionSelector *this,Node *param_1)

{
  ...
  Emit(this,0x10d,(uVar1 & 0xffffffff) << 3 | 0xf800000001,(uVar2 & 0xffffffff) << 3 | 0x5800000001,
