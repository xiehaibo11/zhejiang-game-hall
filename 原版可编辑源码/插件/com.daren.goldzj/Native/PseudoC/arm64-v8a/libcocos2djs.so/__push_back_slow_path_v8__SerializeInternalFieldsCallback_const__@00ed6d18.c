...
/* void std::__ndk1::vector<v8::SerializeInternalFieldsCallback,
   std::__ndk1::allocator<v8::SerializeInternalFieldsCallback>
   >::__push_back_slow_path<v8::SerializeInternalFieldsCallback
   const&>(v8::SerializeInternalFieldsCallback const&) */
...
::__push_back_slow_path<v8::SerializeInternalFieldsCallback_const&>
          (vector<v8::SerializeInternalFieldsCallback,std::__ndk1::allocator<v8::SerializeInternalFieldsCallback>>
           *this,SerializeInternalFieldsCallback *param_1)

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_00ed6e04;
