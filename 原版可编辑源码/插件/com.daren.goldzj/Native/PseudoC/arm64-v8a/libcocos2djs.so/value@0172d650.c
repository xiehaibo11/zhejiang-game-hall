...
/* v8::internal::compiler::FeedbackCellRef::value() const */

undefined1  [16] __thiscall v8::internal::compiler::FeedbackCellRef::value(FeedbackCellRef *this)

{
  ...
  if (*(int *)(*(undefined8 **)this + 1) == 2) {
    ...
    if (*(short *)(*(long *)(lVar4 + 0x10) + 0x18) != 0x5d) {
                    /* WARNING: Subroutine does not return */
  ...
  if (*(int *)(puVar5 + 1) == 2) {
    if ((*(byte *)*puVar5 & 1) == 0) goto LAB_0172d760;
  }
