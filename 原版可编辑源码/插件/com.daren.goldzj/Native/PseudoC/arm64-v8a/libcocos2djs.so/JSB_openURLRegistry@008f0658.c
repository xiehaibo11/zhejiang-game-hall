...
/* JSB_openURLRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_openURLRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar5[1] == *plVar5) {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_global.cpp, 1076): wrong number of arguments: %d, was expecting %d\n"
                        ,0,1);
  }
  else {
    local_70 = 0;
    ...
    if (bVar1) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0x42f,"JSB_openURL");
      __android_log_print(6,"jswrapper","url is invalid!");
    }
    else {
      cocos2d::Application::openURL(cocos2d::Application::_instance,(basic_string *)&local_78);
    }
    if ((local_78 & 1) != 0) {
      operator_delete(local_68);
    }
    if (!bVar1) goto LAB_008f078c;
  }
