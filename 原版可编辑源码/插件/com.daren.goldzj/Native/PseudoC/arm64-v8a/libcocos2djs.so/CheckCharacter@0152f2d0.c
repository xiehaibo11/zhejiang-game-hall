...
/* v8::internal::RegExpBytecodeGenerator::CheckCharacter(unsigned int, v8::internal::Label*) */

void __thiscall
v8::internal::RegExpBytecodeGenerator::CheckCharacter
...

{
  ...
  if (param_1 < 0x800000) {
    ...
    *(uint *)(*(long *)(this + 0x28) + (long)iVar4) = param_1 << 8 | 0x18;
  }
  else {
    iVar4 = *(int *)(this + 0x38);
    if (*(int *)(this + 0x30) <= iVar4 + 3) {
    ...
    *(undefined4 *)(*(long *)(this + 0x28) + (long)iVar4) = 0x17;
    iVar2 = *(int *)(this + 0x38);
    iVar4 = iVar2 + 4;
    *(int *)(this + 0x38) = iVar4;
