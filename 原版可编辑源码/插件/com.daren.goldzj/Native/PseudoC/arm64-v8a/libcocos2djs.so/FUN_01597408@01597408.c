...
undefined8 FUN_01597408(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0x206);
  }
  if (DAT_01d473d0 == (byte *)0x0) {
    plVar5 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d473d0 = (byte *)(**(code **)(*plVar5 + 0x10))(plVar5,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d473d0;
  local_a0 = (byte **)0x0;
  if ((*DAT_01d473d0 & 5) != 0) {
    ...
    uVar6 = (**(code **)(*plVar5 + 0x18))
                      (plVar5,0x58,pbVar3,"V8.Runtime_Runtime_StringGreaterThanOrEqual",0,0,0,0,0,0,
                       0,&local_50,0);
    plVar5 = local_48;
    local_48 = (long *)0x0;
    if (plVar5 != (long *)0x0) {
    ...
    local_a0 = &local_98;
    local_90 = "V8.Runtime_Runtime_StringGreaterThanOrEqual";
    local_98 = pbVar3;
    local_88 = uVar6;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar7 & 1) != 0) &&
    ...
    if (((uVar7 & 1) != 0) &&
      ...
      uVar7 = v8::internal::ComparisonResultToBool(0x15,uVar4);
      lVar1 = 0xb8;
      if ((uVar7 & 1) == 0) {
        lVar1 = 0xc0;
      }
