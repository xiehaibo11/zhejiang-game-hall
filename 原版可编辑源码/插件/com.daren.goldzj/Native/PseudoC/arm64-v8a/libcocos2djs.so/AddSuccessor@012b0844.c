...
void __thiscall
v8::internal::compiler::BasicBlock::AddSuccessor(BasicBlock *this,BasicBlock *param_1)

{
  ...
  if (puVar4 == *(undefined8 **)(this + 0x70)) {
    lVar6 = (long)puVar4 - *(long *)(this + 0x60) >> 3;
    uVar1 = lVar6 + 1;
    if (uVar1 >> 0x1c != 0) {
                    /* WARNING: Subroutine does not return */
      abort();
    }
    lVar3 = (long)*(undefined8 **)(this + 0x70) - *(long *)(this + 0x60);
    uVar7 = lVar3 >> 2;
    if (uVar1 <= uVar7) {
      uVar1 = uVar7;
    }
