...
/* js_cocos2dx_spine_SkeletonAnimation_setTrackCompleteListenerRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonAnimation_setTrackCompleteListenerRegistry
...

{
  ...
  if (this == (SkeletonAnimation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x37d3,"js_cocos2dx_spine_SkeletonAnimation_setTrackCompleteListener");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonAnimation_setTrackCompleteListener : Invalid Native Object"
                       );
  }
  else {
    ...
    if (plVar5[1] - (long)pVVar10 == 0x20) {
      ...
      if (pVVar10[0x18] == (Value)0x5) {
        ...
        if ((uVar8 & 1) == 0) goto LAB_00c78b00;
...
LAB_00c78b28:
        ...
        if (!bVar3) goto LAB_00c78b08;
LAB_00c78b60:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                            ,0x37f9,"js_cocos2dx_spine_SkeletonAnimation_setTrackCompleteListener");
        __android_log_print(6,"jswrapper",
                            "js_cocos2dx_spine_SkeletonAnimation_setTrackCompleteListener : Error processing arguments"
                           );
        bVar3 = false;
      }
      else {
LAB_00c78b00:
        local_b0 = (long *)0x0;
        if (bVar3) goto LAB_00c78b60;
LAB_00c78b08:
        spine::SkeletonAnimation::setTrackCompleteListener(this,pTVar7,(function *)alStack_d0);
        bVar3 = true;
      }
...
LAB_00c78bd0:
      ...
      if (bVar3) goto LAB_00c78c04;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 14333): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar5[1] - (long)pVVar10) >> 4,2);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonAnimation_setTrackCompleteListener",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x3800);
LAB_00c78c04:
