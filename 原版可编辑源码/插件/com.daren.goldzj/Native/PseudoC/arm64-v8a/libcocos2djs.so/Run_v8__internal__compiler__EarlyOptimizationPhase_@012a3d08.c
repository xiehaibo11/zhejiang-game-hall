...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::EarlyOptimizationPhase>()
    */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::EarlyOptimizationPhase>
          (PipelineImpl *this)

{
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFEarlyOptimization");
  EarlyOptimizationPhase::Run(aEStack_18,pPVar5,pZVar2);
