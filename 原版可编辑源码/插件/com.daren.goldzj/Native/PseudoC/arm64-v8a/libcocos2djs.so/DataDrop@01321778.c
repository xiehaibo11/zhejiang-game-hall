...
/* v8::internal::compiler::WasmGraphBuilder::DataDrop(unsigned int, int) */

void v8::internal::compiler::WasmGraphBuilder::DataDrop(uint param_1,int param_2)

{
  ...
  uStack_60 = MachineGraph::Int32Constant(*(MachineGraph **)(uVar1 + 8),0xb3);
  ...
  **(undefined8 **)(uVar1 + 0x20) = pNVar5;
  pOVar2 = (Operator *)
           MachineOperatorBuilder::Store
                     (*(MachineOperatorBuilder **)(*(long *)(uVar1 + 8) + 0x10),4);
  pGVar4 = *(Graph **)*(MachineGraph **)(uVar1 + 8);
  uVar3 = MachineGraph::IntPtrConstant(*(MachineGraph **)(uVar1 + 8),(ulong)(uint)(param_2 << 2));
  local_58 = MachineGraph::Int32Constant(*(MachineGraph **)(uVar1 + 8),0);
