...
/* js_engine_FileUtils_writeToFileRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_engine_FileUtils_writeToFileRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar9 == (long *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x142,"js_engine_FileUtils_writeToFile");
    __android_log_print(6,"jswrapper","js_engine_FileUtils_writeToFile : Invalid Native Object");
  }
  else {
    ...
    if (plVar10[1] - *plVar10 == 0x20) {
      ...
      if ((uVar6 & uVar7 & 1) == 0) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                            ,0x14b,"js_engine_FileUtils_writeToFile");
        __android_log_print(6,"jswrapper",
                            "js_engine_FileUtils_writeToFile : Error processing arguments");
LAB_00895edc:
        bVar2 = false;
      }
      else {
        bVar5 = (**(code **)(*plVar9 + 0xc0))(plVar9,&local_70,&local_b0);
        pVVar11 = (Value *)se::State::rval(aSStack_98);
        uVar12 = boolean_to_seval((bool)(bVar5 & 1),pVVar11);
        if ((uVar12 & 1) == 0) {
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                              ,0x14e,"js_engine_FileUtils_writeToFile");
          __android_log_print(6,"jswrapper",
                              "js_engine_FileUtils_writeToFile : Error processing arguments");
          goto LAB_00895edc;
        }
      ...
      if (bVar2) goto LAB_00895f64;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 337): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar10[1] - *plVar10) >> 4,2);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_FileUtils_writeToFile",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x154);
LAB_00895f64:
  pVVar11 = (Value *)se::State::rval(aSStack_98);
