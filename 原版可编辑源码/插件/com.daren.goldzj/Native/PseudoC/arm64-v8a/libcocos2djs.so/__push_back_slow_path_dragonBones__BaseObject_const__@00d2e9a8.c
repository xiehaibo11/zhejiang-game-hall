...
/* void std::__ndk1::vector<dragonBones::BaseObject*,
   std::__ndk1::allocator<dragonBones::BaseObject*>
   >::__push_back_slow_path<dragonBones::BaseObject* const&>(dragonBones::BaseObject* const&) */
...
__push_back_slow_path<dragonBones::BaseObject*const&>
          (vector<dragonBones::BaseObject*,std::__ndk1::allocator<dragonBones::BaseObject*>> *this,
          BaseObject **param_1)
...
LAB_00d2ea0c:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d2ea0c;
  }
  else {
