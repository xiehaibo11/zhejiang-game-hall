...
/* std::__ndk1::__tree<v8::internal::AccessorPair, std::__ndk1::less<v8::internal::AccessorPair>,
   std::__ndk1::allocator<v8::internal::AccessorPair>
   >::destroy(std::__ndk1::__tree_node<v8::internal::AccessorPair, void*>*) */
