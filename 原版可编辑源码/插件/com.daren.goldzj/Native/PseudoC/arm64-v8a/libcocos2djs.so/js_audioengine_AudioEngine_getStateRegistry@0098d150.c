...
/* js_audioengine_AudioEngine_getStateRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_audioengine_AudioEngine_getStateRegistry(FunctionCallbackInfo *param_1)
  ...
  if (uVar7 == 0x10) {
    ...
    if ((uVar7 & 1) == 0) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0x238,"js_audioengine_AudioEngine_getState");
      __android_log_print(6,"jswrapper",
                          "js_audioengine_AudioEngine_getState : Error processing arguments");
    }
    else {
      iVar3 = cocos2d::AudioEngine::getState(local_64);
      pVVar6 = (Value *)se::State::rval(aSStack_60);
      uVar7 = int32_to_seval(iVar3,pVVar6);
      if ((uVar7 & 1) != 0) goto LAB_0098d30c;
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_audioengine_auto.cpp"
                          ,0x23b,"js_audioengine_AudioEngine_getState");
      __android_log_print(6,"jswrapper",
                          "js_audioengine_AudioEngine_getState : Error processing arguments");
    }
  }
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_audioengine_auto.cpp, 574): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_audioengine_AudioEngine_getState",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_audioengine_auto.cpp"
                      ,0x241);
LAB_0098d30c:
  pVVar6 = (Value *)se::State::rval(aSStack_60);
