...

{
  ...
  stack_st_X509_EXTENSION *psVar2;
                    ...
                    /* try { // try from 00b5e0d8 to 00c5e0df has its CatchHandler @ 00b5e1e8 */
                    /* try { // try from 00b5e0e0 to 00c5e233 has its CatchHandler @ 00b5def4 */
  if (x == (stack_st_X509_EXTENSION **)0x0) {
    ...
    if ((psVar2 == (stack_st_X509_EXTENSION *)0x0) &&
      ...
      if (a == (X509_EXTENSION *)0x0) goto LAB_00b5e1a0;
      if (loc <= iVar1 && -1 < loc) {
        iVar1 = loc;
      }
