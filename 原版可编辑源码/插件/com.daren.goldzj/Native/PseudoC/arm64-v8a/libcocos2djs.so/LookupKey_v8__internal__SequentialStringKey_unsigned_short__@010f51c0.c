...
/* v8::internal::Handle<v8::internal::String>
   v8::internal::StringTable::LookupKey<v8::internal::SequentialStringKey<unsigned short>
   >(v8::internal::Isolate*, v8::internal::SequentialStringKey<unsigned short>*) */

void v8::internal::StringTable::LookupKey<v8::internal::SequentialStringKey<unsigned_short>>
               (Isolate *param_1,SequentialStringKey *param_2)
