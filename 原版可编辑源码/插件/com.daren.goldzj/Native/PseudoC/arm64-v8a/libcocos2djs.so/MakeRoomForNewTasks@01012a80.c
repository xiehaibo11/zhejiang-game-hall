...
/* v8::internal::MemoryAllocator::Unmapper::MakeRoomForNewTasks() */

bool __thiscall v8::internal::MemoryAllocator::Unmapper::MakeRoomForNewTasks(Unmapper *this)

{
  int iVar1;
  long lVar2;
  
  if ((*(long *)(this + 0xb8) == 0) && (0 < *(long *)(this + 0xb0))) {
    lVar2 = 0;
    do {
