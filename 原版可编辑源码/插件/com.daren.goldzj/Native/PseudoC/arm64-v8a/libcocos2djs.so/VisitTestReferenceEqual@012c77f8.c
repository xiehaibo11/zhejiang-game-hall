...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitTestReferenceEqual(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitTestReferenceEqual
