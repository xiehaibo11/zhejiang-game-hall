...
/* spine::EventQueue::event(spine::TrackEntry*, spine::Event*) */

void __thiscall spine::EventQueue::event(EventQueue *this,TrackEntry *param_1,Event *param_2)
