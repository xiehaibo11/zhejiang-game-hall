...
LAB_017fae84:
  ...
  if ((param_2 == (long *)0x0) || (param_2[3] != param_2[4])) {
    if (param_3 != (long *)0x0) goto LAB_017fae98;
LAB_017faee0:
    param_3 = (long *)0x0;
    if (plVar17 == (long *)0x0) goto LAB_017fafd0;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_017faee0;
LAB_017fae98:
  ...
  iVar5 = __num_get<char>::__stage2_int_loop
                    (cVar3,iVar6,pcVar19,&local_168,&local_174,local_130[0],local_148,local_12c,
                     &local_170,(char *)aiStack_8c);
  if (iVar5 != 0) goto LAB_017fafd0;
  param_2 = plVar17;
...
LAB_017fafd0:
  ...
  uVar4 = FUN_01828990(pcVar19,local_168,param_5,iVar6);
  *param_6 = uVar4;
  uVar7 = (ulong)((byte)local_148[0] >> 1);
  if (((byte)local_148[0] & 1) != 0) {
    uVar7 = local_140;
  ...
  if (uVar7 != 0) {
    ...
    if (local_12c < puVar9) {
      ...
      do {
        if ((bVar16) && (*puVar15 != uVar10)) goto LAB_017fb124;
...
LAB_017fb124:
  ...
  if ((plVar17 == (long *)0x0) || (plVar17[3] != plVar17[4])) {
    if (param_3 != (long *)0x0) goto LAB_017fb140;
LAB_017fb1ec:
    if (plVar18 != (long *)0x0) goto LAB_017fb174;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_017fb1ec;
LAB_017fb140:
