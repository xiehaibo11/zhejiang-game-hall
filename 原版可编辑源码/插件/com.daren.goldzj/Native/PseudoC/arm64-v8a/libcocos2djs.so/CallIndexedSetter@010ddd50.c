...
/* v8::internal::PropertyCallbackArguments::CallIndexedSetter(v8::internal::Handle<v8::internal::InterceptorInfo>,
   unsigned int, v8::internal::Handle<v8::internal::Object>) */

PropertyCallbackArguments * __thiscall
v8::internal::PropertyCallbackArguments::CallIndexedSetter
...

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    ...
    RuntimeCallStats::Enter(local_a0,(ulong)&local_a0 | 8,0x93);
  }
    ...
    *(long **)(lVar7 + 0x2c58) = &local_b8;
    ...
    if ((uVar6 & 1) != 0) {
      Logger::ApiIndexedPropertyAccess
                (this_00,"interceptor-indexed-set",*(undefined8 *)(this + 0x20),param_3);
    }
