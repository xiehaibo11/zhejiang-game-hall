...

{
  ...
  if (((byte)UVar1 & 1) == 0) {
    UVar1 = this[0x88];
                    /* try { // try from 009e2098 to 00ae209f has its CatchHandler @ 009e225c */
  }
  else {
    operator_delete(*(void **)(this + 0xb0));
                    /* try { // try from 009e210c to 00ae2127 has its CatchHandler @ 009e22d8 */
    UVar1 = this[0x88];
  }
  if (((byte)UVar1 & 1) == 0) {
    UVar1 = this[0x68];
                    /* try { // try from 009e20a0 to 00ae20ab has its CatchHandler @ 009e2258 */
  }
  else {
  ...
  if (((byte)UVar1 & 1) == 0) {
    ...
    operator_delete(*(void **)(this + 0x78));
                    /* try { // try from 009e212c to 00ae216f has its CatchHandler @ 009e22a8 */
    UVar1 = this[0x50];
  }
  if (((byte)UVar1 & 1) == 0) {
                    /* try { // try from 009e20ac to 00ae20c3 has its CatchHandler @ 009e2280 */
    UVar1 = this[0x38];
  }
  else {
  ...
  if (((byte)UVar1 & 1) == 0) {
                    /* try { // try from 009e20c4 to 00ae20d7 has its CatchHandler @ 009e2270 */
    return;
  }
