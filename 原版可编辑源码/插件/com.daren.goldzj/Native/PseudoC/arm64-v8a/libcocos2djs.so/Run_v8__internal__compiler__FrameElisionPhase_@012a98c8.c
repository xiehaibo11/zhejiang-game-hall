...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::FrameElisionPhase>() */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::FrameElisionPhase>
          (PipelineImpl *this)

{
  ...
  lVar2 = ZoneStats::NewEmptyZone(this_01,"V8.TFFrameElision");
  FrameElider::FrameElider(aFStack_18,*(InstructionSequence **)(lVar5 + 0x110));
  FrameElider::Run(aFStack_18);
