...
/* js_renderer_NodeProxy_clearAssemblerRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_NodeProxy_clearAssemblerRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (NodeProxy *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x4e0,"js_renderer_NodeProxy_clearAssembler");
    __android_log_print(6,"jswrapper","js_renderer_NodeProxy_clearAssembler : Invalid Native Object"
                       );
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      cocos2d::renderer::NodeProxy::clearAssembler(this);
      goto LAB_0093e248;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 1255): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_NodeProxy_clearAssembler",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0x4ea);
LAB_0093e248:
