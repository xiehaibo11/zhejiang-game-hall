...
/* js_gfx_VertexBuffer_selfRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_gfx_VertexBuffer_selfRegistry(FunctionCallbackInfo *param_1)
