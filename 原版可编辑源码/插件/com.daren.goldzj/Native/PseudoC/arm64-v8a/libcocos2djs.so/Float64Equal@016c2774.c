...
/* v8::internal::compiler::GraphAssembler::Float64Equal(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Float64Equal
...

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::Float64Equal
