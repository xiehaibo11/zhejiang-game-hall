...
/* js_cocos2dx_spine_SkeletonCacheAnimation_setSlotsToSetupPoseRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonCacheAnimation_setSlotsToSetupPoseRegistry
...

{
  ...
  if (this == (SkeletonCacheAnimation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3d44,"js_cocos2dx_spine_SkeletonCacheAnimation_setSlotsToSetupPose");
    __android_log_print(6,"jswrapper",&DAT_01923c09);
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      spine::SkeletonCacheAnimation::setSlotsToSetupPose(this);
      goto LAB_00c80f1c;
    }
    __android_log_print(6,"jswrapper",&DAT_01923c5e,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonCacheAnimation_setSlotsToSetupPose",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x3d4e);
LAB_00c80f1c:
