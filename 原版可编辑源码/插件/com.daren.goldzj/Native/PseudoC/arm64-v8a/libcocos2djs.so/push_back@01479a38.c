...
/* std::__ndk1::__split_buffer<std::__ndk1::unique_ptr<v8::IdleTask,
   ...
   std::__ndk1::default_delete<v8::IdleTask> >*>&>::push_back(std::__ndk1::unique_ptr<v8::IdleTask,
   std::__ndk1::default_delete<v8::IdleTask> >*&&) */
...

{
  ...
  puVar12 = puVar4;
  if (puVar4 != *(undefined8 **)(this + 0x18)) goto LAB_01479bc0;
...
LAB_01479b8c:
      ...
      if (((void *)((long)pvVar6 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar6 + uVar13 * 8 + uVar9 + 8))) goto LAB_01479b8c;
      ...
      puVar11 = puVar12;
      if (uVar2 != uVar9) goto LAB_01479b8c;
    }
    puVar11 = *(undefined8 **)this;
  }
  *(void **)this = pvVar6;
