...
/* JSB_glIsProgramRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glIsProgramRegistry(FunctionCallbackInfo *param_1)
...
LAB_008bf154:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            ...
                            ,0x6b3,"JSB_glIsProgram");
        __android_log_print(6,"jswrapper",&DAT_0190552e);
        goto LAB_008bf198;
      }
      lVar9 = __dynamic_cast(lVar8,&PTR_PTR_01c67690,&PTR_PTR_01c676a8,0);
      if (lVar9 == 0) goto LAB_008bf13c;
      cVar4 = glIsProgram(*(undefined4 *)(lVar8 + 0xc));
      bVar3 = cVar4 == '\x01';
    }
    else {
      if (1 < (byte)pVVar7[8]) goto LAB_008bf154;
LAB_008bf13c:
      bVar3 = false;
    }
