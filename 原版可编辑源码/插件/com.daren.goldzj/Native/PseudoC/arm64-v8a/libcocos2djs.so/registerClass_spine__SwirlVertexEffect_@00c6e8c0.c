...
/* void JSBClassType::registerClass<spine::SwirlVertexEffect>(se::Class*) */

void JSBClassType::registerClass<spine::SwirlVertexEffect>(Class *param_1)
