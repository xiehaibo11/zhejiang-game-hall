...
/* js_cocos2d_network_Downloader_finalizeRegistry(void*) */

void js_cocos2d_network_Downloader_finalizeRegistry(void *param_1)

{
  ...
  if (param_1 != (void *)0x0) {
    ...
    if (lVar3 != lVar4) {
      ...
      this_00 = (Downloader *)se::State::nativeThisObject(aSStack_60);
