...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitTestIn(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::VisitTestIn
...

{
  ...
  ProcessKeyedPropertyAccess(this,lVar7 + (long)(int)uVar1 * 8,lVar6,uVar3,3,0);
  return;
}
