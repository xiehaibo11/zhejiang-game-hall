...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitDeletePropertyStrict(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitDeletePropertyStrict
