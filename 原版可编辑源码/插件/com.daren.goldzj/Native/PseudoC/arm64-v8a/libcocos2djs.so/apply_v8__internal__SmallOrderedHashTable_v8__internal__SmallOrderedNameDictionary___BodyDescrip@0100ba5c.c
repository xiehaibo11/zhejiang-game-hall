...
/* void 
   v8::internal::CallIterateBody::apply<v8::internal::SmallOrderedHashTable<v8::internal::SmallOrderedNameDictionary>::BodyDescriptor,
...

{
  ...
  puVar6 = puVar1 + (ulong)*(byte *)(param_2 + 9) * 6;
  if (puVar1 < puVar6) {
