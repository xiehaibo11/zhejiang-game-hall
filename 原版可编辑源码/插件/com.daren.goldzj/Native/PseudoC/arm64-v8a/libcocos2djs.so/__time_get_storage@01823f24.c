...

{
  ...
  *(__locale_t *)this = p_Var3;
  if (p_Var3 == (__locale_t)0x0) {
    ...
    FUN_01819190(local_60);
  }
  else {
    memset(this + 8,0,0x420);
    ctype_byname<char>::ctype_byname((ctype_byname<char> *)local_60,param_1,1);
    local_60[0] = &PTR__ctype_byname_01cddda0;
    init((ctype *)this);
    local_60[0] = &PTR__ctype_byname_01cdbaf0;
    freelocale(local_40);
    local_60[0] = &PTR__ctype_01cdba88;
    ppuVar2 = &PTR__ctype_01cdba88;
