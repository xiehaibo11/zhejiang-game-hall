...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned long,
   ...
   cocos2d::FontLetterDefinition> > >::__rehash(unsigned long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<unsigned_long,cocos2d::FontLetterDefinition>,std::__ndk1::__unordered_map_hasher<unsigned_long,std::__ndk1::__hash_value_type<unsigned_long,cocos2d::FontLetterDefinition>,std::__ndk1::hash<unsigned_long>,true>,std::__ndk1::__unordered_map_equal<unsigned_long,std::__ndk1::__hash_value_type<unsigned_long,cocos2d::FontLetterDefinition>,std::__ndk1::equal_to<unsigned_long>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<unsigned_long,cocos2d::FontLetterDefinition>>>
           *this,ulong param_1)
...
joined_r0x009f38e8:
      if (plVar7 != (long *)0x0) {
        do {
          ...
          if ((uVar6 & param_1) == 0) {
            uVar8 = uVar8 & uVar6;
            if (uVar8 != uVar4) goto LAB_009f392c;
LAB_009f38f0:
            plVar10 = (long *)*plVar7;
            plVar5 = plVar7;
          }
            ...
            if (uVar8 == uVar4) goto LAB_009f38f0;
LAB_009f392c:
            plVar10 = plVar7;
            if (*(long *)(*(long *)this + uVar8 * 8) == 0) goto LAB_009f3988;
            do {
              plVar9 = plVar10;
              plVar10 = (long *)*plVar9;
