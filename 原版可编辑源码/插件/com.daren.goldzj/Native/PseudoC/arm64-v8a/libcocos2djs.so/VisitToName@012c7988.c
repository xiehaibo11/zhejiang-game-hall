...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitToName(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitToName
