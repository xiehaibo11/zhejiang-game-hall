...
/* v8::internal::HeapProfiler::RemoveBuildEmbedderGraphCallback(void (*)(v8::Isolate*,
   v8::EmbedderGraph*, void*), void*) */

void __thiscall
v8::internal::HeapProfiler::RemoveBuildEmbedderGraphCallback
...

{
  ...
  puVar3 = puVar4;
  if ((puVar2 != puVar4) &&
     (((_func_void_Isolate_ptr_EmbedderGraph_ptr_void_ptr *)*puVar4 != param_1 ||
      ((void *)puVar4[1] != param_2)))) {
    do {
      puVar5 = puVar3;
      if (puVar2 + -2 == puVar5) {
        return;
      ...
      puVar3 = puVar5 + 2;
    } while (((_func_void_Isolate_ptr_EmbedderGraph_ptr_void_ptr *)puVar5[2] != param_1) ||
  ...
  if (puVar5 != puVar2) {
    ...
    if (3 < uVar1) {
      ...
      if (uVar1 == uVar6) goto LAB_0119ba78;
    }
    do {
      *puVar3 = *puVar5;
      puVar4 = puVar5 + 1;
