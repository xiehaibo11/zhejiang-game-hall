...
/* void std::__ndk1::vector<v8::internal::GlobalHandles::Node*,
   std::__ndk1::allocator<v8::internal::GlobalHandles::Node*>
   >::__push_back_slow_path<v8::internal::GlobalHandles::Node*
   const&>(v8::internal::GlobalHandles::Node* const&) */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00f68eac;
