...
int FUN_00a150b0(long param_1,undefined4 param_2,undefined4 param_3,undefined8 param_4)

{
  ...
  iVar1 = FUN_00a14dbc(param_1,0,param_2,param_3,param_4);
  if (0 < iVar1) {
    return iVar1;
  }
    ...
    *(long *)(param_1 + 0x80) = lVar2;
    ...
    if (lVar5 <= lVar3) {
      if ((lVar5 < lVar3) || (auVar8._8_8_ < *(long *)(lVar2 + 0x20))) {
        lVar4 = FUN_00a18ea0(lVar3,*(long *)(lVar2 + 0x20),lVar5,auVar8._8_8_);
        if (lVar4 == 0) {
          lVar4 = 1;
        }
        else if (lVar4 < 0) goto LAB_00a15168;
      }
      else {
        lVar4 = 0;
      }
