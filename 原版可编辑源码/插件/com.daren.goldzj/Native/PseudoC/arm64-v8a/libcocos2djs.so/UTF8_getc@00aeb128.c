  ...
  if ((bVar1 & 0xe0) == 0xc0) {
    if (len < 2) {
      return -1;
                    ...
                    /* try { // try from 00aeb18c to 00beb193 has its CatchHandler @ 00aeb1cc */
                    /* try { // try from 00aeb194 to 00beb1df has its CatchHandler @ 00aeb09c */
    if ((str[1] & 0xc0) == 0x80) {
  ...
  if ((bVar1 & 0xf0) == 0xe0) {
    if (len < 3) {
      return -1;
                    ...
                    /* catch() { ... } // from try @ 00aeb18c with catch @ 00aeb1cc */
    if ((str[1] & 0xc0) != 0x80) {
      return -3;
    }
    if ((str[2] & 0xc0) != 0x80) {
    ...
    if ((str[3] & 0xc0) == 0x80) {
      if ((str[4] & 0xc0) != 0x80) {
        return -3;
                    ...
                    /* try { // try from 00aeb308 to 00beb4ab has its CatchHandler @ 00aeb308
                       catch() { ... } // from try @ 00aeb308 with catch @ 00aeb308
                       catch() { ... } // from try @ 00aeb4b4 with catch @ 00aeb308
                       catch() { ... } // from try @ 00aeb64c with catch @ 00aeb308
                       catch() { ... } // from try @ 00aeb770 with catch @ 00aeb308
                       catch() { ... } // from try @ 00aeb7ec with catch @ 00aeb308 */
