...
/* void std::__ndk1::vector<v8::internal::SerializedData::Reservation,
   std::__ndk1::allocator<v8::internal::SerializedData::Reservation>
   >::__emplace_back_slow_path<unsigned int const&>(unsigned int const&) */

void __thiscall
std::__ndk1::
vector<v8::internal::SerializedData::Reservation,std::__ndk1::allocator<v8::internal::SerializedData::Reservation>>
::__emplace_back_slow_path<unsigned_int_const&>
          (vector<v8::internal::SerializedData::Reservation,std::__ndk1::allocator<v8::internal::SerializedData::Reservation>>
           *this,uint *param_1)

{
  ...
  if (uVar1 >> 0x3e == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3e != 0) goto LAB_011dc574;
