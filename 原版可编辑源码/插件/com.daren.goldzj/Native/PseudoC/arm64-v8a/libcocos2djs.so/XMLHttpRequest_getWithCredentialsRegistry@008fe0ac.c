...
/* XMLHttpRequest_getWithCredentialsRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void XMLHttpRequest_getWithCredentialsRegistry(undefined8 param_1,PropertyCallbackInfo *param_2)

{
  ...
  __android_log_print(3,"jswrapper","XMLHttpRequest.withCredentials isn\'t implemented on JSB!");
