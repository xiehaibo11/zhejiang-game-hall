...
/* v8::internal::compiler::BinopMatcher<v8::internal::compiler::FloatMatcher<float,
   ...
   (v8::internal::compiler::IrOpcode::Value)25> >::SwapInputs() */
...
::SwapInputs(BinopMatcher<v8::internal::compiler::FloatMatcher<float,(v8::internal::compiler::IrOpcode::Value)25>,v8::internal::compiler::FloatMatcher<float,(v8::internal::compiler::IrOpcode::Value)25>>
             *this)
