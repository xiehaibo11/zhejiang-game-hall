...
undefined8
FUN_0181ee2c(long param_1,uint *param_2,long *param_3,undefined1 *param_4,long param_5,long *param_6
      ...
      if (uVar7 < 0x800) {
        ...
        if (uVar7 >> 0xb < 0x1b) {
          ...
          if (uVar7 >> 10 < 0x37) {
            ...
            if (param_7 < (((ulong)(uVar2 << 10) & 0xf0000) + 0x10000 |
                           (ulong)(uVar2 << 10) & 0xffff | (ulong)uVar7 & 0x3ff)) {
              return 2;
            }
            ...
            *pbVar5 = (byte)(uVar2 >> 2) & 0xf | (byte)((uVar1 & 3) << 4) | 0x80;
            pbVar5 = (byte *)*param_6;
            *param_6 = (long)(pbVar5 + 1);
            *pbVar5 = (byte)((uVar2 & 3) << 4) | (byte)(uVar7 >> 6) & 0xf | 0x80;
            pbVar5 = (byte *)*param_6;
            *param_6 = (long)(pbVar5 + 1);
            *pbVar5 = (byte)uVar7 & 0x3f | 0x80;
            goto LAB_0181f03c;
          }
          if (uVar7 < 0xe000) {
            return 2;
        ...
        *param_6 = (long)(pbVar5 + 1);
        *pbVar5 = (byte)(uVar7 >> 0xc) | 0xe0;
        pbVar5 = (byte *)*param_6;
        bVar6 = (byte)(uVar2 >> 6) & 0x3f | 0x80;
      }
      *param_6 = (long)(pbVar5 + 1);
      *pbVar5 = bVar6;
      pbVar5 = (byte *)*param_6;
