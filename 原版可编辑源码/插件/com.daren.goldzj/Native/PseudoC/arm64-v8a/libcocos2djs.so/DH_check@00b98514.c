    ...
    if (dh->q == (BIGNUM *)0x0) {
      ...
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          ...
          if (uVar2 == 0xffffffffffffffff) goto LAB_00b9873c;
          if ((uVar2 == 3) || (uVar2 == 7)) goto LAB_00b986e0;
          uVar3 = 8;
        }
        uVar3 = *codes | uVar3;
LAB_00b986dc:
...
LAB_00b98598:
        *codes = *codes | 8;
        ...
        if (iVar1 == 0) goto LAB_00b9873c;
        iVar1 = BN_is_one(r);
        if (iVar1 == 0) goto LAB_00b98598;
      }
      ...
      if (-1 < iVar1) {
        ...
        if (iVar1 != 0) {
          ...
          if ((dh->j == (BIGNUM *)0x0) || (iVar1 = BN_cmp(dh->j,r), iVar1 == 0)) goto LAB_00b986e0;
          uVar3 = *codes | 0x40;
          goto LAB_00b986dc;
        }
      }
