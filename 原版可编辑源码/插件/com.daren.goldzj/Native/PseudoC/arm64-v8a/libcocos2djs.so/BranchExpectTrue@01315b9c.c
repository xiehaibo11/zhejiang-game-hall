...
/* v8::internal::compiler::WasmGraphBuilder::BranchExpectTrue(v8::internal::compiler::Node*,
   v8::internal::compiler::Node**, v8::internal::compiler::Node**) */

Node * __thiscall
v8::internal::compiler::WasmGraphBuilder::BranchExpectTrue
...

{
  ...
  pOVar2 = (Operator *)CommonOperatorBuilder::Branch((CommonOperatorBuilder *)puVar5[1],1,1);
  local_50 = param_1;
  uStack_48 = uVar6;
