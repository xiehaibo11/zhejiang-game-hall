...
/* std::__ndk1::__hash_table<v8::internal::Handle<v8::internal::Module>,
   v8::internal::ModuleHandleHash, v8::internal::ModuleHandleEqual,
   v8::internal::ZoneAllocator<v8::internal::Handle<v8::internal::Module> > >::rehash(unsigned long)
    */
...
::rehash(__hash_table<v8::internal::Handle<v8::internal::Module>,v8::internal::ModuleHandleHash,v8::internal::ModuleHandleEqual,v8::internal::ZoneAllocator<v8::internal::Handle<v8::internal::Module>>>
         *this,ulong param_1)

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      if (uVar1 < uVar2) goto LAB_01130254;
    }
    return;
  }
LAB_01130254:
