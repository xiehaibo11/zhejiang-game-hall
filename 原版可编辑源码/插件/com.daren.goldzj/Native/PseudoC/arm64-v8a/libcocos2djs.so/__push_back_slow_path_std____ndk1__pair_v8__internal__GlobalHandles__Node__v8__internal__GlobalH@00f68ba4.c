...
/* void std::__ndk1::vector<std::__ndk1::pair<v8::internal::GlobalHandles::Node*,
   v8::internal::GlobalHandles::PendingPhantomCallback>,
   std::__ndk1::allocator<std::__ndk1::pair<v8::internal::GlobalHandles::Node*,
   v8::internal::GlobalHandles::PendingPhantomCallback> >
   >::__push_back_slow_path<std::__ndk1::pair<v8::internal::GlobalHandles::Node*,
   v8::internal::GlobalHandles::PendingPhantomCallback>
   >(std::__ndk1::pair<v8::internal::GlobalHandles::Node*,
   v8::internal::GlobalHandles::PendingPhantomCallback>&&) */
...

{
  ...
  if (uVar1 < 0x666666666666667) {
    ...
    if (uVar1 == 0) {
      ...
      if (0x666666666666666 < uVar1) goto LAB_00f68cb0;
