...
/* v8::internal::compiler::JSGraph::PropertyArrayMapConstant() */

void __thiscall v8::internal::compiler::JSGraph::PropertyArrayMapConstant(JSGraph *this)

{
  ...
  if (*(long *)(this + 0x1d8) == 0) {
    local_38 = *(long *)(this + 0x168) + 0x248;
