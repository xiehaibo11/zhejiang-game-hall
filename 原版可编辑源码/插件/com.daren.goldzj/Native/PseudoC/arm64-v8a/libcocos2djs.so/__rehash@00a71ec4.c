...

{
  ...
  if (param_1 == 0) {
    pvVar2 = *(void **)this;
                    /* try { // try from 00a71f50 to 00b72033 has its CatchHandler @ 00a71dec */
    *(undefined8 *)this = 0;
    if (pvVar2 != (void *)0x0) {
    ...
    *(undefined8 *)(this + 8) = 0;
    ...
    if (param_1 >> 0x3d != 0) {
                    ...
                    /* try { // try from 00a72034 to 00b72087 has its CatchHandler @ 00a72034
                       catch() { ... } // from try @ 00a72034 with catch @ 00a72034
                       catch() { ... } // from try @ 00a72220 with catch @ 00a72034 */
      abort();
    }
...
joined_r0x00a71f74:
      if (plVar7 != (long *)0x0) {
        do {
          ...
          if ((uVar6 & param_1) == 0) {
            uVar8 = uVar8 & uVar6;
            if (uVar8 != uVar4) goto LAB_00a71fb8;
LAB_00a71f7c:
            plVar10 = (long *)*plVar7;
            plVar5 = plVar7;
          }
            ...
            if (uVar8 == uVar4) goto LAB_00a71f7c;
LAB_00a71fb8:
                    /* catch() { ... } // from try @ 00a71e6c with catch @ 00a71fc4 */
            plVar10 = plVar7;
            if (*(long *)(*(long *)this + uVar8 * 8) == 0) goto LAB_00a72014;
            do {
                    /* catch() { ... } // from try @ 00a71e60 with catch @ 00a71fc8 */
              plVar9 = plVar10;
                    /* catch() { ... } // from try @ 00a71e40 with catch @ 00a71fcc */
              plVar10 = (long *)*plVar9;
              if (plVar10 == (long *)0x0) break;
                    /* catch() { ... } // from try @ 00a71e78 with catch @ 00a71fdc */
