...
/* CanvasRenderingContext2DImpl::stroke() */

void __thiscall CanvasRenderingContext2DImpl::stroke(CanvasRenderingContext2DImpl *this)

{
  ...
  if ((1.0 <= *(float *)(this + 0x18)) && (1.0 <= *(float *)(this + 0x1c))) {
    ...
    local_67 = 0x6f727473;
    local_61 = 0;
    cocos2d::JniHelper::callObjectVoidMethod<>(p_Var2,(basic_string *)local_50,&local_68);
