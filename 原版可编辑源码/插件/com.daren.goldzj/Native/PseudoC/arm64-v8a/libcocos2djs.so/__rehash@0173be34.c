...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<v8::internal::compiler::PropertyAccessTarget,
   ...
   v8::internal::compiler::PropertyAccessInfo> > >::__rehash(unsigned long) */
      ...
      if (plVar6 != (long *)0x0) {
        do {
          ...
          if ((uVar12 & 0xffffffff) < 2) {
            uVar7 = uVar7 & uVar3;
LAB_0173bf28:
            if (uVar7 == uVar4) goto LAB_0173bef0;
LAB_0173bf30:
            plVar9 = plVar6;
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) goto LAB_0173bfac;
            do {
              plVar8 = plVar9;
              plVar9 = (long *)*plVar8;
              if (((plVar9 == (long *)0x0) || (plVar6[2] != plVar9[2])) || (plVar6[4] != plVar9[4]))
              break;
            } while ((int)plVar6[6] == (int)plVar9[6]);
            *plVar5 = (long)plVar9;
            ...
            **(undefined8 **)(*(long *)this + uVar7 * 8) = plVar6;
            ...
            if (uVar7 < param_1) goto LAB_0173bf28;
            uVar1 = 0;
            if (param_1 != 0) {
              uVar1 = uVar7 / param_1;
            }
            uVar7 = uVar7 - uVar1 * param_1;
            if (uVar7 != uVar4) goto LAB_0173bf30;
LAB_0173bef0:
            plVar9 = (long *)*plVar6;
            plVar5 = plVar6;
          }
