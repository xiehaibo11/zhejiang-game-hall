...
void FUN_00e05434(char *param_1,int param_2,int param_3,int param_4,char *param_5)

{
  ...
  *param_5 = *param_1;
  uVar4 = param_2 - 1;
  if (param_2 < 2) goto LAB_00e054b4;
  uVar9 = (ulong)uVar4;
  if (uVar4 < 0x10) {
LAB_00e05484:
    lVar14 = 0;
    ...
    if (lVar14 != 0) {
      lVar10 = lVar14;
      if ((pcVar12 < param_1 + uVar9 + 1) && (param_1 < param_5 + uVar9 + 1)) goto LAB_00e05484;
      do {
      ...
      if ((uVar4 & 0xf) == 0) goto LAB_00e054b4;
    }
  }
  lVar10 = uVar9 - lVar14;
...
LAB_00e05598:
          ...
          uVar8 = uVar15;
          if ((uVar4 & 0x1f) != 0) goto LAB_00e05598;
        }
        iVar5 = iVar5 + 1;
        lVar10 = lVar10 + 1;
