...
void FUN_0107c428(ulong param_1,ulong param_2,ulong param_3,long param_4)

{
  ...
  case 0x12:
    ...
    break;
  case 0x13:
    goto switchD_0107c568_caseD_13;
  case 0x14:
    if (param_3 != 0) {
      if ((param_3 < 0x10) ||
    ...
    if (param_3 != 0) {
      ...
      do {
        ...
        if (((fVar22 < -2.1474836e+09) || (2147483647.0 < dVar21)) ||
          ...
          if ((int)uVar2 < 0) {
            if ((int)uVar2 < -0x34) goto LAB_0107c898;
    ...
    if (param_3 != 0) {
      ...
      do {
        ...
        if ((((dVar21 < -2147483648.0) || (2147483647.0 < dVar21)) || (ABS(dVar21) == INFINITY)) ||
          ...
          if ((int)uVar2 < 0) {
            if ((int)uVar2 < -0x34) goto LAB_0107c704;
            uVar1 = (ulong)dVar21 & 0xfffffffffffff;
            if (((ulong)dVar21 & 0x7ff0000000000000) != 0) {
              uVar1 = (ulong)dVar21 & 0xfffffffffffff | 0x10000000000000;
            }
...
LAB_0107c708:
    ...
    break;
  case 0x19:
    goto switchD_0107c568_caseD_19;
  case 0x1a:
    if (param_3 == 0) break;
    FUN_010b4df0();
switchD_0107c568_caseD_13:
    if (param_3 != 0) {
      if ((param_3 < 0x10) ||
         (((void *)(uVar1 + param_4 * 2) < (void *)((long)__src + param_3 * 2) &&
          (__src < (double *)(uVar1 + (param_4 + param_3) * 2))))) {
