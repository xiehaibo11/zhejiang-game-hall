...
/* v8::internal::compiler::EffectControlLinearizer::LowerObjectIsConstructor(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerObjectIsConstructor
...

{
  ...
  pNVar2 = (Node *)GraphAssembler::Int32Constant(this_00,0x40);
  pNVar3 = (Node *)GraphAssembler::Int32Constant(this_00,0x40);
