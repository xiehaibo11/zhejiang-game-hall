...
/* js_cocos2dx_dragonbones_AnimationState_set_additiveBlendingRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_AnimationState_set_additiveBlendingRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x119b,&DAT_0192a2b5);
    pcVar8 = "js_cocos2dx_dragonbones_AnimationState_set_additiveBlending : Invalid Native Object";
  }
  else {
    uVar7 = seval_to_boolean((Value *)*puVar5,local_74);
    if ((uVar7 & 1) != 0) {
      *(bool *)(lVar6 + 0xe) = local_74[0];
      goto LAB_00cb3984;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x11a0,&DAT_0192a2b5);
    pcVar8 = 
    "js_cocos2dx_dragonbones_AnimationState_set_additiveBlending : Error processing new value";
  }
