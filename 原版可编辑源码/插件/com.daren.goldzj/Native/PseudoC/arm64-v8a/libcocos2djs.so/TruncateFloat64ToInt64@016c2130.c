...
/* v8::internal::compiler::GraphAssembler::TruncateFloat64ToInt64(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::TruncateFloat64ToInt64(GraphAssembler *this,Node *param_1)

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::TruncateFloat64ToInt64
