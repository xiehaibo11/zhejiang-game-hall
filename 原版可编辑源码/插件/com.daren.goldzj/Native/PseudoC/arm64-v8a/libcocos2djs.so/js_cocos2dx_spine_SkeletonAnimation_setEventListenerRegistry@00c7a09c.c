...
/* js_cocos2dx_spine_SkeletonAnimation_setEventListenerRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonAnimation_setEventListenerRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonAnimation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x38e6,"js_cocos2dx_spine_SkeletonAnimation_setEventListener");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonAnimation_setEventListener : Invalid Native Object"
                       );
  }
  else {
    ...
    if (puVar4[1] - (long)pVVar5 == 0x10) {
      ...
      if (pVVar5[8] == (Value)0x5) {
        ...
        if ((uVar7 & 1) == 0) goto LAB_00c7a340;
...
LAB_00c7a340:
      ...
      spine::SkeletonAnimation::setEventListener(this,(function *)alStack_c0);
    ...
    __android_log_print(6,"jswrapper",&DAT_019214f4,(ulong)(puVar4[1] - (long)pVVar5) >> 4,1);
  }
