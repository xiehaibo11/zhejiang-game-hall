...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::GraphBuilderPhase>() */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::GraphBuilderPhase>
          (PipelineImpl *this)

{
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFBytecodeGraphBuilder");
  GraphBuilderPhase::Run(aGStack_18,pPVar5,pZVar2);
