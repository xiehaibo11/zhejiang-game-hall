...
/* v8::internal::HashTable<v8::internal::CompilationCacheTable,
   v8::internal::CompilationCacheShape>::ToKey(v8::internal::Isolate*, v8::internal::InternalIndex,
   v8::internal::Object*) */
...

{
  ...
  lVar1 = (ulong)*(uint *)(*(long *)this + (param_3 * 0xc00000000 + 0xc00000000 >> 0x20) + 7) +
          param_1;
  iVar2 = (int)lVar1;
