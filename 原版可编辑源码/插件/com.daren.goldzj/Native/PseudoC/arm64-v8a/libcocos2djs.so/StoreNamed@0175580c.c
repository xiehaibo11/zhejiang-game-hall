...
/* v8::internal::compiler::JSOperatorBuilder::StoreNamed(v8::internal::LanguageMode,
   v8::internal::Handle<v8::internal::Name>, v8::internal::compiler::FeedbackSource const&) */

Operator * __thiscall
v8::internal::compiler::JSOperatorBuilder::StoreNamed
...

{
  ...
  Operator::Operator(pOVar2,0x2ed,0,"JSStoreNamed",2,1,1,0,1,2);
  *(undefined8 *)(pOVar2 + 0x30) = param_3;
  *(undefined ***)pOVar2 = &PTR__Operator_01ccfb58;
  pOVar2[0x48] = (Operator)(param_2 & 1);
