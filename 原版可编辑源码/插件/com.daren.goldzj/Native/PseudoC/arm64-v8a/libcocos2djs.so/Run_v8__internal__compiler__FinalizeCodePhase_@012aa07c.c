...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::FinalizeCodePhase>() */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::FinalizeCodePhase>
          (PipelineImpl *this)

{
  ...
  if (this_00 != (PipelineStatistics *)0x0) {
    PipelineStatistics::BeginPhase(this_00,"V8.TFFinalizeCode");
  }
  this_01 = *(ZoneStats **)(lVar5 + 0x30);
  lVar4 = *(long *)(lVar5 + 0xb0);
  if (lVar4 != 0) {
    local_60 = *(undefined8 *)(lVar4 + 0x30);
    *(char **)(lVar4 + 0x30) = "V8.TFFinalizeCode";
  }
  ...
  if ((pRVar1 == (RuntimeCallStats *)0x0) || (TracingFlags::runtime_stats == 0)) {
    ...
    RuntimeCallStats::Enter(pRVar1,(RuntimeCallTimer *)&uStack_50,0x45f);
    lVar5 = *(long *)this;
    local_58 = pRVar1;
  }
  lVar2 = ZoneStats::NewEmptyZone(this_01,"V8.TFFinalizeCode");
  uVar3 = CodeGenerator::FinalizeCode(*(CodeGenerator **)(lVar5 + 0x68));
