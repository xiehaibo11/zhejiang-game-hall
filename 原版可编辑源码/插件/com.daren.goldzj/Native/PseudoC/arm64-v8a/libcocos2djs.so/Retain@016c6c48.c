...
/* v8::internal::compiler::GraphAssembler::Retain(v8::internal::compiler::Node*) */

Node * __thiscall v8::internal::compiler::GraphAssembler::Retain(GraphAssembler *this,Node *param_1)
