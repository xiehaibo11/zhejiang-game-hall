...
/* v8::internal::Dictionary<v8::internal::NumberDictionary,
   v8::internal::NumberDictionaryShape>::ValueAtPut(v8::internal::InternalIndex,
   v8::internal::Object) */

void __thiscall
v8::internal::Dictionary<v8::internal::NumberDictionary,v8::internal::NumberDictionaryShape>::
ValueAtPut(Dictionary<v8::internal::NumberDictionary,v8::internal::NumberDictionaryShape> *this,
...

{
  ...
  lVar1 = (param_2 * 0xc00000000 + 0x1400000000 >> 0x20) + 7;
