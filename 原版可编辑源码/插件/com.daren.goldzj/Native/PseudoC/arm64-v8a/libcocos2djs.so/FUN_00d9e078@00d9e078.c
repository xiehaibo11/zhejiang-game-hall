...
undefined8 FUN_00d9e078(long *param_1,long *param_2)

{
  ...
  if (*(int *)(lVar12 + 0x28) != -1) {
    ...
    do {
      ...
      iVar4 = FUN_00d9e97c(param_1,lVar11);
      if (iVar4 != 0) {
        return 1;
      }
      lVar11 = lVar11 + 2;
      ...
      while( true ) {
        iVar8 = iVar4 + 1;
        iVar5 = FUN_00d9e97c(param_1,lVar11 + -1);
        if (iVar5 != 0) break;
        lVar11 = lVar11 + 3;
        iVar4 = iVar8;
        if ((int)param_1[0x44] <= iVar8) goto LAB_00d9e238;
      }
      iVar5 = FUN_00d9e97c(param_1,lVar12 + 0x150);
      uVar6 = FUN_00d9e97c(param_1,lVar11);
      uVar10 = 0;
      if (uVar6 != 0) {
        iVar7 = FUN_00d9e97c(param_1,lVar11);
        uVar10 = uVar6;
        if (iVar7 != 0) {
          uVar10 = uVar6 << 1;
          lVar11 = 0xbd;
          ...
          while (iVar4 = FUN_00d9e97c(param_1,lVar11), iVar4 != 0) {
            uVar10 = uVar10 << 1;
            if (uVar10 == 0x8000) {
LAB_00d9e238:
              lVar9 = *param_1;
        ...
        if (uVar6 != 0) {
          do {
            iVar4 = FUN_00d9e97c(param_1,lVar11 + 0xe);
            uVar2 = 0;
            if (iVar4 != 0) {
              uVar2 = uVar6;
            }
