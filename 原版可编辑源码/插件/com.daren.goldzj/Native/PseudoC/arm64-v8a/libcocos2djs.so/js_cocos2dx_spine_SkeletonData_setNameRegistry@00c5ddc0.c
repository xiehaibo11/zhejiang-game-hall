...
/* js_cocos2dx_spine_SkeletonData_setNameRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_SkeletonData_setNameRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2861,"js_cocos2dx_spine_SkeletonData_setName");
    __android_log_print(6,"jswrapper",&DAT_0191438d);
  }
  else {
    ...
    if (plVar5[1] - *plVar5 == 0x10) {
      ...
      spine::SkeletonData::setName(this,(String *)&local_88);
      pvVar4 = local_78;
      local_88 = &PTR__String_01c67868;
    ...
    __android_log_print(6,"jswrapper",&DAT_019143cc,(ulong)(plVar5[1] - *plVar5) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonData_setName",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x286f);
LAB_00c5dfe8:
