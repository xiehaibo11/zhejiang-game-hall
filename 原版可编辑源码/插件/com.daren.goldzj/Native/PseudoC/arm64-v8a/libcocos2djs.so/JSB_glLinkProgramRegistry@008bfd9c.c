...
/* JSB_glLinkProgramRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glLinkProgramRegistry(FunctionCallbackInfo *param_1)
...
LAB_008bfec8:
      ...
      if (1 < (byte)pVVar6[8]) goto LAB_008bfec8;
      uVar3 = 0;
    }
    glLinkProgram(uVar3);
  }
