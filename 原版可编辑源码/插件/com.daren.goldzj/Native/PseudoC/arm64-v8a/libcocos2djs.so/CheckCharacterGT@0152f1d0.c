...
/* v8::internal::RegExpBytecodeGenerator::CheckCharacterGT(unsigned short, v8::internal::Label*) */

void __thiscall
v8::internal::RegExpBytecodeGenerator::CheckCharacterGT
...

{
  ...
  *(uint *)(*(long *)(this + 0x28) + (long)iVar3) = (uint)param_1 << 8 | 0x24;
  iVar3 = *(int *)(this + 0x38);
  pRVar1 = this + 0x3c;
