...
/* v8::SharedArrayBuffer::NewBackingStore(v8::Isolate*, unsigned long) */

void __thiscall
v8::SharedArrayBuffer::NewBackingStore(SharedArrayBuffer *this,Isolate *param_1,ulong param_2)

{
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_60,(ulong)&local_60 | 8,0x3d2);
  }
  this_00 = *(Logger **)(this + 0x9558);
  uVar2 = internal::Logger::is_logging(this_00);
  if ((uVar2 & 1) != 0) {
    internal::Logger::ApiEntryCall(this_00,"v8::SharedArrayBuffer::NewBackingStore");
  }
  if ((ulong)param_1 >> 0x35 == 0) {
    uVar1 = *(undefined4 *)(this + 0x2c60);
    *(undefined4 *)(this + 0x2c60) = 5;
    internal::BackingStore::Allocate((BackingStore *)&local_68,this,param_1,1,1);
    if (local_68 != 0) {
      *in_x8 = local_68;
    ...
    internal::FatalProcessOutOfMemory((Isolate *)this,"v8::SharedArrayBuffer::NewBackingStore");
  }
                    /* WARNING: Subroutine does not return */
