...
/* v8::internal::StackTraceFrame::IsWasm(v8::internal::Handle<v8::internal::StackTraceFrame>) */

byte v8::internal::StackTraceFrame::IsWasm(ulong *param_1)
