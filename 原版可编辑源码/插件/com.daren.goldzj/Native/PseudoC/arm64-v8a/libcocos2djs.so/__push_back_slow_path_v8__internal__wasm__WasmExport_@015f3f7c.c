...
/* void std::__ndk1::vector<v8::internal::wasm::WasmExport,
   std::__ndk1::allocator<v8::internal::wasm::WasmExport>
   >::__push_back_slow_path<v8::internal::wasm::WasmExport>(v8::internal::wasm::WasmExport&&) */
...

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_015f4068;
