...
/* v8::internal::RegExpMacroAssemblerARM64::CheckStackLimit() */

void __thiscall
v8::internal::RegExpMacroAssemblerARM64::CheckStackLimit(RegExpMacroAssemblerARM64 *this)

{
  ...
  local_70 = ExternalReference::address_of_regexp_stack_limit_address
                       (*(Isolate **)(*(long *)(this + 0x28) + 0x178));
  ...
  TurboAssembler::AddSubMacro
            (*(TurboAssembler **)(this + 0x28),&DAT_019f7b78,&local_a0,&local_90,1,0x40000000);
  local_90 = 0;
  TurboAssembler::B(*(TurboAssembler **)(this + 0x28),&local_90,8);
  Assembler::bl(*(Assembler **)(this + 0x28),(Label *)(this + 0x6c));
