...
/* js_cocos2dx_spine_Event_setBalanceRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Event_setBalanceRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Event *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x121d,"js_cocos2dx_spine_Event_setBalance");
    pcVar6 = "js_cocos2dx_spine_Event_setBalance : Invalid Native Object";
LAB_00c32198:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Event::setBalance(this,local_64);
        goto LAB_00c321d0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1224,"js_cocos2dx_spine_Event_setBalance");
      pcVar6 = "js_cocos2dx_spine_Event_setBalance : Error processing arguments";
      goto LAB_00c32198;
    }
    __android_log_print(6,"jswrapper",&DAT_018fff13,uVar7 >> 4,1);
  }
