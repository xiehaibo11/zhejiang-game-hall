...
/* JSB_localStorageGetItemRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_localStorageGetItemRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar5[1] - *plVar5 == 0x10) {
    ...
    if ((uVar6 & 1) == 0) {
      ...
      uStack_88 = 0;
      local_80 = (void *)0x0;
      uVar6 = localStorageGetItem((basic_string *)&local_78,(basic_string *)&local_90);
      if ((uVar6 & 1) == 0) {
        ...
        pVVar7 = (Value *)se::State::rval(aSStack_60);
        se::Value::setString(pVVar7,(basic_string *)&local_90);
      }
      if ((local_90 & 1) != 0) {
    ...
    if (bVar2) goto LAB_008e3104;
  }
  else {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_cocos2dx_manual.cpp, 242): Invalid number of arguments\n"
                       );
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "JSB_localStorageGetItem",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_cocos2dx_manual.cpp"
                      ,0xf5);
LAB_008e3104:
  pVVar7 = (Value *)se::State::rval(aSStack_60);
