...
/* void cocos2d::JniHelper::callObjectVoidMethod<int>(_jobject*, std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&, int) */

void cocos2d::JniHelper::callObjectVoidMethod<int>
               (_jobject *param_1,basic_string *param_2,basic_string *param_3,int param_4)

{
  ...
  uStack_80 = 0;
  local_78 = (void *)0x0;
  local_88 = (_jobject *)&DAT_00004902;
  ...
  *puVar5 = 0;
  ...
  if ((uVar6 & 1) == 0) {
    ...
    local_60 = (void *)0x0;
    local_50 = 0x3f800000;
    _JNIEnv::CallVoidMethod(local_88,(_jmethodID *)param_1,local_78,(ulong)(uint)param_4);
