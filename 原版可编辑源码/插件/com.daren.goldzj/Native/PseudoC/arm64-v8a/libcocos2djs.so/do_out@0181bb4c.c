    ...
    *param_4 = param_2;
    if ((param_5 != param_6) && (param_2 != param_3)) {
      do {
        ...
        sVar5 = wcsnrtombs(param_5,param_4,(long)pwVar10 - (long)param_2 >> 2,
...
LAB_0181bdac:
        ...
        if (sVar5 == 0xffffffffffffffff) {
          *param_7 = param_5;
          if (param_2 != *param_4) goto LAB_0181bddc;
          goto LAB_0181be30;
        }
        ...
        *param_7 = param_5;
        ...
        if (pwVar10 == param_3) {
          ...
          pcVar6 = *param_7;
          if ((ulong)((long)param_6 - (long)pcVar6) < sVar5) goto LAB_0181bdac;
          if (sVar5 != 0) {
            *param_7 = pcVar6 + 1;
            *pcVar6 = local_6c[0];
            if (sVar5 != 1) {
          ...
          *param_4 = param_2;
          for (pwVar9 = param_2;
              (pwVar10 = param_3, pwVar9 != param_3 && (pwVar10 = pwVar9, *pwVar9 != L'\0'));
              pwVar9 = pwVar9 + 1) {
          }
          param_5 = *param_7;
        }
