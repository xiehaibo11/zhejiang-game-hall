...
/* void v8::internal::SubclassBodyDescriptor<v8::internal::FixedBodyDescriptor<4, 8, 16>,
   v8::internal::FixedBodyDescriptor<16, 20, 20>
...

{
  ...
  if (puVar1 < (uint *)(param_2 + 7)) {
    ...
    while( true ) {
      ...
      puVar1 = puVar1 + 1;
      if ((uint *)(param_2 + 7) <= puVar1) break;
      uVar2 = *puVar1;
    }
  }
