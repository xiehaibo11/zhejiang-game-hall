...
/* v8::internal::JSMap::Clear(v8::internal::Isolate*, v8::internal::Handle<v8::internal::JSMap>) */

void v8::internal::JSMap::Clear(Isolate *param_1,ulong *param_2)

{
  ...
  puVar1 = (ulong *)OrderedHashTable<v8::internal::OrderedHashMap,2>::Clear(param_1,puVar1);
  uVar3 = *param_2;
  uVar4 = *puVar1;
