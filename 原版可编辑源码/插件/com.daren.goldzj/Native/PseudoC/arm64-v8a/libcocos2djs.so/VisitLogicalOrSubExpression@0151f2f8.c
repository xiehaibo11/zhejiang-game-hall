...
/* v8::internal::interpreter::BytecodeGenerator::VisitLogicalOrSubExpression(v8::internal::Expression*,
   v8::internal::interpreter::BytecodeLabels*, int) */

void __thiscall
v8::internal::interpreter::BytecodeGenerator::VisitLogicalOrSubExpression
  ...
  if ((uVar4 & 1) == 0) {
    ...
    if ((uVar4 & 1) == 0) {
      ...
      *(int *)(pBStack_60 + 0x118) = local_58;
      ...
      BytecodeArrayBuilder::JumpIfTrue((BytecodeArrayBuilder *)(this + 0x18),iVar3 == 1,uVar6);
    }
    uVar6 = 0;
