...
/* v8::internal::compiler::EffectControlLinearizer::LowerToBoolean(v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerToBoolean
...

{
  ...
  Builtins::CallableFor((Builtins *)local_80,*(undefined8 *)(*(long *)this + 0x168),0x5b);
