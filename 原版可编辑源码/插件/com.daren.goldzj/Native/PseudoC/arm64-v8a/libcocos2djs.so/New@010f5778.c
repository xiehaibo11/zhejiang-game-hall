...
/* v8::internal::HashTable<v8::internal::StringTable,
   v8::internal::StringTableShape>::New(v8::internal::Isolate*, int, v8::internal::AllocationType,
   v8::internal::MinimumCapacity) */

void v8::internal::HashTable<v8::internal::StringTable,v8::internal::StringTableShape>::New
...

{
  ...
  plVar1 = (long *)Factory::NewFixedArrayWithMap<v8::internal::FixedArray>
                             (param_1,0x43,param_2 + 3,param_3);
