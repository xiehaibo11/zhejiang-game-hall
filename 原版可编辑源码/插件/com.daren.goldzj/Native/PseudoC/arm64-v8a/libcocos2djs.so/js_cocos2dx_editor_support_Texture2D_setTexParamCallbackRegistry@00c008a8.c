...
/* js_cocos2dx_editor_support_Texture2D_setTexParamCallbackRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_editor_support_Texture2D_setTexParamCallbackRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Texture2D *)se::State::nativeThisObject(aSStack_148);
  if (this == (Texture2D *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x20,"js_cocos2dx_editor_support_Texture2D_setTexParamCallback");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_editor_support_Texture2D_setTexParamCallback : Invalid Native Object"
                       );
  }
  else {
    ...
    if (puVar4[1] - (long)pVVar5 == 0x10) {
      ...
      if (pVVar5[8] == (Value)0x5) {
        ...
        if ((uVar7 & 1) == 0) goto LAB_00c00b4c;
...
LAB_00c00b4c:
      ...
      cocos2d::middleware::Texture2D::setTexParamCallback(this,(function *)alStack_c0);
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_editor_support_auto.cpp, 76): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(puVar4[1] - (long)pVVar5) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_editor_support_Texture2D_setTexParamCallback",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_editor_support_auto.cpp"
                      ,0x4f);
LAB_00c00b04:
