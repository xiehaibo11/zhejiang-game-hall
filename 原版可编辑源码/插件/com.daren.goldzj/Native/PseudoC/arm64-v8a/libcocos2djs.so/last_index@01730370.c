...
/* v8::internal::compiler::JSRegExpRef::last_index() const */

undefined1  [16] __thiscall v8::internal::compiler::JSRegExpRef::last_index(JSRegExpRef *this)
