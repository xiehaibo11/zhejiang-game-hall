...
/* v8::internal::compiler::Verifier::Visitor::CheckTypeMaybe(v8::internal::compiler::Node*,
   v8::internal::compiler::Type) */

void __thiscall
v8::internal::compiler::Verifier::Visitor::CheckTypeMaybe
          (Visitor *this,undefined8 *param_1,undefined8 param_3)

{
  ...
  if (*(int *)(this + 8) == 0) {
    local_150 = (undefined **)param_1[1];
    uVar2 = Type::Maybe((Type *)&local_150,param_3);
    if ((uVar2 & 1) == 0) {
      ...
      pbVar3 = (basic_ostream *)
               std::__ndk1::basic_ostream<char,std::__ndk1::char_traits<char>>::operator<<
                          ...
                          *(uint *)((long)param_1 + 0x14) & 0xffffff);
      pbVar3 = std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>
                         (pbVar3,":",1);
      pbVar3 = (basic_ostream *)compiler::operator<<(pbVar3,(Operator *)*param_1);
      pbVar3 = std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>
                         (pbVar3," type ",6);
      pbVar3 = (basic_ostream *)compiler::operator<<(pbVar3,param_1[1]);
      pbVar3 = std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>
                         (pbVar3," must intersect ",0x10);
      compiler::operator<<(pbVar3,param_3);
      std::__ndk1::basic_stringbuf<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>
      ::str();
      uVar2 = (ulong)local_168 | 1;
      if ((local_168[0] & 1) != 0) {
        uVar2 = local_158;
      }
