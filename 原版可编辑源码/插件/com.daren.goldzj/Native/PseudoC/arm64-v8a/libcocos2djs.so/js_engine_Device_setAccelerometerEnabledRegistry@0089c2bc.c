...
/* js_engine_Device_setAccelerometerEnabledRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_engine_Device_setAccelerometerEnabledRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (uVar6 == 0x10) {
    ...
    if ((uVar6 & 1) != 0) {
      cocos2d::Device::setAccelerometerEnabled(local_64[0]);
      goto LAB_0089c414;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                        ,999,"js_engine_Device_setAccelerometerEnabled");
    __android_log_print(6,"jswrapper",
                        "js_engine_Device_setAccelerometerEnabled : Error processing arguments");
  }
  else {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 1003): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar6 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_Device_setAccelerometerEnabled",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x3ee);
LAB_0089c414:
