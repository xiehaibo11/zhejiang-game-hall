...
/* std::__ndk1::__split_buffer<std::__ndk1::pair<void (*)(v8::Isolate*, void*), void*>*,
   ...
   void*>*>&>::push_back(std::__ndk1::pair<void (*)(v8::Isolate*, void*), void*>*&&) */
...

{
  ...
  puVar12 = puVar4;
  if (puVar4 != *(undefined8 **)(this + 0x18)) goto LAB_00f59190;
...
LAB_00f5915c:
      ...
      if (((void *)((long)pvVar6 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar6 + uVar13 * 8 + uVar9 + 8))) goto LAB_00f5915c;
      ...
      puVar11 = puVar12;
      if (uVar2 != uVar9) goto LAB_00f5915c;
    }
    puVar11 = *(undefined8 **)this;
  }
  *(void **)this = pvVar6;
