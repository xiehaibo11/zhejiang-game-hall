...
/* v8::Value::ToBigInt(v8::Local<v8::Context>) const */

Value * __thiscall v8::Value::ToBigInt(Value *this,long param_2)
    ...
    if ((*(int *)(pIVar7 + 0x2c20) == (int)uVar8) ||
      ...
      *(undefined8 *)local_48 = uVar8;
      ...
      if (internal::TracingFlags::runtime_stats != 0) {
        ...
        internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x3af);
      }
      this_00 = *(Logger **)(pIVar7 + 0x9558);
      uVar5 = internal::Logger::is_logging(this_00);
      if ((uVar5 & 1) != 0) {
        internal::Logger::ApiEntryCall(this_00,"v8::Object::ToBigInt");
      }
      uVar1 = *(undefined4 *)(pIVar7 + 0x2c60);
      *(undefined4 *)(pIVar7 + 0x2c60) = 5;
      puVar3 = (undefined8 *)internal::BigInt::FromObject(pIVar7,this);
      this = local_48;
...
LAB_00eb1a5c:
          ...
          if (*(code **)(lVar4 + 0xb738) == (code *)0x0) goto LAB_00eb1a5c;
