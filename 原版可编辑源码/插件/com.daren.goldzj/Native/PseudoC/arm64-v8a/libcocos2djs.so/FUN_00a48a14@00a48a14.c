...
undefined8 FUN_00a48a14(UI *param_1,UI_STRING *param_2)

{
  ...
  UVar1 = UI_get_string_type(param_2);
                    /* try { // try from 00a48a34 to 00b48b1b has its CatchHandler @ 00a4887c */
  ...
  uVar2 = UI_method_get_writer((UI *)pUVar4,extraout_x1);
                    /* WARNING: Could not recover jumptable at 0x00a48a70. Too many branches */
