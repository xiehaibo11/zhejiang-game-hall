...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::extension::Manifest::AssetDiff> > >::find<std::__ndk1::basic_string<char,
...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00a69e44 to 00b69e93 has its CatchHandler @ 00a69e44
                       catch() { ... } // from try @ 00a69e44 with catch @ 00a69e44
                       catch() { ... } // from try @ 00a69f7c with catch @ 00a69e44 */
  lVar5 = tpidr_el0;
  ...
  uVar13 = *(ulong *)(this + 8);
  if (uVar13 != 0) {
                    /* try { // try from 00a69e94 to 00b69eab has its CatchHandler @ 00a6a014 */
    uVar14 = uVar13 - 1;
    if ((uVar14 & uVar13) == 0) {
      uVar15 = uVar14 & uVar7;
    }
      ...
      if (uVar13 <= uVar7) {
        ...
        uVar15 = uVar7 - uVar15 * uVar13;
                    ...
                    /* try { // try from 00a69ec0 to 00b69ed3 has its CatchHandler @ 00a6a010 */
    plVar8 = *(long **)(*(long *)this + uVar15 * 8);
    if (plVar8 != (long *)0x0) {
      plVar8 = (long *)*plVar8;
      if (plVar8 != (long *)0x0) {
                    /* try { // try from 00a69ed4 to 00b69ee3 has its CatchHandler @ 00a69ffc */
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (sVar1 == __n) {
              ...
              if ((bVar3 & 1) == 0) {
                    /* try { // try from 00a69f2c to 00b69f43 has its CatchHandler @ 00a6a024 */
                if (__n == 0) break;
                pbVar10 = (basic_string *)((long)plVar8 + 0x11);
                lVar11 = -(ulong)(bVar3 >> 1);
                pbVar12 = pbVar2;
                    /* try { // try from 00a69f44 to 00b69f4b has its CatchHandler @ 00a69ff8 */
                while (*pbVar10 == *pbVar12) {
                    /* try { // try from 00a69f4c to 00b69f7b has its CatchHandler @ 00a6a000 */
                  pbVar10 = pbVar10 + 1;
                  lVar11 = lVar11 + 1;
                  pbVar12 = pbVar12 + 1;
                  if (lVar11 == 0) goto LAB_00a69fb4;
                }
              }
            ...
            if ((uVar14 & uVar13) == 0) {
              ...
              if (uVar9 - uVar4 * uVar13 == uVar15) goto LAB_00a69f8c;
              goto LAB_00a69fb0;
            }
            if (uVar9 != uVar15) goto LAB_00a69fb0;
          }
LAB_00a69f8c:
          plVar8 = (long *)*plVar8;
