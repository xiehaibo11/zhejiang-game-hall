...
/* cocos2d::Mat4::scale(cocos2d::Vec3 const&) */

void __thiscall cocos2d::Mat4::scale(Mat4 *this,Vec3 *param_1)

{
  ...
  _local_70 = CONCAT44(SUB84(IDENTITY._0_8_,4),*(undefined4 *)param_1);
                    /* try { // try from 0099b63c to 00a9b653 has its CatchHandler @ 0099b7e4 */
  ...
  MathUtil::multiplyMatrix((float *)this,&local_70,(float *)this);
                    /* try { // try from 0099b65c to 00a9b667 has its CatchHandler @ 0099b7e0 */
  if (*(long *)(lVar1 + 0x28) == local_28) {
                    /* try { // try from 0099b668 to 00a9b673 has its CatchHandler @ 0099b7dc */
    return;
  }
