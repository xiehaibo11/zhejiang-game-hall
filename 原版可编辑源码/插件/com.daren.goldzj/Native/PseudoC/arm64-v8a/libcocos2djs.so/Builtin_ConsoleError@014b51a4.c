...
undefined8 v8::internal::Builtin_ConsoleError(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats == 0) {
    ...
    puStack_28 = param_2;
    FUN_014b8ac8(param_3,&local_30,8,1);
  ...
  uVar1 = FUN_014b5228(param_1,param_2,param_3);
  return uVar1;
}
