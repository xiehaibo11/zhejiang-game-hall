...
/* v8::Template::SetNativeDataProperty(v8::Local<v8::String>, void (*)(v8::Local<v8::String>,
   ...
   v8::PropertyAttribute, v8::Local<v8::AccessorSignature>, v8::AccessControl, v8::SideEffectType,
   v8::SideEffectType) */

void v8::Template::SetNativeDataProperty(long param_1)

{
  ...
  *(uint *)(*plVar6 + 7) = *(uint *)(*plVar6 + 7) & 0xffffe3fe | in_w5 << 10;
