...
/* void cocos2d::volumeRampMulti<3, 8, float, float, float, int, int>(float*, unsigned long, float
   const*, int*, float*, float const*, int*, int) */

void cocos2d::volumeRampMulti<3,8,float,float,float,int,int>
    ...
    do {
      ...
      *param_1 = *param_1 + *param_3 * fVar11;
      param_1[1] = param_1[1] + param_3[1] * *param_5;
                    /* try { // try from 00a81114 to 00b811f7 has its CatchHandler @ 00a80f44 */
      ...
      pfVar1 = param_3 + 7;
      param_3 = param_3 + 8;
                    /* catch() { ... } // from try @ 00a80fc4 with catch @ 00a81188 */
                    /* catch() { ... } // from try @ 00a80fb8 with catch @ 00a8118c */
      param_1[7] = param_1[7] + *pfVar1 * *param_5;
                    /* catch() { ... } // from try @ 00a80f98 with catch @ 00a81190 */
      param_1 = param_1 + 8;
      fVar11 = *param_6 + *param_5;
                    /* catch() { ... } // from try @ 00a80fd0 with catch @ 00a811a0 */
      *param_5 = fVar11;
    } while (param_2 != 0);
  }
  else {
      ...
      *param_1 = fVar12 * fVar11 + *param_1;
      ...
      if (fVar11 <= -16.0) {
        ...
        iVar4 = 0x7fffffff;
                    ...
                    /* try { // try from 00a80e60 to 00b80f43 has its CatchHandler @ 00a80c94 */
        fVar12 = 0.5;
      ...
      if (fVar11 <= -16.0) {
        ...
        iVar5 = (int)(fVar12 + fVar11 * 1.3421773e+08);
                    ...
                    /* catch() { ... } // from try @ 00a80d14 with catch @ 00a80ed4 */
                    /* catch() { ... } // from try @ 00a80d08 with catch @ 00a80ed8 */
                    /* catch() { ... } // from try @ 00a80ce8 with catch @ 00a80edc */
      param_1[2] = fVar11 * *param_5 + param_1[2];
      fVar11 = param_3[3];
                    /* catch() { ... } // from try @ 00a80d20 with catch @ 00a80eec */
      if (fVar11 <= -16.0) {
        iVar6 = -0x80000000;
      }
      else if (16.0 <= fVar11) {
      ...
      fVar11 = param_3[4];
                    /* try { // try from 00a80f44 to 00b80f97 has its CatchHandler @ 00a80f44
                       catch() { ... } // from try @ 00a80f44 with catch @ 00a80f44
                       catch() { ... } // from try @ 00a81114 with catch @ 00a80f44 */
      if (fVar11 <= -16.0) {
        iVar7 = -0x80000000;
      }
      else if (16.0 <= fVar11) {
      ...
      fVar11 = param_3[5];
                    /* try { // try from 00a80f98 to 00b80faf has its CatchHandler @ 00a81190 */
      if (fVar11 <= -16.0) {
        iVar8 = -0x80000000;
                    /* try { // try from 00a80fc4 to 00b80fcf has its CatchHandler @ 00a81188 */
      }
      else if (16.0 <= fVar11) {
        iVar8 = 0x7fffffff;
      }
        ...
        if (fVar11 * 1.3421773e+08 <= 0.0) {
          fVar12 = -0.5;
                    ...
                    /* try { // try from 00a80fb8 to 00b80fc3 has its CatchHandler @ 00a8118c */
        iVar8 = (int)(fVar12 + fVar11 * 1.3421773e+08);
      }
                    /* try { // try from 00a80fd0 to 00b81113 has its CatchHandler @ 00a811a0 */
