...
void FUN_00dfa7e0(byte *param_1,byte *param_2,byte *param_3,byte *param_4,byte *param_5,
...

{
  ...
  uVar7 = iVar1 + (uint)*param_4 >> 1 & 0xff;
  uVar38 = (uVar5 + (uVar7 * 0x6625 >> 8)) - 0x379a;
  uVar39 = iVar41 + (uint)*param_3 >> 1 & 0xff;
  if (uVar38 >> 0xe == 0) {
  ...
  *param_7 = cVar42;
  ...
  if (0 < (int)uVar7) {
    ...
    do {
      ...
      *pcVar4 = (char)in_d3;
      ...
      auVar60 = NEON_sqadd(auVar94,auVar60,2);
      auVar71 = NEON_sqsub(auVar106,auVar71,2);
      uVar58 = NEON_sqshrun(auVar83._0_8_,auVar83,6,2);
      auVar60 = NEON_sqadd(auVar60,auVar66,2);
      uVar64 = NEON_sqshrun(auVar92._0_8_,auVar71,6,2);
      uVar69 = NEON_sqshrun(auVar94._0_8_,auVar60,6,2);
      ...
      *pcVar4 = (char)uVar58;
      ...
      if (param_2 != (byte *)0x0) {
        ...
        uVar58 = NEON_sqshrun(auVar83._0_8_,auVar92,6,2);
        uVar64 = NEON_sqshrun(auVar92._0_8_,auVar71,6,2);
        uVar69 = NEON_sqshrun(auVar94._0_8_,auVar60,6,2);
        *pcVar4 = (char)uVar58;
        pcVar4[1] = (char)uVar64;
  ...
  if (0 < (int)uVar5) {
    ...
    do {
      ...
      uVar8 = (uVar6 + ((uint)*pbVar37 * 0x6625 >> 8)) - 0x379a;
      ...
      uVar8 = ((uVar6 + 0x2204) - ((uint)bVar44 * 0x1913 >> 8)) - ((uint)*pbVar37 * 0x3408 >> 8);
      *pcVar4 = cVar42;
      if (uVar8 >> 0xe == 0) {
        cVar42 = (char)(uVar8 >> 6);
      }
      ...
      uVar8 = (uVar6 + ((uint)bVar44 * 0x811a >> 8)) - 0x4515;
      pcVar4[1] = cVar42;
      if (uVar8 >> 0xe == 0) {
        cVar42 = (char)(uVar8 >> 6);
      }
    ...
    if ((param_2 != (byte *)0x0) && (0 < (int)uVar5)) {
      ...
      do {
        ...
        uVar5 = (uVar7 + ((uint)*pbVar37 * 0x6625 >> 8)) - 0x379a;
        ...
        uVar5 = ((uVar7 + 0x2204) - ((uint)bVar44 * 0x1913 >> 8)) - ((uint)*pbVar37 * 0x3408 >> 8);
        *pcVar4 = cVar42;
        if (uVar5 >> 0xe == 0) {
          cVar42 = (char)(uVar5 >> 6);
        }
        ...
        uVar5 = (uVar7 + ((uint)bVar44 * 0x811a >> 8)) - 0x4515;
        pcVar4[1] = cVar42;
        if (uVar5 >> 0xe == 0) {
          cVar42 = (char)(uVar5 >> 6);
        }
