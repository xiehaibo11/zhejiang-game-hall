...
/* v8::BigInt::NewFromWords(v8::Local<v8::Context>, int, int, unsigned long const*) */

ulong * v8::BigInt::NewFromWords(long param_1,int param_2,int param_3,ulong *param_4)
  ...
  if ((*(int *)(pIVar7 + 0x2c20) == (int)uVar9) ||
    ...
    *local_58 = uVar9;
    ...
    if (internal::TracingFlags::runtime_stats != 0) {
      ...
      internal::RuntimeCallStats::Enter(local_f0,(ulong)&local_f0 | 8,0x35e);
    }
    this = *(Logger **)(pIVar7 + 0x9558);
    uVar9 = internal::Logger::is_logging(this);
    if ((uVar9 & 1) != 0) {
      internal::Logger::ApiEntryCall(this,"v8::BigInt::NewFromWords");
    }
    uVar1 = *(undefined4 *)(pIVar7 + 0x2c60);
    *(undefined4 *)(pIVar7 + 0x2c60) = 5;
    puVar3 = (ulong *)internal::BigInt::FromWords64(pIVar7,param_2,param_3,param_4);
    puVar8 = local_58;
    if (puVar3 == (ulong *)0x0) {
      local_b0 = '\x01';
...
LAB_00ecd238:
        ...
        if (*(code **)(lVar4 + 0xb738) == (code *)0x0) goto LAB_00ecd238;
