...
/* v8::internal::Translation::StoreInt64Register(v8::internal::Register) */

void __thiscall v8::internal::Translation::StoreInt64Register(Translation *this,int param_2)
