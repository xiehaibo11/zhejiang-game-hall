...
/* v8::internal::compiler::JSGenericLowering::LowerJSCreateLiteralArray(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::JSGenericLowering::LowerJSCreateLiteralArray
...

{
  ...
  if (((*(uint *)((long)puVar2 + 0x1c) & 1) != 0) && (*(int *)(puVar2 + 3) < 0x3ffc)) {
    Builtins::CallableFor((Builtins *)local_78,*(undefined8 *)(*(long *)(this + 0x10) + 0x168),0x25)
    ;
  ...
  pNVar4 = (Node *)JSGraph::Constant(*(JSGraph **)(this + 0x10),
                                     (double)(int)*(uint *)((long)puVar2 + 0x1c));
  Node::InsertInput(param_1,pZVar7,3,pNVar4);
  ReplaceWithRuntimeCall(this,param_1,0xba,0xffffffff);
  return;
}
