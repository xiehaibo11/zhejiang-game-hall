...
/* v8::internal::MemoryAllocator::Unmapper::EnsureUnmappingCompleted() */

void __thiscall v8::internal::MemoryAllocator::Unmapper::EnsureUnmappingCompleted(Unmapper *this)
