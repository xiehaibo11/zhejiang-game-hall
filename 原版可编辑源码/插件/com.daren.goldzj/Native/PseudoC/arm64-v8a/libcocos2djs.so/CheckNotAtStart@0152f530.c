...
/* v8::internal::RegExpBytecodeGenerator::CheckNotAtStart(int, v8::internal::Label*) */

void __thiscall
v8::internal::RegExpBytecodeGenerator::CheckNotAtStart
          (RegExpBytecodeGenerator *this,int param_1,Label *param_2)

{
  ...
  *(uint *)(*(long *)(this + 0x28) + (long)iVar3) = param_1 << 8 | 0x30;
  iVar3 = *(int *)(this + 0x38);
  pRVar1 = this + 0x3c;
