...
/* v8::internal::compiler::JSFunctionRef::shared() const */

undefined1  [16] __thiscall v8::internal::compiler::JSFunctionRef::shared(JSFunctionRef *this)

{
  ...
  if (*(int *)(puVar6 + 1) == 2) {
    uVar7 = *(ulong *)*puVar6;
    if ((uVar7 & 1) == 0) goto LAB_01726a64;
    sVar1 = *(short *)((uVar7 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar7 - 1));
  }
  else {
    if (*(int *)(puVar6 + 1) == 0) goto LAB_01726a64;
