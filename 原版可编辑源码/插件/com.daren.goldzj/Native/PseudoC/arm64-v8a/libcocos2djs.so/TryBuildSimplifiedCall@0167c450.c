...
/* v8::internal::compiler::BytecodeGraphBuilder::TryBuildSimplifiedCall(v8::internal::compiler::Operator
   const*, v8::internal::compiler::Node* const*, int, v8::internal::FeedbackSlot) */

void v8::internal::compiler::BytecodeGraphBuilder::TryBuildSimplifiedCall
               (int *param_1_00,BytecodeGraphBuilder *param_1)

{
  Node *pNVar1;
  
  JSTypeHintLowering::ReduceCallOperation(param_1_00,param_1 + 0x50);
