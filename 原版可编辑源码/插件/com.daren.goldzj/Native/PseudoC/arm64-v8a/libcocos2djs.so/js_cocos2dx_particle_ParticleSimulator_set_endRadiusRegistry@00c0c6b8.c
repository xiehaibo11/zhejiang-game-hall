...
/* js_cocos2dx_particle_ParticleSimulator_set_endRadiusRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_particle_ParticleSimulator_set_endRadiusRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x4c6,"js_cocos2dx_particle_ParticleSimulator_set_endRadius");
    pcVar8 = "js_cocos2dx_particle_ParticleSimulator_set_endRadius : Invalid Native Object";
  }
  else {
    local_74 = 0.0;
    uVar7 = seval_to_float((Value *)*puVar5,&local_74);
    if ((uVar7 & 1) != 0) {
      *(float *)(lVar6 + 0x17c) = local_74;
      goto LAB_00c0c854;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                        ,0x4cb,"js_cocos2dx_particle_ParticleSimulator_set_endRadius");
    pcVar8 = "js_cocos2dx_particle_ParticleSimulator_set_endRadius : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar8);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_particle_ParticleSimulator_set_endRadius",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                      ,0x4cf);
LAB_00c0c854:
