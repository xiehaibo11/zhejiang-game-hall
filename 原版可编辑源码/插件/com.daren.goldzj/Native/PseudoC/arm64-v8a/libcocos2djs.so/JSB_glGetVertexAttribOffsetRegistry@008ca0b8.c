...
/* JSB_glGetVertexAttribOffsetRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glGetVertexAttribOffsetRegistry(FunctionCallbackInfo *param_1)
