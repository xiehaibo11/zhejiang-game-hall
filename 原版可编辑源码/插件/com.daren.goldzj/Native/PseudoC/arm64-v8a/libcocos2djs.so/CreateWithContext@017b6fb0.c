...
/* v8::internal::interpreter::BytecodeArrayBuilder::CreateWithContext(v8::internal::interpreter::Register,
   v8::internal::Scope const*) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::CreateWithContext
