...
undefined8 FUN_00db525c(undefined8 *param_1,undefined8 param_2,long *param_3)
...
LAB_00db58d8:
  ...
  default:
    ...
    case 0x80e6:
      ...
      break;
    default:
      goto switchD_00db52ac_caseD_ff;
    }
joined_r0x00db5c74:
    if (iVar4 < 0) {
      *(int *)(param_3 + 3) = iVar4 + 8;
