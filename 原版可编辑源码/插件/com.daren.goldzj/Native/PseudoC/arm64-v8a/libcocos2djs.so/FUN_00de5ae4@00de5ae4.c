...
undefined8 FUN_00de5ae4(long param_1,long param_2)

{
  ...
  *(undefined4 *)(param_1 + 0xcc) = 0;
  if (*(int *)(param_1 + 200) < 1) {
    ...
    *(undefined4 *)(param_1 + 0xd0) = 1;
    ...
    if (iVar6 == 0) {
      uVar8 = FUN_00de77ec(param_1,1,"thread initialization failed.");
      if ((int)uVar8 == 0) {
        return uVar8;
      }
      ...
      *(long *)(param_1 + 0xb8) = param_1 + 0xf8;
      ...
      uVar13 = (ulong)uVar9;
      *(code **)(param_1 + 0xa8) = FUN_00de5130;
  ...
  uVar9 = ((int)(uVar13 << 4) + (uint)(byte)(&DAT_0196fa1c)[*(int *)(param_1 + 0xb68)]) * 3;
  ...
  if (*(ulong *)(param_1 + 0xb50) < uVar1) {
    ...
    *(void **)(param_1 + 0xb48) = __ptr;
    if (__ptr == (void *)0x0) {
      uVar8 = FUN_00de77ec(param_1,1,"no memory during frame initialization.");
      if ((int)uVar8 == 0) {
        return uVar8;
      }
      goto code_r0x00de5d7c;
    }
  ...
  *(int *)(param_1 + 0xb44) = iVar12;
  bVar5 = (&DAT_0196fa1c)[*(int *)(param_1 + 0xb68)];
