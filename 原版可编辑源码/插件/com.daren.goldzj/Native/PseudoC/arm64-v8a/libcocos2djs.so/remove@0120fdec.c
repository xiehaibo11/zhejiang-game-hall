...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<v8::internal::wasm::NativeModule*,
   ...
   std::__ndk1::unique_ptr<v8::internal::wasm::WasmEngine::NativeModuleInfo,
   std::__ndk1::default_delete<v8::internal::wasm::WasmEngine::NativeModuleInfo> > > >
   >::remove(std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<v8::internal::wasm::NativeModule*,
   std::__ndk1::unique_ptr<v8::internal::wasm::WasmEngine::NativeModuleInfo,
...

{
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar7 == uVar4) goto LAB_0120fec8;
  }
  if (*param_3 != 0) {
