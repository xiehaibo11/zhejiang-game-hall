...
/* js_cocos2dx_dragonbones_AnimationState_get_additiveBlendingRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_AnimationState_get_additiveBlendingRegistry
...

{
  ...
  if (lVar3 == 0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_AnimationState_get_additiveBlending : Invalid Native Object"
                       );
    ...
    boolean_to_seval(*(bool *)(lVar3 + 0xe),aVStack_58);
