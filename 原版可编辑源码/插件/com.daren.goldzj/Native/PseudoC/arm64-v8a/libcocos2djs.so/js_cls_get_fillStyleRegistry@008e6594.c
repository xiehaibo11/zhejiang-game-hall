...
/* js_cls_get_fillStyleRegistry(v8::Local<v8::Name>, v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cls_get_fillStyleRegistry(undefined8 param_1,PropertyCallbackInfo *param_2)
