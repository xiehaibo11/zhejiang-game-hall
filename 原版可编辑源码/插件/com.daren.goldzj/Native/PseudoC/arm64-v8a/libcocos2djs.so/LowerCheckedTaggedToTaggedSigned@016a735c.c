...
/* v8::internal::compiler::EffectControlLinearizer::LowerCheckedTaggedToTaggedSigned(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerCheckedTaggedToTaggedSigned
