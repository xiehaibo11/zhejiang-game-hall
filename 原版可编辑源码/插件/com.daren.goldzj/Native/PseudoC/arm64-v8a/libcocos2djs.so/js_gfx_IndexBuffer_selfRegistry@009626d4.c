...
/* js_gfx_IndexBuffer_selfRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_gfx_IndexBuffer_selfRegistry(FunctionCallbackInfo *param_1)
