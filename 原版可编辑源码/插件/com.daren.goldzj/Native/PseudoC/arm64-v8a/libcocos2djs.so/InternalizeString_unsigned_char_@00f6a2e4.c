...
/* v8::internal::Handle<v8::internal::String> v8::internal::Factory::InternalizeString<unsigned
   char>(v8::internal::Vector<unsigned char const> const&, bool) */

void __thiscall
v8::internal::Factory::InternalizeString<unsigned_char>(Factory *this,Vector *param_1,bool param_2)
