...
/* v8::internal::compiler::CompilationDependencies::DependOnInitialMap(v8::internal::compiler::JSFunctionRef
   const&) */

undefined1  [16] __thiscall
v8::internal::compiler::CompilationDependencies::DependOnInitialMap
...

{
  ...
  auVar6 = JSFunctionRef::initial_map(param_1);
  pZVar1 = *(Zone **)this;
