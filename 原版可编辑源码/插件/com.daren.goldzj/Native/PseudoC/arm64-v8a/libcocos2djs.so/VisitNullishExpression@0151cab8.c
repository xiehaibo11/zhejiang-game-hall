...
/* v8::internal::interpreter::BytecodeGenerator::VisitNullishExpression(v8::internal::BinaryOperation*)
    */

void __thiscall
v8::internal::interpreter::BytecodeGenerator::VisitNullishExpression
...

{
  ...
  if (*(int *)(lVar11 + 0x18) != 3) {
    ...
    uVar7 = VisitNullishSubExpression(this,this_00,(BytecodeLabels *)&local_b0,iVar6);
    if ((uVar7 & 1) == 0) {
  ...
  uVar7 = Expression::IsLiteralButNotNullOrUndefined(this_00);
  if (((uVar7 & 1) == 0) || (uVar7 = Expression::ToBooleanIsTrue(this_00), (uVar7 & 1) == 0)) {
    uVar7 = Expression::IsNullLiteral(this_00);
    if ((((uVar7 & 1) != 0) || (uVar7 = Expression::IsUndefinedLiteral(this_00), (uVar7 & 1) != 0))
       && ((uVar7 = Expression::IsNullLiteral(this_01), (uVar7 & 1) != 0 ||
           (uVar7 = Expression::IsUndefinedLiteral(this_01), (uVar7 & 1) != 0)))) {
    ...
    VisitLogicalTestSubExpression(this,0x1f,this_00,uVar2,uVar3,iVar6);
