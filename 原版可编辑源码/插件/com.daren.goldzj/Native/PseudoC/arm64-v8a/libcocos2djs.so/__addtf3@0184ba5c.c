...
LAB_0184bec4:
          uVar15 = uVar22;
          if (uVar10 != 0 || uVar20 != 0) goto LAB_0184becc;
          goto LAB_0184c3c8;
        }
        if ((int)uVar21 < 0x75) {
          if (0x3f < (int)uVar21) {
...
LAB_0184bdfc:
      ...
      uVar12 = uVar11;
      uVar23 = uVar22;
      if ((uVar10 >> 0x33 & 1) == 0) goto LAB_0184c31c;
      uVar23 = uVar22 + 1;
      if (uVar23 != 0x7fff) {
...
LAB_0184be3c:
        ...
        if ((uVar11 != 0x800000) || (uVar24 == 0)) goto LAB_0184c3b0;
LAB_0184c390:
        uVar9 = 0;
        uVar24 = 1;
      }
LAB_0184c39c:
    ...
    if (uVar21 != 0) {
      if (uVar22 == 0) {
        ...
        if (uVar15 != 0x7fff) goto LAB_0184bc48;
      }
...
LAB_0184c3c8:
    ...
    if (1 < (uVar23 & 0x7fff)) {
      ...
      if (uVar11 != 0) {
        if (uVar11 == 0x400000) {
          if (uVar24 == 0) goto LAB_0184c3a4;
          goto LAB_0184be3c;
        }
        if ((uVar11 == 0x800000) && (uVar24 != 0)) goto LAB_0184c390;
LAB_0184c3b0:
        uVar9 = 0xffffffffffffffff;
        uVar23 = 0x7ffe;
        goto LAB_0184c39c;
    ...
    if (uVar22 != 0) {
      if (uVar22 == 0x7fff) {
        if (uVar10 == 0 && uVar20 == 0) {
          uVar23 = uVar22;
          if (uVar15 != 0x7fff) goto LAB_0184c3dc;
          uVar14 = 0;
LAB_0184bd68:
          uVar21 = uVar14;
        ...
        uVar21 = (uVar4 & 0xffff) >> 0xf ^ 1;
        uVar14 = uVar21;
        if (uVar15 == 0x7fff) goto LAB_0184bd68;
LAB_0184bd80:
        uVar9 = uVar10;
        uVar13 = uVar20;
        if (uVar8 != 0 || uVar12 != 0) {
...
LAB_0184bd7c:
        uVar9 = uVar8;
        uVar13 = uVar12;
        if (uVar10 != 0 || uVar20 != 0) goto LAB_0184bd80;
      }
LAB_0184c380:
      uVar15 = 0x7fff;
      goto LAB_0184c3e0;
    ...
    if ((int)uVar21 < 1) {
      if (uVar21 == 0) {
        if (1 < (uVar22 + 1 & 0x7fff)) {
          ...
          if ((uVar18 >> 0x33 & 1) == 0) {
            if (uVar18 == 0 && uVar11 == 0) goto LAB_0184c208;
          }
          else {
...
LAB_0184c208:
            ...
            if (uVar8 != 0 || uVar12 != 0) {
              ...
              if ((uVar6 >> 0x33 & 1) == 0) {
                if (uVar6 == 0 && uVar17 == 0) goto LAB_0184c208;
              }
              else {
        ...
        if (uVar22 != 0x7fff) {
          uVar21 = 0;
          uVar14 = 0;
          if (uVar15 == 0x7fff) goto LAB_0184c154;
LAB_0184c164:
          if (uVar10 == 0 && uVar20 == 0) goto LAB_0184c168;
LAB_0184c19c:
          if (uVar8 == 0 && uVar12 == 0) goto LAB_0184c380;
          uVar23 = uVar25 & 0x1fffffffffffffff | uVar11 << 0x3d;
          uVar11 = uVar27 & 0xffffffffffff;
          if (((uVar27 & 0xffffffffffff) >> 0x2f != 0) && (uVar3 >> 0x32 == 0)) {
            uVar23 = uVar28 & 0x1fffffffffffffff | uVar18 << 0x3d;
...
LAB_0184c168:
      ...
      if (uVar22 != 0) {
        if (uVar15 == 0x7fff) goto LAB_0184bff0;
        uVar21 = -uVar21;
        uVar10 = uVar10 | 0x8000000000000;
LAB_0184c018:
        if ((int)uVar21 < 0x75) {
...
LAB_0184c094:
      ...
      if (uVar10 == 0 && uVar20 == 0) {
        uVar24 = uVar19;
        if (uVar15 != 0x7fff) goto LAB_0184c31c;
        if (uVar8 == 0 && uVar12 == 0) goto LAB_0184c518;
        uVar21 = uVar14 >> 0x12 ^ 1;
        uVar9 = uVar8;
        uVar13 = uVar12;
      }
        ...
        if (uVar15 != 0x7fff) goto LAB_0184c018;
LAB_0184bff0:
        uVar24 = uVar19;
        if (uVar8 == 0 && uVar12 == 0) goto LAB_0184c3c8;
        uVar21 = uVar14 >> 0x12 ^ 1;
        uVar9 = uVar8;
        uVar13 = uVar12;
      }
      ...
      uVar19 = uVar24;
      if (uVar15 == 0) {
        if (uVar8 == 0 && uVar12 == 0) goto LAB_0184be84;
        uVar21 = uVar21 - 1;
        if (uVar21 != 0) goto LAB_0184bebc;
        uVar11 = uVar20 + uVar28 * -8;
        ...
        uVar8 = uVar8 | 0x8000000000000;
LAB_0184bebc:
        if (uVar22 == 0x7fff) goto LAB_0184bec4;
        if ((int)uVar21 < 0x75) {
          if (0x3f < (int)uVar21) {
            lVar16 = 0;
            if (uVar21 != 0x40) {
...
LAB_0184c3e4:
  uVar11 = uVar13;
  if ((uVar13 & 7) == 0) {
    if ((!bVar5) || ((uVar21 >> 4 == 0 && (((uint)uVar1 >> 0xb & 1) == 0)))) goto LAB_0184c44c;
  }
  else {
