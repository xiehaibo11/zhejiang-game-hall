...
/* v8::internal::compiler::SimplifiedOperatorBuilder::StoreField(v8::internal::compiler::FieldAccess
   const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::StoreField
...

{
  ...
  Operator::Operator(pOVar2,0xf1,0x68,"StoreField",2,1,1,0,1,0);
