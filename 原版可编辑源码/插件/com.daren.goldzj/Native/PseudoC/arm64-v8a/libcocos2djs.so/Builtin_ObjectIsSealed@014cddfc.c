...
/* v8::internal::Builtin_ObjectIsSealed(int, unsigned long*, v8::internal::Isolate*) */

undefined8 v8::internal::Builtin_ObjectIsSealed(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats == 0) {
    ...
    *(int *)(param_3 + 0x95b0) = iVar8;
    ...
    if (((uVar9 & 1) == 0) ||
      ...
      uVar6 = JSReceiver::TestIntegrityLevel(pIVar1,4);
  ...
  uVar7 = FUN_014cdf10(param_1,param_2,param_3);
  return uVar7;
}
