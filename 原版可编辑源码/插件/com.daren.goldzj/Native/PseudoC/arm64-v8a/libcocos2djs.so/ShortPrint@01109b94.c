...
/* v8::internal::Object::ShortPrint(v8::internal::StringStream*) const */

void __thiscall v8::internal::Object::ShortPrint(Object *this,StringStream *param_1)

{
  ...
  local_120 = (void *)0x0;
  local_110 = 0x10;
  local_190[0] = *(ulong *)this;
  local_170 = &PTR__basic_stringbuf_01c67100;
  internal::operator<<((basic_ostream *)&local_178,(Brief *)local_190);
  ...
  sVar2 = strlen(__s);
  StringStream::Add(param_1,__s,sVar2,0,0);
  if ((local_190[0] & 1) != 0) {
