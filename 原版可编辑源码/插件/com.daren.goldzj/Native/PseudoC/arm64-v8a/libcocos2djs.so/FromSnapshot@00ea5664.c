...
/* v8::FunctionTemplate::FromSnapshot(v8::Isolate*, unsigned long) */

ulong * v8::FunctionTemplate::FromSnapshot(Isolate *param_1,ulong param_2)

{
  ...
  if ((((int)param_2 < *(int *)(uVar3 + 3) >> 1) &&
     ...
     *(short *)((uVar3 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar4 - 1)) == 0x4e)) {
