...
/* js_cocos2dx_dragonbones_ArmatureData_get_skinsRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_ArmatureData_get_skinsRegistry
...

{
  ...
  plVar12 = *(long **)(lVar5 + 0x108);
joined_r0x00c911ac:
  do {
    if (plVar12 == (long *)(lVar5 + 0x110)) {
...
LAB_00c91318:
    ...
    if ((bVar1 & 1) != 0) {
      if (plVar12[5] != 0) goto LAB_00c911e0;
LAB_00c911cc:
      plVar9 = (long *)plVar12[1];
      if ((long *)plVar12[1] == (long *)0x0) goto LAB_00c91230;
LAB_00c91220:
      do {
        plVar12 = plVar9;
        plVar9 = (long *)*plVar12;
      } while ((long *)*plVar12 != (long *)0x0);
      goto joined_r0x00c911ac;
    }
    if (bVar1 >> 1 == 0) goto LAB_00c911cc;
LAB_00c911e0:
    bVar3 = native_ptr_to_rooted_seval<dragonBones::SkinData>
                      ((type *)plVar12[7],__jsb_dragonBones_SkinData_class,aVStack_58,(bool *)0x0);
    if (!bVar3) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          &DAT_019268ae,0x123,"js_cocos2dx_dragonbones_ArmatureData_get_skins");
      __android_log_print(6,"jswrapper","Convert dragonBones::AnimationData to se::Value failed!");
      se::Value::~Value(aVStack_58);
      se::HandleObject::~HandleObject((HandleObject *)&local_88);
      __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                          "js_cocos2dx_dragonbones_ArmatureData_get_skins",&DAT_019268ae,0x12a);
      goto LAB_00c91318;
    }
    ...
    plVar9 = (long *)plVar12[1];
    if ((long *)plVar12[1] != (long *)0x0) goto LAB_00c91220;
LAB_00c91230:
    plVar9 = plVar12 + 2;
