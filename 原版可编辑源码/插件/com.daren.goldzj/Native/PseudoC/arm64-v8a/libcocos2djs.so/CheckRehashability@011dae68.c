...
/* v8::internal::PartialSerializer::CheckRehashability(v8::internal::HeapObject) */

void __thiscall
v8::internal::PartialSerializer::CheckRehashability(PartialSerializer *this,undefined8 param_2)
