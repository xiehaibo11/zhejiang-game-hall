...
/* v8::internal::compiler::JSCallReducer::ReduceArrayForEach(v8::internal::compiler::Node*,
   v8::internal::compiler::SharedFunctionInfoRef const&) */

undefined8 __thiscall
v8::internal::compiler::JSCallReducer::ReduceArrayForEach
...

{
  ...
  if (local_bb == '\0') {
    ...
    uVar4 = IteratingArrayBuiltinReducerAssembler::ReduceArrayPrototypeForEach
