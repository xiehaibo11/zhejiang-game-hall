...
/* js_cocos2dx_spine_TransformConstraint_setShearMixRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_TransformConstraint_setShearMixRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TransformConstraint *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2d4f,"js_cocos2dx_spine_TransformConstraint_setShearMix");
    puVar6 = &DAT_019189ed;
LAB_00c675fc:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::TransformConstraint::setShearMix(this,local_64);
        goto LAB_00c67634;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x2d56,"js_cocos2dx_spine_TransformConstraint_setShearMix");
      puVar6 = &DAT_01918a37;
      goto LAB_00c675fc;
    }
    __android_log_print(6,"jswrapper",&DAT_01918a86,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TransformConstraint_setShearMix",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x2d5d);
LAB_00c67634:
