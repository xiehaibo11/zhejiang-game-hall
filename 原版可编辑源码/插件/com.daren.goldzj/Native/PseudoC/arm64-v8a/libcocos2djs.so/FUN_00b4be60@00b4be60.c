...
int FUN_00b4be60(long param_1,int param_2,int param_3,EVP_MD *param_4)

{
  ...
  case 0x1001:
    if (param_3 - 1U < 6) {
      if (*(EVP_MD **)(piVar6 + 8) == (EVP_MD *)0x0) goto LAB_00b4c23c;
      iVar3 = EVP_MD_type(*(EVP_MD **)(piVar6 + 8));
      if (param_3 == 5) {
        iVar3 = RSA_X931_hash_id(iVar3);
        if (iVar3 != -1) goto LAB_00b4c268;
        goto LAB_00b4c1b4;
      }
      if (param_3 == 3) goto LAB_00b4bfdc;
      if (iVar3 < 0x101) {
        if (((iVar3 - 0x40U < 0x36) &&
...
LAB_00b4c23c:
          if (param_3 == 4) {
            ...
            if (param_3 != 6) goto LAB_00b4c268;
...
LAB_00b4c268:
      ...
      else if ((iVar3 - 0x2a0U < 4) || (iVar3 == 0x101)) goto LAB_00b4c23c;
LAB_00b4c2c4:
      iVar3 = 0x9d;
      iVar2 = 0x169;
LAB_00b4c1cc:
...
LAB_00b4c280:
  ...
  case 0x1008:
    if ((piVar6[6] | 2U) == 6) {
      ...
      if (lVar5 != 0) goto LAB_00b4bf8c;
switchD_00b4bee4_caseD_d:
      lVar5 = *(long *)(piVar6 + 8);
LAB_00b4bf8c:
...
LAB_00b4c058:
  ...
  case 0x100b:
    if (piVar6[6] == 4) {
      if (param_2 != 0x100b) goto LAB_00b4c224;
      goto switchD_00b4bee4_caseD_d;
    }
    iVar3 = 0x8d;
    iVar2 = 0x1b6;
    break;
        ...
        if (iVar3 != 3) {
          if (iVar2 < 0x101) {
            if (((iVar2 - 0x40U < 0x36) &&
               ...
               (iVar2 - 3U < 2)) goto LAB_00b4c224;
          }
          else if ((iVar2 - 0x2a0U < 4) || (iVar2 == 0x101)) goto LAB_00b4c224;
          goto LAB_00b4c2c4;
        }
LAB_00b4bfdc:
        iVar3 = 0x8d;
...
switchD_00b4bee4_caseD_6:
  iVar3 = -2;
switchD_00b4bee4_caseD_3:
  return iVar3;
}
