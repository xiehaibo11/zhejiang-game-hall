...
/* JSB_localStorageClearRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_localStorageClearRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar4[1] == *plVar4) {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_cocos2dx_manual.cpp, 299): Invalid number of arguments\n"
                       );
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "JSB_localStorageClear",
