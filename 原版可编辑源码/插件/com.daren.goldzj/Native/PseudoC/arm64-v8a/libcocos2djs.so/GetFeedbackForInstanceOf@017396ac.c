...
/* v8::internal::compiler::JSHeapBroker::GetFeedbackForInstanceOf(v8::internal::compiler::FeedbackSource
   const&) */

undefined8 __thiscall
v8::internal::compiler::JSHeapBroker::GetFeedbackForInstanceOf
...

{
  ...
  if (FLAG_concurrent_inlining == '\0') {
    uVar2 = ProcessFeedbackForInstanceOf(this,param_1);
    return uVar2;
  }
  lVar1 = std::__ndk1::
