...
/* v8::internal::compiler::MachineOperatorBuilder::I64x2ReplaceLane(int) */

Operator * __thiscall
v8::internal::compiler::MachineOperatorBuilder::I64x2ReplaceLane
...

{
  ...
  Operator::Operator(pOVar1,0x229,0x7c,"Replace lane",2,0,0,1,0,0);
