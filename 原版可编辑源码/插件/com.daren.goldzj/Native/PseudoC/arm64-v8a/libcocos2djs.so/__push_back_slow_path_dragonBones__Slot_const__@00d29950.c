...
/* void std::__ndk1::vector<dragonBones::Slot*, std::__ndk1::allocator<dragonBones::Slot*>
   >::__push_back_slow_path<dragonBones::Slot* const&>(dragonBones::Slot* const&) */

void __thiscall
std::__ndk1::vector<dragonBones::Slot*,std::__ndk1::allocator<dragonBones::Slot*>>::
__push_back_slow_path<dragonBones::Slot*const&>
          (vector<dragonBones::Slot*,std::__ndk1::allocator<dragonBones::Slot*>> *this,
          Slot **param_1)
...
LAB_00d299b4:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d299b4;
  }
  else {
