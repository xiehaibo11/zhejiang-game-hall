...
/* v8::internal::wasm::WasmFunctionBuilder::EmitI64Const(long) */

void __thiscall
v8::internal::wasm::WasmFunctionBuilder::EmitI64Const(WasmFunctionBuilder *this,long param_1)

{
  ...
  *puVar3 = 0x42;
  ZoneBuffer::write_i64v((ZoneBuffer *)(this + 0x40),param_1);
  return;
}
