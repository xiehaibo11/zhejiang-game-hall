...
/* js_engine_CanvasRenderingContext2D_fillRectRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_engine_CanvasRenderingContext2D_fillRectRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (CanvasRenderingContext2D *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x66c,"js_engine_CanvasRenderingContext2D_fillRect");
    __android_log_print(6,"jswrapper",
                        "js_engine_CanvasRenderingContext2D_fillRect : Invalid Native Object");
  }
  else {
    ...
    if (uVar10 == 0x40) {
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                          ,0x679,"js_engine_CanvasRenderingContext2D_fillRect");
      __android_log_print(6,"jswrapper",
                          "js_engine_CanvasRenderingContext2D_fillRect : Error processing arguments"
                         );
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 1661): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar10 >> 4,4);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_CanvasRenderingContext2D_fillRect",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x680);
LAB_008a1664:
