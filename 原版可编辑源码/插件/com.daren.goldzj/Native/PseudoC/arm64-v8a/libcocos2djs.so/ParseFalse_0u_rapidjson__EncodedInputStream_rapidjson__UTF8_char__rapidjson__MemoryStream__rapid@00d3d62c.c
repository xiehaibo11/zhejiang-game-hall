...
/* void rapidjson::GenericReader<rapidjson::UTF8<char>, rapidjson::UTF8<char>,
   rapidjson::CrtAllocator>::ParseFalse<0u, rapidjson::EncodedInputStream<rapidjson::UTF8<char>,
...

{
  ...
  pcVar8 = pcVar6;
  if ((pcVar6 != pcVar10) && (*pcVar6 == 'a')) {
    pcVar8 = pcVar6 + 1;
    *plVar3 = (long)pcVar8;
    if ((pcVar8 != pcVar10) && (*pcVar8 == 'l')) {
      pcVar8 = pcVar6 + 2;
      *plVar3 = (long)pcVar8;
      if ((pcVar8 != pcVar10) && (*pcVar8 == 's')) {
        pcVar8 = pcVar6 + 3;
        *plVar3 = (long)pcVar8;
        if ((pcVar8 != pcVar10) && (*pcVar8 == 'e')) {
          *plVar3 = (long)(pcVar6 + 4);
          ...
          if (puVar1 < puVar7) {
            ...
            if (__ptr == (void *)0x0) {
              ...
              uVar9 = (long)puVar1 +
                      (((ulong)((long)puVar1 + (1 - (long)__ptr)) >> 1) - (long)__ptr);
            }
