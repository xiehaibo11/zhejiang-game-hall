...
/* js_cocos2dx_spine_SkeletonCacheAnimation_beginScheduleRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonCacheAnimation_beginScheduleRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonCacheAnimation *)0x0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonCacheAnimation_beginSchedule : Invalid Native Object"
                       );
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      spine::SkeletonCacheAnimation::beginSchedule(this);
      goto LAB_00c8145c;
    }
    __android_log_print(6,"jswrapper",&DAT_01923e6b,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
