...
/* js_cocos2dx_dragonbones_AnimationData_set_frameCountRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_AnimationData_set_frameCountRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xc6a,"js_cocos2dx_dragonbones_AnimationData_set_frameCount");
    pcVar8 = "js_cocos2dx_dragonbones_AnimationData_set_frameCount : Invalid Native Object";
  }
  else {
    local_74 = 0;
    uVar7 = seval_to_uint32((Value *)*puVar5,&local_74);
    if ((uVar7 & 1) != 0) {
      *(uint *)(lVar6 + 0x1c) = local_74;
      goto LAB_00caa1dc;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0xc6f,"js_cocos2dx_dragonbones_AnimationData_set_frameCount");
    pcVar8 = "js_cocos2dx_dragonbones_AnimationData_set_frameCount : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar8);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_AnimationData_set_frameCount",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0xc73);
LAB_00caa1dc:
