...
/* std::__ndk1::deque<std::__ndk1::unique_ptr<v8::Task, std::__ndk1::default_delete<v8::Task> >,
   std::__ndk1::allocator<std::__ndk1::unique_ptr<v8::Task, std::__ndk1::default_delete<v8::Task> >
   > >::__add_back_capacity() */
  ...
  *pdStack_40;
  ...
  if (*(ulong *)(this + 0x20) < 0x200) {
    ...
    if ((ulong)(lVar5 >> 3) <= uVar7) {
      ...
      __split_buffer<std::__ndk1::unique_ptr<v8::Task,std::__ndk1::default_delete<v8::Task>>*,std::__ndk1::allocator<std::__ndk1::unique_ptr<v8::Task,std::__ndk1::default_delete<v8::Task>>*>&>
      ::push_back((__split_buffer<std::__ndk1::unique_ptr<v8::Task,std::__ndk1::default_delete<v8::Task>>*,std::__ndk1::allocator<std::__ndk1::unique_ptr<v8::Task,std::__ndk1::default_delete<v8::Task>>*>&>
                   *)&local_60,&local_18);
      ...
      if (ppuVar6 != ppuVar3) {
        do {
          ppuVar6 = ppuVar6 + -1;
          __split_buffer<std::__ndk1::unique_ptr<v8::Task,std::__ndk1::default_delete<v8::Task>>*,std::__ndk1::allocator<std::__ndk1::unique_ptr<v8::Task,std::__ndk1::default_delete<v8::Task>>*>&>
          ::push_front((__split_buffer<std::__ndk1::unique_ptr<v8::Task,std::__ndk1::default_delete<v8::Task>>*,std::__ndk1::allocator<std::__ndk1::unique_ptr<v8::Task,std::__ndk1::default_delete<v8::Task>>*>&>
                        *)&local_60,ppuVar6);
          ppuVar3 = *(unique_ptr ***)(this + 8);
