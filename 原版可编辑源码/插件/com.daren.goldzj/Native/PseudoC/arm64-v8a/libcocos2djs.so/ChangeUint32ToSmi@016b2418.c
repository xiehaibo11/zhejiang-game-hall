...
/* v8::internal::compiler::EffectControlLinearizer::ChangeUint32ToSmi(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::ChangeUint32ToSmi
