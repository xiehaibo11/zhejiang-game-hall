...
undefined8 FUN_01345e80(long param_1,long param_2)

{
  ...
  while ((int)param_2 != (int)param_1) {
    ...
    if ((uVar1 == 5) ||
      ...
      if ((uVar2 != 5) &&
        ...
        FUN_013be7e0(2,*(undefined8 *)(unaff_x26 + 0x25d0));
      }
      param_1 = unaff_x26 + (ulong)*(uint *)(param_1 + 0xb);
    }
  }
  goto LAB_01345fc8;
LAB_01345f84:
  if (lVar6 == uVar5 + 0xb) goto LAB_01345fa8;
  if (*(byte *)(param_2 + lVar6) != *(byte *)(param_1 + lVar6)) {
    if (*(byte *)(param_1 + lVar6) <= *(byte *)(param_2 + lVar6)) goto LAB_01345fb8;
    goto LAB_01345fc0;
  }
  lVar6 = lVar6 + 1;
  goto LAB_01345f84;
