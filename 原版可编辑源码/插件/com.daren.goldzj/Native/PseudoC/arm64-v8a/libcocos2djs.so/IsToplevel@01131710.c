...
/* v8::internal::StackTraceFrame::IsToplevel(v8::internal::Handle<v8::internal::StackTraceFrame>) */

byte v8::internal::StackTraceFrame::IsToplevel(ulong *param_1)
