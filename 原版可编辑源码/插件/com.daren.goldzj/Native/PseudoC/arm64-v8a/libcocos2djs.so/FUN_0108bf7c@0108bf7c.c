...
void FUN_0108bf7c(long param_1,long param_2,int param_3,long param_4,byte param_5,int param_6,
                 uint param_7)
  ...
  if ((int)param_7 < 0) {
    ...
    if (0 < (int)uVar4) {
      ...
      if (uVar4 < 8) {
        ...
        if (uVar8 == uVar6) goto LAB_0108c050;
      }
      lVar7 = uVar6 - uVar8;
  ...
  if (param_7 != 0) {
    v8::internal::Heap::CopyRange<v8::internal::CompressedObjectSlot>
              ((Heap *)(param_1 + 0x8850),param_4,param_4 + (param_6 << 2) + 7,
               param_2 + (param_3 << 2) + 7,param_7,(ulong)((param_5 & 0xfe) == 2) << 2);
    return;
  }
switchD_0108bfa8_default:
  return;
}
