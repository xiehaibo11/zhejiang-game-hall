...
/* v8::internal::compiler::JSHeapBroker::ProcessFeedbackForBinaryOperation(v8::internal::compiler::FeedbackSource
   const&) */

undefined4 * __thiscall
v8::internal::compiler::JSHeapBroker::ProcessFeedbackForBinaryOperation
...

{
  ...
  *this_00;
  ...
  if (lVar4 == 0) {
    ...
    cVar2 = FeedbackNexus::GetBinaryOperationFeedback((FeedbackNexus *)&local_60);
