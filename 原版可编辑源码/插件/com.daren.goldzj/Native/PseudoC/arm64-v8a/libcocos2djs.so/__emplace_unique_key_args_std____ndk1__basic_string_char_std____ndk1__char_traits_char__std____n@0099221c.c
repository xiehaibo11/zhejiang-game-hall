...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::allocator<se::Value> > >, void*>*>, bool>
      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if ((uVar13 & uVar14) == 0) {
            ...
            if (uVar10 - uVar4 * uVar14 == unaff_x21) goto LAB_00992324;
            break;
          }
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(basic_string *)((long)plVar12 + uVar10 + 0x11) == pbVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00992464;
              }
              goto LAB_009923b8;
            }
          }
