...
undefined8 FUN_014b1230(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar10 & 1) == 0) ||
    ...
    uStack_100 = __strlen_chk("getFunctionName",0x10);
    local_108 = "getFunctionName";
...
LAB_014b13f8:
    ...
    if ((0xff < uVar4) && ((uVar4 & 0xff) != 0)) {
      ...
      puVar8 = (undefined8 *)(**(code **)(*plVar7 + 0x28))();
      uVar6 = *puVar8;
      goto LAB_014b135c;
    }
    uStack_100 = __strlen_chk("getFunctionName",0x10);
