...
/* WARNING: Removing unreachable block (ram,0x01045bb4) */
/* WARNING: Removing unreachable block (ram,0x01045bb8) */
/* v8::internal::JsonParser<unsigned char>::BuildJsonArray(v8::internal::JsonParser<unsigned
   char>::JsonContinuation const&, std::__ndk1::vector<v8::internal::Handle<v8::internal::Object>,
   std::__ndk1::allocator<v8::internal::Handle<v8::internal::Object> > > const&) */

ulong * __thiscall
v8::internal::JsonParser<unsigned_char>::BuildJsonArray
          (JsonParser<unsigned_char> *this,JsonContinuation *param_1,vector *param_2)
...
LAB_01045ae4:
          *pdVar9 = dVar15;
          ...
          pdVar9 = (double *)(uVar11 + (uVar7 & 0xfffffff8 | 7));
          if (!NAN(dVar15)) goto LAB_01045ae4;
          *pdVar9 = NAN;
        }
        uVar7 = uVar7 + 8;
