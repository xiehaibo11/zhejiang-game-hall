...
undefined8
FUN_01080740(undefined8 param_1,ulong *param_2,KeyAccumulator *param_3,undefined4 param_4)

{
  ...
  if (iVar3 >> 1 != 0) {
    lVar9 = 0;
    while( true ) {
      uVar8 = uVar8 & 0xffffffff00000000 | (ulong)*(uint *)(uVar8 + (long)(int)lVar9 + 7);
      if (*(CanonicalHandleScope **)(pIVar7 + 0x95b8) == (CanonicalHandleScope *)0x0) {
        puVar5 = *(ulong **)pIVar1;
