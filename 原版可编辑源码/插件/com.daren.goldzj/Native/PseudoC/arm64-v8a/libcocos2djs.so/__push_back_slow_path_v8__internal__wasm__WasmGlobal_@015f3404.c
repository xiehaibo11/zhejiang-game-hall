...
/* void std::__ndk1::vector<v8::internal::wasm::WasmGlobal,
   std::__ndk1::allocator<v8::internal::wasm::WasmGlobal>
   >::__push_back_slow_path<v8::internal::wasm::WasmGlobal>(v8::internal::wasm::WasmGlobal&&) */
...

{
  ...
  if (uVar1 >> 0x3b == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3b != 0) goto LAB_015f34f0;
