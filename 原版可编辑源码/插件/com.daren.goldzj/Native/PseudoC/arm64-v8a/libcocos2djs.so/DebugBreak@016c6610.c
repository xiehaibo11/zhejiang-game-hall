...
/* v8::internal::compiler::GraphAssembler::DebugBreak() */

Node * __thiscall v8::internal::compiler::GraphAssembler::DebugBreak(GraphAssembler *this)

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::DebugBreak
