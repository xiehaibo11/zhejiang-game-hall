...

{
  ...
  lVar4 = OPENSSL_sk_new_null();
                    /* try { // try from 00b5cb20 to 00c5cb57 has its CatchHandler @ 00b5cb74 */
  ...
  if (ptr == (int *)0x0) {
    ...
    *ptr = 0;
    if (lVar4 != 0) {
                    /* try { // try from 00b5cb58 to 00c5cb87 has its CatchHandler @ 00b5c468 */
      ...
      if (iVar1 != 0) {
        if (iVar2 == 2) {
          X509_CRL_free(*(X509_CRL **)(ptr + 2));
                    ...
                    /* catch() { ... } // from try @ 00b5cb20 with catch @ 00b5cb74 */
          X509_free(*(X509 **)(ptr + 2));
                    /* catch() { ... } // from try @ 00b5cab8 with catch @ 00b5cb7c */
        }
        CRYPTO_free(ptr);
        CRYPTO_THREAD_write_lock(*(undefined8 *)(*param_1 + 0x90));
        iVar2 = FUN_00b5c838(*(undefined8 *)(*param_1 + 8),2,param_2,&local_34);
        if (-1 < iVar2) {
          lVar5 = *param_1;
          if (0 < local_34) {
            iVar1 = 0;
