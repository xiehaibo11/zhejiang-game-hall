...
/* spine::Skeleton::findPathConstraint(spine::String const&) */

long __thiscall spine::Skeleton::findPathConstraint(Skeleton *this,String *param_1)

{
  ...
  if (uVar4 != 0) {
    uVar5 = 0;
    do {
      lVar3 = *(long *)(*(long *)(this + 200) + uVar5 * 8);
