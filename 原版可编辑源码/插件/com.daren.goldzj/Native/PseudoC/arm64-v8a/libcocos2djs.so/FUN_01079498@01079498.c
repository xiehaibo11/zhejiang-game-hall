...
undefined4 FUN_01079498(ulong param_1,ulong param_2,ulong param_3,long param_4,long param_5)
          ...
          if (param_4 != 0) {
            ...
            do {
              ...
              if (((dVar16 < -2147483648.0) || (2147483647.0 < dVar16)) ||
                ...
                if ((int)uVar2 < 0) {
                  if ((int)uVar2 < -0x34) goto LAB_01079634;
            ...
            do {
              if (*(long *)(uVar13 + (long)iVar9) == -0x8000000080001) {
                ...
                if ((((dVar16 < -2147483648.0) || (2147483647.0 < dVar16)) ||
                  ...
                  if ((int)uVar4 < 0) {
                    if ((int)uVar4 < -0x34) goto LAB_01079838;
...
LAB_01079784:
    ...
    if (*(short *)(((ulong)pIVar12 | 7) + (ulong)*(uint *)(((ulong)pIVar12 | (ulong)uVar4) - 1)) !=
        0xa9) goto LAB_01079528;
LAB_010795fc:
    v8::internal::PerIsolateAssertScope<(v8::internal::PerIsolateAssertType)0,false>::
    ~PerIsolateAssertScope(aPStack_78);
  }
  uVar15 = 0;
switchD_010795b0_caseD_2:
  v8::internal::PerIsolateAssertScope<(v8::internal::PerIsolateAssertType)0,false>::
