...
/* void std::__ndk1::vector<v8::internal::Handle<v8::internal::Code>,
   std::__ndk1::allocator<v8::internal::Handle<v8::internal::Code> >
   >::__push_back_slow_path<v8::internal::Handle<v8::internal::Code>
   const&>(v8::internal::Handle<v8::internal::Code> const&) */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00ede3e0;
