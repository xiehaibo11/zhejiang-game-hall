...
v8::internal::compiler::InstructionSelector::Emit
          (InstructionSelector *this,uint param_1,ulong param_3,undefined8 param_4,ulong param_5,
          InstructionOperand *param_6)

{
  ...
  if (param_5 < 0x3f) {
    ...
    uVar2 = 0x30;
    if (lVar1 + param_5 != 0) {
      uVar2 = (long)((lVar1 + param_5 << 0x23) + 0x2800000000) >> 0x20;
    }
    local_50 = param_4;
    uStack_48 = param_3;
    ...
    Instruction::Instruction
              (this_01,param_1,(ulong)((param_3 & 7) != 0),(InstructionOperand *)&uStack_48,1,
               (InstructionOperand *)&local_50,param_5,param_6);
