...

{
  ...
  if ((((rem == (BIGNUM *)0x0) || (pBVar11 == (BIGNUM *)0x0)) || (r_00 == (BIGNUM *)0x0)) ||
     (pBVar12 == (BIGNUM *)0x0)) {
joined_r0x00b88dfc:
    if (m_ctx != (BN_MONT_CTX *)0x0) goto LAB_00b88dc8;
  }
  else {
    mont = m_ctx;
...
LAB_00b88d44:
                    if ((iVar9 == iVar5) && (uVar17 != 0)) {
                      ...
                      uVar17 = 0;
                      bVar3 = false;
                      if (iVar10 == 0) goto joined_r0x00b88dfc;
                    }
                    iVar6 = iVar6 + -1;
                    iVar16 = iVar16 + -1;
                    bVar1 = 1 < iVar14;
...
LAB_00b88db8:
    ...
    if (mont == (BN_MONT_CTX *)0x0) {
      ...
      if (iVar6 != 0) goto joined_r0x00b888c8;
      uVar19 = 0;
    }
  }
