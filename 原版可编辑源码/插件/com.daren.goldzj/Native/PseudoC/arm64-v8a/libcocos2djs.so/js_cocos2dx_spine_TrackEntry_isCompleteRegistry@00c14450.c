...
/* js_cocos2dx_spine_TrackEntry_isCompleteRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_TrackEntry_isCompleteRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TrackEntry *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x187,"js_cocos2dx_spine_TrackEntry_isComplete");
    puVar8 = &DAT_018f191e;
LAB_00c145bc:
    ...
    if (plVar5[1] - *plVar5 == 0) {
      bVar3 = spine::TrackEntry::isComplete(this);
      pVVar7 = (Value *)se::State::rval(aSStack_60);
      uVar6 = boolean_to_seval((bool)(bVar3 & 1),pVVar7);
      if ((uVar6 & 1) != 0) goto LAB_00c145f4;
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x18e,"js_cocos2dx_spine_TrackEntry_isComplete");
      puVar8 = &DAT_018f195e;
      goto LAB_00c145bc;
    }
    __android_log_print(6,"jswrapper",&DAT_018f19a3,(ulong)(plVar5[1] - *plVar5) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TrackEntry_isComplete",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x194);
LAB_00c145f4:
  pVVar7 = (Value *)se::State::rval(aSStack_60);
