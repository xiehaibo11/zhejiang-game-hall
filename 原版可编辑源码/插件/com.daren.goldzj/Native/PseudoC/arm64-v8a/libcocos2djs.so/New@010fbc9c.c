...
/* v8::internal::BaseNameDictionary<v8::internal::NameDictionary,
   v8::internal::NameDictionaryShape>::New(v8::internal::Isolate*, int,
   v8::internal::AllocationType, v8::internal::MinimumCapacity) */

void v8::internal::
     BaseNameDictionary<v8::internal::NameDictionary,v8::internal::NameDictionaryShape>::New
...

{
  ...
  plVar1 = (long *)Factory::NewFixedArrayWithMap<v8::internal::FixedArray>
                             (param_1,0x31,param_2 * 3 + 5,param_3);
