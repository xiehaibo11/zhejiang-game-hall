...
/* v8::internal::JSFunction::GetFunctionRealm(v8::internal::Handle<v8::internal::JSFunction>) */

ulong * v8::internal::JSFunction::GetFunctionRealm(ulong *param_1)

{
  ...
  uVar3 = (ulong)pIVar1 |
          (ulong)*(uint *)(((ulong)pIVar1 |
                           (ulong)*(uint *)(((ulong)pIVar1 | (ulong)*(uint *)(*param_1 + 0xf)) - 1))
                          + 0x13);
