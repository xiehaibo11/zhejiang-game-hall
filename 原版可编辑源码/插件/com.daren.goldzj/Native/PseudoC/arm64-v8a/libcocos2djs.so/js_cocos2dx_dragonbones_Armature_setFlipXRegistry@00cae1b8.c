...
/* js_cocos2dx_dragonbones_Armature_setFlipXRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_Armature_setFlipXRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Armature *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xea6,"js_cocos2dx_dragonbones_Armature_setFlipX");
    pcVar6 = "js_cocos2dx_dragonbones_Armature_setFlipX : Invalid Native Object";
LAB_00cae34c:
    ...
    if (uVar7 == 0x10) {
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                          ,0xead,"js_cocos2dx_dragonbones_Armature_setFlipX");
      pcVar6 = "js_cocos2dx_dragonbones_Armature_setFlipX : Error processing arguments";
      goto LAB_00cae34c;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp, 3761): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_Armature_setFlipX",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0xeb4);
LAB_00cae384:
