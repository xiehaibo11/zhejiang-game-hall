...
void FUN_00a2e5bc(int param_1,undefined8 param_2,undefined8 param_3,char *param_4,char *param_5,
                 socklen_t param_6)
    ...
    if ((sVar4 < 0x10) && (__fd = socket(2,1,0), __fd != -1)) {
      ...
      if (-1 < iVar2) {
        ...
        goto LAB_00a2e6bc;
                    ...
                    /* try { // try from 00a2e6b0 to 00b2e797 has its CatchHandler @ 00a2e4c4 */
      close(__fd);
    }
    uVar3 = 0;
  }
