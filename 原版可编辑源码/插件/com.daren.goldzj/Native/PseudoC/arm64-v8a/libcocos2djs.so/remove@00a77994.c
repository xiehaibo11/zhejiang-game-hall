...

{
  ...
  uVar2 = param_2[1];
  uVar6 = param_3[1];
                    /* try { // try from 00a7799c to 00b779a7 has its CatchHandler @ 00a77c68 */
  uVar8 = uVar2 - 1;
  uVar3 = 0;
  if (uVar2 != 0) {
    uVar3 = uVar6 / uVar2;
  }
                    /* try { // try from 00a779a8 to 00b779b3 has its CatchHandler @ 00a77c64 */
  uVar1 = uVar6;
  if (uVar2 <= uVar6) {
    uVar1 = uVar6 - uVar3 * uVar2;
  }
                    /* try { // try from 00a779b4 to 00b779cb has its CatchHandler @ 00a77c7c */
  uVar3 = uVar8 & uVar2;
  if (uVar3 == 0) {
    uVar1 = uVar8 & uVar6;
  }
  ...
  if (plVar7 != param_2 + 2) {
    ...
    if (uVar6 == uVar1) goto LAB_00a77a48;
  }
  if (*param_3 != 0) {
  ...
  if (*param_3 != 0) {
    ...
    if (uVar3 == 0) {
      uVar6 = uVar6 & uVar8;
                    ...
                    /* try { // try from 00a77a5c to 00b77ac3 has its CatchHandler @ 00a77c7c */
      if (uVar2 <= uVar6) {
        uVar3 = 0;
        if (uVar2 != 0) {
          uVar3 = uVar6 / uVar2;
