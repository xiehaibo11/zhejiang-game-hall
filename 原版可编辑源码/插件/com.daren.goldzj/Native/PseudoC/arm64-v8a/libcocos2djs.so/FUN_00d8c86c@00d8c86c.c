...
void FUN_00d8c86c(long *param_1)
  ...
  do {
    if (*(int *)(param_1[0x4d] + 0x18) == 0) {
      ...
      if (lVar35 == 0) {
        ...
        if ((int)uVar28 == 0) goto LAB_00d8dfac;
        lVar35 = puVar31[1];
      }
      lVar35 = lVar35 + -1;
      ...
      if (0x12 < uVar52) {
        do {
          ...
          *(uint *)(lVar47 + 0x48) = (uint)bVar19;
          ...
          if (uVar44 == 0) {
            if ((bVar22 >> 4 & 1) != 0) goto LAB_00d8cdd8;
LAB_00d8cdb0:
...
LAB_00d8cdec:
            ...
            if ((bVar22 >> 4 & 1) == 0) goto LAB_00d8cdb0;
LAB_00d8cdd8:
            uVar53 = uVar52 - 0x10;
            plVar43 = param_1 + uVar52 + 0x11;
            if (3 < (uint)uVar53) goto LAB_00d8cdec;
          }
    ...
    case 0xca:
      ...
      uVar28 = 0;
LAB_00d8d51c:
      uVar28 = FUN_00d8e8a8(param_1,uVar28,uVar29,uVar30);
      iVar27 = (int)uVar28;
joined_r0x00d8c8d4:
      if (iVar27 == 0) goto LAB_00d8dfac;
      break;
    case 0xcc:
      puVar31 = (undefined8 *)param_1[5];
      lVar35 = puVar31[1];
      ...
      if (2 < uVar52) {
        do {
          ...
          *(uint *)(lVar32 + 0x30) = uVar44;
          ...
          if (bVar22 < 0x20) {
            if (0xf < bVar22) goto LAB_00d8d654;
    ...
    case 0xda:
      ...
      *(uint *)(lVar32 + 0x2c) = (uint)bVar22;
      ...
      if ((bVar22 < 5) && ((ulong)CONCAT11(uVar20,uVar21) == (ulong)bVar22 * 2 + 6)) {
        if (uVar44 == 0) {
          if (*(int *)((long)param_1 + 0x13c) == 0) goto LAB_00d8dcc4;
          *(uint *)(param_1 + 0x38) = (uint)bVar22;
          lVar32 = lVar35 + -1;
          bVar25 = true;
          if (lVar32 == 0) goto LAB_00d8ded8;
          pbVar49 = pbVar51 + 1;
          goto LAB_00d8deec;
        }
        bVar26 = lVar35 == 1;
      ...
      if (2 < uVar52) {
        do {
          ...
          *(uint *)(lVar35 + 0x30) = (uint)bVar22;
          ...
          if (bVar22 == 0) {
            lVar54 = lVar37;
            if (0x40 < lVar32) goto LAB_00d8d8e8;
LAB_00d8d8a0:
            ...
            *puVar31 = 0x1000100010001;
            ...
            default:
              ...
              pbVar51 = pbVar49 + 1;
              lVar35 = lVar47 + -1;
              if (0 < lVar54) goto joined_r0x00d8d99c;
              goto LAB_00d8da04;
            case 9:
...
LAB_00d8d408:
        ...
        *(undefined4 *)(puVar36 + 5) = 0x1c;
        ...
        pbVar51 = pbVar50 + 1;
        lVar35 = lVar35 + -1;
        if (CONCAT11(bVar22,*pbVar50) != 0xff) goto LAB_00d8d408;
        pbVar49 = pbVar51;
        if (lVar35 == 0) {
          uVar28 = (*(code *)puVar31[3])(param_1);
          if ((int)uVar28 == 0) goto LAB_00d8dfac;
        ...
        pbVar51 = pbVar49 + 1;
        lVar35 = lVar35 + -1;
        if (*pbVar49 != 3) goto LAB_00d8d408;
        pbVar49 = pbVar51;
        if (lVar35 == 0) {
          uVar28 = (*(code *)puVar31[3])(param_1);
          if ((int)uVar28 == 0) goto LAB_00d8dfac;
        ...
        lVar35 = lVar35 + -1;
        if (puVar33[0x18] != (uint)*pbVar49) goto LAB_00d8d408;
        pbVar49 = pbVar51;
        if (lVar35 == 0) {
          uVar28 = (*(code *)puVar31[3])(param_1);
          if ((int)uVar28 == 0) goto LAB_00d8dfac;
        ...
        pbVar51 = pbVar49 + 1;
        lVar35 = lVar35 + -1;
        if (*puVar33 != (uint)*pbVar49) goto LAB_00d8d408;
        pbVar49 = pbVar51;
        if (lVar35 == 0) {
          uVar28 = (*(code *)puVar31[3])(param_1);
          if ((int)uVar28 == 0) goto LAB_00d8dfac;
        ...
        pbVar51 = pbVar49 + 1;
        lVar35 = lVar35 + -1;
        if (puVar33[0x30] != (uint)*pbVar49) goto LAB_00d8d408;
        pbVar49 = pbVar51;
        if (lVar35 == 0) {
          uVar28 = (*(code *)puVar31[3])(param_1);
          if ((int)uVar28 == 0) goto LAB_00d8dfac;
        ...
        pbVar51 = pbVar49 + 1;
        lVar35 = lVar35 + -1;
        if (*pbVar49 != 0x80) goto LAB_00d8d408;
        if (lVar35 == 0) {
          uVar28 = (*(code *)puVar31[3])(param_1);
          if ((int)uVar28 == 0) goto LAB_00d8dfac;
          pbVar51 = (byte *)*puVar31;
        ...
        pbVar51 = pbVar49 + 1;
        lVar35 = lVar35 + -1;
        if (CONCAT11(bVar22,*pbVar49) != 0) goto LAB_00d8d408;
        if (lVar35 == 0) {
          uVar28 = (*(code *)puVar31[3])(param_1);
          if ((int)uVar28 == 0) goto LAB_00d8dfac;
          pbVar51 = (byte *)*puVar31;
        ...
        pbVar51 = pbVar49 + 1;
        lVar35 = lVar35 + -1;
        if (*pbVar49 != 0) goto LAB_00d8d408;
        if (lVar35 == 0) {
          uVar28 = (*(code *)puVar31[3])(param_1);
          if ((int)uVar28 == 0) goto LAB_00d8dfac;
          pbVar51 = (byte *)*puVar31;
        ...
        pbVar51 = pbVar49 + 1;
        lVar35 = lVar35 + -1;
        if (CONCAT11(bVar22,*pbVar49) != 1) goto LAB_00d8d408;
        if (lVar35 == 0) {
          uVar28 = (*(code *)puVar31[3])(param_1);
          if ((int)uVar28 == 0) goto LAB_00d8dfac;
          pbVar51 = (byte *)*puVar31;
...
LAB_00d8c8cc:
      ...
      iVar27 = (int)uVar28;
      goto joined_r0x00d8c8d4;
    }
    *(undefined4 *)((long)param_1 + 0x23c) = 0;
  } while( true );
code_r0x00d8dd4c:
  lVar35 = lVar35 + 1;
  if ((long)uVar52 <= lVar35) goto LAB_00d8ddf4;
  goto LAB_00d8dd3c;
LAB_00d8dd0c:
  do {
    if (bVar26) {
    ...
    if (0 < (long)uVar52) {
      ...
      uVar41 = uVar52 - 1;
LAB_00d8dd3c:
      if (*(uint *)param_1[lVar35 + 0x39] != (uint)*pbVar49) goto code_r0x00d8dd4c;
      iVar27 = *(int *)param_1[0x39];
      if ((long)uVar52 < 2) goto LAB_00d8ddf0;
      iVar38 = iVar27;
      if (uVar41 < 2) {
        uVar40 = 1;
        goto LAB_00d8ddd0;
...
LAB_00d8ddf4:
    ...
    if (0 < (int)param_1[7]) {
      iVar27 = 0;
      do {
        if (uVar44 == *puVar33) goto LAB_00d8de40;
        iVar27 = iVar27 + 1;
