...
/* unsigned long
   v8::internal::SlotSet::Iterate<v8::internal::PageMarkingItem::MarkUntypedPointers(v8::internal::YoungGenerationMarkingTask*)::{lambda(v8::internal::CompressedMaybeObjectSlot)#2},
   v8::internal::SlotSet::Iterate<v8::internal::PageMarkingItem::MarkUntypedPointers(v8::internal::YoungGenerationMarkingTask*)::{lambda(v8::internal::CompressedMaybeObjectSlot)#2}>(unsigned
   long, unsigned long,
   v8::internal::PageMarkingItem::MarkUntypedPointers(v8::internal::YoungGenerationMarkingTask*)::{lambda(v8::internal::CompressedMaybeObjectSlot)#2},
