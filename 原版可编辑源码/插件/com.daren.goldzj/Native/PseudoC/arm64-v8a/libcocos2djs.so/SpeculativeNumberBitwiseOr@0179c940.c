...
/* v8::internal::compiler::OperationTyper::SpeculativeNumberBitwiseOr(v8::internal::compiler::Type,
   v8::internal::compiler::Type) */

void __thiscall
v8::internal::compiler::OperationTyper::SpeculativeNumberBitwiseOr
...

{
  ...
  NumberBitwiseOr(this,uVar1,uVar2);
  return;
}
