...

{
  ...
  FUN_0109f360();
  pcStack_18 = FUN_0109e4d8;
  puStack_20 = &stack0xfffffffffffffff0;
  FUN_0109f374();
  pcStack_68 = FUN_0109e4e4;
  ...
  if (*(CanonicalHandleScope **)((ulong)pIVar7 | 0x95b8) == (CanonicalHandleScope *)0x0) {
    ...
    puStack_70 = (undefined1 *)&puStack_20;
...
joined_r0x0109e6b8:
  if (in_w3 != 0) {
    ...
    uStack_f8 = *extraout_x1_00;
    pIVar7 = (Isolate *)(uStack_f8 & 0xffffffff00000000);
    uVar6 = v8::internal::JSObject::GetFastElementsUsage((JSObject *)&uStack_f8);
    puVar10 = (undefined8 *)
              v8::internal::
    ...
    if (0 < (int)uVar6) {
      ...
      if (0 < iVar17) {
        ...
        v8::internal::NumberDictionary::UpdateMaxNumberKey
                  ((NumberDictionary *)&uStack_f8,iVar17,extraout_x1_00);
      }
    }
    return puVar10;
  }
