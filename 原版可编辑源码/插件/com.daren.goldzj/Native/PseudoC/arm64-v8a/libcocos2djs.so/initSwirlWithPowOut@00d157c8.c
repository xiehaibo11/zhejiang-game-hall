...
/* spine::VertexEffectDelegate::initSwirlWithPowOut(float, int) */

undefined8 __thiscall
spine::VertexEffectDelegate::initSwirlWithPowOut
          (VertexEffectDelegate *this,float param_1,int param_2)
