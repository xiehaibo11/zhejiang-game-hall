...
/* void JSBClassType::registerClass<dragonBones::AnimationData>(se::Class*) */

void JSBClassType::registerClass<dragonBones::AnimationData>(Class *param_1)
