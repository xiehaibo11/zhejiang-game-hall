...
/* void std::__ndk1::vector<dragonBones::BoneData*, std::__ndk1::allocator<dragonBones::BoneData*>
   >::__push_back_slow_path<dragonBones::BoneData* const&>(dragonBones::BoneData* const&) */
...
__push_back_slow_path<dragonBones::BoneData*const&>
          (vector<dragonBones::BoneData*,std::__ndk1::allocator<dragonBones::BoneData*>> *this,
          BoneData **param_1)
...
LAB_00d362bc:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d362bc;
  }
  else {
