...
/* v8::internal::SlotCallbackResult
   v8::internal::UpdateTypedSlotHelper::UpdateTypedSlot<v8::internal::RememberedSetUpdatingItem<v8::internal::MajorNonAtomicMarkingState,
   (v8::internal::GarbageCollector)1>::UpdateTypedPointers()::{lambda(v8::internal::FullMaybeObjectSlot)#1}>(v8::internal::Heap*,
   v8::internal::SlotType, unsigned long,
   v8::internal::RememberedSetUpdatingItem<v8::internal::MajorNonAtomicMarkingState,
   (v8::internal::GarbageCollector)1>::UpdateTypedPointers()::{lambda(v8::internal::FullMaybeObjectSlot)#1})
    */
...

{
  ...
  case 2:
    ...
    if ((uVar7 >> 3 & 1) == 0) {
      ...
      if ((*(byte *)(uVar6 + 9) >> 2 & 1) != 0) {
        ...
        return (ulong)((*(uint *)(*(long *)(uVar6 + 0x10) + (uVar4 >> 7 & 0x1ffffff) * 4) >>
  ...
  case 3:
    ...
    uStack_20 = 0;
    local_18 = 0;
    uVar4 = UpdateCodeTarget<v8::internal::RememberedSetUpdatingItem<v8::internal::MajorNonAtomicMarkingState,(v8::internal::GarbageCollector)1>::UpdateTypedPointers()::_lambda(v8::internal::FullMaybeObjectSlot)_1_>
                      (&local_38,param_4);
    return uVar4;
  case 4:
    uVar4 = *param_3 - 0x3f;
...
joined_r0x00fec870:
  ...
  uStack_20 = 0;
  local_18 = 0;
  uVar4 = UpdateEmbeddedPointer<v8::internal::RememberedSetUpdatingItem<v8::internal::MajorNonAtomicMarkingState,(v8::internal::GarbageCollector)1>::UpdateTypedPointers()::_lambda(v8::internal::FullMaybeObjectSlot)_1_>
