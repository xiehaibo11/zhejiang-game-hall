...
uint FUN_00b76c60(X509 *param_1,char *param_2,size_t param_3,uint param_4,int param_5,
                 undefined8 *param_6)

{
  ...
  if (param_5 == 1) {
    ...
    local_78 = FUN_00b77848;
    if ((uVar4 & 2) != 0) {
      local_78 = FUN_00b77750;
    }
    iVar3 = 0x16;
    iVar5 = 0x16;
    nid = 0xd;
  ...
  if (a == (GENERAL_NAMES *)0x0) goto LAB_00b76e00;
      ...
      do {
        ...
        if (*piVar7 == param_5) {
          ...
          if ((__s1 == (void *)0x0) || (*piVar7 == 0)) {
            ...
            uVar4 = 0;
            bVar2 = true;
            if ((piVar7[1] != iVar5) || (*piVar7 != (int)param_3)) goto LAB_00b76f78;
