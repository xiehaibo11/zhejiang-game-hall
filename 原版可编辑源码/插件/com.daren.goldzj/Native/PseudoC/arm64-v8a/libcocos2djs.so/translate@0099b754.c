...
/* cocos2d::Mat4::translate(float, float, float) */

void __thiscall cocos2d::Mat4::translate(Mat4 *this,float param_1,float param_2,float param_3)

{
  ...
  lVar1 = tpidr_el0;
                    /* try { // try from 0099b768 to 00a9b84b has its CatchHandler @ 0099b5e8 */
