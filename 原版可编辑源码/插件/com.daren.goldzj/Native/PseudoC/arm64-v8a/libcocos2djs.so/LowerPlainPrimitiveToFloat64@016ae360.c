...
/* v8::internal::compiler::EffectControlLinearizer::LowerPlainPrimitiveToFloat64(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerPlainPrimitiveToFloat64
...

{
  ...
  *(undefined8 *)pEVar5 = 0;
  ...
  pNVar4 = (Node *)GraphAssembler::ChangeInt32ToFloat64(this_00,pNVar4);
