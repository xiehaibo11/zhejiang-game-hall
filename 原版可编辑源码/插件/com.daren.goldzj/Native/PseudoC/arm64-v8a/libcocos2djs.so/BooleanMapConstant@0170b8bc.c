...
/* v8::internal::compiler::JSGraph::BooleanMapConstant() */

void __thiscall v8::internal::compiler::JSGraph::BooleanMapConstant(JSGraph *this)

{
  ...
  if (*(long *)(this + 0x1b0) == 0) {
    local_38 = *(long *)(this + 0x168) + 0x370;
