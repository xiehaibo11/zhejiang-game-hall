...
/* v8::internal::compiler::GraphAssembler::IsOne(v8::internal::TNode<v8::internal::Object>) */

void __thiscall
v8::internal::compiler::GraphAssembler::IsOne(GraphAssembler *this,undefined8 param_2)

{
  Node *pNVar1;
  long lVar2;
  
  pNVar1 = (Node *)JSGraph::OneConstant(*(JSGraph **)(this + 0x18));
