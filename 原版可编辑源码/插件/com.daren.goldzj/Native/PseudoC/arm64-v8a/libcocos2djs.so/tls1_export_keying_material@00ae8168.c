...

{
  ...
  if (__dest == (void *)0x0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ae8390 with catch @ 00ae8330
                       catch(type#1 @ 00000000) { ... } // from try @ 00ae8558 with catch @ 00ae8330
                        */
    iVar3 = 0x41;
    line = 0x269;
  }
    ...
    *puVar2 = uVar6;
    ...
    if ((((iVar3 != 0) && (iVar3 = memcmp(__dest,"server finished",0xf), iVar3 != 0)) &&
      ...
      uVar4 = FUN_00ae7e74(param_1,__dest,uVar1 & 0xffffffff,0,0,0,0,0,0,
