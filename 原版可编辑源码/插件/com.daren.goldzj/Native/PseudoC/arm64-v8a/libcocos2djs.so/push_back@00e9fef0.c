...
/* std::__ndk1::__split_buffer<std::__ndk1::unique_ptr<v8::Task,
   std::__ndk1::default_delete<v8::Task> >*,
   std::__ndk1::allocator<std::__ndk1::unique_ptr<v8::Task, std::__ndk1::default_delete<v8::Task>
   >*> >::push_back(std::__ndk1::unique_ptr<v8::Task, std::__ndk1::default_delete<v8::Task> >*&&) */
...

{
  ...
  puVar12 = puVar4;
  if (puVar4 != *(undefined8 **)(this + 0x18)) goto LAB_00ea0078;
...
LAB_00ea0044:
      ...
      if (((void *)((long)pvVar6 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar6 + uVar13 * 8 + uVar9 + 8))) goto LAB_00ea0044;
      ...
      puVar11 = puVar12;
      if (uVar2 != uVar9) goto LAB_00ea0044;
    }
    puVar11 = *(undefined8 **)this;
  }
  *(void **)this = pvVar6;
