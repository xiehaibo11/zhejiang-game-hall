...
/* bool v8::internal::wasm::ThreadImpl::ExecuteStore<v8::internal::Float32, unsigned
   int>(v8::internal::wasm::Decoder*, v8::internal::wasm::InterpreterCode*, unsigned long, int*,
   v8::internal::MachineRepresentation, int) */

bool __thiscall
v8::internal::wasm::ThreadImpl::ExecuteStore<v8::internal::Float32,unsigned_int>
...

{
  ...
  *(long *)(this + 0x28) = lVar6 + -0x11;
  ...
  if (!CARRY4(local_97,uVar9)) {
    ...
    if (((3 < *(ulong *)(lVar6 + 0x13)) && ((ulong)uVar2 <= *(ulong *)(lVar6 + 0x13) - 4)) &&
       (puVar3 = (uint *)((*(ulong *)(lVar6 + 0x1b) & (ulong)uVar2) + *(long *)(lVar6 + 0xb)),
       puVar3 != (uint *)0x0)) {
      *puVar3 = local_97;
