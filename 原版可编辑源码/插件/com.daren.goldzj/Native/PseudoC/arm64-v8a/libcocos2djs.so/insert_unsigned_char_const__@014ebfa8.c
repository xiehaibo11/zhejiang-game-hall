...
/* std::__ndk1::enable_if<__is_forward_iterator<unsigned char
   ...
   std::__ndk1::vector<unsigned char, v8::internal::ZoneAllocator<unsigned char> >::insert<unsigned
   char const*>(std::__ndk1::__wrap_iter<unsigned char const*>, unsigned char const*, unsigned char
   const*) */
...

{
  ...
  if (param_3 != param_4) {
    ...
    if ((0x1f < uVar7) &&
      ...
      if (uVar7 == uVar12) goto LAB_014ec1a4;
    }
    do {
      puVar14 = param_3 + 1;
      puVar5 = puVar8 + 1;
...
LAB_014ec1a4:
  ...
  if (uVar7 != 0) {
    if ((0x1f < uVar7) && ((puVar10 <= puVar5 || (puVar5 + uVar7 <= param_2)))) {
      ...
      puVar5 = puVar14;
      if (uVar12 == uVar7) goto LAB_014ec24c;
    }
    do {
      puVar13 = param_2 + 1;
      puVar14 = puVar5 + 1;
