...
/* v8::internal::compiler::EffectControlLinearizer::LowerObjectIsBigInt(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerObjectIsBigInt
...

{
  ...
  pNVar2 = (Node *)GraphAssembler::BigIntMapConstant(this_00);
