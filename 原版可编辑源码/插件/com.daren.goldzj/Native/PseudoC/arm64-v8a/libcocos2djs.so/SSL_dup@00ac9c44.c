...

{
  ...
  if ((iVar4 == 0) || (iVar4 = SSL_in_before(ssl), iVar4 == 0)) {
    ...
    return ssl;
                    ...
                    /* try { // try from 00ac9c74 to 00bc9c77 has its CatchHandler @ 00ac9de8 */
  s = SSL_new((SSL_CTX *)ssl->mode);
                    /* try { // try from 00ac9c78 to 00bc9d47 has its CatchHandler @ 00ac9c00 */
  if (s == (SSL *)0x0) {
    return (SSL *)0x0;
  }
...
LAB_00ac9d24:
    ...
    if (0x20 < uVar2) {
      ...
      goto LAB_00aca03c;
                    ...
                    /* try { // try from 00ac9d84 to 00bc9d87 has its CatchHandler @ 00ac9dc8 */
  ...
  if (0 < iVar4) {
    ...
    *(undefined8 *)((long)&s->enc_write_ctx + 4) = 0xffffffffffffffff;
    ...
    s->cipher_list_by_id = (stack_st_SSL_CIPHER *)(uVar16 + 0x308);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ac9c74 with catch @ 00ac9de8
                        */
    s->compress = pCVar14;
    lVar8 = OPENSSL_sk_new_null();
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ac9c40 with catch @ 00ac9df0
                        */
    *(long *)&s->mac_flags = lVar8;
    ...
    if (0 < iVar4) {
      ...
      do {
        ...
        if (iVar5 < 1) goto LAB_00aca03c;
                    /* try { // try from 00ac9e3c to 00bc9eb3 has its CatchHandler @ 00ac9e3c
                       catch() { ... } // from try @ 00ac9e3c with catch @ 00ac9e3c
                       catch() { ... } // from try @ 00ac9ec4 with catch @ 00ac9e3c
                       catch() { ... } // from try @ 00ac9f58 with catch @ 00ac9e3c
                       catch() { ... } // from try @ 00ac9ff8 with catch @ 00ac9e3c */
        iVar6 = iVar6 + 1;
      } while (iVar6 < iVar4);
    }
  }
  ...
  *(int *)&s->verify_result = (int)ssl->verify_result;
  ...
  uVar3 = *(undefined4 *)&ssl->field_0x184;
                    /* try { // try from 00ac9eb4 to 00bc9ec3 has its CatchHandler @ 00aca07c */
  s->debug = ssl->debug;
  ...
  *(undefined4 *)&(s->ex_data).field_0xc = uVar3;
  iVar4 = CRYPTO_dup_ex_data(0,(CRYPTO_EX_DATA *)&s->max_send_fragment,
                    ...
                    /* try { // try from 00ac9ec4 to 00bc9f47 has its CatchHandler @ 00ac9e3c */
  if ((iVar4 != 0) &&
    ...
    if (bp != (BIO *)0x0) {
      if (bp == ssl->rbio) {
        ...
        if (lVar8 == 0) goto LAB_00aca03c;
      }
    }
    s->server = ssl->server;
                    /* try { // try from 00ac9f48 to 00bc9f57 has its CatchHandler @ 00aca060 */
    if (ssl->handshake_func != (_func_3149 *)0x0) {
      if (ssl->server == 0) {
        SSL_set_connect_state(s);
      }
      else {
                    /* try { // try from 00ac9f58 to 00bc9fe7 has its CatchHandler @ 00ac9e3c */
    ...
    *(undefined8 *)(s[6].sid_ctx + 4) = uVar21;
    ...
    if (ssl->cert != (cert_st *)0x0) {
      ...
      s->cert = pcVar10;
      if (pcVar10 == (cert_st *)0x0) goto LAB_00aca03c;
    }
    ...
    if (p_Var11 != (_func_3155 *)0x0) {
      ...
      iVar4 = 1;
      while( true ) {
                    /* try { // try from 00ac9fe8 to 00bc9ff7 has its CatchHandler @ 00aca05c */
        xn = (X509_NAME *)OPENSSL_sk_value(p_Var11,iVar4 + -1);
                    /* try { // try from 00ac9ff8 to 00bca0b7 has its CatchHandler @ 00ac9e3c */
...
LAB_00aca03c:
  SSL_free(s);
                    /* catch() { ... } // from try @ 00ac9fe8 with catch @ 00aca05c */
  return (SSL *)0x0;
}
