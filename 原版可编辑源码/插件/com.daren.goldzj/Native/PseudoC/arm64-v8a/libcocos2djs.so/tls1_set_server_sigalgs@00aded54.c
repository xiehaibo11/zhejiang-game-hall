...

{
  ...
  undefined4 uVar4;
                    ...
                    /* try { // try from 00aded58 to 00bded5f has its CatchHandler @ 00adefc4 */
                    /* try { // try from 00aded60 to 00bdeddf has its CatchHandler @ 00adec9c */
  ...
  *(undefined8 *)(lVar3 + 0x308) = 0;
  lVar3 = *(long *)(param_1 + 0x90);
                    /* try { // try from 00adede0 to 00bdede7 has its CatchHandler @ 00adefb4 */
  *(undefined4 *)(lVar3 + 0x328) = 0;
  if (*(long *)(lVar3 + 0x2c0) == 0) {
    ...
    *(undefined8 *)(lVar3 + 0x300) = uVar2;
                    /* try { // try from 00adee68 to 00bdee6f has its CatchHandler @ 00adefa4 */
    uVar2 = ssl_md(8);
    *(undefined8 *)(lVar3 + 0x308) = uVar2;
                    /* try { // try from 00adee70 to 00bdee93 has its CatchHandler @ 00adec9c */
  }
  else {
                    /* try { // try from 00adede8 to 00bdee67 has its CatchHandler @ 00adec9c */
    iVar1 = tls1_process_sigalgs(param_1);
    if (iVar1 == 0) {
      ERR_put_error(0x14,0x14f,0x41,"ssl/t1_lib.c",0xaee);
      uVar2 = 0x50;
                    /* try { // try from 00adee94 to 00bdeeab has its CatchHandler @ 00adf01c */
    }
    else {
    ...
    uVar4 = 0;
                    ...
                    /* try { // try from 00adeec8 to 00bdeecf has its CatchHandler @ 00adefd4 */
                    /* try { // try from 00adeed0 to 00bdef8b has its CatchHandler @ 00adec9c */
  return uVar4;
}
