...
/* v8::internal::compiler::InstructionSelector::VisitFloat64Ieee754Binop(v8::internal::compiler::Node*,
   unsigned int) */

void __thiscall
v8::internal::compiler::InstructionSelector::VisitFloat64Ieee754Binop
...

{
  ...
  lVar4 = Emit(this,param_2,(uVar1 & 0xffffffff) << 3 | 0xc800000001,
