...
/* v8::internal::compiler::OperationTyper::SpeculativeNumberAdd(v8::internal::compiler::Type,
   v8::internal::compiler::Type) */

void __thiscall
v8::internal::compiler::OperationTyper::SpeculativeNumberAdd
