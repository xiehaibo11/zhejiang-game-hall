...
/* cocos2d::Mat4::scale(float, cocos2d::Mat4*) const */

void __thiscall cocos2d::Mat4::scale(Mat4 *this,float param_1,Mat4 *param_2)

{
  ...
  if (*(long *)(lVar1 + 0x28) == local_28) {
                    /* try { // try from 0099b508 to 00a9b54b has its CatchHandler @ 0099b560 */
    return;
  }
