...
int FUN_00b49dd8(int param_1,uchar *param_2,uchar *param_3,long param_4,int param_5)
...
LAB_00b49f68:
    ...
    if (pBVar4 == (BIGNUM *)0x0) goto LAB_00b49f68;
    ...
    if ((((*(byte *)(param_4 + 0x6c) >> 1 & 1) != 0) &&
       ...
       (iVar3 = (**(code **)(*(long *)(param_4 + 0x10) + 0x30))
                          (a,ret,*(undefined8 *)(param_4 + 0x28),*(undefined8 *)(param_4 + 0x20),ctx
                           ,*(undefined8 *)(param_4 + 0x70)), iVar3 == 0)) goto LAB_00b49f68;
    if (param_5 == 5) {
