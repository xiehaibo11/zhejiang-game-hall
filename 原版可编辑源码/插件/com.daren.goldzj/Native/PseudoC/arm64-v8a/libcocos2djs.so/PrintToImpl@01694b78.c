...
/* v8::internal::compiler::Operator1<unsigned int, v8::internal::compiler::OpEqualTo<unsigned int>,
   v8::internal::compiler::OpHash<unsigned int> >::PrintToImpl(std::__ndk1::basic_ostream<char,
...
::PrintToImpl(Operator1<unsigned_int,v8::internal::compiler::OpEqualTo<unsigned_int>,v8::internal::compiler::OpHash<unsigned_int>>
...

{
  ...
  std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>(param_1,__s,sVar1);
                    /* WARNING: Could not recover jumptable at 0x01694bd0. Too many branches */
