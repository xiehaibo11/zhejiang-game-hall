...
/* js_cocos2dx_dragonbones_Transform_normalizeRadianRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_Transform_normalizeRadianRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (uVar7 == 0x10) {
    ...
    if ((uVar7 & 1) == 0) {
      ...
      fVar9 = fmodf(local_64 + 3.1415927,6.2831855);
      fVar10 = -3.1415927;
      if (fVar9 <= 0.0) {
        fVar10 = 3.1415927;
      }
      pVVar5 = (Value *)se::State::rval(aSStack_60);
      uVar7 = float_to_seval(fVar9 + fVar10,pVVar5);
      if ((uVar7 & 1) != 0) goto LAB_00c95ea0;
      uVar6 = 0x125;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,uVar6,"js_cocos2dx_dragonbones_Transform_normalizeRadian");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_Transform_normalizeRadian : Error processing arguments"
                       );
  }
  else {
    __android_log_print(6,"jswrapper",&DAT_0192d01d,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_Transform_normalizeRadian",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,299);
LAB_00c95ea0:
  pVVar5 = (Value *)se::State::rval(aSStack_60);
