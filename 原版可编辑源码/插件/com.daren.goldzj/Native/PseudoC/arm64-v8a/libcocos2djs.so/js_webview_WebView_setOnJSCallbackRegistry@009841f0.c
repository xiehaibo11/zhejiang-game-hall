...
/* js_webview_WebView_setOnJSCallbackRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_webview_WebView_setOnJSCallbackRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (WebView *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x130,"js_webview_WebView_setOnJSCallback");
    __android_log_print(6,"jswrapper","js_webview_WebView_setOnJSCallback : Invalid Native Object");
  }
  else {
      ...
      if (pVVar5[8] == (Value)0x5) {
        ...
        if ((uVar7 & 1) == 0) {
          ...
          if (alStack_c0 == plVar9) {
            ...
            if (plVar9 == (long *)0x0) goto LAB_00984550;
...
LAB_00984550:
      cocos2d::WebView::setOnJSCallback(this,(function *)alStack_c0);
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_webview_auto.cpp, 345): wrong number of arguments: %d, was expecting %d\n"
