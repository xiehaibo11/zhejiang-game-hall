...
/* v8::internal::compiler::BytecodeGraphBuilder::TryBuildSimplifiedForInNext(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*, v8::internal::compiler::Node*, v8::internal::compiler::Node*,
   v8::internal::FeedbackSlot) */

void v8::internal::compiler::BytecodeGraphBuilder::TryBuildSimplifiedForInNext
               (int *param_1_00,BytecodeGraphBuilder *param_1)

{
  Node *pNVar1;
  
  JSTypeHintLowering::ReduceForInNextOperation(param_1_00,param_1 + 0x50);
