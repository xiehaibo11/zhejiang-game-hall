...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitTestEqual(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::VisitTestEqual
