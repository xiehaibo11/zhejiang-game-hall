...
/* v8::internal::compiler::CommonOperatorBuilder::IfDefault(v8::internal::compiler::BranchHint) */
...

{
  ...
  Operator::Operator(pOVar1,9,0x78,"IfDefault",0,0,1,0,0,1);
  pOVar1[0x2c] = param_2;
  *(undefined ***)pOVar1 = &PTR__Operator_01ccc8a8;
  return pOVar1;
}
