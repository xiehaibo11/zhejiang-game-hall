...
/* v8::ValueDeserializer::ReadValue(v8::Local<v8::Context>) */

ulong * __thiscall v8::ValueDeserializer::ReadValue(ValueDeserializer *this,long param_2)
  ...
  if (*(char *)(*(long *)this + 0x48) == '\0') {
    ...
    *local_48 = uVar9;
    ...
    if (internal::TracingFlags::runtime_stats != 0) {
      ...
      internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x3ee);
    }
    this_00 = *(Logger **)(pIVar7 + 0x9558);
    uVar9 = internal::Logger::is_logging(this_00);
    if ((uVar9 & 1) != 0) {
      internal::Logger::ApiEntryCall(this_00,"v8::ValueDeserializer::ReadValue");
    }
    ...
    *(undefined4 *)(pIVar7 + 0x2c60) = 5;
    ...
    if (*(char *)(lVar4 + 0x48) == '\0') {
      if (*(int *)(lVar4 + 0x28) == 0) {
        puVar3 = (ulong *)internal::ValueDeserializer::ReadObjectUsingEntireBufferForLegacyFormat
                                    ((ValueDeserializer *)(lVar4 + 8));
        puVar8 = local_48;
      }
      else {
        puVar3 = (ulong *)internal::ValueDeserializer::ReadObject((ValueDeserializer *)(lVar4 + 8));
        puVar8 = local_48;
      }
      local_48 = puVar8;
      if (puVar3 == (ulong *)0x0) {
        ...
        *(long *)(local_b0 + 0x2c08) = local_68;
        ...
        if (((*puVar8 & 1) == 0) || ((int)*puVar8 != *(int *)(local_60 + 0xa8))) {
...
LAB_00eb00cc:
          ...
          if (*(code **)(lVar4 + 0xb738) == (code *)0x0) goto LAB_00eb00cc;
