...
LAB_00ab8f00:
  ...
  if (iVar3 < 1) {
                    /* try { // try from 00ab9098 to 00bb90ab has its CatchHandler @ 00ab90ec */
                    /* try { // try from 00ab90ac to 00bb9107 has its CatchHandler @ 00ab9064 */
    return 0xffffffff;
  }
  ...
  *(undefined4 *)(puVar7 + 5) = *(undefined4 *)((long)param_1 + 0x111a);
  ...
  if (param_5 == 0) {
    ...
    param_1[0x43f] = param_4;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ab90ac with catch @ 00ab9064
                        */
