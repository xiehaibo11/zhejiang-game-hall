...
/* v8::internal::compiler::JSGraph::AllocateRegularInOldGenerationStubConstant() */

void __thiscall
v8::internal::compiler::JSGraph::AllocateRegularInOldGenerationStubConstant(JSGraph *this)

{
  ...
  if (*(long *)(this + 0x198) == 0) {
    local_38 = Builtins::builtin_handle((Builtins *)(*(long *)(this + 0x168) + 0x9e00),0x52);
