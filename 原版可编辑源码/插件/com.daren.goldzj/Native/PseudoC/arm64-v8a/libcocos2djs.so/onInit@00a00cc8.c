...

{
  ...
  auVar7 = CustomFileManager::getInstance();
  pbVar2 = auVar7._0_8_;
  CustomFileManager::dirname((CustomFileManager *)(this + 0x38),auVar7._8_8_);
  uVar3 = CustomFileManager::isDirectoryExist(pbVar2);
                    /* try { // try from 00a00d18 to 00b00e97 has its CatchHandler @ 00a00aa8 */
  if (((uVar3 & 1) == 0) &&
