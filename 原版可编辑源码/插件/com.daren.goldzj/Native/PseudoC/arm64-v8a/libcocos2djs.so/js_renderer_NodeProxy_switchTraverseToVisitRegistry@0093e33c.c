...
/* js_renderer_NodeProxy_switchTraverseToVisitRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_renderer_NodeProxy_switchTraverseToVisitRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x4ef,"js_renderer_NodeProxy_switchTraverseToVisit");
    __android_log_print(6,"jswrapper",
                        "js_renderer_NodeProxy_switchTraverseToVisit : Invalid Native Object");
  }
  else {
    plVar5 = (long *)se::State::args(aSStack_98);
    if (plVar5[1] - *plVar5 == 0) {
      local_70 = &PTR_FUN_01c694f0;
      pcStack_68 = cocos2d::renderer::NodeProxy::visit;
      local_50 = &local_70;
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 1270): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar5[1] - *plVar5) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_NodeProxy_switchTraverseToVisit",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0x4f9);
LAB_0093e480:
