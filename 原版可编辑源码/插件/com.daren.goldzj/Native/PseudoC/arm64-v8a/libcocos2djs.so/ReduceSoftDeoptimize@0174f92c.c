...
/* v8::internal::compiler::JSNativeContextSpecialization::ReduceSoftDeoptimize(v8::internal::compiler::Node*,
   v8::internal::DeoptimizeReason) */

Node * __thiscall
v8::internal::compiler::JSNativeContextSpecialization::ReduceSoftDeoptimize
          (JSNativeContextSpecialization *this,Node *param_1,undefined4 param_3)
