...
undefined8 FUN_00db5d50(undefined8 *param_1,ulong *param_2,long *param_3)
...
LAB_00db6080:
    ...
    else if ((((long)uVar3 < 0x7ffffffffffffff8) && (lVar4 = uVar3 + 8, 7 < lVar4)) &&
            (lVar4 <= (long)param_1[0x74])) {
...
LAB_00db5f78:
    ...
    if ((uVar3 == *param_2) &&
      ...
      if (0xffff < CONCAT44(uStack_44,local_48)) goto LAB_00db5fd4;
