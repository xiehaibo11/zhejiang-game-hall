...
/* v8::internal::compiler::GraphAssembler::IntAdd(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::IntAdd(GraphAssembler *this,Node *param_1,Node *param_2)
