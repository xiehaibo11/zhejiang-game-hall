...
/* v8::internal::interpreter::BytecodeArrayBuilder::StoreModuleVariable(int, int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::StoreModuleVariable
