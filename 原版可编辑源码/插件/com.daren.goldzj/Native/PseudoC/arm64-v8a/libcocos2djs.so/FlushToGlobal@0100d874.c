...
/* v8::internal::Worklist<v8::internal::EphemeronHashTable, 128>::FlushToGlobal(int) */

void __thiscall
v8::internal::Worklist<v8::internal::EphemeronHashTable,128>::FlushToGlobal
          (Worklist<v8::internal::EphemeronHashTable,128> *this,int param_1)
