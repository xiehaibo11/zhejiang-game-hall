...
/* std::__ndk1::__hash_table<std::__ndk1::unique_ptr<v8::internal::CodeEntry,
   ...
   std::__ndk1::default_delete<v8::internal::CodeEntry> > > >::rehash(unsigned long) */
...
::rehash(__hash_table<std::__ndk1::unique_ptr<v8::internal::CodeEntry,std::__ndk1::default_delete<v8::internal::CodeEntry>>,v8::internal::CodeEntry::Hasher,v8::internal::CodeEntry::Equals,std::__ndk1::allocator<std::__ndk1::unique_ptr<v8::internal::CodeEntry,std::__ndk1::default_delete<v8::internal::CodeEntry>>>>
         *this,ulong param_1)

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      if (uVar1 < uVar2) goto LAB_011b4f30;
    }
    return;
  }
LAB_011b4f30:
