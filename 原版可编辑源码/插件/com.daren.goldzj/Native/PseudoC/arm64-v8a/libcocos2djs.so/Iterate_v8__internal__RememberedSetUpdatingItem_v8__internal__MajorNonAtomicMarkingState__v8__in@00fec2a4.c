...
/* unsigned long
   v8::internal::SlotSet::Iterate<v8::internal::RememberedSetUpdatingItem<v8::internal::MajorNonAtomicMarkingState,
   (v8::internal::GarbageCollector)1>::UpdateUntypedPointers()::{lambda(v8::internal::CompressedMaybeObjectSlot)#2},
   v8::internal::SlotSet::Iterate<v8::internal::RememberedSetUpdatingItem<v8::internal::MajorNonAtomicMarkingState,
   (v8::internal::GarbageCollector)1>::UpdateUntypedPointers()::{lambda(v8::internal::CompressedMaybeObjectSlot)#2}>(unsigned
   long, unsigned long,
...
LAB_00fec364:
                ...
                uVar17 = *puVar2;
                uVar14 = (ulong)uVar17;
                if ((uVar17 == 3) || ((uVar17 & 1) == 0)) goto LAB_00fec364;
                ...
                if ((uVar17 >> 3 & 1) == 0) {
                  if (((uVar17 >> 4 & 1) == 0) ||
                     (((*(byte *)(uVar16 + 9) >> 2 & 1) != 0 &&
                      ((*(uint *)(*(long *)(uVar16 + 0x10) + (uVar12 - uVar16 >> 7 & 0x1ffffff) * 4)
