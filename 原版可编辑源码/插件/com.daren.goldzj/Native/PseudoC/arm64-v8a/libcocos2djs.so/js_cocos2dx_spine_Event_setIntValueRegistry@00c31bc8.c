...
/* js_cocos2dx_spine_Event_setIntValueRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Event_setIntValueRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Event *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x11f8,"js_cocos2dx_spine_Event_setIntValue");
    pcVar6 = "js_cocos2dx_spine_Event_setIntValue : Invalid Native Object";
LAB_00c31d3c:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Event::setIntValue(this,local_64);
        goto LAB_00c31d74;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x11ff,"js_cocos2dx_spine_Event_setIntValue");
      pcVar6 = "js_cocos2dx_spine_Event_setIntValue : Error processing arguments";
      goto LAB_00c31d3c;
    }
    __android_log_print(6,"jswrapper",&DAT_018ffcb3,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Event_setIntValue",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1206);
LAB_00c31d74:
