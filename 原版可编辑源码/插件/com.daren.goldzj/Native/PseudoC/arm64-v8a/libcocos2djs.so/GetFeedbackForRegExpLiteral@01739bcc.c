...
/* v8::internal::compiler::JSHeapBroker::GetFeedbackForRegExpLiteral(v8::internal::compiler::FeedbackSource
   const&) */

undefined8 __thiscall
v8::internal::compiler::JSHeapBroker::GetFeedbackForRegExpLiteral
...

{
  ...
  if (FLAG_concurrent_inlining == '\0') {
    uVar2 = ProcessFeedbackForRegExpLiteral(this,param_1);
    return uVar2;
  }
  lVar1 = std::__ndk1::
