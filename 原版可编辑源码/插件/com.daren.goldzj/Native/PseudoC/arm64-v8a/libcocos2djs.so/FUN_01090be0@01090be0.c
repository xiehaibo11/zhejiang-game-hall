...
void FUN_01090be0(undefined8 param_1,ulong *param_2,long *param_3)
...
switchD_01090ca4_caseD_1:
    bVar10 = bVar4;
    goto switchD_01090ca4_caseD_0;
  }
  bVar10 = 1;
  bVar13 = 7;
  switch(bVar4) {
  ...
  case 4:
    ...
    break;
  case 6:
    goto switchD_01090ca4_caseD_6;
  }
switchD_01090ca4_caseD_0:
  bVar13 = bVar10;
  if (bVar3 != bVar10) {
switchD_01090ca4_caseD_6:
    ...
    if ((uVar1 == *(uint *)(pIVar11 + 0x168)) ||
      ...
      FUN_01092348(this,*puVar6,0,*puVar7,bVar3,0,iVar8,0xffffffff);
