...
/* js_gfx_IndexBuffer_prop_setFormatRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_gfx_IndexBuffer_prop_setFormatRegistry(undefined8 param_1,undefined8 param_2,long *param_3)

{
  ...
  if (lVar5 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x246,"js_gfx_IndexBuffer_prop_setFormat");
    __android_log_print(6,"jswrapper","js_gfx_IndexBuffer_prop_setFormat : Invalid Native Object");
  }
  else {
    puVar6 = (undefined8 *)se::State::args(aSStack_70);
    uVar7 = puVar6[1] - (long)*puVar6;
    if (uVar7 == 0x10) {
      uVar7 = seval_to_uint16((Value *)*puVar6,local_74);
      if ((uVar7 & 1) != 0) {
        *(ushort *)(lVar5 + 0x18) = local_74[0];
        goto LAB_00962ea0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp"
                          ,0x24d,"js_gfx_IndexBuffer_prop_setFormat");
      __android_log_print(6,"jswrapper","Convert arg0 offset failed!");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp, 594): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar7 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_gfx_IndexBuffer_prop_setFormat",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp"
                      ,0x255);
LAB_00962ea0:
