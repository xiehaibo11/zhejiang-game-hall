...
void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerObjectIsMinusZero
...

{
  ...
  if (*(char *)(*(long *)(*(long *)this + 0x10) + 0x10) == '\x05') {
    pNVar5 = (Node *)GraphAssembler::BitcastFloat64ToInt64(this_00,pNVar5);
    pNVar2 = (Node *)GraphAssembler::Int64Constant(this_00,-0x8000000000000000);
    pNVar5 = (Node *)GraphAssembler::Word64Equal(this_00,pNVar5,pNVar2);
  }
  else {
    pNVar3 = (Node *)GraphAssembler::Float64ExtractLowWord32(this_00,pNVar5);
    pNVar4 = (Node *)GraphAssembler::Int32Constant(this_00,0);
    pNVar3 = (Node *)GraphAssembler::Word32Equal(this_00,pNVar3,pNVar4);
    GraphAssembler::GotoIfNot<v8::internal::compiler::Node*>(this_00,pNVar3,local_88,pNVar2);
    pNVar5 = (Node *)GraphAssembler::Float64ExtractHighWord32(this_00,pNVar5);
    pNVar2 = (Node *)GraphAssembler::Int32Constant(this_00,-0x80000000);
