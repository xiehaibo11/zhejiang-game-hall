...
/* js_cocos2dx_spine_MeshAttachment_setRegionOffsetYRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_MeshAttachment_setRegionOffsetYRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (MeshAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1712,"js_cocos2dx_spine_MeshAttachment_setRegionOffsetY");
    pcVar6 = "js_cocos2dx_spine_MeshAttachment_setRegionOffsetY : Invalid Native Object";
LAB_00c3b10c:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::MeshAttachment::setRegionOffsetY(this,local_64);
        goto LAB_00c3b144;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1719,"js_cocos2dx_spine_MeshAttachment_setRegionOffsetY");
      pcVar6 = "js_cocos2dx_spine_MeshAttachment_setRegionOffsetY : Error processing arguments";
      goto LAB_00c3b10c;
    }
    __android_log_print(6,"jswrapper",&DAT_019045e9,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_MeshAttachment_setRegionOffsetY",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1720);
LAB_00c3b144:
