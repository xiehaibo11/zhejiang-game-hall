...
undefined4 FUN_0107a538(ulong param_1,ulong param_2,ulong param_3,long param_4,long param_5)
          ...
          if (param_4 != 0) {
            ...
            do {
              ...
              if (((dVar16 < -2147483648.0) || (2147483647.0 < dVar16)) ||
                ...
                if ((int)uVar1 < 0) {
                  if ((int)uVar1 < -0x34) goto LAB_0107a6d4;
            ...
            do {
              if (*(long *)(uVar12 + (long)iVar6) == -0x8000000080001) {
                ...
                if ((((dVar16 < -2147483648.0) || (2147483647.0 < dVar16)) ||
                  ...
                  if ((int)uVar3 < 0) {
                    if ((int)uVar3 < -0x34) goto LAB_0107a8d8;
...
LAB_0107a824:
    ...
    if (*(short *)(((ulong)pIVar11 | 7) + (ulong)*(uint *)(((ulong)pIVar11 | (ulong)uVar3) - 1)) !=
        0xa9) goto LAB_0107a5c8;
LAB_0107a69c:
    v8::internal::PerIsolateAssertScope<(v8::internal::PerIsolateAssertType)0,false>::
    ~PerIsolateAssertScope(aPStack_78);
  }
  uVar14 = 0;
switchD_0107a650_caseD_2:
  v8::internal::PerIsolateAssertScope<(v8::internal::PerIsolateAssertType)0,false>::
