...
/* v8::internal::compiler::JSArrayRef::length() const */

undefined1  [16] __thiscall v8::internal::compiler::JSArrayRef::length(JSArrayRef *this)

{
  ...
  if (*(int *)(*(undefined8 **)this + 1) == 2) {
    ...
    if (*(short *)(*(long *)(lVar3 + 0x10) + 0x18) != 0x423) {
                    /* WARNING: Subroutine does not return */
