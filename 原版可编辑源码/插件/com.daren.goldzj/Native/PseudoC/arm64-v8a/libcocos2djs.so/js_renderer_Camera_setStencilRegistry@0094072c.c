...
/* js_renderer_Camera_setStencilRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Camera_setStencilRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Camera *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x617,"js_renderer_Camera_setStencil");
    __android_log_print(6,"jswrapper","js_renderer_Camera_setStencil : Invalid Native Object");
  }
  else {
    ...
    if (uVar6 == 0x10) {
      ...
      if ((uVar6 & 1) != 0) {
        cocos2d::renderer::Camera::setStencil(this,local_64);
        goto LAB_009408e4;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0x61e,"js_renderer_Camera_setStencil");
      __android_log_print(6,"jswrapper","js_renderer_Camera_setStencil : Error processing arguments"
                         );
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 1570): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar6 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Camera_setStencil",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0x625);
LAB_009408e4:
