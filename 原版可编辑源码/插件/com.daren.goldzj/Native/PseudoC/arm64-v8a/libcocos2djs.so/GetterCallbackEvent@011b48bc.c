...
/* v8::internal::ProfilerListener::GetterCallbackEvent(v8::internal::Name, unsigned long) */

void __thiscall
v8::internal::ProfilerListener::GetterCallbackEvent
...

{
  ...
  uVar3 = StringsStorage::GetConsName((StringsStorage *)(this + 0x18),&DAT_0189f8a5,param_2);
