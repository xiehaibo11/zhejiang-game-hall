...
/* v8::internal::compiler::GraphAssembler::ChangeInt32ToInt64(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::ChangeInt32ToInt64(GraphAssembler *this,Node *param_1)
