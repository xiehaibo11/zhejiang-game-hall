...
/* js_gfx_Program_linkRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_gfx_Program_linkRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Program *)se::State::nativeThisObject(aSStack_60);
  if (this == (Program *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                        ,0x66a,"js_gfx_Program_link");
    __android_log_print(6,"jswrapper","js_gfx_Program_link : Invalid Native Object");
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      cocos2d::renderer::Program::link(this);
      goto LAB_00934f18;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp, 1649): wrong number of arguments: %d, was expecting %d\n"
