...
ulong * FUN_0184e920(byte param_1,ulong *param_2,ulong *param_3,ulong *param_4)

{
  ...
  if (param_1 == 0x50) {
    ...
    case 0xc:
      ...
      break;
    case 1:
      puVar1 = (ulong *)FUN_0184e8b8(param_3,&local_8);
      break;
    case 2:
    ...
    default:
      ...
      abort();
    case 9:
      puVar1 = (ulong *)FUN_0184e8e0(param_3,&local_8);
      break;
    case 10:
      puVar1 = (ulong *)((long)param_3 + 2);
