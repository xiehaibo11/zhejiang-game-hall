...
undefined8 FUN_00a12a28(long *param_1,long param_2,uint param_3,int param_4,int *param_5)

{
  ...
  if (param_1[0x10] == 0) {
    ...
    auVar17 = FUN_00a18e40();
    lVar9 = auVar17._0_8_;
    lVar7 = FUN_00a15f20(0,0,param_1[0x10]);
    param_1[0x10] = lVar7;
    lVar8 = *(long *)(lVar7 + 0x18);
    uVar10 = 0;
    if (lVar9 <= lVar8) {
      if ((lVar9 < lVar8) || (auVar17._8_8_ < *(long *)(lVar7 + 0x20))) {
        uVar10 = FUN_00a18ea0(lVar8,*(long *)(lVar7 + 0x20),lVar9,auVar17._8_8_);
        if (uVar10 == 0) {
          uVar10 = 1;
        }
      }
  ...
  for (; plVar14 != (long *)0x0; plVar14 = (long *)*plVar14) {
    uVar4 = FUN_00a128fc(plVar14,local_74);
    uVar10 = 0;
    do {
  ...
  if (uVar16 + param_3 == 0 && param_3 == 0) {
    lVar9 = 0;
    if (uVar16 != 0) goto LAB_00a12bcc;
LAB_00a12cf0:
    uVar4 = 0;
  }
  else {
    lVar9 = (*(code *)PTR_malloc_01d1b740)((ulong)(uVar16 + param_3) << 3);
    if (lVar9 == 0) {
      return 3;
    }
    if (uVar16 == 0) goto LAB_00a12cf0;
LAB_00a12bcc:
    plVar14 = (long *)param_1[1];
    if (plVar14 == (long *)0x0) goto LAB_00a12cf0;
    uVar4 = 0;
    do {
      uVar5 = FUN_00a128fc(plVar14,local_74);
      uVar10 = 0;
      do {
  ...
  iVar6 = FUN_00a15cfc(lVar9,uVar4,iVar15);
  iVar15 = 0;
  if ((iVar6 < 1) || (iVar15 = iVar6, param_3 == 0)) goto LAB_00a12dd0;
  uVar10 = (ulong)param_3;
  if (param_3 < 2) {
LAB_00a12d9c:
    lVar8 = 0;
    ...
    if ((!CARRY4(uVar16,(uint)(uVar10 - 1))) && (uVar10 - 1 >> 0x20 == 0)) {
      ...
      lVar8 = lVar7;
      if ((param_3 & 1) == 0) goto LAB_00a12dd0;
    }
  }
