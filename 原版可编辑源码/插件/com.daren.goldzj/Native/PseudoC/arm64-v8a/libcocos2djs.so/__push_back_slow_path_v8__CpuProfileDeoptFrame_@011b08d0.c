...
/* void std::__ndk1::vector<v8::CpuProfileDeoptFrame,
   std::__ndk1::allocator<v8::CpuProfileDeoptFrame>
   >::__push_back_slow_path<v8::CpuProfileDeoptFrame>(v8::CpuProfileDeoptFrame&&) */
...

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_011b09bc;
