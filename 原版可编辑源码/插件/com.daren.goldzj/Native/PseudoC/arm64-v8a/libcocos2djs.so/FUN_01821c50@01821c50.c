...
byte * FUN_01821c50(long *param_1,byte *param_2,byte *param_3,byte *param_4,long *param_5,
...

{
  ...
  if (100 < __size) {
    ...
    pcVar11 = __ptr;
    if (__ptr != (char *)0x0) goto LAB_01821cd0;
...
LAB_01821cd0:
  lVar12 = 0;
  pcVar9 = pcVar11;
  for (pbVar7 = param_3; pbVar7 != param_4; pbVar7 = pbVar7 + 0x18) {
    if ((*pbVar7 & 1) == 0) {
      if (*pbVar7 >> 1 == 0) goto LAB_01821d10;
LAB_01821d00:
      *pcVar9 = '\x01';
    }
    else {
      if (*(long *)(pbVar7 + 8) != 0) goto LAB_01821d00;
LAB_01821d10:
      __size = __size - 1;
      lVar12 = lVar12 + 1;
      *pcVar9 = '\x02';
  ...
  for (; param_3 != param_4; param_3 = param_3 + 0x18) {
    if (*pcVar11 == '\x02') goto joined_r0x01821f20;
    pcVar11 = pcVar11 + 1;
  }
  *param_6 = *param_6 | 4;
  param_3 = param_4;
