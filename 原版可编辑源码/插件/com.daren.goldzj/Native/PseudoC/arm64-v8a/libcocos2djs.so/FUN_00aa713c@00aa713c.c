...
uint FUN_00aa713c(long param_1,long *param_2,ulong *param_3)

{
  ...
  byte local_34 [4];
                    ...
                    /* try { // try from 00aa715c to 00ba716b has its CatchHandler @ 00aa7244 */
  pbVar6 = (byte *)*param_2;
  ...
  uVar14 = (ulong)*(uint *)(param_1 + 0x68);
                    /* try { // try from 00aa7178 to 00ba718b has its CatchHandler @ 00aa7258 */
  uVar2 = (int)uVar7 - *(uint *)(param_1 + 0x68);
  uVar11 = (uint)*(ulong *)(param_1 + 0x60);
  if ((ulong)uVar2 <= *(ulong *)(param_1 + 0x60)) {
    uVar11 = uVar2;
  }
                    /* try { // try from 00aa718c to 00ba7273 has its CatchHandler @ 00aa70c8 */
  uVar2 = (uint)*param_3;
      ...
      if ((pbVar6 + uVar7 * 4 + 4 <= __dest || pbVar10 <= pbVar6) &&
        ...
        do {
          ...
          *__dest = local_34[0] ^ bVar23;
          ...
          __dest = __dest + 0x40;
          if (lVar9 == 0) goto joined_r0x00aa73f8;
        } while( true );
      }
    }
    do {
      ...
      *__dest = local_34[0] ^ *pbVar12;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00aa715c with catch @ 00aa7244
                        */
      __dest[1] = local_34[1] ^ pbVar12[1];
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00aa7104 with catch @ 00aa7258
                       catch(type#1 @ 00000000) { ... } // from try @ 00aa7178 with catch @ 00aa7258
                        */
...
LAB_00aa72ac:
      ...
      if ((__dest + 1 < local_34 + uVar7 && (byte *)((ulong)local_34 | 1) < __dest + uVar7) ||
         (__dest + 1 < pbVar6 + uVar7 && pbVar6 + 1 < __dest + uVar7)) goto LAB_00aa72ac;
