...
ulong FUN_0135ea68(ulong param_1,ulong param_2,ulong param_3,undefined8 param_4,undefined8 param_5,
...

{
  ...
  *(int *)(param_2 - 1) = (int)param_6;
  ...
  else if (uVar11 <= uVar13) goto LAB_0135f9cc;
  uVar6 = uVar14;
...
LAB_0135f9cc:
  ...
  if ((ulong)((long)((ulong)*(uint *)(uVar6 + 3) << 0x20) >> 0x21) <= uVar13) {
    ...
    pcVar5 = (code *)SoftwareBreakpoint(0,0x1361370);
    (*pcVar5)();
  }
  lVar9 = uVar13 * 4 + 7;
