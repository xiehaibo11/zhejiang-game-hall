...
/* v8::internal::compiler::GraphAssembler::IsEmptyString(v8::internal::TNode<v8::internal::Object>)
    */

void __thiscall
v8::internal::compiler::GraphAssembler::IsEmptyString(GraphAssembler *this,undefined8 param_2)
