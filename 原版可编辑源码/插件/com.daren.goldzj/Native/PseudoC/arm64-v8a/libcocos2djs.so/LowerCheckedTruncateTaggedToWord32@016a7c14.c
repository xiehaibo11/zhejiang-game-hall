...
/* v8::internal::compiler::EffectControlLinearizer::LowerCheckedTruncateTaggedToWord32(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerCheckedTruncateTaggedToWord32
...

{
  ...
  if (*(char *)(*(long *)(*(long *)this + 0x10) + 0x10) == '\x05') {
    pNVar3 = (Node *)GraphAssembler::TruncateInt64ToInt32(this_00,pNVar5);
    if (*(char *)(*(long *)(*(long *)this + 0x10) + 0x10) == '\x05') {
    ...
    pNVar3 = (Node *)ChangeSmiToIntPtr(this,pNVar5);
  }
  ...
  *(undefined8 *)(this + 0x60) = 0;
  ...
  pNVar5 = (Node *)BuildCheckedHeapNumberOrOddballToFloat64(this,*puVar2,puVar2 + 8,pNVar5,param_2);
  pNVar5 = (Node *)GraphAssembler::TruncateFloat64ToWord32(this_00,pNVar5);
