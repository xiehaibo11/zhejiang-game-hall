...
/* void std::__ndk1::vector<v8::internal::wasm::WasmElemSegment,
   std::__ndk1::allocator<v8::internal::wasm::WasmElemSegment> >::__emplace_back_slow_path<unsigned
   int&, v8::internal::wasm::WasmInitExpr&>(unsigned int&, v8::internal::wasm::WasmInitExpr&) */
...
::__emplace_back_slow_path<unsigned_int&,v8::internal::wasm::WasmInitExpr&>
          (vector<v8::internal::wasm::WasmElemSegment,std::__ndk1::allocator<v8::internal::wasm::WasmElemSegment>>
           *this,uint *param_1,WasmInitExpr *param_2)
