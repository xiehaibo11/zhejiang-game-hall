...
/* std::__ndk1::vector<cocos2d::renderer::NodeProxy*,
   std::__ndk1::allocator<cocos2d::renderer::NodeProxy*> >::__append(unsigned long) */

void __thiscall
std::__ndk1::
vector<cocos2d::renderer::NodeProxy*,std::__ndk1::allocator<cocos2d::renderer::NodeProxy*>>::
__append(vector<cocos2d::renderer::NodeProxy*,std::__ndk1::allocator<cocos2d::renderer::NodeProxy*>>
         *this,ulong param_1)
...
LAB_00d1c034:
  ...
  if ((ulong)(lVar2 >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar5 >> 0x3d != 0) goto LAB_00d1c034;
  }
  else {
