...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CheckedTruncateTaggedToWord32(v8::internal::compiler::CheckTaggedInputMode,
   v8::internal::compiler::FeedbackSource const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::CheckedTruncateTaggedToWord32
...

{
  ...
  if ((*param_3 == 0) || ((int)param_3[1] == -1)) {
    if (param_2 == (Operator)0x1) {
      ...
      if (param_2 != (Operator)0x0) goto LAB_012eddc4;
      lVar4 = *(long *)this;
      lVar5 = 0x31c8;
    }
...
LAB_012eddc4:
    ...
    Operator::Operator(pOVar2,0x6a,0x38,"CheckedTruncateTaggedToWord32",1,1,1,1,1,0);
    pOVar2[0x30] = param_2;
    *(undefined ***)pOVar2 = &PTR__Operator_01cc1ce8;
