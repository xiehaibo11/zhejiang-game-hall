...
void FUN_0147950c(ulong *param_1,undefined8 *param_2)

{
  ...
  puVar12 = puVar4;
  if (puVar4 != (undefined8 *)param_1[3]) goto LAB_01479694;
...
LAB_01479660:
      ...
      if (((void *)((long)pvVar6 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar6 + uVar13 * 8 + uVar9 + 8))) goto LAB_01479660;
      ...
      puVar11 = puVar12;
      if (uVar2 != uVar9) goto LAB_01479660;
    }
    puVar11 = (undefined8 *)*param_1;
  }
