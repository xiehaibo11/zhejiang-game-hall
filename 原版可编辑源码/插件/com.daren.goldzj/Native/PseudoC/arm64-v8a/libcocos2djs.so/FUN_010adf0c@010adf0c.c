...
undefined1  [16]
FUN_010adf0c(undefined8 param_1,Factory *param_2,ulong *param_3,undefined8 *param_4,ulong param_5,
            ulong param_6)
  ...
  if (param_5 < param_6) {
    ...
    while( true ) {
      ...
      if (local_c4 != 4) {
        ...
        uVar4 = 0;
        if (puVar3 == (undefined8 *)0x0) goto LAB_010ae088;
        local_68 = *param_4;
        uVar5 = v8::internal::Object::StrictEquals((Object *)&local_68,*puVar3);
        if ((uVar5 & 1) != 0) goto LAB_010ae084;
      }
      param_5 = param_5 + 1;
