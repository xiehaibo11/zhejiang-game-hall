...
/* v8::internal::MacroAssembler::AssertGeneratorObject(v8::internal::Register) */

void v8::internal::MacroAssembler::AssertGeneratorObject
...

{
  ...
  if (param_1[0xc0] != (AssemblerBase)0x0) {
    AssertNotSmi(param_1,param_2,param_3,0x16);
    ...
    local_90 = 0xffffffff;
    local_88._0_4_ = 2;
    TurboAssembler::AddSubMacro((TurboAssembler *)param_1,puVar2,&local_110,&local_c0,1,0x40000000);
    TurboAssembler::B((TurboAssembler *)param_1,&local_d0,0);
    puVar2 = &DAT_019f4018;
    if (local_110._4_4_ != 0x40) {
      puVar2 = &DAT_019f4000;
    ...
    TurboAssembler::Abort((TurboAssembler *)param_1,0x1b);
    Assembler::bind((Label *)param_1);
