...

{
  ...
  pcVar2 = param_1;
  do {
    while (pcVar4 = pcVar2, pcVar2 = __parse_assertion<char_const*>(this,pcVar4,param_2),
          pcVar2 == pcVar4) {
      ...
      if ((pcVar2 == pcVar4) ||
         ...
         pcVar2 == pcVar4)) goto LAB_0086293c;
    }
  } while (pcVar2 != pcVar4);
LAB_0086293c:
  if (pcVar4 == param_1) {
  ...
  do {
    ...
    pcVar5 = pcVar2;
    do {
      while (pcVar4 = pcVar5, pcVar5 = __parse_assertion<char_const*>(this,pcVar4,param_2),
            pcVar5 == pcVar4) {
        p_Var10 = *(__owns_one_state **)(this + 0x38);
        iVar1 = *(int *)(this + 0x1c);
        ...
        if ((pcVar5 == pcVar4) ||
           ...
           pcVar5 == pcVar4)) goto LAB_00862a2c;
      }
    } while (pcVar5 != pcVar4);
LAB_00862a2c:
    if (pcVar4 == pcVar2) {
