...
/* v8::internal::StackTraceFrame::GetWasmInstance(v8::internal::Handle<v8::internal::StackTraceFrame>)
    */

void v8::internal::StackTraceFrame::GetWasmInstance(ulong *param_1)

{
  ...
  uVar4 = uVar4 & 0xffffffff00000000 | (ulong)*(uint *)(uVar4 + 0x33);
