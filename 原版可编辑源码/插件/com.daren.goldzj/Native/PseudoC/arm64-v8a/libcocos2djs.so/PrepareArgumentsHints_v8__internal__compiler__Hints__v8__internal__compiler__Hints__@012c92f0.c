...
/* v8::internal::ZoneVector<v8::internal::compiler::Hints>
   ...
   v8::internal::compiler::Hints*>(v8::internal::compiler::Hints*, v8::internal::compiler::Hints*,
   v8::internal::compiler::Hints*) */

void v8::internal::compiler::SerializerForBackgroundCompilation::
     PrepareArgumentsHints<v8::internal::compiler::Hints*,v8::internal::compiler::Hints*>
               (Hints *param_1,Hints *param_2,Hints *param_3)

{
  ...
  *in_x8;
  ...
  if (*(undefined8 **)(in_x8 + 8) == *(undefined8 **)(in_x8 + 0x10)) {
    std::__ndk1::
    vector<v8::internal::compiler::Hints,v8::internal::ZoneAllocator<v8::internal::compiler::Hints>>
    ::__push_back_slow_path<v8::internal::compiler::Hints_const&>(in_x8,param_2);
  }
  else {
