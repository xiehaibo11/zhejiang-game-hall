...
/* bool spine_Vector_T_ptr_to_seval<spine::PathConstraint>(spine::Vector<spine::PathConstraint*>
   const&, se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::PathConstraint>(Vector *param_1,Value *param_2)
...
LAB_00c89360:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::PathConstraint>
