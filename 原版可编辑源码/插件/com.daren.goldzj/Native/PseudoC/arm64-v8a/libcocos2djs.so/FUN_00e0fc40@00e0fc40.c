...
undefined4 FUN_00e0fc40(uint *param_1)
...
LAB_00e0fcec:
    ...
    case 2:
      ...
      break;
    default:
      goto switchD_00e0fd10_caseD_ffffffff;
    }
    FUN_00e0f54c(param_1,uVar8,pcVar7);
    return 0xffffffff;
  }
  ...
  if (param_1[0x14] == 0) {
    ...
    *(undefined8 *)(param_1 + 0x1e) = *(undefined8 *)(param_1 + 0xc);
    if (uVar2 + uVar9 != 0) goto LAB_00e0fcec;
  }
  FUN_00e0f54c(param_1,0xfffffffb,"unexpected end of file");
  uVar9 = param_1[0x26];
LAB_00e0fd40:
  *param_1 = uVar1 - uVar9;
  *(ulong *)(param_1 + 2) = *(long *)(param_1 + 0x24) - (ulong)(uVar1 - uVar9);
  ...
  return 0;
switchD_00e0fd10_caseD_ffffffff:
  uVar9 = param_1[0x26];
  if ((iVar4 == 1) || (uVar9 == 0)) goto LAB_00e0fd40;
  goto LAB_00e0fc78;
}
