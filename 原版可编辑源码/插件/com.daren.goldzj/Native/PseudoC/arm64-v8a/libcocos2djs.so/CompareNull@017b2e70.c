...
/* v8::internal::interpreter::BytecodeArrayBuilder::CompareNull() */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::CompareNull(BytecodeArrayBuilder *this)
