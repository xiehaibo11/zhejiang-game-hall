...
/* v8::internal::compiler::CodeAssembler::Int32MulWithOverflow(v8::internal::SloppyTNode<v8::internal::Int32T>,
...

{
  ...
  pOVar1 = (Operator *)
           MachineOperatorBuilder::Int32MulWithOverflow((MachineOperatorBuilder *)(this_00 + 0x20));
  local_40 = param_2;
  uStack_38 = param_3;
