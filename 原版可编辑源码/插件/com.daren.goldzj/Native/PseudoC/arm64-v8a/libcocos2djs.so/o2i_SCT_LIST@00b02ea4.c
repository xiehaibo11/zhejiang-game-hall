    ...
    if (CONCAT11(uVar2,uVar3) == uVar8) {
      ...
      do {
        ...
        if (uVar8 == 1) {
          ...
          goto joined_r0x00b03034;
        }
        puVar6 = (undefined1 *)*param_2;
                    /* try { // try from 00b02f48 to 00c02f53 has its CatchHandler @ 00b0312c */
        uVar2 = *puVar6;
        uVar3 = puVar6[1];
        *param_2 = (long)(puVar6 + 2);
        ...
        if (lVar5 == 0) goto joined_r0x00b03034;
        uVar8 = (uVar8 - 2) - uVar1;
...
joined_r0x00b03034:
  ...
  ERR_put_error(0x32,0x6f,0x69,"crypto/ct/ct_oct.c",iVar4);
                    /* try { // try from 00b02fdc to 00c030af has its CatchHandler @ 00b03134 */
  return 0;
}
