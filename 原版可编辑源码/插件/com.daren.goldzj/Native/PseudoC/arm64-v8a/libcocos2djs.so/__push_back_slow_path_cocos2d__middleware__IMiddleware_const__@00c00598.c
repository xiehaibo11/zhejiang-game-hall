...
/* void std::__ndk1::vector<cocos2d::middleware::IMiddleware*,
   std::__ndk1::allocator<cocos2d::middleware::IMiddleware*>
   >::__push_back_slow_path<cocos2d::middleware::IMiddleware*
   const&>(cocos2d::middleware::IMiddleware* const&) */
...
LAB_00c005fc:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00c005fc;
  }
  else {
