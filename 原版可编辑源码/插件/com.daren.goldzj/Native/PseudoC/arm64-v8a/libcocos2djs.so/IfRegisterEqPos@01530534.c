...
/* v8::internal::RegExpBytecodeGenerator::IfRegisterEqPos(int, v8::internal::Label*) */

void __thiscall
v8::internal::RegExpBytecodeGenerator::IfRegisterEqPos
...

{
  ...
  *(uint *)(*(long *)(this + 0x28) + (long)iVar3) = param_1 << 8 | 0x2e;
  iVar3 = *(int *)(this + 0x38);
  pRVar1 = this + 0x3c;
