...
/* v8::internal::Factory::NewSourcePositionTableWithFrameCache(v8::internal::Handle<v8::internal::ByteArray>,
   v8::internal::Handle<v8::internal::SimpleNumberDictionary>) */

ulong * __thiscall
v8::internal::Factory::NewSourcePositionTableWithFrameCache
          (Factory *this,ulong *param_2,ulong *param_3)

{
  ...
  puVar1 = (ulong *)NewStruct(this,0x69,1);
  uVar4 = *puVar1;
  uVar3 = *param_2;
