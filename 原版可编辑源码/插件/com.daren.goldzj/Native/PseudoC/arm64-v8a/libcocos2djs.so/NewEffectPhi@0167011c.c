...
/* v8::internal::compiler::BytecodeGraphBuilder::NewEffectPhi(int, v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::NewEffectPhi
...

{
  ...
  pOVar2 = (Operator *)
           CommonOperatorBuilder::EffectPhi
                     (*(CommonOperatorBuilder **)(*(long *)(this + 0x10) + 8),param_1);
  ...
  if (param_1 != 0) {
    ...
    if ((uint)param_1 < 4) {
      ...
      if (uVar5 == uVar3) goto LAB_016701f8;
    }
    lVar7 = uVar3 - uVar5;
