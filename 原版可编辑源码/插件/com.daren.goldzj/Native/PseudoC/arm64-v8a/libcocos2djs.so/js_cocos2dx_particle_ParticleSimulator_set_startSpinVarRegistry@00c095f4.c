...
/* js_cocos2dx_particle_ParticleSimulator_set_startSpinVarRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_particle_ParticleSimulator_set_startSpinVarRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x33e,"js_cocos2dx_particle_ParticleSimulator_set_startSpinVar");
    pcVar8 = "js_cocos2dx_particle_ParticleSimulator_set_startSpinVar : Invalid Native Object";
  }
  else {
    local_74 = 0.0;
    uVar7 = seval_to_float((Value *)*puVar5,&local_74);
    if ((uVar7 & 1) != 0) {
      *(float *)(lVar6 + 0x144) = local_74;
      goto LAB_00c09790;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                        ,0x343,"js_cocos2dx_particle_ParticleSimulator_set_startSpinVar");
    pcVar8 = "js_cocos2dx_particle_ParticleSimulator_set_startSpinVar : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar8);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_particle_ParticleSimulator_set_startSpinVar",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                      ,0x347);
LAB_00c09790:
