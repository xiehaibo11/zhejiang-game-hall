...
/* v8::internal::compiler::CodeAssembler::WordSar(v8::internal::SloppyTNode<v8::internal::WordT>,
   v8::internal::SloppyTNode<v8::internal::IntegralT>) */

long * __thiscall
v8::internal::compiler::CodeAssembler::WordSar(CodeAssembler *this,Node *param_2,ulong *param_3)
...
LAB_01684290:
    ...
    if (uVar1 != 0x17) {
      bVar3 = false;
      bVar4 = 0;
      goto joined_r0x01684270;
    }
    uVar11 = (ulong)*(int *)(uVar11 + 0x2c);
    bVar3 = true;
    bVar4 = 1;
    if (bVar2) goto LAB_01684290;
LAB_01684274:
  ...
  if (this_00[0x30] == (RawMachineAssembler)0x4) {
    pOVar5 = (Operator *)
             MachineOperatorBuilder::Word32Sar((MachineOperatorBuilder *)(this_00 + 0x20));
  }
  else {
    pOVar5 = (Operator *)
             MachineOperatorBuilder::Word64Sar((MachineOperatorBuilder *)(this_00 + 0x20));
  }
  iVar7 = 2;
  local_40 = param_2;
  puStack_38 = param_3;
