...
undefined8 FUN_0157b1dc(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0x1d8);
  }
  if (DAT_01d47230 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d47230 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d47230;
  local_a0 = (byte **)0x0;
  if ((*DAT_01d47230 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar3,"V8.Runtime_Runtime_CheckProxyGetSetTrapResult",0,0,0,0,0,
                       0,0,&local_50,0);
    plVar4 = local_48;
    local_48 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    local_a0 = &local_98;
    local_90 = "V8.Runtime_Runtime_CheckProxyGetSetTrapResult";
    local_98 = pbVar3;
    local_88 = uVar5;
  }
  ...
  if (((uVar8 & 1) != 0) &&
    ...
    if (((uVar8 & 1) != 0) &&
      ...
      if ((uVar8 & 1) == 0) {
        ...
        else if (9.223372036854776e+18 <= dVar10) {
          lVar7 = 0x7fffffffffffffff;
        }
        else if (dVar10 <= -9.223372036854776e+18) {
      ...
      pIVar6 = (Isolate *)
               v8::internal::JSProxy::CheckGetSetTrapResult
                         (param_3,param_2,param_2 + -1,param_2 + -2,lVar7);
