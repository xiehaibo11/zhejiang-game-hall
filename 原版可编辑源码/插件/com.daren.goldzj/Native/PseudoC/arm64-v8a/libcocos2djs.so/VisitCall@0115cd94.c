...
/* v8::internal::AstTraversalVisitor<v8::internal::SourceRangeAstVisitor>::VisitCall(v8::internal::Call*)
    */

void __thiscall
v8::internal::AstTraversalVisitor<v8::internal::SourceRangeAstVisitor>::VisitCall
          (AstTraversalVisitor<v8::internal::SourceRangeAstVisitor> *this,Call *param_1)
