...
/* void std::__ndk1::vector<v8::internal::Handle<v8::internal::Script>,
   std::__ndk1::allocator<v8::internal::Handle<v8::internal::Script> >
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_015c3bb8;
