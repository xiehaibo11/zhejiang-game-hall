...
/* js_renderer_Particle3DAssembler_ctorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Particle3DAssembler_ctorRegistry(FunctionCallbackInfo *param_1)
