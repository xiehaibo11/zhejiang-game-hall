...
/* std::__ndk1::enable_if<__is_forward_iterator<std::__ndk1::__wrap_iter<v8::internal::compiler::Node**>
   >::value&&is_constructible<v8::internal::compiler::Node*,
   std::__ndk1::iterator_traits<std::__ndk1::__wrap_iter<v8::internal::compiler::Node**>
   >::reference>::value, std::__ndk1::__wrap_iter<v8::internal::compiler::Node**> >::type
   ...
   >(std::__ndk1::__wrap_iter<v8::internal::compiler::Node* const*>,
...

{
  ...
  if (param_3 != param_4) {
    ...
    if ((3 < uVar8) &&
      ...
      if (uVar8 == uVar12) goto LAB_012b58a8;
    }
    do {
      puVar10 = param_3 + 1;
      puVar3 = puVar6 + 1;
