...
/* v8::internal::Scanner::ScanHexDigits() */

undefined8 __thiscall v8::internal::Scanner::ScanHexDigits(Scanner *this)

{
  ...
  if ((uVar6 - 0x30 < 10) || ((uVar6 | 0x20) - 0x61 < 6)) {
    bVar1 = false;
    do {
      while (uVar6 - 0x30 < 10) {
LAB_0119694c:
...
LAB_01196a00:
          ...
          if ((char)plVar7[6] == '\0') {
            ...
            if ((uVar2 & 1) != 0) goto LAB_01196a00;
          }
          bVar1 = false;
          uVar6 = 0xffffffff;
        }
LAB_01196a08:
      ...
      if ((uVar6 | 0x20) - 0x61 < 6) {
        if (uVar6 != 0x5f) goto LAB_0119694c;
      }
      else if (uVar6 != 0x5f) {
        if (!bVar1) {
          return 1;
      ...
      if ((ushort *)plVar7[3] <= puVar4) {
        if ((char)plVar7[6] == '\0') {
          uVar2 = (**(code **)(*plVar7 + 0x28))(plVar7);
          puVar4 = (ushort *)plVar7[2];
          if ((uVar2 & 1) != 0) goto LAB_011969b8;
        }
        bVar1 = true;
        uVar6 = 0xffffffff;
        goto LAB_01196a08;
