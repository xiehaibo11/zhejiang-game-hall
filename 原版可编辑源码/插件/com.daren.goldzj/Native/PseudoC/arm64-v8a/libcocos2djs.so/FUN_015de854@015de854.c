...
undefined8 FUN_015de854(uchar *param_1,uint *param_2)

{
  ...
  if (uVar1 != 0) {
    ...
    do {
      ...
      bVar3 = *(byte *)(*(long *)(param_1 + 0xb8) + (ulong)uVar1 * -0x18 + 8 + lVar7);
      bVar2 = (byte)puVar9[2];
      if (bVar2 != bVar3) {
        ...
        if (((iVar8 != 8 || bVar2 != 9) && (bVar2 != 6 || 2 < (iVar8 - 7U & 0xff))) &&
           (iVar8 != 8 || bVar2 != 7)) {
          if (bVar2 < 0xb) {
            pcVar5 = (&PTR_s_<stmt>_01cc9868)[(char)bVar2];
          }
          else {
            pcVar5 = "<unknown>";
          }
          if (bVar3 < 0xb) {
            pcVar6 = (&PTR_s_<stmt>_01cc9868)[(char)bVar3];
          }
          else {
            pcVar6 = "<unknown>";
          }
