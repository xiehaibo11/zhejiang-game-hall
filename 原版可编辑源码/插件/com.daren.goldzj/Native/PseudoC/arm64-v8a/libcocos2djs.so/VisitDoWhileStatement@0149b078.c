...
/* v8::internal::CallPrinter::VisitDoWhileStatement(v8::internal::DoWhileStatement*) */

void __thiscall
v8::internal::CallPrinter::VisitDoWhileStatement(CallPrinter *this,DoWhileStatement *param_1)
