...
/* js_cocos2dx_spine_TrackEntry_setMixDurationRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_TrackEntry_setMixDurationRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TrackEntry *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1f5,"js_cocos2dx_spine_TrackEntry_setMixDuration");
    pcVar6 = "js_cocos2dx_spine_TrackEntry_setMixDuration : Invalid Native Object";
LAB_00c152d0:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::TrackEntry::setMixDuration(this,local_64);
        goto LAB_00c15308;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1fc,"js_cocos2dx_spine_TrackEntry_setMixDuration");
      pcVar6 = "js_cocos2dx_spine_TrackEntry_setMixDuration : Error processing arguments";
      goto LAB_00c152d0;
    }
    __android_log_print(6,"jswrapper",&DAT_018f2123,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TrackEntry_setMixDuration",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x203);
LAB_00c15308:
