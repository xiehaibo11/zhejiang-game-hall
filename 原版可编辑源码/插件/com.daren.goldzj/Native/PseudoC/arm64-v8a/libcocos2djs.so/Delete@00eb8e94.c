...
/* v8::Object::Delete(v8::Local<v8::Context>, v8::Local<v8::Value>) */

ushort __thiscall v8::Object::Delete(Object *this,long param_2,undefined8 param_3)

{
  ...
  if (*(int *)(pIVar10 + 0x2c20) == *(int *)(pIVar10 + 0xa8)) {
    ...
    bVar2 = *(int *)(pIVar10 + 0x2c20) == *(int *)(pIVar10 + 0x188);
  }
  if (*(short *)((*(ulong *)this & 0xffffffff00000000 | 7) + (ulong)*(uint *)(*(ulong *)this - 1))
    ...
    lVar12 = *(long *)(pIVar10 + 0x95a8);
    *(int *)(pIVar10 + 0x95b0) = *(int *)(pIVar10 + 0x95b0) + 1;
    FUN_00eaadd8(&local_b0,pIVar10,param_2);
    local_c0 = 0;
    uStack_d8 = 0;
    ...
    if (internal::TracingFlags::runtime_stats != 0) {
      ...
      internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x394);
    }
    pLVar11 = *(Logger **)(pIVar10 + 0x9558);
    uVar4 = internal::Logger::is_logging(pLVar11);
    if ((uVar4 & 1) != 0) {
      internal::Logger::ApiEntryCall(pLVar11,"v8::Object::Delete");
    }
    uVar1 = *(undefined4 *)(pIVar10 + 0x2c60);
    *(undefined4 *)(pIVar10 + 0x2c60) = 5;
    uVar3 = internal::Runtime::DeleteObjectProperty(pIVar10,this,param_3,0);
    if ((uVar3 & 0xff) == 0) {
      local_a0 = '\x01';
  ...
  *(undefined4 *)(pIVar10 + 0x2c60) = uVar1;
  if (local_e0 == (RuntimeCallStats *)0x0) {
    if (local_a8 != (ulong *)0x0) goto LAB_00eb9134;
LAB_00eb91f8:
    pIVar6 = local_b0 + 0xb7c0;
  }
  else {
    internal::RuntimeCallStats::Leave(local_e0,(RuntimeCallTimer *)((ulong)&local_e0 | 8));
    if (local_a8 == (ulong *)0x0) goto LAB_00eb91f8;
LAB_00eb9134:
    lVar7 = *(long *)(local_b0 + 0x95c0);
    lVar8 = *(long *)(lVar7 + 0x60) + -1;
    uVar9 = *(undefined8 *)(*(long *)(lVar7 + 0x50) + lVar8 * 8);
...
LAB_00eb9220:
  ...
  *(int *)(pIVar10 + 0x95b0) = *(int *)(pIVar10 + 0x95b0) + -1;
  if (*(long *)(pIVar10 + 0x95a8) != lVar12) {
    *(long *)(pIVar10 + 0x95a8) = lVar12;
