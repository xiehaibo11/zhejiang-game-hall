...
/* void JSBClassType::registerClass<spine::RealTimeAttachUtil>(se::Class*) */

void JSBClassType::registerClass<spine::RealTimeAttachUtil>(Class *param_1)
