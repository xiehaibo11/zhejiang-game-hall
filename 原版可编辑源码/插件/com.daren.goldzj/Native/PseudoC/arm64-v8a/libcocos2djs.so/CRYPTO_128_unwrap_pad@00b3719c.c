...

{
  ...
  if (param_5 - 0x10 == 0) {
    ...
    *param_3 = param_3[1];
    ...
    lVar4 = param_5 - 8;
    lVar2 = FUN_00b36cd0(param_1,&local_58,param_3,param_3,param_5,param_6);
    if (lVar4 != lVar2) goto LAB_00b372d4;
  }
  if (param_2 == (void *)0x0) {
    iVar1 = CRYPTO_memcmp(&local_58,&DAT_018b1886,4);
  }
  else {
  ...
  if ((((iVar1 == 0) &&
     ...
     (iVar1 = CRYPTO_memcmp((void *)((long)param_3 + uVar3),&DAT_01d3ac80,lVar4 - uVar3), iVar1 == 0
     )) {
    return uVar3;
  }
LAB_00b372d4:
