...
/* v8::internal::Handle<v8::internal::String>
   v8::internal::StringTable::LookupKey<v8::internal::InternalizedStringKey>(v8::internal::Isolate*,
   v8::internal::InternalizedStringKey*) */

void v8::internal::StringTable::LookupKey<v8::internal::InternalizedStringKey>
               (Isolate *param_1,InternalizedStringKey *param_2)
