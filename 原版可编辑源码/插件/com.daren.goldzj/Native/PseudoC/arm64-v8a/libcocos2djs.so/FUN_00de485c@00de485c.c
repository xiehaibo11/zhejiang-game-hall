...
void FUN_00de485c(long param_1,int *param_2)
  ...
  if (0 < *(int *)(param_1 + 0x198)) {
    ...
    do {
      ...
      if (*(char *)(local_68 + lVar19 * 800 + 0x300) == '\0') {
        ...
        (**(code **)(&DAT_01d54580 + uVar3 * 8))(puVar2);
        if (uVar14 != 0) {
          lVar15 = 0;
          lVar18 = local_68 + lVar19 * 800;
          do {
            uVar8 = uVar14 >> 0x1e;
            lVar16 = (long)puVar2 + (long)*(int *)((long)&DAT_0196fa20 + lVar15);
            if (uVar8 == 1) {
              puVar11 = &DAT_01d545d8;
LAB_00de4c7c:
              (*(code *)*puVar11)(lVar18,lVar16);
            }
            else {
              if (uVar8 == 2) {
                puVar11 = &DAT_01d54518;
                goto LAB_00de4c7c;
              }
              if (uVar8 == 3) {
                (*DAT_01d545e0)(lVar18,lVar16,0);
              }
            }
            lVar15 = lVar15 + 4;
            uVar14 = uVar14 << 2;
        ...
        *(int *)(lVar17 + 0x98) = iVar10;
        do {
          lVar13 = (long)puVar2 + (long)(int)(&DAT_0196fa20)[lVar18];
          (**(code **)(&DAT_01d54530 + (ulong)*(byte *)(lVar15 + lVar18) * 8))(lVar13);
          uVar8 = uVar14 >> 0x1e;
          if (uVar8 == 1) {
            puVar11 = &DAT_01d545d8;
LAB_00de4d54:
      ...
      (**(code **)(&DAT_01d545f0 + uVar3 * 8))(local_70);
      (**(code **)(&DAT_01d545f0 + uVar3 * 8))(local_78);
      if ((uVar14 & 0xff) != 0) {
        if ((uVar14 & 0xaa) == 0) {
          puVar11 = &DAT_01d545d0;
        }
        else {
          puVar11 = &DAT_01d544f0;
        }
