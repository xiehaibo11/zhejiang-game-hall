...

{
  ...
  if (uVar2 != 0) {
    uVar3 = uVar6 / uVar2;
                    ...
                    /* try { // try from 00a6a0c0 to 00b6a0f7 has its CatchHandler @ 00a6a128 */
  uVar1 = uVar6;
  if (uVar2 <= uVar6) {
  ...
  if (plVar7 != param_2 + 2) {
    uVar6 = plVar7[1];
    if (uVar3 == 0) {
                    /* catch() { ... } // from try @ 00a6a1a0 with catch @ 00a6a13c */
      uVar6 = uVar6 & uVar8;
    }
    else {
                    /* try { // try from 00a6a0f8 to 00b6a13b has its CatchHandler @ 00a6a07c */
      if (uVar2 <= uVar6) {
        uVar4 = 0;
        if (uVar2 != 0) {
          uVar4 = uVar6 / uVar2;
    ...
    if (uVar6 == uVar1) goto LAB_00a6a15c;
  }
  if (*param_3 != 0) {
    ...
    if (uVar3 == 0) {
      uVar6 = uVar6 & uVar8;
                    ...
                    /* catch() { ... } // from try @ 00a6a0c0 with catch @ 00a6a128 */
      uVar4 = 0;
      if (uVar2 != 0) {
        uVar4 = uVar6 / uVar2;
      }
  ...
  if (*param_3 != 0) {
    ...
    if (uVar6 != uVar1) {
      *(long **)(*param_2 + uVar6 * 8) = plVar7;
                    ...
                    /* try { // try from 00a6a190 to 00b6a19f has its CatchHandler @ 00a6a28c */
  *plVar7 = *param_3;
  *param_3 = 0;
                    /* try { // try from 00a6a1a0 to 00b6a2a7 has its CatchHandler @ 00a6a13c */
