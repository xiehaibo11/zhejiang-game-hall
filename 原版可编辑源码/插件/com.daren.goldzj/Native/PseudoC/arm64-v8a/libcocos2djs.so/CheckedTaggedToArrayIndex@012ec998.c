...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CheckedTaggedToArrayIndex(v8::internal::compiler::FeedbackSource
   const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::CheckedTaggedToArrayIndex
...

{
  ...
  if ((*(long *)param_1 == 0) || (*(int *)(param_1 + 8) == -1)) {
    pOVar3 = (Operator *)(*(long *)this + 0x1d10);
  }
  else {
    this_00 = *(Zone **)(this + 8);
    ...
    Operator::Operator(pOVar3,0x69,0x38,"CheckedTaggedToArrayIndex",1,1,1,1,1,0);
