...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitStaNamedProperty(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::VisitStaNamedProperty
...

{
  ...
  if ((uVar3 & 1) != 0) {
    ...
    ProcessNamedPropertyAccess(this,lVar6,local_48,uVar2,1);
    return;
  }
                    /* WARNING: Subroutine does not return */
