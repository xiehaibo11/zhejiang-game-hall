...
/* js_renderer_Light_setSpotExpRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Light_setSpotExpRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Light *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x8e8,"js_renderer_Light_setSpotExp");
    __android_log_print(6,"jswrapper","js_renderer_Light_setSpotExp : Invalid Native Object");
  }
  else {
    ...
    if (uVar6 == 0x10) {
      ...
      if ((uVar6 & 1) != 0) {
        cocos2d::renderer::Light::setSpotExp(this,local_64);
        goto LAB_00946a7c;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0x8ef,"js_renderer_Light_setSpotExp");
      __android_log_print(6,"jswrapper","js_renderer_Light_setSpotExp : Error processing arguments")
      ;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 2291): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar6 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Light_setSpotExp",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0x8f6);
LAB_00946a7c:
