...
/* bool 
   spine_Vector_T_ptr_to_seval<spine::TransformConstraint>(spine::Vector<spine::TransformConstraint*>
   const&, se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::TransformConstraint>(Vector *param_1,Value *param_2)
...
LAB_00c897c4:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::TransformConstraint>
