...
ulong FUN_00da3e70(long param_1,ulong param_2,ulong param_3,long param_4,int param_5)

{
  ...
  if ((int)param_3 < param_5) {
    iVar2 = FUN_00da3d1c(param_1,param_2,param_3,param_5);
    if (iVar2 == 0) {
      return 0xffffffff;
    }
  ...
  uVar5 = (ulong)uVar4;
  uVar6 = (ulong)(int)(*(uint *)(&DAT_01950530 + (long)param_5 * 4) &
  ...
  if (*(long *)(param_4 + (long)param_5 * 8) < (long)uVar6) {
    do {
      iVar2 = (int)uVar5;
      if (iVar2 < 1) {
        iVar2 = FUN_00da3d1c(param_1,param_2,uVar5,1);
        if (iVar2 == 0) {
          return 0xffffffff;
        }
        param_2 = *(ulong *)(param_1 + 0x10);
