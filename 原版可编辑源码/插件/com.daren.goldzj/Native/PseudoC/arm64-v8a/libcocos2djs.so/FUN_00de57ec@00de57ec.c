...
undefined4 FUN_00de57ec(undefined4 *param_1,long param_2)

{
  ...
  if ((*(code **)(param_2 + 0x48) != (code *)0x0) &&
    ...
    FUN_00de77ec(param_1,6,"Frame setup failed");
    return *param_1;
  }
  if (*(int *)(param_2 + 0x70) == 0) {
    iVar3 = param_1[0x2da];
    uVar5 = (uint)(byte)(&DAT_0196fa1c)[iVar3];
    if (iVar3 != 2) goto LAB_00de5854;
    iVar3 = 2;
    param_1[0x68] = 0;
  }
  else {
