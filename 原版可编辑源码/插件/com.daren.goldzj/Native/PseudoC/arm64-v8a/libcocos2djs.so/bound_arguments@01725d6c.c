...
/* v8::internal::compiler::JSBoundFunctionRef::bound_arguments() const */

undefined1  [16] __thiscall
v8::internal::compiler::JSBoundFunctionRef::bound_arguments(JSBoundFunctionRef *this)

{
  ...
  if (*(int *)(*(undefined8 **)this + 1) == 2) {
    ...
    uVar7 = uVar7 & 0xffffffff00000000 | (ulong)*(uint *)(uVar7 + 0x13);
    ...
    if (*(short *)(*(long *)(lVar5 + 0x10) + 0x18) != 0x438) {
                    /* WARNING: Subroutine does not return */
      V8_Fatal("Check failed: %s.","IsJSBoundFunction()");
    }
    local_40 = *(long *)(lVar5 + 200);
    puStack_38 = puVar6;
    if (local_40 == 0) {
                    /* WARNING: Subroutine does not return */
  ...
  if (*(int *)(puVar6 + 1) == 2) {
    uVar7 = *(ulong *)*puVar6;
    if ((uVar7 & 1) == 0) goto LAB_01725ea4;
    uVar1 = *(ushort *)((uVar7 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar7 - 1));
  }
  else {
    if (*(int *)(puVar6 + 1) == 0) goto LAB_01725ea4;
