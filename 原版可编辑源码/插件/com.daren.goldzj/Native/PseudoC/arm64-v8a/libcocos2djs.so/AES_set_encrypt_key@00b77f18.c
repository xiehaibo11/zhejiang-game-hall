  ...
  if ((userKey != (uchar *)0x0) && (key != (AES_KEY *)0x0)) {
    ...
    if (bits != 0x80) {
      ...
      if (bits == 0xc0) {
        ...
        while( true ) {
          uVar4 = key->rd_key[5];
          uVar6 = *(uint *)(&DAT_018c0c0c + (ulong)(uVar4 >> 0x10 & 0xff) * 4) & 0xff000000 ^ uVar6
                  ^ *(uint *)(&DAT_018c100c + (ulong)(uVar4 >> 8 & 0xff) * 4) & 0xff0000 ^
                  *(uint *)(&DAT_018c140c + ((ulong)uVar4 & 0xff) * 4) & 0xff00 ^
                  (uint)(byte)(&DAT_018c180c)[(ulong)(uVar4 >> 0x18) * 4] ^
                  *(uint *)((long)&DAT_018c1c0c + lVar8);
          uVar5 = key->rd_key[3];
        ...
        if (bits == 0x100) {
          ...
          while( true ) {
            uVar4 = key->rd_key[7];
            uVar6 = *(uint *)(&DAT_018c0c0c + (ulong)(uVar4 >> 0x10 & 0xff) * 4) & 0xff000000 ^
                    uVar6 ^ *(uint *)(&DAT_018c100c + (ulong)(uVar4 >> 8 & 0xff) * 4) & 0xff0000 ^
                    *(uint *)(&DAT_018c140c + ((ulong)uVar4 & 0xff) * 4) & 0xff00 ^
                    (uint)(byte)(&DAT_018c180c)[(ulong)(uVar4 >> 0x18) * 4] ^
                    *(uint *)((long)&DAT_018c1c0c + lVar8);
            uVar3 = key->rd_key[3];
            ...
            if (lVar8 == 0x18) break;
            uVar5 = *(uint *)(&DAT_018c0c0c + (ulong)(uVar3 >> 0x18) * 4) & 0xff000000 ^
                    key->rd_key[4] ^
                    *(uint *)(&DAT_018c100c + (ulong)(uVar3 >> 0x10 & 0xff) * 4) & 0xff0000 ^
                    *(uint *)(&DAT_018c140c + (ulong)(uVar3 >> 8 & 0xff) * 4) & 0xff00 ^
                    (uint)(byte)(&DAT_018c180c)[(ulong)(uVar3 & 0xff) * 4];
      ...
      do {
        uVar3 = key->rd_key[3];
        uVar6 = *(uint *)(&DAT_018c0c0c + (ulong)(uVar3 >> 0x10 & 0xff) * 4) & 0xff000000 ^ uVar6 ^
                *(uint *)(&DAT_018c100c + (ulong)(uVar3 >> 8 & 0xff) * 4) & 0xff0000 ^
                *(uint *)(&DAT_018c140c + ((ulong)uVar3 & 0xff) * 4) & 0xff00 ^
                (uint)(byte)(&DAT_018c180c)[(ulong)(uVar3 >> 0x18) * 4] ^
                *(uint *)((long)&DAT_018c1c0c + lVar8);
        uVar2 = key->rd_key[2];
        lVar8 = lVar8 + 4;
        uVar5 = key->rd_key[1] ^ uVar6;
