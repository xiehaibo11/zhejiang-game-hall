...
/* js_renderer_Scene_constructorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Scene_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  se::internal::jsToSeArgs(param_1,(vector *)&local_a0);
                    /* try { // try from 0094f744 to 00a4f74f has its CatchHandler @ 009505c8 */
  this = (Object *)
         se::Object::_createJSObject(__jsb_cocos2d_renderer_Scene_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_cocos2d_renderer_Scene_finalizeRegistry);
  se::State::State(aSStack_60,this,(vector *)&local_a0);
  this_00 = operator_new(0x68,(nothrow_t *)&std::nothrow);
  if (this_00 != (Scene *)0x0) {
    cocos2d::renderer::Scene::Scene(this_00);
  }
