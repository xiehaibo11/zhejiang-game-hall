...
/* js_cocos2dx_spine_RegionAttachment_setScaleYRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_RegionAttachment_setScaleYRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (RegionAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x203a,"js_cocos2dx_spine_RegionAttachment_setScaleY");
    pcVar6 = "js_cocos2dx_spine_RegionAttachment_setScaleY : Invalid Native Object";
LAB_00c4cce0:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::RegionAttachment::setScaleY(this,local_64);
        goto LAB_00c4cd18;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x2041,"js_cocos2dx_spine_RegionAttachment_setScaleY");
      pcVar6 = "js_cocos2dx_spine_RegionAttachment_setScaleY : Error processing arguments";
      goto LAB_00c4cce0;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 8261): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_RegionAttachment_setScaleY",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x2048);
LAB_00c4cd18:
