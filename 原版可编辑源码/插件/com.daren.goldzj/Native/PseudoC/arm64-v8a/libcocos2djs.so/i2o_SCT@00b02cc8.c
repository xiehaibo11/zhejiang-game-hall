...

{
  ...
  iVar1 = SCT_is_complete();
                    /* try { // try from 00b02ce8 to 00c02d83 has its CatchHandler @ 00b02e40 */
  if (iVar1 == 0) {
    iVar1 = 0x6a;
    line = 0xce;
LAB_00b02d3c:
    ...
    if (param_2 == (undefined8 *)0x0) goto LAB_00b02d58;
    puVar2 = (undefined1 *)*param_2;
    if (puVar2 == (undefined1 *)0x0) {
                    /* try { // try from 00b02d84 to 00c02e53 has its CatchHandler @ 00b02b74 */
    ...
    *(undefined8 *)(local_28 + 1) = uVar4;
    ...
    local_28[0x2a] = (char)*(undefined8 *)(param_1 + 0xe);
                    /* catch() { ... } // from try @ 00b02ce8 with catch @ 00b02e40 */
    local_28 = puVar2;
    if (*(size_t *)(param_1 + 0xe) != 0) {
      memcpy(puVar2,*(void **)(param_1 + 0xc),*(size_t *)(param_1 + 0xe));
                    /* try { // try from 00b02e54 to 00c02f47 has its CatchHandler @ 00b02e54
                       catch() { ... } // from try @ 00b02e54 with catch @ 00b02e54
                       catch() { ... } // from try @ 00b030b0 with catch @ 00b02e54 */
      local_28 = puVar2 + *(long *)(param_1 + 0xe);
    }
    iVar1 = i2o_SCT_signature(param_1,&local_28);
    puVar2 = local_28;
    if (0 < iVar1) goto LAB_00b02d58;
  }
  CRYPTO_free(puVar2);
  __n = 0xffffffff;
LAB_00b02d58:
