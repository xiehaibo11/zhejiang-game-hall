...
/* void std::__ndk1::vector<v8::internal::Handle<v8::internal::FeedbackVector>,
   std::__ndk1::allocator<v8::internal::Handle<v8::internal::FeedbackVector> >
   >::__emplace_back_slow_path<v8::internal::FeedbackVector&,
   v8::internal::Isolate*>(v8::internal::FeedbackVector&, v8::internal::Isolate*&&) */
...
::__emplace_back_slow_path<v8::internal::FeedbackVector&,v8::internal::Isolate*>
          (vector<v8::internal::Handle<v8::internal::FeedbackVector>,std::__ndk1::allocator<v8::internal::Handle<v8::internal::FeedbackVector>>>
           *this,FeedbackVector *param_1,Isolate **param_2)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00f59df0;
