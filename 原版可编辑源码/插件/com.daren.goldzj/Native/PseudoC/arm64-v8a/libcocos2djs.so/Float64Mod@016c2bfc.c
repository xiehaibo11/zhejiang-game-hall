...
/* v8::internal::compiler::GraphAssembler::Float64Mod(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Float64Mod(GraphAssembler *this,Node *param_1,Node *param_2)

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::Float64Mod
