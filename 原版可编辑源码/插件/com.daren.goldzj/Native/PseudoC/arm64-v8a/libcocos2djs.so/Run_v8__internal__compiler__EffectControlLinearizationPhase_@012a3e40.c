...
/* void 
   v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::EffectControlLinearizationPhase>()
    */
...

{
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFEffectLinearization");
  EffectControlLinearizationPhase::Run(aEStack_18,pPVar5,pZVar2);
