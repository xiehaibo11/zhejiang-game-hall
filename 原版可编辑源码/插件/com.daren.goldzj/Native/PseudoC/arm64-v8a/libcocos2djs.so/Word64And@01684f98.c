...
/* v8::internal::compiler::CodeAssembler::Word64And(v8::internal::SloppyTNode<v8::internal::Word64T>,
   v8::internal::SloppyTNode<v8::internal::Word64T>) */

void __thiscall
v8::internal::compiler::CodeAssembler::Word64And(CodeAssembler *this,Node *param_2,long *param_3)
...
joined_r0x01685030:
    ...
    goto joined_r0x01685030;
  }
  this_00 = (RawMachineAssembler *)**(undefined8 **)this;
  pOVar2 = (Operator *)MachineOperatorBuilder::Word64And((MachineOperatorBuilder *)(this_00 + 0x20))
  ;
  iVar3 = 2;
  local_40 = param_2;
  plStack_38 = param_3;
