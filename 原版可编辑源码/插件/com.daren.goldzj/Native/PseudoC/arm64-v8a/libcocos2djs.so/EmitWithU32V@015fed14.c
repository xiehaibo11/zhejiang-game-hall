...
/* v8::internal::wasm::WasmFunctionBuilder::EmitWithU32V(v8::internal::wasm::WasmOpcode, unsigned
   int) */

void __thiscall
v8::internal::wasm::WasmFunctionBuilder::EmitWithU32V
          (WasmFunctionBuilder *this,undefined1 param_2,uint param_3)

{
  ...
  *puVar3 = param_2;
  ZoneBuffer::write_u32v((ZoneBuffer *)(this + 0x40),param_3);
  return;
}
