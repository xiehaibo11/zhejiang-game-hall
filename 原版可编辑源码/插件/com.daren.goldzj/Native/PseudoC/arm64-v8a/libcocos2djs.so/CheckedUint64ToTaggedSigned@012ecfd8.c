...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CheckedUint64ToTaggedSigned(v8::internal::compiler::FeedbackSource
   const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::CheckedUint64ToTaggedSigned
...

{
  ...
  if ((*(long *)param_1 == 0) || (*(int *)(param_1 + 8) == -1)) {
    pOVar3 = (Operator *)(*(long *)this + 0x1f50);
  }
  else {
    this_00 = *(Zone **)(this + 8);
    ...
    Operator::Operator(pOVar3,100,0x38,"CheckedUint64ToTaggedSigned",1,1,1,1,1,0);
