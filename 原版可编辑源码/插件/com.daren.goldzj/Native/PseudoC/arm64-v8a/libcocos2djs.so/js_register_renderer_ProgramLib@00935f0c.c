...
/* js_register_renderer_ProgramLib(se::Object*) */

undefined8 js_register_renderer_ProgramLib(Object *param_1)

{
  ...
  this = (Class *)se::Class::create(&local_48,param_1,(Object *)0x0,
                                    js_renderer_ProgramLib_constructorRegistry);
  if (((byte)local_48 & 1) != 0) {
    operator_delete(local_38);
  }
  se::Class::defineFunction(this,"define",js_renderer_ProgramLib_defineRegistry);
  se::Class::defineFinalizeFunction(this,js_cocos2d_renderer_ProgramLib_finalizeRegistry);
  se::Class::install(this);
  local_48 = SUB81(this,0);
  uStack_47 = (undefined7)((ulong)this >> 8);
  local_30 = (Class *)0x1879807;
  std::__ndk1::
  ...
  __jsb_cocos2d_renderer_ProgramLib_proto = se::Class::getProto(this);
  __jsb_cocos2d_renderer_ProgramLib_class = this;
