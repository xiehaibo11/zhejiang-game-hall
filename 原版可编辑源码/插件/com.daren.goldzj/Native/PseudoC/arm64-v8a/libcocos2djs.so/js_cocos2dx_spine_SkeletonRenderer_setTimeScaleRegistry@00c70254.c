...
/* js_cocos2dx_spine_SkeletonRenderer_setTimeScaleRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonRenderer_setTimeScaleRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonRenderer *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3252,"js_cocos2dx_spine_SkeletonRenderer_setTimeScale");
    pcVar6 = "js_cocos2dx_spine_SkeletonRenderer_setTimeScale : Invalid Native Object";
LAB_00c703c8:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::SkeletonRenderer::setTimeScale(this,local_64);
        goto LAB_00c70400;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x3259,"js_cocos2dx_spine_SkeletonRenderer_setTimeScale");
      pcVar6 = "js_cocos2dx_spine_SkeletonRenderer_setTimeScale : Error processing arguments";
      goto LAB_00c703c8;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 12893): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
