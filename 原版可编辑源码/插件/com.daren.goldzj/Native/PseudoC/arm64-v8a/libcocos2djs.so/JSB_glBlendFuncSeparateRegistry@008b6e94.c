...
/* JSB_glBlendFuncSeparateRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glBlendFuncSeparateRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if ((plVar8[1] - *plVar8 & 0xffffffff0U) == 0x40) {
    ...
    uVar5 = seval_to_uint32((Value *)(*plVar8 + 0x20),&uStack_7c);
    uVar6 = seval_to_uint32((Value *)(*plVar8 + 0x30),&local_80);
    if ((uVar3 & uVar4 & uVar5 & uVar6 & 1) == 0) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0x2f6,"JSB_glBlendFuncSeparate");
      __android_log_print(6,"jswrapper",&DAT_0190552e);
    }
    else {
      if ((1 < (local_78 - 0x8003 | uStack_74 - 0x8001)) &&
         (1 < (local_78 - 0x8001 | uStack_74 - 0x8003))) {
        glBlendFuncSeparate(uStack_74,local_78,uStack_7c,local_80);
        goto LAB_008b70c4;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                          ,0x2fb,"JSB_glBlendFuncSeparate");
      DAT_01d36f40 = 0x502;
    }
  }
  else {
