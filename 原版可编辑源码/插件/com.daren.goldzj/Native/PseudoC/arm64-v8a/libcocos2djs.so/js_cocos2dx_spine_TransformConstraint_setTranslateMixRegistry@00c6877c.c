...
/* js_cocos2dx_spine_TransformConstraint_setTranslateMixRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_TransformConstraint_setTranslateMixRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TransformConstraint *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2ded,"js_cocos2dx_spine_TransformConstraint_setTranslateMix");
    pcVar6 = "js_cocos2dx_spine_TransformConstraint_setTranslateMix : Invalid Native Object";
LAB_00c688f0:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::TransformConstraint::setTranslateMix(this,local_64);
        goto LAB_00c68928;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x2df4,"js_cocos2dx_spine_TransformConstraint_setTranslateMix");
      pcVar6 = "js_cocos2dx_spine_TransformConstraint_setTranslateMix : Error processing arguments";
      goto LAB_00c688f0;
    }
    __android_log_print(6,"jswrapper",&DAT_0191959d,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TransformConstraint_setTranslateMix",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x2dfb);
LAB_00c68928:
