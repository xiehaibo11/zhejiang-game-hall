...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00a07770 to 00b077db has its CatchHandler @ 00a07770
                       catch() { ... } // from try @ 00a07770 with catch @ 00a07770
                       catch() { ... } // from try @ 00a078ec with catch @ 00a07770
                       catch() { ... } // from try @ 00a0799c with catch @ 00a07770
                       catch() { ... } // from try @ 00a07a70 with catch @ 00a07770
                       catch() { ... } // from try @ 00a07a7c with catch @ 00a07770 */
  lVar4 = tpidr_el0;
  ...
  *(undefined8 *)(pPVar5 + 0x10) = 0;
  core::Provided::Provided(pPVar5);
                    /* try { // try from 00a077dc to 00b077e3 has its CatchHandler @ 00a07a84 */
  *(undefined ***)pPVar5 = &PTR__DownloadTask_01c6c9e8;
  ...
  *(undefined8 *)this_01 = 0;
                    /* try { // try from 00a07800 to 00b07843 has its CatchHandler @ 00a07aa8 */
  *(undefined8 *)(pPVar5 + 0xd0) = 0;
  *(undefined8 *)(pPVar5 + 0xd8) = 0;
  *(undefined8 *)(pPVar5 + 0x110) = 0;
  ...
  if ((basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
    ...
    assign((basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
           (pPVar5 + 0x38),(char *)pbVar2,uVar1);
                    ...
                    /* try { // try from 00a07884 to 00b0788b has its CatchHandler @ 00a07aa4 */
  ...
  *(Downloader *)(pPVar5 + 0xc0) = this[0xa0];
  if (this + 0xa8 != (Downloader *)this_01) {
                    /* try { // try from 00a078e4 to 00b078eb has its CatchHandler @ 00a07aa0 */
    uVar1 = *(ulong *)(this + 0xb0);
    pDVar3 = *(Downloader **)(this + 0xb8);
                    /* try { // try from 00a078ec to 00b07937 has its CatchHandler @ 00a07770 */
  ...
  *(undefined4 *)(pPVar5 + 0x18) = *(undefined4 *)(this + 0xc0);
  ...
  pPVar5 = local_70;
                    /* try { // try from 00a07938 to 00b07943 has its CatchHandler @ 00a07a88 */
  local_70 = (Provided *)0x0;
  if (pPVar5 != (Provided *)0x0) {
    (**(code **)(*(long *)pPVar5 + 8))();
  }
                    /* try { // try from 00a07958 to 00b0799b has its CatchHandler @ 00a07aa8 */
