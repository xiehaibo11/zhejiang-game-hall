...
/* v8::internal::HashTable<v8::internal::StringTable,
   v8::internal::StringTableShape>::Rehash(v8::internal::ReadOnlyRoots) */

void __thiscall
v8::internal::HashTable<v8::internal::StringTable,v8::internal::StringTableShape>::Rehash
...

{
  ...
  do {
    if (uVar2 == 0) goto LAB_010f5bf4;
    uVar9 = 0;
    bVar17 = true;
    do {
      while( true ) {
        uVar7 = *(ulong *)this;
        uVar6 = *(uint *)(uVar7 + (long)((int)uVar9 * 4 + 0xc) + 7);
        if ((uVar6 != *(uint *)(param_2 + 0x28)) && (uVar6 != *(uint *)(param_2 + 0x20))) break;
LAB_010f5a34:
        uVar9 = uVar9 + 1;
        if (uVar15 <= uVar9) goto LAB_010f5a14;
      }
      uVar10 = uVar7 & 0xffffffff00000000 | (ulong)uVar6;
      uVar6 = *(uint *)(uVar10 + 3);
      if ((uVar6 & 1) == 0) {
        uVar6 = uVar6 >> 3;
      }
      ...
      if (1 < uVar16) {
        iVar12 = 0;
        do {
          if (uVar10 == uVar9) goto LAB_010f5a34;
          iVar1 = (int)uVar10 + iVar12;
          iVar12 = iVar12 + 1;
          uVar10 = (ulong)(iVar1 + 1U & uVar5);
        } while (iVar14 != iVar12);
      }
      if (uVar9 == uVar10) goto LAB_010f5a34;
      uVar6 = *(uint *)(uVar7 + (long)((int)uVar10 * 4 + 0xc) + 7);
      if ((uVar6 != *(uint *)(param_2 + 0x28)) && (uVar6 != *(uint *)(param_2 + 0x20))) {
        ...
        if (1 < uVar16) {
          iVar12 = 0;
          do {
            if (uVar7 == uVar10) goto LAB_010f5a30;
