...
/* v8::internal::compiler::InstructionSelector::VisitTrapIf(v8::internal::compiler::Node*,
   v8::internal::compiler::TrapId) */

void __thiscall
v8::internal::compiler::InstructionSelector::VisitTrapIf
