...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::InstructionSelectionPhase,
   v8::internal::compiler::Linkage*&>(v8::internal::compiler::Linkage*&) */

void __thiscall
v8::internal::compiler::PipelineImpl::
Run<v8::internal::compiler::InstructionSelectionPhase,v8::internal::compiler::Linkage*&>
          (PipelineImpl *this,Linkage **param_1)

{
  ...
  long lVar3;
  PipelineData *pPVar4;
  InstructionSelectionPhase aIStack_90 [8];
  ...
  if (local_88 != (PipelineStatistics *)0x0) {
    PipelineStatistics::BeginPhase(local_88,"V8.TFSelectInstructions");
  }
  local_78 = *(ZoneStats **)(lVar3 + 0x30);
  local_80 = "V8.TFSelectInstructions";
  local_68 = *(long *)(lVar3 + 0xb0);
  local_70 = (Zone *)0x0;
  if (local_68 != 0) {
    local_60 = *(undefined8 *)(local_68 + 0x30);
    *(char **)(local_68 + 0x30) = "V8.TFSelectInstructions";
  }
  ...
  if ((pRVar1 == (RuntimeCallStats *)0x0) || (TracingFlags::runtime_stats == 0)) {
    ...
    pPVar4 = *(PipelineData **)this;
    if (local_70 != (Zone *)0x0) goto LAB_012a967c;
  }
  local_70 = (Zone *)ZoneStats::NewEmptyZone(local_78,local_80);
LAB_012a967c:
  InstructionSelectionPhase::Run(aIStack_90,pPVar4,local_70,*param_1);
