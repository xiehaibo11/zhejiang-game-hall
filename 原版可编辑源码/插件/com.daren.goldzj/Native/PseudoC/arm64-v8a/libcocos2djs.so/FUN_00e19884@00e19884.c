...
undefined8 FUN_00e19884(long param_1,char *param_2,long param_3,long param_4)
      ...
      if (puVar5 == puVar3) {
        ...
        if (((pcVar4 != (code *)0x0) &&
            ...
            puVar3 != (undefined8 *)0x0)) && ((code *)*puVar3 != (code *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x00e19940. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          uVar2 = (*(code *)*puVar3)(*puVar5,param_3,param_4,1);
          return uVar2;
        }
        uVar2 = 7;
      }
