...
/* js_cocos2dx_spine_SkeletonData_setHeightRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_SkeletonData_setHeightRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x28d0,"js_cocos2dx_spine_SkeletonData_setHeight");
    pcVar6 = "js_cocos2dx_spine_SkeletonData_setHeight : Invalid Native Object";
LAB_00c5ec3c:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::SkeletonData::setHeight(this,local_64);
        goto LAB_00c5ec74;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x28d7,"js_cocos2dx_spine_SkeletonData_setHeight");
      pcVar6 = "js_cocos2dx_spine_SkeletonData_setHeight : Error processing arguments";
      goto LAB_00c5ec3c;
    }
    __android_log_print(6,"jswrapper",&DAT_01914ab6,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonData_setHeight",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x28de);
LAB_00c5ec74:
