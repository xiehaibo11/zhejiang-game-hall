...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<void const*,
   ...
   std::__ndk1::weak_ptr<v8::internal::BackingStore> > > >::__rehash(unsigned long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<void_const*,std::__ndk1::weak_ptr<v8::internal::BackingStore>>,std::__ndk1::__unordered_map_hasher<void_const*,std::__ndk1::__hash_value_type<void_const*,std::__ndk1::weak_ptr<v8::internal::BackingStore>>,std::__ndk1::hash<void_const*>,true>,std::__ndk1::__unordered_map_equal<void_const*,std::__ndk1::__hash_value_type<void_const*,std::__ndk1::weak_ptr<v8::internal::BackingStore>>,std::__ndk1::equal_to<void_const*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<void_const*,std::__ndk1::weak_ptr<v8::internal::BackingStore>>>>
           *this,ulong param_1)
