...
/* void std::__ndk1::vector<v8::internal::FuncNameInferrer::Name,
   std::__ndk1::allocator<v8::internal::FuncNameInferrer::Name>
   >::__push_back_slow_path<v8::internal::FuncNameInferrer::Name>(v8::internal::FuncNameInferrer::Name&&)
    */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_0152b5b0;
