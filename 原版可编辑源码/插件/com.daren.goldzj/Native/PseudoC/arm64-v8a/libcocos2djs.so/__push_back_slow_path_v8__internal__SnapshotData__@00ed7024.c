...
/* void std::__ndk1::vector<v8::internal::SnapshotData*,
   std::__ndk1::allocator<v8::internal::SnapshotData*>
   >::__push_back_slow_path<v8::internal::SnapshotData*>(v8::internal::SnapshotData*&&) */

void __thiscall
std::__ndk1::vector<v8::internal::SnapshotData*,std::__ndk1::allocator<v8::internal::SnapshotData*>>
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00ed710c;
