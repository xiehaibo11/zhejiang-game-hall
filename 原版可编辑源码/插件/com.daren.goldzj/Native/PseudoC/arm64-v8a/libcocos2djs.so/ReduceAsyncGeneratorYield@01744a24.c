...
/* v8::internal::compiler::JSIntrinsicLowering::ReduceAsyncGeneratorYield(v8::internal::compiler::Node*)
    */

Node * __thiscall
v8::internal::compiler::JSIntrinsicLowering::ReduceAsyncGeneratorYield
...

{
  ...
  Builtins::CallableFor((Builtins *)local_58,*(undefined8 *)(*(long *)(this + 0x10) + 0x168),0x262);
