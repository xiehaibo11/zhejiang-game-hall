...

{
  ...
  ulong uVar12;
                    ...
                    /* try { // try from 00abccf4 to 00bbcd13 has its CatchHandler @ 00abcc24 */
  uVar5 = param_4 + 1;
                    /* try { // try from 00abcd14 to 00bbcd1b has its CatchHandler @ 00abcd84 */
                    /* try { // try from 00abcd1c to 00bbcd3b has its CatchHandler @ 00abcc24 */
  if ((*(byte *)(*(long *)(*(long *)(param_1 + 8) + 0xc0) + 0x68) & 1) == 0) {
    ...
    lVar6 = *(long *)(param_2 + 0x18);
                    ...
                    /* try { // try from 00abcd3c to 00bbcd47 has its CatchHandler @ 00abcd84 */
  ...
  cipher = EVP_CIPHER_CTX_cipher(*(EVP_CIPHER_CTX **)(param_1 + 0x118));
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00abccec with catch @ 00abcd84
                       catch(type#1 @ 00000000) { ... } // from try @ 00abcd14 with catch @ 00abcd84
                       catch(type#1 @ 00000000) { ... } // from try @ 00abcd3c with catch @ 00abcd84
                        */
  uVar3 = EVP_CIPHER_flags(cipher);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00abcc8c with catch @ 00abcd88
                       catch(type#1 @ 00000000) { ... } // from try @ 00abccb8 with catch @ 00abcd88
                        */
  uVar4 = *puVar15;
  uVar16 = (uint)bVar1;
    ...
    if (uVar8 == 1) {
      ...
      if (uVar9 == 0) {
        ...
        if ((uVar10 < uVar10 - (int)(uVar3 - 1)) || (uVar3 - 1 >> 0x20 != 0)) {
          ...
          uVar5 = uVar14 & uVar5;
          if ((uVar8 & 1) == 0) goto LAB_00abced4;
        }
      }
    }
    iVar7 = -iVar7;
...
LAB_00abced4:
  uVar5 = (int)(0xfe - (uVar5 & 0xff)) >> 0x1f;
                    /* try { // try from 00abcef4 to 00bbcf0b has its CatchHandler @ 00abcef4
                       catch() { ... } // from try @ 00abcef4 with catch @ 00abcef4
                       catch() { ... } // from try @ 00abcf10 with catch @ 00abcef4 */
