...
/* v8::internal::compiler::JSHeapBroker::ProcessFeedbackForTemplateObject(v8::internal::compiler::FeedbackSource
   const&) */

undefined8 __thiscall
v8::internal::compiler::JSHeapBroker::ProcessFeedbackForTemplateObject
...

{
  ...
  *this_00;
  ...
  if (lVar2 == 0) {
    uVar3 = ReadFeedbackForTemplateObject(this,param_1);
