...
/* bool v8::internal::DateParser::Parse<unsigned short const>(v8::internal::Isolate*,
   v8::internal::Vector<unsigned short const>, double*) */

bool __thiscall
v8::internal::DateParser::Parse<unsigned_short_const>
          (DateParser *this,ushort *param_1,undefined8 param_3,double *param_4)

{
  ...
  local_80 = param_1;
  uStack_78 = param_3;
  local_98 = DateStringTokenizer<unsigned_short_const>::Scan
                       ((DateStringTokenizer<unsigned_short_const> *)&local_a0);
  local_b8 = 0x7fffffff00000000;
  local_b0 = 0x7fffffff7fffffff;
  local_a8 = 0x7fffffff;
  local_d4 = 0x7fffffff00000000;
  local_cc = 0;
  iVar7 = ParseES5DateTime<unsigned_short_const>
...
LAB_014c34dc:
    ...
    if (local_98._0_4_ == -2) {
      if ((local_98._8_4_ & 0xff) == 0x2e) {
        auVar16 = DateStringTokenizer<unsigned_short_const>::Scan
                            ((DateStringTokenizer<unsigned_short_const> *)&local_a0);
        ...
        if ((int)local_b8 == 3) {
          if (uVar11 < 1000) goto LAB_014c3700;
        }
...
LAB_014c3700:
      ...
      auVar17 = DateStringTokenizer<unsigned_short_const>::Scan
                          ((DateStringTokenizer<unsigned_short_const> *)&local_a0);
      local_98 = auVar17;
      if ((auVar17._0_4_ != -2) || ((auVar17._8_4_ & 0xff) != 0x3a)) {
        lVar10 = (long)(int)local_b8;
        if (3 < (int)local_b8) goto LAB_014c37f8;
        local_b8 = CONCAT44(local_b8._4_4_,(int)local_b8 + 1);
        local_c8[lVar10] = uVar11;
        uVar11 = local_a8;
        if ((auVar17._0_4_ != -2) || ((auVar17._8_4_ & 0xff) != 0x2e)) goto LAB_014c3780;
LAB_014c36cc:
        auVar17 = DateStringTokenizer<unsigned_short_const>::Scan
                            ((DateStringTokenizer<unsigned_short_const> *)&local_a0);
        uVar11 = local_a8;
...
LAB_014c358c:
      ...
      uVar13 = local_b8 & 0xffffffff;
      if ((int)local_b8 == 3) {
        if (999 < uVar11) goto LAB_014c3664;
      }
...
LAB_014c3664:
        if ((int)local_d4 < 3) {
          *(uint *)(aDStack_e0 + (long)(int)local_d4 * 4) = uVar11;
          ...
          uVar11 = local_a8;
          if (((int)pDVar14 != -2) || (local_98[8] != '-')) goto LAB_014c3780;
          goto LAB_014c36cc;
        }
        goto LAB_014c37f8;
      }
...
LAB_014c3780:
          ...
          bVar4 = true;
          auVar17 = local_98;
switchD_014c3620_caseD_fffffffc:
          do {
            while( true ) {
              bVar5 = bVar4;
              ...
              local_98 = auVar17;
              auVar18 = DateStringTokenizer<unsigned_short_const>::Scan
                                  ((DateStringTokenizer<unsigned_short_const> *)&local_a0);
              iVar7 = auVar17._0_4_;
              local_98 = auVar18;
              if (iVar7 == -3) goto LAB_014c34dc;
LAB_014c37a8:
              iVar12 = local_98._8_4_;
              if (iVar7 == -1) {
                uVar13 = DayComposer::Write(aDStack_e0,param_4);
                if ((uVar13 & 1) == 0) goto LAB_014c37f8;
                ...
                goto switchD_014c3620_caseD_fffffffd;
              }
              bVar4 = bVar5;
              auVar17 = local_98;
              if (iVar7 < 0) break;
...
LAB_014c33f8:
          ...
          if ((uVar11 == 0x2d) || (uVar11 == 0x2b)) {
            if ((local_a8 == 0 && local_b0._4_4_ == 0) || ((int)local_b8 != 0)) goto LAB_014c3428;
            if ((uVar11 == 0x2b) || (uVar11 == 0x2d)) {
              bVar6 = 0;
              bVar4 = false;
              if (bVar5) goto switchD_014c3620_caseD_fffffffd;
              goto switchD_014c3620_caseD_fffffffc;
            }
          }
      ...
      case -2:
        bVar15 = 1;
        if (iVar12 == 0x2b) goto LAB_014c3780;
        bVar4 = true;
        if (iVar12 == 0x2d) goto switchD_014c3620_caseD_fffffffc;
      }
    }
LAB_014c37f8:
    bVar6 = 0;
  }
switchD_014c3620_caseD_fffffffd:
...
LAB_014c3428:
  ...
  if ((iVar8 == -2) && ((local_98._8_4_ & 0xff) == 0x3a)) {
    ...
    if (1 < iVar7 - 3U) goto LAB_014c37f8;
    iVar7 = iVar12 / 100;
    local_a8 = iVar12 % 100;
LAB_014c33ac:
