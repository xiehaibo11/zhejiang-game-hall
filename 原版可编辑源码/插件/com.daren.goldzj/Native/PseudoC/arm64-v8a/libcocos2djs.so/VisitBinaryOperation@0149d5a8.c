...
/* v8::internal::CallPrinter::VisitBinaryOperation(v8::internal::BinaryOperation*) */

void __thiscall
v8::internal::CallPrinter::VisitBinaryOperation(CallPrinter *this,BinaryOperation *param_1)
