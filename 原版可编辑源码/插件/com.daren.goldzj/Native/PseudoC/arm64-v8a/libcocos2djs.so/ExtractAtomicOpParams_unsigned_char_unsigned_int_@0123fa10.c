...
/* bool v8::internal::wasm::ThreadImpl::ExtractAtomicOpParams<unsigned char, unsigned
   int>(v8::internal::wasm::Decoder*, v8::internal::wasm::InterpreterCode*, unsigned long*, unsigned
   long, int*, unsigned char*, unsigned char*) */

bool __thiscall
v8::internal::wasm::ThreadImpl::ExtractAtomicOpParams<unsigned_char,unsigned_int>
          (ThreadImpl *this,Decoder *param_1,InterpreterCode *param_2,ulong *param_3,ulong param_4,
          int *param_5,uchar *param_6,uchar *param_7)
  ...
  *(long *)(this + 0x28) = lVar4 + -0x11;
  ...
  if (CARRY4(local_97,uVar2)) {
    *param_3 = 0;
    ...
    uVar5 = 0;
    if ((*(long *)(lVar4 + 0x13) != 0) &&
       ((ulong)(local_97 + uVar2) <= *(long *)(lVar4 + 0x13) - 1U)) {
