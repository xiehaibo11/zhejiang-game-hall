...
/* void std::__ndk1::vector<v8::internal::JsonParser<unsigned short>::JsonContinuation,
   std::__ndk1::allocator<v8::internal::JsonParser<unsigned short>::JsonContinuation>
   >::__emplace_back_slow_path<v8::internal::JsonParser<unsigned
   short>::JsonContinuation>(v8::internal::JsonParser<unsigned short>::JsonContinuation&&) */
...

{
  ...
  if (uVar1 < 0x666666666666667) {
    ...
    if (uVar1 == 0) {
      ...
      if (0x666666666666666 < uVar1) goto LAB_0104b098;
