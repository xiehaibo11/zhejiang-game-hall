...
undefined8 FUN_00bcdf0c(undefined8 param_1,undefined8 *param_2,BIO *param_3,uint param_4)

{
  ...
  iVar1 = BIO_printf(param_3,"%*sIssuer: ",(ulong)param_4,&DAT_0189703a);
  if ((iVar1 < 1) ||
...
LAB_00bce028:
    ...
    if (0 < iVar1) {
      ...
      do {
        ...
        iVar2 = BIO_printf(param_3,"\n%*s",(ulong)(param_4 << 1),&DAT_0189703a);
