...
/* js_cocos2dx_dragonbones_RectangleBoundingBoxData_constructorRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_RectangleBoundingBoxData_constructorRegistry
...

{
  ...
  this = (Object *)
         se::Object::_createJSObject
                   (__jsb_dragonBones_RectangleBoundingBoxData_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_dragonBones_RectangleBoundingBoxData_finalizeRegistry);
  se::State::State(aSStack_60,this,(vector *)&local_a0);
  this_00 = operator_new(0x20,(nothrow_t *)&std::nothrow);
  if (this_00 != (BaseObject *)0x0) {
    dragonBones::BaseObject::BaseObject(this_00);
    *(undefined ***)this_00 = &PTR__RectangleBoundingBoxData_01c90d48;
    dragonBones::RectangleBoundingBoxData::_onClear((RectangleBoundingBoxData *)this_00);
  }
