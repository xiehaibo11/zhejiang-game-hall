...
/* void std::__ndk1::vector<cocos2d::renderer::UnitNode*,
   std::__ndk1::allocator<cocos2d::renderer::UnitNode*>
   >::__push_back_slow_path<cocos2d::renderer::UnitNode* const&>(cocos2d::renderer::UnitNode*
   const&) */

void __thiscall
std::__ndk1::
vector<cocos2d::renderer::UnitNode*,std::__ndk1::allocator<cocos2d::renderer::UnitNode*>>::
__push_back_slow_path<cocos2d::renderer::UnitNode*const&>
          (vector<cocos2d::renderer::UnitNode*,std::__ndk1::allocator<cocos2d::renderer::UnitNode*>>
           *this,UnitNode **param_1)
