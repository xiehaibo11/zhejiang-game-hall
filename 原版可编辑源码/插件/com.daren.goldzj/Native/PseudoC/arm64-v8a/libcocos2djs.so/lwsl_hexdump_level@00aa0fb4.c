...

{
  ...
  if ((DAT_01d1b790 & param_1) != 0) {
    _lws_log(param_1,&DAT_018938a8);
    if (param_3 != 0) {
      uVar10 = 0;
      do {
...
LAB_00aa13d4:
          ...
          if (param_3 <= uVar12) goto LAB_00aa1624;
LAB_00aa13f4:
          ...
          *pbVar5 = bVar2;
          ...
          if ((~uVar6 & 1) != 0) goto LAB_00aa13d4;
          pbVar7 = pbVar7 + (ulong)uVar6 * 3;
          if (uVar12 < param_3) goto LAB_00aa13f4;
LAB_00aa1624:
          lVar8 = 0xf;
LAB_00aa1628:
