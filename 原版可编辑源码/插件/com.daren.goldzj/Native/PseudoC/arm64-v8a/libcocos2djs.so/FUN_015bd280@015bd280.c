...
undefined8 FUN_015bd280(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_630,(ulong)&local_630 | 8,0x28d);
  }
  if (DAT_01d47848 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d47848 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d47848;
  local_650 = (byte **)0x0;
  if ((*DAT_01d47848 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar3,"V8.Runtime_Runtime_WasmTableCopy",0,0,0,0,0,0,0,
                       &local_608,0);
    plVar4 = local_600;
    local_600 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    local_650 = &local_648;
    local_640 = "V8.Runtime_Runtime_WasmTableCopy";
    local_648 = pbVar3;
    local_638 = uVar5;
  }
  ...
  *(ulong *)(param_3 + 0x2bc8) = uVar6 & 0xffffffff00000000 | (ulong)*(uint *)(uVar6 + 0x77);
  ...
  if (*(CanonicalHandleScope **)(param_3 + 0x95b8) == (CanonicalHandleScope *)0x0) {
    ...
    *puVar7 = uVar6;
    uVar6 = *param_2;
    if ((uVar6 & 1) != 0) goto LAB_015bd470;
LAB_015bd430:
    if ((int)(uint)uVar6 < 0) {
LAB_015bd7a4:
    ...
    uVar6 = param_2[-1];
    if ((uVar6 & 1) == 0) goto LAB_015bd4cc;
LAB_015bd4e0:
    ...
    if (*(short *)(uVar11 + *(uint *)(uVar6 - 1)) != 0x42) goto LAB_015bd7b8;
    dVar13 = *(double *)(uVar6 + 3) + 4503599627370496.0;
    if (((ulong)dVar13 >> 0x20 != 0x43300000) ||
       (*(double *)(uVar6 + 3) != (double)((ulong)dVar13 & 0xffffffff))) goto LAB_015bd7b8;
    uVar6 = param_2[-2];
    if ((uVar6 & 1) == 0) goto LAB_015bd53c;
LAB_015bd550:
    uVar11 = uVar6 & 0xffffffff00000000 | 7;
    if (*(short *)(uVar11 + *(uint *)(uVar6 - 1)) != 0x42) {
                    /* WARNING: Subroutine does not return */
...
LAB_015bd7cc:
    ...
    if (((ulong)dVar10 >> 0x20 != 0x43300000) ||
       (*(double *)(uVar6 + 3) != (double)((ulong)dVar10 & 0xffffffff))) goto LAB_015bd7cc;
    uVar6 = param_2[-3];
    if ((uVar6 & 1) == 0) goto LAB_015bd5ac;
LAB_015bd5c0:
    uVar11 = uVar6 & 0xffffffff00000000 | 7;
    if (*(short *)(uVar11 + *(uint *)(uVar6 - 1)) != 0x42) {
                    /* WARNING: Subroutine does not return */
    ...
    if (*(short *)(uVar11 + *(uint *)(uVar6 - 1)) != 0x42) goto LAB_015bd7e0;
    dVar14 = *(double *)(uVar6 + 3) + 4503599627370496.0;
    if (((ulong)dVar14 >> 0x20 != 0x43300000) ||
       (*(double *)(uVar6 + 3) != (double)((ulong)dVar14 & 0xffffffff))) goto LAB_015bd7e0;
    uVar6 = param_2[-4];
  }
  else {
    ...
    uVar6 = *param_2;
    if ((uVar6 & 1) == 0) goto LAB_015bd430;
LAB_015bd470:
    uVar11 = uVar6 & 0xffffffff00000000 | 7;
    if (*(short *)(uVar11 + *(uint *)(uVar6 - 1)) != 0x42) {
                    /* WARNING: Subroutine does not return */
    ...
    if (*(short *)(uVar11 + *(uint *)(uVar6 - 1)) != 0x42) goto LAB_015bd7a4;
    dVar9 = *(double *)(uVar6 + 3) + 4503599627370496.0;
    if (((ulong)dVar9 >> 0x20 != 0x43300000) ||
       (*(double *)(uVar6 + 3) != (double)((ulong)dVar9 & 0xffffffff))) goto LAB_015bd7a4;
    uVar6 = param_2[-1];
    if ((uVar6 & 1) != 0) goto LAB_015bd4e0;
LAB_015bd4cc:
    if ((int)(uint)uVar6 < 0) {
LAB_015bd7b8:
                    /* WARNING: Subroutine does not return */
      V8_Fatal("Check failed: %s.","args[1].ToUint32(&table_src_index)",dVar9);
    }
    dVar13 = (double)(ulong)((uint)uVar6 >> 1);
    uVar6 = param_2[-2];
    if ((uVar6 & 1) != 0) goto LAB_015bd550;
LAB_015bd53c:
    if ((int)(uint)uVar6 < 0) goto LAB_015bd7cc;
    dVar10 = (double)(ulong)((uint)uVar6 >> 1);
    uVar6 = param_2[-3];
    if ((uVar6 & 1) != 0) goto LAB_015bd5c0;
LAB_015bd5ac:
    if ((int)(uint)uVar6 < 0) {
LAB_015bd7e0:
                    /* WARNING: Subroutine does not return */
  ...
  if ((uVar6 & 1) == 0) {
    if (-1 < (int)uVar6) {
LAB_015bd67c:
      uVar6 = v8::internal::WasmInstanceObject::CopyTableEntries(param_3,puVar7);
      if ((uVar6 & 1) == 0) {
    ...
    if (*(short *)(uVar11 + *(uint *)(uVar6 - 1)) == 0x42) {
      ...
      if (((ulong)dVar15 >> 0x20 == 0x43300000) &&
         (*(double *)(uVar6 + 3) == (double)((ulong)dVar15 & 0xffffffff))) goto LAB_015bd67c;
    }
  }
                    /* WARNING: Subroutine does not return */
