...
/* js_universe_MergeFile_constructorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_universe_MergeFile_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Object *)
         se::Object::_createJSObject(__jsb_universe_MergeFile_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_universe_MergeFile_finalizeRegistry);
  se::State::State(aSStack_60,this,(vector *)&local_a0);
  this_00 = operator_new(0x60,(nothrow_t *)&std::nothrow);
  if (this_00 != (MergeFile *)0x0) {
    universe::MergeFile::MergeFile(this_00);
  }
