...
/* void std::__ndk1::vector<v8::internal::OptimizedCompilationInfo::InlinedFunctionHolder,
   std::__ndk1::allocator<v8::internal::OptimizedCompilationInfo::InlinedFunctionHolder>
   >::__push_back_slow_path<v8::internal::OptimizedCompilationInfo::InlinedFunctionHolder>(v8::internal::OptimizedCompilationInfo::InlinedFunctionHolder&&)
    */
...
::__push_back_slow_path<v8::internal::OptimizedCompilationInfo::InlinedFunctionHolder>
          (vector<v8::internal::OptimizedCompilationInfo::InlinedFunctionHolder,std::__ndk1::allocator<v8::internal::OptimizedCompilationInfo::InlinedFunctionHolder>>
           *this,InlinedFunctionHolder *param_1)

{
  ...
  if (uVar1 >> 0x3b == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3b != 0) goto LAB_00ef2d24;
