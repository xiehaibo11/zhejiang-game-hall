...
void FUN_01451140(ulong param_1)

{
  ...
  *(int *)(unaff_x29 + -0x20) = ((int)unaff_x19 + -1) * 2;
  iVar7 = (int)*(short *)(unaff_x20 + unaff_x19 + 3);
  uVar8 = (ulong)*(ushort *)(unaff_x20 + unaff_x19 + 5);
  uVar4 = *(undefined8 *)(unaff_x29 + (long)*(short *)(unaff_x20 + unaff_x19 + 1) * 8);
  uVar6 = unaff_x26 +
  ...
  lVar5 = unaff_x29;
  if ((int)uVar6 == (int)uVar3) goto LAB_014511f8;
  lVar9 = (ulong)*(ushort *)(unaff_x20 + unaff_x19 + 7) * 4;
  lVar1 = lVar9 + 0x23;
  lVar9 = lVar9 + 0x1f;
  *(int *)(uVar6 + lVar1) = (int)unaff_x26 + *(int *)(uVar6 + lVar1) + 4;
  uVar11 = (int)unaff_x26 + *(int *)(uVar6 + lVar9);
  if (((uVar11 & 0xfffffffd) == (uint)param_1) ||
     (uVar13 = (uint)*(undefined8 *)(unaff_x26 + 0xb88), uVar11 == uVar13)) goto LAB_014511f8;
  if ((uVar11 & 3) == 3) {
    if (uVar11 == 3) goto LAB_01451278;
  }
...
LAB_014511f8:
  FUN_01347660(uVar8,uVar4,uVar3,param_1,lVar5 + (long)iVar7 * 8);
                    /* WARNING: Could not recover jumptable at 0x01451244. Too many branches */
