...
/* js_cocos2dx_spine_SkeletonRenderer_setBatchEnabledRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonRenderer_setBatchEnabledRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonRenderer *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3543,"js_cocos2dx_spine_SkeletonRenderer_setBatchEnabled");
    pcVar6 = "js_cocos2dx_spine_SkeletonRenderer_setBatchEnabled : Invalid Native Object";
LAB_00c75314:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::SkeletonRenderer::setBatchEnabled(this,local_64[0]);
        goto LAB_00c7534c;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x354a,"js_cocos2dx_spine_SkeletonRenderer_setBatchEnabled");
      pcVar6 = "js_cocos2dx_spine_SkeletonRenderer_setBatchEnabled : Error processing arguments";
      goto LAB_00c75314;
    }
    __android_log_print(6,"jswrapper",&DAT_0191f948,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonRenderer_setBatchEnabled",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x3551);
LAB_00c7534c:
