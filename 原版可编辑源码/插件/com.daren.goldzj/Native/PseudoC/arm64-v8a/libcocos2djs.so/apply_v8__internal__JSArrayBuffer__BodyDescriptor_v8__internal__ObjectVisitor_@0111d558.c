...
/* void v8::internal::CallIterateBody::apply<v8::internal::JSArrayBuffer::BodyDescriptor,
...
void v8::internal::CallIterateBody::
     apply<v8::internal::JSArrayBuffer::BodyDescriptor,v8::internal::ObjectVisitor>
...

{
  ...
  if (iVar1 < (int)lVar2) {
    lVar4 = (long)iVar1;
    (**(code **)(*param_4 + 0x10))(param_4,param_2,param_2 + 0x1f,lVar3 + lVar4);
    do {
    ...
    lVar2 = 0x20;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0111d64c. Too many branches */
