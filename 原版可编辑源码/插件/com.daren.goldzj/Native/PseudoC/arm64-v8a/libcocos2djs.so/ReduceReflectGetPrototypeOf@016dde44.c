...
/* v8::internal::compiler::JSCallReducer::ReduceReflectGetPrototypeOf(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::JSCallReducer::ReduceReflectGetPrototypeOf
