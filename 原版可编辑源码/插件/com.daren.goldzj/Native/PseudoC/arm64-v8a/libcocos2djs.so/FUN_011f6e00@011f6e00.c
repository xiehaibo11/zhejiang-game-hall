...
undefined8
FUN_011f6e00(long param_1,uint param_2,long param_3,uint param_4,uint param_5,int *param_6,
            undefined1 *param_7)
...
LAB_011f6e9c:
          ...
          if ((uVar10 & 3) == 0) {
            ...
            if ((uVar10 & 3) == 1) {
              ...
              if (iVar4 != -1) {
                *param_6 = iVar7 + iVar4;
                iVar4 = *(int *)(param_3 + ((long)((ulong)uVar10 << 0x20) >> 0x22) * 8 + 4);
                if (iVar4 == -1) {
                  return 1;
                }
                param_6[1] = iVar7 + iVar4;
                return 2;
              }
              return 0;
            }
