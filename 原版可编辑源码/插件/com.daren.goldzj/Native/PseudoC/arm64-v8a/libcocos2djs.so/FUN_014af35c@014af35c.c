...
undefined8 FUN_014af35c(int param_1,long param_2,Isolate *param_3)

{
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if ((pIVar6 != (Isolate *)0x0) &&
    ...
    pIVar4 = (Isolate *)v8::internal::BigInt::AsUintN(param_3,(long)dVar8,lVar3);
    if (pIVar4 != (Isolate *)0x0) goto LAB_014af420;
  }
