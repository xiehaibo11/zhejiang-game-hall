...
void FUN_01462e50(long param_1,undefined8 param_2,undefined8 param_3,long param_4,ulong param_5,
...
LAB_01462f50:
    ...
    if (sVar3 != 0x43) goto LAB_01462f50;
    if ((param_5 & 1) == 0) {
      uVar5 = 0x1e;
    }
    else {
      ...
      if ((int)lVar4 == (int)*(undefined8 *)(unaff_x26 + 0x140)) {
        ...
        if (*(short *)(lVar4 + 7) != 0x43) goto LAB_01462f50;
        uVar5 = 0x1e;
      }
    }
  }
