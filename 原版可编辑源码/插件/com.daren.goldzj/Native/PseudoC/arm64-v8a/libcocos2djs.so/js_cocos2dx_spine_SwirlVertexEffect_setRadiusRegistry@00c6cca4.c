...
/* js_cocos2dx_spine_SwirlVertexEffect_setRadiusRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_SwirlVertexEffect_setRadiusRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SwirlVertexEffect *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3074,"js_cocos2dx_spine_SwirlVertexEffect_setRadius");
    puVar6 = &DAT_0191b652;
LAB_00c6ce18:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::SwirlVertexEffect::setRadius(this,local_64);
        goto LAB_00c6ce50;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x307b,"js_cocos2dx_spine_SwirlVertexEffect_setRadius");
      puVar6 = &DAT_0191b698;
      goto LAB_00c6ce18;
    }
    __android_log_print(6,"jswrapper",&DAT_0191b6e3,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SwirlVertexEffect_setRadius",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x3082);
LAB_00c6ce50:
