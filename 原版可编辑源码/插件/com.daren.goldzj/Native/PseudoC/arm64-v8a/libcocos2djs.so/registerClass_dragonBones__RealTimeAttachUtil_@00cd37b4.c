...
/* void JSBClassType::registerClass<dragonBones::RealTimeAttachUtil>(se::Class*) */

void JSBClassType::registerClass<dragonBones::RealTimeAttachUtil>(Class *param_1)
