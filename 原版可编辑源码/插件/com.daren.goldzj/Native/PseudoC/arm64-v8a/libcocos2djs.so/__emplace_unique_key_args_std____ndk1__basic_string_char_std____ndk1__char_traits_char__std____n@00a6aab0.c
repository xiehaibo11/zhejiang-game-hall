...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, double>, void*>*>, bool>
   ...
   std::__ndk1::allocator<char> > const&, double&>(std::__ndk1::basic_string<char,
...
long * std::__ndk1::
       ...
       __emplace_unique_key_args<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&,double&>
                 (basic_string *param_1,basic_string *param_2,double *param_3)

{
  ...
  long local_68;
                    ...
                    /* catch() { ... } // from try @ 00a6a6d8 with catch @ 00a6aab4 */
                    /* catch() { ... } // from try @ 00a6a6cc with catch @ 00a6aab8 */
                    /* catch() { ... } // from try @ 00a6a6ac with catch @ 00a6aabc */
                    /* catch() { ... } // from try @ 00a6a6e4 with catch @ 00a6aacc
                       catch() { ... } // from try @ 00a6a81c with catch @ 00a6aacc */
  lVar3 = tpidr_el0;
  ...
  if (pbVar13 != (basic_string *)0x0) {
    ...
    if (((ulong)pbVar12 & (ulong)pbVar13) == 0) {
      unaff_x28 = (basic_string *)((ulong)pbVar12 & (ulong)pbVar5);
                    ...
                    /* try { // try from 00a6ab24 to 00b6ab73 has its CatchHandler @ 00a6ab24
                       catch() { ... } // from try @ 00a6ab24 with catch @ 00a6ab24
                       catch() { ... } // from try @ 00a6ac34 with catch @ 00a6ab24 */
      unaff_x28 = pbVar5;
      if (pbVar13 <= pbVar5) {
        uVar9 = 0;
        if (pbVar13 != (basic_string *)0x0) {
    ...
    if ((puVar7 != (undefined8 *)0x0) && (plVar11 = (long *)*puVar7, plVar11 != (long *)0x0)) {
      ...
      __s2 = param_2 + 1;
                    /* try { // try from 00a6ab74 to 00b6ab8b has its CatchHandler @ 00a6ace4 */
      if (((byte)*param_2 & 1) != 0) {
          ...
          if (((ulong)pbVar12 & (ulong)pbVar13) == 0) {
            ...
            if (pbVar13 != (basic_string *)0x0) {
              uVar9 = (ulong)pbVar8 / (ulong)pbVar13;
                    ...
                    /* try { // try from 00a6aba0 to 00b6abb3 has its CatchHandler @ 00a6ace0 */
            if (pbVar8 + -(uVar9 * (long)pbVar13) == unaff_x28) goto LAB_00a6abb4;
            break;
          }
          if (pbVar8 != unaff_x28) break;
        }
LAB_00a6abb4:
                    /* try { // try from 00a6abb4 to 00b6abc3 has its CatchHandler @ 00a6accc */
        ...
        if (sVar1 == __n) {
          __s1 = (void *)plVar11[4];
                    /* try { // try from 00a6abdc to 00b6abe3 has its CatchHandler @ 00a6acb0 */
          if ((bVar2 & 1) == 0) {
            __s1 = (void *)((long)plVar11 + 0x11);
          }
          if ((bVar2 & 1) == 0) {
                    /* try { // try from 00a6abe4 to 00b6abfb has its CatchHandler @ 00a6acf4 */
            if (__n != 0) {
              uVar9 = 0;
                    /* try { // try from 00a6abfc to 00b6ac03 has its CatchHandler @ 00a6acc8 */
              while (*(basic_string *)((long)plVar11 + uVar9 + 0x11) == __s2[uVar9]) {
                uVar9 = uVar9 + 1;
                    /* try { // try from 00a6ac04 to 00b6ac33 has its CatchHandler @ 00a6acd0 */
                if (bVar2 >> 1 == uVar9) goto LAB_00a6ac3c;
              }
              goto LAB_00a6ac2c;
            }
          }
...
LAB_00a6ac2c:
  ...
  __s1 = (void *)__construct_node_hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&,double&>
  ...
  if ((pbVar13 == (basic_string *)0x0) ||
    ...
    uVar9 = uVar9 | (long)pbVar13 << 1;
                    /* catch() { ... } // from try @ 00a6abdc with catch @ 00a6acb0 */
    ...
    __s1 = (void *)rehash((__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,double>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,double>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,double>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,double>>>
                           *)param_1,uVar10);
    pbVar13 = *(basic_string **)(param_1 + 8);
                    /* catch() { ... } // from try @ 00a6abfc with catch @ 00a6acc8 */
                    /* catch() { ... } // from try @ 00a6abb4 with catch @ 00a6accc */
                    /* catch() { ... } // from try @ 00a6ac04 with catch @ 00a6acd0 */
    if (((ulong)(pbVar13 + -1) & (ulong)pbVar13) == 0) {
                    /* catch() { ... } // from try @ 00a6ab74 with catch @ 00a6ace4 */
      ...
      if (pbVar13 <= pbVar5) {
        ...
        unaff_x28 = pbVar5 + -(uVar9 * (long)pbVar13);
                    ...
                    /* catch() { ... } // from try @ 00a6abe4 with catch @ 00a6acf4 */
    ...
    *(basic_string **)(*(long *)param_1 + (long)unaff_x28 * 8) = pbVar5;
    if (*local_80[0] != 0) {
      pbVar5 = *(basic_string **)(*local_80[0] + 8);
                    /* try { // try from 00a6ad4c to 00b6ad8f has its CatchHandler @ 00a6ad4c
                       catch() { ... } // from try @ 00a6ad4c with catch @ 00a6ad4c
                       catch() { ... } // from try @ 00a6adc8 with catch @ 00a6ad4c */
      if (((ulong)(pbVar13 + -1) & (ulong)pbVar13) == 0) {
  ...
  *(long *)(param_1 + 0x18) = *(long *)(param_1 + 0x18) + 1;
  plVar11 = local_80[0];
LAB_00a6ad88:
                    /* try { // try from 00a6ad90 to 00b6adc7 has its CatchHandler @ 00a6adf8 */
