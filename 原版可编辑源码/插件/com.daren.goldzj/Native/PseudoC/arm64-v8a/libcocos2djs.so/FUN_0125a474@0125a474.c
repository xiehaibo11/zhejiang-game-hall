...
void FUN_0125a474(long param_1,void *param_2,size_t param_3)

{
  ...
  if (param_3 != 0) {
    ...
    *(size_t *)(param_1 + 0x10) = *(long *)(param_1 + 0x10) + param_3;
  }
  if (v8::internal::FLAG_trace_wasm_serialization != '\0') {
    ...
    std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>
              ((basic_ostream *)&local_148,"wrote vector of ",0x10);
    std::__ndk1::basic_ostream<char,std::__ndk1::char_traits<char>>::operator<<
              ((basic_ostream<char,std::__ndk1::char_traits<char>> *)&local_148,param_3);
    std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>
              ((basic_ostream *)&local_148," elements",9);
