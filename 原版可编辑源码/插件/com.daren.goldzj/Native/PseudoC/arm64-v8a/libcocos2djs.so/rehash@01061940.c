...
/* std::__ndk1::__hash_table<v8::internal::CodeEventListener*,
   std::__ndk1::hash<v8::internal::CodeEventListener*>,
   std::__ndk1::equal_to<v8::internal::CodeEventListener*>,
   std::__ndk1::allocator<v8::internal::CodeEventListener*> >::rehash(unsigned long) */
...
::rehash(__hash_table<v8::internal::CodeEventListener*,std::__ndk1::hash<v8::internal::CodeEventListener*>,std::__ndk1::equal_to<v8::internal::CodeEventListener*>,std::__ndk1::allocator<v8::internal::CodeEventListener*>>
         *this,ulong param_1)

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      if (uVar1 < uVar2) goto LAB_01061a04;
    }
    return;
  }
LAB_01061a04:
