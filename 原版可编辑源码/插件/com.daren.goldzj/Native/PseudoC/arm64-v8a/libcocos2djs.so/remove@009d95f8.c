  ...
  if (plVar7 != param_2 + 2) {
    ...
    if (uVar3 == 0) {
      ...
      uVar6 = uVar6 - uVar4 * uVar2;
                    ...
                    /* try { // try from 009d9694 to 00ad971f has its CatchHandler @ 009d9e44 */
    if (uVar6 == uVar1) goto LAB_009d96ac;
  }
  if (*param_3 != 0) {
    ...
    if (uVar3 == 0) {
      uVar6 = uVar6 & uVar8;
                    ...
                    /* try { // try from 009d9678 to 00ad968b has its CatchHandler @ 009d9e14 */
      uVar4 = 0;
      if (uVar2 != 0) {
        uVar4 = uVar6 / uVar2;
      }
