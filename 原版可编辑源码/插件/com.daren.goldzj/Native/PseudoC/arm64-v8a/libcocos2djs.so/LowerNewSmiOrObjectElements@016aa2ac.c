...
/* v8::internal::compiler::EffectControlLinearizer::LowerNewSmiOrObjectElements(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerNewSmiOrObjectElements
...

{
  ...
  uVar3 = GraphAssembler::IntPtrEqual((Node *)this_00,pNVar7);
  ...
  pNVar5 = (Node *)GraphAssembler::WordShl(this_00,pNVar7,pNVar5);
  ...
  pNVar5 = (Node *)GraphAssembler::FixedArrayMapConstant(this_00);
  this_02 = (AccessBuilder *)GraphAssembler::StoreField(this_00,local_d8,(Node *)this_01,pNVar5);
  AccessBuilder::ForFixedArrayLength(this_02);
  if (*(char *)(*(long *)(*(long *)this + 0x10) + 0x10) == '\x05') {
    pNVar5 = (Node *)GraphAssembler::Int32Constant(this_00,1);
    pNVar5 = (Node *)GraphAssembler::Word32Shl(this_00,pNVar7,pNVar5);
  ...
  GraphAssembler::StoreField(this_00,local_d8,(Node *)this_01,pNVar5);
  ...
  *(undefined8 *)(this + 0x60) = 0;
  ...
  pNVar7 = (Node *)GraphAssembler::UintLessThan(this_00,local_b0,pNVar7);
  GraphAssembler::GotoIfNot<v8::internal::compiler::Node*>(this_00,pNVar7,local_98,(Node *)this_01);
  local_de = 0;
  ...
  pNVar7 = (Node *)GraphAssembler::IntAdd(this_00,local_b0,pNVar7);
  GraphAssembler::MergeState<v8::internal::compiler::Node*>
            (this_00,(GraphAssemblerLabel *)local_d8,pNVar7);
  GraphAssembler::GotoBasicBlock(this_00,local_d0);
  *(undefined8 *)(this + 0x58) = 0;
  *(undefined8 *)(this + 0x60) = 0;
