...
/* v8::internal::compiler::GraphAssembler::BitcastWord32ToWord64(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::BitcastWord32ToWord64(GraphAssembler *this,Node *param_1)

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::BitcastWord32ToWord64
