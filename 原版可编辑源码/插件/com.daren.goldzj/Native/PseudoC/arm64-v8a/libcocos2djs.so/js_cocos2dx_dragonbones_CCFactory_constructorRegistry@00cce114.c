...
/* js_cocos2dx_dragonbones_CCFactory_constructorRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_dragonbones_CCFactory_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Object *)
         se::Object::_createJSObject(__jsb_dragonBones_CCFactory_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_dragonBones_CCFactory_finalizeRegistry);
  se::State::State(aSStack_60,this,(vector *)&local_a0);
  this_00 = operator_new(0x70,(nothrow_t *)&std::nothrow);
  if (this_00 != (CCFactory *)0x0) {
    dragonBones::CCFactory::CCFactory(this_00);
  }
