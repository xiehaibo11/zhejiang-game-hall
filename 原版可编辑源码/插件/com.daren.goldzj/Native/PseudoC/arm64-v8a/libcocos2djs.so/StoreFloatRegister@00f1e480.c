...
/* v8::internal::Translation::StoreFloatRegister(v8::internal::VRegister) */

void __thiscall v8::internal::Translation::StoreFloatRegister(Translation *this,int param_2)
