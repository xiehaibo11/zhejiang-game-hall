...
/* std::__ndk1::__split_buffer<spine::SkeletonCacheAnimation::AniQueueData**,
   std::__ndk1::allocator<spine::SkeletonCacheAnimation::AniQueueData**>
   >::push_back(spine::SkeletonCacheAnimation::AniQueueData**&&) */
...

{
  ...
  if (puVar14 != *(undefined8 **)(this + 0x18)) goto LAB_00d1b1b0;
...
LAB_00d1b180:
      ...
      if (uVar2 != uVar11) goto LAB_00d1b180;
    }
    puVar13 = *(undefined8 **)this;
