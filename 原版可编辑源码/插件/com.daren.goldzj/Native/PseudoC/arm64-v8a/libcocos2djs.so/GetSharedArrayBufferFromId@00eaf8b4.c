...
/* v8::ValueDeserializer::Delegate::GetSharedArrayBufferFromId(v8::Isolate*, unsigned int) */

undefined8
v8::ValueDeserializer::Delegate::GetSharedArrayBufferFromId(Isolate *param_1,uint param_2)
