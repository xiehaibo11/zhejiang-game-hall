...
/* WARNING: Removing unreachable block (ram,0x00aee27c) */

undefined4
FUN_00aedfd0(ASN1_OBJECT **param_1,undefined8 *param_2,undefined8 param_3,char *param_4,uint param_5
...

{
  ...
  if (local_7c == 0xfffffffc) {
    ...
    iVar6 = FUN_00aee720(0,&local_7c,&local_68,0,0,&local_a0,param_3,0xffffffff,0,0,param_8);
    if (iVar6 == 0) {
      iVar6 = 0x3a;
      iVar9 = 0x295;
      goto LAB_00aee17c;
  ...
  iVar6 = FUN_00aee720(&local_88,0,0,local_90,local_8c,&local_a0,param_3,uVar2,uVar5,param_7,param_8
                      );
  if (iVar6 == -1) {
    return 0xffffffff;
  }
...
LAB_00aee670:
  ...
  data = local_a0;
  pbVar13 = local_88;
  if (local_8c[0] == '\0') goto LAB_00aee388;
  ...
  local_94[0] = '\x01';
  iVar6 = FUN_00aeecb8(&local_c0,&local_a0,local_88,local_90[0],0);
  pbVar13 = (byte *)local_c0.length;
  if (iVar6 == 0) goto LAB_00aee6bc;
...
joined_r0x00aee648:
  ...
  case 3:
    ...
    goto joined_r0x00aee518;
  default:
switchD_00aee43c_caseD_4:
...
joined_r0x00aee518:
    if (pAVar14 == (ASN1_OBJECT *)0x0) goto LAB_00aee6ac;
LAB_00aee654:
    *param_2 = local_a0;
    uVar5 = 1;
    if (local_94[0] == '\0') {
    ...
    goto LAB_00aee6c8;
  case 0x1c:
    if (((ulong)pbVar13 & 3) == 0) goto switchD_00aee43c_caseD_4;
    iVar6 = 0xd7;
    iVar9 = 0x34f;
    break;
  case 0x1e:
    if (((ulong)pbVar13 & 1) == 0) goto switchD_00aee43c_caseD_4;
    iVar6 = 0xd6;
    iVar9 = 0x34a;
  }
