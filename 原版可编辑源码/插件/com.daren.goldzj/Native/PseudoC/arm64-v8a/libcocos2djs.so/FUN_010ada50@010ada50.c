...
undefined8 FUN_010ada50(undefined8 param_1,ulong *param_2,uint param_3)

{
  ...
  puVar5 = (ulong *)v8::internal::Factory::NewUninitializedFixedArray
                              (this,param_3 + (param_3 + 1 >> 1) + 0x11);
  FUN_01082628(this,*puVar4,0,*puVar5,3,0,0xffffffff);
