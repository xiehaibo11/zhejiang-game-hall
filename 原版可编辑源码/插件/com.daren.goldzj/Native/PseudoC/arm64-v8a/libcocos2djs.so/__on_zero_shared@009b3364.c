...
/* std::__ndk1::__shared_ptr_emplace<cocos2d::TTFLabelAtals,
   std::__ndk1::allocator<cocos2d::TTFLabelAtals> >::__on_zero_shared() */

void __thiscall
std::__ndk1::
__shared_ptr_emplace<cocos2d::TTFLabelAtals,std::__ndk1::allocator<cocos2d::TTFLabelAtals>>::
__on_zero_shared(__shared_ptr_emplace<cocos2d::TTFLabelAtals,std::__ndk1::allocator<cocos2d::TTFLabelAtals>>
                 *this)
...
LAB_009b3394:
  ...
  if (p_Var6 != (__shared_weak_count *)0x0) {
    ...
    if (lVar5 == 0) {
                    /* try { // try from 009b33c0 to 00ab33c7 has its CatchHandler @ 009b352c */
      (**(code **)(*(long *)p_Var6 + 0x10))(p_Var6);
                    /* try { // try from 009b33c8 to 00ab3453 has its CatchHandler @ 009b3290 */
      __shared_weak_count::__release_weak(p_Var6);
      _Var2 = this[0x18];
      goto joined_r0x009b33d0;
    }
  }
  _Var2 = this[0x18];
joined_r0x009b33d0:
