...
/* v8::BigUint64Array::CheckCast(v8::Value*) */

void v8::BigUint64Array::CheckCast(Value *param_1)

{
  ...
  if ((((uVar3 & 1) != 0) &&
     ...
     (local_8 = uVar3, iVar1 = internal::JSTypedArray::type((JSTypedArray *)&local_8), iVar1 == 0xb)
     ) {
    return;
  }
  ...
  if (lVar2 != 0) {
    if (*(code **)(lVar2 + 0xb738) != (code *)0x0) {
      (**(code **)(lVar2 + 0xb738))
                ("v8::BigUint64Array::Cast()","Could not convert to BigUint64Array");
