...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::extension::Manifest::AssetDiff> > >::~__hash_table() */
...

{
  ...
  do {
    ...
    if ((*(byte *)(puVar2 + 8) & 1) == 0) {
      if ((*(byte *)(puVar2 + 5) & 1) == 0) goto LAB_00a5a8bc;
LAB_00a5a894:
      ...
      operator_delete((void *)puVar2[10]);
                    /* try { // try from 00a5a88c to 00b5a96b has its CatchHandler @ 00a5a9b4 */
      if ((*(byte *)(puVar2 + 5) & 1) != 0) goto LAB_00a5a894;
LAB_00a5a8bc:
      bVar1 = *(byte *)(puVar2 + 2);
    }
    if ((bVar1 & 1) != 0) {
