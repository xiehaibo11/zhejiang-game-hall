...
/* js_cocos2dx_dragonbones_ArmatureData_setDefaultSkinRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_ArmatureData_setDefaultSkinRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x480,&DAT_01928661);
    pcVar8 = "js_cocos2dx_dragonbones_ArmatureData_setDefaultSkin : Invalid Native Object";
LAB_00c9c4a4:
...
LAB_00c9c464:
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                          ,0x487,&DAT_01928661);
      pcVar8 = "js_cocos2dx_dragonbones_ArmatureData_setDefaultSkin : Error processing arguments";
      goto LAB_00c9c4a4;
    }
    __android_log_print(6,"jswrapper",&DAT_0192fb4a,(ulong)(puVar5[1] - (long)pVVar6) >> 4,1);
  }
