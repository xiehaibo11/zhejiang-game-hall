...
/* void 
   v8::internal::JSObject::ApplyAttributesToDictionary<v8::internal::NameDictionary>(v8::internal::Isolate*,
   v8::internal::ReadOnlyRoots, v8::internal::Handle<v8::internal::NameDictionary>,
   v8::internal::PropertyAttributes) */

void v8::internal::JSObject::ApplyAttributesToDictionary<v8::internal::NameDictionary>
