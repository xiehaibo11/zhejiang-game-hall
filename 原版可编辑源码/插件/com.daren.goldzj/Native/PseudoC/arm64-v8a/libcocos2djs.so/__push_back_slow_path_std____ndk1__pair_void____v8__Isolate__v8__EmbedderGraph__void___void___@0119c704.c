...
/* void std::__ndk1::vector<std::__ndk1::pair<void (*)(v8::Isolate*, v8::EmbedderGraph*, void*),
   void*>, std::__ndk1::allocator<std::__ndk1::pair<void (*)(v8::Isolate*, v8::EmbedderGraph*,
   void*), void*> > >::__push_back_slow_path<std::__ndk1::pair<void (*)(v8::Isolate*,
   v8::EmbedderGraph*, void*), void*> >(std::__ndk1::pair<void (*)(v8::Isolate*, v8::EmbedderGraph*,
   void*), void*>&&) */
...

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_0119c7f0;
