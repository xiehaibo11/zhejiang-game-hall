...
/* js_cocos2dx_spine_MeshAttachment_setHeightRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_MeshAttachment_setHeightRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (MeshAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1904,"js_cocos2dx_spine_MeshAttachment_setHeight");
    pcVar6 = "js_cocos2dx_spine_MeshAttachment_setHeight : Invalid Native Object";
LAB_00c3ec28:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::MeshAttachment::setHeight(this,local_64);
        goto LAB_00c3ec60;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x190b,"js_cocos2dx_spine_MeshAttachment_setHeight");
      pcVar6 = "js_cocos2dx_spine_MeshAttachment_setHeight : Error processing arguments";
      goto LAB_00c3ec28;
    }
    __android_log_print(6,"jswrapper",&DAT_019067ca,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_MeshAttachment_setHeight",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1912);
LAB_00c3ec60:
