...
undefined8 FUN_00a5326c(undefined8 param_1,char *param_2,DES_cblock *param_3)

{
  ...
  long local_48;
                    ...
                    /* try { // try from 00a53280 to 00b5328b has its CatchHandler @ 00a5349c */
  lVar1 = tpidr_el0;
  local_48 = *(long *)(lVar1 + 0x28);
                    /* try { // try from 00a5328c to 00b53297 has its CatchHandler @ 00a53498 */
                    /* try { // try from 00a53298 to 00b5348f has its CatchHandler @ 00a534b0 */
  sVar2 = strlen(param_2);
  if (0xd < sVar2) {
    sVar2 = 0xe;
  }
  FUN_00a338d4(&local_60,param_2,sVar2);
  ...
  DES_ecb_encrypt((const_DES_cblock *)&DAT_018996b3,param_3,&DStack_e0,1);
  local_50 = local_59;
  ...
  DES_set_odd_parity((DES_cblock *)&local_50);
  DES_set_key((const_DES_cblock *)&local_50,&DStack_e0);
  DES_ecb_encrypt((const_DES_cblock *)&DAT_018996b3,param_3 + 1,&DStack_e0,1);
  param_3[2][4] = '\0';
