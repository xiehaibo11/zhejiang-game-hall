...
/* js_cocos2dx_dragonbones_UserData_addFloatRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_UserData_addFloatRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (UserData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x371,"js_cocos2dx_dragonbones_UserData_addFloat");
    pcVar6 = "js_cocos2dx_dragonbones_UserData_addFloat : Invalid Native Object";
LAB_00c9a404:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        dragonBones::UserData::addFloat(this,local_64);
        goto LAB_00c9a43c;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                          ,0x378,"js_cocos2dx_dragonbones_UserData_addFloat");
      pcVar6 = "js_cocos2dx_dragonbones_UserData_addFloat : Error processing arguments";
      goto LAB_00c9a404;
    }
    __android_log_print(6,"jswrapper",&DAT_0192eb8a,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_UserData_addFloat",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x37f);
LAB_00c9a43c:
