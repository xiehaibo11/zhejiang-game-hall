...
/* void std::__ndk1::vector<cocos2d::renderer::Texture*,
   std::__ndk1::allocator<cocos2d::renderer::Texture*>
   >::__push_back_slow_path<cocos2d::renderer::Texture* const&>(cocos2d::renderer::Texture* const&)
    */
