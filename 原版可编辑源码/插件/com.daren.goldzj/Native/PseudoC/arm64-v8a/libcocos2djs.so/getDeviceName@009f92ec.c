...
/* universe::Device::getDeviceName() */

void __thiscall universe::Device::getDeviceName(Device *this)

{
  ...
  uVar3 = (**(code **)(*(long *)p_Var1 + 0x388))
                    (p_Var1,p_Var2,"getDeviceName","()Ljava/lang/String;");
  ...
  *in_x8 = 0;
  ...
  if (0xffffffffffffffef < __n) {
                    /* catch() { ... } // from try @ 009f92b0 with catch @ 009f943c */
