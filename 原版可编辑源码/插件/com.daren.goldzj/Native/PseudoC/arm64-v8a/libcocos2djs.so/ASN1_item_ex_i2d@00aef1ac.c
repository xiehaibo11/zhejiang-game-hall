...

{
  ...
  iVar1 = 0;
                    /* try { // try from 00aef210 to 00bef247 has its CatchHandler @ 00af05d4 */
  iVar3 = 1;
  switch(it->itype) {
  case '\0':
    pAVar8 = it->templates;
    if (pAVar8 != (ASN1_TEMPLATE *)0x0) goto LAB_00aef2a0;
    break;
  case '\x02':
    ...
    tag = -1;
                    /* try { // try from 00aef298 to 00bef29b has its CatchHandler @ 00af061c */
LAB_00aef2a0:
    iVar3 = FUN_00aef50c(pval,out,pAVar8,tag,aclass);
    return iVar3;
  default:
    goto switchD_00aef224_caseD_3;
  case '\x04':
  ...
  case '\x01':
    iVar1 = asn1_enc_restore(&local_64,out,pval,it);
                    /* try { // try from 00aef304 to 00bef30b has its CatchHandler @ 00af052c */
    if (-1 < iVar1) {
      if (iVar1 != 0) {
        return local_64;
      }
      ...
      if ((pcVar9 == (code *)0x0) || (iVar2 = (*pcVar9)(6,pval,it,0), iVar2 != 0)) {
        if (0 < it->tcount) {
          ...
          do {
            ...
            iVar2 = FUN_00aef50c(ppAVar5,0,pAVar4,0xffffffff,xclass);
            if (iVar2 == -1) {
              return -1;
            }
        ...
        if (iVar2 == -1) {
          return -1;
                    ...
                    /* try { // try from 00aef448 to 00bef44f has its CatchHandler @ 00af0528 */
        ...
        if (0 < it->tcount) {
          ...
          do {
            ...
            ppAVar5 = asn1_get_field_ptr(pval,pAVar4);
            FUN_00aef50c(ppAVar5,out,pAVar4,0xffffffff,xclass);
            lVar7 = lVar7 + 1;
            pAVar8 = pAVar8 + 1;
          } while (lVar7 < it->tcount);
        }
  ...
  iVar1 = FUN_00aef9f4(pval,out,it,tag,aclass);
switchD_00aef224_caseD_3:
  return iVar1;
}
