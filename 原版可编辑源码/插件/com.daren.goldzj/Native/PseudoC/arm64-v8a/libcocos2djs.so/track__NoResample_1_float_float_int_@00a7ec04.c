...
/* void cocos2d::AudioMixer::track__NoResample<1, float, float, int>(cocos2d::AudioMixer::track_t*,
   float*, unsigned long, float*, int*) */

void cocos2d::AudioMixer::track__NoResample<1,float,float,int>
  ...
  volumeMix<1,true,true,float,float,int>
            ((AudioMixer *)param_2,(float *)param_3,uVar1,(float *)param_5,
             (int *)(ulong)((*(int *)(param_1 + 0x14) != 0 || *(int *)(param_1 + 0x10) != 0) ||
                    ...
                    /* try { // try from 00a7ec54 to 00b7ed3f has its CatchHandler @ 00a7ea30 */
