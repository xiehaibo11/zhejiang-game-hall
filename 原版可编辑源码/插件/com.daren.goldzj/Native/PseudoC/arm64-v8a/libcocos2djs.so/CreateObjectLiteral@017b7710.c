...
/* v8::internal::interpreter::BytecodeArrayBuilder::CreateObjectLiteral(unsigned long, int, int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::CreateObjectLiteral
          (BytecodeArrayBuilder *this,ulong param_1,int param_2,int param_3)
