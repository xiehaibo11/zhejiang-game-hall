...
undefined4 FUN_00e09598(long *param_1,int param_2)

{
  ...
  do {
    if (*(uint *)((long)param_1 + 0xa4) < 0x106) {
        ...
        *(uint *)((long)param_1 + 0x171c) = uVar7;
        if (param_2 != 4) {
          if (*(int *)((long)param_1 + 0x16fc) != 0) {
            ...
            FUN_00e0d324(param_1,lVar14,uVar11 - uVar9,0);
            lVar8 = *param_1;
        ...
        FUN_00e0d324(param_1,lVar14,uVar11 - uVar9,1);
        lVar8 = *param_1;
        param_1[0x11] = (ulong)*(uint *)((long)param_1 + 0x9c);
        lVar14 = *(long *)(lVar8 + 0x38);
        FUN_00e0d150(lVar14);
      ...
      if (2 < uVar7) goto LAB_00e095f8;
LAB_00e09654:
      uVar7 = *(uint *)(param_1 + 0x12);
      if (2 < uVar7) goto LAB_00e09660;
LAB_00e097dc:
...
LAB_00e09660:
      ...
      *(short *)((long)param_1 + (ulong)(byte)(&DAT_01974980)[uVar7] * 4 + 0x9b8) =
           *(short *)((long)param_1 + (ulong)(byte)(&DAT_01974980)[uVar7] * 4 + 0x9b8) + 1;
      uVar7 = *(uint *)(param_1 + 0x12);
    ...
    if (bVar6) {
      ...
      FUN_00e0d324(param_1,lVar14,uVar7 - uVar11,0);
      lVar8 = *param_1;
      param_1[0x11] = (ulong)*(uint *)((long)param_1 + 0x9c);
      lVar14 = *(long *)(lVar8 + 0x38);
      FUN_00e0d150(lVar14);
