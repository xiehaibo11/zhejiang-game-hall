...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitTestNull() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitTestNull(BytecodeGraphBuilder *this)

{
  ...
  if ((ulong)(long)*(int *)(lVar3 + 0x5c) <
    ...
    uStack_38 = JSGraph::NullConstant(*(JSGraph **)(this + 0x10));
    local_40 = pNVar4;
