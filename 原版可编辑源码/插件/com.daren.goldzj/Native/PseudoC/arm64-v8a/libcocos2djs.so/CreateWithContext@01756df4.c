...
/* v8::internal::compiler::JSOperatorBuilder::CreateWithContext(v8::internal::Handle<v8::internal::ScopeInfo>
   const&) */
...

{
  ...
  Operator::Operator(pOVar1,0x2fa,0,"JSCreateWithContext",1,1,1,1,1,2);
