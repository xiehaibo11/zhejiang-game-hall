...
/* v8::RegExp::NewWithBacktrackLimit(v8::Local<v8::Context>, v8::Local<v8::String>,
   v8::RegExp::Flags, unsigned int) */

ulong * v8::RegExp::NewWithBacktrackLimit
...

{
  ...
  if ((param_4 >> 0x1e & 3) != 0) {
    ...
    V8_Fatal("Check failed: %s.","i::Smi::IsValid(backtrack_limit)");
  }
  if ((int)param_4 == 0) {
                    /* WARNING: Subroutine does not return */
    V8_Fatal("Check failed: %s.","backtrack_limit != i::JSRegExp::kNoBacktrackLimit");
  }
  if (param_1 == 0) {
  ...
  if ((*(int *)(pIVar7 + 0x2c20) == (int)uVar9) ||
    ...
    *local_58 = uVar9;
    ...
    FUN_00eaadd8(&local_c0,pIVar7,param_1);
    local_d0 = 0;
    uStack_e8 = 0;
    ...
    if (internal::TracingFlags::runtime_stats != 0) {
      ...
      internal::RuntimeCallStats::Enter(local_f0,(ulong)&local_f0 | 8,0x3c6);
    }
    ...
    *(undefined4 *)(pIVar7 + 0x2c60) = 5;
    puVar3 = (ulong *)internal::JSRegExp::New(pIVar7,param_2,param_3,param_4 & 0xffffffff);
    puVar8 = local_58;
    if (puVar3 == (ulong *)0x0) {
      local_b0 = '\x01';
...
LAB_00ec49a4:
        ...
        if (*(code **)(lVar4 + 0xb738) == (code *)0x0) goto LAB_00ec49a4;
