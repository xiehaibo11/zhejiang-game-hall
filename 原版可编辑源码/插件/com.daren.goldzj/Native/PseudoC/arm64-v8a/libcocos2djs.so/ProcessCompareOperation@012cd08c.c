...
/* v8::internal::compiler::SerializerForBackgroundCompilation::ProcessCompareOperation(v8::internal::FeedbackSlot)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::ProcessCompareOperation
...

{
  ...
  if ((param_2 != -1) && (*(long *)(*(long *)(this + 0x28) + 8) != 0)) {
    ...
    piVar3 = (int *)JSHeapBroker::ProcessFeedbackForCompareOperation
                              (*(JSHeapBroker **)this,aFStack_38);
