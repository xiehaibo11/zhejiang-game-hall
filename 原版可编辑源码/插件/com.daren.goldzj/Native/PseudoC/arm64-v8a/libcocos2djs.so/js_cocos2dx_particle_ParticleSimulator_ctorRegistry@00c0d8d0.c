...
/* js_cocos2dx_particle_ParticleSimulator_ctorRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_particle_ParticleSimulator_ctorRegistry(FunctionCallbackInfo *param_1)
