...
/* v8::internal::RegExpBytecodeGenerator::IfRegisterLT(int, int, v8::internal::Label*) */

void __thiscall
v8::internal::RegExpBytecodeGenerator::IfRegisterLT
...

{
  ...
  *(uint *)(*(long *)(this + 0x28) + (long)iVar4) = param_1 << 8 | 0x2c;
  iVar2 = *(int *)(this + 0x38);
  iVar4 = iVar2 + 4;
  *(int *)(this + 0x38) = iVar4;
