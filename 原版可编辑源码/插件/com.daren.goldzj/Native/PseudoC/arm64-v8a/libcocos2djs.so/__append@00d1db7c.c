...
/* std::__ndk1::vector<dragonBones::AnimationState*,
   std::__ndk1::allocator<dragonBones::AnimationState*> >::__append(unsigned long) */

void __thiscall
std::__ndk1::
vector<dragonBones::AnimationState*,std::__ndk1::allocator<dragonBones::AnimationState*>>::__append
...
LAB_00d1dbec:
  ...
  if ((ulong)(lVar2 >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar5 >> 0x3d != 0) goto LAB_00d1dbec;
  }
  else {
