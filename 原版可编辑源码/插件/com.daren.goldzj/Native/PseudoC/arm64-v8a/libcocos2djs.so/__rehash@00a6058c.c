...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::extension::ManifestAsset> > >::__rehash(unsigned long) */
...

{
  ...
  ulong uVar17;
                    ...
                    /* try { // try from 00a605a8 to 00b605b3 has its CatchHandler @ 00a608b0 */
  if (param_1 == 0) {
    pvVar9 = *(void **)this;
    *(undefined8 *)this = 0;
    if (pvVar9 != (void *)0x0) {
      operator_delete(pvVar9);
                    ...
                    /* try { // try from 00a60638 to 00b6063f has its CatchHandler @ 00a6088c */
    *(undefined8 *)(this + 8) = 0;
  }
  else {
                    /* try { // try from 00a605b4 to 00b605bf has its CatchHandler @ 00a608ac */
    if (param_1 >> 0x3d != 0) {
                    /* WARNING: Subroutine does not return */
      FUN_00857170("allocator<T>::allocate(size_t n) \'n\' exceeds maximum supported size");
    }
                    /* try { // try from 00a605c0 to 00b605d7 has its CatchHandler @ 00a608c4 */
    ...
    do {
      *(undefined8 *)(*(long *)this + uVar11 * 8) = 0;
      uVar11 = uVar11 + 1;
                    ...
                    /* try { // try from 00a605f8 to 00b605ff has its CatchHandler @ 00a60894 */
    ...
    if (plVar14 != (long *)0x0) {
      ...
      if ((uVar16 & param_1) == 0) {
        ...
        uVar11 = uVar11 - uVar17 * param_1;
                    /* try { // try from 00a60624 to 00b6062b has its CatchHandler @ 00a60890 */
      }
      *(__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::extension::ManifestAsset>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::extension::ManifestAsset>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::extension::ManifestAsset>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::extension::ManifestAsset>>>
        **)(*(long *)this + uVar11 * 8) = this + 0x10;
      for (plVar15 = (long *)*plVar14; plVar15 != (long *)0x0; plVar15 = (long *)*plVar15) {
                    /* try { // try from 00a6065c to 00b6066b has its CatchHandler @ 00a60874 */
        uVar17 = plVar15[1];
        if ((uVar16 & param_1) == 0) {
          ...
          if (*(long *)(*(long *)this + uVar17 * 8) == 0) {
            *(long **)(*(long *)this + uVar17 * 8) = plVar14;
            uVar11 = uVar17;
                    ...
                    /* try { // try from 00a606a4 to 00b6070b has its CatchHandler @ 00a608c4 */
            plVar13 = plVar15;
            if ((long *)*plVar15 != (long *)0x0) {
              ...
              do {
                ...
                if ((bVar3 & 1) == 0) {
                  while (sVar6 != 0) {
                    if (*pcVar5 != *__s2) goto LAB_00a60770;
                    __s2 = __s2 + 1;
                    sVar1 = sVar1 + 1;
                    pcVar5 = pcVar5 + 1;
                    sVar6 = sVar1;
                    ...
                    /* try { // try from 00a6076c to 00b607a7 has its CatchHandler @ 00a608c4 */
                plVar7 = (long *)*plVar12;
                plVar13 = plVar12;
