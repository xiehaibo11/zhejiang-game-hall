...
/* bool v8::internal::wasm::ThreadImpl::ExtractAtomicOpParams<unsigned long, unsigned
...
bool __thiscall
v8::internal::wasm::ThreadImpl::ExtractAtomicOpParams<unsigned_long,unsigned_long>
          (ThreadImpl *this,Decoder *param_1,InterpreterCode *param_2,ulong *param_3,ulong param_4,
          int *param_5,ulong *param_6,ulong *param_7)

{
  ...
  if (param_7 != (ulong *)0x0) {
    ...
    *param_7 = CONCAT44(uStack_93,local_97);
    iVar7 = iVar8;
  }
  if (param_6 != (ulong *)0x0) {
    ...
    *param_6 = CONCAT44(uStack_93,local_97);
  }
  lVar4 = *(long *)(this + 0x28);
  *(long *)(this + 0x28) = lVar4 + -0x11;
  local_70 = *(undefined1 *)(lVar4 + -1);
  ...
  if (CARRY4(local_97,uVar2)) {
    *param_3 = 0;
    ...
    uVar5 = 0;
    if ((7 < *(ulong *)(lVar4 + 0x13)) &&
       ((ulong)(local_97 + uVar2) <= *(ulong *)(lVar4 + 0x13) - 8)) {
