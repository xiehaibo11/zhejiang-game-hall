...
undefined8 FUN_00acbc44(undefined8 *param_1,EVP_PKEY *param_2)
...
LAB_00acbd20:
    ...
    plVar5 = param_1 + (long)iVar1 * 5 + 4;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00acbbe0 with catch @ 00acbc78
                       catch(type#1 @ 00000000) { ... } // from try @ 00acbc08 with catch @ 00acbc78
                       catch(type#1 @ 00000000) { ... } // from try @ 00acbc30 with catch @ 00acbc78
                        */
    if (*plVar5 != 0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00acbb80 with catch @ 00acbc7c
                       catch(type#1 @ 00000000) { ... } // from try @ 00acbbac with catch @ 00acbc7c
                        */
      ...
      if (iVar2 == 6) {
        ...
        uVar3 = RSA_flags(r);
        if ((uVar3 & 1) != 0) goto LAB_00acbcc0;
      }
