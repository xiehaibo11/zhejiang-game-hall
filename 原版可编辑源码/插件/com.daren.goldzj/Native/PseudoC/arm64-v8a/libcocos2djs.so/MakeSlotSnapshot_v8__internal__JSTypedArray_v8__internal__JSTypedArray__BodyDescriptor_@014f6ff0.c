...
/* WARNING: Removing unreachable block (ram,0x014f7060) */
/* WARNING: Removing unreachable block (ram,0x014f7064) */
/* v8::internal::SlotSnapshot const&
   v8::internal::ConcurrentMarkingVisitor::MakeSlotSnapshot<v8::internal::JSTypedArray,
   v8::internal::JSTypedArray::BodyDescriptor>(v8::internal::Map, v8::internal::JSTypedArray, int)
    */
...

{
  ...
  *(undefined4 *)(this + 0x48) = 0;
  ...
  for (; puVar1 < (uint *)(param_3 + 0xfU); puVar1 = puVar1 + 1) {
    uVar3 = *puVar1;
    iVar4 = *(int *)pCVar2;
    *(int *)pCVar2 = iVar4 + 1;
  ...
  puVar1 = (uint *)(param_3 + 0x33);
  local_58 = pCVar2;
  SlotSnapshottingVisitor::VisitPointers
            ((SlotSnapshottingVisitor *)&local_60,param_3,param_3 + 0x2f,puVar1);
