...
ulong FUN_010a12ec(ulong *param_1,int param_2)

{
  ...
  FUN_010a11bc(this,*puVar4,0,*puVar5,bVar1,0,0xffffffff);
  uVar6 = v8::internal::JSObject::GetElementsTransitionMap(param_1,0xb);
  ...
  *(int *)(uVar9 + 7) = (int)uVar7;
  ...
  uVar7 = v8::internal::JSObject::PrintElementsTransition(waitpid,param_1,bVar1,puVar4,0xb,puVar5);
  return uVar7;
}
