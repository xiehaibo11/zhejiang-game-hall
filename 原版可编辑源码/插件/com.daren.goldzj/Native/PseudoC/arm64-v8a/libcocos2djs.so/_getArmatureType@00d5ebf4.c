...

{
  ...
  if (((byte)*param_1 & 1) == 0) {
    ...
    uVar4 = local_60 & 0xff;
    if ((local_60 & 1) == 0) goto LAB_00d5ec40;
LAB_00d5ecc4:
    pcVar7 = local_50 + uStack_58;
    pcVar5 = local_50;
    if (local_50 == pcVar7) goto LAB_00d5ecec;
  }
  else {
...
LAB_00d5eca8:
    ...
    pcVar7[uVar4] = '\0';
    uVar4 = local_60 & 0xff;
    if ((local_60 & 1) != 0) goto LAB_00d5ecc4;
LAB_00d5ec40:
    pcVar5 = (char *)((ulong)&local_60 | 1);
    pcVar7 = pcVar5 + (uVar4 >> 1);
    if (pcVar5 == pcVar7) goto LAB_00d5ecec;
  }
  do {
