...
/* std::__ndk1::__split_buffer<v8::internal::TranslatedValue*,
   ...
   >::push_front(v8::internal::TranslatedValue*&&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_00f25504;
...
LAB_00f254d8:
      ...
      if (((void *)((long)pvVar4 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar4 + uVar9 + uVar13 * 8 + 8))) goto LAB_00f254d8;
      ...
      puVar7 = puVar8;
      if (uVar2 != uVar9) goto LAB_00f254d8;
    }
