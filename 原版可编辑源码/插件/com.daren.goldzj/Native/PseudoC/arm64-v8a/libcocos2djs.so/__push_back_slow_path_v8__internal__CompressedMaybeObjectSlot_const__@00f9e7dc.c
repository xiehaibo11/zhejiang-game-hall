...
/* void std::__ndk1::vector<v8::internal::CompressedMaybeObjectSlot,
   std::__ndk1::allocator<v8::internal::CompressedMaybeObjectSlot>
   >::__push_back_slow_path<v8::internal::CompressedMaybeObjectSlot
   const&>(v8::internal::CompressedMaybeObjectSlot const&) */
...
::__push_back_slow_path<v8::internal::CompressedMaybeObjectSlot_const&>
          (vector<v8::internal::CompressedMaybeObjectSlot,std::__ndk1::allocator<v8::internal::CompressedMaybeObjectSlot>>
           *this,CompressedMaybeObjectSlot *param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00f9e8c4;
