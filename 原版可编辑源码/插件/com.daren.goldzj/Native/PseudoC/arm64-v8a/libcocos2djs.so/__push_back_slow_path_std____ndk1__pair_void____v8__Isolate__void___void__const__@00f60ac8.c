...
/* void std::__ndk1::vector<std::__ndk1::pair<void (*)(v8::Isolate*, void*), void*>,
   std::__ndk1::allocator<std::__ndk1::pair<void (*)(v8::Isolate*, void*), void*> >
   >::__push_back_slow_path<std::__ndk1::pair<void (*)(v8::Isolate*, void*), void*>
   const&>(std::__ndk1::pair<void (*)(v8::Isolate*, void*), void*> const&) */
...

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_00f60bb4;
