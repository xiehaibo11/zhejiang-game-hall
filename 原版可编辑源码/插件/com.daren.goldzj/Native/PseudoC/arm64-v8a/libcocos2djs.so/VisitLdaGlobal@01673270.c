...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitLdaGlobal() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitLdaGlobal(BytecodeGraphBuilder *this)

{
  ...
  pOVar5 = (Operator *)JSOperatorBuilder::LoadGlobal(pJVar8,&local_58,local_40,1);
