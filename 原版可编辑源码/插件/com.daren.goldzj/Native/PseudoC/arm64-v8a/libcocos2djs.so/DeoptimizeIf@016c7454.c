...
/* v8::internal::compiler::GraphAssembler::DeoptimizeIf(v8::internal::DeoptimizeReason,
   v8::internal::compiler::FeedbackSource const&, v8::internal::compiler::Node*,
   v8::internal::compiler::Node*, v8::internal::compiler::IsSafetyCheck) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::DeoptimizeIf
          (GraphAssembler *this,undefined4 param_2,undefined8 param_3,Node *param_4,
...

{
  ...
  pOVar2 = (Operator *)
           CommonOperatorBuilder::DeoptimizeIf
                     ((CommonOperatorBuilder *)(*(undefined8 **)(this + 0x18))[1],0,param_2,param_3,
                      param_6);
  local_40 = *(undefined8 *)(this + 0x20);
  uStack_38 = *(undefined8 *)(this + 0x28);
  local_50 = param_4;
  uStack_48 = param_5;
  pNVar3 = (Node *)Graph::NewNode(this_00,pOVar2,4,&local_50,false);
