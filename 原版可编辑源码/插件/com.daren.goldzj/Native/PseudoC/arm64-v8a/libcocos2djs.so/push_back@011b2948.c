...
/* std::__ndk1::__split_buffer<v8::internal::CodeMap::CodeEntrySlotInfo*,
   std::__ndk1::allocator<v8::internal::CodeMap::CodeEntrySlotInfo*>&>::push_back(v8::internal::CodeMap::CodeEntrySlotInfo*&&)
    */
...
::push_back(__split_buffer<v8::internal::CodeMap::CodeEntrySlotInfo*,std::__ndk1::allocator<v8::internal::CodeMap::CodeEntrySlotInfo*>&>
            *this,CodeEntrySlotInfo **param_1)

{
  ...
  puVar12 = puVar4;
  if (puVar4 != *(undefined8 **)(this + 0x18)) goto LAB_011b2ad0;
...
LAB_011b2a9c:
      ...
      if (((void *)((long)pvVar6 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar6 + uVar13 * 8 + uVar9 + 8))) goto LAB_011b2a9c;
      ...
      puVar11 = puVar12;
      if (uVar2 != uVar9) goto LAB_011b2a9c;
    }
    puVar11 = *(undefined8 **)this;
  }
  *(void **)this = pvVar6;
