...
/* void std::__ndk1::vector<v8::internal::SharedFunctionInfo,
   std::__ndk1::allocator<v8::internal::SharedFunctionInfo>
   >::__push_back_slow_path<v8::internal::SharedFunctionInfo>(v8::internal::SharedFunctionInfo&&) */
...
__push_back_slow_path<v8::internal::SharedFunctionInfo>
          (vector<v8::internal::SharedFunctionInfo,std::__ndk1::allocator<v8::internal::SharedFunctionInfo>>
           *this,SharedFunctionInfo *param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00f4a050;
