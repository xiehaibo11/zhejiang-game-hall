...
/* void std::__ndk1::vector<v8::internal::CodeEntryAndLineNumber,
   std::__ndk1::allocator<v8::internal::CodeEntryAndLineNumber>
   >::__push_back_slow_path<v8::internal::CodeEntryAndLineNumber>(v8::internal::CodeEntryAndLineNumber&&)
    */
...

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_011b5274;
