...
/* void std::__ndk1::vector<void (*)(v8::Isolate*), std::__ndk1::allocator<void (*)(v8::Isolate*)>
   >::__push_back_slow_path<void (* const&)(v8::Isolate*)>(void (* const&)(v8::Isolate*)) */

void __thiscall
std::__ndk1::vector<void(*)(v8::Isolate*),std::__ndk1::allocator<void(*)(v8::Isolate*)>>::
__push_back_slow_path<void(*const&)(v8::Isolate*)>
          (vector<void(*)(v8::Isolate*),std::__ndk1::allocator<void(*)(v8::Isolate*)>> *this,
          _func_void_Isolate_ptr *param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00f59edc;
