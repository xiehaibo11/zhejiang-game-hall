...
/* v8::internal::interpreter::BytecodeArrayBuilder::CollectTypeProfile(int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::CollectTypeProfile
