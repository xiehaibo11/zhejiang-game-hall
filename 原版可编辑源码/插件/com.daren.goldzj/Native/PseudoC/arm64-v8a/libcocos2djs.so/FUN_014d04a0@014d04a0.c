...
undefined8 FUN_014d04a0(undefined8 param_1,undefined8 param_2,long param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_70,(ulong)&local_70 | 8,0x322);
  }
  if (DAT_01d46688 == (byte *)0x0) {
    plVar2 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d46688 = (byte *)(**(code **)(*plVar2 + 0x10))(plVar2,"disabled-by-default-v8.runtime");
  }
  pbVar1 = DAT_01d46688;
  local_90 = (byte **)0x0;
  if ((*DAT_01d46688 & 5) != 0) {
    ...
    uVar3 = (**(code **)(*plVar2 + 0x18))
                      (plVar2,0x58,pbVar1,"V8.Builtin_RegExpCapture2Getter",0,0,0,0,0,0,0,&local_40,
                       0);
    plVar2 = local_38;
    local_38 = (long *)0x0;
    if (plVar2 != (long *)0x0) {
    ...
    local_90 = &local_88;
    local_80 = "V8.Builtin_RegExpCapture2Getter";
    local_88 = pbVar1;
    local_78 = uVar3;
  }
  uVar3 = FUN_014d0634(param_3);
