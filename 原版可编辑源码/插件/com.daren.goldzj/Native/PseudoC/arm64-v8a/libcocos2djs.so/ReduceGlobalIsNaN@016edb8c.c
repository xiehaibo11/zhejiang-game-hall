...
/* v8::internal::compiler::JSCallReducer::ReduceGlobalIsNaN(v8::internal::compiler::Node*) */

undefined8 __thiscall
v8::internal::compiler::JSCallReducer::ReduceGlobalIsNaN(JSCallReducer *this,Node *param_1)

{
  ...
  if ((*(byte *)(lVar1 + 3) >> 4 & 1) == 0) {
    if (*(int *)(*(long *)param_1 + 0x14) < 3) {
      uVar2 = JSGraph::TrueConstant(*(JSGraph **)(this + 0x10));
      plVar6 = *(long **)(this + 8);
      lVar1 = *plVar6;
      pNVar5 = (Node *)0x0;
    }
