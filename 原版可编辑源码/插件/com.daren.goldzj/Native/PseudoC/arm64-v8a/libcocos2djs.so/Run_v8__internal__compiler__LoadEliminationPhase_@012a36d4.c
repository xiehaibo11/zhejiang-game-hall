...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::LoadEliminationPhase>() */
...

{
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFLoadElimination");
  LoadEliminationPhase::Run(aLStack_18,pPVar5,pZVar2);
