...
/* bool 
   ...
   dragonBones::CCArmatureDisplay>::value, dragonBones::CCArmatureDisplay>::type*, se::Value*,
   bool*) */

bool native_ptr_to_seval<dragonBones::CCArmatureDisplay>(type *param_1,Value *param_2,bool *param_3)

{
  ...
  if (param_1 == (type *)0x0) {
    ...
    if (lVar1 == lVar2) {
      pCVar3 = JSBClassType::findClass<dragonBones::CCArmatureDisplay>((CCArmatureDisplay *)param_1)
      ;
