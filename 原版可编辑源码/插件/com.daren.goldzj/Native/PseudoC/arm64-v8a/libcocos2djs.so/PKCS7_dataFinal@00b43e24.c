...
LAB_00b4404c:
    if (psVar7 != (stack_st_PKCS7_SIGNER_INFO *)0x0) goto LAB_00b44050;
    break;
  case 0x17:
  ...
  case 0x18:
    ...
    if (a != (ASN1_OCTET_STRING *)0x0) goto LAB_00b4404c;
    a = ASN1_OCTET_STRING_new();
    if (a == (ASN1_OCTET_STRING *)0x0) {
      iVar2 = 0x80;
      iVar1 = 0x41;
...
LAB_00b44050:
    ...
    if (0 < iVar1) {
      ...
      do {
        ...
        if (si->pkey != (EVP_PKEY *)0x0) {
          ...
          lVar4 = FUN_00b443d4(&local_a8,bio,iVar2);
          ...
          if (iVar2 < 1) {
            ...
            if (md == (uchar *)0x0) goto LAB_00b442c0;
  ...
  case 0x19:
    ...
    lVar4 = FUN_00b443d4(&local_a8,bio,iVar1);
    if (((lVar4 != 0) &&
