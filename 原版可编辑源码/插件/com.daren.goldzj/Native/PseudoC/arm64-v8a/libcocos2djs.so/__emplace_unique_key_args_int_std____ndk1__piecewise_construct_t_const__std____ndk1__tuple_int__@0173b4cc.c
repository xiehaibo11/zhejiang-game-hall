...
/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<int,
   v8::internal::compiler::PropertyDescriptor>,
   std::__ndk1::__tree_node<std::__ndk1::__value_type<int,
   v8::internal::compiler::PropertyDescriptor>, void*>*, long>, bool>
   std::__ndk1::__tree<std::__ndk1::__value_type<int, v8::internal::compiler::PropertyDescriptor>,
   std::__ndk1::__map_value_compare<int, std::__ndk1::__value_type<int,
   v8::internal::compiler::PropertyDescriptor>, std::__ndk1::less<int>, true>,
   v8::internal::ZoneAllocator<std::__ndk1::__value_type<int,
   v8::internal::compiler::PropertyDescriptor> > >::__emplace_unique_key_args<int,
...
joined_r0x0173b540:
  if (p_Var4 == (__tree_node_base *)0x0) {
    ...
    if ((ulong)(*(long *)(this + 0x18) - (long)p_Var4) < 0x60) {
      p_Var4 = (__tree_node_base *)v8::internal::Zone::NewExpand(this,0x60);
    }
    else {
      *(__tree_node_base **)(this + 0x10) = p_Var4 + 0x60;
    }
    uVar1 = **(undefined4 **)param_4;
    *(undefined8 *)(p_Var4 + 0x40) = 0;
    *(undefined8 *)(p_Var4 + 0x38) = 0;
    *(undefined4 *)(p_Var4 + 0x38) = 0xc0;
    *(undefined8 *)(p_Var4 + 0x50) = 0;
    *(undefined8 *)(p_Var4 + 0x48) = 0;
    *(undefined8 *)(p_Var4 + 0x30) = 0;
    *(undefined8 *)(p_Var4 + 0x28) = 0;
    *(undefined8 *)(p_Var4 + 0x50) = 0;
    *(undefined8 *)(p_Var4 + 0x58) = 0;
    *(undefined8 *)(p_Var4 + 0x40) = 0;
    *(undefined8 *)(p_Var4 + 0x48) = 0;
    *(undefined8 *)p_Var4 = 0;
