...
/* js_cocos2dx_spine_Animation_setDurationRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Animation_setDurationRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Animation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x58,"js_cocos2dx_spine_Animation_setDuration");
    pcVar6 = "js_cocos2dx_spine_Animation_setDuration : Invalid Native Object";
LAB_00c1231c:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Animation::setDuration(this,local_64);
        goto LAB_00c12354;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x5f,"js_cocos2dx_spine_Animation_setDuration");
      pcVar6 = "js_cocos2dx_spine_Animation_setDuration : Error processing arguments";
      goto LAB_00c1231c;
    }
    __android_log_print(6,"jswrapper",&DAT_018f06e2,uVar7 >> 4,1);
  }
