...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   std::__ndk1::weak_ptr<cocos2d::TTFLabelAtals> > > >::rehash(unsigned long) */
...
LAB_009b2ef0:
  ...
  if (param_1 < uVar2) {
                    /* try { // try from 009b2f2c to 00ab310f has its CatchHandler @ 009b2f2c
                       catch() { ... } // from try @ 009b2f2c with catch @ 009b2f2c
                       catch() { ... } // from try @ 009b3180 with catch @ 009b2f2c
                       catch() { ... } // from try @ 009b31c0 with catch @ 009b2f2c */
    ...
    if (uVar1 < uVar2) goto LAB_009b2ef0;
  }
  return;
}
