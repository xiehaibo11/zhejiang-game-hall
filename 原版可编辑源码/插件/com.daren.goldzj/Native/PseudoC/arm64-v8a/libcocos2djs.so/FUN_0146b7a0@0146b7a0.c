...
void FUN_0146b7a0(ulong param_1)

{
  ...
  iVar8 = (int)unaff_x19;
  if ((((int)lVar10 != iVar12) && ((*(byte *)(unaff_x20 + unaff_x19 + 9) >> 5 & 1) != 0)) &&
     (uVar3 = unaff_x26 +
              (ulong)*(uint *)(lVar10 + (ulong)*(uint *)(unaff_x20 + unaff_x19 + 5) * 4 + 0x1f),
     (uVar3 & 1) != 0)) {
...
LAB_0146b9a4:
          ...
          if ((int)uVar14 != (int)*(undefined8 *)(unaff_x26 + 0x168)) {
            ...
            if (lVar17 == 0) {
              ...
              *(undefined8 *)(unaff_x26 + 0x40) = 0x146bb4c;
              ...
              *(int *)(uVar15 + 3) = iVar12 * 2;
              if (((uint)*(undefined8 *)((uVar15 & 0xfffffffffffc0000) + 8) >> 2 & 1) == 0) {
                *(undefined8 *)(unaff_x26 + 0x40) = 0x146ba84;
                *(undefined1 **)(unaff_x26 + 0x38) = &stack0xfffffffffffffff0;
            ...
            do {
              ...
              *(int *)(uVar14 + lVar11 + -1) = (int)uVar3;
              lVar11 = lVar11 + 4;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0146bccc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x21 +
                      (ulong)*(byte *)(*(long *)(unaff_x29 + -0x18) + unaff_x19 + 10) * 8))(uVar14);
          return;
        }
      }
      else {
