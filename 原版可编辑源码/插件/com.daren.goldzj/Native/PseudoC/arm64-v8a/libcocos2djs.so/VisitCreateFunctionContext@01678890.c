...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitCreateFunctionContext() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitCreateFunctionContext(BytecodeGraphBuilder *this)

{
  ...
  pOVar4 = (Operator *)JSOperatorBuilder::CreateFunctionContext(pJVar6,uVar2,uVar1,2);
