...
/* v8::internal::compiler::EffectControlLinearizer::LowerObjectIsArrayBufferView(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerObjectIsArrayBufferView
...

{
  ...
  pNVar2 = (Node *)GraphAssembler::Int32Constant(this_00,0x41a);
  pNVar4 = (Node *)GraphAssembler::Int32Sub(this_00,pNVar4,pNVar2);
  pNVar2 = (Node *)GraphAssembler::Int32Constant(this_00,2);
  pNVar4 = (Node *)GraphAssembler::Uint32LessThan(this_00,pNVar4,pNVar2);
