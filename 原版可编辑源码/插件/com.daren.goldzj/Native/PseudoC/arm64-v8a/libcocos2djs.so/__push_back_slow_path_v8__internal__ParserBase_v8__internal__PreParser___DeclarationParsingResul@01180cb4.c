...
/* void 
   std::__ndk1::vector<v8::internal::ParserBase<v8::internal::PreParser>::DeclarationParsingResult::Declaration,
   std::__ndk1::allocator<v8::internal::ParserBase<v8::internal::PreParser>::DeclarationParsingResult::Declaration>
   >::__push_back_slow_path<v8::internal::ParserBase<v8::internal::PreParser>::DeclarationParsingResult::Declaration
   const&>(v8::internal::ParserBase<v8::internal::PreParser>::DeclarationParsingResult::Declaration
   const&) */
...

{
  ...
  if (uVar1 < 0x1555555555555556) {
    ...
    if (uVar1 == 0) {
      ...
      if (0x1555555555555555 < uVar1) goto LAB_01180dc0;
