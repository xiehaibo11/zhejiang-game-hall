...
/* int 
   v8::internal::MainMarkingVisitor<v8::internal::MajorMarkingState>::VisitJSObjectSubclass<v8::internal::JSArrayBuffer,
   v8::internal::JSArrayBuffer::BodyDescriptor>(v8::internal::Map, v8::internal::JSArrayBuffer) */
...
LAB_00fe7800:
    ...
    IterateJSObjectBodyImpl<v8::internal::MainMarkingVisitor<v8::internal::MajorMarkingState>>
              (param_2,param_3,0x20,(ulong)bVar3 << 2,this);
  }
  return iVar8;
}
