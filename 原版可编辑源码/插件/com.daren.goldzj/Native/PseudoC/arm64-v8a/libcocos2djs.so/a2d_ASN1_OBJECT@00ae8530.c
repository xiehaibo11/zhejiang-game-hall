...

{
  ...
  uchar auStack_78 [24];
                    ...
                    /* try { // try from 00ae8550 to 00be8557 has its CatchHandler @ 00ae8660 */
                    /* try { // try from 00ae8558 to 00be86c7 has its CatchHandler @ 00ae8330 */
  if (num == 0) {
    return 0;
  }
  if (num == -1) {
  ...
  if ((byte)(bVar6 - 0x30) < 3) {
    if (1 < num) {
      ...
      if (iVar25 == 0) {
        ...
        uVar36 = 0;
        pbVar28 = (byte *)(buf + 2);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ae8550 with catch @ 00ae8660
                        */
        ...
        do {
          ...
          do {
            ...
            if ((bVar5 == 0x20) || (bVar5 == 0x2e)) {
              bVar1 = false;
                    /* try { // try from 00ae8760 to 00be8767 has its CatchHandler @ 00ae87bc */
              pbVar28 = pbVar28 + 1;
                    /* try { // try from 00ae8768 to 00be87b7 has its CatchHandler @ 00ae86c8 */
              goto joined_r0x00ae89b8;
            }
            if (9 < bVar5 - 0x30) goto LAB_00ae89ec;
            uVar37 = (uVar39 + uVar37 * 10) - 0x30;
            pbVar28 = pbVar27;
          } while (uVar37 < 0x1999999999999991);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ae8388 with catch @ 00ae86c4
                        */
          bVar1 = false;
                    /* try { // try from 00ae86c8 to 00be875f has its CatchHandler @ 00ae86c8
                       catch() { ... } // from try @ 00ae86c8 with catch @ 00ae86c8
                       catch() { ... } // from try @ 00ae8768 with catch @ 00ae86c8
                       catch() { ... } // from try @ 00ae87bc with catch @ 00ae86c8 */
          while (0 < iVar25) {
            bVar5 = *pbVar28;
            uVar39 = (ulong)bVar5;
            if ((bVar5 == 0x20) || (bVar5 == 0x2e)) {
...
LAB_00ae8790:
            ...
            iVar22 = (iVar23 + 6) / 7;
                    /* try { // try from 00ae87b8 to 00be87bb has its CatchHandler @ 00ae87bc */
                    /* catch() { ... } // from try @ 00ae8760 with catch @ 00ae87bc
                       catch() { ... } // from try @ 00ae87b8 with catch @ 00ae87bc
                       try { // try from 00ae87bc to 00be87d3 has its CatchHandler @ 00ae86c8 */
            if (iVar22 <= iVar26) {
LAB_00ae880c:
              if (iVar23 + 0xcU < 0xd) {
                lVar29 = 0;
                ...
                do {
                  ...
                  if (uVar37 == 0xffffffffffffffff) goto LAB_00ae8a08;
                  lVar29 = lVar38 + 1;
            ...
            if (ptr != (uchar *)0x0) goto LAB_00ae880c;
            goto LAB_00ae8a14;
          }
LAB_00ae8860:
          lVar29 = 0;
            ...
            if (1 < iVar22) {
              ...
              if ((0x1f < uVar3) && (uVar33 = uVar3 & 0xffffffffffffffe0, uVar33 != 0)) {
                ...
                if ((puVar31 <= out + uVar36) ||
                  ...
                  uVar36 = uVar32;
                  if (uVar3 == uVar33) goto LAB_00ae8988;
                }
              }
              do {
                uVar36 = uVar32 + 1;
