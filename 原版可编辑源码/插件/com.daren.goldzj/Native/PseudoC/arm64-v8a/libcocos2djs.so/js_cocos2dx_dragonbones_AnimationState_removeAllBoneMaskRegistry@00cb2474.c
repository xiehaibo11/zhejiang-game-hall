...
/* js_cocos2dx_dragonbones_AnimationState_removeAllBoneMaskRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_AnimationState_removeAllBoneMaskRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (AnimationState *)0x0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_AnimationState_removeAllBoneMask : Invalid Native Object"
                       );
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      dragonBones::AnimationState::removeAllBoneMask(this);
      goto LAB_00cb25c4;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp, 4346): wrong number of arguments: %d, was expecting %d\n"
