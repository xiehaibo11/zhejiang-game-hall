...
/* WARNING: Removing unreachable block (ram,0x017e4770) */
/* v8::internal::compiler::PropertyAccessInfo::StringLength(v8::internal::Zone*,
   v8::internal::Handle<v8::internal::Map>) */

void __thiscall
v8::internal::compiler::PropertyAccessInfo::StringLength
          (undefined4 *param_1_00,PropertyAccessInfo *this,undefined8 param_1)
