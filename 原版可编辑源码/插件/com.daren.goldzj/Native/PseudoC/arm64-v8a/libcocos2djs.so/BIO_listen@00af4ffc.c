...

{
  ...
  if (param_1 == -1) {
    iVar1 = 0x87;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00af50bc with catch @ 00af50d8
                        */
    line = 0xa0;
  }
  else {
    ...
    if ((iVar1 == 0) && (local_34 == 4)) {
      ...
      if (iVar1 == 0) {
        return 0;
                    ...
                    /* try { // try from 00af5080 to 00bf5083 has its CatchHandler @ 00af5094 */
      if (((param_3 & 1) == 0) || (iVar1 = setsockopt(param_1,1,2,local_28 + 1,4), iVar1 == 0)) {
          ...
          if (((param_3 >> 4 & 1) == 0) ||
            ...
            if (((param_3 >> 1 & 1) == 0) ||
              ...
              if (iVar1 == 0) {
                ...
                piVar2 = (int *)__errno();
                    /* catch() { ... } // from try @ 00af5330 with catch @ 00af52dc */
        ...
        piVar2 = (int *)__errno();
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00af5080 with catch @ 00af5094
                        */
        ERR_put_error(2,0xe,*piVar2,"crypto/bio/b_sock2.c",0xb3);
        iVar1 = 0x8b;
                    /* try { // try from 00af50bc to 00bf50bf has its CatchHandler @ 00af50d8 */
        line = 0xb4;
      }
    }
    else {
      piVar2 = (int *)__errno();
                    /* try { // try from 00af50e8 to 00bf50eb has its CatchHandler @ 00af50f4 */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00af50e8 with catch @ 00af50f4
                        */
