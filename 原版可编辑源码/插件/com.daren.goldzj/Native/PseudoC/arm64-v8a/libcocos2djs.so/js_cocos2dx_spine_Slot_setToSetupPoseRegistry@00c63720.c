...
/* js_cocos2dx_spine_Slot_setToSetupPoseRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Slot_setToSetupPoseRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Slot *)0x0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_Slot_setToSetupPose : Invalid Native Object");
  }
  else {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 11071): wrong number of arguments: %d, was expecting %d\n"
