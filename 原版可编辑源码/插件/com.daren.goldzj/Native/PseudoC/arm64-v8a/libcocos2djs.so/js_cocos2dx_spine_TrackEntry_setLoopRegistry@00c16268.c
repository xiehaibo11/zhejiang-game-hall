...
/* js_cocos2dx_spine_TrackEntry_setLoopRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_TrackEntry_setLoopRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TrackEntry *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x285,"js_cocos2dx_spine_TrackEntry_setLoop");
    pcVar6 = "js_cocos2dx_spine_TrackEntry_setLoop : Invalid Native Object";
LAB_00c163d8:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::TrackEntry::setLoop(this,local_64[0]);
        goto LAB_00c16410;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x28c,"js_cocos2dx_spine_TrackEntry_setLoop");
      pcVar6 = "js_cocos2dx_spine_TrackEntry_setLoop : Error processing arguments";
      goto LAB_00c163d8;
    }
    __android_log_print(6,"jswrapper",&DAT_018f2ae5,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TrackEntry_setLoop",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x293);
LAB_00c16410:
