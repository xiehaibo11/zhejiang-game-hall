...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitMov(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::VisitMov
...

{
  ...
  iVar2 = interpreter::BytecodeArrayAccessor::GetRegisterOperand((BytecodeArrayAccessor *)param_1,0)
  ;
  local_40[0] = interpreter::BytecodeArrayAccessor::GetRegisterOperand
                          ((BytecodeArrayAccessor *)param_1,1);
  lVar7 = *(long *)(this + 0x28);
  uVar4 = interpreter::Register::is_function_closure((Register *)local_40);
  if ((uVar4 & 1) == 0) {
    uVar4 = interpreter::Register::is_current_context((Register *)local_40);
    if ((uVar4 & 1) == 0) {
      local_38[0] = local_40[0];
      if (local_40[0] < 0) {
        uVar3 = interpreter::Register::ToParameterIndex((Register *)local_38,*(int *)(lVar7 + 0x18))
        ;
        lVar6 = *(long *)(lVar7 + 0x30);
      }
      else {
        uVar3 = *(int *)(lVar7 + 0x18) + local_40[0];
        lVar6 = *(long *)(lVar7 + 0x30);
      }
      if ((-1 < (int)uVar3) && ((ulong)(*(long *)(lVar7 + 0x38) - lVar6 >> 3) <= (ulong)uVar3))
      goto LAB_012c569c;
      puVar8 = (undefined8 *)(lVar6 + (long)(int)uVar3 * 8);
    }
    else {
