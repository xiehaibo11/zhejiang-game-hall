...
/* v8::internal::RegExpBytecodeGenerator::CheckCharacterInRange(unsigned short, unsigned short,
   v8::internal::Label*) */

void __thiscall
v8::internal::RegExpBytecodeGenerator::CheckCharacterInRange
...

{
  ...
  *(undefined4 *)(*(long *)(this + 0x28) + (long)iVar4) = 0x20;
  iVar2 = *(int *)(this + 0x38);
  iVar4 = iVar2 + 4;
  *(int *)(this + 0x38) = iVar4;
