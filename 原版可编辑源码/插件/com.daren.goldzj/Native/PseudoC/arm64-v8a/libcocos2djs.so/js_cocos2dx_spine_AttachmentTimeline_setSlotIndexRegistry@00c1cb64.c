...
/* js_cocos2dx_spine_AttachmentTimeline_setSlotIndexRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_AttachmentTimeline_setSlotIndexRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (AttachmentTimeline *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x64f,"js_cocos2dx_spine_AttachmentTimeline_setSlotIndex");
    puVar6 = &DAT_018f5987;
LAB_00c1ccd8:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::AttachmentTimeline::setSlotIndex(this,local_68);
        goto LAB_00c1cd10;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x656,"js_cocos2dx_spine_AttachmentTimeline_setSlotIndex");
      puVar6 = &DAT_018f59d1;
      goto LAB_00c1ccd8;
    }
    __android_log_print(6,"jswrapper",&DAT_018f5a20,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_AttachmentTimeline_setSlotIndex",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x65d);
LAB_00c1cd10:
