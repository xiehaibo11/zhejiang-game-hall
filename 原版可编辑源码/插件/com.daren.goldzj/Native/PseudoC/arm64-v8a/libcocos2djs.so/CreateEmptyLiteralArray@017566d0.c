...
/* v8::internal::compiler::JSOperatorBuilder::CreateEmptyLiteralArray(v8::internal::compiler::FeedbackSource
   const&) */

Operator * __thiscall
v8::internal::compiler::JSOperatorBuilder::CreateEmptyLiteralArray
...

{
  ...
  Operator::Operator(pOVar3,0x2dc,0x70,"JSCreateEmptyLiteralArray",0,1,1,1,1,0);
