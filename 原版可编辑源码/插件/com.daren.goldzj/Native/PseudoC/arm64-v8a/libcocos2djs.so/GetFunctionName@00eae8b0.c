...
ulong * __thiscall v8::StackFrame::GetFunctionName(StackFrame *this)

{
  ...
  *local_38 = uVar7;
  ...
  puVar2 = (ulong *)internal::StackTraceFrame::GetFunctionName(this);
  puVar5 = local_38;
  pIVar6 = local_50;
  uVar4 = *puVar2;
  if (((uVar4 & 1) != 0) &&
...
LAB_00eaea08:
      ...
      if (*(code **)(lVar3 + 0xb738) == (code *)0x0) goto LAB_00eaea08;
