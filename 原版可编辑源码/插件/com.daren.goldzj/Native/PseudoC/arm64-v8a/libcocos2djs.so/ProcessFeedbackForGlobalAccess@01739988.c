...
/* v8::internal::compiler::JSHeapBroker::ProcessFeedbackForGlobalAccess(v8::internal::compiler::FeedbackSource
   const&) */

undefined8 __thiscall
v8::internal::compiler::JSHeapBroker::ProcessFeedbackForGlobalAccess
...

{
  ...
  *this_00;
  ...
  if (lVar2 == 0) {
    uVar3 = ReadFeedbackForGlobalAccess(this,param_1);
