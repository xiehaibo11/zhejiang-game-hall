    ...
    if ((uVar2 >> 3 & 1) == 0) {
      if ((uVar2 & 0x41) == 0) {
        if ((uVar2 & 0x102) == 0) {
          if ((uVar2 & 0x84) != 0) {
            if (param_4[1] == 0) {
                    /* catch() { ... } // from try @ 00ad9aa4 with catch @ 00ad9a2c */
              iVar14 = 0x19c;
              iVar15 = 0x137;
              iVar20 = 0x93c;
              goto LAB_00ad9860;
            ...
            uVar26 = (ulong)*(byte *)*param_4;
                    /* try { // try from 00ad98a4 to 00bd98ab has its CatchHandler @ 00ad98ac */
            *param_4 = (long)pbVar18;
            param_4[1] = uVar28;
                    /* catch() { ... } // from try @ 00ad97b4 with catch @ 00ad98ac
                       catch() { ... } // from try @ 00ad98a4 with catch @ 00ad98ac
                       try { // try from 00ad98ac to 00bd991f has its CatchHandler @ 00ad9714 */
            if (uVar26 <= uVar28) {
              *param_4 = (long)(pbVar18 + uVar26);
              param_4[1] = uVar28 - uVar26;
              if (uVar28 - uVar26 != 0) goto LAB_00ad98bc;
                    /* try { // try from 00ad9cd8 to 00bd9cdf has its CatchHandler @ 00ad9d40 */
              to = EVP_PKEY_new();
                    /* try { // try from 00ad9ce0 to 00bd9d8b has its CatchHandler @ 00ad9c70 */
              if ((to == (EVP_PKEY *)0x0) ||
...
LAB_00ada194:
                ...
                goto LAB_00ad986c;
                    ...
                    /* catch() { ... } // from try @ 00ada0d0 with catch @ 00ada134 */
              ERR_put_error(0x14,0x19c,0x10,"ssl/statem/statem_srvr.c",0x955);
              goto LAB_00ad9868;
            }
LAB_00ad98bc:
                    /* catch() { ... } // from try @ 00ad9810 with catch @ 00ad98bc */
          ...
          if ((uVar2 >> 5 & 1) != 0) {
            ...
            if (1 < (ulong)param_4[1]) {
              ...
              *param_4 = (long)puVar30;
              ...
              if (uVar26 <= uVar28) {
                    /* catch() { ... } // from try @ 00ad9cd8 with catch @ 00ad9d40 */
                ...
                *(BIGNUM **)(param_3 + 0xd8) = pBVar17;
                if (pBVar17 == (BIGNUM *)0x0) {
                    /* try { // try from 00ada0dc to 00bda0e3 has its CatchHandler @ 00ada0f4 */
                    /* try { // try from 00ada0e4 to 00bda1cb has its CatchHandler @ 00ada09c */
                  iVar14 = 3;
                  iVar15 = 0x97c;
                }
                else {
                  ...
                  if ((-1 < iVar14) ||
                    ...
                    /* catch() { ... } // from try @ 00ad9cac with catch @ 00ad9d70 */
                    ERR_put_error(0x14,0x1a0,0x173,"ssl/statem/statem_srvr.c",0x981);
                    /* catch() { ... } // from try @ 00ad9de4 with catch @ 00ad9d8c */
                    iVar14 = 0x2f;
                    goto LAB_00ad9af0;
                  }
                  ...
                  *(char **)(*(long *)(param_3 + 0x5e) + 0x148) = pcVar19;
                  if (pcVar19 == (char *)0x0) {
                    ...
                    /* catch() { ... } // from try @ 00ada0dc with catch @ 00ada0f4 */
                ERR_put_error(0x14,0x1a0,iVar14,"ssl/statem/statem_srvr.c",iVar15);
                goto LAB_00ad9b00;
              }
            }
                    /* try { // try from 00ad9a9c to 00bd9aa3 has its CatchHandler @ 00ad9b04 */
                    /* try { // try from 00ad9aa4 to 00bd9b4f has its CatchHandler @ 00ad9a2c */
            iVar14 = 0x1a0;
            iVar15 = 0x15b;
            iVar20 = 0x978;
            goto LAB_00ad955c;
          ...
          if ((uVar2 >> 4 & 1) == 0) {
            ...
            iVar15 = 0xf9;
            iVar20 = 0xa28;
                    /* catch() { ... } // from try @ 00ad9988 with catch @ 00ad99f0 */
            goto LAB_00ad983c;
          }
          local_58 = 0x20;
...
LAB_00ada0ac:
            ...
            if (iVar14 < 1) {
                    /* try { // try from 00ada09c to 00bda0cf has its CatchHandler @ 00ada09c
                       catch() { ... } // from try @ 00ada09c with catch @ 00ada09c
                       catch() { ... } // from try @ 00ada0e4 with catch @ 00ada09c */
              iVar14 = 0x44;
              iVar15 = 0x9c1;
              goto LAB_00ada0ac;
            }
              ...
              if (iVar14 == 0) {
                ...
                if (0 < iVar15) {
                  ...
                  param_3[0x1b] = 1;
                    ...
                    /* try { // try from 00ada0d0 to 00bda0d7 has its CatchHandler @ 00ada134 */
              iVar14 = 0x9da;
LAB_00ada160:
...
LAB_00ad9848:
            ...
            *param_4 = (long)(puVar22 + 2);
            param_4[1] = uVar28;
            if (uVar28 != (uint)CONCAT11(uVar3,uVar4)) goto LAB_00ad9848;
            pEVar29 = *(EVP_PKEY **)(lVar21 + 0x230);
            if (pEVar29 != (EVP_PKEY *)0x0) {
              if (uVar28 == 0) {
                iVar14 = 0x19b;
                    /* try { // try from 00ad9cac to 00bd9cbb has its CatchHandler @ 00ad9d70 */
                iVar15 = 0xab;
                iVar20 = 0x906;
                goto LAB_00ad9860;
              }
              *param_4 = (long)(puVar22 + uVar26);
              ...
              if ((to == (EVP_PKEY *)0x0) ||
                ...
                uVar16 = EVP_PKEY_get0_DH(to);
                    /* try { // try from 00ad97b4 to 00bd97bb has its CatchHandler @ 00ad98ac */
                pBVar17 = BN_bin2bn(puVar22 + 2,(uint)CONCAT11(uVar3,uVar4),(BIGNUM *)0x0);
                    /* try { // try from 00ad97bc to 00bd97df has its CatchHandler @ 00ad9714 */
                if (pBVar17 != (BIGNUM *)0x0) {
                  iVar14 = DH_set0_key(uVar16,pBVar17,0);
                  if (iVar14 != 0) {
                    /* try { // try from 00ad97e0 to 00bd97f3 has its CatchHandler @ 00ad98f4 */
                    iVar14 = ssl_derive(param_3,pEVar29,to);
                    if (iVar14 != 0) goto LAB_00ad9d20;
                    iVar14 = 0x19b;
                    iVar15 = 0x920;
                    goto LAB_00ada194;
                  }
...
LAB_00ad9874:
        ...
        if ((*param_3 | 0x200) != 0x300) {
          uVar28 = param_4[1] - 2;
                    /* try { // try from 00ad9988 to 00bd9993 has its CatchHandler @ 00ad99f0 */
          if (1 < (ulong)param_4[1]) {
            puVar22 = (undefined1 *)*param_4;
                    /* try { // try from 00ad9994 to 00bd9a2b has its CatchHandler @ 00ad9920 */
...
LAB_00ad96e4:
        ...
        if (iVar14 < 0x30) {
          ...
          pbVar18 = CRYPTO_malloc(iVar14,"ssl/statem/statem_srvr.c",0x873);
                    /* catch() { ... } // from try @ 00ad9994 with catch @ 00ad9920 */
          if (pbVar18 != (byte *)0x0) {
            ...
            if ((iVar14 < 1) ||
              ...
              iVar14 = 0x33;
                    ...
                    /* catch() { ... } // from try @ 00ad9bc4 with catch @ 00ad9b50 */
              lVar31 = (long)iVar14;
              lVar21 = lVar31 + -0x30;
              ...
              if (2 < lVar31 - 0x31U) {
                uVar28 = lVar31 - 0x33;
                    /* try { // try from 00ad9b8c to 00bd9b9f has its CatchHandler @ 00ad9c54 */
                if ((uVar28 < 0x20) || (uVar26 = uVar28 & 0xffffffffffffffe0, uVar26 == 0)) {
                  ...
                  do {
                    ...
                    uVar27 = uVar27 - 0x20;
                    /* try { // try from 00ad9bbc to 00bd9bc3 has its CatchHandler @ 00ad9c24 */
                    pbVar24 = pbVar24 + 0x20;
                    bVar35 = (byte)((ulong)uVar52 >> 8);
                    bVar38 = (byte)((ulong)uVar52 >> 0x18);
                    bVar40 = (byte)((ulong)uVar52 >> 0x28);
                    /* try { // try from 00ad9bc4 to 00bd9c6f has its CatchHandler @ 00ad9b50 */
                    ...
                    /* catch() { ... } // from try @ 00ad9bbc with catch @ 00ad9c24 */
                    auVar33[0] = auVar34[0] &
                  ...
                  auVar34 = NEON_ext(auVar5,auVar6,8,1);
                    /* catch() { ... } // from try @ 00ad9b8c with catch @ 00ad9c54 */
                  ...
                  bVar35 = bVar35 & auVar34[0] & bVar36 & auVar34[1];
                    /* catch() { ... } // from try @ 00ad9ce0 with catch @ 00ad9c70 */
                  uVar13 = (uint)bVar35;
                  if (uVar28 == uVar26) goto LAB_00ad9dec;
                }
                lVar25 = (lVar31 + -0x31) - uVar23;
                pbVar24 = pbVar18 + uVar23;
                do {
                    /* try { // try from 00ad9dd8 to 00bd9de3 has its CatchHandler @ 00ad9e40 */
                  lVar25 = lVar25 + -1;
                    /* try { // try from 00ad9de4 to 00bd9e7b has its CatchHandler @ 00ad9d8c */
...
LAB_00ad9dec:
              ...
              if (*(char *)((long)param_3 + 0x1e6) < '\0') {
                uVar2 = *param_3;
                    /* catch() { ... } // from try @ 00ad9dd8 with catch @ 00ad9e40 */
              ...
              bVar35 = bVar35 & (byte)((int)(pbVar18[lVar31 - 0x31U] - 1) >> 0x1f) &
                       (char)bVar36 >> 7;
              bVar36 = ~bVar35;
                    /* catch() { ... } // from try @ 00ad9ed8 with catch @ 00ad9e7c */
              if ((pbVar24 < abStack_140) && (local_170 < pbVar24 + 0x30)) {
                ...
                uVar52 = *(undefined8 *)(pbVar1 + 0x10);
                    /* try { // try from 00ad9ecc to 00bd9ed7 has its CatchHandler @ 00ad9f34 */
                ...
                *pbVar1 = local_170[0] & bVar36 | (byte)uVar16 & bVar35;
                ...
                pbVar1[7] = local_170[7] & bVar36 | (byte)((ulong)uVar16 >> 0x38) & bVar35;
                    /* try { // try from 00ad9ed8 to 00bd9f6f has its CatchHandler @ 00ad9e7c */
              ...
              if (iVar14 != 0) {
                ...
                return 2;
                    ...
                    /* catch() { ... } // from try @ 00ad9ecc with catch @ 00ad9f34 */
...
LAB_00ad9ae8:
        ...
        iVar14 = 0x50;
                    ...
                    /* catch() { ... } // from try @ 00ad97bc with catch @ 00ad9714
                       catch() { ... } // from try @ 00ad9818 with catch @ 00ad9714
                       catch() { ... } // from try @ 00ad98ac with catch @ 00ad9714 */
      if (param_4[1] == 0) {
                    /* try { // try from 00ad9810 to 00bd9817 has its CatchHandler @ 00ad98bc */
        iVar14 = ssl_generate_master_secret(param_3,0,0,0);
                    /* try { // try from 00ad9818 to 00bd98a3 has its CatchHandler @ 00ad9714 */
        if (iVar14 != 0) {
          return 2;
        }
        iVar14 = 0x17e;
                    /* catch() { ... } // from try @ 00ad97e0 with catch @ 00ad98f4 */
        iVar15 = 0x44;
        iVar20 = 0xa13;
        goto LAB_00ad9ae8;
      }
...
LAB_00ad9544:
      ...
      puVar22 = (undefined1 *)*param_4;
      uVar26 = (ulong)CONCAT11(*puVar22,puVar22[1]);
      if (uVar28 < uVar26) goto LAB_00ad9544;
          ...
          if (lVar21 == 0) {
            ...
            if (uVar13 < 0x101) {
              ...
              if (uVar13 == 0) {
                ...
                iVar14 = 0x73;
                    /* try { // try from 00ad9a68 to 00bd9a7f has its CatchHandler @ 00ad9b34 */
                goto LAB_00ad9af0;
              }
...
LAB_00ad9b00:
                    /* catch() { ... } // from try @ 00ad9a9c with catch @ 00ad9b04 */
  ...
  *(undefined8 *)(*(long *)(param_3 + 0x24) + 0x2b0) = 0;
  ossl_statem_set_error(param_3);
                    /* catch() { ... } // from try @ 00ad9a68 with catch @ 00ad9b34 */
  return 0;
}
