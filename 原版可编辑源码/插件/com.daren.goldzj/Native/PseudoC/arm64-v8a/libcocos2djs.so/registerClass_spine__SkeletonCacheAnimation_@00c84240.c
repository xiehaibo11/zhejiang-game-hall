...
/* void JSBClassType::registerClass<spine::SkeletonCacheAnimation>(se::Class*) */

void JSBClassType::registerClass<spine::SkeletonCacheAnimation>(Class *param_1)
