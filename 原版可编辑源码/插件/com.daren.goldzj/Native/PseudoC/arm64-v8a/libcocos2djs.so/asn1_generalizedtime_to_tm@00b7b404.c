...
LAB_00b7b804:
        return uVar12 == uVar3;
    ...
    else if ((((uVar5 & 0xff) < 10) && (pbVar9[(long)(int)uVar12 + 2] - 0x30 < 10)) &&
            ((uVar5 = ((uint)pbVar9[(long)(int)uVar12 + 2] + (uint)bVar2 * 10) - 0x210, uVar5 < 0xd
             && (((pbVar9[(long)(int)uVar12 + 3] - 0x30 < 10 &&
                 ...
                 (uVar6 = ((uint)pbVar9[(long)(int)uVar12 + 4] +
                          (uint)pbVar9[(long)(int)uVar12 + 3] * 10) - 0x210, uVar6 < 0x3c)))))) {
      iVar4 = uVar5 * 0xe10 + uVar6 * 0x3c;
      uVar12 = uVar12 + 5;
      if ((iVar4 == 0) || (iVar8 = OPENSSL_gmtime_adj(param_1,0,(long)(iVar4 * iVar8)), iVar8 != 0))
      goto LAB_00b7b804;
    }
  }
  return false;
