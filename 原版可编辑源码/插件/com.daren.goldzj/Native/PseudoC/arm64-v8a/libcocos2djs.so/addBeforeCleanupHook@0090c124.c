...
/* se::ScriptEngine::addBeforeCleanupHook(std::__ndk1::function<void ()> const&) */

void __thiscall se::ScriptEngine::addBeforeCleanupHook(ScriptEngine *this,function *param_1)

{
  ...
  if (lVar1 != *(long *)(this + 0x60)) {
    ...
    *(long *)(this + 0x58) = *(long *)(this + 0x58) + 0x30;
    return;
  }
  std::__ndk1::
