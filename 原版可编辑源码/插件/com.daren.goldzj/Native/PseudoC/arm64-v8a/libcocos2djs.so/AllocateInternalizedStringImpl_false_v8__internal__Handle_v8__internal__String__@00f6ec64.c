...
/* v8::internal::Handle<v8::internal::String>
   v8::internal::Factory::AllocateInternalizedStringImpl<false,
...

{
  ...
  uVar2 = Heap::AllocateRawWithRetryOrFailSlowPath
                    ((Heap *)(this + 0x8850),param_3 * 2 + 0xfU & 0xfffffffc,uVar4,1,0);
  ...
  *(undefined4 *)(*puVar3 + 3) = param_4;
  String::WriteToFlat<unsigned_short>(*param_2,*puVar3 + 0xb,0,param_3);
  return puVar3;
}
