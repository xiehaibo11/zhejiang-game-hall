...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::MemoryOptimizationPhase>()
    */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::MemoryOptimizationPhase>
          (PipelineImpl *this)

{
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFMemoryOptimization");
  MemoryOptimizationPhase::Run(aMStack_18,pPVar5,pZVar2);
