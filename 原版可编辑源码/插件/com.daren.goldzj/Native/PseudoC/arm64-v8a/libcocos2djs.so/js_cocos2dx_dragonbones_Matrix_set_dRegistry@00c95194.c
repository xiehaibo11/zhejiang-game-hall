...
/* js_cocos2dx_dragonbones_Matrix_set_dRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_Matrix_set_dRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xbd,"js_cocos2dx_dragonbones_Matrix_set_d");
    pcVar8 = "js_cocos2dx_dragonbones_Matrix_set_d : Invalid Native Object";
  }
  else {
    local_74 = 0.0;
    ...
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0xc2,"js_cocos2dx_dragonbones_Matrix_set_d");
    pcVar8 = "js_cocos2dx_dragonbones_Matrix_set_d : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar8);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_Matrix_set_d",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0xc6);
LAB_00c95330:
