...
/* v8::internal::compiler::EffectControlLinearizer::BuildCheckedFloat64ToInt64(v8::internal::compiler::CheckForMinusZeroMode,
   v8::internal::compiler::FeedbackSource const&, v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::EffectControlLinearizer::BuildCheckedFloat64ToInt64
...

{
  ...
  pNVar2 = (Node *)GraphAssembler::TruncateFloat64ToInt64(this_00,param_4);
  pNVar3 = (Node *)GraphAssembler::ChangeInt64ToFloat64(this_00,pNVar2);
  ...
  if (param_2 == '\0') {
    ...
    pNVar3 = (Node *)GraphAssembler::Word64Equal(this_00,pNVar2,pNVar3);
