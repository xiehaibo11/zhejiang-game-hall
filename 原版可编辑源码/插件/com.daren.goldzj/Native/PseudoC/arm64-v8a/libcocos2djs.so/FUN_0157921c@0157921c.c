...
undefined8 FUN_0157921c(undefined8 param_1,long param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0x1ce);
  }
  if (DAT_01d471f0 == (byte *)0x0) {
    plVar3 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d471f0 = (byte *)(**(code **)(*plVar3 + 0x10))(plVar3,"disabled-by-default-v8.runtime");
  }
  pbVar2 = DAT_01d471f0;
  local_a0 = (byte **)0x0;
  if ((*DAT_01d471f0 & 5) != 0) {
    ...
    uVar4 = (**(code **)(*plVar3 + 0x18))
                      (plVar3,0x58,pbVar2,"V8.Runtime_Runtime_AwaitPromisesInit",0,0,0,0,0,0,0,
                       &local_50,0);
    plVar3 = local_48;
    local_48 = (long *)0x0;
    if (plVar3 != (long *)0x0) {
    ...
    local_a0 = &local_98;
    local_90 = "V8.Runtime_Runtime_AwaitPromisesInit";
    local_98 = pbVar2;
    local_88 = uVar4;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar6 & 1) != 0) &&
    ...
    if ((((uVar6 & 1) != 0) &&
      ...
      puVar5 = (undefined8 *)FUN_0157a7b4(param_3,param_2);
      uVar7 = *puVar5;
