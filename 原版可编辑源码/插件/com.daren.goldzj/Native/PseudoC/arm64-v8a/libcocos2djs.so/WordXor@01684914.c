...
/* v8::internal::compiler::CodeAssembler::WordXor(v8::internal::SloppyTNode<v8::internal::WordT>,
   v8::internal::SloppyTNode<v8::internal::WordT>) */

void __thiscall
v8::internal::compiler::CodeAssembler::WordXor(CodeAssembler *this,Node *param_2,long *param_3)
...
joined_r0x01684a14:
    ...
    goto joined_r0x01684a14;
  }
  this_00 = (RawMachineAssembler *)**(undefined8 **)this;
  if (this_00[0x30] == (RawMachineAssembler)0x4) {
    pOVar3 = (Operator *)
             MachineOperatorBuilder::Word32Xor((MachineOperatorBuilder *)(this_00 + 0x20));
  }
  else {
    pOVar3 = (Operator *)
             MachineOperatorBuilder::Word64Xor((MachineOperatorBuilder *)(this_00 + 0x20));
  }
  iVar4 = 2;
  local_40 = param_2;
  plStack_38 = param_3;
