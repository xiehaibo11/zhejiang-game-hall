...
undefined8 FUN_00b58004(X509_LOOKUP *param_1,int param_2,X509_NAME *param_3,undefined4 *param_4)

{
  ...
  X509_NAME *local_160;
                    ...
                    /* catch() { ... } // from try @ 00b57da4 with catch @ 00b5801c */
                    /* catch() { ... } // from try @ 00b57ac8 with catch @ 00b58020
                       catch() { ... } // from try @ 00b57b70 with catch @ 00b58020 */
  ...
  str = BUF_MEM_new();
                    /* try { // try from 00b5807c to 00c58147 has its CatchHandler @ 00b5807c
                       catch() { ... } // from try @ 00b5807c with catch @ 00b5807c
                       catch() { ... } // from try @ 00b5820c with catch @ 00b5807c */
  if (str == (BUF_MEM *)0x0) {
    iVar2 = 7;
    iVar3 = 0xf1;
LAB_00b583b4:
    ...
    if (0 < iVar2) {
      ...
      do {
        ...
        if ((param_2 == 2) && (puVar5[2] != 0)) {
          ...
          if (iVar3 < 0) {
                    /* try { // try from 00b58148 to 00c5814f has its CatchHandler @ 00b58290 */
            uVar11 = 0;
            local_260 = 0;
          }
          else {
            ...
            uVar11 = *(uint *)(local_260 + 8);
                    ...
                    /* try { // try from 00b58150 to 00c5815f has its CatchHandler @ 00b58288 */
        ...
        if (param_2 == 1) {
          while( true ) {
            ...
            iVar3 = stat(str->data,&sStack_248);
                    /* try { // try from 00b581f8 to 00c5820b has its CatchHandler @ 00b58290 */
            if (((iVar3 >> 0x1f & 6U) != 0) ||
          ...
          if (param_2 == 2) {
            while( true ) {
                    /* try { // try from 00b5820c to 00c58313 has its CatchHandler @ 00b5807c */
              BIO_snprintf(str->data,str->max,"%s%c%08lx.%s%d",*puVar5,0x2f,uVar4,pcVar10,
                           (ulong)uVar11);
              iVar3 = stat(str->data,&sStack_248);
              if (((iVar3 >> 0x1f & 6U) != 0) ||
            ...
            do {
              ...
              BIO_snprintf(str->data,str->max,"%s%c%08lx.%s%d",*puVar5,0x2f,uVar4,pcVar10,
                           (ulong)uVar11);
              iVar3 = stat(str->data,&sStack_248);
                    /* try { // try from 00b581a0 to 00c581af has its CatchHandler @ 00b5828c */
              uVar1 = uVar11 + 1;
        ...
        if (iVar3 == -1) {
                    /* catch() { ... } // from try @ 00b58148 with catch @ 00b58290
                       catch() { ... } // from try @ 00b581f8 with catch @ 00b58290 */
          puVar7 = (undefined4 *)0x0;
        }
        else {
          puVar7 = (undefined4 *)OPENSSL_sk_value(param_1->store_ctx->objs,iVar3);
                    /* catch() { ... } // from try @ 00b58150 with catch @ 00b58288 */
                    /* catch() { ... } // from try @ 00b581a0 with catch @ 00b5828c */
        }
        CRYPTO_THREAD_unlock(*(undefined8 *)(pcVar8 + 0x10));
        if (param_2 == 2) {
          CRYPTO_THREAD_write_lock(*(undefined8 *)(pcVar8 + 0x10));
          if ((local_260 == 0) &&
            ...
            if (ptr == (ulong *)0x0) {
              CRYPTO_THREAD_unlock(*(undefined8 *)(pcVar8 + 0x10));
                    /* try { // try from 00b58410 to 00c58417 has its CatchHandler @ 00b58470 */
                    /* try { // try from 00b58418 to 00c58467 has its CatchHandler @ 00b58314 */
              iVar2 = 0x41;
              iVar3 = 0x160;
              goto LAB_00b583b4;
            }
            *ptr = uVar4;
                    /* try { // try from 00b58314 to 00c5840f has its CatchHandler @ 00b58314
                       catch() { ... } // from try @ 00b58314 with catch @ 00b58314
                       catch() { ... } // from try @ 00b58418 with catch @ 00b58314
                       catch() { ... } // from try @ 00b58470 with catch @ 00b58314 */
            *(uint *)(ptr + 1) = uVar11;
