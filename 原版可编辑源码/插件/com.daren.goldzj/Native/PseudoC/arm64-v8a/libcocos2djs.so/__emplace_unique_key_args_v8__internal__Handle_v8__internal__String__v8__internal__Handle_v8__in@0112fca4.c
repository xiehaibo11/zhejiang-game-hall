...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<v8::internal::Handle<v8::internal::String>,
   void*>*>, bool> std::__ndk1::__hash_table<v8::internal::Handle<v8::internal::String>,
   ...
   v8::internal::Handle<v8::internal::String> const&>(v8::internal::Handle<v8::internal::String>
   const&, v8::internal::Handle<v8::internal::String> const&) */
      ...
      do {
        ...
        if (uVar5 != uVar3) {
          if (uVar9 < 2) {
            ...
            if (uVar5 - uVar2 * uVar10 == unaff_x25) goto LAB_0112fda4;
            break;
          }
...
LAB_0112fda4:
  ...
  if ((ulong)(*(long *)(this_00 + 0x18) - (long)plVar4) < 0x18) {
    plVar4 = (long *)v8::internal::Zone::NewExpand(this_00,0x18);
  }
  else {
    *(long **)(this_00 + 0x10) = plVar4 + 3;
  }
  lVar6 = *(long *)param_2;
  *plVar4 = 0;
  plVar4[1] = uVar3;
