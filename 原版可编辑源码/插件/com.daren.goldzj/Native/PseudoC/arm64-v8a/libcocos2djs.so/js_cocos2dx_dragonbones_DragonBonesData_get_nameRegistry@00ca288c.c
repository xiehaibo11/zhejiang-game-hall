...
/* js_cocos2dx_dragonbones_DragonBonesData_get_nameRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_DragonBonesData_get_nameRegistry
...

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x7dd,"js_cocos2dx_dragonbones_DragonBonesData_get_name");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_DragonBonesData_get_name : Invalid Native Object");
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_dragonbones_DragonBonesData_get_name",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x7e5);
  }
  else {
    se::Value::Value(aVStack_58);
    std_string_to_seval((basic_string *)(lVar3 + 0x30),aVStack_58);
