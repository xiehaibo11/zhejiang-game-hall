...
/* js_renderer_Scene_removeCameraRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Scene_removeCameraRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Scene *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xbd2,"js_renderer_Scene_removeCamera");
    __android_log_print(6,"jswrapper","js_renderer_Scene_removeCamera : Invalid Native Object");
  }
  else {
...
LAB_0094d140:
          cocos2d::renderer::Scene::removeCamera(this,pCVar6);
          goto LAB_0094d1bc;
        }
      }
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0xbd9,"js_renderer_Scene_removeCamera");
      __android_log_print(6,"jswrapper",
                          "js_renderer_Scene_removeCamera : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 3037): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(puVar4[1] - (long)pVVar5) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Scene_removeCamera",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0xbe0);
LAB_0094d1bc:
