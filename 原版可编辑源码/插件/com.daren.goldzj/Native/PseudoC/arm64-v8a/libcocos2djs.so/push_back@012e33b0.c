...
/* std::__ndk1::__split_buffer<v8::internal::compiler::RepresentationSelector::NodeState*,
   v8::internal::RecyclingZoneAllocator<v8::internal::compiler::RepresentationSelector::NodeState*>&>::push_back(v8::internal::compiler::RepresentationSelector::NodeState*&&)
    */
...

{
  ...
  if (puVar8 != *(undefined8 **)(this + 0x18)) goto LAB_012e3580;
  pvVar14 = *(void **)this;
  __src = *(void **)(this + 8);
  ...
  if (puVar10 != puVar2) {
    ...
    if ((3 < uVar4) && ((puVar10 + uVar6 + 1 <= puVar1 || (puVar3 + uVar11 + uVar6 + 1 <= puVar10)))
      ...
      puVar8 = puVar1 + uVar6;
      puVar7 = puVar1 + uVar6;
      if (uVar4 == uVar6) goto LAB_012e3534;
    }
    do {
      puVar13 = puVar10 + 1;
      *puVar7 = *puVar10;
