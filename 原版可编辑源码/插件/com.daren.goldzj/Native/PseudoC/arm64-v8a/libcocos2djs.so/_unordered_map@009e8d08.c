...

{
  ...
  puVar1 = *(void **)(this + 0x10);
                    /* catch() { ... } // from try @ 009e8930 with catch @ 009e8d1c
                       catch() { ... } // from try @ 009e89a4 with catch @ 009e8d1c */
  while (puVar1 != (void *)0x0) {
                    /* catch() { ... } // from try @ 009e86d8 with catch @ 009e8d28 */
    pvVar2 = (void *)*puVar1;
    if ((*(byte *)(puVar1 + 2) & 1) != 0) {
                    /* catch() { ... } // from try @ 009e87b8 with catch @ 009e8d34
                       catch() { ... } // from try @ 009e87f4 with catch @ 009e8d34 */
