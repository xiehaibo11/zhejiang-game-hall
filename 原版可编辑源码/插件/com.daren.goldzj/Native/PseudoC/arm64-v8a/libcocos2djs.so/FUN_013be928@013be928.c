...
void FUN_013be928(undefined8 param_1,code *param_2)

{
  ...
  *(undefined8 *)(unaff_x26 + 0x40) = 0x13be9ec;
  ...
  *(undefined8 *)(unaff_x26 + 0x38) = 0;
  if (*(long *)(unaff_x26 + 0x2be0) != 0) {
    *(long *)(*(long *)(unaff_x26 + 0x2bf8) + -8) = *(long *)(unaff_x26 + 0x2be0);
                    ...
                    /* WARNING: Could not recover jumptable at 0x013bea58. Too many branches */
