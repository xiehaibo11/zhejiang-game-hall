...
/* std::__ndk1::__deque_base<v8::internal::compiler::RepresentationSelector::NodeState,
  ...
  if (lVar4 - (long)puVar2 != 0) {
    ...
    while (lVar1 != lVar9) {
      while (lVar9 = lVar9 + 0x10, lVar9 - *plVar6 == 0x1000) {
        plVar6 = plVar6 + 1;
        lVar9 = *plVar6;
        if (lVar1 == lVar9) goto LAB_012d3dbc;
      }
    }
  }
LAB_012d3dbc:
...
LAB_012d3e24:
  ...
  if (puVar5 != (undefined8 *)0x0) goto LAB_012d3e14;
  do {
    puVar5 = puVar7;
    puVar5[1] = 0x100;
    *puVar5 = *(undefined8 *)(this + 0x48);
