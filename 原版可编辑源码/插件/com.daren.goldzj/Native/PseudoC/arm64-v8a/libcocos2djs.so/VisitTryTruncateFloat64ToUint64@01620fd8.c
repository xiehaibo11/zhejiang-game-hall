...
/* v8::internal::compiler::InstructionSelector::VisitTryTruncateFloat64ToUint64(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::InstructionSelector::VisitTryTruncateFloat64ToUint64
...

{
  ...
  Emit(this,0xd6,uVar3,(InstructionOperand *)&local_50,1,(InstructionOperand *)&local_28,0,
