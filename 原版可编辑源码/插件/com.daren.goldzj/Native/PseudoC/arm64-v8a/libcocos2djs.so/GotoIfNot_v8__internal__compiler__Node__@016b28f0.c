...
/* void 
   v8::internal::compiler::GraphAssembler::GotoIfNot<v8::internal::compiler::Node*>(v8::internal::compiler::Node*,
   v8::internal::compiler::GraphAssemblerLabel<1>*, v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::GraphAssembler::GotoIfNot<v8::internal::compiler::Node*>
