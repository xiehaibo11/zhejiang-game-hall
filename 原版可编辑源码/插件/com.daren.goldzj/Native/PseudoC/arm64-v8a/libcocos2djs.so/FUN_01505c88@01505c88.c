...
undefined8 FUN_01505c88(undefined8 param_1,undefined8 *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_100,(ulong)&local_100 | 8,0x12e);
  }
  if (DAT_01d46c28 == (byte *)0x0) {
    plVar6 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d46c28 = (byte *)(**(code **)(*plVar6 + 0x10))(plVar6,"disabled-by-default-v8.runtime");
  }
  pbVar4 = DAT_01d46c28;
  local_120 = (byte **)0x0;
  if ((*DAT_01d46c28 & 5) != 0) {
    ...
    uVar7 = (**(code **)(*plVar6 + 0x18))
                      (plVar6,0x58,pbVar4,"V8.Runtime_Runtime_KeyedStoreIC_Miss",0,0,0,0,0,0,0,
                       &local_d8,0);
    pIVar2 = local_d0;
    local_d0 = (Isolate *)0x0;
    ...
    local_120 = &local_118;
    local_110 = "V8.Runtime_Runtime_KeyedStoreIC_Miss";
    local_118 = pbVar4;
    local_108 = uVar7;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if ((int)local_d8 == *(int *)(((ulong)local_d8 & 0xffffffff00000000) + 0xa0)) {
    ...
    if ((local_bc != 0xd) && (local_bc != 3)) {
      ...
      local_d8 = &PTR__IC_01cc6fb8;
      uStack_c0 = local_c4;
      v8::internal::IC::UpdateState((IC *)&local_d8,puVar11,puVar10);
      v8::internal::StoreInArrayLiteralIC::Store
                ((StoreInArrayLiteralIC *)&local_d8,puVar11,puVar10,param_2);
      uVar9 = *param_2;
      goto LAB_01505ebc;
    }
  }
  ...
  local_d8 = &PTR__IC_01cc6f98;
  uStack_c0 = local_c4;
  v8::internal::IC::UpdateState((IC *)&local_d8,puVar11,puVar10);
  pIVar8 = (Isolate *)
           v8::internal::KeyedStoreIC::Store((KeyedStoreIC *)&local_d8,puVar11,puVar10,param_2);
