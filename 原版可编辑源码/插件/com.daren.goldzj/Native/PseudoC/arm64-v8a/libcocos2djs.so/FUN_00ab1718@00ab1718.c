...
void FUN_00ab1718(long param_1)

{
  ...
  long local_38;
                    ...
                    /* try { // try from 00ab172c to 00bb1733 has its CatchHandler @ 00ab17f4 */
  lVar2 = tpidr_el0;
  local_38 = *(long *)(lVar2 + 0x28);
                    /* try { // try from 00ab1734 to 00bb183f has its CatchHandler @ 00ab15c8 */
  ...
  if (iVar3 == 0) {
    ...
    iVar3 = lws_add_http_header_by_token(param_1,0x48,auStack_78,uVar4,&local_80,lVar1);
                    /* catch() { ... } // from try @ 00ab172c with catch @ 00ab17f4 */
