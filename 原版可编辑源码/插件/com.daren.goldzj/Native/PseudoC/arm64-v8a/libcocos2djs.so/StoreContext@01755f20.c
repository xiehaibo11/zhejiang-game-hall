...
Operator * __thiscall
v8::internal::compiler::JSOperatorBuilder::StoreContext
          (JSOperatorBuilder *this,ulong param_1,ulong param_2)

{
  ...
  Operator::Operator(pOVar1,0x2f7,0x28,"JSStoreContext",1,1,1,0,1,0);
  *(ulong *)(pOVar1 + 0x2c) = (ulong)(uint)((int)param_1 << 0x10) | param_2 << 0x20;
