...
/* JSB_glScissorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glScissorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if ((plVar8[1] - *plVar8 & 0xffffffff0U) == 0x40) {
    ...
    if ((uVar3 & uVar4 & uVar5 & uVar6 & 1) != 0) {
      cocos2d::ccScissor(iStack_74,local_78,iStack_7c,local_80);
      goto LAB_008c12ac;
    }
