...
/* cocos2d::middleware::TypedArrayPool::afterInitHandle() */

void __thiscall cocos2d::middleware::TypedArrayPool::afterInitHandle(TypedArrayPool *this)

{
  ...
  if (&local_70 == (undefined ***)local_50) {
    ...
    if (local_50 == (long *)0x0) goto LAB_00d5fab4;
