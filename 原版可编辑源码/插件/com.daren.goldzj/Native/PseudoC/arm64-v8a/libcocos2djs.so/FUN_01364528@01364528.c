...
ulong FUN_01364528(ulong param_1,ulong param_2,ulong param_3,undefined8 param_4,undefined8 param_5,
...

{
  ...
  *(int *)(in_x11 + 3) = in_w8 * 2;
  ...
  if (lVar5 != 7) {
    ...
    while( true ) {
      lVar5 = lVar5 + -8;
      if (*(long *)(param_8 + lVar5) != lVar7) {
        uVar8 = **(ulong **)(unaff_x26 + 0x1428);
        uVar6 = *(undefined8 *)(param_8 + lVar5);
        uVar2 = uVar8 + 0xc;
  ...
  *(uint *)(param_2 - 1) = uVar3;
  ...
  if (*(int *)(uVar2 - 1) == (int)*(undefined8 *)(unaff_x26 + 0xe8)) {
    uVar2 = FUN_01364814(param_1,param_2);
    return uVar2;
  }
  if ((param_3 & 1) == 0) {
  ...
  if (uVar8 < (ulong)((long)((ulong)*(uint *)(uVar2 + 3) << 0x20) >> 0x21)) {
    ...
    *(int *)(uVar2 + lVar5) = (int)param_1;
    if (((((uint)*(undefined8 *)((uVar2 & 0xfffffffffffc0000) + 8) >> 2 & 1) != 0) &&
      ...
      FUN_0133eb00(uVar2,uVar2 + lVar5,0,2);
    }
    return param_1;
  }
                    /* WARNING: Does not return */
  pcVar1 = (code *)SoftwareBreakpoint(0,0x1364f6c);
  (*pcVar1)();
}
