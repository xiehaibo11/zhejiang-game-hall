...
void __thiscall
v8::internal::IdentityMap<unsigned_long*,v8::internal::ZoneAllocationPolicy>::NewPointerArray
          (IdentityMap<unsigned_long*,v8::internal::ZoneAllocationPolicy> *this,ulong param_1)
