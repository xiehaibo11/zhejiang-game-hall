...
/* JSB_glVertexAttrib2fvRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glVertexAttrib2fvRegistry(FunctionCallbackInfo *param_1)
  ...
  if ((plVar7[1] - *plVar7 & 0xffffffff0U) == 0x20) {
    ...
    if (bVar1) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0xae4,"JSB_glVertexAttrib2fv");
      __android_log_print(6,"jswrapper",&DAT_0190552e);
    }
    else {
      glVertexAttrib2fv(local_7c,local_50);
    }
    if (local_40 != '\0') {
      free(local_50);
    }
    if (!bVar1) goto LAB_008c8b58;
  }
  else {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                        ,0xadd,"JSB_glVertexAttrib2fv");
    __android_log_print(6,"jswrapper","Invalid number of arguments");
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "JSB_glVertexAttrib2fv",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                      ,0xaea);
LAB_008c8b58:
