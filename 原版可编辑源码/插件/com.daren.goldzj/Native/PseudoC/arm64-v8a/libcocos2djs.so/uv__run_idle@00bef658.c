...
void uv__run_idle(long param_1)

{
  ...
  pppplVar1 = (long ****)(param_1 + 0x1a0);
  pppplVar2 = *(long *****)(param_1 + 0x1a0);
  if (pppplVar1 != pppplVar2) {
    local_10 = *(undefined8 **)(param_1 + 0x1a8);
    *local_10 = &local_18;
    ppplVar3 = pppplVar2[1];
    *(long ****)(param_1 + 0x1a8) = ppplVar3;
    *ppplVar3 = (long **)pppplVar1;
    ...
    while ((long ****)local_18 != &local_18) {
      ...
      *local_18 = (long **)pppplVar1;
      ppplVar3 = *(long ****)(param_1 + 0x1a8);
      local_18[1] = (long **)ppplVar3;
      *ppplVar3 = (long **)local_18;
      *(long ****)(param_1 + 0x1a8) = local_18;
