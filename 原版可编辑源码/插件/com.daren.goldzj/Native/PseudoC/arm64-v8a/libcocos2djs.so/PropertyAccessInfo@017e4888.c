...
/* v8::internal::compiler::PropertyAccessInfo::PropertyAccessInfo(v8::internal::Zone*,
   ...
   v8::internal::MaybeHandle<v8::internal::JSObject>, v8::internal::Handle<v8::internal::Object>,
...

{
  ...
  *(undefined4 *)this = param_3;
  this_00 = (Zone *)param_6[3];
  *(undefined8 *)(this + 8) = 0;
  *(undefined8 *)(this + 0x10) = 0;
  *(undefined8 *)(this + 0x18) = 0;
  *(Zone **)(this + 0x20) = this_00;
  uVar2 = param_6[1] - *param_6;
  if (uVar2 != 0) {
    ...
    *(undefined8 **)(this + 0x18) = puVar3 + ((long)uVar2 >> 3);
    puVar1 = (undefined8 *)param_6[1];
    for (puVar4 = (undefined8 *)*param_6; puVar4 != puVar1; puVar4 = puVar4 + 1) {
      *puVar3 = *puVar4;
  ...
  *(undefined8 *)(this + 0x70) = 0xffffffff;
  return;
}
