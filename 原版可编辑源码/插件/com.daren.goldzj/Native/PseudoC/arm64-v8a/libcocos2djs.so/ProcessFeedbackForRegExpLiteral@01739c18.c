...
/* v8::internal::compiler::JSHeapBroker::ProcessFeedbackForRegExpLiteral(v8::internal::compiler::FeedbackSource
   const&) */

undefined8 __thiscall
v8::internal::compiler::JSHeapBroker::ProcessFeedbackForRegExpLiteral
...

{
  ...
  *this_00;
  ...
  if (lVar2 == 0) {
    uVar3 = ReadFeedbackForRegExpLiteral(this,param_1);
