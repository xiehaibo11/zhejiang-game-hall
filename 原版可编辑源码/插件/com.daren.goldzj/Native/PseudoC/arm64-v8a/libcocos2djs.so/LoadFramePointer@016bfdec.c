...
/* v8::internal::compiler::GraphAssembler::LoadFramePointer() */

Node * __thiscall v8::internal::compiler::GraphAssembler::LoadFramePointer(GraphAssembler *this)

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::LoadFramePointer
                     ((MachineOperatorBuilder *)(*(undefined8 **)(this + 0x18))[2]);
  local_38 = (Node *)0x0;
  pNVar3 = (Node *)Graph::NewNode(this_00,pOVar2,0,&local_38,false);
