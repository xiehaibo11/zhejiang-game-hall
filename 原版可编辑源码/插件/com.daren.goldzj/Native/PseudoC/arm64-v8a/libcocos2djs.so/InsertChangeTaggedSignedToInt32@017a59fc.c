...
/* v8::internal::compiler::RepresentationChanger::InsertChangeTaggedSignedToInt32(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::RepresentationChanger::InsertChangeTaggedSignedToInt32
