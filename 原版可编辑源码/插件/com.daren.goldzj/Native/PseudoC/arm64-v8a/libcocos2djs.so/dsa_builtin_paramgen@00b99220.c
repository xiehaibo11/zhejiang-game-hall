...
LAB_00b99640:
              do {
                if (0 < (long)sVar15) {
                  ...
                  acStack_c1[sVar15] = cVar2 + '\x01';
                  sVar15 = sVar15 - 1;
                  if ((char)(cVar2 + '\x01') == '\0') goto LAB_00b99640;
                }
...
LAB_00b99858:
    ...
    if (iVar6 == 0) {
      ...
      *(BIGNUM **)(param_1 + 0x20) = pBVar7;
      if (*(long *)(param_1 + 0x10) == 0) goto LAB_00b99968;
      uVar23 = 0;
