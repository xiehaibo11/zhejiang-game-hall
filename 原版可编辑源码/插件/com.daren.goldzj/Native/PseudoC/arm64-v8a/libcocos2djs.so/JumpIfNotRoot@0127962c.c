...
/* v8::internal::MacroAssembler::JumpIfNotRoot(v8::internal::Register const&,
   v8::internal::RootIndex, v8::internal::Label*) */
...

{
  ...
  *(undefined8 *)(this + 0x1a8) = uVar4;
  TurboAssembler::B((TurboAssembler *)this,param_4,1);
