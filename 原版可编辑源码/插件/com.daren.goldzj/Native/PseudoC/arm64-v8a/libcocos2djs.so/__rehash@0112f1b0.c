...
/* std::__ndk1::__hash_table<v8::internal::Handle<v8::internal::String>,
   ...
   v8::internal::ZoneAllocator<v8::internal::Handle<v8::internal::String> > >::__rehash(unsigned
   long) */
...
::__rehash(__hash_table<v8::internal::Handle<v8::internal::String>,v8::internal::StringHandleHash,v8::internal::StringHandleEqual,v8::internal::ZoneAllocator<v8::internal::Handle<v8::internal::String>>>
           *this,ulong param_1)
