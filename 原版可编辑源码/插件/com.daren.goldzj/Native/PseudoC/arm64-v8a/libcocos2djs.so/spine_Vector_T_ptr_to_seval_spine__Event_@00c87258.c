...
/* bool spine_Vector_T_ptr_to_seval<spine::Event>(spine::Vector<spine::Event*> const&, se::Value*)
    */

bool spine_Vector_T_ptr_to_seval<spine::Event>(Vector *param_1,Value *param_2)
...
LAB_00c87320:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::Event>
