...
::operator()(__func<v8::internal::compiler::JSCallReducerAssembler::Forever(v8::internal::TNode<v8::internal::UnionT<v8::internal::Smi,v8::internal::HeapNumber>>,std::__ndk1::function<v8::internal::TNode<v8::internal::UnionT<v8::internal::Smi,v8::internal::HeapNumber>>(v8::internal::TNode<v8::internal::UnionT<v8::internal::Smi,v8::internal::HeapNumber>>)>const&)::_lambda(v8::internal::TNode<v8::internal::UnionT<v8::internal::Smi,v8::internal::HeapNumber>>)_1_,std::__ndk1::allocator<v8::internal::compiler::JSCallReducerAssembler::Forever(v8::internal::TNode<v8::internal::UnionT<v8::internal::Smi,v8::internal::HeapNumber>>,std::__ndk1::function<v8::internal::TNode<v8::internal::UnionT<v8::internal::Smi,v8::internal::HeapNumber>>(v8::internal::TNode<v8::internal::UnionT<v8::internal::Smi,v8::internal::HeapNumber>>)>const&)::_lambda(v8::internal::TNode<v8::internal::UnionT<v8::internal::Smi,v8::internal::HeapNumber>>)_1_>,v8::internal::TNode<v8::internal::Oddball>(v8::internal::TNode<v8::internal::UnionT<v8::internal::Smi,v8::internal::HeapNumber>>)>
             *this,TNode *param_1)

{
  v8::internal::compiler::GraphAssembler::TrueConstant(*(GraphAssembler **)(this + 8));
  return;
}
