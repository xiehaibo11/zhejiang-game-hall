...
ulong FUN_00b53d24(undefined8 *param_1,byte *param_2)

{
  ...
  if ((iVar17 < 1) ||
     (pcVar6 = strchr(s_0123456789ABCDEFGHIJKLMNOPQRSTUV_01d20958,(uint)bVar3),
     pcVar6 == (char *)0x0)) {
    return 0;
  }
  uVar13 = 0;
  do {
    uVar10 = uVar13 + 1;
    *(char *)((long)param_1 + uVar13) = (char)pcVar6 + -0x58;
    if ((long)iVar17 <= (long)uVar10) {
      uVar10 = (ulong)((int)uVar13 + 1);
      goto LAB_00b53df8;
    }
    pcVar6 = strchr(s_0123456789ABCDEFGHIJKLMNOPQRSTUV_01d20958,(uint)param_2[uVar13 + 1]);
    uVar13 = uVar10;
