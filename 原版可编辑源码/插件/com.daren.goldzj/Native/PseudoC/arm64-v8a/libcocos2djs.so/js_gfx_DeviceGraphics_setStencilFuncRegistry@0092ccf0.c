...
/* js_gfx_DeviceGraphics_setStencilFuncRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_gfx_DeviceGraphics_setStencilFuncRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (pDVar8 == (DeviceGraphics *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x255,"js_gfx_DeviceGraphics_setStencilFunc");
    __android_log_print(6,"jswrapper","js_gfx_DeviceGraphics_setStencilFunc : Invalid Native Object"
                       );
  }
  else {
    ...
    if (uVar11 == 0x30) {
      ...
      if ((uVar4 & uVar5 & uVar6 & 1) != 0) {
        cocos2d::renderer::DeviceGraphics::setStencilFunc
                  (pDVar8,uVar11 & 0xffffffff,uVar3 & 0xffffffff,local_88._4_4_);
        goto LAB_0092cef4;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                          ,0x260,"js_gfx_DeviceGraphics_setStencilFunc");
      __android_log_print(6,"jswrapper",
                          "js_gfx_DeviceGraphics_setStencilFunc : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp, 612): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar11 >> 4,3);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_gfx_DeviceGraphics_setStencilFunc",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                      ,0x267);
LAB_0092cef4:
