...
int FUN_00b0662c(uchar *param_1,BIGNUM *param_2,DH *param_3)

{
  ...
  int local_44;
                    ...
                    /* try { // try from 00b06650 to 00c0665b has its CatchHandler @ 00b067ec */
  iVar1 = BN_num_bits(param_3->p);
                    /* try { // try from 00b0665c to 00c06873 has its CatchHandler @ 00b05eb8 */
  if (10000 < iVar1) {
...
LAB_00b06714:
    ...
    if (pBVar2 != (BN_MONT_CTX *)0x0) goto LAB_00b06714;
  }
  iVar1 = -1;
LAB_00b067ac:
  BN_CTX_end(ctx);
