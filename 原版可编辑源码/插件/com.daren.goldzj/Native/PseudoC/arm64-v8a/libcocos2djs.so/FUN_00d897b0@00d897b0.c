...
void FUN_00d897b0(long param_1,long param_2,uint *param_3,uint param_4,long param_5,uint *param_6,
                 uint param_7)
    ...
    do {
      ...
      *(int *)(lVar7 + 100) = iVar10;
      ...
      if ((iVar5 == 0) && (iVar10 < iVar9)) {
        ...
        if (0 < iVar5) {
          lVar8 = 0;
          if (iVar9 <= iVar10) goto LAB_00d898e0;
          do {
...
LAB_00d89904:
      ...
      else if (iVar10 == iVar9) goto LAB_00d89904;
