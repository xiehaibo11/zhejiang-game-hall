...
void Java_org_cocos2dx_lib_Cocos2dxGLSurfaceView_nativeOnSizeChanged
...

{
  ...
  lVar6 = cocos2d::Application::_instance;
  lVar4 = tpidr_el0;
  local_38 = *(long *)(lVar4 + 0x28);
  if (cocos2d::Application::_instance == 0) goto LAB_0085c09c;
  *(float *)(cocos2d::Application::_instance + 0x2c) = (float)param_3;
  *(float *)(lVar6 + 0x30) = (float)param_4;
  ...
  uStack_68 = CONCAT44(param_4,param_3);
