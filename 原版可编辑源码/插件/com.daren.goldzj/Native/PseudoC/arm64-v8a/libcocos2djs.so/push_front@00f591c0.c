...
/* std::__ndk1::__split_buffer<std::__ndk1::pair<void (*)(v8::Isolate*, void*), void*>*,
   std::__ndk1::allocator<std::__ndk1::pair<void (*)(v8::Isolate*, void*),
   void*>*>&>::push_front(std::__ndk1::pair<void (*)(v8::Isolate*, void*), void*>* const&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_00f5934c;
...
LAB_00f59320:
      ...
      if (((void *)((long)pvVar4 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar4 + uVar9 + uVar13 * 8 + 8))) goto LAB_00f59320;
      ...
      puVar7 = puVar8;
      if (uVar2 != uVar9) goto LAB_00f59320;
    }
