...
void __thiscall
std::__ndk1::moneypunct_byname<char,false>::init(moneypunct_byname<char,false> *this,char *param_1)

{
  ...
  mbstate_t *pmVar6;
  undefined8 uVar7;
  moneypunct_byname<char,false> mVar8;
  void *__dest;
  uint uVar9;
  moneypunct_byname<char,false> *__s;
  ulong uVar10;
  byte *__s_00;
  ulong local_88;
  size_t local_80;
...
LAB_018256ac:
  ...
  __s = (moneypunct_byname<char,false> *)plVar4->mon_decimal_point;
  mVar8 = *__s;
  if (mVar8 == (moneypunct_byname<char,false>)0x0) goto LAB_01825424;
  if (__s[1] == (moneypunct_byname<char,false>)0x0) {
LAB_01825428:
    this[0x10] = mVar8;
  }
  else {
...
LAB_01825424:
      mVar8 = (moneypunct_byname<char,false>)0xff;
      goto LAB_01825428;
    }
    p_Var3 = uselocale(__dataset);
    iVar2 = wctob(__c);
    ...
    if (iVar2 == -1) {
      if ((__c == L'\x202f') || (__c == L'\xa0')) {
        mVar8 = (moneypunct_byname<char,false>)0x20;
        goto LAB_01825428;
      }
      goto LAB_01825424;
    }
  ...
  uVar9 = (uint)*__s_00;
  if (*__s_00 != 0) {
    if (__s_00[1] == 0) goto LAB_0182548c;
    local_70.__count = 0;
    local_70.__value = (_union_27)0x0;
    ...
    if (sVar5 < 0xfffffffffffffffe) {
      ...
      if (((uVar9 != 0xffffffff) || (uVar9 = 0x20, (wchar_t)local_88 == L'\xa0')) ||
         ((wchar_t)local_88 == L'\x202f')) goto LAB_0182548c;
    }
  }
  uVar9 = 0xff;
LAB_0182548c:
  ...
  this_00 = (basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
            (this + 0x30);
  basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::assign
            (this_00,plVar4->currency_symbol);
  uVar9 = 0;
  if ((byte)plVar4->frac_digits != 0xff) {
    uVar9 = (uint)(byte)plVar4->frac_digits;
  }
  *(uint *)(this + 0x78) = uVar9;
  if (plVar4->p_sign_posn == '\0') {
    basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::assign
              ((basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *)
               (this + 0x48),"()");
  }
  ...
  FUN_018257f0(this + 0x7c,&local_70,0,plVar4->p_cs_precedes,plVar4->p_sep_by_space,
               plVar4->p_sign_posn);
  FUN_018257f0(this + 0x80,this_00,0,plVar4->n_cs_precedes,plVar4->n_sep_by_space,
               plVar4->n_sign_posn);
  if (((ulong)local_70 & 1) != 0) {
    operator_delete((void *)local_60);
  }
