...
/* void 
   v8::internal::SmallOrderedHashTable<v8::internal::SmallOrderedHashSet>::BodyDescriptor::IterateBody<v8::internal::YoungGenerationMarkingVisitor>(v8::internal::Map,
   v8::internal::HeapObject, int, v8::internal::YoungGenerationMarkingVisitor*) */

void v8::internal::SmallOrderedHashTable<v8::internal::SmallOrderedHashSet>::BodyDescriptor::
...

{
  ...
  puVar2 = puVar1 + (ulong)*(byte *)(param_2 + 5) * 2;
  if (puVar2 <= puVar1) {
    return;
  }
  uVar4 = *puVar1;
