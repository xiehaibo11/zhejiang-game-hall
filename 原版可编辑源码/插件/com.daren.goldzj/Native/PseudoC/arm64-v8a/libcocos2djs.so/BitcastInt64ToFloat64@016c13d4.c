...
/* v8::internal::compiler::GraphAssembler::BitcastInt64ToFloat64(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::BitcastInt64ToFloat64(GraphAssembler *this,Node *param_1)
