...
/* js_renderer_Assembler_constructorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Assembler_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  uVar5 = se::Object::getProperty(this,"_ctor",aVStack_70);
                    /* try { // try from 0095299c to 00a52ae7 has its CatchHandler @ 00952b3c */
  if ((uVar5 & 1) != 0) {
