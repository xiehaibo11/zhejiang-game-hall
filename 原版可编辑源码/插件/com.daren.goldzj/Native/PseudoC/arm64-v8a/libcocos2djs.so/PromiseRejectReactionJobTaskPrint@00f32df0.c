...
/* v8::internal::PromiseRejectReactionJobTask::PromiseRejectReactionJobTaskPrint(std::__ndk1::basic_ostream<char,
   std::__ndk1::char_traits<char> >&) */

void __thiscall
v8::internal::PromiseRejectReactionJobTask::PromiseRejectReactionJobTaskPrint
          (PromiseRejectReactionJobTask *this,basic_ostream *param_1)

{
  basic_ostream *pbVar1;
  ulong local_28;
  
  HeapObject::PrintHeader((HeapObject *)this,param_1,"PromiseRejectReactionJobTask");
