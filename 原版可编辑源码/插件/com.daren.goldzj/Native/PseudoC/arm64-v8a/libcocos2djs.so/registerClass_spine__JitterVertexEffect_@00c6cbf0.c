...
/* void JSBClassType::registerClass<spine::JitterVertexEffect>(se::Class*) */

void JSBClassType::registerClass<spine::JitterVertexEffect>(Class *param_1)
