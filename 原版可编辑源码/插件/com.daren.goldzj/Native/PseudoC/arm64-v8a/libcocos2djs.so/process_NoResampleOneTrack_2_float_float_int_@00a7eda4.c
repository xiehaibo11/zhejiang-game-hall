...
/* void cocos2d::AudioMixer::process_NoResampleOneTrack<2, float, float,
   int>(cocos2d::AudioMixer::state_t*, long) */

void cocos2d::AudioMixer::process_NoResampleOneTrack<2,float,float,int>
...

{
  ...
  long lVar15;
                    ...
                    /* try { // try from 00a7edb4 to 00b7edbf has its CatchHandler @ 00a7ef20 */
                    /* try { // try from 00a7edc0 to 00b7edcb has its CatchHandler @ 00a7ef1c */
                    /* try { // try from 00a7edcc to 00b7eea7 has its CatchHandler @ 00a7ef34 */
  ...
  if (lVar15 != 0) {
    ...
    __s = *(float **)(param_1 + lVar10 * 0xd0 + 0xa8);
    ...
    do {
      ...
      *(long *)psVar2 = lVar15;
      ...
      if ((pfVar13 == (float *)0x0) || (((ulong)pfVar13 & 3) != 0)) {
                    /* catch() { ... } // from try @ 00a7ed94 with catch @ 00a7ef24 */
                    /* catch() { ... } // from try @ 00a7edcc with catch @ 00a7ef34 */
      ...
      uVar14 = *(ulong *)psVar2;
                    /* try { // try from 00a7eea8 to 00b7ef8b has its CatchHandler @ 00a7ed40 */
      volumeMix<2,true,false,float,float,int>
  ...
  if ((iVar5 == 0 && iVar4 == 0) && iVar6 == 0) {
                    /* try { // try from 00a7ef8c to 00b7efdf has its CatchHandler @ 00a7ef8c
                       catch() { ... } // from try @ 00a7ef8c with catch @ 00a7ef8c
                       catch() { ... } // from try @ 00a7f0f4 with catch @ 00a7ef8c */
    return;
  }
                    /* catch() { ... } // from try @ 00a7edc0 with catch @ 00a7ef1c */
                    /* catch() { ... } // from try @ 00a7edb4 with catch @ 00a7ef20 */
