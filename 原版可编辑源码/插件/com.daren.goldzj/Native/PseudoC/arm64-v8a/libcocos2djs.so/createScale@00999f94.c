...
/* cocos2d::Mat4::createScale(cocos2d::Vec3 const&, cocos2d::Mat4*) */

void cocos2d::Mat4::createScale(Vec3 *param_1,Mat4 *param_2)

{
  ...
  *(undefined4 *)(param_2 + 0x14) = *(undefined4 *)(param_1 + 4);
                    /* try { // try from 00999fbc to 00a99ff7 has its CatchHandler @ 0099a0c0 */
  *(undefined4 *)(param_2 + 0x28) = *(undefined4 *)(param_1 + 8);
  return;
}
