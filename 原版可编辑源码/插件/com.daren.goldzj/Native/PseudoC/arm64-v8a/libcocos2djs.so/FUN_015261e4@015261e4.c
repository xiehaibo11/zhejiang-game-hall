...
void FUN_015261e4(Factory *param_1,ulong *param_2,uint param_3,int param_4,int param_5,ulong param_6
                 )

{
  ...
  local_58 = (ulong)(uVar5 & ((uint)(uVar12 >> 0x16) ^ (uint)uVar12) & 0x3fffffff);
  uVar3 = *(uint *)(((long)(local_58 * 0xc00000000 + 0x1000000000) >> 0x20) + uVar13 + 7);
    ...
    do {
      if (uVar3 != (uint)*(undefined8 *)(param_1 + 0xa8)) {
        ...
        if ((int)dVar17 == param_3) {
          lVar8 = (ulong)(uint)((int)local_58 * 3) << 0x22;
          ...
          if (param_5 == 0) {
                ...
                if (iVar14 < param_4) {
                  ...
                  *puVar15 = (uint)param_6;
                  ...
                  if (((uint)uVar10 >> 0x12 & 1) != 0) {
                    v8::internal::Heap_MarkingBarrierSlow(uVar12,puVar15,param_6);
                    uVar10 = *(ulong *)(param_6 & 0xfffffffffffc0000 | 8);
                  }
                  if ((uVar10 & 0x18) == 0) {
                    return;
                  ...
                  *puVar16 = (uint)param_6;
                  ...
                  uVar10 = *(ulong *)((param_6 & 0xfffffffffffc0000) + 8);
                  if (((uint)uVar10 >> 0x12 & 1) != 0) {
                    v8::internal::Heap_MarkingBarrierSlow(uVar12,puVar16,param_6);
                    uVar10 = *(ulong *)(param_6 & 0xfffffffffffc0000 | 8);
                  }
                  if ((uVar10 & 0x18) == 0) {
                    return;
            ...
            *(uint *)(lVar9 + lVar1) = uVar3 | 0x1a0;
            uVar12 = *param_2;
            lVar1 = uVar12 + ((long)(local_58 * 0xc00000000 + 0x1400000000) >> 0x20);
            *(int *)(lVar1 + 7) = (int)param_6;
            ...
            if (((uVar5 & 1) != 0) &&
              ...
              local_38 = uVar12;
              v8::internal::AccessorPair::set((AccessorPair *)&local_38,param_5 != 1,param_6);
              return;
            }
            puVar6 = (ulong *)v8::internal::Factory::NewAccessorPair(param_1);
            local_38 = *puVar6;
            v8::internal::AccessorPair::set((AccessorPair *)&local_38,param_5 != 1,param_6);
            *(uint *)(*param_2 + ((long)(local_58 * 0xc00000000 + 0x1800000000) >> 0x20) + 7) =
                 uVar3 | 0x1a2;
            uVar12 = *param_2;
            param_6 = *puVar6;
            lVar1 = uVar12 + ((long)(local_58 * 0xc00000000 + 0x1400000000) >> 0x20);
...
joined_r0x015266a4:
          ...
          v8::internal::Heap_GenerationalBarrierSlow(uVar12,puVar15,param_6);
          return;
        }
      }
      local_58 = (ulong)((int)local_58 + iVar14 & uVar5);
      uVar3 = *(uint *)(((long)(local_58 * 0xc00000000 + 0x1000000000) >> 0x20) + uVar13 + 7);
      iVar14 = iVar14 + 1;
  ...
  piVar7 = (int *)v8::internal::
                  Dictionary<v8::internal::NumberDictionary,v8::internal::NumberDictionaryShape>::
                  Add(param_1,param_2,param_3,puVar6,param_5 != 0 | 0xd0,&local_58);
  if (*piVar7 == (int)*param_2) {
    local_38 = *param_2;
    v8::internal::NumberDictionary::UpdateMaxNumberKey((NumberDictionary *)&local_38,param_3,0);
