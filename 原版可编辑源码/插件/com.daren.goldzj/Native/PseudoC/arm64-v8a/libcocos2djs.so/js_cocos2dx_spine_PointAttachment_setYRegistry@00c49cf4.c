...
/* js_cocos2dx_spine_PointAttachment_setYRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_PointAttachment_setYRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (PointAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1ea5,"js_cocos2dx_spine_PointAttachment_setY");
    pcVar6 = "js_cocos2dx_spine_PointAttachment_setY : Invalid Native Object";
LAB_00c49e68:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::PointAttachment::setY(this,local_64);
        goto LAB_00c49ea0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1eac,"js_cocos2dx_spine_PointAttachment_setY");
      pcVar6 = "js_cocos2dx_spine_PointAttachment_setY : Error processing arguments";
      goto LAB_00c49e68;
    }
    __android_log_print(6,"jswrapper",&DAT_0190bbe7,uVar7 >> 4,1);
  }
