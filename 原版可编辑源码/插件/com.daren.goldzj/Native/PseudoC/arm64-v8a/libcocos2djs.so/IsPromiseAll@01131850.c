...
/* v8::internal::StackTraceFrame::IsPromiseAll(v8::internal::Handle<v8::internal::StackTraceFrame>)
    */

byte v8::internal::StackTraceFrame::IsPromiseAll(ulong *param_1)
