...
long FUN_00b6f8b0(X509V3_EXT_METHOD *param_1,X509V3_CTX *param_2,undefined8 param_3)
            ...
            if (pAVar5 != (ASN1_VALUE *)0x0) {
              ...
              if (0 < iVar2) {
                ...
                do {
                  ...
                  iVar3 = FUN_00b703ac(pAVar5,param_2,lVar7);
                  if (iVar3 < 1) {
                    if (iVar3 < 0) goto LAB_00b6fabc;
                    __s1 = *(char **)(lVar7 + 8);
                    iVar3 = strcmp(__s1,"reasons");
                    if (iVar3 == 0) {
                      iVar3 = FUN_00b70590(pAVar5 + 8,*(undefined8 *)(lVar7 + 0x10));
                      if (iVar3 == 0) goto LAB_00b6fabc;
                    }
                    else {
                      iVar3 = strcmp(__s1,"CRLissuer");
                      if (iVar3 == 0) {
                        lVar7 = FUN_00b707ac(param_2,*(undefined8 *)(lVar7 + 0x10));
                        *(long *)(pAVar5 + 0x10) = lVar7;
                        if (lVar7 == 0) goto LAB_00b6fabc;
                      }
                    }
                  }
                  iVar2 = iVar2 + 1;
...
LAB_00b6fabc:
        ...
        pAVar5 = ASN1_item_new((ASN1_ITEM *)DIST_POINT_it);
        a = (GENERAL_NAME *)0x0;
        if (pAVar5 == (ASN1_VALUE *)0x0) goto LAB_00b6fb18;
        iVar2 = OPENSSL_sk_push(lVar4,pAVar5);
        if (iVar2 == 0) {
          ASN1_item_free(pAVar5,(ASN1_ITEM *)DIST_POINT_it);
          goto LAB_00b6fb14;
        ...
        *(ASN1_VALUE **)pAVar5 = pAVar6;
        if (pAVar6 == (ASN1_VALUE *)0x0) goto LAB_00b6fb14;
