...
/* v8::internal::AssemblerBase::Print(v8::internal::Isolate*) */

void __thiscall v8::internal::AssemblerBase::Print(AssemblerBase *this,Isolate *param_1)

{
  ...
  local_130 = 0;
  Disassembler::Decode
            ((Disassembler *)param_1,&local_148,*(undefined8 *)(this + 0x10),
             *(undefined8 *)(this + 0x20),0,0,0);
  local_148 = &PTR__StdoutStream_01ca1128;
  local_e8[0] = &PTR__StdoutStream_01ca1150;
