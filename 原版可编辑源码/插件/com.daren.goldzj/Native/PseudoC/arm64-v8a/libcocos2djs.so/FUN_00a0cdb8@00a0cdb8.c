...
void * FUN_00a0cdb8(long param_1,ulong param_2,long param_3,uint *param_4)

{
  ...
  *__ptr = 0;
  ...
  uVar10 = (ulong)uVar9;
  pvVar13 = (void *)0x0;
  if ((uVar9 < uVar5 - 7) || (uVar5 - 4 < uVar9)) goto LAB_00a0d03c;
  pvVar13 = malloc((ulong)(uVar9 + 1));
                    /* try { // try from 00a0cfa0 to 00b0d013 has its CatchHandler @ 00a0cfa0
                       catch() { ... } // from try @ 00a0cfa0 with catch @ 00a0cfa0
                       catch() { ... } // from try @ 00a0d030 with catch @ 00a0cfa0
                       catch() { ... } // from try @ 00a0d230 with catch @ 00a0cfa0 */
  if (uVar9 == 0) {
    uVar10 = 0;
  }
  else {
    if (uVar9 == 1) {
      ...
      if (uVar12 == uVar10) goto LAB_00a0d034;
    }
    uVar14 = (int)uVar12 << 3;
    do {
                    /* try { // try from 00a0d014 to 00b0d02f has its CatchHandler @ 00a0d294 */
      uVar5 = uVar14 & 0x18;
      uVar14 = uVar14 + 8;
