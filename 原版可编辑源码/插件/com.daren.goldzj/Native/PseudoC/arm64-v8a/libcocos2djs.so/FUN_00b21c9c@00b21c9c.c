...
undefined8 FUN_00b21c9c(EVP_CIPHER_CTX *param_1,undefined8 param_2,undefined8 param_3,ulong param_4)

{
  ...
  if (iVar1 == 0) {
    ...
    uVar2 = EVP_CIPHER_CTX_encrypting(param_1);
    CRYPTO_cfb128_1_encrypt
              (param_3,param_2,param_4,lVar3,uVar4,&local_54,uVar2,*(undefined8 *)(lVar3 + 0x118));
    uVar2 = local_54;
  }
