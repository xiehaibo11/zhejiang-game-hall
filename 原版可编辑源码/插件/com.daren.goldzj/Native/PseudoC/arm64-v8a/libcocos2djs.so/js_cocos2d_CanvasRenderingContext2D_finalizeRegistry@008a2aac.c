...
/* js_cocos2d_CanvasRenderingContext2D_finalizeRegistry(void*) */

void js_cocos2d_CanvasRenderingContext2D_finalizeRegistry(void *param_1)

{
  ...
  if (param_1 != (void *)0x0) {
    ...
    if (lVar3 != lVar4) {
      ...
      this_00 = (CanvasRenderingContext2D *)se::State::nativeThisObject(aSStack_60);
      if (this_00 != (CanvasRenderingContext2D *)0x0) {
        cocos2d::CanvasRenderingContext2D::~CanvasRenderingContext2D(this_00);
