...
/* v8::internal::compiler::JSGraph::FixedArrayMapConstant() */

void __thiscall v8::internal::compiler::JSGraph::FixedArrayMapConstant(JSGraph *this)
