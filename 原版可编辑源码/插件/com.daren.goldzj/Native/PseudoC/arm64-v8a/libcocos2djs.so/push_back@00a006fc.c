...

{
  ...
  if (puVar14 != *(undefined8 **)(this + 0x18)) goto LAB_00a00884;
  ...
  if (puVar13 <= __src && (long)__src - (long)puVar13 != 0) {
    ...
    puVar13 = puVar14;
                    /* try { // try from 00a00754 to 00b00797 has its CatchHandler @ 00a009a8 */
    if (__n != 0) {
...
LAB_00a00854:
      ...
      puVar13 = __src + 2;
                    /* try { // try from 00a00824 to 00b00897 has its CatchHandler @ 00a0040c */
      __src = __src + uVar11;
      ...
      if (uVar2 != uVar11) goto LAB_00a00854;
    }
    puVar13 = *(undefined8 **)this;
...
LAB_00a00884:
  ...
  *(long *)(this + 0x10) = *(long *)(this + 0x10) + 8;
                    /* try { // try from 00a00898 to 00b008d3 has its CatchHandler @ 00a00a50 */
  return;
}
