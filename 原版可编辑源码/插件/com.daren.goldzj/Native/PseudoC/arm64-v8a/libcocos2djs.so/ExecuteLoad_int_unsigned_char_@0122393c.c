...
bool __thiscall
v8::internal::wasm::ThreadImpl::ExecuteLoad<int,unsigned_char>
  ...
  *(long *)(this + 0x28) = lVar7 + -0x11;
  ...
  if (!CARRY4(local_a0._1_4_,uVar11)) {
    ...
    if (((*(long *)(lVar7 + 0x13) != 0) && ((ulong)uVar2 <= *(long *)(lVar7 + 0x13) - 1U)) &&
       (puVar3 = (undefined1 *)((*(ulong *)(lVar7 + 0x1b) & (ulong)uVar2) + *(long *)(lVar7 + 0xb)),
       puVar3 != (undefined1 *)0x0)) {
      uStack_98 = 0;
      local_a0 = (ulong)CONCAT11(*puVar3,1);
      local_90 = 0;
