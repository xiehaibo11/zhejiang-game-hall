...
/* js_cocos2dx_particle_ParticleSimulator_setFinishedCallbackRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_particle_ParticleSimulator_setFinishedCallbackRegistry
...

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x188,"js_cocos2dx_particle_ParticleSimulator_setFinishedCallback");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_particle_ParticleSimulator_setFinishedCallback : Invalid Native Object"
                       );
  }
  else {
    ...
    if (puVar5[1] - (long)pVVar6 == 0x10) {
      ...
      if (pVVar6[8] == (Value)0x5) {
        ...
        if ((uVar8 & 1) == 0) goto LAB_00c064bc;
...
LAB_00c065a8:
        ...
        if (local_a0 == (long *)0x0) goto LAB_00c064c0;
        if (alStack_c0 != local_a0) {
          local_d0 = (long *)(**(code **)(*local_a0 + 0x10))();
          if (local_d0 != (long *)0x0) goto LAB_00c06628;
          goto LAB_00c064c4;
        }
        local_d0 = local_f0;
        (**(code **)(*local_a0 + 0x18))(local_a0,local_f0);
        if (local_d0 == (long *)0x0) goto LAB_00c064c4;
LAB_00c06628:
...
LAB_00c064c4:
      ...
      FUN_008feca4(alStack_90,lVar4 + 0x50);
      if (alStack_90 == local_70) {
        pcVar11 = *(code **)(*local_70 + 0x20);
LAB_00c0653c:
        (*pcVar11)();
...
LAB_00c06568:
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp, 428): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(puVar5[1] - (long)pVVar6) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_particle_ParticleSimulator_setFinishedCallback",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                      ,0x1af);
LAB_00c06474:
