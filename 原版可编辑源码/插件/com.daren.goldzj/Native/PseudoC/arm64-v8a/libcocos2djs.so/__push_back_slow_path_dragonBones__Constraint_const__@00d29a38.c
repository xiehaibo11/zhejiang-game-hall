...
/* void std::__ndk1::vector<dragonBones::Constraint*,
   std::__ndk1::allocator<dragonBones::Constraint*>
   >::__push_back_slow_path<dragonBones::Constraint* const&>(dragonBones::Constraint* const&) */
...
__push_back_slow_path<dragonBones::Constraint*const&>
          (vector<dragonBones::Constraint*,std::__ndk1::allocator<dragonBones::Constraint*>> *this,
          Constraint **param_1)
...
LAB_00d29a9c:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d29a9c;
  }
  else {
