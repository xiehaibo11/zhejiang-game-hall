...
/* js_cocos2dx_spine_TrackEntry_setDrawOrderThresholdRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_TrackEntry_setDrawOrderThresholdRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TrackEntry *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x316,"js_cocos2dx_spine_TrackEntry_setDrawOrderThreshold");
    pcVar6 = "js_cocos2dx_spine_TrackEntry_setDrawOrderThreshold : Invalid Native Object";
LAB_00c17534:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::TrackEntry::setDrawOrderThreshold(this,local_64);
        goto LAB_00c1756c;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x31d,"js_cocos2dx_spine_TrackEntry_setDrawOrderThreshold");
      pcVar6 = "js_cocos2dx_spine_TrackEntry_setDrawOrderThreshold : Error processing arguments";
      goto LAB_00c17534;
    }
    __android_log_print(6,"jswrapper",&DAT_018f34f9,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TrackEntry_setDrawOrderThreshold",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x324);
LAB_00c1756c:
