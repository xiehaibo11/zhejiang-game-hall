...
/* void std::__ndk1::vector<se::Class*, std::__ndk1::allocator<se::Class*>
   >::__push_back_slow_path<se::Class*>(se::Class*&&) */

void __thiscall
std::__ndk1::vector<se::Class*,std::__ndk1::allocator<se::Class*>>::
__push_back_slow_path<se::Class*>
          (vector<se::Class*,std::__ndk1::allocator<se::Class*>> *this,Class **param_1)
