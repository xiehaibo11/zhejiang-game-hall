...
/* std::__ndk1::enable_if<__is_forward_iterator<cocos2d::renderer::Pass**>::value&&is_constructible<cocos2d::renderer::Pass*,
   std::__ndk1::iterator_traits<cocos2d::renderer::Pass**>::reference>::value, void>::type
   std::__ndk1::vector<cocos2d::renderer::Pass*, std::__ndk1::allocator<cocos2d::renderer::Pass*>
   >::assign<cocos2d::renderer::Pass**>(cocos2d::renderer::Pass**, cocos2d::renderer::Pass**) */

void __thiscall
std::__ndk1::vector<cocos2d::renderer::Pass*,std::__ndk1::allocator<cocos2d::renderer::Pass*>>::
assign<cocos2d::renderer::Pass**>
          (vector<cocos2d::renderer::Pass*,std::__ndk1::allocator<cocos2d::renderer::Pass*>> *this,
          Pass **param_1,Pass **param_2)
...
LAB_00922018:
    ...
    if ((ulong)(lVar1 >> 3) < 0xfffffffffffffff) {
      uVar2 = lVar1 >> 2;
      if ((uVar5 <= uVar2) && (uVar5 = uVar2, uVar2 >> 0x3d != 0)) goto LAB_00922018;
    }
    else {
    ...
    *(void **)(this + 0x10) = (void *)((long)pvVar4 + uVar5 * 8);
    ...
    __src = (Pass **)((long)param_1 + (*(long *)(this + 8) - (long)pvVar4));
    if (uVar5 <= uVar2) {
      __src = param_2;
    }
