...
/* std::__ndk1::__split_buffer<int*, std::__ndk1::allocator<int*>&>::push_front(int* const&) */

void __thiscall
std::__ndk1::__split_buffer<int*,std::__ndk1::allocator<int*>&>::push_front
          (__split_buffer<int*,std::__ndk1::allocator<int*>&> *this,int **param_1)

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_00f27280;
...
LAB_00f27254:
      ...
      if (((void *)((long)pvVar4 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar4 + uVar9 + uVar13 * 8 + 8))) goto LAB_00f27254;
      ...
      puVar7 = puVar8;
      if (uVar2 != uVar9) goto LAB_00f27254;
    }
