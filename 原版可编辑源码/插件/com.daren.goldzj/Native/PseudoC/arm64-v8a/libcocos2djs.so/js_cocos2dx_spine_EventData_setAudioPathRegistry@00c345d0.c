...
/* js_cocos2dx_spine_EventData_setAudioPathRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_EventData_setAudioPathRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (EventData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1365,"js_cocos2dx_spine_EventData_setAudioPath");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_EventData_setAudioPath : Invalid Native Object");
  }
  else {
    ...
    if (plVar5[1] - *plVar5 == 0x10) {
      ...
      spine::EventData::setAudioPath(this,(String *)&local_88);
      pvVar4 = local_78;
      local_88 = &PTR__String_01c67868;
    ...
    __android_log_print(6,"jswrapper",&DAT_01901108,(ulong)(plVar5[1] - *plVar5) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_EventData_setAudioPath",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1373);
LAB_00c347f8:
