...
void FUN_00e00510(byte *param_1,byte *param_2,byte *param_3,byte *param_4,uint param_5)

{
  ...
  pbVar36 = param_2;
  if ((param_5 & 0x3ffffffe) == 0) goto LAB_00e00b70;
...
LAB_00e009b4:
    ...
    if ((param_4 < param_1 + (uVar41 >> 2) + 2 && param_1 < pbVar34) ||
       ((param_4 < param_2 + lVar2 && param_2 < pbVar34 ||
        (param_4 < param_3 + lVar2 && param_3 < pbVar34)))) goto LAB_00e009b4;
    pbVar35 = param_2;
    pbVar37 = param_4;
    pbVar38 = param_3;
    uVar43 = uVar42;
    ...
    if (uVar1 != uVar42) goto LAB_00e009b4;
  }
