...
ASN1_STRING * FUN_00b48a08(EVP_PKEY_CTX *param_1)
    ...
    if (a != (RSA_PSS_PARAMS *)0x0) {
      if (local_3c != 0x14) {
        ...
        if ((a_00 == (ASN1_INTEGER *)0x0) ||
           (iVar1 = ASN1_INTEGER_set(a_00,(long)local_3c), iVar1 == 0)) goto LAB_00b48ab8;
      }
      iVar1 = EVP_MD_type(local_28);
      if (iVar1 != 0x40) {
        alg = X509_ALGOR_new();
        a->hashAlgorithm = alg;
        if (alg == (X509_ALGOR *)0x0) goto LAB_00b48ab8;
        X509_ALGOR_set_md(alg,local_28);
      }
      iVar1 = FUN_00b48bb4(&a->maskGenAlgorithm,local_30);
      if (iVar1 != 0) {
