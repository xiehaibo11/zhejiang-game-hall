...
/* v8::internal::interpreter::ConstantArrayBuilder::Insert(v8::internal::Scope const*) */

undefined4 __thiscall
v8::internal::interpreter::ConstantArrayBuilder::Insert(ConstantArrayBuilder *this,Scope *param_1)

{
  ...
  uVar2 = base::hash_value((ulong)param_1);
  lVar4 = *(long *)(this + 0x18);
  uVar6 = *(undefined8 *)(this + 0xb8);
  uVar5 = (ulong)(*(int *)(this + 0x20) - 1U & uVar2);
  puVar7 = (undefined8 *)(lVar4 + uVar5 * 0x18);
  if ((*(char *)(puVar7 + 2) != '\0') && (*(Scope **)(lVar4 + uVar5 * 0x18) != param_1)) {
    do {
      uVar5 = (ulong)((int)uVar5 + 1U & *(int *)(this + 0x20) - 1U);
      if (*(char *)(lVar4 + uVar5 * 0x18 + 0x10) == '\0') break;
    } while (*(Scope **)(lVar4 + uVar5 * 0x18) != param_1);
    puVar7 = (undefined8 *)(lVar4 + uVar5 * 0x18);
  }
  if (*(char *)(puVar7 + 2) == '\0') {
    lVar4 = *(long *)this;
    ...
    uVar3 = ConstantArraySlice::Allocate(lVar4,param_1,6,1);
    *puVar7 = param_1;
