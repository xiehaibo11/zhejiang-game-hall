...
/* v8::internal::interpreter::BytecodeArrayBuilder::GetIterator(v8::internal::interpreter::Register,
   int, int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::GetIterator
