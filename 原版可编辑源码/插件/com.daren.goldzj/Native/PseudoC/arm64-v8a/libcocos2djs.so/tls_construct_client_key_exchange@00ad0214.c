...
/* WARNING: Removing unreachable block (ram,0x00ad07a0) */
/* WARNING: Removing unreachable block (ram,0x00ad0d1c) */
...

{
  ...
  if ((uVar1 & 0x1c8) == 0) {
    iVar5 = 0;
    iVar12 = -1;
    if ((uVar1 >> 3 & 1) == 0) goto LAB_00ad03dc;
LAB_00ad0500:
    iVar4 = 0;
LAB_00ad0504:
...
LAB_00ad0388:
  ...
  if (bVar16) {
joined_r0x00ad085c:
    if (iVar12 == -1) goto LAB_00ad08cc;
  }
  else {
    if ((uVar1 >> 3 & 1) != 0) goto LAB_00ad0500;
LAB_00ad03dc:
    if ((uVar1 & 0x41) == 0) {
      if ((uVar1 & 0x102) == 0) {
        if ((uVar1 & 0x84) == 0) {
          if ((uVar1 >> 4 & 1) != 0) {
            ...
            if (pEVar9 == (EVP_PKEY_CTX *)0x0) {
              ...
              if (puVar8 == (uchar *)0x0) {
                    /* try { // try from 00ad0c18 to 00bd0ccb has its CatchHandler @ 00ad0c18
                       catch() { ... } // from try @ 00ad0c18 with catch @ 00ad0c18
                       catch() { ... } // from try @ 00ad0cd0 with catch @ 00ad0c18
                       catch() { ... } // from try @ 00ad0d2c with catch @ 00ad0c18 */
                iVar5 = 0x41;
                iVar12 = 0x950;
LAB_00ad0c2c:
                ...
                if (ctx != (EVP_MD_CTX *)0x0) {
                  ...
                  if ((((0 < iVar4) &&
                    ...
                    /* try { // try from 00ad0a38 to 00bd0a63 has its CatchHandler @ 00ad0a38
                       catch() { ... } // from try @ 00ad0a38 with catch @ 00ad0a38
                       catch() { ... } // from try @ 00ad0a68 with catch @ 00ad0a38 */
                    EVP_MD_CTX_free(ctx);
                    ...
                    /* try { // try from 00ad0a64 to 00bd0a67 has its CatchHandler @ 00ad0a94 */
                    /* try { // try from 00ad0a68 to 00bd0aa7 has its CatchHandler @ 00ad0a38 */
                      *local_1f8 = '0';
                      local_68 = 0xff;
                      iVar4 = EVP_PKEY_encrypt(pEVar9,(uchar *)local_1f0,&local_68,puVar8,0x20);
                      if (0 < iVar4) {
                    /* catch() { ... } // from try @ 00ad0a64 with catch @ 00ad0a94 */
                        if (local_68 < 0x80) {
                          ...
                          local_1f8[1] = 0x81;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ad0ad8 with catch @ 00ad0aa8
                        */
                          puVar11 = local_1f8 + 3;
                    ...
                    /* try { // try from 00ad0ccc to 00bd0ccf has its CatchHandler @ 00ad0d9c */
                    /* try { // try from 00ad0cd0 to 00bd0d27 has its CatchHandler @ 00ad0c18 */
                      iVar5 = 0x112;
                      iVar12 = 0x97b;
                    }
                    goto LAB_00ad0c2c;
          ...
          if ((uVar1 >> 5 & 1) == 0) {
            ...
            *local_1f8 = (uchar)((uint)iVar4 >> 8);
            ...
            pcVar14 = CRYPTO_strdup(*(char **)(param_1 + 0xce),"ssl/statem/statem_clnt.c",0x9a7);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ad0ad4 with catch @ 00ad0b48
                        */
          ...
          if (lVar15 != 0) {
            ...
            if (iVar4 == 0) {
              iVar5 = 0x195;
              iVar4 = 6;
                    /* try { // try from 00ad0ad4 to 00bd0ad7 has its CatchHandler @ 00ad0b48 */
              iVar6 = 0x8fd;
                    /* try { // try from 00ad0ad8 to 00bd0b63 has its CatchHandler @ 00ad0aa8 */
            }
            else {
