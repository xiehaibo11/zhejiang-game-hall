...
/* js_cocos2dx_dragonbones_ArmatureData_get_animationsRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_ArmatureData_get_animationsRegistry
...

{
  ...
  plVar12 = *(long **)(lVar5 + 0x120);
joined_r0x00c90d04:
  do {
    if (plVar12 == (long *)(lVar5 + 0x128)) {
...
LAB_00c90e70:
    ...
    if ((bVar1 & 1) != 0) {
      if (plVar12[5] != 0) goto LAB_00c90d38;
LAB_00c90d24:
      plVar9 = (long *)plVar12[1];
      if ((long *)plVar12[1] == (long *)0x0) goto LAB_00c90d88;
LAB_00c90d78:
      do {
        plVar12 = plVar9;
        plVar9 = (long *)*plVar12;
      } while ((long *)*plVar12 != (long *)0x0);
      goto joined_r0x00c90d04;
    }
    if (bVar1 >> 1 == 0) goto LAB_00c90d24;
LAB_00c90d38:
    ...
    if (!bVar3) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          &DAT_019268ae,0xfb,"js_cocos2dx_dragonbones_ArmatureData_get_animations");
      __android_log_print(6,"jswrapper","Convert dragonBones::AnimationData to se::Value failed!");
      se::Value::~Value(aVStack_58);
      se::HandleObject::~HandleObject((HandleObject *)&local_88);
      __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                          "js_cocos2dx_dragonbones_ArmatureData_get_animations",&DAT_019268ae,0x102)
      ;
      goto LAB_00c90e70;
    }
    ...
    plVar9 = (long *)plVar12[1];
    if ((long *)plVar12[1] != (long *)0x0) goto LAB_00c90d78;
LAB_00c90d88:
    plVar9 = plVar12 + 2;
