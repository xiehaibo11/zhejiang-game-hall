...
/* v8::internal::PropertyCallbackArguments::CallIndexedQuery(v8::internal::Handle<v8::internal::InterceptorInfo>,
   unsigned int) */

PropertyCallbackArguments * __thiscall
v8::internal::PropertyCallbackArguments::CallIndexedQuery
          (PropertyCallbackArguments *this,ulong *param_2,undefined4 param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    ...
    RuntimeCallStats::Enter(local_90,(ulong)&local_90 | 8,0x92);
  }
  ...
  if (*(int *)(lVar8 + 0xb80c) == 0x20) {
    uVar5 = Debug::PerformSideEffectCheckForCallback(*(Debug **)(lVar8 + 0xb6c8),param_2,0,0);
    pPVar7 = (PropertyCallbackArguments *)0x0;
    if ((uVar5 & 1) == 0) goto LAB_010dda0c;
  }
  ...
  *(long **)(lVar8 + 0x2c58) = &local_a8;
  ...
  if ((uVar5 & 1) != 0) {
    Logger::ApiIndexedPropertyAccess
              (this_00,"interceptor-indexed-query",*(undefined8 *)(this + 0x20),param_3);
  }
