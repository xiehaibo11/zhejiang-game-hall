...
/* int v8::internal::MarkingVisitorBase<v8::internal::ConcurrentMarkingVisitor,
   v8::internal::ConcurrentMarkingState>::VisitEmbedderTracingSubclass<v8::internal::JSDataView>(v8::internal::Map,
  ...
  *(undefined4 *)(this + 0x48) = 0;
  ...
  if (puVar1 < (uint *)(param_3 + 0xfU)) {
    ...
    *(ulong *)(pMVar2 + (long)iVar6 * 0x10 + 0x10) =
    ...
    for (puVar1 = (uint *)(param_3 + 7); puVar1 < (uint *)(param_3 + 0xfU); puVar1 = puVar1 + 1) {
      uVar3 = *puVar1;
      iVar6 = *(int *)pMVar2;
      *(int *)pMVar2 = iVar6 + 1;
      *(uint **)(pMVar2 + (long)iVar6 * 0x10 + 8) = puVar1;
  ...
  if (iVar6 < (int)lVar9) {
    lVar13 = (long)iVar6;
    for (puVar1 = (uint *)(param_3 + 0x27); puVar1 < (uint *)((long)puVar11 + lVar13);
        puVar1 = puVar1 + 1) {
      uVar3 = *puVar1;
      iVar6 = *(int *)local_58;
