...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<int, void*>*>, bool>
   std::__ndk1::__hash_table<int, std::__ndk1::hash<int>, std::__ndk1::equal_to<int>,
   std::__ndk1::allocator<int> >::__emplace_unique_key_args<int, int const&>(int const&, int const&)
    */
      ...
      for (plVar8 = (long *)*plVar8; plVar8 != (long *)0x0; plVar8 = (long *)*plVar8) {
        ...
        if (uVar7 != uVar10) {
          if (uVar5 < 2) {
            ...
            if (uVar7 - uVar2 * uVar9 == unaff_x24) goto LAB_00fdc928;
            break;
          }
