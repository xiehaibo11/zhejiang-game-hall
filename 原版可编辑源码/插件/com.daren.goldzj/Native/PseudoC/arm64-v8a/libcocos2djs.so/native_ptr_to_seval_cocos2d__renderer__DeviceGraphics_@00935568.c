...
/* bool 
   native_ptr_to_seval<cocos2d::renderer::DeviceGraphics>(std::__ndk1::enable_if<std::is_base_of<cocos2d::Ref,
   cocos2d::renderer::DeviceGraphics>::value, cocos2d::renderer::DeviceGraphics>::type*, se::Class*,
   se::Value*, bool*) */

bool native_ptr_to_seval<cocos2d::renderer::DeviceGraphics>
