...
/* v8::internal::V8HeapExplorer::SetElementReference(v8::internal::HeapEntry*, int,
   v8::internal::Object) */

void __thiscall
v8::internal::V8HeapExplorer::SetElementReference
          (V8HeapExplorer *this,uint *param_1,uint param_2,void *param_4)
