...
/* v8::internal::interpreter::BytecodeArrayBuilder::GetSuperConstructor(v8::internal::interpreter::Register)
    */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::GetSuperConstructor
