...
void FUN_014575b4(long param_1,undefined8 param_2,undefined8 param_3,long param_4,long param_5,
...

{
  ...
  if ((param_7 >> 0x15 & 1) != 0) {
    ...
    if ((long)((ulong)*(uint *)(uVar2 + 3) << 0x20) >> 0x21 == 0) {
      ...
      pcVar1 = (code *)SoftwareBreakpoint(0,0x14575f8);
      (*pcVar1)();
    }
    if (*(int *)(uVar2 + 7) == 0) {
      do {
        ...
        if ((int)param_4 == (int)*(undefined8 *)(unaff_x26 + 0xb0)) {
                    /* WARNING: Could not recover jumptable at 0x014576e0. Too many branches */
