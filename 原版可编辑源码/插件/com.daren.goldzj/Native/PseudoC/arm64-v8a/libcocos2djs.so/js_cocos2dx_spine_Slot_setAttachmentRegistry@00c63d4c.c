...
/* js_cocos2dx_spine_Slot_setAttachmentRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Slot_setAttachmentRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Slot *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2b6b,&DAT_018edb9b);
    pcVar7 = "js_cocos2dx_spine_Slot_setAttachment : Invalid Native Object";
LAB_00c63ed8:
    ...
    if (puVar4[1] - (long)pVVar5 == 0x10) {
      if (pVVar5[8] == (Value)0x5) {
        ...
        pAVar6 = (Attachment *)se::Object::getPrivateData(this_00);
        if (pAVar6 == (Attachment *)0x0) {
LAB_00c63ea0:
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                              ,0x2b72,&DAT_018edb9b);
          pcVar7 = "js_cocos2dx_spine_Slot_setAttachment : Error processing arguments";
          goto LAB_00c63ed8;
        }
      }
      else {
        if (1 < (byte)pVVar5[8]) goto LAB_00c63ea0;
        pAVar6 = (Attachment *)0x0;
      }
      spine::Slot::setAttachment(this,pAVar6);
      goto LAB_00c63f10;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 11126): wrong number of arguments: %d, was expecting %d\n"
