...
/* void JSBClassType::registerClass<spine::DrawOrderTimeline>(se::Class*) */

void JSBClassType::registerClass<spine::DrawOrderTimeline>(Class *param_1)
