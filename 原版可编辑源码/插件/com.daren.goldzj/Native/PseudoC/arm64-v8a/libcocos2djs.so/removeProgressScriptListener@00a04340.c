...
/* universe::Downloader2::removeProgressScriptListener(int) */

undefined4 __thiscall
universe::Downloader2::removeProgressScriptListener(Downloader2 *this,int param_1)

{
  ...
  if (uVar4 != 0) {
    ...
    plVar5 = *(long **)(*(long *)(this + 0x1a8) + uVar8 * 8);
    if (plVar5 != (long *)0x0) {
      for (plVar5 = (long *)*plVar5; plVar5 != (long *)0x0; plVar5 = (long *)*plVar5) {
        ...
        if (uVar9 == uVar7) {
          if (*(int *)(plVar5 + 2) == param_1) {
            ...
            ::remove(local_40,this + 0x1a8,plVar5);
            pvVar3 = local_40[0];
            local_40[0] = (void *)0x0;
            if (pvVar3 != (void *)0x0) {
          ...
          if ((uVar6 & uVar4) == 0) {
            ...
            if (uVar9 - uVar1 * uVar4 == uVar8) goto LAB_00a043e0;
            break;
          }
