...
/* JSB_glIsTextureRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glIsTextureRegistry(FunctionCallbackInfo *param_1)
...
LAB_008bf9c4:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            ...
                            ,0x6f2,"JSB_glIsTexture");
        __android_log_print(6,"jswrapper",&DAT_0190552e);
        goto LAB_008bfa08;
      }
      lVar9 = __dynamic_cast(lVar8,&PTR_PTR_01c67690,&PTR_PTR_01c67740,0);
      if (lVar9 == 0) goto LAB_008bf9ac;
      cVar4 = glIsTexture(*(undefined4 *)(lVar8 + 0xc));
      bVar3 = cVar4 == '\x01';
    }
    else {
      if (1 < (byte)pVVar7[8]) goto LAB_008bf9c4;
LAB_008bf9ac:
      bVar3 = false;
    }
