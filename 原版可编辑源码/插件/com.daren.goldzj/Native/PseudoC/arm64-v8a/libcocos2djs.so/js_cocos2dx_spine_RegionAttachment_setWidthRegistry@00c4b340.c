...
/* js_cocos2dx_spine_RegionAttachment_setWidthRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_RegionAttachment_setWidthRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (RegionAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1f70,"js_cocos2dx_spine_RegionAttachment_setWidth");
    pcVar6 = "js_cocos2dx_spine_RegionAttachment_setWidth : Invalid Native Object";
LAB_00c4b4b4:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::RegionAttachment::setWidth(this,local_64);
        goto LAB_00c4b4ec;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1f77,"js_cocos2dx_spine_RegionAttachment_setWidth");
      pcVar6 = "js_cocos2dx_spine_RegionAttachment_setWidth : Error processing arguments";
      goto LAB_00c4b4b4;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 8059): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_RegionAttachment_setWidth",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1f7e);
LAB_00c4b4ec:
