...
void FUN_00b9dc28(int *param_1,int *param_2,long param_3)

{
  ...
  *param_1 = *param_2 + param_2[10];
  ...
  FUN_00b9cab0(param_1 + 0x14,param_1);
  FUN_00b9cab0(param_1 + 10,param_1 + 10,param_3 + 0x28);
  FUN_00b9cab0(param_1 + 0x1e,param_3 + 0x50,param_2 + 0x1e);
  iVar9 = param_2[0x14];
  iVar1 = param_2[0x15];
  iVar5 = param_2[0x16];
  iVar2 = param_2[0x17];
