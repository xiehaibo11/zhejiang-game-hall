          ...
          if (*(long *)(*(long *)this + uVar17 * 8) == 0) {
            *(long **)(*(long *)this + uVar17 * 8) = plVar14;
            ...
            if ((long *)*plVar15 != (long *)0x0) {
                    /* try { // try from 009bf774 to 00abf857 has its CatchHandler @ 009bf588 */
              ...
              do {
                ...
                if ((bVar3 & 1) == 0) {
                  while (sVar6 != 0) {
                    /* catch() { ... } // from try @ 009bf608 with catch @ 009bf7e8 */
                    /* catch() { ... } // from try @ 009bf5fc with catch @ 009bf7ec */
                    /* catch() { ... } // from try @ 009bf5dc with catch @ 009bf7f0 */
                    if (*pcVar5 != *__s2) goto LAB_009bf83c;
                    __s2 = __s2 + 1;
                    sVar1 = sVar1 + 1;
                    /* catch() { ... } // from try @ 009bf614 with catch @ 009bf800 */
                    pcVar5 = pcVar5 + 1;
                    sVar6 = sVar1;
                  }
                }
...
LAB_009bf83c:
            ...
            *plVar13 = **(long **)(*(long *)this + uVar17 * 8);
                    /* try { // try from 009bf858 to 00abf8ab has its CatchHandler @ 009bf858
                       catch() { ... } // from try @ 009bf858 with catch @ 009bf858
                       catch() { ... } // from try @ 009bfa44 with catch @ 009bf858 */
