...
/* js_gfx_DeviceGraphics_setProgramRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_gfx_DeviceGraphics_setProgramRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (DeviceGraphics *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x22f,"js_gfx_DeviceGraphics_setProgram");
    __android_log_print(6,"jswrapper","js_gfx_DeviceGraphics_setProgram : Invalid Native Object");
  }
  else {
    ...
    if (puVar4[1] - (long)pVVar5 == 0x10) {
      if (pVVar5[8] == (Value)0x5) {
        ...
        pPVar6 = (Program *)se::Object::getPrivateData(this_00);
        if (pPVar6 != (Program *)0x0) {
LAB_0092c8bc:
          cocos2d::renderer::DeviceGraphics::setProgram(this,pPVar6);
          goto LAB_0092c938;
        }
      }
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                          ,0x236,"js_gfx_DeviceGraphics_setProgram");
      __android_log_print(6,"jswrapper",
                          "js_gfx_DeviceGraphics_setProgram : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp, 570): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(puVar4[1] - (long)pVVar5) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_gfx_DeviceGraphics_setProgram",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                      ,0x23d);
LAB_0092c938:
