...
LAB_015ec544:
            if (uVar10 == uVar6) goto LAB_015ec50c;
LAB_015ec54c:
                ...
                while ((char)plVar8[2] == (char)plVar12[2]) {
                  if (plVar8 != plVar12) {
                    ...
                    if (pcVar13 != pcVar13 + lVar3 + lVar4) {
                      ...
                      lVar4 = lVar4 + lVar3;
                      do {
                        if (*pcVar13 != *pcVar14) goto LAB_015ec610;
                        pcVar13 = pcVar13 + 1;
                        lVar4 = lVar4 + -1;
                        pcVar14 = pcVar14 + 1;
                      } while (lVar4 != 0);
...
LAB_015ec610:
          ...
          if (uVar10 < param_1) goto LAB_015ec544;
          uVar1 = 0;
          if (param_1 != 0) {
            uVar1 = uVar10 / param_1;
          }
          uVar10 = uVar10 - uVar1 * param_1;
          if (uVar10 != uVar6) goto LAB_015ec54c;
LAB_015ec50c:
          plVar9 = (long *)*plVar8;
joined_r0x015ec63c:
          plVar7 = plVar8;
