...
/* js_renderer_getStageIDsRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_getStageIDsRegistry(FunctionCallbackInfo *param_1)
  ...
  if (plVar8[1] - *plVar8 == 0x10) {
    ...
    if (bVar1) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0x10d,"js_renderer_getStageIDs");
      __android_log_print(6,"jswrapper","Convert arg0 failed!");
      pbVar3 = local_88;
    }
    else {
      uVar6 = cocos2d::renderer::Config::getStageIDs((vector *)&local_88);
      pVVar10 = (Value *)se::State::rval(aSStack_70);
      uint32_to_seval(uVar6,pVVar10);
      pbVar3 = local_88;
    }
    local_88 = pbVar3;
    pbVar12 = local_80;
    ...
    if (!bVar1) goto LAB_0095e5a8;
  }
  else {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp, 274): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar8[1] - *plVar8) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_getStageIDs",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp"
                      ,0x115);
LAB_0095e5a8:
  pVVar10 = (Value *)se::State::rval(aSStack_70);
