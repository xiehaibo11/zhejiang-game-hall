...
/* js_cocos2dx_dragonbones_AnimationState_playRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_dragonbones_AnimationState_playRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (AnimationState *)0x0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_AnimationState_play : Invalid Native Object");
  }
  else {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp, 4125): wrong number of arguments: %d, was expecting %d\n"
