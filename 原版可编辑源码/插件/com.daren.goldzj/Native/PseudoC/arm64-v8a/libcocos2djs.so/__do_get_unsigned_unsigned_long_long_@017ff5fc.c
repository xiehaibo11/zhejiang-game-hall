...
LAB_017ff6e0:
  if (param_2 == (long *)0x0) {
    bVar4 = true;
    if (param_3 != (long *)0x0) goto LAB_017ff724;
LAB_017ff760:
    param_3 = (long *)0x0;
    if (bVar4) goto LAB_017ff850;
  }
  else {
    ...
    param_2 = plVar2;
    if (param_3 == (long *)0x0) goto LAB_017ff760;
LAB_017ff724:
...
LAB_017ff850:
  ...
  uVar8 = FUN_01828db4(pcVar18,local_1b8,param_5,iVar7);
  *param_6 = uVar8;
  uVar9 = (ulong)((byte)local_198[0] >> 1);
  if (((byte)local_198[0] & 1) != 0) {
    uVar9 = local_190;
  ...
  if (uVar9 != 0) {
    ...
    if (local_178 < puVar11) {
      ...
      do {
        if ((bVar4) && (*puVar17 != uVar12)) goto LAB_017ff9a4;
...
LAB_017ff9a4:
  ...
  if (param_2 == (long *)0x0) {
    bVar4 = true;
    if (param_3 != (long *)0x0) goto LAB_017ff9f8;
LAB_017ff9cc:
    if (!bVar4) goto LAB_017ffa3c;
  }
  else {
    if ((int *)param_2[3] == (int *)param_2[4]) {
    ...
    param_2 = plVar2;
    if (param_3 == (long *)0x0) goto LAB_017ff9cc;
LAB_017ff9f8:
    if ((int *)param_3[3] == (int *)param_3[4]) {
    ...
    if (bVar4 != (iVar7 == -1)) goto LAB_017ffa3c;
  }
  *param_5 = *param_5 | 2;
LAB_017ffa3c:
  if ((local_1b0 & 1) != 0) {
