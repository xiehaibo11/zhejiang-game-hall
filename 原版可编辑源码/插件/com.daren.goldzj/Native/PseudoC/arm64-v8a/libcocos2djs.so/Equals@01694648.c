...
/* v8::internal::compiler::Operator1<double, v8::internal::compiler::OpEqualTo<double>,
   v8::internal::compiler::OpHash<double> >::Equals(v8::internal::compiler::Operator const*) const
    */

bool __thiscall
v8::internal::compiler::
Operator1<double,v8::internal::compiler::OpEqualTo<double>,v8::internal::compiler::OpHash<double>>::
Equals(Operator1<double,v8::internal::compiler::OpEqualTo<double>,v8::internal::compiler::OpHash<double>>
