...
/* js_cocos2dx_dragonbones_ArmatureData_getSlotRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_dragonbones_ArmatureData_getSlotRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar5 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3f2,"js_cocos2dx_dragonbones_ArmatureData_getSlot");
    __android_log_print(6,"jswrapper",&DAT_0192f176);
  }
  else {
...
LAB_00c9b37c:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                            ,uVar10,"js_cocos2dx_dragonbones_ArmatureData_getSlot");
        __android_log_print(6,"jswrapper",0x192f1bb);
        bVar3 = false;
      }
      else {
        lVar8 = std::__ndk1::
                ...
                find<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>
                          ((__tree<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::SlotData*>,std::__ndk1::__map_value_compare<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::SlotData*>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::SlotData*>>>
                            *)(lVar5 + 0xd8),(basic_string *)&local_78);
        if (lVar5 + 0xe0 == lVar8) {
          ptVar12 = (type *)0x0;
        }
        else {
        ...
        bVar3 = native_ptr_to_rooted_seval<dragonBones::SlotData>(ptVar12,pVVar9,(bool *)0x0);
        if (!bVar3) {
          uVar10 = 0x3fc;
          goto LAB_00c9b37c;
        }
      ...
      if (bVar3) goto LAB_00c9b3dc;
    }
    else {
      __android_log_print(6,"jswrapper",&DAT_0192f205,(ulong)(plVar6[1] - *plVar6) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_ArmatureData_getSlot",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x402);
LAB_00c9b3dc:
  pVVar9 = (Value *)se::State::rval(aSStack_60);
