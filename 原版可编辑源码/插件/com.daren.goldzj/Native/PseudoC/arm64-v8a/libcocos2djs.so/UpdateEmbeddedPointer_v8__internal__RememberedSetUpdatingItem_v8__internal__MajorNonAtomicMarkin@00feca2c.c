...
/* v8::internal::SlotCallbackResult
   v8::internal::UpdateTypedSlotHelper::UpdateEmbeddedPointer<v8::internal::RememberedSetUpdatingItem<v8::internal::MajorNonAtomicMarkingState,
...
bool v8::internal::UpdateTypedSlotHelper::
     UpdateEmbeddedPointer<v8::internal::RememberedSetUpdatingItem<v8::internal::MajorNonAtomicMarkingState,(v8::internal::GarbageCollector)1>::UpdateTypedPointers()::_lambda(v8::internal::FullMaybeObjectSlot)_1_>
...

{
  ...
  if (*(char *)(param_2 + 1) == '\x02') {
    if (pIVar7[3] != (Instruction)0x18) goto LAB_00fecc38;
  ...
  if ((uVar11 >> 3 & 1) == 0) {
    if ((uVar11 >> 4 & 1) != 0) {
      ...
      return (*(uint *)(*(long *)(uVar9 + 0x10) + (uVar8 >> 7 & 0x1ffffff) * 4) >>
...
LAB_00fecb20:
    ...
    pIVar7 = pIVar14;
    if ((*(byte *)(((ulong)pIVar1 & 0xfffffffffffc0000) + 8) >> 4 & 1) == 0) goto LAB_00fecb20;
    bVar13 = false;
    iVar12 = (int)pIVar14;
  }
  if (iVar12 != iVar3) {
