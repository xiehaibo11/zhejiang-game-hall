...
undefined8 FUN_015ab1dc(undefined8 param_1,undefined8 param_2,long param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_70,(ulong)&local_70 | 8,0x259);
  }
  if (DAT_01d476d0 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d476d0 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d476d0;
  if ((*DAT_01d476d0 & 5) == 0) {
    bVar2 = true;
    ...
    local_78 = (**(code **)(*plVar4 + 0x18))
                         (plVar4,0x58,pbVar3,"V8.Runtime_Runtime_MapIteratorProtector",0,0,0,0,0,0,0
                          ,&local_40,0);
    plVar4 = local_38;
    local_38 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    bVar2 = false;
    local_80 = "V8.Runtime_Runtime_MapIteratorProtector";
    local_88 = pbVar3;
  }
  lVar1 = 0xb8;
  if (*(int *)(*(long *)(param_3 + 0xef8) + 0xb) != 2) {
    lVar1 = 0xc0;
  }
