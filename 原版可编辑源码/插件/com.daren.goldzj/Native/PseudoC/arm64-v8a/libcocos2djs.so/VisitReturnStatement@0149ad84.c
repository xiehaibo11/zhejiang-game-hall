...
/* v8::internal::CallPrinter::VisitReturnStatement(v8::internal::ReturnStatement*) */

void __thiscall
v8::internal::CallPrinter::VisitReturnStatement(CallPrinter *this,ReturnStatement *param_1)
