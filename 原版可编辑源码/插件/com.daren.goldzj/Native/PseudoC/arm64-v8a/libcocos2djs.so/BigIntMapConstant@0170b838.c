...
/* v8::internal::compiler::JSGraph::BigIntMapConstant() */

void __thiscall v8::internal::compiler::JSGraph::BigIntMapConstant(JSGraph *this)

{
  ...
  if (*(long *)(this + 0x1a8) == 0) {
    local_38 = *(long *)(this + 0x168) + 0x1c0;
