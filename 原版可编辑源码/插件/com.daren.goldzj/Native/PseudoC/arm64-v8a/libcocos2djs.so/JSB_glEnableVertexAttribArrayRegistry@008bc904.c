...
/* JSB_glEnableVertexAttribArrayRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glEnableVertexAttribArrayRegistry(FunctionCallbackInfo *param_1)
