...
ulong FUN_014ce6bc(int param_1,long param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_90,(ulong)&local_90 | 8,0x31b);
  }
  if (DAT_01d46648 == (byte *)0x0) {
    plVar7 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d46648 = (byte *)(**(code **)(*plVar7 + 0x10))(plVar7,"disabled-by-default-v8.runtime");
  }
  pbVar5 = DAT_01d46648;
  local_b0 = (byte **)0x0;
  if ((*DAT_01d46648 & 5) != 0) {
    ...
    uVar8 = (**(code **)(*plVar7 + 0x18))
                      (plVar7,0x58,pbVar5,"V8.Builtin_ObjectSeal",0,0,0,0,0,0,0,&local_60,0);
    plVar7 = local_58;
    local_58 = (long *)0x0;
    if (plVar7 != (long *)0x0) {
      (**(code **)(*plVar7 + 8))();
    ...
    local_b0 = &local_a8;
    local_a0 = "V8.Builtin_ObjectSeal";
    local_a8 = pbVar5;
    local_98 = uVar8;
  }
  ...
  *(int *)(param_3 + 0x95b0) = iVar4 + 1;
  ...
  if (((uVar9 & 1) == 0) ||
    ...
    *(int *)(param_3 + 0x95b0) = iVar4;
    ...
    cVar6 = v8::internal::JSReceiver::SetIntegrityLevel(pIVar1,4,0);
