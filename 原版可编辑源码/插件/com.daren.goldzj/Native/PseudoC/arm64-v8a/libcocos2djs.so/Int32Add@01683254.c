...
/* v8::internal::compiler::CodeAssembler::Int32Add(v8::internal::SloppyTNode<v8::internal::Word32T>,
...

{
  ...
  pOVar1 = (Operator *)MachineOperatorBuilder::Int32Add((MachineOperatorBuilder *)(this_00 + 0x20));
  local_40 = param_2;
  uStack_38 = param_3;
