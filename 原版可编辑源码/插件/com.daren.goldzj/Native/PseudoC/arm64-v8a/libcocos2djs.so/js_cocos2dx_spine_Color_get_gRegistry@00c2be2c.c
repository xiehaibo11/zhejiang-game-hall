...
/* js_cocos2dx_spine_Color_get_gRegistry(v8::Local<v8::Name>, v8::PropertyCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_Color_get_gRegistry(undefined8 param_1,PropertyCallbackInfo *param_2)

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xea5,"js_cocos2dx_spine_Color_get_g");
    __android_log_print(6,"jswrapper","js_cocos2dx_spine_Color_get_g : Invalid Native Object");
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_spine_Color_get_g",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                        ,0xead);
  }
  else {
