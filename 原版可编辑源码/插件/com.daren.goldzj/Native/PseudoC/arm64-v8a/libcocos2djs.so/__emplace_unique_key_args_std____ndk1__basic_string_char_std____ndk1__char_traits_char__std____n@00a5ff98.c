...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00a5ffa0 to 00b5ffcf has its CatchHandler @ 00a60044 */
  lVar3 = tpidr_el0;
  local_68 = *(long *)(lVar3 + 0x28);
                    /* try { // try from 00a5ffd4 to 00b5ffdb has its CatchHandler @ 00a60040 */
  uVar9 = *(ulong *)(param_2 + 8);
  pbVar5 = *(basic_string **)(param_2 + 0x10);
                    /* try { // try from 00a5ffdc to 00b6005f has its CatchHandler @ 00a5fef0 */
  if (((byte)*param_2 & 1) == 0) {
    pbVar5 = param_2 + 1;
  ...
  if (pbVar13 != (basic_string *)0x0) {
    ...
    puVar7 = *(undefined8 **)(*(long *)param_1 + (long)unaff_x28 * 8);
                    /* catch() { ... } // from try @ 00a5ffd4 with catch @ 00a60040 */
    if ((puVar7 != (undefined8 *)0x0) && (plVar11 = (long *)*puVar7, plVar11 != (long *)0x0)) {
                    /* catch() { ... } // from try @ 00a5ffa0 with catch @ 00a60044 */
        ...
        if (pbVar8 != pbVar5) {
          if (((ulong)pbVar12 & (ulong)pbVar13) == 0) {
            pbVar8 = (basic_string *)((ulong)pbVar8 & (ulong)pbVar12);
                    ...
                    /* try { // try from 00a60078 to 00b600d3 has its CatchHandler @ 00a60078
                       catch() { ... } // from try @ 00a60078 with catch @ 00a60078
                       catch() { ... } // from try @ 00a603f8 with catch @ 00a60078 */
            if (pbVar13 <= pbVar8) {
              uVar9 = 0;
              if (pbVar13 != (basic_string *)0x0) {
                uVar9 = (ulong)pbVar8 / (ulong)pbVar13;
              }
              if (pbVar8 + -(uVar9 * (long)pbVar13) == unaff_x28) goto LAB_00a6009c;
              break;
            }
          }
...
LAB_00a6009c:
        ...
        if (sVar1 == __n) {
          ...
          if ((bVar2 & 1) == 0) {
            if (__n != 0) {
              uVar9 = 0;
                    /* try { // try from 00a600d4 to 00b600eb has its CatchHandler @ 00a604c8 */
              while (*(basic_string *)((long)plVar11 + uVar9 + 0x11) == __s2[uVar9]) {
                uVar9 = uVar9 + 1;
                if (bVar2 >> 1 == uVar9) goto LAB_00a60124;
              }
              goto LAB_00a60114;
            }
          }
          else if (__n != 0) {
                    /* try { // try from 00a60100 to 00b6010b has its CatchHandler @ 00a604a0 */
            uVar4 = memcmp(__s1,__s2,__n);
            __s1 = (void *)(ulong)uVar4;
                    /* try { // try from 00a6010c to 00b60157 has its CatchHandler @ 00a604d8 */
            if (uVar4 != 0) goto LAB_00a60114;
          }
LAB_00a60124:
          uVar6 = 0;
          goto LAB_00a60270;
...
LAB_00a60114:
  ...
  __s1 = (void *)__construct_node_hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>&,cocos2d::extension::ManifestAsset&>
                    ...
                    /* try { // try from 00a60158 to 00b6015f has its CatchHandler @ 00a60498 */
                    /* try { // try from 00a60160 to 00b60167 has its CatchHandler @ 00a60490 */
                    /* try { // try from 00a60168 to 00b60197 has its CatchHandler @ 00a604a8 */
  if ((pbVar13 == (basic_string *)0x0) ||
    ...
    uVar10 = (ulong)((float)(*(long *)(param_1 + 0x18) + 1) / *(float *)(param_1 + 0x20));
                    /* try { // try from 00a6019c to 00b601a3 has its CatchHandler @ 00a6047c */
    if (uVar10 <= uVar9) {
      uVar10 = uVar9;
    }
    __s1 = (void *)rehash((__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::extension::ManifestAsset>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::extension::ManifestAsset>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::extension::ManifestAsset>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::extension::ManifestAsset>>>
                           *)param_1,uVar10);
                    /* try { // try from 00a601ac to 00b601b3 has its CatchHandler @ 00a60478 */
    pbVar13 = *(basic_string **)(param_1 + 8);
    if (((ulong)(pbVar13 + -1) & (ulong)pbVar13) == 0) {
      unaff_x28 = (basic_string *)((ulong)(pbVar13 + -1) & (ulong)pbVar5);
                    /* try { // try from 00a601d0 to 00b6027b has its CatchHandler @ 00a60480 */
    }
    else {
      unaff_x28 = pbVar5;
      if (pbVar13 <= pbVar5) {
...
LAB_00a60270:
  if (*(long *)(lVar3 + 0x28) != local_68) {
    ...
    __stack_chk_fail(__s1,uVar6);
                    ...
                    /* try { // try from 00a6028c to 00b6031f has its CatchHandler @ 00a604d8 */
  return plVar11;
}
