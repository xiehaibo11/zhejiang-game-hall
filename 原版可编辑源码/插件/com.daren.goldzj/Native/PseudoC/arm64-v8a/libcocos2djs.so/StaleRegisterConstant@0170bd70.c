...
/* v8::internal::compiler::JSGraph::StaleRegisterConstant() */

void __thiscall v8::internal::compiler::JSGraph::StaleRegisterConstant(JSGraph *this)

{
  ...
  if (*(long *)(this + 0x1f8) == 0) {
    local_38 = *(long *)(this + 0x168) + 0x198;
