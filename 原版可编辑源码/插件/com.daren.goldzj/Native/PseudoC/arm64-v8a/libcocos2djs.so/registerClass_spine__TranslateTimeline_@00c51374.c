...
/* void JSBClassType::registerClass<spine::TranslateTimeline>(se::Class*) */

void JSBClassType::registerClass<spine::TranslateTimeline>(Class *param_1)
