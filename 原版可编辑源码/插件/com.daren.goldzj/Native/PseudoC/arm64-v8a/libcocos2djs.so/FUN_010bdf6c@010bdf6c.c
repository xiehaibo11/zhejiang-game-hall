...
undefined8 FUN_010bdf6c(undefined8 param_1,ulong *param_2,ulong *param_3,ulong param_4,long param_5)

{
  ...
  if (param_4 == 0) goto LAB_010be22c;
  uVar7 = *param_2;
  if ((uVar7 & 1) != 0) {
    ...
    if (*(short *)((uVar9 | 7) + (ulong)*(uint *)(uVar7 - 1)) == 0x41b) {
      if ((((byte)(*(byte *)((uVar9 | 10) + (ulong)*(uint *)(uVar7 - 1)) >> 3 | 1) != 0x1b) &&
        ...
        FUN_0107e5a0(uVar7,uVar8,param_4,param_5);
        goto LAB_010be22c;
      }
    }
...
joined_r0x010be214:
          if (param_4 <= uVar9) {
            uVar8 = FUN_0107adc4(*(undefined8 *)(this + 0x2bc8),uVar7,uVar8,param_4,param_5);
            if ((uVar8 & 1) != 0) goto LAB_010be22c;
            this = (Factory *)((ulong)*(uint *)((long)param_3 + 4) << 0x20);
          }
        }
      }
      else {
        dVar10 = *(double *)((uVar9 | uVar1) + 3);
        if ((0.0 <= dVar10) && (dVar10 < 1.8446744073709552e+19)) {
          uVar9 = (ulong)dVar10;
          goto joined_r0x010be214;
        }
      }
    }
  }
  ...
  while( true ) {
    ...
    uVar9 = *puVar2;
    if ((uVar9 & 1) == 0) {
      dVar10 = (double)((int)uVar9 >> 1);
    }
    else {
      dVar10 = *(double *)(uVar9 + 3);
    }
    *(double *)(*(long *)(uVar7 + 0x27) + (ulong)*(uint *)(uVar7 + 0x2f) + param_5 * 8 + uVar8 * 8)
         = dVar10;
    uVar8 = uVar8 + 1;
