...
/* v8::internal::Factory::NewCallableTask(v8::internal::Handle<v8::internal::JSReceiver>,
   v8::internal::Handle<v8::internal::Context>) */

ulong * __thiscall
v8::internal::Factory::NewCallableTask(Factory *this,ulong *param_2,ulong *param_3)

{
  ...
  puVar1 = (ulong *)NewStruct(this,0x49,0);
  uVar4 = *puVar1;
  uVar3 = *param_2;
