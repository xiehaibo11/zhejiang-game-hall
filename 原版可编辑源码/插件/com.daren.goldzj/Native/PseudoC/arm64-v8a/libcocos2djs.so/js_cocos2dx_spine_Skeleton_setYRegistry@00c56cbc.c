...
/* js_cocos2dx_spine_Skeleton_setYRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Skeleton_setYRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Skeleton *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2495,"js_cocos2dx_spine_Skeleton_setY");
    pcVar6 = "js_cocos2dx_spine_Skeleton_setY : Invalid Native Object";
LAB_00c56e30:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Skeleton::setY(this,local_64);
        goto LAB_00c56e68;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x249c,"js_cocos2dx_spine_Skeleton_setY");
      pcVar6 = "js_cocos2dx_spine_Skeleton_setY : Error processing arguments";
      goto LAB_00c56e30;
    }
    __android_log_print(6,"jswrapper",&DAT_01911311,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Skeleton_setY",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x24a3);
LAB_00c56e68:
