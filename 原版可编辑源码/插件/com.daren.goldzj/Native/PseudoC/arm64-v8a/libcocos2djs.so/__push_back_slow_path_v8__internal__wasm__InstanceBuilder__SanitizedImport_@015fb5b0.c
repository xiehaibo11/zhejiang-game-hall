...
/* void std::__ndk1::vector<v8::internal::wasm::InstanceBuilder::SanitizedImport,
   std::__ndk1::allocator<v8::internal::wasm::InstanceBuilder::SanitizedImport>
   >::__push_back_slow_path<v8::internal::wasm::InstanceBuilder::SanitizedImport>(v8::internal::wasm::InstanceBuilder::SanitizedImport&&)
    */
...

{
  ...
  if (uVar1 < 0xaaaaaaaaaaaaaab) {
    ...
    if (uVar1 == 0) {
      ...
      if (0xaaaaaaaaaaaaaaa < uVar1) goto LAB_015fb6bc;
