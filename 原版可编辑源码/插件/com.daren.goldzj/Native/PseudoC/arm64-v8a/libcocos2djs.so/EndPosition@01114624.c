...
/* v8::internal::SharedFunctionInfo::EndPosition() const */

ulong __thiscall v8::internal::SharedFunctionInfo::EndPosition(SharedFunctionInfo *this)

{
  ...
  if (((*(uint *)(uVar3 + 7) & 1) == 0) ||
    ...
    if ((uVar2 & 1) != 0) {
      uVar2 = ScopeInfo::EndPosition((ScopeInfo *)&local_18);
      return uVar2;
    }
  }
  return 0xffffffff;
