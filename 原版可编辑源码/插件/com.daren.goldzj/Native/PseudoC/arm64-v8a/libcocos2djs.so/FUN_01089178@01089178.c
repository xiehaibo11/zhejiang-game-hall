...
void FUN_01089178(undefined8 param_1,ulong *param_2,uint param_3)

{
  ...
  v8::internal::JSObject::TransitionElementsKind(param_2,3);
...
LAB_0108923c:
    FUN_0108a0f8(param_2,puVar5,param_3);
    return;
  }
  iVar6 = param_3 * 4;
    ...
    if ((ulong)(uVar7 >> 4) <= *puVar1) {
      *puVar1 = 0;
      ...
      if (*(short *)((*param_2 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(*param_2 - 1)) != 0x423)
      {
        ...
        if (uVar7 == uVar10) goto LAB_0108923c;
      }
      uVar8 = *puVar5;
      if (1 < *(int *)(uVar8 + 3)) {
        iVar12 = 0;
