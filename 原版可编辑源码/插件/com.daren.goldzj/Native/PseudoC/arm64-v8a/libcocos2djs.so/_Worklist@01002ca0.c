...
/* v8::internal::Worklist<v8::internal::EphemeronHashTable, 128>::~Worklist() */

void __thiscall
v8::internal::Worklist<v8::internal::EphemeronHashTable,128>::~Worklist
          (Worklist<v8::internal::EphemeronHashTable,128> *this)

{
  uint uVar1;
  void *pvVar2;
  ulong uVar3;
  Worklist<v8::internal::EphemeronHashTable,128> *pWVar4;
  long lVar5;
