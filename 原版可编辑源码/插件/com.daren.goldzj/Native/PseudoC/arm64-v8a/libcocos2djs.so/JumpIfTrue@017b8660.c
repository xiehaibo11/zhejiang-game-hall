...
/* v8::internal::interpreter::BytecodeArrayBuilder::JumpIfTrue(v8::internal::interpreter::BytecodeArrayBuilder::ToBooleanMode,
   v8::internal::interpreter::BytecodeLabel*) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::JumpIfTrue
...

{
  ...
  if (param_2 == 1) {
    ...
    local_58[0] = (BytecodeNode)0x99;
    BVar3 = this[0x1b0];
    if (BVar3 == (BytecodeArrayBuilder)0x0) goto LAB_017b87e0;
    if ((int)uVar1 != 0) goto LAB_017b875c;
LAB_017b87cc:
    ...
    uVar2 = uVar2 | uVar4;
    local_38 = uVar2 | uVar1;
    local_58[0] = (BytecodeNode)0x97;
    BVar3 = this[0x1b0];
    if (BVar3 == (BytecodeArrayBuilder)0x0) goto LAB_017b87e0;
    if ((int)uVar1 == 0) goto LAB_017b87cc;
LAB_017b875c:
