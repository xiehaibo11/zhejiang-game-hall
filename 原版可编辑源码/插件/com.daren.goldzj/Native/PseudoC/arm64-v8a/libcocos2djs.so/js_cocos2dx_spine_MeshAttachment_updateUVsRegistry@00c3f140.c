...
/* js_cocos2dx_spine_MeshAttachment_updateUVsRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_MeshAttachment_updateUVsRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (MeshAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x193c,"js_cocos2dx_spine_MeshAttachment_updateUVs");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_MeshAttachment_updateUVs : Invalid Native Object");
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      spine::MeshAttachment::updateUVs(this);
      goto LAB_00c3f290;
    }
    __android_log_print(6,"jswrapper",&DAT_01906b67,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_MeshAttachment_updateUVs",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1946);
LAB_00c3f290:
