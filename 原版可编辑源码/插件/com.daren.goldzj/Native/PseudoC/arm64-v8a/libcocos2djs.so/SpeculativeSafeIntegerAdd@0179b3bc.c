...
/* v8::internal::compiler::OperationTyper::SpeculativeSafeIntegerAdd(v8::internal::compiler::Type,
   v8::internal::compiler::Type) */

void __thiscall
v8::internal::compiler::OperationTyper::SpeculativeSafeIntegerAdd
...

{
  ...
  uVar1 = NumberAdd(this,uVar1,uVar2);
