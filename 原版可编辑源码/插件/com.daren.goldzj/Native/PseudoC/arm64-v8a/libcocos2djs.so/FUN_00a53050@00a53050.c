...
void FUN_00a53050(uchar *param_1,const_DES_cblock *param_2,DES_cblock *param_3)

{
  ...
  local_40 = param_1[7];
                    /* try { // try from 00a53124 to 00b53207 has its CatchHandler @ 00a52fbc */
  ...
  DES_set_odd_parity((DES_cblock *)&local_40);
  DES_set_key((const_DES_cblock *)&local_40,&DStack_c0);
                    /* catch() { ... } // from try @ 00a5303c with catch @ 00a53198 */
                    /* catch() { ... } // from try @ 00a53030 with catch @ 00a5319c */
                    /* catch() { ... } // from try @ 00a53010 with catch @ 00a531a0 */
  DES_ecb_encrypt(param_2,param_3 + 1,&DStack_c0,1);
  local_40 = param_1[0xe];
                    /* catch() { ... } // from try @ 00a53048 with catch @ 00a531b0 */
  ...
  local_3b = param_1[0x13] >> 5 | param_1[0x12] << 3;
                    /* try { // try from 00a53208 to 00b5325f has its CatchHandler @ 00a53208
                       catch() { ... } // from try @ 00a53208 with catch @ 00a53208
                       catch() { ... } // from try @ 00a53490 with catch @ 00a53208 */
  ...
  if (*(long *)(lVar1 + 0x28) == local_38) {
                    /* try { // try from 00a53260 to 00b53277 has its CatchHandler @ 00a534a0 */
    return;
  }
