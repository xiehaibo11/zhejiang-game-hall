...
/* v8::internal::compiler::JSOperatorBuilder::CallWithSpread(unsigned int,
...
Operator * __thiscall
v8::internal::compiler::JSOperatorBuilder::CallWithSpread
          (JSOperatorBuilder *this,uint param_1,undefined4 *param_2,undefined8 *param_3,int param_5,
          int param_6)

{
  ...
  Operator::Operator(pOVar3,0x2ff,0,"JSCallWithSpread",param_1 & 0x7ffffff,1,1,1,1,2);
  *(uint *)(pOVar3 + 0x30) = param_1 | param_5 << 0x1c | param_6 << 0x1b | 0x40000000;
