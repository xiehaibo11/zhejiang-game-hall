...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CheckBigInt(v8::internal::compiler::FeedbackSource
   const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::CheckBigInt
...

{
  ...
  if ((*(long *)param_1 == 0) || (*(int *)(param_1 + 8) == -1)) {
    pOVar3 = (Operator *)(*(long *)this + 0x1bf0);
  }
  else {
    this_00 = *(Zone **)(this + 8);
    ...
    Operator::Operator(pOVar3,0xbf,0x38,"CheckBigInt",1,1,1,1,1,0);
