...
/* WARNING: Removing unreachable block (ram,0x0091a804) */
...

{
  ...
  iVar2 = -0x66;
  if ((param_1 == (void *)0x0) || (param_5 != (char *)0x0)) goto LAB_0091a3b8;
  ...
  if (lVar4 == 0) {
    iVar2 = FUN_0091aff8(param_1,*(undefined8 *)((long)param_1 + 0x60),&local_78);
    if (iVar2 == 0) {
      iVar2 = 0;
...
LAB_0091a5b4:
    ...
    iVar3 = FUN_0091aff8(param_1,*(undefined8 *)((long)param_1 + 0x60),&local_80);
    if (iVar3 != 0) {
      iVar2 = -1;
    }
    iVar3 = FUN_0091aff8(param_1,*(undefined8 *)((long)param_1 + 0x60),&local_80);
...
LAB_0091a8d8:
      ...
      uVar14 = *(undefined8 *)((long)param_1 + 0x48);
      uVar10 = *(undefined8 *)((long)param_1 + 0x40);
      uVar16 = *(undefined8 *)((long)param_1 + 0x28);
      uVar15 = *(undefined8 *)((long)param_1 + 0x20);
      puVar9[0x23] = *(undefined8 *)((long)param_1 + 0x50);
      puVar9[0x22] = uVar14;
      puVar9[0x21] = uVar10;
      puVar9[0x20] = uVar18;
      puVar9[0x1f] = uVar17;
      ...
      if ((param_4 == 0) && (lVar8 == 0xc)) {
        ...
        *(undefined4 *)(puVar9 + 2) = 0;
        ...
        puVar9[0xb] = 0;
        puVar9[9] = 0;
        iVar2 = inflateInit2_(puVar9 + 1,0xfffffff1,"1.2.7",0x70);
        if (iVar2 != 0) {
          free(puVar9);
          goto LAB_0091a3b8;
        }
