...
/* unsigned int v8::internal::wasm::Decoder::read_leb_tail<unsigned int,
   (v8::internal::wasm::Decoder::ValidateFlag)1, (v8::internal::wasm::Decoder::AdvancePCFlag)1,
   (v8::internal::wasm::Decoder::TraceFlag)1, 2>(unsigned char const*, unsigned int*, char const*,
   unsigned int) */

uint __thiscall
v8::internal::wasm::Decoder::
read_leb_tail<unsigned_int,(v8::internal::wasm::Decoder::ValidateFlag)1,(v8::internal::wasm::Decoder::AdvancePCFlag)1,(v8::internal::wasm::Decoder::TraceFlag)1,2>
...

{
  ...
  if ((param_1 < pbVar5) &&
     (param_4 = param_4 | ((int)(char)*param_1 & 0x7fU) << 0xe, (char)*param_1 < 0)) {
    pbVar1 = param_1 + 1;
    if ((pbVar1 < pbVar5) &&
