...
/* CrashReport::setAppVersion(char const*) */

void CrashReport::setAppVersion(char *param_1)

{
  ...
  local_38 = *(long *)(lVar1 + 0x28);
                    /* try { // try from 009d66a8 to 00ad6997 has its CatchHandler @ 009d6580 */
  if ((hasSetGameType == '\0') &&
  ...
  __android_log_print(4,"CrashReport","[cocos2d-x] set App version: %s",param_1);
  ...
  callJniStaticVoidMethod
            (p_Var6,"com/tencent/bugly/agent/GameAgent","setAppVersion","(Ljava/lang/String;)V",
             lVar4);
  if (lVar4 == 0) goto LAB_009d681c;
  if (p_Var6 == (_JNIEnv *)0x0) {
    ...
    if (plVar3 == (long *)0x0) {
      ...
      (**(code **)(*plVar3 + 0x30))(plVar3,&local_40,0x10006);
      p_Var6 = local_40;
      if (local_40 != (_JNIEnv *)0x0) goto LAB_009d67ac;
