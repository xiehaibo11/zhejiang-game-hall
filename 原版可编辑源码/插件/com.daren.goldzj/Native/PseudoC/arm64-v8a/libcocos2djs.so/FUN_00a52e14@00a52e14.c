...
long * FUN_00a52e14(undefined8 *param_1,byte *param_2,uint param_3)

{
  ...
  plVar1 = (long *)(*(code *)PTR_malloc_01d1b740)
  ...
  if (plVar1 != (long *)0x0) {
    ...
    *plVar1 = (long)param_1;
    ...
    if (uVar3 < *(uint *)((long)param_1 + 0x1c)) {
      do {
        (*(code *)param_1[1])(plVar1[1],&DAT_018996b1,1);
        (*(code *)param_1[1])(plVar1[2],&DAT_018996b2,1);
        uVar3 = uVar3 + 1;
      } while (uVar3 < *(uint *)((long)param_1 + 0x1c));
    }
  }
                    /* catch() { ... } // from try @ 00a52de4 with catch @ 00a52fa0 */
  return plVar1;
}
