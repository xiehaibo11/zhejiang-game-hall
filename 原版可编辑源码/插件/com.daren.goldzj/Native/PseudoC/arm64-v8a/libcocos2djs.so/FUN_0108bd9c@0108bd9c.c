...
ulong FUN_0108bd9c(ulong *param_1,int param_2)

{
  ...
  FUN_0108bf7c(this,*puVar4,0,*puVar5,bVar1,0,0xffffffff);
  uVar6 = v8::internal::JSObject::GetElementsTransitionMap(param_1,3);
  ...
  *(int *)(uVar9 + 7) = (int)uVar7;
  ...
  uVar7 = v8::internal::JSObject::PrintElementsTransition(waitpid,param_1,bVar1,puVar4,3,puVar5);
  return uVar7;
}
