...
/* bool 
   native_ptr_to_seval<cocos2d::renderer::Light>(std::__ndk1::enable_if<std::is_base_of<cocos2d::Ref,
   cocos2d::renderer::Light>::value, cocos2d::renderer::Light>::type*, se::Value*, bool*) */

bool native_ptr_to_seval<cocos2d::renderer::Light>(type *param_1,Value *param_2,bool *param_3)

{
  ...
  if (param_1 == (type *)0x0) {
    ...
    if (lVar1 == lVar2) {
      pCVar3 = JSBClassType::findClass<cocos2d::renderer::Light>((Light *)param_1);
