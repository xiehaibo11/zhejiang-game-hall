...

{
  ...
  iVar4 = 0;
  local_160[0] = pBVar8;
  if ((pBVar7 == (BIGNUM *)0x0) || (pBVar8 == (BIGNUM *)0x0)) goto LAB_00b8873c;
      ...
      if (uVar12 < 2) {
        ...
        do {
          ...
          if (((!bVar2) && (iVar5 = BN_mod_mul(r,r,r,m,ctx), iVar5 == 0)) ||
             (iVar5 = BN_mod_mul(r,r,pBVar7,m,ctx), iVar5 == 0)) goto LAB_00b88738;
          bVar2 = false;
          iVar3 = iVar3 + -1;
        } while (-1 < iVar3);
      }
