...
/* v8::internal::interpreter::ConstantArrayBuilder::Insert(v8::internal::AstRawString const*) */

undefined4 __thiscall
v8::internal::interpreter::ConstantArrayBuilder::Insert
          (ConstantArrayBuilder *this,AstRawString *param_1)

{
  ...
  if ((*(char *)(puVar7 + 2) != '\0') && (*(AstRawString **)(lVar4 + uVar5 * 0x18) != param_1)) {
    do {
      uVar5 = (ulong)((int)uVar5 + 1U & *(int *)(this + 0x20) - 1U);
      if (*(char *)(lVar4 + uVar5 * 0x18 + 0x10) == '\0') break;
    } while (*(AstRawString **)(lVar4 + uVar5 * 0x18) != param_1);
    puVar7 = (undefined8 *)(lVar4 + uVar5 * 0x18);
  }
  if (*(char *)(puVar7 + 2) == '\0') {
    lVar4 = *(long *)this;
    ...
    uVar3 = ConstantArraySlice::Allocate(lVar4,param_1,3,1);
    *puVar7 = param_1;
