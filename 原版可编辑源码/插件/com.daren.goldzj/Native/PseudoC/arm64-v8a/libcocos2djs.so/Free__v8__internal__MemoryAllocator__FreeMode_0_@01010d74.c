...
/* void 
   v8::internal::MemoryAllocator::Free<(v8::internal::MemoryAllocator::FreeMode)0>(v8::internal::MemoryChunk*)
    */

void __thiscall
v8::internal::MemoryAllocator::Free<(v8::internal::MemoryAllocator::FreeMode)0>
...

{
  ...
  *(ulong *)(param_1 + 8) = *(ulong *)(param_1 + 8) | 0x2000;
  PerformFreeMemory(this,param_1);
  return;
}
