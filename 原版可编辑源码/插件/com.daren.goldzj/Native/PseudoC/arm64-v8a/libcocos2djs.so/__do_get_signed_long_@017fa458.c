...
LAB_017fa53c:
  ...
  if ((param_2 == (long *)0x0) || (param_2[3] != param_2[4])) {
    if (param_3 != (long *)0x0) goto LAB_017fa550;
LAB_017fa598:
    param_3 = (long *)0x0;
    if (plVar17 == (long *)0x0) goto LAB_017fa688;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_017fa598;
LAB_017fa550:
...
LAB_017fa688:
  ...
  uVar6 = FUN_01828710(pcVar19,local_168,param_5,iVar5);
  *param_6 = uVar6;
  uVar7 = (ulong)((byte)local_148[0] >> 1);
  if (((byte)local_148[0] & 1) != 0) {
    uVar7 = local_140;
  ...
  if (uVar7 != 0) {
    ...
    if (local_12c < puVar9) {
      ...
      do {
        if ((bVar16) && (*puVar15 != uVar10)) goto LAB_017fa7dc;
...
LAB_017fa7dc:
  ...
  if ((plVar17 == (long *)0x0) || (plVar17[3] != plVar17[4])) {
    if (param_3 != (long *)0x0) goto LAB_017fa7f8;
LAB_017fa8a4:
    if (plVar18 != (long *)0x0) goto LAB_017fa82c;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_017fa8a4;
LAB_017fa7f8:
