...
/* void std::__ndk1::vector<cocos2d::renderer::NodeProxy*,
   std::__ndk1::allocator<cocos2d::renderer::NodeProxy*>
   >::__push_back_slow_path<cocos2d::renderer::NodeProxy* const&>(cocos2d::renderer::NodeProxy*
   const&) */
