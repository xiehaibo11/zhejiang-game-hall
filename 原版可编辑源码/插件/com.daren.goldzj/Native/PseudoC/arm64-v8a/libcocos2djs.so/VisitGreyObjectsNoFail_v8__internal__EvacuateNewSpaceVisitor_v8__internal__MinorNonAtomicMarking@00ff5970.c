...
/* void 
   v8::internal::LiveObjectVisitor::VisitGreyObjectsNoFail<v8::internal::EvacuateNewSpaceVisitor,
   v8::internal::MinorNonAtomicMarkingState>(v8::internal::MemoryChunk*,
   v8::internal::MinorNonAtomicMarkingState*, v8::internal::EvacuateNewSpaceVisitor*,
...

{
  ...
  if (VisitGreyObjectsNoFail<v8::internal::EvacuateNewSpaceVisitor,v8::internal::MinorNonAtomicMarkingState>(v8::internal::MemoryChunk*,v8::internal::MinorNonAtomicMarkingState*,v8::internal::EvacuateNewSpaceVisitor*,v8::internal::LiveObjectVisitor::IterationMode)
      ::trace_event_unique_atomic3207 == (byte *)0x0) {
    plVar7 = (long *)tracing::TraceEventHelper::GetTracingController();
    VisitGreyObjectsNoFail<v8::internal::EvacuateNewSpaceVisitor,v8::internal::MinorNonAtomicMarkingState>(v8::internal::MemoryChunk*,v8::internal::MinorNonAtomicMarkingState*,v8::internal::EvacuateNewSpaceVisitor*,v8::internal::LiveObjectVisitor::IterationMode)
    ::trace_event_unique_atomic3207 =
         (byte *)(**(code **)(*plVar7 + 0x10))(plVar7,"disabled-by-default-v8.gc");
  }
  pbVar4 = VisitGreyObjectsNoFail<v8::internal::EvacuateNewSpaceVisitor,v8::internal::MinorNonAtomicMarkingState>(v8::internal::MemoryChunk*,v8::internal::MinorNonAtomicMarkingState*,v8::internal::EvacuateNewSpaceVisitor*,v8::internal::LiveObjectVisitor::IterationMode)
           ::trace_event_unique_atomic3207;
  local_138 = (byte **)0x0;
  if ((*VisitGreyObjectsNoFail<v8::internal::EvacuateNewSpaceVisitor,v8::internal::MinorNonAtomicMarkingState>(v8::internal::MemoryChunk*,v8::internal::MinorNonAtomicMarkingState*,v8::internal::EvacuateNewSpaceVisitor*,v8::internal::LiveObjectVisitor::IterationMode)
  ...
  if ((*(byte *)(param_1 + 1) >> 5 & 1) != 0) {
    ...
    if ((uVar10 & *puVar1) != 0) {
      ...
      if ((puVar1[bVar5] & uVar10) == 0) {
        ...
        EvacuateNewSpaceVisitor::Visit(param_3,plVar7,uVar6);
      }
    }
    goto joined_r0x00ff5b60;
  }
  lVar13 = param_1[0x21];
  lVar2 = param_1[5];
  lVar11 = param_1[3];
  ...
  if (uVar14 == 0) {
    local_e0 = param_1;
    if (local_e8 != 0) goto LAB_00ff5be4;
LAB_00ff5c0c:
    iVar9 = 0;
  }
  else {
    ...
    local_e4 = uVar14;
    if (local_e8 <= uVar14) goto LAB_00ff5c0c;
LAB_00ff5be4:
