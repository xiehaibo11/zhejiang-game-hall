...
/* v8::internal::TurboAssembler::Tbnz(v8::internal::Register const&, unsigned int,
   v8::internal::Label*) */

void __thiscall
v8::internal::TurboAssembler::Tbnz
...

{
  ...
  if ((uVar1 & 1) == 0) {
    Assembler::tbnz((Assembler *)this,param_1,param_2,param_3);
  }
  else {
    Assembler::tbz((Assembler *)this,param_1,param_2,(Label *)&local_38);
