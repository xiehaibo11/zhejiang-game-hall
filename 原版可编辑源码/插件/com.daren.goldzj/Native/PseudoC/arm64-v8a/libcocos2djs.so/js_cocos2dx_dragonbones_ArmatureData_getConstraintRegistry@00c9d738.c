...
/* js_cocos2dx_dragonbones_ArmatureData_getConstraintRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_ArmatureData_getConstraintRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar5 == 0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_ArmatureData_getConstraint : Invalid Native Object"
                       );
  }
  else {
...
LAB_00c9d914:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                            ,uVar10,&DAT_01928824);
        __android_log_print(6,"jswrapper",&DAT_019306f7);
        bVar3 = false;
      }
      else {
        lVar8 = std::__ndk1::
                ...
                find<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>
                          ((__tree<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::ConstraintData*>,std::__ndk1::__map_value_compare<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::ConstraintData*>,std::__ndk1::less<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::ConstraintData*>>>
                            *)(lVar5 + 0xf0),(basic_string *)&local_78);
        if (lVar5 + 0xf8 == lVar8) {
          ptVar12 = (type *)0x0;
        }
        else {
        ...
        bVar3 = native_ptr_to_seval<dragonBones::ConstraintData>(ptVar12,pVVar9,(bool *)0x0);
        if (!bVar3) {
          uVar10 = 0x531;
          goto LAB_00c9d914;
        }
      ...
      if (bVar3) goto LAB_00c9d974;
    }
    else {
      __android_log_print(6,"jswrapper",&DAT_01930747,(ulong)(plVar6[1] - *plVar6) >> 4,1);
    }
  }
