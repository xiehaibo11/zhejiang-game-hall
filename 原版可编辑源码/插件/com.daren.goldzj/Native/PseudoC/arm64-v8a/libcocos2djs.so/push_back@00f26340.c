...
/* std::__ndk1::__split_buffer<v8::internal::TranslatedState::ObjectPosition*,
   std::__ndk1::allocator<v8::internal::TranslatedState::ObjectPosition*>&>::push_back(v8::internal::TranslatedState::ObjectPosition*&&)
    */
...

{
  ...
  puVar12 = puVar4;
  if (puVar4 != *(undefined8 **)(this + 0x18)) goto LAB_00f264c8;
...
LAB_00f26494:
      ...
      if (((void *)((long)pvVar6 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar6 + uVar13 * 8 + uVar9 + 8))) goto LAB_00f26494;
      ...
      puVar11 = puVar12;
      if (uVar2 != uVar9) goto LAB_00f26494;
    }
    puVar11 = *(undefined8 **)this;
  }
  *(void **)this = pvVar6;
