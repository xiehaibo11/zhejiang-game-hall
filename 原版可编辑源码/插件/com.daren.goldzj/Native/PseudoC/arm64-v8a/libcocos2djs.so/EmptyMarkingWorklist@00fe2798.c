...
/* v8::internal::YoungGenerationMarkingTask::EmptyMarkingWorklist() */

void __thiscall
v8::internal::YoungGenerationMarkingTask::EmptyMarkingWorklist(YoungGenerationMarkingTask *this)
...
LAB_00fe3564:
      ...
      case 0x24:
        puVar19 = (uint *)(local_80 + 3);
        puVar3 = (uint *)(local_80 + 0x13);
        if (puVar3 <= puVar19) goto LAB_00fe4180;
        do {
          uVar12 = *puVar19;
          if ((uVar12 & 1) != 0) {
            uVar18 = (ulong)puVar19 & 0xffffffff00000000 | (ulong)uVar12;
...
LAB_00fe4310:
      ...
      case 0x30:
        puVar19 = (uint *)(local_80 + 0xb);
        puVar3 = (uint *)(local_80 + 0xf);
        if (puVar3 <= puVar19) goto LAB_00fe4310;
        do {
          uVar12 = *puVar19;
          if ((uVar12 & 1) != 0) {
            uVar18 = (ulong)puVar19 & 0xffffffff00000000 | (ulong)uVar12;
