...
/* void std::__ndk1::vector<dragonBones::ArmatureCache::SegmentData*,
   std::__ndk1::allocator<dragonBones::ArmatureCache::SegmentData*>
   >::__push_back_slow_path<dragonBones::ArmatureCache::SegmentData*
   const&>(dragonBones::ArmatureCache::SegmentData* const&) */
...
LAB_00d551f0:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d551f0;
  }
  else {
