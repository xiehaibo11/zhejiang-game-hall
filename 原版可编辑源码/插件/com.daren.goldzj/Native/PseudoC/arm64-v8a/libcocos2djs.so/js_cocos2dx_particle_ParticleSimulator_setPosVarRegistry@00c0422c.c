...
/* js_cocos2dx_particle_ParticleSimulator_setPosVarRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_particle_ParticleSimulator_setPosVarRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x70,"js_cocos2dx_particle_ParticleSimulator_setPosVar");
    pcVar9 = "js_cocos2dx_particle_ParticleSimulator_setPosVar : Invalid Native Object";
LAB_00c043dc:
    ...
    if (uVar10 == 0x30) {
      ...
      if ((((uVar10 & 1) != 0) && ((uVar6 & 1) != 0)) && ((uVar7 & 1) != 0)) {
        *(undefined4 *)(lVar4 + 0xf0) = local_78._4_4_;
        *(float *)(lVar4 + 0xf4) = (float)local_78;
        *(float *)(lVar4 + 0xf8) = local_7c;
        goto LAB_00c04414;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                          ,0x7b,"js_cocos2dx_particle_ParticleSimulator_setPosVar");
      pcVar9 = "js_cocos2dx_particle_ParticleSimulator_setPosVar : Error processing arguments";
      goto LAB_00c043dc;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp, 127): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar10 >> 4,3);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_particle_ParticleSimulator_setPosVar",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                      ,0x82);
LAB_00c04414:
