...
/* JSB_glGetProgramInfoLogRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glGetProgramInfoLogRegistry(FunctionCallbackInfo *param_1)
...
LAB_008cd304:
      ...
      if (1 < (byte)VVar1) goto LAB_008cd304;
      uVar10 = 0;
    }
    glGetProgramiv(uVar10,0x8b84,&local_74);
    if ((local_74 < 1) || (iVar4 = glGetError(), iVar4 != 0)) {
      ...
      glGetProgramInfoLog(uVar10,local_74,0,pcVar9);
      pVVar7 = (Value *)se::State::rval(aSStack_70);
