...
/* std::__ndk1::__deque_base<v8::internal::Map,
   v8::internal::RecyclingZoneAllocator<v8::internal::Map> >::clear() */

void __thiscall
std::__ndk1::__deque_base<v8::internal::Map,v8::internal::RecyclingZoneAllocator<v8::internal::Map>>
::clear(__deque_base<v8::internal::Map,v8::internal::RecyclingZoneAllocator<v8::internal::Map>>
        *this)
  ...
  if (lVar4 - (long)puVar2 != 0) {
    ...
    while (lVar1 != lVar9) {
      while (lVar9 = lVar9 + 8, lVar9 - *plVar6 == 0x1000) {
        plVar6 = plVar6 + 1;
        lVar9 = *plVar6;
        if (lVar1 == lVar9) goto LAB_010f2158;
      }
    }
  }
LAB_010f2158:
...
LAB_010f21c0:
  ...
  if (puVar5 != (undefined8 *)0x0) goto LAB_010f21b0;
  do {
    puVar5 = puVar7;
    puVar5[1] = 0x200;
    *puVar5 = *(undefined8 *)(this + 0x48);
