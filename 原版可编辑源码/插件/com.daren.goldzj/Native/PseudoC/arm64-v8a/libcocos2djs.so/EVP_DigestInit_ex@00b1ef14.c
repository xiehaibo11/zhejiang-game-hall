...

{
  ...
  if ((ctx->engine == (ENGINE *)0x0) || (ctx->digest == (EVP_MD *)0x0)) {
    if (type != (EVP_MD *)0x0) goto LAB_00b1ef64;
    if (ctx->digest != (EVP_MD *)0x0) goto LAB_00b1f04c;
...
LAB_00b1ef64:
      ...
      if (impl == (ENGINE *)0x0) {
        ...
        if (impl != (ENGINE *)0x0) goto LAB_00b1efd0;
      }
      else {
...
LAB_00b1f04c:
    if (((ctx->pctx == (EVP_PKEY_CTX *)0x0) ||
      ...
      if ((ctx->flags & 0x100) == 0) {
                    /* WARNING: Could not recover jumptable at 0x00b1f0a0. Too many branches */
