...
void FUN_0142eec0(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  bVar2 = *(byte *)(unaff_x20 + CONCAT44(unaff_0000409c,unaff_w19) + 2);
  iVar3 = unaff_w19 * 2;
  lVar1 = unaff_x26 +
          (ulong)*(uint *)(unaff_x26 + (ulong)*(uint *)(unaff_x20 + 7) +
                          (ulong)*(byte *)(unaff_x20 + CONCAT44(unaff_0000409c,unaff_w19) + 1) * 4 +
                          7);
  if ((bVar2 & 1) != 0) {
