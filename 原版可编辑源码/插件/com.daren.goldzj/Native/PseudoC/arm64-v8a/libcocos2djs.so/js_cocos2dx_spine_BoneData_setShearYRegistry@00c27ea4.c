...
/* js_cocos2dx_spine_BoneData_setShearYRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_BoneData_setShearYRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (BoneData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xc6b,"js_cocos2dx_spine_BoneData_setShearY");
    pcVar6 = "js_cocos2dx_spine_BoneData_setShearY : Invalid Native Object";
LAB_00c28018:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::BoneData::setShearY(this,local_64);
        goto LAB_00c28050;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0xc72,"js_cocos2dx_spine_BoneData_setShearY");
      pcVar6 = "js_cocos2dx_spine_BoneData_setShearY : Error processing arguments";
      goto LAB_00c28018;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 3190): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_BoneData_setShearY",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0xc79);
LAB_00c28050:
