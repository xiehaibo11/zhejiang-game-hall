...
/* v8::internal::MarkCompactCollector::ProcessEphemeron(v8::internal::HeapObject,
   v8::internal::HeapObject) */

undefined8 __thiscall
v8::internal::MarkCompactCollector::ProcessEphemeron
          (MarkCompactCollector *this,ulong param_2,ulong param_3)

{
  ...
  if ((*(uint *)(*(long *)((param_2 & 0xfffffffffffc0000) + 0x10) + (uVar7 >> 7 & 0x1ffffff) * 4) >>
    ...
    if ((*puVar1 & uVar6) == 0) {
      ...
      puVar10[1] = lVar8 + 1;
      puVar10[lVar8 * 2 + 2] = param_2;
      puVar10[lVar8 * 2 + 3] = param_3;
      return 0;
    }
  }
  else {
