...
/* void std::__ndk1::vector<v8::internal::Context, std::__ndk1::allocator<v8::internal::Context>
   >::__push_back_slow_path<v8::internal::Context>(v8::internal::Context&&) */

void __thiscall
std::__ndk1::vector<v8::internal::Context,std::__ndk1::allocator<v8::internal::Context>>::
__push_back_slow_path<v8::internal::Context>
          (vector<v8::internal::Context,std::__ndk1::allocator<v8::internal::Context>> *this,
          Context *param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00ed7020;
