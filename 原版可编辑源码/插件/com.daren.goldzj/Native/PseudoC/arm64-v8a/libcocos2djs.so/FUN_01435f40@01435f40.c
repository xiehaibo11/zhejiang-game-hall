...
void FUN_01435f40(ulong param_1)

{
  ...
  cVar3 = *(char *)(unaff_x20 + unaff_x19 + 1);
  lVar9 = unaff_x26 +
  ...
  uVar13 = (uint)bVar5;
  lVar12 = (ulong)*(byte *)(unaff_x20 + unaff_x19 + 2) * 4 + 0x1f;
  uVar16 = 0;
  ...
  do {
    ...
    if ((param_1 & 1) == 0) {
      ...
      uVar13 = uVar14;
LAB_014360e0:
      iVar17 = iVar17 << (ulong)(iVar7 * 2 >> 1 & 0x1f);
      if (SCARRY4(iVar17,iVar17)) {
        ...
        *(double *)(uVar8 + 3) = (double)iVar17;
      }
      else {
        uVar8 = (ulong)(iVar17 * 2);
        unaff_x29 = lVar6;
        lVar9 = lVar10;
        lVar12 = lVar11;
        uVar14 = uVar13;
      ...
      if ((uVar14 == 0) &&
        ...
        *(undefined4 *)(lVar9 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x01436154. Too many branches */
