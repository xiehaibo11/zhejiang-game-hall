...
int FUN_00ad4b3c(long param_1,void *param_2,undefined4 *param_3)

{
  ...
  if (*(long *)((long)param_2 + 0x18) + uVar5 <= *(ulong *)((long)param_2 + 8)) {
    ...
    if (*(ulong *)((long)param_2 + 8) <= uVar6) {
      ...
      if (ppVar2 == (pitem *)0x0) {
        __dest = (void *)FUN_00ad4988(*(undefined8 *)((long)param_2 + 8),1);
        if (__dest != (void *)0x0) {
...
LAB_00ad4d08:
            if (ppVar2 != (pitem *)0x0) goto LAB_00ad4b94;
          }
          else {
            iVar1 = (**(code **)(*(long *)(param_1 + 8) + 0x68))
                              (param_1,0x16,0,
            ...
            if ((long)uVar5 < 9) {
              ...
              *(byte *)(*(long *)((long)__dest + 0x60) + lVar7) =
                   *(byte *)(*(long *)((long)__dest + 0x60) + lVar7) | (&DAT_018a4a8b)[uVar6 & 7];
            }
            ...
            if (*(char *)((long)ptr + lVar4) == (&DAT_018a4a8b)[uVar5 & 7]) {
              do {
                if (lVar4 < 1) {
                  CRYPTO_free(ptr);
