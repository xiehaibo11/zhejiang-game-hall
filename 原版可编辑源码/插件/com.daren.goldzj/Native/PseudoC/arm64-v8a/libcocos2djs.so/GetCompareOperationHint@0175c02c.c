...
/* v8::internal::compiler::JSTypeHintLowering::GetCompareOperationHint(v8::internal::FeedbackSlot)
   const */

void __thiscall
v8::internal::compiler::JSTypeHintLowering::GetCompareOperationHint
