...
/* XMLHttpRequest_getStatusTextRegistry(v8::Local<v8::Name>, v8::PropertyCallbackInfo<v8::Value>
   const&) */

void XMLHttpRequest_getStatusTextRegistry(undefined8 param_1,PropertyCallbackInfo *param_2)

{
  ...
  se::Value::setString(pVVar4,(basic_string *)(lVar3 + 0x210));
  pVVar4 = (Value *)se::State::rval(aSStack_60);
