...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::extension::Manifest::AssetDiff> > >::__rehash(unsigned long) */
...

{
  ...
  ulong uVar17;
                    ...
                    /* try { // try from 00a5ebf8 to 00b5ecef has its CatchHandler @ 00a5e99c */
  if (param_1 == 0) {
                    /* catch() { ... } // from try @ 00a5ea60 with catch @ 00a5ec70
                       catch() { ... } // from try @ 00a5eb08 with catch @ 00a5ec70 */
    pvVar9 = *(void **)this;
    *(undefined8 *)this = 0;
    if (pvVar9 != (void *)0x0) {
      operator_delete(pvVar9);
    }
                    /* catch() { ... } // from try @ 00a5ea1c with catch @ 00a5ec80 */
    *(undefined8 *)(this + 8) = 0;
                    /* catch() { ... } // from try @ 00a5ea10 with catch @ 00a5ec84 */
  }
  else {
    if (param_1 >> 0x3d != 0) {
    ...
    *(ulong *)(this + 8) = param_1;
    ...
    if (plVar14 != (long *)0x0) {
      ...
      uVar16 = param_1 - 1;
      if ((uVar16 & param_1) == 0) {
                    /* catch() { ... } // from try @ 00a5e9f0 with catch @ 00a5ec88 */
        ...
        uVar11 = uVar11 - uVar17 * param_1;
                    /* catch() { ... } // from try @ 00a5ea84 with catch @ 00a5ec6c
                       catch() { ... } // from try @ 00a5eb5c with catch @ 00a5ec6c */
      }
      *(__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::extension::Manifest::AssetDiff>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::extension::Manifest::AssetDiff>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::extension::Manifest::AssetDiff>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::extension::Manifest::AssetDiff>>>
        **)(*(long *)this + uVar11 * 8) = this + 0x10;
                    /* catch() { ... } // from try @ 00a5ea28 with catch @ 00a5ec98
                       catch() { ... } // from try @ 00a5ea9c with catch @ 00a5ec98
                       catch() { ... } // from try @ 00a5ebbc with catch @ 00a5ec98 */
          ...
          if (*(long *)(*(long *)this + uVar17 * 8) == 0) {
            *(long **)(*(long *)this + uVar17 * 8) = plVar14;
            ...
            if ((long *)*plVar15 != (long *)0x0) {
                    /* try { // try from 00a5ecf0 to 00b5ed43 has its CatchHandler @ 00a5ecf0
                       catch() { ... } // from try @ 00a5ecf0 with catch @ 00a5ecf0
                       catch() { ... } // from try @ 00a5ee7c with catch @ 00a5ecf0 */
              ...
              do {
                ...
                __s1 = (char *)((long)plVar15 + 0x11);
                    /* try { // try from 00a5ed44 to 00b5ed5b has its CatchHandler @ 00a5ef08 */
                if ((bVar3 & 1) != 0) {
                  __s1 = (char *)plVar15[4];
                }
                if ((bVar2 & 1) == 0) {
                ...
                if ((bVar3 & 1) == 0) {
                  while (sVar6 != 0) {
                    /* try { // try from 00a5ed64 to 00b5ed6f has its CatchHandler @ 00a5ef04 */
                    if (*pcVar5 != *__s2) goto LAB_00a5edb8;
                    /* try { // try from 00a5ed70 to 00b5ed7b has its CatchHandler @ 00a5ef00 */
                    __s2 = __s2 + 1;
                    sVar1 = sVar1 + 1;
                    /* try { // try from 00a5ed7c to 00b5ed93 has its CatchHandler @ 00a5ef30 */
                    pcVar5 = pcVar5 + 1;
                    sVar6 = sVar1;
                  }
                }
                else {
                    /* try { // try from 00a5ed94 to 00b5eda3 has its CatchHandler @ 00a5eef8 */
                    /* try { // try from 00a5eda4 to 00b5edab has its CatchHandler @ 00a5eef0 */
                  if ((__n != 0) && (iVar8 = memcmp(__s1,__s2,__n), iVar8 != 0)) break;
                }
                    /* try { // try from 00a5edac to 00b5ede7 has its CatchHandler @ 00a5ef18 */
                plVar7 = (long *)*plVar12;
                plVar13 = plVar12;
...
LAB_00a5edb8:
        ...
        plVar14 = plVar15;
                    ...
                    /* try { // try from 00a5edfc to 00b5ee7b has its CatchHandler @ 00a5ef30 */
  return;
}
