...
/* void std::__ndk1::vector<std::__ndk1::pair<v8::internal::Handle<v8::internal::Object>,
   v8::internal::Handle<v8::internal::Object> >,
   std::__ndk1::allocator<std::__ndk1::pair<v8::internal::Handle<v8::internal::Object>,
   v8::internal::Handle<v8::internal::Object> > >
...

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_01053cb4;
