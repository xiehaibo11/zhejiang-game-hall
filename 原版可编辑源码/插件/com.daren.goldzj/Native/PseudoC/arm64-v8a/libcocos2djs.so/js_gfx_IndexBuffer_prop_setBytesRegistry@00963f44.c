...
/* js_gfx_IndexBuffer_prop_setBytesRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_gfx_IndexBuffer_prop_setBytesRegistry(undefined8 param_1,undefined8 param_2,long *param_3)

{
  ...
  if (lVar5 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2de,"js_gfx_IndexBuffer_prop_setBytes");
    __android_log_print(6,"jswrapper","js_gfx_IndexBuffer_prop_setBytes : Invalid Native Object");
  }
  else {
    ...
    if (uVar7 == 0x10) {
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp"
                          ,0x2e5,"js_gfx_IndexBuffer_prop_setBytes");
      __android_log_print(6,"jswrapper","Convert arg0 offset failed!");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp, 746): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar7 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_gfx_IndexBuffer_prop_setBytes",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp"
                      ,0x2ed);
LAB_0096413c:
