...
/* spine::Vector<spine::AtlasRegion*>::~Vector() */

void __thiscall spine::Vector<spine::AtlasRegion*>::~Vector(Vector<spine::AtlasRegion*> *this)

{
  ...
  *(undefined ***)this = &PTR__Vector_01c8e838;
  *(undefined8 *)(this + 8) = 0;
  if (lVar2 != 0) {
