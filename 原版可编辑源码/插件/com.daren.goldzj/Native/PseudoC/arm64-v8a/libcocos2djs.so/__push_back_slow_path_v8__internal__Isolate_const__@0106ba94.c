...
/* void std::__ndk1::vector<v8::internal::Isolate*, std::__ndk1::allocator<v8::internal::Isolate*>
   >::__push_back_slow_path<v8::internal::Isolate* const&>(v8::internal::Isolate* const&) */

void __thiscall
std::__ndk1::vector<v8::internal::Isolate*,std::__ndk1::allocator<v8::internal::Isolate*>>::
__push_back_slow_path<v8::internal::Isolate*const&>
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_0106bb7c;
