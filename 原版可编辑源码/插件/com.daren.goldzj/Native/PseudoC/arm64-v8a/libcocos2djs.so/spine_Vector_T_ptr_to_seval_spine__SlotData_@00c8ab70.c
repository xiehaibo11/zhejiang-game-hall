...
/* bool spine_Vector_T_ptr_to_seval<spine::SlotData>(spine::Vector<spine::SlotData*> const&,
   se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::SlotData>(Vector *param_1,Value *param_2)
...
LAB_00c8ac38:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::SlotData>
