...
joined_r0x01770b84:
  if (p_Var3 == (__tree_node_base *)0x0) {
    ...
    if ((ulong)(*(long *)(this + 0x18) - (long)p_Var3) < 0x48) {
      p_Var3 = (__tree_node_base *)v8::internal::Zone::NewExpand(this,0x48);
    }
    else {
      *(__tree_node_base **)(this + 0x10) = p_Var3 + 0x48;
    }
