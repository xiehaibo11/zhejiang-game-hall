...
undefined8 FUN_0109b628(undefined8 param_1,ulong *param_2,long *param_3,long *param_4,int param_5)

{
  ...
  if (local_80 == (ulong *)0x0) {
    ...
    if (*piVar4 >> 1 != 0) {
      ...
      uVar19 = *puVar2;
      if ((uVar19 & 1) != 0) goto LAB_0109b75c;
      do {
        iVar12 = iVar12 + 1;
        do {
          lVar15 = lVar15 + 4;
          if ((ulong)(uint)(*piVar4 >> 1) * 4 - lVar15 == 0) goto LAB_0109b770;
  ...
  if (iVar6 < 0) {
    ...
    if (0 < (int)uVar7) {
      ...
      if (uVar7 < 8) {
        ...
        if (uVar22 == uVar17) goto LAB_0109ba34;
      }
