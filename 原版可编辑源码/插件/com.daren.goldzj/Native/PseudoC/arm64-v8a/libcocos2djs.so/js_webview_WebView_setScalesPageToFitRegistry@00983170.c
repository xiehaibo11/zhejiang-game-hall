...
/* js_webview_WebView_setScalesPageToFitRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_webview_WebView_setScalesPageToFitRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (WebView *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xbf,"js_webview_WebView_setScalesPageToFit");
    __android_log_print(6,"jswrapper",
                        "js_webview_WebView_setScalesPageToFit : Invalid Native Object");
  }
  else {
    ...
    if (uVar6 == 0x10) {
      ...
      if ((uVar6 & 1) != 0) {
        cocos2d::WebView::setScalesPageToFit(this,local_64[0]);
        goto LAB_00983324;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_webview_auto.cpp"
                          ,0xc6,"js_webview_WebView_setScalesPageToFit");
      __android_log_print(6,"jswrapper",
                          "js_webview_WebView_setScalesPageToFit : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_webview_auto.cpp, 202): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar6 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_webview_WebView_setScalesPageToFit",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_webview_auto.cpp"
                      ,0xcd);
LAB_00983324:
