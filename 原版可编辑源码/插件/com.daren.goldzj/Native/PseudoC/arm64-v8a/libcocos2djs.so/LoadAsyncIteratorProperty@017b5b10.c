...
/* v8::internal::interpreter::BytecodeArrayBuilder::LoadAsyncIteratorProperty(v8::internal::interpreter::Register,
   int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::LoadAsyncIteratorProperty
...

{
  ...
  uVar2 = ConstantArrayBuilder::InsertAsyncIteratorSymbol();
