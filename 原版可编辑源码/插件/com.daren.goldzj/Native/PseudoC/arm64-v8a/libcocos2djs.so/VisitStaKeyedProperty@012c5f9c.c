...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitStaKeyedProperty(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::VisitStaKeyedProperty
...
LAB_012c6104:
  ...
  ProcessKeyedPropertyAccess(this,lVar5,lVar6,uVar2,1,1);
  return;
}
