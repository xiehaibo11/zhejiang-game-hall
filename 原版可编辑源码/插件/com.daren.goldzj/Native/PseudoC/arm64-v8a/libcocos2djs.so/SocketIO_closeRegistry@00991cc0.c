...
/* SocketIO_closeRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void SocketIO_closeRegistry(FunctionCallbackInfo *param_1)

{
  ...
  uVar6 = (ulong)(plVar4[1] - *plVar4) >> 4;
  if ((int)uVar6 != 0) {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_socketio.cpp, 374): Wrong number of arguments: %d, expected: %d\n"
                        ,uVar6,0);
