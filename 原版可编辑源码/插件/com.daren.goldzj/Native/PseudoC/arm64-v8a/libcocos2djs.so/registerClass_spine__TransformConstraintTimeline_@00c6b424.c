...
/* void JSBClassType::registerClass<spine::TransformConstraintTimeline>(se::Class*) */

void JSBClassType::registerClass<spine::TransformConstraintTimeline>(Class *param_1)
