...
/* v8::internal::compiler::InstructionSelector::VisitF64x2Qfma(v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::InstructionSelector::VisitF64x2Qfma(InstructionSelector *this,Node *param_1)

{
  ...
  Emit(this,0x10c,(uVar1 & 0xffffffff) << 3 | 0xf800000001,(uVar2 & 0xffffffff) << 3 | 0x5800000001,
