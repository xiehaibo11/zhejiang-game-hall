...
/* v8::internal::interpreter::BytecodeArrayBuilder::OutputStarRaw(v8::internal::interpreter::Register)
    */

void __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::OutputStarRaw
