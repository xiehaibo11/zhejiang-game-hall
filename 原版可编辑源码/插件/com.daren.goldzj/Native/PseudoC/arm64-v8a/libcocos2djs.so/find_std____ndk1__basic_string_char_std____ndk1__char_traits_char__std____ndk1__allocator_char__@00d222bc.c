...
/* std::__ndk1::__tree_iterator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::vector<dragonBones::ConstraintTimelineState*,
   std::__ndk1::allocator<dragonBones::ConstraintTimelineState*> > >,
   std::__ndk1::__tree_node<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   std::__ndk1::vector<dragonBones::ConstraintTimelineState*,
   std::__ndk1::allocator<dragonBones::ConstraintTimelineState*> > >, void*>*, long>
