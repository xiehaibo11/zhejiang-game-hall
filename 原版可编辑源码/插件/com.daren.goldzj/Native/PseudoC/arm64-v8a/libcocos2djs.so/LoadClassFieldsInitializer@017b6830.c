...
/* v8::internal::interpreter::BytecodeArrayBuilder::LoadClassFieldsInitializer(v8::internal::interpreter::Register,
   int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::LoadClassFieldsInitializer
...

{
  ...
  uVar2 = ConstantArrayBuilder::InsertClassFieldsSymbol();
