...
/* js_cocos2dx_dragonbones_EventObject_set_boneRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_EventObject_set_boneRegistry
...

{
  ...
  if (lVar7 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1982,"js_cocos2dx_dragonbones_EventObject_set_bone");
    pcVar9 = "js_cocos2dx_dragonbones_EventObject_set_bone : Invalid Native Object";
  }
  else {
...
LAB_00cc1df4:
    ...
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x1987,"js_cocos2dx_dragonbones_EventObject_set_bone");
    pcVar9 = "js_cocos2dx_dragonbones_EventObject_set_bone : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar9);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_EventObject_set_bone",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x198b);
LAB_00cc1e6c:
