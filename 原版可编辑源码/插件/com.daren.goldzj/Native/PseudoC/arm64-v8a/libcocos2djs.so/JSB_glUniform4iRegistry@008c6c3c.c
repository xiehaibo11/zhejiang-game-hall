...
/* JSB_glUniform4iRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glUniform4iRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if ((plVar9[1] - *plVar9 & 0xffffffff0U) == 0x50) {
    uVar3 = seval_to_int32((Value *)*plVar9,&iStack_84);
    uVar4 = seval_to_int32((Value *)(*plVar9 + 0x10),&local_88);
    uVar5 = seval_to_int32((Value *)(*plVar9 + 0x20),&iStack_8c);
    uVar6 = seval_to_int32((Value *)(*plVar9 + 0x30),&local_90);
    uVar7 = seval_to_int32((Value *)(*plVar9 + 0x40),&local_94);
    if ((uVar3 & uVar4 & uVar5 & uVar6 & uVar7 & 1) != 0) {
      glUniform4i(iStack_84,local_88,iStack_8c,local_90,local_94);
      goto LAB_008c6e2c;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                        ,0xa15,"JSB_glUniform4i");
    __android_log_print(6,"jswrapper",&DAT_0190552e);
  }
  else {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                        ,0xa0c,"JSB_glUniform4i");
