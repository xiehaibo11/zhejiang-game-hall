...
/* v8::internal::ValueSerializer::WriteDouble(double) */

void __thiscall v8::internal::ValueSerializer::WriteDouble(ValueSerializer *this,double param_1)

{
  ...
  *(double *)((long)pvVar3 + lVar2) = param_1;
  return;
}
