...
/* void std::__ndk1::__inplace_merge<v8::internal::compiler::SwitchInfo::CasesSortedByValue()
...
void std::__ndk1::
     __inplace_merge<v8::internal::compiler::SwitchInfo::CasesSortedByValue()const::_lambda(v8::internal::compiler::CaseInfo,v8::internal::compiler::CaseInfo)_1_&,std::__ndk1::__wrap_iter<v8::internal::compiler::CaseInfo*>>
               (int *param_1,int *param_2,int *param_3,undefined8 param_4,long param_5,long param_6,
...

{
  ...
  while( true ) {
    ...
    if (param_5 + lVar17 < (param_6 - (param_5 + lVar17)) - lVar18) {
      __inplace_merge<v8::internal::compiler::SwitchInfo::CasesSortedByValue()const::_lambda(v8::internal::compiler::CaseInfo,v8::internal::compiler::CaseInfo)_1_&,std::__ndk1::__wrap_iter<v8::internal::compiler::CaseInfo*>>
                (param_1,piVar13,piVar12,param_4,param_5,lVar17,param_7,param_8);
      ...
      __inplace_merge<v8::internal::compiler::SwitchInfo::CasesSortedByValue()const::_lambda(v8::internal::compiler::CaseInfo,v8::internal::compiler::CaseInfo)_1_&,std::__ndk1::__wrap_iter<v8::internal::compiler::CaseInfo*>>
                (piVar12,piVar19,param_3,param_4,-(param_5 + lVar18),param_6 - lVar17,param_7,
                 param_8);
      param_6 = lVar17;
      param_3 = piVar12;
      param_2 = piVar13;
