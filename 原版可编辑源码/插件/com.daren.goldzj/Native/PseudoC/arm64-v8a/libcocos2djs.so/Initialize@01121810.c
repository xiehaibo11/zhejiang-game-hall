...
/* v8::internal::SmallOrderedHashTable<v8::internal::SmallOrderedHashMap>::Initialize(v8::internal::Isolate*,
   int) */

void __thiscall
v8::internal::SmallOrderedHashTable<v8::internal::SmallOrderedHashMap>::Initialize
...

{
  ...
  *(undefined1 *)(*(long *)this + 6) = 0;
  memset((void *)(*(long *)this + (long)(int)(param_2 << 3 | 7)),0xff,(long)((iVar1 >> 1) + param_2)
        );
  uVar5 = *(ulong *)this;
    ...
    if (0 < param_2) {
      ...
      while( true ) {
        ...
        *(int *)(uVar5 + lVar11) = (int)uVar7;
        ...
        if ((ulong)(uint)param_2 * 8 - lVar8 == 0) break;
        uVar5 = *(ulong *)this;
        lVar8 = lVar8 + 8;
      }
    }
