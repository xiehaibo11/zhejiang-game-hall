...
/* void std::__ndk1::vector<spine::SkeletonCache::FrameData*,
   std::__ndk1::allocator<spine::SkeletonCache::FrameData*>
   >::__push_back_slow_path<spine::SkeletonCache::FrameData*
   const&>(spine::SkeletonCache::FrameData* const&) */

void __thiscall
std::__ndk1::
vector<spine::SkeletonCache::FrameData*,std::__ndk1::allocator<spine::SkeletonCache::FrameData*>>::
__push_back_slow_path<spine::SkeletonCache::FrameData*const&>
          (vector<spine::SkeletonCache::FrameData*,std::__ndk1::allocator<spine::SkeletonCache::FrameData*>>
...
LAB_00d18be4:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d18be4;
  }
  else {
