...
void FUN_0097d34c(long *param_1,long *param_2)
  ...
  if (param_2 != param_1) {
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
        ...
        param_1[4] = 0;
                    /* try { // try from 0097d43c to 00a7d44b has its CatchHandler @ 0097d4cc */
        (**(code **)(*(long *)param_2[4] + 0x18))((long *)param_2[4],param_1);
                    /* try { // try from 0097d450 to 00a7d45b has its CatchHandler @ 0097d4c8 */
        (**(code **)(*(long *)param_2[4] + 0x20))();
        param_2[4] = 0;
        param_1[4] = (long)param_1;
                    /* try { // try from 0097d45c to 00a7d4fb has its CatchHandler @ 0097d3c0 */
        (**(code **)(local_60[0] + 0x18))(local_60,param_2);
        (**(code **)(local_60[0] + 0x20))(local_60);
      }
      else {
        (**(code **)(*plVar2 + 0x18))(plVar2,param_2);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 0097d45c with catch @ 0097d3c0
                       catch(type#1 @ 00000000) { ... } // from try @ 0097d508 with catch @ 0097d3c0
                        */
        (**(code **)(*(long *)param_1[4] + 0x20))();
        param_1[4] = param_2[4];
      }
