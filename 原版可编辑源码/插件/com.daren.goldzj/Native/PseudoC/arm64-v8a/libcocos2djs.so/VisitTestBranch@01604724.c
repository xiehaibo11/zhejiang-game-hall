...
/* v8::internal::DispatchingDecoderVisitor::VisitTestBranch(v8::internal::Instruction*) */

void __thiscall
v8::internal::DispatchingDecoderVisitor::VisitTestBranch
...

{
  ...
  for (pDVar1 = *(DispatchingDecoderVisitor **)(this + 0x10); this + 8 != pDVar1;
    ...
    (**(code **)(**(long **)(pDVar1 + 0x10) + 0x58))(*(long **)(pDVar1 + 0x10),param_1);
  }
  return;
}
