...
/* js_cocos2dx_spine_SkeletonCacheMgr_destroyInstanceRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonCacheMgr_destroyInstanceRegistry(FunctionCallbackInfo *param_1)

{
  ...
  *pMVar3;
  ...
  pMVar3 = spine::SkeletonCacheMgr::_instance;
  if (plVar6[1] - *plVar6 == 0) {
    if (spine::SkeletonCacheMgr::_instance !=
        (Map<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,spine::SkeletonCache*>
         *)0x0) {
      cocos2d::
      Map<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,spine::SkeletonCache*>
      ::clear(spine::SkeletonCacheMgr::_instance);
      ...
      *(undefined8 *)pMVar3 = 0;
      ...
      spine::SkeletonCacheMgr::_instance =
           (Map<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,spine::SkeletonCache*>
            *)0x0;
    }
  }
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 15298): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar6[1] - *plVar6) >> 4,0);
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_spine_SkeletonCacheMgr_destroyInstance",
