...
undefined1  [16]
FUN_010c306c(undefined8 param_1,undefined8 param_2,ulong *param_3,ulong *param_4,ulong param_5,
            ulong param_6)

{
  ...
  if (((*(uint *)((uVar4 & 0xffffffff00000000 | (ulong)*(uint *)(uVar4 + 0xb)) + 0x1b) >> 2 & 1) ==
    ...
    if ((*(short *)((local_28 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(local_28 - 1)) == 0x41)
       && (lVar3 = v8::internal::BigInt::AsInt64((BigInt *)&local_28,local_44), local_44[0] != false
          )) {
