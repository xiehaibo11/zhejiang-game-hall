...
/* v8::internal::compiler::JSGenericLowering::LowerJSCreateEmptyLiteralArray(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::JSGenericLowering::LowerJSCreateEmptyLiteralArray
...

{
  ...
  Node::InsertInput(param_1,pZVar6,0,pNVar3);
  ...
  Builtins::CallableFor((Builtins *)local_68,*(undefined8 *)(*(long *)(this + 0x10) + 0x168),0x24);
