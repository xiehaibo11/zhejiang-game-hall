...
/* v8::internal::interpreter::BytecodeArrayBuilder::JumpIfUndefined(v8::internal::interpreter::BytecodeLabel*)
    */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::JumpIfUndefined
