...
/* v8::internal::compiler::GraphAssembler::Word64And(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Word64And(GraphAssembler *this,Node *param_1,Node *param_2)
