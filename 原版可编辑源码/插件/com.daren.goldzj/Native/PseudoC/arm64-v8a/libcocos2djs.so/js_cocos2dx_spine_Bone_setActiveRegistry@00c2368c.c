...
/* js_cocos2dx_spine_Bone_setActiveRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_setActiveRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar4 == (long *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x9da,"js_cocos2dx_spine_Bone_setActive");
    pcVar7 = "js_cocos2dx_spine_Bone_setActive : Invalid Native Object";
LAB_00c23804:
    ...
    if (uVar8 == 0x10) {
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x9e1,"js_cocos2dx_spine_Bone_setActive");
      pcVar7 = "js_cocos2dx_spine_Bone_setActive : Error processing arguments";
      goto LAB_00c23804;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 2533): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar8 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_setActive",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x9e8);
LAB_00c2383c:
