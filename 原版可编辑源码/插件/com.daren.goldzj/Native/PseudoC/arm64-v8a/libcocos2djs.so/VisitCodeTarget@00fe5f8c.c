...
/* v8::internal::MarkingVisitorBase<v8::internal::MainMarkingVisitor<v8::internal::MajorMarkingState>,
   v8::internal::MajorMarkingState>::VisitCodeTarget(v8::internal::Code, v8::internal::RelocInfo*)
    */

void __thiscall
v8::internal::
MarkingVisitorBase<v8::internal::MainMarkingVisitor<v8::internal::MajorMarkingState>,v8::internal::MajorMarkingState>
::VisitCodeTarget(MarkingVisitorBase<v8::internal::MainMarkingVisitor<v8::internal::MajorMarkingState>,v8::internal::MajorMarkingState>
...
LAB_00fe6130:
      MarkCompactCollector::RecordRelocSlot(param_2,param_3,uVar12);
      return;
    }
    while (*puVar1 == uVar2) {
      cVar4 = '\x01';
      ...
      if (cVar4 == '\0') {
        ...
        if (FLAG_track_retaining_path == '\x01') {
          Heap::AddRetainer(*(Heap **)(this + 0x20),param_2,uVar12);
        }
        goto LAB_00fe6130;
      }
    }
