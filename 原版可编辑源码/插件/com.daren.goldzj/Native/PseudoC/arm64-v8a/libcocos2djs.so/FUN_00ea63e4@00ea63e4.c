...
void FUN_00ea63e4(long param_1)

{
  ...
  *(undefined4 *)(pIVar8 + 0x2c60) = 5;
  ...
  lVar9 = *plVar3;
  *piVar2 = *piVar2 + 1;
  plVar6 = (long *)FUN_00ed757c(pIVar8);
  *(uint *)(*plVar6 + 7) = *(uint *)(*plVar6 + 7) & 0xffffe3fe | in_w6 << 10;
  *(uint *)(*plVar6 + 7) = *(uint *)(*plVar6 + 7) & 0xffffff3e | in_stack_00000008 << 6;
  if (in_stack_00000010 != 1) {
    *(uint *)(*plVar6 + 7) = *(uint *)(*plVar6 + 7) & 0xfffffcfe | in_stack_00000010 << 8;
    v8::internal::ApiNatives::AddNativeDataProperty(pIVar8,param_1,plVar6);
    if (uVar4 != 0) {
      *puVar1 = uVar7;
      *piVar2 = *piVar2 + -1;
      if (*plVar3 != lVar9) {
        *plVar3 = lVar9;
        v8::internal::HandleScope::DeleteExtensions(pIVar8);
      }
    }
