...
/* v8::internal::compiler::InstructionSelector::VisitDeoptimizeIf(v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::InstructionSelector::VisitDeoptimizeIf
...
LAB_0163f928:
      ...
      local_90 = (undefined1 *)0x100000004;
      goto LAB_0163f95c;
    }
  }
  else if (iVar1 != 1) {
    ...
    if (puVar3[0x18] == '\0') goto LAB_0163f928;
  }
  pNVar4 = param_1 + 0x20;
  uVar5 = *(uint *)(param_1 + 0x14) & 0xf000000;
  if (uVar5 == 0xf000000) {
