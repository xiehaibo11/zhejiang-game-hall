...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::LocateSpillSlotsPhase>()
    */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::LocateSpillSlotsPhase>
          (PipelineImpl *this)

{
  ...
  lVar2 = ZoneStats::NewEmptyZone(this_01,"V8.TFLocateSpillSlots");
  SpillSlotLocator::SpillSlotLocator(aSStack_18,*(RegisterAllocationData **)(lVar5 + 0x170));
  SpillSlotLocator::LocateSpillSlots(aSStack_18);
