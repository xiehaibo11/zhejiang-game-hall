...
/* v8::internal::CallPrinter::VisitTryFinallyStatement(v8::internal::TryFinallyStatement*) */

void __thiscall
v8::internal::CallPrinter::VisitTryFinallyStatement(CallPrinter *this,TryFinallyStatement *param_1)
