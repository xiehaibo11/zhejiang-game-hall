...
/* js_cocos2dx_spine_Animation_getNameRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Animation_getNameRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Animation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x34,"js_cocos2dx_spine_Animation_getName");
    __android_log_print(6,"jswrapper",&DAT_018f0434);
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      lVar5 = spine::Animation::getName(this);
      pVVar6 = (Value *)se::State::rval(aSStack_60);
      se::Value::setString(pVVar6,*(char **)(lVar5 + 0x10));
      goto LAB_00c11ef8;
    }
    __android_log_print(6,"jswrapper",&DAT_018f0470,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Animation_getName",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x41);
LAB_00c11ef8:
  pVVar6 = (Value *)se::State::rval(aSStack_60);
