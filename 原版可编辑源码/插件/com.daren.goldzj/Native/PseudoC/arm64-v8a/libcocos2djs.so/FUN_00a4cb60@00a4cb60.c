...
undefined4 FUN_00a4cb60(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (*(char **)(param_1 + 0x58) == (char *)0x0) {
    pcVar6 = (char *)(*(code *)PTR_strdup_01d1b758)(*(undefined8 *)(param_1 + 0x18));
    puVar1 = PTR_strdup_01d1b758;
    if (pcVar6 == (char *)0x0) {
      return 0x1b;
    }
    basename(pcVar6);
  ...
  pcVar5 = (char *)0x0;
LAB_00a4cc8c:
  uVar2 = FUN_00a4c8cc(param_2,param_3,"; filename=\"%s\"",pcVar6);
