...

{
  ...
  if ((cVar1 != '\0') && ((*(byte *)(param_1 + 0x16c) >> 1 & 1) != 0)) {
    ...
    case 0:
      if ((*(byte *)(param_1 + 0x24c) & 7) != 0) goto LAB_00d7a2cc;
      break;
    case 1:
      ...
      break;
    case 2:
      if ((*(uint *)(param_1 + 0x24c) & 7) != 4) goto LAB_00d7a2cc;
      break;
    case 3:
      ...
      break;
    case 4:
      if ((*(uint *)(param_1 + 0x24c) & 3) != 2) goto LAB_00d7a2cc;
      break;
    case 5:
      ...
      break;
    case 6:
      if ((*(byte *)(param_1 + 0x24c) & 1) == 0) goto LAB_00d7a2cc;
    }
  }
  ...
  if ((((*(byte *)(param_1 + 0x450) >> 2 & 1) != 0) && (*(char *)(param_1 + 0x454) == '@')) &&
    ...
    if (local_27 == '\x10') {
      if (local_28 == 2) {
        ...
        if (local_28 != 6) goto LAB_00d7a38c;
        lVar7 = 8;
      }
      if (local_38[0] != 0) {
