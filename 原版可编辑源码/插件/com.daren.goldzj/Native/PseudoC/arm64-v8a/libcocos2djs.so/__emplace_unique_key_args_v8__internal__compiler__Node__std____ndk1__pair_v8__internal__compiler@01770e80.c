...
/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<v8::internal::compiler::Node*,
   ...
   std::__ndk1::pair<v8::internal::compiler::Node*, v8::internal::ZoneHandleSet<v8::internal::Map> >
   >(v8::internal::compiler::Node* const&, std::__ndk1::pair<v8::internal::compiler::Node*,
   v8::internal::ZoneHandleSet<v8::internal::Map> >&&) */
