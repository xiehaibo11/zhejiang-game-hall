...
int FUN_00db39b4(undefined8 *param_1,ulong param_2,long *param_3)
...
LAB_00db51fc:
    ...
    case 0x12:
      iVar4 = (int)param_3[3];
      if ((-1 < iVar4) || (*(int *)(param_3 + 3) = iVar4 + 8, 0 < iVar4 + 8)) goto LAB_00db51fc;
      puVar7 = (undefined8 *)(param_3[1] + (long)iVar4);
LAB_00db5208:
      local_58 = *puVar7;
    }
  ...
  case 0x102:
    ...
    *(short *)((long)param_1 + 0x74) = (short)uVar16;
    if (*(char *)(param_1 + 2) < '\0') {
      ...
      case 0x1e:
      case 0x1f:
        goto switchD_00db3c28_caseD_9;
      case 0x10:
switchD_00db3c28_caseD_10:
      ...
      case 0x18:
        ...
        break;
      case 0x20:
switchD_00db3c28_caseD_20:
        param_1[0x7d] = _TIFFSwab32BitData;
        break;
      default:
        if ((uVar16 != 0x40) && (uVar16 != 0x80)) goto switchD_00db3c28_caseD_9;
  ...
  case 0x10a:
    ...
    uVar2 = *puVar19;
    uVar14 = (ulong)uVar2;
    if (1 < uVar2 - 1) goto LAB_00db4b8c;
  ...
  case 0x112:
    ...
    uVar2 = *puVar19;
    uVar14 = (ulong)uVar2;
    if (7 < uVar2 - 1) goto LAB_00db4b8c;
...
LAB_00db4d98:
  ...
  case 0x128:
    ...
    uVar2 = *puVar19;
    uVar14 = (ulong)uVar2;
    if (2 < uVar2 - 1) goto LAB_00db4b8c;
  ...
  case 0x140:
    ...
    if (pcVar25 != (char *)0x0) {
      ...
      param_1[0x19] = pvVar9;
joined_r0x00db4920:
      if (pvVar9 != (void *)0x0) goto LAB_00db4eb0;
    }
    break;
  case 0x141:
    iVar4 = (int)param_3[3];
  ...
  case 0x142:
    ...
    uVar16 = *puVar21;
    if ((uVar16 & 0xf) != 0) {
      if (*(int *)((long)param_1 + 0xc) != 0) goto LAB_00db4d98;
...
LAB_00db4ce0:
    ...
    if (uVar13 != 0) {
      ...
      uVar16 = uVar13;
      do {
        if (pcVar15 + uVar14 <= pcVar23) goto LAB_00db4ce0;
        pcVar25 = pcVar23 + 1;
        cVar1 = *pcVar23;
        pcVar23 = pcVar25;
        ...
        if (uVar2 != 0) {
          ...
          do {
            if (2 < *(ushort *)(pcVar25 + uVar20 * 2)) {
              if (*(ushort *)(pcVar25 + uVar20 * 2) != 999) goto LAB_00db4b8c;
...
LAB_00db4dd8:
  ...
  case 0x153:
    ...
    uVar14 = (ulong)uVar2;
    uVar16 = (uint)uVar2;
    if (5 < uVar16 - 1) goto LAB_00db4b8c;
    *(ushort *)((long)param_1 + 0x76) = uVar2;
    if (((uVar16 == 5) && (*(short *)((long)param_1 + 0x74) == 0x20)) &&
       ((code *)param_1[0x7d] == _TIFFSwab32BitData)) goto switchD_00db3c28_caseD_10;
    if (((uVar16 - 5 < 2) && (*(short *)((long)param_1 + 0x74) == 0x40)) &&
       ((code *)param_1[0x7d] == _TIFFSwab64BitData)) goto switchD_00db3c28_caseD_20;
    break;
  case 0x154:
    if ((*(byte *)((long)param_1 + 0x12) >> 6 & 1) == 0) {
      ...
      iVar4 = 1;
      param_1[0x12] = pvVar9;
      if ((uVar2 == 0) || (pvVar9 == (void *)0x0)) goto switchD_00db3c28_caseD_9;
      if (3 < uVar2) {
        uVar20 = uVar14 & 3;
  ...
  default:
    ...
    case 0x80e3:
      ...
      *(ushort *)((long)param_1 + 0xd4) = (ushort)(sVar3 != 0);
      if (sVar3 == 0) goto switchD_00db3c28_caseD_9;
    ...
    case 0x80e6:
      ...
      if (iVar4 == 0) goto LAB_00db4d94;
      *(int *)((long)param_1 + 0x6c) = iVar4;
      break;
    default:
      if (uVar16 != 0x1001b) goto switchD_00db3a10_caseD_ff;
      iVar4 = (int)param_3[3];
      if ((iVar4 < 0) && (*(int *)(param_3 + 3) = iVar4 + 8, iVar4 + 8 < 1)) {
        psVar17 = (short *)(param_3[1] + (long)iVar4);
      }
