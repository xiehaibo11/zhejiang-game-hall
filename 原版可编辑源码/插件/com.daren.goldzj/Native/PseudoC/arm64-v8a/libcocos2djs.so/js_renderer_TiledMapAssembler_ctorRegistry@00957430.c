...
/* js_renderer_TiledMapAssembler_ctorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_TiledMapAssembler_ctorRegistry(FunctionCallbackInfo *param_1)
