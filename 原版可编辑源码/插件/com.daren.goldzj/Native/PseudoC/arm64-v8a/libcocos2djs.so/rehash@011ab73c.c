...
/* std::__ndk1::__hash_table<v8::internal::JSGlobalObject, v8::internal::Object::Hasher,
   std::__ndk1::equal_to<v8::internal::JSGlobalObject>,
   std::__ndk1::allocator<v8::internal::JSGlobalObject> >::rehash(unsigned long) */
...
::rehash(__hash_table<v8::internal::JSGlobalObject,v8::internal::Object::Hasher,std::__ndk1::equal_to<v8::internal::JSGlobalObject>,std::__ndk1::allocator<v8::internal::JSGlobalObject>>
         *this,ulong param_1)

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      if (uVar1 < uVar2) goto LAB_011ab800;
    }
    return;
  }
LAB_011ab800:
