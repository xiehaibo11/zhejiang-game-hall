...
void FUN_00a1b51c(long param_1,undefined4 param_2)

{
  ...
  case 2:
    ...
    *(ulong *)(param_1 + 0x9e0) = CONCAT44(extraout_var,extraout_w1);
    break;
  case 3:
    uVar1 = FUN_00a18ed0(uVar1,extraout_w1,*(undefined8 *)(param_1 + 0x9d8),
  ...
  case 9:
    ...
    *(ulong *)(param_1 + 0xa00) = CONCAT44(extraout_var_00,extraout_w1_00);
    break;
  case 10:
    uVar1 = FUN_00a18ed0(uVar1,extraout_w1,*(undefined8 *)(param_1 + 0x9c8),
