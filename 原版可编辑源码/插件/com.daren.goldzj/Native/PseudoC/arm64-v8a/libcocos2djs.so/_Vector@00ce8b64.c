...
/* spine::Vector<spine::Vector<int> >::~Vector() */

void __thiscall spine::Vector<spine::Vector<int>>::~Vector(Vector<spine::Vector<int>> *this)

{
  ...
  uVar2 = *(ulong *)(this + 8);
  *(undefined ***)this = &PTR__Vector_01c8ed00;
  if (uVar2 != 0) {
    uVar3 = 0;
    lVar4 = -1;
    do {
