...
/* v8::internal::WasmStackFrame::GetWasmModuleName() */

long __thiscall v8::internal::WasmStackFrame::GetWasmModuleName(WasmStackFrame *this)

{
  ...
  lVar3 = WasmModuleObject::GetModuleNameOrNull(*(undefined8 *)(this + 8),puVar2);
  if (lVar3 == 0) {
