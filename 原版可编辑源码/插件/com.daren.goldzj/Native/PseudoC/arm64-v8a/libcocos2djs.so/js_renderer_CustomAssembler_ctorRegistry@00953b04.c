...
/* js_renderer_CustomAssembler_ctorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_CustomAssembler_ctorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  __jsbInvocationCount = __jsbInvocationCount + 1;
                    /* catch() { ... } // from try @ 00953804 with catch @ 00953b40 */
  ...
  this_00 = operator_new(0x70,(nothrow_t *)&std::nothrow);
                    /* catch() { ... } // from try @ 009534e4 with catch @ 00953bb8 */
  ...
  if (local_a0 != (Value *)0x0) {
    while (pVVar2 != pVVar3) {
                    /* catch() { ... } // from try @ 009534d4 with catch @ 00953c30 */
