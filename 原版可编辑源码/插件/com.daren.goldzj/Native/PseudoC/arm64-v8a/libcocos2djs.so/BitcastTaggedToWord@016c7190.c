...
/* v8::internal::compiler::GraphAssembler::BitcastTaggedToWord(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::BitcastTaggedToWord(GraphAssembler *this,Node *param_1)

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::BitcastTaggedToWord
