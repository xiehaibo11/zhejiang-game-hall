...
/* v8::internal::compiler::JSCallReducer::ReduceNumberIsFinite(v8::internal::compiler::Node*) */

undefined8 __thiscall
v8::internal::compiler::JSCallReducer::ReduceNumberIsFinite(JSCallReducer *this,Node *param_1)

{
  ...
  if (*(int *)(*(long *)param_1 + 0x14) < 3) {
    ...
    pOVar3 = (Operator *)
             SimplifiedOperatorBuilder::ObjectIsFiniteNumber
