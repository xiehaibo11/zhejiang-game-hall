...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, std::__ndk1::list<int,
   std::__ndk1::allocator<int> > > > >::find<std::__ndk1::basic_string<char,
...

{
  ...
  lVar5 = tpidr_el0;
                    /* try { // try from 00a6fa9c to 00b6fad7 has its CatchHandler @ 00a6fbb4 */
  ...
  if (uVar13 != 0) {
    uVar14 = uVar13 - 1;
                    /* try { // try from 00a6fad8 to 00b6fb53 has its CatchHandler @ 00a6f81c */
    if ((uVar14 & uVar13) == 0) {
      uVar15 = uVar14 & uVar7;
    }
    else {
          ...
          if (uVar9 == uVar7) {
            ...
            if ((bVar3 & 1) != 0) {
              sVar1 = plVar8[3];
                    ...
                    /* try { // try from 00a6fb54 to 00b6fb5b has its CatchHandler @ 00a6fb80 */
            if (sVar1 == __n) {
                    /* catch() { ... } // from try @ 00a6f9f8 with catch @ 00a6fb5c
                       try { // try from 00a6fb5c to 00b6fc0b has its CatchHandler @ 00a6f81c */
              __s1 = (void *)plVar8[4];
              if ((bVar3 & 1) == 0) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                pbVar12 = pbVar2;
                    /* catch() { ... } // from try @ 00a6f8f0 with catch @ 00a6fb7c */
                    /* catch() { ... } // from try @ 00a6f9cc with catch @ 00a6fb80
                       catch() { ... } // from try @ 00a6fa18 with catch @ 00a6fb80
                       catch() { ... } // from try @ 00a6fb54 with catch @ 00a6fb80 */
                    /* catch() { ... } // from try @ 00a6f8d8 with catch @ 00a6fb84
                       catch() { ... } // from try @ 00a6f94c with catch @ 00a6fb84 */
                while (*pbVar10 == *pbVar12) {
                  pbVar10 = pbVar10 + 1;
                  lVar11 = lVar11 + 1;
                  pbVar12 = pbVar12 + 1;
                  if (lVar11 == 0) goto LAB_00a6fbf4;
                }
              }
                    ...
                    /* catch() { ... } // from try @ 00a6f898 with catch @ 00a6fba0 */
            if ((uVar14 & uVar13) == 0) {
              uVar9 = uVar9 & uVar14;
            }
            else {
                    /* catch() { ... } // from try @ 00a6f878 with catch @ 00a6fba4 */
              if (uVar13 <= uVar9) {
                uVar4 = 0;
                if (uVar13 != 0) {
                  uVar4 = uVar9 / uVar13;
                }
                    /* catch() { ... } // from try @ 00a6f8b0 with catch @ 00a6fbb4
                       catch() { ... } // from try @ 00a6f92c with catch @ 00a6fbb4
                       catch() { ... } // from try @ 00a6fa9c with catch @ 00a6fbb4 */
                if (uVar9 - uVar4 * uVar13 == uVar15) goto LAB_00a6fbcc;
                goto LAB_00a6fbf0;
              }
            }
            if (uVar9 != uVar15) goto LAB_00a6fbf0;
          }
LAB_00a6fbcc:
          plVar8 = (long *)*plVar8;
...
LAB_00a6fbf4:
  if (*(long *)(lVar5 + 0x28) == local_68) {
                    /* try { // try from 00a6fc0c to 00b6fc5f has its CatchHandler @ 00a6fc0c
                       catch() { ... } // from try @ 00a6fc0c with catch @ 00a6fc0c
                       catch() { ... } // from try @ 00a6fd70 with catch @ 00a6fc0c */
    return plVar8;
  }
