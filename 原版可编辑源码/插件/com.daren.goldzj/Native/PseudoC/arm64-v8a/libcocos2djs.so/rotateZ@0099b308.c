...

{
  ...
  sincosf(param_1,&fStack_74,&local_78);
                    /* try { // try from 0099b350 to 00a9b367 has its CatchHandler @ 0099b580 */
  _local_60 = CONCAT44(local_78,-fStack_74);
  MathUtil::multiplyMatrix((float *)this,local_70,(float *)this);
                    /* try { // try from 0099b370 to 00a9b37b has its CatchHandler @ 0099b57c */
  if (*(long *)(lVar1 + 0x28) == local_28) {
                    /* try { // try from 0099b37c to 00a9b387 has its CatchHandler @ 0099b578 */
                    /* try { // try from 0099b388 to 00a9b42b has its CatchHandler @ 0099b590 */
    return;
  }
