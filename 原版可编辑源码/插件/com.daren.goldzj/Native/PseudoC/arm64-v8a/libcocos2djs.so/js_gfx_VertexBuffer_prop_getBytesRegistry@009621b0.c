...
/* js_gfx_VertexBuffer_prop_getBytesRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_gfx_VertexBuffer_prop_getBytesRegistry(undefined8 param_1,PropertyCallbackInfo *param_2)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1c6,"js_gfx_VertexBuffer_prop_getBytes");
    __android_log_print(6,"jswrapper","js_gfx_VertexBuffer_prop_getBytes : Invalid Native Object");
  }
  else {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp, 464): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar5[1] - *plVar5) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_gfx_VertexBuffer_prop_getBytes",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp"
                      ,0x1d3);
LAB_009622e8:
  pVVar6 = (Value *)se::State::rval(aSStack_60);
