...
void FUN_01435044(long param_1,undefined8 param_2,undefined8 param_3,long param_4,ulong param_5,
...
LAB_01435140:
    ...
    if (sVar3 != 0x43) goto LAB_01435140;
    if ((param_5 & 1) == 0) {
      uVar5 = 0x1e;
    }
    else {
      ...
      if ((int)lVar4 == (int)*(undefined8 *)(unaff_x26 + 0x140)) {
        ...
        if (*(short *)(lVar4 + 7) != 0x43) goto LAB_01435140;
        uVar5 = 0x1e;
      }
    }
  }
  ...
  if ((int)param_6 != iVar7) {
    ...
    if (uVar6 != uVar5) {
      ...
      *(undefined4 *)(param_6 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x01434f48. Too many branches */
