...
void FUN_01446dc8(long param_1,undefined8 param_2,undefined8 param_3,long param_4,undefined8 param_5
        ...
        while( true ) {
          ...
          if (iVar2 == (int)param_4) {
            if ((ulong)((long)((ulong)*(uint *)(uVar14 + 3) << 0x20) >> 0x21) <= lVar1 + 6U) {
              ...
              pcVar9 = (code *)SoftwareBreakpoint(0,0x1447a44);
              (*pcVar9)();
            }
            uVar11 = unaff_x26 + (ulong)*(uint *)(uVar14 + lVar17 + 0xb);
            if ((*(int *)(uVar14 + lVar17 + 0xf) >> 1 & 1U) == 0) goto LAB_01446eb8;
      ...
      if (uVar15 == 6) {
        ...
        *(int *)(param_6 + -0x20) = (iVar8 + -1) * 2;
        ...
        if ((int)(unaff_x26 + (ulong)uVar3) == 3) {
                    /* WARNING: Does not return */
          pcVar9 = (code *)SoftwareBreakpoint(0,0x144786c);
          (*pcVar9)();
        }
        ...
        *(int *)(param_6 + -0x20) = (iVar8 + -1) * 2;
        ...
        if ((int)uVar11 == (int)*(undefined8 *)(unaff_x26 + 0xa8)) goto LAB_01447db8;
        ...
        if (uVar15 == 0xc) {
          *(int *)(param_6 + -0x20) = (iVar8 + -1) * 2;
          ...
          if ((ulong)((long)((ulong)*(uint *)(lVar16 + 3) << 0x20) >> 0x21) <= uVar14) {
                    /* WARNING: Does not return */
            pcVar9 = (code *)SoftwareBreakpoint(0,0x14474c0);
            (*pcVar9)();
          }
          uVar11 = unaff_x26 +
...
LAB_01446eb8:
  ...
  (**(code **)(unaff_x21 + (ulong)*(byte *)(*(long *)(lVar13 + -0x18) + unaff_x19 + 7) * 8))(uVar11)
  ;
  return;
}
