...
/* v8::internal::interpreter::BytecodeArrayBuilder::StoreAccumulatorInRegister(v8::internal::interpreter::Register)
    */
...

{
  ...
  if (this_00 == (BytecodeRegisterOptimizer *)0x0) {
    ...
    BytecodeRegisterOptimizer::RegisterTransfer
              (this_00,*(RegisterInfo **)(this_00 + 0x10),
               *(RegisterInfo **)
