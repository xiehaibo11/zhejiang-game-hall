...
/* void JSBClassType::registerClass<spine::SkeletonRenderer>(se::Class*) */

void JSBClassType::registerClass<spine::SkeletonRenderer>(Class *param_1)
