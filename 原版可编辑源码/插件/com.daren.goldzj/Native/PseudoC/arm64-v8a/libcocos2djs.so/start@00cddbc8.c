...
/* spine::EventQueue::start(spine::TrackEntry*) */

void __thiscall spine::EventQueue::start(EventQueue *this,TrackEntry *param_1)

{
  ...
  *(undefined1 *)(*(long *)(this + 0x28) + 0xb0) = 1;
