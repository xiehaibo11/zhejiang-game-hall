...
/* js_gfx_DeviceGraphics_setStencilFuncBackRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_gfx_DeviceGraphics_setStencilFuncBackRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (pDVar8 == (DeviceGraphics *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3bc,"js_gfx_DeviceGraphics_setStencilFuncBack");
    __android_log_print(6,"jswrapper",
                        "js_gfx_DeviceGraphics_setStencilFuncBack : Invalid Native Object");
  }
  else {
    ...
    if (uVar11 == 0x30) {
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                          ,0x3c7,"js_gfx_DeviceGraphics_setStencilFuncBack");
      __android_log_print(6,"jswrapper",
                          "js_gfx_DeviceGraphics_setStencilFuncBack : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp, 971): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar11 >> 4,3);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_gfx_DeviceGraphics_setStencilFuncBack",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                      ,0x3ce);
LAB_0092fc40:
