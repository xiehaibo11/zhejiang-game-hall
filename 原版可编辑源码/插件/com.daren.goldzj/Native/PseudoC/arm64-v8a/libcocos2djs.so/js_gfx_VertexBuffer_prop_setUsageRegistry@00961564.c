...
/* js_gfx_VertexBuffer_prop_setUsageRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_gfx_VertexBuffer_prop_setUsageRegistry(undefined8 param_1,undefined8 param_2,long *param_3)

{
  ...
  if (lVar5 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x166,"js_gfx_VertexBuffer_prop_setUsage");
    __android_log_print(6,"jswrapper","js_gfx_VertexBuffer_prop_setUsage : Invalid Native Object");
  }
  else {
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        *(ushort *)(lVar5 + 0x20) = local_74[0];
        goto LAB_00961758;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp"
                          ,0x16d,"js_gfx_VertexBuffer_prop_setUsage");
      __android_log_print(6,"jswrapper","Convert arg0 offset failed!");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp, 370): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar7 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_gfx_VertexBuffer_prop_setUsage",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_gfx_manual.cpp"
                      ,0x175);
LAB_00961758:
