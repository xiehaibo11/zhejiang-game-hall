...
/* v8::ArrayBuffer::New(v8::Isolate*, void*, unsigned long, v8::ArrayBufferCreationMode) */

long * v8::ArrayBuffer::New(Factory *param_1,long param_2,ulong param_3,int param_4)

{
  ...
  if ((param_2 == 0) && (param_3 != 0)) {
    ...
    V8_Fatal("Check failed: %s.","byte_length != 0 implies data != nullptr");
  }
  if (param_3 >> 0x35 == 0) {
    local_50 = 0;
    uStack_68 = 0;
    ...
    if ((uVar6 & 1) != 0) {
      internal::Logger::ApiEntryCall(this_00,"v8::ArrayBuffer::New");
    }
    uVar3 = *(undefined4 *)(param_1 + 0x2c60);
    *(undefined4 *)(param_1 + 0x2c60) = 5;
    FUN_00ec9578(&local_80,param_1,param_2,param_3,0,param_4);
    p_Stack_88 = p_Stack_78;
    local_90 = local_80;
    local_80 = 0;
    p_Stack_78 = (__shared_weak_count *)0x0;
    plVar7 = (long *)internal::Factory::NewJSArrayBuffer(param_1,&local_90,0);
    p_Var2 = p_Stack_88;
    this = p_Stack_78;
