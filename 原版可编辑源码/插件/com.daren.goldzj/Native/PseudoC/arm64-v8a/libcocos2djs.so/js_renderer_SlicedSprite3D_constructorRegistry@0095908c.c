...
/* js_renderer_SlicedSprite3D_constructorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_SlicedSprite3D_constructorRegistry(FunctionCallbackInfo *param_1)
