...
void FUN_0144d220(undefined8 param_1)

{
  ...
  sVar2 = *(short *)(unaff_x20 + unaff_x19 + 1);
  lVar4 = unaff_x26 +
  ...
  if ((int)lVar4 != (int)*(undefined8 *)(unaff_x26 + 0xa0)) {
    ...
    uVar3 = uVar5 | 0xfe;
    if (uVar5 != uVar3) {
      *(uint *)(lVar4 + lVar1) = uVar3;
      *(undefined4 *)(lVar4 + 0x17) = 0;
    }
  }
  *(int *)(unaff_x29 + -0x20) = ((int)unaff_x19 + -1) * 2;
  FUN_01392a60(sVar2 * 2,param_1);
                    /* WARNING: Could not recover jumptable at 0x0144d300. Too many branches */
