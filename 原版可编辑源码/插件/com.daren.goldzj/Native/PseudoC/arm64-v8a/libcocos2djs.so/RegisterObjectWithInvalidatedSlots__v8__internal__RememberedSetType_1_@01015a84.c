...
/* void 
   v8::internal::MemoryChunk::RegisterObjectWithInvalidatedSlots<(v8::internal::RememberedSetType)1>(v8::internal::HeapObject)
    */

void __thiscall
v8::internal::MemoryChunk::RegisterObjectWithInvalidatedSlots<(v8::internal::RememberedSetType)1>
...

{
  ...
  if ((((uint)*(ulong *)(this + 8) >> 0xf & 1) != 0) || ((*(ulong *)(this + 8) & 0x58) == 0)) {
