...

{
  ...
  if (plVar7 != param_2 + 2) {
    ...
    if (uVar3 == 0) {
      uVar6 = uVar6 & uVar8;
                    /* try { // try from 00a0551c to 00b055b7 has its CatchHandler @ 00a0551c
                       catch() { ... } // from try @ 00a0551c with catch @ 00a0551c
                       catch() { ... } // from try @ 00a055c0 with catch @ 00a0551c */
    }
    else if (uVar2 <= uVar6) {
      uVar4 = 0;
      if (uVar2 != 0) {
    ...
    if (uVar6 == uVar1) goto LAB_00a05538;
  }
  if (*param_3 != 0) {
