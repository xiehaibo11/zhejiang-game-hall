...
/* v8::internal::VariableDeclarationParsingScope<v8::internal::ParserTypes<v8::internal::PreParser>
   >::Declare(v8::internal::AstRawString const*, int) */

Variable * __thiscall
v8::internal::VariableDeclarationParsingScope<v8::internal::ParserTypes<v8::internal::PreParser>>::
Declare(VariableDeclarationParsingScope<v8::internal::ParserTypes<v8::internal::PreParser>> *this,
...

{
  ...
  this_00 = (Variable *)
            PreParser::DeclareVariableName
                      (*(PreParser **)this,param_1,this[0x13],*(undefined8 *)*(PreParser **)this,
                       local_34,param_2,0);
  if (local_34[0] != '\0') {
    if (0x7fffff < *(int *)(*(long *)*(ParserBase<v8::internal::PreParser> **)this + 0x2c)) {
      ParserBase<v8::internal::PreParser>::ReportMessage
                (*(ParserBase<v8::internal::PreParser> **)this,0x136);
    }
  }
  ...
  lVar8 = *(long *)this;
  if (this[0x10] ==
      (VariableDeclarationParsingScope<v8::internal::ParserTypes<v8::internal::PreParser>>)0x5) {
    if (*(AstRawString **)(*(long *)(*(long *)(lVar8 + 0x28) + 0x38) + 0x148) == param_1) {
      ...
      PendingCompilationErrorHandler::ReportMessageAt
                (*(PendingCompilationErrorHandler **)(lVar8 + 0x80),param_2,iVar2 + param_2,0xd0,0);
