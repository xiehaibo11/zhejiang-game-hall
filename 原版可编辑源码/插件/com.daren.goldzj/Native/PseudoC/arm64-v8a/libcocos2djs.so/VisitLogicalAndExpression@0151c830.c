...
/* v8::internal::interpreter::BytecodeGenerator::VisitLogicalAndExpression(v8::internal::BinaryOperation*)
    */

void __thiscall
v8::internal::interpreter::BytecodeGenerator::VisitLogicalAndExpression
...

{
  ...
  if (*(int *)(lVar11 + 0x18) != 3) {
    ...
    uVar7 = VisitLogicalAndSubExpression(this,this_00,(BytecodeLabels *)&local_b0,iVar6);
    if ((uVar7 & 1) == 0) {
  ...
  if ((uVar7 & 1) == 0) {
    ...
    if (((uVar7 & 1) != 0) && (uVar7 = Expression::ToBooleanIsTrue(this_01), (uVar7 & 1) != 0)) {
    ...
    VisitLogicalTestSubExpression(this,0x21,this_00,uVar2,uVar3,iVar6);
