...
undefined8
FUN_010b727c(undefined8 param_1,Isolate *param_2,ulong *param_3,ulong *param_4,uint param_5,
...

{
  ...
  if ((param_7 >> 2 & 1) == 0) {
    ...
    if (((*(uint *)((uVar9 & 0xffffffff00000000 | (ulong)*(uint *)(uVar9 + 0xb)) + 0x1b) >> 2 & 1)
      ...
      uVar10 = 0;
      while( true ) {
        puVar2 = (ulong *)v8::internal::Factory::NewNumberFromUint
                                    ((Factory *)(uVar9 & 0xffffffff00000000),
                                     *(uint *)(*(long *)(uVar9 + 0x27) +
