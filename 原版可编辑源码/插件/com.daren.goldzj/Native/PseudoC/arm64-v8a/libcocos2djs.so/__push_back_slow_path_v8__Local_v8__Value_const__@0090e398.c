...
/* void std::__ndk1::vector<v8::Local<v8::Value>, std::__ndk1::allocator<v8::Local<v8::Value> >
   >::__push_back_slow_path<v8::Local<v8::Value> const&>(v8::Local<v8::Value> const&) */

void __thiscall
std::__ndk1::vector<v8::Local<v8::Value>,std::__ndk1::allocator<v8::Local<v8::Value>>>::
__push_back_slow_path<v8::Local<v8::Value>const&>
          (vector<v8::Local<v8::Value>,std::__ndk1::allocator<v8::Local<v8::Value>>> *this,
          Local *param_1)
