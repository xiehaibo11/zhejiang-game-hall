...
LAB_0181d904:
  ...
  if (param_2 < param_3) {
    ...
    do {
      wVar1 = *param_2;
      pbVar5 = pbVar4;
      if (((ushort)wVar1 >> 0xb == 0x1b) || (uVar6 < (ushort)wVar1)) goto LAB_0181d908;
      bVar2 = (byte)wVar1;
      if ((ushort)wVar1 < 0x80) {
        if ((long)param_6 - (long)pbVar4 < 1) goto LAB_0181d904;
        pbVar5 = pbVar4 + 1;
        *pbVar4 = bVar2;
      }
      else if ((ushort)wVar1 < 0x800) {
        if ((long)param_6 - (long)pbVar4 < 2) goto LAB_0181d904;
        *pbVar4 = (byte)((ushort)wVar1 >> 6) | 0xc0;
        pbVar5 = pbVar4 + 2;
        pbVar4[1] = bVar2 & 0x3f | 0x80;
      }
      else {
        if ((long)param_6 - (long)pbVar4 < 3) goto LAB_0181d904;
        pbVar5 = pbVar4 + 3;
