  ...
  if (iVar2 == 0xb) {
    ...
    if (len < 1) {
      ...
      do {
        ...
        if (extraout_w0 == 0) goto LAB_00b3fc9c;
        if (local_64 == 0) {
          iVar5 = 0;
        }
        else {
          iVar5 = BIO_write(bp,out,local_64);
          if (iVar5 != local_64) goto LAB_00b3fc9c;
        }
        len = len - inl;
        iVar3 = iVar5 + iVar3;
        iVar4 = iVar4 + inl;
