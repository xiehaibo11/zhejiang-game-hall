...
/* v8::internal::Handle<v8::internal::WeakFixedArray>
   v8::internal::Factory::CopyArrayAndGrow<v8::internal::WeakFixedArray>(v8::internal::Handle<v8::internal::WeakFixedArray>,
   int, v8::internal::AllocationType) */

ulong * __thiscall
v8::internal::Factory::CopyArrayAndGrow<v8::internal::WeakFixedArray>
