...
/* void JSBClassType::registerClass<dragonBones::PolygonBoundingBoxData>(se::Class*) */

void JSBClassType::registerClass<dragonBones::PolygonBoundingBoxData>(Class *param_1)
