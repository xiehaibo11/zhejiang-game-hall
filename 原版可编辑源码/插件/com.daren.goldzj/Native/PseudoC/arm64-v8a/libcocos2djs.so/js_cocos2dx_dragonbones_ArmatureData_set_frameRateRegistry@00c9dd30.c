...
/* js_cocos2dx_dragonbones_ArmatureData_set_frameRateRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_ArmatureData_set_frameRateRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x559,"js_cocos2dx_dragonbones_ArmatureData_set_frameRate");
    pcVar8 = "js_cocos2dx_dragonbones_ArmatureData_set_frameRate : Invalid Native Object";
  }
  else {
    local_74 = 0;
    uVar7 = seval_to_uint32((Value *)*puVar5,&local_74);
    if ((uVar7 & 1) != 0) {
      *(uint *)(lVar6 + 0x14) = local_74;
      goto LAB_00c9decc;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x55e,"js_cocos2dx_dragonbones_ArmatureData_set_frameRate");
    pcVar8 = "js_cocos2dx_dragonbones_ArmatureData_set_frameRate : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar8);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_ArmatureData_set_frameRate",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x562);
LAB_00c9decc:
