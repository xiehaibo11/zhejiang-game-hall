...
/* v8::internal::compiler::OperationTyper::SpeculativeNumberModulus(v8::internal::compiler::Type,
   v8::internal::compiler::Type) */

void __thiscall
v8::internal::compiler::OperationTyper::SpeculativeNumberModulus
...

{
  ...
  NumberModulus(this,uVar1,uVar2);
  return;
}
