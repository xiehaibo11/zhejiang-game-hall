...
/* int 
   ...
   v8::internal::MajorMarkingState>::VisitEmbedderTracingSubclass<v8::internal::JSTypedArray>(v8::internal::Map,
...

{
  ...
  puVar1 = (uint *)(*(long *)(uVar12 + 0x10) + (~uVar12 + param_3 >> 7 & 0x1ffffff) * 4);
...
LAB_00fe7cb0:
      ...
      do {
        if ((*puVar13 & 1) != 0) {
          ProcessStrongHeapObject<v8::internal::CompressedHeapObjectSlot>
                    (this,param_3,puVar13,(ulong)puVar13 & 0xffffffff00000000 | (ulong)*puVar13);
        }
        puVar13 = puVar13 + 1;
    ...
    puVar1 = (uint *)(param_3 + 0x2f);
    if (puVar1 < (uint *)0xfffffffffffffffc) {
      uVar4 = *puVar1;
      while( true ) {
        if ((uVar4 & 1) != 0) {
          ProcessStrongHeapObject<v8::internal::CompressedHeapObjectSlot>
                    (this,param_3,puVar1,(ulong)puVar1 & 0xffffffff00000000 | (ulong)uVar4);
        }
        puVar1 = puVar1 + 1;
        if ((uint *)(param_3 + 0x33) <= puVar1) break;
        uVar4 = *puVar1;
      }
    }
    BodyDescriptorBase::
    IterateJSObjectBodyImpl<v8::internal::MainMarkingVisitor<v8::internal::MajorMarkingState>>
              (param_2,param_3,0x34,(ulong)bVar3 << 2,this);
    if (bVar3 != 0) {
      if (this[0x34] ==
          (MarkingVisitorBase<v8::internal::MainMarkingVisitor<v8::internal::MajorMarkingState>,v8::internal::MajorMarkingState>
           )0x0) {
