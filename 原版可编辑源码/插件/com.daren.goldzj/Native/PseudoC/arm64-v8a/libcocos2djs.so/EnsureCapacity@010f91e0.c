...
/* v8::internal::HashTable<v8::internal::ObjectHashSet,
   v8::internal::ObjectHashSetShape>::EnsureCapacity(v8::internal::Isolate*,
   v8::internal::Handle<v8::internal::ObjectHashSet>, int, v8::internal::AllocationType) */
...

{
  ...
  if (((iVar2 - param_3 == 0 || iVar2 < param_3) ||
    ...
    *(int *)(*puVar3 + 0xf) = iVar2 << 1;
    local_38 = *param_2;
    Rehash((HashTable<v8::internal::ObjectHashSet,v8::internal::ObjectHashSetShape> *)&local_38,
           param_1 + 0x80,*puVar3);
  }
  return puVar3;
}
