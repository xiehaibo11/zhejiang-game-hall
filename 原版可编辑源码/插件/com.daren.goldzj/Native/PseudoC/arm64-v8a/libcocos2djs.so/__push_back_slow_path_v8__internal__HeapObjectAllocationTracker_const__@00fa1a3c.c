...
/* void std::__ndk1::vector<v8::internal::HeapObjectAllocationTracker*,
   std::__ndk1::allocator<v8::internal::HeapObjectAllocationTracker*>
   >::__push_back_slow_path<v8::internal::HeapObjectAllocationTracker*
   const&>(v8::internal::HeapObjectAllocationTracker* const&) */
...
::__push_back_slow_path<v8::internal::HeapObjectAllocationTracker*const&>
          (vector<v8::internal::HeapObjectAllocationTracker*,std::__ndk1::allocator<v8::internal::HeapObjectAllocationTracker*>>
           *this,HeapObjectAllocationTracker **param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00fa1b24;
