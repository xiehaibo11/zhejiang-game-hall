...
undefined8 CRYPTO_ocb128_decrypt(undefined8 *param_1,long param_2,long param_3,ulong param_4)

{
  ...
  if ((uVar12 == 0) || (param_1[4] == 0)) {
    while (uVar7 = uVar7 + 1, uVar7 <= uVar1) {
      ...
      puVar3 = (ulong *)FUN_00b360b8(param_1,iVar6);
      if (puVar3 == (ulong *)0x0) {
        return 0;
      }
      uVar8 = *puVar3;
      ...
      (*(code *)param_1[1])(&local_60,&local_70,param_1[3]);
      uVar12 = param_1[0x14];
      lVar5 = param_3 + (uVar7 - param_1[0xd]) * 0x10;
      *(ulong *)(lVar5 + -0x10) = local_70 ^ uVar12;
      *(ulong *)(lVar5 + -8) = uStack_68 ^ param_1[0x15];
      param_1[0x16] = local_70 ^ uVar12 ^ param_1[0x16];
    ...
    lVar5 = FUN_00b360b8(param_1,lVar5);
    if (lVar5 == 0) {
      return 0;
    }
    (*(code *)param_1[4])
              (param_2,param_3,uVar12,param_1[3],param_1[0xd] + 1,param_1 + 0x14,param_1[0xb],
               param_1 + 0x16);
  }
  if ((param_4 & 0xf) != 0) {
    uVar12 = param_4 & 0xf;
    ...
    *puVar4 = CONCAT17((byte)((ulong)uVar16 >> 0x38) ^ (byte)((ulong)uVar14 >> 0x38),
    ...
    __src = (byte *)(param_3 + (param_4 & 0xfffffffffffffff0));
    pbVar9 = (byte *)(param_2 + (param_4 & 0xfffffffffffffff0));
    pbVar10 = __src;
    uVar7 = uVar12;
    pbVar13 = abStack_80;
    do {
      uVar7 = uVar7 - 1;
      *pbVar10 = *pbVar13 ^ *pbVar9;
      pbVar9 = pbVar9 + 1;
      pbVar10 = pbVar10 + 1;
      pbVar13 = pbVar13 + 1;
    } while (uVar7 != 0);
