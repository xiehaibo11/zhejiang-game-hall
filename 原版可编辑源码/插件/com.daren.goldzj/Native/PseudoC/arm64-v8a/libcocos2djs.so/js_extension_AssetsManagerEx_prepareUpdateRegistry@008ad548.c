...
/* js_extension_AssetsManagerEx_prepareUpdateRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_extension_AssetsManagerEx_prepareUpdateRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x40e,"js_extension_AssetsManagerEx_prepareUpdate");
    __android_log_print(6,"jswrapper",
                        "js_extension_AssetsManagerEx_prepareUpdate : Invalid Native Object");
  }
  else {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_extension_auto.cpp, 1045): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar5[1] - *plVar5) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_extension_AssetsManagerEx_prepareUpdate",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_extension_auto.cpp"
                      ,0x418);
LAB_008ad698:
