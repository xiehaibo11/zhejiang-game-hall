...
/* JSB_glDeleteBufferRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glDeleteBufferRegistry(FunctionCallbackInfo *param_1)
...
LAB_008cc0a8:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            ...
                            ,0xc59,"JSB_glDeleteBuffer");
        __android_log_print(6,"jswrapper",&DAT_0190552e);
        goto LAB_008cc0ec;
      }
      local_64 = *(uint *)(lVar7 + 0xc);
      bVar2 = false;
    }
    else {
      if (1 < (byte)pVVar6[8]) goto LAB_008cc0a8;
      lVar7 = 0;
      local_64 = 0;
      bVar2 = true;
    }
    cocos2d::ccDeleteBuffers(1,&local_64);
    FUN_008d3790(&DAT_01d36e30,local_64);
    if (!bVar2) {
