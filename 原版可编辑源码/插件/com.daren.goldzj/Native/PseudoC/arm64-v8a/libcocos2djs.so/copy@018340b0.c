...
/* std::__ndk1::__assoc_sub_state::copy() */

void __thiscall std::__ndk1::__assoc_sub_state::copy(__assoc_sub_state *this)

{
  ...
  if (lVar3 == 0) {
    ...
    exception_ptr::exception_ptr(aeStack_58,(exception_ptr *)(this + 0x10));
    rethrow_exception(aeStack_58);
  }
