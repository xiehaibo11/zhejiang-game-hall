...

{
  ...
  long local_48;
                    ...
                    /* try { // try from 00a62bc8 to 00b62cab has its CatchHandler @ 00a628e8 */
  lVar1 = tpidr_el0;
  ...
  *(undefined8 *)(this + 0x40) = 0;
  this[0xa2] = (basic_filebuf<char,std::__ndk1::char_traits<char>>)0x0;
  ...
  *(undefined8 *)(this + 0x70) = 0;
  locale::locale(alStack_50,this_00);
                    /* catch() { ... } // from try @ 00a62968 with catch @ 00a62c3c */
                    /* catch() { ... } // from try @ 00a6295c with catch @ 00a62c40 */
  uVar3 = locale::has_facet(alStack_50,(id *)&codecvt<char,char,mbstate_t>::id);
                    /* catch() { ... } // from try @ 00a6293c with catch @ 00a62c44 */
  locale::~locale(alStack_50);
  if ((uVar3 & 1) != 0) {
                    /* catch() { ... } // from try @ 00a62974 with catch @ 00a62c54 */
    locale::locale(alStack_50,this_00);
  ...
  (**(code **)(*(long *)this + 0x18))(this,0,0x1000);
                    /* try { // try from 00a62cac to 00b62d03 has its CatchHandler @ 00a62cac
                       catch() { ... } // from try @ 00a62cac with catch @ 00a62cac
                       catch() { ... } // from try @ 00a62ea0 with catch @ 00a62cac */
