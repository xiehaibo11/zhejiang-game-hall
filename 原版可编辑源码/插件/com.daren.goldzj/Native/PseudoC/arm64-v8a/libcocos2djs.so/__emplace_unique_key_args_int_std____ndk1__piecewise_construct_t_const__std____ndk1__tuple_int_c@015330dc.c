...

{
  ...
  if (piVar6 != (int *)0x0) {
    piVar5 = param_1 + 2;
    do {
      while (piVar7 = piVar6, piVar8 = piVar7, *(int *)param_2 < piVar7[7]) {
        piVar5 = piVar7;
        piVar6 = *(int **)piVar7;
        if (*(int **)piVar7 == (int *)0x0) {
          p_Var4 = *(__tree_node_base **)piVar7;
          goto joined_r0x01533150;
        }
      }
      if (*(int *)param_2 <= piVar7[7]) break;
      piVar5 = piVar7 + 2;
      piVar6 = *(int **)piVar5;
...
joined_r0x01533150:
  if (p_Var4 == (__tree_node_base *)0x0) {
    ...
    if ((ulong)(*(long *)(this + 0x18) - (long)p_Var4) < 0x28) {
      p_Var4 = (__tree_node_base *)v8::internal::Zone::NewExpand(this,0x28);
    }
    else {
      *(__tree_node_base **)(this + 0x10) = p_Var4 + 0x28;
    }
    uVar1 = **(undefined4 **)param_4;
    *(undefined8 *)p_Var4 = 0;
    *(undefined8 *)(p_Var4 + 8) = 0;
    *(int **)(p_Var4 + 0x10) = piVar8;
    *(undefined4 *)(p_Var4 + 0x1c) = uVar1;
