...

{
  ...
  pIVar3 = (Isolate *)(uStack_78 & 0xffffffff00000000);
  iVar2 = v8::internal::JSObject::GetFastElementsUsage((JSObject *)&uStack_78);
  puVar5 = (undefined8 *)
           v8::internal::
