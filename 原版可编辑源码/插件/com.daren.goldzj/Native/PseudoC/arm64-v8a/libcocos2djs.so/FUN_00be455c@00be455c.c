...
int FUN_00be455c(EC_GROUP *param_1,EC_POINT *param_2,long param_3,EC_POINT *param_4,BN_CTX *param_5)
...
LAB_00be4ab8:
      ...
      if (iVar3 == 0) {
        ...
        if (iVar3 == 0) {
          ...
          if (pBVar6 == (BIGNUM *)0x0) goto LAB_00be4ac0;
