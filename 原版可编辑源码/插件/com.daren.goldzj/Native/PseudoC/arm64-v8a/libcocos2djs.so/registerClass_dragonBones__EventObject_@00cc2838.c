...
/* void JSBClassType::registerClass<dragonBones::EventObject>(se::Class*) */

void JSBClassType::registerClass<dragonBones::EventObject>(Class *param_1)
