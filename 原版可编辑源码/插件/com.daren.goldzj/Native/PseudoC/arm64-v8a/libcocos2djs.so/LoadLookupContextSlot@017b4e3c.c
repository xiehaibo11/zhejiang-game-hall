...
/* v8::internal::interpreter::BytecodeArrayBuilder::LoadLookupContextSlot(v8::internal::AstRawString
   const*, v8::internal::TypeofMode, int, int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::LoadLookupContextSlot
...

{
  ...
  if (param_3 == 0) {
    ...
    BVar5 = this[0x1b0];
    if (BVar5 == (BytecodeArrayBuilder)0x0) goto LAB_017b5038;
    if ((int)uVar8 != 0) goto LAB_017b4f7c;
LAB_017b5024:
    ...
    BVar5 = this[0x1b0];
    if (BVar5 == (BytecodeArrayBuilder)0x0) goto LAB_017b5038;
    if ((int)uVar8 == 0) goto LAB_017b5024;
LAB_017b4f7c:
