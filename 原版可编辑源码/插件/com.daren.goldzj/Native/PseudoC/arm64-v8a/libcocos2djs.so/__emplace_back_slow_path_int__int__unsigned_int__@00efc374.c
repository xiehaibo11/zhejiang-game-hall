...
/* void std::__ndk1::vector<v8::internal::CoverageBlock,
   std::__ndk1::allocator<v8::internal::CoverageBlock> >::__emplace_back_slow_path<int&, int&,
...
::__emplace_back_slow_path<int&,int&,unsigned_int&>
           ...
           *this,int *param_1,int *param_2,uint *param_3)

{
  ...
  if (uVar1 < 0x1555555555555556) {
    ...
    if (uVar1 == 0) {
      ...
      if (0x1555555555555555 < uVar1) goto LAB_00efc498;
