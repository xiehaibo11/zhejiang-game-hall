...
/* void 
   v8::internal::DataHandler::BodyDescriptor::IterateBody<v8::internal::YoungGenerationMarkingVisitor>(v8::internal::Map,
          ...
          while( true ) {
            ...
            while (*puVar2 == uVar3) {
              ...
              if (cVar4 == '\0') {
                ...
                puVar13 = (undefined8 *)(lVar11 + (long)*(int *)(param_4 + 0x10) * 0x50);
