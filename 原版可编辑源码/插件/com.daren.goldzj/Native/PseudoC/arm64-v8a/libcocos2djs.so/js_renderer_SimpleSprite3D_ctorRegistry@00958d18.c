...
/* js_renderer_SimpleSprite3D_ctorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_SimpleSprite3D_ctorRegistry(FunctionCallbackInfo *param_1)
