...
/* v8::internal::interpreter::BytecodeArrayBuilder::Return() */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::Return(BytecodeArrayBuilder *this)
