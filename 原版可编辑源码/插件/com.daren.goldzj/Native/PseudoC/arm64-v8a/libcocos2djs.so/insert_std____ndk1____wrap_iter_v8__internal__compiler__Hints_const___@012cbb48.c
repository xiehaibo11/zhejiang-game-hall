...
/* std::__ndk1::enable_if<__is_forward_iterator<std::__ndk1::__wrap_iter<v8::internal::compiler::Hints
   const*> >::value&&is_constructible<v8::internal::compiler::Hints,
   std::__ndk1::iterator_traits<std::__ndk1::__wrap_iter<v8::internal::compiler::Hints const*>
...

{
  ...
  if (param_3 != param_4) {
    ...
    if ((3 < uVar5) &&
      ...
      if (uVar5 == uVar10) goto LAB_012cbde0;
    }
    do {
      puVar8 = param_3 + 1;
      puVar2 = puVar6 + 1;
