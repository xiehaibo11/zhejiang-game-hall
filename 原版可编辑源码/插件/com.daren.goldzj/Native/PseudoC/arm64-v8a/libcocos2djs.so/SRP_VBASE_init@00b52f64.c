      ...
      if (db == (TXT_DB *)0x0) {
        ...
        if (0 < iVar2) {
          ...
          do {
            ...
            if (*(char *)*puVar6 == 'V') {
              lVar5 = FUN_00b5349c(puVar6[4],lVar4);
              if (lVar5 == 0) goto LAB_00b531b4;
...
LAB_00b5311c:
                  if (pcVar7 != (char *)0x0) {
                    ...
                    ptr[5] = pcVar7;
                    if (pcVar7 == (char *)0x0) goto LAB_00b532a0;
                  }
                  uVar11 = puVar6[1];
                  uVar1 = puVar6[2];
                  ptr[1] = 0;
                  ptr[2] = 0;
                  iVar3 = FUN_00b53d24(auStack_a24,uVar11);
                  if (-1 < iVar3) {
                    pBVar9 = BN_bin2bn(auStack_a24,iVar3,(BIGNUM *)0x0);
                    ptr[2] = pBVar9;
                    if (pBVar9 != (BIGNUM *)0x0) {
                      iVar3 = FUN_00b53d24(auStack_a24,uVar1);
                      if (-1 < iVar3) {
                        pBVar9 = BN_bin2bn(auStack_a24,iVar3,(BIGNUM *)0x0);
                        ptr[1] = pBVar9;
                        if (pBVar9 != (BIGNUM *)0x0) {
                  ...
                  *ptr = pcVar8;
                  if (pcVar8 != (char *)0x0) goto LAB_00b5311c;
LAB_00b532a0:
                  uVar10 = 4;
                }
LAB_00b532a4:
...
LAB_00b532e0:
            ...
            if (*(char *)*puVar6 == 'I') {
              ...
              if (ptr != (undefined8 *)0x0) {
                ...
                *ptr = pcVar7;
                if (pcVar7 != (char *)0x0) {
                  lVar5 = FUN_00b53330(param_1[1],puVar6[1]);
                  ptr[2] = lVar5;
                  if (lVar5 != 0) {
                    lVar5 = FUN_00b53330(param_1[1],puVar6[2]);
                    ptr[1] = lVar5;
          ...
          if ((lVar4 != 0) && (iVar2 = OPENSSL_sk_num(lVar4), 0 < iVar2)) {
            ...
            do {
              ...
              if ((puVar6 != (undefined8 *)0x0) &&
                 (iVar3 = strcmp((char *)*puVar6,local_a30), iVar3 == 0)) goto LAB_00b5322c;
              iVar2 = iVar2 + 1;
