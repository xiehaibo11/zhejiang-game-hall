...
/* void 
   v8::internal::JSArrayBuffer::BodyDescriptor::IterateBody<v8::internal::IterateAndScavengePromotedObjectsVisitor>(v8::internal::Map,
...

{
  ...
  if (puVar1 < (uint *)(param_2 + 0xb)) {
    ...
    while( true ) {
      ...
      puVar1 = puVar1 + 1;
      if ((uint *)(param_2 + 0xb) <= puVar1) break;
      uVar2 = *puVar1;
    }
  }
  BodyDescriptorBase::
