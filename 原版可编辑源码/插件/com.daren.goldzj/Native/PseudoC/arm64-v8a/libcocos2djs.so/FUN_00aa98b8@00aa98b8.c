...
/* WARNING: Removing unreachable block (ram,0x00aa99ac) */
/* WARNING: Removing unreachable block (ram,0x00aa9c88) */
/* WARNING: Removing unreachable block (ram,0x00aa9b58) */
/* WARNING: Removing unreachable block (ram,0x00aa9ca4) */

ulong FUN_00aa98b8(long param_1,long param_2,undefined4 *param_3)

{
  ...
  undefined1 local_34 [4];
                    ...
                    /* try { // try from 00aa98bc to 00ba9903 has its CatchHandler @ 00aa95e4 */
  if (6 < *(byte *)(param_2 + 0x2fe) - 0x22) {
    return 0;
  }
  lVar10 = param_1 + (ulong)*(byte *)(param_2 + 0x304) * 0x6f8;
  pcVar8 = *(char **)(lVar10 + 0x7b8);
                    /* try { // try from 00aa9904 to 00ba990b has its CatchHandler @ 00aa9a40 */
  switch((uint)*(byte *)(param_2 + 0x2fe)) {
  case 0x22:
    lVar10 = FUN_00aab134(param_2);
    ...
    if ((*(byte *)((long)param_3 + 6) & 0x18) == 0) {
      ...
      *(undefined1 *)(*(long *)(lVar10 + 0x7b8) + 0xd) = 0;
      ...
      if ((iVar2 == 0) || (iVar2 = strcmp(pcVar8,"HTTP/1.1 200 "), iVar2 == 0)) {
        ...
        goto switchD_00aa9908_caseD_24;
      }
      _lws_log(1,"ERROR proxy: %s\n",pcVar8);
    }
    else {
                    /* try { // try from 00aa9938 to 00ba993f has its CatchHandler @ 00aa99f8 */
...
LAB_00aa9944:
    ...
    goto LAB_00aa99e0;
  case 0x24:
switchD_00aa9908_caseD_24:
    iVar2 = FUN_00aa3be0(param_2,4,0);
    if (iVar2 != 0) {
      return 0xffffffff;
    }
    bVar7 = *(byte *)(param_2 + 0x2f8);
    if (((bVar7 & 0xf) != 0) && (*(long *)(param_2 + 0x2b0) == 0)) {
      iVar2 = FUN_00aadc0c(param_2);
      if (iVar2 < 0) {
    ...
    *(undefined8 *)(param_2 + 0x2b0) = 0;
    ...
    break;
  case 0x25:
    goto switchD_00aa9908_caseD_25;
  case 0x26:
    if ((*(byte *)(param_2 + 0x2f7) >> 4 & 1) != 0) goto LAB_00aa9c24;
    goto LAB_00aa9bc0;
  case 0x27:
LAB_00aa9978:
    bVar7 = *(byte *)(param_2 + 0x2f8);
  ...
  case 0x28:
    if ((*(ushort *)((long)param_3 + 6) & 0x19) != 0x18) {
                    /* catch() { ... } // from try @ 00aa98b4 with catch @ 00aa9a10 */
      if ((*(ushort *)((long)param_3 + 6) & 1) == 0) {
        return 0;
      }
      do {
        if (*(char *)(param_2 + 0x36) == '_') {
          uVar4 = FUN_00aaa1cc(param_2);
          return uVar4;
        }
        iVar2 = lws_ssl_capable_read(param_2,local_34,1);
                    /* catch() { ... } // from try @ 00aa9804 with catch @ 00aa9a30 */
        if (iVar2 + 1U < 2) {
          pcVar8 = "read failed";
          uVar9 = *(undefined8 *)(param_2 + 0x270);
          pcVar11 = *(code **)(*(long *)(param_2 + 0x248) + 8);
          goto LAB_00aa9958;
                    ...
                    /* catch() { ... } // from try @ 00aa9904 with catch @ 00aa9a40 */
        if (iVar2 == -2) {
          return 0;
        }
        iVar2 = FUN_00aa6228(param_2,local_34[0]);
      } while (iVar2 == 0);
...
LAB_00aa9c68:
    ...
    pcVar8 = "Peer hung up";
                    /* try { // try from 00aa99cc to 00ba99d3 has its CatchHandler @ 00aa99f0 */
    uVar9 = *(undefined8 *)(param_2 + 0x270);
                    /* try { // try from 00aa99d4 to 00ba99e3 has its CatchHandler @ 00aa99f4 */
    pcVar11 = *(code **)(*(long *)(param_2 + 0x248) + 8);
    goto LAB_00aa9958;
  }
  if ((bVar7 & 0xf) == 0) {
...
LAB_00aa9958:
      sVar6 = strlen(pcVar8);
LAB_00aa99e0:
                    /* try { // try from 00aa99e4 to 00ba9ab7 has its CatchHandler @ 00aa95e4 */
                    /* catch() { ... } // from try @ 00aa99cc with catch @ 00aa99f0 */
      (*pcVar11)(param_2,1,uVar9,pcVar8,sVar6);
                    /* catch() { ... } // from try @ 00aa99d4 with catch @ 00aa99f4 */
                    /* catch() { ... } // from try @ 00aa9938 with catch @ 00aa99f8 */
                    /* catch() { ... } // from try @ 00aa96a4 with catch @ 00aa99fc */
...
switchD_00aa9908_caseD_25:
  lVar10 = FUN_00aa9ca8(param_2,pcVar8);
  if (lVar10 != 0) {
