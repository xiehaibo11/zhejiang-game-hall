...
/* JSB_glIsBufferRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glIsBufferRegistry(FunctionCallbackInfo *param_1)
...
LAB_008be92c:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            ...
                            ,0x675,"JSB_glIsBuffer");
        __android_log_print(6,"jswrapper",&DAT_0190552e);
        goto LAB_008be970;
      }
      lVar9 = __dynamic_cast(lVar8,&PTR_PTR_01c67690,&PTR_PTR_01c676f8,0);
      if (lVar9 == 0) goto LAB_008be914;
      cVar4 = glIsBuffer(*(undefined4 *)(lVar8 + 0xc));
      bVar3 = cVar4 == '\x01';
    }
    else {
      if (1 < (byte)pVVar7[8]) goto LAB_008be92c;
LAB_008be914:
      bVar3 = false;
    }
