...
/* v8::internal::compiler::EffectControlLinearizer::LowerObjectIsInteger(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerObjectIsInteger
...

{
  ...
  pNVar2 = (Node *)BuildFloat64RoundTruncate(this,pNVar6);
  pNVar6 = (Node *)GraphAssembler::Float64Sub(this_00,pNVar6,pNVar2);
  pNVar2 = (Node *)GraphAssembler::Float64Constant(this_00,0.0);
  pNVar6 = (Node *)GraphAssembler::Float64Equal(this_00,pNVar6,pNVar2);
