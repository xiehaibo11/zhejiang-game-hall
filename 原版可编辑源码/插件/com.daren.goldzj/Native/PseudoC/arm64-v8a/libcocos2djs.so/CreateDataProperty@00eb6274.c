...
/* v8::Object::CreateDataProperty(v8::Local<v8::Context>, v8::Local<v8::Name>, v8::Local<v8::Value>)
    */

ushort __thiscall
v8::Object::CreateDataProperty(Object *this,long param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  *(int *)pIVar14 = *(int *)pIVar14 + 1;
  ...
  if ((uVar4 & 1) != 0) {
    internal::Logger::ApiEntryCall(this_00,"v8::Object::CreateDataProperty");
  }
  uVar1 = *(undefined4 *)(pIVar10 + 0x2c60);
  *(undefined4 *)(pIVar10 + 0x2c60) = 5;
  uVar3 = internal::JSReceiver::CreateDataProperty(pIVar10,this,param_3,param_4,0x100000001);
  if ((uVar3 & 0xff) == 0) {
    local_a0 = '\x01';
