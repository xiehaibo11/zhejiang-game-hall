...
/* void std::__ndk1::vector<v8::internal::Signature<v8::internal::wasm::ValueType>*,
   std::__ndk1::allocator<v8::internal::Signature<v8::internal::wasm::ValueType>*>
   >::__push_back_slow_path<v8::internal::Signature<v8::internal::wasm::ValueType>*
   const&>(v8::internal::Signature<v8::internal::wasm::ValueType>* const&) */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_015f2d78;
