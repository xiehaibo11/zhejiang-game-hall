...
/* v8::internal::compiler::EffectControlLinearizer::LowerCheckedTaggedToInt64(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerCheckedTaggedToInt64
...

{
  ...
  if (*(char *)(*(long *)(*(long *)this + 0x10) + 0x10) == '\x05') {
    ...
    *(undefined8 *)(this + 0x60) = 0;
    ...
    pNVar6 = (Node *)BuildCheckedFloat64ToInt64(this,*puVar2,puVar2 + 8,uVar5,param_2);
