...
void FUN_010ae0b0(undefined8 param_1,undefined8 param_2,long *param_3,uint param_4,long *param_5,
  ...
  if ((int)param_6 < 0) {
    ...
    if (0 < (int)uVar3) {
      ...
      if (uVar3 < 8) {
        ...
        if (uVar11 == uVar9) goto LAB_010ae184;
      }
      lVar10 = uVar9 - uVar11;
...
LAB_010ae184:
  if ((int)uVar6 != 0) {
    v8::internal::Heap::CopyRange<v8::internal::CompressedObjectSlot>
              ((Heap *)(extraout_x1 + 0x8850),lVar5,lVar5 + 7,lVar7 + 7,uVar6,4,uVar6,param_8,
               puVar14,pcVar15);
    return;
  }
  return;
