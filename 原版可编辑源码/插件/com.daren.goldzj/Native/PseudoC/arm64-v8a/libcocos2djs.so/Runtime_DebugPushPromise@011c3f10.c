...
/* v8::internal::Runtime_DebugPushPromise(int, unsigned long*, v8::internal::Isolate*) */

undefined8 v8::internal::Runtime_DebugPushPromise(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar2 = FUN_011c3fe8(param_1,param_2,param_3);
    return uVar2;
  }
