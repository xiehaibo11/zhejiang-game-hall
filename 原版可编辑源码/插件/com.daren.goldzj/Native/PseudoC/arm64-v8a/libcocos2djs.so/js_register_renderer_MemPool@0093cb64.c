...
/* js_register_renderer_MemPool(se::Object*) */

undefined8 js_register_renderer_MemPool(Object *param_1)

{
  ...
  uStack_47 = 0x6c6f6f506d654d;
  uStack_40 = 0;
  this = (Class *)se::Class::create(&local_48,param_1,(Object *)0x0,
                                    js_renderer_MemPool_constructorRegistry);
  if (((byte)local_48 & 1) != 0) {
    operator_delete(local_38);
  }
  se::Class::defineFunction(this,"removeCommonData",js_renderer_MemPool_removeCommonDataRegistry);
  se::Class::defineFunction(this,"updateCommonData",js_renderer_MemPool_updateCommonDataRegistry);
  se::Class::defineFinalizeFunction(this,js_cocos2d_renderer_MemPool_finalizeRegistry);
  se::Class::install(this);
  local_30 = (Class *)0x1869658;
  ...
  __jsb_cocos2d_renderer_MemPool_proto = se::Class::getProto(this);
  __jsb_cocos2d_renderer_MemPool_class = this;
