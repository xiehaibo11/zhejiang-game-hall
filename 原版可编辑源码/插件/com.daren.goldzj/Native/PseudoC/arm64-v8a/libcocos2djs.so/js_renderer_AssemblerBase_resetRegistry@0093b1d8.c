...
/* js_renderer_AssemblerBase_resetRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_AssemblerBase_resetRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar4 == (long *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x37e,"js_renderer_AssemblerBase_reset");
    __android_log_print(6,"jswrapper","js_renderer_AssemblerBase_reset : Invalid Native Object");
  }
  else {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 901): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar5[1] - *plVar5) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_AssemblerBase_reset",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0x388);
LAB_0093b330:
