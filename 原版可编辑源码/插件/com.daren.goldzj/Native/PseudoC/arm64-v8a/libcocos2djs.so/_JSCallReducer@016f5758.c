...
/* v8::internal::compiler::JSCallReducer::~JSCallReducer() */

void __thiscall v8::internal::compiler::JSCallReducer::~JSCallReducer(JSCallReducer *this)

{
  *(undefined ***)this = &PTR__JSCallReducer_01ccd228;
  std::__ndk1::
