...
/* void 
   v8::internal::Heap::WriteBarrierForRange<v8::internal::CompressedMaybeObjectSlot>(v8::internal::HeapObject,
   v8::internal::CompressedMaybeObjectSlot, v8::internal::CompressedMaybeObjectSlot) */

void __thiscall
v8::internal::Heap::WriteBarrierForRange<v8::internal::CompressedMaybeObjectSlot>
...

{
    ...
    if (param_3 < param_4) {
      ...
      do {
        ...
        if (((uVar2 != 3) && ((uVar2 & 1) != 0)) &&
          ...
          uVar15 = (long)param_3 - uVar12;
          puVar6 = *(undefined8 **)(pSVar13 + (uVar15 >> 0xc) * 8);
          uVar9 = uVar15 >> 7 & 0x1f;
          if (puVar6 == (undefined8 *)0x0) {
            ...
            *puVar6 = 0;
            ...
            puVar6[0xf] = 0;
            puVar6[0xe] = 0;
            *(undefined8 **)(pSVar13 + (uVar15 >> 0xc) * 8) = puVar6;
            param_2 = extraout_x1_00;
          }
          uVar2 = *(uint *)((long)puVar6 + uVar9 * 4);
          uVar8 = 1 << (ulong)((uint)uVar15 >> 2 & 0x1f);
          if ((uVar2 & uVar8) == 0) {
  ...
  case 2:
    for (; param_3 < param_4; param_3 = param_3 + 1) {
      uVar2 = *param_3;
      if ((uVar2 != 3) && ((uVar2 & 1) != 0)) {
        uVar9 = (ulong)uVar2 & 0xfffffffd | (ulong)param_3 & 0xffffffff00000000;
        uVar12 = (ulong)uVar2 & 0xfffc0000 | (ulong)param_3 & 0xffffffff00000000;
        uVar15 = uVar9 - uVar12;
        puVar1 = (uint *)(*(long *)(uVar12 + 0x10) + (uVar15 >> 7 & 0x1ffffff) * 4);
        while( true ) {
          uVar2 = *puVar1;
          uVar8 = (uint)(1L << (uVar15 >> 2 & 0x1f));
...
LAB_00f9bbb4:
  ...
  case 3:
    for (; param_3 < param_4; param_3 = param_3 + 1) {
      uVar2 = *param_3;
      if ((uVar2 != 3) && ((uVar2 & 1) != 0)) {
        uVar12 = (ulong)uVar2 & 0xfffffffd | (ulong)param_3 & 0xffffffff00000000;
        uVar15 = (ulong)uVar2 & 0xfffc0000 | (ulong)param_3 & 0xffffffff00000000;
        if ((*(byte *)(uVar15 + 8) & 0x18) != 0) {
          pSVar13 = *(SlotSet **)(this_00 + 0x30);
          if (pSVar13 == (SlotSet *)0x0) {
            pSVar13 = MemoryChunk::AllocateSlotSet<(v8::internal::RememberedSetType)0>(this_00);
          ...
          uVar2 = *(uint *)((long)puVar6 + uVar16 * 4);
          uVar8 = 1 << (ulong)((uint)uVar9 >> 2 & 0x1f);
          if ((uVar2 & uVar8) == 0) {
            *(uint *)((long)puVar6 + uVar16 * 4) = uVar2 | uVar8;
          }
        }
        uVar9 = uVar12 - uVar15;
        puVar1 = (uint *)(*(long *)(uVar15 + 0x10) + (uVar9 >> 7 & 0x1ffffff) * 4);
        while( true ) {
          uVar2 = *puVar1;
          ...
          while (*puVar1 == uVar2) {
            ...
            if (cVar3 == '\0') {
              puVar17 = (undefined8 *)plVar14[2];
              puVar6 = (undefined8 *)*puVar17;
              lVar10 = puVar6[1];
              if (lVar10 == 0x40) {
                base::Mutex::Lock((Mutex *)(puVar17 + 0x50));
                *puVar6 = puVar17[0x55];
                puVar17[0x55] = puVar6;
                base::Mutex::Unlock((Mutex *)(puVar17 + 0x50));
                puVar7 = operator_new(0x210);
                puVar7[4] = 0;
                puVar7[3] = 0;
                puVar7[6] = 0;
  ...
  case 6:
    for (; param_3 < param_4; param_3 = param_3 + 1) {
      ...
      if ((uVar2 != 3) && ((uVar2 & 1) != 0)) {
        ...
        uVar15 = (ulong)uVar2 & 0xfffc0000 | (ulong)param_3 & 0xffffffff00000000;
        uVar12 = uVar9 - uVar15;
        puVar1 = (uint *)(*(long *)(uVar15 + 0x10) + (uVar12 >> 7 & 0x1ffffff) * 4);
        while( true ) {
          uVar2 = *puVar1;
...
LAB_00f9c0e0:
        if ((*(char *)((long)plVar14 + 0x5c) != '\0') &&
           (((uint)*(undefined8 *)(uVar15 + 8) >> 6 & 1) != 0)) {
  ...
  case 7:
    for (; param_3 < param_4; param_3 = param_3 + 1) {
      uVar2 = *param_3;
      if ((uVar2 != 3) && ((uVar2 & 1) != 0)) {
        uVar15 = (ulong)uVar2 & 0xfffffffd | (ulong)param_3 & 0xffffffff00000000;
        uVar12 = (ulong)uVar2 & 0xfffc0000 | (ulong)param_3 & 0xffffffff00000000;
...
LAB_00f9bf30:
        if ((*(char *)((long)plVar14 + 0x5c) != '\0') &&
           (((uint)*(undefined8 *)(uVar12 + 8) >> 6 & 1) != 0)) {
          RememberedSet<(v8::internal::RememberedSetType)1>::Insert<(v8::internal::AccessMode)0>
                    (this_00,(ulong)param_3);
