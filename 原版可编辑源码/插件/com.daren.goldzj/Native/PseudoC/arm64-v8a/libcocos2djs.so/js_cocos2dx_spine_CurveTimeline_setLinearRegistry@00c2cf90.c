...
/* js_cocos2dx_spine_CurveTimeline_setLinearRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_CurveTimeline_setLinearRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (CurveTimeline *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xf3f,"js_cocos2dx_spine_CurveTimeline_setLinear");
    pcVar6 = "js_cocos2dx_spine_CurveTimeline_setLinear : Invalid Native Object";
LAB_00c2d104:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::CurveTimeline::setLinear(this,local_68);
        goto LAB_00c2d13c;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0xf46,"js_cocos2dx_spine_CurveTimeline_setLinear");
      pcVar6 = "js_cocos2dx_spine_CurveTimeline_setLinear : Error processing arguments";
      goto LAB_00c2d104;
    }
    __android_log_print(6,"jswrapper",&DAT_018fd78d,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_CurveTimeline_setLinear",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0xf4d);
LAB_00c2d13c:
