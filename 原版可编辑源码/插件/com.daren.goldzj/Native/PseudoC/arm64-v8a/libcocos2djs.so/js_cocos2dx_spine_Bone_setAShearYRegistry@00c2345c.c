...
/* js_cocos2dx_spine_Bone_setAShearYRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_setAShearYRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Bone *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x9c7,"js_cocos2dx_spine_Bone_setAShearY");
    pcVar6 = "js_cocos2dx_spine_Bone_setAShearY : Invalid Native Object";
LAB_00c235d0:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Bone::setAShearY(this,local_64);
        goto LAB_00c23608;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x9ce,"js_cocos2dx_spine_Bone_setAShearY");
      pcVar6 = "js_cocos2dx_spine_Bone_setAShearY : Error processing arguments";
      goto LAB_00c235d0;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 2514): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_setAShearY",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x9d5);
LAB_00c23608:
