...
/* void std::__ndk1::vector<v8::internal::HeapObject,
   std::__ndk1::allocator<v8::internal::HeapObject>
   >::__push_back_slow_path<v8::internal::HeapObject const&>(v8::internal::HeapObject const&) */
...
__push_back_slow_path<v8::internal::HeapObject_const&>
          (vector<v8::internal::HeapObject,std::__ndk1::allocator<v8::internal::HeapObject>> *this,
          HeapObject *param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00fa17d4;
