...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitLdaCurrentContextSlot() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitLdaCurrentContextSlot(BytecodeGraphBuilder *this)

{
  ...
  pOVar2 = (Operator *)JSOperatorBuilder::LoadContext(this_00,0,uVar1 & 0xffffffff,false);
