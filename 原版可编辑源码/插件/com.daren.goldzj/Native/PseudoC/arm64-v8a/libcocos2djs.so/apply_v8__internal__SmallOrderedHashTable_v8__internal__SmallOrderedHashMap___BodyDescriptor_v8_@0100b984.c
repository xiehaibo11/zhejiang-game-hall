...
/* void 
   v8::internal::CallIterateBody::apply<v8::internal::SmallOrderedHashTable<v8::internal::SmallOrderedHashMap>::BodyDescriptor,
...

{
  ...
  puVar6 = (uint *)(param_2 + ((ulong)*(byte *)(param_2 + 5) << 4 | 8) + -1);
  if (puVar1 < puVar6) {
