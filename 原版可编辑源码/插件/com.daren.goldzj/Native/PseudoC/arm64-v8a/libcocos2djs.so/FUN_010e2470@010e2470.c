...
Isolate * FUN_010e2470(Isolate *param_1,undefined4 param_2,undefined8 param_3,ulong param_4)

{
  ...
  if (*(uint *)(param_4 + 7) < 2) {
    ...
    local_48 = param_4;
    uVar1 = v8::internal::Dictionary<v8::internal::NameDictionary,v8::internal::NameDictionaryShape>
