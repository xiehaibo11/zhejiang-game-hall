...
/* v8::internal::compiler::JSOperatorBuilder::LoadNamed(v8::internal::Handle<v8::internal::Name>,
   v8::internal::compiler::FeedbackSource const&) */

Operator * __thiscall
v8::internal::compiler::JSOperatorBuilder::LoadNamed
          (JSOperatorBuilder *this,undefined8 param_2,undefined8 *param_3)

{
  ...
  Operator::Operator(pOVar2,0x2ea,0,"JSLoadNamed",1,1,1,1,1,2);
  *(undefined8 *)(pOVar2 + 0x30) = param_2;
  *(undefined ***)pOVar2 = &PTR__Operator_01ccfb58;
  pOVar2[0x48] = (Operator)0x0;
