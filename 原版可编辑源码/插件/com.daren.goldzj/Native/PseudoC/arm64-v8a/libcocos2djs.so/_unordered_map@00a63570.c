...

{
  ...
  while (puVar1 != (void *)0x0) {
    pvVar2 = (void *)*puVar1;
                    /* try { // try from 00a63594 to 00b635f3 has its CatchHandler @ 00a6344c */
  ...
  *(undefined8 *)this = 0;
  if (pvVar2 == (void *)0x0) {
                    /* catch() { ... } // from try @ 00a634ac with catch @ 00a635cc */
                    /* catch() { ... } // from try @ 00a634a0 with catch @ 00a635d0 */
                    /* catch() { ... } // from try @ 00a634b4 with catch @ 00a635d8 */
    return;
  }
