...
/* v8::BigIntObject::ValueOf() const */

ulong * __thiscall v8::BigIntObject::ValueOf(BigIntObject *this)

{
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_60,(ulong)&local_60 | 8,0x35f);
  }
  this_00 = *(Logger **)(pIVar3 + 0x9558);
  uVar1 = internal::Logger::is_logging(this_00);
  if ((uVar1 & 1) != 0) {
    internal::Logger::ApiEntryCall(this_00,"v8::BigIntObject::BigIntValue");
  }
