...
undefined1  [16] __thiscall v8::Value::NumberValue(Value *this,long param_2)
    ...
    if (*(short *)((uVar4 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar4 - 1)) != 0x42) {
      ...
      *(int *)pIVar14 = *(int *)pIVar14 + 1;
      ...
      if (internal::TracingFlags::runtime_stats != 0) {
        ...
        internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x3f3);
      }
      this_00 = *(Logger **)(pIVar9 + 0x9558);
      uVar4 = internal::Logger::is_logging(this_00);
      if ((uVar4 & 1) != 0) {
        internal::Logger::ApiEntryCall(this_00,"v8::Value::NumberValue");
      }
      ...
      *(undefined4 *)(pIVar9 + 0x2c60) = 5;
      ...
      if (((uVar4 & 1) != 0) &&
        ...
        this = (Value *)internal::Object::ConvertToNumberOrNumeric(pIVar9,this,0);
      }
      if (this == (Value *)0x0) {
        local_a0 = '\x01';
