...
/* v8::internal::compiler::JSCreateLowering::ReduceJSCreateWithContext(v8::internal::compiler::Node*)
    */

Node * __thiscall
v8::internal::compiler::JSCreateLowering::ReduceJSCreateWithContext
...

{
  ...
  if (*(char *)(lVar7 + 0x18) == '\x01') {
    ...
    auVar10 = NativeContextRef::with_context_map((NativeContextRef *)&local_90);
