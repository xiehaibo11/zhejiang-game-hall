...
/* void std::__ndk1::vector<v8::internal::RuntimeCallStatEntries::Entry,
   std::__ndk1::allocator<v8::internal::RuntimeCallStatEntries::Entry>
   >::__push_back_slow_path<v8::internal::RuntimeCallStatEntries::Entry>(v8::internal::RuntimeCallStatEntries::Entry&&)
    */
...

{
  ...
  if (uVar1 < 0x666666666666667) {
    ...
    if (uVar1 == 0) {
      ...
      if (0x666666666666666 < uVar1) goto LAB_010578c0;
