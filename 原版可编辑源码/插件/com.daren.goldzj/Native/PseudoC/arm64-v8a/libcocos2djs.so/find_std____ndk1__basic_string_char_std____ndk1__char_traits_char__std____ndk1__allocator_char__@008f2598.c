...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, se::Value>, void*>*>
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if ((uVar14 & uVar13) == 0) {
              ...
              if (uVar9 - uVar4 * uVar13 == uVar15) goto LAB_008f26ec;
              goto LAB_008f2710;
            }
            if (uVar9 != uVar15) goto LAB_008f2710;
          }
LAB_008f26ec:
          plVar8 = (long *)*plVar8;
