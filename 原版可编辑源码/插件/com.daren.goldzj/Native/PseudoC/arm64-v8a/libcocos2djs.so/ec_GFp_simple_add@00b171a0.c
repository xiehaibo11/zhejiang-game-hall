...
LAB_00b1733c:
    ...
    if ((iVar3 == 0) || (iVar3 = BN_mod_sub_quick(r_00,a_01,a_03,m), iVar3 == 0)) goto LAB_00b176a4;
    iVar3 = BN_is_zero(r);
    if (iVar3 == 0) {
      ...
      if (*(int *)(param_3 + 0x20) == 0) {
        ...
        if (*(int *)(param_4 + 0x20) != 0) goto LAB_00b17520;
        iVar3 = (*pcVar1)(param_1,a,pBVar5,*(undefined8 *)(param_4 + 0x18),param_5);
        if (iVar3 == 0) goto LAB_00b176a4;
LAB_00b17550:
...
LAB_00b17520:
          ...
          if (pBVar5 == (BIGNUM *)0x0) goto LAB_00b176a4;
          goto LAB_00b17550;
        }
