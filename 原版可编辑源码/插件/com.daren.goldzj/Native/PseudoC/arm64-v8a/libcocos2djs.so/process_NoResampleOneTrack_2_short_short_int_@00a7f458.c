...
/* void cocos2d::AudioMixer::process_NoResampleOneTrack<2, short, short,
   int>(cocos2d::AudioMixer::state_t*, long) */

void cocos2d::AudioMixer::process_NoResampleOneTrack<2,short,short,int>
...

{
  ...
  lVar15 = *(long *)(param_1 + 8);
                    /* try { // try from 00a7f488 to 00b7f4df has its CatchHandler @ 00a7f488
                       catch() { ... } // from try @ 00a7f488 with catch @ 00a7f488
                       catch() { ... } // from try @ 00a7f648 with catch @ 00a7f488 */
  ...
  if (lVar15 != 0) {
    ...
    psVar2 = param_1 + lVar10 * 0xd0 + 0x80;
                    /* try { // try from 00a7f4e0 to 00b7f4f7 has its CatchHandler @ 00a7f6c8 */
    do {
      lVar9 = 0x7fffffffffffffff;
      *(long *)psVar2 = lVar15;
      if (param_2 != 0x7fffffffffffffff) {
                    /* try { // try from 00a7f500 to 00b7f50b has its CatchHandler @ 00a7f6c4 */
                    /* try { // try from 00a7f50c to 00b7f517 has its CatchHandler @ 00a7f6c0 */
                    /* try { // try from 00a7f518 to 00b7f647 has its CatchHandler @ 00a7f6d8 */
        uVar14 = 0;
      ...
      if ((psVar13 == (short *)0x0) || (((ulong)psVar13 & 3) != 0)) {
        ...
        if (((ulong)psVar13 & 3) == 0) {
          return;
                    ...
                    /* try { // try from 00a7f648 to 00b7f72f has its CatchHandler @ 00a7f488 */
