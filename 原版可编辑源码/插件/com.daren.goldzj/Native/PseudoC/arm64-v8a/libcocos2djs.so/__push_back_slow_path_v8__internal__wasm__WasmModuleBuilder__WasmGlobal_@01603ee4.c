...
/* void std::__ndk1::vector<v8::internal::wasm::WasmModuleBuilder::WasmGlobal,
   v8::internal::ZoneAllocator<v8::internal::wasm::WasmModuleBuilder::WasmGlobal>
   >::__push_back_slow_path<v8::internal::wasm::WasmModuleBuilder::WasmGlobal>(v8::internal::wasm::WasmModuleBuilder::WasmGlobal&&)
    */
