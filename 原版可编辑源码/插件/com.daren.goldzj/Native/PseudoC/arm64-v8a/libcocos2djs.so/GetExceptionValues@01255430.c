...
/* v8::internal::WasmExceptionPackage::GetExceptionValues(v8::internal::Isolate*,
   v8::internal::Handle<v8::internal::WasmExceptionPackage>) */

long v8::internal::WasmExceptionPackage::GetExceptionValues(ulong param_1,undefined8 param_2)
