...
/* js_cocos2dx_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegmentRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegmentRegistry
...

{
  ...
  case 8:
    ...
    if ((((((uVar30 & 1) == 0) || ((uVar19 & 1) == 0)) || ((uVar20 & 1) == 0)) ||
      ...
      iVar15 = dragonBones::EllipseBoundingBoxData::ellipseIntersectsSegment
      ...
      if ((uVar30 & 1) != 0) goto LAB_00ca6e00;
      uVar31 = 0xa47;
    }
    break;
  case 9:
...
LAB_00ca6db4:
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegment : Error processing arguments"
                       );
    goto LAB_00ca6dd4;
  default:
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp, 2715): wrong number of arguments: %d, was expecting %d\n"
