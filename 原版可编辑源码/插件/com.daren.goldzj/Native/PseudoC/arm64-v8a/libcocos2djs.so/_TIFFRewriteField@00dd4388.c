...
joined_r0x00dd4528:
          while (local_84[0] != 0) {
            ...
            if (local_88[0] == param_2) goto LAB_00dd4538;
            lVar4 = lVar4 + lVar5;
          }
          ...
          if (uVar11 == param_3) {
            ...
            if (0 < (long)param_4) {
              ...
              do {
                ...
                *(int *)((long)__ptr + lVar6 * 4) = iVar3;
                if (iVar3 != lVar12) goto LAB_00dd4780;
                lVar6 = lVar6 + 1;
            ...
            do {
              ...
              *(int *)((long)__ptr + lVar6 * 4) = (int)uVar7;
              if ((uVar7 & 0xffffffff00000000) != 0) goto LAB_00dd4780;
              lVar6 = lVar6 + 1;
            } while (lVar6 < (long)param_4);
          }
          iVar3 = TIFFDataWidth(uVar11);
...
LAB_00dd4820:
            ...
            if (8 < (long)((long)iVar3 * param_4)) goto LAB_00dd4820;
            local_a0 = lVar4 + 0xc;
LAB_00dd4814:
            bVar10 = true;
          }
...
LAB_00dd49ec:
            ...
            if (bVar10) {
              ...
              iVar3 = TIFFDataWidth(uVar11);
              _TIFFfree(__ptr);
              if (lVar6 != (long)iVar3 * param_4) goto LAB_00dd49f4;
            }
            ...
            if (lVar6 == lVar4) {
              ...
              if (lVar4 == lVar5) goto LAB_00dd49ec;
              uVar13 = param_1[0x77];
              uVar9 = *param_1;
