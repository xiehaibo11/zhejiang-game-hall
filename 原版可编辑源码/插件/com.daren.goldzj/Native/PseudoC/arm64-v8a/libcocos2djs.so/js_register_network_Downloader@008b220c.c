...
/* js_register_network_Downloader(se::Object*) */

undefined8 js_register_network_Downloader(Object *param_1)

{
  ...
  this = (Class *)se::Class::create(&local_48,param_1,(Object *)0x0,
                                    js_network_Downloader_constructorRegistry);
  if (((byte)local_48 & 1) != 0) {
    operator_delete(local_38);
  }
  se::Class::defineFunction
            (this,"setOnTaskProgress",js_network_Downloader_setOnTaskProgressRegistry);
  se::Class::defineFinalizeFunction(this,js_cocos2d_network_Downloader_finalizeRegistry);
  se::Class::install(this);
  local_48 = SUB81(this,0);
  uStack_47 = (undefined7)((ulong)this >> 8);
  local_30 = (Class *)0x185fa6c;
  std::__ndk1::
  ...
  __jsb_cocos2d_network_Downloader_proto = se::Class::getProto(this);
  __jsb_cocos2d_network_Downloader_class = this;
