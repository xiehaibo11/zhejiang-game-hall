...
undefined1  [16] FUN_010c3144(undefined8 param_1,long *param_2,ulong *param_3,long param_4)

{
  ...
  if ((local_18 & 1) != 0) {
    ...
    if ((*(short *)((local_18 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(local_18 - 1)) == 0x41)
       && (lVar2 = v8::internal::BigInt::AsInt64((BigInt *)&local_18,local_34), local_34[0] != false
          )) {
      do {
