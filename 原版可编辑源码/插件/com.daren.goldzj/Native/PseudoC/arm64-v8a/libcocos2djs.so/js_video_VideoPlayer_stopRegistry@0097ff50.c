...
/* js_video_VideoPlayer_stopRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_video_VideoPlayer_stopRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar4 == (long *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xaa,"js_video_VideoPlayer_stop");
    __android_log_print(6,"jswrapper","js_video_VideoPlayer_stop : Invalid Native Object");
  }
  else {
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_video_auto.cpp, 177): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar5[1] - *plVar5) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_video_VideoPlayer_stop",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_video_auto.cpp"
                      ,0xb4);
LAB_009800a8:
