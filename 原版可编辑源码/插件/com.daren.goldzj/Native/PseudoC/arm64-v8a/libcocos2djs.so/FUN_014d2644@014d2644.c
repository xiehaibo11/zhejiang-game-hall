...
ulong FUN_014d2644(Isolate *param_1)

{
  ...
  *(int *)(param_1 + 0x95b0) = *(int *)(param_1 + 0x95b0) + 1;
  ...
  if (*(int *)(uVar6 + 7) != iVar2) {
    puVar5 = (ulong *)v8::internal::Factory::NewProperSubString((Factory *)param_1,puVar5,0,iVar2);
    uVar6 = *puVar5;
  }
  *(ulong **)pIVar1 = puVar3;
  *(int *)(param_1 + 0x95b0) = *(int *)(param_1 + 0x95b0) + -1;
