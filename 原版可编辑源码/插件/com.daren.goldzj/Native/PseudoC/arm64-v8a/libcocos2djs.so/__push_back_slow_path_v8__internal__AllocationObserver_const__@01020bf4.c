...
/* void std::__ndk1::vector<v8::internal::AllocationObserver*,
   std::__ndk1::allocator<v8::internal::AllocationObserver*>
   >::__push_back_slow_path<v8::internal::AllocationObserver*
   const&>(v8::internal::AllocationObserver* const&) */
...
::__push_back_slow_path<v8::internal::AllocationObserver*const&>
          (vector<v8::internal::AllocationObserver*,std::__ndk1::allocator<v8::internal::AllocationObserver*>>
           *this,AllocationObserver **param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_01020cdc;
