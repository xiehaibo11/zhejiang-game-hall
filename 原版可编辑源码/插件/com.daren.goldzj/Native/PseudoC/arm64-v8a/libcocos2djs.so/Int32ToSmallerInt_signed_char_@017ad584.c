...
/* void v8::internal::compiler::SimdScalarLowering::Int32ToSmallerInt<signed
   char>(v8::internal::compiler::Node**, v8::internal::compiler::Node**) */

void __thiscall
v8::internal::compiler::SimdScalarLowering::Int32ToSmallerInt<signed_char>
...

{
  ...
  lVar4 = 0;
  if (*param_1 != (Node *)0x0) goto LAB_017ad5e8;
  do {
    param_2[1] = (Node *)0x0;
    *param_2 = (Node *)0x0;
    param_2[3] = (Node *)0x0;
      ...
      *param_2 = pNVar5;
      ...
      pOVar2 = (Operator *)
               MachineOperatorBuilder::Word32Sar
                         ((MachineOperatorBuilder *)(*(undefined8 **)this)[2]);
      pNVar5 = *(Node **)((long)param_1 + lVar4);
      uStack_58 = MachineGraph::Int32Constant(*(MachineGraph **)this,8);
      local_60 = pNVar5;
      local_60 = (Node *)Graph::NewNode(pGVar3,pOVar2,2,&local_60,false);
      pNVar5 = (Node *)Graph::NewNode(pGVar3,pOVar1,1,&local_60,false);
      param_2[1] = pNVar5;
      ...
      pOVar2 = (Operator *)
               MachineOperatorBuilder::Word32Sar
                         ((MachineOperatorBuilder *)(*(undefined8 **)this)[2]);
      pNVar5 = *(Node **)((long)param_1 + lVar4);
      uStack_58 = MachineGraph::Int32Constant(*(MachineGraph **)this,0x18);
      local_60 = pNVar5;
      local_60 = (Node *)Graph::NewNode(pGVar3,pOVar2,2,&local_60,false);
      pNVar5 = (Node *)Graph::NewNode(pGVar3,pOVar1,1,&local_60,false);
      param_2[3] = pNVar5;
