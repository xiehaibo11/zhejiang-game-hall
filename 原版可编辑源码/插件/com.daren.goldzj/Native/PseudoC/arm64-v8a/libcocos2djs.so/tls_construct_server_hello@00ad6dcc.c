...

{
  ...
  local_34 = 0;
                    /* try { // try from 00ad6dec to 00bd6e4b has its CatchHandler @ 00ad6cf8 */
  ...
  *puVar1 = (char)((uint)*param_1 >> 8);
  ...
  uVar8 = *(undefined8 *)(lVar5 + 0xa0);
                    /* catch() { ... } // from try @ 00ad6d80 with catch @ 00ad6e1c */
  ...
  *(undefined8 *)(puVar1 + 2) = uVar8;
  ...
  iVar2 = *(int *)(lVar5 + 0x38);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ad6ed8 with catch @ 00ad6e54
                        */
  if (iVar2 < 0x21) {
    puVar6 = puVar1 + 0x23;
    puVar1[0x22] = (char)iVar2;
                    /* try { // try from 00ad6e8c to 00bd6e9b has its CatchHandler @ 00ad6f4c */
    ...
    iVar3 = ssl_prepare_serverhello_tlsext(param_1);
                    /* try { // try from 00ad6ec8 to 00bd6ed7 has its CatchHandler @ 00ad6f34 */
    if (iVar3 < 1) {
      iVar2 = 0x113;
      iVar3 = 0x623;
    }
    else {
                    /* try { // try from 00ad6ed8 to 00bd6f6f has its CatchHandler @ 00ad6e54 */
      lVar5 = ssl_add_serverhello_tlsext(param_1,puVar6 + iVar2 + 1,lVar7 + 0x4000,&local_34);
      if (lVar5 == 0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ad6ec8 with catch @ 00ad6f34
                        */
        ssl3_send_alert(param_1,2,local_34);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ad6e8c with catch @ 00ad6f4c
                        */
        iVar2 = 0x44;
        iVar3 = 0x62b;
      }
