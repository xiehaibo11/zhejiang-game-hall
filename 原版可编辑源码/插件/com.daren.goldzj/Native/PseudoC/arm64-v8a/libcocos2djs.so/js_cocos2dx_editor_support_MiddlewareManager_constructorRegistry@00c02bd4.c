...
/* js_cocos2dx_editor_support_MiddlewareManager_constructorRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_editor_support_MiddlewareManager_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Object *)
         se::Object::_createJSObject
                   (__jsb_cocos2d_middleware_MiddlewareManager_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_cocos2d_middleware_MiddlewareManager_finalizeRegistry);
  se::State::State(aSStack_60,this,(vector *)&local_a0);
  this_00 = operator_new(0x50,(nothrow_t *)&std::nothrow);
  if (this_00 != (MiddlewareManager *)0x0) {
