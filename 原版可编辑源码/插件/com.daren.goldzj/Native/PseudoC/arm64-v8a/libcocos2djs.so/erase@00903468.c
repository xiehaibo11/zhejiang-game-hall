...
/* se::NonRefNativePtrCreatedByCtorMap::erase(std::__ndk1::__hash_map_iterator<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<void*,
   bool>, void*>*> >) */

undefined8 se::NonRefNativePtrCreatedByCtorMap::erase(undefined8 *param_1)
