...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::String>,
   ...
   v8::internal::Handle<v8::internal::Object> > > >::rehash(unsigned long) */
...
::rehash(__hash_table<std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::String>,v8::internal::Handle<v8::internal::Object>>,std::__ndk1::__unordered_map_hasher<v8::internal::Handle<v8::internal::String>,std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::String>,v8::internal::Handle<v8::internal::Object>>,v8::internal::StringHandleHash,true>,std::__ndk1::__unordered_map_equal<v8::internal::Handle<v8::internal::String>,std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::String>,v8::internal::Handle<v8::internal::Object>>,v8::internal::StringHandleEqual,true>,v8::internal::ZoneAllocator<std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::String>,v8::internal::Handle<v8::internal::Object>>>>
         *this,ulong param_1)

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      if (uVar1 < uVar2) goto LAB_0112f6e4;
    }
    return;
  }
LAB_0112f6e4:
