...
/* void 
   v8::internal::Code::BodyDescriptor::IterateBody<v8::internal::IterateAndScavengePromotedObjectsVisitor>(v8::internal::Map,
   v8::internal::HeapObject, v8::internal::IterateAndScavengePromotedObjectsVisitor*) */

void v8::internal::Code::BodyDescriptor::
     IterateBody<v8::internal::IterateAndScavengePromotedObjectsVisitor>
               (undefined8 param_1,ulong param_2,ObjectVisitor *param_3)
    ...
    while( true ) {
      if ((uVar2 & 1) != 0) {
        ...
        if ((*(byte *)(uVar4 + 8) >> 3 & 1) == 0) {
          if ((param_3[0x10] != (ObjectVisitor)0x0) && ((*(byte *)(uVar4 + 8) >> 6 & 1) != 0)) {
      ...
      puVar1 = puVar1 + 1;
      if ((uint *)(param_2 + 0x13) <= puVar1) break;
      uVar2 = *puVar1;
    }
  }
  RelocIterator::RelocIterator(aRStack_80,param_2,1999);
  ObjectVisitor::VisitRelocInfo(param_3,aRStack_80);
  return;
}
