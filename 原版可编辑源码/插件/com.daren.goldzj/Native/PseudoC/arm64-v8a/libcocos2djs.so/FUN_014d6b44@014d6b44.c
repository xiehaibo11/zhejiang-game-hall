...
ulong FUN_014d6b44(undefined8 param_1,Factory *param_2,undefined8 param_3)
  ...
  if (iVar3 != 0) {
    while( true ) {
      ...
      if ((uVar1 & 9) == 8) {
        ...
        if (puVar6 == (ulong *)0x0) goto LAB_014d6ccc;
        local_48 = *puVar4;
        pcVar7 = (char *)v8::internal::String::GetFlatContent
                                   ((PerThreadAssertScopeDebugOnly *)&local_48);
        local_24[0] = false;
        iVar2 = v8::internal::FastAsciiConvert<false>((char *)(*puVar6 + 0xb),pcVar7,iVar3,local_24)
        ;
        if (iVar2 == iVar3) {
          if (local_24[0] != false) {
            puVar4 = puVar6;
...
LAB_014d6ccc:
    ...
    uVar5 = FUN_014d6d40(param_2,*puVar4,*puVar8,iVar3,param_3);
    iVar3 = (int)uVar5;
    if (((uVar5 & 1) == 0) ||
      ...
      if (puVar8 == (undefined8 *)0x0) {
        ...
        uVar5 = FUN_014d6d40(param_2,*puVar4,*puVar8,iVar2,param_3);
      }
    }
  }
  return uVar5;
