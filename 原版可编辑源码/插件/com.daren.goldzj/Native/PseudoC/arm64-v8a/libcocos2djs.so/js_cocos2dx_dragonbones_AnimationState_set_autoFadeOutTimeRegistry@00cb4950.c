...
/* js_cocos2dx_dragonbones_AnimationState_set_autoFadeOutTimeRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_AnimationState_set_autoFadeOutTimeRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1227,&DAT_0192a4d8);
    pcVar8 = "js_cocos2dx_dragonbones_AnimationState_set_autoFadeOutTime : Invalid Native Object";
  }
  else {
    local_74 = 0.0;
    ...
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x122c,&DAT_0192a4d8);
    pcVar8 = 
    "js_cocos2dx_dragonbones_AnimationState_set_autoFadeOutTime : Error processing new value";
  }
