...
/* js_cocos2dx_spine_IkConstraintData_setCompressRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_IkConstraintData_setCompressRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (IkConstraintData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x15ff,"js_cocos2dx_spine_IkConstraintData_setCompress");
    pcVar6 = "js_cocos2dx_spine_IkConstraintData_setCompress : Invalid Native Object";
LAB_00c39394:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::IkConstraintData::setCompress(this,local_64[0]);
        goto LAB_00c393cc;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1606,"js_cocos2dx_spine_IkConstraintData_setCompress");
      pcVar6 = "js_cocos2dx_spine_IkConstraintData_setCompress : Error processing arguments";
      goto LAB_00c39394;
    }
    __android_log_print(6,"jswrapper",&DAT_01903796,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_IkConstraintData_setCompress",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x160d);
LAB_00c393cc:
