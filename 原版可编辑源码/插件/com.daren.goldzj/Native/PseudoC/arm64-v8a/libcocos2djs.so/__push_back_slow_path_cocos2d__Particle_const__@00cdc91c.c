...
/* void std::__ndk1::vector<cocos2d::Particle*, std::__ndk1::allocator<cocos2d::Particle*>
   >::__push_back_slow_path<cocos2d::Particle* const&>(cocos2d::Particle* const&) */

void __thiscall
std::__ndk1::vector<cocos2d::Particle*,std::__ndk1::allocator<cocos2d::Particle*>>::
__push_back_slow_path<cocos2d::Particle*const&>
          (vector<cocos2d::Particle*,std::__ndk1::allocator<cocos2d::Particle*>> *this,
          Particle **param_1)
...
LAB_00cdc980:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00cdc980;
  }
  else {
