...
/* register_all_engine(se::Object*) */

undefined8 register_all_engine(Object *param_1)

{
  ...
  js_register_engine_CanvasGradient(pOVar3);
  js_register_engine_LabelRenderer(pOVar3);
  js_register_engine_CanvasRenderingContext2D(pOVar3);
  js_register_engine_Device(pOVar3);
  js_register_engine_SAXParser(pOVar3);
  js_register_engine_FileUtils(pOVar3);
  se::Value::~Value(aVStack_38);
