...
void FUN_01448ffc(ulong param_1,undefined8 param_2,undefined8 param_3,long param_4,
...
LAB_01449178:
    ...
    if (*(short *)(in_x9 + 7) != 0x43) goto LAB_01449178;
    if ((param_1 & 1) == 0) {
      uVar4 = 0x1e;
    }
      ...
      if (*(short *)(unaff_x26 + (ulong)*(uint *)(param_1 - 1) + 7) != 0x43) goto LAB_01449178;
      uVar4 = 0x1e;
    }
  }
...
LAB_01448f14:
  ...
  (**(code **)(unaff_x21 + (ulong)*(byte *)(*(long *)(param_4 + -0x18) + unaff_x19 + 5) * 8))(uVar3)
  ;
  return;
}
