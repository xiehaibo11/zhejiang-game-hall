...
void FUN_0098f0f0(long param_1,char *param_2)

{
  ...
  boolean_to_seval(cVar1 != '\0',local_78);
  ...
  if ((uVar7 & 1) == 0) {
    se::ScriptEngine::getInstance();
                    /* try { // try from 0098f19c to 00a8f327 has its CatchHandler @ 0098f19c
                       catch() { ... } // from try @ 0098f19c with catch @ 0098f19c
                       catch() { ... } // from try @ 0098f32c with catch @ 0098f19c
                       catch() { ... } // from try @ 0098f3c0 with catch @ 0098f19c */
    se::ScriptEngine::clearException();
  }
  se::Value::~Value(aVStack_48);
  pVVar4 = local_78;
