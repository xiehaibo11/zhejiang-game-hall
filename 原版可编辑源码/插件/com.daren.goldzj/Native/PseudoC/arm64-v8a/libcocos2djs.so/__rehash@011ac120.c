...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<v8::internal::JSGlobalObject,char_const*>,std::__ndk1::__unordered_map_hasher<v8::internal::JSGlobalObject,std::__ndk1::__hash_value_type<v8::internal::JSGlobalObject,char_const*>,v8::internal::Object::Hasher,true>,std::__ndk1::__unordered_map_equal<v8::internal::JSGlobalObject,std::__ndk1::__hash_value_type<v8::internal::JSGlobalObject,char_const*>,std::__ndk1::equal_to<v8::internal::JSGlobalObject>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<v8::internal::JSGlobalObject,char_const*>>>
           *this,ulong param_1)
