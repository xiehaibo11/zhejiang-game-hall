...

{
  ...
  do {
    if (uVar2 == 0) goto LAB_010f7d28;
    uVar8 = 0;
    bVar16 = true;
    do {
      while( true ) {
        uVar6 = *(uint *)(*(ulong *)this + (long)((int)uVar8 * 8 + 0xc) + 7);
        if ((uVar6 != *(uint *)(param_2 + 0x28)) && (uVar6 != *(uint *)(param_2 + 0x20))) break;
LAB_010f7b78:
        uVar8 = uVar8 + 1;
        if (uVar14 <= uVar8) goto LAB_010f7b58;
      }
      ...
      if (1 < uVar15) {
        iVar9 = 0;
        do {
          if (uVar12 == uVar8) goto LAB_010f7b78;
          iVar1 = (int)uVar12 + iVar9;
          iVar9 = iVar9 + 1;
          uVar12 = (ulong)(iVar1 + 1U & uVar5);
        } while (iVar13 != iVar9);
      }
      if (uVar8 == uVar12) goto LAB_010f7b78;
      uVar6 = *(uint *)(uVar11 + (long)((int)uVar12 * 8 + 0xc) + 7);
      if ((uVar6 != *(uint *)(param_2 + 0x28)) && (uVar6 != *(uint *)(param_2 + 0x20))) {
        ...
        if (1 < uVar15) {
          iVar9 = 0;
          do {
            if (uVar11 == uVar12) goto LAB_010f7b74;
