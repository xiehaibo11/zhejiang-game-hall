...
/* void std::__ndk1::vector<v8::internal::BreakLocation,
   std::__ndk1::allocator<v8::internal::BreakLocation>
   >::__push_back_slow_path<v8::internal::BreakLocation>(v8::internal::BreakLocation&&) */

void __thiscall
std::__ndk1::vector<v8::internal::BreakLocation,std::__ndk1::allocator<v8::internal::BreakLocation>>
::__push_back_slow_path<v8::internal::BreakLocation>
          (vector<v8::internal::BreakLocation,std::__ndk1::allocator<v8::internal::BreakLocation>>
           *this,BreakLocation *param_1)

{
  ...
  if (uVar1 < 0xaaaaaaaaaaaaaab) {
    ...
    if (uVar1 == 0) {
      ...
      if (0xaaaaaaaaaaaaaaa < uVar1) goto LAB_00f0e98c;
