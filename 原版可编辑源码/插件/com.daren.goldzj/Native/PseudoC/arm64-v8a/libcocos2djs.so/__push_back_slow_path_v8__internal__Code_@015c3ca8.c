...
/* void std::__ndk1::vector<v8::internal::Code, std::__ndk1::allocator<v8::internal::Code>
   >::__push_back_slow_path<v8::internal::Code>(v8::internal::Code&&) */

void __thiscall
std::__ndk1::vector<v8::internal::Code,std::__ndk1::allocator<v8::internal::Code>>::
__push_back_slow_path<v8::internal::Code>
          (vector<v8::internal::Code,std::__ndk1::allocator<v8::internal::Code>> *this,Code *param_1
          )

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_015c3d90;
