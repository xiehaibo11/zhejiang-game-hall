...
undefined8 FUN_00b77db0(char *param_1,int param_2,long param_3)
...
LAB_00b77de4:
    ...
    if (param_2 == 0) {
      ...
      else if (*(int *)(param_3 + 0x14) != iVar5) goto LAB_00b77de4;
      ...
      do {
        ...
        if ((int)uVar3 < 0) goto LAB_00b77de4;
        param_2 = param_2 + -1;
        param_1 = param_1 + 1;
      ...
      *puVar1 = (char)(uVar6 >> 4);
      ...
      if ((((0xc < iVar5) || (param_1[param_2] != '\0')) ||
          ...
          iVar2 != 4)) || (0xff < (local_38 | uStack_34 | uStack_44 | local_48))) goto LAB_00b77de4;
      puVar1 = (undefined1 *)(param_3 + iVar5);
