...
/* JSB_glGetActiveUniformRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glGetActiveUniformRegistry(FunctionCallbackInfo *param_1)
  ...
  if ((puVar6[1] - (long)pVVar7 & 0xffffffff0U) == 0x20) {
    ...
    if ((!bVar3 & bVar4) == 0) {
      ...
      if (-1 < local_84) {
        ...
        glGetProgramiv(uVar12,0x8b87,&local_88);
        ...
        local_90 = -1;
        local_8c = -1;
        glGetActiveUniform(uVar12,local_84,local_88,0,&local_8c,&local_90,pcVar10);
