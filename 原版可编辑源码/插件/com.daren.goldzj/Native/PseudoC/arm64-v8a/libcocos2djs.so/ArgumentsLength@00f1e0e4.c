...
/* v8::internal::Translation::ArgumentsLength(v8::internal::CreateArgumentsType) */

void __thiscall v8::internal::Translation::ArgumentsLength(Translation *this,uint param_2)
