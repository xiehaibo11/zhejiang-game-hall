...
/* void std::__ndk1::vector<std::__ndk1::pair<v8::internal::HeapObject, v8::internal::Page*>,
   std::__ndk1::allocator<std::__ndk1::pair<v8::internal::HeapObject, v8::internal::Page*> >
   >::__push_back_slow_path<std::__ndk1::pair<v8::internal::HeapObject, v8::internal::Page*>
   >(std::__ndk1::pair<v8::internal::HeapObject, v8::internal::Page*>&&) */
...

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_00fed098;
