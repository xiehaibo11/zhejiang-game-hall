...
/* se::NativePtrToObjectMap::erase(void*) */

void se::NativePtrToObjectMap::erase(void *param_1)

{
  ...
  uVar4 = __nativePtrToObjectMap[1];
  if (uVar4 != 0) {
    ...
    plVar8 = *(long **)(*__nativePtrToObjectMap + uVar7 * 8);
    if (plVar8 != (long *)0x0) {
