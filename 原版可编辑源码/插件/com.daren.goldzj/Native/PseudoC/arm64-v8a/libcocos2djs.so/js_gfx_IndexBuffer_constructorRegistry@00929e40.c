...
/* js_gfx_IndexBuffer_constructorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_gfx_IndexBuffer_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Object *)
         se::Object::_createJSObject
                   (__jsb_cocos2d_renderer_IndexBuffer_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_cocos2d_renderer_IndexBuffer_finalizeRegistry);
  se::State::State(aSStack_60,this,(vector *)&local_a0);
  this_00 = operator_new(0x60,(nothrow_t *)&std::nothrow);
  if (this_00 != (IndexBuffer *)0x0) {
    cocos2d::renderer::IndexBuffer::IndexBuffer(this_00);
  }
