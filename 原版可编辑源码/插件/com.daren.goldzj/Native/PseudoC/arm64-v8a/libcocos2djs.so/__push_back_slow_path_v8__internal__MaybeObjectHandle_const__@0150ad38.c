...
/* void std::__ndk1::vector<v8::internal::MaybeObjectHandle,
   std::__ndk1::allocator<v8::internal::MaybeObjectHandle>
   >::__push_back_slow_path<v8::internal::MaybeObjectHandle const&>(v8::internal::MaybeObjectHandle
   const&) */
...
__push_back_slow_path<v8::internal::MaybeObjectHandle_const&>
          (vector<v8::internal::MaybeObjectHandle,std::__ndk1::allocator<v8::internal::MaybeObjectHandle>>
           *this,MaybeObjectHandle *param_1)

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_0150ae24;
