...

{
  ...
  if (conf == (lhash_st_CONF_VALUE *)0x0) {
    ...
    if (pcVar3 != (char *)0x0) {
      ...
      pcVar1 = (code *)SoftwareBreakpoint(1,0xb01104);
      (*pcVar1)();
    }
    ERR_put_error(0xe,0x6d,0x6a,"crypto/conf/conf_lib.c",0x110);
  }
  else {
                    /* try { // try from 00b00fdc to 00c0100f has its CatchHandler @ 00b01028 */
    ...
    pcVar3 = _CONF_get_string(&local_48,group,name);
                    /* try { // try from 00b01010 to 00c01043 has its CatchHandler @ 00b00dd8 */
    if (pcVar3 != (char *)0x0) {
                    /* catch() { ... } // from try @ 00b00fdc with catch @ 00b01028 */
      ...
      while (iVar2 != 0) {
        ...
        iVar2 = (*(local_48.meth)->is_number)(&local_48,pcVar3[1]);
                    /* try { // try from 00b0106c to 00c01143 has its CatchHandler @ 00b0106c
                       catch() { ... } // from try @ 00b0106c with catch @ 00b0106c
                       catch() { ... } // from try @ 00b01160 with catch @ 00b0106c */
        pcVar3 = pcVar3 + 1;
      }
      return lVar4;
    }
