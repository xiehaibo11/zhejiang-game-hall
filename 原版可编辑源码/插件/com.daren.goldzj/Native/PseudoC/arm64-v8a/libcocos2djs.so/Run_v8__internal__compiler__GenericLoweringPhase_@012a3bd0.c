...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::GenericLoweringPhase>() */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::GenericLoweringPhase>
          (PipelineImpl *this)

{
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFGenericLowering");
  GenericLoweringPhase::Run(aGStack_18,pPVar5,pZVar2);
