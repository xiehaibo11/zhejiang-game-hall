...
/* register_all_webview(se::Object*) */

undefined8 register_all_webview(Object *param_1)

{
  ...
  js_register_webview_WebView(pOVar3);
  se::Value::~Value(aVStack_38);
  if (*(long *)(lVar1 + 0x28) == local_28) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 009874a8 with catch @ 00987430
                       catch(type#1 @ 00000000) { ... } // from try @ 00987534 with catch @ 00987430
                        */
    return 1;
  }
