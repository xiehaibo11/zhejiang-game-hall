...
/* void 
   std::__ndk1::vector<v8::internal::ParserBase<v8::internal::Parser>::DeclarationParsingResult::Declaration,
   std::__ndk1::allocator<v8::internal::ParserBase<v8::internal::Parser>::DeclarationParsingResult::Declaration>
   >::__push_back_slow_path<v8::internal::ParserBase<v8::internal::Parser>::DeclarationParsingResult::Declaration
   const&>(v8::internal::ParserBase<v8::internal::Parser>::DeclarationParsingResult::Declaration
   const&) */
...

{
  ...
  if (uVar1 < 0xaaaaaaaaaaaaaab) {
    ...
    if (uVar1 == 0) {
      ...
      if (0xaaaaaaaaaaaaaaa < uVar1) goto LAB_0116e950;
