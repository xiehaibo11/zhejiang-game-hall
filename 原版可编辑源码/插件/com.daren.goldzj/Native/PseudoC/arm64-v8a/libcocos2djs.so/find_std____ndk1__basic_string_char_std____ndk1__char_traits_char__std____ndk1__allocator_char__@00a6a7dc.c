...

{
  ...
  long local_68;
                    ...
                    /* try { // try from 00a6a7e4 to 00b6a7eb has its CatchHandler @ 00a6a9f4 */
  lVar5 = tpidr_el0;
  local_68 = *(long *)(lVar5 + 0x28);
  uVar7 = *(ulong *)(param_1 + 8);
  pbVar2 = *(basic_string **)(param_1 + 0x10);
                    /* try { // try from 00a6a81c to 00b6a8bf has its CatchHandler @ 00a6aacc */
  if (((byte)*param_1 & 1) == 0) {
    pbVar2 = param_1 + 1;
      ...
      if (plVar8 != (long *)0x0) {
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (sVar1 == __n) {
                    /* try { // try from 00a6a8c0 to 00b6a9af has its CatchHandler @ 00a6a650 */
              __s1 = (void *)plVar8[4];
              if ((bVar3 & 1) == 0) {
            ...
            if ((uVar14 & uVar13) == 0) {
              ...
              if (uVar9 - uVar4 * uVar13 == uVar15) goto LAB_00a6a930;
              goto LAB_00a6a954;
            }
            if (uVar9 != uVar15) goto LAB_00a6a954;
          }
LAB_00a6a930:
          plVar8 = (long *)*plVar8;
