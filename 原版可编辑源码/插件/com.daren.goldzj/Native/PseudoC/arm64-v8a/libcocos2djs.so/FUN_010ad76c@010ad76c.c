...
void FUN_010ad76c(undefined8 param_1,ulong *param_2,long *param_3)
...
switchD_010ad82c_caseD_1:
    bVar8 = bVar4;
    goto switchD_010ad82c_caseD_0;
  }
  bVar8 = 1;
  bVar11 = 7;
  switch(bVar4) {
  ...
  case 4:
    ...
    break;
  case 6:
    goto switchD_010ad82c_caseD_6;
  }
switchD_010ad82c_caseD_0:
  bVar11 = bVar8;
  if (bVar3 != bVar8) {
switchD_010ad82c_caseD_6:
    ...
    if ((uVar1 == *(uint *)(pIVar9 + 0x168)) || (((bVar2 & 0xf0) == 0x20) == ((bVar11 & 0x1e) == 4))
      ...
      puVar6 = (ulong *)FUN_010ae7ac(param_2,puVar5,bVar3,
                                     *(int *)((*param_2 & 0xffffffff00000000 | (ulong)uVar1) + 3) >>
                                     1);
