...
/* void std::__ndk1::vector<long, std::__ndk1::allocator<long>
   >::__push_back_slow_path<long>(long&&) */

void __thiscall
std::__ndk1::vector<long,std::__ndk1::allocator<long>>::__push_back_slow_path<long>
          (vector<long,std::__ndk1::allocator<long>> *this,long *param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00f2868c;
