...
void FUN_00d92c3c(long *param_1)
...
LAB_00d92e1c:
      ...
      FUN_00d935f0(param_1);
      FUN_00d935f0(param_1,piVar26);
      uVar39 = uVar39 + 1;
    } while ((long)uVar39 < (long)iVar38);
    iVar38 = (int)uVar39;
    if (iVar38 < 1) goto LAB_00d931b8;
  }
  iVar38 = (int)uVar39;
  uVar20 = 0;
  do {
...
LAB_00d93154:
      ...
      iVar21 = piVar26[2];
      if (piVar26[3] < iVar21) goto LAB_00d93154;
      iVar5 = piVar26[4];
      lVar22 = (long)iVar5;
      lVar23 = (long)piVar26[5];
      if (piVar26[5] < iVar5) goto LAB_00d93154;
      lVar41 = lVar22;
      if (lVar22 <= lVar23) {
        lVar41 = lVar23;
      }
...
LAB_00d930cc:
            ...
            if (uVar32 != uVar11) goto LAB_00d930cc;
          }
