...
/* cocos2d::AudioPlayerProvider::AudioPlayerProvider(SLEngineItf_ const* const*, SLObjectItf_ const*
...

{
  ...
  PcmAudioService *this_01;
                    ...
                    /* try { // try from 00a72fcc to 00b73007 has its CatchHandler @ 00a73100 */
  ...
  *(undefined4 *)(this + 0x78) = 0x3f800000;
                    /* try { // try from 00a73078 to 00b730bb has its CatchHandler @ 00a730d8 */
  ...
  *(undefined8 *)(this + 0x160) = uVar3;
  __android_log_print(4,"AudioPlayerProvider","deviceSampleRate: %d, bufferSizeInFrames: %d",
                    ...
                    /* try { // try from 00a730bc to 00b73157 has its CatchHandler @ 00a72ed0 */
  if (DAT_01d1b788 < 1) {
    iVar1 = getSDKVersion();
    if (iVar1 < 1) {
  ...
  if (DAT_01d1b788 < 0x11) {
                    /* try { // try from 00a731ac to 00b731c3 has its CatchHandler @ 00a733e4 */
    return;
  }
                    /* catch() { ... } // from try @ 00a72f44 with catch @ 00a730d4 */
                    /* catch() { ... } // from try @ 00a72f9c with catch @ 00a730d8
                       catch() { ... } // from try @ 00a73078 with catch @ 00a730d8 */
  this_00 = operator_new(0x70,(nothrow_t *)&std::nothrow);
  if (this_00 != (AudioMixerController *)0x0) {
                    /* catch() { ... } // from try @ 00a72f24 with catch @ 00a730f0 */
    AudioMixerController::AudioMixerController
              (this_00,*(int *)(this + 0x1c),*(int *)(this + 0x18),2);
  }
                    /* catch() { ... } // from try @ 00a72f5c with catch @ 00a73100
                       catch() { ... } // from try @ 00a72fcc with catch @ 00a73100 */
  ...
  *(PcmAudioService **)(this + 0x150) = this_01;
                    /* try { // try from 00a73158 to 00b731ab has its CatchHandler @ 00a73158
                       catch() { ... } // from try @ 00a73158 with catch @ 00a73158
                       catch() { ... } // from try @ 00a7334c with catch @ 00a73158 */
