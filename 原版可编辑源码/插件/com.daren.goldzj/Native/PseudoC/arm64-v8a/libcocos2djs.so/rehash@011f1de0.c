...
/* std::__ndk1::__hash_table<v8::internal::Object, v8::internal::Object::Hasher,
...
::rehash(__hash_table<v8::internal::Object,v8::internal::Object::Hasher,std::__ndk1::equal_to<v8::internal::Object>,std::__ndk1::allocator<v8::internal::Object>>
         *this,ulong param_1)

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      if (uVar1 < uVar2) goto LAB_011f1ea4;
    }
    return;
  }
LAB_011f1ea4:
