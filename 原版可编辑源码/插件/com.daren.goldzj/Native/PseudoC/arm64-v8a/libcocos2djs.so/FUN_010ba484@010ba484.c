...
ulong * FUN_010ba484(undefined8 param_1,Factory *param_2,ulong *param_3,uint param_4)

{
  ...
  if (param_4 != 0) {
    ...
    do {
      uVar4 = *param_3;
      puVar3 = (ulong *)v8::internal::Factory::NewNumberFromInt
                                  ((Factory *)(uVar4 & 0xffffffff00000000),
                                   *(int *)(*(long *)(uVar4 + 0x27) + (ulong)*(uint *)(uVar4 + 0x2f)
                                           + lVar7));
      uVar6 = *puVar2;
      uVar4 = *puVar3;
