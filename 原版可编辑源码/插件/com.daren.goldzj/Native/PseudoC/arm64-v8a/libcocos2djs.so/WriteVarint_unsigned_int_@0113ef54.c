...
/* void v8::internal::ValueSerializer::WriteVarint<unsigned int>(unsigned int) */

void __thiscall
v8::internal::ValueSerializer::WriteVarint<unsigned_int>(ValueSerializer *this,uint param_1)

{
  ...
  *pbVar7 = bVar4 & 0x7f;
  ...
  __n = (long)(pbVar7 + 1) - (long)local_50;
  uVar1 = lVar2 + __n;
  ...
  if (__n != 0) {
    memcpy((void *)((long)pvVar6 + lVar2),local_50,__n);
  }
LAB_0113efd0:
