...
void FUN_00a23020(long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  FUN_00a0d3ac(__s,0x4000,param_2,&local_70);
  if ((*(long *)(param_1 + 0x230) == 0) || (*(char *)(param_1 + 0x8b60) != '\0')) {
    cVar1 = *(char *)(param_1 + 0x628);
  }
  else {
    FUN_00a0e7c4(*(long *)(param_1 + 0x230),0x100,"%s",__s);
