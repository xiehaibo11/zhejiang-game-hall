...
/* v8::internal::compiler::NativeContextRef::number_function() const */

undefined1  [16] __thiscall
v8::internal::compiler::NativeContextRef::number_function(NativeContextRef *this)

{
  ...
  if (*(int *)(*(undefined8 **)this + 1) == 2) {
    ...
    uVar7 = uVar7 & 0xffffffff00000000 | (ulong)*(uint *)(uVar7 + 0x1ef);
  ...
  if (*(int *)(puVar6 + 1) == 2) {
    uVar7 = *(ulong *)*puVar6;
    if ((uVar7 & 1) == 0) goto LAB_01727ffc;
    sVar1 = *(short *)((uVar7 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar7 - 1));
  }
  else {
    if (*(int *)(puVar6 + 1) == 0) goto LAB_01727ffc;
