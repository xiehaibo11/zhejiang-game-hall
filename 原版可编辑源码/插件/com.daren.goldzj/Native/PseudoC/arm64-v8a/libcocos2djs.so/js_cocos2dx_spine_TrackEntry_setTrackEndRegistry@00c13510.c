...
/* js_cocos2dx_spine_TrackEntry_setTrackEndRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_TrackEntry_setTrackEndRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TrackEntry *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x105,"js_cocos2dx_spine_TrackEntry_setTrackEnd");
    puVar6 = &DAT_018f1064;
LAB_00c13684:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::TrackEntry::setTrackEnd(this,local_64);
        goto LAB_00c136bc;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x10c,"js_cocos2dx_spine_TrackEntry_setTrackEnd");
      puVar6 = &DAT_018f10a5;
      goto LAB_00c13684;
    }
    __android_log_print(6,"jswrapper",&DAT_018f10eb,uVar7 >> 4,1);
  }
