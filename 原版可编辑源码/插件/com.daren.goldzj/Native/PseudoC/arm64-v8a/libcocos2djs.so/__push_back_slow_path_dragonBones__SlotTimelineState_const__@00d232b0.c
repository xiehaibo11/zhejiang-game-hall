...
/* void std::__ndk1::vector<dragonBones::SlotTimelineState*,
   std::__ndk1::allocator<dragonBones::SlotTimelineState*>
   >::__push_back_slow_path<dragonBones::SlotTimelineState* const&>(dragonBones::SlotTimelineState*
   const&) */
...
__push_back_slow_path<dragonBones::SlotTimelineState*const&>
          (vector<dragonBones::SlotTimelineState*,std::__ndk1::allocator<dragonBones::SlotTimelineState*>>
           *this,SlotTimelineState **param_1)
...
LAB_00d23314:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d23314;
  }
  else {
