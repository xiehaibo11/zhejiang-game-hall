...
/* Vec4_to_seval(cocos2d::Vec4 const&, se::Value*) */

undefined8 Vec4_to_seval(Vec4 *param_1,Value *param_2)

{
  ...
  se::Object::setProperty(pOVar2,"z",aVStack_48);
  se::Value::~Value(aVStack_48);
  se::Value::Value(aVStack_48,*(float *)(param_1 + 0xc));
  se::Object::setProperty(local_50,"w",aVStack_48);
  se::Value::~Value(aVStack_48);
