...
/* void 
   v8::internal::LocalArrayBufferTracker::Free<v8::internal::ArrayBufferTracker::FreeDead<v8::internal::MajorNonAtomicMarkingState>(v8::internal::Page*,
   v8::internal::MajorNonAtomicMarkingState*)::{lambda(v8::internal::JSArrayBuffer)#1}>(v8::internal::ArrayBufferTracker::FreeDead<v8::internal::MajorNonAtomicMarkingState>(v8::internal::Page*,
   v8::internal::MajorNonAtomicMarkingState*)::{lambda(v8::internal::JSArrayBuffer)#1}) */
  ...
  if (plVar6 != (long *)0x0) {
    ...
    do {
      while( true ) {
        ...
        if ((*(uint *)(*(long *)((uVar7 & 0xfffffffffffc0000) + 0x10) + (uVar8 >> 7 & 0x1ffffff) * 4
                      ) >> (ulong)((uint)(uVar8 >> 2) & 0x1f) & 1) != 0) break;
        plVar6 = (long *)*plVar6;
        std::__ndk1::
        ...
        if (plVar6 == (long *)0x0) goto LAB_00fa3f04;
      }
      plVar6 = (long *)*plVar6;
