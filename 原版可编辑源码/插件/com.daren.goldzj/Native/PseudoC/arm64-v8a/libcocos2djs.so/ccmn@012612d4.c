...
/* v8::internal::Assembler::ccmn(v8::internal::Register const&, v8::internal::Operand const&,
   v8::internal::StatusFlags, v8::internal::Condition) */

void __thiscall
v8::internal::Assembler::ccmn(Assembler *this,ulong *param_1,char *param_2,uint param_4,int param_5)
