...
uint FUN_010aad6c(undefined8 param_1,ulong *param_2,KeyAccumulator *param_3,undefined4 param_4)

{
  ...
  if (iVar1 == 0) {
LAB_010aae74:
    uVar3 = FUN_0108c4d4(param_2,param_3,param_4);
  }
  else {
    iVar7 = 0;
    while( true ) {
      ...
      if ((uVar6 & 1) == 0) break;
      if (iVar1 + -1 == iVar7) goto LAB_010aae74;
      uVar6 = *puVar4;
      iVar7 = iVar7 + 1;
    }
    uVar3 = 0;
