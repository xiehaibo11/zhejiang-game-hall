...
/* v8::internal::compiler::GraphAssembler::Float64Abs(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Float64Abs(GraphAssembler *this,Node *param_1)
