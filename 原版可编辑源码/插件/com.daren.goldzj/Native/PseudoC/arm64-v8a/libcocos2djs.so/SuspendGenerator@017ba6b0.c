...
/* v8::internal::interpreter::BytecodeArrayBuilder::SuspendGenerator(v8::internal::interpreter::Register,
   v8::internal::interpreter::RegisterList, int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::SuspendGenerator
