...
LAB_017fbc70:
  ...
  if ((param_2 == (long *)0x0) || (param_2[3] != param_2[4])) {
    if (param_3 != (long *)0x0) goto LAB_017fbc84;
LAB_017fbccc:
    param_3 = (long *)0x0;
    if (plVar17 == (long *)0x0) goto LAB_017fbdbc;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_017fbccc;
LAB_017fbc84:
...
LAB_017fbdbc:
  ...
  uVar6 = FUN_01828db4(pcVar19,local_168,param_5,iVar5);
  *param_6 = uVar6;
  uVar7 = (ulong)((byte)local_148[0] >> 1);
  if (((byte)local_148[0] & 1) != 0) {
    uVar7 = local_140;
  ...
  if (uVar7 != 0) {
    ...
    if (local_12c < puVar9) {
      ...
      do {
        if ((bVar16) && (*puVar15 != uVar10)) goto LAB_017fbf10;
...
LAB_017fbf10:
  ...
  if ((plVar17 == (long *)0x0) || (plVar17[3] != plVar17[4])) {
    if (param_3 != (long *)0x0) goto LAB_017fbf2c;
LAB_017fbfd8:
    if (plVar18 != (long *)0x0) goto LAB_017fbf60;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_017fbfd8;
LAB_017fbf2c:
