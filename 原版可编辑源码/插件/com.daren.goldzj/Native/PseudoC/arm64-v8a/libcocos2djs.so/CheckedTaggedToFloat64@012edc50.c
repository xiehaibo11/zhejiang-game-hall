...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CheckedTaggedToFloat64(v8::internal::compiler::CheckTaggedInputMode,
   v8::internal::compiler::FeedbackSource const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::CheckedTaggedToFloat64
...

{
  ...
  if ((*param_3 == 0) || ((int)param_3[1] == -1)) {
    if (param_2 == (Operator)0x1) {
      ...
      if (param_2 != (Operator)0x0) goto LAB_012edca8;
      lVar4 = *(long *)this;
      lVar5 = 0x3128;
    }
...
LAB_012edca8:
    ...
    Operator::Operator(pOVar2,0x6b,0x38,"CheckedTaggedToFloat64",1,1,1,1,1,0);
    pOVar2[0x30] = param_2;
