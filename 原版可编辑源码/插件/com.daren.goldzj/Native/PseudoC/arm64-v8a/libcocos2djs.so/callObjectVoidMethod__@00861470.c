...
/* void cocos2d::JniHelper::callObjectVoidMethod<>(_jobject*, std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&) */

void cocos2d::JniHelper::callObjectVoidMethod<>
...

{
  ...
  *puVar5 = 0;
  ...
  uVar6 = getMethodInfo((JniMethodInfo_ *)&local_78,(char *)pbVar8,(char *)pbVar9,pcVar1);
  if ((uVar6 & 1) == 0) {
    ...
    local_50 = (void *)0x0;
    local_40 = 0x3f800000;
    _JNIEnv::CallVoidMethod(local_78,(_jmethodID *)param_1,local_68);
