...
/* js_cocos2dx_spine_SkeletonData_setAudioPathRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_SkeletonData_setAudioPathRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2991,"js_cocos2dx_spine_SkeletonData_setAudioPath");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonData_setAudioPath : Invalid Native Object");
  }
  else {
    ...
    if (plVar5[1] - *plVar5 == 0x10) {
      ...
      spine::SkeletonData::setAudioPath(this,(String *)&local_88);
      pvVar4 = local_78;
      local_88 = &PTR__String_01c67868;
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 10652): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar5[1] - *plVar5) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonData_setAudioPath",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x299f);
LAB_00c60678:
