...
/* v8::internal::compiler::EffectControlLinearizer::LowerCheckReceiver(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerCheckReceiver
...

{
  ...
  pNVar3 = (Node *)GraphAssembler::Uint32Constant(this_00,0xa9);
  uVar4 = GraphAssembler::Uint32LessThanOrEqual(this_00,pNVar3,pNVar2);
  local_80 = 0;
  local_78 = 0xffffffff;
  GraphAssembler::DeoptimizeIfNot(this_00,0x16,&local_80,uVar4,param_2,1);
