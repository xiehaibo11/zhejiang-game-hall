...
/* v8::internal::ValueSerializer::WriteRawBytes(void const*, unsigned long) */

void __thiscall
v8::internal::ValueSerializer::WriteRawBytes(ValueSerializer *this,void *param_1,ulong param_2)

{
  ...
  if (param_2 != 0) {
    memcpy((void *)((long)pvVar3 + lVar2),param_1,param_2);
  }
  return;
}
