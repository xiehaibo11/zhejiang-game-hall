  ...
  *in_x8 = 0;
  ...
  if (__n < 0x17) {
    ...
    *(char *)in_x8 = (char)((int)__n << 1);
    if (__n == 0) goto LAB_009f989c;
  }
  else {
    uVar4 = __n + 0x10 & 0xfffffffffffffff0;
    __dest = operator_new(uVar4);
                    /* try { // try from 009f987c to 00af9883 has its CatchHandler @ 009f9c64 */
                    /* try { // try from 009f9884 to 00af9903 has its CatchHandler @ 009f9768 */
    in_x8[1] = __n;
