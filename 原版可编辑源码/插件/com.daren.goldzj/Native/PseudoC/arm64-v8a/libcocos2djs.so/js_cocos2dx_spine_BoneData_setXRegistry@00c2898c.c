...
/* js_cocos2dx_spine_BoneData_setXRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_BoneData_setXRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (BoneData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xcc8,"js_cocos2dx_spine_BoneData_setX");
    pcVar6 = "js_cocos2dx_spine_BoneData_setX : Invalid Native Object";
LAB_00c28b00:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::BoneData::setX(this,local_64);
        goto LAB_00c28b38;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0xccf,"js_cocos2dx_spine_BoneData_setX");
      pcVar6 = "js_cocos2dx_spine_BoneData_setX : Error processing arguments";
      goto LAB_00c28b00;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 3283): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_BoneData_setX",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0xcd6);
LAB_00c28b38:
