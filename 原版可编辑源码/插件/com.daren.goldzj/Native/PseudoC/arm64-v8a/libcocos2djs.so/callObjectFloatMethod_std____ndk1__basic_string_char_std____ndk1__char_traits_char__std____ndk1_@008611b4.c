...
/* float cocos2d::JniHelper::callObjectFloatMethod<std::__ndk1::basic_string<char,
...

{
  ...
  *puVar7 = 0;
  ...
  if ((uVar8 & 1) == 0) {
    ...
    fVar14 = (float)_JNIEnv::CallFloatMethod(p_Var3,param_1,uVar4,uVar9);
