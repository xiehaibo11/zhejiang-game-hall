...
/* void cocos2d::JniHelper::callObjectVoidMethod<float>(_jobject*, std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&, float) */

void cocos2d::JniHelper::callObjectVoidMethod<float>
...

{
  ...
  *puVar5 = 0;
  ...
  if ((uVar6 & 1) == 0) {
    ...
    local_60 = (void *)0x0;
    local_50 = 0x3f800000;
    _JNIEnv::CallVoidMethod(local_88,(_jmethodID *)param_1,(double)param_4,local_78);
