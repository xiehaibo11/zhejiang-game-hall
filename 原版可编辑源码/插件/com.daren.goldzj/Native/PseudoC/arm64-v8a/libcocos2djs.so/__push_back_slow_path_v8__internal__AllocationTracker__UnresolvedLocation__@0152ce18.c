...
/* void std::__ndk1::vector<v8::internal::AllocationTracker::UnresolvedLocation*,
   std::__ndk1::allocator<v8::internal::AllocationTracker::UnresolvedLocation*>
   >::__push_back_slow_path<v8::internal::AllocationTracker::UnresolvedLocation*>(v8::internal::AllocationTracker::UnresolvedLocation*&&)
    */
...
::__push_back_slow_path<v8::internal::AllocationTracker::UnresolvedLocation*>
          (vector<v8::internal::AllocationTracker::UnresolvedLocation*,std::__ndk1::allocator<v8::internal::AllocationTracker::UnresolvedLocation*>>
           *this,UnresolvedLocation **param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_0152cf00;
