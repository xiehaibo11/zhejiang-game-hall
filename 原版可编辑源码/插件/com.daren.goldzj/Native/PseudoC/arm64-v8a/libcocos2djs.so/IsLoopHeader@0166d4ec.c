...
/* v8::internal::compiler::BytecodeAnalysis::IsLoopHeader(int) const */

bool __thiscall
v8::internal::compiler::BytecodeAnalysis::IsLoopHeader(BytecodeAnalysis *this,int param_1)

{
  ...
  if (pBVar3 != (BytecodeAnalysis *)0x0) {
    ...
    if ((pBVar2 != pBVar1) && (*(int *)(pBVar2 + 0x20) <= param_1)) goto LAB_0166d528;
  }
  pBVar2 = pBVar1;
LAB_0166d528:
