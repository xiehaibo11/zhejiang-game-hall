...
/* js_cocos2dx_spine_Bone_setWorldXRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_setWorldXRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Bone *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x7a7,"js_cocos2dx_spine_Bone_setWorldX");
    puVar6 = &DAT_018f6e2e;
LAB_00c1f530:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Bone::setWorldX(this,local_64);
        goto LAB_00c1f568;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x7ae,"js_cocos2dx_spine_Bone_setWorldX");
      puVar6 = &DAT_018f6e67;
      goto LAB_00c1f530;
    }
    __android_log_print(6,"jswrapper",&DAT_018f6ea5,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_setWorldX",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x7b5);
LAB_00c1f568:
