...
/* v8::internal::Assembler::ins(v8::internal::VRegister const&, int, v8::internal::Register const&)
    */

void __thiscall
v8::internal::Assembler::ins(Assembler *this,VRegister *param_1,int param_2,Register *param_3)
