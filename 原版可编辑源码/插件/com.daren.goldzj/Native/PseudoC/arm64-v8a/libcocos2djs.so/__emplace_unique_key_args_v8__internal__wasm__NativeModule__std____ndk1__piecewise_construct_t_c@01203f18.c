...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<v8::internal::wasm::NativeModule*,
   ...
   std::__ndk1::allocator<v8::internal::wasm::WasmCode*> > >, void*>*>, bool>
   std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<v8::internal::wasm::NativeModule*,
   std::__ndk1::vector<v8::internal::wasm::WasmCode*,
   ...
   std::__ndk1::tuple<v8::internal::wasm::NativeModule*&&>, std::__ndk1::tuple<>
   >(v8::internal::wasm::NativeModule* const&, std::__ndk1::piecewise_construct_t const&,
   std::__ndk1::tuple<v8::internal::wasm::NativeModule*&&>&&, std::__ndk1::tuple<>&&) */
      ...
      for (pNVar7 = (NativeModule *)**(long **)(*param_1 + (long)unaff_x24 * 8);
        ...
        if (pNVar5 != pNVar9) {
          if (uVar6 < 2) {
            ...
            if (pNVar5 + -(uVar1 * (long)pNVar8) == unaff_x24) goto LAB_01203fdc;
            break;
          }
...
LAB_01203fdc:
  ...
  *(undefined8 *)(pNVar7 + 0x18) = 0;
  if ((pNVar8 == (NativeModule *)0x0) ||
    ...
    rehash((__hash_table<std::__ndk1::__hash_value_type<v8::internal::wasm::NativeModule*,std::__ndk1::vector<v8::internal::wasm::WasmCode*,std::__ndk1::allocator<v8::internal::wasm::WasmCode*>>>,std::__ndk1::__unordered_map_hasher<v8::internal::wasm::NativeModule*,std::__ndk1::__hash_value_type<v8::internal::wasm::NativeModule*,std::__ndk1::vector<v8::internal::wasm::WasmCode*,std::__ndk1::allocator<v8::internal::wasm::WasmCode*>>>,std::__ndk1::hash<v8::internal::wasm::NativeModule*>,true>,std::__ndk1::__unordered_map_equal<v8::internal::wasm::NativeModule*,std::__ndk1::__hash_value_type<v8::internal::wasm::NativeModule*,std::__ndk1::vector<v8::internal::wasm::WasmCode*,std::__ndk1::allocator<v8::internal::wasm::WasmCode*>>>,std::__ndk1::equal_to<v8::internal::wasm::NativeModule*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<v8::internal::wasm::NativeModule*,std::__ndk1::vector<v8::internal::wasm::WasmCode*,std::__ndk1::allocator<v8::internal::wasm::WasmCode*>>>>>
            *)param_1,uVar6);
    pNVar8 = param_1[1];
  ...
  if (pNVar9 == (NativeModule *)0x0) {
    ...
    *(NativeModule ***)(pNVar5 + (long)unaff_x24 * 8) = ppNVar4;
    if (*(long *)pNVar7 == 0) goto LAB_01204134;
