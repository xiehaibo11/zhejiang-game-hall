...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::HeapObject>,
   ...
   unsigned long> > >::__rehash(unsigned long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::HeapObject>,unsigned_long>,std::__ndk1::__unordered_map_hasher<v8::internal::Handle<v8::internal::HeapObject>,std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::HeapObject>,unsigned_long>,v8::internal::Handle<v8::internal::HeapObject>::hash,true>,std::__ndk1::__unordered_map_equal<v8::internal::Handle<v8::internal::HeapObject>,std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::HeapObject>,unsigned_long>,v8::internal::Handle<v8::internal::HeapObject>::equal_to,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::HeapObject>,unsigned_long>>>
           *this,ulong param_1)
