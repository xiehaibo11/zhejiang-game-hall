...
/* v8::internal::HashTable<v8::internal::ObjectHashSet,
   v8::internal::ObjectHashSetShape>::Shrink(v8::internal::Isolate*,
   v8::internal::Handle<v8::internal::ObjectHashSet>, int) */
  ...
  if (iVar1 <= iVar2 >> 3) {
    ...
    if ((0xf < iVar4) && (iVar4 != iVar2 >> 1)) {
      ...
      puVar5 = (ulong *)Factory::NewFixedArrayWithMap<v8::internal::FixedArray>
                                  (param_1,0xe,iVar4 + 3,bVar3);
      *(undefined4 *)(*puVar5 + 7) = 0;
      *(undefined4 *)(*puVar5 + 0xb) = 0;
      *(int *)(*puVar5 + 0xf) = iVar4 << 1;
      local_28 = *param_2;
      Rehash((HashTable<v8::internal::ObjectHashSet,v8::internal::ObjectHashSetShape> *)&local_28,
             param_1 + 0x80,*puVar5);
    }
  }
  return puVar5;
