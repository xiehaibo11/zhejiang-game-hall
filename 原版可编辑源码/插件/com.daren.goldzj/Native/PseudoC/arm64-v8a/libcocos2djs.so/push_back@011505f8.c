...
/* v8::internal::ZoneChunkList<v8::internal::Parser::ExportClauseData>::push_back(v8::internal::Parser::ExportClauseData
   const&) */

void __thiscall
v8::internal::ZoneChunkList<v8::internal::Parser::ExportClauseData>::push_back
          (ZoneChunkList<v8::internal::Parser::ExportClauseData> *this,ExportClauseData *param_1)

{
  ...
  uint uVar3;
  Zone *pZVar4;
  ZoneChunkList<v8::internal::Parser::ExportClauseData> *pZVar5;
  undefined8 uVar6;
  undefined8 uVar7;
