...
/* JSB_glDepthRangefRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glDepthRangefRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if ((plVar6[1] - *plVar6 & 0xffffffff0U) == 0x20) {
    uVar3 = seval_to_float((Value *)*plVar6,&fStack_64);
    uVar4 = seval_to_float((Value *)(*plVar6 + 0x10),&local_68);
    if ((uVar3 & uVar4 & 1) == 0) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                          ,0x4db,"JSB_glDepthRangef");
      __android_log_print(6,"jswrapper",&DAT_0190552e);
    }
    else {
      if (fStack_64 <= local_68) {
        glDepthRangef();
        goto LAB_008bb42c;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                          ,0x4dd,"JSB_glDepthRangef");
      DAT_01d36f40 = 0x502;
    }
  }
  else {
