...
undefined4 FUN_00b0a918(BIO *param_1,EC_KEY *param_2,uint param_3,int param_4)
...
LAB_00b0aa10:
    ...
    if (iVar5 != 0) {
      ...
      if ((((0 < iVar5) &&
           ((lVar10 == 0 ||
            ((iVar5 = BIO_printf(param_1,"%*spriv:\n",(ulong)param_3,&DAT_0189703a), 0 < iVar5 &&
