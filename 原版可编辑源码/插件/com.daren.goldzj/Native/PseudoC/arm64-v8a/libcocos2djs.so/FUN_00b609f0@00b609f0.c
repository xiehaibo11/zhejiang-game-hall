...
undefined8 FUN_00b609f0(long param_1)
  ...
  if (*(int *)(param_1 + 0xf0) == 0) {
    ...
    if ((*(byte *)(*(long *)(param_1 + 0x20) + 0x1a) >> 3 & 1) == 0) {
      ...
      *(undefined4 *)(param_1 + 0xb0) = 0x15;
                    /* WARNING: Could not recover jumptable at 0x00b60abc. Too many branches */
