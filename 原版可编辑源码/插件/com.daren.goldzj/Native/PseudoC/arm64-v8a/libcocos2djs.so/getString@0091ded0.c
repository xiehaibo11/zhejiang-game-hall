...
/* cocos2d::LabelRenderer::getString() */

void cocos2d::LabelRenderer::getString(void)

{
  ...
  se::Object::getProperty(*(Object **)(in_x0 + 0x18),"string",aVStack_58);
