...
/* v8::internal::Handle<v8::internal::HeapNumber>
   v8::internal::Factory::NewHeapNumber<(v8::internal::AllocationType)4>() */

void __thiscall v8::internal::Factory::NewHeapNumber<(v8::internal::AllocationType)4>(Factory *this)

{
  ...
  uVar2 = Heap::AllocateRawWithRetryOrFailSlowPath((Heap *)(this + 0x8850),0xc,4,1,2);
