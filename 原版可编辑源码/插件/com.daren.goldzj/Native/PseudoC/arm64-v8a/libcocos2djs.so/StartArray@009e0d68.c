...
/* rapidjson::Writer<rapidjson::GenericStringBuffer<rapidjson::UTF8<char>, rapidjson::CrtAllocator>,
   rapidjson::UTF8<char>, rapidjson::UTF8<char>, rapidjson::CrtAllocator, 0u>::StartArray() */
...

{
  ...
  if (puVar1 < puVar3) {
    ...
    if (pvVar8 == (void *)0x0) {
                    /* try { // try from 009e0e0c to 00ae0e13 has its CatchHandler @ 009e0ed8 */
      if (*(long *)(this + 8) == 0) {
                    /* try { // try from 009e0e14 to 00ae0efb has its CatchHandler @ 009e0cd0 */
  ...
  *(undefined1 *)(puVar9 + 1) = 1;
                    /* try { // try from 009e0da4 to 00ae0daf has its CatchHandler @ 009e0ee8 */
  plVar10 = *(long **)this;
