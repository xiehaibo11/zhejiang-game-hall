...
/* js_cocos2dx_spine_Color_set_aRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_spine_Color_set_aRegistry(undefined8 param_1,undefined8 param_2,long *param_3)

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xeeb,"js_cocos2dx_spine_Color_set_a");
    pcVar8 = "js_cocos2dx_spine_Color_set_a : Invalid Native Object";
  }
  else {
    local_74 = 0.0;
    ...
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                        ,0xef0,"js_cocos2dx_spine_Color_set_a");
    pcVar8 = "js_cocos2dx_spine_Color_set_a : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar8);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Color_set_a",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0xef4);
LAB_00c2c824:
