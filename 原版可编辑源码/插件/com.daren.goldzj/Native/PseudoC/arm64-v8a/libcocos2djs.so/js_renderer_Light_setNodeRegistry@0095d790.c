...
/* js_renderer_Light_setNodeRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Light_setNodeRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Light *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xb5,"js_renderer_Light_setNode");
    __android_log_print(6,"jswrapper","js_renderer_Light_setNode : Invalid Native Object");
  }
  else {
    ...
    if (plVar4[1] - *plVar4 == 0x10) {
      ...
      if ((uVar6 & 1) == 0) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp"
                            ,0xbc,"js_renderer_Light_setNode");
        __android_log_print(6,"jswrapper",
                            "js_renderer_Light_setNode : Cannot find node proxy form Node");
      }
      else {
        if (local_40 == 5) {
...
LAB_0095d950:
            cocos2d::renderer::Light::setNode(this,pNVar7);
            se::Value::~Value(aVStack_48);
            goto LAB_0095d9dc;
          }
        }
        ...
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp"
                            ,0xbf,"js_renderer_Light_setNode");
        __android_log_print(6,"jswrapper","js_renderer_Light_setNode : Invalid Node Proxy");
      }
      se::Value::~Value(aVStack_48);
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp, 195): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar4[1] - *plVar4) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Light_setNode",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp"
                      ,0xc6);
LAB_0095d9dc:
