...
/* std::__ndk1::__split_buffer<v8::internal::compiler::BytecodeAnalysis::LoopStackEntry*,
   v8::internal::RecyclingZoneAllocator<v8::internal::compiler::BytecodeAnalysis::LoopStackEntry*>&>::push_front(v8::internal::compiler::BytecodeAnalysis::LoopStackEntry*
   const&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_0166e458;
  ...
  if (puVar6 != puVar1) {
    ...
    if ((3 < uVar3) && ((puVar6 + uVar10 + 1 <= __src || (puVar2 + uVar10 + uVar7 + 1 <= puVar6))))
    {
      ...
      puVar8 = __src + uVar10;
      if (uVar3 == uVar10) goto LAB_0166e40c;
    }
    do {
      puVar12 = puVar6 + 1;
      *puVar8 = *puVar6;
