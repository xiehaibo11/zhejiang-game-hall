...
undefined8 FUN_01504128(undefined8 param_1,long param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_f0,(ulong)&local_f0 | 8,0x12d);
  }
  if (DAT_01d46c00 == (byte *)0x0) {
    plVar5 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d46c00 = (byte *)(**(code **)(*plVar5 + 0x10))(plVar5,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d46c00;
  local_110 = (byte **)0x0;
  if ((*DAT_01d46c00 & 5) != 0) {
    ...
    uVar6 = (**(code **)(*plVar5 + 0x18))
                      (plVar5,0x58,pbVar3,"V8.Runtime_Runtime_KeyedLoadIC_Miss",0,0,0,0,0,0,0,
                       &local_c8,0);
    pIVar1 = local_c0;
    local_c0 = (Isolate *)0x0;
    ...
    local_110 = &local_108;
    local_100 = "V8.Runtime_Runtime_KeyedLoadIC_Miss";
    local_108 = pbVar3;
    local_f8 = uVar6;
  }
