...

{
  ...
  long lVar4;
                    ...
                    /* try { // try from 00a0c7f0 to 00b0c7f7 has its CatchHandler @ 00a0c98c */
                    /* try { // try from 00a0c7fc to 00b0c827 has its CatchHandler @ 00a0c978 */
  if ((param_1 == 0) || (lVar4 = *(long *)(param_1 + 0x120), lVar4 == 0)) {
    ...
    if (param_2 != 0) {
      ...
      if (uVar1 == 0) {
        uVar2 = 0;
                    /* try { // try from 00a0c860 to 00b0c94f has its CatchHandler @ 00a0c3c8 */
      }
      else {
        ...
        if (lVar3 == 0) {
          ...
          uVar2 = 0xffffffff;
                    /* try { // try from 00a0c844 to 00b0c85f has its CatchHandler @ 00a0c974 */
        }
      }
    }
  }
