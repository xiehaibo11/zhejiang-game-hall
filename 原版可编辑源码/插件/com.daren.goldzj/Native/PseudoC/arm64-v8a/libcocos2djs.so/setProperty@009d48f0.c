...
/* cocos2d::renderer::EffectBase::setProperty(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&, void*, int) */

void __thiscall
cocos2d::renderer::EffectBase::setProperty
          (EffectBase *this,basic_string *param_1,void *param_2,int param_3)

{
  ...
  if (param_3 == -1) {
    uVar3 = 0;
    if (uVar2 == 0) goto LAB_009d49a4;
  }
  else {
    uVar3 = (ulong)param_3;
    if ((long)uVar2 <= (long)uVar3) {
      __android_log_print(3,"renderer"," (129): EffectBase::setProperty error passIdx [%d]\n",
                          param_3);
      return;
    }
    uVar2 = (ulong)(param_3 + 1);
    if (uVar2 <= uVar3) goto LAB_009d49a4;
  }
