...
undefined8 FUN_00dde8ec(undefined8 *param_1,undefined1 *param_2,long param_3)
  ...
  do {
    while( true ) {
      ...
      *(ulong *)(lVar16 + 0xb0) = *(ulong *)(lVar16 + 0xb0) - uVar8;
      if (uVar5 == 0x101) goto LAB_00ddec18;
...
LAB_00dded40:
    puVar13 = (ulong *)*puVar13;
    if (puVar13 == (ulong *)0x0) goto LAB_00ddec18;
  }
