...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitLdaTrue(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitLdaTrue
...

{
  ...
  local_28 = 0;
  Hints::AddConstant((Hints *)&local_28,lVar3 + 0xb8,lVar2);
