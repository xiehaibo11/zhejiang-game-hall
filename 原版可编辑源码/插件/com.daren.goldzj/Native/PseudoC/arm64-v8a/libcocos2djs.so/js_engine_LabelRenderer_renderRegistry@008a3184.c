...
/* js_engine_LabelRenderer_renderRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_engine_LabelRenderer_renderRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (LabelRenderer *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x75d,"js_engine_LabelRenderer_render");
    __android_log_print(6,"jswrapper","js_engine_LabelRenderer_render : Invalid Native Object");
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      cocos2d::LabelRenderer::render(this);
      goto LAB_008a32d4;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 1892): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_LabelRenderer_render",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x767);
LAB_008a32d4:
