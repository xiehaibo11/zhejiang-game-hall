...
/* void JSBClassType::registerClass<dragonBones::CCArmatureDisplay>(se::Class*) */

void JSBClassType::registerClass<dragonBones::CCArmatureDisplay>(Class *param_1)
