...
/* js_renderer_Effect_selfRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Effect_selfRegistry(FunctionCallbackInfo *param_1)

{
  ...
  uVar4 = se::State::nativeThisObject(aSStack_60);
  if (uVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp"
                        ,0x93,"js_renderer_Effect_self");
    __android_log_print(6,"jswrapper","js_renderer_Effect_self : Invalid Native Object");
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_renderer_Effect_self",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp"
                        ,0x98);
  }
  else {
    pVVar5 = (Value *)se::State::rval(aSStack_60);
    se::Value::setNumber(pVVar5,(double)uVar4);
  }
  pVVar5 = (Value *)se::State::rval(aSStack_60);
