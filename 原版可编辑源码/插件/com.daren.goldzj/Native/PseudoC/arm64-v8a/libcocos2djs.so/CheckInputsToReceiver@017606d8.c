...
/* v8::internal::compiler::JSBinopReduction::CheckInputsToReceiver() */

void __thiscall
v8::internal::compiler::JSBinopReduction::CheckInputsToReceiver(JSBinopReduction *this)

{
  ...
  if ((local_58 != (Node *)0x47f0001) &&
     (uVar2 = Type::SlowIs((Type *)&local_58,0x47f0001), (uVar2 & 1) == 0)) {
    CheckLeftInputToReceiver(this);
  }
  plVar6 = (long *)(*(long *)(this + 8) + 0x20);
  if ((~*(uint *)(*(long *)(this + 8) + 0x14) & 0xf000000) == 0) {
    plVar6 = (long *)(*plVar6 + 0x10);
  ...
  if ((local_58 != (Node *)0x47f0001) &&
    ...
    pOVar3 = (Operator *)
             SimplifiedOperatorBuilder::CheckReceiver
