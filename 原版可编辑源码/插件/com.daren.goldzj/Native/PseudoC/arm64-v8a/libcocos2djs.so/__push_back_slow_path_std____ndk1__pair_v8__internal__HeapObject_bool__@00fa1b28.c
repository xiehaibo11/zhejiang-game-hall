...
/* void std::__ndk1::vector<std::__ndk1::pair<v8::internal::HeapObject, bool>,
   std::__ndk1::allocator<std::__ndk1::pair<v8::internal::HeapObject, bool> >
   >::__push_back_slow_path<std::__ndk1::pair<v8::internal::HeapObject, bool>
   >(std::__ndk1::pair<v8::internal::HeapObject, bool>&&) */
...

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_00fa1c14;
