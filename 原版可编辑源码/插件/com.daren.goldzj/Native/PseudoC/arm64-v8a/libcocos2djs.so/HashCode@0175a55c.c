...
/* v8::internal::compiler::Operator1<v8::internal::compiler::PropertyAccess,
   ...
   v8::internal::compiler::OpHash<v8::internal::compiler::PropertyAccess> >::HashCode() const */
...
::HashCode(Operator1<v8::internal::compiler::PropertyAccess,v8::internal::compiler::OpEqualTo<v8::internal::compiler::PropertyAccess>,v8::internal::compiler::OpHash<v8::internal::compiler::PropertyAccess>>
           *this)

{
  ...
  uVar3 = base::hash_combine(0,(long)*(int *)(this + 0x38));
