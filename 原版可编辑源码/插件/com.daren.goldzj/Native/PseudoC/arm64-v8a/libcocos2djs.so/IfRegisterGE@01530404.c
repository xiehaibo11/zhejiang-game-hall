...
/* v8::internal::RegExpBytecodeGenerator::IfRegisterGE(int, int, v8::internal::Label*) */

void __thiscall
v8::internal::RegExpBytecodeGenerator::IfRegisterGE
          (RegExpBytecodeGenerator *this,int param_1,int param_2,Label *param_3)

{
  ...
  *(uint *)(*(long *)(this + 0x28) + (long)iVar4) = param_1 << 8 | 0x2d;
  iVar2 = *(int *)(this + 0x38);
  iVar4 = iVar2 + 4;
  *(int *)(this + 0x38) = iVar4;
  ...
  *(int *)(*(long *)(this + 0x28) + (long)iVar4) = param_2;
  iVar4 = *(int *)(this + 0x38);
  pRVar1 = this + 0x3c;
