...
/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::allocator<char> > const&, cocos2d::Value const&>(std::__ndk1::basic_string<char,
...

{
  ...
  if (*(long *)(lVar1 + 0x28) != local_48) {
    ...
    __stack_chk_fail(pp_Var2,uVar3);
                    ...
                    /* try { // try from 009c7834 to 00ac788b has its CatchHandler @ 009c78a8 */
  return p_Var5;
}
