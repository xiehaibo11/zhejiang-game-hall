...
/* cocos2d::getSDKVersion() */

int cocos2d::getSDKVersion(void)

{
  ...
  if (((byte)local_58 & 1) != 0) {
    operator_delete(local_48);
                    ...
                    /* try { // try from 00a999a0 to 00b999e7 has its CatchHandler @ 00a999a0
                       catch() { ... } // from try @ 00a999a0 with catch @ 00a999a0
                       catch() { ... } // from try @ 00a99af4 with catch @ 00a999a0 */
  if ((local_40[0] & 1) != 0) {
