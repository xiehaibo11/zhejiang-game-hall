...
/* seval_to_Vec4(se::Value const&, cocos2d::Vec4*) */

undefined4 seval_to_Vec4(Value *param_1,Vec4 *param_2)
  ...
  if (param_1[8] == (Value)0x5) {
    ...
    *(undefined8 *)(param_2 + 8) = 0;
    ...
    if ((((((uVar3 & 1) == 0) || (local_40 != '\x02')) ||
        ...
        ((local_50 != '\x02' ||
         (uVar3 = se::Object::getProperty(this,"z",aVStack_68), (uVar3 & 1) == 0)))) ||
       ((local_60 != '\x02' ||
        ((uVar3 = se::Object::getProperty(this,"w",aVStack_78), (uVar3 & 1) == 0 ||
         (local_70 != '\x02')))))) {
      uVar2 = cocos2d::Vec4::ZERO._0_8_;
      uVar4 = 0;
      *(undefined8 *)(param_2 + 8) = cocos2d::Vec4::ZERO._8_8_;
    ...
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x129,"seval_to_Vec4");
    __android_log_print(6,"jswrapper","Convert parameter to Vec4 failed!");
    uVar4 = 0;
  }
