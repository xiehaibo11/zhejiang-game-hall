...
/* js_cocos2dx_dragonbones_CCArmatureCacheDisplay_setDBEventCallbackRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_CCArmatureCacheDisplay_setDBEventCallbackRegistry
...

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x21f3,"js_cocos2dx_dragonbones_CCArmatureCacheDisplay_setDBEventCallback")
    ;
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_CCArmatureCacheDisplay_setDBEventCallback : Invalid Native Object"
                       );
  }
  else {
    ...
    if (puVar5[1] - (long)pVVar6 == 0x10) {
      ...
      if (pVVar6[8] == (Value)0x5) {
        ...
        if ((uVar8 & 1) == 0) goto LAB_00cd1448;
...
LAB_00cd1534:
        ...
        if (local_a0 == (long *)0x0) goto LAB_00cd144c;
        if (alStack_c0 != local_a0) {
          local_d0 = (long *)(**(code **)(*local_a0 + 0x10))();
          if (local_d0 != (long *)0x0) goto LAB_00cd15b4;
          goto LAB_00cd1450;
        }
        local_d0 = local_f0;
        (**(code **)(*local_a0 + 0x18))(local_a0,local_f0);
        if (local_d0 == (long *)0x0) goto LAB_00cd1450;
LAB_00cd15b4:
...
LAB_00cd1450:
      ...
      FUN_00cd7f88(alStack_90,lVar4 + 0x90);
      if (alStack_90 == local_70) {
        pcVar11 = *(code **)(*local_70 + 0x20);
LAB_00cd14c8:
        (*pcVar11)();
...
LAB_00cd14f4:
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp, 8731): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(puVar5[1] - (long)pVVar6) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_CCArmatureCacheDisplay_setDBEventCallback",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x221e);
LAB_00cd1400:
