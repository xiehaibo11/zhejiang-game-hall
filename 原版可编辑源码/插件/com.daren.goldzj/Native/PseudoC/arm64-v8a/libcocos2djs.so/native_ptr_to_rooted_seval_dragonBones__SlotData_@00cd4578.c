...
/* bool 
   ...
   dragonBones::SlotData>::value, dragonBones::SlotData>::type const*, se::Value*, bool*) */

bool native_ptr_to_rooted_seval<dragonBones::SlotData>(type *param_1,Value *param_2,bool *param_3)

{
  ...
  if (param_1 == (type *)0x0) {
    ...
    if (lVar1 == lVar2) {
      pCVar3 = JSBClassType::findClass<dragonBones::SlotData>((SlotData *)param_1);
