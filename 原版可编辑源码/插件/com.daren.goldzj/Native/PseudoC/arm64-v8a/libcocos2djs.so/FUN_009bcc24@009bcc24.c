...
void FUN_009bcc24(long *param_1,long *param_2)
  ...
  if (param_2 != param_1) {
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
        ...
        param_1[4] = 0;
                    /* catch() { ... } // from try @ 009bcbf8 with catch @ 009bcd18 */
        (**(code **)(*(long *)param_2[4] + 0x18))((long *)param_2[4],param_1);
                    /* catch() { ... } // from try @ 009bcbec with catch @ 009bcd1c */
                    /* catch() { ... } // from try @ 009bcbcc with catch @ 009bcd20 */
        (**(code **)(*(long *)param_2[4] + 0x20))();
        param_2[4] = 0;
                    /* catch() { ... } // from try @ 009bcc04 with catch @ 009bcd30 */
        ...
        (**(code **)(*(long *)param_1[4] + 0x20))();
                    /* try { // try from 009bcca4 to 00abcd87 has its CatchHandler @ 009bcb78 */
        param_1[4] = param_2[4];
      }
