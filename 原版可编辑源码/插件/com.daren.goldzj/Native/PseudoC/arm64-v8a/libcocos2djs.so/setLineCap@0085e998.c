...
/* CanvasRenderingContext2DImpl::setLineCap(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) */

void __thiscall
CanvasRenderingContext2DImpl::setLineCap(CanvasRenderingContext2DImpl *this,basic_string *param_1)
