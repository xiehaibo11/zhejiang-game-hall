...
Factory * __thiscall
v8::internal::Factory::NewExternalStringFromTwoByte(Factory *this,ExternalStringResource *param_1)
  ...
  if (uVar2 < 0xffffff1) {
    if (uVar2 == 0) {
      ...
      uVar4 = Heap::AllocateRawWithRetryOrFailSlowPath
                        ((Heap *)(this + 0x8850),(ulong)*(byte *)(*(long *)(this + lVar7) + 3) << 2,
                         1,1,0);
      uVar6 = *(ulong *)(this + lVar7);
      ...
      *(undefined4 *)(*(long *)pFVar8 + 3) = 7;
      uVar2 = *(ulong *)pFVar8;
      *(ExternalStringResource **)(uVar2 + 0xb) = param_1;
      ...
      if ((uVar4 & 0x7fffffffffffffff) != 0) {
        Heap::UpdateExternalString((Heap *)(this + 0x8850),uVar2,0);
      }
