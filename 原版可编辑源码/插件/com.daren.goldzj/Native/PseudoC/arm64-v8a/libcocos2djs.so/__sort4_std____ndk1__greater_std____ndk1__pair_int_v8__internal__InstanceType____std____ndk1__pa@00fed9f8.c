...
/* unsigned int std::__ndk1::__sort4<std::__ndk1::greater<std::__ndk1::pair<int,
...
uint std::__ndk1::
     __sort4<std::__ndk1::greater<std::__ndk1::pair<int,v8::internal::InstanceType>>&,std::__ndk1::pair<int,v8::internal::InstanceType>*>
               (pair *param_1,pair *param_2,pair *param_3,pair *param_4,greater *param_5)

{
  ...
  uVar4 = __sort3<std::__ndk1::greater<std::__ndk1::pair<int,v8::internal::InstanceType>>&,std::__ndk1::pair<int,v8::internal::InstanceType>*>
                    (param_1,param_2,param_3,param_5);
  iVar1 = *(int *)param_3;
  iVar2 = *(int *)param_4;
  if ((iVar1 < iVar2) ||
     ((uVar5 = uVar4, iVar1 <= iVar2 && (*(ushort *)(param_3 + 4) < *(ushort *)(param_4 + 4))))) {
    *(int *)param_3 = iVar2;
    *(int *)param_4 = iVar1;
    ...
    *(undefined2 *)(param_4 + 4) = uVar3;
    ...
    iVar2 = *(int *)param_3;
    if ((iVar1 < iVar2) ||
       ((uVar5 = uVar4 + 1, iVar1 <= iVar2 && (*(ushort *)(param_2 + 4) < *(ushort *)(param_3 + 4)))
       )) {
      *(int *)param_2 = iVar2;
      *(int *)param_3 = iVar1;
