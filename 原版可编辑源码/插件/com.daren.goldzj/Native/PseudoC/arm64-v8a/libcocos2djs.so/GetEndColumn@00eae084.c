...
int __thiscall v8::Message::GetEndColumn(Message *this)

{
  ...
  *local_48 = uVar6;
  ...
  iVar3 = internal::JSMessageObject::GetColumnNumber((JSMessageObject *)&local_28);
  if (iVar3 == -1) {
    iVar3 = -1;
  }
  else {
    iVar3 = (iVar3 - (*(int *)(*(long *)this + 0x23) >> 1)) + (*(int *)(*(long *)this + 0x27) >> 1);
  }
