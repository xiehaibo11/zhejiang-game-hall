...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitCallRuntime(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitCallRuntime
