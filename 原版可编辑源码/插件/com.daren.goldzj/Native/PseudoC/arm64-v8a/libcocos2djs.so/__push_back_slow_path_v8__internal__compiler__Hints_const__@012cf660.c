...
/* void std::__ndk1::vector<v8::internal::compiler::Hints,
   v8::internal::ZoneAllocator<v8::internal::compiler::Hints>
   >::__push_back_slow_path<v8::internal::compiler::Hints const&>(v8::internal::compiler::Hints
   const&) */

void __thiscall
std::__ndk1::
vector<v8::internal::compiler::Hints,v8::internal::ZoneAllocator<v8::internal::compiler::Hints>>::
__push_back_slow_path<v8::internal::compiler::Hints_const&>
          (vector<v8::internal::compiler::Hints,v8::internal::ZoneAllocator<v8::internal::compiler::Hints>>
           *this,Hints *param_1)
