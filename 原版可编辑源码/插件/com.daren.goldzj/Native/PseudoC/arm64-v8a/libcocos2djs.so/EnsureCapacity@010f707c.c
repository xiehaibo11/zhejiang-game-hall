...
/* v8::internal::HashTable<v8::internal::CompilationCacheTable,
   v8::internal::CompilationCacheShape>::EnsureCapacity(v8::internal::Isolate*,
   v8::internal::Handle<v8::internal::CompilationCacheTable>, int, v8::internal::AllocationType) */
