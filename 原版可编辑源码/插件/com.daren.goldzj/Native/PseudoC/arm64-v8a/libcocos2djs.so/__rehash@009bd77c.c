...

{
  ...
  ulong uVar17;
                    ...
                    /* try { // try from 009bd798 to 00abd7eb has its CatchHandler @ 009bd798
                       catch() { ... } // from try @ 009bd798 with catch @ 009bd798
                       catch() { ... } // from try @ 009bd928 with catch @ 009bd798 */
  if (param_1 == 0) {
                    /* try { // try from 009bd818 to 00abd823 has its CatchHandler @ 009bd99c */
    pvVar9 = *(void **)this;
    *(undefined8 *)this = 0;
    if (pvVar9 != (void *)0x0) {
                    /* try { // try from 009bd824 to 00abd927 has its CatchHandler @ 009bd9b4 */
    ...
    do {
      *(undefined8 *)(*(long *)this + uVar11 * 8) = 0;
      uVar11 = uVar11 + 1;
                    ...
                    /* try { // try from 009bd7ec to 00abd803 has its CatchHandler @ 009bd9a4 */
    ...
    if (plVar14 != (long *)0x0) {
      ...
      if ((uVar16 & param_1) == 0) {
        uVar11 = uVar11 & uVar16;
                    ...
                    /* try { // try from 009bd80c to 00abd817 has its CatchHandler @ 009bd9a0 */
        uVar17 = 0;
        if (param_1 != 0) {
            ...
            *(long **)(*(long *)this + uVar17 * 8) = plVar14;
            ...
            if ((long *)*plVar15 != (long *)0x0) {
              ...
              do {
                ...
                if ((bVar3 & 1) == 0) {
                  while (sVar6 != 0) {
                    if (*pcVar5 != *__s2) goto LAB_009bd960;
                    __s2 = __s2 + 1;
                    sVar1 = sVar1 + 1;
                    pcVar5 = pcVar5 + 1;
                    sVar6 = sVar1;
...
LAB_009bd960:
            ...
            **(long **)(*(long *)this + uVar17 * 8) = (long)plVar15;
            plVar15 = plVar14;
                    ...
                    /* catch() { ... } // from try @ 009bd818 with catch @ 009bd99c */
        plVar14 = plVar15;
      }
    }
  }
                    /* catch() { ... } // from try @ 009bd80c with catch @ 009bd9a0 */
                    /* catch() { ... } // from try @ 009bd7ec with catch @ 009bd9a4 */
                    /* catch() { ... } // from try @ 009bd824 with catch @ 009bd9b4 */
  return;
}
