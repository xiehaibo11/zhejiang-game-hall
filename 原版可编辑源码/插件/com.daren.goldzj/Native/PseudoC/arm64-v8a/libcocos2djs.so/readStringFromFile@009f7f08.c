...
/* universe::CustomFileManager::readStringFromFile(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&) const */

void universe::CustomFileManager::readStringFromFile(basic_string *param_1)
