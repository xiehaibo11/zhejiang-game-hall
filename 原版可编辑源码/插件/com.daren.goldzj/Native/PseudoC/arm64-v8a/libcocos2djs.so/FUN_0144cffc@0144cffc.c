...
void FUN_0144cffc(long param_1,undefined8 param_2,undefined8 param_3,long param_4,ulong param_5,
...

{
  ...
  if ((int)lVar4 == (int)*(undefined8 *)(unaff_x26 + 0x140)) {
    ...
    *(undefined8 *)(unaff_x26 + 0x40) = 0x144d1a8;
...
LAB_0144d0fc:
    ...
    if (sVar3 != 0x43) goto LAB_0144d0fc;
    if ((param_5 & 1) == 0) {
      uVar5 = 0x1e;
    }
    else {
      ...
      if ((int)lVar4 == (int)*(undefined8 *)(unaff_x26 + 0x140)) {
        ...
        if (*(short *)(lVar4 + 7) != 0x43) goto LAB_0144d0fc;
        uVar5 = 0x1e;
      }
    }
  }
