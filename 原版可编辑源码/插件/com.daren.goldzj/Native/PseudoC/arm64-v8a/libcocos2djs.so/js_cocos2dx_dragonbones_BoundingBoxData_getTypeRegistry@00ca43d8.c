...
/* js_cocos2dx_dragonbones_BoundingBoxData_getTypeRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_BoundingBoxData_getTypeRegistry(FunctionCallbackInfo *param_1)
...
LAB_00ca453c:
    ...
    if (plVar6[1] - *plVar6 == 0) {
      ...
      if ((uVar7 & 1) != 0) goto LAB_00ca4574;
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                          ,0x8e7,0x1928ffb);
      puVar9 = &DAT_01933033;
    ...
    __android_log_print(6,"jswrapper",&DAT_01933080,(ulong)(plVar6[1] - *plVar6) >> 4,0);
  }
