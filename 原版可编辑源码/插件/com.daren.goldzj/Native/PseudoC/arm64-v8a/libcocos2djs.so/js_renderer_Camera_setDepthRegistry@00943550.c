...
/* js_renderer_Camera_setDepthRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Camera_setDepthRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Camera *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x75a,"js_renderer_Camera_setDepth");
    __android_log_print(6,"jswrapper","js_renderer_Camera_setDepth : Invalid Native Object");
  }
  else {
    ...
    if (uVar6 == 0x10) {
      ...
      if ((uVar6 & 1) != 0) {
        cocos2d::renderer::Camera::setDepth(this,local_64);
        goto LAB_00943708;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0x761,"js_renderer_Camera_setDepth");
      __android_log_print(6,"jswrapper","js_renderer_Camera_setDepth : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 1893): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar6 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Camera_setDepth",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0x768);
LAB_00943708:
