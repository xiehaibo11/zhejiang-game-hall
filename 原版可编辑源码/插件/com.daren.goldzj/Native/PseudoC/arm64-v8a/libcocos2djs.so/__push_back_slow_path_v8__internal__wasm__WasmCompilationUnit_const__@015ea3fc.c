...
/* void std::__ndk1::vector<v8::internal::wasm::WasmCompilationUnit,
   ...
   >::__push_back_slow_path<v8::internal::wasm::WasmCompilationUnit
   const&>(v8::internal::wasm::WasmCompilationUnit const&) */
...
::__push_back_slow_path<v8::internal::wasm::WasmCompilationUnit_const&>
          (vector<v8::internal::wasm::WasmCompilationUnit,std::__ndk1::allocator<v8::internal::wasm::WasmCompilationUnit>>
           *this,WasmCompilationUnit *param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_015ea4e4;
