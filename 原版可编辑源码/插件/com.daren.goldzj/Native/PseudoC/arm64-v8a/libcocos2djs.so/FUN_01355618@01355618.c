...
undefined1  [16]
FUN_01355618(ulong param_1,ulong param_2,undefined8 param_3,ulong param_4,undefined8 param_5,
...

{
  ...
  *(int *)(param_2 + 7) = (int)param_4;
  ...
  if (param_8 < (ulong)((long)((ulong)*(uint *)(param_4 + 3) << 0x20) >> 0x21)) {
    *(int *)(param_4 + in_x10) = (int)param_1;
    if (((((uint)*(undefined8 *)((param_4 & 0xfffffffffffc0000) + 8) >> 2 & 1) != 0) &&
      ...
      FUN_0133eb00(param_4,param_4 + in_x10,0,2);
    }
  ...
  pcVar1 = (code *)SoftwareBreakpoint(0,0x1356774);
  (*pcVar1)();
}
