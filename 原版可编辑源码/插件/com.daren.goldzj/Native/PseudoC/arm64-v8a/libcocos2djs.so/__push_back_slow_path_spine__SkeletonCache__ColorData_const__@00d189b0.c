...
/* void std::__ndk1::vector<spine::SkeletonCache::ColorData*,
   std::__ndk1::allocator<spine::SkeletonCache::ColorData*>
   >::__push_back_slow_path<spine::SkeletonCache::ColorData*
   const&>(spine::SkeletonCache::ColorData* const&) */
...
LAB_00d18a14:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d18a14;
  }
  else {
