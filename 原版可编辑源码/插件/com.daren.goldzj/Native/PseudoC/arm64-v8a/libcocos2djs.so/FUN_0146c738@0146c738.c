...
void FUN_0146c738(long param_1,undefined8 param_2,long param_3,undefined8 param_4,undefined4 param_5
    ...
    do {
      *(int *)(param_1 + lVar1 + -1) = (int)uVar2;
      lVar1 = lVar1 + 4;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0146c7a0. Too many branches */
