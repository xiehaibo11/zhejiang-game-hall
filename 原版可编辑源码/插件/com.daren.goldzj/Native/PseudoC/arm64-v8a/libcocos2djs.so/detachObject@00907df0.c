...
/* se::Object::detachObject(se::Object*) */

undefined4 __thiscall se::Object::detachObject(Object *this,Object *param_1)

{
  ...
  if ((uVar4 & 1) == 0) {
    ...
    uVar4 = getProperty(pOVar5,"unregisterNativeRef",aVStack_68);
    if ((uVar4 & 1) == 0) {
      uVar6 = 0;
    }
    else {
