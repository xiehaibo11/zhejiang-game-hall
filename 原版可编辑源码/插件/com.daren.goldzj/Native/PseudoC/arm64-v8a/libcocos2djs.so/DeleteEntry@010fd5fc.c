...
/* v8::internal::Dictionary<v8::internal::NameDictionary,
   v8::internal::NameDictionaryShape>::DeleteEntry(v8::internal::Isolate*,
   v8::internal::Handle<v8::internal::NameDictionary>, v8::internal::InternalIndex) */
...

{
  ...
  SetEntry((Dictionary<v8::internal::NameDictionary,v8::internal::NameDictionaryShape> *)&local_28,
           param_1,param_3,uVar1,uVar1,0xc0);
  uVar2 = *param_2;
  puVar3 = (uint *)(uVar2 + 7);
