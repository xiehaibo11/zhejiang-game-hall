...
/* v8::internal::compiler::CodeAssembler::Float64Div(v8::internal::SloppyTNode<v8::internal::Float64T>,
...

{
  ...
  pOVar1 = (Operator *)
           MachineOperatorBuilder::Float64Div((MachineOperatorBuilder *)(this_00 + 0x20));
  local_40 = param_2;
  uStack_38 = param_3;
