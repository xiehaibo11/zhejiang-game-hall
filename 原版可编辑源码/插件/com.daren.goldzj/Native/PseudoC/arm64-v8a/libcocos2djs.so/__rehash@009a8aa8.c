...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int,
   ...
   cocos2d::network::DownloadTaskAndroid*> > >::__rehash(unsigned long) */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<int,cocos2d::network::DownloadTaskAndroid*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,cocos2d::network::DownloadTaskAndroid*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,cocos2d::network::DownloadTaskAndroid*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,cocos2d::network::DownloadTaskAndroid*>>>
           *this,ulong param_1)
    ...
    *(ulong *)(this + 8) = param_1;
    do {
      *(undefined8 *)(*(long *)this + uVar4 * 8) = 0;
      uVar4 = uVar4 + 1;
                    /* try { // try from 009a8af8 to 00aa8bdb has its CatchHandler @ 009a893c */
    } while (param_1 != uVar4);
...
joined_r0x009a8b58:
      if (plVar7 != (long *)0x0) {
        do {
                    /* catch() { ... } // from try @ 009a89bc with catch @ 009a8b6c */
          uVar8 = plVar7[1];
                    /* catch() { ... } // from try @ 009a89b0 with catch @ 009a8b70 */
          if ((uVar6 & param_1) == 0) {
            uVar8 = uVar8 & uVar6;
            if (uVar8 != uVar4) goto LAB_009a8b9c;
LAB_009a8b60:
            plVar10 = (long *)*plVar7;
            plVar5 = plVar7;
          }
          else {
                    /* catch() { ... } // from try @ 009a8990 with catch @ 009a8b74 */
            if (param_1 <= uVar8) {
              uVar1 = 0;
              if (param_1 != 0) {
                uVar1 = uVar8 / param_1;
              ...
              uVar8 = uVar8 - uVar1 * param_1;
                    ...
                    /* catch() { ... } // from try @ 009a89c8 with catch @ 009a8b84 */
            if (uVar8 == uVar4) goto LAB_009a8b60;
LAB_009a8b9c:
            plVar10 = plVar7;
            if (*(long *)(*(long *)this + uVar8 * 8) == 0) goto LAB_009a8bf8;
            do {
              plVar9 = plVar10;
              plVar10 = (long *)*plVar9;
            ...
            *plVar5 = (long)plVar10;
                    /* try { // try from 009a8bdc to 00aa8c2f has its CatchHandler @ 009a8bdc
                       catch() { ... } // from try @ 009a8bdc with catch @ 009a8bdc
                       catch() { ... } // from try @ 009a8d9c with catch @ 009a8bdc */
