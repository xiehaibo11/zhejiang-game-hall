...
/* v8::internal::interpreter::BytecodeArrayWriter::WriteJump(v8::internal::interpreter::BytecodeNode*,
   v8::internal::interpreter::BytecodeLabel*) */

void __thiscall
v8::internal::interpreter::BytecodeArrayWriter::WriteJump
