...
/* v8::internal::compiler::ScopeInfoRef::OuterScopeInfo() const */

undefined1  [16] __thiscall v8::internal::compiler::ScopeInfoRef::OuterScopeInfo(ScopeInfoRef *this)

{
  ...
  if (*(int *)(*(undefined8 **)this + 1) == 2) {
    ...
    uVar3 = ScopeInfo::OuterScopeInfo((ScopeInfo *)&local_18);
    ...
    if (*(int *)(puVar6 + 1) == 2) {
      uVar3 = *(ulong *)*puVar6;
      if ((uVar3 & 1) == 0) goto LAB_0172e478;
      sVar2 = *(short *)((uVar3 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar3 - 1));
    }
    else {
      if (*(int *)(puVar6 + 1) == 0) goto LAB_0172e478;
    ...
    if (*(short *)(*(long *)(lVar5 + 0x10) + 0x18) != 0x83) goto LAB_0172e478;
