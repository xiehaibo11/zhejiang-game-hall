...
ulong FUN_010a6198(undefined8 param_1,long param_2,ulong param_3,ulong param_4,ulong param_5)

{
  ...
  if ((uVar3 <= param_5) ||
    ...
    if (((uint)(*piVar1 >> 1) <= param_5) ||
       ((uVar4 = (ulong)*(uint *)(uVar4 + (long)((int)param_5 << 2) + 7) + param_2, (uVar4 & 1) != 0
        && ((int)uVar4 == *(int *)(param_2 + 0xa8))))) {
