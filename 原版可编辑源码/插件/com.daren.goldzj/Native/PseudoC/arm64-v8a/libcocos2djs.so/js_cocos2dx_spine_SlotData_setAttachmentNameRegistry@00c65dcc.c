...
/* js_cocos2dx_spine_SlotData_setAttachmentNameRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_SlotData_setAttachmentNameRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (SlotData *)se::State::nativeThisObject(aSStack_70);
  if (this == (SlotData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                        ,0x2c8a,"js_cocos2dx_spine_SlotData_setAttachmentName");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SlotData_setAttachmentName : Invalid Native Object");
  }
  else {
    ...
    if (plVar5[1] - *plVar5 == 0x10) {
      ...
      spine::SlotData::setAttachmentName(this,(String *)&local_88);
      pvVar4 = local_78;
      local_88 = &PTR__String_01c67868;
    ...
    __android_log_print(6,"jswrapper",&DAT_01917ece,(ulong)(plVar5[1] - *plVar5) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SlotData_setAttachmentName",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x2c98);
LAB_00c65ff4:
