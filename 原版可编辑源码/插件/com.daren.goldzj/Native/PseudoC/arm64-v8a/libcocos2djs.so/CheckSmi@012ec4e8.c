...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CheckSmi(v8::internal::compiler::FeedbackSource
   const&) */
...

{
  ...
  if ((*(long *)param_1 == 0) || (*(int *)(param_1 + 8) == -1)) {
    pOVar3 = (Operator *)(*(long *)this + 0x1b60);
  }
  else {
    this_00 = *(Zone **)(this + 8);
    ...
    Operator::Operator(pOVar3,0xdd,0x38,"CheckSmi",1,1,1,1,1,0);
