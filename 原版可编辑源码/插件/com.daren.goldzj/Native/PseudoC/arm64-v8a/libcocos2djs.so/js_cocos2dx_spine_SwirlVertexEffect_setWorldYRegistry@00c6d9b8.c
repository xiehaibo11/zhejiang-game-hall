...
/* js_cocos2dx_spine_SwirlVertexEffect_setWorldYRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_SwirlVertexEffect_setWorldYRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SwirlVertexEffect *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x30e3,"js_cocos2dx_spine_SwirlVertexEffect_setWorldY");
    puVar6 = &DAT_0191be02;
LAB_00c6db2c:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::SwirlVertexEffect::setWorldY(this,local_64);
        goto LAB_00c6db64;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x30ea,"js_cocos2dx_spine_SwirlVertexEffect_setWorldY");
      puVar6 = &DAT_0191be48;
      goto LAB_00c6db2c;
    }
    __android_log_print(6,"jswrapper",&DAT_0191be93,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SwirlVertexEffect_setWorldY",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x30f1);
LAB_00c6db64:
