...
/* js_cocos2dx_dragonbones_PolygonBoundingBoxData_set_yRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_PolygonBoundingBoxData_set_yRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xb73,"js_cocos2dx_dragonbones_PolygonBoundingBoxData_set_y");
    puVar8 = &DAT_01933e81;
  }
  else {
    local_74 = 0.0;
    ...
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0xb78,"js_cocos2dx_dragonbones_PolygonBoundingBoxData_set_y");
    puVar8 = &DAT_01933ece;
  }
  __android_log_print(6,"jswrapper",puVar8);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_PolygonBoundingBoxData_set_y",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0xb7c);
LAB_00ca84d4:
