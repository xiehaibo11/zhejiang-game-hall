...
/* js_cocos2dx_dragonbones_AnimationData_get_fadeInTimeRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_AnimationData_get_fadeInTimeRegistry
...

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xcb0,"js_cocos2dx_dragonbones_AnimationData_get_fadeInTime");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_AnimationData_get_fadeInTime : Invalid Native Object"
                       );
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_dragonbones_AnimationData_get_fadeInTime",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0xcb8);
  }
  else {
    se::Value::Value(aVStack_58);
    float_to_seval(*(float *)(lVar3 + 0x2c),aVStack_58);
