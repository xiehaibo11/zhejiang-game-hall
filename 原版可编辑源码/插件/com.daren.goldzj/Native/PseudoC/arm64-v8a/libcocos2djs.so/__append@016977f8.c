...
/* std::__ndk1::vector<v8::internal::SourcePosition,
   v8::internal::ZoneAllocator<v8::internal::SourcePosition> >::__append(unsigned long,
   v8::internal::SourcePosition const&) */

void __thiscall
std::__ndk1::
vector<v8::internal::SourcePosition,v8::internal::ZoneAllocator<v8::internal::SourcePosition>>::
__append(vector<v8::internal::SourcePosition,v8::internal::ZoneAllocator<v8::internal::SourcePosition>>
         *this,ulong param_1,SourcePosition *param_2)

{
  ...
  puVar6 = puVar4;
  if ((3 < param_1) &&
     ((param_2 + 1 <= puVar4 || ((SourcePosition *)(lVar5 + (lVar11 + param_1) * 8) <= param_2)))) {
