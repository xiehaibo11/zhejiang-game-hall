...
/* v8::internal::Assembler::NEONAcrossLanesL(v8::internal::VRegister const&, v8::internal::VRegister
   const&, v8::internal::NEONAcrossLanesOp) */

void __thiscall
v8::internal::Assembler::NEONAcrossLanesL(Assembler *this,uint *param_1,ulong *param_2,uint param_4)
