...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::ResolvePhisPhase>() */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::ResolvePhisPhase>
          (PipelineImpl *this)

{
  ...
  lVar2 = ZoneStats::NewEmptyZone(this_01,"V8.TFResolvePhis");
  ConstraintBuilder::ConstraintBuilder(aCStack_18,*(RegisterAllocationData **)(lVar5 + 0x170));
  ConstraintBuilder::ResolvePhis(aCStack_18);
