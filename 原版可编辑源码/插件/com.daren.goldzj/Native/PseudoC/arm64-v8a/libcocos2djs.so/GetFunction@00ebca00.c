...
ulong * __thiscall v8::FunctionTemplate::GetFunction(FunctionTemplate *this,long param_2)
  ...
  if ((*(int *)(pIVar7 + 0x2c20) == (int)uVar9) ||
    ...
    *local_48 = uVar9;
    ...
    if (internal::TracingFlags::runtime_stats != 0) {
      ...
      internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x372);
    }
    this_00 = *(Logger **)(pIVar7 + 0x9558);
    uVar9 = internal::Logger::is_logging(this_00);
    if ((uVar9 & 1) != 0) {
      internal::Logger::ApiEntryCall(this_00,"v8::FunctionTemplate::GetFunction");
    }
    uVar1 = *(undefined4 *)(pIVar7 + 0x2c60);
    *(undefined4 *)(pIVar7 + 0x2c60) = 5;
    puVar3 = (ulong *)internal::ApiNatives::InstantiateFunction(this,0);
    puVar8 = local_48;
    if (puVar3 == (ulong *)0x0) {
      local_a0 = '\x01';
...
LAB_00ebccbc:
        ...
        if (*(code **)(lVar4 + 0xb738) == (code *)0x0) goto LAB_00ebccbc;
