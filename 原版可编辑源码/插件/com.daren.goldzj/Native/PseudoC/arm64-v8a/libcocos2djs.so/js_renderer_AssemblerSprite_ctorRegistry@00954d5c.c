...
/* js_renderer_AssemblerSprite_ctorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_AssemblerSprite_ctorRegistry(FunctionCallbackInfo *param_1)
