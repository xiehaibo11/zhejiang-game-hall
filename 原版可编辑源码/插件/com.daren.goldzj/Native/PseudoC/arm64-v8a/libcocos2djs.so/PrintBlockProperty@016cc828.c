...
/* v8::internal::compiler::GraphC1Visualizer::PrintBlockProperty(char const*, int) */

void __thiscall
v8::internal::compiler::GraphC1Visualizer::PrintBlockProperty
          (GraphC1Visualizer *this,char *param_1,int param_2)
