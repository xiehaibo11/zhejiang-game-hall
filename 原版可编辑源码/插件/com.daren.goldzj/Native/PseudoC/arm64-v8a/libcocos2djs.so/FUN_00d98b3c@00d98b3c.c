...
void FUN_00d98b3c(long *param_1)
...
LAB_00d98cf8:
              ...
              if (iVar1 != 0x202) goto LAB_00d98cf8;
            ...
            if (iVar1 == 0x204) {
              ...
              if (iVar1 != 0x303) goto LAB_00d98cf8;
            ...
            if (iVar1 != 0x402) goto LAB_00d98cf8;
          ...
          if (iVar1 < 0x505) {
            if (iVar1 == 0x404) {
              ...
              if (iVar1 != 0x408) goto LAB_00d98cf8;
            ...
            if (iVar1 != 0x50a) goto LAB_00d98cf8;
          ...
          if (iVar1 == 0x603) {
            ...
            if (iVar1 != 0x606) goto LAB_00d98cf8;
          ...
          if (iVar1 != 0x707) goto LAB_00d98cf8;
        ...
        *(code **)(lVar22 + lVar21 * 8 + 0x58) = pcVar17;
          ...
          if (iVar1 < 0xe0e) {
            if (iVar1 < 0xd0d) {
              if (iVar1 == 0xc06) {
                ...
                if (iVar1 != 0xc0c) goto LAB_00d98cf8;
              ...
              if (iVar1 != 0xe07) goto LAB_00d98cf8;
            ...
            if (iVar1 == 0xe0e) {
              ...
              if (iVar1 != 0xf0f) goto LAB_00d98cf8;
            ...
            if (iVar1 != 0x1010) goto LAB_00d98cf8;
        ...
        if (0x908 < iVar1) {
          if (iVar1 < 0xa0a) {
            if (iVar1 == 0x909) {
              ...
              if (iVar1 != 0xa05) goto LAB_00d98cf8;
            ...
            if (iVar1 != 0xb0b) goto LAB_00d98cf8;
        ...
        if (iVar1 < 0x808) {
          if (iVar1 == 0x70e) {
            ...
            if (iVar1 != 0x804) goto LAB_00d98cf8;
            pcVar17 = jpeg_fdct_8x4;
          }
          goto LAB_00d99084;
        }
        if (iVar1 != 0x808) {
          if (iVar1 != 0x810) goto LAB_00d98cf8;
...
LAB_00d99090:
      ...
      if (iVar24 == 2) {
        ...
        *(code **)(lVar22 + lVar21 * 8 + 8) = FUN_00d99d70;
      }
      else if (iVar24 == 1) {
        ...
        *(code **)(lVar22 + lVar21 * 8 + 8) = FUN_00d99c74;
      }
      else if (iVar24 == 0) {
        uVar27 = *(undefined8 *)puVar15;
        puVar16 = *(undefined8 **)(piVar23 + 9);
