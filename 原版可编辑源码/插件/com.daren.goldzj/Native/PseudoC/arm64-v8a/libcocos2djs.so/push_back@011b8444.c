...
/* std::__ndk1::__split_buffer<v8::AllocationProfile::Node*,
   std::__ndk1::allocator<v8::AllocationProfile::Node*>&>::push_back(v8::AllocationProfile::Node*&&)
    */
...

{
  ...
  puVar12 = puVar4;
  if (puVar4 != *(undefined8 **)(this + 0x18)) goto LAB_011b85cc;
...
LAB_011b8598:
      ...
      if (((void *)((long)pvVar6 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar6 + uVar13 * 8 + uVar9 + 8))) goto LAB_011b8598;
      ...
      puVar11 = puVar12;
      if (uVar2 != uVar9) goto LAB_011b8598;
    }
    puVar11 = *(undefined8 **)this;
  }
  *(void **)this = pvVar6;
