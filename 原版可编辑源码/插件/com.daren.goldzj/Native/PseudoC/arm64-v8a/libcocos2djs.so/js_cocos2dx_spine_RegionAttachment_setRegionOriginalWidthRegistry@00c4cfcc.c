...
/* js_cocos2dx_spine_RegionAttachment_setRegionOriginalWidthRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_RegionAttachment_setRegionOriginalWidthRegistry
...

{
  ...
  if (this == (RegionAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2060,"js_cocos2dx_spine_RegionAttachment_setRegionOriginalWidth");
    pcVar6 = "js_cocos2dx_spine_RegionAttachment_setRegionOriginalWidth : Invalid Native Object";
LAB_00c4d140:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::RegionAttachment::setRegionOriginalWidth(this,local_64);
        goto LAB_00c4d178;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x2067,"js_cocos2dx_spine_RegionAttachment_setRegionOriginalWidth");
      pcVar6 = 
      "js_cocos2dx_spine_RegionAttachment_setRegionOriginalWidth : Error processing arguments";
      goto LAB_00c4d140;
    }
    __android_log_print(6,"jswrapper",&DAT_0190d7b7,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_RegionAttachment_setRegionOriginalWidth",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x206e);
LAB_00c4d178:
