...
/* v8::internal::compiler::JSHeapBroker::ProcessFeedbackForInstanceOf(v8::internal::compiler::FeedbackSource
   const&) */

undefined8 __thiscall
v8::internal::compiler::JSHeapBroker::ProcessFeedbackForInstanceOf
...

{
  ...
  *this_00;
  ...
  if (lVar2 == 0) {
    uVar3 = ReadFeedbackForInstanceOf(this,param_1);
