...
/* std::__ndk1::__split_buffer<cocos2d::AsyncTaskPool::ThreadTasks::AsyncTaskCallBack*,
   std::__ndk1::allocator<cocos2d::AsyncTaskPool::ThreadTasks::AsyncTaskCallBack*>&>::push_front(cocos2d::AsyncTaskPool::ThreadTasks::AsyncTaskCallBack*
   const&) */
...

{
  ...
  puVar14 = __src;
  if (__src != *(undefined8 **)this) goto LAB_00a69e00;
...
LAB_00a69dd0:
      do {
        puVar12 = __src + 1;
                    /* catch() { ... } // from try @ 00a69bdc with catch @ 00a69dd4 */
                    /* catch() { ... } // from try @ 00a69bd0 with catch @ 00a69dd8 */
        *puVar8 = *__src;
        puVar8 = puVar8 + 1;
        __src = puVar12;
                    /* catch() { ... } // from try @ 00a69bb0 with catch @ 00a69ddc */
      ...
      puVar8 = __src + 2;
      __src = __src + uVar10;
                    /* try { // try from 00a69da8 to 00b69e43 has its CatchHandler @ 00a69b5c */
      ...
      do {
        ...
        puVar8 = puVar8 + 4;
        uVar13 = uVar13 - 4;
                    /* catch() { ... } // from try @ 00a69c1c with catch @ 00a69dbc
                       catch() { ... } // from try @ 00a69d64 with catch @ 00a69dbc */
        puVar12[-1] = *puVar3;
        puVar12[-2] = uVar15;
        puVar12[1] = uVar17;
        *puVar12 = uVar16;
      ...
      if (uVar2 != uVar10) goto LAB_00a69dd0;
    }
  ...
  *(void **)this = pvVar4;
  *(undefined8 **)(this + 8) = puVar14;
                    /* catch() { ... } // from try @ 00a69be8 with catch @ 00a69dec
                       catch() { ... } // from try @ 00a69c50 with catch @ 00a69dec */
