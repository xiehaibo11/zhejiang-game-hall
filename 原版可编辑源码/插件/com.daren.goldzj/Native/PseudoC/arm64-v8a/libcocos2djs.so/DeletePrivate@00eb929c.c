...
/* v8::Object::DeletePrivate(v8::Local<v8::Context>, v8::Local<v8::Private>) */

ushort __thiscall v8::Object::DeletePrivate(Object *this,long param_2,undefined8 param_3)

{
  ...
  if ((*(int *)(pIVar8 + 0x2c20) == *(int *)(pIVar8 + 0xa8)) ||
    ...
    *(int *)pIVar12 = *(int *)pIVar12 + 1;
    ...
    if ((uVar4 & 1) != 0) {
      internal::Logger::ApiEntryCall(this_00,"v8::Object::Delete");
    }
    uVar1 = *(undefined4 *)(pIVar8 + 0x2c60);
    *(undefined4 *)(pIVar8 + 0x2c60) = 5;
    uVar3 = internal::Runtime::DeleteObjectProperty(pIVar8,this,param_3,0);
    if ((uVar3 & 0xff) == 0) {
      local_a0 = '\x01';
