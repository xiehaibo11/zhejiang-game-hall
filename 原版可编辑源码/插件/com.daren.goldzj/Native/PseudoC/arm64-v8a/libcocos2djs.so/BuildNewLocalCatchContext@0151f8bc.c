...
/* v8::internal::interpreter::BytecodeGenerator::BuildNewLocalCatchContext(v8::internal::Scope*) */
...

{
  ...
  *(int *)(this + 0x11c) = iVar2;
  ...
  BytecodeArrayBuilder::StoreAccumulatorInRegister((BytecodeArrayBuilder *)(this + 0x18),iVar1);
  BytecodeArrayBuilder::CreateCatchContext((BytecodeArrayBuilder *)(this + 0x18),iVar1,param_1);
