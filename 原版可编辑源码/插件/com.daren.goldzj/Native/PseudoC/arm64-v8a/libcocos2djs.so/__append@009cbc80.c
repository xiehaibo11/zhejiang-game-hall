...

{
  ...
  ulong uVar5;
                    ...
                    /* try { // try from 009cbc84 to 00acbcd7 has its CatchHandler @ 009cbc84
                       catch() { ... } // from try @ 009cbc84 with catch @ 009cbc84
                       catch() { ... } // from try @ 009cbe64 with catch @ 009cbc84 */
  puVar4 = *(undefined8 **)(this + 8);
  if (param_1 <= (ulong)(*(long *)(this + 0x10) - (long)puVar4 >> 3)) {
    do {
      *puVar4 = 0;
                    /* try { // try from 009cbd04 to 00acbd0f has its CatchHandler @ 009cbed8 */
      param_1 = param_1 - 1;
      puVar4 = (undefined8 *)(*(long *)(this + 8) + 8);
      *(undefined8 **)(this + 8) = puVar4;
                    /* try { // try from 009cbd10 to 00acbe63 has its CatchHandler @ 009cbef0 */
    } while (param_1 != 0);
    return;
  }
  __src = *(void **)this;
  ...
  if ((ulong)(lVar2 >> 3) < 0xfffffffffffffff) {
                    /* try { // try from 009cbcd8 to 00acbcef has its CatchHandler @ 009cbee0 */
    uVar3 = lVar2 >> 2;
    uVar5 = uVar1;
    if (uVar1 <= uVar3) {
      uVar5 = uVar3;
    ...
    if (uVar5 >> 0x3d != 0) {
                    /* WARNING: Subroutine does not return */
                    /* try { // try from 009cbcf8 to 00acbd03 has its CatchHandler @ 009cbedc */
