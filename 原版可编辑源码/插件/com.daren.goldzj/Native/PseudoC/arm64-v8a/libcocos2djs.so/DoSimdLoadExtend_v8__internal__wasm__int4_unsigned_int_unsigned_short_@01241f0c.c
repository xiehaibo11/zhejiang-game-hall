...
/* bool v8::internal::wasm::ThreadImpl::DoSimdLoadExtend<v8::internal::wasm::int4, unsigned int,
   unsigned short>(v8::internal::wasm::Decoder*, v8::internal::wasm::InterpreterCode*, unsigned
   long, int*, v8::internal::MachineRepresentation) */

bool v8::internal::wasm::ThreadImpl::
     DoSimdLoadExtend<v8::internal::wasm::int4,unsigned_int,unsigned_short>(ulong param_1)

{
  ...
  if (bVar3) {
    ...
    *(long *)(param_1 + 0x28) = lVar4 + -0x11;
    ...
    local_50 = CONCAT44((int)((uint7)uStack_6f >> 0x10),(int)uStack_6f) & 0xffff0000ffff;
    uVar2 = CONCAT24((short)(CONCAT17(uStack_68,uStack_6f) >> 0x30),
                     (int)(CONCAT17(uStack_68,uStack_6f) >> 0x20));
    uStack_48 = (ulong)(uVar2 & 0xffff0000ffff);
    uStack_87 = (undefined7)local_50;
    uStack_68 = 0;
    uStack_67 = (uint7)uVar2 & 0xffff0000ffff;
    local_70 = 5;
    uStack_6f = uStack_87;
    local_60 = 0;
