...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<v8::internal::ThreadId,
   ...
   v8::internal::Isolate::PerIsolateThreadData*> >
   >::remove(std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<v8::internal::ThreadId,
   v8::internal::Isolate::PerIsolateThreadData*>, void*>*>) */
...

{
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar7 == uVar4) goto LAB_00f599dc;
  }
  if (*param_3 != 0) {
