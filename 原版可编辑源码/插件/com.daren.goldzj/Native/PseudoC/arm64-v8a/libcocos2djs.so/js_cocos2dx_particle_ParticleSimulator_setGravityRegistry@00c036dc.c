...
/* js_cocos2dx_particle_ParticleSimulator_setGravityRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_particle_ParticleSimulator_setGravityRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xd,"js_cocos2dx_particle_ParticleSimulator_setGravity");
    pcVar9 = "js_cocos2dx_particle_ParticleSimulator_setGravity : Invalid Native Object";
LAB_00c0388c:
    ...
    if (uVar10 == 0x30) {
      ...
      if ((((uVar10 & 1) != 0) && ((uVar6 & 1) != 0)) && ((uVar7 & 1) != 0)) {
        *(undefined4 *)(lVar4 + 0xd8) = local_78._4_4_;
        *(float *)(lVar4 + 0xdc) = (float)local_78;
        *(float *)(lVar4 + 0xe0) = local_7c;
        goto LAB_00c038c4;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                          ,0x18,"js_cocos2dx_particle_ParticleSimulator_setGravity");
      pcVar9 = "js_cocos2dx_particle_ParticleSimulator_setGravity : Error processing arguments";
      goto LAB_00c0388c;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp, 28): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar10 >> 4,3);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_particle_ParticleSimulator_setGravity",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                      ,0x1f);
LAB_00c038c4:
