...

{
  ...
  if (name != (X509_NAME *)0x0) {
    ...
    name->modified = 1;
                    /* try { // try from 00b63af8 to 00c63bc3 has its CatchHandler @ 00b63af8
                       catch() { ... } // from try @ 00b63af8 with catch @ 00b63af8
                       catch() { ... } // from try @ 00b63bd0 with catch @ 00b63af8
                       catch() { ... } // from try @ 00b63c34 with catch @ 00b63af8
                       catch() { ... } // from try @ 00b63d2c with catch @ 00b63af8
                       catch() { ... } // from try @ 00b64060 with catch @ 00b63af8
                       catch() { ... } // from try @ 00b640dc with catch @ 00b63af8 */
    if (set == -1) {
      if (iVar5 == 0) {
        iVar2 = 0;
        bVar1 = true;
      ...
      if (iVar2 != 0) {
        if ((bVar1) && (iVar2 = OPENSSL_sk_num(psVar4), iVar5 + 1 < iVar2)) {
          do {
            lVar3 = OPENSSL_sk_value(psVar4,iVar5);
            iVar5 = iVar5 + 1;
                    /* try { // try from 00b63bc4 to 00c63bcf has its CatchHandler @ 00b64124 */
