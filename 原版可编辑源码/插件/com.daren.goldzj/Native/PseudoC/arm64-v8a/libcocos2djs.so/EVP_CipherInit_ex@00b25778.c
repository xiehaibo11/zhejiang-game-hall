...
LAB_00b257e4:
    ctx->encrypt = iVar3;
    pEVar5 = ctx->cipher;
    if (ctx->engine == (ENGINE *)0x0) goto LAB_00b257f0;
LAB_00b257bc:
    if (pEVar5 == (EVP_CIPHER *)0x0) goto LAB_00b257f0;
    if ((cipher != (EVP_CIPHER *)0x0) && (cipher->nid != pEVar5->nid)) goto LAB_00b257f8;
LAB_00b25938:
    ...
    if (((uint)uVar6 >> 4 & 1) == 0) {
      ...
      case 5:
        ctx->num = 0;
        if (iv == (uchar *)0x0) goto switchD_00b259ec_caseD_0;
        iVar2 = EVP_CIPHER_CTX_iv_length(ctx);
        __dest = iv;
        break;
      default:
...
switchD_00b259ec_caseD_0:
  ...
  iVar3 = ctx->encrypt;
  pEVar5 = ctx->cipher;
  if (ctx->engine != (ENGINE *)0x0) goto LAB_00b257bc;
LAB_00b257f0:
  if (cipher == (EVP_CIPHER *)0x0) {
    if (pEVar5 != (EVP_CIPHER *)0x0) goto LAB_00b25938;
    iVar3 = 0x83;
    iVar2 = 0x90;
  }
  else {
...
LAB_00b257f8:
    ...
    if (impl == (ENGINE *)0x0) {
      ...
      if (impl != (ENGINE *)0x0) goto LAB_00b258b8;
    }
    else {
...
LAB_00b258b8:
    ...
    if (((byte)pEVar5->flags >> 6 & 1) == 0) goto LAB_00b25938;
    if (pEVar5 == (EVP_CIPHER *)0x0) {
      iVar3 = 0x83;
      iVar2 = 0x23e;
LAB_00b25b48:
