...
/* js_cocos2dx_spine_SkeletonDataMgr_setDestroyCallbackRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonDataMgr_setDestroyCallbackRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3b25,"js_cocos2dx_spine_SkeletonDataMgr_setDestroyCallback");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonDataMgr_setDestroyCallback : Invalid Native Object"
                       );
  }
  else {
    ...
    if (puVar5[1] - (long)pVVar6 == 0x10) {
      ...
      if (pVVar6[8] == (Value)0x5) {
        ...
        if ((uVar8 & 1) == 0) goto LAB_00c7d66c;
...
LAB_00c7d758:
        ...
        if (local_a0 == (long *)0x0) goto LAB_00c7d670;
        if (alStack_c0 != local_a0) {
          local_d0 = (long *)(**(code **)(*local_a0 + 0x10))();
          if (local_d0 != (long *)0x0) goto LAB_00c7d7d8;
          goto LAB_00c7d674;
        }
        local_d0 = local_f0;
        (**(code **)(*local_a0 + 0x18))(local_a0,local_f0);
        if (local_d0 == (long *)0x0) goto LAB_00c7d674;
LAB_00c7d7d8:
...
LAB_00c7d674:
      ...
      FUN_00c8e648(alStack_90,lVar4 + 0x10);
      if (alStack_90 == local_70) {
        pcVar11 = *(code **)(*local_70 + 0x20);
LAB_00c7d6ec:
        (*pcVar11)();
...
LAB_00c7d718:
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 15181): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(puVar5[1] - (long)pVVar6) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonDataMgr_setDestroyCallback",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x3b50);
LAB_00c7d624:
