...
/* dragonBones::BaseFactory::addDragonBonesData(dragonBones::DragonBonesData*,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&) */

void __thiscall
dragonBones::BaseFactory::addDragonBonesData
          (BaseFactory *this,DragonBonesData *param_1,basic_string *param_2)

{
  ...
  *this_00;
  ...
  pbVar2 = (basic_string *)(param_1 + 0x30);
  if (uVar1 != 0) {
    pbVar2 = param_2;
  }
  pBVar4 = (BaseFactory *)
  ...
  if (this + 0x18 == pBVar4) {
    ...
    lVar5 = std::__ndk1::
            ...
            __emplace_unique_key_args<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&>,std::__ndk1::tuple<>>
                      ((basic_string *)this_00,(piecewise_construct_t *)pbVar2,
                       (tuple *)&DAT_0194872d,(tuple *)&local_50);
    *(DragonBonesData **)(lVar5 + 0x38) = param_1;
  }
  else {
    local_50 = param_2;
    std::__ndk1::
    ...
    ::
    __emplace_unique_key_args<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::piecewise_construct_t_const&,std::__ndk1::tuple<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&>,std::__ndk1::tuple<>>
              ((basic_string *)this_00,(piecewise_construct_t *)param_2,(tuple *)&DAT_0194872d,
               (tuple *)&local_50);
  }
