...
/* JSB_glDeleteTexturesRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glDeleteTexturesRegistry(FunctionCallbackInfo *param_1)
...
LAB_008cbde4:
      ...
      if (1 < (byte)pVVar6[8]) goto LAB_008cbde4;
      lVar7 = 0;
      local_64 = 0;
      bVar2 = true;
    }
    glDeleteTextures(1,&local_64);
    FUN_008d3790(&DAT_01d36e08,local_64);
    if (!bVar2) {
