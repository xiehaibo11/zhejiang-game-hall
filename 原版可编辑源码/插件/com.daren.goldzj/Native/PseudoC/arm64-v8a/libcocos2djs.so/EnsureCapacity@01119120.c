...
/* v8::internal::HashTable<v8::internal::StringSet,
   v8::internal::StringSetShape>::EnsureCapacity(v8::internal::Isolate*,
   v8::internal::Handle<v8::internal::StringSet>, int, v8::internal::AllocationType) */

ulong * v8::internal::HashTable<v8::internal::StringSet,v8::internal::StringSetShape>::
...

{
  ...
  if (((iVar2 - param_3 == 0 || iVar2 < param_3) ||
    ...
    puVar3 = (ulong *)Factory::NewFixedArrayWithMap<v8::internal::FixedArray>
                                (param_1,0xe,iVar2 + 3,bVar1);
    *(undefined4 *)(*puVar3 + 7) = 0;
    *(undefined4 *)(*puVar3 + 0xb) = 0;
    *(int *)(*puVar3 + 0xf) = iVar2 << 1;
    local_38 = *param_2;
    Rehash((HashTable<v8::internal::StringSet,v8::internal::StringSetShape> *)&local_38,
           param_1 + 0x80,*puVar3);
  }
  return puVar3;
}
