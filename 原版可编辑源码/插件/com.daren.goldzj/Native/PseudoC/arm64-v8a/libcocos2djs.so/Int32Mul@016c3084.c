...
/* v8::internal::compiler::GraphAssembler::Int32Mul(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Int32Mul(GraphAssembler *this,Node *param_1,Node *param_2)
