...
/* void std::__ndk1::vector<dragonBones::TimelineData*,
   std::__ndk1::allocator<dragonBones::TimelineData*>
   >::__push_back_slow_path<dragonBones::TimelineData* const&>(dragonBones::TimelineData* const&) */

void __thiscall
std::__ndk1::vector<dragonBones::TimelineData*,std::__ndk1::allocator<dragonBones::TimelineData*>>::
...
LAB_00d34e54:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d34e54;
  }
  else {
