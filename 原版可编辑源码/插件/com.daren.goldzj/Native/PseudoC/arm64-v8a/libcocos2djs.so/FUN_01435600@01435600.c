...
void FUN_01435600(undefined8 param_1)

{
  ...
  cVar2 = *(char *)(unaff_x20 + unaff_x19 + 1);
  lVar4 = unaff_x26 +
  ...
  *(int *)(unaff_x29 + -0x20) = (int)unaff_x19 * 2;
  FUN_01392a60(cVar2 * 2,param_1);
                    /* WARNING: Could not recover jumptable at 0x014356dc. Too many branches */
