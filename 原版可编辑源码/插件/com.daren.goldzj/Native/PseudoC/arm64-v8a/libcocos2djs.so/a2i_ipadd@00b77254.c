...

{
  ...
  local_40 = 0;
  iVar4 = CONF_parse_list(ipasc,0x3a,0,FUN_00b77db0,&local_58);
  if (iVar4 == 0) {
LAB_00b7737c:
    bVar3 = false;
    iVar4 = 0x10;
  ...
  if (local_48._4_4_ == -1) {
    if ((int)local_48 != 0x10) goto LAB_00b7737c;
LAB_00b77340:
...
LAB_00b77348:
    ...
    if (((int)local_48 == 0x10) || (3 < local_40)) goto LAB_00b7737c;
    if (local_40 == 2) {
      if ((local_48._4_4_ != 0) && ((int)local_48 != local_48._4_4_)) goto LAB_00b7737c;
LAB_00b773b0:
      if (local_48 < 0) goto LAB_00b77340;
    ...
    if (local_40 == 3) {
      if (0 < (int)local_48) goto LAB_00b7737c;
      goto LAB_00b773b0;
    }
    bVar3 = false;
