...
/* v8::internal::compiler::JSTypeHintLowering::ReduceStoreNamedOperation(v8::internal::compiler::Operator
...
void v8::internal::compiler::JSTypeHintLowering::ReduceStoreNamedOperation
...

{
  ...
  lVar1 = TryBuildSoftDeopt(param_1,in_w6,param_5,in_x5,0xd);
  if (lVar1 == 0) {
    *param_1_00 = 0;
