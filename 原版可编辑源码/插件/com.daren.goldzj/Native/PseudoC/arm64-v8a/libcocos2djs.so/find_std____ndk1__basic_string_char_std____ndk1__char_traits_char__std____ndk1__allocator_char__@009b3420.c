...
/* std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   std::__ndk1::weak_ptr<cocos2d::TTFLabelAtals> > > >::find<std::__ndk1::basic_string<char,
...

{
  ...
  local_68 = *(long *)(lVar5 + 0x28);
                    /* try { // try from 009b3454 to 00ab345b has its CatchHandler @ 009b3514 */
  uVar7 = *(ulong *)(param_1 + 8);
  pbVar2 = *(basic_string **)(param_1 + 0x10);
                    /* try { // try from 009b345c to 00ab350b has its CatchHandler @ 009b3290 */
  if (((byte)*param_1 & 1) == 0) {
    pbVar2 = param_1 + 1;
      ...
      if (plVar8 != (long *)0x0) {
        ...
        do {
          ...
          if (uVar9 == uVar7) {
            ...
            if (sVar1 == __n) {
              __s1 = (void *)plVar8[4];
                    /* try { // try from 009b350c to 00ab3513 has its CatchHandler @ 009b3514 */
              if ((bVar3 & 1) == 0) {
                __s1 = (void *)((long)plVar8 + 0x11);
              }
              if ((bVar3 & 1) == 0) {
                    /* catch() { ... } // from try @ 009b3454 with catch @ 009b3514
                       catch() { ... } // from try @ 009b350c with catch @ 009b3514
                       try { // try from 009b3514 to 00ab3547 has its CatchHandler @ 009b3290 */
                if (__n == 0) break;
                pbVar10 = (basic_string *)((long)plVar8 + 0x11);
                lVar11 = -(ulong)(bVar3 >> 1);
                pbVar12 = pbVar2;
                    /* catch() { ... } // from try @ 009b33c0 with catch @ 009b352c */
                while (*pbVar10 == *pbVar12) {
                  pbVar10 = pbVar10 + 1;
                  lVar11 = lVar11 + 1;
                  pbVar12 = pbVar12 + 1;
                  if (lVar11 == 0) goto LAB_009b359c;
                }
              }
            ...
            if ((uVar14 & uVar13) == 0) {
              ...
              if (uVar9 - uVar4 * uVar13 == uVar15) goto LAB_009b3574;
              goto LAB_009b3598;
            }
            if (uVar9 != uVar15) goto LAB_009b3598;
          }
LAB_009b3574:
          plVar8 = (long *)*plVar8;
