...
void FUN_00dcb9fc(long param_1,long param_2,undefined8 param_3,undefined8 param_4,int param_5,
    ...
    do {
      ...
      do {
        ...
        *(uint *)(param_2 + lVar3 * 4) =
             CONCAT13(*(undefined1 *)(lVar2 + (ulong)*(ushort *)(param_12 + lVar4)),
                      CONCAT12(*(undefined1 *)(lVar2 + (ulong)*(ushort *)(param_11 + lVar4)),
                               CONCAT11(*(undefined1 *)
                                         (lVar2 + (ulong)*(ushort *)(param_10 + lVar4)),
