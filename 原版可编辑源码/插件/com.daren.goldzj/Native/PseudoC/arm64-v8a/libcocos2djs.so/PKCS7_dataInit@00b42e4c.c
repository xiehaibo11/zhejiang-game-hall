...
LAB_00b43314:
  ...
  if (0 < iVar1) {
    ...
    do {
      ...
      iVar2 = FUN_00b434c8(&local_70,uVar4);
      if (iVar2 == 0) goto LAB_00b43318;
      iVar1 = iVar1 + 1;
      iVar2 = OPENSSL_sk_num(psVar13);
    } while (iVar1 < iVar2);
  }
  if ((pXVar11 == (X509_ALGOR *)0x0) || (iVar1 = FUN_00b434c8(&local_70,pXVar11), iVar1 != 0)) {
    pBVar12 = local_70;
    if (cipher != (EVP_CIPHER *)0x0) {
      pBVar5 = BIO_f_cipher();
...
LAB_00b43484:
    ...
    local_70 = pBVar12;
    pBVar12 = local_70;
    if (bio != (BIO *)0x0) goto joined_r0x00b43388;
    iVar1 = OBJ_obj2nid(p7->type);
