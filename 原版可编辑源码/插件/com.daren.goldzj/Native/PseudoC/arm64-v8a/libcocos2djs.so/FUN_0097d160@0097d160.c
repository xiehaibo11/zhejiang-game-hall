...
void FUN_0097d160(long param_1,int *param_2,float *param_3,float *param_4)

{
  ...
  std::__ndk1::vector<se::Value,std::__ndk1::allocator<se::Value>>::__append
            ((vector<se::Value,std::__ndk1::allocator<se::Value>> *)&local_88,3);
  int32_to_seval(iVar1,local_88);
  float_to_seval(fVar9,local_88 + 0x10);
  float_to_seval(fVar8,local_88 + 0x20);
