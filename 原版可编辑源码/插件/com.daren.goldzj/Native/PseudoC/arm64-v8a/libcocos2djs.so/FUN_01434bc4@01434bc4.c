...
void FUN_01434bc4(undefined8 param_1,undefined8 param_2,undefined8 param_3,long param_4,
...

{
  ...
  *(double *)(uVar5 + 3) = (double)in_w9 * (double)param_7;
  ...
  (**(code **)(unaff_x21 + (ulong)*(byte *)(*(long *)(param_4 + -0x18) + unaff_x19 + 3) * 8))(uVar5)
  ;
  return;
}
