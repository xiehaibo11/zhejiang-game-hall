...
/* spine::Skeleton::findTransformConstraint(spine::String const&) */

long __thiscall spine::Skeleton::findTransformConstraint(Skeleton *this,String *param_1)

{
  ...
  if (uVar4 != 0) {
    uVar5 = 0;
    do {
      lVar3 = *(long *)(*(long *)(this + 0xa8) + uVar5 * 8);
