...
ulong FUN_0109d154(ulong *param_1,int param_2)

{
  ...
  FUN_0109d024(this,*puVar4,0,*puVar5,bVar1,0,0xffffffff);
  uVar6 = v8::internal::JSObject::GetElementsTransitionMap(param_1,9);
  ...
  *(int *)(uVar9 + 7) = (int)uVar7;
  ...
  uVar7 = v8::internal::JSObject::PrintElementsTransition(waitpid,param_1,bVar1,puVar4,9,puVar5);
  return uVar7;
}
