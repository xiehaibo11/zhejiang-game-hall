...
/* spine::SkeletonAnimation::setTrackEndListener(spine::TrackEntry*, std::__ndk1::function<void
...

{
  ...
  if (lVar5 == 0) {
    ...
    *(undefined8 *)(param_1 + 0x18) = 0;
    ...
    if (plVar2 == (long *)0x0) goto LAB_00d0fc90;
LAB_00d0fc20:
    ...
    plVar2 = *(long **)(param_2 + 0x20);
    if (plVar2 != (long *)0x0) goto LAB_00d0fc20;
LAB_00d0fc90:
    local_50 = (long *)0x0;
  }
  FUN_00c8c388(alStack_70,lVar5 + 0x60);
  if (alStack_70 == local_50) {
    pcVar4 = *(code **)(*local_50 + 0x20);
  }
  else {
    if (local_50 == (long *)0x0) goto LAB_00d0fce8;
