...
void FUN_0107d368(ulong param_1,ulong param_2,ulong param_3,long param_4)

{
  ...
  case 0x12:
    ...
    break;
  case 0x13:
    goto switchD_0107d4a8_caseD_13;
  case 0x14:
    if (param_3 != 0) {
      if ((param_3 < 8) ||
    ...
    if (param_3 != 0) {
      ...
      do {
        ...
        if (((fVar17 < -2.1474836e+09) || (2147483647.0 < dVar16)) ||
          ...
          if ((int)uVar1 < 0) {
            if ((int)uVar1 < -0x34) goto LAB_0107d768;
    ...
    if (param_3 != 0) {
      ...
      do {
        ...
        if ((((dVar16 < -2147483648.0) || (2147483647.0 < dVar16)) || (ABS(dVar16) == INFINITY)) ||
          ...
          if ((int)uVar1 < 0) {
            if ((int)uVar1 < -0x34) goto LAB_0107d60c;
            uVar15 = (ulong)dVar16 & 0xfffffffffffff;
            if (((ulong)dVar16 & 0x7ff0000000000000) != 0) {
              uVar15 = (ulong)dVar16 & 0xfffffffffffff | 0x10000000000000;
            }
...
LAB_0107d610:
    ...
    break;
  case 0x19:
    goto switchD_0107d4a8_caseD_19;
  case 0x1a:
    if (param_3 == 0) break;
    FUN_010b8eb0();
switchD_0107d4a8_caseD_13:
    if (param_3 != 0) {
      if ((param_3 < 8) ||
         ((pbVar9 + param_4 * 4 < (byte *)((long)__src + param_3 * 2) &&
          (__src < pbVar9 + (param_4 + param_3) * 4)))) {
