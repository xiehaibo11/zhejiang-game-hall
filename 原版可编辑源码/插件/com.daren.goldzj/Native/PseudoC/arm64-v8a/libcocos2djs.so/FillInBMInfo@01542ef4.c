...
/* v8::internal::BackReferenceNode::FillInBMInfo(v8::internal::Isolate*, int, int,
   v8::internal::BoyerMooreLookahead*, bool) */

void __thiscall
v8::internal::BackReferenceNode::FillInBMInfo
          (BackReferenceNode *this,Isolate *param_1,int param_2,int param_3,
