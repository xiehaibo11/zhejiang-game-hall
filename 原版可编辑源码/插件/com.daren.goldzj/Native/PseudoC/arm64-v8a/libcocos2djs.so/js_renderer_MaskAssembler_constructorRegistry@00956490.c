...
/* js_renderer_MaskAssembler_constructorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_MaskAssembler_constructorRegistry(FunctionCallbackInfo *param_1)
