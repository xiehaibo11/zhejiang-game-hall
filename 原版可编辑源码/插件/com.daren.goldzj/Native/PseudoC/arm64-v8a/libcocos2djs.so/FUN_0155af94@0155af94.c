...
undefined8 FUN_0155af94(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_90,(ulong)&local_90 | 8,0xe9);
  }
  if (DAT_01d46de0 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d46de0 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d46de0;
  local_b0 = (byte **)0x0;
  if ((*DAT_01d46de0 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar3,"V8.Runtime_Runtime_SetGrow",0,0,0,0,0,0,0,&local_60,0);
    plVar4 = local_58;
    local_58 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
      (**(code **)(*plVar4 + 8))();
    ...
    local_b0 = &local_a8;
    local_a0 = "V8.Runtime_Runtime_SetGrow";
    local_a8 = pbVar3;
    local_98 = uVar5;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  uVar8 = *param_2;
  if (((uVar8 & 1) != 0) &&
     (*(short *)((uVar8 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar8 - 1)) == 0x41d)) {
    ...
    puVar6 = (ulong *)v8::internal::OrderedHashTable<v8::internal::OrderedHashSet,1>::EnsureGrowable
                                (param_3,puVar6);
    if (puVar6 == (ulong *)0x0) {
