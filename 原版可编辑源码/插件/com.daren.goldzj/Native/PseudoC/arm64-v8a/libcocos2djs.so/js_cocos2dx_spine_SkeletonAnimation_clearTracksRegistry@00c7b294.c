...
/* js_cocos2dx_spine_SkeletonAnimation_clearTracksRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonAnimation_clearTracksRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonAnimation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x39b0,"js_cocos2dx_spine_SkeletonAnimation_clearTracks");
    __android_log_print(6,"jswrapper",&DAT_01921bfd);
  }
  else {
    ...
    __android_log_print(6,"jswrapper",&DAT_01921c45,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
