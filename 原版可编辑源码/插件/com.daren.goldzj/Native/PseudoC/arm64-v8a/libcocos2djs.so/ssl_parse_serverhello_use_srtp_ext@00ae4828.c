...
LAB_00ae4850:
    ...
    puVar10 = (undefined1 *)*param_2;
                    /* try { // try from 00ae4890 to 00be4893 has its CatchHandler @ 00ae49d4 */
    uVar1 = *puVar10;
                    /* try { // try from 00ae4894 to 00be49f3 has its CatchHandler @ 00ae4720 */
    uVar2 = puVar10[1];
    *param_2 = (long)(puVar10 + 2);
    param_2[1] = uVar8 - 2;
    if ((CONCAT11(uVar1,uVar2) != 2) || (uVar8 - 2 < 2)) goto LAB_00ae4850;
    uVar1 = puVar10[2];
    uVar2 = puVar10[3];
    *param_2 = (long)(puVar10 + 4);
    param_2[1] = uVar8 - 4;
    if (uVar8 - 4 == 0) goto LAB_00ae4850;
    cVar3 = puVar10[4];
    *param_2 = (long)(puVar10 + 5);
    param_2[1] = uVar8 - 5;
    if (uVar8 - 5 != 0) goto LAB_00ae4850;
    if (cVar3 != '\0') {
