...
/* v8::internal::Runtime_CheckProxyHasTrapResult(int, unsigned long*, v8::internal::Isolate*) */

undefined8
v8::internal::Runtime_CheckProxyHasTrapResult(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar5 = FUN_0157b5ec(param_1,param_2,param_3);
    return uVar5;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar6 & 1) != 0) &&
    ...
    if (((uVar6 & 1) != 0) &&
      ...
      uVar4 = JSProxy::CheckHasTrap(param_3);
      pIVar1 = param_3 + 0xb8;
      if (uVar4 < 0x100) {
        pIVar1 = param_3 + 0xc0;
      }
