...
/* js_cocos2dx_dragonbones_Matrix_get_tyRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_Matrix_get_tyRegistry(undefined8 param_1,PropertyCallbackInfo *param_2)

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xe7,"js_cocos2dx_dragonbones_Matrix_get_ty");
    __android_log_print(6,"jswrapper",&DAT_0192cf0f);
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_dragonbones_Matrix_get_ty",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0xef);
  }
  else {
