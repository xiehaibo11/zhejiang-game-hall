    ...
    if ((*(byte *)(lVar3 + 0x18) & 0x14) == 0) {
      ...
      if (iVar1 < 0x80) {
        ...
        goto LAB_00ae1544;
                    ...
                    /* try { // try from 00ae14a4 to 00be14af has its CatchHandler @ 00ae15e8 */
      if (*(int *)(lVar3 + 0x3c) != 0x100) goto LAB_00ae1544;
      iVar1 = 0x80;
    }
    pDVar2 = DH_new();
    if (pDVar2 != (DH *)0x0) {
      ...
      if (iVar1 < 0xc0) {
        ...
        a_00 = (BIGNUM *)BN_get_rfc3526_prime_8192(0);
                    ...
                    /* try { // try from 00ae1520 to 00be152b has its CatchHandler @ 00ae15e4 */
