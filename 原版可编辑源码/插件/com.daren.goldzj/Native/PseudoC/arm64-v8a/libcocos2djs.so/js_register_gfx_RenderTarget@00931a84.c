...
/* js_register_gfx_RenderTarget(se::Object*) */

undefined8 js_register_gfx_RenderTarget(Object *param_1)

{
  ...
  se::Class::defineFinalizeFunction(this,js_cocos2d_renderer_RenderTarget_finalizeRegistry);
  se::Class::install(this);
  local_48 = SUB81(this,0);
  uStack_47 = (undefined7)((ulong)this >> 8);
  local_30 = (Class *)0x18690c4;
  std::__ndk1::
  ...
  __jsb_cocos2d_renderer_RenderTarget_proto = se::Class::getProto(this);
  __jsb_cocos2d_renderer_RenderTarget_class = this;
