...
/* v8::internal::compiler::EffectControlLinearizer::LowerCheckedUint32ToTaggedSigned(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerCheckedUint32ToTaggedSigned
...

{
  ...
  uVar3 = GraphAssembler::Uint32LessThanOrEqual(this_00,pNVar4,pNVar2);
