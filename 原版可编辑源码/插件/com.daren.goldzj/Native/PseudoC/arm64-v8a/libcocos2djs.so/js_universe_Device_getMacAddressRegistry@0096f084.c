...
/* js_universe_Device_getMacAddressRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_universe_Device_getMacAddressRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (*(long *)(this + 8) - *(long *)this == 0) {
    universe::Device::getMacAddress(this);
    ...
    if (bVar1) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0x4fd,"js_universe_Device_getMacAddress");
      __android_log_print(6,"jswrapper",
                          "js_universe_Device_getMacAddress : Error processing arguments");
    }
    if (((byte)local_78[0] & 1) != 0) {
      operator_delete(local_68);
    }
    if (!bVar1) goto LAB_0096f1ac;
  }
  else {
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp, 1280): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(*(long *)(this + 8) - *(long *)this) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_universe_Device_getMacAddress",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp"
                      ,0x503);
LAB_0096f1ac:
  pVVar6 = (Value *)se::State::rval(aSStack_60);
