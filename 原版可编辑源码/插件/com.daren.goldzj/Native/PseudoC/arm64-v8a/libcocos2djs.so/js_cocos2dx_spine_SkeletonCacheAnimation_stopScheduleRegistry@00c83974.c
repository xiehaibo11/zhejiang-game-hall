...
/* js_cocos2dx_spine_SkeletonCacheAnimation_stopScheduleRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonCacheAnimation_stopScheduleRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonCacheAnimation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3ee4,"js_cocos2dx_spine_SkeletonCacheAnimation_stopSchedule");
    __android_log_print(6,"jswrapper",&DAT_019251ea);
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      spine::SkeletonCacheAnimation::stopSchedule(this);
      goto LAB_00c83ac4;
    }
    __android_log_print(6,"jswrapper",&DAT_01925238,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonCacheAnimation_stopSchedule",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x3eee);
LAB_00c83ac4:
