...
/* v8::internal::Assembler::shll2(v8::internal::VRegister const&, v8::internal::VRegister const&,
   int) */

void v8::internal::Assembler::shll2(VRegister *param_1,VRegister *param_2,int param_3)
