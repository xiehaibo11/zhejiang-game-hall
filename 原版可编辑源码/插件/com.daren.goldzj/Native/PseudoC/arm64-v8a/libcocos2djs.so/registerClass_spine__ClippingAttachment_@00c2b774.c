...
/* void JSBClassType::registerClass<spine::ClippingAttachment>(se::Class*) */

void JSBClassType::registerClass<spine::ClippingAttachment>(Class *param_1)
