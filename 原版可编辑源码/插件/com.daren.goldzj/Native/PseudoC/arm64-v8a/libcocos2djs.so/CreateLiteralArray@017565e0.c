...
/* v8::internal::compiler::JSOperatorBuilder::CreateLiteralArray(v8::internal::Handle<v8::internal::ArrayBoilerplateDescription>,
   v8::internal::compiler::FeedbackSource const&, int, int) */

Operator * __thiscall
v8::internal::compiler::JSOperatorBuilder::CreateLiteralArray
...

{
  ...
  Operator::Operator(pOVar2,0x2e1,0,"JSCreateLiteralArray",0,1,1,1,1,2);
