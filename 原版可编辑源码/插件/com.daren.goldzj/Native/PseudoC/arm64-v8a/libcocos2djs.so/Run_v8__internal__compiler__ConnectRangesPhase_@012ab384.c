...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::ConnectRangesPhase>() */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::ConnectRangesPhase>
          (PipelineImpl *this)

{
  ...
  if (this_00 != (PipelineStatistics *)0x0) {
    PipelineStatistics::BeginPhase(this_00,"V8.TFConnectRanges");
  }
  this_01 = *(ZoneStats **)(lVar5 + 0x30);
  lVar4 = *(long *)(lVar5 + 0xb0);
  if (lVar4 != 0) {
    local_60 = *(undefined8 *)(lVar4 + 0x30);
    *(char **)(lVar4 + 0x30) = "V8.TFConnectRanges";
  }
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFConnectRanges");
  LiveRangeConnector::LiveRangeConnector(aLStack_18,*(RegisterAllocationData **)(lVar5 + 0x170));
  LiveRangeConnector::ConnectRanges(aLStack_18,pZVar2);
