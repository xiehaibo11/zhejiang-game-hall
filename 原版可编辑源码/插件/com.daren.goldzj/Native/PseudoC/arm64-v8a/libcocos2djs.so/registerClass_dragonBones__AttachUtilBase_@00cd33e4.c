...
/* void JSBClassType::registerClass<dragonBones::AttachUtilBase>(se::Class*) */

void JSBClassType::registerClass<dragonBones::AttachUtilBase>(Class *param_1)
