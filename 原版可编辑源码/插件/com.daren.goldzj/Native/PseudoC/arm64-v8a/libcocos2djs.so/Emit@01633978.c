...
v8::internal::compiler::InstructionSelector::Emit
          ...
          undefined8 param_5,undefined8 param_6,undefined8 param_7,undefined8 param_8,ulong param_9,
          InstructionOperand *param_10)

{
  ...
  if (param_9 < 0x3f) {
    ...
    uVar2 = 0x30;
    if (lVar1 + param_9 != 0) {
      uVar2 = (long)((lVar1 + param_9 << 0x23) + 0x2800000000) >> 0x20;
    }
    local_70 = param_4;
    uStack_68 = param_5;
    local_60 = param_6;
    ...
    Instruction::Instruction
              (this_01,param_1,(ulong)((param_3 & 7) != 0),(InstructionOperand *)&local_48,5,
               (InstructionOperand *)&local_70,param_9,param_10);
