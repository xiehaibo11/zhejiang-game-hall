...
LAB_017fc9fc:
  ...
  if ((param_2 == (long *)0x0) || (param_2[3] != param_2[4])) {
    if (param_3 != (long *)0x0) goto LAB_017fca10;
LAB_017fca58:
    param_3 = (long *)0x0;
    if (plVar15 == (long *)0x0) goto LAB_017fcb4c;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_017fca58;
LAB_017fca10:
...
LAB_017fcb4c:
  ...
  auVar18 = FUN_01829160(pcVar17,local_170,param_5);
  *param_6 = auVar18;
  uVar5 = (ulong)((byte)local_150[0] >> 1);
  if (((byte)local_150[0] & 1) != 0) {
    uVar5 = local_148;
  ...
  if (uVar5 != 0) {
    ...
    if (local_130 < puVar7) {
      ...
      do {
        if ((bVar14) && (*puVar13 != uVar8)) goto LAB_017fcca8;
...
LAB_017fcca8:
  ...
  if ((plVar15 == (long *)0x0) || (plVar15[3] != plVar15[4])) {
    if (param_3 != (long *)0x0) goto LAB_017fccc4;
LAB_017fcd70:
    if (plVar16 != (long *)0x0) goto LAB_017fccf8;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_017fcd70;
LAB_017fccc4:
    if ((param_3[3] == param_3[4]) && (iVar4 = (**(code **)(*param_3 + 0x48))(param_3), iVar4 == -1)
       ) goto LAB_017fcd70;
    if (plVar16 == (long *)0x0) goto LAB_017fccf8;
