...
/* v8::internal::interpreter::BytecodeArrayBuilder::CreateArrayLiteral(unsigned long, int, int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::CreateArrayLiteral
