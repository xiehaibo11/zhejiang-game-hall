...
/* bool spine_Vector_T_ptr_to_seval<spine::Timeline>(spine::Vector<spine::Timeline*> const&,
   se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::Timeline>(Vector *param_1,Value *param_2)
...
LAB_00c8521c:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::Timeline>
