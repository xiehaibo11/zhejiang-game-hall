...
/* void 
   v8::internal::Code::BodyDescriptor::IterateBody<v8::internal::YoungGenerationMarkingVisitor>(v8::internal::Map,
   v8::internal::HeapObject, v8::internal::YoungGenerationMarkingVisitor*) */

void v8::internal::Code::BodyDescriptor::IterateBody<v8::internal::YoungGenerationMarkingVisitor>
               (undefined8 param_1,long param_2,ObjectVisitor *param_3)
          ...
          while( true ) {
            ...
            while (*puVar2 == uVar3) {
              ...
              if (cVar4 == '\0') {
                ...
                puVar12 = (undefined8 *)(lVar10 + (long)*(int *)(param_3 + 0x10) * 0x50);
...
LAB_00fefa7c:
  ...
  RelocIterator::RelocIterator(aRStack_a0,param_2,1999);
  ObjectVisitor::VisitRelocInfo(param_3,aRStack_a0);
  return;
}
