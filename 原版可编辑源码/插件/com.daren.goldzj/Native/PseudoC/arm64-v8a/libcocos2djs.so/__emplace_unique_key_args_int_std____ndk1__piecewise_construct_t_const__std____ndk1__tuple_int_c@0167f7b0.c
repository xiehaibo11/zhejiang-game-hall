...
/* std::__ndk1::pair<std::__ndk1::__tree_iterator<std::__ndk1::__value_type<int,
   ...
   v8::internal::compiler::BytecodeGraphBuilder::Environment*>, void*>*, long>, bool>
   ...
   v8::internal::compiler::BytecodeGraphBuilder::Environment*> > >::__emplace_unique_key_args<int,
