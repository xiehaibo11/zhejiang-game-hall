...

{
  ...
  if ((param_2 != param_3) && (pcVar4 = param_2, *param_2 != '\n')) {
    ...
    if (pcVar8 != param_2) {
      __parse_extended_reg_exp<std::__ndk1::__wrap_iter<char_const*>>(this,param_2,pcVar8);
      goto LAB_009c36bc;
    }
  }
  ...
  while (pcVar8 != param_3) {
    ...
    if (pcVar8 == pcVar6) {
      ...
      *(undefined8 *)(this + 0x38) = *(undefined8 *)(*(long *)(this + 0x38) + 8);
      ...
      __parse_extended_reg_exp<std::__ndk1::__wrap_iter<char_const*>>(this,pcVar8,pcVar6);
    }
