...
/* v8::internal::Handle<v8::internal::String> v8::internal::JsonParser<unsigned
   char>::DecodeString<v8::internal::SeqTwoByteString>(v8::internal::JsonString const&,
   v8::internal::Handle<v8::internal::SeqTwoByteString>, v8::internal::Handle<v8::internal::String>)
    */

long * __thiscall
v8::internal::JsonParser<unsigned_char>::DecodeString<v8::internal::SeqTwoByteString>
