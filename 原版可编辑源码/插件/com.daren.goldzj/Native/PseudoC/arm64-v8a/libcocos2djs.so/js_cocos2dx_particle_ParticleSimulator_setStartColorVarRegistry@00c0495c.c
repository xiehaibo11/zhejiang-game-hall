...
/* js_cocos2dx_particle_ParticleSimulator_setStartColorVarRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_particle_ParticleSimulator_setStartColorVarRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xb2,"js_cocos2dx_particle_ParticleSimulator_setStartColorVar");
    pcVar10 = "js_cocos2dx_particle_ParticleSimulator_setStartColorVar : Invalid Native Object";
LAB_00c04b30:
    ...
    if (uVar11 == 0x40) {
      ...
      {
        *(uchar *)(lVar4 + 0x100) = local_84[0];
        *(uchar *)(lVar4 + 0x101) = local_88[0];
        *(uchar *)(lVar4 + 0x102) = local_8c[0];
        *(uchar *)(lVar4 + 0x103) = local_90[0];
        goto LAB_00c04b68;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                          ,0xbf,"js_cocos2dx_particle_ParticleSimulator_setStartColorVar");
      pcVar10 = 
      "js_cocos2dx_particle_ParticleSimulator_setStartColorVar : Error processing arguments";
      goto LAB_00c04b30;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp, 195): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar11 >> 4,4);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_particle_ParticleSimulator_setStartColorVar",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                      ,0xc6);
LAB_00c04b68:
