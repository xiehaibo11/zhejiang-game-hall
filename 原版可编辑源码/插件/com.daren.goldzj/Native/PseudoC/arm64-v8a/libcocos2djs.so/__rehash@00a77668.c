...

{
  ...
  ulong uVar17;
                    ...
                    /* try { // try from 00a7768c to 00b77693 has its CatchHandler @ 00a7789c */
  if (param_1 == 0) {
    pvVar9 = *(void **)this;
    *(undefined8 *)this = 0;
    if (pvVar9 != (void *)0x0) {
    ...
    *(undefined8 *)(this + 8) = 0;
    ...
    if (param_1 >> 0x3d != 0) {
      ...
      abort();
                    ...
                    /* try { // try from 00a776a0 to 00b776c3 has its CatchHandler @ 00a77898 */
    ...
    do {
      *(undefined8 *)(*(long *)this + uVar11 * 8) = 0;
      uVar11 = uVar11 + 1;
                    ...
                    /* try { // try from 00a776d8 to 00b7773f has its CatchHandler @ 00a778cc */
      ...
      for (plVar15 = (long *)*plVar14; plVar15 != (long *)0x0; plVar15 = (long *)*plVar15) {
        ...
        if ((uVar16 & param_1) == 0) {
          uVar17 = uVar17 & uVar16;
                    ...
                    /* try { // try from 00a77744 to 00b77787 has its CatchHandler @ 00a7789c */
          if (param_1 <= uVar17) {
            uVar4 = 0;
            if (param_1 != 0) {
            ...
            *(long **)(*(long *)this + uVar17 * 8) = plVar14;
            ...
            if ((long *)*plVar15 != (long *)0x0) {
              bVar3 = *(byte *)(plVar15 + 2);
                    /* try { // try from 00a7778c to 00b777cf has its CatchHandler @ 00a77898 */
              __n = (ulong)(bVar3 >> 1);
              if ((bVar3 & 1) != 0) {
                __n = plVar15[3];
              }
              ...
              do {
                ...
                if ((bVar3 & 1) == 0) {
                  while (sVar6 != 0) {
                    if (*pcVar5 != *__s2) goto LAB_00a7784c;
                    __s2 = __s2 + 1;
                    sVar1 = sVar1 + 1;
                    pcVar5 = pcVar5 + 1;
                    sVar6 = sVar1;
                    ...
                    /* try { // try from 00a77824 to 00b77923 has its CatchHandler @ 00a775cc */
...
LAB_00a7784c:
        ...
        plVar14 = plVar15;
                    ...
                    /* catch() { ... } // from try @ 00a776a0 with catch @ 00a77898
                       catch() { ... } // from try @ 00a7778c with catch @ 00a77898 */
                    /* catch() { ... } // from try @ 00a7768c with catch @ 00a7789c
                       catch() { ... } // from try @ 00a77744 with catch @ 00a7789c */
  return;
}
