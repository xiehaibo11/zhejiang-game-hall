...
/* cocos2d::Scheduler::performFunctionInCocosThread(std::__ndk1::function<void ()> const&) */

void __thiscall cocos2d::Scheduler::performFunctionInCocosThread(Scheduler *this,function *param_1)
