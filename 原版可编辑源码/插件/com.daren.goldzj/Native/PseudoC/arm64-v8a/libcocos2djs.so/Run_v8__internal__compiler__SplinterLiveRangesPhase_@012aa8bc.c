...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::SplinterLiveRangesPhase>()
    */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::SplinterLiveRangesPhase>
          (PipelineImpl *this)

{
  ...
  if (this_00 != (PipelineStatistics *)0x0) {
    PipelineStatistics::BeginPhase(this_00,"V8.TFSplinterLiveRanges");
  }
  this_01 = *(ZoneStats **)(lVar5 + 0x30);
  lVar4 = *(long *)(lVar5 + 0xb0);
  if (lVar4 != 0) {
    local_70 = *(undefined8 *)(lVar4 + 0x30);
    *(char **)(lVar4 + 0x30) = "V8.TFSplinterLiveRanges";
  }
  ...
  lVar2 = ZoneStats::NewEmptyZone(this_01,"V8.TFSplinterLiveRanges");
  local_40 = *(undefined8 *)(lVar5 + 0x170);
  lStack_38 = lVar2;
  LiveRangeSeparator::Splinter((LiveRangeSeparator *)&local_40);
