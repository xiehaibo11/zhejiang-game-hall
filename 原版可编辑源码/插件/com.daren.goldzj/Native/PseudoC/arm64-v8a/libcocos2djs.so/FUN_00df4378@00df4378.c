...
void FUN_00df4378(byte *param_1,ulong *param_2,int param_3)

{
  ...
  if (param_3 < 4) {
    FUN_00df2c3c(param_1,param_2,param_3);
    return;
  }
  ...
  FUN_00df2c3c(param_1,(long)param_2 + lVar1 * 4,param_3 - (int)lVar1);
  return;
}
