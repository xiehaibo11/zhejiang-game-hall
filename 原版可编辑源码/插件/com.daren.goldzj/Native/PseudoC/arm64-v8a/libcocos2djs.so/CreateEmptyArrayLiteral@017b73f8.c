...
/* v8::internal::interpreter::BytecodeArrayBuilder::CreateEmptyArrayLiteral(int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::CreateEmptyArrayLiteral
          (BytecodeArrayBuilder *this,int param_1)
