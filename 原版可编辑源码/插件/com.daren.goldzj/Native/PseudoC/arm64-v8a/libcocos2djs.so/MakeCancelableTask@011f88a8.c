...
/* v8::internal::MakeCancelableTask(v8::internal::Isolate*, std::__ndk1::function<void ()>) */
...

{
  ...
  CancelableTask::CancelableTask(this_00,(Isolate *)this);
  ...
  if (local_60 == (long *)0x0) {
    ...
    *(CancelableTask **)(this_00 + 0x50) = this_00 + 0x30;
    ...
    if (alStack_80 == local_60) {
      ...
      if (local_60 == (long *)0x0) goto LAB_011f89b0;
