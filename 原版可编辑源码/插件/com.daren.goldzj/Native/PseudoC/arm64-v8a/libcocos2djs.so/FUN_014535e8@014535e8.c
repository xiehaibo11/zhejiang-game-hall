...
void FUN_014535e8(ulong param_1)

{
      ...
      *(undefined4 *)(lVar6 + -0x20) = uVar9;
      ...
      if (uVar2 < 0x40) {
        *(undefined4 *)(lVar6 + -0x20) = uVar9;
        ...
        uVar7 = FUN_01345720(param_1,uVar11);
        lVar6 = unaff_x29[-4];
  ...
  if (bVar3) {
    uVar4 = uVar4 | 2;
    if ((int)param_1 <= (int)uVar11) goto LAB_014536c4;
  }
  else {
  ...
  if ((int)lVar6 != (int)*(undefined8 *)(unaff_x26 + 0xa0)) {
    ...
    if (uVar8 != uVar4) {
      ...
      *(undefined4 *)(lVar6 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x01453744. Too many branches */
