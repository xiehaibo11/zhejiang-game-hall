...
/* js_register_renderer_SlicedSprite3D(se::Object*) */

undefined8 js_register_renderer_SlicedSprite3D(Object *param_1)

{
  ...
  uStack_3f = 0x443365746972;
  uStack_47 = 0x646563696c53;
  uStack_41 = 0x53;
  uStack_40 = 0x70;
  local_39 = 0;
  this = (Class *)se::Class::create(&local_48,param_1,__jsb_cocos2d_renderer_AssemblerSprite_proto,
                                    js_renderer_SlicedSprite3D_constructorRegistry);
  if (((byte)local_48 & 1) != 0) {
    operator_delete(local_38);
  }
  se::Class::defineFunction(this,"ctor",js_renderer_SlicedSprite3D_ctorRegistry);
  se::Class::defineFinalizeFunction(this,js_cocos2d_renderer_SlicedSprite3D_finalizeRegistry);
  se::Class::install(this);
  local_30 = (Class *)0x188c3e8;
  ...
  __jsb_cocos2d_renderer_SlicedSprite3D_proto = se::Class::getProto(this);
  __jsb_cocos2d_renderer_SlicedSprite3D_class = this;
