...
/* js_cocos2dx_dragonbones_EventObject_get_typeRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_EventObject_get_typeRegistry
...

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1920,"js_cocos2dx_dragonbones_EventObject_get_type");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_EventObject_get_type : Invalid Native Object");
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_dragonbones_EventObject_get_type",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x1928);
  }
  else {
    se::Value::Value(aVStack_58);
    std_string_to_seval((basic_string *)(lVar3 + 0x18),aVStack_58);
