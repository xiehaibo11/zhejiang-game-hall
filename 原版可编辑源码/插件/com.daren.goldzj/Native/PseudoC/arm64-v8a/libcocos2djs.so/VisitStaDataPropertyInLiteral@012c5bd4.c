...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitStaDataPropertyInLiteral(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::VisitStaDataPropertyInLiteral
...
LAB_012c5d3c:
  ...
  ProcessKeyedPropertyAccess(this,lVar5,lVar6,uVar2,2,0);
  return;
}
