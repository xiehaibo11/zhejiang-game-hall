...
/* v8::internal::compiler::GraphAssembler::Float64ExtractHighWord32(v8::internal::compiler::Node*)
    */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Float64ExtractHighWord32(GraphAssembler *this,Node *param_1)
