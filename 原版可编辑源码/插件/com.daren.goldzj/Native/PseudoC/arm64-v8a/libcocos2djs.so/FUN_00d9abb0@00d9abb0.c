...
undefined8 FUN_00d9abb0(long *param_1,long *param_2)
...
LAB_00d9aef8:
        ...
        if (iVar7 != 0) {
          ...
          if (*(int *)(lVar16 + 0xc0) == 0) {
            ...
            FUN_00d9d2fc(lVar16,*(undefined4 *)(lVar11 + (long)(int)uVar8 * 4),
...
LAB_00d9ae68:
        ...
        if (0xf < (int)uVar15) {
          ...
          do {
            ...
            if (*(int *)(lVar16 + 0xc0) == 0) {
              lVar11 = *(long *)(lVar11 + 0x60);
              FUN_00d9d2fc(lVar16,*(undefined4 *)(lVar11 + 0x3c0),*(undefined1 *)(lVar11 + 0x4f0));
            }
            else {
              lVar11 = *(long *)(lVar11 + 0xa0);
        ...
        if (*(int *)(lVar16 + 0xc0) == 0) {
          lVar11 = *(long *)(lVar11 + 0x60);
          FUN_00d9d2fc(lVar16,*(undefined4 *)(lVar11 + (long)(int)uVar15 * 4),
        ...
        FUN_00d9d2fc(lVar16,uVar5,iVar7);
        uVar15 = 0;
      }
    ...
    if ((0 < (int)uVar15) &&
      ...
      if (*(int *)(lVar16 + 0xc0) == 0) {
        ...
        FUN_00d9d2fc(lVar16,*(undefined4 *)(lVar14 + 0x380),*(undefined1 *)(lVar14 + 0x4e0));
      }
      else {
        lVar14 = *(long *)(lVar14 + 0xa0);
        *(long *)(lVar14 + 0x700) = *(long *)(lVar14 + 0x700) + 1;
      }
      FUN_00d9d2fc(lVar16,*(undefined4 *)(lVar16 + 0xe4),0xe);
      iVar7 = *(int *)(lVar16 + 0xe8);
      *(undefined4 *)(lVar16 + 0xe4) = 0;
      if ((iVar7 != 0) && (*(int *)(lVar16 + 0xc0) == 0)) {
        pbVar22 = *(byte **)(lVar16 + 0xf0);
