...
/* v8::internal::compiler::JSRegExpRef::flags() const */

undefined1  [16] __thiscall v8::internal::compiler::JSRegExpRef::flags(JSRegExpRef *this)

{
  ...
  if (*(int *)(*(undefined8 **)this + 1) == 2) {
    ...
    uVar4 = uVar4 & 0xffffffff00000000 | (ulong)*(uint *)(uVar4 + 0x13);
    ...
    if (*(short *)(*(long *)(lVar3 + 0x10) + 0x18) != 0x42e) {
                    /* WARNING: Subroutine does not return */
