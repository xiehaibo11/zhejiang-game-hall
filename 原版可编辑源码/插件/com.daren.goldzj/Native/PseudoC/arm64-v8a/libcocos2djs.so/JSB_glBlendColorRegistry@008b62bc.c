...
/* JSB_glBlendColorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glBlendColorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if ((plVar8[1] - *plVar8 & 0xffffffff0U) == 0x40) {
    uVar3 = seval_to_float((Value *)*plVar8,&fStack_74);
    uVar4 = seval_to_float((Value *)(*plVar8 + 0x10),&local_78);
    uVar5 = seval_to_float((Value *)(*plVar8 + 0x20),&fStack_7c);
    uVar6 = seval_to_float((Value *)(*plVar8 + 0x30),&local_80);
    if ((uVar3 & uVar4 & uVar5 & uVar6 & 1) != 0) {
      glBlendColor(fStack_74,local_78,fStack_7c,local_80);
      goto LAB_008b648c;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                        ,0x29b,"JSB_glBlendColor");
    __android_log_print(6,"jswrapper",&DAT_0190552e);
  }
  else {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                        ,0x293,"JSB_glBlendColor");
