...
/* js_cocos2dx_dragonbones_EllipseBoundingBoxData_constructorRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_EllipseBoundingBoxData_constructorRegistry
...

{
  ...
  this = (Object *)
         se::Object::_createJSObject
                   (__jsb_dragonBones_EllipseBoundingBoxData_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_dragonBones_EllipseBoundingBoxData_finalizeRegistry);
  ...
  if (this_00 != (BaseObject *)0x0) {
    ...
    *(undefined ***)this_00 = &PTR__EllipseBoundingBoxData_01c90da0;
    dragonBones::EllipseBoundingBoxData::_onClear((EllipseBoundingBoxData *)this_00);
  }
