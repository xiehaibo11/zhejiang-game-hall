...
/* v8::internal::compiler::Operator1<v8::internal::compiler::StoreGlobalParameters,
   ...
   v8::internal::compiler::OpHash<v8::internal::compiler::StoreGlobalParameters> >::HashCode() const
    */
...
::HashCode(Operator1<v8::internal::compiler::StoreGlobalParameters,v8::internal::compiler::OpEqualTo<v8::internal::compiler::StoreGlobalParameters>,v8::internal::compiler::OpHash<v8::internal::compiler::StoreGlobalParameters>>
           *this)
