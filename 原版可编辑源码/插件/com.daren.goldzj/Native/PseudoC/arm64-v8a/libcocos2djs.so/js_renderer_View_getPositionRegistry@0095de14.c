...
/* js_renderer_View_getPositionRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_View_getPositionRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (View *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xe1,"js_renderer_View_getPosition");
    __android_log_print(6,"jswrapper","js_renderer_View_getPosition : Invalid Native Object");
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_70);
    if (plVar4[1] - *plVar4 == 0x10) {
      cocos2d::Vec3::Vec3((Vec3 *)&local_80);
      cocos2d::renderer::View::getPosition(this,(Vec3 *)&local_80);
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp, 239): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,4);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_View_getPosition",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp"
                      ,0xf2);
LAB_0095e018:
  pVVar5 = (Value *)se::State::rval(aSStack_70);
