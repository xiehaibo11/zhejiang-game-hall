  ...
  if ((uVar6 >> 0x11 & 1) == 0) {
    ...
    if (*(long *)(param_1 + 0x370) < (long)uVar13) {
      ...
      *(uint *)(param_1 + 0x10) = uVar6;
      if (pvVar5 == (void *)0x0) goto LAB_00dcd440;
    }
    if ((uVar6 >> 0x17 & 1) == 0) {
...
LAB_00dcd440:
    ...
    uVar12 = FUN_00dcd65c(param_1,uVar12,pvVar5,uVar13,"TIFFFillTile");
    if (uVar12 != uVar13) {
      return 0;
    }
    *(undefined8 *)(param_1 + 0x378) = 0;
    ...
    *(undefined8 *)(param_1 + 0x390) = uVar7;
    ...
    if (*(uint *)(param_1 + 0xe0) != 0) {
      uVar6 = param_2 / *(uint *)(param_1 + 0xe0);
                    ...
                    /* WARNING: Could not recover jumptable at 0x00dcd590. Too many branches */
