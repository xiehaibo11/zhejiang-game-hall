...
/* js_cocos2dx_dragonbones_BoundingBoxData_get_colorRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_BoundingBoxData_get_colorRegistry
...

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x905,"js_cocos2dx_dragonbones_BoundingBoxData_get_color");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_BoundingBoxData_get_color : Invalid Native Object")
    ;
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_dragonbones_BoundingBoxData_get_color",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x90d);
  }
  else {
    se::Value::Value(aVStack_58);
    uint32_to_seval(*(uint *)(lVar3 + 0x14),aVStack_58);
