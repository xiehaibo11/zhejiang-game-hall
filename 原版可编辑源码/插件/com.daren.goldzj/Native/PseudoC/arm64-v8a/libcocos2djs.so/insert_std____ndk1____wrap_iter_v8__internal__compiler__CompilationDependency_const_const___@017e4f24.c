...
/* std::__ndk1::enable_if<__is_forward_iterator<std::__ndk1::__wrap_iter<v8::internal::compiler::CompilationDependency
   const* const*> >::value&&is_constructible<v8::internal::compiler::CompilationDependency const*,
   std::__ndk1::iterator_traits<std::__ndk1::__wrap_iter<v8::internal::compiler::CompilationDependency
   const* const*> >::reference>::value,
   std::__ndk1::__wrap_iter<v8::internal::compiler::CompilationDependency const**> >::type
   ...
   >::insert<std::__ndk1::__wrap_iter<v8::internal::compiler::CompilationDependency const* const*>
   >(std::__ndk1::__wrap_iter<v8::internal::compiler::CompilationDependency const* const*>,
   std::__ndk1::__wrap_iter<v8::internal::compiler::CompilationDependency const* const*>,
   std::__ndk1::__wrap_iter<v8::internal::compiler::CompilationDependency const* const*>) */
...
::insert<std::__ndk1::__wrap_iter<v8::internal::compiler::CompilationDependency_const*const*>>
          (vector<v8::internal::compiler::CompilationDependency_const*,v8::internal::ZoneAllocator<v8::internal::compiler::CompilationDependency_const*>>
...

{
  ...
  if (param_3 != param_4) {
    ...
    if ((3 < uVar5) &&
      ...
      if (uVar5 == uVar10) goto LAB_017e51bc;
    }
    do {
      puVar8 = param_3 + 1;
      puVar2 = puVar6 + 1;
