...
/* void std::__ndk1::vector<v8::internal::IsCompiledScope,
   std::__ndk1::allocator<v8::internal::IsCompiledScope>
   >::__push_back_slow_path<v8::internal::IsCompiledScope const&>(v8::internal::IsCompiledScope
   const&) */
...

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_00f0ed08;
