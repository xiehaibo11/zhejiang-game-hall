...
/* v8::internal::Factory::NewNoClosuresCell(v8::internal::Handle<v8::internal::HeapObject>) */

ulong * __thiscall v8::internal::Factory::NewNoClosuresCell(Factory *this,ulong *param_2)
