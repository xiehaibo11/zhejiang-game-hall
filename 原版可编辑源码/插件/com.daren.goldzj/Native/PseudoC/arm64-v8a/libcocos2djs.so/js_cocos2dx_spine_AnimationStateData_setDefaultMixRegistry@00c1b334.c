...
/* js_cocos2dx_spine_AnimationStateData_setDefaultMixRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_AnimationStateData_setDefaultMixRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (AnimationStateData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x56b,"js_cocos2dx_spine_AnimationStateData_setDefaultMix");
    puVar6 = &DAT_018f4efe;
LAB_00c1b4a8:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::AnimationStateData::setDefaultMix(this,local_64);
        goto LAB_00c1b4e0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x572,"js_cocos2dx_spine_AnimationStateData_setDefaultMix");
      puVar6 = &DAT_018f4f49;
      goto LAB_00c1b4a8;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 1398): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_AnimationStateData_setDefaultMix",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x579);
LAB_00c1b4e0:
