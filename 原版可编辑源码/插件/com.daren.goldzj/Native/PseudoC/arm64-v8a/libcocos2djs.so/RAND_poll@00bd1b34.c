...

{
  ...
  iVar11 = 0;
  do {
    __fd = open((&PTR_s__dev_urandom_01c8be28)[uVar12],0x900);
    if (-1 < __fd) {
        ...
        if (uVar12 != 0) {
          ...
          do {
            if ((*plVar9 == *(long *)((long)&sStack_190 + (uVar12 * 0x10 + -0xe) * 8)) &&
               (plVar9[-1] == __buf->st_dev)) goto LAB_00bd1cb8;
            uVar8 = uVar8 + 1;
            plVar9 = plVar9 + 0x10;
          } while (uVar8 < uVar12);
        }
...
LAB_00bd1c54:
            uVar10 = uVar1;
            piVar7 = (int *)__errno();
            if (*piVar7 == 4) goto LAB_00bd1c64;
            if (((0x1f < iVar11) || (uVar10 == 0)) || (*piVar7 != 0xb)) goto LAB_00bd1cb8;
          }
          if (((ulong)local_68 & 0x1000000000000) == 0) goto LAB_00bd1c4c;
          ...
          uVar10 = uVar1;
          if ((int)uVar3 < 1) goto LAB_00bd1c54;
LAB_00bd1c64:
