...
/* v8::internal::Runtime_WasmExceptionGetTag(int, unsigned long*, v8::internal::Isolate*) */

undefined8 v8::internal::Runtime_WasmExceptionGetTag(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar8 = FUN_015b7848(param_1,param_2,param_3);
  ...
  *(ulong *)(param_3 + 0x2bc8) = uVar5 & 0xffffffff00000000 | (ulong)*(uint *)(uVar5 + 0x77);
  ...
  if (*(CanonicalHandleScope **)(param_3 + 0x95b8) == (CanonicalHandleScope *)0x0) {
    ...
    *puVar6 = uVar5;
    if ((uVar5 & 1) != 0) goto LAB_015b77a8;
LAB_015b77c8:
    pIVar7 = param_3 + 0xa0;
  }
  else {
    ...
    uVar5 = *puVar6;
    if ((uVar5 & 1) == 0) goto LAB_015b77c8;
LAB_015b77a8:
    if (*(ushort *)(((ulong)param_3 | 7) + (ulong)*(uint *)(uVar5 - 1)) < 0xa9) goto LAB_015b77c8;
    pIVar7 = (Isolate *)WasmExceptionPackage::GetExceptionTag(param_3,puVar6);
  }
