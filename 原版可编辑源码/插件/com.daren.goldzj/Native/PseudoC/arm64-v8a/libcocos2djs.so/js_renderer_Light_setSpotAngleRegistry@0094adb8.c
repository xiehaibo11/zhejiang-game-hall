...
/* js_renderer_Light_setSpotAngleRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Light_setSpotAngleRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Light *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xac5,"js_renderer_Light_setSpotAngle");
    __android_log_print(6,"jswrapper","js_renderer_Light_setSpotAngle : Invalid Native Object");
  }
  else {
    ...
    if (uVar6 == 0x10) {
      ...
      if ((uVar6 & 1) != 0) {
        cocos2d::renderer::Light::setSpotAngle(this,local_64);
        goto LAB_0094af70;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0xacc,"js_renderer_Light_setSpotAngle");
      __android_log_print(6,"jswrapper",
                          "js_renderer_Light_setSpotAngle : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 2768): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar6 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Light_setSpotAngle",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0xad3);
LAB_0094af70:
