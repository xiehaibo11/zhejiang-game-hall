...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   std::__ndk1::weak_ptr<cocos2d::TTFLabelAtals> > > >::__rehash(unsigned long) */
            ...
            *(long **)(*(long *)this + uVar17 * 8) = plVar14;
            ...
            if ((long *)*plVar15 != (long *)0x0) {
              ...
              do {
                ...
                if ((bVar3 & 1) == 0) {
                  while (sVar6 != 0) {
                    /* try { // try from 009b3110 to 00ab3117 has its CatchHandler @ 009b31d8 */
                    if (*pcVar5 != *__s2) goto LAB_009b3168;
                    __s2 = __s2 + 1;
                    sVar1 = sVar1 + 1;
                    pcVar5 = pcVar5 + 1;
                    sVar6 = sVar1;
...
LAB_009b3168:
            *plVar14 = *plVar13;
                    /* try { // try from 009b3178 to 00ab317f has its CatchHandler @ 009b31c0 */
                    /* try { // try from 009b3180 to 00ab31b7 has its CatchHandler @ 009b2f2c */
        ...
        plVar14 = plVar15;
                    ...
                    /* try { // try from 009b31b8 to 00ab31bf has its CatchHandler @ 009b31c0 */
                    /* catch() { ... } // from try @ 009b3178 with catch @ 009b31c0
                       catch() { ... } // from try @ 009b31b8 with catch @ 009b31c0
                       try { // try from 009b31c0 to 00ab31f3 has its CatchHandler @ 009b2f2c */
  return;
}
