...
/* void std::__ndk1::vector<v8::internal::Map, std::__ndk1::allocator<v8::internal::Map>
   >::__push_back_slow_path<v8::internal::Map>(v8::internal::Map&&) */

void __thiscall
std::__ndk1::vector<v8::internal::Map,std::__ndk1::allocator<v8::internal::Map>>::
__push_back_slow_path<v8::internal::Map>
          (vector<v8::internal::Map,std::__ndk1::allocator<v8::internal::Map>> *this,Map *param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_015c3e7c;
