...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitCloneObject(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitCloneObject
