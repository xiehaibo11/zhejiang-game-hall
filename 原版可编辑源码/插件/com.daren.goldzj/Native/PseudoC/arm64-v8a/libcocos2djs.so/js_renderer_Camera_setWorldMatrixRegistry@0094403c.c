...
/* js_renderer_Camera_setWorldMatrixRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Camera_setWorldMatrixRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Camera *)se::State::nativeThisObject(aSStack_a0);
  if (this == (Camera *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                        ,0x7aa,"js_renderer_Camera_setWorldMatrix");
    __android_log_print(6,"jswrapper","js_renderer_Camera_setWorldMatrix : Invalid Native Object");
  }
  else {
    ...
    if (plVar4[1] - *plVar4 == 0x10) {
      ...
      if ((uVar5 & 1) != 0) {
        cocos2d::renderer::Camera::setWorldMatrix(this,aMStack_78);
        cocos2d::Mat4::~Mat4(aMStack_78);
        goto LAB_00944208;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0x7b1,"js_renderer_Camera_setWorldMatrix");
      __android_log_print(6,"jswrapper",
                          "js_renderer_Camera_setWorldMatrix : Error processing arguments");
      cocos2d::Mat4::~Mat4(aMStack_78);
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 1973): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar4[1] - *plVar4) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Camera_setWorldMatrix",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0x7b8);
LAB_00944208:
