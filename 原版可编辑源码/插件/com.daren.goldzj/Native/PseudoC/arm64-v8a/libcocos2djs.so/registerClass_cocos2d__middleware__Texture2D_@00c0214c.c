...
/* void JSBClassType::registerClass<cocos2d::middleware::Texture2D>(se::Class*) */

void JSBClassType::registerClass<cocos2d::middleware::Texture2D>(Class *param_1)
