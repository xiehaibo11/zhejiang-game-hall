...
/* js_cocos2dx_spine_Bone_setBRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_setBRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Bone *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x938,"js_cocos2dx_spine_Bone_setB");
    pcVar6 = "js_cocos2dx_spine_Bone_setB : Invalid Native Object";
LAB_00c224b8:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Bone::setB(this,local_64);
        goto LAB_00c224f0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x93f,"js_cocos2dx_spine_Bone_setB");
      pcVar6 = "js_cocos2dx_spine_Bone_setB : Error processing arguments";
      goto LAB_00c224b8;
    }
    __android_log_print(6,"jswrapper",&DAT_018f8890,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_setB",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x946);
LAB_00c224f0:
