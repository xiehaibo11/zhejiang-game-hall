...
/* v8::internal::CallPrinter::VisitWhileStatement(v8::internal::WhileStatement*) */

void __thiscall
v8::internal::CallPrinter::VisitWhileStatement(CallPrinter *this,WhileStatement *param_1)
