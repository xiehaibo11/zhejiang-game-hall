...
/* v8::internal::GCTracer::OldGenerationAllocationThroughputInBytesPerMillisecond(double) const */

undefined1  [16] __thiscall
v8::internal::GCTracer::OldGenerationAllocationThroughputInBytesPerMillisecond
