...
/* cocos2d::renderer::Particle3DAssembler::fillBuffer(cocos2d::renderer::NodeProxy*,
   cocos2d::renderer::MeshBuffer*, cocos2d::renderer::Assembler::IARenderData const&,
   cocos2d::renderer::RenderData*) */

void __thiscall
cocos2d::renderer::Particle3DAssembler::fillBuffer
...

{
  ...
  if ((int)uVar6 < 0) {
    uVar6 = 0;
    if (*(uint *)(this + 0x58) != 0) {
      uVar6 = *(uint *)(param_4 + 8) / *(uint *)(this + 0x58);
    }
    uVar19 = *(uint *)(param_3 + 0x18);
  }
  else {
    uVar19 = *(uint *)(param_3 + 0x18);
                    /* try { // try from 009d0f70 to 00ad0fe7 has its CatchHandler @ 009d0d30 */
  }
  if ((int)uVar19 < 0) {
    uVar19 = (uint)(*(ulong *)(param_4 + 0x10) >> 1) & 0x7fffffff;
  }
  iVar13 = *(int *)(param_3 + 0xc);
                    /* catch() { ... } // from try @ 009d0db0 with catch @ 009d0f78 */
                    /* catch() { ... } // from try @ 009d0da4 with catch @ 009d0f7c */
                    /* catch() { ... } // from try @ 009d0d84 with catch @ 009d0f80 */
  puVar8 = (uint *)MeshBuffer::request(param_2,uVar6,uVar19);
  uVar4 = *puVar8;
  uVar5 = puVar8[1];
  uVar20 = (ulong)uVar5;
  lVar12 = *(long *)param_2;
                    /* catch() { ... } // from try @ 009d0dbc with catch @ 009d0f90 */
  uVar7 = puVar8[2];
  lVar9 = RenderData::getVertices(param_4);
  memcpy((void *)(lVar12 + ((ulong)uVar4 & 0xfffffffc)),
         (void *)(lVar9 + (ulong)(uint)(*(int *)(this + 0x58) * iVar13)),
         (ulong)(*(int *)(this + 0x58) * uVar6));
  ...
  sVar11 = (short)uVar7 - (short)iVar13;
                    /* try { // try from 009d0fe8 to 00ad103b has its CatchHandler @ 009d0fe8
                       catch() { ... } // from try @ 009d0fe8 with catch @ 009d0fe8
                       catch() { ... } // from try @ 009d1228 with catch @ 009d0fe8 */
  ...
  uVar15 = uVar20;
LAB_009d1038:
                    /* try { // try from 009d103c to 00ad1053 has its CatchHandler @ 009d1238 */
  ...
  do {
    ...
    *(short *)(lVar10 + uVar15 * 2) = *psVar16 + sVar11;
    ...
    psVar16 = psVar16 + 1;
                    ...
                    /* try { // try from 009d105c to 00ad1067 has its CatchHandler @ 009d1234 */
                    /* try { // try from 009d1068 to 00ad1073 has its CatchHandler @ 009d1230 */
                    /* try { // try from 009d1074 to 00ad1227 has its CatchHandler @ 009d1248 */
  return;
}
