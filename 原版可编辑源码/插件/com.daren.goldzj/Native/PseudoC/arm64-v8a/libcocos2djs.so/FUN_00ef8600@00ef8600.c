...
void FUN_00ef8600(ulong *param_1,undefined8 *param_2)

{
  ...
  puVar12 = puVar4;
  if (puVar4 != (undefined8 *)param_1[3]) goto LAB_00ef8788;
  ...
  if (puVar11 <= __src && (long)__src - (long)puVar11 != 0) {
    ...
    param_1[1] = (ulong)(__src + -(lVar1 >> 1));
    param_1[2] = (ulong)puVar12;
    goto LAB_00ef8788;
  }
  lVar1 = (long)param_1[3] - (long)puVar11;
  uVar8 = lVar1 >> 2;
  if (lVar1 == 0) {
    uVar8 = 1;
  }
...
LAB_00ef8754:
      ...
      if (((void *)((long)pvVar6 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar6 + uVar13 * 8 + uVar9 + 8))) goto LAB_00ef8754;
      ...
      puVar11 = puVar12;
      if (uVar2 != uVar9) goto LAB_00ef8754;
    }
    puVar11 = (undefined8 *)*param_1;
  }
  *param_1 = (ulong)pvVar6;
  param_1[1] = (ulong)puVar3;
  param_1[2] = (ulong)puVar12;
  param_1[3] = (ulong)((long)pvVar6 + uVar8 * 8);
