...
/* js_renderer_Scene_addCameraRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Scene_addCameraRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Scene *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xc2f,"js_renderer_Scene_addCamera");
    __android_log_print(6,"jswrapper","js_renderer_Scene_addCamera : Invalid Native Object");
  }
  else {
...
LAB_0094dfcc:
          cocos2d::renderer::Scene::addCamera(this,pCVar6);
          goto LAB_0094e048;
        }
      }
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0xc36,"js_renderer_Scene_addCamera");
      __android_log_print(6,"jswrapper","js_renderer_Scene_addCamera : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 3130): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(puVar4[1] - (long)pVVar5) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Scene_addCamera",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0xc3d);
LAB_0094e048:
