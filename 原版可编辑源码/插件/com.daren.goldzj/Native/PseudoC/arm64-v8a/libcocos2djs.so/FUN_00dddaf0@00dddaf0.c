...
undefined8 FUN_00dddaf0(long param_1,long param_2,long param_3)
      ...
      do {
        ...
        if ((long)uVar17 < lVar7) {
          do {
            ...
            if (3 < (int)uVar18) goto LAB_00dddc1c;
...
LAB_00dddc84:
        if ((long)uVar17 < (long)uVar15) {
          ...
          if ((int)uVar18 < 4) goto LAB_00dddd60;
LAB_00dddd34:
          *pcVar10 = (char)uVar18 + '~';
          lVar12 = lVar12 + -2;
          ...
          if (3 < (int)uVar18) goto LAB_00dddd34;
LAB_00dddd60:
          uVar18 = 0;
        }
