...
/* js_cocos2dx_spine_AnimationState_setTimeScaleRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_AnimationState_setTimeScaleRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (AnimationState *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x462,"js_cocos2dx_spine_AnimationState_setTimeScale");
    puVar6 = &DAT_018f43ea;
LAB_00c198d4:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::AnimationState::setTimeScale(this,local_64);
        goto LAB_00c1990c;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x469,"js_cocos2dx_spine_AnimationState_setTimeScale");
      puVar6 = &DAT_018f4430;
      goto LAB_00c198d4;
    }
    __android_log_print(6,"jswrapper",&DAT_018f447b,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_AnimationState_setTimeScale",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x470);
LAB_00c1990c:
