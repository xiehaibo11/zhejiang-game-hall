...
/* js_cocos2dx_dragonbones_Matrix_get_cRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_Matrix_get_cRegistry(undefined8 param_1,PropertyCallbackInfo *param_2)

{
  ...
  if (lVar3 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x93,"js_cocos2dx_dragonbones_Matrix_get_c");
    __android_log_print(6,"jswrapper","js_cocos2dx_dragonbones_Matrix_get_c : Invalid Native Object"
                       );
    __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                        "js_cocos2dx_dragonbones_Matrix_get_c",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x9b);
  }
  else {
    se::Value::Value(aVStack_58);
    float_to_seval(*(float *)(lVar3 + 8),aVStack_58);
