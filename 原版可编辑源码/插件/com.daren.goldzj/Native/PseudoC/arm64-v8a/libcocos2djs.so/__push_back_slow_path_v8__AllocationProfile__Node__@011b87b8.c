...
/* void std::__ndk1::vector<v8::AllocationProfile::Node*,
   std::__ndk1::allocator<v8::AllocationProfile::Node*>
   >::__push_back_slow_path<v8::AllocationProfile::Node*>(v8::AllocationProfile::Node*&&) */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_011b88a0;
