...
/* bool spine_Vector_T_ptr_to_seval<spine::IkConstraintData>(spine::Vector<spine::IkConstraintData*>
   const&, se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::IkConstraintData>(Vector *param_1,Value *param_2)
...
LAB_00c8a4d0:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::IkConstraintData>
