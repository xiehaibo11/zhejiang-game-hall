...
/* js_video_VideoPlayer_setVisibleRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_video_VideoPlayer_setVisibleRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (plVar4 == (long *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x103,"js_video_VideoPlayer_setVisible");
    __android_log_print(6,"jswrapper","js_video_VideoPlayer_setVisible : Invalid Native Object");
  }
  else {
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        (**(code **)(*plVar4 + 0x60))(plVar4,local_64[0]);
        goto LAB_00980e50;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_video_auto.cpp"
                          ,0x10a,"js_video_VideoPlayer_setVisible");
      __android_log_print(6,"jswrapper",
                          "js_video_VideoPlayer_setVisible : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_video_auto.cpp, 270): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar7 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_video_VideoPlayer_setVisible",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_video_auto.cpp"
                      ,0x111);
LAB_00980e50:
