...
/* js_cocos2dx_spine_TrackEntry_setAnimationStartRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_TrackEntry_setAnimationStartRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TrackEntry *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x272,"js_cocos2dx_spine_TrackEntry_setAnimationStart");
    puVar6 = &DAT_018f291e;
LAB_00c161ac:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::TrackEntry::setAnimationStart(this,local_64);
        goto LAB_00c161e4;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x279,"js_cocos2dx_spine_TrackEntry_setAnimationStart");
      puVar6 = &DAT_018f2965;
      goto LAB_00c161ac;
    }
    __android_log_print(6,"jswrapper",&DAT_018f29b1,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TrackEntry_setAnimationStart",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x280);
LAB_00c161e4:
