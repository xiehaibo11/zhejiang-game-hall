...

{
  ...
  while (puVar1 != (void *)0x0) {
    ...
    if ((*(byte *)(puVar1 + 2) & 1) != 0) {
      operator_delete((void *)puVar1[4]);
                    ...
                    /* try { // try from 009e7850 to 00ae7867 has its CatchHandler @ 009e7ae8 */
  ...
  *(undefined8 *)this = 0;
  if (pvVar2 == (void *)0x0) {
                    /* try { // try from 009e787c to 00ae7887 has its CatchHandler @ 009e7ae0 */
    return;
  }
                    /* try { // try from 009e7870 to 00ae787b has its CatchHandler @ 009e7ae4 */
