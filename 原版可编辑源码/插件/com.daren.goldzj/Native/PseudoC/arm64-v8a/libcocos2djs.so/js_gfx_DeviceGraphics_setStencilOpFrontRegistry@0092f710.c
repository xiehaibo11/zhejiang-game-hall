...
/* js_gfx_DeviceGraphics_setStencilOpFrontRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_gfx_DeviceGraphics_setStencilOpFrontRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (pDVar10 == (DeviceGraphics *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3a3,"js_gfx_DeviceGraphics_setStencilOpFront");
    __android_log_print(6,"jswrapper",
                        "js_gfx_DeviceGraphics_setStencilOpFront : Invalid Native Object");
  }
  else {
    ...
    if (uVar13 == 0x40) {
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                          ,0x3b0,"js_gfx_DeviceGraphics_setStencilOpFront");
      __android_log_print(6,"jswrapper",
                          "js_gfx_DeviceGraphics_setStencilOpFront : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp, 948): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar13 >> 4,4);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_gfx_DeviceGraphics_setStencilOpFront",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                      ,0x3b7);
LAB_0092f93c:
