  ...
  if (b != (BIO *)0x0) {
    if ((b->method == (BIO_METHOD *)0x0) ||
      ...
      if (UNRECOVERED_JUMPTABLE_00 == (_func_603 *)0x0) {
                    /* try { // try from 00af693c to 00bf6993 has its CatchHandler @ 00af693c
                       catch() { ... } // from try @ 00af693c with catch @ 00af693c
                       catch() { ... } // from try @ 00af69b8 with catch @ 00af693c */
                    /* WARNING: Could not recover jumptable at 0x00af6940. Too many branches */
      ...
      if (0 < (long)sVar1) {
        lVar2 = (*b->method->ctrl)(b,10,0,(void *)0x0);
                    /* WARNING: Could not recover jumptable at 0x00af68f8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
