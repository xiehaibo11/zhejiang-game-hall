...
/* double v8::internal::InternalStringToIntDouble<1, unsigned short const*, unsigned short
   const*>(unsigned short const*, unsigned short const*, bool, bool) */

double v8::internal::InternalStringToIntDouble<1,unsigned_short_const*,unsigned_short_const*>
...
LAB_01065c7c:
  ...
  while( true ) {
    lVar8 = lVar8 * 2 + (ulong)(ushort)uVar5 + -0x30;
    uVar7 = lVar8 >> 0x35;
    iVar6 = (int)(lVar8 >> 0x35);
    if (iVar6 != 0) break;
    param_1 = param_1 + 1;
    if (param_1 == param_2) goto LAB_01065c7c;
    uVar5 = (uint)*param_1;
    lVar4 = lVar4 + -2;
    if ((uVar5 & 0xfffe) != 0x30) goto joined_r0x01065c18;
  }
  uVar9 = 1;
  if (1 < iVar6) {
    do {
