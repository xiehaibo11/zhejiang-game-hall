...
/* v8::internal::CompilationCacheRegExp::Put(v8::internal::Handle<v8::internal::String>,
   v8::base::Flags<v8::internal::JSRegExp::Flag, int>,
   v8::internal::Handle<v8::internal::FixedArray>) */

void __thiscall
v8::internal::CompilationCacheRegExp::Put
          (CompilationCacheRegExp *this,undefined8 param_2,undefined4 param_3,undefined8 param_4)

{
  ...
  *(int *)(pIVar6 + 0x95b0) = *(int *)(pIVar6 + 0x95b0) + 1;
  ...
  puVar5 = (undefined8 *)
           CompilationCacheTable::PutRegExp(*(undefined8 *)this,puVar4,param_2,param_3,param_4);
