...
/* v8::internal::MinorMarkCompactCollector::RootMarkingVisitor::VisitRootPointer(v8::internal::Root,
   char const*, v8::internal::FullObjectSlot) */

void __thiscall
v8::internal::MinorMarkCompactCollector::RootMarkingVisitor::VisitRootPointer
...

{
  ...
  uVar7 = *param_4;
  if (((uVar7 & 1) != 0) && (uVar5 = uVar7 & 0xfffffffffffc0000, (*(byte *)(uVar5 + 8) & 0x18) != 0)
     ) {
    lVar6 = (uVar7 - uVar5 >> 7 & 0x1ffffff) * 4;
    uVar1 = *(uint *)(*(long *)(uVar5 + 0x108) + lVar6);
    lVar4 = *(long *)(this + 8);
    uVar2 = 1 << (ulong)((uint)(uVar7 - uVar5 >> 2) & 0x1f);
    *(uint *)(*(long *)(uVar5 + 0x108) + lVar6) = uVar1 | uVar2;
    if ((uVar1 & uVar2) == 0) {
