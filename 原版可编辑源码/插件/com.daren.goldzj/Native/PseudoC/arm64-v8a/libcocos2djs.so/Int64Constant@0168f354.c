...
/* v8::internal::compiler::CommonOperatorBuilder::Int64Constant(long) */

Operator * __thiscall
v8::internal::compiler::CommonOperatorBuilder::Int64Constant
...

{
  ...
  Operator::Operator(pOVar1,0x18,0x7c,"Int64Constant",0,0,0,1,0,0);
