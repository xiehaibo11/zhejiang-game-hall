...

{
  ...
  iVar3 = EVP_PKEY_id(param_4);
                    /* try { // try from 00adbde0 to 00bdbdf3 has its CatchHandler @ 00adbe2c */
  if (iVar3 < 0x32b) {
    if (iVar3 == 6) {
                    /* catch() { ... } // from try @ 00adbde0 with catch @ 00adbe2c */
      lVar8 = 0;
    }
    else {
                    /* try { // try from 00adbdf4 to 00bdbe47 has its CatchHandler @ 00adbd80 */
      if (iVar3 == 0x74) {
        lVar8 = 1;
      }
      else {
    ...
    lVar8 = 5;
                    ...
                    /* try { // try from 00adbe48 to 00bdbea7 has its CatchHandler @ 00adbe48
                       catch() { ... } // from try @ 00adbe48 with catch @ 00adbe48
                       catch() { ... } // from try @ 00adbebc with catch @ 00adbe48 */
  if ((&DAT_018a53a0)[lVar8 * 2] != (uint)param_3[1]) {
                    /* catch() { ... } // from try @ 00adbea8 with catch @ 00adbef4 */
    iVar3 = 0x172;
    iVar5 = 0x329;
    goto LAB_00adbf0c;
  }
  ...
  if (iVar3 == 0x198) {
    ...
    uVar9 = 0;
    lVar8 = -0x100000000;
    piVar10 = &DAT_018a5170;
    do {
                    /* try { // try from 00adbea8 to 00bdbebb has its CatchHandler @ 00adbef4 */
      if (0x1c < uVar9) {
        return 0;
      }
      iVar5 = *piVar10;
      ...
      lVar8 = lVar8 + 0x100000000;
                    /* try { // try from 00adbebc to 00bdbf0f has its CatchHandler @ 00adbe48 */
      piVar10 = piVar10 + 3;
    } while (iVar5 != iVar3);
    if ((int)uVar9 == 0) {
      return 0;
    ...
    if ((*(int *)(param_2 + 0x38) == 0) &&
       (iVar3 = FUN_00adbba0(param_2,&local_34,local_38), iVar3 == 0)) {
      iVar3 = 0x17a;
      iVar5 = 0x333;
      goto LAB_00adbf0c;
    }
...
LAB_00adc02c:
    ...
    if ((*(int *)(param_2 + 0x38) == 0) ||
      ...
      if (puVar11 == (undefined1 *)0x0) {
        ...
        if (uVar9 == 0) goto LAB_00adc1bc;
      }
      goto LAB_00adc02c;
    }
    uVar9 = *(ulong *)(lVar8 + 0x160);
    if (uVar9 != 0) goto LAB_00adc02c;
LAB_00adc1bc:
    uVar12 = 0;
  }
  bVar2 = *param_3;
  ...
  if (0xec < bVar2) {
    if (bVar2 == 0xed) {
      ...
      if (bVar2 != 0xef) goto switchD_00adc118_default;
      lVar8 = 8;
    }
    goto switchD_00adc118_caseD_2;
  }
...
switchD_00adc118_caseD_2:
  if (lVar8 == 0xfffffffffe75ac0) {
switchD_00adc118_default:
    *param_1 = 0;
  }
  else {
    md = (EVP_MD *)ssl_md((&DAT_018a5408)[lVar8 * 4]);
    *param_1 = md;
    if (md != (EVP_MD *)0x0) {
