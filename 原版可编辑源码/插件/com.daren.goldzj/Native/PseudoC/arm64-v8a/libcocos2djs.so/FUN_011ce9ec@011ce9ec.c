...
undefined8 FUN_011ce9ec(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0x1a8);
  }
  if (DAT_01d3fb08 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d3fb08 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d3fb08;
  local_a0 = (byte **)0x0;
  if ((*DAT_01d3fb08 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar3,"V8.Runtime_Runtime_NewObject",0,0,0,0,0,0,0,&local_50,0);
    plVar4 = local_48;
    local_48 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
      (**(code **)(*plVar4 + 8))();
    ...
    local_a0 = &local_98;
    local_90 = "V8.Runtime_Runtime_NewObject";
    local_98 = pbVar3;
    local_88 = uVar5;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar7 & 1) != 0) &&
    ...
    if (((uVar7 & 1) != 0) &&
      ...
      pIVar6 = (Isolate *)v8::internal::JSObject::New(param_2,param_2 + -1,0);
