...
LAB_00bdfdb4:
    ...
    do {
      ...
      if (iVar3 == 0) {
        ...
        if ((iVar3 == 0) || (iVar3 = BN_mul_word(param_1,0x906), iVar3 == 0)) goto LAB_00bdfdb4;
        uVar5 = BN_get_word(rnd);
        iVar3 = BN_add_word(param_1,(long)*(int *)(&DAT_018d5ecc + uVar5 * 4));
        if (iVar3 == 0) goto LAB_00bdfdb4;
        uVar5 = 5;
        while( true ) {
          uVar4 = BN_mod_word(param_1,(ulong)*(ushort *)(&UNK_018d4ecc + uVar5 * 2));
          iVar3 = 3;
          if (1 < uVar4) {
            iVar3 = 0;
          }
        ...
        if (iVar2 == 2) goto LAB_00bdfdb4;
        if (iVar2 != 3) goto LAB_00bdfdc0;
      }
