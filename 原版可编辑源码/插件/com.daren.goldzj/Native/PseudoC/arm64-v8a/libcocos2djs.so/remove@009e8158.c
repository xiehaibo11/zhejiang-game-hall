...

{
  ...
  if (plVar7 != param_2 + 2) {
    ...
    if (uVar6 == uVar1) goto LAB_009e820c;
  }
  if (*param_3 != 0) {
    uVar6 = *(ulong *)(*param_3 + 8);
    if (uVar3 == 0) {
      uVar6 = uVar6 & uVar8;
                    /* try { // try from 009e8200 to 00ae82d7 has its CatchHandler @ 009e800c */
    }
    else if (uVar2 <= uVar6) {
      uVar4 = 0;
      if (uVar2 != 0) {
...
LAB_009e820c:
  if (*param_3 != 0) {
    ...
    if (uVar3 == 0) {
      uVar6 = uVar6 & uVar8;
                    /* catch() { ... } // from try @ 009e808c with catch @ 009e8268 */
    }
    else if (uVar2 <= uVar6) {
      uVar3 = 0;
      if (uVar2 != 0) {
      ...
      uVar6 = uVar6 - uVar3 * uVar2;
                    ...
                    /* catch() { ... } // from try @ 009e8080 with catch @ 009e826c */
    if (uVar6 != uVar1) {
                    /* catch() { ... } // from try @ 009e81f8 with catch @ 009e8234 */
