...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >, std::__ndk1::list<int,
   std::__ndk1::allocator<int> > > > >::__rehash(unsigned long) */
...

{
  ...
  if (param_1 == 0) {
    ...
    *(undefined8 *)this = 0;
    if (pvVar9 != (void *)0x0) {
                    /* try { // try from 00a6f8d8 to 00b6f8df has its CatchHandler @ 00a6fb84 */
    ...
    *(void **)this = pvVar9;
    if (pvVar10 != (void *)0x0) {
                    /* try { // try from 00a6f878 to 00b6f88f has its CatchHandler @ 00a6fba4 */
    ...
    *(ulong *)(this + 8) = param_1;
    do {
      *(undefined8 *)(*(long *)this + uVar11 * 8) = 0;
      uVar11 = uVar11 + 1;
                    /* try { // try from 00a6f898 to 00b6f8a3 has its CatchHandler @ 00a6fba0 */
    } while (param_1 != uVar11);
    plVar14 = *(long **)(this + 0x10);
                    /* try { // try from 00a6f8a4 to 00b6f8af has its CatchHandler @ 00a6fb9c */
    if (plVar14 != (long *)0x0) {
      uVar11 = plVar14[1];
      uVar16 = param_1 - 1;
                    /* try { // try from 00a6f8b0 to 00b6f8b7 has its CatchHandler @ 00a6fbb4 */
      if ((uVar16 & param_1) == 0) {
      ...
      *(__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::list<int,std::__ndk1::allocator<int>>>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::list<int,std::__ndk1::allocator<int>>>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::list<int,std::__ndk1::allocator<int>>>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::list<int,std::__ndk1::allocator<int>>>>>
        **)(*(long *)this + uVar11 * 8) = this + 0x10;
                    /* try { // try from 00a6f8f0 to 00b6f8f7 has its CatchHandler @ 00a6fb7c */
      for (plVar15 = (long *)*plVar14; plVar15 != (long *)0x0; plVar15 = (long *)*plVar15) {
        uVar17 = plVar15[1];
        if ((uVar16 & param_1) == 0) {
          uVar17 = uVar17 & uVar16;
                    /* try { // try from 00a6f92c to 00b6f947 has its CatchHandler @ 00a6fbb4 */
        }
          ...
          if (*(long *)(*(long *)this + uVar17 * 8) == 0) {
            *(long **)(*(long *)this + uVar17 * 8) = plVar14;
            ...
            if ((long *)*plVar15 != (long *)0x0) {
                    /* try { // try from 00a6f94c to 00b6f98f has its CatchHandler @ 00a6fb84 */
              ...
              do {
                ...
                if ((bVar3 & 1) == 0) {
                  while (sVar6 != 0) {
                    if (*pcVar5 != *__s2) goto LAB_00a6fa14;
                    /* try { // try from 00a6f9cc to 00b6f9d3 has its CatchHandler @ 00a6fb80 */
                    /* try { // try from 00a6f9d4 to 00b6f9f7 has its CatchHandler @ 00a6f81c */
                    __s2 = __s2 + 1;
                    sVar1 = sVar1 + 1;
                    pcVar5 = pcVar5 + 1;
                    sVar6 = sVar1;
                    ...
                    /* try { // try from 00a6f9f8 to 00b6fa03 has its CatchHandler @ 00a6fb5c */
...
LAB_00a6fa14:
                    /* try { // try from 00a6fa18 to 00b6fa83 has its CatchHandler @ 00a6fb80 */
            *plVar14 = *plVar13;
