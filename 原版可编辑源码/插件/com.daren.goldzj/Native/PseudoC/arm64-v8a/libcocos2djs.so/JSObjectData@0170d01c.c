...
/* v8::internal::compiler::JSObjectData::JSObjectData(v8::internal::compiler::JSHeapBroker*,
   v8::internal::compiler::ObjectData**, v8::internal::Handle<v8::internal::JSObject>) */

void __thiscall v8::internal::compiler::JSObjectData::JSObjectData(JSObjectData *this,long param_1)
