...
/* void 
   v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::PopulateReferenceMapsPhase>()
    */
...

{
  ...
  lVar2 = ZoneStats::NewEmptyZone(this_01,"V8.TFPopulatePointerMaps");
  ReferenceMapPopulator::ReferenceMapPopulator
            (aRStack_18,*(RegisterAllocationData **)(lVar5 + 0x170));
  ReferenceMapPopulator::PopulateReferenceMaps(aRStack_18);
