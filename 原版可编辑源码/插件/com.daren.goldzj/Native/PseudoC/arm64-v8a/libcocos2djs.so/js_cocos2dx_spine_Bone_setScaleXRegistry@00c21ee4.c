...
/* js_cocos2dx_spine_Bone_setScaleXRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_setScaleXRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Bone *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x912,"js_cocos2dx_spine_Bone_setScaleX");
    pcVar6 = "js_cocos2dx_spine_Bone_setScaleX : Invalid Native Object";
LAB_00c22058:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Bone::setScaleX(this,local_64);
        goto LAB_00c22090;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x919,"js_cocos2dx_spine_Bone_setScaleX");
      pcVar6 = "js_cocos2dx_spine_Bone_setScaleX : Error processing arguments";
      goto LAB_00c22058;
    }
    __android_log_print(6,"jswrapper",&DAT_018f864a,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_setScaleX",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x920);
LAB_00c22090:
