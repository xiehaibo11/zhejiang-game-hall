...
/* void std::__ndk1::vector<v8::internal::Handle<v8::internal::JSFunction>,
   std::__ndk1::allocator<v8::internal::Handle<v8::internal::JSFunction> >
   >::__emplace_back_slow_path<v8::internal::JSFunction&,
   v8::internal::Isolate*&>(v8::internal::JSFunction&, v8::internal::Isolate*&) */
...
::__emplace_back_slow_path<v8::internal::JSFunction&,v8::internal::Isolate*&>
          (vector<v8::internal::Handle<v8::internal::JSFunction>,std::__ndk1::allocator<v8::internal::Handle<v8::internal::JSFunction>>>
           *this,JSFunction *param_1,Isolate **param_2)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_00f1660c;
