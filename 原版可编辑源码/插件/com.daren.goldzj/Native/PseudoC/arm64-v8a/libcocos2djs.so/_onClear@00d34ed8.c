...

{
  ...
  for (puVar7 = *(undefined8 **)(this + 0x90); puVar7 != puVar2; puVar7 = puVar7 + 1) {
    BaseObject::returnToPool((BaseObject *)*puVar7);
  }
  puVar2 = *(undefined8 **)(this + 0xb0);
  for (puVar7 = *(undefined8 **)(this + 0xa8); puVar7 != puVar2; puVar7 = puVar7 + 1) {
    BaseObject::returnToPool((BaseObject *)*puVar7);
  }
  pAVar8 = *(ArmatureData **)(this + 0xc0);
  while (pAVar8 != this + 200) {
    BaseObject::returnToPool(*(BaseObject **)(pAVar8 + 0x38));
    pAVar5 = *(ArmatureData **)(pAVar8 + 8);
    if (*(ArmatureData **)(pAVar8 + 8) == (ArmatureData *)0x0) {
      pAVar5 = pAVar8 + 0x10;
      bVar4 = *(ArmatureData **)*(ArmatureData **)pAVar5 != pAVar8;
      pAVar8 = *(ArmatureData **)pAVar5;
      if (bVar4) {
        do {
          lVar6 = *(long *)pAVar5;
          pAVar5 = (ArmatureData *)(lVar6 + 0x10);
          pAVar8 = *(ArmatureData **)pAVar5;
      ...
      do {
        pAVar8 = pAVar5;
        pAVar5 = *(ArmatureData **)pAVar8;
      } while (*(ArmatureData **)pAVar8 != (ArmatureData *)0x0);
    }
  }
  pAVar8 = *(ArmatureData **)(this + 0xd8);
  while (pAVar8 != this + 0xe0) {
    BaseObject::returnToPool(*(BaseObject **)(pAVar8 + 0x38));
    pAVar5 = *(ArmatureData **)(pAVar8 + 8);
    if (*(ArmatureData **)(pAVar8 + 8) == (ArmatureData *)0x0) {
      pAVar5 = pAVar8 + 0x10;
  ...
  pAVar8 = *(ArmatureData **)(this + 0x108);
  while (pAVar8 != this + 0x110) {
    BaseObject::returnToPool(*(BaseObject **)(pAVar8 + 0x38));
    pAVar5 = *(ArmatureData **)(pAVar8 + 8);
    if (*(ArmatureData **)(pAVar8 + 8) == (ArmatureData *)0x0) {
      pAVar5 = pAVar8 + 0x10;
  ...
  pAVar8 = *(ArmatureData **)(this + 0x120);
  while (pAVar8 != this + 0x128) {
    BaseObject::returnToPool(*(BaseObject **)(pAVar8 + 0x38));
    pAVar5 = *(ArmatureData **)(pAVar8 + 8);
    if (*(ArmatureData **)(pAVar8 + 8) == (ArmatureData *)0x0) {
      pAVar5 = pAVar8 + 0x10;
