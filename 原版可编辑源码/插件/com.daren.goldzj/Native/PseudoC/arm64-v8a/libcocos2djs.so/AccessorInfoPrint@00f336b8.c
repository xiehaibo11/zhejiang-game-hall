...
/* v8::internal::AccessorInfo::AccessorInfoPrint(std::__ndk1::basic_ostream<char,
   std::__ndk1::char_traits<char> >&) */

void __thiscall
v8::internal::AccessorInfo::AccessorInfoPrint(AccessorInfo *this,basic_ostream *param_1)

{
  basic_ostream *pbVar1;
  ulong local_28;
  
  HeapObject::PrintHeader((HeapObject *)this,param_1,"AccessorInfo");
