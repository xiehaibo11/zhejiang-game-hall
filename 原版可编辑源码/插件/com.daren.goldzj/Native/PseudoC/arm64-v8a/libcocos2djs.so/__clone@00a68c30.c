...

{
  ...
  *puVar1 = &PTR_FUN_01c6e7a0;
                    /* try { // try from 00a68c60 to 00b68cb3 has its CatchHandler @ 00a68c60
                       catch() { ... } // from try @ 00a68c60 with catch @ 00a68c60
                       catch() { ... } // from try @ 00a68dc0 with catch @ 00a68c60 */
