...

{
  ...
  void *pvVar6;
                    ...
                    /* try { // try from 00a5aaf4 to 00b5aafb has its CatchHandler @ 00a5ab4c */
                    /* try { // try from 00a5aafc to 00b5ab6b has its CatchHandler @ 00a5aa70 */
  (**(code **)(*(long *)this + 0x30))();
  ...
  *(long **)(this + 0x80) = plVar5;
  ...
  if (bVar3 != (basic_filebuf<char,std::__ndk1::char_traits<char>>)(bVar4 & 1)) {
                    /* catch() { ... } // from try @ 00a5aaf4 with catch @ 00a5ab4c */
    *(undefined8 *)(this + 0x28) = 0;
    *(undefined8 *)(this + 0x20) = 0;
    *(undefined8 *)(this + 0x38) = 0;
    *(undefined8 *)(this + 0x30) = 0;
                    /* catch() { ... } // from try @ 00a5aacc with catch @ 00a5ab50 */
