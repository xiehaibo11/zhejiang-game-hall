...
void FUN_01433d40(ulong param_1)

{
  ...
  uVar6 = *(ulong *)(unaff_x29 + (long)*(char *)(unaff_x20 + unaff_x19 + 1) * 8);
  lVar7 = unaff_x26 +
  ...
  uVar9 = (int)unaff_x19 * 2;
  uVar16 = (ulong)uVar9;
  lVar19 = unaff_x19 + 3;
  bVar3 = (int)lVar7 == (int)*(undefined8 *)(unaff_x26 + 0xa0);
  uVar14 = (ulong)bVar3;
  lVar11 = (ulong)*(byte *)(unaff_x20 + unaff_x19 + 2) * 4 + 0x1f;
...
LAB_01433f78:
  do {
    ...
    if ((param_1 & 1) == 0) {
      ...
      uVar9 = (int)param_1 >> 1;
LAB_014340e0:
      uVar12 = uVar12 >> (ulong)(uVar9 & 0x1f);
      ...
      if ((uVar13 == 0) &&
        ...
        *(undefined4 *)(lVar7 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x01434154. Too many branches */
