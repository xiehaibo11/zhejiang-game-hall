...
/* v8::internal::compiler::JSOperatorBuilder::CreateCatchContext(v8::internal::Handle<v8::internal::ScopeInfo>
   const&) */
...

{
  ...
  Operator::Operator(pOVar1,0x2f9,0,"JSCreateCatchContext",1,1,1,1,1,2);
