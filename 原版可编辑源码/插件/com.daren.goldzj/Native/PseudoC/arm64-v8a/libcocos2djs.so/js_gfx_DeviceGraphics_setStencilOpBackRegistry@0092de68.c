...
/* js_gfx_DeviceGraphics_setStencilOpBackRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_gfx_DeviceGraphics_setStencilOpBackRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (pDVar10 == (DeviceGraphics *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2ef,"js_gfx_DeviceGraphics_setStencilOpBack");
    __android_log_print(6,"jswrapper",
                        "js_gfx_DeviceGraphics_setStencilOpBack : Invalid Native Object");
  }
  else {
    ...
    if (uVar13 == 0x40) {
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                          ,0x2fc,"js_gfx_DeviceGraphics_setStencilOpBack");
      __android_log_print(6,"jswrapper",
                          "js_gfx_DeviceGraphics_setStencilOpBack : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp, 768): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar13 >> 4,4);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_gfx_DeviceGraphics_setStencilOpBack",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_gfx_auto.cpp"
                      ,0x303);
LAB_0092e094:
