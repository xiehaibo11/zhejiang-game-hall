...
/* v8::internal::interpreter::BytecodeArrayBuilder::ReThrow() */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::ReThrow(BytecodeArrayBuilder *this)
