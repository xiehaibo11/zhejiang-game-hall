...
/* js_disableBatchGLCommandsToNativeRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_disableBatchGLCommandsToNativeRegistry(FunctionCallbackInfo *param_1)
