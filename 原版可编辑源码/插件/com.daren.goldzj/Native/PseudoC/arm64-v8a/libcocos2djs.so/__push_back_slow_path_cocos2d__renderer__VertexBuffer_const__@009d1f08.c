...
/* void std::__ndk1::vector<cocos2d::renderer::VertexBuffer*,
   std::__ndk1::allocator<cocos2d::renderer::VertexBuffer*>
   >::__push_back_slow_path<cocos2d::renderer::VertexBuffer*
   const&>(cocos2d::renderer::VertexBuffer* const&) */
