      ...
      if (pOVar3 != (OCSP_REQINFO *)0x0) {
        ...
        if ((flags & 1) == 0) {
          ...
          if (pOVar3 == (OCSP_REQINFO *)0x0) {
            pOVar3 = (OCSP_REQINFO *)OCSP_SIGNATURE_new();
            req[2].tbsRequest = pOVar3;
            if (pOVar3 == (OCSP_REQINFO *)0x0) goto LAB_00b3ae38;
          }
          if (signer != (X509 *)0x0) {
            ...
            if (psVar4 == (stack_st_X509_EXTENSION *)0x0) {
              ...
              if (psVar4 == (stack_st_X509_EXTENSION *)0x0) goto LAB_00b3ae38;
            }
