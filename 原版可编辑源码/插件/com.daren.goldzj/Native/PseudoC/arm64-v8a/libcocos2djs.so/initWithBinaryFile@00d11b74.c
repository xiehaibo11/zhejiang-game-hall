...

{
  ...
  *(Cocos2dAtlasAttachmentLoader **)(this + 0x28) = this_00;
  SkeletonBinary::SkeletonBinary(aSStack_98,(AttachmentLoader *)this_00);
  local_50 = param_3;
  if (((byte)*param_1 & 1) == 0) {
    __s = param_1 + 1;
  }
...
LAB_00d11c5c:
  pSVar5 = (SkeletonData *)SkeletonBinary::readSkeletonDataFile(aSStack_98,(String *)&local_b0);
  pvVar3 = local_a0;
  local_b0 = &PTR__String_01c67868;
  ...
  *(Skeleton **)(this + 0x30) = this_01;
  ...
  SkeletonBinary::~SkeletonBinary(aSStack_98);
