...
/* spine::Vector<spine::IkConstraint*>::~Vector() */

void __thiscall spine::Vector<spine::IkConstraint*>::~Vector(Vector<spine::IkConstraint*> *this)

{
  ...
  *(undefined ***)this = &PTR__Vector_01c8d198;
  *(undefined8 *)(this + 8) = 0;
  if (lVar2 != 0) {
