...
/* bool v8::internal::wasm::ThreadImpl::DoSimdLoadSplat<v8::internal::wasm::int16, int, signed
   char>(v8::internal::wasm::Decoder*, v8::internal::wasm::InterpreterCode*, unsigned long, int*,
   v8::internal::MachineRepresentation) */

bool v8::internal::wasm::ThreadImpl::DoSimdLoadSplat<v8::internal::wasm::int16,int,signed_char>
               (ulong param_1)

{
  ...
  bVar3 = ExecuteLoad<int,signed_char>();
  if (bVar3) {
    ...
    *(long *)(param_1 + 0x28) = lVar4 + -0x11;
    ...
    uVar2 = CONCAT22(CONCAT11(local_70._1_1_,local_70._1_1_),CONCAT11(local_70._1_1_,local_70._1_1_)
                    );
    local_50 = CONCAT44(uVar2,uVar2);
    uStack_7f = (undefined7)local_50;
    uStack_68 = CONCAT71(uStack_7f,local_70._1_1_);
    local_60 = local_70._1_1_;
    local_70 = CONCAT71(uStack_7f,5);
    uStack_48 = local_50;
