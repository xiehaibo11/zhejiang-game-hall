          ...
          *(long *)param_1 = lVar5 + 5;
          ...
          if (puVar1 < puVar6) {
            ...
            puVar3 = (undefined8 *)((long)pvVar2 + ((long)puVar3 - (long)__ptr));
                    /* try { // try from 00a5bb48 to 00b5bbf7 has its CatchHandler @ 00a5bb48
                       catch() { ... } // from try @ 00a5bb48 with catch @ 00a5bb48
                       catch() { ... } // from try @ 00a5bc34 with catch @ 00a5bb48 */
