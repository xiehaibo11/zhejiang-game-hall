...
/* v8::internal::Runtime_JSReceiverSetPrototypeOfThrow(int, unsigned long*, v8::internal::Isolate*)
    */

ulong v8::internal::Runtime_JSReceiverSetPrototypeOfThrow
...

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar5 = FUN_011cba48(param_1,param_2,param_3);
    return uVar5;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar5 & 1) != 0) &&
    ...
    cVar4 = JSReceiver::SetPrototype(param_2,param_2 + -1,1,0);
