...
/* v8::internal::interpreter::BytecodeArrayBuilder::CreateCatchContext(v8::internal::interpreter::Register,
   v8::internal::Scope const*) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::CreateCatchContext
          (BytecodeArrayBuilder *this,int param_2,Scope *param_3)
