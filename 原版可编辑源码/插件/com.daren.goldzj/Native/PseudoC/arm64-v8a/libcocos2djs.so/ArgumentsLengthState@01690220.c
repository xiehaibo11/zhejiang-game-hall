...
/* v8::internal::compiler::CommonOperatorBuilder::ArgumentsLengthState(v8::internal::CreateArgumentsType)
    */
...

{
  ...
  Operator::Operator(pOVar1,0x2d,0x7c,"ArgumentsLengthState",0,0,0,1,0,0);
  pOVar1[0x2c] = param_2;
