...
void FUN_0107b4c8(ulong param_1,ulong param_2,ulong param_3,long param_4)

{
  ...
  case 0x12:
    ...
    break;
  case 0x13:
    goto switchD_0107b608_caseD_13;
  case 0x14:
    if (param_3 != 0) {
      if ((param_3 < 0x10) ||
    ...
    if (param_3 != 0) {
      ...
      do {
        ...
        if (((fVar19 < -2.1474836e+09) || (2147483647.0 < dVar17)) ||
          ...
          if ((int)uVar2 < 0) {
            if ((int)uVar2 < -0x34) goto LAB_0107b938;
    ...
    if (param_3 != 0) {
      ...
      do {
        ...
        if ((((dVar17 < -2147483648.0) || (2147483647.0 < dVar17)) || (ABS(dVar17) == INFINITY)) ||
          ...
          if ((int)uVar2 < 0) {
            if ((int)uVar2 < -0x34) goto LAB_0107b7a4;
            uVar1 = (ulong)dVar17 & 0xfffffffffffff;
            if (((ulong)dVar17 & 0x7ff0000000000000) != 0) {
              uVar1 = (ulong)dVar17 & 0xfffffffffffff | 0x10000000000000;
            }
...
LAB_0107b7a8:
    ...
    break;
  case 0x19:
    goto switchD_0107b608_caseD_19;
  case 0x1a:
    if (param_3 == 0) break;
    FUN_010b0adc();
switchD_0107b608_caseD_13:
    if (param_3 != 0) {
      if ((param_3 < 0x10) ||
         (((void *)(uVar1 + param_4) < (void *)((long)__src + param_3 * 2) &&
          (__src < (double *)(uVar1 + param_4 + param_3))))) {
