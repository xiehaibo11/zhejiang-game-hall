...
/* v8::internal::compiler::JSIntrinsicLowering::ReduceIncBlockCounter(v8::internal::compiler::Node*)
    */

Node * __thiscall
v8::internal::compiler::JSIntrinsicLowering::ReduceIncBlockCounter
...

{
  ...
  Builtins::CallableFor((Builtins *)local_58,*(undefined8 *)(*(long *)(this + 0x10) + 0x168),0x300);
  local_40 = &PTR__CallInterfaceDescriptor_01ca0fc8;
  uStack_38 = local_48;
  pCVar1 = (CallDescriptor *)
           Linkage::GetStubCallDescriptor
                     (*(undefined8 *)**(undefined8 **)(this + 0x10),&local_40,0,0,
