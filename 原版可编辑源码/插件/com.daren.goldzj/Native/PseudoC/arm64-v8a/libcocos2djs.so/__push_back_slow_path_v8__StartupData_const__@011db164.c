...
/* void std::__ndk1::vector<v8::StartupData, std::__ndk1::allocator<v8::StartupData>
   >::__push_back_slow_path<v8::StartupData const&>(v8::StartupData const&) */

void __thiscall
std::__ndk1::vector<v8::StartupData,std::__ndk1::allocator<v8::StartupData>>::
__push_back_slow_path<v8::StartupData_const&>
          (vector<v8::StartupData,std::__ndk1::allocator<v8::StartupData>> *this,
          StartupData *param_1)

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_011db250;
