...
/* js_renderer_Scene_setDebugCameraRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Scene_setDebugCameraRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Scene *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xc8b,"js_renderer_Scene_setDebugCamera");
    __android_log_print(6,"jswrapper","js_renderer_Scene_setDebugCamera : Invalid Native Object");
  }
  else {
    ...
    if (puVar4[1] - (long)pVVar5 == 0x10) {
      if (pVVar5[8] == (Value)0x5) {
        ...
        pCVar6 = (Camera *)se::Object::getPrivateData(this_00);
        if (pCVar6 != (Camera *)0x0) {
LAB_0094ed40:
          cocos2d::renderer::Scene::setDebugCamera(this,pCVar6);
          goto LAB_0094edbc;
        }
      }
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0xc92,"js_renderer_Scene_setDebugCamera");
      __android_log_print(6,"jswrapper",
                          "js_renderer_Scene_setDebugCamera : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 3222): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(puVar4[1] - (long)pVVar5) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Scene_setDebugCamera",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0xc99);
LAB_0094edbc:
