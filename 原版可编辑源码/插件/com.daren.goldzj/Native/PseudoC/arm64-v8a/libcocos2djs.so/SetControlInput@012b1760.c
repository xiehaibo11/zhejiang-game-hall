...
/* v8::internal::compiler::Schedule::SetControlInput(v8::internal::compiler::BasicBlock*,
   v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::Schedule::SetControlInput(Schedule *this,BasicBlock *param_1,Node *param_2)
