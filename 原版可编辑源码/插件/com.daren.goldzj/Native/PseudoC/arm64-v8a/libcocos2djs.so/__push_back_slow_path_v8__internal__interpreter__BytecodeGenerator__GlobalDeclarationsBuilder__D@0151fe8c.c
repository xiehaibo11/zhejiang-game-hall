...
/* void 
   std::__ndk1::vector<v8::internal::interpreter::BytecodeGenerator::GlobalDeclarationsBuilder::Declaration,
   v8::internal::ZoneAllocator<v8::internal::interpreter::BytecodeGenerator::GlobalDeclarationsBuilder::Declaration>
   >::__push_back_slow_path<v8::internal::interpreter::BytecodeGenerator::GlobalDeclarationsBuilder::Declaration>(v8::internal::interpreter::BytecodeGenerator::GlobalDeclarationsBuilder::Declaration&&)
    */
