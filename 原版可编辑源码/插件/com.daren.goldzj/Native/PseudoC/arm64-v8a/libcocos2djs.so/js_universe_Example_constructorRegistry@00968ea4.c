...
/* js_universe_Example_constructorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_universe_Example_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Object *)
         se::Object::_createJSObject(__jsb_universe_Example_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_universe_Example_finalizeRegistry);
  se::State::State(aSStack_60,this,(vector *)&local_a0);
  puVar4 = operator_new(0x30,(nothrow_t *)&std::nothrow);
