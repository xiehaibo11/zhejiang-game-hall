...

{
  ...
  if (uVar13 != 0) {
    ...
    if (plVar8 != (long *)0x0) {
      plVar8 = (long *)*plVar8;
      if (plVar8 != (long *)0x0) {
                    /* try { // try from 00a76300 to 00b763e3 has its CatchHandler @ 00a76198 */
          ...
          if (uVar9 == uVar7) {
            ...
            if (sVar1 == __n) {
              ...
              if ((bVar3 & 1) == 0) {
                ...
                pbVar12 = pbVar2;
                    /* catch() { ... } // from try @ 00a76218 with catch @ 00a76374 */
                while (*pbVar10 == *pbVar12) {
                    /* catch() { ... } // from try @ 00a7620c with catch @ 00a76378 */
                  pbVar10 = pbVar10 + 1;
                    /* catch() { ... } // from try @ 00a761ec with catch @ 00a7637c */
                  lVar11 = lVar11 + 1;
                  pbVar12 = pbVar12 + 1;
                  if (lVar11 == 0) goto LAB_00a763e0;
                }
              }
                    ...
                    /* catch() { ... } // from try @ 00a76224 with catch @ 00a7638c */
            if ((uVar14 & uVar13) == 0) {
              uVar9 = uVar9 & uVar14;
            }
              ...
              if (uVar9 - uVar4 * uVar13 == uVar15) goto LAB_00a763b8;
              goto LAB_00a763dc;
            }
            if (uVar9 != uVar15) goto LAB_00a763dc;
          }
LAB_00a763b8:
          plVar8 = (long *)*plVar8;
...
LAB_00a763dc:
  plVar8 = (long *)0x0;
LAB_00a763e0:
                    /* try { // try from 00a763e4 to 00b7643b has its CatchHandler @ 00a763e4
                       catch() { ... } // from try @ 00a763e4 with catch @ 00a763e4
                       catch() { ... } // from try @ 00a766bc with catch @ 00a763e4 */
