...
/* v8::internal::MemoryChunk::SetReadAndWritable() */

void __thiscall v8::internal::MemoryChunk::SetReadAndWritable(MemoryChunk *this)

{
  ...
  *(long *)(this + 0xb8) = lVar1 + 1;
  if (lVar1 != 0) goto LAB_01013d84;
  if (FLAG_v8_os_page_size == 0) {
    ...
    if (FLAG_v8_os_page_size != 0) goto LAB_01013d50;
    lVar1 = CommitPageSize();
  }
  else {
...
LAB_01013d50:
  ...
  uVar3 = VirtualMemory::SetPermissions
                    (this + 0x40,pMVar4,
                     *(long *)(this + 0x28) + lVar1 + ~*(ulong *)(this + 0x20) & -lVar1,2);
  if ((uVar3 & 1) == 0) {
