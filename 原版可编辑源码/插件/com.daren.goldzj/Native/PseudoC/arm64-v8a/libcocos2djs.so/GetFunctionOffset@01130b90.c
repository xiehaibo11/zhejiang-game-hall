...
/* v8::internal::StackTraceFrame::GetFunctionOffset(v8::internal::Handle<v8::internal::StackTraceFrame>)
    */

int v8::internal::StackTraceFrame::GetFunctionOffset(ulong *param_1)
