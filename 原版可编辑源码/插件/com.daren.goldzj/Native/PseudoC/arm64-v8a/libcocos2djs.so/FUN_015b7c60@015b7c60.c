...
undefined8 FUN_015b7c60(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_620,(ulong)&local_620 | 8,0x282);
  }
  if (DAT_01d477f0 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d477f0 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d477f0;
  local_640 = (byte **)0x0;
  if ((*DAT_01d477f0 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar3,"V8.Runtime_Runtime_WasmExceptionGetValues",0,0,0,0,0,0,0,
                       &local_5f8,0);
    plVar4 = local_5f0;
    local_5f0 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    local_640 = &local_638;
    local_630 = "V8.Runtime_Runtime_WasmExceptionGetValues";
    local_638 = pbVar3;
    local_628 = uVar5;
  }
  ...
  *(ulong *)(param_3 + 0x2bc8) = uVar6 & 0xffffffff00000000 | (ulong)*(uint *)(uVar6 + 0x77);
  ...
  if (((uVar6 & 1) == 0) || (*(ushort *)(((ulong)param_3 | 7) + (ulong)*(uint *)(uVar6 - 1)) < 0xa9)
    ...
    pIVar8 = (Isolate *)v8::internal::WasmExceptionPackage::GetExceptionValues(param_3,puVar7);
  }
