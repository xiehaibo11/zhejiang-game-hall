...
LAB_01809280:
    bVar1 = true;
    if (param_3 != (long *)0x0) goto LAB_01809288;
LAB_0180925c:
    if (bVar1) goto LAB_018092d8;
    plVar5 = (long *)0x0;
  }
  else {
    ...
    bVar1 = *param_1 == 0;
    if (param_3 == (long *)0x0) goto LAB_0180925c;
LAB_01809288:
...
LAB_018092d8:
  ...
  if (plVar6[3] == plVar6[4]) {
    (**(code **)(*plVar6 + 0x50))();
    plVar6 = (long *)*param_1;
    if (plVar6 != (long *)0x0) goto LAB_01809350;
LAB_018093a4:
    bVar1 = true;
    if (plVar5 == (long *)0x0) goto LAB_018093ac;
LAB_01809378:
    if ((int *)plVar5[3] == (int *)plVar5[4]) {
...
LAB_01809350:
    ...
    bVar1 = *param_1 == 0;
    if (plVar5 != (long *)0x0) goto LAB_01809378;
LAB_018093ac:
    if (!bVar1) {
      return;
    }
