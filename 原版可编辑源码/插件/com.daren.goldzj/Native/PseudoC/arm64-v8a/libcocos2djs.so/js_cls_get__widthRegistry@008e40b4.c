...
/* js_cls_get__widthRegistry(v8::Local<v8::Name>, v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cls_get__widthRegistry(undefined8 param_1,PropertyCallbackInfo *param_2)

{
  ...
  if (pfVar3 == (float *)0x0) {
    ...
    se::Value::setFloat(pVVar4,*pfVar3);
  }
  pVVar4 = (Value *)se::State::rval(aSStack_60);
