...
/* js_cls_get_strokeStyleRegistry(v8::Local<v8::Name>, v8::PropertyCallbackInfo<v8::Value> const&)
    */

void js_cls_get_strokeStyleRegistry(undefined8 param_1,PropertyCallbackInfo *param_2)
