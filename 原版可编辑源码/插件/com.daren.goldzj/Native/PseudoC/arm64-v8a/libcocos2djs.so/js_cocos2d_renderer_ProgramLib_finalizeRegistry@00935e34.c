...
/* js_cocos2d_renderer_ProgramLib_finalizeRegistry(void*) */

void js_cocos2d_renderer_ProgramLib_finalizeRegistry(void *param_1)

{
  ...
  if (param_1 != (void *)0x0) {
    ...
    if (lVar3 != lVar4) {
      ...
      this_00 = (ProgramLib *)se::State::nativeThisObject(aSStack_60);
      if (this_00 != (ProgramLib *)0x0) {
        cocos2d::renderer::ProgramLib::~ProgramLib(this_00);
