...
void FUN_01086c44(ulong *param_1,ulong *param_2,long param_3,int param_4,int param_5)

{
  ...
  if (uVar2 <= (uint)(*(int *)(*param_2 + 3) >> 1)) {
    if (param_5 == 0) {
      FUN_01086f08(this,param_1,param_2,param_4,0,iVar17);
    }
    goto LAB_01086e00;
  }
  iVar18 = param_4;
  ...
  if (0 < (int)uVar6) {
    ...
    if (uVar6 < 8) {
      ...
      if (uVar15 == uVar13) goto LAB_01086d7c;
    }
...
LAB_01086d7c:
  if (uVar4 != 0) {
    v8::internal::Heap::CopyRange<v8::internal::CompressedObjectSlot>
              ((Heap *)(this + 0x8850),uVar9,uVar9 + (long)(iVar18 << 2) + 7,uVar10 + 7,uVar4,0);
  }
  uVar10 = *param_1;
  uVar9 = *puVar8;
