...
::__rehash(__hash_table<v8::internal::Isolate*,std::__ndk1::hash<v8::internal::Isolate*>,std::__ndk1::equal_to<v8::internal::Isolate*>,std::__ndk1::allocator<v8::internal::Isolate*>>
           *this,ulong param_1)
