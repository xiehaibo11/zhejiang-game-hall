...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<int, char const*>,
   std::__ndk1::__unordered_map_hasher<int, std::__ndk1::__hash_value_type<int, char const*>,
   ...
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<int, char const*> > >::rehash(unsigned
   long) */
...
::rehash(__hash_table<std::__ndk1::__hash_value_type<int,char_const*>,std::__ndk1::__unordered_map_hasher<int,std::__ndk1::__hash_value_type<int,char_const*>,std::__ndk1::hash<int>,true>,std::__ndk1::__unordered_map_equal<int,std::__ndk1::__hash_value_type<int,char_const*>,std::__ndk1::equal_to<int>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<int,char_const*>>>
         *this,ulong param_1)

{
  ...
  if (param_1 <= uVar2) {
    if (param_1 < uVar2) {
      ...
      if (uVar1 < uVar2) goto LAB_00f28958;
    }
    return;
  }
LAB_00f28958:
