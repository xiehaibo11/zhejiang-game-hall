...
/* js_cocos2dx_spine_Bone_setAppliedValidRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_setAppliedValidRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Bone *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x7ba,"js_cocos2dx_spine_Bone_setAppliedValid");
    puVar6 = &DAT_018f6f5b;
LAB_00c1f75c:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Bone::setAppliedValid(this,local_64[0]);
        goto LAB_00c1f794;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x7c1,"js_cocos2dx_spine_Bone_setAppliedValid");
      puVar6 = &DAT_018f6f9a;
      goto LAB_00c1f75c;
    }
    __android_log_print(6,"jswrapper",&DAT_018f6fde,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_setAppliedValid",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x7c8);
LAB_00c1f794:
