...
/* int 
   v8::internal::MainMarkingVisitor<v8::internal::MajorMarkingState>::VisitJSObjectSubclass<v8::internal::JSWeakRef,
   v8::internal::JSWeakRef::BodyDescriptor>(v8::internal::Map, v8::internal::JSWeakRef) */
...
LAB_00fe7f38:
    ...
    iVar8 = (uint)bVar3 << 2;
    for (; puVar1 < (uint *)(param_3 + 0xb); puVar1 = puVar1 + 1) {
      if ((*puVar1 & 1) != 0) {
        MarkingVisitorBase<v8::internal::MainMarkingVisitor<v8::internal::MajorMarkingState>,v8::internal::MajorMarkingState>
        ::ProcessStrongHeapObject<v8::internal::CompressedHeapObjectSlot>
                  ((MarkingVisitorBase<v8::internal::MainMarkingVisitor<v8::internal::MajorMarkingState>,v8::internal::MajorMarkingState>
    ...
    (**(code **)(*(long *)this + 0x20))(this,param_3,(uint *)(param_3 + 0xb),param_3 + 0xf);
    BodyDescriptorBase::
    IterateJSObjectBodyImpl<v8::internal::MainMarkingVisitor<v8::internal::MajorMarkingState>>
              (param_2,param_3,0x10,(ulong)bVar3 << 2,this);
  }
  return iVar8;
}
