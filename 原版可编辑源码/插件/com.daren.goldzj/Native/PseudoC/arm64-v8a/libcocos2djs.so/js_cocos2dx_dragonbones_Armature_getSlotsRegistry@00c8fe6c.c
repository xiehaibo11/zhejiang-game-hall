...
/* js_cocos2dx_dragonbones_Armature_getSlotsRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_Armature_getSlotsRegistry(FunctionCallbackInfo *param_1)

{
  ...
  pOVar7 = (Object *)
           se::Object::createArrayObject(*(long *)(lVar6 + 0x80) - *(long *)(lVar6 + 0x78) >> 3);
  se::HandleObject::HandleObject((HandleObject *)&local_88,pOVar7);
  se::Value::Value(aVStack_58);
  puVar11 = *(undefined8 **)(lVar6 + 0x78);
  puVar1 = *(undefined8 **)(lVar6 + 0x80);
  if (puVar11 != puVar1) {
    uVar9 = 0;
    do {
      bVar4 = native_ptr_to_rooted_seval<dragonBones::Slot>((type *)*puVar11,aVStack_58,(bool *)0x0)
      ;
      if (!bVar4) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            &DAT_019268ae,0x81,&DAT_01926980);
        __android_log_print(6,"jswrapper","Convert getSlots to se::Value failed!");
        se::Value::~Value(aVStack_58);
        se::HandleObject::~HandleObject((HandleObject *)&local_88);
        __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                            &DAT_01926980,&DAT_019268ae,0x84);
        goto LAB_00c90014;
      }
