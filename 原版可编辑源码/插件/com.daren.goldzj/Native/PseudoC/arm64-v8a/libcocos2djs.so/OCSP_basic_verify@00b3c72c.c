...

{
  ...
  uVar11 = (uint)flags;
  pXVar5 = (X509 *)FUN_00b3ce4c(certs,&bs->signatureAlgorithm);
  if (pXVar5 == (X509 *)0x0) {
    if (((uVar11 >> 1 & 1) == 0) &&
       (pXVar5 = (X509 *)FUN_00b3ce4c(bs[2].signatureAlgorithm,&bs->signatureAlgorithm),
       pXVar5 != (X509 *)0x0)) {
      iVar1 = 1;
      goto LAB_00b3c778;
    }
      ...
      if ((uVar11 >> 8 & 1) == 0) {
        ...
        if (iVar1 < 1) {
          ...
          if (0 < iVar1) {
            ...
            if (iVar1 != 1) {
              ...
              do {
                ...
                if (iVar3 != 0) {
                  ...
                  if (iVar1 == 0) {
                    iVar1 = 0;
                    if ((uVar11 >> 5 & 1) == 0) goto LAB_00b3cba4;
                    goto LAB_00b3c9f8;
                  }
            ...
            if (iVar1 < 2) {
LAB_00b3cb8c:
              iVar1 = FUN_00b3cf14(uVar6,local_68,pOVar12);
            }
            else {
              uVar10 = OPENSSL_sk_value(psVar7,1);
              iVar1 = FUN_00b3cf14(uVar10,local_68,pOVar12);
              if (iVar1 < 0) goto LAB_00b3c9f8;
              if (iVar1 == 0) goto LAB_00b3cb8c;
            ...
            if ((uVar11 >> 5 & 1) != 0) goto LAB_00b3c9f8;
LAB_00b3cba4:
            if (iVar1 != 0) goto LAB_00b3c9f8;
            iVar1 = OPENSSL_sk_num(psVar7);
