...
/* v8::internal::Runtime_KeyedLoadIC_Miss(int, unsigned long*, v8::internal::Isolate*) */

undefined8 v8::internal::Runtime_KeyedLoadIC_Miss(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  uVar4 = FUN_01504128(param_1,param_2,param_3);
  return uVar4;
}
