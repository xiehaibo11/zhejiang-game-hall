...
/* v8::internal::compiler::JSArrayData::JSArrayData(v8::internal::compiler::JSHeapBroker*,
   v8::internal::compiler::ObjectData**, v8::internal::Handle<v8::internal::JSArray>) */

void __thiscall v8::internal::compiler::JSArrayData::JSArrayData(JSArrayData *this,long param_1)
