...
void __thiscall
std::__ndk1::__deque_base<int,v8::internal::RecyclingZoneAllocator<int>>::clear
          (__deque_base<int,v8::internal::RecyclingZoneAllocator<int>> *this)
  ...
  if (lVar4 - (long)puVar2 != 0) {
    ...
    while (lVar1 != lVar9) {
      while (lVar9 = lVar9 + 4, lVar9 - *plVar6 == 0x1000) {
        plVar6 = plVar6 + 1;
        lVar9 = *plVar6;
        if (lVar1 == lVar9) goto LAB_016675c4;
      }
    }
  }
LAB_016675c4:
...
LAB_0166762c:
  ...
  if (puVar5 != (undefined8 *)0x0) goto LAB_0166761c;
  do {
    puVar5 = puVar7;
    puVar5[1] = 0x400;
    *puVar5 = *(undefined8 *)(this + 0x48);
