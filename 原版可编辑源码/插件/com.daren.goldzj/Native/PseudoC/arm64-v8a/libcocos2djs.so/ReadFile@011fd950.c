...
void __thiscall v8::internal::ReadFile(internal *this,__sFILE *param_1,bool *param_2,bool param_3)

{
  ...
  FUN_011fda90(&local_58,this,param_1,(uint)param_2 & 1,&DAT_0189703a);
  puVar8 = local_58;
  if (local_58 == local_50) {
    *in_x8 = 0;
    in_x8[1] = 0;
    in_x8[2] = 0;
    goto joined_r0x011fd9dc;
  }
  ...
  *in_x8 = 0;
  ...
  if (uVar10 < 0x17) {
    ...
    *(char *)in_x8 = (char)((int)uVar10 << 1);
    if (uVar10 < 0x20) goto LAB_011fda10;
LAB_011fd9b8:
    if ((puVar6 < local_50) && (puVar8 < puVar6 + uVar10)) goto LAB_011fda10;
    ...
    puVar6 = puVar2;
    if (uVar10 != uVar3) goto LAB_011fda10;
  }
  else {
    ...
    *in_x8 = uVar9 | 1;
    if (0x1f < uVar10) goto LAB_011fd9b8;
LAB_011fda10:
    do {
      puVar7 = puVar8 + 1;
      puVar2 = puVar6 + 1;
