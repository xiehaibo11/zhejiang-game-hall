    ...
    if (uVar4 < 0x20) {
      ...
      if (uVar12 != 0) {
        ...
        if ((key < (RC2_KEY *)(data + uVar16)) && (data < (uchar *)((long)key->data + uVar16))) {
          ...
          if (uVar4 == uVar12) goto LAB_00b46f70;
        }
      }
    }
    do {
...
LAB_00b46f70:
  if (len < 0x80) {
    ...
    do {
      ...
      lVar9 = lVar9 + 1;
      cVar11 = (&DAT_018bce60)[(byte)(cVar11 + *pcVar1)];
      *(char *)((long)key->data + lVar13 + -1) = cVar11;
    } while ((iVar2 + 1) + lVar9 + -2 < 0x7f);
  }
  lVar9 = (long)((ulong)(iVar3 + 7U) << 0x20) >> 0x23;
  lVar13 = 0x80 - lVar9;
  bVar7 = (&DAT_018bce60)[0xffU >> (ulong)(-iVar3 & 7) & (uint)*(byte *)((long)key + lVar13)];
  *(byte *)((long)key + lVar13) = bVar7;
  if ((int)lVar13 != 0) {
    lVar13 = (long)(int)lVar13 + -1;
    lVar10 = 0;
    do {
      bVar7 = (&DAT_018bce60)[*(byte *)((long)key->data + lVar10 + lVar9 + lVar13) ^ bVar7];
