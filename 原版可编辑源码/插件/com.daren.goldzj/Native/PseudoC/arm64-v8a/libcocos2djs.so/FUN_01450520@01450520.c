...
void FUN_01450520(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  *(int *)(unaff_x29 + -0x20) = ((int)unaff_x19 + -1) * 2;
  ...
  sVar6 = *(short *)(unaff_x20 + unaff_x19 + 2);
  iVar14 = (int)sVar6;
  if (0xb < bVar5) {
    iVar15 = (int)sVar6;
    if (0x11 < bVar5) {
      ...
      if (bVar5 == 0x13) {
        uVar9 = *(ulong *)(unaff_x29 + (long)iVar15 * 8);
        if ((uVar9 & 1) == 0) {
          lVar12 = *(long *)(unaff_x26 + 0xc0);
        }
    ...
    if (bVar5 == 0xe) {
      ...
      FUN_01347360(*(ushort *)(unaff_x20 + unaff_x19 + 4) - 2,*puVar2,puVar2 + -1);
      return;
    }
  }
  if (5 < bVar5) {
...
LAB_01450b8c:
                    /* WARNING: Could not recover jumptable at 0x01450bbc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(*(long *)(unaff_x26 + 0x13e0) +
              (ulong)*(byte *)(*(long *)(unaff_x29 + -0x18) +
                              ((long)((ulong)*(uint *)(unaff_x29 + -0x20) << 0x20) >> 0x21) + 7) * 8
              ))(lVar12);
  return;
}
