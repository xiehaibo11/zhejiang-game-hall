...
/* v8::internal::compiler::Operator1<int, v8::internal::compiler::OpEqualTo<int>,
   v8::internal::compiler::OpHash<int> >::Equals(v8::internal::compiler::Operator const*) const */

bool __thiscall
v8::internal::compiler::
Operator1<int,v8::internal::compiler::OpEqualTo<int>,v8::internal::compiler::OpHash<int>>::Equals
