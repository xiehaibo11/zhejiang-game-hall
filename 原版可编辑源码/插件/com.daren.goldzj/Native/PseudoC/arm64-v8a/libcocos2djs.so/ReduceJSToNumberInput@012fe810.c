...
/* v8::internal::compiler::TypedOptimization::ReduceJSToNumberInput(v8::internal::compiler::Node*)
    */

Node * __thiscall
v8::internal::compiler::TypedOptimization::ReduceJSToNumberInput
...

{
  ...
  if (((local_18 == (int *)0x4021) ||
    ...
    ObjectRef::ObjectRef((ObjectRef *)&local_40,*(undefined8 *)(this + 0x20),uVar5,0);
...
LAB_012fe9c8:
    ...
    if ((uVar1 & 1) == 0) goto LAB_012fe8f4;
    ObjectRef::ObjectRef((ObjectRef *)&local_40,*(undefined8 *)(this + 0x20),uVar5,0);
    uVar1 = ObjectRef::IsHeapObject((ObjectRef *)&local_40);
    if ((uVar1 & 1) == 0) goto LAB_012fe9c8;
    ...
    if ((auVar6._0_8_ & 0xff) == 0) {
      pNVar2 = (Node *)NoChangeBecauseOfMissingData
                                 (*(JSHeapBroker **)(this + 0x20),"ReduceJSToNumberInput",0x305);
      return pNVar2;
    }
LAB_012fe968:
    param_1 = (Node *)JSGraph::Constant(*(JSGraph **)(this + 0x18),dVar4);
  }
  else {
LAB_012fe8f4:
    if ((((ulong)local_18 & 1) == 0) && (*local_18 == 0)) {
      ...
      dVar4 = auVar6._8_8_;
      if ((auVar6._0_8_ & 0xff) != 0) goto LAB_012fe968;
    }
    if ((local_18 != (int *)0x1c5f) &&
      ...
      if ((local_18 == (int *)0x101) ||
        ...
        param_1 = (Node *)JSGraph::NaNConstant(*(JSGraph **)(this + 0x18));
      }
      else if ((local_18 == (int *)0x81) ||
              (uVar1 = Type::SlowIs((Type *)&local_18,0x81), (uVar1 & 1) != 0)) {
        param_1 = (Node *)JSGraph::ZeroConstant(*(JSGraph **)(this + 0x18));
      }
      else {
        param_1 = (Node *)0x0;
      }
