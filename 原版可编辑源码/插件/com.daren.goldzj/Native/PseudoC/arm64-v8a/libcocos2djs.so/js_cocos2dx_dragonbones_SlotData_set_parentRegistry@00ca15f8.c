...
/* js_cocos2dx_dragonbones_SlotData_set_parentRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_SlotData_set_parentRegistry
...

{
  ...
  if (lVar7 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x73d,"js_cocos2dx_dragonbones_SlotData_set_parent");
    puVar9 = (undefined *)0x1932037;
  }
  else {
...
LAB_00ca1730:
    ...
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x742,"js_cocos2dx_dragonbones_SlotData_set_parent");
    puVar9 = &DAT_0193207b;
  }
  __android_log_print(6,"jswrapper",puVar9);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_SlotData_set_parent",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x746);
LAB_00ca17a8:
