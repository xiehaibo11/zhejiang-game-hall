...
/* v8::internal::compiler::GraphAssembler::Int32Add(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Int32Add(GraphAssembler *this,Node *param_1,Node *param_2)
