...
LAB_0181de64:
  ...
  if (param_2 < param_3) {
    ...
    do {
      wVar2 = *param_2;
      if (((wVar2 & 0xfffff800U) == 0xd800) || (uVar5 < (uint)wVar2)) goto LAB_0181de68;
      bVar3 = (byte)((uint)wVar2 >> 8);
      if ((uint)wVar2 >> 0x10 == 0) {
        if ((long)param_6 - (long)param_5 < 2) goto LAB_0181de64;
        pbVar6 = (byte *)(param_5 + 1);
        *param_5 = bVar3;
        lVar7 = 2;
      }
      else {
        if ((long)param_6 - (long)param_5 < 4) goto LAB_0181de64;
