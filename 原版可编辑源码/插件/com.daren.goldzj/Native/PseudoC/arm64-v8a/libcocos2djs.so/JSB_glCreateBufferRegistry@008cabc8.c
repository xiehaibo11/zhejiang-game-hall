...
/* JSB_glCreateBufferRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glCreateBufferRegistry(FunctionCallbackInfo *param_1)

{
  ...
  glGenBuffers(1,&local_a4);
  this = (Object *)se::Object::createObjectWithClass(DAT_01d36f18);
  ...
  if (this_00 != (Ref *)0x0) {
    ...
    *(undefined ***)this_00 = &PTR_FUN_01c67788;
    if (uVar10 != 0) {
      uVar9 = uVar10 - 1;
      if ((uVar9 & uVar10) == 0) {
      ...
      plVar7 = *(long **)(DAT_01d36e30 + unaff_x27 * 8);
      if (plVar7 != (long *)0x0) {
        do {
          plVar7 = (long *)*plVar7;
          if (plVar7 == (long *)0x0) goto LAB_008cae14;
          uVar12 = plVar7[1];
          if (uVar12 != uVar14) {
            if ((uVar9 & uVar10) == 0) {
              uVar12 = uVar12 & uVar9;
              ...
              if (uVar12 - uVar1 * uVar10 == unaff_x27) goto LAB_008cae04;
              goto LAB_008cae14;
            }
            if (uVar12 != unaff_x27) goto LAB_008cae14;
          }
LAB_008cae04:
...
LAB_008cae14:
    ...
    *plVar7 = 0;
    ...
    if ((uVar10 == 0) || (fVar4 * (float)uVar10 < (float)(lVar3 + 1))) {
      ...
      FUN_008d3530(&DAT_01d36e30,uVar10);
      uVar10 = DAT_01d36e38;
      if ((DAT_01d36e38 - 1 & DAT_01d36e38) == 0) {
        unaff_x27 = DAT_01d36e38 - 1 & uVar14;
      }
      else {
        unaff_x27 = uVar14;
        if (DAT_01d36e38 <= uVar14) {
          uVar9 = 0;
          if (DAT_01d36e38 != 0) {
            uVar9 = uVar14 / DAT_01d36e38;
          }
          unaff_x27 = uVar14 - uVar9 * DAT_01d36e38;
        }
      }
    }
    lVar3 = DAT_01d36e30;
    plVar11 = *(long **)(DAT_01d36e30 + unaff_x27 * 8);
    if (plVar11 == (long *)0x0) {
      plVar11 = plVar7;
      *plVar7 = (long)DAT_01d36e40;
      DAT_01d36e40 = plVar11;
      *(long ***)(lVar3 + unaff_x27 * 8) = &DAT_01d36e40;
      if (*plVar7 != 0) {
        ...
        plVar11 = (long *)(DAT_01d36e30 + uVar14 * 8);
        goto LAB_008caf34;
      }
    }
    else {
