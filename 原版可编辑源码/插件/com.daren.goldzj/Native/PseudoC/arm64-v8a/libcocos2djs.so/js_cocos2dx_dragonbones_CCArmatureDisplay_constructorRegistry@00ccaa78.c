...
/* js_cocos2dx_dragonbones_CCArmatureDisplay_constructorRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_CCArmatureDisplay_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Object *)
         se::Object::_createJSObject
                   (__jsb_dragonBones_CCArmatureDisplay_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_dragonBones_CCArmatureDisplay_finalizeRegistry);
  se::State::State(aSStack_60,this,(vector *)&local_a0);
  this_00 = operator_new(0xd0,(nothrow_t *)&std::nothrow);
  if (this_00 != (CCArmatureDisplay *)0x0) {
    dragonBones::CCArmatureDisplay::CCArmatureDisplay(this_00);
  }
