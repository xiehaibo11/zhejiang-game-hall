...
/* js_cocos2dx_dragonbones_AnimationState_set_playTimesRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_AnimationState_set_playTimesRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x11d3,&DAT_0192a39a);
    pcVar8 = "js_cocos2dx_dragonbones_AnimationState_set_playTimes : Invalid Native Object";
  }
  else {
    local_74 = 0;
    ...
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x11d8,&DAT_0192a39a);
    pcVar8 = "js_cocos2dx_dragonbones_AnimationState_set_playTimes : Error processing new value";
  }
