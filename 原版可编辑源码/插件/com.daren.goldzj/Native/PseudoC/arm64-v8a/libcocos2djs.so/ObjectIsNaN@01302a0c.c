...
/* v8::internal::compiler::Typer::Visitor::ObjectIsNaN(v8::internal::compiler::Type,
   v8::internal::compiler::Typer*) */

undefined8 v8::internal::compiler::Typer::Visitor::ObjectIsNaN(long param_1,long param_2)
