...
/* unsigned int
   std::__ndk1::__sort4<v8::internal::EnumIndexComparator<v8::internal::NameDictionary>&,
...
uint std::__ndk1::
     __sort4<v8::internal::EnumIndexComparator<v8::internal::NameDictionary>&,v8::internal::AtomicSlot>
               (uint *param_1,uint *param_2,uint *param_3,uint *param_4,long *param_5)

{
  uint uVar1;
  uint uVar2;
  
  uVar2 = __sort3<v8::internal::EnumIndexComparator<v8::internal::NameDictionary>&,v8::internal::AtomicSlot>
                    ();
