...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitLdaFalse(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitLdaFalse
...

{
  ...
  local_28 = 0;
  Hints::AddConstant((Hints *)&local_28,lVar3 + 0xc0,lVar2);
