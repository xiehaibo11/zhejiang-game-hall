...
/* v8::tracing::TracedValue::BeginDictionary() */

void __thiscall v8::tracing::TracedValue::BeginDictionary(TracedValue *this)

{
  ...
  if (this[0x20] == (TracedValue)0x0) {
    ...
    if (((byte)bVar2 & 1) == 0) {
      ...
      uVar1 = 0x16;
      if (uVar5 == 0x16) goto LAB_011fa190;
    }
    else {
...
LAB_011fa190:
  ...
  if (((byte)bVar2 & 1) == 0) {
    uVar5 = (ulong)((byte)bVar2 >> 1);
    uVar1 = 0x16;
    if (uVar5 != 0x16) goto joined_r0x011fa20c;
  }
  else {
    uVar5 = *(ulong *)(this + 0x10);
    uVar1 = (*(ulong *)(this + 8) & 0xfffffffffffffffe) - 1;
    if (uVar5 != uVar1) goto joined_r0x011fa20c;
  }
  std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::
  __grow_by(pbVar3,uVar1,1,uVar1,uVar1,0,0);
  bVar2 = *pbVar3;
