...
long FUN_0158791c(Factory *param_1,long *param_2,ulong *param_3,long *param_4,undefined8 param_5)
  ...
  *(long *)(param_1 + 0xb628) = *(long *)pFVar1;
  ...
  if (*(long *)pFVar1 == *(long *)(param_1 + 0xb628)) {
    ...
    if (iVar9 == 0) {
      ...
      plVar7 = (long *)v8::internal::Factory::NewRawTwoByteString(param_1,iVar9,0);
      if (plVar7 == (long *)0x0) {
          ...
          do {
            ...
            if (iVar9 < iVar3) {
              v8::internal::String::WriteToFlat<unsigned_short>
                        (*param_2,*plVar7 + (long)iVar13 * 2 + 0xb,iVar9,iVar3);
              iVar13 = (iVar13 - iVar9) + iVar3;
            }
            if (0 < iVar6) {
              v8::internal::String::WriteToFlat<unsigned_short>
                        (*param_4,*plVar7 + (long)iVar13 * 2 + 0xb,0,iVar6);
              iVar13 = iVar13 + iVar6;
            }
            piVar12 = piVar12 + 1;
            iVar9 = iVar3 + iVar5;
        ...
        if (iVar9 < iVar4) {
          v8::internal::String::WriteToFlat<unsigned_short>
                    (*param_2,*plVar7 + (long)iVar13 * 2 + 0xb,iVar9);
        }
