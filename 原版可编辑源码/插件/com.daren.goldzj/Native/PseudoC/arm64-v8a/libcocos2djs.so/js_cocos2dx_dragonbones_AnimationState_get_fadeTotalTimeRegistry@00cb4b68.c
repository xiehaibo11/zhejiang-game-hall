...
/* js_cocos2dx_dragonbones_AnimationState_get_fadeTotalTimeRegistry(v8::Local<v8::Name>,
   v8::PropertyCallbackInfo<v8::Value> const&) */

void js_cocos2dx_dragonbones_AnimationState_get_fadeTotalTimeRegistry
...

{
  ...
  if (lVar3 == 0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_AnimationState_get_fadeTotalTime : Invalid Native Object"
                       );
    ...
    float_to_seval(*(float *)(lVar3 + 0x28),aVStack_58);
