...
/* js_cocos2dx_particle_ParticleSimulator_set_emitterModeRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_particle_ParticleSimulator_set_emitterModeRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x25e,"js_cocos2dx_particle_ParticleSimulator_set_emitterMode");
    pcVar8 = "js_cocos2dx_particle_ParticleSimulator_set_emitterMode : Invalid Native Object";
  }
  else {
    local_74 = 0;
    uVar7 = seval_to_int32((Value *)*puVar5,&local_74);
    if ((uVar7 & 1) != 0) {
      *(int *)(lVar6 + 0x124) = local_74;
      goto LAB_00c07bb0;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                        ,0x263,"js_cocos2dx_particle_ParticleSimulator_set_emitterMode");
    pcVar8 = "js_cocos2dx_particle_ParticleSimulator_set_emitterMode : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar8);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_particle_ParticleSimulator_set_emitterMode",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                      ,0x267);
LAB_00c07bb0:
