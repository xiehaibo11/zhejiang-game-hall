...
/* v8::internal::SerializerDeserializer::RestoreExternalReferenceRedirectors(std::__ndk1::vector<v8::internal::CallHandlerInfo,
   std::__ndk1::allocator<v8::internal::CallHandlerInfo> > const&) */
...

{
  ...
  for (puVar4 = *(ulong **)param_1; puVar4 != puVar1; puVar4 = puVar4 + 1) {
    local_18 = *puVar4;
    uVar2 = *(uint *)(local_18 + 7);
    uVar3 = local_18 & 0xffffffff00000000;
    this = (SerializerDeserializer *)
           CallHandlerInfo::redirected_callback((CallHandlerInfo *)&local_18);
