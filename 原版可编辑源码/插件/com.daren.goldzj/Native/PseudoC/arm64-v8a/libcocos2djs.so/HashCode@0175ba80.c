...
/* v8::internal::compiler::Operator1<v8::internal::compiler::CloneObjectParameters,
   ...
   v8::internal::compiler::OpHash<v8::internal::compiler::CloneObjectParameters> >::HashCode() const
    */
...
::HashCode(Operator1<v8::internal::compiler::CloneObjectParameters,v8::internal::compiler::OpEqualTo<v8::internal::compiler::CloneObjectParameters>,v8::internal::compiler::OpHash<v8::internal::compiler::CloneObjectParameters>>
           *this)
