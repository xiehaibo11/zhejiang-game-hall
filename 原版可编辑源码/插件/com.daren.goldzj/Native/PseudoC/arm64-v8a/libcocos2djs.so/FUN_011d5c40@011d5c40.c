...
undefined8 FUN_011d5c40(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_d0,(ulong)&local_d0 | 8,0x187);
  }
  if (DAT_01d3fbf8 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d3fbf8 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar2 = DAT_01d3fbf8;
  local_f0 = (byte **)0x0;
  if ((*DAT_01d3fbf8 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar2,"V8.Runtime_Runtime_AddPrivateField",0,0,0,0,0,0,0,
                       &local_a8,0);
    plVar4 = local_a0;
    local_a0 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    local_f0 = &local_e8;
    local_e0 = "V8.Runtime_Runtime_AddPrivateField";
    local_e8 = pbVar2;
    local_d8 = uVar5;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar7 & 1) != 0) &&
    ...
    v8::internal::LookupIterator::PropertyOrElement
              ((LookupIterator *)&local_a8,param_3,param_2,puVar9,1);
    if (local_a8._4_4_ == 4) {
      uVar3 = v8::internal::Object::AddDataProperty(&local_a8,param_2 + -2,0,0x100000001,0);
      if ((uVar3 & 0xff) == 0) {
      ...
      puVar6 = (undefined8 *)v8::internal::Factory::NewTypeError((Factory *)param_3,0xb0,puVar9,0,0)
      ;
      uVar8 = v8::internal::Isolate::Throw(param_3,*puVar6,0);
    }
