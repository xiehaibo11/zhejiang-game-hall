...
/* v8::internal::compiler::SerializerForBackgroundCompilation::ProcessHintsForHasInPrototypeChain(v8::internal::compiler::Hints
   const&) */

void __thiscall
v8::internal::compiler::SerializerForBackgroundCompilation::ProcessHintsForHasInPrototypeChain
