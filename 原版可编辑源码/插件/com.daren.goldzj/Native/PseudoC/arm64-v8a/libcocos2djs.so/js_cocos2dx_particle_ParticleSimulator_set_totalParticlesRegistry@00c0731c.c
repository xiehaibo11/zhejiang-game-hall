...
/* js_cocos2dx_particle_ParticleSimulator_set_totalParticlesRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_particle_ParticleSimulator_set_totalParticlesRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x226,"js_cocos2dx_particle_ParticleSimulator_set_totalParticles");
    pcVar8 = "js_cocos2dx_particle_ParticleSimulator_set_totalParticles : Invalid Native Object";
  }
  else {
    local_78 = 0;
    uVar7 = seval_to_size((Value *)*puVar5,&local_78);
    if ((uVar7 & 1) != 0) {
      *(ulong *)(lVar6 + 0x118) = local_78;
      goto LAB_00c074b8;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                        ,0x22b,"js_cocos2dx_particle_ParticleSimulator_set_totalParticles");
    pcVar8 = 
    "js_cocos2dx_particle_ParticleSimulator_set_totalParticles : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar8);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_particle_ParticleSimulator_set_totalParticles",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_particle_auto.cpp"
                      ,0x22f);
LAB_00c074b8:
