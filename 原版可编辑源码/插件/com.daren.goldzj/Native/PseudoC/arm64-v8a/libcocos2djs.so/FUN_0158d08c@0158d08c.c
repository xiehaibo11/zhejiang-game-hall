...
undefined8 FUN_0158d08c(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_90,(ulong)&local_90 | 8,0x1ed);
  }
  if (DAT_01d472d8 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d472d8 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d472d8;
  local_b0 = (byte **)0x0;
  if ((*DAT_01d472d8 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar3,"V8.Runtime_Runtime_NewClosure_Tenured",0,0,0,0,0,0,0,
                       &local_60,0);
    plVar4 = local_58;
    local_58 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    local_b0 = &local_a8;
    local_a0 = "V8.Runtime_Runtime_NewClosure_Tenured";
    local_a8 = pbVar3;
    local_98 = uVar5;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  uVar8 = *param_2;
  if (((uVar8 & 1) != 0) &&
     (*(short *)((uVar8 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar8 - 1)) == 0xa6)) {
    uVar8 = param_2[-1];
    if (((uVar8 & 1) != 0) &&
       (*(short *)((uVar8 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar8 - 1)) == 0x5d)) {
      ...
      puVar7 = (undefined8 *)
               v8::internal::Factory::NewFunctionFromSharedFunctionInfo
                         ((Factory *)param_3,param_2,puVar6,param_2 + -1,1);
      uVar5 = *puVar7;
    ...
    V8_Fatal("Check failed: %s.","args[1].IsFeedbackCell()");
  }
                    /* WARNING: Subroutine does not return */
  V8_Fatal("Check failed: %s.","args[0].IsSharedFunctionInfo()");
}
