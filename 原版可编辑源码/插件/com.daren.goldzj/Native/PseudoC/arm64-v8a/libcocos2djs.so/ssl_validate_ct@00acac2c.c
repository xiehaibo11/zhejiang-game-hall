...

{
  ...
  if (*(long *)(param_1 + 0x238) == 0) {
    return 1;
                    ...
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00aca994 with catch @ 00acac5c
                        */
  ...
  iVar1 = OPENSSL_sk_num(*(undefined8 *)(param_1 + 200));
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00acab5c with catch @ 00acaca4
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00acac70 with catch @ 00acaca8
                        */
    ...
    if (-1 < iVar1) {
      ...
      if (0 < iVar1) {
        CT_POLICY_EVAL_CTX_free(lVar2);
                    /* try { // try from 00acac70 to 00bcac73 has its CatchHandler @ 00acaca8 */
        return iVar1;
      }
      goto LAB_00acad78;
    }
