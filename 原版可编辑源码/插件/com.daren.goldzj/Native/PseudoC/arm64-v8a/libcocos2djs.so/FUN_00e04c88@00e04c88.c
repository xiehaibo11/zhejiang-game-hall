...
void FUN_00e04c88(ulong *param_1,long param_2)

{
  ...
  puVar20 = &DAT_01971040;
  puVar22 = &DAT_01971460;
  do {
    lVar10 = 0;
    lVar16 = lVar15;
    lVar11 = lVar17;
    ...
    do {
      ...
      do {
        ...
        if (uVar6 < 0x7f) {
          uVar8 = (ulong)uVar6;
          uVar6 = (uint)(byte)(&DAT_01970d00)[uVar6];
          *(uint *)((long)param_1 + 0xc) = uVar9 - (byte)(&DAT_01970c80)[uVar8];
        }
