...
/* v8::internal::StackTraceFrame::IsAsmJsWasm(v8::internal::Handle<v8::internal::StackTraceFrame>)
    */

byte v8::internal::StackTraceFrame::IsAsmJsWasm(ulong *param_1)
