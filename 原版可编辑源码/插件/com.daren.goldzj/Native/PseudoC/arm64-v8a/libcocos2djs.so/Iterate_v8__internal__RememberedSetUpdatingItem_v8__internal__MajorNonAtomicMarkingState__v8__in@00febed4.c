...
/* unsigned long
   ...
   (v8::internal::GarbageCollector)1>::UpdateUntypedPointers()::{lambda(v8::internal::CompressedMaybeObjectSlot)#1},
   v8::internal::SlotSet::Iterate<v8::internal::RememberedSetUpdatingItem<v8::internal::MajorNonAtomicMarkingState,
   (v8::internal::GarbageCollector)1>::UpdateUntypedPointers()::{lambda(v8::internal::CompressedMaybeObjectSlot)#1}>(unsigned
   long, unsigned long,
...
LAB_00febf94:
                ...
                uVar17 = *puVar2;
                uVar14 = (ulong)uVar17;
                if ((uVar17 == 3) || ((uVar17 & 1) == 0)) goto LAB_00febf94;
