...
/* js_cocos2dx_spine_MeshAttachment_setRegionV2Registry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_MeshAttachment_setRegionV2Registry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (MeshAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1826,"js_cocos2dx_spine_MeshAttachment_setRegionV2");
    puVar6 = &DAT_01905837;
LAB_00c3d188:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::MeshAttachment::setRegionV2(this,local_64);
        goto LAB_00c3d1c0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x182d,"js_cocos2dx_spine_MeshAttachment_setRegionV2");
      puVar6 = &DAT_0190587c;
      goto LAB_00c3d188;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 6193): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_MeshAttachment_setRegionV2",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1834);
LAB_00c3d1c0:
