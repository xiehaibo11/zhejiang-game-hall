...
/* std::__ndk1::__hash_table<v8::internal::Handle<v8::internal::JSObject>,
   v8::internal::Handle<v8::internal::JSObject>::hash,
   v8::internal::Handle<v8::internal::JSObject>::equal_to,
   v8::internal::ZoneAllocator<v8::internal::Handle<v8::internal::JSObject> > >::__rehash(unsigned
   long) */
...
::__rehash(__hash_table<v8::internal::Handle<v8::internal::JSObject>,v8::internal::Handle<v8::internal::JSObject>::hash,v8::internal::Handle<v8::internal::JSObject>::equal_to,v8::internal::ZoneAllocator<v8::internal::Handle<v8::internal::JSObject>>>
           *this,ulong param_1)
      ...
      if (plVar6 != (long *)0x0) {
        do {
          ...
          if ((uVar12 & 0xffffffff) < 2) {
            uVar7 = uVar7 & uVar3;
LAB_0173b7e0:
            if (uVar7 == uVar4) goto LAB_0173b7a8;
LAB_0173b7e8:
            plVar9 = plVar6;
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) goto LAB_0173b844;
            do {
              plVar8 = plVar9;
              plVar9 = (long *)*plVar8;
            ...
            **(undefined8 **)(*(long *)this + uVar7 * 8) = plVar6;
            ...
            if (uVar7 < param_1) goto LAB_0173b7e0;
            uVar1 = 0;
            if (param_1 != 0) {
              uVar1 = uVar7 / param_1;
            }
            uVar7 = uVar7 - uVar1 * param_1;
            if (uVar7 != uVar4) goto LAB_0173b7e8;
LAB_0173b7a8:
            plVar9 = (long *)*plVar6;
            plVar5 = plVar6;
          }
