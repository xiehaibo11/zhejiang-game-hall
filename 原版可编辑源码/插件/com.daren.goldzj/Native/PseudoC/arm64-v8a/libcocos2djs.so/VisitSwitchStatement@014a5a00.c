...
/* v8::internal::AstTraversalVisitor<v8::internal::SourceRangeAstVisitor>::VisitSwitchStatement(v8::internal::SwitchStatement*)
    */

void __thiscall
v8::internal::AstTraversalVisitor<v8::internal::SourceRangeAstVisitor>::VisitSwitchStatement
          (AstTraversalVisitor<v8::internal::SourceRangeAstVisitor> *this,SwitchStatement *param_1)
      ...
      if ((this[8] == (AstTraversalVisitor<v8::internal::SourceRangeAstVisitor>)0x0) &&
        ...
        do {
          ...
          if (pAVar2 != (AstNode *)0x0) {
            uVar1 = GetCurrentStackPosition();
            if (uVar1 < *(ulong *)this) goto LAB_014a5a3c;
            VisitNoStackOverflowCheck(this,pAVar2);
            if (this[8] != (AstTraversalVisitor<v8::internal::SourceRangeAstVisitor>)0x0) {
              return;
            }
