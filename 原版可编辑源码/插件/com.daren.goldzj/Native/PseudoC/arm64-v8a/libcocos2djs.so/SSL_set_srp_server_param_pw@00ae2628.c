...

{
  ...
  undefined4 uVar4;
                    ...
                    /* try { // try from 00ae2628 to 00be2647 has its CatchHandler @ 00ae2704 */
                    /* try { // try from 00ae2648 to 00be2753 has its CatchHandler @ 00ae2308 */
    ...
    *(undefined8 *)(param_1 + 0x350) = 0;
    ...
    if (iVar1 == 0) {
      uVar4 = 0xffffffff;
                    ...
                    /* catch() { ... } // from try @ 00ae25ec with catch @ 00ae26c0 */
                    /* catch() { ... } // from try @ 00ae24f0 with catch @ 00ae26c4 */
  return uVar4;
}
