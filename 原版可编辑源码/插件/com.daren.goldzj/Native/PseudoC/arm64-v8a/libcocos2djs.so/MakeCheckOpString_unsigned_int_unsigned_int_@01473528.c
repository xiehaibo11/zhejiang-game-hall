...
/* std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >*
   v8::base::MakeCheckOpString<unsigned int, unsigned int>(unsigned int, unsigned int, char const*)
    */

basic_string *
v8::base::MakeCheckOpString<unsigned_int,unsigned_int>(uint param_1,uint param_2,char *param_3)
