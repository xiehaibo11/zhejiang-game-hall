...
undefined8 FUN_00b6db74(BIO *param_1,int *param_2,uint param_3,undefined8 param_4)
      ...
      if (0 < iVar1) {
        ...
        do {
          ...
          if (*piVar3 == 1) {
            ...
            BIO_printf(param_1,"%*s%s-",(ulong)(param_3 + 2),&DAT_0189703a,pcVar4);
            CRYPTO_free(pcVar4);
            pcVar4 = i2s_ASN1_INTEGER((X509V3_EXT_METHOD *)0x0,
            ...
            BIO_printf(param_1,"%*s%s\n",(ulong)(param_3 + 2),&DAT_0189703a,pcVar4);
          }
          CRYPTO_free(pcVar4);
          iVar1 = iVar1 + 1;
