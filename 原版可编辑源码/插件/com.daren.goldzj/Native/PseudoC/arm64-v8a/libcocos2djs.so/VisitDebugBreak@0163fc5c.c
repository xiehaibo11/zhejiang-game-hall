...
/* v8::internal::compiler::InstructionSelector::VisitDebugBreak(v8::internal::compiler::Node*) */

void v8::internal::compiler::InstructionSelector::VisitDebugBreak(Node *param_1)
