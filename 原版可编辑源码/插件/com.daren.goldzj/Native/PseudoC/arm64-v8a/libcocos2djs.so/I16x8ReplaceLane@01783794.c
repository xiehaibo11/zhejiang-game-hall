...
/* v8::internal::compiler::MachineOperatorBuilder::I16x8ReplaceLane(int) */

Operator * __thiscall
v8::internal::compiler::MachineOperatorBuilder::I16x8ReplaceLane
...

{
  ...
  Operator::Operator(pOVar1,0x25e,0x7c,"Replace lane",2,0,0,1,0,0);
