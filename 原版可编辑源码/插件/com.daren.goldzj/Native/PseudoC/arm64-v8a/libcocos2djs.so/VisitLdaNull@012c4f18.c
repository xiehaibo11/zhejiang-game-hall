...
/* v8::internal::compiler::SerializerForBackgroundCompilation::VisitLdaNull(v8::internal::interpreter::BytecodeArrayIterator*)
    */

void v8::internal::compiler::SerializerForBackgroundCompilation::VisitLdaNull
...

{
  ...
  local_28 = 0;
  Hints::AddConstant((Hints *)&local_28,lVar3 + 0xb0,lVar2);
