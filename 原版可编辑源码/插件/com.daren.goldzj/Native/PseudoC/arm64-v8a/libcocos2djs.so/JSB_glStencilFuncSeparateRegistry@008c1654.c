...
/* JSB_glStencilFuncSeparateRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glStencilFuncSeparateRegistry(FunctionCallbackInfo *param_1)
