...
/* bool v8::internal::wasm::ThreadImpl::ExtractAtomicOpParams<unsigned int, unsigned
   int>(v8::internal::wasm::Decoder*, v8::internal::wasm::InterpreterCode*, unsigned long*, unsigned
   long, int*, unsigned int*, unsigned int*) */

bool __thiscall
v8::internal::wasm::ThreadImpl::ExtractAtomicOpParams<unsigned_int,unsigned_int>
  ...
  *(long *)(this + 0x28) = lVar4 + -0x11;
  ...
  if (CARRY4(local_97,uVar2)) {
    *param_3 = 0;
    ...
    uVar5 = 0;
    if ((3 < *(ulong *)(lVar4 + 0x13)) &&
       ((ulong)(local_97 + uVar2) <= *(ulong *)(lVar4 + 0x13) - 4)) {
