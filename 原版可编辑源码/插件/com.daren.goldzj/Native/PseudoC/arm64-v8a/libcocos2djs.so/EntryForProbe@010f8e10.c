...
/* v8::internal::HashTable<v8::internal::ObjectHashSet,
   v8::internal::ObjectHashSetShape>::EntryForProbe(v8::internal::ReadOnlyRoots,
   v8::internal::Object, int, v8::internal::InternalIndex) */

ulong __thiscall
v8::internal::HashTable<v8::internal::ObjectHashSet,v8::internal::ObjectHashSetShape>::EntryForProbe
          (HashTable<v8::internal::ObjectHashSet,v8::internal::ObjectHashSetShape> *this,
          undefined8 param_2,undefined8 param_3,int param_4,ulong param_5)
