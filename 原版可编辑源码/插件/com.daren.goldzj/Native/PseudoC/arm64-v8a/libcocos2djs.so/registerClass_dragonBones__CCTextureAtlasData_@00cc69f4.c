...
/* void JSBClassType::registerClass<dragonBones::CCTextureAtlasData>(se::Class*) */

void JSBClassType::registerClass<dragonBones::CCTextureAtlasData>(Class *param_1)
