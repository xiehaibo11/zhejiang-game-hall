...
/* js_cocos2dx_spine_TrackEntry_setAlphaRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_TrackEntry_setAlphaRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TrackEntry *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1ab,"js_cocos2dx_spine_TrackEntry_setAlpha");
    pcVar6 = "js_cocos2dx_spine_TrackEntry_setAlpha : Invalid Native Object";
LAB_00c14a18:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::TrackEntry::setAlpha(this,local_64);
        goto LAB_00c14a50;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x1b2,"js_cocos2dx_spine_TrackEntry_setAlpha");
      pcVar6 = "js_cocos2dx_spine_TrackEntry_setAlpha : Error processing arguments";
      goto LAB_00c14a18;
    }
    __android_log_print(6,"jswrapper",&DAT_018f1c19,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TrackEntry_setAlpha",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1b9);
LAB_00c14a50:
