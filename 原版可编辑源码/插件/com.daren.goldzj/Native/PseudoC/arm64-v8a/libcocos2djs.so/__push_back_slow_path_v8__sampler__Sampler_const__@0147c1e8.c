...
/* void std::__ndk1::vector<v8::sampler::Sampler*, std::__ndk1::allocator<v8::sampler::Sampler*>
   >::__push_back_slow_path<v8::sampler::Sampler* const&>(v8::sampler::Sampler* const&) */
...
__push_back_slow_path<v8::sampler::Sampler*const&>
          (vector<v8::sampler::Sampler*,std::__ndk1::allocator<v8::sampler::Sampler*>> *this,
          Sampler **param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_0147c2d0;
