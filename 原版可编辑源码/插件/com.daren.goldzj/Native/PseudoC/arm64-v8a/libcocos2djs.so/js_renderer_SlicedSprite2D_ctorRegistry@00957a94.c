...
/* js_renderer_SlicedSprite2D_ctorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_SlicedSprite2D_ctorRegistry(FunctionCallbackInfo *param_1)
