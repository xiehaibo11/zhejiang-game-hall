...
/* v8::internal::AstTraversalVisitor<v8::internal::AstFunctionLiteralIdReindexer>::VisitFunctionLiteral(v8::internal::FunctionLiteral*)
    */

void __thiscall
v8::internal::AstTraversalVisitor<v8::internal::AstFunctionLiteralIdReindexer>::VisitFunctionLiteral
...

{
  ...
  AstTraversalVisitor<v8::internal::AstFunctionLiteralIdReindexer> AVar4;
  int iVar5;
  int iVar6;
  long lVar7;
  AstNode *pAVar8;
  ...
  *(int *)(this + 0x18) = iVar5;
  ...
  if (plVar10 == plVar9) {
    ...
    do {
      ...
      if (AVar4 != (AstTraversalVisitor<v8::internal::AstFunctionLiteralIdReindexer>)0x0) break;
      AVar4 = (AstTraversalVisitor<v8::internal::AstFunctionLiteralIdReindexer>)0x0;
    ...
    if (0 < *(int *)(param_1 + 0x3c)) {
      ...
      while( true ) {
        ...
        if ((this[8] != (AstTraversalVisitor<v8::internal::AstFunctionLiteralIdReindexer>)0x0) ||
           (lVar7 = lVar7 + 1, *(int *)(param_1 + 0x3c) <= lVar7)) goto LAB_01491ba0;
      }
      this[8] = (AstTraversalVisitor<v8::internal::AstFunctionLiteralIdReindexer>)0x1;
LAB_01491ba0:
