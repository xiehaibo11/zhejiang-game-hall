...
/* std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >*
   v8::base::MakeCheckOpString<unsigned long long, unsigned long long>(unsigned long long, unsigned
   long long, char const*) */

basic_string *
v8::base::MakeCheckOpString<unsigned_long_long,unsigned_long_long>
          (ulonglong param_1,ulonglong param_2,char *param_3)
