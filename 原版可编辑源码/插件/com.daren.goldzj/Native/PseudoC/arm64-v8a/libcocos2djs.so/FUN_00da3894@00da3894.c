...
undefined8 FUN_00da3894(long param_1,long param_2)
  ...
  if (iVar3 == 0) {
    ...
    if (0 < *(int *)(param_1 + 0x1f0)) {
      ...
      do {
        ...
        if ((int)uVar8 < 8) {
          uVar5 = FUN_00da3d1c(&local_88,lVar6,uVar8,0);
          if ((int)uVar5 == 0) {
            return uVar5;
          }
          uVar8 = (ulong)local_70;
          lVar6 = local_78;
          if (7 < (int)local_70) goto LAB_00da39fc;
          uVar5 = 1;
LAB_00da3a28:
          uVar4 = FUN_00da3e70(&local_88,lVar6,uVar8,lVar12,uVar5);
          lVar6 = local_78;
          uVar7 = local_70;
          if ((int)uVar4 < 0) {
            return 0;
        ...
        if (iVar3 == 0) {
          if (uVar4 != 0) {
            if (((int)uVar7 < (int)uVar4) &&
               (uVar5 = FUN_00da3d1c(&local_88,lVar6,uVar8,uVar4), lVar6 = local_78,
          ...
          iVar15 = 1;
          if ((int)uVar8 < 8) goto LAB_00da3c20;
          goto LAB_00da3c48;
        }
        if (uVar4 == 0) {
          iVar9 = 0;
          ...
          if (((int)uVar7 < (int)uVar4) &&
             (uVar5 = FUN_00da3d1c(&local_88,lVar6,uVar8,uVar4), lVar6 = local_78, uVar7 = local_70,
             (int)uVar5 == 0)) {
            return uVar5;
          }
          uVar8 = (ulong)(uVar7 - uVar4);
          uVar7 = *(uint *)(&DAT_01950530 + (long)(int)uVar4 * 4) & (uint)(lVar6 >> (uVar8 & 0x3f));
          uVar2 = 0;
          if ((int)uVar7 <= *(int *)(&DAT_0195052c + (long)(int)uVar4 * 4)) {
            uVar2 = *(uint *)(&DAT_01950530 + (long)(int)uVar4 * 4);
          }
          iVar9 = uVar7 - uVar2;
        }
        iVar15 = 1;
...
LAB_00da3c20:
              ...
              uVar8 = (ulong)local_70;
              lVar6 = local_78;
              if (7 < (int)local_70) goto LAB_00da3c48;
              uVar5 = 1;
LAB_00da3c74:
              uVar4 = FUN_00da3e70(&local_88,lVar6,uVar8,lVar12,uVar5);
              lVar6 = local_78;
...
LAB_00da3c48:
            ...
            if (uVar2 == 0) {
              ...
              if (((int)uVar7 < (int)uVar2) &&
                 (uVar5 = FUN_00da3d1c(&local_88,lVar6,uVar8,uVar2), lVar6 = local_78,
                 uVar7 = local_70, (int)uVar5 == 0)) {
                return uVar5;
              }
          ...
          do {
            if ((int)uVar8 < 8) {
              ...
              uVar8 = (ulong)local_70;
              lVar6 = local_78;
              if (7 < (int)local_70) goto LAB_00da3b40;
              uVar5 = 1;
LAB_00da3b6c:
              uVar4 = FUN_00da3e70(&local_88,lVar6,uVar8,lVar12,uVar5);
              lVar6 = local_78;
...
LAB_00da3b40:
            ...
            uVar2 = uVar4 & 0xf;
            if (uVar2 == 0) {
              if ((int)uVar4 >> 4 != 0xf) goto LAB_00da3cd8;
              iVar9 = iVar15 + 0xf;
            }
            else {
              if (((int)uVar7 < (int)uVar2) &&
              ...
              uVar7 = *(uint *)(&DAT_01950530 + (ulong)uVar2 * 4) & (uint)(lVar6 >> (uVar8 & 0x3f));
              uVar4 = 0;
              if ((int)uVar7 <= *(int *)(&DAT_0195052c + (long)(int)uVar2 * 4)) {
                uVar4 = *(uint *)(&DAT_01950530 + (ulong)uVar2 * 4);
              }
              puVar16[*(int *)(jpeg_natural_order + (long)iVar9 * 4)] = (short)uVar7 - (short)uVar4;
            }
            iVar15 = iVar9 + 1;
          } while (iVar15 < iVar3);
          if (iVar9 < 0x3f) goto LAB_00da3c18;
        }
LAB_00da3cd8:
        uVar7 = (uint)uVar8;
        lVar14 = lVar14 + 1;
