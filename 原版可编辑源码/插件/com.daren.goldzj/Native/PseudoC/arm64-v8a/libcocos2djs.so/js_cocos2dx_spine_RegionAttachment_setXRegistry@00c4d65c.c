...
/* js_cocos2dx_spine_RegionAttachment_setXRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_RegionAttachment_setXRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (RegionAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2097,"js_cocos2dx_spine_RegionAttachment_setX");
    pcVar6 = "js_cocos2dx_spine_RegionAttachment_setX : Invalid Native Object";
LAB_00c4d7d0:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::RegionAttachment::setX(this,local_64);
        goto LAB_00c4d808;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x209e,"js_cocos2dx_spine_RegionAttachment_setX");
      pcVar6 = "js_cocos2dx_spine_RegionAttachment_setX : Error processing arguments";
      goto LAB_00c4d7d0;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 8354): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
