...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >,
   cocos2d::AudioEngine::ProfileHelper> > >::__rehash(unsigned long) */
  ...
  if (param_1 == 0) {
    ...
    *(undefined8 *)(this + 8) = 0;
    ...
    if (param_1 >> 0x3d != 0) {
                    ...
                    /* try { // try from 00a6f3d8 to 00b6f3eb has its CatchHandler @ 00a6f514 */
      abort();
    }
    ...
    if (plVar14 != (long *)0x0) {
      ...
      if ((uVar16 & param_1) == 0) {
        ...
        uVar11 = uVar11 - uVar17 * param_1;
                    /* try { // try from 00a6f22c to 00b6f26f has its CatchHandler @ 00a6f28c */
      }
      *(__hash_table<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::AudioEngine::ProfileHelper>,std::__ndk1::__unordered_map_hasher<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::AudioEngine::ProfileHelper>,std::__ndk1::hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::__unordered_map_equal<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::AudioEngine::ProfileHelper>,std::__ndk1::equal_to<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,cocos2d::AudioEngine::ProfileHelper>>>
      ...
      for (plVar15 = (long *)*plVar14; plVar15 != (long *)0x0; plVar15 = (long *)*plVar15) {
        uVar17 = plVar15[1];
        if ((uVar16 & param_1) == 0) {
                    /* catch() { ... } // from try @ 00a6f150 with catch @ 00a6f28c
                       catch() { ... } // from try @ 00a6f22c with catch @ 00a6f28c */
          uVar17 = uVar17 & uVar16;
        }
        else {
                    /* try { // try from 00a6f270 to 00b6f30b has its CatchHandler @ 00a6f084 */
          if (param_1 <= uVar17) {
            uVar4 = 0;
            if (param_1 != 0) {
          ...
          if (*(long *)(*(long *)this + uVar17 * 8) == 0) {
            *(long **)(*(long *)this + uVar17 * 8) = plVar14;
            uVar11 = uVar17;
                    ...
                    /* catch() { ... } // from try @ 00a6f0d8 with catch @ 00a6f2a4 */
            plVar13 = plVar15;
            if ((long *)*plVar15 != (long *)0x0) {
              bVar3 = *(byte *)(plVar15 + 2);
                    /* catch() { ... } // from try @ 00a6f110 with catch @ 00a6f2b4
                       catch() { ... } // from try @ 00a6f180 with catch @ 00a6f2b4 */
              __n = (ulong)(bVar3 >> 1);
              if ((bVar3 & 1) != 0) {
                __n = plVar15[3];
              }
              ...
              do {
                ...
                if ((bVar3 & 1) != 0) {
                  __s1 = (char *)plVar15[4];
                    ...
                    /* try { // try from 00a6f30c to 00b6f35f has its CatchHandler @ 00a6f30c
                       catch() { ... } // from try @ 00a6f30c with catch @ 00a6f30c
                       catch() { ... } // from try @ 00a6f4f8 with catch @ 00a6f30c */
                if ((bVar2 & 1) == 0) {
                ...
                if ((bVar3 & 1) == 0) {
                  while (sVar6 != 0) {
                    if (*pcVar5 != *__s2) goto LAB_00a6f378;
                    __s2 = __s2 + 1;
                    sVar1 = sVar1 + 1;
                    pcVar5 = pcVar5 + 1;
                    sVar6 = sVar1;
                    ...
                    /* try { // try from 00a6f360 to 00b6f377 has its CatchHandler @ 00a6f52c */
...
LAB_00a6f378:
                    /* try { // try from 00a6f380 to 00b6f38b has its CatchHandler @ 00a6f510 */
            *plVar14 = *plVar13;
                    /* try { // try from 00a6f38c to 00b6f397 has its CatchHandler @ 00a6f50c */
            *plVar13 = **(long **)(*(long *)this + uVar17 * 8);
                    /* try { // try from 00a6f398 to 00b6f3d7 has its CatchHandler @ 00a6f53c */
