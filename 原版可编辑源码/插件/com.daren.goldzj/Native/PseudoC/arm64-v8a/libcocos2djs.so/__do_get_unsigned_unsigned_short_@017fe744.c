...
LAB_017fe828:
  if (param_2 == (long *)0x0) {
    bVar4 = true;
    if (param_3 != (long *)0x0) goto LAB_017fe86c;
LAB_017fe8a8:
    param_3 = (long *)0x0;
    if (bVar4) goto LAB_017fe998;
  }
  else {
    ...
    param_2 = plVar2;
    if (param_3 == (long *)0x0) goto LAB_017fe8a8;
LAB_017fe86c:
  ...
  if ((wchar_t *)param_2[3] == (wchar_t *)param_2[4]) {
    wVar6 = (**(code **)(*param_2 + 0x48))(param_2);
  }
  else {
    wVar6 = *(wchar_t *)param_2[3];
  }
  iVar7 = __num_get<wchar_t>::__stage2_int_loop
                    (wVar6,iVar8,pcVar18,&local_1b8,&local_1c4,local_17c,local_198,local_178,
                     &local_1c0,(wchar_t *)aiStack_d8);
  if (iVar7 != 0) goto LAB_017fe998;
...
LAB_017fe998:
  ...
  uVar5 = FUN_01828990(pcVar18,local_1b8,param_5,iVar8);
  *param_6 = uVar5;
  uVar9 = (ulong)((byte)local_198[0] >> 1);
  if (((byte)local_198[0] & 1) != 0) {
    uVar9 = local_190;
  ...
  if (uVar9 != 0) {
    ...
    if (local_178 < puVar11) {
      ...
      do {
        if ((bVar4) && (*puVar17 != uVar12)) goto LAB_017feaec;
...
LAB_017feaec:
  ...
  if (param_2 == (long *)0x0) {
    bVar4 = true;
    if (param_3 != (long *)0x0) goto LAB_017feb40;
LAB_017feb14:
    if (!bVar4) goto LAB_017feb84;
  }
  else {
    if ((int *)param_2[3] == (int *)param_2[4]) {
    ...
    param_2 = plVar2;
    if (param_3 == (long *)0x0) goto LAB_017feb14;
LAB_017feb40:
    if ((int *)param_3[3] == (int *)param_3[4]) {
      iVar8 = (**(code **)(*param_3 + 0x48))(param_3);
    }
    else {
      iVar8 = *(int *)param_3[3];
    }
    if (bVar4 != (iVar8 == -1)) goto LAB_017feb84;
  }
  *param_5 = *param_5 | 2;
LAB_017feb84:
  if ((local_1b0 & 1) != 0) {
