...
/* JSB_glUniformMatrix3fvRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glUniformMatrix3fvRegistry(FunctionCallbackInfo *param_1)
...
joined_r0x008c774c:
      ...
      if (local_90[0] != 0) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                            ,0xa59,"JSB_glUniformMatrix3fv");
LAB_008c7860:
        DAT_01d36f40 = 0x501;
        goto joined_r0x008c774c;
      }
      if (local_58 != (local_58 / 9) * 9) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                            ,0xa5b,"JSB_glUniformMatrix3fv");
        goto LAB_008c7860;
      }
      glUniformMatrix3fv(local_8c,local_58 / 9,0,local_60);
      bVar2 = true;
    }
    if (local_50 != '\0') {
      free(local_60);
    }
    if (bVar2) goto LAB_008c7788;
  }
  else {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                        ,0xa4f,"JSB_glUniformMatrix3fv");
    __android_log_print(6,"jswrapper","Invalid number of arguments");
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "JSB_glUniformMatrix3fv",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                      ,0xa61);
LAB_008c7788:
