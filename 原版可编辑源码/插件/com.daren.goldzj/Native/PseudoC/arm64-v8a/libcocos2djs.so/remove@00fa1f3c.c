...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<v8::internal::AllocationSite, unsigned
   ...
   long> >
   >::remove(std::__ndk1::__hash_const_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<v8::internal::AllocationSite,
   unsigned long>, void*>*>) */
...

{
  ...
  if (plVar5 != param_2 + 2) {
    ...
    if (uVar7 == uVar4) goto LAB_00fa2018;
  }
  if (*param_3 != 0) {
