...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitCreateObjectLiteral() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitCreateObjectLiteral(BytecodeGraphBuilder *this)

{
  ...
  uVar2 = ObjectBoilerplateDescriptionRef::size((ObjectBoilerplateDescriptionRef *)aOStack_50);
  pJVar10 = *(JSOperatorBuilder **)(*(long *)(this + 0x10) + 0x170);
  uVar4 = ObjectBoilerplateDescriptionRef::object((ObjectBoilerplateDescriptionRef *)aOStack_50);
  pOVar6 = (Operator *)
           JSOperatorBuilder::CreateLiteralObject(pJVar10,uVar4,local_40,uVar3 & 0x1f,uVar2);
