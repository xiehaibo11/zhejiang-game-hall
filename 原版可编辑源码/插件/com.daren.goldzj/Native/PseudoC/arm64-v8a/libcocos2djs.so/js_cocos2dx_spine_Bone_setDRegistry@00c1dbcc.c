...
/* js_cocos2dx_spine_Bone_setDRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_setDRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Bone *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x6dd,"js_cocos2dx_spine_Bone_setD");
    pcVar6 = "js_cocos2dx_spine_Bone_setD : Invalid Native Object";
LAB_00c1dd40:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Bone::setD(this,local_64);
        goto LAB_00c1dd78;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x6e4,"js_cocos2dx_spine_Bone_setD");
      pcVar6 = "js_cocos2dx_spine_Bone_setD : Error processing arguments";
      goto LAB_00c1dd40;
    }
    __android_log_print(6,"jswrapper",&DAT_018f61c4,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_setD",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x6eb);
LAB_00c1dd78:
