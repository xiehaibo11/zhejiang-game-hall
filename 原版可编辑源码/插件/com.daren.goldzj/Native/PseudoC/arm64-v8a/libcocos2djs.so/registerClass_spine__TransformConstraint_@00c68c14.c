...
/* void JSBClassType::registerClass<spine::TransformConstraint>(se::Class*) */

void JSBClassType::registerClass<spine::TransformConstraint>(Class *param_1)
