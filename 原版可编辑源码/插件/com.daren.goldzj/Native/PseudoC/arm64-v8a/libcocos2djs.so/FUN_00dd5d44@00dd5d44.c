...
undefined4 FUN_00dd5d44(long param_1,long param_2,long param_3)
      ...
      if (local_90 == puVar11) {
        ...
        do {
          ...
          case 1:
            ...
            iVar21 = -uVar15;
            puVar13 = puVar13 + 2;
            if ((int)uVar3 <= (int)uVar15) goto LAB_00dd6530;
            break;
          case 2:
            goto switchD_00dd5f90_caseD_2;
          case 3:
            goto switchD_00dd5f90_caseD_3;
          case 4:
            goto switchD_00dd5f90_caseD_4;
          case 5:
            goto switchD_00dd5f90_caseD_5;
          case 6:
            puVar13 = puVar11;
            goto LAB_00dd65f8;
          default:
...
LAB_00dd65f8:
    ...
    uVar15 = 0;
    bVar8 = uVar3 == 0;
    if (uVar3 != 0) goto LAB_00dd6738;
    goto joined_r0x00dd6860;
  }
LAB_00dd6a80:
...
switchD_00dd5f90_caseD_c:
  ...
  *puVar14 = uVar3 - uVar15;
  ...
  uVar31 = uVar31 >> 4;
  iVar24 = 1;
  goto joined_r0x00dd6720;
switchD_00dd5f90_caseD_5:
  if (local_90 != puVar11) {
...
LAB_00dd651c:
  ...
  puVar13 = puVar18;
  pbVar29 = pbVar19;
  if ((int)uVar3 <= (int)uVar15) goto joined_r0x00dd65c8;
  goto LAB_00dd5f28;
switchD_00dd5f90_caseD_3:
  if (local_90 != puVar11) {
    while (((int)uVar20 <= (int)uVar15 && ((int)uVar20 < (int)uVar3))) {
      uVar20 = *puVar13 + uVar20 + puVar13[1];
      puVar13 = puVar13 + 2;
...
LAB_00dd6900:
  ...
  if (uVar15 == uVar3) goto joined_r0x00dd6b60;
  ...
  if (((int)uVar15 <= (int)uVar3) || (puVar13 <= puVar11)) goto joined_r0x00dd6b24;
  goto LAB_00dd6a14;
switchD_00dd5f90_caseD_1:
  while (((int)uVar20 <= (int)uVar15 && ((int)uVar20 < (int)uVar3))) {
    uVar20 = *puVar18 + uVar20 + puVar18[1];
    puVar18 = puVar18 + 2;
  }
...
LAB_00dd6530:
  local_90 = puVar14;
  if (uVar25 == 0) goto joined_r0x00dd65c8;
  if ((int)uVar3 <= (int)(uVar15 + uVar25)) {
LAB_00dd65bc:
    *puVar14 = uVar25;
    local_90 = puVar14 + 1;
    goto joined_r0x00dd65c8;
  }
  if ((int)uVar27 < 1) {
    if (pbVar29 < pbVar28) {
      uVar31 = (uint)*(byte *)(lVar17 + (ulong)*pbVar29) << (ulong)(uVar27 & 0x1f) | uVar31;
...
joined_r0x00dd6860:
  if (iVar24 != 0) {
    ...
    uVar15 = uVar27;
    local_68 = param_2;
    if ((int)uVar27 < 0xd) goto joined_r0x00dd6b60;
    goto LAB_00dd6aa8;
  }
  ...
  *(int *)(lVar30 + 0x90) = *(int *)(lVar30 + 0x90) + 1;
  if (param_3 < 1) goto LAB_00dd6a70;
  goto LAB_00dd5ee8;
LAB_00dd6a70:
  iVar24 = 0;
