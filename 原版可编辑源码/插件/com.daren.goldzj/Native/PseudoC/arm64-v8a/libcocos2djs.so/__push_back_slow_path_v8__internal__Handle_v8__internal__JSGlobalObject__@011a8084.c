...
/* void std::__ndk1::vector<v8::internal::Handle<v8::internal::JSGlobalObject>,
   std::__ndk1::allocator<v8::internal::Handle<v8::internal::JSGlobalObject> >
   >::__push_back_slow_path<v8::internal::Handle<v8::internal::JSGlobalObject>
   >(v8::internal::Handle<v8::internal::JSGlobalObject>&&) */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_011a816c;
