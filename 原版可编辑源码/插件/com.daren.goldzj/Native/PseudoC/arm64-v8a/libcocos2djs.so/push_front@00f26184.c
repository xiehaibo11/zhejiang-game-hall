...
/* std::__ndk1::__split_buffer<v8::internal::TranslatedState::ObjectPosition*,
   ...
   >::push_front(v8::internal::TranslatedState::ObjectPosition*&&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_00f26310;
...
LAB_00f262e4:
      ...
      if (((void *)((long)pvVar4 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar4 + uVar9 + uVar13 * 8 + 8))) goto LAB_00f262e4;
      ...
      puVar7 = puVar8;
      if (uVar2 != uVar9) goto LAB_00f262e4;
    }
