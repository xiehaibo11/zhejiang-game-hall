...
/* v8::internal::compiler::GraphAssembler::TruncateInt64ToInt32(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::TruncateInt64ToInt32(GraphAssembler *this,Node *param_1)
