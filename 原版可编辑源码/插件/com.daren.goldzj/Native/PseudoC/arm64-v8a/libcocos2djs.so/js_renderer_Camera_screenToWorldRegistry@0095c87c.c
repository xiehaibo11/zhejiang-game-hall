...
/* js_renderer_Camera_screenToWorldRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Camera_screenToWorldRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Camera *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x55,"js_renderer_Camera_screenToWorld");
    __android_log_print(6,"jswrapper","js_renderer_Camera_screenToWorld : Invalid Native Object");
  }
  else {
    ...
    if (plVar4[1] - *plVar4 == 0x40) {
      ...
      if ((uVar5 & 1) == 0) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp"
                            ,0x5d,"js_renderer_Camera_screenToWorld");
        ...
        if ((uVar5 & 1) == 0) {
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp"
                              ,0x60,"js_renderer_Camera_screenToWorld");
          ...
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp"
                              ,99,"js_renderer_Camera_screenToWorld");
      ...
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp, 108): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar4[1] - *plVar4) >> 4,4);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Camera_screenToWorld",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_renderer_manual.cpp"
                      ,0x6f);
LAB_0095cbc4:
  pVVar6 = (Value *)se::State::rval(aSStack_70);
