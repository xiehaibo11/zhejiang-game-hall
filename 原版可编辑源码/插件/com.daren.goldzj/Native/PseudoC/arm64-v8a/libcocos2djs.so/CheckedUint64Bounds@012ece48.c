...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CheckedUint64Bounds(v8::internal::compiler::FeedbackSource
   const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::CheckedUint64Bounds
...

{
  ...
  if ((*(long *)param_1 == 0) || (*(int *)(param_1 + 8) == -1)) {
    pOVar3 = (Operator *)(*(long *)this + 0x1ec0);
  }
  else {
    this_00 = *(Zone **)(this + 8);
    ...
    Operator::Operator(pOVar3,0x62,0x38,"CheckedUint64Bounds",2,1,1,1,1,0);
