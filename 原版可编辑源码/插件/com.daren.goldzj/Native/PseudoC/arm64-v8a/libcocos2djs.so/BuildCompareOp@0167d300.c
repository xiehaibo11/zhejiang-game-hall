...
/* v8::internal::compiler::BytecodeGraphBuilder::BuildCompareOp(v8::internal::compiler::Operator
   const*) */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::BuildCompareOp
...

{
  ...
  if ((ulong)(*(long *)(lVar6 + 0x30) - *(long *)(lVar6 + 0x28) >> 3) <=
      (ulong)(long)*(int *)(lVar6 + 0x5c)) goto LAB_0167d480;
  ...
  if (local_70[0] == 2) {
    ...
    pNVar4 = local_68;
    if (local_70[0] != 1) goto LAB_0167d3e8;
  }
