...
/* v8::internal::StackTraceFrame::IsAsync(v8::internal::Handle<v8::internal::StackTraceFrame>) */

byte v8::internal::StackTraceFrame::IsAsync(ulong *param_1)
