...
undefined8
FUN_010b0e0c(undefined8 param_1,Isolate *param_2,ulong *param_3,ulong *param_4,uint param_5,
  ...
  if ((param_7 >> 2 & 1) == 0) {
    ...
    if (((*(uint *)((uVar10 & 0xffffffff00000000 | (ulong)*(uint *)(uVar10 + 0xb)) + 0x1b) >> 2 & 1)
      ...
      while( true ) {
        ...
        uVar10 = (long)*(char *)(*(long *)(uVar10 + 0x27) + (ulong)*(uint *)(uVar10 + 0x2f) + uVar11
                                ) << 1;
