...

{
  ...
  long local_58;
                    ...
                    /* try { // try from 00aa9240 to 00ba9303 has its CatchHandler @ 00aa95d0 */
  lVar4 = tpidr_el0;
  ...
  if (iVar5 == 0) {
    if (local_78 < pcVar11) {
      ...
      do {
        if (*pcVar9 == '\0') break;
        pcVar2 = local_78 + 1;
                    /* try { // try from 00aa9308 to 00ba933b has its CatchHandler @ 00aa95c0 */
        *local_78 = *pcVar9;
        pcVar9 = pcVar9 + 1;
        local_78 = pcVar2;
    ...
    if (local_78 != pcVar11) {
      *local_78 = ' ';
      pcVar9 = local_78 + 1;
                    /* try { // try from 00aa9344 to 00ba9373 has its CatchHandler @ 00aa95bc */
      if (local_78 + 0xd < pcVar11) {
        builtin_strncpy(local_78 + 1,"text/html\r\n",0xb);
        local_78 = local_78 + 0xc;
                    /* try { // try from 00aa937c to 00ba93f3 has its CatchHandler @ 00aa95c4 */
        sVar8 = strlen(__s);
        ...
        if (local_78 != pcVar11) {
          pcVar9 = local_78 + 1;
                    /* try { // try from 00aa93f4 to 00ba93ff has its CatchHandler @ 00aa95b8 */
          *local_78 = ' ';
          sVar8 = (size_t)iVar5;
          if (pcVar9 + sVar8 + 3 < pcVar11) {
            local_78 = pcVar9;
                    /* try { // try from 00aa941c to 00ba9423 has its CatchHandler @ 00aa95b4 */
            memcpy(pcVar9,acStack_6c,sVar8);
                    /* try { // try from 00aa942c to 00ba9493 has its CatchHandler @ 00aa95c8 */
            ...
            *pcVar2 = '\r';
            ...
            if (2 < (long)pcVar11 - (long)pcVar9) {
              *pcVar9 = '\r';
              ...
              pcVar9 = local_78;
              if (iVar5 == iVar10) {
                    /* try { // try from 00aa94d4 to 00ba9503 has its CatchHandler @ 00aa95d0 */
