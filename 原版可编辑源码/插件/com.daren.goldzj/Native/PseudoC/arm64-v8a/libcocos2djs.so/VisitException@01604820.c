...
/* v8::internal::DispatchingDecoderVisitor::VisitException(v8::internal::Instruction*) */

void __thiscall
v8::internal::DispatchingDecoderVisitor::VisitException
...

{
  ...
  for (pDVar1 = *(DispatchingDecoderVisitor **)(this + 0x10); this + 8 != pDVar1;
    ...
    (**(code **)(**(long **)(pDVar1 + 0x10) + 0x70))(*(long **)(pDVar1 + 0x10),param_1);
  }
  return;
}
