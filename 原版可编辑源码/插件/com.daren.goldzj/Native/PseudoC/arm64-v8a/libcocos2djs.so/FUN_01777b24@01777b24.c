...
void FUN_01777b24(long param_1,undefined8 *param_2,int param_3)

{
  ...
  if (4 < *(byte *)(lVar1 + uVar5) - 6) {
    ...
    std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>
              (pbVar3," which doesn\'t have a compressed or tagged representation.",0x3a);
