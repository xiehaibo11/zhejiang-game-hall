  ...
  if (lVar3 != 0) {
    ...
    *(undefined8 *)(this + 0x18) = 0;
    while (plVar5 != (long *)0x0) {
      if (param_2 == param_3) goto LAB_0087d46c;
      if (param_2 != plVar5) {
        uVar1 = param_2[3];
        ...
        basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>::assign
                  ((basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>> *
                   )(plVar5 + 2),pcVar2,uVar1);
      }
      cocos2d::Value::operator=((Value *)(plVar5 + 5),(Value *)(param_2 + 5));
      lVar3 = *plVar5;
      FUN_0087d514(this,plVar5);
...
LAB_0087d46c:
  do {
    pvVar6 = (void *)*plVar5;
    cocos2d::Value::~Value((Value *)(plVar5 + 5));
    if ((*(byte *)(plVar5 + 2) & 1) != 0) {
      operator_delete((void *)plVar5[4]);
    }
