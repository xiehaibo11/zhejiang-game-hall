...
void FUN_01449c00(ulong param_1)

{
  ...
  uVar4 = *(ushort *)(unaff_x20 + unaff_x19 + 3);
  uVar7 = *(ulong *)(unaff_x29 + (long)*(short *)(unaff_x20 + unaff_x19 + 1) * 8);
  lVar8 = unaff_x26 +
...
LAB_01449f14:
      if (*(short *)(unaff_x26 + (ulong)*(uint *)(param_1 - 1) + 7) != 0x43) goto LAB_01449f28;
      uVar9 = 0x1e;
      goto LAB_01449f34;
    }
    ...
    if ((int)lVar2 != iVar12) {
      ...
      if (sVar5 == 0x41) {
        ...
        if ((param_1 & 1) == 0) {
          ...
          if (*(int *)(param_1 - 1) != (int)*(undefined8 *)(unaff_x26 + 0x140)) goto LAB_01449f14;
          uVar9 = 0x1e;
        }
        goto LAB_01449f34;
      }
...
LAB_01449f34:
    ...
    if ((param_1 & 1) == 0) {
      ...
      if (*(int *)(param_1 - 1) != iVar12) goto LAB_01449f14;
      dVar14 = *(double *)(uVar7 + 3);
      dVar13 = *(double *)(param_1 + 3);
    }
  }
  ...
  *(undefined8 *)(unaff_x26 + 0x40) = 0x1449d3c;
  ...
  if ((int)lVar8 != (int)*(undefined8 *)(unaff_x26 + 0xa0)) {
    ...
    if (uVar10 != uVar9) {
      ...
      *(undefined4 *)(lVar8 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x01449de8. Too many branches */
