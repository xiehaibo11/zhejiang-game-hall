...
/* void JSBClassType::registerClass<spine::PathConstraintData>(se::Class*) */

void JSBClassType::registerClass<spine::PathConstraintData>(Class *param_1)
