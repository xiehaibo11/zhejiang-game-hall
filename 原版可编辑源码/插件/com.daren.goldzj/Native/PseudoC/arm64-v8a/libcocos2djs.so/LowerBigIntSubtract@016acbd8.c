...
/* v8::internal::compiler::EffectControlLinearizer::LowerBigIntSubtract(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerBigIntSubtract
...

{
  ...
  Builtins::CallableFor((Builtins *)local_b0,*(undefined8 *)(*(long *)this + 0x168),0x2d7);
