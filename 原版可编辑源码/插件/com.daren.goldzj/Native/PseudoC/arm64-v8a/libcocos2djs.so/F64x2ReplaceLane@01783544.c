...
/* v8::internal::compiler::MachineOperatorBuilder::F64x2ReplaceLane(int) */

Operator * __thiscall
v8::internal::compiler::MachineOperatorBuilder::F64x2ReplaceLane
...

{
  ...
  Operator::Operator(pOVar1,0x1fd,0x7c,"Replace lane",2,0,0,1,0,0);
