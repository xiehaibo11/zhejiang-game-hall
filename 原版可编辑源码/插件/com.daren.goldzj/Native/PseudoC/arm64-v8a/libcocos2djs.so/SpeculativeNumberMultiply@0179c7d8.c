...
/* v8::internal::compiler::OperationTyper::SpeculativeNumberMultiply(v8::internal::compiler::Type,
   v8::internal::compiler::Type) */

void __thiscall
v8::internal::compiler::OperationTyper::SpeculativeNumberMultiply
...

{
  ...
  NumberMultiply(this,uVar1,uVar2);
  return;
}
