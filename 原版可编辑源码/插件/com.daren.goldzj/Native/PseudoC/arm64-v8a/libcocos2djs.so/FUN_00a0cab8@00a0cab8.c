...
void * FUN_00a0cab8(long param_1,ulong param_2,long param_3,uint *param_4)

{
  ...
  *__ptr = 0;
  ...
  if (uVar9 != 0) {
    ...
    do {
      ...
      uVar16 = *__s;
                    /* try { // try from 00a0cc54 to 00b0ccd7 has its CatchHandler @ 00a0cc54
                       catch() { ... } // from try @ 00a0cc54 with catch @ 00a0cc54
                       catch() { ... } // from try @ 00a0cd4c with catch @ 00a0cc54 */
  ...
  *param_4 = uVar7;
  free(__s);
  free(__ptr);
                    /* try { // try from 00a0ccd8 to 00b0cd4b has its CatchHandler @ 00a0cd64 */
  return pvVar8;
}
