...
ulong FUN_010a2a78(undefined8 param_1,Isolate *param_2,ulong *param_3,ulong *param_4,ulong param_5,
                  ulong param_6)

{
  ...
  if (((*param_4 & 1) == 0) || ((int)*param_4 != *(int *)(param_2 + 0xa0))) {
        ...
        do {
          if (uVar5 != (uint)*(undefined8 *)(param_2 + 0xa8)) {
            ...
            if ((int)dVar26 == (int)param_5) {
              ...
              local_d0 = *param_4;
              uVar14 = v8::internal::Object::SameValueZero((Object *)&local_d0,*puVar12);
              if ((uVar14 & 1) != 0) goto LAB_010a31d0;
              uVar14 = *param_3;
              uVar16 = uVar14 & 0xffffffff00000000;
              uVar5 = *(uint *)((uVar16 | *(uint *)(uVar14 - 1)) + 0xf);
              if (uVar5 == *(uint *)(param_2 + 0xb0)) goto LAB_010a2f3c;
              uVar20 = uVar16 | uVar5;
              goto LAB_010a2f0c;
            }
          }
...
LAB_010a2f0c:
    ...
    if ((*(ushort *)(uVar19 + 7) < 0x412) ||
       ((*(int *)(uVar20 + 7) != *(int *)(param_2 + 0x168) &&
        (*(int *)(uVar20 + 7) != *(int *)(param_2 + 1000))))) {
      if ((*param_4 & 1) == 0) {
        bVar7 = false;
      }
      else {
        bVar7 = (int)*param_4 == *(int *)(param_2 + 0xa0);
      }
...
LAB_010a2f3c:
  ...
  if (uVar5 != (uint)*puVar9) {
    ...
    if ((*(byte *)((uVar16 | 10) + (ulong)*(uint *)(uVar14 - 1)) & 0xf8) != 0x60) {
      ...
      uVar23 = (**(code **)(*plVar13 + 200))(plVar13,param_2,param_3,param_4,param_5 + 1);
      goto LAB_010a31d0;
    }
    if (*(CanonicalHandleScope **)(param_2 + 0x95b8) == (CanonicalHandleScope *)0x0) {
      puVar9 = *(ulong **)pIVar2;
      ...
      *puVar9 = uVar16 | uVar5;
      ...
      puVar9 = (ulong *)v8::internal::CanonicalHandleScope::Lookup
                                  (*(CanonicalHandleScope **)(param_2 + 0x95b8),uVar16 | uVar5);
    }
  }
LAB_010a2d84:
  param_5 = param_5 + 1;
...
LAB_010a30b0:
  uVar16 = param_5 + 1;
  if (((uVar14 & 1) == 0) ||
     (puVar9 = param_3, *(ushort *)(((ulong)param_2 | 7) + (ulong)*(uint *)(uVar14 - 1)) < 0xa9)) {
    puVar9 = (ulong *)v8::internal::LookupIterator::GetRootForNonJSReceiver(param_2,param_3,uVar16);
  }
  ...
  if (((0xfffffffe < uVar16) &&
     ...
     (puVar10 = (ulong *)v8::internal::Factory::SizeToString((Factory *)param_2,uVar16,true),
  ...
  if (local_d0._4_4_ == 4) {
    ...
    puVar12 = (undefined8 *)v8::internal::Object::GetProperty((LookupIterator *)&local_d0,false);
    if (puVar12 == (undefined8 *)0x0) goto LAB_010a31f8;
    local_68 = *param_4;
    uVar14 = v8::internal::Object::SameValueZero((Object *)&local_68,*puVar12);
    if ((uVar14 & 1) != 0) goto LAB_010a31d0;
  }
