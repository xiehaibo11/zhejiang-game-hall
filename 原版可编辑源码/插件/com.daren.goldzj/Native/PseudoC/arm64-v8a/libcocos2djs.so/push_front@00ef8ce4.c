...
/* std::__ndk1::__split_buffer<v8::internal::OptimizedCompilationJob**,
   std::__ndk1::allocator<v8::internal::OptimizedCompilationJob**>&>::push_front(v8::internal::OptimizedCompilationJob**
   const&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_00ef8e70;
...
LAB_00ef8e44:
      ...
      if (((void *)((long)pvVar4 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar4 + uVar9 + uVar13 * 8 + 8))) goto LAB_00ef8e44;
      ...
      puVar7 = puVar8;
      if (uVar2 != uVar9) goto LAB_00ef8e44;
    }
