...
/* v8::internal::HashTable<v8::internal::NumberDictionary,
   v8::internal::NumberDictionaryShape>::EnsureCapacity(v8::internal::Isolate*,
   v8::internal::Handle<v8::internal::NumberDictionary>, int, v8::internal::AllocationType) */

ulong * v8::internal::HashTable<v8::internal::NumberDictionary,v8::internal::NumberDictionaryShape>
...

{
  ...
  if (((iVar2 - param_3 == 0 || iVar2 < param_3) ||
    ...
    puVar3 = (ulong *)Factory::NewFixedArrayWithMap<v8::internal::FixedArray>
                                (param_1,0x33,iVar2 * 3 + 4,bVar1);
    *(undefined4 *)(*puVar3 + 7) = 0;
    *(undefined4 *)(*puVar3 + 0xb) = 0;
    *(int *)(*puVar3 + 0xf) = iVar2 * 2;
    local_28 = *param_2;
    Rehash((HashTable<v8::internal::NumberDictionary,v8::internal::NumberDictionaryShape> *)
           &local_28,param_1 + 0x80,*puVar3);
  }
  return puVar3;
}
