...
/* void JSBClassType::registerClass<dragonBones::CCArmatureCacheDisplay>(se::Class*) */

void JSBClassType::registerClass<dragonBones::CCArmatureCacheDisplay>(Class *param_1)
