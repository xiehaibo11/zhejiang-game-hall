  ...
  if (*(long *)(this + 0x78) != 0) {
    ...
    if ((*(uint *)(this + 0x9c) >> 4 & 1) == 0) {
      if ((*(uint *)(this + 0x9c) >> 3 & 1) != 0) {
        ...
        if (this[0xa2] == (basic_filebuf<char,std::__ndk1::char_traits<char>>)0x0) {
          ...
          if (iVar3 < 1) {
            if (*(long *)(this + 0x18) == *(long *)(this + 0x20)) {
              bVar2 = false;
                    ...
                    /* try { // try from 00a5af64 to 00b5af93 has its CatchHandler @ 00a5b008 */
          ...
          lVar6 = *(long *)(this + 0x20) - *(long *)(this + 0x18);
                    ...
                    /* try { // try from 00a5af98 to 00b5af9f has its CatchHandler @ 00a5b004 */
        iVar3 = fseeko(*(FILE **)(this + 0x78),-lVar6,1);
        if (iVar3 != 0) goto LAB_00a5afa0;
        if (bVar2) {
      ...
      if (*(long *)(this + 0x30) != *(long *)(this + 0x28)) {
        ...
        if (iVar3 == -1) goto LAB_00a5afcc;
      }
      do {
                    /* try { // try from 00a5aeb4 to 00b5af63 has its CatchHandler @ 00a5aeb4
                       catch() { ... } // from try @ 00a5aeb4 with catch @ 00a5aeb4
                       catch() { ... } // from try @ 00a5afa0 with catch @ 00a5aeb4 */
        ...
        if (sVar4 != __n) goto LAB_00a5afa0;
      } while (iVar3 == 1);
      if ((iVar3 == 2) || (iVar3 = fflush(*(FILE **)(this + 0x78)), iVar3 != 0)) {
LAB_00a5afa0:
                    /* try { // try from 00a5afa0 to 00b5b023 has its CatchHandler @ 00a5aeb4 */
        uVar5 = 0xffffffff;
        goto LAB_00a5afcc;
      }
    }
