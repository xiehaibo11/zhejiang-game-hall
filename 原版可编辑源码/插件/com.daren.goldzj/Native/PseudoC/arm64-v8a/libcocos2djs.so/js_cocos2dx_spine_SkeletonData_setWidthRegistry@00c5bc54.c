...
/* js_cocos2dx_spine_SkeletonData_setWidthRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_SkeletonData_setWidthRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x275a,"js_cocos2dx_spine_SkeletonData_setWidth");
    pcVar6 = "js_cocos2dx_spine_SkeletonData_setWidth : Invalid Native Object";
LAB_00c5bdc8:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::SkeletonData::setWidth(this,local_64);
        goto LAB_00c5be00;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x2761,"js_cocos2dx_spine_SkeletonData_setWidth");
      pcVar6 = "js_cocos2dx_spine_SkeletonData_setWidth : Error processing arguments";
      goto LAB_00c5bdc8;
    }
    __android_log_print(6,"jswrapper",&DAT_019133d9,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonData_setWidth",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x2768);
LAB_00c5be00:
