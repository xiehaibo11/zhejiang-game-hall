...
/* v8::internal::compiler::JSHeapBroker::GetFeedback(v8::internal::compiler::FeedbackSource const&)
   const */

undefined8 __thiscall
v8::internal::compiler::JSHeapBroker::GetFeedback(JSHeapBroker *this,FeedbackSource *param_1)
