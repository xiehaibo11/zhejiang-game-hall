...
/* v8::internal::compiler::ObjectRef::AsObjectBoilerplateDescription() const */

undefined1  [16] __thiscall
v8::internal::compiler::ObjectRef::AsObjectBoilerplateDescription(ObjectRef *this)

{
  ...
  if (*(int *)(puVar1 + 1) == 2) {
    if ((*(byte *)*puVar1 & 1) == 0) goto LAB_0171a7c4;
  }
