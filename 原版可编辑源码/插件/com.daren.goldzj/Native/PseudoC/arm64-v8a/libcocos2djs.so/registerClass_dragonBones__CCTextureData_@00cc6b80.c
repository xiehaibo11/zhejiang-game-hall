...
/* void JSBClassType::registerClass<dragonBones::CCTextureData>(se::Class*) */

void JSBClassType::registerClass<dragonBones::CCTextureData>(Class *param_1)
