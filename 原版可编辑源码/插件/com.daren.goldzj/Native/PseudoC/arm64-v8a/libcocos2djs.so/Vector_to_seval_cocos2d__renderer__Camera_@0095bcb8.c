...
/* bool Vector_to_seval<cocos2d::renderer::Camera>(cocos2d::Vector<cocos2d::renderer::Camera*>
   const&, se::Value*) */

bool Vector_to_seval<cocos2d::renderer::Camera>(Vector *param_1,Value *param_2)

{
  ...
  if (puVar5 != puVar1) {
    uVar4 = 0;
    do {
      native_ptr_to_seval<cocos2d::renderer::Camera>((type *)*puVar5,aVStack_58,(bool *)0x0);
