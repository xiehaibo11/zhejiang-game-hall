...
/* void std::__ndk1::vector<v8::internal::wasm::WasmImport,
   std::__ndk1::allocator<v8::internal::wasm::WasmImport>
   >::__push_back_slow_path<v8::internal::wasm::WasmImport>(v8::internal::wasm::WasmImport&&) */
...

{
  ...
  if (uVar1 < 0xaaaaaaaaaaaaaab) {
    ...
    if (uVar1 == 0) {
      ...
      if (0xaaaaaaaaaaaaaaa < uVar1) goto LAB_015f3234;
