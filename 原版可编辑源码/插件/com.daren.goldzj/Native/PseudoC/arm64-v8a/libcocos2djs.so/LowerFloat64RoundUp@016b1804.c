...
/* v8::internal::compiler::EffectControlLinearizer::LowerFloat64RoundUp(v8::internal::compiler::Node*)
    */

undefined8 __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerFloat64RoundUp
...

{
  ...
  cVar2 = MachineOperatorBuilder::Float64RoundUp(*(MachineOperatorBuilder **)(*(long *)this + 0x10))
  ;
  if (cVar2 == '\0') {
    pNVar9 = param_1 + 0x20;
    ...
    pNVar6 = (Node *)GraphAssembler::Float64LessThan(this_00,pNVar3,pNVar9);
    GraphAssembler::GotoIfNot<>(this_00,pNVar6,local_a0);
    pNVar6 = (Node *)GraphAssembler::Float64LessThanOrEqual(this_00,pNVar4,pNVar9);
    GraphAssembler::GotoIf<>(this_00,pNVar6,local_d8);
    pNVar6 = (Node *)GraphAssembler::Float64Add(this_00,pNVar4,pNVar9);
    pNVar6 = (Node *)GraphAssembler::Float64Sub(this_00,pNVar6,pNVar4);
    pNVar7 = (Node *)GraphAssembler::Float64LessThan(this_00,pNVar6,pNVar9);
    GraphAssembler::GotoIfNot<v8::internal::compiler::Node*>(this_00,pNVar7,local_1c8,pNVar6);
    pNVar6 = (Node *)GraphAssembler::Float64Add(this_00,pNVar6,pNVar5);
    ...
    *(undefined8 *)(this + 0x60) = 0;
    ...
    GraphAssembler::MergeState<v8::internal::compiler::Node*>(this_00,local_1c8,pNVar9);
    GraphAssembler::GotoBasicBlock(this_00,local_1c0);
    *(undefined8 *)(this + 0x58) = 0;
    *(undefined8 *)(this + 0x60) = 0;
    GraphAssembler::Bind<0ul>(this_00,local_a0);
    pNVar3 = (Node *)GraphAssembler::Float64Equal(this_00,pNVar9,pNVar3);
    GraphAssembler::GotoIf<>(this_00,pNVar3,local_148);
    pNVar3 = (Node *)GraphAssembler::Float64Constant(this_00,-4503599627370496.0);
    pNVar3 = (Node *)GraphAssembler::Float64LessThanOrEqual(this_00,pNVar9,pNVar3);
    GraphAssembler::GotoIf<>(this_00,pNVar3,local_110);
    pNVar3 = (Node *)GraphAssembler::Float64Constant(this_00,-0.0);
    pNVar6 = (Node *)GraphAssembler::Float64Sub(this_00,pNVar3,pNVar9);
