...
/* v8::internal::PropertyCallbackArguments::CallIndexedDeleter(v8::internal::Handle<v8::internal::InterceptorInfo>,
   unsigned int) */

PropertyCallbackArguments * __thiscall
v8::internal::PropertyCallbackArguments::CallIndexedDeleter
...

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    ...
    RuntimeCallStats::Enter(local_90,(ulong)&local_90 | 8,0x8e);
  }
  ...
  if (*(int *)(lVar8 + 0xb80c) == 0x20) {
    ...
    if ((uVar5 & 1) == 0) goto LAB_010d745c;
  }
  ...
  *(long **)(lVar8 + 0x2c58) = &local_a8;
  ...
  if ((uVar5 & 1) != 0) {
    Logger::ApiIndexedPropertyAccess
              (this_00,"interceptor-indexed-deleter",*(undefined8 *)(this + 0x20),param_3);
  }
