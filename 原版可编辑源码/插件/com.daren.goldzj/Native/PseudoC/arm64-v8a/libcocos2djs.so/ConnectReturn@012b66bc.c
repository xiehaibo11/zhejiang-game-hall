...
/* v8::internal::compiler::CFGBuilder::ConnectReturn(v8::internal::compiler::Node*) */

void __thiscall v8::internal::compiler::CFGBuilder::ConnectReturn(CFGBuilder *this,Node *param_1)

{
  ...
  Schedule::AddReturn(*(Schedule **)(this + 0x10),pBVar2,param_1);
  return;
}
