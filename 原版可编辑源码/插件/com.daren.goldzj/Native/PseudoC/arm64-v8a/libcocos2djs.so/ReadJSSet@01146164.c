...
/* v8::internal::ValueDeserializer::ReadJSSet() */

void __thiscall v8::internal::ValueDeserializer::ReadJSSet(ValueDeserializer *this)

{
  ...
  if (*(ulong *)(lVar18 + 0x58) <= uVar6) {
    ...
    *(int *)(this + 0x24) = iVar3 + 1;
    puVar11 = (ulong *)Factory::NewJSSet(*(Factory **)this);
    ...
    while( true ) {
      ...
      do {
        if (pbVar15 <= pbVar13) goto LAB_011463f8;
        bVar4 = *pbVar13;
        pbVar13 = pbVar13 + 1;
      } while (bVar4 == 0);
      pbVar13 = *(byte **)(this + 0x10);
      if (bVar4 == 0x2c) goto LAB_01146328;
      local_80 = 0;
      lVar10 = ReadObject(this);
      if (lVar10 == 0) goto LAB_011463f8;
      local_80 = lVar10;
      PerIsolateAssertScope<(v8::internal::PerIsolateAssertType)0,true>::PerIsolateAssertScope
                (aPStack_78,*(Isolate **)this);
      lVar10 = Execution::Call(*(undefined8 *)this,puVar7,puVar11,1,&local_80);
      if (lVar10 == 0) break;
      uVar19 = uVar19 + 1;
      PerIsolateAssertScope<(v8::internal::PerIsolateAssertType)0,true>::~PerIsolateAssertScope
                (aPStack_78);
...
LAB_01146328:
  ...
  uVar17 = 0;
  do {
    if (pbVar15 <= pbVar14) goto LAB_011463f8;
    bVar4 = *pbVar14;
    if (uVar17 < 0x20) {
