...
undefined8 FUN_014b4e24(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar5 & 1) == 0) ||
    ...
    uStack_48 = __strlen_chk("Set.prototype.clear",0x14);
    local_50 = "Set.prototype.clear";
    ...
    v8::internal::JSSet::Clear(param_3,param_2);
