...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<v8::internal::CompilerDispatcher::Job*,
   void*>*>, bool> std::__ndk1::__hash_table<v8::internal::CompilerDispatcher::Job*,
   std::__ndk1::hash<v8::internal::CompilerDispatcher::Job*>,
   std::__ndk1::equal_to<v8::internal::CompilerDispatcher::Job*>,
   std::__ndk1::allocator<v8::internal::CompilerDispatcher::Job*>
   >::__emplace_unique_key_args<v8::internal::CompilerDispatcher::Job*,
   v8::internal::CompilerDispatcher::Job* const&>(v8::internal::CompilerDispatcher::Job* const&,
   v8::internal::CompilerDispatcher::Job* const&) */
...

{
  ...
  *p_Var4;
  ...
  pJVar2 = *param_1;
  uVar7 = ((ulong)(uint)((int)pJVar2 << 3) + 8 ^ (ulong)pJVar2 >> 0x20) * -0x622015f714c7d297;
  uVar10 = *(ulong *)(this + 8);
  uVar7 = (uVar7 ^ (ulong)pJVar2 >> 0x20 ^ uVar7 >> 0x2f) * -0x622015f714c7d297;
      ...
      for (plVar9 = (long *)*plVar9; plVar9 != (long *)0x0; plVar9 = (long *)*plVar9) {
        ...
        if (uVar8 != uVar7) {
          if (uVar5 < 2) {
            ...
            if (uVar8 - uVar1 * uVar10 == unaff_x24) goto LAB_00ef7750;
            break;
          }
          if (uVar8 != unaff_x24) break;
        }
LAB_00ef7750:
        if ((Job *)plVar9[2] == pJVar2) {
          return plVar9;
        }
      }
    }
