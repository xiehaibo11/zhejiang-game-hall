...
/* void JSBClassType::registerClass<spine::PathConstraintMixTimeline>(se::Class*) */

void JSBClassType::registerClass<spine::PathConstraintMixTimeline>(Class *param_1)
