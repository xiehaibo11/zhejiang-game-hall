...
/* spine::Vertices::~Vertices() */

void __thiscall spine::Vertices::~Vertices(Vertices *this)

{
  long *plVar1;
  long lVar2;
  
  *(undefined ***)this = &PTR__Vertices_01c8f598;
  ...
  *(undefined ***)(this + 8) = &PTR__Vector_01c8f5d0;
