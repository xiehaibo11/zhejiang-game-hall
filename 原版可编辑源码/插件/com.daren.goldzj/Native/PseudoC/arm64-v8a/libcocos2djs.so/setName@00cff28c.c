...
/* spine::SkeletonData::setName(spine::String const&) */

void __thiscall spine::SkeletonData::setName(SkeletonData *this,String *param_1)

{
  ...
  if (this + 8 != (SkeletonData *)param_1) {
