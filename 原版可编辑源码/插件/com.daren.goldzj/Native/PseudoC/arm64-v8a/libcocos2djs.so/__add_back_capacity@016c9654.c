...
/* std::__ndk1::deque<v8::internal::compiler::GraphReducer::NodeState,
   v8::internal::RecyclingZoneAllocator<v8::internal::compiler::GraphReducer::NodeState>
   >::__add_back_capacity() */
  ...
  *local_30;
  ...
  if (*(ulong *)(this + 0x30) < 0x100) {
    ...
    if ((ulong)(lVar4 >> 3) <= uVar6) {
      ...
      __split_buffer<v8::internal::compiler::GraphReducer::NodeState*,v8::internal::RecyclingZoneAllocator<v8::internal::compiler::GraphReducer::NodeState*>&>
      ::push_back((__split_buffer<v8::internal::compiler::GraphReducer::NodeState*,v8::internal::RecyclingZoneAllocator<v8::internal::compiler::GraphReducer::NodeState*>&>
                   *)&local_50,&local_58);
      ...
      if (ppNVar7 != *(NodeState ***)(this + 8)) {
        do {
          ppNVar7 = ppNVar7 + -1;
          __split_buffer<v8::internal::compiler::GraphReducer::NodeState*,v8::internal::RecyclingZoneAllocator<v8::internal::compiler::GraphReducer::NodeState*>&>
          ::push_front((__split_buffer<v8::internal::compiler::GraphReducer::NodeState*,v8::internal::RecyclingZoneAllocator<v8::internal::compiler::GraphReducer::NodeState*>&>
                        *)&local_50,ppNVar7);
