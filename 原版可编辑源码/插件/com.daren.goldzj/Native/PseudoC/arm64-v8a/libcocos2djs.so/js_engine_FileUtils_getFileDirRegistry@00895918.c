...
/* js_engine_FileUtils_getFileDirRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_engine_FileUtils_getFileDirRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (pbVar5 == (basic_string *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x12d,"js_engine_FileUtils_getFileDir");
    __android_log_print(6,"jswrapper","js_engine_FileUtils_getFileDir : Invalid Native Object");
  }
  else {
    ...
    if (plVar6[1] - *plVar6 == 0x10) {
      ...
      if ((uVar7 & 1) == 0) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                            ,0x134,"js_engine_FileUtils_getFileDir");
        __android_log_print(6,"jswrapper",
                            "js_engine_FileUtils_getFileDir : Error processing arguments");
        bVar1 = false;
      }
      else {
        cocos2d::FileUtils::getFileDir(pbVar5);
        ...
        if (bVar1) {
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                              ,0x137,"js_engine_FileUtils_getFileDir");
          __android_log_print(6,"jswrapper",
                              "js_engine_FileUtils_getFileDir : Error processing arguments");
        }
        bVar1 = !bVar1;
      ...
      if (bVar1) goto LAB_00895b74;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 314): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar6[1] - *plVar6) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_FileUtils_getFileDir",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x13d);
LAB_00895b74:
  pVVar8 = (Value *)se::State::rval(aSStack_60);
