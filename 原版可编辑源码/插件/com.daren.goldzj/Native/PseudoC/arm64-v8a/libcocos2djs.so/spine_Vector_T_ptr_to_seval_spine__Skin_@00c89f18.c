...
/* bool spine_Vector_T_ptr_to_seval<spine::Skin>(spine::Vector<spine::Skin*> const&, se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::Skin>(Vector *param_1,Value *param_2)
...
LAB_00c89fe0:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::Skin>
