...
/* std::__ndk1::__deque_base<v8::internal::compiler::DeoptimizationExit*,
   v8::internal::RecyclingZoneAllocator<v8::internal::compiler::DeoptimizationExit*> >::clear() */
  ...
  if (lVar4 - (long)puVar2 != 0) {
    ...
    while (lVar1 != lVar9) {
      while (lVar9 = lVar9 + 8, lVar9 - *plVar6 == 0x1000) {
        plVar6 = plVar6 + 1;
        lVar9 = *plVar6;
        if (lVar1 == lVar9) goto LAB_012abd30;
      }
    }
  }
LAB_012abd30:
...
LAB_012abd98:
  ...
  if (puVar5 != (undefined8 *)0x0) goto LAB_012abd88;
  do {
    puVar5 = puVar7;
    puVar5[1] = 0x200;
    *puVar5 = *(undefined8 *)(this + 0x48);
