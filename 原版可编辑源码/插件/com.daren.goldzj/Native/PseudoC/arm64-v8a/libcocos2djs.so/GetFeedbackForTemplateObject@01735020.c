...
/* v8::internal::compiler::JSHeapBroker::GetFeedbackForTemplateObject(v8::internal::compiler::FeedbackSource
   const&) */

undefined8 __thiscall
v8::internal::compiler::JSHeapBroker::GetFeedbackForTemplateObject
...

{
  ...
  if (FLAG_concurrent_inlining == '\0') {
    uVar2 = ProcessFeedbackForTemplateObject(this,param_1);
    return uVar2;
  }
  lVar1 = std::__ndk1::
