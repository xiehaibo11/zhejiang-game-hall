...
/* void std::__ndk1::vector<spine::SkeletonCache::SegmentData*,
   std::__ndk1::allocator<spine::SkeletonCache::SegmentData*>
   >::__push_back_slow_path<spine::SkeletonCache::SegmentData*
   const&>(spine::SkeletonCache::SegmentData* const&) */
...
LAB_00d18afc:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d18afc;
  }
  else {
