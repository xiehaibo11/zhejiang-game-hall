...
/* std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >*
   v8::base::MakeCheckOpString<void const*, void const*>(void const*, void const*, char const*) */

basic_string *
v8::base::MakeCheckOpString<void_const*,void_const*>(void *param_1,void *param_2,char *param_3)
