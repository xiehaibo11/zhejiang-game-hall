...
LAB_017fe340:
  if (param_2 == (long *)0x0) {
    bVar4 = true;
    if (param_3 != (long *)0x0) goto LAB_017fe384;
LAB_017fe3c0:
    param_3 = (long *)0x0;
    if (bVar4) goto LAB_017fe4b0;
  }
  else {
    ...
    param_2 = plVar2;
    if (param_3 == (long *)0x0) goto LAB_017fe3c0;
LAB_017fe384:
...
LAB_017fe4b0:
  ...
  uVar8 = FUN_01828850(pcVar18,local_1b8,param_5,iVar7);
  *param_6 = uVar8;
  uVar9 = (ulong)((byte)local_198[0] >> 1);
  if (((byte)local_198[0] & 1) != 0) {
    uVar9 = local_190;
  ...
  if (uVar9 != 0) {
    ...
    if (local_178 < puVar11) {
      ...
      do {
        if ((bVar4) && (*puVar17 != uVar12)) goto LAB_017fe604;
...
LAB_017fe604:
  ...
  if (param_2 == (long *)0x0) {
    bVar4 = true;
    if (param_3 != (long *)0x0) goto LAB_017fe658;
LAB_017fe62c:
    if (!bVar4) goto LAB_017fe69c;
  }
  else {
    if ((int *)param_2[3] == (int *)param_2[4]) {
    ...
    param_2 = plVar2;
    if (param_3 == (long *)0x0) goto LAB_017fe62c;
LAB_017fe658:
    if ((int *)param_3[3] == (int *)param_3[4]) {
    ...
    if (bVar4 != (iVar7 == -1)) goto LAB_017fe69c;
  }
  *param_5 = *param_5 | 2;
LAB_017fe69c:
  if ((local_1b0 & 1) != 0) {
