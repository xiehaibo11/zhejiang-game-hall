...
/* void JSBClassType::registerClass<dragonBones::TextureAtlasData>(se::Class*) */

void JSBClassType::registerClass<dragonBones::TextureAtlasData>(Class *param_1)
