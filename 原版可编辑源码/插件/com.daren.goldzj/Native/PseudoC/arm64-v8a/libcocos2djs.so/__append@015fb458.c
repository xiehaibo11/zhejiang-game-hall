...
/* std::__ndk1::vector<v8::internal::Handle<v8::internal::WasmExceptionObject>,
   std::__ndk1::allocator<v8::internal::Handle<v8::internal::WasmExceptionObject> >
...
LAB_015fb5ac:
  ...
  if (uVar1 == 0) {
    ...
    if (uVar1 >> 0x3d != 0) goto LAB_015fb5ac;
