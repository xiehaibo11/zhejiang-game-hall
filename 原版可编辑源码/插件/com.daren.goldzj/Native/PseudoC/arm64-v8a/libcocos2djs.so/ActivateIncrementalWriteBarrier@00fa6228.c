...
void __thiscall
v8::internal::IncrementalMarking::ActivateIncrementalWriteBarrier(IncrementalMarking *this)

{
  ...
  if (pMVar2 != (MemoryChunk *)0x0) {
    do {
      MemoryChunk::SetOldGenerationPageFlags(pMVar2,true);
  ...
  if (pMVar2 != (MemoryChunk *)0x0) {
    do {
      MemoryChunk::SetYoungGenerationPageFlags(pMVar2,true);
      pMVar2 = *(MemoryChunk **)(pMVar2 + 0xe0);
    } while (pMVar2 != (MemoryChunk *)0x0);
    lVar1 = *(long *)this;
  }
