...
/* v8::internal::ScopedList<v8::internal::ObjectLiteralProperty*,
   void*>::CopyTo(v8::internal::ZoneList<v8::internal::ObjectLiteralProperty*>*,
   v8::internal::Zone*) const */

void __thiscall
v8::internal::ScopedList<v8::internal::ObjectLiteralProperty*,void*>::CopyTo
          (ScopedList<v8::internal::ObjectLiteralProperty*,void*> *this,ZoneList *param_1,
          Zone *param_2)
