...

{
  ...
  if (iVar1 == 0) {
    return -1;
                    ...
                    /* try { // try from 00af4a18 to 00bf4a23 has its CatchHandler @ 00af4b3c */
  iVar1 = BIO_lookup(local_28,local_38,1,0,1,&local_40);
  if (iVar1 == 0) {
                    /* try { // try from 00af4a80 to 00bf4a87 has its CatchHandler @ 00af4b8c */
    ...
    if (iVar1 == -1) goto LAB_00af4a2c;
                    /* try { // try from 00af4ac4 to 00bf4acb has its CatchHandler @ 00af4b74 */
    uVar6 = BIO_ADDRINFO_address(local_40);
                    /* try { // try from 00af4adc to 00bf4af3 has its CatchHandler @ 00af4b70 */
    iVar5 = BIO_listen(iVar1,uVar6,mode != 0);
    if (iVar5 != 0) goto LAB_00af4a2c;
