...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitToName() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitToName(BytecodeGraphBuilder *this)

{
  ...
  pOVar2 = (Operator *)
           JSOperatorBuilder::ToName(*(JSOperatorBuilder **)(*(long *)(this + 0x10) + 0x170));
