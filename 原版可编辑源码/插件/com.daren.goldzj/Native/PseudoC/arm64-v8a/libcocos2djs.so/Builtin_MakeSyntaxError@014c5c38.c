...
/* v8::internal::Builtin_MakeSyntaxError(int, unsigned long*, v8::internal::Isolate*) */

undefined8 v8::internal::Builtin_MakeSyntaxError(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar11 = FUN_014c5db8(param_1,param_2,param_3);
    return uVar11;
  }
...
LAB_014c5d24:
    ...
    if (iVar4 == 2) goto LAB_014c5d20;
    pIVar6 = (Isolate *)(param_2 + -2);
    if (iVar4 < 4) goto LAB_014c5d24;
