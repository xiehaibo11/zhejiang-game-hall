...
/* v8::internal::compiler::JSTypeHintLowering::ReduceForInNextOperation(v8::internal::compiler::Node*,
...
void v8::internal::compiler::JSTypeHintLowering::ReduceForInNextOperation
...

{
  ...
  lVar1 = TryBuildSoftDeopt(param_1,in_w7,param_6,in_x6,10);
  if (lVar1 == 0) {
    *param_1_00 = 0;
