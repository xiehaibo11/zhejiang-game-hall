...
ulong FUN_00a14dbc(long param_1,ulong param_2,int param_3,uint param_4,undefined4 *param_5)

{
  ...
  if ((param_2 & 1) != 0) {
    uVar1 = FUN_00a12e68(param_1,param_5);
    if (uVar1 == 1) {
      return 1;
    }
    for (plVar6 = *(long **)(param_1 + 8); plVar6 != (long *)0x0; plVar6 = (long *)*plVar6) {
      FUN_00a12120(param_1,plVar6);
    }
    return (ulong)uVar1;
  }
  if (param_3 == -1) {
  ...
  plVar6 = (long *)FUN_00a34664(param_1 + 0x88,&local_98,4);
  if (plVar6 == (long *)0x0) {
    uVar9 = 0;
    goto LAB_00a14f9c;
  }
...
LAB_00a14ed0:
  ...
  uVar2 = FUN_00a130a0(param_1,auVar11._0_8_,auVar11._8_8_,lVar10);
  ...
  if ((int)uVar2 < 1) {
    uVar3 = FUN_00a12120(param_1,lVar10);
  }
  auVar11 = FUN_00a18e40(uVar3);
LAB_00a14f9c:
  uVar8 = auVar11._8_8_;
  uVar7 = auVar11._0_8_;
  lVar10 = 0;
  do {
    if (lVar10 != 0) {
      ...
      uVar1 = FUN_00a130a0(param_1,uVar7,uVar8,lVar10);
      uVar9 = (ulong)uVar1;
      if (local_78 == '\0') {
        sigaction(0xd,(sigaction *)&local_98,(sigaction *)0x0);
      }
      if ((int)uVar1 < 1) {
        FUN_00a12120(param_1,lVar10);
      }
    }
    uVar4 = FUN_00a1610c(uVar7,uVar8,*(undefined8 *)(param_1 + 0x80),&local_48);
    *(undefined8 *)(param_1 + 0x80) = uVar4;
    if (local_48 == 0) break;
    lVar10 = *(long *)(local_48 + 0x28);
    FUN_00a14370(uVar7,uVar8,param_1,lVar10);
  } while (local_48 != 0);
