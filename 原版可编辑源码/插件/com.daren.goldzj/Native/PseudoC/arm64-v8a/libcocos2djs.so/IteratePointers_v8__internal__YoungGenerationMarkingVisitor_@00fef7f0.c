...
/* void 
   v8::internal::BodyDescriptorBase::IteratePointers<v8::internal::YoungGenerationMarkingVisitor>(v8::internal::HeapObject,
   int, int, v8::internal::YoungGenerationMarkingVisitor*) */

void v8::internal::BodyDescriptorBase::IteratePointers<v8::internal::YoungGenerationMarkingVisitor>
...

{
  ...
  puVar1 = (uint *)(param_1 + -1 + (long)param_2);
  puVar2 = (uint *)(param_1 + -1 + (long)param_3);
  if (puVar2 <= puVar1) {
    return;
  }
  uVar4 = *puVar1;
