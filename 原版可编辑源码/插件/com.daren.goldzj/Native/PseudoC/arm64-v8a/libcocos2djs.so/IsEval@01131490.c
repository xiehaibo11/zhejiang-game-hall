...
/* v8::internal::StackTraceFrame::IsEval(v8::internal::Handle<v8::internal::StackTraceFrame>) */

byte v8::internal::StackTraceFrame::IsEval(ulong *param_1)
