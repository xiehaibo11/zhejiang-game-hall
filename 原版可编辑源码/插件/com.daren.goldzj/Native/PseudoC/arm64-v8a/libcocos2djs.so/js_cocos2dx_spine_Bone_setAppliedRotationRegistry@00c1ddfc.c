...
/* js_cocos2dx_spine_Bone_setAppliedRotationRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_setAppliedRotationRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Bone *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x6f0,"js_cocos2dx_spine_Bone_setAppliedRotation");
    pcVar6 = "js_cocos2dx_spine_Bone_setAppliedRotation : Invalid Native Object";
LAB_00c1df70:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Bone::setAppliedRotation(this,local_64);
        goto LAB_00c1dfa8;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x6f7,"js_cocos2dx_spine_Bone_setAppliedRotation");
      pcVar6 = "js_cocos2dx_spine_Bone_setAppliedRotation : Error processing arguments";
      goto LAB_00c1df70;
    }
    __android_log_print(6,"jswrapper",&DAT_018f6303,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_setAppliedRotation",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x6fe);
LAB_00c1dfa8:
