...
/* v8::debug::WeakMap::Get(v8::Local<v8::Context>, v8::Local<v8::Value>) */

ulong * __thiscall v8::debug::WeakMap::Get(WeakMap *this,long param_2,undefined8 param_3)
  ...
  if ((*(int *)(pIVar7 + 0x2c20) == (int)uVar9) ||
    ...
    *local_48 = uVar9;
    ...
    if (internal::TracingFlags::runtime_stats != 0) {
      ...
      internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x3f6);
    }
    this_00 = *(Logger **)(pIVar7 + 0x9558);
    uVar9 = internal::Logger::is_logging(this_00);
    if ((uVar9 & 1) != 0) {
      internal::Logger::ApiEntryCall(this_00,"v8::WeakMap::Get");
    }
...
LAB_00ed3530:
        ...
        if (*(code **)(lVar4 + 0xb738) == (code *)0x0) goto LAB_00ed3530;
