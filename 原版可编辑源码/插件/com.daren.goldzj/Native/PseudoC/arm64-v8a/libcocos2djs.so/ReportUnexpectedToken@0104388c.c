...
/* v8::internal::JsonParser<unsigned char>::ReportUnexpectedToken(v8::internal::JsonToken) */

void __thiscall
v8::internal::JsonParser<unsigned_char>::ReportUnexpectedToken
          (JsonParser<unsigned_char> *this,char param_2)

{
  ...
  if (((*(ulong *)(this_00 + 0x2bd8) & 1) != 0) &&
    ...
    uVar1 = (*(int *)(this + 0x30) - *(int *)(this + 0x40)) - iVar6;
    ...
    if (param_2 == '\r') {
      ...
      puVar3 = (ulong *)Factory::LookupSingleCharacterStringFromCode
                                  ((Factory *)this_00,(ushort)**(byte **)(this + 0x30));
      uVar9 = 0x10a;
    }
