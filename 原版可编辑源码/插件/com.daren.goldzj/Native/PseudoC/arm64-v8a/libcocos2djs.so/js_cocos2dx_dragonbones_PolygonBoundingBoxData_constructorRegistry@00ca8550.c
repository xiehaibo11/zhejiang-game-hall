...
/* js_cocos2dx_dragonbones_PolygonBoundingBoxData_constructorRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_PolygonBoundingBoxData_constructorRegistry
...

{
  ...
  this = (Object *)
         se::Object::_createJSObject
                   (__jsb_dragonBones_PolygonBoundingBoxData_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_dragonBones_PolygonBoundingBoxData_finalizeRegistry);
  ...
  if (this_00 != (BaseObject *)0x0) {
    ...
    *(undefined ***)this_00 = &PTR__PolygonBoundingBoxData_01c90df8;
    *(undefined8 *)(this_00 + 0x30) = 0;
    *(undefined8 *)(this_00 + 0x28) = 0;
    dragonBones::PolygonBoundingBoxData::_onClear((PolygonBoundingBoxData *)this_00);
  }
