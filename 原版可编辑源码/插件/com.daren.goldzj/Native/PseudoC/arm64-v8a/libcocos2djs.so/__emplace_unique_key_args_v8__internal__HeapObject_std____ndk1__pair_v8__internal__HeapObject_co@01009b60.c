...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<v8::internal::HeapObject,
   ...
   std::__ndk1::pair<v8::internal::HeapObject const, v8::internal::Map> >(v8::internal::HeapObject
   const&, std::__ndk1::pair<v8::internal::HeapObject const, v8::internal::Map>&&) */
      ...
      for (plVar8 = (long *)*plVar8; plVar8 != (long *)0x0; plVar8 = (long *)*plVar8) {
        ...
        if (uVar7 != uVar10) {
          if (uVar5 < 2) {
            ...
            if (uVar7 - uVar2 * uVar9 == unaff_x24) goto LAB_01009bec;
            break;
          }
