...
/* spine::Vector<spine::Attachment*>::~Vector() */

void __thiscall spine::Vector<spine::Attachment*>::~Vector(Vector<spine::Attachment*> *this)

{
  ...
  *(undefined ***)this = &PTR__Vector_01c8d438;
  *(undefined8 *)(this + 8) = 0;
  if (lVar2 != 0) {
