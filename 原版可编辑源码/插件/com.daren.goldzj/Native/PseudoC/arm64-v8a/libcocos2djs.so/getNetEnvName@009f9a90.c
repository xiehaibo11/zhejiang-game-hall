...

{
  ...
  p_Var2 = (_jmethodID *)
           (**(code **)(*(long *)p_Var1 + 0x30))(p_Var1,"com/bianfeng/libuniverse/Device");
                    /* try { // try from 009f9adc to 00af9b23 has its CatchHandler @ 009f9c68 */
  uVar3 = (**(code **)(*(long *)p_Var1 + 0x388))
                    (p_Var1,p_Var2,"getNetEnvName","()Ljava/lang/String;");
  uVar3 = _JNIEnv::CallStaticObjectMethod(p_Var1,p_Var2,uVar3);
  __s = (char *)(**(code **)(*(long *)p_Var1 + 0x548))(p_Var1,uVar3,0);
  in_x8[1] = 0;
  in_x8[2] = 0;
                    /* try { // try from 009f9b24 to 00af9c3f has its CatchHandler @ 009f9768 */
  *in_x8 = 0;
  __n = strlen(__s);
