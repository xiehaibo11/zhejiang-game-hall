...
/* void std::__ndk1::vector<dragonBones::AnimationState*,
   std::__ndk1::allocator<dragonBones::AnimationState*>
   >::__push_back_slow_path<dragonBones::AnimationState* const&>(dragonBones::AnimationState*
   const&) */

void __thiscall
std::__ndk1::
vector<dragonBones::AnimationState*,std::__ndk1::allocator<dragonBones::AnimationState*>>::
__push_back_slow_path<dragonBones::AnimationState*const&>
          (vector<dragonBones::AnimationState*,std::__ndk1::allocator<dragonBones::AnimationState*>>
...
LAB_00d1e098:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d1e098;
  }
  else {
