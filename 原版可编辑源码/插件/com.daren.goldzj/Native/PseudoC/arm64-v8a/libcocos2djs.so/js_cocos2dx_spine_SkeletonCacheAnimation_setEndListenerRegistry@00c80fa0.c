...
/* js_cocos2dx_spine_SkeletonCacheAnimation_setEndListenerRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonCacheAnimation_setEndListenerRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (SkeletonCacheAnimation *)se::State::nativeThisObject(aSStack_148);
  if (this == (SkeletonCacheAnimation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                        ,0x3d53,&DAT_018efd34);
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonCacheAnimation_setEndListener : Invalid Native Object"
                       );
  }
  else {
    ...
    if (puVar4[1] - (long)pVVar5 == 0x10) {
      ...
      if (pVVar5[8] == (Value)0x5) {
        ...
        if ((uVar7 & 1) == 0) goto LAB_00c81244;
...
LAB_00c81244:
      ...
      spine::SkeletonCacheAnimation::setEndListener(this,(function *)alStack_c0);
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 15739): wrong number of arguments: %d, was expecting %d\n"
