...
/* v8::internal::compiler::SimplifiedOperatorBuilder::StoreToObject(v8::internal::compiler::ObjectAccess
   const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::StoreToObject
...

{
  ...
  OVar1 = param_1[2];
  Operator::Operator(pOVar3,0xf5,0x68,"StoreToObject",3,1,1,0,1,0);
