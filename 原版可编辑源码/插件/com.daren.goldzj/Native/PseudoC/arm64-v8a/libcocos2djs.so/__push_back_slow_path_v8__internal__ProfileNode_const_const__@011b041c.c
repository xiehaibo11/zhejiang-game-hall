...
/* void std::__ndk1::vector<v8::internal::ProfileNode const*,
   std::__ndk1::allocator<v8::internal::ProfileNode const*>
   >::__push_back_slow_path<v8::internal::ProfileNode const* const&>(v8::internal::ProfileNode
   const* const&) */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_011b0504;
