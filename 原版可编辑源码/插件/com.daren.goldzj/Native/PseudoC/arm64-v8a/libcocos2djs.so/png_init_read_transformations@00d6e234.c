...
LAB_00d6e57c:
          ...
          if ((uVar4 & 0x1f) != 0) goto LAB_00d6e57c;
        }
  ...
  *(undefined8 *)(param_1 + 0x2ca) = *(undefined8 *)(param_1 + 0x2c0);
  if ((uVar15 >> 0xd & 1) == 0) {
    ...
    if ((uVar14 >> 0x17 & 1) != 0) {
      iVar10 = png_gamma_significant(*(undefined4 *)(param_1 + 0x2ec));
      if (iVar10 != 0) goto LAB_00d6e7bc;
      uVar14 = *(uint *)(param_1 + 0x16c);
    }
    if (((uVar14 >> 7 & 1) == 0) || (*(char *)(param_1 + 0x2af) != '\x03')) goto LAB_00d6ec18;
    uVar4 = *(ushort *)(param_1 + 0x2a8);
    if ((ulong)uVar4 != 0) {
...
LAB_00d6ea4c:
          ...
          uVar12 = 100000;
          if (cVar2 != '\x02') goto LAB_00d6ea4c;
        ...
        if (uVar4 != 0) {
          ...
          do {
            if ((long)uVar19 < (long)(ulong)*(ushort *)(param_1 + 0x2a8)) {
              lVar17 = *(long *)(param_1 + 0x330);
              bVar25 = *(byte *)(lVar17 + uVar19);
              if (bVar25 == 0xff) goto LAB_00d6eb3c;
              if (bVar25 != 0) {
  ...
  if (((*(byte *)(param_1 + 800) != 0) && (uVar14 = 8 - *(byte *)(param_1 + 800), 0 < (int)uVar14))
    ...
    if (uVar4 < 2) {
      ...
      if (lVar17 != 0) {
        ...
        if ((uVar4 & 1) == 0) goto LAB_00d6ecd0;
      }
    }
  ...
  if (((*(byte *)(param_1 + 0x321) != 0) &&
    ...
    if (uVar4 < 2) {
      ...
      if (lVar22 != 0) {
        ...
        if ((uVar4 & 1) == 0) goto LAB_00d6ed5c;
      }
    }
    lVar20 = uVar19 - lVar22;
