...
/* std::__ndk1::__split_buffer<v8::internal::interpreter::BytecodeRegisterOptimizer::RegisterInfo**,
   ...
   >::push_back(v8::internal::interpreter::BytecodeRegisterOptimizer::RegisterInfo**&&) */
...

{
  ...
  if (puVar8 != *(undefined8 **)(this + 0x18)) goto LAB_017c0688;
  ...
  if (puVar3 != puVar11) {
    ...
    if ((3 < uVar4) && ((puVar3 + uVar6 + 1 <= puVar1 || (puVar2 + uVar13 + uVar6 + 1 <= puVar3))))
    {
      ...
      puVar7 = puVar1 + uVar6;
      puVar8 = puVar1 + uVar6;
      if (uVar4 == uVar6) goto LAB_017c063c;
    }
    do {
      puVar5 = puVar3 + 1;
      puVar8 = puVar7 + 1;
