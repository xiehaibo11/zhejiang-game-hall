...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::Map>,
   v8::internal::ZoneVector<v8::internal::Handle<v8::internal::Map> > >, void*>*>, bool>
   std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::Map>,
   v8::internal::ZoneVector<v8::internal::Handle<v8::internal::Map> > >,
   std::__ndk1::__unordered_map_hasher<v8::internal::Handle<v8::internal::Map>,
   std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::Map>,
   v8::internal::ZoneVector<v8::internal::Handle<v8::internal::Map> > >,
   v8::internal::Handle<v8::internal::Map>::hash, true>,
   std::__ndk1::__unordered_map_equal<v8::internal::Handle<v8::internal::Map>,
   std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::Map>,
   v8::internal::ZoneVector<v8::internal::Handle<v8::internal::Map> > >,
   v8::internal::Handle<v8::internal::Map>::equal_to, true>,
   v8::internal::ZoneAllocator<std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::Map>,
   v8::internal::ZoneVector<v8::internal::Handle<v8::internal::Map> > > >
   >::__emplace_unique_key_args<v8::internal::Handle<v8::internal::Map>,
   std::__ndk1::pair<v8::internal::Handle<v8::internal::Map> const,
   v8::internal::ZoneVector<v8::internal::Handle<v8::internal::Map> > >
      ...
      for (plVar8 = (long *)*plVar8; plVar8 != (long *)0x0; plVar8 = (long *)*plVar8) {
        ...
        if (uVar7 != uVar2) {
          if (uVar6 < 2) {
            ...
            if (uVar7 - uVar1 * uVar9 == unaff_x25) goto LAB_0173d270;
            break;
          }
...
LAB_0173d270:
  ...
  if ((ulong)(*(long *)(this_00 + 0x18) - (long)plVar8) < 0x38) {
    plVar8 = (long *)v8::internal::Zone::NewExpand(this_00,0x38);
  }
  else {
    *(long **)(this_00 + 0x10) = plVar8 + 7;
  }
  lVar3 = *(long *)param_2;
  plVar8[4] = 0;
  plVar8[5] = 0;
  plVar8[2] = lVar3;
  plVar8[3] = 0;
  plVar8[6] = *(long *)(param_2 + 0x20);
  plVar8[3] = *(long *)(param_2 + 8);
  plVar8[4] = *(long *)(param_2 + 0x10);
  plVar8[5] = *(long *)(param_2 + 0x18);
