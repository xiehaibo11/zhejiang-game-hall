...
/* unsigned long
   ...
   (v8::internal::GarbageCollector)2>::UpdateUntypedPointers()::{lambda(v8::internal::CompressedMaybeObjectSlot)#1},
   v8::internal::SlotSet::Iterate<v8::internal::RememberedSetUpdatingItem<v8::internal::MinorNonAtomicMarkingState,
   (v8::internal::GarbageCollector)2>::UpdateUntypedPointers()::{lambda(v8::internal::CompressedMaybeObjectSlot)#1}>(unsigned
   long, unsigned long,
...
ulong v8::internal::SlotSet::
      Iterate<v8::internal::RememberedSetUpdatingItem<v8::internal::MinorNonAtomicMarkingState,(v8::internal::GarbageCollector)2>::UpdateUntypedPointers()::_lambda(v8::internal::CompressedMaybeObjectSlot)_1_,v8::internal::SlotSet::Iterate<v8::internal::RememberedSetUpdatingItem<v8::internal::MinorNonAtomicMarkingState,(v8::internal::GarbageCollector)2>::UpdateUntypedPointers()::_lambda(v8::internal::CompressedMaybeObjectSlot)_1_>(unsigned_long,unsigned_long,v8::internal::RememberedSetUpdatingItem<v8::internal::MinorNonAtomicMarkingState,(v8::internal::GarbageCollector)2>::UpdateUntypedPointers()::_lambda(v8::internal::CompressedMaybeObjectSlot)_1_,v8::internal::SlotSet::EmptyBucketMode)::_lambda(unsigned_long)_1_>
...
LAB_00feeb18:
                ...
                uVar17 = *puVar2;
                uVar14 = (ulong)uVar17;
                if ((uVar17 == 3) || ((uVar17 & 1) == 0)) goto LAB_00feeb18;
