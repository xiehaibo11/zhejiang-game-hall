...

{
  ...
  *(undefined4 *)(in_x5 + 0x17) = *(undefined4 *)(in_x6 + 0x17);
                    /* WARNING: Could not recover jumptable at 0x0146acec. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(*(long *)(unaff_x26 + 0x13e0) +
              (ulong)*(byte *)(*(long *)(in_x4 + -0x18) +
                              ((long)((ulong)*(uint *)(in_x4 + -0x20) << 0x20) >> 0x21) + 0xb) * 8))
            (in_x5);
  return;
}
