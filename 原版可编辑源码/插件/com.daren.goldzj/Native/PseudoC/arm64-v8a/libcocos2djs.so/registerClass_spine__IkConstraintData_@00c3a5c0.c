...
/* void JSBClassType::registerClass<spine::IkConstraintData>(se::Class*) */

void JSBClassType::registerClass<spine::IkConstraintData>(Class *param_1)
