...
/* void cocos2d::volumeMulti<3, 8, int, short, short, int, short>(int*, unsigned long, short const*,
   int*, short const*, short) */

void cocos2d::volumeMulti<3,8,int,short,short,int,short>
    ...
    do {
      ...
      *(ulong *)param_1 =
      ...
      uVar6 = *(undefined8 *)(param_3 + 4);
                    /* catch() { ... } // from try @ 00a8accc with catch @ 00a8ae28 */
      param_3 = param_3 + 8;
                    /* catch() { ... } // from try @ 00a8acc0 with catch @ 00a8ae2c */
                    /* catch() { ... } // from try @ 00a8aca0 with catch @ 00a8ae30 */
      *(ulong *)(param_1 + 6) =
    ...
    do {
      ...
      *(ulong *)param_1 =
      ...
      iVar13 = (int)(short)((ulong)uVar7 >> 0x30);
                    /* try { // try from 00a8adb4 to 00b8ae97 has its CatchHandler @ 00a8ac4c */
      *(ulong *)(param_1 + 6) =
      ...
      *param_4 = *param_4 + ((int)uVar1 >> 0xf) * (int)param_6;
      ...
      param_4 = param_4 + 1;
                    ...
                    /* catch() { ... } // from try @ 00a8acd8 with catch @ 00a8ae40 */
  return;
}
