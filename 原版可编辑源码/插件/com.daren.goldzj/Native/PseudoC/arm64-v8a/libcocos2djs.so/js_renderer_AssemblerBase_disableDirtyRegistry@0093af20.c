...
/* js_renderer_AssemblerBase_disableDirtyRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_AssemblerBase_disableDirtyRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x36b,"js_renderer_AssemblerBase_disableDirty");
    __android_log_print(6,"jswrapper",
                        "js_renderer_AssemblerBase_disableDirty : Invalid Native Object");
  }
  else {
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        ...
        if (puVar8 != (uint *)0x0) {
          *puVar8 = *puVar8 & (local_64 ^ 0xffffffff);
        }
        goto LAB_0093b0e4;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0x372,"js_renderer_AssemblerBase_disableDirty");
      __android_log_print(6,"jswrapper",
                          "js_renderer_AssemblerBase_disableDirty : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 886): wrong number of arguments: %d, was expecting %d\n"
                          ,uVar7 >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_AssemblerBase_disableDirty",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0x379);
LAB_0093b0e4:
