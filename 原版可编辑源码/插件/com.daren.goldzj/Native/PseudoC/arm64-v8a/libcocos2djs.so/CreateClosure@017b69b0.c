...
/* v8::internal::interpreter::BytecodeArrayBuilder::CreateClosure(unsigned long, int, int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::CreateClosure
