...
/* v8::internal::compiler::EffectControlLinearizer::LowerStringFromCodePointAt(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerStringFromCodePointAt
...

{
  ...
  Builtins::CallableFor((Builtins *)local_98,*(undefined8 *)(*(long *)this + 0x168),0x2f);
