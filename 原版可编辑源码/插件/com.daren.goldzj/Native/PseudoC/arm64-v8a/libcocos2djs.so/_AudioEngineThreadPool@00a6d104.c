...
/* cocos2d::AudioEngine::AudioEngineThreadPool::~AudioEngineThreadPool() */

void __thiscall
cocos2d::AudioEngine::AudioEngineThreadPool::~AudioEngineThreadPool(AudioEngineThreadPool *this)

{
  ...
  if (*(undefined8 **)(this + 0x20) != puVar1) {
    ...
    if (lVar2 != *(long *)(this + 0x20)) {
      *(ulong *)(this + 0x28) =
           lVar2 + (~((lVar2 + -8) - *(long *)(this + 0x20)) & 0xfffffffffffffff8U);
    }
  }
  ...
  if (ptVar7 != (thread *)0x0) {
    ...
    if (this_01 != ptVar7) {
      do {
                    /* try { // try from 00a6d1e0 to 00b6d2c3 has its CatchHandler @ 00a6d01c */
        this_01 = this_01 + -8;
