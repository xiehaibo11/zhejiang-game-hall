...
/* v8::internal::compiler::MachineOperatorBuilder::I8x16ExtractLaneU(int) */

Operator * __thiscall
v8::internal::compiler::MachineOperatorBuilder::I8x16ExtractLaneU
...

{
  ...
  Operator::Operator(pOVar1,0x280,0x7c,"Extract lane",1,0,0,1,0,0);
