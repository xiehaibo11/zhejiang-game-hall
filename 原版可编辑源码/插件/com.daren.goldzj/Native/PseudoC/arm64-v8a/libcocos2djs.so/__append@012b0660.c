...
/* std::__ndk1::vector<v8::internal::compiler::RedundancyElimination::EffectPathChecks const*,
   v8::internal::ZoneAllocator<v8::internal::compiler::RedundancyElimination::EffectPathChecks
   const*> >::__append(unsigned long,
   v8::internal::compiler::RedundancyElimination::EffectPathChecks const* const&) */
...
::__append(vector<v8::internal::compiler::RedundancyElimination::EffectPathChecks_const*,v8::internal::ZoneAllocator<v8::internal::compiler::RedundancyElimination::EffectPathChecks_const*>>
           *this,ulong param_1,EffectPathChecks **param_2)

{
  ulong uVar1;
  EffectPathChecks *pEVar2;
  bool bVar3;
  Zone *this_00;
  undefined8 *puVar4;
  long lVar5;
  ...
  if ((3 < param_1) &&
     (((undefined8 *)((long)param_2 + 1U) <= puVar4 ||
      ((EffectPathChecks **)(lVar5 + (lVar11 + param_1) * 8) <= param_2)))) {
    pEVar2 = *param_2;
