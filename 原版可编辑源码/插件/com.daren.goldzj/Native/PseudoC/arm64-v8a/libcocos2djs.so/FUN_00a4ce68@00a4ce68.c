...
undefined8 FUN_00a4ce68(long *param_1)

{
  ...
  if ((*(char *)((long)param_1 + 0x3be) != '\0') && (*(char *)(lVar6 + 0x612) == '\0')) {
    ppuVar1 = &PTR_DAT_01c6e420;
    if ((undefined **)param_1[0x80] != &PTR_DAT_01c6e320) {
      ppuVar1 = &PTR_DAT_01c6e4a0;
    }
    UNRECOVERED_JUMPTABLE = (code *)ppuVar1[1];
    param_1[0x80] = (long)ppuVar1;
                    /* WARNING: Could not recover jumptable at 0x00a4cf6c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar5 = (*UNRECOVERED_JUMPTABLE)(param_1);
    return uVar5;
  }
  plVar3 = (long *)(*(code *)PTR_malloc_01d1b740)(0x28);
  ...
  if (plVar3 == (long *)0x0) {
    ...
    *(undefined1 *)(lVar6 + 0x8cc8) = 1;
    ...
    if ((pcVar4 != (char *)0x0) ||
      ...
      *pcVar4 = '\0';
      cVar2 = FUN_00a336f8(pcVar4[6]);
                    /* try { // try from 00a4cf08 to 00b4cfeb has its CatchHandler @ 00a4cd4c */
      *(undefined1 *)((long)param_1 + 0x3d4) = 1;
      if (cVar2 == 'D') {
        ...
        *(undefined1 *)(lVar6 + 0x613) = 1;
                    ...
                    /* catch() { ... } // from try @ 00a4cdcc with catch @ 00a4cf7c */
        *(undefined1 *)(lVar6 + 0x613) = 0;
      }
    }
                    /* catch() { ... } // from try @ 00a4cdc0 with catch @ 00a4cf80 */
    lVar6 = *param_1;
                    /* catch() { ... } // from try @ 00a4cda0 with catch @ 00a4cf84 */
    *(undefined4 *)(plVar3 + 3) = 0;
    plVar3[4] = 0;
                    /* catch() { ... } // from try @ 00a4cdd8 with catch @ 00a4cf94 */
    *plVar3 = lVar6 + 0x98;
    ...
    if ((((pcVar4 == (char *)0x0) && (pcVar4 = strchr(__s_00,10), pcVar4 == (char *)0x0)) &&
      ...
      uVar5 = 3;
                    ...
                    /* try { // try from 00a4cfec to 00b4d03f has its CatchHandler @ 00a4cfec
                       catch() { ... } // from try @ 00a4cfec with catch @ 00a4cfec
                       catch() { ... } // from try @ 00a4d1cc with catch @ 00a4cfec */
  return uVar5;
}
