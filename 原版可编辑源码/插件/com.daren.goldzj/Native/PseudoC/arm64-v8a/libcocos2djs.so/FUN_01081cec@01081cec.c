...
void FUN_01081cec(Isolate *param_1,ulong *param_2,uint param_3,ulong *param_4)
...
joined_r0x01081d8c:
    ...
    if ((((ulong)dVar12 >> 0x20 == 0x43300000) && (uVar10 = SUB84(dVar12,0), uVar10 != 0xffffffff))
       && (dVar11 == (double)((ulong)dVar12 & 0xffffffff))) goto joined_r0x01081d8c;
  }
                    /* WARNING: Subroutine does not return */
