...
/* v8::internal::MemoryAllocator::Unmapper::PerformFreeMemoryOnQueuedNonRegularChunks() */

void __thiscall
v8::internal::MemoryAllocator::Unmapper::PerformFreeMemoryOnQueuedNonRegularChunks(Unmapper *this)
