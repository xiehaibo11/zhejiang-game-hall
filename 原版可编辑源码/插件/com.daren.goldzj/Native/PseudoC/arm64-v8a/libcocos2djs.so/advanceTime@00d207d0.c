...

{
  ...
  *(float *)(this + 0x78) = *(float *)(this + 0x20) * *(float *)(this + 0x74);
  ...
  if ((int)(*(long **)(this + 0x88))[2] < 1) {
    ...
    if (0.0 < param_2 && bVar8) goto LAB_00d208d4;
LAB_00d208b4:
    plVar10 = *(long **)(this + 0x138);
    if (plVar10 == (long *)0x0) goto LAB_00d20908;
LAB_00d208fc:
    if (0 < (int)plVar10[2]) goto LAB_00d20908;
    (**(code **)(*plVar10 + 0x40))(uVar25);
    if (0.0 < param_2 && bVar8) goto LAB_00d2090c;
LAB_00d20974:
        ...
        if ((uVar19 - 1 == uVar18) ||
          ...
          if (*(char *)(lVar13 + 0x94) == '\0') {
            ...
            *(undefined4 *)(lVar13 + 0x9c) = 0x3f800000;
            ...
            if (fVar23 <= 0.0) goto LAB_00d20a58;
...
LAB_00d20a58:
    ...
    if (0.0 >= param_2 || !bVar8) goto LAB_00d208b4;
LAB_00d208d4:
    *(float *)(*(long *)(this + 0x88) + 0x18) =
         (float)(uint)(int)((param_2 + param_2) * *(float *)(*(long *)(this + 0x88) + 0x18)) /
         (param_2 + param_2);
    plVar10 = *(long **)(this + 0x138);
    if (plVar10 != (long *)0x0) goto LAB_00d208fc;
LAB_00d20908:
    if (param_2 <= 0.0 || !bVar8) goto LAB_00d20974;
LAB_00d2090c:
    uVar15 = (uint)(*(float *)(*(long *)(this + 0x88) + 0x18) * param_2);
    if (*(uint *)(*(long *)(this + 0x130) + 0x18) == uVar15) goto LAB_00d20c40;
  ...
  if (this[0xf] != (AnimationState)0x0) {
    ...
    if (lVar6 != 0) {
      ...
      do {
        ...
        if ((bVar4 & 1) == 0) {
          if (bVar4 >> 1 == 0) goto LAB_00d20bcc;
LAB_00d20ac8:
          AVar5 = this[0x30];
          ...
          if (sVar7 == sVar1) {
            ...
            if ((bVar4 & 1) == 0) {
              if (sVar7 != 0) {
                ...
                lVar17 = -uVar19;
                do {
                  if (*pAVar14 != *pAVar12) goto LAB_00d20b50;
                  pAVar14 = pAVar14 + 1;
                  lVar17 = lVar17 + 1;
                  pAVar12 = pAVar12 + 1;
                } while (lVar17 != 0);
...
LAB_00d20b50:
          ...
          if (sVar7 == sVar1) {
            ...
            if ((bVar4 & 1) == 0) {
              if (sVar7 != 0) {
                ...
                lVar13 = -uVar19;
                do {
                  if (*pAVar14 != *pAVar12) goto LAB_00d20bec;
                  pAVar14 = pAVar14 + 1;
                  lVar13 = lVar13 + 1;
                  pAVar12 = pAVar12 + 1;
                } while (lVar13 != 0);
          ...
          if (*(long *)(lVar13 + 0x80) != 0) goto LAB_00d20ac8;
LAB_00d20bcc:
          if ((int)plVar10[2] < 1) {
