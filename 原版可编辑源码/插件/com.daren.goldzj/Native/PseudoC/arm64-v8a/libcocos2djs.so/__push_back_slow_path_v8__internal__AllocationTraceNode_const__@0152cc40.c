...
/* void std::__ndk1::vector<v8::internal::AllocationTraceNode*,
   std::__ndk1::allocator<v8::internal::AllocationTraceNode*>
   >::__push_back_slow_path<v8::internal::AllocationTraceNode*
   const&>(v8::internal::AllocationTraceNode* const&) */
...
::__push_back_slow_path<v8::internal::AllocationTraceNode*const&>
          (vector<v8::internal::AllocationTraceNode*,std::__ndk1::allocator<v8::internal::AllocationTraceNode*>>
           *this,AllocationTraceNode **param_1)

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_0152cd28;
