...
/* js_cocos2dx_spine_SkeletonRenderer_setOpacityModifyRGBRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonRenderer_setOpacityModifyRGBRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonRenderer *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x329e,"js_cocos2dx_spine_SkeletonRenderer_setOpacityModifyRGB");
    pcVar6 = "js_cocos2dx_spine_SkeletonRenderer_setOpacityModifyRGB : Invalid Native Object";
LAB_00c70cd4:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::SkeletonRenderer::setOpacityModifyRGB(this,local_64[0]);
        goto LAB_00c70d0c;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x32a5,"js_cocos2dx_spine_SkeletonRenderer_setOpacityModifyRGB");
      pcVar6 = "js_cocos2dx_spine_SkeletonRenderer_setOpacityModifyRGB : Error processing arguments"
      ;
      goto LAB_00c70cd4;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 12969): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
