...
/* js_cocos2dx_spine_SkeletonData_findEventRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_SkeletonData_findEventRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x26bd,"js_cocos2dx_spine_SkeletonData_findEvent");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonData_findEvent : Invalid Native Object");
  }
  else {
    ...
    if (plVar6[1] - *plVar6 == 0x10) {
      ...
      ptVar7 = (type *)spine::SkeletonData::findEvent(this,(String *)&local_88);
      pVVar8 = (Value *)se::State::rval(aSStack_70);
      bVar4 = native_ptr_to_rooted_seval<spine::EventData>(ptVar7,pVVar8,(bool *)0x0);
      if (!bVar4) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                            ,0x26c7,"js_cocos2dx_spine_SkeletonData_findEvent");
        __android_log_print(6,"jswrapper",
                            "js_cocos2dx_spine_SkeletonData_findEvent : Error processing arguments")
        ;
      }
      pvVar5 = local_78;
      local_88 = &PTR__String_01c67868;
      ...
      if (bVar4) goto LAB_00c5a9b0;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 9930): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar6[1] - *plVar6) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonData_findEvent",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x26cd);
LAB_00c5a9b0:
  pVVar8 = (Value *)se::State::rval(aSStack_70);
