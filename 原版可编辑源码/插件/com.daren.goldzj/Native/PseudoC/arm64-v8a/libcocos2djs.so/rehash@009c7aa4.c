...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<unsigned long,
   ...
   cocos2d::renderer::ProgramLib::Template> > >::rehash(unsigned long) */
...

{
  ...
  if (uVar2 < param_1) {
LAB_009c7af4:
                    /* try { // try from 009c7afc to 00ac7b37 has its CatchHandler @ 009c7c58 */
    __rehash(this,uVar1);
    return;
  }
  if (param_1 < uVar2) {
    ...
    if (uVar1 < uVar2) goto LAB_009c7af4;
  }
  return;
}
