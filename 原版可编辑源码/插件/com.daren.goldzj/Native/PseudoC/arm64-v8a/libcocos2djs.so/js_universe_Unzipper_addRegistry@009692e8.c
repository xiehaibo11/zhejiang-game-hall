...
/* js_universe_Unzipper_addRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_universe_Unzipper_addRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Unzipper *)se::State::nativeThisObject(aSStack_70);
  if (this == (Unzipper *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1e2,"js_universe_Unzipper_add");
    __android_log_print(6,"jswrapper","js_universe_Unzipper_add : Invalid Native Object");
  }
  else {
    ...
    if (plVar8[1] - *plVar8 == 0x30) {
      ...
      if (bVar1) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp"
                            ,0x1ed,"js_universe_Unzipper_add");
        __android_log_print(6,"jswrapper","js_universe_Unzipper_add : Error processing arguments");
      }
      else {
      ...
      if (!bVar1) goto LAB_009694d0;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp, 497): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar8[1] - *plVar8) >> 4,3);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_universe_Unzipper_add",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_homeup_auto.cpp"
                      ,500);
LAB_009694d0:
