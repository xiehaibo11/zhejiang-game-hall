...
void FUN_00da4178(undefined8 *param_1,int param_2)

{
  ...
  lVar16 = param_1[0x49];
  if (param_2 == 2) {
    *(code **)(lVar16 + 8) = FUN_00da48d0;
    return;
  }
  if (param_2 != 0) {
    param_1 = (undefined8 *)*param_1;
    *(undefined4 *)(param_1 + 5) = 3;
                    /* WARNING: Could not recover jumptable at 0x00da4204. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)*param_1)();
    return;
  }
  if (*(int *)(param_1[0x50] + 0x10) == 0) {
    *(code **)(lVar16 + 8) = FUN_00da481c;
    *(undefined8 *)(lVar16 + 0x60) = 0;
    return;
  }
  *(code **)(lVar16 + 8) = FUN_00da451c;
  iVar4 = *(int *)(param_1 + 7);
  if (0 < iVar4) {
...
LAB_00da42fc:
          ...
          if (((puVar20 + uVar8 <= puVar23 || puVar23 + uVar8 <= puVar20) &&
            ...
            lVar10 = lVar21;
            if ((uVar6 & 3) == 0) goto LAB_00da4328;
          }
        }
        lVar21 = uVar8 - lVar10;
...
LAB_00da4494:
          ...
          uVar13 = uVar15;
          if (uVar8 != uVar15) goto LAB_00da4494;
        }
        uVar8 = (ulong)uVar7;
