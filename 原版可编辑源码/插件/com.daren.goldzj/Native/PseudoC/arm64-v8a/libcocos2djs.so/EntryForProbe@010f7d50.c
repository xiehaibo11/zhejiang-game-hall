...
/* v8::internal::HashTable<v8::internal::ObjectHashTable,
   v8::internal::ObjectHashTableShape>::EntryForProbe(v8::internal::ReadOnlyRoots,
...
EntryForProbe(HashTable<v8::internal::ObjectHashTable,v8::internal::ObjectHashTableShape> *this,
