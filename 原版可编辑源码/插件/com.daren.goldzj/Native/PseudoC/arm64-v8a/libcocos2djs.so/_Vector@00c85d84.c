...
/* spine::Vector<spine::TrackEntry*>::~Vector() */

void __thiscall spine::Vector<spine::TrackEntry*>::~Vector(Vector<spine::TrackEntry*> *this)

{
  ...
  *(undefined ***)this = &PTR__Vector_01c8d010;
  *(undefined8 *)(this + 8) = 0;
  if (lVar2 != 0) {
