...
/* void std::__ndk1::vector<v8::internal::wasm::WasmException,
   std::__ndk1::allocator<v8::internal::wasm::WasmException>
   >::__emplace_back_slow_path<v8::internal::Signature<v8::internal::wasm::ValueType>*&>(v8::internal::Signature<v8::internal::wasm::ValueType>*&)
    */
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_015f35dc;
