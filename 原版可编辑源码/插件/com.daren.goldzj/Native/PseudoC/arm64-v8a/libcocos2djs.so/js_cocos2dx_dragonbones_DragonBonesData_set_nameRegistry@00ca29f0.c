...
/* js_cocos2dx_dragonbones_DragonBonesData_set_nameRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_DragonBonesData_set_nameRegistry
...

{
  ...
  if (lVar8 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x7eb,&DAT_01928eae);
    __android_log_print(6,"jswrapper",&DAT_01932935);
  }
  else {
    local_88 = 0;
    local_80 = 0;
    ...
    if ((uVar9 & 1) == 0) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                          ,0x7f0,&DAT_01928eae);
      __android_log_print(6,"jswrapper",&DAT_0193297e);
      bVar3 = false;
    }
    else {
