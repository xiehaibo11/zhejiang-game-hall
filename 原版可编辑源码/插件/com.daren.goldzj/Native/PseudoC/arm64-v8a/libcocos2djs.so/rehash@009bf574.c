...

{
  ...
  ulong uVar2;
                    ...
                    /* try { // try from 009bf588 to 00abf5db has its CatchHandler @ 009bf588
                       catch() { ... } // from try @ 009bf588 with catch @ 009bf588
                       catch() { ... } // from try @ 009bf774 with catch @ 009bf588 */
  if (param_1 - 1 == 0) {
    param_1 = 2;
  }
...
LAB_009bf5c4:
  ...
  if (param_1 < uVar2) {
                    /* try { // try from 009bf5dc to 00abf5f3 has its CatchHandler @ 009bf7f0 */
                    /* try { // try from 009bf5fc to 00abf607 has its CatchHandler @ 009bf7ec */
    uVar1 = (ulong)((float)*(ulong *)(this + 0x18) / *(float *)(this + 0x20));
                    /* try { // try from 009bf608 to 00abf613 has its CatchHandler @ 009bf7e8 */
    if (uVar2 < 3 || (uVar2 - 1 & uVar2) != 0) {
      uVar1 = __next_prime(uVar1);
    }
    else if (1 < uVar1) {
                    /* try { // try from 009bf614 to 00abf773 has its CatchHandler @ 009bf800 */
      uVar1 = 1L << ((ulong)(uint)-(int)LZCOUNT(uVar1 - 1) & 0x3f);
    }
    if (uVar1 <= param_1) {
      uVar1 = param_1;
    }
    if (uVar1 < uVar2) goto LAB_009bf5c4;
  }
  return;
}
