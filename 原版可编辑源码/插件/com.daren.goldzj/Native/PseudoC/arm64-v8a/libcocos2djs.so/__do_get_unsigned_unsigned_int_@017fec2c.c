...
LAB_017fed10:
  if (param_2 == (long *)0x0) {
    bVar4 = true;
    if (param_3 != (long *)0x0) goto LAB_017fed54;
LAB_017fed90:
    param_3 = (long *)0x0;
    if (bVar4) goto LAB_017fee80;
  }
  else {
    ...
    param_2 = plVar2;
    if (param_3 == (long *)0x0) goto LAB_017fed90;
LAB_017fed54:
  ...
  iVar6 = __num_get<wchar_t>::__stage2_int_loop
                    (wVar5,iVar8,pcVar18,&local_1b8,&local_1c4,local_17c,local_198,local_178,
                     &local_1c0,(wchar_t *)aiStack_d8);
  if (iVar6 != 0) goto LAB_017fee80;
...
LAB_017fee80:
  ...
  uVar7 = FUN_01828af4(pcVar18,local_1b8,param_5,iVar8);
  *param_6 = uVar7;
  uVar9 = (ulong)((byte)local_198[0] >> 1);
  if (((byte)local_198[0] & 1) != 0) {
    uVar9 = local_190;
  ...
  if (uVar9 != 0) {
    ...
    if (local_178 < puVar11) {
      ...
      do {
        if ((bVar4) && (*puVar17 != uVar12)) goto LAB_017fefd4;
...
LAB_017fefd4:
  ...
  if (param_2 == (long *)0x0) {
    bVar4 = true;
    if (param_3 != (long *)0x0) goto LAB_017ff028;
LAB_017feffc:
    if (!bVar4) goto LAB_017ff06c;
  }
  else {
    if ((int *)param_2[3] == (int *)param_2[4]) {
    ...
    param_2 = plVar2;
    if (param_3 == (long *)0x0) goto LAB_017feffc;
LAB_017ff028:
    if ((int *)param_3[3] == (int *)param_3[4]) {
    ...
    if (bVar4 != (iVar8 == -1)) goto LAB_017ff06c;
  }
  *param_5 = *param_5 | 2;
LAB_017ff06c:
  if ((local_1b0 & 1) != 0) {
