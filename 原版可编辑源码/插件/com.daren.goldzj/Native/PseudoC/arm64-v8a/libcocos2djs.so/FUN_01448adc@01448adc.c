...
void FUN_01448adc(long param_1,undefined8 param_2,undefined8 param_3,long param_4,undefined8 param_5
...

{
  ...
  if (uVar2 == 0x43) {
    if (((in_w9 == 0) && (*(int *)(param_1 + -1) != (int)*(undefined8 *)(unaff_x26 + 0x140))) &&
       (*(short *)(unaff_x26 + (ulong)*(uint *)(param_1 + -1) + 7) != 0x43)) goto LAB_01448ca4;
    uVar5 = 0x1e;
  }
  else {
    if (in_w9 == 0) {
  ...
  if (in_w8 == 0) {
    ...
    if (uVar6 != uVar5) {
      ...
      *(undefined4 *)(param_6 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x01448aa8. Too many branches */
