...
/* XMLHttpRequest_getAllResponseHeadersRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void XMLHttpRequest_getAllResponseHeadersRegistry(FunctionCallbackInfo *param_1)
