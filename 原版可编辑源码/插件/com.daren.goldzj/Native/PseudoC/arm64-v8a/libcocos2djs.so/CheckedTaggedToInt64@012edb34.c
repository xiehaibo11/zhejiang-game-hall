...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CheckedTaggedToInt64(v8::internal::compiler::CheckForMinusZeroMode,
   v8::internal::compiler::FeedbackSource const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::CheckedTaggedToInt64
...

{
  ...
  if ((*param_3 == 0) || ((int)param_3[1] == -1)) {
    if (param_2 == (Operator)0x1) {
      ...
      if (param_2 != (Operator)0x0) goto LAB_012edb8c;
      lVar4 = *(long *)this;
      lVar5 = 0x3088;
    }
...
LAB_012edb8c:
    ...
    Operator::Operator(pOVar2,0x6c,0x38,"CheckedTaggedToInt64",1,1,1,1,1,0);
    pOVar2[0x30] = param_2;
