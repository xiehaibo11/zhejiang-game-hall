...
/* v8::internal::PropertyCallbackArguments::BasicCallNamedGetterCallback(void
   (*)(v8::Local<v8::Name>, v8::PropertyCallbackInfo<v8::Value> const&),
...
v8::internal::PropertyCallbackArguments::BasicCallNamedGetterCallback
          (PropertyCallbackArguments *this,code *param_1,undefined8 param_3,undefined8 param_4,
          undefined8 param_5)

{
  ...
  if ((*(int *)(lVar6 + 0xb80c) == 0x20) &&
     (uVar4 = Debug::PerformSideEffectCheckForCallback
                        (*(Debug **)(lVar6 + 0xb6c8),param_4,param_5,1), (uVar4 & 1) == 0)) {
