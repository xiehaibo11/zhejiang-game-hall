...
/* v8::internal::compiler::CodeAssembler::Branch(v8::internal::TNode<v8::internal::BoolT>,
   std::__ndk1::function<void ()> const&, v8::internal::compiler::CodeAssemblerLabel*) */

void __thiscall
v8::internal::compiler::CodeAssembler::Branch
          (CodeAssembler *this,long *param_2,long param_3,CodeAssemblerLabel *param_4)

{
  ...
  if (*(short *)(lVar3 + 0x10) == 0x18) {
    ...
    if (*(long *)(lVar3 + 0x30) != (long)iVar2) goto LAB_01689acc;
  }
  else {
...
LAB_01689acc:
      ...
      *(undefined8 *)pRVar1 = 0;
      local_78 = pRVar1;
      Branch(this,param_2,local_90,param_4);
  ...
  if (*(long **)(param_3 + 0x20) != (long *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x01689ac8. Too many branches */
