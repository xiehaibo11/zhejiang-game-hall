...
/* v8::internal::compiler::Typer::Visitor::Negate(v8::internal::compiler::Type,
   v8::internal::compiler::Typer*) */

undefined8 v8::internal::compiler::Typer::Visitor::Negate(undefined8 param_1,long param_2)

{
  ...
  if ((local_28 == 0x1c5f) ||
    ...
    uVar2 = OperationTyper::NumberMultiply
