...
/* cocos2d::Scheduler::resumeTarget(void*) */

void __thiscall cocos2d::Scheduler::resumeTarget(Scheduler *this,void *param_1)

{
  ...
  if (*(long *)this != 0) {
    ...
    ;
    while( true ) {
      if ((lVar8 == 0) || (lVar8 = lVar8 - plVar7[4], lVar8 == 0)) goto LAB_0088ebc8;
      if ((*(int *)(lVar8 + 0x58) == 8) && ((void *)**(undefined8 **)(lVar8 + 0x50) == param_1))
      break;
      lVar8 = *(long *)(lVar8 + 0x48);
    }
    *(undefined1 *)(lVar8 + 0x21) = 0;
  }
LAB_0088ebc8:
