...
/* v8::internal::compiler::LoadElimination::AbstractState::KillField(v8::internal::compiler::LoadElimination::AliasStateInfo
   const&, v8::internal::compiler::LoadElimination::IndexRange,
  ...
  if ((int)param_3 == iVar4) {
    ...
    while( true ) {
      if ((pAVar2 != (AbstractField *)0x0) &&
         (lVar3 = AbstractField::Kill(pAVar2,param_1,param_4,param_5),
