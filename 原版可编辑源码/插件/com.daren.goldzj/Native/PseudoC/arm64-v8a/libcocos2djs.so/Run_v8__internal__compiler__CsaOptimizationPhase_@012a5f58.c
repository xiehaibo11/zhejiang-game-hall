...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::CsaOptimizationPhase>() */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::CsaOptimizationPhase>
          (PipelineImpl *this)

{
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFCSAOptimization");
  CsaOptimizationPhase::Run(aCStack_18,pPVar5,pZVar2);
