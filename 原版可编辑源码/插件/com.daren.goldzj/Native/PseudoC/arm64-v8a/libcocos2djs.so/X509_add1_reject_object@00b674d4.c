...

{
  ...
  if (a == (ASN1_OBJECT *)0x0) {
    return 0;
                    ...
                    /* try { // try from 00b674f8 to 00c67593 has its CatchHandler @ 00b674f8
                       catch() { ... } // from try @ 00b674f8 with catch @ 00b674f8
                       catch() { ... } // from try @ 00b67660 with catch @ 00b674f8 */
  if (x == (X509 *)0x0) {
LAB_00b67544:
    ASN1_OBJECT_free(a);
    return 0;
