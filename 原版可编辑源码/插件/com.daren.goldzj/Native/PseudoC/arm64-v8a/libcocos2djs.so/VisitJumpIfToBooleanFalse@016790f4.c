...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitJumpIfToBooleanFalse() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitJumpIfToBooleanFalse(BytecodeGraphBuilder *this)
