...
/* v8::internal::compiler::JSBoundFunctionRef::bound_target_function() const */

undefined1  [16] __thiscall
v8::internal::compiler::JSBoundFunctionRef::bound_target_function(JSBoundFunctionRef *this)

{
  ...
  if (*(int *)(puVar6 + 1) == 2) {
    uVar7 = *(ulong *)*puVar6;
    if ((uVar7 & 1) == 0) goto LAB_01725c0c;
    uVar1 = *(ushort *)((uVar7 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar7 - 1));
  }
  else {
    if (*(int *)(puVar6 + 1) == 0) goto LAB_01725c0c;
