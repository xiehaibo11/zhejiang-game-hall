...
/* v8::internal::compiler::JSHeapBroker::GetFeedbackForCompareOperation(v8::internal::compiler::FeedbackSource
   const&) */

undefined1 __thiscall
v8::internal::compiler::JSHeapBroker::GetFeedbackForCompareOperation
...

{
  ...
  if (FLAG_concurrent_inlining == '\0') {
    piVar3 = (int *)ProcessFeedbackForCompareOperation(this,param_1);
    iVar1 = *piVar3;
  }
  else {
    lVar2 = std::__ndk1::
