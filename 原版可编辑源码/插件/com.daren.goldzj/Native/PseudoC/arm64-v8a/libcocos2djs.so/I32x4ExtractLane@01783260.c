...
/* v8::internal::compiler::MachineOperatorBuilder::I32x4ExtractLane(int) */

Operator * __thiscall
v8::internal::compiler::MachineOperatorBuilder::I32x4ExtractLane
...

{
  ...
  Operator::Operator(pOVar1,0x23d,0x7c,"Extract lane",1,0,0,1,0,0);
