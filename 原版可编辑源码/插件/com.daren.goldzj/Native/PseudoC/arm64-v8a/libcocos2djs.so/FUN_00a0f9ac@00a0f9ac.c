...
void FUN_00a0f9ac(long *param_1,int param_2)

{
  ...
  if (*(int *)((long)param_1 + 0xac) == 2) goto LAB_00a0fa8c;
                    /* try { // try from 00a0f9ec to 00b0fa43 has its CatchHandler @ 00a0f958 */
  lVar9 = *param_1;
  if ((*(char *)((long)param_1 + 0x3ba) == '\0') && (*(char *)((long)param_1 + 0x3d6) == '\0')) {
    ...
    if (iVar2 == 0) {
      ...
      if (iVar2 == 0) {
                    /* catch() { ... } // from try @ 00a0faa4 with catch @ 00a0fb44
                       catch() { ... } // from try @ 00a0faf4 with catch @ 00a0fb44 */
                    /* catch() { ... } // from try @ 00a0fae8 with catch @ 00a0fb48 */
        __buf = (long *)((long)param_1 + 0x1aa);
        if (local_d8[0].sa_family == 1) {
          FUN_00a0e7c4(__buf,0x2e,"%s",(ulong)local_d8 | 2);
          uVar8 = 0;
LAB_00a0fbb8:
          param_1[0x3b] = uVar8;
          ...
          *(long *)((long)param_1 + 0x96) = param_1[0x39];
          ...
          if (local_158[0].sa_family == 1) {
            FUN_00a0e7c4(param_1 + 0x3c,0x2e,"%s",(ulong)local_158 | 2);
            uVar8 = 0;
LAB_00a0fc74:
            lVar9 = *param_1;
            param_1[0x42] = uVar8;
...
LAB_00a0fc5c:
          ...
          *(undefined1 *)(param_1 + 0x3c) = 0;
          ...
          uVar10 = *puVar3;
          uVar4 = FUN_00a155d4(param_1,uVar10);
...
LAB_00a0fb9c:
        ...
        pcVar5 = "getsockname() failed with errno %d: %s";
                    /* try { // try from 00a0fb40 to 00b0fb6b has its CatchHandler @ 00a0fa68 */
      }
    }
    else {
      puVar3 = (undefined4 *)__errno();
      uVar10 = *puVar3;
      uVar4 = FUN_00a155d4(param_1,uVar10);
                    /* try { // try from 00a0fae8 to 00b0faef has its CatchHandler @ 00a0fb48 */
      pcVar5 = "getpeername() failed with errno %d: %s";
                    /* try { // try from 00a0faf4 to 00b0fb3f has its CatchHandler @ 00a0fb44 */
    }
    FUN_00a23020(lVar9,pcVar5,uVar10,uVar4);
  }
  else {
LAB_00a0fa00:
    lVar11 = param_1[0x39];
    ...
    *(undefined8 *)(lVar9 + 0x8e30) = *puVar7;
                    /* catch() { ... } // from try @ 00a0fb40 with catch @ 00a0fa68 */
...
LAB_00a0fa8c:
  if (*(long *)(lVar1 + 0x28) == lVar6) {
                    /* try { // try from 00a0faa4 to 00b0fac7 has its CatchHandler @ 00a0fb44 */
    return;
  }
