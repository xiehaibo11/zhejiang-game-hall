...
uint __thiscall
v8::internal::compiler::MapInference::AllOfInstanceTypesAre(MapInference *this,ushort param_2)

{
  ...
  if (&local_60 == (undefined ***)local_40) {
    ...
    if (local_40 == (long *)0x0) goto LAB_01791ebc;
