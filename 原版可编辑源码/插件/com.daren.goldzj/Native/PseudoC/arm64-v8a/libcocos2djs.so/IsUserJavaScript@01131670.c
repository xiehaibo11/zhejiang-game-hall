...
/* v8::internal::StackTraceFrame::IsUserJavaScript(v8::internal::Handle<v8::internal::StackTraceFrame>)
    */

byte v8::internal::StackTraceFrame::IsUserJavaScript(ulong *param_1)
