...
/* std::__ndk1::vector<v8::internal::compiler::UnwindingInfoWriter::BlockInitialState const*,
   v8::internal::ZoneAllocator<v8::internal::compiler::UnwindingInfoWriter::BlockInitialState
