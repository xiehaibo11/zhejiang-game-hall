...
/* void std::__ndk1::vector<v8::internal::ChunkedStream<unsigned short>::Chunk,
   std::__ndk1::allocator<v8::internal::ChunkedStream<unsigned short>::Chunk>
   >::__emplace_back_slow_path<unsigned short const*, unsigned long&, unsigned long>(unsigned short
...
::__emplace_back_slow_path<unsigned_short_const*,unsigned_long&,unsigned_long>
          (vector<v8::internal::ChunkedStream<unsigned_short>::Chunk,std::__ndk1::allocator<v8::internal::ChunkedStream<unsigned_short>::Chunk>>
           *this,ushort **param_1,ulong *param_2,ulong *param_3)

{
  ...
  if (uVar1 < 0xaaaaaaaaaaaaaab) {
    ...
    if (uVar1 == 0) {
      ...
      if (0xaaaaaaaaaaaaaaa < uVar1) goto LAB_01187de4;
