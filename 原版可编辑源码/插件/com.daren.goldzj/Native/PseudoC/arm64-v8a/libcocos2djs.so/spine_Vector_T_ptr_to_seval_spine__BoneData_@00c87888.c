...
/* bool spine_Vector_T_ptr_to_seval<spine::BoneData>(spine::Vector<spine::BoneData*> const&,
   se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::BoneData>(Vector *param_1,Value *param_2)
...
LAB_00c87950:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::BoneData>
