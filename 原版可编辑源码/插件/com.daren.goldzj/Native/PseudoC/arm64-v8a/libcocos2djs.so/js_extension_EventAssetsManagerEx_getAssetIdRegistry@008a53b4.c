...
/* js_extension_EventAssetsManagerEx_getAssetIdRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_extension_EventAssetsManagerEx_getAssetIdRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar5 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x42,"js_extension_EventAssetsManagerEx_getAssetId");
    __android_log_print(6,"jswrapper",
                        "js_extension_EventAssetsManagerEx_getAssetId : Invalid Native Object");
  }
  else {
    ...
    if (plVar6[1] - *plVar6 == 0) {
      ...
      if ((*(byte *)(lVar5 + 0x30) & 1) == 0) {
        local_80 = *(void **)(lVar5 + 0x40);
        uStack_88 = *(ulong *)(lVar5 + 0x38);
        local_90 = *(ulong *)(lVar5 + 0x30);
      }
      else {
        uVar7 = *(ulong *)(lVar5 + 0x38);
        if (0xffffffffffffffef < uVar7) {
                    /* WARNING: Subroutine does not return */
          std::__ndk1::__basic_string_common<true>::__throw_length_error();
        }
        pvVar4 = *(void **)(lVar5 + 0x40);
        if (uVar7 < 0x17) {
          __dest = (void *)((ulong)&local_90 | 1);
          local_90 = (ulong)(byte)((int)uVar7 << 1);
          if (uVar7 != 0) goto LAB_008a554c;
        }
        else {
...
LAB_008a554c:
      ...
      if (bVar1) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_extension_auto.cpp"
                            ,0x49,"js_extension_EventAssetsManagerEx_getAssetId");
        __android_log_print(6,"jswrapper",
                            "js_extension_EventAssetsManagerEx_getAssetId : Error processing arguments"
                           );
      }
      if ((local_90 & 1) != 0) {
        operator_delete(local_80);
      }
      if (!bVar1) goto LAB_008a55bc;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_extension_auto.cpp, 76): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar6[1] - *plVar6) >> 4,0);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_extension_EventAssetsManagerEx_getAssetId",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_extension_auto.cpp"
                      ,0x4f);
LAB_008a55bc:
  pVVar8 = (Value *)se::State::rval(aSStack_70);
