...
/* js_register_renderer_Effect(se::Object*) */

undefined8 js_register_renderer_Effect(Object *param_1)

{
  ...
  local_3f = 0x65766974;
  uStack_47 = 0x4e746365666645;
  uStack_40 = 0x61;
  local_3b = 0;
  this = (Class *)se::Class::create(&local_48,param_1,__jsb_cocos2d_renderer_EffectBase_proto,
                                    js_renderer_Effect_constructorRegistry);
  if (((byte)local_48 & 1) != 0) {
    operator_delete(local_38);
  }
  se::Class::defineFunction(this,"clear",js_renderer_Effect_clearRegistry);
  se::Class::defineFunction(this,"switchTechnique",js_renderer_Effect_switchTechniqueRegistry);
  se::Class::defineFunction(this,"copy",js_renderer_Effect_copyRegistry);
  se::Class::defineFinalizeFunction(this,js_cocos2d_renderer_Effect_finalizeRegistry);
  se::Class::install(this);
  local_30 = (Class *)0x188b60c;
  ...
  __jsb_cocos2d_renderer_Effect_proto = se::Class::getProto(this);
  __jsb_cocos2d_renderer_Effect_class = this;
