...
/* std::__ndk1::__split_buffer<v8::internal::compiler::BytecodeGraphBuilder::OsrIteratorState::IteratorsStates*,
   ...
   >::push_front(v8::internal::compiler::BytecodeGraphBuilder::OsrIteratorState::IteratorsStates*&&)
    */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_0167f20c;
  ...
  if (__src != puVar4) {
    ...
    if ((3 < uVar2) && ((__src + uVar11 + 1 <= puVar1 || (puVar12 + uVar11 + uVar8 + 1 <= __src))))
    {
      ...
      if (uVar2 == uVar11) goto LAB_0167f1c0;
    }
    do {
      puVar3 = __src + 1;
      puVar10 = puVar9 + 1;
