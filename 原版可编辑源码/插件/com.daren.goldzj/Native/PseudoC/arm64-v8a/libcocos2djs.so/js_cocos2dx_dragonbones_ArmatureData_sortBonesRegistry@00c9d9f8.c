...
/* js_cocos2dx_dragonbones_ArmatureData_sortBonesRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_ArmatureData_sortBonesRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (ArmatureData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x53c,0x1928857);
    __android_log_print(6,"jswrapper",&DAT_01930803);
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      dragonBones::ArmatureData::sortBones(this);
      goto LAB_00c9db48;
    }
    __android_log_print(6,"jswrapper",&DAT_0193084a,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
