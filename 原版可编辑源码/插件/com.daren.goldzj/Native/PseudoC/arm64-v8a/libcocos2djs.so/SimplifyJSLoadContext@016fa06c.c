...
/* v8::internal::compiler::JSContextSpecialization::SimplifyJSLoadContext(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*, unsigned long) */

Node * __thiscall
v8::internal::compiler::JSContextSpecialization::SimplifyJSLoadContext
