...
/* v8::internal::compiler::MoveOperands::Print() const */

void __thiscall v8::internal::compiler::MoveOperands::Print(MoveOperands *this)

{
  ...
  uStack_128 = 0;
  local_130 = 0;
  compiler::operator<<((basic_ostream *)&local_148,(InstructionOperand *)(this + 8));
  std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>
            ((basic_ostream *)&local_148," = ",3);
  compiler::operator<<((basic_ostream *)&local_148,(InstructionOperand *)this);
