...
/* void std::__ndk1::vector<v8::internal::SourcePositionInfo,
   std::__ndk1::allocator<v8::internal::SourcePositionInfo>
   >::__push_back_slow_path<v8::internal::SourcePositionInfo>(v8::internal::SourcePositionInfo&&) */
...
__push_back_slow_path<v8::internal::SourcePositionInfo>
          (vector<v8::internal::SourcePositionInfo,std::__ndk1::allocator<v8::internal::SourcePositionInfo>>
           *this,SourcePositionInfo *param_1)

{
  ...
  if (uVar1 >> 0x3b == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3b != 0) goto LAB_014e7210;
