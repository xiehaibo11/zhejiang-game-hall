...
/* v8::internal::Heap::RemoveGCEpilogueCallback(void (*)(v8::Isolate*, v8::GCType,
   v8::GCCallbackFlags, void*), void*) */

void __thiscall
v8::internal::Heap::RemoveGCEpilogueCallback
...

{
  ...
  lVar3 = *(long *)(this + 0x600);
  puVar2 = *(undefined8 **)(this + 0x5f8);
