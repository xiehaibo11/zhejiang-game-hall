...
/* v8::internal::Isolate::ThreadDataTable::Lookup(v8::internal::ThreadId) */

long __thiscall v8::internal::Isolate::ThreadDataTable::Lookup(ThreadDataTable *this,int param_2)
