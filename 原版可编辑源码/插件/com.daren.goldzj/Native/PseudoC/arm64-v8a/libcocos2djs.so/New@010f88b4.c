...
/* v8::internal::HashTable<v8::internal::ObjectHashSet,
   v8::internal::ObjectHashSetShape>::New(v8::internal::Isolate*, int, v8::internal::AllocationType,
   v8::internal::MinimumCapacity) */

void v8::internal::HashTable<v8::internal::ObjectHashSet,v8::internal::ObjectHashSetShape>::New
...

{
  ...
  plVar1 = (long *)Factory::NewFixedArrayWithMap<v8::internal::FixedArray>
                             (param_1,0xe,param_2 + 3,param_3);
  *(undefined4 *)(*plVar1 + 7) = 0;
  *(undefined4 *)(*plVar1 + 0xb) = 0;
  *(int *)(*plVar1 + 0xf) = param_2 << 1;
  return;
}
