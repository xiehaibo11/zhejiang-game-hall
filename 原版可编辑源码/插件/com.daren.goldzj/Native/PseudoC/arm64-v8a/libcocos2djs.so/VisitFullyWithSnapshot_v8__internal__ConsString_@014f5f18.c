...
/* WARNING: Removing unreachable block (ram,0x014f5fcc) */
/* int 
   v8::internal::ConcurrentMarkingVisitor::VisitFullyWithSnapshot<v8::internal::ConsString>(v8::internal::Map,
   v8::internal::ConsString) */

int __thiscall
v8::internal::ConcurrentMarkingVisitor::VisitFullyWithSnapshot<v8::internal::ConsString>
