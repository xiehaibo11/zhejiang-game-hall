...
/* v8::internal::compiler::GraphAssembler::Float64Div(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Float64Div(GraphAssembler *this,Node *param_1,Node *param_2)
