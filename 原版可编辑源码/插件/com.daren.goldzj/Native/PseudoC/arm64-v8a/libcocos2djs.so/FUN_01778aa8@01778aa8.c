...
void FUN_01778aa8(long param_1,undefined8 *param_2,int param_3)

{
  ...
  if (uVar6 < (ulong)(*(long *)(*(long *)(param_1 + 8) + 0x18) - lVar1)) {
    uVar4 = (uint)*(byte *)(lVar1 + uVar6);
    if ((3 < uVar4 - 1) && (1 < uVar4 - 9)) {
      ...
      std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>
                (pbVar3," which doesn\'t have a compressed or int32-compatible representation.",0x44
                );
