...
/* void v8::internal::MemoryChunk::ReleaseInvalidatedSlots<(v8::internal::RememberedSetType)1>() */

void __thiscall
v8::internal::MemoryChunk::ReleaseInvalidatedSlots<(v8::internal::RememberedSetType)1>
          (MemoryChunk *this)
