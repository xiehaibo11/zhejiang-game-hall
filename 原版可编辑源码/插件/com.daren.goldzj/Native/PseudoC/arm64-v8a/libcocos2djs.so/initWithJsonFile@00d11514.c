...
LAB_00d1159c:
    ...
    local_a8 = &PTR__String_01c67868;
    if (pbVar6 != (basic_string *)0x0) goto LAB_00d1159c;
    local_a0 = 0;
    local_98 = (void *)0x0;
  }
  ...
  *(Cocos2dAtlasAttachmentLoader **)(this + 0x28) = this_01;
  SkeletonJson::SkeletonJson((SkeletonJson *)&local_a8,(AttachmentLoader *)this_01);
  local_78 = param_3;
  if (((byte)*param_1 & 1) == 0) {
    pbVar6 = param_1 + 1;
  }
...
LAB_00d116d8:
  pSVar5 = (SkeletonData *)
           SkeletonJson::readSkeletonDataFile((SkeletonJson *)&local_a8,(String *)&local_c0);
  pvVar3 = local_b0;
  local_c0 = &PTR__String_01c67868;
  ...
  *(Skeleton **)(this + 0x30) = this_02;
  ...
  SkeletonJson::~SkeletonJson((SkeletonJson *)&local_a8);
