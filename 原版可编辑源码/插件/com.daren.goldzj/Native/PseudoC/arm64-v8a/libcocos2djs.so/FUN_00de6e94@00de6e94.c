...
int FUN_00de6e94(long param_1,undefined8 *param_2)

{
  ...
  if (iVar2 < 1) {
    ...
    puVar1 = param_2 + 0x13;
    do {
      iVar3 = FUN_00de3dfc(param_2 + 6,iVar2 - iVar11,
                           *(long *)(param_1 + 0x18) + (long)(*(int *)(param_1 + 0x30) * iVar11));
      iVar8 = (iVar2 + 1 >> 1) - iVar9;
      iVar4 = FUN_00de3ddc(puVar1,iVar8);
      if (iVar4 != 0) {
        iVar4 = FUN_00de3dfc(puVar1,iVar8,
                             *(long *)(param_1 + 0x20) +
                             (long)*(int *)(param_1 + 0x34) * (long)iVar9);
        FUN_00de3dfc(param_2 + 0x20,iVar8,
      ...
      if (*(int *)(param_2 + 0xe) < *(int *)(param_2 + 0xd)) {
        ...
        pcVar5 = *(code **)(&DAT_01d54788 + (ulong)*puVar10 * 8);
        ...
        do {
          ...
          FUN_00df4754(param_2 + 6);
          FUN_00df4754(puVar1);
          FUN_00df4754(param_2 + 0x20);
