...
/* v8::internal::Dictionary<v8::internal::NameDictionary,
   v8::internal::NameDictionaryShape>::SetEntry(v8::internal::Isolate*, v8::internal::InternalIndex,
   v8::internal::Object, v8::internal::Object, v8::internal::PropertyDetails) */

void __thiscall
v8::internal::Dictionary<v8::internal::NameDictionary,v8::internal::NameDictionaryShape>::SetEntry
...

{
  ...
  *(int *)(*(ulong *)this + lVar1) = (int)param_4;
  ...
  if ((((uint)uVar4 >> 0x12 & 1) == 0) && ((uVar4 & 0x18) != 0)) {
    *(int *)(uVar2 + (lVar5 + 0x1800000000 >> 0x20) + 7) = (int)param_5;
  }
  else {
    if ((param_4 & 1) != 0) {
    ...
    lVar1 = (lVar5 + 0x1800000000 >> 0x20) + 7;
  ...
  *(int *)(*(long *)this + (lVar5 + 0x1c00000000 >> 0x20) + 7) = param_6 << 1;
  return;
}
