    ...
    if (iVar1 == 0) {
      ...
      if (iVar1 == 0) {
        ...
        method_00 = extraout_x1_01;
                    ...
                    /* try { // try from 00b6bdd8 to 00c6bddf has its CatchHandler @ 00b6beb0 */
        ...
        if (iVar1 == 0) {
          ...
          if (iVar1 == 0) {
            ...
            method_00 = extraout_x1_03;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b6bdd8 with catch @ 00b6beb0
                        */
          }
          else {
            ...
            if (iVar1 == 0) {
              ...
              method_00 = extraout_x1_04;
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00b6bc80 with catch @ 00b6beb8
                        */
            }
            else {
