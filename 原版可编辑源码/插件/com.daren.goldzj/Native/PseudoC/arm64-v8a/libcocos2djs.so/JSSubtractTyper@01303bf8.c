...
/* v8::internal::compiler::Typer::Visitor::JSSubtractTyper(v8::internal::compiler::Type,
   v8::internal::compiler::Type, v8::internal::compiler::Typer*) */

undefined8
v8::internal::compiler::Typer::Visitor::JSSubtractTyper
...

{
  ...
  if (((local_38 == 0x1c5f) ||
     ...
     (((uVar2 ^ 1) & 1) == 0)) {
    uVar5 = OperationTyper::NumberSubtract(pOVar1,local_18,local_38);
  }
  else if ((uVar2 & 1) == 0) {
    uVar5 = 0x8000001;
