...
/* v8::internal::compiler::LifetimePosition::Print() const */

void __thiscall v8::internal::compiler::LifetimePosition::Print(LifetimePosition *this)

{
  ...
  local_130 = 0;
  local_f0 = 0;
  compiler::operator<<(&local_148,*(undefined4 *)this);
