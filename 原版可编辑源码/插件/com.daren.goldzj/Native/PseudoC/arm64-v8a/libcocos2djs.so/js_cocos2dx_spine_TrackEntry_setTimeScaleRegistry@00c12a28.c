...
/* js_cocos2dx_spine_TrackEntry_setTimeScaleRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_TrackEntry_setTimeScaleRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (TrackEntry *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xa8,"js_cocos2dx_spine_TrackEntry_setTimeScale");
    puVar6 = &DAT_018f0a1c;
LAB_00c12b9c:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::TrackEntry::setTimeScale(this,local_64);
        goto LAB_00c12bd4;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0xaf,"js_cocos2dx_spine_TrackEntry_setTimeScale");
      puVar6 = &DAT_018f0a5e;
      goto LAB_00c12b9c;
    }
    __android_log_print(6,"jswrapper",&DAT_018f0aa5,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_TrackEntry_setTimeScale",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0xb6);
LAB_00c12bd4:
