...
/* void std::__ndk1::vector<dragonBones::ActionData*,
   std::__ndk1::allocator<dragonBones::ActionData*>
   >::__push_back_slow_path<dragonBones::ActionData* const&>(dragonBones::ActionData* const&) */
...
LAB_00d3730c:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d3730c;
  }
  else {
