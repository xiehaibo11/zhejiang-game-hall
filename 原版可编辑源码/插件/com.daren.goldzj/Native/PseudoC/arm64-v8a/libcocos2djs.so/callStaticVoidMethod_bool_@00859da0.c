...
/* void cocos2d::JniHelper::callStaticVoidMethod<bool>(std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&,
   std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >
   const&, bool) */

void cocos2d::JniHelper::callStaticVoidMethod<bool>
               (basic_string *param_1,basic_string *param_2,bool param_3)

{
  ...
  *puVar5 = 0;
  ...
  if ((uVar6 & 1) == 0) {
    ...
    local_50 = (void *)0x0;
    local_40 = 0x3f800000;
    _JNIEnv::CallStaticVoidMethod(local_78,p_Stack_70,local_68,(ulong)param_3);
