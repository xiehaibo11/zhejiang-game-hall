...

{
  ...
  if (puVar2 <= puVar1) {
LAB_00ff2098:
    if ((uint *)(param_2 + 0x47U) <= puVar2) {
      return;
    }
    uVar4 = *puVar2;
    do {
      if ((uVar4 & 1) != 0) {
        uVar12 = (ulong)puVar2 & 0xffffffff00000000 | (ulong)uVar4;
        uVar9 = (ulong)puVar2 & 0xffffffff00000000 | (ulong)uVar4 & 0xfffffffffffc0000;
        if ((*(byte *)(uVar9 + 8) & 0x18) != 0) {
          puVar1 = (uint *)(*(long *)(uVar9 + 0x108) + (uVar12 - uVar9 >> 7 & 0x1ffffff) * 4);
          while( true ) {
            uVar4 = *puVar1;
...
LAB_00ff1ff0:
    puVar1 = puVar1 + 1;
    if (puVar2 <= puVar1) goto LAB_00ff2098;
    uVar4 = *puVar1;
  } while( true );
}
