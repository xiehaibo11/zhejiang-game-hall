...
undefined8
FUN_010b9734(undefined8 param_1,ulong *param_2,KeyAccumulator *param_3,undefined4 param_4)

{
  ...
  if (((*(uint *)((uVar4 & 0xffffffff00000000 | (ulong)*(uint *)(uVar4 + 0xb)) + 0x1b) >> 2 & 1) ==
    ...
    uVar3 = v8::internal::Factory::NewNumberFromInt
    ...
    if ((uVar4 & 1) != 0) {
      lVar6 = 1;
      do {
        if (lVar5 == lVar6) goto LAB_010b9838;
        uVar4 = *param_2;
        uVar3 = v8::internal::Factory::NewNumberFromInt
                          ((Factory *)(uVar4 & 0xffffffff00000000),
                           *(int *)(*(long *)(uVar4 + 0x27) + (ulong)*(uint *)(uVar4 + 0x2f) +
