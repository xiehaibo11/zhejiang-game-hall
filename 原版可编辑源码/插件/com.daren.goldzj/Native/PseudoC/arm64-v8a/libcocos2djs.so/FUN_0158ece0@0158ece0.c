...
undefined8 FUN_0158ece0(undefined8 param_1,long param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_90,(ulong)&local_90 | 8,0x1f5);
  }
  if (DAT_01d47300 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d47300 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d47300;
  local_b0 = (byte **)0x0;
  if ((*DAT_01d47300 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar3,"V8.Runtime_Runtime_PushCatchContext",0,0,0,0,0,0,0,
                       &local_60,0);
    plVar4 = local_58;
    local_58 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    local_b0 = &local_a8;
    local_a0 = "V8.Runtime_Runtime_PushCatchContext";
    local_a8 = pbVar3;
    local_98 = uVar5;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar8 & 1) != 0) &&
    ...
    puVar7 = (undefined8 *)
             v8::internal::Factory::NewCatchContext
                       ((Factory *)param_3,puVar6,(ulong *)(param_2 + -8),param_2);
