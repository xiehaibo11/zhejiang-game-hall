...
/* v8::internal::interpreter::BytecodeGenerator::VisitThrow(v8::internal::Throw*) */

void __thiscall
v8::internal::interpreter::BytecodeGenerator::VisitThrow(BytecodeGenerator *this,Throw *param_1)
