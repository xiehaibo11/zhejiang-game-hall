...
/* v8::internal::AsmJsWasmStackFrame::GetFileName() */

void __thiscall v8::internal::AsmJsWasmStackFrame::GetFileName(AsmJsWasmStackFrame *this)

{
  ...
  uVar3 = uVar3 | *(uint *)((uVar3 | *(uint *)(**(ulong **)(this + 0x10) + 0x6f)) + 0x13);
