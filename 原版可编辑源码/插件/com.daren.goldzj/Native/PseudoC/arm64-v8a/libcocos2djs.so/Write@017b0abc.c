...
/* v8::internal::interpreter::BytecodeArrayBuilder::Write(v8::internal::interpreter::BytecodeNode*)
    */

void __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::Write
...

{
  ...
  BytecodeArrayWriter::Write((BytecodeArrayWriter *)(this + 0x110),param_1);
  return;
}
