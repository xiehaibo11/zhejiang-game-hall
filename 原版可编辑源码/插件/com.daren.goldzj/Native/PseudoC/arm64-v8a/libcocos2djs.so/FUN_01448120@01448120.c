...
void FUN_01448120(ulong param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  lVar3 = (long)(int)*(short *)(unaff_x20 + unaff_x19 + 1);
  if (lVar3 < 1) {
    ...
    *(int *)(uVar4 + 3) = (int)param_1;
    if (((((uint)*(undefined8 *)((uVar4 & 0xfffffffffffc0000) + 8) >> 2 & 1) != 0) &&
      ...
      FUN_0133eb00(uVar4,uVar4 + 3,0,2);
                    ...
                    /* WARNING: Could not recover jumptable at 0x01448230. Too many branches */
  ...
  pcVar2 = (code *)SoftwareBreakpoint(0,0x1448238);
  (*pcVar2)();
}
