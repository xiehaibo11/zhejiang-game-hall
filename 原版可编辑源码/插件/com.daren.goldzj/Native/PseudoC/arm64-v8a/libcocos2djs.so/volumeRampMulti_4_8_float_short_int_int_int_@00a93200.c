...
/* void cocos2d::volumeRampMulti<4, 8, float, short, int, int, int>(float*, unsigned long, short
   const*, int*, int*, int const*, int*, int) */

void cocos2d::volumeRampMulti<4,8,float,short,int,int,int>
...

{
  ...
  float fVar17;
                    ...
                    /* try { // try from 00a93200 to 00b9322f has its CatchHandler @ 00a93200
                       catch() { ... } // from try @ 00a93200 with catch @ 00a93200
                       catch() { ... } // from try @ 00a93234 with catch @ 00a93200 */
  if (param_4 == (int *)0x0) {
    iVar4 = *param_5;
    do {
    ...
    do {
      ...
      auVar8 = NEON_scvtf(auVar7,4);
                    /* try { // try from 00a93230 to 00b93233 has its CatchHandler @ 00a93240 */
                    /* try { // try from 00a93234 to 00b93253 has its CatchHandler @ 00a93200 */
      param_1[2] = auVar8._8_4_ * fVar17 * 1.1368684e-13;
      param_1[3] = auVar8._12_4_ * fVar17 * 1.1368684e-13;
      *param_1 = auVar8._0_4_ * fVar17 * 1.1368684e-13;
      param_1[1] = auVar8._4_4_ * fVar17 * 1.1368684e-13;
      uVar6 = *(undefined8 *)(param_3 + 4);
                    /* catch() { ... } // from try @ 00a93230 with catch @ 00a93240 */
