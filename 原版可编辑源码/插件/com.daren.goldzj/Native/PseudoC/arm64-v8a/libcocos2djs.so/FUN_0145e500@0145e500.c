...
void FUN_0145e500(undefined8 param_1)

{
  ...
  *(int *)(unaff_x29 + -0x20) = ((int)unaff_x19 + -1) * 2;
  FUN_0137e420(*(undefined8 *)(unaff_x29 + -8),iVar1 * 2,uVar2,param_1,lVar3);
                    /* WARNING: Could not recover jumptable at 0x0145e5b8. Too many branches */
