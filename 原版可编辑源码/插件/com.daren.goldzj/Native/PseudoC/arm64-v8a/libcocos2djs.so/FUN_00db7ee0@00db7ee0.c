...
ushort FUN_00db7ee0(undefined8 *param_1,undefined8 param_2,long *param_3,ulong *param_4)
  ...
  if ((*(uint *)(param_1 + 2) >> 0x13 & 1) == 0) {
    if (((lVar1 < 0x7ffffffffffffffe) && (lVar2 = lVar1 + 2, 1 < lVar2)) &&
      ...
      if (local_44[0] < 0x1001) {
        lVar1 = 0xc;
        if (local_44[0] == 0) goto LAB_00db8204;
        goto LAB_00db7ff4;
      }
LAB_00db81bc:
      uVar3 = param_1[0x77];
    ...
    if (0x1000 < CONCAT44(uStack_54,local_58)) goto LAB_00db81bc;
    lVar1 = 0x14;
    local_44[0] = (ushort)local_58;
...
LAB_00db7ff4:
    ...
    if (param_4 != (ulong *)0x0) {
      ...
      if ((uVar6 >> 0x13 & 1) != 0) {
        ...
        if ((uVar6 >> 7 & 1) == 0) goto LAB_00db82c4;
        goto LAB_00db82bc;
      }
      ...
      if ((uVar6 >> 7 & 1) != 0) goto LAB_00db8158;
      goto LAB_00db8160;
    }
    goto LAB_00db82c4;
  }
