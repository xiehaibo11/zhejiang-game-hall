...
/* unsigned int
   std::__ndk1::__sort4<v8::internal::EnumIndexComparator<v8::internal::GlobalDictionary>&,
   v8::internal::AtomicSlot>(v8::internal::AtomicSlot, v8::internal::AtomicSlot,
   v8::internal::AtomicSlot, v8::internal::AtomicSlot,
...

{
  ...
  uVar3 = __sort3<v8::internal::EnumIndexComparator<v8::internal::GlobalDictionary>&,v8::internal::AtomicSlot>
                    ();
  uVar4 = *param_5 & 0xffffffff00000000;
  lVar1 = *param_5 + 7;
  if (*(uint *)((uVar4 | *(uint *)(lVar1 + (int)((*param_4 & 0x7ffffffe) * 2 + 0x14))) + 7) >> 9 <
    ...
    *param_4 = uVar2;
    ...
    if (*(uint *)((uVar4 | *(uint *)(lVar1 + (int)((*param_3 & 0x7ffffffe) * 2 + 0x14))) + 7) >> 9 <
        *(uint *)((uVar4 | *(uint *)(lVar1 + (int)((*param_2 & 0x7ffffffe) * 2 + 0x14))) + 7) >> 9)
    {
      uVar2 = *param_2;
      *param_2 = *param_3;
      *param_3 = uVar2;
      uVar4 = *param_5 & 0xffffffff00000000;
      lVar1 = *param_5 + 7;
      if (*(uint *)((uVar4 | *(uint *)(lVar1 + (int)((*param_2 & 0x7ffffffe) * 2 + 0x14))) + 7) >> 9
          < *(uint *)((uVar4 | *(uint *)(lVar1 + (int)((*param_1 & 0x7ffffffe) * 2 + 0x14))) + 7) >>
            9) {
        uVar2 = *param_1;
        uVar3 = uVar3 + 3;
        *param_1 = *param_2;
