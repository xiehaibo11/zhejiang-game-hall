...
/* js_dragonBones_ArmatureCacheMgr_finalizeRegistry(void*) */

void js_dragonBones_ArmatureCacheMgr_finalizeRegistry(void *param_1)
  ...
  *this_00;
  ...
  if (param_1 != (void *)0x0) {
    ...
    if (lVar4 != lVar5) {
      ...
      this_00 = (Map<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,dragonBones::ArmatureCache*>
