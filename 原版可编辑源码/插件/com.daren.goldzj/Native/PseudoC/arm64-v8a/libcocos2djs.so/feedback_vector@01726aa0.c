...
/* v8::internal::compiler::JSFunctionRef::feedback_vector() const */

undefined1  [16] __thiscall
v8::internal::compiler::JSFunctionRef::feedback_vector(JSFunctionRef *this)

{
  ...
  if (*(int *)(*(undefined8 **)this + 1) == 2) {
    ...
    uVar8 = uVar8 | *(uint *)((uVar8 | *(uint *)(uVar7 + 0x13)) + 3);
  ...
  if (*(int *)(puVar6 + 1) == 2) {
    uVar7 = *(ulong *)*puVar6;
    if ((uVar7 & 1) == 0) goto LAB_01726be4;
    sVar1 = *(short *)((uVar7 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar7 - 1));
  }
  else {
    if (*(int *)(puVar6 + 1) == 0) goto LAB_01726be4;
