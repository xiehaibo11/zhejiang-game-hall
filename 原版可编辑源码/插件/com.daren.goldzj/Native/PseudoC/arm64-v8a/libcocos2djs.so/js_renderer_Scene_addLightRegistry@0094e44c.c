...
/* js_renderer_Scene_addLightRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_Scene_addLightRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Scene *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xc57,"js_renderer_Scene_addLight");
    __android_log_print(6,"jswrapper","js_renderer_Scene_addLight : Invalid Native Object");
  }
  else {
    ...
    if (puVar4[1] - (long)pVVar5 == 0x10) {
      if (pVVar5[8] == (Value)0x5) {
        ...
        if (pLVar6 != (Light *)0x0) {
LAB_0094e5a0:
          cocos2d::renderer::Scene::addLight(this,pLVar6);
          goto LAB_0094e61c;
        }
      }
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                          ,0xc5e,"js_renderer_Scene_addLight");
      __android_log_print(6,"jswrapper","js_renderer_Scene_addLight : Error processing arguments");
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 3170): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(puVar4[1] - (long)pVVar5) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_Scene_addLight",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0xc65);
LAB_0094e61c:
