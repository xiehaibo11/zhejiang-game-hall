...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<v8::internal::Handle<v8::internal::Module>,
   ...
   v8::internal::UnorderedStringSet*> > >::__rehash(unsigned long) */
      ...
      if (plVar6 != (long *)0x0) {
        do {
          ...
          if ((uVar12 & 0xffffffff) < 2) {
            uVar7 = uVar7 & uVar3;
LAB_0112f588:
            if (uVar7 == uVar4) goto LAB_0112f550;
LAB_0112f590:
            plVar9 = plVar6;
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) goto LAB_0112f5f4;
            do {
              plVar8 = plVar9;
              plVar9 = (long *)*plVar8;
            ...
            **(undefined8 **)(*(long *)this + uVar7 * 8) = plVar6;
            ...
            if (uVar7 < param_1) goto LAB_0112f588;
            uVar1 = 0;
            if (param_1 != 0) {
              uVar1 = uVar7 / param_1;
            }
            uVar7 = uVar7 - uVar1 * param_1;
            if (uVar7 != uVar4) goto LAB_0112f590;
LAB_0112f550:
            plVar9 = (long *)*plVar6;
            plVar5 = plVar6;
          }
