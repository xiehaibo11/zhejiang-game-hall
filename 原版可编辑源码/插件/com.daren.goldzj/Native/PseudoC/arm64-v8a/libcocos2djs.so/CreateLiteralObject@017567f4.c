...
/* v8::internal::compiler::JSOperatorBuilder::CreateLiteralObject(v8::internal::Handle<v8::internal::ObjectBoilerplateDescription>,
   v8::internal::compiler::FeedbackSource const&, int, int) */

Operator * __thiscall
v8::internal::compiler::JSOperatorBuilder::CreateLiteralObject
...

{
  ...
  Operator::Operator(pOVar2,0x2e2,0,"JSCreateLiteralObject",0,1,1,1,1,2);
  *(undefined8 *)(pOVar2 + 0x30) = param_2;
  *(undefined ***)pOVar2 = &PTR__Operator_01ccfe98;
  *(undefined4 *)(pOVar2 + 0x48) = param_5;
