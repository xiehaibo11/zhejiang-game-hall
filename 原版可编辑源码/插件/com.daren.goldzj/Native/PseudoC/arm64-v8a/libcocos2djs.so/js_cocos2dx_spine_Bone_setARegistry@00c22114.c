...
/* js_cocos2dx_spine_Bone_setARegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_setARegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Bone *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x925,"js_cocos2dx_spine_Bone_setA");
    pcVar6 = "js_cocos2dx_spine_Bone_setA : Invalid Native Object";
LAB_00c22288:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::Bone::setA(this,local_64);
        goto LAB_00c222c0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x92c,"js_cocos2dx_spine_Bone_setA");
      pcVar6 = "js_cocos2dx_spine_Bone_setA : Error processing arguments";
      goto LAB_00c22288;
    }
    __android_log_print(6,"jswrapper",&DAT_018f876d,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_setA",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x933);
LAB_00c222c0:
