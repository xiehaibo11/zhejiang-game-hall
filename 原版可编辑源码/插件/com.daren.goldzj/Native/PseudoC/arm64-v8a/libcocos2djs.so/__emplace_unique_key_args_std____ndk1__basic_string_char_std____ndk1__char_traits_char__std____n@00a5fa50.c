...

{
  ...
  long local_68;
                    ...
                    /* catch() { ... } // from try @ 00a5f75c with catch @ 00a5fa54 */
                    /* catch() { ... } // from try @ 00a5f750 with catch @ 00a5fa58 */
                    /* catch() { ... } // from try @ 00a5f7a0 with catch @ 00a5fa5c
                       catch() { ... } // from try @ 00a5f870 with catch @ 00a5fa5c */
  lVar3 = tpidr_el0;
                    /* catch() { ... } // from try @ 00a5f730 with catch @ 00a5fa74 */
  local_68 = *(long *)(lVar3 + 0x28);
                    /* catch() { ... } // from try @ 00a5f768 with catch @ 00a5fa84
                       catch() { ... } // from try @ 00a5f804 with catch @ 00a5fa84
                       catch() { ... } // from try @ 00a5f9a4 with catch @ 00a5fa84 */
  ...
  if (pbVar13 != (basic_string *)0x0) {
    ...
    if ((puVar7 != (undefined8 *)0x0) && (plVar11 = (long *)*puVar7, plVar11 != (long *)0x0)) {
                    /* try { // try from 00a5fb08 to 00b5fb1b has its CatchHandler @ 00a5fe14 */
      ...
      do {
        pbVar8 = (basic_string *)plVar11[1];
                    /* try { // try from 00a5fb20 to 00b5fb2f has its CatchHandler @ 00a5fe0c */
        if (pbVar8 != pbVar5) {
          if (((ulong)pbVar12 & (ulong)pbVar13) == 0) {
            pbVar8 = (basic_string *)((ulong)pbVar8 & (ulong)pbVar12);
          }
          else {
                    /* try { // try from 00a5fb30 to 00b5fb53 has its CatchHandler @ 00a5fdfc */
            if (pbVar13 <= pbVar8) {
              uVar9 = 0;
              if (pbVar13 != (basic_string *)0x0) {
                uVar9 = (ulong)pbVar8 / (ulong)pbVar13;
              }
              if (pbVar8 + -(uVar9 * (long)pbVar13) == unaff_x28) goto LAB_00a5fb54;
              break;
            }
          }
...
LAB_00a5fb54:
        bVar2 = *(byte *)(plVar11 + 2);
                    /* try { // try from 00a5fb5c to 00b5fb67 has its CatchHandler @ 00a5fe1c */
        sVar1 = (ulong)(bVar2 >> 1);
        if ((bVar2 & 1) != 0) {
          sVar1 = plVar11[3];
        }
        if (sVar1 == __n) {
          ...
          if ((bVar2 & 1) == 0) {
            if (__n != 0) {
              uVar9 = 0;
                    /* try { // try from 00a5fb8c to 00b5fb9b has its CatchHandler @ 00a5fde4 */
              while (*(basic_string *)((long)plVar11 + uVar9 + 0x11) == __s2[uVar9]) {
                uVar9 = uVar9 + 1;
                if (bVar2 >> 1 == uVar9) goto LAB_00a5fbdc;
              }
              goto LAB_00a5fbcc;
            }
          }
          else {
                    /* try { // try from 00a5fbb0 to 00b5fc8f has its CatchHandler @ 00a5fe1c */
            if (__n != 0) {
              uVar4 = memcmp(__s1,__s2,__n);
              __s1 = (void *)(ulong)uVar4;
              if (uVar4 != 0) goto LAB_00a5fbcc;
            }
          }
LAB_00a5fbdc:
          uVar6 = 0;
...
LAB_00a5fbcc:
  ...
  __s1 = (void *)__construct_node_hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>&,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>&>
      ...
      if (pbVar13 <= pbVar5) {
        ...
        if (pbVar13 != (basic_string *)0x0) {
          uVar9 = (ulong)pbVar5 / (ulong)pbVar13;
                    ...
                    /* try { // try from 00a5fc90 to 00b5fc97 has its CatchHandler @ 00a5fddc */
        unaff_x28 = pbVar5 + -(uVar9 * (long)pbVar13);
      }
    }
  }
                    /* try { // try from 00a5fc98 to 00b5fd9f has its CatchHandler @ 00a5fe24 */
