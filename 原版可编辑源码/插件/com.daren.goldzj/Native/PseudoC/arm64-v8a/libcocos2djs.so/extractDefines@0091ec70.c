...
/* cocos2d::renderer::Pass::extractDefines(unsigned long&,
...
void __thiscall cocos2d::renderer::Pass::extractDefines(Pass *this,ulong *param_1,vector *param_2)

{
  ...
  if (*(Pass **)(this + 0x30) != (Pass *)0x0) {
    extractDefines(*(Pass **)(this + 0x30),param_1,param_2);
  }
  MathUtil::combineHash(param_1,(ulong *)(this + 0x78));
  local_40 = this + 0x60;
  if (*(long **)(param_2 + 8) < *(long **)(param_2 + 0x10)) {
    **(long **)(param_2 + 8) = (long)local_40;
