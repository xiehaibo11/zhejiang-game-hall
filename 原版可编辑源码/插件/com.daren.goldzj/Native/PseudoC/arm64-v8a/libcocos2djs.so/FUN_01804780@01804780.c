...
long * FUN_01804780(long *param_1,long param_2,long param_3,long param_4,long param_5,
                   wchar_t param_6)

{
  ...
  if (param_1 == (long *)0x0) goto LAB_018048fc;
  ...
  if ((param_3 - param_2 < 1) ||
    ...
    if (0 < (long)__n) {
      ...
      if (__n < 5) {
        ...
        uVar2 = __n + 4 & 0xfffffffffffffffc;
      ...
      if (uVar2 != __n) goto LAB_018048f8;
    }
