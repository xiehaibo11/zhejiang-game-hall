...

{
  ...
  uVar3 = uVar8 & uVar2;
                    /* try { // try from 00a05c78 to 00b05c7b has its CatchHandler @ 00a05cc4 */
  if (uVar3 == 0) {
    uVar1 = uVar8 & uVar6;
  }
  ...
  if (plVar7 != param_2 + 2) {
    ...
    if (uVar6 == uVar1) goto LAB_00a05d08;
  }
  if (*param_3 != 0) {
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00a05c78 with catch @ 00a05cc4
                        */
...
LAB_00a05d08:
  ...
  *plVar7 = *param_3;
  *param_3 = 0;
                    /* try { // try from 00a05d4c to 00b05d77 has its CatchHandler @ 00a05d4c
                       catch() { ... } // from try @ 00a05d4c with catch @ 00a05d4c
                       catch() { ... } // from try @ 00a05d7c with catch @ 00a05d4c */
