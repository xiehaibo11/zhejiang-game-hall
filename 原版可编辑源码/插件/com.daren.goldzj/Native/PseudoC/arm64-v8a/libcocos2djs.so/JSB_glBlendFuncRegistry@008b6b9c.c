...
/* JSB_glBlendFuncRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glBlendFuncRegistry(FunctionCallbackInfo *param_1)
  ...
  if ((plVar6[1] - *plVar6 & 0xffffffff0U) == 0x20) {
    ...
    if ((uVar3 & uVar4 & 1) == 0) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0x2dc,"JSB_glBlendFunc");
      __android_log_print(6,"jswrapper",&DAT_0190552e);
    }
    else {
      if ((1 < (local_68 - 0x8003 | uStack_64 - 0x8001)) &&
         (1 < (local_68 - 0x8001 | uStack_64 - 0x8003))) {
        glBlendFunc();
        goto LAB_008b6d98;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                          ,0x2e1,"JSB_glBlendFunc");
      DAT_01d36f40 = 0x502;
    }
  }
  else {
