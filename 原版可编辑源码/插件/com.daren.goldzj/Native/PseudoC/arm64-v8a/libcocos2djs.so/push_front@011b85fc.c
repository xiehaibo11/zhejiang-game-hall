...
/* std::__ndk1::__split_buffer<v8::AllocationProfile::Node*,
   std::__ndk1::allocator<v8::AllocationProfile::Node*>&>::push_front(v8::AllocationProfile::Node*
   const&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_011b8788;
...
LAB_011b875c:
      ...
      if (((void *)((long)pvVar4 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar4 + uVar9 + uVar13 * 8 + 8))) goto LAB_011b875c;
      ...
      puVar7 = puVar8;
      if (uVar2 != uVar9) goto LAB_011b875c;
    }
