...
/* void 
   v8::internal::Heap::CreateFillerForArray<v8::internal::WeakFixedArray>(v8::internal::WeakFixedArray,
   int, int) */

void __thiscall
v8::internal::Heap::CreateFillerForArray<v8::internal::WeakFixedArray>
