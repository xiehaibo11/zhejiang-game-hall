...
ulong * v8::Date::New(double param_1,long param_2)
  ...
  if ((*(int *)(pIVar7 + 0x2c20) == (int)uVar9) ||
    ...
    *local_48 = uVar9;
    ...
    if (internal::TracingFlags::runtime_stats != 0) {
      ...
      internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x367);
    }
    this = *(Logger **)(pIVar7 + 0x9558);
    uVar9 = internal::Logger::is_logging(this);
    if ((uVar9 & 1) != 0) {
      internal::Logger::ApiEntryCall(this,"v8::Date::New");
    }
    ...
    *(undefined4 *)(pIVar7 + 0x2c60) = 5;
    ...
    puVar3 = (ulong *)internal::JSDate::New(dVar10,puVar8,puVar3);
    puVar8 = local_48;
    if (puVar3 == (ulong *)0x0) {
      local_a0 = '\x01';
...
LAB_00ec42b0:
        ...
        if (*(code **)(lVar4 + 0xb738) == (code *)0x0) goto LAB_00ec42b0;
