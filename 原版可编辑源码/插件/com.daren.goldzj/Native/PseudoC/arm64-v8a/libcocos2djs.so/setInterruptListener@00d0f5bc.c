...
/* spine::SkeletonAnimation::setInterruptListener(std::__ndk1::function<void (spine::TrackEntry*)>
   const&) */
...

{
  ...
  FUN_00c8c388(alStack_60,this + 0xf0);
  if (alStack_60 == local_40) {
    pcVar3 = *(code **)(*local_40 + 0x20);
  }
  else {
    if (local_40 == (long *)0x0) goto LAB_00d0f660;
