...
/* js_cocos2dx_spine_SwirlVertexEffect_setAngleRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_spine_SwirlVertexEffect_setAngleRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SwirlVertexEffect *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x30bd,"js_cocos2dx_spine_SwirlVertexEffect_setAngle");
    pcVar6 = "js_cocos2dx_spine_SwirlVertexEffect_setAngle : Invalid Native Object";
LAB_00c6d6cc:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::SwirlVertexEffect::setAngle(this,local_64);
        goto LAB_00c6d704;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x30c4,"js_cocos2dx_spine_SwirlVertexEffect_setAngle");
      pcVar6 = "js_cocos2dx_spine_SwirlVertexEffect_setAngle : Error processing arguments";
      goto LAB_00c6d6cc;
    }
    __android_log_print(6,"jswrapper",&DAT_0191bc03,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SwirlVertexEffect_setAngle",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x30cb);
LAB_00c6d704:
