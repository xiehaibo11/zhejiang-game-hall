...
void FUN_00dff6cc(byte *param_1,byte *param_2,byte *param_3,byte *param_4,uint param_5)

{
  ...
  auVar26 = _DAT_01970c70;
  auVar25 = _DAT_01970c60;
  auVar24 = _DAT_01970c50;
  auVar23 = _DAT_01970c10;
  auVar22 = _DAT_01970bf0;
  pbVar3 = param_4;
  pbVar5 = param_3;
  pbVar4 = param_2;
  pbVar2 = param_1;
  if ((param_5 & 0xfffffffe) != 0) {
    ...
    if ((7 < uVar1) && (uVar46 = uVar1 & 0x7ffffffffffffff8, uVar46 != 0)) {
      ...
      if ((param_1 + uVar45 * 2 + 2 <= param_4 || pbVar2 <= param_1) &&
        ...
        if (uVar1 == uVar46) goto joined_r0x00dffd00;
      }
    }
    do {
      bVar47 = *param_3;
