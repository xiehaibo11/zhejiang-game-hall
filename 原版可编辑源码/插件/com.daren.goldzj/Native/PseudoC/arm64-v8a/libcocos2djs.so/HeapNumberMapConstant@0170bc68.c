...
/* v8::internal::compiler::JSGraph::HeapNumberMapConstant() */

void __thiscall v8::internal::compiler::JSGraph::HeapNumberMapConstant(JSGraph *this)

{
  ...
  if (*(long *)(this + 0x1e8) == 0) {
    local_38 = *(long *)(this + 0x168) + 0x140;
