...
/* v8::internal::compiler::EffectControlLinearizer::LowerCheckedInt32Sub(v8::internal::compiler::Node*,
   v8::internal::compiler::Node*) */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerCheckedInt32Sub
...

{
  ...
  pNVar2 = (Node *)GraphAssembler::Int32SubWithOverflow
