...
/* void std::__ndk1::vector<v8::internal::ProfileNode*,
   std::__ndk1::allocator<v8::internal::ProfileNode*>
   >::__push_back_slow_path<v8::internal::ProfileNode* const&>(v8::internal::ProfileNode* const&) */

void __thiscall
std::__ndk1::vector<v8::internal::ProfileNode*,std::__ndk1::allocator<v8::internal::ProfileNode*>>::
...

{
  ...
  if (uVar1 >> 0x3d == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3d != 0) goto LAB_011b1594;
