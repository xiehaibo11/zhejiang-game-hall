...
/* std::__ndk1::__hash_table<std::__ndk1::__hash_value_type<void*, bool>,
   std::__ndk1::__unordered_map_hasher<void*, std::__ndk1::__hash_value_type<void*, bool>,
   std::__ndk1::hash<void*>, true>, std::__ndk1::__unordered_map_equal<void*,
   std::__ndk1::__hash_value_type<void*, bool>, std::__ndk1::equal_to<void*>, true>,
   std::__ndk1::allocator<std::__ndk1::__hash_value_type<void*, bool> > >::__rehash(unsigned long)
    */
...
::__rehash(__hash_table<std::__ndk1::__hash_value_type<void*,bool>,std::__ndk1::__unordered_map_hasher<void*,std::__ndk1::__hash_value_type<void*,bool>,std::__ndk1::hash<void*>,true>,std::__ndk1::__unordered_map_equal<void*,std::__ndk1::__hash_value_type<void*,bool>,std::__ndk1::equal_to<void*>,true>,std::__ndk1::allocator<std::__ndk1::__hash_value_type<void*,bool>>>
           *this,ulong param_1)
...
joined_r0x0090405c:
      if (plVar7 != (long *)0x0) {
        do {
          ...
          if ((uVar6 & param_1) == 0) {
            uVar8 = uVar8 & uVar6;
            if (uVar8 != uVar4) goto LAB_009040a0;
LAB_00904064:
            plVar10 = (long *)*plVar7;
            plVar5 = plVar7;
          }
            ...
            if (uVar8 == uVar4) goto LAB_00904064;
LAB_009040a0:
            plVar10 = plVar7;
            if (*(long *)(*(long *)this + uVar8 * 8) == 0) goto LAB_009040fc;
            do {
              plVar9 = plVar10;
              plVar10 = (long *)*plVar9;
