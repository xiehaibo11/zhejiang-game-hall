...
/* void std::__ndk1::vector<v8::internal::SourceChangeRange,
   std::__ndk1::allocator<v8::internal::SourceChangeRange>
   >::__emplace_back_slow_path<v8::internal::SourceChangeRange>(v8::internal::SourceChangeRange&&)
    */
...
__emplace_back_slow_path<v8::internal::SourceChangeRange>
          (vector<v8::internal::SourceChangeRange,std::__ndk1::allocator<v8::internal::SourceChangeRange>>
           *this,SourceChangeRange *param_1)

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_00f16efc;
