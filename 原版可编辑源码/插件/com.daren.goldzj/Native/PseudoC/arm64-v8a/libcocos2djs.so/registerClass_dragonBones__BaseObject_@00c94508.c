...
/* void JSBClassType::registerClass<dragonBones::BaseObject>(se::Class*) */

void JSBClassType::registerClass<dragonBones::BaseObject>(Class *param_1)
