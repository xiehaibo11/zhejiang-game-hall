...
/* v8::Set::Has(v8::Local<v8::Context>, v8::Local<v8::Value>) */

undefined8 __thiscall v8::Set::Has(Set *this,long param_2,undefined8 param_3)

{
  ...
  *(int *)pIVar15 = *(int *)pIVar15 + 1;
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x3cf);
  }
  this_00 = *(Logger **)(pIVar10 + 0x9558);
  uVar3 = internal::Logger::is_logging(this_00);
  if ((uVar3 & 1) != 0) {
    internal::Logger::ApiEntryCall(this_00,"v8::Set::Has");
  }
