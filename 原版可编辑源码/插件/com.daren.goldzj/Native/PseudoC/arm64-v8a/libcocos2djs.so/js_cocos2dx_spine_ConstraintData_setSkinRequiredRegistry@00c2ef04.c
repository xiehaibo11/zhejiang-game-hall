...
/* js_cocos2dx_spine_ConstraintData_setSkinRequiredRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_ConstraintData_setSkinRequiredRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (ConstraintData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1064,"js_cocos2dx_spine_ConstraintData_setSkinRequired");
    pcVar6 = "js_cocos2dx_spine_ConstraintData_setSkinRequired : Invalid Native Object";
LAB_00c2f074:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::ConstraintData::setSkinRequired(this,local_64[0]);
        goto LAB_00c2f0ac;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x106b,"js_cocos2dx_spine_ConstraintData_setSkinRequired");
      pcVar6 = "js_cocos2dx_spine_ConstraintData_setSkinRequired : Error processing arguments";
      goto LAB_00c2f074;
    }
    __android_log_print(6,"jswrapper",&DAT_018fe675,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_ConstraintData_setSkinRequired",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x1072);
LAB_00c2f0ac:
