...
/* js_cocos2dx_dragonbones_ArmatureData_set_nameRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_ArmatureData_set_nameRegistry
...

{
  ...
  if (lVar8 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x575,"js_cocos2dx_dragonbones_ArmatureData_set_name");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_ArmatureData_set_name : Invalid Native Object");
  }
  else {
    local_88 = 0;
    local_80 = 0;
    ...
    if ((uVar9 & 1) == 0) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                          ,0x57a,"js_cocos2dx_dragonbones_ArmatureData_set_name");
      __android_log_print(6,"jswrapper",&DAT_01930a78);
      bVar3 = false;
    }
    else {
    ...
    if (bVar3) goto LAB_00c9e2a8;
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_ArmatureData_set_name",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x57e);
LAB_00c9e2a8:
