  ...
  if (param_1 != (int *)0x0) {
    ...
    if ((-1 < iVar2) && (iVar2 != 0x7fffffff)) {
      uVar6 = *(ulong *)(param_1 + 6);
                    /* try { // try from 00b5484c to 00c54853 has its CatchHandler @ 00b548bc */
      uVar1 = (long)iVar2 + 1;
      iVar7 = iVar2;
      iVar5 = iVar2;
      if (uVar6 <= uVar1) {
        if (uVar6 << 1 < uVar6) {
          return 0;
                    ...
                    /* try { // try from 00b5489c to 00c54ab7 has its CatchHandler @ 00b54760 */
        if ((uVar6 & 0x7fffffffffffffff) >> 0x3c != 0) {
          return 0;
        }
                    /* catch() { ... } // from try @ 00b5484c with catch @ 00b548bc */
        ...
        *(void **)(param_1 + 2) = pvVar4;
                    /* catch() { ... } // from try @ 00b54870 with catch @ 00b548cc */
      ...
      *param_1 = iVar5;
                    /* try { // try from 00b54870 to 00c5489b has its CatchHandler @ 00b548cc */
      param_1[4] = 0;
    }
  }
  return iVar5;
