...
/* void JSBClassType::registerClass<dragonBones::BoundingBoxData>(se::Class*) */

void JSBClassType::registerClass<dragonBones::BoundingBoxData>(Class *param_1)
