...
/* v8::internal::interpreter::BytecodeArrayBuilder::JumpIfNull(v8::internal::interpreter::BytecodeLabel*)
    */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::JumpIfNull
