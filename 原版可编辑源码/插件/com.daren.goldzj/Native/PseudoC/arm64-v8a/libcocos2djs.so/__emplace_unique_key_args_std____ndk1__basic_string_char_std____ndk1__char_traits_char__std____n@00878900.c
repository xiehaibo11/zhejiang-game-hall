      ...
      do {
        ...
        if (uVar10 != uVar7) {
          if ((uVar16 & uVar15) == 0) {
            ...
            if (uVar10 - uVar4 * uVar15 == unaff_x27) goto LAB_008789fc;
            break;
          }
          ...
          if ((bVar3 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(piecewise_construct_t *)((long)plVar14 + uVar10 + 0x11) == ppVar2[uVar10]) {
                uVar10 = uVar10 + 1;
                if (bVar3 >> 1 == uVar10) goto LAB_00878b14;
              }
              goto LAB_00878a6c;
            }
          }
...
LAB_00878a6c:
  ...
  __s1 = (void *)pair<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const,cocos2d::Value>
                 ::
  ...
  *plVar14 = 0;
  ...
  if (plVar11 == (long *)0x0) {
    ...
    *(basic_string **)(lVar13 + unaff_x27 * 8) = pbVar12;
    if (*plVar14 == 0) goto LAB_00878b98;
