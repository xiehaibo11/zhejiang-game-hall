...
/* std::__ndk1::__split_buffer<v8::internal::compiler::HandlerRangeMatcher::Range*,
   std::__ndk1::allocator<v8::internal::compiler::HandlerRangeMatcher::Range*>&>::push_front(v8::internal::compiler::HandlerRangeMatcher::Range*
   const&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_012ced88;
...
LAB_012ced5c:
      ...
      if (((void *)((long)pvVar4 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar4 + uVar9 + uVar13 * 8 + 8))) goto LAB_012ced5c;
      ...
      puVar7 = puVar8;
      if (uVar2 != uVar9) goto LAB_012ced5c;
    }
