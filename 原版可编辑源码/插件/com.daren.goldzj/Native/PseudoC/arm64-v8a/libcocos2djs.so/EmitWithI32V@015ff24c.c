...
/* v8::internal::wasm::WasmFunctionBuilder::EmitWithI32V(v8::internal::wasm::WasmOpcode, int) */

void __thiscall
v8::internal::wasm::WasmFunctionBuilder::EmitWithI32V
          (WasmFunctionBuilder *this,undefined1 param_2,int param_3)

{
  ...
  *puVar3 = param_2;
  ZoneBuffer::write_i32v((ZoneBuffer *)(this + 0x40),param_3);
  return;
}
