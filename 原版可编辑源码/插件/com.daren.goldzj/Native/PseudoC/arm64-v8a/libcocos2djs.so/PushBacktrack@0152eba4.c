...
/* v8::internal::RegExpBytecodeGenerator::PushBacktrack(v8::internal::Label*) */

void __thiscall
v8::internal::RegExpBytecodeGenerator::PushBacktrack(RegExpBytecodeGenerator *this,Label *param_1)

{
  ...
  *(undefined4 *)(*(long *)(this + 0x28) + (long)iVar3) = 2;
  iVar3 = *(int *)(this + 0x38);
  pRVar1 = this + 0x3c;
