...
undefined8 FUN_00b68dd0(undefined8 *param_1,void *param_2,void *param_3,int param_4)

{
  ...
  iVar3 = FUN_00b695ac(param_2,param_3,param_4);
  if (-1 < iVar3) {
    uVar4 = FUN_00b68bb8(param_1,param_2,iVar3);
    return uVar4;
  }
  ...
  if (pAVar5 != (ASN1_VALUE *)0x0) {
    if (*(long *)pAVar5 == 0) {
      ...
      **(undefined8 **)(val + 8) = pAVar6;
      if (pAVar6 == (ASN1_BIT_STRING *)0x0) goto LAB_00b68ff0;
    ...
    if (lVar7 == 0) {
      pAVar6 = ASN1_BIT_STRING_new();
                    /* try { // try from 00b68ea4 to 00c68f13 has its CatchHandler @ 00b68ea4
                       catch() { ... } // from try @ 00b68ea4 with catch @ 00b68ea4
                       catch() { ... } // from try @ 00b68f68 with catch @ 00b68ea4 */
...
LAB_00b68ee8:
    ...
    if (iVar3 != 0) {
      ...
      *(ulong *)(lVar10 + 0x10) = uVar11;
                    /* try { // try from 00b68f14 to 00c68f1b has its CatchHandler @ 00b68ff8 */
      if (bVar2) {
        iVar3 = -8;
                    /* try { // try from 00b68f24 to 00c68f3f has its CatchHandler @ 00b68fc8 */
        do {
          uVar1 = iVar3 + 9;
          iVar3 = iVar3 + 1;
        ...
        *(ulong *)(lVar10 + 0x10) = uVar11 | (long)-iVar3;
                    ...
                    /* try { // try from 00b68f50 to 00c68f67 has its CatchHandler @ 00b68ff8 */
      lVar7 = lVar12 << 0x20;
      do {
        lVar10 = lVar12;
        lVar7 = lVar7 + -0x100000000;
        if (lVar10 < 1) {
          ...
          goto LAB_00b68f84;
                    ...
                    /* try { // try from 00b68f68 to 00c69013 has its CatchHandler @ 00b68ea4 */
        lVar12 = lVar10 + -1;
      ...
      if (iVar3 != 0) {
        ...
        *(ulong *)(lVar10 + 0x10) = uVar11;
        if (bVar2) {
          ...
          do {
            uVar1 = iVar3 + 9;
                    /* catch() { ... } // from try @ 00b68f24 with catch @ 00b68fc8 */
            iVar3 = iVar3 + 1;
...
LAB_00b68ff0:
                    /* catch() { ... } // from try @ 00b68f14 with catch @ 00b68ff8
                       catch() { ... } // from try @ 00b68f50 with catch @ 00b68ff8 */
