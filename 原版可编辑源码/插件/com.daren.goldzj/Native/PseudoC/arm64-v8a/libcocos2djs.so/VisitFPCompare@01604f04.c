...
/* v8::internal::DispatchingDecoderVisitor::VisitFPCompare(v8::internal::Instruction*) */

void __thiscall
v8::internal::DispatchingDecoderVisitor::VisitFPCompare
...

{
  ...
  for (pDVar1 = *(DispatchingDecoderVisitor **)(this + 0x10); this + 8 != pDVar1;
    ...
    (**(code **)(**(long **)(pDVar1 + 0x10) + 0x118))(*(long **)(pDVar1 + 0x10),param_1);
  }
  return;
}
