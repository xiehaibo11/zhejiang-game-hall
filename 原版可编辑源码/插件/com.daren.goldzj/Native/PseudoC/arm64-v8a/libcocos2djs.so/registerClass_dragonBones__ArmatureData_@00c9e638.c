...
/* void JSBClassType::registerClass<dragonBones::ArmatureData>(se::Class*) */

void JSBClassType::registerClass<dragonBones::ArmatureData>(Class *param_1)
