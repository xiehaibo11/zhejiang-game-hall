...
/* spine::CacheModeAttachUtil::syncAttachedNode(cocos2d::renderer::NodeProxy*,
   spine::SkeletonCache::FrameData*) */

void __thiscall
spine::CacheModeAttachUtil::syncAttachedNode
...

{
  ...
  *this_01;
  ...
  if (((DAT_01d3de10 & 1) == 0) && (iVar1 = __cxa_guard_acquire(&DAT_01d3de10), iVar1 != 0)) {
    cocos2d::Mat4::Mat4((Mat4 *)&DAT_01d3ddd0);
    __cxa_atexit(cocos2d::Mat4::~Mat4,&DAT_01d3ddd0,&PTR_LOOP_01d1b000);
    __cxa_guard_release(&DAT_01d3de10);
  }
  if ((param_1 != (NodeProxy *)0x0) && (this_00 = *(Ref **)(this + 0x28), this_00 != (Ref *)0x0)) {
    if (*(long *)(this_00 + 0x88) == 0) {
      ...
      *(undefined8 *)(this + 0x28) = 0;
      ...
      if ((int)(uVar5 >> 3) < 1) {
        ...
        if (this_02 != (NodeProxy *)0x0) goto LAB_00d1be70;
LAB_00d1bebc:
        iVar1 = (int)uVar7;
        if (uVar5 != uVar6) {
          while( true ) {
...
LAB_00d1be70:
            ...
            if (uVar6 < uVar2) {
              ...
              cocos2d::Mat4::multiply
                        (*(Mat4 **)(*(long *)(this + 0x28) + 0x98),pMVar3,(Mat4 *)&DAT_01d3ddd0);
              cocos2d::renderer::NodeProxy::updateWorldMatrix(this_02,(Mat4 *)&DAT_01d3ddd0);
            }
            else {
            ...
            iVar1 = (int)uVar6;
            if (uVar5 == uVar6) goto LAB_00d1bed8;
          }
          goto LAB_00d1bebc;
        }
LAB_00d1bed8:
