...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::TypeAssertionsPhase>() */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::TypeAssertionsPhase>
          (PipelineImpl *this)

{
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFTypeAssertions");
  TypeAssertionsPhase::Run(aTStack_18,pPVar5,pZVar2);
