...
void FUN_012466e8(long *param_1)

{
  ...
  uStack_40 = 0;
  local_50 = 0;
  pcStack_60 = "WebAssembly.Module.exports()";
  if ((int)param_1[2] < 1) {
  ...
  if (((uVar4 & 1) == 0) ||
    ...
    if (local_58 == 0) goto LAB_0124679c;
  }
  else {
    if ((int)param_1[2] < 1) {
      if (*(long *)(lVar3 + 8) == -0xa0) goto LAB_0124679c;
    }
    else if (param_1[1] == 0) {
LAB_0124679c:
    ...
    puVar2 = (undefined8 *)v8::internal::wasm::GetExports();
