...
/* JSB_glGetProgramParameterRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glGetProgramParameterRegistry(FunctionCallbackInfo *param_1)
  ...
  if ((plVar5[1] - *plVar5 & 0xffffffff0U) == 0x20) {
    ...
    if ((byte)pVVar6[8] < 2) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0xcd1,"JSB_glGetProgramParameter");
      ...
      if (pVVar6[8] == (Value)0x5) {
        ...
        if ((lVar7 != 0 & bVar3) != 0) {
          glGetProgramiv(*(undefined4 *)(lVar7 + 0xc),local_64,&local_68);
          if ((local_64 - 0x8b85 < 5) && ((1 << (ulong)(local_64 - 0x8b85 & 0x1f) & 0x13U) != 0)) {
            pVVar6 = (Value *)se::State::rval(aSStack_60);
            se::Value::setInt32(pVVar6,local_68);
          }
          else {
            pVVar6 = (Value *)se::State::rval(aSStack_60);
            if ((local_64 - 0x8b80 < 4) && (local_64 - 0x8b80 != 1)) {
              se::Value::setBoolean(pVVar6,0 < local_68);
            }
            else {
              se::Value::setNull(pVVar6);
            }
      ...
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                          ,0xcd4,"JSB_glGetProgramParameter");
      __android_log_print(6,"jswrapper",&DAT_0190552e);
    }
  }
  else {
