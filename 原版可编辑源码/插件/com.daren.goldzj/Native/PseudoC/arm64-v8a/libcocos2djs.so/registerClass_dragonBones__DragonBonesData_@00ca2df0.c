...
/* void JSBClassType::registerClass<dragonBones::DragonBonesData>(se::Class*) */

void JSBClassType::registerClass<dragonBones::DragonBonesData>(Class *param_1)
