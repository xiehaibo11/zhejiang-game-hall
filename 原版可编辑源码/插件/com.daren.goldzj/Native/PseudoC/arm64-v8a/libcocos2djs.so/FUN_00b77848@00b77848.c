...
undefined8 FUN_00b77848(byte *param_1,byte *param_2,byte *param_3,byte *param_4,uint param_5)

{
  ...
  if (param_4 < (byte *)0x2) {
    if (param_2 != (byte *)0x0) goto LAB_00b77898;
  }
...
LAB_00b77898:
    ...
    do {
      ...
      if (bVar1 == 0x2a) {
        ...
        if ((pbVar9 != (byte *)0x0) || (bVar2 || iVar5 != 0)) goto LAB_00b77aec;
        ...
        if ((bVar12 & 1) != 0) goto LAB_00b77aec;
        bVar12 = bVar12 | 4;
      }
      else {
        if ((bVar1 != 0x2e) || (bVar12 != 0)) goto LAB_00b77aec;
        iVar5 = iVar5 + 1;
        bVar12 = 1;
        bVar2 = false;
      }
...
LAB_00b77aec:
  ...
  if ((param_5 >> 0xf & 1) != 0) {
    ...
    if (pbVar9 == param_4) goto joined_r0x00b77b64;
  }
  pbVar14 = param_1;
  if (param_2 != param_4) {
    return 0;
