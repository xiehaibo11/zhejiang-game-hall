...
void cocos2d::JniHelper::callStaticVoidMethod<int,int>
               (basic_string *param_1,basic_string *param_2,int param_3,int param_4)

{
  ...
  getJNISignature<int,int>(param_3,param_4);
  ...
  *puVar5 = 0;
  ...
  if (((byte)local_b8[0] & 1) != 0) {
                    /* try { // try from 009d8138 to 00ad8183 has its CatchHandler @ 009d8138
                       catch() { ... } // from try @ 009d8138 with catch @ 009d8138
                       catch() { ... } // from try @ 009d824c with catch @ 009d8138
                       catch() { ... } // from try @ 009d8398 with catch @ 009d8138 */
  ...
  if ((uVar6 & 1) == 0) {
    reportError(param_1,param_2,(basic_string *)&local_a0);
                    ...
                    /* try { // try from 009d8184 to 00ad818b has its CatchHandler @ 009d83e8 */
                    /* try { // try from 009d8190 to 00ad824b has its CatchHandler @ 009d83ec */
    uStack_68 = 0;
    local_70 = (void *)0x0;
    uStack_58 = 0;
    local_60 = (void *)0x0;
    ...
    _JNIEnv::CallStaticVoidMethod
              (local_88,p_Stack_80,local_78,(ulong)(uint)param_3,(ulong)(uint)param_4);
  ...
  if (*(long *)(lVar2 + 0x28) == local_48) {
                    /* try { // try from 009d824c to 00ad82db has its CatchHandler @ 009d8138 */
    return;
  }
