...
void FUN_014434d8(long param_1,ulong param_2,undefined8 param_3,long param_4,undefined8 param_5,
  ...
  if ((int)uVar13 != (int)*(undefined8 *)(unaff_x26 + 0xc08)) {
      ...
      if (*(int *)(uVar13 - 1) == (int)*(undefined8 *)(unaff_x26 + 0x120)) {
        *(int *)(param_6 + -0x20) = (iVar8 + -1) * 2;
        ...
        (*pcVar9)(in_w10 * 2,uVar14,param_4,param_7);
                    /* WARNING: Could not recover jumptable at 0x01443628. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (**(code **)(unaff_x21 + (ulong)*(byte *)(*(long *)(param_6 + -0x18) + unaff_x19 + 5) * 8))
                  ();
        return;
      }
      lVar18 = unaff_x26 + (ulong)*(uint *)(uVar13 + 7);
      if (((int)lVar18 != 0) && (*(int *)(lVar18 + 3) != 0)) goto FUN_01444140;
      uVar16 = unaff_x26 + (ulong)*(uint *)(uVar13 + 3);
      uVar1 = unaff_x26 + (ulong)*(uint *)(uVar13 + 0xb);
      if ((uVar1 & 1) == 0) {
                    /* WARNING: Could not recover jumptable at 0x014435b4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + unaff_x19 + 5) * 8))(uVar1);
        return;
      }
      if ((int)uVar1 != (int)*(undefined8 *)(unaff_x26 + 0xb0)) {
        if ((int)uVar1 == 3) goto FUN_01444140;
    ...
    if (uVar17 == 4) {
      ...
      if ((uVar15 >> 6 & 1) == 0) {
        ...
        if (bVar10) {
                    /* WARNING: Could not recover jumptable at 0x01444068. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + unaff_x19 + 5) * 8))();
          return;
        }
        if (((param_2 & 1) != 0) &&
...
LAB_014440d0:
          ...
          *(undefined8 *)(lVar18 + 3) = uVar11;
                    /* WARNING: Could not recover jumptable at 0x0144413c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + unaff_x19 + 5) * 8))();
          return;
        }
        ...
        if (bVar10) {
                    /* WARNING: Could not recover jumptable at 0x014440ac. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + unaff_x19 + 5) * 8))
      ...
      if (uVar17 == 5) {
                    /* WARNING: Could not recover jumptable at 0x01444010. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + unaff_x19 + 5) * 8))(uVar12);
        return;
      }
      if (uVar17 == 0xd) {
                    /* WARNING: Could not recover jumptable at 0x01443ff0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + unaff_x19 + 5) * 8))();
        return;
      }
        ...
        while( true ) {
          ...
          if (iVar3 == (int)param_4) {
            if ((ulong)((long)((ulong)*(uint *)(uVar13 + 3) << 0x20) >> 0x21) <= lVar2 + 6U) {
              ...
              pcVar9 = (code *)SoftwareBreakpoint(0,0x1443d4c);
              (*pcVar9)();
            }
            uVar12 = unaff_x26 + (ulong)*(uint *)(uVar13 + lVar19 + 0xb);
            lVar18 = param_6;
            if ((*(int *)(uVar13 + lVar19 + 0xf) >> 1 & 1U) == 0) goto LAB_01443fa8;
            if (*(int *)(uVar12 - 1) == (int)*(undefined8 *)(unaff_x26 + 0xcc8)) {
              ...
              uVar12 = param_2;
              if ((int)lVar19 != (int)*(undefined8 *)(unaff_x26 + 0xca8)) goto LAB_01443fa8;
              if (*(int *)(lVar2 + 0x33) == (int)*(undefined8 *)(unaff_x26 + 0xa8)) {
                ...
                if ((uVar13 & 1) != 0) {
                  ...
                  *(int *)(param_6 + -0x20) = (iVar8 + -1) * 2;
                  ...
                  unaff_x21 = param_6;
LAB_01443fa8:
                    /* WARNING: Could not recover jumptable at 0x01443fd0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                  (**(code **)(unaff_x21 +
                              (ulong)*(byte *)(*(long *)(lVar18 + -0x18) + unaff_x19 + 5) * 8))
                            (uVar12);
                  return;
                }
              }
        ...
        if (uVar17 == 6) {
          ...
          *(int *)(param_6 + -0x20) = (iVar8 + -1) * 2;
          FUN_0133fcc0(0,unaff_x26 + (ulong)uVar15);
                    /* WARNING: Could not recover jumptable at 0x01443cc4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        ...
        if (uVar17 == 7) {
          ...
          *(int *)(param_6 + -0x20) = (iVar8 + -1) * 2;
          FUN_01348300(uVar12,uVar14,param_4,unaff_x26 + (ulong)uVar15);
                    /* WARNING: Could not recover jumptable at 0x01443c38. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x21 + (ulong)*(byte *)(*(long *)(param_6 + -0x18) + unaff_x19 + 5) * 8)
          )();
          return;
        ...
        if ((uVar17 == 8) || (uVar17 == 9)) {
          ...
          if ((int)(unaff_x26 + (ulong)uVar15) == 3) {
                    /* WARNING: Does not return */
            pcVar9 = (code *)SoftwareBreakpoint(0,0x1443b34);
            (*pcVar9)();
          }
          ...
          *(int *)(param_6 + -0x20) = (iVar8 + -1) * 2;
          FUN_01348140(uVar14,uVar11,0,unaff_x26 + (ulong)uVar4,param_6,
                    ...
                    /* WARNING: Could not recover jumptable at 0x01443bc4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(param_6 + (ulong)*(byte *)(*(long *)(local_40 + -0x18) + unaff_x20) * 8))();
          return;
        }
        if (uVar17 != 3) {
          ...
          if (uVar17 == 0xc) {
            *(int *)(param_6 + -0x20) = (iVar8 + -1) * 2;
            FUN_013fc180(uVar12,param_4,uVar14,2);
                    /* WARNING: Could not recover jumptable at 0x0144381c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
            (**(code **)(unaff_x21 +
                        (ulong)*(byte *)(*(long *)(param_6 + -0x18) + unaff_x19 + 5) * 8))();
            return;
          }
          if (uVar17 != 0xe) {
            *(int *)(param_6 + -0x20) = (iVar8 + -1) * 2;
          ...
          if ((ulong)((long)((ulong)*(uint *)(lVar18 + 3) << 0x20) >> 0x21) <= uVar13) {
                    /* WARNING: Does not return */
            pcVar9 = (code *)SoftwareBreakpoint(0,0x1443730);
            (*pcVar9)();
          }
          if ((int)unaff_x26 + *(int *)(unaff_x26 + (ulong)*(uint *)(lVar18 + uVar13 * 4 + 7) + 3)
              != (int)*(undefined8 *)(unaff_x26 + 0xa8)) {
                    /* WARNING: Could not recover jumptable at 0x0144376c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
            (**(code **)(unaff_x21 + (ulong)*(byte *)(unaff_x20 + unaff_x19 + 5) * 8))();
            return;
          }
...
LAB_01443ae0:
                    /* WARNING: Could not recover jumptable at 0x01443b08. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(unaff_x21 + (ulong)*(byte *)(*(long *)(lVar18 + -0x18) + unaff_x19 + 5) * 8))
                    (uVar13);
          return;
        }
      }
