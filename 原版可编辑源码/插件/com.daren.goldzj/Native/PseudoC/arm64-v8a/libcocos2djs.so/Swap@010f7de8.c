...
/* v8::internal::HashTable<v8::internal::ObjectHashTable,
   v8::internal::ObjectHashTableShape>::Swap(v8::internal::InternalIndex,
   v8::internal::InternalIndex, v8::internal::WriteBarrierMode) */

void __thiscall
v8::internal::HashTable<v8::internal::ObjectHashTable,v8::internal::ObjectHashTableShape>::Swap
...
LAB_010f7f88:
    *(uint *)(*(long *)this + lVar3) = uVar4;
    if (param_4 == 4) goto LAB_010f7fb0;
    if (param_4 == 0) {
LAB_010f7fa0:
      *(uint *)(*(long *)this + uVar13) = uVar5;
      return;
