...
/* v8::internal::compiler::Typer::Visitor::JSBitwiseXorTyper(v8::internal::compiler::Type,
   v8::internal::compiler::Type, v8::internal::compiler::Typer*) */

undefined8
v8::internal::compiler::Typer::Visitor::JSBitwiseXorTyper
...

{
  ...
  if (((local_38 == 0x1c5f) ||
     ...
     (((uVar2 ^ 1) & 1) == 0)) {
    uVar5 = OperationTyper::NumberBitwiseXor(pOVar1,local_18,local_38);
  }
  else if ((uVar2 & 1) == 0) {
    uVar5 = 0x8000001;
