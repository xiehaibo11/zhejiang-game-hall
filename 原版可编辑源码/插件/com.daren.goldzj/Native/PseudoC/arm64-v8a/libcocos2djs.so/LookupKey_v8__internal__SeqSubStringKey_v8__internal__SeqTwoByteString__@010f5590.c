...
/* v8::internal::Handle<v8::internal::String>
   v8::internal::StringTable::LookupKey<v8::internal::SeqSubStringKey<v8::internal::SeqTwoByteString>
   >(v8::internal::Isolate*, v8::internal::SeqSubStringKey<v8::internal::SeqTwoByteString>*) */

void v8::internal::StringTable::
     LookupKey<v8::internal::SeqSubStringKey<v8::internal::SeqTwoByteString>>
