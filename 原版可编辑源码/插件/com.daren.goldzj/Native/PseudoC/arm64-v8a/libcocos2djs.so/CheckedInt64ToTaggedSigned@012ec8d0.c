...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CheckedInt64ToTaggedSigned(v8::internal::compiler::FeedbackSource
   const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::CheckedInt64ToTaggedSigned
...

{
  ...
  if ((*(long *)param_1 == 0) || (*(int *)(param_1 + 8) == -1)) {
    pOVar3 = (Operator *)(*(long *)this + 0x1cc8);
  }
  else {
    this_00 = *(Zone **)(this + 8);
    ...
    Operator::Operator(pOVar3,0x5e,0x38,"CheckedInt64ToTaggedSigned",1,1,1,1,1,0);
