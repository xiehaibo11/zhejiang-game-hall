...
uint FUN_00de8a28(ulong *param_1,long param_2,int param_3,long param_4,uint param_5,long param_6)

{
  ...
  if ((int)param_5 < 0x10) {
    ...
    do {
      ...
      if (uVar10 < 0x7f) {
        uVar11 = (ulong)uVar10;
        uVar10 = (uint)(byte)(&DAT_01970d00)[uVar10];
        uVar18 = (int)uVar6 - (uint)(byte)(&DAT_01970c80)[uVar11];
        uVar6 = (ulong)uVar18;
      ...
      *(uint *)(param_1 + 1) = uVar10;
      ...
      if (uVar12 < 0x7f) {
        uVar11 = (ulong)uVar12;
        uVar12 = (uint)(byte)(&DAT_01970d00)[uVar12];
        uVar18 = (int)uVar6 - (uint)(byte)(&DAT_01970c80)[uVar11];
        uVar6 = (ulong)uVar18;
        *(uint *)((long)param_1 + 0xc) = uVar18;
      }
      *(uint *)(param_1 + 1) = uVar12;
      if (bVar4) {
        ...
        if (uVar18 < 0x7f) {
          ...
          uVar10 = (int)uVar6 - (uint)(byte)(&DAT_01970c80)[uVar11];
          uVar6 = (ulong)uVar10;
...
joined_r0x00de9270:
          if (uVar12 < 0x7f) {
            uVar11 = (ulong)uVar12;
            uVar12 = (uint)(byte)(&DAT_01970d00)[uVar12];
            uVar6 = (ulong)(iVar5 - (uint)(byte)(&DAT_01970c80)[uVar11]);
            *(uint *)((long)param_1 + 0xc) = iVar5 - (uint)(byte)(&DAT_01970c80)[uVar11];
            uVar14 = uVar15;
          }
          *(uint *)(param_1 + 1) = uVar12;
        }
          ...
          *(uint *)(param_1 + 1) = uVar10;
          ...
          if (bVar4) {
            ...
            *(uint *)(param_1 + 1) = uVar18;
            ...
            pbVar20 = (&PTR_DAT_01c92740)[uVar18];
            *(uint *)(param_1 + 1) = uVar12;
            uVar10 = (uint)*pbVar20;
            if (*pbVar20 == 0) {
              uVar14 = 0;
...
LAB_00de93c8:
      ...
      uVar1 = iVar5 >> 0x1f;
      bVar2 = (&DAT_0196fae0)[lVar22 >> 0x20];
      uVar10 = (int)uVar6 - 1;
