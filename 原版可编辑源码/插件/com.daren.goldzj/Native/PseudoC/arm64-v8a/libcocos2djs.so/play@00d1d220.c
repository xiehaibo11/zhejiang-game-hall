...

{
  ...
  *(undefined4 *)(lVar5 + 0x40) = 0;
  ...
  pAVar6 = this + 0x78;
  if (*(AnimationState **)pAVar6 == (AnimationState *)0x0) {
    lVar5 = *(long *)(*(long *)(*(long *)(this + 0x68) + 0x20) + 0x140);
    if (lVar5 == 0) goto LAB_00d1d348;
    ...
    uVar2 = AnimationState::isPlaying(*(AnimationState **)pAVar6);
    if (((uVar2 & 1) == 0) &&
       (uVar2 = AnimationState::isCompleted(*(AnimationState **)pAVar6), (uVar2 & 1) == 0)) {
      AnimationState::play(*(AnimationState **)pAVar6);
      goto LAB_00d1d348;
    }
    pAVar4 = *(AnimationConfig **)(this + 0x70);
