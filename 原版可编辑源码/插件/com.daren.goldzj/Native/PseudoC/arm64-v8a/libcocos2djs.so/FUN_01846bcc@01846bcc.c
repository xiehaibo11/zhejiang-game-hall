...
void FUN_01846bcc(long param_1,undefined8 *param_2)

{
  ...
  if (uVar4 < (ulong)param_2[2]) {
    ...
    *param_2 = pvVar1;
    if (pvVar1 == (void *)0x0) goto LAB_01846e10;
    lVar3 = param_2[1];
    uVar4 = lVar3 + 1;
  }
  param_2[1] = uVar4;
...
LAB_01846e10:
  ...
  if (*(char *)((long)plVar5 + 9) == '\x01') {
    return;
                    ...
                    /* WARNING: Could not recover jumptable at 0x01846e0c. Too many branches */
