...
/* bool spine_Vector_T_ptr_to_seval<spine::ConstraintData>(spine::Vector<spine::ConstraintData*>
   const&, se::Value*) */

bool spine_Vector_T_ptr_to_seval<spine::ConstraintData>(Vector *param_1,Value *param_2)
...
LAB_00c8b128:
      ...
      do {
        ...
        bVar4 = native_ptr_to_rooted_seval<spine::ConstraintData>
