...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<std::__ndk1::basic_string<char,
   ...
   cocos2d::EventDispatcher::Node*&>(std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>,
   std::__ndk1::allocator<char> > const&, std::__ndk1::basic_string<char,
   std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> > const&,
   cocos2d::EventDispatcher::Node*&) */
...
long * std::__ndk1::
       ...
       __emplace_unique_key_args<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>,std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&,cocos2d::EventDispatcher::Node*&>
                 (basic_string *param_1,basic_string *param_2,Node **param_3)
      ...
      do {
        ...
        if (pbVar8 != pbVar5) {
          if (((ulong)pbVar12 & (ulong)pbVar13) == 0) {
            ...
            if (pbVar8 + -(uVar9 * (long)pbVar13) == unaff_x28) goto LAB_009103f8;
            break;
          }
          ...
          if ((bVar2 & 1) == 0) {
            if (__n != 0) {
              ...
              while (*(basic_string *)((long)plVar11 + uVar9 + 0x11) == __s2[uVar9]) {
                uVar9 = uVar9 + 1;
                if (bVar2 >> 1 == uVar9) goto LAB_00910480;
              }
              goto LAB_00910470;
            }
          }
...
LAB_00910470:
  ...
  __s1 = (void *)__construct_node_hash<std::__ndk1::basic_string<char,std::__ndk1::char_traits<char>,std::__ndk1::allocator<char>>const&,cocos2d::EventDispatcher::Node*&>
