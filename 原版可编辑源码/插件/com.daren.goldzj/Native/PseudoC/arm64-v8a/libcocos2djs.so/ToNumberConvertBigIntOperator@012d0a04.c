...
/* v8::internal::compiler::SimplifiedLowering::ToNumberConvertBigIntOperator() */

void __thiscall
v8::internal::compiler::SimplifiedLowering::ToNumberConvertBigIntOperator(SimplifiedLowering *this)

{
  ...
  if (*(long *)(this + 0x40) == 0) {
    Builtins::CallableFor(aBStack_38,*(undefined8 *)(*(long *)this + 0x168),0x66);
