...
/* v8::internal::compiler::BranchElimination::ReduceLoop(v8::internal::compiler::Node*) */

undefined8 __thiscall
v8::internal::compiler::BranchElimination::ReduceLoop(BranchElimination *this,Node *param_1)
