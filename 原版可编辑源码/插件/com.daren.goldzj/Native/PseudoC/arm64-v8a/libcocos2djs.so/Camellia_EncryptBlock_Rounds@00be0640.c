...

{
  ...
  while( true ) {
    ...
    uVar1 = *(uint *)(&DAT_018d7278 + (ulong)(uVar1 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6a78 + (ulong)(uVar1 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6e78 + (ulong)(uVar1 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6678 + (ulong)(uVar1 >> 0x18) * 4);
    uVar2 = *(uint *)(&DAT_018d6a78 + (ulong)(uVar2 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6678 + (ulong)(uVar2 & 0xff) * 4) ^ uVar1 ^
    ...
    uVar1 = *(uint *)(&DAT_018d6a78 + (ulong)(uVar1 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6678 + (ulong)(uVar1 & 0xff) * 4) ^ uVar10 ^
            *(uint *)(&DAT_018d7278 + (ulong)(uVar1 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6e78 + (ulong)(uVar1 >> 0x18) * 4);
    uVar7 = uVar1 ^ uVar7;
    ...
    uVar10 = *(uint *)(&DAT_018d7278 + (ulong)(uVar10 >> 8 & 0xff) * 4) ^
             ...
             *(uint *)(&DAT_018d6e78 + (ulong)(uVar10 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_018d6678 + (ulong)(uVar10 >> 0x18) * 4);
    uVar8 = *(uint *)(&DAT_018d6a78 + (ulong)(uVar8 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6678 + (ulong)(uVar8 & 0xff) * 4) ^ uVar10 ^
    ...
    uVar10 = *(uint *)(&DAT_018d7278 + (ulong)(uVar10 >> 8 & 0xff) * 4) ^
             ...
             *(uint *)(&DAT_018d6e78 + (ulong)(uVar10 >> 0x10 & 0xff) * 4) ^
             *(uint *)(&DAT_018d6678 + (ulong)(uVar10 >> 0x18) * 4);
    uVar3 = *(uint *)(&DAT_018d6a78 + (ulong)(uVar2 >> 8 & 0xff) * 4) ^
    ...
    uVar1 = *(uint *)(&DAT_018d7278 + (ulong)(uVar2 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6a78 + (ulong)(uVar2 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6e78 + (ulong)(uVar2 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6678 + (ulong)(uVar2 >> 0x18) * 4);
    uVar10 = *(uint *)(&DAT_018d6a78 + (ulong)(uVar10 >> 8 & 0xff) * 4) ^
             *(uint *)(&DAT_018d6678 + (ulong)(uVar10 & 0xff) * 4) ^ uVar1 ^
    ...
    uVar2 = *(uint *)(&DAT_018d7278 + (ulong)(uVar8 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6a78 + (ulong)(uVar8 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6e78 + (ulong)(uVar8 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6678 + (ulong)(uVar8 >> 0x18) * 4);
    uVar8 = *(uint *)(&DAT_018d6a78 + (ulong)(uVar1 >> 8 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6678 + (ulong)(uVar1 & 0xff) * 4) ^ uVar2 ^
            *(uint *)(&DAT_018d7278 + (ulong)(uVar1 >> 0x10 & 0xff) * 4) ^
            *(uint *)(&DAT_018d6e78 + (ulong)(uVar1 >> 0x18) * 4);
    uVar7 = uVar8 ^ uVar7;
