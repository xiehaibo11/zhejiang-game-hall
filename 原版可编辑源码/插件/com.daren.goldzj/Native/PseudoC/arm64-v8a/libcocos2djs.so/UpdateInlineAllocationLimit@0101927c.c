...
/* v8::internal::NewSpace::UpdateInlineAllocationLimit(unsigned long) */

void __thiscall v8::internal::NewSpace::UpdateInlineAllocationLimit(NewSpace *this,ulong param_1)

{
  ...
  if (*(char *)(*(long *)(this + 0x40) + 0x5e0) == '\0') {
    uVar9 = *(ulong *)(*(long *)(this + 0x160) + 0x28);
    uVar4 = (**(code **)(*(long *)this + 0x80))(this);
    uVar10 = uVar9;
    if (((uVar4 & 1) != 0) && (this[0x38] == (NewSpace)0x0)) {
