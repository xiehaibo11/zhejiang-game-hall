...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::LoopPeelingPhase>() */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::LoopPeelingPhase>
          (PipelineImpl *this)

{
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFLoopPeeling");
  LoopPeelingPhase::Run(aLStack_18,pPVar5,pZVar2);
