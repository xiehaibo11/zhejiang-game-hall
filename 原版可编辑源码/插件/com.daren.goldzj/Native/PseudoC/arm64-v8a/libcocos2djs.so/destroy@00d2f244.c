...
/* std::__ndk1::__tree<std::__ndk1::__value_type<dragonBones::BaseObject*, bool>,
   std::__ndk1::__map_value_compare<dragonBones::BaseObject*,
   std::__ndk1::__value_type<dragonBones::BaseObject*, bool>,
   std::__ndk1::less<dragonBones::BaseObject*>, true>,
   std::__ndk1::allocator<std::__ndk1::__value_type<dragonBones::BaseObject*, bool> >
   >::destroy(std::__ndk1::__tree_node<std::__ndk1::__value_type<dragonBones::BaseObject*, bool>,
   void*>*) */
