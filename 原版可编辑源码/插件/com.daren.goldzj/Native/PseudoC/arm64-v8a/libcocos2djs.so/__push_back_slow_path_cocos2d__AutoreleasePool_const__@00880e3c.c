...
/* void std::__ndk1::vector<cocos2d::AutoreleasePool*,
   std::__ndk1::allocator<cocos2d::AutoreleasePool*>
   >::__push_back_slow_path<cocos2d::AutoreleasePool* const&>(cocos2d::AutoreleasePool* const&) */
...
__push_back_slow_path<cocos2d::AutoreleasePool*const&>
          (vector<cocos2d::AutoreleasePool*,std::__ndk1::allocator<cocos2d::AutoreleasePool*>> *this
          ,AutoreleasePool **param_1)
