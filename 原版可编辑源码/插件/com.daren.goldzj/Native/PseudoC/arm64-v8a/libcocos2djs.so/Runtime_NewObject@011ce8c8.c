...
undefined8 v8::internal::Runtime_NewObject(int param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (TracingFlags::runtime_stats != 0) {
    uVar4 = FUN_011ce9ec(param_1,param_2,param_3);
    return uVar4;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar5 & 1) != 0) &&
    ...
    if (((uVar5 & 1) != 0) &&
      ...
      pIVar3 = (Isolate *)JSObject::New(param_2,param_2 + -1,0);
