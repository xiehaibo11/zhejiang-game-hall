...
/* js_cocos2dx_spine_SkeletonCacheAnimation_setBonesToSetupPoseRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonCacheAnimation_setBonesToSetupPoseRegistry
...

{
  ...
  if (this == (SkeletonCacheAnimation *)0x0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonCacheAnimation_setBonesToSetupPose : Invalid Native Object"
                       );
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      spine::SkeletonCacheAnimation::setBonesToSetupPose(this);
      goto LAB_00c7ff98;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 15542): wrong number of arguments: %d, was expecting %d\n"
