...
/* v8::internal::compiler::BasicBlock::Print() */

void __thiscall v8::internal::compiler::BasicBlock::Print(BasicBlock *this)

{
  ...
  std::__ndk1::basic_ostream<char,std::__ndk1::char_traits<char>>::operator<<
            ((basic_ostream<char,std::__ndk1::char_traits<char>> *)&local_148,this);
  local_148 = &PTR__StdoutStream_01ca1128;
  local_e8[0] = &PTR__StdoutStream_01ca1150;
