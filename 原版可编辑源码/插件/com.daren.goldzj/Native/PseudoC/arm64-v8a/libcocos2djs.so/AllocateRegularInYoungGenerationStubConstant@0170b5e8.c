...
/* v8::internal::compiler::JSGraph::AllocateRegularInYoungGenerationStubConstant() */

void __thiscall
v8::internal::compiler::JSGraph::AllocateRegularInYoungGenerationStubConstant(JSGraph *this)

{
  ...
  if (*(long *)(this + 0x188) == 0) {
    local_38 = Builtins::builtin_handle((Builtins *)(*(long *)(this + 0x168) + 0x9e00),0x50);
