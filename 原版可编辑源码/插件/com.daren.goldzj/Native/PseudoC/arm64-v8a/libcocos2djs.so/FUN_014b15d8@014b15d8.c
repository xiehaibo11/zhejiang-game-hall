...
undefined8 FUN_014b15d8(undefined8 param_1,ulong *param_2,Factory *param_3)

{
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar12 & 1) == 0) ||
    ...
    uStack_100 = __strlen_chk("getLineNumber",0xe);
    local_108 = "getLineNumber";
