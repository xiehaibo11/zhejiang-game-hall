...
undefined8 FUN_011c0e14(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0x108);
  }
  if (DAT_01d3f978 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d3f978 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d3f978;
  local_a0 = (byte **)0x0;
  if ((*DAT_01d3f978 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar3,"V8.Runtime_Runtime_GetBreakLocations",0,0,0,0,0,0,0,
                       &local_50,0);
    plVar4 = local_48;
    local_48 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    local_a0 = &local_98;
    local_90 = "V8.Runtime_Runtime_GetBreakLocations";
    local_98 = pbVar3;
    local_88 = uVar5;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  if (*(char *)(*(long *)(param_3 + 0xb6c8) + 8) != '\0') {
    ...
    if (((uVar8 & 1) != 0) &&
      ...
      puVar6 = (ulong *)v8::internal::Debug::GetSourceBreakLocations(param_3,puVar6);
      uVar8 = *puVar6;
      if (((uVar8 & 1) == 0) || (uVar5 = *(undefined8 *)(param_3 + 0xa0), (int)uVar8 != (int)uVar5))
      {
        puVar7 = (undefined8 *)
                 v8::internal::Factory::NewJSArrayWithElements
                           (param_3,puVar6,3,*(int *)(uVar8 + 3) >> 1,0);
        uVar5 = *puVar7;
      }
