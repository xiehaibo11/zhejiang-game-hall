...
ulong FUN_011d4f5c(undefined8 param_1,ulong *param_2,long param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0x1a6);
  }
  if (DAT_01d3fbe0 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d3fbe0 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d3fbe0;
  if ((*DAT_01d3fbe0 & 5) == 0) {
    ppbVar6 = (byte **)0x0;
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar3,"V8.Runtime_Runtime_LoadPrivateGetter",0,0,0,0,0,0,0,
                       &local_50,0);
    plVar4 = local_48;
    local_48 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    ppbVar6 = &local_98;
    local_90 = "V8.Runtime_Runtime_LoadPrivateGetter";
    local_98 = pbVar3;
    local_88 = uVar5;
  }
