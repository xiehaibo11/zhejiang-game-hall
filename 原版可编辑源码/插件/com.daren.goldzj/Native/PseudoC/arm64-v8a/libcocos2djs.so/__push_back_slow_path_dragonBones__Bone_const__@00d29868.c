...
/* void std::__ndk1::vector<dragonBones::Bone*, std::__ndk1::allocator<dragonBones::Bone*>
   >::__push_back_slow_path<dragonBones::Bone* const&>(dragonBones::Bone* const&) */

void __thiscall
std::__ndk1::vector<dragonBones::Bone*,std::__ndk1::allocator<dragonBones::Bone*>>::
__push_back_slow_path<dragonBones::Bone*const&>
          (vector<dragonBones::Bone*,std::__ndk1::allocator<dragonBones::Bone*>> *this,
          Bone **param_1)
...
LAB_00d298cc:
  ...
  if ((ulong)(*(long *)(this + 0x10) - (long)__src >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar3 >> 0x3d != 0) goto LAB_00d298cc;
  }
  else {
