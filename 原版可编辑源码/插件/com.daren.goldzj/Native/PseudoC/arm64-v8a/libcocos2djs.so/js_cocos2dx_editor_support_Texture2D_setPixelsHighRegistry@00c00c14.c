...
/* js_cocos2dx_editor_support_Texture2D_setPixelsHighRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_editor_support_Texture2D_setPixelsHighRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Texture2D *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x54,"js_cocos2dx_editor_support_Texture2D_setPixelsHigh");
    pcVar6 = "js_cocos2dx_editor_support_Texture2D_setPixelsHigh : Invalid Native Object";
LAB_00c00d88:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        cocos2d::middleware::Texture2D::setPixelsHigh(this,local_64);
        goto LAB_00c00dc0;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_editor_support_auto.cpp"
                          ,0x5b,"js_cocos2dx_editor_support_Texture2D_setPixelsHigh");
      pcVar6 = "js_cocos2dx_editor_support_Texture2D_setPixelsHigh : Error processing arguments";
      goto LAB_00c00d88;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_editor_support_auto.cpp, 95): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_editor_support_Texture2D_setPixelsHigh",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_editor_support_auto.cpp"
                      ,0x62);
LAB_00c00dc0:
