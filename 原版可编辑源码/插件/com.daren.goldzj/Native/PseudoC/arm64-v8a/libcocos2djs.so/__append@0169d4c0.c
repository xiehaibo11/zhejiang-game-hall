...
/* std::__ndk1::vector<v8::internal::compiler::CsaLoadElimination::AbstractState const*,
   v8::internal::ZoneAllocator<v8::internal::compiler::CsaLoadElimination::AbstractState const*>
   >::__append(unsigned long, v8::internal::compiler::CsaLoadElimination::AbstractState const*
   const&) */
...
::__append(vector<v8::internal::compiler::CsaLoadElimination::AbstractState_const*,v8::internal::ZoneAllocator<v8::internal::compiler::CsaLoadElimination::AbstractState_const*>>
