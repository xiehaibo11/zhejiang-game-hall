...
/* v8::internal::interpreter::BytecodeArrayBuilder::CompareReference(v8::internal::interpreter::Register)
    */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::CompareReference
