...
/* js_renderer_EffectBase_getPropertyRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_EffectBase_getPropertyRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (EffectBase *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x5d,"js_renderer_EffectBase_getProperty");
    __android_log_print(6,"jswrapper","js_renderer_EffectBase_getProperty : Invalid Native Object");
  }
  else {
    ...
    if (lVar11 == 2) {
      ...
      if ((uVar4 & uVar5 & 1) == 0) {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                            ,0x6f,"js_renderer_EffectBase_getProperty");
        __android_log_print(6,"jswrapper",
                            "js_renderer_EffectBase_getProperty : Error processing arguments");
LAB_00936350:
        bVar3 = false;
      }
      else {
        ptVar9 = (type *)cocos2d::renderer::EffectBase::getProperty
                                   (this,(basic_string *)&local_88,local_8c);
        pVVar10 = (Value *)se::State::rval(aSStack_70);
        bVar3 = native_ptr_to_seval<cocos2d::renderer::Technique::Parameter>
                          (ptVar9,pVVar10,(bool *)0x0);
        if (!bVar3) {
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                              ,0x72,"js_renderer_EffectBase_getProperty");
          __android_log_print(6,"jswrapper",
                              "js_renderer_EffectBase_getProperty : Error processing arguments");
          goto LAB_00936350;
        }
LAB_00936248:
      ...
      if (lVar11 == 1) {
        ...
        if ((uVar8 & 1) == 0) {
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                              ,100,"js_renderer_EffectBase_getProperty");
          __android_log_print(6,"jswrapper",
                              "js_renderer_EffectBase_getProperty : Error processing arguments");
        }
        else {
          ...
          bVar3 = native_ptr_to_seval<cocos2d::renderer::Technique::Parameter>
                            (ptVar9,pVVar10,(bool *)0x0);
          if (bVar3) goto LAB_00936248;
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                              ,0x67,"js_renderer_EffectBase_getProperty");
          __android_log_print(6,"jswrapper",
                              "js_renderer_EffectBase_getProperty : Error processing arguments");
        }
        goto LAB_00936350;
      ...
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp, 117): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar7[1] - *plVar7) >> 4,2);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_renderer_EffectBase_getProperty",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_renderer_auto.cpp"
                      ,0x78);
LAB_00936394:
  pVVar10 = (Value *)se::State::rval(aSStack_70);
