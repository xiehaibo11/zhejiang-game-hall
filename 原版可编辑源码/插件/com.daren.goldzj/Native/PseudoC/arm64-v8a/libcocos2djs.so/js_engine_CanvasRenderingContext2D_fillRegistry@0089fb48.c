...
/* js_engine_CanvasRenderingContext2D_fillRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_engine_CanvasRenderingContext2D_fillRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (CanvasRenderingContext2D *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x5a0,"js_engine_CanvasRenderingContext2D_fill");
    __android_log_print(6,"jswrapper",
                        "js_engine_CanvasRenderingContext2D_fill : Invalid Native Object");
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      cocos2d::CanvasRenderingContext2D::fill(this);
      goto LAB_0089fc98;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 1447): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_CanvasRenderingContext2D_fill",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x5aa);
LAB_0089fc98:
