      ...
      do {
        ...
        if (ppVar3 != (pitem *)0x0) {
          ...
          *(int *)(param_1 + 0x10e0) = (int)plVar7[1];
          lVar5 = plVar7[4];
                    /* try { // try from 00ab8224 to 00bb8227 has its CatchHandler @ 00ab82c4 */
          ...
          *(long *)(param_1 + 0x3b8) = lVar5;
          ...
          lVar5 = *plVar7;
                    /* try { // try from 00ab823c to 00bb823f has its CatchHandler @ 00ab82bc */
          *(undefined2 *)(param_1 + 0x1116) = *(undefined2 *)(lVar5 + 9);
          *(undefined4 *)(param_1 + 0x1112) = *(undefined4 *)(lVar5 + 5);
                    /* try { // try from 00ab8254 to 00bb8257 has its CatchHandler @ 00ab82c0 */
          CRYPTO_free(ppVar3->data);
          pitem_free(ppVar3);
        }
        puVar6 = *(ushort **)(param_1 + 0x1128);
        uVar1 = *puVar6;
                    /* try { // try from 00ab826c to 00bb826f has its CatchHandler @ 00ab82bc */
        ...
        iVar2 = dtls1_record_replay_check(param_1,puVar6);
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ab823c with catch @ 00ab82bc
                       catch(type#1 @ 00000000) { ... } // from try @ 00ab826c with catch @ 00ab82bc
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ab8254 with catch @ 00ab82c0
                        */
                    /* catch(type#1 @ 00000000) { ... } // from try @ 00ab8224 with catch @ 00ab82c4
                        */
