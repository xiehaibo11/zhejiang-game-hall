...
/* std::__ndk1::enable_if<__is_forward_iterator<std::__ndk1::move_iterator<std::__ndk1::__wrap_iter<v8::internal::Handle<v8::internal::Map>*>
   > >::value&&is_constructible<v8::internal::Handle<v8::internal::Map>,
   std::__ndk1::iterator_traits<std::__ndk1::move_iterator<std::__ndk1::__wrap_iter<v8::internal::Handle<v8::internal::Map>*>
   > >::reference>::value, void>::type std::__ndk1::vector<v8::internal::Handle<v8::internal::Map>,
   ...
   > >(std::__ndk1::move_iterator<std::__ndk1::__wrap_iter<v8::internal::Handle<v8::internal::Map>*>
   >, std::__ndk1::move_iterator<std::__ndk1::__wrap_iter<v8::internal::Handle<v8::internal::Map>*>
   >) */
...

{
  ...
  if (param_2 != puVar6) {
    ...
    if ((3 < uVar1) &&
      ...
      puVar9 = puVar8;
      if (uVar1 == uVar10) goto joined_r0x01751fbc;
    }
    do {
      puVar11 = param_2 + 1;
      puVar8 = puVar9 + 1;
