  ...
  if ((param_1 == 0) || (lVar8 = *(long *)(param_1 + 0x38), lVar8 == 0)) {
    ...
    if ((param_3 < 5) && (uVar2 < 10)) {
      if (((*(uint *)(lVar8 + 0xb8) == param_3) &&
          ((&PTR_FUN_01c92788)[(long)*(int *)(lVar8 + 0xb4) * 2] ==
           (&PTR_FUN_01c92788)[(long)(int)uVar2 * 2])) || (*(long *)(param_1 + 0x10) == 0)) {
        uVar7 = 0;
      }
      else {
      ...
      if (*(uint *)(lVar8 + 0xb4) != uVar2) {
        *(uint *)(lVar8 + 0xb4) = uVar2;
        ...
        uVar4 = *(ushort *)(&DAT_01c92782 + lVar1);
        uVar5 = *(ushort *)(&DAT_01c92780 + lVar1);
        uVar6 = *(ushort *)(&DAT_01c92784 + lVar1);
        *(uint *)(lVar8 + 0xac) = (uint)*(ushort *)(&DAT_01c92786 + lVar1);
