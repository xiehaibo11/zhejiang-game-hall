...
::SwapInputs(BinopMatcher<v8::internal::compiler::HeapObjectMatcherImpl<(v8::internal::compiler::IrOpcode::Value)30>,v8::internal::compiler::HeapObjectMatcherImpl<(v8::internal::compiler::IrOpcode::Value)30>>
             *this)
