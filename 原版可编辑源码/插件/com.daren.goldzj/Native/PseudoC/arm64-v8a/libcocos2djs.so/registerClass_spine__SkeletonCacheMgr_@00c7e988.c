...
/* void JSBClassType::registerClass<spine::SkeletonCacheMgr>(se::Class*) */

void JSBClassType::registerClass<spine::SkeletonCacheMgr>(Class *param_1)
