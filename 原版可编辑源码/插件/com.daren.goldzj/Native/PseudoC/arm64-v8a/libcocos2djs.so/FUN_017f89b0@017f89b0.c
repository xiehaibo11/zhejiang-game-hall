...
void FUN_017f89b0(undefined8 *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  *param_1 = &PTR__basic_streambuf_01c671a8;
  ...
  param_1[3] = 0;
  param_1[2] = 0;
  *param_1 = &PTR__basic_streambuf_01cdb8b0;
  param_1[8] = param_2;
  std::__ndk1::locale::locale(alStack_50,(locale *)(param_1 + 1));
  plVar3 = (long *)std::__ndk1::locale::use_facet
                             (alStack_50,(id *)&std::__ndk1::codecvt<char,char,mbstate_t>::id);
