...
/* js_cocos2dx_spine_SkeletonCacheAnimation_setStartListenerRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonCacheAnimation_setStartListenerRegistry
...

{
  ...
  if (this == (SkeletonCacheAnimation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x3ccd,&DAT_018efbd9);
    __android_log_print(6,"jswrapper",&DAT_019235dd);
  }
  else {
    ...
    if (puVar4[1] - (long)pVVar5 == 0x10) {
      ...
      if (pVVar5[8] == (Value)0x5) {
        ...
        if ((uVar7 & 1) == 0) goto LAB_00c80494;
...
LAB_00c80494:
      ...
      spine::SkeletonCacheAnimation::setStartListener(this,(function *)alStack_c0);
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 15605): wrong number of arguments: %d, was expecting %d\n"
