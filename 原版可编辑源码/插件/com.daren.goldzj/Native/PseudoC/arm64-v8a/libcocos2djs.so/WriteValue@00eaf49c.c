...
/* v8::ValueSerializer::WriteValue(v8::Local<v8::Context>, v8::Local<v8::Value>) */

ushort __thiscall
v8::ValueSerializer::WriteValue(ValueSerializer *this,long param_2,undefined8 param_3)

{
  ...
  *(int *)pIVar14 = *(int *)pIVar14 + 1;
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x3ef);
  }
  this_00 = *(Logger **)(pIVar10 + 0x9558);
  uVar4 = internal::Logger::is_logging(this_00);
  if ((uVar4 & 1) != 0) {
    internal::Logger::ApiEntryCall(this_00,"v8::ValueSerializer::WriteValue");
  }
  uVar1 = *(undefined4 *)(pIVar10 + 0x2c60);
  *(undefined4 *)(pIVar10 + 0x2c60) = 5;
  uVar3 = internal::ValueSerializer::WriteObject((ValueSerializer *)(*(long *)this + 8),param_3);
  if ((uVar3 & 0xff) == 0) {
    local_a0 = '\x01';
