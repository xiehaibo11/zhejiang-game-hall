...
void FUN_01448660(undefined8 param_1)

{
  ...
  *(int *)(unaff_x29 + -0x20) = ((int)unaff_x19 + -1) * 2;
  FUN_01387920(param_1,uVar2,uVar4,lVar3,(uint)uVar1 * 2);
                    /* WARNING: Could not recover jumptable at 0x01448720. Too many branches */
