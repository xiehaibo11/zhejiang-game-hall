...
/* std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >*
   v8::base::MakeCheckOpString<unsigned long, unsigned long>(unsigned long, unsigned long, char
   const*) */

basic_string *
v8::base::MakeCheckOpString<unsigned_long,unsigned_long>(ulong param_1,ulong param_2,char *param_3)
