...
/* js_extension_AssetsManagerEx_setVerifyCallbackRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_extension_AssetsManagerEx_setVerifyCallbackRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (lVar4 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x2e3,"js_extension_AssetsManagerEx_setVerifyCallback");
    __android_log_print(6,"jswrapper",
                        "js_extension_AssetsManagerEx_setVerifyCallback : Invalid Native Object");
  }
  else {
      ...
      if (pVVar6[8] == (Value)0x5) {
        ...
        if ((uVar8 & 1) == 0) {
          ...
          if (alStack_c0 == plVar10) {
            ...
            if (plVar10 == (long *)0x0) goto LAB_008ab484;
...
LAB_008ab538:
        ...
        if (local_a0 == (long *)0x0) goto LAB_008ab484;
...
LAB_008ab484:
      ...
      FUN_008b0388(alStack_90,lVar4 + 0x200);
      if (alStack_90 == local_70) {
        pcVar11 = *(code **)(*local_70 + 0x20);
LAB_008ab4bc:
        (*pcVar11)();
    ...
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_extension_auto.cpp, 784): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(puVar5[1] - (long)pVVar6) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_extension_AssetsManagerEx_setVerifyCallback",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_extension_auto.cpp"
                      ,0x313);
LAB_008ab3f8:
