...
undefined8 FUN_014b3384(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if (((uVar10 & 1) == 0) ||
    ...
    uStack_100 = __strlen_chk("isConstructor",0xe);
    local_108 = "isConstructor";
