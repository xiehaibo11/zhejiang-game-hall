...
/* void v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::EscapeAnalysisPhase>() */

void __thiscall
v8::internal::compiler::PipelineImpl::Run<v8::internal::compiler::EscapeAnalysisPhase>
          (PipelineImpl *this)

{
  ...
  pZVar2 = (Zone *)ZoneStats::NewEmptyZone(this_01,"V8.TFEscapeAnalysis");
  EscapeAnalysisPhase::Run(aEStack_18,pPVar5,pZVar2);
