...
/* v8::internal::CallPrinter::VisitTryCatchStatement(v8::internal::TryCatchStatement*) */

void __thiscall
v8::internal::CallPrinter::VisitTryCatchStatement(CallPrinter *this,TryCatchStatement *param_1)
