...
/* std::__ndk1::vector<v8::internal::HeapGraphEdge*,
   std::__ndk1::allocator<v8::internal::HeapGraphEdge*> >::__append(unsigned long) */

void __thiscall
std::__ndk1::
vector<v8::internal::HeapGraphEdge*,std::__ndk1::allocator<v8::internal::HeapGraphEdge*>>::__append
...
LAB_011a9eec:
  ...
  if (uVar1 == 0) {
    ...
    if (uVar1 >> 0x3d != 0) goto LAB_011a9eec;
