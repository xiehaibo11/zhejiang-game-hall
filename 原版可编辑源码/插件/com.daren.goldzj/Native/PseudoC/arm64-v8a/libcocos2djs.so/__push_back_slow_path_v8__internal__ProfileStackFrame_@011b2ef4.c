...
/* void std::__ndk1::vector<v8::internal::ProfileStackFrame,
   std::__ndk1::allocator<v8::internal::ProfileStackFrame>
   >::__push_back_slow_path<v8::internal::ProfileStackFrame>(v8::internal::ProfileStackFrame&&) */
...
__push_back_slow_path<v8::internal::ProfileStackFrame>
          (vector<v8::internal::ProfileStackFrame,std::__ndk1::allocator<v8::internal::ProfileStackFrame>>
           *this,ProfileStackFrame *param_1)

{
  ...
  if (uVar1 >> 0x3b == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3b != 0) goto LAB_011b2fe0;
