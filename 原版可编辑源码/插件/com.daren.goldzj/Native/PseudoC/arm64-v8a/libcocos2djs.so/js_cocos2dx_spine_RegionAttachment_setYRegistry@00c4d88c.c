...
/* js_cocos2dx_spine_RegionAttachment_setYRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_RegionAttachment_setYRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (RegionAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x20aa,"js_cocos2dx_spine_RegionAttachment_setY");
    pcVar6 = "js_cocos2dx_spine_RegionAttachment_setY : Invalid Native Object";
LAB_00c4da00:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::RegionAttachment::setY(this,local_64);
        goto LAB_00c4da38;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x20b1,"js_cocos2dx_spine_RegionAttachment_setY");
      pcVar6 = "js_cocos2dx_spine_RegionAttachment_setY : Error processing arguments";
      goto LAB_00c4da00;
    }
    __android_log_print(6,"jswrapper",&DAT_0190dcab,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_RegionAttachment_setY",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x20b8);
LAB_00c4da38:
