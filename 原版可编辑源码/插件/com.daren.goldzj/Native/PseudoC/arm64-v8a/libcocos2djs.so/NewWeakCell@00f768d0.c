...
/* v8::internal::Factory::NewWeakCell() */

void __thiscall v8::internal::Factory::NewWeakCell(Factory *this)

{
  ...
  uVar1 = *(undefined4 *)(this + 0x2d8);
  uVar2 = Heap::AllocateRawWithRetryOrFailSlowPath((Heap *)(this + 0x8850),0x24,1,1,0);
