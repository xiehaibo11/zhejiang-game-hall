...
undefined8 FUN_015abc98(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0x227);
  }
  if (DAT_01d476f0 == (byte *)0x0) {
    plVar4 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d476f0 = (byte *)(**(code **)(*plVar4 + 0x10))(plVar4,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d476f0;
  local_a0 = (byte **)0x0;
  if ((*DAT_01d476f0 & 5) != 0) {
    ...
    uVar5 = (**(code **)(*plVar4 + 0x18))
                      (plVar4,0x58,pbVar3,"V8.Runtime_Runtime_DeserializeWasmModule",0,0,0,0,0,0,0,
                       &local_50,0);
    plVar4 = local_48;
    local_48 = (long *)0x0;
    if (plVar4 != (long *)0x0) {
    ...
    local_a0 = &local_98;
    local_90 = "V8.Runtime_Runtime_DeserializeWasmModule";
    local_98 = pbVar3;
    local_88 = uVar5;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  if ((*(uint *)(uVar7 + 0x1b) >> 2 & 1) != 0) {
                    /* WARNING: Subroutine does not return */
    V8_Fatal("Check failed: %s.","!buffer->was_detached()");
  }
  if ((*(uint *)(((ulong)plVar4 & 0xffffffff00000000 | (ulong)*(uint *)((long)plVar4 + 0xb)) + 0x1b)
       >> 2 & 1) == 0) {
    local_50 = plVar4;
    ...
    pIVar6 = (Isolate *)
             v8::internal::wasm::DeserializeNativeModule
                        ...
                        *(long *)(*plVar4 + 0x13) + *(long *)(param_2[-1] + 0xf),
