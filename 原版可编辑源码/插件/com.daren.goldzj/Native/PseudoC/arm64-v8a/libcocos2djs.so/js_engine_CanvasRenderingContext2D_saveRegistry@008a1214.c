...
/* js_engine_CanvasRenderingContext2D_saveRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_engine_CanvasRenderingContext2D_saveRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (CanvasRenderingContext2D *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x65d,"js_engine_CanvasRenderingContext2D_save");
    __android_log_print(6,"jswrapper",
                        "js_engine_CanvasRenderingContext2D_save : Invalid Native Object");
  }
  else {
    plVar4 = (long *)se::State::args(aSStack_60);
    if (plVar4[1] - *plVar4 == 0) {
      cocos2d::CanvasRenderingContext2D::save(this);
      goto LAB_008a1364;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp, 1636): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_engine_CanvasRenderingContext2D_save",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/auto/jsb_cocos2dx_auto.cpp"
                      ,0x667);
LAB_008a1364:
