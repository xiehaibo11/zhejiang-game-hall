...
/* void JSBClassType::registerClass<dragonBones::WorldClock>(se::Class*) */

void JSBClassType::registerClass<dragonBones::WorldClock>(Class *param_1)
