...
/* v8::internal::Assembler::tbz(v8::internal::Register const&, unsigned int, v8::internal::Label*)
    */

void __thiscall
v8::internal::Assembler::tbz(Assembler *this,Register *param_1,uint param_2,Label *param_3)
