...
undefined8
FUN_010c1078(undefined8 param_1,ulong *param_2,KeyAccumulator *param_3,undefined4 param_4)

{
  ...
  if (((*(uint *)((uVar4 & 0xffffffff00000000 | (ulong)*(uint *)(uVar4 + 0xb)) + 0x1b) >> 2 & 1) ==
    ...
    uVar3 = v8::internal::BigInt::FromUint64
                      ((Isolate *)(uVar4 & 0xffffffff00000000),
                       *(ulong *)(*(long *)(uVar4 + 0x27) + (ulong)*(uint *)(uVar4 + 0x2f)));
    uVar4 = v8::internal::KeyAccumulator::AddKey(param_3,uVar3,param_4);
    if ((uVar4 & 1) != 0) {
      lVar6 = 1;
      do {
        if (lVar5 == lVar6) goto LAB_010c117c;
        uVar4 = *param_2;
        uVar3 = v8::internal::BigInt::FromUint64
                          ((Isolate *)(uVar4 & 0xffffffff00000000),
                           *(ulong *)(*(long *)(uVar4 + 0x27) + (ulong)*(uint *)(uVar4 + 0x2f) +
