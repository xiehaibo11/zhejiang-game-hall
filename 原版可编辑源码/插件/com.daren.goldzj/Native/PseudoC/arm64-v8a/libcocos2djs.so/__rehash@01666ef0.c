...
::__rehash(__hash_table<v8::internal::compiler::LinearScanAllocator::RangeWithRegister,v8::internal::compiler::LinearScanAllocator::RangeWithRegister::Hash,v8::internal::compiler::LinearScanAllocator::RangeWithRegister::Equals,v8::internal::ZoneAllocator<v8::internal::compiler::LinearScanAllocator::RangeWithRegister>>
           *this,ulong param_1)
      ...
      if (plVar6 != (long *)0x0) {
        do {
          ...
          if ((uVar12 & 0xffffffff) < 2) {
            uVar7 = uVar7 & uVar3;
LAB_01666fe4:
            if (uVar7 == uVar4) goto LAB_01666fac;
LAB_01666fec:
            plVar9 = plVar6;
            if (*(long *)(*(long *)this + uVar7 * 8) == 0) goto LAB_01667048;
            do {
              plVar8 = plVar9;
              plVar9 = (long *)*plVar8;
            ...
            **(undefined8 **)(*(long *)this + uVar7 * 8) = plVar6;
            ...
            if (uVar7 < param_1) goto LAB_01666fe4;
            uVar1 = 0;
            if (param_1 != 0) {
              uVar1 = uVar7 / param_1;
            }
            uVar7 = uVar7 - uVar1 * param_1;
            if (uVar7 != uVar4) goto LAB_01666fec;
LAB_01666fac:
            plVar9 = (long *)*plVar6;
            plVar5 = plVar6;
          }
