...
Factory * v8::String::NewFromUtf8(Factory *param_1,char *param_2,int param_3,uint param_4)
    ...
    if ((int)param_4 < 0xffffff1) {
      ...
      *(undefined4 *)(param_1 + 0x2c60) = 5;
      ...
      if (internal::TracingFlags::runtime_stats != 0) {
        ...
        internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0x3d8);
      }
      this = *(Logger **)(param_1 + 0x9558);
      uVar2 = internal::Logger::is_logging(this);
      if ((uVar2 & 1) != 0) {
        internal::Logger::ApiEntryCall(this,"v8::String::NewFromUtf8");
      }
      ...
      local_50 = param_2;
      if (param_3 == 1) {
        pFVar3 = (Factory *)internal::Factory::InternalizeUtf8String(param_1,(Vector *)&local_50);
      }
      else {
        pFVar3 = (Factory *)internal::Factory::NewStringFromUtf8(param_1,&local_50,0);
      }
