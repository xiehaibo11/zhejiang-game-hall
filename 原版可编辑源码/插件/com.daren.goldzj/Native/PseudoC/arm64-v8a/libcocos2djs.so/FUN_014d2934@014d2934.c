...
ulong FUN_014d2934(Isolate *param_1)

{
  ...
  *(int *)(param_1 + 0x95b0) = *(int *)(param_1 + 0x95b0) + 1;
  ...
  if (iVar2 != 0) {
    puVar5 = (ulong *)v8::internal::Factory::NewProperSubString
                                ((Factory *)param_1,puVar5,iVar2,*(undefined4 *)(*puVar5 + 7));
  }
  uVar6 = *puVar5;
  *(ulong **)pIVar1 = puVar3;
  *(int *)(param_1 + 0x95b0) = *(int *)(param_1 + 0x95b0) + -1;
