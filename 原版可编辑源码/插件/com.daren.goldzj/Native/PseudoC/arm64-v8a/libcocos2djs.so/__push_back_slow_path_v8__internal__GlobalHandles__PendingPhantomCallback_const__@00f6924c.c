...
/* void std::__ndk1::vector<v8::internal::GlobalHandles::PendingPhantomCallback,
   std::__ndk1::allocator<v8::internal::GlobalHandles::PendingPhantomCallback>
   >::__push_back_slow_path<v8::internal::GlobalHandles::PendingPhantomCallback
   const&>(v8::internal::GlobalHandles::PendingPhantomCallback const&) */
...
::__push_back_slow_path<v8::internal::GlobalHandles::PendingPhantomCallback_const&>
          (vector<v8::internal::GlobalHandles::PendingPhantomCallback,std::__ndk1::allocator<v8::internal::GlobalHandles::PendingPhantomCallback>>
           *this,PendingPhantomCallback *param_1)

{
  ...
  if (uVar1 >> 0x3b == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3b != 0) goto LAB_00f69338;
