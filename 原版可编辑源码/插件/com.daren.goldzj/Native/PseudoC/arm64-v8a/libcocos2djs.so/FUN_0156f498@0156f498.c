...
undefined8 FUN_0156f498(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  if (v8::internal::TracingFlags::runtime_stats != 0) {
    ...
    v8::internal::RuntimeCallStats::Enter(local_a0,(ulong)&local_a0 | 8,0x176);
  }
  if (DAT_01d470d8 == (byte *)0x0) {
    plVar5 = (long *)v8::internal::tracing::TraceEventHelper::GetTracingController();
    DAT_01d470d8 = (byte *)(**(code **)(*plVar5 + 0x10))(plVar5,"disabled-by-default-v8.runtime");
  }
  pbVar3 = DAT_01d470d8;
  local_c0 = (byte **)0x0;
  if ((*DAT_01d470d8 & 5) != 0) {
    ...
    uVar6 = (**(code **)(*plVar5 + 0x18))
                      (plVar5,0x58,pbVar3,
                       "V8.Runtime_Runtime_CreateObjectLiteralWithoutAllocationSite",0,0,0,0,0,0,0,
                       &local_68,0);
    plVar5 = local_60;
    local_60 = (long *)0x0;
    if (plVar5 != (long *)0x0) {
    ...
    local_c0 = &local_b8;
    local_b0 = "V8.Runtime_Runtime_CreateObjectLiteralWithoutAllocationSite";
    local_b8 = pbVar3;
    local_a8 = uVar6;
  }
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  uVar9 = *param_2;
  if (((uVar9 & 1) == 0) ||
     (*(short *)((uVar9 & 0xffffffff00000000 | 7) + (ulong)*(uint *)(uVar9 - 1)) != 0x82)) {
  ...
  pIVar7 = (Isolate *)FUN_01571608(param_3,param_2,(int)uVar11 >> 1,0);
  if (((uVar11 >> 1 & 1) == 0) || (pIVar8 = pIVar7, v8::internal::FLAG_track_double_fields != '\0'))
  {
    local_68 = &local_70;
    local_60 = (long *)((ulong)local_60 & 0xffffffff00000000);
    local_70 = param_3;
    pIVar8 = (Isolate *)FUN_01570f78(&local_68,pIVar7);
    if (pIVar7 != (Isolate *)0x0) goto joined_r0x0156f640;
  }
  else {
joined_r0x0156f640:
    if (pIVar8 != (Isolate *)0x0) goto LAB_0156f648;
  }
