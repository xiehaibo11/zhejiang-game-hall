...
/* void std::__ndk1::vector<std::__ndk1::pair<v8::internal::Handle<v8::internal::AccessorPair>,
   v8::internal::Handle<v8::internal::NativeContext> >,
   std::__ndk1::allocator<std::__ndk1::pair<v8::internal::Handle<v8::internal::AccessorPair>,
   v8::internal::Handle<v8::internal::NativeContext> > >
   >::__emplace_back_slow_path<v8::internal::Handle<v8::internal::AccessorPair>,
   v8::internal::Handle<v8::internal::NativeContext>
...

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_00f0eb2c;
