...
LAB_00af0124:
    ...
    case -4:
      ...
      break;
    default:
      goto switchD_00af00dc_caseD_fffffffd;
    }
  }
  else {
    if ((*(long *)(param_2 + 0x20) != 0) &&
       ...
       UNRECOVERED_JUMPTABLE != (code *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x00af0088. Too many branches */
    ...
    if (*param_2 != '\x05') {
      iVar1 = *(int *)(param_2 + 8);
      if (iVar1 == 1) goto LAB_00af0124;
      lVar2 = *param_1;
      goto joined_r0x00af00bc;
    }
    if (*param_1 == 0) {
      return;
    }
switchD_00af00dc_caseD_fffffffd:
                    /* try { // try from 00af00a8 to 00bf00af has its CatchHandler @ 00af04c8 */
