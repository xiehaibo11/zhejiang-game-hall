...
/* void cocos2d::volumeMulti<1, 7, int, short, short, int, short>(int*, unsigned long, short const*,
   int*, short const*, short) */

void cocos2d::volumeMulti<1,7,int,short,short,int,short>
...

{
  ...
  undefined8 uVar6;
                    ...
                    /* try { // try from 00a89570 to 00b895bf has its CatchHandler @ 00a89570
                       catch() { ... } // from try @ 00a89570 with catch @ 00a89570
                       catch() { ... } // from try @ 00a89688 with catch @ 00a89570 */
  if (param_4 == (int *)0x0) {
    ...
    do {
      sVar4 = *param_3;
                    /* try { // try from 00a895ec to 00b895ff has its CatchHandler @ 00a8971c */
      iVar5 = (int)sVar4;
                    /* try { // try from 00a89600 to 00b8960f has its CatchHandler @ 00a89708 */
    ...
    do {
      ...
      *(ulong *)param_1 =
           CONCAT44((int)((ulong)*(undefined8 *)param_1 >> 0x20) +
                    (int)sVar4 * (int)(short)((ulong)uVar6 >> 0x10),
                    (int)*(undefined8 *)param_1 + (int)sVar4 * (int)(short)uVar6);
                    /* try { // try from 00a895c0 to 00b895d7 has its CatchHandler @ 00a89720 */
