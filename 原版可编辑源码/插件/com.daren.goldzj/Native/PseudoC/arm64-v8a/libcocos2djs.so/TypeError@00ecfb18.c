...
/* v8::Exception::TypeError(v8::Local<v8::String>) */

ulong * v8::Exception::TypeError(undefined8 param_1)

{
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_80,(ulong)&local_80 | 8,0x3e3);
  }
  this = *(Logger **)(pIVar3 + 0x9558);
  uVar4 = internal::Logger::is_logging(this);
  if ((uVar4 & 1) != 0) {
    internal::Logger::ApiEntryCall(this,"v8::TypeError::New");
  }
