...
/* v8::internal::compiler::SimplifiedOperatorBuilder::CheckedTaggedToTaggedSigned(v8::internal::compiler::FeedbackSource
   const&) */

Operator * __thiscall
v8::internal::compiler::SimplifiedOperatorBuilder::CheckedTaggedToTaggedSigned
...

{
  ...
  if ((*(long *)param_1 == 0) || (*(int *)(param_1 + 8) == -1)) {
    pOVar3 = (Operator *)(*(long *)this + 0x1de8);
  }
  else {
    this_00 = *(Zone **)(this + 8);
    ...
    Operator::Operator(pOVar3,0x6d,0x38,&DAT_019ffb75,1,1,1,1,1,0);
