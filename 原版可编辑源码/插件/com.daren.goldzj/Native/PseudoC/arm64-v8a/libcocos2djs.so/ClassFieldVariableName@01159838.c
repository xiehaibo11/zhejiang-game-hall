...
/* v8::internal::ParserBase<v8::internal::Parser>::ClassFieldVariableName(v8::internal::AstValueFactory*,
   int) */

undefined8 __thiscall
v8::internal::ParserBase<v8::internal::Parser>::ClassFieldVariableName
          (ParserBase<v8::internal::Parser> *this,AstValueFactory *param_1,int param_2)
