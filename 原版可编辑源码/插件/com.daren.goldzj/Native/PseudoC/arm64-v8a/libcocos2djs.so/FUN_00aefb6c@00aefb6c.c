...
/* WARNING: Removing unreachable block (ram,0x00aefc58) */

int FUN_00aefb6c(long *param_1,uchar *param_2,undefined4 *param_3,char *param_4)

{
  ...
  if ((*(long *)(param_4 + 0x20) != 0) &&
    ...
    return iVar1;
                    ...
                    /* try { // try from 00aefb9c to 00befba3 has its CatchHandler @ 00af04e8 */
...
LAB_00aefbd0:
    ...
    if (*param_4 != '\x05') goto LAB_00aefbd0;
  ...
  default:
    ...
    if ((*(long *)(param_4 + 0x28) == 0x800) && ((*(byte *)(piVar6 + 4) >> 4 & 1) != 0)) {
                    /* try { // try from 00aefcdc to 00befce3 has its CatchHandler @ 00af04e4 */
      if (param_2 != (uchar *)0x0) {
