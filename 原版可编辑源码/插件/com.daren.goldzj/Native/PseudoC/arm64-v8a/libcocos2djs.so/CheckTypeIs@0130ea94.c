...
/* v8::internal::compiler::Verifier::Visitor::CheckTypeIs(v8::internal::compiler::Node*,
   v8::internal::compiler::Type) */

void __thiscall
v8::internal::compiler::Verifier::Visitor::CheckTypeIs
          (Visitor *this,undefined8 *param_1,long param_3)

{
  ...
  if (*(int *)(this + 8) == 0) {
    ...
    if ((local_150 != (undefined **)param_3) &&
       (uVar2 = Type::SlowIs((Type *)&local_150,param_3), (uVar2 & 1) == 0)) {
