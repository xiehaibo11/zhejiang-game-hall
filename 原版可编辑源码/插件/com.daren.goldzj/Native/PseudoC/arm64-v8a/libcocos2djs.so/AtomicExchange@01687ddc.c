...
/* v8::internal::compiler::RawMachineAssembler::AtomicExchange(v8::internal::MachineType,
...

{
  ...
  if ((param_2 & 0xff) == 5) {
    if (this[0x30] != (RawMachineAssembler)0x5) {
      pOVar1 = (Operator *)MachineOperatorBuilder::Word32AtomicPairExchange(this_00);
      iVar2 = 4;
      uStack_48 = param_6;
      goto LAB_01687e68;
    }
    pOVar1 = (Operator *)MachineOperatorBuilder::Word64AtomicExchange(this_00,param_2);
  }
  else {
    pOVar1 = (Operator *)MachineOperatorBuilder::Word32AtomicExchange(this_00,param_2);
  }
  iVar2 = 3;
LAB_01687e68:
  local_60 = param_3;
