...
/* v8::internal::ProfilerListener::SetterCallbackEvent(v8::internal::Name, unsigned long) */

void __thiscall
v8::internal::ProfilerListener::SetterCallbackEvent
...

{
  ...
  uVar3 = StringsStorage::GetConsName((StringsStorage *)(this + 0x18),&DAT_019b0c3f,param_2);
