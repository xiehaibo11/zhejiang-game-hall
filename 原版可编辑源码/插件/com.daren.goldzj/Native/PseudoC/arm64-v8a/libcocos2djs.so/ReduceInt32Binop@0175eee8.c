...
/* v8::internal::compiler::JSTypedLowering::ReduceInt32Binop(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::JSTypedLowering::ReduceInt32Binop(JSTypedLowering *this,Node *param_1)

{
  ...
  JSBinopReduction::ConvertInputsToUI32((JSBinopReduction *)&local_30,0,0);
  ...
  pNVar6 = local_28;
  uVar3 = Type::Intersect(*(undefined8 *)(local_28 + 8),1099,
