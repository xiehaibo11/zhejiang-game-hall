...
/* js_cocos2dx_dragonbones_AnimationState_set_nameRegistry(v8::Local<v8::Name>,
   v8::Local<v8::Value>, v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_AnimationState_set_nameRegistry
...

{
  ...
  if (lVar8 == 0) {
    ...
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_dragonbones_AnimationState_set_name : Invalid Native Object");
  }
  else {
    local_88 = 0;
    local_80 = 0;
    ...
    if ((uVar9 & 1) == 0) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0x1264,&DAT_0192a5b5);
      __android_log_print(6,"jswrapper",
                          "js_cocos2dx_dragonbones_AnimationState_set_name : Error processing new value"
                         );
      bVar3 = false;
    }
    else {
