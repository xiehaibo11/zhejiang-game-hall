...
Node * __thiscall
v8::internal::compiler::JSTypedLowering::ReduceJSIncrement(JSTypedLowering *this,Node *param_1)

{
  ...
  if ((local_18 == 0x5fff) || (uVar2 = Type::SlowIs((Type *)&local_18,0x5fff), (uVar2 & 1) != 0)) {
    ...
    pOVar4 = (Operator *)
             JSOperatorBuilder::Add(*(JSOperatorBuilder **)(*(long *)(this + 0x10) + 0x170),8);
