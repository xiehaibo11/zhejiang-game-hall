...
/* std::__ndk1::__tree<std::__ndk1::__value_type<int, v8::internal::RetainingPathOption>,
   std::__ndk1::__map_value_compare<int, std::__ndk1::__value_type<int,
   v8::internal::RetainingPathOption>, std::__ndk1::less<int>, true>,
   std::__ndk1::allocator<std::__ndk1::__value_type<int, v8::internal::RetainingPathOption> >
   >::destroy(std::__ndk1::__tree_node<std::__ndk1::__value_type<int,
   v8::internal::RetainingPathOption>, void*>*) */
