...
undefined8 __thiscall tinyxml2::XMLComment::ShallowEqual(XMLComment *this,XMLNode *param_1)
...
LAB_00913bd8:
      pcVar4 = pcVar4 + lVar2;
      if ((int)lVar2 == 0x7fffffff) goto LAB_00913bf8;
      if (bVar1) goto LAB_00913be8;
    }
    uVar5 = 0;
  }
  return uVar5;
