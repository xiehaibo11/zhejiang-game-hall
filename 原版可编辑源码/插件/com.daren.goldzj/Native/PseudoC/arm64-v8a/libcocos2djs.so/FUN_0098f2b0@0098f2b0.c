...
void FUN_0098f2b0(long *param_1,long *param_2)
  ...
  if (param_2 != param_1) {
    ...
    if (plVar2 == param_1) {
      if ((long *)param_2[4] == param_2) {
        ...
        param_2[4] = 0;
                    /* try { // try from 0098f3bc to 00a8f3bf has its CatchHandler @ 0098f3c4 */
        param_1[4] = (long)param_1;
                    /* try { // try from 0098f3c0 to 00a8f42b has its CatchHandler @ 0098f19c */
                    /* catch() { ... } // from try @ 0098f3bc with catch @ 0098f3c4 */
                    /* catch() { ... } // from try @ 0098f328 with catch @ 0098f3c8 */
        (**(code **)(local_60[0] + 0x18))(local_60,param_2);
        (**(code **)(local_60[0] + 0x20))(local_60);
      }
      else {
        (**(code **)(*plVar2 + 0x18))(plVar2,param_2);
                    /* try { // try from 0098f328 to 00a8f32b has its CatchHandler @ 0098f3c8 */
                    /* try { // try from 0098f32c to 00a8f3bb has its CatchHandler @ 0098f19c */
        (**(code **)(*(long *)param_1[4] + 0x20))();
        param_1[4] = param_2[4];
      }
