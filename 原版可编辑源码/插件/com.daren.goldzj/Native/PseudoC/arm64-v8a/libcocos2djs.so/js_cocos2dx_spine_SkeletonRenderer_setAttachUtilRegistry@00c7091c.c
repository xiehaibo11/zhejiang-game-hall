...
/* js_cocos2dx_spine_SkeletonRenderer_setAttachUtilRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonRenderer_setAttachUtilRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (SkeletonRenderer *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x328b,"js_cocos2dx_spine_SkeletonRenderer_setAttachUtil");
    pcVar7 = "js_cocos2dx_spine_SkeletonRenderer_setAttachUtil : Invalid Native Object";
LAB_00c70aa8:
...
LAB_00c70a70:
          __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                              "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                              ,0x3292,"js_cocos2dx_spine_SkeletonRenderer_setAttachUtil");
          pcVar7 = "js_cocos2dx_spine_SkeletonRenderer_setAttachUtil : Error processing arguments";
          goto LAB_00c70aa8;
        }
      }
      else {
        if (1 < (byte)pVVar5[8]) goto LAB_00c70a70;
        pRVar6 = (RealTimeAttachUtil *)0x0;
      }
      spine::SkeletonRenderer::setAttachUtil(this,pRVar6);
      goto LAB_00c70ae0;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 12950): wrong number of arguments: %d, was expecting %d\n"
                        ,(ulong)(puVar4[1] - (long)pVVar5) >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_SkeletonRenderer_setAttachUtil",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x3299);
LAB_00c70ae0:
