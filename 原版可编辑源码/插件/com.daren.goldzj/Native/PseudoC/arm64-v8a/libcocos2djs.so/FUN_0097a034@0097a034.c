...
void FUN_0097a034(long *param_1,long *param_2)
    ...
    if (plVar2 == param_1) {
      ...
      if (param_2 == plVar3) {
        ...
        param_1[4] = (long)param_1;
                    ...
                    /* try { // try from 0097a07c to 00a7a22b has its CatchHandler @ 0097a07c
                       catch() { ... } // from try @ 0097a07c with catch @ 0097a07c
                       catch() { ... } // from try @ 0097a268 with catch @ 0097a07c */
