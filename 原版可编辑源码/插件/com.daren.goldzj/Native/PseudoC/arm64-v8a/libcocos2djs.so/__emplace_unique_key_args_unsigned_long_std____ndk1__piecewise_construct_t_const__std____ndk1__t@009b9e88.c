...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<std::__ndk1::__hash_value_type<unsigned
   long, cocos2d::renderer::VertexFormat::Element>, void*>*>, bool>
   ...
   cocos2d::renderer::VertexFormat::Element> > >::__emplace_unique_key_args<unsigned long,
   std::__ndk1::piecewise_construct_t const&, std::__ndk1::tuple<unsigned long&&>,
   std::__ndk1::tuple<> >(unsigned long const&, std::__ndk1::piecewise_construct_t const&,
   std::__ndk1::tuple<unsigned long&&>&&, std::__ndk1::tuple<>&&) */
...

{
  ...
  undefined1 auVar9 [16];
                    ...
                    /* try { // try from 009b9e8c to 00ab9e9f has its CatchHandler @ 009ba2a4 */
  uVar7 = param_1[1];
  uVar8 = *(ulong *)param_2;
  if (uVar7 != 0) {
    uVar3 = uVar7 - 1;
    if ((uVar3 & uVar7) == 0) {
      ...
      unaff_x24 = uVar8;
                    /* try { // try from 009b9ec0 to 00ab9ec7 has its CatchHandler @ 009ba28c */
      if (uVar7 <= uVar8) {
        uVar5 = 0;
        if (uVar7 != 0) {
          uVar5 = uVar8 / uVar7;
    ...
    if (puVar6 != (ulong *)0x0) {
      do {
        puVar6 = (ulong *)*puVar6;
        if (puVar6 == (ulong *)0x0) goto LAB_009b9f3c;
        uVar5 = puVar6[1];
        if (uVar5 != uVar8) {
          if ((uVar3 & uVar7) == 0) {
            uVar5 = uVar5 & uVar3;
            ...
            if (uVar7 != 0) {
              uVar1 = uVar5 / uVar7;
                    ...
                    /* try { // try from 009b9f10 to 00aba013 has its CatchHandler @ 009ba2cc */
            if (uVar5 - uVar1 * uVar7 == unaff_x24) goto LAB_009b9f28;
            goto LAB_009b9f3c;
          }
          if (uVar5 != unaff_x24) goto LAB_009b9f3c;
        }
LAB_009b9f28:
