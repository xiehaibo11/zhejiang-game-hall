...
/* v8::internal::compiler::EffectControlLinearizer::LowerObjectIsSymbol(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::EffectControlLinearizer::LowerObjectIsSymbol
