...
LAB_017fb328:
  ...
  if ((param_2 == (long *)0x0) || (param_2[3] != param_2[4])) {
    if (param_3 != (long *)0x0) goto LAB_017fb33c;
LAB_017fb384:
    param_3 = (long *)0x0;
    if (plVar17 == (long *)0x0) goto LAB_017fb474;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_017fb384;
LAB_017fb33c:
...
LAB_017fb474:
  ...
  uVar5 = FUN_01828af4(pcVar19,local_168,param_5,iVar6);
  *param_6 = uVar5;
  uVar7 = (ulong)((byte)local_148[0] >> 1);
  if (((byte)local_148[0] & 1) != 0) {
    uVar7 = local_140;
  ...
  if (uVar7 != 0) {
    ...
    if (local_12c < puVar9) {
      ...
      do {
        if ((bVar16) && (*puVar15 != uVar10)) goto LAB_017fb5c8;
...
LAB_017fb5c8:
  ...
  if ((plVar17 == (long *)0x0) || (plVar17[3] != plVar17[4])) {
    if (param_3 != (long *)0x0) goto LAB_017fb5e4;
LAB_017fb690:
    if (plVar18 != (long *)0x0) goto LAB_017fb618;
  }
  else {
    ...
    if (param_3 == (long *)0x0) goto LAB_017fb690;
LAB_017fb5e4:
