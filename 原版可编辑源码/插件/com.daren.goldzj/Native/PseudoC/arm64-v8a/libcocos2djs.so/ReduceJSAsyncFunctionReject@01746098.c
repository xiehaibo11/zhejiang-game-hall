...
/* v8::internal::compiler::JSNativeContextSpecialization::ReduceJSAsyncFunctionReject(v8::internal::compiler::Node*)
    */

Node * __thiscall
v8::internal::compiler::JSNativeContextSpecialization::ReduceJSAsyncFunctionReject
...

{
  ...
  if (((ulong)this_00 & 1) == 0) {
    ...
    pGVar9 = (Graph *)**(undefined8 **)(this + 0x10);
    pOVar8 = (Operator *)
             JSOperatorBuilder::RejectPromise
    ...
    pNStack_78 = pNVar2;
    local_70 = uVar7;
    uVar3 = Graph::NewNode(pGVar9,pOVar8,7,&local_a0,false);
