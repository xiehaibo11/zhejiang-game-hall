...
/* js_cocos2dx_spine_BoneData_setShearXRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_BoneData_setShearXRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (BoneData *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0xc58,"js_cocos2dx_spine_BoneData_setShearX");
    pcVar6 = "js_cocos2dx_spine_BoneData_setShearX : Invalid Native Object";
LAB_00c27de8:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::BoneData::setShearX(this,local_64);
        goto LAB_00c27e20;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0xc5f,"js_cocos2dx_spine_BoneData_setShearX");
      pcVar6 = "js_cocos2dx_spine_BoneData_setShearX : Error processing arguments";
      goto LAB_00c27de8;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp, 3171): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_BoneData_setShearX",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0xc66);
LAB_00c27e20:
