...
/* v8::Object::Delete(v8::Local<v8::Context>, unsigned int) */

ushort __thiscall v8::Object::Delete(Object *this,long param_2,undefined4 param_3)

{
  ...
  *(undefined4 *)(pIVar10 + 0x2c60) = 5;
  uVar3 = internal::JSReceiver::DeleteElement(this,param_3,0);
  if ((uVar3 & 0xff) == 0) {
    local_a0 = '\x01';
