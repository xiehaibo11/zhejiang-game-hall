...
/* void std::__ndk1::vector<std::__ndk1::pair<int, v8::internal::HeapObject>,
   std::__ndk1::allocator<std::__ndk1::pair<int, v8::internal::HeapObject> >
...

{
  ...
  if (uVar1 >> 0x3c == 0) {
    ...
    if (uVar1 == 0) {
      ...
      if (uVar1 >> 0x3c != 0) goto LAB_00f9d0ec;
