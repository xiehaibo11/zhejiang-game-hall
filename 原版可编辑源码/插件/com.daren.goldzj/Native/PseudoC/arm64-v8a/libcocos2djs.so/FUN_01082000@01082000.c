...
ulong FUN_01082000(ulong *param_1,int param_2)

{
  ...
  bVar1 = *(byte *)(((ulong)pIVar4 | 10) + (ulong)*(uint *)(uVar8 - 1));
  if (bVar1 < 0x20) {
    v8::internal::Isolate::UpdateNoElementsProtectorOnSetElement(pIVar4,param_1);
    uVar8 = *param_1;
    pIVar4 = (Isolate *)(uVar8 & 0xffffffff00000000);
  }
  uVar8 = (ulong)pIVar4 | (ulong)*(uint *)(uVar8 + 7);
  ...
  puVar6 = (ulong *)v8::internal::Factory::NewUninitializedFixedArray(this,param_2);
  FUN_010821fc(this,*puVar5,0,*puVar6,bVar1 >> 3,0,0xffffffff);
  bVar2 = bVar1 < 0x30 & bVar1 >> 3;
  uVar7 = v8::internal::JSObject::GetElementsTransitionMap(param_1,bVar2);
  v8::internal::JSObject::MigrateToMap((ulong)*(uint *)((long)param_1 + 4) << 0x20,param_1,uVar7,0);
  uVar10 = *param_1;
  uVar8 = *puVar6;
  *(int *)(uVar10 + 7) = (int)uVar8;
  ...
  bVar3 = v8::internal::JSObject::UpdateAllocationSite<(v8::internal::AllocationSiteUpdateMode)0>
                    (param_1,bVar2);
  if (v8::internal::FLAG_trace_elements_transitions == '\0') {
    return (ulong)bVar3;
  }
  uVar8 = v8::internal::JSObject::PrintElementsTransition
                    (waitpid,param_1,bVar1 >> 3,puVar5,bVar2,puVar6);
  return uVar8;
}
