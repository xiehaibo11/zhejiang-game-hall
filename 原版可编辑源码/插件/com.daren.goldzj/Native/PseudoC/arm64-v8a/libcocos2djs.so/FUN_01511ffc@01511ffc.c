...
/* WARNING: Heritage AFTER dead removal. Example location: x0 : 0x01512048 */
/* WARNING: Restarted to delay deadcode elimination for space: register */

undefined8 FUN_01511ffc(long param_1,Literal *param_2)
...
LAB_01512168:
      ...
      if (uVar1 == 0) {
        ...
        if (uVar1 >> 0x3c != 0) goto LAB_01512168;
