...
/* v8::internal::compiler::WasmGraphBuilder::BuildTruncateIntPtrToInt32(v8::internal::compiler::Node*)
    */

Node * __thiscall
v8::internal::compiler::WasmGraphBuilder::BuildTruncateIntPtrToInt32
...

{
  ...
  if (this_00[0x10] == (MachineOperatorBuilder)0x5) {
    ...
    pOVar1 = (Operator *)MachineOperatorBuilder::TruncateInt64ToInt32(this_00);
    local_28 = param_1;
