...
/* void std::__ndk1::__sort<bool (*&)(v8::internal::compiler::MoveOperands const*,
...
LAB_0164fc88:
  param_1 = (MoveOperands **)pauVar12;
  lVar7 = (long)param_2 - (long)param_1;
  uVar6 = lVar7 >> 3;
  switch(uVar6) {
  case 0:
  case 1:
    goto switchD_0164ffec_caseD_0;
  case 2:
    uVar6 = (**(code **)param_3)
  ...
  case 4:
    __sort4<bool(*&)(v8::internal::compiler::MoveOperands_const*,v8::internal::compiler::MoveOperands_const*),v8::internal::compiler::MoveOperands**>
              (param_1,(MoveOperands **)(*(undefined1 (*) [16])param_1 + 8),
               (MoveOperands **)((long)param_1 + 0x10),(MoveOperands **)pauVar11,param_3);
    return;
  case 5:
    FUN_016502e4(param_1,*(undefined1 (*) [16])param_1 + 8,
      ...
      if ((uVar6 & 1) == 0) {
        if ((uVar5 & 1) == 0) {
          ...
          *(undefined8 *)*pauVar11 = uVar8;
          uVar6 = (**(code **)param_3)
                            (*(undefined8 *)*pauVar12,*(undefined8 *)*(undefined1 (*) [16])param_1);
          if ((uVar6 & 1) == 0) goto LAB_0164ff44;
          uVar8 = *(undefined8 *)*(undefined1 (*) [16])param_1;
...
LAB_0164ff44:
      ...
      iVar4 = FUN_016502e4(param_1,*(undefined1 (*) [16])param_1 + lVar7,pauVar12,*pauVar12 + lVar7,
                           pauVar11,param_3);
    }
    uVar6 = (**(code **)param_3)
                      (*(undefined8 *)*(undefined1 (*) [16])param_1,*(undefined8 *)*pauVar12);
  ...
  while (pauVar13 = pauVar10, (undefined1 (*) [16])param_1 != pauVar13) {
    ...
    if ((uVar6 & 1) != 0) goto code_r0x0164fd78;
  }
...
LAB_0164fd8c:
  ...
  if (iVar4 == 0) {
    bVar2 = __insertion_sort_incomplete<bool(*&)(v8::internal::compiler::MoveOperands_const*,v8::internal::compiler::MoveOperands_const*),v8::internal::compiler::MoveOperands**>
                      (param_1,(MoveOperands **)pauVar10,param_3);
    bVar3 = __insertion_sort_incomplete<bool(*&)(v8::internal::compiler::MoveOperands_const*,v8::internal::compiler::MoveOperands_const*),v8::internal::compiler::MoveOperands**>
                      ((MoveOperands **)(*pauVar10 + 8),param_2,param_3);
    if (bVar3) goto LAB_0164ffcc;
    pauVar12 = (undefined1 (*) [16])(*pauVar10 + 8);
    if (bVar2) goto LAB_0164fc88;
  }
  if ((long)param_2 - (long)pauVar10 <= (long)pauVar10 - (long)param_1) {
    __sort<bool(*&)(v8::internal::compiler::MoveOperands_const*,v8::internal::compiler::MoveOperands_const*),v8::internal::compiler::MoveOperands**>
              ((MoveOperands **)(*pauVar10 + 8),param_2,param_3);
    param_2 = (MoveOperands **)pauVar10;
    goto LAB_0164fc74;
  }
  __sort<bool(*&)(v8::internal::compiler::MoveOperands_const*,v8::internal::compiler::MoveOperands_const*),v8::internal::compiler::MoveOperands**>
            (param_1,(MoveOperands **)pauVar10,param_3);
