...
/* void JSBClassType::registerClass<spine::AnimationStateData>(se::Class*) */

void JSBClassType::registerClass<spine::AnimationStateData>(Class *param_1)
