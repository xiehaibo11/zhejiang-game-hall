...
/* JSB_glBlendEquationSeparateRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glBlendEquationSeparateRegistry(FunctionCallbackInfo *param_1)
  ...
  if ((plVar6[1] - *plVar6 & 0xffffffff0U) == 0x20) {
    ...
    if ((uVar3 & uVar4 & 1) == 0) {
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          ...
                          ,0x2c3,"JSB_glBlendEquationSeparate");
      __android_log_print(6,"jswrapper",&DAT_0190552e);
    }
    else {
      if ((local_64 - 0x8006 < 6) && ((1 << (ulong)(local_64 - 0x8006 & 0x1f) & 0x31U) != 0)) {
        if ((local_68 - 0x8006 < 6) && ((1 << (ulong)(local_68 - 0x8006 & 0x1f) & 0x31U) != 0)) {
          glBlendEquationSeparate();
          goto LAB_008b6aa8;
        }
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                            ,0x2c9,"JSB_glBlendEquationSeparate");
      }
      else {
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_opengl_manual.cpp"
                            ,0x2c6,"JSB_glBlendEquationSeparate");
      }
      DAT_01d36f40 = 0x500;
    }
  }
