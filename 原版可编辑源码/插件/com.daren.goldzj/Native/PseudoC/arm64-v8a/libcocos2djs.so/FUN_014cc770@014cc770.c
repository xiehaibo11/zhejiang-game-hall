...
undefined8 FUN_014cc770(undefined8 param_1,ulong *param_2,Isolate *param_3)

{
  ...
  *(int *)(param_3 + 0x95b0) = *(int *)(param_3 + 0x95b0) + 1;
  ...
  uVar8 = *param_2;
  if (((uVar8 & 1) == 0) ||
     (puVar5 = param_2, puVar3 = local_60,
  ...
  if (puVar5 == (ulong *)0x0) {
    ...
    {
      local_60 = puVar3;
      puVar6 = (undefined8 *)v8::internal::Factory::NewTypeError((Factory *)param_3,0x6b,0,0,0);
