...
/* void v8::internal::CallIterateBody::apply<v8::internal::JSWeakRef::BodyDescriptor,
   v8::internal::ObjectVisitor>(v8::internal::Map, v8::internal::HeapObject, int,
   v8::internal::ObjectVisitor*) */

void v8::internal::CallIterateBody::
     apply<v8::internal::JSWeakRef::BodyDescriptor,v8::internal::ObjectVisitor>
...

{
  ...
  (**(code **)(*param_4 + 0x38))(param_4,param_2,param_2 + 0xb);
  ...
  if (iVar1 < (int)lVar2) {
    lVar4 = (long)iVar1;
    (**(code **)(*param_4 + 0x10))(param_4,param_2,param_2 + 0xf,lVar3 + lVar4);
    do {
    ...
    lVar2 = 0x10;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0111d968. Too many branches */
