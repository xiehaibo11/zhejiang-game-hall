...
/* js_renderer_ForwardRenderer_constructorRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_renderer_ForwardRenderer_constructorRegistry(FunctionCallbackInfo *param_1)

{
  ...
  this = (Object *)
         se::Object::_createJSObject
                   (__jsb_cocos2d_renderer_ForwardRenderer_class,*(long *)(param_1 + 8) + 8);
  se::Object::_setFinalizeCallback(this,js_cocos2d_renderer_ForwardRenderer_finalizeRegistry);
  se::State::State(aSStack_60,this,(vector *)&local_a0);
  this_00 = operator_new(0x100,(nothrow_t *)&std::nothrow);
  if (this_00 != (ForwardRenderer *)0x0) {
    cocos2d::renderer::ForwardRenderer::ForwardRenderer(this_00);
  }
