...

{
  ...
  if ((int)param_4 < 0x40) {
    ...
    rp = (ulong *)(param_1 + uVar3 * 8);
                    /* try { // try from 00afd938 to 00bfd98b has its CatchHandler @ 00afd938
                       catch() { ... } // from try @ 00afd938 with catch @ 00afd938
                       catch() { ... } // from try @ 00afda20 with catch @ 00afd938
                       catch() { ... } // from try @ 00afda68 with catch @ 00afd938 */
