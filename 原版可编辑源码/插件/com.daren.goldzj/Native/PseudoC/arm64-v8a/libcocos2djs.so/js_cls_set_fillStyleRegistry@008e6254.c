...
/* js_cls_set_fillStyleRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_cls_set_fillStyleRegistry(undefined8 param_1,undefined8 param_2,long *param_3)
  ...
  if (this == (CanvasRenderingContext2D *)0x0) {
    ...
    if (plVar6[1] - *plVar6 == 0x10) {
      ...
      if (bVar1) {
        ...
        cocos2d::CanvasRenderingContext2D::set_fillStyle(this,(basic_string *)&local_88);
      }
      if ((local_88 & 1) != 0) {
        operator_delete(local_78);
      }
      if (!bVar1) goto LAB_008e6420;
    }
    else {
      __android_log_print(6,"jswrapper",
                          "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_cocos2dx_manual.cpp, 410): wrong number of arguments: %d, was expecting %d\n"
                          ,(ulong)(plVar6[1] - *plVar6) >> 4,1);
    }
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cls_set_fillStyle",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/scripting/js-bindings/manual/jsb_cocos2dx_manual.cpp"
                      ,0x19a);
LAB_008e6420:
