...
/* js_cocos2dx_dragonbones_Animation_advanceTimeRegistry(v8::FunctionCallbackInfo<v8::Value> const&)
    */

void js_cocos2dx_dragonbones_Animation_advanceTimeRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Animation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1755,0x192ae9f);
    pcVar6 = "js_cocos2dx_dragonbones_Animation_advanceTime : Invalid Native Object";
LAB_00cbdebc:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        dragonBones::Animation::advanceTime(this,local_64);
        goto LAB_00cbdef4;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                          ,0x175c,0x192ae9f);
      pcVar6 = "js_cocos2dx_dragonbones_Animation_advanceTime : Error processing arguments";
      goto LAB_00cbdebc;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp, 5984): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
