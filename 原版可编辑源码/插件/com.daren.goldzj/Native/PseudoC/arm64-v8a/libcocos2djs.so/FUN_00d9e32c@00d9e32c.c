...
undefined8 FUN_00d9e32c(long *param_1,long *param_2)

{
  ...
  if (*(int *)(lVar8 + 0x28) != -1) {
    ...
    do {
      ...
      if ((iVar13 <= iVar6) && (iVar2 = FUN_00d9e97c(param_1,lVar7), iVar2 != 0)) {
        return 1;
      }
      lVar12 = (long)iVar6;
      lVar7 = lVar7 + 2;
      while( true ) {
        ...
        iVar2 = FUN_00d9e97c(param_1,lVar7 + -1);
        if (iVar2 != 0) {
          iVar2 = FUN_00d9e97c(param_1,lVar8 + 0x150);
          piVar5 = &local_64;
          if (iVar2 != 0) {
            piVar5 = &local_68;
          }
      ...
      iVar2 = FUN_00d9e97c(param_1,lVar7);
      if (iVar2 != 0) {
