...
/* v8::internal::compiler::GraphAssembler::Word64ReverseBytes(v8::internal::compiler::Node*) */

Node * __thiscall
v8::internal::compiler::GraphAssembler::Word64ReverseBytes(GraphAssembler *this,Node *param_1)

{
  ...
  pOVar2 = (Operator *)
           MachineOperatorBuilder::Word64ReverseBytes
