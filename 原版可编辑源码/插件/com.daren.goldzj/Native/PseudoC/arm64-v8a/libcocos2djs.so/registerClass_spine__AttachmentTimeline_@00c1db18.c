...
/* void JSBClassType::registerClass<spine::AttachmentTimeline>(se::Class*) */

void JSBClassType::registerClass<spine::AttachmentTimeline>(Class *param_1)
