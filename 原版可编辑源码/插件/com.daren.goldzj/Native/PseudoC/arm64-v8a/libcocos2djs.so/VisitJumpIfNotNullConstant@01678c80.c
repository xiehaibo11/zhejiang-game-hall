...
/* v8::internal::compiler::BytecodeGraphBuilder::VisitJumpIfNotNullConstant() */

void __thiscall
v8::internal::compiler::BytecodeGraphBuilder::VisitJumpIfNotNullConstant(BytecodeGraphBuilder *this)
