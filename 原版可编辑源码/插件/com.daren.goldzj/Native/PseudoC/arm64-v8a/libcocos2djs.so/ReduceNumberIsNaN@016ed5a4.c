...
/* v8::internal::compiler::JSCallReducer::ReduceNumberIsNaN(v8::internal::compiler::Node*) */

undefined8 __thiscall
v8::internal::compiler::JSCallReducer::ReduceNumberIsNaN(JSCallReducer *this,Node *param_1)
