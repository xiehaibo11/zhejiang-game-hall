...
/* std::__ndk1::pair<std::__ndk1::__hash_iterator<std::__ndk1::__hash_node<v8::internal::CompilerDispatcher::Job*,
   ...
   v8::internal::CompilerDispatcher::Job*>(v8::internal::CompilerDispatcher::Job* const&,
   v8::internal::CompilerDispatcher::Job*&&) */
      ...
      for (plVar9 = (long *)*plVar9; plVar9 != (long *)0x0; plVar9 = (long *)*plVar9) {
        ...
        if (uVar8 != uVar7) {
          if (uVar5 < 2) {
            ...
            if (uVar8 - uVar1 * uVar10 == unaff_x24) goto LAB_00ef7094;
            break;
          }
