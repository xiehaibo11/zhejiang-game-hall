...
/* v8::internal::StackTraceFrame::GetScriptId(v8::internal::Handle<v8::internal::StackTraceFrame>)
    */

int v8::internal::StackTraceFrame::GetScriptId(ulong *param_1)
