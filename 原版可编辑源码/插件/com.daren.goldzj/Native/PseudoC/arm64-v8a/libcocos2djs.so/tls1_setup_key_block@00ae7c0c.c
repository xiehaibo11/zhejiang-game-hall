      ...
      *(int *)(lVar5 + 0x27c) = local_40;
      ...
      if (pvVar4 != (void *)0x0) {
        ...
        *(void **)(lVar5 + 0x260) = pvVar4;
                    /* try { // try from 00ae7d08 to 00be7d0f has its CatchHandler @ 00ae7dfc */
                    /* try { // try from 00ae7d10 to 00be7e23 has its CatchHandler @ 00ae7b04 */
        uVar3 = FUN_00ae7e74(param_1,"key expansion",0xd,lVar5 + 0x90,0x20,lVar5 + 0xb0,0x20,0,0,
