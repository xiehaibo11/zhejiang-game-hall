...
/* JSB_glGetShaderSourceRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glGetShaderSourceRegistry(FunctionCallbackInfo *param_1)
...
LAB_008cd954:
      ...
      if (1 < (byte)VVar1) goto LAB_008cd954;
      uVar10 = 0;
    }
    glGetShaderiv(uVar10,0x8b88,&local_74);
    if ((local_74 < 1) || (iVar4 = glGetError(), iVar4 != 0)) {
      ...
      glGetShaderSource(uVar10,local_74,0,pcVar9);
      pVVar7 = (Value *)se::State::rval(aSStack_70);
