...
long * FUN_00b2a1f4(long param_1,ENGINE *param_2,int param_3)
...
LAB_00b2a2a8:
    ...
    if (param_2 == (ENGINE *)0x0) goto LAB_00b2a22c;
LAB_00b2a2bc:
...
joined_r0x00b2a278:
    ...
    if (param_1 != 0) goto LAB_00b2a2a8;
    bVar1 = false;
    if (param_2 != (ENGINE *)0x0) goto LAB_00b2a2bc;
LAB_00b2a22c:
    param_2 = ENGINE_get_pkey_meth_engine(param_3);
    if (param_2 != (ENGINE *)0x0) goto LAB_00b2a2c8;
    local_118 = local_110;
    local_110[0] = param_3;
    if ((DAT_01d3aa90 != 0) && (iVar2 = OPENSSL_sk_find(DAT_01d3aa90,local_110), -1 < iVar2)) {
      pEVar3 = (EVP_PKEY_METHOD *)OPENSSL_sk_value(DAT_01d3aa90,iVar2);
      param_2 = (ENGINE *)0x0;
      goto joined_r0x00b2a278;
    }
    plVar4 = OBJ_bsearch_(&local_118,&PTR_rsa_pkey_meth_01d207d0,10,8,(cmp *)&LAB_00b2ab18);
    if (plVar4 != (long *)0x0) {
