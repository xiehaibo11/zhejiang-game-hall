...
/* JSB_glViewportRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glViewportRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if ((plVar8[1] - *plVar8 & 0xffffffff0U) == 0x40) {
    uVar3 = seval_to_int32((Value *)*plVar8,&iStack_74);
