...
/* void std::__ndk1::vector<v8::internal::compiler::Variable,
   v8::internal::ZoneAllocator<v8::internal::compiler::Variable>
   >::__push_back_slow_path<v8::internal::compiler::Variable>(v8::internal::compiler::Variable&&) */
