...
void FUN_0144b980(ulong param_1)

{
  ...
  uVar6 = *(ulong *)(unaff_x29 + (long)*(short *)(unaff_x20 + unaff_x19 + 1) * 8);
  lVar7 = unaff_x26 +
  ...
  uVar16 = (ulong)uVar9;
  lVar11 = (ulong)*(ushort *)(unaff_x20 + unaff_x19 + 3) * 4 + 0x1f;
...
LAB_0144bd24:
      ...
      if ((uVar13 == 0) &&
        ...
        *(undefined4 *)(lVar7 + 0x17) = 0;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0144bd98. Too many branches */
