...
LAB_0181da70:
    ...
    if (param_6 <= param_5) goto LAB_0181da64;
    bVar4 = *param_2;
    uVar7 = (ulong)bVar4;
    if ((char)bVar4 < '\0') {
      if (0xc1 < bVar4) {
...
LAB_0181da64:
          ...
          if (((param_2[1] & 0xc0U) == 0x80) &&
             (uVar7 = (ulong)(byte)param_2[1] & 0x3f | (uVar7 & 0x1f) << 6, uVar7 <= uVar6)) {
            lVar9 = 2;
            goto LAB_0181da4c;
          }
        }
        else if (bVar4 < 0xf0) {
          if ((long)param_3 - (long)param_2 < 3) goto LAB_0181da64;
          bVar3 = param_2[1];
          if (bVar4 == 0xed) {
            bVar4 = bVar3 & 0xe0;
joined_r0x0181da10:
            if (bVar4 != 0x80) goto LAB_0181da6c;
          }
          else {
            if (bVar4 != 0xe0) {
              bVar4 = bVar3 & 0xc0;
              goto joined_r0x0181da10;
            }
            if ((bVar3 & 0xe0) != 0xa0) goto LAB_0181da6c;
          }
...
LAB_0181da6c:
    ...
    if (uVar6 < uVar7) goto LAB_0181da6c;
    lVar9 = 1;
LAB_0181da4c:
