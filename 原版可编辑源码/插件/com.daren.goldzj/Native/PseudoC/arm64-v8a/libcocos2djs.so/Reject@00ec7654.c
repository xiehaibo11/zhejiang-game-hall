...
/* v8::Promise::Resolver::Reject(v8::Local<v8::Context>, v8::Local<v8::Value>) */

undefined8 __thiscall v8::Promise::Resolver::Reject(Resolver *this,long param_2,undefined8 param_3)

{
  ...
  *(int *)pIVar15 = *(int *)pIVar15 + 1;
  ...
  if (internal::TracingFlags::runtime_stats != 0) {
    ...
    internal::RuntimeCallStats::Enter(local_e0,(ulong)&local_e0 | 8,0x3bd);
  }
  this_00 = *(Logger **)(pIVar10 + 0x9558);
  uVar4 = internal::Logger::is_logging(this_00);
  if ((uVar4 & 1) != 0) {
    internal::Logger::ApiEntryCall(this_00,"v8::Promise_Resolver::Reject");
  }
  uVar1 = *(undefined4 *)(pIVar10 + 0x2c60);
  *(undefined4 *)(pIVar10 + 0x2c60) = 5;
  local_e8 = *(undefined8 *)this;
  iVar3 = internal::JSPromise::status((JSPromise *)&local_e8);
  if ((iVar3 == 0) && (lVar5 = internal::JSPromise::Reject(this,param_3,1), lVar5 == 0)) {
    local_a0 = '\x01';
