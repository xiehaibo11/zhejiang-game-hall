...
/* js_cocos2dx_spine_MeshAttachment_setRegionDegreesRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_MeshAttachment_setRegionDegreesRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (MeshAttachment *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x17a7,"js_cocos2dx_spine_MeshAttachment_setRegionDegrees");
    pcVar6 = "js_cocos2dx_spine_MeshAttachment_setRegionDegrees : Invalid Native Object";
LAB_00c3c29c:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        spine::MeshAttachment::setRegionDegrees(this,local_64);
        goto LAB_00c3c2d4;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x17ae,"js_cocos2dx_spine_MeshAttachment_setRegionDegrees");
      pcVar6 = "js_cocos2dx_spine_MeshAttachment_setRegionDegrees : Error processing arguments";
      goto LAB_00c3c29c;
    }
    __android_log_print(6,"jswrapper",&DAT_0190502d,uVar7 >> 4,1);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_MeshAttachment_setRegionDegrees",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x17b5);
LAB_00c3c2d4:
