...
/* v8::internal::compiler::MachineOperatorBuilder::I32x4ReplaceLane(int) */

Operator * __thiscall
v8::internal::compiler::MachineOperatorBuilder::I32x4ReplaceLane
...

{
  ...
  Operator::Operator(pOVar1,0x23e,0x7c,"Replace lane",2,0,0,1,0,0);
