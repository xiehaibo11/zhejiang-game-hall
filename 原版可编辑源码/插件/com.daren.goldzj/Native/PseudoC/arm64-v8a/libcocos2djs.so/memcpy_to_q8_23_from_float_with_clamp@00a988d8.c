  ...
  if (param_3 != 0) {
    if (param_3 == 1) {
      ...
      uVar6 = NEON_fmov(0xbf800000,4);
                    /* try { // try from 00a98908 to 00b98927 has its CatchHandler @ 00a98944 */
      ...
      puVar3 = (ulong *)((long)param_1 + uVar4 * 4);
                    /* try { // try from 00a98928 to 00b9895f has its CatchHandler @ 00a98810 */
      uVar5 = uVar4;
      do {
        uVar5 = uVar5 - 2;
        fVar9 = (float)*(undefined8 *)param_2;
        iVar11 = -(uint)(fVar9 <= (float)uVar6);
        fVar10 = (float)((ulong)*(undefined8 *)param_2 >> 0x20);
        iVar13 = -(uint)(fVar10 <= (float)((ulong)uVar6 >> 0x20));
        iVar14 = -(uint)(0.9999999 <= fVar9);
        iVar15 = -(uint)(0.9999999 <= fVar10);
                    /* catch() { ... } // from try @ 00a98908 with catch @ 00a98944 */
        auVar16._0_8_ = (long)(int)-(uint)(0.0 < fVar9 * 8388608.0);
        auVar16._8_8_ = (long)(int)-(uint)(0.0 < fVar10 * 8388608.0);
        auVar16 = auVar7 ^ (auVar7 ^ auVar8) & auVar16;
        uVar12 = CONCAT44((int)(long)(auVar16._8_8_ + (double)(fVar10 * 8388608.0)),
                          (int)(long)(auVar16._0_8_ + (double)(fVar9 * 8388608.0)));
      ...
      while( true ) {
        ...
        if (0.9999999 <= fVar9) {
          *(int *)puVar3 = 0x7fffff;
          ...
          fVar10 = 0.5;
          if (fVar9 * 8388608.0 <= 0.0) {
            fVar10 = -0.5;
          }
          *(int *)puVar3 = (int)(fVar10 + fVar9 * 8388608.0);
        }
        pfVar2 = pfVar2 + 1;
