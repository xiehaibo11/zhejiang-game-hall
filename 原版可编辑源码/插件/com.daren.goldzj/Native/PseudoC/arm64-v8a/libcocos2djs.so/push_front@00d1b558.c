...
/* std::__ndk1::__split_buffer<spine::SkeletonCacheAnimation::AniQueueData**,
   std::__ndk1::allocator<spine::SkeletonCacheAnimation::AniQueueData**>&>::push_front(spine::SkeletonCacheAnimation::AniQueueData**
   const&) */
...

{
  ...
  puVar14 = __src;
  if (__src != *(undefined8 **)this) goto LAB_00d1b6f0;
...
LAB_00d1b6c0:
      ...
      if (uVar2 != uVar10) goto LAB_00d1b6c0;
    }
