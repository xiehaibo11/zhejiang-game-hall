...
/* v8::internal::interpreter::BytecodeArrayBuilder::CreateEvalContext(v8::internal::Scope const*,
   int) */

BytecodeArrayBuilder * __thiscall
v8::internal::interpreter::BytecodeArrayBuilder::CreateEvalContext
          (BytecodeArrayBuilder *this,Scope *param_1,int param_2)
