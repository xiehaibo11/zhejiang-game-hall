...
/* js_cocos2dx_spine_Bone_getCRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void js_cocos2dx_spine_Bone_getCRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (Bone *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x73b,"js_cocos2dx_spine_Bone_getC");
    puVar7 = &DAT_018f673a;
LAB_00c1e824:
    ...
    if (plVar4[1] - *plVar4 == 0) {
      fVar9 = (float)spine::Bone::getC(this);
      pVVar6 = (Value *)se::State::rval(aSStack_60);
      uVar5 = float_to_seval(fVar9,pVVar6);
      if ((uVar5 & 1) != 0) goto LAB_00c1e85c;
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                          ,0x742,"js_cocos2dx_spine_Bone_getC");
      puVar7 = &DAT_018f676e;
      goto LAB_00c1e824;
    }
    __android_log_print(6,"jswrapper",&DAT_018f67a7,(ulong)(plVar4[1] - *plVar4) >> 4,0);
  }
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_spine_Bone_getC",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                      ,0x748);
LAB_00c1e85c:
  pVVar6 = (Value *)se::State::rval(aSStack_60);
