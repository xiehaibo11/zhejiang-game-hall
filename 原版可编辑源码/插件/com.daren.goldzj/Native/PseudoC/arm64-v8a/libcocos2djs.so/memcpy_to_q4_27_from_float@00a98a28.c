  ...
  if (param_3 != 0) {
    if (param_3 == 1) {
      ...
      do {
        ...
        auVar27._0_8_ = (long)(int)-(uint)(0.0 < fVar10 * 1.3421773e+08);
        ...
        uVar13 = CONCAT44((int)(long)(auVar27._8_8_ + (double)(fVar11 * 1.3421773e+08)),
                          (int)(long)(auVar27._0_8_ + (double)(fVar10 * 1.3421773e+08)));
    ...
    do {
      while( true ) {
        ...
        if (16.0 <= fVar10) {
          ...
          *piVar3 = (int)(fVar11 + fVar10 * 1.3421773e+08);
        }
        pfVar2 = pfVar2 + 1;
        piVar3 = piVar3 + 1;
        if (lVar1 == 0) {
