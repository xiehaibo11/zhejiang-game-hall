...
/* v8::internal::compiler::GraphAssembler::ChangeTaggedToCompressed(v8::internal::compiler::Node*)
    */

Node * __thiscall
v8::internal::compiler::GraphAssembler::ChangeTaggedToCompressed(GraphAssembler *this,Node *param_1)
