...
/* v8::internal::JavaScriptFrame::Iterate(v8::internal::RootVisitor*) const */

void __thiscall v8::internal::JavaScriptFrame::Iterate(JavaScriptFrame *this,RootVisitor *param_1)
