...
/* v8::internal::compiler::Operator1<v8::internal::compiler::NumberOperationParameters,
   ...
   v8::internal::compiler::OpHash<v8::internal::compiler::NumberOperationParameters>
...
::PrintToImpl(Operator1<v8::internal::compiler::NumberOperationParameters,v8::internal::compiler::OpEqualTo<v8::internal::compiler::NumberOperationParameters>,v8::internal::compiler::OpHash<v8::internal::compiler::NumberOperationParameters>>
...

{
  ...
  std::__ndk1::__put_character_sequence<char,std::__ndk1::char_traits<char>>(param_1,__s,sVar1);
                    /* WARNING: Could not recover jumptable at 0x012f7808. Too many branches */
