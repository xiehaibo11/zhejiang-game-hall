...
/* v8::internal::TranslatedState::EnsureObjectAllocatedAt(v8::internal::TranslatedValue*) */

void __thiscall
v8::internal::TranslatedState::EnsureObjectAllocatedAt
          (TranslatedState *this,TranslatedValue *param_1)

{
  ...
  if (param_1[1] == (TranslatedValue)0x0) {
    uStack_48 = 0;
    ...
    *(undefined4 *)
    ...
    while (lVar7 != 0) {
      ...
      EnsureCapturedObjectAllocatedAt(this,iVar5,(stack *)&local_60);
      lVar7 = local_38;
    }
    local_38 = 0;
