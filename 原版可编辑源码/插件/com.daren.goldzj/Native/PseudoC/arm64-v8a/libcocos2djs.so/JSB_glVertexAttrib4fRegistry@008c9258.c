...
/* JSB_glVertexAttrib4fRegistry(v8::FunctionCallbackInfo<v8::Value> const&) */

void JSB_glVertexAttrib4fRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if ((plVar9[1] - *plVar9 & 0xffffffff0U) == 0x50) {
    uVar3 = seval_to_uint32((Value *)*plVar9,&local_84);
