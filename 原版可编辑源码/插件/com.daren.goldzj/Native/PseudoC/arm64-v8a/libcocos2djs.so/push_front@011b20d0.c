...
/* std::__ndk1::__split_buffer<v8::internal::CpuProfile::SampleInfo*,
   std::__ndk1::allocator<v8::internal::CpuProfile::SampleInfo*>&>::push_front(v8::internal::CpuProfile::SampleInfo*
   const&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_011b225c;
...
LAB_011b2230:
      ...
      if (((void *)((long)pvVar4 + uVar13 * 8) < (void *)((long)__src + uVar9 + 8)) &&
         (__src < (undefined8 *)((long)pvVar4 + uVar9 + uVar13 * 8 + 8))) goto LAB_011b2230;
      ...
      puVar7 = puVar8;
      if (uVar2 != uVar9) goto LAB_011b2230;
    }
