...
void FUN_01643a78(int *param_1,int *param_2,undefined8 param_3,ulong param_4,int *param_5)
  ...
  if (param_4 != 0) {
    if (param_4 == 2) {
      ...
      *(undefined8 *)param_5 = uVar9;
      ...
      FUN_01643828(param_1,piVar1,param_3,uVar8,param_5,uVar8);
      FUN_01643828(piVar1,param_2,param_3,param_4 - uVar8,param_5 + uVar8 * 4,param_4 - uVar8);
      piVar2 = piVar1;
      piVar6 = param_5;
      piVar5 = param_1;
      if (uVar8 != 0) {
