...
undefined4 FUN_00a18f14(char *param_1,undefined8 *param_2,long *param_3)
  ...
  if ((sVar3 != 0) && ((sVar3 & 3) == 0)) {
    ...
    while (cVar1 != '\0') {
      ...
      if (cVar1 == '=') {
        ...
        if (sVar9 == sVar6) goto LAB_00a18fac;
        goto LAB_00a19d90;
      }
      sVar6 = sVar6 - 1;
      cVar1 = *pcVar8;
...
LAB_00a18fac:
      ...
      puVar4 = (undefined1 *)(*(code *)PTR_malloc_01d1b740)(lVar12 + 1);
        ...
        if (uVar14 != 0) {
          ...
          do {
            ...
            case '9':
              ...
              break;
            case '=':
              goto switchD_00a1901c_caseD_3d;
            case 'A':
              break;
            case 'B':
...
switchD_00a1901c_caseD_3d:
            ...
            if (*pcVar10 != cVar1) goto LAB_00a19d7c;
...
joined_r0x00a19a94:
            if (lVar13 == 0) {
              uVar2 = FUN_00a16cd8(uVar16 & 0xff);
              puVar17[2] = uVar2;
LAB_00a19d24:
              uVar2 = FUN_00a16cd8(uVar16 >> 8 & 0xff);
              puVar17[1] = uVar2;
            }
            else if (lVar13 == 1) goto LAB_00a19d24;
            uVar2 = FUN_00a16cd8(uVar16 >> 0x10 & 0xff);
            *puVar17 = uVar2;
            if (3 - lVar13 == 0) goto LAB_00a19d7c;
            uVar15 = uVar15 + 1;
