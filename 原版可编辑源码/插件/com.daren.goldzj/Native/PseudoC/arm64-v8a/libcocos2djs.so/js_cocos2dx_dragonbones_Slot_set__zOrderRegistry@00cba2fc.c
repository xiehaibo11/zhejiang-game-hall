...
/* js_cocos2dx_dragonbones_Slot_set__zOrderRegistry(v8::Local<v8::Name>, v8::Local<v8::Value>,
   v8::PropertyCallbackInfo<void> const&) */

void js_cocos2dx_dragonbones_Slot_set__zOrderRegistry
...

{
  ...
  if (lVar6 == 0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x153e,"js_cocos2dx_dragonbones_Slot_set__zOrder");
    pcVar8 = "js_cocos2dx_dragonbones_Slot_set__zOrder : Invalid Native Object";
  }
  else {
    local_74 = 0;
    uVar7 = seval_to_int32((Value *)*puVar5,&local_74);
    if ((uVar7 & 1) != 0) {
      *(int *)(lVar6 + 0x98) = local_74;
      goto LAB_00cba498;
    }
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                        ,0x1543,"js_cocos2dx_dragonbones_Slot_set__zOrder");
    pcVar8 = "js_cocos2dx_dragonbones_Slot_set__zOrder : Error processing new value";
  }
  __android_log_print(6,"jswrapper",pcVar8);
  __android_log_print(6,"jswrapper","[ERROR] Failed to invoke %s, location: %s:%d\n",
                      "js_cocos2dx_dragonbones_Slot_set__zOrder",
                      "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                      ,0x1547);
LAB_00cba498:
