...
/* std::__ndk1::__split_buffer<v8::internal::Map*,
   v8::internal::RecyclingZoneAllocator<v8::internal::Map*> >::push_front(v8::internal::Map*&&) */
...

{
  ...
  if (__src != *(undefined8 **)this) goto LAB_010f2aa4;
  ...
  if (__src != puVar4) {
    ...
    if ((3 < uVar2) && ((__src + uVar11 + 1 <= puVar1 || (puVar12 + uVar11 + uVar8 + 1 <= __src))))
    {
      ...
      if (uVar2 == uVar11) goto LAB_010f2a58;
    }
    do {
      puVar3 = __src + 1;
      puVar10 = puVar9 + 1;
