...
/* v8::internal::compiler::JSRegExpRef::raw_properties_or_hash() const */

undefined1  [16] __thiscall
v8::internal::compiler::JSRegExpRef::raw_properties_or_hash(JSRegExpRef *this)
