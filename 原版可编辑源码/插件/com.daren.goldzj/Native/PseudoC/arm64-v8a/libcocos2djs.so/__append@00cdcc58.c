...
void __thiscall
std::__ndk1::vector<cocos2d::Particle*,std::__ndk1::allocator<cocos2d::Particle*>>::__append
          (vector<cocos2d::Particle*,std::__ndk1::allocator<cocos2d::Particle*>> *this,ulong param_1
          )
...
LAB_00cdccc8:
  ...
  if ((ulong)(lVar2 >> 3) < 0xfffffffffffffff) {
    ...
    if (uVar5 >> 0x3d != 0) goto LAB_00cdccc8;
  }
  else {
