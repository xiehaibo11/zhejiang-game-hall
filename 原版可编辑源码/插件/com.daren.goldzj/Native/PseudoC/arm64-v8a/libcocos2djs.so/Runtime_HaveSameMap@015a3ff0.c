...
/* v8::internal::Runtime_HaveSameMap(int, unsigned long*, v8::internal::Isolate*) */

undefined8 v8::internal::Runtime_HaveSameMap(int param_1,ulong *param_2,Isolate *param_3)
