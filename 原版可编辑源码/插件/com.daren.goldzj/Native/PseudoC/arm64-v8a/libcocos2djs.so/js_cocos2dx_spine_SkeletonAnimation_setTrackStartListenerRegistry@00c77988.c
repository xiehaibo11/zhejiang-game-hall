...
/* js_cocos2dx_spine_SkeletonAnimation_setTrackStartListenerRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_spine_SkeletonAnimation_setTrackStartListenerRegistry
...

{
  ...
  if (this == (SkeletonAnimation *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x371b,"js_cocos2dx_spine_SkeletonAnimation_setTrackStartListener");
    __android_log_print(6,"jswrapper",
                        "js_cocos2dx_spine_SkeletonAnimation_setTrackStartListener : Invalid Native Object"
                       );
  }
  else {
    ...
    if (plVar5[1] - (long)pVVar10 == 0x20) {
      ...
      if (pVVar10[0x18] == (Value)0x5) {
        ...
        if ((uVar8 & 1) == 0) goto LAB_00c77bfc;
...
LAB_00c77c24:
        ...
        if (!bVar3) goto LAB_00c77c04;
LAB_00c77c5c:
        __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                            "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_spine_auto.cpp"
                            ,0x3741,"js_cocos2dx_spine_SkeletonAnimation_setTrackStartListener");
        __android_log_print(6,"jswrapper",
                            "js_cocos2dx_spine_SkeletonAnimation_setTrackStartListener : Error processing arguments"
                           );
        bVar3 = false;
      }
      else {
LAB_00c77bfc:
        local_b0 = (long *)0x0;
        if (bVar3) goto LAB_00c77c5c;
LAB_00c77c04:
        spine::SkeletonAnimation::setTrackStartListener(this,pTVar7,(function *)alStack_d0);
        bVar3 = true;
      }
...
LAB_00c77ccc:
      ...
      if (bVar3) goto LAB_00c77d00;
    }
    else {
      __android_log_print(6,"jswrapper",&DAT_0192066c,(ulong)(plVar5[1] - (long)pVVar10) >> 4,2);
    }
  }
