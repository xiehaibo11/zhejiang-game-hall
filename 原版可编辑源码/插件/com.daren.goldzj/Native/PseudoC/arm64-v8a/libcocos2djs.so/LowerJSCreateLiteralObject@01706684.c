...
/* v8::internal::compiler::JSGenericLowering::LowerJSCreateLiteralObject(v8::internal::compiler::Node*)
    */

void __thiscall
v8::internal::compiler::JSGenericLowering::LowerJSCreateLiteralObject
...

{
  ...
  if (((*(byte *)((long)puVar2 + 0x1c) & 1) != 0) && (*(int *)(puVar2 + 3) < 0xaab)) {
    Builtins::CallableFor((Builtins *)local_78,*(undefined8 *)(*(long *)(this + 0x10) + 0x168),0x26)
    ;
  ...
  ReplaceWithRuntimeCall(this,param_1,0xbc,0xffffffff);
  return;
}
