...
/* js_cocos2dx_dragonbones_AnimationState_setCurrentTimeRegistry(v8::FunctionCallbackInfo<v8::Value>
   const&) */

void js_cocos2dx_dragonbones_AnimationState_setCurrentTimeRegistry(FunctionCallbackInfo *param_1)

{
  ...
  if (this == (AnimationState *)0x0) {
    __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                        ...
                        ,0x1062,&DAT_01929f65);
    pcVar6 = "js_cocos2dx_dragonbones_AnimationState_setCurrentTime : Invalid Native Object";
LAB_00cb1494:
    ...
    if (uVar7 == 0x10) {
      ...
      if ((uVar7 & 1) != 0) {
        dragonBones::AnimationState::setCurrentTime(this,local_64);
        goto LAB_00cb14cc;
      }
      __android_log_print(6,"jswrapper","jsb: ERROR: File %s: Line: %d, Function: %s\n",
                          "F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp"
                          ,0x1069,&DAT_01929f65);
      pcVar6 = "js_cocos2dx_dragonbones_AnimationState_setCurrentTime : Error processing arguments";
      goto LAB_00cb1494;
    }
    __android_log_print(6,"jswrapper",
                        "[ERROR] (F:/darenneiqian/frameworks/cocos2d-x/cocos/editor-support/../scripting/js-bindings/auto/jsb_cocos2dx_dragonbones_auto.cpp, 4205): wrong number of arguments: %d, was expecting %d\n"
                        ,uVar7 >> 4,1);
  }
