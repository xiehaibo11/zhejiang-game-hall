...
public class Cocos2dxWebView extends WebView {
    ...
    public class TyWebview2JsInterface {
        public TyWebview2JsInterface() {
        }

        @JavascriptInterface
        public void CallNativeJSFunction(int i, String str) {
            ((Cocos2dxActivity) Cocos2dxActivity.getContext()).CallJSFuncByEvent(i, str);
        }
    }
    ...
    public Cocos2dxWebView(Context context, int i) {
        ...
        addJavascriptInterface(new TyWebview2JsInterface(), "TyWebview2JsInterface");
    }
