...
public final class ContentResolverCompat {
    ...
    public static Cursor query(ContentResolver contentResolver, Uri uri, String[] strArr, String str, String[] strArr2, String str2, CancellationSignal cancellationSignal) throws Exception {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            ...
            return PluginProviderClient.query(RePlugin.getPluginContext(), uri, strArr, str, strArr2, str2, (android.os.CancellationSignal) cancellationSignalObject);
        }
        if (cancellationSignal != null) {
            cancellationSignal.throwIfCanceled();
        }
        return PluginProviderClient.query(RePlugin.getPluginContext(), uri, strArr, str, strArr2, str2);
    }
}
