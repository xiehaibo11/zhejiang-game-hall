...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getDrawable(Uri uri) {
        try {
            ...
            this.mProviderContext.getContentResolver();
            InputStream inputStreamOpenInputStream = PluginProviderClient.openInputStream(RePlugin.getPluginContext(), uri);
    ...
    Drawable getDrawableFromResourceUri(Uri uri) throws FileNotFoundException {
        ...
        try {
            ...
            if (size == 1) {
                ...
                identifier = resourcesForApplication.getIdentifier(pathSegments.get(1), pathSegments.get(0), BuildConfig.APPLICATION_ID);
            } else {
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i) {
        ...
        return PluginProviderClient.query(RePlugin.getPluginContext(), uriBuild, null, suggestSelection, strArr2, null);
    }
}
