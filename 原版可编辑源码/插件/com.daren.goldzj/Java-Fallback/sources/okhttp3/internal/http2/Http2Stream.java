...
public final class Http2Stream {
    ...
    private final class FramingSource implements Source {
        ...
        L3:
            ...
            Http2Stream r2 = this.this$0;
            monitor-enter(r2);
            boolean r3 = this.finished;     // Catch: Throwable -> L35
            boolean r8 = true;
            if ((this.readBuffer.size() + r13) <= this.maxByteCount) goto L9;
            boolean r4 = true;
        L10:
            monitor-exit(r2);     // Catch: Throwable -> L35
            if (r4 == true) goto L12;
            if (r3 == true) goto L15;
            ...
            monitor-enter(r23);
            if (this.readBuffer.size() == 0) goto L25;
            r8 = false;
        L25:
            this.readBuffer.writeAll(this.receiveBuffer);     // Catch: Throwable -> L30
            if (r8 == false) goto L28;
            this.this$0.notifyAll();     // Catch: Throwable -> L30
        L28:
            monitor-exit(r23);     // Catch: Throwable -> L30
        L30:
            th = move-exception;
            throw th;
        L34:
