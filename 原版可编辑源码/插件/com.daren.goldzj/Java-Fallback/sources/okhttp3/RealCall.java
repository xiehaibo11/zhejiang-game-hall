...
final class RealCall implements Call {
    ...
    final class AsyncCall extends NamedRunnable {
        ...
        protected void execute() {
            ...
            boolean r1 = true;
            this.responseCallback.onResponse(this.this$0, this.this$0.getResponseWithInterceptorChain());     // Catch: IOException -> L7 Throwable -> L9
        L6:
            this.this$0.client.dispatcher().finished(this);
            return;
        L7:
            IOException e = e;
        L13:
            IOException r0 = this.this$0.timeoutExit(e);     // Catch: Throwable -> L9
            if (r1 == false) goto L16;
            Platform.get().log(4, "Callback failure for " + this.this$0.toLoggableString(), r0);     // Catch: Throwable -> L9
            goto L6
        L16:
            RealCall.access$000(this.this$0).callFailed(this.this$0, r0);     // Catch: Throwable -> L9
            this.responseCallback.onFailure(this.this$0, r0);     // Catch: Throwable -> L9
        L9:
            th = move-exception;
            this.this$0.client.dispatcher().finished(this);
            throw th;
