...
public abstract class PluginAppCompatActivityAndroidX extends AppCompatActivity {
    private e a;
    ...
    L5:
        th = move-exception;
        d.a("PluginAppCompatActivityAndroidX", "o r i s: p=" + getPackageCodePath() + "; " + th.getMessage(), th);
    }
