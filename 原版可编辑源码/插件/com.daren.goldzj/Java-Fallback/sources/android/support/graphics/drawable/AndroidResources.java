...
class AndroidResources {
    ...
    static {
        STYLEABLE_VECTOR_DRAWABLE_TYPE_ARRAY = new int[]{android.R.attr.name, android.R.attr.tint, android.R.attr.height, android.R.attr.width, android.R.attr.alpha, android.R.attr.autoMirrored, android.R.attr.tintMode, android.R.attr.viewportWidth, android.R.attr.viewportHeight};
        STYLEABLE_VECTOR_DRAWABLE_GROUP = new int[]{android.R.attr.name, android.R.attr.pivotX, android.R.attr.pivotY, android.R.attr.scaleX, android.R.attr.scaleY, android.R.attr.rotation, android.R.attr.translateX, android.R.attr.translateY};
        STYLEABLE_VECTOR_DRAWABLE_PATH = new int[]{android.R.attr.name, android.R.attr.fillColor, android.R.attr.pathData, android.R.attr.strokeColor, android.R.attr.strokeWidth, android.R.attr.trimPathStart, android.R.attr.trimPathEnd, android.R.attr.trimPathOffset, android.R.attr.strokeLineCap, android.R.attr.strokeLineJoin, android.R.attr.strokeMiterLimit, android.R.attr.strokeAlpha, android.R.attr.fillAlpha, android.R.attr.fillType};
        STYLEABLE_VECTOR_DRAWABLE_CLIP_PATH = new int[]{android.R.attr.name, android.R.attr.pathData};
        STYLEABLE_ANIMATED_VECTOR_DRAWABLE = new int[]{android.R.attr.drawable};
        STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET = new int[]{android.R.attr.name, android.R.attr.animation};
        STYLEABLE_ANIMATOR = new int[]{android.R.attr.interpolator, android.R.attr.duration, android.R.attr.startOffset, android.R.attr.repeatCount, android.R.attr.repeatMode, android.R.attr.valueFrom, android.R.attr.valueTo, android.R.attr.valueType};
        STYLEABLE_ANIMATOR_SET = new int[]{android.R.attr.ordering};
        STYLEABLE_PROPERTY_VALUES_HOLDER = new int[]{android.R.attr.valueFrom, android.R.attr.valueTo, android.R.attr.valueType, android.R.attr.propertyName};
        STYLEABLE_KEYFRAME = new int[]{android.R.attr.value, android.R.attr.interpolator, android.R.attr.valueType, android.R.attr.fraction};
        STYLEABLE_PROPERTY_ANIMATOR = new int[]{android.R.attr.propertyName, android.R.attr.pathData, android.R.attr.propertyXName, android.R.attr.propertyYName};
        STYLEABLE_PATH_INTERPOLATOR = new int[]{android.R.attr.controlX1, android.R.attr.controlY1, android.R.attr.controlX2, android.R.attr.controlY2, android.R.attr.pathData};
    }
