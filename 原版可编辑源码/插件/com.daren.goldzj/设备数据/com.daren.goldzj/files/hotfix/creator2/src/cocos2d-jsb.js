...
var a = r.type;
if (e === l.EMAIL_ADDR) a = "email"; else if (e === l.NUMERIC || e === l.DECIMAL) a = "number"; else if (e === l.PHONE_NUMBER) {
a = "number";
r.pattern = "[0-9]*";
...
t.platform = e;
t.isMobile = e === t.ANDROID || e === t.IPAD || e === t.IPHONE || e === t.WP8 || e === t.TIZEN || e === t.BLACKBERRY || e === t.XIAOMI_GAME || e === t.OPENHARMONY || n || r || s || a || o;
t.os = __getOS();
...
L(t, !0, e);
N(t);
for (var i = new B(t[0]), n = t[1], r = t[2], s = t[3], a = t[4], o = t[A], c = 0; c < o.length; ++c) o[c].unshift(i, n, r, s, a);
return o;
};
...
E.pool = new n.default.Pool(function(t) {
t.reset();
}, 5);
E.pool.get = function() {
...
var o = s[a];
"string" != typeof o ? M(r, o[g], o, g, e, i) : M(r, o, s, a, e, i);
}
}
function N(t) {
var e = t[4];
...
e("CC_WECHATGAME", r);
e("CC_QQPLAY", s);
t.CocosEngine = cc.ENGINE_VERSION = "2.4.13";
}), {} ]
}, {}, [ 256 ]);