...
var a, o, c, u, l, h, f, _, d, p, v, m, g, y, A = (a = t(r, i - 1), o = t(r, i - 0), 
c = t(r, i + 1), u = t(r, i + 2), d = (_ = (1 - this._tension) / 2) * (2 * (h = (l = n) * l) - (f = h * l) - l), 
p = _ * (-f + h) + (2 * f - 3 * h) + 1, v = _ * (f - 2 * h + l) + -2 * f + 3 * h, 
m = _ * (f - h), g = a.x * d + o.x * p + c.x * v + u.x * m, y = a.y * d + o.y * p + c.y * v + u.y * m, 
cc.v2(g, y));
if (cc.macro.ENABLE_STACKABLE_ACTIONS) {
var E, T;
E = this.target.x - this._previousPosition.x;
T = this.target.y - this._previousPosition.y;
if (0 !== E || 0 !== T) {
...
for (var v, m, g = u.ratios, y = !0, A = 1, E = g.length; A < E; A++) {
v = g[A] - g[A - 1];
if (1 === A) m = v; else if (Math.abs(v - m) > 1e-6) {
y = !1;
break;
}
}
...
var T = u.values[0];
null == T || u._lerp || ("number" == typeof T ? u._lerp = r.prototype._lerpNumber : T instanceof cc.Quat ? u._lerp = r.prototype._lerpQuat : T instanceof cc.Vec2 ? u._lerp = r.prototype._lerpVector2 : T instanceof cc.Vec3 ? u._lerp = r.prototype._lerpVector3 : T.lerp && (u._lerp = r.prototype._lerpObject));
return u;
},
...
function c(t, e) {
var c, u, l, h, f = e - 0, _ = e - t[0], d = 3 * f, p = 3 * _, v = 3 * (e - t[2]), m = 1 / (-f + p - v + (e - 1)), g = (d - 6 * _ + v) * m, y = g * (1 / 3), A = (-d + p) * m, E = 1 / 3 * (3 * A - g * g), T = E * (1 / 3), C = (2 * g * g * g - 9 * g * A + f * m * 27) / 27, b = C / 2, x = b * b + T * T * T;
if (x < 0) {
var S = 1 / 3 * -E, R = a(S * S * S), w = -C / (2 * R), I = n(w < -1 ? -1 : w > 1 ? 1 : w), O = 2 * o(R);
u = O * i(I * (1 / 3)) - y;
l = O * i((I + s) * (1 / 3)) - y;
h = O * i((I + 2 * s) * (1 / 3)) - y;
...
if (_ && 1 !== f.length) {
for (var v = e.types, m = e.ratios, g = e.values = [], y = e.types = [], A = e.ratios = [], E = 0, T = i.Linear, C = 0, b = t.length; C < b - 1; C++) {
var x, S = t[C], R = m[C], w = m[C + 1] - R, I = f[C], O = f[C + 1], D = v[C], M = [], L = E / w, N = 1 / (w * r * c);
if (S && S.length > 0) {
var P = [];
P.push(h(I));
...
var V, G, W, H;
if ((x = n(x = L, D)) < 0) {
H = (0 - x) * (G = z.beziers[0]).getLength();
W = G.start.sub(G.endCtrlPoint).normalize();
V = G.start.add(W.mul(H));
} else if (x > 1) {
H = (x - 1) * (G = z.beziers[z.beziers.length - 1]).getLength();
W = G.end.sub(G.startCtrlPoint).normalize();
V = G.end.add(W.mul(H));
} else {
var j = s(U, x);
j < 0 && (j = ~j);
...
T = "constant" === D ? D : i.Linear;
for (F = 0, B = M.length; F < B; F++) {
var Y = R + E + N * F * w;
X(M[F], T, Y);
}
E = Math.abs(L - 1) > 1e-6 ? (L - 1) * w : 0;
}
m[m.length - 1] !== A[A.length - 1] && X(f[f.length - 1], T, m[m.length - 1]);
}
}
function X(t, e, i) {
g.push(t);
...
t.off("stop");
t.src = null;
cc.sys.platform === cc.sys.ALIPAY_GAME ? t.destroy() : c.includes(t) || (c.length < _._maxPoolSize ? c.push(t) : t.destroy());
...
t("./event/event-target")), f = t("./renderer/render-flow"), _ = cc.Object.Flags.Destroying, d = Math.PI / 180, p = !!cc.ActionManager, v = function() {}, m = new i.Vec3(), g = new i.Quat(), y = new i.Vec3(), A = new i.Vec3(), E = new i.Quat(), T = new i.Quat(), C = new i.Vec3(), b = new i.Vec3(), x = new i.Vec3(), S = new i.Vec3(), R = new i.Vec3(), w = new i.Quat(), I = new i.Quat(), O = new i.Vec3(), D = new i.Quat(), M = new i.Vec3(), L = new i.Quat(), N = new i.Vec3(), P = new i.Vec3(), F = new i.Quat(), B = new i.Quat(), k = (new i.Quat(), 
cc.mat4()), z = new i.Vec3(), U = new l.Pool();
U.get = function() {
return this._get() || [];
};
var V = cc.Enum({
...
}), H = [ W.TOUCH_START, W.TOUCH_MOVE, W.TOUCH_END, W.TOUCH_CANCEL ], j = [ W.MOUSE_DOWN, W.MOUSE_ENTER, W.MOUSE_MOVE, W.MOUSE_LEAVE, W.MOUSE_UP, W.MOUSE_WHEEL ], Y = !0, X = function(t) {
if (0 !== t) {
...
var i = t.getLocation(), n = this.owner;
n._hitTest(i, this) ? e.type = W.TOUCH_END : e.type = W.TOUCH_CANCEL;
e.touch = t;
e.bubbles = !0;
n.dispatchEvent(e);
}, Q = function(t, e) {
...
t.type = W.MOUSE_LEAVE;
q.dispatchEvent(t);
q._mouseListener._previousIn = !1;
}
q = this.owner;
t.type = W.MOUSE_ENTER;
i.dispatchEvent(t);
this._previousIn = !0;
}
t.type = W.MOUSE_MOVE;
...
e[5] = l *= a;
if (r) {
var f = e[0], _ = e[1], p = e[4], v = e[5], m = Math.tan(this._skewX * d), g = Math.tan(this._skewY * d);
...
function lt() {
this._localMatDirty & G.TRSS && this._updateLocalMatrix();
if (this._parent) {
...
function ft(t, e, i) {
var n = e.m, r = i.m, s = t.m, a = n[0], o = n[1], c = n[4], u = n[5], l = n[12], h = n[13], f = r[0], _ = r[1], d = r[4], p = r[5], v = r[12], m = r[13];
if (0 !== o || 0 !== c) {
s[0] = f * a + _ * c;
s[1] = f * o + _ * u;
s[4] = d * a + p * c;
...
this._groupIndex = t;
ot(this);
this.emit(W.GROUP_CHANGED, this);
}
},
group: {
get: function() {
...
if (e.x !== t) {
e.x = t;
16 & this._eventMask && this.emit(W.ANCHOR_CHANGED);
}
}
},
anchorY: {
...
this.emit(W.SIBLING_ORDER_CHANGED);
...
if (e) {
e.targetOff(t);
1 & this._eventMask && !e.hasEventListener(W.POSITION_CHANGED) && (this._eventMask &= -2);
...
if (!i.Mat4.invert(k, this._worldMatrix)) return !1;
i.Vec2.transformMat4(a, s, k);
...
i.Trs.toScale(b, this._trs);
i.Vec3.copy(t, b);
for (var e = this._parent; e; ) {
i.Trs.toScale(b, e._trs);
i.Vec3.mul(t, t, b);
e = e._parent;
}
return t;
...
i.Vec3.div(x, t, x);
} else i.Vec3.copy(x, t);
i.Trs.fromScale(this._trs, x);
this.setLocalDirty(G.ALL_SCALE);
},
...
i.Trs.toScale(R, r);
i.Vec3.mul(e, e, R);
i.Trs.toRotation(I, r);
i.Vec3.transformQuat(e, e, I);
...
this._worldMatDirty = !0;
t === G.ALL_POSITION || t === G.POSITION ? this._renderFlag |= f.FLAG_WORLD_TRANSFORM : this._renderFlag |= f.FLAG_TRANSFORM;
},
...
this._updateWorldMatrix();
i.Mat4.invert(k, this._worldMatrix);
if (t instanceof cc.Vec2) {
e = e || new cc.Vec2();
return i.Vec2.transformMat4(e, t, k);
}
e = e || new cc.Vec3();
return i.Vec3.transformMat4(e, t, k);
},
...
i.Mat4.copy(k, this._matrix);
i.Mat4.transform(k, k, z);
...
z.x = -this._anchorPoint.x * e.width;
z.y = -this._anchorPoint.y * e.height;
i.Mat4.copy(k, this._worldMatrix);
i.Mat4.transform(k, k, z);
return o.fromMat4(t, k);
},
...
"./utils/affine-transform": 189,
"./utils/base-node": 190,
"./utils/prefab-helper": 201,
"./utils/trans-pool": 207,
"./value-types": 213,
"./value-types/utils": 220
} ],
26: [ (function(t, e) {
"use strict";
...
29: [ (function(t, e) {
"use strict";
var i = t("./preprocess"), n = t("./fetch"), r = t("./cache"), s = t("./helper"), a = t("./releaseManager"), o = t("./depend-util"), c = t("./load"), u = t("./pipeline"), l = t("./task"), h = t("./request-item"), f = t("./downloader"), _ = t("./parser"), d = t("./pack-manager"), p = t("./bundle"), v = t("./builtins"), m = t("./factory"), g = t("./urlTransformer"), y = g.parse, A = g.combine, E = t("./utilities"), T = E.parseParameters, C = E.asyncify, b = t("./shared"), x = b.assets, S = b.files, R = b.parsed, w = b.pipeline, I = b.transformPipeline, O = b.fetchPipeline, D = b.RequestType, M = b.bundles, L = b.BuiltinBundleName;
function N() {
...
this.transformPipeline = I.append(y).append(A);
this.bundles = M;
this.assets = x;
this._files = S;
this._parsed = R;
...
if (!t._native || t._nativeAsset) return C(i)(null);
...
var n = T(e, void 0, i);
e = n.options, i = n.onComplete;
if (this.assets.has(t)) return C(i)(null, this.assets.get(t));
e.__isNative__ = !0;
...
i && i(n, null);
} else m.create(t, r, e.ext || cc.path.extname(t), e, (function(t, e) {
i && i(t, e);
}));
}));
},
...
var n = T(e, void 0, i), r = (e = n.options, i = n.onComplete, cc.path.basename(t));
...
i(null, t);
}, S = new l(), R = [], w = !1, I = 0, O = 0, D = -1, M = !1, L = function() {
...
var p = "undefined" != typeof n.maxRetryCount ? n.maxRetryCount : this.maxRetryCount, g = "undefined" != typeof n.maxConcurrency ? n.maxConcurrency : this.maxConcurrency, y = "undefined" != typeof n.maxRequestsPerFrame ? n.maxRequestsPerFrame : this.maxRequestsPerFrame;
m((function(i, a) {
0 === i && S.add(t, [ r ]);
...
T(r + "/config." + (s ? s + "." : "") + "json", e, (function(t, e) {
t && (c = t);
(o = e) && (o.base = r + "/");
2 == ++a && i(c, o);
}));
...
var p = "40px " + _;
r.font = p;
var v = n.safeMeasureText(r, s, p), m = document.createElement("style");
m.type = "text/css";
var g = "";
isNaN(_ - 0) ? g += "@font-face { font-family:" + _ + "; src:" : g += "@font-face { font-family:'" + _ + "'; src:";
g += "url('" + t + "');";
m.textContent = g + "}";
document.body.appendChild(m);
var y, A, E, T, C, b, x = document.createElement("div"), S = x.style;
S.fontFamily = _;
x.innerHTML = ".";
S.position = "absolute";
S.left = "-100px";
...
if (l()) y = Date.now(), A = _, E = i, T = new Promise(function(t, e) {
(function i() {
Date.now() - y >= u ? e() : document.fonts.load("40px " + A).then((function(e) {
e.length >= 1 ? t() : setTimeout(i, 100);
}), (function() {
e();
}));
})();
}), C = null, b = new Promise(function(t, e) {
C = setTimeout(e, u);
}), Promise.race([ b, T ]).then((function() {
if (C) {
clearTimeout(C);
C = null;
}
...
47: [ (function(t, e) {
"use strict";
var i = t("./pack-manager"), n = t("./pipeline"), r = t("./parser"), s = t("./utilities"), a = s.getDepends, o = s.cache, c = s.gatherAsset, u = s.setProperties, l = s.forEach, h = s.clear, f = s.checkCircleReference, _ = t("./shared"), d = _.assets, p = _.files, v = _.parsed, m = _.pipeline, g = t("./task"), y = new n("loadOneAsset", [ function(t, e) {
...
var u = i.uuid;
if (u in s) {
var l = s[u], h = l.finish, _ = l.content, m = l.err, g = l.callbacks;
n.canInvoke && t.dispatch("progress", ++n.finish, n.total, i);
if (h || f(u, u, s)) {
_ && _.addRef && _.addRef();
i.content = _;
...
for (var f = A.callbacks, m = 0, g = f.length; m < g; m++) {
var y = f[m];
e.addRef && e.addRef();
y.item.content = e;
y.done(t);
...
var r = null, s = null;
try {
var a = e instanceof ArrayBuffer ? e : e.buffer, o = new Uint8Array(a);
if (1554098963 !== o[0] + (o[1] << 8) + (o[2] << 16) + (o[3] << 24)) return new Error("Invalid magic number in ASTC header");
var c = o[4], u = o[5], l = o[6];
if ((c < 3 || c > 6 || u < 3 || u > 6 || l < 3 || l > 6) && (c < 4 || 7 === c || 9 === c || 11 === c || c > 12 || u < 4 || 7 === u || 9 === u || 11 === u || u > 12 || 1 !== l)) return new Error("Invalid block number in ASTC header");
var h = t(c, u), f = o[7] + (o[8] << 8) + (o[9] << 16), _ = o[10] + (o[11] << 8) + (o[12] << 16);
o[13], o[14], o[15];
s = {
_data: new Uint8Array(a, 16),
_compressed: !0,
...
p && (p.persistDeps = []);
for (var v in n) {
for (var m = n[v], g = f.get(m.uuid), y = 0, A = g.length; y < A; y++) {
var E = r.get(g[y]);
E && E.addRef();
}
p && p.persistDeps.push.apply(p.persistDeps, g);
}
},
_free: function(t, e) {
_.remove(t._uuid);
...
var E = t.packs;
for (var T in E) for (var C = E[T], b = 0; b < C.length; ++b) C[b] = e[C[b]];
var x = t.versions;
...
var O = t.redirect;
if (O) for (var D = 0; D < O.length; D += 2) {
O[D] = e[O[D]];
O[D + 1] = r[O[D + 1]];
}
},
...
this._flipXY(n);
for (var p = 0; p < 4; ++p) for (var v = n[p], m = 0; m < 4; ++m) {
var g = n[m];
l.push({
u: g.u,
v: v.v
...
var e = t.format;
this.initWithData(t._data, e || this._format, t.width, t.height);
...
if (".astc" === f && !i.ext("WEBGL_compressed_texture_astc")) continue;
...
var _ = s.passes[f], d = _.name || f, p = t.name + "-" + a + "-" + d, v = _.stage || "opaque", m = l(t, _), g = h(_), y = u[f] = new n.default(d, p, _.program, v, m, g);
_.rasterizerState && y.setCullMode(_.rasterizerState.cullMode);
var A = _.blendState && _.blendState.targets[0];
A && y.setBlend(A.blend, A.blendEq, A.blendSrc, A.blendDst, A.blendAlphaEq, A.blendSrcAlpha, A.blendDstAlpha, A.blendColor);
var E = _.depthStencilState;
if (E) {
...
var _ = (0, cc._decorator.ccclass)("cc.MaterialVariant")(n = (function(t) {
h(e, t);
...
var h, f = (h = r) instanceof cc.Scene ? cc.visibleRect : h._contentSize, _ = r._anchorPoint, d = r instanceof cc.Scene, p = t.x, v = t.y, m = t._anchorPoint;
if (e._alignFlags & i) {
var g, y, A = f.width;
if (d) {
...
g += e._isAbsLeft ? e._left : e._left * A;
y -= e._isAbsRight ? e._right : e._right * A;
if (l) {
g += c.x;
g *= u.x;
y += c.x;
...
var b = e._isAbsHorizontalCenter ? e._horizontalCenter : e._horizontalCenter * A, x = (.5 - _.x) * f.width;
if (l) {
b *= u.x;
x += c.x;
x *= u.x;
...
v = L + (O - .5) * I + M;
} else v = e.isAlignBottom ? R + O * I : S + (O - 1) * I;
}
}
t.setPosition(p, v);
}
...
set: function(t) {
A.main === this ? this._depth < t && p() : A.main && t < A.main._depth && d.includes(this) && (A.main = this);
this._depth = t;
...
"../utils/blend-func": 192,
"./CCRenderComponent": 101
} ],
97: [ (function(t, e) {
"use strict";
var i = cc.Class({
...
"../renderer/render-flow": 160,
"../utils/misc": 198,
"../value-types/mat4": 215,
"../value-types/vec2": 222,
"./CCRenderComponent": 101
} ],
100: [ (function(t, e) {
"use strict";
...
"../../core/utils/blend-func": 192,
"../components/CCRenderComponent": 101
} ],
101: [ (function(t, e) {
"use strict";
...
105: [ (function(t, e) {
"use strict";
var i = t("../../platform/CCMacro"), n = t("../editbox/EditBoxImplBase"), r = t("../CCLabel"), s = t("./types"), a = s.InputMode, o = s.InputFlag, c = s.KeyboardReturnType;
function u(t) {
...
})) : i === o.INITIAL_CAPS_SENTENCE && (t = u(t)); else {
...
default: e
}, n = t("../../platform/utils"), r = t("../../platform/CCMacro"), s = t("./types"), a = t("../CCLabel"), o = t("./tabIndexUtil"), c = cc.EditBox, u = cc.js, l = s.InputMode, h = s.InputFlag, f = s.KeyboardReturnType, _ = {
zoomInvalid: !1
};
...
var d = 0, p = cc.v3(), v = null, m = !1, g = !1, y = c._ImplClass;
function A() {
y.call(this);
...
if (t) {
this._delegate = t;
t.inputMode === l.ANY ? this._createTextArea() : this._createInput();
o.add(this);
...
setTimeout((function() {
v || m && cc.view.enableAutoFullScreen(!0);
}), 800);
}
},
...
n /= a;
r /= a;
var o = cc.game.container, c = t[0] * n, u = t[1], l = t[4], h = t[5] * r, f = o && o.style.paddingLeft && parseInt(o.style.paddingLeft);
f += s.x / a;
var d = o && o.style.paddingBottom && parseInt(o.style.paddingBottom);
d += s.y / a;
var p = t[12] * n + f, v = t[13] * r + d;
if (_.zoomInvalid) {
this.setSize(e.width * c, e.height * h);
c = 1;
h = 1;
}
var m = this._elem, g = "matrix(" + c + "," + -u + "," + -l + "," + h + "," + p + "," + -v + ")";
m.style.transform = g;
m.style["-webkit-transform"] = g;
m.style["transform-origin"] = "0px 100% 0px";
m.style["-webkit-transform-origin"] = "0px 100% 0px";
}
}
},
...
var a = r.type;
if (e === l.EMAIL_ADDR) a = "email"; else if (e === l.NUMERIC) a = "number"; else if (e === l.DECIMAL) a = "digit"; else if (e === l.PHONE_NUMBER) {
a = "tel";
r.onmousewheel = function() {
return !1;
};
} else if (e === l.URL) a = "url"; else {
a = "text";
n === f.SEARCH && (a = "search");
}
r.type = a;
var o = "none";
i === h.INITIAL_CAPS_ALL_CHARACTERS ? o = "uppercase" : i === h.INITIAL_CAPS_WORD && (o = "capitalize");
...
var _, d, p, v = 0, m = 0, g = 0, y = 0, A = 0, E = 0, T = 0, C = 0, b = 0, x = 0, S = 0, R = 0, w = 0;
m = h - l;
if (f = f || !1) if (c(m) >= 2 * n) m = 2 * n; else for (;m < 0; ) m += 2 * n; else if (c(m) >= 2 * n) m = 2 * -n; else for (;m > 0; ) m -= 2 * n;
p = 0 | s(1, r(c(m) / (.5 * n) + .5, 5));
g = c(4 / 3 * (1 - a(_ = m / p / 2)) / o(_));
f || (g = -g);
for (d = 0; d <= p; d++) {
E = e + (y = a(v = l + m * (d / p))) * u;
T = i + (A = o(v)) * u;
C = -A * u * g;
b = y * u * g;
0 === d ? t.moveTo(E, T) : t.bezierCurveTo(x + R, S + w, E - C, T - b, E, T);
x = E;
S = T;
R = C;
w = b;
...
var d, p, v, m, g, y, A, E, T, C, b, x, S, R, w, I;
if (!(f > 10)) {
g = .5 * (o + l);
y = .5 * (u + h);
A = .5 * ((d = .5 * (n + s)) + (v = .5 * (s + o)));
...
t(e, n, r, d, p, A, E, b = .5 * (A + (T = .5 * (v + g))), x = .5 * (E + (C = .5 * (m + y))), f + 1, 0);
t(e, b, x, T, C, g, y, l, h, f + 1, _);
}
}
}
};
...
if (o in t) {
var c, u;
c = E.test(s) ? "this." + s + "=" : "this[" + y(s) + "]=";
var l = t[o];
if ("object" == typeof l && l) u = l instanceof cc.ValueType ? g(l) : Array.isArray(l) ? "[]" : "{}"; else if ("function" == typeof l) {
var h = i.length;
i.push(l);
u = "F[" + h + "]()";
...
function w(t) {
var e = (t = t || {}).name, n = t.extends, r = t.mixins, s = m(e, n, r, t);
...
var A = y(o), E = g(u, "requireComponent"), T = y(h), C = g(f, "executionOrder"), b = y(o), x = y(o), S = y(h), R = y(h), w = y(h);
...
for (var e, i, s = n.now(), a = [], o = this._touches, c = this._touchesIntegerDict, u = this._touchesCache, l = 0, h = t.length; l < h; l++) if (void 0 === c[i = (e = t[l]).getID()]) {
...
for (var e, i, s = n.now(), a = [], o = this._touches, c = this._touchesIntegerDict, u = 0, l = t.length; u < l; u++) if (void 0 !== (i = c[(e = t[u]).getID()])) {
var h = o[i];
if (h) {
...
for (var e, i, n, r = [], s = this._touches, a = this._touchesIntegerDict, o = this._touchesCache, c = 0, u = t.length; c < u; c++) if (void 0 !== (i = a[n = (e = t[c]).getID()])) {
var l = s[i];
if (l) {
...
var n = e.getPointByEvent(t, i), s = e.getMouseEvent(n, i, a), u = t.button;
a === c.MOVE && (1 & t.buttons ? u = c.BUTTON_LEFT : 2 & t.buttons ? u = c.BUTTON_RIGHT : 4 & t.buttons && (u = c.BUTTON_MIDDLE));
s.setButton(u);
o(t, s, n, i);
r.dispatchEvent(s);
t.stopPropagation();
...
137: [ (function(t, e) {
"use strict";
var i, n = "qgame" === (i = window._CCSettings ? _CCSettings.platform : void 0), r = "quickgame" === i, s = "huawei" === i, a = "jkw-game" === i, o = "qtt-game" === i, c = "link-sure" === i, u = "migu-runtime" === i, l = "honor-minigame" === i, h = "undefined" == typeof window ? global : window, f = cc && cc.sys ? cc.sys : (function() {
cc.sys = {};
var t = cc.sys;
...
t.LINKSURE = 119;
t.TAOBAO = 120;
t.TAOBAO_MINIGAME = 121;
t.MIGU_MINIGAME = 122;
t.HONOR_MINIGAME = 123;
...
var e, i;
e = n ? t.VIVO_GAME : r ? t.OPPO_GAME : s ? t.HUAWEI_GAME : a ? t.JKW_GAME : o ? t.QTT_GAME : c ? t.LINKSURE : u ? t.MIGU_MINIGAME : l ? t.HONOR_MINIGAME : __getPlatform();
t.platform = e;
t.isMobile = e === t.ANDROID || e === t.IPAD || e === t.IPHONE || e === t.WP8 || e === t.TIZEN || e === t.BLACKBERRY || e === t.XIAOMI_GAME || e === t.OPENHARMONY || n || r || s || a || o || u || l;
t.os = __getOS();
...
var f, _ = window.innerWidth, d = window.innerHeight, p = window.devicePixelRatio || 1;
...
if (t.isMobile) f.accelerometer = !0; else {
f.keyboard = !0;
f.mouse = !0;
}
f.touches = t.isBrowser || t.isMobile;
f.imageBitmap = !1;
t.__audioSupport = {
ONLY_ONE: !1,
WEB_AUDIO: !1,
...
r = globalThis.oh ? t._devicePixelRatio = globalThis.oh.devicePixelRatio : t._devicePixelRatio = window.devicePixelRatio;
n.width = e * r;
n.height = i * r;
},
...
return [ 1, _, _, [ t ], _, i ? [ e, -1 ] : [ e ], [ 0 ], _, [], [], [] ];
};
i.unpackJSONs = function(t, e) {
if (t[0] < 1) throw new Error(cc.debug.getError(5304, t[0]));
D(t, !0, e);
M(t);
for (var i = new P(t[0]), n = t[1], r = t[2], s = t[3], a = t[4], o = t[g], c = 0; c < o.length; ++c) o[c].unshift(i, n, r, s, a);
return o;
};
...
"../value-types/color": 212,
"../value-types/mat4": 215,
"../value-types/quat": 216,
"../value-types/rect": 217,
"../value-types/size": 218,
"../value-types/vec2": 222,
"../value-types/vec3": 223,
"../value-types/vec4": 224,
"./js": 149
} ],
144: [ (function(t) {
"use strict";
...
y(t, _ + T(i) + "=", this.enumerateField(e, i, n));
};
...
var v = r * l, m = r * h, g = s * l, y = s * h, A = a * f, E = a * _, T = o * f, C = o * _;
i[p] = v + A + c;
i[p + 1] = g + T + u;
i[p += d] = m + A + c;
i[p + 1] = y + T + u;
...
for (var u = s._iData, l = a.indiceOffset, h = a.vertexOffset, f = 0, _ = Math.min(this.indicesCount, r.length); f < _; f++) u[l++] = h + r[f];
};
...
"../../renderer/core/input-assembler": 229,
"../../renderer/core/pass": 230,
"../../renderer/gfx": 233,
...
160: [ (function(t, e) {
"use strict";
var i, n, r = 0, s = 1 << r++, a = 1 << r++, o = 1 << r++, c = 1 << r++, u = o | c, l = 1 << r++, h = 1 << r++, f = 1 << r++, _ = h | f, d = 1 << r++, p = 1 << r++, v = 1 << r++, m = 1 << r++, g = 0;
function y() {
this._func = x;
this._next = null;
}
...
for (var e = g, n = i, r = n.parentOpacity, s = n.parentOpacity *= t._opacity / 255, a = (n.worldMatDirty ? c : 0) | (n.parentOpacityDirty ? _ : 0), o = t._children, u = 0, l = o.length; u < l; u++) {
var h = o[u];
h._renderFlag |= a;
...
this.line = 0;
this.hash = "";
}, f = cc.rect(), _ = null, d = [], p = [], v = [], m = [], g = null, y = 0, A = 0, E = 0, T = 0, C = 0, b = 1, x = null, S = cc.size(), R = "", w = 0, I = 0, O = 0, D = 0, M = 0, L = 0, N = 0, P = !1, F = 0, B = 0, k = 0, z = (function(t) {
s(e, t);
function e() {
...
i._clearHorizontalKerning = function() {
d.length = 0;
};
i._multilineTextWrap = function(t) {
for (var e = R.length, i = 0, n = 0, r = 0, s = 0, a = 0, c = 0, h = 0, f = null, _ = cc.v2(0, 0), p = 0; p < e; ) {
var m = R.charAt(p);
if ("\n" !== m) {
for (var E = t(R, p, e), x = c, w = h, I = a, O = n, D = !1, z = 0; z < E; ++z) {
var U = p + z;
if ("\r" !== (m = R.charAt(U))) if (f = l.fontAtlas.getLetterDefinitionForChar(m, l)) {
var V = O + f.offsetX * b - l.margin;
if (P && k > 0 && n > 0 && V + f.w * b > k && !o.isUnicodeSpace(m)) {
v.push(a);
a = 0;
i++;
n = 0;
...
_.x = V;
_.y = r - f.offsetY * b + l.margin;
this._recordLetterInfo(_, m, U, i);
U + 1 < d.length && U < e - 1 && (O += d[U + 1]);
O += f.xAdvance * b + M - 2 * l.margin;
I = _.x + f.w * b - l.margin;
x < _.y && (x = _.y);
w > _.y - f.h * b && (w = _.y - f.h * b);
} else {
this._recordPlaceholderInfo(U, m);
var G = "";
g && (G = g.atlasName);
console.log("Can't find letter definition in texture atlas " + G + " for letter:" + m);
} else this._recordPlaceholderInfo(U, m);
}
if (!D) {
n = O;
c < x && (c = x);
...
n = 0;
r -= L * this._getFontScale() + 0;
this._recordPlaceholderInfo(p, m);
p++;
}
}
v.push(a);
A = (y = i + 1) * L * this._getFontScale();
y > 1 && (A += 0 * (y - 1));
S.width = F;
S.height = B;
F <= 0 && (S.width = parseFloat(s.toFixed(2)) + 2 * l.margin);
B <= 0 && (S.height = parseFloat(A.toFixed(2)) + 2 * l.margin);
T = S.height;
C = 0;
if (N !== u.CLAMP) {
c > 0 && (T = S.height + c);
...
if (!s) return r;
for (var a = s.xAdvance * b + M, c = e + 1; c < i; ++c) {
n = t.charAt(c);
if (!(s = l.fontAtlas.getLetterDefinitionForChar(n, l))) break;
if (a + s.offsetX * b + s.w * b > k && !o.isUnicodeSpace(n) && k > 0) return r;
a += s.xAdvance * b + M;
...
N === u.SHRINK && w > 0 && this._isVerticalClamp() && this._shrinkLabelToContentSize(this._isVerticalClamp);
...
var t = x ? x._texture : l.fontAtlas.getTexture(), e = _.node;
this.verticesCount = this.indicesCount = 0;
this._renderData && (this._renderData.dataLength = 0);
for (var i = S, n = e._anchorPoint.x * i.width, r = e._anchorPoint.y * i.height, s = !0, a = 0, o = R.length; a < o; ++a) {
var c = p[a];
if (c.valid) {
...
d - h.h * b < C && N === u.CLAMP && (f.height = d < C ? 0 : (d - C) / b);
}
var g = c.line, y = c.x + h.w / 2 * b + m[g];
if (F > 0 && this._isHorizontalClamped(y, g)) if (N === u.CLAMP) f.width = 0; else if (N === u.SHRINK) {
if (S.width > h.w) {
s = !1;
break;
}
...
var A = this._determineRect(f), w = c.x + m[c.line];
this.appendQuad(_, t, f, A, w - n, d - r, b);
}
}
}
...
for (var t = 0; t < y; ++t) m.push(0);
break;

case c.TextAlignment.CENTER:
for (var e = 0, i = v.length; e < i; e++) m.push((S.width - v[e]) / 2);
break;

case c.TextAlignment.RIGHT:
for (var n = 0, r = v.length; n < r; n++) m.push(S.width - v[n]);
}
E = S.height;
if (D !== c.VerticalTextAlignment.TOP) {
var s = S.height - A + L * this._getFontScale() - I * b;
D === c.VerticalTextAlignment.BOTTOM ? E -= s : E -= s / 2;
}
};
...
var o, c = t("../../../utils/text-utils"), u = t("../../../platform/CCMacro"), l = t("../../../components/CCLabel"), h = t("../../../components/CCLabelOutline"), f = t("../../../components/CCLabelShadow"), _ = l.Overflow, d = t("../utils").deleteFromDynamicAtlas, p = t("../utils").getFontFamily, v = (1 / 255).toFixed(3), m = null, g = null, y = null, A = "", E = "", T = 0, C = 0, b = [], x = cc.Size.ZERO, S = 0, R = 0, w = 0, I = null, O = "", D = _.NONE, M = !1, L = !1, N = null, P = cc.Color.WHITE, F = null, B = cc.Color.BLACK, k = cc.rect(), z = cc.Size.ZERO, U = cc.Size.ZERO, V = !1, G = !1, W = !1, H = 0, j = cc.Vec2.ZERO, Y = 0, X = [ "left", "center", "right" ], q = (function(t) {
s(e, t);
function e() {
return t.apply(this, arguments) || this;
}
...
var t = 0;
R === u.TextAlignment.RIGHT ? t = x.width - k.width : R === u.TextAlignment.CENTER && (t = (x.width - k.width) / 2);
var e = this._getLineHeight() * (b.length - 1), i = T * (1 - c.BASELINE_RATIO / 2);
if (w !== u.VerticalTextAlignment.TOP) {
var n = e + k.height + T - x.height;
w === u.VerticalTextAlignment.BOTTOM ? i -= n += c.BASELINE_RATIO / 2 * T : i -= n / 2;
}
i += c.BASELINE_OFFSET * T;
return cc.v2(t + k.x, i + k.y);
};
i._setupOutline = function() {
m.strokeStyle = "rgba(" + P.r + ", " + P.g + ", " + P.b + ", " + P.a / 255 + ")";
m.lineWidth = 2 * N.width;
};
i._setupShadow = function() {
m.shadowColor = "rgba(" + B.r + ", " + B.g + ", " + B.b + ", " + B.a / 255 + ")";
m.shadowBlur = F.blur;
m.shadowOffsetX = F.offset.x;
m.shadowOffsetY = -F.offset.y;
};
i._drawTextEffect = function(t, e) {
if (F || N || W) {
var i = b.length > 1 && F, n = this._measureText(m, A), r = 0, s = 0;
F && this._setupShadow();
...
s = t.y + a * e;
if (i) {
N && m.strokeText(b[a], r, s);
m.fillText(b[a], r, s);
}
if (W) {
Y = n(b[a]);
R === u.TextAlignment.RIGHT ? j.x = t.x - Y : R === u.TextAlignment.CENTER ? j.x = t.x - Y / 2 : j.x = t.x;
j.y = s + C / 8;
m.fillRect(j.x, j.y, Y, H);
}
}
i && (m.shadowColor = "transparent");
}
};
i._updateTexture = function() {
m.clearRect(0, 0, g.width, g.height);
m.lineJoin = "round";
if (L) m.fillStyle = "rgba(" + I.r + ", " + I.g + ", " + I.b + ", " + I.a / 255 + ")"; else {
var t = N ? P : I;
m.fillStyle = "rgba(" + t.r + ", " + t.g + ", " + t.b + ", " + v + ")";
m.fillRect(0, 0, g.width, g.height);
m.fillStyle = "rgba(" + I.r + ", " + I.g + ", " + I.b + ", 1)";
}
var e = this._calculateFillTextStartPosition(), i = this._getLineHeight(), n = e.x, r = 0;
this._drawTextEffect(e, i);
for (var s = 0; s < b.length; ++s) {
r = e.y + s * i;
N && m.strokeText(b[s], n, r);
m.fillText(b[s], n, r);
}
F && (m.shadowColor = "transparent");
...
return 0 | (0 === S ? T : S * T / C);
};
i._calculateParagraphLength = function(t, e) {
for (var i = [], n = 0; n < t.length; ++n) {
var r = c.safeMeasureText(e, t[n], A);
i.push(r);
}
return i;
};
...
var e = this._calculateParagraphLength(t, m), i = 0, n = 0, r = 0;
if (M) {
var s = U.width, a = U.height;
if (s < 0 || a < 0) return;
n = a + 1;
for (var o = 0, u = 0 | T + 1, l = 0; o < u; ) {
if ((l = o + u + 1 >> 1) <= 0) {
cc.logID(4003);
break;
}
...
var f = c.safeMeasureText(m, t[i], A);
n += c.fragmentText(t[i], f, s, this._measureText(m, A)).length * h;
}
n > a ? u = l - 1 : o = l;
}
...
var _ = (x.width - k.width) / r, d = x.height / n;
...
var n = c.safeMeasureText(m, t[i], A), r = c.fragmentText(t[i], n, e, this._measureText(m, A));
b = b.concat(r);
}
}
};
...
var r = c.safeMeasureText(m, t[n], A);
e = e > r ? e : r;
}
i = (b.length + c.BASELINE_RATIO) * this._getLineHeight();
...
this._calculateWrapText(t);
var o = (b.length + c.BASELINE_RATIO) * this._getLineHeight();
x.height = o + k.height;
U.height = o + z.height;
}
};
...
var s, a;
if (r === O(t, e, i, n) > 0) for (s = e; s < i; s += n) a = R(s, t[s], t[s + 1], a); else for (s = i - n; s >= e; s -= n) a = R(s, t[s], t[s + 1], a);
if (a && E(a, a.next)) {
w(a);
a = a.next;
}
...
do {
i = !1;
if (n.steiner || !E(n, n.next) && 0 !== A(n.prev, n, n.next)) n = n.next; else {
w(n);
...
if (_ !== t.prev && _ !== t.next && g(r.x, r.y, s.x, s.y, a.x, a.y, _.x, _.y) && A(_.prev, _, _.next) >= 0) return !1;
_ = _.nextZ;
}
_ = t.prevZ;
for (;_ && _.z >= h; ) {
...
if (!E(r, s) && T(r, n, n.next, s) && b(r, s) && b(s, r)) {
e.push(r.i / i);
e.push(n.i / i);
e.push(s.i / i);
w(n);
...
n = i.next;
for (;n !== u; ) {
if (r >= n.x && n.x >= l && g(s < h ? r : a, s, l, h, s < h ? a : r, s, n.x, n.y) && ((c = Math.abs(s - n.y) / (r - n.x)) < f || c === f && n.x > i.x) && b(n, t)) {
i = n;
f = c;
}
n = n.next;
...
function y(t, e) {
return t.next.i !== e.i && t.prev.i !== e.i && !C(t, e) && b(t, e) && b(e, t) && x(t, e);
}
function A(t, e, i) {
...
function T(t, e, i, n) {
return !!(E(t, e) && E(i, n) || E(t, n) && E(i, e)) || A(t, e, i) > 0 != A(t, e, n) > 0 && A(i, n, t) > 0 != A(i, n, e) > 0;
}
function C(t, e) {
var i = t;
do {
...
t("./impl");
var p = Math.PI, v = Math.min, m = Math.max, g = Math.ceil, y = Math.acos, A = Math.cos, E = Math.sin, T = Math.atan2;
function C(t, e, i) {
return t < e ? e : t > i ? i : t;
}
var b = cc.gfx, x = new b.VertexFormat([ {
name: b.ATTR_POSITION,
type: b.ATTR_TYPE_FLOAT32,
num: 2
}, {
name: b.ATTR_COLOR,
...
i = p, n = u._tessTol, r = 2 * y(e / (e + n)), m(2, g(i / r)));
this._calculateJoins(u, s, o, c);
for (var d = u._paths, v = 0, A = u._pathOffset, E = u._pathLength; A < E; A++) {
var T = d[A], C = T.points.length;
o === f.ROUND ? v += 2 * (C + T.nbevel * (l + 2) + 1) : v += 2 * (C + 5 * T.nbevel + 1);
T.closed || (a === _.ROUND ? v += 2 * (2 * l + 2) : v += 12);
}
for (var b = this.genBuffer(t, v), x = b.meshbuffer, S = x._vData, R = x._iData, w = u._pathOffset, I = u._pathLength; w < I; w++) {
var O, D = d[w], M = D.points, L = M.length, N = b.vertexStart, P = void 0, F = void 0, B = void 0, k = void 0;
if (O = D.closed) {
P = M[L - 1];
F = M[0];
B = 0;
...
if (O) {
var W = this.getVfmtFloatCount(), H = N * W;
this._vset(S[H], S[H + 1], 1);
this._vset(S[H + W], S[H + W + 1], -1);
} else {
var j = F.sub(P);
j.normalizeSelf();
var Y = j.x, X = j.y;
...
for (var q = b.indiceStart, K = N + 2, Z = b.vertexStart; K < Z; K++) {
R[q++] = K - 2;
R[q++] = K - 1;
R[q++] = K;
}
...
if (0 !== p) {
for (var v = a.vertexStart, m = 0; m < p; ++m) this._vset(_[m].x, _[m].y);
var g = a.indiceStart;
if (f.complex) {
for (var y = [], A = this.getVfmtFloatCount(), E = v, T = a.vertexStart; E < T; E++) {
var C = E * A;
y.push(c[C]);
y.push(c[C + 1]);
}
...
for (var x = 0, S = b.length; x < S; x++) u[g++] = b[x] + v;
...
u.nbevel = 0;
for (var g = 0; g < _; g++) {
var y, A, E = d.dy, T = -d.dx, C = p.dy, b = -p.dx;
p.dmx = .5 * (E + C);
p.dmy = .5 * (T + b);
...
y * (A = m(11, v(d.len, p.len) * r)) * A < 1 && (p.flags |= h.PT_INNERBEVEL);
var S = p.dmx * e, R = p.dmy * e, w = S * S + R * R;
w > p.len * p.len + s && w > d.len * d.len + s && (p.flags |= h.PT_INNERBEVEL);
...
var f = this._chooseBevel(e.flags & h.PT_INNERBEVEL, t, e, i), _ = f[0], d = f[1], v = f[2], m = f[3], y = T(-a, -s), b = T(-c, -o);
b > y && (b -= 2 * p);
this._vset(_, d, 1);
this._vset(u - s * n, e.y - a * n, -1);
for (var x = C(g((y - b) / p) * r, 2, r), S = 0; S < x; S++) {
var R = y + S / (x - 1) * (b - y), w = u + A(R) * n, I = l + E(R) * n;
this._vset(u, l, 0);
this._vset(w, I, -1);
}
this._vset(v, m, 1);
...
var O = this._chooseBevel(e.flags & h.PT_INNERBEVEL, t, e, -n), D = O[0], M = O[1], L = O[2], N = O[3], P = T(a, s), F = T(c, o);
F < P && (F += 2 * p);
this._vset(u + s * n, l + a * n, 1);
this._vset(D, M, -1);
for (var B = C(g((F - P) / p) * r, 2, r), k = 0; k < B; k++) {
var z = P + k / (B - 1) * (F - P), U = u + A(z) * i, V = l + E(z) * i;
this._vset(U, V, 1);
this._vset(u, l, 0);
}
this._vset(u + o * n, l + c * n, 1);
...
var m = this._chooseBevel(e.flags & h.PT_INNERBEVEL, t, e, i);
c = m[0];
u = m[1];
l = m[2];
f = m[3];
...
var g = this._chooseBevel(e.flags & h.PT_INNERBEVEL, t, e, -n);
r = g[0];
s = g[1];
a = g[2];
o = g[3];
...
var h, f, _, d, p = e.width, v = e.height, m = i.width, g = i.height, y = this._getColor(t), A = this.floatsPerVert, E = o + this.uvOffset;
if (n) {
h = i.x / p;
_ = (i.x + g) / p;
f = (i.y + m) / v;
...
for (var T = o + this.colorOffset, C = 0; C < 4; C++) {
l[T] = y;
T += A;
}
...
var e = t.canvas;
e && e._destroy && e._destroy();
t.canvas = null;
t.context = null;
} else this.pool.push(t);
}
};
...
i.MaskAssembler = C;
r.default.register(o, C);
}), {
"../../../../renderer/gfx": 233,
"../../../components/CCMask": 99,
"../../assembler": 156,
"../../render-flow": 160,
"../vertex-format": 187,
"./graphics": 168,
"./sprite/2d/simple": 180
} ],
176: [ (function(t, e, i) {
"use strict";
i.__esModule = !0;
...
var c = t("../../../components/CCMotionStreak"), u = t("../../render-flow");
function l(t, e) {
this.point = t || cc.v2();
this.dir = e || cc.v2();
this.distance = 0;
...
cc.v2(), cc.v2();
var h = cc.v2(), f = cc.v2(), _ = new r.default();
function d(t, e) {
t.x = -e.y;
t.y = e.x;
return t;
...
var i = t._stroke / 2;
t.node.getWorldMatrix(_);
var n = _.m[12], r = _.m[13], s = t._points, a = t._lastWPos, o = t._fadeTime;
if (t._lastWPosUpdated && (a.x !== n || a.y !== r)) {
var c, u = !1;
if (0 === s.length) {
var p = new l();
p.setPoint(a.x, a.y);
this._tailShortenTime = p.time = o;
s.push(p);
c = new l();
s.unshift(c);
} else {
c = s[0];
var v = s[1], m = v.point.x - n, g = v.point.y - r;
u = m * m + g * g >= t.minSeg * t.minSeg;
}
c.setPoint(n, r);
c.time = o + e;
var y = s[1];
c.distance = c.point.sub(y.point, f).mag();
f.normalizeSelf();
c.setDir(f.x, f.y);
2 === s.length && y.setDir(f.x, f.y);
if (u) {
var A = new l(c.point.clone(), c.dir.clone());
...
if (!(s.length < 2)) {
var E, T = t._color, C = T.a, b = T.b << 16 | T.g << 8 | T.r, x = 0, S = this._renderData._flexBuffer;
S.reserve(2 * s.length, 6 * (s.length - 1));
for (var R = S.vData, w = S.uintVData, I = s.length - 1; I >= 0; I--) {
var O = s[I], D = O.point, M = O.dir;
O.time -= e;
var L = I === s.length - 1;
if (O.time <= 0) {
L && I - 1 >= 0 && (this._tailShortenTime = s[I - 1].time - e);
s.splice(I, 1);
} else {
var N = O.time / o;
if (L) {
...
if (s.length >= 3) {
var F = O.time / this._tailShortenTime;
if (F <= 1) {
D.x = P.point.x - P.distance * P.dir.x * F;
D.y = P.point.y - P.distance * P.dir.y * F;
}
} else this._tailShortenTime = O.time;
}
d(h, M);
var B = N * C << 24 >>> 0 | b, k = 5 * x;
R[k] = D.x + h.x * i;
R[k + 1] = D.y + h.y * i;
R[k + 2] = 1;
R[k + 3] = N;
...
i.fillBuffers = function(t, e) {
var i = this._renderData._flexBuffer, n = i.vData, r = i.usedVertices, s = i.usedIndices, a = i.usedVerticesFloats, o = e._meshBuffer, c = o.request(r, s), l = c.byteOffset >> 2, h = o._vData;
n.length + l > h.length ? h.set(n.subarray(0, a), l) : h.set(n, l);
for (var f = o._iData, _ = c.indiceOffset, d = c.vertexOffset, p = 0, v = r; p < v; p += 2) {
var m = d + p;
f[_++] = m;
f[_++] = m + 2;
f[_++] = m + 1;
...
t.node._renderFlag |= u.FLAG_UPDATE_RENDER_DATA;
};
return e;
})(n.default);
i.default = p;
...
var n, r, s, a, c, u, l, h, f, _, d = t._spriteFrame, p = d._texture.width, v = d._texture.height, m = d._rect;
if (d._rotated) {
n = m.x / p;
r = (m.y + m.width) / v;
s = c = n;
...
var g = this._renderData.vDatas[0], y = this.uvOffset, A = this.floatsPerVert;
switch (t._fillType) {
case o.HORIZONTAL:
g[y] = s + (c - s) * e;
g[y + 1] = a + (u - a) * e;
...
i.updateVerts = function(t) {
var e = t.node, i = Math.abs(e.width), n = Math.abs(e.height), r = e.anchorX * i, s = e.anchorY * n, a = t.spriteFrame, o = a.vertices, c = o.x, u = o.y, l = a._originalSize.width, h = a._originalSize.height, f = a._rect.width, _ = a._rect.height, d = a._offset.x + (l - f) / 2, p = a._offset.y + (h - _) / 2, v = i / (t.trim ? f : l), m = n / (t.trim ? _ : h), g = this._local;
if (t.trim) for (var y = 0, A = c.length; y < A; y++) {
var E = 2 * y;
g[E] = (c[y] - d) * v - r;
g[E + 1] = (h - u[y] - p) * m - s;
} else for (var T = 0, C = c.length; T < C; T++) {
var b = 2 * T;
g[b] = c[T] * v - r;
g[b + 1] = (h - u[T]) * m - s;
}
if (a._flipX) for (var x = 0, S = this.verticesCount; x < S; x++) g[2 * x] = i - g[2 * x] - 2 * r;
if (a._flipY) for (var R = 0, w = this.verticesCount; R < w; R++) g[2 * R + 1] = n - g[2 * R + 1] - 2 * s;
};
i.updateWorldVerts = function(t) {
...
f[2] = l;
f[3] = h;
var p = t._fillCenter, v = _.x = Math.min(Math.max(0, p.x), 1) * (l - a) + a, m = _.y = Math.min(Math.max(0, p.y), 1) * (h - o) + o;
c[0].x = c[3].x = a;
c[1].x = c[2].x = l;
c[0].y = c[1].y = o;
c[2].y = c[3].y = h;
...
var l = t.spriteFrame, h = l._originalSize.width, f = l._originalSize.height, _ = l._rect.width, d = l._rect.height, p = l._offset, v = a / h, m = o / f, g = p.x + (h - _) / 2, y = p.x - (h - _) / 2;
e = g * v - c;
i = (p.y + (f - d) / 2) * m - u;
n = a + y * v - c;
r = o + (p.y - (f - d) / 2) * m - u;
...
h.length = f.length = 0;
var _, d, p = e.insetLeft, v = e.insetRight, m = i.width - p - v, g = e.insetTop, y = e.insetBottom, A = i.height - g - y, E = n.width / (p + v) > 1 ? 1 : n.width / (p + v), T = n.height / (g + y) > 1 ? 1 : n.height / (g + y);
_ = m > 0 ? Math.floor(1e3 * this.sizableWidth) / 1e3 % m == 0 ? m : this.sizableWidth % m : this.sizableWidth;
d = A > 0 ? Math.floor(1e3 * this.sizableHeight) / 1e3 % A == 0 ? A : this.sizableHeight % A : this.sizableHeight;
for (var C = 0; C <= o; C++) 0 === C ? h[C] = -r : C > 0 && C < o ? h[C] = 1 === C ? p * E + Math.min(m, this.sizableWidth) - r : m > 0 ? C === o - 1 ? p + _ + m * (C - 2) - r : p + Math.min(m, this.sizableWidth) + m * (C - 2) - r : p + this.sizableWidth - r : C === o && (h[C] = Math.min(p + this.sizableWidth + v, c) - r);
for (var b = 0; b <= a; b++) 0 === b ? f[b] = -s : b > 0 && b < a ? f[b] = 1 === b ? y * T + Math.min(A, this.sizableHeight) - s : A > 0 ? b === a - 1 ? y + d + (b - 2) * A - s : y + Math.min(A, this.sizableHeight) + (b - 2) * A - s : y + this.sizableHeight - s : b === a && (f[b] = Math.min(y + this.sizableHeight + g, u) - s);
this.updateWorldVerts(t);
};
i.updateWorldVerts = function(t) {
for (var e, i, n, r, s = this._renderData, a = this._local, o = a.x, c = a.y, u = s.vDatas[0], l = this.row, h = this.col, f = t.node._worldMatrix.m, _ = f[0], d = f[1], p = f[4], v = f[5], m = f[12], g = f[13], y = this.floatsPerVert, A = 0, E = 0, T = l; E < T; ++E) {
n = c[E];
r = c[E + 1];
for (var C = 0, b = h; C < b; ++C) {
e = o[C];
i = o[C + 1];
u[A] = e * _ + n * p + m;
u[A + 1] = e * d + n * v + g;
...
if (e) for (var i = t._spriteFrame, n = i._rect, r = i.insetLeft, s = i.insetRight, a = n.width - r - s, o = i.insetTop, c = i.insetBottom, u = n.height - o - c, l = this.row, h = this.col, f = this.hRepeat, _ = this.vRepeat, d = 0, p = 0, v = t.spriteFrame.uv, m = t.spriteFrame.uvSliced, g = t.spriteFrame._rotated, y = this.floatsPerVert, A = this.uvOffset, E = [], T = [], C = 0, b = l; C < b; ++C) {
p = this.sizableHeight > u ? this.sizableHeight >= C * u ? 1 : _ % 1 : _;
for (var x = 0, S = h; x < S; ++x) {
d = this.sizableWidth > a ? this.sizableWidth >= x * a ? 1 : f % 1 : f;
if (g) {
if (0 === C) {
E[0] = m[0].u;
E[1] = m[0].u;
E[2] = m[4].u + (m[8].u - m[4].u) * p;
} else if (C < l - 1) {
E[0] = m[4].u;
E[1] = m[4].u;
E[2] = m[4].u + (m[8].u - m[4].u) * p;
...
if (n) {
a.prototype.checkAndSwitchBuffer = function(t) {
if (this.vertexOffset + t > 65535) {
this.uploadData();
this._batcher._flush();
}
...
var n = e.x, r = e.y, s = n + e.width, a = r + e.height, o = i.a * n + i.c * r + i.tx, c = i.b * n + i.d * r + i.ty, u = i.a * s + i.c * r + i.tx, l = i.b * s + i.d * r + i.ty, h = i.a * n + i.c * a + i.tx, f = i.b * n + i.d * a + i.ty, _ = i.a * s + i.c * a + i.tx, d = i.b * s + i.d * a + i.ty, p = Math.min(o, u, h, _), v = Math.max(o, u, h, _), m = Math.min(c, l, f, d), g = Math.max(c, l, f, d);
t.x = p;
t.y = m;
t.width = v - p;
t.height = g - m;
...
n.propertyDefine(m, [ "parent", "name", "children", "childrenCount" ], {});
...
MIDDLE_RATIO: .37,
BASELINE_OFFSET: 0,
label_wordRex: /([a-zA-Z0-9ÄÖÜäöüßéèçàùêâîôûа-яА-ЯЁё\u0600-\u06ff]+|\S)/,
label_symbolRex: /^[!,.:;'}\]%\?>、‘“》？。，！]/,
label_lastWordRex: /([a-zA-Z0-9ÄÖÜäöüßéèçàùêâîôûаíìÍÌïÁÀáàÉÈÒÓòóŐőÙÚŰúűñÑæÆœŒÃÂãÔõěščřžýáíéóúůťďňĚŠČŘŽÁÍÉÓÚŤżźśóńłęćąŻŹŚÓŃŁĘĆĄ-яА-ЯЁё\u0600-\u06ff]+|\S)$/,
label_lastEnglish: /[a-zA-Z0-9ÄÖÜäöüßéèçàùêâîôûаíìÍÌïÁÀáàÉÈÒÓòóŐőÙÚŰúűñÑæÆœŒÃÂãÔõěščřžýáíéóúůťďňĚŠČŘŽÁÍÉÓÚŤżźśóńłęćąŻŹŚÓŃŁĘĆĄ-яА-ЯЁё\u0600-\u06ff]+$/,
label_firstEnglish: /^[a-zA-Z0-9ÄÖÜäöüßéèçàùêâîôûаíìÍÌïÁÀáàÉÈÒÓòóŐőÙÚŰúűñÑæÆœŒÃÂãÔõěščřžýáíéóúůťďňĚŠČŘŽÁÍÉÓÚŤżźśóńłęćąŻŹŚÓŃŁĘĆĄ-яА-ЯЁё\u0600-\u06ff]/,
highSurrogateRex: /[\uD800-\uDBFF]/,
lowSurrogateRex: /[\uDC00-\uDFFF]/,
...
for (var v = 0; v < p; v++) {
var m = this._spacesData[v];
m.trs = new i.FLOAT_ARRAY_TYPE(this.trsList.buffer, v * r, 10);
m.localMat = new i.FLOAT_ARRAY_TYPE(this.localMatList.buffer, v * s, 16);
m.worldMat = new i.FLOAT_ARRAY_TYPE(this.worldMatList.buffer, v * a, 16);
m.dirty = new n(this.dirtyList.buffer, 4 * v, 1);
m.parent = new o(this.parentList.buffer, 8 * v, 2);
m.zOrder = new c(this.zOrderList.buffer, 4 * v, 1);
m.cullingMask = new u(this.cullingMaskList.buffer, 4 * v, 1);
m.opacity = new l(this.opacityList.buffer, 1 * v, 1);
m.is3D = new h(this.is3DList.buffer, 1 * v, 1);
m.skew = new i.FLOAT_ARRAY_TYPE(this.skewList.buffer, v * _, 2);
}
};
(function() {
var t = function() {};
...
f.ORANGE_R = f.ORANGE;
f.CYAN_R = f.CYAN;
f.MAGENTA_R = f.MAGENTA;
r.default.fastDefine("cc.Color", f, {
r: 0,
g: 0,
b: 0,
a: 255
...
return "string" == typeof t ? new f().fromHEX(t) : "object" == typeof t ? new f(t.r, t.g, t.b, t.a) : new f(t, e, i, n);
};
e.exports = i.default;
}), {
"../platform/CCClass": 128,
...
var n = e.m, r = i.m, s = t.m, a = n[0], o = n[1], c = n[2], u = n[3], l = n[4], h = n[5], f = n[6], _ = n[7], d = n[8], p = r[0], v = r[1], m = r[2], g = r[3], y = r[4], A = r[5], E = r[6], T = r[7], C = r[8];
s[0] = p * a + v * u + m * f;
s[1] = p * o + v * l + m * _;
s[2] = p * c + v * h + m * d;
s[3] = g * a + y * u + A * f;
...
var n = e.m, r = i.m, s = t.m, a = n[0], o = n[1], c = n[2], u = n[3], l = n[4], h = n[5], f = n[6], _ = n[7], d = n[8], p = r[0], v = r[1], m = r[2], g = r[4], y = r[5], A = r[6], E = r[8], T = r[9], C = r[10];
s[0] = p * a + v * u + m * f;
s[1] = p * o + v * l + m * _;
s[2] = p * c + v * h + m * d;
s[3] = g * a + y * u + A * f;
...
var i = t.m, n = e.x, r = e.y, s = e.z, a = e.w, o = n + n, c = r + r, u = s + s, l = n * o, h = r * o, f = r * c, _ = s * o, d = s * c, p = s * u, v = a * o, m = a * c, g = a * u;
i[0] = 1 - f - p;
i[3] = h - g;
i[6] = _ + m;
i[1] = h + g;
...
var i = e.m, n = t.m, r = i[0], s = i[1], a = i[2], o = i[3], c = i[4], u = i[5], l = i[6], h = i[7], f = i[8], _ = i[9], d = i[10], p = i[11], v = i[12], m = i[13], g = i[14], y = i[15], A = r * u - s * c, E = r * l - a * c, T = r * h - o * c, C = s * l - a * u, b = s * h - o * u, x = a * h - o * l, S = f * m - _ * v, R = f * g - d * v, w = f * y - p * v, I = _ * g - d * m, O = _ * y - p * m, D = d * y - p * g, M = A * D - E * O + T * I + C * w - b * R + x * S;
if (!M) return t;
M = 1 / M;
n[0] = (u * D - l * O + h * I) * M;
n[1] = (l * w - c * D - h * R) * M;
...
var i = t.m, n = e.m, s = i[0], a = i[1], o = i[2], c = i[3], u = i[4], l = i[5], h = i[6], f = i[7], _ = i[8], d = n[0], p = n[1], v = n[2], m = n[3], g = n[4], y = n[5], A = n[6], E = n[7], T = n[8];
return Math.abs(s - d) <= r.EPSILON * Math.max(1, Math.abs(s), Math.abs(d)) && Math.abs(a - p) <= r.EPSILON * Math.max(1, Math.abs(a), Math.abs(p)) && Math.abs(o - v) <= r.EPSILON * Math.max(1, Math.abs(o), Math.abs(v)) && Math.abs(c - m) <= r.EPSILON * Math.max(1, Math.abs(c), Math.abs(m)) && Math.abs(u - g) <= r.EPSILON * Math.max(1, Math.abs(u), Math.abs(g)) && Math.abs(l - y) <= r.EPSILON * Math.max(1, Math.abs(l), Math.abs(y)) && Math.abs(h - A) <= r.EPSILON * Math.max(1, Math.abs(h), Math.abs(A)) && Math.abs(f - E) <= r.EPSILON * Math.max(1, Math.abs(f), Math.abs(E)) && Math.abs(_ - T) <= r.EPSILON * Math.max(1, Math.abs(_), Math.abs(T));
};
...
var f = 0, _ = 0, d = 0, p = 0, v = 0, m = 0, g = 0, y = 0, A = 0, E = 0, T = 0, C = 0, b = 0, x = 0, S = 0, R = 0, w = (function(t) {
l(i, t);
var e = i.prototype;
e.mul = function(t, e) {
...
S = i[14];
R = i[15];
var n = f * m - _ * v, r = f * g - d * v, s = f * y - p * v, a = _ * g - d * m, o = _ * y - p * m, c = d * y - p * g, u = A * x - E * b, l = A * S - T * b, h = A * R - C * b, w = E * S - T * x, I = E * R - C * x, O = T * R - C * S, D = n * O - r * I + s * w + a * h - o * l + c * u;
if (0 === D) return null;
D = 1 / D;
var M = t.m;
M[0] = (m * O - g * I + y * w) * D;
...
S = e[14];
R = e[15];
return (f * m - _ * v) * (T * R - C * S) - (f * g - d * v) * (E * R - C * x) + (f * y - p * v) * (E * S - T * x) + (_ * g - d * m) * (A * R - C * b) - (_ * y - p * m) * (A * S - T * b) + (d * y - p * g) * (A * x - E * b);
};
...
n[8] = a * f + o * v + c * A + u * b;
n[9] = a * _ + o * m + c * E + u * x;
n[10] = a * d + o * g + c * T + u * S;
n[11] = a * p + o * y + c * C + u * R;
a = s[12];
o = s[13];
c = s[14];
u = s[15];
n[12] = a * f + o * v + c * A + u * b;
n[13] = a * _ + o * m + c * E + u * x;
n[14] = a * d + o * g + c * T + u * S;
n[15] = a * p + o * y + c * C + u * R;
return t;
};
...
a[10] = T;
a[11] = C;
a[12] = f * n + v * r + A * s + o[12];
a[13] = _ * n + m * r + E * s + o[13];
a[14] = d * n + g * r + T * s + o[14];
a[15] = p * n + y * r + C * s + o[15];
}
return t;
};
...
s *= c;
a *= c;
var u = Math.sin(i), l = Math.cos(i), h = 1 - l, b = e.m;
f = b[0];
_ = b[1];
d = b[2];
p = b[3];
...
T = b[10];
C = b[11];
var x = r * r * h + l, S = s * r * h + a * u, R = a * r * h - s * u, w = r * s * h - a * u, I = s * s * h + l, O = a * s * h + r * u, D = r * a * h + s * u, M = s * a * h - r * u, L = a * a * h + l, N = t.m;
N[0] = f * x + v * S + A * R;
N[1] = _ * x + m * S + E * R;
N[2] = d * x + g * S + T * R;
N[3] = p * x + y * S + C * R;
...
var n = e.x, r = e.y, s = e.z, a = e.w, o = n + n, c = r + r, u = s + s, l = n * o, h = n * c, f = n * u, _ = r * c, d = r * u, p = s * u, v = a * o, m = a * c, g = a * u, y = t.m;
y[0] = 1 - (_ + p);
y[1] = h + g;
y[2] = f - m;
y[3] = 0;
...
var r = t.m, o = O.m;
n.x = s.default.set(I, r[0], r[1], r[2]).mag();
o[0] = r[0] / n.x;
o[1] = r[1] / n.x;
o[2] = r[2] / n.x;
n.y = s.default.set(I, r[4], r[5], r[6]).mag();
o[3] = r[4] / n.y;
o[4] = r[5] / n.y;
o[5] = r[6] / n.y;
n.z = s.default.set(I, r[8], r[9], r[10]).mag();
o[6] = r[8] / n.z;
o[7] = r[9] / n.z;
o[8] = r[10] / n.z;
...
var r = e.x, s = e.y, a = e.z, o = e.w, c = r + r, u = s + s, l = a + a, h = r * c, f = r * u, _ = r * l, d = s * u, p = s * l, v = a * l, m = o * c, g = o * u, y = o * l, A = n.x, E = n.y, T = n.z, C = t.m;
C[0] = (1 - (d + v)) * A;
C[1] = (f + y) * A;
C[2] = (_ - g) * A;
C[3] = 0;
...
var s = e.x, a = e.y, o = e.z, c = e.w, u = s + s, l = a + a, h = o + o, f = s * u, _ = s * l, d = s * h, p = a * l, v = a * h, m = o * h, g = c * u, y = c * l, A = c * h, E = n.x, T = n.y, C = n.z, b = r.x, x = r.y, S = r.z, R = t.m;
R[0] = (1 - (p + m)) * E;
R[1] = (_ + A) * E;
R[2] = (d - y) * E;
R[3] = 0;
...
var i = e.x, n = e.y, r = e.z, s = e.w, a = i + i, o = n + n, c = r + r, u = i * a, l = n * a, h = n * o, f = r * a, _ = r * o, d = r * c, p = s * a, v = s * o, m = s * c, g = t.m;
g[0] = 1 - h - d;
g[1] = l + m;
g[2] = f - v;
g[3] = 0;
...
var r = e.x, s = e.y, a = e.z, o = n.x, c = n.y, u = n.z, l = r - i.x, h = s - i.y, f = a - i.z, _ = 1 / Math.sqrt(l * l + h * h + f * f), d = c * (f *= _) - u * (h *= _), p = u * (l *= _) - o * f, v = o * h - c * l, m = h * (v *= _ = 1 / Math.sqrt(d * d + p * p + v * v)) - f * (p *= _), g = f * (d *= _) - l * v, y = l * p - h * d, A = t.m;
A[0] = d;
A[1] = m;
A[2] = l;
A[3] = 0;
...
var i = e.m, n = t.m, r = i[0], s = i[1], a = i[2], o = i[3], c = i[4], u = i[5], l = i[6], h = i[7], f = i[8], _ = i[9], d = i[10], p = i[11], v = i[12], m = i[13], g = i[14], y = i[15];
n[0] = u * (d * y - p * g) - _ * (l * y - h * g) + m * (l * p - h * d);
n[1] = -(s * (d * y - p * g) - _ * (a * y - o * g) + m * (a * p - o * d));
n[2] = s * (l * y - h * g) - u * (a * y - o * g) + m * (a * h - o * l);
n[3] = -(s * (l * p - h * d) - u * (a * p - o * d) + _ * (a * h - o * l));
n[4] = -(c * (d * y - p * g) - f * (l * y - h * g) + v * (l * p - h * d));
n[5] = r * (d * y - p * g) - f * (a * y - o * g) + v * (a * p - o * d);
n[6] = -(r * (l * y - h * g) - c * (a * y - o * g) + v * (a * h - o * l));
n[7] = r * (l * p - h * d) - c * (a * p - o * d) + f * (a * h - o * l);
n[8] = c * (_ * y - p * m) - f * (u * y - h * m) + v * (u * p - h * _);
n[9] = -(r * (_ * y - p * m) - f * (s * y - o * m) + v * (s * p - o * _));
n[10] = r * (u * y - h * m) - c * (s * y - o * m) + v * (s * h - o * u);
n[11] = -(r * (u * p - h * _) - c * (s * p - o * _) + f * (s * h - o * u));
n[12] = -(c * (_ * g - d * m) - f * (u * g - l * m) + v * (u * d - l * _));
n[13] = r * (_ * g - d * m) - f * (s * g - a * m) + v * (s * d - a * _);
n[14] = -(r * (u * g - l * m) - c * (s * g - a * m) + v * (s * l - a * u));
...
function i(e, i, n, r, s, a, c, u, l, h, f, _, d, p, v, m) {
var g;
void 0 === e && (e = 1);
void 0 === i && (i = 0);
void 0 === n && (n = 0);
...
void 0 === v && (v = 0);
void 0 === m && (m = 1);
(g = t.call(this) || this).m = void 0;
if (e instanceof o.FLOAT_ARRAY_TYPE) g.m = e; else {
g.m = new o.FLOAT_ARRAY_TYPE(16);
var y = g.m;
y[0] = e;
y[1] = i;
y[2] = n;
...
var I = new s.default(), O = new c.default();
...
var v = new w(t, e, i, n, r, s, a, o, c, u, l, h, f, _, d, p);
void 0 === t && w.identity(v);
return v;
};
cc.Mat4 = w;
e.exports = i.default;
...
i.invert(v, e);
s.default.transformQuat(g, n, v);
i.fromAxisAngle(v, g, r);
i.multiply(t, e, v);
return t;
};
...
var v = new p(), m = new p(), g = new s.default(), y = new a.default(), A = .5 * Math.PI / 180;
...
var i = this.x, n = this.y, r = i + this.width, s = n + this.height, a = e.m, o = a[0] * i + a[4] * n + a[12], c = a[1] * i + a[5] * n + a[13], u = a[0] * r + a[4] * n + a[12], l = a[1] * r + a[5] * n + a[13], h = a[0] * i + a[4] * s + a[12], f = a[1] * i + a[5] * s + a[13], _ = a[0] * r + a[4] * s + a[12], d = a[1] * r + a[5] * s + a[13], p = Math.min(o, u, h, _), v = Math.max(o, u, h, _), m = Math.min(c, l, f, d), g = Math.max(c, l, f, d);
t.x = p;
t.y = m;
t.width = v - p;
t.height = g - m;
...
i.default = _;
r.default.fastDefine("cc.Rect", _, {
x: 0,
y: 0,
width: 0,
height: 0
...
var i = e[3], n = e[4], r = e[5], s = e[6], a = i + i, o = n + n, c = r + r, u = i * a, l = i * o, h = i * c, f = n * o, _ = n * c, d = r * c, p = s * a, v = s * o, m = s * c, g = e[7], y = e[8], A = e[9], E = t.m;
E[0] = (1 - (f + d)) * g;
E[1] = (l + m) * g;
E[2] = (h - v) * g;
E[3] = 0;
...
Math.abs(d) < a.EPSILON ? t.y = 0 : t.y = 1 / d;
return t;
};
i.normalize = function(t, e) {
_ = e.x;
...
d = e.y;
var n = i.m;
t.x = n[0] * _ + n[4] * d + n[12];
t.y = n[1] * _ + n[5] * d + n[13];
return t;
};
i.strictEquals = function(t, e) {
return t.x === e.x && t.y === e.y;
...
p = e.y;
v = e.z;
Math.abs(d) < o.EPSILON ? t.x = 0 : t.x = 1 / d;
Math.abs(p) < o.EPSILON ? t.y = 0 : t.y = 1 / p;
Math.abs(v) < o.EPSILON ? t.z = 0 : t.z = 1 / v;
return t;
};
i.normalize = function(t, e) {
d = e.x;
...
p = e.y;
v = e.z;
var n = i.m, r = n[3] * d + n[7] * p + n[11] * v + n[15];
r = r ? 1 / r : 1;
t.x = (n[0] * d + n[4] * p + n[8] * v + n[12]) * r;
t.y = (n[1] * d + n[5] * p + n[9] * v + n[13]) * r;
t.z = (n[2] * d + n[6] * p + n[10] * v + n[14]) * r;
return t;
};
...
p = e.y;
v = e.z;
var n = i.m, r = n[3] * d + n[7] * p + n[11] * v;
r = r ? 1 / r : 1;
t.x = (n[0] * d + n[4] * p + n[8] * v) * r;
t.y = (n[1] * d + n[5] * p + n[9] * v) * r;
t.z = (n[2] * d + n[6] * p + n[10] * v) * r;
return t;
};
i.transformMat3 = function(t, e, i) {
d = e.x;
...
v = e.z;
var n = i.m;
t.x = d * n[0] + p * n[3] + v * n[6];
t.y = d * n[1] + p * n[4] + v * n[7];
t.z = d * n[2] + p * n[5] + v * n[8];
return t;
};
...
v = e.z;
var n = i.m;
t.x = n[0] * d + n[1] * p + n[2] * v + n[3];
t.y = n[4] * d + n[5] * p + n[6] * v + n[7];
t.x = n[8] * d + n[9] * p + n[10] * v + n[11];
return t;
};
...
p = e.y - i.y;
v = e.z - i.z;
var r = Math.cos(n), s = Math.sin(n), a = d, o = p * r - v * s, c = p * s + v * r;
t.x = a + i.x;
t.y = o + i.y;
t.z = c + i.z;
return t;
...
p = e.y - i.y;
v = e.z - i.z;
var r = Math.cos(n), s = Math.sin(n), a = v * s + d * r, o = p, c = v * r - d * s;
t.x = a + i.x;
t.y = o + i.y;
t.z = c + i.z;
return t;
...
p = e.y - i.y;
v = e.z - i.z;
var r = Math.cos(n), s = Math.sin(n), a = d * r - p * s, o = d * s + p * r, c = v;
t.x = a + i.x;
t.y = o + i.y;
t.z = c + i.z;
return t;
...
m.FRONT_R = m.FORWARD;
var g = new m(), y = new m();
r.default.fastDefine("cc.Vec3", m, {
x: 0,
y: 0,
z: 0
});
...
var f = 0, _ = 0, d = 0, p = 0, v = (function(t) {
l(i, t);
var e = i.prototype;
e.sub = function(t, e) {
return i.subtract(e || new i(), this, t);
...
d = t.z;
p = t.w;
return Math.sqrt(f * f + _ * _ + d * d + p * p);
};
i.lengthSqr = function(t) {
f = t.x;
_ = t.y;
...
d = e.z;
p = e.w;
Math.abs(f) < s.EPSILON ? t.x = 0 : t.x = 1 / f;
Math.abs(_) < s.EPSILON ? t.y = 0 : t.y = 1 / _;
...
p = e.w;
var n = i.m;
t.x = n[0] * f + n[4] * _ + n[8] * d + n[12] * p;
t.y = n[1] * f + n[5] * _ + n[9] * d + n[13] * p;
t.z = n[2] * f + n[6] * _ + n[10] * d + n[14] * p;
t.w = n[3] * f + n[7] * _ + n[11] * d + n[15] * p;
return t;
};
i.transformAffine = function(t, e, i) {
f = e.x;
...
p = e.w;
var n = i.m;
t.x = n[0] * f + n[1] * _ + n[2] * d + n[3] * p;
t.y = n[4] * f + n[5] * _ + n[6] * d + n[7] * p;
t.x = n[8] * f + n[9] * _ + n[10] * d + n[11] * p;
t.w = e.w;
return t;
};
i.transformQuat = function(t, e, i) {
...
_ = i.y;
d = i.z;
var a = (p = i.w) * n + _ * s - d * r, o = p * r + d * n - f * s, c = p * s + f * r - _ * n, u = -f * n - _ * r - d * s;
t.x = a * p + u * -f + o * -d - c * -_;
t.y = o * p + u * -_ + c * -f - a * -d;
t.z = c * p + u * -d + a * -_ - o * -f;
t.w = e.w;
...
p = this.w;
var n = t.m;
e.x = n[0] * f + n[4] * _ + n[8] * d + n[12] * p;
e.y = n[1] * f + n[5] * _ + n[9] * d + n[13] * p;
e.z = n[2] * f + n[6] * _ + n[10] * d + n[14] * p;
e.w = n[3] * f + n[7] * _ + n[11] * d + n[15] * p;
return e;
};
e.maxAxis = function() {
...
v.ZERO_R = v.ZERO;
v.ONE_R = v.ONE;
v.NEG_ONE_R = v.NEG_ONE;
n.default.fastDefine("cc.Vec4", v, {
x: 0,
y: 0,
z: 0,
w: 0
...
228: [ (function(t, e) {
"use strict";
var i, n, r, s, a, o, c, u, l, h, f, _, d, p, v, m, g, y, A, E, T, C, b, x, S, R, w, I, O, D, M, L, N, P, F, B, k, z, U, V, G, W;
(function(t) {
...
var H = {};
H[H.bool = a.BOOL] = "bool";
H[H.int = a.INT] = "int";
H[H.ivec2 = a.INT2] = "ivec2invTypeParams";
H[H.ivec3 = a.INT3] = "ivec3";
H[H.ivec4 = a.INT4] = "ivec4";
H[H.float = a.FLOAT] = "float";
H[H.vec2 = a.FLOAT2] = "vec2";
H[H.vec3 = a.FLOAT3] = "vec3";
H[H.vec4 = a.FLOAT4] = "vec4";
H[H.mat2 = a.MAT2] = "mat2";
H[H.mat3 = a.MAT3] = "mat3";
H[H.mat4 = a.MAT4] = "mat4";
H[H.sampler2D = a.SAMPLER2D] = "sampler2D";
H[H.samplerCube = a.SAMPLER_CUBE] = "samplerCube";
...
V[a.MAT3] = 36, V[a.MAT4] = 64, V[a.SAMPLER2D] = 4, V[a.SAMPLER_CUBE] = 4, V), Y = ((G = {})[a.BOOL] = o.R32I, 
G[a.INT] = o.R32I, G[a.INT2] = o.RG32I, G[a.INT3] = o.RGB32I, G[a.INT4] = o.RGBA32I, 
G[a.FLOAT] = o.R32F, G[a.FLOAT2] = o.RG32F, G[a.FLOAT3] = o.RGB32F, G[a.FLOAT4] = o.RGBA32F, 
G), X = {
BACK: 1029,
FRONT: 1028,
NONE: 0,
...
"../../core/value-types/value-type": 221,
"../enums": 232,
"../gfx": 233
} ],
231: [ (function(t, e, i) {
...
var t = e._video;
if (!e._loaded && t && (t.readyState === a || t.readyState === s)) {
t.currentTime = 0;
e._loaded = !0;
e._forceUpdate = !0;
...
var r, s, a = cc.view._devicePixelRatio, u = 1 / a, l = 1 / a, h = cc.game.container, f = i[0] * u, _ = i[1], d = i[4], p = i[5] * l, v = h && h.style.paddingLeft ? parseInt(h.style.paddingLeft) : 0, m = h && h.style.paddingBottom ? parseInt(h.style.paddingBottom) : 0;
...
var g = r * i[0] * t._anchorPoint.x, y = s * i[5] * t._anchorPoint.y, A = "matrix(" + f + "," + -_ + "," + -d + "," + p + "," + (i[12] * u - g + v) + "," + -(i[13] * l - y + m) + ")";
...
this._updateSize(this._w, this._h);
var d = this._w * s, p = this._h * a, v = d * i[0] * t._anchorPoint.x, m = p * i[5] * t._anchorPoint.y, g = "matrix(" + c + "," + -u + "," + -l + "," + h + "," + (i[12] * s - v + f) + "," + -(i[13] * a - m + _) + ")";
...
"./cocos2d/deprecated": 225,
"./cocos2d/particle": void 0,
"./cocos2d/particle/CCParticleAsset": 227,
"./cocos2d/tilemap": void 0,
"./cocos2d/tilemap/CCTiledMapAsset": 236,
"./cocos2d/videoplayer/CCVideoPlayer": 237,
"./cocos2d/webview/CCWebView": 239,
"./extensions/ccpool/CCNodePool": 242,
"./extensions/dragonbones": 247,
"./extensions/spine": 251
} ],
242: [ (function(t, e) {
"use strict";
...
243: [ (function(t, e) {
"use strict";
var i = t("../../cocos2d/core/components/CCRenderComponent"), n = t("../../cocos2d/core/event/event-target"), r = t("../../cocos2d/core/graphics/graphics"), s = t("../../cocos2d/core/renderer/render-flow").FLAG_POST_RENDER, a = t("./ArmatureCache"), o = t("./AttachUtil"), c = cc.Enum({
default: -1
}), u = cc.Enum({
"<None>": 0
}), l = (cc.Enum({
...
type: l,
notify: function() {
if (this._defaultCacheMode === l.REALTIME || !this._armature || a.canCache(this._armature)) this.setAnimationCacheMode(this._defaultCacheMode); else {
this._defaultCacheMode = l.REALTIME;
...
if (this._cacheMode === l.SHARED_CACHE) this._armatureCache = a.sharedCache; else if (this._cacheMode === l.PRIVATE_CACHE) {
...
"../../cocos2d/core/components/CCRenderComponent": 101,
"../../cocos2d/core/event/event-target": 118,
"../../cocos2d/core/graphics/graphics": 122,
"../../cocos2d/core/renderer/render-flow": 160,
...
default: i
}, r = t("../../cocos2d/core/renderer/render-flow").FLAG_TRANSFORM, s = function() {}, a = function(t) {
...
for (var u, l = e.getSlots(), h = 0, f = l.length; h < f; h++) (u = l[h]).childArmature && s(u.childArmature);
}
}.bind(this);
s(this._armature);
...
var l = null;
if (l = s.parent ? s.parent._attachedNode : r) {
var h = l.getChildByName("ATTACHED_NODE:" + s.name);
if (h && h.isValid) this._buildBoneRelation(h, s, u); else {
h = this._buildBoneAttachedNode(s, u);
l.addChild(h);
}
h._rootNode = r;
s._attachedNode = h;
...
for (var c = this._armatureNode._mulMat, u = function(t, e, i) {
var n = o.m;
n[0] = i.a;
n[1] = i.b;
n[4] = -i.c;
...
n[13] = i.ty;
c(t, e, o);
}, l = !1, h = 0, f = e.length; h < f; h++) {
var _ = e[h];
if (_ && _.isValid) {
var d = a ? s[_._boneIndex] : _._bone;
if (d && !d._isInPool) {
u(_._worldMatrix, _._rootNode._worldMatrix, d.globalTransformMatrix);
_._renderFlag &= ~r;
} else {
...
"../../cocos2d/core/renderer/render-flow": 160,
"../../cocos2d/core/value-types/mat4": 215
} ],
245: [ (function(t, e) {
"use strict";
var i = cc.Class({
...
var c, u, l, h, f, _, d, p, v, m, g, y, A, E, T, C, b, x, S, R, w, I, O, D, M, L, N, P, F, B, k = t("./ArmatureDisplay"), z = t("../../cocos2d/core/renderer/render-flow"), U = cc.gfx, V = cc.color(255, 0, 0, 255), G = cc.color(0, 0, 255, 255), W = cc.color(0, 255, 0, 255);
function H(t, e) {
if (!t) return null;
var i, n;
switch (e) {
...
var r = !g.enableBatch, s = g._materials[0];
if (!s) return null;
var a = g._materialCache, o = t.getId() + i + n + r, c = a[o];
if (!c) {
...
c.setBlend(!0, U.BLEND_FUNC_ADD, i, n, U.BLEND_FUNC_ADD, i, n);
a[o] = c;
}
return c;
}
...
for (var n, s, a, o, c, u, l, h, f, _, g = t._slots, R = 0, w = g.length; R < w; R++) {
l = (h = g[R])._color;
if (h._visible && h._displayData) {
e ? h._mulMat(h._worldMatrix, e, h._matrix) : r.default.copy(h._worldMatrix, h._matrix);
if (h.childArmature) this.realTimeTraverse(h.childArmature, h._worldMatrix, i * l.a / 255); else if (o = H(h.getTexture(), h._blendMode)) {
if (d || o.getHash() !== m.material.getHash()) {
d = !1;
m._flush();
m.node = v;
m.material = o;
...
for (var D = 0, k = u.length; D < k; D++) s[A++] = E + u[D];
}
}
}
};
...
var i = t.segments;
if (0 != i.length) {
var n, r, s, a, o, c = t.vertices, u = t.indices, l = 0, h = 0, f = 0;
if (e) {
var _ = e.m;
M = _[0];
P = _[1];
...
var g = 16 & D, R = g && 1 === M && 0 === P && 0 === L && 1 === F, w = 0, I = t.colors, O = I[w++], k = O.vfOffset;
j(O, 1);
for (var z = 0, U = i.length; z < U; z++) {
var V = i[z];
a = H(V.tex, V.blendMode);
if (d || a.getHash() !== m.material.getHash()) {
d = !1;
m._flush();
m.node = v;
m.material = a;
...
r = p._iData;
s = p._uintVData;
for (var G = A, W = A + C; G < W; G++) r[G] = E + u[h++];
f = V.vfCount;
n.set(c.subarray(l, l + f), y);
l += f;
if (R) for (var Y = y, X = y + f; Y < X; Y += 5) {
n[Y] += N;
n[Y + 1] += B;
} else if (g) for (var q = y, K = y + f; q < K; q += 5) {
b = n[q];
x = n[q + 1];
n[q] = b * M + x * L + N;
n[q + 1] = b * P + x * F + B;
}
if (1 & D) for (var Z = l - f, J = y + 4, Q = y + 4 + f; J < Q; J += 5, Z += 5) {
if (Z >= k) {
j(O = I[w++], 1);
k = O.vfOffset;
}
...
s.strokeColor = V;
s.fillColor = G;
for (var a = i.getBones(), o = 0, _ = a.length; o < _; o++) {
var y = a[o], A = Math.max(y.boneData.length, 5), E = y.globalTransformMatrix.tx, T = y.globalTransformMatrix.ty, C = E + y.globalTransformMatrix.a * A, b = T + y.globalTransformMatrix.b * A;
s.moveTo(E, T);
s.lineTo(C, b);
s.stroke();
s.circle(E, T, 2 * Math.PI);
s.fill();
0 === o && (s.fillColor = W);
}
}
...
i.default = Y;
n.default.register(k, Y);
e.exports = i.default;
}), {
"../../cocos2d/core/renderer/assembler": 156,
"../../cocos2d/core/renderer/render-flow": 160,
"../../cocos2d/core/value-types/mat4": 215,
"./ArmatureDisplay": 243
} ],
...
}.bind(this), u = 0, l = n.length; u < l; u++) {
var h = c(n[u]);
e.push(h);
}
this._sortNodeArray();
...
if (o) {
var u = o.getChildByName("ATTACHED_NODE:" + s.name);
u && u.isValid && this._buildBoneRelation(u, r, s.index);
}
}
}
}
...
250: [ (function(t, e) {
"use strict";
var i = t("./track-entry-listeners"), n = t("../../cocos2d/core/components/CCRenderComponent"), r = t("./lib/spine"), s = t("../../cocos2d/core/graphics/graphics"), a = t("../../cocos2d/core/renderer/render-flow").FLAG_POST_RENDER, o = t("./skeleton-cache"), c = t("./AttachUtil"), u = cc.Enum({
default: -1
}), l = cc.Enum({
"<None>": 0
}), h = cc.Enum({
...
if (this._cacheMode === h.SHARED_CACHE) this._skeletonCache = o.sharedCache; else if (this._cacheMode === h.PRIVATE_CACHE) {
...
var o, c, u, l, h, f, _, d, p, v, m, g, y, A, E, T, C, b, x, S, R, w, I, O, D, M, L, N, P, F, B, k, z, U, V, G, W, H, j, Y, X, q, K, Z, J, Q, $ = t("./Skeleton"), tt = t("./lib/spine"), et = t("../../cocos2d/core/renderer/render-flow"), it = t("../../cocos2d/core/renderer/webgl/vertex-format"), nt = it.vfmtPosUvColor, rt = it.vfmtPosUvTwoColor, st = cc.gfx, at = 0, ot = [ 0, 1, 2, 2, 3, 0 ], ct = cc.color(0, 0, 255, 255), ut = cc.color(255, 0, 0, 255), lt = cc.color(0, 255, 0, 255), ht = cc.color(255, 255, 0, 255), ft = 0, _t = 0, dt = 0, pt = 0, vt = 0, mt = 0, gt = 0;
function yt(t, e) {
var i, n;
switch (e) {
case tt.BlendMode.Additive:
i = o ? cc.macro.ONE : cc.macro.SRC_ALPHA;
n = cc.macro.ONE;
break;
...
if (!s) return null;
var a = t.getId() + i + n + h + r, c = X._materialCache, u = c[a];
if (!u) {
if (c.baseMaterial) u = cc.MaterialVariant.create(s); else {
u = s;
c.baseMaterial = s;
}
u.define("CC_USE_MODEL", r);
u.define("USE_TINT", h);
u.setProperty("texture", t);
u.setBlend(!0, st.BLEND_FUNC_ADD, i, n, st.BLEND_FUNC_ADD, i, n);
c[a] = u;
}
return u;
}
...
var s, a = q._vData, u = q._iData, l = q._uintVData;
null.a = i.a * e.a * t.a * g * 255;
c = o ? null.a : 255;
b = p * e.r * t.r * c;
x = v * e.g * t.g * c;
S = m * e.b * t.b * c;
...
null.r = r.darkColor.r * b;
null.g = r.darkColor.g * x;
null.b = r.darkColor.b * S;
}
null.a = o ? 255 : 0;
if (n.isClipping()) {
var f = a.subarray(dt + 2);
n.clipTriangles(a.subarray(dt), ft, u.subarray(mt), vt, f, null, null, h, T);
var _ = new Float32Array(n.clippedVertices), d = n.clippedTriangles;
vt = d.length;
ft = _.length / C * T;
s = q.request(ft / T, vt);
mt = s.indiceOffset, pt = s.vertexOffset, dt = s.byteOffset >> 2;
a = q._vData, u = q._iData;
l = q._uintVData;
u.set(d, mt);
if (Q) for (var E = 0, R = _.length, w = dt; E < R; E += C, w += T) {
null.x = _[E];
null.y = _[E + 1];
null.set(_[E + 2], _[E + 3], _[E + 4], _[E + 5]);
null.x = _[E + 6];
null.y = _[E + 7];
h ? null.set(_[E + 8], _[E + 9], _[E + 10], _[E + 11]) : null.set(0, 0, 0, 0);
...
l[w + 4] = Et(null);
h && (l[w + 5] = Et(null));
} else for (var I = 0, O = _.length, D = dt; I < O; I += C, D += T) {
a[D] = _[I];
a[D + 1] = _[I + 1];
a[D + 2] = _[I + 6];
a[D + 3] = _[I + 7];
y = (_[I + 5] << 24 >>> 0) + (_[I + 4] << 16) + (_[I + 3] << 8) + _[I + 2];
l[D + 4] = y;
if (h) {
A = (_[I + 11] << 24 >>> 0) + (_[I + 10] << 16) + (_[I + 9] << 8) + _[I + 8];
l[D + 5] = A;
}
}
} else if (Q) for (var M = dt, L = dt + ft; M < L; M += T) {
null.x = a[M];
null.y = a[M + 1];
null.x = a[M + 2];
null.y = a[M + 3];
...
var e, i, n, r, s, a, o, c, p, v, m, g, y = X._skeleton, A = y.color, E = X._debugRenderer, b = X._clipper, x = null;
u = X._startSlotIndex;
l = X._endSlotIndex;
R = !1;
-1 == u && (R = !0);
...
vt = 0;
mt = 0;
for (var S = 0, B = y.drawOrder.length; S < B; S++) if (null != (m = y.drawOrder[S]) && m.bone.active) {
u >= 0 && u == m.data.index && (R = !0);
if (R) {
l >= 0 && l == m.data.index && (R = !1);
ft = 0;
vt = 0;
if (n = m.getAttachment()) {
c = n instanceof tt.RegionAttachment;
p = n instanceof tt.MeshAttachment;
if (n instanceof tt.ClippingAttachment) b.clipStart(m, n); else if (c || p) if (x = yt(n.region.texture._texture, m.data.blendMode)) {
if (w || x.getHash() !== K.material.getHash()) {
w = !1;
K._flush();
K.node = Z;
K.material = x;
...
vt = 6;
v = q.request(4, 6);
mt = v.indiceOffset, pt = v.vertexOffset, dt = v.byteOffset >> 2;
e = q._vData, i = q._iData;
n.computeWorldVertices(m.bone, e, dt, T);
if (E && f) {
E.strokeColor = ct;
E.moveTo(e[dt], e[dt + 1]);
for (var k = dt + T, z = dt + ft; k < z; k += T) E.lineTo(e[k], e[k + 1]);
E.close();
E.stroke();
}
} else if (p) {
o = n.triangles;
ft = (n.worldVerticesLength >> 1) * T;
vt = o.length;
v = q.request(ft / T, vt);
mt = v.indiceOffset, pt = v.vertexOffset, dt = v.byteOffset >> 2;
e = q._vData, i = q._iData;
n.computeWorldVertices(m, 0, n.worldVerticesLength, e, dt, T);
if (E && d) {
E.strokeColor = ht;
for (var U = 0, V = o.length; U < V; U += 3) {
var G = o[U] * T + dt, W = o[U + 1] * T + dt, H = o[U + 2] * T + dt;
E.moveTo(e[G], e[G + 1]);
E.lineTo(e[W], e[W + 1]);
E.lineTo(e[H], e[H + 1]);
E.close();
...
i.set(o, mt);
a = n.uvs;
for (var j = dt, Y = dt + ft, J = 0; j < Y; j += T, J += 2) {
e[j + 2] = a[J];
e[j + 3] = a[J + 1];
}
r = n.color, s = m.color;
this.fillVertices(A, r, s, b, m);
e = q._vData, i = q._iData;
if (vt > 0) {
for (var Q = mt, $ = mt + vt; Q < $; Q++) i[Q] += pt;
if (t) {
g = t.m;
D = g[0];
M = g[4];
...
P = g[5];
F = g[13];
for (var et = dt, it = dt + ft; et < it; et += T) {
I = e[et];
O = e[et + 1];
e[et] = I * D + O * M + L;
e[et + 1] = I * N + O * P + F;
...
b.clipEndWithSlot(m);
} else b.clipEndWithSlot(m);
} else b.clipEndWithSlot(m); else b.clipEndWithSlot(m);
} else b.clipEndWithSlot(m);
} else b.clipEndWithSlot(m);
}
b.clipEnd();
...
E.strokeColor = ut;
E.fillColor = ct;
for (var rt = 0, st = y.bones.length; rt < st; rt++) {
var at = (nt = y.bones[rt]).data.length * nt.a + nt.worldX, _t = nt.data.length * nt.c + nt.worldY;
E.moveTo(nt.worldX, nt.worldY);
E.lineTo(at, _t);
E.stroke();
E.circle(nt.worldX, nt.worldY, 1.5 * Math.PI);
E.fill();
0 === rt && (E.fillColor = lt);
}
}
...
var i = e.segments;
if (0 != i.length) {
var n, r, s, a, o, c, u = e.vertices, l = e.indices, h = 0, f = 0, _ = 0;
if (t) {
c = t.m;
D = c[0];
N = c[1];
...
var d = 16 & at, p = d && 1 === D && 0 === N && 0 === M && 1 === P, v = 0, m = e.colors, g = m[v++], E = g.vfOffset;
At(g);
for (var T = 0, C = i.length; T < C; T++) {
var b = i[T];
if (a = yt(b.tex, b.blendMode)) {
if (w || a.getHash() !== K.material.getHash()) {
w = !1;
K._flush();
K.node = Z;
K.material = a;
...
r = q._iData;
s = q._uintVData;
for (var x = mt, S = mt + vt; x < S; x++) r[x] = pt + l[f++];
_ = b.vfCount;
n.set(u.subarray(h, h + _), gt);
h += _;
if (p) for (var R = gt, B = gt + _; R < B; R += 6) {
n[R] += L;
n[R + 1] += F;
} else if (d) for (var k = gt, z = gt + _; k < z; k += 6) {
I = n[k];
O = n[k + 1];
n[k] = I * D + O * M + L;
n[k + 1] = I * N + O * P + F;
...
q.adjust(_t, vt);
if (J) for (var U = h - _, V = gt + 4, G = gt + 4 + _; V < G; V += 6, U += 6) {
if (U >= E) {
At(g = m[v++]);
E = g.vfOffset;
}
...
T = h ? 6 : 5;
Z = t.node;
q = e.getBuffer("spine", E);
K = e;
X = t;
w = !0;
o = t.premultipliedAlpha;
c = 1;
at = 0;
J = !1;
Q = t._effectDelegate && t._effectDelegate._vertexEffect;
(4294967295 !== n._val || o) && (J = !0);
h && (at |= 1);
var r = void 0;
if (X.enableBatch) {
r = Z._worldMatrix;
...
i.default = Tt;
r.default.register($, Tt);
e.exports = i.default;
}), {
"../../cocos2d/core/renderer/assembler": 156,
"../../cocos2d/core/renderer/render-flow": 160,
"../../cocos2d/core/renderer/webgl/vertex-format": 187,
"./Skeleton": 250,
"./lib/spine": void 0
} ],
255: [ (function(t, e) {
...
"./package": void 0,
"./polyfill/array": 258,
"./polyfill/array-buffer": 257,
"./polyfill/misc": 259,
"./polyfill/number": 260,
"./polyfill/object": 261,
"./polyfill/string": 262,
"./polyfill/typescript": 263,
"./predefine": 264
} ],
257: [ (function() {
"use strict";
...
e("CC_WECHATGAME", r);
e("CC_QQPLAY", s);
t.CocosEngine = cc.ENGINE_VERSION = "2.4.15";
}), {} ]
}, {}, [ 256 ]);